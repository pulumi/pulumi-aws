...
export class ApplicationLoadBalancer extends pulumi.Resource {
    ...
    /**
     * Create a ApplicationLoadBalancer resource with the given unique name, arguments and optional additional
     * resource dependencies.
     *
     * @param urnName A _unique_ name for this ApplicationLoadBalancer instance
     * @param args A collection of arguments for creating this ApplicationLoadBalancer intance
     * @param dependsOn A optional array of additional resources this intance depends on
     */
    constructor(urnName: string, args?: ApplicationLoadBalancerArgs, dependsOn?: pulumi.Resource[]) {
        super("aws:elasticloadbalancingv2/applicationLoadBalancer:ApplicationLoadBalancer", urnName, {
