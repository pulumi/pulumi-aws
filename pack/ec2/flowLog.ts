 ...
 * ```
 */
export class FlowLog extends pulumi.Resource {
    /**
     * Elastic Network Interface ID to attach to
     */
    public readonly eniId?: pulumi.Computed<string>;
    /**
     ...
     * `ACCEPT`,`REJECT`, `ALL`
     */
    public readonly trafficType: pulumi.Computed<string>;
    /**
     * VPC ID to attach to
     */
     ...
     * @param args A collection of arguments for creating this FlowLog instance
     * @param dependsOn A optional array of additional resources this instance depends on
     */
    constructor(urnName: string, args: FlowLogArgs, dependsOn?: pulumi.Resource[]) {
...
export interface FlowLogArgs {
     ...
     * Elastic Network Interface ID to attach to
     */
    readonly eniId?: pulumi.ComputedValue<string>;
    /**
     * The ARN for the IAM role that's used to post flow
     * logs to a CloudWatch Logs log group
     */
     ...
     * `ACCEPT`,`REJECT`, `ALL`
     */
    readonly trafficType: pulumi.ComputedValue<string>;
    /**
     * VPC ID to attach to
     */
