 ...
 */
export class AmiFromInstance extends pulumi.Resource {
    /**
     ...
     */
    public readonly snapshotWithoutReboot?: pulumi.Computed<boolean>;
    /**
     * The id of the instance to use as the basis of the AMI.
     */
    public readonly sourceInstanceId: pulumi.Computed<string>;
    /**
...
export interface AmiFromInstanceArgs {
     ...
     * guarantees that no filesystem writes will be underway at the time of snapshot.
     */
    readonly snapshotWithoutReboot?: pulumi.ComputedValue<boolean>;
    /**
     * The id of the instance to use as the basis of the AMI.
     */
    readonly sourceInstanceId: pulumi.ComputedValue<string>;
