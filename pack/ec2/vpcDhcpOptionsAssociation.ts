 ...
 */
export class VpcDhcpOptionsAssociation extends pulumi.Resource {
    /**
     * The ID of the DHCP Options Set to associate to the VPC.
     */
    public readonly dhcpOptionsId: pulumi.Computed<string>;
    /**
...
export interface VpcDhcpOptionsAssociationArgs {
     ...
     * The ID of the DHCP Options Set to associate to the VPC.
     */
    readonly dhcpOptionsId: pulumi.ComputedValue<string>;
    /**
     * The ID of the VPC to which we would like to associate a DHCP Options Set.
     */
