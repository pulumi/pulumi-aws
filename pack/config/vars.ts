...
// console.
export let accessKey: string | undefined = _config.getObject<string | undefined>("accessKey");
...
// dynamodb-local.
export let dynamodbEndpoint: string | undefined = _config.getObject<string | undefined>("dynamodbEndpoint");
...
// Use this to override the default endpoint URL constructed from the `region`. It's typically used to connect to
// kinesalite.
export let kinesisEndpoint: string | undefined = _config.getObject<string | undefined>("kinesisEndpoint");
...
export let profile: string | undefined = _config.getObject<string | undefined>("profile");
// The region where AWS operations will take place. Examples are us-east-1, us-west-2, etc.
export let region: Region = _config.requireObject<Region>("region");
...
// console.
export let secretKey: string | undefined = _config.getObject<string | undefined>("secretKey");
// The path to the shared credentials file. If not set this defaults to ~/.aws/credentials.
export let sharedCredentialsFile: string | undefined = _config.getObject<string | undefined>("sharedCredentialsFile");
...
export let token: string | undefined = _config.getObject<string | undefined>("token");
