 ...
 */
export class TopicSubscription extends pulumi.Resource {
    /**
     ...
     */
    public readonly confirmationTimeoutInMinutes?: pulumi.Computed<number>;
     ...
     */
    public readonly endpointAutoConfirms?: pulumi.Computed<boolean>;
    /**
     ...
     */
    public readonly rawMessageDelivery?: pulumi.Computed<boolean>;
    /**
     * The ARN of the SNS topic to subscribe to
     */
    public readonly topic: pulumi.Computed<Topic>;
     ...
     * @param args A collection of arguments for creating this TopicSubscription instance
     * @param dependsOn A optional array of additional resources this instance depends on
     */
    constructor(urnName: string, args: TopicSubscriptionArgs, dependsOn?: pulumi.Resource[]) {
...
export interface TopicSubscriptionArgs {
     ...
     * Integer indicating number of minutes to wait in retying mode for fetching subscription arn before marking it as failure. Only applicable for http and https protocols (default is 1 minute).
     */
    readonly confirmationTimeoutInMinutes?: pulumi.ComputedValue<number>;
     ...
     * Boolean indicating whether the end point is capable of [auto confirming subscription](http://docs.aws.amazon.com/sns/latest/dg/SendMessageToHttp.html#SendMessageToHttp.prepare) e.g., PagerDuty (default is false)
     */
    readonly endpointAutoConfirms?: pulumi.ComputedValue<boolean>;
    /**
     * The protocol to use. The possible values for this are: `sqs`,  `lambda`, `application`. (`http` or `https` are partially supported, see below) (`email`, `sms`, are options but unsupported, see below).
     */
     ...
     * Boolean indicating whether or not to enable raw message delivery (the original message is directly passed, not wrapped in JSON with the original message in the message property).
     */
    readonly rawMessageDelivery?: pulumi.ComputedValue<boolean>;
    /**
     * The ARN of the SNS topic to subscribe to
     */
    readonly topic: pulumi.ComputedValue<Topic>;
}
