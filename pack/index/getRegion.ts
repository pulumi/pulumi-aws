...
export interface GetRegionArgs {
    /**
     * Set to `true` to match only the region configured
     * in the provider. (It is not meaningful to set this to `false`.)
     */
    current?: pulumi.ComputedValue<boolean>;
    /**
     * The endpoint of the region to select.
     */
    endpoint?: pulumi.ComputedValue<string>;
    /**
