 ...
 */
export class JavaAppLayer extends pulumi.Resource {
    /**
     ...
     */
    public readonly appServerVersion?: pulumi.Computed<string>;
    /**
     ...
     */
    public readonly jvmOptions?: pulumi.Computed<string>;
    /**
     * Keyword for the type of JVM to use. Defaults to `openjdk`.
     */
    public readonly jvmType?: pulumi.Computed<string>;
    /**
     * Version of JVM to use. Defaults to "7".
     */
    public readonly jvmVersion?: pulumi.Computed<string>;
    /**
...
export interface JavaAppLayerArgs {
     ...
     * Version of the selected application container to use. Defaults to "7".
     */
    readonly appServerVersion?: pulumi.ComputedValue<string>;
    /**
     * Whether to automatically assign an elastic IP address to the layer's instances.
     */
     ...
     * Options to set for the JVM.
     */
    readonly jvmOptions?: pulumi.ComputedValue<string>;
    /**
     * Keyword for the type of JVM to use. Defaults to `openjdk`.
     */
    readonly jvmType?: pulumi.ComputedValue<string>;
    /**
     * Version of JVM to use. Defaults to "7".
     */
    readonly jvmVersion?: pulumi.ComputedValue<string>;
    /**
     * A human-readable name for the layer.
     */
