 ...
 */
export class RailsAppLayer extends pulumi.Resource {
    /**
     * Keyword for the app server to use. Defaults to "apache_passenger".
     */
    public readonly appServer?: pulumi.Computed<string>;
    /**
     ...
     */
    public readonly bundlerVersion?: pulumi.Computed<string>;
     ...
     */
    public readonly manageBundler?: pulumi.Computed<boolean>;
    /**
     ...
     */
    public readonly passengerVersion?: pulumi.Computed<string>;
    /**
     * The version of Ruby to use. Defaults to "2.0.0".
     */
    public readonly rubyVersion?: pulumi.Computed<string>;
    /**
     * The version of RubyGems to use. Defaults to "2.2.2".
     */
    public readonly rubygemsVersion?: pulumi.Computed<string>;
    /**
...
export interface RailsAppLayerArgs {
     ...
     * Keyword for the app server to use. Defaults to "apache_passenger".
     */
    readonly appServer?: pulumi.ComputedValue<string>;
    /**
     * Whether to automatically assign an elastic IP address to the layer's instances.
     */
     ...
     * When OpsWorks is managing Bundler, which version to use. Defaults to "1.5.3".
     */
    readonly bundlerVersion?: pulumi.ComputedValue<string>;
     ...
     * Whether OpsWorks should manage bundler. On by default.
     */
    readonly manageBundler?: pulumi.ComputedValue<boolean>;
    /**
     * A human-readable name for the layer.
     */
     ...
     * The version of Passenger to use. Defaults to "4.0.46".
     */
    readonly passengerVersion?: pulumi.ComputedValue<string>;
    /**
     * The version of Ruby to use. Defaults to "2.0.0".
     */
    readonly rubyVersion?: pulumi.ComputedValue<string>;
    /**
     * The version of RubyGems to use. Defaults to "2.2.2".
     */
    readonly rubygemsVersion?: pulumi.ComputedValue<string>;
    /**
     * The id of the stack the layer will belong to.
     */
