...
export class MemcachedLayer
        extends fabric.Resource implements MemcachedLayerArgs {
    public readonly allocatedMemory?: fabric.Property<number>;
...
export interface MemcachedLayerArgs {
    readonly allocatedMemory?: fabric.PropertyValue<number>;
