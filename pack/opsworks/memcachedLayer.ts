 ...
 */
export class MemcachedLayer extends pulumi.Resource {
    /**
     * Amount of memory to allocate for the cache on each instance, in megabytes. Defaults to 512MB.
     */
    public readonly allocatedMemory?: pulumi.Computed<number>;
    /**
     ...
     * @param args A collection of arguments for creating this MemcachedLayer instance
     * @param dependsOn A optional array of additional resources this instance depends on
     */
    constructor(urnName: string, args: MemcachedLayerArgs, dependsOn?: pulumi.Resource[]) {
...
export interface MemcachedLayerArgs {
     ...
     * Amount of memory to allocate for the cache on each instance, in megabytes. Defaults to 512MB.
     */
    readonly allocatedMemory?: pulumi.ComputedValue<number>;
    /**
     * Whether to automatically assign an elastic IP address to the layer's instances.
     */
