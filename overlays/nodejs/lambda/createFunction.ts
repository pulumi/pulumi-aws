...
export function createFunction(
    name: string, args: lambda.FunctionArgs, handler: Handler,
    opts?: pulumi.ResourceOptions, serialize?: (obj: any) => boolean): lambda.Function {
    ...
    const argsCopy = {
        ...args,
        runtime: args.runtime || lambda.NodeJS8d10Runtime,
        timeout: args.timeout === undefined ? 180 : opts.timeout,
