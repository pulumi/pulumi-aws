...
export class MemberAccountAssociation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<MemberAccountAssociationState>, opts?: pulumi.CustomResourceOptions): MemberAccountAssociation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<MemberAccountAssociationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<MemberAccountAssociationArgs> | pulumi.WrappedObject<MemberAccountAssociationState>, opts?: pulumi.CustomResourceOptions) {
