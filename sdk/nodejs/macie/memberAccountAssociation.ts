...
export class MemberAccountAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MemberAccountAssociationState): MemberAccountAssociation {
        return new MemberAccountAssociation(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: MemberAccountAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: MemberAccountAssociationArgs | MemberAccountAssociationState, opts?: pulumi.ResourceOptions) {
