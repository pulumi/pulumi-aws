...
export class GlobalTable extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GlobalTableState): GlobalTable {
        return new GlobalTable(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: GlobalTableArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: GlobalTableArgs | GlobalTableState, opts?: pulumi.ResourceOptions) {
