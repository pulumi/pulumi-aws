...
export class GlobalTable extends pulumi.CustomResource {
     ...
     */
    public readonly replicas!: pulumi.Output<outputApi.dynamodb.GlobalTableReplica[]>;
...
export interface GlobalTableState {
     ...
     * Underlying DynamoDB Table. At least 1 replica must be defined. See below.
     */
    readonly replicas?: pulumi.Input<pulumi.Input<inputApi.dynamodb.GlobalTableReplica>[]>;
}
