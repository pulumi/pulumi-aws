 ...
 */
export function metricConditionalCheckFailedRequests(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricConsumedReadCapacityUnits(change: cloudwatch.MetricChange = {}) {
 ...
 * compare the calculated value to the provisioned throughput value you provide DynamoDB.
 */
export function metricConsumedWriteCapacityUnits(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricOnlineIndexConsumedWriteCapacity(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricOnlineIndexPercentageProgress(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricOnlineIndexThrottleEvents(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricPendingReplicationCount(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricProvisionedReadCapacityUnits(change: cloudwatch.MetricChange = {}) {
 ...
 * must specify both TableName and GlobalSecondaryIndex.
 */
export function metricProvisionedWriteCapacityUnits(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricReadThrottleEvents(change: cloudwatch.MetricChange = {}) {
 ...
 * global table.
 */
export function metricReplicationLatency(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricReturnedBytes(change: cloudwatch.MetricChange = {}) {
 ...
 * items.
 */
export function metricReturnedItemCount(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricReturnedRecordsCount(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricSuccessfulRequestLatency(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricSystemErrors(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricTimeToLiveDeletedItemCount(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricThrottledRequests(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricUserErrors(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricWriteThrottleEvents(change: cloudwatch.MetricChange = {}) {
