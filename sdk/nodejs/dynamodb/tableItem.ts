...
export class TableItem extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<TableItemState>, opts?: pulumi.CustomResourceOptions): TableItem {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<TableItemArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<TableItemArgs> | pulumi.WrappedObject<TableItemState>, opts?: pulumi.CustomResourceOptions) {
