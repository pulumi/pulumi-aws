...
declare module "./table" {
    interface Table {
        /**
         * Direct access to create metrics for this specific [dynamodb.Table].
         */
        metrics: {
            /**
             * The number of failed attempts to perform conditional writes. The PutItem, UpdateItem, and
             ...
             * Valid Statistics: Minimum, Maximum, Average, SampleCount, Sum
             */
            conditionalCheckFailedRequests(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Count
             *
             * Additional Dimensions: GlobalSecondaryIndexName
             *
             * Valid Statistics:
             * * Minimum – Minimum number of read capacity units consumed by any individual request to the
             *   table or index.
             ...
             * * SampleCount – Number of requests to DynamoDB that consumed read capacity.
             */
            consumedReadCapacityUnits(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * SampleCount – Number of requests to DynamoDB that consumed write capacity.
             */
            consumedWriteCapacityUnits(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * Sum
             */
            onlineIndexConsumedWriteCapacity(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * Sum
             */
            onlineIndexPercentageProgress(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * Sum
             */
            onlineIndexThrottleEvents(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Count
             *
             * Additional Dimensions: ReceivingRegion
             *
             * Valid Statistics:
             * * Average
             * * Sample Count
             * * Sum
             */
            pendingReplicationCount(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             *   capacity units, this statistic might not reflect the true average.
             */
            provisionedReadCapacityUnits(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             *   capacity units, this statistic might not reflect the true average.
             */
            provisionedWriteCapacityUnits(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * Sum
             */
            readThrottleEvents(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * Maximum
             */
            replicationLatency(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Bytes
             *
             * Additional Dimensions: Operation, StreamLabel
             *
             * Valid Statistics:
             * * Minimum
             * * Maximum
             ...
             * * Sum
             */
            returnedBytes(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Count
             *
             * Additional Dimensions: Operation
             *
             * Valid Statistics:
             * * Minimum
             * * Maximum
             ...
             * * Sum
             */
            returnedItemCount(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * Sum
             */
            returnedRecordsCount(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Milliseconds
             *
             * Additional Dimensions: TableName
             *
             * Valid Statistics:
             * * Minimum
             * * Maximum
             ...
             * * SampleCount
             */
            successfulRequestLatency(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * SampleCount
             */
            systemErrors(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * Sum
             */
            timeToLiveDeletedItemCount(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * SampleCount
             */
            throttledRequests(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * * SampleCount
             */
            writeThrottleEvents(change?: cloudwatch.MetricChange): cloudwatch.Metric;
        }
    }
}
