...
export class ResourceGroup extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: ResourceGroupArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ResourceGroupArgs | ResourceGroupState, opts?: pulumi.ResourceOptions) {
