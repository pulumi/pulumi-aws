...
export class ResourceGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ResourceGroupState>, opts?: pulumi.CustomResourceOptions): ResourceGroup {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ResourceGroupArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ResourceGroupArgs> | pulumi.WrappedObject<ResourceGroupState>, opts?: pulumi.CustomResourceOptions) {
