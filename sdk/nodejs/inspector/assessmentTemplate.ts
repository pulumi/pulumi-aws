...
export class AssessmentTemplate extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<AssessmentTemplateState>, opts?: pulumi.CustomResourceOptions): AssessmentTemplate {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<AssessmentTemplateArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<AssessmentTemplateArgs> | pulumi.WrappedObject<AssessmentTemplateState>, opts?: pulumi.CustomResourceOptions) {
