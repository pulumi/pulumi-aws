...
export class AssessmentTemplate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AssessmentTemplateState): AssessmentTemplate {
        return new AssessmentTemplate(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: AssessmentTemplateArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AssessmentTemplateArgs | AssessmentTemplateState, opts?: pulumi.ResourceOptions) {
