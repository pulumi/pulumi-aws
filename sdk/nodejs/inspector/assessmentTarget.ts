 ...
 *
 * const bar = new aws.inspector/resourceGroup.ResourceGroup("bar", {tags: {
 *     Name: "foo",
 *     Env: "bar",
 * }});
 * const foo = new aws.inspector/assessmentTarget.AssessmentTarget("foo", {resourceGroupArn: bar.arn});
 * ```
 *
 * ## Import
 *
