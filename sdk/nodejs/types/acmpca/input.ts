...
export interface CertificateAuthorityRevocationConfiguration {
     ...
     */
    ocspConfiguration?: pulumi.Input<inputs.acmpca.CertificateAuthorityRevocationConfigurationOcspConfiguration>;
}
...
export interface GetCertificateAuthorityRevocationConfiguration {
    ...
    ocspConfigurations?: inputs.acmpca.GetCertificateAuthorityRevocationConfigurationOcspConfiguration[];
}
...
export interface GetCertificateAuthorityRevocationConfigurationArgs {
    ...
    ocspConfigurations?: pulumi.Input<pulumi.Input<inputs.acmpca.GetCertificateAuthorityRevocationConfigurationOcspConfigurationArgs>[]>;
}
...
export interface GetCertificateAuthorityRevocationConfigurationOcspConfigurationArgs {
    enabled?: pulumi.Input<boolean>;
    ocspCustomCname?: pulumi.Input<string>;
}
