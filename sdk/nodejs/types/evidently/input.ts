...
export interface FeatureVariation {
     ...
     */
    value: pulumi.Input<inputs.evidently.FeatureVariationValue>;
}
...
export interface ProjectDataDelivery {
     ...
     */
    cloudwatchLogs?: pulumi.Input<inputs.evidently.ProjectDataDeliveryCloudwatchLogs>;
    /**
     * A block that defines the S3 bucket and prefix that stores the evaluation events. See below.
     */
    s3Destination?: pulumi.Input<inputs.evidently.ProjectDataDeliveryS3Destination>;
}
