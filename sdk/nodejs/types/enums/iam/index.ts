...
export const ManagedPolicy = {
    ...
    AWSBatchServiceRole: "arn:iam::aws:policy/service-role/AWSBatchServiceRole",
    ...
    AWSCloudHSMRole: "arn:iam::aws:policy/service-role/AWSCloudHSMRole",
    ...
    AWSCodeDeployRole: "arn:iam::aws:policy/service-role/AWSCodeDeployRole",
    ...
    AWSCodeStarServiceRole: "arn:iam::aws:policy/service-role/AWSCodeStarServiceRole",
    AWSConfigRole: "arn:iam::aws:policy/service-role/AWSConfigRole",
    AWSConfigRulesExecutionRole: "arn:iam::aws:policy/service-role/AWSConfigRulesExecutionRole",
    AWSConfigUserAccess: "arn:aws:iam::aws:policy/AWSConfigUserAccess",
    AWSConnector: "arn:aws:iam::aws:policy/AWSConnector",
    AWSDataPipelineRole: "arn:iam::aws:policy/service-role/AWSDataPipelineRole",
    ...
    AWSElasticBeanstalkEnhancedHealth: "arn:iam::aws:policy/service-role/AWSElasticBeanstalkEnhancedHealth",
    ...
    AWSElasticBeanstalkService: "arn:iam::aws:policy/service-role/AWSElasticBeanstalkService",
    ...
    AWSGreengrassResourceAccessRolePolicy: "arn:iam::aws:policy/service-role/AWSGreengrassResourceAccessRolePolicy",
    ...
    AWSIoTLogging: "arn:iam::aws:policy/service-role/AWSIoTLogging",
    AWSIoTRuleActions: "arn:iam::aws:policy/service-role/AWSIoTRuleActions",
    AWSKeyManagementServicePowerUser: "arn:aws:iam::aws:policy/AWSKeyManagementServicePowerUser",
    AWSLambdaBasicExecutionRole: "arn:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole",
    AWSLambdaDynamoDBExecutionRole: "arn:iam::aws:policy/service-role/AWSLambdaDynamoDBExecutionRole",
    AWSLambdaENIManagementAccess: "arn:iam::aws:policy/service-role/AWSLambdaENIManagementAccess",
    ...
    AWSLambdaKinesisExecutionRole: "arn:iam::aws:policy/service-role/AWSLambdaKinesisExecutionRole",
    AWSLambdaReadOnlyAccess: "arn:aws:iam::aws:policy/AWSLambdaReadOnlyAccess",
    AWSLambdaRole: "arn:iam::aws:policy/service-role/AWSLambdaRole",
    AWSLambdaVPCAccessExecutionRole: "arn:iam::aws:policy/service-role/AWSLambdaVPCAccessExecutionRole",
    ...
    AWSMobileHub_ServiceUseOnly: "arn:iam::aws:policy/service-role/AWSMobileHub_ServiceUseOnly",
    AWSOpsWorksCMInstanceProfileRole: "arn:aws:iam::aws:policy/AWSOpsWorksCMInstanceProfileRole",
    AWSOpsWorksCMServiceRole: "arn:iam::aws:policy/service-role/AWSOpsWorksCMServiceRole",
    ...
    AWSOpsWorksRole: "arn:iam::aws:policy/service-role/AWSOpsWorksRole",
    AWSQuickSightDescribeRD: "arn:iam::aws:policy/service-role/AWSQuickSightDescribeRDS",
    AWSQuickSightDescribeRedshift: "arn:iam::aws:policy/service-role/AWSQuickSightDescribeRedshift",
    AWSQuickSightListIAM: "arn:iam::aws:policy/service-role/AWSQuickSightListIAM",
    AWSQuicksightAthenaAccess: "arn:iam::aws:policy/service-role/AWSQuicksightAthenaAccess",
    ...
    AmazonAPIGatewayPushToCloudWatchLogs: "arn:iam::aws:policy/service-role/AmazonAPIGatewayPushToCloudWatchLogs",
    ...
    AmazonAppStreamServiceAccess: "arn:iam::aws:policy/service-role/AmazonAppStreamServiceAccess",
    ...
    AmazonDMSCloudWatchLogsRole: "arn:iam::aws:policy/service-role/AmazonDMSCloudWatchLogsRole",
    AmazonDMSRedshiftS3Role: "arn:iam::aws:policy/service-role/AmazonDMSRedshiftS3Role",
    AmazonDMSVPCManagementRole: "arn:iam::aws:policy/service-role/AmazonDMSVPCManagementRole",
    ...
    AmazonEC2ContainerServiceAutoscaleRole: "arn:iam::aws:policy/service-role/AmazonEC2ContainerServiceAutoscaleRole",
    AmazonEC2ContainerServiceFullAccess: "arn:aws:iam::aws:policy/AmazonEC2ContainerServiceFullAccess",
    AmazonEC2ContainerServiceRole: "arn:iam::aws:policy/service-role/AmazonEC2ContainerServiceRole",
    AmazonEC2ContainerServiceforEC2Role: "arn:iam::aws:policy/service-role/AmazonEC2ContainerServiceforEC2Role",
    AmazonEC2FullAccess: "arn:aws:iam::aws:policy/AmazonEC2FullAccess",
    AmazonEC2ReadOnlyAccess: "arn:aws:iam::aws:policy/AmazonEC2ReadOnlyAccess",
    AmazonEC2ReportsAccess: "arn:aws:iam::aws:policy/AmazonEC2ReportsAccess",
    AmazonEC2RoleforAWSCodeDeploy: "arn:iam::aws:policy/service-role/AmazonEC2RoleforAWSCodeDeploy",
    AmazonEC2RoleforDataPipelineRole: "arn:iam::aws:policy/service-role/AmazonEC2RoleforDataPipelineRole",
    AmazonEC2RoleforSSM: "arn:iam::aws:policy/service-role/AmazonEC2RoleforSSM",
    AmazonEC2SpotFleetAutoscaleRole: "arn:iam::aws:policy/service-role/AmazonEC2SpotFleetAutoscaleRole",
    AmazonEC2SpotFleetRole: "arn:iam::aws:policy/service-role/AmazonEC2SpotFleetRole",
    AmazonEC2SpotFleetTaggingRole: "arn:iam::aws:policy/service-role/AmazonEC2SpotFleetTaggingRole",
    ...
    AmazonElasticMapReduceRole: "arn:iam::aws:policy/service-role/AmazonElasticMapReduceRole",
    AmazonElasticMapReduceforAutoScalingRole: "arn:iam::aws:policy/service-role/AmazonElasticMapReduceforAutoScalingRole",
    AmazonElasticMapReduceforEC2Role: "arn:iam::aws:policy/service-role/AmazonElasticMapReduceforEC2Role",
    ...
    AmazonElasticTranscoderRole: "arn:iam::aws:policy/service-role/AmazonElasticTranscoderRole",
    ...
    AmazonMachineLearningRoleforRedshiftDataSource: "arn:iam::aws:policy/service-role/AmazonMachineLearningRoleforRedshiftDataSource",
    ...
    AmazonRDSDirectoryServiceAccess: "arn:iam::aws:policy/service-role/AmazonRDSDirectoryServiceAccess",
    AmazonRDSEnhancedMonitoringRole: "arn:iam::aws:policy/service-role/AmazonRDSEnhancedMonitoringRole",
    ...
    AmazonSNSRole: "arn:iam::aws:policy/service-role/AmazonSNSRole",
    ...
    AmazonSSMAutomationRole: "arn:iam::aws:policy/service-role/AmazonSSMAutomationRole",
    AmazonSSMFullAccess: "arn:aws:iam::aws:policy/AmazonSSMFullAccess",
    AmazonSSMMaintenanceWindowRole: "arn:iam::aws:policy/service-role/AmazonSSMMaintenanceWindowRole",
    ...
    ApplicationAutoScalingForAmazonAppStreamAccess: "arn:iam::aws:policy/service-role/ApplicationAutoScalingForAmazonAppStreamAccess",
    ...
    AutoScalingNotificationAccessRole: "arn:iam::aws:policy/service-role/AutoScalingNotificationAccessRole",
