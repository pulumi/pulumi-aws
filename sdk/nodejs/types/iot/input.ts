...
export interface TopicRuleErrorAction {
    ...
    cloudwatchLogs?: pulumi.Input<inputs.iot.TopicRuleErrorActionCloudwatchLogs>;
    ...
    http?: pulumi.Input<inputs.iot.TopicRuleErrorActionHttp>;
    ...
    kafka?: pulumi.Input<inputs.iot.TopicRuleErrorActionKafka>;
    ...
    timestream?: pulumi.Input<inputs.iot.TopicRuleErrorActionTimestream>;
}
...
export interface TopicRuleErrorActionHttp {
     ...
     */
    httpHeaders?: pulumi.Input<pulumi.Input<inputs.iot.TopicRuleErrorActionHttpHttpHeader>[]>;
    /**
     * The HTTPS URL.
     */
...
export interface TopicRuleErrorActionTimestream {
     ...
     */
    dimensions: pulumi.Input<pulumi.Input<inputs.iot.TopicRuleErrorActionTimestreamDimension>[]>;
    /**
     ...
     */
    timestamp?: pulumi.Input<inputs.iot.TopicRuleErrorActionTimestreamTimestamp>;
}
...
export interface TopicRuleHttp {
     ...
     * Custom HTTP header IoT Core should send. It is possible to define more than one custom header.
     */
    httpHeaders?: pulumi.Input<pulumi.Input<inputs.iot.TopicRuleHttpHttpHeader>[]>;
    /**
     * The HTTPS URL.
     */
    url: pulumi.Input<string>;
