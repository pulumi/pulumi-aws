...
export interface ScheduleTarget {
     ...
     */
    deadLetterConfig?: pulumi.Input<inputs.scheduler.ScheduleTargetDeadLetterConfig>;
    /**
     ...
     */
    ecsParameters?: pulumi.Input<inputs.scheduler.ScheduleTargetEcsParameters>;
    /**
     ...
     */
    eventbridgeParameters?: pulumi.Input<inputs.scheduler.ScheduleTargetEventbridgeParameters>;
    /**
     ...
     */
    kinesisParameters?: pulumi.Input<inputs.scheduler.ScheduleTargetKinesisParameters>;
    /**
     * Information about the retry policy settings. Detailed below.
     */
    retryPolicy?: pulumi.Input<inputs.scheduler.ScheduleTargetRetryPolicy>;
    /**
     ...
     */
    sqsParameters?: pulumi.Input<inputs.scheduler.ScheduleTargetSqsParameters>;
}
...
export interface ScheduleTargetEcsParameters {
     ...
     */
    capacityProviderStrategies?: pulumi.Input<pulumi.Input<inputs.scheduler.ScheduleTargetEcsParametersCapacityProviderStrategy>[]>;
    /**
     ...
     */
    networkConfiguration?: pulumi.Input<inputs.scheduler.ScheduleTargetEcsParametersNetworkConfiguration>;
    /**
     * A set of up to 10 placement constraints to use for the task. Detailed below.
     */
    placementConstraints?: pulumi.Input<pulumi.Input<inputs.scheduler.ScheduleTargetEcsParametersPlacementConstraint>[]>;
    /**
     * A set of up to 5 placement strategies. Detailed below.
     */
    placementStrategies?: pulumi.Input<pulumi.Input<inputs.scheduler.ScheduleTargetEcsParametersPlacementStrategy>[]>;
    /**
