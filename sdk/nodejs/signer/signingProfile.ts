...
export class SigningProfile extends pulumi.CustomResource {
     ...
     */
    public readonly signingParameters!: pulumi.Output<{[key: string]: string} | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SigningProfileArgs | SigningProfileState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["signingParameters"] = state ? state.signingParameters : undefined;
            ...
            resourceInputs["signingParameters"] = args ? args.signingParameters : undefined;
