 ...
 *
 * const testSp = new aws.signer/signingProfile.SigningProfile("testSp", {platformId: "AWSLambda-SHA384-ECDSA"});
 * const prodSp = new aws.signer/signingProfile.SigningProfile("prodSp", {
 *     namePrefix: "prod_sp_",
