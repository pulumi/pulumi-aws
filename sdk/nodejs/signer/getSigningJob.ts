...
export interface GetSigningJobResult {
     ...
     */
    readonly revocationRecords: outputs.GetSigningJobRevocationRecord[];
    /**
     ...
     */
    readonly signedObjects: outputs.GetSigningJobSignedObject[];
    /**
     * Object that contains the name of your S3 bucket or your raw code.
     */
    readonly sources: outputs.GetSigningJobSource[];
    /**
