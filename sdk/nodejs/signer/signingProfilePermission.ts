 ...
 *     },
 * });
 * const spPermission1 = new aws.signer/signingProfilePermission.SigningProfilePermission("spPermission1", {
 *     profileName: prodSp.name,
 *     action: "signer:StartSigningJob",
 *     principal: _var.aws_account,
 * });
 * const spPermission2 = new aws.signer/signingProfilePermission.SigningProfilePermission("spPermission2", {
 *     profileName: prodSp.name,
 *     action: "signer:GetSigningProfile",
 *     principal: _var.aws_team_role_arn,
 *     statementId: "ProdAccountStartSigningJob_StatementId",
 * });
 * const spPermission3 = new aws.signer/signingProfilePermission.SigningProfilePermission("spPermission3", {
 *     profileName: prodSp.name,
