...
export class Directory extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DirectoryState): Directory {
        return new Directory(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: DirectoryArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DirectoryArgs | DirectoryState, opts?: pulumi.ResourceOptions) {
