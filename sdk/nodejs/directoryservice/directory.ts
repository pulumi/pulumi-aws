...
export class Directory extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<DirectoryState>, opts?: pulumi.CustomResourceOptions): Directory {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<DirectoryArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<DirectoryArgs> | pulumi.WrappedObject<DirectoryState>, opts?: pulumi.CustomResourceOptions) {
