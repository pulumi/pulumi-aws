 ...
 *     vpcId: aws_vpc_main.id,
 * });
 * const aws_directory_service_directory_bar = new aws.directoryservice.Directory("bar", {
 ...
 *     vpcId: aws_vpc_main.id,
 * });
 * const aws_directory_service_directory_connector = new aws.directoryservice.Directory("connector", {
 *     connectSettings: {
