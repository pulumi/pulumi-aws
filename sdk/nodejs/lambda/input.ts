...
export interface EventSourceMappingDestinationConfig {
     ...
     */
    onFailure?: pulumi.Input<inputs.EventSourceMappingDestinationConfigOnFailure>;
}
...
export interface EventSourceMappingDocumentDbEventSourceConfig {
     ...
     */
    fullDocument?: pulumi.Input<string>;
}
export interface EventSourceMappingFilterCriteria {
    /**
     * A set of up to 5 filter. If an event satisfies at least one, Lambda sends the event to the function or adds it to the next batch. Detailed below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.EventSourceMappingFilterCriteriaFilter>[]>;
}
...
export interface FunctionEventInvokeConfigDestinationConfig {
     ...
     */
    onFailure?: pulumi.Input<inputs.FunctionEventInvokeConfigDestinationConfigOnFailure>;
    /**
     * Configuration block with destination configuration for successful asynchronous invocations. See below for details.
     */
    onSuccess?: pulumi.Input<inputs.FunctionEventInvokeConfigDestinationConfigOnSuccess>;
}
