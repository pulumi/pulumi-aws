...
export class LayerVersion extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<LayerVersionState>, opts?: pulumi.CustomResourceOptions): LayerVersion {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<LayerVersionArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<LayerVersionArgs> | pulumi.WrappedObject<LayerVersionState>, opts?: pulumi.CustomResourceOptions) {
