...
export class Permission extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<PermissionState>, opts?: pulumi.CustomResourceOptions): Permission {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<PermissionArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<PermissionArgs> | pulumi.WrappedObject<PermissionState>, opts?: pulumi.CustomResourceOptions) {
