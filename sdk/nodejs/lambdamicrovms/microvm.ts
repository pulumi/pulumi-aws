 ...
 * ```
 */
export class Microvm extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MicrovmState, opts?: pulumi.CustomResourceOptions): Microvm {
        return new Microvm(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:lambdamicrovms/microvm:Microvm';

    /**
     * Returns true if the given object is an instance of Microvm.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is Microvm {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === Microvm.__pulumiType;
    }
     ...
     */
    declare public readonly idlePolicy: pulumi.Output<outputs.lambdamicrovms.MicrovmIdlePolicy | undefined>;
    /**
     ...
     */
    declare public readonly logging: pulumi.Output<outputs.lambdamicrovms.MicrovmLogging | undefined>;
    /**
    ...
    declare public readonly timeouts: pulumi.Output<outputs.lambdamicrovms.MicrovmTimeouts | undefined>;
     ...
     */
    constructor(name: string, args: MicrovmArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: MicrovmArgs | MicrovmState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as MicrovmState | undefined;
            ...
            const args = argsOrState as MicrovmArgs | undefined;
        ...
        super(Microvm.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface MicrovmState {
     ...
     * Configuration controlling automatic suspend and resume behavior. See below. Changing this value creates a new resource.
     */
    idlePolicy?: pulumi.Input<inputs.lambdamicrovms.MicrovmIdlePolicy | undefined>;
    /**
     * ARN of the MicroVM image to run. Changing this value creates a new resource.
     *
     * The following arguments are optional:
     ...
     * Logging configuration for the MicroVM. See below. Changing this value creates a new resource.
     */
    logging?: pulumi.Input<inputs.lambdamicrovms.MicrovmLogging | undefined>;
    /**
     * Maximum duration in seconds that the MicroVM can exist before the platform terminates it. Valid range: `1`–`28800` (8 hours). Changing this value creates a new resource.
     */
    ...
    timeouts?: pulumi.Input<inputs.lambdamicrovms.MicrovmTimeouts | undefined>;
}
