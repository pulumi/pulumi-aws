...
export class CatalogTable extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<CatalogTableState>, opts?: pulumi.CustomResourceOptions): CatalogTable {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<CatalogTableArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<CatalogTableArgs> | pulumi.WrappedObject<CatalogTableState>, opts?: pulumi.CustomResourceOptions) {
