...
export class CatalogTable extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: pulumi.InputObject<CatalogTableArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.InputObject<CatalogTableArgs> | pulumi.InputObject<CatalogTableState>, opts?: pulumi.CustomResourceOptions) {
