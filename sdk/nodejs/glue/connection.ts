...
export class Connection extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ConnectionState>, opts?: pulumi.CustomResourceOptions): Connection {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ConnectionArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ConnectionArgs> | pulumi.WrappedObject<ConnectionState>, opts?: pulumi.CustomResourceOptions) {
