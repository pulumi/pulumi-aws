...
export class CatalogDatabase extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CatalogDatabaseState): CatalogDatabase {
        return new CatalogDatabase(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: CatalogDatabaseArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: CatalogDatabaseArgs | CatalogDatabaseState, opts?: pulumi.ResourceOptions) {
