 ...
 *
 * const example = new aws.glue/catalogDatabase.CatalogDatabase("example", {name: "MyCatalogDatabase"});
 * ```
 ...
 * import * as aws from "@pulumi/aws";
 *
 * const example = new aws.glue/catalogDatabase.CatalogDatabase("example", {
