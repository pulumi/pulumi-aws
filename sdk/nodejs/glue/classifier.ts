...
export class Classifier extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClassifierState): Classifier {
        return new Classifier(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: ClassifierArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ClassifierArgs | ClassifierState, opts?: pulumi.ResourceOptions) {
