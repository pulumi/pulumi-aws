...
export class Crawler extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<CrawlerState>, opts?: pulumi.CustomResourceOptions): Crawler {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<CrawlerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<CrawlerArgs> | pulumi.WrappedObject<CrawlerState>, opts?: pulumi.CustomResourceOptions) {
