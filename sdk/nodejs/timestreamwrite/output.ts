...
export interface TableMagneticStoreWriteProperties {
     ...
     */
    magneticStoreRejectedDataLocation?: outputs.TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocation;
}
export interface TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocation {
    /**
     * Configuration of an S3 location to write error reports for records rejected, asynchronously, during magnetic store writes. See S3 Configuration below for more details.
     */
    s3Configuration?: outputs.TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationS3Configuration;
}
...
export interface TableSchema {
     ...
     */
    compositePartitionKey: outputs.TableSchemaCompositePartitionKey;
}
