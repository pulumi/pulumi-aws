...
export class ReplicationInstance extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ReplicationInstanceState>, opts?: pulumi.CustomResourceOptions): ReplicationInstance {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ReplicationInstanceArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ReplicationInstanceArgs> | pulumi.WrappedObject<ReplicationInstanceState>, opts?: pulumi.CustomResourceOptions) {
