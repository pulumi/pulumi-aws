...
export class ReplicationTask extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReplicationTaskState): ReplicationTask {
        return new ReplicationTask(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ReplicationTaskArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ReplicationTaskArgs | ReplicationTaskState, opts?: pulumi.ResourceOptions) {
