...
export interface GetDistributionConfigurationsArgs {
     ...
     */
    filters?: inputs.GetDistributionConfigurationsFilter[];
}
...
export interface GetDistributionConfigurationsResult {
    ...
    readonly filters?: inputs.GetDistributionConfigurationsFilter[];
    /**
...
export interface GetDistributionConfigurationsOutputArgs {
     ...
     * Configuration block(s) for filtering. Detailed below.
     */
    filters?: pulumi.Input<pulumi.Input<inputs.GetDistributionConfigurationsFilterArgs>[]>;
}
