...
export class Snapshot extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<SnapshotState>, opts?: pulumi.CustomResourceOptions): Snapshot {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<SnapshotArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<SnapshotArgs> | pulumi.WrappedObject<SnapshotState>, opts?: pulumi.CustomResourceOptions) {
