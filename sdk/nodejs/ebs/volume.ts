...
export class Volume extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<VolumeResult> {
        return ctx.list({...args, type: 'aws:ebs/volume:Volume'});
    }
