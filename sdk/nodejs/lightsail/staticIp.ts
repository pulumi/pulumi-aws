...
export class StaticIp extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<StaticIpState>, opts?: pulumi.CustomResourceOptions): StaticIp {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<StaticIpArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<StaticIpArgs> | pulumi.WrappedObject<StaticIpState>, opts?: pulumi.CustomResourceOptions) {
