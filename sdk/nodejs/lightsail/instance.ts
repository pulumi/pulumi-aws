...
export class Instance extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<InstanceState>, opts?: pulumi.CustomResourceOptions): Instance {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<InstanceArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<InstanceArgs> | pulumi.WrappedObject<InstanceState>, opts?: pulumi.CustomResourceOptions) {
