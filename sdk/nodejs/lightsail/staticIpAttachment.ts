...
export class StaticIpAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StaticIpAttachmentState): StaticIpAttachment {
        return new StaticIpAttachment(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: StaticIpAttachmentArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: StaticIpAttachmentArgs | StaticIpAttachmentState, opts?: pulumi.ResourceOptions) {
