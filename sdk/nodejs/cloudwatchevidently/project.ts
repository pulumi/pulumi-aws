 ...
 *
 * const example = new aws.cloudwatchevidently.Project("example", {
...
export class Project extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:cloudwatchevidently/project:Project';
     ...
     */
    public readonly dataDelivery!: pulumi.Output<outputs.cloudwatchevidently.ProjectDataDelivery | undefined>;
    /**
...
export interface ProjectState {
     ...
     * A block that contains information about where Evidently is to store evaluation events for longer term storage, if you choose to do so. If you choose not to store these events, Evidently deletes them after using them to produce metrics and other experiment results that you can view. See below.
     */
    dataDelivery?: pulumi.Input<inputs.cloudwatchevidently.ProjectDataDelivery>;
    /**
     * Specifies the description of the project.
     */
