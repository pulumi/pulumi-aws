...
export class AutoshiftObserverNotificationStatus extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AutoshiftObserverNotificationStatusState, opts?: pulumi.CustomResourceOptions): AutoshiftObserverNotificationStatus {
        return new AutoshiftObserverNotificationStatus(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:arczonalshift/autoshiftObserverNotificationStatus:AutoshiftObserverNotificationStatus';
    ...
    constructor(name: string, argsOrState?: AutoshiftObserverNotificationStatusArgs | AutoshiftObserverNotificationStatusState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as AutoshiftObserverNotificationStatusState | undefined;
            resourceInputs["region"] = state?.region;
            resourceInputs["status"] = state?.status;
        } else {
            const args = argsOrState as AutoshiftObserverNotificationStatusArgs | undefined;
