...
export class AggregateAuthorization extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AggregateAuthorizationState): AggregateAuthorization {
        return new AggregateAuthorization(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: AggregateAuthorizationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AggregateAuthorizationArgs | AggregateAuthorizationState, opts?: pulumi.ResourceOptions) {
