...
export class DeliveryChannel extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DeliveryChannelState): DeliveryChannel {
        return new DeliveryChannel(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: DeliveryChannelArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DeliveryChannelArgs | DeliveryChannelState, opts?: pulumi.ResourceOptions) {
