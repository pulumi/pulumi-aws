...
export class RecorderStatus extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RecorderStatusState): RecorderStatus {
        return new RecorderStatus(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: RecorderStatusArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: RecorderStatusArgs | RecorderStatusState, opts?: pulumi.ResourceOptions) {
