...
export class Recorder extends pulumi.CustomResource {
     ...
     */
    public readonly recordingGroup!: pulumi.Output<outputApi.cfg.RecorderRecordingGroup>;
    /**
...
export interface RecorderState {
     ...
     * Recording group - see below.
     */
    readonly recordingGroup?: pulumi.Input<inputApi.cfg.RecorderRecordingGroup>;
    /**
     * Amazon Resource Name (ARN) of the IAM role.
     * used to make read or write requests to the delivery channel and to describe the AWS resources associated with the account.
     * See [AWS Docs](http://docs.aws.amazon.com/config/latest/developerguide/iamrole-permissions.html) for more details.
