...
export class Recorder extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: RecorderArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: RecorderArgs | RecorderState, opts?: pulumi.ResourceOptions) {
