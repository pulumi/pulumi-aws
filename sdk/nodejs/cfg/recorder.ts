...
export class Recorder extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<RecorderState>, opts?: pulumi.CustomResourceOptions): Recorder {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<RecorderArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<RecorderArgs> | pulumi.WrappedObject<RecorderState>, opts?: pulumi.CustomResourceOptions) {
