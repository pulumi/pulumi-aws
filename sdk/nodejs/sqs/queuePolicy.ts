...
export class QueuePolicy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: QueuePolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: QueuePolicyArgs | QueuePolicyState, opts?: pulumi.ResourceOptions) {
