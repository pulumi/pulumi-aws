...
export class Environment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<EnvironmentState>, opts?: pulumi.CustomResourceOptions): Environment {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<EnvironmentArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<EnvironmentArgs> | pulumi.WrappedObject<EnvironmentState>, opts?: pulumi.CustomResourceOptions) {
