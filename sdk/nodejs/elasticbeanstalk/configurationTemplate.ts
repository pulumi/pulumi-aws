...
export class ConfigurationTemplate extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: ConfigurationTemplateArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ConfigurationTemplateArgs | ConfigurationTemplateState, opts?: pulumi.ResourceOptions) {
