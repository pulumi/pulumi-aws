...
export class SecretVersion extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<SecretVersionState>, opts?: pulumi.CustomResourceOptions): SecretVersion {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<SecretVersionArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<SecretVersionArgs> | pulumi.WrappedObject<SecretVersionState>, opts?: pulumi.CustomResourceOptions) {
