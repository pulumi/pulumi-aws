 ...
 * 
 * const aws_secretsmanager_secret_version_example = pulumi.output(aws.secretsmanager.getSecretVersion({
 *     secretId: aws_secretsmanager_secret_example.id.apply(__arg0 => __arg0%!v(PANIC=interface conversion: il.Node is nil, not *il.ResourceNode)),
 * }));
 * ```
 * 
 ...
 * import * as aws from "@pulumi/aws";
 * 
 * const aws_secretsmanager_secret_version_by_version_stage = pulumi.output(aws.secretsmanager.getSecretVersion({
 *     secretId: aws_secretsmanager_secret_example.id.apply(__arg0 => __arg0%!v(PANIC=interface conversion: il.Node is nil, not *il.ResourceNode)),
