 ...
 * 
 * const aws_secretsmanager_secret_example = new aws.secretsmanager.Secret("example", {
 *     name: "example",
 * });
 * ```
 * 
 ...
 * import * as aws from "@pulumi/aws";
 * 
 * const aws_secretsmanager_secret_rotation_example = new aws.secretsmanager.Secret("rotation-example", {
