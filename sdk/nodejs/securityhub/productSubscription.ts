...
export class ProductSubscription extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ProductSubscriptionState>, opts?: pulumi.CustomResourceOptions): ProductSubscription {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ProductSubscriptionArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ProductSubscriptionArgs> | pulumi.WrappedObject<ProductSubscriptionState>, opts?: pulumi.CustomResourceOptions) {
