...
export class StandardsSubscription extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<StandardsSubscriptionState>, opts?: pulumi.CustomResourceOptions): StandardsSubscription {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<StandardsSubscriptionArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<StandardsSubscriptionArgs> | pulumi.WrappedObject<StandardsSubscriptionState>, opts?: pulumi.CustomResourceOptions) {
