 ...
 * ```
 */
export class TelemetryEvaluation extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TelemetryEvaluationState, opts?: pulumi.CustomResourceOptions): TelemetryEvaluation {
        return new TelemetryEvaluation(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:observabilityadmin/telemetryEvaluation:TelemetryEvaluation';

    /**
     * Returns true if the given object is an instance of TelemetryEvaluation.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is TelemetryEvaluation {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === TelemetryEvaluation.__pulumiType;
    }
    ...
    declare public readonly timeouts: pulumi.Output<outputs.observabilityadmin.TelemetryEvaluationTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: TelemetryEvaluationArgs | TelemetryEvaluationState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as TelemetryEvaluationState | undefined;
            resourceInputs["failureReason"] = state?.failureReason;
            resourceInputs["region"] = state?.region;
            resourceInputs["status"] = state?.status;
            resourceInputs["timeouts"] = state?.timeouts;
        } else {
            const args = argsOrState as TelemetryEvaluationArgs | undefined;
        ...
        super(TelemetryEvaluation.__pulumiType, name, resourceInputs, opts);
    }
}
