...
export class Cluster extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly certificateAuthority!: pulumi.Output<outputApi.eks.ClusterCertificateAuthority>;
     ...
     */
    public readonly vpcConfig!: pulumi.Output<outputApi.eks.ClusterVpcConfig>;
...
export interface ClusterState {
     ...
     * Nested attribute containing `certificate-authority-data` for your cluster.
     */
    readonly certificateAuthority?: pulumi.Input<inputApi.eks.ClusterCertificateAuthority>;
     ...
     * Nested argument for the VPC associated with your cluster. Amazon EKS VPC resources have specific requirements to work properly with Kubernetes. For more information, see [Cluster VPC Considerations](https://docs.aws.amazon.com/eks/latest/userguide/network_reqs.html) and [Cluster Security Group Considerations](https://docs.aws.amazon.com/eks/latest/userguide/sec-group-reqs.html) in the Amazon EKS User Guide. Configuration detailed below.
     */
    readonly vpcConfig?: pulumi.Input<inputApi.eks.ClusterVpcConfig>;
}
