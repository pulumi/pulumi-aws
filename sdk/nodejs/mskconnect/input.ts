...
export interface ConnectorCapacity {
     ...
     */
    autoscaling?: pulumi.Input<inputs.ConnectorCapacityAutoscaling>;
    /**
     * Details about a fixed capacity allocated to a connector. See below.
     */
    provisionedCapacity?: pulumi.Input<inputs.ConnectorCapacityProvisionedCapacity>;
}
export interface ConnectorCapacityAutoscaling {
     ...
     */
    scaleInPolicy?: pulumi.Input<inputs.ConnectorCapacityAutoscalingScaleInPolicy>;
    /**
     * The scale-out policy for the connector. See below.
     */
    scaleOutPolicy?: pulumi.Input<inputs.ConnectorCapacityAutoscalingScaleOutPolicy>;
}
...
export interface ConnectorKafkaCluster {
     ...
     */
    apacheKafkaCluster: pulumi.Input<inputs.ConnectorKafkaClusterApacheKafkaCluster>;
}
export interface ConnectorKafkaClusterApacheKafkaCluster {
     ...
     */
    vpc: pulumi.Input<inputs.ConnectorKafkaClusterApacheKafkaClusterVpc>;
}
...
export interface ConnectorLogDelivery {
     ...
     */
    workerLogDelivery: pulumi.Input<inputs.ConnectorLogDeliveryWorkerLogDelivery>;
}
export interface ConnectorLogDeliveryWorkerLogDelivery {
    /**
     * Details about delivering logs to Amazon CloudWatch Logs. See below.
     */
    cloudwatchLogs?: pulumi.Input<inputs.ConnectorLogDeliveryWorkerLogDeliveryCloudwatchLogs>;
    /**
     * Details about delivering logs to Amazon Kinesis Data Firehose. See below.
     */
    firehose?: pulumi.Input<inputs.ConnectorLogDeliveryWorkerLogDeliveryFirehose>;
    /**
     * Details about delivering logs to Amazon S3. See below.
     */
    s3?: pulumi.Input<inputs.ConnectorLogDeliveryWorkerLogDeliveryS3>;
}
...
export interface ConnectorPlugin {
     ...
     */
    customPlugin: pulumi.Input<inputs.ConnectorPluginCustomPlugin>;
}
...
export interface CustomPluginLocation {
     ...
     */
    s3: pulumi.Input<inputs.CustomPluginLocationS3>;
}
