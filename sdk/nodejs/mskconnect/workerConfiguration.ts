 ...
 *
 * const example = new aws.mskconnect/workerConfiguration.WorkerConfiguration("example", {propertiesFileContent: `key.converter=org.apache.kafka.connect.storage.StringConverter
