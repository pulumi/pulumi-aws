 ...
 *
 * const exampleDomain = new aws.customerprofiles/domain.Domain("exampleDomain", {domainName: "example"});
 * const exampleProfile = new aws.customerprofiles/profile.Profile("exampleProfile", {domainName: exampleDomain.domainName});
 * ```
 *
 * ## Import
 *
