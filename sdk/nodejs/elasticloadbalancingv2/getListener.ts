 ...
 * 
 * const selected = pulumi.output(aws.elbv2.getLoadBalancer({
 *     name: "default-public",
 * }));
 * const listener = pulumi.output(aws.elbv2.getListener({
 *     arn: listenerArn,
 * }));
 * const selected443 = selected.apply(selected => aws.elbv2.getListener({
