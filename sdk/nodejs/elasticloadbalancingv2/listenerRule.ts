...
export class ListenerRule extends pulumi.CustomResource {
     ...
     */
    public readonly actions!: pulumi.Output<outputApi.elasticloadbalancingv2.ListenerRuleAction[]>;
    /**
     ...
     */
    public readonly conditions!: pulumi.Output<outputApi.elasticloadbalancingv2.ListenerRuleCondition[]>;
    /**
...
export interface ListenerRuleState {
     ...
     * An Action block. Action blocks are documented below.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputApi.elasticloadbalancingv2.ListenerRuleAction>[]>;
    /**
     * The ARN of the rule (matches `id`)
     */
     ...
     * A Condition block. Condition blocks are documented below.
     */
    readonly conditions?: pulumi.Input<pulumi.Input<inputApi.elasticloadbalancingv2.ListenerRuleCondition>[]>;
    /**
     * The ARN of the listener to which to attach the rule.
     */
