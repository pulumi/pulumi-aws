 ...
 * });
 * const test = new aws.elbv2.TargetGroup("test", {
 *     port: 80,
 *     protocol: "HTTP",
 *     vpcId: main.id,
 * });
 ...
 *     cidrBlock: "10.0.0.0/16",
 * });
 * const ip_example = new aws.elbv2.TargetGroup("ip-example", {
 *     port: 80,
 *     protocol: "HTTP",
 *     targetType: "ip",
 *     vpcId: main.id,
 ...
 * import * as aws from "@pulumi/aws";
 * 
 * const lambda_example = new aws.elbv2.TargetGroup("lambda-example", {
 *     targetType: "lambda",
 * });
 * ```
 *
