...
export class TargetGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TargetGroupState): TargetGroup {
        return new TargetGroup(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: TargetGroupArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TargetGroupArgs | TargetGroupState, opts?: pulumi.ResourceOptions) {
