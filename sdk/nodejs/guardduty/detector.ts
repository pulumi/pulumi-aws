...
export class Detector extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<DetectorState>, opts?: pulumi.CustomResourceOptions): Detector {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<DetectorArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<DetectorArgs> | pulumi.WrappedObject<DetectorState>, opts?: pulumi.CustomResourceOptions) {
