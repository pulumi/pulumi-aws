...
export class Group extends pulumi.CustomResource {
     ...
     */
    public readonly initialLifecycleHooks!: pulumi.Output<outputs.GroupInitialLifecycleHook[] | undefined>;
    /**
     * If this block is configured, add a instance maintenance policy to the specified Auto Scaling group. Defined below.
     */
    public readonly instanceMaintenancePolicy!: pulumi.Output<outputs.GroupInstanceMaintenancePolicy | undefined>;
    /**
     * If this block is configured, start an
     * [Instance Refresh](https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-instance-refresh.html)
     * when this Auto Scaling Group is updated. Defined below.
     */
    public readonly instanceRefresh!: pulumi.Output<outputs.GroupInstanceRefresh | undefined>;
    /**
     ...
     */
    public readonly launchTemplate!: pulumi.Output<outputs.GroupLaunchTemplate>;
    /**
     ...
     */
    public readonly mixedInstancesPolicy!: pulumi.Output<outputs.GroupMixedInstancesPolicy>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputs.GroupTag[] | undefined>;
    /**
     ...
     */
    public readonly trafficSources!: pulumi.Output<outputs.GroupTrafficSource[]>;
    /**
     ...
     */
    public readonly warmPool!: pulumi.Output<outputs.GroupWarmPool | undefined>;
    /**
...
export interface GroupState {
     ...
     * a new Auto Scaling Group. For all other use-cases, please use `aws.autoscaling.LifecycleHook` resource.
     */
    initialLifecycleHooks?: pulumi.Input<pulumi.Input<inputs.GroupInitialLifecycleHook>[]>;
    /**
     * If this block is configured, add a instance maintenance policy to the specified Auto Scaling group. Defined below.
     */
    instanceMaintenancePolicy?: pulumi.Input<inputs.GroupInstanceMaintenancePolicy>;
    /**
     * If this block is configured, start an
     * [Instance Refresh](https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-instance-refresh.html)
     * when this Auto Scaling Group is updated. Defined below.
     */
    instanceRefresh?: pulumi.Input<inputs.GroupInstanceRefresh>;
    /**
     * Name of the launch configuration to use.
     */
     ...
     * Nested argument with Launch template specification to use to launch instances. See Launch Template below for more details.
     */
    launchTemplate?: pulumi.Input<inputs.GroupLaunchTemplate>;
    /**
     * List of elastic load balancer names to add to the autoscaling
     * group names. Only valid for classic load balancers. For ALBs, use `targetGroupArns` instead. To remove all load balancer attachments an empty list should be specified.
     */
     ...
     * Granularity to associate with the metrics to collect. The only valid value is `1Minute`. Default is `1Minute`.
     */
    metricsGranularity?: pulumi.Input<string | enums.MetricsGranularity>;
    /**
     * Setting this causes Pulumi to wait for
     * this number of instances from this Auto Scaling Group to show up healthy in the
     * ELB only on creation. Updates will not wait on ELB instance number changes.
     ...
     * Configuration block containing settings to define launch targets for Auto Scaling groups. See Mixed Instances Policy below for more details.
     */
    mixedInstancesPolicy?: pulumi.Input<inputs.GroupMixedInstancesPolicy>;
    /**
     * Name of the Auto Scaling Group. By default generated by Pulumi. Conflicts with `namePrefix`.
     */
     ...
     * Configuration block(s) containing resource tags. See Tag below for more details.
     */
    tags?: pulumi.Input<pulumi.Input<inputs.GroupTag>[]>;
    /**
     * Set of `aws.alb.TargetGroup` ARNs, for use with Application or Network Load Balancing. To remove all target group attachments an empty list should be specified.
     */
     ...
     * Attaches one or more traffic sources to the specified Auto Scaling group.
     */
    trafficSources?: pulumi.Input<pulumi.Input<inputs.GroupTrafficSource>[]>;
    /**
     * List of subnet IDs to launch resources in. Subnets automatically determine which availability zones the group will reside. Conflicts with `availabilityZones`.
     */
     ...
     * to the specified Auto Scaling group. Defined below
     */
    warmPool?: pulumi.Input<inputs.GroupWarmPool>;
    /**
     * Current size of the warm pool.
     */
