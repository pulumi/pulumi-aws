...
export class Group extends pulumi.CustomResource {
     ...
     */
    public readonly initialLifecycleHooks!: pulumi.Output<outputApi.autoscaling.GroupInitialLifecycleHook[] | undefined>;
    /**
     ...
     */
    public readonly launchTemplate!: pulumi.Output<outputApi.autoscaling.GroupLaunchTemplate | undefined>;
    /**
     ...
     */
    public readonly mixedInstancesPolicy!: pulumi.Output<outputApi.autoscaling.GroupMixedInstancesPolicy | undefined>;
    /**
     ...
     */
    public readonly tags!: pulumi.Output<outputApi.autoscaling.GroupTag[] | undefined>;
    /**
...
export interface GroupState {
     ...
     * a new autoscaling group. For all other use-cases, please use `aws.autoscaling.LifecycleHook` resource.
     */
    readonly initialLifecycleHooks?: pulumi.Input<pulumi.Input<inputApi.autoscaling.GroupInitialLifecycleHook>[]>;
    /**
     * The name of the launch configuration to use.
     */
     ...
     * Nested argument containing launch template settings along with the overrides to specify multiple instance types. Defined below.
     */
    readonly launchTemplate?: pulumi.Input<inputApi.autoscaling.GroupLaunchTemplate>;
    /**
     * A list of elastic load balancer names to add to the autoscaling
     * group names. Only valid for classic load balancers. For ALBs, use `targetGroupArns` instead.
     */
     ...
     * Configuration block containing settings to define launch targets for Auto Scaling groups. Defined below.
     */
    readonly mixedInstancesPolicy?: pulumi.Input<inputApi.autoscaling.GroupMixedInstancesPolicy>;
    /**
     * The name of the auto scaling group. By default generated by this provider.
     */
     ...
     * A list of tag blocks. Tags documented below.
     */
    readonly tags?: pulumi.Input<pulumi.Input<inputApi.autoscaling.GroupTag>[]>;
    /**
     * A list of tag blocks (maps). Tags documented below.
     */
