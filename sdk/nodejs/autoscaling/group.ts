 ...
 * 
 * const aws_placement_group_test = new aws.ec2.PlacementGroup("test", {
 *     name: "test",
 *     strategy: "cluster",
 * });
 ...
 *     placementGroup: aws_placement_group_test.id,
 *     tags: [
 *         {
 *             key: "foo",
 ...
 * import * as aws from "@pulumi/aws";
 * 
 * const aws_launch_template_example = new aws.ec2.LaunchTemplate("example", {
 *     imageId: aws_ami_example.id.apply(__arg0 => __arg0%!v(PANIC=interface conversion: il.Node is nil, not *il.ResourceNode)),
 *     instanceType: "c5.large",
 *     namePrefix: "example",
 * });
 * const aws_autoscaling_group_example = new aws.autoscaling.Group("example", {
 *     availabilityZones: ["us-east-1a"],
 *     desiredCapacity: 1,
 *     maxSize: 1,
 *     minSize: 1,
 ...
 * const var_extra_tags = config.get("extraTags") || [
 *     {
 *         key: "Foo",
 *         propagateAtLaunch: true,
 *         value: "Bar",
 ...
 *             value: "value2",
 *         },...
 *         [{"key": "interpolation1", "value": "value3", "propagate_at_launch": true}, {"key": "interpolation2", "value": "value4", "propagate_at_launch": true}].concat(var_extra_tags),
 *     ],
 *     vpcZoneIdentifiers: [
 *         aws_subnet_example1.id,
 *         aws_subnet_example2.id,
