...
export class Notification extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<NotificationState>, opts?: pulumi.CustomResourceOptions): Notification {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<NotificationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<NotificationArgs> | pulumi.WrappedObject<NotificationState>, opts?: pulumi.CustomResourceOptions) {
