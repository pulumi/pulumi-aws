...
export class PrincipalAssociation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<PrincipalAssociationState>, opts?: pulumi.CustomResourceOptions): PrincipalAssociation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<PrincipalAssociationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<PrincipalAssociationArgs> | pulumi.WrappedObject<PrincipalAssociationState>, opts?: pulumi.CustomResourceOptions) {
