 ...
 *
 * const example = new aws.codedeploy/application.Application("example", {computePlatform: "ECS"});
 * ```
 * ### Lambda Application
 *
 * ```typescript
 ...
 * import * as aws from "@pulumi/aws";
 *
 * const example = new aws.codedeploy/application.Application("example", {computePlatform: "Lambda"});
 * ```
 * ### Server Application
 *
 * ```typescript
 ...
 * import * as aws from "@pulumi/aws";
 *
 * const example = new aws.codedeploy/application.Application("example", {computePlatform: "Server"});
 * ```
 *
 * ## Import
 *
