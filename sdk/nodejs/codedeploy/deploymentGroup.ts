...
export class DeploymentGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<DeploymentGroupState>, opts?: pulumi.CustomResourceOptions): DeploymentGroup {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<DeploymentGroupArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<DeploymentGroupArgs> | pulumi.WrappedObject<DeploymentGroupState>, opts?: pulumi.CustomResourceOptions) {
