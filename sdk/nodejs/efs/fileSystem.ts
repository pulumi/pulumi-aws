...
export class FileSystem extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FileSystemState): FileSystem {
        return new FileSystem(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: FileSystemArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: FileSystemArgs | FileSystemState, opts?: pulumi.ResourceOptions) {
