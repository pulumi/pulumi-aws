...
export class FileSystem extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<FileSystemState>, opts?: pulumi.CustomResourceOptions): FileSystem {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<FileSystemArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<FileSystemArgs> | pulumi.WrappedObject<FileSystemState>, opts?: pulumi.CustomResourceOptions) {
