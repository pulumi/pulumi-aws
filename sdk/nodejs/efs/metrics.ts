 ...
 */
export function metricBurstCreditBalance(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricClientConnections(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricDataReadIOBytes(change: cloudwatch.MetricChange = {}) {
 ...
 *  2. "Count" for SampleCount.
 */
export function metricDataWriteIOBytes(change: cloudwatch.MetricChange = {}) {
 ...
 *  2. "Count" for SampleCount.
 */
export function metricMetadataIOBytes(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricPercentIOLimit(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricPermittedThroughput(change: cloudwatch.MetricChange = {}) {
 ...
 *  2. "Count" for SampleCount.
 */
export function metricTotalIOBytes(change: cloudwatch.MetricChange = {}) {
