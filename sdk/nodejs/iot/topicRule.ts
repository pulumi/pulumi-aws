...
export class TopicRule extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<TopicRuleState>, opts?: pulumi.CustomResourceOptions): TopicRule {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<TopicRuleArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<TopicRuleArgs> | pulumi.WrappedObject<TopicRuleState>, opts?: pulumi.CustomResourceOptions) {
