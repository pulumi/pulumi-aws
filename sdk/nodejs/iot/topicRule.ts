...
export class TopicRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TopicRuleState): TopicRule {
        return new TopicRule(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: TopicRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TopicRuleArgs | TopicRuleState, opts?: pulumi.ResourceOptions) {
