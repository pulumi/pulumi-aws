...
export class ThingType extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ThingTypeState>, opts?: pulumi.CustomResourceOptions): ThingType {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<ThingTypeArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ThingTypeArgs> | pulumi.WrappedObject<ThingTypeState>, opts?: pulumi.CustomResourceOptions) {
