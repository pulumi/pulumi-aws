...
export class ThingType extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: ThingTypeArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ThingTypeArgs | ThingTypeState, opts?: pulumi.ResourceOptions) {
