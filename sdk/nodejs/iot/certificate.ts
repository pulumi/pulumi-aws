...
export class Certificate extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<CertificateState>, opts?: pulumi.CustomResourceOptions): Certificate {
    ...
    constructor(name: string, argsOrState?: pulumi.WrappedObject<CertificateArgs> | pulumi.WrappedObject<CertificateState>, opts?: pulumi.CustomResourceOptions) {
