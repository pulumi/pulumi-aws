...
export class ThingPrincipalAttachment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ThingPrincipalAttachmentState>, opts?: pulumi.CustomResourceOptions): ThingPrincipalAttachment {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ThingPrincipalAttachmentArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ThingPrincipalAttachmentArgs> | pulumi.WrappedObject<ThingPrincipalAttachmentState>, opts?: pulumi.CustomResourceOptions) {
