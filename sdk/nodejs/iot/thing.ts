...
export class Thing extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ThingState): Thing {
        return new Thing(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: ThingArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ThingArgs | ThingState, opts?: pulumi.ResourceOptions) {
