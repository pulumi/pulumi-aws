...
export class RoleAlias extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<RoleAliasState>, opts?: pulumi.CustomResourceOptions): RoleAlias {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<RoleAliasArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<RoleAliasArgs> | pulumi.WrappedObject<RoleAliasState>, opts?: pulumi.CustomResourceOptions) {
