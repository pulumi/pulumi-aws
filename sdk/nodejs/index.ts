...
export {acm, acmpca, apigateway, appautoscaling, applicationloadbalancing, appsync, athena, autoscaling, batch, budgets, cfg, cloud9, cloudformation, cloudfront, cloudhsmv2, cloudtrail, cloudwatch, codebuild, codecommit, codedeploy, codepipeline, cognito, config, dax, devicefarm, directconnect, directoryservice, dms, dynamodb, ebs, ec2, ec2transitgateway, ecr, ecs, efs, eks, elasticache, elasticbeanstalk, elasticloadbalancing, elasticloadbalancingv2, elasticsearch, elastictranscoder, emr, glacier, glue, iam, inspector, iot, kinesis, kms, lambda, lightsail, macie, mediastore, mq, neptune, opsworks, organizations, pinpoint, pricing, rds, redshift, route53, s3, secretsmanager, serverless, servicecatalog, servicediscovery, ses, sfn, simpledb, sns, sqs, ssm, storagegateway, swf, waf, wafregional, workspaces};
