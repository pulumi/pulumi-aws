...
export {accessanalyzer, acm, acmpca, alb, apigateway, apigatewayv2, appautoscaling, applicationloadbalancing, appmesh, appsync, athena, autoscaling, autoscalingplans, backup, batch, budgets, cfg, cloud9, cloudformation, cloudfront, cloudhsmv2, cloudtrail, cloudwatch, codeartifact, codebuild, codecommit, codedeploy, codepipeline, codestarnotifications, cognito, config, cur, datapipeline, datasync, dax, devicefarm, directconnect, directoryservice, dlm, dms, docdb, dynamodb, ebs, ec2, ec2clientvpn, ec2transitgateway, ecr, ecs, efs, eks, elasticache, elasticbeanstalk, elasticloadbalancing, elasticloadbalancingv2, elasticsearch, elastictranscoder, elb, emr, fms, fsx, gamelift, glacier, globalaccelerator, glue, guardduty, iam, inspector, iot, kinesis, kinesisanalyticsv2, kms, lambda, lb, lex, licensemanager, lightsail, macie, mediaconvert, mediapackage, mediastore, mq, msk, neptune, opsworks, organizations, outposts, pinpoint, pricing, qldb, quicksight, ram, rds, redshift, resourcegroups, route53, s3, s3control, s3outposts, sagemaker, secretsmanager, securityhub, serverless, servicecatalog, servicediscovery, servicequotas, ses, sfn, shield, simpledb, sns, sqs, ssm, storagegateway, swf, transfer, types, waf, wafregional, wafv2, worklink, workspaces, xray};
