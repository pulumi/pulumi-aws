...
export class ClientCertificate extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ClientCertificateState>, opts?: pulumi.CustomResourceOptions): ClientCertificate {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<ClientCertificateArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ClientCertificateArgs> | pulumi.WrappedObject<ClientCertificateState>, opts?: pulumi.CustomResourceOptions) {
