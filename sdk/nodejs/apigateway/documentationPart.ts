...
export class DocumentationPart extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DocumentationPartState): DocumentationPart {
        return new DocumentationPart(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: DocumentationPartArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DocumentationPartArgs | DocumentationPartState, opts?: pulumi.ResourceOptions) {
