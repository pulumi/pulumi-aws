...
export class Integration extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<IntegrationState>, opts?: pulumi.CustomResourceOptions): Integration {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<IntegrationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<IntegrationArgs> | pulumi.WrappedObject<IntegrationState>, opts?: pulumi.CustomResourceOptions) {
