...
export class DomainName extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<DomainNameState>, opts?: pulumi.CustomResourceOptions): DomainName {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<DomainNameArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<DomainNameArgs> | pulumi.WrappedObject<DomainNameState>, opts?: pulumi.CustomResourceOptions) {
