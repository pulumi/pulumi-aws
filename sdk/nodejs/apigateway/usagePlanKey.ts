...
export class UsagePlanKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UsagePlanKeyState): UsagePlanKey {
        return new UsagePlanKey(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: UsagePlanKeyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UsagePlanKeyArgs | UsagePlanKeyState, opts?: pulumi.ResourceOptions) {
