...
export class UsagePlanKey extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<UsagePlanKeyState>, opts?: pulumi.CustomResourceOptions): UsagePlanKey {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<UsagePlanKeyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<UsagePlanKeyArgs> | pulumi.WrappedObject<UsagePlanKeyState>, opts?: pulumi.CustomResourceOptions) {
