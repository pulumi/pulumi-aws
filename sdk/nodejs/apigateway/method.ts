...
export class Method extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MethodState): Method {
        return new Method(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: MethodArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: MethodArgs | MethodState, opts?: pulumi.ResourceOptions) {
