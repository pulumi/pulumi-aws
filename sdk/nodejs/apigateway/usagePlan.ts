...
export class UsagePlan extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UsagePlanState): UsagePlan {
        return new UsagePlan(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: UsagePlanArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UsagePlanArgs | UsagePlanState, opts?: pulumi.ResourceOptions) {
