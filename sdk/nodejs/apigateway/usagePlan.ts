...
export class UsagePlan extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<UsagePlanState>, opts?: pulumi.CustomResourceOptions): UsagePlan {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<UsagePlanArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<UsagePlanArgs> | pulumi.WrappedObject<UsagePlanState>, opts?: pulumi.CustomResourceOptions) {
