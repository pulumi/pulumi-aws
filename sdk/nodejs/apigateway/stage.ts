...
export class Stage extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<StageState>, opts?: pulumi.CustomResourceOptions): Stage {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<StageArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<StageArgs> | pulumi.WrappedObject<StageState>, opts?: pulumi.CustomResourceOptions) {
...
export interface StageState {
     ...
     * Enables access logs for the API stage. Detailed below.
     */
    readonly accessLogSettings?: { destinationArn: string, format: string };
    /**
     * Specifies whether a cache cluster is enabled for the stage
     */
