...
export class Authorizer extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: AuthorizerArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AuthorizerArgs | AuthorizerState, opts?: pulumi.ResourceOptions) {
