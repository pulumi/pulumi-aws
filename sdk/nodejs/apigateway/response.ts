...
export class Response extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResponseState): Response {
        return new Response(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ResponseArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ResponseArgs | ResponseState, opts?: pulumi.ResourceOptions) {
