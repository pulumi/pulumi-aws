...
export class MethodSettings extends pulumi.CustomResource {
     ...
     */
    public readonly settings!: pulumi.Output<outputApi.apigateway.MethodSettingsSettings>;
    /**
...
export interface MethodSettingsState {
     ...
     * The settings block, see below.
     */
    readonly settings?: pulumi.Input<inputApi.apigateway.MethodSettingsSettings>;
    /**
     * The name of the stage
     */
