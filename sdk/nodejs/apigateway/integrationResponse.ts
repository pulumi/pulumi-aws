...
export class IntegrationResponse extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: IntegrationResponseArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: IntegrationResponseArgs | IntegrationResponseState, opts?: pulumi.ResourceOptions) {
