...
export class BasePathMapping extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BasePathMappingState): BasePathMapping {
        return new BasePathMapping(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: BasePathMappingArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: BasePathMappingArgs | BasePathMappingState, opts?: pulumi.ResourceOptions) {
