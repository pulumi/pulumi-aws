...
export class RestApi extends pulumi.CustomResource {
     ...
     */
    public readonly endpointConfiguration!: pulumi.Output<outputApi.apigateway.RestApiEndpointConfiguration>;
    /**
...
export interface RestApiState {
     ...
     * Nested argument defining API endpoint configuration including endpoint type. Defined below.
     */
    readonly endpointConfiguration?: pulumi.Input<inputApi.apigateway.RestApiEndpointConfiguration>;
    /**
     * The execution ARN part to be used in [`lambdaPermission`](https://www.terraform.io/docs/providers/aws/r/lambda_permission.html)'s `sourceArn`
     * when allowing API Gateway to invoke a Lambda function,
     * e.g. `arn:aws:execute-api:eu-west-2:123456789012:z4675bid1j`, which can be concatenated with allowed stage, method and resource path.
