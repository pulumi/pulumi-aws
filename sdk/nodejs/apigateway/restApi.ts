...
export class RestApi extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<RestApiState>, opts?: pulumi.CustomResourceOptions): RestApi {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<RestApiArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<RestApiArgs> | pulumi.WrappedObject<RestApiState>, opts?: pulumi.CustomResourceOptions) {
