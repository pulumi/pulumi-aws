 ...
 *
 * const main = new aws.route53/delegationSet.DelegationSet("main", {referenceName: "DynDNS"});
 * const primary = new aws.route53/zone.Zone("primary", {delegationSetId: main.id});
 * const secondary = new aws.route53/zone.Zone("secondary", {delegationSetId: main.id});
 * ```
 *
 * ## Import
 *
