...
export class DelegationSet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<DelegationSetState>, opts?: pulumi.CustomResourceOptions): DelegationSet {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<DelegationSetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<DelegationSetArgs> | pulumi.WrappedObject<DelegationSetState>, opts?: pulumi.CustomResourceOptions) {
