...
export class Record extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<RecordState>, opts?: pulumi.CustomResourceOptions): Record {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<RecordArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<RecordArgs> | pulumi.WrappedObject<RecordState>, opts?: pulumi.CustomResourceOptions) {
