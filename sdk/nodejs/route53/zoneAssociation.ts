...
export class ZoneAssociation extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: ZoneAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ZoneAssociationArgs | ZoneAssociationState, opts?: pulumi.ResourceOptions) {
