...
export class Hsm extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<HsmState>, opts?: pulumi.CustomResourceOptions): Hsm {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<HsmArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<HsmArgs> | pulumi.WrappedObject<HsmState>, opts?: pulumi.CustomResourceOptions) {
