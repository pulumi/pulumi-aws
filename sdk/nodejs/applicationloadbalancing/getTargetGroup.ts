...
export interface GetTargetGroupResult {
    ...
    readonly healthChecks: outputs.applicationloadbalancing.GetTargetGroupHealthCheck[];
    /**
    ...
    readonly stickinesses: outputs.applicationloadbalancing.GetTargetGroupStickiness[];
