...
export class Listener extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ListenerState>, opts?: pulumi.CustomResourceOptions): Listener {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ListenerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ListenerArgs> | pulumi.WrappedObject<ListenerState>, opts?: pulumi.CustomResourceOptions) {
