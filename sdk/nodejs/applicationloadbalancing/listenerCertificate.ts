...
export class ListenerCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ListenerCertificateState): ListenerCertificate {
        return new ListenerCertificate(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ListenerCertificateArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ListenerCertificateArgs | ListenerCertificateState, opts?: pulumi.ResourceOptions) {
