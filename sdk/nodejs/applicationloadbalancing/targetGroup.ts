...
export class TargetGroup extends pulumi.CustomResource {
     ...
     */
    public readonly healthCheck!: pulumi.Output<outputApi.applicationloadbalancing.TargetGroupHealthCheck>;
    /**
     ...
     */
    public readonly stickiness!: pulumi.Output<outputApi.applicationloadbalancing.TargetGroupStickiness>;
    /**
...
export interface TargetGroupState {
     ...
     * A Health Check block. Health Check blocks are documented below.
     */
    readonly healthCheck?: pulumi.Input<inputApi.applicationloadbalancing.TargetGroupHealthCheck>;
    /**
     * Boolean whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `targetType` is `lambda`.
     */
     ...
     * A Stickiness block. Stickiness blocks are documented below. `stickiness` is only valid if used with Load Balancers of type `Application`
     */
    readonly stickiness?: pulumi.Input<inputApi.applicationloadbalancing.TargetGroupStickiness>;
    /**
     * A mapping of tags to assign to the resource.
     */
