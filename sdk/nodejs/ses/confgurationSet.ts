...
export class ConfgurationSet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ConfgurationSetState>, opts?: pulumi.CustomResourceOptions): ConfgurationSet {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<ConfgurationSetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ConfgurationSetArgs> | pulumi.WrappedObject<ConfgurationSetState>, opts?: pulumi.CustomResourceOptions) {
