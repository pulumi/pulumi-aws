...
export class DomainIdentityVerification extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainIdentityVerificationState): DomainIdentityVerification {
        return new DomainIdentityVerification(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: DomainIdentityVerificationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DomainIdentityVerificationArgs | DomainIdentityVerificationState, opts?: pulumi.ResourceOptions) {
