...
export class DomainDkim extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainDkimState): DomainDkim {
        return new DomainDkim(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: DomainDkimArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DomainDkimArgs | DomainDkimState, opts?: pulumi.ResourceOptions) {
