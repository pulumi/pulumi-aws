...
export class ActiveReceiptRuleSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ActiveReceiptRuleSetState): ActiveReceiptRuleSet {
        return new ActiveReceiptRuleSet(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ActiveReceiptRuleSetArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ActiveReceiptRuleSetArgs | ActiveReceiptRuleSetState, opts?: pulumi.ResourceOptions) {
