...
export class ActiveReceiptRuleSet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ActiveReceiptRuleSetState>, opts?: pulumi.CustomResourceOptions): ActiveReceiptRuleSet {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ActiveReceiptRuleSetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ActiveReceiptRuleSetArgs> | pulumi.WrappedObject<ActiveReceiptRuleSetState>, opts?: pulumi.CustomResourceOptions) {
