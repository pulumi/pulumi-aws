...
export class IdentityNotificationTopic extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: IdentityNotificationTopicArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: IdentityNotificationTopicArgs | IdentityNotificationTopicState, opts?: pulumi.ResourceOptions) {
