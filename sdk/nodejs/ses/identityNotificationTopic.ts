...
export class IdentityNotificationTopic extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<IdentityNotificationTopicState>, opts?: pulumi.CustomResourceOptions): IdentityNotificationTopic {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<IdentityNotificationTopicArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<IdentityNotificationTopicArgs> | pulumi.WrappedObject<IdentityNotificationTopicState>, opts?: pulumi.CustomResourceOptions) {
