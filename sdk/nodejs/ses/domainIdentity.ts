...
export class DomainIdentity extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<DomainIdentityState>, opts?: pulumi.CustomResourceOptions): DomainIdentity {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<DomainIdentityArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<DomainIdentityArgs> | pulumi.WrappedObject<DomainIdentityState>, opts?: pulumi.CustomResourceOptions) {
