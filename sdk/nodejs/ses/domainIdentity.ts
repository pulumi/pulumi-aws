...
export class DomainIdentity extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: DomainIdentityArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DomainIdentityArgs | DomainIdentityState, opts?: pulumi.ResourceOptions) {
