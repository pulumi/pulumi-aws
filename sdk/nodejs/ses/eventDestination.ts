...
export class EventDestination extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: EventDestinationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: EventDestinationArgs | EventDestinationState, opts?: pulumi.ResourceOptions) {
