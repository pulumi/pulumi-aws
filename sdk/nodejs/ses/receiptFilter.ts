...
export class ReceiptFilter extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ReceiptFilterState>, opts?: pulumi.CustomResourceOptions): ReceiptFilter {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ReceiptFilterArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ReceiptFilterArgs> | pulumi.WrappedObject<ReceiptFilterState>, opts?: pulumi.CustomResourceOptions) {
