...
export class PublicDnsNamespace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PublicDnsNamespaceState): PublicDnsNamespace {
        return new PublicDnsNamespace(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: PublicDnsNamespaceArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PublicDnsNamespaceArgs | PublicDnsNamespaceState, opts?: pulumi.ResourceOptions) {
