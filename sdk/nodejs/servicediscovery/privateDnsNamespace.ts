...
export class PrivateDnsNamespace extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivateDnsNamespaceState): PrivateDnsNamespace {
        return new PrivateDnsNamespace(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: PrivateDnsNamespaceArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PrivateDnsNamespaceArgs | PrivateDnsNamespaceState, opts?: pulumi.ResourceOptions) {
