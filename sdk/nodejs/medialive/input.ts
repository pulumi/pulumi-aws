 ...
 *
 * const exampleInputSecurityGroup = new aws.medialive/inputSecurityGroup.InputSecurityGroup("exampleInputSecurityGroup", {
 *     whitelistRules: [{
 *         cidr: "10.0.0.8/32",
 *     }],
 *     tags: {
 ...
 *     },
 * });
 * const exampleInput = new aws.medialive/input.Input("exampleInput", {
