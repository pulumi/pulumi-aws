...
export class Input extends pulumi.CustomResource {
     ...
     */
    public readonly destinations!: pulumi.Output<outputs.InputDestination[] | undefined>;
    /**
     * The input class.
     */
     ...
     */
    public readonly inputDevices!: pulumi.Output<outputs.InputInputDevice[]>;
    /**
     ...
     */
    public readonly mediaConnectFlows!: pulumi.Output<outputs.InputMediaConnectFlow[]>;
    /**
     * Name of the input.
     */
     ...
     */
    public readonly sources!: pulumi.Output<outputs.InputSource[]>;
    /**
     ...
     */
    public readonly vpc!: pulumi.Output<outputs.InputVpc | undefined>;
...
export interface InputState {
     ...
     * Destination settings for PUSH type inputs. See Destinations for more details.
     */
    destinations?: pulumi.Input<pulumi.Input<inputs.InputDestination>[]>;
    /**
     * The input class.
     */
     ...
     * Settings for the devices. See Input Devices for more details.
     */
    inputDevices?: pulumi.Input<pulumi.Input<inputs.InputInputDevice>[]>;
    /**
     * A list of IDs for all Inputs which are partners of this one.
     */
     ...
     * A list of the MediaConnect Flows. See Media Connect Flows for more details.
     */
    mediaConnectFlows?: pulumi.Input<pulumi.Input<inputs.InputMediaConnectFlow>[]>;
    /**
     * Name of the input.
     */
     ...
     * The source URLs for a PULL-type input. See Sources for more details.
     */
    sources?: pulumi.Input<pulumi.Input<inputs.InputSource>[]>;
    /**
     * A map of tags to assign to the Input. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
     */
     ...
     * Settings for a private VPC Input. See VPC for more details.
     */
    vpc?: pulumi.Input<inputs.InputVpc>;
}
