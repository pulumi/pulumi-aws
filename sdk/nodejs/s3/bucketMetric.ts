...
export class BucketMetric extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<BucketMetricState>, opts?: pulumi.CustomResourceOptions): BucketMetric {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<BucketMetricArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<BucketMetricArgs> | pulumi.WrappedObject<BucketMetricState>, opts?: pulumi.CustomResourceOptions) {
