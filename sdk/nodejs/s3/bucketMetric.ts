...
export class BucketMetric extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BucketMetricState): BucketMetric {
        return new BucketMetric(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: BucketMetricArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: BucketMetricArgs | BucketMetricState, opts?: pulumi.ResourceOptions) {
