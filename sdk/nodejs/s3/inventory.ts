...
export class Inventory extends pulumi.CustomResource {
     ...
     */
    public readonly destination!: pulumi.Output<outputApi.s3.InventoryDestination>;
    /**
     ...
     */
    public readonly filter!: pulumi.Output<outputApi.s3.InventoryFilter | undefined>;
    /**
     ...
     */
    public readonly schedule!: pulumi.Output<outputApi.s3.InventorySchedule>;
...
export interface InventoryState {
     ...
     * Destination bucket where inventory list files are written (documented below).
     */
    readonly destination?: pulumi.Input<inputApi.s3.InventoryDestination>;
    /**
     * Specifies whether the inventory is enabled or disabled.
     */
     ...
     * Object filtering that accepts a prefix (documented below).
     */
    readonly filter?: pulumi.Input<inputApi.s3.InventoryFilter>;
    /**
     * Object filtering that accepts a prefix (documented below). Can be `All` or `Current`.
     */
     ...
     * Contains the frequency for generating inventory results (documented below).
     */
    readonly schedule?: pulumi.Input<inputApi.s3.InventorySchedule>;
}
