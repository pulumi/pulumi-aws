...
export class Inventory extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<InventoryState>, opts?: pulumi.CustomResourceOptions): Inventory {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<InventoryArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<InventoryArgs> | pulumi.WrappedObject<InventoryState>, opts?: pulumi.CustomResourceOptions) {
