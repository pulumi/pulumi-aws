...
export class BucketLifecycleConfigurationV2 extends pulumi.CustomResource {
     ...
     */
    public readonly rules!: pulumi.Output<outputs.BucketLifecycleConfigurationV2Rule[]>;
...
export interface BucketLifecycleConfigurationV2State {
     ...
     * List of configuration blocks describing the rules managing the replication. See below.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.BucketLifecycleConfigurationV2Rule>[]>;
}
