 ...
 * 
 * const aws_s3_bucket_object_bootstrap_script = pulumi.output(aws.s3.getBucketObject({
 ...
 *     userData: aws_s3_bucket_object_bootstrap_script.apply(__arg0 => __arg0.body),
 * });
 * ```
 * 
 ...
 * import * as aws from "@pulumi/aws";
 * 
 * const aws_s3_bucket_object_lambda = pulumi.output(aws.s3.getBucketObject({
 ...
 *     s3Bucket: aws_s3_bucket_object_lambda.apply(__arg0 => __arg0.bucket),
 *     s3Key: aws_s3_bucket_object_lambda.apply(__arg0 => __arg0.key),
 *     s3ObjectVersion: aws_s3_bucket_object_lambda.apply(__arg0 => __arg0.versionId),
 * });
 * ```
 */
