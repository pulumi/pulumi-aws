...
export class BucketNotification extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: BucketNotificationState): BucketNotification {
        return new BucketNotification(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: BucketNotificationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: BucketNotificationArgs | BucketNotificationState, opts?: pulumi.ResourceOptions) {
