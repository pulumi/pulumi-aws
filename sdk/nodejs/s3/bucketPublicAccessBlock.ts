...
export class BucketPublicAccessBlock extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<BucketPublicAccessBlockState>, opts?: pulumi.CustomResourceOptions): BucketPublicAccessBlock {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<BucketPublicAccessBlockArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<BucketPublicAccessBlockArgs> | pulumi.WrappedObject<BucketPublicAccessBlockState>, opts?: pulumi.CustomResourceOptions) {
