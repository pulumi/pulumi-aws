...
export class UserAccessLoggingSettings extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserAccessLoggingSettingsState, opts?: pulumi.CustomResourceOptions): UserAccessLoggingSettings {
        return new UserAccessLoggingSettings(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:workspacesweb/userAccessLoggingSettings:UserAccessLoggingSettings';
    ...
    constructor(name: string, argsOrState?: UserAccessLoggingSettingsArgs | UserAccessLoggingSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "aws:workspaces/webUserAccessLoggingSettings:WebUserAccessLoggingSettings" }] };
