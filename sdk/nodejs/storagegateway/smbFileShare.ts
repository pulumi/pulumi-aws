...
export class SmbFileShare extends pulumi.CustomResource {
    ...
    public static list(): rxjs.Observable<SmbFileShareResult> {
        return rxjs.from(
            pulumi.runtime
                .invoke('pulumi:pulumi:readStackResourceOutputs', {
                    stackName: pulumi.runtime.getStack(),
                    type: 'aws:storagegateway/smbFileShare:SmbFileShare',
                })
...
/**
 * The live SmbFileShare resource.
 */
export interface SmbFileShareResult {
    /**
     * Amazon Resource Name (ARN) of the SMB File Share.
     */
    readonly arn: string;
     ...
     * A list of users in the Active Directory that are not allowed to access the file share. Only valid if `authentication` is set to `ActiveDirectory`.
     */
    readonly invalidUserLists?: string[];
    /**
     * Boolean value if `true` to use Amazon S3 server side encryption with your own AWS KMS key, or `false` to use a key managed by Amazon S3. Defaults to `false`.
     */
     ...
     * A list of users in the Active Directory that are allowed to access the file share. Only valid if `authentication` is set to `ActiveDirectory`.
     */
    readonly validUserLists?: string[];
}
