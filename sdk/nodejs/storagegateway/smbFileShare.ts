...
export class SmbFileShare extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SmbFileShareState): SmbFileShare {
        return new SmbFileShare(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: SmbFileShareArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SmbFileShareArgs | SmbFileShareState, opts?: pulumi.ResourceOptions) {
