...
export class NfsFileShare extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NfsFileShareState): NfsFileShare {
        return new NfsFileShare(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: NfsFileShareArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NfsFileShareArgs | NfsFileShareState, opts?: pulumi.ResourceOptions) {
