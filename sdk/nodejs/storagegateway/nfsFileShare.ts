...
export class NfsFileShare extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<NfsFileShareState>, opts?: pulumi.CustomResourceOptions): NfsFileShare {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<NfsFileShareArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<NfsFileShareArgs> | pulumi.WrappedObject<NfsFileShareState>, opts?: pulumi.CustomResourceOptions) {
