...
export class WorkingStorage extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WorkingStorageState): WorkingStorage {
        return new WorkingStorage(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: WorkingStorageArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: WorkingStorageArgs | WorkingStorageState, opts?: pulumi.ResourceOptions) {
