...
export class Cache extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<CacheState>, opts?: pulumi.CustomResourceOptions): Cache {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<CacheArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<CacheArgs> | pulumi.WrappedObject<CacheState>, opts?: pulumi.CustomResourceOptions) {
