...
export class Mesh extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<MeshState>, opts?: pulumi.CustomResourceOptions): Mesh {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<MeshArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<MeshArgs> | pulumi.WrappedObject<MeshState>, opts?: pulumi.CustomResourceOptions) {
