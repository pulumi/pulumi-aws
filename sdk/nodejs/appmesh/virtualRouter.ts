...
export class VirtualRouter extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VirtualRouterState>, opts?: pulumi.CustomResourceOptions): VirtualRouter {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VirtualRouterArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VirtualRouterArgs> | pulumi.WrappedObject<VirtualRouterState>, opts?: pulumi.CustomResourceOptions) {
