...
export class GangliaLayer extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<GangliaLayerResult> {
...
/**
 * The live GangliaLayer resource.
 */
export interface GangliaLayerResult {
    /**
     * Whether to automatically assign an elastic IP address to the layer's instances.
     */
