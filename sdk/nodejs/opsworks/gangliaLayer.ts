...
export class GangliaLayer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GangliaLayerState): GangliaLayer {
        return new GangliaLayer(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: GangliaLayerArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: GangliaLayerArgs | GangliaLayerState, opts?: pulumi.ResourceOptions) {
