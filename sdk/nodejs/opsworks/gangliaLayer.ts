...
export class GangliaLayer extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<GangliaLayerState>, opts?: pulumi.CustomResourceOptions): GangliaLayer {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<GangliaLayerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<GangliaLayerArgs> | pulumi.WrappedObject<GangliaLayerState>, opts?: pulumi.CustomResourceOptions) {
