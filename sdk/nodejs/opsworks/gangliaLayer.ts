...
export class GangliaLayer extends pulumi.CustomResource {
     ...
     */
    public readonly ebsVolumes!: pulumi.Output<outputApi.opsworks.GangliaLayerEbsVolume[] | undefined>;
    /**
...
export interface GangliaLayerState {
     ...
     * `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
     */
    readonly ebsVolumes?: pulumi.Input<pulumi.Input<inputApi.opsworks.GangliaLayerEbsVolume>[]>;
    /**
     * Name of an Elastic Load Balancer to attach to this layer
     */
