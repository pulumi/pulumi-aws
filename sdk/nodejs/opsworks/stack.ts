...
export class Stack extends pulumi.CustomResource {
     ...
     */
    public readonly customCookbooksSources!: pulumi.Output<outputs.StackCustomCookbooksSource[]>;
    /**
...
export interface StackState {
     ...
     * When `useCustomCookbooks` is set, provide this sub-object as described below.
     */
    customCookbooksSources?: pulumi.Input<pulumi.Input<inputs.StackCustomCookbooksSource>[]>;
    /**
     * Custom JSON attributes to apply to the entire stack.
     */
