...
export class MemcachedLayer extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<MemcachedLayerResult> {
...
/**
 * The live MemcachedLayer resource.
 */
export interface MemcachedLayerResult {
    /**
     * Amount of memory to allocate for the cache on each instance, in megabytes. Defaults to 512MB.
     */
