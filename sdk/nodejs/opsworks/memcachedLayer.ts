...
export class MemcachedLayer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MemcachedLayerState): MemcachedLayer {
        return new MemcachedLayer(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: MemcachedLayerArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: MemcachedLayerArgs | MemcachedLayerState, opts?: pulumi.ResourceOptions) {
