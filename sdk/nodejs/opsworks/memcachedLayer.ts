...
export class MemcachedLayer extends pulumi.CustomResource {
    ...
    public readonly cloudwatchConfiguration!: pulumi.Output<outputs.MemcachedLayerCloudwatchConfiguration | undefined>;
     ...
     */
    public readonly ebsVolumes!: pulumi.Output<outputs.MemcachedLayerEbsVolume[]>;
    /**
    ...
    public readonly loadBasedAutoScaling!: pulumi.Output<outputs.MemcachedLayerLoadBasedAutoScaling>;
    /**
...
export interface MemcachedLayerState {
    ...
    cloudwatchConfiguration?: pulumi.Input<inputs.MemcachedLayerCloudwatchConfiguration>;
     ...
     * `ebsVolume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
     */
    ebsVolumes?: pulumi.Input<pulumi.Input<inputs.MemcachedLayerEbsVolume>[]>;
    /**
     * Name of an Elastic Load Balancer to attach to this layer
     */
    ...
    loadBasedAutoScaling?: pulumi.Input<inputs.MemcachedLayerLoadBasedAutoScaling>;
    /**
     * A human-readable name for the layer.
     */
