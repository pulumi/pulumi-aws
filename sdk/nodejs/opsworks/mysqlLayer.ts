...
export class MysqlLayer extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<MysqlLayerState>, opts?: pulumi.CustomResourceOptions): MysqlLayer {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<MysqlLayerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<MysqlLayerArgs> | pulumi.WrappedObject<MysqlLayerState>, opts?: pulumi.CustomResourceOptions) {
