...
export class PhpAppLayer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PhpAppLayerState): PhpAppLayer {
        return new PhpAppLayer(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: PhpAppLayerArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PhpAppLayerArgs | PhpAppLayerState, opts?: pulumi.ResourceOptions) {
