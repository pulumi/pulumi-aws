...
export class UserProfile extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<UserProfileState>, opts?: pulumi.CustomResourceOptions): UserProfile {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<UserProfileArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<UserProfileArgs> | pulumi.WrappedObject<UserProfileState>, opts?: pulumi.CustomResourceOptions) {
