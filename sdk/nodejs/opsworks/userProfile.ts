...
export class UserProfile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserProfileState): UserProfile {
        return new UserProfile(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: UserProfileArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UserProfileArgs | UserProfileState, opts?: pulumi.ResourceOptions) {
