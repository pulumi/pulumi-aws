...
export class NodejsAppLayer extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<NodejsAppLayerState>, opts?: pulumi.CustomResourceOptions): NodejsAppLayer {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<NodejsAppLayerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<NodejsAppLayerArgs> | pulumi.WrappedObject<NodejsAppLayerState>, opts?: pulumi.CustomResourceOptions) {
