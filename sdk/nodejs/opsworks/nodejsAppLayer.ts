...
export class NodejsAppLayer extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: pulumi.InputObject<NodejsAppLayerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.InputObject<NodejsAppLayerArgs> | pulumi.InputObject<NodejsAppLayerState>, opts?: pulumi.CustomResourceOptions) {
