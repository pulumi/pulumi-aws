...
export class RdsDbInstance extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RdsDbInstanceState): RdsDbInstance {
        return new RdsDbInstance(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: RdsDbInstanceArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: RdsDbInstanceArgs | RdsDbInstanceState, opts?: pulumi.ResourceOptions) {
