...
export class HaproxyLayer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: HaproxyLayerState): HaproxyLayer {
        return new HaproxyLayer(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: HaproxyLayerArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: HaproxyLayerArgs | HaproxyLayerState, opts?: pulumi.ResourceOptions) {
