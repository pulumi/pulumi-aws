...
export class InstanceGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<InstanceGroupState>, opts?: pulumi.CustomResourceOptions): InstanceGroup {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<InstanceGroupArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<InstanceGroupArgs> | pulumi.WrappedObject<InstanceGroupState>, opts?: pulumi.CustomResourceOptions) {
