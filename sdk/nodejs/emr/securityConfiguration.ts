...
export class SecurityConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SecurityConfigurationState): SecurityConfiguration {
        return new SecurityConfiguration(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: SecurityConfigurationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SecurityConfigurationArgs | SecurityConfigurationState, opts?: pulumi.ResourceOptions) {
