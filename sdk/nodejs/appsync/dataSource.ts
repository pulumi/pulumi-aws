...
export class DataSource extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DataSourceState): DataSource {
        return new DataSource(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: DataSourceArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DataSourceArgs | DataSourceState, opts?: pulumi.ResourceOptions) {
