...
export class ApiKey extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ApiKeyState): ApiKey {
        return new ApiKey(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ApiKeyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ApiKeyArgs | ApiKeyState, opts?: pulumi.ResourceOptions) {
