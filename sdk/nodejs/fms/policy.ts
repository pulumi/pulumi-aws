 ...
 *
 * const exampleRuleGroup = new aws.wafregional/ruleGroup.RuleGroup("exampleRuleGroup", {metricName: "WAFRuleGroupExample"});
 * const examplePolicy = new aws.fms/policy.Policy("examplePolicy", {
