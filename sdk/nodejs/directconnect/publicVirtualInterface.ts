...
export class PublicVirtualInterface extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PublicVirtualInterfaceState): PublicVirtualInterface {
        return new PublicVirtualInterface(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: PublicVirtualInterfaceArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PublicVirtualInterfaceArgs | PublicVirtualInterfaceState, opts?: pulumi.ResourceOptions) {
