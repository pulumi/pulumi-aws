...
export class PublicVirtualInterface extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<PublicVirtualInterfaceState>, opts?: pulumi.CustomResourceOptions): PublicVirtualInterface {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<PublicVirtualInterfaceArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<PublicVirtualInterfaceArgs> | pulumi.WrappedObject<PublicVirtualInterfaceState>, opts?: pulumi.CustomResourceOptions) {
