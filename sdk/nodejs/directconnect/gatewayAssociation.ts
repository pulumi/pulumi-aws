...
export class GatewayAssociation extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: GatewayAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: GatewayAssociationArgs | GatewayAssociationState, opts?: pulumi.ResourceOptions) {
