...
export class GatewayAssociation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<GatewayAssociationState>, opts?: pulumi.CustomResourceOptions): GatewayAssociation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<GatewayAssociationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<GatewayAssociationArgs> | pulumi.WrappedObject<GatewayAssociationState>, opts?: pulumi.CustomResourceOptions) {
