...
export class ConnectionAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ConnectionAssociationState): ConnectionAssociation {
        return new ConnectionAssociation(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ConnectionAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ConnectionAssociationArgs | ConnectionAssociationState, opts?: pulumi.ResourceOptions) {
