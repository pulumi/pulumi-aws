...
export class HostedPrivateVirtualInterfaceAccepter extends pulumi.CustomResource {
    ...
    public static list(): rxjs.Observable<HostedPrivateVirtualInterfaceAccepterResult> {
        return rxjs.from(
            pulumi.runtime
                .invoke('pulumi:pulumi:readStackResourceOutputs', {
                    stackName: pulumi.runtime.getStack(),
                    type: 'aws:directconnect/hostedPrivateVirtualInterfaceAccepter:HostedPrivateVirtualInterfaceAccepter',
                })
