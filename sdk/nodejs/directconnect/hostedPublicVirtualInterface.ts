...
export class HostedPublicVirtualInterface extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: HostedPublicVirtualInterfaceArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: HostedPublicVirtualInterfaceArgs | HostedPublicVirtualInterfaceState, opts?: pulumi.ResourceOptions) {
