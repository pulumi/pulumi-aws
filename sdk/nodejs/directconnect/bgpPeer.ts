...
export class BgpPeer extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<BgpPeerState>, opts?: pulumi.CustomResourceOptions): BgpPeer {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<BgpPeerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<BgpPeerArgs> | pulumi.WrappedObject<BgpPeerState>, opts?: pulumi.CustomResourceOptions) {
