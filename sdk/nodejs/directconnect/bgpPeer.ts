...
export class BgpPeer extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<BgpPeerResult> {
...
/**
 * The live BgpPeer resource.
 */
export interface BgpPeerResult {
    /**
     * The address family for the BGP peer. `ipv4 ` or `ipv6`.
     */
