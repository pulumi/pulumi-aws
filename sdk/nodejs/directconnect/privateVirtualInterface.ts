...
export class PrivateVirtualInterface extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PrivateVirtualInterfaceState): PrivateVirtualInterface {
        return new PrivateVirtualInterface(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: PrivateVirtualInterfaceArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PrivateVirtualInterfaceArgs | PrivateVirtualInterfaceState, opts?: pulumi.ResourceOptions) {
