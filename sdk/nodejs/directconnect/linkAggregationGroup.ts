...
export class LinkAggregationGroup extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LinkAggregationGroupState): LinkAggregationGroup {
        return new LinkAggregationGroup(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: LinkAggregationGroupArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: LinkAggregationGroupArgs | LinkAggregationGroupState, opts?: pulumi.ResourceOptions) {
