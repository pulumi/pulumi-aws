...
export class ApnsVoipSandboxChannel extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ApnsVoipSandboxChannelState>, opts?: pulumi.CustomResourceOptions): ApnsVoipSandboxChannel {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ApnsVoipSandboxChannelArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ApnsVoipSandboxChannelArgs> | pulumi.WrappedObject<ApnsVoipSandboxChannelState>, opts?: pulumi.CustomResourceOptions) {
