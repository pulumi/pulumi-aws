...
export class ApnsSandboxChannel extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ApnsSandboxChannelState>, opts?: pulumi.CustomResourceOptions): ApnsSandboxChannel {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ApnsSandboxChannelArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ApnsSandboxChannelArgs> | pulumi.WrappedObject<ApnsSandboxChannelState>, opts?: pulumi.CustomResourceOptions) {
