...
export class ApnsVoipChannel extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ApnsVoipChannelState>, opts?: pulumi.CustomResourceOptions): ApnsVoipChannel {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ApnsVoipChannelArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ApnsVoipChannelArgs> | pulumi.WrappedObject<ApnsVoipChannelState>, opts?: pulumi.CustomResourceOptions) {
