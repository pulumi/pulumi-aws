...
export class SecurityGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<SecurityGroupState>, opts?: pulumi.CustomResourceOptions): SecurityGroup {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<SecurityGroupArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<SecurityGroupArgs> | pulumi.WrappedObject<SecurityGroupState>, opts?: pulumi.CustomResourceOptions) {
