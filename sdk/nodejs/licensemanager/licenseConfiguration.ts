...
export class LicenseConfiguration extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<LicenseConfigurationState>, opts?: pulumi.CustomResourceOptions): LicenseConfiguration {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<LicenseConfigurationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<LicenseConfigurationArgs> | pulumi.WrappedObject<LicenseConfigurationState>, opts?: pulumi.CustomResourceOptions) {
