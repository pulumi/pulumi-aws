...
export class Stream extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamState): Stream {
        return new Stream(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: StreamArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: StreamArgs | StreamState, opts?: pulumi.ResourceOptions) {
