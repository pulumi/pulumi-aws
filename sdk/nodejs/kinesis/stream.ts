...
export class Stream extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<StreamState>, opts?: pulumi.CustomResourceOptions): Stream {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<StreamArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<StreamArgs> | pulumi.WrappedObject<StreamState>, opts?: pulumi.CustomResourceOptions) {
