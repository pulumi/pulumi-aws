...
export class FirehoseDeliveryStream extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: FirehoseDeliveryStreamArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: FirehoseDeliveryStreamArgs | FirehoseDeliveryStreamState, opts?: pulumi.ResourceOptions) {
