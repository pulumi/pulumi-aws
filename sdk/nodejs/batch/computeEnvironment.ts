...
export class ComputeEnvironment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ComputeEnvironmentState>, opts?: pulumi.CustomResourceOptions): ComputeEnvironment {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ComputeEnvironmentArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ComputeEnvironmentArgs> | pulumi.WrappedObject<ComputeEnvironmentState>, opts?: pulumi.CustomResourceOptions) {
