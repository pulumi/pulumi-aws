...
export class ComputeEnvironment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ComputeEnvironmentState): ComputeEnvironment {
        return new ComputeEnvironment(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ComputeEnvironmentArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ComputeEnvironmentArgs | ComputeEnvironmentState, opts?: pulumi.ResourceOptions) {
