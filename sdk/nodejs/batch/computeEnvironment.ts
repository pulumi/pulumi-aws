...
export class ComputeEnvironment extends pulumi.CustomResource {
     ...
     */
    public readonly computeResources!: pulumi.Output<outputApi.batch.ComputeEnvironmentComputeResources | undefined>;
    /**
...
export interface ComputeEnvironmentState {
     ...
     * Details of the compute resources managed by the compute environment. This parameter is required for managed compute environments. See details below.
     */
    readonly computeResources?: pulumi.Input<inputApi.batch.ComputeEnvironmentComputeResources>;
    /**
     * The Amazon Resource Name (ARN) of the underlying Amazon ECS cluster used by the compute environment.
     */
