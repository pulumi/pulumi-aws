...
export class JobQueue extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JobQueueState): JobQueue {
        return new JobQueue(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: JobQueueArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: JobQueueArgs | JobQueueState, opts?: pulumi.ResourceOptions) {
