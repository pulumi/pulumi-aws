...
export class JobQueue extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<JobQueueState>, opts?: pulumi.CustomResourceOptions): JobQueue {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<JobQueueArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<JobQueueArgs> | pulumi.WrappedObject<JobQueueState>, opts?: pulumi.CustomResourceOptions) {
