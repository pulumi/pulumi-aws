...
export class JobDefinition extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: JobDefinitionState): JobDefinition {
        return new JobDefinition(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: JobDefinitionArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: JobDefinitionArgs | JobDefinitionState, opts?: pulumi.ResourceOptions) {
