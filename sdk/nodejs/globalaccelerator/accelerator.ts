...
export class Accelerator extends pulumi.CustomResource {
     ...
     */
    public readonly attributes!: pulumi.Output<outputApi.globalaccelerator.AcceleratorAttributes | undefined>;
    /**
     ...
     */
    public /*out*/ readonly ipSets!: pulumi.Output<outputApi.globalaccelerator.AcceleratorIpSet[]>;
    /**
...
export interface AcceleratorState {
     ...
     * The attributes of the accelerator. Fields documented below.
     */
    readonly attributes?: pulumi.Input<inputApi.globalaccelerator.AcceleratorAttributes>;
    /**
     * Indicates whether the accelerator is enabled. The value is true or false. The default value is true.
     */
     ...
     * IP address set associated with the accelerator.
     */
    readonly ipSets?: pulumi.Input<pulumi.Input<inputApi.globalaccelerator.AcceleratorIpSet>[]>;
    /**
     * The name of the accelerator.
     */
