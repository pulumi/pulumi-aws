...
export class EndpointGroup extends pulumi.CustomResource {
     ...
     */
    public readonly endpointConfigurations!: pulumi.Output<outputApi.globalaccelerator.EndpointGroupEndpointConfiguration[] | undefined>;
...
export interface EndpointGroupState {
     ...
     * The list of endpoint objects. Fields documented below.
     */
    readonly endpointConfigurations?: pulumi.Input<pulumi.Input<inputApi.globalaccelerator.EndpointGroupEndpointConfiguration>[]>;
