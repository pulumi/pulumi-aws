...
export class Stack extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<StackState>, opts?: pulumi.CustomResourceOptions): Stack {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<StackArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<StackArgs> | pulumi.WrappedObject<StackState>, opts?: pulumi.CustomResourceOptions) {
