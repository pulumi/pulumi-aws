...
export class ClusterParameterGroup extends pulumi.CustomResource {
     ...
     */
    public readonly parameters!: pulumi.Output<outputApi.docdb.ClusterParameterGroupParameter[] | undefined>;
    /**
...
export interface ClusterParameterGroupState {
     ...
     * A list of documentDB parameters to apply.
     */
    readonly parameters?: pulumi.Input<pulumi.Input<inputApi.docdb.ClusterParameterGroupParameter>[]>;
    /**
     * A mapping of tags to assign to the resource.
     */
