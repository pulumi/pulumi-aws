...
export class Fleet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<FleetState>, opts?: pulumi.CustomResourceOptions): Fleet {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<FleetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<FleetArgs> | pulumi.WrappedObject<FleetState>, opts?: pulumi.CustomResourceOptions) {
