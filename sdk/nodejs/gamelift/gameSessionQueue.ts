...
export class GameSessionQueue extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<GameSessionQueueState>, opts?: pulumi.CustomResourceOptions): GameSessionQueue {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<GameSessionQueueArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<GameSessionQueueArgs> | pulumi.WrappedObject<GameSessionQueueState>, opts?: pulumi.CustomResourceOptions) {
