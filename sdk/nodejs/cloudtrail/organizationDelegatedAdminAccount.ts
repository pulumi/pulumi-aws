...
export class OrganizationDelegatedAdminAccount extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OrganizationDelegatedAdminAccountState, opts?: pulumi.CustomResourceOptions): OrganizationDelegatedAdminAccount {
        return new OrganizationDelegatedAdminAccount(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:cloudtrail/organizationDelegatedAdminAccount:OrganizationDelegatedAdminAccount';
     ...
     */
    public static isInstance(obj: any): obj is OrganizationDelegatedAdminAccount {
    ...
    constructor(name: string, argsOrState?: OrganizationDelegatedAdminAccountArgs | OrganizationDelegatedAdminAccountState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(OrganizationDelegatedAdminAccount.__pulumiType, name, resourceInputs, opts);
    }
}
