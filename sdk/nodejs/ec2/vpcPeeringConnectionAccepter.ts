...
export class VpcPeeringConnectionAccepter extends pulumi.CustomResource {
     ...
     */
    public readonly accepter!: pulumi.Output<outputApi.ec2.VpcPeeringConnectionAccepterAccepter>;
    /**
     ...
     */
    public readonly requester!: pulumi.Output<outputApi.ec2.VpcPeeringConnectionAccepterRequester>;
    /**
...
export interface VpcPeeringConnectionAccepterState {
     ...
     * (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options set for the accepter VPC.
     */
    readonly accepter?: pulumi.Input<inputApi.ec2.VpcPeeringConnectionAccepterAccepter>;
    /**
     * Whether or not to accept the peering request. Defaults to `false`.
     */
     ...
     * (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options set for the requester VPC.
     */
    readonly requester?: pulumi.Input<inputApi.ec2.VpcPeeringConnectionAccepterRequester>;
    /**
     * A mapping of tags to assign to the resource.
     */
