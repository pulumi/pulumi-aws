...
export class VpcPeeringConnectionAccepter extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: VpcPeeringConnectionAccepterArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpcPeeringConnectionAccepterArgs | VpcPeeringConnectionAccepterState, opts?: pulumi.ResourceOptions) {
