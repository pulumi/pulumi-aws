...
export class VpcPeeringConnectionAccepter extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpcPeeringConnectionAccepterState>, opts?: pulumi.CustomResourceOptions): VpcPeeringConnectionAccepter {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VpcPeeringConnectionAccepterArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpcPeeringConnectionAccepterArgs> | pulumi.WrappedObject<VpcPeeringConnectionAccepterState>, opts?: pulumi.CustomResourceOptions) {
