...
export class DefaultVpcDhcpOptions extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: DefaultVpcDhcpOptionsArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: DefaultVpcDhcpOptionsArgs | DefaultVpcDhcpOptionsState, opts?: pulumi.ResourceOptions) {
