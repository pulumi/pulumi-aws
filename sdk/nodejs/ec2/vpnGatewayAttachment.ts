...
export class VpnGatewayAttachment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpnGatewayAttachmentState>, opts?: pulumi.CustomResourceOptions): VpnGatewayAttachment {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VpnGatewayAttachmentArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpnGatewayAttachmentArgs> | pulumi.WrappedObject<VpnGatewayAttachmentState>, opts?: pulumi.CustomResourceOptions) {
