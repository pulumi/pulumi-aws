...
export class VpnGatewayAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpnGatewayAttachmentState): VpnGatewayAttachment {
        return new VpnGatewayAttachment(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: VpnGatewayAttachmentArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpnGatewayAttachmentArgs | VpnGatewayAttachmentState, opts?: pulumi.ResourceOptions) {
