...
export class Vpc extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpcState>, opts?: pulumi.CustomResourceOptions): Vpc {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VpcArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpcArgs> | pulumi.WrappedObject<VpcState>, opts?: pulumi.CustomResourceOptions) {
