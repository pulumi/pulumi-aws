...
export class VpnGateway extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpnGatewayState>, opts?: pulumi.CustomResourceOptions): VpnGateway {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<VpnGatewayArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpnGatewayArgs> | pulumi.WrappedObject<VpnGatewayState>, opts?: pulumi.CustomResourceOptions) {
