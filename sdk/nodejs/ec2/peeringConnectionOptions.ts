...
export class PeeringConnectionOptions extends pulumi.CustomResource {
     ...
     */
    public readonly accepter!: pulumi.Output<outputApi.ec2.PeeringConnectionOptionsAccepter>;
    /**
     * A optional configuration block that allows for [VPC Peering Connection]
     * (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that requests
     * the peering connection (a maximum of one).
     */
    public readonly requester!: pulumi.Output<outputApi.ec2.PeeringConnectionOptionsRequester>;
    /**
...
export interface PeeringConnectionOptionsState {
     ...
     * the peering connection (a maximum of one).
     */
    readonly accepter?: pulumi.Input<inputApi.ec2.PeeringConnectionOptionsAccepter>;
    /**
     * A optional configuration block that allows for [VPC Peering Connection]
     * (http://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide) options to be set for the VPC that requests
     * the peering connection (a maximum of one).
     */
    readonly requester?: pulumi.Input<inputApi.ec2.PeeringConnectionOptionsRequester>;
    /**
     * The ID of the requester VPC peering connection.
     */
