 ...
 * 
 * const aws_vpc_bar = new aws.ec2.Vpc("bar", {
 *     cidrBlock: "10.1.0.0/16",
 * });
 * const aws_vpc_foo = new aws.ec2.Vpc("foo", {
 *     cidrBlock: "10.0.0.0/16",
 * });
 * const aws_vpc_peering_connection_foo = new aws.ec2.VpcPeeringConnection("foo", {
 *     autoAccept: true,
 *     peerVpcId: aws_vpc_bar.id,
 *     vpcId: aws_vpc_foo.id,
 * });
 * const aws_vpc_peering_connection_options_foo = new aws.ec2.PeeringConnectionOptions("foo", {
 *     accepter: {
 ...
 *     },
 *     vpcPeeringConnectionId: aws_vpc_peering_connection_foo.id,
 * });
 * ```
 * 
