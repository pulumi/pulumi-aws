...
export class VpcPeeringConnection extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcPeeringConnectionState): VpcPeeringConnection {
        return new VpcPeeringConnection(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: VpcPeeringConnectionArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpcPeeringConnectionArgs | VpcPeeringConnectionState, opts?: pulumi.ResourceOptions) {
