...
export class AmiCopy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<AmiCopyState>, opts?: pulumi.CustomResourceOptions): AmiCopy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<AmiCopyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<AmiCopyArgs> | pulumi.WrappedObject<AmiCopyState>, opts?: pulumi.CustomResourceOptions) {
