...
export class VpcIpv4CidrBlockAssociation extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: VpcIpv4CidrBlockAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpcIpv4CidrBlockAssociationArgs | VpcIpv4CidrBlockAssociationState, opts?: pulumi.ResourceOptions) {
