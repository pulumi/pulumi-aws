...
export class AmiFromInstance extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<AmiFromInstanceState>, opts?: pulumi.CustomResourceOptions): AmiFromInstance {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<AmiFromInstanceArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<AmiFromInstanceArgs> | pulumi.WrappedObject<AmiFromInstanceState>, opts?: pulumi.CustomResourceOptions) {
