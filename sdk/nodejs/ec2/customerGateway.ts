...
export class CustomerGateway extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<CustomerGatewayState>, opts?: pulumi.CustomResourceOptions): CustomerGateway {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<CustomerGatewayArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<CustomerGatewayArgs> | pulumi.WrappedObject<CustomerGatewayState>, opts?: pulumi.CustomResourceOptions) {
