...
export class CustomerGateway extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: CustomerGatewayArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: CustomerGatewayArgs | CustomerGatewayState, opts?: pulumi.ResourceOptions) {
