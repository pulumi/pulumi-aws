...
export class NetworkAclRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkAclRuleState): NetworkAclRule {
        return new NetworkAclRule(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: NetworkAclRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NetworkAclRuleArgs | NetworkAclRuleState, opts?: pulumi.ResourceOptions) {
