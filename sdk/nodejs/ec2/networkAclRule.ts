...
export class NetworkAclRule extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<NetworkAclRuleState>, opts?: pulumi.CustomResourceOptions): NetworkAclRule {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<NetworkAclRuleArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<NetworkAclRuleArgs> | pulumi.WrappedObject<NetworkAclRuleState>, opts?: pulumi.CustomResourceOptions) {
