...
export class EipAssociation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<EipAssociationState>, opts?: pulumi.CustomResourceOptions): EipAssociation {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<EipAssociationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<EipAssociationArgs> | pulumi.WrappedObject<EipAssociationState>, opts?: pulumi.CustomResourceOptions) {
