...
export class DefaultSecurityGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<DefaultSecurityGroupState>, opts?: pulumi.CustomResourceOptions): DefaultSecurityGroup {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<DefaultSecurityGroupArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<DefaultSecurityGroupArgs> | pulumi.WrappedObject<DefaultSecurityGroupState>, opts?: pulumi.CustomResourceOptions) {
