...
export class CapacityReservation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<CapacityReservationState>, opts?: pulumi.CustomResourceOptions): CapacityReservation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<CapacityReservationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<CapacityReservationArgs> | pulumi.WrappedObject<CapacityReservationState>, opts?: pulumi.CustomResourceOptions) {
