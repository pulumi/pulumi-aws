...
export class VolumeAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VolumeAttachmentState): VolumeAttachment {
        return new VolumeAttachment(name, <any>state, { id });
    }
    ...
    constructor(name: string, argsOrState?: VolumeAttachmentArgs | VolumeAttachmentState, opts?: pulumi.ResourceOptions) {
