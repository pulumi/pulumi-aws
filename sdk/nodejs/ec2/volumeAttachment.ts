...
export class VolumeAttachment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VolumeAttachmentState>, opts?: pulumi.CustomResourceOptions): VolumeAttachment {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VolumeAttachmentArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VolumeAttachmentArgs> | pulumi.WrappedObject<VolumeAttachmentState>, opts?: pulumi.CustomResourceOptions) {
