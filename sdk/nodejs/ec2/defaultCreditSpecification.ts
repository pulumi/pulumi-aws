...
export class DefaultCreditSpecification extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DefaultCreditSpecificationState, opts?: pulumi.CustomResourceOptions): DefaultCreditSpecification {
        return new DefaultCreditSpecification(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:ec2/defaultCreditSpecification:DefaultCreditSpecification';
     ...
     */
    public static isInstance(obj: any): obj is DefaultCreditSpecification {
    ...
    constructor(name: string, argsOrState?: DefaultCreditSpecificationArgs | DefaultCreditSpecificationState, opts?: pulumi.CustomResourceOptions) {
