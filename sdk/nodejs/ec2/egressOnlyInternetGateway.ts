...
export class EgressOnlyInternetGateway extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EgressOnlyInternetGatewayState): EgressOnlyInternetGateway {
        return new EgressOnlyInternetGateway(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: EgressOnlyInternetGatewayArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: EgressOnlyInternetGatewayArgs | EgressOnlyInternetGatewayState, opts?: pulumi.ResourceOptions) {
