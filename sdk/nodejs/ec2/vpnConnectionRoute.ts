...
export class VpnConnectionRoute extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpnConnectionRouteState): VpnConnectionRoute {
        return new VpnConnectionRoute(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: VpnConnectionRouteArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpnConnectionRouteArgs | VpnConnectionRouteState, opts?: pulumi.ResourceOptions) {
