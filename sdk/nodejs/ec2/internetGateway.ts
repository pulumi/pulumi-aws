...
export class InternetGateway extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: InternetGatewayArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: InternetGatewayArgs | InternetGatewayState, opts?: pulumi.ResourceOptions) {
