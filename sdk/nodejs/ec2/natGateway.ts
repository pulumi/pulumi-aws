...
export class NatGateway extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: NatGatewayArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NatGatewayArgs | NatGatewayState, opts?: pulumi.ResourceOptions) {
