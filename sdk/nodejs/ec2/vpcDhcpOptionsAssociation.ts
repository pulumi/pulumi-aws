...
export class VpcDhcpOptionsAssociation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpcDhcpOptionsAssociationState>, opts?: pulumi.CustomResourceOptions): VpcDhcpOptionsAssociation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VpcDhcpOptionsAssociationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpcDhcpOptionsAssociationArgs> | pulumi.WrappedObject<VpcDhcpOptionsAssociationState>, opts?: pulumi.CustomResourceOptions) {
