...
export class SpotDatafeedSubscription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SpotDatafeedSubscriptionState): SpotDatafeedSubscription {
        return new SpotDatafeedSubscription(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: SpotDatafeedSubscriptionArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SpotDatafeedSubscriptionArgs | SpotDatafeedSubscriptionState, opts?: pulumi.ResourceOptions) {
