...
export class VpcEndpointSubnetAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcEndpointSubnetAssociationState): VpcEndpointSubnetAssociation {
        return new VpcEndpointSubnetAssociation(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: VpcEndpointSubnetAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpcEndpointSubnetAssociationArgs | VpcEndpointSubnetAssociationState, opts?: pulumi.ResourceOptions) {
