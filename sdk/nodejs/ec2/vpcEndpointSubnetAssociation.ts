...
export class VpcEndpointSubnetAssociation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpcEndpointSubnetAssociationState>, opts?: pulumi.CustomResourceOptions): VpcEndpointSubnetAssociation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VpcEndpointSubnetAssociationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpcEndpointSubnetAssociationArgs> | pulumi.WrappedObject<VpcEndpointSubnetAssociationState>, opts?: pulumi.CustomResourceOptions) {
