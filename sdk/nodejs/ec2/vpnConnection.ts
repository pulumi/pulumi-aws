...
export class VpnConnection extends pulumi.CustomResource {
    ...
    public /*out*/ readonly routes!: pulumi.Output<outputApi.ec2.VpnConnectionRoute[]>;
    /**
    ...
    public /*out*/ readonly vgwTelemetries!: pulumi.Output<outputApi.ec2.VpnConnectionVgwTelemetry[]>;
    /**
...
export interface VpnConnectionState {
    ...
    readonly routes?: pulumi.Input<pulumi.Input<inputApi.ec2.VpnConnectionRoute>[]>;
    /**
     * Whether the VPN connection uses static routes exclusively. Static routes must be used for devices that don't support BGP.
     */
    ...
    readonly vgwTelemetries?: pulumi.Input<pulumi.Input<inputApi.ec2.VpnConnectionVgwTelemetry>[]>;
    /**
     * The ID of the Virtual Private Gateway.
     */
