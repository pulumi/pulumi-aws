...
export class RouteTableAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RouteTableAssociationState): RouteTableAssociation {
        return new RouteTableAssociation(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: RouteTableAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: RouteTableAssociationArgs | RouteTableAssociationState, opts?: pulumi.ResourceOptions) {
