...
export class NetworkInterfaceAttachment extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: NetworkInterfaceAttachmentState): NetworkInterfaceAttachment {
        return new NetworkInterfaceAttachment(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: NetworkInterfaceAttachmentArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: NetworkInterfaceAttachmentArgs | NetworkInterfaceAttachmentState, opts?: pulumi.ResourceOptions) {
