...
export class VpnGatewayRoutePropagation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpnGatewayRoutePropagationState>, opts?: pulumi.CustomResourceOptions): VpnGatewayRoutePropagation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VpnGatewayRoutePropagationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpnGatewayRoutePropagationArgs> | pulumi.WrappedObject<VpnGatewayRoutePropagationState>, opts?: pulumi.CustomResourceOptions) {
