...
export class VpnGatewayRoutePropagation extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: VpnGatewayRoutePropagationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpnGatewayRoutePropagationArgs | VpnGatewayRoutePropagationState, opts?: pulumi.ResourceOptions) {
