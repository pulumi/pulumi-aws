 ...
 */
export function metricCPUCreditUsage(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricCPUCreditBalance(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricCPUSurplusCreditBalance(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricCPUSurplusCreditsCharged(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricDiskReadOps(change: cloudwatch.MetricChange = {}) {
 ...
 * If there are no instance store volumes, either the value is 0 or the metric is not reported.
 */
export function metricDiskWriteOps(change: cloudwatch.MetricChange = {}) {
 ...
 * If there are no instance store volumes, either the value is 0 or the metric is not reported.
 */
export function metricDiskReadBytes(change: cloudwatch.MetricChange = {}) {
 ...
 * If there are no instance store volumes, either the value is 0 or the metric is not reported.
 */
export function metricDiskWriteBytes(change: cloudwatch.MetricChange = {}) {
 ...
 * detailed (one-minute) monitoring, divide it by 60.
 */
export function metricNetworkIn(change: cloudwatch.MetricChange = {}) {
 ...
 * detailed (one-minute) monitoring, divide it by 60.
 */
export function metricNetworkOut(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricNetworkPacketsIn(change: cloudwatch.MetricChange = {}) {
 ...
 * metric is available for basic monitoring only.
 */
export function metricNetworkPacketsOut(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricStatusCheckFailed(change: cloudwatch.MetricChange = {}) {
 ...
 * By default, this metric is available at a 1-minute frequency at no charge.
 */
export function metricStatusCheckFailed_Instance(change: cloudwatch.MetricChange = {}) {
 ...
 * By default, this metric is available at a 1-minute frequency at no charge.
 */
export function metricStatusCheckFailed_System(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricEBSReadOps(change: cloudwatch.MetricChange = {}) {
 ...
 * have detailed (one-minute) monitoring, divide it by 60.
 */
export function metricEBSWriteOps(change: cloudwatch.MetricChange = {}) {
 ...
 * have detailed (one-minute) monitoring, divide it by 60.
 */
export function metricEBSReadBytes(change: cloudwatch.MetricChange = {}) {
 ...
 * have detailed (one-minute) monitoring, divide it by 60.
 */
export function metricEBSWriteBytes(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricEBSIOBalance(change: cloudwatch.MetricChange = {}) {
 ...
 * only.
 */
export function metricEBSByteBalance(change: cloudwatch.MetricChange = {}) {
