...
declare module "./instance" {
    interface Instance {
        /**
         * Direct access to create metrics for this specific [ec2.Instance].
         */
        metrics: {
            /**
             * The number of CPU credits spent by the instance for CPU utilization. One CPU credit equals one
             ...
             * than five minutes, use the Sum statistic instead of the Average statistic.
             */
            cpuCreditUsage(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * CPU credit metrics are available at a five-minute frequency only.
             */
            cpuCreditBalance(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * spent surplus credits above the maximum incur an additional charge.
             */
            cpuSurplusCreditBalance(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             *  * The instance is switched from unlimited to standard.
             */
            cpuSurplusCreditsCharged(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Percent
             */
            cpuUtilization(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Count
             */
            diskReadOps(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Count
             */
            diskWriteOps(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Bytes
             */
            diskReadBytes(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Bytes
             */
            diskWriteBytes(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Bytes
             */
            networkIn(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Bytes
             */
            networkOut(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Statistics: Minimum, Maximum, Average
             */
            networkPacketsIn(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Statistics: Minimum, Maximum, Average
             */
            networkPacketsOut(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Count
             */
            statusCheckFailed(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Count
             */
            statusCheckFailed_Instance(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Units: Count
             */
            statusCheckFailed_System(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Unit: Count
             */
            ebsReadOps(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Unit: Count
             */
            ebsWriteOps(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Unit: Bytes
             */
            ebsReadBytes(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Unit: Bytes
             */
            ebsWriteBytes(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Unit: Percent
             */
            ebsIOBalance(change?: cloudwatch.MetricChange): cloudwatch.Metric;
             ...
             * Unit: Percent
             */
            ebsByteBalance(change?: cloudwatch.MetricChange): cloudwatch.Metric;
        }
    }
}

// All instance metrics just make a normal AWS/EC2 metric, except with the Instance
// dimension set to this Instance's id.

Object.defineProperty(Instance.prototype, "metrics", {
    get: function (this: Instance) {
        const dimensions = { dimensions: { InstanceId: this.id } };
        const result = {};
