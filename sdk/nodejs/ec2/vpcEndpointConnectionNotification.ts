...
export class VpcEndpointConnectionNotification extends pulumi.CustomResource {
    ...
    public static list(): rxjs.Observable<VpcEndpointConnectionNotificationResult> {
        return rxjs.from(
            pulumi.runtime
                .invoke('pulumi:pulumi:readStackResourceOutputs', {
                    stackName: pulumi.runtime.getStack(),
                    type: 'aws:ec2/vpcEndpointConnectionNotification:VpcEndpointConnectionNotification',
                })
