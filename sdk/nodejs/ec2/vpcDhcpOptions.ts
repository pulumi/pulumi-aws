...
export class VpcDhcpOptions extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: VpcDhcpOptionsArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpcDhcpOptionsArgs | VpcDhcpOptionsState, opts?: pulumi.ResourceOptions) {
