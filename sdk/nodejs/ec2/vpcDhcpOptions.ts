...
export class VpcDhcpOptions extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpcDhcpOptionsState>, opts?: pulumi.CustomResourceOptions): VpcDhcpOptions {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<VpcDhcpOptionsArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpcDhcpOptionsArgs> | pulumi.WrappedObject<VpcDhcpOptionsState>, opts?: pulumi.CustomResourceOptions) {
