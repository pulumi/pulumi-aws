...
export class MainRouteTableAssociation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MainRouteTableAssociationState): MainRouteTableAssociation {
        return new MainRouteTableAssociation(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: MainRouteTableAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: MainRouteTableAssociationArgs | MainRouteTableAssociationState, opts?: pulumi.ResourceOptions) {
