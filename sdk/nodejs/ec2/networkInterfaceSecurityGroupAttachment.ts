...
export class NetworkInterfaceSecurityGroupAttachment extends pulumi.CustomResource {
    ...
    public static list(): rxjs.Observable<NetworkInterfaceSecurityGroupAttachmentResult> {
        return rxjs.from(
            pulumi.runtime
                .invoke('pulumi:pulumi:readStackResourceOutputs', {
                    stackName: pulumi.runtime.getStack(),
                    type: 'aws:ec2/networkInterfaceSecurityGroupAttachment:NetworkInterfaceSecurityGroupAttachment',
                })
