...
export class VpcEndpointService extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpcEndpointServiceState>, opts?: pulumi.CustomResourceOptions): VpcEndpointService {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VpcEndpointServiceArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpcEndpointServiceArgs> | pulumi.WrappedObject<VpcEndpointServiceState>, opts?: pulumi.CustomResourceOptions) {
