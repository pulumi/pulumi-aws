...
export class VpcEndpointService extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: VpcEndpointServiceArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpcEndpointServiceArgs | VpcEndpointServiceState, opts?: pulumi.ResourceOptions) {
