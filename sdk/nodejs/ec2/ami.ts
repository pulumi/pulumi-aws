...
export class Ami extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AmiState): Ami {
        return new Ami(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: AmiArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AmiArgs | AmiState, opts?: pulumi.ResourceOptions) {
