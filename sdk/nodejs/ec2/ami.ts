...
export class Ami extends pulumi.CustomResource {
     ...
     */
    public readonly ebsBlockDevices!: pulumi.Output<outputApi.ec2.AmiEbsBlockDevice[]>;
    /**
     ...
     */
    public readonly ephemeralBlockDevices!: pulumi.Output<outputApi.ec2.AmiEphemeralBlockDevice[]>;
    /**
...
export interface AmiState {
     ...
     * attached to created instances. The structure of this block is described below.
     */
    readonly ebsBlockDevices?: pulumi.Input<pulumi.Input<inputApi.ec2.AmiEbsBlockDevice>[]>;
    /**
     * Specifies whether enhanced networking with ENA is enabled. Defaults to `false`.
     */
     ...
     * should be attached to created instances. The structure of this block is described below.
     */
    readonly ephemeralBlockDevices?: pulumi.Input<pulumi.Input<inputApi.ec2.AmiEphemeralBlockDevice>[]>;
    /**
     * Path to an S3 object containing an image manifest, e.g. created
     * by the `ec2-upload-bundle` command in the EC2 command line tools.
     */
