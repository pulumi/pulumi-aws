...
export class Ami extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<AmiState>, opts?: pulumi.CustomResourceOptions): Ami {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<AmiArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<AmiArgs> | pulumi.WrappedObject<AmiState>, opts?: pulumi.CustomResourceOptions) {
