...
export class SecurityGroupRule extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<SecurityGroupRuleState>, opts?: pulumi.CustomResourceOptions): SecurityGroupRule {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<SecurityGroupRuleArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<SecurityGroupRuleArgs> | pulumi.WrappedObject<SecurityGroupRuleState>, opts?: pulumi.CustomResourceOptions) {
