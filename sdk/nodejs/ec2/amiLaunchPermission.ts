...
export class AmiLaunchPermission extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AmiLaunchPermissionState): AmiLaunchPermission {
        return new AmiLaunchPermission(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: AmiLaunchPermissionArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AmiLaunchPermissionArgs | AmiLaunchPermissionState, opts?: pulumi.ResourceOptions) {
