...
export class AmiLaunchPermission extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<AmiLaunchPermissionState>, opts?: pulumi.CustomResourceOptions): AmiLaunchPermission {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<AmiLaunchPermissionArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<AmiLaunchPermissionArgs> | pulumi.WrappedObject<AmiLaunchPermissionState>, opts?: pulumi.CustomResourceOptions) {
