...
export class DefaultNetworkAcl extends pulumi.CustomResource {
     ...
     */
    public readonly egress!: pulumi.Output<outputApi.ec2.DefaultNetworkAclEgress[] | undefined>;
    /**
     * Specifies an ingress rule. Parameters defined below.
     */
    public readonly ingress!: pulumi.Output<outputApi.ec2.DefaultNetworkAclIngress[] | undefined>;
    /**
...
export interface DefaultNetworkAclState {
     ...
     * Specifies an egress rule. Parameters defined below.
     */
    readonly egress?: pulumi.Input<pulumi.Input<inputApi.ec2.DefaultNetworkAclEgress>[]>;
    /**
     * Specifies an ingress rule. Parameters defined below.
     */
    readonly ingress?: pulumi.Input<pulumi.Input<inputApi.ec2.DefaultNetworkAclIngress>[]>;
    /**
     * The ID of the AWS account that owns the Default Network ACL
     */
