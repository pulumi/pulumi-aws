...
export class VpcEndpointRouteTableAssociation extends pulumi.CustomResource {
    ...
    public static list(): rxjs.Observable<VpcEndpointRouteTableAssociationResult> {
        return rxjs.from(
            pulumi.runtime
                .invoke('pulumi:pulumi:readStackResourceOutputs', {
                    stackName: pulumi.runtime.getStack(),
                    type: 'aws:ec2/vpcEndpointRouteTableAssociation:VpcEndpointRouteTableAssociation',
                })
