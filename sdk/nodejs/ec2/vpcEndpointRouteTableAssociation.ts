...
export class VpcEndpointRouteTableAssociation extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: VpcEndpointRouteTableAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpcEndpointRouteTableAssociationArgs | VpcEndpointRouteTableAssociationState, opts?: pulumi.ResourceOptions) {
