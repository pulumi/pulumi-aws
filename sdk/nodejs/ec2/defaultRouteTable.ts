...
export class DefaultRouteTable extends pulumi.CustomResource {
     ...
     */
    public readonly routes!: pulumi.Output<outputApi.ec2.DefaultRouteTableRoute[]>;
    /**
...
export interface DefaultRouteTableState {
     ...
     * This argument is processed in [attribute-as-blocks mode](https://www.terraform.io/docs/configuration/attr-as-blocks.html).
     */
    readonly routes?: pulumi.Input<pulumi.Input<inputApi.ec2.DefaultRouteTableRoute>[]>;
    /**
     * A mapping of tags to assign to the resource.
     */
