...
export class NetworkInterface extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<NetworkInterfaceState>, opts?: pulumi.CustomResourceOptions): NetworkInterface {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<NetworkInterfaceArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<NetworkInterfaceArgs> | pulumi.WrappedObject<NetworkInterfaceState>, opts?: pulumi.CustomResourceOptions) {
