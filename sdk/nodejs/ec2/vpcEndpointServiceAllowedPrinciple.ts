...
export class VpcEndpointServiceAllowedPrinciple extends pulumi.CustomResource {
    ...
    public static list(): rxjs.Observable<VpcEndpointServiceAllowedPrincipleResult> {
        return rxjs.from(
            pulumi.runtime
                .invoke('pulumi:pulumi:readStackResourceOutputs', {
                    stackName: pulumi.runtime.getStack(),
                    type: 'aws:ec2/vpcEndpointServiceAllowedPrinciple:VpcEndpointServiceAllowedPrinciple',
                })
