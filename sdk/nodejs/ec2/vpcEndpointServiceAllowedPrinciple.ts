 ...
 * const aws_vpc_endpoint_service_allowed_principal_allow_me_to_foo = new aws.ec2.VpcEndpointServiceAllowedPrinciple("allow_me_to_foo", {
 *     principalArn: aws_caller_identity_current.apply(__arg0 => __arg0.arn),
