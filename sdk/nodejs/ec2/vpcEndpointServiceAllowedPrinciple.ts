...
export class VpcEndpointServiceAllowedPrinciple extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpcEndpointServiceAllowedPrincipleState>, opts?: pulumi.CustomResourceOptions): VpcEndpointServiceAllowedPrinciple {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VpcEndpointServiceAllowedPrincipleArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpcEndpointServiceAllowedPrincipleArgs> | pulumi.WrappedObject<VpcEndpointServiceAllowedPrincipleState>, opts?: pulumi.CustomResourceOptions) {
