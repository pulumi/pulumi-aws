...
export class VpcEndpointServiceAllowedPrinciple extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcEndpointServiceAllowedPrincipleState): VpcEndpointServiceAllowedPrinciple {
        return new VpcEndpointServiceAllowedPrinciple(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: VpcEndpointServiceAllowedPrincipleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: VpcEndpointServiceAllowedPrincipleArgs | VpcEndpointServiceAllowedPrincipleState, opts?: pulumi.ResourceOptions) {
