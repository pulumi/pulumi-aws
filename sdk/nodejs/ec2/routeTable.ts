...
export class RouteTable extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<RouteTableState>, opts?: pulumi.CustomResourceOptions): RouteTable {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<RouteTableArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<RouteTableArgs> | pulumi.WrappedObject<RouteTableState>, opts?: pulumi.CustomResourceOptions) {
