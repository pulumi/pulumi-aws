...
export class LaunchConfiguration extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LaunchConfigurationState): LaunchConfiguration {
        return new LaunchConfiguration(name, <any>state, { id });
    }
...
export interface LaunchConfigurationState {
     ...
     * instance.  See [Block Devices](#block-devices) below for details.
     */
    readonly ebsBlockDevices?: pulumi.Input<{ deleteOnTermination?: pulumi.Input<boolean>, deviceName: pulumi.Input<string>, encrypted?: pulumi.Input<boolean>, iops?: pulumi.Input<number>, noDevice?: pulumi.Input<boolean>, snapshotId?: pulumi.Input<string>, volumeSize?: pulumi.Input<number>, volumeType?: pulumi.Input<string> }[]>;
    /**
     * If true, the launched EC2 instance will be EBS-optimized.
     */
