...
export class ProxyProtocolPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ProxyProtocolPolicyState>, opts?: pulumi.CustomResourceOptions): ProxyProtocolPolicy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ProxyProtocolPolicyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ProxyProtocolPolicyArgs> | pulumi.WrappedObject<ProxyProtocolPolicyState>, opts?: pulumi.CustomResourceOptions) {
