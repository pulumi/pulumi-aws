...
export class WebIpAccessSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:workspaces/webIpAccessSettings:WebIpAccessSettings';

    /**
     * Returns true if the given object is an instance of WebIpAccessSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WebIpAccessSettings {
     ...
     */
    public readonly ipRules!: pulumi.Output<outputs.workspaces.WebIpAccessSettingsIpRule[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: WebIpAccessSettingsArgs | WebIpAccessSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WebIpAccessSettingsState | undefined;
            ...
            const args = argsOrState as WebIpAccessSettingsArgs | undefined;
