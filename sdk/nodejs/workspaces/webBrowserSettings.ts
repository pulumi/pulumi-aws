...
export class WebBrowserSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:workspaces/webBrowserSettings:WebBrowserSettings';

    /**
     * Returns true if the given object is an instance of WebBrowserSettings.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is WebBrowserSettings {
    ...
    constructor(name: string, argsOrState?: WebBrowserSettingsArgs | WebBrowserSettingsState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as WebBrowserSettingsState | undefined;
            ...
            const args = argsOrState as WebBrowserSettingsArgs | undefined;
