...
export class Database extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<DatabaseState>, opts?: pulumi.CustomResourceOptions): Database {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<DatabaseArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<DatabaseArgs> | pulumi.WrappedObject<DatabaseState>, opts?: pulumi.CustomResourceOptions) {
