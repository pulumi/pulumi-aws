...
export class ListenerRule extends pulumi.CustomResource {
     ...
     */
    public readonly actions!: pulumi.Output<outputApi.alb.ListenerRuleAction[]>;
    /**
     ...
     */
    public readonly conditions!: pulumi.Output<outputApi.alb.ListenerRuleCondition[]>;
    /**
...
export interface ListenerRuleState {
     ...
     * An Action block. Action blocks are documented below.
     */
    readonly actions?: pulumi.Input<pulumi.Input<inputApi.alb.ListenerRuleAction>[]>;
    /**
     * The ARN of the rule (matches `id`)
     */
     ...
     * A Condition block. Condition blocks are documented below.
     */
    readonly conditions?: pulumi.Input<pulumi.Input<inputApi.alb.ListenerRuleCondition>[]>;
    /**
     * The ARN of the listener to which to attach the rule.
     */
