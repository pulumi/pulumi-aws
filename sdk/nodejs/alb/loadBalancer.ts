...
export class LoadBalancer extends pulumi.CustomResource {
     ...
     */
    public readonly accessLogs!: pulumi.Output<outputApi.alb.LoadBalancerAccessLogs | undefined>;
    /**
     ...
     */
    public readonly subnetMappings!: pulumi.Output<outputApi.alb.LoadBalancerSubnetMapping[]>;
    /**
...
export interface LoadBalancerState {
     ...
     * An Access Logs block. Access Logs documented below.
     */
    readonly accessLogs?: pulumi.Input<inputApi.alb.LoadBalancerAccessLogs>;
    /**
     * The ARN of the load balancer (matches `id`).
     */
     ...
     * A subnet mapping block as documented below.
     */
    readonly subnetMappings?: pulumi.Input<pulumi.Input<inputApi.alb.LoadBalancerSubnetMapping>[]>;
    /**
     * A list of subnet IDs to attach to the LB. Subnets
     * cannot be updated for Load Balancers of type `network`. Changing this value
     * for load balancers of type `network` will force a recreation of the resource.
