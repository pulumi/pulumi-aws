...
export class LoadBalancer extends pulumi.CustomResource {
     ...
     */
    public readonly secondaryIpsAutoAssignedPerSubnet!: pulumi.Output<number>;
    /**
    ...
    constructor(name: string, argsOrState?: LoadBalancerArgs | LoadBalancerState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["secondaryIpsAutoAssignedPerSubnet"] = state ? state.secondaryIpsAutoAssignedPerSubnet : undefined;
