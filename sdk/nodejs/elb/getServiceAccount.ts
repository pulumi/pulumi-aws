 ...
 *     acl: "private",
 * });
 * const allowElbLogging = pulumi.all([main, elbLogs.arn]).apply(([main, arn]) => aws.iam.getPolicyDocument({
 *     statements: [{
 *         effect: "Allow",
 *         principals: [{
 *             type: "AWS",
 ...
 *     bucket: elbLogs.id,
 *     policy: allowElbLogging.then(allowElbLogging => allowElbLogging.json),
 * });
