...
export class EndpointConfiguration extends pulumi.CustomResource {
     ...
     */
    public readonly productionVariants!: pulumi.Output<outputApi.sagemaker.EndpointConfigurationProductionVariant[]>;
    /**
...
export interface EndpointConfigurationState {
     ...
     * Fields are documented below.
     */
    readonly productionVariants?: pulumi.Input<pulumi.Input<inputApi.sagemaker.EndpointConfigurationProductionVariant>[]>;
    /**
     * A mapping of tags to assign to the resource.
     */
