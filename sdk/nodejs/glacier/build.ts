...
export class Build extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: BuildArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: BuildArgs | BuildState, opts?: pulumi.ResourceOptions) {
        ...
        super("aws:glacier/build:Build", name, inputs, opts);
    }
}
