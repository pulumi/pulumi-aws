...
export class ByteMatchSet extends pulumi.CustomResource {
     ...
     */
    public readonly byteMatchTuples!: pulumi.Output<outputApi.waf.ByteMatchSetByteMatchTuple[] | undefined>;
    /**
...
export interface ByteMatchSetState {
     ...
     * the location in requests that you want to search, and other settings.
     */
    readonly byteMatchTuples?: pulumi.Input<pulumi.Input<inputApi.waf.ByteMatchSetByteMatchTuple>[]>;
    /**
     * The name or description of the Byte Match Set.
     */
