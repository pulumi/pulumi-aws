...
export class RuleGroup extends pulumi.CustomResource {
     ...
     */
    public readonly activatedRules!: pulumi.Output<outputApi.waf.RuleGroupActivatedRule[] | undefined>;
    /**
...
export interface RuleGroupState {
     ...
     * A list of activated rules, see below
     */
    readonly activatedRules?: pulumi.Input<pulumi.Input<inputApi.waf.RuleGroupActivatedRule>[]>;
    /**
     * A friendly name for the metrics from the rule group
     */
