...
export class SqlInjectionMatchSet extends pulumi.CustomResource {
    ...
    public static list(): rxjs.Observable<SqlInjectionMatchSetResult> {
        return rxjs.from(
            pulumi.runtime
                .invoke('pulumi:pulumi:readStackResourceOutputs', {
                    stackName: pulumi.runtime.getStack(),
                    type: 'aws:waf/sqlInjectionMatchSet:SqlInjectionMatchSet',
                })
...
/**
 * The live SqlInjectionMatchSet resource.
 */
export interface SqlInjectionMatchSetResult {
    /**
     * The name or description of the SizeConstraintSet.
     */
