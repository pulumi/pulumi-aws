...
export class SqlInjectionMatchSet extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: SqlInjectionMatchSetArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SqlInjectionMatchSetArgs | SqlInjectionMatchSetState, opts?: pulumi.ResourceOptions) {
...
export interface SqlInjectionMatchSetState {
     ...
     * The parts of web requests that you want AWS WAF to inspect for malicious SQL code and, if you want AWS WAF to inspect a header, the name of the header.
     */
    readonly sqlInjectionMatchTuples?: pulumi.Input<{ fieldToMatch: pulumi.Input<{ data?: pulumi.Input<string>, type: pulumi.Input<string> }>, textTransformation: pulumi.Input<string> }[]>;
}
