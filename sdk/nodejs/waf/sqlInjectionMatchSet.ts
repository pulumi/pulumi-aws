...
export class SqlInjectionMatchSet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<SqlInjectionMatchSetState>, opts?: pulumi.CustomResourceOptions): SqlInjectionMatchSet {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<SqlInjectionMatchSetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<SqlInjectionMatchSetArgs> | pulumi.WrappedObject<SqlInjectionMatchSetState>, opts?: pulumi.CustomResourceOptions) {
        ...
        super("aws:waf/sqlInjectionMatchSet:SqlInjectionMatchSet", name, inputs, opts);
    }
}
