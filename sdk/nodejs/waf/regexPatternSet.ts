...
export class RegexPatternSet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<RegexPatternSetState>, opts?: pulumi.CustomResourceOptions): RegexPatternSet {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<RegexPatternSetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<RegexPatternSetArgs> | pulumi.WrappedObject<RegexPatternSetState>, opts?: pulumi.CustomResourceOptions) {
