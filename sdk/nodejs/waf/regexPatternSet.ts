 ...
 *
 * const example = new aws.waf/regexPatternSet.RegexPatternSet("example", {regexPatternStrings: [
 *     "one",
 *     "two",
 * ]});
 * ```
...
export class RegexPatternSet extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:waf/regexPatternSet:RegexPatternSet';
