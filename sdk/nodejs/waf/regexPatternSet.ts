...
export class RegexPatternSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegexPatternSetState): RegexPatternSet {
        return new RegexPatternSet(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: RegexPatternSetArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: RegexPatternSetArgs | RegexPatternSetState, opts?: pulumi.ResourceOptions) {
