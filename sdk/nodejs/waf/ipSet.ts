...
export class IpSet extends pulumi.CustomResource {
     ...
     */
    public readonly ipSetDescriptors!: pulumi.Output<outputApi.waf.IpSetIpSetDescriptor[] | undefined>;
    /**
...
export interface IpSetState {
     ...
     * One or more pairs specifying the IP address type (IPV4 or IPV6) and the IP address range (in CIDR format) from which web requests originate.
     */
    readonly ipSetDescriptors?: pulumi.Input<pulumi.Input<inputApi.waf.IpSetIpSetDescriptor>[]>;
    /**
     * The name or description of the IPSet.
     */
