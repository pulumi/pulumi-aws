...
export class GeoMatchSet extends pulumi.CustomResource {
     ...
     */
    public readonly geoMatchConstraints!: pulumi.Output<outputApi.waf.GeoMatchSetGeoMatchConstraint[] | undefined>;
    /**
...
export interface GeoMatchSetState {
     ...
     * The GeoMatchConstraint objects which contain the country that you want AWS WAF to search for.
     */
    readonly geoMatchConstraints?: pulumi.Input<pulumi.Input<inputApi.waf.GeoMatchSetGeoMatchConstraint>[]>;
    /**
     * The name or description of the GeoMatchSet.
     */
