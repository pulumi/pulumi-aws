...
export class SizeConstraintSet extends pulumi.CustomResource {
     ...
     */
    public readonly sizeConstraints!: pulumi.Output<outputApi.waf.SizeConstraintSetSizeConstraint[] | undefined>;
...
export interface SizeConstraintSetState {
     ...
     * Specifies the parts of web requests that you want to inspect the size of.
     */
    readonly sizeConstraints?: pulumi.Input<pulumi.Input<inputApi.waf.SizeConstraintSetSizeConstraint>[]>;
}
