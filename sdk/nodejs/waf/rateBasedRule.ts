...
export class RateBasedRule extends pulumi.CustomResource {
     ...
     */
    public readonly predicates!: pulumi.Output<outputApi.waf.RateBasedRulePredicate[] | undefined>;
    /**
     * Valid value is IP.
     */
...
export interface RateBasedRuleState {
     ...
     * The objects to include in a rule (documented below).
     */
    readonly predicates?: pulumi.Input<pulumi.Input<inputApi.waf.RateBasedRulePredicate>[]>;
    /**
     * Valid value is IP.
     */
