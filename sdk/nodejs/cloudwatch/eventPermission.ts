 ...
 * 
 * const aws_cloudwatch_event_permission_DevAccountAccess = new aws.cloudwatch.EventPermission("DevAccountAccess", {
 ...
 * import * as aws from "@pulumi/aws";
 * 
 * const aws_cloudwatch_event_permission_OrganizationAccess = new aws.cloudwatch.EventPermission("OrganizationAccess", {
 *     condition: {
