...
export class EventPermission extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EventPermissionState): EventPermission {
        return new EventPermission(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: EventPermissionArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: EventPermissionArgs | EventPermissionState, opts?: pulumi.ResourceOptions) {
