...
export class LogResourcePolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<LogResourcePolicyState>, opts?: pulumi.CustomResourceOptions): LogResourcePolicy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<LogResourcePolicyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<LogResourcePolicyArgs> | pulumi.WrappedObject<LogResourcePolicyState>, opts?: pulumi.CustomResourceOptions) {
