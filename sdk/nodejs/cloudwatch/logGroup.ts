...
export class LogGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<LogGroupState>, opts?: pulumi.CustomResourceOptions): LogGroup {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<LogGroupArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<LogGroupArgs> | pulumi.WrappedObject<LogGroupState>, opts?: pulumi.CustomResourceOptions) {
