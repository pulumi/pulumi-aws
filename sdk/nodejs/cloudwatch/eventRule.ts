...
export class EventRule extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EventRuleState): EventRule {
        return new EventRule(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: EventRuleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: EventRuleArgs | EventRuleState, opts?: pulumi.ResourceOptions) {
