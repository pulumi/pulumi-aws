...
export class LogStream extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<LogStreamState>, opts?: pulumi.CustomResourceOptions): LogStream {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<LogStreamArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<LogStreamArgs> | pulumi.WrappedObject<LogStreamState>, opts?: pulumi.CustomResourceOptions) {
