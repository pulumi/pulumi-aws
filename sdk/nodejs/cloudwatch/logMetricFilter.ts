...
export class LogMetricFilter extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<LogMetricFilterState>, opts?: pulumi.CustomResourceOptions): LogMetricFilter {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<LogMetricFilterArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<LogMetricFilterArgs> | pulumi.WrappedObject<LogMetricFilterState>, opts?: pulumi.CustomResourceOptions) {
