...
export class LogMetricFilter extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogMetricFilterState): LogMetricFilter {
        return new LogMetricFilter(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: LogMetricFilterArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: LogMetricFilterArgs | LogMetricFilterState, opts?: pulumi.ResourceOptions) {
