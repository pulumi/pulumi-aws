...
export class Dashboard extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<DashboardState>, opts?: pulumi.CustomResourceOptions): Dashboard {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<DashboardArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<DashboardArgs> | pulumi.WrappedObject<DashboardState>, opts?: pulumi.CustomResourceOptions) {
