...
export class MetricAlarm extends pulumi.CustomResource {
     ...
     */
    public readonly metricQueries!: pulumi.Output<outputApi.cloudwatch.MetricAlarmMetricQuery[] | undefined>;
    /**
...
export interface MetricAlarmState {
     ...
     * Enables you to create an alarm based on a metric math expression. You may specify at most 20.
     */
    readonly metricQueries?: pulumi.Input<pulumi.Input<inputApi.cloudwatch.MetricAlarmMetricQuery>[]>;
    /**
     * The namespace for this metric. See docs for the [list of namespaces](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/aws-namespaces.html).
     * See docs for [supported metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/CW_Support_For_AWS.html).
     */
