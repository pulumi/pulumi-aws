...
export class LogDestinationPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogDestinationPolicyState): LogDestinationPolicy {
        return new LogDestinationPolicy(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: LogDestinationPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: LogDestinationPolicyArgs | LogDestinationPolicyState, opts?: pulumi.ResourceOptions) {
