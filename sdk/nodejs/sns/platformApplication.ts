...
export class PlatformApplication extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<PlatformApplicationState>, opts?: pulumi.CustomResourceOptions): PlatformApplication {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<PlatformApplicationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<PlatformApplicationArgs> | pulumi.WrappedObject<PlatformApplicationState>, opts?: pulumi.CustomResourceOptions) {
