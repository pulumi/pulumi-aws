...
export class PlatformApplication extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PlatformApplicationState): PlatformApplication {
        return new PlatformApplication(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: PlatformApplicationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PlatformApplicationArgs | PlatformApplicationState, opts?: pulumi.ResourceOptions) {
