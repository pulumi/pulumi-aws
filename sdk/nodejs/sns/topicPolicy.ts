 ...
 * const sns_topic_policy = pulumi.output(aws.iam.getPolicyDocument({
...
export class TopicPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<TopicPolicyState>, opts?: pulumi.CustomResourceOptions): TopicPolicy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<TopicPolicyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<TopicPolicyArgs> | pulumi.WrappedObject<TopicPolicyState>, opts?: pulumi.CustomResourceOptions) {
