...
export class TopicPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TopicPolicyState): TopicPolicy {
        return new TopicPolicy(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: TopicPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TopicPolicyArgs | TopicPolicyState, opts?: pulumi.ResourceOptions) {
