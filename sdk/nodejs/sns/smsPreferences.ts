...
export class SmsPreferences extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: SmsPreferencesArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SmsPreferencesArgs | SmsPreferencesState, opts?: pulumi.ResourceOptions) {
