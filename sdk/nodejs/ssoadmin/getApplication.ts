...
export interface GetApplicationArgs {
     ...
     */
    portalOptions?: inputs.GetApplicationPortalOption[];
}
...
export interface GetApplicationResult {
     ...
     * Options for the portal associated with an application. See the `aws.ssoadmin.Application` resource documentation. The attributes are the same.
     */
    readonly portalOptions?: inputs.GetApplicationPortalOption[];
    /**
...
export interface GetApplicationOutputArgs {
     ...
     * Options for the portal associated with an application. See the `aws.ssoadmin.Application` resource documentation. The attributes are the same.
     */
    portalOptions?: pulumi.Input<pulumi.Input<inputs.GetApplicationPortalOptionArgs>[]>;
}
