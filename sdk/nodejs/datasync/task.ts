...
export class Task extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<TaskState>, opts?: pulumi.CustomResourceOptions): Task {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<TaskArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<TaskArgs> | pulumi.WrappedObject<TaskState>, opts?: pulumi.CustomResourceOptions) {
