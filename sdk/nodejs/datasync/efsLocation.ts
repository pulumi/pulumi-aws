...
export class EfsLocation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<EfsLocationState>, opts?: pulumi.CustomResourceOptions): EfsLocation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<EfsLocationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<EfsLocationArgs> | pulumi.WrappedObject<EfsLocationState>, opts?: pulumi.CustomResourceOptions) {
