 ...
 */
export function metricBuildDuration(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricBuilds(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricDownloadSourceDuration(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricFailedBuilds(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricFinalizingDuration(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricInstallDuration(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricPostBuildDuration(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricPreBuildDuration(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricProvisioningDuration(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricQueuedDuration(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricSubmittedDuration(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricSucceededBuilds(change: cloudwatch.MetricChange = {}) {
 ...
 */
export function metricUploadArtifactsDuration(change: cloudwatch.MetricChange = {}) {
