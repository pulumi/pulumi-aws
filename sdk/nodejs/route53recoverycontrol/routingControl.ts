 ...
 *
 * const example = new aws.route53recoverycontrol/routingControl.RoutingControl("example", {clusterArn: "arn:aws:route53-recovery-control::881188118811:cluster/8d47920e-d789-437d-803a-2dcc4b204393"});
 * ```
 *
 * ```typescript
 * import * as pulumi from "@pulumi/pulumi";
 * import * as aws from "@pulumi/aws";
 *
 * const example = new aws.route53recoverycontrol/routingControl.RoutingControl("example", {
