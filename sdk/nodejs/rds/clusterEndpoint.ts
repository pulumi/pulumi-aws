...
export class ClusterEndpoint extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ClusterEndpointState>, opts?: pulumi.CustomResourceOptions): ClusterEndpoint {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ClusterEndpointArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ClusterEndpointArgs> | pulumi.WrappedObject<ClusterEndpointState>, opts?: pulumi.CustomResourceOptions) {
