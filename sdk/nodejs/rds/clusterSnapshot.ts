...
export class ClusterSnapshot extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ClusterSnapshotState>, opts?: pulumi.CustomResourceOptions): ClusterSnapshot {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ClusterSnapshotArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ClusterSnapshotArgs> | pulumi.WrappedObject<ClusterSnapshotState>, opts?: pulumi.CustomResourceOptions) {
