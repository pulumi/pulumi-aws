...
export class ClusterSnapshot extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterSnapshotState): ClusterSnapshot {
        return new ClusterSnapshot(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ClusterSnapshotArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ClusterSnapshotArgs | ClusterSnapshotState, opts?: pulumi.ResourceOptions) {
