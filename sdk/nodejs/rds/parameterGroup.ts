...
export class ParameterGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ParameterGroupState>, opts?: pulumi.CustomResourceOptions): ParameterGroup {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ParameterGroupArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ParameterGroupArgs> | pulumi.WrappedObject<ParameterGroupState>, opts?: pulumi.CustomResourceOptions) {
