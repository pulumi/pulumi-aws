...
export class ClusterParameterGroup extends pulumi.CustomResource {
     ...
     */
    public readonly parameters!: pulumi.Output<outputApi.rds.ClusterParameterGroupParameter[] | undefined>;
    /**
...
export interface ClusterParameterGroupState {
     ...
     * A list of DB parameters to apply. Note that parameters may differ from a family to an other. Full list of all parameters can be discovered via [`aws rds describe-db-cluster-parameters`](https://docs.aws.amazon.com/cli/latest/reference/rds/describe-db-cluster-parameters.html) after initial creation of the group.
     */
    readonly parameters?: pulumi.Input<pulumi.Input<inputApi.rds.ClusterParameterGroupParameter>[]>;
    /**
     * A mapping of tags to assign to the resource.
     */
