...
export class Cluster extends pulumi.CustomResource {
    ...
    public readonly s3Import!: pulumi.Output<outputApi.rds.ClusterS3Import | undefined>;
    /**
     * Nested attribute with scaling properties. Only valid when `engineMode` is set to `serverless`. More details below.
     */
    public readonly scalingConfiguration!: pulumi.Output<outputApi.rds.ClusterScalingConfiguration | undefined>;
    /**
...
export interface ClusterState {
    ...
    readonly s3Import?: pulumi.Input<inputApi.rds.ClusterS3Import>;
    /**
     * Nested attribute with scaling properties. Only valid when `engineMode` is set to `serverless`. More details below.
     */
    readonly scalingConfiguration?: pulumi.Input<inputApi.rds.ClusterScalingConfiguration>;
    /**
     * Determines whether a final DB snapshot is created before the DB cluster is deleted. If true is specified, no DB snapshot is created. If false is specified, a DB snapshot is created before the DB cluster is deleted, using the value from `finalSnapshotIdentifier`. Default is `false`.
     */
