...
export class OptionGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<OptionGroupState>, opts?: pulumi.CustomResourceOptions): OptionGroup {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<OptionGroupArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<OptionGroupArgs> | pulumi.WrappedObject<OptionGroupState>, opts?: pulumi.CustomResourceOptions) {
