 ...
 *                 type: "AWS",
 *             }],
 *             resources: [aws_s3_bucket_example.arn.apply(__arg0 => `${__arg0%!v(PANIC=interface conversion: il.Node is nil, not *il.ResourceNode)}/*`)],
 *         },
 *         {
 ...
 *     policy: aws_iam_policy_document_s3_policy.apply(__arg0 => __arg0.json),
 * });
 * ```
 * 
