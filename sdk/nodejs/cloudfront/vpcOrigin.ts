...
export class VpcOrigin extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VpcOriginState, opts?: pulumi.CustomResourceOptions): VpcOrigin {
        return new VpcOrigin(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'aws:cloudfront/vpcOrigin:VpcOrigin';
