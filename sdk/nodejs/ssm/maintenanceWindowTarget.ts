...
export class MaintenanceWindowTarget extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MaintenanceWindowTargetState): MaintenanceWindowTarget {
        return new MaintenanceWindowTarget(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: MaintenanceWindowTargetArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: MaintenanceWindowTargetArgs | MaintenanceWindowTargetState, opts?: pulumi.ResourceOptions) {
