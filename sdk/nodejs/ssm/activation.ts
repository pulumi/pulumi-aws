...
export class Activation extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ActivationState): Activation {
        return new Activation(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ActivationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ActivationArgs | ActivationState, opts?: pulumi.ResourceOptions) {
