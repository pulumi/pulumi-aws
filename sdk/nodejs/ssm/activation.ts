...
export class Activation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ActivationState>, opts?: pulumi.CustomResourceOptions): Activation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ActivationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ActivationArgs> | pulumi.WrappedObject<ActivationState>, opts?: pulumi.CustomResourceOptions) {
