...
export class PatchGroup extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<PatchGroupState>, opts?: pulumi.CustomResourceOptions): PatchGroup {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<PatchGroupArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<PatchGroupArgs> | pulumi.WrappedObject<PatchGroupState>, opts?: pulumi.CustomResourceOptions) {
