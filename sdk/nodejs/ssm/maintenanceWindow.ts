...
export class MaintenanceWindow extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<MaintenanceWindowState>, opts?: pulumi.CustomResourceOptions): MaintenanceWindow {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<MaintenanceWindowArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<MaintenanceWindowArgs> | pulumi.WrappedObject<MaintenanceWindowState>, opts?: pulumi.CustomResourceOptions) {
