...
export class MaintenanceWindowTask extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MaintenanceWindowTaskState): MaintenanceWindowTask {
        return new MaintenanceWindowTask(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: MaintenanceWindowTaskArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: MaintenanceWindowTaskArgs | MaintenanceWindowTaskState, opts?: pulumi.ResourceOptions) {
