...
export class PatchBaseline extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: PatchBaselineState): PatchBaseline {
        return new PatchBaseline(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: PatchBaselineArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PatchBaselineArgs | PatchBaselineState, opts?: pulumi.ResourceOptions) {
