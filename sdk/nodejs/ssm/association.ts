...
export class Association extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<AssociationState>, opts?: pulumi.CustomResourceOptions): Association {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<AssociationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<AssociationArgs> | pulumi.WrappedObject<AssociationState>, opts?: pulumi.CustomResourceOptions) {
