...
export class Association extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AssociationState): Association {
        return new Association(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: AssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AssociationArgs | AssociationState, opts?: pulumi.ResourceOptions) {
