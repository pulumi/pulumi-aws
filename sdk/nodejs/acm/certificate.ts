 ...
 *
 * const example = new tls.index/privateKey.PrivateKey("example", {algorithm: "RSA"});
 * const exampleSelfSignedCert = new tls.index/selfSignedCert.SelfSignedCert("example", {
 *     keyAlgorithm: "RSA",
