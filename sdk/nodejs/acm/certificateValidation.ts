...
export class CertificateValidation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<CertificateValidationState>, opts?: pulumi.CustomResourceOptions): CertificateValidation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<CertificateValidationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<CertificateValidationArgs> | pulumi.WrappedObject<CertificateValidationState>, opts?: pulumi.CustomResourceOptions) {
