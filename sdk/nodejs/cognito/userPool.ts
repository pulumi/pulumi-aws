...
export class UserPool extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: UserPoolArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UserPoolArgs | UserPoolState, opts?: pulumi.ResourceOptions) {
