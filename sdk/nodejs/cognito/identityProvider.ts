...
export class IdentityProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: IdentityProviderState): IdentityProvider {
        return new IdentityProvider(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: IdentityProviderArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: IdentityProviderArgs | IdentityProviderState, opts?: pulumi.ResourceOptions) {
