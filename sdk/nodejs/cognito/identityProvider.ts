 ...
 *
 * const example = new aws.cognito/userPool.UserPool("example", {autoVerifiedAttributes: ["email"]});
 * const exampleProvider = new aws.cognito/identityProvider.IdentityProvider("exampleProvider", {
