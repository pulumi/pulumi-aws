...
export class UserPoolClient extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserPoolClientState): UserPoolClient {
        return new UserPoolClient(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: UserPoolClientArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UserPoolClientArgs | UserPoolClientState, opts?: pulumi.ResourceOptions) {
