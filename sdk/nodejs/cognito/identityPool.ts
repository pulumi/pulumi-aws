...
export class IdentityPool extends pulumi.CustomResource {
     ...
     */
    public readonly cognitoIdentityProviders!: pulumi.Output<outputs.IdentityPoolCognitoIdentityProvider[] | undefined>;
    /**
...
export interface IdentityPoolState {
     ...
     * An array of Amazon Cognito Identity user pools and their client IDs.
     */
    cognitoIdentityProviders?: pulumi.Input<pulumi.Input<inputs.IdentityPoolCognitoIdentityProvider>[]>;
    /**
     * The "domain" by which Cognito will refer to your users. This name acts as a placeholder that allows your
     * backend and the Cognito service to communicate about the developer provider.
     */
