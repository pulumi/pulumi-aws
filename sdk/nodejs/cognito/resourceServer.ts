...
export class ResourceServer extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ResourceServerState): ResourceServer {
        return new ResourceServer(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ResourceServerArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ResourceServerArgs | ResourceServerState, opts?: pulumi.ResourceOptions) {
