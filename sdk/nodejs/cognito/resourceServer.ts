...
export class ResourceServer extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ResourceServerState>, opts?: pulumi.CustomResourceOptions): ResourceServer {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ResourceServerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ResourceServerArgs> | pulumi.WrappedObject<ResourceServerState>, opts?: pulumi.CustomResourceOptions) {
