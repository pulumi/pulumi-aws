...
export class LifecyclePolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<LifecyclePolicyState>, opts?: pulumi.CustomResourceOptions): LifecyclePolicy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<LifecyclePolicyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<LifecyclePolicyArgs> | pulumi.WrappedObject<LifecyclePolicyState>, opts?: pulumi.CustomResourceOptions) {
