...
export class RepositoryPolicy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: RepositoryPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: RepositoryPolicyArgs | RepositoryPolicyState, opts?: pulumi.ResourceOptions) {
