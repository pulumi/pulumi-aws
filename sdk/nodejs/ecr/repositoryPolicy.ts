...
export class RepositoryPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<RepositoryPolicyState>, opts?: pulumi.CustomResourceOptions): RepositoryPolicy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<RepositoryPolicyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<RepositoryPolicyArgs> | pulumi.WrappedObject<RepositoryPolicyState>, opts?: pulumi.CustomResourceOptions) {
