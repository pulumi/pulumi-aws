...
export class NetworkAssociation extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<NetworkAssociationState>, opts?: pulumi.CustomResourceOptions): NetworkAssociation {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<NetworkAssociationArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<NetworkAssociationArgs> | pulumi.WrappedObject<NetworkAssociationState>, opts?: pulumi.CustomResourceOptions) {
