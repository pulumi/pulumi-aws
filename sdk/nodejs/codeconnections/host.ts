...
export class Host extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'aws:codeconnections/host:Host';
     ...
     */
    public readonly vpcConfiguration!: pulumi.Output<outputs.codeconnections.HostVpcConfiguration | undefined>;
