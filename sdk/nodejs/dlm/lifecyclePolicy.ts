...
export class LifecyclePolicy extends pulumi.CustomResource {
     ...
     */
    public readonly policyDetails!: pulumi.Output<outputApi.dlm.LifecyclePolicyPolicyDetails>;
    /**
...
export interface LifecyclePolicyState {
     ...
     * See the `policyDetails` configuration block. Max of 1.
     */
    readonly policyDetails?: pulumi.Input<inputApi.dlm.LifecyclePolicyPolicyDetails>;
    /**
     * Whether the lifecycle policy should be enabled or disabled. `ENABLED` or `DISABLED` are valid values. Defaults to `ENABLED`.
     */
