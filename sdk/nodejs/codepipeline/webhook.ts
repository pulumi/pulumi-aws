...
export class Webhook extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<WebhookState>, opts?: pulumi.CustomResourceOptions): Webhook {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<WebhookArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<WebhookArgs> | pulumi.WrappedObject<WebhookState>, opts?: pulumi.CustomResourceOptions) {
