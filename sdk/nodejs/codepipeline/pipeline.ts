...
export class Pipeline extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<PipelineState>, opts?: pulumi.CustomResourceOptions): Pipeline {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<PipelineArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<PipelineArgs> | pulumi.WrappedObject<PipelineState>, opts?: pulumi.CustomResourceOptions) {
