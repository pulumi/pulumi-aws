...
export class Budget extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<BudgetState>, opts?: pulumi.CustomResourceOptions): Budget {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<BudgetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<BudgetArgs> | pulumi.WrappedObject<BudgetState>, opts?: pulumi.CustomResourceOptions) {
