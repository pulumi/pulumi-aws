...
export class Environment extends pulumi.CustomResource {
     ...
     */
    public readonly workerReplacementStrategy!: pulumi.Output<string>;
    ...
    constructor(name: string, argsOrState?: EnvironmentArgs | EnvironmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["workerReplacementStrategy"] = state ? state.workerReplacementStrategy : undefined;
        } else {
