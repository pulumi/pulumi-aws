...
export class WindowsFileSystem extends pulumi.CustomResource {
     ...
     */
    public readonly selfManagedActiveDirectory!: pulumi.Output<{ dnsIps: string[], domainName: string, fileSystemAdministratorsGroup?: string, organizationalUnitDistinguishedName?: string, password: string, username: string } | undefined>;
...
export interface WindowsFileSystemState {
     ...
     * Configuration block that Amazon FSx uses to join the Windows File Server instance to your self-managed (including on-premises) Microsoft Active Directory (AD) directory. Cannot be specified with `activeDirectoryId`. Detailed below.
     */
    readonly selfManagedActiveDirectory?: pulumi.Input<{ dnsIps: pulumi.Input<pulumi.Input<string>[]>, domainName: pulumi.Input<string>, fileSystemAdministratorsGroup?: pulumi.Input<string>, organizationalUnitDistinguishedName?: pulumi.Input<string>, password: pulumi.Input<string>, username: pulumi.Input<string> }>;
