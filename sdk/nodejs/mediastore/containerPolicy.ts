...
export class ContainerPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ContainerPolicyState): ContainerPolicy {
        return new ContainerPolicy(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ContainerPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ContainerPolicyArgs | ContainerPolicyState, opts?: pulumi.ResourceOptions) {
