...
export class Attachment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<AttachmentState>, opts?: pulumi.CustomResourceOptions): Attachment {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<AttachmentArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<AttachmentArgs> | pulumi.WrappedObject<AttachmentState>, opts?: pulumi.CustomResourceOptions) {
