...
export class LoadBalancerPolicy extends pulumi.CustomResource {
     ...
     */
    public readonly policyAttributes!: pulumi.Output<outputs.elasticloadbalancing.LoadBalancerPolicyPolicyAttribute[]>;
    /**
...
export interface LoadBalancerPolicyState {
     ...
     * Policy attribute to apply to the policy.
     */
    policyAttributes?: pulumi.Input<pulumi.Input<inputs.elasticloadbalancing.LoadBalancerPolicyPolicyAttribute>[]>;
    /**
     * The name of the load balancer policy.
     */
