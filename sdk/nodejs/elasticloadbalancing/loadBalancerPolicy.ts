...
export class LoadBalancerPolicy extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: LoadBalancerPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: LoadBalancerPolicyArgs | LoadBalancerPolicyState, opts?: pulumi.ResourceOptions) {
