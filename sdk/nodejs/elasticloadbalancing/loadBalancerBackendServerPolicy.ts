...
export class LoadBalancerBackendServerPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LoadBalancerBackendServerPolicyState): LoadBalancerBackendServerPolicy {
        return new LoadBalancerBackendServerPolicy(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: LoadBalancerBackendServerPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: LoadBalancerBackendServerPolicyArgs | LoadBalancerBackendServerPolicyState, opts?: pulumi.ResourceOptions) {
