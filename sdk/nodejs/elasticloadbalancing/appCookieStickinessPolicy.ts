...
export class AppCookieStickinessPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: AppCookieStickinessPolicyState): AppCookieStickinessPolicy {
        return new AppCookieStickinessPolicy(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: AppCookieStickinessPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AppCookieStickinessPolicyArgs | AppCookieStickinessPolicyState, opts?: pulumi.ResourceOptions) {
