...
export class SslNegotiationPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SslNegotiationPolicyState): SslNegotiationPolicy {
        return new SslNegotiationPolicy(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: SslNegotiationPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SslNegotiationPolicyArgs | SslNegotiationPolicyState, opts?: pulumi.ResourceOptions) {
