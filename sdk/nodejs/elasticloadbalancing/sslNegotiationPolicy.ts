...
export class SslNegotiationPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<SslNegotiationPolicyState>, opts?: pulumi.CustomResourceOptions): SslNegotiationPolicy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<SslNegotiationPolicyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<SslNegotiationPolicyArgs> | pulumi.WrappedObject<SslNegotiationPolicyState>, opts?: pulumi.CustomResourceOptions) {
