...
export class ListenerPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ListenerPolicyState): ListenerPolicy {
        return new ListenerPolicy(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ListenerPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ListenerPolicyArgs | ListenerPolicyState, opts?: pulumi.ResourceOptions) {
