...
export class ListenerRule extends pulumi.CustomResource {
     ...
     */
    declare public readonly actions: pulumi.Output<outputs.lb.ListenerRuleAction[]>;
    /**
     ...
     */
    declare public readonly conditions: pulumi.Output<outputs.lb.ListenerRuleCondition[]>;
    /**
