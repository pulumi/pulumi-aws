...
export class RouteTablePropagation extends pulumi.CustomResource {
    ...
    public static list(ctx: pulumi.query.ListContext, args?: pulumi.query.ListArgs): rxjs.Observable<RouteTablePropagationResult> {
        return ctx.list({...args, type: 'aws:ec2transitgateway/routeTablePropagation:RouteTablePropagation'});
    }
