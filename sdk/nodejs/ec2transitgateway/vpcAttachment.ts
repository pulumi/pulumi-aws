...
export class VpcAttachment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<VpcAttachmentState>, opts?: pulumi.CustomResourceOptions): VpcAttachment {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<VpcAttachmentArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<VpcAttachmentArgs> | pulumi.WrappedObject<VpcAttachmentState>, opts?: pulumi.CustomResourceOptions) {
