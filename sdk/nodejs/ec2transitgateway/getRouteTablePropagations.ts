...
export interface GetRouteTablePropagationsArgs {
     ...
     */
    filters?: inputs.GetRouteTablePropagationsFilter[];
    /**
...
export interface GetRouteTablePropagationsResult {
    readonly filters?: inputs.GetRouteTablePropagationsFilter[];
    /**
...
export interface GetRouteTablePropagationsOutputArgs {
     ...
     * which take the following arguments:
     */
    filters?: pulumi.Input<pulumi.Input<inputs.GetRouteTablePropagationsFilterArgs>[]>;
    /**
     * Identifier of EC2 Transit Gateway Route Table.
     *
     * The following arguments are optional:
