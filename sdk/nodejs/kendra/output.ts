...
export interface DataSourceConfiguration {
     ...
     */
    s3Configuration?: outputs.DataSourceConfigurationS3Configuration;
    /**
     * A block that provides the configuration information required for Amazon Kendra Web Crawler. Detailed below.
     */
    webCrawlerConfiguration?: outputs.DataSourceConfigurationWebCrawlerConfiguration;
}
export interface DataSourceConfigurationS3Configuration {
     ...
     */
    accessControlListConfiguration?: outputs.DataSourceConfigurationS3ConfigurationAccessControlListConfiguration;
    /**
     ...
     */
    documentsMetadataConfiguration?: outputs.DataSourceConfigurationS3ConfigurationDocumentsMetadataConfiguration;
    /**
...
export interface DataSourceConfigurationWebCrawlerConfiguration {
     ...
     */
    authenticationConfiguration?: outputs.DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfiguration;
    /**
     ...
     */
    proxyConfiguration?: outputs.DataSourceConfigurationWebCrawlerConfigurationProxyConfiguration;
    /**
...
export interface DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfiguration {
     ...
     */
    basicAuthentications?: outputs.DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfigurationBasicAuthentication[];
}
...
export interface DataSourceConfigurationWebCrawlerConfigurationUrls {
     ...
     */
    seedUrlConfiguration?: outputs.DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfiguration;
    /**
     ...
     */
    siteMapsConfiguration?: outputs.DataSourceConfigurationWebCrawlerConfigurationUrlsSiteMapsConfiguration;
}
...
export interface DataSourceCustomDocumentEnrichmentConfiguration {
     ...
     */
    inlineConfigurations?: outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration[];
    /**
     ...
     */
    postExtractionHookConfiguration?: outputs.DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration;
    /**
     * Configuration information for invoking a Lambda function in AWS Lambda on the original or raw documents before extracting their metadata and text. You can use a Lambda function to apply advanced logic for creating, modifying, or deleting document metadata and content. For more information, see [Advanced data manipulation](https://docs.aws.amazon.com/kendra/latest/dg/custom-document-enrichment.html#advanced-data-manipulation). Detailed below.
     */
    preExtractionHookConfiguration?: outputs.DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration;
    /**
...
export interface DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration {
     ...
     */
    condition?: outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition;
    /**
     ...
     */
    target?: outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget;
}
export interface DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition {
     ...
     */
    conditionOnValue?: outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue;
    /**
...
export interface DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget {
     ...
     */
    targetDocumentAttributeValue?: outputs.DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetTargetDocumentAttributeValue;
    /**
...
export interface DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration {
     ...
     */
    invocationCondition?: outputs.DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationCondition;
    /**
...
export interface DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationCondition {
     ...
     * The value used by the operator. For example, you can specify the value 'financial' for strings in the `_source_uri` field that partially match or contain this value. See condition_on_value.
     */
    conditionOnValue?: outputs.DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationConditionConditionOnValue;
    /**
     * The condition operator. For example, you can use `Contains` to partially match a string. Valid Values: `GreaterThan` | `GreaterThanOrEquals` | `LessThan` | `LessThanOrEquals` | `Equals` | `NotEquals` | `Contains` | `NotContains` | `Exists` | `NotExists` | `BeginsWith`.
     */
    operator: string;
...
export interface DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration {
     ...
     * A block that specifies the condition used for when a Lambda function should be invoked. For example, you can specify a condition that if there are empty date-time values, then Amazon Kendra should invoke a function that inserts the current date-time. See invocation_condition.
     */
    invocationCondition?: outputs.DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition;
    /**
     * The Amazon Resource Name (ARN) of a Lambda Function that can manipulate your document metadata fields or attributes and content.
     */
    lambdaArn: string;
...
export interface DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition {
     ...
     * The value used by the operator. For example, you can specify the value 'financial' for strings in the `_source_uri` field that partially match or contain this value. See condition_on_value.
     */
    conditionOnValue?: outputs.DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue;
    /**
     * The condition operator. For example, you can use `Contains` to partially match a string. Valid Values: `GreaterThan` | `GreaterThanOrEquals` | `LessThan` | `LessThanOrEquals` | `Equals` | `NotEquals` | `Contains` | `NotContains` | `Exists` | `NotExists` | `BeginsWith`.
     */
    operator: string;
...
export interface ExperienceConfiguration {
     ...
     */
    contentSourceConfiguration: outputs.ExperienceConfigurationContentSourceConfiguration;
    /**
     * The AWS SSO field name that contains the identifiers of your users, such as their emails. Detailed below.
     */
    userIdentityConfiguration?: outputs.ExperienceConfigurationUserIdentityConfiguration;
}
...
export interface IndexDocumentMetadataConfigurationUpdate {
     ...
     */
    relevance: outputs.IndexDocumentMetadataConfigurationUpdateRelevance;
    /**
     * A block that provides information about how the field is used during a search. Documented below. Detailed below
     */
    search: outputs.IndexDocumentMetadataConfigurationUpdateSearch;
    /**
...
export interface IndexIndexStatistic {
     ...
     */
    faqStatistics: outputs.IndexIndexStatisticFaqStatistic[];
    /**
     * A block that specifies the number of text documents indexed. Detailed below.
     */
    textDocumentStatistics: outputs.IndexIndexStatisticTextDocumentStatistic[];
}
...
export interface IndexUserTokenConfigurations {
     ...
     */
    jsonTokenTypeConfiguration?: outputs.IndexUserTokenConfigurationsJsonTokenTypeConfiguration;
    /**
     * A block that specifies the information about the JWT token type configuration. Detailed below.
     */
    jwtTokenTypeConfiguration?: outputs.IndexUserTokenConfigurationsJwtTokenTypeConfiguration;
}
...
export interface GetExperienceConfiguration {
     ...
     */
    contentSourceConfigurations: outputs.GetExperienceConfigurationContentSourceConfiguration[];
    /**
     * The AWS SSO field name that contains the identifiers of your users, such as their emails. Documented below.
     */
    userIdentityConfigurations: outputs.GetExperienceConfigurationUserIdentityConfiguration[];
}
...
export interface GetIndexDocumentMetadataConfigurationUpdate {
     ...
     */
    relevances: outputs.GetIndexDocumentMetadataConfigurationUpdateRelevance[];
    /**
     * Block that provides information about how the field is used during a search. Documented below.
     */
    searches: outputs.GetIndexDocumentMetadataConfigurationUpdateSearch[];
    /**
...
export interface GetIndexIndexStatistic {
     ...
     */
    faqStatistics: outputs.GetIndexIndexStatisticFaqStatistic[];
    /**
     * A block that specifies the number of text documents indexed.
     */
    textDocumentStatistics: outputs.GetIndexIndexStatisticTextDocumentStatistic[];
}
...
export interface GetIndexUserTokenConfiguration {
     ...
     */
    jsonTokenTypeConfigurations: outputs.GetIndexUserTokenConfigurationJsonTokenTypeConfiguration[];
    /**
     * A block that specifies the information about the JWT token type configuration.
     */
    jwtTokenTypeConfigurations: outputs.GetIndexUserTokenConfigurationJwtTokenTypeConfiguration[];
}
