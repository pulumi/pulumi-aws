...
export class UserPolicy extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserPolicyState): UserPolicy {
        return new UserPolicy(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: UserPolicyArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UserPolicyArgs | UserPolicyState, opts?: pulumi.ResourceOptions) {
