...
export class UserPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<UserPolicyState>, opts?: pulumi.CustomResourceOptions): UserPolicy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<UserPolicyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<UserPolicyArgs> | pulumi.WrappedObject<UserPolicyState>, opts?: pulumi.CustomResourceOptions) {
