...
export class SamlProvider extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: SamlProviderState): SamlProvider {
        return new SamlProvider(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: SamlProviderArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: SamlProviderArgs | SamlProviderState, opts?: pulumi.ResourceOptions) {
