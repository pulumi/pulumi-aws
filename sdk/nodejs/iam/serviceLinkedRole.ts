...
export class ServiceLinkedRole extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServiceLinkedRoleState): ServiceLinkedRole {
        return new ServiceLinkedRole(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ServiceLinkedRoleArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ServiceLinkedRoleArgs | ServiceLinkedRoleState, opts?: pulumi.ResourceOptions) {
