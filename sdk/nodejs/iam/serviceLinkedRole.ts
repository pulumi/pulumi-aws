...
export class ServiceLinkedRole extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ServiceLinkedRoleState>, opts?: pulumi.CustomResourceOptions): ServiceLinkedRole {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ServiceLinkedRoleArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ServiceLinkedRoleArgs> | pulumi.WrappedObject<ServiceLinkedRoleState>, opts?: pulumi.CustomResourceOptions) {
