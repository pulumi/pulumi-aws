...
export class UserPolicyAttachment extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: UserPolicyAttachmentArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UserPolicyAttachmentArgs | UserPolicyAttachmentState, opts?: pulumi.ResourceOptions) {
