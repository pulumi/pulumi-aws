...
export class GroupMembership extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<GroupMembershipState>, opts?: pulumi.CustomResourceOptions): GroupMembership {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<GroupMembershipArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<GroupMembershipArgs> | pulumi.WrappedObject<GroupMembershipState>, opts?: pulumi.CustomResourceOptions) {
