...
export class GroupMembership extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: GroupMembershipArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: GroupMembershipArgs | GroupMembershipState, opts?: pulumi.ResourceOptions) {
