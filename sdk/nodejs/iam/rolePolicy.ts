...
export class RolePolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<RolePolicyState>, opts?: pulumi.CustomResourceOptions): RolePolicy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<RolePolicyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<RolePolicyArgs> | pulumi.WrappedObject<RolePolicyState>, opts?: pulumi.CustomResourceOptions) {
