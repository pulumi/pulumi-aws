...
export class GroupPolicy extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<GroupPolicyState>, opts?: pulumi.CustomResourceOptions): GroupPolicy {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<GroupPolicyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<GroupPolicyArgs> | pulumi.WrappedObject<GroupPolicyState>, opts?: pulumi.CustomResourceOptions) {
