...
export class ServerCertificate extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<ServerCertificateState>, opts?: pulumi.CustomResourceOptions): ServerCertificate {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<ServerCertificateArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<ServerCertificateArgs> | pulumi.WrappedObject<ServerCertificateState>, opts?: pulumi.CustomResourceOptions) {
