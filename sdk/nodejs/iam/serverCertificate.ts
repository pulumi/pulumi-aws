...
export class ServerCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ServerCertificateState): ServerCertificate {
        return new ServerCertificate(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ServerCertificateArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ServerCertificateArgs | ServerCertificateState, opts?: pulumi.ResourceOptions) {
