...
export class GroupPolicyAttachment extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: GroupPolicyAttachmentArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: GroupPolicyAttachmentArgs | GroupPolicyAttachmentState, opts?: pulumi.ResourceOptions) {
