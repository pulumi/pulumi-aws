...
export class OpenIdConnectProvider extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<OpenIdConnectProviderState>, opts?: pulumi.CustomResourceOptions): OpenIdConnectProvider {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<OpenIdConnectProviderArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<OpenIdConnectProviderArgs> | pulumi.WrappedObject<OpenIdConnectProviderState>, opts?: pulumi.CustomResourceOptions) {
