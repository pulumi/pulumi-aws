...
export class UserGroupMembership extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: UserGroupMembershipArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UserGroupMembershipArgs | UserGroupMembershipState, opts?: pulumi.ResourceOptions) {
