...
export class PolicyAttachment extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<PolicyAttachmentState>, opts?: pulumi.CustomResourceOptions): PolicyAttachment {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<PolicyAttachmentArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<PolicyAttachmentArgs> | pulumi.WrappedObject<PolicyAttachmentState>, opts?: pulumi.CustomResourceOptions) {
