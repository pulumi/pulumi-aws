...
export class RolePolicyAttachment extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: RolePolicyAttachmentArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: RolePolicyAttachmentArgs | RolePolicyAttachmentState, opts?: pulumi.ResourceOptions) {
