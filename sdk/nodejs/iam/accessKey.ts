...
export class AccessKey extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<AccessKeyState>, opts?: pulumi.CustomResourceOptions): AccessKey {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<AccessKeyArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<AccessKeyArgs> | pulumi.WrappedObject<AccessKeyState>, opts?: pulumi.CustomResourceOptions) {
