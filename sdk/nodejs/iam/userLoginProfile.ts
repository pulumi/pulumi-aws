...
export class UserLoginProfile extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: UserLoginProfileState): UserLoginProfile {
        return new UserLoginProfile(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: UserLoginProfileArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: UserLoginProfileArgs | UserLoginProfileState, opts?: pulumi.ResourceOptions) {
