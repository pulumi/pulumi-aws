...
export class UserLoginProfile extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<UserLoginProfileState>, opts?: pulumi.CustomResourceOptions): UserLoginProfile {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<UserLoginProfileArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<UserLoginProfileArgs> | pulumi.WrappedObject<UserLoginProfileState>, opts?: pulumi.CustomResourceOptions) {
