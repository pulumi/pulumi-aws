...
export class AccountAlias extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<AccountAliasState>, opts?: pulumi.CustomResourceOptions): AccountAlias {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<AccountAliasArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<AccountAliasArgs> | pulumi.WrappedObject<AccountAliasState>, opts?: pulumi.CustomResourceOptions) {
