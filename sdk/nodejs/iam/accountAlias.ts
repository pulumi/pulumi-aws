...
export class AccountAlias extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: AccountAliasArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: AccountAliasArgs | AccountAliasState, opts?: pulumi.ResourceOptions) {
