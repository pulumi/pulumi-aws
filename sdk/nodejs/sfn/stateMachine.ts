...
export class StateMachine extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StateMachineState): StateMachine {
        return new StateMachine(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: StateMachineArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: StateMachineArgs | StateMachineState, opts?: pulumi.ResourceOptions) {
