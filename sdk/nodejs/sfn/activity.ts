...
export class Activity extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: ActivityArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ActivityArgs | ActivityState, opts?: pulumi.ResourceOptions) {
