...
export class WebAclAssociation extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: WebAclAssociationArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: WebAclAssociationArgs | WebAclAssociationState, opts?: pulumi.ResourceOptions) {
