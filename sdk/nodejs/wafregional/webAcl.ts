...
export class WebAcl extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: WebAclState): WebAcl {
        return new WebAcl(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: WebAclArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: WebAclArgs | WebAclState, opts?: pulumi.ResourceOptions) {
...
export interface WebAclState {
     ...
     * The rules to associate with the web ACL and the settings for each rule.
     */
    readonly rules?: pulumi.Input<pulumi.Input<{ action: pulumi.Input<{ type: pulumi.Input<string> }>, priority: pulumi.Input<number>, ruleId: pulumi.Input<string>, type?: pulumi.Input<string> }>[]>;
}
