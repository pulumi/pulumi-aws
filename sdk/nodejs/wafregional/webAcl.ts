...
export class WebAcl extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<WebAclState>, opts?: pulumi.CustomResourceOptions): WebAcl {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<WebAclArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<WebAclArgs> | pulumi.WrappedObject<WebAclState>, opts?: pulumi.CustomResourceOptions) {
