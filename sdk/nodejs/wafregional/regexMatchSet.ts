...
export class RegexMatchSet extends pulumi.CustomResource {
     ...
     */
    public readonly regexMatchTuples!: pulumi.Output<outputApi.wafregional.RegexMatchSetRegexMatchTuple[] | undefined>;
...
export interface RegexMatchSetState {
     ...
     * the location in requests that you want AWS WAF to search, and other settings. See below.
     */
    readonly regexMatchTuples?: pulumi.Input<pulumi.Input<inputApi.wafregional.RegexMatchSetRegexMatchTuple>[]>;
}
