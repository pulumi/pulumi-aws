...
export class RegexMatchSet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<RegexMatchSetState>, opts?: pulumi.CustomResourceOptions): RegexMatchSet {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<RegexMatchSetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<RegexMatchSetArgs> | pulumi.WrappedObject<RegexMatchSetState>, opts?: pulumi.CustomResourceOptions) {
