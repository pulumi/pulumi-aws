 ...
 *
 * const exampleRule = new aws.wafregional/rule.Rule("exampleRule", {metricName: "example"});
 * const exampleRuleGroup = new aws.wafregional/ruleGroup.RuleGroup("exampleRuleGroup", {
 *     metricName: "example",
 *     activatedRules: [{
 *         action: {
 *             type: "COUNT",
