...
export class GeoMatchSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: GeoMatchSetState): GeoMatchSet {
        return new GeoMatchSet(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: GeoMatchSetArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: GeoMatchSetArgs | GeoMatchSetState, opts?: pulumi.ResourceOptions) {
...
export interface GeoMatchSetState {
     ...
     * The Geo Match Constraint objects which contain the country that you want AWS WAF to search for.
     */
    readonly geoMatchConstraints?: pulumi.Input<{ type: pulumi.Input<string>, value: pulumi.Input<string> }[]>;
    /**
     * The name or description of the Geo Match Set.
     */
