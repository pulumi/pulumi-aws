...
export class XssMatchSet extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: XssMatchSetState): XssMatchSet {
        return new XssMatchSet(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args?: XssMatchSetArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: XssMatchSetArgs | XssMatchSetState, opts?: pulumi.ResourceOptions) {
...
export interface XssMatchSetState {
     ...
     * The parts of web requests that you want to inspect for cross-site scripting attacks.
     */
    readonly xssMatchTuples?: pulumi.Input<{ fieldToMatch: pulumi.Input<{ data?: pulumi.Input<string>, type: pulumi.Input<string> }>, textTransformation: pulumi.Input<string> }[]>;
}
