...
export class XssMatchSet extends pulumi.CustomResource {
     ...
     */
    public readonly xssMatchTuples!: pulumi.Output<outputApi.wafregional.XssMatchSetXssMatchTuple[] | undefined>;
...
export interface XssMatchSetState {
     ...
     * The parts of web requests that you want to inspect for cross-site scripting attacks.
     */
    readonly xssMatchTuples?: pulumi.Input<pulumi.Input<inputApi.wafregional.XssMatchSetXssMatchTuple>[]>;
}
