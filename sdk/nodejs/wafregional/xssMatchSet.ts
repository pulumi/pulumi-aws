...
export class XssMatchSet extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<XssMatchSetState>, opts?: pulumi.CustomResourceOptions): XssMatchSet {
     ...
     */
    constructor(name: string, args?: pulumi.WrappedObject<XssMatchSetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<XssMatchSetArgs> | pulumi.WrappedObject<XssMatchSetState>, opts?: pulumi.CustomResourceOptions) {
