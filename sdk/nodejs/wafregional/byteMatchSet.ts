...
export class ByteMatchSet extends pulumi.CustomResource {
     ...
     */
    public readonly byteMatchTuples!: pulumi.Output<outputApi.wafregional.ByteMatchSetByteMatchTuple[] | undefined>;
    /**
...
export interface ByteMatchSetState {
     ...
     * Settings for the ByteMatchSet, such as the bytes (typically a string that corresponds with ASCII characters) that you want AWS WAF to search for in web requests. ByteMatchTuple documented below.
     */
    readonly byteMatchTuples?: pulumi.Input<pulumi.Input<inputApi.wafregional.ByteMatchSetByteMatchTuple>[]>;
    /**
     * The name or description of the ByteMatchSet.
     */
