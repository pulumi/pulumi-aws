...
export class Portfolio extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args?: PortfolioArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: PortfolioArgs | PortfolioState, opts?: pulumi.ResourceOptions) {
