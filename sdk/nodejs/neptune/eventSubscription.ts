...
export class EventSubscription extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: EventSubscriptionState): EventSubscription {
        return new EventSubscription(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: EventSubscriptionArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: EventSubscriptionArgs | EventSubscriptionState, opts?: pulumi.ResourceOptions) {
