...
export class EventSubscription extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<EventSubscriptionState>, opts?: pulumi.CustomResourceOptions): EventSubscription {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<EventSubscriptionArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<EventSubscriptionArgs> | pulumi.WrappedObject<EventSubscriptionState>, opts?: pulumi.CustomResourceOptions) {
