...
export class Pipeline extends pulumi.CustomResource {
     ...
     */
    public readonly contentConfig!: pulumi.Output<outputApi.elastictranscoder.PipelineContentConfig>;
    /**
     * The permissions for the `contentConfig` object. (documented below)
     */
    public readonly contentConfigPermissions!: pulumi.Output<outputApi.elastictranscoder.PipelineContentConfigPermission[] | undefined>;
    /**
     ...
     */
    public readonly notifications!: pulumi.Output<outputApi.elastictranscoder.PipelineNotifications | undefined>;
    /**
     ...
     */
    public readonly thumbnailConfig!: pulumi.Output<outputApi.elastictranscoder.PipelineThumbnailConfig>;
    /**
     * The permissions for the `thumbnailConfig` object. (documented below)
     */
    public readonly thumbnailConfigPermissions!: pulumi.Output<outputApi.elastictranscoder.PipelineThumbnailConfigPermission[] | undefined>;
...
export interface PipelineState {
     ...
     * The ContentConfig object specifies information about the Amazon S3 bucket in which you want Elastic Transcoder to save transcoded files and playlists. (documented below)
     */
    readonly contentConfig?: pulumi.Input<inputApi.elastictranscoder.PipelineContentConfig>;
    /**
     * The permissions for the `contentConfig` object. (documented below)
     */
    readonly contentConfigPermissions?: pulumi.Input<pulumi.Input<inputApi.elastictranscoder.PipelineContentConfigPermission>[]>;
    /**
     * The Amazon S3 bucket in which you saved the media files that you want to transcode and the graphics that you want to use as watermarks.
     */
     ...
     * The Amazon Simple Notification Service (Amazon SNS) topic that you want to notify to report job status. (documented below)
     */
    readonly notifications?: pulumi.Input<inputApi.elastictranscoder.PipelineNotifications>;
    /**
     * The Amazon S3 bucket in which you want Elastic Transcoder to save the transcoded files.
     */
     ...
     * The ThumbnailConfig object specifies information about the Amazon S3 bucket in which you want Elastic Transcoder to save thumbnail files. (documented below)
     */
    readonly thumbnailConfig?: pulumi.Input<inputApi.elastictranscoder.PipelineThumbnailConfig>;
    /**
     * The permissions for the `thumbnailConfig` object. (documented below)
     */
    readonly thumbnailConfigPermissions?: pulumi.Input<pulumi.Input<inputApi.elastictranscoder.PipelineThumbnailConfigPermission>[]>;
}
