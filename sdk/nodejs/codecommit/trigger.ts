...
export class Trigger extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<TriggerState>, opts?: pulumi.CustomResourceOptions): Trigger {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<TriggerArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<TriggerArgs> | pulumi.WrappedObject<TriggerState>, opts?: pulumi.CustomResourceOptions) {
