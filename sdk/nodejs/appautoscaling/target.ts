...
export class Target extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: TargetState): Target {
        return new Target(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: TargetArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TargetArgs | TargetState, opts?: pulumi.ResourceOptions) {
