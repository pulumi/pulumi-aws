...
export class Target extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: pulumi.WrappedObject<TargetState>, opts?: pulumi.CustomResourceOptions): Target {
     ...
     */
    constructor(name: string, args: pulumi.WrappedObject<TargetArgs>, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: pulumi.WrappedObject<TargetArgs> | pulumi.WrappedObject<TargetState>, opts?: pulumi.CustomResourceOptions) {
