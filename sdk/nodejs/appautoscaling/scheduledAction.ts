...
export class ScheduledAction extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ScheduledActionState): ScheduledAction {
        return new ScheduledAction(name, <any>state, { id });
    }
     ...
     */
    constructor(name: string, args: ScheduledActionArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: ScheduledActionArgs | ScheduledActionState, opts?: pulumi.ResourceOptions) {
