...
export class Service extends pulumi.CustomResource {
     ...
     */
    public readonly deploymentController!: pulumi.Output<outputApi.ecs.ServiceDeploymentController | undefined>;
    /**
     ...
     */
    public readonly loadBalancers!: pulumi.Output<outputApi.ecs.ServiceLoadBalancer[] | undefined>;
    /**
     ...
     */
    public readonly networkConfiguration!: pulumi.Output<outputApi.ecs.ServiceNetworkConfiguration | undefined>;
    /**
     ...
     */
    public readonly orderedPlacementStrategies!: pulumi.Output<outputApi.ecs.ServiceOrderedPlacementStrategy[] | undefined>;
    /**
     * rules that are taken into consideration during task placement. Maximum number of
     * `placementConstraints` is `10`. Defined below.
     */
    public readonly placementConstraints!: pulumi.Output<outputApi.ecs.ServicePlacementConstraint[] | undefined>;
    /**
     ...
     */
    public readonly serviceRegistries!: pulumi.Output<outputApi.ecs.ServiceServiceRegistries | undefined>;
    /**
...
export interface ServiceState {
     ...
     * Configuration block containing deployment controller configuration. Defined below.
     */
    readonly deploymentController?: pulumi.Input<inputApi.ecs.ServiceDeploymentController>;
    /**
     * The upper limit (as a percentage of the service's desiredCount) of the number of running tasks that can be running in a service during a deployment. Not valid when using the `DAEMON` scheduling strategy.
     */
     ...
     * A load balancer block. Load balancers documented below.
     */
    readonly loadBalancers?: pulumi.Input<pulumi.Input<inputApi.ecs.ServiceLoadBalancer>[]>;
    /**
     * The name of the service (up to 255 letters, numbers, hyphens, and underscores)
     */
     ...
     * The network configuration for the service. This parameter is required for task definitions that use the `awsvpc` network mode to receive their own Elastic Network Interface, and it is not supported for other network modes.
     */
    readonly networkConfiguration?: pulumi.Input<inputApi.ecs.ServiceNetworkConfiguration>;
    /**
     * Service level strategy rules that are taken into consideration during task placement. List from top to bottom in order of precedence. The maximum number of `orderedPlacementStrategy` blocks is `5`. Defined below.
     */
    readonly orderedPlacementStrategies?: pulumi.Input<pulumi.Input<inputApi.ecs.ServiceOrderedPlacementStrategy>[]>;
    /**
     * rules that are taken into consideration during task placement. Maximum number of
     * `placementConstraints` is `10`. Defined below.
     */
    readonly placementConstraints?: pulumi.Input<pulumi.Input<inputApi.ecs.ServicePlacementConstraint>[]>;
    /**
     * The platform version on which to run your service. Only applicable for `launchType` set to `FARGATE`. Defaults to `LATEST`. More information about Fargate platform versions can be found in the [AWS ECS User Guide](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html).
     */
     ...
     * The service discovery registries for the service. The maximum number of `serviceRegistries` blocks is `1`.
     */
    readonly serviceRegistries?: pulumi.Input<inputApi.ecs.ServiceServiceRegistries>;
    /**
     * Key-value mapping of resource tags
     */
