 ...
 *
 * const exampleCluster = new aws.ecs/cluster.Cluster("exampleCluster", {});
 * const exampleClusterCapacityProviders = new aws.ecs/clusterCapacityProviders.ClusterCapacityProviders("exampleClusterCapacityProviders", {
