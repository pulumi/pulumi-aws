...
export class TaskDefinition extends pulumi.CustomResource {
     ...
     */
    constructor(name: string, args: TaskDefinitionArgs, opts?: pulumi.ResourceOptions)
    constructor(name: string, argsOrState?: TaskDefinitionArgs | TaskDefinitionState, opts?: pulumi.ResourceOptions) {
