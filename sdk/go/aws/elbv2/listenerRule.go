...
func NewListenerRule(ctx *pulumi.Context,
	...
	inputs["arn"] = nil
	s, err := ctx.RegisterResource("aws:elbv2/listenerRule:ListenerRule", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetListenerRule(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:elbv2/listenerRule:ListenerRule", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ListenerRule{s: s}, nil
