...
func NewTargetGroup(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("aws:elbv2/targetGroup:TargetGroup", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetTargetGroup(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:elbv2/targetGroup:TargetGroup", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &TargetGroup{s: s}, nil
