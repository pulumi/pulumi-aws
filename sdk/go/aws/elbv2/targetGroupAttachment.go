...
func NewTargetGroupAttachment(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("aws:elbv2/targetGroupAttachment:TargetGroupAttachment", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetTargetGroupAttachment(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:elbv2/targetGroupAttachment:TargetGroupAttachment", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &TargetGroupAttachment{s: s}, nil
