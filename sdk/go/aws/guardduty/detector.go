...
type Detector struct {
	...
	Datasources DetectorDatasourcesPtrOutput `pulumi:"datasources"`
...
// The AWS account ID of the GuardDuty detector
func (o DetectorOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Detector) pulumi.StringPtrOutput { return v.AccountId }).(pulumi.StringPtrOutput)
}

// Amazon Resource Name (ARN) of the GuardDuty detector
func (o DetectorOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Detector) pulumi.StringPtrOutput { return v.Arn }).(pulumi.StringPtrOutput)
}

// Describes which data sources will be enabled for the detector. See Data Sources below for more details. [Deprecated](https://docs.aws.amazon.com/guardduty/latest/ug/guardduty-feature-object-api-changes-march2023.html) in favor of `guardduty.DetectorFeature` resources.
func (o DetectorOutput) Datasources() DetectorDatasourcesPtrOutput {
	return o.ApplyT(func(v *Detector) DetectorDatasourcesPtrOutput { return v.Datasources }).(DetectorDatasourcesPtrOutput)
}
