...
// return err
// }
// bucketPol := pulumi.All(gdBucket.Arn,gdBucket.Arn).ApplyT(func(_args []interface{}) (iam.GetPolicyDocumentResult, error) {
// gdBucketArn := _args[0].(*string)
// gdBucketArn1 := _args[1].(*string)
