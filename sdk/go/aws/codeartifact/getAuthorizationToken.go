...
func GetAuthorizationTokenOutput(ctx *pulumi.Context, args GetAuthorizationTokenOutputArgs, opts ...pulumi.InvokeOption) GetAuthorizationTokenResultOutput {
	...
	return ctx.InvokeOutput("aws:codeartifact/getAuthorizationToken:getAuthorizationToken", args, GetAuthorizationTokenResultOutput{}, options).(GetAuthorizationTokenResultOutput)
}
