...
// The SES receipt rule set ARN.
func (o ActiveReceiptRuleSetOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ActiveReceiptRuleSet) pulumi.StringPtrOutput { return v.Arn }).(pulumi.StringPtrOutput)
}
