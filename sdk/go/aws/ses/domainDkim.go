...
func (i *DomainDkim) ToOutput(ctx context.Context) pulumix.Output[*DomainDkim] {
	return pulumix.Output[*DomainDkim]{
		OutputState: i.ToDomainDkimOutputWithContext(ctx).OutputState,
	}
}
...
func (i DomainDkimArray) ToOutput(ctx context.Context) pulumix.Output[[]*DomainDkim] {
	return pulumix.Output[[]*DomainDkim]{
		OutputState: i.ToDomainDkimArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i DomainDkimMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*DomainDkim] {
	return pulumix.Output[map[string]*DomainDkim]{
		OutputState: i.ToDomainDkimMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o DomainDkimArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*DomainDkim] {
	return pulumix.Output[[]*DomainDkim]{
		OutputState: o.OutputState,
	}
}
...
func (o DomainDkimMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*DomainDkim] {
	return pulumix.Output[map[string]*DomainDkim]{
		OutputState: o.OutputState,
	}
}
