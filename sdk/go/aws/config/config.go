...
func GetAccessKey(ctx *pulumi.Context) string {
	return config.Get("aws:accessKey")
}

func GetAllowedAccountIds(ctx *pulumi.Context) string {
	return config.Get("aws:allowedAccountIds")
}

func GetAssumeRole(ctx *pulumi.Context) string {
	return config.Get("aws:assumeRole")
}
...
func GetDynamodbEndpoint(ctx *pulumi.Context) string {
	return config.Get("aws:dynamodbEndpoint")
}

func GetEndpoints(ctx *pulumi.Context) string {
	return config.Get("aws:endpoints")
}

func GetForbiddenAccountIds(ctx *pulumi.Context) string {
	return config.Get("aws:forbiddenAccountIds")
}

// Explicitly allow the provider to perform "insecure" SSL requests. If omitted,default value is `false`
func GetInsecure(ctx *pulumi.Context) bool {
	return config.GetBool("aws:insecure")
}

// Use this to override the default endpoint URL constructed from the `region`. It's typically used to connect to
// kinesalite.
func GetKinesisEndpoint(ctx *pulumi.Context) string {
	return config.Get("aws:kinesisEndpoint")
}

// The maximum number of times an AWS API request is being executed. If the API request still fails, an error is thrown.
func GetMaxRetries(ctx *pulumi.Context) int {
	return config.GetInt("aws:maxRetries")
}
...
func GetRegion(ctx *pulumi.Context) string {
	return config.Require("aws:region")
}
