...
type OrganizationsAccess struct {
	...
	Timeouts OrganizationsAccessTimeoutsPtrOutput `pulumi:"timeouts"`
}
...
func NewOrganizationsAccess(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws:notifications/organizationsAccess:OrganizationsAccess", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOrganizationsAccess(ctx *pulumi.Context,
	...
	var resource OrganizationsAccess
	err := ctx.ReadResource("aws:notifications/organizationsAccess:OrganizationsAccess", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
type organizationsAccessState struct {
	...
	Timeouts *OrganizationsAccessTimeouts `pulumi:"timeouts"`
}

type OrganizationsAccessState struct {
	// Whether to enable organizations access for AWS User Notifications in AWS Organizations. When set to `true`, enables organizations access. When set to `false`, disables organizations access.
	Enabled  pulumi.BoolPtrInput
	Timeouts OrganizationsAccessTimeoutsPtrInput
}
...
func (o OrganizationsAccessOutput) Timeouts() OrganizationsAccessTimeoutsPtrOutput {
	return o.ApplyT(func(v *OrganizationsAccess) OrganizationsAccessTimeoutsPtrOutput { return v.Timeouts }).(OrganizationsAccessTimeoutsPtrOutput)
}
