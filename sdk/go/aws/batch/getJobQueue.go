...
func LookupJobQueue(ctx *pulumi.Context, args *GetJobQueueArgs, opts ...pulumi.InvokeOption) (*GetJobQueueResult, error) {
...
type GetJobQueueResult struct {
	...
	ComputeEnvironmentOrders []GetJobQueueComputeEnvironmentOrdersResult `pulumi:"computeEnvironmentOrders"`
	Name string `pulumi:"name"`
...
type GetJobQueueComputeEnvironmentOrdersResult struct {
