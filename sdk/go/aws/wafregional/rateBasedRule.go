...
func NewRateBasedRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("aws:wafregional/rateBasedRule:RateBasedRule", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRateBasedRule(ctx *pulumi.Context,
	...
	var resource RateBasedRule
	err := ctx.ReadResource("aws:wafregional/rateBasedRule:RateBasedRule", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
