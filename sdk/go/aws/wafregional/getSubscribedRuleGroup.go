...
func GetSubscribedRuleGroupOutput(ctx *pulumi.Context, args GetSubscribedRuleGroupOutputArgs, opts ...pulumi.InvokeOption) GetSubscribedRuleGroupResultOutput {
	...
	return ctx.InvokeOutput("aws:wafregional/getSubscribedRuleGroup:getSubscribedRuleGroup", args, GetSubscribedRuleGroupResultOutput{}, options).(GetSubscribedRuleGroupResultOutput)
}
