...
func LookupElasticIp(ctx *pulumi.Context, args *GetElasticIpArgs, opts ...pulumi.InvokeOption) (*GetElasticIpResult, error) {
...
type GetElasticIpArgs struct {
	...
	Filters *[]GetElasticIpFiltersArgs `pulumi:"filters"`
...
type GetElasticIpResult struct {
	...
	Filters *[]GetElasticIpFiltersResult `pulumi:"filters"`
...
type GetElasticIpFiltersArgs struct {
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
type GetElasticIpFiltersResult struct {
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
