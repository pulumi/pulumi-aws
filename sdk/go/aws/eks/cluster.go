...
type Cluster struct {
	...
	KubeApiServerConfig ClusterKubeApiServerConfigOutput `pulumi:"kubeApiServerConfig"`
	// Configuration block for customizing the Kubernetes controller manager. Detailed below.
	KubeControllerManagerConfig ClusterKubeControllerManagerConfigOutput `pulumi:"kubeControllerManagerConfig"`
	// Configuration block for customizing the Kubernetes scheduler. Detailed below.
	KubeSchedulerConfig ClusterKubeSchedulerConfigOutput `pulumi:"kubeSchedulerConfig"`
...
// Configuration block for customizing the Kubernetes API server. Detailed below.
func (o ClusterOutput) KubeApiServerConfig() ClusterKubeApiServerConfigOutput {
	return o.ApplyT(func(v *Cluster) ClusterKubeApiServerConfigOutput { return v.KubeApiServerConfig }).(ClusterKubeApiServerConfigOutput)
}

// Configuration block for customizing the Kubernetes controller manager. Detailed below.
func (o ClusterOutput) KubeControllerManagerConfig() ClusterKubeControllerManagerConfigOutput {
	return o.ApplyT(func(v *Cluster) ClusterKubeControllerManagerConfigOutput { return v.KubeControllerManagerConfig }).(ClusterKubeControllerManagerConfigOutput)
}

// Configuration block for customizing the Kubernetes scheduler. Detailed below.
func (o ClusterOutput) KubeSchedulerConfig() ClusterKubeSchedulerConfigOutput {
	return o.ApplyT(func(v *Cluster) ClusterKubeSchedulerConfigOutput { return v.KubeSchedulerConfig }).(ClusterKubeSchedulerConfigOutput)
}
