...
func NewTransitVirtualInterface(ctx *pulumi.Context,
	name string, args *TransitVirtualInterfaceArgs, opts ...pulumi.ResourceOpt) (*TransitVirtualInterface, error) {
	...
	s, err := ctx.RegisterResource("aws:directconnect/transitVirtualInterface:TransitVirtualInterface", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &TransitVirtualInterface{s: s}, nil
}
...
func GetTransitVirtualInterface(ctx *pulumi.Context,
	name string, id pulumi.ID, state *TransitVirtualInterfaceState, opts ...pulumi.ResourceOpt) (*TransitVirtualInterface, error) {
	inputs := make(map[string]interface{})
	if state != nil {
	...
	s, err := ctx.ReadResource("aws:directconnect/transitVirtualInterface:TransitVirtualInterface", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &TransitVirtualInterface{s: s}, nil
