...
//
// > This content is derived from https://github.com/terraform-providers/terraform-provider-aws/blob/master/website/docs/d/lb_target_group_current.html.markdown.
func LookupTargetGroup(ctx *pulumi.Context, args *GetTargetGroupArgs) (*GetTargetGroupResult, error) {
	...
	outputs, err := ctx.Invoke("aws:lb/getTargetGroup:getTargetGroup", inputs)
	if err != nil {
		return nil, err
	}
