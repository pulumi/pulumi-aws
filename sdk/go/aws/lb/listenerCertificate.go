...
func NewListenerCertificate(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("aws:lb/listenerCertificate:ListenerCertificate", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetListenerCertificate(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:lb/listenerCertificate:ListenerCertificate", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ListenerCertificate{s: s}, nil
