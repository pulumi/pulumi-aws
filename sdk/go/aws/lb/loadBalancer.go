...
type LoadBalancer struct {
	...
	EnablePrefixForIpv6SourceNat pulumi.StringOutput `pulumi:"enablePrefixForIpv6SourceNat"`
...
// Whether to use an IPv6 prefix from each subnet for source NAT. `ipAddressType` must be `dualstack`. Valid values: `on`, `off`.
func (o LoadBalancerOutput) EnablePrefixForIpv6SourceNat() pulumi.StringOutput {
	return o.ApplyT(func(v *LoadBalancer) pulumi.StringOutput { return v.EnablePrefixForIpv6SourceNat }).(pulumi.StringOutput)
}
