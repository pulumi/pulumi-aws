...
func NewTargetGroup(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("aws:lb/targetGroup:TargetGroup", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetTargetGroup(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:lb/targetGroup:TargetGroup", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &TargetGroup{s: s}, nil
