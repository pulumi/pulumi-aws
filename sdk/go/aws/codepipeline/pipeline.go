...
// return err
// }
// codepipelinePolicyPolicyDocument := pulumi.All(codepipelineBucket.Arn,codepipelineBucket.Arn,example.Arn).ApplyT(func(_args []interface{}) (iam.GetPolicyDocumentResult, error) {
...
// fmt.Sprintf("%v/*", codepipelineBucketArn1),
// },
// },
// {
// Effect: "Allow",
