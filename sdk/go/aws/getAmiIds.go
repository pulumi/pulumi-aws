...
func LookupAmiIds(ctx *pulumi.Context, args *GetAmiIdsArgs, opts ...pulumi.InvokeOption) (*GetAmiIdsResult, error) {
...
type GetAmiIdsArgs struct {
	...
	Filters *[]GetAmiIdsFiltersArgs `pulumi:"filters"`
...
type GetAmiIdsResult struct {
	ExecutableUsers *[]string `pulumi:"executableUsers"`
	Filters *[]GetAmiIdsFiltersResult `pulumi:"filters"`
...
type GetAmiIdsFiltersArgs struct {
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
type GetAmiIdsFiltersResult struct {
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
