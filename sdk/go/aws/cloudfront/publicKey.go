...
// Internal value used by CloudFront to allow future updates to the public key configuration.
func (o PublicKeyOutput) CallerReference() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PublicKey) pulumi.StringPtrOutput { return v.CallerReference }).(pulumi.StringPtrOutput)
}
...
// The current version of the public key. For example: `E2QWRUHAPOMQZL`.
func (o PublicKeyOutput) Etag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PublicKey) pulumi.StringPtrOutput { return v.Etag }).(pulumi.StringPtrOutput)
}
...
//
// **NOTE:** When setting `encodedKey` value, there needs a newline at the end of string. Otherwise, multiple runs of pulumi will want to recreate the `cloudfront.PublicKey` resource.
func (o PublicKeyOutput) NamePrefix() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *PublicKey) pulumi.StringPtrOutput { return v.NamePrefix }).(pulumi.StringPtrOutput)
}
