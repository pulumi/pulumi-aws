...
// Creation date of the SAML provider in RFC1123 format, e.g. `Mon, 02 Jan 2006 15:04:05 MST`.
func (o LookupSamlProviderResultOutput) CreateDate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSamlProviderResult) *string { return v.CreateDate }).(pulumi.StringPtrOutput)
}

// The provider-assigned unique ID for this managed resource.
func (o LookupSamlProviderResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSamlProviderResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// Name of the provider.
func (o LookupSamlProviderResultOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSamlProviderResult) *string { return v.Name }).(pulumi.StringPtrOutput)
}
...
// Expiration date and time for the SAML provider in RFC1123 format, e.g. `Mon, 02 Jan 2007 15:04:05 MST`.
func (o LookupSamlProviderResultOutput) ValidUntil() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSamlProviderResult) *string { return v.ValidUntil }).(pulumi.StringPtrOutput)
}
