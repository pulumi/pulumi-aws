...
func LookupRole(ctx *pulumi.Context, args *LookupRoleArgs, opts ...pulumi.InvokeOption) (*LookupRoleResult, error) {
	...
	if optsErr != nil {
		return &LookupRoleResult{}, optsErr
	}
	if len(invokeOpts.DependsOn) > 0 {
		return &LookupRoleResult{}, errors.New("DependsOn is not supported for direct form invoke LookupRole, use LookupRoleOutput instead")
	}
	if len(invokeOpts.DependsOnInputs) > 0 {
		return &LookupRoleResult{}, errors.New("DependsOnInputs is not supported for direct form invoke LookupRole, use LookupRoleOutput instead")
	}
...
func LookupRoleOutput(ctx *pulumi.Context, args LookupRoleOutputArgs, opts ...pulumi.InvokeOption) LookupRoleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupRoleResultOutput, error) {
			...
			opts = internal.PkgInvokeDefaultOpts(opts)
			var rv LookupRoleResult
			secret, deps, err := ctx.InvokePackageRawWithDeps("aws:iam/getRole:getRole", args, &rv, "", opts...)
			if err != nil {
				return LookupRoleResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(LookupRoleResultOutput)
			output = pulumi.OutputWithDependencies(ctx.Context(), output, deps...).(LookupRoleResultOutput)
			if secret {
