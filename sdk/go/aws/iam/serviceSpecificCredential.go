...
type ServiceSpecificCredential struct {
	...
	ServiceSpecificCredentialId pulumi.StringPtrOutput `pulumi:"serviceSpecificCredentialId"`
	...
	ServiceUserName pulumi.StringPtrOutput `pulumi:"serviceUserName"`
...
// The generated password for the service-specific credential.
func (o ServiceSpecificCredentialOutput) ServicePassword() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ServiceSpecificCredential) pulumi.StringPtrOutput { return v.ServicePassword }).(pulumi.StringPtrOutput)
}

// The unique identifier for the service-specific credential.
func (o ServiceSpecificCredentialOutput) ServiceSpecificCredentialId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ServiceSpecificCredential) pulumi.StringPtrOutput { return v.ServiceSpecificCredentialId }).(pulumi.StringPtrOutput)
}

// The generated user name for the service-specific credential. This value is generated by combining the IAM user's name combined with the ID number of the AWS account, as in `jane-at-123456789012`, for example.
func (o ServiceSpecificCredentialOutput) ServiceUserName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ServiceSpecificCredential) pulumi.StringPtrOutput { return v.ServiceUserName }).(pulumi.StringPtrOutput)
}
