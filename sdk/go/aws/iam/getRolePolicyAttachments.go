...
func GetRolePolicyAttachmentsOutput(ctx *pulumi.Context, args GetRolePolicyAttachmentsOutputArgs, opts ...pulumi.InvokeOption) GetRolePolicyAttachmentsResultOutput {
	...
	return ctx.InvokeOutput("aws:iam/getRolePolicyAttachments:getRolePolicyAttachments", args, GetRolePolicyAttachmentsResultOutput{}, options).(GetRolePolicyAttachmentsResultOutput)
}
