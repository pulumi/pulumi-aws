...
func NewOpenIdConnectProvider(ctx *pulumi.Context,
	...
	if args != nil {
		if i := args.ClientIdLists; i != nil { inputs["clientIdLists"] = i.ToStringArrayOutput() }
		if i := args.ThumbprintLists; i != nil { inputs["thumbprintLists"] = i.ToStringArrayOutput() }
...
func GetOpenIdConnectProvider(ctx *pulumi.Context,
	...
	if state != nil {
		...
		if i := state.ClientIdLists; i != nil { inputs["clientIdLists"] = i.ToStringArrayOutput() }
		if i := state.ThumbprintLists; i != nil { inputs["thumbprintLists"] = i.ToStringArrayOutput() }
...
type OpenIdConnectProviderState struct {
	...
	// A list of client IDs (also known as audiences). When a mobile or web app registers with an OpenID Connect provider, they establish a value that identifies the application. (This is the value that's sent as the clientId parameter on OAuth requests.)
	ClientIdLists pulumi.StringArrayInput `pulumi:"clientIdLists"`
	// A list of server certificate thumbprints for the OpenID Connect (OIDC) identity provider's server certificate(s). 
	ThumbprintLists pulumi.StringArrayInput `pulumi:"thumbprintLists"`
	// The URL of the identity provider. Corresponds to the _iss_ claim.
