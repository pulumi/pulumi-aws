...
// The ARN assigned by AWS for this provider.
func (o SamlProviderOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SamlProvider) pulumi.StringPtrOutput { return v.Arn }).(pulumi.StringPtrOutput)
}
...
// The expiration date and time for the SAML provider in RFC1123 format, e.g., `Mon, 02 Jan 2006 15:04:05 MST`.
func (o SamlProviderOutput) ValidUntil() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SamlProvider) pulumi.StringPtrOutput { return v.ValidUntil }).(pulumi.StringPtrOutput)
}
