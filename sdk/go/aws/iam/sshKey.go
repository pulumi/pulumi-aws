...
// import (
//
//	iam/sshKey "github.com/pulumi/pulumi-aws/sdk/v1/go/aws/iam/sshKey"
...
// userUser, err := iam/user.NewUser(ctx, "userUser", &iam/user.UserArgs{
// Path: "/",
// })
// if err != nil {
// return err
// }
// _, err = iam/sshKey.NewSshKey(ctx, "userSshKey", &iam/sshKey.SshKeyArgs{
