...
// The Amazon Resource Name (ARN) of the security group rule.
func (o SecurityGroupEgressRuleOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SecurityGroupEgressRule) pulumi.StringPtrOutput { return v.Arn }).(pulumi.StringPtrOutput)
}
...
// The ID of the security group rule.
func (o SecurityGroupEgressRuleOutput) SecurityGroupRuleId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SecurityGroupEgressRule) pulumi.StringPtrOutput { return v.SecurityGroupRuleId }).(pulumi.StringPtrOutput)
}
