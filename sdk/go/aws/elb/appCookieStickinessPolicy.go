...
func (i *AppCookieStickinessPolicy) ToOutput(ctx context.Context) pulumix.Output[*AppCookieStickinessPolicy] {
	return pulumix.Output[*AppCookieStickinessPolicy]{
		OutputState: i.ToAppCookieStickinessPolicyOutputWithContext(ctx).OutputState,
	}
}
...
func (i AppCookieStickinessPolicyArray) ToOutput(ctx context.Context) pulumix.Output[[]*AppCookieStickinessPolicy] {
	return pulumix.Output[[]*AppCookieStickinessPolicy]{
		OutputState: i.ToAppCookieStickinessPolicyArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i AppCookieStickinessPolicyMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*AppCookieStickinessPolicy] {
	return pulumix.Output[map[string]*AppCookieStickinessPolicy]{
		OutputState: i.ToAppCookieStickinessPolicyMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o AppCookieStickinessPolicyArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*AppCookieStickinessPolicy] {
	return pulumix.Output[[]*AppCookieStickinessPolicy]{
		OutputState: o.OutputState,
	}
}
...
func (o AppCookieStickinessPolicyMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*AppCookieStickinessPolicy] {
	return pulumix.Output[map[string]*AppCookieStickinessPolicy]{
		OutputState: o.OutputState,
	}
}
