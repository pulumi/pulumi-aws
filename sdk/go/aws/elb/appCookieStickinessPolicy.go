...
//
// > This content is derived from https://github.com/terraform-providers/terraform-provider-aws/blob/master/website/docs/r/app_cookie_stickiness_policy_current.html.markdown.
...
func NewAppCookieStickinessPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("aws:elb/appCookieStickinessPolicy:AppCookieStickinessPolicy", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetAppCookieStickinessPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:elb/appCookieStickinessPolicy:AppCookieStickinessPolicy", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &AppCookieStickinessPolicy{s: s}, nil
