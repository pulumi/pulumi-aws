...
type LoadBalancer struct {
	...
	SourceSecurityGroup pulumi.StringPtrOutput `pulumi:"sourceSecurityGroup"`
...
// part of your inbound rules for your load balancer's back-end application
// instances. Use this for Classic or Default VPC only.
func (o LoadBalancerOutput) SourceSecurityGroup() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LoadBalancer) pulumi.StringPtrOutput { return v.SourceSecurityGroup }).(pulumi.StringPtrOutput)
}

// The ID of the security group that you can use as
// part of your inbound rules for your load balancer's back-end application
// instances. Only available on ELBs launched in a VPC.
func (o LoadBalancerOutput) SourceSecurityGroupId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *LoadBalancer) pulumi.StringPtrOutput { return v.SourceSecurityGroupId }).(pulumi.StringPtrOutput)
}
