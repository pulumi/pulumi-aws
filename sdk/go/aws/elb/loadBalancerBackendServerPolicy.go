...
//
// > This content is derived from https://github.com/terraform-providers/terraform-provider-aws/blob/master/website/docs/r/load_balancer_backend_server_policy_current.html.markdown.
...
func NewLoadBalancerBackendServerPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("aws:elb/loadBalancerBackendServerPolicy:LoadBalancerBackendServerPolicy", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetLoadBalancerBackendServerPolicy(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:elb/loadBalancerBackendServerPolicy:LoadBalancerBackendServerPolicy", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &LoadBalancerBackendServerPolicy{s: s}, nil
