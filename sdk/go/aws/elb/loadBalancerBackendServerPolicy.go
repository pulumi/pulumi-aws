...
func NewLoadBalancerBackendServerPolicy(ctx *pulumi.Context,
	...
	if args != nil {
		if i := args.InstancePort; i != nil { inputs["instancePort"] = i.ToIntOutput() }
	...
	err := ctx.RegisterResource("aws:elb/loadBalancerBackendServerPolicy:LoadBalancerBackendServerPolicy", name, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoadBalancerBackendServerPolicy(ctx *pulumi.Context,
	...
	inputs := map[string]pulumi.Input{}
	if state != nil {
		if i := state.InstancePort; i != nil { inputs["instancePort"] = i.ToIntOutput() }
	...
	var resource LoadBalancerBackendServerPolicy
	err := ctx.ReadResource("aws:elb/loadBalancerBackendServerPolicy:LoadBalancerBackendServerPolicy", name, id, inputs, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
