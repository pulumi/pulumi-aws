...
type FileSystem struct {
	...
	NumberOfMountTargets pulumi.IntPtrOutput `pulumi:"numberOfMountTargets"`
...
// Amazon Resource Name of the file system.
func (o FileSystemOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FileSystem) pulumi.StringPtrOutput { return v.Arn }).(pulumi.StringPtrOutput)
}

// The identifier of the Availability Zone in which the file system's One Zone storage classes exist.
func (o FileSystemOutput) AvailabilityZoneId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FileSystem) pulumi.StringPtrOutput { return v.AvailabilityZoneId }).(pulumi.StringPtrOutput)
}
...
// The DNS name for the filesystem per [documented convention](http://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html).
func (o FileSystemOutput) DnsName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FileSystem) pulumi.StringPtrOutput { return v.DnsName }).(pulumi.StringPtrOutput)
}
...
// The value of the file system's `Name` tag.
func (o FileSystemOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FileSystem) pulumi.StringPtrOutput { return v.Name }).(pulumi.StringPtrOutput)
}

// The current number of mount targets that the file system has.
func (o FileSystemOutput) NumberOfMountTargets() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *FileSystem) pulumi.IntPtrOutput { return v.NumberOfMountTargets }).(pulumi.IntPtrOutput)
}

// The AWS account that created the file system. If the file system was createdby an IAM user, the parent account to which the user belongs is the owner.
func (o FileSystemOutput) OwnerId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FileSystem) pulumi.StringPtrOutput { return v.OwnerId }).(pulumi.StringPtrOutput)
}
