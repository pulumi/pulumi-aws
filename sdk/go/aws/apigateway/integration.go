...
func NewIntegration(ctx *pulumi.Context,
	...
	if args != nil {
		if i := args.CacheKeyParameters; i != nil { inputs["cacheKeyParameters"] = i.ToStringArrayOutput() }
		if i := args.CacheNamespace; i != nil { inputs["cacheNamespace"] = i.ToStringOutput() }
		...
		if i := args.Credentials; i != nil { inputs["credentials"] = i.ToStringOutput() }
		if i := args.HttpMethod; i != nil { inputs["httpMethod"] = i.ToStringOutput() }
		if i := args.IntegrationHttpMethod; i != nil { inputs["integrationHttpMethod"] = i.ToStringOutput() }
		if i := args.PassthroughBehavior; i != nil { inputs["passthroughBehavior"] = i.ToStringOutput() }
		if i := args.RequestParameters; i != nil { inputs["requestParameters"] = i.ToStringMapOutput() }
		if i := args.RequestTemplates; i != nil { inputs["requestTemplates"] = i.ToStringMapOutput() }
		if i := args.ResourceId; i != nil { inputs["resourceId"] = i.ToStringOutput() }
		if i := args.RestApi; i != nil { inputs["restApi"] = i.ToStringOutput() }
		if i := args.TimeoutMilliseconds; i != nil { inputs["timeoutMilliseconds"] = i.ToIntOutput() }
...
func GetIntegration(ctx *pulumi.Context,
	...
	inputs := map[string]pulumi.Input{}
	if state != nil {
		if i := state.CacheKeyParameters; i != nil { inputs["cacheKeyParameters"] = i.ToStringArrayOutput() }
		if i := state.CacheNamespace; i != nil { inputs["cacheNamespace"] = i.ToStringOutput() }
		...
		if i := state.Credentials; i != nil { inputs["credentials"] = i.ToStringOutput() }
		if i := state.HttpMethod; i != nil { inputs["httpMethod"] = i.ToStringOutput() }
		if i := state.IntegrationHttpMethod; i != nil { inputs["integrationHttpMethod"] = i.ToStringOutput() }
		if i := state.PassthroughBehavior; i != nil { inputs["passthroughBehavior"] = i.ToStringOutput() }
		if i := state.RequestParameters; i != nil { inputs["requestParameters"] = i.ToStringMapOutput() }
		if i := state.RequestTemplates; i != nil { inputs["requestTemplates"] = i.ToStringMapOutput() }
		if i := state.ResourceId; i != nil { inputs["resourceId"] = i.ToStringOutput() }
		if i := state.RestApi; i != nil { inputs["restApi"] = i.ToStringOutput() }
		if i := state.TimeoutMilliseconds; i != nil { inputs["timeoutMilliseconds"] = i.ToIntOutput() }
