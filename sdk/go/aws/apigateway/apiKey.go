...
// ARN
func (o ApiKeyOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ApiKey) pulumi.StringPtrOutput { return v.Arn }).(pulumi.StringPtrOutput)
}

// Creation date of the API key
func (o ApiKeyOutput) CreatedDate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ApiKey) pulumi.StringPtrOutput { return v.CreatedDate }).(pulumi.StringPtrOutput)
}
...
// Last update date of the API key
func (o ApiKeyOutput) LastUpdatedDate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ApiKey) pulumi.StringPtrOutput { return v.LastUpdatedDate }).(pulumi.StringPtrOutput)
}
