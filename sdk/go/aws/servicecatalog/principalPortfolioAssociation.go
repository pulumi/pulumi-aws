...
// ## Import
//
// Using `pulumi import`, import `servicecatalog.PrincipalPortfolioAssociation` using `acceptLanguage`, `principalArn`, `portfolioId`, and `principalType` separated by a comma. For example:
//
// ```sh
