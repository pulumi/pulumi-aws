...
//				return err
//			}
//			ctx.Export("arn", notImplemented("tolist(data.aws_ssoadmin_instances.example.arns)")[0])
//			ctx.Export("identityStoreId", notImplemented("tolist(data.aws_ssoadmin_instances.example.identity_store_ids)")[0])
//			return nil
//		})
//	}
//
