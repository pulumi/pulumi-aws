...
//
// > This content is derived from https://github.com/terraform-providers/terraform-provider-aws/blob/master/website/docs/r/alb_listener_rule_current.html.markdown.
...
func NewListenerRule(ctx *pulumi.Context,
	...
	inputs["arn"] = nil
	s, err := ctx.RegisterResource("aws:alb/listenerRule:ListenerRule", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetListenerRule(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:alb/listenerRule:ListenerRule", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ListenerRule{s: s}, nil
