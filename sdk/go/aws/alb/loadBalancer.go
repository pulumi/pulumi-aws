...
func NewLoadBalancer(ctx *pulumi.Context,
	...
	inputs["vpcId"] = nil
	inputs["zoneId"] = nil
	s, err := ctx.RegisterResource("aws:alb/loadBalancer:LoadBalancer", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetLoadBalancer(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:alb/loadBalancer:LoadBalancer", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &LoadBalancer{s: s}, nil
