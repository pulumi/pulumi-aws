...
type KeyPair struct {
	...
	EncryptedFingerprint pulumi.StringPtrOutput `pulumi:"encryptedFingerprint"`
	...
	EncryptedPrivateKey pulumi.StringPtrOutput `pulumi:"encryptedPrivateKey"`
...
// The MD5 public key fingerprint for the encrypted private key.
func (o KeyPairOutput) EncryptedFingerprint() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KeyPair) pulumi.StringPtrOutput { return v.EncryptedFingerprint }).(pulumi.StringPtrOutput)
}

// the private key material, base 64 encoded and encrypted with the given `pgpKey`. This is only populated when creating a new key and `pgpKey` is supplied.
func (o KeyPairOutput) EncryptedPrivateKey() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *KeyPair) pulumi.StringPtrOutput { return v.EncryptedPrivateKey }).(pulumi.StringPtrOutput)
}
