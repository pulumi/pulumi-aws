...
// return err
// }
// allowAccessFromAnotherAccountPolicyDocument := pulumi.All(example.Arn,example.Arn).ApplyT(func(_args []interface{}) (iam.GetPolicyDocumentResult, error) {
// exampleArn := _args[0].(*string)
// exampleArn1 := _args[1].(*string)
