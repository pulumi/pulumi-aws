...
//	rds/proxyDefaultTargetGroup "github.com/pulumi/pulumi-aws/sdk/v1/go/aws/rds/proxyDefaultTargetGroup"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
// func main() {
// pulumi.Run(func(ctx *pulumi.Context) error {
// exampleProxy, err := rds/proxy.NewProxy(ctx, "exampleProxy", &rds/proxy.ProxyArgs{
// DebugLogging: false,
// EngineFamily: "MYSQL",
...
// return err
// }
// _, err = rds/proxyDefaultTargetGroup.NewProxyDefaultTargetGroup(ctx, "exampleProxyDefaultTargetGroup", &rds/proxyDefaultTargetGroup.ProxyDefaultTargetGroupArgs{
// DbProxyName: exampleProxy.Name,
// ConnectionPoolConfig: map[string]interface{}{
