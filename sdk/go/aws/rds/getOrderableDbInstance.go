...
func (o GetOrderableDbInstanceResultOutput) AvailabilityZoneGroup() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetOrderableDbInstanceResult) *string { return v.AvailabilityZoneGroup }).(pulumi.StringPtrOutput)
}
...
// Whether a DB instance supports RDS on Outposts.
func (o GetOrderableDbInstanceResultOutput) OutpostCapable() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetOrderableDbInstanceResult) *bool { return v.OutpostCapable }).(pulumi.BoolPtrOutput)
}
...
func (o GetOrderableDbInstanceResultOutput) SupportsGlobalDatabases() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetOrderableDbInstanceResult) *bool { return v.SupportsGlobalDatabases }).(pulumi.BoolPtrOutput)
}
...
func (o GetOrderableDbInstanceResultOutput) SupportsKerberosAuthentication() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetOrderableDbInstanceResult) *bool { return v.SupportsKerberosAuthentication }).(pulumi.BoolPtrOutput)
}
...
func (o GetOrderableDbInstanceResultOutput) SupportsStorageAutoscaling() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetOrderableDbInstanceResult) *bool { return v.SupportsStorageAutoscaling }).(pulumi.BoolPtrOutput)
}
