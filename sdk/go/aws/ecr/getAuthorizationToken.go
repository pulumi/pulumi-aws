...
func GetAuthorizationTokenOutput(ctx *pulumi.Context, args GetAuthorizationTokenOutputArgs, opts ...pulumi.InvokeOption) GetAuthorizationTokenResultOutput {
	...
	return ctx.InvokeOutput("aws:ecr/getAuthorizationToken:getAuthorizationToken", args, GetAuthorizationTokenResultOutput{}, options).(GetAuthorizationTokenResultOutput)
}
