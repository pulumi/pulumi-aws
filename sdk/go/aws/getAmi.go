...
func LookupAmi(ctx *pulumi.Context, args *GetAmiArgs, opts ...pulumi.InvokeOption) (*GetAmiResult, error) {
	var rv GetAmiResult
...
type GetAmiArgs struct {
	...
	Filters *[]GetAmiFiltersArgs `pulumi:"filters"`
...
type GetAmiResult struct {
	...
	// instance stores).
	BlockDeviceMappings []GetAmiBlockDeviceMappingsResult `pulumi:"blockDeviceMappings"`
	...
	ExecutableUsers *[]string `pulumi:"executableUsers"`
	Filters *[]GetAmiFiltersResult `pulumi:"filters"`
	...
	ProductCodes []GetAmiProductCodesResult `pulumi:"productCodes"`
...
type GetAmiBlockDeviceMappingsResult struct {
	DeviceName string `pulumi:"deviceName"`
	Ebs map[string]string `pulumi:"ebs"`
	NoDevice string `pulumi:"noDevice"`
	VirtualName string `pulumi:"virtualName"`
}
type GetAmiFiltersArgs struct {
	// The name of the AMI that was provided during image creation.
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
type GetAmiFiltersResult struct {
	// The name of the AMI that was provided during image creation.
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
type GetAmiProductCodesResult struct {
