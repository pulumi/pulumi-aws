...
type Group struct {
	...
	PredictedCapacity pulumi.IntPtrOutput `pulumi:"predictedCapacity"`
	...
	WarmPoolSize pulumi.IntPtrOutput `pulumi:"warmPoolSize"`
}
...
// Amount of time, in seconds, after a scaling activity completes before another scaling activity can start.
func (o GroupOutput) DefaultCooldown() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.IntPtrOutput { return v.DefaultCooldown }).(pulumi.IntPtrOutput)
}
...
// should be running in the group. (See also Waiting for
// Capacity below.)
func (o GroupOutput) DesiredCapacity() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.IntPtrOutput { return v.DesiredCapacity }).(pulumi.IntPtrOutput)
}
...
// "EC2" or "ELB". Controls how health checking is done.
func (o GroupOutput) HealthCheckType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.StringPtrOutput { return v.HealthCheckType }).(pulumi.StringPtrOutput)
}
...
// Creates a unique name beginning with the specified
// prefix. Conflicts with `name`.
func (o GroupOutput) NamePrefix() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.StringPtrOutput { return v.NamePrefix }).(pulumi.StringPtrOutput)
}
...
// Predicted capacity of the group.
func (o GroupOutput) PredictedCapacity() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.IntPtrOutput { return v.PredictedCapacity }).(pulumi.IntPtrOutput)
}
...
// ARN of the service-linked role that the ASG will use to call other AWS services
func (o GroupOutput) ServiceLinkedRoleArn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.StringPtrOutput { return v.ServiceLinkedRoleArn }).(pulumi.StringPtrOutput)
}
...
// Current size of the warm pool.
func (o GroupOutput) WarmPoolSize() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *Group) pulumi.IntPtrOutput { return v.WarmPoolSize }).(pulumi.IntPtrOutput)
}
