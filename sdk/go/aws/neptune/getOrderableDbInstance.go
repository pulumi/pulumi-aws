...
func GetOrderableDbInstanceOutput(ctx *pulumi.Context, args GetOrderableDbInstanceOutputArgs, opts ...pulumi.InvokeOption) GetOrderableDbInstanceResultOutput {
	...
	return ctx.InvokeOutput("aws:neptune/getOrderableDbInstance:getOrderableDbInstance", args, GetOrderableDbInstanceResultOutput{}, options).(GetOrderableDbInstanceResultOutput)
}
