...
func NewListenerCertificate(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("aws:applicationloadbalancing/listenerCertificate:ListenerCertificate", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetListenerCertificate(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:applicationloadbalancing/listenerCertificate:ListenerCertificate", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &ListenerCertificate{s: s}, nil
