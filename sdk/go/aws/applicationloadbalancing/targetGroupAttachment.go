...
func NewTargetGroupAttachment(ctx *pulumi.Context,
	...
	s, err := ctx.RegisterResource("aws:applicationloadbalancing/targetGroupAttachment:TargetGroupAttachment", name, true, inputs, opts...)
	if err != nil {
		return nil, err
	}
...
func GetTargetGroupAttachment(ctx *pulumi.Context,
	...
	s, err := ctx.ReadResource("aws:applicationloadbalancing/targetGroupAttachment:TargetGroupAttachment", name, id, inputs, opts...)
	if err != nil {
		return nil, err
	}
	return &TargetGroupAttachment{s: s}, nil
