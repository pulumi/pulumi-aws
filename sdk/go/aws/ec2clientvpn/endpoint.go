...
type Endpoint struct {
	...
	ClientConnectOptions EndpointClientConnectOptionsPtrOutput `pulumi:"clientConnectOptions"`
	// Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.
	ClientLoginBannerOptions EndpointClientLoginBannerOptionsPtrOutput `pulumi:"clientLoginBannerOptions"`
	...
	SelfServicePortalUrl pulumi.StringPtrOutput `pulumi:"selfServicePortalUrl"`
...
// The options for managing connection authorization for new client connections.
func (o EndpointOutput) ClientConnectOptions() EndpointClientConnectOptionsPtrOutput {
	return o.ApplyT(func(v *Endpoint) EndpointClientConnectOptionsPtrOutput { return v.ClientConnectOptions }).(EndpointClientConnectOptionsPtrOutput)
}

// Options for enabling a customizable text banner that will be displayed on AWS provided clients when a VPN session is established.
func (o EndpointOutput) ClientLoginBannerOptions() EndpointClientLoginBannerOptionsPtrOutput {
	return o.ApplyT(func(v *Endpoint) EndpointClientLoginBannerOptionsPtrOutput { return v.ClientLoginBannerOptions }).(EndpointClientLoginBannerOptionsPtrOutput)
}
...
// The DNS name to be used by clients when establishing their VPN session.
func (o EndpointOutput) DnsName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Endpoint) pulumi.StringPtrOutput { return v.DnsName }).(pulumi.StringPtrOutput)
}
...
// The URL of the self-service portal.
func (o EndpointOutput) SelfServicePortalUrl() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Endpoint) pulumi.StringPtrOutput { return v.SelfServicePortalUrl }).(pulumi.StringPtrOutput)
}
...
// The ID of the VPC to associate with the Client VPN endpoint. If no security group IDs are specified in the request, the default security group for the VPC is applied.
func (o EndpointOutput) VpcId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Endpoint) pulumi.StringPtrOutput { return v.VpcId }).(pulumi.StringPtrOutput)
}
