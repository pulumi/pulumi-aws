...
func LookupFunction(ctx *pulumi.Context, args *GetFunctionArgs, opts ...pulumi.InvokeOption) (*GetFunctionResult, error) {
...
type GetFunctionResult struct {
	...
	DeadLetterConfig GetFunctionDeadLetterConfigResult `pulumi:"deadLetterConfig"`
	// Description of what your Lambda Function does.
	Description string `pulumi:"description"`
	// The Lambda environment's configuration settings.
	Environment GetFunctionEnvironmentResult `pulumi:"environment"`
	FunctionName string `pulumi:"functionName"`
	...
	TracingConfig GetFunctionTracingConfigResult `pulumi:"tracingConfig"`
	// The version of the Lambda function.
	Version string `pulumi:"version"`
	// VPC configuration associated with your Lambda function.
	VpcConfig GetFunctionVpcConfigResult `pulumi:"vpcConfig"`
	// id is the provider-assigned unique ID for this managed resource.
	Id string `pulumi:"id"`
}
type GetFunctionDeadLetterConfigResult struct {
	TargetArn string `pulumi:"targetArn"`
}
type GetFunctionEnvironmentResult struct {
	Variables map[string]string `pulumi:"variables"`
}
type GetFunctionTracingConfigResult struct {
	Mode string `pulumi:"mode"`
}
type GetFunctionVpcConfigResult struct {
