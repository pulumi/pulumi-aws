...
func LookupVpcAttachmentOutput(ctx *pulumi.Context, args LookupVpcAttachmentOutputArgs, opts ...pulumi.InvokeOption) LookupVpcAttachmentResultOutput {
	...
	return ctx.InvokeOutput("aws:ec2transitgateway/getVpcAttachment:getVpcAttachment", args, LookupVpcAttachmentResultOutput{}, options).(LookupVpcAttachmentResultOutput)
}
