...
// ### Base Policy Example
//
// The base policy created by `createBasePolicy` looks like the following. This base policy is overridden by the policy you specify in the `networkmanager.CoreNetworkPolicyAttachment` resource.
//
// ## Import
//
