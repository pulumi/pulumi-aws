...
//
// > **Note:** Granting access to roles in target accounts is done with `accountaccess.Entitlement`. Each target role must trust the Account Access service in its `assumeRolePolicy` — see that resource's documentation for the required trust policy.
//
// ## Example Usage
//
// ### Basic Usage
