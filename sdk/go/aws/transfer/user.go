...
//
// > **NOTE:** We suggest using `jsonencode()` or `iam.getPolicyDocument` when assigning a value to `policy`. They seamlessly translate Terraform language into JSON, enabling you to maintain consistency within your configuration without the need for context switches. Also, you can sidestep potential complications arising from formatting discrepancies, whitespace inconsistencies, and other nuances inherent to JSON.
//
// ## Example Usage
//
// ```go
...
//				Role:   fooRole.ID(),
//				Policy: pulumi.String(pulumi.String(foo.Json)),
//			})
//			if err != nil {
//				return err
//			}
