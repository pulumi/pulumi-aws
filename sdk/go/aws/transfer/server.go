...
// Amazon Resource Name (ARN) of Transfer Server
func (o ServerOutput) Arn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Server) pulumi.StringPtrOutput { return v.Arn }).(pulumi.StringPtrOutput)
}
...
// The endpoint of the Transfer Server (e.g., `s-12345678.server.transfer.REGION.amazonaws.com`)
func (o ServerOutput) Endpoint() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Server) pulumi.StringPtrOutput { return v.Endpoint }).(pulumi.StringPtrOutput)
}
...
// This value contains the message-digest algorithm (MD5) hash of the server's host key. This value is equivalent to the output of the `ssh-keygen -l -E md5 -f my-new-server-key` command.
func (o ServerOutput) HostKeyFingerprint() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Server) pulumi.StringPtrOutput { return v.HostKeyFingerprint }).(pulumi.StringPtrOutput)
}
