...
type StackSetInstance struct {
	...
	OrganizationalUnitId pulumi.StringPtrOutput `pulumi:"organizationalUnitId"`
...
// Target AWS Account ID to create a Stack based on the StackSet. Defaults to current account.
func (o StackSetInstanceOutput) AccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StackSetInstance) pulumi.StringPtrOutput { return v.AccountId }).(pulumi.StringPtrOutput)
}
...
// Organizational unit ID in which the stack is deployed.
func (o StackSetInstanceOutput) OrganizationalUnitId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StackSetInstance) pulumi.StringPtrOutput { return v.OrganizationalUnitId }).(pulumi.StringPtrOutput)
}
...
// Target AWS Region to create a Stack based on the StackSet. Defaults to current region.
func (o StackSetInstanceOutput) Region() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StackSetInstance) pulumi.StringPtrOutput { return v.Region }).(pulumi.StringPtrOutput)
}
...
// Stack identifier.
func (o StackSetInstanceOutput) StackId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *StackSetInstance) pulumi.StringPtrOutput { return v.StackId }).(pulumi.StringPtrOutput)
}
