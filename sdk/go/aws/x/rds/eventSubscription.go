...
type EventSubscription struct {
	...
	SnsTopic pulumix.Output[string] `pulumi:"snsTopic"`
...
// The SNS topic to send events to.
func (o EventSubscriptionOutput) SnsTopic() pulumix.Output[string] {
	value := pulumix.Apply[EventSubscription](o, func(v EventSubscription) pulumix.Output[string] { return v.SnsTopic })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}
