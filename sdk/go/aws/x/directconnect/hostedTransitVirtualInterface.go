...
// The address family for the BGP peer. ` ipv4  ` or `ipv6`.
func (o HostedTransitVirtualInterfaceOutput) AddressFamily() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.AddressFamily })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The IPv4 CIDR address to use to send traffic to Amazon. Required for IPv4 BGP peers.
func (o HostedTransitVirtualInterfaceOutput) AmazonAddress() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.AmazonAddress })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

func (o HostedTransitVirtualInterfaceOutput) AmazonSideAsn() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.AmazonSideAsn })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The ARN of the virtual interface.
func (o HostedTransitVirtualInterfaceOutput) Arn() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.Arn })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The Direct Connect endpoint on which the virtual interface terminates.
func (o HostedTransitVirtualInterfaceOutput) AwsDevice() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.AwsDevice })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The autonomous system (AS) number for Border Gateway Protocol (BGP) configuration.
func (o HostedTransitVirtualInterfaceOutput) BgpAsn() pulumix.Output[int] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[int] { return v.BgpAsn })
	return pulumix.Flatten[int, pulumix.Output[int]](value)
}

// The authentication key for BGP configuration.
func (o HostedTransitVirtualInterfaceOutput) BgpAuthKey() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.BgpAuthKey })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The ID of the Direct Connect connection (or LAG) on which to create the virtual interface.
func (o HostedTransitVirtualInterfaceOutput) ConnectionId() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.ConnectionId })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The IPv4 CIDR destination address to which Amazon should send traffic. Required for IPv4 BGP peers.
func (o HostedTransitVirtualInterfaceOutput) CustomerAddress() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.CustomerAddress })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// Indicates whether jumbo frames (8500 MTU) are supported.
func (o HostedTransitVirtualInterfaceOutput) JumboFrameCapable() pulumix.Output[bool] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[bool] { return v.JumboFrameCapable })
	return pulumix.Flatten[bool, pulumix.Output[bool]](value)
}

// The maximum transmission unit (MTU) is the size, in bytes, of the largest permissible packet that can be passed over the connection. The MTU of a virtual transit interface can be either `1500` or `8500` (jumbo frames). Default is `1500`.
func (o HostedTransitVirtualInterfaceOutput) Mtu() pulumix.Output[*int] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[*int] { return v.Mtu })
	return pulumix.Flatten[*int, pulumix.Output[*int]](value)
}

// The name for the virtual interface.
func (o HostedTransitVirtualInterfaceOutput) Name() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.Name })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The AWS account that will own the new virtual interface.
func (o HostedTransitVirtualInterfaceOutput) OwnerAccountId() pulumix.Output[string] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[string] { return v.OwnerAccountId })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The VLAN ID.
func (o HostedTransitVirtualInterfaceOutput) Vlan() pulumix.Output[int] {
	value := pulumix.Apply[HostedTransitVirtualInterface](o, func(v HostedTransitVirtualInterface) pulumix.Output[int] { return v.Vlan })
	return pulumix.Flatten[int, pulumix.Output[int]](value)
}
