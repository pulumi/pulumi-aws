...
type DataCatalogEncryptionSettings struct {
	...
	DataCatalogEncryptionSettings pulumix.GPtrOutput[DataCatalogEncryptionSettingsDataCatalogEncryptionSettings, DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutput] `pulumi:"dataCatalogEncryptionSettings"`
}
...
type DataCatalogEncryptionSettingsState struct {
	...
	// The security configuration to set. see Data Catalog Encryption Settings.
	DataCatalogEncryptionSettings pulumix.Input[*DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsArgs]
}
...
// The ID of the Data Catalog to set the security configuration for. If none is provided, the AWS account ID is used by default.
func (o DataCatalogEncryptionSettingsOutput) CatalogId() pulumix.Output[string] {
	value := pulumix.Apply[DataCatalogEncryptionSettings](o, func(v DataCatalogEncryptionSettings) pulumix.Output[string] { return v.CatalogId })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The security configuration to set. see Data Catalog Encryption Settings.
func (o DataCatalogEncryptionSettingsOutput) DataCatalogEncryptionSettings() pulumix.GPtrOutput[DataCatalogEncryptionSettingsDataCatalogEncryptionSettings, DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutput] {
	value := pulumix.Apply[DataCatalogEncryptionSettings](o, func(v DataCatalogEncryptionSettings) pulumix.GPtrOutput[DataCatalogEncryptionSettingsDataCatalogEncryptionSettings, DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutput] {
		return v.DataCatalogEncryptionSettings
	})
	unwrapped := pulumix.Flatten[*DataCatalogEncryptionSettingsDataCatalogEncryptionSettings, pulumix.GPtrOutput[DataCatalogEncryptionSettingsDataCatalogEncryptionSettings, DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutput]](value)
	return pulumix.GPtrOutput[DataCatalogEncryptionSettingsDataCatalogEncryptionSettings, DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsOutput]{OutputState: unwrapped.OutputState}
}
