...
func (args LookupPolicyOutputArgs) ToOutput() pulumix.Output[*LookupPolicyArgs] {
	...
	return pulumix.Apply[[]any](allArgs, func(resolvedArgs []interface{}) *LookupPolicyArgs {
		return &LookupPolicyArgs{
			PolicyId: resolvedArgs[0].(string),
		}
	})
}
...
func (o LookupPolicyResultOutput) AwsManaged() pulumix.Output[bool] {
	return pulumix.Apply[*LookupPolicyResult](o, func(v *LookupPolicyResult) bool { return v.AwsManaged })
}

func (o LookupPolicyResultOutput) Content() pulumix.Output[string] {
	return pulumix.Apply[*LookupPolicyResult](o, func(v *LookupPolicyResult) string { return v.Content })
}
...
func (o LookupPolicyResultOutput) Type() pulumix.Output[string] {
	return pulumix.Apply[*LookupPolicyResult](o, func(v *LookupPolicyResult) string { return v.Type })
}
