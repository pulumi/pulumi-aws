...
type EipAssociation struct {
	...
	AllowReassociation pulumix.Output[*bool] `pulumi:"allowReassociation"`
...
type EipAssociationState struct {
	...
	// Whether to allow an Elastic IP to
	// be re-associated. Defaults to `true` in VPC.
	AllowReassociation pulumix.Input[*bool]
	// The ID of the instance. This is required for
	// EC2-Classic. For EC2-VPC, you can specify either the instance ID or the
	// network interface ID, but not both. The operation fails if you specify an
	// instance ID unless exactly one network interface is attached.
...
// The allocation ID. This is required for EC2-VPC.
func (o EipAssociationOutput) AllocationId() pulumix.Output[string] {
	value := pulumix.Apply[EipAssociation](o, func(v EipAssociation) pulumix.Output[string] { return v.AllocationId })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// Whether to allow an Elastic IP to
// be re-associated. Defaults to `true` in VPC.
func (o EipAssociationOutput) AllowReassociation() pulumix.Output[*bool] {
	value := pulumix.Apply[EipAssociation](o, func(v EipAssociation) pulumix.Output[*bool] { return v.AllowReassociation })
...
// network interface ID, but not both. The operation fails if you specify an
// instance ID unless exactly one network interface is attached.
func (o EipAssociationOutput) InstanceId() pulumix.Output[string] {
	value := pulumix.Apply[EipAssociation](o, func(v EipAssociation) pulumix.Output[string] { return v.InstanceId })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}
...
// instance has more than one network interface, you must specify a network
// interface ID.
func (o EipAssociationOutput) NetworkInterfaceId() pulumix.Output[string] {
	value := pulumix.Apply[EipAssociation](o, func(v EipAssociation) pulumix.Output[string] { return v.NetworkInterfaceId })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}
...
// specified, the Elastic IP address is associated with the primary private IP
// address.
func (o EipAssociationOutput) PrivateIpAddress() pulumix.Output[string] {
	value := pulumix.Apply[EipAssociation](o, func(v EipAssociation) pulumix.Output[string] { return v.PrivateIpAddress })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The Elastic IP address. This is required for EC2-Classic.
func (o EipAssociationOutput) PublicIp() pulumix.Output[string] {
	value := pulumix.Apply[EipAssociation](o, func(v EipAssociation) pulumix.Output[string] { return v.PublicIp })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}
