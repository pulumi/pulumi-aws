...
// The id of the `ec2.RouteTable` to propagate routes into.
func (o VpnGatewayRoutePropagationOutput) RouteTableId() pulumix.Output[string] {
	value := pulumix.Apply[VpnGatewayRoutePropagation](o, func(v VpnGatewayRoutePropagation) pulumix.Output[string] { return v.RouteTableId })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The id of the `ec2.VpnGateway` to propagate routes from.
func (o VpnGatewayRoutePropagationOutput) VpnGatewayId() pulumix.Output[string] {
	value := pulumix.Apply[VpnGatewayRoutePropagation](o, func(v VpnGatewayRoutePropagation) pulumix.Output[string] { return v.VpnGatewayId })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}
