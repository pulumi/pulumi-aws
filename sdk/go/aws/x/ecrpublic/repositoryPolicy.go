...
// Name of the repository to apply the policy.
func (o RepositoryPolicyOutput) RepositoryName() pulumix.Output[string] {
	value := pulumix.Apply[RepositoryPolicy](o, func(v RepositoryPolicy) pulumix.Output[string] { return v.RepositoryName })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}
