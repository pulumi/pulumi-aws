...
// ARN of the Service Network.
func (o ServiceNetworkOutput) Arn() pulumix.Output[string] {
	value := pulumix.Apply[ServiceNetwork](o, func(v ServiceNetwork) pulumix.Output[string] { return v.Arn })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// Type of IAM policy. Either `NONE` or `AWS_IAM`.
func (o ServiceNetworkOutput) AuthType() pulumix.Output[string] {
	value := pulumix.Apply[ServiceNetwork](o, func(v ServiceNetwork) pulumix.Output[string] { return v.AuthType })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}
...
//
// The following arguments are optional:
func (o ServiceNetworkOutput) Name() pulumix.Output[string] {
	value := pulumix.Apply[ServiceNetwork](o, func(v ServiceNetwork) pulumix.Output[string] { return v.Name })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// Key-value mapping of resource tags. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
func (o ServiceNetworkOutput) Tags() pulumix.MapOutput[string] {
	value := pulumix.Apply[ServiceNetwork](o, func(v ServiceNetwork) pulumix.MapOutput[string] { return v.Tags })
	unwrapped := pulumix.Flatten[map[string]string, pulumix.MapOutput[string]](value)
	return pulumix.MapOutput[string]{OutputState: unwrapped.OutputState}
}

// Map of tags assigned to the resource, including those inherited from the provider `defaultTags` configuration block.
func (o ServiceNetworkOutput) TagsAll() pulumix.MapOutput[string] {
	value := pulumix.Apply[ServiceNetwork](o, func(v ServiceNetwork) pulumix.MapOutput[string] { return v.TagsAll })
	unwrapped := pulumix.Flatten[map[string]string, pulumix.MapOutput[string]](value)
	return pulumix.MapOutput[string]{OutputState: unwrapped.OutputState}
}
