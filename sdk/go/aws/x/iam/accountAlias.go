...
type AccountAlias struct {
	...
	// The account alias
	AccountAlias pulumix.Output[string] `pulumi:"accountAlias"`
}
...
type AccountAliasState struct {
	// The account alias
	AccountAlias pulumix.Input[*string]
}
...
// The account alias
func (o AccountAliasOutput) AccountAlias() pulumix.Output[string] {
	value := pulumix.Apply[AccountAlias](o, func(v AccountAlias) pulumix.Output[string] { return v.AccountAlias })
