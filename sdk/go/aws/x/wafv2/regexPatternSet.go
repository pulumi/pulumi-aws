...
type RegexPatternSet struct {
	...
	RegularExpressions pulumix.GArrayOutput[RegexPatternSetRegularExpression, RegexPatternSetRegularExpressionOutput] `pulumi:"regularExpressions"`
...
type RegexPatternSetState struct {
	...
	// One or more blocks of regular expression patterns that you want AWS WAF to search for, such as `B[a@]dB[o0]t`. See Regular Expression below for details. A maximum of 10 `regularExpression` blocks may be specified.
	RegularExpressions pulumix.Input[[]*RegexPatternSetRegularExpressionArgs]
	// Specifies whether this is for an AWS CloudFront distribution or for a regional application. Valid values are `CLOUDFRONT` or `REGIONAL`. To work with CloudFront, you must also specify the region `us-east-1` (N. Virginia) on the AWS provider.
...
// The Amazon Resource Name (ARN) that identifies the cluster.
func (o RegexPatternSetOutput) Arn() pulumix.Output[string] {
	value := pulumix.Apply[RegexPatternSet](o, func(v RegexPatternSet) pulumix.Output[string] { return v.Arn })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// A friendly description of the regular expression pattern set.
func (o RegexPatternSetOutput) Description() pulumix.Output[*string] {
	value := pulumix.Apply[RegexPatternSet](o, func(v RegexPatternSet) pulumix.Output[*string] { return v.Description })
	return pulumix.Flatten[*string, pulumix.Output[*string]](value)
}

func (o RegexPatternSetOutput) LockToken() pulumix.Output[string] {
	value := pulumix.Apply[RegexPatternSet](o, func(v RegexPatternSet) pulumix.Output[string] { return v.LockToken })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}
...
// One or more blocks of regular expression patterns that you want AWS WAF to search for, such as `B[a@]dB[o0]t`. See Regular Expression below for details. A maximum of 10 `regularExpression` blocks may be specified.
func (o RegexPatternSetOutput) RegularExpressions() pulumix.GArrayOutput[RegexPatternSetRegularExpression, RegexPatternSetRegularExpressionOutput] {
	value := pulumix.Apply[RegexPatternSet](o, func(v RegexPatternSet) pulumix.GArrayOutput[RegexPatternSetRegularExpression, RegexPatternSetRegularExpressionOutput] {
		return v.RegularExpressions
	})
	unwrapped := pulumix.Flatten[[]RegexPatternSetRegularExpression, pulumix.GArrayOutput[RegexPatternSetRegularExpression, RegexPatternSetRegularExpressionOutput]](value)
	return pulumix.GArrayOutput[RegexPatternSetRegularExpression, RegexPatternSetRegularExpressionOutput]{OutputState: unwrapped.OutputState}
}

// Specifies whether this is for an AWS CloudFront distribution or for a regional application. Valid values are `CLOUDFRONT` or `REGIONAL`. To work with CloudFront, you must also specify the region `us-east-1` (N. Virginia) on the AWS provider.
func (o RegexPatternSetOutput) Scope() pulumix.Output[string] {
	value := pulumix.Apply[RegexPatternSet](o, func(v RegexPatternSet) pulumix.Output[string] { return v.Scope })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// An array of key:value pairs to associate with the resource. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
func (o RegexPatternSetOutput) Tags() pulumix.MapOutput[string] {
	value := pulumix.Apply[RegexPatternSet](o, func(v RegexPatternSet) pulumix.MapOutput[string] { return v.Tags })
	unwrapped := pulumix.Flatten[map[string]string, pulumix.MapOutput[string]](value)
	return pulumix.MapOutput[string]{OutputState: unwrapped.OutputState}
}

// A map of tags assigned to the resource, including those inherited from the provider `defaultTags` configuration block.
func (o RegexPatternSetOutput) TagsAll() pulumix.MapOutput[string] {
	value := pulumix.Apply[RegexPatternSet](o, func(v RegexPatternSet) pulumix.MapOutput[string] { return v.TagsAll })
	unwrapped := pulumix.Flatten[map[string]string, pulumix.MapOutput[string]](value)
	return pulumix.MapOutput[string]{OutputState: unwrapped.OutputState}
}
