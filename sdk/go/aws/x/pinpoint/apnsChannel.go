...
// The application ID.
func (o ApnsChannelOutput) ApplicationId() pulumix.Output[string] {
	value := pulumix.Apply[ApnsChannel](o, func(v ApnsChannel) pulumix.Output[string] { return v.ApplicationId })
	return pulumix.Flatten[string, pulumix.Output[string]](value)
}

// The ID assigned to your iOS app. To find this value, choose Certificates, IDs & Profiles, choose App IDs in the Identifiers section, and choose your app.
func (o ApnsChannelOutput) BundleId() pulumix.Output[*string] {
	value := pulumix.Apply[ApnsChannel](o, func(v ApnsChannel) pulumix.Output[*string] { return v.BundleId })
	return pulumix.Flatten[*string, pulumix.Output[*string]](value)
}

// The pem encoded TLS Certificate from Apple.
func (o ApnsChannelOutput) Certificate() pulumix.Output[*string] {
	value := pulumix.Apply[ApnsChannel](o, func(v ApnsChannel) pulumix.Output[*string] { return v.Certificate })
	return pulumix.Flatten[*string, pulumix.Output[*string]](value)
}
...
//
// If you choose to use __Certificate credentials__ you will have to provide:
func (o ApnsChannelOutput) DefaultAuthenticationMethod() pulumix.Output[*string] {
	value := pulumix.Apply[ApnsChannel](o, func(v ApnsChannel) pulumix.Output[*string] { return v.DefaultAuthenticationMethod })
	return pulumix.Flatten[*string, pulumix.Output[*string]](value)
}

// Whether the channel is enabled or disabled. Defaults to `true`.
func (o ApnsChannelOutput) Enabled() pulumix.Output[*bool] {
	value := pulumix.Apply[ApnsChannel](o, func(v ApnsChannel) pulumix.Output[*bool] { return v.Enabled })
...
//
// If you choose to use __Key credentials__ you will have to provide:
func (o ApnsChannelOutput) PrivateKey() pulumix.Output[*string] {
	value := pulumix.Apply[ApnsChannel](o, func(v ApnsChannel) pulumix.Output[*string] { return v.PrivateKey })
	return pulumix.Flatten[*string, pulumix.Output[*string]](value)
}

// The ID assigned to your Apple developer account team. This value is provided on the Membership page.
func (o ApnsChannelOutput) TeamId() pulumix.Output[*string] {
	value := pulumix.Apply[ApnsChannel](o, func(v ApnsChannel) pulumix.Output[*string] { return v.TeamId })
	return pulumix.Flatten[*string, pulumix.Output[*string]](value)
}

// The `.p8` file that you download from your Apple developer account when you create an authentication key.
func (o ApnsChannelOutput) TokenKey() pulumix.Output[*string] {
	value := pulumix.Apply[ApnsChannel](o, func(v ApnsChannel) pulumix.Output[*string] { return v.TokenKey })
	return pulumix.Flatten[*string, pulumix.Output[*string]](value)
}

// The ID assigned to your signing key. To find this value, choose Certificates, IDs & Profiles, and choose your key in the Keys section.
func (o ApnsChannelOutput) TokenKeyId() pulumix.Output[*string] {
	value := pulumix.Apply[ApnsChannel](o, func(v ApnsChannel) pulumix.Output[*string] { return v.TokenKeyId })
	return pulumix.Flatten[*string, pulumix.Output[*string]](value)
}
