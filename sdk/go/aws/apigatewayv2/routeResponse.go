...
// ```
//
// > **Note:** For WebSocket routes requiring two-way communication, add an `apigatewayv2.RouteResponse` to the route with `routeResponseKey = "$default"`. Only the `$default` route response is supported. Use an integration response to manipulate backend responses — see [Overview of integration responses](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api-integration-responses.html#apigateway-websocket-api-integration-response-overview).
//
// ## Import
//
// Using `pulumi import`, import `apigatewayv2.RouteResponse` using the API identifier, route identifier and route response identifier. For example:
//
// ```sh
