...
type SigningProfilePermission struct {
	...
	StatementId pulumi.StringPtrOutput `pulumi:"statementId"`
...
// The signing profile version that a permission applies to.
func (o SigningProfilePermissionOutput) ProfileVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningProfilePermission) pulumi.StringPtrOutput { return v.ProfileVersion }).(pulumi.StringPtrOutput)
}

// A unique statement identifier. By default generated by the provider.
func (o SigningProfilePermissionOutput) StatementId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningProfilePermission) pulumi.StringPtrOutput { return v.StatementId }).(pulumi.StringPtrOutput)
}
