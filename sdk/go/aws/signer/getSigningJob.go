...
// Date and time in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) that the signing job was completed.
func (o LookupSigningJobResultOutput) CompletedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.CompletedAt }).(pulumi.StringPtrOutput)
}

// Date and time in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) that the signing job was created.
func (o LookupSigningJobResultOutput) CreatedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.CreatedAt }).(pulumi.StringPtrOutput)
}

// The provider-assigned unique ID for this managed resource.
func (o LookupSigningJobResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
...
// IAM entity that initiated the signing job.
func (o LookupSigningJobResultOutput) JobInvoker() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.JobInvoker }).(pulumi.StringPtrOutput)
}

// AWS account ID of the job owner.
func (o LookupSigningJobResultOutput) JobOwner() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.JobOwner }).(pulumi.StringPtrOutput)
}

// A human-readable name for the signing platform associated with the signing job.
func (o LookupSigningJobResultOutput) PlatformDisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.PlatformDisplayName }).(pulumi.StringPtrOutput)
}

// Platform to which your signed code image will be distributed.
func (o LookupSigningJobResultOutput) PlatformId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.PlatformId }).(pulumi.StringPtrOutput)
}

// Name of the profile that initiated the signing operation.
func (o LookupSigningJobResultOutput) ProfileName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.ProfileName }).(pulumi.StringPtrOutput)
}

// Version of the signing profile used to initiate the signing job.
func (o LookupSigningJobResultOutput) ProfileVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.ProfileVersion }).(pulumi.StringPtrOutput)
}

// IAM principal that requested the signing job.
func (o LookupSigningJobResultOutput) RequestedBy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.RequestedBy }).(pulumi.StringPtrOutput)
}
...
// The time when the signature of a signing job expires.
func (o LookupSigningJobResultOutput) SignatureExpiresAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.SignatureExpiresAt }).(pulumi.StringPtrOutput)
}
...
// Status of the signing job.
func (o LookupSigningJobResultOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.Status }).(pulumi.StringPtrOutput)
}

// String value that contains the status reason.
func (o LookupSigningJobResultOutput) StatusReason() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSigningJobResult) *string { return v.StatusReason }).(pulumi.StringPtrOutput)
}
