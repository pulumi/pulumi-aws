...
type SigningJob struct {
	...
	JobInvoker pulumi.StringPtrOutput `pulumi:"jobInvoker"`
	// The AWS account ID of the job owner.
	JobOwner pulumi.StringPtrOutput `pulumi:"jobOwner"`
	// A human-readable name for the signing platform associated with the signing job.
	PlatformDisplayName pulumi.StringPtrOutput `pulumi:"platformDisplayName"`
	...
	RequestedBy pulumi.StringPtrOutput `pulumi:"requestedBy"`
	...
	SignatureExpiresAt pulumi.StringPtrOutput `pulumi:"signatureExpiresAt"`
...
// Date and time in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) that the signing job was completed.
func (o SigningJobOutput) CompletedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.CompletedAt }).(pulumi.StringPtrOutput)
}

// Date and time in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) that the signing job was created.
func (o SigningJobOutput) CreatedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.CreatedAt }).(pulumi.StringPtrOutput)
}
...
// The ID of the signing job on output.
func (o SigningJobOutput) JobId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.JobId }).(pulumi.StringPtrOutput)
}

// The IAM entity that initiated the signing job.
func (o SigningJobOutput) JobInvoker() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.JobInvoker }).(pulumi.StringPtrOutput)
}

// The AWS account ID of the job owner.
func (o SigningJobOutput) JobOwner() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.JobOwner }).(pulumi.StringPtrOutput)
}

// A human-readable name for the signing platform associated with the signing job.
func (o SigningJobOutput) PlatformDisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.PlatformDisplayName }).(pulumi.StringPtrOutput)
}

// The platform to which your signed code image will be distributed.
func (o SigningJobOutput) PlatformId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.PlatformId }).(pulumi.StringPtrOutput)
}
...
// The version of the signing profile used to initiate the signing job.
func (o SigningJobOutput) ProfileVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.ProfileVersion }).(pulumi.StringPtrOutput)
}

// The IAM principal that requested the signing job.
func (o SigningJobOutput) RequestedBy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.RequestedBy }).(pulumi.StringPtrOutput)
}
...
// The time when the signature of a signing job expires.
func (o SigningJobOutput) SignatureExpiresAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.SignatureExpiresAt }).(pulumi.StringPtrOutput)
}
...
// Status of the signing job.
func (o SigningJobOutput) Status() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.Status }).(pulumi.StringPtrOutput)
}

// String value that contains the status reason.
func (o SigningJobOutput) StatusReason() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SigningJob) pulumi.StringPtrOutput { return v.StatusReason }).(pulumi.StringPtrOutput)
}
