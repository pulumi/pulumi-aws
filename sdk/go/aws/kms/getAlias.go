...
// ARN pointed to by the alias.
func (o LookupAliasResultOutput) TargetKeyArn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAliasResult) *string { return v.TargetKeyArn }).(pulumi.StringPtrOutput)
}
