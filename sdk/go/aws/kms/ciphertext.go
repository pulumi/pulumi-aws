...
func NewCiphertext(ctx *pulumi.Context,
	...
	if args != nil {
		if i := args.Context; i != nil { inputs["context"] = i.ToStringMapOutput() }
		if i := args.KeyId; i != nil { inputs["keyId"] = i.ToStringOutput() }
		if i := args.Plaintext; i != nil { inputs["plaintext"] = i.ToStringOutput() }
	}
...
func GetCiphertext(ctx *pulumi.Context,
	...
	inputs := map[string]pulumi.Input{}
	if state != nil {
		if i := state.CiphertextBlob; i != nil { inputs["ciphertextBlob"] = i.ToStringOutput() }
		if i := state.Context; i != nil { inputs["context"] = i.ToStringMapOutput() }
		if i := state.KeyId; i != nil { inputs["keyId"] = i.ToStringOutput() }
		if i := state.Plaintext; i != nil { inputs["plaintext"] = i.ToStringOutput() }
	}
	var resource Ciphertext
