...
// import (
//
//	kms/ciphertext "github.com/pulumi/pulumi-aws/sdk/v1/go/aws/kms/ciphertext"
...
// oauthConfig, err := kms/key.NewKey(ctx, "oauthConfig", &kms/key.KeyArgs{
...
// return err
// }
// _, err = kms/ciphertext.NewCiphertext(ctx, "oauth", &kms/ciphertext.CiphertextArgs{
