...
func LookupvailabilityZone(ctx *pulumi.Context, args *GetAvailabilityZoneArgs) (*GetAvailabilityZoneResult, error) {
	...
	ret := GetAvailabilityZoneResult{}
	if v, ok := outputs["name"]; ok {
		ret.Name = v
	}
	if v, ok := outputs["nameSuffix"]; ok {
		ret.NameSuffix = v
	}
