...
func LookupDedicatedIpPoolOutput(ctx *pulumi.Context, args LookupDedicatedIpPoolOutputArgs, opts ...pulumi.InvokeOption) LookupDedicatedIpPoolResultOutput {
	...
	return ctx.InvokeOutput("aws:sesv2/getDedicatedIpPool:getDedicatedIpPool", args, LookupDedicatedIpPoolResultOutput{}, options).(LookupDedicatedIpPoolResultOutput)
}
