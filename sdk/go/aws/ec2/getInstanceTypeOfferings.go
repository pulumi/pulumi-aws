...
func GetInstanceTypeOfferingsOutput(ctx *pulumi.Context, args GetInstanceTypeOfferingsOutputArgs, opts ...pulumi.InvokeOption) GetInstanceTypeOfferingsResultOutput {
	...
	return ctx.InvokeOutput("aws:ec2/getInstanceTypeOfferings:getInstanceTypeOfferings", args, GetInstanceTypeOfferingsResultOutput{}, options).(GetInstanceTypeOfferingsResultOutput)
}
