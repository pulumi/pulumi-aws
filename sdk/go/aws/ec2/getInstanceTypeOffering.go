...
func GetInstanceTypeOffering(ctx *pulumi.Context, args *GetInstanceTypeOfferingArgs, opts ...pulumi.InvokeOption) (*GetInstanceTypeOfferingResult, error) {
	...
	if optsErr != nil {
		return &GetInstanceTypeOfferingResult{}, optsErr
	}
	if len(invokeOpts.DependsOn) > 0 {
		return &GetInstanceTypeOfferingResult{}, errors.New("DependsOn is not supported for direct form invoke GetInstanceTypeOffering, use GetInstanceTypeOfferingOutput instead")
	}
	if len(invokeOpts.DependsOnInputs) > 0 {
		return &GetInstanceTypeOfferingResult{}, errors.New("DependsOnInputs is not supported for direct form invoke GetInstanceTypeOffering, use GetInstanceTypeOfferingOutput instead")
	}
