...
type GetNetworkInterfaceArgs struct {
	...
	Filters *[]GetNetworkInterfaceFiltersArgs `pulumi:"filters"`
...
type GetNetworkInterfaceResult struct {
	...
	Associations []GetNetworkInterfaceAssociationsResult `pulumi:"associations"`
	Attachments []GetNetworkInterfaceAttachmentsResult `pulumi:"attachments"`
	// The Availability Zone.
	AvailabilityZone string `pulumi:"availabilityZone"`
	// Description of the network interface.
	Description string `pulumi:"description"`
	Filters *[]GetNetworkInterfaceFiltersResult `pulumi:"filters"`
	Id string `pulumi:"id"`
...
type GetNetworkInterfaceAssociationsResult struct {
	// The allocation ID.
...
type GetNetworkInterfaceAttachmentsResult struct {
	AttachmentId string `pulumi:"attachmentId"`
	DeviceIndex int `pulumi:"deviceIndex"`
	InstanceId string `pulumi:"instanceId"`
	InstanceOwnerId string `pulumi:"instanceOwnerId"`
}
type GetNetworkInterfaceFiltersArgs struct {
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
type GetNetworkInterfaceFiltersResult struct {
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
