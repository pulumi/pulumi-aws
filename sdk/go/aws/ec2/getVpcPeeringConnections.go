...
func (o GetVpcPeeringConnectionsResultOutput) Region() pulumi.StringOutput {
	return o.ApplyT(func(v GetVpcPeeringConnectionsResult) string { return v.Region }).(pulumi.StringOutput)
}
