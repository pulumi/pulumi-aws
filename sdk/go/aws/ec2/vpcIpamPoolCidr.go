...
type VpcIpamPoolCidr struct {
	...
	IpamPoolCidrId pulumi.StringPtrOutput `pulumi:"ipamPoolCidrId"`
...
// The CIDR you want to assign to the pool. Conflicts with `netmaskLength`.
func (o VpcIpamPoolCidrOutput) Cidr() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VpcIpamPoolCidr) pulumi.StringPtrOutput { return v.Cidr }).(pulumi.StringPtrOutput)
}
...
// The unique ID generated by AWS for the pool cidr. Typically this is the resource `id` but this attribute was added to the API calls after the fact and is therefore not used as the resource id.
func (o VpcIpamPoolCidrOutput) IpamPoolCidrId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *VpcIpamPoolCidr) pulumi.StringPtrOutput { return v.IpamPoolCidrId }).(pulumi.StringPtrOutput)
}
