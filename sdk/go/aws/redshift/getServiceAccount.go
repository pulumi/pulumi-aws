...
// return err
// }
// allowAuditLoggingPolicyDocument := pulumi.All(bucket.Arn,bucket.Arn).ApplyT(func(_args []interface{}) (iam.GetPolicyDocumentResult, error) {
...
// _, err = s3.NewBucketPolicy(ctx, "allowAuditLoggingBucketPolicy", &s3.BucketPolicyArgs{
// Bucket: bucket.ID(),
// Policy: allowAuditLoggingPolicyDocument.ApplyT(func(allowAuditLoggingPolicyDocument iam.GetPolicyDocumentResult) (*string, error) {
// return &allowAuditLoggingPolicyDocument.Json, nil
