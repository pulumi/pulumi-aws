...
func LookupUserHierarchyStructureOutput(ctx *pulumi.Context, args LookupUserHierarchyStructureOutputArgs, opts ...pulumi.InvokeOption) LookupUserHierarchyStructureResultOutput {
	...
	return ctx.InvokeOutput("aws:connect/getUserHierarchyStructure:getUserHierarchyStructure", args, LookupUserHierarchyStructureResultOutput{}, options).(LookupUserHierarchyStructureResultOutput)
}
