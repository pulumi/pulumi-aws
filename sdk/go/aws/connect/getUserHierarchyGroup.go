...
func LookupUserHierarchyGroupOutput(ctx *pulumi.Context, args LookupUserHierarchyGroupOutputArgs, opts ...pulumi.InvokeOption) LookupUserHierarchyGroupResultOutput {
	...
	return ctx.InvokeOutput("aws:connect/getUserHierarchyGroup:getUserHierarchyGroup", args, LookupUserHierarchyGroupResultOutput{}, options).(LookupUserHierarchyGroupResultOutput)
}
