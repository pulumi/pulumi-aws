...
func LookupSnapshotIds(ctx *pulumi.Context, args *GetSnapshotIdsArgs, opts ...pulumi.InvokeOption) (*GetSnapshotIdsResult, error) {
...
type GetSnapshotIdsArgs struct {
	...
	Filters *[]GetSnapshotIdsFiltersArgs `pulumi:"filters"`
...
type GetSnapshotIdsResult struct {
	Filters *[]GetSnapshotIdsFiltersResult `pulumi:"filters"`
...
type GetSnapshotIdsFiltersArgs struct {
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
type GetSnapshotIdsFiltersResult struct {
	Name string `pulumi:"name"`
	Values []string `pulumi:"values"`
}
