...
// Domain-specific endpoint used to access the [Dashboard application](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/dashboards.html).
func (o LookupDomainResultOutput) DashboardEndpoint() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupDomainResult) *string { return v.DashboardEndpoint }).(pulumi.StringPtrOutput)
}
