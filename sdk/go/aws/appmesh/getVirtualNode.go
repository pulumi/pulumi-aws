...
// Creation date of the virtual node.
func (o LookupVirtualNodeResultOutput) CreatedDate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualNodeResult) *string { return v.CreatedDate }).(pulumi.StringPtrOutput)
}
...
// Last update date of the virtual node.
func (o LookupVirtualNodeResultOutput) LastUpdatedDate() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualNodeResult) *string { return v.LastUpdatedDate }).(pulumi.StringPtrOutput)
}
...
func (o LookupVirtualNodeResultOutput) MeshOwner() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVirtualNodeResult) *string { return v.MeshOwner }).(pulumi.StringPtrOutput)
}
