...
func (o GetAutoscalingGroupsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetAutoscalingGroupsResult] {
	return pulumix.Output[GetAutoscalingGroupsResult]{
