...
func (o LookupEndpointResultOutput) KmsKeyArn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupEndpointResult) *string { return v.KmsKeyArn }).(pulumi.StringPtrOutput)
}
...
func (o LookupEndpointResultOutput) SecretsManagerAccessRoleArn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupEndpointResult) *string { return v.SecretsManagerAccessRoleArn }).(pulumi.StringPtrOutput)
}

func (o LookupEndpointResultOutput) SecretsManagerArn() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupEndpointResult) *string { return v.SecretsManagerArn }).(pulumi.StringPtrOutput)
}
...
func (o LookupEndpointResultOutput) ServiceAccessRole() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupEndpointResult) *string { return v.ServiceAccessRole }).(pulumi.StringPtrOutput)
}
