...
type DataLake struct {
	...
	Configuration DataLakeConfigurationOutput `pulumi:"configuration"`
...
type DataLakeArgs struct {
	// Specify the Region or Regions that will contribute data to the rollup region.
	Configuration DataLakeConfigurationInput
	// The Amazon Resource Name (ARN) used to create and update the AWS Glue table. This table contains partitions generated by the ingestion and normalization of AWS log sources and custom sources.
...
// Specify the Region or Regions that will contribute data to the rollup region.
func (o DataLakeOutput) Configuration() DataLakeConfigurationOutput {
	return o.ApplyT(func(v *DataLake) DataLakeConfigurationOutput { return v.Configuration }).(DataLakeConfigurationOutput)
}
