...
//	"os"
//
//	cognito/identityPool "github.com/pulumi/pulumi-aws/sdk/v1/go/aws/cognito/identityPool"
//	iam/samlProvider "github.com/pulumi/pulumi-aws/sdk/v1/go/aws/iam/samlProvider"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
// _, err := iam/samlProvider.NewSamlProvider(ctx, "default", &iam/samlProvider.SamlProviderArgs{
// SamlMetadataDocument: readFileOrPanic("saml-metadata.xml"),
// })
// if err != nil {
// return err
// }
// _, err = cognito/identityPool.NewIdentityPool(ctx, "main", &cognito/identityPool.IdentityPoolArgs{
// IdentityPoolName: "identity pool",
// AllowUnauthenticatedIdentities: false,
// AllowClassicFlow: false,
// CognitoIdentityProviders: []map[string]interface{}{
