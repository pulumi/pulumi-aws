...
func NewEndpoint(ctx *pulumi.Context,
	...
	if args != nil {
		if i := args.EndpointConfigName; i != nil { inputs["endpointConfigName"] = i.ToStringOutput() }
...
func GetEndpoint(ctx *pulumi.Context,
	...
	if state != nil {
		...
		if i := state.EndpointConfigName; i != nil { inputs["endpointConfigName"] = i.ToStringOutput() }
