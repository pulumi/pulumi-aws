...
//
// > **NOTE:** This resource must be created in the Organization main account and rules will include the main account unless its ID is added to the `excludedAccounts` argument.
//
