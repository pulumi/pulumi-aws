...
public final class LaunchTemplateCapacityReservationSpecificationCapacityReservationTarget {
    ...
    public @Nullable String capacityReservationId() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateCapacityReservationSpecificationCapacityReservationTarget.capacityReservationId' is not present");
    }
    ...
    public @Nullable String capacityReservationResourceGroupArn() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateCapacityReservationSpecificationCapacityReservationTarget.capacityReservationResourceGroupArn' is not present");
    }
