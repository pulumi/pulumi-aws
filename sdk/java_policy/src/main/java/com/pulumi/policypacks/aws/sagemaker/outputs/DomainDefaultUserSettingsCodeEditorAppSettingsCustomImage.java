...
public final class DomainDefaultUserSettingsCodeEditorAppSettingsCustomImage {
    ...
    public String appImageConfigName() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsCodeEditorAppSettingsCustomImage.appImageConfigName' is not present");
    }
    ...
    public String imageName() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsCodeEditorAppSettingsCustomImage.imageName' is not present");
    }
    ...
    public @Nullable Integer imageVersionNumber() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsCodeEditorAppSettingsCustomImage.imageVersionNumber' is not present");
    }
