...
public final class InsightFiltersVerificationState {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersVerificationState.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersVerificationState.value' is not present");
    }
