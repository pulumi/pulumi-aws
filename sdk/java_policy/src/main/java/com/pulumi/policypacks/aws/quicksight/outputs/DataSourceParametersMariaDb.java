...
public final class DataSourceParametersMariaDb {
    ...
    public String database() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersMariaDb.database' is not present");
    }
    ...
    public String host() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersMariaDb.host' is not present");
    }
    ...
    public Integer port() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersMariaDb.port' is not present");
    }
