...
public final class FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter {
    ...
    public String parameterName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter.parameterName' is not present");
    }
    ...
    public String parameterValue() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter.parameterValue' is not present");
    }
