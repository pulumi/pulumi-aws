...
public final class EnvironmentLoggingConfigurationDagProcessingLogsArgs {
    ...
    public String cloudWatchLogGroupArn() {
        ...
        throw new UndeferrableValueException("Value 'EnvironmentLoggingConfigurationDagProcessingLogsArgs.cloudWatchLogGroupArn' is not present");
    }
    ...
    public Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'EnvironmentLoggingConfigurationDagProcessingLogsArgs.enabled' is not present");
    }
    ...
    public String logLevel() {
        ...
        throw new UndeferrableValueException("Value 'EnvironmentLoggingConfigurationDagProcessingLogsArgs.logLevel' is not present");
    }
