...
public final class FirewallPolicyEncryptionConfiguration {
    ...
    public @Nullable String keyId() {
        ...
        throw new UndeferrableValueException("Value 'FirewallPolicyEncryptionConfiguration.keyId' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'FirewallPolicyEncryptionConfiguration.type' is not present");
    }
