...
public final class VpcConnectionTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("VpcConnectionTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("VpcConnectionTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("VpcConnectionTimeouts.update");
    }
