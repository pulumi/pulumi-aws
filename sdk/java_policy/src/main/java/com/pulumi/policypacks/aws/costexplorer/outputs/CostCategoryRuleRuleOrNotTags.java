...
public final class CostCategoryRuleRuleOrNotTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleOrNotTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleOrNotTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleOrNotTags.values");
    }
