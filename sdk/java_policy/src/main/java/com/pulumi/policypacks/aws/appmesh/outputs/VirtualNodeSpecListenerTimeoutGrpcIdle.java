...
public final class VirtualNodeSpecListenerTimeoutGrpcIdle {
    ...
    public String unit() {
        ...
        throw new UndeferrableValueException("Value 'VirtualNodeSpecListenerTimeoutGrpcIdle.unit' is not present");
    }
    ...
    public Integer value() {
        ...
        throw new UndeferrableValueException("Value 'VirtualNodeSpecListenerTimeoutGrpcIdle.value' is not present");
    }
