...
public final class ApplicationLayerAutomaticResponseTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'ApplicationLayerAutomaticResponseTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'ApplicationLayerAutomaticResponseTimeouts.delete' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'ApplicationLayerAutomaticResponseTimeouts.update' is not present");
    }
