...
public final class RegisteredDomainAdminContact {
    ...
    public @Nullable String addressLine1() {
        ...
        return addressLine1.getValue("RegisteredDomainAdminContact.addressLine1");
    }
    ...
    public @Nullable String addressLine2() {
        ...
        return addressLine2.getValue("RegisteredDomainAdminContact.addressLine2");
    }
    ...
    public @Nullable String city() {
        ...
        return city.getValue("RegisteredDomainAdminContact.city");
    }
    ...
    public @Nullable String contactType() {
        ...
        return contactType.getValue("RegisteredDomainAdminContact.contactType");
    }
    ...
    public @Nullable String countryCode() {
        ...
        return countryCode.getValue("RegisteredDomainAdminContact.countryCode");
    }
    ...
    public @Nullable String email() {
        ...
        return email.getValue("RegisteredDomainAdminContact.email");
    }
    ...
    public @Nullable Map<String,String> extraParams() {
        ...
        return extraParams.getValue("RegisteredDomainAdminContact.extraParams");
    }
    ...
    public @Nullable String fax() {
        ...
        return fax.getValue("RegisteredDomainAdminContact.fax");
    }
    ...
    public @Nullable String firstName() {
        ...
        return firstName.getValue("RegisteredDomainAdminContact.firstName");
    }
    ...
    public @Nullable String lastName() {
        ...
        return lastName.getValue("RegisteredDomainAdminContact.lastName");
    }
    ...
    public @Nullable String organizationName() {
        ...
        return organizationName.getValue("RegisteredDomainAdminContact.organizationName");
    }
    ...
    public @Nullable String phoneNumber() {
        ...
        return phoneNumber.getValue("RegisteredDomainAdminContact.phoneNumber");
    }
    ...
    public @Nullable String state() {
        ...
        return state.getValue("RegisteredDomainAdminContact.state");
    }
    ...
    public @Nullable String zipCode() {
        ...
        return zipCode.getValue("RegisteredDomainAdminContact.zipCode");
    }
