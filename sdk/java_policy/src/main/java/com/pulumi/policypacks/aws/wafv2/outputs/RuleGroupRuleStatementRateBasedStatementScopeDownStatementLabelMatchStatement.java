...
public final class RuleGroupRuleStatementRateBasedStatementScopeDownStatementLabelMatchStatement {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementScopeDownStatementLabelMatchStatement.key' is not present");
    }
    ...
    public String scope() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementScopeDownStatementLabelMatchStatement.scope' is not present");
    }
