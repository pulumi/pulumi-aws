...
public final class PhpAppLayerLoadBasedAutoScalingDownscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("PhpAppLayerLoadBasedAutoScalingDownscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("PhpAppLayerLoadBasedAutoScalingDownscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("PhpAppLayerLoadBasedAutoScalingDownscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("PhpAppLayerLoadBasedAutoScalingDownscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("PhpAppLayerLoadBasedAutoScalingDownscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("PhpAppLayerLoadBasedAutoScalingDownscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("PhpAppLayerLoadBasedAutoScalingDownscaling.thresholdsWaitTime");
    }
