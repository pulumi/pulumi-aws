...
public final class DistributionDefaultCacheBehaviorForwardedValuesCookiesArgs {
    ...
    public String forward() {
        ...
        return forward.getValue("DistributionDefaultCacheBehaviorForwardedValuesCookiesArgs.forward");
    }
    ...
    public List<String> whitelistedNames() {
        ...
        return whitelistedNames.getValue("DistributionDefaultCacheBehaviorForwardedValuesCookiesArgs.whitelistedNames");
    }
