...
public final class DomainDefaultUserSettingsRSessionAppSettingsCustomImage {
    ...
    public String appImageConfigName() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsRSessionAppSettingsCustomImage.appImageConfigName' is not present");
    }
    ...
    public String imageName() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsRSessionAppSettingsCustomImage.imageName' is not present");
    }
    ...
    public @Nullable Integer imageVersionNumber() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsRSessionAppSettingsCustomImage.imageVersionNumber' is not present");
    }
