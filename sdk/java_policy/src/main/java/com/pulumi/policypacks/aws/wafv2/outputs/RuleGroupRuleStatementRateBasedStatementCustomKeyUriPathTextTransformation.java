...
public final class RuleGroupRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation.type' is not present");
    }
