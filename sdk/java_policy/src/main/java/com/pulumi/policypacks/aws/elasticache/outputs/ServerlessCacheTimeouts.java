...
public final class ServerlessCacheTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ServerlessCacheTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ServerlessCacheTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ServerlessCacheTimeouts.update");
    }
