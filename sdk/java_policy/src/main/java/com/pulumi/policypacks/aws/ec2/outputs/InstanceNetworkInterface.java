...
public final class InstanceNetworkInterface {
    ...
    public @Nullable Boolean deleteOnTermination() {
        ...
        return deleteOnTermination.getValue("InstanceNetworkInterface.deleteOnTermination");
    }
    ...
    public Integer deviceIndex() {
        ...
        return deviceIndex.getValue("InstanceNetworkInterface.deviceIndex");
    }
    ...
    public @Nullable Integer networkCardIndex() {
        ...
        return networkCardIndex.getValue("InstanceNetworkInterface.networkCardIndex");
    }
    ...
    public String networkInterfaceId() {
        ...
        return networkInterfaceId.getValue("InstanceNetworkInterface.networkInterfaceId");
    }
