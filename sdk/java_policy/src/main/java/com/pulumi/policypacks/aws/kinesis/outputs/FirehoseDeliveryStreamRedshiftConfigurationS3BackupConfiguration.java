...
import com.pulumi.policypacks.aws.kinesis.outputs.FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions;
...
public final class FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration {
    ...
    public String bucketArn() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.bucketArn' is not present");
    }
    ...
    public @Nullable Integer bufferingInterval() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.bufferingInterval' is not present");
    }
    ...
    public @Nullable Integer bufferingSize() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.bufferingSize' is not present");
    }

    @PolicyResourceProperty(name="cloudwatchLoggingOptions", flag="unknown_cloudwatchLoggingOptions")
    private @Nullable FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions value_cloudwatchLoggingOptions;
    private boolean unknown_cloudwatchLoggingOptions;
    public @Nullable FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfigurationCloudwatchLoggingOptions cloudwatchLoggingOptions() {
        if (!unknown_cloudwatchLoggingOptions) return value_cloudwatchLoggingOptions;
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.cloudwatchLoggingOptions' is not present");
    }
    ...
    public @Nullable String compressionFormat() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.compressionFormat' is not present");
    }
    ...
    public @Nullable String errorOutputPrefix() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.errorOutputPrefix' is not present");
    }
    ...
    public @Nullable String kmsKeyArn() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.kmsKeyArn' is not present");
    }
    ...
    public @Nullable String prefix() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.prefix' is not present");
    }
    ...
    public String roleArn() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationS3BackupConfiguration.roleArn' is not present");
    }
