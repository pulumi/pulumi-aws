...
public final class SmbFileShareCacheAttributesArgs {
    ...
    public Integer cacheStaleTimeoutInSeconds() {
        ...
        return cacheStaleTimeoutInSeconds.getValue("SmbFileShareCacheAttributesArgs.cacheStaleTimeoutInSeconds");
    }
