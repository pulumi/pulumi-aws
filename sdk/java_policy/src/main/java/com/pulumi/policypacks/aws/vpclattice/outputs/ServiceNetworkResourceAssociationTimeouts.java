...
public final class ServiceNetworkResourceAssociationTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'ServiceNetworkResourceAssociationTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'ServiceNetworkResourceAssociationTimeouts.delete' is not present");
    }
