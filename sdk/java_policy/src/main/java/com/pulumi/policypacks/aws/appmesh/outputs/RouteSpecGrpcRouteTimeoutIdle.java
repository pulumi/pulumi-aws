...
public final class RouteSpecGrpcRouteTimeoutIdle {
    ...
    public String unit() {
        ...
        throw new UndeferrableValueException("Value 'RouteSpecGrpcRouteTimeoutIdle.unit' is not present");
    }
    ...
    public Integer value() {
        ...
        throw new UndeferrableValueException("Value 'RouteSpecGrpcRouteTimeoutIdle.value' is not present");
    }
