...
public final class PipelineNotificationsArgs {
     ...
     * 
     */
    private UndeferrableValue<String> completed;

    public String completed() {
        if (completed == null) return null;
        return completed.getValue("PipelineNotificationsArgs.completed");
    }
     ...
     * 
     */
    private UndeferrableValue<String> error;

    public String error() {
        if (error == null) return null;
        return error.getValue("PipelineNotificationsArgs.error");
    }
     ...
     * 
     */
    private UndeferrableValue<String> progressing;

    public String progressing() {
        if (progressing == null) return null;
        return progressing.getValue("PipelineNotificationsArgs.progressing");
    }
    ...
    public String warning() {
        ...
        return warning.getValue("PipelineNotificationsArgs.warning");
    }
