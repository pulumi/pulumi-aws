...
public final class MemcachedLayerEbsVolume {
    ...
    public @Nullable Boolean encrypted() {
        ...
        return encrypted.getValue("MemcachedLayerEbsVolume.encrypted");
    }
    ...
    public @Nullable Integer iops() {
        ...
        return iops.getValue("MemcachedLayerEbsVolume.iops");
    }
    ...
    public String mountPoint() {
        ...
        return mountPoint.getValue("MemcachedLayerEbsVolume.mountPoint");
    }
    ...
    public Integer numberOfDisks() {
        ...
        return numberOfDisks.getValue("MemcachedLayerEbsVolume.numberOfDisks");
    }
    ...
    public @Nullable String raidLevel() {
        ...
        return raidLevel.getValue("MemcachedLayerEbsVolume.raidLevel");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("MemcachedLayerEbsVolume.size");
    }
    ...
    public @Nullable String type() {
        ...
        return type.getValue("MemcachedLayerEbsVolume.type");
    }
