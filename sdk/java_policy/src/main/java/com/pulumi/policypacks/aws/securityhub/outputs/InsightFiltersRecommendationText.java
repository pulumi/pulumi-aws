...
public final class InsightFiltersRecommendationText {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersRecommendationText.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersRecommendationText.value' is not present");
    }
