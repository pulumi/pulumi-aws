...
public final class DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec {
    ...
    public @Nullable String instanceType() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec.instanceType' is not present");
    }
    ...
    public @Nullable String lifecycleConfigArn() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec.lifecycleConfigArn' is not present");
    }
    ...
    public @Nullable String sagemakerImageArn() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec.sagemakerImageArn' is not present");
    }
    ...
    public @Nullable String sagemakerImageVersionAlias() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec.sagemakerImageVersionAlias' is not present");
    }
    ...
    public @Nullable String sagemakerImageVersionArn() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec.sagemakerImageVersionArn' is not present");
    }
