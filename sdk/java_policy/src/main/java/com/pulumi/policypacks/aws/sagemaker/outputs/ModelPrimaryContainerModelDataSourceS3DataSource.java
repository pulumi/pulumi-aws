...
import com.pulumi.policypacks.aws.sagemaker.outputs.ModelPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig;
...
public final class ModelPrimaryContainerModelDataSourceS3DataSource {
    ...
    public String compressionType() {
        ...
        throw new UndeferrableValueException("Value 'ModelPrimaryContainerModelDataSourceS3DataSource.compressionType' is not present");
    }
    ...
    private @Nullable ModelPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig value_modelAccessConfig;
    private boolean unknown_modelAccessConfig;
    public @Nullable ModelPrimaryContainerModelDataSourceS3DataSourceModelAccessConfig modelAccessConfig() {
        if (!unknown_modelAccessConfig) return value_modelAccessConfig;
        throw new UndeferrableValueException("Value 'ModelPrimaryContainerModelDataSourceS3DataSource.modelAccessConfig' is not present");
    }
    ...
    public String s3DataType() {
        ...
        throw new UndeferrableValueException("Value 'ModelPrimaryContainerModelDataSourceS3DataSource.s3DataType' is not present");
    }
    ...
    public String s3Uri() {
        ...
        throw new UndeferrableValueException("Value 'ModelPrimaryContainerModelDataSourceS3DataSource.s3Uri' is not present");
    }
