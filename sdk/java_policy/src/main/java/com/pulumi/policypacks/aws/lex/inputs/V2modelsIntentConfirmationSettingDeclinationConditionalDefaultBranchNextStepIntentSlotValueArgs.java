...
public final class V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepIntentSlotValueArgs {
    ...
    public String interpretedValue() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepIntentSlotValueArgs.interpretedValue' is not present");
    }
