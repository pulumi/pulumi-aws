...
public final class RolePolicyArgs extends com.pulumi.resources.PolicyResourceInput {
    ...
    public String name() {
        ...
        return name.getValue("RolePolicyArgs.name");
    }
    ...
    public String namePrefix() {
        ...
        return namePrefix.getValue("RolePolicyArgs.namePrefix");
    }
    ...
    public String policy() {
        ...
        return policy.getValue("RolePolicyArgs.policy");
    }
    ...
    public String role() {
        ...
        return role.getValue("RolePolicyArgs.role");
    }
