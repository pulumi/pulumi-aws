...
public final class InsightFiltersResourceAwsIamAccessKeyStatus {
    ...
    public String comparison() {
        ...
        return comparison.getValue("InsightFiltersResourceAwsIamAccessKeyStatus.comparison");
    }
    ...
    public String value() {
        ...
        return value.getValue("InsightFiltersResourceAwsIamAccessKeyStatus.value");
    }
