...
public final class VpnConnectionTunnel1LogOptionsCloudwatchLogOptions {
    ...
    public @Nullable Boolean logEnabled() {
        ...
        throw new UndeferrableValueException("Value 'VpnConnectionTunnel1LogOptionsCloudwatchLogOptions.logEnabled' is not present");
    }
    ...
    public @Nullable String logGroupArn() {
        ...
        throw new UndeferrableValueException("Value 'VpnConnectionTunnel1LogOptionsCloudwatchLogOptions.logGroupArn' is not present");
    }
    ...
    public @Nullable String logOutputFormat() {
        ...
        throw new UndeferrableValueException("Value 'VpnConnectionTunnel1LogOptionsCloudwatchLogOptions.logOutputFormat' is not present");
    }
