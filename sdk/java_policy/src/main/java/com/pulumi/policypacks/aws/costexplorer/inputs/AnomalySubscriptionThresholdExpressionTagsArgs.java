...
public final class AnomalySubscriptionThresholdExpressionTagsArgs {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionTagsArgs.key' is not present");
    }
    ...
    public List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionTagsArgs.matchOptions' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionTagsArgs.values' is not present");
    }
