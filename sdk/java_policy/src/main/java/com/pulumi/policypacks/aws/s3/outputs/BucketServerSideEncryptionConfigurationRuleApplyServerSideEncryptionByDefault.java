...
public final class BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault {
    ...
    public @Nullable String kmsMasterKeyId() {
        ...
        throw new UndeferrableValueException("Value 'BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault.kmsMasterKeyId' is not present");
    }
    ...
    public String sseAlgorithm() {
        ...
        throw new UndeferrableValueException("Value 'BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault.sseAlgorithm' is not present");
    }
