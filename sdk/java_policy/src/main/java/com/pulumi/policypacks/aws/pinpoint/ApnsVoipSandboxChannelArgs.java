...
public final class ApnsVoipSandboxChannelArgs extends com.pulumi.resources.PolicyResourceInput {
    ...
    public String applicationId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipSandboxChannelArgs.applicationId' is not present");
    }
    ...
    public String bundleId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipSandboxChannelArgs.bundleId' is not present");
    }
    ...
    public String certificate() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipSandboxChannelArgs.certificate' is not present");
    }
    ...
    public String defaultAuthenticationMethod() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipSandboxChannelArgs.defaultAuthenticationMethod' is not present");
    }
    ...
    public Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipSandboxChannelArgs.enabled' is not present");
    }
    ...
    public String privateKey() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipSandboxChannelArgs.privateKey' is not present");
    }
    ...
    public String teamId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipSandboxChannelArgs.teamId' is not present");
    }
    ...
    public String tokenKey() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipSandboxChannelArgs.tokenKey' is not present");
    }
    ...
    public String tokenKeyId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipSandboxChannelArgs.tokenKeyId' is not present");
    }
