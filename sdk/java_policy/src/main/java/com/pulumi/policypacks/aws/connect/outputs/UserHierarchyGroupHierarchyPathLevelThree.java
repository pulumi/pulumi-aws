...
public final class UserHierarchyGroupHierarchyPathLevelThree {
    ...
    public @Nullable String arn() {
        ...
        return arn.getValue("UserHierarchyGroupHierarchyPathLevelThree.arn");
    }
    ...
    public @Nullable String id() {
        ...
        return id.getValue("UserHierarchyGroupHierarchyPathLevelThree.id");
    }
    ...
    public @Nullable String name() {
        ...
        return name.getValue("UserHierarchyGroupHierarchyPathLevelThree.name");
    }
