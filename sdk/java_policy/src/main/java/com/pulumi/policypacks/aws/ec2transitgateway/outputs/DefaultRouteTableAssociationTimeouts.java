...
public final class DefaultRouteTableAssociationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("DefaultRouteTableAssociationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("DefaultRouteTableAssociationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("DefaultRouteTableAssociationTimeouts.update");
    }
