...
public final class AnalysisSourceEntitySourceTemplateDataSetReference {
    ...
    public String dataSetArn() {
        ...
        throw new UndeferrableValueException("Value 'AnalysisSourceEntitySourceTemplateDataSetReference.dataSetArn' is not present");
    }
    ...
    public String dataSetPlaceholder() {
        ...
        throw new UndeferrableValueException("Value 'AnalysisSourceEntitySourceTemplateDataSetReference.dataSetPlaceholder' is not present");
    }
