...
public final class LogAccountPolicyArgs extends com.pulumi.resources.PolicyResourceInput {
    ...
    public String policyDocument() {
        ...
        return policyDocument.getValue("LogAccountPolicyArgs.policyDocument");
    }
    ...
    public String policyName() {
        ...
        return policyName.getValue("LogAccountPolicyArgs.policyName");
    }
    ...
    public String policyType() {
        ...
        return policyType.getValue("LogAccountPolicyArgs.policyType");
    }
    ...
    public String scope() {
        ...
        return scope.getValue("LogAccountPolicyArgs.scope");
    }
     ...
     * 
     */
    private UndeferrableValue<String> selectionCriteria;

    public String selectionCriteria() {
        if (selectionCriteria == null) return null;
        return selectionCriteria.getValue("LogAccountPolicyArgs.selectionCriteria");
    }
