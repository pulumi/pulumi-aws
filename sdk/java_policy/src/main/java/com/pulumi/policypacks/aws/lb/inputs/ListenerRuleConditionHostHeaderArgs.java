...
public final class ListenerRuleConditionHostHeaderArgs {
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'ListenerRuleConditionHostHeaderArgs.values' is not present");
    }
