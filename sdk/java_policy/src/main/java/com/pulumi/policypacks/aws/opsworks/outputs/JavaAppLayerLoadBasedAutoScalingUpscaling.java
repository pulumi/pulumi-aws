...
public final class JavaAppLayerLoadBasedAutoScalingUpscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("JavaAppLayerLoadBasedAutoScalingUpscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("JavaAppLayerLoadBasedAutoScalingUpscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("JavaAppLayerLoadBasedAutoScalingUpscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("JavaAppLayerLoadBasedAutoScalingUpscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("JavaAppLayerLoadBasedAutoScalingUpscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("JavaAppLayerLoadBasedAutoScalingUpscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("JavaAppLayerLoadBasedAutoScalingUpscaling.thresholdsWaitTime");
    }
