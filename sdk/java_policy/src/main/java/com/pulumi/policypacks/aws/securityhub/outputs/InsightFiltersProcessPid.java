...
public final class InsightFiltersProcessPid {
    ...
    public @Nullable String eq() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProcessPid.eq' is not present");
    }
    ...
    public @Nullable String gte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProcessPid.gte' is not present");
    }
    ...
    public @Nullable String lte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProcessPid.lte' is not present");
    }
