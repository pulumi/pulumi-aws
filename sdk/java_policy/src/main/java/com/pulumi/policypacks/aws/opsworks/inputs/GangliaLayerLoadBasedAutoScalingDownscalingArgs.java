...
public final class GangliaLayerLoadBasedAutoScalingDownscalingArgs {
    ...
    public List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingDownscalingArgs.alarms' is not present");
    }
    ...
    public Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingDownscalingArgs.cpuThreshold' is not present");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingDownscalingArgs.ignoreMetricsTime' is not present");
    }
    ...
    public Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingDownscalingArgs.instanceCount' is not present");
    }
    ...
    public Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingDownscalingArgs.loadThreshold' is not present");
    }
    ...
    public Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingDownscalingArgs.memoryThreshold' is not present");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingDownscalingArgs.thresholdsWaitTime' is not present");
    }
