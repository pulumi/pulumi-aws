...
public final class GangliaLayerLoadBasedAutoScalingDownscalingArgs {
    ...
    public List<String> alarms() {
        ...
        return alarms.getValue("GangliaLayerLoadBasedAutoScalingDownscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("GangliaLayerLoadBasedAutoScalingDownscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("GangliaLayerLoadBasedAutoScalingDownscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("GangliaLayerLoadBasedAutoScalingDownscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("GangliaLayerLoadBasedAutoScalingDownscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("GangliaLayerLoadBasedAutoScalingDownscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("GangliaLayerLoadBasedAutoScalingDownscalingArgs.thresholdsWaitTime");
    }
