...
public final class DomainAdminContact {
    ...
    public @Nullable String addressLine1() {
        ...
        return addressLine1.getValue("DomainAdminContact.addressLine1");
    }
    ...
    public @Nullable String addressLine2() {
        ...
        return addressLine2.getValue("DomainAdminContact.addressLine2");
    }
    ...
    public @Nullable String city() {
        ...
        return city.getValue("DomainAdminContact.city");
    }
    ...
    public @Nullable String contactType() {
        ...
        return contactType.getValue("DomainAdminContact.contactType");
    }
    ...
    public @Nullable String countryCode() {
        ...
        return countryCode.getValue("DomainAdminContact.countryCode");
    }
    ...
    public @Nullable String email() {
        ...
        return email.getValue("DomainAdminContact.email");
    }
     ...
     * 
     */
    private @Nullable UndeferrableValue<List<DomainAdminContactExtraParam>> extraParams;

    public @Nullable List<DomainAdminContactExtraParam> extraParams() {
        if (extraParams == null) return null;
        return extraParams.getValue("DomainAdminContact.extraParams");
    }
    ...
    public @Nullable String fax() {
        ...
        return fax.getValue("DomainAdminContact.fax");
    }
    ...
    public @Nullable String firstName() {
        ...
        return firstName.getValue("DomainAdminContact.firstName");
    }
    ...
    public @Nullable String lastName() {
        ...
        return lastName.getValue("DomainAdminContact.lastName");
    }
    ...
    public @Nullable String organizationName() {
        ...
        return organizationName.getValue("DomainAdminContact.organizationName");
    }
    ...
    public @Nullable String phoneNumber() {
        ...
        return phoneNumber.getValue("DomainAdminContact.phoneNumber");
    }
    ...
    public @Nullable String state() {
        ...
        return state.getValue("DomainAdminContact.state");
    }
    ...
    public @Nullable String zipCode() {
        ...
        return zipCode.getValue("DomainAdminContact.zipCode");
    }
