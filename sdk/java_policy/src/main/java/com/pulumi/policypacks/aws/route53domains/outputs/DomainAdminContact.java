...
import com.pulumi.policypacks.aws.route53domains.outputs.DomainAdminContactExtraParam;
...
public final class DomainAdminContact {
    ...
    public @Nullable String addressLine1() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.addressLine1' is not present");
    }
    ...
    public @Nullable String addressLine2() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.addressLine2' is not present");
    }
    ...
    public @Nullable String city() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.city' is not present");
    }
    ...
    public @Nullable String contactType() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.contactType' is not present");
    }
    ...
    public @Nullable String countryCode() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.countryCode' is not present");
    }
    ...
    public @Nullable String email() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.email' is not present");
    }
    ...
    private @Nullable List<DomainAdminContactExtraParam> value_extraParams;
    private boolean unknown_extraParams;
    public @Nullable List<DomainAdminContactExtraParam> extraParams() {
        if (!unknown_extraParams) return value_extraParams;
        throw new UndeferrableValueException("Value 'DomainAdminContact.extraParams' is not present");
    }
    ...
    public @Nullable String fax() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.fax' is not present");
    }
    ...
    public @Nullable String firstName() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.firstName' is not present");
    }
    ...
    public @Nullable String lastName() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.lastName' is not present");
    }
    ...
    public @Nullable String organizationName() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.organizationName' is not present");
    }
    ...
    public @Nullable String phoneNumber() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.phoneNumber' is not present");
    }
    ...
    public @Nullable String state() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.state' is not present");
    }
    ...
    public @Nullable String zipCode() {
        ...
        throw new UndeferrableValueException("Value 'DomainAdminContact.zipCode' is not present");
    }
