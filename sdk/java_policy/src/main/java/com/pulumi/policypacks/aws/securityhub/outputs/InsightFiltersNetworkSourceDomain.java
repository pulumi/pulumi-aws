...
public final class InsightFiltersNetworkSourceDomain {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNetworkSourceDomain.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNetworkSourceDomain.value' is not present");
    }
