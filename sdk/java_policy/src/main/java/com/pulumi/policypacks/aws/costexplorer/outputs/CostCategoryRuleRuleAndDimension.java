...
public final class CostCategoryRuleRuleAndDimension {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleAndDimension.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleAndDimension.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleAndDimension.values");
    }
