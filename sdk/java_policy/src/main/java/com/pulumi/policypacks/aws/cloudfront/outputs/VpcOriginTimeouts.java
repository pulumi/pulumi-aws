...
public final class VpcOriginTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("VpcOriginTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("VpcOriginTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("VpcOriginTimeouts.update");
    }
