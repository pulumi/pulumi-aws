...
public final class AmiEbsBlockDevice {
    ...
    public @Nullable Boolean deleteOnTermination() {
        ...
        return deleteOnTermination.getValue("AmiEbsBlockDevice.deleteOnTermination");
    }
    ...
    public String deviceName() {
        ...
        return deviceName.getValue("AmiEbsBlockDevice.deviceName");
    }
    ...
    public @Nullable Boolean encrypted() {
        ...
        return encrypted.getValue("AmiEbsBlockDevice.encrypted");
    }
    ...
    public @Nullable Integer iops() {
        ...
        return iops.getValue("AmiEbsBlockDevice.iops");
    }
    ...
    public @Nullable String outpostArn() {
        ...
        return outpostArn.getValue("AmiEbsBlockDevice.outpostArn");
    }
    ...
    public @Nullable String snapshotId() {
        ...
        return snapshotId.getValue("AmiEbsBlockDevice.snapshotId");
    }
    ...
    public @Nullable Integer throughput() {
        ...
        return throughput.getValue("AmiEbsBlockDevice.throughput");
    }
    ...
    public @Nullable Integer volumeSize() {
        ...
        return volumeSize.getValue("AmiEbsBlockDevice.volumeSize");
    }
    ...
    public @Nullable String volumeType() {
        ...
        return volumeType.getValue("AmiEbsBlockDevice.volumeType");
    }
