...
public final class BucketReplicationConfigurationRuleFilter {
    ...
    public @Nullable String prefix() {
        ...
        throw new UndeferrableValueException("Value 'BucketReplicationConfigurationRuleFilter.prefix' is not present");
    }
    ...
    public @Nullable Map<String,String> tags() {
        ...
        throw new UndeferrableValueException("Value 'BucketReplicationConfigurationRuleFilter.tags' is not present");
    }
