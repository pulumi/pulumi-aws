...
public final class DomainBillingContact {
    ...
    public String addressLine1() {
        ...
        return addressLine1.getValue("DomainBillingContact.addressLine1");
    }
    ...
    public String addressLine2() {
        ...
        return addressLine2.getValue("DomainBillingContact.addressLine2");
    }
    ...
    public String city() {
        ...
        return city.getValue("DomainBillingContact.city");
    }
    ...
    public String contactType() {
        ...
        return contactType.getValue("DomainBillingContact.contactType");
    }
    ...
    public String countryCode() {
        ...
        return countryCode.getValue("DomainBillingContact.countryCode");
    }
    ...
    public String email() {
        ...
        return email.getValue("DomainBillingContact.email");
    }
     ...
     * 
     */
    private UndeferrableValue<List<DomainBillingContactExtraParam>> extraParams;

    public List<DomainBillingContactExtraParam> extraParams() {
        if (extraParams == null) return null;
        return extraParams.getValue("DomainBillingContact.extraParams");
    }
    ...
    public String fax() {
        ...
        return fax.getValue("DomainBillingContact.fax");
    }
    ...
    public String firstName() {
        ...
        return firstName.getValue("DomainBillingContact.firstName");
    }
    ...
    public String lastName() {
        ...
        return lastName.getValue("DomainBillingContact.lastName");
    }
    ...
    public String organizationName() {
        ...
        return organizationName.getValue("DomainBillingContact.organizationName");
    }
    ...
    public String phoneNumber() {
        ...
        return phoneNumber.getValue("DomainBillingContact.phoneNumber");
    }
    ...
    public String state() {
        ...
        return state.getValue("DomainBillingContact.state");
    }
    ...
    public String zipCode() {
        ...
        return zipCode.getValue("DomainBillingContact.zipCode");
    }
