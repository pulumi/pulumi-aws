...
public final class LustreFileSystem extends com.pulumi.resources.PolicyResourceOutput {
    ...
    private @Nullable String value_driveCacheType;
    ...
    private @Nullable String value_importPath;
    ...
    private LustreFileSystemLogConfiguration value_logConfiguration;
    ...
    private LustreFileSystemMetadataConfiguration value_metadataConfiguration;
    ...
    private @Nullable Integer value_perUnitStorageThroughput;
    ...
    private @Nullable LustreFileSystemRootSquashConfiguration value_rootSquashConfiguration;
