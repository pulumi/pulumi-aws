...
public final class Smsvoicev2PhoneNumberTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("Smsvoicev2PhoneNumberTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("Smsvoicev2PhoneNumberTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("Smsvoicev2PhoneNumberTimeouts.update");
    }
