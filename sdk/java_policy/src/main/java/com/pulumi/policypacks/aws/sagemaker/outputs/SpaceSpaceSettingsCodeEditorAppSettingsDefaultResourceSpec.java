...
public final class SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec {
    ...
    public @Nullable String instanceType() {
        ...
        return instanceType.getValue("SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec.instanceType");
    }
    ...
    public @Nullable String lifecycleConfigArn() {
        ...
        return lifecycleConfigArn.getValue("SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec.lifecycleConfigArn");
    }
    ...
    public @Nullable String sagemakerImageArn() {
        ...
        return sagemakerImageArn.getValue("SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec.sagemakerImageArn");
    }
    ...
    public @Nullable String sagemakerImageVersionAlias() {
        ...
        return sagemakerImageVersionAlias.getValue("SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec.sagemakerImageVersionAlias");
    }
    ...
    public @Nullable String sagemakerImageVersionArn() {
        ...
        return sagemakerImageVersionArn.getValue("SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec.sagemakerImageVersionArn");
    }
