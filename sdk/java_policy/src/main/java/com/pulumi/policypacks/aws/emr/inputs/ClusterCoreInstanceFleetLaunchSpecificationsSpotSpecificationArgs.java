...
public final class ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs {
    ...
    public String allocationStrategy() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs.allocationStrategy' is not present");
    }
    ...
    public Integer blockDurationMinutes() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs.blockDurationMinutes' is not present");
    }
    ...
    public String timeoutAction() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs.timeoutAction' is not present");
    }
    ...
    public Integer timeoutDurationMinutes() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs.timeoutDurationMinutes' is not present");
    }
