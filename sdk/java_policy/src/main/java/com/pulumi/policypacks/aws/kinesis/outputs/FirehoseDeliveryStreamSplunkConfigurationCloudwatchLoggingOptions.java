...
public final class FirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions {
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions.enabled' is not present");
    }
    ...
    public @Nullable String logGroupName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions.logGroupName' is not present");
    }
    ...
    public @Nullable String logStreamName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamSplunkConfigurationCloudwatchLoggingOptions.logStreamName' is not present");
    }
