...
public final class StorageLensConfigurationStorageLensConfigurationExcludeArgs {
    ...
    public List<String> buckets() {
        ...
        throw new UndeferrableValueException("Value 'StorageLensConfigurationStorageLensConfigurationExcludeArgs.buckets' is not present");
    }
    ...
    public List<String> regions() {
        ...
        throw new UndeferrableValueException("Value 'StorageLensConfigurationStorageLensConfigurationExcludeArgs.regions' is not present");
    }
