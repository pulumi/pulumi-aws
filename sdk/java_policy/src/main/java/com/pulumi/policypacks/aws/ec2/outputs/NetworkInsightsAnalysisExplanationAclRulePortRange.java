...
public final class NetworkInsightsAnalysisExplanationAclRulePortRange {
    ...
    public @Nullable Integer from() {
        ...
        throw new UndeferrableValueException("Value 'NetworkInsightsAnalysisExplanationAclRulePortRange.from' is not present");
    }
    ...
    public @Nullable Integer to() {
        ...
        throw new UndeferrableValueException("Value 'NetworkInsightsAnalysisExplanationAclRulePortRange.to' is not present");
    }
