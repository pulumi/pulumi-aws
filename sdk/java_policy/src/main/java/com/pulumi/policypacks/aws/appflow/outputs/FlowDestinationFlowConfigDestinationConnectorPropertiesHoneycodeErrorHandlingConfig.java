...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesHoneycodeErrorHandlingConfig {
    ...
    public @Nullable String bucketName() {
        ...
        return bucketName.getValue("FlowDestinationFlowConfigDestinationConnectorPropertiesHoneycodeErrorHandlingConfig.bucketName");
    }
    ...
    public @Nullable String bucketPrefix() {
        ...
        return bucketPrefix.getValue("FlowDestinationFlowConfigDestinationConnectorPropertiesHoneycodeErrorHandlingConfig.bucketPrefix");
    }
    ...
    public @Nullable Boolean failOnFirstDestinationError() {
        ...
        return failOnFirstDestinationError.getValue("FlowDestinationFlowConfigDestinationConnectorPropertiesHoneycodeErrorHandlingConfig.failOnFirstDestinationError");
    }
