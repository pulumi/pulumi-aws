...
public final class V2modelsIntentClosingSettingNextStepDialogAction {
    ...
    public @Nullable String slotToElicit() {
        ...
        return slotToElicit.getValue("V2modelsIntentClosingSettingNextStepDialogAction.slotToElicit");
    }
    ...
    public @Nullable Boolean suppressNextMessage() {
        ...
        return suppressNextMessage.getValue("V2modelsIntentClosingSettingNextStepDialogAction.suppressNextMessage");
    }
    ...
    public String type() {
        ...
        return type.getValue("V2modelsIntentClosingSettingNextStepDialogAction.type");
    }
