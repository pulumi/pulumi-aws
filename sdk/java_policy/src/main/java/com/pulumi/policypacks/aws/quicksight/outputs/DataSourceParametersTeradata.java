...
public final class DataSourceParametersTeradata {
    ...
    public String database() {
        ...
        return database.getValue("DataSourceParametersTeradata.database");
    }
    ...
    public String host() {
        ...
        return host.getValue("DataSourceParametersTeradata.host");
    }
    ...
    public Integer port() {
        ...
        return port.getValue("DataSourceParametersTeradata.port");
    }
