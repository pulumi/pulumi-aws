...
public final class NodejsAppLayerLoadBasedAutoScalingUpscalingArgs {

    private UndeferrableValue<List<String>> alarms;

    public List<String> alarms() {
        if (alarms == null) return null;
        return alarms.getValue("NodejsAppLayerLoadBasedAutoScalingUpscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("NodejsAppLayerLoadBasedAutoScalingUpscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("NodejsAppLayerLoadBasedAutoScalingUpscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("NodejsAppLayerLoadBasedAutoScalingUpscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("NodejsAppLayerLoadBasedAutoScalingUpscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("NodejsAppLayerLoadBasedAutoScalingUpscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("NodejsAppLayerLoadBasedAutoScalingUpscalingArgs.thresholdsWaitTime");
    }
