...
public final class DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec {
    ...
    public @Nullable String instanceType() {
        ...
        return instanceType.getValue("DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec.instanceType");
    }
    ...
    public @Nullable String lifecycleConfigArn() {
        ...
        return lifecycleConfigArn.getValue("DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec.lifecycleConfigArn");
    }
    ...
    public @Nullable String sagemakerImageArn() {
        ...
        return sagemakerImageArn.getValue("DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec.sagemakerImageArn");
    }
    ...
    public @Nullable String sagemakerImageVersionAlias() {
        ...
        return sagemakerImageVersionAlias.getValue("DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec.sagemakerImageVersionAlias");
    }
    ...
    public @Nullable String sagemakerImageVersionArn() {
        ...
        return sagemakerImageVersionArn.getValue("DomainDefaultUserSettingsKernelGatewayAppSettingsDefaultResourceSpec.sagemakerImageVersionArn");
    }
