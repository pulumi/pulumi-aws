...
public final class SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTarget {
    ...
    public @Nullable String capacityReservationId() {
        ...
        return capacityReservationId.getValue("SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTarget.capacityReservationId");
    }
    ...
    public @Nullable String capacityReservationResourceGroupArn() {
        ...
        return capacityReservationResourceGroupArn.getValue("SpotInstanceRequestCapacityReservationSpecificationCapacityReservationTarget.capacityReservationResourceGroupArn");
    }
