...
public final class FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions {
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions.enabled' is not present");
    }
    ...
    public @Nullable String logGroupName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions.logGroupName' is not present");
    }
    ...
    public @Nullable String logStreamName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamRedshiftConfigurationCloudwatchLoggingOptions.logStreamName' is not present");
    }
