...
public final class GatewayRouteSpecHttpRouteActionRewritePrefix {
    ...
    public @Nullable String defaultPrefix() {
        ...
        throw new UndeferrableValueException("Value 'GatewayRouteSpecHttpRouteActionRewritePrefix.defaultPrefix' is not present");
    }
    ...
    public @Nullable String value() {
        ...
        throw new UndeferrableValueException("Value 'GatewayRouteSpecHttpRouteActionRewritePrefix.value' is not present");
    }
