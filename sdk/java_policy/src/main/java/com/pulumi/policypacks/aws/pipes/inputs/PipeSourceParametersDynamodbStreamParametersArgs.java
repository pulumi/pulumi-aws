...
import com.pulumi.policypacks.aws.pipes.inputs.PipeSourceParametersDynamodbStreamParametersDeadLetterConfigArgs;
...
public final class PipeSourceParametersDynamodbStreamParametersArgs {
    ...
    public Integer batchSize() {
        ...
        return batchSize.getValue("PipeSourceParametersDynamodbStreamParametersArgs.batchSize");
    }
     ...
     * 
     */
    private UndeferrableValue<PipeSourceParametersDynamodbStreamParametersDeadLetterConfigArgs> deadLetterConfig;

    public PipeSourceParametersDynamodbStreamParametersDeadLetterConfigArgs deadLetterConfig() {
        if (deadLetterConfig == null) return null;
        return deadLetterConfig.getValue("PipeSourceParametersDynamodbStreamParametersArgs.deadLetterConfig");
    }
    ...
    public Integer maximumBatchingWindowInSeconds() {
        ...
        return maximumBatchingWindowInSeconds.getValue("PipeSourceParametersDynamodbStreamParametersArgs.maximumBatchingWindowInSeconds");
    }
    ...
    public Integer maximumRecordAgeInSeconds() {
        ...
        return maximumRecordAgeInSeconds.getValue("PipeSourceParametersDynamodbStreamParametersArgs.maximumRecordAgeInSeconds");
    }
    ...
    public Integer maximumRetryAttempts() {
        ...
        return maximumRetryAttempts.getValue("PipeSourceParametersDynamodbStreamParametersArgs.maximumRetryAttempts");
    }
    ...
    public String onPartialBatchItemFailure() {
        ...
        return onPartialBatchItemFailure.getValue("PipeSourceParametersDynamodbStreamParametersArgs.onPartialBatchItemFailure");
    }
    ...
    public Integer parallelizationFactor() {
        ...
        return parallelizationFactor.getValue("PipeSourceParametersDynamodbStreamParametersArgs.parallelizationFactor");
    }
    ...
    public String startingPosition() {
        ...
        return startingPosition.getValue("PipeSourceParametersDynamodbStreamParametersArgs.startingPosition");
    }
