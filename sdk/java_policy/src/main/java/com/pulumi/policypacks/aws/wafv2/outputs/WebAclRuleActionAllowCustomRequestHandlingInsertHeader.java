...
public final class WebAclRuleActionAllowCustomRequestHandlingInsertHeader {
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleActionAllowCustomRequestHandlingInsertHeader.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclRuleActionAllowCustomRequestHandlingInsertHeader.value");
    }
