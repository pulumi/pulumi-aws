...
public final class TableOnDemandThroughput {
    ...
    public @Nullable Integer maxReadRequestUnits() {
        ...
        return maxReadRequestUnits.getValue("TableOnDemandThroughput.maxReadRequestUnits");
    }
    ...
    public @Nullable Integer maxWriteRequestUnits() {
        ...
        return maxWriteRequestUnits.getValue("TableOnDemandThroughput.maxWriteRequestUnits");
    }
