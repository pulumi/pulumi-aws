...
import com.pulumi.policypacks.aws.securityhub.outputs.InsightFiltersUpdatedAtDateRange;
...
public final class InsightFiltersUpdatedAt {
    ...
    private @Nullable InsightFiltersUpdatedAtDateRange value_dateRange;
    private boolean unknown_dateRange;
    public @Nullable InsightFiltersUpdatedAtDateRange dateRange() {
        if (!unknown_dateRange) return value_dateRange;
        throw new UndeferrableValueException("Value 'InsightFiltersUpdatedAt.dateRange' is not present");
    }
    ...
    public @Nullable String end() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersUpdatedAt.end' is not present");
    }
    ...
    public @Nullable String start() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersUpdatedAt.start' is not present");
    }
