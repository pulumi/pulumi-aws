...
public final class RouteSpecHttp2RouteActionWeightedTargetArgs {
    ...
    public Integer port() {
        ...
        throw new UndeferrableValueException("Value 'RouteSpecHttp2RouteActionWeightedTargetArgs.port' is not present");
    }
    ...
    public String virtualNode() {
        ...
        throw new UndeferrableValueException("Value 'RouteSpecHttp2RouteActionWeightedTargetArgs.virtualNode' is not present");
    }
    ...
    public Integer weight() {
        ...
        throw new UndeferrableValueException("Value 'RouteSpecHttp2RouteActionWeightedTargetArgs.weight' is not present");
    }
