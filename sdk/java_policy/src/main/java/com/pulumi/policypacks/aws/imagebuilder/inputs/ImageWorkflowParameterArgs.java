...
public final class ImageWorkflowParameterArgs {
    ...
    public String name() {
        ...
        return name.getValue("ImageWorkflowParameterArgs.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("ImageWorkflowParameterArgs.value");
    }
