...
public final class RuleGroupCustomResponseBodyArgs {
    ...
    public String content() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupCustomResponseBodyArgs.content' is not present");
    }
    ...
    public String contentType() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupCustomResponseBodyArgs.contentType' is not present");
    }
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupCustomResponseBodyArgs.key' is not present");
    }
