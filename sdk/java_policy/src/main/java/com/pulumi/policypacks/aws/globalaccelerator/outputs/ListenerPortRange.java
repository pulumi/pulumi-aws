...
public final class ListenerPortRange {
    ...
    public @Nullable Integer fromPort() {
        ...
        throw new UndeferrableValueException("Value 'ListenerPortRange.fromPort' is not present");
    }
    ...
    public @Nullable Integer toPort() {
        ...
        throw new UndeferrableValueException("Value 'ListenerPortRange.toPort' is not present");
    }
