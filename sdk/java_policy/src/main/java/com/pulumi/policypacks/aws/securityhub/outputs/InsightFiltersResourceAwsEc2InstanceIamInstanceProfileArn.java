...
public final class InsightFiltersResourceAwsEc2InstanceIamInstanceProfileArn {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceAwsEc2InstanceIamInstanceProfileArn.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceAwsEc2InstanceIamInstanceProfileArn.value' is not present");
    }
