...
public final class InsightFiltersProductArnArgs {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProductArnArgs.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProductArnArgs.value' is not present");
    }
