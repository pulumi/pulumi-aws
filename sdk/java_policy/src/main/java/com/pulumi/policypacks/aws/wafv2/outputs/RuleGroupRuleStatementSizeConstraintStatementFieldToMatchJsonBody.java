...
public final class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        return invalidFallbackBehavior.getValue("RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody.invalidFallbackBehavior");
    }
     ...
     * 
     */
    private UndeferrableValue<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern> matchPattern;
    ...
    public RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        ...
        return matchPattern.getValue("RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody.matchPattern");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody.matchScope");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        return oversizeHandling.getValue("RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody.oversizeHandling");
    }
