...
public final class DataSourceParametersAuroraPostgresqlArgs {
    ...
    public String database() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersAuroraPostgresqlArgs.database' is not present");
    }
    ...
    public String host() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersAuroraPostgresqlArgs.host' is not present");
    }
    ...
    public Integer port() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersAuroraPostgresqlArgs.port' is not present");
    }
