...
public final class RuleGroupVisibilityConfig {
    ...
    public Boolean cloudwatchMetricsEnabled() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupVisibilityConfig.cloudwatchMetricsEnabled' is not present");
    }
    ...
    public String metricName() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupVisibilityConfig.metricName' is not present");
    }
    ...
    public Boolean sampledRequestsEnabled() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupVisibilityConfig.sampledRequestsEnabled' is not present");
    }
