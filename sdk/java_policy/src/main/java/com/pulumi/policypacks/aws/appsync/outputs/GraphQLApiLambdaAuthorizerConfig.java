...
public final class GraphQLApiLambdaAuthorizerConfig {
    ...
    public @Nullable Integer authorizerResultTtlInSeconds() {
        ...
        return authorizerResultTtlInSeconds.getValue("GraphQLApiLambdaAuthorizerConfig.authorizerResultTtlInSeconds");
    }
    ...
    public String authorizerUri() {
        ...
        return authorizerUri.getValue("GraphQLApiLambdaAuthorizerConfig.authorizerUri");
    }
    ...
    public @Nullable String identityValidationExpression() {
        ...
        return identityValidationExpression.getValue("GraphQLApiLambdaAuthorizerConfig.identityValidationExpression");
    }
