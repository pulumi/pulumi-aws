...
public final class WebAclRuleStatementRateBasedStatementCustomKeyQueryArgumentTextTransformation {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementCustomKeyQueryArgumentTextTransformation.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementCustomKeyQueryArgumentTextTransformation.type' is not present");
    }
