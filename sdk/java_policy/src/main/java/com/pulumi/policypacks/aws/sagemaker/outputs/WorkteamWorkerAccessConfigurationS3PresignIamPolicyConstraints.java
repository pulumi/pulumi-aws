...
public final class WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints {
    ...
    public @Nullable String sourceIp() {
        ...
        return sourceIp.getValue("WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints.sourceIp");
    }
     ...
     * 
     */
    private @Nullable UndeferrableValue<String> vpcSourceIp;

    public @Nullable String vpcSourceIp() {
        if (vpcSourceIp == null) return null;
        return vpcSourceIp.getValue("WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints.vpcSourceIp");
    }
