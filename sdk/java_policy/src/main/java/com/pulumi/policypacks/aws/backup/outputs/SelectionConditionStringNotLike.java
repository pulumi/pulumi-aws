...
public final class SelectionConditionStringNotLike {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'SelectionConditionStringNotLike.key' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'SelectionConditionStringNotLike.value' is not present");
    }
