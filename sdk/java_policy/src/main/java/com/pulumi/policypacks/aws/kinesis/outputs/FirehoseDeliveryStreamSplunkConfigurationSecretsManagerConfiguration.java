...
public final class FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration {
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration.enabled' is not present");
    }
    ...
    public @Nullable String roleArn() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration.roleArn' is not present");
    }
    ...
    public @Nullable String secretArn() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration.secretArn' is not present");
    }
