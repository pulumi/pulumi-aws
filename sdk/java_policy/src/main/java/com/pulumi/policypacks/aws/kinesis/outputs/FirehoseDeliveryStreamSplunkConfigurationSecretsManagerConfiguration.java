...
public final class FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration {
    ...
    public @Nullable Boolean enabled() {
        ...
        return enabled.getValue("FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration.enabled");
    }
    ...
    public @Nullable String roleArn() {
        ...
        return roleArn.getValue("FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration.roleArn");
    }
    ...
    public @Nullable String secretArn() {
        ...
        return secretArn.getValue("FirehoseDeliveryStreamSplunkConfigurationSecretsManagerConfiguration.secretArn");
    }
