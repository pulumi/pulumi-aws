...
public final class CostCategoryRuleRuleOrAndTagsArgs {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrAndTagsArgs.key' is not present");
    }
    ...
    public List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrAndTagsArgs.matchOptions' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrAndTagsArgs.values' is not present");
    }
