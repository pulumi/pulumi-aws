...
public final class InvocationLoggingConfigurationLoggingConfigCloudwatchConfigLargeDataDeliveryS3Config {
    ...
    public @Nullable String bucketName() {
        ...
        return bucketName.getValue("InvocationLoggingConfigurationLoggingConfigCloudwatchConfigLargeDataDeliveryS3Config.bucketName");
    }
    ...
    public @Nullable String keyPrefix() {
        ...
        return keyPrefix.getValue("InvocationLoggingConfigurationLoggingConfigCloudwatchConfigLargeDataDeliveryS3Config.keyPrefix");
    }
