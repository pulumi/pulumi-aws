...
public final class RuleGroupRuleStatementRegexMatchStatementTextTransformation {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementTextTransformation.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementTextTransformation.type' is not present");
    }
