...
public final class LaunchTemplatePrivateDnsNameOptions {
    ...
    public @Nullable Boolean enableResourceNameDnsARecord() {
        ...
        return enableResourceNameDnsARecord.getValue("LaunchTemplatePrivateDnsNameOptions.enableResourceNameDnsARecord");
    }
    ...
    public @Nullable Boolean enableResourceNameDnsAaaaRecord() {
        ...
        return enableResourceNameDnsAaaaRecord.getValue("LaunchTemplatePrivateDnsNameOptions.enableResourceNameDnsAaaaRecord");
    }
    ...
    public @Nullable String hostnameType() {
        ...
        return hostnameType.getValue("LaunchTemplatePrivateDnsNameOptions.hostnameType");
    }
