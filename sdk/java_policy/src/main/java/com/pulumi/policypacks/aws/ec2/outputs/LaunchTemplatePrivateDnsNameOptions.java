...
public final class LaunchTemplatePrivateDnsNameOptions {
    ...
    public @Nullable Boolean enableResourceNameDnsARecord() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplatePrivateDnsNameOptions.enableResourceNameDnsARecord' is not present");
    }
    ...
    public @Nullable Boolean enableResourceNameDnsAaaaRecord() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplatePrivateDnsNameOptions.enableResourceNameDnsAaaaRecord' is not present");
    }
    ...
    public @Nullable String hostnameType() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplatePrivateDnsNameOptions.hostnameType' is not present");
    }
