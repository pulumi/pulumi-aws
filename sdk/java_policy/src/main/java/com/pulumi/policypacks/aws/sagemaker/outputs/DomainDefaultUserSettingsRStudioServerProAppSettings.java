...
public final class DomainDefaultUserSettingsRStudioServerProAppSettings {
    ...
    public @Nullable String accessStatus() {
        ...
        return accessStatus.getValue("DomainDefaultUserSettingsRStudioServerProAppSettings.accessStatus");
    }
    ...
    public @Nullable String userGroup() {
        ...
        return userGroup.getValue("DomainDefaultUserSettingsRStudioServerProAppSettings.userGroup");
    }
