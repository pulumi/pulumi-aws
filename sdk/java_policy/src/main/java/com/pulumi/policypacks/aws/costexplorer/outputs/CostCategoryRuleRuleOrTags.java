...
public final class CostCategoryRuleRuleOrTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleOrTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleOrTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleOrTags.values");
    }
