...
public final class LoadBalancerConnectionLogs {
    ...
    public String bucket() {
        ...
        throw new UndeferrableValueException("Value 'LoadBalancerConnectionLogs.bucket' is not present");
    }
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'LoadBalancerConnectionLogs.enabled' is not present");
    }
    ...
    public @Nullable String prefix() {
        ...
        throw new UndeferrableValueException("Value 'LoadBalancerConnectionLogs.prefix' is not present");
    }
