...
public final class SelectionConditionStringEqual {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'SelectionConditionStringEqual.key' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'SelectionConditionStringEqual.value' is not present");
    }
