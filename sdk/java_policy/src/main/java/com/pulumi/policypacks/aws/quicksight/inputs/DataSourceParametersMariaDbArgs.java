...
public final class DataSourceParametersMariaDbArgs {
    ...
    public String database() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersMariaDbArgs.database' is not present");
    }
    ...
    public String host() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersMariaDbArgs.host' is not present");
    }
    ...
    public Integer port() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersMariaDbArgs.port' is not present");
    }
