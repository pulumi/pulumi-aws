...
public final class RuleGroupRuleStatementRegexMatchStatementTextTransformationArgs {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementTextTransformationArgs.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementTextTransformationArgs.type' is not present");
    }
