...
import com.pulumi.policypacks.aws.opensearch.inputs.DomainClusterConfigColdStorageOptionsArgs;
import com.pulumi.policypacks.aws.opensearch.inputs.DomainClusterConfigNodeOptionArgs;
import com.pulumi.policypacks.aws.opensearch.inputs.DomainClusterConfigZoneAwarenessConfigArgs;
...
public final class DomainClusterConfigArgs {
     ...
     * 
     */
    private UndeferrableValue<Boolean> multiAzWithStandbyEnabled;

    public Boolean multiAzWithStandbyEnabled() {
        if (multiAzWithStandbyEnabled == null) return null;
        return multiAzWithStandbyEnabled.getValue("DomainClusterConfigArgs.multiAzWithStandbyEnabled");
    }
     ...
     * 
     */
    private UndeferrableValue<List<DomainClusterConfigNodeOptionArgs>> nodeOptions;

    public List<DomainClusterConfigNodeOptionArgs> nodeOptions() {
        if (nodeOptions == null) return null;
        return nodeOptions.getValue("DomainClusterConfigArgs.nodeOptions");
    }
