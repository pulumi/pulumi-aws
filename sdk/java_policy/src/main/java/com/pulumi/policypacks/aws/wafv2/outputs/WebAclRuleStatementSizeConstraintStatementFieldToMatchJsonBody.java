...
public final class WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        return invalidFallbackBehavior.getValue("WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody.invalidFallbackBehavior");
    }
     ...
     * 
     */
    private UndeferrableValue<WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern> matchPattern;
    ...
    public WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        ...
        return matchPattern.getValue("WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody.matchPattern");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody.matchScope");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        return oversizeHandling.getValue("WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody.oversizeHandling");
    }
