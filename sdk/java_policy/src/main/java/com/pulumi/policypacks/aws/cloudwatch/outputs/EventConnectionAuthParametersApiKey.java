...
public final class EventConnectionAuthParametersApiKey {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'EventConnectionAuthParametersApiKey.key' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'EventConnectionAuthParametersApiKey.value' is not present");
    }
