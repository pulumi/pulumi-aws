...
public final class ModelVpcConfig {
    ...
    public List<String> securityGroupIds() {
        ...
        throw new UndeferrableValueException("Value 'ModelVpcConfig.securityGroupIds' is not present");
    }
    ...
    public List<String> subnets() {
        ...
        throw new UndeferrableValueException("Value 'ModelVpcConfig.subnets' is not present");
    }
