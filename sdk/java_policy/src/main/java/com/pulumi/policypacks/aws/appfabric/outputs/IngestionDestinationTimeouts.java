...
public final class IngestionDestinationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("IngestionDestinationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("IngestionDestinationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("IngestionDestinationTimeouts.update");
    }
