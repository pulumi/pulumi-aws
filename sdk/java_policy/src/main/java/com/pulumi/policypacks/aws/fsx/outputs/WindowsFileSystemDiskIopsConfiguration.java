...
public final class WindowsFileSystemDiskIopsConfiguration {
    ...
    public @Nullable Integer iops() {
        ...
        throw new UndeferrableValueException("Value 'WindowsFileSystemDiskIopsConfiguration.iops' is not present");
    }
    ...
    public @Nullable String mode() {
        ...
        throw new UndeferrableValueException("Value 'WindowsFileSystemDiskIopsConfiguration.mode' is not present");
    }
