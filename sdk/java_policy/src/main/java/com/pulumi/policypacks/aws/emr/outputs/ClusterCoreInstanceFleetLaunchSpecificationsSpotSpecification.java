...
public final class ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification {
    ...
    public String allocationStrategy() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification.allocationStrategy' is not present");
    }
    ...
    public @Nullable Integer blockDurationMinutes() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification.blockDurationMinutes' is not present");
    }
    ...
    public String timeoutAction() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification.timeoutAction' is not present");
    }
    ...
    public Integer timeoutDurationMinutes() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecification.timeoutDurationMinutes' is not present");
    }
