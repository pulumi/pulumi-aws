...
public final class SpotInstanceRequestPrivateDnsNameOptions {
    ...
    public @Nullable Boolean enableResourceNameDnsARecord() {
        ...
        return enableResourceNameDnsARecord.getValue("SpotInstanceRequestPrivateDnsNameOptions.enableResourceNameDnsARecord");
    }
    ...
    public @Nullable Boolean enableResourceNameDnsAaaaRecord() {
        ...
        return enableResourceNameDnsAaaaRecord.getValue("SpotInstanceRequestPrivateDnsNameOptions.enableResourceNameDnsAaaaRecord");
    }
    ...
    public @Nullable String hostnameType() {
        ...
        return hostnameType.getValue("SpotInstanceRequestPrivateDnsNameOptions.hostnameType");
    }
