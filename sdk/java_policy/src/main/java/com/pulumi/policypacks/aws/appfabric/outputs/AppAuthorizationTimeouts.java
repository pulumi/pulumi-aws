...
public final class AppAuthorizationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("AppAuthorizationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("AppAuthorizationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("AppAuthorizationTimeouts.update");
    }
