...
public final class InsightFiltersNoteText {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNoteText.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNoteText.value' is not present");
    }
