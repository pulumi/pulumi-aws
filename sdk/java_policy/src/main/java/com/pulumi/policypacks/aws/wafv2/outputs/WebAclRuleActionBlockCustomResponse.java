...
import com.pulumi.policypacks.aws.wafv2.outputs.WebAclRuleActionBlockCustomResponseResponseHeader;
...
public final class WebAclRuleActionBlockCustomResponse {
    ...
    public @Nullable String customResponseBodyKey() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionBlockCustomResponse.customResponseBodyKey' is not present");
    }
    ...
    public Integer responseCode() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionBlockCustomResponse.responseCode' is not present");
    }
    ...
    private @Nullable List<WebAclRuleActionBlockCustomResponseResponseHeader> value_responseHeaders;
    private boolean unknown_responseHeaders;
    public @Nullable List<WebAclRuleActionBlockCustomResponseResponseHeader> responseHeaders() {
        if (!unknown_responseHeaders) return value_responseHeaders;
        throw new UndeferrableValueException("Value 'WebAclRuleActionBlockCustomResponse.responseHeaders' is not present");
    }
