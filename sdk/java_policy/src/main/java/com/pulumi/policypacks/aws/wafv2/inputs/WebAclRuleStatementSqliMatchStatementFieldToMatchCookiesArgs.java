...
import com.pulumi.policypacks.aws.wafv2.inputs.WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternArgs;
import java.lang.String;
import java.util.List;


public final class WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesArgs {
    ...
    private List<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternArgs> value_matchPatterns;
    private boolean unknown_matchPatterns;
    public List<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPatternArgs> matchPatterns() {
        if (!unknown_matchPatterns) return value_matchPatterns;
        throw new UndeferrableValueException("Value 'WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesArgs.matchPatterns' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesArgs.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesArgs.oversizeHandling' is not present");
    }
