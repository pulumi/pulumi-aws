...
public final class ClusterCoreInstanceFleetInstanceTypeConfigConfiguration {
    ...
    public @Nullable String classification() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetInstanceTypeConfigConfiguration.classification' is not present");
    }
    ...
    public @Nullable Map<String,String> properties() {
        ...
        throw new UndeferrableValueException("Value 'ClusterCoreInstanceFleetInstanceTypeConfigConfiguration.properties' is not present");
    }
