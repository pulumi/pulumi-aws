...
public final class ClusterCoreInstanceFleetInstanceTypeConfigConfiguration {
    ...
    public @Nullable String classification() {
        ...
        return classification.getValue("ClusterCoreInstanceFleetInstanceTypeConfigConfiguration.classification");
    }
    ...
    public @Nullable Map<String,String> properties() {
        ...
        return properties.getValue("ClusterCoreInstanceFleetInstanceTypeConfigConfiguration.properties");
    }
