...
import com.pulumi.policypacks.aws.wafv2.inputs.WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs;
import java.lang.String;


public final class WebAclRuleStatementByteMatchStatementFieldToMatchHeaderArgs {
    ...
    private WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs value_matchPattern;
    private boolean unknown_matchPattern;
    public WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern() {
        if (!unknown_matchPattern) return value_matchPattern;
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchHeaderArgs.matchPattern' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchHeaderArgs.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchHeaderArgs.oversizeHandling' is not present");
    }
