...
public final class WebhookFilterGroupFilter {
     ...
     * 
     */
    private @Nullable UndeferrableValue<Boolean> excludeMatchedPattern;

    public @Nullable Boolean excludeMatchedPattern() {
        if (excludeMatchedPattern == null) return null;
        return excludeMatchedPattern.getValue("WebhookFilterGroupFilter.excludeMatchedPattern");
    }
    ...
    public String pattern() {
        ...
        return pattern.getValue("WebhookFilterGroupFilter.pattern");
    }
    ...
    public String type() {
        ...
        return type.getValue("WebhookFilterGroupFilter.type");
    }
