...
public final class VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileArgs {
    ...
    public String certificateChain() {
        ...
        throw new UndeferrableValueException("Value 'VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileArgs.certificateChain' is not present");
    }
    ...
    public String privateKey() {
        ...
        throw new UndeferrableValueException("Value 'VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFileArgs.privateKey' is not present");
    }
