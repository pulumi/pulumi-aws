...
public final class RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformationArgs {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformationArgs.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexPatternSetReferenceStatementTextTransformationArgs.type' is not present");
    }
