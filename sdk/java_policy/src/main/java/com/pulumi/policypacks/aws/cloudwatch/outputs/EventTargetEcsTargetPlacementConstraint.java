...
public final class EventTargetEcsTargetPlacementConstraint {
    ...
    public @Nullable String expression() {
        ...
        throw new UndeferrableValueException("Value 'EventTargetEcsTargetPlacementConstraint.expression' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'EventTargetEcsTargetPlacementConstraint.type' is not present");
    }
