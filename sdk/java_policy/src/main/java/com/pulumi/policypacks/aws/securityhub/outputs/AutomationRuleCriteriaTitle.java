...
public final class AutomationRuleCriteriaTitle {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaTitle.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaTitle.value' is not present");
    }
