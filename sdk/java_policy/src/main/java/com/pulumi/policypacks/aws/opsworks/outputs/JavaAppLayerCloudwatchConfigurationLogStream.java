...
public final class JavaAppLayerCloudwatchConfigurationLogStream {
    ...
    public @Nullable Integer batchCount() {
        ...
        return batchCount.getValue("JavaAppLayerCloudwatchConfigurationLogStream.batchCount");
    }
    ...
    public @Nullable Integer batchSize() {
        ...
        return batchSize.getValue("JavaAppLayerCloudwatchConfigurationLogStream.batchSize");
    }
    ...
    public @Nullable Integer bufferDuration() {
        ...
        return bufferDuration.getValue("JavaAppLayerCloudwatchConfigurationLogStream.bufferDuration");
    }
    ...
    public @Nullable String datetimeFormat() {
        ...
        return datetimeFormat.getValue("JavaAppLayerCloudwatchConfigurationLogStream.datetimeFormat");
    }
    ...
    public @Nullable String encoding() {
        ...
        return encoding.getValue("JavaAppLayerCloudwatchConfigurationLogStream.encoding");
    }
    ...
    public String file() {
        ...
        return file.getValue("JavaAppLayerCloudwatchConfigurationLogStream.file");
    }
    ...
    public @Nullable String fileFingerprintLines() {
        ...
        return fileFingerprintLines.getValue("JavaAppLayerCloudwatchConfigurationLogStream.fileFingerprintLines");
    }
    ...
    public @Nullable String initialPosition() {
        ...
        return initialPosition.getValue("JavaAppLayerCloudwatchConfigurationLogStream.initialPosition");
    }
    ...
    public String logGroupName() {
        ...
        return logGroupName.getValue("JavaAppLayerCloudwatchConfigurationLogStream.logGroupName");
    }
    ...
    public @Nullable String multilineStartPattern() {
        ...
        return multilineStartPattern.getValue("JavaAppLayerCloudwatchConfigurationLogStream.multilineStartPattern");
    }
    ...
    public @Nullable String timeZone() {
        ...
        return timeZone.getValue("JavaAppLayerCloudwatchConfigurationLogStream.timeZone");
    }
