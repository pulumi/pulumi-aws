...
public final class FileCacheLustreConfigurationArgs {
    ...
    private List<FileCacheLustreConfigurationLogConfigurationArgs> value_logConfigurations;
    ...
    private List<FileCacheLustreConfigurationMetadataConfigurationArgs> value_metadataConfigurations;
    ...
    private String value_mountName;
