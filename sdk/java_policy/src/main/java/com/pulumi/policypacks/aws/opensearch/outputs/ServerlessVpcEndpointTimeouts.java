...
public final class ServerlessVpcEndpointTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ServerlessVpcEndpointTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ServerlessVpcEndpointTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ServerlessVpcEndpointTimeouts.update");
    }
