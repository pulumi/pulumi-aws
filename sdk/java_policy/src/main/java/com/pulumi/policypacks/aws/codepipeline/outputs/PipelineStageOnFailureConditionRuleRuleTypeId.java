...
public final class PipelineStageOnFailureConditionRuleRuleTypeId {
    ...
    public String category() {
        ...
        return category.getValue("PipelineStageOnFailureConditionRuleRuleTypeId.category");
    }
    ...
    public @Nullable String owner() {
        ...
        return owner.getValue("PipelineStageOnFailureConditionRuleRuleTypeId.owner");
    }
    ...
    public String provider() {
        ...
        return provider.getValue("PipelineStageOnFailureConditionRuleRuleTypeId.provider");
    }
    ...
    public @Nullable String version() {
        ...
        return version.getValue("PipelineStageOnFailureConditionRuleRuleTypeId.version");
    }
