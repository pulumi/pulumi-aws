...
public final class CatalogTablePartitionIndexArgs {
    ...
    public String indexName() {
        ...
        throw new UndeferrableValueException("Value 'CatalogTablePartitionIndexArgs.indexName' is not present");
    }
    ...
    public String indexStatus() {
        ...
        throw new UndeferrableValueException("Value 'CatalogTablePartitionIndexArgs.indexStatus' is not present");
    }
    ...
    public List<String> keys() {
        ...
        throw new UndeferrableValueException("Value 'CatalogTablePartitionIndexArgs.keys' is not present");
    }
