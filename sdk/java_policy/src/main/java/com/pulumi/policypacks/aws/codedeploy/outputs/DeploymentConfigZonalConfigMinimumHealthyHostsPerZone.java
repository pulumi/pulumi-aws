...
public final class DeploymentConfigZonalConfigMinimumHealthyHostsPerZone {
    ...
    public @Nullable String type() {
        ...
        return type.getValue("DeploymentConfigZonalConfigMinimumHealthyHostsPerZone.type");
    }
    ...
    public @Nullable Integer value() {
        ...
        return value.getValue("DeploymentConfigZonalConfigMinimumHealthyHostsPerZone.value");
    }
