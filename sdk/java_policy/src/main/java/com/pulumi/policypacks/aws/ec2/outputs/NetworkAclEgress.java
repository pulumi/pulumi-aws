...
public final class NetworkAclEgress {
    ...
    public String action() {
        ...
        return action.getValue("NetworkAclEgress.action");
    }
    ...
    public @Nullable String cidrBlock() {
        ...
        return cidrBlock.getValue("NetworkAclEgress.cidrBlock");
    }
    ...
    public Integer fromPort() {
        ...
        return fromPort.getValue("NetworkAclEgress.fromPort");
    }
    ...
    public @Nullable Integer icmpCode() {
        ...
        return icmpCode.getValue("NetworkAclEgress.icmpCode");
    }
    ...
    public @Nullable Integer icmpType() {
        ...
        return icmpType.getValue("NetworkAclEgress.icmpType");
    }
    ...
    public @Nullable String ipv6CidrBlock() {
        ...
        return ipv6CidrBlock.getValue("NetworkAclEgress.ipv6CidrBlock");
    }
    ...
    public String protocol() {
        ...
        return protocol.getValue("NetworkAclEgress.protocol");
    }
    ...
    public Integer ruleNo() {
        ...
        return ruleNo.getValue("NetworkAclEgress.ruleNo");
    }
    ...
    public Integer toPort() {
        ...
        return toPort.getValue("NetworkAclEgress.toPort");
    }
