...
public final class NodejsAppLayerArgs extends com.pulumi.resources.PolicyResourceInput {
    ...
    private NodejsAppLayerCloudwatchConfigurationArgs value_cloudwatchConfiguration;
    ...
    private List<NodejsAppLayerEbsVolumeArgs> value_ebsVolumes;
    ...
    private NodejsAppLayerLoadBasedAutoScalingArgs value_loadBasedAutoScaling;
     ...
     * 
     */
    @PolicyResourceProperty(name="nodejsVersion", flag="unknown_nodejsVersion")
    private String value_nodejsVersion;
    private boolean unknown_nodejsVersion;
    public String nodejsVersion() {
        if (!unknown_nodejsVersion) return value_nodejsVersion;
