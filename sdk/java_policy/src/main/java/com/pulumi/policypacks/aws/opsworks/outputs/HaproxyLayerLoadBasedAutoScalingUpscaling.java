...
public final class HaproxyLayerLoadBasedAutoScalingUpscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("HaproxyLayerLoadBasedAutoScalingUpscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("HaproxyLayerLoadBasedAutoScalingUpscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("HaproxyLayerLoadBasedAutoScalingUpscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("HaproxyLayerLoadBasedAutoScalingUpscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("HaproxyLayerLoadBasedAutoScalingUpscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("HaproxyLayerLoadBasedAutoScalingUpscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("HaproxyLayerLoadBasedAutoScalingUpscaling.thresholdsWaitTime");
    }
