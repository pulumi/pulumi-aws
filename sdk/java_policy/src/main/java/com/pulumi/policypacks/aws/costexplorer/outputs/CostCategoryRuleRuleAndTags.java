...
public final class CostCategoryRuleRuleAndTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleAndTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleAndTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleAndTags.values");
    }
