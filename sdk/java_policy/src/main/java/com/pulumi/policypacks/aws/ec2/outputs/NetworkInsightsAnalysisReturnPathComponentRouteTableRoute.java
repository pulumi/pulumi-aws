...
public final class NetworkInsightsAnalysisReturnPathComponentRouteTableRoute {
    ...
    public @Nullable String destinationCidr() {
        ...
        return destinationCidr.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.destinationCidr");
    }
    ...
    public @Nullable String destinationPrefixListId() {
        ...
        return destinationPrefixListId.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.destinationPrefixListId");
    }
    ...
    public @Nullable String egressOnlyInternetGatewayId() {
        ...
        return egressOnlyInternetGatewayId.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.egressOnlyInternetGatewayId");
    }
    ...
    public @Nullable String gatewayId() {
        ...
        return gatewayId.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.gatewayId");
    }
    ...
    public @Nullable String instanceId() {
        ...
        return instanceId.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.instanceId");
    }
    ...
    public @Nullable String natGatewayId() {
        ...
        return natGatewayId.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.natGatewayId");
    }
    ...
    public @Nullable String networkInterfaceId() {
        ...
        return networkInterfaceId.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.networkInterfaceId");
    }
    ...
    public @Nullable String origin() {
        ...
        return origin.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.origin");
    }
    ...
    public @Nullable String transitGatewayId() {
        ...
        return transitGatewayId.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.transitGatewayId");
    }
    ...
    public @Nullable String vpcPeeringConnectionId() {
        ...
        return vpcPeeringConnectionId.getValue("NetworkInsightsAnalysisReturnPathComponentRouteTableRoute.vpcPeeringConnectionId");
    }
