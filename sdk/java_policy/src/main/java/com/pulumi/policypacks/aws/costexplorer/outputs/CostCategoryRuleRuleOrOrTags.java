...
public final class CostCategoryRuleRuleOrOrTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleOrOrTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleOrOrTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleOrOrTags.values");
    }
