...
import com.pulumi.policypacks.aws.wafv2.inputs.WebAclRuleStatementXssMatchStatementFieldToMatchCookiesMatchPatternArgs;
import java.lang.String;
import java.util.List;


public final class WebAclRuleStatementXssMatchStatementFieldToMatchCookiesArgs {
    ...
    private List<WebAclRuleStatementXssMatchStatementFieldToMatchCookiesMatchPatternArgs> value_matchPatterns;
    private boolean unknown_matchPatterns;
    public List<WebAclRuleStatementXssMatchStatementFieldToMatchCookiesMatchPatternArgs> matchPatterns() {
        if (!unknown_matchPatterns) return value_matchPatterns;
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchCookiesArgs.matchPatterns' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchCookiesArgs.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchCookiesArgs.oversizeHandling' is not present");
    }
