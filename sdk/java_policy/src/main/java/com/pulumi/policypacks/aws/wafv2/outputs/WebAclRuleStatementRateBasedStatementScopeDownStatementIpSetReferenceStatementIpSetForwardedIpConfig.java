...
public final class WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfig {
    ...
    public String fallbackBehavior() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfig.fallbackBehavior' is not present");
    }
    ...
    public String headerName() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfig.headerName' is not present");
    }
    ...
    public String position() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementScopeDownStatementIpSetReferenceStatementIpSetForwardedIpConfig.position' is not present");
    }
