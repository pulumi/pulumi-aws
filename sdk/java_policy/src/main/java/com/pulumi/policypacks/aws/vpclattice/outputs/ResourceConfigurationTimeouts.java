...
public final class ResourceConfigurationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ResourceConfigurationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ResourceConfigurationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ResourceConfigurationTimeouts.update");
    }
