...
public final class InsightFiltersNetworkDirection {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNetworkDirection.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNetworkDirection.value' is not present");
    }
