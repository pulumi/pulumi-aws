...
package com.pulumi.policypacks.aws.vpc.outputs;
...
public final class SecurityGroupVpcAssociationTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'SecurityGroupVpcAssociationTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'SecurityGroupVpcAssociationTimeouts.delete' is not present");
    }
