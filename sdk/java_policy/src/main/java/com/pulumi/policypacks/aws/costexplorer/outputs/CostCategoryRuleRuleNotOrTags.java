...
public final class CostCategoryRuleRuleNotOrTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleNotOrTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleNotOrTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleNotOrTags.values");
    }
