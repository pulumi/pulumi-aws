...
public final class PermissionsTableWithColumnsArgs {
    ...
    public String catalogId() {
        ...
        return catalogId.getValue("PermissionsTableWithColumnsArgs.catalogId");
    }
    ...
    public List<String> columnNames() {
        ...
        return columnNames.getValue("PermissionsTableWithColumnsArgs.columnNames");
    }
    ...
    public String databaseName() {
        ...
        return databaseName.getValue("PermissionsTableWithColumnsArgs.databaseName");
    }
    ...
    public List<String> excludedColumnNames() {
        ...
        return excludedColumnNames.getValue("PermissionsTableWithColumnsArgs.excludedColumnNames");
    }
    ...
    public String name() {
        ...
        return name.getValue("PermissionsTableWithColumnsArgs.name");
    }
    ...
    public Boolean wildcard() {
        ...
        return wildcard.getValue("PermissionsTableWithColumnsArgs.wildcard");
    }
