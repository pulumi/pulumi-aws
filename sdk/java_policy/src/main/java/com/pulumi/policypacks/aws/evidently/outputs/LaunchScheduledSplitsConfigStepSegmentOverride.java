...
public final class LaunchScheduledSplitsConfigStepSegmentOverride {
    ...
    public Integer evaluationOrder() {
        ...
        return evaluationOrder.getValue("LaunchScheduledSplitsConfigStepSegmentOverride.evaluationOrder");
    }
    ...
    public String segment() {
        ...
        return segment.getValue("LaunchScheduledSplitsConfigStepSegmentOverride.segment");
    }
    ...
    public Map<String,Integer> weights() {
        ...
        return weights.getValue("LaunchScheduledSplitsConfigStepSegmentOverride.weights");
    }
