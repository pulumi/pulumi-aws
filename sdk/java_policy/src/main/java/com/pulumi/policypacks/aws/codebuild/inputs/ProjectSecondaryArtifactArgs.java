...
public final class ProjectSecondaryArtifactArgs {
    ...
    public String artifactIdentifier() {
        ...
        return artifactIdentifier.getValue("ProjectSecondaryArtifactArgs.artifactIdentifier");
    }
    ...
    public String bucketOwnerAccess() {
        ...
        return bucketOwnerAccess.getValue("ProjectSecondaryArtifactArgs.bucketOwnerAccess");
    }
    ...
    public Boolean encryptionDisabled() {
        ...
        return encryptionDisabled.getValue("ProjectSecondaryArtifactArgs.encryptionDisabled");
    }
    ...
    public String location() {
        ...
        return location.getValue("ProjectSecondaryArtifactArgs.location");
    }
    ...
    public String name() {
        ...
        return name.getValue("ProjectSecondaryArtifactArgs.name");
    }
     ...
     * 
     */
    private UndeferrableValue<String> namespaceType;

    public String namespaceType() {
        if (namespaceType == null) return null;
        return namespaceType.getValue("ProjectSecondaryArtifactArgs.namespaceType");
    }
     ...
     * 
     */
    private UndeferrableValue<Boolean> overrideArtifactName;

    public Boolean overrideArtifactName() {
        if (overrideArtifactName == null) return null;
        return overrideArtifactName.getValue("ProjectSecondaryArtifactArgs.overrideArtifactName");
    }
    ...
    public String packaging() {
        ...
        return packaging.getValue("ProjectSecondaryArtifactArgs.packaging");
    }
    ...
    public String path() {
        ...
        return path.getValue("ProjectSecondaryArtifactArgs.path");
    }
    ...
    public String type() {
        ...
        return type.getValue("ProjectSecondaryArtifactArgs.type");
    }
