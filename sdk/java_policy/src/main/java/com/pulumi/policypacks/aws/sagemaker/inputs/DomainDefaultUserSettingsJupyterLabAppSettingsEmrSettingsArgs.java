...
public final class DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettingsArgs {
    ...
    public List<String> assumableRoleArns() {
        ...
        return assumableRoleArns.getValue("DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettingsArgs.assumableRoleArns");
    }
    ...
    public List<String> executionRoleArns() {
        ...
        return executionRoleArns.getValue("DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettingsArgs.executionRoleArns");
    }
