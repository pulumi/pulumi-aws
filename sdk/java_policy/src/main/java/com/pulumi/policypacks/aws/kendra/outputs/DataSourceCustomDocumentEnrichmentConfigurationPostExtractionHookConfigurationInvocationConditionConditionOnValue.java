...
public final class DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationConditionConditionOnValue {
    ...
    public @Nullable String dateValue() {
        ...
        return dateValue.getValue("DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationConditionConditionOnValue.dateValue");
    }
    ...
    public @Nullable Integer longValue() {
        ...
        return longValue.getValue("DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationConditionConditionOnValue.longValue");
    }
    ...
    public @Nullable List<String> stringListValues() {
        ...
        return stringListValues.getValue("DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationConditionConditionOnValue.stringListValues");
    }
    ...
    public @Nullable String stringValue() {
        ...
        return stringValue.getValue("DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationConditionConditionOnValue.stringValue");
    }
