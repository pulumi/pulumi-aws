...
public final class UserProfileUserSettingsJupyterLabAppSettingsCustomImage {
    ...
    public String appImageConfigName() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsJupyterLabAppSettingsCustomImage.appImageConfigName' is not present");
    }
    ...
    public String imageName() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsJupyterLabAppSettingsCustomImage.imageName' is not present");
    }
    ...
    public @Nullable Integer imageVersionNumber() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsJupyterLabAppSettingsCustomImage.imageVersionNumber' is not present");
    }
