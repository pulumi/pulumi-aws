...
import com.pulumi.policypacks.aws.route53domains.inputs.DomainTechContactExtraParamArgs;
import java.lang.String;
import java.util.List;
import javax.annotation.Nullable;


public final class DomainTechContactArgs {
    ...
    public String addressLine1() {
        ...
        return addressLine1.getValue("DomainTechContactArgs.addressLine1");
    }
    ...
    public String addressLine2() {
        ...
        return addressLine2.getValue("DomainTechContactArgs.addressLine2");
    }
    ...
    public String city() {
        ...
        return city.getValue("DomainTechContactArgs.city");
    }
    ...
    public String contactType() {
        ...
        return contactType.getValue("DomainTechContactArgs.contactType");
    }
    ...
    public String countryCode() {
        ...
        return countryCode.getValue("DomainTechContactArgs.countryCode");
    }
    ...
    public String email() {
        ...
        return email.getValue("DomainTechContactArgs.email");
    }
     ...
     * 
     */
    private UndeferrableValue<List<DomainTechContactExtraParamArgs>> extraParams;

    public List<DomainTechContactExtraParamArgs> extraParams() {
        if (extraParams == null) return null;
        return extraParams.getValue("DomainTechContactArgs.extraParams");
    }
    ...
    public String fax() {
        ...
        return fax.getValue("DomainTechContactArgs.fax");
    }
    ...
    public String firstName() {
        ...
        return firstName.getValue("DomainTechContactArgs.firstName");
    }
    ...
    public String lastName() {
        ...
        return lastName.getValue("DomainTechContactArgs.lastName");
    }
    ...
    public String organizationName() {
        ...
        return organizationName.getValue("DomainTechContactArgs.organizationName");
    }
    ...
    public String phoneNumber() {
        ...
        return phoneNumber.getValue("DomainTechContactArgs.phoneNumber");
    }
    ...
    public String state() {
        ...
        return state.getValue("DomainTechContactArgs.state");
    }
    ...
    public String zipCode() {
        ...
        return zipCode.getValue("DomainTechContactArgs.zipCode");
    }
