...
public final class RegionSettingsArgs extends com.pulumi.resources.PolicyResourceInput {
    ...
    public Map<String,Boolean> resourceTypeManagementPreference() {
        ...
        return resourceTypeManagementPreference.getValue("RegionSettingsArgs.resourceTypeManagementPreference");
    }
    ...
    public Map<String,Boolean> resourceTypeOptInPreference() {
        ...
        return resourceTypeOptInPreference.getValue("RegionSettingsArgs.resourceTypeOptInPreference");
    }
