...
public final class AutomationRuleCriteriaResourceDetailsOther {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaResourceDetailsOther.comparison' is not present");
    }
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaResourceDetailsOther.key' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaResourceDetailsOther.value' is not present");
    }
