...
public final class V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStepIntentSlotValueArgs {
    ...
    public String interpretedValue() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStepIntentSlotValueArgs.interpretedValue' is not present");
    }
