...
public final class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsZendeskOauthRequest {
    ...
    public @Nullable String authCode() {
        ...
        return authCode.getValue("ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsZendeskOauthRequest.authCode");
    }
    ...
    public @Nullable String redirectUri() {
        ...
        return redirectUri.getValue("ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsZendeskOauthRequest.redirectUri");
    }
