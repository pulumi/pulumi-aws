...
public final class ProfilesProfileTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'ProfilesProfileTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'ProfilesProfileTimeouts.delete' is not present");
    }
     ...
     * 
     */
    @PolicyResourceProperty(name="read", flag="unknown_read")
    private @Nullable String value_read;
    private boolean unknown_read;
    public @Nullable String read() {
        if (!unknown_read) return value_read;
        throw new UndeferrableValueException("Value 'ProfilesProfileTimeouts.read' is not present");
    }
