...
public final class EnvironmentLoggingConfigurationTaskLogs {
    ...
    public @Nullable String cloudWatchLogGroupArn() {
        ...
        return cloudWatchLogGroupArn.getValue("EnvironmentLoggingConfigurationTaskLogs.cloudWatchLogGroupArn");
    }
    ...
    public @Nullable Boolean enabled() {
        ...
        return enabled.getValue("EnvironmentLoggingConfigurationTaskLogs.enabled");
    }
    ...
    public @Nullable String logLevel() {
        ...
        return logLevel.getValue("EnvironmentLoggingConfigurationTaskLogs.logLevel");
    }
