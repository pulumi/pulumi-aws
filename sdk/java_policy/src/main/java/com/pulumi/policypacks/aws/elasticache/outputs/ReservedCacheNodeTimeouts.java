...
public final class ReservedCacheNodeTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ReservedCacheNodeTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ReservedCacheNodeTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ReservedCacheNodeTimeouts.update");
    }
