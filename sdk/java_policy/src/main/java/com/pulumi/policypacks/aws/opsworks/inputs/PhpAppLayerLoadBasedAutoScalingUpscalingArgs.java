...
public final class PhpAppLayerLoadBasedAutoScalingUpscalingArgs {
    ...
    public List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'PhpAppLayerLoadBasedAutoScalingUpscalingArgs.alarms' is not present");
    }
    ...
    public Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'PhpAppLayerLoadBasedAutoScalingUpscalingArgs.cpuThreshold' is not present");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'PhpAppLayerLoadBasedAutoScalingUpscalingArgs.ignoreMetricsTime' is not present");
    }
    ...
    public Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'PhpAppLayerLoadBasedAutoScalingUpscalingArgs.instanceCount' is not present");
    }
    ...
    public Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'PhpAppLayerLoadBasedAutoScalingUpscalingArgs.loadThreshold' is not present");
    }
    ...
    public Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'PhpAppLayerLoadBasedAutoScalingUpscalingArgs.memoryThreshold' is not present");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'PhpAppLayerLoadBasedAutoScalingUpscalingArgs.thresholdsWaitTime' is not present");
    }
