...
public final class CostCategoryRuleRuleNotNotTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleNotNotTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleNotNotTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleNotNotTags.values");
    }
