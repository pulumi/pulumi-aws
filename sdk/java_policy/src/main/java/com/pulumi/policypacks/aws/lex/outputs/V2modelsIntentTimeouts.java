...
public final class V2modelsIntentTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("V2modelsIntentTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("V2modelsIntentTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("V2modelsIntentTimeouts.update");
    }
