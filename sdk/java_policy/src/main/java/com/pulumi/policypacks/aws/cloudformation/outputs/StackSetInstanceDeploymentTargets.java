...
public final class StackSetInstanceDeploymentTargets {
    ...
    public @Nullable String accountFilterType() {
        ...
        return accountFilterType.getValue("StackSetInstanceDeploymentTargets.accountFilterType");
    }
    ...
    public @Nullable List<String> accounts() {
        ...
        return accounts.getValue("StackSetInstanceDeploymentTargets.accounts");
    }
    ...
    public @Nullable String accountsUrl() {
        ...
        return accountsUrl.getValue("StackSetInstanceDeploymentTargets.accountsUrl");
    }
    ...
    public @Nullable List<String> organizationalUnitIds() {
        ...
        return organizationalUnitIds.getValue("StackSetInstanceDeploymentTargets.organizationalUnitIds");
    }
