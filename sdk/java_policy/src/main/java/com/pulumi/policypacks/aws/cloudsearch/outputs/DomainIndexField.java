...
public final class DomainIndexField {
    ...
    private @Nullable String value_analysisScheme;
    ...
    private @Nullable Boolean value_facet;
    ...
    private @Nullable Boolean value_highlight;
    ...
    private @Nullable Boolean value_return_;
    private boolean unknown_return_;
    public @Nullable Boolean return_() {
        if (!unknown_return_) return value_return_;
        throw new UndeferrableValueException("Value 'DomainIndexField.return_' is not present");
    }
    ...
    private @Nullable Boolean value_search;
    ...
    private @Nullable Boolean value_sort;
    ...
    private @Nullable String value_sourceFields;
