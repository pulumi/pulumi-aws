...
public final class CostCategoryRuleRuleOrAndDimension {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleOrAndDimension.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleOrAndDimension.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleOrAndDimension.values");
    }
