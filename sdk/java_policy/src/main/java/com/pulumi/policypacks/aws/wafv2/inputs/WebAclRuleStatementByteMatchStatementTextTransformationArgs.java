...
public final class WebAclRuleStatementByteMatchStatementTextTransformationArgs {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementTextTransformationArgs.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementTextTransformationArgs.type' is not present");
    }
