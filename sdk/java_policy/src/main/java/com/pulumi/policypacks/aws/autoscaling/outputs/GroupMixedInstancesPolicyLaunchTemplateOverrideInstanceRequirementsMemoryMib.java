...
public final class GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsMemoryMib {
    ...
    public @Nullable Integer max() {
        ...
        throw new UndeferrableValueException("Value 'GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsMemoryMib.max' is not present");
    }
    ...
    public @Nullable Integer min() {
        ...
        throw new UndeferrableValueException("Value 'GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsMemoryMib.min' is not present");
    }
