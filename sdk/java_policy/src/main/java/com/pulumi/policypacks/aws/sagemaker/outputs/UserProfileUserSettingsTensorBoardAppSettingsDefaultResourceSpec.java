...
public final class UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec {
    ...
    public @Nullable String instanceType() {
        ...
        return instanceType.getValue("UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec.instanceType");
    }
    ...
    public @Nullable String lifecycleConfigArn() {
        ...
        return lifecycleConfigArn.getValue("UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec.lifecycleConfigArn");
    }
    ...
    public @Nullable String sagemakerImageArn() {
        ...
        return sagemakerImageArn.getValue("UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec.sagemakerImageArn");
    }
    ...
    public @Nullable String sagemakerImageVersionAlias() {
        ...
        return sagemakerImageVersionAlias.getValue("UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec.sagemakerImageVersionAlias");
    }
    ...
    public @Nullable String sagemakerImageVersionArn() {
        ...
        return sagemakerImageVersionArn.getValue("UserProfileUserSettingsTensorBoardAppSettingsDefaultResourceSpec.sagemakerImageVersionArn");
    }
