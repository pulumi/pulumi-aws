...
public final class RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        return invalidFallbackBehavior.getValue("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody.invalidFallbackBehavior");
    }
     ...
     * 
     */
    private UndeferrableValue<RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern;
    ...
    public RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        ...
        return matchPattern.getValue("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody.matchPattern");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody.matchScope");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        return oversizeHandling.getValue("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody.oversizeHandling");
    }
