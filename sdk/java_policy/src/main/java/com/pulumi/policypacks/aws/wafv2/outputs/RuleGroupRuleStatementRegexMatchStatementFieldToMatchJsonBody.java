...
import com.pulumi.policypacks.aws.wafv2.outputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern;
import java.lang.String;
import javax.annotation.Nullable;


public final class RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody.invalidFallbackBehavior' is not present");
    }
    ...
    private RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern value_matchPattern;
    ...
    public RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody.matchPattern' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody.matchScope' is not present");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody.oversizeHandling' is not present");
    }
