...
public final class WebAclChallengeConfigImmunityTimeProperty {
    ...
    public @Nullable Integer immunityTime() {
        ...
        throw new UndeferrableValueException("Value 'WebAclChallengeConfigImmunityTimeProperty.immunityTime' is not present");
    }
