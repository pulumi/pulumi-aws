...
public final class StaticWebLayerLoadBasedAutoScalingUpscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("StaticWebLayerLoadBasedAutoScalingUpscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("StaticWebLayerLoadBasedAutoScalingUpscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("StaticWebLayerLoadBasedAutoScalingUpscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("StaticWebLayerLoadBasedAutoScalingUpscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("StaticWebLayerLoadBasedAutoScalingUpscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("StaticWebLayerLoadBasedAutoScalingUpscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("StaticWebLayerLoadBasedAutoScalingUpscaling.thresholdsWaitTime");
    }
