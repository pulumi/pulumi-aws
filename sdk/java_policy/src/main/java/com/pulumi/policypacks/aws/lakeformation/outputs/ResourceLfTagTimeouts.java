...
public final class ResourceLfTagTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'ResourceLfTagTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'ResourceLfTagTimeouts.delete' is not present");
    }
