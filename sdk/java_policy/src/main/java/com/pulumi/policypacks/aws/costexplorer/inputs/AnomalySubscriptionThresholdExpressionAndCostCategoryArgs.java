...
public final class AnomalySubscriptionThresholdExpressionAndCostCategoryArgs {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionAndCostCategoryArgs.key' is not present");
    }
    ...
    public List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionAndCostCategoryArgs.matchOptions' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionAndCostCategoryArgs.values' is not present");
    }
