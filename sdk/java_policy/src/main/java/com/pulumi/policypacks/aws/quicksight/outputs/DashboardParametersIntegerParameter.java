...
public final class DashboardParametersIntegerParameter {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'DashboardParametersIntegerParameter.name' is not present");
    }
    ...
    public List<Integer> values() {
        ...
        throw new UndeferrableValueException("Value 'DashboardParametersIntegerParameter.values' is not present");
    }
