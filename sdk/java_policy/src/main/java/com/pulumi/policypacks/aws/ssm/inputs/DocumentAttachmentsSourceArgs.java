...
public final class DocumentAttachmentsSourceArgs {
    ...
    public String key() {
        ...
        return key.getValue("DocumentAttachmentsSourceArgs.key");
    }
    ...
    public String name() {
        ...
        return name.getValue("DocumentAttachmentsSourceArgs.name");
    }
    ...
    public List<String> values() {
        ...
        return values.getValue("DocumentAttachmentsSourceArgs.values");
    }
