...
public final class LaunchTemplateInstanceRequirementsMemoryMibArgs {
    ...
    public Integer max() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsMemoryMibArgs.max' is not present");
    }
    ...
    public Integer min() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsMemoryMibArgs.min' is not present");
    }
