...
public final class VpcBlockPublicAccessExclusionTimeoutsArgs {
    ...
    public String create() {
        ...
        throw new UndeferrableValueException("Value 'VpcBlockPublicAccessExclusionTimeoutsArgs.create' is not present");
    }
    ...
    public String delete() {
        ...
        throw new UndeferrableValueException("Value 'VpcBlockPublicAccessExclusionTimeoutsArgs.delete' is not present");
    }
    ...
    public String update() {
        ...
        throw new UndeferrableValueException("Value 'VpcBlockPublicAccessExclusionTimeoutsArgs.update' is not present");
    }
