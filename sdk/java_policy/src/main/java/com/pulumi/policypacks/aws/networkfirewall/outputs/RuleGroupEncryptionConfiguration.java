...
public final class RuleGroupEncryptionConfiguration {
    ...
    public @Nullable String keyId() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupEncryptionConfiguration.keyId' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupEncryptionConfiguration.type' is not present");
    }
