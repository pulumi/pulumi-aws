...
public final class AutomationRuleCriteriaDescription {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaDescription.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaDescription.value' is not present");
    }
