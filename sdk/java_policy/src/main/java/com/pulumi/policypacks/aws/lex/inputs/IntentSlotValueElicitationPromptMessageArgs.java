...
public final class IntentSlotValueElicitationPromptMessageArgs {
    ...
    public String content() {
        ...
        throw new UndeferrableValueException("Value 'IntentSlotValueElicitationPromptMessageArgs.content' is not present");
    }
    ...
    public String contentType() {
        ...
        throw new UndeferrableValueException("Value 'IntentSlotValueElicitationPromptMessageArgs.contentType' is not present");
    }
    ...
    private Integer value_groupNumber;
    private boolean unknown_groupNumber;
    public Integer groupNumber() {
        if (!unknown_groupNumber) return value_groupNumber;
        throw new UndeferrableValueException("Value 'IntentSlotValueElicitationPromptMessageArgs.groupNumber' is not present");
    }
