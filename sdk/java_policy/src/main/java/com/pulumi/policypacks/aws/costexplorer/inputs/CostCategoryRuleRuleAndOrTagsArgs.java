...
public final class CostCategoryRuleRuleAndOrTagsArgs {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndOrTagsArgs.key' is not present");
    }
    ...
    public List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndOrTagsArgs.matchOptions' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndOrTagsArgs.values' is not present");
    }
