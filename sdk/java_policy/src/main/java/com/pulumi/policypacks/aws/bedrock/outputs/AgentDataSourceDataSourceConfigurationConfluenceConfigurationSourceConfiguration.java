...
public final class AgentDataSourceDataSourceConfigurationConfluenceConfigurationSourceConfiguration {
    ...
    public String authType() {
        ...
        throw new UndeferrableValueException("Value 'AgentDataSourceDataSourceConfigurationConfluenceConfigurationSourceConfiguration.authType' is not present");
    }
    ...
    public String credentialsSecretArn() {
        ...
        throw new UndeferrableValueException("Value 'AgentDataSourceDataSourceConfigurationConfluenceConfigurationSourceConfiguration.credentialsSecretArn' is not present");
    }
    ...
    public String hostType() {
        ...
        throw new UndeferrableValueException("Value 'AgentDataSourceDataSourceConfigurationConfluenceConfigurationSourceConfiguration.hostType' is not present");
    }
    ...
    public String hostUrl() {
        ...
        throw new UndeferrableValueException("Value 'AgentDataSourceDataSourceConfigurationConfluenceConfigurationSourceConfiguration.hostUrl' is not present");
    }
