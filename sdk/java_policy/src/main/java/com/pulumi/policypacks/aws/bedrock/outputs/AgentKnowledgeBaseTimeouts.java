...
public final class AgentKnowledgeBaseTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("AgentKnowledgeBaseTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("AgentKnowledgeBaseTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("AgentKnowledgeBaseTimeouts.update");
    }
