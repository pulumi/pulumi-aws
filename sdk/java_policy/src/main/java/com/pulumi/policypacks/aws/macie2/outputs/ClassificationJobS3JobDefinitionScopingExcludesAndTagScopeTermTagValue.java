...
public final class ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValue {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValue.key");
    }
    ...
    public @Nullable String value() {
        ...
        return value.getValue("ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValue.value");
    }
