...
public final class ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValue {
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValue.key' is not present");
    }
    ...
    public @Nullable String value() {
        ...
        throw new UndeferrableValueException("Value 'ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValue.value' is not present");
    }
