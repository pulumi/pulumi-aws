...
public final class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorOauth2OauthRequest {
    ...
    public @Nullable String authCode() {
        ...
        return authCode.getValue("ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorOauth2OauthRequest.authCode");
    }
    ...
    public @Nullable String redirectUri() {
        ...
        return redirectUri.getValue("ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorOauth2OauthRequest.redirectUri");
    }
