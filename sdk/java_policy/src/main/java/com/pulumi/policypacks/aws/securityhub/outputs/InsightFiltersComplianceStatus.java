...
public final class InsightFiltersComplianceStatus {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersComplianceStatus.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersComplianceStatus.value' is not present");
    }
