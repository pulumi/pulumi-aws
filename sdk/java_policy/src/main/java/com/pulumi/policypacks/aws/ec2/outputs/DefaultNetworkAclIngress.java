...
public final class DefaultNetworkAclIngress {
    ...
    public String action() {
        ...
        return action.getValue("DefaultNetworkAclIngress.action");
    }
    ...
    public @Nullable String cidrBlock() {
        ...
        return cidrBlock.getValue("DefaultNetworkAclIngress.cidrBlock");
    }
    ...
    public Integer fromPort() {
        ...
        return fromPort.getValue("DefaultNetworkAclIngress.fromPort");
    }
    ...
    public @Nullable Integer icmpCode() {
        ...
        return icmpCode.getValue("DefaultNetworkAclIngress.icmpCode");
    }
    ...
    public @Nullable Integer icmpType() {
        ...
        return icmpType.getValue("DefaultNetworkAclIngress.icmpType");
    }
    ...
    public @Nullable String ipv6CidrBlock() {
        ...
        return ipv6CidrBlock.getValue("DefaultNetworkAclIngress.ipv6CidrBlock");
    }
    ...
    public String protocol() {
        ...
        return protocol.getValue("DefaultNetworkAclIngress.protocol");
    }
    ...
    public Integer ruleNo() {
        ...
        return ruleNo.getValue("DefaultNetworkAclIngress.ruleNo");
    }
    ...
    public Integer toPort() {
        ...
        return toPort.getValue("DefaultNetworkAclIngress.toPort");
    }
