...
public final class JavaAppLayerLoadBasedAutoScalingDownscalingArgs {

    private UndeferrableValue<List<String>> alarms;

    public List<String> alarms() {
        if (alarms == null) return null;
        return alarms.getValue("JavaAppLayerLoadBasedAutoScalingDownscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("JavaAppLayerLoadBasedAutoScalingDownscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("JavaAppLayerLoadBasedAutoScalingDownscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("JavaAppLayerLoadBasedAutoScalingDownscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("JavaAppLayerLoadBasedAutoScalingDownscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("JavaAppLayerLoadBasedAutoScalingDownscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("JavaAppLayerLoadBasedAutoScalingDownscalingArgs.thresholdsWaitTime");
    }
