...
public final class IntentRejectionStatementMessage {
    ...
    public String content() {
        ...
        throw new UndeferrableValueException("Value 'IntentRejectionStatementMessage.content' is not present");
    }
    ...
    public String contentType() {
        ...
        throw new UndeferrableValueException("Value 'IntentRejectionStatementMessage.contentType' is not present");
    }
    ...
    public @Nullable Integer groupNumber() {
        ...
        throw new UndeferrableValueException("Value 'IntentRejectionStatementMessage.groupNumber' is not present");
    }
