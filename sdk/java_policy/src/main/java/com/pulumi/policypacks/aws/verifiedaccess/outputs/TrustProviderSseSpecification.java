...
public final class TrustProviderSseSpecification {
    ...
    public @Nullable Boolean customerManagedKeyEnabled() {
        ...
        throw new UndeferrableValueException("Value 'TrustProviderSseSpecification.customerManagedKeyEnabled' is not present");
    }
    ...
    public @Nullable String kmsKeyArn() {
        ...
        throw new UndeferrableValueException("Value 'TrustProviderSseSpecification.kmsKeyArn' is not present");
    }
