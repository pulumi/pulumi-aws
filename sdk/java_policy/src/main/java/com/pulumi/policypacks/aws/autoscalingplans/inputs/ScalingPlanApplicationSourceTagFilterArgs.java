...
public final class ScalingPlanApplicationSourceTagFilterArgs {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'ScalingPlanApplicationSourceTagFilterArgs.key' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'ScalingPlanApplicationSourceTagFilterArgs.values' is not present");
    }
