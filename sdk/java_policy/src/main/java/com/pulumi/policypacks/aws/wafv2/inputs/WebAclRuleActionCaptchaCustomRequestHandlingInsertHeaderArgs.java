...
public final class WebAclRuleActionCaptchaCustomRequestHandlingInsertHeaderArgs {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionCaptchaCustomRequestHandlingInsertHeaderArgs.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionCaptchaCustomRequestHandlingInsertHeaderArgs.value' is not present");
    }
