...
public final class WebAclRuleActionCaptchaCustomRequestHandlingInsertHeaderArgs {
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleActionCaptchaCustomRequestHandlingInsertHeaderArgs.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclRuleActionCaptchaCustomRequestHandlingInsertHeaderArgs.value");
    }
