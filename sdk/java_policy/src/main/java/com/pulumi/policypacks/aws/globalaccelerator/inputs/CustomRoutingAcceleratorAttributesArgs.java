...
public final class CustomRoutingAcceleratorAttributesArgs {
    ...
    public Boolean flowLogsEnabled() {
        ...
        throw new UndeferrableValueException("Value 'CustomRoutingAcceleratorAttributesArgs.flowLogsEnabled' is not present");
    }
    ...
    public String flowLogsS3Bucket() {
        ...
        throw new UndeferrableValueException("Value 'CustomRoutingAcceleratorAttributesArgs.flowLogsS3Bucket' is not present");
    }
    ...
    public String flowLogsS3Prefix() {
        ...
        throw new UndeferrableValueException("Value 'CustomRoutingAcceleratorAttributesArgs.flowLogsS3Prefix' is not present");
    }
