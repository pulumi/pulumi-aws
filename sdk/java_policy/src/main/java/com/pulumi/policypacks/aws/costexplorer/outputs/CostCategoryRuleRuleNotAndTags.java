...
public final class CostCategoryRuleRuleNotAndTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleNotAndTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleNotAndTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleNotAndTags.values");
    }
