...
public final class CostCategoryRuleRuleNotNotDimension {
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleNotNotDimension.key' is not present");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleNotNotDimension.matchOptions' is not present");
    }
    ...
    public @Nullable List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleNotNotDimension.values' is not present");
    }
