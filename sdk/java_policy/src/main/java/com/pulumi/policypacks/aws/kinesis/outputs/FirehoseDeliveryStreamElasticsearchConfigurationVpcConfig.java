...
public final class FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig {
    ...
    public String roleArn() {
        ...
        return roleArn.getValue("FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig.roleArn");
    }
    ...
    public List<String> securityGroupIds() {
        ...
        return securityGroupIds.getValue("FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig.securityGroupIds");
    }
    ...
    public List<String> subnetIds() {
        ...
        return subnetIds.getValue("FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig.subnetIds");
    }
    ...
    public @Nullable String vpcId() {
        ...
        return vpcId.getValue("FirehoseDeliveryStreamElasticsearchConfigurationVpcConfig.vpcId");
    }
