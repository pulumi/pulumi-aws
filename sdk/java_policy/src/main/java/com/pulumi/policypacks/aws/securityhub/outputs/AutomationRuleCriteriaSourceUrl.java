...
public final class AutomationRuleCriteriaSourceUrl {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaSourceUrl.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaSourceUrl.value' is not present");
    }
