...
public final class PipelineTriggerGitConfigurationPullRequestBranches {
    ...
    public @Nullable List<String> excludes() {
        ...
        return excludes.getValue("PipelineTriggerGitConfigurationPullRequestBranches.excludes");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        return includes.getValue("PipelineTriggerGitConfigurationPullRequestBranches.includes");
    }
