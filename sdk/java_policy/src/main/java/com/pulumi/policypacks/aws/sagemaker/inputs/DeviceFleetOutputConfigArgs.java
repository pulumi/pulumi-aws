...
public final class DeviceFleetOutputConfigArgs {
    ...
    public String kmsKeyId() {
        ...
        throw new UndeferrableValueException("Value 'DeviceFleetOutputConfigArgs.kmsKeyId' is not present");
    }
    ...
    public String s3OutputLocation() {
        ...
        throw new UndeferrableValueException("Value 'DeviceFleetOutputConfigArgs.s3OutputLocation' is not present");
    }
