...
public final class EventConnectionAuthParametersInvocationHttpParametersHeader {
    ...
    public @Nullable Boolean isValueSecret() {
        ...
        return isValueSecret.getValue("EventConnectionAuthParametersInvocationHttpParametersHeader.isValueSecret");
    }
    ...
    public @Nullable String key() {
        ...
        return key.getValue("EventConnectionAuthParametersInvocationHttpParametersHeader.key");
    }
    ...
    public @Nullable String value() {
        ...
        return value.getValue("EventConnectionAuthParametersInvocationHttpParametersHeader.value");
    }
