...
public final class DataLakeConfigurationReplicationConfigurationArgs {
    ...
    public List<String> regions() {
        ...
        return regions.getValue("DataLakeConfigurationReplicationConfigurationArgs.regions");
    }
    ...
    public String roleArn() {
        ...
        return roleArn.getValue("DataLakeConfigurationReplicationConfigurationArgs.roleArn");
    }
