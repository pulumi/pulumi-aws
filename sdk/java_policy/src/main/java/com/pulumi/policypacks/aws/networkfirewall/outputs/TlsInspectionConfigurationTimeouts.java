...
public final class TlsInspectionConfigurationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("TlsInspectionConfigurationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("TlsInspectionConfigurationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("TlsInspectionConfigurationTimeouts.update");
    }
