...
public final class WebAclDefaultActionAllowCustomRequestHandlingInsertHeaderArgs {
    ...
    public String name() {
        ...
        return name.getValue("WebAclDefaultActionAllowCustomRequestHandlingInsertHeaderArgs.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclDefaultActionAllowCustomRequestHandlingInsertHeaderArgs.value");
    }
