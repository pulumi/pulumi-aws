...
public final class AgentAgentMemoryConfiguration {
    ...
    public List<String> enabledMemoryTypes() {
        ...
        return enabledMemoryTypes.getValue("AgentAgentMemoryConfiguration.enabledMemoryTypes");
    }
    ...
    public Integer storageDays() {
        ...
        return storageDays.getValue("AgentAgentMemoryConfiguration.storageDays");
    }
