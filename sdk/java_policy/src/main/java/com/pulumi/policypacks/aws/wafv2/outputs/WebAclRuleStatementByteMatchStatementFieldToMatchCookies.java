...
import com.pulumi.policypacks.aws.wafv2.outputs.WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern;
...
public final class WebAclRuleStatementByteMatchStatementFieldToMatchCookies {
    ...
    private List<WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern> value_matchPatterns;
    ...
    public List<WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchCookies.matchPatterns' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchCookies.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchCookies.oversizeHandling' is not present");
    }
