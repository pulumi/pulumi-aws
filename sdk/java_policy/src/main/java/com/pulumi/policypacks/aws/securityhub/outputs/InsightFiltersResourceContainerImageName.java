...
public final class InsightFiltersResourceContainerImageName {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceContainerImageName.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceContainerImageName.value' is not present");
    }
