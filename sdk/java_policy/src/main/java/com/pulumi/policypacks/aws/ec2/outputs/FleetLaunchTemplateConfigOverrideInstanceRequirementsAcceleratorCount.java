...
public final class FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount {
    ...
    public @Nullable Integer max() {
        ...
        throw new UndeferrableValueException("Value 'FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount.max' is not present");
    }
    ...
    public @Nullable Integer min() {
        ...
        throw new UndeferrableValueException("Value 'FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount.min' is not present");
    }
