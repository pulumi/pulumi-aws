...
public final class FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount {
    ...
    public @Nullable Integer max() {
        ...
        return max.getValue("FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount.max");
    }
    ...
    public @Nullable Integer min() {
        ...
        return min.getValue("FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount.min");
    }
