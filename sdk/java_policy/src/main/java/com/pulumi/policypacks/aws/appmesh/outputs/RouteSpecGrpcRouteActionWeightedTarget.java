...
public final class RouteSpecGrpcRouteActionWeightedTarget {
    ...
    public @Nullable Integer port() {
        ...
        return port.getValue("RouteSpecGrpcRouteActionWeightedTarget.port");
    }
    ...
    public String virtualNode() {
        ...
        return virtualNode.getValue("RouteSpecGrpcRouteActionWeightedTarget.virtualNode");
    }
    ...
    public Integer weight() {
        ...
        return weight.getValue("RouteSpecGrpcRouteActionWeightedTarget.weight");
    }
