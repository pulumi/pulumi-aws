...
public final class CustomLayerEbsVolume {
    ...
    public @Nullable Boolean encrypted() {
        ...
        return encrypted.getValue("CustomLayerEbsVolume.encrypted");
    }
    ...
    public @Nullable Integer iops() {
        ...
        return iops.getValue("CustomLayerEbsVolume.iops");
    }
    ...
    public String mountPoint() {
        ...
        return mountPoint.getValue("CustomLayerEbsVolume.mountPoint");
    }
    ...
    public Integer numberOfDisks() {
        ...
        return numberOfDisks.getValue("CustomLayerEbsVolume.numberOfDisks");
    }
    ...
    public @Nullable String raidLevel() {
        ...
        return raidLevel.getValue("CustomLayerEbsVolume.raidLevel");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("CustomLayerEbsVolume.size");
    }
    ...
    public @Nullable String type() {
        ...
        return type.getValue("CustomLayerEbsVolume.type");
    }
