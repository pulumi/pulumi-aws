...
public final class CostCategoryRuleRuleAndNotCostCategory {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleAndNotCostCategory.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleAndNotCostCategory.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleAndNotCostCategory.values");
    }
