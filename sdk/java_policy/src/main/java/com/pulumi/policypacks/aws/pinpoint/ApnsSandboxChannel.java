...
@PolicyResourceType(type="aws:pinpoint/apnsSandboxChannel:ApnsSandboxChannel")
public final class ApnsSandboxChannel extends com.pulumi.resources.PolicyResourceOutput {
    ...
    public String applicationId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsSandboxChannel.applicationId' is not present");
    }
    ...
    public @Nullable String bundleId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsSandboxChannel.bundleId' is not present");
    }
    ...
    public @Nullable String certificate() {
        ...
        throw new UndeferrableValueException("Value 'ApnsSandboxChannel.certificate' is not present");
    }
    ...
    public @Nullable String defaultAuthenticationMethod() {
        ...
        throw new UndeferrableValueException("Value 'ApnsSandboxChannel.defaultAuthenticationMethod' is not present");
    }
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'ApnsSandboxChannel.enabled' is not present");
    }
    ...
    public @Nullable String privateKey() {
        ...
        throw new UndeferrableValueException("Value 'ApnsSandboxChannel.privateKey' is not present");
    }
    ...
    public @Nullable String teamId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsSandboxChannel.teamId' is not present");
    }
    ...
    public @Nullable String tokenKey() {
        ...
        throw new UndeferrableValueException("Value 'ApnsSandboxChannel.tokenKey' is not present");
    }
    ...
    public @Nullable String tokenKeyId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsSandboxChannel.tokenKeyId' is not present");
    }
