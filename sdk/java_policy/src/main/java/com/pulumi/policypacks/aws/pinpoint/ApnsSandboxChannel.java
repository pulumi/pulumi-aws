...
public final class ApnsSandboxChannel extends com.pulumi.resources.PolicyResourceOutput {
    ...
    public String applicationId() {
        ...
        return applicationId.getValue("ApnsSandboxChannel.applicationId");
    }
    ...
    public @Nullable String bundleId() {
        ...
        return bundleId.getValue("ApnsSandboxChannel.bundleId");
    }
    ...
    public @Nullable String certificate() {
        ...
        return certificate.getValue("ApnsSandboxChannel.certificate");
    }
    ...
    public @Nullable String defaultAuthenticationMethod() {
        ...
        return defaultAuthenticationMethod.getValue("ApnsSandboxChannel.defaultAuthenticationMethod");
    }
    ...
    public @Nullable Boolean enabled() {
        ...
        return enabled.getValue("ApnsSandboxChannel.enabled");
    }
    ...
    public @Nullable String privateKey() {
        ...
        return privateKey.getValue("ApnsSandboxChannel.privateKey");
    }
    ...
    public @Nullable String teamId() {
        ...
        return teamId.getValue("ApnsSandboxChannel.teamId");
    }
    ...
    public @Nullable String tokenKey() {
        ...
        return tokenKey.getValue("ApnsSandboxChannel.tokenKey");
    }
    ...
    public @Nullable String tokenKeyId() {
        ...
        return tokenKeyId.getValue("ApnsSandboxChannel.tokenKeyId");
    }
