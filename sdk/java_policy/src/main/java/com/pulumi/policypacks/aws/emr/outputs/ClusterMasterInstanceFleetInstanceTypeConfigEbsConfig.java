...
public final class ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig {
    ...
    public @Nullable Integer iops() {
        ...
        return iops.getValue("ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig.iops");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig.size");
    }
    ...
    public String type() {
        ...
        return type.getValue("ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig.type");
    }
    ...
    public @Nullable Integer volumesPerInstance() {
        ...
        return volumesPerInstance.getValue("ClusterMasterInstanceFleetInstanceTypeConfigEbsConfig.volumesPerInstance");
    }
