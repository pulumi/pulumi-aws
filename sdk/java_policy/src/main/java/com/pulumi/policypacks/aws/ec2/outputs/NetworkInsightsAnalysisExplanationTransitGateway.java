...
public final class NetworkInsightsAnalysisExplanationTransitGateway {
    ...
    public @Nullable String arn() {
        ...
        return arn.getValue("NetworkInsightsAnalysisExplanationTransitGateway.arn");
    }
    ...
    public @Nullable String id() {
        ...
        return id.getValue("NetworkInsightsAnalysisExplanationTransitGateway.id");
    }
    ...
    public @Nullable String name() {
        ...
        return name.getValue("NetworkInsightsAnalysisExplanationTransitGateway.name");
    }
