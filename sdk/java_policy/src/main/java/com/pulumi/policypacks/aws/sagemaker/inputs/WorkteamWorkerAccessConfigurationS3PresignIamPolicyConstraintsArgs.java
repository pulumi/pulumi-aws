...
public final class WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraintsArgs {
    ...
    public String sourceIp() {
        ...
        return sourceIp.getValue("WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraintsArgs.sourceIp");
    }
     ...
     * 
     */
    private UndeferrableValue<String> vpcSourceIp;

    public String vpcSourceIp() {
        if (vpcSourceIp == null) return null;
        return vpcSourceIp.getValue("WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraintsArgs.vpcSourceIp");
    }
