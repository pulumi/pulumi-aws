...
public final class BotAbortStatement {
    ...
    private UndeferrableValue<List<BotAbortStatementMessage>> messages;

    public List<BotAbortStatementMessage> messages() {
        if (messages == null) return null;
        return messages.getValue("BotAbortStatement.messages");
    }
    ...
    public @Nullable String responseCard() {
        ...
        return responseCard.getValue("BotAbortStatement.responseCard");
    }
