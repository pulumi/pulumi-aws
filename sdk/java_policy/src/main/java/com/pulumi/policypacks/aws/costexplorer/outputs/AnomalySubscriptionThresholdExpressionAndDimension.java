...
public final class AnomalySubscriptionThresholdExpressionAndDimension {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("AnomalySubscriptionThresholdExpressionAndDimension.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("AnomalySubscriptionThresholdExpressionAndDimension.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("AnomalySubscriptionThresholdExpressionAndDimension.values");
    }
