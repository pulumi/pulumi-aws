...
public final class SpotInstanceRequestPrivateDnsNameOptionsArgs {
    ...
    public Boolean enableResourceNameDnsARecord() {
        ...
        throw new UndeferrableValueException("Value 'SpotInstanceRequestPrivateDnsNameOptionsArgs.enableResourceNameDnsARecord' is not present");
    }
    ...
    public Boolean enableResourceNameDnsAaaaRecord() {
        ...
        throw new UndeferrableValueException("Value 'SpotInstanceRequestPrivateDnsNameOptionsArgs.enableResourceNameDnsAaaaRecord' is not present");
    }
    ...
    public String hostnameType() {
        ...
        throw new UndeferrableValueException("Value 'SpotInstanceRequestPrivateDnsNameOptionsArgs.hostnameType' is not present");
    }
