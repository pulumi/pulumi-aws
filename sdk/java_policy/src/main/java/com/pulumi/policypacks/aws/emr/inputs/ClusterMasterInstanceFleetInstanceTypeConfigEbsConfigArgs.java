...
public final class ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs {
    ...
    public Integer iops() {
        ...
        return iops.getValue("ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs.iops");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs.size");
    }
    ...
    public String type() {
        ...
        return type.getValue("ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs.type");
    }
    ...
    public Integer volumesPerInstance() {
        ...
        return volumesPerInstance.getValue("ClusterMasterInstanceFleetInstanceTypeConfigEbsConfigArgs.volumesPerInstance");
    }
