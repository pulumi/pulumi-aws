...
public final class VirtualNodeSpecLoggingAccessLogFileFormatJson {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'VirtualNodeSpecLoggingAccessLogFileFormatJson.key' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'VirtualNodeSpecLoggingAccessLogFileFormatJson.value' is not present");
    }
