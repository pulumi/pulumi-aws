...
public final class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSlackOauthRequest {
    ...
    public @Nullable String authCode() {
        ...
        return authCode.getValue("ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSlackOauthRequest.authCode");
    }
    ...
    public @Nullable String redirectUri() {
        ...
        return redirectUri.getValue("ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSlackOauthRequest.redirectUri");
    }
