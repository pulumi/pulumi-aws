...
public final class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue {
    ...
    public @Nullable String dateValue() {
        ...
        return dateValue.getValue("DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue.dateValue");
    }
    ...
    public @Nullable Integer longValue() {
        ...
        return longValue.getValue("DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue.longValue");
    }
    ...
    public @Nullable List<String> stringListValues() {
        ...
        return stringListValues.getValue("DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue.stringListValues");
    }
    ...
    public @Nullable String stringValue() {
        ...
        return stringValue.getValue("DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue.stringValue");
    }
