...
public final class AutomationRuleCriteriaProductArn {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaProductArn.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaProductArn.value' is not present");
    }
