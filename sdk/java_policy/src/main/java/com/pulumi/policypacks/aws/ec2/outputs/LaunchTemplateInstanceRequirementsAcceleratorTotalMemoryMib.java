...
public final class LaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib {
    ...
    public @Nullable Integer max() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib.max' is not present");
    }
    ...
    public @Nullable Integer min() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsAcceleratorTotalMemoryMib.min' is not present");
    }
