...
import com.pulumi.policypacks.aws.wafv2.inputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs;
import java.lang.String;
import javax.annotation.Nullable;


public final class RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs {
    ...
    public String invalidFallbackBehavior() {
        ...
        return invalidFallbackBehavior.getValue("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs.invalidFallbackBehavior");
    }
     ...
     * 
     */
    private UndeferrableValue<RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;

    public RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern() {
        if (matchPattern == null) return null;
        return matchPattern.getValue("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs.matchPattern");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs.matchScope");
    }
    ...
    public String oversizeHandling() {
        ...
        return oversizeHandling.getValue("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs.oversizeHandling");
    }
