...
public final class EventConnectionAuthParametersOauthOauthHttpParametersBody {
    ...
    public @Nullable Boolean isValueSecret() {
        ...
        return isValueSecret.getValue("EventConnectionAuthParametersOauthOauthHttpParametersBody.isValueSecret");
    }
    ...
    public @Nullable String key() {
        ...
        return key.getValue("EventConnectionAuthParametersOauthOauthHttpParametersBody.key");
    }
    ...
    public @Nullable String value() {
        ...
        return value.getValue("EventConnectionAuthParametersOauthOauthHttpParametersBody.value");
    }
