...
public final class EventConnectionAuthParametersOauthOauthHttpParametersBody {
    ...
    public @Nullable Boolean isValueSecret() {
        ...
        throw new UndeferrableValueException("Value 'EventConnectionAuthParametersOauthOauthHttpParametersBody.isValueSecret' is not present");
    }
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'EventConnectionAuthParametersOauthOauthHttpParametersBody.key' is not present");
    }
    ...
    public @Nullable String value() {
        ...
        throw new UndeferrableValueException("Value 'EventConnectionAuthParametersOauthOauthHttpParametersBody.value' is not present");
    }
