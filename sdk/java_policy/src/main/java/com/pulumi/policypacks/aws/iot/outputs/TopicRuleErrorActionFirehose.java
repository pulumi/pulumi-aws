...
public final class TopicRuleErrorActionFirehose {
    ...
    public @Nullable Boolean batchMode() {
        ...
        return batchMode.getValue("TopicRuleErrorActionFirehose.batchMode");
    }
    ...
    public String deliveryStreamName() {
        ...
        return deliveryStreamName.getValue("TopicRuleErrorActionFirehose.deliveryStreamName");
    }
    ...
    public String roleArn() {
        ...
        return roleArn.getValue("TopicRuleErrorActionFirehose.roleArn");
    }
    ...
    public @Nullable String separator() {
        ...
        return separator.getValue("TopicRuleErrorActionFirehose.separator");
    }
