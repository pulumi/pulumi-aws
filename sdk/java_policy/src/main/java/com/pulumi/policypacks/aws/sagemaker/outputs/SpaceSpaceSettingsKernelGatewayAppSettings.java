...
public final class SpaceSpaceSettingsKernelGatewayAppSettings {
    ...
    private @Nullable List<SpaceSpaceSettingsKernelGatewayAppSettingsCustomImage> value_customImages;
    ...
    public @Nullable List<SpaceSpaceSettingsKernelGatewayAppSettingsCustomImage> customImages() {
        ...
        throw new UndeferrableValueException("Value 'SpaceSpaceSettingsKernelGatewayAppSettings.customImages' is not present");
    }
    ...
    private SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec value_defaultResourceSpec;
    ...
    public SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec defaultResourceSpec() {
        ...
        throw new UndeferrableValueException("Value 'SpaceSpaceSettingsKernelGatewayAppSettings.defaultResourceSpec' is not present");
    }
    ...
    public @Nullable List<String> lifecycleConfigArns() {
        ...
        throw new UndeferrableValueException("Value 'SpaceSpaceSettingsKernelGatewayAppSettings.lifecycleConfigArns' is not present");
    }
