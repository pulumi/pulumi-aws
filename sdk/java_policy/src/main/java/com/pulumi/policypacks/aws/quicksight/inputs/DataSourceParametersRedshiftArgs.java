...
public final class DataSourceParametersRedshiftArgs {
    ...
    public String clusterId() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersRedshiftArgs.clusterId' is not present");
    }
    ...
    public String database() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersRedshiftArgs.database' is not present");
    }
    ...
    public String host() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersRedshiftArgs.host' is not present");
    }
    ...
    public Integer port() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersRedshiftArgs.port' is not present");
    }
