...
public final class QuicksetupConfigurationManagerTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'QuicksetupConfigurationManagerTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'QuicksetupConfigurationManagerTimeouts.delete' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'QuicksetupConfigurationManagerTimeouts.update' is not present");
    }
