...
public final class QuicksetupConfigurationManagerTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("QuicksetupConfigurationManagerTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("QuicksetupConfigurationManagerTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("QuicksetupConfigurationManagerTimeouts.update");
    }
