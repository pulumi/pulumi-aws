...
public final class SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec {
    ...
    public @Nullable String instanceType() {
        ...
        return instanceType.getValue("SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.instanceType");
    }
    ...
    public @Nullable String lifecycleConfigArn() {
        ...
        return lifecycleConfigArn.getValue("SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.lifecycleConfigArn");
    }
    ...
    public @Nullable String sagemakerImageArn() {
        ...
        return sagemakerImageArn.getValue("SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.sagemakerImageArn");
    }
    ...
    public @Nullable String sagemakerImageVersionAlias() {
        ...
        return sagemakerImageVersionAlias.getValue("SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.sagemakerImageVersionAlias");
    }
    ...
    public @Nullable String sagemakerImageVersionArn() {
        ...
        return sagemakerImageVersionArn.getValue("SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.sagemakerImageVersionArn");
    }
