...
public final class SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec {
    ...
    public @Nullable String instanceType() {
        ...
        throw new UndeferrableValueException("Value 'SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.instanceType' is not present");
    }
    ...
    public @Nullable String lifecycleConfigArn() {
        ...
        throw new UndeferrableValueException("Value 'SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.lifecycleConfigArn' is not present");
    }
    ...
    public @Nullable String sagemakerImageArn() {
        ...
        throw new UndeferrableValueException("Value 'SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.sagemakerImageArn' is not present");
    }
    ...
    public @Nullable String sagemakerImageVersionAlias() {
        ...
        throw new UndeferrableValueException("Value 'SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.sagemakerImageVersionAlias' is not present");
    }
    ...
    public @Nullable String sagemakerImageVersionArn() {
        ...
        throw new UndeferrableValueException("Value 'SpaceSpaceSettingsKernelGatewayAppSettingsDefaultResourceSpec.sagemakerImageVersionArn' is not present");
    }
