...
public final class ImageImageTestsConfiguration {
    ...
    public @Nullable Boolean imageTestsEnabled() {
        ...
        throw new UndeferrableValueException("Value 'ImageImageTestsConfiguration.imageTestsEnabled' is not present");
    }
    ...
    public @Nullable Integer timeoutMinutes() {
        ...
        throw new UndeferrableValueException("Value 'ImageImageTestsConfiguration.timeoutMinutes' is not present");
    }
