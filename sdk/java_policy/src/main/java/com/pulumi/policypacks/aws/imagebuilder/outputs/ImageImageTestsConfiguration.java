...
public final class ImageImageTestsConfiguration {
    ...
    public @Nullable Boolean imageTestsEnabled() {
        ...
        return imageTestsEnabled.getValue("ImageImageTestsConfiguration.imageTestsEnabled");
    }
    ...
    public @Nullable Integer timeoutMinutes() {
        ...
        return timeoutMinutes.getValue("ImageImageTestsConfiguration.timeoutMinutes");
    }
