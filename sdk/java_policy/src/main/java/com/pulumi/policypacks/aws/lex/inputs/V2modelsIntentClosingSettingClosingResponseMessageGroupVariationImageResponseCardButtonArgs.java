...
public final class V2modelsIntentClosingSettingClosingResponseMessageGroupVariationImageResponseCardButtonArgs {
    ...
    public String text() {
        ...
        return text.getValue("V2modelsIntentClosingSettingClosingResponseMessageGroupVariationImageResponseCardButtonArgs.text");
    }
    ...
    public String value() {
        ...
        return value.getValue("V2modelsIntentClosingSettingClosingResponseMessageGroupVariationImageResponseCardButtonArgs.value");
    }
