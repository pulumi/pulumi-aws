...
import com.pulumi.policypacks.aws.wafv2.inputs.WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs;
import java.lang.String;
import javax.annotation.Nullable;


public final class WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs {
    ...
    public String invalidFallbackBehavior() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs.invalidFallbackBehavior' is not present");
    }
    ...
    private WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs value_matchPattern;
    private boolean unknown_matchPattern;
    public WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern() {
        if (!unknown_matchPattern) return value_matchPattern;
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs.matchPattern' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs.oversizeHandling' is not present");
    }
