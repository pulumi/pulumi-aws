...
public final class EntityRecognizerVpcConfigArgs {
    ...
    public List<String> securityGroupIds() {
        ...
        throw new UndeferrableValueException("Value 'EntityRecognizerVpcConfigArgs.securityGroupIds' is not present");
    }
    ...
    public List<String> subnets() {
        ...
        throw new UndeferrableValueException("Value 'EntityRecognizerVpcConfigArgs.subnets' is not present");
    }
