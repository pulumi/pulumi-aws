...
public final class V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationSuccessNextStepDialogAction {
    ...
    public @Nullable String slotToElicit() {
        ...
        return slotToElicit.getValue("V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationSuccessNextStepDialogAction.slotToElicit");
    }
    ...
    public @Nullable Boolean suppressNextMessage() {
        ...
        return suppressNextMessage.getValue("V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationSuccessNextStepDialogAction.suppressNextMessage");
    }
    ...
    public String type() {
        ...
        return type.getValue("V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationSuccessNextStepDialogAction.type");
    }
