...
import com.pulumi.policypacks.aws.wafv2.outputs.RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern;
...
public final class RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies {
    ...
    private List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern> value_matchPatterns;
    ...
    public List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies.matchPatterns' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies.oversizeHandling' is not present");
    }
