...
public final class GangliaLayerCloudwatchConfigurationLogStream {
    ...
    public @Nullable Integer batchCount() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.batchCount' is not present");
    }
    ...
    public @Nullable Integer batchSize() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.batchSize' is not present");
    }
    ...
    public @Nullable Integer bufferDuration() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.bufferDuration' is not present");
    }
    ...
    public @Nullable String datetimeFormat() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.datetimeFormat' is not present");
    }
    ...
    public @Nullable String encoding() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.encoding' is not present");
    }
    ...
    public String file() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.file' is not present");
    }
    ...
    public @Nullable String fileFingerprintLines() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.fileFingerprintLines' is not present");
    }
    ...
    public @Nullable String initialPosition() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.initialPosition' is not present");
    }
    ...
    public String logGroupName() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.logGroupName' is not present");
    }
    ...
    public @Nullable String multilineStartPattern() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.multilineStartPattern' is not present");
    }
    ...
    public @Nullable String timeZone() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerCloudwatchConfigurationLogStream.timeZone' is not present");
    }
