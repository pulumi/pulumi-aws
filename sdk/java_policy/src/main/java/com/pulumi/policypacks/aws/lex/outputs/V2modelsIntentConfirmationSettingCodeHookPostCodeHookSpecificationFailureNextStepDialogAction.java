...
public final class V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureNextStepDialogAction {
    ...
    public @Nullable String slotToElicit() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureNextStepDialogAction.slotToElicit' is not present");
    }
    ...
    public @Nullable Boolean suppressNextMessage() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureNextStepDialogAction.suppressNextMessage' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationFailureNextStepDialogAction.type' is not present");
    }
