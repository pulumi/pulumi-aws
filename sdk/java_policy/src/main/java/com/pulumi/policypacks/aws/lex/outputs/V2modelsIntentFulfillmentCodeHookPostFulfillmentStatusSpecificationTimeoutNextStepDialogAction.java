...
public final class V2modelsIntentFulfillmentCodeHookPostFulfillmentStatusSpecificationTimeoutNextStepDialogAction {
    ...
    public @Nullable String slotToElicit() {
        ...
        return slotToElicit.getValue("V2modelsIntentFulfillmentCodeHookPostFulfillmentStatusSpecificationTimeoutNextStepDialogAction.slotToElicit");
    }
    ...
    public @Nullable Boolean suppressNextMessage() {
        ...
        return suppressNextMessage.getValue("V2modelsIntentFulfillmentCodeHookPostFulfillmentStatusSpecificationTimeoutNextStepDialogAction.suppressNextMessage");
    }
    ...
    public String type() {
        ...
        return type.getValue("V2modelsIntentFulfillmentCodeHookPostFulfillmentStatusSpecificationTimeoutNextStepDialogAction.type");
    }
