...
public final class InsightFiltersConfidence {
    ...
    public @Nullable String eq() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersConfidence.eq' is not present");
    }
    ...
    public @Nullable String gte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersConfidence.gte' is not present");
    }
    ...
    public @Nullable String lte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersConfidence.lte' is not present");
    }
