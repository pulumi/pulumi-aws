...
public final class RegexMatchSetRegexMatchTupleFieldToMatch {
    ...
    public @Nullable String data() {
        ...
        throw new UndeferrableValueException("Value 'RegexMatchSetRegexMatchTupleFieldToMatch.data' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'RegexMatchSetRegexMatchTupleFieldToMatch.type' is not present");
    }
