...
public final class PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedLoadMetricSpecification {
    ...
    public String predefinedMetricType() {
        ...
        return predefinedMetricType.getValue("PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedLoadMetricSpecification.predefinedMetricType");
    }
    ...
    public @Nullable String resourceLabel() {
        ...
        return resourceLabel.getValue("PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedLoadMetricSpecification.resourceLabel");
    }
