...
public final class RepositoryCreationTemplateEncryptionConfiguration {
    ...
    public @Nullable String encryptionType() {
        ...
        throw new UndeferrableValueException("Value 'RepositoryCreationTemplateEncryptionConfiguration.encryptionType' is not present");
    }
    ...
    public @Nullable String kmsKey() {
        ...
        throw new UndeferrableValueException("Value 'RepositoryCreationTemplateEncryptionConfiguration.kmsKey' is not present");
    }
