...
public final class DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration {
    ...
    private @Nullable DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition value_invocationCondition;
    ...
    public @Nullable DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationCondition invocationCondition() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration.invocationCondition' is not present");
    }
    ...
    public String lambdaArn() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration.lambdaArn' is not present");
    }
    ...
    public String s3Bucket() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfiguration.s3Bucket' is not present");
    }
