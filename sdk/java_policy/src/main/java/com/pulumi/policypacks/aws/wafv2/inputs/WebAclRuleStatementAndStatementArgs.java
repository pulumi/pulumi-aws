...
public final class WebAclRuleStatementAndStatementArgs {
    ...
    public List<WebAclRuleStatementArgs> statements() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementAndStatementArgs.statements' is not present");
    }
