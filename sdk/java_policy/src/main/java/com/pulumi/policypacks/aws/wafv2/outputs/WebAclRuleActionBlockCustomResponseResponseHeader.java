...
public final class WebAclRuleActionBlockCustomResponseResponseHeader {
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleActionBlockCustomResponseResponseHeader.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclRuleActionBlockCustomResponseResponseHeader.value");
    }
