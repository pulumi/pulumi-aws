...
public final class FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableIpSetArgs {
    ...
    public List<String> definitions() {
        ...
        return definitions.getValue("FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableIpSetArgs.definitions");
    }
