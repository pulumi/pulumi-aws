...
public final class DomainBillingContactExtraParam {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'DomainBillingContactExtraParam.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'DomainBillingContactExtraParam.value' is not present");
    }
