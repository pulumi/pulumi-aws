...
public final class OntapStorageVirtualMachineEndpointManagement {
    ...
    public @Nullable String dnsName() {
        ...
        throw new UndeferrableValueException("Value 'OntapStorageVirtualMachineEndpointManagement.dnsName' is not present");
    }
    ...
    public @Nullable List<String> ipAddresses() {
        ...
        throw new UndeferrableValueException("Value 'OntapStorageVirtualMachineEndpointManagement.ipAddresses' is not present");
    }
