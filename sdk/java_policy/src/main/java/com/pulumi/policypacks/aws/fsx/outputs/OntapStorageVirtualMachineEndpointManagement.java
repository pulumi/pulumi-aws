...
public final class OntapStorageVirtualMachineEndpointManagement {
    ...
    public @Nullable String dnsName() {
        ...
        return dnsName.getValue("OntapStorageVirtualMachineEndpointManagement.dnsName");
    }
    ...
    public @Nullable List<String> ipAddresses() {
        ...
        return ipAddresses.getValue("OntapStorageVirtualMachineEndpointManagement.ipAddresses");
    }
