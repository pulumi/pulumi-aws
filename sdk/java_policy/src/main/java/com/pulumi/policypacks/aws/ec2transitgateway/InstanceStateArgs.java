...
public final class InstanceStateArgs extends com.pulumi.resources.PolicyResourceInput {
     ...
     * 
     */
    private UndeferrableValue<Boolean> force;

    public Boolean force() {
        if (force == null) return null;
        return force.getValue("InstanceStateArgs.force");
    }
    ...
    public String instanceId() {
        ...
        return instanceId.getValue("InstanceStateArgs.instanceId");
    }
    ...
    public String state() {
        ...
        return state.getValue("InstanceStateArgs.state");
    }
