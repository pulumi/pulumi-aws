...
public final class CostCategoryRuleRuleAndCostCategory {
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndCostCategory.key' is not present");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndCostCategory.matchOptions' is not present");
    }
    ...
    public @Nullable List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndCostCategory.values' is not present");
    }
