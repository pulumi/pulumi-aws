...
public final class CostCategoryRuleRuleAndCostCategory {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleAndCostCategory.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleAndCostCategory.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleAndCostCategory.values");
    }
