...
public final class OntapVolumeSnaplockConfigurationRetentionPeriodMaximumRetention {
    ...
    public @Nullable String type() {
        ...
        return type.getValue("OntapVolumeSnaplockConfigurationRetentionPeriodMaximumRetention.type");
    }
    ...
    public @Nullable Integer value() {
        ...
        return value.getValue("OntapVolumeSnaplockConfigurationRetentionPeriodMaximumRetention.value");
    }
