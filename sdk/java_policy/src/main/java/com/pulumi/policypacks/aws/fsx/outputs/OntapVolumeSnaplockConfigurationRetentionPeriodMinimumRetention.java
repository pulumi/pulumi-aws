...
public final class OntapVolumeSnaplockConfigurationRetentionPeriodMinimumRetention {
    ...
    public @Nullable String type() {
        ...
        return type.getValue("OntapVolumeSnaplockConfigurationRetentionPeriodMinimumRetention.type");
    }
    ...
    public @Nullable Integer value() {
        ...
        return value.getValue("OntapVolumeSnaplockConfigurationRetentionPeriodMinimumRetention.value");
    }
