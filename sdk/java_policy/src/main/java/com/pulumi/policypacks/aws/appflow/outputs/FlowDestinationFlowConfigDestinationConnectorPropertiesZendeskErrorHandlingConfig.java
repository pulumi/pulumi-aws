...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig {
    ...
    public @Nullable String bucketName() {
        ...
        return bucketName.getValue("FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig.bucketName");
    }
    ...
    public @Nullable String bucketPrefix() {
        ...
        return bucketPrefix.getValue("FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig.bucketPrefix");
    }
    ...
    public @Nullable Boolean failOnFirstDestinationError() {
        ...
        return failOnFirstDestinationError.getValue("FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig.failOnFirstDestinationError");
    }
