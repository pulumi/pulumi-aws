...
public final class FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount {
    ...
    public @Nullable Integer max() {
        ...
        return max.getValue("FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount.max");
    }
    ...
    public @Nullable Integer min() {
        ...
        return min.getValue("FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount.min");
    }
