...
public final class RegisteredDomainRegistrantContact {
    ...
    public @Nullable String addressLine1() {
        ...
        return addressLine1.getValue("RegisteredDomainRegistrantContact.addressLine1");
    }
    ...
    public @Nullable String addressLine2() {
        ...
        return addressLine2.getValue("RegisteredDomainRegistrantContact.addressLine2");
    }
    ...
    public @Nullable String city() {
        ...
        return city.getValue("RegisteredDomainRegistrantContact.city");
    }
    ...
    public @Nullable String contactType() {
        ...
        return contactType.getValue("RegisteredDomainRegistrantContact.contactType");
    }
    ...
    public @Nullable String countryCode() {
        ...
        return countryCode.getValue("RegisteredDomainRegistrantContact.countryCode");
    }
    ...
    public @Nullable String email() {
        ...
        return email.getValue("RegisteredDomainRegistrantContact.email");
    }
    ...
    public @Nullable Map<String,String> extraParams() {
        ...
        return extraParams.getValue("RegisteredDomainRegistrantContact.extraParams");
    }
    ...
    public @Nullable String fax() {
        ...
        return fax.getValue("RegisteredDomainRegistrantContact.fax");
    }
    ...
    public @Nullable String firstName() {
        ...
        return firstName.getValue("RegisteredDomainRegistrantContact.firstName");
    }
    ...
    public @Nullable String lastName() {
        ...
        return lastName.getValue("RegisteredDomainRegistrantContact.lastName");
    }
    ...
    public @Nullable String organizationName() {
        ...
        return organizationName.getValue("RegisteredDomainRegistrantContact.organizationName");
    }
    ...
    public @Nullable String phoneNumber() {
        ...
        return phoneNumber.getValue("RegisteredDomainRegistrantContact.phoneNumber");
    }
    ...
    public @Nullable String state() {
        ...
        return state.getValue("RegisteredDomainRegistrantContact.state");
    }
    ...
    public @Nullable String zipCode() {
        ...
        return zipCode.getValue("RegisteredDomainRegistrantContact.zipCode");
    }
