...
public final class AccessPosixProfile {
    ...
    public Integer gid() {
        ...
        throw new UndeferrableValueException("Value 'AccessPosixProfile.gid' is not present");
    }
    ...
    public @Nullable List<Integer> secondaryGids() {
        ...
        throw new UndeferrableValueException("Value 'AccessPosixProfile.secondaryGids' is not present");
    }
    ...
    public Integer uid() {
        ...
        throw new UndeferrableValueException("Value 'AccessPosixProfile.uid' is not present");
    }
