...
public final class EcsClusterLayerLoadBasedAutoScalingDownscalingArgs {

    private UndeferrableValue<List<String>> alarms;

    public List<String> alarms() {
        if (alarms == null) return null;
        return alarms.getValue("EcsClusterLayerLoadBasedAutoScalingDownscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("EcsClusterLayerLoadBasedAutoScalingDownscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("EcsClusterLayerLoadBasedAutoScalingDownscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("EcsClusterLayerLoadBasedAutoScalingDownscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("EcsClusterLayerLoadBasedAutoScalingDownscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("EcsClusterLayerLoadBasedAutoScalingDownscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("EcsClusterLayerLoadBasedAutoScalingDownscalingArgs.thresholdsWaitTime");
    }
