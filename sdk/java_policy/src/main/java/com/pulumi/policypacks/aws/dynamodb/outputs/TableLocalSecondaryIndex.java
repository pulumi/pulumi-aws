...
public final class TableLocalSecondaryIndex {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'TableLocalSecondaryIndex.name' is not present");
    }
    ...
    public @Nullable List<String> nonKeyAttributes() {
        ...
        throw new UndeferrableValueException("Value 'TableLocalSecondaryIndex.nonKeyAttributes' is not present");
    }
    ...
    public String projectionType() {
        ...
        throw new UndeferrableValueException("Value 'TableLocalSecondaryIndex.projectionType' is not present");
    }
    ...
    public String rangeKey() {
        ...
        throw new UndeferrableValueException("Value 'TableLocalSecondaryIndex.rangeKey' is not present");
    }
