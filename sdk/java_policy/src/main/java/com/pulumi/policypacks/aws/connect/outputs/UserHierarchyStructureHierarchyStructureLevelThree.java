...
public final class UserHierarchyStructureHierarchyStructureLevelThree {
    ...
    public @Nullable String arn() {
        ...
        return arn.getValue("UserHierarchyStructureHierarchyStructureLevelThree.arn");
    }
    ...
    public @Nullable String id() {
        ...
        return id.getValue("UserHierarchyStructureHierarchyStructureLevelThree.id");
    }
    ...
    public String name() {
        ...
        return name.getValue("UserHierarchyStructureHierarchyStructureLevelThree.name");
    }
