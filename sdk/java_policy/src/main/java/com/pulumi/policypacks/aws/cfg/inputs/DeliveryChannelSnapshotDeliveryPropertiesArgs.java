...
public final class DeliveryChannelSnapshotDeliveryPropertiesArgs {
    ...
    private String value_deliveryFrequency;
    ...
    public String deliveryFrequency() {
        ...
        throw new UndeferrableValueException("Value 'DeliveryChannelSnapshotDeliveryPropertiesArgs.deliveryFrequency' is not present");
    }
