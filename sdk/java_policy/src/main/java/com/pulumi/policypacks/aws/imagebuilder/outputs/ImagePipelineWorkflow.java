...
public final class ImagePipelineWorkflow {
    ...
    public @Nullable String onFailure() {
        ...
        throw new UndeferrableValueException("Value 'ImagePipelineWorkflow.onFailure' is not present");
    }
    ...
    public @Nullable String parallelGroup() {
        ...
        throw new UndeferrableValueException("Value 'ImagePipelineWorkflow.parallelGroup' is not present");
    }
    ...
    private @Nullable List<ImagePipelineWorkflowParameter> value_parameters;
    private boolean unknown_parameters;
    public @Nullable List<ImagePipelineWorkflowParameter> parameters() {
        if (!unknown_parameters) return value_parameters;
        throw new UndeferrableValueException("Value 'ImagePipelineWorkflow.parameters' is not present");
    }
    ...
    public String workflowArn() {
        ...
        throw new UndeferrableValueException("Value 'ImagePipelineWorkflow.workflowArn' is not present");
    }
