...
public final class RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig {
    ...
    public String fallbackBehavior() {
        ...
        return fallbackBehavior.getValue("RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig.fallbackBehavior");
    }
    ...
    public String headerName() {
        ...
        return headerName.getValue("RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig.headerName");
    }
    ...
    public String position() {
        ...
        return position.getValue("RuleGroupRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig.position");
    }
