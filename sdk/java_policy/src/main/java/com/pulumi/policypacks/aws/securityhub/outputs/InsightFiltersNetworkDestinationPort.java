...
public final class InsightFiltersNetworkDestinationPort {
    ...
    public @Nullable String eq() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNetworkDestinationPort.eq' is not present");
    }
    ...
    public @Nullable String gte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNetworkDestinationPort.gte' is not present");
    }
    ...
    public @Nullable String lte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNetworkDestinationPort.lte' is not present");
    }
