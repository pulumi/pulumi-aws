...
public final class InsightFiltersNetworkDestinationPort {
    ...
    public @Nullable String eq() {
        ...
        return eq.getValue("InsightFiltersNetworkDestinationPort.eq");
    }
    ...
    public @Nullable String gte() {
        ...
        return gte.getValue("InsightFiltersNetworkDestinationPort.gte");
    }
    ...
    public @Nullable String lte() {
        ...
        return lte.getValue("InsightFiltersNetworkDestinationPort.lte");
    }
