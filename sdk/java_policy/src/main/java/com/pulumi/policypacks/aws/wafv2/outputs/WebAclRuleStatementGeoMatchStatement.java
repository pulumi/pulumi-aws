...
import com.pulumi.policypacks.aws.wafv2.outputs.WebAclRuleStatementGeoMatchStatementForwardedIpConfig;
...
public final class WebAclRuleStatementGeoMatchStatement {
    ...
    public List<String> countryCodes() {
        ...
        return countryCodes.getValue("WebAclRuleStatementGeoMatchStatement.countryCodes");
    }
     ...
     * 
     */
    private @Nullable UndeferrableValue<WebAclRuleStatementGeoMatchStatementForwardedIpConfig> forwardedIpConfig;

    public @Nullable WebAclRuleStatementGeoMatchStatementForwardedIpConfig forwardedIpConfig() {
        if (forwardedIpConfig == null) return null;
        return forwardedIpConfig.getValue("WebAclRuleStatementGeoMatchStatement.forwardedIpConfig");
    }
