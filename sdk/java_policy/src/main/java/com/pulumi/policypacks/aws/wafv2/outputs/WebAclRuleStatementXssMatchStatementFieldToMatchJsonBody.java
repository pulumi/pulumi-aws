...
public final class WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        return invalidFallbackBehavior.getValue("WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody.invalidFallbackBehavior");
    }
     ...
     * 
     */
    private UndeferrableValue<WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern;

    public WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        if (matchPattern == null) return null;
        return matchPattern.getValue("WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody.matchPattern");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody.matchScope");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        return oversizeHandling.getValue("WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody.oversizeHandling");
    }
