...
import com.pulumi.policypacks.aws.wafv2.outputs.WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern;
import java.lang.String;
import javax.annotation.Nullable;


public final class WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody.invalidFallbackBehavior' is not present");
    }
    ...
    private WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern value_matchPattern;
    ...
    public WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody.matchPattern' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody.matchScope' is not present");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody.oversizeHandling' is not present");
    }
