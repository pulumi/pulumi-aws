...
public final class CostCategoryRuleRuleAndAndDimensionArgs {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndAndDimensionArgs.key' is not present");
    }
    ...
    public List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndAndDimensionArgs.matchOptions' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndAndDimensionArgs.values' is not present");
    }
