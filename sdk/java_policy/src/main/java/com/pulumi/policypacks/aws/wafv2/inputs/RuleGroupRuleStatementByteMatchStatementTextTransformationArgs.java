...
public final class RuleGroupRuleStatementByteMatchStatementTextTransformationArgs {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementTextTransformationArgs.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementTextTransformationArgs.type' is not present");
    }
