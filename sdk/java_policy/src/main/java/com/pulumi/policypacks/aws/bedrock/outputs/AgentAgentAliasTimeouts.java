...
public final class AgentAgentAliasTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("AgentAgentAliasTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("AgentAgentAliasTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("AgentAgentAliasTimeouts.update");
    }
