...
public final class WebAclRuleStatementSizeConstraintStatementTextTransformation {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementSizeConstraintStatementTextTransformation.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementSizeConstraintStatementTextTransformation.type' is not present");
    }
