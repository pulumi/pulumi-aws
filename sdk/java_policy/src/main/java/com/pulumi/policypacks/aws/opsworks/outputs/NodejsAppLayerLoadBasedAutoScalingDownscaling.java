...
public final class NodejsAppLayerLoadBasedAutoScalingDownscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("NodejsAppLayerLoadBasedAutoScalingDownscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("NodejsAppLayerLoadBasedAutoScalingDownscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("NodejsAppLayerLoadBasedAutoScalingDownscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("NodejsAppLayerLoadBasedAutoScalingDownscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("NodejsAppLayerLoadBasedAutoScalingDownscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("NodejsAppLayerLoadBasedAutoScalingDownscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("NodejsAppLayerLoadBasedAutoScalingDownscaling.thresholdsWaitTime");
    }
