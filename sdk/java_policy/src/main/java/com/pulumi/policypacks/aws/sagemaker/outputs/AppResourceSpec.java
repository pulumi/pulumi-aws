...
public final class AppResourceSpec {
    ...
    public @Nullable String instanceType() {
        ...
        return instanceType.getValue("AppResourceSpec.instanceType");
    }
    ...
    public @Nullable String lifecycleConfigArn() {
        ...
        return lifecycleConfigArn.getValue("AppResourceSpec.lifecycleConfigArn");
    }
    ...
    public @Nullable String sagemakerImageArn() {
        ...
        return sagemakerImageArn.getValue("AppResourceSpec.sagemakerImageArn");
    }
    ...
    public @Nullable String sagemakerImageVersionAlias() {
        ...
        return sagemakerImageVersionAlias.getValue("AppResourceSpec.sagemakerImageVersionAlias");
    }
    ...
    public @Nullable String sagemakerImageVersionArn() {
        ...
        return sagemakerImageVersionArn.getValue("AppResourceSpec.sagemakerImageVersionArn");
    }
