...
public final class DomainMatchingExportingConfigS3Exporting {
    ...
    public String s3BucketName() {
        ...
        return s3BucketName.getValue("DomainMatchingExportingConfigS3Exporting.s3BucketName");
    }
    ...
    public @Nullable String s3KeyName() {
        ...
        return s3KeyName.getValue("DomainMatchingExportingConfigS3Exporting.s3KeyName");
    }
