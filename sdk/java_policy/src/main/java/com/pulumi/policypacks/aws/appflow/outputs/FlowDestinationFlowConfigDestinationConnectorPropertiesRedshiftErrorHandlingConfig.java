...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesRedshiftErrorHandlingConfig {
    ...
    public @Nullable String bucketName() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesRedshiftErrorHandlingConfig.bucketName' is not present");
    }
    ...
    public @Nullable String bucketPrefix() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesRedshiftErrorHandlingConfig.bucketPrefix' is not present");
    }
    ...
    public @Nullable Boolean failOnFirstDestinationError() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesRedshiftErrorHandlingConfig.failOnFirstDestinationError' is not present");
    }
