...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesRedshiftErrorHandlingConfig {
    ...
    public @Nullable String bucketName() {
        ...
        return bucketName.getValue("FlowDestinationFlowConfigDestinationConnectorPropertiesRedshiftErrorHandlingConfig.bucketName");
    }
    ...
    public @Nullable String bucketPrefix() {
        ...
        return bucketPrefix.getValue("FlowDestinationFlowConfigDestinationConnectorPropertiesRedshiftErrorHandlingConfig.bucketPrefix");
    }
    ...
    public @Nullable Boolean failOnFirstDestinationError() {
        ...
        return failOnFirstDestinationError.getValue("FlowDestinationFlowConfigDestinationConnectorPropertiesRedshiftErrorHandlingConfig.failOnFirstDestinationError");
    }
