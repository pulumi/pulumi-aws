...
public final class DataSourceParametersOracle {
    ...
    public String database() {
        ...
        return database.getValue("DataSourceParametersOracle.database");
    }
    ...
    public String host() {
        ...
        return host.getValue("DataSourceParametersOracle.host");
    }
    ...
    public Integer port() {
        ...
        return port.getValue("DataSourceParametersOracle.port");
    }
