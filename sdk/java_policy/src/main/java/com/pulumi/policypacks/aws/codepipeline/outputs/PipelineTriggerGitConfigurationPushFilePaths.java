...
public final class PipelineTriggerGitConfigurationPushFilePaths {
    ...
    public @Nullable List<String> excludes() {
        ...
        return excludes.getValue("PipelineTriggerGitConfigurationPushFilePaths.excludes");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        return includes.getValue("PipelineTriggerGitConfigurationPushFilePaths.includes");
    }
