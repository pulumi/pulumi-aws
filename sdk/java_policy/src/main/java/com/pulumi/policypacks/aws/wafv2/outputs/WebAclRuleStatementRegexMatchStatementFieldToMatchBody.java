...
public final class WebAclRuleStatementRegexMatchStatementFieldToMatchBody {
    ...
    public @Nullable String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexMatchStatementFieldToMatchBody.oversizeHandling' is not present");
    }
