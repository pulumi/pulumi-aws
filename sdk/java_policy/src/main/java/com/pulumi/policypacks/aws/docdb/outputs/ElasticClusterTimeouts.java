...
public final class ElasticClusterTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ElasticClusterTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ElasticClusterTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ElasticClusterTimeouts.update");
    }
