...
public final class ServerlessCacheReaderEndpoint {
    ...
    public String address() {
        ...
        throw new UndeferrableValueException("Value 'ServerlessCacheReaderEndpoint.address' is not present");
    }
    ...
    public Integer port() {
        ...
        throw new UndeferrableValueException("Value 'ServerlessCacheReaderEndpoint.port' is not present");
    }
