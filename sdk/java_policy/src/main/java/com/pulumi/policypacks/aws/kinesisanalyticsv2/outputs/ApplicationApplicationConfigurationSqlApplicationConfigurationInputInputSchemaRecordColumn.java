...
public final class ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordColumn {
    ...
    public @Nullable String mapping() {
        ...
        throw new UndeferrableValueException("Value 'ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordColumn.mapping' is not present");
    }
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordColumn.name' is not present");
    }
    ...
    public String sqlType() {
        ...
        throw new UndeferrableValueException("Value 'ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordColumn.sqlType' is not present");
    }
