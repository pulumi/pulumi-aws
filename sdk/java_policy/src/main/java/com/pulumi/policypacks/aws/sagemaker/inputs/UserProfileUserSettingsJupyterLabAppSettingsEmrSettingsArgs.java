...
public final class UserProfileUserSettingsJupyterLabAppSettingsEmrSettingsArgs {
     ...
     * 
     */
    private UndeferrableValue<List<String>> assumableRoleArns;

    public List<String> assumableRoleArns() {
        if (assumableRoleArns == null) return null;
        return assumableRoleArns.getValue("UserProfileUserSettingsJupyterLabAppSettingsEmrSettingsArgs.assumableRoleArns");
    }
     ...
     * 
     */
    private UndeferrableValue<List<String>> executionRoleArns;

    public List<String> executionRoleArns() {
        if (executionRoleArns == null) return null;
        return executionRoleArns.getValue("UserProfileUserSettingsJupyterLabAppSettingsEmrSettingsArgs.executionRoleArns");
    }
