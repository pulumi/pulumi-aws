...
public final class UserProfileUserSettingsJupyterLabAppSettingsEmrSettingsArgs {
    ...
    private List<String> value_assumableRoleArns;
    ...
    public List<String> assumableRoleArns() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsJupyterLabAppSettingsEmrSettingsArgs.assumableRoleArns' is not present");
    }
    ...
    private List<String> value_executionRoleArns;
    ...
    public List<String> executionRoleArns() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsJupyterLabAppSettingsEmrSettingsArgs.executionRoleArns' is not present");
    }
