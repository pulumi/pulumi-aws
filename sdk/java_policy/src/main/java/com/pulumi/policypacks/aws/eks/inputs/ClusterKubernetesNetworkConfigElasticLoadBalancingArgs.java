...
public final class ClusterKubernetesNetworkConfigElasticLoadBalancingArgs {
    ...
    public Boolean enabled() {
        ...
        return enabled.getValue("ClusterKubernetesNetworkConfigElasticLoadBalancingArgs.enabled");
    }
