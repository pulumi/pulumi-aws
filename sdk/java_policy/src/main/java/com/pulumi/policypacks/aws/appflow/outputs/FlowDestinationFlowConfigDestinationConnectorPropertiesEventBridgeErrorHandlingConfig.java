...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridgeErrorHandlingConfig {
    ...
    public @Nullable String bucketName() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridgeErrorHandlingConfig.bucketName' is not present");
    }
    ...
    public @Nullable String bucketPrefix() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridgeErrorHandlingConfig.bucketPrefix' is not present");
    }
    ...
    public @Nullable Boolean failOnFirstDestinationError() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesEventBridgeErrorHandlingConfig.failOnFirstDestinationError' is not present");
    }
