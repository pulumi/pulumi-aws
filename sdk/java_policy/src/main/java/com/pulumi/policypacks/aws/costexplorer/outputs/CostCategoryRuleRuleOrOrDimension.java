...
public final class CostCategoryRuleRuleOrOrDimension {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleOrOrDimension.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleOrOrDimension.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleOrOrDimension.values");
    }
