...
public final class WebAclRuleStatementByteMatchStatementFieldToMatchHeader {
     ...
     * 
     */
    private UndeferrableValue<WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern> matchPattern;

    public WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern matchPattern() {
        if (matchPattern == null) return null;
        return matchPattern.getValue("WebAclRuleStatementByteMatchStatementFieldToMatchHeader.matchPattern");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("WebAclRuleStatementByteMatchStatementFieldToMatchHeader.matchScope");
    }
    ...
    public String oversizeHandling() {
        ...
        return oversizeHandling.getValue("WebAclRuleStatementByteMatchStatementFieldToMatchHeader.oversizeHandling");
    }
