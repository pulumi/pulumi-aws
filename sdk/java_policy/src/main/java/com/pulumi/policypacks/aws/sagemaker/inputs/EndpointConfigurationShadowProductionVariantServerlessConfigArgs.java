...
public final class EndpointConfigurationShadowProductionVariantServerlessConfigArgs {
    ...
    public Integer maxConcurrency() {
        ...
        throw new UndeferrableValueException("Value 'EndpointConfigurationShadowProductionVariantServerlessConfigArgs.maxConcurrency' is not present");
    }
    ...
    public Integer memorySizeInMb() {
        ...
        throw new UndeferrableValueException("Value 'EndpointConfigurationShadowProductionVariantServerlessConfigArgs.memorySizeInMb' is not present");
    }
    ...
    public Integer provisionedConcurrency() {
        ...
        throw new UndeferrableValueException("Value 'EndpointConfigurationShadowProductionVariantServerlessConfigArgs.provisionedConcurrency' is not present");
    }
