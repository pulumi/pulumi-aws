...
public final class DelegationSignerRecordTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'DelegationSignerRecordTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'DelegationSignerRecordTimeouts.delete' is not present");
    }
