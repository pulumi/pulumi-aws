...
import com.pulumi.policypacks.aws.wafv2.outputs.WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern;
...
public final class WebAclRuleStatementSqliMatchStatementFieldToMatchCookies {
    ...
    private List<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern> value_matchPatterns;
    ...
    public List<WebAclRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementSqliMatchStatementFieldToMatchCookies.matchPatterns' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementSqliMatchStatementFieldToMatchCookies.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementSqliMatchStatementFieldToMatchCookies.oversizeHandling' is not present");
    }
