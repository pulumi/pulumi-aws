...
public final class AnomalySubscriptionThresholdExpressionNotCostCategory {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("AnomalySubscriptionThresholdExpressionNotCostCategory.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("AnomalySubscriptionThresholdExpressionNotCostCategory.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("AnomalySubscriptionThresholdExpressionNotCostCategory.values");
    }
