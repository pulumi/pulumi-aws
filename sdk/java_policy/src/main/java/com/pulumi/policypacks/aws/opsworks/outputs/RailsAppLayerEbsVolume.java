...
public final class RailsAppLayerEbsVolume {
    ...
    public @Nullable Boolean encrypted() {
        ...
        return encrypted.getValue("RailsAppLayerEbsVolume.encrypted");
    }
    ...
    public @Nullable Integer iops() {
        ...
        return iops.getValue("RailsAppLayerEbsVolume.iops");
    }
    ...
    public String mountPoint() {
        ...
        return mountPoint.getValue("RailsAppLayerEbsVolume.mountPoint");
    }
    ...
    public Integer numberOfDisks() {
        ...
        return numberOfDisks.getValue("RailsAppLayerEbsVolume.numberOfDisks");
    }
    ...
    public @Nullable String raidLevel() {
        ...
        return raidLevel.getValue("RailsAppLayerEbsVolume.raidLevel");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("RailsAppLayerEbsVolume.size");
    }
    ...
    public @Nullable String type() {
        ...
        return type.getValue("RailsAppLayerEbsVolume.type");
    }
