...
public final class NetworkInsightsAnalysisExplanationVpnConnection {
    ...
    public @Nullable String arn() {
        ...
        return arn.getValue("NetworkInsightsAnalysisExplanationVpnConnection.arn");
    }
    ...
    public @Nullable String id() {
        ...
        return id.getValue("NetworkInsightsAnalysisExplanationVpnConnection.id");
    }
    ...
    public @Nullable String name() {
        ...
        return name.getValue("NetworkInsightsAnalysisExplanationVpnConnection.name");
    }
