...
public final class EnrollmentStatusTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'EnrollmentStatusTimeouts.create' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'EnrollmentStatusTimeouts.update' is not present");
    }
