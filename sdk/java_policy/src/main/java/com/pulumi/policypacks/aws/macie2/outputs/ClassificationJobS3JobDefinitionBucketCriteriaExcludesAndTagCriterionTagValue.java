...
public final class ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionTagValue {
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionTagValue.key' is not present");
    }
    ...
    public @Nullable String value() {
        ...
        throw new UndeferrableValueException("Value 'ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionTagValue.value' is not present");
    }
