...
public final class DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputsS3Output {
    ...
    public @Nullable String localPath() {
        ...
        return localPath.getValue("DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputsS3Output.localPath");
    }
     ...
     * 
     */
    private @Nullable UndeferrableValue<String> s3UploadMode;

    public @Nullable String s3UploadMode() {
        if (s3UploadMode == null) return null;
        return s3UploadMode.getValue("DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputsS3Output.s3UploadMode");
    }
    ...
    public String s3Uri() {
        ...
        return s3Uri.getValue("DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputsS3Output.s3Uri");
    }
