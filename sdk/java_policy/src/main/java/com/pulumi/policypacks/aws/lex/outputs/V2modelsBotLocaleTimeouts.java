...
public final class V2modelsBotLocaleTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("V2modelsBotLocaleTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("V2modelsBotLocaleTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("V2modelsBotLocaleTimeouts.update");
    }
