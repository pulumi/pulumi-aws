...
public final class DataSourceParametersMysqlArgs {
    ...
    public String database() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersMysqlArgs.database' is not present");
    }
    ...
    public String host() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersMysqlArgs.host' is not present");
    }
    ...
    public Integer port() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersMysqlArgs.port' is not present");
    }
