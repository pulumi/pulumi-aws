...
public final class InsightFiltersResourceContainerLaunchedAtDateRange {
    ...
    public String unit() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceContainerLaunchedAtDateRange.unit' is not present");
    }
    ...
    public Integer value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceContainerLaunchedAtDateRange.value' is not present");
    }
