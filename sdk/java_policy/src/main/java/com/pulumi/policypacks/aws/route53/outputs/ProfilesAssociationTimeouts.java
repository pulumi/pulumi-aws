...
public final class ProfilesAssociationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ProfilesAssociationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ProfilesAssociationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ProfilesAssociationTimeouts.update");
    }
