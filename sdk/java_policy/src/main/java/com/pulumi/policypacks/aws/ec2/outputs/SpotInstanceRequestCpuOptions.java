...
public final class SpotInstanceRequestCpuOptions {
    ...
    public @Nullable String amdSevSnp() {
        ...
        throw new UndeferrableValueException("Value 'SpotInstanceRequestCpuOptions.amdSevSnp' is not present");
    }
    ...
    public @Nullable Integer coreCount() {
        ...
        throw new UndeferrableValueException("Value 'SpotInstanceRequestCpuOptions.coreCount' is not present");
    }
    ...
    public @Nullable Integer threadsPerCore() {
        ...
        throw new UndeferrableValueException("Value 'SpotInstanceRequestCpuOptions.threadsPerCore' is not present");
    }
