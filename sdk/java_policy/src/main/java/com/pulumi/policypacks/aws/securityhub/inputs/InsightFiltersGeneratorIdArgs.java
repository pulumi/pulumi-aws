...
public final class InsightFiltersGeneratorIdArgs {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersGeneratorIdArgs.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersGeneratorIdArgs.value' is not present");
    }
