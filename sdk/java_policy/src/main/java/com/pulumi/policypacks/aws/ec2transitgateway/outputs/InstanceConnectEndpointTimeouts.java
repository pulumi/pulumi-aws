...
public final class InstanceConnectEndpointTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'InstanceConnectEndpointTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'InstanceConnectEndpointTimeouts.delete' is not present");
    }
