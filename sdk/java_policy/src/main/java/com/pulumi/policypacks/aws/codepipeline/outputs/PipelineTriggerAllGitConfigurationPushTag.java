...
public final class PipelineTriggerAllGitConfigurationPushTag {
    ...
    public @Nullable List<String> excludes() {
        ...
        return excludes.getValue("PipelineTriggerAllGitConfigurationPushTag.excludes");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        return includes.getValue("PipelineTriggerAllGitConfigurationPushTag.includes");
    }
