...
public final class OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfiguration {
    ...
    public String clients() {
        ...
        return clients.getValue("OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfiguration.clients");
    }
    ...
    public List<String> options() {
        ...
        return options.getValue("OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfiguration.options");
    }
