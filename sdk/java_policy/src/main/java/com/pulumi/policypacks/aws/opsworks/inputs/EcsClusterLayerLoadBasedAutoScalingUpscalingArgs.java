...
public final class EcsClusterLayerLoadBasedAutoScalingUpscalingArgs {
    ...
    public List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingUpscalingArgs.alarms' is not present");
    }
    ...
    public Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingUpscalingArgs.cpuThreshold' is not present");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingUpscalingArgs.ignoreMetricsTime' is not present");
    }
    ...
    public Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingUpscalingArgs.instanceCount' is not present");
    }
    ...
    public Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingUpscalingArgs.loadThreshold' is not present");
    }
    ...
    public Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingUpscalingArgs.memoryThreshold' is not present");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingUpscalingArgs.thresholdsWaitTime' is not present");
    }
