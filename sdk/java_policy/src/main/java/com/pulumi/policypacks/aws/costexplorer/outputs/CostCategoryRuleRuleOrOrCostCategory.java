...
public final class CostCategoryRuleRuleOrOrCostCategory {
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrOrCostCategory.key' is not present");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrOrCostCategory.matchOptions' is not present");
    }
    ...
    public @Nullable List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrOrCostCategory.values' is not present");
    }
