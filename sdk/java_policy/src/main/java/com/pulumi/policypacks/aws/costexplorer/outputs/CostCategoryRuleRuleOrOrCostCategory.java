...
public final class CostCategoryRuleRuleOrOrCostCategory {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleOrOrCostCategory.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleOrOrCostCategory.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleOrOrCostCategory.values");
    }
