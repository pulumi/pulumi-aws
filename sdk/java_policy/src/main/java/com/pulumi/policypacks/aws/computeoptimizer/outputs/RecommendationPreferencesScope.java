...
public final class RecommendationPreferencesScope {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'RecommendationPreferencesScope.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'RecommendationPreferencesScope.value' is not present");
    }
