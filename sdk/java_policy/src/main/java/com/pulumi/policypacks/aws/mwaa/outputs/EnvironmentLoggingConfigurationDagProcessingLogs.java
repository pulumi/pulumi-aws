...
public final class EnvironmentLoggingConfigurationDagProcessingLogs {
    ...
    public @Nullable String cloudWatchLogGroupArn() {
        ...
        return cloudWatchLogGroupArn.getValue("EnvironmentLoggingConfigurationDagProcessingLogs.cloudWatchLogGroupArn");
    }
    ...
    public @Nullable Boolean enabled() {
        ...
        return enabled.getValue("EnvironmentLoggingConfigurationDagProcessingLogs.enabled");
    }
    ...
    public @Nullable String logLevel() {
        ...
        return logLevel.getValue("EnvironmentLoggingConfigurationDagProcessingLogs.logLevel");
    }
