...
public final class ReplicationConfigurationTemplateTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ReplicationConfigurationTemplateTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ReplicationConfigurationTemplateTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ReplicationConfigurationTemplateTimeouts.update");
    }
