...
public final class ReplicationConfigurationTemplateTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'ReplicationConfigurationTemplateTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'ReplicationConfigurationTemplateTimeouts.delete' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'ReplicationConfigurationTemplateTimeouts.update' is not present");
    }
