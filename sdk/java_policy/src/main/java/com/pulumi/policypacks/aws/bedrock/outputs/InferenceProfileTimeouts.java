...
public final class InferenceProfileTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("InferenceProfileTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("InferenceProfileTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("InferenceProfileTimeouts.update");
    }
