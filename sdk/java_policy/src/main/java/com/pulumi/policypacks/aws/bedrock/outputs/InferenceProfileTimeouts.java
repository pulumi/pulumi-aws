...
public final class InferenceProfileTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'InferenceProfileTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'InferenceProfileTimeouts.delete' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'InferenceProfileTimeouts.update' is not present");
    }
