...
public final class ClusterMasterInstanceGroupEbsConfigArgs {
    ...
    public Integer iops() {
        ...
        throw new UndeferrableValueException("Value 'ClusterMasterInstanceGroupEbsConfigArgs.iops' is not present");
    }
    ...
    public Integer size() {
        ...
        throw new UndeferrableValueException("Value 'ClusterMasterInstanceGroupEbsConfigArgs.size' is not present");
    }
    ...
    public Integer throughput() {
        ...
        throw new UndeferrableValueException("Value 'ClusterMasterInstanceGroupEbsConfigArgs.throughput' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'ClusterMasterInstanceGroupEbsConfigArgs.type' is not present");
    }
    ...
    public Integer volumesPerInstance() {
        ...
        throw new UndeferrableValueException("Value 'ClusterMasterInstanceGroupEbsConfigArgs.volumesPerInstance' is not present");
    }
