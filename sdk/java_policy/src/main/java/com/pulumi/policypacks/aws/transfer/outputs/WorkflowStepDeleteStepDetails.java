...
public final class WorkflowStepDeleteStepDetails {
    ...
    public @Nullable String name() {
        ...
        throw new UndeferrableValueException("Value 'WorkflowStepDeleteStepDetails.name' is not present");
    }
    ...
    public @Nullable String sourceFileLocation() {
        ...
        throw new UndeferrableValueException("Value 'WorkflowStepDeleteStepDetails.sourceFileLocation' is not present");
    }
