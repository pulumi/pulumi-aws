...
public final class CostCategoryRuleRuleAndNotTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleAndNotTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleAndNotTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleAndNotTags.values");
    }
