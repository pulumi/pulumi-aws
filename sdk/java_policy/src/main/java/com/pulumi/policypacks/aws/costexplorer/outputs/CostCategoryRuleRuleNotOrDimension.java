...
public final class CostCategoryRuleRuleNotOrDimension {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleNotOrDimension.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleNotOrDimension.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleNotOrDimension.values");
    }
