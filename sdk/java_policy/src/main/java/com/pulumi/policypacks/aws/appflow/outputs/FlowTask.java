...
public final class FlowTask {
    ...
    private @Nullable List<FlowTaskConnectorOperator> value_connectorOperators;
    ...
    public @Nullable List<FlowTaskConnectorOperator> connectorOperators() {
        ...
        throw new UndeferrableValueException("Value 'FlowTask.connectorOperators' is not present");
    }
    ...
    private @Nullable String value_destinationField;
    ...
    public @Nullable String destinationField() {
        ...
        throw new UndeferrableValueException("Value 'FlowTask.destinationField' is not present");
    }
    ...
    private @Nullable List<String> value_sourceFields;
    ...
    public @Nullable List<String> sourceFields() {
        ...
        throw new UndeferrableValueException("Value 'FlowTask.sourceFields' is not present");
    }
    ...
    private @Nullable Map<String,String> value_taskProperties;
    ...
    public @Nullable Map<String,String> taskProperties() {
        ...
        throw new UndeferrableValueException("Value 'FlowTask.taskProperties' is not present");
    }
    ...
    public String taskType() {
        ...
        throw new UndeferrableValueException("Value 'FlowTask.taskType' is not present");
    }
