...
public final class V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValueArgs {
    ...
    public String interpretedValue() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentClosingSettingConditionalDefaultBranchNextStepIntentSlotValueArgs.interpretedValue' is not present");
    }
