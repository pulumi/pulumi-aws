...
public final class BucketLifecycleConfigurationV2Timeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'BucketLifecycleConfigurationV2Timeouts.create' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'BucketLifecycleConfigurationV2Timeouts.update' is not present");
    }
