...
public final class InsightFiltersProcessPath {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProcessPath.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProcessPath.value' is not present");
    }
