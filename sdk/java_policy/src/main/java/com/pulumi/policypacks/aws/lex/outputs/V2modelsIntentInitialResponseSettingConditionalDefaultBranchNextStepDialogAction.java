...
public final class V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction {
    ...
    public @Nullable String slotToElicit() {
        ...
        return slotToElicit.getValue("V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction.slotToElicit");
    }
    ...
    public @Nullable Boolean suppressNextMessage() {
        ...
        return suppressNextMessage.getValue("V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction.suppressNextMessage");
    }
    ...
    public String type() {
        ...
        return type.getValue("V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction.type");
    }
