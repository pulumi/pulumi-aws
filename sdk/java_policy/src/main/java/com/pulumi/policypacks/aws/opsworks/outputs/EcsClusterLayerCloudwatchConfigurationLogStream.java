...
public final class EcsClusterLayerCloudwatchConfigurationLogStream {
    ...
    public @Nullable Integer batchCount() {
        ...
        return batchCount.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.batchCount");
    }
    ...
    public @Nullable Integer batchSize() {
        ...
        return batchSize.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.batchSize");
    }
    ...
    public @Nullable Integer bufferDuration() {
        ...
        return bufferDuration.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.bufferDuration");
    }
    ...
    public @Nullable String datetimeFormat() {
        ...
        return datetimeFormat.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.datetimeFormat");
    }
    ...
    public @Nullable String encoding() {
        ...
        return encoding.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.encoding");
    }
    ...
    public String file() {
        ...
        return file.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.file");
    }
    ...
    public @Nullable String fileFingerprintLines() {
        ...
        return fileFingerprintLines.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.fileFingerprintLines");
    }
    ...
    public @Nullable String initialPosition() {
        ...
        return initialPosition.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.initialPosition");
    }
    ...
    public String logGroupName() {
        ...
        return logGroupName.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.logGroupName");
    }
    ...
    public @Nullable String multilineStartPattern() {
        ...
        return multilineStartPattern.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.multilineStartPattern");
    }
    ...
    public @Nullable String timeZone() {
        ...
        return timeZone.getValue("EcsClusterLayerCloudwatchConfigurationLogStream.timeZone");
    }
