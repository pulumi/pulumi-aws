...
public final class WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs {
    ...
    public String fallbackBehavior() {
        ...
        return fallbackBehavior.getValue("WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs.fallbackBehavior");
    }
    ...
    public String headerName() {
        ...
        return headerName.getValue("WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs.headerName");
    }
    ...
    public String position() {
        ...
        return position.getValue("WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs.position");
    }
