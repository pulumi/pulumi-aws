...
public final class ManagedUserPoolClient extends com.pulumi.resources.PolicyResourceOutput {
    ...
    private @Nullable ManagedUserPoolClientAnalyticsConfiguration value_analyticsConfiguration;
    ...
    private @Nullable String value_namePattern;
    ...
    private @Nullable String value_namePrefix;
    ...
    private @Nullable ManagedUserPoolClientTokenValidityUnits value_tokenValidityUnits;
