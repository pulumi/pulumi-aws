...
public final class TableMaintenanceConfigurationIcebergSnapshotManagementSettings {
    ...
    public Integer maxSnapshotAgeHours() {
        ...
        throw new UndeferrableValueException("Value 'TableMaintenanceConfigurationIcebergSnapshotManagementSettings.maxSnapshotAgeHours' is not present");
    }
    ...
    public Integer minSnapshotsToKeep() {
        ...
        throw new UndeferrableValueException("Value 'TableMaintenanceConfigurationIcebergSnapshotManagementSettings.minSnapshotsToKeep' is not present");
    }
