...
public final class DataLakeSettingsCreateTableDefaultPermissionArgs {
    ...
    public List<String> permissions() {
        ...
        return permissions.getValue("DataLakeSettingsCreateTableDefaultPermissionArgs.permissions");
    }
    ...
    public String principal() {
        ...
        return principal.getValue("DataLakeSettingsCreateTableDefaultPermissionArgs.principal");
    }
