...
public final class FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameter {
    ...
    public String parameterName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameter.parameterName' is not present");
    }
    ...
    public String parameterValue() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameter.parameterValue' is not present");
    }
