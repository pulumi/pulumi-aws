...
public final class DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings {
    ...
    public @Nullable List<String> assumableRoleArns() {
        ...
        return assumableRoleArns.getValue("DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings.assumableRoleArns");
    }
    ...
    public @Nullable List<String> executionRoleArns() {
        ...
        return executionRoleArns.getValue("DomainDefaultUserSettingsJupyterLabAppSettingsEmrSettings.executionRoleArns");
    }
