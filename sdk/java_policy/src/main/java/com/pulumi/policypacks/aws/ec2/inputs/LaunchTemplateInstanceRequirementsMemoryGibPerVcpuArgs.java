...
public final class LaunchTemplateInstanceRequirementsMemoryGibPerVcpuArgs {
    ...
    public Double max() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsMemoryGibPerVcpuArgs.max' is not present");
    }
    ...
    public Double min() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsMemoryGibPerVcpuArgs.min' is not present");
    }
