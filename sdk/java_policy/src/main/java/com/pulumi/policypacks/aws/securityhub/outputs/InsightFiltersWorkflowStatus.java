...
public final class InsightFiltersWorkflowStatus {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersWorkflowStatus.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersWorkflowStatus.value' is not present");
    }
