...
public final class DashboardParametersDateTimeParameter {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'DashboardParametersDateTimeParameter.name' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'DashboardParametersDateTimeParameter.values' is not present");
    }
