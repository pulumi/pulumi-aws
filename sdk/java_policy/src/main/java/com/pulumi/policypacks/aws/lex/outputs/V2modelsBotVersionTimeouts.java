...
public final class V2modelsBotVersionTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsBotVersionTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsBotVersionTimeouts.delete' is not present");
    }
