...
public final class DataSourceParametersOracleArgs {
    ...
    public String database() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersOracleArgs.database' is not present");
    }
    ...
    public String host() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersOracleArgs.host' is not present");
    }
    ...
    public Integer port() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersOracleArgs.port' is not present");
    }
