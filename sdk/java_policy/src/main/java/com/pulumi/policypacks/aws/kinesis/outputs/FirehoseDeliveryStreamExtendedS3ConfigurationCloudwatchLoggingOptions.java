...
public final class FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions {
    ...
    public @Nullable Boolean enabled() {
        ...
        return enabled.getValue("FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions.enabled");
    }
    ...
    public @Nullable String logGroupName() {
        ...
        return logGroupName.getValue("FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions.logGroupName");
    }
    ...
    public @Nullable String logStreamName() {
        ...
        return logStreamName.getValue("FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions.logStreamName");
    }
