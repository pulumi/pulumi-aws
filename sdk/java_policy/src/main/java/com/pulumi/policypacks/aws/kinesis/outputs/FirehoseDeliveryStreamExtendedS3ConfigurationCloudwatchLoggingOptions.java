...
public final class FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions {
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions.enabled' is not present");
    }
    ...
    public @Nullable String logGroupName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions.logGroupName' is not present");
    }
    ...
    public @Nullable String logStreamName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationCloudwatchLoggingOptions.logStreamName' is not present");
    }
