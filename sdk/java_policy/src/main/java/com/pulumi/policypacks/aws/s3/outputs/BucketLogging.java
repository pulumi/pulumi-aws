...
public final class BucketLogging {
    ...
    public String targetBucket() {
        ...
        throw new UndeferrableValueException("Value 'BucketLogging.targetBucket' is not present");
    }
    ...
    public @Nullable String targetPrefix() {
        ...
        throw new UndeferrableValueException("Value 'BucketLogging.targetPrefix' is not present");
    }
