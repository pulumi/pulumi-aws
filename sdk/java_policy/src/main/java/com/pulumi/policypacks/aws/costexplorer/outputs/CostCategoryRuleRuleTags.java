...
public final class CostCategoryRuleRuleTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleTags.values");
    }
