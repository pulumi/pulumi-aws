...
public final class IntentConclusionStatementMessageArgs {
    ...
    public String content() {
        ...
        throw new UndeferrableValueException("Value 'IntentConclusionStatementMessageArgs.content' is not present");
    }
    ...
    public String contentType() {
        ...
        throw new UndeferrableValueException("Value 'IntentConclusionStatementMessageArgs.contentType' is not present");
    }
    ...
    public Integer groupNumber() {
        ...
        throw new UndeferrableValueException("Value 'IntentConclusionStatementMessageArgs.groupNumber' is not present");
    }
