...
public final class RuleGroupRuleStatementRateBasedStatementScopeDownStatementByteMatchStatementFieldToMatchCookies {
     ...
     * 
     */
    private UndeferrableValue<List<RuleGroupRuleStatementRateBasedStatementScopeDownStatementByteMatchStatementFieldToMatchCookiesMatchPattern>> matchPatterns;
    ...
    public List<RuleGroupRuleStatementRateBasedStatementScopeDownStatementByteMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns() {
        ...
        return matchPatterns.getValue("RuleGroupRuleStatementRateBasedStatementScopeDownStatementByteMatchStatementFieldToMatchCookies.matchPatterns");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("RuleGroupRuleStatementRateBasedStatementScopeDownStatementByteMatchStatementFieldToMatchCookies.matchScope");
    }
    ...
    public String oversizeHandling() {
        ...
        return oversizeHandling.getValue("RuleGroupRuleStatementRateBasedStatementScopeDownStatementByteMatchStatementFieldToMatchCookies.oversizeHandling");
    }
