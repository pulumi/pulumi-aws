...
public final class SpotFleetRequestLaunchSpecificationRootBlockDevice {
    ...
    public @Nullable Boolean deleteOnTermination() {
        ...
        throw new UndeferrableValueException("Value 'SpotFleetRequestLaunchSpecificationRootBlockDevice.deleteOnTermination' is not present");
    }
    ...
    public @Nullable Boolean encrypted() {
        ...
        throw new UndeferrableValueException("Value 'SpotFleetRequestLaunchSpecificationRootBlockDevice.encrypted' is not present");
    }
    ...
    public @Nullable Integer iops() {
        ...
        throw new UndeferrableValueException("Value 'SpotFleetRequestLaunchSpecificationRootBlockDevice.iops' is not present");
    }
    ...
    public @Nullable String kmsKeyId() {
        ...
        throw new UndeferrableValueException("Value 'SpotFleetRequestLaunchSpecificationRootBlockDevice.kmsKeyId' is not present");
    }
    ...
    public @Nullable Integer throughput() {
        ...
        throw new UndeferrableValueException("Value 'SpotFleetRequestLaunchSpecificationRootBlockDevice.throughput' is not present");
    }
    ...
    public @Nullable Integer volumeSize() {
        ...
        throw new UndeferrableValueException("Value 'SpotFleetRequestLaunchSpecificationRootBlockDevice.volumeSize' is not present");
    }
    ...
    public @Nullable String volumeType() {
        ...
        throw new UndeferrableValueException("Value 'SpotFleetRequestLaunchSpecificationRootBlockDevice.volumeType' is not present");
    }
