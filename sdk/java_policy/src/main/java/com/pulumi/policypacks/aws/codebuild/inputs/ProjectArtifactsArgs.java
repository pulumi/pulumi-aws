...
public final class ProjectArtifactsArgs {
    ...
    public String artifactIdentifier() {
        ...
        return artifactIdentifier.getValue("ProjectArtifactsArgs.artifactIdentifier");
    }
    ...
    public String bucketOwnerAccess() {
        ...
        return bucketOwnerAccess.getValue("ProjectArtifactsArgs.bucketOwnerAccess");
    }
    ...
    public Boolean encryptionDisabled() {
        ...
        return encryptionDisabled.getValue("ProjectArtifactsArgs.encryptionDisabled");
    }
    ...
    public String location() {
        ...
        return location.getValue("ProjectArtifactsArgs.location");
    }
    ...
    public String name() {
        ...
        return name.getValue("ProjectArtifactsArgs.name");
    }
    ...
    public String namespaceType() {
        ...
        return namespaceType.getValue("ProjectArtifactsArgs.namespaceType");
    }
    ...
    public Boolean overrideArtifactName() {
        ...
        return overrideArtifactName.getValue("ProjectArtifactsArgs.overrideArtifactName");
    }
    ...
    public String packaging() {
        ...
        return packaging.getValue("ProjectArtifactsArgs.packaging");
    }
    ...
    public String path() {
        ...
        return path.getValue("ProjectArtifactsArgs.path");
    }
    ...
    public String type() {
        ...
        return type.getValue("ProjectArtifactsArgs.type");
    }
