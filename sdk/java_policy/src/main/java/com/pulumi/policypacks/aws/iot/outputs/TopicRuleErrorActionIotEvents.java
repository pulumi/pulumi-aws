...
public final class TopicRuleErrorActionIotEvents {
    ...
    public @Nullable Boolean batchMode() {
        ...
        return batchMode.getValue("TopicRuleErrorActionIotEvents.batchMode");
    }
    ...
    public String inputName() {
        ...
        return inputName.getValue("TopicRuleErrorActionIotEvents.inputName");
    }
    ...
    public @Nullable String messageId() {
        ...
        return messageId.getValue("TopicRuleErrorActionIotEvents.messageId");
    }
    ...
    public String roleArn() {
        ...
        return roleArn.getValue("TopicRuleErrorActionIotEvents.roleArn");
    }
