...
public final class JavaAppLayerEbsVolumeArgs {

    private UndeferrableValue<Boolean> encrypted;

    public Boolean encrypted() {
        if (encrypted == null) return null;
        return encrypted.getValue("JavaAppLayerEbsVolumeArgs.encrypted");
    }
    ...
    public Integer iops() {
        ...
        return iops.getValue("JavaAppLayerEbsVolumeArgs.iops");
    }
    ...
    public String mountPoint() {
        ...
        return mountPoint.getValue("JavaAppLayerEbsVolumeArgs.mountPoint");
    }
    ...
    public Integer numberOfDisks() {
        ...
        return numberOfDisks.getValue("JavaAppLayerEbsVolumeArgs.numberOfDisks");
    }
    ...
    public String raidLevel() {
        ...
        return raidLevel.getValue("JavaAppLayerEbsVolumeArgs.raidLevel");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("JavaAppLayerEbsVolumeArgs.size");
    }
    ...
    public String type() {
        ...
        return type.getValue("JavaAppLayerEbsVolumeArgs.type");
    }
