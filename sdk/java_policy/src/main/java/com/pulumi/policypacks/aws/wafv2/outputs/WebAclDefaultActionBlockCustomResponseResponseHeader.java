...
public final class WebAclDefaultActionBlockCustomResponseResponseHeader {
    ...
    public String name() {
        ...
        return name.getValue("WebAclDefaultActionBlockCustomResponseResponseHeader.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclDefaultActionBlockCustomResponseResponseHeader.value");
    }
