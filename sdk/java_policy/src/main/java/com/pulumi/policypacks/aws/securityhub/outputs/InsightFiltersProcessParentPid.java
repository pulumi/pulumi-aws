...
public final class InsightFiltersProcessParentPid {
    ...
    public @Nullable String eq() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProcessParentPid.eq' is not present");
    }
    ...
    public @Nullable String gte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProcessParentPid.gte' is not present");
    }
    ...
    public @Nullable String lte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProcessParentPid.lte' is not present");
    }
