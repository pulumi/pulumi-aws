...
public final class InsightFiltersProcessParentPid {
    ...
    public @Nullable String eq() {
        ...
        return eq.getValue("InsightFiltersProcessParentPid.eq");
    }
    ...
    public @Nullable String gte() {
        ...
        return gte.getValue("InsightFiltersProcessParentPid.gte");
    }
    ...
    public @Nullable String lte() {
        ...
        return lte.getValue("InsightFiltersProcessParentPid.lte");
    }
