...
public final class DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings {
    ...
    public @Nullable List<String> assumableRoleArns() {
        ...
        return assumableRoleArns.getValue("DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings.assumableRoleArns");
    }
    ...
    public @Nullable List<String> executionRoleArns() {
        ...
        return executionRoleArns.getValue("DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings.executionRoleArns");
    }
