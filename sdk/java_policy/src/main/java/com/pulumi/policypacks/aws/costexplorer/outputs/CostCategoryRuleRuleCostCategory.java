...
public final class CostCategoryRuleRuleCostCategory {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleCostCategory.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleCostCategory.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleCostCategory.values");
    }
