...
public final class LaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps {
    ...
    public @Nullable Integer max() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps.max' is not present");
    }
    ...
    public @Nullable Integer min() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsBaselineEbsBandwidthMbps.min' is not present");
    }
