...
public final class InsightFiltersRecordState {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersRecordState.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersRecordState.value' is not present");
    }
