...
public final class BudgetNotification {
    ...
    public String comparisonOperator() {
        ...
        throw new UndeferrableValueException("Value 'BudgetNotification.comparisonOperator' is not present");
    }
    ...
    public String notificationType() {
        ...
        throw new UndeferrableValueException("Value 'BudgetNotification.notificationType' is not present");
    }
    ...
    private @Nullable List<String> value_subscriberEmailAddresses;
    ...
    public @Nullable List<String> subscriberEmailAddresses() {
        ...
        throw new UndeferrableValueException("Value 'BudgetNotification.subscriberEmailAddresses' is not present");
    }
    ...
    private @Nullable List<String> value_subscriberSnsTopicArns;
    ...
    public @Nullable List<String> subscriberSnsTopicArns() {
        ...
        throw new UndeferrableValueException("Value 'BudgetNotification.subscriberSnsTopicArns' is not present");
    }
    ...
    public Double threshold() {
        ...
        throw new UndeferrableValueException("Value 'BudgetNotification.threshold' is not present");
    }
    ...
    public String thresholdType() {
        ...
        throw new UndeferrableValueException("Value 'BudgetNotification.thresholdType' is not present");
    }
