...
public final class MemberDetectorFeatureAdditionalConfigurationArgs {
    ...
    public String name() {
        ...
        return name.getValue("MemberDetectorFeatureAdditionalConfigurationArgs.name");
    }
    ...
    public String status() {
        ...
        return status.getValue("MemberDetectorFeatureAdditionalConfigurationArgs.status");
    }
