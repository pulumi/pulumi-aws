...
public final class EnvironmentLoggingConfigurationWebserverLogs {
    ...
    public @Nullable String cloudWatchLogGroupArn() {
        ...
        return cloudWatchLogGroupArn.getValue("EnvironmentLoggingConfigurationWebserverLogs.cloudWatchLogGroupArn");
    }
    ...
    public @Nullable Boolean enabled() {
        ...
        return enabled.getValue("EnvironmentLoggingConfigurationWebserverLogs.enabled");
    }
    ...
    public @Nullable String logLevel() {
        ...
        return logLevel.getValue("EnvironmentLoggingConfigurationWebserverLogs.logLevel");
    }
