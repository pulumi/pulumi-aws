...
public final class EnvironmentLoggingConfigurationWebserverLogs {
    ...
    public @Nullable String cloudWatchLogGroupArn() {
        ...
        throw new UndeferrableValueException("Value 'EnvironmentLoggingConfigurationWebserverLogs.cloudWatchLogGroupArn' is not present");
    }
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'EnvironmentLoggingConfigurationWebserverLogs.enabled' is not present");
    }
    ...
    public @Nullable String logLevel() {
        ...
        throw new UndeferrableValueException("Value 'EnvironmentLoggingConfigurationWebserverLogs.logLevel' is not present");
    }
