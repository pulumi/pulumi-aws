...
public final class ApnsVoipChannel extends com.pulumi.resources.PolicyResourceOutput {
    ...
    public String applicationId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipChannel.applicationId' is not present");
    }
    ...
    public @Nullable String bundleId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipChannel.bundleId' is not present");
    }
    ...
    public @Nullable String certificate() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipChannel.certificate' is not present");
    }
    ...
    public @Nullable String defaultAuthenticationMethod() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipChannel.defaultAuthenticationMethod' is not present");
    }
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipChannel.enabled' is not present");
    }
    ...
    public @Nullable String privateKey() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipChannel.privateKey' is not present");
    }
    ...
    public @Nullable String teamId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipChannel.teamId' is not present");
    }
    ...
    public @Nullable String tokenKey() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipChannel.tokenKey' is not present");
    }
    ...
    public @Nullable String tokenKeyId() {
        ...
        throw new UndeferrableValueException("Value 'ApnsVoipChannel.tokenKeyId' is not present");
    }
