...
public final class CertificateValidity {
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'CertificateValidity.type' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'CertificateValidity.value' is not present");
    }
