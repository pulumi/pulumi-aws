...
public final class CostCategoryRuleRuleAndAndTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleAndAndTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleAndAndTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleAndAndTags.values");
    }
