...
public final class AutomationRuleCriteriaUpdatedAt {
    ...
    private @Nullable AutomationRuleCriteriaUpdatedAtDateRange value_dateRange;
    ...
    public @Nullable AutomationRuleCriteriaUpdatedAtDateRange dateRange() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaUpdatedAt.dateRange' is not present");
    }
    ...
    public @Nullable String end() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaUpdatedAt.end' is not present");
    }
    ...
    public @Nullable String start() {
        ...
        throw new UndeferrableValueException("Value 'AutomationRuleCriteriaUpdatedAt.start' is not present");
    }
