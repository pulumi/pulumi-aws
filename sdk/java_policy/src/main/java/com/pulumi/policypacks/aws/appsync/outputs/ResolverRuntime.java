...
public final class ResolverRuntime {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'ResolverRuntime.name' is not present");
    }
    ...
    public String runtimeVersion() {
        ...
        throw new UndeferrableValueException("Value 'ResolverRuntime.runtimeVersion' is not present");
    }
