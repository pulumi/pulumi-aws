...
public final class AnalysisParametersDateTimeParameter {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'AnalysisParametersDateTimeParameter.name' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'AnalysisParametersDateTimeParameter.values' is not present");
    }
