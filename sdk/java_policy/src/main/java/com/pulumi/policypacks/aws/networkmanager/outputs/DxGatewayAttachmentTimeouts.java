...
public final class DxGatewayAttachmentTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("DxGatewayAttachmentTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("DxGatewayAttachmentTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("DxGatewayAttachmentTimeouts.update");
    }
