...
public final class CustomerManagedPolicyAttachmentCustomerManagedPolicyReference {
    ...
    public String name() {
        ...
        return name.getValue("CustomerManagedPolicyAttachmentCustomerManagedPolicyReference.name");
    }
    ...
    public @Nullable String path() {
        ...
        return path.getValue("CustomerManagedPolicyAttachmentCustomerManagedPolicyReference.path");
    }
