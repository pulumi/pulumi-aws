...
public final class RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        return invalidFallbackBehavior.getValue("RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.invalidFallbackBehavior");
    }
     ...
     * 
     */
    private UndeferrableValue<RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern;
    ...
    public RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        ...
        return matchPattern.getValue("RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.matchPattern");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.matchScope");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        return oversizeHandling.getValue("RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.oversizeHandling");
    }
