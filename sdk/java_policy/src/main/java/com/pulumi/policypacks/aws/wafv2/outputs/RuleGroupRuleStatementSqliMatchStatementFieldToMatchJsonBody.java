...
import com.pulumi.policypacks.aws.wafv2.outputs.RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern;
...
public final class RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.invalidFallbackBehavior' is not present");
    }
    ...
    private RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern value_matchPattern;
    ...
    public RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.matchPattern' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.matchScope' is not present");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody.oversizeHandling' is not present");
    }
