...
public final class SizeConstraintSetSizeConstraintFieldToMatch {
    ...
    public @Nullable String data() {
        ...
        throw new UndeferrableValueException("Value 'SizeConstraintSetSizeConstraintFieldToMatch.data' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'SizeConstraintSetSizeConstraintFieldToMatch.type' is not present");
    }
