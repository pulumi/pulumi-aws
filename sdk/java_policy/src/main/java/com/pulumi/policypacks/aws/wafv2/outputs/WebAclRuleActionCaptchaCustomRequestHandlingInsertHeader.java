...
public final class WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader.value' is not present");
    }
