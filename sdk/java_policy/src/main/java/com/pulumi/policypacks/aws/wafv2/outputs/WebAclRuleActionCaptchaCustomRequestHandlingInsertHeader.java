...
public final class WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader {
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclRuleActionCaptchaCustomRequestHandlingInsertHeader.value");
    }
