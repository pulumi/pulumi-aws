...
public final class VirtualGatewaySpecListenerTlsValidationTrustSdsArgs {
    ...
    public String secretName() {
        ...
        return secretName.getValue("VirtualGatewaySpecListenerTlsValidationTrustSdsArgs.secretName");
    }
