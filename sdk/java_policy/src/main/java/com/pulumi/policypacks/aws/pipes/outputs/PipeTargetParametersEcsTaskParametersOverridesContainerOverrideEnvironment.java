...
public final class PipeTargetParametersEcsTaskParametersOverridesContainerOverrideEnvironment {
    ...
    public @Nullable String name() {
        ...
        return name.getValue("PipeTargetParametersEcsTaskParametersOverridesContainerOverrideEnvironment.name");
    }
    ...
    public @Nullable String value() {
        ...
        return value.getValue("PipeTargetParametersEcsTaskParametersOverridesContainerOverrideEnvironment.value");
    }
