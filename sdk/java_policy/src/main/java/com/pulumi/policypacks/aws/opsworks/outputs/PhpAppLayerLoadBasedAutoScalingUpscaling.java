...
public final class PhpAppLayerLoadBasedAutoScalingUpscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("PhpAppLayerLoadBasedAutoScalingUpscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("PhpAppLayerLoadBasedAutoScalingUpscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("PhpAppLayerLoadBasedAutoScalingUpscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("PhpAppLayerLoadBasedAutoScalingUpscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("PhpAppLayerLoadBasedAutoScalingUpscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("PhpAppLayerLoadBasedAutoScalingUpscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("PhpAppLayerLoadBasedAutoScalingUpscaling.thresholdsWaitTime");
    }
