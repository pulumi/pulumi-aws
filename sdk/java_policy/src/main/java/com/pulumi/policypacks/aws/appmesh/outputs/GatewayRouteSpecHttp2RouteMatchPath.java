...
public final class GatewayRouteSpecHttp2RouteMatchPath {
    ...
    public @Nullable String exact() {
        ...
        throw new UndeferrableValueException("Value 'GatewayRouteSpecHttp2RouteMatchPath.exact' is not present");
    }
    ...
    public @Nullable String regex() {
        ...
        throw new UndeferrableValueException("Value 'GatewayRouteSpecHttp2RouteMatchPath.regex' is not present");
    }
