...
public final class KxDataviewSegmentConfigurationArgs {
    ...
    public List<String> dbPaths() {
        ...
        return dbPaths.getValue("KxDataviewSegmentConfigurationArgs.dbPaths");
    }
     ...
     * 
     */
    private UndeferrableValue<Boolean> onDemand;

    public Boolean onDemand() {
        if (onDemand == null) return null;
        return onDemand.getValue("KxDataviewSegmentConfigurationArgs.onDemand");
    }
    ...
    public String volumeName() {
        ...
        return volumeName.getValue("KxDataviewSegmentConfigurationArgs.volumeName");
    }
