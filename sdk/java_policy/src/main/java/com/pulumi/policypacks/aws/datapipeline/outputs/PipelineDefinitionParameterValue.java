...
public final class PipelineDefinitionParameterValue {
    ...
    public String id() {
        ...
        throw new UndeferrableValueException("Value 'PipelineDefinitionParameterValue.id' is not present");
    }
    ...
    public String stringValue() {
        ...
        throw new UndeferrableValueException("Value 'PipelineDefinitionParameterValue.stringValue' is not present");
    }
