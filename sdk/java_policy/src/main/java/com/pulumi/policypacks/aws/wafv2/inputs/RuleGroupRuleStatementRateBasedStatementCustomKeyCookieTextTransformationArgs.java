...
public final class RuleGroupRuleStatementRateBasedStatementCustomKeyCookieTextTransformationArgs {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementCustomKeyCookieTextTransformationArgs.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementCustomKeyCookieTextTransformationArgs.type' is not present");
    }
