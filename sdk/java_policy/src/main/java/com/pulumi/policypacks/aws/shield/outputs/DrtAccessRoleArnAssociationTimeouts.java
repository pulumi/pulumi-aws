...
public final class DrtAccessRoleArnAssociationTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'DrtAccessRoleArnAssociationTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'DrtAccessRoleArnAssociationTimeouts.delete' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'DrtAccessRoleArnAssociationTimeouts.update' is not present");
    }
