...
public final class DrtAccessRoleArnAssociationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("DrtAccessRoleArnAssociationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("DrtAccessRoleArnAssociationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("DrtAccessRoleArnAssociationTimeouts.update");
    }
