...
public final class HaproxyLayerEbsVolumeArgs {

    private UndeferrableValue<Boolean> encrypted;

    public Boolean encrypted() {
        if (encrypted == null) return null;
        return encrypted.getValue("HaproxyLayerEbsVolumeArgs.encrypted");
    }
    ...
    public Integer iops() {
        ...
        return iops.getValue("HaproxyLayerEbsVolumeArgs.iops");
    }
    ...
    public String mountPoint() {
        ...
        return mountPoint.getValue("HaproxyLayerEbsVolumeArgs.mountPoint");
    }
    ...
    public Integer numberOfDisks() {
        ...
        return numberOfDisks.getValue("HaproxyLayerEbsVolumeArgs.numberOfDisks");
    }
    ...
    public String raidLevel() {
        ...
        return raidLevel.getValue("HaproxyLayerEbsVolumeArgs.raidLevel");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("HaproxyLayerEbsVolumeArgs.size");
    }
    ...
    public String type() {
        ...
        return type.getValue("HaproxyLayerEbsVolumeArgs.type");
    }
