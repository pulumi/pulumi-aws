...
public final class UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSettingArgs {
    ...
    public String dataSourceName() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSettingArgs.dataSourceName' is not present");
    }
    ...
    public String secretArn() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSettingArgs.secretArn' is not present");
    }
    ...
    public String status() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSettingArgs.status' is not present");
    }
