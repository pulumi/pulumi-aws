...
public final class InsightFiltersResourceAwsEc2InstanceImageId {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceAwsEc2InstanceImageId.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceAwsEc2InstanceImageId.value' is not present");
    }
