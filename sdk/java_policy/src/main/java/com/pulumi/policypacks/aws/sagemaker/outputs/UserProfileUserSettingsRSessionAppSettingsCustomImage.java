...
public final class UserProfileUserSettingsRSessionAppSettingsCustomImage {
    ...
    public String appImageConfigName() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsRSessionAppSettingsCustomImage.appImageConfigName' is not present");
    }
    ...
    public String imageName() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsRSessionAppSettingsCustomImage.imageName' is not present");
    }
    ...
    public @Nullable Integer imageVersionNumber() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsRSessionAppSettingsCustomImage.imageVersionNumber' is not present");
    }
