...
import com.pulumi.policypacks.aws.route53domains.outputs.DomainRegistrantContactExtraParam;
...
public final class DomainRegistrantContact {
    ...
    public @Nullable String addressLine1() {
        ...
        return addressLine1.getValue("DomainRegistrantContact.addressLine1");
    }
    ...
    public @Nullable String addressLine2() {
        ...
        return addressLine2.getValue("DomainRegistrantContact.addressLine2");
    }
    ...
    public @Nullable String city() {
        ...
        return city.getValue("DomainRegistrantContact.city");
    }
    ...
    public @Nullable String contactType() {
        ...
        return contactType.getValue("DomainRegistrantContact.contactType");
    }
    ...
    public @Nullable String countryCode() {
        ...
        return countryCode.getValue("DomainRegistrantContact.countryCode");
    }
    ...
    public @Nullable String email() {
        ...
        return email.getValue("DomainRegistrantContact.email");
    }
     ...
     * 
     */
    private @Nullable UndeferrableValue<List<DomainRegistrantContactExtraParam>> extraParams;

    public @Nullable List<DomainRegistrantContactExtraParam> extraParams() {
        if (extraParams == null) return null;
        return extraParams.getValue("DomainRegistrantContact.extraParams");
    }
    ...
    public @Nullable String fax() {
        ...
        return fax.getValue("DomainRegistrantContact.fax");
    }
    ...
    public @Nullable String firstName() {
        ...
        return firstName.getValue("DomainRegistrantContact.firstName");
    }
    ...
    public @Nullable String lastName() {
        ...
        return lastName.getValue("DomainRegistrantContact.lastName");
    }
    ...
    public @Nullable String organizationName() {
        ...
        return organizationName.getValue("DomainRegistrantContact.organizationName");
    }
    ...
    public @Nullable String phoneNumber() {
        ...
        return phoneNumber.getValue("DomainRegistrantContact.phoneNumber");
    }
    ...
    public @Nullable String state() {
        ...
        return state.getValue("DomainRegistrantContact.state");
    }
    ...
    public @Nullable String zipCode() {
        ...
        return zipCode.getValue("DomainRegistrantContact.zipCode");
    }
