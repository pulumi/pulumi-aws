...
public final class HaproxyLayerLoadBasedAutoScalingDownscalingArgs {
    ...
    public List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerLoadBasedAutoScalingDownscalingArgs.alarms' is not present");
    }
    ...
    public Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerLoadBasedAutoScalingDownscalingArgs.cpuThreshold' is not present");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerLoadBasedAutoScalingDownscalingArgs.ignoreMetricsTime' is not present");
    }
    ...
    public Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerLoadBasedAutoScalingDownscalingArgs.instanceCount' is not present");
    }
    ...
    public Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerLoadBasedAutoScalingDownscalingArgs.loadThreshold' is not present");
    }
    ...
    public Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerLoadBasedAutoScalingDownscalingArgs.memoryThreshold' is not present");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerLoadBasedAutoScalingDownscalingArgs.thresholdsWaitTime' is not present");
    }
