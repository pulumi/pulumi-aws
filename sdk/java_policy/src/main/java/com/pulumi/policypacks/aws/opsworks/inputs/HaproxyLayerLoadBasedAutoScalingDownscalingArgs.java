...
public final class HaproxyLayerLoadBasedAutoScalingDownscalingArgs {
    ...
    public List<String> alarms() {
        ...
        return alarms.getValue("HaproxyLayerLoadBasedAutoScalingDownscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("HaproxyLayerLoadBasedAutoScalingDownscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("HaproxyLayerLoadBasedAutoScalingDownscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("HaproxyLayerLoadBasedAutoScalingDownscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("HaproxyLayerLoadBasedAutoScalingDownscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("HaproxyLayerLoadBasedAutoScalingDownscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("HaproxyLayerLoadBasedAutoScalingDownscalingArgs.thresholdsWaitTime");
    }
