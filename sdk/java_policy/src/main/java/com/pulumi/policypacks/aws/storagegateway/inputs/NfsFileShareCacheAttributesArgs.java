...
public final class NfsFileShareCacheAttributesArgs {
    ...
    public Integer cacheStaleTimeoutInSeconds() {
        ...
        return cacheStaleTimeoutInSeconds.getValue("NfsFileShareCacheAttributesArgs.cacheStaleTimeoutInSeconds");
    }
