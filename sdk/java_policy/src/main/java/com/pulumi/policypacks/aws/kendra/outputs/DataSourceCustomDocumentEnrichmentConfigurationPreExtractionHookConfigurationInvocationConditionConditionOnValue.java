...
public final class DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue {
    ...
    public @Nullable String dateValue() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue.dateValue' is not present");
    }
    ...
    public @Nullable Integer longValue() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue.longValue' is not present");
    }
    ...
    public @Nullable List<String> stringListValues() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue.stringListValues' is not present");
    }
    ...
    public @Nullable String stringValue() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPreExtractionHookConfigurationInvocationConditionConditionOnValue.stringValue' is not present");
    }
