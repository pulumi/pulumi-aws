...
public final class VirtualNodeSpecListenerTlsValidationSubjectAlternativeNamesMatchArgs {
    ...
    public List<String> exacts() {
        ...
        throw new UndeferrableValueException("Value 'VirtualNodeSpecListenerTlsValidationSubjectAlternativeNamesMatchArgs.exacts' is not present");
    }
