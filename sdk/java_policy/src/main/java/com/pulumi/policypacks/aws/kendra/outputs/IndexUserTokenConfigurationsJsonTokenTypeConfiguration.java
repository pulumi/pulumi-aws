...
public final class IndexUserTokenConfigurationsJsonTokenTypeConfiguration {
    ...
    public String groupAttributeField() {
        ...
        throw new UndeferrableValueException("Value 'IndexUserTokenConfigurationsJsonTokenTypeConfiguration.groupAttributeField' is not present");
    }
    ...
    public String userNameAttributeField() {
        ...
        throw new UndeferrableValueException("Value 'IndexUserTokenConfigurationsJsonTokenTypeConfiguration.userNameAttributeField' is not present");
    }
