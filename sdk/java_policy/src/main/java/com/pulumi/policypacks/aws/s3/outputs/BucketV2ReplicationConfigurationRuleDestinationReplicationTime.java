...
public final class BucketV2ReplicationConfigurationRuleDestinationReplicationTime {
    ...
    public @Nullable Integer minutes() {
        ...
        return minutes.getValue("BucketV2ReplicationConfigurationRuleDestinationReplicationTime.minutes");
    }
    ...
    public @Nullable String status() {
        ...
        return status.getValue("BucketV2ReplicationConfigurationRuleDestinationReplicationTime.status");
    }
