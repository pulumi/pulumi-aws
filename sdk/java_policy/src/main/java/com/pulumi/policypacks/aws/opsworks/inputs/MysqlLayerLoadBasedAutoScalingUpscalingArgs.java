...
public final class MysqlLayerLoadBasedAutoScalingUpscalingArgs {
    ...
    public List<String> alarms() {
        ...
        return alarms.getValue("MysqlLayerLoadBasedAutoScalingUpscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("MysqlLayerLoadBasedAutoScalingUpscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("MysqlLayerLoadBasedAutoScalingUpscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("MysqlLayerLoadBasedAutoScalingUpscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("MysqlLayerLoadBasedAutoScalingUpscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("MysqlLayerLoadBasedAutoScalingUpscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("MysqlLayerLoadBasedAutoScalingUpscalingArgs.thresholdsWaitTime");
    }
