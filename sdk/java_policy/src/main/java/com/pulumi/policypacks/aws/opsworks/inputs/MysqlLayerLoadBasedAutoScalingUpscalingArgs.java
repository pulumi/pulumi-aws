...
public final class MysqlLayerLoadBasedAutoScalingUpscalingArgs {
    ...
    public List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'MysqlLayerLoadBasedAutoScalingUpscalingArgs.alarms' is not present");
    }
    ...
    public Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'MysqlLayerLoadBasedAutoScalingUpscalingArgs.cpuThreshold' is not present");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'MysqlLayerLoadBasedAutoScalingUpscalingArgs.ignoreMetricsTime' is not present");
    }
    ...
    public Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'MysqlLayerLoadBasedAutoScalingUpscalingArgs.instanceCount' is not present");
    }
    ...
    public Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'MysqlLayerLoadBasedAutoScalingUpscalingArgs.loadThreshold' is not present");
    }
    ...
    public Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'MysqlLayerLoadBasedAutoScalingUpscalingArgs.memoryThreshold' is not present");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'MysqlLayerLoadBasedAutoScalingUpscalingArgs.thresholdsWaitTime' is not present");
    }
