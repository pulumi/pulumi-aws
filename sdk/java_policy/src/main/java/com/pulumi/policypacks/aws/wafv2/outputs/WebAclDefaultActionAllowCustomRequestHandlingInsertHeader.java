...
public final class WebAclDefaultActionAllowCustomRequestHandlingInsertHeader {
    ...
    public String name() {
        ...
        return name.getValue("WebAclDefaultActionAllowCustomRequestHandlingInsertHeader.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclDefaultActionAllowCustomRequestHandlingInsertHeader.value");
    }
