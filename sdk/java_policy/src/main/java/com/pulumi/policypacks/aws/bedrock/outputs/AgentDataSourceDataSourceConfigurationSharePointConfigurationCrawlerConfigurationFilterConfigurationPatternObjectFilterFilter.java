...
public final class AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterFilter {
    ...
    public @Nullable List<String> exclusionFilters() {
        ...
        throw new UndeferrableValueException("Value 'AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterFilter.exclusionFilters' is not present");
    }
    ...
    public @Nullable List<String> inclusionFilters() {
        ...
        throw new UndeferrableValueException("Value 'AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterFilter.inclusionFilters' is not present");
    }
    ...
    public String objectType() {
        ...
        throw new UndeferrableValueException("Value 'AgentDataSourceDataSourceConfigurationSharePointConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterFilter.objectType' is not present");
    }
