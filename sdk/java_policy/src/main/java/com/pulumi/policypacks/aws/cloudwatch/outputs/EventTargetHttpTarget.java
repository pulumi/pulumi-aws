...
public final class EventTargetHttpTarget {
    ...
    public @Nullable Map<String,String> headerParameters() {
        ...
        throw new UndeferrableValueException("Value 'EventTargetHttpTarget.headerParameters' is not present");
    }
    ...
    private @Nullable List<String> value_pathParameterValues;
    ...
    public @Nullable List<String> pathParameterValues() {
        ...
        throw new UndeferrableValueException("Value 'EventTargetHttpTarget.pathParameterValues' is not present");
    }
    ...
    public @Nullable Map<String,String> queryStringParameters() {
        ...
        throw new UndeferrableValueException("Value 'EventTargetHttpTarget.queryStringParameters' is not present");
    }
