...
public final class InsightFiltersNoteUpdatedBy {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNoteUpdatedBy.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersNoteUpdatedBy.value' is not present");
    }
