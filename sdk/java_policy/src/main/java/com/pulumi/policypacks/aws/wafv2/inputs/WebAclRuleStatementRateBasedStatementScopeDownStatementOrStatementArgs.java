...
public final class WebAclRuleStatementRateBasedStatementScopeDownStatementOrStatementArgs {
    ...
    public List<WebAclRuleStatementArgs> statements() {
        ...
        return statements.getValue("WebAclRuleStatementRateBasedStatementScopeDownStatementOrStatementArgs.statements");
    }
