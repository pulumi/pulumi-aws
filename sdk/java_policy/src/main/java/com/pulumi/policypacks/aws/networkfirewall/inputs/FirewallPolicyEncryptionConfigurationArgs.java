...
public final class FirewallPolicyEncryptionConfigurationArgs {
    ...
    public String keyId() {
        ...
        throw new UndeferrableValueException("Value 'FirewallPolicyEncryptionConfigurationArgs.keyId' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'FirewallPolicyEncryptionConfigurationArgs.type' is not present");
    }
