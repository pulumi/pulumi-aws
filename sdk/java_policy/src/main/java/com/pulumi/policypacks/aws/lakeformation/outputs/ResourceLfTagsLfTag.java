...
public final class ResourceLfTagsLfTag {
    ...
    public @Nullable String catalogId() {
        ...
        throw new UndeferrableValueException("Value 'ResourceLfTagsLfTag.catalogId' is not present");
    }
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'ResourceLfTagsLfTag.key' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'ResourceLfTagsLfTag.value' is not present");
    }
