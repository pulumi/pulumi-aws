...
public final class AnomalySubscriptionThresholdExpressionTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("AnomalySubscriptionThresholdExpressionTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("AnomalySubscriptionThresholdExpressionTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("AnomalySubscriptionThresholdExpressionTags.values");
    }
