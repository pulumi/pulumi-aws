...
import com.pulumi.policypacks.aws.wafv2.inputs.RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPatternArgs;
import java.lang.String;
import java.util.List;


public final class RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesArgs {
    ...
    private List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPatternArgs> value_matchPatterns;
    private boolean unknown_matchPatterns;
    public List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPatternArgs> matchPatterns() {
        if (!unknown_matchPatterns) return value_matchPatterns;
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesArgs.matchPatterns' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesArgs.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesArgs.oversizeHandling' is not present");
    }
