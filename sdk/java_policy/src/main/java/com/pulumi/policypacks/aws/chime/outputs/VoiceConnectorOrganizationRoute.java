...
public final class VoiceConnectorOrganizationRoute {
    ...
    public String host() {
        ...
        return host.getValue("VoiceConnectorOrganizationRoute.host");
    }
    ...
    public @Nullable Integer port() {
        ...
        return port.getValue("VoiceConnectorOrganizationRoute.port");
    }
    ...
    public Integer priority() {
        ...
        return priority.getValue("VoiceConnectorOrganizationRoute.priority");
    }
    ...
    public String protocol() {
        ...
        return protocol.getValue("VoiceConnectorOrganizationRoute.protocol");
    }
    ...
    public Integer weight() {
        ...
        return weight.getValue("VoiceConnectorOrganizationRoute.weight");
    }
