...
public final class PipelineTriggerGitConfigurationPullRequestFilePaths {
    ...
    public @Nullable List<String> excludes() {
        ...
        return excludes.getValue("PipelineTriggerGitConfigurationPullRequestFilePaths.excludes");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        return includes.getValue("PipelineTriggerGitConfigurationPullRequestFilePaths.includes");
    }
