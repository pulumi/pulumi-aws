...
public final class UserProfileUserSettingsCanvasAppSettingsModelRegisterSettings {
    ...
    public @Nullable String crossAccountModelRegisterRoleArn() {
        ...
        return crossAccountModelRegisterRoleArn.getValue("UserProfileUserSettingsCanvasAppSettingsModelRegisterSettings.crossAccountModelRegisterRoleArn");
    }
    ...
    public @Nullable String status() {
        ...
        return status.getValue("UserProfileUserSettingsCanvasAppSettingsModelRegisterSettings.status");
    }
