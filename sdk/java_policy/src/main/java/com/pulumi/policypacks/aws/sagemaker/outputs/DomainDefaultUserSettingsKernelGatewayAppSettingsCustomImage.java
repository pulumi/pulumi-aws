...
public final class DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage {
    ...
    public String appImageConfigName() {
        ...
        return appImageConfigName.getValue("DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage.appImageConfigName");
    }
    ...
    public String imageName() {
        ...
        return imageName.getValue("DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage.imageName");
    }
    ...
    public @Nullable Integer imageVersionNumber() {
        ...
        return imageVersionNumber.getValue("DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImage.imageVersionNumber");
    }
