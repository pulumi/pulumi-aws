...
public final class InstanceDesiredStateTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'InstanceDesiredStateTimeouts.create' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'InstanceDesiredStateTimeouts.update' is not present");
    }
