...
public final class ResiliencyPolicyTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ResiliencyPolicyTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ResiliencyPolicyTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ResiliencyPolicyTimeouts.update");
    }
