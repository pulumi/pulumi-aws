...
public final class InsightFiltersFindingProviderFieldsSeverityLabel {
    ...
    public String comparison() {
        ...
        return comparison.getValue("InsightFiltersFindingProviderFieldsSeverityLabel.comparison");
    }
    ...
    public String value() {
        ...
        return value.getValue("InsightFiltersFindingProviderFieldsSeverityLabel.value");
    }
