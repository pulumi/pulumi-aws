...
public final class JavaAppLayerLoadBasedAutoScalingUpscalingArgs {
    ...
    public List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingUpscalingArgs.alarms' is not present");
    }
    ...
    public Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingUpscalingArgs.cpuThreshold' is not present");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingUpscalingArgs.ignoreMetricsTime' is not present");
    }
    ...
    public Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingUpscalingArgs.instanceCount' is not present");
    }
    ...
    public Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingUpscalingArgs.loadThreshold' is not present");
    }
    ...
    public Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingUpscalingArgs.memoryThreshold' is not present");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingUpscalingArgs.thresholdsWaitTime' is not present");
    }
