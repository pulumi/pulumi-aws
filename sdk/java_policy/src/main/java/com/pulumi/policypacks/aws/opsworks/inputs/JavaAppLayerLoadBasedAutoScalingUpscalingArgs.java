...
public final class JavaAppLayerLoadBasedAutoScalingUpscalingArgs {
    ...
    public List<String> alarms() {
        ...
        return alarms.getValue("JavaAppLayerLoadBasedAutoScalingUpscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("JavaAppLayerLoadBasedAutoScalingUpscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("JavaAppLayerLoadBasedAutoScalingUpscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("JavaAppLayerLoadBasedAutoScalingUpscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("JavaAppLayerLoadBasedAutoScalingUpscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("JavaAppLayerLoadBasedAutoScalingUpscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("JavaAppLayerLoadBasedAutoScalingUpscalingArgs.thresholdsWaitTime");
    }
