...
public final class VirtualGatewaySpecListenerTlsCertificateSdsArgs {
    ...
    public String secretName() {
        ...
        return secretName.getValue("VirtualGatewaySpecListenerTlsCertificateSdsArgs.secretName");
    }
