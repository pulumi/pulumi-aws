...
public final class PermissionsTableWithColumns {
    ...
    public @Nullable String catalogId() {
        ...
        return catalogId.getValue("PermissionsTableWithColumns.catalogId");
    }
    ...
    public @Nullable List<String> columnNames() {
        ...
        return columnNames.getValue("PermissionsTableWithColumns.columnNames");
    }
    ...
    public String databaseName() {
        ...
        return databaseName.getValue("PermissionsTableWithColumns.databaseName");
    }
    ...
    public @Nullable List<String> excludedColumnNames() {
        ...
        return excludedColumnNames.getValue("PermissionsTableWithColumns.excludedColumnNames");
    }
    ...
    public String name() {
        ...
        return name.getValue("PermissionsTableWithColumns.name");
    }
    ...
    public @Nullable Boolean wildcard() {
        ...
        return wildcard.getValue("PermissionsTableWithColumns.wildcard");
    }
