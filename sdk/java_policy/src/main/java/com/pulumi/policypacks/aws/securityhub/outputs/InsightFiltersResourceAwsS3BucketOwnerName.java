...
public final class InsightFiltersResourceAwsS3BucketOwnerName {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceAwsS3BucketOwnerName.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceAwsS3BucketOwnerName.value' is not present");
    }
