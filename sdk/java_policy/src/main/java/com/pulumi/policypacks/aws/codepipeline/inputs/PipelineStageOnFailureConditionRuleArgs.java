...
import com.pulumi.policypacks.aws.codepipeline.inputs.PipelineStageOnFailureConditionRuleRuleTypeIdArgs;
...
public final class PipelineStageOnFailureConditionRuleArgs {
    ...
    public List<String> commands() {
        ...
        throw new UndeferrableValueException("Value 'PipelineStageOnFailureConditionRuleArgs.commands' is not present");
    }
    ...
    public Map<String,String> configuration() {
        ...
        throw new UndeferrableValueException("Value 'PipelineStageOnFailureConditionRuleArgs.configuration' is not present");
    }
    ...
    public List<String> inputArtifacts() {
        ...
        throw new UndeferrableValueException("Value 'PipelineStageOnFailureConditionRuleArgs.inputArtifacts' is not present");
    }
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'PipelineStageOnFailureConditionRuleArgs.name' is not present");
    }
    ...
    public String region() {
        ...
        throw new UndeferrableValueException("Value 'PipelineStageOnFailureConditionRuleArgs.region' is not present");
    }
    ...
    public String roleArn() {
        ...
        throw new UndeferrableValueException("Value 'PipelineStageOnFailureConditionRuleArgs.roleArn' is not present");
    }
    ...
    private PipelineStageOnFailureConditionRuleRuleTypeIdArgs value_ruleTypeId;
    private boolean unknown_ruleTypeId;
    public PipelineStageOnFailureConditionRuleRuleTypeIdArgs ruleTypeId() {
        if (!unknown_ruleTypeId) return value_ruleTypeId;
        throw new UndeferrableValueException("Value 'PipelineStageOnFailureConditionRuleArgs.ruleTypeId' is not present");
    }
    ...
    public Integer timeoutInMinutes() {
        ...
        throw new UndeferrableValueException("Value 'PipelineStageOnFailureConditionRuleArgs.timeoutInMinutes' is not present");
    }
