...
public final class DomainAdminContactArgs {
    ...
    public String addressLine1() {
        ...
        return addressLine1.getValue("DomainAdminContactArgs.addressLine1");
    }
    ...
    public String addressLine2() {
        ...
        return addressLine2.getValue("DomainAdminContactArgs.addressLine2");
    }
    ...
    public String city() {
        ...
        return city.getValue("DomainAdminContactArgs.city");
    }
    ...
    public String contactType() {
        ...
        return contactType.getValue("DomainAdminContactArgs.contactType");
    }
    ...
    public String countryCode() {
        ...
        return countryCode.getValue("DomainAdminContactArgs.countryCode");
    }
    ...
    public String email() {
        ...
        return email.getValue("DomainAdminContactArgs.email");
    }
     ...
     * 
     */
    private UndeferrableValue<List<DomainAdminContactExtraParamArgs>> extraParams;

    public List<DomainAdminContactExtraParamArgs> extraParams() {
        if (extraParams == null) return null;
        return extraParams.getValue("DomainAdminContactArgs.extraParams");
    }
    ...
    public String fax() {
        ...
        return fax.getValue("DomainAdminContactArgs.fax");
    }
    ...
    public String firstName() {
        ...
        return firstName.getValue("DomainAdminContactArgs.firstName");
    }
    ...
    public String lastName() {
        ...
        return lastName.getValue("DomainAdminContactArgs.lastName");
    }
    ...
    public String organizationName() {
        ...
        return organizationName.getValue("DomainAdminContactArgs.organizationName");
    }
    ...
    public String phoneNumber() {
        ...
        return phoneNumber.getValue("DomainAdminContactArgs.phoneNumber");
    }
    ...
    public String state() {
        ...
        return state.getValue("DomainAdminContactArgs.state");
    }
    ...
    public String zipCode() {
        ...
        return zipCode.getValue("DomainAdminContactArgs.zipCode");
    }
