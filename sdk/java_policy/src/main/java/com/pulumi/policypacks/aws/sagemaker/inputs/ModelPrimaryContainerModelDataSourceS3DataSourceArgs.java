...
public final class ModelPrimaryContainerModelDataSourceS3DataSourceArgs {
    ...
    public String compressionType() {
        ...
        throw new UndeferrableValueException("Value 'ModelPrimaryContainerModelDataSourceS3DataSourceArgs.compressionType' is not present");
    }
    ...
    private ModelPrimaryContainerModelDataSourceS3DataSourceModelAccessConfigArgs value_modelAccessConfig;
    ...
    public ModelPrimaryContainerModelDataSourceS3DataSourceModelAccessConfigArgs modelAccessConfig() {
        ...
        throw new UndeferrableValueException("Value 'ModelPrimaryContainerModelDataSourceS3DataSourceArgs.modelAccessConfig' is not present");
    }
    ...
    public String s3DataType() {
        ...
        throw new UndeferrableValueException("Value 'ModelPrimaryContainerModelDataSourceS3DataSourceArgs.s3DataType' is not present");
    }
    ...
    public String s3Uri() {
        ...
        throw new UndeferrableValueException("Value 'ModelPrimaryContainerModelDataSourceS3DataSourceArgs.s3Uri' is not present");
    }
