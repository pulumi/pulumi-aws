...
public final class RiskConfigurationAccountTakeoverRiskConfigurationActionsHighActionArgs {
    ...
    public String eventAction() {
        ...
        throw new UndeferrableValueException("Value 'RiskConfigurationAccountTakeoverRiskConfigurationActionsHighActionArgs.eventAction' is not present");
    }
    ...
    public Boolean notify_() {
        ...
        throw new UndeferrableValueException("Value 'RiskConfigurationAccountTakeoverRiskConfigurationActionsHighActionArgs.notify_' is not present");
    }
