...
public final class InsightFiltersProductName {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProductName.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersProductName.value' is not present");
    }
