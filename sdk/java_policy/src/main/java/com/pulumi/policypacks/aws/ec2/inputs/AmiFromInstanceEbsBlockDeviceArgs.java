...
public final class AmiFromInstanceEbsBlockDeviceArgs {
    ...
    public Boolean deleteOnTermination() {
        ...
        throw new UndeferrableValueException("Value 'AmiFromInstanceEbsBlockDeviceArgs.deleteOnTermination' is not present");
    }
    ...
    public String deviceName() {
        ...
        throw new UndeferrableValueException("Value 'AmiFromInstanceEbsBlockDeviceArgs.deviceName' is not present");
    }
    ...
    public Boolean encrypted() {
        ...
        throw new UndeferrableValueException("Value 'AmiFromInstanceEbsBlockDeviceArgs.encrypted' is not present");
    }
    ...
    public Integer iops() {
        ...
        throw new UndeferrableValueException("Value 'AmiFromInstanceEbsBlockDeviceArgs.iops' is not present");
    }
    ...
    public String outpostArn() {
        ...
        throw new UndeferrableValueException("Value 'AmiFromInstanceEbsBlockDeviceArgs.outpostArn' is not present");
    }
    ...
    public String snapshotId() {
        ...
        throw new UndeferrableValueException("Value 'AmiFromInstanceEbsBlockDeviceArgs.snapshotId' is not present");
    }
    ...
    public Integer throughput() {
        ...
        throw new UndeferrableValueException("Value 'AmiFromInstanceEbsBlockDeviceArgs.throughput' is not present");
    }
    ...
    public Integer volumeSize() {
        ...
        throw new UndeferrableValueException("Value 'AmiFromInstanceEbsBlockDeviceArgs.volumeSize' is not present");
    }
    ...
    public String volumeType() {
        ...
        throw new UndeferrableValueException("Value 'AmiFromInstanceEbsBlockDeviceArgs.volumeType' is not present");
    }
