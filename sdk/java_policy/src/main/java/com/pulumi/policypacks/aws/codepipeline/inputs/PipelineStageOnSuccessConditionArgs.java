...
public final class PipelineStageOnSuccessConditionArgs {
    ...
    public String result() {
        ...
        throw new UndeferrableValueException("Value 'PipelineStageOnSuccessConditionArgs.result' is not present");
    }
    ...
    private List<PipelineStageOnSuccessConditionRuleArgs> value_rules;
    ...
    public List<PipelineStageOnSuccessConditionRuleArgs> rules() {
        ...
        throw new UndeferrableValueException("Value 'PipelineStageOnSuccessConditionArgs.rules' is not present");
    }
