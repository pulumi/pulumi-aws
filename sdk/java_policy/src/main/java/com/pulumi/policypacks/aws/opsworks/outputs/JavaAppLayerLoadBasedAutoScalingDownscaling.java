...
public final class JavaAppLayerLoadBasedAutoScalingDownscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("JavaAppLayerLoadBasedAutoScalingDownscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("JavaAppLayerLoadBasedAutoScalingDownscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("JavaAppLayerLoadBasedAutoScalingDownscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("JavaAppLayerLoadBasedAutoScalingDownscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("JavaAppLayerLoadBasedAutoScalingDownscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("JavaAppLayerLoadBasedAutoScalingDownscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("JavaAppLayerLoadBasedAutoScalingDownscaling.thresholdsWaitTime");
    }
