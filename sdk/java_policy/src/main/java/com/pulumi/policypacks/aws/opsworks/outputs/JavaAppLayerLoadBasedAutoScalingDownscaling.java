...
public final class JavaAppLayerLoadBasedAutoScalingDownscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingDownscaling.alarms' is not present");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingDownscaling.cpuThreshold' is not present");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingDownscaling.ignoreMetricsTime' is not present");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingDownscaling.instanceCount' is not present");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingDownscaling.loadThreshold' is not present");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingDownscaling.memoryThreshold' is not present");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'JavaAppLayerLoadBasedAutoScalingDownscaling.thresholdsWaitTime' is not present");
    }
