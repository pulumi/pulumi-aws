...
public final class AnomalySubscriptionThresholdExpressionNotDimension {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("AnomalySubscriptionThresholdExpressionNotDimension.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("AnomalySubscriptionThresholdExpressionNotDimension.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("AnomalySubscriptionThresholdExpressionNotDimension.values");
    }
