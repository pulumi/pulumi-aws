...
public final class AnomalySubscriptionThresholdExpressionNotDimension {
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionNotDimension.key' is not present");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionNotDimension.matchOptions' is not present");
    }
    ...
    public @Nullable List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionNotDimension.values' is not present");
    }
