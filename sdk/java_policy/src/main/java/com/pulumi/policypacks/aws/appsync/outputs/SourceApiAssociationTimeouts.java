...
public final class SourceApiAssociationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("SourceApiAssociationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("SourceApiAssociationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("SourceApiAssociationTimeouts.update");
    }
