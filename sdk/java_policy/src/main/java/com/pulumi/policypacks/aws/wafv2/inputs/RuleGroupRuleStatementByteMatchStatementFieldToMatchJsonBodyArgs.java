...
import com.pulumi.policypacks.aws.wafv2.inputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs;
import java.lang.String;
import javax.annotation.Nullable;


public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs {
    ...
    public String invalidFallbackBehavior() {
        ...
        return invalidFallbackBehavior.getValue("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs.invalidFallbackBehavior");
    }
     ...
     * 
     */
    private UndeferrableValue<RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;

    public RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern() {
        if (matchPattern == null) return null;
        return matchPattern.getValue("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs.matchPattern");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs.matchScope");
    }
    ...
    public String oversizeHandling() {
        ...
        return oversizeHandling.getValue("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyArgs.oversizeHandling");
    }
