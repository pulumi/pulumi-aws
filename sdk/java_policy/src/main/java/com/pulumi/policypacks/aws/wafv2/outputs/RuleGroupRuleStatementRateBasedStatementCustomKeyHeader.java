...
import com.pulumi.policypacks.aws.wafv2.outputs.RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation;
...
public final class RuleGroupRuleStatementRateBasedStatementCustomKeyHeader {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementCustomKeyHeader.name' is not present");
    }
    ...
    private List<RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation> value_textTransformations;
    ...
    public List<RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation> textTransformations() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementCustomKeyHeader.textTransformations' is not present");
    }
