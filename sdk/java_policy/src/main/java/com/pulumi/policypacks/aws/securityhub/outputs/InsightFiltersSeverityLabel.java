...
public final class InsightFiltersSeverityLabel {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersSeverityLabel.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersSeverityLabel.value' is not present");
    }
