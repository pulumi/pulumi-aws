...
public final class PipeTargetParametersHttpParameters {
    ...
    public @Nullable Map<String,String> headerParameters() {
        ...
        return headerParameters.getValue("PipeTargetParametersHttpParameters.headerParameters");
    }
    ...
    public @Nullable String pathParameterValues() {
        ...
        return pathParameterValues.getValue("PipeTargetParametersHttpParameters.pathParameterValues");
    }
    ...
    public @Nullable Map<String,String> queryStringParameters() {
        ...
        return queryStringParameters.getValue("PipeTargetParametersHttpParameters.queryStringParameters");
    }
