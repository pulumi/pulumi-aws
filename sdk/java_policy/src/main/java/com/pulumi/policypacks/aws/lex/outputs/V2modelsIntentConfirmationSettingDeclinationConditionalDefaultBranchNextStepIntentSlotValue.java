...
public final class V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepIntentSlotValue {
    ...
    public @Nullable String interpretedValue() {
        ...
        return interpretedValue.getValue("V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepIntentSlotValue.interpretedValue");
    }
