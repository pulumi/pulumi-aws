...
public final class WebAclRuleActionChallengeCustomRequestHandlingInsertHeader {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionChallengeCustomRequestHandlingInsertHeader.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionChallengeCustomRequestHandlingInsertHeader.value' is not present");
    }
