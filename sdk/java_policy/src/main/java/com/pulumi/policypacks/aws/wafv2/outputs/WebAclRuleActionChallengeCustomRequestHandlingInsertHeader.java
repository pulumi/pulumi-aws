...
public final class WebAclRuleActionChallengeCustomRequestHandlingInsertHeader {
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleActionChallengeCustomRequestHandlingInsertHeader.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclRuleActionChallengeCustomRequestHandlingInsertHeader.value");
    }
