...
public final class CostCategoryRuleRuleAndOrTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleAndOrTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleAndOrTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleAndOrTags.values");
    }
