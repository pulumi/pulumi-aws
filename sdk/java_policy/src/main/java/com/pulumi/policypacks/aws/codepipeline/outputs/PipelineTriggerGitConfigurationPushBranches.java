...
public final class PipelineTriggerGitConfigurationPushBranches {
    ...
    public @Nullable List<String> excludes() {
        ...
        throw new UndeferrableValueException("Value 'PipelineTriggerGitConfigurationPushBranches.excludes' is not present");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        throw new UndeferrableValueException("Value 'PipelineTriggerGitConfigurationPushBranches.includes' is not present");
    }
