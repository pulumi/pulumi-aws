...
public final class PipelineTriggerGitConfigurationPushBranches {
    ...
    public @Nullable List<String> excludes() {
        ...
        return excludes.getValue("PipelineTriggerGitConfigurationPushBranches.excludes");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        return includes.getValue("PipelineTriggerGitConfigurationPushBranches.includes");
    }
