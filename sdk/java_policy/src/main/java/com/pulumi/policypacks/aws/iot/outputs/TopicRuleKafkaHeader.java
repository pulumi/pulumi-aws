...
public final class TopicRuleKafkaHeader {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'TopicRuleKafkaHeader.key' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'TopicRuleKafkaHeader.value' is not present");
    }
