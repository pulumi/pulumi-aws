...
public final class DomainClusterConfig {
     ...
     * 
     */
    private @Nullable UndeferrableValue<Boolean> multiAzWithStandbyEnabled;

    public @Nullable Boolean multiAzWithStandbyEnabled() {
        if (multiAzWithStandbyEnabled == null) return null;
        return multiAzWithStandbyEnabled.getValue("DomainClusterConfig.multiAzWithStandbyEnabled");
    }
     ...
     * 
     */
    private @Nullable UndeferrableValue<List<DomainClusterConfigNodeOption>> nodeOptions;

    public @Nullable List<DomainClusterConfigNodeOption> nodeOptions() {
        if (nodeOptions == null) return null;
        return nodeOptions.getValue("DomainClusterConfig.nodeOptions");
    }
