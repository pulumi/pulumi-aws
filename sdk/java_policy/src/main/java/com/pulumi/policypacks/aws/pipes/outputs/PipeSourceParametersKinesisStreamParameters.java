...
public final class PipeSourceParametersKinesisStreamParameters {
    ...
    public @Nullable Integer batchSize() {
        ...
        return batchSize.getValue("PipeSourceParametersKinesisStreamParameters.batchSize");
    }
     ...
     * 
     */
    private @Nullable UndeferrableValue<PipeSourceParametersKinesisStreamParametersDeadLetterConfig> deadLetterConfig;
    ...
    public @Nullable PipeSourceParametersKinesisStreamParametersDeadLetterConfig deadLetterConfig() {
        ...
        return deadLetterConfig.getValue("PipeSourceParametersKinesisStreamParameters.deadLetterConfig");
    }
    ...
    public @Nullable Integer maximumBatchingWindowInSeconds() {
        ...
        return maximumBatchingWindowInSeconds.getValue("PipeSourceParametersKinesisStreamParameters.maximumBatchingWindowInSeconds");
    }
    ...
    public @Nullable Integer maximumRecordAgeInSeconds() {
        ...
        return maximumRecordAgeInSeconds.getValue("PipeSourceParametersKinesisStreamParameters.maximumRecordAgeInSeconds");
    }
    ...
    public @Nullable Integer maximumRetryAttempts() {
        ...
        return maximumRetryAttempts.getValue("PipeSourceParametersKinesisStreamParameters.maximumRetryAttempts");
    }
    ...
    public @Nullable String onPartialBatchItemFailure() {
        ...
        return onPartialBatchItemFailure.getValue("PipeSourceParametersKinesisStreamParameters.onPartialBatchItemFailure");
    }
    ...
    public @Nullable Integer parallelizationFactor() {
        ...
        return parallelizationFactor.getValue("PipeSourceParametersKinesisStreamParameters.parallelizationFactor");
    }
    ...
    public String startingPosition() {
        ...
        return startingPosition.getValue("PipeSourceParametersKinesisStreamParameters.startingPosition");
    }
    ...
    public @Nullable String startingPositionTimestamp() {
        ...
        return startingPositionTimestamp.getValue("PipeSourceParametersKinesisStreamParameters.startingPositionTimestamp");
    }
