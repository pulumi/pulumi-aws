...
import com.pulumi.policypacks.aws.pipes.outputs.PipeSourceParametersKinesisStreamParametersDeadLetterConfig;
...
public final class PipeSourceParametersKinesisStreamParameters {
    ...
    public @Nullable Integer batchSize() {
        ...
        throw new UndeferrableValueException("Value 'PipeSourceParametersKinesisStreamParameters.batchSize' is not present");
    }
    ...
    private @Nullable PipeSourceParametersKinesisStreamParametersDeadLetterConfig value_deadLetterConfig;
    private boolean unknown_deadLetterConfig;
    public @Nullable PipeSourceParametersKinesisStreamParametersDeadLetterConfig deadLetterConfig() {
        if (!unknown_deadLetterConfig) return value_deadLetterConfig;
        throw new UndeferrableValueException("Value 'PipeSourceParametersKinesisStreamParameters.deadLetterConfig' is not present");
    }
    ...
    public @Nullable Integer maximumBatchingWindowInSeconds() {
        ...
        throw new UndeferrableValueException("Value 'PipeSourceParametersKinesisStreamParameters.maximumBatchingWindowInSeconds' is not present");
    }
    ...
    public @Nullable Integer maximumRecordAgeInSeconds() {
        ...
        throw new UndeferrableValueException("Value 'PipeSourceParametersKinesisStreamParameters.maximumRecordAgeInSeconds' is not present");
    }
    ...
    public @Nullable Integer maximumRetryAttempts() {
        ...
        throw new UndeferrableValueException("Value 'PipeSourceParametersKinesisStreamParameters.maximumRetryAttempts' is not present");
    }
    ...
    public @Nullable String onPartialBatchItemFailure() {
        ...
        throw new UndeferrableValueException("Value 'PipeSourceParametersKinesisStreamParameters.onPartialBatchItemFailure' is not present");
    }
    ...
    public @Nullable Integer parallelizationFactor() {
        ...
        throw new UndeferrableValueException("Value 'PipeSourceParametersKinesisStreamParameters.parallelizationFactor' is not present");
    }
    ...
    public String startingPosition() {
        ...
        throw new UndeferrableValueException("Value 'PipeSourceParametersKinesisStreamParameters.startingPosition' is not present");
    }
    ...
    public @Nullable String startingPositionTimestamp() {
        ...
        throw new UndeferrableValueException("Value 'PipeSourceParametersKinesisStreamParameters.startingPositionTimestamp' is not present");
    }
