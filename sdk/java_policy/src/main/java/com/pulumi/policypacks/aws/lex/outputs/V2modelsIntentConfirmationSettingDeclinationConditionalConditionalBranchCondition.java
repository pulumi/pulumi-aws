...
public final class V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchCondition {
    ...
    public String expressionString() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchCondition.expressionString' is not present");
    }
