...
public final class StaticWebLayerLoadBasedAutoScalingUpscalingArgs {
    ...
    public List<String> alarms() {
        ...
        return alarms.getValue("StaticWebLayerLoadBasedAutoScalingUpscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("StaticWebLayerLoadBasedAutoScalingUpscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("StaticWebLayerLoadBasedAutoScalingUpscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("StaticWebLayerLoadBasedAutoScalingUpscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("StaticWebLayerLoadBasedAutoScalingUpscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("StaticWebLayerLoadBasedAutoScalingUpscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("StaticWebLayerLoadBasedAutoScalingUpscalingArgs.thresholdsWaitTime");
    }
