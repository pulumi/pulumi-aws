...
public final class NetworkInsightsAnalysisExplanationNatGateway {
    ...
    public @Nullable String arn() {
        ...
        return arn.getValue("NetworkInsightsAnalysisExplanationNatGateway.arn");
    }
    ...
    public @Nullable String id() {
        ...
        return id.getValue("NetworkInsightsAnalysisExplanationNatGateway.id");
    }
    ...
    public @Nullable String name() {
        ...
        return name.getValue("NetworkInsightsAnalysisExplanationNatGateway.name");
    }
