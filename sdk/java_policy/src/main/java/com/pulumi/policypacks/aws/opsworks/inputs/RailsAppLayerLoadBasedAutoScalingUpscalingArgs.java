...
public final class RailsAppLayerLoadBasedAutoScalingUpscalingArgs {
    ...
    public List<String> alarms() {
        ...
        return alarms.getValue("RailsAppLayerLoadBasedAutoScalingUpscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("RailsAppLayerLoadBasedAutoScalingUpscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("RailsAppLayerLoadBasedAutoScalingUpscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("RailsAppLayerLoadBasedAutoScalingUpscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("RailsAppLayerLoadBasedAutoScalingUpscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("RailsAppLayerLoadBasedAutoScalingUpscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("RailsAppLayerLoadBasedAutoScalingUpscalingArgs.thresholdsWaitTime");
    }
