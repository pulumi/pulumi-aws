...
public final class ClusterMasterInstanceGroupEbsConfig {
    ...
    public @Nullable Integer iops() {
        ...
        return iops.getValue("ClusterMasterInstanceGroupEbsConfig.iops");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("ClusterMasterInstanceGroupEbsConfig.size");
    }
    ...
    public @Nullable Integer throughput() {
        ...
        return throughput.getValue("ClusterMasterInstanceGroupEbsConfig.throughput");
    }
    ...
    public String type() {
        ...
        return type.getValue("ClusterMasterInstanceGroupEbsConfig.type");
    }
    ...
    public @Nullable Integer volumesPerInstance() {
        ...
        return volumesPerInstance.getValue("ClusterMasterInstanceGroupEbsConfig.volumesPerInstance");
    }
