...
public final class PipelineTriggerGitConfigurationPushFilePathsArgs {
    ...
    public List<String> excludes() {
        ...
        return excludes.getValue("PipelineTriggerGitConfigurationPushFilePathsArgs.excludes");
    }
    ...
    public List<String> includes() {
        ...
        return includes.getValue("PipelineTriggerGitConfigurationPushFilePathsArgs.includes");
    }
