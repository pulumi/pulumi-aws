...
public final class LaunchTemplateInstanceRequirementsAcceleratorCount {
    ...
    public @Nullable Integer max() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsAcceleratorCount.max' is not present");
    }
    ...
    public @Nullable Integer min() {
        ...
        throw new UndeferrableValueException("Value 'LaunchTemplateInstanceRequirementsAcceleratorCount.min' is not present");
    }
