...
public final class WebAclRuleActionAllowCustomRequestHandlingInsertHeaderArgs {
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleActionAllowCustomRequestHandlingInsertHeaderArgs.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclRuleActionAllowCustomRequestHandlingInsertHeaderArgs.value");
    }
