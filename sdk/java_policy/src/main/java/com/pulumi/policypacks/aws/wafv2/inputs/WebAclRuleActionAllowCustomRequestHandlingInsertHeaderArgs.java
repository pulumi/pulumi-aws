...
public final class WebAclRuleActionAllowCustomRequestHandlingInsertHeaderArgs {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionAllowCustomRequestHandlingInsertHeaderArgs.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionAllowCustomRequestHandlingInsertHeaderArgs.value' is not present");
    }
