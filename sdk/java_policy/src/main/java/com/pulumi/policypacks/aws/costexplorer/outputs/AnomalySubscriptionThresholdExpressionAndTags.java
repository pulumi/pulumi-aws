...
public final class AnomalySubscriptionThresholdExpressionAndTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("AnomalySubscriptionThresholdExpressionAndTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("AnomalySubscriptionThresholdExpressionAndTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("AnomalySubscriptionThresholdExpressionAndTags.values");
    }
