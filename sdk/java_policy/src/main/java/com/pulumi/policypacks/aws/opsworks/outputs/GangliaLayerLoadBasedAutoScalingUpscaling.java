...
public final class GangliaLayerLoadBasedAutoScalingUpscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingUpscaling.alarms' is not present");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingUpscaling.cpuThreshold' is not present");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingUpscaling.ignoreMetricsTime' is not present");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingUpscaling.instanceCount' is not present");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingUpscaling.loadThreshold' is not present");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingUpscaling.memoryThreshold' is not present");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'GangliaLayerLoadBasedAutoScalingUpscaling.thresholdsWaitTime' is not present");
    }
