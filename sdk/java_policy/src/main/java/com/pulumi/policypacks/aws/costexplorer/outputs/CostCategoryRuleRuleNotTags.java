...
public final class CostCategoryRuleRuleNotTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleNotTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleNotTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleNotTags.values");
    }
