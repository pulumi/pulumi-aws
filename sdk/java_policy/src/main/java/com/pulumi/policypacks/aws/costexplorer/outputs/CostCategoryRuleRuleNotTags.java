...
public final class CostCategoryRuleRuleNotTags {
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleNotTags.key' is not present");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleNotTags.matchOptions' is not present");
    }
    ...
    public @Nullable List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleNotTags.values' is not present");
    }
