...
import com.pulumi.policypacks.aws.wafv2.inputs.WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPatternArgs;
import java.lang.String;
import javax.annotation.Nullable;


public final class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyArgs {
    ...
    public String invalidFallbackBehavior() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyArgs.invalidFallbackBehavior' is not present");
    }
    ...
    private WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPatternArgs value_matchPattern;
    private boolean unknown_matchPattern;
    public WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern() {
        if (!unknown_matchPattern) return value_matchPattern;
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyArgs.matchPattern' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyArgs.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyArgs.oversizeHandling' is not present");
    }
