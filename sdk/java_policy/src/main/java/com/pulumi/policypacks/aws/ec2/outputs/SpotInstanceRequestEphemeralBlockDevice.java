...
public final class SpotInstanceRequestEphemeralBlockDevice {
    ...
    public String deviceName() {
        ...
        return deviceName.getValue("SpotInstanceRequestEphemeralBlockDevice.deviceName");
    }
    ...
    public @Nullable Boolean noDevice() {
        ...
        return noDevice.getValue("SpotInstanceRequestEphemeralBlockDevice.noDevice");
    }
    ...
    public @Nullable String virtualName() {
        ...
        return virtualName.getValue("SpotInstanceRequestEphemeralBlockDevice.virtualName");
    }
