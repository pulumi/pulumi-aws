...
public final class BucketV2LifecycleRuleTransition {
    ...
    public @Nullable String date() {
        ...
        throw new UndeferrableValueException("Value 'BucketV2LifecycleRuleTransition.date' is not present");
    }
    ...
    public @Nullable Integer days() {
        ...
        throw new UndeferrableValueException("Value 'BucketV2LifecycleRuleTransition.days' is not present");
    }
    ...
    public String storageClass() {
        ...
        throw new UndeferrableValueException("Value 'BucketV2LifecycleRuleTransition.storageClass' is not present");
    }
