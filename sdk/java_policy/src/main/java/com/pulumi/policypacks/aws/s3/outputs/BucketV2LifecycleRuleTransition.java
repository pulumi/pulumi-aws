...
public final class BucketV2LifecycleRuleTransition {
    ...
    public @Nullable String date() {
        ...
        return date.getValue("BucketV2LifecycleRuleTransition.date");
    }
    ...
    public @Nullable Integer days() {
        ...
        return days.getValue("BucketV2LifecycleRuleTransition.days");
    }
    ...
    public String storageClass() {
        ...
        return storageClass.getValue("BucketV2LifecycleRuleTransition.storageClass");
    }
