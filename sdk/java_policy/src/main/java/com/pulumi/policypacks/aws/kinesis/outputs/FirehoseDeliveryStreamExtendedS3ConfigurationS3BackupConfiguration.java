...
import com.pulumi.policypacks.aws.kinesis.outputs.FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfigurationCloudwatchLoggingOptions;
...
public final class FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration {
    ...
    public String bucketArn() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.bucketArn' is not present");
    }
    ...
    public @Nullable Integer bufferingInterval() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.bufferingInterval' is not present");
    }
    ...
    public @Nullable Integer bufferingSize() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.bufferingSize' is not present");
    }

    @PolicyResourceProperty(name="cloudwatchLoggingOptions", flag="unknown_cloudwatchLoggingOptions")
    private @Nullable FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfigurationCloudwatchLoggingOptions value_cloudwatchLoggingOptions;
    private boolean unknown_cloudwatchLoggingOptions;
    public @Nullable FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfigurationCloudwatchLoggingOptions cloudwatchLoggingOptions() {
        if (!unknown_cloudwatchLoggingOptions) return value_cloudwatchLoggingOptions;
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.cloudwatchLoggingOptions' is not present");
    }
    ...
    public @Nullable String compressionFormat() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.compressionFormat' is not present");
    }
    ...
    public @Nullable String errorOutputPrefix() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.errorOutputPrefix' is not present");
    }
    ...
    public @Nullable String kmsKeyArn() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.kmsKeyArn' is not present");
    }
    ...
    public @Nullable String prefix() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.prefix' is not present");
    }
    ...
    public String roleArn() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationS3BackupConfiguration.roleArn' is not present");
    }
