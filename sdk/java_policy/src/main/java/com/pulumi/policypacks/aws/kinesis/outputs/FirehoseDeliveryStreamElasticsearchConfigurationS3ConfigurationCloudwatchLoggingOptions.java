...
public final class FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions {
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions.enabled' is not present");
    }
    ...
    public @Nullable String logGroupName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions.logGroupName' is not present");
    }
    ...
    public @Nullable String logStreamName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions.logStreamName' is not present");
    }
