...
public final class FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions {
    ...
    public @Nullable Boolean enabled() {
        ...
        return enabled.getValue("FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions.enabled");
    }
    ...
    public @Nullable String logGroupName() {
        ...
        return logGroupName.getValue("FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions.logGroupName");
    }
    ...
    public @Nullable String logStreamName() {
        ...
        return logStreamName.getValue("FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationCloudwatchLoggingOptions.logStreamName");
    }
