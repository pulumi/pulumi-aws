...
public final class NodejsAppLayer extends com.pulumi.resources.PolicyResourceOutput {
    ...
    private @Nullable NodejsAppLayerCloudwatchConfiguration value_cloudwatchConfiguration;
    ...
    private List<NodejsAppLayerEbsVolume> value_ebsVolumes;
    ...
    private NodejsAppLayerLoadBasedAutoScaling value_loadBasedAutoScaling;
    ...
    private @Nullable String value_nodejsVersion;
