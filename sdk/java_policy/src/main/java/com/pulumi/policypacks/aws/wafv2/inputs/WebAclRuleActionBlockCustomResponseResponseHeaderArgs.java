...
public final class WebAclRuleActionBlockCustomResponseResponseHeaderArgs {
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleActionBlockCustomResponseResponseHeaderArgs.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclRuleActionBlockCustomResponseResponseHeaderArgs.value");
    }
