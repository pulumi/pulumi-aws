...
public final class WebAclRuleActionBlockCustomResponseResponseHeaderArgs {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionBlockCustomResponseResponseHeaderArgs.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionBlockCustomResponseResponseHeaderArgs.value' is not present");
    }
