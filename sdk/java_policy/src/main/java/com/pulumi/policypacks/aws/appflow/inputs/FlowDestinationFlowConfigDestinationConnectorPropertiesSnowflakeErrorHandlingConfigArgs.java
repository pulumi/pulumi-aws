...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesSnowflakeErrorHandlingConfigArgs {
    ...
    public String bucketName() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesSnowflakeErrorHandlingConfigArgs.bucketName' is not present");
    }
    ...
    public String bucketPrefix() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesSnowflakeErrorHandlingConfigArgs.bucketPrefix' is not present");
    }
    ...
    public Boolean failOnFirstDestinationError() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesSnowflakeErrorHandlingConfigArgs.failOnFirstDestinationError' is not present");
    }
