...
public final class EipDomainNameTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("EipDomainNameTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("EipDomainNameTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("EipDomainNameTimeouts.update");
    }
