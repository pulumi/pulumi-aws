...
public final class PipelineStageOnSuccessCondition {
    ...
    public @Nullable String result() {
        ...
        return result.getValue("PipelineStageOnSuccessCondition.result");
    }
     ...
     * 
     */
    private UndeferrableValue<List<PipelineStageOnSuccessConditionRule>> rules;

    public List<PipelineStageOnSuccessConditionRule> rules() {
        if (rules == null) return null;
        return rules.getValue("PipelineStageOnSuccessCondition.rules");
    }
