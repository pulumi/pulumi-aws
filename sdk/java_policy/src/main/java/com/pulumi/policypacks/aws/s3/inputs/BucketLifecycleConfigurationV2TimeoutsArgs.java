...
public final class BucketLifecycleConfigurationV2TimeoutsArgs {
    ...
    public String create() {
        ...
        throw new UndeferrableValueException("Value 'BucketLifecycleConfigurationV2TimeoutsArgs.create' is not present");
    }
    ...
    public String update() {
        ...
        throw new UndeferrableValueException("Value 'BucketLifecycleConfigurationV2TimeoutsArgs.update' is not present");
    }
