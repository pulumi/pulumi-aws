...
public final class CustomerManagedPolicyAttachmentCustomerManagedPolicyReferenceArgs {
    ...
    public String name() {
        ...
        return name.getValue("CustomerManagedPolicyAttachmentCustomerManagedPolicyReferenceArgs.name");
    }
    ...
    public String path() {
        ...
        return path.getValue("CustomerManagedPolicyAttachmentCustomerManagedPolicyReferenceArgs.path");
    }
