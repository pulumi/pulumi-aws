...
import com.pulumi.policypacks.aws.wafv2.outputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern;
import java.lang.String;
import java.util.List;


public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies {
    ...
    private List<RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern> value_matchPatterns;
    ...
    public List<RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies.matchPatterns' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies.oversizeHandling' is not present");
    }
