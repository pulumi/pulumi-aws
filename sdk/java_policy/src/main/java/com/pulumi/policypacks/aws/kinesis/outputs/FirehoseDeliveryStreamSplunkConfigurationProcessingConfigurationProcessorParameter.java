...
public final class FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter {
    ...
    public String parameterName() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter.parameterName' is not present");
    }
    ...
    public String parameterValue() {
        ...
        throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter.parameterValue' is not present");
    }
