...
public final class ModelContainerModelDataSourceS3DataSource {
    ...
    public String compressionType() {
        ...
        throw new UndeferrableValueException("Value 'ModelContainerModelDataSourceS3DataSource.compressionType' is not present");
    }
    ...
    private @Nullable ModelContainerModelDataSourceS3DataSourceModelAccessConfig value_modelAccessConfig;
    ...
    public @Nullable ModelContainerModelDataSourceS3DataSourceModelAccessConfig modelAccessConfig() {
        ...
        throw new UndeferrableValueException("Value 'ModelContainerModelDataSourceS3DataSource.modelAccessConfig' is not present");
    }
    ...
    public String s3DataType() {
        ...
        throw new UndeferrableValueException("Value 'ModelContainerModelDataSourceS3DataSource.s3DataType' is not present");
    }
    ...
    public String s3Uri() {
        ...
        throw new UndeferrableValueException("Value 'ModelContainerModelDataSourceS3DataSource.s3Uri' is not present");
    }
