...
import com.pulumi.policypacks.aws.codepipeline.inputs.PipelineStageOnSuccessConditionRuleRuleTypeIdArgs;
...
public final class PipelineStageOnSuccessConditionRuleArgs {
    ...
    public List<String> commands() {
        ...
        return commands.getValue("PipelineStageOnSuccessConditionRuleArgs.commands");
    }
    ...
    public Map<String,String> configuration() {
        ...
        return configuration.getValue("PipelineStageOnSuccessConditionRuleArgs.configuration");
    }
    ...
    public List<String> inputArtifacts() {
        ...
        return inputArtifacts.getValue("PipelineStageOnSuccessConditionRuleArgs.inputArtifacts");
    }
    ...
    public String name() {
        ...
        return name.getValue("PipelineStageOnSuccessConditionRuleArgs.name");
    }
    ...
    public String region() {
        ...
        return region.getValue("PipelineStageOnSuccessConditionRuleArgs.region");
    }
    ...
    public String roleArn() {
        ...
        return roleArn.getValue("PipelineStageOnSuccessConditionRuleArgs.roleArn");
    }
     ...
     * 
     */
    private UndeferrableValue<PipelineStageOnSuccessConditionRuleRuleTypeIdArgs> ruleTypeId;

    public PipelineStageOnSuccessConditionRuleRuleTypeIdArgs ruleTypeId() {
        if (ruleTypeId == null) return null;
        return ruleTypeId.getValue("PipelineStageOnSuccessConditionRuleArgs.ruleTypeId");
    }
    ...
    public Integer timeoutInMinutes() {
        ...
        return timeoutInMinutes.getValue("PipelineStageOnSuccessConditionRuleArgs.timeoutInMinutes");
    }
