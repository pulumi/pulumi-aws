...
public final class HaproxyLayerLoadBasedAutoScalingDownscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("HaproxyLayerLoadBasedAutoScalingDownscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("HaproxyLayerLoadBasedAutoScalingDownscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("HaproxyLayerLoadBasedAutoScalingDownscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("HaproxyLayerLoadBasedAutoScalingDownscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("HaproxyLayerLoadBasedAutoScalingDownscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("HaproxyLayerLoadBasedAutoScalingDownscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("HaproxyLayerLoadBasedAutoScalingDownscaling.thresholdsWaitTime");
    }
