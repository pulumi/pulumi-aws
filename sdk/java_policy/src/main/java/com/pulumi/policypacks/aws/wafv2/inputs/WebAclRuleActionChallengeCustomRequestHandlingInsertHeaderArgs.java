...
public final class WebAclRuleActionChallengeCustomRequestHandlingInsertHeaderArgs {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionChallengeCustomRequestHandlingInsertHeaderArgs.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionChallengeCustomRequestHandlingInsertHeaderArgs.value' is not present");
    }
