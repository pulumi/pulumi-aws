...
public final class WebAclRuleActionChallengeCustomRequestHandlingInsertHeaderArgs {
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleActionChallengeCustomRequestHandlingInsertHeaderArgs.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclRuleActionChallengeCustomRequestHandlingInsertHeaderArgs.value");
    }
