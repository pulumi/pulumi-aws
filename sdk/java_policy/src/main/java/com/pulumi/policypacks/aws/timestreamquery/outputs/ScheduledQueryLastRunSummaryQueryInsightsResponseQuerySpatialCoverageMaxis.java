...
public final class ScheduledQueryLastRunSummaryQueryInsightsResponseQuerySpatialCoverageMaxis {
    ...
    public @Nullable List<String> partitionKeys() {
        ...
        throw new UndeferrableValueException("Value 'ScheduledQueryLastRunSummaryQueryInsightsResponseQuerySpatialCoverageMaxis.partitionKeys' is not present");
    }
    ...
    public @Nullable String tableArn() {
        ...
        throw new UndeferrableValueException("Value 'ScheduledQueryLastRunSummaryQueryInsightsResponseQuerySpatialCoverageMaxis.tableArn' is not present");
    }
    ...
    public @Nullable Double value() {
        ...
        throw new UndeferrableValueException("Value 'ScheduledQueryLastRunSummaryQueryInsightsResponseQuerySpatialCoverageMaxis.value' is not present");
    }
