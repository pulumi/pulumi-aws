...
public final class WebAclRuleStatementManagedRuleGroupStatementRuleActionOverride {
     ...
     * 
     */
    private UndeferrableValue<WebAclRuleStatementManagedRuleGroupStatementRuleActionOverrideActionToUse> actionToUse;
    ...
    public WebAclRuleStatementManagedRuleGroupStatementRuleActionOverrideActionToUse actionToUse() {
        ...
        return actionToUse.getValue("WebAclRuleStatementManagedRuleGroupStatementRuleActionOverride.actionToUse");
    }
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleStatementManagedRuleGroupStatementRuleActionOverride.name");
    }
