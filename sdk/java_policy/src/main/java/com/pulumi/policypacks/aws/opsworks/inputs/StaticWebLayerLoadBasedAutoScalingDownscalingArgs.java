...
public final class StaticWebLayerLoadBasedAutoScalingDownscalingArgs {
    ...
    public List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'StaticWebLayerLoadBasedAutoScalingDownscalingArgs.alarms' is not present");
    }
    ...
    public Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'StaticWebLayerLoadBasedAutoScalingDownscalingArgs.cpuThreshold' is not present");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'StaticWebLayerLoadBasedAutoScalingDownscalingArgs.ignoreMetricsTime' is not present");
    }
    ...
    public Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'StaticWebLayerLoadBasedAutoScalingDownscalingArgs.instanceCount' is not present");
    }
    ...
    public Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'StaticWebLayerLoadBasedAutoScalingDownscalingArgs.loadThreshold' is not present");
    }
    ...
    public Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'StaticWebLayerLoadBasedAutoScalingDownscalingArgs.memoryThreshold' is not present");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'StaticWebLayerLoadBasedAutoScalingDownscalingArgs.thresholdsWaitTime' is not present");
    }
