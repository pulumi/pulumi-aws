...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnectorErrorHandlingConfig {
    ...
    public @Nullable String bucketName() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnectorErrorHandlingConfig.bucketName' is not present");
    }
    ...
    public @Nullable String bucketPrefix() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnectorErrorHandlingConfig.bucketPrefix' is not present");
    }
    ...
    public @Nullable Boolean failOnFirstDestinationError() {
        ...
        throw new UndeferrableValueException("Value 'FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnectorErrorHandlingConfig.failOnFirstDestinationError' is not present");
    }
