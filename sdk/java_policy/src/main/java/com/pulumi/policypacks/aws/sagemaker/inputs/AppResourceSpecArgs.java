...
public final class AppResourceSpecArgs {
    ...
    public String instanceType() {
        ...
        throw new UndeferrableValueException("Value 'AppResourceSpecArgs.instanceType' is not present");
    }
    ...
    public String lifecycleConfigArn() {
        ...
        throw new UndeferrableValueException("Value 'AppResourceSpecArgs.lifecycleConfigArn' is not present");
    }
    ...
    public String sagemakerImageArn() {
        ...
        throw new UndeferrableValueException("Value 'AppResourceSpecArgs.sagemakerImageArn' is not present");
    }
    ...
    public String sagemakerImageVersionAlias() {
        ...
        throw new UndeferrableValueException("Value 'AppResourceSpecArgs.sagemakerImageVersionAlias' is not present");
    }
    ...
    public String sagemakerImageVersionArn() {
        ...
        throw new UndeferrableValueException("Value 'AppResourceSpecArgs.sagemakerImageVersionArn' is not present");
    }
