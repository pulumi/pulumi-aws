...
public final class DistributionDefaultCacheBehaviorForwardedValuesCookies {
    ...
    public String forward() {
        ...
        throw new UndeferrableValueException("Value 'DistributionDefaultCacheBehaviorForwardedValuesCookies.forward' is not present");
    }
    ...
    public @Nullable List<String> whitelistedNames() {
        ...
        throw new UndeferrableValueException("Value 'DistributionDefaultCacheBehaviorForwardedValuesCookies.whitelistedNames' is not present");
    }
