...
public final class DistributionDefaultCacheBehaviorForwardedValuesCookies {
    ...
    public String forward() {
        ...
        return forward.getValue("DistributionDefaultCacheBehaviorForwardedValuesCookies.forward");
    }
    ...
    public @Nullable List<String> whitelistedNames() {
        ...
        return whitelistedNames.getValue("DistributionDefaultCacheBehaviorForwardedValuesCookies.whitelistedNames");
    }
