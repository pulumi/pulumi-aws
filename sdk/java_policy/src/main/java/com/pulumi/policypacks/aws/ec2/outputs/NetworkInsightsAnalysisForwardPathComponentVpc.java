...
public final class NetworkInsightsAnalysisForwardPathComponentVpc {
    ...
    public @Nullable String arn() {
        ...
        return arn.getValue("NetworkInsightsAnalysisForwardPathComponentVpc.arn");
    }
    ...
    public @Nullable String id() {
        ...
        return id.getValue("NetworkInsightsAnalysisForwardPathComponentVpc.id");
    }
    ...
    public @Nullable String name() {
        ...
        return name.getValue("NetworkInsightsAnalysisForwardPathComponentVpc.name");
    }
