...
public final class WebAclRuleActionCountCustomRequestHandlingInsertHeaderArgs {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionCountCustomRequestHandlingInsertHeaderArgs.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleActionCountCustomRequestHandlingInsertHeaderArgs.value' is not present");
    }
