...
public final class WebAclRuleActionCountCustomRequestHandlingInsertHeaderArgs {
    ...
    public String name() {
        ...
        return name.getValue("WebAclRuleActionCountCustomRequestHandlingInsertHeaderArgs.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclRuleActionCountCustomRequestHandlingInsertHeaderArgs.value");
    }
