...
public final class CustomLayerLoadBasedAutoScalingDownscalingArgs {
    ...
    public List<String> alarms() {
        ...
        return alarms.getValue("CustomLayerLoadBasedAutoScalingDownscalingArgs.alarms");
    }
    ...
    public Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("CustomLayerLoadBasedAutoScalingDownscalingArgs.cpuThreshold");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("CustomLayerLoadBasedAutoScalingDownscalingArgs.ignoreMetricsTime");
    }
    ...
    public Integer instanceCount() {
        ...
        return instanceCount.getValue("CustomLayerLoadBasedAutoScalingDownscalingArgs.instanceCount");
    }
    ...
    public Double loadThreshold() {
        ...
        return loadThreshold.getValue("CustomLayerLoadBasedAutoScalingDownscalingArgs.loadThreshold");
    }
    ...
    public Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("CustomLayerLoadBasedAutoScalingDownscalingArgs.memoryThreshold");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("CustomLayerLoadBasedAutoScalingDownscalingArgs.thresholdsWaitTime");
    }
