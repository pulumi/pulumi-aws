...
public final class InsightFiltersFindingProviderFieldsConfidence {
    ...
    public @Nullable String eq() {
        ...
        return eq.getValue("InsightFiltersFindingProviderFieldsConfidence.eq");
    }
    ...
    public @Nullable String gte() {
        ...
        return gte.getValue("InsightFiltersFindingProviderFieldsConfidence.gte");
    }
    ...
    public @Nullable String lte() {
        ...
        return lte.getValue("InsightFiltersFindingProviderFieldsConfidence.lte");
    }
