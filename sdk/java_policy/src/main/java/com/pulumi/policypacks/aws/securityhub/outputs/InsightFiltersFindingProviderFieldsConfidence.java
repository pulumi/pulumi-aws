...
public final class InsightFiltersFindingProviderFieldsConfidence {
    ...
    public @Nullable String eq() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersFindingProviderFieldsConfidence.eq' is not present");
    }
    ...
    public @Nullable String gte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersFindingProviderFieldsConfidence.gte' is not present");
    }
    ...
    public @Nullable String lte() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersFindingProviderFieldsConfidence.lte' is not present");
    }
