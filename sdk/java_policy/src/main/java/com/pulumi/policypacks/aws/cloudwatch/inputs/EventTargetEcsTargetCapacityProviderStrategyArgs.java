...
public final class EventTargetEcsTargetCapacityProviderStrategyArgs {
    ...
    public Integer base() {
        ...
        throw new UndeferrableValueException("Value 'EventTargetEcsTargetCapacityProviderStrategyArgs.base' is not present");
    }
    ...
    public String capacityProvider() {
        ...
        throw new UndeferrableValueException("Value 'EventTargetEcsTargetCapacityProviderStrategyArgs.capacityProvider' is not present");
    }
    ...
    public Integer weight() {
        ...
        throw new UndeferrableValueException("Value 'EventTargetEcsTargetCapacityProviderStrategyArgs.weight' is not present");
    }
