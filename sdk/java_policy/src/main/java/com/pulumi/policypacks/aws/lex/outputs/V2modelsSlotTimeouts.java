...
public final class V2modelsSlotTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("V2modelsSlotTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("V2modelsSlotTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("V2modelsSlotTimeouts.update");
    }
