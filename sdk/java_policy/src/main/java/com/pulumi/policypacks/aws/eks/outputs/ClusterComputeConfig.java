...
public final class ClusterComputeConfig {
    ...
    public @Nullable Boolean enabled() {
        ...
        throw new UndeferrableValueException("Value 'ClusterComputeConfig.enabled' is not present");
    }
    ...
    private @Nullable List<String> value_nodePools;
    private boolean unknown_nodePools;
    public @Nullable List<String> nodePools() {
        if (!unknown_nodePools) return value_nodePools;
        throw new UndeferrableValueException("Value 'ClusterComputeConfig.nodePools' is not present");
    }
    ...
    private @Nullable String value_nodeRoleArn;
    private boolean unknown_nodeRoleArn;
    public @Nullable String nodeRoleArn() {
        if (!unknown_nodeRoleArn) return value_nodeRoleArn;
        throw new UndeferrableValueException("Value 'ClusterComputeConfig.nodeRoleArn' is not present");
    }
