...
public final class NetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRange {
    ...
    public @Nullable Integer from() {
        ...
        throw new UndeferrableValueException("Value 'NetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRange.from' is not present");
    }
    ...
    public @Nullable Integer to() {
        ...
        throw new UndeferrableValueException("Value 'NetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRange.to' is not present");
    }
