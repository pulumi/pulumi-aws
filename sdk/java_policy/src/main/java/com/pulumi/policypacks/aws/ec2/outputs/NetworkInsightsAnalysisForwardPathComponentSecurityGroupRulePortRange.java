...
public final class NetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRange {
    ...
    public @Nullable Integer from() {
        ...
        return from.getValue("NetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRange.from");
    }
    ...
    public @Nullable Integer to() {
        ...
        return to.getValue("NetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRange.to");
    }
