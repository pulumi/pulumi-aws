...
public final class WorkteamMemberDefinitionCognitoMemberDefinition {
    ...
    public String clientId() {
        ...
        throw new UndeferrableValueException("Value 'WorkteamMemberDefinitionCognitoMemberDefinition.clientId' is not present");
    }
    ...
    public String userGroup() {
        ...
        throw new UndeferrableValueException("Value 'WorkteamMemberDefinitionCognitoMemberDefinition.userGroup' is not present");
    }
    ...
    public String userPool() {
        ...
        throw new UndeferrableValueException("Value 'WorkteamMemberDefinitionCognitoMemberDefinition.userPool' is not present");
    }
