...
public final class PipelineTriggerGitConfigurationPushBranchesArgs {
    ...
    public List<String> excludes() {
        ...
        return excludes.getValue("PipelineTriggerGitConfigurationPushBranchesArgs.excludes");
    }
    ...
    public List<String> includes() {
        ...
        return includes.getValue("PipelineTriggerGitConfigurationPushBranchesArgs.includes");
    }
