...
import com.pulumi.policypacks.aws.lex.outputs.V2modelsIntentClosingSettingConditionalConditionalBranch;
import com.pulumi.policypacks.aws.lex.outputs.V2modelsIntentClosingSettingConditionalDefaultBranch;
...
public final class V2modelsIntentClosingSettingConditional {
    ...
    public Boolean active() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentClosingSettingConditional.active' is not present");
    }
    ...
    private @Nullable List<V2modelsIntentClosingSettingConditionalConditionalBranch> value_conditionalBranches;
    private boolean unknown_conditionalBranches;
    public @Nullable List<V2modelsIntentClosingSettingConditionalConditionalBranch> conditionalBranches() {
        if (!unknown_conditionalBranches) return value_conditionalBranches;
        throw new UndeferrableValueException("Value 'V2modelsIntentClosingSettingConditional.conditionalBranches' is not present");
    }
    ...
    private V2modelsIntentClosingSettingConditionalDefaultBranch value_defaultBranch;
    ...
    public V2modelsIntentClosingSettingConditionalDefaultBranch defaultBranch() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentClosingSettingConditional.defaultBranch' is not present");
    }
