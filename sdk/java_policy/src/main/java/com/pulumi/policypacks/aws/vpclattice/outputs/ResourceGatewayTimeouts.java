...
public final class ResourceGatewayTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ResourceGatewayTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ResourceGatewayTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ResourceGatewayTimeouts.update");
    }
