...
public final class CostCategoryRuleRuleAndOrDimension {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleAndOrDimension.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleAndOrDimension.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleAndOrDimension.values");
    }
