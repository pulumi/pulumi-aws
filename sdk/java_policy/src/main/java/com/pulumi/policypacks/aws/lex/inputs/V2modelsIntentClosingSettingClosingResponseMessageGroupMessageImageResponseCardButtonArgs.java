...
public final class V2modelsIntentClosingSettingClosingResponseMessageGroupMessageImageResponseCardButtonArgs {
    ...
    public String text() {
        ...
        return text.getValue("V2modelsIntentClosingSettingClosingResponseMessageGroupMessageImageResponseCardButtonArgs.text");
    }
    ...
    public String value() {
        ...
        return value.getValue("V2modelsIntentClosingSettingClosingResponseMessageGroupMessageImageResponseCardButtonArgs.value");
    }
