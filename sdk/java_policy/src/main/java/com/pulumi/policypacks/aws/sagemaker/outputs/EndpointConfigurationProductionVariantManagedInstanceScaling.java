...
public final class EndpointConfigurationProductionVariantManagedInstanceScaling {
    ...
    public @Nullable Integer maxInstanceCount() {
        ...
        throw new UndeferrableValueException("Value 'EndpointConfigurationProductionVariantManagedInstanceScaling.maxInstanceCount' is not present");
    }
    ...
    public @Nullable Integer minInstanceCount() {
        ...
        throw new UndeferrableValueException("Value 'EndpointConfigurationProductionVariantManagedInstanceScaling.minInstanceCount' is not present");
    }
    ...
    public @Nullable String status() {
        ...
        throw new UndeferrableValueException("Value 'EndpointConfigurationProductionVariantManagedInstanceScaling.status' is not present");
    }
