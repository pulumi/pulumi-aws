...
public final class EndpointConfigurationProductionVariantManagedInstanceScaling {
    ...
    public @Nullable Integer maxInstanceCount() {
        ...
        return maxInstanceCount.getValue("EndpointConfigurationProductionVariantManagedInstanceScaling.maxInstanceCount");
    }
    ...
    public @Nullable Integer minInstanceCount() {
        ...
        return minInstanceCount.getValue("EndpointConfigurationProductionVariantManagedInstanceScaling.minInstanceCount");
    }
    ...
    public @Nullable String status() {
        ...
        return status.getValue("EndpointConfigurationProductionVariantManagedInstanceScaling.status");
    }
