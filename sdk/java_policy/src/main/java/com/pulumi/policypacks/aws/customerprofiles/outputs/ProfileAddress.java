...
public final class ProfileAddress {
    ...
    public @Nullable String address1() {
        ...
        return address1.getValue("ProfileAddress.address1");
    }
    ...
    public @Nullable String address2() {
        ...
        return address2.getValue("ProfileAddress.address2");
    }
    ...
    public @Nullable String address3() {
        ...
        return address3.getValue("ProfileAddress.address3");
    }
    ...
    public @Nullable String address4() {
        ...
        return address4.getValue("ProfileAddress.address4");
    }
    ...
    public @Nullable String city() {
        ...
        return city.getValue("ProfileAddress.city");
    }
    ...
    public @Nullable String country() {
        ...
        return country.getValue("ProfileAddress.country");
    }
    ...
    public @Nullable String county() {
        ...
        return county.getValue("ProfileAddress.county");
    }
    ...
    public @Nullable String postalCode() {
        ...
        return postalCode.getValue("ProfileAddress.postalCode");
    }
    ...
    public @Nullable String province() {
        ...
        return province.getValue("ProfileAddress.province");
    }
    ...
    public @Nullable String state() {
        ...
        return state.getValue("ProfileAddress.state");
    }
