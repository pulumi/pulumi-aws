...
public final class CostCategoryRuleRuleAndAndCostCategoryArgs {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndAndCostCategoryArgs.key' is not present");
    }
    ...
    public List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndAndCostCategoryArgs.matchOptions' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleAndAndCostCategoryArgs.values' is not present");
    }
