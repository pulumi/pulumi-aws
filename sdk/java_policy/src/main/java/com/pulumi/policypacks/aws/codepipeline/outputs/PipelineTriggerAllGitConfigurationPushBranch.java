...
public final class PipelineTriggerAllGitConfigurationPushBranch {
    ...
    public @Nullable List<String> excludes() {
        ...
        return excludes.getValue("PipelineTriggerAllGitConfigurationPushBranch.excludes");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        return includes.getValue("PipelineTriggerAllGitConfigurationPushBranch.includes");
    }
