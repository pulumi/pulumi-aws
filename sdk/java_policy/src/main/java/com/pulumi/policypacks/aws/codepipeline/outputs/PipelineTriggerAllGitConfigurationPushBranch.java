...
public final class PipelineTriggerAllGitConfigurationPushBranch {
    ...
    public @Nullable List<String> excludes() {
        ...
        throw new UndeferrableValueException("Value 'PipelineTriggerAllGitConfigurationPushBranch.excludes' is not present");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        throw new UndeferrableValueException("Value 'PipelineTriggerAllGitConfigurationPushBranch.includes' is not present");
    }
