...
public final class EcsClusterLayerEbsVolume {
    ...
    public @Nullable Boolean encrypted() {
        ...
        return encrypted.getValue("EcsClusterLayerEbsVolume.encrypted");
    }
    ...
    public @Nullable Integer iops() {
        ...
        return iops.getValue("EcsClusterLayerEbsVolume.iops");
    }
    ...
    public String mountPoint() {
        ...
        return mountPoint.getValue("EcsClusterLayerEbsVolume.mountPoint");
    }
    ...
    public Integer numberOfDisks() {
        ...
        return numberOfDisks.getValue("EcsClusterLayerEbsVolume.numberOfDisks");
    }
    ...
    public @Nullable String raidLevel() {
        ...
        return raidLevel.getValue("EcsClusterLayerEbsVolume.raidLevel");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("EcsClusterLayerEbsVolume.size");
    }
    ...
    public @Nullable String type() {
        ...
        return type.getValue("EcsClusterLayerEbsVolume.type");
    }
