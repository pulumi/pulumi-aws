...
public final class V2modelsIntentConfirmationSettingDeclinationNextStepDialogActionArgs {
    ...
    public String slotToElicit() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingDeclinationNextStepDialogActionArgs.slotToElicit' is not present");
    }
    ...
    public Boolean suppressNextMessage() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingDeclinationNextStepDialogActionArgs.suppressNextMessage' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingDeclinationNextStepDialogActionArgs.type' is not present");
    }
