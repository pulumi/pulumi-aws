...
public final class HaproxyLayerCloudwatchConfigurationLogStream {
    ...
    public @Nullable Integer batchCount() {
        ...
        return batchCount.getValue("HaproxyLayerCloudwatchConfigurationLogStream.batchCount");
    }
    ...
    public @Nullable Integer batchSize() {
        ...
        return batchSize.getValue("HaproxyLayerCloudwatchConfigurationLogStream.batchSize");
    }
    ...
    public @Nullable Integer bufferDuration() {
        ...
        return bufferDuration.getValue("HaproxyLayerCloudwatchConfigurationLogStream.bufferDuration");
    }
    ...
    public @Nullable String datetimeFormat() {
        ...
        return datetimeFormat.getValue("HaproxyLayerCloudwatchConfigurationLogStream.datetimeFormat");
    }
    ...
    public @Nullable String encoding() {
        ...
        return encoding.getValue("HaproxyLayerCloudwatchConfigurationLogStream.encoding");
    }
    ...
    public String file() {
        ...
        return file.getValue("HaproxyLayerCloudwatchConfigurationLogStream.file");
    }
    ...
    public @Nullable String fileFingerprintLines() {
        ...
        return fileFingerprintLines.getValue("HaproxyLayerCloudwatchConfigurationLogStream.fileFingerprintLines");
    }
    ...
    public @Nullable String initialPosition() {
        ...
        return initialPosition.getValue("HaproxyLayerCloudwatchConfigurationLogStream.initialPosition");
    }
    ...
    public String logGroupName() {
        ...
        return logGroupName.getValue("HaproxyLayerCloudwatchConfigurationLogStream.logGroupName");
    }
    ...
    public @Nullable String multilineStartPattern() {
        ...
        return multilineStartPattern.getValue("HaproxyLayerCloudwatchConfigurationLogStream.multilineStartPattern");
    }
    ...
    public @Nullable String timeZone() {
        ...
        return timeZone.getValue("HaproxyLayerCloudwatchConfigurationLogStream.timeZone");
    }
