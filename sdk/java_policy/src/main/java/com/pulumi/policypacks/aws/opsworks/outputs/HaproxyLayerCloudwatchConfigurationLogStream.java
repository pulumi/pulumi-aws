...
public final class HaproxyLayerCloudwatchConfigurationLogStream {
    ...
    public @Nullable Integer batchCount() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.batchCount' is not present");
    }
    ...
    public @Nullable Integer batchSize() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.batchSize' is not present");
    }
    ...
    public @Nullable Integer bufferDuration() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.bufferDuration' is not present");
    }
    ...
    public @Nullable String datetimeFormat() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.datetimeFormat' is not present");
    }
    ...
    public @Nullable String encoding() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.encoding' is not present");
    }
    ...
    public String file() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.file' is not present");
    }
    ...
    public @Nullable String fileFingerprintLines() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.fileFingerprintLines' is not present");
    }
    ...
    public @Nullable String initialPosition() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.initialPosition' is not present");
    }
    ...
    public String logGroupName() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.logGroupName' is not present");
    }
    ...
    public @Nullable String multilineStartPattern() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.multilineStartPattern' is not present");
    }
    ...
    public @Nullable String timeZone() {
        ...
        throw new UndeferrableValueException("Value 'HaproxyLayerCloudwatchConfigurationLogStream.timeZone' is not present");
    }
