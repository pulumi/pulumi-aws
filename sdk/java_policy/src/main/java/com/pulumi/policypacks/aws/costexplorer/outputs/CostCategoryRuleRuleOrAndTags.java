...
public final class CostCategoryRuleRuleOrAndTags {
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrAndTags.key' is not present");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrAndTags.matchOptions' is not present");
    }
    ...
    public @Nullable List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrAndTags.values' is not present");
    }
