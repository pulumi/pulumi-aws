...
public final class CostCategoryRuleRuleOrAndTags {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleOrAndTags.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleOrAndTags.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleOrAndTags.values");
    }
