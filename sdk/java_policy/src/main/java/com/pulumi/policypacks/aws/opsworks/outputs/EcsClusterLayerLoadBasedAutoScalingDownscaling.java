...
public final class EcsClusterLayerLoadBasedAutoScalingDownscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("EcsClusterLayerLoadBasedAutoScalingDownscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("EcsClusterLayerLoadBasedAutoScalingDownscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("EcsClusterLayerLoadBasedAutoScalingDownscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("EcsClusterLayerLoadBasedAutoScalingDownscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("EcsClusterLayerLoadBasedAutoScalingDownscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("EcsClusterLayerLoadBasedAutoScalingDownscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("EcsClusterLayerLoadBasedAutoScalingDownscaling.thresholdsWaitTime");
    }
