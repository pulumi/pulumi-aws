...
public final class EcsClusterLayerLoadBasedAutoScalingDownscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingDownscaling.alarms' is not present");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingDownscaling.cpuThreshold' is not present");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingDownscaling.ignoreMetricsTime' is not present");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingDownscaling.instanceCount' is not present");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingDownscaling.loadThreshold' is not present");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingDownscaling.memoryThreshold' is not present");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'EcsClusterLayerLoadBasedAutoScalingDownscaling.thresholdsWaitTime' is not present");
    }
