...
public final class V2modelsIntentInitialResponseSettingConditionalConditionalBranchCondition {
    ...
    public String expressionString() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentInitialResponseSettingConditionalConditionalBranchCondition.expressionString' is not present");
    }
