...
public final class VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFile {
    ...
    public String certificateChain() {
        ...
        throw new UndeferrableValueException("Value 'VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFile.certificateChain' is not present");
    }
    ...
    public String privateKey() {
        ...
        throw new UndeferrableValueException("Value 'VirtualNodeSpecBackendVirtualServiceClientPolicyTlsCertificateFile.privateKey' is not present");
    }
