...
public final class RailsAppLayerLoadBasedAutoScalingDownscalingArgs {
    ...
    public List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'RailsAppLayerLoadBasedAutoScalingDownscalingArgs.alarms' is not present");
    }
    ...
    public Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'RailsAppLayerLoadBasedAutoScalingDownscalingArgs.cpuThreshold' is not present");
    }
    ...
    public Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'RailsAppLayerLoadBasedAutoScalingDownscalingArgs.ignoreMetricsTime' is not present");
    }
    ...
    public Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'RailsAppLayerLoadBasedAutoScalingDownscalingArgs.instanceCount' is not present");
    }
    ...
    public Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'RailsAppLayerLoadBasedAutoScalingDownscalingArgs.loadThreshold' is not present");
    }
    ...
    public Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'RailsAppLayerLoadBasedAutoScalingDownscalingArgs.memoryThreshold' is not present");
    }
    ...
    public Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'RailsAppLayerLoadBasedAutoScalingDownscalingArgs.thresholdsWaitTime' is not present");
    }
