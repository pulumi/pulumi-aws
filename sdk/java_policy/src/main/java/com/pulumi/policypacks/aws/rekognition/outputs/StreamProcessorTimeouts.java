...
public final class StreamProcessorTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("StreamProcessorTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("StreamProcessorTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("StreamProcessorTimeouts.update");
    }
