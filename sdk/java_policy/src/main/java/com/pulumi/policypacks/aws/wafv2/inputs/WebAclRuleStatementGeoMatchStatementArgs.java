...
import com.pulumi.policypacks.aws.wafv2.inputs.WebAclRuleStatementGeoMatchStatementForwardedIpConfigArgs;
import java.lang.String;
import java.util.List;
import javax.annotation.Nullable;


public final class WebAclRuleStatementGeoMatchStatementArgs {
    ...
    public List<String> countryCodes() {
        ...
        return countryCodes.getValue("WebAclRuleStatementGeoMatchStatementArgs.countryCodes");
    }
     ...
     * 
     */
    private UndeferrableValue<WebAclRuleStatementGeoMatchStatementForwardedIpConfigArgs> forwardedIpConfig;

    public WebAclRuleStatementGeoMatchStatementForwardedIpConfigArgs forwardedIpConfig() {
        if (forwardedIpConfig == null) return null;
        return forwardedIpConfig.getValue("WebAclRuleStatementGeoMatchStatementArgs.forwardedIpConfig");
    }
