...
public final class PhpAppLayerEbsVolume {
    ...
    public @Nullable Boolean encrypted() {
        ...
        return encrypted.getValue("PhpAppLayerEbsVolume.encrypted");
    }
    ...
    public @Nullable Integer iops() {
        ...
        return iops.getValue("PhpAppLayerEbsVolume.iops");
    }
    ...
    public String mountPoint() {
        ...
        return mountPoint.getValue("PhpAppLayerEbsVolume.mountPoint");
    }
    ...
    public Integer numberOfDisks() {
        ...
        return numberOfDisks.getValue("PhpAppLayerEbsVolume.numberOfDisks");
    }
    ...
    public @Nullable String raidLevel() {
        ...
        return raidLevel.getValue("PhpAppLayerEbsVolume.raidLevel");
    }
    ...
    public Integer size() {
        ...
        return size.getValue("PhpAppLayerEbsVolume.size");
    }
    ...
    public @Nullable String type() {
        ...
        return type.getValue("PhpAppLayerEbsVolume.type");
    }
