...
public final class ScheduledQueryTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("ScheduledQueryTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("ScheduledQueryTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("ScheduledQueryTimeouts.update");
    }
