...
public final class GatewayRouteSpecHttpRouteMatchHeaderMatchRange {
    ...
    public Integer end() {
        ...
        throw new UndeferrableValueException("Value 'GatewayRouteSpecHttpRouteMatchHeaderMatchRange.end' is not present");
    }
    ...
    public Integer start() {
        ...
        throw new UndeferrableValueException("Value 'GatewayRouteSpecHttpRouteMatchHeaderMatchRange.start' is not present");
    }
