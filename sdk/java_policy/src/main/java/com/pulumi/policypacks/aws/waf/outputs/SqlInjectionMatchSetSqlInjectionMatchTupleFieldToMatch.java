...
public final class SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch {
    ...
    public @Nullable String data() {
        ...
        throw new UndeferrableValueException("Value 'SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch.data' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch.type' is not present");
    }
