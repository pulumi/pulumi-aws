...
public final class SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch {
    ...
    public @Nullable String data() {
        ...
        return data.getValue("SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch.data");
    }
    ...
    public String type() {
        ...
        return type.getValue("SqlInjectionMatchSetSqlInjectionMatchTupleFieldToMatch.type");
    }
