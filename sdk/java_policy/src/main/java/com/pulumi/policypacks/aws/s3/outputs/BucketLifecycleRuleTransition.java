...
public final class BucketLifecycleRuleTransition {
    ...
    public @Nullable String date() {
        ...
        return date.getValue("BucketLifecycleRuleTransition.date");
    }
    ...
    public @Nullable Integer days() {
        ...
        return days.getValue("BucketLifecycleRuleTransition.days");
    }
    ...
    public String storageClass() {
        ...
        return storageClass.getValue("BucketLifecycleRuleTransition.storageClass");
    }
