...
public final class BucketLifecycleRuleTransition {
    ...
    public @Nullable String date() {
        ...
        throw new UndeferrableValueException("Value 'BucketLifecycleRuleTransition.date' is not present");
    }
    ...
    public @Nullable Integer days() {
        ...
        throw new UndeferrableValueException("Value 'BucketLifecycleRuleTransition.days' is not present");
    }
    ...
    public String storageClass() {
        ...
        throw new UndeferrableValueException("Value 'BucketLifecycleRuleTransition.storageClass' is not present");
    }
