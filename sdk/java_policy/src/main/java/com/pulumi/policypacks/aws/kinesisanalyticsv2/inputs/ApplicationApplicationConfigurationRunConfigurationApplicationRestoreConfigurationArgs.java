...
public final class ApplicationApplicationConfigurationRunConfigurationApplicationRestoreConfigurationArgs {
    ...
    private String value_applicationRestoreType;
    ...
    public String applicationRestoreType() {
        ...
        throw new UndeferrableValueException("Value 'ApplicationApplicationConfigurationRunConfigurationApplicationRestoreConfigurationArgs.applicationRestoreType' is not present");
    }
    ...
    public String snapshotName() {
        ...
        throw new UndeferrableValueException("Value 'ApplicationApplicationConfigurationRunConfigurationApplicationRestoreConfigurationArgs.snapshotName' is not present");
    }
