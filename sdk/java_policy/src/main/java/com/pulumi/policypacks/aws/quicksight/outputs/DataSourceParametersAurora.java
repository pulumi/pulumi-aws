...
public final class DataSourceParametersAurora {
    ...
    public String database() {
        ...
        return database.getValue("DataSourceParametersAurora.database");
    }
    ...
    public String host() {
        ...
        return host.getValue("DataSourceParametersAurora.host");
    }
    ...
    public Integer port() {
        ...
        return port.getValue("DataSourceParametersAurora.port");
    }
