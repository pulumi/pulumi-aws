...
public final class DataSourceParametersAurora {
    ...
    public String database() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersAurora.database' is not present");
    }
    ...
    public String host() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersAurora.host' is not present");
    }
    ...
    public Integer port() {
        ...
        throw new UndeferrableValueException("Value 'DataSourceParametersAurora.port' is not present");
    }
