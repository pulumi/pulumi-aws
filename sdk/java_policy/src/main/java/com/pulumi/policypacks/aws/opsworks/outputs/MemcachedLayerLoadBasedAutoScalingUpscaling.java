...
public final class MemcachedLayerLoadBasedAutoScalingUpscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'MemcachedLayerLoadBasedAutoScalingUpscaling.alarms' is not present");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'MemcachedLayerLoadBasedAutoScalingUpscaling.cpuThreshold' is not present");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'MemcachedLayerLoadBasedAutoScalingUpscaling.ignoreMetricsTime' is not present");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'MemcachedLayerLoadBasedAutoScalingUpscaling.instanceCount' is not present");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'MemcachedLayerLoadBasedAutoScalingUpscaling.loadThreshold' is not present");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'MemcachedLayerLoadBasedAutoScalingUpscaling.memoryThreshold' is not present");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'MemcachedLayerLoadBasedAutoScalingUpscaling.thresholdsWaitTime' is not present");
    }
