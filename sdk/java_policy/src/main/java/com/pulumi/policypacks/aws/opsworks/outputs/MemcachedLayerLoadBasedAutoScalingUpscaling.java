...
public final class MemcachedLayerLoadBasedAutoScalingUpscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        return alarms.getValue("MemcachedLayerLoadBasedAutoScalingUpscaling.alarms");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        return cpuThreshold.getValue("MemcachedLayerLoadBasedAutoScalingUpscaling.cpuThreshold");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        return ignoreMetricsTime.getValue("MemcachedLayerLoadBasedAutoScalingUpscaling.ignoreMetricsTime");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        return instanceCount.getValue("MemcachedLayerLoadBasedAutoScalingUpscaling.instanceCount");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        return loadThreshold.getValue("MemcachedLayerLoadBasedAutoScalingUpscaling.loadThreshold");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        return memoryThreshold.getValue("MemcachedLayerLoadBasedAutoScalingUpscaling.memoryThreshold");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        return thresholdsWaitTime.getValue("MemcachedLayerLoadBasedAutoScalingUpscaling.thresholdsWaitTime");
    }
