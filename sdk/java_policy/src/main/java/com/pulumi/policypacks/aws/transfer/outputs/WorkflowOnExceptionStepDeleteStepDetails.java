...
public final class WorkflowOnExceptionStepDeleteStepDetails {
    ...
    public @Nullable String name() {
        ...
        return name.getValue("WorkflowOnExceptionStepDeleteStepDetails.name");
    }
    ...
    public @Nullable String sourceFileLocation() {
        ...
        return sourceFileLocation.getValue("WorkflowOnExceptionStepDeleteStepDetails.sourceFileLocation");
    }
