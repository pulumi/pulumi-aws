...
public final class AnomalySubscriptionThresholdExpressionCostCategory {
    ...
    public @Nullable String key() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionCostCategory.key' is not present");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionCostCategory.matchOptions' is not present");
    }
    ...
    public @Nullable List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'AnomalySubscriptionThresholdExpressionCostCategory.values' is not present");
    }
