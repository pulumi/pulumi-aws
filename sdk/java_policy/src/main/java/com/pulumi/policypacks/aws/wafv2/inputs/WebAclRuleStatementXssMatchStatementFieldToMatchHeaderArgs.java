...
import com.pulumi.policypacks.aws.wafv2.inputs.WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs;
import java.lang.String;


public final class WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs {
    ...
    private WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs value_matchPattern;
    private boolean unknown_matchPattern;
    public WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern() {
        if (!unknown_matchPattern) return value_matchPattern;
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs.matchPattern' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs.oversizeHandling' is not present");
    }
