...
public final class DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettingsArgs {
    ...
    public List<String> assumableRoleArns() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettingsArgs.assumableRoleArns' is not present");
    }
    ...
    public List<String> executionRoleArns() {
        ...
        throw new UndeferrableValueException("Value 'DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettingsArgs.executionRoleArns' is not present");
    }
