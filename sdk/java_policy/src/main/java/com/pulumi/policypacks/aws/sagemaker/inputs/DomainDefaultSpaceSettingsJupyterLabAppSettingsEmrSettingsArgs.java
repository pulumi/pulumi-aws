...
public final class DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettingsArgs {
    ...
    public List<String> assumableRoleArns() {
        ...
        return assumableRoleArns.getValue("DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettingsArgs.assumableRoleArns");
    }
    ...
    public List<String> executionRoleArns() {
        ...
        return executionRoleArns.getValue("DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettingsArgs.executionRoleArns");
    }
