...
public final class MemcachedLayerCloudwatchConfigurationLogStream {
    ...
    public @Nullable Integer batchCount() {
        ...
        return batchCount.getValue("MemcachedLayerCloudwatchConfigurationLogStream.batchCount");
    }
    ...
    public @Nullable Integer batchSize() {
        ...
        return batchSize.getValue("MemcachedLayerCloudwatchConfigurationLogStream.batchSize");
    }
    ...
    public @Nullable Integer bufferDuration() {
        ...
        return bufferDuration.getValue("MemcachedLayerCloudwatchConfigurationLogStream.bufferDuration");
    }
    ...
    public @Nullable String datetimeFormat() {
        ...
        return datetimeFormat.getValue("MemcachedLayerCloudwatchConfigurationLogStream.datetimeFormat");
    }
    ...
    public @Nullable String encoding() {
        ...
        return encoding.getValue("MemcachedLayerCloudwatchConfigurationLogStream.encoding");
    }
    ...
    public String file() {
        ...
        return file.getValue("MemcachedLayerCloudwatchConfigurationLogStream.file");
    }
    ...
    public @Nullable String fileFingerprintLines() {
        ...
        return fileFingerprintLines.getValue("MemcachedLayerCloudwatchConfigurationLogStream.fileFingerprintLines");
    }
    ...
    public @Nullable String initialPosition() {
        ...
        return initialPosition.getValue("MemcachedLayerCloudwatchConfigurationLogStream.initialPosition");
    }
    ...
    public String logGroupName() {
        ...
        return logGroupName.getValue("MemcachedLayerCloudwatchConfigurationLogStream.logGroupName");
    }
    ...
    public @Nullable String multilineStartPattern() {
        ...
        return multilineStartPattern.getValue("MemcachedLayerCloudwatchConfigurationLogStream.multilineStartPattern");
    }
    ...
    public @Nullable String timeZone() {
        ...
        return timeZone.getValue("MemcachedLayerCloudwatchConfigurationLogStream.timeZone");
    }
