...
public final class EventConnectionAuthParametersOauthOauthHttpParametersHeader {
    ...
    public @Nullable Boolean isValueSecret() {
        ...
        return isValueSecret.getValue("EventConnectionAuthParametersOauthOauthHttpParametersHeader.isValueSecret");
    }
    ...
    public @Nullable String key() {
        ...
        return key.getValue("EventConnectionAuthParametersOauthOauthHttpParametersHeader.key");
    }
    ...
    public @Nullable String value() {
        ...
        return value.getValue("EventConnectionAuthParametersOauthOauthHttpParametersHeader.value");
    }
