...
public final class RouteSpecHttpRouteActionWeightedTarget {
    ...
    public @Nullable Integer port() {
        ...
        return port.getValue("RouteSpecHttpRouteActionWeightedTarget.port");
    }
    ...
    public String virtualNode() {
        ...
        return virtualNode.getValue("RouteSpecHttpRouteActionWeightedTarget.virtualNode");
    }
    ...
    public Integer weight() {
        ...
        return weight.getValue("RouteSpecHttpRouteActionWeightedTarget.weight");
    }
