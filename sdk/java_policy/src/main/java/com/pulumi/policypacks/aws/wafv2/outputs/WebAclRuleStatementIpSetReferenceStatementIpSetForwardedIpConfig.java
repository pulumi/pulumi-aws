...
public final class WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig {
    ...
    public String fallbackBehavior() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig.fallbackBehavior' is not present");
    }
    ...
    public String headerName() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig.headerName' is not present");
    }
    ...
    public String position() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfig.position' is not present");
    }
