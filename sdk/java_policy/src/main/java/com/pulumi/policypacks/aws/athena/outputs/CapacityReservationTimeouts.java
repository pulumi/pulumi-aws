...
public final class CapacityReservationTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'CapacityReservationTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'CapacityReservationTimeouts.delete' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'CapacityReservationTimeouts.update' is not present");
    }
