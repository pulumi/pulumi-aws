...
public final class CapacityReservationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("CapacityReservationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("CapacityReservationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("CapacityReservationTimeouts.update");
    }
