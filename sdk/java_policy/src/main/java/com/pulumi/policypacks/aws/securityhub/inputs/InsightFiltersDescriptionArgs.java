...
public final class InsightFiltersDescriptionArgs {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersDescriptionArgs.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersDescriptionArgs.value' is not present");
    }
