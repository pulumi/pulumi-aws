...
public final class PhpAppLayerCloudwatchConfigurationLogStream {
    ...
    public @Nullable Integer batchCount() {
        ...
        return batchCount.getValue("PhpAppLayerCloudwatchConfigurationLogStream.batchCount");
    }
    ...
    public @Nullable Integer batchSize() {
        ...
        return batchSize.getValue("PhpAppLayerCloudwatchConfigurationLogStream.batchSize");
    }
    ...
    public @Nullable Integer bufferDuration() {
        ...
        return bufferDuration.getValue("PhpAppLayerCloudwatchConfigurationLogStream.bufferDuration");
    }
    ...
    public @Nullable String datetimeFormat() {
        ...
        return datetimeFormat.getValue("PhpAppLayerCloudwatchConfigurationLogStream.datetimeFormat");
    }
    ...
    public @Nullable String encoding() {
        ...
        return encoding.getValue("PhpAppLayerCloudwatchConfigurationLogStream.encoding");
    }
    ...
    public String file() {
        ...
        return file.getValue("PhpAppLayerCloudwatchConfigurationLogStream.file");
    }
    ...
    public @Nullable String fileFingerprintLines() {
        ...
        return fileFingerprintLines.getValue("PhpAppLayerCloudwatchConfigurationLogStream.fileFingerprintLines");
    }
    ...
    public @Nullable String initialPosition() {
        ...
        return initialPosition.getValue("PhpAppLayerCloudwatchConfigurationLogStream.initialPosition");
    }
    ...
    public String logGroupName() {
        ...
        return logGroupName.getValue("PhpAppLayerCloudwatchConfigurationLogStream.logGroupName");
    }
    ...
    public @Nullable String multilineStartPattern() {
        ...
        return multilineStartPattern.getValue("PhpAppLayerCloudwatchConfigurationLogStream.multilineStartPattern");
    }
    ...
    public @Nullable String timeZone() {
        ...
        return timeZone.getValue("PhpAppLayerCloudwatchConfigurationLogStream.timeZone");
    }
