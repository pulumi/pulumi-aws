...
public final class UserProfileUserSettingsCodeEditorAppSettingsCustomImageArgs {
    ...
    public String appImageConfigName() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsCodeEditorAppSettingsCustomImageArgs.appImageConfigName' is not present");
    }
    ...
    public String imageName() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsCodeEditorAppSettingsCustomImageArgs.imageName' is not present");
    }
    ...
    public Integer imageVersionNumber() {
        ...
        throw new UndeferrableValueException("Value 'UserProfileUserSettingsCodeEditorAppSettingsCustomImageArgs.imageVersionNumber' is not present");
    }
