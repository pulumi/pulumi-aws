...
public final class ReplicationGroupLogDeliveryConfiguration {
    ...
    public String destination() {
        ...
        return destination.getValue("ReplicationGroupLogDeliveryConfiguration.destination");
    }
    ...
    public String destinationType() {
        ...
        return destinationType.getValue("ReplicationGroupLogDeliveryConfiguration.destinationType");
    }
    ...
    public String logFormat() {
        ...
        return logFormat.getValue("ReplicationGroupLogDeliveryConfiguration.logFormat");
    }
    ...
    public String logType() {
        ...
        return logType.getValue("ReplicationGroupLogDeliveryConfiguration.logType");
    }
