...
public final class DefaultRouteTablePropagationTimeouts {
    ...
    public @Nullable String create() {
        ...
        throw new UndeferrableValueException("Value 'DefaultRouteTablePropagationTimeouts.create' is not present");
    }
    ...
    public @Nullable String delete() {
        ...
        throw new UndeferrableValueException("Value 'DefaultRouteTablePropagationTimeouts.delete' is not present");
    }
    ...
    public @Nullable String update() {
        ...
        throw new UndeferrableValueException("Value 'DefaultRouteTablePropagationTimeouts.update' is not present");
    }
