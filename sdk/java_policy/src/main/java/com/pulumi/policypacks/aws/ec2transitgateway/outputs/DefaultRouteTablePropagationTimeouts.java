...
public final class DefaultRouteTablePropagationTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("DefaultRouteTablePropagationTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("DefaultRouteTablePropagationTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("DefaultRouteTablePropagationTimeouts.update");
    }
