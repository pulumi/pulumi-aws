...
public final class BucketServerSideEncryptionConfigurationV2RuleApplyServerSideEncryptionByDefault {
    ...
    public @Nullable String kmsMasterKeyId() {
        ...
        return kmsMasterKeyId.getValue("BucketServerSideEncryptionConfigurationV2RuleApplyServerSideEncryptionByDefault.kmsMasterKeyId");
    }
    ...
    public String sseAlgorithm() {
        ...
        return sseAlgorithm.getValue("BucketServerSideEncryptionConfigurationV2RuleApplyServerSideEncryptionByDefault.sseAlgorithm");
    }
