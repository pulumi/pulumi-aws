...
public final class WebAclRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation {
    ...
    public Integer priority() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation.priority' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation.type' is not present");
    }
