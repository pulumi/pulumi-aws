...
public final class BucketV2ReplicationConfigurationRuleDestinationMetric {
    ...
    public @Nullable Integer minutes() {
        ...
        throw new UndeferrableValueException("Value 'BucketV2ReplicationConfigurationRuleDestinationMetric.minutes' is not present");
    }
    ...
    public @Nullable String status() {
        ...
        throw new UndeferrableValueException("Value 'BucketV2ReplicationConfigurationRuleDestinationMetric.status' is not present");
    }
