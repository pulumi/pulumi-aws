...
public final class OntapStorageVirtualMachineEndpointIscsi {
    ...
    public @Nullable String dnsName() {
        ...
        return dnsName.getValue("OntapStorageVirtualMachineEndpointIscsi.dnsName");
    }
    ...
    public @Nullable List<String> ipAddresses() {
        ...
        return ipAddresses.getValue("OntapStorageVirtualMachineEndpointIscsi.ipAddresses");
    }
