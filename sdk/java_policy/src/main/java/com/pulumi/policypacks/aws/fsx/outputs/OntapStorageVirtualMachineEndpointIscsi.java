...
public final class OntapStorageVirtualMachineEndpointIscsi {
    ...
    public @Nullable String dnsName() {
        ...
        throw new UndeferrableValueException("Value 'OntapStorageVirtualMachineEndpointIscsi.dnsName' is not present");
    }
    ...
    public @Nullable List<String> ipAddresses() {
        ...
        throw new UndeferrableValueException("Value 'OntapStorageVirtualMachineEndpointIscsi.ipAddresses' is not present");
    }
