...
public final class ResourceLfTagsDatabase {
    ...
    public @Nullable String catalogId() {
        ...
        throw new UndeferrableValueException("Value 'ResourceLfTagsDatabase.catalogId' is not present");
    }
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'ResourceLfTagsDatabase.name' is not present");
    }
