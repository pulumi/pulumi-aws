...
public final class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsVeeva {
    ...
    public String password() {
        ...
        throw new UndeferrableValueException("Value 'ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsVeeva.password' is not present");
    }
    ...
    public String username() {
        ...
        throw new UndeferrableValueException("Value 'ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsVeeva.username' is not present");
    }
