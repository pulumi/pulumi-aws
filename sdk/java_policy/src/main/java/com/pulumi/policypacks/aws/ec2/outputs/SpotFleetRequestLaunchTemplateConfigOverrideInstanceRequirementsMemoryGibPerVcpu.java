...
public final class SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu {
    ...
    public @Nullable Double max() {
        ...
        return max.getValue("SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu.max");
    }
    ...
    public @Nullable Double min() {
        ...
        return min.getValue("SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu.min");
    }
