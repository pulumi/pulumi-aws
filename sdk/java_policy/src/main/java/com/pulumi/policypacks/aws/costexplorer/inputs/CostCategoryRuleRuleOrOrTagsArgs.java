...
public final class CostCategoryRuleRuleOrOrTagsArgs {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrOrTagsArgs.key' is not present");
    }
    ...
    public List<String> matchOptions() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrOrTagsArgs.matchOptions' is not present");
    }
    ...
    public List<String> values() {
        ...
        throw new UndeferrableValueException("Value 'CostCategoryRuleRuleOrOrTagsArgs.values' is not present");
    }
