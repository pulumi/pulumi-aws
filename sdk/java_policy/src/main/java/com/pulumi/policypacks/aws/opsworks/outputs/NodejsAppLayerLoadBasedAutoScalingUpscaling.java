...
public final class NodejsAppLayerLoadBasedAutoScalingUpscaling {
    ...
    public @Nullable List<String> alarms() {
        ...
        throw new UndeferrableValueException("Value 'NodejsAppLayerLoadBasedAutoScalingUpscaling.alarms' is not present");
    }
    ...
    public @Nullable Double cpuThreshold() {
        ...
        throw new UndeferrableValueException("Value 'NodejsAppLayerLoadBasedAutoScalingUpscaling.cpuThreshold' is not present");
    }
    ...
    public @Nullable Integer ignoreMetricsTime() {
        ...
        throw new UndeferrableValueException("Value 'NodejsAppLayerLoadBasedAutoScalingUpscaling.ignoreMetricsTime' is not present");
    }
    ...
    public @Nullable Integer instanceCount() {
        ...
        throw new UndeferrableValueException("Value 'NodejsAppLayerLoadBasedAutoScalingUpscaling.instanceCount' is not present");
    }
    ...
    public @Nullable Double loadThreshold() {
        ...
        throw new UndeferrableValueException("Value 'NodejsAppLayerLoadBasedAutoScalingUpscaling.loadThreshold' is not present");
    }
    ...
    public @Nullable Double memoryThreshold() {
        ...
        throw new UndeferrableValueException("Value 'NodejsAppLayerLoadBasedAutoScalingUpscaling.memoryThreshold' is not present");
    }
    ...
    public @Nullable Integer thresholdsWaitTime() {
        ...
        throw new UndeferrableValueException("Value 'NodejsAppLayerLoadBasedAutoScalingUpscaling.thresholdsWaitTime' is not present");
    }
