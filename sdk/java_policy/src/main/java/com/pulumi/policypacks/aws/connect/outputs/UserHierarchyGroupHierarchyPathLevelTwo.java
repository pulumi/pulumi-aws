...
public final class UserHierarchyGroupHierarchyPathLevelTwo {
    ...
    public @Nullable String arn() {
        ...
        return arn.getValue("UserHierarchyGroupHierarchyPathLevelTwo.arn");
    }
    ...
    public @Nullable String id() {
        ...
        return id.getValue("UserHierarchyGroupHierarchyPathLevelTwo.id");
    }
    ...
    public @Nullable String name() {
        ...
        return name.getValue("UserHierarchyGroupHierarchyPathLevelTwo.name");
    }
