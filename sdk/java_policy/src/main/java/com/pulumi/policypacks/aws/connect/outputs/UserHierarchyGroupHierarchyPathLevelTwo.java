...
public final class UserHierarchyGroupHierarchyPathLevelTwo {
    ...
    public @Nullable String arn() {
        ...
        throw new UndeferrableValueException("Value 'UserHierarchyGroupHierarchyPathLevelTwo.arn' is not present");
    }
    ...
    public @Nullable String id() {
        ...
        throw new UndeferrableValueException("Value 'UserHierarchyGroupHierarchyPathLevelTwo.id' is not present");
    }
    ...
    public @Nullable String name() {
        ...
        throw new UndeferrableValueException("Value 'UserHierarchyGroupHierarchyPathLevelTwo.name' is not present");
    }
