...
public final class WebAclDefaultActionBlockCustomResponseResponseHeaderArgs {
    ...
    public String name() {
        ...
        return name.getValue("WebAclDefaultActionBlockCustomResponseResponseHeaderArgs.name");
    }
    ...
    public String value() {
        ...
        return value.getValue("WebAclDefaultActionBlockCustomResponseResponseHeaderArgs.value");
    }
