...
public final class WebAclDefaultActionBlockCustomResponseResponseHeaderArgs {
    ...
    public String name() {
        ...
        throw new UndeferrableValueException("Value 'WebAclDefaultActionBlockCustomResponseResponseHeaderArgs.name' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'WebAclDefaultActionBlockCustomResponseResponseHeaderArgs.value' is not present");
    }
