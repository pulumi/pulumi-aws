...
public final class DefaultSecurityGroupIngress {
    ...
    public @Nullable List<String> cidrBlocks() {
        ...
        return cidrBlocks.getValue("DefaultSecurityGroupIngress.cidrBlocks");
    }
    ...
    public @Nullable String description() {
        ...
        return description.getValue("DefaultSecurityGroupIngress.description");
    }
    ...
    public Integer fromPort() {
        ...
        return fromPort.getValue("DefaultSecurityGroupIngress.fromPort");
    }
    ...
    public @Nullable List<String> ipv6CidrBlocks() {
        ...
        return ipv6CidrBlocks.getValue("DefaultSecurityGroupIngress.ipv6CidrBlocks");
    }
    ...
    public @Nullable List<String> prefixListIds() {
        ...
        return prefixListIds.getValue("DefaultSecurityGroupIngress.prefixListIds");
    }
    ...
    public String protocol() {
        ...
        return protocol.getValue("DefaultSecurityGroupIngress.protocol");
    }
    ...
    public @Nullable List<String> securityGroups() {
        ...
        return securityGroups.getValue("DefaultSecurityGroupIngress.securityGroups");
    }
    ...
    public @Nullable Boolean self() {
        ...
        return self.getValue("DefaultSecurityGroupIngress.self");
    }
    ...
    public Integer toPort() {
        ...
        return toPort.getValue("DefaultSecurityGroupIngress.toPort");
    }
