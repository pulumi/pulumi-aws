...
public final class PatchBaselineSourceArgs {
    ...
    public String configuration() {
        ...
        return configuration.getValue("PatchBaselineSourceArgs.configuration");
    }
    ...
    public String name() {
        ...
        return name.getValue("PatchBaselineSourceArgs.name");
    }
    ...
    public List<String> products() {
        ...
        return products.getValue("PatchBaselineSourceArgs.products");
    }
