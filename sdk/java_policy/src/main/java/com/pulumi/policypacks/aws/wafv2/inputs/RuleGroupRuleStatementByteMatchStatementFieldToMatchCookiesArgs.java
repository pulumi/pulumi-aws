...
import com.pulumi.policypacks.aws.wafv2.inputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs;
import java.lang.String;
import java.util.List;


public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesArgs {
    ...
    private List<RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs> value_matchPatterns;
    private boolean unknown_matchPatterns;
    public List<RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs> matchPatterns() {
        if (!unknown_matchPatterns) return value_matchPatterns;
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesArgs.matchPatterns' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesArgs.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesArgs.oversizeHandling' is not present");
    }
