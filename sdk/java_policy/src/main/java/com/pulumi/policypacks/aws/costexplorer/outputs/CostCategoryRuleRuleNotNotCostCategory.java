...
public final class CostCategoryRuleRuleNotNotCostCategory {
    ...
    public @Nullable String key() {
        ...
        return key.getValue("CostCategoryRuleRuleNotNotCostCategory.key");
    }
    ...
    public @Nullable List<String> matchOptions() {
        ...
        return matchOptions.getValue("CostCategoryRuleRuleNotNotCostCategory.matchOptions");
    }
    ...
    public @Nullable List<String> values() {
        ...
        return values.getValue("CostCategoryRuleRuleNotNotCostCategory.values");
    }
