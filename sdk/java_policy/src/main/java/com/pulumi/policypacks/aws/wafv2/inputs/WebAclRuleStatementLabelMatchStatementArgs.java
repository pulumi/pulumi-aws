...
public final class WebAclRuleStatementLabelMatchStatementArgs {
    ...
    public String key() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementLabelMatchStatementArgs.key' is not present");
    }
    ...
    public String scope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementLabelMatchStatementArgs.scope' is not present");
    }
