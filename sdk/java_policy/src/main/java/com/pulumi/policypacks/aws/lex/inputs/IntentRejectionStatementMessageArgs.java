...
public final class IntentRejectionStatementMessageArgs {
    ...
    public String content() {
        ...
        throw new UndeferrableValueException("Value 'IntentRejectionStatementMessageArgs.content' is not present");
    }
    ...
    public String contentType() {
        ...
        throw new UndeferrableValueException("Value 'IntentRejectionStatementMessageArgs.contentType' is not present");
    }
    ...
    public Integer groupNumber() {
        ...
        throw new UndeferrableValueException("Value 'IntentRejectionStatementMessageArgs.groupNumber' is not present");
    }
