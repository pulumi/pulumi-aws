...
public final class NetworkInsightsAnalysisExplanationComponent {
    ...
    public @Nullable String arn() {
        ...
        return arn.getValue("NetworkInsightsAnalysisExplanationComponent.arn");
    }
    ...
    public @Nullable String id() {
        ...
        return id.getValue("NetworkInsightsAnalysisExplanationComponent.id");
    }
    ...
    public @Nullable String name() {
        ...
        return name.getValue("NetworkInsightsAnalysisExplanationComponent.name");
    }
