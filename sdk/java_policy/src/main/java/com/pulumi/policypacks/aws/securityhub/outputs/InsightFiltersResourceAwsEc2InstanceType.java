...
public final class InsightFiltersResourceAwsEc2InstanceType {
    ...
    public String comparison() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceAwsEc2InstanceType.comparison' is not present");
    }
    ...
    public String value() {
        ...
        throw new UndeferrableValueException("Value 'InsightFiltersResourceAwsEc2InstanceType.value' is not present");
    }
