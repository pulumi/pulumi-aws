...
public final class V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction {
    ...
    public @Nullable String slotToElicit() {
        ...
        return slotToElicit.getValue("V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction.slotToElicit");
    }
    ...
    public @Nullable Boolean suppressNextMessage() {
        ...
        return suppressNextMessage.getValue("V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction.suppressNextMessage");
    }
    ...
    public String type() {
        ...
        return type.getValue("V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction.type");
    }
