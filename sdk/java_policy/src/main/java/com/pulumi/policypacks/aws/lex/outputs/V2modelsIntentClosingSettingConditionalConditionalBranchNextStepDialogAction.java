...
public final class V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction {
    ...
    public @Nullable String slotToElicit() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction.slotToElicit' is not present");
    }
    ...
    public @Nullable Boolean suppressNextMessage() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction.suppressNextMessage' is not present");
    }
    ...
    public String type() {
        ...
        throw new UndeferrableValueException("Value 'V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogAction.type' is not present");
    }
