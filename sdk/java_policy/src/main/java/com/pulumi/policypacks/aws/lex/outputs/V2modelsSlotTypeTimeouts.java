...
public final class V2modelsSlotTypeTimeouts {
    ...
    public @Nullable String create() {
        ...
        return create.getValue("V2modelsSlotTypeTimeouts.create");
    }
    ...
    public @Nullable String delete() {
        ...
        return delete.getValue("V2modelsSlotTypeTimeouts.delete");
    }
    ...
    public @Nullable String update() {
        ...
        return update.getValue("V2modelsSlotTypeTimeouts.update");
    }
