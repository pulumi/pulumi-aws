...
public final class FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions {
    ...
    public @Nullable Boolean enabled() {
        ...
        return enabled.getValue("FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions.enabled");
    }
    ...
    public @Nullable String logGroupName() {
        ...
        return logGroupName.getValue("FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions.logGroupName");
    }
    ...
    public @Nullable String logStreamName() {
        ...
        return logStreamName.getValue("FirehoseDeliveryStreamElasticsearchConfigurationCloudwatchLoggingOptions.logStreamName");
    }
