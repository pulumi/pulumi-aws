...
import com.pulumi.policypacks.aws.wafv2.outputs.WebAclRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern;
...
public final class WebAclRuleStatementRegexMatchStatementFieldToMatchCookies {
    ...
    private List<WebAclRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern> value_matchPatterns;
    ...
    public List<WebAclRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexMatchStatementFieldToMatchCookies.matchPatterns' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexMatchStatementFieldToMatchCookies.matchScope' is not present");
    }
    ...
    public String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexMatchStatementFieldToMatchCookies.oversizeHandling' is not present");
    }
