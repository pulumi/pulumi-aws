...
import com.pulumi.policypacks.aws.wafv2.outputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern;
import java.lang.String;
import javax.annotation.Nullable;


public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody.invalidFallbackBehavior' is not present");
    }
    ...
    private RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern value_matchPattern;
    private boolean unknown_matchPattern;
    public RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        if (!unknown_matchPattern) return value_matchPattern;
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody.matchPattern' is not present");
    }
    ...
    public String matchScope() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody.matchScope' is not present");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody.oversizeHandling' is not present");
    }
