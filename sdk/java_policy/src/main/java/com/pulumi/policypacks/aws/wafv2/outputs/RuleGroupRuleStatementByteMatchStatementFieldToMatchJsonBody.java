...
public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody {
    ...
    public @Nullable String invalidFallbackBehavior() {
        ...
        return invalidFallbackBehavior.getValue("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody.invalidFallbackBehavior");
    }
     ...
     * 
     */
    private UndeferrableValue<RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern;
    ...
    public RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
        ...
        return matchPattern.getValue("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody.matchPattern");
    }
    ...
    public String matchScope() {
        ...
        return matchScope.getValue("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody.matchScope");
    }
    ...
    public @Nullable String oversizeHandling() {
        ...
        return oversizeHandling.getValue("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody.oversizeHandling");
    }
