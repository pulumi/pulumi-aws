...
public final class PipelineTriggerAllGitConfigurationPushFilePath {
    ...
    public @Nullable List<String> excludes() {
        ...
        throw new UndeferrableValueException("Value 'PipelineTriggerAllGitConfigurationPushFilePath.excludes' is not present");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        throw new UndeferrableValueException("Value 'PipelineTriggerAllGitConfigurationPushFilePath.includes' is not present");
    }
