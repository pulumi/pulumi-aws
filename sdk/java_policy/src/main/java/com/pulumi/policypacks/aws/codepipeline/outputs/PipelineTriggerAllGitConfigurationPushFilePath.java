...
public final class PipelineTriggerAllGitConfigurationPushFilePath {
    ...
    public @Nullable List<String> excludes() {
        ...
        return excludes.getValue("PipelineTriggerAllGitConfigurationPushFilePath.excludes");
    }
    ...
    public @Nullable List<String> includes() {
        ...
        return includes.getValue("PipelineTriggerAllGitConfigurationPushFilePath.includes");
    }
