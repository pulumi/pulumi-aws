...
namespace Pulumi.Aws.ArcRegionSwitch.Outputs
{
    ...
    public sealed class PlanWorkflowStepCustomActionLambdaConfig
    {
        ...
        private PlanWorkflowStepCustomActionLambdaConfig(
            ImmutableArray<Outputs.PlanWorkflowStepCustomActionLambdaConfigLambda> lambdas,
            ...
            ImmutableArray<Outputs.PlanWorkflowStepCustomActionLambdaConfigUngraceful> ungracefuls)
        {
            Lambdas = lambdas;
