...
namespace Pulumi.Aws.WafRegional
{
    ...
    /// {
    ///     var exampleRegexPatternSet = new Aws.Wafregional.RegexPatternSet.RegexPatternSet("exampleRegexPatternSet", new()
    ///     {
    ...
    ///     });
    /// 
    ///     var exampleRegexMatchSet = new Aws.Wafregional.RegexMatchSet.RegexMatchSet("exampleRegexMatchSet", new()
    ///     {
    ...
    public partial class RegexMatchSet : global::Pulumi.CustomResource
    {
        ...
        public RegexMatchSet(string name, RegexMatchSetArgs? args = null, CustomResourceOptions? options = null)
            : base("aws:wafregional/regexMatchSet:RegexMatchSet", name, args ?? new RegexMatchSetArgs(), MakeResourceOptions(options, ""))
        {
        }

        private RegexMatchSet(string name, Input<string> id, RegexMatchSetState? state = null, CustomResourceOptions? options = null)
            : base("aws:wafregional/regexMatchSet:RegexMatchSet", name, state, MakeResourceOptions(options, id))
        {
        }
