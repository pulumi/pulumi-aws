...
namespace Pulumi.Aws.WafRegional
{
    ...
    /// ```
    /// </summary>
    [AwsResourceType("aws:wafregional/rateBasedRule:RateBasedRule")]
    public partial class RateBasedRule : Pulumi.CustomResource
    {
        ...
        public RateBasedRule(string name, RateBasedRuleArgs args, CustomResourceOptions? options = null)
            : base("aws:wafregional/rateBasedRule:RateBasedRule", name, args ?? new RateBasedRuleArgs(), MakeResourceOptions(options, ""))
        {
        }
