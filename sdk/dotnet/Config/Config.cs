...
namespace Pulumi.Aws
{
    public static class Config
    {
        ...
        private static readonly __Value<Pulumi.Aws.Region?> _region = new __Value<Pulumi.Aws.Region?>(() => __config.GetObject<Pulumi.Aws.Region>("region") ?? Utilities.GetEnv("AWS_REGION", "AWS_DEFAULT_REGION"));
        /// <summary>
