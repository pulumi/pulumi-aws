...
namespace Pulumi.Aws.Batch.Inputs
{
    ...
    public sealed class JobDefinitionEksPropertiesPodPropertiesInitContainerGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("args")]
        ...
        {
            get => _envs ?? (_envs = new InputList<Inputs.JobDefinitionEksPropertiesPodPropertiesInitContainerEnvGetArgs>());
            set => _envs = value;
        }
        ...
        public Input<Inputs.JobDefinitionEksPropertiesPodPropertiesInitContainerSecurityContextGetArgs>? SecurityContext { get; set; }
        ...
        {
            get => _volumeMounts ?? (_volumeMounts = new InputList<Inputs.JobDefinitionEksPropertiesPodPropertiesInitContainerVolumeMountGetArgs>());
            set => _volumeMounts = value;
        }

        public JobDefinitionEksPropertiesPodPropertiesInitContainerGetArgs()
        {
        }
        public static new JobDefinitionEksPropertiesPodPropertiesInitContainerGetArgs Empty => new JobDefinitionEksPropertiesPodPropertiesInitContainerGetArgs();
    }
}
