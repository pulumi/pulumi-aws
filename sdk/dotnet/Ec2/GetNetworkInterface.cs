...
namespace Pulumi.Aws.Ec2
{
    public static partial class Invokes
    {
        ...
        public static Task<GetNetworkInterfaceResult> GetNetworkInterface(GetNetworkInterfaceArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetNetworkInterfaceResult>("aws:ec2/getNetworkInterface:getNetworkInterface", args ?? ResourceArgs.Empty, options.WithVersion());
    }
