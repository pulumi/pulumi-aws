...
namespace Pulumi.Aws.Ec2
{
    ...
    public sealed class GetVpcArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("filters")]
        private InputList<Inputs.GetVpcFiltersArgs>? _filters;

        /// <summary>
        /// Custom filter block as described below.
        /// </summary>
        public InputList<Inputs.GetVpcFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetVpcFiltersArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetVpcFiltersArgs : Pulumi.ResourceArgs
    {
        /// <summary>
