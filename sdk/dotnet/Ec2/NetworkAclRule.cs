...
namespace Pulumi.Aws.Ec2
{
    ...
    /// {
    ///     var barNetworkAcl = new Aws.Ec2.NetworkAcl.NetworkAcl("barNetworkAcl", new()
    ///     {
    ///         VpcId = aws_vpc.Foo.Id,
    ///     });
    /// 
    ///     var barNetworkAclRule = new Aws.Ec2.NetworkAclRule.NetworkAclRule("barNetworkAclRule", new()
    ///     {
