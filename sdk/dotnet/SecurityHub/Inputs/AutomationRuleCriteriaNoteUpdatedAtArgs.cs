...
namespace Pulumi.Aws.SecurityHub.Inputs
{
    ...
    public sealed class AutomationRuleCriteriaNoteUpdatedAtArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A configuration block of the date range for the date filter. See DateRange below for more details.
        /// </summary>
        [Input("dateRange")]
        public Input<Inputs.AutomationRuleCriteriaNoteUpdatedAtDateRangeArgs>? DateRange { get; set; }
        ...
        public AutomationRuleCriteriaNoteUpdatedAtArgs()
        {
        }
        public static new AutomationRuleCriteriaNoteUpdatedAtArgs Empty => new AutomationRuleCriteriaNoteUpdatedAtArgs();
    }
}
