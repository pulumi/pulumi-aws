...
namespace Pulumi.Aws.SecurityHub.Inputs
{
    ...
    public sealed class AutomationRuleCriteriaUpdatedAtGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// A configuration block of the date range for the date filter. See dateRange below for more details.
        /// </summary>
        [Input("dateRange")]
        public Input<Inputs.AutomationRuleCriteriaUpdatedAtDateRangeGetArgs>? DateRange { get; set; }
        ...
        public AutomationRuleCriteriaUpdatedAtGetArgs()
        {
        }
        public static new AutomationRuleCriteriaUpdatedAtGetArgs Empty => new AutomationRuleCriteriaUpdatedAtGetArgs();
    }
}
