...
namespace Pulumi.Aws.WafV2.Outputs
{
    ...
    [OutputType]
    public sealed class WebAclRuleStatementNotStatementStatementRegexMatchStatementFieldToMatchBody
    {
        /// <summary>
        ...
        [OutputConstructor]
        private WebAclRuleStatementNotStatementStatementRegexMatchStatementFieldToMatchBody(string? oversizeHandling)
        {
