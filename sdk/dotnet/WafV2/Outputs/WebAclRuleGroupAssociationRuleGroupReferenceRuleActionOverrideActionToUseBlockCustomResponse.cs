...
namespace Pulumi.Aws.WafV2.Outputs
{
    ...
    public sealed class WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUseBlockCustomResponse
    {
        ...
        [OutputConstructor]
        private WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUseBlockCustomResponse(
            string? customResponseBodyKey,

            int responseCode,

            ImmutableArray<Outputs.WebAclRuleGroupAssociationRuleGroupReferenceRuleActionOverrideActionToUseBlockCustomResponseResponseHeader> responseHeaders)
        {
