...
namespace Pulumi.Aws.WafV2.Outputs
{
    ...
    [OutputType]
    public sealed class WebAclAssociationConfigRequestBodyCloudfront
    {
        /// <summary>
        ...
        [OutputConstructor]
        private WebAclAssociationConfigRequestBodyCloudfront(string defaultSizeInspectionLimit)
        {
