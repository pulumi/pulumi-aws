...
namespace Pulumi.Aws.WafV2.Outputs
{
    ...
    [OutputType]
    public sealed class WebAclAssociationConfigRequestBodyVerifiedAccessInstance
    {
        /// <summary>
        ...
        [OutputConstructor]
        private WebAclAssociationConfigRequestBodyVerifiedAccessInstance(string defaultSizeInspectionLimit)
        {
