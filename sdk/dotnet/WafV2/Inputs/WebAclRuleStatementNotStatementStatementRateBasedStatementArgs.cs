...
namespace Pulumi.Aws.WafV2.Inputs
{
    ...
    public sealed class WebAclRuleStatementNotStatementStatementRateBasedStatementArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("customKeys")]
        private InputList<Inputs.WebAclRuleStatementNotStatementStatementRateBasedStatementCustomKeyArgs>? _customKeys;

        /// <summary>
        /// Aggregate the request counts using one or more web request components as the aggregate keys. See Custom Keys below.
        /// </summary>
        public InputList<Inputs.WebAclRuleStatementNotStatementStatementRateBasedStatementCustomKeyArgs> CustomKeys
        {
            get => _customKeys ?? (_customKeys = new InputList<Inputs.WebAclRuleStatementNotStatementStatementRateBasedStatementCustomKeyArgs>());
        ...
        public Input<Inputs.WebAclRuleStatementNotStatementStatementRateBasedStatementForwardedIpConfigArgs>? ForwardedIpConfig { get; set; }
        ...
        public Input<Inputs.WebAclRuleStatementNotStatementStatementRateBasedStatementScopeDownStatementArgs>? ScopeDownStatement { get; set; }

        public WebAclRuleStatementNotStatementStatementRateBasedStatementArgs()
        {
        }
        public static new WebAclRuleStatementNotStatementStatementRateBasedStatementArgs Empty => new WebAclRuleStatementNotStatementStatementRateBasedStatementArgs();
    }
}
