...
namespace Pulumi.Aws.WafV2.Inputs
{
    ...
    public sealed class RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatchArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cookies")]
        public Input<Inputs.RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs>? Cookies { get; set; }

        [Input("headers")]
        private InputList<Inputs.RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs>? _headers;

        /// <summary>
        /// Inspect the request headers. See Headers below for details.
        /// </summary>
        public InputList<Inputs.RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs> Headers
        {
            get => _headers ?? (_headers = new InputList<Inputs.RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs>());
            set => _headers = value;
        }
        ...
        /// </summary>
        [Input("jsonBody")]
        public Input<Inputs.RuleGroupRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs>? JsonBody { get; set; }
