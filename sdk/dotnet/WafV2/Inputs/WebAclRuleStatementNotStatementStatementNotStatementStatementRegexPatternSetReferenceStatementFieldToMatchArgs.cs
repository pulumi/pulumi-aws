...
namespace Pulumi.Aws.WafV2.Inputs
{
    ...
    public sealed class WebAclRuleStatementNotStatementStatementNotStatementStatementRegexPatternSetReferenceStatementFieldToMatchArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("headerOrders")]
        private InputList<Inputs.WebAclRuleStatementNotStatementStatementNotStatementStatementRegexPatternSetReferenceStatementFieldToMatchHeaderOrderArgs>? _headerOrders;
        ...
        /// </summary>
        public InputList<Inputs.WebAclRuleStatementNotStatementStatementNotStatementStatementRegexPatternSetReferenceStatementFieldToMatchHeaderOrderArgs> HeaderOrders
        {
            get => _headerOrders ?? (_headerOrders = new InputList<Inputs.WebAclRuleStatementNotStatementStatementNotStatementStatementRegexPatternSetReferenceStatementFieldToMatchHeaderOrderArgs>());
        ...
        public Input<Inputs.WebAclRuleStatementNotStatementStatementNotStatementStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs>? Ja3Fingerprint { get; set; }

        /// <summary>
        /// Match against the request's JA4 fingerprint (CloudFront and ALB only). See JA4 Fingerprint below.
        /// </summary>
        [Input("ja4Fingerprint")]
        public Input<Inputs.WebAclRuleStatementNotStatementStatementNotStatementStatementRegexPatternSetReferenceStatementFieldToMatchJa4FingerprintArgs>? Ja4Fingerprint { get; set; }
        ...
        /// </summary>
        [Input("uriFragment")]
        public Input<Inputs.WebAclRuleStatementNotStatementStatementNotStatementStatementRegexPatternSetReferenceStatementFieldToMatchUriFragmentArgs>? UriFragment { get; set; }
