...
namespace Pulumi.Aws.AutoScaling.Inputs
{
    ...
    public sealed class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryArgs : Pulumi.ResourceArgs
    {
        /// <summary>
