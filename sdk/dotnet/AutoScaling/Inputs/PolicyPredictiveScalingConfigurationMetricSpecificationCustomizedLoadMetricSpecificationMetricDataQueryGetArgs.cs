...
namespace Pulumi.Aws.AutoScaling.Inputs
{
    ...
    public sealed class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedLoadMetricSpecificationMetricDataQueryGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
