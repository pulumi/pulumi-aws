...
namespace Pulumi.Aws.AutoScaling.Inputs
{
    ...
    public sealed class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryArgs : Pulumi.ResourceArgs
    {
        /// <summary>
