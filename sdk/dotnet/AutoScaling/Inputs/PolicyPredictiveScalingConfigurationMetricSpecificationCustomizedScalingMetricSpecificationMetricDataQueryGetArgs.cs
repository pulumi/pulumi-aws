...
namespace Pulumi.Aws.AutoScaling.Inputs
{
    ...
    public sealed class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedScalingMetricSpecificationMetricDataQueryGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
