...
namespace Pulumi.Aws.ElasticLoadBalancingV2
{
    public static partial class Invokes
    {
        ...
        public static Task<GetLoadBalancerResult> GetLoadBalancer(GetLoadBalancerArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetLoadBalancerResult>("aws:elasticloadbalancingv2/getLoadBalancer:getLoadBalancer", args ?? ResourceArgs.Empty, options.WithVersion());
    }
