...
namespace Pulumi.Aws.OpsWorks.Inputs
{
    ...
    public sealed class MemcachedLayerLoadBasedAutoScalingDownscalingGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("alarms")]
        ...
        public MemcachedLayerLoadBasedAutoScalingDownscalingGetArgs()
        {
        }
        public static new MemcachedLayerLoadBasedAutoScalingDownscalingGetArgs Empty => new MemcachedLayerLoadBasedAutoScalingDownscalingGetArgs();
    }
}
