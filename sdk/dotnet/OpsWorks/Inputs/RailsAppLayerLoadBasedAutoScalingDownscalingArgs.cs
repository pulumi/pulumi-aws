...
namespace Pulumi.Aws.OpsWorks.Inputs
{
    ...
    public sealed class RailsAppLayerLoadBasedAutoScalingDownscalingArgs : global::Pulumi.ResourceArgs
    {
        [Input("alarms")]
        ...
        public RailsAppLayerLoadBasedAutoScalingDownscalingArgs()
        {
        }
        public static new RailsAppLayerLoadBasedAutoScalingDownscalingArgs Empty => new RailsAppLayerLoadBasedAutoScalingDownscalingArgs();
    }
}
