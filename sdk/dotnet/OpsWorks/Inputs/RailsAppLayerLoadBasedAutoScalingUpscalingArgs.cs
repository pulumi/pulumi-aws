...
namespace Pulumi.Aws.OpsWorks.Inputs
{
    ...
    public sealed class RailsAppLayerLoadBasedAutoScalingUpscalingArgs : global::Pulumi.ResourceArgs
    {
        [Input("alarms")]
        ...
        public RailsAppLayerLoadBasedAutoScalingUpscalingArgs()
        {
        }
        public static new RailsAppLayerLoadBasedAutoScalingUpscalingArgs Empty => new RailsAppLayerLoadBasedAutoScalingUpscalingArgs();
    }
}
