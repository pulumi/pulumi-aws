...
namespace Pulumi.Aws.OpsWorks.Inputs
{
    ...
    public sealed class MysqlLayerLoadBasedAutoScalingUpscalingArgs : global::Pulumi.ResourceArgs
    {
        [Input("alarms")]
        ...
        public MysqlLayerLoadBasedAutoScalingUpscalingArgs()
        {
        }
        public static new MysqlLayerLoadBasedAutoScalingUpscalingArgs Empty => new MysqlLayerLoadBasedAutoScalingUpscalingArgs();
    }
}
