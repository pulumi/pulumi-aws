...
namespace Pulumi.Aws.OpsWorks.Inputs
{
    ...
    public sealed class MemcachedLayerLoadBasedAutoScalingUpscalingGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("alarms")]
        ...
        public MemcachedLayerLoadBasedAutoScalingUpscalingGetArgs()
        {
        }
        public static new MemcachedLayerLoadBasedAutoScalingUpscalingGetArgs Empty => new MemcachedLayerLoadBasedAutoScalingUpscalingGetArgs();
    }
}
