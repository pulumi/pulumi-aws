...
namespace Pulumi.Aws.OpsWorks.Inputs
{
    ...
    public sealed class MemcachedLayerLoadBasedAutoScalingDownscalingArgs : global::Pulumi.ResourceArgs
    {
        [Input("alarms")]
        ...
        public MemcachedLayerLoadBasedAutoScalingDownscalingArgs()
        {
        }
        public static new MemcachedLayerLoadBasedAutoScalingDownscalingArgs Empty => new MemcachedLayerLoadBasedAutoScalingDownscalingArgs();
    }
}
