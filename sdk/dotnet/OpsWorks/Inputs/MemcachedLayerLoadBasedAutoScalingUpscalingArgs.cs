...
namespace Pulumi.Aws.OpsWorks.Inputs
{
    ...
    public sealed class MemcachedLayerLoadBasedAutoScalingUpscalingArgs : global::Pulumi.ResourceArgs
    {
        [Input("alarms")]
        ...
        public MemcachedLayerLoadBasedAutoScalingUpscalingArgs()
        {
        }
        public static new MemcachedLayerLoadBasedAutoScalingUpscalingArgs Empty => new MemcachedLayerLoadBasedAutoScalingUpscalingArgs();
    }
}
