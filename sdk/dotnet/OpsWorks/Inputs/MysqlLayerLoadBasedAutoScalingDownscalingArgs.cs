...
namespace Pulumi.Aws.OpsWorks.Inputs
{
    ...
    public sealed class MysqlLayerLoadBasedAutoScalingDownscalingArgs : global::Pulumi.ResourceArgs
    {
        [Input("alarms")]
        ...
        public MysqlLayerLoadBasedAutoScalingDownscalingArgs()
        {
        }
        public static new MysqlLayerLoadBasedAutoScalingDownscalingArgs Empty => new MysqlLayerLoadBasedAutoScalingDownscalingArgs();
    }
}
