...
namespace Pulumi.Aws.ElasticLoadBalancing
{
    ...
    /// </summary>
    [Obsolete(@"aws.elasticloadbalancing.AppCookieStickinessPolicy has been deprecated in favour of aws.elb.AppCookieStickinessPolicy")]
    public partial class AppCookieStickinessPolicy : Pulumi.CustomResource
    {
        ...
        public AppCookieStickinessPolicy(string name, AppCookieStickinessPolicyArgs args, CustomResourceOptions? options = null)
            : base("aws:elasticloadbalancing/appCookieStickinessPolicy:AppCookieStickinessPolicy", name, args ?? new AppCookieStickinessPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private AppCookieStickinessPolicy(string name, Input<string> id, AppCookieStickinessPolicyState? state = null, CustomResourceOptions? options = null)
            : base("aws:elasticloadbalancing/appCookieStickinessPolicy:AppCookieStickinessPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
