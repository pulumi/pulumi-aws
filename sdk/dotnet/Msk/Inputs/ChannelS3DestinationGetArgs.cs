...
namespace Pulumi.Aws.Msk.Inputs
{
    ...
    public sealed class ChannelS3DestinationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.ChannelS3DestinationDeadLetterQueueS3GetArgs> DeadLetterQueueS3 { get; set; } = null!;
        ...
        public Input<Inputs.ChannelS3DestinationStorageGetArgs> Storage { get; set; } = null!;

        public ChannelS3DestinationGetArgs()
        {
        }
        public static new ChannelS3DestinationGetArgs Empty => new ChannelS3DestinationGetArgs();
    }
}
