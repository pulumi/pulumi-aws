...
namespace Pulumi.Aws.Msk.Inputs
{
    ...
    public sealed class ChannelIcebergDestinationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("catalog")]
        public Input<Inputs.ChannelIcebergDestinationCatalogArgs>? Catalog { get; set; }
        ...
        public Input<Inputs.ChannelIcebergDestinationDeadLetterQueueS3Args> DeadLetterQueueS3 { get; set; } = null!;

        /// <summary>
        /// Destination Iceberg table. See `DestinationTable` Block below.
        /// </summary>
        [Input("destinationTable", required: true)]
        public Input<Inputs.ChannelIcebergDestinationDestinationTableArgs> DestinationTable { get; set; } = null!;
        ...
        public Input<Inputs.ChannelIcebergDestinationSchemaEvolutionArgs> SchemaEvolution { get; set; } = null!;
        ...
        public Input<Inputs.ChannelIcebergDestinationTableCreationArgs> TableCreation { get; set; } = null!;

        public ChannelIcebergDestinationArgs()
        {
        }
        public static new ChannelIcebergDestinationArgs Empty => new ChannelIcebergDestinationArgs();
    }
}
