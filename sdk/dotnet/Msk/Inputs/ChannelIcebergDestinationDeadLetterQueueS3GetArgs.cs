...
namespace Pulumi.Aws.Msk.Inputs
{
    ...
    public sealed class ChannelIcebergDestinationDeadLetterQueueS3GetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public ChannelIcebergDestinationDeadLetterQueueS3GetArgs()
        {
        }
        public static new ChannelIcebergDestinationDeadLetterQueueS3GetArgs Empty => new ChannelIcebergDestinationDeadLetterQueueS3GetArgs();
    }
}
