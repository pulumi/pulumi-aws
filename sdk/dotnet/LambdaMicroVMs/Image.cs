...
namespace Pulumi.Aws.LambdaMicroVMs
{
    ...
    /// ```
    /// </summary>
    [AwsResourceType("aws:lambdamicrovms/image:Image")]
    public partial class Image : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("codeArtifact")]
        public Output<Outputs.ImageCodeArtifact> CodeArtifact { get; private set; } = null!;

        /// <summary>
        /// CPU configuration for the MicroVM. See `CpuConfiguration` Block below.
        /// </summary>
        [Output("cpuConfigurations")]
        public Output<ImmutableArray<Outputs.ImageCpuConfiguration>> CpuConfigurations { get; private set; } = null!;
        ...
        public Image(string name, ImageArgs args, CustomResourceOptions? options = null)
            : base("aws:lambdamicrovms/image:Image", name, args ?? new ImageArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Image(string name, Input<string> id, ImageState? state = null, CustomResourceOptions? options = null)
            : base("aws:lambdamicrovms/image:Image", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            var defaultOptions = new CustomResourceOptions
            {
                ...
                Aliases =
                {
                    new global::Pulumi.Alias { Type = "aws:lambda/microvmsImage:MicrovmsImage" },
                },
            };
    ...
    public sealed class ImageArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ImageCodeArtifactArgs> CodeArtifact { get; set; } = null!;

        [Input("cpuConfigurations")]
        private InputList<Inputs.ImageCpuConfigurationArgs>? _cpuConfigurations;

        /// <summary>
        /// CPU configuration for the MicroVM. See `CpuConfiguration` Block below.
        /// </summary>
        public InputList<Inputs.ImageCpuConfigurationArgs> CpuConfigurations
        {
            get => _cpuConfigurations ?? (_cpuConfigurations = new InputList<Inputs.ImageCpuConfigurationArgs>());
    ...
    public sealed class ImageState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("codeArtifact")]
        public Input<Inputs.ImageCodeArtifactGetArgs>? CodeArtifact { get; set; }

        [Input("cpuConfigurations")]
        private InputList<Inputs.ImageCpuConfigurationGetArgs>? _cpuConfigurations;

        /// <summary>
        /// CPU configuration for the MicroVM. See `CpuConfiguration` Block below.
        /// </summary>
        public InputList<Inputs.ImageCpuConfigurationGetArgs> CpuConfigurations
        {
            get => _cpuConfigurations ?? (_cpuConfigurations = new InputList<Inputs.ImageCpuConfigurationGetArgs>());
            set => _cpuConfigurations = value;
        }
