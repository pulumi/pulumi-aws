...
namespace Pulumi.Aws.TimestreamWrite.Outputs
{
    ...
    public sealed class GetTableSchemaResult
    {
        ...
        [OutputConstructor]
        private GetTableSchemaResult(ImmutableArray<Outputs.GetTableSchemaCompositePartitionKeyResult> compositePartitionKeys)
        {
            CompositePartitionKeys = compositePartitionKeys;
        }
    }
}
