...
namespace Pulumi.Aws.Pricing
{
    ...
    public sealed class GetProductArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.GetProductFiltersArgs>? _filters;
        ...
        /// </summary>
        public InputList<Inputs.GetProductFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetProductFiltersArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetProductFiltersArgs : Pulumi.ResourceArgs
    {
        /// <summary>
