...
namespace Pulumi.Aws.Quicksight.Inputs
{
    ...
    public sealed class AnalysisDefinitionAnalysisDefaultsDefaultNewSheetConfigurationInteractiveLayoutConfigurationFreeFormCanvasSizeOptionsScreenCanvasSizeOptionsGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("optimizedViewPortWidth", required: true)]
        public Input<string> OptimizedViewPortWidth { get; set; } = null!;

        public AnalysisDefinitionAnalysisDefaultsDefaultNewSheetConfigurationInteractiveLayoutConfigurationFreeFormCanvasSizeOptionsScreenCanvasSizeOptionsGetArgs()
        {
        }
