...
namespace Pulumi.Aws.Quicksight.Inputs
{
    ...
    public sealed class DataSetPhysicalTableMapS3SourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        {
            get => _inputColumns ?? (_inputColumns = new InputList<Inputs.DataSetPhysicalTableMapS3SourceInputColumnArgs>());
        ...
        public DataSetPhysicalTableMapS3SourceArgs()
        {
        }
        public static new DataSetPhysicalTableMapS3SourceArgs Empty => new DataSetPhysicalTableMapS3SourceArgs();
    }
}
