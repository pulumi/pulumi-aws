...
namespace Pulumi.Aws.Quicksight.Inputs
{
    ...
    public sealed class AnalysisDefinitionAnalysisDefaultsDefaultNewSheetConfigurationInteractiveLayoutConfigurationFreeFormCanvasSizeOptionsScreenCanvasSizeOptionsArgs : global::Pulumi.ResourceArgs
    {
        [Input("optimizedViewPortWidth", required: true)]
        public Input<string> OptimizedViewPortWidth { get; set; } = null!;

        public AnalysisDefinitionAnalysisDefaultsDefaultNewSheetConfigurationInteractiveLayoutConfigurationFreeFormCanvasSizeOptionsScreenCanvasSizeOptionsArgs()
        {
        }
