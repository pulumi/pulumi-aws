...
namespace Pulumi.Aws.CodeBuild.Inputs
{
    ...
    public sealed class ProjectSecondarySourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("auth")]
        public Input<Inputs.ProjectSecondarySourceAuthArgs>? Auth { get; set; }
        ...
        public Input<Inputs.ProjectSecondarySourceBuildStatusConfigArgs>? BuildStatusConfig { get; set; }
        ...
        public static new ProjectSecondarySourceArgs Empty => new ProjectSecondarySourceArgs();
    }
}
