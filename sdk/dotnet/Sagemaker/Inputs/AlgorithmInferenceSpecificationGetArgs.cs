...
namespace Pulumi.Aws.Sagemaker.Inputs
{
    ...
    public sealed class AlgorithmInferenceSpecificationGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("containers", required: true)]
        private InputList<Inputs.AlgorithmInferenceSpecificationContainerGetArgs>? _containers;

        /// <summary>
        /// List of container definitions for inference.
        /// </summary>
        public InputList<Inputs.AlgorithmInferenceSpecificationContainerGetArgs> Containers
        {
            get => _containers ?? (_containers = new InputList<Inputs.AlgorithmInferenceSpecificationContainerGetArgs>());
        ...
        public AlgorithmInferenceSpecificationGetArgs()
        {
        }
        public static new AlgorithmInferenceSpecificationGetArgs Empty => new AlgorithmInferenceSpecificationGetArgs();
    }
}
