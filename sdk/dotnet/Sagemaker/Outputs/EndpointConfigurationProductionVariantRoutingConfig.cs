...
namespace Pulumi.Aws.Sagemaker.Outputs
{
    ...
    [OutputType]
    public sealed class EndpointConfigurationProductionVariantRoutingConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private EndpointConfigurationProductionVariantRoutingConfig(string routingStrategy)
        {
