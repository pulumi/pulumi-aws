...
namespace Pulumi.Aws.NetworkFirewall.Inputs
{
    ...
    public sealed class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationArgs : Pulumi.ResourceArgs
    {
        /// <summary>
