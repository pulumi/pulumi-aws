...
namespace Pulumi.Aws.Ec2TransitGateway.Inputs
{
    ...
    public sealed class PolicyTableEntryPolicyRuleArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("metadata")]
        public Input<Inputs.PolicyTableEntryPolicyRuleMetadataArgs>? Metadata { get; set; }
        ...
        public PolicyTableEntryPolicyRuleArgs()
        {
        }
        public static new PolicyTableEntryPolicyRuleArgs Empty => new PolicyTableEntryPolicyRuleArgs();
    }
}
