...
namespace Pulumi.Aws.CloudWatch.Inputs
{
    ...
    public sealed class MetricAlarmWarmUpConfigurationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("onlyStartEvaluatingAfterWarmUpPeriodEnds")]
        public Input<bool>? OnlyStartEvaluatingAfterWarmUpPeriodEnds { get; set; }

        /// <summary>
        /// Length of the warm-up period, in minutes. Valid values are `1` to `2880`.
        /// </summary>
        [Input("warmUpPeriodDurationInMinutes", required: true)]
        public Input<int> WarmUpPeriodDurationInMinutes { get; set; } = null!;

        public MetricAlarmWarmUpConfigurationGetArgs()
        {
        }
        public static new MetricAlarmWarmUpConfigurationGetArgs Empty => new MetricAlarmWarmUpConfigurationGetArgs();
    }
}
