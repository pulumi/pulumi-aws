...
namespace Pulumi.Aws.CloudWatchEvidently
{
    /// <summary>
    ...
    /// {
    ///     var example = new Aws.CloudWatchEvidently.Project("example", new()
    ///     {
    ...
    ///     var example = new Aws.CloudWatchEvidently.Project("example", new()
    ///     {
    ///         DataDelivery = new Aws.CloudWatchEvidently.Inputs.ProjectDataDeliveryArgs
    ///         {
    ///             CloudwatchLogs = new Aws.CloudWatchEvidently.Inputs.ProjectDataDeliveryCloudwatchLogsArgs
    ///             {
    ...
    ///         DataDelivery = new Aws.CloudWatchEvidently.Inputs.ProjectDataDeliveryArgs
    ///         {
    ///             S3Destination = new Aws.CloudWatchEvidently.Inputs.ProjectDataDeliveryS3DestinationArgs
    ///             {
    ...
    /// ```
    /// </summary>
    [AwsResourceType("aws:cloudwatchevidently/project:Project")]
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs? args = null, CustomResourceOptions? options = null)
            : base("aws:cloudwatchevidently/project:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, ProjectState? state = null, CustomResourceOptions? options = null)
            : base("aws:cloudwatchevidently/project:Project", name, state, MakeResourceOptions(options, id))
        {
        }
