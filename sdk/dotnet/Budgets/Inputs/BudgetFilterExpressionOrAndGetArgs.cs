...
namespace Pulumi.Aws.Budgets.Inputs
{
    ...
    public sealed class BudgetFilterExpressionOrAndGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("tags")]
        public Input<Inputs.BudgetFilterExpressionOrAndTagsGetArgs>? Tags { get; set; }

        public BudgetFilterExpressionOrAndGetArgs()
        {
        }
        public static new BudgetFilterExpressionOrAndGetArgs Empty => new BudgetFilterExpressionOrAndGetArgs();
    }
}
