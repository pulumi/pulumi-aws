...
namespace Pulumi.Aws.MailManager.Outputs
{
    ...
    [OutputType]
    public sealed class RuleSetRuleUnlessStringExpressionEvaluate
    {
        /// <summary>
        /// Add On result to evaluate. See `Analysis` Block.
        /// </summary>
        public readonly Outputs.RuleSetRuleUnlessStringExpressionEvaluateAnalysis? Analysis;
        /// <summary>
        ...
        private RuleSetRuleUnlessStringExpressionEvaluate(
            Outputs.RuleSetRuleUnlessStringExpressionEvaluateAnalysis? analysis,
