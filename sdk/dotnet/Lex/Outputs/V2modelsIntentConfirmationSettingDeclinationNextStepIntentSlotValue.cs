...
namespace Pulumi.Aws.Lex.Outputs
{
    ...
    [OutputType]
    public sealed class V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue
    {
        /// <summary>
        ...
        [OutputConstructor]
        private V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValue(string? interpretedValue)
        {
