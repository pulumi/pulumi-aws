...
namespace Pulumi.Aws.Lex.Outputs
{
    ...
    [OutputType]
    public sealed class V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranchNextStepIntentSlotValue
    {
        /// <summary>
        ...
        [OutputConstructor]
        private V2modelsIntentConfirmationSettingConfirmationConditionalDefaultBranchNextStepIntentSlotValue(string? interpretedValue)
        {
