...
namespace Pulumi.Aws.Lex.Outputs
{
    ...
    [OutputType]
    public sealed class V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutConditionalConditionalBranchNextStepIntentSlotValue
    {
        /// <summary>
        ...
        [OutputConstructor]
        private V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutConditionalConditionalBranchNextStepIntentSlotValue(string? interpretedValue)
        {
