...
namespace Pulumi.Aws.Lex.Outputs
{
    ...
    [OutputType]
    public sealed class V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutNextStepIntentSlotValue
    {
        /// <summary>
        ...
        [OutputConstructor]
        private V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutNextStepIntentSlotValue(string? interpretedValue)
        {
