...
namespace Pulumi.Aws.Lex.Outputs
{
    ...
    public sealed class V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroupVariationImageResponseCard
    {
        ...
        [OutputConstructor]
        private V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroupVariationImageResponseCard(
            ImmutableArray<Outputs.V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroupVariationImageResponseCardButton> buttons,
