...
namespace Pulumi.Aws.Lex.Inputs
{
    ...
    public sealed class V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingPromptSpecificationPromptAttemptsSpecificationTextInputSpecificationArgs : global::Pulumi.ResourceArgs
    {
        [Input("startTimeoutMs", required: true)]
        public Input<int> StartTimeoutMs { get; set; } = null!;

        public V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingPromptSpecificationPromptAttemptsSpecificationTextInputSpecificationArgs()
        {
        }
