...
namespace Pulumi.Aws.Lex.Inputs
{
    ...
    {
        [Input("customPayload")]
        public Input<Inputs.V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationContinueResponseMessageGroupMessageCustomPayloadArgs>? CustomPayload { get; set; }
