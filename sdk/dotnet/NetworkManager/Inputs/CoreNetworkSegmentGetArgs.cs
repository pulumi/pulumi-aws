...
namespace Pulumi.Aws.NetworkManager.Inputs
{
    ...
    public sealed class CoreNetworkSegmentGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("edgeLocations")]
        ...
        public CoreNetworkSegmentGetArgs()
        {
        }
        public static new CoreNetworkSegmentGetArgs Empty => new CoreNetworkSegmentGetArgs();
    }
}
