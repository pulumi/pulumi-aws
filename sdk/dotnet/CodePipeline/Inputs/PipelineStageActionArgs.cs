...
namespace Pulumi.Aws.CodePipeline.Inputs
{
    ...
    public sealed class PipelineStageActionArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.PipelineStageActionOutputArtifactsForComputeActionArgs>? _outputArtifactsForComputeActions;

        /// <summary>
        /// A block of output artifacts for the compute action. If the action is not `Compute`, this argument is ignored.
        /// </summary>
        public InputList<Inputs.PipelineStageActionOutputArtifactsForComputeActionArgs> OutputArtifactsForComputeActions
        {
            get => _outputArtifactsForComputeActions ?? (_outputArtifactsForComputeActions = new InputList<Inputs.PipelineStageActionOutputArtifactsForComputeActionArgs>());
