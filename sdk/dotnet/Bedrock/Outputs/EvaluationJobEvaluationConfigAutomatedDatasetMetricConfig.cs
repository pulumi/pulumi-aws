...
namespace Pulumi.Aws.Bedrock.Outputs
{
    ...
    [OutputType]
    public sealed class EvaluationJobEvaluationConfigAutomatedDatasetMetricConfig
    {
        /// <summary>
        /// Prompt dataset to use. See `Dataset` Block below.
        /// </summary>
        public readonly Outputs.EvaluationJobEvaluationConfigAutomatedDatasetMetricConfigDataset Dataset;
        /// <summary>
        ...
        private EvaluationJobEvaluationConfigAutomatedDatasetMetricConfig(
            Outputs.EvaluationJobEvaluationConfigAutomatedDatasetMetricConfigDataset dataset,
