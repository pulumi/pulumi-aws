...
namespace Pulumi.Aws.Bedrock.Outputs
{
    ...
    public sealed class AgentcoreGatewayTargetTargetConfigurationHttpAgentcoreRuntimeSchema
    {
        ...
        [OutputConstructor]
        private AgentcoreGatewayTargetTargetConfigurationHttpAgentcoreRuntimeSchema(Outputs.AgentcoreGatewayTargetTargetConfigurationHttpAgentcoreRuntimeSchemaSource source)
        {
            Source = source;
        }
    }
