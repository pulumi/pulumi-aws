...
namespace Pulumi.Aws.Bedrock.Inputs
{
    ...
    public sealed class EvaluationJobEvaluationConfigAutomatedDatasetMetricConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Prompt dataset to use. See `Dataset` Block below.
        /// </summary>
        [Input("dataset", required: true)]
        public Input<Inputs.EvaluationJobEvaluationConfigAutomatedDatasetMetricConfigDatasetArgs> Dataset { get; set; } = null!;
        ...
        public EvaluationJobEvaluationConfigAutomatedDatasetMetricConfigArgs()
        {
        }
        public static new EvaluationJobEvaluationConfigAutomatedDatasetMetricConfigArgs Empty => new EvaluationJobEvaluationConfigAutomatedDatasetMetricConfigArgs();
    }
}
