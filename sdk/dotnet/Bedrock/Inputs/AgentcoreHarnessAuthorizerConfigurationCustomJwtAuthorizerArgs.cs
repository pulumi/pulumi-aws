...
namespace Pulumi.Aws.Bedrock.Inputs
{
    ...
    public sealed class AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _customClaims ?? (_customClaims = new InputList<Inputs.AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerCustomClaimArgs>());
        ...
        {
            get => _privateEndpointOverrides ?? (_privateEndpointOverrides = new InputList<Inputs.AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerPrivateEndpointOverrideArgs>());
            set => _privateEndpointOverrides = value;
        }

        public AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerArgs()
        {
        }
        public static new AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerArgs Empty => new AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerArgs();
    }
}
