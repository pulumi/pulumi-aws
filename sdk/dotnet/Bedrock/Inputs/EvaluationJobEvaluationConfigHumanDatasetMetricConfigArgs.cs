...
namespace Pulumi.Aws.Bedrock.Inputs
{
    ...
    public sealed class EvaluationJobEvaluationConfigHumanDatasetMetricConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Prompt dataset to use. See `Dataset` Block below.
        /// </summary>
        [Input("dataset", required: true)]
        public Input<Inputs.EvaluationJobEvaluationConfigHumanDatasetMetricConfigDatasetArgs> Dataset { get; set; } = null!;
        ...
        public EvaluationJobEvaluationConfigHumanDatasetMetricConfigArgs()
        {
        }
        public static new EvaluationJobEvaluationConfigHumanDatasetMetricConfigArgs Empty => new EvaluationJobEvaluationConfigHumanDatasetMetricConfigArgs();
    }
}
