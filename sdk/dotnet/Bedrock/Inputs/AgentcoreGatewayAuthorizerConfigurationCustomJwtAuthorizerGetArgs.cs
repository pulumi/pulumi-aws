...
namespace Pulumi.Aws.Bedrock.Inputs
{
    ...
    public sealed class AgentcoreGatewayAuthorizerConfigurationCustomJwtAuthorizerGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AgentcoreGatewayAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfigurationGetArgs>? AllowedWorkloadConfiguration { get; set; }
        ...
        public Input<Inputs.AgentcoreGatewayAuthorizerConfigurationCustomJwtAuthorizerPrivateEndpointGetArgs>? PrivateEndpoint { get; set; }

        [Input("privateEndpointOverrides")]
        private InputList<Inputs.AgentcoreGatewayAuthorizerConfigurationCustomJwtAuthorizerPrivateEndpointOverrideGetArgs>? _privateEndpointOverrides;

        /// <summary>
        /// Overrides for the private endpoints used to reach the authorization server. See `PrivateEndpointOverrides` below.
        /// </summary>
        public InputList<Inputs.AgentcoreGatewayAuthorizerConfigurationCustomJwtAuthorizerPrivateEndpointOverrideGetArgs> PrivateEndpointOverrides
        {
            get => _privateEndpointOverrides ?? (_privateEndpointOverrides = new InputList<Inputs.AgentcoreGatewayAuthorizerConfigurationCustomJwtAuthorizerPrivateEndpointOverrideGetArgs>());
