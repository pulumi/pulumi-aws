...
namespace Pulumi.Aws.Bedrock.Inputs
{
    ...
    public sealed class AgentcoreAgentRuntimeAuthorizerConfigurationCustomJwtAuthorizerArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.AgentcoreAgentRuntimeAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfigurationArgs>? AllowedWorkloadConfiguration { get; set; }
        ...
        public Input<Inputs.AgentcoreAgentRuntimeAuthorizerConfigurationCustomJwtAuthorizerPrivateEndpointArgs>? PrivateEndpoint { get; set; }

        [Input("privateEndpointOverrides")]
        private InputList<Inputs.AgentcoreAgentRuntimeAuthorizerConfigurationCustomJwtAuthorizerPrivateEndpointOverrideArgs>? _privateEndpointOverrides;

        /// <summary>
        /// Overrides for the private endpoints used to reach the authorization server. See `PrivateEndpointOverrides` below.
        /// </summary>
        public InputList<Inputs.AgentcoreAgentRuntimeAuthorizerConfigurationCustomJwtAuthorizerPrivateEndpointOverrideArgs> PrivateEndpointOverrides
        {
            get => _privateEndpointOverrides ?? (_privateEndpointOverrides = new InputList<Inputs.AgentcoreAgentRuntimeAuthorizerConfigurationCustomJwtAuthorizerPrivateEndpointOverrideArgs>());
