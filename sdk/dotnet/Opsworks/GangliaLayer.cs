...
namespace Pulumi.Aws.OpsWorks
{
    ...
    public partial class GangliaLayer : Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("ebsVolumes")]
        public Output<ImmutableArray<Outputs.GangliaLayerEbsVolumes>> EbsVolumes { get; private set; } = null!;
        ...
        public GangliaLayer(string name, GangliaLayerArgs args, CustomResourceOptions? options = null)
            : base("aws:opsworks/gangliaLayer:GangliaLayer", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }

        private GangliaLayer(string name, Input<string> id, GangliaLayerState? state = null, CustomResourceOptions? options = null)
            : base("aws:opsworks/gangliaLayer:GangliaLayer", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class GangliaLayerArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("ebsVolumes")]
        private InputList<Inputs.GangliaLayerEbsVolumesArgs>? _ebsVolumes;

        /// <summary>
        /// `ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
        /// </summary>
        public InputList<Inputs.GangliaLayerEbsVolumesArgs> EbsVolumes
        {
            get => _ebsVolumes ?? (_ebsVolumes = new InputList<Inputs.GangliaLayerEbsVolumesArgs>());
    ...
    public sealed class GangliaLayerState : Pulumi.ResourceArgs
    {
        ...
        [Input("ebsVolumes")]
        private InputList<Inputs.GangliaLayerEbsVolumesGetArgs>? _ebsVolumes;

        /// <summary>
        /// `ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
        /// </summary>
        public InputList<Inputs.GangliaLayerEbsVolumesGetArgs> EbsVolumes
        {
            get => _ebsVolumes ?? (_ebsVolumes = new InputList<Inputs.GangliaLayerEbsVolumesGetArgs>());
            set => _ebsVolumes = value;
        }
    ...
    public sealed class GangliaLayerEbsVolumesArgs : Pulumi.ResourceArgs
    {
        [Input("encrypted")]
        ...
        public GangliaLayerEbsVolumesArgs()
        {
        }
    }

    public sealed class GangliaLayerEbsVolumesGetArgs : Pulumi.ResourceArgs
    {
        [Input("encrypted")]
        public Input<bool>? Encrypted { get; set; }
        ...
        public GangliaLayerEbsVolumesGetArgs()
        {
        }
    }
    }
    ...
    [OutputType]
    public sealed class GangliaLayerEbsVolumes
    {
        ...
        [OutputConstructor]
        private GangliaLayerEbsVolumes(
            bool? encrypted,
            int? iops,
            string mountPoint,
            int numberOfDisks,
