...
namespace Pulumi.Aws.GuardDuty.Inputs
{
    ...
    public sealed class MemberDetectorFeatureAdditionalConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public MemberDetectorFeatureAdditionalConfigurationArgs()
        {
        }
        public static new MemberDetectorFeatureAdditionalConfigurationArgs Empty => new MemberDetectorFeatureAdditionalConfigurationArgs();
    }
}
