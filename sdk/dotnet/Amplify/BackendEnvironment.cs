...
namespace Pulumi.Aws.Amplify
{
    ...
    /// {
    ///     var exampleApp = new Aws.Amplify.App.App("exampleApp");
    /// 
    ///     var exampleBackendEnvironment = new Aws.Amplify.BackendEnvironment.BackendEnvironment("exampleBackendEnvironment", new()
    ///     {
    ///         AppId = exampleApp.Id,
