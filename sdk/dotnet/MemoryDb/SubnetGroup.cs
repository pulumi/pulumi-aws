...
namespace Pulumi.Aws.MemoryDb
{
    ...
    ///     });
    /// 
    ///     var exampleSubnetGroup = new Aws.Memorydb.SubnetGroup.SubnetGroup("exampleSubnetGroup", new()
    ///     {
    ///         SubnetIds = new[]
    ///         {
    ///             exampleSubnet.Id,
    ...
    public partial class SubnetGroup : global::Pulumi.CustomResource
    {
        ...
        public SubnetGroup(string name, SubnetGroupArgs args, CustomResourceOptions? options = null)
            : base("aws:memorydb/subnetGroup:SubnetGroup", name, args ?? new SubnetGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SubnetGroup(string name, Input<string> id, SubnetGroupState? state = null, CustomResourceOptions? options = null)
            : base("aws:memorydb/subnetGroup:SubnetGroup", name, state, MakeResourceOptions(options, id))
        {
        }
