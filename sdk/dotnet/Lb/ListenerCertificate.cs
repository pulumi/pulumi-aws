...
namespace Pulumi.Aws.LB
{
    ...
    public partial class ListenerCertificate : Pulumi.CustomResource
    {
        ...
        public ListenerCertificate(string name, ListenerCertificateArgs args, CustomResourceOptions? options = null)
            : base("aws:lb/listenerCertificate:ListenerCertificate", name, args ?? ResourceArgs.Empty, MakeResourceOptions(options, ""))
        {
        }
        ...
        private static CustomResourceOptions MakeResourceOptions(CustomResourceOptions? options, Input<string>? id)
        {
            ...
            {
                Version = Utilities.Version,                Aliases = { new Alias { Type = "aws:elasticloadbalancingv2/listenerCertificate:ListenerCertificate" } },
            };
