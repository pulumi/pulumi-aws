...
namespace Pulumi.Aws.CloudFront.Outputs
{
    ...
    [OutputType]
    public sealed class DistributionOriginCustomOriginConfigOriginMtlsConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DistributionOriginCustomOriginConfigOriginMtlsConfig(string clientCertificateArn)
        {
