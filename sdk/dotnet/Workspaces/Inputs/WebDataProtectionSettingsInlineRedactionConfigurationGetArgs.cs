...
namespace Pulumi.Aws.Workspaces.Inputs
{
    ...
    public sealed class WebDataProtectionSettingsInlineRedactionConfigurationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternGetArgs>? _inlineRedactionPatterns;

        /// <summary>
        /// The inline redaction patterns to be enabled for the inline redaction configuration. Detailed below.
        /// </summary>
        public InputList<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternGetArgs> InlineRedactionPatterns
        {
            get => _inlineRedactionPatterns ?? (_inlineRedactionPatterns = new InputList<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternGetArgs>());
            set => _inlineRedactionPatterns = value;
        }

        public WebDataProtectionSettingsInlineRedactionConfigurationGetArgs()
        {
        }
        public static new WebDataProtectionSettingsInlineRedactionConfigurationGetArgs Empty => new WebDataProtectionSettingsInlineRedactionConfigurationGetArgs();
    }
}
