...
namespace Pulumi.Aws.Workspaces.Inputs
{
    ...
    public sealed class WebUserSettingsToolbarConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public WebUserSettingsToolbarConfigurationArgs()
        {
        }
        public static new WebUserSettingsToolbarConfigurationArgs Empty => new WebUserSettingsToolbarConfigurationArgs();
    }
}
