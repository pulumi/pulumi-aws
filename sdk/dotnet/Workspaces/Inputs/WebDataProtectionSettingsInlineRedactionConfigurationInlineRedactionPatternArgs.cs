...
namespace Pulumi.Aws.Workspaces.Inputs
{
    ...
    public sealed class WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("customPattern")]
        public Input<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternCustomPatternArgs>? CustomPattern { get; set; }
        ...
        private InputList<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternRedactionPlaceHolderArgs>? _redactionPlaceHolders;

        /// <summary>
        /// The redaction placeholder that will replace the redacted text in session. Detailed below.
        /// </summary>
        public InputList<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternRedactionPlaceHolderArgs> RedactionPlaceHolders
        {
            get => _redactionPlaceHolders ?? (_redactionPlaceHolders = new InputList<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternRedactionPlaceHolderArgs>());
            set => _redactionPlaceHolders = value;
        }

        public WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs()
        {
        }
        public static new WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs Empty => new WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs();
    }
}
