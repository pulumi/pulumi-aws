...
namespace Pulumi.Aws.Workspaces.Inputs
{
    ...
    public sealed class WebDataProtectionSettingsInlineRedactionConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs>? _inlineRedactionPatterns;

        /// <summary>
        /// The inline redaction patterns to be enabled for the inline redaction configuration. Detailed below.
        /// </summary>
        public InputList<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs> InlineRedactionPatterns
        {
            get => _inlineRedactionPatterns ?? (_inlineRedactionPatterns = new InputList<Inputs.WebDataProtectionSettingsInlineRedactionConfigurationInlineRedactionPatternArgs>());
            set => _inlineRedactionPatterns = value;
        }

        public WebDataProtectionSettingsInlineRedactionConfigurationArgs()
        {
        }
        public static new WebDataProtectionSettingsInlineRedactionConfigurationArgs Empty => new WebDataProtectionSettingsInlineRedactionConfigurationArgs();
    }
}
