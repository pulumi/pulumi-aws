...
namespace Pulumi.Aws.Iam
{
    ...
    /// {
    ///     var exampleUser = new Aws.Iam.User.User("exampleUser", new()
    ///     {
    ///         Path = "/",
    ///         ForceDestroy = true,
    ///     });
    /// 
    ///     var exampleUserLoginProfile = new Aws.Iam.UserLoginProfile.UserLoginProfile("exampleUserLoginProfile", new()
    ///     {
