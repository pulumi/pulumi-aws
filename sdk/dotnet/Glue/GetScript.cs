...
namespace Pulumi.Aws.Glue
{
    public static partial class Invokes
    {
        ...
        public static Task<GetScriptResult> GetScript(GetScriptArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetScriptResult>("aws:glue/getScript:getScript", args ?? ResourceArgs.Empty, options.WithVersion());
    }

    public sealed class GetScriptArgs : Pulumi.ResourceArgs
    {
        [Input("dagEdges", required: true)]
        private InputList<Inputs.GetScriptDagEdgesArgs>? _dagEdges;

        /// <summary>
        /// A list of the edges in the DAG. Defined below.
        /// </summary>
        public InputList<Inputs.GetScriptDagEdgesArgs> DagEdges
        {
            get => _dagEdges ?? (_dagEdges = new InputList<Inputs.GetScriptDagEdgesArgs>());
            set => _dagEdges = value;
        }

        [Input("dagNodes", required: true)]
        private InputList<Inputs.GetScriptDagNodesArgs>? _dagNodes;

        /// <summary>
        /// A list of the nodes in the DAG. Defined below.
        /// </summary>
        public InputList<Inputs.GetScriptDagNodesArgs> DagNodes
        {
            get => _dagNodes ?? (_dagNodes = new InputList<Inputs.GetScriptDagNodesArgs>());
            set => _dagNodes = value;
        }
    ...
    public sealed class GetScriptDagEdgesArgs : Pulumi.ResourceArgs
    {
        /// <summary>
    ...
    public sealed class GetScriptDagNodesArgs : Pulumi.ResourceArgs
    {
        [Input("args", required: true)]
        private InputList<GetScriptDagNodesArgsArgs>? _args;

        /// <summary>
        /// Nested configuration an argument or property of a node. Defined below.
        /// </summary>
        public InputList<GetScriptDagNodesArgsArgs> Args
        {
            get => _args ?? (_args = new InputList<GetScriptDagNodesArgsArgs>());
            set => _args = value;
        }
    ...
    public sealed class GetScriptDagNodesArgsArgs : Pulumi.ResourceArgs
    {
        /// <summary>
