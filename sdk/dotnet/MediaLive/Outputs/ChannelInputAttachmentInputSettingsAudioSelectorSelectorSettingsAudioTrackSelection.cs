...
namespace Pulumi.Aws.MediaLive.Outputs
{
    ...
    public sealed class ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioTrackSelection
    {
        ...
        [OutputConstructor]
        private ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioTrackSelection(ImmutableArray<Outputs.ChannelInputAttachmentInputSettingsAudioSelectorSelectorSettingsAudioTrackSelectionTrack> tracks)
        {
            Tracks = tracks;
        }
    }
