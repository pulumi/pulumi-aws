...
namespace Pulumi.PolicyPacks.Aws.Macie2.Inputs
{
    public sealed class ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermArgs
    {
        ...
        [Input("tagValues")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValueArgs>> _mTagValues;

        public List<Inputs.ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermTagValueArgs>? TagValues => _mTagValues.GetValue("tagValues");
