...
namespace Pulumi.PolicyPacks.Aws.Macie2.Inputs
{
    public sealed class ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Inputs.ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionTagValueArgs>? _mValue_TagValues;
        private bool _mUnknown_TagValues;
        public List<Inputs.ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionTagValueArgs>? TagValues
        {
            get
            {
