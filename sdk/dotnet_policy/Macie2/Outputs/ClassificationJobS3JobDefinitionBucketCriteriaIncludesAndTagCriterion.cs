...
namespace Pulumi.PolicyPacks.Aws.Macie2.Outputs
{
    public sealed class ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterion
    {
        ...
        [Input("tagValues")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterionTagValue>> _mTagValues;

        public List<Outputs.ClassificationJobS3JobDefinitionBucketCriteriaIncludesAndTagCriterionTagValue>? TagValues => _mTagValues.GetValue("tagValues");
    }
}
