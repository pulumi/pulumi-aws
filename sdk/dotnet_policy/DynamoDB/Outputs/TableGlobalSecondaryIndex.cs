...
namespace Pulumi.PolicyPacks.Aws.DynamoDB.Outputs
{
    public sealed class TableGlobalSecondaryIndex
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.TableGlobalSecondaryIndexOnDemandThroughput> _mOnDemandThroughput;

        public Outputs.TableGlobalSecondaryIndexOnDemandThroughput? OnDemandThroughput => _mOnDemandThroughput.GetValue("onDemandThroughput");
