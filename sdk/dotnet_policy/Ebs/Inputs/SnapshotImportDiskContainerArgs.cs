...
namespace Pulumi.PolicyPacks.Aws.Ebs.Inputs
{
    public sealed class SnapshotImportDiskContainerArgs
    {
        ...
        [Input("userBucket")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Inputs.SnapshotImportDiskContainerUserBucketArgs> _mUserBucket;

        public Inputs.SnapshotImportDiskContainerUserBucketArgs? UserBucket => _mUserBucket.GetValue("userBucket");
    }
}
