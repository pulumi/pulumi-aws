...
namespace Pulumi.PolicyPacks.Aws.CloudWatch.Inputs
{
    public sealed class GetLogDataProtectionPolicyDocumentStatementArgs
    {
        ...
        [Input("operation")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Inputs.GetLogDataProtectionPolicyDocumentStatementOperationArgs> _mOperation;

        public Inputs.GetLogDataProtectionPolicyDocumentStatementOperationArgs? Operation => _mOperation.GetValue("operation");
