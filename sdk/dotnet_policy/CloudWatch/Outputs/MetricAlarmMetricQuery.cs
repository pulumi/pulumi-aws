...
namespace Pulumi.PolicyPacks.Aws.CloudWatch.Outputs
{
    public sealed class MetricAlarmMetricQuery
    {
        ...
        [Input("metric")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.MetricAlarmMetricQueryMetric> _mMetric;

        public Outputs.MetricAlarmMetricQueryMetric? Metric => _mMetric.GetValue("metric");
