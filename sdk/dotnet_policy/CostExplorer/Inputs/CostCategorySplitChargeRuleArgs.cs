...
{
    public sealed class CostCategorySplitChargeRuleArgs
    {
        /// <summary>
        ...
        [Input("parameters")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.CostCategorySplitChargeRuleParameterArgs>> _mParameters;

        public List<Inputs.CostCategorySplitChargeRuleParameterArgs>? Parameters => _mParameters.GetValue("parameters");
