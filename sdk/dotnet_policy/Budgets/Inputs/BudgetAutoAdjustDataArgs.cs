...
namespace Pulumi.PolicyPacks.Aws.Budgets.Inputs
{
    public sealed class BudgetAutoAdjustDataArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Inputs.BudgetAutoAdjustDataHistoricalOptionsArgs? _mValue_HistoricalOptions;
        private bool _mUnknown_HistoricalOptions;
        public Inputs.BudgetAutoAdjustDataHistoricalOptionsArgs? HistoricalOptions
        {
            get
            {
