...
namespace Pulumi.PolicyPacks.Aws.LakeFormation.Inputs
{
    public sealed class PermissionsLfTagPolicyArgs
    {
        ...
        [Input("expressions")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.PermissionsLfTagPolicyExpressionArgs>> _mExpressions;

        public List<Inputs.PermissionsLfTagPolicyExpressionArgs>? Expressions => _mExpressions.GetValue("expressions");
