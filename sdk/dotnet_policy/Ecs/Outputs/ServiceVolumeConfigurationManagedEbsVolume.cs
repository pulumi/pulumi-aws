...
namespace Pulumi.PolicyPacks.Aws.Ecs.Outputs
{
    public sealed class ServiceVolumeConfigurationManagedEbsVolume
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.ServiceVolumeConfigurationManagedEbsVolumeTagSpecification>> _mTagSpecifications;

        public List<Outputs.ServiceVolumeConfigurationManagedEbsVolumeTagSpecification>? TagSpecifications => _mTagSpecifications.GetValue("tagSpecifications");
