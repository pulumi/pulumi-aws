...
namespace Pulumi.PolicyPacks.Aws.Ecs.Outputs
{
    public sealed class ServiceVolumeConfigurationManagedEbsVolume
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.ServiceVolumeConfigurationManagedEbsVolumeTagSpecification>? _mValue_TagSpecifications;
        private bool _mUnknown_TagSpecifications;
        public List<Outputs.ServiceVolumeConfigurationManagedEbsVolumeTagSpecification>? TagSpecifications
        {
            get
            {
