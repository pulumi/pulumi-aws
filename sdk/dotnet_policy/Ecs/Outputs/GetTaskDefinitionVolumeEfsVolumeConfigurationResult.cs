...
namespace Pulumi.PolicyPacks.Aws.Ecs.Outputs
{
    public sealed class GetTaskDefinitionVolumeEfsVolumeConfigurationResult
    {
        ...
        private List<Outputs.GetTaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfigResult>? _mValue_AuthorizationConfigs;
        private bool _mUnknown_AuthorizationConfigs;
        public List<Outputs.GetTaskDefinitionVolumeEfsVolumeConfigurationAuthorizationConfigResult>? AuthorizationConfigs
        {
            get
            {
                if (!_mUnknown_AuthorizationConfigs) return _mValue_AuthorizationConfigs;
                throw new UndeferrableValueException("Value 'GetTaskDefinitionVolumeEfsVolumeConfigurationResult.AuthorizationConfigs' is not present");
            }
        }
        ...
        public string? FileSystemId
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetTaskDefinitionVolumeEfsVolumeConfigurationResult.FileSystemId' is not present");
            }
        }
        ...
        public string? RootDirectory
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetTaskDefinitionVolumeEfsVolumeConfigurationResult.RootDirectory' is not present");
            }
        }
        ...
        public string? TransitEncryption
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetTaskDefinitionVolumeEfsVolumeConfigurationResult.TransitEncryption' is not present");
            }
        }
        ...
        public int? TransitEncryptionPort
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetTaskDefinitionVolumeEfsVolumeConfigurationResult.TransitEncryptionPort' is not present");
            }
        }
    }
}
