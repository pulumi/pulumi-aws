...
namespace Pulumi.PolicyPacks.Aws.Ecs.Outputs
{
    public sealed class GetTaskExecutionOverridesResult
    {
        ...
        private List<Outputs.GetTaskExecutionOverridesContainerOverrideResult>? _mValue_ContainerOverrides;
        private bool _mUnknown_ContainerOverrides;
        public List<Outputs.GetTaskExecutionOverridesContainerOverrideResult>? ContainerOverrides
        {
            get
            {
                if (!_mUnknown_ContainerOverrides) return _mValue_ContainerOverrides;
                throw new UndeferrableValueException("Value 'GetTaskExecutionOverridesResult.ContainerOverrides' is not present");
            }
        }
        ...
        public string? Cpu
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetTaskExecutionOverridesResult.Cpu' is not present");
            }
        }
        ...
        public string? ExecutionRoleArn
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetTaskExecutionOverridesResult.ExecutionRoleArn' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.GetTaskExecutionOverridesInferenceAcceleratorOverrideResult>? _mValue_InferenceAcceleratorOverrides;
        private bool _mUnknown_InferenceAcceleratorOverrides;
        public List<Outputs.GetTaskExecutionOverridesInferenceAcceleratorOverrideResult>? InferenceAcceleratorOverrides
        {
            get
            {
                if (!_mUnknown_InferenceAcceleratorOverrides) return _mValue_InferenceAcceleratorOverrides;
                throw new UndeferrableValueException("Value 'GetTaskExecutionOverridesResult.InferenceAcceleratorOverrides' is not present");
            }
        }
        ...
        public string? Memory
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetTaskExecutionOverridesResult.Memory' is not present");
            }
        }
        ...
        public string? TaskRoleArn
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetTaskExecutionOverridesResult.TaskRoleArn' is not present");
            }
        }
    }
}
