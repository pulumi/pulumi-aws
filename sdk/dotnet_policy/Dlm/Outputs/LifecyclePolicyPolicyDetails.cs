...
namespace Pulumi.PolicyPacks.Aws.Dlm.Outputs
{
    public sealed class LifecyclePolicyPolicyDetails
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<Outputs.LifecyclePolicyPolicyDetailsAction> _mAction;

        public Outputs.LifecyclePolicyPolicyDetailsAction? Action => _mAction.GetValue("action");
        ...
        [Input("eventSource")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.LifecyclePolicyPolicyDetailsEventSource> _mEventSource;

        public Outputs.LifecyclePolicyPolicyDetailsEventSource? EventSource => _mEventSource.GetValue("eventSource");

        [Input("parameters")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.LifecyclePolicyPolicyDetailsParameters> _mParameters;

        public Outputs.LifecyclePolicyPolicyDetailsParameters? Parameters => _mParameters.GetValue("parameters");
        ...
        [Input("schedules")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.LifecyclePolicyPolicyDetailsSchedule>> _mSchedules;

        public List<Outputs.LifecyclePolicyPolicyDetailsSchedule>? Schedules => _mSchedules.GetValue("schedules");
