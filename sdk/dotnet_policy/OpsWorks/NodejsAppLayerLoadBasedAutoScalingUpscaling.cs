...
{
    [PolicyResourceType("aws:opsworks/NodejsAppLayerLoadBasedAutoScalingUpscaling:NodejsAppLayerLoadBasedAutoScalingUpscaling")]
    public sealed class NodejsAppLayerLoadBasedAutoScalingUpscaling
    {
        [Input("alarms")]
