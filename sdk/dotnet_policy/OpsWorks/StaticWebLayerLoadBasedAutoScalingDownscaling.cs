...
{
    [PolicyResourceType("aws:opsworks/StaticWebLayerLoadBasedAutoScalingDownscaling:StaticWebLayerLoadBasedAutoScalingDownscaling")]
    public sealed class StaticWebLayerLoadBasedAutoScalingDownscaling
    {
        [Input("alarms")]
