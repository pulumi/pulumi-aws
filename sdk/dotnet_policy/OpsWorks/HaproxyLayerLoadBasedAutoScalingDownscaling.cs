...
{
    [PolicyResourceType("aws:opsworks/HaproxyLayerLoadBasedAutoScalingDownscaling:HaproxyLayerLoadBasedAutoScalingDownscaling")]
    public sealed class HaproxyLayerLoadBasedAutoScalingDownscaling
    {
        [Input("alarms")]
