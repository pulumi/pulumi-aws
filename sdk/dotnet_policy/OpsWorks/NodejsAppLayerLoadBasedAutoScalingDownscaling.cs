...
{
    [PolicyResourceType("aws:opsworks/NodejsAppLayerLoadBasedAutoScalingDownscaling:NodejsAppLayerLoadBasedAutoScalingDownscaling")]
    public sealed class NodejsAppLayerLoadBasedAutoScalingDownscaling
    {
        [Input("alarms")]
