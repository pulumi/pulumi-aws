...
{
    [PolicyResourceType("aws:opsworks/GangliaLayerLoadBasedAutoScalingUpscaling:GangliaLayerLoadBasedAutoScalingUpscaling")]
    public sealed class GangliaLayerLoadBasedAutoScalingUpscaling
    {
        [Input("alarms")]
