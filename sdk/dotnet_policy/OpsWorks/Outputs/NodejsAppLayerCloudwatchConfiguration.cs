...
namespace Pulumi.PolicyPacks.Aws.OpsWorks.Outputs
{
    public sealed class NodejsAppLayerCloudwatchConfiguration
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.NodejsAppLayerCloudwatchConfigurationLogStream>? _mValue_LogStreams;
        private bool _mUnknown_LogStreams;
        public List<Outputs.NodejsAppLayerCloudwatchConfigurationLogStream>? LogStreams
        {
            get
            {
