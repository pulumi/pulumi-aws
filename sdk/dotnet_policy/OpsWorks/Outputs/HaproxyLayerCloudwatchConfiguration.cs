...
namespace Pulumi.PolicyPacks.Aws.OpsWorks.Outputs
{
    public sealed class HaproxyLayerCloudwatchConfiguration
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.HaproxyLayerCloudwatchConfigurationLogStream>? _mValue_LogStreams;
        private bool _mUnknown_LogStreams;
        public List<Outputs.HaproxyLayerCloudwatchConfigurationLogStream>? LogStreams
        {
            get
            {
