...
{
    [PolicyResourceType("aws:opsworks/GangliaLayerLoadBasedAutoScalingDownscaling:GangliaLayerLoadBasedAutoScalingDownscaling")]
    public sealed class GangliaLayerLoadBasedAutoScalingDownscaling
    {
        [Input("alarms")]
