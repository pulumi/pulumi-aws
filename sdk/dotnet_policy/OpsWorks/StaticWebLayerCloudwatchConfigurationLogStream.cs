...
{
    [PolicyResourceType("aws:opsworks/StaticWebLayerCloudwatchConfigurationLogStream:StaticWebLayerCloudwatchConfigurationLogStream")]
    public sealed class StaticWebLayerCloudwatchConfigurationLogStream
    {
        [Input("batchCount")]
