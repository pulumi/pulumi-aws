...
namespace Pulumi.PolicyPacks.Aws.OpsWorks.Inputs
{
    public sealed class RailsAppLayerCloudwatchConfigurationArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Inputs.RailsAppLayerCloudwatchConfigurationLogStreamArgs>? _mValue_LogStreams;
        private bool _mUnknown_LogStreams;
        public List<Inputs.RailsAppLayerCloudwatchConfigurationLogStreamArgs>? LogStreams
        {
            get
            {
