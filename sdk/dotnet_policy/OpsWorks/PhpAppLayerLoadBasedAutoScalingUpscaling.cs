...
{
    [PolicyResourceType("aws:opsworks/PhpAppLayerLoadBasedAutoScalingUpscaling:PhpAppLayerLoadBasedAutoScalingUpscaling")]
    public sealed class PhpAppLayerLoadBasedAutoScalingUpscaling
    {
        [Input("alarms")]
