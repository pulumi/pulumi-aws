...
namespace Pulumi.PolicyPacks.Aws.Ec2.Inputs
{
    public sealed class NetworkInsightsAnalysisForwardPathComponentSecurityGroupRuleArgs
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.NetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRangeArgs>> _mPortRanges;

        public List<Inputs.NetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRangeArgs>? PortRanges => _mPortRanges.GetValue("portRanges");
