...
namespace Pulumi.PolicyPacks.Aws.Ec2.Inputs
{
    public sealed class NetworkInsightsAnalysisReturnPathComponentAclRuleArgs
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.NetworkInsightsAnalysisReturnPathComponentAclRulePortRangeArgs>> _mPortRanges;

        public List<Inputs.NetworkInsightsAnalysisReturnPathComponentAclRulePortRangeArgs>? PortRanges => _mPortRanges.GetValue("portRanges");
