...
namespace Pulumi.PolicyPacks.Aws.Ec2.Inputs
{
    public sealed class NetworkInsightsAnalysisForwardPathComponentAclRuleArgs
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.NetworkInsightsAnalysisForwardPathComponentAclRulePortRangeArgs>> _mPortRanges;

        public List<Inputs.NetworkInsightsAnalysisForwardPathComponentAclRulePortRangeArgs>? PortRanges => _mPortRanges.GetValue("portRanges");
