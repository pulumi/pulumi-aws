...
namespace Pulumi.PolicyPacks.Aws.Ec2.Inputs
{
    public sealed class NetworkInsightsAnalysisReturnPathComponentSecurityGroupRuleArgs
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.NetworkInsightsAnalysisReturnPathComponentSecurityGroupRulePortRangeArgs>> _mPortRanges;

        public List<Inputs.NetworkInsightsAnalysisReturnPathComponentSecurityGroupRulePortRangeArgs>? PortRanges => _mPortRanges.GetValue("portRanges");
