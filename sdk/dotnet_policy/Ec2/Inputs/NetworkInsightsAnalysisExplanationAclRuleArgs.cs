...
namespace Pulumi.PolicyPacks.Aws.Ec2.Inputs
{
    public sealed class NetworkInsightsAnalysisExplanationAclRuleArgs
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.NetworkInsightsAnalysisExplanationAclRulePortRangeArgs>> _mPortRanges;

        public List<Inputs.NetworkInsightsAnalysisExplanationAclRulePortRangeArgs>? PortRanges => _mPortRanges.GetValue("portRanges");
