...
namespace Pulumi.PolicyPacks.Aws.Ec2.Outputs
{
    public sealed class GetNetworkInsightsAnalysisForwardPathComponentSecurityGroupRuleResult
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.GetNetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRangeResult>> _mPortRanges;

        public List<Outputs.GetNetworkInsightsAnalysisForwardPathComponentSecurityGroupRulePortRangeResult>? PortRanges => _mPortRanges.GetValue("portRanges");
