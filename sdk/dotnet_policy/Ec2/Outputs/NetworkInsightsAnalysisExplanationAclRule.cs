...
namespace Pulumi.PolicyPacks.Aws.Ec2.Outputs
{
    public sealed class NetworkInsightsAnalysisExplanationAclRule
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.NetworkInsightsAnalysisExplanationAclRulePortRange>> _mPortRanges;

        public List<Outputs.NetworkInsightsAnalysisExplanationAclRulePortRange>? PortRanges => _mPortRanges.GetValue("portRanges");
