...
namespace Pulumi.PolicyPacks.Aws.Ec2.Outputs
{
    public sealed class GetNetworkInsightsAnalysisExplanationAclRuleResult
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.GetNetworkInsightsAnalysisExplanationAclRulePortRangeResult>> _mPortRanges;

        public List<Outputs.GetNetworkInsightsAnalysisExplanationAclRulePortRangeResult>? PortRanges => _mPortRanges.GetValue("portRanges");
