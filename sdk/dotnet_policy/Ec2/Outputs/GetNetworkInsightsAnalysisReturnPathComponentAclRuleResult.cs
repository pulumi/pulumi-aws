...
namespace Pulumi.PolicyPacks.Aws.Ec2.Outputs
{
    public sealed class GetNetworkInsightsAnalysisReturnPathComponentAclRuleResult
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.GetNetworkInsightsAnalysisReturnPathComponentAclRulePortRangeResult>> _mPortRanges;

        public List<Outputs.GetNetworkInsightsAnalysisReturnPathComponentAclRulePortRangeResult>? PortRanges => _mPortRanges.GetValue("portRanges");
