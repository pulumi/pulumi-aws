...
namespace Pulumi.PolicyPacks.Aws.Ec2.Outputs
{
    public sealed class GetNetworkInsightsAnalysisExplanationSecurityGroupRuleResult
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.GetNetworkInsightsAnalysisExplanationSecurityGroupRulePortRangeResult>> _mPortRanges;

        public List<Outputs.GetNetworkInsightsAnalysisExplanationSecurityGroupRulePortRangeResult>? PortRanges => _mPortRanges.GetValue("portRanges");
