...
namespace Pulumi.PolicyPacks.Aws.Ec2.Outputs
{
    public sealed class LaunchTemplateBlockDeviceMapping
    {
        ...
        [Input("ebs")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.LaunchTemplateBlockDeviceMappingEbs> _mEbs;

        public Outputs.LaunchTemplateBlockDeviceMappingEbs? Ebs => _mEbs.GetValue("ebs");
