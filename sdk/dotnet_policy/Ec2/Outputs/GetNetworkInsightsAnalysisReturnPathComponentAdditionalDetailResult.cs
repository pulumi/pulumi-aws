    ...
    public sealed class GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetailResult
    {
        ...
        public string? AdditionalDetailType
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetailResult.AdditionalDetailType' is not present");
            }
        }

        [PolicyResourceProperty("components", "_mUnknown_Components")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetailComponentResult>? _mValue_Components;
        private bool _mUnknown_Components;
        public List<Outputs.GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetailComponentResult>? Components
        {
            get
            {
                if (!_mUnknown_Components) return _mValue_Components;
                throw new UndeferrableValueException("Value 'GetNetworkInsightsAnalysisReturnPathComponentAdditionalDetailResult.Components' is not present");
            }
        }
    }
}
