...
namespace Pulumi.PolicyPacks.Aws.Ec2.Outputs
{
    public sealed class GetNetworkInsightsAnalysisReturnPathComponentSecurityGroupRuleResult
    {
        ...
        [Input("portRanges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.GetNetworkInsightsAnalysisReturnPathComponentSecurityGroupRulePortRangeResult>> _mPortRanges;

        public List<Outputs.GetNetworkInsightsAnalysisReturnPathComponentSecurityGroupRulePortRangeResult>? PortRanges => _mPortRanges.GetValue("portRanges");
