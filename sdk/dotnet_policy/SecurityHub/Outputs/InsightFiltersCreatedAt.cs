...
namespace Pulumi.PolicyPacks.Aws.SecurityHub.Outputs
{
    public sealed class InsightFiltersCreatedAt
    {
        ...
        private Outputs.InsightFiltersCreatedAtDateRange? _mValue_DateRange;
        private bool _mUnknown_DateRange;
        public Outputs.InsightFiltersCreatedAtDateRange? DateRange
        {
            get
            {
                if (!_mUnknown_DateRange) return _mValue_DateRange;
                throw new UndeferrableValueException("Value 'InsightFiltersCreatedAt.DateRange' is not present");
            }
        }
        ...
        public string? End
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'InsightFiltersCreatedAt.End' is not present");
            }
        }
        ...
        public string? Start
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'InsightFiltersCreatedAt.Start' is not present");
            }
        }
    }
}
