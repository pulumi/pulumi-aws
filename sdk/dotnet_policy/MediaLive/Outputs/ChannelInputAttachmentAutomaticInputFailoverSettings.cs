...
namespace Pulumi.PolicyPacks.Aws.MediaLive.Outputs
{
    public sealed class ChannelInputAttachmentAutomaticInputFailoverSettings
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverCondition>? _mValue_FailoverConditions;
        private bool _mUnknown_FailoverConditions;
        public List<Outputs.ChannelInputAttachmentAutomaticInputFailoverSettingsFailoverCondition>? FailoverConditions
        {
            get
            {
