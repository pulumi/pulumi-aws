...
namespace Pulumi.PolicyPacks.Aws.Iot.Outputs
{
    public sealed class TopicRuleKafka
    {
        ...
        [Input("headers")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.TopicRuleKafkaHeader>> _mHeaders;

        public List<Outputs.TopicRuleKafkaHeader>? Headers => _mHeaders.GetValue("headers");
