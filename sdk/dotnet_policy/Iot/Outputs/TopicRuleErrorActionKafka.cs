...
namespace Pulumi.PolicyPacks.Aws.Iot.Outputs
{
    public sealed class TopicRuleErrorActionKafka
    {
        ...
        [Input("headers")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.TopicRuleErrorActionKafkaHeader>> _mHeaders;

        public List<Outputs.TopicRuleErrorActionKafkaHeader>? Headers => _mHeaders.GetValue("headers");
