...
namespace Pulumi.PolicyPacks.Aws.Bedrock.Outputs
{
    public sealed class AgentAgentPromptOverrideConfigurationPromptConfiguration
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.AgentAgentPromptOverrideConfigurationPromptConfigurationInferenceConfiguration>> _mInferenceConfigurations;

        public List<Outputs.AgentAgentPromptOverrideConfigurationPromptConfigurationInferenceConfiguration>? InferenceConfigurations => _mInferenceConfigurations.GetValue("inferenceConfigurations");
