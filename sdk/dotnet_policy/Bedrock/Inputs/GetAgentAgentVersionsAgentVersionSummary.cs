...
namespace Pulumi.PolicyPacks.Aws.Bedrock.Inputs
{
    public sealed class GetAgentAgentVersionsAgentVersionSummaryArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.GetAgentAgentVersionsAgentVersionSummaryGuardrailConfigurationArgs>> _mGuardrailConfigurations;

        public List<Inputs.GetAgentAgentVersionsAgentVersionSummaryGuardrailConfigurationArgs>? GuardrailConfigurations => _mGuardrailConfigurations.GetValue("guardrailConfigurations");
