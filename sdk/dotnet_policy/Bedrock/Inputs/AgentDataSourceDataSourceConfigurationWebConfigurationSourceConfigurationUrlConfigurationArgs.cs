...
namespace Pulumi.PolicyPacks.Aws.Bedrock.Inputs
{
    public sealed class AgentDataSourceDataSourceConfigurationWebConfigurationSourceConfigurationUrlConfigurationArgs
    {
        ...
        private List<Inputs.AgentDataSourceDataSourceConfigurationWebConfigurationSourceConfigurationUrlConfigurationSeedUrlArgs>? _mValue_SeedUrls;
        private bool _mUnknown_SeedUrls;
        public List<Inputs.AgentDataSourceDataSourceConfigurationWebConfigurationSourceConfigurationUrlConfigurationSeedUrlArgs>? SeedUrls
        {
            get
            {
