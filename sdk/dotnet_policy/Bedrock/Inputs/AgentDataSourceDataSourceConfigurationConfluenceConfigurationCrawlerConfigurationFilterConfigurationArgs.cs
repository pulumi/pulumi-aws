...
namespace Pulumi.PolicyPacks.Aws.Bedrock.Inputs
{
    public sealed class AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationArgs
    {
        ...
        private List<Inputs.AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterArgs>? _mValue_PatternObjectFilters;
        private bool _mUnknown_PatternObjectFilters;
        public List<Inputs.AgentDataSourceDataSourceConfigurationConfluenceConfigurationCrawlerConfigurationFilterConfigurationPatternObjectFilterArgs>? PatternObjectFilters
        {
            get
            {
