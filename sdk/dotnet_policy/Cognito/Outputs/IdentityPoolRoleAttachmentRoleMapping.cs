...
namespace Pulumi.PolicyPacks.Aws.Cognito.Outputs
{
    public sealed class IdentityPoolRoleAttachmentRoleMapping
    {
        ...
        [Input("mappingRules")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.IdentityPoolRoleAttachmentRoleMappingMappingRule>> _mMappingRules;

        public List<Outputs.IdentityPoolRoleAttachmentRoleMappingMappingRule>? MappingRules => _mMappingRules.GetValue("mappingRules");
