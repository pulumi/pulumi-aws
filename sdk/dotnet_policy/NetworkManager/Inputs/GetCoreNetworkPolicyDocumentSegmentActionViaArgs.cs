...
{
    public sealed class GetCoreNetworkPolicyDocumentSegmentActionViaInputArgs
    {
        /// <summary>
        ...
        public List<string>? NetworkFunctionGroups
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetCoreNetworkPolicyDocumentSegmentActionViaInputArgs.NetworkFunctionGroups' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Inputs.GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverrideInputArgs>? _mValue_WithEdgeOverrides;
        private bool _mUnknown_WithEdgeOverrides;
        public List<Inputs.GetCoreNetworkPolicyDocumentSegmentActionViaWithEdgeOverrideInputArgs>? WithEdgeOverrides
        {
            get
            {
                if (!_mUnknown_WithEdgeOverrides) return _mValue_WithEdgeOverrides;
                throw new UndeferrableValueException("Value 'GetCoreNetworkPolicyDocumentSegmentActionViaInputArgs.WithEdgeOverrides' is not present");
            }
        }
    }
}
