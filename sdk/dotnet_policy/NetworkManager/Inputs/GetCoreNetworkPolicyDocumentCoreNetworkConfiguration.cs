...
namespace Pulumi.PolicyPacks.Aws.NetworkManager.Inputs
{
    public sealed class GetCoreNetworkPolicyDocumentCoreNetworkConfigurationArgs
    {
        ...
        [Input("edgeLocations")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationArgs>> _mEdgeLocations;

        public List<Inputs.GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationArgs>? EdgeLocations => _mEdgeLocations.GetValue("edgeLocations");
