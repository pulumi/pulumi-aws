...
namespace Pulumi.PolicyPacks.Aws.NetworkManager.Inputs
{
    public sealed class GetCoreNetworkPolicyDocumentAttachmentPolicyInputArgs
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<Inputs.GetCoreNetworkPolicyDocumentAttachmentPolicyActionInputArgs> _mAction;

        public Inputs.GetCoreNetworkPolicyDocumentAttachmentPolicyActionInputArgs? Action => _mAction.GetValue("action");
        ...
        [Input("conditions")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.GetCoreNetworkPolicyDocumentAttachmentPolicyConditionInputArgs>> _mConditions;

        public List<Inputs.GetCoreNetworkPolicyDocumentAttachmentPolicyConditionInputArgs>? Conditions => _mConditions.GetValue("conditions");
