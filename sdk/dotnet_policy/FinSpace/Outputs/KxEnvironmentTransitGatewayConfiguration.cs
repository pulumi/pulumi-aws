...
namespace Pulumi.PolicyPacks.Aws.FinSpace.Outputs
{
    public sealed class KxEnvironmentTransitGatewayConfiguration
    {
        ...
        private List<Outputs.KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfiguration>? _mValue_AttachmentNetworkAclConfigurations;
        private bool _mUnknown_AttachmentNetworkAclConfigurations;
        public List<Outputs.KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfiguration>? AttachmentNetworkAclConfigurations
        {
            get
            {
