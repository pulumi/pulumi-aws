...
namespace Pulumi.PolicyPacks.Aws.Lex.Outputs
{
    public sealed class V2modelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationImageResponseCard
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.V2modelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationImageResponseCardButton>> _mButtons;

        public List<Outputs.V2modelsIntentConfirmationSettingConfirmationResponseMessageGroupVariationImageResponseCardButton>? Buttons => _mButtons.GetValue("buttons");
