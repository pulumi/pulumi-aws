...
namespace Pulumi.PolicyPacks.Aws.Lex.Outputs
{
    public sealed class V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroupVariationImageResponseCard
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroupVariationImageResponseCardButton>> _mButtons;

        public List<Outputs.V2modelsIntentClosingSettingConditionalConditionalBranchResponseMessageGroupVariationImageResponseCardButton>? Buttons => _mButtons.GetValue("buttons");
