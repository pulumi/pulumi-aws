...
namespace Pulumi.PolicyPacks.Aws.Lex.Outputs
{
    public sealed class BotAbortStatement
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.BotAbortStatementMessage>> _mMessages;

        public List<Outputs.BotAbortStatementMessage>? Messages => _mMessages.GetValue("messages");
