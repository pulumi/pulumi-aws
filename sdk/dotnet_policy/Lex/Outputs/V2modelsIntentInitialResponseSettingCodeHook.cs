...
namespace Pulumi.PolicyPacks.Aws.Lex.Outputs
{
    public sealed class V2modelsIntentInitialResponseSettingCodeHook
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecification> _mPostCodeHookSpecification;

        public Outputs.V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecification? PostCodeHookSpecification => _mPostCodeHookSpecification.GetValue("postCodeHookSpecification");
    }
}
