...
namespace Pulumi.PolicyPacks.Aws.Lex.Outputs
{
    public sealed class V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchResponse
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchResponseMessageGroup>? _mValue_MessageGroups;
        private bool _mUnknown_MessageGroups;
        public List<Outputs.V2modelsIntentConfirmationSettingFailureConditionalDefaultBranchResponseMessageGroup>? MessageGroups
        {
            get
            {
