    ...
    public sealed class IntentSlotValueElicitationPrompt
    {
        ...
        public int? MaxAttempts
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'IntentSlotValueElicitationPrompt.MaxAttempts' is not present");
            }
        }

        [PolicyResourceProperty("messages", "_mUnknown_Messages")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.IntentSlotValueElicitationPromptMessage>? _mValue_Messages;
        private bool _mUnknown_Messages;
        public List<Outputs.IntentSlotValueElicitationPromptMessage>? Messages
        {
            get
            {
                if (!_mUnknown_Messages) return _mValue_Messages;
                throw new UndeferrableValueException("Value 'IntentSlotValueElicitationPrompt.Messages' is not present");
            }
        }
        ...
        public string? ResponseCard
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'IntentSlotValueElicitationPrompt.ResponseCard' is not present");
            }
        }
    }
}
