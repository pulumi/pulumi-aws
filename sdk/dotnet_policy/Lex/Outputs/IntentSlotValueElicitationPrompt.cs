...
namespace Pulumi.PolicyPacks.Aws.Lex.Outputs
{
    public sealed class IntentSlotValueElicitationPrompt
    {
        ...
        [Input("messages")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.IntentSlotValueElicitationPromptMessage>> _mMessages;

        public List<Outputs.IntentSlotValueElicitationPromptMessage>? Messages => _mMessages.GetValue("messages");
