...
namespace Pulumi.PolicyPacks.Aws.Lex.Outputs
{
    public sealed class V2modelsSlotSubSlotSetting
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.V2modelsSlotSubSlotSettingSlotSpecification>? _mValue_SlotSpecifications;
        private bool _mUnknown_SlotSpecifications;
        public List<Outputs.V2modelsSlotSubSlotSettingSlotSpecification>? SlotSpecifications
        {
            get
            {
