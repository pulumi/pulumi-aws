    ...
    public sealed class V2modelsIntentConfirmationSettingFailureConditional
    {
        ...
        public bool? Active
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingFailureConditional.Active' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.V2modelsIntentConfirmationSettingFailureConditionalConditionalBranch>? _mValue_ConditionalBranches;
        private bool _mUnknown_ConditionalBranches;
        public List<Outputs.V2modelsIntentConfirmationSettingFailureConditionalConditionalBranch>? ConditionalBranches
        {
            get
            {
                if (!_mUnknown_ConditionalBranches) return _mValue_ConditionalBranches;
                throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingFailureConditional.ConditionalBranches' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Outputs.V2modelsIntentConfirmationSettingFailureConditionalDefaultBranch? _mValue_DefaultBranch;
        private bool _mUnknown_DefaultBranch;
        public Outputs.V2modelsIntentConfirmationSettingFailureConditionalDefaultBranch? DefaultBranch
        {
            get
            {
                if (!_mUnknown_DefaultBranch) return _mValue_DefaultBranch;
                throw new UndeferrableValueException("Value 'V2modelsIntentConfirmationSettingFailureConditional.DefaultBranch' is not present");
            }
        }
    }
}
