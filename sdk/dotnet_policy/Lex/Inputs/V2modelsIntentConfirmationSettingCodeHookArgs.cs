...
namespace Pulumi.PolicyPacks.Aws.Lex.Inputs
{
    public sealed class V2modelsIntentConfirmationSettingCodeHookArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Inputs.V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationArgs> _mPostCodeHookSpecification;

        public Inputs.V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationArgs? PostCodeHookSpecification => _mPostCodeHookSpecification.GetValue("postCodeHookSpecification");
    }
}
