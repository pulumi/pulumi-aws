...
namespace Pulumi.PolicyPacks.Aws.NetworkFirewall.Outputs
{
    public sealed class FirewallFirewallStatusSyncState
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.FirewallFirewallStatusSyncStateAttachment>> _mAttachments;

        public List<Outputs.FirewallFirewallStatusSyncStateAttachment>? Attachments => _mAttachments.GetValue("attachments");
