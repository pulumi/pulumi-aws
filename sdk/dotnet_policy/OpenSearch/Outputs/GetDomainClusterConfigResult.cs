    ...
    public sealed class GetDomainClusterConfigResult
    {
        ...
        public bool? MultiAzWithStandbyEnabled
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetDomainClusterConfigResult.MultiAzWithStandbyEnabled' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.GetDomainClusterConfigNodeOptionResult>? _mValue_NodeOptions;
        private bool _mUnknown_NodeOptions;
        public List<Outputs.GetDomainClusterConfigNodeOptionResult>? NodeOptions
        {
            get
            {
                if (!_mUnknown_NodeOptions) return _mValue_NodeOptions;
                throw new UndeferrableValueException("Value 'GetDomainClusterConfigResult.NodeOptions' is not present");
            }
        }
