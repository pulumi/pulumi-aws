...
namespace Pulumi.PolicyPacks.Aws.Kinesis.Outputs
{
    public sealed class FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessor
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorParameter>> _mParameters;

        public List<Outputs.FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorParameter>? Parameters => _mParameters.GetValue("parameters");
