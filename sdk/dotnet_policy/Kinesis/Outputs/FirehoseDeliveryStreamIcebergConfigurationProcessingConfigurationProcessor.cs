...
namespace Pulumi.PolicyPacks.Aws.Kinesis.Outputs
{
    public sealed class FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessor
    {
        ...
        private List<Outputs.FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorParameter>? _mValue_Parameters;
        private bool _mUnknown_Parameters;
        public List<Outputs.FirehoseDeliveryStreamIcebergConfigurationProcessingConfigurationProcessorParameter>? Parameters
        {
            get
            {
