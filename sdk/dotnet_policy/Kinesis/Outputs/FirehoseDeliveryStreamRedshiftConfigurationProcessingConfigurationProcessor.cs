...
namespace Pulumi.PolicyPacks.Aws.Kinesis.Outputs
{
    public sealed class FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessor
    {
        ...
        private List<Outputs.FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameter>? _mValue_Parameters;
        private bool _mUnknown_Parameters;
        public List<Outputs.FirehoseDeliveryStreamRedshiftConfigurationProcessingConfigurationProcessorParameter>? Parameters
        {
            get
            {
