...
namespace Pulumi.PolicyPacks.Aws.Kinesis.Outputs
{
    public sealed class FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessor
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter>> _mParameters;

        public List<Outputs.FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter>? Parameters => _mParameters.GetValue("parameters");
