...
namespace Pulumi.PolicyPacks.Aws.Kinesis.Outputs
{
    public sealed class FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessor
    {
        ...
        private List<Outputs.FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter>? _mValue_Parameters;
        private bool _mUnknown_Parameters;
        public List<Outputs.FirehoseDeliveryStreamElasticsearchConfigurationProcessingConfigurationProcessorParameter>? Parameters
        {
            get
            {
