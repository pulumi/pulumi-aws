...
namespace Pulumi.PolicyPacks.Aws.Kinesis.Outputs
{
    public sealed class FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfigurationProcessor
    {
        ...
        private List<Outputs.FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfigurationProcessorParameter>? _mValue_Parameters;
        private bool _mUnknown_Parameters;
        public List<Outputs.FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfigurationProcessorParameter>? Parameters
        {
            get
            {
                if (!_mUnknown_Parameters) return _mValue_Parameters;
                throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfigurationProcessor.Parameters' is not present");
            }
        }
        ...
        public string? Type
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamExtendedS3ConfigurationProcessingConfigurationProcessor.Type' is not present");
            }
        }
    }
}
