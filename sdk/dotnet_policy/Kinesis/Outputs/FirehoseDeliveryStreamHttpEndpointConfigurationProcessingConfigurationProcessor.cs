...
namespace Pulumi.PolicyPacks.Aws.Kinesis.Outputs
{
    public sealed class FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessor
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorParameter>> _mParameters;

        public List<Outputs.FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorParameter>? Parameters => _mParameters.GetValue("parameters");
