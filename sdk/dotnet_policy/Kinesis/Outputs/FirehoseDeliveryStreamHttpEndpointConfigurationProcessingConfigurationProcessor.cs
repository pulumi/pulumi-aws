...
namespace Pulumi.PolicyPacks.Aws.Kinesis.Outputs
{
    public sealed class FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessor
    {
        ...
        private List<Outputs.FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorParameter>? _mValue_Parameters;
        private bool _mUnknown_Parameters;
        public List<Outputs.FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessorParameter>? Parameters
        {
            get
            {
                if (!_mUnknown_Parameters) return _mValue_Parameters;
                throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessor.Parameters' is not present");
            }
        }
        ...
        public string? Type
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'FirehoseDeliveryStreamHttpEndpointConfigurationProcessingConfigurationProcessor.Type' is not present");
            }
        }
    }
}
