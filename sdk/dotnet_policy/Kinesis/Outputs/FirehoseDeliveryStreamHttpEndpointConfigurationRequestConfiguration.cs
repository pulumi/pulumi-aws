...
namespace Pulumi.PolicyPacks.Aws.Kinesis.Outputs
{
    public sealed class FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfiguration
    {
        ...
        private List<Outputs.FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfigurationCommonAttribute>? _mValue_CommonAttributes;
        private bool _mUnknown_CommonAttributes;
        public List<Outputs.FirehoseDeliveryStreamHttpEndpointConfigurationRequestConfigurationCommonAttribute>? CommonAttributes
        {
            get
            {
