...
namespace Pulumi.PolicyPacks.Aws.Route53.Inputs
{
    public sealed class RecordGeoproximityRoutingPolicyArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Inputs.RecordGeoproximityRoutingPolicyCoordinateArgs>? _mValue_Coordinates;
        private bool _mUnknown_Coordinates;
        public List<Inputs.RecordGeoproximityRoutingPolicyCoordinateArgs>? Coordinates
        {
            get
            {
