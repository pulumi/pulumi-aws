...
namespace Pulumi.PolicyPacks.Aws.Route53.Outputs
{
    public sealed class RecordsExclusiveResourceRecordSetGeoproximityLocation
    {
        ...
        [Input("coordinates")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.RecordsExclusiveResourceRecordSetGeoproximityLocationCoordinates> _mCoordinates;

        public Outputs.RecordsExclusiveResourceRecordSetGeoproximityLocationCoordinates? Coordinates => _mCoordinates.GetValue("coordinates");
