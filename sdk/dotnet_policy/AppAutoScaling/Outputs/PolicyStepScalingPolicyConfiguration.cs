...
namespace Pulumi.PolicyPacks.Aws.AppAutoScaling.Outputs
{
    public sealed class PolicyStepScalingPolicyConfiguration
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.PolicyStepScalingPolicyConfigurationStepAdjustment>? _mValue_StepAdjustments;
        private bool _mUnknown_StepAdjustments;
        public List<Outputs.PolicyStepScalingPolicyConfigurationStepAdjustment>? StepAdjustments
        {
            get
            {
