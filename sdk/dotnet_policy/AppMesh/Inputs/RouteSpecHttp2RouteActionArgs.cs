...
namespace Pulumi.PolicyPacks.Aws.AppMesh.Inputs
{
    public sealed class RouteSpecHttp2RouteActionArgs
    {
        ...
        private List<Inputs.RouteSpecHttp2RouteActionWeightedTargetArgs>? _mValue_WeightedTargets;
        private bool _mUnknown_WeightedTargets;
        public List<Inputs.RouteSpecHttp2RouteActionWeightedTargetArgs>? WeightedTargets
        {
            get
            {
