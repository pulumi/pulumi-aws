...
namespace Pulumi.PolicyPacks.Aws.AppMesh.Outputs
{
    public sealed class VirtualGatewaySpecLoggingAccessLogFileFormat
    {
        ...
        private List<Outputs.VirtualGatewaySpecLoggingAccessLogFileFormatJson>? _mValue_Jsons;
        private bool _mUnknown_Jsons;
        public List<Outputs.VirtualGatewaySpecLoggingAccessLogFileFormatJson>? Jsons
        {
            get
            {
