...
namespace Pulumi.PolicyPacks.Aws.AppMesh.Outputs
{
    public sealed class GatewayRouteSpecHttp2RouteMatchHeader
    {
        ...
        [Input("match")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.GatewayRouteSpecHttp2RouteMatchHeaderMatch> _mMatch;

        public Outputs.GatewayRouteSpecHttp2RouteMatchHeaderMatch? Match => _mMatch.GetValue("match");
