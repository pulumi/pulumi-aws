...
namespace Pulumi.PolicyPacks.Aws.AppMesh.Outputs
{
    public sealed class GetRouteSpecHttpRouteMatchHeaderMatchResult
    {
        ...
        [Input("ranges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.GetRouteSpecHttpRouteMatchHeaderMatchRangeResult>> _mRanges;

        public List<Outputs.GetRouteSpecHttpRouteMatchHeaderMatchRangeResult>? Ranges => _mRanges.GetValue("ranges");
