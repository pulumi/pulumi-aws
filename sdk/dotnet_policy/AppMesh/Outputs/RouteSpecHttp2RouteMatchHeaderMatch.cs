...
namespace Pulumi.PolicyPacks.Aws.AppMesh.Outputs
{
    public sealed class RouteSpecHttp2RouteMatchHeaderMatch
    {
        ...
        [Input("range")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.RouteSpecHttp2RouteMatchHeaderMatchRange> _mRange;

        public Outputs.RouteSpecHttp2RouteMatchHeaderMatchRange? Range => _mRange.GetValue("range");
