...
namespace Pulumi.PolicyPacks.Aws.AppMesh.Outputs
{
    public sealed class VirtualNodeSpecLoggingAccessLogFile
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<Outputs.VirtualNodeSpecLoggingAccessLogFileFormat> _mFormat;

        public Outputs.VirtualNodeSpecLoggingAccessLogFileFormat? Format => _mFormat.GetValue("format");
