...
namespace Pulumi.PolicyPacks.Aws.AppMesh.Outputs
{
    public sealed class GetGatewayRouteSpecHttp2RouteMatchHeaderMatchResult
    {
        ...
        [Input("ranges")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.GetGatewayRouteSpecHttp2RouteMatchHeaderMatchRangeResult>> _mRanges;

        public List<Outputs.GetGatewayRouteSpecHttp2RouteMatchHeaderMatchRangeResult>? Ranges => _mRanges.GetValue("ranges");
