...
namespace Pulumi.PolicyPacks.Aws.AppMesh.Outputs
{
    public sealed class RouteSpecGrpcRouteRetryPolicy
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.RouteSpecGrpcRouteRetryPolicyPerRetryTimeout> _mPerRetryTimeout;

        public Outputs.RouteSpecGrpcRouteRetryPolicyPerRetryTimeout? PerRetryTimeout => _mPerRetryTimeout.GetValue("perRetryTimeout");
