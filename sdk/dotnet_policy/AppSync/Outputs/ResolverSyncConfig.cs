...
namespace Pulumi.PolicyPacks.Aws.AppSync.Outputs
{
    public sealed class ResolverSyncConfig
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Outputs.ResolverSyncConfigLambdaConflictHandlerConfig? _mValue_LambdaConflictHandlerConfig;
        private bool _mUnknown_LambdaConflictHandlerConfig;
        public Outputs.ResolverSyncConfigLambdaConflictHandlerConfig? LambdaConflictHandlerConfig
        {
            get
            {
