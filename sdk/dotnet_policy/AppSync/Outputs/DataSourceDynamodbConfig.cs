...
namespace Pulumi.PolicyPacks.Aws.AppSync.Outputs
{
    public sealed class DataSourceDynamodbConfig
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<Outputs.DataSourceDynamodbConfigDeltaSyncConfig> _mDeltaSyncConfig;

        public Outputs.DataSourceDynamodbConfigDeltaSyncConfig? DeltaSyncConfig => _mDeltaSyncConfig.GetValue("deltaSyncConfig");
