...
namespace Pulumi.PolicyPacks.Aws.AutoScaling.Outputs
{
    public sealed class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatMetric
    {
        ...
        private List<Outputs.PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatMetricDimension>? _mValue_Dimensions;
        private bool _mUnknown_Dimensions;
        public List<Outputs.PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStatMetricDimension>? Dimensions
        {
            get
            {
