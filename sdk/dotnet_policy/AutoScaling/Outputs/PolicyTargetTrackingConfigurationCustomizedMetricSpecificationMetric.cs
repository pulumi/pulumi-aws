...
namespace Pulumi.PolicyPacks.Aws.AutoScaling.Outputs
{
    public sealed class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetric
    {
        ...
        [Input("metricStat")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStat> _mMetricStat;

        public Outputs.PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricMetricStat? MetricStat => _mMetricStat.GetValue("metricStat");
