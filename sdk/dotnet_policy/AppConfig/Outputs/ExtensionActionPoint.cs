...
namespace Pulumi.PolicyPacks.Aws.AppConfig.Outputs
{
    public sealed class ExtensionActionPoint
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.ExtensionActionPointAction>> _mActions;

        public List<Outputs.ExtensionActionPointAction>? Actions => _mActions.GetValue("actions");
