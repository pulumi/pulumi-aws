...
{
    public sealed class GetResourceCollectionCloudformationArgs
    {
        /// <summary>
        ...
        public List<string>? StackNames
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetResourceCollectionCloudformationArgs.StackNames' is not present");
            }
        }
    }
}
