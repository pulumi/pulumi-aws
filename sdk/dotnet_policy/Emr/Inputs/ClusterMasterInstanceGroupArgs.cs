...
namespace Pulumi.PolicyPacks.Aws.Emr.Inputs
{
    public sealed class ClusterMasterInstanceGroupArgs
    {
        ...
        [Input("ebsConfigs")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.ClusterMasterInstanceGroupEbsConfigArgs>> _mEbsConfigs;

        public List<Inputs.ClusterMasterInstanceGroupEbsConfigArgs>? EbsConfigs => _mEbsConfigs.GetValue("ebsConfigs");
