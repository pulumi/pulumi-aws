...
namespace Pulumi.PolicyPacks.Aws.Emr.Outputs
{
    public sealed class ClusterCoreInstanceFleetInstanceTypeConfig
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.ClusterCoreInstanceFleetInstanceTypeConfigConfiguration>> _mConfigurations;

        public List<Outputs.ClusterCoreInstanceFleetInstanceTypeConfigConfiguration>? Configurations => _mConfigurations.GetValue("configurations");
        ...
        [Input("ebsConfigs")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig>> _mEbsConfigs;

        public List<Outputs.ClusterCoreInstanceFleetInstanceTypeConfigEbsConfig>? EbsConfigs => _mEbsConfigs.GetValue("ebsConfigs");
