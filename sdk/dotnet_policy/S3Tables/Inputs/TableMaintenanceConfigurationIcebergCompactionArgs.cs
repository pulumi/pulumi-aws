...
namespace Pulumi.PolicyPacks.Aws.S3Tables.Inputs
{
    public sealed class TableMaintenanceConfigurationIcebergCompactionArgs
    {
        ...
        private Inputs.TableMaintenanceConfigurationIcebergCompactionSettingsArgs? _mValue_Settings;
        private bool _mUnknown_Settings;
        public Inputs.TableMaintenanceConfigurationIcebergCompactionSettingsArgs? Settings
        {
            get
            {
