...
namespace Pulumi.PolicyPacks.Aws.CodeBuild.Inputs
{
    public sealed class FleetScalingConfigurationArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.FleetScalingConfigurationTargetTrackingScalingConfigArgs>> _mTargetTrackingScalingConfigs;

        public List<Inputs.FleetScalingConfigurationTargetTrackingScalingConfigArgs>? TargetTrackingScalingConfigs => _mTargetTrackingScalingConfigs.GetValue("targetTrackingScalingConfigs");
    }
}
