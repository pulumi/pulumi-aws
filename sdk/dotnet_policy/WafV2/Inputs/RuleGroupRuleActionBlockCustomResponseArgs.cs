...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class RuleGroupRuleActionBlockCustomResponseArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.RuleGroupRuleActionBlockCustomResponseResponseHeaderArgs>> _mResponseHeaders;

        public List<Inputs.RuleGroupRuleActionBlockCustomResponseResponseHeaderArgs>? ResponseHeaders => _mResponseHeaders.GetValue("responseHeaders");
    }
}
