...
{
    public sealed class RuleGroupRuleActionBlockCustomResponseArgs
    {
        /// <summary>
        ...
        public string? CustomResponseBodyKey
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleActionBlockCustomResponseArgs.CustomResponseBodyKey' is not present");
            }
        }
        ...
        public int? ResponseCode
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleActionBlockCustomResponseArgs.ResponseCode' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Inputs.RuleGroupRuleActionBlockCustomResponseResponseHeaderArgs>? _mValue_ResponseHeaders;
        private bool _mUnknown_ResponseHeaders;
        public List<Inputs.RuleGroupRuleActionBlockCustomResponseResponseHeaderArgs>? ResponseHeaders
        {
            get
            {
                if (!_mUnknown_ResponseHeaders) return _mValue_ResponseHeaders;
                throw new UndeferrableValueException("Value 'RuleGroupRuleActionBlockCustomResponseArgs.ResponseHeaders' is not present");
            }
        }
    }
}
