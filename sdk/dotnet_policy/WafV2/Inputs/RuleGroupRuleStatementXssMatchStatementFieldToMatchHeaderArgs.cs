...
{
    public sealed class RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderArgs
    {
        /// <summary>
        ...
        private Inputs.RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs? _mValue_MatchPattern;
        private bool _mUnknown_MatchPattern;
        public Inputs.RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs? MatchPattern
        {
            get
            {
                if (!_mUnknown_MatchPattern) return _mValue_MatchPattern;
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderArgs.MatchPattern' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderArgs.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderArgs.OversizeHandling' is not present");
            }
        }
    }
}
