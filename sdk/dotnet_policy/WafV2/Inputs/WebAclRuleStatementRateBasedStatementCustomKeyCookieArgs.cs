...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class WebAclRuleStatementRateBasedStatementCustomKeyCookieArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Inputs.WebAclRuleStatementRateBasedStatementCustomKeyCookieTextTransformationArgs>? _mValue_TextTransformations;
        private bool _mUnknown_TextTransformations;
        public List<Inputs.WebAclRuleStatementRateBasedStatementCustomKeyCookieTextTransformationArgs>? TextTransformations
        {
            get
            {
