...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatementFieldToMatchCookiesArgs
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs>> _mMatchPatterns;

        public List<Inputs.WebAclRuleStatementRateBasedStatementScopeDownStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs>? MatchPatterns => _mMatchPatterns.GetValue("matchPatterns");
