...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class WebAclRuleStatementIpSetReferenceStatementArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Inputs.WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs? _mValue_IpSetForwardedIpConfig;
        private bool _mUnknown_IpSetForwardedIpConfig;
        public Inputs.WebAclRuleStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs? IpSetForwardedIpConfig
        {
            get
            {
