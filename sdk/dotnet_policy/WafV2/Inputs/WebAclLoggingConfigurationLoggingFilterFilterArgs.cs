...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class WebAclLoggingConfigurationLoggingFilterFilterArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Inputs.WebAclLoggingConfigurationLoggingFilterFilterConditionArgs>? _mValue_Conditions;
        private bool _mUnknown_Conditions;
        public List<Inputs.WebAclLoggingConfigurationLoggingFilterFilterConditionArgs>? Conditions
        {
            get
            {
