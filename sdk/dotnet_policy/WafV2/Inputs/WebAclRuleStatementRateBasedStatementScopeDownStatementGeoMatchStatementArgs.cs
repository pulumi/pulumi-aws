...
{
    public sealed class WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementArgs
    {
        /// <summary>
        ...
        public List<string>? CountryCodes
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementArgs.CountryCodes' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Inputs.WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfigArgs? _mValue_ForwardedIpConfig;
        private bool _mUnknown_ForwardedIpConfig;
        public Inputs.WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfigArgs? ForwardedIpConfig
        {
            get
            {
                if (!_mUnknown_ForwardedIpConfig) return _mValue_ForwardedIpConfig;
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementArgs.ForwardedIpConfig' is not present");
            }
        }
    }
}
