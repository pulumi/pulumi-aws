...
{
    public sealed class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesArgs
    {
        /// <summary>
        ...
        private List<Inputs.WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPatternArgs>? _mValue_MatchPatterns;
        private bool _mUnknown_MatchPatterns;
        public List<Inputs.WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPatternArgs>? MatchPatterns
        {
            get
            {
                if (!_mUnknown_MatchPatterns) return _mValue_MatchPatterns;
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesArgs.MatchPatterns' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesArgs.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesArgs.OversizeHandling' is not present");
            }
        }
    }
}
