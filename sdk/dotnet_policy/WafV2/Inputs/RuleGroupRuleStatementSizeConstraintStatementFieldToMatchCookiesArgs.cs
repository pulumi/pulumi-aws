...
{
    public sealed class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesArgs
    {
        /// <summary>
        ...
        private List<Inputs.RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs>? _mValue_MatchPatterns;
        private bool _mUnknown_MatchPatterns;
        public List<Inputs.RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs>? MatchPatterns
        {
            get
            {
                if (!_mUnknown_MatchPatterns) return _mValue_MatchPatterns;
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesArgs.MatchPatterns' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesArgs.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSizeConstraintStatementFieldToMatchCookiesArgs.OversizeHandling' is not present");
            }
        }
    }
}
