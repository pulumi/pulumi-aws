...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs
    {
        ...
        [Input("matchPattern")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Inputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs> _mMatchPattern;

        public Inputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs? MatchPattern => _mMatchPattern.GetValue("matchPattern");
