...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class WebAclRuleActionBlockCustomResponseArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.WebAclRuleActionBlockCustomResponseResponseHeaderArgs>> _mResponseHeaders;

        public List<Inputs.WebAclRuleActionBlockCustomResponseResponseHeaderArgs>? ResponseHeaders => _mResponseHeaders.GetValue("responseHeaders");
    }
}
