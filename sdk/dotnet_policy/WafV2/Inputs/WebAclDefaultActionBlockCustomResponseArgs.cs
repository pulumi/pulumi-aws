...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class WebAclDefaultActionBlockCustomResponseArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.WebAclDefaultActionBlockCustomResponseResponseHeaderArgs>> _mResponseHeaders;

        public List<Inputs.WebAclDefaultActionBlockCustomResponseResponseHeaderArgs>? ResponseHeaders => _mResponseHeaders.GetValue("responseHeaders");
    }
}
