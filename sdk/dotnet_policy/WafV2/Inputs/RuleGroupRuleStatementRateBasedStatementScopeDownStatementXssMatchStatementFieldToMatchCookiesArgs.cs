...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class RuleGroupRuleStatementRateBasedStatementScopeDownStatementXssMatchStatementFieldToMatchCookiesArgs
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.RuleGroupRuleStatementRateBasedStatementScopeDownStatementXssMatchStatementFieldToMatchCookiesMatchPatternArgs>> _mMatchPatterns;

        public List<Inputs.RuleGroupRuleStatementRateBasedStatementScopeDownStatementXssMatchStatementFieldToMatchCookiesMatchPatternArgs>? MatchPatterns => _mMatchPatterns.GetValue("matchPatterns");
