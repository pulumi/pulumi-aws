...
{
    public sealed class RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesArgs
    {
        /// <summary>
        ...
        private List<Inputs.RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPatternArgs>? _mValue_MatchPatterns;
        private bool _mUnknown_MatchPatterns;
        public List<Inputs.RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPatternArgs>? MatchPatterns
        {
            get
            {
                if (!_mUnknown_MatchPatterns) return _mValue_MatchPatterns;
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesArgs.MatchPatterns' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesArgs.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesArgs.OversizeHandling' is not present");
            }
        }
    }
}
