...
namespace Pulumi.PolicyPacks.Aws.WafV2.Inputs
{
    public sealed class RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesArgs
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPatternArgs>> _mMatchPatterns;

        public List<Inputs.RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchCookiesMatchPatternArgs>? MatchPatterns => _mMatchPatterns.GetValue("matchPatterns");
