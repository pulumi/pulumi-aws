...
{
    public sealed class WebAclRuleStatementByteMatchStatementFieldToMatchCookiesArgs
    {
        /// <summary>
        ...
        private List<Inputs.WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs>? _mValue_MatchPatterns;
        private bool _mUnknown_MatchPatterns;
        public List<Inputs.WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs>? MatchPatterns
        {
            get
            {
                if (!_mUnknown_MatchPatterns) return _mValue_MatchPatterns;
                throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchCookiesArgs.MatchPatterns' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchCookiesArgs.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementByteMatchStatementFieldToMatchCookiesArgs.OversizeHandling' is not present");
            }
        }
    }
}
