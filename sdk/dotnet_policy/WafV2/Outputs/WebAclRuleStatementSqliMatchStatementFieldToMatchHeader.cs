...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class WebAclRuleStatementSqliMatchStatementFieldToMatchHeader
    {
        ...
        private Outputs.WebAclRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern? _mValue_MatchPattern;
        private bool _mUnknown_MatchPattern;
        public Outputs.WebAclRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern? MatchPattern
        {
            get
            {
                if (!_mUnknown_MatchPattern) return _mValue_MatchPattern;
                throw new UndeferrableValueException("Value 'WebAclRuleStatementSqliMatchStatementFieldToMatchHeader.MatchPattern' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementSqliMatchStatementFieldToMatchHeader.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementSqliMatchStatementFieldToMatchHeader.OversizeHandling' is not present");
            }
        }
    }
}
