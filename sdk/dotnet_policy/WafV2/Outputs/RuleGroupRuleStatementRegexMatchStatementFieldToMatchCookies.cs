...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies
    {
        ...
        private List<Outputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern>? _mValue_MatchPatterns;
        private bool _mUnknown_MatchPatterns;
        public List<Outputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPattern>? MatchPatterns
        {
            get
            {
                if (!_mUnknown_MatchPatterns) return _mValue_MatchPatterns;
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies.MatchPatterns' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookies.OversizeHandling' is not present");
            }
        }
    }
}
