    ...
    public sealed class WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatement
    {
        ...
        public List<string>? CountryCodes
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatement.CountryCodes' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Outputs.WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfig? _mValue_ForwardedIpConfig;
        private bool _mUnknown_ForwardedIpConfig;
        public Outputs.WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatementForwardedIpConfig? ForwardedIpConfig
        {
            get
            {
                if (!_mUnknown_ForwardedIpConfig) return _mValue_ForwardedIpConfig;
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRateBasedStatementScopeDownStatementGeoMatchStatement.ForwardedIpConfig' is not present");
            }
        }
    }
}
