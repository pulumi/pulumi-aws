...
{
    public sealed class RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexMatchStatementFieldToMatchCookies
    {
        /// <summary>
        ...
        private List<Outputs.RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexMatchStatementFieldToMatchCookiesMatchPattern>? _mValue_MatchPatterns;
        private bool _mUnknown_MatchPatterns;
        public List<Outputs.RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexMatchStatementFieldToMatchCookiesMatchPattern>? MatchPatterns
        {
            get
            {
                if (!_mUnknown_MatchPatterns) return _mValue_MatchPatterns;
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexMatchStatementFieldToMatchCookies.MatchPatterns' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexMatchStatementFieldToMatchCookies.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementRateBasedStatementScopeDownStatementRegexMatchStatementFieldToMatchCookies.OversizeHandling' is not present");
            }
        }
    }
}
