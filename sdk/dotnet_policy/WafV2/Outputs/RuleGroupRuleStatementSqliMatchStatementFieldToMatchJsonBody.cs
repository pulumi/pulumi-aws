...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBody
    {
        ...
        [Input("matchPattern")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern> _mMatchPattern;

        public Outputs.RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern? MatchPattern => _mMatchPattern.GetValue("matchPattern");
