...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class WebAclRuleActionBlockCustomResponse
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.WebAclRuleActionBlockCustomResponseResponseHeader>? _mValue_ResponseHeaders;
        private bool _mUnknown_ResponseHeaders;
        public List<Outputs.WebAclRuleActionBlockCustomResponseResponseHeader>? ResponseHeaders
        {
            get
            {
