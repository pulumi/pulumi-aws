...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class WebAclRuleStatementRateBasedStatementScopeDownStatementSqliMatchStatementFieldToMatchCookies
    {
        ...
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.WebAclRuleStatementRateBasedStatementScopeDownStatementSqliMatchStatementFieldToMatchCookiesMatchPattern>> _mMatchPatterns;

        public List<Outputs.WebAclRuleStatementRateBasedStatementScopeDownStatementSqliMatchStatementFieldToMatchCookiesMatchPattern>? MatchPatterns => _mMatchPatterns.GetValue("matchPatterns");
