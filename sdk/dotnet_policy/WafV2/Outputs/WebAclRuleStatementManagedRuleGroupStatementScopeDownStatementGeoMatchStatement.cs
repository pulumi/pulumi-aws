    ...
    public sealed class WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatement
    {
        ...
        public List<string>? CountryCodes
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatement.CountryCodes' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Outputs.WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementForwardedIpConfig? _mValue_ForwardedIpConfig;
        private bool _mUnknown_ForwardedIpConfig;
        public Outputs.WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatementForwardedIpConfig? ForwardedIpConfig
        {
            get
            {
                if (!_mUnknown_ForwardedIpConfig) return _mValue_ForwardedIpConfig;
                throw new UndeferrableValueException("Value 'WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementGeoMatchStatement.ForwardedIpConfig' is not present");
            }
        }
    }
}
