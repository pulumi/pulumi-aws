...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class WebAclDefaultActionBlockCustomResponse
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.WebAclDefaultActionBlockCustomResponseResponseHeader>? _mValue_ResponseHeaders;
        private bool _mUnknown_ResponseHeaders;
        public List<Outputs.WebAclDefaultActionBlockCustomResponseResponseHeader>? ResponseHeaders
        {
            get
            {
