...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class WebAclDefaultActionBlockCustomResponse
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.WebAclDefaultActionBlockCustomResponseResponseHeader>> _mResponseHeaders;

        public List<Outputs.WebAclDefaultActionBlockCustomResponseResponseHeader>? ResponseHeaders => _mResponseHeaders.GetValue("responseHeaders");
    }
}
