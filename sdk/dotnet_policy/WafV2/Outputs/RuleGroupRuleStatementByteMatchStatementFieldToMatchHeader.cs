...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader
    {
        ...
        private Outputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern? _mValue_MatchPattern;
        private bool _mUnknown_MatchPattern;
        public Outputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern? MatchPattern
        {
            get
            {
                if (!_mUnknown_MatchPattern) return _mValue_MatchPattern;
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader.MatchPattern' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader.OversizeHandling' is not present");
            }
        }
    }
}
