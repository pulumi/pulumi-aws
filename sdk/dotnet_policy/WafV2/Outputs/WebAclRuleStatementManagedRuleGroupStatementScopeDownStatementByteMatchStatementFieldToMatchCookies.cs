...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementByteMatchStatementFieldToMatchCookies
    {
        ...
        private List<Outputs.WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementByteMatchStatementFieldToMatchCookiesMatchPattern>? _mValue_MatchPatterns;
        private bool _mUnknown_MatchPatterns;
        public List<Outputs.WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementByteMatchStatementFieldToMatchCookiesMatchPattern>? MatchPatterns
        {
            get
            {
                if (!_mUnknown_MatchPatterns) return _mValue_MatchPatterns;
                throw new UndeferrableValueException("Value 'WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementByteMatchStatementFieldToMatchCookies.MatchPatterns' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementByteMatchStatementFieldToMatchCookies.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementManagedRuleGroupStatementScopeDownStatementByteMatchStatementFieldToMatchCookies.OversizeHandling' is not present");
            }
        }
    }
}
