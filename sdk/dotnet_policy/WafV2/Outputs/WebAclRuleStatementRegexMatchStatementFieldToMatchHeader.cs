...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class WebAclRuleStatementRegexMatchStatementFieldToMatchHeader
    {
        ...
        private Outputs.WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern? _mValue_MatchPattern;
        private bool _mUnknown_MatchPattern;
        public Outputs.WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPattern? MatchPattern
        {
            get
            {
                if (!_mUnknown_MatchPattern) return _mValue_MatchPattern;
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexMatchStatementFieldToMatchHeader.MatchPattern' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexMatchStatementFieldToMatchHeader.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'WebAclRuleStatementRegexMatchStatementFieldToMatchHeader.OversizeHandling' is not present");
            }
        }
    }
}
