...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class RuleGroupRuleStatementSqliMatchStatementFieldToMatchCookies
    {
        ...
        private List<Outputs.RuleGroupRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern>? _mValue_MatchPatterns;
        private bool _mUnknown_MatchPatterns;
        public List<Outputs.RuleGroupRuleStatementSqliMatchStatementFieldToMatchCookiesMatchPattern>? MatchPatterns
        {
            get
            {
                if (!_mUnknown_MatchPatterns) return _mValue_MatchPatterns;
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSqliMatchStatementFieldToMatchCookies.MatchPatterns' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSqliMatchStatementFieldToMatchCookies.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSqliMatchStatementFieldToMatchCookies.OversizeHandling' is not present");
            }
        }
    }
}
