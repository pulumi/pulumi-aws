...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class RuleGroupRuleStatementRateBasedStatement
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.RuleGroupRuleStatementRateBasedStatementCustomKey>? _mValue_CustomKeys;
        private bool _mUnknown_CustomKeys;
        public List<Outputs.RuleGroupRuleStatementRateBasedStatementCustomKey>? CustomKeys
        {
            get
            {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Outputs.RuleGroupRuleStatementRateBasedStatementForwardedIpConfig? _mValue_ForwardedIpConfig;
        private bool _mUnknown_ForwardedIpConfig;
        public Outputs.RuleGroupRuleStatementRateBasedStatementForwardedIpConfig? ForwardedIpConfig
        {
            get
            {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Outputs.RuleGroupRuleStatementRateBasedStatementScopeDownStatement? _mValue_ScopeDownStatement;
        private bool _mUnknown_ScopeDownStatement;
        public Outputs.RuleGroupRuleStatementRateBasedStatementScopeDownStatement? ScopeDownStatement
        {
            get
            {
