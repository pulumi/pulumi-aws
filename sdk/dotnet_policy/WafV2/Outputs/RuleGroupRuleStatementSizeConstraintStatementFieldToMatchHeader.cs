...
{
    public sealed class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeader
    {
        /// <summary>
        ...
        private Outputs.RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern? _mValue_MatchPattern;
        private bool _mUnknown_MatchPattern;
        public Outputs.RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern? MatchPattern
        {
            get
            {
                if (!_mUnknown_MatchPattern) return _mValue_MatchPattern;
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeader.MatchPattern' is not present");
            }
        }
        ...
        public string? MatchScope
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeader.MatchScope' is not present");
            }
        }
        ...
        public string? OversizeHandling
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeader.OversizeHandling' is not present");
            }
        }
    }
}
