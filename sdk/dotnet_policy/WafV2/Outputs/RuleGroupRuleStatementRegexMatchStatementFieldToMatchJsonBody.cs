...
namespace Pulumi.PolicyPacks.Aws.WafV2.Outputs
{
    public sealed class RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody
    {
        ...
        [Input("matchPattern")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern> _mMatchPattern;

        public Outputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern? MatchPattern => _mMatchPattern.GetValue("matchPattern");
