...
{
    public sealed class PipelineStageBeforeEntryConditionArgs
    {
        /// <summary>
        ...
        [Input("rules")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.PipelineStageBeforeEntryConditionRuleArgs>> _mRules;

        public List<Inputs.PipelineStageBeforeEntryConditionRuleArgs>? Rules => _mRules.GetValue("rules");
    }
}
