...
namespace Pulumi.PolicyPacks.Aws.CodePipeline.Outputs
{
    public sealed class PipelineStageOnFailureConditionRule
    {
        ...
        [Input("ruleTypeId")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.PipelineStageOnFailureConditionRuleRuleTypeId> _mRuleTypeId;

        public Outputs.PipelineStageOnFailureConditionRuleRuleTypeId? RuleTypeId => _mRuleTypeId.GetValue("ruleTypeId");
