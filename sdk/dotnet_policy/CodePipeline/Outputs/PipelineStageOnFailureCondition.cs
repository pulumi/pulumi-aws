...
namespace Pulumi.PolicyPacks.Aws.CodePipeline.Outputs
{
    public sealed class PipelineStageOnFailureCondition
    {
        ...
        [Input("rules")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.PipelineStageOnFailureConditionRule>> _mRules;

        public List<Outputs.PipelineStageOnFailureConditionRule>? Rules => _mRules.GetValue("rules");
    }
}
