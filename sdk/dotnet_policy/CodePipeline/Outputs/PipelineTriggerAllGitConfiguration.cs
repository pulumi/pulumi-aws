...
namespace Pulumi.PolicyPacks.Aws.CodePipeline.Outputs
{
    public sealed class PipelineTriggerAllGitConfiguration
    {
        ...
        private List<Outputs.PipelineTriggerAllGitConfigurationPullRequest>? _mValue_PullRequests;
        private bool _mUnknown_PullRequests;
        public List<Outputs.PipelineTriggerAllGitConfigurationPullRequest>? PullRequests
        {
            get
            {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.PipelineTriggerAllGitConfigurationPush>? _mValue_Pushes;
        private bool _mUnknown_Pushes;
        public List<Outputs.PipelineTriggerAllGitConfigurationPush>? Pushes
        {
            get
            {
