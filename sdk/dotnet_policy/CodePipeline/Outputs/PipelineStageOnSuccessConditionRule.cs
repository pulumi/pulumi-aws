...
namespace Pulumi.PolicyPacks.Aws.CodePipeline.Outputs
{
    public sealed class PipelineStageOnSuccessConditionRule
    {
        ...
        [Input("ruleTypeId")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.PipelineStageOnSuccessConditionRuleRuleTypeId> _mRuleTypeId;

        public Outputs.PipelineStageOnSuccessConditionRuleRuleTypeId? RuleTypeId => _mRuleTypeId.GetValue("ruleTypeId");
