...
namespace Pulumi.PolicyPacks.Aws.BcmData.Inputs
{
    public sealed class ExportExportDestinationConfigurationS3DestinationArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.ExportExportDestinationConfigurationS3DestinationS3OutputConfigurationArgs>> _mS3OutputConfigurations;

        public List<Inputs.ExportExportDestinationConfigurationS3DestinationS3OutputConfigurationArgs>? S3OutputConfigurations => _mS3OutputConfigurations.GetValue("s3OutputConfigurations");
