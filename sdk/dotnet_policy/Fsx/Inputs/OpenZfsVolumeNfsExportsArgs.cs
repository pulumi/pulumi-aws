...
namespace Pulumi.PolicyPacks.Aws.Fsx.Inputs
{
    public sealed class OpenZfsVolumeNfsExportsArgs
    {
        ...
        private List<Inputs.OpenZfsVolumeNfsExportsClientConfigurationArgs>? _mValue_ClientConfigurations;
        private bool _mUnknown_ClientConfigurations;
        public List<Inputs.OpenZfsVolumeNfsExportsClientConfigurationArgs>? ClientConfigurations
        {
            get
            {
