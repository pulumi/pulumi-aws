...
namespace Pulumi.PolicyPacks.Aws.DataSync.Inputs
{
    public sealed class LocationFsxOntapFileSystemProtocolSmbArgs
    {
        ...
        [Input("mountOptions")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Inputs.LocationFsxOntapFileSystemProtocolSmbMountOptionsArgs> _mMountOptions;

        public Inputs.LocationFsxOntapFileSystemProtocolSmbMountOptionsArgs? MountOptions => _mMountOptions.GetValue("mountOptions");
