...
namespace Pulumi.PolicyPacks.Aws.Sagemaker.Outputs
{
    public sealed class DataQualityJobDefinitionNetworkConfig
    {
        ...
        [Input("vpcConfig")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.DataQualityJobDefinitionNetworkConfigVpcConfig> _mVpcConfig;

        public Outputs.DataQualityJobDefinitionNetworkConfigVpcConfig? VpcConfig => _mVpcConfig.GetValue("vpcConfig");
    }
}
