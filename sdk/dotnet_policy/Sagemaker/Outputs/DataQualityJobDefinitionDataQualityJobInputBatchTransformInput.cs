...
namespace Pulumi.PolicyPacks.Aws.Sagemaker.Outputs
{
    public sealed class DataQualityJobDefinitionDataQualityJobInputBatchTransformInput
    {
        ...
        [Input("datasetFormat")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.DataQualityJobDefinitionDataQualityJobInputBatchTransformInputDatasetFormat> _mDatasetFormat;

        public Outputs.DataQualityJobDefinitionDataQualityJobInputBatchTransformInputDatasetFormat? DatasetFormat => _mDatasetFormat.GetValue("datasetFormat");
