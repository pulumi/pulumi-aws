...
namespace Pulumi.PolicyPacks.Aws.Sagemaker.Inputs
{
    public sealed class ModelContainerModelDataSourceArgs
    {
        ...
        private List<Inputs.ModelContainerModelDataSourceS3DataSourceArgs>? _mValue_S3DataSources;
        private bool _mUnknown_S3DataSources;
        public List<Inputs.ModelContainerModelDataSourceS3DataSourceArgs>? S3DataSources
        {
            get
            {
