...
namespace Pulumi.PolicyPacks.Aws.SsoAdmin.Outputs
{
    public sealed class GetApplicationProvidersApplicationProviderResult
    {
        ...
        [Input("displayDatas")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.GetApplicationProvidersApplicationProviderDisplayDataResult>> _mDisplayDatas;

        public List<Outputs.GetApplicationProvidersApplicationProviderDisplayDataResult>? DisplayDatas => _mDisplayDatas.GetValue("displayDatas");
