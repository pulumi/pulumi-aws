    ...
    public sealed class GetApplicationProvidersApplicationProviderResult
    {
        ...
        public string? ApplicationProviderArn
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetApplicationProvidersApplicationProviderResult.ApplicationProviderArn' is not present");
            }
        }
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.GetApplicationProvidersApplicationProviderDisplayDataResult>? _mValue_DisplayDatas;
        private bool _mUnknown_DisplayDatas;
        public List<Outputs.GetApplicationProvidersApplicationProviderDisplayDataResult>? DisplayDatas
        {
            get
            {
                if (!_mUnknown_DisplayDatas) return _mValue_DisplayDatas;
                throw new UndeferrableValueException("Value 'GetApplicationProvidersApplicationProviderResult.DisplayDatas' is not present");
            }
        }
        ...
        public string? FederationProtocol
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'GetApplicationProvidersApplicationProviderResult.FederationProtocol' is not present");
            }
        }
    }
}
