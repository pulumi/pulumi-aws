...
namespace Pulumi.PolicyPacks.Aws.Pipes.Outputs
{
    public sealed class PipeSourceParametersDynamodbStreamParameters
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Outputs.PipeSourceParametersDynamodbStreamParametersDeadLetterConfig> _mDeadLetterConfig;

        public Outputs.PipeSourceParametersDynamodbStreamParametersDeadLetterConfig? DeadLetterConfig => _mDeadLetterConfig.GetValue("deadLetterConfig");
