...
namespace Pulumi.PolicyPacks.Aws.Pipes.Inputs
{
    public sealed class PipeSourceParametersDynamodbStreamParametersArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Inputs.PipeSourceParametersDynamodbStreamParametersDeadLetterConfigArgs> _mDeadLetterConfig;

        public Inputs.PipeSourceParametersDynamodbStreamParametersDeadLetterConfigArgs? DeadLetterConfig => _mDeadLetterConfig.GetValue("deadLetterConfig");
