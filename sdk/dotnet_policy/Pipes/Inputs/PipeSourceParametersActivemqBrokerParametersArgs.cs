...
namespace Pulumi.PolicyPacks.Aws.Pipes.Inputs
{
    public sealed class PipeSourceParametersActivemqBrokerParametersArgs
    {
        ...
        [Input("credentials")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<Inputs.PipeSourceParametersActivemqBrokerParametersCredentialsArgs> _mCredentials;

        public Inputs.PipeSourceParametersActivemqBrokerParametersCredentialsArgs? Credentials => _mCredentials.GetValue("credentials");
