...
namespace Pulumi.PolicyPacks.Aws.ImageBuilder.Outputs
{
    public sealed class ImagePipelineWorkflow
    {
        ...
        [Input("parameters")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.ImagePipelineWorkflowParameter>> _mParameters;

        public List<Outputs.ImagePipelineWorkflowParameter>? Parameters => _mParameters.GetValue("parameters");
