...
{
    public sealed class ImageWorkflowArgs
    {
        /// <summary>
        ...
        [Input("parameters")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.ImageWorkflowParameterArgs>> _mParameters;

        public List<Inputs.ImageWorkflowParameterArgs>? Parameters => _mParameters.GetValue("parameters");
