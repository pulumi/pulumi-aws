...
namespace Pulumi.PolicyPacks.Aws.Transfer.Outputs
{
    public sealed class WorkflowStepTagStepDetails
    {
        ...
        [Input("tags")]
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.WorkflowStepTagStepDetailsTag>> _mTags;

        public List<Outputs.WorkflowStepTagStepDetailsTag>? Tags => _mTags.GetValue("tags");
    }
}
