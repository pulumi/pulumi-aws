...
namespace Pulumi.PolicyPacks.Aws.Kendra.Outputs
{
    public sealed class DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration
    {
        ...
        private Outputs.DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationCondition? _mValue_InvocationCondition;
        private bool _mUnknown_InvocationCondition;
        public Outputs.DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationInvocationCondition? InvocationCondition
        {
            get
            {
                if (!_mUnknown_InvocationCondition) return _mValue_InvocationCondition;
                throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration.InvocationCondition' is not present");
            }
        }
        ...
        public string? LambdaArn
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration.LambdaArn' is not present");
            }
        }
        ...
        public string? S3Bucket
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration.S3Bucket' is not present");
            }
        }
    }
}
