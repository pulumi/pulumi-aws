...
{
    public sealed class IndexUserGroupResolutionConfigurationArgs
    {
        /// <summary>
        ...
        public string? UserGroupResolutionMode
        {
            get
            {
                ...
                throw new UndeferrableValueException("Value 'IndexUserGroupResolutionConfigurationArgs.UserGroupResolutionMode' is not present");
            }
        }
    }
}
