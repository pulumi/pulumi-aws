...
namespace Pulumi.PolicyPacks.Aws.DataZone.Inputs
{
    public sealed class EnvironmentLastDeploymentArgs
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Inputs.EnvironmentLastDeploymentFailureReasonArgs>> _mFailureReasons;

        public List<Inputs.EnvironmentLastDeploymentFailureReasonArgs>? FailureReasons => _mFailureReasons.GetValue("failureReasons");
