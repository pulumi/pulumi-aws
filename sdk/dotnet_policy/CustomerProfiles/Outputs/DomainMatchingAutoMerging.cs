...
namespace Pulumi.PolicyPacks.Aws.CustomerProfiles.Outputs
{
    public sealed class DomainMatchingAutoMerging
    {
        ...
        private Outputs.DomainMatchingAutoMergingConflictResolution? _mValue_ConflictResolution;
        private bool _mUnknown_ConflictResolution;
        public Outputs.DomainMatchingAutoMergingConflictResolution? ConflictResolution
        {
            get
            {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private Outputs.DomainMatchingAutoMergingConsolidation? _mValue_Consolidation;
        private bool _mUnknown_Consolidation;
        public Outputs.DomainMatchingAutoMergingConsolidation? Consolidation
        {
            get
            {
