...
namespace Pulumi.PolicyPacks.Aws.Batch.Outputs
{
    public sealed class SchedulingPolicyFairSharePolicy
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.SchedulingPolicyFairSharePolicyShareDistribution>> _mShareDistributions;

        public List<Outputs.SchedulingPolicyFairSharePolicyShareDistribution>? ShareDistributions => _mShareDistributions.GetValue("shareDistributions");
    }
}
