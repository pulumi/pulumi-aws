...
namespace Pulumi.PolicyPacks.Aws.Batch.Outputs
{
    public sealed class SchedulingPolicyFairSharePolicy
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.SchedulingPolicyFairSharePolicyShareDistribution>? _mValue_ShareDistributions;
        private bool _mUnknown_ShareDistributions;
        public List<Outputs.SchedulingPolicyFairSharePolicyShareDistribution>? ShareDistributions
        {
            get
            {
