...
namespace Pulumi.PolicyPacks.Aws.SsmIncidents.Outputs
{
    public sealed class GetResponsePlanIncidentTemplateResult
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.GetResponsePlanIncidentTemplateNotificationTargetResult>> _mNotificationTargets;

        public List<Outputs.GetResponsePlanIncidentTemplateNotificationTargetResult>? NotificationTargets => _mNotificationTargets.GetValue("notificationTargets");
