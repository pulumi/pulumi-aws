...
namespace Pulumi.PolicyPacks.Aws.S3Control.Outputs
{
    public sealed class ObjectLambdaAccessPointConfiguration
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private List<Outputs.ObjectLambdaAccessPointConfigurationTransformationConfiguration>? _mValue_TransformationConfigurations;
        private bool _mUnknown_TransformationConfigurations;
        public List<Outputs.ObjectLambdaAccessPointConfigurationTransformationConfiguration>? TransformationConfigurations
        {
            get
            {
