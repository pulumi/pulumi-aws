...
namespace Pulumi.PolicyPacks.Aws.S3Control.Outputs
{
    public sealed class ObjectLambdaAccessPointConfiguration
    {
        ...
        #pragma warning disable CS0649 // Field is assigned through deserializer
        private global::Pulumi.Core.UndeferrableValue<List<Outputs.ObjectLambdaAccessPointConfigurationTransformationConfiguration>> _mTransformationConfigurations;

        public List<Outputs.ObjectLambdaAccessPointConfigurationTransformationConfiguration>? TransformationConfigurations => _mTransformationConfigurations.GetValue("transformationConfigurations");
    }
}
