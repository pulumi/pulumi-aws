...
public final class AnomalySubscriptionThresholdExpressionAndDimension {
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionAndDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionAndDimension defaults) {
