...
public final class NetworkManagedServiceS3Access {
    ...
    public static Builder builder(NetworkManagedServiceS3Access defaults) {
    ...
    public static final class Builder {
        ...
        private String status;
        public Builder() {}
        public Builder(NetworkManagedServiceS3Access defaults) {
        ...
        public Builder domainName(String domainName) {
            if (domainName == null) {
              throw new MissingRequiredPropertyException("NetworkManagedServiceS3Access", "domainName");
            }
        ...
        public Builder ipv4Addresses(List<String> ipv4Addresses) {
            if (ipv4Addresses == null) {
              throw new MissingRequiredPropertyException("NetworkManagedServiceS3Access", "ipv4Addresses");
            }
        ...
        public Builder s3PolicyDocument(String s3PolicyDocument) {
            if (s3PolicyDocument == null) {
              throw new MissingRequiredPropertyException("NetworkManagedServiceS3Access", "s3PolicyDocument");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("NetworkManagedServiceS3Access", "status");
            }
            this.status = status;
            return this;
        }
        public NetworkManagedServiceS3Access build() {
            final var _resultValue = new NetworkManagedServiceS3Access();
