...
public class StreamConsumer extends com.pulumi.resources.CustomResource {
     ...
     */
    public StreamConsumer(java.lang.String name) {
     ...
     */
    public StreamConsumer(java.lang.String name, StreamConsumerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public StreamConsumer(java.lang.String name, StreamConsumerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:kinesis/streamConsumer:StreamConsumer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private StreamConsumer(java.lang.String name, Output<java.lang.String> id, @Nullable StreamConsumerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:kinesis/streamConsumer:StreamConsumer", name, state, makeResourceOptions(options, id), false);
    }

    private static StreamConsumerArgs makeArgs(StreamConsumerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? StreamConsumerArgs.Empty : args;
    }
     ...
     */
    public static StreamConsumer get(java.lang.String name, Output<java.lang.String> id, @Nullable StreamConsumerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
