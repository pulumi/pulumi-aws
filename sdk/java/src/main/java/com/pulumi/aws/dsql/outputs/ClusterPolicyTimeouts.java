...
@CustomType
public final class ClusterPolicyTimeouts {
    /**
    ...
    public static Builder builder(ClusterPolicyTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ClusterPolicyTimeouts defaults) {
        ...
        public ClusterPolicyTimeouts build() {
            final var _resultValue = new ClusterPolicyTimeouts();
