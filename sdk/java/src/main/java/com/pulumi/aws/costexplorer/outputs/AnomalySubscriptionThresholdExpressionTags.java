...
@CustomType
public final class AnomalySubscriptionThresholdExpressionTags {
    /**
    ...
    private AnomalySubscriptionThresholdExpressionTags() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionTags defaults) {
