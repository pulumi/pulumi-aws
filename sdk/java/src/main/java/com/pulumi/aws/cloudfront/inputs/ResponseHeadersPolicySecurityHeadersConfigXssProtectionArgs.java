...
public final class ResponseHeadersPolicySecurityHeadersConfigXssProtectionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param reportUri A reporting URI, which CloudFront uses as the value of the report directive in the `X-XSS-Protection` header. You cannot specify a `reportUri` when `modeBlock` is `true`.
         * 
         * @return builder
         * 
         */
