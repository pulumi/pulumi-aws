...
public final class ViewTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ViewTimeoutsArgs Empty = new ViewTimeoutsArgs();
    ...
    private ViewTimeoutsArgs() {}

    private ViewTimeoutsArgs(ViewTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(ViewTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ViewTimeoutsArgs();
        }

        public Builder(ViewTimeoutsArgs defaults) {
            $ = new ViewTimeoutsArgs(Objects.requireNonNull(defaults));
        }
