...
import com.pulumi.aws.lex.outputs.V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStepDialogAction;
import com.pulumi.aws.lex.outputs.V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStepIntent;
...
public final class V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStep {
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStep defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Map<String,String> sessionAttributes;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStep defaults) {
        ...
        @CustomType.Setter
        public Builder dialogAction(@Nullable V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStepDialogAction dialogAction) {

            this.dialogAction = dialogAction;
            return this;
        }
        @CustomType.Setter
        public Builder intent(@Nullable V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStepIntent intent) {
        ...
        public V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStep build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingConditionalConditionalBranchNextStep();
