...
public final class VirtualNodeSpecListenerTimeoutGrpcIdle {
    ...
    public static final class Builder {
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecListenerTimeoutGrpcIdle", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder value(Integer value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecListenerTimeoutGrpcIdle", "value");
            }
            this.value = value;
            return this;
        }
        public VirtualNodeSpecListenerTimeoutGrpcIdle build() {
            final var _resultValue = new VirtualNodeSpecListenerTimeoutGrpcIdle();
