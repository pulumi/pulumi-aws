...
public class ClusterPolicy extends com.pulumi.resources.CustomResource {
    ...
    public ClusterPolicy(java.lang.String name, ClusterPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:msk/clusterPolicy:ClusterPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClusterPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable ClusterPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:msk/clusterPolicy:ClusterPolicy", name, state, makeResourceOptions(options, id), false);
    }
