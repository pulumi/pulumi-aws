...
public class FindingsFilter extends com.pulumi.resources.CustomResource {
     ...
     */
    public FindingsFilter(java.lang.String name) {
     ...
     */
    public FindingsFilter(java.lang.String name, FindingsFilterArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public FindingsFilter(java.lang.String name, FindingsFilterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:macie/findingsFilter:FindingsFilter", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private FindingsFilter(java.lang.String name, Output<java.lang.String> id, @Nullable FindingsFilterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:macie/findingsFilter:FindingsFilter", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static FindingsFilter get(java.lang.String name, Output<java.lang.String> id, @Nullable FindingsFilterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
