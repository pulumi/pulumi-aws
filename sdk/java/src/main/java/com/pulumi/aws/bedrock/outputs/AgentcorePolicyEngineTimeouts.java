...
@CustomType
public final class AgentcorePolicyEngineTimeouts {
    /**
    ...
    public static Builder builder(AgentcorePolicyEngineTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(AgentcorePolicyEngineTimeouts defaults) {
        ...
        public AgentcorePolicyEngineTimeouts build() {
            final var _resultValue = new AgentcorePolicyEngineTimeouts();
