...
import com.pulumi.aws.mailmanager.inputs.RuleSetState;
import com.pulumi.aws.mailmanager.outputs.RuleSetRule;
 ...
 * 
 */
@ResourceType(type="aws:mailmanager/ruleSet:RuleSet")
public class RuleSet extends com.pulumi.resources.CustomResource {
    ...
    public RuleSet(java.lang.String name, @Nullable RuleSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:mailmanager/ruleSet:RuleSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RuleSet(java.lang.String name, Output<java.lang.String> id, @Nullable RuleSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:mailmanager/ruleSet:RuleSet", name, state, makeResourceOptions(options, id), false);
    }
