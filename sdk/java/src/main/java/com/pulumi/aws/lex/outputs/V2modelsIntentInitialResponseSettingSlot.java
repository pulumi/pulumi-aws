...
@CustomType
public final class V2modelsIntentInitialResponseSettingSlot {
    /**
    ...
    private V2modelsIntentInitialResponseSettingSlot() {}
    /**
     * @return Which attempt to configure. Valid values are `Initial`, `Retry1`, `Retry2`, `Retry3`, `Retry4`, `Retry5`.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingSlot defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable V2modelsIntentInitialResponseSettingValue value;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingSlot defaults) {
        ...
        public Builder mapBlockKey(String mapBlockKey) {
            if (mapBlockKey == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingSlot", "mapBlockKey");
            }
        ...
        public V2modelsIntentInitialResponseSettingSlot build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingSlot();
