...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs Empty = new WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs();
    ...
    private Output<WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs() {}

    private WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs(WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs();
        }

        public Builder(WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs defaults) {
            $ = new WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs build() {
