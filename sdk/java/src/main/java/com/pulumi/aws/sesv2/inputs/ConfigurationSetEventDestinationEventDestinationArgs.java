...
public final class ConfigurationSetEventDestinationEventDestinationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Object that defines an Amazon CloudWatch destination for email events. See `cloudWatchDestination` Block for details.
     * 
     */
    ...
    /**
     * @return Object that defines an Amazon EventBridge destination for email events. You can use Amazon EventBridge to send notifications when certain email events occur. See `eventBridgeDestination` Block for details.
     * 
     */
    ...
    /**
     * @return Object that defines an Amazon Kinesis Data Firehose destination for email events. See `kinesisFirehoseDestination` Block for details.
     * 
     */
    ...
    /**
     * @return Object that defines an AWS End User Messaging project destination for email events. See `pinpointDestination` Block for details.
     * 
     */
    ...
    /**
     * @return Object that defines an Amazon SNS destination for email events. See `snsDestination` Block for details.
     * 
     */
