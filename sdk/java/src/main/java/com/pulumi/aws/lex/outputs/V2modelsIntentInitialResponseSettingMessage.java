...
@CustomType
public final class V2modelsIntentInitialResponseSettingMessage {
    /**
    ...
    private V2modelsIntentInitialResponseSettingMessage() {}
    /**
     * @return Configuration block for a message in a custom format defined by the client application. See `custom_payload`.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingMessage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable V2modelsIntentInitialResponseSettingSsmlMessage ssmlMessage;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingMessage defaults) {
        ...
        public V2modelsIntentInitialResponseSettingMessage build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingMessage();
