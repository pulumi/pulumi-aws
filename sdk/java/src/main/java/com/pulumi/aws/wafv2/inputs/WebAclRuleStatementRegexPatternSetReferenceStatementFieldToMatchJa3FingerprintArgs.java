...
public final class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs();
        }

        public Builder(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs defaults) {
            $ = new WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs build() {
            if ($.fallbackBehavior == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3FingerprintArgs", "fallbackBehavior");
            }
            return $;
        }
    }
