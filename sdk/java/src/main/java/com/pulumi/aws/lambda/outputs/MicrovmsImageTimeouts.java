...
@CustomType
public final class MicrovmsImageTimeouts {
    /**
    ...
    public static Builder builder(MicrovmsImageTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(MicrovmsImageTimeouts defaults) {
        ...
        public MicrovmsImageTimeouts build() {
            final var _resultValue = new MicrovmsImageTimeouts();
