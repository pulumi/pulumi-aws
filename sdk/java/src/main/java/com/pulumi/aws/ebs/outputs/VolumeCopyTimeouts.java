...
@CustomType
public final class VolumeCopyTimeouts {
    /**
    ...
    public static Builder builder(VolumeCopyTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(VolumeCopyTimeouts defaults) {
        ...
        public VolumeCopyTimeouts build() {
            final var _resultValue = new VolumeCopyTimeouts();
