...
public final class BudgetFilterExpressionAndDimensionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionAndDimensionsArgs Empty = new BudgetFilterExpressionAndDimensionsArgs();
    ...
    private BudgetFilterExpressionAndDimensionsArgs() {}

    private BudgetFilterExpressionAndDimensionsArgs(BudgetFilterExpressionAndDimensionsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionAndDimensionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionAndDimensionsArgs();
        }

        public Builder(BudgetFilterExpressionAndDimensionsArgs defaults) {
            $ = new BudgetFilterExpressionAndDimensionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionAndDimensionsArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionAndDimensionsArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionAndDimensionsArgs", "values");
            }
            return $;
        }
    }
