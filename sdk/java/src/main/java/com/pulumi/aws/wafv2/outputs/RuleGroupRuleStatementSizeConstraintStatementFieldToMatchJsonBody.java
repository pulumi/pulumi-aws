...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern;
...
public final class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody {
    ...
    public static Builder builder(RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
            if (matchPattern == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody", "matchPattern");
            }
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody", "matchScope");
            }
        ...
        public RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody build() {
            final var _resultValue = new RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJsonBody();
