...
public final class ElasticClusterTimeouts {
    ...
    public static Builder builder(ElasticClusterTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ElasticClusterTimeouts defaults) {
        ...
        public ElasticClusterTimeouts build() {
            final var _resultValue = new ElasticClusterTimeouts();
