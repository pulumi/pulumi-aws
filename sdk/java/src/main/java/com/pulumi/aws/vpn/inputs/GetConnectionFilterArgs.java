...
public final class GetConnectionFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetConnectionFilterArgs Empty = new GetConnectionFilterArgs();
    ...
    private GetConnectionFilterArgs() {}

    private GetConnectionFilterArgs(GetConnectionFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetConnectionFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetConnectionFilterArgs();
        }

        public Builder(GetConnectionFilterArgs defaults) {
            $ = new GetConnectionFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetConnectionFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetConnectionFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetConnectionFilterArgs", "values");
            }
            return $;
        }
    }
