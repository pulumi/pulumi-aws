...
public final class SavingsPlanTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final SavingsPlanTimeoutsArgs Empty = new SavingsPlanTimeoutsArgs();
    ...
    private SavingsPlanTimeoutsArgs() {}

    private SavingsPlanTimeoutsArgs(SavingsPlanTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
    }
    ...
    public static Builder builder(SavingsPlanTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SavingsPlanTimeoutsArgs();
        }

        public Builder(SavingsPlanTimeoutsArgs defaults) {
            $ = new SavingsPlanTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SavingsPlanTimeoutsArgs build() {
            return $;
        }
    }
