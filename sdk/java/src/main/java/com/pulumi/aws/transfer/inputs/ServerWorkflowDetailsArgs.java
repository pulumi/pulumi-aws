...
public final class ServerWorkflowDetailsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Trigger that starts a workflow if a file is only partially uploaded. See `onPartialUpload` Block below for details.
     * 
     */
    ...
    /**
     * @return Trigger that starts a workflow: the workflow begins to execute after a file is uploaded. See `onUpload` Block below for details.
     * 
     */
