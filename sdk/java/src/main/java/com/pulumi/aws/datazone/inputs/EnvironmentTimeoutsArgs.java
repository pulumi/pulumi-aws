...
public final class EnvironmentTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final EnvironmentTimeoutsArgs Empty = new EnvironmentTimeoutsArgs();
    ...
    private EnvironmentTimeoutsArgs() {}

    private EnvironmentTimeoutsArgs(EnvironmentTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(EnvironmentTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentTimeoutsArgs();
        }

        public Builder(EnvironmentTimeoutsArgs defaults) {
            $ = new EnvironmentTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EnvironmentTimeoutsArgs build() {
            return $;
        }
    }
