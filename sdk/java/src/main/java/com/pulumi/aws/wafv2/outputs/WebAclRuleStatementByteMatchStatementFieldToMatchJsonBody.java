...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern;
...
public final class WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody {
     ...
     * 
     */
    private @Nullable WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
     ...
     * 
     */
    public Optional<WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern() {
    ...
    public static Builder builder(WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(@Nullable WebAclRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementByteMatchStatementFieldToMatchJsonBody", "matchScope");
            }
