...
public final class V2modelsIntentFulfillmentCodeHookValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentFulfillmentCodeHookValueArgs Empty = new V2modelsIntentFulfillmentCodeHookValueArgs();
    ...
    private V2modelsIntentFulfillmentCodeHookValueArgs() {}

    private V2modelsIntentFulfillmentCodeHookValueArgs(V2modelsIntentFulfillmentCodeHookValueArgs $) {
    ...
    public static Builder builder(V2modelsIntentFulfillmentCodeHookValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentFulfillmentCodeHookValueArgs();
        }

        public Builder(V2modelsIntentFulfillmentCodeHookValueArgs defaults) {
            $ = new V2modelsIntentFulfillmentCodeHookValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentFulfillmentCodeHookValueArgs build() {
            return $;
        }
    }
