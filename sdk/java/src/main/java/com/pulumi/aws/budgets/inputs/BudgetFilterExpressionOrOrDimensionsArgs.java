...
public final class BudgetFilterExpressionOrOrDimensionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionOrOrDimensionsArgs Empty = new BudgetFilterExpressionOrOrDimensionsArgs();
    ...
    private BudgetFilterExpressionOrOrDimensionsArgs() {}

    private BudgetFilterExpressionOrOrDimensionsArgs(BudgetFilterExpressionOrOrDimensionsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionOrOrDimensionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionOrOrDimensionsArgs();
        }

        public Builder(BudgetFilterExpressionOrOrDimensionsArgs defaults) {
            $ = new BudgetFilterExpressionOrOrDimensionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionOrOrDimensionsArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionOrOrDimensionsArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionOrOrDimensionsArgs", "values");
            }
            return $;
        }
    }
