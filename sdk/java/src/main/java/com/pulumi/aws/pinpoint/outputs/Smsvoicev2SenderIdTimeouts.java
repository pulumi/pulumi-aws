...
@CustomType
public final class Smsvoicev2SenderIdTimeouts {
    /**
    ...
    public static Builder builder(Smsvoicev2SenderIdTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(Smsvoicev2SenderIdTimeouts defaults) {
        ...
        public Smsvoicev2SenderIdTimeouts build() {
            final var _resultValue = new Smsvoicev2SenderIdTimeouts();
