...
@CustomType
public final class MlflowAppTimeouts {
    /**
    ...
    public static Builder builder(MlflowAppTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(MlflowAppTimeouts defaults) {
        ...
        public MlflowAppTimeouts build() {
            final var _resultValue = new MlflowAppTimeouts();
