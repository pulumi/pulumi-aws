...
public final class InsightFiltersResourceAwsEc2InstanceIamInstanceProfileArn {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsEc2InstanceIamInstanceProfileArn", "comparison");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsEc2InstanceIamInstanceProfileArn", "value");
            }
            this.value = value;
            return this;
        }
