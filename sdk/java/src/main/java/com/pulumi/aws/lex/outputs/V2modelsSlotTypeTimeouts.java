...
public final class V2modelsSlotTypeTimeouts {
    ...
    public static Builder builder(V2modelsSlotTypeTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(V2modelsSlotTypeTimeouts defaults) {
        ...
        public V2modelsSlotTypeTimeouts build() {
            final var _resultValue = new V2modelsSlotTypeTimeouts();
