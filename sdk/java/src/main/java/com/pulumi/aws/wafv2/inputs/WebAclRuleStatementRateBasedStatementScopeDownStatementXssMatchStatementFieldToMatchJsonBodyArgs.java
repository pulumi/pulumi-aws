...
public final class WebAclRuleStatementRateBasedStatementScopeDownStatementXssMatchStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<WebAclRuleStatementRateBasedStatementScopeDownStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;

    /**
     * @return JSON content to inspect. See JSON Body Match Pattern below.
     * 
     */
    public Optional<Output<WebAclRuleStatementRateBasedStatementScopeDownStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs>> matchPattern() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder matchPattern(@Nullable Output<WebAclRuleStatementRateBasedStatementScopeDownStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
