...
public final class RegistryTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegistryTimeoutsArgs Empty = new RegistryTimeoutsArgs();
    ...
    private RegistryTimeoutsArgs() {}

    private RegistryTimeoutsArgs(RegistryTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(RegistryTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryTimeoutsArgs();
        }

        public Builder(RegistryTimeoutsArgs defaults) {
            $ = new RegistryTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegistryTimeoutsArgs build() {
            return $;
        }
    }
