...
public final class MysqlLayerState extends com.pulumi.resources.ResourceArgs {

    public static final MysqlLayerState Empty = new MysqlLayerState();
    ...
    private MysqlLayerState() {}

    private MysqlLayerState(MysqlLayerState $) {
        this.arn = $.arn;
    ...
    public static Builder builder(MysqlLayerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MysqlLayerState defaults) {
            $ = new MysqlLayerState(Objects.requireNonNull(defaults));
        }
