...
public final class ScheduledActionScalableTargetActionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param maxCapacity Maximum capacity. At least one of `maxCapacity` or `minCapacity` must be set.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param minCapacity Minimum capacity. At least one of `minCapacity` or `maxCapacity` must be set.
         * 
         * @return builder
         * 
         */
