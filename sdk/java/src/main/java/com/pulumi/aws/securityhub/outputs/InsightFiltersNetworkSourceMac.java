...
public final class InsightFiltersNetworkSourceMac {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersNetworkSourceMac", "comparison");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersNetworkSourceMac", "value");
            }
            this.value = value;
            return this;
        }
