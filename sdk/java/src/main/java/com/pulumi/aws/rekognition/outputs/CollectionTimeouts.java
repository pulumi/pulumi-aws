...
public final class CollectionTimeouts {
    ...
    public static Builder builder(CollectionTimeouts defaults) {
    ...
    public static final class Builder {
        private @Nullable String create;
        public Builder() {}
        public Builder(CollectionTimeouts defaults) {
        ...
        public CollectionTimeouts build() {
            final var _resultValue = new CollectionTimeouts();
