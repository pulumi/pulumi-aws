...
@CustomType
public final class GetCostCategoryRuleRuleAndNotTag {
    /**
    ...
    private GetCostCategoryRuleRuleAndNotTag() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(GetCostCategoryRuleRuleAndNotTag defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(GetCostCategoryRuleRuleAndNotTag defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndNotTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder matchOptions(List<String> matchOptions) {
            if (matchOptions == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndNotTag", "matchOptions");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndNotTag", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetCostCategoryRuleRuleAndNotTag build() {
            final var _resultValue = new GetCostCategoryRuleRuleAndNotTag();
