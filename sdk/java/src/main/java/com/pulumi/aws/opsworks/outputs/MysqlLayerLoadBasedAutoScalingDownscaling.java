...
public final class MysqlLayerLoadBasedAutoScalingDownscaling {
    ...
    private MysqlLayerLoadBasedAutoScalingDownscaling() {}
    ...
    public static Builder builder(MysqlLayerLoadBasedAutoScalingDownscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(MysqlLayerLoadBasedAutoScalingDownscaling defaults) {
        ...
        public MysqlLayerLoadBasedAutoScalingDownscaling build() {
            final var _resultValue = new MysqlLayerLoadBasedAutoScalingDownscaling();
