...
import com.pulumi.aws.quicksight.outputs.VisualsInsightVisualInsightConfiguration;
...
@CustomType
public final class VisualsInsightVisual {
    /**
    ...
    private @Nullable VisualsInsightVisualInsightConfiguration insightConfiguration;
    ...
    public Optional<VisualsInsightVisualInsightConfiguration> insightConfiguration() {
    ...
    public static Builder builder(VisualsInsightVisual defaults) {
    ...
    public static final class Builder {
        ...
        private String visualId;
        public Builder() {}
        public Builder(VisualsInsightVisual defaults) {
    	      Objects.requireNonNull(defaults);
    	      this.actions = defaults.actions;
    	      this.dataSetIdentifier = defaults.dataSetIdentifier;
    	      this.insightConfiguration = defaults.insightConfiguration;
        ...
        public Builder dataSetIdentifier(String dataSetIdentifier) {
            if (dataSetIdentifier == null) {
              throw new MissingRequiredPropertyException("VisualsInsightVisual", "dataSetIdentifier");
            }
            this.dataSetIdentifier = dataSetIdentifier;
            return this;
        }
        @CustomType.Setter
        public Builder insightConfiguration(@Nullable VisualsInsightVisualInsightConfiguration insightConfiguration) {
        ...
        public Builder visualId(String visualId) {
            if (visualId == null) {
              throw new MissingRequiredPropertyException("VisualsInsightVisual", "visualId");
            }
            this.visualId = visualId;
            return this;
        }
        public VisualsInsightVisual build() {
            final var _resultValue = new VisualsInsightVisual();
            _resultValue.actions = actions;
            _resultValue.dataSetIdentifier = dataSetIdentifier;
            _resultValue.insightConfiguration = insightConfiguration;
