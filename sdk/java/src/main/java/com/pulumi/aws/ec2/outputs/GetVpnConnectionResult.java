...
import com.pulumi.aws.ec2.outputs.GetVpnConnectionFilter;
import com.pulumi.aws.ec2.outputs.GetVpnConnectionRoute;
import com.pulumi.aws.ec2.outputs.GetVpnConnectionVgwTelemetry;
...
public final class GetVpnConnectionResult {
    ...
    public static final class Builder {
        ...
        public Builder category(String category) {
            if (category == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "category");
            }
        ...
        public Builder coreNetworkArn(String coreNetworkArn) {
            if (coreNetworkArn == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "coreNetworkArn");
            }
        ...
        public Builder coreNetworkAttachmentArn(String coreNetworkAttachmentArn) {
            if (coreNetworkAttachmentArn == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "coreNetworkAttachmentArn");
            }
        ...
        public Builder customerGatewayConfiguration(String customerGatewayConfiguration) {
            if (customerGatewayConfiguration == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "customerGatewayConfiguration");
            }
        ...
        public Builder gatewayAssociationState(String gatewayAssociationState) {
            if (gatewayAssociationState == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "gatewayAssociationState");
            }
        ...
        public Builder preSharedKeyArn(String preSharedKeyArn) {
            if (preSharedKeyArn == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "preSharedKeyArn");
            }
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "region");
            }
            this.region = region;
            return this;
        }
        ...
        public Builder routes(List<GetVpnConnectionRoute> routes) {
            if (routes == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "routes");
            }
            this.routes = routes;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder transitGatewayId(String transitGatewayId) {
            if (transitGatewayId == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "transitGatewayId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder vgwTelemetries(List<GetVpnConnectionVgwTelemetry> vgwTelemetries) {
            if (vgwTelemetries == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionResult", "vgwTelemetries");
            }
