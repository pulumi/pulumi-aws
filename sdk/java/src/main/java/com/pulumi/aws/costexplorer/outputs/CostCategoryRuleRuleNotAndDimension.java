...
public final class CostCategoryRuleRuleNotAndDimension {
    ...
    private CostCategoryRuleRuleNotAndDimension() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleNotAndDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleNotAndDimension defaults) {
        ...
        public CostCategoryRuleRuleNotAndDimension build() {
            final var _resultValue = new CostCategoryRuleRuleNotAndDimension();
