    ...
    public static final class Builder {
        ...
        public InstanceSecondaryNetworkInterfaceArgs build() {
            if ($.networkCardIndex == null) {
                throw new MissingRequiredPropertyException("InstanceSecondaryNetworkInterfaceArgs", "networkCardIndex");
            }
            if ($.secondarySubnetId == null) {
                throw new MissingRequiredPropertyException("InstanceSecondaryNetworkInterfaceArgs", "secondarySubnetId");
            }
            return $;
        }
    }
