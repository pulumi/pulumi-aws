...
public final class UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs extends com.pulumi.resources.ResourceArgs {

    public static final UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs Empty = new UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs();
    ...
    private UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs() {}

    private UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs(UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs $) {
    ...
    public static Builder builder(UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs();
        }

        public Builder(UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs defaults) {
            $ = new UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs(Objects.requireNonNull(defaults));
        }
        ...
        public UserProfileUserSettingsKernelGatewayAppSettingsDefaultResourceSpecArgs build() {
            return $;
        }
    }
