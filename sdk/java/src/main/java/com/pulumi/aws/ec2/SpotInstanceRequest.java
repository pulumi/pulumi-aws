...
public class SpotInstanceRequest extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ SpotInstanceRequestCapacityReservationSpecification> capacityReservationSpecification;
     ...
     * 
     */
    public Output<Optional<SpotInstanceRequestCapacityReservationSpecification>> capacityReservationSpecification() {
    ...
    private Output</* @Nullable */ SpotInstanceRequestCpuOptions> cpuOptions;

    /**
     * @return The CPU options for the instance. See CPU Options below for more details.
     * 
     */
    public Output<Optional<SpotInstanceRequestCpuOptions>> cpuOptions() {
    ...
    private Output</* @Nullable */ List<SpotInstanceRequestEbsBlockDevice>> ebsBlockDevices;
     ...
     * 
     */
    public Output<Optional<List<SpotInstanceRequestEbsBlockDevice>>> ebsBlockDevices() {
    ...
    private Output</* @Nullable */ SpotInstanceRequestEnclaveOptions> enclaveOptions;

    /**
     * @return Enable Nitro Enclaves on launched instances. See Enclave Options below for more details.
     * 
     */
    public Output<Optional<SpotInstanceRequestEnclaveOptions>> enclaveOptions() {
    ...
    private Output</* @Nullable */ List<SpotInstanceRequestEphemeralBlockDevice>> ephemeralBlockDevices;
     ...
     * 
     */
    public Output<Optional<List<SpotInstanceRequestEphemeralBlockDevice>>> ephemeralBlockDevices() {
    ...
    private Output</* @Nullable */ SpotInstanceRequestMaintenanceOptions> maintenanceOptions;

    /**
     * @return Maintenance and recovery options for the instance. See Maintenance Options below for more details.
     * 
     */
    public Output<Optional<SpotInstanceRequestMaintenanceOptions>> maintenanceOptions() {
    ...
    private Output</* @Nullable */ SpotInstanceRequestMetadataOptions> metadataOptions;

    /**
     * @return Customize the metadata options of the instance. See Metadata Options below for more details.
     * 
     */
    public Output<Optional<SpotInstanceRequestMetadataOptions>> metadataOptions() {
    ...
    private Output</* @Nullable */ List<SpotInstanceRequestNetworkInterface>> networkInterfaces;

    /**
     * @return Customize network interfaces to be attached at instance boot time. See Network Interfaces below for more details.
     * 
     */
    public Output<Optional<List<SpotInstanceRequestNetworkInterface>>> networkInterfaces() {
    ...
    private Output</* @Nullable */ SpotInstanceRequestPrivateDnsNameOptions> privateDnsNameOptions;
     ...
     * 
     */
    public Output<Optional<SpotInstanceRequestPrivateDnsNameOptions>> privateDnsNameOptions() {
    ...
    private Output</* @Nullable */ SpotInstanceRequestRootBlockDevice> rootBlockDevice;
     ...
     * 
     */
    public Output<Optional<SpotInstanceRequestRootBlockDevice>> rootBlockDevice() {
    ...
    private Output</* @Nullable */ String> spotBidStatus;
     ...
     * 
     */
    public Output<Optional<String>> spotBidStatus() {
        return Codegen.optional(this.spotBidStatus);
    }
    /**
    ...
    private Output</* @Nullable */ String> spotInstanceId;
     ...
     * 
     */
    public Output<Optional<String>> spotInstanceId() {
        return Codegen.optional(this.spotInstanceId);
    }
    /**
