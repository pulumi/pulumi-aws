...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern;
...
public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader {
    ...
    public static Builder builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader defaults) {
    ...
    public static final class Builder {
        ...
        private String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern matchPattern) {
            if (matchPattern == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader", "matchPattern");
            }
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader", "matchScope");
            }
        ...
        public Builder oversizeHandling(String oversizeHandling) {
            if (oversizeHandling == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader", "oversizeHandling");
            }
            this.oversizeHandling = oversizeHandling;
            return this;
        }
        public RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader build() {
            final var _resultValue = new RuleGroupRuleStatementByteMatchStatementFieldToMatchHeader();
