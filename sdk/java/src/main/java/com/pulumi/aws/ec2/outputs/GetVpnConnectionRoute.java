    ...
    public static final class Builder {
        ...
        public Builder destinationCidrBlock(String destinationCidrBlock) {
            if (destinationCidrBlock == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionRoute", "destinationCidrBlock");
            }
        ...
        public Builder source(String source) {
            if (source == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionRoute", "source");
            }
            this.source = source;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetVpnConnectionRoute", "state");
            }
            this.state = state;
            return this;
        }
        public GetVpnConnectionRoute build() {
            final var _resultValue = new GetVpnConnectionRoute();
