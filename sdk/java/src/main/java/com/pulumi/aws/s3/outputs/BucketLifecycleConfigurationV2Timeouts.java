...
@CustomType
public final class BucketLifecycleConfigurationV2Timeouts {
    /**
    ...
    public static Builder builder(BucketLifecycleConfigurationV2Timeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(BucketLifecycleConfigurationV2Timeouts defaults) {
        ...
        public BucketLifecycleConfigurationV2Timeouts build() {
            final var _resultValue = new BucketLifecycleConfigurationV2Timeouts();
