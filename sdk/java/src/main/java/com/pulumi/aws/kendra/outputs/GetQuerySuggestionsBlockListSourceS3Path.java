...
public final class GetQuerySuggestionsBlockListSourceS3Path {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("GetQuerySuggestionsBlockListSourceS3Path", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetQuerySuggestionsBlockListSourceS3Path", "key");
            }
            this.key = key;
            return this;
        }
