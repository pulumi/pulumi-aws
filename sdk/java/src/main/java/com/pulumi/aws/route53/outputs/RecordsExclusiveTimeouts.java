...
@CustomType
public final class RecordsExclusiveTimeouts {
    /**
    ...
    public static Builder builder(RecordsExclusiveTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(RecordsExclusiveTimeouts defaults) {
        ...
        public RecordsExclusiveTimeouts build() {
            final var _resultValue = new RecordsExclusiveTimeouts();
