...
@CustomType
public final class CostCategoryRuleRuleAndOrDimension {
    /**
    ...
    private CostCategoryRuleRuleAndOrDimension() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleAndOrDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleAndOrDimension defaults) {
        ...
        public CostCategoryRuleRuleAndOrDimension build() {
            final var _resultValue = new CostCategoryRuleRuleAndOrDimension();
