...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternAll;
...
public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern {
     ...
     * 
     */
    private @Nullable RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternAll all;
    /**
    ...
    private RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern() {}
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    public Optional<RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternAll> all() {
    ...
    public static Builder builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder all(@Nullable RuleGroupRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternAll all) {
            this.all = all;
            return this;
        }
        @CustomType.Setter
