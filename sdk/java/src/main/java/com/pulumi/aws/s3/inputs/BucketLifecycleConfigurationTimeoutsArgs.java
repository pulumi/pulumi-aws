...
public final class BucketLifecycleConfigurationTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BucketLifecycleConfigurationTimeoutsArgs Empty = new BucketLifecycleConfigurationTimeoutsArgs();
    ...
    private BucketLifecycleConfigurationTimeoutsArgs() {}

    private BucketLifecycleConfigurationTimeoutsArgs(BucketLifecycleConfigurationTimeoutsArgs $) {
        this.create = $.create;
        this.update = $.update;
    }
    ...
    public static Builder builder(BucketLifecycleConfigurationTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BucketLifecycleConfigurationTimeoutsArgs();
        }

        public Builder(BucketLifecycleConfigurationTimeoutsArgs defaults) {
            $ = new BucketLifecycleConfigurationTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BucketLifecycleConfigurationTimeoutsArgs build() {
            return $;
        }
    }
