...
public final class PoolTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PoolTimeoutsArgs Empty = new PoolTimeoutsArgs();
    ...
    private PoolTimeoutsArgs() {}

    private PoolTimeoutsArgs(PoolTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(PoolTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PoolTimeoutsArgs();
        }

        public Builder(PoolTimeoutsArgs defaults) {
            $ = new PoolTimeoutsArgs(Objects.requireNonNull(defaults));
        }
