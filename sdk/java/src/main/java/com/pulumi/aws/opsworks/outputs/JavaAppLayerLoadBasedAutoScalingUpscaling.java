...
public final class JavaAppLayerLoadBasedAutoScalingUpscaling {
    ...
    public static Builder builder(JavaAppLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(JavaAppLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public JavaAppLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new JavaAppLayerLoadBasedAutoScalingUpscaling();
