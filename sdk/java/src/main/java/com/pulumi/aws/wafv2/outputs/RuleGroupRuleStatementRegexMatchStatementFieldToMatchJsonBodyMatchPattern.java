...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternAll;
...
public final class RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern {
    ...
    public static Builder builder(RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedPaths;
        public Builder() {}
        public Builder(RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern defaults) {
        ...
        @CustomType.Setter
        public Builder all(@Nullable RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternAll all) {
            this.all = all;
            return this;
        }
        @CustomType.Setter
