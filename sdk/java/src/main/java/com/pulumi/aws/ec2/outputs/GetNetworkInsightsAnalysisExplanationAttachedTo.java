...
public final class GetNetworkInsightsAnalysisExplanationAttachedTo {
    ...
    public static final class Builder {
        ...
        public Builder arn(String arn) {
            if (arn == null) {
              throw new MissingRequiredPropertyException("GetNetworkInsightsAnalysisExplanationAttachedTo", "arn");
            }
            this.arn = arn;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetNetworkInsightsAnalysisExplanationAttachedTo", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetNetworkInsightsAnalysisExplanationAttachedTo", "name");
            }
            this.name = name;
            return this;
        }
        public GetNetworkInsightsAnalysisExplanationAttachedTo build() {
            final var _resultValue = new GetNetworkInsightsAnalysisExplanationAttachedTo();
