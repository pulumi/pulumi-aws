...
public final class CostCategoryRuleRuleOrTagsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private CostCategoryRuleRuleOrTagsArgs(CostCategoryRuleRuleOrTagsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(CostCategoryRuleRuleOrTagsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CostCategoryRuleRuleOrTagsArgs();
        }

        public Builder(CostCategoryRuleRuleOrTagsArgs defaults) {
            $ = new CostCategoryRuleRuleOrTagsArgs(Objects.requireNonNull(defaults));
        }
