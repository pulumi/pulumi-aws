...
public final class UserProfileTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final UserProfileTimeoutsArgs Empty = new UserProfileTimeoutsArgs();
    ...
    private UserProfileTimeoutsArgs() {}

    private UserProfileTimeoutsArgs(UserProfileTimeoutsArgs $) {
        this.create = $.create;
        this.update = $.update;
    }
    ...
    public static Builder builder(UserProfileTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UserProfileTimeoutsArgs();
        }

        public Builder(UserProfileTimeoutsArgs defaults) {
            $ = new UserProfileTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public UserProfileTimeoutsArgs build() {
            return $;
        }
    }
