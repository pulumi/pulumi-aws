...
public final class CostCategoryRuleRuleNotOrDimension {
    ...
    private CostCategoryRuleRuleNotOrDimension() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleNotOrDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleNotOrDimension defaults) {
        ...
        public CostCategoryRuleRuleNotOrDimension build() {
            final var _resultValue = new CostCategoryRuleRuleNotOrDimension();
