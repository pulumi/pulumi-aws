...
public final class RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation {
    ...
    public static final class Builder {
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation", "priority");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRateBasedStatementCustomKeyHeaderTextTransformation", "type");
            }
            this.type = type;
            return this;
        }
