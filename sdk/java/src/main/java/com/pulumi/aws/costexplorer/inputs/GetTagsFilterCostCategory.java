...
public final class GetTagsFilterCostCategory extends com.pulumi.resources.InvokeArgs {
    ...
    private GetTagsFilterCostCategory(GetTagsFilterCostCategory $) {
        this.key = $.key;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagsFilterCostCategory();
        }

        public Builder(GetTagsFilterCostCategory defaults) {
            $ = new GetTagsFilterCostCategory(Objects.requireNonNull(defaults));
        }
