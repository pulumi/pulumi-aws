...
public class WorkspaceServiceAccount extends com.pulumi.resources.CustomResource {
     ...
     */
    public WorkspaceServiceAccount(String name) {
     ...
     */
    public static WorkspaceServiceAccount get(String name, Output<String> id, @Nullable WorkspaceServiceAccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
