...
public class Role extends com.pulumi.resources.CustomResource {
     ...
     * 
     * @deprecated
     * Use the aws.iam.RolePolicy resource instead. If Terraform should exclusively manage all inline policy associations (the current behavior of this argument), use the aws.iam.RolePoliciesExclusive resource as well.
     * 
     */
