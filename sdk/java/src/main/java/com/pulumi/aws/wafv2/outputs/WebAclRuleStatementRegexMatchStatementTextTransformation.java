...
public final class WebAclRuleStatementRegexMatchStatementTextTransformation {
    ...
    private WebAclRuleStatementRegexMatchStatementTextTransformation() {}
    /**
     * @return Relative processing order for multiple transformations that are defined for a rule statement. AWS WAF processes all transformations, from lowest priority to highest, before inspecting the transformed content.
     * 
     */
    ...
    public static Builder builder(WebAclRuleStatementRegexMatchStatementTextTransformation defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(WebAclRuleStatementRegexMatchStatementTextTransformation defaults) {
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementRegexMatchStatementTextTransformation", "priority");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementRegexMatchStatementTextTransformation", "type");
            }
            this.type = type;
            return this;
        }
