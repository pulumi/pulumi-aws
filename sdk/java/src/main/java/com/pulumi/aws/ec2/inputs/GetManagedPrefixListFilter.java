...
public final class GetManagedPrefixListFilter extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetManagedPrefixListFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetManagedPrefixListFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetManagedPrefixListFilter", "values");
            }
            return $;
        }
    }
