...
public final class BudgetFilterExpressionAndOrDimensionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionAndOrDimensionsArgs Empty = new BudgetFilterExpressionAndOrDimensionsArgs();
    ...
    private BudgetFilterExpressionAndOrDimensionsArgs() {}

    private BudgetFilterExpressionAndOrDimensionsArgs(BudgetFilterExpressionAndOrDimensionsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionAndOrDimensionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionAndOrDimensionsArgs();
        }

        public Builder(BudgetFilterExpressionAndOrDimensionsArgs defaults) {
            $ = new BudgetFilterExpressionAndOrDimensionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionAndOrDimensionsArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionAndOrDimensionsArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionAndOrDimensionsArgs", "values");
            }
            return $;
        }
    }
