...
public final class PhpAppLayerLoadBasedAutoScalingDownscaling {
    ...
    public static Builder builder(PhpAppLayerLoadBasedAutoScalingDownscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(PhpAppLayerLoadBasedAutoScalingDownscaling defaults) {
        ...
        public PhpAppLayerLoadBasedAutoScalingDownscaling build() {
            final var _resultValue = new PhpAppLayerLoadBasedAutoScalingDownscaling();
