...
import com.pulumi.aws.quicksight.inputs.VisualsRadarChartVisualChartConfigurationArgs;
...
public final class VisualsRadarChartVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsRadarChartVisualArgs Empty = new VisualsRadarChartVisualArgs();
    ...
    private @Nullable Output<VisualsRadarChartVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsRadarChartVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsRadarChartVisualArgs(VisualsRadarChartVisualArgs $) {
    ...
    public static Builder builder(VisualsRadarChartVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsRadarChartVisualArgs();
        }

        public Builder(VisualsRadarChartVisualArgs defaults) {
            $ = new VisualsRadarChartVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsRadarChartVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsRadarChartVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsRadarChartVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsRadarChartVisualArgs", "visualId");
            }
            return $;
        }
    }
