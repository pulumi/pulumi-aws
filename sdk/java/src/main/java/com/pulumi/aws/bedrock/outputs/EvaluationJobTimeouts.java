...
@CustomType
public final class EvaluationJobTimeouts {
    /**
    ...
    public static Builder builder(EvaluationJobTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(EvaluationJobTimeouts defaults) {
        ...
        public EvaluationJobTimeouts build() {
            final var _resultValue = new EvaluationJobTimeouts();
