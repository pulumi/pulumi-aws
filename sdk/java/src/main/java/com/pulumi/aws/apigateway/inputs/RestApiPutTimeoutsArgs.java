...
public final class RestApiPutTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RestApiPutTimeoutsArgs Empty = new RestApiPutTimeoutsArgs();
    ...
    private RestApiPutTimeoutsArgs() {}

    private RestApiPutTimeoutsArgs(RestApiPutTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(RestApiPutTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RestApiPutTimeoutsArgs();
        }

        public Builder(RestApiPutTimeoutsArgs defaults) {
            $ = new RestApiPutTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RestApiPutTimeoutsArgs build() {
            return $;
        }
    }
