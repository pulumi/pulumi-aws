...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternAll;
...
@CustomType
public final class RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern {
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    private @Nullable RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternAll all;
    /**
    ...
    private RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern() {}
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    public Optional<RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternAll> all() {
    ...
    public static Builder builder(RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedHeaders;
        public Builder() {}
        public Builder(RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern defaults) {
        ...
        public RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern build() {
            final var _resultValue = new RuleGroupRuleStatementXssMatchStatementFieldToMatchHeaderMatchPattern();
