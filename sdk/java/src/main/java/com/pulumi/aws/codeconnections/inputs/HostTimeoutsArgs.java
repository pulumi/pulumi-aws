...
public final class HostTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final HostTimeoutsArgs Empty = new HostTimeoutsArgs();
    ...
    private HostTimeoutsArgs() {}

    private HostTimeoutsArgs(HostTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(HostTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostTimeoutsArgs();
        }

        public Builder(HostTimeoutsArgs defaults) {
            $ = new HostTimeoutsArgs(Objects.requireNonNull(defaults));
        }
