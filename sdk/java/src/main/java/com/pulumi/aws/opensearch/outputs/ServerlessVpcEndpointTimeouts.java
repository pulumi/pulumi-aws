...
public final class ServerlessVpcEndpointTimeouts {
    ...
    public static Builder builder(ServerlessVpcEndpointTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ServerlessVpcEndpointTimeouts defaults) {
        ...
        public ServerlessVpcEndpointTimeouts build() {
            final var _resultValue = new ServerlessVpcEndpointTimeouts();
