...
public final class WebUserAccessLoggingSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebUserAccessLoggingSettingsArgs Empty = new WebUserAccessLoggingSettingsArgs();
    ...
    private WebUserAccessLoggingSettingsArgs() {}

    private WebUserAccessLoggingSettingsArgs(WebUserAccessLoggingSettingsArgs $) {
    ...
    public static Builder builder(WebUserAccessLoggingSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebUserAccessLoggingSettingsArgs();
        }

        public Builder(WebUserAccessLoggingSettingsArgs defaults) {
            $ = new WebUserAccessLoggingSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebUserAccessLoggingSettingsArgs build() {
            if ($.kinesisStreamArn == null) {
                throw new MissingRequiredPropertyException("WebUserAccessLoggingSettingsArgs", "kinesisStreamArn");
            }
            return $;
        }
    }
