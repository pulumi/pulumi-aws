...
public final class WebAclRuleMatchPattern {
    ...
    private WebAclRuleMatchPattern() {}
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    ...
    public static Builder builder(WebAclRuleMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedPaths;
        public Builder() {}
        public Builder(WebAclRuleMatchPattern defaults) {
        ...
        public WebAclRuleMatchPattern build() {
            final var _resultValue = new WebAclRuleMatchPattern();
