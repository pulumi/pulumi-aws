...
@CustomType
public final class GetCostCategoryRuleRuleOrNotTag {
    /**
    ...
    private GetCostCategoryRuleRuleOrNotTag() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(GetCostCategoryRuleRuleOrNotTag defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(GetCostCategoryRuleRuleOrNotTag defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleOrNotTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder matchOptions(List<String> matchOptions) {
            if (matchOptions == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleOrNotTag", "matchOptions");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleOrNotTag", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetCostCategoryRuleRuleOrNotTag build() {
            final var _resultValue = new GetCostCategoryRuleRuleOrNotTag();
