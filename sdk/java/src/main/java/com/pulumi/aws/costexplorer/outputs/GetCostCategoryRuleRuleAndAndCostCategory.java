...
public final class GetCostCategoryRuleRuleAndAndCostCategory {
    ...
    private GetCostCategoryRuleRuleAndAndCostCategory() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(GetCostCategoryRuleRuleAndAndCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(GetCostCategoryRuleRuleAndAndCostCategory defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndAndCostCategory", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder matchOptions(List<String> matchOptions) {
            if (matchOptions == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndAndCostCategory", "matchOptions");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndAndCostCategory", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetCostCategoryRuleRuleAndAndCostCategory build() {
            final var _resultValue = new GetCostCategoryRuleRuleAndAndCostCategory();
