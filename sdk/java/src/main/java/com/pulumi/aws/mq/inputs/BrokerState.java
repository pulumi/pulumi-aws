...
public final class BrokerState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param authenticationStrategy Authentication strategy used to secure the broker. Valid values are `simple` and `ldap`. `ldap` is not supported for `engineType` `RabbitMQ`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param dataReplicationPrimaryBrokerArn ARN of the primary broker used to replicate data in a data replication pair. Required when `dataReplicationMode` is `CRDR`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param pendingDataReplicationMode Data replication mode that will be applied after reboot.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param storageType Storage type of the broker. For `engineType` `ActiveMQ`, valid values are `efs` and `ebs` (AWS-default is `efs`). For `engineType` `RabbitMQ`, only `ebs` is supported. When using `ebs`, only the `mq.m5` broker instance type family is supported.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param tags Map of tags to assign to the broker. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
         * 
         * @return builder
         * 
         */
