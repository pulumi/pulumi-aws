...
public final class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;

    /**
     * @return JSON content to inspect. See JSON Body Match Pattern below.
     * 
     */
    public Optional<Output<WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPatternArgs>> matchPattern() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder matchPattern(@Nullable Output<WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
