...
public final class CostCategoryRuleRuleOrOrTags {
    ...
    public static Builder builder(CostCategoryRuleRuleOrOrTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleOrOrTags defaults) {
        ...
        public CostCategoryRuleRuleOrOrTags build() {
            final var _resultValue = new CostCategoryRuleRuleOrOrTags();
