...
import com.pulumi.aws.quicksight.outputs.VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptionsFieldLevelOption;
...
@CustomType
public final class VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptions {
    private @Nullable String customLabel;
    private @Nullable String fieldLevel;
    private @Nullable List<VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptionsFieldLevelOption> fieldLevelOptions;
    ...
    private VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptions() {}
    ...
    public List<VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptionsFieldLevelOption> fieldLevelOptions() {
    ...
    public static Builder builder(VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable CellStyle valueCellStyle;
        public Builder() {}
        public Builder(VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptions defaults) {
        ...
        @CustomType.Setter
        public Builder fieldLevelOptions(@Nullable List<VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptionsFieldLevelOption> fieldLevelOptions) {

            this.fieldLevelOptions = fieldLevelOptions;
            return this;
        }
        public Builder fieldLevelOptions(VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptionsFieldLevelOption... fieldLevelOptions) {
        ...
        public VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptions build() {
            final var _resultValue = new VisualsPivotTableVisualChartConfigurationTotalOptionsColumnSubtotalOptions();
