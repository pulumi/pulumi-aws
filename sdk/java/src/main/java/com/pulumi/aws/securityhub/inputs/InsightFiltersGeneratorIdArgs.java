...
public final class InsightFiltersGeneratorIdArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersGeneratorIdArgs(InsightFiltersGeneratorIdArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersGeneratorIdArgs();
        }

        public Builder(InsightFiltersGeneratorIdArgs defaults) {
            $ = new InsightFiltersGeneratorIdArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersGeneratorIdArgs build() {
            if ($.comparison == null) {
                throw new MissingRequiredPropertyException("InsightFiltersGeneratorIdArgs", "comparison");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("InsightFiltersGeneratorIdArgs", "value");
            }
            return $;
        }
    }
