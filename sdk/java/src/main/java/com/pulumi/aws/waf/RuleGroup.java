...
public class RuleGroup extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return Name of the rule group. If omitted, the provider will assign a random, unique name. Conflicts with `namePrefix`.
     * 
     */
    ...
    public RuleGroup(java.lang.String name, RuleGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:waf/ruleGroup:RuleGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RuleGroup(java.lang.String name, Output<java.lang.String> id, @Nullable RuleGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:waf/ruleGroup:RuleGroup", name, state, makeResourceOptions(options, id), false);
    }
