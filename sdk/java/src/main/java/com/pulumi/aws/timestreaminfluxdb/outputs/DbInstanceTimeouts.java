...
public final class DbInstanceTimeouts {
    ...
    public static Builder builder(DbInstanceTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(DbInstanceTimeouts defaults) {
        ...
        public DbInstanceTimeouts build() {
            final var _resultValue = new DbInstanceTimeouts();
