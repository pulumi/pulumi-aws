    ...
    public static final class Builder {
        ...
        public Builder certificateAuthorityArns(List<String> certificateAuthorityArns) {
            if (certificateAuthorityArns == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustAcm", "certificateAuthorityArns");
            }
        ...
        public VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustAcm build() {
            final var _resultValue = new VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustAcm();
