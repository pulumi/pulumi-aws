...
public final class SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps {
    ...
    public static Builder builder(SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double min;
        public Builder() {}
        public Builder(SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsNetworkBandwidthGbps defaults) {
