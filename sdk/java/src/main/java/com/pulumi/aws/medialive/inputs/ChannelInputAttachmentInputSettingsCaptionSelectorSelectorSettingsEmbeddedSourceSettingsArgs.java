...
public final class ChannelInputAttachmentInputSettingsCaptionSelectorSelectorSettingsEmbeddedSourceSettingsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="source608TrackNumber")
    private @Nullable Output<Integer> source608TrackNumber;

    public Optional<Output<Integer>> source608TrackNumber() {
    ...
    public static final class Builder {
        ...
        public Builder source608TrackNumber(@Nullable Output<Integer> source608TrackNumber) {
            $.source608TrackNumber = source608TrackNumber;
            return this;
        }

        public Builder source608TrackNumber(Integer source608TrackNumber) {
            return source608TrackNumber(Output.of(source608TrackNumber));
        }
