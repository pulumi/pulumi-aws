...
public final class BucketWebsite {
     ...
     * 
     */
    private @Nullable Either<String,List<BucketWebsiteConfigurationV2RoutingRule>> routingRules;
     ...
     * 
     */
    public Optional<Either<String,List<BucketWebsiteConfigurationV2RoutingRule>>> routingRules() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder routingRules(@Nullable Either<String,List<BucketWebsiteConfigurationV2RoutingRule>> routingRules) {
