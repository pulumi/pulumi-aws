...
public final class LogS3TableIntegrationSourceTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final LogS3TableIntegrationSourceTimeoutsArgs Empty = new LogS3TableIntegrationSourceTimeoutsArgs();
    ...
    private LogS3TableIntegrationSourceTimeoutsArgs() {}

    private LogS3TableIntegrationSourceTimeoutsArgs(LogS3TableIntegrationSourceTimeoutsArgs $) {
        this.delete = $.delete;
    }
    ...
    public static Builder builder(LogS3TableIntegrationSourceTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogS3TableIntegrationSourceTimeoutsArgs();
        }

        public Builder(LogS3TableIntegrationSourceTimeoutsArgs defaults) {
            $ = new LogS3TableIntegrationSourceTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LogS3TableIntegrationSourceTimeoutsArgs build() {
            return $;
        }
    }
