...
@CustomType
public final class NetworkInsightsAnalysisForwardPathComponentAclRulePortRange {
    private @Nullable Integer from;
    private @Nullable Integer to;

    private NetworkInsightsAnalysisForwardPathComponentAclRulePortRange() {}
    ...
    public static Builder builder(NetworkInsightsAnalysisForwardPathComponentAclRulePortRange defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer to;
        public Builder() {}
        public Builder(NetworkInsightsAnalysisForwardPathComponentAclRulePortRange defaults) {
