...
public final class RuleGroupRuleStatementRateBasedStatementScopeDownStatement {
    ...
    /**
     * @return Rule statement that inspects web traffic based on the Autonomous System Number (ASN) associated with the request&#39;s IP address. See ASN Match Statement below for details.
     * 
     */
