...
public final class AnomalySubscriptionThresholdExpressionOrCostCategoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnomalySubscriptionThresholdExpressionOrCostCategoryArgs Empty = new AnomalySubscriptionThresholdExpressionOrCostCategoryArgs();
    ...
    private AnomalySubscriptionThresholdExpressionOrCostCategoryArgs() {}

    private AnomalySubscriptionThresholdExpressionOrCostCategoryArgs(AnomalySubscriptionThresholdExpressionOrCostCategoryArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionOrCostCategoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalySubscriptionThresholdExpressionOrCostCategoryArgs();
        }

        public Builder(AnomalySubscriptionThresholdExpressionOrCostCategoryArgs defaults) {
            $ = new AnomalySubscriptionThresholdExpressionOrCostCategoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnomalySubscriptionThresholdExpressionOrCostCategoryArgs build() {
            return $;
        }
    }
