...
public final class OntapVolumeSnaplockConfigurationAutocommitPeriod {
    ...
    public static Builder builder(OntapVolumeSnaplockConfigurationAutocommitPeriod defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer value;
        public Builder() {}
        public Builder(OntapVolumeSnaplockConfigurationAutocommitPeriod defaults) {
