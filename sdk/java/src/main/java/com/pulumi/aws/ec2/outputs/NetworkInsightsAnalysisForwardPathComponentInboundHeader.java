...
public final class NetworkInsightsAnalysisForwardPathComponentInboundHeader {
    ...
    private @Nullable List<NetworkInsightsAnalysisForwardPathComponentInboundHeaderDestinationPortRange> destinationPortRanges;
    private @Nullable String protocol;
    private @Nullable List<String> sourceAddresses;
    private @Nullable List<NetworkInsightsAnalysisForwardPathComponentInboundHeaderSourcePortRange> sourcePortRanges;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder destinationPortRanges(@Nullable List<NetworkInsightsAnalysisForwardPathComponentInboundHeaderDestinationPortRange> destinationPortRanges) {
        ...
        @CustomType.Setter
        public Builder sourcePortRanges(@Nullable List<NetworkInsightsAnalysisForwardPathComponentInboundHeaderSourcePortRange> sourcePortRanges) {
