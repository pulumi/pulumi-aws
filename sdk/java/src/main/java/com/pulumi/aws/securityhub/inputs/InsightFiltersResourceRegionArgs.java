...
public final class InsightFiltersResourceRegionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public InsightFiltersResourceRegionArgs build() {
            if ($.comparison == null) {
                throw new MissingRequiredPropertyException("InsightFiltersResourceRegionArgs", "comparison");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("InsightFiltersResourceRegionArgs", "value");
            }
            return $;
        }
    }
