...
public final class ClusterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Name of the cache engine to be used for this cache cluster. Valid values are `memcached`, `redis`.
     * 
     */
    ...
    /**
     * @return The IP versions for cache cluster connections. IPv6 is supported with Redis engine `6.2` onword or Memcached version `1.6.6` for all [Nitro system](https://aws.amazon.com/ec2/nitro/) instances. Valid values are `ipv4`, `ipv6` or `dualStack`.
     * 
     */
    ...
    /**
     * @return Single-element string list containing an ARN of a Redis RDB snapshot file stored in Amazon S3. The object name cannot contain any commas. Changing `snapshotArns` forces a new resource.
     * 
     */
    ...
    /**
     * @return Name of a snapshot from which to restore data into the new node group. Changing `snapshotName` forces a new resource.
     * 
     */
    ...
    /**
     * @return Enable encryption in-transit. Supported only with Memcached versions `1.6.12` and later, running in a VPC. For Redis or Valkey transit encryption, use `aws.elasticache.ReplicationGroup` instead. See the [ElastiCache in-transit encryption documentation](https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/in-transit-encryption.html#in-transit-encryption-constraints) for more details.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param availabilityZone Availability Zone for the cache cluster. If you want to create cache nodes in multi-az, use `preferredAvailabilityZones` instead. Default: System chosen Availability Zone. Changing this value will re-create the resource.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param engine Name of the cache engine to be used for this cache cluster. Valid values are `memcached`, `redis`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param networkType The IP versions for cache cluster connections. IPv6 is supported with Redis engine `6.2` onword or Memcached version `1.6.6` for all [Nitro system](https://aws.amazon.com/ec2/nitro/) instances. Valid values are `ipv4`, `ipv6` or `dualStack`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param port The port number on which each of the cache nodes will accept connections. For Memcached the default is 11211, and for Redis the default port is 6379. Cannot be provided with `replicationGroupId`. Changing this value will re-create the resource.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param snapshotArns Single-element string list containing an ARN of a Redis RDB snapshot file stored in Amazon S3. The object name cannot contain any commas. Changing `snapshotArns` forces a new resource.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param snapshotName Name of a snapshot from which to restore data into the new node group. Changing `snapshotName` forces a new resource.
         * 
         * @return builder
         * 
         */
