...
public final class CostCategoryRuleRuleNotNotTags {
    ...
    public static Builder builder(CostCategoryRuleRuleNotNotTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleNotNotTags defaults) {
        ...
        public CostCategoryRuleRuleNotNotTags build() {
            final var _resultValue = new CostCategoryRuleRuleNotNotTags();
