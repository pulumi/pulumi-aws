...
public final class BudgetFilterExpressionTagsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionTagsArgs Empty = new BudgetFilterExpressionTagsArgs();
    ...
    private BudgetFilterExpressionTagsArgs() {}

    private BudgetFilterExpressionTagsArgs(BudgetFilterExpressionTagsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionTagsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionTagsArgs();
        }

        public Builder(BudgetFilterExpressionTagsArgs defaults) {
            $ = new BudgetFilterExpressionTagsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionTagsArgs build() {
            return $;
        }
    }
