...
public class IdentityNotificationTopic extends com.pulumi.resources.CustomResource {
    ...
    private IdentityNotificationTopic(java.lang.String name, Output<java.lang.String> id, @Nullable IdentityNotificationTopicState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static IdentityNotificationTopic get(java.lang.String name, Output<java.lang.String> id, @Nullable IdentityNotificationTopicState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
