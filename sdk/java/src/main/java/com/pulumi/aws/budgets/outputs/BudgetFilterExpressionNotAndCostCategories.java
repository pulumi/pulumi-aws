...
@CustomType
public final class BudgetFilterExpressionNotAndCostCategories {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionNotAndCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotAndCostCategories defaults) {
        ...
        public BudgetFilterExpressionNotAndCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionNotAndCostCategories();
