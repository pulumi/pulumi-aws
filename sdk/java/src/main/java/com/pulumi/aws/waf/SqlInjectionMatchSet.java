...
public class SqlInjectionMatchSet extends com.pulumi.resources.CustomResource {
    ...
    public SqlInjectionMatchSet(java.lang.String name, @Nullable SqlInjectionMatchSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:waf/sqlInjectionMatchSet:SqlInjectionMatchSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private SqlInjectionMatchSet(java.lang.String name, Output<java.lang.String> id, @Nullable SqlInjectionMatchSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:waf/sqlInjectionMatchSet:SqlInjectionMatchSet", name, state, makeResourceOptions(options, id), false);
    }
