...
public final class FleetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the `disconnectTimeoutInSeconds` time interval begins. Defaults to `0`. Valid value is between `60` and ` 3600  `seconds.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param idleDisconnectTimeoutInSeconds Amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the `disconnectTimeoutInSeconds` time interval begins. Defaults to `0`. Valid value is between `60` and ` 3600  `seconds.
         * 
         * @return builder
         * 
         */
