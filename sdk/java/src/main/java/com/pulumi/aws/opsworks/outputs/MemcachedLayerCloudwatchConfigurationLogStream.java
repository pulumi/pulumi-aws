...
public final class MemcachedLayerCloudwatchConfigurationLogStream {
    ...
    public static final class Builder {
        ...
        public Builder file(String file) {
            if (file == null) {
              throw new MissingRequiredPropertyException("MemcachedLayerCloudwatchConfigurationLogStream", "file");
            }
            this.file = file;
            return this;
        }
        ...
        public Builder logGroupName(String logGroupName) {
            if (logGroupName == null) {
              throw new MissingRequiredPropertyException("MemcachedLayerCloudwatchConfigurationLogStream", "logGroupName");
            }
        ...
        public MemcachedLayerCloudwatchConfigurationLogStream build() {
            final var _resultValue = new MemcachedLayerCloudwatchConfigurationLogStream();
