...
public final class FirehoseDeliveryStreamElasticsearchConfigurationS3Configuration {
    ...
    public static Builder builder(FirehoseDeliveryStreamElasticsearchConfigurationS3Configuration defaults) {
    ...
    public static final class Builder {
        ...
        private String roleArn;
        public Builder() {}
        public Builder(FirehoseDeliveryStreamElasticsearchConfigurationS3Configuration defaults) {
