...
public final class VirtualNodeSpecListenerOutlierDetectionInterval {
    ...
    public static final class Builder {
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecListenerOutlierDetectionInterval", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder value(Integer value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecListenerOutlierDetectionInterval", "value");
            }
            this.value = value;
            return this;
        }
        public VirtualNodeSpecListenerOutlierDetectionInterval build() {
            final var _resultValue = new VirtualNodeSpecListenerOutlierDetectionInterval();
