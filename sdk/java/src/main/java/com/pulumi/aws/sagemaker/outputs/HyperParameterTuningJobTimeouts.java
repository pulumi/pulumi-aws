...
@CustomType
public final class HyperParameterTuningJobTimeouts {
    /**
    ...
    public static Builder builder(HyperParameterTuningJobTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(HyperParameterTuningJobTimeouts defaults) {
        ...
        public HyperParameterTuningJobTimeouts build() {
            final var _resultValue = new HyperParameterTuningJobTimeouts();
