...
public final class ConfigurationSetEventDestinationEventDestinationCloudWatchDestination {
    /**
     * @return Array of objects that define the dimensions to use when you send email events to Amazon CloudWatch. See `dimensionConfiguration` Block for details.
     * 
     */
