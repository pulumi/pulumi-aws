...
@CustomType
public final class RegistryTimeouts {
    /**
    ...
    public static Builder builder(RegistryTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(RegistryTimeouts defaults) {
        ...
        public RegistryTimeouts build() {
            final var _resultValue = new RegistryTimeouts();
