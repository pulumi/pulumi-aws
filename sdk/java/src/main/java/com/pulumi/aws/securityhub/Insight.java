...
public class Insight extends com.pulumi.resources.CustomResource {
     ...
     */
    public Insight(java.lang.String name) {
     ...
     */
    public Insight(java.lang.String name, InsightArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Insight(java.lang.String name, InsightArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:securityhub/insight:Insight", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Insight(java.lang.String name, Output<java.lang.String> id, @Nullable InsightState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:securityhub/insight:Insight", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static Insight get(java.lang.String name, Output<java.lang.String> id, @Nullable InsightState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
