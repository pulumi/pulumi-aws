...
public final class DataCellsFilterTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final DataCellsFilterTimeoutsArgs Empty = new DataCellsFilterTimeoutsArgs();
    ...
    private DataCellsFilterTimeoutsArgs() {}

    private DataCellsFilterTimeoutsArgs(DataCellsFilterTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(DataCellsFilterTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataCellsFilterTimeoutsArgs();
        }

        public Builder(DataCellsFilterTimeoutsArgs defaults) {
            $ = new DataCellsFilterTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DataCellsFilterTimeoutsArgs build() {
            return $;
        }
    }
