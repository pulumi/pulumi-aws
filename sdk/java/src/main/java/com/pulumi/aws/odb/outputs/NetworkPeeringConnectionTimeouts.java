...
@CustomType
public final class NetworkPeeringConnectionTimeouts {
    /**
    ...
    public static Builder builder(NetworkPeeringConnectionTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(NetworkPeeringConnectionTimeouts defaults) {
        ...
        public NetworkPeeringConnectionTimeouts build() {
            final var _resultValue = new NetworkPeeringConnectionTimeouts();
