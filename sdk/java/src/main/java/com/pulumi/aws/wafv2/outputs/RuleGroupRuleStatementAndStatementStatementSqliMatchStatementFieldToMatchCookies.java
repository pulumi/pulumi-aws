...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatchCookiesMatchPattern;
...
public final class RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatchCookies {
    ...
    public static Builder builder(RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatchCookies defaults) {
    ...
    public static final class Builder {
        ...
        private String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatchCookies defaults) {
        ...
        @CustomType.Setter
        public Builder matchPatterns(List<RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns) {
            this.matchPatterns = Objects.requireNonNull(matchPatterns);
            return this;
        }
        public Builder matchPatterns(RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatchCookiesMatchPattern... matchPatterns) {
        ...
        public RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatchCookies build() {
            final var o = new RuleGroupRuleStatementAndStatementStatementSqliMatchStatementFieldToMatchCookies();
