...
public final class DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec {
    ...
    private DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec() {}
    /**
     * @return The instance type that the image version runs on.. For valid values see [SageMaker AI Instance Types](https://docs.aws.amazon.com/sagemaker/latest/dg/notebooks-available-instance-types.html).
     * 
     */
    ...
    public static Builder builder(DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sagemakerImageVersionArn;
        public Builder() {}
        public Builder(DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec defaults) {
        ...
        public DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec build() {
            final var _resultValue = new DomainDefaultUserSettingsCodeEditorAppSettingsDefaultResourceSpec();
