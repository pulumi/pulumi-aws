...
public final class GetResponsePlanActionSsmAutomationParameter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetResponsePlanActionSsmAutomationParameter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetResponsePlanActionSsmAutomationParameter", "values");
            }
            this.values = values;
            return this;
        }
