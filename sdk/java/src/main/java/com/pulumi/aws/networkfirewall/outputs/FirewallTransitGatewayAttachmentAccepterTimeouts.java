...
@CustomType
public final class FirewallTransitGatewayAttachmentAccepterTimeouts {
    /**
    ...
    public static Builder builder(FirewallTransitGatewayAttachmentAccepterTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(FirewallTransitGatewayAttachmentAccepterTimeouts defaults) {
        ...
        public FirewallTransitGatewayAttachmentAccepterTimeouts build() {
            final var _resultValue = new FirewallTransitGatewayAttachmentAccepterTimeouts();
