...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern;
...
@CustomType
public final class WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBody {
    /**
     ...
     * 
     */
    private @Nullable WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
    ...
    private WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBody() {}
    /**
     * @return How to handle requests with invalid JSON body. Valid values: `EVALUATE_AS_STRING`, `MATCH`, `NO_MATCH`.
     * 
     */
     ...
     * 
     */
    public Optional<WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern> matchPattern() {
    ...
    public static Builder builder(WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(@Nullable WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBody", "matchScope");
            }
        ...
        public WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBody build() {
            final var _resultValue = new WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBody();
