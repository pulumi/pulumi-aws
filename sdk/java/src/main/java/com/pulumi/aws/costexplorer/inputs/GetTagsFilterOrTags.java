...
public final class GetTagsFilterOrTags extends com.pulumi.resources.InvokeArgs {
    ...
    private GetTagsFilterOrTags(GetTagsFilterOrTags $) {
        this.key = $.key;
    ...
    public static Builder builder(GetTagsFilterOrTags defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagsFilterOrTags();
        }

        public Builder(GetTagsFilterOrTags defaults) {
        ...
        public GetTagsFilterOrTags build() {
            return $;
        }
    }
