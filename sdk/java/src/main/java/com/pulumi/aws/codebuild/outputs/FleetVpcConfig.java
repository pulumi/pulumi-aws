    ...
    public static final class Builder {
        ...
        public Builder securityGroupIds(List<String> securityGroupIds) {
            if (securityGroupIds == null) {
              throw new MissingRequiredPropertyException("FleetVpcConfig", "securityGroupIds");
            }
        ...
        public Builder subnets(List<String> subnets) {
            if (subnets == null) {
              throw new MissingRequiredPropertyException("FleetVpcConfig", "subnets");
            }
        ...
        public Builder vpcId(String vpcId) {
            if (vpcId == null) {
              throw new MissingRequiredPropertyException("FleetVpcConfig", "vpcId");
            }
            this.vpcId = vpcId;
            return this;
        }
