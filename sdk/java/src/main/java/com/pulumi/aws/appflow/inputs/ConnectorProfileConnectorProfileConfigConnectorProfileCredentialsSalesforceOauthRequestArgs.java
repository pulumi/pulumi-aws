...
public final class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestArgs() {}

    private ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestArgs(ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestArgs $) {
    ...
    public static Builder builder(ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestArgs();
        }

        public Builder(ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestArgs defaults) {
            $ = new ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceOauthRequestArgs build() {
            return $;
        }
    }
