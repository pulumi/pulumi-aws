...
public final class PipelineTriggerGitConfigurationPullRequestFilePathsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PipelineTriggerGitConfigurationPullRequestFilePathsArgs Empty = new PipelineTriggerGitConfigurationPullRequestFilePathsArgs();
    ...
    private PipelineTriggerGitConfigurationPullRequestFilePathsArgs() {}

    private PipelineTriggerGitConfigurationPullRequestFilePathsArgs(PipelineTriggerGitConfigurationPullRequestFilePathsArgs $) {
    ...
    public static Builder builder(PipelineTriggerGitConfigurationPullRequestFilePathsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineTriggerGitConfigurationPullRequestFilePathsArgs();
        }

        public Builder(PipelineTriggerGitConfigurationPullRequestFilePathsArgs defaults) {
            $ = new PipelineTriggerGitConfigurationPullRequestFilePathsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineTriggerGitConfigurationPullRequestFilePathsArgs build() {
            return $;
        }
    }
