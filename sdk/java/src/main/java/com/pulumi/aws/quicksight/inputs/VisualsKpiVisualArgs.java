...
import com.pulumi.aws.quicksight.inputs.VisualsKpiVisualChartConfigurationArgs;
import com.pulumi.aws.quicksight.inputs.VisualsKpiVisualConditionalFormattingArgs;
...
public final class VisualsKpiVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsKpiVisualArgs Empty = new VisualsKpiVisualArgs();
    ...
    private @Nullable Output<VisualsKpiVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsKpiVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private @Nullable Output<VisualsKpiVisualConditionalFormattingArgs> conditionalFormatting;

    public Optional<Output<VisualsKpiVisualConditionalFormattingArgs>> conditionalFormatting() {
    ...
    private VisualsKpiVisualArgs() {}

    private VisualsKpiVisualArgs(VisualsKpiVisualArgs $) {
    ...
    public static Builder builder(VisualsKpiVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsKpiVisualArgs();
        }

        public Builder(VisualsKpiVisualArgs defaults) {
            $ = new VisualsKpiVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsKpiVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsKpiVisualChartConfigurationArgs chartConfiguration) {
        ...
        public Builder conditionalFormatting(@Nullable Output<VisualsKpiVisualConditionalFormattingArgs> conditionalFormatting) {
            $.conditionalFormatting = conditionalFormatting;
            return this;
        }

        public Builder conditionalFormatting(VisualsKpiVisualConditionalFormattingArgs conditionalFormatting) {
        ...
        public VisualsKpiVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsKpiVisualArgs", "visualId");
            }
            return $;
        }
    }
