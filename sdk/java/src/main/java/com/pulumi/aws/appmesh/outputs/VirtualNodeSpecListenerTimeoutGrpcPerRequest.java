...
public final class VirtualNodeSpecListenerTimeoutGrpcPerRequest {
    ...
    public static final class Builder {
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecListenerTimeoutGrpcPerRequest", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder value(Integer value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecListenerTimeoutGrpcPerRequest", "value");
            }
            this.value = value;
            return this;
        }
        public VirtualNodeSpecListenerTimeoutGrpcPerRequest build() {
            final var _resultValue = new VirtualNodeSpecListenerTimeoutGrpcPerRequest();
