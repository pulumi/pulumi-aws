...
public final class ModelCardTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ModelCardTimeoutsArgs Empty = new ModelCardTimeoutsArgs();
    ...
    private ModelCardTimeoutsArgs() {}

    private ModelCardTimeoutsArgs(ModelCardTimeoutsArgs $) {
        this.delete = $.delete;
    }
    ...
    public static Builder builder(ModelCardTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModelCardTimeoutsArgs();
        }

        public Builder(ModelCardTimeoutsArgs defaults) {
            $ = new ModelCardTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ModelCardTimeoutsArgs build() {
            return $;
        }
    }
