...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern;
...
@CustomType
public final class RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies {
    /**
     ...
     * 
     */
    private List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns;
    /**
    ...
    private RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies() {}
    /**
     * @return The filter to use to identify the subset of cookies to inspect in a web request. You must specify exactly one setting: either `all`, `included_cookies` or `excluded_cookies`. More details: [CookieMatchPattern](https://docs.aws.amazon.com/waf/latest/APIReference/API_CookieMatchPattern.html)
     * 
     */
    public List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns() {
    ...
    public static Builder builder(RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies defaults) {
    ...
    public static final class Builder {
        ...
        private String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies defaults) {
        ...
        @CustomType.Setter
        public Builder matchPatterns(List<RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns) {
            if (matchPatterns == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies", "matchPatterns");
            }
            this.matchPatterns = matchPatterns;
            return this;
        }
        public Builder matchPatterns(RuleGroupRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern... matchPatterns) {
            return matchPatterns(List.of(matchPatterns));
        }
        @CustomType.Setter
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies", "matchScope");
            }
        ...
        public Builder oversizeHandling(String oversizeHandling) {
            if (oversizeHandling == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementXssMatchStatementFieldToMatchCookies", "oversizeHandling");
            }
