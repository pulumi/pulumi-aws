...
import com.pulumi.aws.quicksight.inputs.VisualsFilledMapVisualChartConfigurationArgs;
import com.pulumi.aws.quicksight.inputs.VisualsFilledMapVisualConditionalFormattingArgs;
...
public final class VisualsFilledMapVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsFilledMapVisualArgs Empty = new VisualsFilledMapVisualArgs();
    ...
    private @Nullable Output<VisualsFilledMapVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsFilledMapVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private @Nullable Output<VisualsFilledMapVisualConditionalFormattingArgs> conditionalFormatting;

    public Optional<Output<VisualsFilledMapVisualConditionalFormattingArgs>> conditionalFormatting() {
    ...
    private VisualsFilledMapVisualArgs(VisualsFilledMapVisualArgs $) {
    ...
    public static Builder builder(VisualsFilledMapVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsFilledMapVisualArgs();
        }

        public Builder(VisualsFilledMapVisualArgs defaults) {
            $ = new VisualsFilledMapVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsFilledMapVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsFilledMapVisualChartConfigurationArgs chartConfiguration) {
        ...
        public Builder conditionalFormatting(@Nullable Output<VisualsFilledMapVisualConditionalFormattingArgs> conditionalFormatting) {
            $.conditionalFormatting = conditionalFormatting;
            return this;
        }

        public Builder conditionalFormatting(VisualsFilledMapVisualConditionalFormattingArgs conditionalFormatting) {
        ...
        public VisualsFilledMapVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsFilledMapVisualArgs", "visualId");
            }
            return $;
        }
    }
