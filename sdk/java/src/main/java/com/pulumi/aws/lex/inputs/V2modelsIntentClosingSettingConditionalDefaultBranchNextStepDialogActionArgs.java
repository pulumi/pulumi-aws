...
public final class V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs Empty = new V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs();
    ...
    private V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs() {}

    private V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs(V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs $) {
    ...
    public static Builder builder(V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs();
        }

        public Builder(V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs defaults) {
            $ = new V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogActionArgs", "type");
            }
            return $;
        }
    }
