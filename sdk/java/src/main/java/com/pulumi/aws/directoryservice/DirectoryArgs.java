...
public final class DirectoryArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The alias for the directory (must be unique amongst all aliases in AWS). Required for `enableSso`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param alias The alias for the directory (must be unique amongst all aliases in AWS). Required for `enableSso`.
         * 
         * @return builder
         * 
         */
