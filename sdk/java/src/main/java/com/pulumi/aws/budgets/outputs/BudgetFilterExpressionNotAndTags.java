...
@CustomType
public final class BudgetFilterExpressionNotAndTags {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionNotAndTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotAndTags defaults) {
        ...
        public BudgetFilterExpressionNotAndTags build() {
            final var _resultValue = new BudgetFilterExpressionNotAndTags();
