...
public final class VpcConnectionTimeouts {
    ...
    public static Builder builder(VpcConnectionTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(VpcConnectionTimeouts defaults) {
        ...
        public VpcConnectionTimeouts build() {
            final var _resultValue = new VpcConnectionTimeouts();
