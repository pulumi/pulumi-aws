...
@CustomType
public final class BudgetFilterExpressionOrAndCostCategories {
    /**
    ...
    private BudgetFilterExpressionOrAndCostCategories() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionOrAndCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionOrAndCostCategories defaults) {
        ...
        public BudgetFilterExpressionOrAndCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionOrAndCostCategories();
