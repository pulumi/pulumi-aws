...
public final class V2modelsSlotTimeouts {
    ...
    public static Builder builder(V2modelsSlotTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(V2modelsSlotTimeouts defaults) {
        ...
        public V2modelsSlotTimeouts build() {
            final var _resultValue = new V2modelsSlotTimeouts();
