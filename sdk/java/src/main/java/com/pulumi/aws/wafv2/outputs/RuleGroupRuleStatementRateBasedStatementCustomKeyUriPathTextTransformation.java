...
public final class RuleGroupRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation {
    ...
    public static final class Builder {
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation", "priority");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation", "type");
            }
            this.type = type;
            return this;
        }
        public RuleGroupRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation build() {
            final var _resultValue = new RuleGroupRuleStatementRateBasedStatementCustomKeyUriPathTextTransformation();
