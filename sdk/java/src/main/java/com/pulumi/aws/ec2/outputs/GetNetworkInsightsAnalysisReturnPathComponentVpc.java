...
public final class GetNetworkInsightsAnalysisReturnPathComponentVpc {
    ...
    public static Builder builder(GetNetworkInsightsAnalysisReturnPathComponentVpc defaults) {
    ...
    public static final class Builder {
        ...
        public Builder arn(String arn) {
            if (arn == null) {
              throw new MissingRequiredPropertyException("GetNetworkInsightsAnalysisReturnPathComponentVpc", "arn");
            }
            this.arn = arn;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetNetworkInsightsAnalysisReturnPathComponentVpc", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetNetworkInsightsAnalysisReturnPathComponentVpc", "name");
            }
            this.name = name;
            return this;
        }
        public GetNetworkInsightsAnalysisReturnPathComponentVpc build() {
            final var _resultValue = new GetNetworkInsightsAnalysisReturnPathComponentVpc();
