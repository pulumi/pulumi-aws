...
@CustomType
public final class DelegationSignerRecordTimeouts {
    /**
    ...
    public static Builder builder(DelegationSignerRecordTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(DelegationSignerRecordTimeouts defaults) {
        ...
        public DelegationSignerRecordTimeouts build() {
            final var _resultValue = new DelegationSignerRecordTimeouts();
