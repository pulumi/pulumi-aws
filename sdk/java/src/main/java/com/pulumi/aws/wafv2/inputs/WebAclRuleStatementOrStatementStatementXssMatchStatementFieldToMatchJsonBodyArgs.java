...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs;
...
public final class WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs Empty = new WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs();
    ...
    private Output<WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs() {}

    private WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs(WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs();
        }

        public Builder(WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs defaults) {
            $ = new WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs build() {
