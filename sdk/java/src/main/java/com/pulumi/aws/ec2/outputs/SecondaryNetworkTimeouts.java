...
@CustomType
public final class SecondaryNetworkTimeouts {
    /**
    ...
    public static Builder builder(SecondaryNetworkTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(SecondaryNetworkTimeouts defaults) {
        ...
        public SecondaryNetworkTimeouts build() {
            final var _resultValue = new SecondaryNetworkTimeouts();
