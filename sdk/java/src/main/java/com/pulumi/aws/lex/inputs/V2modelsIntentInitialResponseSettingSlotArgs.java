...
public final class V2modelsIntentInitialResponseSettingSlotArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private V2modelsIntentInitialResponseSettingSlotArgs(V2modelsIntentInitialResponseSettingSlotArgs $) {
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingSlotArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(V2modelsIntentInitialResponseSettingSlotArgs defaults) {
            $ = new V2modelsIntentInitialResponseSettingSlotArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentInitialResponseSettingSlotArgs build() {
            if ($.mapBlockKey == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingSlotArgs", "mapBlockKey");
            }
            return $;
        }
    }
