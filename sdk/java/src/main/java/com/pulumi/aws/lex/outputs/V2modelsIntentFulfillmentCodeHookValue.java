...
@CustomType
public final class V2modelsIntentFulfillmentCodeHookValue {
    /**
    ...
    public static Builder builder(V2modelsIntentFulfillmentCodeHookValue defaults) {
    ...
    public static final class Builder {
        private @Nullable String interpretedValue;
        public Builder() {}
        public Builder(V2modelsIntentFulfillmentCodeHookValue defaults) {
        ...
        public V2modelsIntentFulfillmentCodeHookValue build() {
            final var _resultValue = new V2modelsIntentFulfillmentCodeHookValue();
