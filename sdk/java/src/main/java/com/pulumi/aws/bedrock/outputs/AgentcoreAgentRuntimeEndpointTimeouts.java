...
@CustomType
public final class AgentcoreAgentRuntimeEndpointTimeouts {
    /**
    ...
    public static Builder builder(AgentcoreAgentRuntimeEndpointTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(AgentcoreAgentRuntimeEndpointTimeouts defaults) {
        ...
        public AgentcoreAgentRuntimeEndpointTimeouts build() {
            final var _resultValue = new AgentcoreAgentRuntimeEndpointTimeouts();
