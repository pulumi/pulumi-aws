...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternAll;
...
public final class WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern {
     ...
     * 
     */
    private @Nullable WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternAll all;
    private @Nullable List<String> excludedCookies;
    private @Nullable List<String> includedCookies;

    private WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern() {}
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    public Optional<WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternAll> all() {
    ...
    public static Builder builder(WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder all(@Nullable WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternAll all) {
            this.all = all;
            return this;
        }
        @CustomType.Setter
