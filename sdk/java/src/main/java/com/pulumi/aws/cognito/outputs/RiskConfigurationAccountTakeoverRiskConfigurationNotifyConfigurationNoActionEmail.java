...
public final class RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmail {
    ...
    public static final class Builder {
        ...
        public Builder htmlBody(String htmlBody) {
            if (htmlBody == null) {
              throw new MissingRequiredPropertyException("RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmail", "htmlBody");
            }
        ...
        public Builder subject(String subject) {
            if (subject == null) {
              throw new MissingRequiredPropertyException("RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmail", "subject");
            }
        ...
        public Builder textBody(String textBody) {
            if (textBody == null) {
              throw new MissingRequiredPropertyException("RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmail", "textBody");
            }
            this.textBody = textBody;
            return this;
        }
        public RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmail build() {
            final var _resultValue = new RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmail();
