...
public final class AnomalySubscriptionThresholdExpressionDimensionArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnomalySubscriptionThresholdExpressionDimensionArgs Empty = new AnomalySubscriptionThresholdExpressionDimensionArgs();
    ...
    private AnomalySubscriptionThresholdExpressionDimensionArgs() {}

    private AnomalySubscriptionThresholdExpressionDimensionArgs(AnomalySubscriptionThresholdExpressionDimensionArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionDimensionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalySubscriptionThresholdExpressionDimensionArgs();
        }

        public Builder(AnomalySubscriptionThresholdExpressionDimensionArgs defaults) {
            $ = new AnomalySubscriptionThresholdExpressionDimensionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnomalySubscriptionThresholdExpressionDimensionArgs build() {
            return $;
        }
    }
