...
@CustomType
public final class WebAclRuleStatementSqliMatchStatementTextTransformation {
    /**
    ...
    public static Builder builder(WebAclRuleStatementSqliMatchStatementTextTransformation defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(WebAclRuleStatementSqliMatchStatementTextTransformation defaults) {
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementSqliMatchStatementTextTransformation", "priority");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementSqliMatchStatementTextTransformation", "type");
            }
            this.type = type;
            return this;
        }
