...
@CustomType
public final class CostCategoryRuleRuleOrAndCostCategory {
    /**
    ...
    private CostCategoryRuleRuleOrAndCostCategory() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleOrAndCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleOrAndCostCategory defaults) {
        ...
        public CostCategoryRuleRuleOrAndCostCategory build() {
            final var _resultValue = new CostCategoryRuleRuleOrAndCostCategory();
