...
public final class PipelineTriggerAllGitConfigurationPullRequestFilePathArgs extends com.pulumi.resources.ResourceArgs {

    public static final PipelineTriggerAllGitConfigurationPullRequestFilePathArgs Empty = new PipelineTriggerAllGitConfigurationPullRequestFilePathArgs();
    ...
    private PipelineTriggerAllGitConfigurationPullRequestFilePathArgs() {}

    private PipelineTriggerAllGitConfigurationPullRequestFilePathArgs(PipelineTriggerAllGitConfigurationPullRequestFilePathArgs $) {
    ...
    public static Builder builder(PipelineTriggerAllGitConfigurationPullRequestFilePathArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineTriggerAllGitConfigurationPullRequestFilePathArgs();
        }

        public Builder(PipelineTriggerAllGitConfigurationPullRequestFilePathArgs defaults) {
            $ = new PipelineTriggerAllGitConfigurationPullRequestFilePathArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineTriggerAllGitConfigurationPullRequestFilePathArgs build() {
            return $;
        }
    }
