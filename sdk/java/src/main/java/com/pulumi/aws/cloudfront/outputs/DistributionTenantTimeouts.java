...
@CustomType
public final class DistributionTenantTimeouts {
    /**
    ...
    public static Builder builder(DistributionTenantTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(DistributionTenantTimeouts defaults) {
        ...
        public DistributionTenantTimeouts build() {
            final var _resultValue = new DistributionTenantTimeouts();
