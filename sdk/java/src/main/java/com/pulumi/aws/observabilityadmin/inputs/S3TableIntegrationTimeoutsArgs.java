...
public final class S3TableIntegrationTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final S3TableIntegrationTimeoutsArgs Empty = new S3TableIntegrationTimeoutsArgs();
    ...
    private S3TableIntegrationTimeoutsArgs() {}

    private S3TableIntegrationTimeoutsArgs(S3TableIntegrationTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
    }
    ...
    public static Builder builder(S3TableIntegrationTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new S3TableIntegrationTimeoutsArgs();
        }

        public Builder(S3TableIntegrationTimeoutsArgs defaults) {
            $ = new S3TableIntegrationTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public S3TableIntegrationTimeoutsArgs build() {
            return $;
        }
    }
