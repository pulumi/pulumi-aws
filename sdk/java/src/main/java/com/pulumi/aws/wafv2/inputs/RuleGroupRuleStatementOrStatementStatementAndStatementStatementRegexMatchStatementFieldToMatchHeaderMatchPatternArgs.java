...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternAllArgs;
...
public final class RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="all")
    private @Nullable Output<RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternAllArgs> all;
    ...
    private RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs(RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs $) {
        this.all = $.all;
    ...
    public static Builder builder(RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs();
        }

        public Builder(RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs defaults) {
            $ = new RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder all(@Nullable Output<RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternAllArgs> all) {
            $.all = all;
            return this;
        }
         ...
         * 
         */
        public Builder all(RuleGroupRuleStatementOrStatementStatementAndStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternAllArgs all) {
