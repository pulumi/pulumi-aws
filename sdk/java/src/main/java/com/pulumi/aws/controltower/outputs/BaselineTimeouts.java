...
@CustomType
public final class BaselineTimeouts {
    /**
    ...
    public static Builder builder(BaselineTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(BaselineTimeouts defaults) {
        ...
        public BaselineTimeouts build() {
            final var _resultValue = new BaselineTimeouts();
