...
public final class GetLocalGatewayRouteTablesFilter extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetLocalGatewayRouteTablesFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetLocalGatewayRouteTablesFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetLocalGatewayRouteTablesFilter", "values");
            }
            return $;
        }
    }
