...
@CustomType
public final class FirehoseDeliveryStreamExtendedS3ConfigurationOrcSerDe {
    /**
    ...
    private FirehoseDeliveryStreamExtendedS3ConfigurationOrcSerDe() {}
    /**
     * @return The Hadoop Distributed File System (HDFS) block size. This is useful if you intend to copy the data from Amazon S3 to HDFS before querying. The default is 256 MiB and the minimum is 64 MiB. Kinesis Data Firehose uses this value for padding calculations.
     * 
     */
    ...
    public static Builder builder(FirehoseDeliveryStreamExtendedS3ConfigurationOrcSerDe defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer stripeSizeBytes;
        public Builder() {}
        public Builder(FirehoseDeliveryStreamExtendedS3ConfigurationOrcSerDe defaults) {
        ...
        public FirehoseDeliveryStreamExtendedS3ConfigurationOrcSerDe build() {
            final var _resultValue = new FirehoseDeliveryStreamExtendedS3ConfigurationOrcSerDe();
