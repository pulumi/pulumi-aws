...
public final class WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody {
     ...
     * 
     */
    private @Nullable WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
     ...
     * 
     */
    public Optional<WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder matchPattern(@Nullable WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody", "matchScope");
            }
        ...
        public WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody build() {
            final var _resultValue = new WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody();
