...
public final class NodejsAppLayerLoadBasedAutoScalingUpscaling {
    ...
    private NodejsAppLayerLoadBasedAutoScalingUpscaling() {}
    ...
    public static Builder builder(NodejsAppLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(NodejsAppLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public NodejsAppLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new NodejsAppLayerLoadBasedAutoScalingUpscaling();
