...
import com.pulumi.aws.quicksight.inputs.VisualsComboChartVisualChartConfigurationArgs;
...
public final class VisualsComboChartVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsComboChartVisualArgs Empty = new VisualsComboChartVisualArgs();
    ...
    private @Nullable Output<VisualsComboChartVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsComboChartVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsComboChartVisualArgs(VisualsComboChartVisualArgs $) {
    ...
    public static Builder builder(VisualsComboChartVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsComboChartVisualArgs();
        }

        public Builder(VisualsComboChartVisualArgs defaults) {
            $ = new VisualsComboChartVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsComboChartVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsComboChartVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsComboChartVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsComboChartVisualArgs", "visualId");
            }
            return $;
        }
    }
