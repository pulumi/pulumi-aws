...
public final class LfTagExpressionState extends com.pulumi.resources.ResourceArgs {

    public static final LfTagExpressionState Empty = new LfTagExpressionState();
    ...
    private LfTagExpressionState() {}

    private LfTagExpressionState(LfTagExpressionState $) {
    ...
    public static Builder builder(LfTagExpressionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LfTagExpressionState();
        }

        public Builder(LfTagExpressionState defaults) {
            $ = new LfTagExpressionState(Objects.requireNonNull(defaults));
        }
        ...
        public LfTagExpressionState build() {
            return $;
        }
    }
