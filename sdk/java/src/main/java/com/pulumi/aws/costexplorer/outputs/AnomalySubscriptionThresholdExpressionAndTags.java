...
public final class AnomalySubscriptionThresholdExpressionAndTags {
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionAndTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionAndTags defaults) {
        ...
        public AnomalySubscriptionThresholdExpressionAndTags build() {
            final var _resultValue = new AnomalySubscriptionThresholdExpressionAndTags();
