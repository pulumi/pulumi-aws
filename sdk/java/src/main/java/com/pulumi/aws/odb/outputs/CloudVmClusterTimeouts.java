...
@CustomType
public final class CloudVmClusterTimeouts {
    /**
    ...
    public static Builder builder(CloudVmClusterTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(CloudVmClusterTimeouts defaults) {
        ...
        public CloudVmClusterTimeouts build() {
            final var _resultValue = new CloudVmClusterTimeouts();
