...
public final class V2modelsSlotTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsSlotTimeoutsArgs Empty = new V2modelsSlotTimeoutsArgs();
    ...
    private V2modelsSlotTimeoutsArgs() {}

    private V2modelsSlotTimeoutsArgs(V2modelsSlotTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(V2modelsSlotTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsSlotTimeoutsArgs();
        }

        public Builder(V2modelsSlotTimeoutsArgs defaults) {
            $ = new V2modelsSlotTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsSlotTimeoutsArgs build() {
            return $;
        }
    }
