...
import com.pulumi.aws.lambdamicrovms.inputs.ImageState;
import com.pulumi.aws.lambdamicrovms.outputs.ImageCodeArtifact;
import com.pulumi.aws.lambdamicrovms.outputs.ImageCpuConfiguration;
import com.pulumi.aws.lambdamicrovms.outputs.ImageTimeouts;
 ...
 * 
 */
@ResourceType(type="aws:lambdamicrovms/image:Image")
public class Image extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="codeArtifact", refs={ImageCodeArtifact.class}, tree="[0]")
    private Output<ImageCodeArtifact> codeArtifact;

    /**
     * @return Code artifact containing the application code and metadata for the image. See below.
     * 
     */
    public Output<ImageCodeArtifact> codeArtifact() {
     ...
     * 
     */
    @Export(name="cpuConfigurations", refs={List.class,ImageCpuConfiguration.class}, tree="[0,1]")
    private Output</* @Nullable */ List<ImageCpuConfiguration>> cpuConfigurations;

    /**
     * @return CPU configuration for the MicroVM. See `cpuConfiguration` Block below.
     * 
     */
    public Output<Optional<List<ImageCpuConfiguration>>> cpuConfigurations() {
    ...
    public Image(java.lang.String name, ImageArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:lambdamicrovms/image:Image", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Image(java.lang.String name, Output<java.lang.String> id, @Nullable ImageState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:lambdamicrovms/image:Image", name, state, makeResourceOptions(options, id), false);
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("aws:lambda/microvmsImage:MicrovmsImage").build())
            ))
            .build();
