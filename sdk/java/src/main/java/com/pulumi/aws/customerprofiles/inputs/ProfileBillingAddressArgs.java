...
public final class ProfileBillingAddressArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ProfileBillingAddressArgs(ProfileBillingAddressArgs $) {
    ...
    public static Builder builder(ProfileBillingAddressArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProfileBillingAddressArgs();
        }

        public Builder(ProfileBillingAddressArgs defaults) {
            $ = new ProfileBillingAddressArgs(Objects.requireNonNull(defaults));
        }
