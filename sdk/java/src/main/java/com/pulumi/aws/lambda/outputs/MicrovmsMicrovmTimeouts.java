...
@CustomType
public final class MicrovmsMicrovmTimeouts {
    /**
    ...
    public static Builder builder(MicrovmsMicrovmTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(MicrovmsMicrovmTimeouts defaults) {
        ...
        public MicrovmsMicrovmTimeouts build() {
            final var _resultValue = new MicrovmsMicrovmTimeouts();
