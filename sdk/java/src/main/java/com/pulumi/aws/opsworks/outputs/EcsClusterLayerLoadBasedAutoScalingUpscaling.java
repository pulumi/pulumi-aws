...
public final class EcsClusterLayerLoadBasedAutoScalingUpscaling {
    ...
    private EcsClusterLayerLoadBasedAutoScalingUpscaling() {}
    ...
    public static Builder builder(EcsClusterLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(EcsClusterLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public EcsClusterLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new EcsClusterLayerLoadBasedAutoScalingUpscaling();
