...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPattern;
...
public final class RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody {
     ...
     * 
     */
    private RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
    ...
    public static Builder builder(RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
            if (matchPattern == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody", "matchPattern");
            }
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody", "matchScope");
            }
        ...
        public RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody build() {
            final var _resultValue = new RuleGroupRuleStatementRegexPatternSetReferenceStatementFieldToMatchJsonBody();
