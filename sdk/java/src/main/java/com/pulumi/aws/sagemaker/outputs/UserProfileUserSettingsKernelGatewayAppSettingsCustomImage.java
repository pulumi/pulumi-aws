    ...
    public static final class Builder {
        ...
        public Builder appImageConfigName(String appImageConfigName) {
            if (appImageConfigName == null) {
              throw new MissingRequiredPropertyException("UserProfileUserSettingsKernelGatewayAppSettingsCustomImage", "appImageConfigName");
            }
        ...
        public Builder imageName(String imageName) {
            if (imageName == null) {
              throw new MissingRequiredPropertyException("UserProfileUserSettingsKernelGatewayAppSettingsCustomImage", "imageName");
            }
