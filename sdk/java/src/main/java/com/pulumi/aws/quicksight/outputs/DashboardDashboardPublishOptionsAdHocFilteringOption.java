...
public final class DashboardDashboardPublishOptionsAdHocFilteringOption {
    ...
    private DashboardDashboardPublishOptionsAdHocFilteringOption() {}
    /**
     * @return Availability status. Possibles values: ENABLED, DISABLED.
     * 
     */
    ...
    public static Builder builder(DashboardDashboardPublishOptionsAdHocFilteringOption defaults) {
    ...
    public static final class Builder {
        private @Nullable String availabilityStatus;
        public Builder() {}
        public Builder(DashboardDashboardPublishOptionsAdHocFilteringOption defaults) {
