...
public final class LaunchTemplateInstanceRequirementsMemoryGibPerVcpu {
    ...
    public static Builder builder(LaunchTemplateInstanceRequirementsMemoryGibPerVcpu defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double min;
        public Builder() {}
        public Builder(LaunchTemplateInstanceRequirementsMemoryGibPerVcpu defaults) {
        ...
        public LaunchTemplateInstanceRequirementsMemoryGibPerVcpu build() {
            final var _resultValue = new LaunchTemplateInstanceRequirementsMemoryGibPerVcpu();
