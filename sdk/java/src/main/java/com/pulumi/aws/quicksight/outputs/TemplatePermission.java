...
public final class TemplatePermission {
    ...
    public static Builder builder(TemplatePermission defaults) {
    ...
    public static final class Builder {
        ...
        private String principal;
        public Builder() {}
        public Builder(TemplatePermission defaults) {
        ...
        public Builder actions(List<String> actions) {
            if (actions == null) {
              throw new MissingRequiredPropertyException("TemplatePermission", "actions");
            }
        ...
        public Builder principal(String principal) {
            if (principal == null) {
              throw new MissingRequiredPropertyException("TemplatePermission", "principal");
            }
