...
public final class AgentcoreHarnessArgs extends com.pulumi.resources.ResourceArgs {

    public static final AgentcoreHarnessArgs Empty = new AgentcoreHarnessArgs();
     ...
     * 
     */
    @Import(name="harnessName", required=true)
    ...
    private Output<AgentcoreHarnessModelArgs> model;

    /**
     * @return Model configuration for the harness. See `model` Block below.
     * 
     */
    public Output<AgentcoreHarnessModelArgs> model() {
        return this.model;
    }
     ...
     * 
     */
    @Import(name="systemPrompts", required=true)
    private Output<List<AgentcoreHarnessSystemPromptArgs>> systemPrompts;
     ...
     * 
     */
    public Output<List<AgentcoreHarnessSystemPromptArgs>> systemPrompts() {
    ...
    private AgentcoreHarnessArgs() {}

    private AgentcoreHarnessArgs(AgentcoreHarnessArgs $) {
    ...
    public static Builder builder(AgentcoreHarnessArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AgentcoreHarnessArgs();
        }

        public Builder(AgentcoreHarnessArgs defaults) {
            $ = new AgentcoreHarnessArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder harnessName(Output<String> harnessName) {
         ...
         * 
         */
        public Builder model(Output<AgentcoreHarnessModelArgs> model) {
            $.model = model;
            return this;
        }
         ...
         * 
         */
        public Builder systemPrompts(Output<List<AgentcoreHarnessSystemPromptArgs>> systemPrompts) {
        ...
        public AgentcoreHarnessArgs build() {
            if ($.executionRoleArn == null) {
                throw new MissingRequiredPropertyException("AgentcoreHarnessArgs", "executionRoleArn");
            }
            if ($.harnessName == null) {
                throw new MissingRequiredPropertyException("AgentcoreHarnessArgs", "harnessName");
            }
            if ($.model == null) {
                throw new MissingRequiredPropertyException("AgentcoreHarnessArgs", "model");
            }
            if ($.systemPrompts == null) {
                throw new MissingRequiredPropertyException("AgentcoreHarnessArgs", "systemPrompts");
            }
            return $;
        }
    }
