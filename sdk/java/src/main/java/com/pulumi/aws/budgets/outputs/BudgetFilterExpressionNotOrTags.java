...
@CustomType
public final class BudgetFilterExpressionNotOrTags {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionNotOrTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotOrTags defaults) {
        ...
        public BudgetFilterExpressionNotOrTags build() {
            final var _resultValue = new BudgetFilterExpressionNotOrTags();
