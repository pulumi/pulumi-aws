...
public final class GetInstanceTypeOfferingsFilter extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetInstanceTypeOfferingsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetInstanceTypeOfferingsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetInstanceTypeOfferingsFilter", "values");
            }
            return $;
        }
    }
