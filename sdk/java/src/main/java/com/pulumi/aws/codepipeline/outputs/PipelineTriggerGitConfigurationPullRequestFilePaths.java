...
@CustomType
public final class PipelineTriggerGitConfigurationPullRequestFilePaths {
    /**
    ...
    private PipelineTriggerGitConfigurationPullRequestFilePaths() {}
    /**
     * @return A list of patterns of Git repository file paths that, when a commit is pushed, are to be excluded from starting the pipeline.
     * 
     */
    ...
    public static Builder builder(PipelineTriggerGitConfigurationPullRequestFilePaths defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(PipelineTriggerGitConfigurationPullRequestFilePaths defaults) {
        ...
        public PipelineTriggerGitConfigurationPullRequestFilePaths build() {
            final var _resultValue = new PipelineTriggerGitConfigurationPullRequestFilePaths();
