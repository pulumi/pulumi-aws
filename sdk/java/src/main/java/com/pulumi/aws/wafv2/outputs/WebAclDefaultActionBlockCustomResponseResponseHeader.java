...
public final class WebAclDefaultActionBlockCustomResponseResponseHeader {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("WebAclDefaultActionBlockCustomResponseResponseHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("WebAclDefaultActionBlockCustomResponseResponseHeader", "value");
            }
            this.value = value;
            return this;
        }
        public WebAclDefaultActionBlockCustomResponseResponseHeader build() {
            final var _resultValue = new WebAclDefaultActionBlockCustomResponseResponseHeader();
