...
import com.pulumi.aws.lex.outputs.V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlot;
...
public final class V2modelsIntentConfirmationSettingDeclinationNextStepIntent {
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingDeclinationNextStepIntent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlot> slots;
        public Builder() {}
        public Builder(V2modelsIntentConfirmationSettingDeclinationNextStepIntent defaults) {
        ...
        @CustomType.Setter
        public Builder slots(@Nullable List<V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlot> slots) {

            this.slots = slots;
            return this;
        }
        public Builder slots(V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlot... slots) {
            return slots(List.of(slots));
        }
        public V2modelsIntentConfirmationSettingDeclinationNextStepIntent build() {
            final var _resultValue = new V2modelsIntentConfirmationSettingDeclinationNextStepIntent();
