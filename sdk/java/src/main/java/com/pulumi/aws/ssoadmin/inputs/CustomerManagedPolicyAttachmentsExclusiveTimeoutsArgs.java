...
public final class CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs Empty = new CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs();
    ...
    private CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs() {}

    private CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs(CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs $) {
        this.create = $.create;
        this.update = $.update;
    }
    ...
    public static Builder builder(CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs();
        }

        public Builder(CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs defaults) {
            $ = new CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CustomerManagedPolicyAttachmentsExclusiveTimeoutsArgs build() {
            return $;
        }
    }
