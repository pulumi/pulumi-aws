...
public final class ShardGroupTimeouts {
    ...
    public static Builder builder(ShardGroupTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ShardGroupTimeouts defaults) {
        ...
        public ShardGroupTimeouts build() {
            final var _resultValue = new ShardGroupTimeouts();
