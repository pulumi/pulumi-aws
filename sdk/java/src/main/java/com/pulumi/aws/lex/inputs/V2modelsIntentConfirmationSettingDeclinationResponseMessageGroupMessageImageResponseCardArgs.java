...
public final class V2modelsIntentConfirmationSettingDeclinationResponseMessageGroupMessageImageResponseCardArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="buttons")
    private @Nullable Output<List<V2modelsIntentConfirmationSettingDeclinationResponseMessageGroupMessageImageResponseCardButtonArgs>> buttons;
     ...
     * 
     */
    public Optional<Output<List<V2modelsIntentConfirmationSettingDeclinationResponseMessageGroupMessageImageResponseCardButtonArgs>>> buttons() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder buttons(@Nullable Output<List<V2modelsIntentConfirmationSettingDeclinationResponseMessageGroupMessageImageResponseCardButtonArgs>> buttons) {
            $.buttons = buttons;
            return this;
        }
         ...
         * 
         */
        public Builder buttons(List<V2modelsIntentConfirmationSettingDeclinationResponseMessageGroupMessageImageResponseCardButtonArgs> buttons) {
