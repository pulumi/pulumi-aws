...
public final class RuleGroupRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint {
    ...
    public static Builder builder(RuleGroupRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint defaults) {
    ...
    public static final class Builder {
        private String fallbackBehavior;
        public Builder() {}
        public Builder(RuleGroupRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint defaults) {
        ...
        public Builder fallbackBehavior(String fallbackBehavior) {
            if (fallbackBehavior == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementSqliMatchStatementFieldToMatchJa3Fingerprint", "fallbackBehavior");
            }
