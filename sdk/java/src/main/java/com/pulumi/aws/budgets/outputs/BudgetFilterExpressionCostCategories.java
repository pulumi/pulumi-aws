...
@CustomType
public final class BudgetFilterExpressionCostCategories {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionCostCategories defaults) {
        ...
        public BudgetFilterExpressionCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionCostCategories();
