...
public class StoredIscsiVolume extends com.pulumi.resources.CustomResource {
    ...
    public StoredIscsiVolume(java.lang.String name, StoredIscsiVolumeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:storagegateway/storedIscsiVolume:StoredIscsiVolume", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private StoredIscsiVolume(java.lang.String name, Output<java.lang.String> id, @Nullable StoredIscsiVolumeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:storagegateway/storedIscsiVolume:StoredIscsiVolume", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static StoredIscsiVolume get(java.lang.String name, Output<java.lang.String> id, @Nullable StoredIscsiVolumeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
