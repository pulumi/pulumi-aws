...
@CustomType
public final class CostCategoryRuleRuleNotNotCostCategory {
    /**
    ...
    public static Builder builder(CostCategoryRuleRuleNotNotCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleNotNotCostCategory defaults) {
        ...
        public CostCategoryRuleRuleNotNotCostCategory build() {
            final var _resultValue = new CostCategoryRuleRuleNotNotCostCategory();
