...
@CustomType
public final class BudgetFilterExpressionNotTags {
    /**
    ...
    private BudgetFilterExpressionNotTags() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionNotTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotTags defaults) {
        ...
        public BudgetFilterExpressionNotTags build() {
            final var _resultValue = new BudgetFilterExpressionNotTags();
