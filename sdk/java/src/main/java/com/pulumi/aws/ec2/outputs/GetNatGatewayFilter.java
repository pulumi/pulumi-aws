...
@CustomType
public final class GetNatGatewayFilter {
    /**
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetNatGatewayFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetNatGatewayFilter", "values");
            }
            this.values = values;
            return this;
        }
