...
public final class V2modelsIntentInitialResponseSettingNextStepDialogAction {
    ...
    private V2modelsIntentInitialResponseSettingNextStepDialogAction() {}
    /**
     * @return If the dialog action is `ElicitSlot`, defines the slot to elicit from the user.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingNextStepDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingNextStepDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingNextStepDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentInitialResponseSettingNextStepDialogAction build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingNextStepDialogAction();
