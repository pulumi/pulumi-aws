...
public final class InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRange {
    ...
    public static final class Builder {
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRange", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder value(Integer value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsEc2InstanceLaunchedAtDateRange", "value");
            }
            this.value = value;
            return this;
        }
