...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig {
    ...
    public static Builder builder(FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig defaults) {
        ...
        public Builder failOnFirstDestinationError(@Nullable Boolean failOnFirstDestinationError) {
            this.failOnFirstDestinationError = failOnFirstDestinationError;
            return this;
        }        public FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig build() {
            return new FlowDestinationFlowConfigDestinationConnectorPropertiesZendeskErrorHandlingConfig(bucketName, bucketPrefix, failOnFirstDestinationError);
        }
    }
}
