...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfigArgs() {}

    private FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfigArgs(FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfigArgs $) {
    ...
    public static Builder builder(FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfigArgs();
        }

        public Builder(FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfigArgs defaults) {
            $ = new FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfigArgs build() {
            return $;
        }
    }
