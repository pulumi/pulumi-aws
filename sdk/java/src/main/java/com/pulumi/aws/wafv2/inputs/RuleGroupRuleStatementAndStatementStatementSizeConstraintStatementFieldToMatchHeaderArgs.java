...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs Empty = new RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs();
    ...
    private Output<RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs() {}

    private RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs(RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs();
        }

        public Builder(RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs defaults) {
            $ = new RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public RuleGroupRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs build() {
