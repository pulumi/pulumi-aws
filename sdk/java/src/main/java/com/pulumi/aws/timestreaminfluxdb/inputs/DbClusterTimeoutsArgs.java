...
public final class DbClusterTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final DbClusterTimeoutsArgs Empty = new DbClusterTimeoutsArgs();
    ...
    private DbClusterTimeoutsArgs() {}

    private DbClusterTimeoutsArgs(DbClusterTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(DbClusterTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DbClusterTimeoutsArgs();
        }

        public Builder(DbClusterTimeoutsArgs defaults) {
            $ = new DbClusterTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DbClusterTimeoutsArgs build() {
            return $;
        }
    }
