...
public final class GetDistributionConfigurationsFilter extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetDistributionConfigurationsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetDistributionConfigurationsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetDistributionConfigurationsFilter", "values");
            }
            return $;
        }
    }
