...
public final class AnomalySubscriptionThresholdExpressionOrCostCategory {
    ...
    private AnomalySubscriptionThresholdExpressionOrCostCategory() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionOrCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionOrCostCategory defaults) {
        ...
        public AnomalySubscriptionThresholdExpressionOrCostCategory build() {
            final var _resultValue = new AnomalySubscriptionThresholdExpressionOrCostCategory();
