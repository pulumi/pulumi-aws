...
public final class ServiceVolumeConfigurationManagedEbsVolumeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param sizeInGb Size of the volume in GiB. You must specify either a `sizeInGb` or a `snapshotId`. You can optionally specify a volume size greater than or equal to the snapshot size.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param snapshotId Snapshot that Amazon ECS uses to create the volume. You must specify either a `sizeInGb` or a `snapshotId`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param volumeInitializationRate Volume Initialization Rate in MiB/s. You must also specify a `snapshotId`.
         * 
         * @return builder
         * 
         */
