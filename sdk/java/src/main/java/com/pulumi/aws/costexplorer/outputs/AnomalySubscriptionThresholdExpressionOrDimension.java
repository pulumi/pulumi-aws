...
public final class AnomalySubscriptionThresholdExpressionOrDimension {
    ...
    private AnomalySubscriptionThresholdExpressionOrDimension() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionOrDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionOrDimension defaults) {
