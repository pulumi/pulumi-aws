...
@CustomType
public final class BudgetFilterExpressionAndNotDimensions {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionAndNotDimensions defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionAndNotDimensions defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionAndNotDimensions", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionAndNotDimensions", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public BudgetFilterExpressionAndNotDimensions build() {
            final var _resultValue = new BudgetFilterExpressionAndNotDimensions();
