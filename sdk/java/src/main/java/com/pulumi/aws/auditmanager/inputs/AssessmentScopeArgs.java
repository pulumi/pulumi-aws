...
public final class AssessmentScopeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param awsAccounts Amazon Web Services accounts that are in scope for the assessment. See `aws_accounts` below.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param awsServices Amazon Web Services services that are included in the scope of the assessment. See `aws_services` below.
         * 
         * @return builder
         * 
         */
