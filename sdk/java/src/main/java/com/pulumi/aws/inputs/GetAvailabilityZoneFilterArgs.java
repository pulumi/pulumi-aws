...
public final class GetAvailabilityZoneFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAvailabilityZoneFilterArgs Empty = new GetAvailabilityZoneFilterArgs();
    ...
    private GetAvailabilityZoneFilterArgs() {}

    private GetAvailabilityZoneFilterArgs(GetAvailabilityZoneFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetAvailabilityZoneFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAvailabilityZoneFilterArgs();
        }

        public Builder(GetAvailabilityZoneFilterArgs defaults) {
            $ = new GetAvailabilityZoneFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAvailabilityZoneFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetAvailabilityZoneFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetAvailabilityZoneFilterArgs", "values");
            }
            return $;
        }
    }
