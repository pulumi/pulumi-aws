...
@CustomType
public final class BudgetFilterExpressionAndOrCostCategories {
    /**
    ...
    private BudgetFilterExpressionAndOrCostCategories() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionAndOrCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionAndOrCostCategories defaults) {
        ...
        public BudgetFilterExpressionAndOrCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionAndOrCostCategories();
