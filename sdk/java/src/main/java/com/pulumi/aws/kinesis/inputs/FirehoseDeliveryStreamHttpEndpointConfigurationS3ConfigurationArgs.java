...
import com.pulumi.aws.kinesis.inputs.FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs;
...
public final class FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs Empty = new FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs();
    ...
    private @Nullable Output<FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs> cloudwatchLoggingOptions;

    /**
     * @return The CloudWatch Logging Options for the delivery stream. See `cloudwatchLoggingOptions` block below for details.
     * 
     */
    public Optional<Output<FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs>> cloudwatchLoggingOptions() {
    ...
    private FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs() {}

    private FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs(FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs $) {
    ...
    public static Builder builder(FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs();
        }

        public Builder(FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs defaults) {
            $ = new FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudwatchLoggingOptions(@Nullable Output<FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs> cloudwatchLoggingOptions) {
         ...
         * 
         */
        public Builder cloudwatchLoggingOptions(FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs cloudwatchLoggingOptions) {
        ...
        public FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs build() {
            if ($.bucketArn == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs", "bucketArn");
            }
            if ($.roleArn == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamHttpEndpointConfigurationS3ConfigurationArgs", "roleArn");
            }
            return $;
        }
    }
