...
public final class TemplateSourceEntitySourceAnalysisDataSetReference {
    ...
    public static final class Builder {
        ...
        public Builder dataSetArn(String dataSetArn) {
            if (dataSetArn == null) {
              throw new MissingRequiredPropertyException("TemplateSourceEntitySourceAnalysisDataSetReference", "dataSetArn");
            }
        ...
        public Builder dataSetPlaceholder(String dataSetPlaceholder) {
            if (dataSetPlaceholder == null) {
              throw new MissingRequiredPropertyException("TemplateSourceEntitySourceAnalysisDataSetReference", "dataSetPlaceholder");
            }
