...
import com.pulumi.aws.quicksight.outputs.AnalysisDefinitionSheetParameterControl;
import com.pulumi.aws.quicksight.outputs.AnalysisDefinitionSheetSheetControlLayouts;
import com.pulumi.aws.quicksight.outputs.AnalysisDefinitionSheetTextBox;
...
@CustomType
public final class AnalysisDefinitionSheet {
    ...
    private @Nullable List<AnalysisDefinitionSheetParameterControl> parameterControls;
    private @Nullable AnalysisDefinitionSheetSheetControlLayouts sheetControlLayouts;
    private String sheetId;
    private @Nullable List<AnalysisDefinitionSheetTextBox> textBoxes;
    ...
    public List<AnalysisDefinitionSheetParameterControl> parameterControls() {
        return this.parameterControls == null ? List.of() : this.parameterControls;
    }
    public Optional<AnalysisDefinitionSheetSheetControlLayouts> sheetControlLayouts() {
        return Optional.ofNullable(this.sheetControlLayouts);
    }
    public String sheetId() {
        return this.sheetId;
    }
    public List<AnalysisDefinitionSheetTextBox> textBoxes() {
    ...
    public static Builder builder(AnalysisDefinitionSheet defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<Visuals> visuals;
        public Builder() {}
        public Builder(AnalysisDefinitionSheet defaults) {
        ...
        @CustomType.Setter
        public Builder parameterControls(@Nullable List<AnalysisDefinitionSheetParameterControl> parameterControls) {

            this.parameterControls = parameterControls;
            return this;
        }
        public Builder parameterControls(AnalysisDefinitionSheetParameterControl... parameterControls) {
            return parameterControls(List.of(parameterControls));
        }
        @CustomType.Setter
        public Builder sheetControlLayouts(@Nullable AnalysisDefinitionSheetSheetControlLayouts sheetControlLayouts) {
        ...
        public Builder sheetId(String sheetId) {
            if (sheetId == null) {
              throw new MissingRequiredPropertyException("AnalysisDefinitionSheet", "sheetId");
            }
            this.sheetId = sheetId;
            return this;
        }
        @CustomType.Setter
        public Builder textBoxes(@Nullable List<AnalysisDefinitionSheetTextBox> textBoxes) {

            this.textBoxes = textBoxes;
            return this;
        }
        public Builder textBoxes(AnalysisDefinitionSheetTextBox... textBoxes) {
        ...
        public AnalysisDefinitionSheet build() {
            final var _resultValue = new AnalysisDefinitionSheet();
