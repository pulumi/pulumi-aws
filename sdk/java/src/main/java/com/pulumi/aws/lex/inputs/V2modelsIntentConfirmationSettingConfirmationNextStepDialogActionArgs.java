...
public final class V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs Empty = new V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs();
    ...
    private V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs() {}

    private V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs(V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs $) {
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs();
        }

        public Builder(V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs defaults) {
            $ = new V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingConfirmationNextStepDialogActionArgs", "type");
            }
            return $;
        }
    }
