...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPatternAll;
...
@CustomType
public final class RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern {
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    private @Nullable RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPatternAll all;
    /**
    ...
    private RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern() {}
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    public Optional<RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPatternAll> all() {
    ...
    public static Builder builder(RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedHeaders;
        public Builder() {}
        public Builder(RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPattern defaults) {
        ...
        @CustomType.Setter
        public Builder all(@Nullable RuleGroupRuleStatementSqliMatchStatementFieldToMatchHeaderMatchPatternAll all) {
            this.all = all;
            return this;
        }
        @CustomType.Setter
