    ...
    public static final class Builder {
        ...
        public RuleGroupVisibilityConfigArgs build() {
            if ($.cloudwatchMetricsEnabled == null) {
                throw new MissingRequiredPropertyException("RuleGroupVisibilityConfigArgs", "cloudwatchMetricsEnabled");
            }
            if ($.metricName == null) {
                throw new MissingRequiredPropertyException("RuleGroupVisibilityConfigArgs", "metricName");
            }
            if ($.sampledRequestsEnabled == null) {
                throw new MissingRequiredPropertyException("RuleGroupVisibilityConfigArgs", "sampledRequestsEnabled");
            }
            return $;
        }
    }
