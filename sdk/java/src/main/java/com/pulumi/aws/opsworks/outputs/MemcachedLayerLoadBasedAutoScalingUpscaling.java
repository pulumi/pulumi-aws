...
public final class MemcachedLayerLoadBasedAutoScalingUpscaling {
    ...
    private MemcachedLayerLoadBasedAutoScalingUpscaling() {}
    ...
    public static Builder builder(MemcachedLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(MemcachedLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public MemcachedLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new MemcachedLayerLoadBasedAutoScalingUpscaling();
