...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs;
...
public final class RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs Empty = new RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs();
    ...
    private Output<RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern() {
    ...
    private RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs() {}

    private RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs(RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs $) {
    ...
    public static Builder builder(RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs();
        }

        public Builder(RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs defaults) {
            $ = new RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern) {
        ...
        public RuleGroupRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs build() {
