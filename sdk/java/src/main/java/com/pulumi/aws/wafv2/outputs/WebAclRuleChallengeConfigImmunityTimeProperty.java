...
public final class WebAclRuleChallengeConfigImmunityTimeProperty {
    ...
    public static Builder builder(WebAclRuleChallengeConfigImmunityTimeProperty defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer immunityTime;
        public Builder() {}
        public Builder(WebAclRuleChallengeConfigImmunityTimeProperty defaults) {
        ...
        public WebAclRuleChallengeConfigImmunityTimeProperty build() {
            final var _resultValue = new WebAclRuleChallengeConfigImmunityTimeProperty();
