...
public final class RegionTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegionTimeoutsArgs Empty = new RegionTimeoutsArgs();
    ...
    private RegionTimeoutsArgs() {}

    private RegionTimeoutsArgs(RegionTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
    }
    ...
    public static Builder builder(RegionTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegionTimeoutsArgs();
        }

        public Builder(RegionTimeoutsArgs defaults) {
            $ = new RegionTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegionTimeoutsArgs build() {
            return $;
        }
    }
