...
public final class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJa3Fingerprint {
    ...
    private RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJa3Fingerprint() {}
    /**
     * @return The match status to assign to the web request if the request doesn&#39;t have a JA3 fingerprint. Valid values include: `MATCH` or `NO_MATCH`.
     * 
     */
    ...
    public static Builder builder(RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJa3Fingerprint defaults) {
    ...
    public static final class Builder {
        private String fallbackBehavior;
        public Builder() {}
        public Builder(RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJa3Fingerprint defaults) {
        ...
        public Builder fallbackBehavior(String fallbackBehavior) {
            if (fallbackBehavior == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementSizeConstraintStatementFieldToMatchJa3Fingerprint", "fallbackBehavior");
            }
