...
public final class GetNetworkInsightsAnalysisReturnPathComponentSubnet {
    ...
    public static Builder builder(GetNetworkInsightsAnalysisReturnPathComponentSubnet defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetNetworkInsightsAnalysisReturnPathComponentSubnet defaults) {
        ...
        public Builder arn(String arn) {
            if (arn == null) {
              throw new MissingRequiredPropertyException("GetNetworkInsightsAnalysisReturnPathComponentSubnet", "arn");
            }
            this.arn = arn;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetNetworkInsightsAnalysisReturnPathComponentSubnet", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetNetworkInsightsAnalysisReturnPathComponentSubnet", "name");
            }
            this.name = name;
            return this;
        }
