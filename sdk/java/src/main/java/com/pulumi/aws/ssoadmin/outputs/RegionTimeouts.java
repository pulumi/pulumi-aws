...
@CustomType
public final class RegionTimeouts {
    /**
    ...
    public static Builder builder(RegionTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(RegionTimeouts defaults) {
        ...
        public RegionTimeouts build() {
            final var _resultValue = new RegionTimeouts();
