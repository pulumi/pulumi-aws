...
public final class NodejsAppLayerEbsVolumeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private NodejsAppLayerEbsVolumeArgs(NodejsAppLayerEbsVolumeArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NodejsAppLayerEbsVolumeArgs();
        }

        public Builder(NodejsAppLayerEbsVolumeArgs defaults) {
            $ = new NodejsAppLayerEbsVolumeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NodejsAppLayerEbsVolumeArgs build() {
            if ($.mountPoint == null) {
                throw new MissingRequiredPropertyException("NodejsAppLayerEbsVolumeArgs", "mountPoint");
            }
            if ($.numberOfDisks == null) {
                throw new MissingRequiredPropertyException("NodejsAppLayerEbsVolumeArgs", "numberOfDisks");
            }
            if ($.size == null) {
                throw new MissingRequiredPropertyException("NodejsAppLayerEbsVolumeArgs", "size");
            }
            return $;
        }
    }
