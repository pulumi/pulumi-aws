...
@CustomType
public final class RouteSpecHttpRouteMatchQueryParameterMatch {
    /**
    ...
    private RouteSpecHttpRouteMatchQueryParameterMatch() {}
    /**
     * @return The exact query parameter to match on.
     * 
     */
    ...
    public static Builder builder(RouteSpecHttpRouteMatchQueryParameterMatch defaults) {
    ...
    public static final class Builder {
        private @Nullable String exact;
        public Builder() {}
        public Builder(RouteSpecHttpRouteMatchQueryParameterMatch defaults) {
