...
@CustomType
public final class PipelineEndpointTimeouts {
    /**
    ...
    public static Builder builder(PipelineEndpointTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(PipelineEndpointTimeouts defaults) {
        ...
        public PipelineEndpointTimeouts build() {
            final var _resultValue = new PipelineEndpointTimeouts();
