...
public final class SubscriberTimeouts {
    ...
    public static Builder builder(SubscriberTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(SubscriberTimeouts defaults) {
        ...
        public SubscriberTimeouts build() {
            final var _resultValue = new SubscriberTimeouts();
