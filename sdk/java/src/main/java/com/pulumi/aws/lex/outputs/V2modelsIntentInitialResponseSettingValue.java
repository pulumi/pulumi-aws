...
@CustomType
public final class V2modelsIntentInitialResponseSettingValue {
    /**
    ...
    private V2modelsIntentInitialResponseSettingValue() {}
    /**
     * @return Value that Amazon Lex determines for the slot. The actual value depends on the setting of the value selection strategy for the bot. You can choose to use the value entered by the user, or you can have Amazon Lex choose the first value in the resolvedValues list.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingValue defaults) {
    ...
    public static final class Builder {
        private @Nullable String interpretedValue;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingValue defaults) {
        ...
        public V2modelsIntentInitialResponseSettingValue build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingValue();
