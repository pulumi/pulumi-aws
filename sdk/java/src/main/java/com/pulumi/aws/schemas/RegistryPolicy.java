...
public class RegistryPolicy extends com.pulumi.resources.CustomResource {
    ...
    public RegistryPolicy(java.lang.String name, RegistryPolicyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:schemas/registryPolicy:RegistryPolicy", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private RegistryPolicy(java.lang.String name, Output<java.lang.String> id, @Nullable RegistryPolicyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:schemas/registryPolicy:RegistryPolicy", name, state, makeResourceOptions(options, id), false);
    }
