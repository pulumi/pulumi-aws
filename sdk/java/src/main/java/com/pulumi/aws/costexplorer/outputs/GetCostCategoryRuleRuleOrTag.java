...
@CustomType
public final class GetCostCategoryRuleRuleOrTag {
    /**
    ...
    private GetCostCategoryRuleRuleOrTag() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(GetCostCategoryRuleRuleOrTag defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(GetCostCategoryRuleRuleOrTag defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleOrTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder matchOptions(List<String> matchOptions) {
            if (matchOptions == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleOrTag", "matchOptions");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleOrTag", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetCostCategoryRuleRuleOrTag build() {
            final var _resultValue = new GetCostCategoryRuleRuleOrTag();
