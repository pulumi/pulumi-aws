...
@CustomType
public final class NodejsAppLayerLoadBasedAutoScalingDownscaling {
    ...
    private NodejsAppLayerLoadBasedAutoScalingDownscaling() {}
    ...
    public static Builder builder(NodejsAppLayerLoadBasedAutoScalingDownscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(NodejsAppLayerLoadBasedAutoScalingDownscaling defaults) {
        ...
        public NodejsAppLayerLoadBasedAutoScalingDownscaling build() {
            final var _resultValue = new NodejsAppLayerLoadBasedAutoScalingDownscaling();
