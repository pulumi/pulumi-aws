...
public final class FleetLaunchTemplateConfigOverrideInstanceRequirements {
     ...
     * 
     */
    private final @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount acceleratorCount;
    /**
     ...
     * 
     */
    private final @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib acceleratorTotalMemoryMib;
    /**
     ...
     * 
     */
    private final @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps baselineEbsBandwidthMbps;
    /**
     ...
     * 
     */
    private final @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu memoryGibPerVcpu;
    /**
     * @return Block describing the minimum and maximum amount of memory (MiB). Default is no maximum.
     * 
     */
    private final FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryMib memoryMib;
    /**
     * @return Block describing the minimum and maximum number of network interfaces. Default is no minimum or maximum.
     * 
     */
    private final @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount networkInterfaceCount;
    /**
     ...
     * 
     */
    private final @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb totalLocalStorageGb;
    /**
     * @return Block describing the minimum and maximum number of vCPUs. Default is no maximum.
     * 
     */
    private final FleetLaunchTemplateConfigOverrideInstanceRequirementsVcpuCount vcpuCount;

    @CustomType.Constructor
    private FleetLaunchTemplateConfigOverrideInstanceRequirements(
        @CustomType.Parameter("acceleratorCount") @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount acceleratorCount,
        ...
        @CustomType.Parameter("acceleratorTotalMemoryMib") @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorTotalMemoryMib acceleratorTotalMemoryMib,
        ...
        @CustomType.Parameter("baselineEbsBandwidthMbps") @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsBaselineEbsBandwidthMbps baselineEbsBandwidthMbps,
        ...
        @CustomType.Parameter("memoryGibPerVcpu") @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryGibPerVcpu memoryGibPerVcpu,
        @CustomType.Parameter("memoryMib") FleetLaunchTemplateConfigOverrideInstanceRequirementsMemoryMib memoryMib,
        @CustomType.Parameter("networkInterfaceCount") @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsNetworkInterfaceCount networkInterfaceCount,
        ...
        @CustomType.Parameter("totalLocalStorageGb") @Nullable FleetLaunchTemplateConfigOverrideInstanceRequirementsTotalLocalStorageGb totalLocalStorageGb,
        @CustomType.Parameter("vcpuCount") FleetLaunchTemplateConfigOverrideInstanceRequirementsVcpuCount vcpuCount) {
