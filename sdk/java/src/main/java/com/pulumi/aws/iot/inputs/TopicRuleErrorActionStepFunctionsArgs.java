...
public final class TopicRuleErrorActionStepFunctionsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TopicRuleErrorActionStepFunctionsArgs build() {
            if ($.roleArn == null) {
                throw new MissingRequiredPropertyException("TopicRuleErrorActionStepFunctionsArgs", "roleArn");
            }
            if ($.stateMachineName == null) {
                throw new MissingRequiredPropertyException("TopicRuleErrorActionStepFunctionsArgs", "stateMachineName");
            }
            return $;
        }
    }
