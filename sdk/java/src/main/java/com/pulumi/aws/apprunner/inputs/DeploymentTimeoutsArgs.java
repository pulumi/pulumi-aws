...
public final class DeploymentTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeploymentTimeoutsArgs Empty = new DeploymentTimeoutsArgs();
    ...
    private DeploymentTimeoutsArgs() {}

    private DeploymentTimeoutsArgs(DeploymentTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(DeploymentTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentTimeoutsArgs();
        }

        public Builder(DeploymentTimeoutsArgs defaults) {
            $ = new DeploymentTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeploymentTimeoutsArgs build() {
            return $;
        }
    }
