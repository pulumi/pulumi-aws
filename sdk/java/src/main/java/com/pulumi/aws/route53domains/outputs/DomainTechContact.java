...
import com.pulumi.aws.route53domains.outputs.DomainTechContactExtraParam;
...
public final class DomainTechContact {
     ...
     * 
     */
    private @Nullable List<DomainTechContactExtraParam> extraParams;
    /**
    ...
    public List<DomainTechContactExtraParam> extraParams() {
        return this.extraParams == null ? List.of() : this.extraParams;
    }
    /**
     * @return Fax number of the contact. Phone number must be specified in the format &#34;+[country dialing code].[number including any area code]&#34;.
     * 
    ...
    public static Builder builder(DomainTechContact defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String zipCode;
        public Builder() {}
        public Builder(DomainTechContact defaults) {
        ...
        @CustomType.Setter
        public Builder extraParams(@Nullable List<DomainTechContactExtraParam> extraParams) {

            this.extraParams = extraParams;
            return this;
        }
        public Builder extraParams(DomainTechContactExtraParam... extraParams) {
        ...
        public DomainTechContact build() {
            final var _resultValue = new DomainTechContact();
