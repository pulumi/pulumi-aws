...
public final class V2ServiceState extends com.pulumi.resources.ResourceArgs {

    public static final V2ServiceState Empty = new V2ServiceState();
    ...
    private @Nullable Output<V2ServicePermissionModelArgs> permissionModel;

    /**
     * @return Permission model for resource discovery. See `permissionModel` Block below.
     * 
     */
    public Optional<Output<V2ServicePermissionModelArgs>> permissionModel() {
    ...
    private V2ServiceState() {}

    private V2ServiceState(V2ServiceState $) {
        this.arn = $.arn;
    ...
    public static Builder builder(V2ServiceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(V2ServiceState defaults) {
            $ = new V2ServiceState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder permissionModel(@Nullable Output<V2ServicePermissionModelArgs> permissionModel) {
