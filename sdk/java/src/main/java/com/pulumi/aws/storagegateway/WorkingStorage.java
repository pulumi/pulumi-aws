...
public class WorkingStorage extends com.pulumi.resources.CustomResource {
     ...
     */
    public WorkingStorage(java.lang.String name) {
     ...
     */
    public WorkingStorage(java.lang.String name, WorkingStorageArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WorkingStorage(java.lang.String name, WorkingStorageArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:storagegateway/workingStorage:WorkingStorage", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WorkingStorage(java.lang.String name, Output<java.lang.String> id, @Nullable WorkingStorageState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:storagegateway/workingStorage:WorkingStorage", name, state, makeResourceOptions(options, id), false);
    }

    private static WorkingStorageArgs makeArgs(WorkingStorageArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WorkingStorageArgs.Empty : args;
    }
     ...
     */
    public static WorkingStorage get(java.lang.String name, Output<java.lang.String> id, @Nullable WorkingStorageState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
