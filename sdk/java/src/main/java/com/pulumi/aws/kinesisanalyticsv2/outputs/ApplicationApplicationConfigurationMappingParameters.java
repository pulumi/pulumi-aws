...
@CustomType
public final class ApplicationApplicationConfigurationMappingParameters {
    /**
    ...
    private ApplicationApplicationConfigurationMappingParameters() {}
    /**
     * @return Provides additional mapping information when the record format uses delimiters (for example, CSV).
     * 
     */
    ...
    public static Builder builder(ApplicationApplicationConfigurationMappingParameters defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable ApplicationApplicationConfigurationJsonMappingParameters jsonMappingParameters;
        public Builder() {}
        public Builder(ApplicationApplicationConfigurationMappingParameters defaults) {
        ...
        public ApplicationApplicationConfigurationMappingParameters build() {
            final var _resultValue = new ApplicationApplicationConfigurationMappingParameters();
