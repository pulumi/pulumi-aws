...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyMatchPatternArgs;
...
public final class WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs Empty = new WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs();
    ...
    private @Nullable Output<WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;

    /**
     * @return JSON content to inspect. See JSON Body Match Pattern below.
     * 
     */
    public Optional<Output<WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyMatchPatternArgs>> matchPattern() {
    ...
    private WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs() {}

    private WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs(WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs();
        }

        public Builder(WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs defaults) {
            $ = new WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(@Nullable Output<WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs build() {
            if ($.matchScope == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyArgs", "matchScope");
            }
            return $;
        }
    }
