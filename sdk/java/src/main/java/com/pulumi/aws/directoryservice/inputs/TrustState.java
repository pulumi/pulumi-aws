...
public final class TrustState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param stateLastUpdatedDateTime Date and time when the Trust state in `trustState` was last updated.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param trustStateReason Reason for the Trust state set in `trustState`.
         * 
         * @return builder
         * 
         */
