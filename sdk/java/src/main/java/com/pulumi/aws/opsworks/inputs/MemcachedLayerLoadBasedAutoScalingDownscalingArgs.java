...
public final class MemcachedLayerLoadBasedAutoScalingDownscalingArgs extends com.pulumi.resources.ResourceArgs {

    public static final MemcachedLayerLoadBasedAutoScalingDownscalingArgs Empty = new MemcachedLayerLoadBasedAutoScalingDownscalingArgs();
    ...
    private MemcachedLayerLoadBasedAutoScalingDownscalingArgs() {}

    private MemcachedLayerLoadBasedAutoScalingDownscalingArgs(MemcachedLayerLoadBasedAutoScalingDownscalingArgs $) {
        this.alarms = $.alarms;
    ...
    public static Builder builder(MemcachedLayerLoadBasedAutoScalingDownscalingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MemcachedLayerLoadBasedAutoScalingDownscalingArgs();
        }

        public Builder(MemcachedLayerLoadBasedAutoScalingDownscalingArgs defaults) {
            $ = new MemcachedLayerLoadBasedAutoScalingDownscalingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MemcachedLayerLoadBasedAutoScalingDownscalingArgs build() {
            return $;
        }
    }
