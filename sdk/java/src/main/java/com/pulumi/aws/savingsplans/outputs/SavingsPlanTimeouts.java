...
@CustomType
public final class SavingsPlanTimeouts {
    /**
    ...
    public static Builder builder(SavingsPlanTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(SavingsPlanTimeouts defaults) {
        ...
        public SavingsPlanTimeouts build() {
            final var _resultValue = new SavingsPlanTimeouts();
