...
import com.pulumi.aws.quicksight.inputs.VisualsHeatMapVisualChartConfigurationArgs;
...
public final class VisualsHeatMapVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsHeatMapVisualArgs Empty = new VisualsHeatMapVisualArgs();
    ...
    private @Nullable Output<VisualsHeatMapVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsHeatMapVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsHeatMapVisualArgs() {}

    private VisualsHeatMapVisualArgs(VisualsHeatMapVisualArgs $) {
    ...
    public static Builder builder(VisualsHeatMapVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsHeatMapVisualArgs();
        }

        public Builder(VisualsHeatMapVisualArgs defaults) {
            $ = new VisualsHeatMapVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsHeatMapVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsHeatMapVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsHeatMapVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsHeatMapVisualArgs", "visualId");
            }
            return $;
        }
    }
