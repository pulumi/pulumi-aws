...
public final class DbInstanceTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final DbInstanceTimeoutsArgs Empty = new DbInstanceTimeoutsArgs();
    ...
    private DbInstanceTimeoutsArgs() {}

    private DbInstanceTimeoutsArgs(DbInstanceTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(DbInstanceTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DbInstanceTimeoutsArgs();
        }

        public Builder(DbInstanceTimeoutsArgs defaults) {
            $ = new DbInstanceTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DbInstanceTimeoutsArgs build() {
            return $;
        }
    }
