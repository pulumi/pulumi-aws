...
public final class PrivateVirtualInterfaceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PrivateVirtualInterfaceArgs(PrivateVirtualInterfaceArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PrivateVirtualInterfaceArgs();
        }

        public Builder(PrivateVirtualInterfaceArgs defaults) {
            $ = new PrivateVirtualInterfaceArgs(Objects.requireNonNull(defaults));
        }
