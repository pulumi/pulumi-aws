...
public final class ManagedPolicyAttachmentsExclusiveTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ManagedPolicyAttachmentsExclusiveTimeoutsArgs Empty = new ManagedPolicyAttachmentsExclusiveTimeoutsArgs();
    ...
    private ManagedPolicyAttachmentsExclusiveTimeoutsArgs() {}

    private ManagedPolicyAttachmentsExclusiveTimeoutsArgs(ManagedPolicyAttachmentsExclusiveTimeoutsArgs $) {
        this.create = $.create;
        this.update = $.update;
    }
    ...
    public static Builder builder(ManagedPolicyAttachmentsExclusiveTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedPolicyAttachmentsExclusiveTimeoutsArgs();
        }

        public Builder(ManagedPolicyAttachmentsExclusiveTimeoutsArgs defaults) {
            $ = new ManagedPolicyAttachmentsExclusiveTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ManagedPolicyAttachmentsExclusiveTimeoutsArgs build() {
            return $;
        }
    }
