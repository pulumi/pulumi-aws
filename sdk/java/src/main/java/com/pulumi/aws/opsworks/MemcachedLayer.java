...
public class MemcachedLayer extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="allocatedMemory", refs={Integer.class}, tree="[0]")
     ...
     * 
     */
    public Output<Optional<Integer>> allocatedMemory() {
        return Codegen.optional(this.allocatedMemory);
    }
    /**
    ...
    @Export(name="cloudwatchConfiguration", refs={MemcachedLayerCloudwatchConfiguration.class}, tree="[0]")
    private Output</* @Nullable */ MemcachedLayerCloudwatchConfiguration> cloudwatchConfiguration;

    public Output<Optional<MemcachedLayerCloudwatchConfiguration>> cloudwatchConfiguration() {
    ...
    public MemcachedLayer(String name, MemcachedLayerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:opsworks/memcachedLayer:MemcachedLayer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
