...
public final class GetTagsFilterNotCostCategory extends com.pulumi.resources.InvokeArgs {

    public static final GetTagsFilterNotCostCategory Empty = new GetTagsFilterNotCostCategory();
    ...
    private GetTagsFilterNotCostCategory() {}

    private GetTagsFilterNotCostCategory(GetTagsFilterNotCostCategory $) {
        this.key = $.key;
    ...
    public static Builder builder(GetTagsFilterNotCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagsFilterNotCostCategory();
        }

        public Builder(GetTagsFilterNotCostCategory defaults) {
            $ = new GetTagsFilterNotCostCategory(Objects.requireNonNull(defaults));
        }
        ...
        public GetTagsFilterNotCostCategory build() {
            return $;
        }
    }
