...
@CustomType
public final class DbClusterTimeouts {
    /**
    ...
    public static Builder builder(DbClusterTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(DbClusterTimeouts defaults) {
        ...
        public DbClusterTimeouts build() {
            final var _resultValue = new DbClusterTimeouts();
