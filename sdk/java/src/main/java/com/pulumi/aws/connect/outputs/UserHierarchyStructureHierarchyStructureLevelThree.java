...
public final class UserHierarchyStructureHierarchyStructureLevelThree {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("UserHierarchyStructureHierarchyStructureLevelThree", "name");
            }
            this.name = name;
            return this;
        }
        public UserHierarchyStructureHierarchyStructureLevelThree build() {
            final var _resultValue = new UserHierarchyStructureHierarchyStructureLevelThree();
