...
public final class SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount {
    ...
    public static Builder builder(SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount defaults) {
        ...
        public Builder min(@Nullable Integer min) {
            ...
            return new SpotFleetRequestLaunchTemplateConfigOverrideInstanceRequirementsAcceleratorCount(max, min);
        }
    }
}
