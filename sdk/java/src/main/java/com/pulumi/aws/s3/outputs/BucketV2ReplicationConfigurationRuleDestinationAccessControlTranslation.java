...
public final class BucketV2ReplicationConfigurationRuleDestinationAccessControlTranslation {
    /**
     * @return Replica ownership. For default and valid values, see [PUT bucket replication](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketReplication.html) in the Amazon S3 API Reference. The only valid value is `Destination`.
     * 
     */
