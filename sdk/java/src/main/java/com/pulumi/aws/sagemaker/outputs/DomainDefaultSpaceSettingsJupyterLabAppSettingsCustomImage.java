...
public final class DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage {
    ...
    public static Builder builder(DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer imageVersionNumber;
        public Builder() {}
        public Builder(DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage defaults) {
        ...
        public Builder appImageConfigName(String appImageConfigName) {
            if (appImageConfigName == null) {
              throw new MissingRequiredPropertyException("DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage", "appImageConfigName");
            }
        ...
        public Builder imageName(String imageName) {
            if (imageName == null) {
              throw new MissingRequiredPropertyException("DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage", "imageName");
            }
        ...
        public DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage build() {
            final var _resultValue = new DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage();
