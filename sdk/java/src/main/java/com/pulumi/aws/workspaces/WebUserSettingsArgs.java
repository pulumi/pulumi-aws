...
public final class WebUserSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebUserSettingsArgs Empty = new WebUserSettingsArgs();
    ...
    private WebUserSettingsArgs() {}

    private WebUserSettingsArgs(WebUserSettingsArgs $) {
    ...
    public static Builder builder(WebUserSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebUserSettingsArgs();
        }

        public Builder(WebUserSettingsArgs defaults) {
            $ = new WebUserSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebUserSettingsArgs build() {
            if ($.copyAllowed == null) {
                throw new MissingRequiredPropertyException("WebUserSettingsArgs", "copyAllowed");
            }
            if ($.downloadAllowed == null) {
                throw new MissingRequiredPropertyException("WebUserSettingsArgs", "downloadAllowed");
            }
            if ($.pasteAllowed == null) {
                throw new MissingRequiredPropertyException("WebUserSettingsArgs", "pasteAllowed");
            }
            if ($.printAllowed == null) {
                throw new MissingRequiredPropertyException("WebUserSettingsArgs", "printAllowed");
            }
            if ($.uploadAllowed == null) {
                throw new MissingRequiredPropertyException("WebUserSettingsArgs", "uploadAllowed");
            }
            return $;
        }
    }
