...
public final class GetWindowsFileSystemResult {
    /**
     * @return ID for Microsoft Active Directory instance that the file system is joined to.
     * 
     */
    private String activeDirectoryId;
    /**
     * @return Set of DNS alias names associated with the Amazon FSx file system.
     * 
     */
    ...
    private String arn;
    /**
     * @return Configuration that Amazon FSx for Windows File Server uses to audit and log user accesses of files, folders, and file shares on the Amazon FSx for Windows File Server file system.
     * 
     */
    ...
    /**
     * @return Identifier of the source backup used to create the file system.
     * 
     */
    private String backupId;
    /**
     * @return Whether tags on the file system are copied to backups.
     * 
     */
    ...
    /**
     * @return SSD IOPS configuration for the file system.
     * 
     */
    ...
    /**
     * @return Set of network interface identifiers for the file system.
     * 
     */
    ...
    /**
     * @return Subnet in which the preferred file server is located.
     * 
     */
    private String preferredSubnetId;
    private String region;
    /**
     * @return Set of security group identifiers associated with the file system.
     * 
     */
    private List<String> securityGroupIds;
    /**
     * @return Whether a final backup is skipped when the file system is deleted.
     * 
     */
    ...
    /**
     * @return IDs of the subnets that the file system is accessible from.
     * 
     */
