...
@CustomType
public final class FilesAccessPointTimeouts {
    /**
    ...
    public static Builder builder(FilesAccessPointTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(FilesAccessPointTimeouts defaults) {
        ...
        public FilesAccessPointTimeouts build() {
            final var _resultValue = new FilesAccessPointTimeouts();
