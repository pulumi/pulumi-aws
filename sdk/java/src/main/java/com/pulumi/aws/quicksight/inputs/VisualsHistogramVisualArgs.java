...
import com.pulumi.aws.quicksight.inputs.VisualsHistogramVisualChartConfigurationArgs;
...
public final class VisualsHistogramVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsHistogramVisualArgs Empty = new VisualsHistogramVisualArgs();
    ...
    private @Nullable Output<VisualsHistogramVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsHistogramVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsHistogramVisualArgs() {}

    private VisualsHistogramVisualArgs(VisualsHistogramVisualArgs $) {
    ...
    public static Builder builder(VisualsHistogramVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsHistogramVisualArgs();
        }

        public Builder(VisualsHistogramVisualArgs defaults) {
            $ = new VisualsHistogramVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsHistogramVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsHistogramVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsHistogramVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsHistogramVisualArgs", "visualId");
            }
            return $;
        }
    }
