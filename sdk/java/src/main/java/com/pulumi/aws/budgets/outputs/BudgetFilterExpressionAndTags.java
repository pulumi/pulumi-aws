...
@CustomType
public final class BudgetFilterExpressionAndTags {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionAndTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionAndTags defaults) {
        ...
        public BudgetFilterExpressionAndTags build() {
            final var _resultValue = new BudgetFilterExpressionAndTags();
