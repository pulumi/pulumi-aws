...
@CustomType
public final class CostCategoryRuleRuleOrCostCategory {
    /**
    ...
    private CostCategoryRuleRuleOrCostCategory(
    ...
    public static Builder builder(CostCategoryRuleRuleOrCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CostCategoryRuleRuleOrCostCategory defaults) {
        ...
        }        public CostCategoryRuleRuleOrCostCategory build() {
            return new CostCategoryRuleRuleOrCostCategory(key, matchOptions, values);
        }
    }
}
