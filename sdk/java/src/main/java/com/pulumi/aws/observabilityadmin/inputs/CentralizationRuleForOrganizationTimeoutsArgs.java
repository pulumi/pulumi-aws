...
public final class CentralizationRuleForOrganizationTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CentralizationRuleForOrganizationTimeoutsArgs Empty = new CentralizationRuleForOrganizationTimeoutsArgs();
    ...
    private CentralizationRuleForOrganizationTimeoutsArgs() {}

    private CentralizationRuleForOrganizationTimeoutsArgs(CentralizationRuleForOrganizationTimeoutsArgs $) {
        this.create = $.create;
        this.update = $.update;
    }
    ...
    public static Builder builder(CentralizationRuleForOrganizationTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CentralizationRuleForOrganizationTimeoutsArgs();
        }

        public Builder(CentralizationRuleForOrganizationTimeoutsArgs defaults) {
            $ = new CentralizationRuleForOrganizationTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CentralizationRuleForOrganizationTimeoutsArgs build() {
            return $;
        }
    }
