...
public final class V2modelsIntentConfirmationSettingConfirmationResponseMessageGroup {
     ...
     * 
     */
    private @Nullable V2modelsIntentConfirmationSettingConfirmationResponseMessageGroupMessage message;
    /**
     ...
     * 
     */
    public Optional<V2modelsIntentConfirmationSettingConfirmationResponseMessageGroupMessage> message() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder message(@Nullable V2modelsIntentConfirmationSettingConfirmationResponseMessageGroupMessage message) {
