...
public final class GetInfrastructureConfigurationsFilter extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param name Name of the filter field. Valid values can be found in the [Image Builder ListInfrastructureConfigurations API Reference](https://docs.aws.amazon.com/imagebuilder/latest/APIReference/API_ListInfrastructureConfigurations.html).
         * 
         * @return builder
         * 
         */
        ...
        public GetInfrastructureConfigurationsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetInfrastructureConfigurationsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetInfrastructureConfigurationsFilter", "values");
            }
            return $;
        }
    }
