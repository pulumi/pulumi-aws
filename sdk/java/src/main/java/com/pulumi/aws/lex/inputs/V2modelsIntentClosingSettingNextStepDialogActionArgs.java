...
public final class V2modelsIntentClosingSettingNextStepDialogActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentClosingSettingNextStepDialogActionArgs Empty = new V2modelsIntentClosingSettingNextStepDialogActionArgs();
    ...
    private V2modelsIntentClosingSettingNextStepDialogActionArgs() {}

    private V2modelsIntentClosingSettingNextStepDialogActionArgs(V2modelsIntentClosingSettingNextStepDialogActionArgs $) {
    ...
    public static Builder builder(V2modelsIntentClosingSettingNextStepDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentClosingSettingNextStepDialogActionArgs();
        }

        public Builder(V2modelsIntentClosingSettingNextStepDialogActionArgs defaults) {
            $ = new V2modelsIntentClosingSettingNextStepDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentClosingSettingNextStepDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentClosingSettingNextStepDialogActionArgs", "type");
            }
            return $;
        }
    }
