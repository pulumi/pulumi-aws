...
public final class IntegrationTimeouts {
    ...
    public static Builder builder(IntegrationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(IntegrationTimeouts defaults) {
        ...
        public IntegrationTimeouts build() {
            final var _resultValue = new IntegrationTimeouts();
