...
public final class QueryLoggingConfigurationState extends com.pulumi.resources.ResourceArgs {
    ...
    private QueryLoggingConfigurationState() {}

    private QueryLoggingConfigurationState(QueryLoggingConfigurationState $) {
    ...
    public static Builder builder(QueryLoggingConfigurationState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new QueryLoggingConfigurationState();
        }

        public Builder(QueryLoggingConfigurationState defaults) {
        ...
        public QueryLoggingConfigurationState build() {
            return $;
        }
    }
