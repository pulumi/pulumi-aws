...
public class DelegationSignerRecord extends com.pulumi.resources.CustomResource {
     ...
     */
    public DelegationSignerRecord(java.lang.String name) {
     ...
     */
    public DelegationSignerRecord(java.lang.String name, DelegationSignerRecordArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DelegationSignerRecord(java.lang.String name, DelegationSignerRecordArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:route53domains/delegationSignerRecord:DelegationSignerRecord", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DelegationSignerRecord(java.lang.String name, Output<java.lang.String> id, @Nullable DelegationSignerRecordState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:route53domains/delegationSignerRecord:DelegationSignerRecord", name, state, makeResourceOptions(options, id), false);
    }

    private static DelegationSignerRecordArgs makeArgs(DelegationSignerRecordArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DelegationSignerRecordArgs.Empty : args;
    }
     ...
     */
    public static DelegationSignerRecord get(java.lang.String name, Output<java.lang.String> id, @Nullable DelegationSignerRecordState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
