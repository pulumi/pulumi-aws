...
public final class GetVirtualNodeSpecListenerTimeoutTcpIdle {
    ...
    public static final class Builder {
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("GetVirtualNodeSpecListenerTimeoutTcpIdle", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder value(Integer value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetVirtualNodeSpecListenerTimeoutTcpIdle", "value");
            }
            this.value = value;
            return this;
        }
        public GetVirtualNodeSpecListenerTimeoutTcpIdle build() {
            final var _resultValue = new GetVirtualNodeSpecListenerTimeoutTcpIdle();
