...
public final class MeasureFieldSchemaNumericalMeasureFieldArgs extends com.pulumi.resources.ResourceArgs {

    public static final MeasureFieldSchemaNumericalMeasureFieldArgs Empty = new MeasureFieldSchemaNumericalMeasureFieldArgs();
    ...
    private MeasureFieldSchemaNumericalMeasureFieldArgs() {}

    private MeasureFieldSchemaNumericalMeasureFieldArgs(MeasureFieldSchemaNumericalMeasureFieldArgs $) {
    ...
    public static Builder builder(MeasureFieldSchemaNumericalMeasureFieldArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MeasureFieldSchemaNumericalMeasureFieldArgs();
        }

        public Builder(MeasureFieldSchemaNumericalMeasureFieldArgs defaults) {
            $ = new MeasureFieldSchemaNumericalMeasureFieldArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MeasureFieldSchemaNumericalMeasureFieldArgs build() {
            if ($.column == null) {
                throw new MissingRequiredPropertyException("MeasureFieldSchemaNumericalMeasureFieldArgs", "column");
            }
            if ($.fieldId == null) {
                throw new MissingRequiredPropertyException("MeasureFieldSchemaNumericalMeasureFieldArgs", "fieldId");
            }
            return $;
        }
    }
