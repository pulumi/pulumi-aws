...
public final class CostCategoryRuleRuleAndNotTags {
    ...
    public static Builder builder(CostCategoryRuleRuleAndNotTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleAndNotTags defaults) {
        ...
        public CostCategoryRuleRuleAndNotTags build() {
            final var _resultValue = new CostCategoryRuleRuleAndNotTags();
