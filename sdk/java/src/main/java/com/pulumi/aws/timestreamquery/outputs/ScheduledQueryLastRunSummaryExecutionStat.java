...
public final class ScheduledQueryLastRunSummaryExecutionStat {
    ...
    public static Builder builder(ScheduledQueryLastRunSummaryExecutionStat defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer recordsIngested;
        public Builder() {}
        public Builder(ScheduledQueryLastRunSummaryExecutionStat defaults) {
        ...
        public ScheduledQueryLastRunSummaryExecutionStat build() {
            final var _resultValue = new ScheduledQueryLastRunSummaryExecutionStat();
