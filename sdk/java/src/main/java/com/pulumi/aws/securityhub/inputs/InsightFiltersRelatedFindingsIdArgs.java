...
public final class InsightFiltersRelatedFindingsIdArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public InsightFiltersRelatedFindingsIdArgs build() {
            if ($.comparison == null) {
                throw new MissingRequiredPropertyException("InsightFiltersRelatedFindingsIdArgs", "comparison");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("InsightFiltersRelatedFindingsIdArgs", "value");
            }
            return $;
        }
    }
