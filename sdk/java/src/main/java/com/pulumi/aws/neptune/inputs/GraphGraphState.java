...
public final class GraphGraphState extends com.pulumi.resources.ResourceArgs {

    public static final GraphGraphState Empty = new GraphGraphState();
    ...
    private GraphGraphState() {}

    private GraphGraphState(GraphGraphState $) {
        this.arn = $.arn;
    ...
    public static Builder builder(GraphGraphState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GraphGraphState defaults) {
            $ = new GraphGraphState(Objects.requireNonNull(defaults));
        }
