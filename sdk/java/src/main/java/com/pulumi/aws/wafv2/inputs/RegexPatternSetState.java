...
public final class RegexPatternSetState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return A friendly name of the regular expression pattern set. If omitted, the provider will assign a random, unique name. Conflicts with `namePrefix`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param name A friendly name of the regular expression pattern set. If omitted, the provider will assign a random, unique name. Conflicts with `namePrefix`.
         * 
         * @return builder
         * 
         */
