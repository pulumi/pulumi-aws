...
public final class ConfigurationSetVdmOptionsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Additional settings for your VDM configuration as applicable to the Dashboard. See `dashboardOptions` Block for details.
     * 
     */
    ...
    /**
     * @return Additional settings for your VDM configuration as applicable to the Guardian. See `guardianOptions` Block for details.
     * 
     */
