...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternAll;
...
@CustomType
public final class RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern {
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    private @Nullable RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternAll all;
    /**
    ...
    private RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern() {}
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    public Optional<RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternAll> all() {
    ...
    public static Builder builder(RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedHeaders;
        public Builder() {}
        public Builder(RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern defaults) {
        ...
        @CustomType.Setter
        public Builder all(@Nullable RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternAll all) {
        ...
        public RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern build() {
            final var _resultValue = new RuleGroupRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern();
