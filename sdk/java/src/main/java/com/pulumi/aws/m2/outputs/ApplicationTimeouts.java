...
@CustomType
public final class ApplicationTimeouts {
    /**
    ...
    public static Builder builder(ApplicationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ApplicationTimeouts defaults) {
        ...
        public ApplicationTimeouts build() {
            final var _resultValue = new ApplicationTimeouts();
