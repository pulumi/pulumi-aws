...
public final class GetVpcIamPoolCidrsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetVpcIamPoolCidrsFilterArgs Empty = new GetVpcIamPoolCidrsFilterArgs();
    ...
    private GetVpcIamPoolCidrsFilterArgs() {}

    private GetVpcIamPoolCidrsFilterArgs(GetVpcIamPoolCidrsFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetVpcIamPoolCidrsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVpcIamPoolCidrsFilterArgs();
        }

        public Builder(GetVpcIamPoolCidrsFilterArgs defaults) {
            $ = new GetVpcIamPoolCidrsFilterArgs(Objects.requireNonNull(defaults));
        }
