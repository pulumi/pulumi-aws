...
@CustomType
public final class OtelEnrichmentTimeouts {
    /**
    ...
    public static Builder builder(OtelEnrichmentTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(OtelEnrichmentTimeouts defaults) {
        ...
        public OtelEnrichmentTimeouts build() {
            final var _resultValue = new OtelEnrichmentTimeouts();
