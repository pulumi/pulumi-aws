...
public final class DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs Empty = new DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs();
    ...
    private DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs(DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs $) {
    ...
    public static Builder builder(DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs();
        }

        public Builder(DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs defaults) {
            $ = new DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardDefinitionSheetParameterControlDropdownDisplayOptionsArgs build() {
            return $;
        }
    }
