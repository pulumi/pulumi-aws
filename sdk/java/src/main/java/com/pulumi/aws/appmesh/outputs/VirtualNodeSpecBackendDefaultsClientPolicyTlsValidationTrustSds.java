...
public final class VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustSds {
    ...
    private VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustSds() {}
    /**
     * @return Name of the secret for a virtual node&#39;s Transport Layer Security (TLS) Secret Discovery Service validation context trust.
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder secretName(String secretName) {
            if (secretName == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustSds", "secretName");
            }
            this.secretName = secretName;
            return this;
        }
        public VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustSds build() {
            final var _resultValue = new VirtualNodeSpecBackendDefaultsClientPolicyTlsValidationTrustSds();
