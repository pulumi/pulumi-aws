...
public final class ApiEventConfigAuthProviderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Configuration for Cognito user pool authentication. Required when `authType` is `AMAZON_COGNITO_USER_POOLS`. See `cognitoConfig` Block below.
     * 
     */
    ...
    /**
     * @return Configuration for Lambda authorization. Required when `authType` is `AWS_LAMBDA`. See `lambdaAuthorizerConfig` Block below.
     * 
     */
    ...
    /**
     * @return Configuration for OpenID Connect. Required when `authType` is `OPENID_CONNECT`. See `openidConnectConfig` Block below.
     * 
     */
