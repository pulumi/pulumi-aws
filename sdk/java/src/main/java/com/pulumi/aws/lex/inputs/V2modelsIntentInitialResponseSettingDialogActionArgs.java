...
public final class V2modelsIntentInitialResponseSettingDialogActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentInitialResponseSettingDialogActionArgs Empty = new V2modelsIntentInitialResponseSettingDialogActionArgs();
    ...
    private V2modelsIntentInitialResponseSettingDialogActionArgs() {}

    private V2modelsIntentInitialResponseSettingDialogActionArgs(V2modelsIntentInitialResponseSettingDialogActionArgs $) {
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentInitialResponseSettingDialogActionArgs();
        }

        public Builder(V2modelsIntentInitialResponseSettingDialogActionArgs defaults) {
            $ = new V2modelsIntentInitialResponseSettingDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentInitialResponseSettingDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingDialogActionArgs", "type");
            }
            return $;
        }
    }
