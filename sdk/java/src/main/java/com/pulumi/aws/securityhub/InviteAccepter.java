...
public class InviteAccepter extends com.pulumi.resources.CustomResource {
    ...
    public InviteAccepter(java.lang.String name, InviteAccepterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:securityhub/inviteAccepter:InviteAccepter", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private InviteAccepter(java.lang.String name, Output<java.lang.String> id, @Nullable InviteAccepterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:securityhub/inviteAccepter:InviteAccepter", name, state, makeResourceOptions(options, id), false);
    }
