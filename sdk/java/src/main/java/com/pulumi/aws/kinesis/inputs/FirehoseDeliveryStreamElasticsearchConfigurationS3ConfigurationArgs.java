...
public final class FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationArgs build() {
            if ($.bucketArn == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationArgs", "bucketArn");
            }
            if ($.roleArn == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamElasticsearchConfigurationS3ConfigurationArgs", "roleArn");
            }
            return $;
        }
    }
