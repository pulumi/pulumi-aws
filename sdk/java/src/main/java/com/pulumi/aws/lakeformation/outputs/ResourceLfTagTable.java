...
public final class ResourceLfTagTable {
    ...
    public static Builder builder(ResourceLfTagTable defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean wildcard;
        public Builder() {}
        public Builder(ResourceLfTagTable defaults) {
        ...
        public Builder databaseName(String databaseName) {
            if (databaseName == null) {
              throw new MissingRequiredPropertyException("ResourceLfTagTable", "databaseName");
            }
        ...
        public ResourceLfTagTable build() {
            final var _resultValue = new ResourceLfTagTable();
