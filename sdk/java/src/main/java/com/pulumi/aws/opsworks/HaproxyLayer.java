...
public class HaproxyLayer extends com.pulumi.resources.CustomResource {
     ...
     */
    public HaproxyLayer(String name, @Nullable HaproxyLayerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HaproxyLayer(String name, @Nullable HaproxyLayerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
