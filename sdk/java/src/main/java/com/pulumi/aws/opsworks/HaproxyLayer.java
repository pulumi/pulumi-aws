...
public class HaproxyLayer extends com.pulumi.resources.CustomResource {
     ...
     */
    public HaproxyLayer(java.lang.String name) {
     ...
     */
    public HaproxyLayer(java.lang.String name, HaproxyLayerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HaproxyLayer(java.lang.String name, HaproxyLayerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:opsworks/haproxyLayer:HaproxyLayer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HaproxyLayer(java.lang.String name, Output<java.lang.String> id, @Nullable HaproxyLayerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:opsworks/haproxyLayer:HaproxyLayer", name, state, makeResourceOptions(options, id), false);
    }

    private static HaproxyLayerArgs makeArgs(HaproxyLayerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? HaproxyLayerArgs.Empty : args;
    }
     ...
     */
    public static HaproxyLayer get(java.lang.String name, Output<java.lang.String> id, @Nullable HaproxyLayerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
