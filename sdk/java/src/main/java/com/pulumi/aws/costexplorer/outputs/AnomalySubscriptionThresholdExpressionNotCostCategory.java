...
public final class AnomalySubscriptionThresholdExpressionNotCostCategory {
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionNotCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionNotCostCategory defaults) {
        ...
        public AnomalySubscriptionThresholdExpressionNotCostCategory build() {
            final var _resultValue = new AnomalySubscriptionThresholdExpressionNotCostCategory();
