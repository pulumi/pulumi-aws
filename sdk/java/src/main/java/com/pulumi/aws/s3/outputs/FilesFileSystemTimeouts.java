...
@CustomType
public final class FilesFileSystemTimeouts {
    /**
    ...
    public static Builder builder(FilesFileSystemTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(FilesFileSystemTimeouts defaults) {
        ...
        public FilesFileSystemTimeouts build() {
            final var _resultValue = new FilesFileSystemTimeouts();
