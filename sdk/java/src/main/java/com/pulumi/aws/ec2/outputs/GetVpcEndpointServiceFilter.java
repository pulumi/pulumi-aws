...
public final class GetVpcEndpointServiceFilter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetVpcEndpointServiceFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetVpcEndpointServiceFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetVpcEndpointServiceFilter build() {
            final var _resultValue = new GetVpcEndpointServiceFilter();
