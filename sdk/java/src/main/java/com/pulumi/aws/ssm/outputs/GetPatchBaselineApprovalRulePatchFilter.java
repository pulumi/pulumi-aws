...
public final class GetPatchBaselineApprovalRulePatchFilter {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetPatchBaselineApprovalRulePatchFilter", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetPatchBaselineApprovalRulePatchFilter", "values");
            }
            this.values = values;
            return this;
        }
