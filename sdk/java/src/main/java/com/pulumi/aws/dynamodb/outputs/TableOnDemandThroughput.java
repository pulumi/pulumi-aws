...
public final class TableOnDemandThroughput {
    ...
    public static Builder builder(TableOnDemandThroughput defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer maxWriteRequestUnits;
        public Builder() {}
        public Builder(TableOnDemandThroughput defaults) {
        ...
        public TableOnDemandThroughput build() {
            final var _resultValue = new TableOnDemandThroughput();
