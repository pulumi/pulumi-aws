...
public class BucketCorsConfigurationV2 extends com.pulumi.resources.CustomResource {
     ...
     */
    public BucketCorsConfigurationV2(java.lang.String name) {
     ...
     */
    public BucketCorsConfigurationV2(java.lang.String name, BucketCorsConfigurationV2Args args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BucketCorsConfigurationV2(java.lang.String name, BucketCorsConfigurationV2Args args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:s3/bucketCorsConfigurationV2:BucketCorsConfigurationV2", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BucketCorsConfigurationV2(java.lang.String name, Output<java.lang.String> id, @Nullable BucketCorsConfigurationV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:s3/bucketCorsConfigurationV2:BucketCorsConfigurationV2", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static BucketCorsConfigurationV2 get(java.lang.String name, Output<java.lang.String> id, @Nullable BucketCorsConfigurationV2State state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
