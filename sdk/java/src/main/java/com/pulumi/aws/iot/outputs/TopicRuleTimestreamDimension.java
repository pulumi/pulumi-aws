...
public final class TopicRuleTimestreamDimension {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("TopicRuleTimestreamDimension", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("TopicRuleTimestreamDimension", "value");
            }
            this.value = value;
            return this;
        }
        public TopicRuleTimestreamDimension build() {
            final var _resultValue = new TopicRuleTimestreamDimension();
