...
public class IpSet extends com.pulumi.resources.CustomResource {
    ...
    public IpSet(java.lang.String name, @Nullable IpSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:waf/ipSet:IpSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IpSet(java.lang.String name, Output<java.lang.String> id, @Nullable IpSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:waf/ipSet:IpSet", name, state, makeResourceOptions(options, id), false);
    }
