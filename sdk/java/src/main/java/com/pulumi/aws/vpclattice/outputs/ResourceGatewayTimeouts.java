...
public final class ResourceGatewayTimeouts {
    ...
    public static Builder builder(ResourceGatewayTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ResourceGatewayTimeouts defaults) {
        ...
        public ResourceGatewayTimeouts build() {
            final var _resultValue = new ResourceGatewayTimeouts();
