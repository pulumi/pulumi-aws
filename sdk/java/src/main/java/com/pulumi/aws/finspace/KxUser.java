...
public class KxUser extends com.pulumi.resources.CustomResource {
     ...
     */
    public KxUser(java.lang.String name) {
     ...
     */
    public KxUser(java.lang.String name, KxUserArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public KxUser(java.lang.String name, KxUserArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:finspace/kxUser:KxUser", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private KxUser(java.lang.String name, Output<java.lang.String> id, @Nullable KxUserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:finspace/kxUser:KxUser", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static KxUser get(java.lang.String name, Output<java.lang.String> id, @Nullable KxUserState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
