...
public final class WebAclRuleStatementRegexPatternSetReferenceStatementTextTransformation {
    ...
    public static final class Builder {
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementRegexPatternSetReferenceStatementTextTransformation", "priority");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementRegexPatternSetReferenceStatementTextTransformation", "type");
            }
            this.type = type;
            return this;
        }
