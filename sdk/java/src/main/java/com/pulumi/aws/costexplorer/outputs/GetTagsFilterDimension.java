...
@CustomType
public final class GetTagsFilterDimension {
    /**
    ...
    private GetTagsFilterDimension(
    ...
    public static Builder builder(GetTagsFilterDimension defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetTagsFilterDimension defaults) {
        ...
        }        public GetTagsFilterDimension build() {
            return new GetTagsFilterDimension(key, matchOptions, values);
        }
    }
}
