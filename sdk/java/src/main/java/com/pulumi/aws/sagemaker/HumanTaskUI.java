...
public class HumanTaskUI extends com.pulumi.resources.CustomResource {
     ...
     */
    public HumanTaskUI(java.lang.String name, HumanTaskUIArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public HumanTaskUI(java.lang.String name, HumanTaskUIArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:sagemaker/humanTaskUI:HumanTaskUI", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private HumanTaskUI(java.lang.String name, Output<java.lang.String> id, @Nullable HumanTaskUIState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:sagemaker/humanTaskUI:HumanTaskUI", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static HumanTaskUI get(java.lang.String name, Output<java.lang.String> id, @Nullable HumanTaskUIState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
