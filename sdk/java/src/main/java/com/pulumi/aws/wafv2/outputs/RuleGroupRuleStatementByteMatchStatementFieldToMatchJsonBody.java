...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern;
...
public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody {
     ...
     * 
     */
    private RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
    ...
    private RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody() {}
    /**
     * @return What to do when JSON parsing fails. Defaults to evaluating up to the first parsing failure. Valid values are `EVALUATE_AS_STRING`, `MATCH` and `NO_MATCH`.
     * 
     */
    ...
    public static Builder builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
            if (matchPattern == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody", "matchPattern");
            }
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody", "matchScope");
            }
        ...
        public RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody build() {
            final var _resultValue = new RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBody();
