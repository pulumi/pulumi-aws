...
import com.pulumi.aws.kinesis.inputs.FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs;
...
public final class FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs Empty = new FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs();
    ...
    private @Nullable Output<FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs> cloudwatchLoggingOptions;

    /**
     * @return The CloudWatch Logging Options for the delivery stream. See `cloudwatch_logging_options` block below for details.
     * 
     */
    public Optional<Output<FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs>> cloudwatchLoggingOptions() {
    ...
    private FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs() {}

    private FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs(FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs $) {
    ...
    public static Builder builder(FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs();
        }

        public Builder(FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs defaults) {
            $ = new FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudwatchLoggingOptions(@Nullable Output<FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs> cloudwatchLoggingOptions) {
         ...
         * 
         */
        public Builder cloudwatchLoggingOptions(FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs cloudwatchLoggingOptions) {
        ...
        public FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs build() {
            if ($.bucketArn == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs", "bucketArn");
            }
            if ($.roleArn == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamOpensearchserverlessConfigurationS3ConfigurationArgs", "roleArn");
            }
            return $;
        }
    }
