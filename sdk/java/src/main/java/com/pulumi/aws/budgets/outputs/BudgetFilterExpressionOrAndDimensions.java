...
@CustomType
public final class BudgetFilterExpressionOrAndDimensions {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionOrAndDimensions defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionOrAndDimensions defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionOrAndDimensions", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionOrAndDimensions", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public BudgetFilterExpressionOrAndDimensions build() {
            final var _resultValue = new BudgetFilterExpressionOrAndDimensions();
