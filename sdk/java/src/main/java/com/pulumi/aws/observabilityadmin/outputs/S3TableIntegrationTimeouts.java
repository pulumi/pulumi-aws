...
@CustomType
public final class S3TableIntegrationTimeouts {
    /**
    ...
    public static Builder builder(S3TableIntegrationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(S3TableIntegrationTimeouts defaults) {
        ...
        public S3TableIntegrationTimeouts build() {
            final var _resultValue = new S3TableIntegrationTimeouts();
