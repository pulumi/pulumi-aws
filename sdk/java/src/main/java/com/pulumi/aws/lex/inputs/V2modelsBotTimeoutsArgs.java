...
public final class V2modelsBotTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsBotTimeoutsArgs Empty = new V2modelsBotTimeoutsArgs();
    ...
    private V2modelsBotTimeoutsArgs() {}

    private V2modelsBotTimeoutsArgs(V2modelsBotTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(V2modelsBotTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsBotTimeoutsArgs();
        }

        public Builder(V2modelsBotTimeoutsArgs defaults) {
            $ = new V2modelsBotTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsBotTimeoutsArgs build() {
            return $;
        }
    }
