...
public final class ResourceLfTagTableWithColumnsColumnWildcard {
    ...
    public static Builder builder(ResourceLfTagTableWithColumnsColumnWildcard defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> excludedColumnNames;
        public Builder() {}
        public Builder(ResourceLfTagTableWithColumnsColumnWildcard defaults) {
        ...
        public ResourceLfTagTableWithColumnsColumnWildcard build() {
            final var _resultValue = new ResourceLfTagTableWithColumnsColumnWildcard();
