...
public final class DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs() {}

    private DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs(DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs $) {
    ...
    public static Builder builder(DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs();
        }

        public Builder(DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs defaults) {
        ...
        public DashboardDashboardPublishOptionsDataPointMenuLabelOptionArgs build() {
            return $;
        }
    }
