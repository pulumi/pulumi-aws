...
@CustomType
public final class V2modelsIntentInitialResponseSettingMessageGroup {
    /**
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingMessageGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<V2modelsIntentInitialResponseSettingVariation> variations;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingMessageGroup defaults) {
        ...
        public Builder message(V2modelsIntentInitialResponseSettingMessage message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingMessageGroup", "message");
            }
        ...
        public V2modelsIntentInitialResponseSettingMessageGroup build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingMessageGroup();
