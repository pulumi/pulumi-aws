...
public final class GetTransitGatewayRouteTablesPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static Builder builder(GetTransitGatewayRouteTablesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTransitGatewayRouteTablesPlainArgs();
        }

        public Builder(GetTransitGatewayRouteTablesPlainArgs defaults) {
            $ = new GetTransitGatewayRouteTablesPlainArgs(Objects.requireNonNull(defaults));
        }
