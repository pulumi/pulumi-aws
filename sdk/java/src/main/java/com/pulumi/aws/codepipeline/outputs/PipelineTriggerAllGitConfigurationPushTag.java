...
public final class PipelineTriggerAllGitConfigurationPushTag {
    ...
    public static Builder builder(PipelineTriggerAllGitConfigurationPushTag defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(PipelineTriggerAllGitConfigurationPushTag defaults) {
        ...
        public PipelineTriggerAllGitConfigurationPushTag build() {
            final var _resultValue = new PipelineTriggerAllGitConfigurationPushTag();
