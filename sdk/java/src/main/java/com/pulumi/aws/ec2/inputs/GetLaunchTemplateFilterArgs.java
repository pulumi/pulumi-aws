...
public final class GetLaunchTemplateFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetLaunchTemplateFilterArgs Empty = new GetLaunchTemplateFilterArgs();
    ...
    private GetLaunchTemplateFilterArgs() {}

    private GetLaunchTemplateFilterArgs(GetLaunchTemplateFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetLaunchTemplateFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLaunchTemplateFilterArgs();
        }

        public Builder(GetLaunchTemplateFilterArgs defaults) {
            $ = new GetLaunchTemplateFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLaunchTemplateFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetLaunchTemplateFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetLaunchTemplateFilterArgs", "values");
            }
            return $;
        }
    }
