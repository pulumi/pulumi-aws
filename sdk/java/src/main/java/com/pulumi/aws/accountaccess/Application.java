...
import com.pulumi.aws.accountaccess.inputs.ApplicationState;
import com.pulumi.aws.accountaccess.outputs.ApplicationIdentitySource;
import com.pulumi.aws.accountaccess.outputs.ApplicationTimeouts;
 ...
 * 
 */
@ResourceType(type="aws:accountaccess/application:Application")
public class Application extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="identitySource", refs={ApplicationIdentitySource.class}, tree="[0]")
    private Output<ApplicationIdentitySource> identitySource;
     ...
     * 
     */
    public Output<ApplicationIdentitySource> identitySource() {
    ...
    public Application(java.lang.String name, ApplicationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:accountaccess/application:Application", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Application(java.lang.String name, Output<java.lang.String> id, @Nullable ApplicationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:accountaccess/application:Application", name, state, makeResourceOptions(options, id), false);
    }
