...
import com.pulumi.aws.quicksight.inputs.VisualsFunnelChartVisualChartConfigurationArgs;
...
public final class VisualsFunnelChartVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsFunnelChartVisualArgs Empty = new VisualsFunnelChartVisualArgs();
    ...
    private @Nullable Output<VisualsFunnelChartVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsFunnelChartVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsFunnelChartVisualArgs(VisualsFunnelChartVisualArgs $) {
    ...
    public static Builder builder(VisualsFunnelChartVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsFunnelChartVisualArgs();
        }

        public Builder(VisualsFunnelChartVisualArgs defaults) {
            $ = new VisualsFunnelChartVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsFunnelChartVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsFunnelChartVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsFunnelChartVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsFunnelChartVisualArgs", "visualId");
            }
            return $;
        }
    }
