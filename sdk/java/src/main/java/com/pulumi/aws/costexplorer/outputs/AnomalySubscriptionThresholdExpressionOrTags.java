...
public final class AnomalySubscriptionThresholdExpressionOrTags {
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionOrTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionOrTags defaults) {
        ...
        public AnomalySubscriptionThresholdExpressionOrTags build() {
            final var _resultValue = new AnomalySubscriptionThresholdExpressionOrTags();
