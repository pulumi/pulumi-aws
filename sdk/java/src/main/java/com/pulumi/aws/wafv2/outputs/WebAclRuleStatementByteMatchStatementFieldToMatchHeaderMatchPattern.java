...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternAll;
...
public final class WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern {
     ...
     * 
     */
    private @Nullable WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternAll all;
    /**
    ...
    private WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern() {}
    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    public Optional<WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternAll> all() {
    ...
    public static Builder builder(WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedHeaders;
        public Builder() {}
        public Builder(WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern defaults) {
        ...
        @CustomType.Setter
        public Builder all(@Nullable WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPatternAll all) {
        ...
        public WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern build() {
            final var _resultValue = new WebAclRuleStatementByteMatchStatementFieldToMatchHeaderMatchPattern();
