...
public final class RailsAppLayerEbsVolumeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public RailsAppLayerEbsVolumeArgs build() {
            if ($.mountPoint == null) {
                throw new MissingRequiredPropertyException("RailsAppLayerEbsVolumeArgs", "mountPoint");
            }
            if ($.numberOfDisks == null) {
                throw new MissingRequiredPropertyException("RailsAppLayerEbsVolumeArgs", "numberOfDisks");
            }
            if ($.size == null) {
                throw new MissingRequiredPropertyException("RailsAppLayerEbsVolumeArgs", "size");
            }
            return $;
        }
    }
