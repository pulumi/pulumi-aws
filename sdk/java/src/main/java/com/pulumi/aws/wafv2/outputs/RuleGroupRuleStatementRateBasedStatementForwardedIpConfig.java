...
public final class RuleGroupRuleStatementRateBasedStatementForwardedIpConfig {
    ...
    public static Builder builder(RuleGroupRuleStatementRateBasedStatementForwardedIpConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String headerName;
        public Builder() {}
        public Builder(RuleGroupRuleStatementRateBasedStatementForwardedIpConfig defaults) {
        ...
        public Builder fallbackBehavior(String fallbackBehavior) {
            if (fallbackBehavior == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRateBasedStatementForwardedIpConfig", "fallbackBehavior");
            }
        ...
        public Builder headerName(String headerName) {
            if (headerName == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRateBasedStatementForwardedIpConfig", "headerName");
            }
