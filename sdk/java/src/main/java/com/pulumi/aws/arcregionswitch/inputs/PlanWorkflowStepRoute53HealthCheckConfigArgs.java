...
import com.pulumi.aws.arcregionswitch.inputs.PlanWorkflowStepRoute53HealthCheckConfigRecordSetArgs;
...
public final class PlanWorkflowStepRoute53HealthCheckConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final PlanWorkflowStepRoute53HealthCheckConfigArgs Empty = new PlanWorkflowStepRoute53HealthCheckConfigArgs();
    ...
    private @Nullable Output<List<PlanWorkflowStepRoute53HealthCheckConfigRecordSetArgs>> recordSets;

    /**
     * @return Configuration block for record sets. See Record Set below.
     * 
     */
    public Optional<Output<List<PlanWorkflowStepRoute53HealthCheckConfigRecordSetArgs>>> recordSets() {
    ...
    private PlanWorkflowStepRoute53HealthCheckConfigArgs() {}

    private PlanWorkflowStepRoute53HealthCheckConfigArgs(PlanWorkflowStepRoute53HealthCheckConfigArgs $) {
    ...
    public static Builder builder(PlanWorkflowStepRoute53HealthCheckConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PlanWorkflowStepRoute53HealthCheckConfigArgs();
        }

        public Builder(PlanWorkflowStepRoute53HealthCheckConfigArgs defaults) {
            $ = new PlanWorkflowStepRoute53HealthCheckConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder recordSets(@Nullable Output<List<PlanWorkflowStepRoute53HealthCheckConfigRecordSetArgs>> recordSets) {
         ...
         * 
         */
        public Builder recordSets(List<PlanWorkflowStepRoute53HealthCheckConfigRecordSetArgs> recordSets) {
         ...
         * 
         */
        public Builder recordSets(PlanWorkflowStepRoute53HealthCheckConfigRecordSetArgs... recordSets) {
        ...
        public PlanWorkflowStepRoute53HealthCheckConfigArgs build() {
            if ($.hostedZoneId == null) {
                throw new MissingRequiredPropertyException("PlanWorkflowStepRoute53HealthCheckConfigArgs", "hostedZoneId");
            }
            if ($.recordName == null) {
                throw new MissingRequiredPropertyException("PlanWorkflowStepRoute53HealthCheckConfigArgs", "recordName");
            }
            return $;
        }
    }
