...
public final class FsxOpenZfsFileSystemState extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<FsxOpenZfsFileSystemProtocolArgs> protocol;

    /**
     * @return The type of protocol that DataSync uses to access your file system. See below.
     * 
     */
    public Optional<Output<FsxOpenZfsFileSystemProtocolArgs>> protocol() {
    ...
    private FsxOpenZfsFileSystemState() {}

    private FsxOpenZfsFileSystemState(FsxOpenZfsFileSystemState $) {
        this.arn = $.arn;
    ...
    public static Builder builder(FsxOpenZfsFileSystemState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FsxOpenZfsFileSystemState();
        }

        public Builder(FsxOpenZfsFileSystemState defaults) {
            $ = new FsxOpenZfsFileSystemState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param creationTime The time that the FSx for openzfs location was created.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder protocol(@Nullable Output<FsxOpenZfsFileSystemProtocolArgs> protocol) {
            $.protocol = protocol;
            return this;
        }
        ...
        /**
         * @param uri The URL of the FSx for openzfs location that was described.
         * 
         * @return builder
         * 
         */
        ...
        public FsxOpenZfsFileSystemState build() {
            return $;
        }
    }
