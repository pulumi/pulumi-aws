...
public final class GetContainerRecipesFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetContainerRecipesFilterArgs() {}

    private GetContainerRecipesFilterArgs(GetContainerRecipesFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetContainerRecipesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetContainerRecipesFilterArgs();
        }

        public Builder(GetContainerRecipesFilterArgs defaults) {
            $ = new GetContainerRecipesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetContainerRecipesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetContainerRecipesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetContainerRecipesFilterArgs", "values");
            }
            return $;
        }
    }
