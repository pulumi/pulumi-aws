...
@CustomType
public final class CostCategoryRuleRuleOrAndTags {
    /**
    ...
    private CostCategoryRuleRuleOrAndTags() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleOrAndTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleOrAndTags defaults) {
        ...
        public CostCategoryRuleRuleOrAndTags build() {
            final var _resultValue = new CostCategoryRuleRuleOrAndTags();
