...
@CustomType
public final class BudgetFilterExpressionNotDimensions {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionNotDimensions defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotDimensions defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionNotDimensions", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionNotDimensions", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public BudgetFilterExpressionNotDimensions build() {
            final var _resultValue = new BudgetFilterExpressionNotDimensions();
