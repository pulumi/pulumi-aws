...
public final class NetworkInsightsAnalysisExplanationComponent {
    ...
    public static Builder builder(NetworkInsightsAnalysisExplanationComponent defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(NetworkInsightsAnalysisExplanationComponent defaults) {
        ...
        public NetworkInsightsAnalysisExplanationComponent build() {
            final var _resultValue = new NetworkInsightsAnalysisExplanationComponent();
