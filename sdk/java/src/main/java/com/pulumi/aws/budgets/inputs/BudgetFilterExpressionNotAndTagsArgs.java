...
public final class BudgetFilterExpressionNotAndTagsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private BudgetFilterExpressionNotAndTagsArgs() {}

    private BudgetFilterExpressionNotAndTagsArgs(BudgetFilterExpressionNotAndTagsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionNotAndTagsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionNotAndTagsArgs();
        }

        public Builder(BudgetFilterExpressionNotAndTagsArgs defaults) {
            $ = new BudgetFilterExpressionNotAndTagsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionNotAndTagsArgs build() {
            return $;
        }
    }
