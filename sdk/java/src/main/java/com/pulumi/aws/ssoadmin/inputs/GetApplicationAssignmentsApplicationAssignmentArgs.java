...
public final class GetApplicationAssignmentsApplicationAssignmentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetApplicationAssignmentsApplicationAssignmentArgs(GetApplicationAssignmentsApplicationAssignmentArgs $) {
    ...
    public static Builder builder(GetApplicationAssignmentsApplicationAssignmentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetApplicationAssignmentsApplicationAssignmentArgs();
        }

        public Builder(GetApplicationAssignmentsApplicationAssignmentArgs defaults) {
            $ = new GetApplicationAssignmentsApplicationAssignmentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetApplicationAssignmentsApplicationAssignmentArgs build() {
            if ($.applicationArn == null) {
                throw new MissingRequiredPropertyException("GetApplicationAssignmentsApplicationAssignmentArgs", "applicationArn");
            }
            if ($.principalId == null) {
                throw new MissingRequiredPropertyException("GetApplicationAssignmentsApplicationAssignmentArgs", "principalId");
            }
            if ($.principalType == null) {
                throw new MissingRequiredPropertyException("GetApplicationAssignmentsApplicationAssignmentArgs", "principalType");
            }
            return $;
        }
    }
