...
public final class GetAvailabilityZonesFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetAvailabilityZonesFilterArgs Empty = new GetAvailabilityZonesFilterArgs();
    ...
    private GetAvailabilityZonesFilterArgs() {}

    private GetAvailabilityZonesFilterArgs(GetAvailabilityZonesFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetAvailabilityZonesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAvailabilityZonesFilterArgs defaults) {
            $ = new GetAvailabilityZonesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAvailabilityZonesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetAvailabilityZonesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetAvailabilityZonesFilterArgs", "values");
            }
            return $;
        }
    }
