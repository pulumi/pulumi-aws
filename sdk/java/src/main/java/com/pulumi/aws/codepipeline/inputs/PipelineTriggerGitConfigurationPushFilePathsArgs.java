...
public final class PipelineTriggerGitConfigurationPushFilePathsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PipelineTriggerGitConfigurationPushFilePathsArgs Empty = new PipelineTriggerGitConfigurationPushFilePathsArgs();
    ...
    private PipelineTriggerGitConfigurationPushFilePathsArgs() {}

    private PipelineTriggerGitConfigurationPushFilePathsArgs(PipelineTriggerGitConfigurationPushFilePathsArgs $) {
    ...
    public static Builder builder(PipelineTriggerGitConfigurationPushFilePathsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineTriggerGitConfigurationPushFilePathsArgs();
        }

        public Builder(PipelineTriggerGitConfigurationPushFilePathsArgs defaults) {
            $ = new PipelineTriggerGitConfigurationPushFilePathsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineTriggerGitConfigurationPushFilePathsArgs build() {
            return $;
        }
    }
