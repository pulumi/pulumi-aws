...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern;
...
@CustomType
public final class RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody {
    /**
     ...
     * 
     */
    private RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
     ...
     * 
     */
    public RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
    ...
    public static Builder builder(RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
            if (matchPattern == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody", "matchPattern");
            }
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody", "matchScope");
            }
        ...
        public RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody build() {
            final var _resultValue = new RuleGroupRuleStatementXssMatchStatementFieldToMatchJsonBody();
