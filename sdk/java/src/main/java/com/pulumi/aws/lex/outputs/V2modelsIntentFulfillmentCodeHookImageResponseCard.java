...
@CustomType
public final class V2modelsIntentFulfillmentCodeHookImageResponseCard {
    /**
    ...
    public static Builder builder(V2modelsIntentFulfillmentCodeHookImageResponseCard defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(V2modelsIntentFulfillmentCodeHookImageResponseCard defaults) {
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentFulfillmentCodeHookImageResponseCard", "title");
            }
            this.title = title;
            return this;
        }
        public V2modelsIntentFulfillmentCodeHookImageResponseCard build() {
            final var _resultValue = new V2modelsIntentFulfillmentCodeHookImageResponseCard();
