...
public final class CostCategoryRuleRuleAndNotDimension {
    ...
    public static Builder builder(CostCategoryRuleRuleAndNotDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleAndNotDimension defaults) {
        ...
        public CostCategoryRuleRuleAndNotDimension build() {
            final var _resultValue = new CostCategoryRuleRuleAndNotDimension();
