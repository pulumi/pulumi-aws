...
public final class CostCategoryRuleRuleOrTags {
    ...
    public static Builder builder(CostCategoryRuleRuleOrTags defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CostCategoryRuleRuleOrTags defaults) {
        ...
        }        public CostCategoryRuleRuleOrTags build() {
            return new CostCategoryRuleRuleOrTags(key, matchOptions, values);
        }
    }
}
