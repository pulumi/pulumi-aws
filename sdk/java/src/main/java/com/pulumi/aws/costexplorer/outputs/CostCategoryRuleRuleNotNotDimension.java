...
public final class CostCategoryRuleRuleNotNotDimension {
    ...
    private CostCategoryRuleRuleNotNotDimension() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleNotNotDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleNotNotDimension defaults) {
        ...
        public CostCategoryRuleRuleNotNotDimension build() {
            final var _resultValue = new CostCategoryRuleRuleNotNotDimension();
