...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs Empty = new WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs();
    ...
    private Output<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs() {}

    private WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs();
        }

        public Builder(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs defaults) {
            $ = new WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchHeaderArgs build() {
