...
@CustomType
public final class CostCategoryRuleRuleAndOrCostCategory {
    /**
    ...
    private CostCategoryRuleRuleAndOrCostCategory() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleAndOrCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleAndOrCostCategory defaults) {
        ...
        public CostCategoryRuleRuleAndOrCostCategory build() {
            final var _resultValue = new CostCategoryRuleRuleAndOrCostCategory();
