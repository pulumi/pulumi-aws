...
public final class VolumeCopyTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final VolumeCopyTimeoutsArgs Empty = new VolumeCopyTimeoutsArgs();
    ...
    private VolumeCopyTimeoutsArgs() {}

    private VolumeCopyTimeoutsArgs(VolumeCopyTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(VolumeCopyTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VolumeCopyTimeoutsArgs();
        }

        public Builder(VolumeCopyTimeoutsArgs defaults) {
            $ = new VolumeCopyTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VolumeCopyTimeoutsArgs build() {
            return $;
        }
    }
