...
@CustomType
public final class InsightFiltersCriticality {
    /**
    ...
    private InsightFiltersCriticality() {}
    /**
     * @return The equal-to condition to be applied to a single field when querying for findings, provided as a String.
     * 
     */
    ...
    public static Builder builder(InsightFiltersCriticality defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String lte;
        public Builder() {}
        public Builder(InsightFiltersCriticality defaults) {
        ...
        public InsightFiltersCriticality build() {
            final var _resultValue = new InsightFiltersCriticality();
            _resultValue.eq = eq;
