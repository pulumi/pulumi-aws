...
public final class KeyValueStoreTimeouts {
    ...
    public static Builder builder(KeyValueStoreTimeouts defaults) {
    ...
    public static final class Builder {
        private @Nullable String create;
        public Builder() {}
        public Builder(KeyValueStoreTimeouts defaults) {
        ...
        public KeyValueStoreTimeouts build() {
            final var _resultValue = new KeyValueStoreTimeouts();
