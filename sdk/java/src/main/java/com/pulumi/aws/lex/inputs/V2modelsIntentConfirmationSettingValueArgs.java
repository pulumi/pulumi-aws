...
public final class V2modelsIntentConfirmationSettingValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentConfirmationSettingValueArgs Empty = new V2modelsIntentConfirmationSettingValueArgs();
    ...
    private V2modelsIntentConfirmationSettingValueArgs() {}

    private V2modelsIntentConfirmationSettingValueArgs(V2modelsIntentConfirmationSettingValueArgs $) {
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentConfirmationSettingValueArgs();
        }

        public Builder(V2modelsIntentConfirmationSettingValueArgs defaults) {
            $ = new V2modelsIntentConfirmationSettingValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentConfirmationSettingValueArgs build() {
            return $;
        }
    }
