...
public final class InsightFiltersResourceAwsEc2InstanceImageId {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsEc2InstanceImageId", "comparison");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsEc2InstanceImageId", "value");
            }
            this.value = value;
            return this;
        }
