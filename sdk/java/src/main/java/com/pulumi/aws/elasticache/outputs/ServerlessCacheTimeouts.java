...
public final class ServerlessCacheTimeouts {
    ...
    public static Builder builder(ServerlessCacheTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ServerlessCacheTimeouts defaults) {
        ...
        public ServerlessCacheTimeouts build() {
            final var _resultValue = new ServerlessCacheTimeouts();
