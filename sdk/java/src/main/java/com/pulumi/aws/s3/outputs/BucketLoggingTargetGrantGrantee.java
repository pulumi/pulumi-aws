...
public final class BucketLoggingTargetGrantGrantee {
    ...
    public static Builder builder(BucketLoggingTargetGrantGrantee defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String uri;
        public Builder() {}
        public Builder(BucketLoggingTargetGrantGrantee defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("BucketLoggingTargetGrantGrantee", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public BucketLoggingTargetGrantGrantee build() {
            final var _resultValue = new BucketLoggingTargetGrantGrantee();
