...
public final class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3Fingerprint {
    ...
    private WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3Fingerprint() {}
    /**
     * @return Match status to assign to the web request if there is insufficient TSL Client Hello information to compute the JA3 fingerprint. Valid values include: `MATCH` or `NO_MATCH`.
     * 
     */
    ...
    public static Builder builder(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3Fingerprint defaults) {
    ...
    public static final class Builder {
        private String fallbackBehavior;
        public Builder() {}
        public Builder(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchJa3Fingerprint defaults) {
