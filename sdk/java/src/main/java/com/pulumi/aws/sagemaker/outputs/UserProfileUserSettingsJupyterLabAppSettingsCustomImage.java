...
public final class UserProfileUserSettingsJupyterLabAppSettingsCustomImage {
    ...
    public static Builder builder(UserProfileUserSettingsJupyterLabAppSettingsCustomImage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer imageVersionNumber;
        public Builder() {}
        public Builder(UserProfileUserSettingsJupyterLabAppSettingsCustomImage defaults) {
        ...
        public Builder appImageConfigName(String appImageConfigName) {
            if (appImageConfigName == null) {
              throw new MissingRequiredPropertyException("UserProfileUserSettingsJupyterLabAppSettingsCustomImage", "appImageConfigName");
            }
        ...
        public Builder imageName(String imageName) {
            if (imageName == null) {
              throw new MissingRequiredPropertyException("UserProfileUserSettingsJupyterLabAppSettingsCustomImage", "imageName");
            }
        ...
        public UserProfileUserSettingsJupyterLabAppSettingsCustomImage build() {
            final var _resultValue = new UserProfileUserSettingsJupyterLabAppSettingsCustomImage();
