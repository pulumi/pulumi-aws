...
public final class MemcachedLayerArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<MemcachedLayerLoadBasedAutoScalingArgs> loadBasedAutoScaling;

    public Optional<Output<MemcachedLayerLoadBasedAutoScalingArgs>> loadBasedAutoScaling() {
    ...
    private MemcachedLayerArgs(MemcachedLayerArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder(MemcachedLayerArgs defaults) {
            $ = new MemcachedLayerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder loadBasedAutoScaling(@Nullable Output<MemcachedLayerLoadBasedAutoScalingArgs> loadBasedAutoScaling) {
        ...
        public MemcachedLayerArgs build() {
            if ($.stackId == null) {
                throw new MissingRequiredPropertyException("MemcachedLayerArgs", "stackId");
            }
            return $;
        }
    }
