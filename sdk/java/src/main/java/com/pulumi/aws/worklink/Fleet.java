...
public class Fleet extends com.pulumi.resources.CustomResource {
    ...
    public Fleet(java.lang.String name, @Nullable FleetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:worklink/fleet:Fleet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Fleet(java.lang.String name, Output<java.lang.String> id, @Nullable FleetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:worklink/fleet:Fleet", name, state, makeResourceOptions(options, id), false);
    }
