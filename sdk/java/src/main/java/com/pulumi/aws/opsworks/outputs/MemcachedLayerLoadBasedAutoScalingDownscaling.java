...
public final class MemcachedLayerLoadBasedAutoScalingDownscaling {
    ...
    private MemcachedLayerLoadBasedAutoScalingDownscaling() {}
    ...
    public static Builder builder(MemcachedLayerLoadBasedAutoScalingDownscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(MemcachedLayerLoadBasedAutoScalingDownscaling defaults) {
        ...
        public MemcachedLayerLoadBasedAutoScalingDownscaling build() {
            final var _resultValue = new MemcachedLayerLoadBasedAutoScalingDownscaling();
