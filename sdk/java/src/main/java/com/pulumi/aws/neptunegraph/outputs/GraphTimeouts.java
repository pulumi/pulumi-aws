...
@CustomType
public final class GraphTimeouts {
    /**
    ...
    public static Builder builder(GraphTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(GraphTimeouts defaults) {
        ...
        public GraphTimeouts build() {
            final var _resultValue = new GraphTimeouts();
