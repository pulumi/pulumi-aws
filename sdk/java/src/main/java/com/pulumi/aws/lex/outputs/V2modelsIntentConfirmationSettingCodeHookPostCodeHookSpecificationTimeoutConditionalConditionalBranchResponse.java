...
import com.pulumi.aws.lex.outputs.V2modelsIntentConfirmationSettingMessageGroup;
...
public final class V2modelsIntentConfirmationSettingCodeHookPostCodeHookSpecificationTimeoutConditionalConditionalBranchResponse {
     ...
     * 
     */
    private @Nullable List<V2modelsIntentConfirmationSettingMessageGroup> messageGroups;
     ...
     * 
     */
    public List<V2modelsIntentConfirmationSettingMessageGroup> messageGroups() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder messageGroups(@Nullable List<V2modelsIntentConfirmationSettingMessageGroup> messageGroups) {

            this.messageGroups = messageGroups;
            return this;
        }
        public Builder messageGroups(V2modelsIntentConfirmationSettingMessageGroup... messageGroups) {
