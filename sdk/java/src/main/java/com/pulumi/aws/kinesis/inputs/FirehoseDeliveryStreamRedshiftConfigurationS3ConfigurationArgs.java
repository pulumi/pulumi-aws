...
import com.pulumi.aws.kinesis.inputs.FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs;
...
public final class FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs Empty = new FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs();
    ...
    private @Nullable Output<FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs> cloudwatchLoggingOptions;

    /**
     * @return The CloudWatch Logging Options for the delivery stream. See `cloudwatch_logging_options` block below for details.
     * 
     */
    public Optional<Output<FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs>> cloudwatchLoggingOptions() {
    ...
    private FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs() {}

    private FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs(FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs $) {
    ...
    public static Builder builder(FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs();
        }

        public Builder(FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs defaults) {
            $ = new FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudwatchLoggingOptions(@Nullable Output<FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs> cloudwatchLoggingOptions) {
         ...
         * 
         */
        public Builder cloudwatchLoggingOptions(FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs cloudwatchLoggingOptions) {
        ...
        public FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs build() {
            if ($.bucketArn == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs", "bucketArn");
            }
            if ($.roleArn == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamRedshiftConfigurationS3ConfigurationArgs", "roleArn");
            }
            return $;
        }
    }
