...
public final class MeasureFieldSchema2NumericalMeasureFieldArgs extends com.pulumi.resources.ResourceArgs {

    public static final MeasureFieldSchema2NumericalMeasureFieldArgs Empty = new MeasureFieldSchema2NumericalMeasureFieldArgs();
    ...
    private MeasureFieldSchema2NumericalMeasureFieldArgs() {}

    private MeasureFieldSchema2NumericalMeasureFieldArgs(MeasureFieldSchema2NumericalMeasureFieldArgs $) {
    ...
    public static Builder builder(MeasureFieldSchema2NumericalMeasureFieldArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MeasureFieldSchema2NumericalMeasureFieldArgs();
        }

        public Builder(MeasureFieldSchema2NumericalMeasureFieldArgs defaults) {
            $ = new MeasureFieldSchema2NumericalMeasureFieldArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MeasureFieldSchema2NumericalMeasureFieldArgs build() {
            if ($.column == null) {
                throw new MissingRequiredPropertyException("MeasureFieldSchema2NumericalMeasureFieldArgs", "column");
            }
            if ($.fieldId == null) {
                throw new MissingRequiredPropertyException("MeasureFieldSchema2NumericalMeasureFieldArgs", "fieldId");
            }
            return $;
        }
    }
