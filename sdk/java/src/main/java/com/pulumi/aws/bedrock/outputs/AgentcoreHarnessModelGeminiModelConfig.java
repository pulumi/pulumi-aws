...
public final class AgentcoreHarnessModelGeminiModelConfig {
    ...
    public static Builder builder(AgentcoreHarnessModelGeminiModelConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder apiKeyArn(String apiKeyArn) {
            if (apiKeyArn == null) {
              throw new MissingRequiredPropertyException("AgentcoreHarnessModelGeminiModelConfig", "apiKeyArn");
            }
        ...
        public Builder modelId(String modelId) {
            if (modelId == null) {
              throw new MissingRequiredPropertyException("AgentcoreHarnessModelGeminiModelConfig", "modelId");
            }
