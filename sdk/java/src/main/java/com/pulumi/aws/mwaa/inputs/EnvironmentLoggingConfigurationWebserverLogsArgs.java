...
public final class EnvironmentLoggingConfigurationWebserverLogsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private EnvironmentLoggingConfigurationWebserverLogsArgs(EnvironmentLoggingConfigurationWebserverLogsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EnvironmentLoggingConfigurationWebserverLogsArgs();
        }

        public Builder(EnvironmentLoggingConfigurationWebserverLogsArgs defaults) {
            $ = new EnvironmentLoggingConfigurationWebserverLogsArgs(Objects.requireNonNull(defaults));
        }
