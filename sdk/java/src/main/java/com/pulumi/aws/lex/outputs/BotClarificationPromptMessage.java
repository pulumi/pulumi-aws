...
public final class BotClarificationPromptMessage {
    ...
    public static final class Builder {
        ...
        public Builder content(String content) {
            if (content == null) {
              throw new MissingRequiredPropertyException("BotClarificationPromptMessage", "content");
            }
        ...
        public Builder contentType(String contentType) {
            if (contentType == null) {
              throw new MissingRequiredPropertyException("BotClarificationPromptMessage", "contentType");
            }
