...
public final class V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs Empty = new V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs();
    ...
    private V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs() {}

    private V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs(V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs $) {
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs();
        }

        public Builder(V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs defaults) {
            $ = new V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentConfirmationSettingConfirmationNextStepIntentSlotValueArgs build() {
            return $;
        }
    }
