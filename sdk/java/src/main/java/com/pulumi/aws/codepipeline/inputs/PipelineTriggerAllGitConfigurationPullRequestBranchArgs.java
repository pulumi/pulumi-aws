...
public final class PipelineTriggerAllGitConfigurationPullRequestBranchArgs extends com.pulumi.resources.ResourceArgs {

    public static final PipelineTriggerAllGitConfigurationPullRequestBranchArgs Empty = new PipelineTriggerAllGitConfigurationPullRequestBranchArgs();
    ...
    private PipelineTriggerAllGitConfigurationPullRequestBranchArgs() {}

    private PipelineTriggerAllGitConfigurationPullRequestBranchArgs(PipelineTriggerAllGitConfigurationPullRequestBranchArgs $) {
    ...
    public static Builder builder(PipelineTriggerAllGitConfigurationPullRequestBranchArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineTriggerAllGitConfigurationPullRequestBranchArgs();
        }

        public Builder(PipelineTriggerAllGitConfigurationPullRequestBranchArgs defaults) {
            $ = new PipelineTriggerAllGitConfigurationPullRequestBranchArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineTriggerAllGitConfigurationPullRequestBranchArgs build() {
            return $;
        }
    }
