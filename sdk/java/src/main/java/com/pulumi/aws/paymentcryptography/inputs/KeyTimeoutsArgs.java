...
public final class KeyTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final KeyTimeoutsArgs Empty = new KeyTimeoutsArgs();
    ...
    private KeyTimeoutsArgs() {}

    private KeyTimeoutsArgs(KeyTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(KeyTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(KeyTimeoutsArgs defaults) {
            $ = new KeyTimeoutsArgs(Objects.requireNonNull(defaults));
        }
