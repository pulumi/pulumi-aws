...
public final class PolicySecurityServicePolicyDataArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Network Firewall firewall policy options to configure a centralized deployment model. See the `policyOption` block.
     * 
     */
    ...
    /**
     * @return Service that the policy uses to protect the resources. For the current list of supported types, refer to the [AWS Firewall Manager SecurityServicePolicyData API Type Reference](https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_SecurityServicePolicyData.html#fms-Type-SecurityServicePolicyData-Type).
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param type Service that the policy uses to protect the resources. For the current list of supported types, refer to the [AWS Firewall Manager SecurityServicePolicyData API Type Reference](https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_SecurityServicePolicyData.html#fms-Type-SecurityServicePolicyData-Type).
         * 
         * @return builder
         * 
         */
