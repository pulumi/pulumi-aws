...
public final class MigrationProjectTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final MigrationProjectTimeoutsArgs Empty = new MigrationProjectTimeoutsArgs();
    ...
    private MigrationProjectTimeoutsArgs() {}

    private MigrationProjectTimeoutsArgs(MigrationProjectTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(MigrationProjectTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MigrationProjectTimeoutsArgs();
        }

        public Builder(MigrationProjectTimeoutsArgs defaults) {
            $ = new MigrationProjectTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MigrationProjectTimeoutsArgs build() {
            return $;
        }
    }
