...
public final class RestApiPutTimeouts {
    ...
    public static Builder builder(RestApiPutTimeouts defaults) {
    ...
    public static final class Builder {
        private @Nullable String create;
        public Builder() {}
        public Builder(RestApiPutTimeouts defaults) {
        ...
        public RestApiPutTimeouts build() {
            final var _resultValue = new RestApiPutTimeouts();
