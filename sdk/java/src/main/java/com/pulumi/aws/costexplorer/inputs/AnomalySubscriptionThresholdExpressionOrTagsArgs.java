...
public final class AnomalySubscriptionThresholdExpressionOrTagsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnomalySubscriptionThresholdExpressionOrTagsArgs Empty = new AnomalySubscriptionThresholdExpressionOrTagsArgs();
    ...
    private AnomalySubscriptionThresholdExpressionOrTagsArgs() {}

    private AnomalySubscriptionThresholdExpressionOrTagsArgs(AnomalySubscriptionThresholdExpressionOrTagsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionOrTagsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalySubscriptionThresholdExpressionOrTagsArgs();
        }

        public Builder(AnomalySubscriptionThresholdExpressionOrTagsArgs defaults) {
            $ = new AnomalySubscriptionThresholdExpressionOrTagsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnomalySubscriptionThresholdExpressionOrTagsArgs build() {
            return $;
        }
    }
