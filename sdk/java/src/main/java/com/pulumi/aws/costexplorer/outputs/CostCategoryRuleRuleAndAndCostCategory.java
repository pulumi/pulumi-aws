...
public final class CostCategoryRuleRuleAndAndCostCategory {
    ...
    private CostCategoryRuleRuleAndAndCostCategory() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleAndAndCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleAndAndCostCategory defaults) {
        ...
        public CostCategoryRuleRuleAndAndCostCategory build() {
            final var _resultValue = new CostCategoryRuleRuleAndAndCostCategory();
