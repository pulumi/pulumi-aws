...
public final class DataRepositoryAssociationS3AutoImportPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return List of file event types to automatically import from the linked S3 bucket. Valid values are `NEW`, `CHANGED`, `DELETED`. Max of 3.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param events List of file event types to automatically import from the linked S3 bucket. Valid values are `NEW`, `CHANGED`, `DELETED`. Max of 3.
         * 
         * @return builder
         * 
         */
