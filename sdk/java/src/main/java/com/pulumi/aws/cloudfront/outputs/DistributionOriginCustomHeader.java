...
public final class DistributionOriginCustomHeader {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DistributionOriginCustomHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DistributionOriginCustomHeader", "value");
            }
            this.value = value;
            return this;
        }
