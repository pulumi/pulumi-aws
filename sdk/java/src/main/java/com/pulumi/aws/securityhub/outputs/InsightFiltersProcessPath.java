...
public final class InsightFiltersProcessPath {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersProcessPath", "comparison");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersProcessPath", "value");
            }
            this.value = value;
            return this;
        }
        public InsightFiltersProcessPath build() {
            final var _resultValue = new InsightFiltersProcessPath();
