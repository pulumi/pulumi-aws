...
public final class GetFrameworkControlScope {
    ...
    private GetFrameworkControlScope(
        @CustomType.Parameter("complianceResourceIds") List<String> complianceResourceIds,
        @CustomType.Parameter("complianceResourceTypes") List<String> complianceResourceTypes,
    ...
    public static final class Builder {
        ...
        public Builder tags(Map<String,String> tags) {
            ...
            return new GetFrameworkControlScope(complianceResourceIds, complianceResourceTypes, tags);
        }
    }
}
