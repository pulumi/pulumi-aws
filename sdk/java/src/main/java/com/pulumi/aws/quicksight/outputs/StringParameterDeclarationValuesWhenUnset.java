...
@CustomType
public final class StringParameterDeclarationValuesWhenUnset {
    ...
    public static Builder builder(StringParameterDeclarationValuesWhenUnset defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String valueWhenUnsetOption;
        public Builder() {}
        public Builder(StringParameterDeclarationValuesWhenUnset defaults) {
        ...
        public StringParameterDeclarationValuesWhenUnset build() {
            final var _resultValue = new StringParameterDeclarationValuesWhenUnset();
