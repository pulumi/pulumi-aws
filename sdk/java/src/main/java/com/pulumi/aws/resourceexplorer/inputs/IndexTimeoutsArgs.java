...
public final class IndexTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final IndexTimeoutsArgs Empty = new IndexTimeoutsArgs();
    ...
    private IndexTimeoutsArgs() {}

    private IndexTimeoutsArgs(IndexTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(IndexTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IndexTimeoutsArgs();
        }

        public Builder(IndexTimeoutsArgs defaults) {
            $ = new IndexTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IndexTimeoutsArgs build() {
            return $;
        }
    }
