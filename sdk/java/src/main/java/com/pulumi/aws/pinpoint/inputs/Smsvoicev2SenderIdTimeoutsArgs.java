...
public final class Smsvoicev2SenderIdTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final Smsvoicev2SenderIdTimeoutsArgs Empty = new Smsvoicev2SenderIdTimeoutsArgs();
    ...
    private Smsvoicev2SenderIdTimeoutsArgs() {}

    private Smsvoicev2SenderIdTimeoutsArgs(Smsvoicev2SenderIdTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(Smsvoicev2SenderIdTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new Smsvoicev2SenderIdTimeoutsArgs();
        }

        public Builder(Smsvoicev2SenderIdTimeoutsArgs defaults) {
            $ = new Smsvoicev2SenderIdTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Smsvoicev2SenderIdTimeoutsArgs build() {
            return $;
        }
    }
