...
import com.pulumi.aws.ec2.outputs.NetworkInsightsAnalysisReturnPathComponentOutboundHeaderDestinationPortRange;
import com.pulumi.aws.ec2.outputs.NetworkInsightsAnalysisReturnPathComponentOutboundHeaderSourcePortRange;
...
public final class NetworkInsightsAnalysisReturnPathComponentOutboundHeader {
    ...
    private @Nullable List<NetworkInsightsAnalysisReturnPathComponentOutboundHeaderDestinationPortRange> destinationPortRanges;
    private @Nullable String protocol;
    private @Nullable List<String> sourceAddresses;
    private @Nullable List<NetworkInsightsAnalysisReturnPathComponentOutboundHeaderSourcePortRange> sourcePortRanges;
    ...
    public static Builder builder(NetworkInsightsAnalysisReturnPathComponentOutboundHeader defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<NetworkInsightsAnalysisReturnPathComponentOutboundHeaderSourcePortRange> sourcePortRanges;
        public Builder() {}
        public Builder(NetworkInsightsAnalysisReturnPathComponentOutboundHeader defaults) {
        ...
        public Builder destinationPortRanges(NetworkInsightsAnalysisReturnPathComponentOutboundHeaderDestinationPortRange... destinationPortRanges) {
        ...
        public Builder sourcePortRanges(NetworkInsightsAnalysisReturnPathComponentOutboundHeaderSourcePortRange... sourcePortRanges) {
            return sourcePortRanges(List.of(sourcePortRanges));
        }
        public NetworkInsightsAnalysisReturnPathComponentOutboundHeader build() {
            final var _resultValue = new NetworkInsightsAnalysisReturnPathComponentOutboundHeader();
