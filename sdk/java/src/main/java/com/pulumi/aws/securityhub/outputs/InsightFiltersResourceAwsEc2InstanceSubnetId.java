...
public final class InsightFiltersResourceAwsEc2InstanceSubnetId {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsEc2InstanceSubnetId", "comparison");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsEc2InstanceSubnetId", "value");
            }
            this.value = value;
            return this;
        }
