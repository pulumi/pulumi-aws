...
public final class ChannelTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ChannelTimeoutsArgs Empty = new ChannelTimeoutsArgs();
    ...
    private ChannelTimeoutsArgs() {}

    private ChannelTimeoutsArgs(ChannelTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(ChannelTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ChannelTimeoutsArgs();
        }

        public Builder(ChannelTimeoutsArgs defaults) {
            $ = new ChannelTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ChannelTimeoutsArgs build() {
            return $;
        }
    }
