...
public class VpcEndpointServiceAllowedPrincipal extends com.pulumi.resources.CustomResource {
    ...
    private VpcEndpointServiceAllowedPrincipal(java.lang.String name, Output<java.lang.String> id, @Nullable VpcEndpointServiceAllowedPrincipalState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static VpcEndpointServiceAllowedPrincipal get(java.lang.String name, Output<java.lang.String> id, @Nullable VpcEndpointServiceAllowedPrincipalState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
