...
public final class JavaAppLayerLoadBasedAutoScalingDownscaling {
    ...
    public static Builder builder(JavaAppLayerLoadBasedAutoScalingDownscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(JavaAppLayerLoadBasedAutoScalingDownscaling defaults) {
        ...
        public JavaAppLayerLoadBasedAutoScalingDownscaling build() {
            final var _resultValue = new JavaAppLayerLoadBasedAutoScalingDownscaling();
