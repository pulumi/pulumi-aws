...
@CustomType
public final class ManagedUserPoolClientRefreshTokenRotation {
    /**
    ...
    public static Builder builder(ManagedUserPoolClientRefreshTokenRotation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer retryGracePeriodSeconds;
        public Builder() {}
        public Builder(ManagedUserPoolClientRefreshTokenRotation defaults) {
        ...
        public Builder feature(String feature) {
            if (feature == null) {
              throw new MissingRequiredPropertyException("ManagedUserPoolClientRefreshTokenRotation", "feature");
            }
        ...
        public ManagedUserPoolClientRefreshTokenRotation build() {
            final var _resultValue = new ManagedUserPoolClientRefreshTokenRotation();
