...
public final class GetVpnConnectionFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetVpnConnectionFilterArgs Empty = new GetVpnConnectionFilterArgs();
    ...
    private GetVpnConnectionFilterArgs() {}

    private GetVpnConnectionFilterArgs(GetVpnConnectionFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetVpnConnectionFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetVpnConnectionFilterArgs();
        }

        public Builder(GetVpnConnectionFilterArgs defaults) {
            $ = new GetVpnConnectionFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetVpnConnectionFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetVpnConnectionFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetVpnConnectionFilterArgs", "values");
            }
            return $;
        }
    }
