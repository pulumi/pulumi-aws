...
public final class AnomalySubscriptionThresholdExpressionAndCostCategory {
    ...
    private AnomalySubscriptionThresholdExpressionAndCostCategory() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionAndCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionAndCostCategory defaults) {
        ...
        public AnomalySubscriptionThresholdExpressionAndCostCategory build() {
            final var _resultValue = new AnomalySubscriptionThresholdExpressionAndCostCategory();
