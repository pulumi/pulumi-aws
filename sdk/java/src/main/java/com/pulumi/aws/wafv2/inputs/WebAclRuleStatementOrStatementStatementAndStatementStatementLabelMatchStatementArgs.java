...
public final class WebAclRuleStatementOrStatementStatementAndStatementStatementLabelMatchStatementArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleStatementOrStatementStatementAndStatementStatementLabelMatchStatementArgs(WebAclRuleStatementOrStatementStatementAndStatementStatementLabelMatchStatementArgs $) {
        this.key = $.key;
        this.scope = $.scope;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementOrStatementStatementAndStatementStatementLabelMatchStatementArgs();
        }

        public Builder(WebAclRuleStatementOrStatementStatementAndStatementStatementLabelMatchStatementArgs defaults) {
            $ = new WebAclRuleStatementOrStatementStatementAndStatementStatementLabelMatchStatementArgs(Objects.requireNonNull(defaults));
        }
