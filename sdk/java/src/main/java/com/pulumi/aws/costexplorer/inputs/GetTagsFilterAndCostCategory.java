...
public final class GetTagsFilterAndCostCategory extends com.pulumi.resources.InvokeArgs {

    public static final GetTagsFilterAndCostCategory Empty = new GetTagsFilterAndCostCategory();
    ...
    private GetTagsFilterAndCostCategory() {}

    private GetTagsFilterAndCostCategory(GetTagsFilterAndCostCategory $) {
        this.key = $.key;
    ...
    public static Builder builder(GetTagsFilterAndCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagsFilterAndCostCategory();
        }

        public Builder(GetTagsFilterAndCostCategory defaults) {
            $ = new GetTagsFilterAndCostCategory(Objects.requireNonNull(defaults));
        }
        ...
        public GetTagsFilterAndCostCategory build() {
            return $;
        }
    }
