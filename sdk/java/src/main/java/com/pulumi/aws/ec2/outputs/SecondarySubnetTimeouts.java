...
@CustomType
public final class SecondarySubnetTimeouts {
    /**
    ...
    public static Builder builder(SecondarySubnetTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(SecondarySubnetTimeouts defaults) {
        ...
        public SecondarySubnetTimeouts build() {
            final var _resultValue = new SecondarySubnetTimeouts();
