...
public final class AgentAgentKnowledgeBaseAssociationTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AgentAgentKnowledgeBaseAssociationTimeoutsArgs Empty = new AgentAgentKnowledgeBaseAssociationTimeoutsArgs();
    ...
    private AgentAgentKnowledgeBaseAssociationTimeoutsArgs() {}

    private AgentAgentKnowledgeBaseAssociationTimeoutsArgs(AgentAgentKnowledgeBaseAssociationTimeoutsArgs $) {
        this.create = $.create;
        this.update = $.update;
    }
    ...
    public static Builder builder(AgentAgentKnowledgeBaseAssociationTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AgentAgentKnowledgeBaseAssociationTimeoutsArgs();
        }

        public Builder(AgentAgentKnowledgeBaseAssociationTimeoutsArgs defaults) {
            $ = new AgentAgentKnowledgeBaseAssociationTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AgentAgentKnowledgeBaseAssociationTimeoutsArgs build() {
            return $;
        }
    }
