...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern;
...
@CustomType
public final class WebAclRuleStatementSizeConstraintStatementFieldToMatchHeader {
    /**
     ...
     * 
     */
    private WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern matchPattern;
    /**
     ...
     * 
     */
    public WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern matchPattern() {
    ...
    public static Builder builder(WebAclRuleStatementSizeConstraintStatementFieldToMatchHeader defaults) {
    ...
    public static final class Builder {
        ...
        private String oversizeHandling;
        public Builder() {}
        public Builder(WebAclRuleStatementSizeConstraintStatementFieldToMatchHeader defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern matchPattern) {
            if (matchPattern == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementSizeConstraintStatementFieldToMatchHeader", "matchPattern");
            }
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementSizeConstraintStatementFieldToMatchHeader", "matchScope");
            }
        ...
        public Builder oversizeHandling(String oversizeHandling) {
            if (oversizeHandling == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementSizeConstraintStatementFieldToMatchHeader", "oversizeHandling");
            }
