...
public final class BaselineTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BaselineTimeoutsArgs Empty = new BaselineTimeoutsArgs();
    ...
    private BaselineTimeoutsArgs() {}

    private BaselineTimeoutsArgs(BaselineTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(BaselineTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BaselineTimeoutsArgs();
        }

        public Builder(BaselineTimeoutsArgs defaults) {
            $ = new BaselineTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BaselineTimeoutsArgs build() {
            return $;
        }
    }
