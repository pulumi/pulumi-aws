...
public final class StaticWebLayerEbsVolume {
    ...
    public static final class Builder {
        ...
        public Builder mountPoint(String mountPoint) {
            if (mountPoint == null) {
              throw new MissingRequiredPropertyException("StaticWebLayerEbsVolume", "mountPoint");
            }
        ...
        public Builder numberOfDisks(Integer numberOfDisks) {
            if (numberOfDisks == null) {
              throw new MissingRequiredPropertyException("StaticWebLayerEbsVolume", "numberOfDisks");
            }
        ...
        public Builder size(Integer size) {
            if (size == null) {
              throw new MissingRequiredPropertyException("StaticWebLayerEbsVolume", "size");
            }
            this.size = size;
            return this;
        }
