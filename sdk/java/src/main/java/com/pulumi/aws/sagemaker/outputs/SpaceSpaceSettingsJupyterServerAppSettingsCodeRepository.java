...
public final class SpaceSpaceSettingsJupyterServerAppSettingsCodeRepository {
    ...
    public static Builder builder(SpaceSpaceSettingsJupyterServerAppSettingsCodeRepository defaults) {
    ...
    public static final class Builder {
        private String repositoryUrl;
        public Builder() {}
        public Builder(SpaceSpaceSettingsJupyterServerAppSettingsCodeRepository defaults) {
