 ...
 *             .eventSelectors(%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
 *             .build());
 * 
 *     }
 * }
 ...
 *             .cloudWatchLogsGroupArn(String.format(&#34;%s:*&#34;, exampleLogGroup.arn()))
 *             .build());
 * 
 *     }
 * }
