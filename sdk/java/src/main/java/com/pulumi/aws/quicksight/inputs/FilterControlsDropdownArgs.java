...
import com.pulumi.aws.quicksight.inputs.FilterControlsDropdownDisplayOptionsArgs;
import com.pulumi.aws.quicksight.inputs.FilterControlsDropdownSelectableValuesArgs;
...
public final class FilterControlsDropdownArgs extends com.pulumi.resources.ResourceArgs {

    public static final FilterControlsDropdownArgs Empty = new FilterControlsDropdownArgs();
    ...
    private @Nullable Output<FilterControlsDropdownDisplayOptionsArgs> displayOptions;

    public Optional<Output<FilterControlsDropdownDisplayOptionsArgs>> displayOptions() {
    ...
    private @Nullable Output<FilterControlsDropdownSelectableValuesArgs> selectableValues;

    public Optional<Output<FilterControlsDropdownSelectableValuesArgs>> selectableValues() {
    ...
    private FilterControlsDropdownArgs(FilterControlsDropdownArgs $) {
    ...
    public static Builder builder(FilterControlsDropdownArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FilterControlsDropdownArgs();
        }

        public Builder(FilterControlsDropdownArgs defaults) {
            $ = new FilterControlsDropdownArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder displayOptions(@Nullable Output<FilterControlsDropdownDisplayOptionsArgs> displayOptions) {
            $.displayOptions = displayOptions;
            return this;
        }

        public Builder displayOptions(FilterControlsDropdownDisplayOptionsArgs displayOptions) {
        ...
        public Builder selectableValues(@Nullable Output<FilterControlsDropdownSelectableValuesArgs> selectableValues) {
            $.selectableValues = selectableValues;
            return this;
        }

        public Builder selectableValues(FilterControlsDropdownSelectableValuesArgs selectableValues) {
        ...
        public FilterControlsDropdownArgs build() {
            if ($.filterControlId == null) {
                throw new MissingRequiredPropertyException("FilterControlsDropdownArgs", "filterControlId");
            }
            if ($.sourceFilterId == null) {
                throw new MissingRequiredPropertyException("FilterControlsDropdownArgs", "sourceFilterId");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("FilterControlsDropdownArgs", "title");
            }
            return $;
        }
    }
