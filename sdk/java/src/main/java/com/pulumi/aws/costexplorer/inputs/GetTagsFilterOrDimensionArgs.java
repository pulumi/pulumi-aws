...
public final class GetTagsFilterOrDimensionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetTagsFilterOrDimensionArgs() {}

    private GetTagsFilterOrDimensionArgs(GetTagsFilterOrDimensionArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(GetTagsFilterOrDimensionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagsFilterOrDimensionArgs();
        }

        public Builder(GetTagsFilterOrDimensionArgs defaults) {
            $ = new GetTagsFilterOrDimensionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTagsFilterOrDimensionArgs build() {
            return $;
        }
    }
