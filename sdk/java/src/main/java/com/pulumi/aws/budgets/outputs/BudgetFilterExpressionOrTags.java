...
@CustomType
public final class BudgetFilterExpressionOrTags {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionOrTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionOrTags defaults) {
        ...
        public BudgetFilterExpressionOrTags build() {
            final var _resultValue = new BudgetFilterExpressionOrTags();
