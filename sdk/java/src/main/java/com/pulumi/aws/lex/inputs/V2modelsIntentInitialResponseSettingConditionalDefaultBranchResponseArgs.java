...
public final class V2modelsIntentInitialResponseSettingConditionalDefaultBranchResponseArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<V2modelsIntentInitialResponseSettingConditionalDefaultBranchResponseMessageGroupArgs>> messageGroups;
     ...
     * 
     */
    public Optional<Output<List<V2modelsIntentInitialResponseSettingConditionalDefaultBranchResponseMessageGroupArgs>>> messageGroups() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder messageGroups(@Nullable Output<List<V2modelsIntentInitialResponseSettingConditionalDefaultBranchResponseMessageGroupArgs>> messageGroups) {
         ...
         * 
         */
        public Builder messageGroups(List<V2modelsIntentInitialResponseSettingConditionalDefaultBranchResponseMessageGroupArgs> messageGroups) {
