...
public final class WebAclRuleStatementSqliMatchStatementFieldToMatchJa4Fingerprint {
    ...
    public static Builder builder(WebAclRuleStatementSqliMatchStatementFieldToMatchJa4Fingerprint defaults) {
    ...
    public static final class Builder {
        private String fallbackBehavior;
        public Builder() {}
        public Builder(WebAclRuleStatementSqliMatchStatementFieldToMatchJa4Fingerprint defaults) {
        ...
        public Builder fallbackBehavior(String fallbackBehavior) {
            if (fallbackBehavior == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementSqliMatchStatementFieldToMatchJa4Fingerprint", "fallbackBehavior");
            }
            this.fallbackBehavior = fallbackBehavior;
            return this;
        }
        public WebAclRuleStatementSqliMatchStatementFieldToMatchJa4Fingerprint build() {
            final var _resultValue = new WebAclRuleStatementSqliMatchStatementFieldToMatchJa4Fingerprint();
