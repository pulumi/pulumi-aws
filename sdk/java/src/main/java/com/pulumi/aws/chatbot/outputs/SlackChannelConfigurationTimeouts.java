...
@CustomType
public final class SlackChannelConfigurationTimeouts {
    /**
    ...
    public static Builder builder(SlackChannelConfigurationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(SlackChannelConfigurationTimeouts defaults) {
        ...
        public SlackChannelConfigurationTimeouts build() {
            final var _resultValue = new SlackChannelConfigurationTimeouts();
