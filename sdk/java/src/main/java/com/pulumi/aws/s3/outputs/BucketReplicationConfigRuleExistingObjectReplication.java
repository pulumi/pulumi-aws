...
public final class BucketReplicationConfigRuleExistingObjectReplication {
    ...
    private BucketReplicationConfigRuleExistingObjectReplication() {}
    /**
     * @return Whether the existing objects should be replicated. Either `&#34;Enabled&#34;` or `&#34;Disabled&#34;`.
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("BucketReplicationConfigRuleExistingObjectReplication", "status");
            }
            this.status = status;
            return this;
        }
