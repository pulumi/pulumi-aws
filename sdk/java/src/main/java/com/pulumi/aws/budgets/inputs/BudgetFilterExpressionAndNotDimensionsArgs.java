...
public final class BudgetFilterExpressionAndNotDimensionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionAndNotDimensionsArgs Empty = new BudgetFilterExpressionAndNotDimensionsArgs();
    ...
    private BudgetFilterExpressionAndNotDimensionsArgs() {}

    private BudgetFilterExpressionAndNotDimensionsArgs(BudgetFilterExpressionAndNotDimensionsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionAndNotDimensionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionAndNotDimensionsArgs();
        }

        public Builder(BudgetFilterExpressionAndNotDimensionsArgs defaults) {
            $ = new BudgetFilterExpressionAndNotDimensionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionAndNotDimensionsArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionAndNotDimensionsArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionAndNotDimensionsArgs", "values");
            }
            return $;
        }
    }
