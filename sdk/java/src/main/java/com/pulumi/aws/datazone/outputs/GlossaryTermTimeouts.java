...
public final class GlossaryTermTimeouts {
    ...
    public static Builder builder(GlossaryTermTimeouts defaults) {
    ...
    public static final class Builder {
        private @Nullable String create;
        public Builder() {}
        public Builder(GlossaryTermTimeouts defaults) {
        ...
        public GlossaryTermTimeouts build() {
            final var _resultValue = new GlossaryTermTimeouts();
