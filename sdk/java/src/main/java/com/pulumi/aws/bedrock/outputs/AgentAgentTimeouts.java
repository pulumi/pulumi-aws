...
@CustomType
public final class AgentAgentTimeouts {
    /**
    ...
    public static Builder builder(AgentAgentTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(AgentAgentTimeouts defaults) {
        ...
        public AgentAgentTimeouts build() {
            final var _resultValue = new AgentAgentTimeouts();
