...
public final class GraphTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GraphTimeoutsArgs Empty = new GraphTimeoutsArgs();
    ...
    private GraphTimeoutsArgs() {}

    private GraphTimeoutsArgs(GraphTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(GraphTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GraphTimeoutsArgs();
        }

        public Builder(GraphTimeoutsArgs defaults) {
            $ = new GraphTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GraphTimeoutsArgs build() {
            return $;
        }
    }
