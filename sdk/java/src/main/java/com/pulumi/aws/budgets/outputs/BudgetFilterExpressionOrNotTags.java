...
@CustomType
public final class BudgetFilterExpressionOrNotTags {
    /**
    ...
    private BudgetFilterExpressionOrNotTags() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionOrNotTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionOrNotTags defaults) {
        ...
        public BudgetFilterExpressionOrNotTags build() {
            final var _resultValue = new BudgetFilterExpressionOrNotTags();
