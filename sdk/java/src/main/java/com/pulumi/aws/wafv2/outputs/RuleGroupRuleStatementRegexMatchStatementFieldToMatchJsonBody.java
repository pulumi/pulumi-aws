...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern;
...
public final class RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody {
     ...
     * 
     */
    private RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
    ...
    public static Builder builder(RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
            if (matchPattern == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody", "matchPattern");
            }
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody", "matchScope");
            }
        ...
        public RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody build() {
            final var _resultValue = new RuleGroupRuleStatementRegexMatchStatementFieldToMatchJsonBody();
