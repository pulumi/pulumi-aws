...
@CustomType
public final class PortalTimeouts {
    /**
    ...
    public static Builder builder(PortalTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(PortalTimeouts defaults) {
        ...
        public PortalTimeouts build() {
            final var _resultValue = new PortalTimeouts();
