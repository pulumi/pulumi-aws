    ...
    public static final class Builder {
        ...
        public Builder attributeNames(List<String> attributeNames) {
            if (attributeNames == null) {
              throw new MissingRequiredPropertyException("EntityRecognizerInputDataConfigAugmentedManifest", "attributeNames");
            }
        ...
        public Builder s3Uri(String s3Uri) {
            if (s3Uri == null) {
              throw new MissingRequiredPropertyException("EntityRecognizerInputDataConfigAugmentedManifest", "s3Uri");
            }
            this.s3Uri = s3Uri;
            return this;
        }
