...
public final class V2modelsIntentConfirmationSettingConfirmationNextStepDialogAction {
    ...
    private V2modelsIntentConfirmationSettingConfirmationNextStepDialogAction() {}
    /**
     * @return If the dialog action is `ElicitSlot`, defines the slot to elicit from the user.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingConfirmationNextStepDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentConfirmationSettingConfirmationNextStepDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingConfirmationNextStepDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentConfirmationSettingConfirmationNextStepDialogAction build() {
            final var _resultValue = new V2modelsIntentConfirmationSettingConfirmationNextStepDialogAction();
