...
@CustomType
public final class AnycastIpListTimeouts {
    /**
    ...
    public static Builder builder(AnycastIpListTimeouts defaults) {
    ...
    public static final class Builder {
        private @Nullable String create;
        public Builder() {}
        public Builder(AnycastIpListTimeouts defaults) {
        ...
        public AnycastIpListTimeouts build() {
            final var _resultValue = new AnycastIpListTimeouts();
