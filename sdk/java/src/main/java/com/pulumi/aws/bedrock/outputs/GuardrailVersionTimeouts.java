...
public final class GuardrailVersionTimeouts {
    ...
    public static Builder builder(GuardrailVersionTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(GuardrailVersionTimeouts defaults) {
        ...
        public GuardrailVersionTimeouts build() {
            final var _resultValue = new GuardrailVersionTimeouts();
