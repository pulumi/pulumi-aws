...
public final class RailsAppLayerLoadBasedAutoScalingDownscaling {
    ...
    public static Builder builder(RailsAppLayerLoadBasedAutoScalingDownscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(RailsAppLayerLoadBasedAutoScalingDownscaling defaults) {
        ...
        public RailsAppLayerLoadBasedAutoScalingDownscaling build() {
            final var _resultValue = new RailsAppLayerLoadBasedAutoScalingDownscaling();
