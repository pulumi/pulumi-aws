...
public final class WebAclRuleStatementRegexMatchStatementFieldToMatchUriFragmentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleStatementRegexMatchStatementFieldToMatchUriFragmentArgs() {}

    private WebAclRuleStatementRegexMatchStatementFieldToMatchUriFragmentArgs(WebAclRuleStatementRegexMatchStatementFieldToMatchUriFragmentArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementRegexMatchStatementFieldToMatchUriFragmentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementRegexMatchStatementFieldToMatchUriFragmentArgs();
        }

        public Builder(WebAclRuleStatementRegexMatchStatementFieldToMatchUriFragmentArgs defaults) {
            $ = new WebAclRuleStatementRegexMatchStatementFieldToMatchUriFragmentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebAclRuleStatementRegexMatchStatementFieldToMatchUriFragmentArgs build() {
            return $;
        }
    }
