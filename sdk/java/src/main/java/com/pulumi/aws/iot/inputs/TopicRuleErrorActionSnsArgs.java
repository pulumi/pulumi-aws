...
public final class TopicRuleErrorActionSnsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TopicRuleErrorActionSnsArgs build() {
            if ($.roleArn == null) {
                throw new MissingRequiredPropertyException("TopicRuleErrorActionSnsArgs", "roleArn");
            }
            if ($.targetArn == null) {
                throw new MissingRequiredPropertyException("TopicRuleErrorActionSnsArgs", "targetArn");
            }
            return $;
        }
    }
