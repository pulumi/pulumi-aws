...
public final class ResourceLfTagsTableWithColumnsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ResourceLfTagsTableWithColumnsArgs(ResourceLfTagsTableWithColumnsArgs $) {
    ...
    public static Builder builder(ResourceLfTagsTableWithColumnsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ResourceLfTagsTableWithColumnsArgs();
        }

        public Builder(ResourceLfTagsTableWithColumnsArgs defaults) {
            $ = new ResourceLfTagsTableWithColumnsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ResourceLfTagsTableWithColumnsArgs build() {
            if ($.databaseName == null) {
                throw new MissingRequiredPropertyException("ResourceLfTagsTableWithColumnsArgs", "databaseName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("ResourceLfTagsTableWithColumnsArgs", "name");
            }
            return $;
        }
    }
