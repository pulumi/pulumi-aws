...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternAll;
...
public final class WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern {
    ...
    public static Builder builder(WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedHeaders;
        public Builder() {}
        public Builder(WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPattern defaults) {
        ...
        @CustomType.Setter
        public Builder all(@Nullable WebAclRuleStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternAll all) {
            this.all = all;
            return this;
        }
        @CustomType.Setter
