...
public final class CostCategoryRuleRuleNotOrCostCategory {
    ...
    public static Builder builder(CostCategoryRuleRuleNotOrCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleNotOrCostCategory defaults) {
        ...
        public CostCategoryRuleRuleNotOrCostCategory build() {
            final var _resultValue = new CostCategoryRuleRuleNotOrCostCategory();
