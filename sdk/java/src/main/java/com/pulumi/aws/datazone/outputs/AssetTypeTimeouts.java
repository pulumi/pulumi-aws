...
public final class AssetTypeTimeouts {
    ...
    public static Builder builder(AssetTypeTimeouts defaults) {
    ...
    public static final class Builder {
        private @Nullable String create;
        public Builder() {}
        public Builder(AssetTypeTimeouts defaults) {
        ...
        public AssetTypeTimeouts build() {
            final var _resultValue = new AssetTypeTimeouts();
