...
public final class GetTagsFilterTags extends com.pulumi.resources.InvokeArgs {
    ...
    private GetTagsFilterTags(GetTagsFilterTags $) {
        this.key = $.key;
    ...
    public static Builder builder(GetTagsFilterTags defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagsFilterTags();
        }

        public Builder(GetTagsFilterTags defaults) {
            $ = new GetTagsFilterTags(Objects.requireNonNull(defaults));
        }
