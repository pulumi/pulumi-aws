...
@CustomType
public final class RouteServerVpcAssociationTimeouts {
    /**
    ...
    public static Builder builder(RouteServerVpcAssociationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(RouteServerVpcAssociationTimeouts defaults) {
        ...
        public RouteServerVpcAssociationTimeouts build() {
            final var _resultValue = new RouteServerVpcAssociationTimeouts();
