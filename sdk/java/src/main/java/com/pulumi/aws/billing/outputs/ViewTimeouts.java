...
@CustomType
public final class ViewTimeouts {
    /**
    ...
    public static Builder builder(ViewTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ViewTimeouts defaults) {
        ...
        public ViewTimeouts build() {
            final var _resultValue = new ViewTimeouts();
