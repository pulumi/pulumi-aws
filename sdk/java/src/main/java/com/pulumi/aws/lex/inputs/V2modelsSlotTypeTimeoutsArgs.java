...
public final class V2modelsSlotTypeTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsSlotTypeTimeoutsArgs Empty = new V2modelsSlotTypeTimeoutsArgs();
    ...
    private V2modelsSlotTypeTimeoutsArgs() {}

    private V2modelsSlotTypeTimeoutsArgs(V2modelsSlotTypeTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(V2modelsSlotTypeTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsSlotTypeTimeoutsArgs();
        }

        public Builder(V2modelsSlotTypeTimeoutsArgs defaults) {
            $ = new V2modelsSlotTypeTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsSlotTypeTimeoutsArgs build() {
            return $;
        }
    }
