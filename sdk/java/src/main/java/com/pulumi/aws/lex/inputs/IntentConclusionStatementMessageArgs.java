...
public final class IntentConclusionStatementMessageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private IntentConclusionStatementMessageArgs(IntentConclusionStatementMessageArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntentConclusionStatementMessageArgs();
        }
        ...
        public IntentConclusionStatementMessageArgs build() {
            if ($.content == null) {
                throw new MissingRequiredPropertyException("IntentConclusionStatementMessageArgs", "content");
            }
            if ($.contentType == null) {
                throw new MissingRequiredPropertyException("IntentConclusionStatementMessageArgs", "contentType");
            }
            return $;
        }
    }
