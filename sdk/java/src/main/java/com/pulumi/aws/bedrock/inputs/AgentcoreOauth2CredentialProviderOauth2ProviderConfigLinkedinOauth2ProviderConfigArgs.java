...
import com.pulumi.aws.bedrock.inputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigClientSecretConfigArgs;
import com.pulumi.aws.bedrock.inputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscoveryArgs;
...
public final class AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs Empty = new AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs();
    ...
    private @Nullable Output<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigClientSecretConfigArgs> clientSecretConfig;
     ...
     * 
     */
    public Optional<Output<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigClientSecretConfigArgs>> clientSecretConfig() {
    ...
    private @Nullable Output<List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscoveryArgs>> oauthDiscoveries;
     ...
     * 
     */
    public Optional<Output<List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscoveryArgs>>> oauthDiscoveries() {
        return Optional.ofNullable(this.oauthDiscoveries);
    }

    private AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs() {}

    private AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs(AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs $) {
    ...
    public static Builder builder(AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs();
        }

        public Builder(AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs defaults) {
            $ = new AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder clientSecretConfig(@Nullable Output<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigClientSecretConfigArgs> clientSecretConfig) {
         ...
         * 
         */
        public Builder clientSecretConfig(AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigClientSecretConfigArgs clientSecretConfig) {
         ...
         * 
         */
        public Builder oauthDiscoveries(@Nullable Output<List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscoveryArgs>> oauthDiscoveries) {
         ...
         * 
         */
        public Builder oauthDiscoveries(List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscoveryArgs> oauthDiscoveries) {
         ...
         * 
         */
        public Builder oauthDiscoveries(AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigOauthDiscoveryArgs... oauthDiscoveries) {
            return oauthDiscoveries(List.of(oauthDiscoveries));
        }

        public AgentcoreOauth2CredentialProviderOauth2ProviderConfigLinkedinOauth2ProviderConfigArgs build() {
            return $;
        }
    }
