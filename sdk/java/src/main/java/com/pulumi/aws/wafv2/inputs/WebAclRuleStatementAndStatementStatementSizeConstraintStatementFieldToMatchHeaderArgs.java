...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs Empty = new WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs();
    ...
    private Output<WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs() {}

    private WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs(WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs();
        }

        public Builder(WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs defaults) {
            $ = new WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs build() {
