...
public final class GetNetworkInterfaceFilter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetNetworkInterfaceFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetNetworkInterfaceFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetNetworkInterfaceFilter build() {
            final var _resultValue = new GetNetworkInterfaceFilter();
