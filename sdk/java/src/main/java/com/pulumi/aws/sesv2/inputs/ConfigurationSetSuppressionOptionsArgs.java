...
public final class ConfigurationSetSuppressionOptionsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return List that contains the reasons that email addresses are automatically added to the suppression list for your account. Valid values: `BOUNCE`, `COMPLAINT`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param suppressedReasons List that contains the reasons that email addresses are automatically added to the suppression list for your account. Valid values: `BOUNCE`, `COMPLAINT`.
         * 
         * @return builder
         * 
         */
