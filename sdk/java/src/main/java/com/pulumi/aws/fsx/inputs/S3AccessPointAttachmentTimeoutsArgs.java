...
public final class S3AccessPointAttachmentTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final S3AccessPointAttachmentTimeoutsArgs Empty = new S3AccessPointAttachmentTimeoutsArgs();
    ...
    private S3AccessPointAttachmentTimeoutsArgs() {}

    private S3AccessPointAttachmentTimeoutsArgs(S3AccessPointAttachmentTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
    }
    ...
    public static Builder builder(S3AccessPointAttachmentTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new S3AccessPointAttachmentTimeoutsArgs();
        }

        public Builder(S3AccessPointAttachmentTimeoutsArgs defaults) {
            $ = new S3AccessPointAttachmentTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public S3AccessPointAttachmentTimeoutsArgs build() {
            return $;
        }
    }
