...
public final class InsightFiltersResourceAwsIamAccessKeyStatus {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsIamAccessKeyStatus", "comparison");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceAwsIamAccessKeyStatus", "value");
            }
            this.value = value;
            return this;
        }
