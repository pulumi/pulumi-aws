...
public final class PipelineTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PipelineTimeoutsArgs Empty = new PipelineTimeoutsArgs();
    ...
    private PipelineTimeoutsArgs() {}

    private PipelineTimeoutsArgs(PipelineTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(PipelineTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineTimeoutsArgs();
        }

        public Builder(PipelineTimeoutsArgs defaults) {
            $ = new PipelineTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineTimeoutsArgs build() {
            return $;
        }
    }
