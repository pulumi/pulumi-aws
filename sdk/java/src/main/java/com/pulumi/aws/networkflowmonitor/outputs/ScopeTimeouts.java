...
@CustomType
public final class ScopeTimeouts {
    /**
    ...
    public static Builder builder(ScopeTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ScopeTimeouts defaults) {
        ...
        public ScopeTimeouts build() {
            final var _resultValue = new ScopeTimeouts();
