...
public final class SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs Empty = new SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs();
    ...
    private SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs() {}

    private SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs(SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs $) {
    ...
    public static Builder builder(SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs();
        }

        public Builder(SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs defaults) {
            $ = new SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs build() {
            if ($.appImageConfigName == null) {
                throw new MissingRequiredPropertyException("SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs", "appImageConfigName");
            }
            if ($.imageName == null) {
                throw new MissingRequiredPropertyException("SpaceSpaceSettingsKernelGatewayAppSettingsCustomImageArgs", "imageName");
            }
            return $;
        }
    }
