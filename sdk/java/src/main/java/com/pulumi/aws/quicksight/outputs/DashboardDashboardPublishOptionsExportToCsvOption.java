...
public final class DashboardDashboardPublishOptionsExportToCsvOption {
    ...
    public static Builder builder(DashboardDashboardPublishOptionsExportToCsvOption defaults) {
    ...
    public static final class Builder {
        private @Nullable String availabilityStatus;
        public Builder() {}
        public Builder(DashboardDashboardPublishOptionsExportToCsvOption defaults) {
