...
public final class PermissionTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PermissionTimeoutsArgs Empty = new PermissionTimeoutsArgs();
    ...
    private PermissionTimeoutsArgs() {}

    private PermissionTimeoutsArgs(PermissionTimeoutsArgs $) {
        this.delete = $.delete;
    }
    ...
    public static Builder builder(PermissionTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PermissionTimeoutsArgs();
        }

        public Builder(PermissionTimeoutsArgs defaults) {
            $ = new PermissionTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PermissionTimeoutsArgs build() {
            return $;
        }
    }
