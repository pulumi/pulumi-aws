...
public final class FilterFilterCriteriaEcrImagePushedAt {
    ...
    public static Builder builder(FilterFilterCriteriaEcrImagePushedAt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startInclusive;
        public Builder() {}
        public Builder(FilterFilterCriteriaEcrImagePushedAt defaults) {
        ...
        public FilterFilterCriteriaEcrImagePushedAt build() {
            final var _resultValue = new FilterFilterCriteriaEcrImagePushedAt();
