...
@CustomType
public final class AgentFlowTimeouts {
    /**
    ...
    public static Builder builder(AgentFlowTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(AgentFlowTimeouts defaults) {
        ...
        public AgentFlowTimeouts build() {
            final var _resultValue = new AgentFlowTimeouts();
