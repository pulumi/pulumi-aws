...
public final class PatchBaselineArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param approvedPatches List of explicitly approved patches for the baseline. Cannot be specified with `approvalRule`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param rejectedPatchesAction Action for Patch Manager to take on patches included in the `rejectedPatches` list. Valid values are `ALLOW_AS_DEPENDENCY` and `BLOCK`.
         * 
         * @return builder
         * 
         */
