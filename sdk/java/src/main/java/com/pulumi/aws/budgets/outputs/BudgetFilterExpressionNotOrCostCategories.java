...
@CustomType
public final class BudgetFilterExpressionNotOrCostCategories {
    /**
    ...
    private BudgetFilterExpressionNotOrCostCategories() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionNotOrCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotOrCostCategories defaults) {
        ...
        public BudgetFilterExpressionNotOrCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionNotOrCostCategories();
