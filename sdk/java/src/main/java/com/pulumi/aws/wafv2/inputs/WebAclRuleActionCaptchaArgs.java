...
public final class WebAclRuleActionCaptchaArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleActionCaptchaArgs(WebAclRuleActionCaptchaArgs $) {
    ...
    public static Builder builder(WebAclRuleActionCaptchaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleActionCaptchaArgs();
        }
