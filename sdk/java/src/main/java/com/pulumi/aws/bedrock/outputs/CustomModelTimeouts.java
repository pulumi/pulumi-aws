...
@CustomType
public final class CustomModelTimeouts {
    /**
    ...
    public static Builder builder(CustomModelTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(CustomModelTimeouts defaults) {
        ...
        public CustomModelTimeouts build() {
            final var _resultValue = new CustomModelTimeouts();
