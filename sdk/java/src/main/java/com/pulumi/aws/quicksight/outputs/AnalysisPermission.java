...
public final class AnalysisPermission {
    ...
    public static Builder builder(AnalysisPermission defaults) {
    ...
    public static final class Builder {
        ...
        private String principal;
        public Builder() {}
        public Builder(AnalysisPermission defaults) {
        ...
        public Builder actions(List<String> actions) {
            if (actions == null) {
              throw new MissingRequiredPropertyException("AnalysisPermission", "actions");
            }
        ...
        public Builder principal(String principal) {
            if (principal == null) {
              throw new MissingRequiredPropertyException("AnalysisPermission", "principal");
            }
            this.principal = principal;
            return this;
        }
        public AnalysisPermission build() {
            final var _resultValue = new AnalysisPermission();
