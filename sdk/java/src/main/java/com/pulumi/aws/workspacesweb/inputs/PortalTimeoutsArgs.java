...
public final class PortalTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PortalTimeoutsArgs Empty = new PortalTimeoutsArgs();
    ...
    private PortalTimeoutsArgs() {}

    private PortalTimeoutsArgs(PortalTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(PortalTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PortalTimeoutsArgs();
        }

        public Builder(PortalTimeoutsArgs defaults) {
            $ = new PortalTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PortalTimeoutsArgs build() {
            return $;
        }
    }
