...
public final class ThemePermission {
    ...
    public static Builder builder(ThemePermission defaults) {
    ...
    public static final class Builder {
        ...
        private String principal;
        public Builder() {}
        public Builder(ThemePermission defaults) {
        ...
        public Builder actions(List<String> actions) {
            if (actions == null) {
              throw new MissingRequiredPropertyException("ThemePermission", "actions");
            }
        ...
        public Builder principal(String principal) {
            if (principal == null) {
              throw new MissingRequiredPropertyException("ThemePermission", "principal");
            }
