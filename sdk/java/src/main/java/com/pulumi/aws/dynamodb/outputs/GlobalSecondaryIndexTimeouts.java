...
@CustomType
public final class GlobalSecondaryIndexTimeouts {
    /**
    ...
    public static Builder builder(GlobalSecondaryIndexTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(GlobalSecondaryIndexTimeouts defaults) {
        ...
        public GlobalSecondaryIndexTimeouts build() {
            final var _resultValue = new GlobalSecondaryIndexTimeouts();
