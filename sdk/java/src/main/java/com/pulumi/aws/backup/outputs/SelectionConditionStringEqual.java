...
public final class SelectionConditionStringEqual {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("SelectionConditionStringEqual", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("SelectionConditionStringEqual", "value");
            }
            this.value = value;
            return this;
        }
        public SelectionConditionStringEqual build() {
            final var _resultValue = new SelectionConditionStringEqual();
