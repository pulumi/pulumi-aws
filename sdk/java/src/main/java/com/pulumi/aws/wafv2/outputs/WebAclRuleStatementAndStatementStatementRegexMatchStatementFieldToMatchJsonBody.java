...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern;
...
@CustomType
public final class WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBody {
    /**
     ...
     * 
     */
    private WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
    ...
    private WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBody() {}
    /**
     * @return What to do when JSON parsing fails. Defaults to evaluating up to the first parsing failure. Valid values are `EVALUATE_AS_STRING`, `MATCH` and `NO_MATCH`.
     * 
     */
     ...
     * 
     */
    public WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
    ...
    public static Builder builder(WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
        ...
        public WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBody build() {
            final var o = new WebAclRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchJsonBody();
