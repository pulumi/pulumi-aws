...
@CustomType
public final class TelemetryRuleRuleDestinationConfigurationCloudtrailParametersAdvancedEventSelectorFieldSelector {
    /**
    ...
    public static Builder builder(TelemetryRuleRuleDestinationConfigurationCloudtrailParametersAdvancedEventSelectorFieldSelector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> startsWiths;
        public Builder() {}
        public Builder(TelemetryRuleRuleDestinationConfigurationCloudtrailParametersAdvancedEventSelectorFieldSelector defaults) {
        ...
        public Builder field(String field) {
            if (field == null) {
              throw new MissingRequiredPropertyException("TelemetryRuleRuleDestinationConfigurationCloudtrailParametersAdvancedEventSelectorFieldSelector", "field");
            }
            this.field = field;
            return this;
        }
        ...
        public TelemetryRuleRuleDestinationConfigurationCloudtrailParametersAdvancedEventSelectorFieldSelector build() {
            final var _resultValue = new TelemetryRuleRuleDestinationConfigurationCloudtrailParametersAdvancedEventSelectorFieldSelector();
