...
public class AccountVdmAttributes extends com.pulumi.resources.CustomResource {
     ...
     */
    public AccountVdmAttributes(java.lang.String name) {
     ...
     */
    public AccountVdmAttributes(java.lang.String name, AccountVdmAttributesArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AccountVdmAttributes(java.lang.String name, AccountVdmAttributesArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:sesv2/accountVdmAttributes:AccountVdmAttributes", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AccountVdmAttributes(java.lang.String name, Output<java.lang.String> id, @Nullable AccountVdmAttributesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:sesv2/accountVdmAttributes:AccountVdmAttributes", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static AccountVdmAttributes get(java.lang.String name, Output<java.lang.String> id, @Nullable AccountVdmAttributesState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
