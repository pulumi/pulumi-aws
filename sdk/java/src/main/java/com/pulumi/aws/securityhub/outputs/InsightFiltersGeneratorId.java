...
public final class InsightFiltersGeneratorId {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersGeneratorId", "comparison");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersGeneratorId", "value");
            }
            this.value = value;
            return this;
        }
        public InsightFiltersGeneratorId build() {
            final var _resultValue = new InsightFiltersGeneratorId();
