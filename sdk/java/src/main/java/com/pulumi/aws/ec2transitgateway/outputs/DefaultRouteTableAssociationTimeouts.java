...
public final class DefaultRouteTableAssociationTimeouts {
    ...
    public static Builder builder(DefaultRouteTableAssociationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(DefaultRouteTableAssociationTimeouts defaults) {
        ...
        public DefaultRouteTableAssociationTimeouts build() {
            final var _resultValue = new DefaultRouteTableAssociationTimeouts();
