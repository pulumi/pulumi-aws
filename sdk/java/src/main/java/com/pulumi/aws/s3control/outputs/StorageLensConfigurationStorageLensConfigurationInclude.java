...
public final class StorageLensConfigurationStorageLensConfigurationInclude {
    ...
    public static Builder builder(StorageLensConfigurationStorageLensConfigurationInclude defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> regions;
        public Builder() {}
        public Builder(StorageLensConfigurationStorageLensConfigurationInclude defaults) {
