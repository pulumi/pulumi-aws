...
@CustomType
public final class BudgetFilterExpressionNotNotDimensions {
    /**
    ...
    private BudgetFilterExpressionNotNotDimensions() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionNotNotDimensions defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotNotDimensions defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionNotNotDimensions", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionNotNotDimensions", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public BudgetFilterExpressionNotNotDimensions build() {
            final var _resultValue = new BudgetFilterExpressionNotNotDimensions();
