...
public final class RouteSpecHttp2RouteTimeoutIdle {
    ...
    public static final class Builder {
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("RouteSpecHttp2RouteTimeoutIdle", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder value(Integer value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("RouteSpecHttp2RouteTimeoutIdle", "value");
            }
            this.value = value;
            return this;
        }
        public RouteSpecHttp2RouteTimeoutIdle build() {
            final var _resultValue = new RouteSpecHttp2RouteTimeoutIdle();
