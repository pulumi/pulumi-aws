...
@CustomType
public final class ResiliencyPolicyTimeouts {
    /**
    ...
    public static Builder builder(ResiliencyPolicyTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ResiliencyPolicyTimeouts defaults) {
        ...
        public ResiliencyPolicyTimeouts build() {
            final var _resultValue = new ResiliencyPolicyTimeouts();
