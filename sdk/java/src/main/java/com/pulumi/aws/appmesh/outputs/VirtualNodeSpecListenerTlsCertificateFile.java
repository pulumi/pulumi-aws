    ...
    public static final class Builder {
        ...
        public Builder certificateChain(String certificateChain) {
            if (certificateChain == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecListenerTlsCertificateFile", "certificateChain");
            }
        ...
        public Builder privateKey(String privateKey) {
            if (privateKey == null) {
              throw new MissingRequiredPropertyException("VirtualNodeSpecListenerTlsCertificateFile", "privateKey");
            }
