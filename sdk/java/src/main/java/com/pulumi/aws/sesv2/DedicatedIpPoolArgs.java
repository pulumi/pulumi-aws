...
public final class DedicatedIpPoolArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Map of tags to assign to the pool. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param tags Map of tags to assign to the pool. If configured with a provider `defaultTags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
         * 
         * @return builder
         * 
         */
