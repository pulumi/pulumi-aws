...
public final class CostCategoryRuleRuleTagsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CostCategoryRuleRuleTagsArgs Empty = new CostCategoryRuleRuleTagsArgs();
    ...
    private CostCategoryRuleRuleTagsArgs() {}

    private CostCategoryRuleRuleTagsArgs(CostCategoryRuleRuleTagsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(CostCategoryRuleRuleTagsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CostCategoryRuleRuleTagsArgs();
        }

        public Builder(CostCategoryRuleRuleTagsArgs defaults) {
            $ = new CostCategoryRuleRuleTagsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CostCategoryRuleRuleTagsArgs build() {
            return $;
        }
    }
