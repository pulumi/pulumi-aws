...
@CustomType
public final class BudgetFilterExpressionAndAndTags {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionAndAndTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionAndAndTags defaults) {
        ...
        public BudgetFilterExpressionAndAndTags build() {
            final var _resultValue = new BudgetFilterExpressionAndAndTags();
