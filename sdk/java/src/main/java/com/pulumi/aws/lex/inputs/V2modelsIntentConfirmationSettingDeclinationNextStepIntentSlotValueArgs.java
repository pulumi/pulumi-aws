...
public final class V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs Empty = new V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs();
    ...
    private V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs() {}

    private V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs(V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs $) {
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs();
        }

        public Builder(V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs defaults) {
            $ = new V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentConfirmationSettingDeclinationNextStepIntentSlotValueArgs build() {
            return $;
        }
    }
