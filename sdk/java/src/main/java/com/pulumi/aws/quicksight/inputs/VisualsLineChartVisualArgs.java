...
public final class VisualsLineChartVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsLineChartVisualArgs Empty = new VisualsLineChartVisualArgs();
    ...
    private @Nullable Output<VisualsLineChartVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsLineChartVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsLineChartVisualArgs() {}

    private VisualsLineChartVisualArgs(VisualsLineChartVisualArgs $) {
    ...
    public static Builder builder(VisualsLineChartVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsLineChartVisualArgs();
        }

        public Builder(VisualsLineChartVisualArgs defaults) {
            $ = new VisualsLineChartVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsLineChartVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsLineChartVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsLineChartVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsLineChartVisualArgs", "visualId");
            }
            return $;
        }
    }
