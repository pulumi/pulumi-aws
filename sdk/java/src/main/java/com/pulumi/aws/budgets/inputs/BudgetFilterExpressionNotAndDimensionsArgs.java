...
public final class BudgetFilterExpressionNotAndDimensionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionNotAndDimensionsArgs Empty = new BudgetFilterExpressionNotAndDimensionsArgs();
    ...
    private BudgetFilterExpressionNotAndDimensionsArgs() {}

    private BudgetFilterExpressionNotAndDimensionsArgs(BudgetFilterExpressionNotAndDimensionsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionNotAndDimensionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionNotAndDimensionsArgs();
        }

        public Builder(BudgetFilterExpressionNotAndDimensionsArgs defaults) {
            $ = new BudgetFilterExpressionNotAndDimensionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionNotAndDimensionsArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionNotAndDimensionsArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionNotAndDimensionsArgs", "values");
            }
            return $;
        }
    }
