...
@CustomType
public final class InvoiceUnitTimeouts {
    /**
    ...
    public static Builder builder(InvoiceUnitTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(InvoiceUnitTimeouts defaults) {
        ...
        public InvoiceUnitTimeouts build() {
            final var _resultValue = new InvoiceUnitTimeouts();
