...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs Empty = new WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs();
    ...
    private Output<WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs() {}

    private WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs(WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs();
        }

        public Builder(WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs defaults) {
            $ = new WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementOrStatementStatementSizeConstraintStatementFieldToMatchHeaderArgs build() {
