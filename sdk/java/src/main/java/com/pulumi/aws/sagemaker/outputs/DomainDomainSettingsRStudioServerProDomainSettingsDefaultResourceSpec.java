...
@CustomType
public final class DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec {
    /**
    ...
    private DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec() {}
    /**
     * @return The instance type that the image version runs on.. For valid values see [SageMaker AI Instance Types](https://docs.aws.amazon.com/sagemaker/latest/dg/notebooks-available-instance-types.html).
     * 
     */
    ...
    public static Builder builder(DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sagemakerImageVersionArn;
        public Builder() {}
        public Builder(DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec defaults) {
        ...
        public DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec build() {
            final var _resultValue = new DomainDomainSettingsRStudioServerProDomainSettingsDefaultResourceSpec();
