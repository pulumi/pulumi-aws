...
public final class UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting {
    ...
    public static Builder builder(UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String status;
        public Builder() {}
        public Builder(UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting defaults) {
        ...
        public UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting build() {
            final var _resultValue = new UserProfileUserSettingsCanvasAppSettingsIdentityProviderOauthSetting();
