...
public class ResourceAssociation extends com.pulumi.resources.CustomResource {
     ...
     */
    public ResourceAssociation(java.lang.String name) {
     ...
     */
    public ResourceAssociation(java.lang.String name, ResourceAssociationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ResourceAssociation(java.lang.String name, ResourceAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ram/resourceAssociation:ResourceAssociation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ResourceAssociation(java.lang.String name, Output<java.lang.String> id, @Nullable ResourceAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ram/resourceAssociation:ResourceAssociation", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ResourceAssociation get(java.lang.String name, Output<java.lang.String> id, @Nullable ResourceAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
