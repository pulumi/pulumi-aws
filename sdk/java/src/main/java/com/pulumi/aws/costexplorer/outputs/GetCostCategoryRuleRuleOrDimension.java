...
public final class GetCostCategoryRuleRuleOrDimension {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleOrDimension", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder matchOptions(List<String> matchOptions) {
            if (matchOptions == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleOrDimension", "matchOptions");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleOrDimension", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetCostCategoryRuleRuleOrDimension build() {
            final var _resultValue = new GetCostCategoryRuleRuleOrDimension();
