...
import com.pulumi.aws.workspaces.inputs.WebBrowserSettingsState;
...
public class WebBrowserSettings extends com.pulumi.resources.CustomResource {
     ...
     */
    public WebBrowserSettings(java.lang.String name) {
        this(name, WebBrowserSettingsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WebBrowserSettings(java.lang.String name, WebBrowserSettingsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebBrowserSettings(java.lang.String name, WebBrowserSettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:workspaces/webBrowserSettings:WebBrowserSettings", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebBrowserSettings(java.lang.String name, Output<java.lang.String> id, @Nullable WebBrowserSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:workspaces/webBrowserSettings:WebBrowserSettings", name, state, makeResourceOptions(options, id), false);
    }

    private static WebBrowserSettingsArgs makeArgs(WebBrowserSettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebBrowserSettingsArgs.Empty : args;
    }
     ...
     */
    public static WebBrowserSettings get(java.lang.String name, Output<java.lang.String> id, @Nullable WebBrowserSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
