...
@CustomType
public final class BudgetFilterExpressionAndNotCostCategories {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionAndNotCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionAndNotCostCategories defaults) {
        ...
        public BudgetFilterExpressionAndNotCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionAndNotCostCategories();
