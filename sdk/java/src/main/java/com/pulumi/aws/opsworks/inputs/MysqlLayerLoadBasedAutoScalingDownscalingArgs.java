...
public final class MysqlLayerLoadBasedAutoScalingDownscalingArgs extends com.pulumi.resources.ResourceArgs {

    public static final MysqlLayerLoadBasedAutoScalingDownscalingArgs Empty = new MysqlLayerLoadBasedAutoScalingDownscalingArgs();
    ...
    private MysqlLayerLoadBasedAutoScalingDownscalingArgs(MysqlLayerLoadBasedAutoScalingDownscalingArgs $) {
        this.alarms = $.alarms;
    ...
    public static Builder builder(MysqlLayerLoadBasedAutoScalingDownscalingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MysqlLayerLoadBasedAutoScalingDownscalingArgs();
        }

        public Builder(MysqlLayerLoadBasedAutoScalingDownscalingArgs defaults) {
            $ = new MysqlLayerLoadBasedAutoScalingDownscalingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MysqlLayerLoadBasedAutoScalingDownscalingArgs build() {
            return $;
        }
    }
