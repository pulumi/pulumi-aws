...
public final class FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfig {
    ...
    private FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfig(
    ...
    public static Builder builder(FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfig defaults) {
        ...
        public Builder failOnFirstDestinationError(@Nullable Boolean failOnFirstDestinationError) {
            this.failOnFirstDestinationError = failOnFirstDestinationError;
            return this;
        }        public FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfig build() {
            return new FlowDestinationFlowConfigDestinationConnectorPropertiesMarketoErrorHandlingConfig(bucketName, bucketPrefix, failOnFirstDestinationError);
        }
    }
}
