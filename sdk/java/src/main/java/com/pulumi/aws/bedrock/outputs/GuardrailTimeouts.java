...
public final class GuardrailTimeouts {
    ...
    public static Builder builder(GuardrailTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(GuardrailTimeouts defaults) {
        ...
        public GuardrailTimeouts build() {
            final var _resultValue = new GuardrailTimeouts();
