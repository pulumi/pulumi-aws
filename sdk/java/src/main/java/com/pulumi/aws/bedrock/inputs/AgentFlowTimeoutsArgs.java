...
public final class AgentFlowTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AgentFlowTimeoutsArgs Empty = new AgentFlowTimeoutsArgs();
    ...
    private AgentFlowTimeoutsArgs() {}

    private AgentFlowTimeoutsArgs(AgentFlowTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(AgentFlowTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AgentFlowTimeoutsArgs();
        }

        public Builder(AgentFlowTimeoutsArgs defaults) {
            $ = new AgentFlowTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AgentFlowTimeoutsArgs build() {
            return $;
        }
    }
