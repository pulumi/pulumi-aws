...
@CustomType
public final class TelemetryRuleForOrganizationTimeouts {
    /**
    ...
    public static Builder builder(TelemetryRuleForOrganizationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(TelemetryRuleForOrganizationTimeouts defaults) {
        ...
        public TelemetryRuleForOrganizationTimeouts build() {
            final var _resultValue = new TelemetryRuleForOrganizationTimeouts();
