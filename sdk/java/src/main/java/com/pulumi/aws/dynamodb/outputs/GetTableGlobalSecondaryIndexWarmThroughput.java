...
@CustomType
public final class GetTableGlobalSecondaryIndexWarmThroughput {
    private Integer readUnitsPerSecond;
    private Integer writeUnitsPerSecond;

    private GetTableGlobalSecondaryIndexWarmThroughput() {}
    ...
    public static Builder builder(GetTableGlobalSecondaryIndexWarmThroughput defaults) {
    ...
    public static final class Builder {
        ...
        private Integer writeUnitsPerSecond;
        public Builder() {}
        public Builder(GetTableGlobalSecondaryIndexWarmThroughput defaults) {
        ...
        public Builder readUnitsPerSecond(Integer readUnitsPerSecond) {
            if (readUnitsPerSecond == null) {
              throw new MissingRequiredPropertyException("GetTableGlobalSecondaryIndexWarmThroughput", "readUnitsPerSecond");
            }
        ...
        public Builder writeUnitsPerSecond(Integer writeUnitsPerSecond) {
            if (writeUnitsPerSecond == null) {
              throw new MissingRequiredPropertyException("GetTableGlobalSecondaryIndexWarmThroughput", "writeUnitsPerSecond");
            }
            this.writeUnitsPerSecond = writeUnitsPerSecond;
            return this;
        }
        public GetTableGlobalSecondaryIndexWarmThroughput build() {
            final var _resultValue = new GetTableGlobalSecondaryIndexWarmThroughput();
