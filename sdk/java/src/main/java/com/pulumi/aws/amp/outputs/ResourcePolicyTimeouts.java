...
@CustomType
public final class ResourcePolicyTimeouts {
    /**
    ...
    public static Builder builder(ResourcePolicyTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ResourcePolicyTimeouts defaults) {
        ...
        public ResourcePolicyTimeouts build() {
            final var _resultValue = new ResourcePolicyTimeouts();
