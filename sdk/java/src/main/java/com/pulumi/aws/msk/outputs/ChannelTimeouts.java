...
@CustomType
public final class ChannelTimeouts {
    /**
    ...
    public static Builder builder(ChannelTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ChannelTimeouts defaults) {
        ...
        public ChannelTimeouts build() {
            final var _resultValue = new ChannelTimeouts();
