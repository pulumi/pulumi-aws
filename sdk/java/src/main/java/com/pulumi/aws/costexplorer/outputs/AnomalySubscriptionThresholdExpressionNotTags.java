...
@CustomType
public final class AnomalySubscriptionThresholdExpressionNotTags {
    /**
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionNotTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionNotTags defaults) {
        ...
        public AnomalySubscriptionThresholdExpressionNotTags build() {
            final var _resultValue = new AnomalySubscriptionThresholdExpressionNotTags();
