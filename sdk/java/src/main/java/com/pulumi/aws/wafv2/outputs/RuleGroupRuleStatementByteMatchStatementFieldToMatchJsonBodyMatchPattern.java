...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternAll;
...
public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern {
    ...
    public static Builder builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedPaths;
        public Builder() {}
        public Builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPattern defaults) {
        ...
        @CustomType.Setter
        public Builder all(@Nullable RuleGroupRuleStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternAll all) {
