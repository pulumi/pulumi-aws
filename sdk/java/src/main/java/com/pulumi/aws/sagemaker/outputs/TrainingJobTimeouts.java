...
@CustomType
public final class TrainingJobTimeouts {
    /**
    ...
    public static Builder builder(TrainingJobTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(TrainingJobTimeouts defaults) {
        ...
        public TrainingJobTimeouts build() {
            final var _resultValue = new TrainingJobTimeouts();
