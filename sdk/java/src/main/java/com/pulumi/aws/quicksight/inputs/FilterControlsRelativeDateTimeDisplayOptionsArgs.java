...
public final class FilterControlsRelativeDateTimeDisplayOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final FilterControlsRelativeDateTimeDisplayOptionsArgs Empty = new FilterControlsRelativeDateTimeDisplayOptionsArgs();
    ...
    private FilterControlsRelativeDateTimeDisplayOptionsArgs(FilterControlsRelativeDateTimeDisplayOptionsArgs $) {
    ...
    public static Builder builder(FilterControlsRelativeDateTimeDisplayOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FilterControlsRelativeDateTimeDisplayOptionsArgs();
        }

        public Builder(FilterControlsRelativeDateTimeDisplayOptionsArgs defaults) {
            $ = new FilterControlsRelativeDateTimeDisplayOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FilterControlsRelativeDateTimeDisplayOptionsArgs build() {
            return $;
        }
    }
