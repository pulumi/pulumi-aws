...
@CustomType
public final class PlanTimeouts {
    /**
    ...
    public static Builder builder(PlanTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(PlanTimeouts defaults) {
        ...
        public PlanTimeouts build() {
            final var _resultValue = new PlanTimeouts();
