...
@CustomType
public final class PipelineTriggerAllGitConfigurationPushFilePath {
    /**
    ...
    public static Builder builder(PipelineTriggerAllGitConfigurationPushFilePath defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(PipelineTriggerAllGitConfigurationPushFilePath defaults) {
        ...
        public PipelineTriggerAllGitConfigurationPushFilePath build() {
            final var _resultValue = new PipelineTriggerAllGitConfigurationPushFilePath();
