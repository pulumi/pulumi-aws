...
public final class VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs Empty = new VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs();
    ...
    private VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs() {}

    private VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs(VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs $) {
    ...
    public static Builder builder(VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs();
        }

        public Builder(VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs defaults) {
            $ = new VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VisualsPivotTableVisualChartConfigurationTotalOptionsRowTotalOptionsArgs build() {
            return $;
        }
    }
