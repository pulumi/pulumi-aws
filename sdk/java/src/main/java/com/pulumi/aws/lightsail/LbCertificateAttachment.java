...
public class LbCertificateAttachment extends com.pulumi.resources.CustomResource {
    ...
    public LbCertificateAttachment(String name, LbCertificateAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:lightsail/lbCertificateAttachment:LbCertificateAttachment", name, args == null ? LbCertificateAttachmentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
