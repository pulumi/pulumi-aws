...
public class LbCertificateAttachment extends com.pulumi.resources.CustomResource {
     ...
     */
    public LbCertificateAttachment(java.lang.String name) {
     ...
     */
    public LbCertificateAttachment(java.lang.String name, LbCertificateAttachmentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LbCertificateAttachment(java.lang.String name, LbCertificateAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:lightsail/lbCertificateAttachment:LbCertificateAttachment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LbCertificateAttachment(java.lang.String name, Output<java.lang.String> id, @Nullable LbCertificateAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:lightsail/lbCertificateAttachment:LbCertificateAttachment", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LbCertificateAttachment get(java.lang.String name, Output<java.lang.String> id, @Nullable LbCertificateAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
