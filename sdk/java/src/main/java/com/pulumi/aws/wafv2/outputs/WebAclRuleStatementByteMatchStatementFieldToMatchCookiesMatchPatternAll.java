...
public final class WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternAll {
    ...
    public static Builder builder(WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternAll defaults) {
        return new Builder(defaults);
    }
    @CustomType.Builder
    public static final class Builder {
        public Builder() {}
        public Builder(WebAclRuleStatementByteMatchStatementFieldToMatchCookiesMatchPatternAll defaults) {
