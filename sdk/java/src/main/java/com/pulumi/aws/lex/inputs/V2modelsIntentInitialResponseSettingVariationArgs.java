...
public final class V2modelsIntentInitialResponseSettingVariationArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentInitialResponseSettingVariationArgs Empty = new V2modelsIntentInitialResponseSettingVariationArgs();
    ...
    private V2modelsIntentInitialResponseSettingVariationArgs(V2modelsIntentInitialResponseSettingVariationArgs $) {
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingVariationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentInitialResponseSettingVariationArgs();
        }

        public Builder(V2modelsIntentInitialResponseSettingVariationArgs defaults) {
            $ = new V2modelsIntentInitialResponseSettingVariationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentInitialResponseSettingVariationArgs build() {
            return $;
        }
    }
