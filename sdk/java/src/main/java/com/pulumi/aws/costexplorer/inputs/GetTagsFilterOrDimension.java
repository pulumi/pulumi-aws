...
public final class GetTagsFilterOrDimension extends com.pulumi.resources.InvokeArgs {

    public static final GetTagsFilterOrDimension Empty = new GetTagsFilterOrDimension();
    ...
    private GetTagsFilterOrDimension(GetTagsFilterOrDimension $) {
        this.key = $.key;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagsFilterOrDimension();
        }

        public Builder(GetTagsFilterOrDimension defaults) {
            $ = new GetTagsFilterOrDimension(Objects.requireNonNull(defaults));
        }
