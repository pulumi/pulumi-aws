...
public final class GetDistributionConfigurationsPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetDistributionConfigurationsPlainArgs(GetDistributionConfigurationsPlainArgs $) {
    ...
    public static Builder builder(GetDistributionConfigurationsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDistributionConfigurationsPlainArgs();
        }

        public Builder(GetDistributionConfigurationsPlainArgs defaults) {
            $ = new GetDistributionConfigurationsPlainArgs(Objects.requireNonNull(defaults));
        }
