...
public class IpGroup extends com.pulumi.resources.CustomResource {
     ...
     */
    public IpGroup(java.lang.String name, @Nullable IpGroupArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IpGroup(java.lang.String name, @Nullable IpGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:workspaces/ipGroup:IpGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private IpGroup(java.lang.String name, Output<java.lang.String> id, @Nullable IpGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:workspaces/ipGroup:IpGroup", name, state, makeResourceOptions(options, id), false);
    }
