...
public final class ClusterInstanceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Database engine version. Please note that to upgrade the `engineVersion` of the instance, it must be done on the `aws.rds.Cluster` `engineVersion`. Trying to upgrade in `aws.rds.ClusterInstance` will not update the `engineVersion`.
     * 
     */
    ...
    /**
     * @return ARN for the KMS key to encrypt Performance Insights data. When specifying `performanceInsightsKmsKeyId`, `performanceInsightsEnabled` needs to be set to true.
     * 
     */
    ...
    /**
     * @return Daily time range during which automated backups are created if automated backups are enabled. Eg: &#34;04:00-09:00&#34;. **NOTE:** If `preferredBackupWindow` is set at the cluster level, this argument **must** be omitted.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param engineVersion Database engine version. Please note that to upgrade the `engineVersion` of the instance, it must be done on the `aws.rds.Cluster` `engineVersion`. Trying to upgrade in `aws.rds.ClusterInstance` will not update the `engineVersion`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param performanceInsightsKmsKeyId ARN for the KMS key to encrypt Performance Insights data. When specifying `performanceInsightsKmsKeyId`, `performanceInsightsEnabled` needs to be set to true.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param preferredBackupWindow Daily time range during which automated backups are created if automated backups are enabled. Eg: &#34;04:00-09:00&#34;. **NOTE:** If `preferredBackupWindow` is set at the cluster level, this argument **must** be omitted.
         * 
         * @return builder
         * 
         */
