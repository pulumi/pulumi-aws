...
@CustomType
public final class GetRouteTablePropagationsFilter {
    /**
    ...
    private GetRouteTablePropagationsFilter() {}
    /**
     * @return Name of the field to filter by, as defined by
     * [the underlying AWS API](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetTransitGatewayRouteTablePropagations.html).
     * 
    ...
    public static Builder builder(GetRouteTablePropagationsFilter defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(GetRouteTablePropagationsFilter defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetRouteTablePropagationsFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetRouteTablePropagationsFilter", "values");
            }
            this.values = values;
            return this;
        }
