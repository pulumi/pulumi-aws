...
@CustomType
public final class BudgetFilterExpressionAndOrDimensions {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionAndOrDimensions defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionAndOrDimensions defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionAndOrDimensions", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("BudgetFilterExpressionAndOrDimensions", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public BudgetFilterExpressionAndOrDimensions build() {
            final var _resultValue = new BudgetFilterExpressionAndOrDimensions();
