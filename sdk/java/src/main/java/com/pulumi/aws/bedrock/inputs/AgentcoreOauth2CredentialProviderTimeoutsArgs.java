...
public final class AgentcoreOauth2CredentialProviderTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AgentcoreOauth2CredentialProviderTimeoutsArgs Empty = new AgentcoreOauth2CredentialProviderTimeoutsArgs();
    ...
    private AgentcoreOauth2CredentialProviderTimeoutsArgs() {}

    private AgentcoreOauth2CredentialProviderTimeoutsArgs(AgentcoreOauth2CredentialProviderTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(AgentcoreOauth2CredentialProviderTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AgentcoreOauth2CredentialProviderTimeoutsArgs();
        }

        public Builder(AgentcoreOauth2CredentialProviderTimeoutsArgs defaults) {
            $ = new AgentcoreOauth2CredentialProviderTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AgentcoreOauth2CredentialProviderTimeoutsArgs build() {
            return $;
        }
    }
