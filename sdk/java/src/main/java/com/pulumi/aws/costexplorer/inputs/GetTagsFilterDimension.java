...
public final class GetTagsFilterDimension extends com.pulumi.resources.InvokeArgs {

    public static final GetTagsFilterDimension Empty = new GetTagsFilterDimension();
    ...
    private GetTagsFilterDimension(GetTagsFilterDimension $) {
        this.key = $.key;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagsFilterDimension();
        }

        public Builder(GetTagsFilterDimension defaults) {
            $ = new GetTagsFilterDimension(Objects.requireNonNull(defaults));
        }
