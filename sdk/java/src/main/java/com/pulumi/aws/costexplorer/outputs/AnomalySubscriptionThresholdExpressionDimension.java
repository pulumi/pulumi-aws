...
public final class AnomalySubscriptionThresholdExpressionDimension {
    ...
    private AnomalySubscriptionThresholdExpressionDimension() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionDimension defaults) {
        ...
        public AnomalySubscriptionThresholdExpressionDimension build() {
            final var _resultValue = new AnomalySubscriptionThresholdExpressionDimension();
