...
public final class EcsClusterLayerState extends com.pulumi.resources.ResourceArgs {
    ...
    private EcsClusterLayerState(EcsClusterLayerState $) {
        this.arn = $.arn;
    ...
    public static Builder builder(EcsClusterLayerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(EcsClusterLayerState defaults) {
            $ = new EcsClusterLayerState(Objects.requireNonNull(defaults));
        }
