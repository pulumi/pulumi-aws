...
public final class IntentRejectionStatementMessageArgs extends com.pulumi.resources.ResourceArgs {

    public static final IntentRejectionStatementMessageArgs Empty = new IntentRejectionStatementMessageArgs();
    ...
    private IntentRejectionStatementMessageArgs() {}

    private IntentRejectionStatementMessageArgs(IntentRejectionStatementMessageArgs $) {
    ...
    public static Builder builder(IntentRejectionStatementMessageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntentRejectionStatementMessageArgs();
        }

        public Builder(IntentRejectionStatementMessageArgs defaults) {
            $ = new IntentRejectionStatementMessageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IntentRejectionStatementMessageArgs build() {
            if ($.content == null) {
                throw new MissingRequiredPropertyException("IntentRejectionStatementMessageArgs", "content");
            }
            if ($.contentType == null) {
                throw new MissingRequiredPropertyException("IntentRejectionStatementMessageArgs", "contentType");
            }
            return $;
        }
    }
