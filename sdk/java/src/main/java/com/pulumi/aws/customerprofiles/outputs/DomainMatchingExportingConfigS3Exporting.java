...
public final class DomainMatchingExportingConfigS3Exporting {
    ...
    public static Builder builder(DomainMatchingExportingConfigS3Exporting defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String s3KeyName;
        public Builder() {}
        public Builder(DomainMatchingExportingConfigS3Exporting defaults) {
        ...
        public Builder s3BucketName(String s3BucketName) {
            if (s3BucketName == null) {
              throw new MissingRequiredPropertyException("DomainMatchingExportingConfigS3Exporting", "s3BucketName");
            }
        ...
        public DomainMatchingExportingConfigS3Exporting build() {
            final var _resultValue = new DomainMatchingExportingConfigS3Exporting();
