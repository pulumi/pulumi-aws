...
public final class ConnectionTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConnectionTimeoutsArgs Empty = new ConnectionTimeoutsArgs();
    ...
    private ConnectionTimeoutsArgs() {}

    private ConnectionTimeoutsArgs(ConnectionTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(ConnectionTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectionTimeoutsArgs();
        }

        public Builder(ConnectionTimeoutsArgs defaults) {
            $ = new ConnectionTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConnectionTimeoutsArgs build() {
            return $;
        }
    }
