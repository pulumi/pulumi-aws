...
public final class GetUserHierarchyStructureHierarchyStructureLevelThree {
    ...
    public static final class Builder {
        ...
        public Builder arn(String arn) {
            if (arn == null) {
              throw new MissingRequiredPropertyException("GetUserHierarchyStructureHierarchyStructureLevelThree", "arn");
            }
            this.arn = arn;
            return this;
        }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetUserHierarchyStructureHierarchyStructureLevelThree", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetUserHierarchyStructureHierarchyStructureLevelThree", "name");
            }
            this.name = name;
            return this;
        }
        public GetUserHierarchyStructureHierarchyStructureLevelThree build() {
            final var _resultValue = new GetUserHierarchyStructureHierarchyStructureLevelThree();
