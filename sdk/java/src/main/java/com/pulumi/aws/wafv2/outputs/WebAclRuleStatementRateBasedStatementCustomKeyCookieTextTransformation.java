...
public final class WebAclRuleStatementRateBasedStatementCustomKeyCookieTextTransformation {
    ...
    public static Builder builder(WebAclRuleStatementRateBasedStatementCustomKeyCookieTextTransformation defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(WebAclRuleStatementRateBasedStatementCustomKeyCookieTextTransformation defaults) {
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementRateBasedStatementCustomKeyCookieTextTransformation", "priority");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementRateBasedStatementCustomKeyCookieTextTransformation", "type");
            }
            this.type = type;
            return this;
        }
