...
public final class ExportExportArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param dataQueries Data query for this specific data export. See the `data_query` argument reference below.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param destinationConfigurations Destination configuration for this specific data export. See the `destination_configurations` argument reference below.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param refreshCadences Cadence for Amazon Web Services to update the export in your S3 bucket. See the `refresh_cadence` argument reference below.
         * 
         * @return builder
         * 
         */
