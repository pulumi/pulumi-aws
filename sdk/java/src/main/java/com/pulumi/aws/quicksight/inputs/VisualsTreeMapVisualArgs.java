...
public final class VisualsTreeMapVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsTreeMapVisualArgs Empty = new VisualsTreeMapVisualArgs();
    ...
    private @Nullable Output<VisualsTreeMapVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsTreeMapVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsTreeMapVisualArgs() {}

    private VisualsTreeMapVisualArgs(VisualsTreeMapVisualArgs $) {
    ...
    public static Builder builder(VisualsTreeMapVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsTreeMapVisualArgs();
        }

        public Builder(VisualsTreeMapVisualArgs defaults) {
            $ = new VisualsTreeMapVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsTreeMapVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsTreeMapVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsTreeMapVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsTreeMapVisualArgs", "visualId");
            }
            return $;
        }
    }
