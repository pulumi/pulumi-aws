...
@CustomType
public final class RouteServerTimeouts {
    /**
    ...
    public static Builder builder(RouteServerTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(RouteServerTimeouts defaults) {
        ...
        public RouteServerTimeouts build() {
            final var _resultValue = new RouteServerTimeouts();
