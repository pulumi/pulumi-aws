...
public final class InsightFiltersNetworkSourceDomain {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersNetworkSourceDomain", "comparison");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersNetworkSourceDomain", "value");
            }
            this.value = value;
            return this;
        }
