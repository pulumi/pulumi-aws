...
public final class FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor", "type");
            }
            this.type = type;
            return this;
        }
        public FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor build() {
            final var _resultValue = new FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessor();
