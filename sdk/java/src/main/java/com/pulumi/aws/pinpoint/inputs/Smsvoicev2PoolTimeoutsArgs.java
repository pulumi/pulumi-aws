...
public final class Smsvoicev2PoolTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final Smsvoicev2PoolTimeoutsArgs Empty = new Smsvoicev2PoolTimeoutsArgs();
    ...
    private Smsvoicev2PoolTimeoutsArgs() {}

    private Smsvoicev2PoolTimeoutsArgs(Smsvoicev2PoolTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(Smsvoicev2PoolTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new Smsvoicev2PoolTimeoutsArgs();
        }

        public Builder(Smsvoicev2PoolTimeoutsArgs defaults) {
            $ = new Smsvoicev2PoolTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Smsvoicev2PoolTimeoutsArgs build() {
            return $;
        }
    }
