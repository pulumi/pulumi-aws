...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs;
...
public final class WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs Empty = new WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs();
    ...
    private Output<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs() {}

    private WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs();
        }

        public Builder(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs defaults) {
            $ = new WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchJsonBodyArgs build() {
