...
public final class MultiplexProgramTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final MultiplexProgramTimeoutsArgs Empty = new MultiplexProgramTimeoutsArgs();
    ...
    private MultiplexProgramTimeoutsArgs() {}

    private MultiplexProgramTimeoutsArgs(MultiplexProgramTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(MultiplexProgramTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MultiplexProgramTimeoutsArgs();
        }

        public Builder(MultiplexProgramTimeoutsArgs defaults) {
            $ = new MultiplexProgramTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MultiplexProgramTimeoutsArgs build() {
            return $;
        }
    }
