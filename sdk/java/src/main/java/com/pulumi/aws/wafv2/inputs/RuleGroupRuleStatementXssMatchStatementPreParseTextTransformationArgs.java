...
public final class RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs() {}

    private RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs(RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs $) {
    ...
    public static Builder builder(RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs();
        }

        public Builder(RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs defaults) {
            $ = new RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs build() {
            if ($.priority == null) {
                throw new MissingRequiredPropertyException("RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs", "priority");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("RuleGroupRuleStatementXssMatchStatementPreParseTextTransformationArgs", "type");
            }
            return $;
        }
    }
