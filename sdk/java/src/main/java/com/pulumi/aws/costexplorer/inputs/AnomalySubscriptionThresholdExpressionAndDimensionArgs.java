...
public final class AnomalySubscriptionThresholdExpressionAndDimensionArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnomalySubscriptionThresholdExpressionAndDimensionArgs Empty = new AnomalySubscriptionThresholdExpressionAndDimensionArgs();
    ...
    private AnomalySubscriptionThresholdExpressionAndDimensionArgs() {}

    private AnomalySubscriptionThresholdExpressionAndDimensionArgs(AnomalySubscriptionThresholdExpressionAndDimensionArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionAndDimensionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalySubscriptionThresholdExpressionAndDimensionArgs();
        }

        public Builder(AnomalySubscriptionThresholdExpressionAndDimensionArgs defaults) {
            $ = new AnomalySubscriptionThresholdExpressionAndDimensionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnomalySubscriptionThresholdExpressionAndDimensionArgs build() {
            return $;
        }
    }
