...
public final class AnomalySubscriptionThresholdExpressionNotCostCategoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnomalySubscriptionThresholdExpressionNotCostCategoryArgs Empty = new AnomalySubscriptionThresholdExpressionNotCostCategoryArgs();
    ...
    private AnomalySubscriptionThresholdExpressionNotCostCategoryArgs() {}

    private AnomalySubscriptionThresholdExpressionNotCostCategoryArgs(AnomalySubscriptionThresholdExpressionNotCostCategoryArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionNotCostCategoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalySubscriptionThresholdExpressionNotCostCategoryArgs();
        }

        public Builder(AnomalySubscriptionThresholdExpressionNotCostCategoryArgs defaults) {
            $ = new AnomalySubscriptionThresholdExpressionNotCostCategoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnomalySubscriptionThresholdExpressionNotCostCategoryArgs build() {
            return $;
        }
    }
