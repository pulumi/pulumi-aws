...
public class StaticWebLayer extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<Optional<List<StaticWebLayerEbsVolume>>> ebsVolumes() {
    ...
    private Output</* @Nullable */ StaticWebLayerLoadBasedAutoScaling> loadBasedAutoScaling;

    public Output<Optional<StaticWebLayerLoadBasedAutoScaling>> loadBasedAutoScaling() {
