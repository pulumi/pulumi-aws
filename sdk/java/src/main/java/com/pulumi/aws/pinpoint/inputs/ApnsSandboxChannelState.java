...
public final class ApnsSandboxChannelState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Default authentication method used for APNs Sandbox. __NOTE__: AWS End User Messaging uses this default for every APNs push notification that you send using the console. You can override the default when you send a message programmatically using the AWS End User Messaging API, the AWS CLI, or an AWS SDK. If your default authentication type fails, AWS End User Messaging doesn&#39;t attempt to use the other authentication type.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param defaultAuthenticationMethod Default authentication method used for APNs Sandbox. __NOTE__: AWS End User Messaging uses this default for every APNs push notification that you send using the console. You can override the default when you send a message programmatically using the AWS End User Messaging API, the AWS CLI, or an AWS SDK. If your default authentication type fails, AWS End User Messaging doesn&#39;t attempt to use the other authentication type.
         * 
         * @return builder
         * 
         */
