...
public final class BudgetFilterExpressionAndAndDimensionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionAndAndDimensionsArgs Empty = new BudgetFilterExpressionAndAndDimensionsArgs();
    ...
    private BudgetFilterExpressionAndAndDimensionsArgs() {}

    private BudgetFilterExpressionAndAndDimensionsArgs(BudgetFilterExpressionAndAndDimensionsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionAndAndDimensionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionAndAndDimensionsArgs();
        }

        public Builder(BudgetFilterExpressionAndAndDimensionsArgs defaults) {
            $ = new BudgetFilterExpressionAndAndDimensionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionAndAndDimensionsArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionAndAndDimensionsArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionAndAndDimensionsArgs", "values");
            }
            return $;
        }
    }
