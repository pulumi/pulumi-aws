...
@CustomType
public final class RegisteredDomainAdminContact {
    /**
    ...
    public static Builder builder(RegisteredDomainAdminContact defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(RegisteredDomainAdminContact defaults) {
        ...
        public Builder zipCode(@Nullable String zipCode) {
            this.zipCode = zipCode;
            return this;
        }        public RegisteredDomainAdminContact build() {
            return new RegisteredDomainAdminContact(addressLine1, addressLine2, city, contactType, countryCode, email, extraParams, fax, firstName, lastName, organizationName, phoneNumber, state, zipCode);
        }
    }
}
