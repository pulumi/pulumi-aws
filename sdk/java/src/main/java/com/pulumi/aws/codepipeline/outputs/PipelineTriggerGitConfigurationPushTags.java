...
public final class PipelineTriggerGitConfigurationPushTags {
    ...
    public static Builder builder(PipelineTriggerGitConfigurationPushTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(PipelineTriggerGitConfigurationPushTags defaults) {
        ...
        public PipelineTriggerGitConfigurationPushTags build() {
            final var _resultValue = new PipelineTriggerGitConfigurationPushTags();
