...
public final class VisualsTableVisualChartConfigurationTotalOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsTableVisualChartConfigurationTotalOptionsArgs Empty = new VisualsTableVisualChartConfigurationTotalOptionsArgs();
    ...
    private VisualsTableVisualChartConfigurationTotalOptionsArgs() {}

    private VisualsTableVisualChartConfigurationTotalOptionsArgs(VisualsTableVisualChartConfigurationTotalOptionsArgs $) {
    ...
    public static Builder builder(VisualsTableVisualChartConfigurationTotalOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsTableVisualChartConfigurationTotalOptionsArgs();
        }

        public Builder(VisualsTableVisualChartConfigurationTotalOptionsArgs defaults) {
            $ = new VisualsTableVisualChartConfigurationTotalOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VisualsTableVisualChartConfigurationTotalOptionsArgs build() {
            return $;
        }
    }
