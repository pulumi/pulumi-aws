...
public class StandardsControl extends com.pulumi.resources.CustomResource {
    ...
    private StandardsControl(java.lang.String name, Output<java.lang.String> id, @Nullable StandardsControlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static StandardsControl get(java.lang.String name, Output<java.lang.String> id, @Nullable StandardsControlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
