...
public final class V2modelsIntentInitialResponseSettingButtonArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentInitialResponseSettingButtonArgs Empty = new V2modelsIntentInitialResponseSettingButtonArgs();
    ...
    private V2modelsIntentInitialResponseSettingButtonArgs() {}
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingButtonArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentInitialResponseSettingButtonArgs();
        }

        public Builder(V2modelsIntentInitialResponseSettingButtonArgs defaults) {
            $ = new V2modelsIntentInitialResponseSettingButtonArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentInitialResponseSettingButtonArgs build() {
            if ($.text == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingButtonArgs", "text");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingButtonArgs", "value");
            }
            return $;
        }
    }
