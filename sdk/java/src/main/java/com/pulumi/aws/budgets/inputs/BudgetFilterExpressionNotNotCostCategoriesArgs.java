...
public final class BudgetFilterExpressionNotNotCostCategoriesArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionNotNotCostCategoriesArgs Empty = new BudgetFilterExpressionNotNotCostCategoriesArgs();
    ...
    private BudgetFilterExpressionNotNotCostCategoriesArgs() {}

    private BudgetFilterExpressionNotNotCostCategoriesArgs(BudgetFilterExpressionNotNotCostCategoriesArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionNotNotCostCategoriesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionNotNotCostCategoriesArgs();
        }

        public Builder(BudgetFilterExpressionNotNotCostCategoriesArgs defaults) {
            $ = new BudgetFilterExpressionNotNotCostCategoriesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionNotNotCostCategoriesArgs build() {
            return $;
        }
    }
