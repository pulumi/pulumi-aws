...
public final class PhpAppLayerEbsVolumeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private PhpAppLayerEbsVolumeArgs() {}

    private PhpAppLayerEbsVolumeArgs(PhpAppLayerEbsVolumeArgs $) {
    ...
    public static Builder builder(PhpAppLayerEbsVolumeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PhpAppLayerEbsVolumeArgs();
        }

        public Builder(PhpAppLayerEbsVolumeArgs defaults) {
            $ = new PhpAppLayerEbsVolumeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PhpAppLayerEbsVolumeArgs build() {
            if ($.mountPoint == null) {
                throw new MissingRequiredPropertyException("PhpAppLayerEbsVolumeArgs", "mountPoint");
            }
            if ($.numberOfDisks == null) {
                throw new MissingRequiredPropertyException("PhpAppLayerEbsVolumeArgs", "numberOfDisks");
            }
            if ($.size == null) {
                throw new MissingRequiredPropertyException("PhpAppLayerEbsVolumeArgs", "size");
            }
            return $;
        }
    }
