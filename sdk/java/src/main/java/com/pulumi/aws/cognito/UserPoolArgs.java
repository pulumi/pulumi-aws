...
public final class UserPoolArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Configuration block for configuring email Multi-Factor Authentication (MFA); requires at least 2 `accountRecoverySetting` entries; requires an `emailConfiguration` configuration block. Detailed below.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param emailMfaConfiguration Configuration block for configuring email Multi-Factor Authentication (MFA); requires at least 2 `accountRecoverySetting` entries; requires an `emailConfiguration` configuration block. Detailed below.
         * 
         * @return builder
         * 
         */
