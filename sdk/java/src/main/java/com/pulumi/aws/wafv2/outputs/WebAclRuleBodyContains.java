...
@CustomType
public final class WebAclRuleBodyContains {
    /**
    ...
    public static Builder builder(WebAclRuleBodyContains defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> successStrings;
        public Builder() {}
        public Builder(WebAclRuleBodyContains defaults) {
        ...
        public Builder failureStrings(List<String> failureStrings) {
            if (failureStrings == null) {
              throw new MissingRequiredPropertyException("WebAclRuleBodyContains", "failureStrings");
            }
        ...
        public Builder successStrings(List<String> successStrings) {
            if (successStrings == null) {
              throw new MissingRequiredPropertyException("WebAclRuleBodyContains", "successStrings");
            }
        ...
        public WebAclRuleBodyContains build() {
            final var _resultValue = new WebAclRuleBodyContains();
