...
@CustomType
public final class CostCategoryRuleRuleNotOrTags {
    /**
    ...
    private CostCategoryRuleRuleNotOrTags() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleNotOrTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleNotOrTags defaults) {
        ...
        public CostCategoryRuleRuleNotOrTags build() {
            final var _resultValue = new CostCategoryRuleRuleNotOrTags();
