...
public final class TemplateDefinitionSheetParameterControlListDisplayOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final TemplateDefinitionSheetParameterControlListDisplayOptionsArgs Empty = new TemplateDefinitionSheetParameterControlListDisplayOptionsArgs();
    ...
    private TemplateDefinitionSheetParameterControlListDisplayOptionsArgs() {}

    private TemplateDefinitionSheetParameterControlListDisplayOptionsArgs(TemplateDefinitionSheetParameterControlListDisplayOptionsArgs $) {
    ...
    public static Builder builder(TemplateDefinitionSheetParameterControlListDisplayOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TemplateDefinitionSheetParameterControlListDisplayOptionsArgs();
        }

        public Builder(TemplateDefinitionSheetParameterControlListDisplayOptionsArgs defaults) {
            $ = new TemplateDefinitionSheetParameterControlListDisplayOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TemplateDefinitionSheetParameterControlListDisplayOptionsArgs build() {
            return $;
        }
    }
