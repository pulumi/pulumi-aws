...
public final class V2modelsIntentConfirmationSettingImageResponseCardArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentConfirmationSettingImageResponseCardArgs Empty = new V2modelsIntentConfirmationSettingImageResponseCardArgs();
    ...
    private V2modelsIntentConfirmationSettingImageResponseCardArgs(V2modelsIntentConfirmationSettingImageResponseCardArgs $) {
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingImageResponseCardArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(V2modelsIntentConfirmationSettingImageResponseCardArgs defaults) {
            $ = new V2modelsIntentConfirmationSettingImageResponseCardArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentConfirmationSettingImageResponseCardArgs build() {
            if ($.title == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingImageResponseCardArgs", "title");
            }
            return $;
        }
    }
