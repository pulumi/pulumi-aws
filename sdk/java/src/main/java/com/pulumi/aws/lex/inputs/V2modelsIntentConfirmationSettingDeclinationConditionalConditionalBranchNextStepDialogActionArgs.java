...
public final class V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs Empty = new V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs();
    ...
    private V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs() {}

    private V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs(V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs $) {
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs();
        }

        public Builder(V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs defaults) {
            $ = new V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingDeclinationConditionalConditionalBranchNextStepDialogActionArgs", "type");
            }
            return $;
        }
    }
