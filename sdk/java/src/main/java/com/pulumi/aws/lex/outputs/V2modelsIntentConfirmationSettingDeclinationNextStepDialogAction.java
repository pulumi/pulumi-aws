...
@CustomType
public final class V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction {
    /**
    ...
    private V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction() {}
    /**
     * @return If the dialog action is `ElicitSlot`, defines the slot to elicit from the user.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction build() {
            final var _resultValue = new V2modelsIntentConfirmationSettingDeclinationNextStepDialogAction();
