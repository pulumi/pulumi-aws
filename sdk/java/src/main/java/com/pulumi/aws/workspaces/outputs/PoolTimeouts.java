...
@CustomType
public final class PoolTimeouts {
    /**
    ...
    public static Builder builder(PoolTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(PoolTimeouts defaults) {
        ...
        public PoolTimeouts build() {
            final var _resultValue = new PoolTimeouts();
