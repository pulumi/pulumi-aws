...
public final class GetOntapFileSystemDiskIopsConfiguration {
    ...
    /**
     * @return Whether the file system is using the `AUTOMATIC` setting of SSD IOPS of 3 IOPS per GB of storage capacity, or if it using a `USER_PROVISIONED` value.
     * 
     */
    private String mode;
