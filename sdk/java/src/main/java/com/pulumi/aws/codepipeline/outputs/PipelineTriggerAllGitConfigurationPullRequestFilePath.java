...
public final class PipelineTriggerAllGitConfigurationPullRequestFilePath {
    ...
    public static Builder builder(PipelineTriggerAllGitConfigurationPullRequestFilePath defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(PipelineTriggerAllGitConfigurationPullRequestFilePath defaults) {
        ...
        public PipelineTriggerAllGitConfigurationPullRequestFilePath build() {
            final var _resultValue = new PipelineTriggerAllGitConfigurationPullRequestFilePath();
