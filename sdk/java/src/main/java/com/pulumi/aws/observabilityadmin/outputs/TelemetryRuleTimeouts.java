...
@CustomType
public final class TelemetryRuleTimeouts {
    /**
    ...
    public static Builder builder(TelemetryRuleTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(TelemetryRuleTimeouts defaults) {
        ...
        public TelemetryRuleTimeouts build() {
            final var _resultValue = new TelemetryRuleTimeouts();
