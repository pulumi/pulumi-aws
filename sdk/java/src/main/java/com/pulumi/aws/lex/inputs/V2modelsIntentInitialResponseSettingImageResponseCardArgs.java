...
public final class V2modelsIntentInitialResponseSettingImageResponseCardArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentInitialResponseSettingImageResponseCardArgs Empty = new V2modelsIntentInitialResponseSettingImageResponseCardArgs();
    ...
    private V2modelsIntentInitialResponseSettingImageResponseCardArgs() {}
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingImageResponseCardArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentInitialResponseSettingImageResponseCardArgs();
        }

        public Builder(V2modelsIntentInitialResponseSettingImageResponseCardArgs defaults) {
            $ = new V2modelsIntentInitialResponseSettingImageResponseCardArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentInitialResponseSettingImageResponseCardArgs build() {
            if ($.title == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingImageResponseCardArgs", "title");
            }
            return $;
        }
    }
