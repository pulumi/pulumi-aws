...
public class OrganizationAdminAccount extends com.pulumi.resources.CustomResource {
    ...
    public OrganizationAdminAccount(java.lang.String name, OrganizationAdminAccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:macie2/organizationAdminAccount:OrganizationAdminAccount", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private OrganizationAdminAccount(java.lang.String name, Output<java.lang.String> id, @Nullable OrganizationAdminAccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:macie2/organizationAdminAccount:OrganizationAdminAccount", name, state, makeResourceOptions(options, id), false);
    }
