...
@CustomType
public final class WebAclRuleTimeouts {
    /**
    ...
    public static Builder builder(WebAclRuleTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(WebAclRuleTimeouts defaults) {
        ...
        public WebAclRuleTimeouts build() {
            final var _resultValue = new WebAclRuleTimeouts();
