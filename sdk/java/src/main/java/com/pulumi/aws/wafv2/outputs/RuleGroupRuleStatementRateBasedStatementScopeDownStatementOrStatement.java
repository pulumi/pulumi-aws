...
public final class RuleGroupRuleStatementRateBasedStatementScopeDownStatementOrStatement {
    ...
    public static final class Builder {
        ...
        public Builder statements(List<RuleGroupRuleStatement> statements) {
            if (statements == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRateBasedStatementScopeDownStatementOrStatement", "statements");
            }
        ...
        public RuleGroupRuleStatementRateBasedStatementScopeDownStatementOrStatement build() {
            final var _resultValue = new RuleGroupRuleStatementRateBasedStatementScopeDownStatementOrStatement();
