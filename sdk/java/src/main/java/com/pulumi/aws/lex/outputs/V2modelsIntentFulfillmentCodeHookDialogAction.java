...
@CustomType
public final class V2modelsIntentFulfillmentCodeHookDialogAction {
    /**
    ...
    public static Builder builder(V2modelsIntentFulfillmentCodeHookDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentFulfillmentCodeHookDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentFulfillmentCodeHookDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentFulfillmentCodeHookDialogAction build() {
            final var _resultValue = new V2modelsIntentFulfillmentCodeHookDialogAction();
