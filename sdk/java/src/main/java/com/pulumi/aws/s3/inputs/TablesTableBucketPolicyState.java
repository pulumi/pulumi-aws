...
public final class TablesTableBucketPolicyState extends com.pulumi.resources.ResourceArgs {

    public static final TablesTableBucketPolicyState Empty = new TablesTableBucketPolicyState();
    ...
    private TablesTableBucketPolicyState() {}

    private TablesTableBucketPolicyState(TablesTableBucketPolicyState $) {
    ...
    public static Builder builder(TablesTableBucketPolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TablesTableBucketPolicyState();
        }

        public Builder(TablesTableBucketPolicyState defaults) {
            $ = new TablesTableBucketPolicyState(Objects.requireNonNull(defaults));
        }
        ...
        public TablesTableBucketPolicyState build() {
            return $;
        }
    }
