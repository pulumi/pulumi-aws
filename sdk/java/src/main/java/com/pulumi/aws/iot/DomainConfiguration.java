...
public class DomainConfiguration extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return An object that specifies the authorization service for a domain. See the `authorizerConfig` Block below for details.
     * 
     */
    ...
    /**
     * @return The ARNs of the certificates that IoT passes to the device during the TLS handshake. Currently you can specify only one certificate ARN. This value is not required for Amazon Web Services-managed domains. When using a custom `domainName`, the cert must include it.
     * 
     */
    ...
    /**
     * @return An object that specifies the TLS configuration for a domain. See the `tlsConfig` Block below for details.
     * 
     */
