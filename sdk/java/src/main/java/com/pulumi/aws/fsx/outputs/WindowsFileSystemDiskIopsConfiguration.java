...
public final class WindowsFileSystemDiskIopsConfiguration {
    ...
    public static Builder builder(WindowsFileSystemDiskIopsConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String mode;
        public Builder() {}
        public Builder(WindowsFileSystemDiskIopsConfiguration defaults) {
        ...
        public WindowsFileSystemDiskIopsConfiguration build() {
            final var _resultValue = new WindowsFileSystemDiskIopsConfiguration();
