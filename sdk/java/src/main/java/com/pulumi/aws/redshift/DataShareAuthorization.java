...
public class DataShareAuthorization extends com.pulumi.resources.CustomResource {
     ...
     */
    public DataShareAuthorization(String name) {
     ...
     */
    public DataShareAuthorization(String name, DataShareAuthorizationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:redshift/dataShareAuthorization:DataShareAuthorization", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private DataShareAuthorization(String name, Output<String> id, @Nullable DataShareAuthorizationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:redshift/dataShareAuthorization:DataShareAuthorization", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static DataShareAuthorization get(String name, Output<String> id, @Nullable DataShareAuthorizationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
