...
public class SigningProfile extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<SigningProfileRevocationRecord>> revocationRecords;

    /**
     * @return Revocation information for a signing profile.
     * 
     */
    public Output<Optional<List<SigningProfileRevocationRecord>>> revocationRecords() {
    ...
    private Output</* @Nullable */ SigningProfileSigningMaterial> signingMaterial;

    public Output<Optional<SigningProfileSigningMaterial>> signingMaterial() {
        return Codegen.optional(this.signingMaterial);
    }
    /**
    ...
    private Output</* @Nullable */ String> versionArn;

    /**
     * @return The signing profile ARN, including the profile version.
     * 
     */
    public Output<Optional<String>> versionArn() {
        return Codegen.optional(this.versionArn);
    }
