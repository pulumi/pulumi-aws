...
@CustomType
public final class BudgetFilterExpressionAndCostCategories {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionAndCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionAndCostCategories defaults) {
        ...
        public BudgetFilterExpressionAndCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionAndCostCategories();
