...
public final class RouteSpecHttpRouteMatchHeaderMatchRange {
    ...
    public static final class Builder {
        ...
        public Builder end(Integer end) {
            if (end == null) {
              throw new MissingRequiredPropertyException("RouteSpecHttpRouteMatchHeaderMatchRange", "end");
            }
            this.end = end;
            return this;
        }
        ...
        public Builder start(Integer start) {
            if (start == null) {
              throw new MissingRequiredPropertyException("RouteSpecHttpRouteMatchHeaderMatchRange", "start");
            }
            this.start = start;
            return this;
        }
