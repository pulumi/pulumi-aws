...
import com.pulumi.aws.kinesis.outputs.FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions;
...
@CustomType
public final class FirehoseDeliveryStreamOpensearchConfigurationS3Configuration {
    /**
     ...
     * 
     */
    private @Nullable FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions cloudwatchLoggingOptions;
    /**
    ...
    private FirehoseDeliveryStreamOpensearchConfigurationS3Configuration() {}
    /**
     * @return The ARN of the S3 bucket
     * 
     */
     ...
     * 
     */
    public Optional<FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions> cloudwatchLoggingOptions() {
    ...
    public static Builder builder(FirehoseDeliveryStreamOpensearchConfigurationS3Configuration defaults) {
    ...
    public static final class Builder {
        ...
        private String roleArn;
        public Builder() {}
        public Builder(FirehoseDeliveryStreamOpensearchConfigurationS3Configuration defaults) {
        ...
        public Builder bucketArn(String bucketArn) {
            if (bucketArn == null) {
              throw new MissingRequiredPropertyException("FirehoseDeliveryStreamOpensearchConfigurationS3Configuration", "bucketArn");
            }
        ...
        @CustomType.Setter
        public Builder cloudwatchLoggingOptions(@Nullable FirehoseDeliveryStreamOpensearchConfigurationS3ConfigurationCloudwatchLoggingOptions cloudwatchLoggingOptions) {
        ...
        public Builder roleArn(String roleArn) {
            if (roleArn == null) {
              throw new MissingRequiredPropertyException("FirehoseDeliveryStreamOpensearchConfigurationS3Configuration", "roleArn");
            }
            this.roleArn = roleArn;
            return this;
        }
        public FirehoseDeliveryStreamOpensearchConfigurationS3Configuration build() {
            final var _resultValue = new FirehoseDeliveryStreamOpensearchConfigurationS3Configuration();
