...
public final class WebAclCaptchaConfigImmunityTimePropertyArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclCaptchaConfigImmunityTimePropertyArgs Empty = new WebAclCaptchaConfigImmunityTimePropertyArgs();
    ...
    private WebAclCaptchaConfigImmunityTimePropertyArgs() {}

    private WebAclCaptchaConfigImmunityTimePropertyArgs(WebAclCaptchaConfigImmunityTimePropertyArgs $) {
    ...
    public static Builder builder(WebAclCaptchaConfigImmunityTimePropertyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclCaptchaConfigImmunityTimePropertyArgs();
        }

        public Builder(WebAclCaptchaConfigImmunityTimePropertyArgs defaults) {
            $ = new WebAclCaptchaConfigImmunityTimePropertyArgs(Objects.requireNonNull(defaults));
        }
