...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs Empty = new WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs();
    ...
    private Output<WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs() {}

    private WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs(WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs();
        }

        public Builder(WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs defaults) {
            $ = new WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementOrStatementStatementRegexMatchStatementFieldToMatchHeaderArgs build() {
