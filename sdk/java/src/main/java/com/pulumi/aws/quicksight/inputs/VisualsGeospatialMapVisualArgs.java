...
import com.pulumi.aws.quicksight.inputs.VisualsGeospatialMapVisualChartConfigurationArgs;
...
public final class VisualsGeospatialMapVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsGeospatialMapVisualArgs Empty = new VisualsGeospatialMapVisualArgs();
    ...
    private @Nullable Output<VisualsGeospatialMapVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsGeospatialMapVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsGeospatialMapVisualArgs(VisualsGeospatialMapVisualArgs $) {
    ...
    public static Builder builder(VisualsGeospatialMapVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsGeospatialMapVisualArgs();
        }

        public Builder(VisualsGeospatialMapVisualArgs defaults) {
            $ = new VisualsGeospatialMapVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsGeospatialMapVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsGeospatialMapVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsGeospatialMapVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsGeospatialMapVisualArgs", "visualId");
            }
            return $;
        }
    }
