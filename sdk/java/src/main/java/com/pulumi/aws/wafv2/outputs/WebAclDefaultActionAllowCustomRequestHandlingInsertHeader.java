...
public final class WebAclDefaultActionAllowCustomRequestHandlingInsertHeader {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("WebAclDefaultActionAllowCustomRequestHandlingInsertHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("WebAclDefaultActionAllowCustomRequestHandlingInsertHeader", "value");
            }
            this.value = value;
            return this;
        }
        public WebAclDefaultActionAllowCustomRequestHandlingInsertHeader build() {
            final var _resultValue = new WebAclDefaultActionAllowCustomRequestHandlingInsertHeader();
