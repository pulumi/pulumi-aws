...
public final class WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchSingleHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchSingleHeaderArgs(WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchSingleHeaderArgs $) {
        this.name = $.name;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchSingleHeaderArgs();
        }

        public Builder(WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchSingleHeaderArgs defaults) {
            $ = new WebAclRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchSingleHeaderArgs(Objects.requireNonNull(defaults));
        }
