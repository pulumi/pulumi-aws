...
@CustomType
public final class ClusterTimeouts {
    /**
    ...
    public static Builder builder(ClusterTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ClusterTimeouts defaults) {
        ...
        public ClusterTimeouts build() {
            final var _resultValue = new ClusterTimeouts();
