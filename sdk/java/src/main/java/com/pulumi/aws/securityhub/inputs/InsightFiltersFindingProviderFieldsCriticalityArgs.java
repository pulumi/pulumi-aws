...
public final class InsightFiltersFindingProviderFieldsCriticalityArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersFindingProviderFieldsCriticalityArgs() {}

    private InsightFiltersFindingProviderFieldsCriticalityArgs(InsightFiltersFindingProviderFieldsCriticalityArgs $) {
        this.eq = $.eq;
        this.gte = $.gte;
        this.lte = $.lte;
    }
    ...
    public static Builder builder(InsightFiltersFindingProviderFieldsCriticalityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersFindingProviderFieldsCriticalityArgs();
        }

        public Builder(InsightFiltersFindingProviderFieldsCriticalityArgs defaults) {
        ...
        public InsightFiltersFindingProviderFieldsCriticalityArgs build() {
            return $;
        }
    }
