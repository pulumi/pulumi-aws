...
public final class WebAclRuleJa3FingerprintArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleJa3FingerprintArgs Empty = new WebAclRuleJa3FingerprintArgs();
    ...
    private WebAclRuleJa3FingerprintArgs() {}

    private WebAclRuleJa3FingerprintArgs(WebAclRuleJa3FingerprintArgs $) {
    ...
    public static Builder builder(WebAclRuleJa3FingerprintArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleJa3FingerprintArgs();
        }

        public Builder(WebAclRuleJa3FingerprintArgs defaults) {
            $ = new WebAclRuleJa3FingerprintArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebAclRuleJa3FingerprintArgs build() {
            if ($.fallbackBehavior == null) {
                throw new MissingRequiredPropertyException("WebAclRuleJa3FingerprintArgs", "fallbackBehavior");
            }
            return $;
        }
    }
