...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookiesMatchPattern;
...
public final class WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookies {
     ...
     * 
     */
    private @Nullable List<WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns;
    /**
    ...
    public static Builder builder(WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookies defaults) {
    ...
    public static final class Builder {
        ...
        private String oversizeHandling;
        public Builder() {}
        public Builder(WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookies defaults) {
        ...
        @CustomType.Setter
        public Builder matchPatterns(@Nullable List<WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns) {

            this.matchPatterns = matchPatterns;
            return this;
        }
        public Builder matchPatterns(WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookiesMatchPattern... matchPatterns) {
            return matchPatterns(List.of(matchPatterns));
        }
        @CustomType.Setter
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookies", "matchScope");
            }
        ...
        public Builder oversizeHandling(String oversizeHandling) {
            if (oversizeHandling == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookies", "oversizeHandling");
            }
        ...
        public WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookies build() {
            final var _resultValue = new WebAclRuleStatementNotStatementStatementXssMatchStatementFieldToMatchCookies();
