...
@CustomType
public final class BudgetFilterExpressionTags {
    /**
    ...
    private BudgetFilterExpressionTags() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionTags defaults) {
        ...
        public BudgetFilterExpressionTags build() {
            final var _resultValue = new BudgetFilterExpressionTags();
