...
@CustomType
public final class VpcEndpointAssociationTimeouts {
    /**
    ...
    public static Builder builder(VpcEndpointAssociationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(VpcEndpointAssociationTimeouts defaults) {
        ...
        public VpcEndpointAssociationTimeouts build() {
            final var _resultValue = new VpcEndpointAssociationTimeouts();
