...
public final class ScopeTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ScopeTimeoutsArgs Empty = new ScopeTimeoutsArgs();
    ...
    private ScopeTimeoutsArgs() {}

    private ScopeTimeoutsArgs(ScopeTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(ScopeTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ScopeTimeoutsArgs();
        }

        public Builder(ScopeTimeoutsArgs defaults) {
            $ = new ScopeTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ScopeTimeoutsArgs build() {
            return $;
        }
    }
