...
public final class GetPeeringAttachmentFilter extends com.pulumi.resources.InvokeArgs {
    ...
    private GetPeeringAttachmentFilter(GetPeeringAttachmentFilter $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPeeringAttachmentFilter();
        }

        public Builder(GetPeeringAttachmentFilter defaults) {
            $ = new GetPeeringAttachmentFilter(Objects.requireNonNull(defaults));
        }
