...
public final class PolicySecurityServicePolicyDataPolicyOptionNetworkFirewallPolicy {
    /**
     * @return Deployment model for the firewall policy. To use a distributed model, remove the `policyOption` section. Valid values are `CENTRALIZED` and `DISTRIBUTED`.
     * 
     */
