...
@CustomType
public final class TrustStoreTimeouts {
    /**
    ...
    public static Builder builder(TrustStoreTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(TrustStoreTimeouts defaults) {
        ...
        public TrustStoreTimeouts build() {
            final var _resultValue = new TrustStoreTimeouts();
