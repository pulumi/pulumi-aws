...
public final class EcsClusterLayerEbsVolumeArgs extends com.pulumi.resources.ResourceArgs {

    public static final EcsClusterLayerEbsVolumeArgs Empty = new EcsClusterLayerEbsVolumeArgs();
    ...
    private EcsClusterLayerEbsVolumeArgs() {}

    private EcsClusterLayerEbsVolumeArgs(EcsClusterLayerEbsVolumeArgs $) {
    ...
    public static Builder builder(EcsClusterLayerEbsVolumeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new EcsClusterLayerEbsVolumeArgs();
        }

        public Builder(EcsClusterLayerEbsVolumeArgs defaults) {
            $ = new EcsClusterLayerEbsVolumeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public EcsClusterLayerEbsVolumeArgs build() {
            if ($.mountPoint == null) {
                throw new MissingRequiredPropertyException("EcsClusterLayerEbsVolumeArgs", "mountPoint");
            }
            if ($.numberOfDisks == null) {
                throw new MissingRequiredPropertyException("EcsClusterLayerEbsVolumeArgs", "numberOfDisks");
            }
            if ($.size == null) {
                throw new MissingRequiredPropertyException("EcsClusterLayerEbsVolumeArgs", "size");
            }
            return $;
        }
    }
