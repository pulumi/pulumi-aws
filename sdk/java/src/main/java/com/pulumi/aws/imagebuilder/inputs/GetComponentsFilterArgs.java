...
public final class GetComponentsFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetComponentsFilterArgs() {}

    private GetComponentsFilterArgs(GetComponentsFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetComponentsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetComponentsFilterArgs();
        }

        public Builder(GetComponentsFilterArgs defaults) {
            $ = new GetComponentsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetComponentsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetComponentsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetComponentsFilterArgs", "values");
            }
            return $;
        }
    }
