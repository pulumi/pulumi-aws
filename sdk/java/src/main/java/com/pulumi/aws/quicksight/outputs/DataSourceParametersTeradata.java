...
public final class DataSourceParametersTeradata {
    ...
    public static final class Builder {
        ...
        public Builder database(String database) {
            if (database == null) {
              throw new MissingRequiredPropertyException("DataSourceParametersTeradata", "database");
            }
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("DataSourceParametersTeradata", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("DataSourceParametersTeradata", "port");
            }
            this.port = port;
            return this;
        }
