...
import com.pulumi.aws.lex.outputs.V2modelsIntentClosingSettingNextStepDialogAction;
import com.pulumi.aws.lex.outputs.V2modelsIntentClosingSettingNextStepIntent;
...
public final class V2modelsIntentClosingSettingNextStep {
     ...
     * 
     */
    private @Nullable V2modelsIntentClosingSettingNextStepDialogAction dialogAction;
    /**
     * @return Configuration block for override settings to configure the intent state. See `intent`.
     * 
     */
    private @Nullable V2modelsIntentClosingSettingNextStepIntent intent;
    /**
     ...
     * 
     */
    public Optional<V2modelsIntentClosingSettingNextStepDialogAction> dialogAction() {
     ...
     * 
     */
    public Optional<V2modelsIntentClosingSettingNextStepIntent> intent() {
    ...
    public static Builder builder(V2modelsIntentClosingSettingNextStep defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder dialogAction(@Nullable V2modelsIntentClosingSettingNextStepDialogAction dialogAction) {

            this.dialogAction = dialogAction;
            return this;
        }
        @CustomType.Setter
        public Builder intent(@Nullable V2modelsIntentClosingSettingNextStepIntent intent) {
        ...
        public V2modelsIntentClosingSettingNextStep build() {
            final var _resultValue = new V2modelsIntentClosingSettingNextStep();
