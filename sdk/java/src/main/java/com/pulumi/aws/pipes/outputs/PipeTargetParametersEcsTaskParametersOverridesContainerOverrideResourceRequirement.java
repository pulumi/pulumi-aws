...
public final class PipeTargetParametersEcsTaskParametersOverridesContainerOverrideResourceRequirement {
    ...
    public static Builder builder(PipeTargetParametersEcsTaskParametersOverridesContainerOverrideResourceRequirement defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(PipeTargetParametersEcsTaskParametersOverridesContainerOverrideResourceRequirement defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("PipeTargetParametersEcsTaskParametersOverridesContainerOverrideResourceRequirement", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("PipeTargetParametersEcsTaskParametersOverridesContainerOverrideResourceRequirement", "value");
            }
            this.value = value;
            return this;
        }
        public PipeTargetParametersEcsTaskParametersOverridesContainerOverrideResourceRequirement build() {
            final var _resultValue = new PipeTargetParametersEcsTaskParametersOverridesContainerOverrideResourceRequirement();
