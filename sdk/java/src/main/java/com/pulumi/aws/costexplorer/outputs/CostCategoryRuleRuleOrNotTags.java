...
@CustomType
public final class CostCategoryRuleRuleOrNotTags {
    /**
    ...
    public static Builder builder(CostCategoryRuleRuleOrNotTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleOrNotTags defaults) {
        ...
        public CostCategoryRuleRuleOrNotTags build() {
            final var _resultValue = new CostCategoryRuleRuleOrNotTags();
