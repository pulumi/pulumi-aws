...
public final class AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs Empty = new AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs();
    ...
    private AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs(AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs $) {
    ...
    public static Builder builder(AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs();
        }

        public Builder(AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs defaults) {
            $ = new AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnalysisDefinitionSheetParameterControlListDisplayOptionsArgs build() {
            return $;
        }
    }
