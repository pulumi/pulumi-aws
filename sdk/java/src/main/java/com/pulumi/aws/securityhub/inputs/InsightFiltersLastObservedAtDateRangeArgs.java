...
public final class InsightFiltersLastObservedAtDateRangeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersLastObservedAtDateRangeArgs(InsightFiltersLastObservedAtDateRangeArgs $) {
        this.unit = $.unit;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersLastObservedAtDateRangeArgs();
        }

        public Builder(InsightFiltersLastObservedAtDateRangeArgs defaults) {
            $ = new InsightFiltersLastObservedAtDateRangeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersLastObservedAtDateRangeArgs build() {
            if ($.unit == null) {
                throw new MissingRequiredPropertyException("InsightFiltersLastObservedAtDateRangeArgs", "unit");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("InsightFiltersLastObservedAtDateRangeArgs", "value");
            }
            return $;
        }
    }
