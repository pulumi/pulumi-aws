...
import com.pulumi.aws.lex.inputs.V2modelsIntentInitialResponseSettingButtonArgs;
...
public final class V2modelsIntentInitialResponseSettingCodeHookPostCodeHookSpecificationTimeoutResponseMessageGroupMessageImageResponseCardArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="buttons")
    private @Nullable Output<List<V2modelsIntentInitialResponseSettingButtonArgs>> buttons;
     ...
     * 
     */
    public Optional<Output<List<V2modelsIntentInitialResponseSettingButtonArgs>>> buttons() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder buttons(@Nullable Output<List<V2modelsIntentInitialResponseSettingButtonArgs>> buttons) {
            $.buttons = buttons;
            return this;
        }
         ...
         * 
         */
        public Builder buttons(List<V2modelsIntentInitialResponseSettingButtonArgs> buttons) {
         ...
         * 
         */
        public Builder buttons(V2modelsIntentInitialResponseSettingButtonArgs... buttons) {
