...
public class RdsDbInstance extends com.pulumi.resources.CustomResource {
    ...
    private RdsDbInstance(java.lang.String name, Output<java.lang.String> id, @Nullable RdsDbInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
     ...
     */
    public static RdsDbInstance get(java.lang.String name, Output<java.lang.String> id, @Nullable RdsDbInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
