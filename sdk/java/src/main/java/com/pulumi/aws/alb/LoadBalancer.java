...
import com.pulumi.aws.alb.outputs.LoadBalancerHealthCheckLogs;
import com.pulumi.aws.alb.outputs.LoadBalancerIpamPools;
import com.pulumi.aws.alb.outputs.LoadBalancerMinimumLoadBalancerCapacity;
...
public class LoadBalancer extends com.pulumi.resources.CustomResource {
    ...
    public LoadBalancer(java.lang.String name, @Nullable LoadBalancerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:alb/loadBalancer:LoadBalancer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private LoadBalancer(java.lang.String name, Output<java.lang.String> id, @Nullable LoadBalancerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:alb/loadBalancer:LoadBalancer", name, state, makeResourceOptions(options, id), false);
    }
