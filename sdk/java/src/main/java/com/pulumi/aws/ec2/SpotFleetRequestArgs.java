...
public final class SpotFleetRequestArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Launch template configuration block. See Launch Template Configs below for more details. Conflicts with `launchSpecification`. At least one of `launchSpecification` or `launchTemplateConfig` is required.
     * 
     */
    ...
    /**
     * @return The unit for the target capacity. This can only be done with `instanceRequirements` defined
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param targetCapacityUnitType The unit for the target capacity. This can only be done with `instanceRequirements` defined
         * 
         * @return builder
         * 
         */
