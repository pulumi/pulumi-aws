...
import com.pulumi.aws.lex.outputs.V2modelsIntentInitialResponseSettingCustomPayload;
...
import com.pulumi.aws.lex.outputs.V2modelsIntentInitialResponseSettingSsmlMessage;
...
@CustomType
public final class V2modelsIntentInitialResponseSettingVariation {
    /**
     * @return Configuration block for a message in a custom format defined by the client application. See `custom_payload`.
     * 
     */
    private @Nullable V2modelsIntentInitialResponseSettingCustomPayload customPayload;
    /**
     ...
     * 
     */
    private @Nullable V2modelsIntentInitialResponseSettingSsmlMessage ssmlMessage;

    private V2modelsIntentInitialResponseSettingVariation() {}
    /**
     * @return Configuration block for a message in a custom format defined by the client application. See `custom_payload`.
     * 
     */
    public Optional<V2modelsIntentInitialResponseSettingCustomPayload> customPayload() {
     ...
     * 
     */
    public Optional<V2modelsIntentInitialResponseSettingSsmlMessage> ssmlMessage() {
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingVariation defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable V2modelsIntentInitialResponseSettingSsmlMessage ssmlMessage;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingVariation defaults) {
        ...
        @CustomType.Setter
        public Builder customPayload(@Nullable V2modelsIntentInitialResponseSettingCustomPayload customPayload) {
        ...
        @CustomType.Setter
        public Builder ssmlMessage(@Nullable V2modelsIntentInitialResponseSettingSsmlMessage ssmlMessage) {

            this.ssmlMessage = ssmlMessage;
            return this;
        }
        public V2modelsIntentInitialResponseSettingVariation build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingVariation();
