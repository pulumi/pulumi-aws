...
public final class AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelS3Args extends com.pulumi.resources.ResourceArgs {
    ...
    private AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelS3Args() {}

    private AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelS3Args(AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelS3Args $) {
    ...
    public static Builder builder(AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelS3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelS3Args();
        }

        public Builder(AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelS3Args defaults) {
        ...
        public AgentcoreGatewayTargetTargetConfigurationMcpSmithyModelS3Args build() {
            return $;
        }
    }
