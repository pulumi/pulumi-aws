...
public class InvitationAccepter extends com.pulumi.resources.CustomResource {
    ...
    public InvitationAccepter(java.lang.String name, InvitationAccepterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:detective/invitationAccepter:InvitationAccepter", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private InvitationAccepter(java.lang.String name, Output<java.lang.String> id, @Nullable InvitationAccepterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:detective/invitationAccepter:InvitationAccepter", name, state, makeResourceOptions(options, id), false);
    }
