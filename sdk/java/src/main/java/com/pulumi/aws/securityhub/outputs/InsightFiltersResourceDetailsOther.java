...
public final class InsightFiltersResourceDetailsOther {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceDetailsOther", "comparison");
            }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceDetailsOther", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceDetailsOther", "value");
            }
            this.value = value;
            return this;
        }
        public InsightFiltersResourceDetailsOther build() {
            final var _resultValue = new InsightFiltersResourceDetailsOther();
