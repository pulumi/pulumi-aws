...
public final class GetIndexDocumentMetadataConfigurationUpdateRelevance {
    /**
     * @return Time period that the boost applies to. For more information, refer to [Duration](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-Duration).
     * 
     */
    private String duration;
    /**
     * @return How &#34;fresh&#34; a document is. For more information, refer to [Freshness](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-Freshness).
     * 
     */
