...
import com.pulumi.aws.vpc.inputs.RouteServerEndpointState;
import com.pulumi.aws.vpc.outputs.RouteServerEndpointTimeouts;
...
public class RouteServerEndpoint extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="timeouts", refs={RouteServerEndpointTimeouts.class}, tree="[0]")
    private Output</* @Nullable */ RouteServerEndpointTimeouts> timeouts;
     ...
     */
    public RouteServerEndpoint(java.lang.String name) {
        this(name, RouteServerEndpointArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public RouteServerEndpoint(java.lang.String name, RouteServerEndpointArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RouteServerEndpoint(java.lang.String name, RouteServerEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:vpc/routeServerEndpoint:RouteServerEndpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RouteServerEndpoint(java.lang.String name, Output<java.lang.String> id, @Nullable RouteServerEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:vpc/routeServerEndpoint:RouteServerEndpoint", name, state, makeResourceOptions(options, id), false);
    }

    private static RouteServerEndpointArgs makeArgs(RouteServerEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? RouteServerEndpointArgs.Empty : args;
    }
     ...
     */
    public static RouteServerEndpoint get(java.lang.String name, Output<java.lang.String> id, @Nullable RouteServerEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
