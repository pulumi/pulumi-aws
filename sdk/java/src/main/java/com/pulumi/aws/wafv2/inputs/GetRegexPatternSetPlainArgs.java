...
public final class GetRegexPatternSetPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetRegexPatternSetPlainArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetRegexPatternSetPlainArgs", "name");
            }
            if ($.scope == null) {
                throw new MissingRequiredPropertyException("GetRegexPatternSetPlainArgs", "scope");
            }
            return $;
        }
    }
