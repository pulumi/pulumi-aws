...
public final class DaemonTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final DaemonTimeoutsArgs Empty = new DaemonTimeoutsArgs();
    ...
    private DaemonTimeoutsArgs() {}

    private DaemonTimeoutsArgs(DaemonTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(DaemonTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DaemonTimeoutsArgs();
        }

        public Builder(DaemonTimeoutsArgs defaults) {
            $ = new DaemonTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DaemonTimeoutsArgs build() {
            return $;
        }
    }
