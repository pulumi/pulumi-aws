...
public final class ClusterPeeringTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterPeeringTimeoutsArgs Empty = new ClusterPeeringTimeoutsArgs();
    ...
    private ClusterPeeringTimeoutsArgs() {}

    private ClusterPeeringTimeoutsArgs(ClusterPeeringTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(ClusterPeeringTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterPeeringTimeoutsArgs();
        }

        public Builder(ClusterPeeringTimeoutsArgs defaults) {
            $ = new ClusterPeeringTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterPeeringTimeoutsArgs build() {
            return $;
        }
    }
