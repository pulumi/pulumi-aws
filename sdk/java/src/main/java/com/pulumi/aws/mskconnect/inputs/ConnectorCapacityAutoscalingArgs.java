...
public final class ConnectorCapacityAutoscalingArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param scaleInPolicy The scale-in policy for the connector. See `scale_in_policy` Block for details.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param scaleOutPolicy The scale-out policy for the connector. See `scale_out_policy` Block for details.
         * 
         * @return builder
         * 
         */
