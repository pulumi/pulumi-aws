...
public final class MlflowAppTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final MlflowAppTimeoutsArgs Empty = new MlflowAppTimeoutsArgs();
    ...
    private MlflowAppTimeoutsArgs() {}

    private MlflowAppTimeoutsArgs(MlflowAppTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(MlflowAppTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MlflowAppTimeoutsArgs();
        }

        public Builder(MlflowAppTimeoutsArgs defaults) {
            $ = new MlflowAppTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MlflowAppTimeoutsArgs build() {
            return $;
        }
    }
