...
@CustomType
public final class TopicTimeouts {
    /**
    ...
    public static Builder builder(TopicTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(TopicTimeouts defaults) {
        ...
        public TopicTimeouts build() {
            final var _resultValue = new TopicTimeouts();
