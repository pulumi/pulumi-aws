...
public final class VisualsBoxPlotVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsBoxPlotVisualArgs Empty = new VisualsBoxPlotVisualArgs();
    ...
    private @Nullable Output<VisualsBoxPlotVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsBoxPlotVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsBoxPlotVisualArgs() {}

    private VisualsBoxPlotVisualArgs(VisualsBoxPlotVisualArgs $) {
    ...
    public static Builder builder(VisualsBoxPlotVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsBoxPlotVisualArgs();
        }

        public Builder(VisualsBoxPlotVisualArgs defaults) {
            $ = new VisualsBoxPlotVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsBoxPlotVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsBoxPlotVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsBoxPlotVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsBoxPlotVisualArgs", "visualId");
            }
            return $;
        }
    }
