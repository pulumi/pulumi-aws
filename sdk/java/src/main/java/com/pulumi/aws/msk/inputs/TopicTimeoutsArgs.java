...
public final class TopicTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final TopicTimeoutsArgs Empty = new TopicTimeoutsArgs();
    ...
    private TopicTimeoutsArgs() {}

    private TopicTimeoutsArgs(TopicTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(TopicTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TopicTimeoutsArgs();
        }

        public Builder(TopicTimeoutsArgs defaults) {
            $ = new TopicTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TopicTimeoutsArgs build() {
            return $;
        }
    }
