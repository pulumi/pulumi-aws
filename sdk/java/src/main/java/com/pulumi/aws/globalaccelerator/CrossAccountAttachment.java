...
public class CrossAccountAttachment extends com.pulumi.resources.CustomResource {
     ...
     */
    public CrossAccountAttachment(String name) {
     ...
     */
    public CrossAccountAttachment(String name, @Nullable CrossAccountAttachmentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CrossAccountAttachment(String name, @Nullable CrossAccountAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:globalaccelerator/crossAccountAttachment:CrossAccountAttachment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private CrossAccountAttachment(String name, Output<String> id, @Nullable CrossAccountAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:globalaccelerator/crossAccountAttachment:CrossAccountAttachment", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static CrossAccountAttachment get(String name, Output<String> id, @Nullable CrossAccountAttachmentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
