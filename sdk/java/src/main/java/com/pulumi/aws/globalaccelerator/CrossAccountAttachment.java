...
public class CrossAccountAttachment extends com.pulumi.resources.CustomResource {
    ...
    public CrossAccountAttachment(String name, @Nullable CrossAccountAttachmentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:globalaccelerator/crossAccountAttachment:CrossAccountAttachment", name, args == null ? CrossAccountAttachmentArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
