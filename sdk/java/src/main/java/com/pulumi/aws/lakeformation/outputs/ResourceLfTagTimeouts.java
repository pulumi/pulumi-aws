...
public final class ResourceLfTagTimeouts {
    ...
    public static Builder builder(ResourceLfTagTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(ResourceLfTagTimeouts defaults) {
        ...
        public ResourceLfTagTimeouts build() {
            final var _resultValue = new ResourceLfTagTimeouts();
