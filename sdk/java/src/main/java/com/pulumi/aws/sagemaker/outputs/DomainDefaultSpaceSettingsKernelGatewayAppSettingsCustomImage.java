...
@CustomType
public final class DomainDefaultSpaceSettingsKernelGatewayAppSettingsCustomImage {
    /**
    ...
    public static Builder builder(DomainDefaultSpaceSettingsKernelGatewayAppSettingsCustomImage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer imageVersionNumber;
        public Builder() {}
        public Builder(DomainDefaultSpaceSettingsKernelGatewayAppSettingsCustomImage defaults) {
        ...
        public Builder appImageConfigName(String appImageConfigName) {
            if (appImageConfigName == null) {
              throw new MissingRequiredPropertyException("DomainDefaultSpaceSettingsKernelGatewayAppSettingsCustomImage", "appImageConfigName");
            }
        ...
        public Builder imageName(String imageName) {
            if (imageName == null) {
              throw new MissingRequiredPropertyException("DomainDefaultSpaceSettingsKernelGatewayAppSettingsCustomImage", "imageName");
            }
