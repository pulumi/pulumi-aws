...
import com.pulumi.aws.bedrock.outputs.AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfigurationHostingEnvironment;
...
public final class AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfiguration {
    ...
    public static Builder builder(AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> workloadIdentities;
        public Builder() {}
        public Builder(AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfiguration defaults) {
        ...
        @CustomType.Setter
        public Builder hostingEnvironments(@Nullable List<AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfigurationHostingEnvironment> hostingEnvironments) {

            this.hostingEnvironments = hostingEnvironments;
            return this;
        }
        public Builder hostingEnvironments(AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfigurationHostingEnvironment... hostingEnvironments) {
        ...
        public AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfiguration build() {
            final var _resultValue = new AgentcoreHarnessAuthorizerConfigurationCustomJwtAuthorizerAllowedWorkloadConfiguration();
