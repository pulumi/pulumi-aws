...
public class ResourceCollection extends com.pulumi.resources.CustomResource {
     ...
     */
    public ResourceCollection(java.lang.String name) {
     ...
     */
    public ResourceCollection(java.lang.String name, ResourceCollectionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ResourceCollection(java.lang.String name, ResourceCollectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:devopsguru/resourceCollection:ResourceCollection", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ResourceCollection(java.lang.String name, Output<java.lang.String> id, @Nullable ResourceCollectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:devopsguru/resourceCollection:ResourceCollection", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ResourceCollection get(java.lang.String name, Output<java.lang.String> id, @Nullable ResourceCollectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
