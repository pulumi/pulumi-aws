...
@CustomType
public final class WebAclRuleGroupAssociationVisibilityConfig {
    /**
    ...
    private WebAclRuleGroupAssociationVisibilityConfig() {}
    /**
     * @return Whether the associated resource sends metrics to CloudWatch. For the list of available metrics, see [AWS WAF Metrics](https://docs.aws.amazon.com/waf/latest/developerguide/monitoring-cloudwatch.html#waf-metrics).
     * 
     */
    ...
    public static Builder builder(WebAclRuleGroupAssociationVisibilityConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean sampledRequestsEnabled;
        public Builder() {}
        public Builder(WebAclRuleGroupAssociationVisibilityConfig defaults) {
        ...
        public Builder cloudwatchMetricsEnabled(Boolean cloudwatchMetricsEnabled) {
            if (cloudwatchMetricsEnabled == null) {
              throw new MissingRequiredPropertyException("WebAclRuleGroupAssociationVisibilityConfig", "cloudwatchMetricsEnabled");
            }
        ...
        public Builder metricName(String metricName) {
            if (metricName == null) {
              throw new MissingRequiredPropertyException("WebAclRuleGroupAssociationVisibilityConfig", "metricName");
            }
        ...
        public Builder sampledRequestsEnabled(Boolean sampledRequestsEnabled) {
            if (sampledRequestsEnabled == null) {
              throw new MissingRequiredPropertyException("WebAclRuleGroupAssociationVisibilityConfig", "sampledRequestsEnabled");
            }
            this.sampledRequestsEnabled = sampledRequestsEnabled;
            return this;
        }
        public WebAclRuleGroupAssociationVisibilityConfig build() {
            final var _resultValue = new WebAclRuleGroupAssociationVisibilityConfig();
