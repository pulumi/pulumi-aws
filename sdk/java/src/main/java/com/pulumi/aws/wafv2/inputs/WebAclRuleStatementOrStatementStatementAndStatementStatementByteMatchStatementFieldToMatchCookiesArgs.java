...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs;
...
public final class WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs Empty = new WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs();
    ...
    private Output<List<WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns;
     ...
     * 
     */
    public Output<List<WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns() {
    ...
    private WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs() {}

    private WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs(WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs();
        }

        public Builder(WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs defaults) {
            $ = new WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPatterns(Output<List<WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns) {
         ...
         * 
         */
        public Builder matchPatterns(List<WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs> matchPatterns) {
         ...
         * 
         */
        public Builder matchPatterns(WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs... matchPatterns) {
        ...
        public WebAclRuleStatementOrStatementStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs build() {
