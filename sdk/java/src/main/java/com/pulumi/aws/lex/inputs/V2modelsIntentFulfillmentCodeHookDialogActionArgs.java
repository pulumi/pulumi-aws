...
public final class V2modelsIntentFulfillmentCodeHookDialogActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentFulfillmentCodeHookDialogActionArgs Empty = new V2modelsIntentFulfillmentCodeHookDialogActionArgs();
    ...
    private V2modelsIntentFulfillmentCodeHookDialogActionArgs() {}

    private V2modelsIntentFulfillmentCodeHookDialogActionArgs(V2modelsIntentFulfillmentCodeHookDialogActionArgs $) {
    ...
    public static Builder builder(V2modelsIntentFulfillmentCodeHookDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentFulfillmentCodeHookDialogActionArgs();
        }

        public Builder(V2modelsIntentFulfillmentCodeHookDialogActionArgs defaults) {
            $ = new V2modelsIntentFulfillmentCodeHookDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentFulfillmentCodeHookDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentFulfillmentCodeHookDialogActionArgs", "type");
            }
            return $;
        }
    }
