...
public final class RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatementFieldToMatchSingleHeader {
    ...
    private RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatementFieldToMatchSingleHeader() {}
    /**
     * @return The name of the query header to inspect. This setting must be provided as lower case characters.
     * 
     */
    ...
    public static final class Builder {
        ...
        public RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatementFieldToMatchSingleHeader build() {
            final var o = new RuleGroupRuleStatementAndStatementStatementAndStatementStatementByteMatchStatementFieldToMatchSingleHeader();
            o.name = name;
            return o;
        }
    }
