...
public final class CostCategoryRuleRuleOrOrDimension {
    ...
    public static Builder builder(CostCategoryRuleRuleOrOrDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleOrOrDimension defaults) {
        ...
        public CostCategoryRuleRuleOrOrDimension build() {
            final var _resultValue = new CostCategoryRuleRuleOrOrDimension();
