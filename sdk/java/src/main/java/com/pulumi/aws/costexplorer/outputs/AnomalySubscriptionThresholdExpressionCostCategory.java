...
public final class AnomalySubscriptionThresholdExpressionCostCategory {
    ...
    private AnomalySubscriptionThresholdExpressionCostCategory() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(AnomalySubscriptionThresholdExpressionCostCategory defaults) {
        ...
        public AnomalySubscriptionThresholdExpressionCostCategory build() {
            final var _resultValue = new AnomalySubscriptionThresholdExpressionCostCategory();
