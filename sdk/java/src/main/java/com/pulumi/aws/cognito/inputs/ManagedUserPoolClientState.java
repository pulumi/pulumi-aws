...
public final class ManagedUserPoolClientState extends com.pulumi.resources.ResourceArgs {
    ...
    private ManagedUserPoolClientState(ManagedUserPoolClientState $) {
    ...
    public static Builder builder(ManagedUserPoolClientState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedUserPoolClientState();
        }

        public Builder(ManagedUserPoolClientState defaults) {
            $ = new ManagedUserPoolClientState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param name Name of the user pool client.
         * 
         * @return builder
         * 
         */
