...
public final class AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs Empty = new AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs();
    ...
    private AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs(AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs $) {
    ...
    public static Builder builder(AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs();
        }

        public Builder(AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs defaults) {
            $ = new AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnalysisDefinitionSheetParameterControlDropdownDisplayOptionsArgs build() {
            return $;
        }
    }
