...
public final class V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction {
    ...
    private V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction() {}
    /**
     * @return If the dialog action is `ElicitSlot`, defines the slot to elicit from the user.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction build() {
            final var _resultValue = new V2modelsIntentClosingSettingConditionalDefaultBranchNextStepDialogAction();
