...
public final class ApnsVoipSandboxChannelArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ApnsVoipSandboxChannelArgs(ApnsVoipSandboxChannelArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApnsVoipSandboxChannelArgs();
        }

        public Builder(ApnsVoipSandboxChannelArgs defaults) {
            $ = new ApnsVoipSandboxChannelArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApnsVoipSandboxChannelArgs build() {
            if ($.applicationId == null) {
                throw new MissingRequiredPropertyException("ApnsVoipSandboxChannelArgs", "applicationId");
            }
            return $;
        }
    }
