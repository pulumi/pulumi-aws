...
public final class InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs build() {
            if ($.unit == null) {
                throw new MissingRequiredPropertyException("InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs", "unit");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("InsightFiltersResourceAwsIamAccessKeyCreatedAtDateRangeArgs", "value");
            }
            return $;
        }
    }
