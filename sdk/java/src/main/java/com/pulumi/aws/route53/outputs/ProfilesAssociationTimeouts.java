...
public final class ProfilesAssociationTimeouts {
    ...
    public static Builder builder(ProfilesAssociationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ProfilesAssociationTimeouts defaults) {
        ...
        public ProfilesAssociationTimeouts build() {
            final var _resultValue = new ProfilesAssociationTimeouts();
