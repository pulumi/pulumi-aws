...
@CustomType
public final class V2modelsIntentInitialResponseSettingDialogAction {
    /**
    ...
    private V2modelsIntentInitialResponseSettingDialogAction() {}
    /**
     * @return If the dialog action is `ElicitSlot`, defines the slot to elicit from the user.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentInitialResponseSettingDialogAction build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingDialogAction();
