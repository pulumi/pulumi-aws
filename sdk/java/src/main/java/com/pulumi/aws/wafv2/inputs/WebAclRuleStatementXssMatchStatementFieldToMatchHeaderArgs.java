...
public final class WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;

    /**
     * @return Headers to inspect. See Headers Match Pattern below.
     * 
     */
    public Optional<Output<WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs>> matchPattern() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder matchPattern(@Nullable Output<WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
