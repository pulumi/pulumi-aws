...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs Empty = new WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs();
    ...
    private Output<WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs() {}

    private WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs(WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs();
        }

        public Builder(WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs defaults) {
            $ = new WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs build() {
            if ($.matchPattern == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs", "matchPattern");
            }
            if ($.matchScope == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs", "matchScope");
            }
            if ($.oversizeHandling == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementXssMatchStatementFieldToMatchHeaderArgs", "oversizeHandling");
            }
            return $;
        }
    }
