 ...
 *                 .name(String.format(&#34;%s._domainkey&#34;, exampleDomainDkim.dkimTokens()[range.value()]))
 *                 .type(&#34;CNAME&#34;)
 *                 .ttl(&#34;600&#34;)
 *                 .records(String.format(&#34;%s.dkim.amazonses.com&#34;, exampleDomainDkim.dkimTokens()[range.value()]))
 *                 .build());
 * 
 *         
 * }
