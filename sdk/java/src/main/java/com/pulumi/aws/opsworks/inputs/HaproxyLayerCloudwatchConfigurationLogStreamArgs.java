...
public final class HaproxyLayerCloudwatchConfigurationLogStreamArgs extends com.pulumi.resources.ResourceArgs {

    public static final HaproxyLayerCloudwatchConfigurationLogStreamArgs Empty = new HaproxyLayerCloudwatchConfigurationLogStreamArgs();
    ...
    private HaproxyLayerCloudwatchConfigurationLogStreamArgs() {}

    private HaproxyLayerCloudwatchConfigurationLogStreamArgs(HaproxyLayerCloudwatchConfigurationLogStreamArgs $) {
    ...
    public static Builder builder(HaproxyLayerCloudwatchConfigurationLogStreamArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HaproxyLayerCloudwatchConfigurationLogStreamArgs();
        }

        public Builder(HaproxyLayerCloudwatchConfigurationLogStreamArgs defaults) {
            $ = new HaproxyLayerCloudwatchConfigurationLogStreamArgs(Objects.requireNonNull(defaults));
        }
        ...
        public HaproxyLayerCloudwatchConfigurationLogStreamArgs build() {
            if ($.file == null) {
                throw new MissingRequiredPropertyException("HaproxyLayerCloudwatchConfigurationLogStreamArgs", "file");
            }
            if ($.logGroupName == null) {
                throw new MissingRequiredPropertyException("HaproxyLayerCloudwatchConfigurationLogStreamArgs", "logGroupName");
            }
            return $;
        }
    }
