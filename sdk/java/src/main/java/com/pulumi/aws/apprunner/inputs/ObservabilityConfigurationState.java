...
public final class ObservabilityConfigurationState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param latest Whether the observability configuration has the highest `observabilityConfigurationRevision` among all configurations that share the same `observabilityConfigurationName`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param observabilityConfigurationRevision Revision of this observability configuration.
         * 
         * @return builder
         * 
         */
