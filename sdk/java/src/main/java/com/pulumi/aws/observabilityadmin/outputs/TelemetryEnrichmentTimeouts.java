...
@CustomType
public final class TelemetryEnrichmentTimeouts {
    /**
    ...
    private TelemetryEnrichmentTimeouts() {}
    /**
     * @return A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as &#34;30s&#34; or &#34;2h45m&#34;. Valid time units are &#34;s&#34; (seconds), &#34;m&#34; (minutes), &#34;h&#34; (hours).
     * 
     */
    ...
    public static Builder builder(TelemetryEnrichmentTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(TelemetryEnrichmentTimeouts defaults) {
        ...
        public TelemetryEnrichmentTimeouts build() {
            final var _resultValue = new TelemetryEnrichmentTimeouts();
