...
@CustomType
public final class FilterFilterCriteriaEcrImageLastInUseAt {
    /**
    ...
    private FilterFilterCriteriaEcrImageLastInUseAt() {}
    /**
     * @return (Required) The end of the port range, inclusive.
     * 
     */
    ...
    public static Builder builder(FilterFilterCriteriaEcrImageLastInUseAt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startInclusive;
        public Builder() {}
        public Builder(FilterFilterCriteriaEcrImageLastInUseAt defaults) {
        ...
        public FilterFilterCriteriaEcrImageLastInUseAt build() {
            final var _resultValue = new FilterFilterCriteriaEcrImageLastInUseAt();
