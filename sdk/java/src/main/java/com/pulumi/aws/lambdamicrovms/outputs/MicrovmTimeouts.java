...
@CustomType
public final class MicrovmTimeouts {
    /**
    ...
    public static Builder builder(MicrovmTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(MicrovmTimeouts defaults) {
        ...
        public MicrovmTimeouts build() {
            final var _resultValue = new MicrovmTimeouts();
