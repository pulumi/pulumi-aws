...
@CustomType
public final class BudgetFilterExpressionNotNotCostCategories {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionNotNotCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotNotCostCategories defaults) {
        ...
        public BudgetFilterExpressionNotNotCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionNotNotCostCategories();
