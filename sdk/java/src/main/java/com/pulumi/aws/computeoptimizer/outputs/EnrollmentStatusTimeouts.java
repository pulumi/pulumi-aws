...
public final class EnrollmentStatusTimeouts {
    ...
    public static Builder builder(EnrollmentStatusTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(EnrollmentStatusTimeouts defaults) {
        ...
        public EnrollmentStatusTimeouts build() {
            final var _resultValue = new EnrollmentStatusTimeouts();
