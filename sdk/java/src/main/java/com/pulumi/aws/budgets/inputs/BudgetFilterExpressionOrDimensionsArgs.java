...
public final class BudgetFilterExpressionOrDimensionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionOrDimensionsArgs Empty = new BudgetFilterExpressionOrDimensionsArgs();
    ...
    private BudgetFilterExpressionOrDimensionsArgs() {}

    private BudgetFilterExpressionOrDimensionsArgs(BudgetFilterExpressionOrDimensionsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionOrDimensionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionOrDimensionsArgs();
        }

        public Builder(BudgetFilterExpressionOrDimensionsArgs defaults) {
            $ = new BudgetFilterExpressionOrDimensionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionOrDimensionsArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionOrDimensionsArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionOrDimensionsArgs", "values");
            }
            return $;
        }
    }
