...
import com.pulumi.aws.bedrock.outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigClientSecretConfig;
import com.pulumi.aws.bedrock.outputs.AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigOauthDiscovery;
...
@CustomType
public final class AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfig {
    /**
     ...
     * 
     */
    private @Nullable AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigClientSecretConfig clientSecretConfig;
    /**
     ...
     * 
     */
    private @Nullable List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigOauthDiscovery> oauthDiscoveries;

    private AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfig() {}
    /**
     * @return Version used together with the write-only credentials. Required when `clientIdWo` and `clientSecretWo` are set. Changing this value triggers an update to `clientIdWo` and `clientSecretWo`.
     * 
     */
     ...
     * 
     */
    public Optional<AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigClientSecretConfig> clientSecretConfig() {
     ...
     * 
     */
    public List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigOauthDiscovery> oauthDiscoveries() {
    ...
    public static Builder builder(AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigOauthDiscovery> oauthDiscoveries;
        public Builder() {}
        public Builder(AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfig defaults) {
        ...
        @CustomType.Setter
        public Builder clientSecretConfig(@Nullable AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigClientSecretConfig clientSecretConfig) {
        ...
        @CustomType.Setter
        public Builder oauthDiscoveries(@Nullable List<AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigOauthDiscovery> oauthDiscoveries) {

            this.oauthDiscoveries = oauthDiscoveries;
            return this;
        }
        public Builder oauthDiscoveries(AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfigOauthDiscovery... oauthDiscoveries) {
            return oauthDiscoveries(List.of(oauthDiscoveries));
        }
        public AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfig build() {
            final var _resultValue = new AgentcoreOauth2CredentialProviderOauth2ProviderConfigSalesforceOauth2ProviderConfig();
