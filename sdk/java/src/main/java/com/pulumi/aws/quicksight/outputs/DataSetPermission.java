...
public final class DataSetPermission {
    ...
    public static Builder builder(DataSetPermission defaults) {
    ...
    public static final class Builder {
        ...
        private String principal;
        public Builder() {}
        public Builder(DataSetPermission defaults) {
        ...
        public Builder actions(List<String> actions) {
            if (actions == null) {
              throw new MissingRequiredPropertyException("DataSetPermission", "actions");
            }
        ...
        public Builder principal(String principal) {
            if (principal == null) {
              throw new MissingRequiredPropertyException("DataSetPermission", "principal");
            }
