...
public final class BudgetFilterExpressionOrAndDimensionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BudgetFilterExpressionOrAndDimensionsArgs Empty = new BudgetFilterExpressionOrAndDimensionsArgs();
    ...
    private BudgetFilterExpressionOrAndDimensionsArgs() {}

    private BudgetFilterExpressionOrAndDimensionsArgs(BudgetFilterExpressionOrAndDimensionsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(BudgetFilterExpressionOrAndDimensionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BudgetFilterExpressionOrAndDimensionsArgs();
        }

        public Builder(BudgetFilterExpressionOrAndDimensionsArgs defaults) {
            $ = new BudgetFilterExpressionOrAndDimensionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BudgetFilterExpressionOrAndDimensionsArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionOrAndDimensionsArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("BudgetFilterExpressionOrAndDimensionsArgs", "values");
            }
            return $;
        }
    }
