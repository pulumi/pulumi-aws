...
@CustomType
public final class AgentcoreGatewayTargetTimeouts {
    /**
    ...
    public static Builder builder(AgentcoreGatewayTargetTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(AgentcoreGatewayTargetTimeouts defaults) {
        ...
        public AgentcoreGatewayTargetTimeouts build() {
            final var _resultValue = new AgentcoreGatewayTargetTimeouts();
