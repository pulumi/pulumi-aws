...
public final class ClusterTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterTimeoutsArgs Empty = new ClusterTimeoutsArgs();
    ...
    private ClusterTimeoutsArgs() {}

    private ClusterTimeoutsArgs(ClusterTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(ClusterTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterTimeoutsArgs();
        }

        public Builder(ClusterTimeoutsArgs defaults) {
            $ = new ClusterTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterTimeoutsArgs build() {
            return $;
        }
    }
