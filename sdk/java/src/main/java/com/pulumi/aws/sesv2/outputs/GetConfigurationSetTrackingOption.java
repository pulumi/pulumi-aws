...
public final class GetConfigurationSetTrackingOption {
    /**
     * @return Domain used for tracking open and click events.
     * 
     */
    private String customRedirectDomain;
    /**
     * @return HTTPS policy used for tracking open and click events. Valid values are `REQUIRE`, `REQUIRE_OPEN_ONLY`, or `OPTIONAL`.
     * 
     */
