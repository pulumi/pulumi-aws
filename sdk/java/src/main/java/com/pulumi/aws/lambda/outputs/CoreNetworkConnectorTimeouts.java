...
@CustomType
public final class CoreNetworkConnectorTimeouts {
    /**
    ...
    public static Builder builder(CoreNetworkConnectorTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(CoreNetworkConnectorTimeouts defaults) {
        ...
        public CoreNetworkConnectorTimeouts build() {
            final var _resultValue = new CoreNetworkConnectorTimeouts();
