...
@CustomType
public final class BudgetFilterExpressionNotNotTags {
    /**
    ...
    private BudgetFilterExpressionNotNotTags() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionNotNotTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotNotTags defaults) {
        ...
        public BudgetFilterExpressionNotNotTags build() {
            final var _resultValue = new BudgetFilterExpressionNotNotTags();
