...
public final class TemplateDefinitionSheetParameterControlTextAreaArgs extends com.pulumi.resources.ResourceArgs {

    public static final TemplateDefinitionSheetParameterControlTextAreaArgs Empty = new TemplateDefinitionSheetParameterControlTextAreaArgs();
    ...
    private TemplateDefinitionSheetParameterControlTextAreaArgs() {}

    private TemplateDefinitionSheetParameterControlTextAreaArgs(TemplateDefinitionSheetParameterControlTextAreaArgs $) {
    ...
    public static Builder builder(TemplateDefinitionSheetParameterControlTextAreaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TemplateDefinitionSheetParameterControlTextAreaArgs();
        }

        public Builder(TemplateDefinitionSheetParameterControlTextAreaArgs defaults) {
            $ = new TemplateDefinitionSheetParameterControlTextAreaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TemplateDefinitionSheetParameterControlTextAreaArgs build() {
            if ($.parameterControlId == null) {
                throw new MissingRequiredPropertyException("TemplateDefinitionSheetParameterControlTextAreaArgs", "parameterControlId");
            }
            if ($.sourceParameterName == null) {
                throw new MissingRequiredPropertyException("TemplateDefinitionSheetParameterControlTextAreaArgs", "sourceParameterName");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("TemplateDefinitionSheetParameterControlTextAreaArgs", "title");
            }
            return $;
        }
    }
