...
public final class AgentKnowledgeBaseTimeouts {
    ...
    public static Builder builder(AgentKnowledgeBaseTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(AgentKnowledgeBaseTimeouts defaults) {
        ...
        public AgentKnowledgeBaseTimeouts build() {
            final var _resultValue = new AgentKnowledgeBaseTimeouts();
