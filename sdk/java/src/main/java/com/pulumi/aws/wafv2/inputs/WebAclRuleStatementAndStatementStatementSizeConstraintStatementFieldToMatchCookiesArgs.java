...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs;
...
public final class WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs Empty = new WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs();
    ...
    private Output<List<WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns;
     ...
     * 
     */
    public Output<List<WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns() {
    ...
    private WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs() {}

    private WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs(WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs();
        }

        public Builder(WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs defaults) {
            $ = new WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPatterns(Output<List<WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns) {
         ...
         * 
         */
        public Builder matchPatterns(List<WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs> matchPatterns) {
         ...
         * 
         */
        public Builder matchPatterns(WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesMatchPatternArgs... matchPatterns) {
        ...
        public WebAclRuleStatementAndStatementStatementSizeConstraintStatementFieldToMatchCookiesArgs build() {
