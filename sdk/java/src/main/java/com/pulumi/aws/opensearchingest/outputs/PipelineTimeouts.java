...
public final class PipelineTimeouts {
    ...
    public static Builder builder(PipelineTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(PipelineTimeouts defaults) {
        ...
        public PipelineTimeouts build() {
            final var _resultValue = new PipelineTimeouts();
