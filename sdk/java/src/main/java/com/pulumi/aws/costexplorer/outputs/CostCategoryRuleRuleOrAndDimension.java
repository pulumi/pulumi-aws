...
public final class CostCategoryRuleRuleOrAndDimension {
    ...
    public static Builder builder(CostCategoryRuleRuleOrAndDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleOrAndDimension defaults) {
        ...
        public CostCategoryRuleRuleOrAndDimension build() {
            final var _resultValue = new CostCategoryRuleRuleOrAndDimension();
