...
public final class InstanceConnectEndpointTimeoutsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InstanceConnectEndpointTimeoutsArgs(InstanceConnectEndpointTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
    }
    ...
    public static Builder builder(InstanceConnectEndpointTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConnectEndpointTimeoutsArgs();
        }

        public Builder(InstanceConnectEndpointTimeoutsArgs defaults) {
            $ = new InstanceConnectEndpointTimeoutsArgs(Objects.requireNonNull(defaults));
        }
