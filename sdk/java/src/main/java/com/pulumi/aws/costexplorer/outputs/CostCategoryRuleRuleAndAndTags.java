...
@CustomType
public final class CostCategoryRuleRuleAndAndTags {
    /**
    ...
    private CostCategoryRuleRuleAndAndTags() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleAndAndTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleAndAndTags defaults) {
        ...
        public CostCategoryRuleRuleAndAndTags build() {
            final var _resultValue = new CostCategoryRuleRuleAndAndTags();
