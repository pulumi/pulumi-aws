...
public final class WebAclRuleStatementXssMatchStatementArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<WebAclRuleStatementXssMatchStatementTextTransformationArgs>> textTransformations;

    public Optional<Output<List<WebAclRuleStatementXssMatchStatementTextTransformationArgs>>> textTransformations() {
    ...
    public static final class Builder {
        ...
        public Builder textTransformations(@Nullable Output<List<WebAclRuleStatementXssMatchStatementTextTransformationArgs>> textTransformations) {
