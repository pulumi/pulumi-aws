...
public final class WebAclRuleActionBlockCustomResponseResponseHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public WebAclRuleActionBlockCustomResponseResponseHeaderArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("WebAclRuleActionBlockCustomResponseResponseHeaderArgs", "name");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("WebAclRuleActionBlockCustomResponseResponseHeaderArgs", "value");
            }
            return $;
        }
    }
