...
@CustomType
public final class IngressPointTimeouts {
    /**
    ...
    public static Builder builder(IngressPointTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(IngressPointTimeouts defaults) {
        ...
        public IngressPointTimeouts build() {
            final var _resultValue = new IngressPointTimeouts();
