    ...
    public static final class Builder {
        ...
        public Builder parameterName(String parameterName) {
            if (parameterName == null) {
              throw new MissingRequiredPropertyException("FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter", "parameterName");
            }
        ...
        public Builder parameterValue(String parameterValue) {
            if (parameterValue == null) {
              throw new MissingRequiredPropertyException("FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter", "parameterValue");
            }
            this.parameterValue = parameterValue;
            return this;
        }
        public FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter build() {
            final var _resultValue = new FirehoseDeliveryStreamSplunkConfigurationProcessingConfigurationProcessorParameter();
