...
import com.pulumi.aws.quicksight.inputs.VisualsWaterfallVisualChartConfigurationArgs;
...
public final class VisualsWaterfallVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsWaterfallVisualArgs Empty = new VisualsWaterfallVisualArgs();
    ...
    private @Nullable Output<VisualsWaterfallVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsWaterfallVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsWaterfallVisualArgs() {}

    private VisualsWaterfallVisualArgs(VisualsWaterfallVisualArgs $) {
    ...
    public static Builder builder(VisualsWaterfallVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsWaterfallVisualArgs();
        }

        public Builder(VisualsWaterfallVisualArgs defaults) {
            $ = new VisualsWaterfallVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsWaterfallVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsWaterfallVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsWaterfallVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsWaterfallVisualArgs", "visualId");
            }
            return $;
        }
    }
