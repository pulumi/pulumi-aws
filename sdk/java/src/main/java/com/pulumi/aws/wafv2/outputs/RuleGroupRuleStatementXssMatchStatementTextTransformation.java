...
public final class RuleGroupRuleStatementXssMatchStatementTextTransformation {
    ...
    public static final class Builder {
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementXssMatchStatementTextTransformation", "priority");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementXssMatchStatementTextTransformation", "type");
            }
            this.type = type;
            return this;
        }
