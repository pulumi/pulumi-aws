...
public final class TelemetryRuleForOrganizationRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<TelemetryRuleForOrganizationRuleDestinationConfigurationArgs> destinationConfiguration;

    /**
     * @return Configuration block specifying where and how the telemetry data is delivered. See `destinationConfiguration` below.
     * 
     */
    public Optional<Output<TelemetryRuleForOrganizationRuleDestinationConfigurationArgs>> destinationConfiguration() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder destinationConfiguration(@Nullable Output<TelemetryRuleForOrganizationRuleDestinationConfigurationArgs> destinationConfiguration) {
         ...
         * 
         */
        public Builder destinationConfiguration(TelemetryRuleForOrganizationRuleDestinationConfigurationArgs destinationConfiguration) {
