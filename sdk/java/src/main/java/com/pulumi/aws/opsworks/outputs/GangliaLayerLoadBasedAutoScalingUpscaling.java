...
public final class GangliaLayerLoadBasedAutoScalingUpscaling {
    ...
    private GangliaLayerLoadBasedAutoScalingUpscaling() {}
    ...
    public static Builder builder(GangliaLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(GangliaLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public GangliaLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new GangliaLayerLoadBasedAutoScalingUpscaling();
