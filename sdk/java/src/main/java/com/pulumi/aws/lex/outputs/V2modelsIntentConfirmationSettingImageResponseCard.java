...
public final class V2modelsIntentConfirmationSettingImageResponseCard {
    ...
    private V2modelsIntentConfirmationSettingImageResponseCard() {}
    /**
     * @return Configuration blocks for buttons that should be displayed on the response card. The arrangement of the buttons is determined by the platform that displays the button. See `button`.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingImageResponseCard defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(V2modelsIntentConfirmationSettingImageResponseCard defaults) {
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingImageResponseCard", "title");
            }
            this.title = title;
            return this;
        }
        public V2modelsIntentConfirmationSettingImageResponseCard build() {
            final var _resultValue = new V2modelsIntentConfirmationSettingImageResponseCard();
