...
public final class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricDimensionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricDimensionArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricDimensionArgs", "name");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetricDimensionArgs", "value");
            }
            return $;
        }
    }
