...
@CustomType
public final class MysqlLayerLoadBasedAutoScalingUpscaling {
    ...
    private MysqlLayerLoadBasedAutoScalingUpscaling() {}
    ...
    public static Builder builder(MysqlLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(MysqlLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public MysqlLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new MysqlLayerLoadBasedAutoScalingUpscaling();
