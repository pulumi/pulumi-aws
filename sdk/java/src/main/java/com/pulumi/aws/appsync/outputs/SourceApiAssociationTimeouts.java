...
public final class SourceApiAssociationTimeouts {
    ...
    public static Builder builder(SourceApiAssociationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(SourceApiAssociationTimeouts defaults) {
        ...
        public SourceApiAssociationTimeouts build() {
            final var _resultValue = new SourceApiAssociationTimeouts();
