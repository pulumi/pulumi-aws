...
public final class V2modelsIntentConfirmationSettingDialogActionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private V2modelsIntentConfirmationSettingDialogActionArgs() {}
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(V2modelsIntentConfirmationSettingDialogActionArgs defaults) {
            $ = new V2modelsIntentConfirmationSettingDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentConfirmationSettingDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingDialogActionArgs", "type");
            }
            return $;
        }
    }
