...
public final class BucketLifecycleConfigurationV2TimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BucketLifecycleConfigurationV2TimeoutsArgs Empty = new BucketLifecycleConfigurationV2TimeoutsArgs();
    ...
    private BucketLifecycleConfigurationV2TimeoutsArgs() {}

    private BucketLifecycleConfigurationV2TimeoutsArgs(BucketLifecycleConfigurationV2TimeoutsArgs $) {
        this.create = $.create;
        this.update = $.update;
    }
    ...
    public static Builder builder(BucketLifecycleConfigurationV2TimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BucketLifecycleConfigurationV2TimeoutsArgs();
        }

        public Builder(BucketLifecycleConfigurationV2TimeoutsArgs defaults) {
            $ = new BucketLifecycleConfigurationV2TimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BucketLifecycleConfigurationV2TimeoutsArgs build() {
            return $;
        }
    }
