...
public final class GetMulticastDomainFilter extends com.pulumi.resources.InvokeArgs {
    ...
    private GetMulticastDomainFilter(GetMulticastDomainFilter $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMulticastDomainFilter();
        }

        public Builder(GetMulticastDomainFilter defaults) {
            $ = new GetMulticastDomainFilter(Objects.requireNonNull(defaults));
        }
