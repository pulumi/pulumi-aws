...
public final class FilterFilterCriteriaEpssScore {
    ...
    public static Builder builder(FilterFilterCriteriaEpssScore defaults) {
    ...
    public static final class Builder {
        ...
        private Double upperInclusive;
        public Builder() {}
        public Builder(FilterFilterCriteriaEpssScore defaults) {
        ...
        public Builder lowerInclusive(Double lowerInclusive) {
            if (lowerInclusive == null) {
              throw new MissingRequiredPropertyException("FilterFilterCriteriaEpssScore", "lowerInclusive");
            }
        ...
        public Builder upperInclusive(Double upperInclusive) {
            if (upperInclusive == null) {
              throw new MissingRequiredPropertyException("FilterFilterCriteriaEpssScore", "upperInclusive");
            }
            this.upperInclusive = upperInclusive;
            return this;
        }
        public FilterFilterCriteriaEpssScore build() {
            final var _resultValue = new FilterFilterCriteriaEpssScore();
