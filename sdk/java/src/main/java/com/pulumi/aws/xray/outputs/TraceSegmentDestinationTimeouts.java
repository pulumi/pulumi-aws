...
@CustomType
public final class TraceSegmentDestinationTimeouts {
    /**
    ...
    public static Builder builder(TraceSegmentDestinationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(TraceSegmentDestinationTimeouts defaults) {
        ...
        public TraceSegmentDestinationTimeouts build() {
            final var _resultValue = new TraceSegmentDestinationTimeouts();
