...
public final class GetLicenseGrantsResult {
    ...
    public static Builder builder(GetLicenseGrantsResult defaults) {
    ...
    public static final class Builder {
        ...
        private String region;
        public Builder() {}
        public Builder(GetLicenseGrantsResult defaults) {
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetLicenseGrantsResult", "region");
            }
            this.region = region;
            return this;
        }
