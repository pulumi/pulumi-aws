...
public final class AnomalySubscriptionThresholdExpressionTagsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnomalySubscriptionThresholdExpressionTagsArgs Empty = new AnomalySubscriptionThresholdExpressionTagsArgs();
    ...
    private AnomalySubscriptionThresholdExpressionTagsArgs() {}

    private AnomalySubscriptionThresholdExpressionTagsArgs(AnomalySubscriptionThresholdExpressionTagsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionTagsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalySubscriptionThresholdExpressionTagsArgs();
        }

        public Builder(AnomalySubscriptionThresholdExpressionTagsArgs defaults) {
            $ = new AnomalySubscriptionThresholdExpressionTagsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnomalySubscriptionThresholdExpressionTagsArgs build() {
            return $;
        }
    }
