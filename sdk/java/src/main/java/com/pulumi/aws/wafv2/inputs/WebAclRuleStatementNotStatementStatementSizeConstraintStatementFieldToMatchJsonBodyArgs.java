...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs;
...
public final class WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs Empty = new WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs();
    ...
    private @Nullable Output<WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;

    /**
     * @return JSON content to inspect. See JSON Body Match Pattern below.
     * 
     */
    public Optional<Output<WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs>> matchPattern() {
    ...
    private WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs() {}

    private WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs(WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs();
        }

        public Builder(WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs defaults) {
            $ = new WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(@Nullable Output<WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs build() {
            if ($.matchScope == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementSizeConstraintStatementFieldToMatchJsonBodyArgs", "matchScope");
            }
            return $;
        }
    }
