...
@CustomType
public final class FilterFilterCriteriaLastObservedAt {
    /**
    ...
    public static Builder builder(FilterFilterCriteriaLastObservedAt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startInclusive;
        public Builder() {}
        public Builder(FilterFilterCriteriaLastObservedAt defaults) {
        ...
        public FilterFilterCriteriaLastObservedAt build() {
            final var _resultValue = new FilterFilterCriteriaLastObservedAt();
