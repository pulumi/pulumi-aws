    ...
    public static final class Builder {
        ...
        public WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs build() {
            if ($.fallbackBehavior == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs", "fallbackBehavior");
            }
            if ($.headerName == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs", "headerName");
            }
            if ($.position == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfigArgs", "position");
            }
            return $;
        }
    }
