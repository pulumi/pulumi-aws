...
public final class LogTransformerTransformerConfigParseCloudfrontArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LogTransformerTransformerConfigParseCloudfrontArgs() {}

    private LogTransformerTransformerConfigParseCloudfrontArgs(LogTransformerTransformerConfigParseCloudfrontArgs $) {
        this.source = $.source;
    }
    ...
    public static Builder builder(LogTransformerTransformerConfigParseCloudfrontArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LogTransformerTransformerConfigParseCloudfrontArgs();
        }

        public Builder(LogTransformerTransformerConfigParseCloudfrontArgs defaults) {
        ...
        public LogTransformerTransformerConfigParseCloudfrontArgs build() {
            return $;
        }
    }
