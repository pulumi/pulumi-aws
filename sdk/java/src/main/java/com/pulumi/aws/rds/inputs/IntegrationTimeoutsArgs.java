...
public final class IntegrationTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final IntegrationTimeoutsArgs Empty = new IntegrationTimeoutsArgs();
    ...
    private IntegrationTimeoutsArgs() {}

    private IntegrationTimeoutsArgs(IntegrationTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
    }
    ...
    public static Builder builder(IntegrationTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntegrationTimeoutsArgs();
        }

        public Builder(IntegrationTimeoutsArgs defaults) {
            $ = new IntegrationTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IntegrationTimeoutsArgs build() {
            return $;
        }
    }
