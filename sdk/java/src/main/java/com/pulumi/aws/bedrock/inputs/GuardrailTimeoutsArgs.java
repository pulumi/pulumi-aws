...
public final class GuardrailTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GuardrailTimeoutsArgs Empty = new GuardrailTimeoutsArgs();
    ...
    private GuardrailTimeoutsArgs(GuardrailTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(GuardrailTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GuardrailTimeoutsArgs();
        }

        public Builder(GuardrailTimeoutsArgs defaults) {
            $ = new GuardrailTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GuardrailTimeoutsArgs build() {
            return $;
        }
    }
