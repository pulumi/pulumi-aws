...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs;
...
public final class WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs Empty = new WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs();
    ...
    private Output<WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs() {}

    private WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs(WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs();
        }

        public Builder(WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs defaults) {
            $ = new WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs build() {
            if ($.matchPattern == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs", "matchPattern");
            }
            if ($.matchScope == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs", "matchScope");
            }
            return $;
        }
    }
