...
public final class WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;

    /**
     * @return JSON content to inspect. See JSON Body Match Pattern below.
     * 
     */
    public Optional<Output<WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs>> matchPattern() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder matchPattern(@Nullable Output<WebAclRuleStatementRegexMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
