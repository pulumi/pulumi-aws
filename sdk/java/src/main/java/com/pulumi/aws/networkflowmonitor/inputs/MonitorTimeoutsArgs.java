...
public final class MonitorTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final MonitorTimeoutsArgs Empty = new MonitorTimeoutsArgs();
    ...
    private MonitorTimeoutsArgs() {}

    private MonitorTimeoutsArgs(MonitorTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(MonitorTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitorTimeoutsArgs();
        }

        public Builder(MonitorTimeoutsArgs defaults) {
            $ = new MonitorTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MonitorTimeoutsArgs build() {
            return $;
        }
    }
