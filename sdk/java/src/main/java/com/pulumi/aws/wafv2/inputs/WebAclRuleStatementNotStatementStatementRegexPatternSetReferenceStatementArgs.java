...
public final class WebAclRuleStatementNotStatementStatementRegexPatternSetReferenceStatementArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<WebAclRuleStatementNotStatementStatementRegexPatternSetReferenceStatementTextTransformationArgs>> textTransformations;
     ...
     * 
     */
    public Optional<Output<List<WebAclRuleStatementNotStatementStatementRegexPatternSetReferenceStatementTextTransformationArgs>>> textTransformations() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder textTransformations(@Nullable Output<List<WebAclRuleStatementNotStatementStatementRegexPatternSetReferenceStatementTextTransformationArgs>> textTransformations) {
        ...
        public WebAclRuleStatementNotStatementStatementRegexPatternSetReferenceStatementArgs build() {
            if ($.arn == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementRegexPatternSetReferenceStatementArgs", "arn");
            }
            return $;
        }
    }
