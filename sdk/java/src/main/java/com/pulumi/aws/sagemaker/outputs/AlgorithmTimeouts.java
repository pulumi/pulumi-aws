...
@CustomType
public final class AlgorithmTimeouts {
    /**
    ...
    public static Builder builder(AlgorithmTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(AlgorithmTimeouts defaults) {
        ...
        public AlgorithmTimeouts build() {
            final var _resultValue = new AlgorithmTimeouts();
