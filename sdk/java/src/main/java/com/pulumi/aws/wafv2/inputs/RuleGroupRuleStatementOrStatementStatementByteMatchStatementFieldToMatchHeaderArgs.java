...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs Empty = new RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs();
    ...
    private Output<RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs() {}

    private RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs(RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs();
        }

        public Builder(RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs defaults) {
            $ = new RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public RuleGroupRuleStatementOrStatementStatementByteMatchStatementFieldToMatchHeaderArgs build() {
