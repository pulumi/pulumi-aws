...
public final class GangliaLayerCloudwatchConfigurationLogStream {
    ...
    public static final class Builder {
        ...
        public Builder file(String file) {
            if (file == null) {
              throw new MissingRequiredPropertyException("GangliaLayerCloudwatchConfigurationLogStream", "file");
            }
            this.file = file;
            return this;
        }
        ...
        public Builder logGroupName(String logGroupName) {
            if (logGroupName == null) {
              throw new MissingRequiredPropertyException("GangliaLayerCloudwatchConfigurationLogStream", "logGroupName");
            }
        ...
        public GangliaLayerCloudwatchConfigurationLogStream build() {
            final var _resultValue = new GangliaLayerCloudwatchConfigurationLogStream();
