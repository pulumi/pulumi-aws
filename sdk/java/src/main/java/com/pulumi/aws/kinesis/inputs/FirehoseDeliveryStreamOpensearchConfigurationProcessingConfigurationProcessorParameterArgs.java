...
public final class FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs(FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs $) {
    ...
    public static Builder builder(FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs();
        }

        public Builder(FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs defaults) {
            $ = new FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs build() {
            if ($.parameterName == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs", "parameterName");
            }
            if ($.parameterValue == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamOpensearchConfigurationProcessingConfigurationProcessorParameterArgs", "parameterValue");
            }
            return $;
        }
    }
