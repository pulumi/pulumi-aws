...
@CustomType
public final class PipelineTriggerGitConfigurationPullRequestBranches {
    /**
    ...
    private PipelineTriggerGitConfigurationPullRequestBranches() {}
    /**
     * @return A list of patterns of Git branches that, when a commit is pushed, are to be excluded from starting the pipeline.
     * 
     */
    ...
    public static Builder builder(PipelineTriggerGitConfigurationPullRequestBranches defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(PipelineTriggerGitConfigurationPullRequestBranches defaults) {
        ...
        public PipelineTriggerGitConfigurationPullRequestBranches build() {
            final var _resultValue = new PipelineTriggerGitConfigurationPullRequestBranches();
