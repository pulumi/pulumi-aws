...
public final class VpcEndpointAssociationSubnetMapping {
    ...
    public static Builder builder(VpcEndpointAssociationSubnetMapping defaults) {
    ...
    public static final class Builder {
        ...
        private String subnetId;
        public Builder() {}
        public Builder(VpcEndpointAssociationSubnetMapping defaults) {
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("VpcEndpointAssociationSubnetMapping", "subnetId");
            }
            this.subnetId = subnetId;
            return this;
        }
        public VpcEndpointAssociationSubnetMapping build() {
            final var _resultValue = new VpcEndpointAssociationSubnetMapping();
