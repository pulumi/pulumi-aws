...
public class ResourceSet extends com.pulumi.resources.CustomResource {
     ...
     */
    public ResourceSet(String name, @Nullable ResourceSetArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ResourceSet(String name, @Nullable ResourceSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:fms/resourceSet:ResourceSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private ResourceSet(String name, Output<String> id, @Nullable ResourceSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:fms/resourceSet:ResourceSet", name, state, makeResourceOptions(options, id));
    }
