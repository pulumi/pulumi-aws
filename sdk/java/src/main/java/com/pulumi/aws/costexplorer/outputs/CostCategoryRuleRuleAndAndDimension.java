...
public final class CostCategoryRuleRuleAndAndDimension {
    ...
    private CostCategoryRuleRuleAndAndDimension() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleAndAndDimension defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleAndAndDimension defaults) {
        ...
        public CostCategoryRuleRuleAndAndDimension build() {
            final var _resultValue = new CostCategoryRuleRuleAndAndDimension();
