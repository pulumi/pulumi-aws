...
public final class V2modelsIntentConfirmationSettingMessageGroup {
    ...
    private V2modelsIntentConfirmationSettingMessageGroup() {}
    /**
     * @return Configuration block for the primary message that Amazon Lex should send to the user. See `message`.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingMessageGroup defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<V2modelsIntentConfirmationSettingVariation> variations;
        public Builder() {}
        public Builder(V2modelsIntentConfirmationSettingMessageGroup defaults) {
        ...
        public Builder message(V2modelsIntentConfirmationSettingMessage message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingMessageGroup", "message");
            }
        ...
        public V2modelsIntentConfirmationSettingMessageGroup build() {
            final var _resultValue = new V2modelsIntentConfirmationSettingMessageGroup();
