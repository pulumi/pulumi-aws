...
@CustomType
public final class FilterFilterCriteriaFirstObservedAt {
    /**
    ...
    public static Builder builder(FilterFilterCriteriaFirstObservedAt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startInclusive;
        public Builder() {}
        public Builder(FilterFilterCriteriaFirstObservedAt defaults) {
        ...
        public FilterFilterCriteriaFirstObservedAt build() {
            final var _resultValue = new FilterFilterCriteriaFirstObservedAt();
