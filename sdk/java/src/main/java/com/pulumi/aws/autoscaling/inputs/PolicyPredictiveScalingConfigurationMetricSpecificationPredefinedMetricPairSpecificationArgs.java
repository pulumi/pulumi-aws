    ...
    public static final class Builder {
        ...
        public PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedMetricPairSpecificationArgs build() {
            if ($.predefinedMetricType == null) {
                throw new MissingRequiredPropertyException("PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedMetricPairSpecificationArgs", "predefinedMetricType");
            }
            return $;
        }
    }
