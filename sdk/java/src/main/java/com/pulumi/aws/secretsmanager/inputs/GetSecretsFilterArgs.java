...
public final class GetSecretsFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetSecretsFilterArgs() {}

    private GetSecretsFilterArgs(GetSecretsFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetSecretsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSecretsFilterArgs();
        }

        public Builder(GetSecretsFilterArgs defaults) {
            $ = new GetSecretsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSecretsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetSecretsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetSecretsFilterArgs", "values");
            }
            return $;
        }
    }
