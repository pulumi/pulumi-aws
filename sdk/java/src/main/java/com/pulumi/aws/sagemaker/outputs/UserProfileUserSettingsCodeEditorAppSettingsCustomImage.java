...
public final class UserProfileUserSettingsCodeEditorAppSettingsCustomImage {
    ...
    public static Builder builder(UserProfileUserSettingsCodeEditorAppSettingsCustomImage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer imageVersionNumber;
        public Builder() {}
        public Builder(UserProfileUserSettingsCodeEditorAppSettingsCustomImage defaults) {
        ...
        public Builder appImageConfigName(String appImageConfigName) {
            if (appImageConfigName == null) {
              throw new MissingRequiredPropertyException("UserProfileUserSettingsCodeEditorAppSettingsCustomImage", "appImageConfigName");
            }
        ...
        public Builder imageName(String imageName) {
            if (imageName == null) {
              throw new MissingRequiredPropertyException("UserProfileUserSettingsCodeEditorAppSettingsCustomImage", "imageName");
            }
        ...
        public UserProfileUserSettingsCodeEditorAppSettingsCustomImage build() {
            final var _resultValue = new UserProfileUserSettingsCodeEditorAppSettingsCustomImage();
