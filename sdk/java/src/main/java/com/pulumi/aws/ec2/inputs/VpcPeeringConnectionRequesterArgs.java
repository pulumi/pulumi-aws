...
public final class VpcPeeringConnectionRequesterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VpcPeeringConnectionRequesterArgs(VpcPeeringConnectionRequesterArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpcPeeringConnectionRequesterArgs();
        }

        public Builder(VpcPeeringConnectionRequesterArgs defaults) {
            $ = new VpcPeeringConnectionRequesterArgs(Objects.requireNonNull(defaults));
        }
