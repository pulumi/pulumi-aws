...
public final class ClusterDefaultCapacityProviderStrategyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterDefaultCapacityProviderStrategyArgs(ClusterDefaultCapacityProviderStrategyArgs $) {
        this.base = $.base;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterDefaultCapacityProviderStrategyArgs();
        }

        public Builder(ClusterDefaultCapacityProviderStrategyArgs defaults) {
            $ = new ClusterDefaultCapacityProviderStrategyArgs(Objects.requireNonNull(defaults));
        }
