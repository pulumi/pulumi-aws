...
public final class GetCostCategoryRuleRuleAndOrTag {
    ...
    public static Builder builder(GetCostCategoryRuleRuleAndOrTag defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(GetCostCategoryRuleRuleAndOrTag defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndOrTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder matchOptions(List<String> matchOptions) {
            if (matchOptions == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndOrTag", "matchOptions");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndOrTag", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetCostCategoryRuleRuleAndOrTag build() {
            final var _resultValue = new GetCostCategoryRuleRuleAndOrTag();
