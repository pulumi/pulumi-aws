...
@CustomType
public final class BudgetFilterExpressionOrOrCostCategories {
    /**
    ...
    private BudgetFilterExpressionOrOrCostCategories() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionOrOrCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionOrOrCostCategories defaults) {
        ...
        public BudgetFilterExpressionOrOrCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionOrOrCostCategories();
