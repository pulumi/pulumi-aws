...
public final class VpcOriginTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final VpcOriginTimeoutsArgs Empty = new VpcOriginTimeoutsArgs();
    ...
    private VpcOriginTimeoutsArgs(VpcOriginTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(VpcOriginTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpcOriginTimeoutsArgs();
        }

        public Builder(VpcOriginTimeoutsArgs defaults) {
            $ = new VpcOriginTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VpcOriginTimeoutsArgs build() {
            return $;
        }
    }
