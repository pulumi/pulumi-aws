...
@CustomType
public final class DaemonTimeouts {
    /**
    ...
    public static Builder builder(DaemonTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(DaemonTimeouts defaults) {
        ...
        public DaemonTimeouts build() {
            final var _resultValue = new DaemonTimeouts();
