...
@CustomType
public final class BudgetFilterExpressionOrOrTags {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionOrOrTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionOrOrTags defaults) {
        ...
        public BudgetFilterExpressionOrOrTags build() {
            final var _resultValue = new BudgetFilterExpressionOrOrTags();
