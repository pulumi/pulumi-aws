...
public final class GetDbSystemShapesDbSystemShape {
    /**
     * @return Maximum number of CPU cores that can be enabled for the shape.
     * 
     */
    private Integer availableCoreCount;
    /**
     * @return Maximum number of CPU cores per DB node that can be enabled for the shape.
     * 
     */
    private Integer availableCoreCountPerNode;
    /**
     * @return Maximum amount of data storage, in terabytes (TB), that can be enabled for the shape.
     * 
     */
    private Integer availableDataStorageInTbs;
    /**
     * @return Maximum amount of data storage, in terabytes (TB), that&#39;s available per storage server for the shape.
     * 
     */
    private Integer availableDataStoragePerServerInTbs;
    /**
     * @return Maximum amount of DB node storage, in gigabytes (GB), that&#39;s available per DB node for the shape.
     * 
     */
    private Integer availableDbNodePerNodeInGbs;
    /**
     * @return Maximum amount of DB node storage, in gigabytes (GB), that can be enabled for the shape.
     * 
     */
    private Integer availableDbNodeStorageInGbs;
    /**
     * @return Maximum amount of memory, in gigabytes (GB), that can be enabled for the shape.
     * 
     */
    private Integer availableMemoryInGbs;
    /**
     * @return Maximum amount of memory, in gigabytes (GB), that&#39;s available per DB node for the shape.
     * 
     */
    private Integer availableMemoryPerNodeInGbs;
    /**
     * @return Discrete number by which the CPU core count for the shape can be increased or decreased.
     * 
     */
    private Integer coreCountIncrement;
    /**
     * @return Maximum number of Exadata storage servers available for the shape.
     * 
     */
    private Integer maxStorageCount;
    /**
     * @return Maximum number of compute servers available for the shape.
     * 
     */
    private Integer maximumNodeCount;
    /**
     * @return Minimum number of CPU cores that can be enabled per node for the shape.
     * 
     */
    private Integer minCoreCountPerNode;
    /**
     * @return Minimum amount of data storage, in terabytes (TB), that must be allocated for the shape.
     * 
     */
    private Integer minDataStorageInTbs;
    /**
     * @return Minimum amount of DB node storage, in gigabytes (GB), that must be allocated per DB node for the shape.
     * 
     */
    private Integer minDbNodeStoragePerNodeInGbs;
    /**
     * @return Minimum amount of memory, in gigabytes (GB), that must be allocated per DB node for the shape.
     * 
     */
    private Integer minMemoryPerNodeInGbs;
    /**
     * @return Minimum number of Exadata storage servers available for the shape.
     * 
     */
    private Integer minStorageCount;
    /**
     * @return Minimum number of CPU cores that can be enabled for the shape.
     * 
     */
    private Integer minimumCoreCount;
    /**
     * @return Minimum number of compute servers available for the shape.
     * 
     */
    ...
    private String name;
    /**
     * @return Runtime minimum number of CPU cores that can be enabled for the shape.
     * 
     */
    private Integer runtimeMinimumCoreCount;
    /**
     * @return Family of the shape.
     * 
     */
    private String shapeFamily;
    /**
     * @return Shape type, determined by the CPU hardware.
     * 
     */
