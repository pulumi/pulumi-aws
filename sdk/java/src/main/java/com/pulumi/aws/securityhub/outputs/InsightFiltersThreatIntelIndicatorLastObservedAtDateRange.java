...
public final class InsightFiltersThreatIntelIndicatorLastObservedAtDateRange {
    ...
    public static final class Builder {
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("InsightFiltersThreatIntelIndicatorLastObservedAtDateRange", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder value(Integer value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersThreatIntelIndicatorLastObservedAtDateRange", "value");
            }
            this.value = value;
            return this;
        }
