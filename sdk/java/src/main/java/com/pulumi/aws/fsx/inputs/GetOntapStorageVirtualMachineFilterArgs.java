...
public final class GetOntapStorageVirtualMachineFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetOntapStorageVirtualMachineFilterArgs Empty = new GetOntapStorageVirtualMachineFilterArgs();
    ...
    private GetOntapStorageVirtualMachineFilterArgs(GetOntapStorageVirtualMachineFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetOntapStorageVirtualMachineFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOntapStorageVirtualMachineFilterArgs();
        }

        public Builder(GetOntapStorageVirtualMachineFilterArgs defaults) {
            $ = new GetOntapStorageVirtualMachineFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOntapStorageVirtualMachineFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetOntapStorageVirtualMachineFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetOntapStorageVirtualMachineFilterArgs", "values");
            }
            return $;
        }
    }
