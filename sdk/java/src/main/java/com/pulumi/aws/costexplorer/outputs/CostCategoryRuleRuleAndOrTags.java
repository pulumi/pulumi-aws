...
public final class CostCategoryRuleRuleAndOrTags {
    ...
    private CostCategoryRuleRuleAndOrTags() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleAndOrTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleAndOrTags defaults) {
        ...
        public CostCategoryRuleRuleAndOrTags build() {
            final var _resultValue = new CostCategoryRuleRuleAndOrTags();
