...
public final class V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs Empty = new V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs();
    ...
    private V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs() {}

    private V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs(V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs $) {
    ...
    public static Builder builder(V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs();
        }

        public Builder(V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs defaults) {
            $ = new V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentClosingSettingConditionalConditionalBranchNextStepDialogActionArgs", "type");
            }
            return $;
        }
    }
