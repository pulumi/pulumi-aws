...
@CustomType
public final class PermissionTimeouts {
    /**
    ...
    public static Builder builder(PermissionTimeouts defaults) {
    ...
    public static final class Builder {
        private @Nullable String delete;
        public Builder() {}
        public Builder(PermissionTimeouts defaults) {
        ...
        public PermissionTimeouts build() {
            final var _resultValue = new PermissionTimeouts();
