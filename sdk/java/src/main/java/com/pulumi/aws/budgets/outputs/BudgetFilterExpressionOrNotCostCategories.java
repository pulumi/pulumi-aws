...
@CustomType
public final class BudgetFilterExpressionOrNotCostCategories {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionOrNotCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionOrNotCostCategories defaults) {
        ...
        public BudgetFilterExpressionOrNotCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionOrNotCostCategories();
