...
import com.pulumi.aws.ec2.inputs.VpcEncryptionControlState;
import com.pulumi.aws.ec2.outputs.VpcEncryptionControlResourceExclusions;
import com.pulumi.aws.ec2.outputs.VpcEncryptionControlTimeouts;
...
public class VpcEncryptionControl extends com.pulumi.resources.CustomResource {
    ...
    @Export(name="timeouts", refs={VpcEncryptionControlTimeouts.class}, tree="[0]")
    private Output</* @Nullable */ VpcEncryptionControlTimeouts> timeouts;

    public Output<Optional<VpcEncryptionControlTimeouts>> timeouts() {
     ...
     */
    public VpcEncryptionControl(java.lang.String name) {
        this(name, VpcEncryptionControlArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public VpcEncryptionControl(java.lang.String name, VpcEncryptionControlArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VpcEncryptionControl(java.lang.String name, VpcEncryptionControlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpcEncryptionControl:VpcEncryptionControl", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VpcEncryptionControl(java.lang.String name, Output<java.lang.String> id, @Nullable VpcEncryptionControlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpcEncryptionControl:VpcEncryptionControl", name, state, makeResourceOptions(options, id), false);
    }

    private static VpcEncryptionControlArgs makeArgs(VpcEncryptionControlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VpcEncryptionControlArgs.Empty : args;
    }
    ...
    private static com.pulumi.resources.CustomResourceOptions makeResourceOptions(@Nullable com.pulumi.resources.CustomResourceOptions options, @Nullable Output<java.lang.String> id) {
        var defaultOptions = com.pulumi.resources.CustomResourceOptions.builder()
            ...
            .aliases(List.of(
                Output.of(Alias.builder().type("aws:ec2/encryptionControl:EncryptionControl").build())
            ))
            .build();
     ...
     */
    public static VpcEncryptionControl get(java.lang.String name, Output<java.lang.String> id, @Nullable VpcEncryptionControlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
