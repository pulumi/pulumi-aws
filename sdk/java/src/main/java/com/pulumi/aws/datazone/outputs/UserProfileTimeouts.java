...
@CustomType
public final class UserProfileTimeouts {
    /**
    ...
    public static Builder builder(UserProfileTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(UserProfileTimeouts defaults) {
        ...
        public UserProfileTimeouts build() {
            final var _resultValue = new UserProfileTimeouts();
