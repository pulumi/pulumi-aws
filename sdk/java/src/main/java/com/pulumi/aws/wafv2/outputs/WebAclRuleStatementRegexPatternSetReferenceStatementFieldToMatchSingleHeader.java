...
public final class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchSingleHeader {
    ...
    public static Builder builder(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchSingleHeader defaults) {
    ...
    public static final class Builder {
        private String name;
        public Builder() {}
        public Builder(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchSingleHeader defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchSingleHeader", "name");
            }
            this.name = name;
            return this;
        }
