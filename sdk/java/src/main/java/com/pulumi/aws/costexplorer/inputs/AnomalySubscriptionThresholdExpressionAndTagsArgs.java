...
public final class AnomalySubscriptionThresholdExpressionAndTagsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnomalySubscriptionThresholdExpressionAndTagsArgs Empty = new AnomalySubscriptionThresholdExpressionAndTagsArgs();
    ...
    private AnomalySubscriptionThresholdExpressionAndTagsArgs() {}

    private AnomalySubscriptionThresholdExpressionAndTagsArgs(AnomalySubscriptionThresholdExpressionAndTagsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionAndTagsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalySubscriptionThresholdExpressionAndTagsArgs();
        }

        public Builder(AnomalySubscriptionThresholdExpressionAndTagsArgs defaults) {
            $ = new AnomalySubscriptionThresholdExpressionAndTagsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnomalySubscriptionThresholdExpressionAndTagsArgs build() {
            return $;
        }
    }
