...
@CustomType
public final class PhpAppLayerLoadBasedAutoScalingUpscaling {
    ...
    private PhpAppLayerLoadBasedAutoScalingUpscaling() {}
    ...
    public static Builder builder(PhpAppLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(PhpAppLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public PhpAppLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new PhpAppLayerLoadBasedAutoScalingUpscaling();
