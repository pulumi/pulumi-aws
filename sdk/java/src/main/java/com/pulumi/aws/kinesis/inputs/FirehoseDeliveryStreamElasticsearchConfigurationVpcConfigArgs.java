...
public final class FirehoseDeliveryStreamElasticsearchConfigurationVpcConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public FirehoseDeliveryStreamElasticsearchConfigurationVpcConfigArgs build() {
            if ($.roleArn == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamElasticsearchConfigurationVpcConfigArgs", "roleArn");
            }
            if ($.securityGroupIds == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamElasticsearchConfigurationVpcConfigArgs", "securityGroupIds");
            }
            if ($.subnetIds == null) {
                throw new MissingRequiredPropertyException("FirehoseDeliveryStreamElasticsearchConfigurationVpcConfigArgs", "subnetIds");
            }
            return $;
        }
    }
