...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPatternAll;
...
public final class RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern {
    ...
    public static Builder builder(RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedPaths;
        public Builder() {}
        public Builder(RuleGroupRuleStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern defaults) {
