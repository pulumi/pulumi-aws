...
public final class WebAclRuleGroupAssociationVisibilityConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleGroupAssociationVisibilityConfigArgs Empty = new WebAclRuleGroupAssociationVisibilityConfigArgs();
    ...
    private WebAclRuleGroupAssociationVisibilityConfigArgs() {}

    private WebAclRuleGroupAssociationVisibilityConfigArgs(WebAclRuleGroupAssociationVisibilityConfigArgs $) {
    ...
    public static Builder builder(WebAclRuleGroupAssociationVisibilityConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleGroupAssociationVisibilityConfigArgs();
        }

        public Builder(WebAclRuleGroupAssociationVisibilityConfigArgs defaults) {
            $ = new WebAclRuleGroupAssociationVisibilityConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WebAclRuleGroupAssociationVisibilityConfigArgs build() {
            if ($.cloudwatchMetricsEnabled == null) {
                throw new MissingRequiredPropertyException("WebAclRuleGroupAssociationVisibilityConfigArgs", "cloudwatchMetricsEnabled");
            }
            if ($.metricName == null) {
                throw new MissingRequiredPropertyException("WebAclRuleGroupAssociationVisibilityConfigArgs", "metricName");
            }
            if ($.sampledRequestsEnabled == null) {
                throw new MissingRequiredPropertyException("WebAclRuleGroupAssociationVisibilityConfigArgs", "sampledRequestsEnabled");
            }
            return $;
        }
    }
