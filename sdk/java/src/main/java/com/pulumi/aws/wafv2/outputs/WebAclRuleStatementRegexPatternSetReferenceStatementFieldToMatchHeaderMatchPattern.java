...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPatternAll;
...
public final class WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPattern {
     ...
     * 
     */
    private @Nullable WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPatternAll all;
    /**
     ...
     * 
     */
    public Optional<WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPatternAll> all() {
    ...
    public static Builder builder(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPattern defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includedHeaders;
        public Builder() {}
        public Builder(WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPattern defaults) {
        ...
        @CustomType.Setter
        public Builder all(@Nullable WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPatternAll all) {
            this.all = all;
            return this;
        }
        @CustomType.Setter
        ...
        public WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPattern build() {
            final var _resultValue = new WebAclRuleStatementRegexPatternSetReferenceStatementFieldToMatchHeaderMatchPattern();
