...
public final class AnomalySubscriptionThresholdExpressionCostCategoryArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnomalySubscriptionThresholdExpressionCostCategoryArgs Empty = new AnomalySubscriptionThresholdExpressionCostCategoryArgs();
    ...
    private AnomalySubscriptionThresholdExpressionCostCategoryArgs() {}

    private AnomalySubscriptionThresholdExpressionCostCategoryArgs(AnomalySubscriptionThresholdExpressionCostCategoryArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionCostCategoryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalySubscriptionThresholdExpressionCostCategoryArgs();
        }

        public Builder(AnomalySubscriptionThresholdExpressionCostCategoryArgs defaults) {
            $ = new AnomalySubscriptionThresholdExpressionCostCategoryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnomalySubscriptionThresholdExpressionCostCategoryArgs build() {
            return $;
        }
    }
