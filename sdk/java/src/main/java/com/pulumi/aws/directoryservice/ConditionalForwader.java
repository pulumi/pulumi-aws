...
public class ConditionalForwader extends com.pulumi.resources.CustomResource {
     ...
     */
    public ConditionalForwader(java.lang.String name) {
     ...
     */
    public ConditionalForwader(java.lang.String name, ConditionalForwaderArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ConditionalForwader(java.lang.String name, ConditionalForwaderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:directoryservice/conditionalForwader:ConditionalForwader", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ConditionalForwader(java.lang.String name, Output<java.lang.String> id, @Nullable ConditionalForwaderState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:directoryservice/conditionalForwader:ConditionalForwader", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ConditionalForwader get(java.lang.String name, Output<java.lang.String> id, @Nullable ConditionalForwaderState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
