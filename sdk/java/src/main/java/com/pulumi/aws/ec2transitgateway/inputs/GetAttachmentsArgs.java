...
import com.pulumi.aws.ec2transitgateway.inputs.GetAttachmentsFilterArgs;
...
public final class GetAttachmentsArgs extends com.pulumi.resources.InvokeArgs {
     ...
     */
    @Import(name="filters")
    private @Nullable Output<List<GetAttachmentsFilterArgs>> filters;

    /**
     * @return One or more configuration blocks containing name-values filters. Detailed below.
     * 
     */
    public Optional<Output<List<GetAttachmentsFilterArgs>>> filters() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder filters(@Nullable Output<List<GetAttachmentsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }
         ...
         * 
         */
        public Builder filters(List<GetAttachmentsFilterArgs> filters) {
