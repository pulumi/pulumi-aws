...
public final class LaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private LaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs() {}

    private LaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs(LaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs $) {
        this.max = $.max;
        this.min = $.min;
    }
    ...
    public static Builder builder(LaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs();
        }

        public Builder(LaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs defaults) {
        ...
        public LaunchTemplateInstanceRequirementsTotalLocalStorageGbArgs build() {
            return $;
        }
    }
