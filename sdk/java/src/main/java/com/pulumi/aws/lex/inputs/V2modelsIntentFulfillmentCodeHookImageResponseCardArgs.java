...
public final class V2modelsIntentFulfillmentCodeHookImageResponseCardArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentFulfillmentCodeHookImageResponseCardArgs Empty = new V2modelsIntentFulfillmentCodeHookImageResponseCardArgs();
    ...
    private V2modelsIntentFulfillmentCodeHookImageResponseCardArgs(V2modelsIntentFulfillmentCodeHookImageResponseCardArgs $) {
    ...
    public static Builder builder(V2modelsIntentFulfillmentCodeHookImageResponseCardArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(V2modelsIntentFulfillmentCodeHookImageResponseCardArgs defaults) {
            $ = new V2modelsIntentFulfillmentCodeHookImageResponseCardArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentFulfillmentCodeHookImageResponseCardArgs build() {
            if ($.title == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentFulfillmentCodeHookImageResponseCardArgs", "title");
            }
            return $;
        }
    }
