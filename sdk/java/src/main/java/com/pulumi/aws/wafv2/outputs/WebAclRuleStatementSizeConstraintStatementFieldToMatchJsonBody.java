...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern;
...
public final class WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody {
     ...
     * 
     */
    private @Nullable WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
    ...
    private WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody() {}
    /**
     * @return How to handle requests with invalid JSON body. Valid values: `EVALUATE_AS_STRING`, `MATCH`, `NO_MATCH`.
     * 
     */
     ...
     * 
     */
    public Optional<WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern> matchPattern() {
    ...
    public static Builder builder(WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(@Nullable WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementSizeConstraintStatementFieldToMatchJsonBody", "matchScope");
            }
