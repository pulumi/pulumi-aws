...
public final class CostCategoryRuleRuleAndNotCostCategory {
    ...
    public static Builder builder(CostCategoryRuleRuleAndNotCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleAndNotCostCategory defaults) {
        ...
        public CostCategoryRuleRuleAndNotCostCategory build() {
            final var _resultValue = new CostCategoryRuleRuleAndNotCostCategory();
