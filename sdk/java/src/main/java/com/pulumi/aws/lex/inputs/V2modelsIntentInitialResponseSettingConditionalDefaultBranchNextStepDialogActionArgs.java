...
public final class V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs Empty = new V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs();
    ...
    private V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs() {}

    private V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs(V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs $) {
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs();
        }

        public Builder(V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs defaults) {
            $ = new V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogActionArgs", "type");
            }
            return $;
        }
    }
