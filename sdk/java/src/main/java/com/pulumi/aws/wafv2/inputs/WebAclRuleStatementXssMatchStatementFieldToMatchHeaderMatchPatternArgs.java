...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternAllArgs;
...
public final class WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs Empty = new WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs();
     ...
     */
    @Import(name="all")
    private @Nullable Output<WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternAllArgs> all;

    /**
     * @return An empty configuration block that is used for inspecting all headers.
     * 
     */
    public Optional<Output<WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternAllArgs>> all() {
    ...
    private WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs() {}

    private WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs(WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs $) {
        this.all = $.all;
    ...
    public static Builder builder(WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs();
        }

        public Builder(WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs defaults) {
            $ = new WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder all(@Nullable Output<WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternAllArgs> all) {
            $.all = all;
            return this;
        }
         ...
         * 
         */
        public Builder all(WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternAllArgs all) {
        ...
        public WebAclRuleStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs build() {
            return $;
        }
    }
