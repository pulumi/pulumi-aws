...
@CustomType
public final class RailsAppLayerLoadBasedAutoScalingUpscaling {
    ...
    private RailsAppLayerLoadBasedAutoScalingUpscaling() {}
    ...
    public static Builder builder(RailsAppLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(RailsAppLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public RailsAppLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new RailsAppLayerLoadBasedAutoScalingUpscaling();
