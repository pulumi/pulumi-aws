...
import com.pulumi.aws.wafv2.outputs.WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern;
...
@CustomType
public final class WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBody {
    /**
     ...
     * 
     */
    private @Nullable WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
    ...
    private WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBody() {}
    /**
     * @return How to handle requests with invalid JSON body. Valid values: `EVALUATE_AS_STRING`, `MATCH`, `NO_MATCH`.
     * 
     */
     ...
     * 
     */
    public Optional<WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern() {
    ...
    public static Builder builder(WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(@Nullable WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
        ...
        public Builder matchScope(String matchScope) {
            if (matchScope == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBody", "matchScope");
            }
        ...
        public WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBody build() {
            final var _resultValue = new WebAclRuleStatementNotStatementStatementSqliMatchStatementFieldToMatchJsonBody();
