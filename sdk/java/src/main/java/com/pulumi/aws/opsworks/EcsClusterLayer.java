...
public class EcsClusterLayer extends com.pulumi.resources.CustomResource {
     ...
     */
    public EcsClusterLayer(String name, @Nullable EcsClusterLayerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EcsClusterLayer(String name, @Nullable EcsClusterLayerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
