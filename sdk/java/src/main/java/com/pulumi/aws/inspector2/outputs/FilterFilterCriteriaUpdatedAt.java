...
@CustomType
public final class FilterFilterCriteriaUpdatedAt {
    /**
    ...
    public static Builder builder(FilterFilterCriteriaUpdatedAt defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String startInclusive;
        public Builder() {}
        public Builder(FilterFilterCriteriaUpdatedAt defaults) {
        ...
        public FilterFilterCriteriaUpdatedAt build() {
            final var _resultValue = new FilterFilterCriteriaUpdatedAt();
