...
public final class V2modelsIntentInitialResponseSettingValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentInitialResponseSettingValueArgs Empty = new V2modelsIntentInitialResponseSettingValueArgs();
    ...
    private V2modelsIntentInitialResponseSettingValueArgs() {}

    private V2modelsIntentInitialResponseSettingValueArgs(V2modelsIntentInitialResponseSettingValueArgs $) {
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentInitialResponseSettingValueArgs();
        }

        public Builder(V2modelsIntentInitialResponseSettingValueArgs defaults) {
            $ = new V2modelsIntentInitialResponseSettingValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentInitialResponseSettingValueArgs build() {
            return $;
        }
    }
