...
@CustomType
public final class GetCostCategoryRuleRuleAndDimension {
    /**
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndDimension", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder matchOptions(List<String> matchOptions) {
            if (matchOptions == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndDimension", "matchOptions");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleAndDimension", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetCostCategoryRuleRuleAndDimension build() {
            final var _resultValue = new GetCostCategoryRuleRuleAndDimension();
