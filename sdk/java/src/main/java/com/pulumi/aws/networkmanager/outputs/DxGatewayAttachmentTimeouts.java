...
public final class DxGatewayAttachmentTimeouts {
    ...
    public static Builder builder(DxGatewayAttachmentTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(DxGatewayAttachmentTimeouts defaults) {
        ...
        public DxGatewayAttachmentTimeouts build() {
            final var _resultValue = new DxGatewayAttachmentTimeouts();
