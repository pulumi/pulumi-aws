...
@CustomType
public final class LocalGatewayRouteTableTimeouts {
    /**
    ...
    public static Builder builder(LocalGatewayRouteTableTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(LocalGatewayRouteTableTimeouts defaults) {
        ...
        public LocalGatewayRouteTableTimeouts build() {
            final var _resultValue = new LocalGatewayRouteTableTimeouts();
