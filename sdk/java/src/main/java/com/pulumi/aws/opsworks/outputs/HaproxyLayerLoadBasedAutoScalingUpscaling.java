...
public final class HaproxyLayerLoadBasedAutoScalingUpscaling {
    ...
    private HaproxyLayerLoadBasedAutoScalingUpscaling() {}
    ...
    public static Builder builder(HaproxyLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(HaproxyLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public HaproxyLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new HaproxyLayerLoadBasedAutoScalingUpscaling();
