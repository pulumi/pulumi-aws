...
import com.pulumi.aws.ec2.inputs.LocalGatewayRouteTableVirtualInterfaceGroupAssociationState;
 ...
 * 
 */
@ResourceType(type="aws:ec2/localGatewayRouteTableVirtualInterfaceGroupAssociation:LocalGatewayRouteTableVirtualInterfaceGroupAssociation")
public class LocalGatewayRouteTableVirtualInterfaceGroupAssociation extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public LocalGatewayRouteTableVirtualInterfaceGroupAssociation(java.lang.String name) {
        this(name, LocalGatewayRouteTableVirtualInterfaceGroupAssociationArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LocalGatewayRouteTableVirtualInterfaceGroupAssociation(java.lang.String name, LocalGatewayRouteTableVirtualInterfaceGroupAssociationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LocalGatewayRouteTableVirtualInterfaceGroupAssociation(java.lang.String name, LocalGatewayRouteTableVirtualInterfaceGroupAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/localGatewayRouteTableVirtualInterfaceGroupAssociation:LocalGatewayRouteTableVirtualInterfaceGroupAssociation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LocalGatewayRouteTableVirtualInterfaceGroupAssociation(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGatewayRouteTableVirtualInterfaceGroupAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/localGatewayRouteTableVirtualInterfaceGroupAssociation:LocalGatewayRouteTableVirtualInterfaceGroupAssociation", name, state, makeResourceOptions(options, id), false);
    }

    private static LocalGatewayRouteTableVirtualInterfaceGroupAssociationArgs makeArgs(LocalGatewayRouteTableVirtualInterfaceGroupAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LocalGatewayRouteTableVirtualInterfaceGroupAssociationArgs.Empty : args;
    }
     ...
     */
    public static LocalGatewayRouteTableVirtualInterfaceGroupAssociation get(java.lang.String name, Output<java.lang.String> id, @Nullable LocalGatewayRouteTableVirtualInterfaceGroupAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
