...
public final class CatalogTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final CatalogTimeoutsArgs Empty = new CatalogTimeoutsArgs();
    ...
    private CatalogTimeoutsArgs() {}

    private CatalogTimeoutsArgs(CatalogTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(CatalogTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CatalogTimeoutsArgs();
        }

        public Builder(CatalogTimeoutsArgs defaults) {
            $ = new CatalogTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CatalogTimeoutsArgs build() {
            return $;
        }
    }
