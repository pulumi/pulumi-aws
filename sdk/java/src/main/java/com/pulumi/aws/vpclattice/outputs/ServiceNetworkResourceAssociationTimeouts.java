...
public final class ServiceNetworkResourceAssociationTimeouts {
    ...
    public static Builder builder(ServiceNetworkResourceAssociationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(ServiceNetworkResourceAssociationTimeouts defaults) {
        ...
        public ServiceNetworkResourceAssociationTimeouts build() {
            final var _resultValue = new ServiceNetworkResourceAssociationTimeouts();
