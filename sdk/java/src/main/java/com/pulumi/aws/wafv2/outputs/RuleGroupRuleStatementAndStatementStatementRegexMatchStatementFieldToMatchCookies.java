...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchCookiesMatchPattern;
...
public final class RuleGroupRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchCookies {
    ...
    public static Builder builder(RuleGroupRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchCookies defaults) {
    ...
    public static final class Builder {
        ...
        private String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchCookies defaults) {
        ...
        @CustomType.Setter
        public Builder matchPatterns(List<RuleGroupRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns) {
            this.matchPatterns = Objects.requireNonNull(matchPatterns);
            return this;
        }
        public Builder matchPatterns(RuleGroupRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchCookiesMatchPattern... matchPatterns) {
        ...
        public RuleGroupRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchCookies build() {
            final var o = new RuleGroupRuleStatementAndStatementStatementRegexMatchStatementFieldToMatchCookies();
