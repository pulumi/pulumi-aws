...
public class KeyPair extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ String> encryptedFingerprint;

    /**
     * @return The MD5 public key fingerprint for the encrypted private key.
     * 
     */
    public Output<Optional<String>> encryptedFingerprint() {
        return Codegen.optional(this.encryptedFingerprint);
    }
    /**
    ...
    private Output</* @Nullable */ String> encryptedPrivateKey;
     ...
     * 
     */
    public Output<Optional<String>> encryptedPrivateKey() {
        return Codegen.optional(this.encryptedPrivateKey);
    }
    /**
