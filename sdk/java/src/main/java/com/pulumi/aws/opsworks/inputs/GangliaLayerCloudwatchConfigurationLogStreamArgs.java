...
public final class GangliaLayerCloudwatchConfigurationLogStreamArgs extends com.pulumi.resources.ResourceArgs {

    public static final GangliaLayerCloudwatchConfigurationLogStreamArgs Empty = new GangliaLayerCloudwatchConfigurationLogStreamArgs();
    ...
    private GangliaLayerCloudwatchConfigurationLogStreamArgs() {}

    private GangliaLayerCloudwatchConfigurationLogStreamArgs(GangliaLayerCloudwatchConfigurationLogStreamArgs $) {
    ...
    public static Builder builder(GangliaLayerCloudwatchConfigurationLogStreamArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GangliaLayerCloudwatchConfigurationLogStreamArgs();
        }

        public Builder(GangliaLayerCloudwatchConfigurationLogStreamArgs defaults) {
            $ = new GangliaLayerCloudwatchConfigurationLogStreamArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GangliaLayerCloudwatchConfigurationLogStreamArgs build() {
            if ($.file == null) {
                throw new MissingRequiredPropertyException("GangliaLayerCloudwatchConfigurationLogStreamArgs", "file");
            }
            if ($.logGroupName == null) {
                throw new MissingRequiredPropertyException("GangliaLayerCloudwatchConfigurationLogStreamArgs", "logGroupName");
            }
            return $;
        }
    }
