...
public final class V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStepIntentArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="slots")
    private @Nullable Output<List<V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStepIntentSlotArgs>> slots;
     ...
     * 
     */
    public Optional<Output<List<V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStepIntentSlotArgs>>> slots() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder slots(@Nullable Output<List<V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStepIntentSlotArgs>> slots) {
            $.slots = slots;
            return this;
        }
         ...
         * 
         */
        public Builder slots(List<V2modelsIntentConfirmationSettingFailureConditionalConditionalBranchNextStepIntentSlotArgs> slots) {
