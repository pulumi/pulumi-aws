...
public final class VpcOriginTimeouts {
    ...
    public static Builder builder(VpcOriginTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(VpcOriginTimeouts defaults) {
        ...
        public VpcOriginTimeouts build() {
            final var _resultValue = new VpcOriginTimeouts();
