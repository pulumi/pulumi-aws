...
public final class AnycastIpListTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnycastIpListTimeoutsArgs Empty = new AnycastIpListTimeoutsArgs();
    ...
    private AnycastIpListTimeoutsArgs() {}

    private AnycastIpListTimeoutsArgs(AnycastIpListTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(AnycastIpListTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnycastIpListTimeoutsArgs();
        }

        public Builder(AnycastIpListTimeoutsArgs defaults) {
            $ = new AnycastIpListTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnycastIpListTimeoutsArgs build() {
            return $;
        }
    }
