...
@CustomType
public final class AccessApplicationTimeouts {
    /**
    ...
    public static Builder builder(AccessApplicationTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(AccessApplicationTimeouts defaults) {
        ...
        public AccessApplicationTimeouts build() {
            final var _resultValue = new AccessApplicationTimeouts();
