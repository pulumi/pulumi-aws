...
public final class InsightFiltersResourceContainerLaunchedAtDateRange {
    ...
    public static final class Builder {
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceContainerLaunchedAtDateRange", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder value(Integer value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersResourceContainerLaunchedAtDateRange", "value");
            }
            this.value = value;
            return this;
        }
        public InsightFiltersResourceContainerLaunchedAtDateRange build() {
            final var _resultValue = new InsightFiltersResourceContainerLaunchedAtDateRange();
