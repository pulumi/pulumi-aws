    ...
    public static final class Builder {
        ...
        public DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImageArgs build() {
            if ($.appImageConfigName == null) {
                throw new MissingRequiredPropertyException("DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImageArgs", "appImageConfigName");
            }
            if ($.imageName == null) {
                throw new MissingRequiredPropertyException("DomainDefaultUserSettingsKernelGatewayAppSettingsCustomImageArgs", "imageName");
            }
            return $;
        }
    }
