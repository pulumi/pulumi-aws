...
public final class CostCategoryRuleRuleNotAndTags {
    ...
    public static Builder builder(CostCategoryRuleRuleNotAndTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleNotAndTags defaults) {
        ...
        public CostCategoryRuleRuleNotAndTags build() {
            final var _resultValue = new CostCategoryRuleRuleNotAndTags();
