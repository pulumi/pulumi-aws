...
public final class InsightFiltersNetworkDestinationDomainArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private InsightFiltersNetworkDestinationDomainArgs(InsightFiltersNetworkDestinationDomainArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InsightFiltersNetworkDestinationDomainArgs();
        }

        public Builder(InsightFiltersNetworkDestinationDomainArgs defaults) {
            $ = new InsightFiltersNetworkDestinationDomainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InsightFiltersNetworkDestinationDomainArgs build() {
            if ($.comparison == null) {
                throw new MissingRequiredPropertyException("InsightFiltersNetworkDestinationDomainArgs", "comparison");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("InsightFiltersNetworkDestinationDomainArgs", "value");
            }
            return $;
        }
    }
