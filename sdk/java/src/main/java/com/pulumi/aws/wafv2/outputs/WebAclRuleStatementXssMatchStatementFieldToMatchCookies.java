...
public final class WebAclRuleStatementXssMatchStatementFieldToMatchCookies {
    private List<WebAclRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder matchPatterns(List<WebAclRuleStatementXssMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns) {
        ...
        public WebAclRuleStatementXssMatchStatementFieldToMatchCookies build() {
            final var o = new WebAclRuleStatementXssMatchStatementFieldToMatchCookies();
