...
public final class EventArchiveState extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return Identifier of the AWS KMS customer managed key for EventBridge to use, if you choose to use a customer managed key to encrypt this archive. The identifier can be the key ARN, KeyId, key alias, or key alias ARN.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param kmsKeyIdentifier Identifier of the AWS KMS customer managed key for EventBridge to use, if you choose to use a customer managed key to encrypt this archive. The identifier can be the key ARN, KeyId, key alias, or key alias ARN.
         * 
         * @return builder
         * 
         */
