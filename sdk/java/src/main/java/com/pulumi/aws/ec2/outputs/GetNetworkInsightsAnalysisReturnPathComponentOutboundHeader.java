...
public final class GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader {
    ...
    private @Nullable List<GetNetworkInsightsAnalysisReturnPathComponentOutboundHeaderDestinationPortRange> destinationPortRanges;
    private @Nullable String protocol;
    private @Nullable List<String> sourceAddresses;
    private @Nullable List<GetNetworkInsightsAnalysisReturnPathComponentOutboundHeaderSourcePortRange> sourcePortRanges;
    ...
    public static Builder builder(GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<GetNetworkInsightsAnalysisReturnPathComponentOutboundHeaderSourcePortRange> sourcePortRanges;
        public Builder() {}
        public Builder(GetNetworkInsightsAnalysisReturnPathComponentOutboundHeader defaults) {
        ...
        @CustomType.Setter
        public Builder destinationPortRanges(@Nullable List<GetNetworkInsightsAnalysisReturnPathComponentOutboundHeaderDestinationPortRange> destinationPortRanges) {
        ...
        @CustomType.Setter
        public Builder sourcePortRanges(@Nullable List<GetNetworkInsightsAnalysisReturnPathComponentOutboundHeaderSourcePortRange> sourcePortRanges) {
