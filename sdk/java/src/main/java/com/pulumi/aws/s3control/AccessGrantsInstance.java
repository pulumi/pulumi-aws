...
public class AccessGrantsInstance extends com.pulumi.resources.CustomResource {
     ...
     */
    public AccessGrantsInstance(String name) {
     ...
     */
    public AccessGrantsInstance(String name, @Nullable AccessGrantsInstanceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static AccessGrantsInstance get(String name, Output<String> id, @Nullable AccessGrantsInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
