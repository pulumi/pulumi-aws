...
public final class CostCategoryRuleRuleAndCostCategory {
    ...
    private CostCategoryRuleRuleAndCostCategory(
    ...
    public static Builder builder(CostCategoryRuleRuleAndCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CostCategoryRuleRuleAndCostCategory defaults) {
        ...
        }        public CostCategoryRuleRuleAndCostCategory build() {
            return new CostCategoryRuleRuleAndCostCategory(key, matchOptions, values);
        }
    }
}
