...
public final class VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustSdsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustSdsArgs(VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustSdsArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustSdsArgs();
        }

        public Builder(VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustSdsArgs defaults) {
            $ = new VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustSdsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustSdsArgs build() {
            if ($.secretName == null) {
                throw new MissingRequiredPropertyException("VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustSdsArgs", "secretName");
            }
            return $;
        }
    }
