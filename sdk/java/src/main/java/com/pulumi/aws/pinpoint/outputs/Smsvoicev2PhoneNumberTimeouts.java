...
public final class Smsvoicev2PhoneNumberTimeouts {
    ...
    public static Builder builder(Smsvoicev2PhoneNumberTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(Smsvoicev2PhoneNumberTimeouts defaults) {
        ...
        public Smsvoicev2PhoneNumberTimeouts build() {
            final var _resultValue = new Smsvoicev2PhoneNumberTimeouts();
