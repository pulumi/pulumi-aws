...
@CustomType
public final class V2modelsSlotValueElicitationSettingImageResponseCard {
    private @Nullable List<V2modelsSlotValueElicitationSettingButton> buttons;
    private @Nullable String imageUrl;
    private @Nullable String subtitle;
    private String title;

    private V2modelsSlotValueElicitationSettingImageResponseCard() {}
    ...
    public static Builder builder(V2modelsSlotValueElicitationSettingImageResponseCard defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(V2modelsSlotValueElicitationSettingImageResponseCard defaults) {
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("V2modelsSlotValueElicitationSettingImageResponseCard", "title");
            }
            this.title = title;
            return this;
        }
        public V2modelsSlotValueElicitationSettingImageResponseCard build() {
            final var _resultValue = new V2modelsSlotValueElicitationSettingImageResponseCard();
