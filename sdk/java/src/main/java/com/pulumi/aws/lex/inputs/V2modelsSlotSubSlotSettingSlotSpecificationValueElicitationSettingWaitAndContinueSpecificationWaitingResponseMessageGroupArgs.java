...
public final class V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationWaitingResponseMessageGroupArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="message")
    private @Nullable Output<V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationWaitingResponseMessageGroupMessageArgs> message;
     ...
     * 
     */
    public Optional<Output<V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationWaitingResponseMessageGroupMessageArgs>> message() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder message(@Nullable Output<V2modelsSlotSubSlotSettingSlotSpecificationValueElicitationSettingWaitAndContinueSpecificationWaitingResponseMessageGroupMessageArgs> message) {
            $.message = message;
            return this;
        }
