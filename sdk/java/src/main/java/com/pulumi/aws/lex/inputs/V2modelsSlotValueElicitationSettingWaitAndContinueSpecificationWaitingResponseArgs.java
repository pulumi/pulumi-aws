...
import com.pulumi.aws.lex.inputs.V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationWaitingResponseMessageGroupArgs;
...
public final class V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationWaitingResponseArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationWaitingResponseArgs() {}

    private V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationWaitingResponseArgs(V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationWaitingResponseArgs $) {
    ...
    public static Builder builder(V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationWaitingResponseArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationWaitingResponseArgs();
        }

        public Builder(V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationWaitingResponseArgs defaults) {
        ...
        public V2modelsSlotValueElicitationSettingWaitAndContinueSpecificationWaitingResponseArgs build() {
            return $;
        }
    }
