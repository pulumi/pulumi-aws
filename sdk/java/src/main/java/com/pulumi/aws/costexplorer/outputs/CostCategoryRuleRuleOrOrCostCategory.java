...
public final class CostCategoryRuleRuleOrOrCostCategory {
    ...
    private CostCategoryRuleRuleOrOrCostCategory() {}
    /**
     * @return Unique name of the Cost Category.
     * 
     */
    ...
    public static Builder builder(CostCategoryRuleRuleOrOrCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleOrOrCostCategory defaults) {
        ...
        public CostCategoryRuleRuleOrOrCostCategory build() {
            final var _resultValue = new CostCategoryRuleRuleOrOrCostCategory();
