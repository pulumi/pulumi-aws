...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs Empty = new WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs();
    ...
    private Output<WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs() {}

    private WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs(WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs();
        }

        public Builder(WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs defaults) {
            $ = new WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public WebAclRuleStatementOrStatementStatementXssMatchStatementFieldToMatchHeaderArgs build() {
