...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig;
...
public final class RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatement {
    ...
    private RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatement(
        ...
        @CustomType.Parameter("ipSetForwardedIpConfig") @Nullable RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig ipSetForwardedIpConfig) {
        this.arn = arn;
     ...
     * 
     */
    public Optional<RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig> ipSetForwardedIpConfig() {
    ...
    public static final class Builder {
        ...
        public Builder ipSetForwardedIpConfig(@Nullable RuleGroupRuleStatementNotStatementStatementIpSetReferenceStatementIpSetForwardedIpConfig ipSetForwardedIpConfig) {
            this.ipSetForwardedIpConfig = ipSetForwardedIpConfig;
            return this;
