    ...
    public static final class Builder {
        ...
        public Builder healthyThreshold(Integer healthyThreshold) {
            if (healthyThreshold == null) {
              throw new MissingRequiredPropertyException("VirtualGatewaySpecListenerHealthCheck", "healthyThreshold");
            }
        ...
        public Builder intervalMillis(Integer intervalMillis) {
            if (intervalMillis == null) {
              throw new MissingRequiredPropertyException("VirtualGatewaySpecListenerHealthCheck", "intervalMillis");
            }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("VirtualGatewaySpecListenerHealthCheck", "protocol");
            }
        ...
        public Builder timeoutMillis(Integer timeoutMillis) {
            if (timeoutMillis == null) {
              throw new MissingRequiredPropertyException("VirtualGatewaySpecListenerHealthCheck", "timeoutMillis");
            }
        ...
        public Builder unhealthyThreshold(Integer unhealthyThreshold) {
            if (unhealthyThreshold == null) {
              throw new MissingRequiredPropertyException("VirtualGatewaySpecListenerHealthCheck", "unhealthyThreshold");
            }
            this.unhealthyThreshold = unhealthyThreshold;
            return this;
        }
        public VirtualGatewaySpecListenerHealthCheck build() {
            final var _resultValue = new VirtualGatewaySpecListenerHealthCheck();
