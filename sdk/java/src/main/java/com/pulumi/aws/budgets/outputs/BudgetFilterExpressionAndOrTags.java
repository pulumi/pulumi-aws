...
public final class BudgetFilterExpressionAndOrTags {
    ...
    public static Builder builder(BudgetFilterExpressionAndOrTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionAndOrTags defaults) {
        ...
        public BudgetFilterExpressionAndOrTags build() {
            final var _resultValue = new BudgetFilterExpressionAndOrTags();
