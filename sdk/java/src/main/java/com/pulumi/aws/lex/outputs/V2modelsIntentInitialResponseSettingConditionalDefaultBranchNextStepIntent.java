...
public final class V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepIntent {
     ...
     * 
     */
    private @Nullable List<V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepIntentSlot> slots;
     ...
     * 
     */
    public List<V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepIntentSlot> slots() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder slots(@Nullable List<V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepIntentSlot> slots) {
