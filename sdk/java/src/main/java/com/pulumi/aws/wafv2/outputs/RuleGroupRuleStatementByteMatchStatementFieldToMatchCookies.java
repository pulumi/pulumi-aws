...
public final class RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies {
     ...
     * 
     */
    private List<RuleGroupRuleStatementByteMatchStatementFieldToMatchCookiesMatchPattern> matchPatterns;
    /**
    ...
    private RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies() {}
    /**
     * @return The filter to use to identify the subset of cookies to inspect in a web request. You must specify exactly one setting: either `all`, `included_cookies` or `excluded_cookies`. More details: [CookieMatchPattern](https://docs.aws.amazon.com/waf/latest/APIReference/API_CookieMatchPattern.html)
     * 
     */
    ...
    public static Builder builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies defaults) {
    ...
    public static final class Builder {
        ...
        private String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies defaults) {
        ...
        public RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies build() {
            final var _resultValue = new RuleGroupRuleStatementByteMatchStatementFieldToMatchCookies();
