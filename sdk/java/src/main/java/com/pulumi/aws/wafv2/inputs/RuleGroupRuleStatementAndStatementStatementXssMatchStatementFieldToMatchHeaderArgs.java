...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs Empty = new RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs();
    ...
    private Output<RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs() {}

    private RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs(RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs();
        }

        public Builder(RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs defaults) {
            $ = new RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public RuleGroupRuleStatementAndStatementStatementXssMatchStatementFieldToMatchHeaderArgs build() {
