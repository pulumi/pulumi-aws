...
@CustomType
public final class GraphGraphTimeouts {
    /**
    ...
    public static Builder builder(GraphGraphTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(GraphGraphTimeouts defaults) {
        ...
        public GraphGraphTimeouts build() {
            final var _resultValue = new GraphGraphTimeouts();
