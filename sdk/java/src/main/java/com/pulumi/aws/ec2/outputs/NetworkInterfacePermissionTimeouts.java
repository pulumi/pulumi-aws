...
public final class NetworkInterfacePermissionTimeouts {
    ...
    public static Builder builder(NetworkInterfacePermissionTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(NetworkInterfacePermissionTimeouts defaults) {
        ...
        public NetworkInterfacePermissionTimeouts build() {
            final var _resultValue = new NetworkInterfacePermissionTimeouts();
