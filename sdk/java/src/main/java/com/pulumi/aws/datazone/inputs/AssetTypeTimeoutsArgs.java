...
public final class AssetTypeTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AssetTypeTimeoutsArgs Empty = new AssetTypeTimeoutsArgs();
    ...
    private AssetTypeTimeoutsArgs(AssetTypeTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(AssetTypeTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AssetTypeTimeoutsArgs();
        }

        public Builder(AssetTypeTimeoutsArgs defaults) {
            $ = new AssetTypeTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AssetTypeTimeoutsArgs build() {
            return $;
        }
    }
