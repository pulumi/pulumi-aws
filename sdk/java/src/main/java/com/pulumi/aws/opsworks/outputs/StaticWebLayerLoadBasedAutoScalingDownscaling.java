...
public final class StaticWebLayerLoadBasedAutoScalingDownscaling {
    ...
    private StaticWebLayerLoadBasedAutoScalingDownscaling() {}
    ...
    public static Builder builder(StaticWebLayerLoadBasedAutoScalingDownscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(StaticWebLayerLoadBasedAutoScalingDownscaling defaults) {
        ...
        public StaticWebLayerLoadBasedAutoScalingDownscaling build() {
            final var _resultValue = new StaticWebLayerLoadBasedAutoScalingDownscaling();
