...
public class SmsChannel extends com.pulumi.resources.CustomResource {
     ...
     */
    public SmsChannel(java.lang.String name) {
     ...
     */
    public SmsChannel(java.lang.String name, SmsChannelArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SmsChannel(java.lang.String name, SmsChannelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:pinpoint/smsChannel:SmsChannel", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SmsChannel(java.lang.String name, Output<java.lang.String> id, @Nullable SmsChannelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:pinpoint/smsChannel:SmsChannel", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SmsChannel get(java.lang.String name, Output<java.lang.String> id, @Nullable SmsChannelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
