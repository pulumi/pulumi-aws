...
public final class GetCostCategoryRuleRuleNotNotCostCategory {
    ...
    private GetCostCategoryRuleRuleNotNotCostCategory() {}
    /**
     * @return Key for the tag.
     * 
     */
    ...
    public static Builder builder(GetCostCategoryRuleRuleNotNotCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> values;
        public Builder() {}
        public Builder(GetCostCategoryRuleRuleNotNotCostCategory defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleNotNotCostCategory", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder matchOptions(List<String> matchOptions) {
            if (matchOptions == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleNotNotCostCategory", "matchOptions");
            }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetCostCategoryRuleRuleNotNotCostCategory", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetCostCategoryRuleRuleNotNotCostCategory build() {
            final var _resultValue = new GetCostCategoryRuleRuleNotNotCostCategory();
