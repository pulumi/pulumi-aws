...
public final class GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementNetworkInterfaceCount {
    ...
    public static final class Builder {
        ...
        public Builder max(Integer max) {
            if (max == null) {
              throw new MissingRequiredPropertyException("GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementNetworkInterfaceCount", "max");
            }
            this.max = max;
            return this;
        }
        ...
        public Builder min(Integer min) {
            if (min == null) {
              throw new MissingRequiredPropertyException("GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementNetworkInterfaceCount", "min");
            }
            this.min = min;
            return this;
        }
