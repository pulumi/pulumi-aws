...
public final class GlossaryTermTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final GlossaryTermTimeoutsArgs Empty = new GlossaryTermTimeoutsArgs();
    ...
    private GlossaryTermTimeoutsArgs() {}

    private GlossaryTermTimeoutsArgs(GlossaryTermTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(GlossaryTermTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GlossaryTermTimeoutsArgs();
        }

        public Builder(GlossaryTermTimeoutsArgs defaults) {
            $ = new GlossaryTermTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GlossaryTermTimeoutsArgs build() {
            return $;
        }
    }
