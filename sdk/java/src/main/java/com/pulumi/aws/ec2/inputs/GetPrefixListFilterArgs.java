...
public final class GetPrefixListFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPrefixListFilterArgs Empty = new GetPrefixListFilterArgs();
    ...
    private GetPrefixListFilterArgs() {}

    private GetPrefixListFilterArgs(GetPrefixListFilterArgs $) {
        this.name = $.name;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetPrefixListFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPrefixListFilterArgs();
        }

        public Builder(GetPrefixListFilterArgs defaults) {
            $ = new GetPrefixListFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPrefixListFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPrefixListFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetPrefixListFilterArgs", "values");
            }
            return $;
        }
    }
