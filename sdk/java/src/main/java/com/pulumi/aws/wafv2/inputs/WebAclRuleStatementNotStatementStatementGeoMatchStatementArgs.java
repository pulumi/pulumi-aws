...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfigArgs;
...
public final class WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfigArgs>> forwardedIpConfig() {
        return Optional.ofNullable(this.forwardedIpConfig);
    }

    private WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs() {}

    private WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs(WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs();
        }

        public Builder(WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs defaults) {
            $ = new WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder forwardedIpConfig(WebAclRuleStatementNotStatementStatementGeoMatchStatementForwardedIpConfigArgs forwardedIpConfig) {
        ...
        public WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs build() {
            if ($.countryCodes == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementGeoMatchStatementArgs", "countryCodes");
            }
            return $;
        }
    }
