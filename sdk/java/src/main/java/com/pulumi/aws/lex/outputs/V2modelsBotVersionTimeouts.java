...
public final class V2modelsBotVersionTimeouts {
    ...
    public static Builder builder(V2modelsBotVersionTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(V2modelsBotVersionTimeouts defaults) {
        ...
        public V2modelsBotVersionTimeouts build() {
            final var _resultValue = new V2modelsBotVersionTimeouts();
