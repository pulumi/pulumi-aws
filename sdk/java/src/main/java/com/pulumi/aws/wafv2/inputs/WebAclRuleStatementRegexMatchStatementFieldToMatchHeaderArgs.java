...
public final class WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;

    /**
     * @return Headers to inspect. See Headers Match Pattern below.
     * 
     */
    public Optional<Output<WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs>> matchPattern() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder matchPattern(@Nullable Output<WebAclRuleStatementRegexMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
