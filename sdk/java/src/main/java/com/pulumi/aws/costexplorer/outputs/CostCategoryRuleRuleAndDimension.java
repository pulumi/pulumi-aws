...
public final class CostCategoryRuleRuleAndDimension {
    ...
    private CostCategoryRuleRuleAndDimension(
    ...
    public static Builder builder(CostCategoryRuleRuleAndDimension defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CostCategoryRuleRuleAndDimension defaults) {
        ...
        }        public CostCategoryRuleRuleAndDimension build() {
            return new CostCategoryRuleRuleAndDimension(key, matchOptions, values);
        }
    }
}
