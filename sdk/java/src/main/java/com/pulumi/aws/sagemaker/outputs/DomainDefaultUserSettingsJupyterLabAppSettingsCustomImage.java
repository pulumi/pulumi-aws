...
public final class DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage {
    ...
    public static Builder builder(DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer imageVersionNumber;
        public Builder() {}
        public Builder(DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage defaults) {
        ...
        public Builder appImageConfigName(String appImageConfigName) {
            if (appImageConfigName == null) {
              throw new MissingRequiredPropertyException("DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage", "appImageConfigName");
            }
        ...
        public Builder imageName(String imageName) {
            if (imageName == null) {
              throw new MissingRequiredPropertyException("DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage", "imageName");
            }
        ...
        public DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage build() {
            final var _resultValue = new DomainDefaultUserSettingsJupyterLabAppSettingsCustomImage();
