...
public final class FirehoseDeliveryStreamSnowflakeConfigurationCloudwatchLoggingOptions {
    ...
    private FirehoseDeliveryStreamSnowflakeConfigurationCloudwatchLoggingOptions() {}
    /**
     * @return Enables or disables the logging. Defaults to `false`.
     * 
     */
    ...
    public static Builder builder(FirehoseDeliveryStreamSnowflakeConfigurationCloudwatchLoggingOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String logStreamName;
        public Builder() {}
        public Builder(FirehoseDeliveryStreamSnowflakeConfigurationCloudwatchLoggingOptions defaults) {
        ...
        public FirehoseDeliveryStreamSnowflakeConfigurationCloudwatchLoggingOptions build() {
            final var _resultValue = new FirehoseDeliveryStreamSnowflakeConfigurationCloudwatchLoggingOptions();
