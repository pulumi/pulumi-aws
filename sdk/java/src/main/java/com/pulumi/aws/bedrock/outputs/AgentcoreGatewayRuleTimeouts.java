...
@CustomType
public final class AgentcoreGatewayRuleTimeouts {
    /**
    ...
    public static Builder builder(AgentcoreGatewayRuleTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(AgentcoreGatewayRuleTimeouts defaults) {
        ...
        public AgentcoreGatewayRuleTimeouts build() {
            final var _resultValue = new AgentcoreGatewayRuleTimeouts();
