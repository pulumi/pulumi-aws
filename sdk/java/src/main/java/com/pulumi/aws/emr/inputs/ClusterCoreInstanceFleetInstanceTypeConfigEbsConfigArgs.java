...
public final class ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs(ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs $) {
        this.iops = $.iops;
        this.size = $.size;
        this.type = $.type;
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs();
        }

        public Builder(ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs defaults) {
            $ = new ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs build() {
            if ($.size == null) {
                throw new MissingRequiredPropertyException("ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs", "size");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs", "type");
            }
            return $;
        }
    }
