...
public final class StaticWebLayerLoadBasedAutoScalingUpscaling {
    ...
    public static Builder builder(StaticWebLayerLoadBasedAutoScalingUpscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer thresholdsWaitTime;
        public Builder() {}
        public Builder(StaticWebLayerLoadBasedAutoScalingUpscaling defaults) {
        ...
        public StaticWebLayerLoadBasedAutoScalingUpscaling build() {
            final var _resultValue = new StaticWebLayerLoadBasedAutoScalingUpscaling();
