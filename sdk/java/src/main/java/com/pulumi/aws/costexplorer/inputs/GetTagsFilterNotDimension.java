...
public final class GetTagsFilterNotDimension extends com.pulumi.resources.InvokeArgs {

    public static final GetTagsFilterNotDimension Empty = new GetTagsFilterNotDimension();
    ...
    private GetTagsFilterNotDimension() {}

    private GetTagsFilterNotDimension(GetTagsFilterNotDimension $) {
        this.key = $.key;
    ...
    public static Builder builder(GetTagsFilterNotDimension defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagsFilterNotDimension();
        }

        public Builder(GetTagsFilterNotDimension defaults) {
            $ = new GetTagsFilterNotDimension(Objects.requireNonNull(defaults));
        }
        ...
        public GetTagsFilterNotDimension build() {
            return $;
        }
    }
