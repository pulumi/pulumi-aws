...
public final class AnomalySubscriptionThresholdExpressionNotTagsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AnomalySubscriptionThresholdExpressionNotTagsArgs Empty = new AnomalySubscriptionThresholdExpressionNotTagsArgs();
    ...
    private AnomalySubscriptionThresholdExpressionNotTagsArgs() {}

    private AnomalySubscriptionThresholdExpressionNotTagsArgs(AnomalySubscriptionThresholdExpressionNotTagsArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(AnomalySubscriptionThresholdExpressionNotTagsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AnomalySubscriptionThresholdExpressionNotTagsArgs();
        }

        public Builder(AnomalySubscriptionThresholdExpressionNotTagsArgs defaults) {
            $ = new AnomalySubscriptionThresholdExpressionNotTagsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AnomalySubscriptionThresholdExpressionNotTagsArgs build() {
            return $;
        }
    }
