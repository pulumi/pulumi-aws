...
public final class DomainVpcOptionsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param securityGroupIds List of VPC Security Group IDs to be applied to the OpenSearch domain endpoints. If omitted, the default Security Group for the VPC will be used.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param subnetIds List of VPC Subnet IDs for the OpenSearch domain endpoints to be created in.
         * 
         * @return builder
         * 
         */
