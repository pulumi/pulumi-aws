...
public final class WebAclRuleStatementRegexMatchStatementFieldToMatchJa3Fingerprint {
    ...
    private WebAclRuleStatementRegexMatchStatementFieldToMatchJa3Fingerprint() {}
    /**
     * @return Match status to assign to the web request if the request doesn&#39;t have a valid IP address in the specified position. Valid values include: `MATCH` or `NO_MATCH`.
     * 
     */
    ...
    public static Builder builder(WebAclRuleStatementRegexMatchStatementFieldToMatchJa3Fingerprint defaults) {
    ...
    public static final class Builder {
        private String fallbackBehavior;
        public Builder() {}
        public Builder(WebAclRuleStatementRegexMatchStatementFieldToMatchJa3Fingerprint defaults) {
        ...
        public Builder fallbackBehavior(String fallbackBehavior) {
            if (fallbackBehavior == null) {
              throw new MissingRequiredPropertyException("WebAclRuleStatementRegexMatchStatementFieldToMatchJa3Fingerprint", "fallbackBehavior");
            }
