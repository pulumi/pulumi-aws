...
public final class VisualsBarChartVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsBarChartVisualArgs Empty = new VisualsBarChartVisualArgs();
    ...
    private @Nullable Output<VisualsBarChartVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsBarChartVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsBarChartVisualArgs(VisualsBarChartVisualArgs $) {
    ...
    public static Builder builder(VisualsBarChartVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsBarChartVisualArgs();
        }

        public Builder(VisualsBarChartVisualArgs defaults) {
            $ = new VisualsBarChartVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsBarChartVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsBarChartVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsBarChartVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsBarChartVisualArgs", "visualId");
            }
            return $;
        }
    }
