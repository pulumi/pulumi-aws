...
@CustomType
public final class AgentAgentCollaboratorTimeouts {
    /**
    ...
    public static Builder builder(AgentAgentCollaboratorTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(AgentAgentCollaboratorTimeouts defaults) {
        ...
        public AgentAgentCollaboratorTimeouts build() {
            final var _resultValue = new AgentAgentCollaboratorTimeouts();
