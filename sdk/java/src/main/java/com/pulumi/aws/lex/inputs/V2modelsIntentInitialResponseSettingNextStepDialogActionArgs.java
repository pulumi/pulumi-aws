...
public final class V2modelsIntentInitialResponseSettingNextStepDialogActionArgs extends com.pulumi.resources.ResourceArgs {

    public static final V2modelsIntentInitialResponseSettingNextStepDialogActionArgs Empty = new V2modelsIntentInitialResponseSettingNextStepDialogActionArgs();
    ...
    private V2modelsIntentInitialResponseSettingNextStepDialogActionArgs() {}

    private V2modelsIntentInitialResponseSettingNextStepDialogActionArgs(V2modelsIntentInitialResponseSettingNextStepDialogActionArgs $) {
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingNextStepDialogActionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new V2modelsIntentInitialResponseSettingNextStepDialogActionArgs();
        }

        public Builder(V2modelsIntentInitialResponseSettingNextStepDialogActionArgs defaults) {
            $ = new V2modelsIntentInitialResponseSettingNextStepDialogActionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public V2modelsIntentInitialResponseSettingNextStepDialogActionArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingNextStepDialogActionArgs", "type");
            }
            return $;
        }
    }
