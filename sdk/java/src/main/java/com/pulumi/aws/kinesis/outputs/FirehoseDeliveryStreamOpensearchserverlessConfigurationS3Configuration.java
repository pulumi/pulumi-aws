...
public final class FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration {
    ...
    public static final class Builder {
        ...
        public Builder bucketArn(String bucketArn) {
            if (bucketArn == null) {
              throw new MissingRequiredPropertyException("FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration", "bucketArn");
            }
        ...
        public Builder roleArn(String roleArn) {
            if (roleArn == null) {
              throw new MissingRequiredPropertyException("FirehoseDeliveryStreamOpensearchserverlessConfigurationS3Configuration", "roleArn");
            }
