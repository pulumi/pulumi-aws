...
public final class StorageLensConfigurationStorageLensConfigurationAccountLevelDetailedStatusCodeMetrics {
    ...
    public static Builder builder(StorageLensConfigurationStorageLensConfigurationAccountLevelDetailedStatusCodeMetrics defaults) {
    ...
    public static final class Builder {
        private @Nullable Boolean enabled;
        public Builder() {}
        public Builder(StorageLensConfigurationStorageLensConfigurationAccountLevelDetailedStatusCodeMetrics defaults) {
        ...
        public StorageLensConfigurationStorageLensConfigurationAccountLevelDetailedStatusCodeMetrics build() {
            final var _resultValue = new StorageLensConfigurationStorageLensConfigurationAccountLevelDetailedStatusCodeMetrics();
