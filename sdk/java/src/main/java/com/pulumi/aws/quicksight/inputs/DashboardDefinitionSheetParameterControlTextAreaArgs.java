...
public final class DashboardDefinitionSheetParameterControlTextAreaArgs extends com.pulumi.resources.ResourceArgs {

    public static final DashboardDefinitionSheetParameterControlTextAreaArgs Empty = new DashboardDefinitionSheetParameterControlTextAreaArgs();
    ...
    private DashboardDefinitionSheetParameterControlTextAreaArgs(DashboardDefinitionSheetParameterControlTextAreaArgs $) {
    ...
    public static Builder builder(DashboardDefinitionSheetParameterControlTextAreaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DashboardDefinitionSheetParameterControlTextAreaArgs();
        }

        public Builder(DashboardDefinitionSheetParameterControlTextAreaArgs defaults) {
            $ = new DashboardDefinitionSheetParameterControlTextAreaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DashboardDefinitionSheetParameterControlTextAreaArgs build() {
            if ($.parameterControlId == null) {
                throw new MissingRequiredPropertyException("DashboardDefinitionSheetParameterControlTextAreaArgs", "parameterControlId");
            }
            if ($.sourceParameterName == null) {
                throw new MissingRequiredPropertyException("DashboardDefinitionSheetParameterControlTextAreaArgs", "sourceParameterName");
            }
            if ($.title == null) {
                throw new MissingRequiredPropertyException("DashboardDefinitionSheetParameterControlTextAreaArgs", "title");
            }
            return $;
        }
    }
