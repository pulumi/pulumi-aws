...
public final class WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody {
     ...
     * 
     */
    private @Nullable WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
    ...
    private WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody() {}
    /**
     * @return How to handle requests with invalid JSON body. Valid values: `EVALUATE_AS_STRING`, `MATCH`, `NO_MATCH`.
     * 
     */
     ...
     * 
     */
    public Optional<WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern> matchPattern() {
    ...
    public static Builder builder(WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(@Nullable WebAclRuleStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
        ...
        public WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody build() {
            final var _resultValue = new WebAclRuleStatementXssMatchStatementFieldToMatchJsonBody();
