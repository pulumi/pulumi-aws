...
public final class InsightFiltersFindingProviderFieldsSeverityLabel {
    ...
    public static final class Builder {
        ...
        public Builder comparison(String comparison) {
            if (comparison == null) {
              throw new MissingRequiredPropertyException("InsightFiltersFindingProviderFieldsSeverityLabel", "comparison");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("InsightFiltersFindingProviderFieldsSeverityLabel", "value");
            }
            this.value = value;
            return this;
        }
