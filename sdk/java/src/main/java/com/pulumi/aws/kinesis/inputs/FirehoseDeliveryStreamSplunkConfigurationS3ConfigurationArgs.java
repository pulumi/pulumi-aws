...
public final class FirehoseDeliveryStreamSplunkConfigurationS3ConfigurationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder cloudwatchLoggingOptions(@Nullable Output<FirehoseDeliveryStreamSplunkConfigurationS3ConfigurationCloudwatchLoggingOptionsArgs> cloudwatchLoggingOptions) {
