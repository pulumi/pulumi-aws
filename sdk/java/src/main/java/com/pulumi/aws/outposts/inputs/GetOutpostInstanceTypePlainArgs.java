...
public final class GetOutpostInstanceTypePlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    /**
     * @return Desired instance type. Conflicts with `preferredInstanceTypes`.
     * 
     */
    ...
    /**
     * @return Ordered list of preferred instance types. The first match in this list will be returned. If no preferred matches are found and the original search returned more than one result, an error is returned. Conflicts with `instanceType`.
     * 
     */
    ...
    public static final class Builder {
        ...
        /**
         * @param instanceType Desired instance type. Conflicts with `preferredInstanceTypes`.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param preferredInstanceTypes Ordered list of preferred instance types. The first match in this list will be returned. If no preferred matches are found and the original search returned more than one result, an error is returned. Conflicts with `instanceType`.
         * 
         * @return builder
         * 
         */
