...
public class EncryptionByDefault extends com.pulumi.resources.CustomResource {
     ...
     */
    public EncryptionByDefault(java.lang.String name) {
     ...
     */
    public EncryptionByDefault(java.lang.String name, @Nullable EncryptionByDefaultArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public EncryptionByDefault(java.lang.String name, @Nullable EncryptionByDefaultArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ebs/encryptionByDefault:EncryptionByDefault", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private EncryptionByDefault(java.lang.String name, Output<java.lang.String> id, @Nullable EncryptionByDefaultState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ebs/encryptionByDefault:EncryptionByDefault", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static EncryptionByDefault get(java.lang.String name, Output<java.lang.String> id, @Nullable EncryptionByDefaultState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
