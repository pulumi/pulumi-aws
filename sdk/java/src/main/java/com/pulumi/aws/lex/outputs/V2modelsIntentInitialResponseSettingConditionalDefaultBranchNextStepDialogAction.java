...
@CustomType
public final class V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction {
    /**
    ...
    private V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction() {}
    /**
     * @return If the dialog action is `ElicitSlot`, defines the slot to elicit from the user.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingConditionalDefaultBranchNextStepDialogAction();
