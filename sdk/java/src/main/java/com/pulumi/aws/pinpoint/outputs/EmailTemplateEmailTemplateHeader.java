...
public final class EmailTemplateEmailTemplateHeader {
    ...
    public static Builder builder(EmailTemplateEmailTemplateHeader defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String value;
        public Builder() {}
        public Builder(EmailTemplateEmailTemplateHeader defaults) {
        ...
        public EmailTemplateEmailTemplateHeader build() {
            final var _resultValue = new EmailTemplateEmailTemplateHeader();
