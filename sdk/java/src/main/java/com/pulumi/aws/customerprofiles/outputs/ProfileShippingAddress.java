...
public final class ProfileShippingAddress {
    ...
    public static Builder builder(ProfileShippingAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String state;
        public Builder() {}
        public Builder(ProfileShippingAddress defaults) {
        ...
        public ProfileShippingAddress build() {
            final var _resultValue = new ProfileShippingAddress();
