...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs;
...
public final class WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs Empty = new WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs();
    ...
    private Output<List<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns;
     ...
     * 
     */
    public Output<List<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns() {
    ...
    private WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs() {}

    private WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs();
        }

        public Builder(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs defaults) {
            $ = new WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPatterns(Output<List<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns) {
         ...
         * 
         */
        public Builder matchPatterns(List<WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs> matchPatterns) {
         ...
         * 
         */
        public Builder matchPatterns(WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesMatchPatternArgs... matchPatterns) {
        ...
        public WebAclRuleStatementAndStatementStatementByteMatchStatementFieldToMatchCookiesArgs build() {
