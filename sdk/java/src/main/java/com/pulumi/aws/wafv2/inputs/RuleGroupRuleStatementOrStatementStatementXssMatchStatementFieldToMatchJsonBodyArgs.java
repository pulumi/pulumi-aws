...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs;
...
public final class RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs Empty = new RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs();
    ...
    private Output<RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern() {
    ...
    private RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs() {}

    private RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs(RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs $) {
    ...
    public static Builder builder(RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs();
        }

        public Builder(RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs defaults) {
            $ = new RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPatternArgs matchPattern) {
        ...
        public RuleGroupRuleStatementOrStatementStatementXssMatchStatementFieldToMatchJsonBodyArgs build() {
