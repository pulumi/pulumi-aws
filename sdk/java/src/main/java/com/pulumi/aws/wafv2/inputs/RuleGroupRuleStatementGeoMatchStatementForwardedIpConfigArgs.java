    ...
    public static final class Builder {
        ...
        public RuleGroupRuleStatementGeoMatchStatementForwardedIpConfigArgs build() {
            if ($.fallbackBehavior == null) {
                throw new MissingRequiredPropertyException("RuleGroupRuleStatementGeoMatchStatementForwardedIpConfigArgs", "fallbackBehavior");
            }
            if ($.headerName == null) {
                throw new MissingRequiredPropertyException("RuleGroupRuleStatementGeoMatchStatementForwardedIpConfigArgs", "headerName");
            }
            return $;
        }
    }
