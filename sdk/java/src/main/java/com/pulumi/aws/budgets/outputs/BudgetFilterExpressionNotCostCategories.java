...
@CustomType
public final class BudgetFilterExpressionNotCostCategories {
    /**
    ...
    public static Builder builder(BudgetFilterExpressionNotCostCategories defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionNotCostCategories defaults) {
        ...
        public BudgetFilterExpressionNotCostCategories build() {
            final var _resultValue = new BudgetFilterExpressionNotCostCategories();
