...
public class AccessKey extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ String> encryptedSecret;
     ...
     * 
     */
    public Output<Optional<String>> encryptedSecret() {
        return Codegen.optional(this.encryptedSecret);
    }
    /**
    ...
    private Output</* @Nullable */ String> encryptedSesSmtpPasswordV4;
     ...
     * 
     */
    public Output<Optional<String>> encryptedSesSmtpPasswordV4() {
        return Codegen.optional(this.encryptedSesSmtpPasswordV4);
    }
    /**
    ...
    private Output</* @Nullable */ String> sesSmtpPasswordV4;
     ...
     * 
     */
    public Output<Optional<String>> sesSmtpPasswordV4() {
        return Codegen.optional(this.sesSmtpPasswordV4);
    }
    /**
