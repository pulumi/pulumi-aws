...
public final class ConnectionTimeouts {
    ...
    public static Builder builder(ConnectionTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ConnectionTimeouts defaults) {
        ...
        public ConnectionTimeouts build() {
            final var _resultValue = new ConnectionTimeouts();
