...
public final class IntentFollowUpPromptRejectionStatementMessageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public IntentFollowUpPromptRejectionStatementMessageArgs build() {
            if ($.content == null) {
                throw new MissingRequiredPropertyException("IntentFollowUpPromptRejectionStatementMessageArgs", "content");
            }
            if ($.contentType == null) {
                throw new MissingRequiredPropertyException("IntentFollowUpPromptRejectionStatementMessageArgs", "contentType");
            }
            return $;
        }
    }
