...
@CustomType
public final class BudgetFilterExpressionOrAndTags {
    /**
    ...
    private BudgetFilterExpressionOrAndTags() {}
    /**
     * @return (Optional) The cost category key to filter on.
     * 
     */
    ...
    public static Builder builder(BudgetFilterExpressionOrAndTags defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(BudgetFilterExpressionOrAndTags defaults) {
        ...
        public BudgetFilterExpressionOrAndTags build() {
            final var _resultValue = new BudgetFilterExpressionOrAndTags();
