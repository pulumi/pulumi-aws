...
public final class V2modelsIntentClosingSettingNextStepDialogAction {
    ...
    private V2modelsIntentClosingSettingNextStepDialogAction() {}
    /**
     * @return If the dialog action is `ElicitSlot`, defines the slot to elicit from the user.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentClosingSettingNextStepDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentClosingSettingNextStepDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentClosingSettingNextStepDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentClosingSettingNextStepDialogAction build() {
            final var _resultValue = new V2modelsIntentClosingSettingNextStepDialogAction();
