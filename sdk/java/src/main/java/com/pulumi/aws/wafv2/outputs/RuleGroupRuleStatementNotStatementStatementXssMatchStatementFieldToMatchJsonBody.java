...
import com.pulumi.aws.wafv2.outputs.RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern;
...
@CustomType
public final class RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody {
    /**
     ...
     * 
     */
    private RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern;
    /**
    ...
    private RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody() {}
    /**
     * @return What to do when JSON parsing fails. Defaults to evaluating up to the first parsing failure. Valid values are `EVALUATE_AS_STRING`, `MATCH` and `NO_MATCH`.
     * 
     */
     ...
     * 
     */
    public RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern() {
    ...
    public static Builder builder(RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oversizeHandling;
        public Builder() {}
        public Builder(RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody defaults) {
        ...
        @CustomType.Setter
        public Builder matchPattern(RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBodyMatchPattern matchPattern) {
        ...
        public RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody build() {
            final var o = new RuleGroupRuleStatementNotStatementStatementXssMatchStatementFieldToMatchJsonBody();
