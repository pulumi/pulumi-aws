...
public class CustomLayer extends com.pulumi.resources.CustomResource {
     ...
     */
    public CustomLayer(java.lang.String name, CustomLayerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CustomLayer(java.lang.String name, CustomLayerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:opsworks/customLayer:CustomLayer", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CustomLayer(java.lang.String name, Output<java.lang.String> id, @Nullable CustomLayerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:opsworks/customLayer:CustomLayer", name, state, makeResourceOptions(options, id), false);
    }

    private static CustomLayerArgs makeArgs(CustomLayerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CustomLayerArgs.Empty : args;
    }
     ...
     */
    public static CustomLayer get(java.lang.String name, Output<java.lang.String> id, @Nullable CustomLayerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
