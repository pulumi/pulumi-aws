...
@CustomType
public final class MonitorTimeouts {
    /**
    ...
    public static Builder builder(MonitorTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(MonitorTimeouts defaults) {
        ...
        public MonitorTimeouts build() {
            final var _resultValue = new MonitorTimeouts();
