...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementAndStatementStatementGeoMatchStatementForwardedIpConfigArgs;
...
public final class WebAclRuleStatementAndStatementStatementGeoMatchStatementArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    public Optional<Output<WebAclRuleStatementAndStatementStatementGeoMatchStatementForwardedIpConfigArgs>> forwardedIpConfig() {
        return Optional.ofNullable(this.forwardedIpConfig);
    }

    private WebAclRuleStatementAndStatementStatementGeoMatchStatementArgs() {}

    private WebAclRuleStatementAndStatementStatementGeoMatchStatementArgs(WebAclRuleStatementAndStatementStatementGeoMatchStatementArgs $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementAndStatementStatementGeoMatchStatementArgs();
        }

        public Builder(WebAclRuleStatementAndStatementStatementGeoMatchStatementArgs defaults) {
            $ = new WebAclRuleStatementAndStatementStatementGeoMatchStatementArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder forwardedIpConfig(WebAclRuleStatementAndStatementStatementGeoMatchStatementForwardedIpConfigArgs forwardedIpConfig) {
