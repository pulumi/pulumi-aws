...
public final class GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustSd {
    ...
    public static final class Builder {
        ...
        public Builder secretName(String secretName) {
            if (secretName == null) {
              throw new MissingRequiredPropertyException("GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustSd", "secretName");
            }
            this.secretName = secretName;
            return this;
        }
        public GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustSd build() {
            final var _resultValue = new GetVirtualNodeSpecBackendVirtualServiceClientPolicyTlValidationTrustSd();
