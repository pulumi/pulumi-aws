...
public class GangliaLayer extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ GangliaLayerLoadBasedAutoScaling> loadBasedAutoScaling;

    public Output<Optional<GangliaLayerLoadBasedAutoScaling>> loadBasedAutoScaling() {
