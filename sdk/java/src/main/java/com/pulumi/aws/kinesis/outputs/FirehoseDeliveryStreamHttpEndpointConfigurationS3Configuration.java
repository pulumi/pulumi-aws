...
public final class FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration {
    ...
    public static final class Builder {
        ...
        public Builder bucketArn(String bucketArn) {
            if (bucketArn == null) {
              throw new MissingRequiredPropertyException("FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration", "bucketArn");
            }
        ...
        public Builder roleArn(String roleArn) {
            if (roleArn == null) {
              throw new MissingRequiredPropertyException("FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration", "roleArn");
            }
            this.roleArn = roleArn;
            return this;
        }
        public FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration build() {
            final var _resultValue = new FirehoseDeliveryStreamHttpEndpointConfigurationS3Configuration();
