...
public final class FilterFilterCriteriaEpssScoreArgs extends com.pulumi.resources.ResourceArgs {

    public static final FilterFilterCriteriaEpssScoreArgs Empty = new FilterFilterCriteriaEpssScoreArgs();
    ...
    private FilterFilterCriteriaEpssScoreArgs() {}

    private FilterFilterCriteriaEpssScoreArgs(FilterFilterCriteriaEpssScoreArgs $) {
    ...
    public static Builder builder(FilterFilterCriteriaEpssScoreArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FilterFilterCriteriaEpssScoreArgs();
        }

        public Builder(FilterFilterCriteriaEpssScoreArgs defaults) {
            $ = new FilterFilterCriteriaEpssScoreArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FilterFilterCriteriaEpssScoreArgs build() {
            if ($.lowerInclusive == null) {
                throw new MissingRequiredPropertyException("FilterFilterCriteriaEpssScoreArgs", "lowerInclusive");
            }
            if ($.upperInclusive == null) {
                throw new MissingRequiredPropertyException("FilterFilterCriteriaEpssScoreArgs", "upperInclusive");
            }
            return $;
        }
    }
