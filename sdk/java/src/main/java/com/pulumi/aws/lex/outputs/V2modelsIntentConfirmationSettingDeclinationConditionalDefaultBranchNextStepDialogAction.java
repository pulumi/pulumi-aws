...
public final class V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepDialogAction {
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepDialogAction build() {
            final var _resultValue = new V2modelsIntentConfirmationSettingDeclinationConditionalDefaultBranchNextStepDialogAction();
