...
public final class V2modelsIntentInitialResponseSettingImageResponseCard {
    ...
    public static Builder builder(V2modelsIntentInitialResponseSettingImageResponseCard defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(V2modelsIntentInitialResponseSettingImageResponseCard defaults) {
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentInitialResponseSettingImageResponseCard", "title");
            }
            this.title = title;
            return this;
        }
        public V2modelsIntentInitialResponseSettingImageResponseCard build() {
            final var _resultValue = new V2modelsIntentInitialResponseSettingImageResponseCard();
