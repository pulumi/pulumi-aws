...
public final class NetworkTimeouts {
    ...
    public static Builder builder(NetworkTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(NetworkTimeouts defaults) {
        ...
        public NetworkTimeouts build() {
            final var _resultValue = new NetworkTimeouts();
