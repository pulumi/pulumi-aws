...
public class VpcIpamResourceDiscoveryAssociation extends com.pulumi.resources.CustomResource {
     ...
     */
    public VpcIpamResourceDiscoveryAssociation(java.lang.String name) {
     ...
     */
    public VpcIpamResourceDiscoveryAssociation(java.lang.String name, VpcIpamResourceDiscoveryAssociationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VpcIpamResourceDiscoveryAssociation(java.lang.String name, VpcIpamResourceDiscoveryAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpcIpamResourceDiscoveryAssociation:VpcIpamResourceDiscoveryAssociation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private VpcIpamResourceDiscoveryAssociation(java.lang.String name, Output<java.lang.String> id, @Nullable VpcIpamResourceDiscoveryAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:ec2/vpcIpamResourceDiscoveryAssociation:VpcIpamResourceDiscoveryAssociation", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static VpcIpamResourceDiscoveryAssociation get(java.lang.String name, Output<java.lang.String> id, @Nullable VpcIpamResourceDiscoveryAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
