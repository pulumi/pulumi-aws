...
@CustomType
public final class KeyTimeouts {
    /**
    ...
    public static Builder builder(KeyTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(KeyTimeouts defaults) {
        ...
        public KeyTimeouts build() {
            final var _resultValue = new KeyTimeouts();
