...
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementNotStatementStatementRateBasedStatementCustomKeyArgs;
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementNotStatementStatementRateBasedStatementForwardedIpConfigArgs;
import com.pulumi.aws.wafv2.inputs.WebAclRuleStatementNotStatementStatementRateBasedStatementScopeDownStatementArgs;
...
public final class WebAclRuleStatementNotStatementStatementRateBasedStatementArgs extends com.pulumi.resources.ResourceArgs {

    public static final WebAclRuleStatementNotStatementStatementRateBasedStatementArgs Empty = new WebAclRuleStatementNotStatementStatementRateBasedStatementArgs();
    ...
    private @Nullable Output<List<WebAclRuleStatementNotStatementStatementRateBasedStatementCustomKeyArgs>> customKeys;

    /**
     * @return Aggregate the request counts using one or more web request components as the aggregate keys. See Custom Keys below.
     * 
     */
    public Optional<Output<List<WebAclRuleStatementNotStatementStatementRateBasedStatementCustomKeyArgs>>> customKeys() {
    ...
    private @Nullable Output<WebAclRuleStatementNotStatementStatementRateBasedStatementForwardedIpConfigArgs> forwardedIpConfig;
     ...
     * 
     */
    public Optional<Output<WebAclRuleStatementNotStatementStatementRateBasedStatementForwardedIpConfigArgs>> forwardedIpConfig() {
    ...
    private @Nullable Output<WebAclRuleStatementNotStatementStatementRateBasedStatementScopeDownStatementArgs> scopeDownStatement;
     ...
     * 
     */
    public Optional<Output<WebAclRuleStatementNotStatementStatementRateBasedStatementScopeDownStatementArgs>> scopeDownStatement() {
        return Optional.ofNullable(this.scopeDownStatement);
    }

    private WebAclRuleStatementNotStatementStatementRateBasedStatementArgs() {}

    private WebAclRuleStatementNotStatementStatementRateBasedStatementArgs(WebAclRuleStatementNotStatementStatementRateBasedStatementArgs $) {
    ...
    public static Builder builder(WebAclRuleStatementNotStatementStatementRateBasedStatementArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WebAclRuleStatementNotStatementStatementRateBasedStatementArgs();
        }

        public Builder(WebAclRuleStatementNotStatementStatementRateBasedStatementArgs defaults) {
            $ = new WebAclRuleStatementNotStatementStatementRateBasedStatementArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder customKeys(@Nullable Output<List<WebAclRuleStatementNotStatementStatementRateBasedStatementCustomKeyArgs>> customKeys) {
         ...
         * 
         */
        public Builder customKeys(List<WebAclRuleStatementNotStatementStatementRateBasedStatementCustomKeyArgs> customKeys) {
         ...
         * 
         */
        public Builder customKeys(WebAclRuleStatementNotStatementStatementRateBasedStatementCustomKeyArgs... customKeys) {
         ...
         * 
         */
        public Builder forwardedIpConfig(@Nullable Output<WebAclRuleStatementNotStatementStatementRateBasedStatementForwardedIpConfigArgs> forwardedIpConfig) {
         ...
         * 
         */
        public Builder forwardedIpConfig(WebAclRuleStatementNotStatementStatementRateBasedStatementForwardedIpConfigArgs forwardedIpConfig) {
         ...
         * 
         */
        public Builder scopeDownStatement(@Nullable Output<WebAclRuleStatementNotStatementStatementRateBasedStatementScopeDownStatementArgs> scopeDownStatement) {
         ...
         * 
         */
        public Builder scopeDownStatement(WebAclRuleStatementNotStatementStatementRateBasedStatementScopeDownStatementArgs scopeDownStatement) {
            return scopeDownStatement(Output.of(scopeDownStatement));
        }

        public WebAclRuleStatementNotStatementStatementRateBasedStatementArgs build() {
            if ($.aggregateKeyType == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementRateBasedStatementArgs", "aggregateKeyType");
            }
            if ($.limit == null) {
                throw new MissingRequiredPropertyException("WebAclRuleStatementNotStatementStatementRateBasedStatementArgs", "limit");
            }
            return $;
        }
    }
