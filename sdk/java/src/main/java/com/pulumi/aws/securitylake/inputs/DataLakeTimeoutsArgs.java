...
public final class DataLakeTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final DataLakeTimeoutsArgs Empty = new DataLakeTimeoutsArgs();
    ...
    private DataLakeTimeoutsArgs() {}

    private DataLakeTimeoutsArgs(DataLakeTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(DataLakeTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataLakeTimeoutsArgs();
        }

        public Builder(DataLakeTimeoutsArgs defaults) {
            $ = new DataLakeTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DataLakeTimeoutsArgs build() {
            return $;
        }
    }
