...
public final class HostTimeouts {
    ...
    public static Builder builder(HostTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(HostTimeouts defaults) {
        ...
        public HostTimeouts build() {
            final var _resultValue = new HostTimeouts();
