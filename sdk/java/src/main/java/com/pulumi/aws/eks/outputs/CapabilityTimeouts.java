...
@CustomType
public final class CapabilityTimeouts {
    /**
    ...
    public static Builder builder(CapabilityTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(CapabilityTimeouts defaults) {
        ...
        public CapabilityTimeouts build() {
            final var _resultValue = new CapabilityTimeouts();
