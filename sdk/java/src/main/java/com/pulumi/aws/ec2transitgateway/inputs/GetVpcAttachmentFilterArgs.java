...
public final class GetVpcAttachmentFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetVpcAttachmentFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetVpcAttachmentFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetVpcAttachmentFilterArgs", "values");
            }
            return $;
        }
    }
