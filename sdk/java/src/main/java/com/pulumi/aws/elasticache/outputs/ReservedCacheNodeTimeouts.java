...
public final class ReservedCacheNodeTimeouts {
    ...
    public static Builder builder(ReservedCacheNodeTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(ReservedCacheNodeTimeouts defaults) {
        ...
        public ReservedCacheNodeTimeouts build() {
            final var _resultValue = new ReservedCacheNodeTimeouts();
