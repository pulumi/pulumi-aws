...
public final class BudgetCostFilter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("BudgetCostFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("BudgetCostFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public BudgetCostFilter build() {
            final var _resultValue = new BudgetCostFilter();
