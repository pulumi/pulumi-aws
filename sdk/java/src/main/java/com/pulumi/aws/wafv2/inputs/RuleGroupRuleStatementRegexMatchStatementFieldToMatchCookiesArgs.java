...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPatternArgs;
...
public final class RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs Empty = new RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs();
    ...
    private Output<List<RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns;
     ...
     * 
     */
    public Output<List<RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns() {
    ...
    private RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs() {}

    private RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs(RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs $) {
    ...
    public static Builder builder(RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs();
        }

        public Builder(RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs defaults) {
            $ = new RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPatterns(Output<List<RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPatternArgs>> matchPatterns) {
         ...
         * 
         */
        public Builder matchPatterns(List<RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPatternArgs> matchPatterns) {
         ...
         * 
         */
        public Builder matchPatterns(RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesMatchPatternArgs... matchPatterns) {
        ...
        public RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs build() {
            if ($.matchPatterns == null) {
                throw new MissingRequiredPropertyException("RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs", "matchPatterns");
            }
            if ($.matchScope == null) {
                throw new MissingRequiredPropertyException("RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs", "matchScope");
            }
            if ($.oversizeHandling == null) {
                throw new MissingRequiredPropertyException("RuleGroupRuleStatementRegexMatchStatementFieldToMatchCookiesArgs", "oversizeHandling");
            }
            return $;
        }
    }
