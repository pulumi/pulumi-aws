...
@CustomType
public final class CapacityProviderTimeouts {
    /**
    ...
    public static Builder builder(CapacityProviderTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(CapacityProviderTimeouts defaults) {
        ...
        public CapacityProviderTimeouts build() {
            final var _resultValue = new CapacityProviderTimeouts();
