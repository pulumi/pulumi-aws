...
import com.pulumi.aws.workspaces.inputs.WebNetworkSettingsState;
...
public class WebNetworkSettings extends com.pulumi.resources.CustomResource {
     ...
     */
    public WebNetworkSettings(java.lang.String name) {
        this(name, WebNetworkSettingsArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public WebNetworkSettings(java.lang.String name, WebNetworkSettingsArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public WebNetworkSettings(java.lang.String name, WebNetworkSettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:workspaces/webNetworkSettings:WebNetworkSettings", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private WebNetworkSettings(java.lang.String name, Output<java.lang.String> id, @Nullable WebNetworkSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:workspaces/webNetworkSettings:WebNetworkSettings", name, state, makeResourceOptions(options, id), false);
    }

    private static WebNetworkSettingsArgs makeArgs(WebNetworkSettingsArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? WebNetworkSettingsArgs.Empty : args;
    }
     ...
     */
    public static WebNetworkSettings get(java.lang.String name, Output<java.lang.String> id, @Nullable WebNetworkSettingsState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
