...
public final class IntentConclusionStatementMessage {
    ...
    public static final class Builder {
        ...
        public Builder content(String content) {
            if (content == null) {
              throw new MissingRequiredPropertyException("IntentConclusionStatementMessage", "content");
            }
        ...
        public Builder contentType(String contentType) {
            if (contentType == null) {
              throw new MissingRequiredPropertyException("IntentConclusionStatementMessage", "contentType");
            }
