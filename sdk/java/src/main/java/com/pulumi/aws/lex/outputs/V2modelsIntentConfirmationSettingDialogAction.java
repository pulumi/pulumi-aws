...
public final class V2modelsIntentConfirmationSettingDialogAction {
    ...
    private V2modelsIntentConfirmationSettingDialogAction() {}
    /**
     * @return If the dialog action is `ElicitSlot`, defines the slot to elicit from the user.
     * 
     */
    ...
    public static Builder builder(V2modelsIntentConfirmationSettingDialogAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(V2modelsIntentConfirmationSettingDialogAction defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("V2modelsIntentConfirmationSettingDialogAction", "type");
            }
            this.type = type;
            return this;
        }
        public V2modelsIntentConfirmationSettingDialogAction build() {
            final var _resultValue = new V2modelsIntentConfirmationSettingDialogAction();
