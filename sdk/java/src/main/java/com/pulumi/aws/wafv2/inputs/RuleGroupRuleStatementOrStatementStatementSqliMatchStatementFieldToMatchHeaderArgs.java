...
import com.pulumi.aws.wafv2.inputs.RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs;
...
public final class RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs extends com.pulumi.resources.ResourceArgs {

    public static final RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs Empty = new RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs();
    ...
    private Output<RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern;
     ...
     * 
     */
    public Output<RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern() {
    ...
    private RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs() {}

    private RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs(RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs $) {
    ...
    public static Builder builder(RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs();
        }

        public Builder(RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs defaults) {
            $ = new RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder matchPattern(Output<RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs> matchPattern) {
         ...
         * 
         */
        public Builder matchPattern(RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderMatchPatternArgs matchPattern) {
        ...
        public RuleGroupRuleStatementOrStatementStatementSqliMatchStatementFieldToMatchHeaderArgs build() {
