...
public final class FormTypeTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final FormTypeTimeoutsArgs Empty = new FormTypeTimeoutsArgs();
    ...
    private FormTypeTimeoutsArgs() {}

    private FormTypeTimeoutsArgs(FormTypeTimeoutsArgs $) {
        this.create = $.create;
    }
    ...
    public static Builder builder(FormTypeTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FormTypeTimeoutsArgs();
        }

        public Builder(FormTypeTimeoutsArgs defaults) {
            $ = new FormTypeTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FormTypeTimeoutsArgs build() {
            return $;
        }
    }
