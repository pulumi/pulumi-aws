...
@CustomType
public final class ModelAgreementTimeouts {
    /**
    ...
    public static Builder builder(ModelAgreementTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String delete;
        public Builder() {}
        public Builder(ModelAgreementTimeouts defaults) {
        ...
        public ModelAgreementTimeouts build() {
            final var _resultValue = new ModelAgreementTimeouts();
