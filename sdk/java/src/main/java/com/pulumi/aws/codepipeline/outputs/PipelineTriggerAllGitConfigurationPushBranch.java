...
public final class PipelineTriggerAllGitConfigurationPushBranch {
    ...
    public static Builder builder(PipelineTriggerAllGitConfigurationPushBranch defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> includes;
        public Builder() {}
        public Builder(PipelineTriggerAllGitConfigurationPushBranch defaults) {
        ...
        public PipelineTriggerAllGitConfigurationPushBranch build() {
            final var _resultValue = new PipelineTriggerAllGitConfigurationPushBranch();
