...
public final class RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutArgs(RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutArgs $) {
        this.unit = $.unit;
        this.value = $.value;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutArgs();
        }
        ...
        public RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutArgs build() {
            if ($.unit == null) {
                throw new MissingRequiredPropertyException("RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutArgs", "unit");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("RouteSpecHttp2RouteRetryPolicyPerRetryTimeoutArgs", "value");
            }
            return $;
        }
    }
