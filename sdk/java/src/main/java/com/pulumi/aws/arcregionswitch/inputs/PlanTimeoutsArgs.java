...
public final class PlanTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PlanTimeoutsArgs Empty = new PlanTimeoutsArgs();
    ...
    private PlanTimeoutsArgs() {}

    private PlanTimeoutsArgs(PlanTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(PlanTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PlanTimeoutsArgs();
        }

        public Builder(PlanTimeoutsArgs defaults) {
            $ = new PlanTimeoutsArgs(Objects.requireNonNull(defaults));
        }
