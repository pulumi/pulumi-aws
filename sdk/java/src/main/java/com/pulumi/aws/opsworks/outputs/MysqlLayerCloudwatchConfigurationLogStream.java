...
public final class MysqlLayerCloudwatchConfigurationLogStream {
    ...
    public static final class Builder {
        ...
        public Builder file(String file) {
            if (file == null) {
              throw new MissingRequiredPropertyException("MysqlLayerCloudwatchConfigurationLogStream", "file");
            }
            this.file = file;
            return this;
        }
        ...
        public Builder logGroupName(String logGroupName) {
            if (logGroupName == null) {
              throw new MissingRequiredPropertyException("MysqlLayerCloudwatchConfigurationLogStream", "logGroupName");
            }
        ...
        public MysqlLayerCloudwatchConfigurationLogStream build() {
            final var _resultValue = new MysqlLayerCloudwatchConfigurationLogStream();
