...
public final class RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation {
    ...
    private RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation() {}
    /**
     * @return The relative processing order for multiple transformations that are defined for a rule statement. AWS WAF processes all transformations, from lowest priority to highest, before inspecting the transformed content.
     * 
     */
    ...
    public static Builder builder(RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation defaults) {
        ...
        public Builder priority(Integer priority) {
            if (priority == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation", "priority");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("RuleGroupRuleStatementRateBasedStatementCustomKeyQueryStringTextTransformation", "type");
            }
            this.type = type;
            return this;
        }
