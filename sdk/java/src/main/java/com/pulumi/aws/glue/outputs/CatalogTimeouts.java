...
@CustomType
public final class CatalogTimeouts {
    /**
    ...
    public static Builder builder(CatalogTimeouts defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String update;
        public Builder() {}
        public Builder(CatalogTimeouts defaults) {
        ...
        public CatalogTimeouts build() {
            final var _resultValue = new CatalogTimeouts();
