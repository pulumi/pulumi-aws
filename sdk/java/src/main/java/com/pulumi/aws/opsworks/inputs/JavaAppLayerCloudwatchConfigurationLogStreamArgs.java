...
public final class JavaAppLayerCloudwatchConfigurationLogStreamArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public JavaAppLayerCloudwatchConfigurationLogStreamArgs build() {
            if ($.file == null) {
                throw new MissingRequiredPropertyException("JavaAppLayerCloudwatchConfigurationLogStreamArgs", "file");
            }
            if ($.logGroupName == null) {
                throw new MissingRequiredPropertyException("JavaAppLayerCloudwatchConfigurationLogStreamArgs", "logGroupName");
            }
            return $;
        }
    }
