...
public class IdentitySource extends com.pulumi.resources.CustomResource {
     ...
     */
    public IdentitySource(String name) {
     ...
     */
    public static IdentitySource get(String name, Output<String> id, @Nullable IdentitySourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
