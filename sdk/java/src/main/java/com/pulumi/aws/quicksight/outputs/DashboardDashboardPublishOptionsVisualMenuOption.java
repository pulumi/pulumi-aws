...
public final class DashboardDashboardPublishOptionsVisualMenuOption {
    ...
    public static Builder builder(DashboardDashboardPublishOptionsVisualMenuOption defaults) {
    ...
    public static final class Builder {
        private @Nullable String availabilityStatus;
        public Builder() {}
        public Builder(DashboardDashboardPublishOptionsVisualMenuOption defaults) {
