...
public class ServiceSpecificCredential extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ String> serviceSpecificCredentialId;

    /**
     * @return The unique identifier for the service-specific credential.
     * 
     */
    public Output<Optional<String>> serviceSpecificCredentialId() {
        return Codegen.optional(this.serviceSpecificCredentialId);
    }
    /**
    ...
    private Output</* @Nullable */ String> serviceUserName;
     ...
     * 
     */
    public Output<Optional<String>> serviceUserName() {
        return Codegen.optional(this.serviceUserName);
    }
    /**
