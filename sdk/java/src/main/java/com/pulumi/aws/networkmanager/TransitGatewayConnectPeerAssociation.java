...
public class TransitGatewayConnectPeerAssociation extends com.pulumi.resources.CustomResource {
    ...
    public TransitGatewayConnectPeerAssociation(java.lang.String name, TransitGatewayConnectPeerAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:networkmanager/transitGatewayConnectPeerAssociation:TransitGatewayConnectPeerAssociation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private TransitGatewayConnectPeerAssociation(java.lang.String name, Output<java.lang.String> id, @Nullable TransitGatewayConnectPeerAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:networkmanager/transitGatewayConnectPeerAssociation:TransitGatewayConnectPeerAssociation", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static TransitGatewayConnectPeerAssociation get(java.lang.String name, Output<java.lang.String> id, @Nullable TransitGatewayConnectPeerAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
