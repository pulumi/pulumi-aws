...
import com.pulumi.aws.quicksight.inputs.VisualsWordCloudVisualChartConfigurationArgs;
...
public final class VisualsWordCloudVisualArgs extends com.pulumi.resources.ResourceArgs {

    public static final VisualsWordCloudVisualArgs Empty = new VisualsWordCloudVisualArgs();
    ...
    private @Nullable Output<VisualsWordCloudVisualChartConfigurationArgs> chartConfiguration;

    public Optional<Output<VisualsWordCloudVisualChartConfigurationArgs>> chartConfiguration() {
    ...
    private VisualsWordCloudVisualArgs() {}

    private VisualsWordCloudVisualArgs(VisualsWordCloudVisualArgs $) {
    ...
    public static Builder builder(VisualsWordCloudVisualArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VisualsWordCloudVisualArgs();
        }

        public Builder(VisualsWordCloudVisualArgs defaults) {
            $ = new VisualsWordCloudVisualArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder chartConfiguration(@Nullable Output<VisualsWordCloudVisualChartConfigurationArgs> chartConfiguration) {
            $.chartConfiguration = chartConfiguration;
            return this;
        }

        public Builder chartConfiguration(VisualsWordCloudVisualChartConfigurationArgs chartConfiguration) {
        ...
        public VisualsWordCloudVisualArgs build() {
            if ($.visualId == null) {
                throw new MissingRequiredPropertyException("VisualsWordCloudVisualArgs", "visualId");
            }
            return $;
        }
    }
