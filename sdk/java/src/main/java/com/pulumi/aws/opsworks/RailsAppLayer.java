...
public class RailsAppLayer extends com.pulumi.resources.CustomResource {
     ...
     */
    public RailsAppLayer(String name, @Nullable RailsAppLayerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RailsAppLayer(String name, @Nullable RailsAppLayerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
