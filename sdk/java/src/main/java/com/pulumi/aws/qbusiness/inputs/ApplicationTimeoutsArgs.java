...
public final class ApplicationTimeoutsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApplicationTimeoutsArgs Empty = new ApplicationTimeoutsArgs();
    ...
    private ApplicationTimeoutsArgs() {}

    private ApplicationTimeoutsArgs(ApplicationTimeoutsArgs $) {
        this.create = $.create;
        this.delete = $.delete;
        this.update = $.update;
    }
    ...
    public static Builder builder(ApplicationTimeoutsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ApplicationTimeoutsArgs();
        }

        public Builder(ApplicationTimeoutsArgs defaults) {
            $ = new ApplicationTimeoutsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApplicationTimeoutsArgs build() {
            return $;
        }
    }
