...
public final class HostedTransitVirtualInterfaceState extends com.pulumi.resources.ResourceArgs {
    ...
    private HostedTransitVirtualInterfaceState(HostedTransitVirtualInterfaceState $) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new HostedTransitVirtualInterfaceState();
        }

        public Builder(HostedTransitVirtualInterfaceState defaults) {
            $ = new HostedTransitVirtualInterfaceState(Objects.requireNonNull(defaults));
        }
