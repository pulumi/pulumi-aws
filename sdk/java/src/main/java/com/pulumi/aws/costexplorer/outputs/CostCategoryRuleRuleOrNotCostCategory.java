...
@CustomType
public final class CostCategoryRuleRuleOrNotCostCategory {
    /**
    ...
    public static Builder builder(CostCategoryRuleRuleOrNotCostCategory defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(CostCategoryRuleRuleOrNotCostCategory defaults) {
        ...
        public CostCategoryRuleRuleOrNotCostCategory build() {
            final var _resultValue = new CostCategoryRuleRuleOrNotCostCategory();
