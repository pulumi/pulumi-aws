...
public class ClientCertificate extends com.pulumi.resources.CustomResource {
     ...
     */
    public ClientCertificate(java.lang.String name, @Nullable ClientCertificateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ClientCertificate(java.lang.String name, @Nullable ClientCertificateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:apigateway/clientCertificate:ClientCertificate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private ClientCertificate(java.lang.String name, Output<java.lang.String> id, @Nullable ClientCertificateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("aws:apigateway/clientCertificate:ClientCertificate", name, state, makeResourceOptions(options, id), false);
    }
