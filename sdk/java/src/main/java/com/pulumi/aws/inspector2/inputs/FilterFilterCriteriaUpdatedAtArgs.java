...
public final class FilterFilterCriteriaUpdatedAtArgs extends com.pulumi.resources.ResourceArgs {

    public static final FilterFilterCriteriaUpdatedAtArgs Empty = new FilterFilterCriteriaUpdatedAtArgs();
    ...
    private FilterFilterCriteriaUpdatedAtArgs() {}

    private FilterFilterCriteriaUpdatedAtArgs(FilterFilterCriteriaUpdatedAtArgs $) {
    ...
    public static Builder builder(FilterFilterCriteriaUpdatedAtArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FilterFilterCriteriaUpdatedAtArgs();
        }

        public Builder(FilterFilterCriteriaUpdatedAtArgs defaults) {
            $ = new FilterFilterCriteriaUpdatedAtArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FilterFilterCriteriaUpdatedAtArgs build() {
            return $;
        }
    }
