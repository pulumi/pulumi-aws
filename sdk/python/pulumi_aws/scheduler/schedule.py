...
class ScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Brief description of the schedule.
        :param pulumi.Input[builtins.str] end_date: The date, in UTC, before which the schedule can invoke its target. Depending on the schedule's recurrence expression, invocations might stop on, or before, the end date you specify. EventBridge Scheduler ignores the end date for one-time schedules. Example: `2030-01-01T01:00:00Z`.
        :param pulumi.Input[builtins.str] group_name: Name of the schedule group to associate with this schedule. When omitted, the `default` schedule group is used.
...
class _ScheduleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the schedule.
        :param pulumi.Input[builtins.str] description: Brief description of the schedule.
        :param pulumi.Input[builtins.str] end_date: The date, in UTC, before which the schedule can invoke its target. Depending on the schedule's recurrence expression, invocations might stop on, or before, the end date you specify. EventBridge Scheduler ignores the end date for one-time schedules. Example: `2030-01-01T01:00:00Z`.
        :param pulumi.Input['ScheduleFlexibleTimeWindowArgs'] flexible_time_window: Configures a time window during which EventBridge Scheduler invokes the schedule. Detailed below.
        :param pulumi.Input[builtins.str] group_name: Name of the schedule group to associate with this schedule. When omitted, the `default` schedule group is used.
