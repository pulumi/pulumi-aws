...
if not MYPY:
    class ScheduleFlexibleTimeWindowArgsDict(TypedDict):
        ...
        """
        maximum_window_in_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ScheduleFlexibleTimeWindowArgs:
    def __init__(__self__, *,
                 mode: pulumi.Input[builtins.str],
                 maximum_window_in_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] mode: Determines whether the schedule is invoked within a flexible time window. One of: `OFF`, `FLEXIBLE`.
        :param pulumi.Input[builtins.int] maximum_window_in_minutes: Maximum time window during which a schedule can be invoked. Ranges from `1` to `1440` minutes.
        """
    ...
    def maximum_window_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Maximum time window during which a schedule can be invoked. Ranges from `1` to `1440` minutes.
        """
    ...
    def maximum_window_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ScheduleTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] arn: ARN of the target of this schedule, such as a SQS queue or ECS cluster. For universal targets, this is a [Service ARN specific to the target service](https://docs.aws.amazon.com/scheduler/latest/UserGuide/managing-targets-universal.html#supported-universal-targets).
        :param pulumi.Input[builtins.str] role_arn: ARN of the IAM role that EventBridge Scheduler will use for this target when the schedule is invoked. Read more in [Set up the execution role](https://docs.aws.amazon.com/scheduler/latest/UserGuide/setting-up.html#setting-up-execution-role).
        ...
        :param pulumi.Input[builtins.str] input: Text, or well-formed JSON, passed to the target. Read more in [Universal target](https://docs.aws.amazon.com/scheduler/latest/UserGuide/managing-targets-universal.html).
...
class ScheduleTargetDeadLetterConfigArgs:
    def __init__(__self__, *,
                 arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] arn: ARN of the SQS queue specified as the destination for the dead-letter queue.
        """
        pulumi.set(__self__, "arn", arn)
...
class ScheduleTargetEcsParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] task_definition_arn: ARN of the task definition to use.
        ...
        :param pulumi.Input[builtins.bool] enable_ecs_managed_tags: Specifies whether to enable Amazon ECS managed tags for the task. For more information, see [Tagging Your Amazon ECS Resources](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/ecs-using-tags.html) in the Amazon ECS Developer Guide.
        :param pulumi.Input[builtins.bool] enable_execute_command: Specifies whether to enable the execute command functionality for the containers in this task.
        :param pulumi.Input[builtins.str] group: Specifies an ECS task group for the task. At most 255 characters.
        :param pulumi.Input[builtins.str] launch_type: Specifies the launch type on which your task is running. The launch type that you specify here must match one of the launch type (compatibilities) of the target task. One of: `EC2`, `FARGATE`, `EXTERNAL`.
        ...
        :param pulumi.Input[builtins.str] platform_version: Specifies the platform version for the task. Specify only the numeric portion of the platform version, such as `1.1.0`.
        :param pulumi.Input[builtins.str] propagate_tags: Specifies whether to propagate the tags from the task definition to the task. One of: `TASK_DEFINITION`.
        :param pulumi.Input[builtins.str] reference_id: Reference ID to use for the task.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The metadata that you apply to the task. Each tag consists of a key and an optional value. For more information, see [`RunTask`](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_RunTask.html) in the Amazon ECS API Reference.
        :param pulumi.Input[builtins.int] task_count: The number of tasks to create. Ranges from `1` (default) to `10`.
        """
...
class ScheduleTargetEcsParametersCapacityProviderStrategyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] base: How many tasks, at a minimum, to run on the specified capacity provider. Only one capacity provider in a capacity provider strategy can have a base defined. Ranges from `0` (default) to `100000`.
        :param pulumi.Input[builtins.int] weight: Designates the relative percentage of the total number of tasks launched that should use the specified capacity provider. The weight value is taken into consideration after the base value, if defined, is satisfied. Ranges from from `0` to `1000`.
        """
...
class ScheduleTargetEcsParametersNetworkConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: Set of 1 to 16 subnets to be associated with the task. These subnets must all be in the same VPC.
        :param pulumi.Input[builtins.bool] assign_public_ip: Specifies whether the task's elastic network interface receives a public IP address. This attribute is a boolean type, where `true` maps to `ENABLED` and `false` to `DISABLED`. You can specify `true` only when the `launch_type` is set to `FARGATE`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: Set of 1 to 5 Security Group ID-s to be associated with the task. These security groups must all be in the same VPC.
        """
...
class ScheduleTargetEcsParametersPlacementConstraintArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of constraint. One of: `distinctInstance`, `memberOf`.
...
class ScheduleTargetEcsParametersPlacementStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of placement strategy. One of: `random`, `spread`, `binpack`.
        :param pulumi.Input[builtins.str] field: The field to apply the placement strategy against.
        """
        pulumi.set(__self__, "type", type)
...
class ScheduleTargetEventbridgeParametersArgs:
    def __init__(__self__, *,
                 ...
                 source: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] detail_type: Free-form string used to decide what fields to expect in the event detail. Up to 128 characters.
        :param pulumi.Input[builtins.str] source: Source of the event.
        """
...
class ScheduleTargetKinesisParametersArgs:
    def __init__(__self__, *,
                 partition_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] partition_key: Specifies the shard to which EventBridge Scheduler sends the event. Up to 256 characters.
        """
...
class ScheduleTargetRetryPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] maximum_event_age_in_seconds: Maximum amount of time, in seconds, to continue to make retry attempts. Ranges from `60` to `86400` (default).
        :param pulumi.Input[builtins.int] maximum_retry_attempts: Maximum number of retry attempts to make before the request fails. Ranges from `0` to `185` (default).
        """
...
class ScheduleTargetSqsParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] message_group_id: FIFO message group ID to use as the target.
        """
