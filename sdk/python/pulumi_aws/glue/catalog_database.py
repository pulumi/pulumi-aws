...
class CatalogDatabaseArgs:
    def __init__(__self__, *,
        ...
        """
        CatalogDatabaseArgs._configure(
...
class _CatalogDatabaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CatalogDatabaseTargetDatabaseArgs'] target_database: Configuration block for a target database for resource linking. See `target_database` below.
        """
        _CatalogDatabaseState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            arn=arn,
            catalog_id=catalog_id,
            create_table_default_permissions=create_table_default_permissions,
...
class CatalogDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CatalogDatabaseArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if target_database is not None and not isinstance(target_database, CatalogDatabaseTargetDatabaseArgs):
                target_database = target_database or {}
                def _setter(key, value):
                    target_database[key] = value
                CatalogDatabaseTargetDatabaseArgs._configure(_setter, **target_database)
