...
class CatalogTableArgs:
    def __init__(__self__, *,
                 ...
                 view_expanded_text: Optional[pulumi.Input[builtins.str]] = None,
                 view_original_text: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] owner: Owner of the table.
        ...
        :param pulumi.Input[builtins.str] view_expanded_text: If the table is a view, the expanded text of the view; otherwise null.
        :param pulumi.Input[builtins.str] view_original_text: If the table is a view, the original text of the view; otherwise null.
        """
    ...
    def view_expanded_text(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def view_expanded_text(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "view_expanded_text", value)

    @property
    @pulumi.getter(name="viewOriginalText")
    def view_original_text(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def view_original_text(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CatalogTableState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the Glue Table.
        :param pulumi.Input[builtins.str] catalog_id: ID of the Glue Catalog and database to create the table in. If omitted, this defaults to the AWS Account ID plus the database name.
        :param pulumi.Input[builtins.str] database_name: Name of the metadata database where the table metadata resides. For Hive compatibility, this must be all lowercase.
...
class CatalogTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_table: Optional[pulumi.Input[Union['CatalogTableTargetTableArgs', 'CatalogTableTargetTableArgsDict']]] = None,
            view_expanded_text: Optional[pulumi.Input[builtins.str]] = None,
            view_original_text: Optional[pulumi.Input[builtins.str]] = None) -> 'CatalogTable':
        """
    ...
    @property
    @pulumi.getter
    def retention(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Retention time for this table.
        """
        return pulumi.get(self, "retention")
    ...
    @property
    @pulumi.getter(name="tableType")
    def table_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of this table (EXTERNAL_TABLE, VIRTUAL_VIEW, etc.). While optional, some Athena DDL queries such as `ALTER TABLE` and `SHOW CREATE TABLE` will fail if this argument is empty.
        """
        return pulumi.get(self, "table_type")
    ...
    @property
    @pulumi.getter(name="viewExpandedText")
    def view_expanded_text(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If the table is a view, the expanded text of the view; otherwise null.
        """
        return pulumi.get(self, "view_expanded_text")
    ...
    @property
    @pulumi.getter(name="viewOriginalText")
    def view_original_text(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If the table is a view, the original text of the view; otherwise null.
        """
        return pulumi.get(self, "view_original_text")
