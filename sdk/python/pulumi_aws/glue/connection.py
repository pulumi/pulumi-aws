...
class ConnectionArgs:
    ...
    def match_criterias(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def match_criterias(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Connection(pulumi.CustomResource):
    ...
    pulumi_type = "aws:glue/connection:Connection"
    ...
    @property
    @pulumi.getter(name="connectionProperties")
    def connection_properties(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Map of key-value pairs used as parameters for this connection. For more information, see the [AWS Documentation](https://docs.aws.amazon.com/glue/latest/dg/connection-properties.html).
    ...
    @property
    @pulumi.getter(name="matchCriterias")
    def match_criterias(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of criteria that can be used in selecting this connection.
        """
        return pulumi.get(self, "match_criterias")
