...
class CatalogDatabaseCreateTableDefaultPermissionPrincipal(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str data_lake_principal_identifier: An identifier for the Lake Formation principal.
        """
...
class CatalogDatabaseFederatedDatabase(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connection_name: Name of the connection to the external metastore.
        :param builtins.str identifier: Unique identifier for the federated database.
        """
...
class CatalogDatabaseTargetDatabase(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str catalog_id: ID of the Data Catalog in which the database resides.
        :param builtins.str database_name: Name of the catalog database.
...
class CatalogTableOpenTableFormatInputIcebergInput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str metadata_operation: A required metadata operation. Can only be set to CREATE.
        :param builtins.str version: The table version for the Iceberg table. Defaults to 2.
        """
...
class CatalogTableOptimizerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Indicates whether the table optimizer is enabled.
        :param builtins.str role_arn: The ARN of the IAM role to use for the table optimizer.
...
class CatalogTableOptimizerConfigurationOrphanFileDeletionConfigurationIcebergConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 orphan_file_retention_period_in_days: Optional[builtins.int] = None):
        """
        :param builtins.str location: Specifies a directory in which to look for files. You may choose a sub-directory rather than the top-level table location. Defaults to the table's location.
        :param builtins.int orphan_file_retention_period_in_days: The number of days that orphan files should be retained before file deletion. Defaults to `3`.
        """
    ...
    def orphan_file_retention_period_in_days(self) -> Optional[builtins.int]:
        """
...
class CatalogTableOptimizerConfigurationRetentionConfigurationIcebergConfiguration(dict):
    ...
    def __init__(__self__, *,
                 clean_expired_files: Optional[builtins.bool] = None,
                 number_of_snapshots_to_retain: Optional[builtins.int] = None,
                 snapshot_retention_period_in_days: Optional[builtins.int] = None):
        """
        :param builtins.bool clean_expired_files: If set to `false`, snapshots are only deleted from table metadata, and the underlying data and metadata files are not deleted. Defaults to `false`.
        :param builtins.int number_of_snapshots_to_retain: The number of Iceberg snapshots to retain within the retention period. Defaults to `1` or the corresponding Iceberg table configuration field if it exists.
        :param builtins.int snapshot_retention_period_in_days: The number of days to retain the Iceberg snapshots. Defaults to `5`, or the corresponding Iceberg table configuration field if it exists.
        """
    ...
    def clean_expired_files(self) -> Optional[builtins.bool]:
        """
    ...
    def number_of_snapshots_to_retain(self) -> Optional[builtins.int]:
        """
    ...
    def snapshot_retention_period_in_days(self) -> Optional[builtins.int]:
        """
...
class CatalogTablePartitionIndex(dict):
    ...
    def __init__(__self__, *,
                 ...
                 index_status: Optional[builtins.str] = None):
        """
        :param builtins.str index_name: Name of the partition index.
        :param Sequence[builtins.str] keys: Keys for the partition index.
        """
    ...
    def index_status(self) -> Optional[builtins.str]:
...
class CatalogTablePartitionKey(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the Partition Key.
        :param builtins.str comment: Free-form text comment.
        :param builtins.str type: Datatype of data in the Partition Key.
        """
...
class CatalogTableStorageDescriptor(dict):
    ...
    def __init__(__self__, *,
                 additional_locations: Optional[Sequence[builtins.str]] = None,
                 bucket_columns: Optional[Sequence[builtins.str]] = None,
                 columns: Optional[Sequence['outputs.CatalogTableStorageDescriptorColumn']] = None,
                 compressed: Optional[builtins.bool] = None,
                 input_format: Optional[builtins.str] = None,
                 location: Optional[builtins.str] = None,
                 number_of_buckets: Optional[builtins.int] = None,
                 ...
                 stored_as_sub_directories: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] additional_locations: List of locations that point to the path where a Delta table is located.
        :param Sequence[builtins.str] bucket_columns: List of reducer grouping columns, clustering columns, and bucketing columns in the table.
        ...
        :param builtins.bool compressed: Whether the data in the table is compressed.
        :param builtins.str input_format: Input format: SequenceFileInputFormat (binary), or TextInputFormat, or a custom format.
        :param builtins.str location: Physical location of the table. By default this takes the form of the warehouse location, followed by the database location in the warehouse, followed by the table name.
        :param builtins.int number_of_buckets: Must be specified if the table contains any dimension columns.
        :param builtins.str output_format: Output format: SequenceFileOutputFormat (binary), or IgnoreKeyTextOutputFormat, or a custom format.
        :param Mapping[str, builtins.str] parameters: User-supplied properties in key-value form.
        ...
        :param builtins.bool stored_as_sub_directories: Whether the table data is stored in subdirectories.
        """
    ...
    def additional_locations(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def bucket_columns(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter
    def compressed(self) -> Optional[builtins.bool]:
        """
    ...
    def number_of_buckets(self) -> Optional[builtins.int]:
        """
    ...
    def stored_as_sub_directories(self) -> Optional[builtins.bool]:
        """
...
class CatalogTableStorageDescriptorColumn(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str comment: Free-form text comment.
        :param Mapping[str, builtins.str] parameters: Key-value pairs defining properties associated with the column.
        :param builtins.str type: Datatype of data in the Column.
        """
        pulumi.set(__self__, "name", name)
        if comment is not None:
            pulumi.set(__self__, "comment", comment)
...
class CatalogTableStorageDescriptorSchemaReference(dict):
    ...
    def __init__(__self__, *,
                 schema_version_number: builtins.int,
                 schema_id: Optional['outputs.CatalogTableStorageDescriptorSchemaReferenceSchemaId'] = None,
                 schema_version_id: Optional[builtins.str] = None):
        """
        :param builtins.int schema_version_number: Version number of the schema.
        ...
        :param builtins.str schema_version_id: Unique ID assigned to a version of the schema. Either this or the `schema_id` has to be provided.
        """
    ...
    def schema_version_number(self) -> builtins.int:
        """
    ...
    def schema_version_id(self) -> Optional[builtins.str]:
        """
...
class CatalogTableStorageDescriptorSchemaReferenceSchemaId(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str registry_name: Name of the schema registry that contains the schema. Must be provided when `schema_name` is specified and conflicts with `schema_arn`.
        :param builtins.str schema_arn: ARN of the schema. One of `schema_arn` or `schema_name` has to be provided.
        :param builtins.str schema_name: Name of the schema. One of `schema_arn` or `schema_name` has to be provided.
        """
...
class CatalogTableStorageDescriptorSerDeInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 parameters: Optional[Mapping[str, builtins.str]] = None,
                 serialization_library: Optional[builtins.str] = None):
        """
        :param builtins.str name: Name of the SerDe.
        :param Mapping[str, builtins.str] parameters: Map of initialization parameters for the SerDe, in key-value form.
        :param builtins.str serialization_library: Usually the class that implements the SerDe. An example is `org.apache.hadoop.hive.serde2.columnar.ColumnarSerDe`.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if parameters is not None:
    ...
    def serialization_library(self) -> Optional[builtins.str]:
        """
...
class CatalogTableStorageDescriptorSkewedInfo(dict):
    ...
    def __init__(__self__, *,
                 skewed_column_names: Optional[Sequence[builtins.str]] = None,
                 skewed_column_value_location_maps: Optional[Mapping[str, builtins.str]] = None,
                 skewed_column_values: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] skewed_column_names: List of names of columns that contain skewed values.
        :param Mapping[str, builtins.str] skewed_column_value_location_maps: List of values that appear so frequently as to be considered skewed.
        :param Sequence[builtins.str] skewed_column_values: Map of skewed values to the columns that contain them.
        """
    ...
    def skewed_column_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def skewed_column_value_location_maps(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def skewed_column_values(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CatalogTableStorageDescriptorSortColumn(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str column: Name of the column.
        :param builtins.int sort_order: Whether the column is sorted in ascending (`1`) or descending order (`0`).
        """
...
class CatalogTableTargetTable(dict):
    ...
    def __init__(__self__, *,
                 ...
                 region: Optional[builtins.str] = None):
        """
        :param builtins.str catalog_id: ID of the Data Catalog in which the table resides.
        :param builtins.str database_name: Name of the catalog database that contains the target table.
        :param builtins.str name: Name of the target table.
...
class ClassifierCsvClassifier(dict):
    ...
    def __init__(__self__, *,
                 allow_single_column: Optional[builtins.bool] = None,
                 contains_header: Optional[builtins.str] = None,
                 custom_datatype_configured: Optional[builtins.bool] = None,
                 custom_datatypes: Optional[Sequence[builtins.str]] = None,
                 delimiter: Optional[builtins.str] = None,
                 disable_value_trimming: Optional[builtins.bool] = None,
                 headers: Optional[Sequence[builtins.str]] = None,
                 quote_symbol: Optional[builtins.str] = None,
                 serde: Optional[builtins.str] = None):
        """
        :param builtins.bool allow_single_column: Enables the processing of files that contain only one column.
        :param builtins.str contains_header: Indicates whether the CSV file contains a header. This can be one of "ABSENT", "PRESENT", or "UNKNOWN".
        :param builtins.bool custom_datatype_configured: Enables the custom datatype to be configured.
        :param Sequence[builtins.str] custom_datatypes: A list of supported custom datatypes. Valid values are `BINARY`, `BOOLEAN`, `DATE`, `DECIMAL`, `DOUBLE`, `FLOAT`, `INT`, `LONG`, `SHORT`, `STRING`, `TIMESTAMP`.
        :param builtins.str delimiter: The delimiter used in the CSV to separate columns.
        :param builtins.bool disable_value_trimming: Specifies whether to trim column values.
        :param Sequence[builtins.str] headers: A list of strings representing column names.
        :param builtins.str quote_symbol: A custom symbol to denote what combines content into a single column value. It must be different from the column delimiter.
        :param builtins.str serde: The SerDe for processing CSV. Valid values are `OpenCSVSerDe`, `LazySimpleSerDe`, `None`.
        """
    ...
    def allow_single_column(self) -> Optional[builtins.bool]:
        """
    ...
    def contains_header(self) -> Optional[builtins.str]:
        """
    ...
    def custom_datatype_configured(self) -> Optional[builtins.bool]:
        """
    ...
    def custom_datatypes(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def disable_value_trimming(self) -> Optional[builtins.bool]:
        """
    ...
    def quote_symbol(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def serde(self) -> Optional[builtins.str]:
        """
...
class ClassifierGrokClassifier(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_patterns: Optional[builtins.str] = None):
        """
        :param builtins.str classification: An identifier of the data format that the classifier matches, such as Twitter, JSON, Omniture logs, Amazon CloudWatch Logs, and so on.
        :param builtins.str grok_pattern: The grok pattern used by this classifier.
        :param builtins.str custom_patterns: Custom grok patterns used by this classifier.
        """
    ...
    def custom_patterns(self) -> Optional[builtins.str]:
        """
...
class ClassifierJsonClassifier(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str json_path: A `JsonPath` string defining the JSON data for the classifier to classify. AWS Glue supports a subset of `JsonPath`, as described in [Writing JsonPath Custom Classifiers](https://docs.aws.amazon.com/glue/latest/dg/custom-classifier.html#custom-classifier-json).
        """
...
class ClassifierXmlClassifier(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str classification: An identifier of the data format that the classifier matches.
        :param builtins.str row_tag: The XML tag designating the element that contains each record in an XML document being parsed. Note that this cannot identify a self-closing element (closed by `/>`). An empty row element that contains only attributes can be parsed as long as it ends with a closing tag (for example, `<row item_a="A" item_b="B"></row>` is okay, but `<row item_a="A" item_b="B" />` is not).
        """
        pulumi.set(__self__, "classification", classification)
...
class ConnectionPhysicalConnectionRequirements(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str availability_zone: The availability zone of the connection. This field is redundant and implied by `subnet_id`, but is currently an api requirement.
        :param Sequence[builtins.str] security_group_id_lists: The security group ID list used by the connection.
        :param builtins.str subnet_id: The subnet ID used by the connection.
        """
...
class CrawlerCatalogTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str database_name: The name of the Glue database to be synchronized.
        :param Sequence[builtins.str] tables: A list of catalog tables to be synchronized.
        ...
        :param builtins.str dlq_event_queue_arn: A valid Amazon SQS ARN.
               
               > **Note:** `deletion_behavior` of catalog target doesn't support `DEPRECATE_IN_DATABASE`.
               
               > **Note:** `configuration` for catalog target crawlers will have `{ ... "Grouping": { "TableGroupingPolicy": "CombineCompatibleSchemas"} }` by default.
        :param builtins.str event_queue_arn: A valid Amazon SQS ARN.
        """
        pulumi.set(__self__, "database_name", database_name)
...
class CrawlerDeltaTarget(dict):
    ...
    def __init__(__self__, *,
                 delta_tables: Sequence[builtins.str],
                 write_manifest: builtins.bool,
                 connection_name: Optional[builtins.str] = None,
    ...
    def delta_tables(self) -> Sequence[builtins.str]:
        """
    ...
    def write_manifest(self) -> builtins.bool:
        """
...
class CrawlerDynamodbTarget(dict):
    ...
    def __init__(__self__, *,
                 path: builtins.str,
                 scan_all: Optional[builtins.bool] = None,
                 scan_rate: Optional[builtins.float] = None):
        """
        :param builtins.str path: The name of the DynamoDB table to crawl.
        :param builtins.bool scan_all: Indicates whether to scan all the records, or to sample rows from the table. Scanning all the records can take a long time when the table is not a high throughput table.  defaults to `true`.
        :param builtins.float scan_rate: The percentage of the configured read capacity units to use by the AWS Glue crawler. The valid values are null or a value between 0.1 to 1.5.
        """
    ...
    def scan_all(self) -> Optional[builtins.bool]:
        """
    ...
    def scan_rate(self) -> Optional[builtins.float]:
        """
...
class CrawlerHudiTarget(dict):
    ...
    def __init__(__self__, *,
                 maximum_traversal_depth: builtins.int,
                 paths: Sequence[builtins.str],
                 connection_name: Optional[builtins.str] = None,
                 exclusions: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.int maximum_traversal_depth: The maximum depth of Amazon S3 paths that the crawler can traverse to discover the Hudi metadata folder in your Amazon S3 path. Used to limit the crawler run time. Valid values are between `1` and `20`.
    ...
    def maximum_traversal_depth(self) -> builtins.int:
        """
...
class CrawlerIcebergTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exclusions: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.int maximum_traversal_depth: The maximum depth of Amazon S3 paths that the crawler can traverse to discover the Iceberg metadata folder in your Amazon S3 path. Used to limit the crawler run time. Valid values are between `1` and `20`.
...
class CrawlerJdbcTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 path: builtins.str,
                 enable_additional_metadatas: Optional[Sequence[builtins.str]] = None,
                 exclusions: Optional[Sequence[builtins.str]] = None):
        """
        ...
        :param Sequence[builtins.str] enable_additional_metadatas: Specify a value of `RAWTYPES` or `COMMENTS` to enable additional metadata intable responses. `RAWTYPES` provides the native-level datatype. `COMMENTS` provides comments associated with a column or table in the database.
        :param Sequence[builtins.str] exclusions: A list of glob patterns used to exclude from the crawl.
        """
        pulumi.set(__self__, "connection_name", connection_name)
        pulumi.set(__self__, "path", path)
    ...
    def enable_additional_metadatas(self) -> Optional[Sequence[builtins.str]]:
        """
...
class CrawlerLakeFormationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_id: Required for cross account crawls. For same account crawls as the target data, this can omitted.
        :param builtins.bool use_lake_formation_credentials: Specifies whether to use Lake Formation credentials for the crawler instead of the IAM role credentials.
        """
...
class CrawlerLineageConfiguration(dict):
    ...
    def __init__(__self__, *,
                 crawler_lineage_settings: Optional[builtins.str] = None):
        """
        :param builtins.str crawler_lineage_settings: Specifies whether data lineage is enabled for the crawler. Valid values are: `ENABLE` and `DISABLE`. Default value is `DISABLE`.
        """
    ...
    def crawler_lineage_settings(self) -> Optional[builtins.str]:
        """
...
class CrawlerMongodbTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool scan_all: Indicates whether to scan all the records, or to sample rows from the table. Scanning all the records can take a long time when the table is not a high throughput table. Default value is `true`.
        """
        pulumi.set(__self__, "connection_name", connection_name)
        pulumi.set(__self__, "path", path)
        if scan_all is not None:
...
class CrawlerS3Target(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str connection_name: The name of a connection which allows crawler to access data in S3 within a VPC.
        :param builtins.str dlq_event_queue_arn: The ARN of the dead-letter SQS queue.
        :param builtins.str event_queue_arn: The ARN of the SQS queue to receive S3 notifications from.
        :param Sequence[builtins.str] exclusions: A list of glob patterns used to exclude from the crawl.
...
class CrawlerSchemaChangePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str delete_behavior: The deletion behavior when the crawler finds a deleted object. Valid values: `LOG`, `DELETE_FROM_DATABASE`, or `DEPRECATE_IN_DATABASE`. Defaults to `DEPRECATE_IN_DATABASE`.
        :param builtins.str update_behavior: The update behavior when the crawler finds a changed schema. Valid values: `LOG` or `UPDATE_IN_DATABASE`. Defaults to `UPDATE_IN_DATABASE`.
        """
...
class DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsConnectionPasswordEncryption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 aws_kms_key_id: Optional[builtins.str] = None):
        """
        :param builtins.bool return_connection_password_encrypted: When set to `true`, passwords remain encrypted in the responses of GetConnection and GetConnections. This encryption takes effect independently of the catalog encryption.
        :param builtins.str aws_kms_key_id: A KMS key ARN that is used to encrypt the connection password. If connection password protection is enabled, the caller of CreateConnection and UpdateConnection needs at least `kms:Encrypt` permission on the specified AWS KMS key, to encrypt passwords before storing them in the Data Catalog.
        """
    ...
    def return_connection_password_encrypted(self) -> builtins.bool:
        """
    ...
    def aws_kms_key_id(self) -> Optional[builtins.str]:
        """
...
class DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 catalog_encryption_service_role: Optional[builtins.str] = None,
                 sse_aws_kms_key_id: Optional[builtins.str] = None):
        """
        :param builtins.str catalog_encryption_mode: The encryption-at-rest mode for encrypting Data Catalog data. Valid values: `DISABLED`, `SSE-KMS`, `SSE-KMS-WITH-SERVICE-ROLE`.
        :param builtins.str catalog_encryption_service_role: The ARN of the AWS IAM role used for accessing encrypted Data Catalog data.
        :param builtins.str sse_aws_kms_key_id: The ARN of the AWS KMS key to use for encryption at rest.
        """
    ...
    def catalog_encryption_service_role(self) -> Optional[builtins.str]:
        """
    ...
    def sse_aws_kms_key_id(self) -> Optional[builtins.str]:
        """
...
class DataQualityRulesetTargetTable(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str database_name: Name of the database where the AWS Glue table exists.
        :param builtins.str table_name: Name of the AWS Glue table.
        :param builtins.str catalog_id: The catalog id where the AWS Glue table exists.
        """
        pulumi.set(__self__, "database_name", database_name)
...
class JobCommand(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str script_location: Specifies the S3 path to a script that executes a job.
        :param builtins.str name: The name of the job command. Defaults to `glueetl`. Use `pythonshell` for Python Shell Job Type, `glueray` for Ray Job Type, or `gluestreaming` for Streaming Job Type. `max_capacity` needs to be set if `pythonshell` is chosen.
        :param builtins.str python_version: The Python version being used to execute a Python shell job. Allowed values are 2, 3 or 3.9. Version 3 refers to Python 3.11 when `glue_version` is set to 5.0.
        :param builtins.str runtime: In Ray jobs, runtime is used to specify the versions of Ray, Python and additional libraries available in your environment. This field is not used in other job types. For supported runtime environment values, see [Working with Ray jobs](https://docs.aws.amazon.com/glue/latest/dg/ray-jobs-section.html#author-job-ray-runtimes) in the Glue Developer Guide.
        """
...
class JobExecutionProperty(dict):
    ...
    def __init__(__self__, *,
                 max_concurrent_runs: Optional[builtins.int] = None):
        """
        :param builtins.int max_concurrent_runs: The maximum number of concurrent runs allowed for a job. The default is 1.
        """
    ...
    def max_concurrent_runs(self) -> Optional[builtins.int]:
        """
...
class JobSourceControlDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str auth_strategy: The type of authentication, which can be an authentication token stored in Amazon Web Services Secrets Manager, or a personal access token. Valid values are: `PERSONAL_ACCESS_TOKEN` and `AWS_SECRETS_MANAGER`.
        :param builtins.str auth_token: The value of an authorization token.
        :param builtins.str branch: A branch in the remote repository.
        :param builtins.str folder: A folder in the remote repository.
        :param builtins.str last_commit_id: The last commit ID for a commit in the remote repository.
        :param builtins.str owner: The owner of the remote repository that contains the job artifacts.
        :param builtins.str provider: The provider for the remote repository. Valid values are: `GITHUB`, `GITLAB`, `BITBUCKET`, and `AWS_CODE_COMMIT`.
        :param builtins.str repository: The name of the remote repository that contains the job artifacts.
        """
...
class MLTransformInputRecordTable(dict):
    ...
    def __init__(__self__, *,
                 ...
                 connection_name: Optional[builtins.str] = None):
        """
        :param builtins.str database_name: A database name in the AWS Glue Data Catalog.
        :param builtins.str table_name: A table name in the AWS Glue Data Catalog.
        :param builtins.str catalog_id: A unique identifier for the AWS Glue Data Catalog.
        :param builtins.str connection_name: The name of the connection to the AWS Glue Data Catalog.
        """
        pulumi.set(__self__, "database_name", database_name)
        pulumi.set(__self__, "table_name", table_name)
        if catalog_id is not None:
...
class MLTransformParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str transform_type: The type of machine learning transform. For information about the types of machine learning transforms, see [Creating Machine Learning Transforms](http://docs.aws.amazon.com/glue/latest/dg/add-job-machine-learning-transform.html).
        """
...
class MLTransformParametersFindMatchesParameters(dict):
    ...
    def __init__(__self__, *,
                 accuracy_cost_trade_off: Optional[builtins.float] = None,
                 enforce_provided_labels: Optional[builtins.bool] = None,
                 precision_recall_trade_off: Optional[builtins.float] = None,
                 primary_key_column_name: Optional[builtins.str] = None):
        """
        :param builtins.float accuracy_cost_trade_off: The value that is selected when tuning your transform for a balance between accuracy and cost.
        :param builtins.bool enforce_provided_labels: The value to switch on or off to force the output to match the provided labels from users.
        :param builtins.float precision_recall_trade_off: The value selected when tuning your transform for a balance between precision and recall.
        :param builtins.str primary_key_column_name: The name of a column that uniquely identifies rows in the source table.
        """
    ...
    def accuracy_cost_trade_off(self) -> Optional[builtins.float]:
        """
    ...
    def enforce_provided_labels(self) -> Optional[builtins.bool]:
        """
    ...
    def precision_recall_trade_off(self) -> Optional[builtins.float]:
        """
    ...
    def primary_key_column_name(self) -> Optional[builtins.str]:
        """
...
class MLTransformSchema(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str data_type: The type of data in the column.
        :param builtins.str name: The name you assign to this ML Transform. It must be unique in your account.
        """
...
class PartitionStorageDescriptor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] additional_locations: List of locations that point to the path where a Delta table is located.
        :param Sequence[builtins.str] bucket_columns: A list of reducer grouping columns, clustering columns, and bucketing columns in the table.
        :param Sequence['PartitionStorageDescriptorColumnArgs'] columns: A list of the Columns in the table.
        :param builtins.bool compressed: True if the data in the table is compressed, or False if not.
        :param builtins.str input_format: The input format: SequenceFileInputFormat (binary), or TextInputFormat, or a custom format.
        :param builtins.str location: The physical location of the table. By default this takes the form of the warehouse location, followed by the database location in the warehouse, followed by the table name.
        :param builtins.int number_of_buckets: Must be specified if the table contains any dimension columns.
        :param builtins.str output_format: The output format: SequenceFileOutputFormat (binary), or IgnoreKeyTextOutputFormat, or a custom format.
        :param Mapping[str, builtins.str] parameters: User-supplied properties in key-value form.
        ...
        :param builtins.bool stored_as_sub_directories: True if the table data is stored in subdirectories, or False if not.
        """
        if additional_locations is not None:
            pulumi.set(__self__, "additional_locations", additional_locations)
        if bucket_columns is not None:
...
class PartitionStorageDescriptorColumn(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str comment: Free-form text comment.
        :param builtins.str type: The datatype of data in the Column.
        """
        pulumi.set(__self__, "name", name)
        if comment is not None:
            pulumi.set(__self__, "comment", comment)
...
class PartitionStorageDescriptorSerDeInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the SerDe.
        :param Mapping[str, builtins.str] parameters: A map of initialization parameters for the SerDe, in key-value form.
        :param builtins.str serialization_library: Usually the class that implements the SerDe. An example is: org.apache.hadoop.hive.serde2.columnar.ColumnarSerDe.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class PartitionStorageDescriptorSkewedInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 skewed_column_values: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] skewed_column_names: A list of names of columns that contain skewed values.
        :param Mapping[str, builtins.str] skewed_column_value_location_maps: A list of values that appear so frequently as to be considered skewed.
        :param Sequence[builtins.str] skewed_column_values: A map of skewed values to the columns that contain them.
        """
        if skewed_column_names is not None:
            pulumi.set(__self__, "skewed_column_names", skewed_column_names)
        if skewed_column_value_location_maps is not None:
...
class PartitionStorageDescriptorSortColumn(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sort_order: builtins.int):
        """
        :param builtins.str column: The name of the column.
        :param builtins.int sort_order: Indicates that the column is sorted in ascending order (== 1), or in descending order (==0).
        """
        pulumi.set(__self__, "column", column)
        pulumi.set(__self__, "sort_order", sort_order)
...
class SecurityConfigurationEncryptionConfigurationCloudwatchEncryption(dict):
    ...
    def __init__(__self__, *,
                 cloudwatch_encryption_mode: Optional[builtins.str] = None,
                 kms_key_arn: Optional[builtins.str] = None):
        """
        :param builtins.str cloudwatch_encryption_mode: Encryption mode to use for CloudWatch data. Valid values: `DISABLED`, `SSE-KMS`. Default value: `DISABLED`.
    ...
    def cloudwatch_encryption_mode(self) -> Optional[builtins.str]:
        """
...
class SecurityConfigurationEncryptionConfigurationJobBookmarksEncryption(dict):
    ...
    def __init__(__self__, *,
                 job_bookmarks_encryption_mode: Optional[builtins.str] = None,
                 kms_key_arn: Optional[builtins.str] = None):
        """
        :param builtins.str job_bookmarks_encryption_mode: Encryption mode to use for job bookmarks data. Valid values: `CSE-KMS`, `DISABLED`. Default value: `DISABLED`.
        :param builtins.str kms_key_arn: Amazon Resource Name (ARN) of the KMS key to be used to encrypt the data.
        """
    ...
    def job_bookmarks_encryption_mode(self) -> Optional[builtins.str]:
        """
...
class SecurityConfigurationEncryptionConfigurationS3Encryption(dict):
    ...
    def __init__(__self__, *,
                 kms_key_arn: Optional[builtins.str] = None,
                 s3_encryption_mode: Optional[builtins.str] = None):
        """
        :param builtins.str kms_key_arn: Amazon Resource Name (ARN) of the KMS key to be used to encrypt the data.
        :param builtins.str s3_encryption_mode: Encryption mode to use for S3 data. Valid values: `DISABLED`, `SSE-KMS`, `SSE-S3`. Default value: `DISABLED`.
        """
        if kms_key_arn is not None:
            pulumi.set(__self__, "kms_key_arn", kms_key_arn)
    ...
    def s3_encryption_mode(self) -> Optional[builtins.str]:
        """
...
class TriggerAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] arguments: Arguments to be passed to the job. You can specify arguments here that your own job-execution script consumes, as well as arguments that AWS Glue itself consumes.
        :param builtins.str crawler_name: The name of the crawler to be executed. Conflicts with `job_name`.
        :param builtins.str job_name: The name of a job to be executed. Conflicts with `crawler_name`.
        ...
        :param builtins.str security_configuration: The name of the Security Configuration structure to be used with this action.
        :param builtins.int timeout: The job run timeout in minutes. It overrides the timeout value of the job.
        """
...
class TriggerEventBatchingCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int batch_window: Window of time in seconds after which EventBridge event trigger fires. Window starts when first event is received. Default value is `900`.
        """
...
class TriggerPredicate(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str logical: How to handle multiple conditions. Defaults to `AND`. Valid values are `AND` or `ANY`.
        """
...
class TriggerPredicateCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str crawl_state: The condition crawl state. Currently, the values supported are `RUNNING`, `SUCCEEDED`, `CANCELLED`, and `FAILED`. If this is specified, `crawler_name` must also be specified. Conflicts with `state`.
        :param builtins.str crawler_name: The name of the crawler to watch. If this is specified, `crawl_state` must also be specified. Conflicts with `job_name`.
        :param builtins.str job_name: The name of the job to watch. If this is specified, `state` must also be specified. Conflicts with `crawler_name`.
        :param builtins.str logical_operator: A logical operator. Defaults to `EQUALS`.
        :param builtins.str state: The condition job state. Currently, the values supported are `SUCCEEDED`, `STOPPED`, `TIMEOUT` and `FAILED`. If this is specified, `job_name` must also be specified. Conflicts with `crawler_state`.
        """
...
class UserDefinedFunctionResourceUri(dict):
    ...
    def __init__(__self__, *,
                 ...
                 uri: builtins.str):
        """
        :param builtins.str resource_type: The type of the resource. can be one of `JAR`, `FILE`, and `ARCHIVE`.
        :param builtins.str uri: The URI for accessing the resource.
        """
...
class GetCatalogTableStorageDescriptorResult(dict):
    def __init__(__self__, *,
                 additional_locations: Sequence[builtins.str],
                 bucket_columns: Sequence[builtins.str],
        ...
        :param builtins.str input_format: Input format: SequenceFileInputFormat (binary), or TextInputFormat, or a custom format.
        :param builtins.str location: Physical location of the table. By default, this takes the form of the warehouse location, followed by the database location in the warehouse, followed by the table name.
        :param builtins.int number_of_buckets: Is if the table contains any dimension columns.
        :param builtins.str output_format: Output format: SequenceFileOutputFormat (binary), or IgnoreKeyTextOutputFormat, or a custom format.
        :param Mapping[str, builtins.str] parameters: Map of initialization parameters for the SerDe, in key-value form.
    ...
    @property
    @pulumi.getter(name="additionalLocations")
    def additional_locations(self) -> Sequence[builtins.str]:
        """
        List of locations that point to the path where a Delta table is located
        """
        return pulumi.get(self, "additional_locations")
    ...
    @property
    @pulumi.getter(name="bucketColumns")
    def bucket_columns(self) -> Sequence[builtins.str]:
        """
        List of reducer grouping columns, clustering columns, and bucketing columns in the table.
        """
        return pulumi.get(self, "bucket_columns")
    ...
    @property
    @pulumi.getter(name="numberOfBuckets")
    def number_of_buckets(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="storedAsSubDirectories")
    def stored_as_sub_directories(self) -> builtins.bool:
        """
        Whether the table data is stored in subdirectories.
        """
        return pulumi.get(self, "stored_as_sub_directories")
...
class GetCatalogTableStorageDescriptorSchemaReferenceResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str schema_version_id: Unique ID assigned to a version of the schema.
        :param builtins.int schema_version_number: Version number of the schema.
        """
...
class GetCatalogTableStorageDescriptorSchemaReferenceSchemaIdResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str registry_name: Name of the schema registry that contains the schema.
        :param builtins.str schema_arn: ARN of the schema.
        :param builtins.str schema_name: Name of the schema.
        """
        pulumi.set(__self__, "registry_name", registry_name)
        pulumi.set(__self__, "schema_arn", schema_arn)
        pulumi.set(__self__, "schema_name", schema_name)
...
class GetCatalogTableStorageDescriptorSkewedInfoResult(dict):
    def __init__(__self__, *,
                 skewed_column_names: Sequence[builtins.str],
                 skewed_column_value_location_maps: Mapping[str, builtins.str],
                 skewed_column_values: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] skewed_column_names: List of names of columns that contain skewed values.
        :param Mapping[str, builtins.str] skewed_column_value_location_maps: List of values that appear so frequently as to be considered skewed.
        :param Sequence[builtins.str] skewed_column_values: Map of skewed values to the columns that contain them.
    ...
    @property
    @pulumi.getter(name="skewedColumnNames")
    def skewed_column_names(self) -> Sequence[builtins.str]:
        """
        List of names of columns that contain skewed values.
        """
        return pulumi.get(self, "skewed_column_names")
    ...
    @property
    @pulumi.getter(name="skewedColumnValueLocationMaps")
    def skewed_column_value_location_maps(self) -> Mapping[str, builtins.str]:
        """
        List of values that appear so frequently as to be considered skewed.
        """
        return pulumi.get(self, "skewed_column_value_location_maps")
    ...
    @property
    @pulumi.getter(name="skewedColumnValues")
    def skewed_column_values(self) -> Sequence[builtins.str]:
        """
        Map of skewed values to the columns that contain them.
        """
        return pulumi.get(self, "skewed_column_values")
...
class GetDataCatalogEncryptionSettingsDataCatalogEncryptionSettingConnectionPasswordEncryptionResult(dict):
    def __init__(__self__, *,
                 aws_kms_key_id: builtins.str,
                 return_connection_password_encrypted: builtins.bool):
        """
        :param builtins.str aws_kms_key_id: KMS key ARN that is used to encrypt the connection password.
        :param builtins.bool return_connection_password_encrypted: When set to `true`, passwords remain encrypted in the responses of GetConnection and GetConnections. This encryption takes effect independently of the catalog encryption.
        """
        pulumi.set(__self__, "aws_kms_key_id", aws_kms_key_id)
        pulumi.set(__self__, "return_connection_password_encrypted", return_connection_password_encrypted)
...
class GetDataCatalogEncryptionSettingsDataCatalogEncryptionSettingEncryptionAtRestResult(dict):
    def __init__(__self__, *,
                 catalog_encryption_mode: builtins.str,
                 catalog_encryption_service_role: builtins.str,
                 sse_aws_kms_key_id: builtins.str):
        """
        :param builtins.str catalog_encryption_mode: The encryption-at-rest mode for encrypting Data Catalog data.
        :param builtins.str catalog_encryption_service_role: The ARN of the AWS IAM role used for accessing encrypted Data Catalog data.
        :param builtins.str sse_aws_kms_key_id: ARN of the AWS KMS key to use for encryption at rest.
        """
        pulumi.set(__self__, "catalog_encryption_mode", catalog_encryption_mode)
        pulumi.set(__self__, "catalog_encryption_service_role", catalog_encryption_service_role)
        pulumi.set(__self__, "sse_aws_kms_key_id", sse_aws_kms_key_id)
...
class GetScriptDagEdgeResult(dict):
    def __init__(__self__, *,
                 source: builtins.str,
                 target: builtins.str,
                 target_parameter: Optional[builtins.str] = None):
        """
        :param builtins.str source: ID of the node at which the edge starts.
        :param builtins.str target: ID of the node at which the edge ends.
        :param builtins.str target_parameter: Target of the edge.
        """
    ...
    def target_parameter(self) -> Optional[builtins.str]:
        """
        Target of the edge.
        """
...
class GetScriptDagNodeResult(dict):
    def __init__(__self__, *,
                 ...
                 line_number: Optional[builtins.int] = None):
        """
        :param Sequence['GetScriptDagNodeArgArgs'] args: Nested configuration an argument or property of a node. Defined below.
        :param builtins.str id: Node identifier that is unique within the node's graph.
        :param builtins.str node_type: Type of node this is.
        :param builtins.int line_number: Line number of the node.
        """
    ...
    def line_number(self) -> Optional[builtins.int]:
        """
...
class GetScriptDagNodeArgResult(dict):
    def __init__(__self__, *,
                 name: builtins.str,
                 value: builtins.str,
                 param: Optional[builtins.bool] = None):
        """
        :param builtins.str name: Name of the argument or property.
        :param builtins.str value: Value of the argument or property.
        :param builtins.bool param: Boolean if the value is used as a parameter. Defaults to `false`.
        """
        pulumi.set(__self__, "name", name)
    ...
    @property
    @pulumi.getter
    def param(self) -> Optional[builtins.bool]:
        """
