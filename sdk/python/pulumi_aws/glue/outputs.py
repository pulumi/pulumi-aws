...
class CatalogTableOptimizerConfigurationOrphanFileDeletionConfigurationIcebergConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 orphan_file_retention_period_in_days: Optional[int] = None):
        """
        ...
        :param int orphan_file_retention_period_in_days: The number of days that orphan files should be retained before file deletion. Defaults to `3`.
        """
    ...
    def orphan_file_retention_period_in_days(self) -> Optional[int]:
        """
...
class CatalogTableOptimizerConfigurationRetentionConfigurationIcebergConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 number_of_snapshots_to_retain: Optional[int] = None,
        ...
        :param int number_of_snapshots_to_retain: The number of Iceberg snapshots to retain within the retention period. Defaults to `1` or the corresponding Iceberg table configuration field if it exists.
        :param int snapshot_retention_period_in_days: The number of days to retain the Iceberg snapshots. Defaults to `5`, or the corresponding Iceberg table configuration field if it exists.
        """
    ...
    def number_of_snapshots_to_retain(self) -> Optional[int]:
        """
...
class DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsEncryptionAtRest(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str catalog_encryption_mode: The encryption-at-rest mode for encrypting Data Catalog data. Valid values: `DISABLED`, `SSE-KMS`, `SSE-KMS-WITH-SERVICE-ROLE`.
...
class JobCommand(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str python_version: The Python version being used to execute a Python shell job. Allowed values are 2, 3 or 3.9. Version 3 refers to Python 3.11 when `glue_version` is set to 5.0.
...
class JobSourceControlDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str auth_strategy: The type of authentication, which can be an authentication token stored in Amazon Web Services Secrets Manager, or a personal access token. Valid values are: `PERSONAL_ACCESS_TOKEN` and `AWS_SECRETS_MANAGER`.
        :param str auth_token: The value of an authorization token.
        :param str branch: A branch in the remote repository.
        :param str folder: A folder in the remote repository.
        :param str last_commit_id: The last commit ID for a commit in the remote repository.
        :param str owner: The owner of the remote repository that contains the job artifacts.
        :param str provider: The provider for the remote repository. Valid values are: `GITHUB`, `GITLAB`, `BITBUCKET`, and `AWS_CODE_COMMIT`.
        :param str repository: The name of the remote repository that contains the job artifacts.
        """
