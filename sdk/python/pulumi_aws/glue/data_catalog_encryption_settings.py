...
class DataCatalogEncryptionSettings(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if data_catalog_encryption_settings is not None and not isinstance(data_catalog_encryption_settings, DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsArgs):
                data_catalog_encryption_settings = data_catalog_encryption_settings or {}
                def _setter(key, value):
                    data_catalog_encryption_settings[key] = value
                DataCatalogEncryptionSettingsDataCatalogEncryptionSettingsArgs._configure(_setter, **data_catalog_encryption_settings)
