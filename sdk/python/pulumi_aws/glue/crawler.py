...
class CrawlerArgs:
    ...
    def _configure(
        ...
        if 'lakeFormationConfiguration' in kwargs:
            lake_formation_configuration = kwargs['lakeFormationConfiguration']
        if 'lineageConfiguration' in kwargs:
...
class Crawler(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if lake_formation_configuration is not None and not isinstance(lake_formation_configuration, CrawlerLakeFormationConfigurationArgs):
                lake_formation_configuration = lake_formation_configuration or {}
                def _setter(key, value):
                    lake_formation_configuration[key] = value
                CrawlerLakeFormationConfigurationArgs._configure(_setter, **lake_formation_configuration)
            __props__.__dict__["lake_formation_configuration"] = lake_formation_configuration
            if lineage_configuration is not None and not isinstance(lineage_configuration, CrawlerLineageConfigurationArgs):
                lineage_configuration = lineage_configuration or {}
                def _setter(key, value):
                    lineage_configuration[key] = value
                CrawlerLineageConfigurationArgs._configure(_setter, **lineage_configuration)
