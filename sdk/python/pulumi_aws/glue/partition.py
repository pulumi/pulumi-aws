...
class PartitionArgs:
    def __init__(__self__, *,
                 ...
                 partition_values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
    ...
    def partition_values(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def partition_values(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _PartitionState:
    def __init__(__self__, *,
                 ...
                 last_accessed_time: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] catalog_id: ID of the Glue Catalog and database to create the table in. If omitted, this defaults to the AWS Account ID plus the database name.
        :param pulumi.Input[builtins.str] creation_time: The time at which the partition was created.
        :param pulumi.Input[builtins.str] database_name: Name of the metadata database where the table metadata resides. For Hive compatibility, this must be all lowercase.
        :param pulumi.Input[builtins.str] last_accessed_time: The last time at which the partition was accessed.
    ...
    def last_accessed_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_accessed_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_accessed_time", value)

    @property
    @pulumi.getter(name="lastAnalyzedTime")
    def last_analyzed_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_analyzed_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="partitionValues")
    def partition_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The values that define the partition.
        """
        return pulumi.get(self, "partition_values")
    ...
    @partition_values.setter
    def partition_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "partition_values", value)
...
class Partition(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="lastAccessedTime")
    def last_accessed_time(self) -> pulumi.Output[builtins.str]:
        """
        The last time at which the partition was accessed.
        """
        return pulumi.get(self, "last_accessed_time")
    ...
    @property
    @pulumi.getter(name="lastAnalyzedTime")
    def last_analyzed_time(self) -> pulumi.Output[builtins.str]:
        """
        The last time at which column statistics were computed for this partition.
        """
        return pulumi.get(self, "last_analyzed_time")
    ...
    @property
    @pulumi.getter(name="partitionValues")
    def partition_values(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The values that define the partition.
        """
        return pulumi.get(self, "partition_values")
