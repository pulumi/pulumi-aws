...
class MLTransformArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the ML Transform.
        :param pulumi.Input[builtins.str] glue_version: The version of glue to use, for example "1.0". For information about available versions, see the [AWS Glue Release Notes](https://docs.aws.amazon.com/glue/latest/dg/release-notes.html).
        :param pulumi.Input[builtins.float] max_capacity: The number of AWS Glue data processing units (DPUs) that are allocated to task runs for this transform. You can allocate from `2` to `100` DPUs; the default is `10`. `max_capacity` is a mutually exclusive option with `number_of_workers` and `worker_type`.
...
class _MLTransformState:
    def __init__(__self__, *,
                 ...
                 label_count: Optional[pulumi.Input[builtins.int]] = None,
                 max_capacity: Optional[pulumi.Input[builtins.float]] = None,
                 max_retries: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 number_of_workers: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of Glue ML Transform.
        :param pulumi.Input[builtins.str] description: Description of the ML Transform.
        :param pulumi.Input[builtins.str] glue_version: The version of glue to use, for example "1.0". For information about available versions, see the [AWS Glue Release Notes](https://docs.aws.amazon.com/glue/latest/dg/release-notes.html).
        :param pulumi.Input[Sequence[pulumi.Input['MLTransformInputRecordTableArgs']]] input_record_tables: A list of AWS Glue table definitions used by the transform. see Input Record Tables.
        :param pulumi.Input[builtins.int] label_count: The number of labels available for this transform.
        :param pulumi.Input[builtins.float] max_capacity: The number of AWS Glue data processing units (DPUs) that are allocated to task runs for this transform. You can allocate from `2` to `100` DPUs; the default is `10`. `max_capacity` is a mutually exclusive option with `number_of_workers` and `worker_type`.
        :param pulumi.Input[builtins.int] max_retries: The maximum number of times to retry this ML Transform if it fails.
        :param pulumi.Input[builtins.str] name: The name you assign to this ML Transform. It must be unique in your account.
        :param pulumi.Input[builtins.int] number_of_workers: The number of workers of a defined `worker_type` that are allocated when an ML Transform runs. Required with `worker_type`.
    ...
    def label_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @label_count.setter
    def label_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class MLTransform(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            timeout: Optional[pulumi.Input[builtins.int]] = None,
            worker_type: Optional[pulumi.Input[builtins.str]] = None) -> 'MLTransform':
        """
    ...
    @property
    @pulumi.getter(name="labelCount")
    def label_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of labels available for this transform.
        """
        return pulumi.get(self, "label_count")
