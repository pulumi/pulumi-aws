...
class TriggerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of trigger. Valid values are `CONDITIONAL`, `EVENT`, `ON_DEMAND`, and `SCHEDULED`.
        :param pulumi.Input[builtins.str] description: A description of the new trigger.
        :param pulumi.Input[builtins.bool] enabled: Start the trigger. Defaults to `true`.
        ...
        :param pulumi.Input[builtins.str] workflow_name: A workflow to which the trigger should be associated to. Every workflow graph (DAG) needs a starting trigger (`ON_DEMAND` or `SCHEDULED` type) and can contain multiple additional `CONDITIONAL` triggers.
        """
...
class _TriggerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['TriggerActionArgs']]] actions: List of actions initiated by this trigger when it fires. See Actions Below.
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of Glue Trigger
        :param pulumi.Input[builtins.str] description: A description of the new trigger.
        :param pulumi.Input[builtins.bool] enabled: Start the trigger. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input['TriggerEventBatchingConditionArgs']]] event_batching_conditions: Batch condition that must be met (specified number of events received or batch time window expired) before EventBridge event trigger fires. See Event Batching Condition.
        :param pulumi.Input[builtins.str] name: The name of the trigger.
...
class Trigger(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            workflow_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Trigger':
        """
