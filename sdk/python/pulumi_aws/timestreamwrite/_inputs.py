...
if not MYPY:
    class TableMagneticStoreWritePropertiesArgsDict(TypedDict):
        enable_magnetic_store_writes: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class TableMagneticStoreWritePropertiesArgs:
    def __init__(__self__, *,
                 enable_magnetic_store_writes: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] enable_magnetic_store_writes: A flag to enable magnetic store writes.
    ...
    def enable_magnetic_store_writes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        A flag to enable magnetic store writes.
        """
    ...
    def enable_magnetic_store_writes(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationS3ConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_name: Bucket name of the customer S3 bucket.
        :param pulumi.Input[builtins.str] encryption_option: Encryption option for the customer s3 location. Options are S3 server side encryption with an S3-managed key or KMS managed key. Valid values are `SSE_KMS` and `SSE_S3`.
        :param pulumi.Input[builtins.str] kms_key_id: KMS key arn for the customer s3 location when encrypting with a KMS managed key.
        :param pulumi.Input[builtins.str] object_key_prefix: Object key prefix for the customer S3 location.
        """
...
if not MYPY:
    class TableRetentionPropertiesArgsDict(TypedDict):
        magnetic_store_retention_period_in_days: pulumi.Input[builtins.int]
        """
        The duration for which data must be stored in the magnetic store. Minimum value of 1. Maximum value of 73000.
        """
        memory_store_retention_period_in_hours: pulumi.Input[builtins.int]
        """
...
class TableRetentionPropertiesArgs:
    def __init__(__self__, *,
                 ...
                 memory_store_retention_period_in_hours: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] magnetic_store_retention_period_in_days: The duration for which data must be stored in the magnetic store. Minimum value of 1. Maximum value of 73000.
        :param pulumi.Input[builtins.int] memory_store_retention_period_in_hours: The duration for which data must be stored in the memory store. Minimum value of 1. Maximum value of 8766.
        """
    ...
    def magnetic_store_retention_period_in_days(self) -> pulumi.Input[builtins.int]:
        """
        The duration for which data must be stored in the magnetic store. Minimum value of 1. Maximum value of 73000.
        """
    ...
    def magnetic_store_retention_period_in_days(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "magnetic_store_retention_period_in_days", value)

    @property
    @pulumi.getter(name="memoryStoreRetentionPeriodInHours")
    def memory_store_retention_period_in_hours(self) -> pulumi.Input[builtins.int]:
        """
        The duration for which data must be stored in the memory store. Minimum value of 1. Maximum value of 8766.
        """
    ...
    def memory_store_retention_period_in_hours(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class TableSchemaCompositePartitionKeyArgsDict(TypedDict):
        ...
        """
        enforcement_in_record: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TableSchemaCompositePartitionKeyArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 enforcement_in_record: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: The type of the partition key. Valid values: `DIMENSION`, `MEASURE`.
        :param pulumi.Input[builtins.str] enforcement_in_record: The level of enforcement for the specification of a dimension key in ingested records. Valid values: `REQUIRED`, `OPTIONAL`.
        :param pulumi.Input[builtins.str] name: The name of the attribute used for a dimension key.
        """
    ...
    def enforcement_in_record(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The level of enforcement for the specification of a dimension key in ingested records. Valid values: `REQUIRED`, `OPTIONAL`.
        """
    ...
    def enforcement_in_record(self, value: Optional[pulumi.Input[builtins.str]]):
