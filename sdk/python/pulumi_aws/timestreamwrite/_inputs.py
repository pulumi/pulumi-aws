...
class TableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationS3ConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key_id: KMS key arn for the customer s3 location when encrypting with a KMS managed key.
        :param pulumi.Input[_builtins.str] object_key_prefix: Object key prefix for the customer S3 location.
        """
...
class TableRetentionPropertiesArgs:
    ...
    def magnetic_store_retention_period_in_days(self, value: pulumi.Input[_builtins.int]):
    ...
    def memory_store_retention_period_in_hours(self, value: pulumi.Input[_builtins.int]):
