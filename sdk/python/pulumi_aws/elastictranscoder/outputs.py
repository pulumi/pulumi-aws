...
class PipelineContentConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        PipelineContentConfig._configure(
...
class PipelineContentConfigPermission(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[str] accesses: The permission that you want to give to the AWS user that you specified in `content_config_permissions.grantee`. Valid values are `Read`, `ReadAcp`, `WriteAcp` or `FullControl`.
        ...
        """
        PipelineContentConfigPermission._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            accesses=accesses,
            grantee=grantee,
...
class PipelineNotifications(dict):
    def __init__(__self__, *,
        ...
        """
        PipelineNotifications._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            completed=completed,
            error=error,
...
class PipelineThumbnailConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        PipelineThumbnailConfig._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            bucket=bucket,
            storage_class=storage_class,
        )
...
class PipelineThumbnailConfigPermission(dict):
    ...
    def __init__(__self__, *,
                 ...
                 grantee_type: Optional[str] = None):
        """
        :param Sequence[str] accesses: The permission that you want to give to the AWS user that you specified in `thumbnail_config_permissions.grantee`. Valid values are `Read`, `ReadAcp`, `WriteAcp` or `FullControl`.
        :param str grantee: The AWS user or group that you want to have access to thumbnail files.
        :param str grantee_type: Specify the type of value that appears in the `thumbnail_config_permissions.grantee` object. Valid values are `Canonical`, `Email` or `Group`.
        """
        PipelineThumbnailConfigPermission._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            accesses=accesses,
            grantee=grantee,
            grantee_type=grantee_type,
...
class PresetAudioCodecOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        PresetAudioCodecOptions._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            bit_depth=bit_depth,
            bit_order=bit_order,
            profile=profile,
...
class PresetVideoWatermark(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        PresetVideoWatermark._configure(
            lambda key, value: pulumi.set(__self__, key, value),
