...
class PipelineArgs:
    def __init__(__self__, *,
                 input_bucket: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] input_bucket: The Amazon S3 bucket in which you saved the media files that you want to transcode and the graphics that you want to use as watermarks.
        ...
        :param pulumi.Input[builtins.str] aws_kms_key_arn: The AWS Key Management Service (AWS KMS) key that you want to use with this pipeline.
    ...
    def input_bucket(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @input_bucket.setter
    def input_bucket(self, value: pulumi.Input[builtins.str]):
    ...
    def aws_kms_key_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def output_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def output_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PipelineState:
    def __init__(__self__, *,
                 ...
                 content_config: Optional[pulumi.Input['PipelineContentConfigArgs']] = None,
                 content_config_permissions: Optional[pulumi.Input[Sequence[pulumi.Input['PipelineContentConfigPermissionArgs']]]] = None,
                 input_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 notifications: Optional[pulumi.Input['PipelineNotificationsArgs']] = None,
                 output_bucket: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the Elastictranscoder pipeline.
        :param pulumi.Input[builtins.str] aws_kms_key_arn: The AWS Key Management Service (AWS KMS) key that you want to use with this pipeline.
        :param pulumi.Input['PipelineContentConfigArgs'] content_config: The ContentConfig object specifies information about the Amazon S3 bucket in which you want Elastic Transcoder to save transcoded files and playlists. (documented below)
        :param pulumi.Input[Sequence[pulumi.Input['PipelineContentConfigPermissionArgs']]] content_config_permissions: The permissions for the `content_config` object. (documented below)
        :param pulumi.Input[builtins.str] input_bucket: The Amazon S3 bucket in which you saved the media files that you want to transcode and the graphics that you want to use as watermarks.
    ...
    @property
    @pulumi.getter(name="inputBucket")
    def input_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon S3 bucket in which you saved the media files that you want to transcode and the graphics that you want to use as watermarks.
        """
        return pulumi.get(self, "input_bucket")
    ...
    @input_bucket.setter
    def input_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "input_bucket", value)
...
class Pipeline(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="awsKmsKeyArn")
    def aws_kms_key_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The AWS Key Management Service (AWS KMS) key that you want to use with this pipeline.
        """
        return pulumi.get(self, "aws_kms_key_arn")
    ...
    @property
    @pulumi.getter(name="inputBucket")
    def input_bucket(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon S3 bucket in which you saved the media files that you want to transcode and the graphics that you want to use as watermarks.
        """
        return pulumi.get(self, "input_bucket")
    ...
    @property
    @pulumi.getter(name="outputBucket")
    def output_bucket(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon S3 bucket in which you want Elastic Transcoder to save the transcoded files.
        """
        return pulumi.get(self, "output_bucket")
