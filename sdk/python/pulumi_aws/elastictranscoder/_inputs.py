...
class PresetThumbnailsArgs:
    ...
    def _configure(
        ...
        if 'paddingPolicy' in kwargs:
            padding_policy = kwargs['paddingPolicy']
        if 'sizingPolicy' in kwargs:
...
class PresetVideoWatermarkArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'horizontalAlign' in kwargs:
            horizontal_align = kwargs['horizontalAlign']
        if 'horizontalOffset' in kwargs:
