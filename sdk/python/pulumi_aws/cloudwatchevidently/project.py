...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Tags to apply to the project. If configured with a provider [`default_tags` configuration block](https://www.terraform.io/docs/providers/aws/index.html#default_tags-configuration-block) present, tags with matching keys will overwrite those defined at the provider-level.
...
class Project(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = aws.cloudwatchevidently.Project("example",
        ...
        example = aws.cloudwatchevidently.Project("example",
            data_delivery=aws.cloudwatchevidently.ProjectDataDeliveryArgs(
                cloudwatch_logs=aws.cloudwatchevidently.ProjectDataDeliveryCloudwatchLogsArgs(
        ...
        example = aws.cloudwatchevidently.Project("example",
            data_delivery=aws.cloudwatchevidently.ProjectDataDeliveryArgs(
                s3_destination=aws.cloudwatchevidently.ProjectDataDeliveryS3DestinationArgs(
    ...
    def _internal_init(__self__,
        ...
        super(Project, __self__).__init__(
            'aws:cloudwatchevidently/project:Project',
            resource_name,
            __props__,
            opts)
