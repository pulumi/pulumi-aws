...
class _RegisteredDomainState:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'abuseContactEmail' in kwargs:
            abuse_contact_email = kwargs['abuseContactEmail']
        if 'abuseContactPhone' in kwargs:
        ...
        if 'registrantPrivacy' in kwargs:
            registrant_privacy = kwargs['registrantPrivacy']
        if 'registrarName' in kwargs:
            registrar_name = kwargs['registrarName']
        if 'registrarUrl' in kwargs:
...
class RegisteredDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if admin_contact is not None and not isinstance(admin_contact, RegisteredDomainAdminContactArgs):
                admin_contact = admin_contact or {}
                def _setter(key, value):
                    admin_contact[key] = value
                RegisteredDomainAdminContactArgs._configure(_setter, **admin_contact)
            ...
            if registrant_contact is not None and not isinstance(registrant_contact, RegisteredDomainRegistrantContactArgs):
                registrant_contact = registrant_contact or {}
                def _setter(key, value):
                    registrant_contact[key] = value
                RegisteredDomainRegistrantContactArgs._configure(_setter, **registrant_contact)
            __props__.__dict__["registrant_contact"] = registrant_contact
            __props__.__dict__["registrant_privacy"] = registrant_privacy
            __props__.__dict__["tags"] = tags
            if tech_contact is not None and not isinstance(tech_contact, RegisteredDomainTechContactArgs):
                tech_contact = tech_contact or {}
                def _setter(key, value):
                    tech_contact[key] = value
                RegisteredDomainTechContactArgs._configure(_setter, **tech_contact)
