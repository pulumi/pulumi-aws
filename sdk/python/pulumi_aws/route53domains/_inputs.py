...
class DomainAdminContactExtraParamArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[str]):
        """
        :param pulumi.Input[str] name: The name of an additional parameter that is required by a top-level domain.
        :param pulumi.Input[str] value: The value that corresponds with the name of an extra parameter.
        """
...
if not MYPY:
    class DomainBillingContactArgsDict(TypedDict):
        ...
        First line of the contact's address.
        """
        address_line2: pulumi.Input[str]
        """
        Second line of contact's address, if any.
        """
...
class DomainBillingContactArgs:
    ...
    @property
    @pulumi.getter(name="addressLine2")
    def address_line2(self) -> pulumi.Input[str]:
        """
        Second line of contact's address, if any.
        """
        return pulumi.get(self, "address_line2")
    ...
    @address_line2.setter
    def address_line2(self, value: pulumi.Input[str]):
        pulumi.set(self, "address_line2", value)
    ...
    @property
    @pulumi.getter(name="contactType")
    def contact_type(self) -> pulumi.Input[str]:
        """
        Indicates whether the contact is a person, company, association, or public organization. See the [AWS API documentation](https://docs.aws.amazon.com/Route53/latest/APIReference/API_domains_ContactDetail.html#Route53Domains-Type-domains_ContactDetail-ContactType) for valid values.
        """
        return pulumi.get(self, "contact_type")
    ...
    @contact_type.setter
    def contact_type(self, value: pulumi.Input[str]):
        pulumi.set(self, "contact_type", value)
    ...
    @fax.setter
    def fax(self, value: pulumi.Input[str]):
        pulumi.set(self, "fax", value)
...
if not MYPY:
    class DomainNameServerArgsDict(TypedDict):
        glue_ips: pulumi.Input[Sequence[pulumi.Input[str]]]
        """
...
class DomainNameServerArgs:
    ...
    def glue_ips(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
        Glue IP addresses of a name server. The list can contain only one IPv4 and one IPv6 address.
        """
    ...
    @glue_ips.setter
    def glue_ips(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
