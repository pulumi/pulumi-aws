...
class DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] duration_in_years: The number of years that you want to register the domain for. Domains are registered for a minimum of one year. Increasing the duration renews the domain.
    ...
    def billing_privacy(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def billing_privacy(self, value: Optional[pulumi.Input[bool]]):
...
class _DomainState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] hosted_zone_id: The ID of the public Route 53 hosted zone created for the domain. This hosted zone is deleted when the domain is deregistered.
        :param pulumi.Input[Sequence[pulumi.Input['DomainNameServerArgs']]] name_servers: The list of nameservers for the domain. See `name_server` Blocks for more details.
        :param pulumi.Input['DomainRegistrantContactArgs'] registrant_contact: Details about the domain registrant. See Contact Blocks for more details.
        :param pulumi.Input[bool] registrant_privacy: Whether domain registrant contact information is concealed from WHOIS queries. Default: `true`.
...
class Domain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transfer_lock: Optional[pulumi.Input[bool]] = None,
            updated_date: Optional[pulumi.Input[str]] = None,
            whois_server: Optional[pulumi.Input[str]] = None) -> 'Domain':
        """
    ...
    @property
    @pulumi.getter(name="adminPrivacy")
    def admin_privacy(self) -> pulumi.Output[bool]:
        """
        Whether domain administrative contact information is concealed from WHOIS queries. Default: `true`.
        """
        return pulumi.get(self, "admin_privacy")
    ...
    @property
    @pulumi.getter(name="billingPrivacy")
    def billing_privacy(self) -> pulumi.Output[bool]:
        """
        Whether domain billing contact information is concealed from WHOIS queries. Default: `true`.
        """
        return pulumi.get(self, "billing_privacy")
    ...
    @property
    @pulumi.getter(name="durationInYears")
    def duration_in_years(self) -> pulumi.Output[int]:
        """
        The number of years that you want to register the domain for. Domains are registered for a minimum of one year. Increasing the duration renews the domain.
        """
        return pulumi.get(self, "duration_in_years")
    ...
    @property
    @pulumi.getter(name="registrantPrivacy")
    def registrant_privacy(self) -> pulumi.Output[bool]:
        """
        Whether domain registrant contact information is concealed from WHOIS queries. Default: `true`.
        """
        return pulumi.get(self, "registrant_privacy")
    ...
    @property
    @pulumi.getter(name="techPrivacy")
    def tech_privacy(self) -> pulumi.Output[bool]:
        """
        Whether domain technical contact information is concealed from WHOIS queries. Default: `true`.
        """
        return pulumi.get(self, "tech_privacy")
    ...
    @property
    @pulumi.getter(name="transferLock")
    def transfer_lock(self) -> pulumi.Output[bool]:
        """
        Whether the domain is locked for transfer. Default: `true`.
        """
        return pulumi.get(self, "transfer_lock")
