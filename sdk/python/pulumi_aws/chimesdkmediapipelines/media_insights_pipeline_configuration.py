...
class MediaInsightsPipelineConfigurationArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'resourceAccessRoleArn' in kwargs:
            resource_access_role_arn = kwargs['resourceAccessRoleArn']
        if 'realTimeAlertConfiguration' in kwargs:
...
class MediaInsightsPipelineConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if real_time_alert_configuration is not None and not isinstance(real_time_alert_configuration, MediaInsightsPipelineConfigurationRealTimeAlertConfigurationArgs):
                real_time_alert_configuration = real_time_alert_configuration or {}
                def _setter(key, value):
                    real_time_alert_configuration[key] = value
                MediaInsightsPipelineConfigurationRealTimeAlertConfigurationArgs._configure(_setter, **real_time_alert_configuration)
