...
class ManagedUserPoolClientArgs:
    def __init__(__self__, *,
        ...
        """
        ManagedUserPoolClientArgs._configure(
...
class _ManagedUserPoolClientState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] write_attributes: List of user pool attributes that the application client can write to.
        """
        _ManagedUserPoolClientState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            access_token_validity=access_token_validity,
            allowed_oauth_flows=allowed_oauth_flows,
            allowed_oauth_flows_user_pool_client=allowed_oauth_flows_user_pool_client,
...
class ManagedUserPoolClient(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ManagedUserPoolClientArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if analytics_configuration is not None and not isinstance(analytics_configuration, ManagedUserPoolClientAnalyticsConfigurationArgs):
                analytics_configuration = analytics_configuration or {}
                def _setter(key, value):
                    analytics_configuration[key] = value
                ManagedUserPoolClientAnalyticsConfigurationArgs._configure(_setter, **analytics_configuration)
            ...
            if token_validity_units is not None and not isinstance(token_validity_units, ManagedUserPoolClientTokenValidityUnitsArgs):
                token_validity_units = token_validity_units or {}
                def _setter(key, value):
                    token_validity_units[key] = value
                ManagedUserPoolClientTokenValidityUnitsArgs._configure(_setter, **token_validity_units)
