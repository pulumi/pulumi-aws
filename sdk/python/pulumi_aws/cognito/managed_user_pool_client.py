...
class ManagedUserPoolClient(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            analytics_configuration = _utilities.configure(analytics_configuration, ManagedUserPoolClientAnalyticsConfigurationArgs, True)
            ...
            token_validity_units = _utilities.configure(token_validity_units, ManagedUserPoolClientTokenValidityUnitsArgs, True)
