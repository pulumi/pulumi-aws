...
class ManagedUserPoolClientArgs:
    def __init__(__self__, *,
                 ...
                 analytics_configuration: pulumi.Input[Optional['ManagedUserPoolClientAnalyticsConfigurationArgs']] = None,
                 ...
                 refresh_token_rotation: pulumi.Input[Optional['ManagedUserPoolClientRefreshTokenRotationArgs']] = None,
                 ...
                 token_validity_units: pulumi.Input[Optional['ManagedUserPoolClientTokenValidityUnitsArgs']] = None,
        ...
        :param pulumi.Input['ManagedUserPoolClientAnalyticsConfigurationArgs'] analytics_configuration: Configuration block for AWS End User Messaging analytics that collects metrics for this user pool. See details below.
        ...
        :param pulumi.Input[_builtins.str] name_pattern: Regular expression that matches the name of the existing User Pool Client to be managed. It must only match one User Pool Client.
        :param pulumi.Input[_builtins.str] name_prefix: String that matches the beginning of the name of the  existing User Pool Client to be managed. It must match only one User Pool Client.
    ...
    def analytics_configuration(self) -> pulumi.Input[Optional['ManagedUserPoolClientAnalyticsConfigurationArgs']]:
        """
    ...
    def analytics_configuration(self, value: pulumi.Input[Optional['ManagedUserPoolClientAnalyticsConfigurationArgs']]):
    ...
    def refresh_token_rotation(self) -> pulumi.Input[Optional['ManagedUserPoolClientRefreshTokenRotationArgs']]:
        """
    ...
    def refresh_token_rotation(self, value: pulumi.Input[Optional['ManagedUserPoolClientRefreshTokenRotationArgs']]):
    ...
    def token_validity_units(self) -> pulumi.Input[Optional['ManagedUserPoolClientTokenValidityUnitsArgs']]:
        """
    ...
    def token_validity_units(self, value: pulumi.Input[Optional['ManagedUserPoolClientTokenValidityUnitsArgs']]):
...
class _ManagedUserPoolClientState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] id_token_validity: Time limit, between 5 minutes and 1 day, after which the ID token is no longer valid and cannot be used. By default, the unit is hours. The unit can be overridden by a value in `token_validity_units.id_token`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] logout_urls: List of allowed logout URLs for the identity providers. `allowed_oauth_flows_user_pool_client` must be set to `true` before you can configure this option.
        :param pulumi.Input[_builtins.str] name: Name of the user pool client.
        :param pulumi.Input[_builtins.str] name_pattern: Regular expression that matches the name of the existing User Pool Client to be managed. It must only match one User Pool Client.
        :param pulumi.Input[_builtins.str] name_prefix: String that matches the beginning of the name of the  existing User Pool Client to be managed. It must match only one User Pool Client.
