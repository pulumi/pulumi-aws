...
class IdentityPoolCognitoIdentityProvider(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_id: The client ID for the Amazon Cognito Identity User Pool.
        :param builtins.str provider_name: The provider name for an Amazon Cognito Identity User Pool.
        :param builtins.bool server_side_token_check: Whether server-side token validation is enabled for the identity provider’s token or not.
        """
...
class IdentityPoolRoleAttachmentRoleMapping(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str identity_provider: A string identifying the identity provider, for example, "graph.facebook.com" or "cognito-idp.us-east-1.amazonaws.com/us-east-1_abcdefghi:app_client_id". Depends on `cognito_identity_providers` set on `cognito.IdentityPool` resource or a `cognito.IdentityProvider` resource.
        :param builtins.str type: The role mapping type.
        :param builtins.str ambiguous_role_resolution: Specifies the action to be taken if either no rules match the claim value for the Rules type, or there is no cognito:preferred_role claim and there are multiple cognito:roles matches for the Token type. `Required` if you specify Token or Rules as the Type.
...
class IdentityPoolRoleAttachmentRoleMappingMappingRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str claim: The claim name that must be present in the token, for example, "isAdmin" or "paid".
        :param builtins.str match_type: The match condition that specifies how closely the claim value in the IdP token must match Value.
        :param builtins.str role_arn: The role ARN.
        :param builtins.str value: A brief string that the claim must match, for example, "paid" or "yes".
        """
...
class ManagedUserPoolClientAnalyticsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str application_arn: Application ARN for an Amazon Pinpoint application. It conflicts with `external_id` and `role_arn`.
        :param builtins.str application_id: Unique identifier for an Amazon Pinpoint application.
        :param builtins.str external_id: ID for the Analytics Configuration and conflicts with `application_arn`.
        :param builtins.str role_arn: ARN of an IAM role that authorizes Amazon Cognito to publish events to Amazon Pinpoint analytics. It conflicts with `application_arn`.
        :param builtins.bool user_data_shared: If `user_data_shared` is set to `true`, Amazon Cognito will include user data in the events it publishes to Amazon Pinpoint analytics.
        """
...
class ManagedUserPoolClientTokenValidityUnits(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str access_token: Time unit for the value in `access_token_validity` and defaults to `hours`.
        :param builtins.str id_token: Time unit for the value in `id_token_validity`, and it defaults to `hours`.
        :param builtins.str refresh_token: Time unit for the value in `refresh_token_validity` and defaults to `days`.
        """
...
class ResourceServerScope(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str scope_description: The scope description.
        :param builtins.str scope_name: The scope name.
        """
...
class RiskConfigurationAccountTakeoverRiskConfigurationActionsHighAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool notify: Whether to send a notification.
        """
...
class RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str from_: The email address that is sending the email. The address must be either individually verified with Amazon Simple Email Service, or from a domain that has been verified with Amazon SES.
        ...
        :param builtins.str reply_to: The destination to which the receiver of an email should reply to.
        """
...
class RiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationBlockEmail(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str html_body: The email HTML body.
        :param builtins.str subject: The email subject.
        :param builtins.str text_body: The email text body.
        """
...
class RiskConfigurationCompromisedCredentialsRiskConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 event_filters: Optional[Sequence[builtins.str]] = None):
        """
        ...
        :param Sequence[builtins.str] event_filters: Perform the action for these events. The default is to perform all events if no event filter is specified. Valid values are `SIGN_IN`, `PASSWORD_CHANGE`, and `SIGN_UP`.
        """
        pulumi.set(__self__, "actions", actions)
    ...
    def event_filters(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RiskConfigurationCompromisedCredentialsRiskConfigurationActions(dict):
    ...
    def __init__(__self__, *,
                 event_action: builtins.str):
        """
        :param builtins.str event_action: The event action. Valid values are `BLOCK` or `NO_ACTION`.
        """
        pulumi.set(__self__, "event_action", event_action)
...
class RiskConfigurationRiskExceptionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 blocked_ip_range_lists: Optional[Sequence[builtins.str]] = None,
                 skipped_ip_range_lists: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] blocked_ip_range_lists: Overrides the risk decision to always block the pre-authentication requests.
               The IP range is in CIDR notation, a compact representation of an IP address and its routing prefix.
               Can contain a maximum of 200 items.
        :param Sequence[builtins.str] skipped_ip_range_lists: Risk detection isn't performed on the IP addresses in this range list.
    ...
    def blocked_ip_range_lists(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def skipped_ip_range_lists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class UserPoolAccountRecoverySettingRecoveryMechanism(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Recovery method for a user. Can be of the following: `verified_email`, `verified_phone_number`, and `admin_only`.
        :param builtins.int priority: Positive integer specifying priority of a method with 1 being the highest priority.
        """
...
class UserPoolAdminCreateUserConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool allow_admin_create_user_only: Set to True if only the administrator is allowed to create user profiles. Set to False if users can sign themselves up via an app.
...
class UserPoolAdminCreateUserConfigInviteMessageTemplate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str email_message: Message template for email messages. Must contain `{username}` and `{####}` placeholders, for username and temporary password, respectively.
        :param builtins.str email_subject: Subject line for email messages.
        :param builtins.str sms_message: Message template for SMS messages. Must contain `{username}` and `{####}` placeholders, for username and temporary password, respectively.
        """
...
class UserPoolClientAnalyticsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_data_shared: Optional[builtins.bool] = None):
        """
        :param builtins.str application_arn: Application ARN for an Amazon Pinpoint application. Conflicts with `external_id` and `role_arn`.
        :param builtins.str application_id: Application ID for an Amazon Pinpoint application.
        :param builtins.str external_id: ID for the Analytics Configuration. Conflicts with `application_arn`.
        :param builtins.str role_arn: ARN of an IAM role that authorizes Amazon Cognito to publish events to Amazon Pinpoint analytics. Conflicts with `application_arn`.
        :param builtins.bool user_data_shared: If set to `true`, Amazon Cognito will include user data in the events it publishes to Amazon Pinpoint analytics.
        """
        if application_arn is not None:
            pulumi.set(__self__, "application_arn", application_arn)
        if application_id is not None:
...
class UserPoolClientTokenValidityUnits(dict):
    ...
    def __init__(__self__, *,
                 ...
                 refresh_token: Optional[builtins.str] = None):
        """
        :param builtins.str access_token: Time unit in for the value in `access_token_validity`, defaults to `hours`.
        :param builtins.str id_token: Time unit in for the value in `id_token_validity`, defaults to `hours`.
        :param builtins.str refresh_token: Time unit in for the value in `refresh_token_validity`, defaults to `days`.
        """
        if access_token is not None:
            pulumi.set(__self__, "access_token", access_token)
        if id_token is not None:
...
class UserPoolDeviceConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool challenge_required_on_new_device: Whether a challenge is required on a new device. Only applicable to a new device.
        :param builtins.bool device_only_remembered_on_user_prompt: Whether a device is only remembered on user prompt. `false` equates to "Always" remember, `true` is "User Opt In," and not using a `device_configuration` block is "No."
        """
...
class UserPoolEmailConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 from_email_address: Optional[builtins.str] = None,
                 reply_to_email_address: Optional[builtins.str] = None,
                 source_arn: Optional[builtins.str] = None):
        """
        :param builtins.str configuration_set: Email configuration set name from SES.
        :param builtins.str email_sending_account: Email delivery method to use. `COGNITO_DEFAULT` for the default email functionality built into Cognito or `DEVELOPER` to use your Amazon SES configuration. Required to be `DEVELOPER` if `from_email_address` is set.
        :param builtins.str from_email_address: Sender’s email address or sender’s display name with their email address (e.g., `john@example.com`, `John Smith <john@example.com>` or `\\"John Smith Ph.D.\\" <john@example.com>`). Escaped double quotes are required around display names that contain certain characters as specified in [RFC 5322](https://tools.ietf.org/html/rfc5322).
        :param builtins.str reply_to_email_address: REPLY-TO email address.
        :param builtins.str source_arn: ARN of the SES verified email identity to use. Required if `email_sending_account` is set to `DEVELOPER`.
        """
    ...
    def from_email_address(self) -> Optional[builtins.str]:
        """
...
class UserPoolEmailMfaConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str message: The template for the email messages that your user pool sends to users with codes for MFA and sign-in with email OTPs. The message must contain the {####} placeholder. In the message, Amazon Cognito replaces this placeholder with the code. If you don't provide this parameter, Amazon Cognito sends messages in the default format.
        :param builtins.str subject: The subject of the email messages that your user pool sends to users with codes for MFA and email OTP sign-in.
        """
...
class UserPoolLambdaConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str create_auth_challenge: ARN of the lambda creating an authentication challenge.
        ...
        :param builtins.str custom_message: Custom Message AWS Lambda trigger.
        ...
        :param builtins.str define_auth_challenge: Defines the authentication challenge.
        :param builtins.str kms_key_id: The Amazon Resource Name of Key Management Service Customer master keys. Amazon Cognito uses the key to encrypt codes and temporary passwords sent to CustomEmailSender and CustomSMSSender.
        :param builtins.str post_authentication: Post-authentication AWS Lambda trigger.
        :param builtins.str post_confirmation: Post-confirmation AWS Lambda trigger.
        :param builtins.str pre_authentication: Pre-authentication AWS Lambda trigger.
        :param builtins.str pre_sign_up: Pre-registration AWS Lambda trigger.
        :param builtins.str pre_token_generation: Allow to customize identity token claims before token generation. Set this parameter for legacy purposes; for new instances of pre token generation triggers, set the lambda_arn of `pre_token_generation_config`.
        ...
        :param builtins.str user_migration: User migration Lambda config type.
        :param builtins.str verify_auth_challenge_response: Verifies the authentication challenge response.
        """
...
class UserPoolLambdaConfigCustomEmailSender(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str lambda_arn: The Lambda Amazon Resource Name of the Lambda function that Amazon Cognito triggers to send email notifications to users.
        :param builtins.str lambda_version: The Lambda version represents the signature of the "request" attribute in the "event" information Amazon Cognito passes to your custom email Lambda function. The only supported value is `V1_0`.
        """
...
class UserPoolLambdaConfigCustomSmsSender(dict):
    ...
    def __init__(__self__, *,
                 ...
                 lambda_version: builtins.str):
        """
        :param builtins.str lambda_arn: The Lambda Amazon Resource Name of the Lambda function that Amazon Cognito triggers to send SMS notifications to users.
        :param builtins.str lambda_version: The Lambda version represents the signature of the "request" attribute in the "event" information Amazon Cognito passes to your custom SMS Lambda function. The only supported value is `V1_0`.
        """
        pulumi.set(__self__, "lambda_arn", lambda_arn)
        pulumi.set(__self__, "lambda_version", lambda_version)
...
class UserPoolPasswordPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int minimum_length: Minimum length of the password policy that you have set.
        :param builtins.int password_history_size: Number of previous passwords that you want Amazon Cognito to restrict each user from reusing. Users can't set a password that matches any of number of previous passwords specified by this argument. A value of 0 means that password history is not enforced. Valid values are between 0 and 24.
               
               **Note:** This argument requires advanced security features to be active in the user pool.
        :param builtins.bool require_lowercase: Whether you have required users to use at least one lowercase letter in their password.
        :param builtins.bool require_numbers: Whether you have required users to use at least one number in their password.
        :param builtins.bool require_symbols: Whether you have required users to use at least one symbol in their password.
        :param builtins.bool require_uppercase: Whether you have required users to use at least one uppercase letter in their password.
        :param builtins.int temporary_password_validity_days: In the password policy you have set, refers to the number of days a temporary password is valid. If the user does not sign-in during this time, their password will need to be reset by an administrator.
        """
...
class UserPoolSchema(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str attribute_data_type: Attribute data type. Must be one of `Boolean`, `Number`, `String`, `DateTime`.
        :param builtins.str name: Name of the attribute.
        :param builtins.bool developer_only_attribute: Whether the attribute type is developer only.
        :param builtins.bool mutable: Whether the attribute can be changed once it has been created.
        ...
        :param builtins.bool required: Whether a user pool attribute is required. If the attribute is required and the user does not provide a value, registration or sign-in will fail.
...
class UserPoolSchemaNumberAttributeConstraints(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str max_value: Maximum value of an attribute that is of the number data type.
        :param builtins.str min_value: Minimum value of an attribute that is of the number data type.
        """
...
class UserPoolSchemaStringAttributeConstraints(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str max_length: Maximum length of an attribute value of the string type.
        :param builtins.str min_length: Minimum length of an attribute value of the string type.
        """
...
class UserPoolSignInPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] allowed_first_auth_factors: The sign in methods your user pool supports as the first factor. This is a list of strings, allowed values are `PASSWORD`, `EMAIL_OTP`, `SMS_OTP`, and `WEB_AUTHN`.
        """
...
class UserPoolSmsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str sns_caller_arn: ARN of the Amazon SNS caller. This is usually the IAM role that you've given Cognito permission to assume.
        :param builtins.str sns_region: The AWS Region to use with Amazon SNS integration. You can choose the same Region as your user pool, or a supported Legacy Amazon SNS alternate Region. Amazon Cognito resources in the Asia Pacific (Seoul) AWS Region must use your Amazon SNS configuration in the Asia Pacific (Tokyo) Region. For more information, see [SMS message settings for Amazon Cognito user pools](https://docs.aws.amazon.com/cognito/latest/developerguide/user-pool-sms-settings.html).
        """
        pulumi.set(__self__, "external_id", external_id)
...
class UserPoolUserAttributeUpdateSettings(dict):
    ...
    def __init__(__self__, *,
                 attributes_require_verification_before_updates: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] attributes_require_verification_before_updates: A list of attributes requiring verification before update. If set, the provided value(s) must also be set in `auto_verified_attributes`. Valid values: `email`, `phone_number`.
        """
    ...
    def attributes_require_verification_before_updates(self) -> Sequence[builtins.str]:
        """
...
class UserPoolUsernameConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool case_sensitive: Whether username case sensitivity will be applied for all users in the user pool through Cognito APIs.
        """
...
class UserPoolVerificationMessageTemplate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 sms_message: Optional[builtins.str] = None):
        """
        :param builtins.str default_email_option: Default email option. Must be either `CONFIRM_WITH_CODE` or `CONFIRM_WITH_LINK`. Defaults to `CONFIRM_WITH_CODE`.
        :param builtins.str email_message: Email message template. Must contain the `{####}` placeholder. Conflicts with `email_verification_message` argument.
        :param builtins.str email_message_by_link: Email message template for sending a confirmation link to the user, it must contain the `{##Click Here##}` placeholder.
        :param builtins.str email_subject: Subject line for the email message template. Conflicts with `email_verification_subject` argument.
        :param builtins.str email_subject_by_link: Subject line for the email message template for sending a confirmation link to the user.
        :param builtins.str sms_message: SMS message template. Must contain the `{####}` placeholder. Conflicts with `sms_verification_message` argument.
        """
...
class UserPoolWebAuthnConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_verification: Optional[builtins.str] = None):
        """
        :param builtins.str relying_party_id: The authentication domain that passkeys providers use as a relying party.
        :param builtins.str user_verification: If your user pool should require a passkey. Must be one of `required` or `preferred`.
        """
    ...
    def user_verification(self) -> Optional[builtins.str]:
        """
...
class GetUserGroupsGroupResult(dict):
    def __init__(__self__, *,
                 ...
                 role_arn: builtins.str):
        """
        :param builtins.str description: Description of the user group.
        :param builtins.str group_name: Name of the user group.
        :param builtins.int precedence: Precedence of the user group.
        :param builtins.str role_arn: ARN of the IAM role to be associated with the user group.
        """
...
class GetUserPoolAccountRecoverySettingRecoveryMechanismResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: - Name of the attribute.
        :param builtins.int priority: - Priority of this mechanism in the recovery process (lower numbers are higher priority).
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "priority", priority)
...
class GetUserPoolAdminCreateUserConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool allow_admin_create_user_only: - Whether only admins can create users.
        :param builtins.int unused_account_validity_days: - Number of days an unconfirmed user account remains valid.
    ...
    @property
    @pulumi.getter(name="allowAdminCreateUserOnly")
    def allow_admin_create_user_only(self) -> builtins.bool:
        """
    ...
    def unused_account_validity_days(self) -> builtins.int:
        """
...
class GetUserPoolAdminCreateUserConfigInviteMessageTemplateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str email_message: - Email message content.
        :param builtins.str email_subject: - Email message subject.
        :param builtins.str sms_message: - SMS message content.
        """
        pulumi.set(__self__, "email_message", email_message)
        pulumi.set(__self__, "email_subject", email_subject)
        pulumi.set(__self__, "sms_message", sms_message)
...
class GetUserPoolClientAnalyticsConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str application_arn: (Optional) Application ARN for an Amazon Pinpoint application. Conflicts with `external_id` and `role_arn`.
        :param builtins.str application_id: (Optional) Application ID for an Amazon Pinpoint application.
        :param builtins.str external_id: (Optional) ID for the Analytics Configuration. Conflicts with `application_arn`.
        :param builtins.str role_arn: (Optional) ARN of an IAM role that authorizes Amazon Cognito to publish events to Amazon Pinpoint analytics. Conflicts with `application_arn`.
        :param builtins.bool user_data_shared: (Optional) If set to `true`, Amazon Cognito will include user data in the events it publishes to Amazon Pinpoint analytics.
        """
        pulumi.set(__self__, "application_arn", application_arn)
        pulumi.set(__self__, "application_id", application_id)
        pulumi.set(__self__, "external_id", external_id)
    ...
    @property
    @pulumi.getter(name="userDataShared")
    def user_data_shared(self) -> builtins.bool:
        """
...
class GetUserPoolClientTokenValidityUnitResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str access_token: (Optional) Time unit in for the value in `access_token_validity`, defaults to `hours`.
        :param builtins.str id_token: (Optional) Time unit in for the value in `id_token_validity`, defaults to `hours`.
        :param builtins.str refresh_token: (Optional) Time unit in for the value in `refresh_token_validity`, defaults to `days`.
        """
        pulumi.set(__self__, "access_token", access_token)
        pulumi.set(__self__, "id_token", id_token)
        pulumi.set(__self__, "refresh_token", refresh_token)
...
class GetUserPoolDeviceConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool challenge_required_on_new_device: - Whether a challenge is required on new devices.
        :param builtins.bool device_only_remembered_on_user_prompt: - Whether devices are only remembered if the user prompts it.
        """
        pulumi.set(__self__, "challenge_required_on_new_device", challenge_required_on_new_device)
        pulumi.set(__self__, "device_only_remembered_on_user_prompt", device_only_remembered_on_user_prompt)
...
class GetUserPoolEmailConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 source_arn: builtins.str):
        """
        :param builtins.str configuration_set: - Configuration set used for sending emails.
        :param builtins.str email_sending_account: - Email sending account.
        :param builtins.str from_: - Email sender address.
        :param builtins.str reply_to_email_address: - Reply-to email address.
        :param builtins.str source_arn: - Source Amazon Resource Name (ARN) for emails.
        """
        pulumi.set(__self__, "configuration_set", configuration_set)
        pulumi.set(__self__, "email_sending_account", email_sending_account)
        pulumi.set(__self__, "from_", from_)
...
class GetUserPoolLambdaConfigCustomEmailSenderResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str lambda_version: - Version of the Lambda function.
        """
        pulumi.set(__self__, "lambda_arn", lambda_arn)
        pulumi.set(__self__, "lambda_version", lambda_version)
...
class GetUserPoolSchemaAttributeResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str attribute_data_type: - Data type of the attribute (e.g., string, number).
        :param builtins.bool developer_only_attribute: - Whether the attribute is for developer use only.
        :param builtins.bool mutable: - Whether the attribute can be changed after user creation.
        :param builtins.str name: - Name of the attribute.
        :param builtins.bool required: - Whether the attribute is required during user registration.
    ...
    @property
    @pulumi.getter(name="developerOnlyAttribute")
    def developer_only_attribute(self) -> builtins.bool:
        """
...
class GetUserPoolSchemaAttributeNumberAttributeConstraintResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str max_value: - Maximum allowed value.
        :param builtins.str min_value: - Minimum allowed value.
        """
        pulumi.set(__self__, "max_value", max_value)
        pulumi.set(__self__, "min_value", min_value)
...
class GetUserPoolSchemaAttributeStringAttributeConstraintResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str max_length: - Maximum allowed length.
        :param builtins.str min_length: - Minimum allowed length.
        """
        pulumi.set(__self__, "max_length", max_length)
        pulumi.set(__self__, "min_length", min_length)
