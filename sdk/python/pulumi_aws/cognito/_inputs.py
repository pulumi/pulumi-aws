...
class UserPoolAccountRecoverySettingRecoveryMechanismArgs:
    def __init__(__self__, *,
                 ...
                 priority: pulumi.Input[int]):
        """
        :param pulumi.Input[str] name: Recovery method for a user. Can be of the following: `verified_email`, `verified_phone_number`, and `admin_only`.
...
class UserPoolLambdaConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] pre_token_generation: Allow to customize identity token claims before token generation. Set this parameter for legacy purposes; for new instances of pre token generation triggers, set the lambda_arn of `pre_token_generation_config`.
...
if not MYPY:
    class UserPoolPasswordPolicyArgsDict(TypedDict):
        ...
        """
        password_history_size: NotRequired[pulumi.Input[int]]
        """
