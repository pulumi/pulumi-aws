...
class UserPoolClientArgs:
    def __init__(__self__, *,
                 ...
                 generate_secret: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] generate_secret: Boolean flag indicating whether an application secret should be generated.
        ...
        :param pulumi.Input[builtins.str] name: Name of the application client.
    ...
    def generate_secret(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def generate_secret(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class UserPoolClient(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            token_validity_units: Optional[pulumi.Input[Union['UserPoolClientTokenValidityUnitsArgs', 'UserPoolClientTokenValidityUnitsArgsDict']]] = None,
            user_pool_id: Optional[pulumi.Input[builtins.str]] = None,
            write_attributes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'UserPoolClient':
        """
    ...
    @property
    @pulumi.getter(name="generateSecret")
    def generate_secret(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean flag indicating whether an application secret should be generated.
        """
        return pulumi.get(self, "generate_secret")
