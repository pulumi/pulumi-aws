...
class UserPoolUICustomizationArgs:
    ...
    @property
    @pulumi.getter
    def css(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @css.setter
    def css(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "css", value)

    @property
    @pulumi.getter(name="imageFile")
    def image_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class _UserPoolUICustomizationState:
    def __init__(__self__, *,
                 ...
                 css: Optional[pulumi.Input[builtins.str]] = None,
                 css_version: Optional[pulumi.Input[builtins.str]] = None,
                 image_file: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] client_id: The client ID for the client app. Defaults to `ALL`. If `ALL` is specified, the `css` and/or `image_file` settings will be used for every client that has no UI customization set previously.
        :param pulumi.Input[builtins.str] creation_date: The creation date in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) for the UI customization.
        :param pulumi.Input[builtins.str] css: The CSS values in the UI customization, provided as a String. At least one of `css` or `image_file` is required.
        :param pulumi.Input[builtins.str] css_version: The CSS version number.
        :param pulumi.Input[builtins.str] image_file: The uploaded logo image for the UI customization, provided as a base64-encoded String. Drift detection is not possible for this argument. At least one of `css` or `image_file` is required.
    ...
    def css_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @css_version.setter
    def css_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UserPoolUICustomization(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def css(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The CSS values in the UI customization, provided as a String. At least one of `css` or `image_file` is required.
        """
        return pulumi.get(self, "css")
    ...
    @property
    @pulumi.getter(name="cssVersion")
    def css_version(self) -> pulumi.Output[builtins.str]:
        """
        The CSS version number.
        """
        return pulumi.get(self, "css_version")
    ...
    @property
    @pulumi.getter(name="imageFile")
    def image_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The uploaded logo image for the UI customization, provided as a base64-encoded String. Drift detection is not possible for this argument. At least one of `css` or `image_file` is required.
        """
        return pulumi.get(self, "image_file")
