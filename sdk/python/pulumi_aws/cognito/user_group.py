...
class UserGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] role_arn: The ARN of the IAM role to be associated with the user group.
        """
...
@pulumi.type_token("aws:cognito/userGroup:UserGroup")
class UserGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            role_arn: Optional[pulumi.Input[_builtins.str]] = None,
            user_pool_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'UserGroup':
        """
