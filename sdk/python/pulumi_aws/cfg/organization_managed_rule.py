...
class OrganizationManagedRuleArgs:
    def __init__(__self__, *,
                 rule_identifier: pulumi.Input[builtins.str],
    ...
    def rule_identifier(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def rule_identifier(self, value: pulumi.Input[builtins.str]):
    ...
    def resource_id_scope(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OrganizationManagedRuleState:
    ...
    @property
    @pulumi.getter(name="ruleIdentifier")
    def rule_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Identifier of an available AWS Config Managed Rule to call. For available values, see the [List of AWS Config Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/managed-rules-by-aws-config.html) documentation
        """
        return pulumi.get(self, "rule_identifier")
    ...
    @rule_identifier.setter
    def rule_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rule_identifier", value)
...
class OrganizationManagedRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rule_identifier: Optional[pulumi.Input[builtins.str]] = None,
            tag_key_scope: Optional[pulumi.Input[builtins.str]] = None,
            tag_value_scope: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationManagedRule':
        """
    ...
    @property
    @pulumi.getter(name="ruleIdentifier")
    def rule_identifier(self) -> pulumi.Output[builtins.str]:
        """
        Identifier of an available AWS Config Managed Rule to call. For available values, see the [List of AWS Config Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/managed-rules-by-aws-config.html) documentation
        """
        return pulumi.get(self, "rule_identifier")
