...
class ConformancePackArgs:
    def __init__(__self__, *,
                 ...
                 input_parameters: pulumi.Input[Optional[Sequence[pulumi.Input['ConformancePackInputParameterArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the conformance pack. Must begin with a letter and contain from 1 to 256 alphanumeric characters and hyphens.
    ...
    def delivery_s3_bucket(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def delivery_s3_bucket(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "delivery_s3_bucket", value)

    @_builtins.property
    @pulumi.getter(name="deliveryS3KeyPrefix")
    def delivery_s3_key_prefix(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def delivery_s3_key_prefix(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "delivery_s3_key_prefix", value)

    @_builtins.property
    @pulumi.getter(name="inputParameters")
    def input_parameters(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ConformancePackInputParameterArgs']]]]:
        """
    ...
    def input_parameters(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ConformancePackInputParameterArgs']]]]):
    ...
    def template_s3_uri(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def template_s3_uri(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ConformancePack(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 delivery_s3_bucket: pulumi.Input[Optional[_builtins.str]] = None,
                 delivery_s3_key_prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 input_parameters: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ConformancePackInputParameterArgs', 'ConformancePackInputParameterArgsDict', 'outputs.ConformancePackInputParameter']]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 template_body: pulumi.Input[Optional[_builtins.str]] = None,
                 template_s3_uri: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        * `region` (String) Region where this resource is managed.
        ...
        :param pulumi.Input[_builtins.str] delivery_s3_bucket: Amazon S3 bucket where AWS Config stores conformance pack templates. Maximum length of 63.
        :param pulumi.Input[_builtins.str] delivery_s3_key_prefix: The prefix for the Amazon S3 bucket. Maximum length of 1024.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ConformancePackInputParameterArgs', 'ConformancePackInputParameterArgsDict', 'outputs.ConformancePackInputParameter']]]] input_parameters: Set of configuration blocks describing input parameters passed to the conformance pack template. Documented below. When configured, the parameters must also be included in the `template_body` or in the template stored in Amazon S3 if using `template_s3_uri`.
        :param pulumi.Input[_builtins.str] name: The name of the conformance pack. Must begin with a letter and contain from 1 to 256 alphanumeric characters and hyphens.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[_builtins.str] template_body: A string containing full conformance pack template body. Maximum length of 51200. Drift detection is not possible with this argument.
        :param pulumi.Input[_builtins.str] template_s3_uri: Location of file, e.g., `s3://bucketname/prefix`, containing the template body. The uri must point to the conformance pack template that is located in an Amazon S3 bucket in the same region as the conformance pack. Maximum length of 1024. Drift detection is not possible with this argument.
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            template_body: pulumi.Input[Optional[_builtins.str]] = None,
            template_s3_uri: pulumi.Input[Optional[_builtins.str]] = None) -> 'ConformancePack':
        """
