...
class Recorder(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if recording_group is not None and not isinstance(recording_group, RecorderRecordingGroupArgs):
                recording_group = recording_group or {}
                def _setter(key, value):
                    recording_group[key] = value
                RecorderRecordingGroupArgs._configure(_setter, **recording_group)
