...
__all__ = ['RecorderArrgs', 'Recorder']

@pulumi.input_type
calass RecorderArrgs:
    def __init__(__self__, *,
                 role_arn: pulumi.Input[str],
                 name: Optional[pulumi.Input[str]] = None,
                 recording_group: Optional[pulumi.Input['RecorderRecordingGroupArrgs']] = None):
        """
        ...
        :param pulumi.Input['RecorderRecordingGroupArrgs'] recording_group: Recording group - see below.
        """
    ...
    def recording_group(self) -> Optional[pulumi.Input['RecorderRecordingGroupArrgs']]:
        """
    ...
    def recording_group(self, value: Optional[pulumi.Input['RecorderRecordingGroupArrgs']]):
        pulumi.set(self, "recording_group", value)


@pulumi.input_type
calass _RecorderState:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[str]] = None,
                 recording_group: Optional[pulumi.Input['RecorderRecordingGroupArrgs']] = None,
...
calass Recorder(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 recording_group: Optional[pulumi.Input[pulumi.InputType['RecorderRecordingGroupArrgs']]] = None,
                 role_arn: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        foo = aws.cfg.Recorder("foo",
            ...
            recording_group=aws.cfg.RecorderRecordingGroupArrgs(
                all_supported=False,
                exclusion_by_resource_types=[aws.cfg.RecorderRecordingGroupExclusionByResourceTypeArrgs(
                    resource_types=["AWS::EC2::Instance"],
                )],
                recording_strategies=[aws.cfg.RecorderRecordingGroupRecordingStrategyArrgs(
        ...
        :param pulumi.Input[str] name: The name of the recorder. Defaults to `default`. Changing it recreates the resource.
        :param pulumi.Input[pulumi.InputType['RecorderRecordingGroupArrgs']] recording_group: Recording group - see below.
        :param pulumi.Input[str] role_arn: Amazon Resource Name (ARN) of the IAM role. Used to make read or write requests to the delivery channel and to describe the AWS resources associated with the account. See [AWS Docs](http://docs.aws.amazon.com/config/latest/developerguide/iamrole-permissions.html) for more details.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param RecorderArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RecorderArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RecorderArrgs.__new__(RecorderArrgs)
