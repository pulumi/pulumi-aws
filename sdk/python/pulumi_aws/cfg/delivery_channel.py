...
class DeliveryChannelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] sns_topic_arn: The ARN of the SNS topic that AWS Config delivers notifications to.
        """
    ...
    def s3_kms_key_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def s3_kms_key_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DeliveryChannel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            s3_kms_key_arn: Optional[pulumi.Input[builtins.str]] = None,
            snapshot_delivery_properties: Optional[pulumi.Input[Union['DeliveryChannelSnapshotDeliveryPropertiesArgs', 'DeliveryChannelSnapshotDeliveryPropertiesArgsDict']]] = None,
            sns_topic_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'DeliveryChannel':
        """
    ...
    @property
    @pulumi.getter(name="s3KmsKeyArn")
    def s3_kms_key_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the AWS KMS key used to encrypt objects delivered by AWS Config. Must belong to the same Region as the destination S3 bucket.
        """
        return pulumi.get(self, "s3_kms_key_arn")
