...
class OrganizationCustomRuleArgs:
    def __init__(__self__, *,
                 ...
                 trigger_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[builtins.str] lambda_function_arn: Amazon Resource Name (ARN) of the rule Lambda Function
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trigger_types: List of notification types that trigger AWS Config to run an evaluation for the rule. Valid values: `ConfigurationItemChangeNotification`, `OversizedConfigurationItemChangeNotification`, and `ScheduledNotification`
    ...
    def trigger_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _OrganizationCustomRuleState:
    ...
    @trigger_types.setter
    def trigger_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "trigger_types", value)
...
class OrganizationCustomRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tag_key_scope: Optional[pulumi.Input[builtins.str]] = None,
            tag_value_scope: Optional[pulumi.Input[builtins.str]] = None,
            trigger_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'OrganizationCustomRule':
        """
