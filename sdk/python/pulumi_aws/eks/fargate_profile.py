...
class FargateProfileArgs:
    ...
    def pod_execution_role_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def pod_execution_role_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def fargate_profile_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fargate_profile_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FargateProfileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the EKS Fargate Profile.
        :param pulumi.Input[builtins.str] cluster_name: Name of the EKS Cluster.
        :param pulumi.Input[builtins.str] fargate_profile_name: Name of the EKS Fargate Profile.
        :param pulumi.Input[builtins.str] pod_execution_role_arn: Amazon Resource Name (ARN) of the IAM Role that provides permissions for the EKS Fargate Profile.
        :param pulumi.Input[Sequence[pulumi.Input['FargateProfileSelectorArgs']]] selectors: Configuration block(s) for selecting Kubernetes Pods to execute with this EKS Fargate Profile. Detailed below.
...
class FargateProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'FargateProfile':
        """
    ...
    @property
    @pulumi.getter(name="fargateProfileName")
    def fargate_profile_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the EKS Fargate Profile.
        """
        return pulumi.get(self, "fargate_profile_name")
    ...
    @property
    @pulumi.getter(name="podExecutionRoleArn")
    def pod_execution_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        Amazon Resource Name (ARN) of the IAM Role that provides permissions for the EKS Fargate Profile.
        """
        return pulumi.get(self, "pod_execution_role_arn")
