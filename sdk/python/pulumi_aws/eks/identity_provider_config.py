...
class IdentityProviderConfigArgs:
    ...
    def _configure(
        ...
        if oidc is None:
            raise TypeError("Missing 'oidc' argument")
...
class _IdentityProviderConfigState:
    def __init__(__self__, *,
        ...
        """
        _IdentityProviderConfigState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            arn=arn,
            cluster_name=cluster_name,
            oidc=oidc,
...
class IdentityProviderConfig(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if oidc is not None and not isinstance(oidc, IdentityProviderConfigOidcArgs):
                oidc = oidc or {}
                def _setter(key, value):
                    oidc[key] = value
                IdentityProviderConfigOidcArgs._configure(_setter, **oidc)
