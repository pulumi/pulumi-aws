...
class _IdentityProviderConfigState:
    def __init__(__self__, *,
                 ...
                 oidc: pulumi.Input[Optional['IdentityProviderConfigOidcArgs']] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input['IdentityProviderConfigOidcArgs'] oidc: Nested attribute containing [OpenID Connect](https://openid.net/connect/) identity provider information for the cluster. Detailed below.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[_builtins.str] status: Status of the EKS Identity Provider Configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Key-value map of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    @_builtins.property
    @pulumi.getter
    def oidc(self) -> pulumi.Input[Optional['IdentityProviderConfigOidcArgs']]:
        """
        Nested attribute containing [OpenID Connect](https://openid.net/connect/) identity provider information for the cluster. Detailed below.
        """
        return pulumi.get(self, "oidc")
    ...
    @oidc.setter
    def oidc(self, value: pulumi.Input[Optional['IdentityProviderConfigOidcArgs']]):
        pulumi.set(self, "oidc", value)
...
class IdentityProviderConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 cluster_name: pulumi.Input[Optional[_builtins.str]] = None,
                 oidc: pulumi.Input[Optional[Union['IdentityProviderConfigOidcArgs', 'IdentityProviderConfigOidcArgsDict', 'outputs.IdentityProviderConfigOidc']]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        * `region` (String) Region where this resource is managed.
        ...
        :param pulumi.Input[_builtins.str] cluster_name: Name of the EKS Cluster.
        :param pulumi.Input[Union['IdentityProviderConfigOidcArgs', 'IdentityProviderConfigOidcArgsDict', 'outputs.IdentityProviderConfigOidc']] oidc: Nested attribute containing [OpenID Connect](https://openid.net/connect/) identity provider information for the cluster. Detailed below.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Key-value map of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
        ...
    ...
    def get(resource_name: str,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'IdentityProviderConfig':
        """
