...
class Cluster(pulumi.CustomResource):
    ...
    Nested argument for the VPC associated with your cluster. Amazon EKS VPC resources have specific requirements to work properly with Kubernetes. For more information, see [Cluster VPC Considerations](https://docs.aws.amazon.com/eks/latest/userguide/network_reqs.html) and [Cluster Security Group Considerations](https://docs.aws.amazon.com/eks/latest/userguide/sec-group-reqs.html) in the Amazon EKS User Guide. Configuration detailed below.
      ...
      * `cluster_security_group_id` (`str`) - The cluster security group that was created by Amazon EKS for the cluster.
      * `endpoint_private_access` (`bool`) - Indicates whether or not the Amazon EKS private API server endpoint is enabled. Default is `false`.
      * `endpoint_public_access` (`bool`) - Indicates whether or not the Amazon EKS public API server endpoint is enabled. Default is `true`.
    ...
    def __init__(__self__, resource_name, opts=None, enabled_cluster_log_types=None, name=None, role_arn=None, tags=None, version=None, vpc_config=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **vpc_config** object supports the following:
          ...
          * `cluster_security_group_id` (`pulumi.Input[str]`) - The cluster security group that was created by Amazon EKS for the cluster.
          * `endpoint_private_access` (`pulumi.Input[bool]`) - Indicates whether or not the Amazon EKS private API server endpoint is enabled. Default is `false`.
          * `endpoint_public_access` (`pulumi.Input[bool]`) - Indicates whether or not the Amazon EKS public API server endpoint is enabled. Default is `true`.
