...
class NodeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] disk_size: Disk size in GiB for worker nodes. Defaults to `20`. The provider will only perform drift detection if a configuration value is provided.
