...
class _AccessPolicyAssociationState:
    def __init__(__self__, *,
                 ...
                 associated_at: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['AccessPolicyAssociationAccessScopeArgs'] access_scope: The configuration block to determine the scope of the access. See `access_scope` Block below.
        :param pulumi.Input[builtins.str] associated_at: Date and time in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) that the policy was associated.
        :param pulumi.Input[builtins.str] cluster_name: Name of the EKS Cluster.
    ...
    def associated_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def associated_at(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="policyArn")
    def policy_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the access policy that you're associating.
        """
        return pulumi.get(self, "policy_arn")
    ...
    @policy_arn.setter
    def policy_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "policy_arn", value)
...
class AccessPolicyAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            modified_at: Optional[pulumi.Input[builtins.str]] = None,
            policy_arn: Optional[pulumi.Input[builtins.str]] = None,
            principal_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'AccessPolicyAssociation':
        """
    ...
    @property
    @pulumi.getter(name="associatedAt")
    def associated_at(self) -> pulumi.Output[builtins.str]:
        """
        Date and time in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) that the policy was associated.
        """
        return pulumi.get(self, "associated_at")
