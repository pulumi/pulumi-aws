...
if not MYPY:
    class LanguageModelInputDataConfigArgsDict(TypedDict):
        ...
        """
        tuning_data_s3_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LanguageModelInputDataConfigArgs:
    def __init__(__self__, *,
                 data_access_role_arn: pulumi.Input[builtins.str],
                 s3_uri: pulumi.Input[builtins.str],
                 tuning_data_s3_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] data_access_role_arn: IAM role with access to S3 bucket.
        :param pulumi.Input[builtins.str] s3_uri: S3 URI where training data is located.
        :param pulumi.Input[builtins.str] tuning_data_s3_uri: S3 URI where tuning data is located.
    ...
    def tuning_data_s3_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        S3 URI where tuning data is located.
    ...
    def tuning_data_s3_uri(self, value: Optional[pulumi.Input[builtins.str]]):
