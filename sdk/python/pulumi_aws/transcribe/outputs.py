...
class LanguageModelInputDataConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_uri: builtins.str,
                 tuning_data_s3_uri: Optional[builtins.str] = None):
        """
        :param builtins.str data_access_role_arn: IAM role with access to S3 bucket.
        :param builtins.str s3_uri: S3 URI where training data is located.
        :param builtins.str tuning_data_s3_uri: S3 URI where tuning data is located.
    ...
    def tuning_data_s3_uri(self) -> Optional[builtins.str]:
        """
