...
class NetworkPeeringConnectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] peer_network_id: Unique identifier of the ODB peering connection. Changing this will force Terraform to create a new resource. Either odb_network_id or odb_network_arn should be used.
        ...
        :param pulumi.Input[_builtins.str] odb_network_id: Unique identifier of the ODB network that initiates the peering connection. A sample ID is `odbpcx-abcdefgh12345678`. Changing this will force Terraform to create a new resource.
    ...
    def peer_network_id(self) -> pulumi.Input[_builtins.str]:
        """
        Unique identifier of the ODB peering connection. Changing this will force Terraform to create a new resource. Either odb_network_id or odb_network_arn should be used.
...
class _NetworkPeeringConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] arn: ARN of the ODB network peering connection.
        ...
        :param pulumi.Input[_builtins.str] status_reason: Reason for the current status of the ODB peering connection.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Map of tags to assign to the resource. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags_all: Map of tags assigned to the resource, including inherited tags.
        """
        if arn is not None:
