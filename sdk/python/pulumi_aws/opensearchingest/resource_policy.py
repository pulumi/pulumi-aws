...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] policy: JSON-formatted policy to attach to the resource.
        :param pulumi.Input[_builtins.str] resource_arn: ARN of the resource to attach the policy to.
...
@pulumi.type_token("aws:opensearchingest/resourcePolicy:ResourcePolicy")
class ResourcePolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `resource_arn` (String) ARN of the resource the policy is attached to.
        ...
        Using `pulumi import`, import OpenSearch Ingestion Resource Policy using the `resource_arn`. For example:
