...
__all__ = [
    ...
    'PipelineLogPublishingOptionsCloudwatchLogDestinationArgsDict',
    'PipelineTimeoutsArgs',
    'PipelineTimeoutsArgsDict',
...
class PipelineEncryptionAtRestOptionsArgs:
    def __init__(__self__, *,
                 kms_key_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_arn: The ARN of the KMS key used to encrypt data-at-rest in OpenSearch Ingestion. By default, data is encrypted using an AWS owned key.
        """
...
class PipelineLogPublishingOptionsCloudwatchLogDestinationArgs:
    def __init__(__self__, *,
                 log_group: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] log_group: The name of the CloudWatch Logs group to send pipeline logs to. You can specify an existing log group or create a new one. For example, /aws/OpenSearchService/IngestionService/my-pipeline.
        """
...
if not MYPY:
    class PipelineVpcOptionsArgsDict(TypedDict):
        ...
        """
        vpc_endpoint_management: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipelineVpcOptionsArgs:
    def __init__(__self__, *,
                 ...
                 vpc_endpoint_management: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] vpc_endpoint_management: Whether you or Amazon OpenSearch Ingestion service create and manage the VPC endpoint configured for the pipeline. Valid values are `CUSTOMER` or `SERVICE`
        """
    ...
    def vpc_endpoint_management(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether you or Amazon OpenSearch Ingestion service create and manage the VPC endpoint configured for the pipeline. Valid values are `CUSTOMER` or `SERVICE`
        """
    ...
    def vpc_endpoint_management(self, value: Optional[pulumi.Input[builtins.str]]):
