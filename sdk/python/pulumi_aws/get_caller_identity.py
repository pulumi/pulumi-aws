...
def get_caller_identity(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Account ID number of the account that owns or contains the calling entity.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_caller_identity_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
