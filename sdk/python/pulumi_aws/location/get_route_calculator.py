...
def get_route_calculator(calculator_name: Optional[_builtins.str] = None,
...
def get_route_calculator_output(calculator_name: Optional[pulumi.Input[_builtins.str]] = None,
