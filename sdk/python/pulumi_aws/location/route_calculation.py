...
class RouteCalculationArgs:
    def __init__(__self__, *,
                 calculator_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] calculator_name: The name of the route calculator resource.
        :param pulumi.Input[builtins.str] data_source: Specifies the data provider of traffic and road network data.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] description: The optional description for the route calculator resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value tags for the route calculator. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
    ...
    def calculator_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def calculator_name(self, value: pulumi.Input[builtins.str]):
...
class _RouteCalculationState:
    def __init__(__self__, *,
                 calculator_arn: Optional[pulumi.Input[builtins.str]] = None,
                 calculator_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] calculator_arn: The Amazon Resource Name (ARN) for the Route calculator resource. Use the ARN when you specify a resource across AWS.
        :param pulumi.Input[builtins.str] calculator_name: The name of the route calculator resource.
        :param pulumi.Input[builtins.str] create_time: The timestamp for when the route calculator resource was created in ISO 8601 format.
        :param pulumi.Input[builtins.str] data_source: Specifies the data provider of traffic and road network data.
        ...
        :param pulumi.Input[builtins.str] update_time: The timestamp for when the route calculator resource was last update in ISO 8601.
        """
    ...
    def calculator_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def calculator_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "calculator_arn", value)

    @property
    @pulumi.getter(name="calculatorName")
    def calculator_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the route calculator resource.
        """
        return pulumi.get(self, "calculator_name")
    ...
    @calculator_name.setter
    def calculator_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "calculator_name", value)
...
class RouteCalculation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'RouteCalculation':
        """
    ...
    @property
    @pulumi.getter(name="calculatorArn")
    def calculator_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) for the Route calculator resource. Use the ARN when you specify a resource across AWS.
        """
        return pulumi.get(self, "calculator_arn")
    ...
    @property
    @pulumi.getter(name="calculatorName")
    def calculator_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the route calculator resource.
        """
        return pulumi.get(self, "calculator_name")
