...
class MapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] map_name: The name for the map resource.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] description: An optional description for the map resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value tags for the map. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
...
class _MapState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 map_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['MapConfigurationArgs'] configuration: Configuration block with the map style selected from an available data provider. Detailed below.
        :param pulumi.Input[builtins.str] create_time: The timestamp for when the map resource was created in ISO 8601 format.
        :param pulumi.Input[builtins.str] description: An optional description for the map resource.
        :param pulumi.Input[builtins.str] map_arn: The Amazon Resource Name (ARN) for the map resource. Used to specify a resource across all AWS.
        :param pulumi.Input[builtins.str] map_name: The name for the map resource.
               
               The following arguments are optional:
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value tags for the map. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags_all: A map of tags assigned to the resource, including those inherited from the provider `default_tags` configuration block.
        :param pulumi.Input[builtins.str] update_time: The timestamp for when the map resource was last updated in ISO 8601 format.
        """
    ...
    def map_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @map_arn.setter
    def map_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Map(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'Map':
        """
    ...
    @property
    @pulumi.getter(name="mapArn")
    def map_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) for the map resource. Used to specify a resource across all AWS.
        """
        return pulumi.get(self, "map_arn")
    ...
    @property
    @pulumi.getter(name="mapName")
    def map_name(self) -> pulumi.Output[builtins.str]:
        """
        The name for the map resource.
