...
class PlaceIndexArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_source: Specifies the geospatial data provider for the new place index.
...
class _PlaceIndexState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] create_time: The timestamp for when the place index resource was created in ISO 8601 format.
        :param pulumi.Input[builtins.str] data_source: Specifies the geospatial data provider for the new place index.
        :param pulumi.Input['PlaceIndexDataSourceConfigurationArgs'] data_source_configuration: Configuration block with the data storage option chosen for requesting Places. Detailed below.
        :param pulumi.Input[builtins.str] description: The optional description for the place index resource.
        :param pulumi.Input[builtins.str] index_arn: The Amazon Resource Name (ARN) for the place index resource. Used to specify a resource across AWS.
        :param pulumi.Input[builtins.str] index_name: The name of the place index resource.
    ...
    def index_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @index_arn.setter
    def index_arn(self, value: Optional[pulumi.Input[builtins.str]]):
