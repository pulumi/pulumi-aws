...
class CertificateAuthority(pulumi.CustomResource):
    ...
    Nested argument containing algorithms and certificate subject information. Defined below.
      ...
      * `key_algorithm` (`str`) - Type of the public key algorithm and size, in bits, of the key pair that your key pair creates when it issues a certificate. Valid values can be found in the [ACM PCA Documentation](https://docs.aws.amazon.com/acm-pca/latest/APIReference/API_CertificateAuthorityConfiguration.html).
      * `signing_algorithm` (`str`) - Name of the algorithm your private CA uses to sign certificate requests. Valid values can be found in the [ACM PCA Documentation](https://docs.aws.amazon.com/acm-pca/latest/APIReference/API_CertificateAuthorityConfiguration.html).
      * `subject` (`dict`) - Nested argument that contains X.500 distinguished name information. At least one nested attribute must be specified.
        ...
        * `common_name` (`str`) - Fully qualified domain name (FQDN) associated with the certificate subject.
    ...
    Nested argument containing revocation configuration. Defined below.
      ...
      * `crl_configuration` (`dict`) - Nested argument containing configuration of the certificate revocation list (CRL), if any, maintained by the certificate authority. Defined below.
    
        * `custom_cname` (`str`) - Name inserted into the certificate CRL Distribution Points extension that enables the use of an alias for the CRL distribution point. Use this value if you don't want the name of your S3 bucket to be public.
        * `enabled` (`bool`) - Boolean value that specifies whether certificate revocation lists (CRLs) are enabled. Defaults to `false`.
        * `expiration_in_days` (`float`) - Number of days until a certificate expires. Must be between 1 and 5000.
    ...
    def __init__(__self__, resource_name, opts=None, certificate_authority_configuration=None, enabled=None, permanent_deletion_time_in_days=None, revocation_configuration=None, tags=None, type=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **certificate_authority_configuration** object supports the following:
          ...
          * `key_algorithm` (`pulumi.Input[str]`) - Type of the public key algorithm and size, in bits, of the key pair that your key pair creates when it issues a certificate. Valid values can be found in the [ACM PCA Documentation](https://docs.aws.amazon.com/acm-pca/latest/APIReference/API_CertificateAuthorityConfiguration.html).
          * `signing_algorithm` (`pulumi.Input[str]`) - Name of the algorithm your private CA uses to sign certificate requests. Valid values can be found in the [ACM PCA Documentation](https://docs.aws.amazon.com/acm-pca/latest/APIReference/API_CertificateAuthorityConfiguration.html).
          * `subject` (`pulumi.Input[dict]`) - Nested argument that contains X.500 distinguished name information. At least one nested attribute must be specified.
            ...
            * `common_name` (`pulumi.Input[str]`) - Fully qualified domain name (FQDN) associated with the certificate subject.
            * `country` (`pulumi.Input[str]`) - Two digit code that specifies the country in which the certificate subject located.
            * `distinguished_name_qualifier` (`pulumi.Input[str]`) - Disambiguating information for the certificate subject.
            * `generation_qualifier` (`pulumi.Input[str]`) - Typically a qualifier appended to the name of an individual. Examples include Jr. for junior, Sr. for senior, and III for third.
            * `given_name` (`pulumi.Input[str]`) - First name.
            ...
            * `organizational_unit` (`pulumi.Input[str]`) - A subdivision or unit of the organization (such as sales or finance) with which the certificate subject is affiliated.
        ...
        The **revocation_configuration** object supports the following:
          ...
          * `crl_configuration` (`pulumi.Input[dict]`) - Nested argument containing configuration of the certificate revocation list (CRL), if any, maintained by the certificate authority. Defined below.
        
            * `custom_cname` (`pulumi.Input[str]`) - Name inserted into the certificate CRL Distribution Points extension that enables the use of an alias for the CRL distribution point. Use this value if you don't want the name of your S3 bucket to be public.
            ...
            * `expiration_in_days` (`pulumi.Input[float]`) - Number of days until a certificate expires. Must be between 1 and 5000.
