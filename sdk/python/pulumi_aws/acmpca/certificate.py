...
class CertificateArgs:
    def __init__(__self__, *,
                 ...
                 certificate_signing_request: pulumi.Input[builtins.str],
                 signing_algorithm: pulumi.Input[builtins.str],
                 validity: pulumi.Input['CertificateValidityArgs'],
                 api_passthrough: Optional[pulumi.Input[builtins.str]] = None,
                 template_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def certificate_signing_request(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def certificate_signing_request(self, value: pulumi.Input[builtins.str]):
    ...
    def api_passthrough(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def api_passthrough(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "api_passthrough", value)

    @property
    @pulumi.getter(name="templateArn")
    def template_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @template_arn.setter
    def template_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate: PEM-encoded certificate value.
        :param pulumi.Input[builtins.str] certificate_authority_arn: ARN of the certificate authority.
...
class Certificate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="apiPassthrough")
    def api_passthrough(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies X.509 certificate information to be included in the issued certificate. To use with API Passthrough templates
        """
        return pulumi.get(self, "api_passthrough")
    ...
    @property
    @pulumi.getter(name="templateArn")
    def template_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Template to use when issuing a certificate.
        See [ACM PCA Documentation](https://docs.aws.amazon.com/privateca/latest/userguide/UsingTemplates.html) for more information.
        """
