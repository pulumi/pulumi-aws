...
class CertificateAuthorityCertificateAuthorityConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_algorithm: Type of the public key algorithm and size, in bits, of the key pair that your key pair creates when it issues a certificate. Valid values can be found in the [ACM PCA Documentation](https://docs.aws.amazon.com/privateca/latest/APIReference/API_CertificateAuthorityConfiguration.html).
        :param builtins.str signing_algorithm: Name of the algorithm your private CA uses to sign certificate requests. Valid values can be found in the [ACM PCA Documentation](https://docs.aws.amazon.com/privateca/latest/APIReference/API_CertificateAuthorityConfiguration.html).
...
class CertificateAuthorityCertificateAuthorityConfigurationSubject(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str common_name: Fully qualified domain name (FQDN) associated with the certificate subject. Must be less than or equal to 64 characters in length.
        :param builtins.str country: Two digit code that specifies the country in which the certificate subject located. Must be less than or equal to 2 characters in length.
        :param builtins.str distinguished_name_qualifier: Disambiguating information for the certificate subject. Must be less than or equal to 64 characters in length.
        :param builtins.str generation_qualifier: Typically a qualifier appended to the name of an individual. Examples include Jr. for junior, Sr. for senior, and III for third. Must be less than or equal to 3 characters in length.
        :param builtins.str given_name: First name. Must be less than or equal to 16 characters in length.
        :param builtins.str initials: Concatenation that typically contains the first letter of the `given_name`, the first letter of the middle name if one exists, and the first letter of the `surname`. Must be less than or equal to 5 characters in length.
        :param builtins.str locality: Locality (such as a city or town) in which the certificate subject is located. Must be less than or equal to 128 characters in length.
        :param builtins.str organization: Legal name of the organization with which the certificate subject is affiliated. Must be less than or equal to 64 characters in length.
        :param builtins.str organizational_unit: Subdivision or unit of the organization (such as sales or finance) with which the certificate subject is affiliated. Must be less than or equal to 64 characters in length.
        :param builtins.str pseudonym: Typically a shortened version of a longer `given_name`. For example, Jonathan is often shortened to John. Elizabeth is often shortened to Beth, Liz, or Eliza. Must be less than or equal to 128 characters in length.
        :param builtins.str state: State in which the subject of the certificate is located. Must be less than or equal to 128 characters in length.
        :param builtins.str surname: Family name. In the US and the UK for example, the surname of an individual is ordered last. In Asian cultures the surname is typically ordered first. Must be less than or equal to 40 characters in length.
        :param builtins.str title: Title such as Mr. or Ms. which is pre-pended to the name to refer formally to the certificate subject. Must be less than or equal to 64 characters in length.
        """
...
class CertificateAuthorityRevocationConfigurationCrlConfiguration(dict):
    ...
    def __init__(__self__, *,
                 custom_cname: Optional[builtins.str] = None,
                 enabled: Optional[builtins.bool] = None,
                 expiration_in_days: Optional[builtins.int] = None,
                 s3_bucket_name: Optional[builtins.str] = None,
                 s3_object_acl: Optional[builtins.str] = None):
        """
        :param builtins.str custom_cname: Name inserted into the certificate CRL Distribution Points extension that enables the use of an alias for the CRL distribution point. Use this value if you don't want the name of your S3 bucket to be public. Must be less than or equal to 253 characters in length.
        :param builtins.bool enabled: Boolean value that specifies whether certificate revocation lists (CRLs) are enabled. Defaults to `false`.
        :param builtins.int expiration_in_days: Number of days until a certificate expires. Must be between 1 and 5000.
        :param builtins.str s3_bucket_name: Name of the S3 bucket that contains the CRL. If you do not provide a value for the `custom_cname` argument, the name of your S3 bucket is placed into the CRL Distribution Points extension of the issued certificate. You must specify a bucket policy that allows ACM PCA to write the CRL to your bucket. Must be between 3 and 255 characters in length.
        :param builtins.str s3_object_acl: Determines whether the CRL will be publicly readable or privately held in the CRL Amazon S3 bucket. Defaults to `PUBLIC_READ`.
        """
    ...
    def custom_cname(self) -> Optional[builtins.str]:
        """
    ...
    def s3_object_acl(self) -> Optional[builtins.str]:
        """
...
class CertificateAuthorityRevocationConfigurationOcspConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ocsp_custom_cname: Optional[builtins.str] = None):
        """
        :param builtins.bool enabled: Boolean value that specifies whether a custom OCSP responder is enabled.
        :param builtins.str ocsp_custom_cname: CNAME specifying a customized OCSP domain. Note: The value of the CNAME must not include a protocol prefix such as "http://" or "https://".
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def ocsp_custom_cname(self) -> Optional[builtins.str]:
        """
...
class CertificateValidity(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str type: Determines how `value` is interpreted. Valid values: `DAYS`, `MONTHS`, `YEARS`, `ABSOLUTE`, `END_DATE`.
        :param builtins.str value: If `type` is `DAYS`, `MONTHS`, or `YEARS`, the relative time until the certificate expires. If `type` is `ABSOLUTE`, the date in seconds since the Unix epoch. If `type` is `END_DATE`, the  date in RFC 3339 format.
        """
...
class GetCertificateAuthorityRevocationConfigurationCrlConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 s3_object_acl: builtins.str):
        """
        :param builtins.str custom_cname: Name inserted into the certificate CRL Distribution Points extension that enables the use of an alias for the CRL distribution point.
        :param builtins.bool enabled: Boolean value that specifies whether certificate revocation lists (CRLs) are enabled.
        :param builtins.int expiration_in_days: Number of days until a certificate expires.
        :param builtins.str s3_bucket_name: Name of the S3 bucket that contains the CRL.
        :param builtins.str s3_object_acl: Whether the CRL is publicly readable or privately held in the CRL Amazon S3 bucket.
        """
        pulumi.set(__self__, "custom_cname", custom_cname)
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "expiration_in_days", expiration_in_days)
    ...
    @property
    @pulumi.getter(name="expirationInDays")
    def expiration_in_days(self) -> builtins.int:
        """
...
class GetCertificateAuthorityRevocationConfigurationOcspConfigurationResult(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool,
                 ocsp_custom_cname: builtins.str):
        """
        :param builtins.bool enabled: Boolean value that specifies whether a custom OCSP responder is enabled.
        :param builtins.str ocsp_custom_cname: A CNAME specifying a customized OCSP domain.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "ocsp_custom_cname", ocsp_custom_cname)
