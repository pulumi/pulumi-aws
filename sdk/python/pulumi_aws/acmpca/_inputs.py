...
class CertificateAuthorityCertificateAuthorityConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key_algorithm: Type of the public key algorithm and size, in bits, of the key pair that your key pair creates when it issues a certificate. Valid values can be found in the [ACM PCA Documentation](https://docs.aws.amazon.com/privateca/latest/APIReference/API_CertificateAuthorityConfiguration.html).
        :param pulumi.Input[builtins.str] signing_algorithm: Name of the algorithm your private CA uses to sign certificate requests. Valid values can be found in the [ACM PCA Documentation](https://docs.aws.amazon.com/privateca/latest/APIReference/API_CertificateAuthorityConfiguration.html).
...
if not MYPY:
    class CertificateAuthorityCertificateAuthorityConfigurationSubjectArgsDict(TypedDict):
        ...
        """
        distinguished_name_qualifier: NotRequired[pulumi.Input[builtins.str]]
        """
        Disambiguating information for the certificate subject. Must be less than or equal to 64 characters in length.
        """
        generation_qualifier: NotRequired[pulumi.Input[builtins.str]]
        """
        Typically a qualifier appended to the name of an individual. Examples include Jr. for junior, Sr. for senior, and III for third. Must be less than or equal to 3 characters in length.
        """
        given_name: NotRequired[pulumi.Input[builtins.str]]
        """
        First name. Must be less than or equal to 16 characters in length.
        """
        initials: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        pseudonym: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        surname: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CertificateAuthorityCertificateAuthorityConfigurationSubjectArgs:
    def __init__(__self__, *,
                 ...
                 distinguished_name_qualifier: Optional[pulumi.Input[builtins.str]] = None,
                 generation_qualifier: Optional[pulumi.Input[builtins.str]] = None,
                 given_name: Optional[pulumi.Input[builtins.str]] = None,
                 initials: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 pseudonym: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 surname: Optional[pulumi.Input[builtins.str]] = None,
                 title: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] common_name: Fully qualified domain name (FQDN) associated with the certificate subject. Must be less than or equal to 64 characters in length.
        :param pulumi.Input[builtins.str] country: Two digit code that specifies the country in which the certificate subject located. Must be less than or equal to 2 characters in length.
        :param pulumi.Input[builtins.str] distinguished_name_qualifier: Disambiguating information for the certificate subject. Must be less than or equal to 64 characters in length.
        :param pulumi.Input[builtins.str] generation_qualifier: Typically a qualifier appended to the name of an individual. Examples include Jr. for junior, Sr. for senior, and III for third. Must be less than or equal to 3 characters in length.
        :param pulumi.Input[builtins.str] given_name: First name. Must be less than or equal to 16 characters in length.
        :param pulumi.Input[builtins.str] initials: Concatenation that typically contains the first letter of the `given_name`, the first letter of the middle name if one exists, and the first letter of the `surname`. Must be less than or equal to 5 characters in length.
        :param pulumi.Input[builtins.str] locality: Locality (such as a city or town) in which the certificate subject is located. Must be less than or equal to 128 characters in length.
        :param pulumi.Input[builtins.str] organization: Legal name of the organization with which the certificate subject is affiliated. Must be less than or equal to 64 characters in length.
        :param pulumi.Input[builtins.str] organizational_unit: Subdivision or unit of the organization (such as sales or finance) with which the certificate subject is affiliated. Must be less than or equal to 64 characters in length.
        :param pulumi.Input[builtins.str] pseudonym: Typically a shortened version of a longer `given_name`. For example, Jonathan is often shortened to John. Elizabeth is often shortened to Beth, Liz, or Eliza. Must be less than or equal to 128 characters in length.
        :param pulumi.Input[builtins.str] state: State in which the subject of the certificate is located. Must be less than or equal to 128 characters in length.
        :param pulumi.Input[builtins.str] surname: Family name. In the US and the UK for example, the surname of an individual is ordered last. In Asian cultures the surname is typically ordered first. Must be less than or equal to 40 characters in length.
        :param pulumi.Input[builtins.str] title: Title such as Mr. or Ms. which is pre-pended to the name to refer formally to the certificate subject. Must be less than or equal to 64 characters in length.
        """
    ...
    def distinguished_name_qualifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Disambiguating information for the certificate subject. Must be less than or equal to 64 characters in length.
        """
    ...
    def distinguished_name_qualifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "distinguished_name_qualifier", value)

    @property
    @pulumi.getter(name="generationQualifier")
    def generation_qualifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Typically a qualifier appended to the name of an individual. Examples include Jr. for junior, Sr. for senior, and III for third. Must be less than or equal to 3 characters in length.
        """
    ...
    def generation_qualifier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def initials(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Concatenation that typically contains the first letter of the `given_name`, the first letter of the middle name if one exists, and the first letter of the `surname`. Must be less than or equal to 5 characters in length.
        """
    ...
    @initials.setter
    def initials(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def pseudonym(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Typically a shortened version of a longer `given_name`. For example, Jonathan is often shortened to John. Elizabeth is often shortened to Beth, Liz, or Eliza. Must be less than or equal to 128 characters in length.
        """
    ...
    @pseudonym.setter
    def pseudonym(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CertificateAuthorityRevocationConfigurationCrlConfigurationArgsDict(TypedDict):
        custom_cname: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        s3_object_acl: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CertificateAuthorityRevocationConfigurationCrlConfigurationArgs:
    def __init__(__self__, *,
                 custom_cname: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 s3_object_acl: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] custom_cname: Name inserted into the certificate CRL Distribution Points extension that enables the use of an alias for the CRL distribution point. Use this value if you don't want the name of your S3 bucket to be public. Must be less than or equal to 253 characters in length.
        :param pulumi.Input[builtins.bool] enabled: Boolean value that specifies whether certificate revocation lists (CRLs) are enabled. Defaults to `false`.
        :param pulumi.Input[builtins.int] expiration_in_days: Number of days until a certificate expires. Must be between 1 and 5000.
        :param pulumi.Input[builtins.str] s3_bucket_name: Name of the S3 bucket that contains the CRL. If you do not provide a value for the `custom_cname` argument, the name of your S3 bucket is placed into the CRL Distribution Points extension of the issued certificate. You must specify a bucket policy that allows ACM PCA to write the CRL to your bucket. Must be between 3 and 255 characters in length.
        :param pulumi.Input[builtins.str] s3_object_acl: Determines whether the CRL will be publicly readable or privately held in the CRL Amazon S3 bucket. Defaults to `PUBLIC_READ`.
        """
    ...
    def custom_cname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name inserted into the certificate CRL Distribution Points extension that enables the use of an alias for the CRL distribution point. Use this value if you don't want the name of your S3 bucket to be public. Must be less than or equal to 253 characters in length.
        """
    ...
    @custom_cname.setter
    def custom_cname(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def s3_object_acl(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines whether the CRL will be publicly readable or privately held in the CRL Amazon S3 bucket. Defaults to `PUBLIC_READ`.
        """
    ...
    def s3_object_acl(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class CertificateAuthorityRevocationConfigurationOcspConfigurationArgsDict(TypedDict):
        ...
        """
        ocsp_custom_cname: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CertificateAuthorityRevocationConfigurationOcspConfigurationArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool],
                 ocsp_custom_cname: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] enabled: Boolean value that specifies whether a custom OCSP responder is enabled.
        :param pulumi.Input[builtins.str] ocsp_custom_cname: CNAME specifying a customized OCSP domain. Note: The value of the CNAME must not include a protocol prefix such as "http://" or "https://".
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def ocsp_custom_cname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        CNAME specifying a customized OCSP domain. Note: The value of the CNAME must not include a protocol prefix such as "http://" or "https://".
        """
    ...
    def ocsp_custom_cname(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CertificateValidityArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: Determines how `value` is interpreted. Valid values: `DAYS`, `MONTHS`, `YEARS`, `ABSOLUTE`, `END_DATE`.
        :param pulumi.Input[builtins.str] value: If `type` is `DAYS`, `MONTHS`, or `YEARS`, the relative time until the certificate expires. If `type` is `ABSOLUTE`, the date in seconds since the Unix epoch. If `type` is `END_DATE`, the  date in RFC 3339 format.
        """
