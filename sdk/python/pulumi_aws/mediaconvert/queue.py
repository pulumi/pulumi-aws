...
class Queue(pulumi.CustomResource):
    ...
    A detail pricing plan of the  reserved queue. See below.
      ...
      * `renewal_type` (`str`) - Specifies whether the term of your reserved queue pricing plan. Valid values are `AUTO_RENEW` or `EXPIRE`.
      * `reserved_slots` (`float`) - Specifies the number of reserved transcode slots (RTS) for queue.
    """
    ...
    def __init__(__self__, resource_name, opts=None, description=None, name=None, pricing_plan=None, reservation_plan_settings=None, status=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **reservation_plan_settings** object supports the following:
          ...
          * `renewal_type` (`pulumi.Input[str]`) - Specifies whether the term of your reserved queue pricing plan. Valid values are `AUTO_RENEW` or `EXPIRE`.
          * `reserved_slots` (`pulumi.Input[float]`) - Specifies the number of reserved transcode slots (RTS) for queue.
        """
