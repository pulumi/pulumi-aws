...
class QueueArgs:
    ...
    def _configure(
        ...
        if 'reservationPlanSettings' in kwargs:
...
class Queue(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if reservation_plan_settings is not None and not isinstance(reservation_plan_settings, QueueReservationPlanSettingsArgs):
                reservation_plan_settings = reservation_plan_settings or {}
                def _setter(key, value):
                    reservation_plan_settings[key] = value
                QueueReservationPlanSettingsArgs._configure(_setter, **reservation_plan_settings)
