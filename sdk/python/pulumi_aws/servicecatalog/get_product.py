...
class GetProductResult:
    ...
    def has_default_path(self) -> builtins.bool:
        """
...
def get_product(accept_language: Optional[builtins.str] = None,
    ...
    :param builtins.str accept_language: Language code. Valid values are `en` (English), `jp` (Japanese), `zh` (Chinese). The default value is `en`.
