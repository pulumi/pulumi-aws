...
class ProductArgs:
    ...
    @property
    @pulumi.getter
    def distributor(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @distributor.setter
    def distributor(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def support_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProductState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 distributor: Optional[pulumi.Input[builtins.str]] = None,
                 has_default_path: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def has_default_path(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def has_default_path(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Product(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Product':
        """
    ...
    @property
    @pulumi.getter
    def distributor(self) -> pulumi.Output[builtins.str]:
        """
        Distributor (i.e., vendor) of the product.
        """
        return pulumi.get(self, "distributor")
    ...
    @property
    @pulumi.getter(name="hasDefaultPath")
    def has_default_path(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the product has a default path. If the product does not have a default path, call `ListLaunchPaths` to disambiguate between paths.  Otherwise, `ListLaunchPaths` is not required, and the output of ProductViewSummary can be used directly with `DescribeProvisioningParameters`.
        """
        return pulumi.get(self, "has_default_path")
    ...
    @property
    @pulumi.getter(name="supportDescription")
    def support_description(self) -> pulumi.Output[builtins.str]:
        """
        Support information about the product.
        """
        return pulumi.get(self, "support_description")
