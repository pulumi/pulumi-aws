...
class Product(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if provisioning_artifact_parameters is not None and not isinstance(provisioning_artifact_parameters, ProductProvisioningArtifactParametersArgs):
                provisioning_artifact_parameters = provisioning_artifact_parameters or {}
                def _setter(key, value):
                    provisioning_artifact_parameters[key] = value
                ProductProvisioningArtifactParametersArgs._configure(_setter, **provisioning_artifact_parameters)
