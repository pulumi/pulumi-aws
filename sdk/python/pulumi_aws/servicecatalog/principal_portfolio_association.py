...
class PrincipalPortfolioAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Using `pulumi import`, import `servicecatalog.PrincipalPortfolioAssociation` using `accept_language`, `principal_arn`, `portfolio_id`, and `principal_type` separated by a comma. For example:
    ...
    def get(resource_name: str,
            ...
            principal_arn: Optional[pulumi.Input[_builtins.str]] = None,
            principal_type: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'PrincipalPortfolioAssociation':
        """
