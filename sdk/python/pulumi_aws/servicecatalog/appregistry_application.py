...
class _AppregistryApplicationState:
    def __init__(__self__, *,
                 application_tag: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
    ...
    def application_tag(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class AppregistryApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'AppregistryApplication':
        """
