...
class ProvisionedProductArgs:
    def __init__(__self__, *,
                 ...
                 ignore_errors: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 notification_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 path_id: Optional[pulumi.Input[builtins.str]] = None,
                 path_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] ignore_errors: _Only applies to deleting._ If set to `true`, AWS Service Catalog stops managing the specified provisioned product even if it cannot delete the underlying resources. The default value is `false`.
        :param pulumi.Input[builtins.str] name: User-friendly name of the provisioned product.
               
               The following arguments are optional:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_arns: Passed to CloudFormation. The SNS topic ARNs to which to publish stack-related events.
        :param pulumi.Input[builtins.str] path_id: Path identifier of the product. This value is optional if the product has a default path, and required if the product has more than one path. To list the paths for a product, use `servicecatalog_get_launch_paths`. When required, you must provide `path_id` or `path_name`, but not both.
        :param pulumi.Input[builtins.str] path_name: Name of the path. You must provide `path_id` or `path_name`, but not both.
        :param pulumi.Input[builtins.str] product_id: Product identifier. For example, `prod-abcdzk7xy33qa`. You must provide `product_id` or `product_name`, but not both.
        :param pulumi.Input[builtins.str] product_name: Name of the product. You must provide `product_id` or `product_name`, but not both.
    ...
    def ignore_errors(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_errors(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def path_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @path_id.setter
    def path_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "path_id", value)

    @property
    @pulumi.getter(name="pathName")
    def path_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @path_name.setter
    def path_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provisioning_artifact_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provisioning_artifact_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provisioning_artifact_id", value)

    @property
    @pulumi.getter(name="provisioningArtifactName")
    def provisioning_artifact_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provisioning_artifact_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def retain_physical_resources(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ProvisionedProductState:
    def __init__(__self__, *,
                 ...
                 cloudwatch_dashboard_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 created_time: Optional[pulumi.Input[builtins.str]] = None,
                 ignore_errors: Optional[pulumi.Input[builtins.bool]] = None,
                 last_provisioning_record_id: Optional[pulumi.Input[builtins.str]] = None,
                 last_record_id: Optional[pulumi.Input[builtins.str]] = None,
                 last_successful_provisioning_record_id: Optional[pulumi.Input[builtins.str]] = None,
                 launch_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 notification_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] accept_language: Language code. Valid values: `en` (English), `jp` (Japanese), `zh` (Chinese). Default value is `en`.
        :param pulumi.Input[builtins.str] arn: ARN of the provisioned product.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cloudwatch_dashboard_names: Set of CloudWatch dashboards that were created when provisioning the product.
        :param pulumi.Input[builtins.str] created_time: Time when the provisioned product was created.
        :param pulumi.Input[builtins.bool] ignore_errors: _Only applies to deleting._ If set to `true`, AWS Service Catalog stops managing the specified provisioned product even if it cannot delete the underlying resources. The default value is `false`.
        :param pulumi.Input[builtins.str] last_provisioning_record_id: Record identifier of the last request performed on this provisioned product of the following types: `ProvisionedProduct`, `UpdateProvisionedProduct`, `ExecuteProvisionedProductPlan`, `TerminateProvisionedProduct`.
        :param pulumi.Input[builtins.str] last_record_id: Record identifier of the last request performed on this provisioned product.
        :param pulumi.Input[builtins.str] last_successful_provisioning_record_id: Record identifier of the last successful request performed on this provisioned product of the following types: `ProvisionedProduct`, `UpdateProvisionedProduct`, `ExecuteProvisionedProductPlan`, `TerminateProvisionedProduct`.
        :param pulumi.Input[builtins.str] launch_role_arn: ARN of the launch role associated with the provisioned product.
        :param pulumi.Input[builtins.str] name: User-friendly name of the provisioned product.
        ...
        :param pulumi.Input[builtins.str] status_message: Current status message of the provisioned product.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Tags to apply to the provisioned product. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags_all: Map of tags assigned to the resource, including those inherited from the provider `default_tags` configuration block.
        :param pulumi.Input[builtins.str] type: Type of provisioned product. Valid values are `CFN_STACK` and `CFN_STACKSET`.
        """
        if accept_language is not None:
            pulumi.set(__self__, "accept_language", accept_language)
        if arn is not None:
    ...
    def cloudwatch_dashboard_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def cloudwatch_dashboard_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def last_provisioning_record_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_provisioning_record_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_provisioning_record_id", value)

    @property
    @pulumi.getter(name="lastRecordId")
    def last_record_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_record_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_record_id", value)

    @property
    @pulumi.getter(name="lastSuccessfulProvisioningRecordId")
    def last_successful_provisioning_record_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_successful_provisioning_record_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_successful_provisioning_record_id", value)

    @property
    @pulumi.getter(name="launchRoleArn")
    def launch_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def launch_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ProvisionedProduct(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ProvisionedProduct':
        """
    ...
    @property
    @pulumi.getter(name="cloudwatchDashboardNames")
    def cloudwatch_dashboard_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Set of CloudWatch dashboards that were created when provisioning the product.
        """
        return pulumi.get(self, "cloudwatch_dashboard_names")
    ...
    @property
    @pulumi.getter(name="lastProvisioningRecordId")
    def last_provisioning_record_id(self) -> pulumi.Output[builtins.str]:
        """
        Record identifier of the last request performed on this provisioned product of the following types: `ProvisionedProduct`, `UpdateProvisionedProduct`, `ExecuteProvisionedProductPlan`, `TerminateProvisionedProduct`.
        """
        return pulumi.get(self, "last_provisioning_record_id")
    ...
    @property
    @pulumi.getter(name="lastRecordId")
    def last_record_id(self) -> pulumi.Output[builtins.str]:
        """
        Record identifier of the last request performed on this provisioned product.
        """
        return pulumi.get(self, "last_record_id")
    ...
    @property
    @pulumi.getter(name="lastSuccessfulProvisioningRecordId")
    def last_successful_provisioning_record_id(self) -> pulumi.Output[builtins.str]:
        """
        Record identifier of the last successful request performed on this provisioned product of the following types: `ProvisionedProduct`, `UpdateProvisionedProduct`, `ExecuteProvisionedProductPlan`, `TerminateProvisionedProduct`.
        """
        return pulumi.get(self, "last_successful_provisioning_record_id")
    ...
    @property
    @pulumi.getter(name="launchRoleArn")
    def launch_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the launch role associated with the provisioned product.
        """
        return pulumi.get(self, "launch_role_arn")
    ...
    @property
    @pulumi.getter(name="pathId")
    def path_id(self) -> pulumi.Output[builtins.str]:
        """
        Path identifier of the product. This value is optional if the product has a default path, and required if the product has more than one path. To list the paths for a product, use `servicecatalog_get_launch_paths`. When required, you must provide `path_id` or `path_name`, but not both.
        """
        return pulumi.get(self, "path_id")
    ...
    @property
    @pulumi.getter(name="pathName")
    def path_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the path. You must provide `path_id` or `path_name`, but not both.
        """
        return pulumi.get(self, "path_name")
    ...
    @property
    @pulumi.getter(name="productName")
    def product_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the product. You must provide `product_id` or `product_name`, but not both.
        """
        return pulumi.get(self, "product_name")
    ...
    @property
    @pulumi.getter(name="provisioningArtifactName")
    def provisioning_artifact_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the provisioning artifact. You must provide the `provisioning_artifact_id` or `provisioning_artifact_name`, but not both.
        """
        return pulumi.get(self, "provisioning_artifact_name")
