...
class ProvisionedProduct(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if stack_set_provisioning_preferences is not None and not isinstance(stack_set_provisioning_preferences, ProvisionedProductStackSetProvisioningPreferencesArgs):
                stack_set_provisioning_preferences = stack_set_provisioning_preferences or {}
                def _setter(key, value):
                    stack_set_provisioning_preferences[key] = value
                ProvisionedProductStackSetProvisioningPreferencesArgs._configure(_setter, **stack_set_provisioning_preferences)
