...
class _TagOptionResourceAssociationState:
    ...
    def _configure(
        ...
        if resource_created_time is None and 'resourceCreatedTime' in kwargs:
            resource_created_time = kwargs['resourceCreatedTime']
        if resource_description is None and 'resourceDescription' in kwargs:
            resource_description = kwargs['resourceDescription']
        if resource_id is None and 'resourceId' in kwargs:
            resource_id = kwargs['resourceId']
