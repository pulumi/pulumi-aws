...
class PortfolioShareArgs:
    ...
    def share_principals(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "share_principals", value)

    @property
    @pulumi.getter(name="shareTagOptions")
    def share_tag_options(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def share_tag_options(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "share_tag_options", value)

    @property
    @pulumi.getter(name="waitForAcceptance")
    def wait_for_acceptance(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def wait_for_acceptance(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class PortfolioShare(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            share_tag_options: Optional[pulumi.Input[builtins.bool]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            wait_for_acceptance: Optional[pulumi.Input[builtins.bool]] = None) -> 'PortfolioShare':
        """
    ...
    @property
    @pulumi.getter(name="sharePrincipals")
    def share_principals(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables or disables Principal sharing when creating the portfolio share. If this flag is not provided, principal sharing is disabled.
        """
        return pulumi.get(self, "share_principals")
    ...
    @property
    @pulumi.getter(name="shareTagOptions")
    def share_tag_options(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable sharing of `servicecatalog.TagOption` resources when creating the portfolio share.
        """
        return pulumi.get(self, "share_tag_options")
    ...
    @property
    @pulumi.getter(name="waitForAcceptance")
    def wait_for_acceptance(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to wait (up to the timeout) for the share to be accepted. Organizational shares are automatically accepted.
        """
        return pulumi.get(self, "wait_for_acceptance")
