...
class ProductPortfolioAssociationArgs:
    ...
    def source_portfolio_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws:servicecatalog/productPortfolioAssociation:ProductPortfolioAssociation")
class ProductPortfolioAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="sourcePortfolioId")
    def source_portfolio_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Identifier of the source portfolio.
        """
        return pulumi.get(self, "source_portfolio_id")
