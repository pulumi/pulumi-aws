...
class RepositoryAssociationKmsKeyDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str encryption_option: The encryption option for a repository association. It is either owned by AWS Key Management Service (KMS) (`AWS_OWNED_CMK`) or customer managed (`CUSTOMER_MANAGED_CMK`).
        :param builtins.str kms_key_id: The ID of the AWS KMS key that is associated with a repository association.
        """
...
class RepositoryAssociationRepositoryBitbucket(dict):
    ...
    def __init__(__self__, *,
                 ...
                 owner: builtins.str):
        """
        :param builtins.str connection_arn: The Amazon Resource Name (ARN) of an AWS CodeStar Connections connection.
        :param builtins.str name: The name of the third party source repository.
        :param builtins.str owner: The username for the account that owns the repository.
        """
...
class RepositoryAssociationRepositoryCodecommit(dict):
    def __init__(__self__, *,
                 name: builtins.str):
        """
        :param builtins.str name: The name of the AWS CodeCommit repository.
        """
        pulumi.set(__self__, "name", name)
...
class RepositoryAssociationRepositoryS3Bucket(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str bucket_name: The name of the S3 bucket used for associating a new S3 repository. Note: The name must begin with `codeguru-reviewer-`.
        :param builtins.str name: The name of the repository in the S3 bucket.
        """
...
class RepositoryAssociationS3RepositoryDetailCodeArtifact(dict):
    ...
    def __init__(__self__, *,
                 build_artifacts_object_key: Optional[builtins.str] = None,
                 source_code_artifacts_object_key: Optional[builtins.str] = None):
    ...
    def build_artifacts_object_key(self) -> Optional[builtins.str]:
        return pulumi.get(self, "build_artifacts_object_key")

    @property
    @pulumi.getter(name="sourceCodeArtifactsObjectKey")
    def source_code_artifacts_object_key(self) -> Optional[builtins.str]:
