...
class KxDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the KX database.
        :param pulumi.Input[builtins.str] name: Name of the KX database.
...
class _KxDatabaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) identifier of the KX database.
        :param pulumi.Input[builtins.str] created_timestamp: Timestamp at which the databse is created in FinSpace. Value determined as epoch time in seconds. For example, the value for Monday, November 1, 2021 12:00:00 PM UTC is specified as 1635768000.
        :param pulumi.Input[builtins.str] description: Description of the KX database.
        :param pulumi.Input[builtins.str] environment_id: Unique identifier for the KX environment.
        :param pulumi.Input[builtins.str] last_modified_timestamp: Last timestamp at which the database was updated in FinSpace. Value determined as epoch time in seconds. For example, the value for Monday, November 1, 2021 12:00:00 PM UTC is specified as 1635768000.
        :param pulumi.Input[builtins.str] name: Name of the KX database.
...
class KxDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'KxDatabase':
        """
