...
class KxScalingGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone_id: The availability zone identifiers for the requested regions.
        :param pulumi.Input[builtins.str] environment_id: A unique identifier for the kdb environment, where you want to create the scaling group.
        :param pulumi.Input[builtins.str] host_type: The memory and CPU capabilities of the scaling group host on which FinSpace Managed kdb clusters will be placed.
...
class _KxScalingGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) identifier of the KX Scaling Group.
        :param pulumi.Input[builtins.str] availability_zone_id: The availability zone identifiers for the requested regions.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] clusters: The list of Managed kdb clusters that are currently active in the given scaling group.
        :param pulumi.Input[builtins.str] created_timestamp: The timestamp at which the scaling group was created in FinSpace. The value is determined as epoch time in milliseconds. For example, the value for Monday, November 1, 2021 12:00:00 PM UTC is specified as 1635768000000.
        :param pulumi.Input[builtins.str] environment_id: A unique identifier for the kdb environment, where you want to create the scaling group.
        :param pulumi.Input[builtins.str] host_type: The memory and CPU capabilities of the scaling group host on which FinSpace Managed kdb clusters will be placed.
...
class KxScalingGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status_reason: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'KxScalingGroup':
        """
    ...
    @property
    @pulumi.getter
    def clusters(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of Managed kdb clusters that are currently active in the given scaling group.
        """
        return pulumi.get(self, "clusters")
