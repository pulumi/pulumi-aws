...
class KxVolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] az_mode: The number of availability zones you want to assign per volume. Currently, Finspace only support SINGLE for volumes.
...
class _KxVolumeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) identifier of the KX volume.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The identifier of the AWS Availability Zone IDs.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] az_mode: The number of availability zones you want to assign per volume. Currently, Finspace only support SINGLE for volumes.
               * `SINGLE` - Assigns one availability zone per volume.
        :param pulumi.Input[builtins.str] created_timestamp: The timestamp at which the volume was created in FinSpace. The value is determined as epoch time in milliseconds. For example, the value for Monday, November 1, 2021 12:00:00 PM UTC is specified as 1635768000000.
        :param pulumi.Input[builtins.str] description: Description of the volume.
        :param pulumi.Input[builtins.str] environment_id: A unique identifier for the kdb environment, whose clusters can attach to the volume.
...
class KxVolume(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'KxVolume':
        """
