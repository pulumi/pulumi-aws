...
class KxClusterArgs:
    def __init__(__self__, *,
                 ...
                 command_line_arguments: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_zone_id: The availability zone identifiers for the requested regions. Required when `az_mode` is set to SINGLE.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] command_line_arguments: List of key-value pairs to make available inside the cluster.
    ...
    def command_line_arguments(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def command_line_arguments(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def initialization_script(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def initialization_script(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KxClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) identifier of the KX cluster.
        :param pulumi.Input['KxClusterAutoScalingConfigurationArgs'] auto_scaling_configuration: Configuration based on which FinSpace will scale in or scale out nodes in your cluster. See auto_scaling_configuration.
        :param pulumi.Input[builtins.str] availability_zone_id: The availability zone identifiers for the requested regions. Required when `az_mode` is set to SINGLE.
        :param pulumi.Input[builtins.str] az_mode: The number of availability zones you want to assign per cluster. This can be one of the following:
               * SINGLE - Assigns one availability zone per cluster.
        ...
        :param pulumi.Input['KxClusterCodeArgs'] code: Details of the custom code that you want to use inside a cluster when analyzing data. Consists of the S3 source bucket, location, object version, and the relative path from where the custom code is loaded into the cluster. See code.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] command_line_arguments: List of key-value pairs to make available inside the cluster.
        :param pulumi.Input[builtins.str] created_timestamp: Timestamp at which the cluster is created in FinSpace. Value determined as epoch time in seconds. For example, the value for Monday, November 1, 2021 12:00:00 PM UTC is specified as 1635768000.
        :param pulumi.Input[Sequence[pulumi.Input['KxClusterDatabaseArgs']]] databases: KX database that will be available for querying. Defined below.
        :param pulumi.Input[builtins.str] description: Description of the cluster.
        :param pulumi.Input[builtins.str] environment_id: Unique identifier for the KX environment.
        :param pulumi.Input[builtins.str] execution_role: An IAM role that defines a set of permissions associated with a cluster. These permissions are assumed when a cluster attempts to access another cluster.
...
class KxCluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="commandLineArguments")
    def command_line_arguments(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        List of key-value pairs to make available inside the cluster.
        """
        return pulumi.get(self, "command_line_arguments")
    ...
    @property
    @pulumi.getter(name="initializationScript")
    def initialization_script(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Path to Q program that will be run at launch of a cluster. This is a relative path within .zip file that contains the custom code, which will be loaded on the cluster. It must include the file name itself. For example, somedir/init.q.
        """
        return pulumi.get(self, "initialization_script")
