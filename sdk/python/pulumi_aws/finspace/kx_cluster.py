...
class KxClusterArgs:
    ...
    def _configure(
        ...
        if 'capacityConfiguration' in kwargs:
        ...
        if 'autoScalingConfiguration' in kwargs:
        ...
        if 'cacheStorageConfigurations' in kwargs:
        ...
        if 'initializationScript' in kwargs:
            initialization_script = kwargs['initializationScript']
        if 'savedownStorageConfiguration' in kwargs:
