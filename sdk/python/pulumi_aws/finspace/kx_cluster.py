...
class KxClusterArgs:
    ...
    def _configure(
        ...
        if az_mode is None:
            raise TypeError("Missing 'az_mode' argument")
        if capacity_configuration is None and 'capacityConfiguration' in kwargs:
            capacity_configuration = kwargs['capacityConfiguration']
        if capacity_configuration is None:
            raise TypeError("Missing 'capacity_configuration' argument")
        ...
        if auto_scaling_configuration is None and 'autoScalingConfiguration' in kwargs:
            auto_scaling_configuration = kwargs['autoScalingConfiguration']
        if availability_zone_id is None and 'availabilityZoneId' in kwargs:
            availability_zone_id = kwargs['availabilityZoneId']
        if cache_storage_configurations is None and 'cacheStorageConfigurations' in kwargs:
            cache_storage_configurations = kwargs['cacheStorageConfigurations']
        ...
        if initialization_script is None and 'initializationScript' in kwargs:
            initialization_script = kwargs['initializationScript']
        if savedown_storage_configuration is None and 'savedownStorageConfiguration' in kwargs:
            savedown_storage_configuration = kwargs['savedownStorageConfiguration']
...
class KxCluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            auto_scaling_configuration = _utilities.configure(auto_scaling_configuration, KxClusterAutoScalingConfigurationArgs, True)
            ...
            capacity_configuration = _utilities.configure(capacity_configuration, KxClusterCapacityConfigurationArgs, True)
            ...
            code = _utilities.configure(code, KxClusterCodeArgs, True)
            ...
            savedown_storage_configuration = _utilities.configure(savedown_storage_configuration, KxClusterSavedownStorageConfigurationArgs, True)
            __props__.__dict__["savedown_storage_configuration"] = savedown_storage_configuration
            __props__.__dict__["tags"] = tags
            if type is None and not opts.urn:
                raise TypeError("Missing required property 'type'")
            __props__.__dict__["type"] = type
            vpc_configuration = _utilities.configure(vpc_configuration, KxClusterVpcConfigurationArgs, True)
