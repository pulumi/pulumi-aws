...
class KxClusterAutoScalingConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.float scale_out_cooldown_seconds: Duration in seconds that FinSpace will wait after a scale out event before initiating another scaling event.
        """
...
class KxClusterCode(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str s3_bucket: Unique name for the S3 bucket.
        :param _builtins.str s3_key: Full S3 path (excluding bucket) to the .zip file that contains the code to be loaded onto the cluster when it’s started.
        :param _builtins.str s3_object_version: Version of an S3 Object.
        """
...
class KxClusterDatabaseCacheConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cache_type: Type of disk cache.
        :param Sequence[_builtins.str] db_paths: Paths within the database to cache.
        """
...
class KxEnvironmentCustomDnsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str custom_dns_server_ip: IP address of the DNS server.
        :param _builtins.str custom_dns_server_name: Name of the DNS server.
        """
...
class KxEnvironmentTransitGatewayConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str routable_cidr_space: Routing CIDR on behalf of KX environment. It could be any “/26 range in the 100.64.0.0 CIDR space. After providing, it will be added to the customer’s transit gateway routing table so that the traffics could be routed to KX network.
        :param _builtins.str transit_gateway_id: Identifier of the transit gateway created by the customer to connect outbound traffics from KX network to your internal network.
...
class KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationIcmpTypeCode(dict):
    def __init__(__self__, *,
                 ...
                 type: _builtins.int):
        """
        :param _builtins.int code: ICMP code. A value of `-1` means all codes for the specified ICMP type.
        :param _builtins.int type: ICMP type. A value of `-1` means all types.
        """
...
class KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationPortRange(dict):
    ...
    def __init__(__self__, *,
                 ...
                 to: _builtins.int):
        """
        :param _builtins.int from_: First port in the range.
        :param _builtins.int to: Last port in the range.
        """
