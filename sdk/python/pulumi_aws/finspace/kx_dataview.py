...
class KxDataviewArgs:
    def __init__(__self__, *,
                 auto_update: pulumi.Input[builtins.bool],
                 az_mode: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] az_mode: The number of availability zones you want to assign per cluster. This can be one of the following:
               * `SINGLE` - Assigns one availability zone per cluster.
               * `MULTI` - Assigns all the availability zones per cluster.
        :param pulumi.Input[builtins.str] database_name: The name of the database where you want to create a dataview.
        :param pulumi.Input[builtins.str] environment_id: Unique identifier for the KX environment.
        :param pulumi.Input[builtins.str] availability_zone_id: The identifier of the availability zones. If attaching a volume, the volume must be in the same availability zone as the dataview that you are attaching to.
        :param pulumi.Input[builtins.str] changeset_id: A unique identifier of the changeset of the database that you want to use to ingest data.
        :param pulumi.Input[builtins.str] description: A description for the dataview.
        :param pulumi.Input[builtins.str] name: A unique identifier for the dataview.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.bool] read_write: The option to specify whether you want to make the dataview writable to perform database maintenance. The following are some considerations related to writable dataviews.
    ...
    def auto_update(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @auto_update.setter
    def auto_update(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "auto_update", value)

    @property
    @pulumi.getter(name="azMode")
    def az_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @az_mode.setter
    def az_mode(self, value: pulumi.Input[builtins.str]):
    ...
    def read_write(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @read_write.setter
    def read_write(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _KxDataviewState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) identifier of the KX dataview.
        :param pulumi.Input[builtins.bool] auto_update: The option to specify whether you want to apply all the future additions and corrections automatically to the dataview, when you ingest new changesets. The default value is false.
        :param pulumi.Input[builtins.str] availability_zone_id: The identifier of the availability zones. If attaching a volume, the volume must be in the same availability zone as the dataview that you are attaching to.
        :param pulumi.Input[builtins.str] az_mode: The number of availability zones you want to assign per cluster. This can be one of the following:
               * `SINGLE` - Assigns one availability zone per cluster.
               * `MULTI` - Assigns all the availability zones per cluster.
        :param pulumi.Input[builtins.str] changeset_id: A unique identifier of the changeset of the database that you want to use to ingest data.
        :param pulumi.Input[builtins.str] created_timestamp: Timestamp at which the dataview was created in FinSpace. Value determined as epoch time in milliseconds. For example, the value for Monday, November 1, 2021 12:00:00 PM UTC is specified as 1635768000000.
        :param pulumi.Input[builtins.str] database_name: The name of the database where you want to create a dataview.
        :param pulumi.Input[builtins.str] description: A description for the dataview.
        :param pulumi.Input[builtins.str] environment_id: Unique identifier for the KX environment.
        :param pulumi.Input[builtins.str] last_modified_timestamp: The last time that the dataview was updated in FinSpace. The value is determined as epoch time in milliseconds. For example, the value for Monday, November 1, 2021 12:00:00 PM UTC is specified as 1635768000000.
        :param pulumi.Input[builtins.str] name: A unique identifier for the dataview.
...
class KxDataview(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'KxDataview':
        """
    ...
    @property
    @pulumi.getter(name="autoUpdate")
    def auto_update(self) -> pulumi.Output[builtins.bool]:
        """
        The option to specify whether you want to apply all the future additions and corrections automatically to the dataview, when you ingest new changesets. The default value is false.
        """
        return pulumi.get(self, "auto_update")
    ...
    @property
    @pulumi.getter(name="changesetId")
    def changeset_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A unique identifier of the changeset of the database that you want to use to ingest data.
        """
        return pulumi.get(self, "changeset_id")
    ...
    @property
    @pulumi.getter(name="readWrite")
    def read_write(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The option to specify whether you want to make the dataview writable to perform database maintenance. The following are some considerations related to writable dataviews.
        * You cannot create partial writable dataviews. When you create writeable dataviews you must provide the entire database path. You cannot perform updates on a writeable dataview. Hence, `auto_update` must be set as `false` if `read_write` is `true` for a dataview.
        * You must also use a unique volume for creating a writeable dataview. So, if you choose a volume that is already in use by another dataview, the dataview creation fails.
