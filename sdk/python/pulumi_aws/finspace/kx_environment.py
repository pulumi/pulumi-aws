...
__all__ = ['KxEnvironmentArrgs', 'KxEnvironment']

@pulumi.input_type
calass KxEnvironmentArrgs:
    def __init__(__self__, *,
                 kms_key_id: pulumi.Input[str],
                 custom_dns_configurations: Optional[pulumi.Input[Sequence[pulumi.Input['KxEnvironmentCustomDnsConfigurationArrgs']]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 transit_gateway_configuration: Optional[pulumi.Input['KxEnvironmentTransitGatewayConfigurationArrgs']] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input['KxEnvironmentCustomDnsConfigurationArrgs']]] custom_dns_configurations: List of DNS server name and server IP. This is used to set up Route-53 outbound resolvers. Defined below.
        ...
        :param pulumi.Input['KxEnvironmentTransitGatewayConfigurationArrgs'] transit_gateway_configuration: Transit gateway and network configuration that is used to connect the KX environment to an internal network. Defined below.
        """
    ...
    def custom_dns_configurations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['KxEnvironmentCustomDnsConfigurationArrgs']]]]:
        """
    ...
    def custom_dns_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['KxEnvironmentCustomDnsConfigurationArrgs']]]]):
    ...
    def transit_gateway_configuration(self) -> Optional[pulumi.Input['KxEnvironmentTransitGatewayConfigurationArrgs']]:
        """
    ...
    def transit_gateway_configuration(self, value: Optional[pulumi.Input['KxEnvironmentTransitGatewayConfigurationArrgs']]):
        pulumi.set(self, "transit_gateway_configuration", value)


@pulumi.input_type
calass _KxEnvironmentState:
    def __init__(__self__, *,
...
calass KxEnvironment(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 custom_dns_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['KxEnvironmentCustomDnsConfigurationArrgs']]]]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 kms_key_id: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 transit_gateway_configuration: Optional[pulumi.Input[pulumi.InputType['KxEnvironmentTransitGatewayConfigurationArrgs']]] = None,
                 __props__=None):
        """
        ...
        example_env = aws.finspace.KxEnvironment("exampleEnv",
            ...
            transit_gateway_configuration=aws.finspace.KxEnvironmentTransitGatewayConfigurationArrgs(
                transit_gateway_id=example_transit_gateway.id,
                routable_cidr_space="100.64.0.0/26",
            ),
            custom_dns_configurations=[aws.finspace.KxEnvironmentCustomDnsConfigurationArrgs(
        ...
        example_env = aws.finspace.KxEnvironment("exampleEnv",
            ...
            transit_gateway_configuration=aws.finspace.KxEnvironmentTransitGatewayConfigurationArrgs(
                transit_gateway_id=example_transit_gateway.id,
                routable_cidr_space="100.64.0.0/26",
                attachment_network_acl_configurations=[aws.finspace.KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationArrgs(
                    rule_number=1,
                    protocol="6",
                    rule_action="allow",
                    cidr_block="0.0.0.0/0",
                    port_range=aws.finspace.KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationPortRangeArrgs(
                        from_=53,
                        to=53,
                    ),
                    icmp_type_code=aws.finspace.KxEnvironmentTransitGatewayConfigurationAttachmentNetworkAclConfigurationIcmpTypeCodeArrgs(
                        type=-1,
                        code=-1,
                    ),
                )],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['KxEnvironmentCustomDnsConfigurationArrgs']]]] custom_dns_configurations: List of DNS server name and server IP. This is used to set up Route-53 outbound resolvers. Defined below.
        :param pulumi.Input[str] description: Description for the KX environment.
        :param pulumi.Input[str] kms_key_id: KMS key ID to encrypt your data in the FinSpace environment.
        ...
        :param pulumi.Input[str] name: Name of the KX environment that you want to create.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Key-value mapping of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[pulumi.InputType['KxEnvironmentTransitGatewayConfigurationArrgs']] transit_gateway_configuration: Transit gateway and network configuration that is used to connect the KX environment to an internal network. Defined below.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: KxEnvironmentArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Resource for managing an AWS FinSpace Kx Environment.
        ...
        :param str resource_name: The name of the resource.
        :param KxEnvironmentArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(KxEnvironmentArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = KxEnvironmentArrgs.__new__(KxEnvironmentArrgs)
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            transit_gateway_configuration: Optional[pulumi.Input[pulumi.InputType['KxEnvironmentTransitGatewayConfigurationArrgs']]] = None) -> 'KxEnvironment':
        """
