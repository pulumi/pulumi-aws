...
@pulumi.output_type
calass GetAvailabilityZonesResult:
    """
...
calass AwaitableGetAvailabilityZonesResult(GetAvailabilityZonesResult):
...
def get_availability_zones(all_availability_zones: Optional[bool] = None,
                           ...
                           filters: Optional[Sequence[pulumi.InputType['GetAvailabilityZonesFilterArrgs']]] = None,
    ...
    example = aws.get_availability_zones(filters=[aws.GetAvailabilityZonesFilterArrgs(
        name="opt-in-status",
    ...
    :param Sequence[pulumi.InputType['GetAvailabilityZonesFilterArrgs']] filters: Configuration block(s) for filtering. Detailed below.
...
def get_availability_zones_output(all_availability_zones: Optional[pulumi.Input[Optional[bool]]] = None,
                                  ...
                                  filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetAvailabilityZonesFilterArrgs']]]]] = None,
