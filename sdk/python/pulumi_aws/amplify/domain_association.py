...
class DomainAssociationArgs:
    def __init__(__self__, *,
        ...
        """
        DomainAssociationArgs._configure(
    ...
    def _configure(
        ...
        if sub_domains is None and 'subDomains' in kwargs:
            sub_domains = kwargs['subDomains']
        if sub_domains is None:
            raise TypeError("Missing 'sub_domains' argument")
        if enable_auto_sub_domain is None and 'enableAutoSubDomain' in kwargs:
            enable_auto_sub_domain = kwargs['enableAutoSubDomain']
        if wait_for_verification is None and 'waitForVerification' in kwargs:
            wait_for_verification = kwargs['waitForVerification']

        _setter("app_id", app_id)
        _setter("domain_name", domain_name)
        _setter("sub_domains", sub_domains)
        ...
        if wait_for_verification is not None:
            _setter("wait_for_verification", wait_for_verification)
...
class _DomainAssociationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] wait_for_verification: If enabled, the resource will wait for the domain association status to change to `PENDING_DEPLOYMENT` or `AVAILABLE`. Setting this to `false` will skip the process. Default: `true`.
        """
        _DomainAssociationState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            app_id=app_id,
            arn=arn,
    ...
    def _configure(
        ...
        if app_id is None and 'appId' in kwargs:
            app_id = kwargs['appId']
        if certificate_verification_dns_record is None and 'certificateVerificationDnsRecord' in kwargs:
            certificate_verification_dns_record = kwargs['certificateVerificationDnsRecord']
        if domain_name is None and 'domainName' in kwargs:
            domain_name = kwargs['domainName']
        if enable_auto_sub_domain is None and 'enableAutoSubDomain' in kwargs:
            enable_auto_sub_domain = kwargs['enableAutoSubDomain']
        ...
        if certificate_verification_dns_record is not None:
            _setter("certificate_verification_dns_record", certificate_verification_dns_record)
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            DomainAssociationArgs._configure(_setter, **kwargs)
