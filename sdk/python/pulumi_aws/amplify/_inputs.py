...
if not MYPY:
    class AppAutoBranchCreationConfigArgsDict(TypedDict):
        basic_auth_credentials: NotRequired[pulumi.Input[builtins.str]]
        """
        Basic authorization credentials for the autocreated branch.
        """
        build_spec: NotRequired[pulumi.Input[builtins.str]]
        """
        Build specification (build spec) for the autocreated branch.
        """
        enable_auto_build: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enables auto building for the autocreated branch.
        """
        enable_basic_auth: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enables basic authorization for the autocreated branch.
        """
        enable_performance_mode: NotRequired[pulumi.Input[builtins.bool]]
        """
        Enables performance mode for the branch.
        """
        enable_pull_request_preview: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        pull_request_environment_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppAutoBranchCreationConfigArgs:
    def __init__(__self__, *,
                 ...
                 enable_auto_build: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] basic_auth_credentials: Basic authorization credentials for the autocreated branch.
        :param pulumi.Input[builtins.str] build_spec: Build specification (build spec) for the autocreated branch.
        :param pulumi.Input[builtins.bool] enable_auto_build: Enables auto building for the autocreated branch.
        :param pulumi.Input[builtins.bool] enable_basic_auth: Enables basic authorization for the autocreated branch.
        :param pulumi.Input[builtins.bool] enable_performance_mode: Enables performance mode for the branch.
        :param pulumi.Input[builtins.bool] enable_pull_request_preview: Enables pull request previews for the autocreated branch.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] environment_variables: Environment variables for the autocreated branch.
        :param pulumi.Input[builtins.str] framework: Framework for the autocreated branch.
        :param pulumi.Input[builtins.str] pull_request_environment_name: Amplify environment name for the pull request.
        :param pulumi.Input[builtins.str] stage: Describes the current stage for the autocreated branch. Valid values: `PRODUCTION`, `BETA`, `DEVELOPMENT`, `EXPERIMENTAL`, `PULL_REQUEST`.
        """
    ...
    def enable_auto_build(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables auto building for the autocreated branch.
        """
    ...
    def enable_auto_build(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def enable_performance_mode(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables performance mode for the branch.
        """
    ...
    def enable_performance_mode(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_performance_mode", value)

    @property
    @pulumi.getter(name="enablePullRequestPreview")
    def enable_pull_request_preview(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables pull request previews for the autocreated branch.
        """
    ...
    def enable_pull_request_preview(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def pull_request_environment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Amplify environment name for the pull request.
        """
...
class AppCacheConfigArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: Type of cache configuration to use for an Amplify app. Valid values: `AMPLIFY_MANAGED`, `AMPLIFY_MANAGED_NO_COOKIES`.
        """
...
class AppCustomRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] source: Source pattern for a URL rewrite or redirect rule.
        :param pulumi.Input[builtins.str] target: Target pattern for a URL rewrite or redirect rule.
        :param pulumi.Input[builtins.str] condition: Condition for a URL rewrite or redirect rule, such as a country code.
        :param pulumi.Input[builtins.str] status: Status code for a URL rewrite or redirect rule. Valid values: `200`, `301`, `302`, `404`, `404-200`.
        """
...
if not MYPY:
    class AppProductionBranchArgsDict(TypedDict):
        ...
        """
        last_deploy_time: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        thumbnail_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppProductionBranchArgs:
    def __init__(__self__, *,
                 ...
                 last_deploy_time: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 thumbnail_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] branch_name: Branch name for the production branch.
        :param pulumi.Input[builtins.str] last_deploy_time: Last deploy time of the production branch.
        :param pulumi.Input[builtins.str] status: Status of the production branch.
        :param pulumi.Input[builtins.str] thumbnail_url: Thumbnail URL for the production branch.
        """
    ...
    def last_deploy_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Last deploy time of the production branch.
        """
    ...
    def last_deploy_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def thumbnail_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Thumbnail URL for the production branch.
        """
    ...
    def thumbnail_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DomainAssociationCertificateSettingsArgsDict(TypedDict):
        ...
        """
        certificate_verification_dns_record: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DomainAssociationCertificateSettingsArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 certificate_verification_dns_record: Optional[pulumi.Input[builtins.str]] = None,
                 custom_certificate_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] custom_certificate_arn: The Amazon resource name (ARN) for the custom certificate.
               Required when `type` is `CUSTOM`.
        """
        pulumi.set(__self__, "type", type)
    ...
    def certificate_verification_dns_record(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        DNS records for certificate verification in a space-delimited format (`<record> CNAME <target>`).
        """
    ...
    def certificate_verification_dns_record(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def custom_certificate_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainAssociationSubDomainArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] branch_name: Branch name setting for the subdomain.
        :param pulumi.Input[builtins.str] prefix: Prefix setting for the subdomain.
        :param pulumi.Input[builtins.str] dns_record: DNS record for the subdomain in a space-prefixed and space-delimited format (` CNAME <target>`).
        :param pulumi.Input[builtins.bool] verified: Verified status of the subdomain.
        """
        pulumi.set(__self__, "branch_name", branch_name)
