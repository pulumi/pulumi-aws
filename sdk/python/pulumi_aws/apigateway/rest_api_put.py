...
class RestApiPutArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] body: PUT request body containing external API definitions. Currently, only OpenAPI definition JSON/YAML files are supported. The maximum size of the API definition file is 6MB.
        :param pulumi.Input[str] rest_api_id: Identifier of the associated REST API.
               
               The following arguments are optional:
        :param pulumi.Input[bool] fail_on_warnings: Whether to rollback the API update when a warning is encountered. The default value is `false`.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] parameters: Map of customizations for importing the specification in the `body` argument. For example, to exclude DocumentationParts from an imported API, use `ignore = "documentation"`. Additional documentation, including other parameters such as `basepath`, can be found in the [API Gateway Developer Guide](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-import-api.html).
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] triggers: Map of arbitrary keys and values that, when changed, will trigger a redeployment. To force a redeployment without changing these keys/values, use the `-replace` option with `pulumi preview` or `pulumi up`.
        """
...
class RestApiPut(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rest_api_id: Optional[pulumi.Input[str]] = None,
            timeouts: Optional[pulumi.Input[Union['RestApiPutTimeoutsArgs', 'RestApiPutTimeoutsArgsDict']]] = None,
            triggers: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None) -> 'RestApiPut':
        """
    ...
    @property
    @pulumi.getter(name="failOnWarnings")
    def fail_on_warnings(self) -> pulumi.Output[bool]:
        """
        Whether to rollback the API update when a warning is encountered. The default value is `false`.
        """
        return pulumi.get(self, "fail_on_warnings")
