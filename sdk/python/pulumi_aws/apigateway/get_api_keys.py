...
class GetApiKeysResult:
    ...
    def include_values(self) -> Optional[bool]:
...
def get_api_keys(customer_id: Optional[str] = None,
    ...
    :param bool include_values: Set this value to `true` if you wish the result contains the key value. Defaults to `false`.
    """
    __args__ = dict()
...
def get_api_keys_output(customer_id: Optional[pulumi.Input[Optional[str]]] = None,
                        include_values: Optional[pulumi.Input[Optional[bool]]] = None,
