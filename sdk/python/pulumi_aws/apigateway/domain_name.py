...
class DomainNameArgs:
    ...
    def _configure(
        ...
        if 'certificatePrivateKey' in kwargs:
        ...
        if 'regionalCertificateName' in kwargs:
...
class _DomainNameState:
    ...
    def _configure(
        ...
        if 'regionalCertificateName' in kwargs:
            regional_certificate_name = kwargs['regionalCertificateName']
        if 'regionalDomainName' in kwargs:
            regional_domain_name = kwargs['regionalDomainName']
        if 'regionalZoneId' in kwargs:
