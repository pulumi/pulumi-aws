...
class AccountThrottleSettingArgs:
    def __init__(__self__, *,
                 ...
                 rate_limit: pulumi.Input[builtins.float]):
        """
        :param pulumi.Input[builtins.int] burst_limit: Absolute maximum number of times API Gateway allows the API to be called per second (RPS).
        :param pulumi.Input[builtins.float] rate_limit: Number of times API Gateway allows the API to be called per second on average (RPS).
        """
    ...
    def burst_limit(self) -> pulumi.Input[builtins.int]:
        """
        Absolute maximum number of times API Gateway allows the API to be called per second (RPS).
        """
    ...
    @burst_limit.setter
    def burst_limit(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "burst_limit", value)

    @property
    @pulumi.getter(name="rateLimit")
    def rate_limit(self) -> pulumi.Input[builtins.float]:
        """
        Number of times API Gateway allows the API to be called per second on average (RPS).
        """
...
class DocumentationPartLocationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Type of API entity to which the documentation content appliesE.g., `API`, `METHOD` or `REQUEST_BODY`
        :param pulumi.Input[builtins.str] method: HTTP verb of a method. The default value is `*` for any method.
        :param pulumi.Input[builtins.str] name: Name of the targeted API entity.
        :param pulumi.Input[builtins.str] path: URL path of the target. The default value is `/` for the root resource.
        :param pulumi.Input[builtins.str] status_code: HTTP status code of a response. The default value is `*` for any status code.
        """
...
class DomainNameEndpointConfigurationArgs:
    ...
    @property
    @pulumi.getter
    def types(self) -> pulumi.Input[builtins.str]:
        """
        A list of endpoint types of an API or its custom domain name. For an edge-optimized API and its custom domain name, the endpoint type is `EDGE`. For a regional API and its custom domain name, the endpoint type is `REGIONAL`. For a private API, the endpoint type is `PRIVATE`.
        """
...
if not MYPY:
    class IntegrationTlsConfigArgsDict(TypedDict):
        insecure_skip_verification: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class IntegrationTlsConfigArgs:
    def __init__(__self__, *,
                 insecure_skip_verification: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] insecure_skip_verification: Whether or not API Gateway skips verification that the certificate for an integration endpoint is issued by a [supported certificate authority](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-supported-certificate-authorities-for-http-endpoints.html). This isn’t recommended, but it enables you to use certificates that are signed by private certificate authorities, or certificates that are self-signed. If enabled, API Gateway still performs basic certificate validation, which includes checking the certificate's expiration date, hostname, and presence of a root certificate authority. Supported only for `HTTP` and `HTTP_PROXY` integrations.
        """
    ...
    def insecure_skip_verification(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether or not API Gateway skips verification that the certificate for an integration endpoint is issued by a [supported certificate authority](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-supported-certificate-authorities-for-http-endpoints.html). This isn’t recommended, but it enables you to use certificates that are signed by private certificate authorities, or certificates that are self-signed. If enabled, API Gateway still performs basic certificate validation, which includes checking the certificate's expiration date, hostname, and presence of a root certificate authority. Supported only for `HTTP` and `HTTP_PROXY` integrations.
        """
    ...
    def insecure_skip_verification(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class MethodSettingsSettingsArgsDict(TypedDict):
        ...
        """
        require_authorization_for_cache_control: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        unauthorized_cache_control_header_strategy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MethodSettingsSettingsArgs:
    def __init__(__self__, *,
                 ...
                 require_authorization_for_cache_control: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 unauthorized_cache_control_header_strategy: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] cache_data_encrypted: Whether the cached responses are encrypted.
        :param pulumi.Input[builtins.int] cache_ttl_in_seconds: Time to live (TTL), in seconds, for cached responses. The higher the TTL, the longer the response will be cached.
        :param pulumi.Input[builtins.bool] caching_enabled: Whether responses should be cached and returned for requests. A cache cluster must be enabled on the stage for responses to be cached.
        :param pulumi.Input[builtins.bool] data_trace_enabled: Whether data trace logging is enabled for this method, which effects the log entries pushed to Amazon CloudWatch Logs.
        :param pulumi.Input[builtins.str] logging_level: Logging level for this method, which effects the log entries pushed to Amazon CloudWatch Logs. The available levels are `OFF`, `ERROR`, and `INFO`.
        :param pulumi.Input[builtins.bool] metrics_enabled: Whether Amazon CloudWatch metrics are enabled for this method.
        :param pulumi.Input[builtins.bool] require_authorization_for_cache_control: Whether authorization is required for a cache invalidation request.
        :param pulumi.Input[builtins.int] throttling_burst_limit: Throttling burst limit. Default: `-1` (throttling disabled).
        :param pulumi.Input[builtins.float] throttling_rate_limit: Throttling rate limit. Default: `-1` (throttling disabled).
        :param pulumi.Input[builtins.str] unauthorized_cache_control_header_strategy: How to handle unauthorized requests for cache invalidation. The available values are `FAIL_WITH_403`, `SUCCEED_WITH_RESPONSE_HEADER`, `SUCCEED_WITHOUT_RESPONSE_HEADER`.
        """
    ...
    def require_authorization_for_cache_control(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether authorization is required for a cache invalidation request.
        """
    ...
    def require_authorization_for_cache_control(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def unauthorized_cache_control_header_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        How to handle unauthorized requests for cache invalidation. The available values are `FAIL_WITH_403`, `SUCCEED_WITH_RESPONSE_HEADER`, `SUCCEED_WITHOUT_RESPONSE_HEADER`.
        """
    ...
    def unauthorized_cache_control_header_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StageAccessLogSettingsArgs:
    def __init__(__self__, *,
                 ...
                 format: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] destination_arn: ARN of the CloudWatch Logs log group or Kinesis Data Firehose delivery stream to receive access logs. If you specify a Kinesis Data Firehose delivery stream, the stream name must begin with `amazon-apigateway-`. Automatically removes trailing `:*` if present.
        :param pulumi.Input[builtins.str] format: Formatting and values recorded in the logs.
               For more information on configuring the log format rules visit the AWS [documentation](https://docs.aws.amazon.com/apigateway/latest/developerguide/set-up-logging.html)
        """
...
class StageCanarySettingsArgs:
    def __init__(__self__, *,
                 ...
                 use_stage_cache: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] deployment_id: ID of the deployment that the canary points to.
        :param pulumi.Input[builtins.float] percent_traffic: Percent `0.0` - `100.0` of traffic to divert to the canary deployment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] stage_variable_overrides: Map of overridden stage `variables` (including new variables) for the canary deployment.
        :param pulumi.Input[builtins.bool] use_stage_cache: Whether the canary deployment uses the stage cache. Defaults to false.
        """
...
class UsagePlanApiStageThrottleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] path: Method to apply the throttle settings for. Specfiy the path and method, for example `/test/GET`.
        :param pulumi.Input[builtins.int] burst_limit: The API request burst limit, the maximum rate limit over a time ranging from one to a few seconds, depending upon whether the underlying token bucket is at its full capacity.
        :param pulumi.Input[builtins.float] rate_limit: The API request steady-state rate limit.
        """
        pulumi.set(__self__, "path", path)
...
class UsagePlanQuotaSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] limit: Maximum number of requests that can be made in a given time period.
        :param pulumi.Input[builtins.str] period: Time period in which the limit applies. Valid values are "DAY", "WEEK" or "MONTH".
        :param pulumi.Input[builtins.int] offset: Number of requests subtracted from the given limit in the initial time period.
        """
