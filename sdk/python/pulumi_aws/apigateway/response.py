...
class Response(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            response_type: Optional[pulumi.Input[builtins.str]] = None,
            rest_api_id: Optional[pulumi.Input[builtins.str]] = None,
            status_code: Optional[pulumi.Input[builtins.str]] = None) -> 'Response':
        """
    ...
    @property
    @pulumi.getter(name="responseType")
    def response_type(self) -> pulumi.Output[builtins.str]:
        """
        Response type of the associated GatewayResponse.
        """
        return pulumi.get(self, "response_type")
    ...
    @property
    @pulumi.getter(name="statusCode")
    def status_code(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        HTTP status code of the Gateway Response.
        """
        return pulumi.get(self, "status_code")
