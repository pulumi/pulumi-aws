...
class FormTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_identifier: Identifier of the domain.
...
class _FormTypeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: Creation time of the Form Type.
        :param pulumi.Input[builtins.str] created_by: Creator of the Form Type.
        :param pulumi.Input[builtins.str] description: Description of form type. Must have a length of between 1 and 2048 characters.
        :param pulumi.Input[builtins.str] domain_identifier: Identifier of the domain.
        :param pulumi.Input['FormTypeModelArgs'] model: Object of the model of the form type that contains the following attributes.
        :param pulumi.Input[builtins.str] name: Name of the form type. Must be the name of the structure in smithy document.
    ...
    def origin_domain_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def origin_domain_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "origin_domain_id", value)

    @property
    @pulumi.getter(name="originProjectId")
    def origin_project_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def origin_project_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FormType(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="originDomainId")
    def origin_domain_id(self) -> pulumi.Output[builtins.str]:
        """
        Origin domain id of the Form Type.
        """
        return pulumi.get(self, "origin_domain_id")
    ...
    @property
    @pulumi.getter(name="originProjectId")
    def origin_project_id(self) -> pulumi.Output[builtins.str]:
        """
        Origin project id of the Form Type.
        """
        return pulumi.get(self, "origin_project_id")
