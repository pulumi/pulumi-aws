...
class EnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 profile_identifier: pulumi.Input[builtins.str],
                 project_identifier: pulumi.Input[builtins.str],
                 account_identifier: Optional[pulumi.Input[builtins.str]] = None,
                 account_region: Optional[pulumi.Input[builtins.str]] = None,
                 blueprint_identifier: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_identifier: The ID of the domain where the environment exists.
        :param pulumi.Input[builtins.str] profile_identifier: The ID of the profile with which the environment is created.
        :param pulumi.Input[builtins.str] project_identifier: The ID of the project where the environment exists.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] account_identifier: The ID of the Amazon Web Services account where the environment exists
        :param pulumi.Input[builtins.str] account_region: The Amazon Web Services region where the environment exists.
        :param pulumi.Input[builtins.str] blueprint_identifier: The blueprint with which the environment is created.
    ...
    def profile_identifier(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def profile_identifier(self, value: pulumi.Input[builtins.str]):
    ...
    def account_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def account_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "account_region", value)

    @property
    @pulumi.getter(name="blueprintIdentifier")
    def blueprint_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def blueprint_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EnvironmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_region: The Amazon Web Services region where the environment exists.
        :param pulumi.Input[builtins.str] blueprint_identifier: The blueprint with which the environment is created.
        :param pulumi.Input[builtins.str] created_at: The time the environment was created.
        :param pulumi.Input[builtins.str] created_by: The user who created the environment.
        :param pulumi.Input[builtins.str] description: The description of the environment.
        :param pulumi.Input[builtins.str] domain_identifier: The ID of the domain where the environment exists.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] glossary_terms: The business glossary terms that can be used in this environment.
    ...
    @property
    @pulumi.getter(name="profileIdentifier")
    def profile_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the profile with which the environment is created.
        """
        return pulumi.get(self, "profile_identifier")
    ...
    @profile_identifier.setter
    def profile_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "profile_identifier", value)
    ...
    def provider_environment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provider_environment(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Environment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="accountRegion")
    def account_region(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Web Services region where the environment exists.
        """
        return pulumi.get(self, "account_region")
    ...
    @property
    @pulumi.getter(name="blueprintIdentifier")
    def blueprint_identifier(self) -> pulumi.Output[builtins.str]:
        """
        The blueprint with which the environment is created.
        """
        return pulumi.get(self, "blueprint_identifier")
    ...
    @property
    @pulumi.getter(name="profileIdentifier")
    def profile_identifier(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the profile with which the environment is created.
        """
        return pulumi.get(self, "profile_identifier")
    ...
    @property
    @pulumi.getter(name="providerEnvironment")
    def provider_environment(self) -> pulumi.Output[builtins.str]:
        """
        The provider of the environment.
        """
        return pulumi.get(self, "provider_environment")
