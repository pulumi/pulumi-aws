...
class EnvironmentProfileArgs:
    def __init__(__self__, *,
                 aws_account_region: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] aws_account_region: Desired region for environment profile.
    ...
    def aws_account_region(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def aws_account_region(self, value: pulumi.Input[builtins.str]):
    ...
    def environment_blueprint_identifier(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def environment_blueprint_identifier(self, value: pulumi.Input[builtins.str]):
...
class _EnvironmentProfileState:
    def __init__(__self__, *,
                 aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 aws_account_region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] aws_account_id: Id of the AWS account being used.
        :param pulumi.Input[builtins.str] aws_account_region: Desired region for environment profile.
        :param pulumi.Input[builtins.str] created_at: Creation time of environment profile.
        :param pulumi.Input[builtins.str] created_by: Creator of environment profile.
        :param pulumi.Input[builtins.str] description: Description of environment profile.
        :param pulumi.Input[builtins.str] domain_identifier: Domain Identifier for environment profile.
        :param pulumi.Input[builtins.str] environment_blueprint_identifier: ID of the blueprint which the environment will be created with.
        :param pulumi.Input[builtins.str] name: Name of the environment profile.
    ...
    @property
    @pulumi.getter(name="awsAccountRegion")
    def aws_account_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Desired region for environment profile.
        """
        return pulumi.get(self, "aws_account_region")
    ...
    @aws_account_region.setter
    def aws_account_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "aws_account_region", value)
    ...
    @property
    @pulumi.getter(name="environmentBlueprintIdentifier")
    def environment_blueprint_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the blueprint which the environment will be created with.
        """
        return pulumi.get(self, "environment_blueprint_identifier")
    ...
    @environment_blueprint_identifier.setter
    def environment_blueprint_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "environment_blueprint_identifier", value)
...
class EnvironmentProfile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="environmentBlueprintIdentifier")
    def environment_blueprint_identifier(self) -> pulumi.Output[builtins.str]:
        """
        ID of the blueprint which the environment will be created with.
        """
        return pulumi.get(self, "environment_blueprint_identifier")
