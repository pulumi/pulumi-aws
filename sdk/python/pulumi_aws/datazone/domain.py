...
class DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_execution_role: ARN of the role used by DataZone to configure the Domain.
...
class _DomainState:
    ...
    @property
    @pulumi.getter(name="domainExecutionRole")
    def domain_execution_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the role used by DataZone to configure the Domain.
    ...
    @domain_execution_role.setter
    def domain_execution_role(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "domain_execution_role", value)
    ...
    def portal_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @portal_url.setter
    def portal_url(self, value: Optional[pulumi.Input[builtins.str]]):
