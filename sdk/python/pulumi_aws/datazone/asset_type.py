...
class AssetTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_identifier: The unique identifier of the Amazon DataZone domain where the custom asset type is being created.
...
class _AssetTypeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The timestamp when the custom asset type was created.
        :param pulumi.Input[builtins.str] created_by: The user who created the custom asset type.
        :param pulumi.Input[builtins.str] description: The description of the custom asset type.
        :param pulumi.Input[builtins.str] domain_identifier: The unique identifier of the Amazon DataZone domain where the custom asset type is being created.
        :param pulumi.Input[Sequence[pulumi.Input['AssetTypeFormsInputArgs']]] forms_inputs: The metadata forms that are to be attached to the custom asset type.
        :param pulumi.Input[builtins.str] name: The name of the custom asset type.
