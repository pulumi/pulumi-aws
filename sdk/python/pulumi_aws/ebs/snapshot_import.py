...
class SnapshotImportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description string for the import snapshot task.
...
class SnapshotImport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            temporary_restore_days: Optional[pulumi.Input[builtins.int]] = None,
            volume_id: Optional[pulumi.Input[builtins.str]] = None,
            volume_size: Optional[pulumi.Input[builtins.int]] = None) -> 'SnapshotImport':
        """
