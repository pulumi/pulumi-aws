...
if not MYPY:
    class SnapshotImportClientDataArgsDict(TypedDict):
        ...
        """
        upload_end: NotRequired[pulumi.Input[builtins.str]]
        """
        The time that the disk upload ends.
        """
        upload_size: NotRequired[pulumi.Input[builtins.float]]
        """
        The size of the uploaded disk image, in GiB.
        """
        upload_start: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SnapshotImportClientDataArgs:
    def __init__(__self__, *,
                 ...
                 upload_end: Optional[pulumi.Input[builtins.str]] = None,
                 upload_size: Optional[pulumi.Input[builtins.float]] = None,
                 upload_start: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] comment: A user-defined comment about the disk upload.
        :param pulumi.Input[builtins.str] upload_end: The time that the disk upload ends.
        :param pulumi.Input[builtins.float] upload_size: The size of the uploaded disk image, in GiB.
        :param pulumi.Input[builtins.str] upload_start: The time that the disk upload starts.
        """
    ...
    def upload_end(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time that the disk upload ends.
        """
    ...
    @upload_end.setter
    def upload_end(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "upload_end", value)

    @property
    @pulumi.getter(name="uploadSize")
    def upload_size(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The size of the uploaded disk image, in GiB.
        """
    ...
    @upload_size.setter
    def upload_size(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "upload_size", value)

    @property
    @pulumi.getter(name="uploadStart")
    def upload_start(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time that the disk upload starts.
        """
    ...
    @upload_start.setter
    def upload_start(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SnapshotImportDiskContainerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] format: The format of the disk image being imported. One of `VHD` or `VMDK`.
        :param pulumi.Input[builtins.str] description: The description of the disk image being imported.
        :param pulumi.Input[builtins.str] url: The URL to the Amazon S3-based disk image being imported. It can either be a https URL (https://..) or an Amazon S3 URL (s3://..). One of `url` or `user_bucket` must be set.
...
class SnapshotImportDiskContainerUserBucketArgs:
    def __init__(__self__, *,
                 ...
                 s3_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] s3_bucket: The name of the Amazon S3 bucket where the disk image is located.
        :param pulumi.Input[builtins.str] s3_key: The file name of the disk image.
        """
