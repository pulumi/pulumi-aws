...
def get_ebs_volumes(filters: Optional[Sequence[Union['GetEbsVolumesFilterArgs', 'GetEbsVolumesFilterArgsDict', 'outputs.GetEbsVolumesFilterResult']]] = None,
    ...
    :param Sequence[Union['GetEbsVolumesFilterArgs', 'GetEbsVolumesFilterArgsDict', 'outputs.GetEbsVolumesFilterResult']] filters: Custom filter block as described below.
...
def get_ebs_volumes_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetEbsVolumesFilterArgs', 'GetEbsVolumesFilterArgsDict', 'outputs.GetEbsVolumesFilterResult']]]]] = None,
