...
class ProbeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] destination: The destination IP address. This must be either IPV4 or IPV6.
...
class Probe(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Probe':
        """
    ...
    @property
    @pulumi.getter(name="probeId")
    def probe_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "probe_id")
