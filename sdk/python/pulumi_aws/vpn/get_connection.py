...
warnings.warn("""aws.vpn/getconnection.getConnection has been deprecated in favor of aws.ec2/getvpnconnection.getVpnConnection""", DeprecationWarning)
...
def get_connection(filters: Optional[Sequence[Union['GetConnectionFilterArgs', 'GetConnectionFilterArgsDict']]] = None,
    ...
    """
    pulumi.log.warn("""get_connection is deprecated: aws.vpn/getconnection.getConnection has been deprecated in favor of aws.ec2/getvpnconnection.getVpnConnection""")
    __args__ = dict()
    __args__['filters'] = filters
    __args__['region'] = region
    __args__['vpnConnectionId'] = vpn_connection_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('aws:vpn/getConnection:getConnection', __args__, opts=opts, typ=GetConnectionResult).value
...
def get_connection_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetConnectionFilterArgs', 'GetConnectionFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws:vpn/getConnection:getConnection', __args__, opts=opts, typ=GetConnectionResult)
