...
class GetTargetGroupResult:
    ...
    def connection_termination(self) -> builtins.bool:
    ...
    def lambda_multi_value_headers_enabled(self) -> builtins.bool:
        return pulumi.get(self, "lambda_multi_value_headers_enabled")

    @property
    @pulumi.getter(name="loadBalancerArns")
    def load_balancer_arns(self) -> Sequence[builtins.str]:
    ...
    def proxy_protocol_v2(self) -> builtins.bool:
