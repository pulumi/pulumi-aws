...
def get_target_group(arn: Optional[_builtins.str] = None,
                     load_balancing_anomaly_mitigation: Optional[_builtins.str] = None,
...
def get_target_group_output(arn: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                            load_balancing_anomaly_mitigation: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
