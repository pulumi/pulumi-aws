...
class EmailChannelArgs:
    ...
    def orchestration_sending_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def orchestration_sending_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EmailChannel(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="configurationSet")
    def configuration_set(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the Amazon SES configuration set that you want to apply to messages that you send through the channel.
        """
        return pulumi.get(self, "configuration_set")
    ...
    @property
    @pulumi.getter(name="messagesPerSecond")
    def messages_per_second(self) -> pulumi.Output[builtins.int]:
        """
        Messages per second that can be sent.
        """
        return pulumi.get(self, "messages_per_second")
    ...
    @property
    @pulumi.getter(name="orchestrationSendingRoleArn")
    def orchestration_sending_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of an IAM role for Amazon Pinpoint to use to send email from your campaigns or journeys through Amazon SES.
        """
        return pulumi.get(self, "orchestration_sending_role_arn")
