...
class Smsvoicev2ConfigurationSetArgs:
    def __init__(__self__, *,
                 default_message_type: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] default_message_type: The default message type. Must either be "TRANSACTIONAL" or "PROMOTIONAL"
        :param pulumi.Input[str] default_sender_id: The default sender ID to use for this configuration set.
    ...
    def default_message_type(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def default_message_type(self, value: Optional[pulumi.Input[str]]):
...
class Smsvoicev2ConfigurationSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None) -> 'Smsvoicev2ConfigurationSet':
        """
    ...
    @property
    @pulumi.getter(name="defaultMessageType")
    def default_message_type(self) -> pulumi.Output[Optional[str]]:
        """
        The default message type. Must either be "TRANSACTIONAL" or "PROMOTIONAL"
        """
        return pulumi.get(self, "default_message_type")
