...
class Smsvoicev2ConfigurationSetArgs:
    def __init__(__self__, *,
                 default_message_type: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def default_message_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_message_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Smsvoicev2ConfigurationSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Smsvoicev2ConfigurationSet':
        """
    ...
    @property
    @pulumi.getter(name="defaultMessageType")
    def default_message_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The default message type. Must either be "TRANSACTIONAL" or "PROMOTIONAL"
        """
        return pulumi.get(self, "default_message_type")
