...
class Smsvoicev2OptOutListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The name of the opt-out list.
...
class _Smsvoicev2OptOutListState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] arn: ARN of the opt-out list.
        :param pulumi.Input[str] name: The name of the opt-out list.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Key-value map of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
...
class Smsvoicev2OptOutList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None) -> 'Smsvoicev2OptOutList':
        """
