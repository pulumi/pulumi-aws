...
class Smsvoicev2OptOutListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the opt-out list.
...
class Smsvoicev2OptOutList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'Smsvoicev2OptOutList':
        """
