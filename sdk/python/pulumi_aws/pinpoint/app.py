...
class AppArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The application name. By default generated by Pulumi
...
class _AppState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: The Application ID of the Pinpoint App.
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the PinPoint Application
        :param pulumi.Input['AppCampaignHookArgs'] campaign_hook: Specifies settings for invoking an AWS Lambda function that customizes a segment for a campaign
        :param pulumi.Input['AppLimitsArgs'] limits: The default campaign limits for the app. These limits apply to each campaign for the app, unless the campaign overrides the default with limits of its own
        :param pulumi.Input[builtins.str] name: The application name. By default generated by Pulumi
        :param pulumi.Input[builtins.str] name_prefix: The name of the Pinpoint application. Conflicts with `name`
