...
class SmsChannelArgs:
    ...
    def short_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @short_code.setter
    def short_code(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SmsChannelState:
    ...
    def promotional_messages_per_second(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def transactional_messages_per_second(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def transactional_messages_per_second(self, value: Optional[pulumi.Input[builtins.int]]):
...
class SmsChannel(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="promotionalMessagesPerSecond")
    def promotional_messages_per_second(self) -> pulumi.Output[builtins.int]:
        """
        Maximum number of promotional messages that can be sent per second.
        """
        return pulumi.get(self, "promotional_messages_per_second")
    ...
    @property
    @pulumi.getter(name="senderId")
    def sender_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Identifier of the sender for your messages.
        """
        return pulumi.get(self, "sender_id")
    ...
    @property
    @pulumi.getter(name="shortCode")
    def short_code(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Short Code registered with the phone provider.
        """
        return pulumi.get(self, "short_code")
    ...
    @property
    @pulumi.getter(name="transactionalMessagesPerSecond")
    def transactional_messages_per_second(self) -> pulumi.Output[builtins.int]:
        """
        Maximum number of transactional messages per second that can be sent.
        """
        return pulumi.get(self, "transactional_messages_per_second")
