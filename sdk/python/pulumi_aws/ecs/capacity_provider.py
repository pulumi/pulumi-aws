...
class CapacityProvider(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_group = aws.autoscaling.group.Group("testGroup", tags=[{
            key: AmazonECSManaged,
            value: True,
            propagateAtLaunch: True,
        }])
        test_capacity_provider = aws.ecs.capacity_provider.CapacityProvider("testCapacityProvider", auto_scaling_group_provider={
