...
class ServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ServiceServiceConnectConfigurationArgs'] service_connect_configuration: The ECS Service Connect configuration for this service to discover and connect to services, and be discovered by, and connected from, other services within a namespace. See below.
    ...
    def _configure(
        ...
        if 'deploymentMaximumPercent' in kwargs:
            deployment_maximum_percent = kwargs['deploymentMaximumPercent']
        if 'deploymentMinimumHealthyPercent' in kwargs:
        ...
        if 'forceNewDeployment' in kwargs:
        ...
        if 'waitForSteadyState' in kwargs:
...
class Service(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] propagate_tags: Specifies whether to propagate the tags from the task definition or the service to the tasks. The valid values are `SERVICE` and `TASK_DEFINITION`.
        :param pulumi.Input[str] scheduling_strategy: Scheduling strategy to use for the service. The valid values are `REPLICA` and `DAEMON`. Defaults to `REPLICA`. Note that [*Tasks using the Fargate launch type or the `CODE_DEPLOY` or `EXTERNAL` deployment controller types don't support the `DAEMON` scheduling strategy*](https://docs.aws.amazon.com/AmazonECS/latest/APIReference/API_CreateService.html).
        :param pulumi.Input[pulumi.InputType['ServiceServiceConnectConfigurationArgs']] service_connect_configuration: The ECS Service Connect configuration for this service to discover and connect to services, and be discovered by, and connected from, other services within a namespace. See below.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if alarms is not None and not isinstance(alarms, ServiceAlarmsArgs):
                alarms = alarms or {}
                def _setter(key, value):
                    alarms[key] = value
                ServiceAlarmsArgs._configure(_setter, **alarms)
            __props__.__dict__["alarms"] = alarms
            __props__.__dict__["capacity_provider_strategies"] = capacity_provider_strategies
            __props__.__dict__["cluster"] = cluster
            if deployment_circuit_breaker is not None and not isinstance(deployment_circuit_breaker, ServiceDeploymentCircuitBreakerArgs):
                deployment_circuit_breaker = deployment_circuit_breaker or {}
                def _setter(key, value):
                    deployment_circuit_breaker[key] = value
                ServiceDeploymentCircuitBreakerArgs._configure(_setter, **deployment_circuit_breaker)
            ...
            if service_connect_configuration is not None and not isinstance(service_connect_configuration, ServiceServiceConnectConfigurationArgs):
                service_connect_configuration = service_connect_configuration or {}
                def _setter(key, value):
                    service_connect_configuration[key] = value
                ServiceServiceConnectConfigurationArgs._configure(_setter, **service_connect_configuration)
            __props__.__dict__["service_connect_configuration"] = service_connect_configuration
            if service_registries is not None and not isinstance(service_registries, ServiceServiceRegistriesArgs):
                service_registries = service_registries or {}
                def _setter(key, value):
                    service_registries[key] = value
                ServiceServiceRegistriesArgs._configure(_setter, **service_registries)
