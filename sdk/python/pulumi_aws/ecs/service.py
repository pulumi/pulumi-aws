...
class ServiceArgs:
    def __init__(__self__, *,
                 ...
                 force_new_deployment: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 wait_for_steady_state: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] desired_count: Number of instances of the task definition to place and keep running. Defaults to 0. Do not specify if using the `DAEMON` scheduling strategy.
        :param pulumi.Input[builtins.bool] enable_ecs_managed_tags: Whether to enable Amazon ECS managed tags for the tasks within the service.
        :param pulumi.Input[builtins.bool] enable_execute_command: Whether to enable Amazon ECS Exec for the tasks within the service.
        :param pulumi.Input[builtins.bool] force_delete: Enable to delete a service even if it wasn't scaled down to zero tasks. It's only necessary to use this if the service uses the `REPLICA` scheduling strategy.
        :param pulumi.Input[builtins.bool] force_new_deployment: Enable to force a new task deployment of the service. This can be used to update tasks to use a newer Docker image with same image/tag combination (e.g., `myimage:latest`), roll Fargate tasks onto a newer platform version, or immediately deploy `ordered_placement_strategy` and `placement_constraints` updates.
               When using the forceNewDeployment property you also need to configure the triggers property.
        :param pulumi.Input[builtins.int] health_check_grace_period_seconds: Seconds to ignore failing load balancer health checks on newly instantiated tasks to prevent premature shutdown, up to 2147483647. Only valid for services configured to use load balancers.
        :param pulumi.Input[builtins.str] iam_role: ARN of the IAM role that allows Amazon ECS to make calls to your load balancer on your behalf. This parameter is required if you are using a load balancer with your service, but only if your task definition does not use the `awsvpc` network mode. If using `awsvpc` network mode, do not specify this role. If your account has already created the Amazon ECS service-linked role, that role is used by default for your service unless you specify a role here.
        :param pulumi.Input[builtins.str] launch_type: Launch type on which to run your service. The valid values are `EC2`, `FARGATE`, and `EXTERNAL`. Defaults to `EC2`. Conflicts with `capacity_provider_strategy`.
        ...
        :param pulumi.Input[builtins.str] name: Name of the service (up to 255 letters, numbers, hyphens, and underscores)
        ...
        :param pulumi.Input[builtins.bool] wait_for_steady_state: If `true`, this provider will wait for the service to reach a steady state (like [`aws ecs wait services-stable`](https://docs.aws.amazon.com/cli/latest/reference/ecs/wait/services-stable.html)) before continuing. Default `false`.
        """
    ...
    def availability_zone_rebalancing(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def availability_zone_rebalancing(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def deployment_maximum_percent(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def deployment_maximum_percent(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "deployment_maximum_percent", value)

    @property
    @pulumi.getter(name="deploymentMinimumHealthyPercent")
    def deployment_minimum_healthy_percent(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def deployment_minimum_healthy_percent(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def force_new_deployment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def force_new_deployment(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def wait_for_steady_state(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def wait_for_steady_state(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Service(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volume_configuration: Optional[pulumi.Input[Union['ServiceVolumeConfigurationArgs', 'ServiceVolumeConfigurationArgsDict']]] = None,
            vpc_lattice_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ServiceVpcLatticeConfigurationArgs', 'ServiceVpcLatticeConfigurationArgsDict']]]]] = None,
            wait_for_steady_state: Optional[pulumi.Input[builtins.bool]] = None) -> 'Service':
        """
    ...
    @property
    @pulumi.getter(name="availabilityZoneRebalancing")
    def availability_zone_rebalancing(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ECS automatically redistributes tasks within a service across Availability Zones (AZs) to mitigate the risk of impaired application availability due to underlying infrastructure failures and task lifecycle activities. The valid values are `ENABLED` and `DISABLED`. Defaults to `DISABLED`.
        """
        return pulumi.get(self, "availability_zone_rebalancing")
    ...
    @property
    @pulumi.getter(name="deploymentMaximumPercent")
    def deployment_maximum_percent(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Upper limit (as a percentage of the service's desiredCount) of the number of running tasks that can be running in a service during a deployment. Not valid when using the `DAEMON` scheduling strategy.
        """
        return pulumi.get(self, "deployment_maximum_percent")
    ...
    @property
    @pulumi.getter(name="deploymentMinimumHealthyPercent")
    def deployment_minimum_healthy_percent(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Lower limit (as a percentage of the service's desiredCount) of the number of running tasks that must remain running and healthy in a service during a deployment.
        """
        return pulumi.get(self, "deployment_minimum_healthy_percent")
    ...
    @property
    @pulumi.getter(name="forceNewDeployment")
    def force_new_deployment(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable to force a new task deployment of the service. This can be used to update tasks to use a newer Docker image with same image/tag combination (e.g., `myimage:latest`), roll Fargate tasks onto a newer platform version, or immediately deploy `ordered_placement_strategy` and `placement_constraints` updates.
        When using the forceNewDeployment property you also need to configure the triggers property.
        """
    ...
    @property
    @pulumi.getter(name="propagateTags")
    def propagate_tags(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether to propagate the tags from the task definition or the service to the tasks. The valid values are `SERVICE` and `TASK_DEFINITION`.
        """
        return pulumi.get(self, "propagate_tags")
    ...
    @property
    @pulumi.getter(name="waitForSteadyState")
    def wait_for_steady_state(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `true`, this provider will wait for the service to reach a steady state (like [`aws ecs wait services-stable`](https://docs.aws.amazon.com/cli/latest/reference/ecs/wait/services-stable.html)) before continuing. Default `false`.
        """
        return pulumi.get(self, "wait_for_steady_state")
