...
class TaskSetArgs:
    ...
    def _configure(
        ...
        if 'waitUntilStable' in kwargs:
            wait_until_stable = kwargs['waitUntilStable']
        if 'waitUntilStableTimeout' in kwargs:
...
class TaskSet(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if service_registries is not None and not isinstance(service_registries, TaskSetServiceRegistriesArgs):
                service_registries = service_registries or {}
                def _setter(key, value):
                    service_registries[key] = value
                TaskSetServiceRegistriesArgs._configure(_setter, **service_registries)
