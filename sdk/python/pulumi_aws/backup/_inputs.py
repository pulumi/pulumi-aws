...
class FrameworkControlArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of a control. This name is between 1 and 256 characters.
...
class FrameworkControlInputParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of a parameter, for example, BackupPlanFrequency.
        :param pulumi.Input[builtins.str] value: The value of parameter, for example, hourly.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
if not MYPY:
    class FrameworkControlScopeArgsDict(TypedDict):
        compliance_resource_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The ID of the only AWS resource that you want your control scope to contain. Minimum number of 1 item. Maximum number of 100 items.
        """
        compliance_resource_types: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class FrameworkControlScopeArgs:
    def __init__(__self__, *,
                 compliance_resource_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 compliance_resource_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compliance_resource_ids: The ID of the only AWS resource that you want your control scope to contain. Minimum number of 1 item. Maximum number of 100 items.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compliance_resource_types: Describes whether the control scope includes one or more types of resources, such as EFS or RDS.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: The tag key-value pair applied to those AWS resources that you want to trigger an evaluation for a rule. A maximum of one key-value pair can be provided.
        """
    ...
    def compliance_resource_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The ID of the only AWS resource that you want your control scope to contain. Minimum number of 1 item. Maximum number of 100 items.
        """
    ...
    def compliance_resource_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "compliance_resource_ids", value)

    @property
    @pulumi.getter(name="complianceResourceTypes")
    def compliance_resource_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Describes whether the control scope includes one or more types of resources, such as EFS or RDS.
        """
    ...
    def compliance_resource_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class PlanAdvancedBackupSettingArgsDict(TypedDict):
        backup_options: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]
        """
...
class PlanAdvancedBackupSettingArgs:
    def __init__(__self__, *,
                 ...
                 resource_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] backup_options: Specifies the backup option for a selected resource. This option is only available for Windows VSS backup jobs. Set to `{ WindowsVSS = "enabled" }` to enable Windows VSS backup option and create a VSS Windows backup.
        :param pulumi.Input[builtins.str] resource_type: The type of AWS resource to be backed up. For VSS Windows backups, the only supported resource type is Amazon EC2. Valid values: `EC2`.
        """
    ...
    def backup_options(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
        Specifies the backup option for a selected resource. This option is only available for Windows VSS backup jobs. Set to `{ WindowsVSS = "enabled" }` to enable Windows VSS backup option and create a VSS Windows backup.
        """
    ...
    def backup_options(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class PlanRuleArgsDict(TypedDict):
        ...
        """
        target_vault_name: pulumi.Input[builtins.str]
        """
        The name of a logical container where backups are stored.
        """
        completion_window: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        enable_continuous_backup: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        recovery_point_tags: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        schedule_expression_timezone: NotRequired[pulumi.Input[builtins.str]]
        """
        The timezone in which the schedule expression is set. Default value: `"Etc/UTC"`.
        """
        start_window: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PlanRuleArgs:
    def __init__(__self__, *,
                 rule_name: pulumi.Input[builtins.str],
                 target_vault_name: pulumi.Input[builtins.str],
                 completion_window: Optional[pulumi.Input[builtins.int]] = None,
                 copy_actions: Optional[pulumi.Input[Sequence[pulumi.Input['PlanRuleCopyActionArgs']]]] = None,
                 enable_continuous_backup: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle: Optional[pulumi.Input['PlanRuleLifecycleArgs']] = None,
                 recovery_point_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 schedule: Optional[pulumi.Input[builtins.str]] = None,
                 schedule_expression_timezone: Optional[pulumi.Input[builtins.str]] = None,
                 start_window: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] rule_name: An display name for a backup rule.
        :param pulumi.Input[builtins.str] target_vault_name: The name of a logical container where backups are stored.
        :param pulumi.Input[builtins.int] completion_window: The amount of time in minutes AWS Backup attempts a backup before canceling the job and returning an error.
        ...
        :param pulumi.Input[builtins.bool] enable_continuous_backup: Enable continuous backups for supported resources.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] recovery_point_tags: Metadata that you can assign to help organize the resources that you create.
        :param pulumi.Input[builtins.str] schedule: A CRON expression specifying when AWS Backup initiates a backup job.
        :param pulumi.Input[builtins.str] schedule_expression_timezone: The timezone in which the schedule expression is set. Default value: `"Etc/UTC"`.
        :param pulumi.Input[builtins.int] start_window: The amount of time in minutes before beginning a backup.
        """
    ...
    def target_vault_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of a logical container where backups are stored.
        """
    ...
    def target_vault_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_vault_name", value)

    @property
    @pulumi.getter(name="completionWindow")
    def completion_window(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The amount of time in minutes AWS Backup attempts a backup before canceling the job and returning an error.
        """
    ...
    def completion_window(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def enable_continuous_backup(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable continuous backups for supported resources.
        """
    ...
    def enable_continuous_backup(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def recovery_point_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Metadata that you can assign to help organize the resources that you create.
        """
    ...
    def recovery_point_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def schedule_expression_timezone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "schedule_expression_timezone", value)

    @property
    @pulumi.getter(name="startWindow")
    def start_window(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The amount of time in minutes before beginning a backup.
        """
    ...
    @start_window.setter
    def start_window(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "start_window", value)


if not MYPY:
    class PlanRuleCopyActionArgsDict(TypedDict):
        destination_vault_arn: pulumi.Input[builtins.str]
        """
...
class PlanRuleCopyActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] destination_vault_arn: An Amazon Resource Name (ARN) that uniquely identifies the destination backup vault for the copied backup.
    ...
    def destination_vault_arn(self) -> pulumi.Input[builtins.str]:
        """
        An Amazon Resource Name (ARN) that uniquely identifies the destination backup vault for the copied backup.
        """
    ...
    def destination_vault_arn(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class PlanRuleCopyActionLifecycleArgsDict(TypedDict):
        cold_storage_after: NotRequired[pulumi.Input[builtins.int]]
        """
        Specifies the number of days after creation that a recovery point is moved to cold storage.
        """
        delete_after: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PlanRuleCopyActionLifecycleArgs:
    def __init__(__self__, *,
                 cold_storage_after: Optional[pulumi.Input[builtins.int]] = None,
        ...
        """
        :param pulumi.Input[builtins.int] cold_storage_after: Specifies the number of days after creation that a recovery point is moved to cold storage.
        :param pulumi.Input[builtins.int] delete_after: Specifies the number of days after creation that a recovery point is deleted. Must be 90 days greater than `cold_storage_after`.
        :param pulumi.Input[builtins.bool] opt_in_to_archive_for_supported_resources: This setting will instruct your backup plan to transition supported resources to archive (cold) storage tier in accordance with your lifecycle settings.
        """
    ...
    def cold_storage_after(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the number of days after creation that a recovery point is moved to cold storage.
        """
    ...
    def cold_storage_after(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def opt_in_to_archive_for_supported_resources(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        This setting will instruct your backup plan to transition supported resources to archive (cold) storage tier in accordance with your lifecycle settings.
        """
    ...
    def opt_in_to_archive_for_supported_resources(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ReportPlanReportDeliveryChannelArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] s3_bucket_name: The unique name of the S3 bucket that receives your reports.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] formats: A list of the format of your reports: CSV, JSON, or both. If not specified, the default format is CSV.
        :param pulumi.Input[builtins.str] s3_key_prefix: The prefix for where Backup Audit Manager delivers your reports to Amazon S3. The prefix is this part of the following path: s3://your-bucket-name/prefix/Backup/us-west-2/year/month/day/report-name. If not specified, there is no prefix.
        """
...
if not MYPY:
    class ReportPlanReportSettingArgsDict(TypedDict):
        report_template: pulumi.Input[builtins.str]
        """
        ...
        """
        framework_arns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Specifies the Amazon Resource Names (ARNs) of the frameworks a report covers.
        """
        number_of_frameworks: NotRequired[pulumi.Input[builtins.int]]
        """
        Specifies the number of frameworks a report covers.
        """
        organization_units: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ReportPlanReportSettingArgs:
    def __init__(__self__, *,
                 ...
                 framework_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 number_of_frameworks: Optional[pulumi.Input[builtins.int]] = None,
                 organization_units: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] report_template: Identifies the report template for the report. Reports are built using a report template. The report templates are: `RESOURCE_COMPLIANCE_REPORT` | `CONTROL_COMPLIANCE_REPORT` | `BACKUP_JOB_REPORT` | `COPY_JOB_REPORT` | `RESTORE_JOB_REPORT`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] accounts: Specifies the list of accounts a report covers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] framework_arns: Specifies the Amazon Resource Names (ARNs) of the frameworks a report covers.
        :param pulumi.Input[builtins.int] number_of_frameworks: Specifies the number of frameworks a report covers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] organization_units: Specifies the list of Organizational Units a report covers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: Specifies the list of regions a report covers.
        """
    ...
    def report_template(self) -> pulumi.Input[builtins.str]:
        """
        Identifies the report template for the report. Reports are built using a report template. The report templates are: `RESOURCE_COMPLIANCE_REPORT` | `CONTROL_COMPLIANCE_REPORT` | `BACKUP_JOB_REPORT` | `COPY_JOB_REPORT` | `RESTORE_JOB_REPORT`.
        """
    ...
    def report_template(self, value: pulumi.Input[builtins.str]):
    ...
    def framework_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies the Amazon Resource Names (ARNs) of the frameworks a report covers.
        """
    ...
    def framework_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "framework_arns", value)

    @property
    @pulumi.getter(name="numberOfFrameworks")
    def number_of_frameworks(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the number of frameworks a report covers.
        """
    ...
    def number_of_frameworks(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "number_of_frameworks", value)

    @property
    @pulumi.getter(name="organizationUnits")
    def organization_units(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies the list of Organizational Units a report covers.
        """
    ...
    def organization_units(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class RestoreTestingPlanRecoveryPointSelectionArgsDict(TypedDict):
        ...
        """
        include_vaults: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        recovery_point_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        Specifies the types of recovery points to include in the selection. Valid values are "CONTINUOUS" and "SNAPSHOT".
        """
        exclude_vaults: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        selection_window_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class RestoreTestingPlanRecoveryPointSelectionArgs:
    def __init__(__self__, *,
                 ...
                 include_vaults: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 recovery_point_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 exclude_vaults: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 selection_window_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] algorithm: Specifies the algorithm used for selecting recovery points. Valid values are "RANDOM_WITHIN_WINDOW" and "LATEST_WITHIN_WINDOW".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_vaults: Specifies the backup vaults to include in the recovery point selection. Each value must be a valid AWS ARN for a backup vault or "*" to include all backup vaults.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] recovery_point_types: Specifies the types of recovery points to include in the selection. Valid values are "CONTINUOUS" and "SNAPSHOT".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_vaults: Specifies the backup vaults to exclude from the recovery point selection. Each value must be a valid AWS ARN for a backup vault or "*" to exclude all backup vaults.
        :param pulumi.Input[builtins.int] selection_window_days: Specifies the number of days within which the recovery points should be selected. Must be a value between 1 and 365.
        """
    ...
    def include_vaults(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies the backup vaults to include in the recovery point selection. Each value must be a valid AWS ARN for a backup vault or "*" to include all backup vaults.
        """
    ...
    def include_vaults(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "include_vaults", value)

    @property
    @pulumi.getter(name="recoveryPointTypes")
    def recovery_point_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specifies the types of recovery points to include in the selection. Valid values are "CONTINUOUS" and "SNAPSHOT".
        """
    ...
    def recovery_point_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "recovery_point_types", value)

    @property
    @pulumi.getter(name="excludeVaults")
    def exclude_vaults(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Specifies the backup vaults to exclude from the recovery point selection. Each value must be a valid AWS ARN for a backup vault or "*" to exclude all backup vaults.
        """
    ...
    def exclude_vaults(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "exclude_vaults", value)

    @property
    @pulumi.getter(name="selectionWindowDays")
    def selection_window_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the number of days within which the recovery points should be selected. Must be a value between 1 and 365.
        """
    ...
    def selection_window_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class RestoreTestingSelectionProtectedResourceConditionsStringEqualArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: The Tag name, must start with one of the following prefixes: [aws:ResourceTag/] with a Minimum length of 1. Maximum length of 128, and can contain characters that are letters, white space, and numbers that can be represented in UTF-8 and the following characters: `+ - = . _ : /`.
        :param pulumi.Input[builtins.str] value: The value of the Tag. Maximum length of 256.
        """
...
class SelectionConditionStringEqualArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Key for the filter.
        :param pulumi.Input[builtins.str] value: Value for the filter.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class SelectionSelectionTagArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: Key for the filter.
        :param pulumi.Input[builtins.str] type: An operation, such as `STRINGEQUALS`, that is applied to the key-value pair used to filter resources in a selection.
        :param pulumi.Input[builtins.str] value: Value for the filter.
        """
        pulumi.set(__self__, "key", key)
