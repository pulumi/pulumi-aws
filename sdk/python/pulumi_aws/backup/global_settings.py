...
class GlobalSettingsArgs:
    def __init__(__self__, *,
                 global_settings: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
        """
        The set of arguments for constructing a GlobalSettings resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] global_settings: A list of resources along with the opt-in preferences for the account.
        """
        pulumi.set(__self__, "global_settings", global_settings)

    @property
    @pulumi.getter(name="globalSettings")
    def global_settings(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
    ...
    def global_settings(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
...
class _GlobalSettingsState:
    def __init__(__self__, *,
                 global_settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
    ...
    @property
    @pulumi.getter(name="globalSettings")
    def global_settings(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A list of resources along with the opt-in preferences for the account.
        """
        return pulumi.get(self, "global_settings")
    ...
    @global_settings.setter
    def global_settings(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "global_settings", value)
...
class GlobalSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            global_settings: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'GlobalSettings':
        """
    ...
    @property
    @pulumi.getter(name="globalSettings")
    def global_settings(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        A list of resources along with the opt-in preferences for the account.
        """
        return pulumi.get(self, "global_settings")
