...
class RestoreTestingSelectionArgs:
    def __init__(__self__, *,
                 ...
                 protected_resource_type: pulumi.Input[builtins.str],
                 restore_testing_plan_name: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 protected_resource_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 protected_resource_conditions: Optional[pulumi.Input['RestoreTestingSelectionProtectedResourceConditionsArgs']] = None,
                 restore_metadata_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 validation_window_hours: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a RestoreTestingSelection resource.
        :param pulumi.Input[builtins.str] iam_role_arn: The ARN of the IAM role.
    ...
    def protected_resource_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def protected_resource_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "protected_resource_type", value)

    @property
    @pulumi.getter(name="restoreTestingPlanName")
    def restore_testing_plan_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def restore_testing_plan_name(self, value: pulumi.Input[builtins.str]):
    ...
    def protected_resource_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def protected_resource_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def restore_metadata_overrides(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def restore_metadata_overrides(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "restore_metadata_overrides", value)

    @property
    @pulumi.getter(name="validationWindowHours")
    def validation_window_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def validation_window_hours(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _RestoreTestingSelectionState:
    def __init__(__self__, *,
                 ...
                 protected_resource_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 protected_resource_conditions: Optional[pulumi.Input['RestoreTestingSelectionProtectedResourceConditionsArgs']] = None,
                 protected_resource_type: Optional[pulumi.Input[builtins.str]] = None,
                 restore_metadata_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 restore_testing_plan_name: Optional[pulumi.Input[builtins.str]] = None,
                 validation_window_hours: Optional[pulumi.Input[builtins.int]] = None):
        """
    ...
    @property
    @pulumi.getter(name="protectedResourceType")
    def protected_resource_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the protected resource.
        """
        return pulumi.get(self, "protected_resource_type")
    ...
    @protected_resource_type.setter
    def protected_resource_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "protected_resource_type", value)
    ...
    @property
    @pulumi.getter(name="restoreTestingPlanName")
    def restore_testing_plan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the restore testing plan.
        """
        return pulumi.get(self, "restore_testing_plan_name")
    ...
    @restore_testing_plan_name.setter
    def restore_testing_plan_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restore_testing_plan_name", value)
...
class RestoreTestingSelection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            restore_metadata_overrides: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            restore_testing_plan_name: Optional[pulumi.Input[builtins.str]] = None,
            validation_window_hours: Optional[pulumi.Input[builtins.int]] = None) -> 'RestoreTestingSelection':
        """
    ...
    @property
    @pulumi.getter(name="protectedResourceArns")
    def protected_resource_arns(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The ARNs for the protected resources.
        """
        return pulumi.get(self, "protected_resource_arns")
    ...
    @property
    @pulumi.getter(name="protectedResourceType")
    def protected_resource_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the protected resource.
        """
        return pulumi.get(self, "protected_resource_type")
    ...
    @property
    @pulumi.getter(name="restoreMetadataOverrides")
    def restore_metadata_overrides(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Override certain restore metadata keys. See the complete list of [restore testing inferred metadata](https://docs.aws.amazon.com/aws-backup/latest/devguide/restore-testing-inferred-metadata.html) .
        """
        return pulumi.get(self, "restore_metadata_overrides")
    ...
    @property
    @pulumi.getter(name="restoreTestingPlanName")
    def restore_testing_plan_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the restore testing plan.
        """
        return pulumi.get(self, "restore_testing_plan_name")
    ...
    @property
    @pulumi.getter(name="validationWindowHours")
    def validation_window_hours(self) -> pulumi.Output[builtins.int]:
        """
        The amount of hours available to run a validation script on the data. Valid range is `1` to `168`.
        """
        return pulumi.get(self, "validation_window_hours")
