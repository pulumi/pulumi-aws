...
class FrameworkControl(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of a control. This name is between 1 and 256 characters.
...
class FrameworkControlInputParameter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of a parameter, for example, BackupPlanFrequency.
        :param builtins.str value: The value of parameter, for example, hourly.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class FrameworkControlScope(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] compliance_resource_ids: The ID of the only AWS resource that you want your control scope to contain. Minimum number of 1 item. Maximum number of 100 items.
        ...
        :param Mapping[str, builtins.str] tags: The tag key-value pair applied to those AWS resources that you want to trigger an evaluation for a rule. A maximum of one key-value pair can be provided.
        """
...
class PlanAdvancedBackupSetting(dict):
    ...
    def __init__(__self__, *,
                 backup_options: Mapping[str, builtins.str],
                 resource_type: builtins.str):
        """
        :param Mapping[str, builtins.str] backup_options: Specifies the backup option for a selected resource. This option is only available for Windows VSS backup jobs. Set to `{ WindowsVSS = "enabled" }` to enable Windows VSS backup option and create a VSS Windows backup.
        :param builtins.str resource_type: The type of AWS resource to be backed up. For VSS Windows backups, the only supported resource type is Amazon EC2. Valid values: `EC2`.
        """
    ...
    def backup_options(self) -> Mapping[str, builtins.str]:
        """
...
class PlanRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 completion_window: Optional[builtins.int] = None,
                 ...
                 start_window: Optional[builtins.int] = None):
        """
        :param builtins.str rule_name: An display name for a backup rule.
        :param builtins.str target_vault_name: The name of a logical container where backups are stored.
        :param builtins.int completion_window: The amount of time in minutes AWS Backup attempts a backup before canceling the job and returning an error.
        :param Sequence['PlanRuleCopyActionArgs'] copy_actions: Configuration block(s) with copy operation settings. Detailed below.
        :param builtins.bool enable_continuous_backup: Enable continuous backups for supported resources.
        ...
        :param Mapping[str, builtins.str] recovery_point_tags: Metadata that you can assign to help organize the resources that you create.
        :param builtins.str schedule: A CRON expression specifying when AWS Backup initiates a backup job.
        :param builtins.str schedule_expression_timezone: The timezone in which the schedule expression is set. Default value: `"Etc/UTC"`.
        :param builtins.int start_window: The amount of time in minutes before beginning a backup.
        """
    ...
    def completion_window(self) -> Optional[builtins.int]:
        """
    ...
    def start_window(self) -> Optional[builtins.int]:
        """
...
class PlanRuleCopyAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str destination_vault_arn: An Amazon Resource Name (ARN) that uniquely identifies the destination backup vault for the copied backup.
...
class PlanRuleCopyActionLifecycle(dict):
    ...
    def __init__(__self__, *,
                 cold_storage_after: Optional[builtins.int] = None,
                 delete_after: Optional[builtins.int] = None,
                 opt_in_to_archive_for_supported_resources: Optional[builtins.bool] = None):
        """
        :param builtins.int cold_storage_after: Specifies the number of days after creation that a recovery point is moved to cold storage.
        :param builtins.int delete_after: Specifies the number of days after creation that a recovery point is deleted. Must be 90 days greater than `cold_storage_after`.
        :param builtins.bool opt_in_to_archive_for_supported_resources: This setting will instruct your backup plan to transition supported resources to archive (cold) storage tier in accordance with your lifecycle settings.
        """
    ...
    def cold_storage_after(self) -> Optional[builtins.int]:
        """
    ...
    def delete_after(self) -> Optional[builtins.int]:
        """
...
class ReportPlanReportDeliveryChannel(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str s3_key_prefix: The prefix for where Backup Audit Manager delivers your reports to Amazon S3. The prefix is this part of the following path: s3://your-bucket-name/prefix/Backup/us-west-2/year/month/day/report-name. If not specified, there is no prefix.
        """
...
class ReportPlanReportSetting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 number_of_frameworks: Optional[builtins.int] = None,
                 organization_units: Optional[Sequence[builtins.str]] = None,
                 regions: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str report_template: Identifies the report template for the report. Reports are built using a report template. The report templates are: `RESOURCE_COMPLIANCE_REPORT` | `CONTROL_COMPLIANCE_REPORT` | `BACKUP_JOB_REPORT` | `COPY_JOB_REPORT` | `RESTORE_JOB_REPORT`.
        :param Sequence[builtins.str] accounts: Specifies the list of accounts a report covers.
        :param Sequence[builtins.str] framework_arns: Specifies the Amazon Resource Names (ARNs) of the frameworks a report covers.
        :param builtins.int number_of_frameworks: Specifies the number of frameworks a report covers.
        :param Sequence[builtins.str] organization_units: Specifies the list of Organizational Units a report covers.
        :param Sequence[builtins.str] regions: Specifies the list of regions a report covers.
        """
    ...
    def number_of_frameworks(self) -> Optional[builtins.int]:
        """
...
class RestoreTestingPlanRecoveryPointSelection(dict):
    ...
    def __init__(__self__, *,
                 ...
                 recovery_point_types: Sequence[builtins.str],
                 exclude_vaults: Optional[Sequence[builtins.str]] = None,
                 selection_window_days: Optional[builtins.int] = None):
        """
        :param builtins.str algorithm: Specifies the algorithm used for selecting recovery points. Valid values are "RANDOM_WITHIN_WINDOW" and "LATEST_WITHIN_WINDOW".
        :param Sequence[builtins.str] include_vaults: Specifies the backup vaults to include in the recovery point selection. Each value must be a valid AWS ARN for a backup vault or "*" to include all backup vaults.
        :param Sequence[builtins.str] recovery_point_types: Specifies the types of recovery points to include in the selection. Valid values are "CONTINUOUS" and "SNAPSHOT".
        :param Sequence[builtins.str] exclude_vaults: Specifies the backup vaults to exclude from the recovery point selection. Each value must be a valid AWS ARN for a backup vault or "*" to exclude all backup vaults.
        :param builtins.int selection_window_days: Specifies the number of days within which the recovery points should be selected. Must be a value between 1 and 365.
        """
    ...
    def recovery_point_types(self) -> Sequence[builtins.str]:
        """
...
class RestoreTestingSelectionProtectedResourceConditionsStringEqual(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The Tag name, must start with one of the following prefixes: [aws:ResourceTag/] with a Minimum length of 1. Maximum length of 128, and can contain characters that are letters, white space, and numbers that can be represented in UTF-8 and the following characters: `+ - = . _ : /`.
        :param builtins.str value: The value of the Tag. Maximum length of 256.
        """
...
class SelectionConditionStringEqual(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str value: Value for the filter.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class SelectionSelectionTag(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: Key for the filter.
        :param builtins.str type: An operation, such as `STRINGEQUALS`, that is applied to the key-value pair used to filter resources in a selection.
        :param builtins.str value: Value for the filter.
        """
        pulumi.set(__self__, "key", key)
...
class GetFrameworkControlInputParameterResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Backup framework name.
        :param builtins.str value: Value of parameter, for example, hourly.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class GetFrameworkControlScopeResult(dict):
    def __init__(__self__, *,
                 compliance_resource_ids: Sequence[builtins.str],
                 compliance_resource_types: Sequence[builtins.str],
    ...
    @property
    @pulumi.getter(name="complianceResourceIds")
    def compliance_resource_ids(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="complianceResourceTypes")
    def compliance_resource_types(self) -> Sequence[builtins.str]:
        """
        Describes whether the control scope includes one or more types of resources, such as EFS or RDS.
        """
        return pulumi.get(self, "compliance_resource_types")
...
class GetPlanRuleResult(dict):
    def __init__(__self__, *,
                 completion_window: builtins.int,
                 copy_actions: Sequence['outputs.GetPlanRuleCopyActionResult'],
                 enable_continuous_backup: builtins.bool,
                 lifecycles: Sequence['outputs.GetPlanRuleLifecycleResult'],
                 rule_name: builtins.str,
                 schedule: builtins.str,
                 schedule_expression_timezone: builtins.str,
                 start_window: builtins.int,
                 target_vault_name: builtins.str,
                 recovery_point_tags: Optional[Mapping[str, builtins.str]] = None):
        pulumi.set(__self__, "completion_window", completion_window)
        pulumi.set(__self__, "copy_actions", copy_actions)
    ...
    @property
    @pulumi.getter(name="completionWindow")
    def completion_window(self) -> builtins.int:
        return pulumi.get(self, "completion_window")
    ...
    @property
    @pulumi.getter(name="enableContinuousBackup")
    def enable_continuous_backup(self) -> builtins.bool:
        return pulumi.get(self, "enable_continuous_backup")
    ...
    @property
    @pulumi.getter(name="startWindow")
    def start_window(self) -> builtins.int:
        return pulumi.get(self, "start_window")
...
class GetPlanRuleCopyActionLifecycleResult(dict):
    def __init__(__self__, *,
                 cold_storage_after: builtins.int,
                 delete_after: builtins.int,
                 opt_in_to_archive_for_supported_resources: builtins.bool):
        pulumi.set(__self__, "cold_storage_after", cold_storage_after)
        pulumi.set(__self__, "delete_after", delete_after)
        pulumi.set(__self__, "opt_in_to_archive_for_supported_resources", opt_in_to_archive_for_supported_resources)
    ...
    @property
    @pulumi.getter(name="coldStorageAfter")
    def cold_storage_after(self) -> builtins.int:
        return pulumi.get(self, "cold_storage_after")

    @property
    @pulumi.getter(name="deleteAfter")
    def delete_after(self) -> builtins.int:
        return pulumi.get(self, "delete_after")

    @property
    @pulumi.getter(name="optInToArchiveForSupportedResources")
    def opt_in_to_archive_for_supported_resources(self) -> builtins.bool:
        return pulumi.get(self, "opt_in_to_archive_for_supported_resources")
...
class GetReportPlanReportDeliveryChannelResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] formats: List of the format of your reports: CSV, JSON, or both.
        :param builtins.str s3_bucket_name: Unique name of the S3 bucket that receives your reports.
        :param builtins.str s3_key_prefix: Prefix for where Backup Audit Manager delivers your reports to Amazon S3. The prefix is this part of the following path: s3://your-bucket-name/prefix/Backup/us-west-2/year/month/day/report-name.
        """
        pulumi.set(__self__, "formats", formats)
        pulumi.set(__self__, "s3_bucket_name", s3_bucket_name)
        pulumi.set(__self__, "s3_key_prefix", s3_key_prefix)
...
class GetReportPlanReportSettingResult(dict):
    def __init__(__self__, *,
                 accounts: Sequence[builtins.str],
                 framework_arns: Sequence[builtins.str],
                 number_of_frameworks: builtins.int,
                 organization_units: Sequence[builtins.str],
                 regions: Sequence[builtins.str],
                 report_template: builtins.str):
        """
        :param Sequence[builtins.str] accounts: (Optional) Specifies the list of accounts a report covers.
        :param Sequence[builtins.str] framework_arns: ARNs of the frameworks a report covers.
        :param builtins.int number_of_frameworks: Specifies the number of frameworks a report covers.
        :param Sequence[builtins.str] organization_units: (Optional) Specifies the list of Organizational Units a report covers.
        :param Sequence[builtins.str] regions: (Optional) Specifies the list of regions a report covers.
        :param builtins.str report_template: Identifies the report template for the report. Reports are built using a report template.
        """
        pulumi.set(__self__, "accounts", accounts)
        pulumi.set(__self__, "framework_arns", framework_arns)
        pulumi.set(__self__, "number_of_frameworks", number_of_frameworks)
    ...
    @property
    @pulumi.getter
    def accounts(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="frameworkArns")
    def framework_arns(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="numberOfFrameworks")
    def number_of_frameworks(self) -> builtins.int:
        """
        Specifies the number of frameworks a report covers.
        """
        return pulumi.get(self, "number_of_frameworks")
    ...
    @property
    @pulumi.getter(name="organizationUnits")
    def organization_units(self) -> Sequence[builtins.str]:
        """
