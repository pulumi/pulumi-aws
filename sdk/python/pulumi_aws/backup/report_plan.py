...
class ReportPlan(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if report_delivery_channel is not None and not isinstance(report_delivery_channel, ReportPlanReportDeliveryChannelArgs):
                report_delivery_channel = report_delivery_channel or {}
                def _setter(key, value):
                    report_delivery_channel[key] = value
                ReportPlanReportDeliveryChannelArgs._configure(_setter, **report_delivery_channel)
            ...
            if report_setting is not None and not isinstance(report_setting, ReportPlanReportSettingArgs):
                report_setting = report_setting or {}
                def _setter(key, value):
                    report_setting[key] = value
                ReportPlanReportSettingArgs._configure(_setter, **report_setting)
