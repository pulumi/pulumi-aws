...
class LogicallyAirGappedVaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] max_retention_days: Maximum retention period that the Logically Air Gapped Backup Vault retains recovery points.
        :param pulumi.Input[int] min_retention_days: Minimum retention period that the Logically Air Gapped Backup Vault retains recovery points.
        :param pulumi.Input[str] name: Name of the Logically Air Gapped Backup Vault to create.
...
class _LogicallyAirGappedVaultState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] arn: The ARN of the Logically Air Gapped Backup Vault.
        :param pulumi.Input[int] max_retention_days: Maximum retention period that the Logically Air Gapped Backup Vault retains recovery points.
        :param pulumi.Input[int] min_retention_days: Minimum retention period that the Logically Air Gapped Backup Vault retains recovery points.
        :param pulumi.Input[str] name: Name of the Logically Air Gapped Backup Vault to create.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Metadata that you can assign to help organize the resources that you create. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
