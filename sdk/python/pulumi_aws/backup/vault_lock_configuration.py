...
class VaultLockConfigurationArgs:
    ...
    def backup_vault_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def backup_vault_name(self, value: pulumi.Input[builtins.str]):
...
class _VaultLockConfigurationState:
    ...
    def backup_vault_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backup_vault_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VaultLockConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="changeableForDays")
    def changeable_for_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of days before the lock date. If omitted creates a vault lock in `governance` mode, otherwise it will create a vault lock in `compliance` mode.
        """
        return pulumi.get(self, "changeable_for_days")
    ...
    @property
    @pulumi.getter(name="maxRetentionDays")
    def max_retention_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum retention period that the vault retains its recovery points.
        """
        return pulumi.get(self, "max_retention_days")
    ...
    @property
    @pulumi.getter(name="minRetentionDays")
    def min_retention_days(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The minimum retention period that the vault retains its recovery points.
        """
        return pulumi.get(self, "min_retention_days")
