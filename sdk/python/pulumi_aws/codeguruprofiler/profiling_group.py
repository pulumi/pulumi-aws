...
class _ProfilingGroupState:
    def __init__(__self__, *,
                 agent_orchestration_config: pulumi.Input[Optional['ProfilingGroupAgentOrchestrationConfigArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="agentOrchestrationConfig")
    def agent_orchestration_config(self) -> pulumi.Input[Optional['ProfilingGroupAgentOrchestrationConfigArgs']]:
        """
        Specifies whether profiling is enabled or disabled for the created profiling. See Agent Orchestration Config for more details.
        """
        return pulumi.get(self, "agent_orchestration_config")
    ...
    @agent_orchestration_config.setter
    def agent_orchestration_config(self, value: pulumi.Input[Optional['ProfilingGroupAgentOrchestrationConfigArgs']]):
        pulumi.set(self, "agent_orchestration_config", value)
...
class ProfilingGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 agent_orchestration_config: pulumi.Input[Optional[Union['ProfilingGroupAgentOrchestrationConfigArgs', 'ProfilingGroupAgentOrchestrationConfigArgsDict', 'outputs.ProfilingGroupAgentOrchestrationConfig']]] = None,
                 compute_platform: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Union['ProfilingGroupAgentOrchestrationConfigArgs', 'ProfilingGroupAgentOrchestrationConfigArgsDict', 'outputs.ProfilingGroupAgentOrchestrationConfig']] agent_orchestration_config: Specifies whether profiling is enabled or disabled for the created profiling. See Agent Orchestration Config for more details.
        :param pulumi.Input[_builtins.str] compute_platform: Compute platform of the profiling group.
        :param pulumi.Input[_builtins.str] name: Name of the profiling group.
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'ProfilingGroup':
        """
