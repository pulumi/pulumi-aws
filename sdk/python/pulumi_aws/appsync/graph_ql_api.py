...
class GraphQLApi(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if openid_connect_config is not None and not isinstance(openid_connect_config, GraphQLApiOpenidConnectConfigArgs):
                openid_connect_config = openid_connect_config or {}
                def _setter(key, value):
                    openid_connect_config[key] = value
                GraphQLApiOpenidConnectConfigArgs._configure(_setter, **openid_connect_config)
