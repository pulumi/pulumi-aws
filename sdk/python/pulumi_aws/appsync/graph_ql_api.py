...
class GraphQLApiArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] authentication_type: Authentication type. Valid values: `API_KEY`, `AWS_IAM`, `AMAZON_COGNITO_USER_POOLS`, `OPENID_CONNECT`, `AWS_LAMBDA`
        ...
        :param pulumi.Input[builtins.str] api_type: API type. Valid values are `GRAPHQL` or `MERGED`. A `MERGED` type requires `merged_api_execution_role_arn` to be set.
        ...
        :param pulumi.Input[builtins.str] merged_api_execution_role_arn: ARN of the execution role when `api_type` is set to `MERGED`.
        :param pulumi.Input[builtins.str] name: User-supplied name for the GraphQL API.
...
class _GraphQLApiState:
    def __init__(__self__, *,
                 ...
                 uris: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 user_pool_config: Optional[pulumi.Input['GraphQLApiUserPoolConfigArgs']] = None,
                 visibility: Optional[pulumi.Input[builtins.str]] = None,
                 xray_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] uris: Map of URIs associated with the API E.g., `uris["GRAPHQL"] = https://ID.appsync-api.REGION.amazonaws.com/graphql`
        :param pulumi.Input['GraphQLApiUserPoolConfigArgs'] user_pool_config: Amazon Cognito User Pool configuration. See `user_pool_config` Block for details.
        :param pulumi.Input[builtins.str] visibility: Sets the value of the GraphQL API to public (`GLOBAL`) or private (`PRIVATE`). If no value is provided, the visibility will be set to `GLOBAL` by default. This value cannot be changed once the API has been created.
        :param pulumi.Input[builtins.bool] xray_enabled: Whether tracing with X-ray is enabled. Defaults to false.
        """
    ...
    @property
    @pulumi.getter
    def uris(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    @uris.setter
    def uris(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class GraphQLApi(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            user_pool_config: Optional[pulumi.Input[Union['GraphQLApiUserPoolConfigArgs', 'GraphQLApiUserPoolConfigArgsDict']]] = None,
            visibility: Optional[pulumi.Input[builtins.str]] = None,
            xray_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'GraphQLApi':
        """
    ...
    @property
    @pulumi.getter
    def uris(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Map of URIs associated with the API E.g., `uris["GRAPHQL"] = https://ID.appsync-api.REGION.amazonaws.com/graphql`
        """
        return pulumi.get(self, "uris")
