...
class DataSource(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            dynamodb_config = _utilities.configure(dynamodb_config, DataSourceDynamodbConfigArgs, True)
            ...
            opensearchservice_config = _utilities.configure(opensearchservice_config, DataSourceOpensearchserviceConfigArgs, True)
