...
class DataSourceDynamodbConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] table_name: Name of the DynamoDB table.
        ...
        :param pulumi.Input[builtins.str] region: AWS region of the DynamoDB table. Defaults to current region.
        :param pulumi.Input[builtins.bool] use_caller_credentials: Set to `true` to use Amazon Cognito credentials with this data source.
        :param pulumi.Input[builtins.bool] versioned: Detects Conflict Detection and Resolution with this data source.
        """
...
if not MYPY:
    class DataSourceDynamodbConfigDeltaSyncConfigArgsDict(TypedDict):
        ...
        The table name.
        """
        base_table_ttl: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of minutes that an Item is stored in the data source.
        """
        delta_sync_table_ttl: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DataSourceDynamodbConfigDeltaSyncConfigArgs:
    def __init__(__self__, *,
                 delta_sync_table_name: pulumi.Input[builtins.str],
                 base_table_ttl: Optional[pulumi.Input[builtins.int]] = None,
                 delta_sync_table_ttl: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] delta_sync_table_name: The table name.
        :param pulumi.Input[builtins.int] base_table_ttl: The number of minutes that an Item is stored in the data source.
        :param pulumi.Input[builtins.int] delta_sync_table_ttl: The number of minutes that a Delta Sync log entry is stored in the Delta Sync table.
        """
    ...
    def base_table_ttl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of minutes that an Item is stored in the data source.
        """
    ...
    def base_table_ttl(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "base_table_ttl", value)

    @property
    @pulumi.getter(name="deltaSyncTableTtl")
    def delta_sync_table_ttl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of minutes that a Delta Sync log entry is stored in the Delta Sync table.
        """
    ...
    def delta_sync_table_ttl(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DataSourceElasticsearchConfigArgs:
    def __init__(__self__, *,
                 ...
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] endpoint: HTTP endpoint of the Elasticsearch domain.
        :param pulumi.Input[builtins.str] region: AWS region of Elasticsearch domain. Defaults to current region.
        """
...
class DataSourceHttpConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] endpoint: HTTP URL.
...
class DataSourceHttpConfigAuthorizationConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] authorization_type: Authorization type that the HTTP endpoint requires. Default values is `AWS_IAM`.
...
class DataSourceHttpConfigAuthorizationConfigAwsIamConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] signing_region: Signing Amazon Web Services Region for IAM authorization.
        :param pulumi.Input[builtins.str] signing_service_name: Signing service name for IAM authorization.
        """
...
class DataSourceLambdaConfigArgs:
    def __init__(__self__, *,
                 function_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] function_arn: ARN for the Lambda function.
        """
...
class DataSourceOpensearchserviceConfigArgs:
    def __init__(__self__, *,
                 ...
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] endpoint: HTTP endpoint of the OpenSearch domain.
        :param pulumi.Input[builtins.str] region: AWS region of the OpenSearch domain. Defaults to current region.
        """
        pulumi.set(__self__, "endpoint", endpoint)
        if region is not None:
            pulumi.set(__self__, "region", region)
...
class DataSourceRelationalDatabaseConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] source_type: Source type for the relational database. Valid values: `RDS_HTTP_ENDPOINT`.
        """
...
class DataSourceRelationalDatabaseConfigHttpEndpointConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] aws_secret_store_arn: AWS secret store ARN for database credentials.
        :param pulumi.Input[builtins.str] db_cluster_identifier: Amazon RDS cluster identifier.
        :param pulumi.Input[builtins.str] database_name: Logical database name.
        :param pulumi.Input[builtins.str] region: AWS Region for RDS HTTP endpoint. Defaults to current region.
...
if not MYPY:
    class FunctionSyncConfigArgsDict(TypedDict):
        conflict_detection: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FunctionSyncConfigArgs:
    def __init__(__self__, *,
                 conflict_detection: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] conflict_detection: Conflict Detection strategy to use. Valid values are `NONE` and `VERSION`.
        :param pulumi.Input[builtins.str] conflict_handler: Conflict Resolution strategy to perform in the event of a conflict. Valid values are `NONE`, `OPTIMISTIC_CONCURRENCY`, `AUTOMERGE`, and `LAMBDA`.
    ...
    def conflict_detection(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Conflict Detection strategy to use. Valid values are `NONE` and `VERSION`.
        """
    ...
    def conflict_detection(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FunctionSyncConfigLambdaConflictHandlerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] lambda_conflict_handler_arn: ARN for the Lambda function to use as the Conflict Handler.
        """
...
class GraphQLApiAdditionalAuthenticationProviderLambdaAuthorizerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] authorizer_uri: ARN of the Lambda function to be called for authorization. Note: This Lambda function must have a resource-based policy assigned to it, to allow `lambda:InvokeFunction` from service principal `appsync.amazonaws.com`.
        :param pulumi.Input[builtins.int] authorizer_result_ttl_in_seconds: Number of seconds a response should be cached for. The default is 5 minutes (300 seconds). The Lambda function can override this by returning a `ttlOverride` key in its response. A value of 0 disables caching of responses. Minimum value of 0. Maximum value of 3600.
        :param pulumi.Input[builtins.str] identity_validation_expression: Regular expression for validation of tokens before the Lambda function is called.
        """
...
if not MYPY:
    class GraphQLApiAdditionalAuthenticationProviderOpenidConnectConfigArgsDict(TypedDict):
        ...
        """
        auth_ttl: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        iat_ttl: NotRequired[pulumi.Input[builtins.int]]
        """
...
class GraphQLApiAdditionalAuthenticationProviderOpenidConnectConfigArgs:
    def __init__(__self__, *,
                 issuer: pulumi.Input[builtins.str],
                 auth_ttl: Optional[pulumi.Input[builtins.int]] = None,
                 client_id: Optional[pulumi.Input[builtins.str]] = None,
                 iat_ttl: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] issuer: Issuer for the OpenID Connect configuration. The issuer returned by discovery MUST exactly match the value of iss in the ID Token.
        :param pulumi.Input[builtins.int] auth_ttl: Number of milliseconds a token is valid after being authenticated.
        :param pulumi.Input[builtins.str] client_id: Client identifier of the Relying party at the OpenID identity provider. This identifier is typically obtained when the Relying party is registered with the OpenID identity provider. You can specify a regular expression so the AWS AppSync can validate against multiple client identifiers at a time.
        :param pulumi.Input[builtins.int] iat_ttl: Number of milliseconds a token is valid after being issued to a user.
        """
    ...
    def auth_ttl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of milliseconds a token is valid after being authenticated.
        """
    ...
    @auth_ttl.setter
    def auth_ttl(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def iat_ttl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of milliseconds a token is valid after being issued to a user.
        """
    ...
    @iat_ttl.setter
    def iat_ttl(self, value: Optional[pulumi.Input[builtins.int]]):
...
class GraphQLApiAdditionalAuthenticationProviderUserPoolConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] user_pool_id: User pool ID.
        :param pulumi.Input[builtins.str] app_id_client_regex: Regular expression for validating the incoming Amazon Cognito User Pool app client ID.
        :param pulumi.Input[builtins.str] aws_region: AWS region in which the user pool was created.
        """
...
class GraphQLApiEnhancedMetricsConfigArgs:
    def __init__(__self__, *,
                 ...
                 resolver_level_metrics_behavior: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] data_source_level_metrics_behavior: How data source metrics will be emitted to CloudWatch. Valid values: `FULL_REQUEST_DATA_SOURCE_METRICS`, `PER_DATA_SOURCE_METRICS`
        :param pulumi.Input[builtins.str] operation_level_metrics_config: How operation metrics will be emitted to CloudWatch. Valid values: `ENABLED`, `DISABLED`
        :param pulumi.Input[builtins.str] resolver_level_metrics_behavior: How resolver metrics will be emitted to CloudWatch. Valid values: `FULL_REQUEST_RESOLVER_METRICS`, `PER_RESOLVER_METRICS`
        """
...
if not MYPY:
    class GraphQLApiLogConfigArgsDict(TypedDict):
        cloudwatch_logs_role_arn: pulumi.Input[builtins.str]
        """
        Amazon Resource Name of the service role that AWS AppSync will assume to publish to Amazon CloudWatch logs in your account.
        """
        field_log_level: pulumi.Input[builtins.str]
        """
...
class GraphQLApiLogConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cloudwatch_logs_role_arn: Amazon Resource Name of the service role that AWS AppSync will assume to publish to Amazon CloudWatch logs in your account.
        :param pulumi.Input[builtins.str] field_log_level: Field logging level. Valid values: `ALL`, `ERROR`, `NONE`.
        :param pulumi.Input[builtins.bool] exclude_verbose_content: Set to TRUE to exclude sections that contain information such as headers, context, and evaluated mapping templates, regardless of logging  level. Valid values: `true`, `false`. Default value: `false`
        """
    ...
    def cloudwatch_logs_role_arn(self) -> pulumi.Input[builtins.str]:
        """
        Amazon Resource Name of the service role that AWS AppSync will assume to publish to Amazon CloudWatch logs in your account.
        """
    ...
    def cloudwatch_logs_role_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cloudwatch_logs_role_arn", value)

    @property
    @pulumi.getter(name="fieldLogLevel")
    def field_log_level(self) -> pulumi.Input[builtins.str]:
        """
        Field logging level. Valid values: `ALL`, `ERROR`, `NONE`.
        """
    ...
    def field_log_level(self, value: pulumi.Input[builtins.str]):
...
class GraphQLApiUserPoolConfigArgs:
    def __init__(__self__, *,
                 ...
                 aws_region: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] default_action: Action that you want your GraphQL API to take when a request that uses Amazon Cognito User Pool authentication doesn't match the Amazon Cognito User Pool configuration. Valid: `ALLOW` and `DENY`
        :param pulumi.Input[builtins.str] user_pool_id: User pool ID.
        :param pulumi.Input[builtins.str] app_id_client_regex: Regular expression for validating the incoming Amazon Cognito User Pool app client ID.
        :param pulumi.Input[builtins.str] aws_region: AWS region in which the user pool was created.
        """
...
class ResolverCachingConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] caching_keys: The caching keys for a resolver that has caching activated. Valid values are entries from the $context.arguments, $context.source, and $context.identity maps.
        :param pulumi.Input[builtins.int] ttl: The TTL in seconds for a resolver that has caching activated. Valid values are between `1` and `3600` seconds.
        """
...
if not MYPY:
    class SourceApiAssociationSourceApiAssociationConfigArgsDict(TypedDict):
        merge_type: pulumi.Input[builtins.str]
        """
...
class SourceApiAssociationSourceApiAssociationConfigArgs:
    def __init__(__self__, *,
                 merge_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] merge_type: Merge type. Valid values: `MANUAL_MERGE`, `AUTO_MERGE`
        """
        pulumi.set(__self__, "merge_type", merge_type)

    @property
    @pulumi.getter(name="mergeType")
    def merge_type(self) -> pulumi.Input[builtins.str]:
        """
        Merge type. Valid values: `MANUAL_MERGE`, `AUTO_MERGE`
        """
    ...
    @merge_type.setter
    def merge_type(self, value: pulumi.Input[builtins.str]):
