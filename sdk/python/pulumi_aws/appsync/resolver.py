...
class ResolverArgs:
    ...
    def _configure(
        ...
        if 'requestTemplate' in kwargs:
            request_template = kwargs['requestTemplate']
        if 'responseTemplate' in kwargs:
...
class Resolver(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if runtime is not None and not isinstance(runtime, ResolverRuntimeArgs):
                runtime = runtime or {}
                def _setter(key, value):
                    runtime[key] = value
                ResolverRuntimeArgs._configure(_setter, **runtime)
