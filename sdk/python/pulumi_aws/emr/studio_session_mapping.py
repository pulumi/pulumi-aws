...
class StudioSessionMappingArgs:
    ...
    def session_policy_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def session_policy_arn(self, value: pulumi.Input[builtins.str]):
    ...
    @studio_id.setter
    def studio_id(self, value: pulumi.Input[builtins.str]):
    ...
    def identity_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class _StudioSessionMappingState:
    ...
    @session_policy_arn.setter
    def session_policy_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "session_policy_arn", value)

    @property
    @pulumi.getter(name="studioId")
    def studio_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Amazon EMR Studio to which the user or group will be mapped.
        """
        return pulumi.get(self, "studio_id")
    ...
    @studio_id.setter
    def studio_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "studio_id", value)
...
class StudioSessionMapping(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="identityName")
    def identity_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the user or group from the Amazon Web Services SSO Identity Store.
        """
        return pulumi.get(self, "identity_name")
    ...
    @property
    @pulumi.getter(name="sessionPolicyArn")
    def session_policy_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) for the session policy that will be applied to the user or group. You should specify the ARN for the session policy that you want to apply, not the ARN of your user role.
        """
        return pulumi.get(self, "session_policy_arn")
