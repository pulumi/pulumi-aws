...
if not MYPY:
    class BlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangeArgsDict(TypedDict):
        max_range: pulumi.Input[builtins.int]
        """
        The final port in the range of TCP ports.
        """
        min_range: pulumi.Input[builtins.int]
        """
...
class BlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangeArgs:
    def __init__(__self__, *,
                 ...
                 min_range: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_range: The final port in the range of TCP ports.
        :param pulumi.Input[builtins.int] min_range: The first port in the range of TCP ports.
        """
    ...
    def max_range(self) -> pulumi.Input[builtins.int]:
        """
        The final port in the range of TCP ports.
        """
    ...
    @max_range.setter
    def max_range(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "max_range", value)

    @property
    @pulumi.getter(name="minRange")
    def min_range(self) -> pulumi.Input[builtins.int]:
        """
        The first port in the range of TCP ports.
        """
    ...
    @min_range.setter
    def min_range(self, value: pulumi.Input[builtins.int]):
...
class ClusterAutoTerminationPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] idle_timeout: Specifies the amount of idle time in seconds after which the cluster automatically terminates. You can specify a minimum of `60` seconds and a maximum of `604800` seconds (seven days).
        """
...
class ClusterBootstrapActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Name of the bootstrap action.
        :param pulumi.Input[builtins.str] path: Location of the script to run during a bootstrap action. Can be either a location in Amazon S3 or on a local file system.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: List of command line arguments to pass to the bootstrap action script.
        """
...
if not MYPY:
    class ClusterCoreInstanceFleetArgsDict(TypedDict):
        ...
        """
        provisioned_on_demand_capacity: NotRequired[pulumi.Input[builtins.int]]
        provisioned_spot_capacity: NotRequired[pulumi.Input[builtins.int]]
        target_on_demand_capacity: NotRequired[pulumi.Input[builtins.int]]
        """
        The target capacity of On-Demand units for the instance fleet, which determines how many On-Demand instances to provision.
        """
        target_spot_capacity: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ClusterCoreInstanceFleetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] target_spot_capacity: Target capacity of Spot units for the instance fleet, which determines how many Spot instances to provision.
        """
        if id is not None:
    ...
    def provisioned_on_demand_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "provisioned_on_demand_capacity")

    @provisioned_on_demand_capacity.setter
    def provisioned_on_demand_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "provisioned_on_demand_capacity", value)

    @property
    @pulumi.getter(name="provisionedSpotCapacity")
    def provisioned_spot_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "provisioned_spot_capacity")

    @provisioned_spot_capacity.setter
    def provisioned_spot_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def target_on_demand_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "target_on_demand_capacity", value)

    @property
    @pulumi.getter(name="targetSpotCapacity")
    def target_spot_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Target capacity of Spot units for the instance fleet, which determines how many Spot instances to provision.
        """
    ...
    def target_spot_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ClusterCoreInstanceFleetInstanceTypeConfigArgsDict(TypedDict):
        ...
        """
        bid_price: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        bid_price_as_percentage_of_on_demand_price: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ClusterCoreInstanceFleetInstanceTypeConfigArgs:
    def __init__(__self__, *,
                 instance_type: pulumi.Input[builtins.str],
                 bid_price: Optional[pulumi.Input[builtins.str]] = None,
                 bid_price_as_percentage_of_on_demand_price: Optional[pulumi.Input[builtins.float]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] instance_type: EC2 instance type, such as m4.xlarge.
        :param pulumi.Input[builtins.str] bid_price: Bid price for each EC2 Spot instance type as defined by `instance_type`. Expressed in USD. If neither `bid_price` nor `bid_price_as_percentage_of_on_demand_price` is provided, `bid_price_as_percentage_of_on_demand_price` defaults to 100%.
        :param pulumi.Input[builtins.float] bid_price_as_percentage_of_on_demand_price: Bid price, as a percentage of On-Demand price, for each EC2 Spot instance as defined by `instance_type`. Expressed as a number (for example, 20 specifies 20%). If neither `bid_price` nor `bid_price_as_percentage_of_on_demand_price` is provided, `bid_price_as_percentage_of_on_demand_price` defaults to 100%.
        ...
        :param pulumi.Input[builtins.int] weighted_capacity: Number of units that a provisioned instance of this type provides toward fulfilling the target capacities defined in `emr.InstanceFleet`.
        """
    ...
    def bid_price(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Bid price for each EC2 Spot instance type as defined by `instance_type`. Expressed in USD. If neither `bid_price` nor `bid_price_as_percentage_of_on_demand_price` is provided, `bid_price_as_percentage_of_on_demand_price` defaults to 100%.
        """
    ...
    @bid_price.setter
    def bid_price(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bid_price", value)

    @property
    @pulumi.getter(name="bidPriceAsPercentageOfOnDemandPrice")
    def bid_price_as_percentage_of_on_demand_price(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Bid price, as a percentage of On-Demand price, for each EC2 Spot instance as defined by `instance_type`. Expressed as a number (for example, 20 specifies 20%). If neither `bid_price` nor `bid_price_as_percentage_of_on_demand_price` is provided, `bid_price_as_percentage_of_on_demand_price` defaults to 100%.
        """
    ...
    def bid_price_as_percentage_of_on_demand_price(self, value: Optional[pulumi.Input[builtins.float]]):
...
class ClusterCoreInstanceFleetInstanceTypeConfigConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] classification: Classification within a configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: Map of properties specified within a configuration classification.
        """
...
if not MYPY:
    class ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgsDict(TypedDict):
        ...
        """
        volumes_per_instance: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ClusterCoreInstanceFleetInstanceTypeConfigEbsConfigArgs:
    def __init__(__self__, *,
                 ...
                 volumes_per_instance: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] size: Volume size, in gibibytes (GiB).
        :param pulumi.Input[builtins.str] type: Volume type. Valid options are `gp3`, `gp2`, `io1`, `io2`, `standard`, `st1` and `sc1`. See [EBS Volume Types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html).
        :param pulumi.Input[builtins.int] iops: Number of I/O operations per second (IOPS) that the volume supports.
        :param pulumi.Input[builtins.int] volumes_per_instance: Number of EBS volumes with this configuration to attach to each EC2 instance in the instance group (default is 1).
        """
    ...
    def volumes_per_instance(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of EBS volumes with this configuration to attach to each EC2 instance in the instance group (default is 1).
        """
    ...
    def volumes_per_instance(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ClusterCoreInstanceFleetLaunchSpecificationsOnDemandSpecificationArgs:
    def __init__(__self__, *,
                 allocation_strategy: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] allocation_strategy: Specifies the strategy to use in launching On-Demand instance fleets. Currently, the only option is `lowest-price` (the default), which launches the lowest price first.
        """
        pulumi.set(__self__, "allocation_strategy", allocation_strategy)

    @property
    @pulumi.getter(name="allocationStrategy")
    def allocation_strategy(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the strategy to use in launching On-Demand instance fleets. Currently, the only option is `lowest-price` (the default), which launches the lowest price first.
        """
    ...
    def allocation_strategy(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgsDict(TypedDict):
        ...
        """
        timeout_action: pulumi.Input[builtins.str]
        """
        ...
        """
        timeout_duration_minutes: pulumi.Input[builtins.int]
        """
...
class ClusterCoreInstanceFleetLaunchSpecificationsSpotSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] allocation_strategy: Specifies the strategy to use in launching Spot instance fleets. Valid values include `capacity-optimized`, `diversified`, `lowest-price`, `price-capacity-optimized`. See the [AWS documentation](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-instance-fleet.html#emr-instance-fleet-allocation-strategy) for details on each strategy type.
        :param pulumi.Input[builtins.str] timeout_action: Action to take when TargetSpotCapacity has not been fulfilled when the TimeoutDurationMinutes has expired; that is, when all Spot instances could not be provisioned within the Spot provisioning timeout. Valid values are `TERMINATE_CLUSTER` and `SWITCH_TO_ON_DEMAND`. SWITCH_TO_ON_DEMAND specifies that if no Spot instances are available, On-Demand Instances should be provisioned to fulfill any remaining Spot capacity.
        :param pulumi.Input[builtins.int] timeout_duration_minutes: Spot provisioning timeout period in minutes. If Spot instances are not provisioned within this time period, the TimeOutAction is taken. Minimum value is 5 and maximum value is 1440. The timeout applies only during initial provisioning, when the cluster is first created.
        :param pulumi.Input[builtins.int] block_duration_minutes: Defined duration for Spot instances (also known as Spot blocks) in minutes. When specified, the Spot instance does not terminate before the defined duration expires, and defined duration pricing for Spot instances applies. Valid values are 60, 120, 180, 240, 300, or 360. The duration period starts as soon as a Spot instance receives its instance ID. At the end of the duration, Amazon EC2 marks the Spot instance for termination and provides a Spot instance termination notice, which gives the instance a two-minute warning before it terminates.
        """
        pulumi.set(__self__, "allocation_strategy", allocation_strategy)
    ...
    def timeout_action(self) -> pulumi.Input[builtins.str]:
        """
        Action to take when TargetSpotCapacity has not been fulfilled when the TimeoutDurationMinutes has expired; that is, when all Spot instances could not be provisioned within the Spot provisioning timeout. Valid values are `TERMINATE_CLUSTER` and `SWITCH_TO_ON_DEMAND`. SWITCH_TO_ON_DEMAND specifies that if no Spot instances are available, On-Demand Instances should be provisioned to fulfill any remaining Spot capacity.
        """
    ...
    def timeout_action(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "timeout_action", value)

    @property
    @pulumi.getter(name="timeoutDurationMinutes")
    def timeout_duration_minutes(self) -> pulumi.Input[builtins.int]:
        """
        Spot provisioning timeout period in minutes. If Spot instances are not provisioned within this time period, the TimeOutAction is taken. Minimum value is 5 and maximum value is 1440. The timeout applies only during initial provisioning, when the cluster is first created.
        """
    ...
    def timeout_duration_minutes(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class ClusterCoreInstanceGroupArgsDict(TypedDict):
        ...
        """
        autoscaling_policy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterCoreInstanceGroupArgs:
    def __init__(__self__, *,
                 instance_type: pulumi.Input[builtins.str],
                 autoscaling_policy: Optional[pulumi.Input[builtins.str]] = None,
                 bid_price: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] instance_type: EC2 instance type for all instances in the instance group.
        :param pulumi.Input[builtins.str] autoscaling_policy: String containing the [EMR Auto Scaling Policy](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-automatic-scaling.html) JSON.
        :param pulumi.Input[builtins.str] bid_price: Bid price for each EC2 instance in the instance group, expressed in USD. By setting this attribute, the instance group is being declared as a Spot Instance, and will implicitly create a Spot request. Leave this blank to use On-Demand Instances.
        ...
        :param pulumi.Input[builtins.str] id: Core node type Instance Group ID, if using Instance Group for this node type.
        :param pulumi.Input[builtins.int] instance_count: Target number of instances for the instance group. Must be at least 1. Defaults to 1.
        :param pulumi.Input[builtins.str] name: Friendly name given to the instance group.
        """
        pulumi.set(__self__, "instance_type", instance_type)
    ...
    def autoscaling_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        String containing the [EMR Auto Scaling Policy](https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-automatic-scaling.html) JSON.
        """
    ...
    def autoscaling_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterCoreInstanceGroupEbsConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Volume type. Valid options are `gp3`, `gp2`, `io1`, `io2`, `standard`, `st1` and `sc1`. See [EBS Volume Types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html).
        :param pulumi.Input[builtins.int] iops: Number of I/O operations per second (IOPS) that the volume supports.
        :param pulumi.Input[builtins.int] throughput: The throughput, in mebibyte per second (MiB/s).
        :param pulumi.Input[builtins.int] volumes_per_instance: Number of EBS volumes with this configuration to attach to each EC2 instance in the instance group (default is 1).
        """
        pulumi.set(__self__, "size", size)
        pulumi.set(__self__, "type", type)
...
if not MYPY:
    class ClusterEc2AttributesArgsDict(TypedDict):
        instance_profile: pulumi.Input[builtins.str]
        """
        Instance Profile for EC2 instances of the cluster assume this role.
        """
        additional_master_security_groups: NotRequired[pulumi.Input[builtins.str]]
        """
        String containing a comma separated list of additional Amazon EC2 security group IDs for the master node.
        """
        additional_slave_security_groups: NotRequired[pulumi.Input[builtins.str]]
        """
        String containing a comma separated list of additional Amazon EC2 security group IDs for the slave nodes as a comma separated string.
        """
        emr_managed_master_security_group: NotRequired[pulumi.Input[builtins.str]]
        """
        Identifier of the Amazon EC2 EMR-Managed security group for the master node.
        """
        emr_managed_slave_security_group: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        service_access_security_group: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterEc2AttributesArgs:
    def __init__(__self__, *,
                 instance_profile: pulumi.Input[builtins.str],
                 additional_master_security_groups: Optional[pulumi.Input[builtins.str]] = None,
                 additional_slave_security_groups: Optional[pulumi.Input[builtins.str]] = None,
                 emr_managed_master_security_group: Optional[pulumi.Input[builtins.str]] = None,
                 emr_managed_slave_security_group: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] instance_profile: Instance Profile for EC2 instances of the cluster assume this role.
        :param pulumi.Input[builtins.str] additional_master_security_groups: String containing a comma separated list of additional Amazon EC2 security group IDs for the master node.
        :param pulumi.Input[builtins.str] additional_slave_security_groups: String containing a comma separated list of additional Amazon EC2 security group IDs for the slave nodes as a comma separated string.
        :param pulumi.Input[builtins.str] emr_managed_master_security_group: Identifier of the Amazon EC2 EMR-Managed security group for the master node.
        :param pulumi.Input[builtins.str] emr_managed_slave_security_group: Identifier of the Amazon EC2 EMR-Managed security group for the slave nodes.
        :param pulumi.Input[builtins.str] key_name: Amazon EC2 key pair that can be used to ssh to the master node as the user called `hadoop`.
        :param pulumi.Input[builtins.str] service_access_security_group: Identifier of the Amazon EC2 service-access security group - required when the cluster runs on a private subnet.
        :param pulumi.Input[builtins.str] subnet_id: VPC subnet id where you want the job flow to launch. Cannot specify the `cc1.4xlarge` instance type for nodes of a job flow launched in an Amazon VPC.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: List of VPC subnet id-s where you want the job flow to launch.  Amazon EMR identifies the best Availability Zone to launch instances according to your fleet specifications.
    ...
    def instance_profile(self) -> pulumi.Input[builtins.str]:
        """
        Instance Profile for EC2 instances of the cluster assume this role.
        """
    ...
    def instance_profile(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "instance_profile", value)

    @property
    @pulumi.getter(name="additionalMasterSecurityGroups")
    def additional_master_security_groups(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        String containing a comma separated list of additional Amazon EC2 security group IDs for the master node.
        """
    ...
    def additional_master_security_groups(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "additional_master_security_groups", value)

    @property
    @pulumi.getter(name="additionalSlaveSecurityGroups")
    def additional_slave_security_groups(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        String containing a comma separated list of additional Amazon EC2 security group IDs for the slave nodes as a comma separated string.
        """
    ...
    def additional_slave_security_groups(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "additional_slave_security_groups", value)

    @property
    @pulumi.getter(name="emrManagedMasterSecurityGroup")
    def emr_managed_master_security_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Identifier of the Amazon EC2 EMR-Managed security group for the master node.
        """
    ...
    def emr_managed_master_security_group(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "emr_managed_master_security_group", value)

    @property
    @pulumi.getter(name="emrManagedSlaveSecurityGroup")
    def emr_managed_slave_security_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Identifier of the Amazon EC2 EMR-Managed security group for the slave nodes.
        """
    ...
    def emr_managed_slave_security_group(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ClusterKerberosAttributesArgsDict(TypedDict):
        kdc_admin_password: pulumi.Input[builtins.str]
        """
        ...
        """
        ad_domain_join_password: NotRequired[pulumi.Input[builtins.str]]
        """
        Active Directory password for `ad_domain_join_user`. This provider cannot perform drift detection of this configuration.
        """
        ad_domain_join_user: NotRequired[pulumi.Input[builtins.str]]
        """
        Required only when establishing a cross-realm trust with an Active Directory domain. A user with sufficient privileges to join resources to the domain. This provider cannot perform drift detection of this configuration.
        """
        cross_realm_trust_principal_password: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterKerberosAttributesArgs:
    def __init__(__self__, *,
                 kdc_admin_password: pulumi.Input[builtins.str],
                 realm: pulumi.Input[builtins.str],
                 ad_domain_join_password: Optional[pulumi.Input[builtins.str]] = None,
                 ad_domain_join_user: Optional[pulumi.Input[builtins.str]] = None,
                 cross_realm_trust_principal_password: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] kdc_admin_password: Password used within the cluster for the kadmin service on the cluster-dedicated KDC, which maintains Kerberos principals, password policies, and keytabs for the cluster. This provider cannot perform drift detection of this configuration.
        :param pulumi.Input[builtins.str] realm: Name of the Kerberos realm to which all nodes in a cluster belong. For example, `EC2.INTERNAL`
        :param pulumi.Input[builtins.str] ad_domain_join_password: Active Directory password for `ad_domain_join_user`. This provider cannot perform drift detection of this configuration.
        :param pulumi.Input[builtins.str] ad_domain_join_user: Required only when establishing a cross-realm trust with an Active Directory domain. A user with sufficient privileges to join resources to the domain. This provider cannot perform drift detection of this configuration.
        :param pulumi.Input[builtins.str] cross_realm_trust_principal_password: Required only when establishing a cross-realm trust with a KDC in a different realm. The cross-realm principal password, which must be identical across realms. This provider cannot perform drift detection of this configuration.
        """
    ...
    def kdc_admin_password(self) -> pulumi.Input[builtins.str]:
        """
        Password used within the cluster for the kadmin service on the cluster-dedicated KDC, which maintains Kerberos principals, password policies, and keytabs for the cluster. This provider cannot perform drift detection of this configuration.
        """
    ...
    def kdc_admin_password(self, value: pulumi.Input[builtins.str]):
    ...
    def ad_domain_join_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Active Directory password for `ad_domain_join_user`. This provider cannot perform drift detection of this configuration.
        """
    ...
    def ad_domain_join_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ad_domain_join_password", value)

    @property
    @pulumi.getter(name="adDomainJoinUser")
    def ad_domain_join_user(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required only when establishing a cross-realm trust with an Active Directory domain. A user with sufficient privileges to join resources to the domain. This provider cannot perform drift detection of this configuration.
        """
    ...
    def ad_domain_join_user(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ad_domain_join_user", value)

    @property
    @pulumi.getter(name="crossRealmTrustPrincipalPassword")
    def cross_realm_trust_principal_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required only when establishing a cross-realm trust with a KDC in a different realm. The cross-realm principal password, which must be identical across realms. This provider cannot perform drift detection of this configuration.
        """
    ...
    def cross_realm_trust_principal_password(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterMasterInstanceFleetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Friendly name given to the instance fleet.
        :param pulumi.Input[builtins.int] target_on_demand_capacity: Target capacity of On-Demand units for the instance fleet, which determines how many On-Demand instances to provision.
        :param pulumi.Input[builtins.int] target_spot_capacity: Target capacity of Spot units for the instance fleet, which determines how many Spot instances to provision.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class ClusterMasterInstanceGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] id: Master node type Instance Group ID, if using Instance Group for this node type.
        :param pulumi.Input[builtins.int] instance_count: Target number of instances for the instance group. Must be 1 or 3. Defaults to 1. Launching with multiple master nodes is only supported in EMR version 5.23.0+, and requires this resource's `core_instance_group` to be configured. Public (Internet accessible) instances must be created in VPC subnets that have map public IP on launch enabled. Termination protection is automatically enabled when launched with multiple master nodes and this provider must have the `termination_protection = false` configuration applied before destroying this resource.
        :param pulumi.Input[builtins.str] name: Friendly name given to the instance group.
        """
        pulumi.set(__self__, "instance_type", instance_type)
        if bid_price is not None:
...
if not MYPY:
    class ClusterPlacementGroupConfigArgsDict(TypedDict):
        instance_role: pulumi.Input[builtins.str]
        """
        Role of the instance in the cluster. Valid Values: `MASTER`, `CORE`, `TASK`.
        """
        placement_strategy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterPlacementGroupConfigArgs:
    def __init__(__self__, *,
                 instance_role: pulumi.Input[builtins.str],
                 placement_strategy: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] instance_role: Role of the instance in the cluster. Valid Values: `MASTER`, `CORE`, `TASK`.
        :param pulumi.Input[builtins.str] placement_strategy: EC2 Placement Group strategy associated with instance role. Valid Values: `SPREAD`, `PARTITION`, `CLUSTER`, `NONE`.
        """
    ...
    def instance_role(self) -> pulumi.Input[builtins.str]:
        """
        Role of the instance in the cluster. Valid Values: `MASTER`, `CORE`, `TASK`.
        """
    ...
    def instance_role(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "instance_role", value)

    @property
    @pulumi.getter(name="placementStrategy")
    def placement_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        EC2 Placement Group strategy associated with instance role. Valid Values: `SPREAD`, `PARTITION`, `CLUSTER`, `NONE`.
        """
    ...
    def placement_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterStepArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] action_on_failure: Action to take if the step fails. Valid values: `TERMINATE_JOB_FLOW`, `TERMINATE_CLUSTER`, `CANCEL_AND_WAIT`, and `CONTINUE`
...
class ClusterStepHadoopJarStepArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] jar: Path to a JAR file run during the step.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: List of command line arguments passed to the JAR file's main function when executed.
        :param pulumi.Input[builtins.str] main_class: Name of the main class in the specified Java file. If not specified, the JAR file should specify a Main-Class in its manifest file.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: Key-Value map of Java properties that are set when the step runs. You can use these properties to pass key value pairs to your main function.
        """
...
class InstanceFleetInstanceTypeConfigArgs:
    def __init__(__self__, *,
                 ...
                 weighted_capacity: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] instance_type: An EC2 instance type, such as m4.xlarge.
        :param pulumi.Input[builtins.str] bid_price: The bid price for each EC2 Spot instance type as defined by `instance_type`. Expressed in USD. If neither `bid_price` nor `bid_price_as_percentage_of_on_demand_price` is provided, `bid_price_as_percentage_of_on_demand_price` defaults to 100%.
        :param pulumi.Input[builtins.float] bid_price_as_percentage_of_on_demand_price: The bid price, as a percentage of On-Demand price, for each EC2 Spot instance as defined by `instance_type`. Expressed as a number (for example, 20 specifies 20%). If neither `bid_price` nor `bid_price_as_percentage_of_on_demand_price` is provided, `bid_price_as_percentage_of_on_demand_price` defaults to 100%.
        ...
        :param pulumi.Input[builtins.int] weighted_capacity: The number of units that a provisioned instance of this type provides toward fulfilling the target capacities defined in `emr.InstanceFleet`.
        """
        pulumi.set(__self__, "instance_type", instance_type)
        if bid_price is not None:
            pulumi.set(__self__, "bid_price", bid_price)
...
class InstanceFleetInstanceTypeConfigConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] classification: The classification within a configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A map of properties specified within a configuration classification
        """
        if classification is not None:
            pulumi.set(__self__, "classification", classification)
        if properties is not None:
...
class InstanceFleetInstanceTypeConfigEbsConfigArgs:
    def __init__(__self__, *,
                 ...
                 volumes_per_instance: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] size: The volume size, in gibibytes (GiB).
        :param pulumi.Input[builtins.str] type: The volume type. Valid options are `gp2`, `io1`, `standard` and `st1`. See [EBS Volume Types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html).
        :param pulumi.Input[builtins.int] iops: The number of I/O operations per second (IOPS) that the volume supports
        :param pulumi.Input[builtins.int] volumes_per_instance: The number of EBS volumes with this configuration to attach to each EC2 instance in the instance group (default is 1)
        """
        pulumi.set(__self__, "size", size)
        pulumi.set(__self__, "type", type)
        if iops is not None:
...
class InstanceFleetLaunchSpecificationsOnDemandSpecificationArgs:
    def __init__(__self__, *,
                 allocation_strategy: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] allocation_strategy: Specifies one of the following strategies to launch Spot Instance fleets: `price-capacity-optimized`, `capacity-optimized`, `lowest-price`, or `diversified`. For more information on the provisioning strategies, see [Allocation strategies for Spot Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-allocation-strategy.html).
        """
        pulumi.set(__self__, "allocation_strategy", allocation_strategy)
...
class InstanceFleetLaunchSpecificationsSpotSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] allocation_strategy: Specifies one of the following strategies to launch Spot Instance fleets: `price-capacity-optimized`, `capacity-optimized`, `lowest-price`, or `diversified`. For more information on the provisioning strategies, see [Allocation strategies for Spot Instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-fleet-allocation-strategy.html).
        :param pulumi.Input[builtins.str] timeout_action: The action to take when TargetSpotCapacity has not been fulfilled when the TimeoutDurationMinutes has expired; that is, when all Spot instances could not be provisioned within the Spot provisioning timeout. Valid values are `TERMINATE_CLUSTER` and `SWITCH_TO_ON_DEMAND`. SWITCH_TO_ON_DEMAND specifies that if no Spot instances are available, On-Demand Instances should be provisioned to fulfill any remaining Spot capacity.
        :param pulumi.Input[builtins.int] timeout_duration_minutes: The spot provisioning timeout period in minutes. If Spot instances are not provisioned within this time period, the TimeOutAction is taken. Minimum value is 5 and maximum value is 1440. The timeout applies only during initial provisioning, when the cluster is first created.
        :param pulumi.Input[builtins.int] block_duration_minutes: The defined duration for Spot instances (also known as Spot blocks) in minutes. When specified, the Spot instance does not terminate before the defined duration expires, and defined duration pricing for Spot instances applies. Valid values are 60, 120, 180, 240, 300, or 360. The duration period starts as soon as a Spot instance receives its instance ID. At the end of the duration, Amazon EC2 marks the Spot instance for termination and provides a Spot instance termination notice, which gives the instance a two-minute warning before it terminates.
        """
        pulumi.set(__self__, "allocation_strategy", allocation_strategy)
        pulumi.set(__self__, "timeout_action", timeout_action)
        pulumi.set(__self__, "timeout_duration_minutes", timeout_duration_minutes)
...
class InstanceGroupEbsConfigArgs:
    def __init__(__self__, *,
                 ...
                 volumes_per_instance: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] size: The volume size, in gibibytes (GiB). This can be a number from 1 - 1024. If the volume type is EBS-optimized, the minimum value is 10.
        :param pulumi.Input[builtins.str] type: The volume type. Valid options are 'gp2', 'io1' and 'standard'.
        :param pulumi.Input[builtins.int] iops: The number of I/O operations per second (IOPS) that the volume supports.
        :param pulumi.Input[builtins.int] volumes_per_instance: The number of EBS Volumes to attach per instance.
        """
        pulumi.set(__self__, "size", size)
        pulumi.set(__self__, "type", type)
        if iops is not None:
...
class ManagedScalingPolicyComputeLimitArgs:
    def __init__(__self__, *,
                 ...
                 minimum_capacity_units: pulumi.Input[builtins.int],
                 unit_type: pulumi.Input[builtins.str],
                 maximum_core_capacity_units: Optional[pulumi.Input[builtins.int]] = None,
                 maximum_ondemand_capacity_units: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] maximum_capacity_units: The upper boundary of EC2 units. It is measured through VCPU cores or instances for instance groups and measured through units for instance fleets. Managed scaling activities are not allowed beyond this boundary. The limit only applies to the core and task nodes. The master node cannot be scaled after initial configuration.
        :param pulumi.Input[builtins.int] minimum_capacity_units: The lower boundary of EC2 units. It is measured through VCPU cores or instances for instance groups and measured through units for instance fleets. Managed scaling activities are not allowed beyond this boundary. The limit only applies to the core and task nodes. The master node cannot be scaled after initial configuration.
        :param pulumi.Input[builtins.str] unit_type: The unit type used for specifying a managed scaling policy. Valid Values: `InstanceFleetUnits` | `Instances` | `VCPU`
        :param pulumi.Input[builtins.int] maximum_core_capacity_units: The upper boundary of EC2 units for core node type in a cluster. It is measured through VCPU cores or instances for instance groups and measured through units for instance fleets. The core units are not allowed to scale beyond this boundary. The parameter is used to split capacity allocation between core and task nodes.
        :param pulumi.Input[builtins.int] maximum_ondemand_capacity_units: The upper boundary of On-Demand EC2 units. It is measured through VCPU cores or instances for instance groups and measured through units for instance fleets. The On-Demand units are not allowed to scale beyond this boundary. The parameter is used to split capacity allocation between On-Demand and Spot instances.
        """
    ...
    def maximum_capacity_units(self) -> pulumi.Input[builtins.int]:
        """
        The upper boundary of EC2 units. It is measured through VCPU cores or instances for instance groups and measured through units for instance fleets. Managed scaling activities are not allowed beyond this boundary. The limit only applies to the core and task nodes. The master node cannot be scaled after initial configuration.
        """
    ...
    def maximum_capacity_units(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "maximum_capacity_units", value)

    @property
    @pulumi.getter(name="minimumCapacityUnits")
    def minimum_capacity_units(self) -> pulumi.Input[builtins.int]:
        """
        The lower boundary of EC2 units. It is measured through VCPU cores or instances for instance groups and measured through units for instance fleets. Managed scaling activities are not allowed beyond this boundary. The limit only applies to the core and task nodes. The master node cannot be scaled after initial configuration.
        """
    ...
    def minimum_capacity_units(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "minimum_capacity_units", value)

    @property
    @pulumi.getter(name="unitType")
    def unit_type(self) -> pulumi.Input[builtins.str]:
        """
        The unit type used for specifying a managed scaling policy. Valid Values: `InstanceFleetUnits` | `Instances` | `VCPU`
        """
    ...
    @unit_type.setter
    def unit_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "unit_type", value)

    @property
    @pulumi.getter(name="maximumCoreCapacityUnits")
    def maximum_core_capacity_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The upper boundary of EC2 units for core node type in a cluster. It is measured through VCPU cores or instances for instance groups and measured through units for instance fleets. The core units are not allowed to scale beyond this boundary. The parameter is used to split capacity allocation between core and task nodes.
        """
    ...
    def maximum_core_capacity_units(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "maximum_core_capacity_units", value)

    @property
    @pulumi.getter(name="maximumOndemandCapacityUnits")
    def maximum_ondemand_capacity_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The upper boundary of On-Demand EC2 units. It is measured through VCPU cores or instances for instance groups and measured through units for instance fleets. The On-Demand units are not allowed to scale beyond this boundary. The parameter is used to split capacity allocation between On-Demand and Spot instances.
        """
    ...
    def maximum_ondemand_capacity_units(self, value: Optional[pulumi.Input[builtins.int]]):
...
class GetSupportedInstanceTypesSupportedInstanceTypeArgs:
    ...
    def ebs_optimized_available(self, value: builtins.bool):
    ...
    def ebs_optimized_by_default(self, value: builtins.bool):
    ...
    def ebs_storage_only(self, value: builtins.bool):
    ...
    def instance_family_id(self, value: builtins.str):
    ...
    def is64_bits_only(self, value: builtins.bool):
    ...
    @memory_gb.setter
    def memory_gb(self, value: builtins.float):
    ...
    def number_of_disks(self, value: builtins.int):
    ...
    @storage_gb.setter
    def storage_gb(self, value: builtins.int):
    ...
    @vcpu.setter
    def vcpu(self, value: builtins.int):
