...
class InstanceGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] configurations_json: A JSON string for supplying list of configurations specific to the EMR instance group. Note that this can only be changed when using EMR release 5.21 or later.
        ...
        :param pulumi.Input[_builtins.str] name: Human friendly name given to the instance group. Changing this forces a new resource to be created.
...
class _InstanceGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Human friendly name given to the instance group. Changing this forces a new resource to be created.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[_builtins.int] running_instance_count: The number of instances currently running in this instance group.
        :param pulumi.Input[_builtins.str] status: The current status of the instance group.
        """
        if autoscaling_policy is not None:
            pulumi.set(__self__, "autoscaling_policy", autoscaling_policy)
        if bid_price is not None:
