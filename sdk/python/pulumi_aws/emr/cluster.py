        ...
        * `properties` - (Optional) Key-Value map of Java properties that are set when the step runs. You can use these properties to pass key value pairs to your main function.
        ...
        The **core_instance_group** object supports the following:
          ...
          * `ebs_configs` (`pulumi.Input[list]`)
            ...
            * `volumes_per_instance` (`pulumi.Input[float]`)
        ...
        The **ec2_attributes** object supports the following:
          ...
          * `additional_master_security_groups` (`pulumi.Input[str]`)
          * `additional_slave_security_groups` (`pulumi.Input[str]`)
          * `emr_managed_master_security_group` (`pulumi.Input[str]`)
          * `emr_managed_slave_security_group` (`pulumi.Input[str]`)
          * `instance_profile` (`pulumi.Input[str]`)
          * `key_name` (`pulumi.Input[str]`)
          * `service_access_security_group` (`pulumi.Input[str]`)
        ...
        The **kerberos_attributes** object supports the following:
          ...
          * `ad_domain_join_password` (`pulumi.Input[str]`)
          * `ad_domain_join_user` (`pulumi.Input[str]`)
          * `cross_realm_trust_principal_password` (`pulumi.Input[str]`)
        ...
        The **steps** object supports the following:
          ...
          * `hadoop_jar_step` (`pulumi.Input[dict]`)
