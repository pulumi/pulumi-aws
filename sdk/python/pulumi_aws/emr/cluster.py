...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 autoscaling_role: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 keep_job_flow_alive_when_no_steps: Optional[pulumi.Input[builtins.bool]] = None,
                 kerberos_attributes: Optional[pulumi.Input['ClusterKerberosAttributesArgs']] = None,
                 list_steps_states: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 log_encryption_kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 unhealthy_node_replacement: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] service_role: IAM role that will be assumed by the Amazon EMR service to access AWS resources.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] additional_info: JSON string for selecting additional features such as adding proxy information. Note: Currently there is no API to retrieve the value of this argument after EMR cluster creation from provider, therefore the provider cannot detect drift from the actual EMR cluster if its value is changed outside the provider.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] applications: A case-insensitive list of applications for Amazon EMR to install and configure when launching the cluster. For a list of applications available for each Amazon EMR release version, see the [Amazon EMR Release Guide](https://docs.aws.amazon.com/emr/latest/ReleaseGuide/emr-release-components.html).
        ...
        :param pulumi.Input[builtins.str] autoscaling_role: IAM role for automatic scaling policies. The IAM role provides permissions that the automatic scaling feature requires to launch and terminate EC2 instances in an instance group.
        ...
        :param pulumi.Input[builtins.str] configurations: List of configurations supplied for the EMR cluster you are creating. Supply a configuration object for applications to override their default configuration. See [AWS Documentation](https://docs.aws.amazon.com/emr/latest/ReleaseGuide/emr-configure-apps.html) for more information.
        :param pulumi.Input[builtins.str] configurations_json: JSON string for supplying list of configurations for the EMR cluster.
        ...
        :param pulumi.Input[builtins.str] custom_ami_id: Custom Amazon Linux AMI for the cluster (instead of an EMR-owned AMI). Available in Amazon EMR version 5.7.0 and later.
        :param pulumi.Input[builtins.int] ebs_root_volume_size: Size in GiB of the EBS root device volume of the Linux AMI that is used for each EC2 instance. Available in Amazon EMR version 4.x and later.
        ...
        :param pulumi.Input[builtins.bool] keep_job_flow_alive_when_no_steps: Switch on/off run cluster with no steps or when all steps are complete (default is on)
        :param pulumi.Input['ClusterKerberosAttributesArgs'] kerberos_attributes: Kerberos configuration for the cluster. See below.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] list_steps_states: List of [step states](https://docs.aws.amazon.com/emr/latest/APIReference/API_StepStatus.html) used to filter returned steps
        :param pulumi.Input[builtins.str] log_encryption_kms_key_id: AWS KMS customer master key (CMK) key ID or arn used for encrypting log files. This attribute is only available with EMR version 5.30.0 and later, excluding EMR 6.0.0.
        :param pulumi.Input[builtins.str] log_uri: S3 bucket to write the log files of the job flow. If a value is not provided, logs are not created.
        ...
        :param pulumi.Input[builtins.bool] termination_protection: Switch on/off termination protection (default is `false`, except when using multiple master nodes). Before attempting to destroy the resource when termination protection is enabled, this configuration must be applied with its value set to `false`.
        :param pulumi.Input[builtins.bool] unhealthy_node_replacement: Whether whether Amazon EMR should gracefully replace core nodes that have degraded within the cluster. Default value is `false`.
        :param pulumi.Input[builtins.bool] visible_to_all_users: Whether the job flow is visible to all IAM users of the AWS account associated with the job flow. Default value is `true`.
        """
    ...
    def autoscaling_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def autoscaling_role(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def keep_job_flow_alive_when_no_steps(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def keep_job_flow_alive_when_no_steps(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def list_steps_states(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def list_steps_states(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "list_steps_states", value)

    @property
    @pulumi.getter(name="logEncryptionKmsKeyId")
    def log_encryption_kms_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def log_encryption_kms_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scale_down_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scale_down_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def step_concurrency_level(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def step_concurrency_level(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def unhealthy_node_replacement(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def unhealthy_node_replacement(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClusterState:
    ...
    def master_public_dns(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_public_dns(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            termination_protection: Optional[pulumi.Input[builtins.bool]] = None,
            unhealthy_node_replacement: Optional[pulumi.Input[builtins.bool]] = None,
            visible_to_all_users: Optional[pulumi.Input[builtins.bool]] = None) -> 'Cluster':
        """
    ...
    @property
    @pulumi.getter(name="autoscalingRole")
    def autoscaling_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IAM role for automatic scaling policies. The IAM role provides permissions that the automatic scaling feature requires to launch and terminate EC2 instances in an instance group.
        """
        return pulumi.get(self, "autoscaling_role")
    ...
    @property
    @pulumi.getter
    def configurations(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        List of configurations supplied for the EMR cluster you are creating. Supply a configuration object for applications to override their default configuration. See [AWS Documentation](https://docs.aws.amazon.com/emr/latest/ReleaseGuide/emr-configure-apps.html) for more information.
        """
        return pulumi.get(self, "configurations")
    ...
    @property
    @pulumi.getter(name="keepJobFlowAliveWhenNoSteps")
    def keep_job_flow_alive_when_no_steps(self) -> pulumi.Output[builtins.bool]:
        """
        Switch on/off run cluster with no steps or when all steps are complete (default is on)
        """
        return pulumi.get(self, "keep_job_flow_alive_when_no_steps")
    ...
    @property
    @pulumi.getter(name="listStepsStates")
    def list_steps_states(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of [step states](https://docs.aws.amazon.com/emr/latest/APIReference/API_StepStatus.html) used to filter returned steps
        """
        return pulumi.get(self, "list_steps_states")
    ...
    @property
    @pulumi.getter(name="logEncryptionKmsKeyId")
    def log_encryption_kms_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        AWS KMS customer master key (CMK) key ID or arn used for encrypting log files. This attribute is only available with EMR version 5.30.0 and later, excluding EMR 6.0.0.
        """
        return pulumi.get(self, "log_encryption_kms_key_id")
    ...
    @property
    @pulumi.getter(name="masterPublicDns")
    def master_public_dns(self) -> pulumi.Output[builtins.str]:
        """
        The DNS name of the master node. If the cluster is on a private subnet, this is the private DNS name. On a public subnet, this is the public DNS name.
        """
        return pulumi.get(self, "master_public_dns")
    ...
    @property
    @pulumi.getter(name="scaleDownBehavior")
    def scale_down_behavior(self) -> pulumi.Output[builtins.str]:
        """
        Way that individual Amazon EC2 instances terminate when an automatic scale-in activity occurs or an `instance group` is resized.
        """
        return pulumi.get(self, "scale_down_behavior")
    ...
    @property
    @pulumi.getter(name="stepConcurrencyLevel")
    def step_concurrency_level(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of steps that can be executed concurrently. You can specify a maximum of 256 steps. Only valid for EMR clusters with `release_label` 5.28.0 or greater (default is 1).
        """
        return pulumi.get(self, "step_concurrency_level")
    ...
    @property
    @pulumi.getter(name="unhealthyNodeReplacement")
    def unhealthy_node_replacement(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether whether Amazon EMR should gracefully replace core nodes that have degraded within the cluster. Default value is `false`.
        """
        return pulumi.get(self, "unhealthy_node_replacement")
