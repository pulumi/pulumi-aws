...
class SecurityConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] configuration: A JSON formatted Security Configuration
        :param pulumi.Input[_builtins.str] name: The name of the EMR Security Configuration. By default generated by this provider.
...
class _SecurityConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] configuration: A JSON formatted Security Configuration
        :param pulumi.Input[_builtins.str] creation_date: Date the Security Configuration was created
        :param pulumi.Input[_builtins.str] name: The name of the EMR Security Configuration. By default generated by this provider.
        :param pulumi.Input[_builtins.str] name_prefix: Creates a unique name beginning with the specified
               prefix. Conflicts with `name`.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
