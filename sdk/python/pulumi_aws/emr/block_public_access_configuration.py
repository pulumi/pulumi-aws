...
class BlockPublicAccessConfigurationArgs:
    ...
    def block_public_security_group_rules(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def block_public_security_group_rules(self, value: pulumi.Input[builtins.bool]):
...
class _BlockPublicAccessConfigurationState:
    ...
    @property
    @pulumi.getter(name="blockPublicSecurityGroupRules")
    def block_public_security_group_rules(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable or disable EMR Block Public Access.
    ...
    @block_public_security_group_rules.setter
    def block_public_security_group_rules(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "block_public_security_group_rules", value)
...
class BlockPublicAccessConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="blockPublicSecurityGroupRules")
    def block_public_security_group_rules(self) -> pulumi.Output[builtins.bool]:
        """
        Enable or disable EMR Block Public Access.
