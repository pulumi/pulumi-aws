...
class Queue(pulumi.CustomResource):
    ...
    """
    delay_seconds: pulumi.Output[int]
    """
    ...
    """
    kms_data_key_reuse_period_seconds: pulumi.Output[int]
    """
    ...
    """
    max_message_size: pulumi.Output[int]
    """
    The limit of how many bytes a message can contain before Amazon SQS rejects it. An integer from 1024 bytes (1 KiB) up to 262144 bytes (256 KiB). The default for this attribute is 262144 (256 KiB).
    """
    message_retention_seconds: pulumi.Output[int]
    """
    ...
    """
    receive_wait_time_seconds: pulumi.Output[int]
    """
    ...
    """
    visibility_timeout_seconds: pulumi.Output[int]
    """
    ...
    def __init__(__self__, __name__, __opts__=None, content_based_deduplication=None, delay_seconds=None, fifo_queue=None, kms_data_key_reuse_period_seconds=None, kms_master_key_id=None, max_message_size=None, message_retention_seconds=None, name=None, name_prefix=None, policy=None, receive_wait_time_seconds=None, redrive_policy=None, tags=None, visibility_timeout_seconds=None):
        ...
        :param pulumi.Input[str] name: This is the human-readable name of the queue. If omitted, Terraform will assign a random name.
