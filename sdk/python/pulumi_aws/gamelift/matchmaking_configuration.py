...
class MatchmakingConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 backfill_mode: Optional[pulumi.Input[builtins.str]] = None,
                 custom_event_data: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 flex_match_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] rule_set_name: A rule set names for the matchmaking rule set to use with this configuration.
        :param pulumi.Input[builtins.bool] acceptance_required: Specifies if the match that was created with this configuration must be accepted by matched players.
        ...
        :param pulumi.Input[builtins.str] backfill_mode: The method used to backfill game sessions that are created with this matchmaking configuration.
        :param pulumi.Input[builtins.str] custom_event_data: Information to be added to all events related to this matchmaking configuration.
        :param pulumi.Input[builtins.str] description: A human-readable description of the matchmaking configuration.
        :param pulumi.Input[builtins.str] flex_match_mode: Indicates whether this matchmaking configuration is being used with GameLift hosting or as a standalone matchmaking solution.
        ...
        :param pulumi.Input[builtins.str] game_session_data: A set of custom game session properties.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] game_session_queue_arns: The ARNs of the GameLift game session queue resources.
        :param pulumi.Input[builtins.str] name: Name of the matchmaking configuration
    ...
    def backfill_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backfill_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def flex_match_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def flex_match_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MatchmakingConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] acceptance_timeout_seconds: The length of time (in seconds) to wait for players to accept a proposed match, if acceptance is required.
        :param pulumi.Input[builtins.int] additional_player_count: The number of player slots in a match to keep open for future players.
        :param pulumi.Input[builtins.str] arn: Matchmaking Configuration ARN.
        :param pulumi.Input[builtins.str] backfill_mode: The method used to backfill game sessions that are created with this matchmaking configuration.
        :param pulumi.Input[builtins.str] creation_time: The time when the Matchmaking Configuration was created.
        :param pulumi.Input[builtins.str] custom_event_data: Information to be added to all events related to this matchmaking configuration.
        :param pulumi.Input[builtins.str] description: A human-readable description of the matchmaking configuration.
        :param pulumi.Input[builtins.str] flex_match_mode: Indicates whether this matchmaking configuration is being used with GameLift hosting or as a standalone matchmaking solution.
        :param pulumi.Input[Sequence[pulumi.Input['MatchmakingConfigurationGamePropertyArgs']]] game_properties: One or more custom game properties. See below.
    ...
    @property
    @pulumi.getter(name="requestTimeoutSeconds")
    def request_timeout_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum duration, in seconds, that a matchmaking ticket can remain in process before timing out.
        """
        return pulumi.get(self, "request_timeout_seconds")
    ...
    @request_timeout_seconds.setter
    def request_timeout_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "request_timeout_seconds", value)
...
class MatchmakingConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] description: A human-readable description of the matchmaking configuration.
        :param pulumi.Input[builtins.str] flex_match_mode: Indicates whether this matchmaking configuration is being used with GameLift hosting or as a standalone matchmaking solution.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MatchmakingConfigurationGamePropertyArgs', 'MatchmakingConfigurationGamePropertyArgsDict']]]] game_properties: One or more custom game properties. See below.
        :param pulumi.Input[builtins.str] game_session_data: A set of custom game session properties.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] game_session_queue_arns: The ARNs of the GameLift game session queue resources.
        :param pulumi.Input[builtins.str] name: Name of the matchmaking configuration
        :param pulumi.Input[builtins.str] notification_target: An SNS topic ARN that is set up to receive matchmaking notifications.
    ...
    def get(resource_name: str,
            ...
            rule_set_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'MatchmakingConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="backfillMode")
    def backfill_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The method used to backfill game sessions that are created with this matchmaking configuration.
        """
        return pulumi.get(self, "backfill_mode")
    ...
    @property
    @pulumi.getter(name="flexMatchMode")
    def flex_match_mode(self) -> pulumi.Output[builtins.str]:
        """
        Indicates whether this matchmaking configuration is being used with GameLift hosting or as a standalone matchmaking solution.
        """
        return pulumi.get(self, "flex_match_mode")
    ...
    @property
    @pulumi.getter(name="ruleSetArn")
    def rule_set_arn(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "rule_set_arn")
