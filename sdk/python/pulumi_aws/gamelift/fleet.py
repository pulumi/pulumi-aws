...
class FleetArgs:
    def __init__(__self__, *,
                 ec2_instance_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ec2_instance_type: Name of an EC2 instance typeE.g., `t2.micro`
        :param pulumi.Input[builtins.str] build_id: ID of the GameLift Build to be deployed on the fleet.
        ...
        :param pulumi.Input[builtins.str] description: Human-readable description of the fleet.
        ...
        :param pulumi.Input[builtins.str] fleet_type: Type of fleet. This value must be `ON_DEMAND` or `SPOT`. Defaults to `ON_DEMAND`.
        :param pulumi.Input[builtins.str] instance_role_arn: ARN of an IAM role that instances in the fleet can assume.
    ...
    def ec2_instance_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ec2_instance_type(self, value: pulumi.Input[builtins.str]):
    ...
    def new_game_session_protection_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def new_game_session_protection_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FleetState:
    def __init__(__self__, *,
                 ...
                 build_arn: Optional[pulumi.Input[builtins.str]] = None,
                 build_id: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_configuration: Optional[pulumi.Input['FleetCertificateConfigurationArgs']] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ec2_inbound_permissions: Optional[pulumi.Input[Sequence[pulumi.Input['FleetEc2InboundPermissionArgs']]]] = None,
                 ec2_instance_type: Optional[pulumi.Input[builtins.str]] = None,
                 fleet_type: Optional[pulumi.Input[builtins.str]] = None,
                 instance_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 log_paths: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 metric_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 new_game_session_protection_policy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: Fleet ARN.
        :param pulumi.Input[builtins.str] build_arn: Build ARN.
        :param pulumi.Input[builtins.str] build_id: ID of the GameLift Build to be deployed on the fleet.
        :param pulumi.Input['FleetCertificateConfigurationArgs'] certificate_configuration: Prompts GameLift to generate a TLS/SSL certificate for the fleet. See certificate_configuration.
        :param pulumi.Input[builtins.str] description: Human-readable description of the fleet.
        :param pulumi.Input[Sequence[pulumi.Input['FleetEc2InboundPermissionArgs']]] ec2_inbound_permissions: Range of IP addresses and port settings that permit inbound traffic to access server processes running on the fleet. See below.
    ...
    def build_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Build ARN.
        """
    ...
    @build_arn.setter
    def build_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="ec2InstanceType")
    def ec2_instance_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of an EC2 instance typeE.g., `t2.micro`
        """
        return pulumi.get(self, "ec2_instance_type")
    ...
    @ec2_instance_type.setter
    def ec2_instance_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ec2_instance_type", value)
    ...
    def log_paths(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "log_paths")

    @log_paths.setter
    def log_paths(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def script_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Script ARN.
        """
    ...
    @script_arn.setter
    def script_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Fleet(pulumi.CustomResource):
    ...
    pulumi_type = "aws:gamelift/fleet:Fleet"
    ...
    def get(resource_name: str,
            ...
            script_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Fleet':
        """
    ...
    @property
    @pulumi.getter(name="buildId")
    def build_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ID of the GameLift Build to be deployed on the fleet.
        """
        return pulumi.get(self, "build_id")
    ...
    @property
    @pulumi.getter(name="ec2InstanceType")
    def ec2_instance_type(self) -> pulumi.Output[builtins.str]:
        """
        Name of an EC2 instance typeE.g., `t2.micro`
        """
        return pulumi.get(self, "ec2_instance_type")
    ...
    @property
    @pulumi.getter(name="logPaths")
    def log_paths(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "log_paths")

    @property
    @pulumi.getter(name="metricGroups")
    def metric_groups(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of names of metric groups to add this fleet to. A metric group tracks metrics across all fleets in the group. Defaults to `default`.
        """
        return pulumi.get(self, "metric_groups")
    ...
    @property
    @pulumi.getter(name="newGameSessionProtectionPolicy")
    def new_game_session_protection_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Game session protection policy to apply to all instances in this fleetE.g., `FullProtection`. Defaults to `NoProtection`.
        """
        return pulumi.get(self, "new_game_session_protection_policy")
    ...
    @property
    @pulumi.getter(name="scriptArn")
    def script_arn(self) -> pulumi.Output[builtins.str]:
        """
        Script ARN.
        """
        return pulumi.get(self, "script_arn")
