...
class Fleet(pulumi.CustomResource):
    ...
    Range of IP addresses and port settings that permit inbound traffic to access server processes running on the fleet. See below.
      ...
      * `fromPort` (`float`) - Starting value for a range of allowed port numbers.
      ...
      * `toPort` (`float`) - Ending value for a range of allowed port numbers. Port numbers are end-inclusive. This value must be higher than `from_port`.
    """
    ...
    def __init__(__self__, resource_name, opts=None, build_id=None, description=None, ec2_inbound_permissions=None, ec2_instance_type=None, fleet_type=None, instance_role_arn=None, metric_groups=None, name=None, new_game_session_protection_policy=None, resource_creation_limit_policy=None, runtime_configuration=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **ec2_inbound_permissions** object supports the following:
          ...
          * `fromPort` (`pulumi.Input[float]`) - Starting value for a range of allowed port numbers.
          ...
          * `toPort` (`pulumi.Input[float]`) - Ending value for a range of allowed port numbers. Port numbers are end-inclusive. This value must be higher than `from_port`.
