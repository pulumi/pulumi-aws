...
class GameSessionQueueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] custom_event_data: Information to be added to all events that are related to this game session queue.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destinations: List of fleet/alias ARNs used by session queue for placing game sessions.
...
class _GameSessionQueueState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Game Session Queue ARN.
        :param pulumi.Input[builtins.str] custom_event_data: Information to be added to all events that are related to this game session queue.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destinations: List of fleet/alias ARNs used by session queue for placing game sessions.
        :param pulumi.Input[builtins.str] name: Name of the session queue.
        :param pulumi.Input[builtins.str] notification_target: An SNS topic ARN that is set up to receive game session placement notifications.
