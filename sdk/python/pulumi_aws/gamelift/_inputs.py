...
class AliasRoutingStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Type of routing strategyE.g., `SIMPLE` or `TERMINAL`
        :param pulumi.Input[builtins.str] fleet_id: ID of the GameLift Fleet to point the alias to.
        :param pulumi.Input[builtins.str] message: Message text to be used with the `TERMINAL` routing strategy.
        """
...
class BuildStorageLocationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: Name of your S3 bucket.
        :param pulumi.Input[builtins.str] key: Name of the zip file containing your build files.
        :param pulumi.Input[builtins.str] role_arn: ARN of the access role that allows Amazon GameLift to access your S3 bucket.
        :param pulumi.Input[builtins.str] object_version: A specific version of the file. If not set, the latest version of the file is retrieved.
        """
...
class FleetCertificateConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] certificate_type: Indicates whether a TLS/SSL certificate is generated for a fleet. Valid values are `DISABLED` and `GENERATED`. Default value is `DISABLED`.
        """
...
class FleetEc2InboundPermissionArgs:
    def __init__(__self__, *,
                 ...
                 to_port: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] from_port: Starting value for a range of allowed port numbers.
        :param pulumi.Input[builtins.str] ip_range: Range of allowed IP addresses expressed in CIDR notationE.g., `000.000.000.000/[subnet mask]` or `0.0.0.0/[subnet mask]`.
        :param pulumi.Input[builtins.str] protocol: Network communication protocol used by the fleetE.g., `TCP` or `UDP`
        :param pulumi.Input[builtins.int] to_port: Ending value for a range of allowed port numbers. Port numbers are end-inclusive. This value must be higher than `from_port`.
        """
...
class FleetResourceCreationLimitPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] new_game_sessions_per_creator: Maximum number of game sessions that an individual can create during the policy period.
        :param pulumi.Input[builtins.int] policy_period_in_minutes: Time span used in evaluating the resource creation limit policy.
        """
...
class FleetRuntimeConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] game_session_activation_timeout_seconds: Maximum amount of time (in seconds) that a game session can remain in status `ACTIVATING`.
        :param pulumi.Input[builtins.int] max_concurrent_game_session_activations: Maximum number of game sessions with status `ACTIVATING` to allow on an instance simultaneously.
...
class FleetRuntimeConfigurationServerProcessArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] concurrent_executions: Number of server processes using this configuration to run concurrently on an instance.
        :param pulumi.Input[builtins.str] launch_path: Location of the server executable in a game build. All game builds are installed on instances at the root : for Windows instances `C:\\game`, and for Linux instances `/local/game`.
        :param pulumi.Input[builtins.str] parameters: Optional list of parameters to pass to the server executable on launch.
        """
...
class GameServerGroupAutoScalingPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] estimated_instance_warmup: Length of time, in seconds, it takes for a new instance to start
               new game server processes and register with GameLift FleetIQ.
               Specifying a warm-up time can be useful, particularly with game servers that take a long time to start up,
               because it avoids prematurely starting new instances. Defaults to `60`.
        """
...
class GameServerGroupInstanceDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] instance_type: An EC2 instance type.
        :param pulumi.Input[builtins.str] weighted_capacity: Instance weighting that indicates how much this instance type contributes
               to the total capacity of a game server group.
               Instance weights are used by GameLift FleetIQ to calculate the instance type's cost per unit hour and better identify
               the most cost-effective options.
        """
...
class GameServerGroupLaunchTemplateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: A unique identifier for an existing EC2 launch template.
        :param pulumi.Input[builtins.str] name: A readable identifier for an existing EC2 launch template.
        :param pulumi.Input[builtins.str] version: The version of the EC2 launch template to use. If none is set, the default is the first version created.
        """
        if id is not None:
...
if not MYPY:
    class GameSessionQueuePlayerLatencyPolicyArgsDict(TypedDict):
        maximum_individual_player_latency_milliseconds: pulumi.Input[builtins.int]
        """
...
class GameSessionQueuePlayerLatencyPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] maximum_individual_player_latency_milliseconds: Maximum latency value that is allowed for any player.
        :param pulumi.Input[builtins.int] policy_duration_seconds: Length of time that the policy is enforced while placing a new game session. Absence of value for this attribute means that the policy is enforced until the queue times out.
        """
    ...
    def maximum_individual_player_latency_milliseconds(self) -> pulumi.Input[builtins.int]:
        """
        Maximum latency value that is allowed for any player.
        """
    ...
    def maximum_individual_player_latency_milliseconds(self, value: pulumi.Input[builtins.int]):
...
class ScriptStorageLocationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: Name of your S3 bucket.
        :param pulumi.Input[builtins.str] key: Name of the zip file containing your script files.
        :param pulumi.Input[builtins.str] role_arn: ARN of the access role that allows Amazon GameLift to access your S3 bucket.
        :param pulumi.Input[builtins.str] object_version: A specific version of the file. If not set, the latest version of the file is retrieved.
        """
        pulumi.set(__self__, "bucket", bucket)
