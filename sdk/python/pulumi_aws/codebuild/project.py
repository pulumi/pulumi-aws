...
class Project(pulumi.CustomResource):
    ...
    Information about the project's build output artifacts. Artifact blocks are documented below.
      ...
      * `artifact_identifier` (`str`) - The artifact identifier. Must be the same specified inside AWS CodeBuild buildspec.
      * `encryption_disabled` (`bool`) - If set to true, output artifacts will not be encrypted. If `type` is set to `NO_ARTIFACTS` then this value will be ignored. Defaults to `false`.
      ...
      * `namespace_type` (`str`) - The namespace to use in storing build artifacts. If `type` is set to `S3`, then valid values for this parameter are: `BUILD_ID` or `NONE`.
      * `override_artifact_name` (`bool`) - If set to true, a name specified in the build spec file overrides the artifact name.
    ...
    Information about the project's build environment. Environment blocks are documented below.
      ...
      * `compute_type` (`str`) - Information about the compute resources the build project will use. Available values for this parameter are: `BUILD_GENERAL1_SMALL`, `BUILD_GENERAL1_MEDIUM` or `BUILD_GENERAL1_LARGE`. `BUILD_GENERAL1_SMALL` is only valid if `type` is set to `LINUX_CONTAINER`
      * `environment_variables` (`list`) - A set of environment variables to make available to builds for this build project.
      ...
      * `image_pull_credentials_type` (`str`) - The type of credentials AWS CodeBuild uses to pull images in your build. Available values for this parameter are `CODEBUILD` or `SERVICE_ROLE`. When you use a cross-account or private registry image, you must use SERVICE_ROLE credentials. When you use an AWS CodeBuild curated image, you must use CODEBUILD credentials. Default to `CODEBUILD`
      * `privileged_mode` (`bool`) - If set to true, enables running the Docker daemon inside a Docker container. Defaults to `false`.
      * `registry_credential` (`dict`) - Information about credentials for access to a private Docker registry. Registry Credential config blocks are documented below.
    ...
    Configuration for the builds to store log data to CloudWatch or S3.
      ...
      * `cloudwatch_logs` (`dict`) - Configuration for the builds to store logs to CloudWatch
        ...
        * `stream_name` (`str`) - The stream name of the logs in CloudWatch Logs.
    
      * `s3_logs` (`dict`) - Configuration for the builds to store logs to S3.
    ...
    A set of secondary sources to be used inside the build. Secondary sources blocks are documented below.
      ...
      * `git_clone_depth` (`float`) - Truncate git history to this many commits.
      * `insecure_ssl` (`bool`) - Ignore SSL warnings when connecting to source control.
      * `location` (`str`) - The location of the source code from git or s3.
      * `report_build_status` (`bool`) - Set to `true` to report the status of a build's start and finish to your source provider. This option is only valid when your source provider is `GITHUB`, `BITBUCKET`, or `GITHUB_ENTERPRISE`.
      * `source_identifier` (`str`) - The source identifier. Source data will be put inside a folder named as this parameter inside AWS CodeBuild source directory
      * `type` (`str`) - The type of repository that contains the source code to be built. Valid values for this parameter are: `CODECOMMIT`, `CODEPIPELINE`, `GITHUB`, `GITHUB_ENTERPRISE`, `BITBUCKET` or `S3`.
    """
    ...
    def __init__(__self__, resource_name, opts=None, artifacts=None, badge_enabled=None, build_timeout=None, cache=None, description=None, encryption_key=None, environment=None, logs_config=None, name=None, secondary_artifacts=None, secondary_sources=None, service_role=None, source=None, tags=None, vpc_config=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **artifacts** object supports the following:
          ...
          * `artifact_identifier` (`pulumi.Input[str]`) - The artifact identifier. Must be the same specified inside AWS CodeBuild buildspec.
          * `encryption_disabled` (`pulumi.Input[bool]`) - If set to true, output artifacts will not be encrypted. If `type` is set to `NO_ARTIFACTS` then this value will be ignored. Defaults to `false`.
          ...
          * `namespace_type` (`pulumi.Input[str]`) - The namespace to use in storing build artifacts. If `type` is set to `S3`, then valid values for this parameter are: `BUILD_ID` or `NONE`.
          * `override_artifact_name` (`pulumi.Input[bool]`) - If set to true, a name specified in the build spec file overrides the artifact name.
        ...
        The **environment** object supports the following:
          ...
          * `compute_type` (`pulumi.Input[str]`) - Information about the compute resources the build project will use. Available values for this parameter are: `BUILD_GENERAL1_SMALL`, `BUILD_GENERAL1_MEDIUM` or `BUILD_GENERAL1_LARGE`. `BUILD_GENERAL1_SMALL` is only valid if `type` is set to `LINUX_CONTAINER`
          * `environment_variables` (`pulumi.Input[list]`) - A set of environment variables to make available to builds for this build project.
          ...
          * `image_pull_credentials_type` (`pulumi.Input[str]`) - The type of credentials AWS CodeBuild uses to pull images in your build. Available values for this parameter are `CODEBUILD` or `SERVICE_ROLE`. When you use a cross-account or private registry image, you must use SERVICE_ROLE credentials. When you use an AWS CodeBuild curated image, you must use CODEBUILD credentials. Default to `CODEBUILD`
          * `privileged_mode` (`pulumi.Input[bool]`) - If set to true, enables running the Docker daemon inside a Docker container. Defaults to `false`.
          * `registry_credential` (`pulumi.Input[dict]`) - Information about credentials for access to a private Docker registry. Registry Credential config blocks are documented below.
        
            * `credential` (`pulumi.Input[str]`) - The Amazon Resource Name (ARN) or name of credentials created using AWS Secrets Manager.
            * `credential_provider` (`pulumi.Input[str]`) - The service that created the credentials to access a private Docker registry. The valid value, SECRETS_MANAGER, is for AWS Secrets Manager.
        
          * `type` (`pulumi.Input[str]`) - The type of repository that contains the source code to be built. Valid values for this parameter are: `CODECOMMIT`, `CODEPIPELINE`, `GITHUB`, `GITHUB_ENTERPRISE`, `BITBUCKET` or `S3`.
        
        The **logs_config** object supports the following:
        
          * `cloudwatch_logs` (`pulumi.Input[dict]`) - Configuration for the builds to store logs to CloudWatch
            ...
            * `stream_name` (`pulumi.Input[str]`) - The stream name of the logs in CloudWatch Logs.
        
          * `s3_logs` (`pulumi.Input[dict]`) - Configuration for the builds to store logs to S3.
        ...
        The **secondary_sources** object supports the following:
          ...
          * `git_clone_depth` (`pulumi.Input[float]`) - Truncate git history to this many commits.
          * `insecure_ssl` (`pulumi.Input[bool]`) - Ignore SSL warnings when connecting to source control.
          * `location` (`pulumi.Input[str]`) - The location of the source code from git or s3.
          * `report_build_status` (`pulumi.Input[bool]`) - Set to `true` to report the status of a build's start and finish to your source provider. This option is only valid when your source provider is `GITHUB`, `BITBUCKET`, or `GITHUB_ENTERPRISE`.
          * `source_identifier` (`pulumi.Input[str]`) - The source identifier. Source data will be put inside a folder named as this parameter inside AWS CodeBuild source directory
          * `type` (`pulumi.Input[str]`) - The type of repository that contains the source code to be built. Valid values for this parameter are: `CODECOMMIT`, `CODEPIPELINE`, `GITHUB`, `GITHUB_ENTERPRISE`, `BITBUCKET` or `S3`.
