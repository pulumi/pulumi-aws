...
class ProjectArgs:
    def __init__(__self__, *,
                 ...
                 badge_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 concurrent_build_limit: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] service_role: Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that
        ...
        :param pulumi.Input[builtins.bool] badge_enabled: Generates a publicly-accessible URL for the projects build badge. Available as
        ...
        :param pulumi.Input[builtins.int] build_timeout: Number of minutes, from 5 to 2160 (36 hours), for AWS CodeBuild to wait until timing out
        ...
        :param pulumi.Input[builtins.int] concurrent_build_limit: Specify a maximum number of concurrent builds for the project. The value
               specified must be greater than 0 and less than the account concurrent running builds limit.
        :param pulumi.Input[builtins.str] description: Short description of the project.
        :param pulumi.Input[builtins.str] encryption_key: AWS Key Management Service (AWS KMS) customer master key (CMK) to be used for encrypting
        ...
        :param pulumi.Input[builtins.str] name: Project's name.
        :param pulumi.Input[builtins.str] project_visibility: Specifies the visibility of the project's builds. Possible values are: `PUBLIC_READ`
        ...
        :param pulumi.Input[builtins.str] source_version: Version of the build input to be built for this project. If not specified, the latest
               version is used.
    ...
    def badge_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def badge_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def concurrent_build_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def concurrent_build_limit(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def project_visibility(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def project_visibility(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "project_visibility", value)

    @property
    @pulumi.getter(name="queuedTimeout")
    def queued_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def queued_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def resource_access_role(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProjectState:
    def __init__(__self__, *,
                 ...
                 badge_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 badge_url: Optional[pulumi.Input[builtins.str]] = None,
                 build_batch_config: Optional[pulumi.Input['ProjectBuildBatchConfigArgs']] = None,
                 build_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 cache: Optional[pulumi.Input['ProjectCacheArgs']] = None,
                 concurrent_build_limit: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the CodeBuild project.
        :param pulumi.Input['ProjectArtifactsArgs'] artifacts: Configuration block. Detailed below.
        :param pulumi.Input[builtins.bool] badge_enabled: Generates a publicly-accessible URL for the projects build badge. Available as
               `badge_url` attribute when enabled.
        :param pulumi.Input[builtins.str] badge_url: URL of the build badge when `badge_enabled` is enabled.
        :param pulumi.Input['ProjectBuildBatchConfigArgs'] build_batch_config: Defines the batch build options for the project.
        :param pulumi.Input[builtins.int] build_timeout: Number of minutes, from 5 to 2160 (36 hours), for AWS CodeBuild to wait until timing out
               any related build that does not get marked as completed. The default is 60 minutes. The `build_timeout` property is
               not available on the `Lambda` compute type.
    ...
    def badge_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @badge_url.setter
    def badge_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def public_project_alias(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_project_alias(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Project(pulumi.CustomResource):
    ...
    pulumi_type = "aws:codebuild/project:Project"
    ...
    @property
    @pulumi.getter(name="badgeEnabled")
    def badge_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Generates a publicly-accessible URL for the projects build badge. Available as
        `badge_url` attribute when enabled.
        """
    ...
    @property
    @pulumi.getter(name="badgeUrl")
    def badge_url(self) -> pulumi.Output[builtins.str]:
        """
        URL of the build badge when `badge_enabled` is enabled.
        """
        return pulumi.get(self, "badge_url")
    ...
    @property
    @pulumi.getter(name="buildTimeout")
    def build_timeout(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of minutes, from 5 to 2160 (36 hours), for AWS CodeBuild to wait until timing out
        any related build that does not get marked as completed. The default is 60 minutes. The `build_timeout` property is
        not available on the `Lambda` compute type.
    ...
    @property
    @pulumi.getter(name="concurrentBuildLimit")
    def concurrent_build_limit(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specify a maximum number of concurrent builds for the project. The value
        specified must be greater than 0 and less than the account concurrent running builds limit.
        """
    ...
    @property
    @pulumi.getter(name="projectVisibility")
    def project_visibility(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the visibility of the project's builds. Possible values are: `PUBLIC_READ`
        and `PRIVATE`. Default value is `PRIVATE`.
        """
    ...
    @property
    @pulumi.getter(name="publicProjectAlias")
    def public_project_alias(self) -> pulumi.Output[builtins.str]:
        """
        The project identifier used with the public build APIs.
        """
        return pulumi.get(self, "public_project_alias")
    ...
    @property
    @pulumi.getter(name="queuedTimeout")
    def queued_timeout(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of minutes, from 5 to 480 (8 hours), a build is allowed to be queued before it
        times out. The default is 8 hours. The `queued_timeout` property is not available on the `Lambda` compute type.
        """
    ...
    @property
    @pulumi.getter(name="resourceAccessRole")
    def resource_access_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the IAM role that enables CodeBuild to access the CloudWatch Logs and
        Amazon S3 artifacts for the project's builds in order to display them publicly. Only applicable if
        `project_visibility` is `PUBLIC_READ`.
    ...
    @property
    @pulumi.getter(name="sourceVersion")
    def source_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Version of the build input to be built for this project. If not specified, the latest
        version is used.
        """
