...
class FleetArgs:
    def __init__(__self__, *,
                 base_capacity: pulumi.Input[builtins.int],
                 ...
                 fleet_service_role: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] base_capacity: Number of machines allocated to the ﬂeet.
        :param pulumi.Input[builtins.str] compute_type: Compute resources the compute fleet uses. See [compute types](https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-compute-types.html#environment.types) for more information and valid values.
        :param pulumi.Input[builtins.str] environment_type: Environment type of the compute fleet. See [environment types](https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-compute-types.html#environment.types) for more information and valid values.
        ...
        :param pulumi.Input[builtins.str] fleet_service_role: The service role associated with the compute fleet.
    ...
    def base_capacity(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def base_capacity(self, value: pulumi.Input[builtins.int]):
    ...
    def fleet_service_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fleet_service_role(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def overflow_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def overflow_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FleetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the Fleet.
        :param pulumi.Input[builtins.int] base_capacity: Number of machines allocated to the ﬂeet.
        :param pulumi.Input['FleetComputeConfigurationArgs'] compute_configuration: The compute configuration of the compute fleet. This is only required if `compute_type` is set to `ATTRIBUTE_BASED_COMPUTE`. See `compute_configuration` below.
        :param pulumi.Input[builtins.str] compute_type: Compute resources the compute fleet uses. See [compute types](https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-compute-types.html#environment.types) for more information and valid values.
        :param pulumi.Input[builtins.str] created: Creation time of the fleet.
        :param pulumi.Input[builtins.str] environment_type: Environment type of the compute fleet. See [environment types](https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-compute-types.html#environment.types) for more information and valid values.
...
class Fleet(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="computeType")
    def compute_type(self) -> pulumi.Output[builtins.str]:
        """
        Compute resources the compute fleet uses. See [compute types](https://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref-compute-types.html#environment.types) for more information and valid values.
        """
        return pulumi.get(self, "compute_type")
    ...
    @property
    @pulumi.getter(name="fleetServiceRole")
    def fleet_service_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The service role associated with the compute fleet.
        """
        return pulumi.get(self, "fleet_service_role")
    ...
    @property
    @pulumi.getter(name="overflowBehavior")
    def overflow_behavior(self) -> pulumi.Output[builtins.str]:
        """
        Overflow behavior for compute fleet. Valid values: `ON_DEMAND`, `QUEUE`.
        """
        return pulumi.get(self, "overflow_behavior")
