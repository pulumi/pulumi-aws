...
class FleetComputeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int disk: Amount of disk space of the instance type included in the fleet.
        :param builtins.str machine_type: Machine type of the instance type included in the fleet. Valid values: `GENERAL`, `NVME`.
        :param builtins.int memory: Amount of memory of the instance type included in the fleet.
        :param builtins.int vcpu: Number of vCPUs of the instance type included in the fleet.
        """
        if disk is not None:
...
class FleetScalingConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 scaling_type: Optional[builtins.str] = None,
                 target_tracking_scaling_configs: Optional[Sequence['outputs.FleetScalingConfigurationTargetTrackingScalingConfig']] = None):
        """
        :param builtins.int max_capacity: Maximum number of instances in the ﬂeet when auto-scaling.
        :param builtins.str scaling_type: Scaling type for a compute fleet. Valid value: `TARGET_TRACKING_SCALING`.
    ...
    def scaling_type(self) -> Optional[builtins.str]:
        """
...
class FleetScalingConfigurationTargetTrackingScalingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str metric_type: Metric type to determine auto-scaling. Valid value: `FLEET_UTILIZATION_RATE`.
        :param builtins.float target_value: Value of metricType when to start scaling.
        """
...
class FleetStatus(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str context: Additional information about a compute fleet.
        :param builtins.str message: Message associated with the status of a compute fleet.
        :param builtins.str status_code: Status code of the compute fleet.
        """
...
class ProjectArtifacts(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 artifact_identifier: Optional[builtins.str] = None,
                 bucket_owner_access: Optional[builtins.str] = None,
                 encryption_disabled: Optional[builtins.bool] = None,
                 location: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 namespace_type: Optional[builtins.str] = None,
                 override_artifact_name: Optional[builtins.bool] = None,
                 packaging: Optional[builtins.str] = None,
                 path: Optional[builtins.str] = None):
        """
        :param builtins.str type: Build output artifact's type. Valid values: `CODEPIPELINE`, `NO_ARTIFACTS`, `S3`.
        :param builtins.str artifact_identifier: Artifact identifier. Must be the same specified inside the AWS CodeBuild build
               specification.
        :param builtins.str bucket_owner_access: Specifies the bucket owner's access for objects that another account uploads to
        ...
        :param builtins.bool encryption_disabled: Whether to disable encrypting output artifacts. If `type` is set to `NO_ARTIFACTS`,
               this value is ignored. Defaults to `false`.
        :param builtins.str location: Information about the build output artifact location. If `type` is set to `CODEPIPELINE` or
               `NO_ARTIFACTS`, this value is ignored. If `type` is set to `S3`, this is the name of the output bucket.
        :param builtins.str name: Name of the project. If `type` is set to `S3`, this is the name of the output artifact object
        :param builtins.str namespace_type: Namespace to use in storing build artifacts. If `type` is set to `S3`, then valid values
               are `BUILD_ID`, `NONE`.
        :param builtins.bool override_artifact_name: Whether a name specified in the build specification overrides the artifact name.
        :param builtins.str packaging: Type of build output artifact to create. If `type` is set to `S3`, valid values are `NONE`,
               `ZIP`
        :param builtins.str path: If `type` is set to `S3`, this is the path to the output artifact.
        """
    ...
    def artifact_identifier(self) -> Optional[builtins.str]:
        """
    ...
    def bucket_owner_access(self) -> Optional[builtins.str]:
        """
    ...
    def encryption_disabled(self) -> Optional[builtins.bool]:
        """
    ...
    def override_artifact_name(self) -> Optional[builtins.bool]:
        """
    ...
    @property
    @pulumi.getter
    def packaging(self) -> Optional[builtins.str]:
        """
...
class ProjectBuildBatchConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 combine_artifacts: Optional[builtins.bool] = None,
                 restrictions: Optional['outputs.ProjectBuildBatchConfigRestrictions'] = None,
                 timeout_in_mins: Optional[builtins.int] = None):
        """
        :param builtins.str service_role: Specifies the service role ARN for the batch build project.
        :param builtins.bool combine_artifacts: Specifies if the build artifacts for the batch build should be combined into a single
               artifact location.
        ...
        :param builtins.int timeout_in_mins: Specifies the maximum amount of time, in minutes, that the batch build must be
               completed in.
        """
    ...
    def combine_artifacts(self) -> Optional[builtins.bool]:
        """
    ...
    def timeout_in_mins(self) -> Optional[builtins.int]:
        """
...
class ProjectBuildBatchConfigRestrictions(dict):
    ...
    def __init__(__self__, *,
                 compute_types_alloweds: Optional[Sequence[builtins.str]] = None,
                 maximum_builds_allowed: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] compute_types_alloweds: An array of strings that specify the compute types that are allowed for the batch
               build.
        ...
        :param builtins.int maximum_builds_allowed: Specifies the maximum number of builds allowed.
        """
    ...
    def compute_types_alloweds(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def maximum_builds_allowed(self) -> Optional[builtins.int]:
        """
...
class ProjectCache(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str location: Location where the AWS CodeBuild project stores cached resources. For
               type `S3`, the value must be a valid S3 bucket name/prefix.
        :param Sequence[builtins.str] modes: Specifies settings that AWS CodeBuild uses to store and reuse build
               dependencies. Valid values:  `LOCAL_SOURCE_CACHE`, `LOCAL_DOCKER_LAYER_CACHE`, `LOCAL_CUSTOM_CACHE`.
        :param builtins.str type: Type of storage that will be used for the AWS CodeBuild project cache. Valid values: `NO_CACHE`,
...
class ProjectEnvironment(dict):
    ...
    def __init__(__self__, *,
                 ...
                 privileged_mode: Optional[builtins.bool] = None,
                 registry_credential: Optional['outputs.ProjectEnvironmentRegistryCredential'] = None):
        """
        :param builtins.str compute_type: Information about the compute resources the build project will use. Valid values:
        ...
        :param builtins.str image: Docker image to use for this build project. Valid values
        ...
        :param builtins.str type: Type of build environment to use for related builds. Valid values: `WINDOWS_CONTAINER` (deprecated), `LINUX_CONTAINER`,
        ...
        :param builtins.bool privileged_mode: Whether to enable running the Docker daemon inside a Docker container. Defaults to
               `false`.
    ...
    def image_pull_credentials_type(self) -> Optional[builtins.str]:
        """
    ...
    def privileged_mode(self) -> Optional[builtins.bool]:
        """
...
class ProjectEnvironmentEnvironmentVariable(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str name: Environment variable's name or key.
        :param builtins.str value: Environment variable's value.
        :param builtins.str type: Type of environment variable. Valid values: `PARAMETER_STORE`, `PLAINTEXT`, `SECRETS_MANAGER`.
        """
        pulumi.set(__self__, "name", name)
...
class ProjectEnvironmentFleet(dict):
    ...
    def __init__(__self__, *,
                 fleet_arn: Optional[builtins.str] = None):
        """
        :param builtins.str fleet_arn: Compute fleet ARN for the build project.
        """
...
class ProjectEnvironmentRegistryCredential(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str credential: ARN or name of credentials created using AWS Secrets Manager.
        :param builtins.str credential_provider: Service that created the credentials to access a private Docker registry. Valid
...
class ProjectFileSystemLocation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str identifier: The name used to access a file system created by Amazon EFS. CodeBuild creates an
        ...
        :param builtins.str location: A string that specifies the location of the file system created by Amazon EFS. Its format is
               `efs-dns-name:/directory-path`.
        :param builtins.str mount_options: The mount options for a file system created by AWS EFS.
        :param builtins.str mount_point: The location in the container where you mount the file system.
        :param builtins.str type: The type of the file system. The one supported type is `EFS`.
        """
...
class ProjectLogsConfigCloudwatchLogs(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str group_name: Group name of the logs in CloudWatch Logs.
        :param builtins.str status: Current status of logs in CloudWatch Logs for a build project. Valid values: `ENABLED`,
               `DISABLED`. Defaults to `ENABLED`.
        :param builtins.str stream_name: Prefix of the log stream name of the logs in CloudWatch Logs.
        """
...
class ProjectLogsConfigS3Logs(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str bucket_owner_access: Specifies the bucket owner's access for objects that another account uploads to
               ...
               `READ_ONLY`, and `FULL`. your CodeBuild service role must have the `s3:PutBucketAcl` permission. This permission
               allows CodeBuild to modify the access control list for the bucket.
        :param builtins.bool encryption_disabled: Whether to disable encrypting S3 logs. Defaults to `false`.
        :param builtins.str location: Name of the S3 bucket and the path prefix for S3 logs. Must be set if status is `ENABLED`,
               otherwise it must be empty.
        :param builtins.str status: Current status of logs in S3 for a build project. Valid values: `ENABLED`, `DISABLED`. Defaults
               to `DISABLED`.
        """
        if bucket_owner_access is not None:
            pulumi.set(__self__, "bucket_owner_access", bucket_owner_access)
...
class ProjectSecondaryArtifact(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str artifact_identifier: Artifact identifier. Must be the same specified inside the AWS CodeBuild build
               specification.
        :param builtins.str type: Build output artifact's type. Valid values `CODEPIPELINE`, `NO_ARTIFACTS`, and `S3`.
        :param builtins.str bucket_owner_access: Specifies the bucket owner's access for objects that another account uploads to
               their Amazon S3 bucket. By default, only the account that uploads the objects to the bucket has access to these
               objects. This property allows you to give the bucket owner access to these objects. Valid values are `NONE`,
        ...
        :param builtins.str name: Name of the project. If `type` is set to `CODEPIPELINE` or `NO_ARTIFACTS`, this value is ignored
               if specified. If `type` is set to `S3`, this is the name of the output artifact object.
        :param builtins.str namespace_type: Namespace to use in storing build artifacts. If `type` is set to `CODEPIPELINE` or
               `NO_ARTIFACTS`, this value is ignored if specified. If `type` is set to `S3`, valid values are `BUILD_ID` or `NONE`.
        :param builtins.bool override_artifact_name: Whether a name specified in the build specification overrides the artifact name.
        :param builtins.str packaging: Type of build output artifact to create. If `type` is set to `CODEPIPELINE` or
               `NO_ARTIFACTS`, this value is ignored if specified. If `type` is set to `S3`, valid values are `NONE` or `ZIP`.
        :param builtins.str path: Along with `namespace_type` and `name`, the pattern that AWS CodeBuild uses to name and store the
...
class ProjectSecondarySource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 buildspec: Optional[builtins.str] = None,
                 git_clone_depth: Optional[builtins.int] = None,
                 git_submodules_config: Optional['outputs.ProjectSecondarySourceGitSubmodulesConfig'] = None,
                 insecure_ssl: Optional[builtins.bool] = None,
                 location: Optional[builtins.str] = None,
                 report_build_status: Optional[builtins.bool] = None):
        """
        :param builtins.str source_identifier: An identifier for this project source. The identifier can only contain alphanumeric
               characters and underscores, and must be less than 128 characters in length.
        :param builtins.str type: Type of repository that contains the source code to be built. Valid values: `BITBUCKET`,
        ...
        :param builtins.str buildspec: The build spec declaration to use for this build project's related builds. This must be set
        ...
        :param builtins.int git_clone_depth: Truncate git history to this many commits. Use `0` for a `Full` checkout which you need
        ...
        :param builtins.bool insecure_ssl: Ignore SSL warnings when connecting to source control.
        :param builtins.str location: Location of the source code from git or s3.
        :param builtins.bool report_build_status: Whether to report the status of a build's start and finish to your source provider.
    ...
    @property
    @pulumi.getter
    def buildspec(self) -> Optional[builtins.str]:
        """
    ...
    def git_clone_depth(self) -> Optional[builtins.int]:
        """
    ...
    def insecure_ssl(self) -> Optional[builtins.bool]:
        """
...
class ProjectSecondarySourceAuth(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str resource: The ARN of the resource to use for authentication. For type `CODECONNECTIONS` this should be
               an AWS CodeStar Connection. For type `SECRETS_MANAGER` this should be an AWS Secrets Manager secret.
        :param builtins.str type: The type of authentication AWS CodeBuild should perform. Valid values are `CODECONNECTIONS` and
               `SECRETS_MANAGER`.
        """
...
class ProjectSecondarySourceBuildStatusConfig(dict):
    ...
    def __init__(__self__, *,
                 context: Optional[builtins.str] = None,
                 target_url: Optional[builtins.str] = None):
        """
        :param builtins.str context: Specifies the context of the build status CodeBuild sends to the source provider. The usage of
               this parameter depends on the source provider.
        :param builtins.str target_url: Specifies the target url of the build status CodeBuild sends to the source provider. The
    ...
    def target_url(self) -> Optional[builtins.str]:
        """
...
class ProjectSecondarySourceGitSubmodulesConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool fetch_submodules: Whether to fetch Git submodules for the AWS CodeBuild build project.
        """
        pulumi.set(__self__, "fetch_submodules", fetch_submodules)

    @property
    @pulumi.getter(name="fetchSubmodules")
    def fetch_submodules(self) -> builtins.bool:
        """
...
class ProjectSecondarySourceVersion(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str source_identifier: An identifier for a source in the build project.
        :param builtins.str source_version: The source version for the corresponding source identifier.
...
class ProjectSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'ProjectSourceBuildStatusConfigArgs' build_status_config: Configuration block that contains information that defines how the build project
               reports the build status to the source provider. This option is only used when the source provider is GitHub, GitHub
               Enterprise, GitLab, GitLab Self Managed, or Bitbucket. `build_status_config` blocks are documented below.
        :param builtins.str buildspec: Build specification to use for this build project's related builds. This must be set when
...
class ProjectVpcConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vpc_id: builtins.str):
        """
        :param Sequence[builtins.str] security_group_ids: Security group IDs to assign to running builds.
        :param Sequence[builtins.str] subnets: Subnet IDs within which to run builds.
        :param builtins.str vpc_id: ID of the VPC within which to run builds.
        """
        pulumi.set(__self__, "security_group_ids", security_group_ids)
        pulumi.set(__self__, "subnets", subnets)
        pulumi.set(__self__, "vpc_id", vpc_id)
...
class ReportGroupExportConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The export configuration type. Valid values are `S3` and `NO_EXPORT`.
...
class ReportGroupExportConfigS3Destination(dict):
    ...
    def __init__(__self__, *,
                 ...
                 path: Optional[builtins.str] = None):
        """
        :param builtins.str bucket: The name of the S3 bucket where the raw data of a report are exported.
        :param builtins.str encryption_key: The encryption key for the report's encrypted raw data. The KMS key ARN.
        :param builtins.bool encryption_disabled: A boolean value that specifies if the results of a report are encrypted.
               **Note: the API does not currently allow setting encryption as disabled**
        :param builtins.str packaging: The type of build output artifact to create. Valid values are: `NONE` (default) and `ZIP`.
        :param builtins.str path: The path to the exported report's raw data results.
        """
...
class WebhookFilterGroupFilter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str,
                 exclude_matched_pattern: Optional[builtins.bool] = None):
        """
        :param builtins.str pattern: For a filter that uses `EVENT` type, a comma-separated string that specifies one event: `PUSH`, `PULL_REQUEST_CREATED`, `PULL_REQUEST_UPDATED`, `PULL_REQUEST_REOPENED`. `PULL_REQUEST_MERGED`, `WORKFLOW_JOB_QUEUED` works with GitHub & GitHub Enterprise only. For a filter that uses any of the other filter types, a regular expression.
        :param builtins.str type: The webhook filter group's type. Valid values for this parameter are: `EVENT`, `BASE_REF`, `HEAD_REF`, `ACTOR_ACCOUNT_ID`, `FILE_PATH`, `COMMIT_MESSAGE`, `WORKFLOW_NAME`, `TAG_NAME`, `RELEASE_NAME`. At least one filter group must specify `EVENT` as its type.
        :param builtins.bool exclude_matched_pattern: If set to `true`, the specified filter does *not* trigger a build. Defaults to `false`.
        """
    ...
    def exclude_matched_pattern(self) -> Optional[builtins.bool]:
        """
...
class WebhookScopeConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of either the enterprise or organization.
        :param builtins.str scope: The type of scope for a GitHub webhook. Valid values for this parameter are: `GITHUB_ORGANIZATION`, `GITHUB_GLOBAL`.
        :param builtins.str domain: The domain of the GitHub Enterprise organization. Required if your project's source type is GITHUB_ENTERPRISE.
        """
        pulumi.set(__self__, "name", name)
...
class GetFleetComputeConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int disk: Amount of disk space of the instance type included in the fleet.
        :param builtins.str machine_type: Machine type of the instance type included in the fleet.
        :param builtins.int memory: Amount of memory of the instance type included in the fleet.
        :param builtins.int vcpu: Number of vCPUs of the instance type included in the fleet.
        """
        pulumi.set(__self__, "disk", disk)
...
class GetFleetScalingConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int desired_capacity: The desired number of instances in the ﬂeet when auto-scaling.
        :param builtins.int max_capacity: The maximum number of instances in the ﬂeet when auto-scaling.
        :param builtins.str scaling_type: The scaling type for a compute fleet.
...
class GetFleetScalingConfigurationTargetTrackingScalingConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str metric_type: The metric type to determine auto-scaling.
        :param builtins.float target_value: The value of metric_type when to start scaling.
        """
        pulumi.set(__self__, "metric_type", metric_type)
        pulumi.set(__self__, "target_value", target_value)
