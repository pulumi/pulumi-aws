...
class ResourceArgs:
    ...
    def hybrid_access_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_service_linked_role(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_service_linked_role(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Resource(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="hybridAccessEnabled")
    def hybrid_access_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Flag to enable AWS LakeFormation hybrid access permission mode.
    ...
    @property
    @pulumi.getter(name="useServiceLinkedRole")
    def use_service_linked_role(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Designates an AWS Identity and Access Management (IAM) service-linked role by registering this role with the Data Catalog.
        """
        return pulumi.get(self, "use_service_linked_role")
