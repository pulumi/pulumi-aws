...
class GetPermissionsResult:
    ...
    def catalog_resource(self) -> Optional[builtins.bool]:
    ...
    def permissions_with_grant_options(self) -> Sequence[builtins.str]:
        """
...
def get_permissions(catalog_id: Optional[builtins.str] = None,
                    catalog_resource: Optional[builtins.bool] = None,
    ...
    :param builtins.str catalog_id: Identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment.
    :param builtins.bool catalog_resource: Whether the permissions are to be granted for the Data Catalog. Defaults to `false`.
...
def get_permissions_output(catalog_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           catalog_resource: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
