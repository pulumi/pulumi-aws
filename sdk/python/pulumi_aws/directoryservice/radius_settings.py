...
class RadiusSettingsArgs:
    def __init__(__self__, *,
                 authentication_protocol: pulumi.Input[builtins.str],
                 directory_id: pulumi.Input[builtins.str],
                 display_label: pulumi.Input[builtins.str],
                 radius_port: pulumi.Input[builtins.int],
                 radius_retries: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.str] authentication_protocol: The protocol specified for your RADIUS endpoints. Valid values: `PAP`, `CHAP`, `MS-CHAPv1`, `MS-CHAPv2`.
        :param pulumi.Input[builtins.str] directory_id: The identifier of the directory for which you want to manager RADIUS settings.
        :param pulumi.Input[builtins.str] display_label: Display label.
        :param pulumi.Input[builtins.int] radius_port: The port that your RADIUS server is using for communications. Your self-managed network must allow inbound traffic over this port from the AWS Directory Service servers.
    ...
    def authentication_protocol(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def authentication_protocol(self, value: pulumi.Input[builtins.str]):
    ...
    def display_label(self) -> pulumi.Input[builtins.str]:
        """
        Display label.
        """
    ...
    def display_label(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "display_label", value)

    @property
    @pulumi.getter(name="radiusPort")
    def radius_port(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @radius_port.setter
    def radius_port(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "radius_port", value)

    @property
    @pulumi.getter(name="radiusRetries")
    def radius_retries(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def radius_retries(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "radius_retries", value)

    @property
    @pulumi.getter(name="radiusServers")
    def radius_servers(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def radius_servers(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "radius_servers", value)

    @property
    @pulumi.getter(name="radiusTimeout")
    def radius_timeout(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def radius_timeout(self, value: pulumi.Input[builtins.int]):
    ...
    def use_same_username(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _RadiusSettingsState:
    def __init__(__self__, *,
                 authentication_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 directory_id: Optional[pulumi.Input[builtins.str]] = None,
                 display_label: Optional[pulumi.Input[builtins.str]] = None,
                 radius_port: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="authenticationProtocol")
    def authentication_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The protocol specified for your RADIUS endpoints. Valid values: `PAP`, `CHAP`, `MS-CHAPv1`, `MS-CHAPv2`.
        """
        return pulumi.get(self, "authentication_protocol")
    ...
    @authentication_protocol.setter
    def authentication_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authentication_protocol", value)
    ...
    @property
    @pulumi.getter(name="displayLabel")
    def display_label(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Display label.
        """
        return pulumi.get(self, "display_label")
    ...
    @display_label.setter
    def display_label(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "display_label", value)

    @property
    @pulumi.getter(name="radiusPort")
    def radius_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The port that your RADIUS server is using for communications. Your self-managed network must allow inbound traffic over this port from the AWS Directory Service servers.
        """
        return pulumi.get(self, "radius_port")
    ...
    @radius_port.setter
    def radius_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "radius_port", value)

    @property
    @pulumi.getter(name="radiusRetries")
    def radius_retries(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of times that communication with the RADIUS server is attempted. Minimum value of `0`. Maximum value of `10`.
        """
        return pulumi.get(self, "radius_retries")
    ...
    @radius_retries.setter
    def radius_retries(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "radius_retries", value)

    @property
    @pulumi.getter(name="radiusServers")
    def radius_servers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of strings that contains the fully qualified domain name (FQDN) or IP addresses of the RADIUS server endpoints, or the FQDN or IP addresses of your RADIUS server load balancer.
        """
        return pulumi.get(self, "radius_servers")
    ...
    @radius_servers.setter
    def radius_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "radius_servers", value)

    @property
    @pulumi.getter(name="radiusTimeout")
    def radius_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The amount of time, in seconds, to wait for the RADIUS server to respond. Minimum value of `1`. Maximum value of `50`.
        """
        return pulumi.get(self, "radius_timeout")
    ...
    @radius_timeout.setter
    def radius_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "radius_timeout", value)
...
class RadiusSettings(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="authenticationProtocol")
    def authentication_protocol(self) -> pulumi.Output[builtins.str]:
        """
        The protocol specified for your RADIUS endpoints. Valid values: `PAP`, `CHAP`, `MS-CHAPv1`, `MS-CHAPv2`.
        """
        return pulumi.get(self, "authentication_protocol")
    ...
    @property
    @pulumi.getter(name="displayLabel")
    def display_label(self) -> pulumi.Output[builtins.str]:
        """
        Display label.
        """
        return pulumi.get(self, "display_label")
    ...
    @property
    @pulumi.getter(name="radiusPort")
    def radius_port(self) -> pulumi.Output[builtins.int]:
        """
        The port that your RADIUS server is using for communications. Your self-managed network must allow inbound traffic over this port from the AWS Directory Service servers.
        """
        return pulumi.get(self, "radius_port")
    ...
    @property
    @pulumi.getter(name="radiusRetries")
    def radius_retries(self) -> pulumi.Output[builtins.int]:
        """
        The maximum number of times that communication with the RADIUS server is attempted. Minimum value of `0`. Maximum value of `10`.
        """
        return pulumi.get(self, "radius_retries")
    ...
    @property
    @pulumi.getter(name="radiusServers")
    def radius_servers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        An array of strings that contains the fully qualified domain name (FQDN) or IP addresses of the RADIUS server endpoints, or the FQDN or IP addresses of your RADIUS server load balancer.
        """
        return pulumi.get(self, "radius_servers")
    ...
    @property
    @pulumi.getter(name="radiusTimeout")
    def radius_timeout(self) -> pulumi.Output[builtins.int]:
        """
        The amount of time, in seconds, to wait for the RADIUS server to respond. Minimum value of `1`. Maximum value of `50`.
        """
        return pulumi.get(self, "radius_timeout")
    ...
    @property
    @pulumi.getter(name="useSameUsername")
    def use_same_username(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Not currently used.
        """
        return pulumi.get(self, "use_same_username")
