...
class TrustArgs:
    def __init__(__self__, *,
                 ...
                 remote_domain_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] trust_direction: The direction of the Trust relationship.
               Valid values are `One-Way: Outgoing`, `One-Way: Incoming`, and `Two-Way`.
        :param pulumi.Input[builtins.str] trust_password: Password for the Trust.
        ...
        :param pulumi.Input[builtins.str] trust_type: Type of the Trust relationship.
    ...
    def remote_domain_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def remote_domain_name(self, value: pulumi.Input[builtins.str]):
    ...
    def trust_password(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def trust_password(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "trust_password", value)

    @property
    @pulumi.getter(name="conditionalForwarderIpAddrs")
    def conditional_forwarder_ip_addrs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def conditional_forwarder_ip_addrs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "conditional_forwarder_ip_addrs", value)

    @property
    @pulumi.getter(name="deleteAssociatedConditionalForwarder")
    def delete_associated_conditional_forwarder(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_associated_conditional_forwarder(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def selective_auth(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TrustState:
    def __init__(__self__, *,
                 conditional_forwarder_ip_addrs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 created_date_time: Optional[pulumi.Input[builtins.str]] = None,
                 delete_associated_conditional_forwarder: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 trust_password: Optional[pulumi.Input[builtins.str]] = None,
                 trust_state: Optional[pulumi.Input[builtins.str]] = None,
                 trust_state_reason: Optional[pulumi.Input[builtins.str]] = None,
                 trust_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Trust resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] conditional_forwarder_ip_addrs: Set of IPv4 addresses for the DNS server associated with the remote Directory.
               Can contain between 1 and 4 values.
        :param pulumi.Input[builtins.str] created_date_time: Date and time when the Trust was created.
        :param pulumi.Input[builtins.bool] delete_associated_conditional_forwarder: Whether to delete the conditional forwarder when deleting the Trust relationship.
        :param pulumi.Input[builtins.str] directory_id: ID of the Directory.
        ...
        :param pulumi.Input[builtins.str] selective_auth: Whether to enable selective authentication.
               Valid values are `Enabled` and `Disabled`.
               Default value is `Disabled`.
        :param pulumi.Input[builtins.str] state_last_updated_date_time: Date and time when the Trust state in `trust_state` was last updated.
        :param pulumi.Input[builtins.str] trust_direction: The direction of the Trust relationship.
               Valid values are `One-Way: Outgoing`, `One-Way: Incoming`, and `Two-Way`.
        :param pulumi.Input[builtins.str] trust_password: Password for the Trust.
               Does not need to match the passwords for either Directory.
               Can contain upper- and lower-case letters, numbers, and punctuation characters.
               May be up to 128 characters long.
        :param pulumi.Input[builtins.str] trust_state: State of the Trust relationship.
               One of `Created`, `VerifyFailed`,`Verified`, `UpdateFailed`,`Updated`,`Deleted`, or `Failed`.
        :param pulumi.Input[builtins.str] trust_state_reason: Reason for the Trust state set in `trust_state`.
        :param pulumi.Input[builtins.str] trust_type: Type of the Trust relationship.
               Valid values are `Forest` and `External`.
               Default value is `Forest`.
        """
    ...
    def created_date_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def created_date_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def last_updated_date_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @property
    @pulumi.getter(name="remoteDomainName")
    def remote_domain_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Fully qualified domain name of the remote Directory.
        """
        return pulumi.get(self, "remote_domain_name")
    ...
    @remote_domain_name.setter
    def remote_domain_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remote_domain_name", value)
    ...
    def state_last_updated_date_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def state_last_updated_date_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="trustPassword")
    def trust_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Password for the Trust.
        Does not need to match the passwords for either Directory.
        Can contain upper- and lower-case letters, numbers, and punctuation characters.
    ...
    @trust_password.setter
    def trust_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trust_password", value)

    @property
    @pulumi.getter(name="trustState")
    def trust_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @trust_state.setter
    def trust_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trust_state", value)

    @property
    @pulumi.getter(name="trustStateReason")
    def trust_state_reason(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def trust_state_reason(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Trust(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            trust_state: Optional[pulumi.Input[builtins.str]] = None,
            trust_state_reason: Optional[pulumi.Input[builtins.str]] = None,
            trust_type: Optional[pulumi.Input[builtins.str]] = None) -> 'Trust':
        """
    ...
    @property
    @pulumi.getter(name="conditionalForwarderIpAddrs")
    def conditional_forwarder_ip_addrs(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Set of IPv4 addresses for the DNS server associated with the remote Directory.
        Can contain between 1 and 4 values.
        """
    ...
    @property
    @pulumi.getter(name="deleteAssociatedConditionalForwarder")
    def delete_associated_conditional_forwarder(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to delete the conditional forwarder when deleting the Trust relationship.
        """
        return pulumi.get(self, "delete_associated_conditional_forwarder")
    ...
    @property
    @pulumi.getter(name="lastUpdatedDateTime")
    def last_updated_date_time(self) -> pulumi.Output[builtins.str]:
        """
        Date and time when the Trust was last updated.
        """
        return pulumi.get(self, "last_updated_date_time")
    ...
    @property
    @pulumi.getter(name="remoteDomainName")
    def remote_domain_name(self) -> pulumi.Output[builtins.str]:
        """
        Fully qualified domain name of the remote Directory.
        """
        return pulumi.get(self, "remote_domain_name")
    ...
    @property
    @pulumi.getter(name="selectiveAuth")
    def selective_auth(self) -> pulumi.Output[builtins.str]:
        """
        Whether to enable selective authentication.
        Valid values are `Enabled` and `Disabled`.
        Default value is `Disabled`.
    ...
    @property
    @pulumi.getter(name="stateLastUpdatedDateTime")
    def state_last_updated_date_time(self) -> pulumi.Output[builtins.str]:
        """
        Date and time when the Trust state in `trust_state` was last updated.
        """
        return pulumi.get(self, "state_last_updated_date_time")
    ...
    @property
    @pulumi.getter(name="trustPassword")
    def trust_password(self) -> pulumi.Output[builtins.str]:
        """
        Password for the Trust.
        Does not need to match the passwords for either Directory.
        Can contain upper- and lower-case letters, numbers, and punctuation characters.
    ...
    @property
    @pulumi.getter(name="trustState")
    def trust_state(self) -> pulumi.Output[builtins.str]:
        """
        State of the Trust relationship.
        One of `Created`, `VerifyFailed`,`Verified`, `UpdateFailed`,`Updated`,`Deleted`, or `Failed`.
        """
    ...
    @property
    @pulumi.getter(name="trustStateReason")
    def trust_state_reason(self) -> pulumi.Output[builtins.str]:
        """
        Reason for the Trust state set in `trust_state`.
        """
        return pulumi.get(self, "trust_state_reason")
