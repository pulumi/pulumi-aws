...
class DirectoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alias: The alias for the directory (must be unique amongst all aliases in AWS). Required for `enable_sso`.
        ...
        :param pulumi.Input[builtins.str] description: A textual description for the directory.
        ...
        :param pulumi.Input[builtins.str] type: The directory type (`SimpleAD`, `ADConnector` or `MicrosoftAD` are accepted values). Defaults to `SimpleAD`.
    ...
    def desired_number_of_domain_controllers(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def desired_number_of_domain_controllers(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def enable_sso(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @enable_sso.setter
    def enable_sso(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DirectoryState:
    def __init__(__self__, *,
                 access_url: Optional[pulumi.Input[builtins.str]] = None,
                 alias: Optional[pulumi.Input[builtins.str]] = None,
                 connect_settings: Optional[pulumi.Input['DirectoryConnectSettingsArgs']] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 desired_number_of_domain_controllers: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] access_url: The access URL for the directory, such as `http://alias.awsapps.com`.
        :param pulumi.Input[builtins.str] alias: The alias for the directory (must be unique amongst all aliases in AWS). Required for `enable_sso`.
        :param pulumi.Input['DirectoryConnectSettingsArgs'] connect_settings: Connector related information about the directory. Fields documented below.
        :param pulumi.Input[builtins.str] description: A textual description for the directory.
        :param pulumi.Input[builtins.int] desired_number_of_domain_controllers: The number of domain controllers desired in the directory. Minimum value of `2`. Scaling of domain controllers is only supported for `MicrosoftAD` directories.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_ip_addresses: A list of IP addresses of the DNS servers for the directory or connector.
        :param pulumi.Input[builtins.str] edition: The MicrosoftAD edition (`Standard` or `Enterprise`). Defaults to `Enterprise`.
        :param pulumi.Input[builtins.bool] enable_sso: Whether to enable single-sign on for the directory. Requires `alias`. Defaults to `false`.
        :param pulumi.Input[builtins.str] name: The fully qualified name for the directory, such as `corp.example.com`
        :param pulumi.Input[builtins.str] password: The password for the directory administrator or connector user.
    ...
    def access_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @access_url.setter
    def access_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Directory(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="accessUrl")
    def access_url(self) -> pulumi.Output[builtins.str]:
        """
        The access URL for the directory, such as `http://alias.awsapps.com`.
        """
        return pulumi.get(self, "access_url")
    ...
    @property
    @pulumi.getter(name="desiredNumberOfDomainControllers")
    def desired_number_of_domain_controllers(self) -> pulumi.Output[builtins.int]:
        """
        The number of domain controllers desired in the directory. Minimum value of `2`. Scaling of domain controllers is only supported for `MicrosoftAD` directories.
        """
        return pulumi.get(self, "desired_number_of_domain_controllers")
    ...
    @property
    @pulumi.getter(name="enableSso")
    def enable_sso(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable single-sign on for the directory. Requires `alias`. Defaults to `false`.
        """
        return pulumi.get(self, "enable_sso")
