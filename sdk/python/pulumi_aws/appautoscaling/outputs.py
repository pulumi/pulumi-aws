...
class PolicyStepScalingPolicyConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 metric_aggregation_type: Optional[builtins.str] = None,
                 min_adjustment_magnitude: Optional[builtins.int] = None,
                 step_adjustments: Optional[Sequence['outputs.PolicyStepScalingPolicyConfigurationStepAdjustment']] = None):
        """
        :param builtins.str adjustment_type: Whether the adjustment is an absolute number or a percentage of the current capacity. Valid values are `ChangeInCapacity`, `ExactCapacity`, and `PercentChangeInCapacity`.
        :param builtins.int cooldown: Amount of time, in seconds, after a scaling activity completes and before the next scaling activity can start.
        :param builtins.str metric_aggregation_type: Aggregation type for the policy's metrics. Valid values are "Minimum", "Maximum", and "Average". Without a value, AWS will treat the aggregation type as "Average".
        :param builtins.int min_adjustment_magnitude: Minimum number to adjust your scalable dimension as a result of a scaling activity. If the adjustment type is PercentChangeInCapacity, the scaling policy changes the scalable dimension of the scalable target by this amount.
    ...
    def metric_aggregation_type(self) -> Optional[builtins.str]:
        """
    ...
    def min_adjustment_magnitude(self) -> Optional[builtins.int]:
        """
...
class PolicyStepScalingPolicyConfigurationStepAdjustment(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int scaling_adjustment: Number of members by which to scale, when the adjustment bounds are breached. A positive value scales up. A negative value scales down.
        :param builtins.str metric_interval_lower_bound: Lower bound for the difference between the alarm threshold and the CloudWatch metric. Without a value, AWS will treat this bound as negative infinity.
        :param builtins.str metric_interval_upper_bound: Upper bound for the difference between the alarm threshold and the CloudWatch metric. Without a value, AWS will treat this bound as infinity. The upper bound must be greater than the lower bound.
        """
...
class PolicyTargetTrackingScalingPolicyConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool disable_scale_in: Whether scale in by the target tracking policy is disabled. If the value is true, scale in is disabled and the target tracking policy won't remove capacity from the scalable resource. Otherwise, scale in is enabled and the target tracking policy can remove capacity from the scalable resource. The default value is `false`.
...
class PolicyTargetTrackingScalingPolicyConfigurationCustomizedMetricSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str statistic: Statistic of the metric. Valid values: `Average`, `Minimum`, `Maximum`, `SampleCount`, and `Sum`.
...
class ScheduledActionScalableTargetAction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_capacity: Maximum capacity. At least one of `max_capacity` or `min_capacity` must be set.
        :param builtins.int min_capacity: Minimum capacity. At least one of `min_capacity` or `max_capacity` must be set.
        """
...
class TargetSuspendedState(dict):
    ...
    def __init__(__self__, *,
                 dynamic_scaling_in_suspended: Optional[builtins.bool] = None,
                 dynamic_scaling_out_suspended: Optional[builtins.bool] = None,
                 scheduled_scaling_suspended: Optional[builtins.bool] = None):
        """
        :param builtins.bool dynamic_scaling_in_suspended: Whether scale in by a target tracking scaling policy or a step scaling policy is suspended. Default is `false`.
        :param builtins.bool dynamic_scaling_out_suspended: Whether scale out by a target tracking scaling policy or a step scaling policy is suspended. Default is `false`.
        :param builtins.bool scheduled_scaling_suspended: Whether scheduled scaling is suspended. Default is `false`.
        """
    ...
    def dynamic_scaling_in_suspended(self) -> Optional[builtins.bool]:
        """
    ...
    def dynamic_scaling_out_suspended(self) -> Optional[builtins.bool]:
        """
    ...
    def scheduled_scaling_suspended(self) -> Optional[builtins.bool]:
        """
