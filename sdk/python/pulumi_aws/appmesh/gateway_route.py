...
class _GatewayRouteState:
    def __init__(__self__, *,
                 ...
                 spec: pulumi.Input[Optional['GatewayRouteSpecArgs']] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def spec(self) -> pulumi.Input[Optional['GatewayRouteSpecArgs']]:
        """
        Gateway route specification to apply.
        """
        return pulumi.get(self, "spec")
    ...
    @spec.setter
    def spec(self, value: pulumi.Input[Optional['GatewayRouteSpecArgs']]):
        pulumi.set(self, "spec", value)
    ...
    @_builtins.property
    @pulumi.getter(name="virtualGatewayName")
    def virtual_gateway_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Name of the virtual gateway to associate the gateway route with. Must be between 1 and 255 characters in length.
        """
        return pulumi.get(self, "virtual_gateway_name")
    ...
    @virtual_gateway_name.setter
    def virtual_gateway_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "virtual_gateway_name", value)
