...
class GatewayRouteArgs:
    def __init__(__self__, *,
                 ...
                 virtual_gateway_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] mesh_name: Name of the service mesh in which to create the gateway route. Must be between 1 and 255 characters in length.
        :param pulumi.Input['GatewayRouteSpecArgs'] spec: Gateway route specification to apply.
        :param pulumi.Input[builtins.str] virtual_gateway_name: Name of the virtual gateway to associate the gateway route with. Must be between 1 and 255 characters in length.
        ...
        :param pulumi.Input[builtins.str] name: Name to use for the gateway route. Must be between 1 and 255 characters in length.
    ...
    def virtual_gateway_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def virtual_gateway_name(self, value: pulumi.Input[builtins.str]):
...
class _GatewayRouteState:
    def __init__(__self__, *,
                 ...
                 virtual_gateway_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering GatewayRoute resources.
        :param pulumi.Input[builtins.str] arn: ARN of the gateway route.
        :param pulumi.Input[builtins.str] created_date: Creation date of the gateway route.
        :param pulumi.Input[builtins.str] last_updated_date: Last update date of the gateway route.
        :param pulumi.Input[builtins.str] mesh_name: Name of the service mesh in which to create the gateway route. Must be between 1 and 255 characters in length.
        :param pulumi.Input[builtins.str] mesh_owner: AWS account ID of the service mesh's owner. Defaults to the account ID the AWS provider is currently connected to.
        :param pulumi.Input[builtins.str] name: Name to use for the gateway route. Must be between 1 and 255 characters in length.
    ...
    @property
    @pulumi.getter(name="virtualGatewayName")
    def virtual_gateway_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the virtual gateway to associate the gateway route with. Must be between 1 and 255 characters in length.
        """
        return pulumi.get(self, "virtual_gateway_name")
    ...
    @virtual_gateway_name.setter
    def virtual_gateway_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "virtual_gateway_name", value)
...
class GatewayRoute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            virtual_gateway_name: Optional[pulumi.Input[builtins.str]] = None) -> 'GatewayRoute':
        """
    ...
    @property
    @pulumi.getter(name="virtualGatewayName")
    def virtual_gateway_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the virtual gateway to associate the gateway route with. Must be between 1 and 255 characters in length.
        """
        return pulumi.get(self, "virtual_gateway_name")
