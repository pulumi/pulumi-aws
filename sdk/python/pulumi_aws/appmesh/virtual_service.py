...
class VirtualServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] mesh_name: Name of the service mesh in which to create the virtual service. Must be between 1 and 255 characters in length.
        ...
        :param pulumi.Input[builtins.str] name: Name to use for the virtual service. Must be between 1 and 255 characters in length.
...
class _VirtualServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the virtual service.
        :param pulumi.Input[builtins.str] created_date: Creation date of the virtual service.
        :param pulumi.Input[builtins.str] last_updated_date: Last update date of the virtual service.
        :param pulumi.Input[builtins.str] mesh_name: Name of the service mesh in which to create the virtual service. Must be between 1 and 255 characters in length.
        :param pulumi.Input[builtins.str] mesh_owner: AWS account ID of the service mesh's owner. Defaults to the account ID the AWS provider is currently connected to.
        :param pulumi.Input[builtins.str] name: Name to use for the virtual service. Must be between 1 and 255 characters in length.
...
class VirtualService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            spec: Optional[pulumi.Input[Union['VirtualServiceSpecArgs', 'VirtualServiceSpecArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'VirtualService':
        """
