...
class VirtualNode(pulumi.CustomResource):
    ...
    The virtual node specification to apply.
      ...
      * `backends` (`list`) - The backends to which the virtual node is expected to send outbound traffic.
        ...
        * `virtual_service` (`dict`) - Specifies a virtual service to use as a backend for a virtual node.
    
          * `virtual_service_name` (`str`) - The name of the virtual service that is acting as a virtual node backend.
      ...
      * `listener` (`dict`) - The listeners from which the virtual node is expected to receive inbound traffic.
        ...
        * `health_check` (`dict`) - The health check information for the listener.
          ...
          * `healthy_threshold` (`float`) - The number of consecutive successful health checks that must occur before declaring listener healthy.
          ...
          * `timeout_millis` (`float`) - The amount of time to wait when receiving a response from the health check, in milliseconds.
          * `unhealthy_threshold` (`float`) - The number of consecutive failed health checks that must occur before declaring a virtual node unhealthy.
      ...
      * `logging` (`dict`) - The inbound and outbound access logging information for the virtual node.
        ...
        * `access_log` (`dict`) - The access log configuration for a virtual node.
    
          * `file` (`dict`) - The file object to send virtual node access logs to.
    
            * `path` (`str`) - The destination path for the health check request. This is only required if the specified protocol is `http`.
    
      * `service_discovery` (`dict`) - The service discovery information for the virtual node.
    
        * `aws_cloud_map` (`dict`) - Specifies any AWS Cloud Map information for the virtual node.
          ...
          * `namespace_name` (`str`) - The name of the AWS Cloud Map namespace to use.
        ...
        * Replace the `backends` attribute of the `spec` object with one or more `backend` configuration blocks,
        ...
        The **spec** object supports the following:
          ...
          * `backends` (`pulumi.Input[list]`) - The backends to which the virtual node is expected to send outbound traffic.
            ...
            * `virtual_service` (`pulumi.Input[dict]`) - Specifies a virtual service to use as a backend for a virtual node.
        
              * `virtual_service_name` (`pulumi.Input[str]`) - The name of the virtual service that is acting as a virtual node backend.
          ...
          * `listener` (`pulumi.Input[dict]`) - The listeners from which the virtual node is expected to receive inbound traffic.
            ...
            * `health_check` (`pulumi.Input[dict]`) - The health check information for the listener.
              ...
              * `healthy_threshold` (`pulumi.Input[float]`) - The number of consecutive successful health checks that must occur before declaring listener healthy.
                * `interval_millis`- (Required) The time period in milliseconds between each health check execution.
              ...
              * `timeout_millis` (`pulumi.Input[float]`) - The amount of time to wait when receiving a response from the health check, in milliseconds.
              * `unhealthy_threshold` (`pulumi.Input[float]`) - The number of consecutive failed health checks that must occur before declaring a virtual node unhealthy.
          ...
          * `logging` (`pulumi.Input[dict]`) - The inbound and outbound access logging information for the virtual node.
            ...
            * `access_log` (`pulumi.Input[dict]`) - The access log configuration for a virtual node.
        
              * `file` (`pulumi.Input[dict]`) - The file object to send virtual node access logs to.
        
                * `path` (`pulumi.Input[str]`) - The destination path for the health check request. This is only required if the specified protocol is `http`.
        
          * `service_discovery` (`pulumi.Input[dict]`) - The service discovery information for the virtual node.
        
            * `aws_cloud_map` (`pulumi.Input[dict]`) - Specifies any AWS Cloud Map information for the virtual node.
              ...
              * `namespace_name` (`pulumi.Input[str]`) - The name of the AWS Cloud Map namespace to use.
                Use the [`servicediscovery.HttpNamespace`](https://www.terraform.io/docs/providers/aws/r/service_discovery_http_namespace.html) resource to configure a Cloud Map namespace.
