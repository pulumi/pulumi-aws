...
class GatewayRouteSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int priority: Priority for the gateway route, between `0` and `1000`.
        """
...
class GatewayRouteSpecGrpcRouteActionTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int port: The port number that corresponds to the target for Virtual Service provider port. This is required when the provider (router or node) of the Virtual Service has multiple listeners.
        """
...
class GatewayRouteSpecGrpcRouteActionTargetVirtualService(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str virtual_service_name: Name of the virtual service that traffic is routed to. Must be between 1 and 255 characters in length.
        """
...
class GatewayRouteSpecGrpcRouteMatch(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port: Optional[builtins.int] = None):
        """
        :param builtins.str service_name: Fully qualified domain name for the service to match from the request.
        :param builtins.int port: The port number to match from the request.
        """
...
class GatewayRouteSpecHttp2RouteActionRewriteHostname(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str default_target_hostname: Default target host name to write to. Valid values: `ENABLED`, `DISABLED`.
        """
...
class GatewayRouteSpecHttp2RouteActionRewritePath(dict):
    def __init__(__self__, *,
                 exact: builtins.str):
        """
        :param builtins.str exact: The exact path to match on.
        """
...
class GatewayRouteSpecHttp2RouteActionRewritePrefix(dict):
    ...
    def __init__(__self__, *,
                 default_prefix: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str default_prefix: Default prefix used to replace the incoming route prefix when rewritten. Valid values: `ENABLED`, `DISABLED`.
        :param builtins.str value: Value used to replace the incoming route prefix when rewritten.
        """
    ...
    def default_prefix(self) -> Optional[builtins.str]:
        """
...
class GatewayRouteSpecHttp2RouteMatch(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int port: The port number to match from the request.
        :param builtins.str prefix: Path to match requests with. This parameter must always start with `/`, which by itself matches all requests to the virtual service name.
...
class GatewayRouteSpecHttp2RouteMatchHeader(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name for the HTTP header in the client request that will be matched on.
        :param builtins.bool invert: If `true`, the match is on the opposite of the `match` method and value. Default is `false`.
...
class GatewayRouteSpecHttp2RouteMatchHeaderMatch(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str exact: Header value sent by the client must match the specified value exactly.
        :param builtins.str prefix: Header value sent by the client must begin with the specified characters.
        ...
        :param builtins.str regex: Header value sent by the client must include the specified characters.
        :param builtins.str suffix: Header value sent by the client must end with the specified characters.
        """
...
class GatewayRouteSpecHttp2RouteMatchHeaderMatchRange(dict):
    def __init__(__self__, *,
                 ...
                 start: builtins.int):
        """
        :param builtins.int end: End of the range.
        :param builtins.int start: Start of the range.
        """
...
class GatewayRouteSpecHttp2RouteMatchHostname(dict):
    def __init__(__self__, *,
                 ...
                 suffix: Optional[builtins.str] = None):
        """
        :param builtins.str exact: Exact host name to match on.
        :param builtins.str suffix: Specified ending characters of the host name to match on.
        """
        if exact is not None:
            pulumi.set(__self__, "exact", exact)
        if suffix is not None:
...
class GatewayRouteSpecHttp2RouteMatchPath(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str exact: The exact path to match on.
        :param builtins.str regex: The regex used to match the path.
        """
        if exact is not None:
            pulumi.set(__self__, "exact", exact)
        if regex is not None:
...
class GatewayRouteSpecHttp2RouteMatchQueryParameter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name for the query parameter that will be matched on.
...
class GatewayRouteSpecHttp2RouteMatchQueryParameterMatch(dict):
    def __init__(__self__, *,
                 exact: Optional[builtins.str] = None):
        """
        :param builtins.str exact: The exact query parameter to match on.
        """
        if exact is not None:
            pulumi.set(__self__, "exact", exact)
...
class MeshSpecEgressFilter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Egress filter type. By default, the type is `DROP_ALL`. Valid values are `ALLOW_ALL` and `DROP_ALL`.
        """
        if type is not None:
...
class MeshSpecServiceDiscovery(dict):
    ...
    def __init__(__self__, *,
                 ip_preference: Optional[builtins.str] = None):
        """
        :param builtins.str ip_preference: The IP version to use to control traffic within the mesh. Valid values are `IPv6_PREFERRED`, `IPv4_PREFERRED`, `IPv4_ONLY`, and `IPv6_ONLY`.
        """
    ...
    def ip_preference(self) -> Optional[builtins.str]:
        """
...
class RouteSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int priority: Priority for the route, between `0` and `1000`.
...
class RouteSpecGrpcRouteActionWeightedTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port: Optional[builtins.int] = None):
        """
        :param builtins.str virtual_node: Virtual node to associate with the weighted target. Must be between 1 and 255 characters in length.
        :param builtins.int weight: Relative weight of the weighted target. An integer between 0 and 100.
        :param builtins.int port: The targeted port of the weighted object.
        """
...
class RouteSpecGrpcRouteMatch(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str method_name: Method name to match from the request. If you specify a name, you must also specify a `service_name`.
        :param builtins.int port: The port number to match from the request.
        :param builtins.str service_name: Fully qualified domain name for the service to match from the request.
        """
...
class RouteSpecGrpcRouteMatchMetadata(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the route. Must be between 1 and 50 characters in length.
        :param builtins.bool invert: If `true`, the match is on the opposite of the `match` criteria. Default is `false`.
...
class RouteSpecGrpcRouteMatchMetadataMatch(dict):
    def __init__(__self__, *,
                 ...
                 suffix: Optional[builtins.str] = None):
        """
        :param builtins.str exact: Value sent by the client must match the specified value exactly. Must be between 1 and 255 characters in length.
        :param builtins.str prefix: Value sent by the client must begin with the specified characters. Must be between 1 and 255 characters in length.
        ...
        :param builtins.str regex: Value sent by the client must include the specified characters. Must be between 1 and 255 characters in length.
        :param builtins.str suffix: Value sent by the client must end with the specified characters. Must be between 1 and 255 characters in length.
        """
        if exact is not None:
            pulumi.set(__self__, "exact", exact)
        if prefix is not None:
...
class RouteSpecGrpcRouteRetryPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 grpc_retry_events: Optional[Sequence[builtins.str]] = None,
                 http_retry_events: Optional[Sequence[builtins.str]] = None,
                 tcp_retry_events: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.int max_retries: Maximum number of retries.
        :param 'RouteSpecGrpcRouteRetryPolicyPerRetryTimeoutArgs' per_retry_timeout: Per-retry timeout.
        :param Sequence[builtins.str] grpc_retry_events: List of gRPC retry events.
               Valid values: `cancelled`, `deadline-exceeded`, `internal`, `resource-exhausted`, `unavailable`.
        :param Sequence[builtins.str] http_retry_events: List of HTTP retry events.
               Valid values: `client-error` (HTTP status code 409), `gateway-error` (HTTP status codes 502, 503, and 504), `server-error` (HTTP status codes 500, 501, 502, 503, 504, 505, 506, 507, 508, 510, and 511), `stream-error` (retry on refused stream).
        :param Sequence[builtins.str] tcp_retry_events: List of TCP retry events. The only valid value is `connection-error`.
        """
    ...
    def grpc_retry_events(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def http_retry_events(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def tcp_retry_events(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RouteSpecGrpcRouteRetryPolicyPerRetryTimeout(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.int):
        """
        :param builtins.str unit: Retry unit. Valid values: `ms`, `s`.
        :param builtins.int value: Retry value.
        """
...
class RouteSpecGrpcRouteTimeoutIdle(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.int):
        """
        :param builtins.str unit: Unit of time. Valid values: `ms`, `s`.
        :param builtins.int value: Number of time units. Minimum value of `0`.
        """
        pulumi.set(__self__, "unit", unit)
        pulumi.set(__self__, "value", value)
...
class RouteSpecHttp2RouteMatch(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str method: Client request header method to match on. Valid values: `GET`, `HEAD`, `POST`, `PUT`, `DELETE`, `CONNECT`, `OPTIONS`, `TRACE`, `PATCH`.
        :param 'RouteSpecHttp2RouteMatchPathArgs' path: Client request path to match on.
        :param builtins.int port: The port number to match from the request.
        :param builtins.str prefix: Path with which to match requests.
        ...
        :param builtins.str scheme: Client request header scheme to match on. Valid values: `http`, `https`.
        """
        if headers is not None:
            pulumi.set(__self__, "headers", headers)
...
class VirtualGatewaySpecBackendDefaultsClientPolicyTls(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool enforce: Whether the policy is enforced. Default is `true`.
        :param Sequence[builtins.int] ports: One or more ports that the policy is enforced for.
        """
...
class VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateFile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_chain: Certificate trust chain for a certificate stored on the file system of the mesh endpoint that the proxy is running on. Must be between 1 and 255 characters in length.
        :param builtins.str private_key: Private key for a certificate stored on the file system of the mesh endpoint that the proxy is running on. Must be between 1 and 255 characters in length.
        """
...
class VirtualGatewaySpecBackendDefaultsClientPolicyTlsCertificateSds(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str secret_name: Name of the secret for a virtual gateway's Transport Layer Security (TLS) Secret Discovery Service validation context trust.
        """
...
class VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationSubjectAlternativeNamesMatch(dict):
    def __init__(__self__, *,
                 exacts: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] exacts: Values sent must match the specified values exactly.
        """
        pulumi.set(__self__, "exacts", exacts)

    @property
    @pulumi.getter
    def exacts(self) -> Sequence[builtins.str]:
        """
...
class VirtualGatewaySpecBackendDefaultsClientPolicyTlsValidationTrustAcm(dict):
    ...
    def __init__(__self__, *,
                 certificate_authority_arns: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] certificate_authority_arns: One or more ACM ARNs.
        """
        pulumi.set(__self__, "certificate_authority_arns", certificate_authority_arns)

    @property
    @pulumi.getter(name="certificateAuthorityArns")
    def certificate_authority_arns(self) -> Sequence[builtins.str]:
        """
...
class VirtualGatewaySpecListenerConnectionPoolGrpc(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_requests: Maximum number of inflight requests Envoy can concurrently support across hosts in upstream cluster. Minimum value of `1`.
        """
...
class VirtualGatewaySpecListenerConnectionPoolHttp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int max_connections: Maximum number of outbound TCP connections Envoy can establish concurrently with all hosts in upstream cluster. Minimum value of `1`.
        :param builtins.int max_pending_requests: Number of overflowing requests after `max_connections` Envoy will queue to upstream cluster. Minimum value of `1`.
        """
...
class VirtualGatewaySpecListenerHealthCheck(dict):
    ...
    def __init__(__self__, *,
                 ...
                 port: Optional[builtins.int] = None):
        """
        :param builtins.int healthy_threshold: Number of consecutive successful health checks that must occur before declaring listener healthy.
        :param builtins.int interval_millis: Time period in milliseconds between each health check execution.
        :param builtins.str protocol: Protocol for the health check request. Valid values are `http`, `http2`, and `grpc`.
        :param builtins.int timeout_millis: Amount of time to wait when receiving a response from the health check, in milliseconds.
        :param builtins.int unhealthy_threshold: Number of consecutive failed health checks that must occur before declaring a virtual gateway unhealthy.
        :param builtins.str path: Destination path for the health check request. This is only required if the specified protocol is `http` or `http2`.
        :param builtins.int port: Destination port for the health check request. This port must match the port defined in the `port_mapping` for the listener.
        """
    ...
    def interval_millis(self) -> builtins.int:
        """
    ...
    def timeout_millis(self) -> builtins.int:
        """
...
class VirtualGatewaySpecListenerPortMapping(dict):
    def __init__(__self__, *,
                 ...
                 protocol: builtins.str):
        """
        :param builtins.int port: Port used for the port mapping.
        :param builtins.str protocol: Protocol used for the port mapping. Valid values are `http`, `http2`, `tcp` and `grpc`.
        """
        pulumi.set(__self__, "port", port)
        pulumi.set(__self__, "protocol", protocol)
...
class VirtualGatewaySpecListenerTls(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str mode: Listener's TLS mode. Valid values: `DISABLED`, `PERMISSIVE`, `STRICT`.
...
class VirtualGatewaySpecListenerTlsCertificateAcm(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_arn: ARN for the certificate.
        """
...
class VirtualGatewaySpecLoggingAccessLogFile(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str path: File path to write access logs to. You can use `/dev/stdout` to send access logs to standard out. Must be between 1 and 255 characters in length.
...
class VirtualGatewaySpecLoggingAccessLogFileFormat(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str text: The logging format for text. Must be between 1 and 1000 characters in length.
        """
...
class VirtualGatewaySpecLoggingAccessLogFileFormatJson(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The specified key for the JSON. Must be between 1 and 100 characters in length.
        :param builtins.str value: The specified value for the JSON. Must be between 1 and 100 characters in length.
        """
...
class VirtualNodeSpecBackendDefaultsClientPolicyTlsCertificateFile(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_chain: Certificate trust chain for a certificate stored on the file system of the mesh endpoint that the proxy is running on. Must be between 1 and 255 characters in length.
        :param builtins.str private_key: Private key for a certificate stored on the file system of the virtual node that the proxy is running on. Must be between 1 and 255 characters in length.
        """
        pulumi.set(__self__, "certificate_chain", certificate_chain)
        pulumi.set(__self__, "private_key", private_key)
...
class VirtualNodeSpecBackendDefaultsClientPolicyTlsCertificateSds(dict):
    ...
    def __init__(__self__, *,
                 secret_name: builtins.str):
        """
        :param builtins.str secret_name: Name of the secret for a virtual node's Transport Layer Security (TLS) Secret Discovery Service validation context trust.
        """
        pulumi.set(__self__, "secret_name", secret_name)
...
class VirtualNodeSpecBackendVirtualService(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str virtual_service_name: Name of the virtual service that is acting as a virtual node backend. Must be between 1 and 255 characters in length.
...
class VirtualNodeSpecListenerHealthCheck(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int healthy_threshold: Number of consecutive successful health checks that must occur before declaring listener healthy.
        :param builtins.int interval_millis: Time period in milliseconds between each health check execution.
        :param builtins.str protocol: Protocol for the health check request. Valid values are `http`, `http2`, `tcp` and `grpc`.
        :param builtins.int timeout_millis: Amount of time to wait when receiving a response from the health check, in milliseconds.
        :param builtins.int unhealthy_threshold: Number of consecutive failed health checks that must occur before declaring a virtual node unhealthy.
        :param builtins.str path: Destination path for the health check request. This is only required if the specified protocol is `http` or `http2`.
        :param builtins.int port: Destination port for the health check request. This port must match the port defined in the `port_mapping` for the listener.
        """
        pulumi.set(__self__, "healthy_threshold", healthy_threshold)
...
class VirtualNodeSpecListenerOutlierDetection(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_server_errors: builtins.int):
        """
        ...
        :param builtins.int max_ejection_percent: Maximum percentage of hosts in load balancing pool for upstream service that can be ejected. Will eject at least one host regardless of the value.
               Minimum value of `0`. Maximum value of `100`.
        :param builtins.int max_server_errors: Number of consecutive `5xx` errors required for ejection. Minimum value of `1`.
        """
    ...
    def max_server_errors(self) -> builtins.int:
        """
...
class VirtualNodeSpecServiceDiscoveryAwsCloudMap(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str namespace_name: Name of the AWS Cloud Map namespace to use.
        ...
        :param builtins.str service_name: Name of the AWS Cloud Map service to use. Use the `servicediscovery.Service` resource to configure a Cloud Map service. Must be between 1 and 1024 characters in length.
        :param Mapping[str, builtins.str] attributes: String map that contains attributes with values that you can use to filter instances by any custom attribute that you specified when you registered the instance. Only instances that match all of the specified key/value pairs will be returned.
        """
...
class VirtualNodeSpecServiceDiscoveryDns(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str hostname: DNS host name for your virtual node.
        :param builtins.str ip_preference: The preferred IP version that this virtual node uses. Valid values: `IPv6_PREFERRED`, `IPv4_PREFERRED`, `IPv4_ONLY`, `IPv6_ONLY`.
        :param builtins.str response_type: The DNS response type for the virtual node. Valid values: `LOADBALANCER`, `ENDPOINTS`.
        """
        pulumi.set(__self__, "hostname", hostname)
        if ip_preference is not None:
            pulumi.set(__self__, "ip_preference", ip_preference)
...
class VirtualServiceSpecProviderVirtualNode(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str virtual_node_name: Name of the virtual node that is acting as a service provider. Must be between 1 and 255 characters in length.
        """
...
class VirtualServiceSpecProviderVirtualRouter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str virtual_router_name: Name of the virtual router that is acting as a service provider. Must be between 1 and 255 characters in length.
        """
...
class GetGatewayRouteSpecHttp2RouteMatchHeaderResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str name: Name of the gateway route.
        """
        pulumi.set(__self__, "invert", invert)
        pulumi.set(__self__, "matches", matches)
        pulumi.set(__self__, "name", name)
...
class GetRouteSpecGrpcRouteRetryPolicyResult(dict):
    def __init__(__self__, *,
                 grpc_retry_events: Sequence[builtins.str],
                 http_retry_events: Sequence[builtins.str],
                 max_retries: builtins.int,
                 per_retry_timeouts: Sequence['outputs.GetRouteSpecGrpcRouteRetryPolicyPerRetryTimeoutResult'],
                 tcp_retry_events: Sequence[builtins.str]):
        pulumi.set(__self__, "grpc_retry_events", grpc_retry_events)
        pulumi.set(__self__, "http_retry_events", http_retry_events)
        pulumi.set(__self__, "max_retries", max_retries)
    ...
    @property
    @pulumi.getter(name="grpcRetryEvents")
    def grpc_retry_events(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "grpc_retry_events")

    @property
    @pulumi.getter(name="httpRetryEvents")
    def http_retry_events(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "http_retry_events")
    ...
    @property
    @pulumi.getter(name="tcpRetryEvents")
    def tcp_retry_events(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "tcp_retry_events")
...
class GetVirtualGatewaySpecListenerConnectionPoolHttpResult(dict):
    ...
    @property
    @pulumi.getter(name="maxPendingRequests")
    def max_pending_requests(self) -> builtins.int:
        return pulumi.get(self, "max_pending_requests")
