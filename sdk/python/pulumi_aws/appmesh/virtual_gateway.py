...
class VirtualGateway(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] name: The name to use for the virtual gateway.
    ...
    def get(resource_name: str,
            ...
            spec: Optional[pulumi.Input[pulumi.InputType['VirtualGatewaySpecArgs']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None) -> 'VirtualGateway':
        """
