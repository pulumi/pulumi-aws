...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy: An IAM policy. The policy string in JSON must not contain newlines or blank lines.
        :param pulumi.Input[builtins.str] resource_arn: The ID or Amazon Resource Name (ARN) of the service network or service for which the policy is created.
        """
...
@pulumi.type_token("aws:vpclattice/resourcePolicy:ResourcePolicy")
