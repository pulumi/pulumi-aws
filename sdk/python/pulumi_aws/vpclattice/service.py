...
class ServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_arn: Amazon Resource Name (ARN) of the certificate.
        :param pulumi.Input[builtins.str] custom_domain_name: Custom domain name of the service.
        :param pulumi.Input[builtins.str] name: Name of the service. The name must be unique within the account. The valid characters are a-z, 0-9, and hyphens (-). You can't use a hyphen as the first or last character, or immediately after another hyphen.Must be between 3 and 40 characters in length.
...
class _ServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the service.
        :param pulumi.Input[builtins.str] auth_type: Type of IAM policy. Either `NONE` or `AWS_IAM`.
        :param pulumi.Input[builtins.str] certificate_arn: Amazon Resource Name (ARN) of the certificate.
        :param pulumi.Input[builtins.str] custom_domain_name: Custom domain name of the service.
        ...
        :param pulumi.Input[builtins.str] name: Name of the service. The name must be unique within the account. The valid characters are a-z, 0-9, and hyphens (-). You can't use a hyphen as the first or last character, or immediately after another hyphen.Must be between 3 and 40 characters in length.
               ...
               The following arguments are optional:
        :param pulumi.Input[builtins.str] status: Status of the service.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value mapping of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
...
class Service(pulumi.CustomResource):
    ...
    pulumi_type = "aws:vpclattice/service:Service"
