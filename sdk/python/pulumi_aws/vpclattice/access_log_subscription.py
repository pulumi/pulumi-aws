...
class AccessLogSubscriptionArgs:
    ...
    def service_network_log_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AccessLogSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            service_network_log_type: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'AccessLogSubscription':
        """
    ...
    @property
    @pulumi.getter(name="serviceNetworkLogType")
    def service_network_log_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of log that monitors your Amazon VPC Lattice service networks. Valid values are: `SERVICE`, `RESOURCE`. Defaults to `SERVICE`.
        """
        return pulumi.get(self, "service_network_log_type")
