...
def get_partition(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Identifier of the current partition (e.g., `aws` in AWS Commercial, `aws-cn` in AWS China).
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_partition_output(id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
