...
class Disk_attachmentArgs:
    def __init__(__self__, *,
                 ...
                 disk_path: pulumi.Input[_builtins.str],
    ...
    @disk_path.setter
    def disk_path(self, value: pulumi.Input[_builtins.str]):
...
class Disk_attachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Using `pulumi import`, import `lightsail.Disk_attachment` using the id attribute. For example:
    ...
    def get(resource_name: str,
            ...
            disk_path: Optional[pulumi.Input[_builtins.str]] = None,
            instance_name: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'Disk_attachment':
        """
