...
class ContainerService(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if private_registry_access is not None and not isinstance(private_registry_access, ContainerServicePrivateRegistryAccessArgs):
                private_registry_access = private_registry_access or {}
                def _setter(key, value):
                    private_registry_access[key] = value
                ContainerServicePrivateRegistryAccessArgs._configure(_setter, **private_registry_access)
            __props__.__dict__["private_registry_access"] = private_registry_access
            if public_domain_names is not None and not isinstance(public_domain_names, ContainerServicePublicDomainNamesArgs):
                public_domain_names = public_domain_names or {}
                def _setter(key, value):
                    public_domain_names[key] = value
                ContainerServicePublicDomainNamesArgs._configure(_setter, **public_domain_names)
