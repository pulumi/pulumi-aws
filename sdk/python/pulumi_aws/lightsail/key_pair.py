...
class KeyPairArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: The name of the Lightsail Key Pair. If omitted, a unique name will be generated by this provider
        :param pulumi.Input[builtins.str] pgp_key: An optional PGP key to encrypt the resulting private key material. Only used when creating a new key pair
        :param pulumi.Input[builtins.str] public_key: The public key material. This public key will be imported into Lightsail
...
class _KeyPairState:
    def __init__(__self__, *,
                 ...
                 encrypted_fingerprint: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the Lightsail key pair.
        :param pulumi.Input[builtins.str] encrypted_fingerprint: The MD5 public key fingerprint for the encrypted private key.
        :param pulumi.Input[builtins.str] encrypted_private_key: the private key material, base 64 encoded and encrypted with the given `pgp_key`. This is only populated when creating a new key and `pgp_key` is supplied.
        :param pulumi.Input[builtins.str] fingerprint: The MD5 public key fingerprint as specified in section 4 of RFC 4716.
        :param pulumi.Input[builtins.str] name: The name of the Lightsail Key Pair. If omitted, a unique name will be generated by this provider
        :param pulumi.Input[builtins.str] pgp_key: An optional PGP key to encrypt the resulting private key material. Only used when creating a new key pair
        :param pulumi.Input[builtins.str] private_key: the private key, base64 encoded. This is only populated when creating a new key, and when no `pgp_key` is provided.
        :param pulumi.Input[builtins.str] public_key: The public key material. This public key will be imported into Lightsail
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the collection. To create a key-only tag, use an empty string as the value. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    def encrypted_fingerprint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encrypted_fingerprint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KeyPair(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            public_key: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'KeyPair':
        """
    ...
    @property
    @pulumi.getter(name="encryptedFingerprint")
    def encrypted_fingerprint(self) -> pulumi.Output[builtins.str]:
        """
        The MD5 public key fingerprint for the encrypted private key.
        """
        return pulumi.get(self, "encrypted_fingerprint")
