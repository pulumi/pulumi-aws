...
class _LbCertificateState:
    def __init__(__self__, *,
                 ...
                 domain_name: pulumi.Input[Optional[_builtins.str]] = None,
                 domain_validation_records: pulumi.Input[Optional[Sequence[pulumi.Input['LbCertificateDomainValidationRecordArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subject_alternative_names: Set of domains that should be SANs in the issued certificate. `domain_name` attribute is automatically added as a Subject Alternative Name.
        :param pulumi.Input[_builtins.str] support_code: Support code for the certificate.
        """
        if arn is not None:
    ...
    def domain_validation_records(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LbCertificateDomainValidationRecordArgs']]]]):
...
class LbCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Using `pulumi import`, import `lightsail.LbCertificate` using the id attribute. For example:
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            subject_alternative_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            support_code: pulumi.Input[Optional[_builtins.str]] = None) -> 'LbCertificate':
        """
