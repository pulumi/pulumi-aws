...
class DistributionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] bundle_id: The bundle ID to use for the distribution.
        :param pulumi.Input['DistributionDefaultCacheBehaviorArgs'] default_cache_behavior: An object that describes the default cache behavior of the distribution.
        :param pulumi.Input['DistributionOriginArgs'] origin: An object that describes the origin resource of the distribution, such as a Lightsail instance, bucket, or load balancer.
        :param pulumi.Input['DistributionCacheBehaviorSettingsArgs'] cache_behavior_settings: An object that describes the cache behavior settings of the distribution.
        :param pulumi.Input[Sequence[pulumi.Input['DistributionCacheBehaviorArgs']]] cache_behaviors: An array of objects that describe the per-path cache behavior of the distribution.
        :param pulumi.Input[_builtins.str] certificate_name: The name of the SSL/TLS certificate attached to the distribution, if any.
        :param pulumi.Input[_builtins.str] ip_address_type: The IP address type of the distribution.
        :param pulumi.Input[_builtins.bool] is_enabled: Indicates whether the distribution is enabled.
        :param pulumi.Input[_builtins.str] name: The name of the distribution.
        """
...
class _DistributionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] alternative_domain_names: The alternate domain names of the distribution.
        :param pulumi.Input[_builtins.str] arn: The Amazon Resource Name (ARN) of the distribution.
        :param pulumi.Input[_builtins.str] bundle_id: The bundle ID to use for the distribution.
        :param pulumi.Input['DistributionCacheBehaviorSettingsArgs'] cache_behavior_settings: An object that describes the cache behavior settings of the distribution.
        :param pulumi.Input[Sequence[pulumi.Input['DistributionCacheBehaviorArgs']]] cache_behaviors: An array of objects that describe the per-path cache behavior of the distribution.
        :param pulumi.Input[_builtins.str] certificate_name: The name of the SSL/TLS certificate attached to the distribution, if any.
        :param pulumi.Input[_builtins.str] created_at: The timestamp when the distribution was created.
        :param pulumi.Input['DistributionDefaultCacheBehaviorArgs'] default_cache_behavior: An object that describes the default cache behavior of the distribution.
        :param pulumi.Input[_builtins.str] domain_name: The domain name of the distribution.
        :param pulumi.Input[_builtins.str] ip_address_type: The IP address type of the distribution.
        :param pulumi.Input[_builtins.bool] is_enabled: Indicates whether the distribution is enabled.
        :param pulumi.Input[Sequence[pulumi.Input['DistributionLocationArgs']]] locations: An object that describes the location of the distribution, such as the AWS Region and Availability Zone.
        :param pulumi.Input[_builtins.str] name: The name of the distribution.
        :param pulumi.Input['DistributionOriginArgs'] origin: An object that describes the origin resource of the distribution, such as a Lightsail instance, bucket, or load balancer.
        :param pulumi.Input[_builtins.str] origin_public_dns: The public DNS of the origin.
        :param pulumi.Input[_builtins.str] resource_type: The Lightsail resource type (e.g., Distribution).
        :param pulumi.Input[_builtins.str] status: The status of the distribution.
        :param pulumi.Input[_builtins.str] support_code: The support code. Include this code in your email to support when you have questions about your Lightsail distribution. This code enables our support team to look up your Lightsail information more easily.
        """
...
class Distribution(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] bundle_id: The bundle ID to use for the distribution.
        :param pulumi.Input[Union['DistributionCacheBehaviorSettingsArgs', 'DistributionCacheBehaviorSettingsArgsDict']] cache_behavior_settings: An object that describes the cache behavior settings of the distribution.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DistributionCacheBehaviorArgs', 'DistributionCacheBehaviorArgsDict']]]] cache_behaviors: An array of objects that describe the per-path cache behavior of the distribution.
        :param pulumi.Input[_builtins.str] certificate_name: The name of the SSL/TLS certificate attached to the distribution, if any.
        :param pulumi.Input[Union['DistributionDefaultCacheBehaviorArgs', 'DistributionDefaultCacheBehaviorArgsDict']] default_cache_behavior: An object that describes the default cache behavior of the distribution.
        :param pulumi.Input[_builtins.str] ip_address_type: The IP address type of the distribution.
        :param pulumi.Input[_builtins.bool] is_enabled: Indicates whether the distribution is enabled.
        :param pulumi.Input[_builtins.str] name: The name of the distribution.
        :param pulumi.Input[Union['DistributionOriginArgs', 'DistributionOriginArgsDict']] origin: An object that describes the origin resource of the distribution, such as a Lightsail instance, bucket, or load balancer.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[_builtins.str] ip_address_type: The IP address type of the distribution.
        :param pulumi.Input[_builtins.bool] is_enabled: Indicates whether the distribution is enabled.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DistributionLocationArgs', 'DistributionLocationArgsDict']]]] locations: An object that describes the location of the distribution, such as the AWS Region and Availability Zone.
        :param pulumi.Input[_builtins.str] name: The name of the distribution.
        :param pulumi.Input[Union['DistributionOriginArgs', 'DistributionOriginArgsDict']] origin: An object that describes the origin resource of the distribution, such as a Lightsail instance, bucket, or load balancer.
        :param pulumi.Input[_builtins.str] origin_public_dns: The public DNS of the origin.
        :param pulumi.Input[_builtins.str] resource_type: The Lightsail resource type (e.g., Distribution).
