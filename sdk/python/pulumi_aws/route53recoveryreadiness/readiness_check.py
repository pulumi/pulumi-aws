...
class ReadinessCheckArgs:
    def __init__(__self__, *,
                 readiness_check_name: pulumi.Input[builtins.str],
                 resource_set_name: pulumi.Input[builtins.str],
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ReadinessCheck resource.
        :param pulumi.Input[builtins.str] readiness_check_name: Unique name describing the readiness check.
        :param pulumi.Input[builtins.str] resource_set_name: Name describing the resource set that will be monitored for readiness.
    ...
    def readiness_check_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def readiness_check_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "readiness_check_name", value)

    @property
    @pulumi.getter(name="resourceSetName")
    def resource_set_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_set_name(self, value: pulumi.Input[builtins.str]):
...
class _ReadinessCheckState:
    def __init__(__self__, *,
                 ...
                 readiness_check_name: Optional[pulumi.Input[builtins.str]] = None,
                 resource_set_name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering ReadinessCheck resources.
        :param pulumi.Input[builtins.str] arn: ARN of the readiness_check
        :param pulumi.Input[builtins.str] readiness_check_name: Unique name describing the readiness check.
        :param pulumi.Input[builtins.str] resource_set_name: Name describing the resource set that will be monitored for readiness.
    ...
    @property
    @pulumi.getter(name="readinessCheckName")
    def readiness_check_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique name describing the readiness check.
        """
        return pulumi.get(self, "readiness_check_name")
    ...
    @readiness_check_name.setter
    def readiness_check_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "readiness_check_name", value)

    @property
    @pulumi.getter(name="resourceSetName")
    def resource_set_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name describing the resource set that will be monitored for readiness.
    ...
    @resource_set_name.setter
    def resource_set_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_set_name", value)
...
class ReadinessCheck(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_set_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ReadinessCheck':
        """
    ...
    @property
    @pulumi.getter(name="readinessCheckName")
    def readiness_check_name(self) -> pulumi.Output[builtins.str]:
        """
        Unique name describing the readiness check.
        """
        return pulumi.get(self, "readiness_check_name")
    ...
    @property
    @pulumi.getter(name="resourceSetName")
    def resource_set_name(self) -> pulumi.Output[builtins.str]:
        """
        Name describing the resource set that will be monitored for readiness.
