...
class CellArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if cell_name is None and 'cellName' in kwargs:
            cell_name = kwargs['cellName']
        if cell_name is None:
            raise TypeError("Missing 'cell_name' argument")
...
class _CellState:
    def __init__(__self__, *,
        ...
        """
        _CellState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            arn=arn,
            cell_name=cell_name,
            cells=cells,
            parent_readiness_scopes=parent_readiness_scopes,
            tags=tags,
            tags_all=tags_all,
        )
    @staticmethod
    def _configure(
        ...
        if cell_name is None and 'cellName' in kwargs:
            cell_name = kwargs['cellName']
        if parent_readiness_scopes is None and 'parentReadinessScopes' in kwargs:
            parent_readiness_scopes = kwargs['parentReadinessScopes']
        ...
        if parent_readiness_scopes is not None:
            _setter("parent_readiness_scopes", parent_readiness_scopes)
        if tags is not None:
            _setter("tags", tags)
