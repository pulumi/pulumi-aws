...
class AccountSettingsMinimumThroughputBillingCommitment(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str earliest_allowed_end_at: Earliest timestamp when the commitment can be ended.
        :param _builtins.str ended_at: Timestamp when the commitment was ended.
        :param _builtins.str started_at: Timestamp when the commitment was started.
        :param _builtins.str status_actual: Current status of the minimum throughput billing commitment. Values: `ENABLED`, `DISABLED`, `ENABLED_UNTIL_EARLIEST_ALLOWED_END`.
        """
...
class FirehoseDeliveryStreamExtendedS3ConfigurationDynamicPartitioningConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 retry_duration: Optional[_builtins.int] = None):
        """
        :param _builtins.bool enabled: Enables or disables dynamic partitioning. Defaults to `false`.
        :param _builtins.int retry_duration: Total amount of seconds Firehose spends on retries. Valid values between 0 and 7200. Default is 300.
...
class GetStreamStreamModeDetailResult(dict):
    def __init__(__self__, *,
                 stream_mode: _builtins.str):
        """
        :param _builtins.str stream_mode: Capacity mode of the stream. Either `ON_DEMAND` or `PROVISIONED`.
        """
        pulumi.set(__self__, "stream_mode", stream_mode)
