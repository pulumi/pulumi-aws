...
class FirehoseDeliveryStreamArgs:
    ...
    def _configure(
        ...
        if 'splunkConfiguration' in kwargs:
...
class FirehoseDeliveryStream(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if elasticsearch_configuration is not None and not isinstance(elasticsearch_configuration, FirehoseDeliveryStreamElasticsearchConfigurationArgs):
                elasticsearch_configuration = elasticsearch_configuration or {}
                def _setter(key, value):
                    elasticsearch_configuration[key] = value
                FirehoseDeliveryStreamElasticsearchConfigurationArgs._configure(_setter, **elasticsearch_configuration)
            __props__.__dict__["elasticsearch_configuration"] = elasticsearch_configuration
            if extended_s3_configuration is not None and not isinstance(extended_s3_configuration, FirehoseDeliveryStreamExtendedS3ConfigurationArgs):
                extended_s3_configuration = extended_s3_configuration or {}
                def _setter(key, value):
                    extended_s3_configuration[key] = value
                FirehoseDeliveryStreamExtendedS3ConfigurationArgs._configure(_setter, **extended_s3_configuration)
            __props__.__dict__["extended_s3_configuration"] = extended_s3_configuration
            if http_endpoint_configuration is not None and not isinstance(http_endpoint_configuration, FirehoseDeliveryStreamHttpEndpointConfigurationArgs):
                http_endpoint_configuration = http_endpoint_configuration or {}
                def _setter(key, value):
                    http_endpoint_configuration[key] = value
                FirehoseDeliveryStreamHttpEndpointConfigurationArgs._configure(_setter, **http_endpoint_configuration)
            __props__.__dict__["http_endpoint_configuration"] = http_endpoint_configuration
            if kinesis_source_configuration is not None and not isinstance(kinesis_source_configuration, FirehoseDeliveryStreamKinesisSourceConfigurationArgs):
                kinesis_source_configuration = kinesis_source_configuration or {}
                def _setter(key, value):
                    kinesis_source_configuration[key] = value
                FirehoseDeliveryStreamKinesisSourceConfigurationArgs._configure(_setter, **kinesis_source_configuration)
            __props__.__dict__["kinesis_source_configuration"] = kinesis_source_configuration
            if msk_source_configuration is not None and not isinstance(msk_source_configuration, FirehoseDeliveryStreamMskSourceConfigurationArgs):
                msk_source_configuration = msk_source_configuration or {}
                def _setter(key, value):
                    msk_source_configuration[key] = value
                FirehoseDeliveryStreamMskSourceConfigurationArgs._configure(_setter, **msk_source_configuration)
            __props__.__dict__["msk_source_configuration"] = msk_source_configuration
            __props__.__dict__["name"] = name
            if opensearch_configuration is not None and not isinstance(opensearch_configuration, FirehoseDeliveryStreamOpensearchConfigurationArgs):
                opensearch_configuration = opensearch_configuration or {}
                def _setter(key, value):
                    opensearch_configuration[key] = value
                FirehoseDeliveryStreamOpensearchConfigurationArgs._configure(_setter, **opensearch_configuration)
            __props__.__dict__["opensearch_configuration"] = opensearch_configuration
            if opensearchserverless_configuration is not None and not isinstance(opensearchserverless_configuration, FirehoseDeliveryStreamOpensearchserverlessConfigurationArgs):
                opensearchserverless_configuration = opensearchserverless_configuration or {}
                def _setter(key, value):
                    opensearchserverless_configuration[key] = value
                FirehoseDeliveryStreamOpensearchserverlessConfigurationArgs._configure(_setter, **opensearchserverless_configuration)
            __props__.__dict__["opensearchserverless_configuration"] = opensearchserverless_configuration
            if redshift_configuration is not None and not isinstance(redshift_configuration, FirehoseDeliveryStreamRedshiftConfigurationArgs):
                redshift_configuration = redshift_configuration or {}
                def _setter(key, value):
                    redshift_configuration[key] = value
                FirehoseDeliveryStreamRedshiftConfigurationArgs._configure(_setter, **redshift_configuration)
            __props__.__dict__["redshift_configuration"] = redshift_configuration
            if server_side_encryption is not None and not isinstance(server_side_encryption, FirehoseDeliveryStreamServerSideEncryptionArgs):
                server_side_encryption = server_side_encryption or {}
                def _setter(key, value):
                    server_side_encryption[key] = value
                FirehoseDeliveryStreamServerSideEncryptionArgs._configure(_setter, **server_side_encryption)
            __props__.__dict__["server_side_encryption"] = server_side_encryption
            if splunk_configuration is not None and not isinstance(splunk_configuration, FirehoseDeliveryStreamSplunkConfigurationArgs):
                splunk_configuration = splunk_configuration or {}
                def _setter(key, value):
                    splunk_configuration[key] = value
                FirehoseDeliveryStreamSplunkConfigurationArgs._configure(_setter, **splunk_configuration)
