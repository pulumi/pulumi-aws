...
class StreamArgs:
    ...
    def _configure(
        ...
        if 'enforceConsumerDeletion' in kwargs:
        ...
        if 'shardLevelMetrics' in kwargs:
...
class Stream(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if stream_mode_details is not None and not isinstance(stream_mode_details, StreamStreamModeDetailsArgs):
                stream_mode_details = stream_mode_details or {}
                def _setter(key, value):
                    stream_mode_details[key] = value
                StreamStreamModeDetailsArgs._configure(_setter, **stream_mode_details)
