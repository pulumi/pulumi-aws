...
class FleetArgs:
    def __init__(__self__, *,
                 audit_stream_arn: Optional[pulumi.Input[builtins.str]] = None,
                 device_ca_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 optimize_for_end_user_location: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Fleet resource.
        :param pulumi.Input[builtins.str] audit_stream_arn: The ARN of the Amazon Kinesis data stream that receives the audit events. Kinesis data stream name must begin with `"AmazonWorkLink-"`.
        :param pulumi.Input[builtins.str] device_ca_certificate: The certificate chain, including intermediate certificates and the root certificate authority certificate used to issue device certificates.
        :param pulumi.Input[builtins.str] display_name: The name of the fleet.
        ...
        :param pulumi.Input[builtins.str] name: A region-unique name for the AMI.
        ...
        :param pulumi.Input[builtins.bool] optimize_for_end_user_location: The option to optimize for better performance by routing traffic through the closest AWS Region to users, which may be outside of your home Region. Defaults to `true`.
    ...
    def audit_stream_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def audit_stream_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "audit_stream_arn", value)

    @property
    @pulumi.getter(name="deviceCaCertificate")
    def device_ca_certificate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def device_ca_certificate(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def optimize_for_end_user_location(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def optimize_for_end_user_location(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _FleetState:
    def __init__(__self__, *,
                 ...
                 audit_stream_arn: Optional[pulumi.Input[builtins.str]] = None,
                 company_code: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the created WorkLink Fleet.
        :param pulumi.Input[builtins.str] audit_stream_arn: The ARN of the Amazon Kinesis data stream that receives the audit events. Kinesis data stream name must begin with `"AmazonWorkLink-"`.
        :param pulumi.Input[builtins.str] company_code: The identifier used by users to sign in to the Amazon WorkLink app.
        :param pulumi.Input[builtins.str] created_time: The time that the fleet was created.
        :param pulumi.Input[builtins.str] device_ca_certificate: The certificate chain, including intermediate certificates and the root certificate authority certificate used to issue device certificates.
        :param pulumi.Input[builtins.str] display_name: The name of the fleet.
        :param pulumi.Input['FleetIdentityProviderArgs'] identity_provider: Provide this to allow manage the identity provider configuration for the fleet. Fields documented below.
        :param pulumi.Input[builtins.str] last_updated_time: The time that the fleet was last updated.
        :param pulumi.Input[builtins.str] name: A region-unique name for the AMI.
        :param pulumi.Input['FleetNetworkArgs'] network: Provide this to allow manage the company network configuration for the fleet. Fields documented below.
        :param pulumi.Input[builtins.bool] optimize_for_end_user_location: The option to optimize for better performance by routing traffic through the closest AWS Region to users, which may be outside of your home Region. Defaults to `true`.
    ...
    def company_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @company_code.setter
    def company_code(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Fleet(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 device_ca_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 identity_provider: Optional[pulumi.Input[Union['FleetIdentityProviderArgs', 'FleetIdentityProviderArgsDict']]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 network: Optional[pulumi.Input[Union['FleetNetworkArgs', 'FleetNetworkArgsDict']]] = None,
                 optimize_for_end_user_location: Optional[pulumi.Input[builtins.bool]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[builtins.str] device_ca_certificate: The certificate chain, including intermediate certificates and the root certificate authority certificate used to issue device certificates.
        :param pulumi.Input[builtins.str] display_name: The name of the fleet.
        :param pulumi.Input[Union['FleetIdentityProviderArgs', 'FleetIdentityProviderArgsDict']] identity_provider: Provide this to allow manage the identity provider configuration for the fleet. Fields documented below.
        :param pulumi.Input[builtins.str] name: A region-unique name for the AMI.
        :param pulumi.Input[Union['FleetNetworkArgs', 'FleetNetworkArgsDict']] network: Provide this to allow manage the company network configuration for the fleet. Fields documented below.
        :param pulumi.Input[builtins.bool] optimize_for_end_user_location: The option to optimize for better performance by routing traffic through the closest AWS Region to users, which may be outside of your home Region. Defaults to `true`.
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            network: Optional[pulumi.Input[Union['FleetNetworkArgs', 'FleetNetworkArgsDict']]] = None,
            optimize_for_end_user_location: Optional[pulumi.Input[builtins.bool]] = None) -> 'Fleet':
        """
    ...
    @property
    @pulumi.getter(name="auditStreamArn")
    def audit_stream_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the Amazon Kinesis data stream that receives the audit events. Kinesis data stream name must begin with `"AmazonWorkLink-"`.
        """
        return pulumi.get(self, "audit_stream_arn")
    ...
    @property
    @pulumi.getter(name="companyCode")
    def company_code(self) -> pulumi.Output[builtins.str]:
        """
        The identifier used by users to sign in to the Amazon WorkLink app.
        """
        return pulumi.get(self, "company_code")
    ...
    @property
    @pulumi.getter(name="deviceCaCertificate")
    def device_ca_certificate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The certificate chain, including intermediate certificates and the root certificate authority certificate used to issue device certificates.
        """
        return pulumi.get(self, "device_ca_certificate")
    ...
    @property
    @pulumi.getter(name="optimizeForEndUserLocation")
    def optimize_for_end_user_location(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The option to optimize for better performance by routing traffic through the closest AWS Region to users, which may be outside of your home Region. Defaults to `true`.
