...
if not MYPY:
    class FleetIdentityProviderArgsDict(TypedDict):
        saml_metadata: pulumi.Input[builtins.str]
        """
...
class FleetIdentityProviderArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] saml_metadata: The SAML metadata document provided by the customer’s identity provider.
        :param pulumi.Input[builtins.str] type: The type of identity provider.
        """
    ...
    def saml_metadata(self) -> pulumi.Input[builtins.str]:
        """
        The SAML metadata document provided by the customer’s identity provider.
        """
    ...
    def saml_metadata(self, value: pulumi.Input[builtins.str]):
...
class FleetNetworkArgs:
    def __init__(__self__, *,
                 ...
                 vpc_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: A list of security group IDs associated with access to the provided subnets.
               
               **identity_provider** requires the following:
               
               > **NOTE:** `identity_provider` cannot be removed without force recreating.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A list of subnet IDs used for X-ENI connections from Amazon WorkLink rendering containers.
        :param pulumi.Input[builtins.str] vpc_id: The VPC ID with connectivity to associated websites.
        """
