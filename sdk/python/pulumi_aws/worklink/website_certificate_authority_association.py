...
class WebsiteCertificateAuthorityAssociationArgs:
    def __init__(__self__, *,
                 ...
                 fleet_arn: pulumi.Input[builtins.str],
                 display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a WebsiteCertificateAuthorityAssociation resource.
        :param pulumi.Input[builtins.str] certificate: The root certificate of the Certificate Authority.
        :param pulumi.Input[builtins.str] fleet_arn: The ARN of the fleet.
        :param pulumi.Input[builtins.str] display_name: The certificate name to display.
        """
    ...
    def fleet_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @fleet_arn.setter
    def fleet_arn(self, value: pulumi.Input[builtins.str]):
...
class _WebsiteCertificateAuthorityAssociationState:
    def __init__(__self__, *,
                 ...
                 website_ca_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering WebsiteCertificateAuthorityAssociation resources.
        :param pulumi.Input[builtins.str] certificate: The root certificate of the Certificate Authority.
        :param pulumi.Input[builtins.str] display_name: The certificate name to display.
        :param pulumi.Input[builtins.str] fleet_arn: The ARN of the fleet.
        :param pulumi.Input[builtins.str] website_ca_id: A unique identifier for the Certificate Authority.
        """
    ...
    def website_ca_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def website_ca_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WebsiteCertificateAuthorityAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            display_name: Optional[pulumi.Input[builtins.str]] = None,
            fleet_arn: Optional[pulumi.Input[builtins.str]] = None,
            website_ca_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WebsiteCertificateAuthorityAssociation':
        """
    ...
    @property
    @pulumi.getter(name="websiteCaId")
    def website_ca_id(self) -> pulumi.Output[builtins.str]:
        """
        A unique identifier for the Certificate Authority.
        """
        return pulumi.get(self, "website_ca_id")
