...
class AssociationArgs:
    ...
    def license_configuration_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def license_configuration_arn(self, value: pulumi.Input[builtins.str]):
...
class Association(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="licenseConfigurationArn")
    def license_configuration_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the license configuration.
        """
        return pulumi.get(self, "license_configuration_arn")
