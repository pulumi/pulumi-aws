...
class LicenseGrantAccepterArgs:
    def __init__(__self__, *,
                 grant_arn: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a LicenseGrantAccepter resource.
        :param pulumi.Input[builtins.str] grant_arn: The ARN of the grant to accept.
        """
        pulumi.set(__self__, "grant_arn", grant_arn)

    @property
    @pulumi.getter(name="grantArn")
    def grant_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @grant_arn.setter
    def grant_arn(self, value: pulumi.Input[builtins.str]):
...
class _LicenseGrantAccepterState:
    def __init__(__self__, *,
                 allowed_operations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 grant_arn: Optional[pulumi.Input[builtins.str]] = None,
                 home_region: Optional[pulumi.Input[builtins.str]] = None,
                 license_arn: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_arn: Optional[pulumi.Input[builtins.str]] = None,
                 principal: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering LicenseGrantAccepter resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_operations: A list of the allowed operations for the grant.
        :param pulumi.Input[builtins.str] grant_arn: The ARN of the grant to accept.
        :param pulumi.Input[builtins.str] home_region: The home region for the license.
        :param pulumi.Input[builtins.str] license_arn: The ARN of the license for the grant.
        :param pulumi.Input[builtins.str] name: The Name of the grant.
        :param pulumi.Input[builtins.str] parent_arn: The parent ARN.
        :param pulumi.Input[builtins.str] principal: The target account for the grant.
    ...
    def allowed_operations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def allowed_operations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_operations", value)

    @property
    @pulumi.getter(name="grantArn")
    def grant_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the grant to accept.
        """
        return pulumi.get(self, "grant_arn")
    ...
    @grant_arn.setter
    def grant_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grant_arn", value)
    ...
    def license_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @license_arn.setter
    def license_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def parent_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The parent ARN.
        """
    ...
    @parent_arn.setter
    def parent_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws:licensemanager/licenseGrantAccepter:LicenseGrantAccepter")
class LicenseGrantAccepter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            principal: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'LicenseGrantAccepter':
        """
    ...
    @property
    @pulumi.getter(name="allowedOperations")
    def allowed_operations(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of the allowed operations for the grant.
        """
        return pulumi.get(self, "allowed_operations")
    ...
    @property
    @pulumi.getter(name="grantArn")
    def grant_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the grant to accept.
        """
        return pulumi.get(self, "grant_arn")
    ...
    @property
    @pulumi.getter(name="licenseArn")
    def license_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the license for the grant.
        """
        return pulumi.get(self, "license_arn")
    ...
    @property
    @pulumi.getter(name="parentArn")
    def parent_arn(self) -> pulumi.Output[builtins.str]:
        """
        The parent ARN.
        """
        return pulumi.get(self, "parent_arn")
