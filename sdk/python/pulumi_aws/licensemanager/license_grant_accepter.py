...
class _LicenseGrantAccepterState:
    def __init__(__self__, *,
                 ...
                 grant_arn: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @grant_arn.setter
    def grant_arn(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "grant_arn", value)
...
class LicenseGrantAccepter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            version: Optional[pulumi.Input[_builtins.str]] = None) -> 'LicenseGrantAccepter':
        """
