...
class PrimaryContactArgs:
    def __init__(__self__, *,
                 ...
                 district_or_county: Optional[pulumi.Input[builtins.str]] = None,
                 state_or_region: Optional[pulumi.Input[builtins.str]] = None,
                 website_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a PrimaryContact resource.
        :param pulumi.Input[builtins.str] address_line1: The first line of the primary contact address.
        :param pulumi.Input[builtins.str] city: The city of the primary contact address.
        :param pulumi.Input[builtins.str] country_code: The ISO-3166 two-letter country code for the primary contact address.
        :param pulumi.Input[builtins.str] full_name: The full name of the primary contact address.
        :param pulumi.Input[builtins.str] phone_number: The phone number of the primary contact information. The number will be validated and, in some countries, checked for activation.
        :param pulumi.Input[builtins.str] postal_code: The postal code of the primary contact address.
        :param pulumi.Input[builtins.str] account_id: The ID of the target account when managing member accounts. Will manage current user's account by default if omitted.
        :param pulumi.Input[builtins.str] address_line2: The second line of the primary contact address, if any.
        :param pulumi.Input[builtins.str] address_line3: The third line of the primary contact address, if any.
        :param pulumi.Input[builtins.str] company_name: The name of the company associated with the primary contact information, if any.
        :param pulumi.Input[builtins.str] district_or_county: The district or county of the primary contact address, if any.
        :param pulumi.Input[builtins.str] state_or_region: The state or region of the primary contact address. This field is required in selected countries.
        :param pulumi.Input[builtins.str] website_url: The URL of the website associated with the primary contact information, if any.
        """
    ...
    def district_or_county(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def district_or_county(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "district_or_county", value)

    @property
    @pulumi.getter(name="stateOrRegion")
    def state_or_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def state_or_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "state_or_region", value)

    @property
    @pulumi.getter(name="websiteUrl")
    def website_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @website_url.setter
    def website_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PrimaryContact(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            postal_code: Optional[pulumi.Input[builtins.str]] = None,
            state_or_region: Optional[pulumi.Input[builtins.str]] = None,
            website_url: Optional[pulumi.Input[builtins.str]] = None) -> 'PrimaryContact':
        """
    ...
    @property
    @pulumi.getter(name="addressLine1")
    def address_line1(self) -> pulumi.Output[builtins.str]:
        """
        The first line of the primary contact address.
        """
        return pulumi.get(self, "address_line1")
    ...
    @property
    @pulumi.getter(name="addressLine2")
    def address_line2(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The second line of the primary contact address, if any.
        """
        return pulumi.get(self, "address_line2")
    ...
    @property
    @pulumi.getter(name="addressLine3")
    def address_line3(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The third line of the primary contact address, if any.
        """
        return pulumi.get(self, "address_line3")
    ...
    @property
    @pulumi.getter(name="districtOrCounty")
    def district_or_county(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The district or county of the primary contact address, if any.
        """
        return pulumi.get(self, "district_or_county")
    ...
    @property
    @pulumi.getter(name="stateOrRegion")
    def state_or_region(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The state or region of the primary contact address. This field is required in selected countries.
        """
        return pulumi.get(self, "state_or_region")
    ...
    @property
    @pulumi.getter(name="websiteUrl")
    def website_url(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The URL of the website associated with the primary contact information, if any.
        """
        return pulumi.get(self, "website_url")
