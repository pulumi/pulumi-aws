...
class BudgetArgs:
    def __init__(__self__, *,
                 budget_type: pulumi.Input[builtins.str],
                 ...
                 limit_amount: Optional[pulumi.Input[builtins.str]] = None,
                 limit_unit: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] budget_type: Whether this budget tracks monetary cost or usage.
        ...
        :param pulumi.Input[builtins.str] limit_amount: The amount of cost or usage being measured for a budget.
        :param pulumi.Input[builtins.str] limit_unit: The unit of measurement used for the budget forecast, actual spend, or budget threshold, such as dollars or GB. See [Spend](http://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/data-type-spend.html) documentation.
    ...
    def budget_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @budget_type.setter
    def budget_type(self, value: pulumi.Input[builtins.str]):
    ...
    def limit_amount(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @limit_amount.setter
    def limit_amount(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "limit_amount", value)

    @property
    @pulumi.getter(name="limitUnit")
    def limit_unit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @limit_unit.setter
    def limit_unit(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_period_end(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_period_start(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BudgetState:
    def __init__(__self__, *,
                 ...
                 auto_adjust_data: Optional[pulumi.Input['BudgetAutoAdjustDataArgs']] = None,
                 budget_type: Optional[pulumi.Input[builtins.str]] = None,
                 cost_filters: Optional[pulumi.Input[Sequence[pulumi.Input['BudgetCostFilterArgs']]]] = None,
                 cost_types: Optional[pulumi.Input['BudgetCostTypesArgs']] = None,
                 limit_amount: Optional[pulumi.Input[builtins.str]] = None,
                 limit_unit: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] account_id: The ID of the target account for budget. Will use current user's account_id by default if omitted.
        :param pulumi.Input[builtins.str] arn: The ARN of the budget.
        :param pulumi.Input['BudgetAutoAdjustDataArgs'] auto_adjust_data: Object containing AutoAdjustData which determines the budget amount for an auto-adjusting budget.
        :param pulumi.Input[builtins.str] budget_type: Whether this budget tracks monetary cost or usage.
        :param pulumi.Input[Sequence[pulumi.Input['BudgetCostFilterArgs']]] cost_filters: A list of CostFilter name/values pair to apply to budget.
        :param pulumi.Input['BudgetCostTypesArgs'] cost_types: Object containing CostTypes The types of cost included in a budget, such as tax and subscriptions.
    ...
    @property
    @pulumi.getter(name="budgetType")
    def budget_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether this budget tracks monetary cost or usage.
        """
        return pulumi.get(self, "budget_type")
    ...
    @budget_type.setter
    def budget_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "budget_type", value)
...
class Budget(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_period_end: Optional[pulumi.Input[builtins.str]] = None,
            time_period_start: Optional[pulumi.Input[builtins.str]] = None,
            time_unit: Optional[pulumi.Input[builtins.str]] = None) -> 'Budget':
        """
    ...
    @property
    @pulumi.getter(name="budgetType")
    def budget_type(self) -> pulumi.Output[builtins.str]:
        """
        Whether this budget tracks monetary cost or usage.
        """
        return pulumi.get(self, "budget_type")
    ...
    @property
    @pulumi.getter(name="limitAmount")
    def limit_amount(self) -> pulumi.Output[builtins.str]:
        """
        The amount of cost or usage being measured for a budget.
        """
        return pulumi.get(self, "limit_amount")
    ...
    @property
    @pulumi.getter(name="limitUnit")
    def limit_unit(self) -> pulumi.Output[builtins.str]:
        """
        The unit of measurement used for the budget forecast, actual spend, or budget threshold, such as dollars or GB. See [Spend](http://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/data-type-spend.html) documentation.
        """
        return pulumi.get(self, "limit_unit")
    ...
    @property
    @pulumi.getter(name="timePeriodEnd")
    def time_period_end(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The end of the time period covered by the budget. There are no restrictions on the end date. Format: `2017-01-01_12:00`.
        """
        return pulumi.get(self, "time_period_end")
