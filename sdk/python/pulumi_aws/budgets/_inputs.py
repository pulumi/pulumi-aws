...
if not MYPY:
    class BudgetAutoAdjustDataArgsDict(TypedDict):
        ...
        """
        last_auto_adjust_time: NotRequired[pulumi.Input[str]]
        """
...
class BudgetAutoAdjustDataArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[str] auto_adjust_type: (Required) - The string that defines whether your budget auto-adjusts based on historical or forecasted data. Valid values: `FORECAST`,`HISTORICAL`
        ...
        :param pulumi.Input[str] last_auto_adjust_time: (Optional) - The last time that your budget was auto-adjusted.
        """
...
if not MYPY:
    class BudgetAutoAdjustDataHistoricalOptionsArgsDict(TypedDict):
        ...
        """
        lookback_available_periods: NotRequired[pulumi.Input[int]]
        """
...
class BudgetAutoAdjustDataHistoricalOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[int] budget_adjustment_period: (Required) - The number of budget periods included in the moving-average calculation that determines your auto-adjusted budget amount.
        :param pulumi.Input[int] lookback_available_periods: (Optional) - The integer that describes how many budget periods in your BudgetAdjustmentPeriod are included in the calculation of your current budget limit. If the first budget period in your BudgetAdjustmentPeriod has no cost data, then that budget period isn’t included in the average that determines your budget limit. You can’t set your own LookBackAvailablePeriods. The value is automatically calculated from the `budget_adjustment_period` and your historical cost data.
        """
...
if not MYPY:
    class BudgetCostTypesArgsDict(TypedDict):
        include_credit: NotRequired[pulumi.Input[bool]]
        """
        A boolean value whether to include credits in the cost budget. Defaults to `true`
        """
        include_discount: NotRequired[pulumi.Input[bool]]
        """
        Whether a budget includes discounts. Defaults to `true`
        """
        include_other_subscription: NotRequired[pulumi.Input[bool]]
        """
        A boolean value whether to include other subscription costs in the cost budget. Defaults to `true`
        """
        include_recurring: NotRequired[pulumi.Input[bool]]
        """
        A boolean value whether to include recurring costs in the cost budget. Defaults to `true`
        """
        include_refund: NotRequired[pulumi.Input[bool]]
        """
        A boolean value whether to include refunds in the cost budget. Defaults to `true`
        """
        include_subscription: NotRequired[pulumi.Input[bool]]
        """
        A boolean value whether to include subscriptions in the cost budget. Defaults to `true`
        """
        include_support: NotRequired[pulumi.Input[bool]]
        """
        A boolean value whether to include support costs in the cost budget. Defaults to `true`
        """
        include_tax: NotRequired[pulumi.Input[bool]]
        """
        A boolean value whether to include tax in the cost budget. Defaults to `true`
        """
        include_upfront: NotRequired[pulumi.Input[bool]]
        """
        A boolean value whether to include upfront costs in the cost budget. Defaults to `true`
        """
        use_amortized: NotRequired[pulumi.Input[bool]]
        """
        Whether a budget uses the amortized rate. Defaults to `false`
        """
        use_blended: NotRequired[pulumi.Input[bool]]
        """
...
if not MYPY:
    class BudgetNotificationArgsDict(TypedDict):
        ...
        """
        subscriber_email_addresses: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
        (Optional) E-Mail addresses to notify. Either this or `subscriber_sns_topic_arns` is required.
        """
        subscriber_sns_topic_arns: NotRequired[pulumi.Input[Sequence[pulumi.Input[str]]]]
        """
