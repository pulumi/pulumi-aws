...
class BudgetActionActionThresholdArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'actionThresholdType' in kwargs:
            action_threshold_type = kwargs['actionThresholdType']
        if 'actionThresholdValue' in kwargs:
...
class BudgetAutoAdjustDataArgs:
    ...
    def _configure(
        ...
        if 'lastAutoAdjustTime' in kwargs:
...
class BudgetAutoAdjustDataHistoricalOptionsArgs:
    ...
    def _configure(
        ...
        if 'lookbackAvailablePeriods' in kwargs:
...
class BudgetNotificationArgs:
    ...
    def _configure(
        ...
        if 'subscriberEmailAddresses' in kwargs:
            subscriber_email_addresses = kwargs['subscriberEmailAddresses']
        if 'subscriberSnsTopicArns' in kwargs:
