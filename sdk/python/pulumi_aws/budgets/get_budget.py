...
def get_budget(account_id: Optional[str] = None,
    ...
    test = aws.budgets.get_budget(name=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetBudgetResult(
        ...
        arn=__ret__.arn,
        auto_adjust_datas=__ret__.auto_adjust_datas,
        budget_exceeded=__ret__.budget_exceeded,
        budget_limits=__ret__.budget_limits,
        budget_type=__ret__.budget_type,
        calculated_spends=__ret__.calculated_spends,
        cost_filters=__ret__.cost_filters,
        cost_types=__ret__.cost_types,
        id=__ret__.id,
        name=__ret__.name,
        name_prefix=__ret__.name_prefix,
        notifications=__ret__.notifications,
        planned_limits=__ret__.planned_limits,
        time_period_end=__ret__.time_period_end,
        time_period_start=__ret__.time_period_start,
