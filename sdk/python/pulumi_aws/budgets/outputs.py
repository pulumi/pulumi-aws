...
class BudgetActionActionThreshold(dict):
    ...
    def __init__(__self__, *,
                 ...
                 action_threshold_value: builtins.float):
        """
        :param builtins.str action_threshold_type: The type of threshold for a notification. Valid values are `PERCENTAGE` or `ABSOLUTE_VALUE`.
        :param builtins.float action_threshold_value: The threshold of a notification.
        """
    ...
    def action_threshold_value(self) -> builtins.float:
        """
...
class BudgetActionDefinitionIamActionDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy_arn: The Amazon Resource Name (ARN) of the policy to be attached.
        :param Sequence[builtins.str] groups: A list of groups to be attached. There must be at least one group.
        :param Sequence[builtins.str] roles: A list of roles to be attached. There must be at least one role.
        :param Sequence[builtins.str] users: A list of users to be attached. There must be at least one user.
        """
...
class BudgetActionDefinitionScpActionDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy_id: The policy ID attached.
        :param Sequence[builtins.str] target_ids: A list of target IDs.
        """
...
class BudgetActionDefinitionSsmActionDefinition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 region: builtins.str):
        """
        :param builtins.str action_sub_type: The action subType. Valid values are `STOP_EC2_INSTANCES` or `STOP_RDS_INSTANCES`.
        :param Sequence[builtins.str] instance_ids: The EC2 and RDS instance IDs.
        :param builtins.str region: The Region to run the SSM document.
        """
...
class BudgetActionSubscriber(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str address: The address that AWS sends budget notifications to, either an SNS topic or an email.
        :param builtins.str subscription_type: The type of notification that AWS sends to a subscriber. Valid values are `SNS` or `EMAIL`.
        """
...
class BudgetAutoAdjustData(dict):
    ...
    def __init__(__self__, *,
                 ...
                 last_auto_adjust_time: Optional[builtins.str] = None):
        """
        :param builtins.str auto_adjust_type: (Required) - The string that defines whether your budget auto-adjusts based on historical or forecasted data. Valid values: `FORECAST`,`HISTORICAL`
        ...
        :param builtins.str last_auto_adjust_time: (Optional) - The last time that your budget was auto-adjusted.
        """
    ...
    def last_auto_adjust_time(self) -> Optional[builtins.str]:
        """
...
class BudgetAutoAdjustDataHistoricalOptions(dict):
    ...
    def __init__(__self__, *,
                 budget_adjustment_period: builtins.int,
                 lookback_available_periods: Optional[builtins.int] = None):
        """
        :param builtins.int budget_adjustment_period: (Required) - The number of budget periods included in the moving-average calculation that determines your auto-adjusted budget amount.
        :param builtins.int lookback_available_periods: (Optional) - The integer that describes how many budget periods in your BudgetAdjustmentPeriod are included in the calculation of your current budget limit. If the first budget period in your BudgetAdjustmentPeriod has no cost data, then that budget period isn’t included in the average that determines your budget limit. You can’t set your own LookBackAvailablePeriods. The value is automatically calculated from the `budget_adjustment_period` and your historical cost data.
        """
    ...
    def budget_adjustment_period(self) -> builtins.int:
        """
    ...
    def lookback_available_periods(self) -> Optional[builtins.int]:
        """
...
class BudgetCostTypes(dict):
    ...
    def __init__(__self__, *,
                 include_credit: Optional[builtins.bool] = None,
                 include_discount: Optional[builtins.bool] = None,
                 include_other_subscription: Optional[builtins.bool] = None,
                 include_recurring: Optional[builtins.bool] = None,
                 include_refund: Optional[builtins.bool] = None,
                 include_subscription: Optional[builtins.bool] = None,
                 include_support: Optional[builtins.bool] = None,
                 include_tax: Optional[builtins.bool] = None,
                 include_upfront: Optional[builtins.bool] = None,
                 use_amortized: Optional[builtins.bool] = None,
                 use_blended: Optional[builtins.bool] = None):
        """
        :param builtins.bool include_credit: A boolean value whether to include credits in the cost budget. Defaults to `true`
        :param builtins.bool include_discount: Whether a budget includes discounts. Defaults to `true`
        :param builtins.bool include_other_subscription: A boolean value whether to include other subscription costs in the cost budget. Defaults to `true`
        :param builtins.bool include_recurring: A boolean value whether to include recurring costs in the cost budget. Defaults to `true`
        :param builtins.bool include_refund: A boolean value whether to include refunds in the cost budget. Defaults to `true`
        :param builtins.bool include_subscription: A boolean value whether to include subscriptions in the cost budget. Defaults to `true`
        :param builtins.bool include_support: A boolean value whether to include support costs in the cost budget. Defaults to `true`
        :param builtins.bool include_tax: A boolean value whether to include tax in the cost budget. Defaults to `true`
        :param builtins.bool include_upfront: A boolean value whether to include upfront costs in the cost budget. Defaults to `true`
        :param builtins.bool use_amortized: Whether a budget uses the amortized rate. Defaults to `false`
        :param builtins.bool use_blended: A boolean value whether to use blended costs in the cost budget. Defaults to `false`
        """
    ...
    def include_credit(self) -> Optional[builtins.bool]:
        """
    ...
    def include_discount(self) -> Optional[builtins.bool]:
        """
    ...
    def include_other_subscription(self) -> Optional[builtins.bool]:
        """
    ...
    def include_recurring(self) -> Optional[builtins.bool]:
        """
    ...
    def include_refund(self) -> Optional[builtins.bool]:
        """
    ...
    def include_subscription(self) -> Optional[builtins.bool]:
        """
    ...
    def include_support(self) -> Optional[builtins.bool]:
        """
    ...
    def include_tax(self) -> Optional[builtins.bool]:
        """
    ...
    def include_upfront(self) -> Optional[builtins.bool]:
        """
    ...
    def use_amortized(self) -> Optional[builtins.bool]:
        """
    ...
    def use_blended(self) -> Optional[builtins.bool]:
        """
...
class BudgetNotification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 subscriber_email_addresses: Optional[Sequence[builtins.str]] = None,
                 subscriber_sns_topic_arns: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str comparison_operator: (Required) Comparison operator to use to evaluate the condition. Can be `LESS_THAN`, `EQUAL_TO` or `GREATER_THAN`.
        :param builtins.str notification_type: (Required) What kind of budget value to notify on. Can be `ACTUAL` or `FORECASTED`
        :param builtins.float threshold: (Required) Threshold when the notification should be sent.
        :param builtins.str threshold_type: (Required) What kind of threshold is defined. Can be `PERCENTAGE` OR `ABSOLUTE_VALUE`.
        :param Sequence[builtins.str] subscriber_email_addresses: (Optional) E-Mail addresses to notify. Either this or `subscriber_sns_topic_arns` is required.
        :param Sequence[builtins.str] subscriber_sns_topic_arns: (Optional) SNS topics to notify. Either this or `subscriber_email_addresses` is required.
        """
    ...
    def subscriber_email_addresses(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def subscriber_sns_topic_arns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BudgetPlannedLimit(dict):
    ...
    def __init__(__self__, *,
                 ...
                 unit: builtins.str):
        """
        :param builtins.str amount: (Required) The amount of cost or usage being measured for a budget.
        :param builtins.str start_time: (Required) The start time of the budget limit. Format: `2017-01-01_12:00`. See [PlannedBudgetLimits](https://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_budgets_Budget.html#awscostmanagement-Type-budgets_Budget-PlannedBudgetLimits) documentation.
        :param builtins.str unit: (Required) The unit of measurement used for the budget forecast, actual spend, or budget threshold, such as dollars or GB. See [Spend](http://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/data-type-spend.html) documentation.
        """
...
class GetBudgetAutoAdjustDataResult(dict):
    def __init__(__self__, *,
                 ...
                 last_auto_adjust_time: builtins.str):
        """
        :param builtins.str auto_adjust_type: (Required) - The string that defines whether your budget auto-adjusts based on historical or forecasted data. Valid values: `FORECAST`,`HISTORICAL`.
...
class GetBudgetAutoAdjustDataHistoricalOptionResult(dict):
    def __init__(__self__, *,
                 budget_adjustment_period: builtins.int,
                 lookback_available_periods: builtins.int):
        """
        :param builtins.int budget_adjustment_period: (Required) - The number of budget periods included in the moving-average calculation that determines your auto-adjusted budget amount.
        :param builtins.int lookback_available_periods: (Optional) - The integer that describes how many budget periods in your BudgetAdjustmentPeriod are included in the calculation of your current budget limit. If the first budget period in your BudgetAdjustmentPeriod has no cost data, then that budget period isn’t included in the average that determines your budget limit. You can’t set your own LookBackAvailablePeriods. The value is automatically calculated from the `budget_adjustment_period` and your historical cost data.
        """
    ...
    @property
    @pulumi.getter(name="lookbackAvailablePeriods")
    def lookback_available_periods(self) -> builtins.int:
        """
        (Optional) - The integer that describes how many budget periods in your BudgetAdjustmentPeriod are included in the calculation of your current budget limit. If the first budget period in your BudgetAdjustmentPeriod has no cost data, then that budget period isn’t included in the average that determines your budget limit. You can’t set your own LookBackAvailablePeriods. The value is automatically calculated from the `budget_adjustment_period` and your historical cost data.
        """
        return pulumi.get(self, "lookback_available_periods")
...
class GetBudgetBudgetLimitResult(dict):
    def __init__(__self__, *,
                 ...
                 unit: builtins.str):
        """
        :param builtins.str amount: The cost or usage amount that's associated with a budget forecast, actual spend, or budget threshold. Length Constraints: Minimum length of `1`. Maximum length of `2147483647`.
        :param builtins.str unit: The unit of measurement that's used for the budget forecast, actual spend, or budget threshold, such as USD or GBP. Length Constraints: Minimum length of `1`. Maximum length of `2147483647`.
        """
        pulumi.set(__self__, "amount", amount)
        pulumi.set(__self__, "unit", unit)
...
class GetBudgetCostTypeResult(dict):
    ...
    @property
    @pulumi.getter(name="includeCredit")
    def include_credit(self) -> builtins.bool:
        """
        A boolean value whether to include credits in the cost budget. Defaults to `true`.
        """
        return pulumi.get(self, "include_credit")
    ...
    @property
    @pulumi.getter(name="includeDiscount")
    def include_discount(self) -> builtins.bool:
        """
        Whether a budget includes discounts. Defaults to `true`.
        """
        return pulumi.get(self, "include_discount")
    ...
    @property
    @pulumi.getter(name="includeOtherSubscription")
    def include_other_subscription(self) -> builtins.bool:
        """
        A boolean value whether to include other subscription costs in the cost budget. Defaults to `true`.
        """
        return pulumi.get(self, "include_other_subscription")
    ...
    @property
    @pulumi.getter(name="includeRecurring")
    def include_recurring(self) -> builtins.bool:
        """
        A boolean value whether to include recurring costs in the cost budget. Defaults to `true`.
        """
        return pulumi.get(self, "include_recurring")
    ...
    @property
    @pulumi.getter(name="includeRefund")
    def include_refund(self) -> builtins.bool:
        """
        A boolean value whether to include refunds in the cost budget. Defaults to `true`.
        """
        return pulumi.get(self, "include_refund")
    ...
    @property
    @pulumi.getter(name="includeSubscription")
    def include_subscription(self) -> builtins.bool:
        """
        A boolean value whether to include subscriptions in the cost budget. Defaults to `true`.
        """
        return pulumi.get(self, "include_subscription")
    ...
    @property
    @pulumi.getter(name="includeSupport")
    def include_support(self) -> builtins.bool:
        """
        A boolean value whether to include support costs in the cost budget. Defaults to `true`.
        """
        return pulumi.get(self, "include_support")
    ...
    @property
    @pulumi.getter(name="includeTax")
    def include_tax(self) -> builtins.bool:
        """
        A boolean value whether to include tax in the cost budget. Defaults to `true`.
        """
        return pulumi.get(self, "include_tax")
    ...
    @property
    @pulumi.getter(name="includeUpfront")
    def include_upfront(self) -> builtins.bool:
        """
        A boolean value whether to include upfront costs in the cost budget. Defaults to `true`.
        """
        return pulumi.get(self, "include_upfront")
    ...
    @property
    @pulumi.getter(name="useAmortized")
    def use_amortized(self) -> builtins.bool:
        """
        Whether a budget uses the amortized rate. Defaults to `false`.
        """
        return pulumi.get(self, "use_amortized")
    ...
    @property
    @pulumi.getter(name="useBlended")
    def use_blended(self) -> builtins.bool:
        """
        A boolean value whether to use blended costs in the cost budget. Defaults to `false`.
        """
        return pulumi.get(self, "use_blended")
...
class GetBudgetNotificationResult(dict):
    def __init__(__self__, *,
                 comparison_operator: builtins.str,
                 notification_type: builtins.str,
                 subscriber_email_addresses: Sequence[builtins.str],
                 subscriber_sns_topic_arns: Sequence[builtins.str],
                 threshold: builtins.float,
                 threshold_type: builtins.str):
        """
        :param builtins.str comparison_operator: (Required) Comparison operator to use to evaluate the condition. Can be `LESS_THAN`, `EQUAL_TO` or `GREATER_THAN`.
    ...
    @property
    @pulumi.getter(name="subscriberEmailAddresses")
    def subscriber_email_addresses(self) -> Sequence[builtins.str]:
        """
        (Optional) E-Mail addresses to notify. Either this or `subscriber_sns_topic_arns` is required.
        """
        return pulumi.get(self, "subscriber_email_addresses")
    ...
    @property
    @pulumi.getter(name="subscriberSnsTopicArns")
    def subscriber_sns_topic_arns(self) -> Sequence[builtins.str]:
        """
        (Optional) SNS topics to notify. Either this or `subscriber_email_addresses` is required.
        """
        return pulumi.get(self, "subscriber_sns_topic_arns")
