...
class PipeLogConfigurationCloudwatchLogsLogDestination(dict):
    ...
    def __init__(__self__, *,
                 log_group_arn: str):
        """
        :param str log_group_arn: Amazon Web Services Resource Name (ARN) for the CloudWatch log group to which EventBridge sends the log records.
        """
...
class PipeLogConfigurationFirehoseLogDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str delivery_stream_arn: Amazon Resource Name (ARN) of the Kinesis Data Firehose delivery stream to which EventBridge delivers the pipe log records.
        """
...
class PipeLogConfigurationS3LogDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str bucket_name: Name of the Amazon S3 bucket to which EventBridge delivers the log records for the pipe.
        :param str bucket_owner: Amazon Web Services account that owns the Amazon S3 bucket to which EventBridge delivers the log records for the pipe.
        :param str output_format: EventBridge format for the log records. Valid values `json`, `plain` and `w3c`.
        :param str prefix: Prefix text with which to begin Amazon S3 log object names.
        """
...
class PipeTargetParametersBatchJobParametersContainerOverridesEnvironment(dict):
    def __init__(__self__, *,
        ...
        :param str value: Value of parameter to start execution of a SageMaker AI Model Building Pipeline. Maximum length of 1024.
        """
        if name is not None:
