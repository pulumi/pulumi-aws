...
if not MYPY:
    class PipeEnrichmentParametersArgsDict(TypedDict):
        ...
        """
        input_template: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeEnrichmentParametersArgs:
    def __init__(__self__, *,
                 ...
                 input_template: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] input_template: Valid JSON text passed to the target. In this case, nothing from the event itself is passed to the target. Maximum length of 8192 characters.
        """
    ...
    def input_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Valid JSON text passed to the target. In this case, nothing from the event itself is passed to the target. Maximum length of 8192 characters.
        """
    ...
    def input_template(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "input_template", value)


if not MYPY:
    class PipeEnrichmentParametersHttpParametersArgsDict(TypedDict):
        header_parameters: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        path_parameter_values: NotRequired[pulumi.Input[builtins.str]]
        query_string_parameters: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
elif False:
...
class PipeEnrichmentParametersHttpParametersArgs:
    def __init__(__self__, *,
                 header_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 path_parameter_values: Optional[pulumi.Input[builtins.str]] = None,
                 query_string_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
    ...
    def header_parameters(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "header_parameters")

    @header_parameters.setter
    def header_parameters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "header_parameters", value)

    @property
    @pulumi.getter(name="pathParameterValues")
    def path_parameter_values(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "path_parameter_values")

    @path_parameter_values.setter
    def path_parameter_values(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "path_parameter_values", value)

    @property
    @pulumi.getter(name="queryStringParameters")
    def query_string_parameters(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "query_string_parameters")

    @query_string_parameters.setter
    def query_string_parameters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class PipeLogConfigurationArgsDict(TypedDict):
        ...
        """
        include_execution_datas: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class PipeLogConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 include_execution_datas: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 s3_log_destination: Optional[pulumi.Input['PipeLogConfigurationS3LogDestinationArgs']] = None):
        """
        :param pulumi.Input[builtins.str] level: The level of logging detail to include. Valid values `OFF`, `ERROR`, `INFO` and `TRACE`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_execution_datas: String list that specifies whether the execution data (specifically, the `payload`, `awsRequest`, and `awsResponse` fields) is included in the log messages for this pipe. This applies to all log destinations for the pipe. Valid values `ALL`.
    ...
    def include_execution_datas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        String list that specifies whether the execution data (specifically, the `payload`, `awsRequest`, and `awsResponse` fields) is included in the log messages for this pipe. This applies to all log destinations for the pipe. Valid values `ALL`.
        """
    ...
    def include_execution_datas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class PipeLogConfigurationCloudwatchLogsLogDestinationArgs:
    def __init__(__self__, *,
                 log_group_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] log_group_arn: Amazon Web Services Resource Name (ARN) for the CloudWatch log group to which EventBridge sends the log records.
        """
...
class PipeLogConfigurationFirehoseLogDestinationArgs:
    def __init__(__self__, *,
                 delivery_stream_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] delivery_stream_arn: Amazon Resource Name (ARN) of the Kinesis Data Firehose delivery stream to which EventBridge delivers the pipe log records.
        """
...
class PipeLogConfigurationS3LogDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_name: Name of the Amazon S3 bucket to which EventBridge delivers the log records for the pipe.
        :param pulumi.Input[builtins.str] bucket_owner: Amazon Web Services account that owns the Amazon S3 bucket to which EventBridge delivers the log records for the pipe.
        :param pulumi.Input[builtins.str] output_format: EventBridge format for the log records. Valid values `json`, `plain` and `w3c`.
        :param pulumi.Input[builtins.str] prefix: Prefix text with which to begin Amazon S3 log object names.
        """
...
if not MYPY:
    class PipeSourceParametersActivemqBrokerParametersArgsDict(TypedDict):
        ...
        """
        maximum_batching_window_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PipeSourceParametersActivemqBrokerParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] queue_name: The name of the destination queue to consume. Maximum length of 1000.
        :param pulumi.Input[builtins.int] batch_size: The maximum number of records to include in each batch. Maximum value of 10000.
        :param pulumi.Input[builtins.int] maximum_batching_window_in_seconds: The maximum length of a time to wait for events. Maximum value of 300.
        """
...
if not MYPY:
    class PipeSourceParametersActivemqBrokerParametersCredentialsArgsDict(TypedDict):
        basic_auth: pulumi.Input[builtins.str]
        """
...
class PipeSourceParametersActivemqBrokerParametersCredentialsArgs:
    def __init__(__self__, *,
                 basic_auth: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] basic_auth: The ARN of the Secrets Manager secret containing the credentials.
        """
        pulumi.set(__self__, "basic_auth", basic_auth)

    @property
    @pulumi.getter(name="basicAuth")
    def basic_auth(self) -> pulumi.Input[builtins.str]:
        """
        The ARN of the Secrets Manager secret containing the credentials.
        """
    ...
    @basic_auth.setter
    def basic_auth(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "basic_auth", value)


if not MYPY:
    class PipeSourceParametersDynamodbStreamParametersArgsDict(TypedDict):
        starting_position: pulumi.Input[builtins.str]
        """
        ...
        The maximum length of a time to wait for events. Maximum value of 300.
        """
        maximum_record_age_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        maximum_retry_attempts: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        on_partial_batch_item_failure: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        parallelization_factor: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PipeSourceParametersDynamodbStreamParametersArgs:
    def __init__(__self__, *,
                 ...
                 on_partial_batch_item_failure: Optional[pulumi.Input[builtins.str]] = None,
                 parallelization_factor: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] starting_position: The position in a stream from which to start reading. Valid values: TRIM_HORIZON, LATEST.
        :param pulumi.Input[builtins.int] batch_size: The maximum number of records to include in each batch. Maximum value of 10000.
        ...
        :param pulumi.Input[builtins.int] maximum_batching_window_in_seconds: The maximum length of a time to wait for events. Maximum value of 300.
        :param pulumi.Input[builtins.int] maximum_record_age_in_seconds: Discard records older than the specified age. The default value is -1, which sets the maximum age to infinite. When the value is set to infinite, EventBridge never discards old records. Maximum value of 604,800.
        :param pulumi.Input[builtins.int] maximum_retry_attempts: Discard records after the specified number of retries. The default value is -1, which sets the maximum number of retries to infinite. When MaximumRetryAttempts is infinite, EventBridge retries failed records until the record expires in the event source. Maximum value of 10,000.
        :param pulumi.Input[builtins.str] on_partial_batch_item_failure: Define how to handle item process failures. AUTOMATIC_BISECT halves each batch and retry each half until all the records are processed or there is one failed message left in the batch. Valid values: AUTOMATIC_BISECT.
        :param pulumi.Input[builtins.int] parallelization_factor: The number of batches to process concurrently from each shard. The default value is 1. Maximum value of 10.
        """
    ...
    def starting_position(self) -> pulumi.Input[builtins.str]:
        """
        The position in a stream from which to start reading. Valid values: TRIM_HORIZON, LATEST.
        """
    ...
    def starting_position(self, value: pulumi.Input[builtins.str]):
    ...
    def on_partial_batch_item_failure(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Define how to handle item process failures. AUTOMATIC_BISECT halves each batch and retry each half until all the records are processed or there is one failed message left in the batch. Valid values: AUTOMATIC_BISECT.
        """
    ...
    def on_partial_batch_item_failure(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PipeSourceParametersFilterCriteriaFilterArgs:
    def __init__(__self__, *,
                 pattern: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] pattern: The event pattern. At most 4096 characters.
        """
...
if not MYPY:
    class PipeSourceParametersKinesisStreamParametersArgsDict(TypedDict):
        ...
        The number of batches to process concurrently from each shard. The default value is 1. Maximum value of 10.
        """
        starting_position_timestamp: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeSourceParametersKinesisStreamParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] on_partial_batch_item_failure: Define how to handle item process failures. AUTOMATIC_BISECT halves each batch and retry each half until all the records are processed or there is one failed message left in the batch. Valid values: AUTOMATIC_BISECT.
        :param pulumi.Input[builtins.int] parallelization_factor: The number of batches to process concurrently from each shard. The default value is 1. Maximum value of 10.
        :param pulumi.Input[builtins.str] starting_position_timestamp: With StartingPosition set to AT_TIMESTAMP, the time from which to start reading, in Unix time seconds.
        """
        pulumi.set(__self__, "starting_position", starting_position)
        if batch_size is not None:
            pulumi.set(__self__, "batch_size", batch_size)
...
if not MYPY:
    class PipeSourceParametersManagedStreamingKafkaParametersArgsDict(TypedDict):
        ...
        The maximum length of a time to wait for events. Maximum value of 300.
        """
        starting_position: NotRequired[pulumi.Input[builtins.str]]
        """
        The position in a stream from which to start reading. Valid values: TRIM_HORIZON, LATEST.
        """
elif False:
...
class PipeSourceParametersManagedStreamingKafkaParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] topic_name: The name of the topic that the pipe will read from. Maximum length of 249.
        :param pulumi.Input[builtins.int] batch_size: The maximum number of records to include in each batch. Maximum value of 10000.
        :param pulumi.Input[builtins.str] consumer_group_id: The name of the destination queue to consume. Maximum value of 200.
...
if not MYPY:
    class PipeSourceParametersManagedStreamingKafkaParametersCredentialsArgsDict(TypedDict):
        client_certificate_tls_auth: NotRequired[pulumi.Input[builtins.str]]
        """
        The ARN of the Secrets Manager secret containing the credentials.
        """
        sasl_scram512_auth: NotRequired[pulumi.Input[builtins.str]]
        """
        The ARN of the Secrets Manager secret containing the credentials.
        """
elif False:
...
class PipeSourceParametersManagedStreamingKafkaParametersCredentialsArgs:
    def __init__(__self__, *,
                 client_certificate_tls_auth: Optional[pulumi.Input[builtins.str]] = None,
                 sasl_scram512_auth: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] client_certificate_tls_auth: The ARN of the Secrets Manager secret containing the credentials.
        :param pulumi.Input[builtins.str] sasl_scram512_auth: The ARN of the Secrets Manager secret containing the credentials.
        """
    ...
    def client_certificate_tls_auth(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the Secrets Manager secret containing the credentials.
        """
    ...
    def client_certificate_tls_auth(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_certificate_tls_auth", value)

    @property
    @pulumi.getter(name="saslScram512Auth")
    def sasl_scram512_auth(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the Secrets Manager secret containing the credentials.
        """
    ...
    def sasl_scram512_auth(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PipeSourceParametersRabbitmqBrokerParametersArgsDict(TypedDict):
        ...
        The maximum length of a time to wait for events. Maximum value of 300.
        """
        virtual_host: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeSourceParametersRabbitmqBrokerParametersArgs:
    def __init__(__self__, *,
                 ...
                 batch_size: Optional[pulumi.Input[builtins.int]] = None,
                 maximum_batching_window_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 virtual_host: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] batch_size: The maximum number of records to include in each batch. Maximum value of 10000.
        :param pulumi.Input[builtins.int] maximum_batching_window_in_seconds: The maximum length of a time to wait for events. Maximum value of 300.
        :param pulumi.Input[builtins.str] virtual_host: The name of the virtual host associated with the source broker. Maximum length of 200.
        """
        pulumi.set(__self__, "credentials", credentials)
        pulumi.set(__self__, "queue_name", queue_name)
        if batch_size is not None:
    ...
    def virtual_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the virtual host associated with the source broker. Maximum length of 200.
        """
    ...
    @virtual_host.setter
    def virtual_host(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PipeSourceParametersSelfManagedKafkaParametersArgsDict(TypedDict):
        ...
        The name of the topic that the pipe will read from. Maximum length of 249.
        """
        additional_bootstrap_servers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class PipeSourceParametersSelfManagedKafkaParametersArgs:
    def __init__(__self__, *,
                 topic_name: pulumi.Input[builtins.str],
                 additional_bootstrap_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 batch_size: Optional[pulumi.Input[builtins.int]] = None,
                 consumer_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] topic_name: The name of the topic that the pipe will read from. Maximum length of 249.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_bootstrap_servers: An array of server URLs. Maximum number of 2 items, each of maximum length 300.
        :param pulumi.Input[builtins.int] batch_size: The maximum number of records to include in each batch. Maximum value of 10000.
        :param pulumi.Input[builtins.str] consumer_group_id: The name of the destination queue to consume. Maximum value of 200.
        ...
        :param pulumi.Input[builtins.int] maximum_batching_window_in_seconds: The maximum length of a time to wait for events. Maximum value of 300.
        :param pulumi.Input[builtins.str] server_root_ca_certificate: The ARN of the Secrets Manager secret used for certification.
        :param pulumi.Input[builtins.str] starting_position: The position in a stream from which to start reading. Valid values: TRIM_HORIZON, LATEST.
    ...
    def additional_bootstrap_servers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array of server URLs. Maximum number of 2 items, each of maximum length 300.
        """
    ...
    def additional_bootstrap_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class PipeSourceParametersSelfManagedKafkaParametersCredentialsArgsDict(TypedDict):
        basic_auth: NotRequired[pulumi.Input[builtins.str]]
        """
        The ARN of the Secrets Manager secret containing the credentials.
        """
        client_certificate_tls_auth: NotRequired[pulumi.Input[builtins.str]]
        ...
        The ARN of the Secrets Manager secret containing the credentials.
        """
        sasl_scram256_auth: NotRequired[pulumi.Input[builtins.str]]
        """
        The ARN of the Secrets Manager secret containing the credentials.
        """
        sasl_scram512_auth: NotRequired[pulumi.Input[builtins.str]]
...
class PipeSourceParametersSelfManagedKafkaParametersCredentialsArgs:
    def __init__(__self__, *,
                 basic_auth: Optional[pulumi.Input[builtins.str]] = None,
                 client_certificate_tls_auth: Optional[pulumi.Input[builtins.str]] = None,
                 sasl_scram256_auth: Optional[pulumi.Input[builtins.str]] = None,
                 sasl_scram512_auth: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] basic_auth: The ARN of the Secrets Manager secret containing the credentials.
        :param pulumi.Input[builtins.str] client_certificate_tls_auth: The ARN of the Secrets Manager secret containing the credentials.
        :param pulumi.Input[builtins.str] sasl_scram256_auth: The ARN of the Secrets Manager secret containing the credentials.
        :param pulumi.Input[builtins.str] sasl_scram512_auth: The ARN of the Secrets Manager secret containing the credentials.
        """
    ...
    @property
    @pulumi.getter(name="basicAuth")
    def basic_auth(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the Secrets Manager secret containing the credentials.
        """
        return pulumi.get(self, "basic_auth")
    ...
    @basic_auth.setter
    def basic_auth(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "basic_auth", value)
    ...
    def sasl_scram256_auth(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the Secrets Manager secret containing the credentials.
        """
    ...
    def sasl_scram256_auth(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PipeTargetParametersBatchJobParametersArgsDict(TypedDict):
        job_definition: pulumi.Input[builtins.str]
        """
...
class PipeTargetParametersBatchJobParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] job_definition: The job definition used by this job. This value can be one of name, name:revision, or the Amazon Resource Name (ARN) for the job definition. If name is specified without a revision then the latest active revision is used.
        :param pulumi.Input[builtins.str] job_name: The name of the job. It can be up to 128 letters long.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Additional parameters passed to the job that replace parameter substitution placeholders that are set in the job definition. Parameters are specified as a key and value pair mapping. Parameters included here override any corresponding parameter defaults from the job definition. Detailed below.
    ...
    def job_definition(self) -> pulumi.Input[builtins.str]:
        """
        The job definition used by this job. This value can be one of name, name:revision, or the Amazon Resource Name (ARN) for the job definition. If name is specified without a revision then the latest active revision is used.
        """
    ...
    def job_definition(self, value: pulumi.Input[builtins.str]):
...
class PipeTargetParametersBatchJobParametersArrayPropertiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] size: The size of the array, if this is an array batch job. Minimum value of 2. Maximum value of 10,000.
        """
        if size is not None:
...
class PipeTargetParametersBatchJobParametersContainerOverridesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] commands: List of commands to send to the container that overrides the default command from the Docker image or the task definition. You must also specify a container name.
        ...
        :param pulumi.Input[builtins.str] instance_type: The instance type to use for a multi-node parallel job. This parameter isn't applicable to single-node container jobs or jobs that run on Fargate resources, and shouldn't be provided.
...
class PipeTargetParametersBatchJobParametersContainerOverridesEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] value: Value of parameter to start execution of a SageMaker AI Model Building Pipeline. Maximum length of 1024.
        """
        if name is not None:
...
class PipeTargetParametersBatchJobParametersContainerOverridesResourceRequirementArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: The type of placement strategy. The random placement strategy randomly places tasks on available candidates. The spread placement strategy spreads placement across available candidates evenly based on the field parameter. The binpack strategy places tasks on available candidates that have the least available amount of the resource that is specified with the field parameter. For example, if you binpack on memory, a task is placed on the instance with the least amount of remaining memory (but still enough to run the task). Valid Values: random, spread, binpack.
        :param pulumi.Input[builtins.str] value: Value of parameter to start execution of a SageMaker AI Model Building Pipeline. Maximum length of 1024.
        """
...
class PipeTargetParametersBatchJobParametersDependsOnArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] job_id: The job ID of the AWS Batch job that's associated with this dependency.
        :param pulumi.Input[builtins.str] type: The type of placement strategy. The random placement strategy randomly places tasks on available candidates. The spread placement strategy spreads placement across available candidates evenly based on the field parameter. The binpack strategy places tasks on available candidates that have the least available amount of the resource that is specified with the field parameter. For example, if you binpack on memory, a task is placed on the instance with the least amount of remaining memory (but still enough to run the task). Valid Values: random, spread, binpack.
        """
...
class PipeTargetParametersBatchJobParametersRetryStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] attempts: The number of times to move a job to the RUNNABLE status. If the value of attempts is greater than one, the job is retried on failure the same number of attempts as the value. Maximum value of 10.
        """
...
if not MYPY:
    class PipeTargetParametersCloudwatchLogsParametersArgsDict(TypedDict):
        log_stream_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeTargetParametersCloudwatchLogsParametersArgs:
    def __init__(__self__, *,
                 ...
                 timestamp: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] log_stream_name: The name of the log stream.
        :param pulumi.Input[builtins.str] timestamp: The time the event occurred, expressed as the number of milliseconds after Jan 1, 1970 00:00:00 UTC. This is the JSON path to the field in the event e.g. $.detail.timestamp
        """
    ...
    @timestamp.setter
    def timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "timestamp", value)


if not MYPY:
    class PipeTargetParametersEcsTaskParametersArgsDict(TypedDict):
        task_definition_arn: pulumi.Input[builtins.str]
        """
        ...
        """
        enable_ecs_managed_tags: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        launch_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        reference_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeTargetParametersEcsTaskParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] task_definition_arn: The ARN of the task definition to use if the event target is an Amazon ECS task.
        ...
        :param pulumi.Input[builtins.bool] enable_ecs_managed_tags: Specifies whether to enable Amazon ECS managed tags for the task. Valid values: true, false.
        :param pulumi.Input[builtins.bool] enable_execute_command: Whether or not to enable the execute command functionality for the containers in this task. If true, this enables execute command functionality on all containers in the task. Valid values: true, false.
        :param pulumi.Input[builtins.str] group: Specifies an Amazon ECS task group for the task. The maximum length is 255 characters.
        :param pulumi.Input[builtins.str] launch_type: Specifies the launch type on which your task is running. The launch type that you specify here must match one of the launch type (compatibilities) of the target task. The FARGATE value is supported only in the Regions where AWS Fargate with Amazon ECS is supported. Valid Values: EC2, FARGATE, EXTERNAL
        ...
        :param pulumi.Input[builtins.str] platform_version: Specifies the platform version for the task. Specify only the numeric portion of the platform version, such as 1.1.0. This structure is used only if LaunchType is FARGATE.
        :param pulumi.Input[builtins.str] propagate_tags: Specifies whether to propagate the tags from the task definition to the task. If no value is specified, the tags are not propagated. Tags can only be propagated to the task during task creation. To add tags to a task after task creation, use the TagResource API action. Valid Values: TASK_DEFINITION
        :param pulumi.Input[builtins.str] reference_id: The reference ID to use for the task. Maximum length of 1,024.
        ...
        :param pulumi.Input[builtins.int] task_count: The number of tasks to create based on TaskDefinition. The default is 1.
        """
    ...
    def task_definition_arn(self) -> pulumi.Input[builtins.str]:
        """
        The ARN of the task definition to use if the event target is an Amazon ECS task.
        """
    ...
    def task_definition_arn(self, value: pulumi.Input[builtins.str]):
...
class PipeTargetParametersEcsTaskParametersCapacityProviderStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] capacity_provider: The short name of the capacity provider. Maximum value of 255.
        :param pulumi.Input[builtins.int] base: The base value designates how many tasks, at a minimum, to run on the specified capacity provider. Only one capacity provider in a capacity provider strategy can have a base defined. If no value is specified, the default value of 0 is used. Maximum value of 100,000.
        :param pulumi.Input[builtins.int] weight: The weight value designates the relative percentage of the total number of tasks launched that should use the specified capacity provider. The weight value is taken into consideration after the base value, if defined, is satisfied. Maximum value of 1,000.
        """
...
if not MYPY:
    class PipeTargetParametersEcsTaskParametersNetworkConfigurationAwsVpcConfigurationArgsDict(TypedDict):
        assign_public_ip: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeTargetParametersEcsTaskParametersNetworkConfigurationAwsVpcConfigurationArgs:
    def __init__(__self__, *,
                 assign_public_ip: Optional[pulumi.Input[builtins.str]] = None,
                 security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 subnets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] assign_public_ip: Specifies whether the task's elastic network interface receives a public IP address. You can specify ENABLED only when LaunchType in EcsParameters is set to FARGATE. Valid Values: ENABLED, DISABLED.
        """
    ...
    def assign_public_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether the task's elastic network interface receives a public IP address. You can specify ENABLED only when LaunchType in EcsParameters is set to FARGATE. Valid Values: ENABLED, DISABLED.
        """
    ...
    def assign_public_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PipeTargetParametersEcsTaskParametersOverridesArgsDict(TypedDict):
        ...
        """
        task_role_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeTargetParametersEcsTaskParametersOverridesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cpu: The number of cpu units reserved for the container, instead of the default value from the task definition. You must also specify a container name.
        ...
        :param pulumi.Input[builtins.str] execution_role_arn: The Amazon Resource Name (ARN) of the task execution IAM role override for the task.
        ...
        :param pulumi.Input[builtins.str] memory: The hard limit (in MiB) of memory to present to the container, instead of the default value from the task definition. If your container attempts to exceed the memory specified here, the container is killed. You must also specify a container name.
        :param pulumi.Input[builtins.str] task_role_arn: The Amazon Resource Name (ARN) of the IAM role that containers in this task can assume. All containers in this task are granted the permissions that are specified in this role.
        """
        if container_overrides is not None:
            pulumi.set(__self__, "container_overrides", container_overrides)
        if cpu is not None:
...
if not MYPY:
    class PipeTargetParametersEcsTaskParametersOverridesContainerOverrideArgsDict(TypedDict):
        ...
        The hard limit (in MiB) of memory to present to the container, instead of the default value from the task definition. If your container attempts to exceed the memory specified here, the container is killed. You must also specify a container name.
        """
        memory_reservation: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PipeTargetParametersEcsTaskParametersOverridesContainerOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] commands: List of commands to send to the container that overrides the default command from the Docker image or the task definition. You must also specify a container name.
        :param pulumi.Input[builtins.int] cpu: The number of cpu units reserved for the container, instead of the default value from the task definition. You must also specify a container name.
        ...
        :param pulumi.Input[builtins.int] memory: The hard limit (in MiB) of memory to present to the container, instead of the default value from the task definition. If your container attempts to exceed the memory specified here, the container is killed. You must also specify a container name.
        :param pulumi.Input[builtins.int] memory_reservation: The soft limit (in MiB) of memory to reserve for the container, instead of the default value from the task definition. You must also specify a container name.
        :param pulumi.Input[builtins.str] name: Name of the pipe. If omitted, the provider will assign a random, unique name. Conflicts with `name_prefix`.
...
class PipeTargetParametersEcsTaskParametersOverridesInferenceAcceleratorOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] device_name: The Elastic Inference accelerator device name to override for the task. This parameter must match a deviceName specified in the task definition.
        :param pulumi.Input[builtins.str] device_type: The Elastic Inference accelerator type to use.
        """
...
class PipeTargetParametersEcsTaskParametersPlacementConstraintArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] expression: A cluster query language expression to apply to the constraint. You cannot specify an expression if the constraint type is distinctInstance. Maximum length of 2,000.
        :param pulumi.Input[builtins.str] type: The type of placement strategy. The random placement strategy randomly places tasks on available candidates. The spread placement strategy spreads placement across available candidates evenly based on the field parameter. The binpack strategy places tasks on available candidates that have the least available amount of the resource that is specified with the field parameter. For example, if you binpack on memory, a task is placed on the instance with the least amount of remaining memory (but still enough to run the task). Valid Values: random, spread, binpack.
        """
...
class PipeTargetParametersEcsTaskParametersPlacementStrategyArgs:
    def __init__(__self__, *,
                 ...
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] field: The field to apply the placement strategy against. For the spread placement strategy, valid values are instanceId (or host, which has the same effect), or any platform or custom attribute that is applied to a container instance, such as attribute:ecs.availability-zone. For the binpack placement strategy, valid values are cpu and memory. For the random placement strategy, this field is not used. Maximum length of 255.
        :param pulumi.Input[builtins.str] type: The type of placement strategy. The random placement strategy randomly places tasks on available candidates. The spread placement strategy spreads placement across available candidates evenly based on the field parameter. The binpack strategy places tasks on available candidates that have the least available amount of the resource that is specified with the field parameter. For example, if you binpack on memory, a task is placed on the instance with the least amount of remaining memory (but still enough to run the task). Valid Values: random, spread, binpack.
        """
...
if not MYPY:
    class PipeTargetParametersEventbridgeEventBusParametersArgsDict(TypedDict):
        detail_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeTargetParametersEventbridgeEventBusParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] detail_type: A free-form string, with a maximum of 128 characters, used to decide what fields to expect in the event detail.
        :param pulumi.Input[builtins.str] endpoint_id: The URL subdomain of the endpoint. For example, if the URL for Endpoint is https://abcde.veo.endpoints.event.amazonaws.com, then the EndpointId is abcde.veo.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resources: List of AWS resources, identified by Amazon Resource Name (ARN), which the event primarily concerns. Any number, including zero, may be present.
        ...
        :param pulumi.Input[builtins.str] time: The time stamp of the event, per RFC3339. If no time stamp is provided, the time stamp of the PutEvents call is used. This is the JSON path to the field in the event e.g. $.detail.timestamp
        """
    ...
    def detail_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A free-form string, with a maximum of 128 characters, used to decide what fields to expect in the event detail.
        """
    ...
    @detail_type.setter
    def detail_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PipeTargetParametersKinesisStreamParametersArgsDict(TypedDict):
        partition_key: pulumi.Input[builtins.str]
        """
...
class PipeTargetParametersKinesisStreamParametersArgs:
    def __init__(__self__, *,
                 partition_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] partition_key: Determines which shard in the stream the data record is assigned to. Partition keys are Unicode strings with a maximum length limit of 256 characters for each key. Amazon Kinesis Data Streams uses the partition key as input to a hash function that maps the partition key and associated data to a specific shard. Specifically, an MD5 hash function is used to map partition keys to 128-bit integer values and to map associated data records to shards. As a result of this hashing mechanism, all data records with the same partition key map to the same shard within the stream.
        """
        pulumi.set(__self__, "partition_key", partition_key)

    @property
    @pulumi.getter(name="partitionKey")
    def partition_key(self) -> pulumi.Input[builtins.str]:
        """
        Determines which shard in the stream the data record is assigned to. Partition keys are Unicode strings with a maximum length limit of 256 characters for each key. Amazon Kinesis Data Streams uses the partition key as input to a hash function that maps the partition key and associated data to a specific shard. Specifically, an MD5 hash function is used to map partition keys to 128-bit integer values and to map associated data records to shards. As a result of this hashing mechanism, all data records with the same partition key map to the same shard within the stream.
        """
...
class PipeTargetParametersLambdaFunctionParametersArgs:
    def __init__(__self__, *,
                 invocation_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] invocation_type: Specify whether to invoke the function synchronously or asynchronously. Valid Values: REQUEST_RESPONSE, FIRE_AND_FORGET.
        """
        pulumi.set(__self__, "invocation_type", invocation_type)

    @property
    @pulumi.getter(name="invocationType")
    def invocation_type(self) -> pulumi.Input[builtins.str]:
        """
        Specify whether to invoke the function synchronously or asynchronously. Valid Values: REQUEST_RESPONSE, FIRE_AND_FORGET.
        """
    ...
    def invocation_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class PipeTargetParametersRedshiftDataParametersArgsDict(TypedDict):
        ...
        """
        sqls: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        List of SQL statements text to run, each of maximum length of 100,000.
        """
        db_user: NotRequired[pulumi.Input[builtins.str]]
        """
        The database user name. Required when authenticating using temporary credentials.
        """
        secret_manager_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        The name or ARN of the secret that enables access to the database. Required when authenticating using Secrets Manager.
        """
        statement_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The name of the SQL statement. You can name the SQL statement when you create it to identify the query.
        """
        with_event: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class PipeTargetParametersRedshiftDataParametersArgs:
    def __init__(__self__, *,
                 ...
                 secret_manager_arn: Optional[pulumi.Input[builtins.str]] = None,
                 statement_name: Optional[pulumi.Input[builtins.str]] = None,
                 with_event: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] database: The name of the database. Required when authenticating using temporary credentials.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sqls: List of SQL statements text to run, each of maximum length of 100,000.
        :param pulumi.Input[builtins.str] db_user: The database user name. Required when authenticating using temporary credentials.
        :param pulumi.Input[builtins.str] secret_manager_arn: The name or ARN of the secret that enables access to the database. Required when authenticating using Secrets Manager.
        ...
        :param pulumi.Input[builtins.bool] with_event: Indicates whether to send an event back to EventBridge after the SQL statement runs.
        """
    ...
    @property
    @pulumi.getter
    def sqls(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        List of SQL statements text to run, each of maximum length of 100,000.
        """
    ...
    @sqls.setter
    def sqls(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def secret_manager_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name or ARN of the secret that enables access to the database. Required when authenticating using Secrets Manager.
        """
    ...
    def secret_manager_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PipeTargetParametersSqsQueueParametersArgsDict(TypedDict):
        message_deduplication_id: NotRequired[pulumi.Input[builtins.str]]
        """
        This parameter applies only to FIFO (first-in-first-out) queues. The token used for deduplication of sent messages.
        """
        message_group_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipeTargetParametersSqsQueueParametersArgs:
    def __init__(__self__, *,
                 message_deduplication_id: Optional[pulumi.Input[builtins.str]] = None,
                 message_group_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] message_deduplication_id: This parameter applies only to FIFO (first-in-first-out) queues. The token used for deduplication of sent messages.
        :param pulumi.Input[builtins.str] message_group_id: The FIFO message group ID to use as the target.
        """
    ...
    def message_deduplication_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        This parameter applies only to FIFO (first-in-first-out) queues. The token used for deduplication of sent messages.
        """
    ...
    def message_deduplication_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "message_deduplication_id", value)

    @property
    @pulumi.getter(name="messageGroupId")
    def message_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The FIFO message group ID to use as the target.
        """
    ...
    def message_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
