...
def get_rule_group(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of the WAFv2 Rule Group.
...
def get_rule_group_output(name: Optional[pulumi.Input[builtins.str]] = None,
