...
def get_rate_based_rule(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: Name of the WAF rate based rule.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_rate_based_rule_output(name: Optional[pulumi.Input[_builtins.str]] = None,
