...
calass IpSetArrgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IpSetIpSetDescriptorArrgs']]] ip_set_descriptors: One or more pairs specifying the IP address type (IPV4 or IPV6) and the IP address range (in CIDR format) from which web requests originate.
...
calass IpSet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ipset = aws.waf.IpSet("ipset", ip_set_descriptors=[
            aws.waf.IpSetIpSetDescriptorArrgs(
                type="IPV4",
                value="192.0.7.0/24",
            ),
            aws.waf.IpSetIpSetDescriptorArrgs(
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['IpSetIpSetDescriptorArrgs']]]] ip_set_descriptors: One or more pairs specifying the IP address type (IPV4 or IPV6) and the IP address range (in CIDR format) from which web requests originate.
        :param pulumi.Input[str] name: The name or description of the IPSet.
        """
        ...
    @overload
