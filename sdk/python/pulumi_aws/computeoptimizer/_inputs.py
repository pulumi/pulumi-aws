...
class RecommendationPreferencesExternalMetricsPreferenceArgs:
    def __init__(__self__, *,
                 source: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] source: The source options for external metrics preferences. Valid values: `Datadog`, `Dynatrace`, `NewRelic`, `Instana`.
        """
...
if not MYPY:
    class RecommendationPreferencesPreferredResourceArgsDict(TypedDict):
        ...
        exclude_lists: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        include_lists: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RecommendationPreferencesPreferredResourceArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 exclude_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_lists: The preferred resource type values to exclude from the recommendation candidates. If this isn’t specified, all supported resources are included by default.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] include_lists: The preferred resource type values to include in the recommendation candidates. You can specify the exact resource type value, such as `"m5.large"`, or use wild card expressions, such as `"m5"`. If this isn’t specified, all supported resources are included by default.
        """
    ...
    def exclude_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The preferred resource type values to exclude from the recommendation candidates. If this isn’t specified, all supported resources are included by default.
        """
    ...
    def exclude_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class RecommendationPreferencesScopeArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the scope. Valid values: `Organization`, `AccountId`, `ResourceArn`.
        :param pulumi.Input[builtins.str] value: The value of the scope. `ALL_ACCOUNTS` for `Organization` scopes, AWS account ID for `AccountId` scopes, ARN of an EC2 instance or an Auto Scaling group for `ResourceArn` scopes.
        """
        pulumi.set(__self__, "name", name)
...
class RecommendationPreferencesUtilizationPreferenceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] metric_name: The name of the resource utilization metric name to customize. Valid values: `CpuUtilization`, `MemoryUtilization`.
...
if not MYPY:
    class RecommendationPreferencesUtilizationPreferenceMetricParametersArgsDict(TypedDict):
        headroom: pulumi.Input[builtins.str]
        """
...
class RecommendationPreferencesUtilizationPreferenceMetricParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] headroom: The headroom value in percentage used for the specified metric parameter. Valid values: `PERCENT_30`, `PERCENT_20`, `PERCENT_10`, `PERCENT_0`.
        :param pulumi.Input[builtins.str] threshold: The threshold value used for the specified metric parameter. You can only specify the threshold value for CPU utilization. Valid values: `P90`, `P95`, `P99_5`.
        """
    ...
    @property
    @pulumi.getter
    def headroom(self) -> pulumi.Input[builtins.str]:
        """
        The headroom value in percentage used for the specified metric parameter. Valid values: `PERCENT_30`, `PERCENT_20`, `PERCENT_10`, `PERCENT_0`.
        """
    ...
    @headroom.setter
    def headroom(self, value: pulumi.Input[builtins.str]):
