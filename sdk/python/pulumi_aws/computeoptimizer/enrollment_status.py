...
class _EnrollmentStatusState:
    ...
    def number_of_member_accounts_opted_in(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def number_of_member_accounts_opted_in(self, value: Optional[pulumi.Input[builtins.int]]):
...
class EnrollmentStatus(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="numberOfMemberAccountsOptedIn")
    def number_of_member_accounts_opted_in(self) -> pulumi.Output[builtins.int]:
        """
        The count of organization member accounts that are opted in to the service, if your account is an organization management account.
        """
        return pulumi.get(self, "number_of_member_accounts_opted_in")
