...
class _InputSecurityGroupState:
    def __init__(__self__, *,
                 ...
                 whitelist_rules: pulumi.Input[Optional[Sequence[pulumi.Input['InputSecurityGroupWhitelistRuleArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="whitelistRules")
    def whitelist_rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InputSecurityGroupWhitelistRuleArgs']]]]:
        """
        Whitelist rules. See Whitelist Rules for more details.
    ...
    @whitelist_rules.setter
    def whitelist_rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InputSecurityGroupWhitelistRuleArgs']]]]):
        pulumi.set(self, "whitelist_rules", value)
