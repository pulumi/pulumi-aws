...
class DeploymentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] configuration_profile_id: Configuration profile ID. Must be between 4 and 7 characters in length.
        :param pulumi.Input[builtins.str] configuration_version: Configuration version to deploy. Can be at most 1024 characters.
        :param pulumi.Input[builtins.str] deployment_strategy_id: Deployment strategy ID or name of a predefined deployment strategy. See [Predefined Deployment Strategies](https://docs.aws.amazon.com/appconfig/latest/userguide/appconfig-creating-deployment-strategy.html#appconfig-creating-deployment-strategy-predefined) for more details.
...
class _DeploymentState:
    def __init__(__self__, *,
                 ...
                 deployment_number: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] application_id: Application ID. Must be between 4 and 7 characters in length.
        :param pulumi.Input[builtins.str] arn: ARN of the AppConfig Deployment.
        :param pulumi.Input[builtins.str] configuration_profile_id: Configuration profile ID. Must be between 4 and 7 characters in length.
        :param pulumi.Input[builtins.str] configuration_version: Configuration version to deploy. Can be at most 1024 characters.
        :param pulumi.Input[builtins.int] deployment_number: Deployment number.
        :param pulumi.Input[builtins.str] deployment_strategy_id: Deployment strategy ID or name of a predefined deployment strategy. See [Predefined Deployment Strategies](https://docs.aws.amazon.com/appconfig/latest/userguide/appconfig-creating-deployment-strategy.html#appconfig-creating-deployment-strategy-predefined) for more details.
        :param pulumi.Input[builtins.str] description: Description of the deployment. Can be at most 1024 characters.
        :param pulumi.Input[builtins.str] environment_id: Environment ID. Must be between 4 and 7 characters in length.
    ...
    @property
    @pulumi.getter(name="configurationVersion")
    def configuration_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Configuration version to deploy. Can be at most 1024 characters.
        """
        return pulumi.get(self, "configuration_version")
    ...
    @configuration_version.setter
    def configuration_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "configuration_version", value)

    @property
    @pulumi.getter(name="deploymentNumber")
    def deployment_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Deployment number.
        """
    ...
    def deployment_number(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "deployment_number", value)

    @property
    @pulumi.getter(name="deploymentStrategyId")
    def deployment_strategy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Deployment strategy ID or name of a predefined deployment strategy. See [Predefined Deployment Strategies](https://docs.aws.amazon.com/appconfig/latest/userguide/appconfig-creating-deployment-strategy.html#appconfig-creating-deployment-strategy-predefined) for more details.
        """
        return pulumi.get(self, "deployment_strategy_id")
    ...
    @deployment_strategy_id.setter
    def deployment_strategy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "deployment_strategy_id", value)
...
class Deployment(pulumi.CustomResource):
    ...
    pulumi_type = "aws:appconfig/deployment:Deployment"
    ...
    @property
    @pulumi.getter(name="deploymentNumber")
    def deployment_number(self) -> pulumi.Output[builtins.int]:
        """
        Deployment number.
        """
        return pulumi.get(self, "deployment_number")
