...
class DeploymentStrategyArgs:
    def __init__(__self__, *,
                 deployment_duration_in_minutes: pulumi.Input[builtins.int],
                 growth_factor: pulumi.Input[builtins.float],
                 replicate_to: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 final_bake_time_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 growth_type: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a DeploymentStrategy resource.
        :param pulumi.Input[builtins.int] deployment_duration_in_minutes: Total amount of time for a deployment to last. Minimum value of 0, maximum value of 1440.
        ...
        :param pulumi.Input[builtins.str] description: Description of the deployment strategy. Can be at most 1024 characters.
    ...
    def deployment_duration_in_minutes(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def deployment_duration_in_minutes(self, value: pulumi.Input[builtins.int]):
    ...
    def replicate_to(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @replicate_to.setter
    def replicate_to(self, value: pulumi.Input[builtins.str]):
    ...
    def final_bake_time_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def final_bake_time_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "final_bake_time_in_minutes", value)

    @property
    @pulumi.getter(name="growthType")
    def growth_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @growth_type.setter
    def growth_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DeploymentStrategyState:
    def __init__(__self__, *,
                 ...
                 deployment_duration_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 final_bake_time_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 growth_factor: Optional[pulumi.Input[builtins.float]] = None,
                 growth_type: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 replicate_to: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering DeploymentStrategy resources.
        :param pulumi.Input[builtins.str] arn: ARN of the AppConfig Deployment Strategy.
        :param pulumi.Input[builtins.int] deployment_duration_in_minutes: Total amount of time for a deployment to last. Minimum value of 0, maximum value of 1440.
        :param pulumi.Input[builtins.str] description: Description of the deployment strategy. Can be at most 1024 characters.
        :param pulumi.Input[builtins.int] final_bake_time_in_minutes: Amount of time AWS AppConfig monitors for alarms before considering the deployment to be complete and no longer eligible for automatic roll back. Minimum value of 0, maximum value of 1440.
        :param pulumi.Input[builtins.float] growth_factor: Percentage of targets to receive a deployed configuration during each interval. Minimum value of 1.0, maximum value of 100.0.
    ...
    @property
    @pulumi.getter(name="deploymentDurationInMinutes")
    def deployment_duration_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Total amount of time for a deployment to last. Minimum value of 0, maximum value of 1440.
        """
        return pulumi.get(self, "deployment_duration_in_minutes")
    ...
    @deployment_duration_in_minutes.setter
    def deployment_duration_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "deployment_duration_in_minutes", value)
    ...
    @property
    @pulumi.getter(name="growthFactor")
    def growth_factor(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Percentage of targets to receive a deployed configuration during each interval. Minimum value of 1.0, maximum value of 100.0.
        """
        return pulumi.get(self, "growth_factor")
    ...
    @growth_factor.setter
    def growth_factor(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "growth_factor", value)
    ...
    @property
    @pulumi.getter(name="replicateTo")
    def replicate_to(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Where to save the deployment strategy. Valid values: `NONE` and `SSM_DOCUMENT`.
        """
        return pulumi.get(self, "replicate_to")
    ...
    @replicate_to.setter
    def replicate_to(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replicate_to", value)
...
class DeploymentStrategy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            replicate_to: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'DeploymentStrategy':
        """
    ...
    @property
    @pulumi.getter(name="deploymentDurationInMinutes")
    def deployment_duration_in_minutes(self) -> pulumi.Output[builtins.int]:
        """
        Total amount of time for a deployment to last. Minimum value of 0, maximum value of 1440.
        """
        return pulumi.get(self, "deployment_duration_in_minutes")
    ...
    @property
    @pulumi.getter(name="finalBakeTimeInMinutes")
    def final_bake_time_in_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Amount of time AWS AppConfig monitors for alarms before considering the deployment to be complete and no longer eligible for automatic roll back. Minimum value of 0, maximum value of 1440.
        """
        return pulumi.get(self, "final_bake_time_in_minutes")
    ...
    @property
    @pulumi.getter(name="growthType")
    def growth_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Algorithm used to define how percentage grows over time. Valid value: `LINEAR` and `EXPONENTIAL`. Defaults to `LINEAR`.
        """
        return pulumi.get(self, "growth_type")
    ...
    @property
    @pulumi.getter(name="replicateTo")
    def replicate_to(self) -> pulumi.Output[builtins.str]:
        """
        Where to save the deployment strategy. Valid values: `NONE` and `SSM_DOCUMENT`.
        """
        return pulumi.get(self, "replicate_to")
