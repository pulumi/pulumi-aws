...
class Dashboard(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if dashboard_publish_options is not None and not isinstance(dashboard_publish_options, DashboardDashboardPublishOptionsArgs):
                dashboard_publish_options = dashboard_publish_options or {}
                def _setter(key, value):
                    dashboard_publish_options[key] = value
                DashboardDashboardPublishOptionsArgs._configure(_setter, **dashboard_publish_options)
