...
class DashboardArgs:
    def __init__(__self__, *,
                 ...
                 version_description: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] dashboard_id: Identifier for the dashboard.
        :param pulumi.Input[builtins.str] version_description: A description of the current dashboard version being created/updated.
    ...
    def version_description(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def version_description(self, value: pulumi.Input[builtins.str]):
...
class _DashboardState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the dashboard.
        :param pulumi.Input[builtins.str] aws_account_id: AWS account ID.
        :param pulumi.Input[builtins.str] created_time: The time that the dashboard was created.
        :param pulumi.Input[builtins.str] dashboard_id: Identifier for the dashboard.
        :param pulumi.Input['DashboardDashboardPublishOptionsArgs'] dashboard_publish_options: Options for publishing the dashboard. See dashboard_publish_options.
        :param pulumi.Input[builtins.str] last_updated_time: The time that the dashboard was last updated.
        :param pulumi.Input[builtins.str] name: Display name for the dashboard.
        :param pulumi.Input['DashboardParametersArgs'] parameters: The parameters for the creation of the dashboard, which you want to use to override the default settings. A dashboard can have any type of parameters, and some parameters might accept multiple values. See parameters.
        :param pulumi.Input[Sequence[pulumi.Input['DashboardPermissionArgs']]] permissions: A set of resource permissions on the dashboard. Maximum of 64 items. See permissions.
        :param pulumi.Input['DashboardSourceEntityArgs'] source_entity: The entity that you are using as a source when you create the dashboard (template). Only one of `definition` or `source_entity` should be configured. See source_entity.
        ...
        :param pulumi.Input[builtins.str] version_description: A description of the current dashboard version being created/updated.
               ...
               The following arguments are optional:
        :param pulumi.Input[builtins.int] version_number: The version number of the dashboard version.
        """
        if arn is not None:
    ...
    def source_entity_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_entity_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Dashboard(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            theme_arn: Optional[pulumi.Input[builtins.str]] = None,
            version_description: Optional[pulumi.Input[builtins.str]] = None,
            version_number: Optional[pulumi.Input[builtins.int]] = None) -> 'Dashboard':
        """
    ...
    @property
    @pulumi.getter(name="sourceEntityArn")
    def source_entity_arn(self) -> pulumi.Output[builtins.str]:
        """
        Amazon Resource Name (ARN) of a template that was used to create this dashboard.
        """
        return pulumi.get(self, "source_entity_arn")
