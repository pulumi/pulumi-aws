...
class DataSetRowLevelPermissionTagConfigurationTagRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] match_all_value: A string that you want to use to filter by all the values in a column in the dataset and don’t want to list the values one by one.
