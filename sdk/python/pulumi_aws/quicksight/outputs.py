...
class AnalysisParametersDateTimeParameter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Display name for the analysis.
...
class AnalysisPermission(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] actions: List of IAM actions to grant or revoke permissions on.
        :param builtins.str principal: ARN of the principal. See the [ResourcePermission documentation](https://docs.aws.amazon.com/quicksight/latest/APIReference/API_ResourcePermission.html) for the applicable ARN values.
        """
...
class AnalysisSourceEntitySourceTemplate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str arn: The Amazon Resource Name (ARN) of the resource.
...
class AnalysisSourceEntitySourceTemplateDataSetReference(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str data_set_arn: Dataset Amazon Resource Name (ARN).
        :param builtins.str data_set_placeholder: Dataset placeholder.
        """
...
class DashboardDashboardPublishOptionsAdHocFilteringOption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str availability_status: Availability status. Possibles values: ENABLED, DISABLED.
        """
...
class DashboardDashboardPublishOptionsSheetControlsOption(dict):
    ...
    def __init__(__self__, *,
                 visibility_state: Optional[builtins.str] = None):
        """
        :param builtins.str visibility_state: Visibility state. Possibles values: EXPANDED, COLLAPSED.
        """
    ...
    def visibility_state(self) -> Optional[builtins.str]:
        """
...
class DashboardParametersDateTimeParameter(dict):
    def __init__(__self__, *,
                 ...
                 values: Sequence[builtins.str]):
        """
        :param builtins.str name: Display name for the dashboard.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
...
class DataSetColumnGroupGeoSpatialColumnGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param Sequence[builtins.str] columns: Columns in this hierarchy.
        :param builtins.str country_code: Country code. Valid values are `US`.
        :param builtins.str name: A display name for the hierarchy.
        """
...
class DataSetColumnLevelPermissionRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] column_names: An array of column names.
        :param Sequence[builtins.str] principals: An array of ARNs for Amazon QuickSight users or groups.
        """
...
class DataSetDataSetUsageConfiguration(dict):
    ...
    def __init__(__self__, *,
                 disable_use_as_direct_query_source: Optional[builtins.bool] = None,
                 disable_use_as_imported_source: Optional[builtins.bool] = None):
        """
        :param builtins.bool disable_use_as_direct_query_source: Controls whether a child dataset of a direct query can use this dataset as a source.
        :param builtins.bool disable_use_as_imported_source: Controls whether a child dataset that's stored in QuickSight can use this dataset as a source.
        """
    ...
    def disable_use_as_direct_query_source(self) -> Optional[builtins.bool]:
        """
    ...
    def disable_use_as_imported_source(self) -> Optional[builtins.bool]:
        """
...
class DataSetFieldFolder(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str field_folders_id: Key of the field folder map.
        :param Sequence[builtins.str] columns: An array of column names to add to the folder. A column can only be in one folder.
...
class DataSetLogicalTableMap(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str alias: A display name for the logical table.
        :param builtins.str logical_table_map_id: Key of the logical table map.
...
class DataSetLogicalTableMapDataTransformCastColumnTypeOperation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str column_name: Column name.
        :param builtins.str new_column_type: New column data type. Valid values are `STRING`, `INTEGER`, `DECIMAL`, `DATETIME`.
        :param builtins.str format: When casting a column from string to datetime type, you can supply a string in a format supported by Amazon QuickSight to denote the source data format.
        """
...
class DataSetLogicalTableMapDataTransformCreateColumnsOperationColumn(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str column_id: A unique ID to identify a calculated column. During a dataset update, if the column ID of a calculated column matches that of an existing calculated column, Amazon QuickSight preserves the existing calculated column.
        :param builtins.str column_name: Column name.
        :param builtins.str expression: An expression that defines the calculated column.
        """
...
class DataSetLogicalTableMapDataTransformFilterOperation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str condition_expression: An expression that must evaluate to a Boolean value. Rows for which the expression evaluates to true are kept in the dataset.
        """
...
class DataSetLogicalTableMapDataTransformProjectOperation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] projected_columns: Projected columns.
        """
...
class DataSetLogicalTableMapDataTransformRenameColumnOperation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str column_name: Column to be renamed.
        :param builtins.str new_column_name: New name for the column.
        """
        pulumi.set(__self__, "column_name", column_name)
...
class DataSetLogicalTableMapDataTransformTagColumnOperationTag(dict):
    ...
    def __init__(__self__, *,
                 ...
                 column_geographic_role: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str column_geographic_role: A geospatial role for a column. Valid values are `COUNTRY`, `STATE`, `COUNTY`, `CITY`, `POSTCODE`, `LONGITUDE`, and `LATITUDE`.
        """
    ...
    def column_geographic_role(self) -> Optional[builtins.str]:
        """
...
class DataSetLogicalTableMapDataTransformTagColumnOperationTagColumnDescription(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str text: The text of a description for a column.
        """
        if text is not None:
...
class DataSetLogicalTableMapDataTransformUntagColumnOperation(dict):
    ...
    def __init__(__self__, *,
                 column_name: builtins.str,
                 tag_names: Sequence[builtins.str]):
        """
        :param builtins.str column_name: Column name.
        :param Sequence[builtins.str] tag_names: The column tags to remove from this column.
        """
        pulumi.set(__self__, "column_name", column_name)
    ...
    def tag_names(self) -> Sequence[builtins.str]:
        """
...
class DataSetLogicalTableMapSource(dict):
    ...
    def __init__(__self__, *,
                 data_set_arn: Optional[builtins.str] = None,
                 join_instruction: Optional['outputs.DataSetLogicalTableMapSourceJoinInstruction'] = None,
                 physical_table_id: Optional[builtins.str] = None):
        """
        :param builtins.str data_set_arn: ARN of the parent data set.
        ...
        :param builtins.str physical_table_id: Physical table ID.
        """
    ...
    @property
    @pulumi.getter(name="dataSetArn")
    def data_set_arn(self) -> Optional[builtins.str]:
        """
    ...
    def physical_table_id(self) -> Optional[builtins.str]:
        """
        Physical table ID.
        """
...
class DataSetLogicalTableMapSourceJoinInstruction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str left_operand: Operand on the left side of a join.
        :param builtins.str on_clause: Join instructions provided in the ON clause of a join.
        :param builtins.str right_operand: Operand on the right side of a join.
        :param builtins.str type: Type of join. Valid values are `INNER`, `OUTER`, `LEFT`, and `RIGHT`.
...
class DataSetLogicalTableMapSourceJoinInstructionLeftJoinKeyProperties(dict):
    ...
    def __init__(__self__, *,
                 unique_key: Optional[builtins.bool] = None):
        """
        :param builtins.bool unique_key: A value that indicates that a row in a table is uniquely identified by the columns in a join key. This is used by Amazon QuickSight to optimize query performance.
        """
    ...
    def unique_key(self) -> Optional[builtins.bool]:
        """
...
class DataSetPhysicalTableMap(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str physical_table_map_id: Key of the physical table map.
...
class DataSetPhysicalTableMapCustomSql(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str data_source_arn: ARN of the data source.
        :param builtins.str name: Display name for the SQL query result.
...
class DataSetPhysicalTableMapCustomSqlColumn(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str name: Name of this column in the underlying data source.
        :param builtins.str type: Data type of the column.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class DataSetPhysicalTableMapRelationalTable(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Name of the relational table.
        :param builtins.str catalog: Catalog associated with the table.
        :param builtins.str schema: Schema name. This name applies to certain relational database engines.
        """
        pulumi.set(__self__, "data_source_arn", data_source_arn)
...
class DataSetPhysicalTableMapS3SourceUploadSettings(dict):
    ...
    def __init__(__self__, *,
                 contains_header: Optional[builtins.bool] = None,
                 delimiter: Optional[builtins.str] = None,
                 format: Optional[builtins.str] = None,
                 start_from_row: Optional[builtins.int] = None,
                 text_qualifier: Optional[builtins.str] = None):
        """
        :param builtins.bool contains_header: Whether the file has a header row, or the files each have a header row.
        :param builtins.str delimiter: Delimiter between values in the file.
        :param builtins.str format: File format. Valid values are `CSV`, `TSV`, `CLF`, `ELF`, `XLSX`, and `JSON`.
        :param builtins.int start_from_row: A row number to start reading data from.
        :param builtins.str text_qualifier: Text qualifier. Valid values are `DOUBLE_QUOTE` and `SINGLE_QUOTE`.
        """
    ...
    def contains_header(self) -> Optional[builtins.bool]:
        """
    ...
    def start_from_row(self) -> Optional[builtins.int]:
        """
    ...
    def text_qualifier(self) -> Optional[builtins.str]:
        """
...
class DataSetRefreshPropertiesRefreshConfigurationIncrementalRefreshLookbackWindow(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str column_name: The name of the lookback window column.
        :param builtins.int size: The lookback window column size.
        :param builtins.str size_unit: The size unit that is used for the lookback window column. Valid values for this structure are `HOUR`, `DAY`, and `WEEK`.
        """
        pulumi.set(__self__, "column_name", column_name)
...
class DataSetRowLevelPermissionDataSet(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str arn: ARN of the dataset that contains permissions for RLS.
        :param builtins.str permission_policy: Type of permissions to use when interpreting the permissions for RLS. Valid values are `GRANT_ACCESS` and `DENY_ACCESS`.
        :param builtins.str format_version: User or group rules associated with the dataset that contains permissions for RLS.
        :param builtins.str namespace: Namespace associated with the dataset that contains permissions for RLS.
        :param builtins.str status: Status of the row-level security permission dataset. If enabled, the status is `ENABLED`. If disabled, the status is `DISABLED`.
        """
        pulumi.set(__self__, "arn", arn)
...
class DataSetRowLevelPermissionTagConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str status: The status of row-level security tags. If enabled, the status is `ENABLED`. If disabled, the status is `DISABLED`.
        """
...
class DataSetRowLevelPermissionTagConfigurationTagRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str column_name: Column name that a tag key is assigned to.
        :param builtins.str tag_key: Unique key for a tag.
        :param builtins.str match_all_value: A string that you want to use to filter by all the values in a column in the dataset and don’t want to list the values one by one.
        :param builtins.str tag_multi_value_delimiter: A string that you want to use to delimit the values when you pass the values at run time.
        """
        pulumi.set(__self__, "column_name", column_name)
    ...
    def match_all_value(self) -> Optional[builtins.str]:
        """
    ...
    def tag_multi_value_delimiter(self) -> Optional[builtins.str]:
        """
...
class DataSourceCredentials(dict):
    ...
    def __init__(__self__, *,
                 copy_source_arn: Optional[builtins.str] = None,
                 credential_pair: Optional['outputs.DataSourceCredentialsCredentialPair'] = None,
                 secret_arn: Optional[builtins.str] = None):
        """
        :param builtins.str copy_source_arn: The Amazon Resource Name (ARN) of a data source that has the credential pair that you want to use.
        ...
        :param builtins.str secret_arn: The Amazon Resource Name (ARN) of the secret associated with the data source in Amazon Secrets Manager.
        """
    ...
    def copy_source_arn(self) -> Optional[builtins.str]:
        """
...
class DataSourceCredentialsCredentialPair(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str password: Password, maximum length of 1024 characters.
        :param builtins.str username: User name, maximum length of 64 characters.
        """
...
class DataSourceParametersAmazonElasticsearch(dict):
    def __init__(__self__, *,
                 domain: builtins.str):
        """
        :param builtins.str domain: The OpenSearch domain.
        """
...
class DataSourceParametersAthena(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str work_group: The work-group to which to connect.
        """
...
class DataSourceParametersAurora(dict):
    def __init__(__self__, *,
                 ...
                 port: builtins.int):
        """
        :param builtins.str database: The database to which to connect.
        :param builtins.str host: The host to which to connect.
        :param builtins.int port: The port to which to connect.
        """
...
class DataSourceParametersAwsIotAnalytics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str data_set_name: The name of the data set to which to connect.
        """
...
class DataSourceParametersDatabricks(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host: The host name of the Databricks data source.
        :param builtins.int port: The port for the Databricks data source.
        :param builtins.str sql_endpoint_path: The HTTP path of the Databricks data source.
        """
        pulumi.set(__self__, "host", host)
        pulumi.set(__self__, "port", port)
...
class DataSourceParametersJira(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str site_base_url: The base URL of the Jira instance's site to which to connect.
        """
...
class DataSourceParametersPresto(dict):
    def __init__(__self__, *,
                 ...
                 port: builtins.int):
        """
        :param builtins.str catalog: The catalog to which to connect.
        :param builtins.str host: The host to which to connect.
        :param builtins.int port: The port to which to connect.
        """
        pulumi.set(__self__, "catalog", catalog)
...
class DataSourceParametersRds(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str database: The database to which to connect.
        :param builtins.str instance_id: The instance ID to which to connect.
        """
        pulumi.set(__self__, "database", database)
...
class DataSourceParametersRedshift(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str database: The database to which to connect.
        :param builtins.str cluster_id: The ID of the cluster to which to connect.
        :param builtins.str host: The host to which to connect.
        :param builtins.int port: The port to which to connect.
        """
        pulumi.set(__self__, "database", database)
...
class DataSourceParametersS3(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: Use the `role_arn` to override an account-wide role for a specific S3 data source. For example, say an account administrator has turned off all S3 access with an account-wide role. The administrator can then use `role_arn` to bypass the account-wide role and allow S3 access for the single S3 data source that is specified in the structure, even if the account-wide role forbidding S3 access is still active.
        """
...
class DataSourceParametersS3ManifestFileLocation(dict):
    def __init__(__self__, *,
                 ...
                 key: builtins.str):
        """
        :param builtins.str bucket: The name of the bucket that contains the manifest file.
        :param builtins.str key: The key of the manifest file within the bucket.
        """
...
class DataSourceParametersSnowflake(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str database: The database to which to connect.
        :param builtins.str host: The host to which to connect.
        :param builtins.str warehouse: The warehouse to which to connect.
        """
        pulumi.set(__self__, "database", database)
        pulumi.set(__self__, "host", host)
...
class DataSourceParametersSpark(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host: The host to which to connect.
        :param builtins.int port: The warehouse to which to connect.
        """
        pulumi.set(__self__, "host", host)
        pulumi.set(__self__, "port", port)
...
class DataSourceParametersTwitter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 query: builtins.str):
        """
        :param builtins.int max_rows: The maximum number of rows to query.
        :param builtins.str query: The Twitter query to retrieve the data.
        """
...
class DataSourcePermission(dict):
    def __init__(__self__, *,
                 ...
                 principal: builtins.str):
        """
        :param Sequence[builtins.str] actions: Set of IAM actions to grant or revoke permissions on. Max of 16 items.
        :param builtins.str principal: The Amazon Resource Name (ARN) of the principal.
        """
        pulumi.set(__self__, "actions", actions)
        pulumi.set(__self__, "principal", principal)
...
class DataSourceSslProperties(dict):
    ...
    def __init__(__self__, *,
                 disable_ssl: builtins.bool):
        """
        :param builtins.bool disable_ssl: A Boolean option to control whether SSL should be disabled.
        """
        pulumi.set(__self__, "disable_ssl", disable_ssl)

    @property
    @pulumi.getter(name="disableSsl")
    def disable_ssl(self) -> builtins.bool:
        """
...
class DataSourceVpcConnectionProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str vpc_connection_arn: The Amazon Resource Name (ARN) for the VPC connection.
        """
...
class IamPolicyAssignmentIdentities(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] groups: Array of Quicksight group names to assign the policy to.
        :param Sequence[builtins.str] users: Array of Quicksight user names to assign the policy to.
        """
...
class RefreshScheduleSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 start_after_date_time: Optional[builtins.str] = None):
        """
        :param builtins.str refresh_type: The type of refresh that the dataset undergoes. Valid values are `INCREMENTAL_REFRESH` and `FULL_REFRESH`.
        ...
        :param builtins.str start_after_date_time: Time after which the refresh schedule can be started, expressed in `YYYY-MM-DDTHH:MM:SS` format.
        """
    ...
    def start_after_date_time(self) -> Optional[builtins.str]:
        """
...
class RefreshScheduleScheduleScheduleFrequency(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_of_the_day: Optional[builtins.str] = None,
                 timezone: Optional[builtins.str] = None):
        """
        :param builtins.str interval: The interval between scheduled refreshes. Valid values are `MINUTE15`, `MINUTE30`, `HOURLY`, `DAILY`, `WEEKLY` and `MONTHLY`.
        ...
        :param builtins.str time_of_the_day: The time of day that you want the dataset to refresh. This value is expressed in `HH:MM` format. This field is not required for schedules that refresh hourly.
        :param builtins.str timezone: The timezone that you want the refresh schedule to use.
        """
    ...
    def time_of_the_day(self) -> Optional[builtins.str]:
        """
...
class RefreshScheduleScheduleScheduleFrequencyRefreshOnDay(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str day_of_month: The day of the month that you want to schedule refresh on.
        :param builtins.str day_of_week: The day of the week that you want to schedule a refresh on. Valid values are `SUNDAY`, `MONDAY`, `TUESDAY`, `WEDNESDAY`, `THURSDAY`, `FRIDAY` and `SATURDAY`.
        """
...
class ThemeConfigurationDataColorPalette(dict):
    ...
    def __init__(__self__, *,
                 colors: Optional[Sequence[builtins.str]] = None,
                 empty_fill_color: Optional[builtins.str] = None,
                 min_max_gradients: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] colors: List of hexadecimal codes for the colors. Minimum of 8 items and maximum of 20 items.
        :param builtins.str empty_fill_color: The hexadecimal code of a color that applies to charts where a lack of data is highlighted.
        :param Sequence[builtins.str] min_max_gradients: The minimum and maximum hexadecimal codes that describe a color gradient. List of exactly 2 items.
        """
    ...
    @property
    @pulumi.getter
    def colors(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def empty_fill_color(self) -> Optional[builtins.str]:
        """
    ...
    def min_max_gradients(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ThemeConfigurationSheetTileBorder(dict):
    def __init__(__self__, *,
                 show: Optional[builtins.bool] = None):
        """
        :param builtins.bool show: The option to enable display of borders for visuals.
        """
        if show is not None:
    ...
    @property
    @pulumi.getter
    def show(self) -> Optional[builtins.bool]:
        """
...
class ThemeConfigurationSheetTileLayoutGutter(dict):
    def __init__(__self__, *,
                 show: Optional[builtins.bool] = None):
        """
        :param builtins.bool show: This Boolean value controls whether to display a gutter space between sheet tiles.
        """
        if show is not None:
            pulumi.set(__self__, "show", show)
...
class ThemeConfigurationSheetTileLayoutMargin(dict):
    def __init__(__self__, *,
                 show: Optional[builtins.bool] = None):
        """
        :param builtins.bool show: This Boolean value controls whether to display sheet margins.
        """
        if show is not None:
            pulumi.set(__self__, "show", show)
...
class ThemeConfigurationTypographyFontFamily(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str font_family: Font family name.
        """
...
class ThemeConfigurationUiColorPalette(dict):
    ...
    def __init__(__self__, *,
                 accent: Optional[builtins.str] = None,
                 accent_foreground: Optional[builtins.str] = None,
                 danger: Optional[builtins.str] = None,
                 danger_foreground: Optional[builtins.str] = None,
                 dimension: Optional[builtins.str] = None,
                 dimension_foreground: Optional[builtins.str] = None,
                 measure: Optional[builtins.str] = None,
                 measure_foreground: Optional[builtins.str] = None,
                 primary_background: Optional[builtins.str] = None,
                 primary_foreground: Optional[builtins.str] = None,
                 secondary_background: Optional[builtins.str] = None,
                 secondary_foreground: Optional[builtins.str] = None,
                 success: Optional[builtins.str] = None,
                 success_foreground: Optional[builtins.str] = None,
                 warning: Optional[builtins.str] = None,
                 warning_foreground: Optional[builtins.str] = None):
        """
        :param builtins.str accent: Color (hexadecimal) that applies to selected states and buttons.
        :param builtins.str accent_foreground: Color (hexadecimal) that applies to any text or other elements that appear over the accent color.
        :param builtins.str danger: Color (hexadecimal) that applies to error messages.
        :param builtins.str danger_foreground: Color (hexadecimal) that applies to any text or other elements that appear over the error color.
        :param builtins.str dimension: Color (hexadecimal) that applies to the names of fields that are identified as dimensions.
        :param builtins.str dimension_foreground: Color (hexadecimal) that applies to any text or other elements that appear over the dimension color.
        :param builtins.str measure: Color (hexadecimal) that applies to the names of fields that are identified as measures.
        :param builtins.str measure_foreground: Color (hexadecimal) that applies to any text or other elements that appear over the measure color.
        :param builtins.str primary_background: Color (hexadecimal) that applies to visuals and other high emphasis UI.
        :param builtins.str primary_foreground: Color (hexadecimal) of text and other foreground elements that appear over the primary background regions, such as grid lines, borders, table banding, icons, and so on.
        :param builtins.str secondary_background: Color (hexadecimal) that applies to the sheet background and sheet controls.
        :param builtins.str secondary_foreground: Color (hexadecimal) that applies to any sheet title, sheet control text, or UI that appears over the secondary background.
        :param builtins.str success: Color (hexadecimal) that applies to success messages, for example the check mark for a successful download.
        :param builtins.str success_foreground: Color (hexadecimal) that applies to any text or other elements that appear over the success color.
        :param builtins.str warning: Color (hexadecimal) that applies to warning and informational messages.
        :param builtins.str warning_foreground: Color (hexadecimal) that applies to any text or other elements that appear over the warning color.
        """
    ...
    @property
    @pulumi.getter
    def accent(self) -> Optional[builtins.str]:
        """
    ...
    def accent_foreground(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def danger(self) -> Optional[builtins.str]:
        """
    ...
    def danger_foreground(self) -> Optional[builtins.str]:
        """
    ...
    def dimension_foreground(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def measure(self) -> Optional[builtins.str]:
        """
    ...
    def measure_foreground(self) -> Optional[builtins.str]:
        """
    ...
    def primary_background(self) -> Optional[builtins.str]:
        """
    ...
    def primary_foreground(self) -> Optional[builtins.str]:
        """
    ...
    def secondary_background(self) -> Optional[builtins.str]:
        """
    ...
    def secondary_foreground(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def success(self) -> Optional[builtins.str]:
        """
    ...
    def success_foreground(self) -> Optional[builtins.str]:
        """
    ...
    def warning_foreground(self) -> Optional[builtins.str]:
        """
...
class GetDataSetDataSetUsageConfigurationResult(dict):
    def __init__(__self__, *,
                 disable_use_as_direct_query_source: builtins.bool,
                 disable_use_as_imported_source: builtins.bool):
        pulumi.set(__self__, "disable_use_as_direct_query_source", disable_use_as_direct_query_source)
        pulumi.set(__self__, "disable_use_as_imported_source", disable_use_as_imported_source)

    @property
    @pulumi.getter(name="disableUseAsDirectQuerySource")
    def disable_use_as_direct_query_source(self) -> builtins.bool:
        return pulumi.get(self, "disable_use_as_direct_query_source")

    @property
    @pulumi.getter(name="disableUseAsImportedSource")
    def disable_use_as_imported_source(self) -> builtins.bool:
        return pulumi.get(self, "disable_use_as_imported_source")
...
class GetDataSetLogicalTableMapDataTransformTagColumnOperationTagResult(dict):
    def __init__(__self__, *,
                 ...
                 column_geographic_role: builtins.str):
...
class GetDataSetLogicalTableMapSourceResult(dict):
    def __init__(__self__, *,
                 ...
                 physical_table_id: builtins.str):
        pulumi.set(__self__, "data_set_arn", data_set_arn)
...
class GetDataSetLogicalTableMapSourceJoinInstructionLeftJoinKeyPropertyResult(dict):
    def __init__(__self__, *,
                 unique_key: builtins.bool):
        pulumi.set(__self__, "unique_key", unique_key)

    @property
    @pulumi.getter(name="uniqueKey")
    def unique_key(self) -> builtins.bool:
        return pulumi.get(self, "unique_key")
...
class GetDataSetPhysicalTableMapS3SourceUploadSettingResult(dict):
    def __init__(__self__, *,
                 contains_header: builtins.bool,
                 delimiter: builtins.str,
                 format: builtins.str,
                 start_from_row: builtins.int,
                 text_qualifier: builtins.str):
        pulumi.set(__self__, "contains_header", contains_header)
        pulumi.set(__self__, "delimiter", delimiter)
        pulumi.set(__self__, "format", format)
        pulumi.set(__self__, "start_from_row", start_from_row)
    ...
    @property
    @pulumi.getter(name="containsHeader")
    def contains_header(self) -> builtins.bool:
        return pulumi.get(self, "contains_header")
    ...
    @property
    @pulumi.getter(name="startFromRow")
    def start_from_row(self) -> builtins.int:
        return pulumi.get(self, "start_from_row")
...
class GetDataSetRowLevelPermissionTagConfigurationTagRuleResult(dict):
    def __init__(__self__, *,
                 column_name: builtins.str,
                 match_all_value: builtins.str,
                 tag_key: builtins.str,
                 tag_multi_value_delimiter: builtins.str):
        pulumi.set(__self__, "column_name", column_name)
        pulumi.set(__self__, "match_all_value", match_all_value)
        pulumi.set(__self__, "tag_key", tag_key)
        pulumi.set(__self__, "tag_multi_value_delimiter", tag_multi_value_delimiter)
...
class GetThemeConfigurationDataColorPaletteResult(dict):
    def __init__(__self__, *,
                 colors: Sequence[builtins.str],
                 empty_fill_color: builtins.str,
                 min_max_gradients: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] colors: List of hexadecimal codes for the colors. Minimum of 8 items and maximum of 20 items.
        :param builtins.str empty_fill_color: The hexadecimal code of a color that applies to charts where a lack of data is highlighted.
        :param Sequence[builtins.str] min_max_gradients: The minimum and maximum hexadecimal codes that describe a color gradient. List of exactly 2 items.
    ...
    @property
    @pulumi.getter
    def colors(self) -> Sequence[builtins.str]:
        """
        List of hexadecimal codes for the colors. Minimum of 8 items and maximum of 20 items.
        """
        return pulumi.get(self, "colors")
    ...
    @property
    @pulumi.getter(name="minMaxGradients")
    def min_max_gradients(self) -> Sequence[builtins.str]:
        """
        The minimum and maximum hexadecimal codes that describe a color gradient. List of exactly 2 items.
        """
        return pulumi.get(self, "min_max_gradients")
...
class GetThemeConfigurationUiColorPaletteResult(dict):
    def __init__(__self__, *,
                 accent: builtins.str,
                 accent_foreground: builtins.str,
                 danger: builtins.str,
                 danger_foreground: builtins.str,
                 dimension: builtins.str,
                 dimension_foreground: builtins.str,
                 measure: builtins.str,
                 measure_foreground: builtins.str,
                 primary_background: builtins.str,
                 primary_foreground: builtins.str,
                 secondary_background: builtins.str,
                 secondary_foreground: builtins.str,
                 success: builtins.str,
                 success_foreground: builtins.str,
                 warning: builtins.str,
                 warning_foreground: builtins.str):
        """
        :param builtins.str accent: Color (hexadecimal) that applies to selected states and buttons.
        :param builtins.str accent_foreground: Color (hexadecimal) that applies to any text or other elements that appear over the accent color.
        :param builtins.str danger: Color (hexadecimal) that applies to error messages.
