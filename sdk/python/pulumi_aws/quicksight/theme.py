...
class _ThemeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the theme.
        :param pulumi.Input[builtins.str] aws_account_id: AWS account ID.
        :param pulumi.Input[builtins.str] base_theme_id: The ID of the theme that a custom theme will inherit from. All themes inherit from one of the starting themes defined by Amazon QuickSight. For a list of the starting themes, use ListThemes or choose Themes from within an analysis.
        :param pulumi.Input['ThemeConfigurationArgs'] configuration: The theme configuration, which contains the theme display properties. See configuration.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] created_time: The time that the theme was created.
        ...
        :param pulumi.Input[builtins.str] theme_id: Identifier of the theme.
        :param pulumi.Input[builtins.str] version_description: A description of the current theme version being created/updated.
        :param pulumi.Input[builtins.int] version_number: The version number of the theme version.
        """
        if arn is not None:
    ...
    @property
    @pulumi.getter(name="baseThemeId")
    def base_theme_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the theme that a custom theme will inherit from. All themes inherit from one of the starting themes defined by Amazon QuickSight. For a list of the starting themes, use ListThemes or choose Themes from within an analysis.
        """
        return pulumi.get(self, "base_theme_id")
    ...
    @base_theme_id.setter
    def base_theme_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "base_theme_id", value)
...
class Theme(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            theme_id: Optional[pulumi.Input[builtins.str]] = None,
            version_description: Optional[pulumi.Input[builtins.str]] = None,
            version_number: Optional[pulumi.Input[builtins.int]] = None) -> 'Theme':
        """
