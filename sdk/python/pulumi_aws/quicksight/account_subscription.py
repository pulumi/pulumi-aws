...
class AccountSubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 notification_email: pulumi.Input[builtins.str],
                 active_directory_name: Optional[pulumi.Input[builtins.str]] = None,
                 admin_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 author_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 contact_number: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] edition: Edition of Amazon QuickSight that you want your account to have. Currently, you can choose from `STANDARD`, `ENTERPRISE` or `ENTERPRISE_AND_Q`.
        ...
        :param pulumi.Input[builtins.str] email_address: Email address of the author of the Amazon QuickSight account to use for future communications. This field is required if `ENTERPPRISE_AND_Q` is the selected edition of the new Amazon QuickSight account.
    ...
    def notification_email(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def notification_email(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "notification_email", value)

    @property
    @pulumi.getter(name="activeDirectoryName")
    def active_directory_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def active_directory_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def author_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def contact_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def contact_number(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def iam_identity_center_instance_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def iam_identity_center_instance_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def reader_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _AccountSubscriptionState:
    def __init__(__self__, *,
                 ...
                 account_subscription_status: Optional[pulumi.Input[builtins.str]] = None,
                 active_directory_name: Optional[pulumi.Input[builtins.str]] = None,
                 admin_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    def account_subscription_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def account_subscription_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AccountSubscription(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="accountSubscriptionStatus")
    def account_subscription_status(self) -> pulumi.Output[builtins.str]:
        """
        Status of the Amazon QuickSight account's subscription.
        """
        return pulumi.get(self, "account_subscription_status")
    ...
    @property
    @pulumi.getter(name="activeDirectoryName")
    def active_directory_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of your Active Directory. This field is required if `ACTIVE_DIRECTORY` is the selected authentication method of the new Amazon QuickSight account.
        """
        return pulumi.get(self, "active_directory_name")
    ...
    @property
    @pulumi.getter(name="contactNumber")
    def contact_number(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A 10-digit phone number for the author of the Amazon QuickSight account to use for future communications. This field is required if `ENTERPPRISE_AND_Q` is the selected edition of the new Amazon QuickSight account.
        """
        return pulumi.get(self, "contact_number")
    ...
    @property
    @pulumi.getter(name="iamIdentityCenterInstanceArn")
    def iam_identity_center_instance_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) for the IAM Identity Center instance.
        """
        return pulumi.get(self, "iam_identity_center_instance_arn")
