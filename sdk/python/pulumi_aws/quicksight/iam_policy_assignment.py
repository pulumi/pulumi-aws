...
class IamPolicyAssignmentArgs:
    def __init__(__self__, *,
                 assignment_name: pulumi.Input[builtins.str],
                 assignment_status: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] assignment_name: Name of the assignment.
        :param pulumi.Input[builtins.str] assignment_status: Status of the assignment. Valid values are `ENABLED`, `DISABLED`, and `DRAFT`.
    ...
    def assignment_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def assignment_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "assignment_name", value)

    @property
    @pulumi.getter(name="assignmentStatus")
    def assignment_status(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def assignment_status(self, value: pulumi.Input[builtins.str]):
...
class _IamPolicyAssignmentState:
    def __init__(__self__, *,
                 ...
                 assignment_status: Optional[pulumi.Input[builtins.str]] = None,
                 aws_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 identities: Optional[pulumi.Input['IamPolicyAssignmentIdentitiesArgs']] = None,
                 namespace: Optional[pulumi.Input[builtins.str]] = None,
                 policy_arn: Optional[pulumi.Input[builtins.str]] = None):
        ...
        :param pulumi.Input[builtins.str] assignment_id: Assignment ID.
        :param pulumi.Input[builtins.str] assignment_name: Name of the assignment.
        :param pulumi.Input[builtins.str] assignment_status: Status of the assignment. Valid values are `ENABLED`, `DISABLED`, and `DRAFT`.
    ...
    @property
    @pulumi.getter(name="assignmentStatus")
    def assignment_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Status of the assignment. Valid values are `ENABLED`, `DISABLED`, and `DRAFT`.
    ...
    @assignment_status.setter
    def assignment_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "assignment_status", value)
...
class IamPolicyAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            identities: Optional[pulumi.Input[Union['IamPolicyAssignmentIdentitiesArgs', 'IamPolicyAssignmentIdentitiesArgsDict']]] = None,
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            policy_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'IamPolicyAssignment':
        """
    ...
    @property
    @pulumi.getter(name="assignmentId")
    def assignment_id(self) -> pulumi.Output[builtins.str]:
        """
        Assignment ID.
        """
        return pulumi.get(self, "assignment_id")
    ...
    @property
    @pulumi.getter(name="assignmentStatus")
    def assignment_status(self) -> pulumi.Output[builtins.str]:
        """
        Status of the assignment. Valid values are `ENABLED`, `DISABLED`, and `DRAFT`.
    ...
    @property
    @pulumi.getter(name="policyArn")
    def policy_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARN of the IAM policy to apply to the Amazon QuickSight users and groups specified in this assignment.
        """
        return pulumi.get(self, "policy_arn")
