...
class TemplateAliasArgs:
    ...
    def template_version_number(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def template_version_number(self, value: pulumi.Input[builtins.int]):
...
class _TemplateAliasState:
    ...
    @property
    @pulumi.getter(name="templateVersionNumber")
    def template_version_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Version number of the template.
    ...
    @template_version_number.setter
    def template_version_number(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "template_version_number", value)
...
class TemplateAlias(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="templateVersionNumber")
    def template_version_number(self) -> pulumi.Output[builtins.int]:
        """
        Version number of the template.
