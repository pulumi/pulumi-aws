...
class IngestionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ingestion_id: ID for the ingestion.
    ...
    def ingestion_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ingestion_id.setter
    def ingestion_id(self, value: pulumi.Input[builtins.str]):
...
class _IngestionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_set_id: ID of the dataset used in the ingestion.
        :param pulumi.Input[builtins.str] ingestion_id: ID for the ingestion.
        :param pulumi.Input[builtins.str] ingestion_status: Ingestion status.
        :param pulumi.Input[builtins.str] ingestion_type: Type of ingestion to be created. Valid values are `INCREMENTAL_REFRESH` and `FULL_REFRESH`.
    ...
    @property
    @pulumi.getter(name="ingestionId")
    def ingestion_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID for the ingestion.
        """
        return pulumi.get(self, "ingestion_id")
    ...
    @ingestion_id.setter
    def ingestion_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ingestion_id", value)

    @property
    @pulumi.getter(name="ingestionStatus")
    def ingestion_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Ingestion status.
        """
    ...
    def ingestion_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Ingestion(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ingestionId")
    def ingestion_id(self) -> pulumi.Output[builtins.str]:
        """
        ID for the ingestion.
        """
        return pulumi.get(self, "ingestion_id")
    ...
    @property
    @pulumi.getter(name="ingestionStatus")
    def ingestion_status(self) -> pulumi.Output[builtins.str]:
        """
        Ingestion status.
        """
        return pulumi.get(self, "ingestion_status")
