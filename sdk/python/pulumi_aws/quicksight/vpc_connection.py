...
class VpcConnectionArgs:
    def __init__(__self__, *,
                 ...
                 vpc_connection_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] vpc_connection_id: The ID of the VPC connection.
    ...
    def vpc_connection_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vpc_connection_id(self, value: pulumi.Input[builtins.str]):
    ...
    def dns_resolvers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def dns_resolvers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _VpcConnectionState:
    def __init__(__self__, *,
                 ...
                 timeouts: Optional[pulumi.Input['VpcConnectionTimeoutsArgs']] = None,
                 vpc_connection_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering VpcConnection resources.
        :param pulumi.Input[builtins.str] arn: ARN of the VPC connection.
        :param pulumi.Input[builtins.str] availability_status: The availability status of the VPC connection. Valid values are `AVAILABLE`, `UNAVAILABLE` or `PARTIALLY_AVAILABLE`.
        :param pulumi.Input[builtins.str] aws_account_id: AWS account ID.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_resolvers: A list of IP addresses of DNS resolver endpoints for the VPC connection.
        :param pulumi.Input[builtins.str] name: The display name for the VPC connection.
        :param pulumi.Input[builtins.str] role_arn: The IAM role to associate with the VPC connection.
    ...
    @property
    @pulumi.getter(name="vpcConnectionId")
    def vpc_connection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the VPC connection.
        """
        return pulumi.get(self, "vpc_connection_id")
    ...
    @vpc_connection_id.setter
    def vpc_connection_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpc_connection_id", value)


class VpcConnection(pulumi.CustomResource):

    pulumi_type = "aws:quicksight/vpcConnection:VpcConnection"
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            timeouts: Optional[pulumi.Input[Union['VpcConnectionTimeoutsArgs', 'VpcConnectionTimeoutsArgsDict']]] = None,
            vpc_connection_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcConnection':
        """
    ...
    @property
    @pulumi.getter(name="dnsResolvers")
    def dns_resolvers(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of IP addresses of DNS resolver endpoints for the VPC connection.
        """
        return pulumi.get(self, "dns_resolvers")
    ...
    @property
    @pulumi.getter(name="vpcConnectionId")
    def vpc_connection_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the VPC connection.
        """
        return pulumi.get(self, "vpc_connection_id")
