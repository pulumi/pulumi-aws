...
class DataSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data_source_id: An identifier for the data source.
        ...
        :param pulumi.Input[builtins.str] aws_account_id: The ID for the AWS account that the data source is in. Currently, you use the ID for the AWS account that contains your Amazon QuickSight account.
...
class _DataSourceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the data source
        :param pulumi.Input[builtins.str] aws_account_id: The ID for the AWS account that the data source is in. Currently, you use the ID for the AWS account that contains your Amazon QuickSight account.
        :param pulumi.Input['DataSourceCredentialsArgs'] credentials: The credentials Amazon QuickSight uses to connect to your underlying source. See Credentials below for more details.
        :param pulumi.Input[builtins.str] data_source_id: An identifier for the data source.
        :param pulumi.Input[builtins.str] name: A name for the data source, maximum of 128 characters.
