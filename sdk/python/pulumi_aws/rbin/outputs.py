...
class RuleLockConfigurationUnlockDelay(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'unlockDelayUnit' in kwargs:
            unlock_delay_unit = kwargs['unlockDelayUnit']
        if 'unlockDelayValue' in kwargs:
...
class RuleResourceTag(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'resourceTagKey' in kwargs:
            resource_tag_key = kwargs['resourceTagKey']
        if 'resourceTagValue' in kwargs:
...
class RuleRetentionPeriod(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'retentionPeriodUnit' in kwargs:
            retention_period_unit = kwargs['retentionPeriodUnit']
        if 'retentionPeriodValue' in kwargs:
