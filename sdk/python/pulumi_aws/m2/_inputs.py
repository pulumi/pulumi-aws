...
if not MYPY:
    class ApplicationDefinitionArgsDict(TypedDict):
        ...
        """
        s3_location: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ApplicationDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content: JSON application definition. Either this or `s3_location` must be specified.
        :param pulumi.Input[builtins.str] s3_location: Location of the application definition in S3. Either this or `content` must be specified.
        """
    ...
    def s3_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Location of the application definition in S3. Either this or `content` must be specified.
        """
    ...
    @s3_location.setter
    def s3_location(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EnvironmentHighAvailabilityConfigArgs:
    def __init__(__self__, *,
                 desired_capacity: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] desired_capacity: Desired number of instances for the Environment.
        """
...
if not MYPY:
    class EnvironmentStorageConfigurationEfsArgsDict(TypedDict):
        ...
        """
        mount_point: pulumi.Input[builtins.str]
        """
...
class EnvironmentStorageConfigurationEfsArgs:
    def __init__(__self__, *,
                 ...
                 mount_point: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] file_system_id: Id of the EFS filesystem to mount.
        :param pulumi.Input[builtins.str] mount_point: Path to mount the filesystem on, must start with `/m2/mount/`.
        """
    ...
    def mount_point(self) -> pulumi.Input[builtins.str]:
        """
        Path to mount the filesystem on, must start with `/m2/mount/`.
        """
    ...
    @mount_point.setter
    def mount_point(self, value: pulumi.Input[builtins.str]):
...
class EnvironmentStorageConfigurationFsxArgs:
    def __init__(__self__, *,
                 ...
                 mount_point: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] file_system_id: Id of the FSX filesystem to mount.
        :param pulumi.Input[builtins.str] mount_point: Path to mount the filesystem on, must start with `/m2/mount/`.
        """
        pulumi.set(__self__, "file_system_id", file_system_id)
        pulumi.set(__self__, "mount_point", mount_point)
