...
class MacsecKeyAssociationArgs:
    ...
    @property
    @pulumi.getter
    def cak(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cak.setter
    def cak(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cak", value)

    @property
    @pulumi.getter
    def ckn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ckn.setter
    def ckn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MacsecKeyAssociationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secret_arn: The Amazon Resource Name (ARN) of the MAC Security (MACsec) secret key to associate with the dedicated connection.
               ...
               > **Note:** `ckn` and `cak` are mutually exclusive with `secret_arn` - these arguments cannot be used together. If you use `ckn` and `cak`, you should not use `secret_arn`. If you use the `secret_arn` argument to reference an existing MAC Security (MACSec) secret key, you should not use `ckn` or `cak`.
        :param pulumi.Input[builtins.str] start_on: The date in UTC format that the MAC Security (MACsec) secret key takes effect.
        :param pulumi.Input[builtins.str] state: The state of the MAC Security (MACsec) secret key. The possible values are: associating, associated, disassociating, disassociated. See [MacSecKey](https://docs.aws.amazon.com/directconnect/latest/APIReference/API_MacSecKey.html#DX-Type-MacSecKey-state) for descriptions of each state.
        """
        if cak is not None:
            pulumi.set(__self__, "cak", cak)
        if ckn is not None:
...
class MacsecKeyAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def cak(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The MAC Security (MACsec) CAK to associate with the dedicated connection. The valid values are 64 hexadecimal characters (0-9, A-E). Required if using `ckn`.
        """
        return pulumi.get(self, "cak")
    ...
    @property
    @pulumi.getter
    def ckn(self) -> pulumi.Output[builtins.str]:
        """
        The MAC Security (MACsec) CKN to associate with the dedicated connection. The valid values are 64 hexadecimal characters (0-9, A-E). Required if using `cak`.
        """
        return pulumi.get(self, "ckn")
    ...
    @property
    @pulumi.getter(name="startOn")
    def start_on(self) -> pulumi.Output[builtins.str]:
        """
        The date in UTC format that the MAC Security (MACsec) secret key takes effect.
        """
        return pulumi.get(self, "start_on")
