...
class PublicVirtualInterfaceArgs:
    def __init__(__self__, *,
        ...
        """
        PublicVirtualInterfaceArgs._configure(
    ...
    def _configure(
        ...
        if route_filter_prefixes is None and 'routeFilterPrefixes' in kwargs:
            route_filter_prefixes = kwargs['routeFilterPrefixes']
        if route_filter_prefixes is None:
            raise TypeError("Missing 'route_filter_prefixes' argument")
        if vlan is None:
...
class _PublicVirtualInterfaceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] vlan: The VLAN ID.
        """
        _PublicVirtualInterfaceState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            address_family=address_family,
            amazon_address=amazon_address,
...
class PublicVirtualInterface(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PublicVirtualInterfaceArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            vlan: Optional[pulumi.Input[int]] = None) -> 'PublicVirtualInterface':
        """
