...
class PublicVirtualInterfaceArgs:
    ...
    def route_filter_prefixes(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class PublicVirtualInterface(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vlan: Optional[pulumi.Input[_builtins.int]] = None) -> 'PublicVirtualInterface':
        """
