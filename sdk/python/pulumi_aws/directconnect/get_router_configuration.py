...
def get_router_configuration_output(region: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                    router_type_identifier: pulumi.Input[Optional[_builtins.str]] = None,
