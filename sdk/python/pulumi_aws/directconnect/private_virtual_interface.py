...
class PrivateVirtualInterfaceArgs:
    ...
    def sitelink_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class PrivateVirtualInterface(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vlan: Optional[pulumi.Input[builtins.int]] = None,
            vpn_gateway_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateVirtualInterface':
        """
    ...
    @property
    @pulumi.getter(name="sitelinkEnabled")
    def sitelink_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether to enable or disable SiteLink.
        """
        return pulumi.get(self, "sitelink_enabled")
