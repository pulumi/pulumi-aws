...
class LinkAggregationGroupArgs:
    def __init__(__self__, *,
                 connections_bandwidth: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] connections_bandwidth: The bandwidth of the individual dedicated connections bundled by the LAG. Valid values: 1Gbps, 10Gbps, 100Gbps, and 400Gbps. Case sensitive. Refer to the AWS Direct Connection supported bandwidths for [Dedicated Connections](https://docs.aws.amazon.com/directconnect/latest/UserGuide/dedicated_connection.html).
        :param pulumi.Input[builtins.str] location: The AWS Direct Connect location in which the LAG should be allocated. See [DescribeLocations](https://docs.aws.amazon.com/directconnect/latest/APIReference/API_DescribeLocations.html) for the list of AWS Direct Connect locations. Use `locationCode`.
        :param pulumi.Input[builtins.str] connection_id: The ID of an existing dedicated connection to migrate to the LAG.
        :param pulumi.Input[builtins.bool] force_destroy: A boolean that indicates all connections associated with the LAG should be deleted so that the LAG can be destroyed without error. These objects are *not* recoverable.
        :param pulumi.Input[builtins.str] name: The name of the LAG.
        :param pulumi.Input[builtins.str] provider_name: The name of the service provider associated with the LAG.
    ...
    def connections_bandwidth(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connections_bandwidth(self, value: pulumi.Input[builtins.str]):
...
class _LinkAggregationGroupState:
    def __init__(__self__, *,
                 ...
                 connection_id: Optional[pulumi.Input[builtins.str]] = None,
                 connections_bandwidth: Optional[pulumi.Input[builtins.str]] = None,
                 force_destroy: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the LAG.
        :param pulumi.Input[builtins.str] connection_id: The ID of an existing dedicated connection to migrate to the LAG.
        :param pulumi.Input[builtins.str] connections_bandwidth: The bandwidth of the individual dedicated connections bundled by the LAG. Valid values: 1Gbps, 10Gbps, 100Gbps, and 400Gbps. Case sensitive. Refer to the AWS Direct Connection supported bandwidths for [Dedicated Connections](https://docs.aws.amazon.com/directconnect/latest/UserGuide/dedicated_connection.html).
        :param pulumi.Input[builtins.bool] force_destroy: A boolean that indicates all connections associated with the LAG should be deleted so that the LAG can be destroyed without error. These objects are *not* recoverable.
        :param pulumi.Input[builtins.str] has_logical_redundancy: Indicates whether the LAG supports a secondary BGP peer in the same address family (IPv4/IPv6).
        :param pulumi.Input[builtins.bool] jumbo_frame_capable: Indicates whether jumbo frames (9001 MTU) are supported.
        :param pulumi.Input[builtins.str] location: The AWS Direct Connect location in which the LAG should be allocated. See [DescribeLocations](https://docs.aws.amazon.com/directconnect/latest/APIReference/API_DescribeLocations.html) for the list of AWS Direct Connect locations. Use `locationCode`.
        :param pulumi.Input[builtins.str] name: The name of the LAG.
        :param pulumi.Input[builtins.str] owner_account_id: The ID of the AWS account that owns the LAG.
        :param pulumi.Input[builtins.str] provider_name: The name of the service provider associated with the LAG.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the resource. .If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    @property
    @pulumi.getter(name="connectionsBandwidth")
    def connections_bandwidth(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The bandwidth of the individual dedicated connections bundled by the LAG. Valid values: 1Gbps, 10Gbps, 100Gbps, and 400Gbps. Case sensitive. Refer to the AWS Direct Connection supported bandwidths for [Dedicated Connections](https://docs.aws.amazon.com/directconnect/latest/UserGuide/dedicated_connection.html).
        """
        return pulumi.get(self, "connections_bandwidth")
    ...
    @connections_bandwidth.setter
    def connections_bandwidth(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "connections_bandwidth", value)
...
class LinkAggregationGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            provider_name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'LinkAggregationGroup':
        """
    ...
    @property
    @pulumi.getter(name="connectionsBandwidth")
    def connections_bandwidth(self) -> pulumi.Output[builtins.str]:
        """
        The bandwidth of the individual dedicated connections bundled by the LAG. Valid values: 1Gbps, 10Gbps, 100Gbps, and 400Gbps. Case sensitive. Refer to the AWS Direct Connection supported bandwidths for [Dedicated Connections](https://docs.aws.amazon.com/directconnect/latest/UserGuide/dedicated_connection.html).
        """
        return pulumi.get(self, "connections_bandwidth")
