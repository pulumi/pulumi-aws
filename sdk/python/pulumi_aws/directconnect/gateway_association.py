...
class GatewayAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] associated_gateway_owner_account_id: The ID of the AWS account that owns the VGW or transit gateway with which to associate the Direct Connect gateway.
               Used for cross-account Direct Connect gateway associations.
        :param pulumi.Input[builtins.str] proposal_id: The ID of the Direct Connect gateway association proposal.
               Used for cross-account Direct Connect gateway associations.
    ...
    def dx_gateway_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dx_gateway_id(self, value: pulumi.Input[builtins.str]):
    ...
    def associated_gateway_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def associated_gateway_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "associated_gateway_id", value)

    @property
    @pulumi.getter(name="associatedGatewayOwnerAccountId")
    def associated_gateway_owner_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def associated_gateway_owner_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "associated_gateway_owner_account_id", value)

    @property
    @pulumi.getter(name="proposalId")
    def proposal_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class _GatewayAssociationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dx_gateway_association_id: The ID of the Direct Connect gateway association.
        :param pulumi.Input[builtins.str] dx_gateway_id: The ID of the Direct Connect gateway.
        :param pulumi.Input[builtins.str] dx_gateway_owner_account_id: The ID of the AWS account that owns the Direct Connect gateway.
        :param pulumi.Input[builtins.str] proposal_id: The ID of the Direct Connect gateway association proposal.
               Used for cross-account Direct Connect gateway associations.
        :param pulumi.Input[builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        """
    ...
    def associated_gateway_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def associated_gateway_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "associated_gateway_type", value)

    @property
    @pulumi.getter(name="dxGatewayAssociationId")
    def dx_gateway_association_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dx_gateway_association_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dx_gateway_owner_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class GatewayAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            dx_gateway_owner_account_id: Optional[pulumi.Input[builtins.str]] = None,
            proposal_id: Optional[pulumi.Input[builtins.str]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None) -> 'GatewayAssociation':
        """
    ...
    @property
    @pulumi.getter(name="allowedPrefixes")
    def allowed_prefixes(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        VPC prefixes (CIDRs) to advertise to the Direct Connect gateway. Defaults to the CIDR block of the VPC associated with the Virtual Gateway. To enable drift detection, must be configured.
    ...
    @property
    @pulumi.getter(name="associatedGatewayId")
    def associated_gateway_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the VGW or transit gateway with which to associate the Direct Connect gateway.
        Used for single account Direct Connect gateway associations.
        """
    ...
    @property
    @pulumi.getter(name="associatedGatewayOwnerAccountId")
    def associated_gateway_owner_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the AWS account that owns the VGW or transit gateway with which to associate the Direct Connect gateway.
        Used for cross-account Direct Connect gateway associations.
        """
    ...
    @property
    @pulumi.getter(name="associatedGatewayType")
    def associated_gateway_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the associated gateway, `transitGateway` or `virtualPrivateGateway`.
        """
        return pulumi.get(self, "associated_gateway_type")
    ...
    @property
    @pulumi.getter(name="dxGatewayAssociationId")
    def dx_gateway_association_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Direct Connect gateway association.
        """
        return pulumi.get(self, "dx_gateway_association_id")
    ...
    @property
    @pulumi.getter(name="dxGatewayId")
    def dx_gateway_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Direct Connect gateway.
        """
        return pulumi.get(self, "dx_gateway_id")
    ...
    @property
    @pulumi.getter(name="dxGatewayOwnerAccountId")
    def dx_gateway_owner_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the AWS account that owns the Direct Connect gateway.
        """
        return pulumi.get(self, "dx_gateway_owner_account_id")
    ...
    @property
    @pulumi.getter(name="proposalId")
    def proposal_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the Direct Connect gateway association proposal.
        Used for cross-account Direct Connect gateway associations.
        """
