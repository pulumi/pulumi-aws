...
class GatewayArgs:
    def __init__(__self__, *,
                 amazon_side_asn: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Gateway resource.
        :param pulumi.Input[builtins.str] amazon_side_asn: The ASN to be configured on the Amazon side of the connection. The ASN must be in the private range of 64,512 to 65,534 or 4,200,000,000 to 4,294,967,294.
    ...
    def amazon_side_asn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def amazon_side_asn(self, value: pulumi.Input[builtins.str]):
...
class _GatewayState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] amazon_side_asn: The ASN to be configured on the Amazon side of the connection. The ASN must be in the private range of 64,512 to 65,534 or 4,200,000,000 to 4,294,967,294.
        :param pulumi.Input[builtins.str] arn: The ARN of the gateway.
        :param pulumi.Input[builtins.str] name: The name of the connection.
        :param pulumi.Input[builtins.str] owner_account_id: AWS Account ID of the gateway.
        """
...
class Gateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            arn: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            owner_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Gateway':
        """
