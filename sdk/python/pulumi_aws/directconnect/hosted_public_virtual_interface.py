...
class HostedPublicVirtualInterface(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name, id, opts=None, address_family=None, amazon_address=None, arn=None, aws_device=None, bgp_asn=None, bgp_auth_key=None, connection_id=None, customer_address=None, name=None, owner_account_id=None, route_filter_prefixes=None, vlan=None):
        """
