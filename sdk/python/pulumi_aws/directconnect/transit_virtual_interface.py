...
class TransitVirtualInterface(pulumi.CustomResource):
    ...
    @staticmethod
    def get(resource_name, id, opts=None, address_family=None, amazon_address=None, arn=None, aws_device=None, bgp_asn=None, bgp_auth_key=None, connection_id=None, customer_address=None, dx_gateway_id=None, jumbo_frame_capable=None, mtu=None, name=None, tags=None, vlan=None):
        """
