...
class HostedTransitVirtualInterfaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] mtu: The maximum transmission unit (MTU) is the size, in bytes, of the largest permissible packet that can be passed over the connection. The MTU of a virtual transit interface can be either `1500` or `8500` (jumbo frames). Default is `1500`.
        :param pulumi.Input[str] name: The name for the virtual interface.
        """
        HostedTransitVirtualInterfaceArgs._configure(
...
class _HostedTransitVirtualInterfaceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] vlan: The VLAN ID.
        """
        _HostedTransitVirtualInterfaceState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            address_family=address_family,
            amazon_address=amazon_address,
...
class HostedTransitVirtualInterface(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            HostedTransitVirtualInterfaceArgs._configure(_setter, **kwargs)
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            owner_account_id: Optional[pulumi.Input[str]] = None,
            vlan: Optional[pulumi.Input[int]] = None) -> 'HostedTransitVirtualInterface':
        """
