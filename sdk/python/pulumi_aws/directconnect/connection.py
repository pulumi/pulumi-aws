...
class ConnectionArgs:
    ...
    def request_macsec(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ConnectionState:
    def __init__(__self__, *,
                 ...
                 macsec_capable: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the connection.
        ...
        :param pulumi.Input[builtins.str] location: The AWS Direct Connect location where the connection is located. See [DescribeLocations](https://docs.aws.amazon.com/directconnect/latest/APIReference/API_DescribeLocations.html) for the list of AWS Direct Connect locations. Use `locationCode`.
        :param pulumi.Input[builtins.bool] macsec_capable: Boolean value indicating whether the connection supports MAC Security (MACsec).
        :param pulumi.Input[builtins.str] name: The name of the connection.
        :param pulumi.Input[builtins.str] owner_account_id: The ID of the AWS account that owns the connection.
    ...
    def macsec_capable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def macsec_capable(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def port_encryption_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def port_encryption_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Connection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="macsecCapable")
    def macsec_capable(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean value indicating whether the connection supports MAC Security (MACsec).
        """
        return pulumi.get(self, "macsec_capable")
    ...
    @property
    @pulumi.getter(name="portEncryptionStatus")
    def port_encryption_status(self) -> pulumi.Output[builtins.str]:
        """
        The MAC Security (MACsec) port link status of the connection.
        """
        return pulumi.get(self, "port_encryption_status")
