...
class V2modelsSlotArgs:
    def __init__(__self__, *,
                 ...
                 intent_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] bot_id: Identifier of the bot associated with the slot.
        :param pulumi.Input[builtins.str] bot_version: Version of the bot associated with the slot.
        :param pulumi.Input[builtins.str] intent_id: Identifier of the intent that contains the slot.
        :param pulumi.Input[builtins.str] locale_id: Identifier of the language and locale that the slot will be used in.
        :param pulumi.Input[builtins.str] description: Description of the slot.
    ...
    def intent_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @intent_id.setter
    def intent_id(self, value: pulumi.Input[builtins.str]):
...
class V2modelsSlot(pulumi.CustomResource):
    ...
    pulumi_type = "aws:lex/v2modelsSlot:V2modelsSlot"
