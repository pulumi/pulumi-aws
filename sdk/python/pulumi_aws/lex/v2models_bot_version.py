...
class V2modelsBotVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bot_id: Idientifier of the bot to create the version for.
    ...
    def bot_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bot_version.setter
    def bot_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _V2modelsBotVersionState:
    ...
    @property
    @pulumi.getter(name="botId")
    def bot_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Idientifier of the bot to create the version for.
        """
        return pulumi.get(self, "bot_id")
    ...
    @bot_id.setter
    def bot_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bot_id", value)
...
class V2modelsBotVersion(pulumi.CustomResource):
    ...
    pulumi_type = "aws:lex/v2modelsBotVersion:V2modelsBotVersion"
