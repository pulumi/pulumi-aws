...
class BotAlias(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if conversation_logs is not None and not isinstance(conversation_logs, BotAliasConversationLogsArgs):
                conversation_logs = conversation_logs or {}
                def _setter(key, value):
                    conversation_logs[key] = value
                BotAliasConversationLogsArgs._configure(_setter, **conversation_logs)
