...
class V2modelsBotArgs:
    def __init__(__self__, *,
                 idle_session_ttl_in_seconds: pulumi.Input[builtins.int],
    ...
    def idle_session_ttl_in_seconds(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def idle_session_ttl_in_seconds(self, value: pulumi.Input[builtins.int]):
    ...
    def test_bot_alias_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def test_bot_alias_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class V2modelsBot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            test_bot_alias_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            timeouts: Optional[pulumi.Input[Union['V2modelsBotTimeoutsArgs', 'V2modelsBotTimeoutsArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'V2modelsBot':
        """
    ...
    @property
    @pulumi.getter(name="testBotAliasTags")
    def test_bot_alias_tags(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        List of tags to add to the test alias for a bot. You can only add tags when you create a bot.
        """
        return pulumi.get(self, "test_bot_alias_tags")
