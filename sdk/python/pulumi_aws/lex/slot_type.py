...
class SlotTypeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] create_version: Determines if a new slot type version is created when the initial resource is created and on each
    ...
    def value_selection_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SlotTypeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] checksum: Checksum identifying the version of the slot type that was created. The checksum is
               not included as an argument because the resource will add it automatically when updating the slot type.
        :param pulumi.Input[builtins.bool] create_version: Determines if a new slot type version is created when the initial resource is created and on each
               update. Defaults to `false`.
        :param pulumi.Input[builtins.str] created_date: The date when the slot type version was created.
        :param pulumi.Input[builtins.str] description: A description of the slot type. Must be less than or equal to 200 characters in length.
        :param pulumi.Input[Sequence[pulumi.Input['SlotTypeEnumerationValueArgs']]] enumeration_values: A list of EnumerationValue objects that defines the values that
               the slot type can take. Each value can have a list of synonyms, which are additional values that help
               train the machine learning model about the values that it resolves for a slot. Attributes are
        ...
        :param pulumi.Input[builtins.str] value_selection_strategy: Determines the slot resolution strategy that Amazon Lex
               ...
               value is similar to the slot value. `TOP_RESOLUTION` returns the first value in the resolution list
               if there is a resolution list for the slot, otherwise null is returned. Defaults to `ORIGINAL_VALUE`.
        :param pulumi.Input[builtins.str] version: The version of the slot type.
        """
...
class SlotType(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="valueSelectionStrategy")
    def value_selection_strategy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Determines the slot resolution strategy that Amazon Lex
        uses to return slot type values. `ORIGINAL_VALUE` returns the value entered by the user if the user
        value is similar to the slot value. `TOP_RESOLUTION` returns the first value in the resolution list
