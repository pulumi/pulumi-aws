...
class GetBotResult:
    ...
    def enable_model_improvements(self) -> builtins.bool:
        """
    ...
    def idle_session_ttl_in_seconds(self) -> builtins.int:
        """
    ...
    def nlu_intent_confidence_threshold(self) -> builtins.float:
        """
