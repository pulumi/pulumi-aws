...
class V2modelsBotLocaleArgs:
    def __init__(__self__, *,
                 ...
                 bot_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] bot_id: Identifier of the bot to create the locale for.
        :param pulumi.Input[builtins.str] bot_version: Version of the bot to create the locale for. This can only be the draft version of the bot.
        :param pulumi.Input[builtins.str] locale_id: Identifier of the language and locale that the bot will be used in. The string must match one of the supported locales. All of the intents, slot types, and slots used in the bot must have the same locale. For more information, see Supported languages (https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html)
        :param pulumi.Input[builtins.float] n_lu_intent_confidence_threshold: Determines the threshold where Amazon Lex will insert the AMAZON.FallbackIntent, AMAZON.KendraSearchIntent, or both when returning alternative intents.
    ...
    def bot_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @bot_version.setter
    def bot_version(self, value: pulumi.Input[builtins.str]):
    ...
    def n_lu_intent_confidence_threshold(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def n_lu_intent_confidence_threshold(self, value: pulumi.Input[builtins.float]):
...
class _V2modelsBotLocaleState:
    ...
    @property
    @pulumi.getter(name="localeId")
    def locale_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Identifier of the language and locale that the bot will be used in. The string must match one of the supported locales. All of the intents, slot types, and slots used in the bot must have the same locale. For more information, see Supported languages (https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html)
        """
        return pulumi.get(self, "locale_id")
    ...
    @locale_id.setter
    def locale_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "locale_id", value)

    @property
    @pulumi.getter(name="nLuIntentConfidenceThreshold")
    def n_lu_intent_confidence_threshold(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Determines the threshold where Amazon Lex will insert the AMAZON.FallbackIntent, AMAZON.KendraSearchIntent, or both when returning alternative intents.
    ...
    @n_lu_intent_confidence_threshold.setter
    def n_lu_intent_confidence_threshold(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "n_lu_intent_confidence_threshold", value)
...
class V2modelsBotLocale(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="localeId")
    def locale_id(self) -> pulumi.Output[builtins.str]:
        """
        Identifier of the language and locale that the bot will be used in. The string must match one of the supported locales. All of the intents, slot types, and slots used in the bot must have the same locale. For more information, see Supported languages (https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html)
        """
        return pulumi.get(self, "locale_id")
    ...
    @property
    @pulumi.getter(name="nLuIntentConfidenceThreshold")
    def n_lu_intent_confidence_threshold(self) -> pulumi.Output[builtins.float]:
        """
        Determines the threshold where Amazon Lex will insert the AMAZON.FallbackIntent, AMAZON.KendraSearchIntent, or both when returning alternative intents.
