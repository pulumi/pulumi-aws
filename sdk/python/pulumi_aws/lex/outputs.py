...
class BotIntent(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'intentName' in kwargs:
            intent_name = kwargs['intentName']
        if 'intentVersion' in kwargs:
...
class IntentSlot(dict):
    ...
    def _configure(
        ...
        if 'slotTypeVersion' in kwargs:
            slot_type_version = kwargs['slotTypeVersion']
        if 'valueElicitationPrompt' in kwargs:
