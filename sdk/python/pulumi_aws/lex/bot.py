...
class BotArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if abort_statement is None and 'abortStatement' in kwargs:
            abort_statement = kwargs['abortStatement']
        if abort_statement is None:
            raise TypeError("Missing 'abort_statement' argument")
        ...
        if intents is None:
            raise TypeError("Missing 'intents' argument")
        if clarification_prompt is None and 'clarificationPrompt' in kwargs:
        ...
        if enable_model_improvements is None and 'enableModelImprovements' in kwargs:
        ...
        if nlu_intent_confidence_threshold is None and 'nluIntentConfidenceThreshold' in kwargs:
            nlu_intent_confidence_threshold = kwargs['nluIntentConfidenceThreshold']
        if process_behavior is None and 'processBehavior' in kwargs:
...
class Bot(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            abort_statement = _utilities.configure(abort_statement, BotAbortStatementArgs, True)
            ...
            clarification_prompt = _utilities.configure(clarification_prompt, BotClarificationPromptArgs, True)
