...
if not MYPY:
    class FileSystemAssociationCacheAttributesArgsDict(TypedDict):
        cache_stale_timeout_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class FileSystemAssociationCacheAttributesArgs:
    def __init__(__self__, *,
                 cache_stale_timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] cache_stale_timeout_in_seconds: Refreshes a file share's cache by using Time To Live (TTL).
               TTL is the length of time since the last refresh after which access to the directory would cause the file gateway
               to first refresh that directory's contents from the Amazon S3 bucket. Valid Values: `0` or `300` to `2592000` seconds (5 minutes to 30 days). Defaults to `0`
        """
    ...
    def cache_stale_timeout_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Refreshes a file share's cache by using Time To Live (TTL).
        TTL is the length of time since the last refresh after which access to the directory would cause the file gateway
        to first refresh that directory's contents from the Amazon S3 bucket. Valid Values: `0` or `300` to `2592000` seconds (5 minutes to 30 days). Defaults to `0`
    ...
    def cache_stale_timeout_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class GatewayGatewayNetworkInterfaceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] ipv4_address: The Internet Protocol version 4 (IPv4) address of the interface.
        """
...
if not MYPY:
    class GatewayMaintenanceStartTimeArgsDict(TypedDict):
        ...
        """
        minute_of_hour: NotRequired[pulumi.Input[builtins.int]]
        """
...
class GatewayMaintenanceStartTimeArgs:
    def __init__(__self__, *,
                 ...
                 minute_of_hour: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] hour_of_day: The hour component of the maintenance start time represented as _hh_, where _hh_ is the hour (00 to 23). The hour of the day is in the time zone of the gateway.
        :param pulumi.Input[builtins.str] day_of_month: The day of the month component of the maintenance start time represented as an ordinal number from 1 to 28, where 1 represents the first day of the month and 28 represents the last day of the month.
        :param pulumi.Input[builtins.str] day_of_week: The day of the week component of the maintenance start time week represented as an ordinal number from 0 to 6, where 0 represents Sunday and 6 Saturday.
        :param pulumi.Input[builtins.int] minute_of_hour: The minute component of the maintenance start time represented as _mm_, where _mm_ is the minute (00 to 59). The minute of the hour is in the time zone of the gateway.
        """
    ...
    def minute_of_hour(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The minute component of the maintenance start time represented as _mm_, where _mm_ is the minute (00 to 59). The minute of the hour is in the time zone of the gateway.
        """
    ...
    def minute_of_hour(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class GatewaySmbActiveDirectorySettingsArgsDict(TypedDict):
        ...
        """
        active_directory_status: NotRequired[pulumi.Input[builtins.str]]
        domain_controllers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class GatewaySmbActiveDirectorySettingsArgs:
    def __init__(__self__, *,
                 ...
                 password: pulumi.Input[builtins.str],
                 username: pulumi.Input[builtins.str],
                 active_directory_status: Optional[pulumi.Input[builtins.str]] = None,
                 domain_controllers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 organizational_unit: Optional[pulumi.Input[builtins.str]] = None,
                 timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] domain_name: The name of the domain that you want the gateway to join.
        :param pulumi.Input[builtins.str] password: The password of the user who has permission to add the gateway to the Active Directory domain.
        :param pulumi.Input[builtins.str] username: The user name of user who has permission to add the gateway to the Active Directory domain.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domain_controllers: List of IPv4 addresses, NetBIOS names, or host names of your domain server.
               If you need to specify the port number include it after the colon (“:”). For example, `mydc.mydomain.com:389`.
        :param pulumi.Input[builtins.str] organizational_unit: The organizational unit (OU) is a container in an Active Directory that can hold users, groups,
               computers, and other OUs and this parameter specifies the OU that the gateway will join within the AD domain.
        :param pulumi.Input[builtins.int] timeout_in_seconds: Specifies the time in seconds, in which the JoinDomain operation must complete. The default is `20` seconds.
        """
    ...
    def active_directory_status(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "active_directory_status")

    @active_directory_status.setter
    def active_directory_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "active_directory_status", value)

    @property
    @pulumi.getter(name="domainControllers")
    def domain_controllers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of IPv4 addresses, NetBIOS names, or host names of your domain server.
        If you need to specify the port number include it after the colon (“:”). For example, `mydc.mydomain.com:389`.
        """
    ...
    def domain_controllers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class NfsFileShareNfsFileShareDefaultsArgsDict(TypedDict):
        directory_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NfsFileShareNfsFileShareDefaultsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] directory_mode: The Unix directory mode in the string form "nnnn". Defaults to `"0777"`.
        :param pulumi.Input[builtins.str] file_mode: The Unix file mode in the string form "nnnn". Defaults to `"0666"`.
        :param pulumi.Input[builtins.str] group_id: The default group ID for the file share (unless the files have another group ID specified). Defaults to `65534` (`nfsnobody`). Valid values: `0` through `4294967294`.
        :param pulumi.Input[builtins.str] owner_id: The default owner ID for the file share (unless the files have another owner ID specified). Defaults to `65534` (`nfsnobody`). Valid values: `0` through `4294967294`.
        """
    ...
    def directory_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Unix directory mode in the string form "nnnn". Defaults to `"0777"`.
        """
    ...
    def directory_mode(self, value: Optional[pulumi.Input[builtins.str]]):
