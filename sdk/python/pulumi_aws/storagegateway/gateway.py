...
class GatewayArgs:
    ...
    def _configure(
        ...
        if 'gatewayIpAddress' in kwargs:
            gateway_ip_address = kwargs['gatewayIpAddress']
        if 'gatewayType' in kwargs:
            gateway_type = kwargs['gatewayType']
        if 'gatewayVpcEndpoint' in kwargs:
...
class _GatewayState:
    ...
    def _configure(
        ...
        if 'gatewayName' in kwargs:
            gateway_name = kwargs['gatewayName']
        if 'gatewayNetworkInterfaces' in kwargs:
