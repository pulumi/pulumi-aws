...
class SmbFileShare(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cache_attributes is not None and not isinstance(cache_attributes, SmbFileShareCacheAttributesArgs):
                cache_attributes = cache_attributes or {}
                def _setter(key, value):
                    cache_attributes[key] = value
                SmbFileShareCacheAttributesArgs._configure(_setter, **cache_attributes)
