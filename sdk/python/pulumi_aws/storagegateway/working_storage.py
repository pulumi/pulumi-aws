...
class WorkingStorage(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Using `pulumi import`, import `storagegateway.WorkingStorage` using the gateway Amazon Resource Name (ARN) and local disk identifier separated with a colon (`:`). For example:
