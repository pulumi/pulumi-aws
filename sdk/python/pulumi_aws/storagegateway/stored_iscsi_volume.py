...
class StoredIscsiVolumeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] kms_key: ARN of the AWS KMS key used for Amazon S3 server side encryption. This value can only be set when `kms_encrypted` is `true`.
    ...
    def kms_key(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ARN of the AWS KMS key used for Amazon S3 server side encryption. This value can only be set when `kms_encrypted` is `true`.
        """
...
class _StoredIscsiVolumeState:
    def __init__(__self__, *,
                 ...
                 preserve_existing_data: pulumi.Input[Optional[_builtins.bool]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 snapshot_id: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 ...
                 volume_attachment_status: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="preserveExistingData")
    def preserve_existing_data(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Specify this field as `true` if you want to preserve the data on the local disk. Otherwise, specifying this field as false creates an empty volume.
        """
        return pulumi.get(self, "preserve_existing_data")
    ...
    @preserve_existing_data.setter
    def preserve_existing_data(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "preserve_existing_data", value)
    ...
    def volume_attachment_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def volume_attachment_status(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class StoredIscsiVolume(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volume_size_in_bytes: pulumi.Input[Optional[_builtins.int]] = None,
            volume_status: pulumi.Input[Optional[_builtins.str]] = None,
            volume_type: pulumi.Input[Optional[_builtins.str]] = None) -> 'StoredIscsiVolume':
        """
