...
class StoredIscsiVolumeArgs:
    def __init__(__self__, *,
                 ...
                 preserve_existing_data: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.str] disk_id: The unique identifier for the gateway local disk that is configured as a stored volume.
        ...
        :param pulumi.Input[builtins.bool] preserve_existing_data: Specify this field as `true` if you want to preserve the data on the local disk. Otherwise, specifying this field as false creates an empty volume.
        ...
        :param pulumi.Input[builtins.bool] kms_encrypted: `true` to use Amazon S3 server side encryption with your own AWS KMS key, or `false` to use a key managed by Amazon S3. Optional.
        :param pulumi.Input[builtins.str] kms_key: The Amazon Resource Name (ARN) of the AWS KMS key used for Amazon S3 server side encryption. This value can only be set when `kms_encrypted` is `true`.
        :param pulumi.Input[builtins.str] snapshot_id: The snapshot ID of the snapshot to restore as the new stored volumeE.g., `snap-1122aabb`.
    ...
    def preserve_existing_data(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def preserve_existing_data(self, value: pulumi.Input[builtins.bool]):
...
class _StoredIscsiVolumeState:
    def __init__(__self__, *,
                 ...
                 preserve_existing_data: Optional[pulumi.Input[builtins.bool]] = None,
                 snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 target_arn: Optional[pulumi.Input[builtins.str]] = None,
                 target_name: Optional[pulumi.Input[builtins.str]] = None,
                 volume_attachment_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] target_name: The name of the iSCSI target used by initiators to connect to the target and as a suffix for the target ARN. The target name must be unique across all volumes of a gateway.
        :param pulumi.Input[builtins.str] volume_attachment_status: A value that indicates whether a storage volume is attached to, detached from, or is in the process of detaching from a gateway.
        :param pulumi.Input[builtins.str] volume_id: Volume ID, e.g., `vol-12345678`.
        :param pulumi.Input[builtins.int] volume_size_in_bytes: The size of the data stored on the volume in bytes.
        :param pulumi.Input[builtins.str] volume_status: indicates the state of the storage volume.
        :param pulumi.Input[builtins.str] volume_type: indicates the type of the volume.
        """
        if arn is not None:
    ...
    @property
    @pulumi.getter(name="preserveExistingData")
    def preserve_existing_data(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specify this field as `true` if you want to preserve the data on the local disk. Otherwise, specifying this field as false creates an empty volume.
        """
        return pulumi.get(self, "preserve_existing_data")
    ...
    @preserve_existing_data.setter
    def preserve_existing_data(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "preserve_existing_data", value)
    ...
    def volume_attachment_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def volume_attachment_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StoredIscsiVolume(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volume_size_in_bytes: Optional[pulumi.Input[builtins.int]] = None,
            volume_status: Optional[pulumi.Input[builtins.str]] = None,
            volume_type: Optional[pulumi.Input[builtins.str]] = None) -> 'StoredIscsiVolume':
        """
    ...
    @property
    @pulumi.getter(name="preserveExistingData")
    def preserve_existing_data(self) -> pulumi.Output[builtins.bool]:
        """
        Specify this field as `true` if you want to preserve the data on the local disk. Otherwise, specifying this field as false creates an empty volume.
        """
        return pulumi.get(self, "preserve_existing_data")
    ...
    @property
    @pulumi.getter(name="volumeAttachmentStatus")
    def volume_attachment_status(self) -> pulumi.Output[builtins.str]:
        """
        A value that indicates whether a storage volume is attached to, detached from, or is in the process of detaching from a gateway.
        """
        return pulumi.get(self, "volume_attachment_status")
