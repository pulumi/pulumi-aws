...
class StoredIscsiVolumeArgs:
    ...
    def _configure(
        ...
        if 'preserveExistingData' in kwargs:
...
class _StoredIscsiVolumeState:
    ...
    def _configure(
        ...
        if 'kmsKey' in kwargs:
            kms_key = kwargs['kmsKey']
        if 'lunNumber' in kwargs:
            lun_number = kwargs['lunNumber']
        if 'networkInterfaceId' in kwargs:
            network_interface_id = kwargs['networkInterfaceId']
        if 'networkInterfacePort' in kwargs:
