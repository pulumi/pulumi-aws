...
class ResourceShareAccepterArgs:
    ...
    def share_arn(self) -> pulumi.Input[builtins.str]:
        """
...
class _ResourceShareAccepterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] share_arn: The ARN of the resource share.
        :param pulumi.Input[builtins.str] share_id: The ID of the resource share as displayed in the console.
        :param pulumi.Input[builtins.str] share_name: The name of the resource share.
        :param pulumi.Input[builtins.str] status: The status of the resource share (ACTIVE, PENDING, FAILED, DELETING, DELETED).
        """
    ...
    def invitation_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def invitation_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "invitation_arn", value)

    @property
    @pulumi.getter(name="receiverAccountId")
    def receiver_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sender_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sender_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sender_account_id", value)

    @property
    @pulumi.getter(name="shareArn")
    def share_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the resource share.
        """
        return pulumi.get(self, "share_arn")
    ...
    @share_arn.setter
    def share_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "share_arn", value)
...
class ResourceShareAccepter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            share_id: Optional[pulumi.Input[builtins.str]] = None,
            share_name: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ResourceShareAccepter':
        """
    ...
    @property
    @pulumi.getter(name="invitationArn")
    def invitation_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the resource share invitation.
        """
        return pulumi.get(self, "invitation_arn")
    ...
    @property
    @pulumi.getter(name="receiverAccountId")
    def receiver_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The account ID of the receiver account which accepts the invitation.
        """
        return pulumi.get(self, "receiver_account_id")
    ...
    @property
    @pulumi.getter(name="senderAccountId")
    def sender_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The account ID of the sender account which submits the invitation.
        """
        return pulumi.get(self, "sender_account_id")
    ...
    @property
    @pulumi.getter(name="shareArn")
    def share_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the resource share.
        """
        return pulumi.get(self, "share_arn")
