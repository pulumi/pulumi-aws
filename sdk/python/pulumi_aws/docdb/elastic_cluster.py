...
class ElasticClusterArgs:
    def __init__(__self__, *,
                 admin_user_name: pulumi.Input[builtins.str],
                 admin_user_password: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] admin_user_name: Name of the Elastic DocumentDB cluster administrator
        :param pulumi.Input[builtins.str] admin_user_password: Password for the Elastic DocumentDB cluster administrator. Can contain any printable ASCII characters. Must be at least 8 characters
        :param pulumi.Input[builtins.str] auth_type: Authentication type for the Elastic DocumentDB cluster. Valid values are `PLAIN_TEXT` and `SECRET_ARN`
        ...
        :param pulumi.Input[builtins.int] backup_retention_period: The number of days for which automatic snapshots are retained. It should be in between 1 and 35. If not specified, the default value of 1 is set.
        :param pulumi.Input[builtins.str] kms_key_id: ARN of a KMS key that is used to encrypt the Elastic DocumentDB cluster. If not specified, the default encryption key that KMS creates for your account is used.
    ...
    def admin_user_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def admin_user_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "admin_user_name", value)

    @property
    @pulumi.getter(name="adminUserPassword")
    def admin_user_password(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def admin_user_password(self, value: pulumi.Input[builtins.str]):
...
class _ElasticClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] admin_user_name: Name of the Elastic DocumentDB cluster administrator
        :param pulumi.Input[builtins.str] admin_user_password: Password for the Elastic DocumentDB cluster administrator. Can contain any printable ASCII characters. Must be at least 8 characters
        :param pulumi.Input[builtins.str] arn: ARN of the DocumentDB Elastic Cluster
        :param pulumi.Input[builtins.str] auth_type: Authentication type for the Elastic DocumentDB cluster. Valid values are `PLAIN_TEXT` and `SECRET_ARN`
        :param pulumi.Input[builtins.int] backup_retention_period: The number of days for which automatic snapshots are retained. It should be in between 1 and 35. If not specified, the default value of 1 is set.
        :param pulumi.Input[builtins.str] endpoint: The DNS address of the DocDB instance
        :param pulumi.Input[builtins.str] kms_key_id: ARN of a KMS key that is used to encrypt the Elastic DocumentDB cluster. If not specified, the default encryption key that KMS creates for your account is used.
        :param pulumi.Input[builtins.str] name: Name of the Elastic DocumentDB cluster
        :param pulumi.Input[builtins.str] preferred_backup_window: The daily time range during which automated backups are created if automated backups are enabled, as determined by the `backup_retention_period`.
        :param pulumi.Input[builtins.str] preferred_maintenance_window: Weekly time range during which system maintenance can occur in UTC. Format: `ddd:hh24:mi-ddd:hh24:mi`. If not specified, AWS will choose a random 30-minute window on a random day of the week.
...
class ElasticCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            timeouts: Optional[pulumi.Input[Union['ElasticClusterTimeoutsArgs', 'ElasticClusterTimeoutsArgsDict']]] = None,
            vpc_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ElasticCluster':
        """
    ...
    @property
    @pulumi.getter(name="adminUserPassword")
    def admin_user_password(self) -> pulumi.Output[builtins.str]:
        """
        Password for the Elastic DocumentDB cluster administrator. Can contain any printable ASCII characters. Must be at least 8 characters
        """
        return pulumi.get(self, "admin_user_password")
