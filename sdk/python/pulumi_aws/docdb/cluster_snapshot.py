...
class _ClusterSnapshotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: List of EC2 Availability Zones that instances in the DocumentDB cluster snapshot can be restored in.
        :param pulumi.Input[builtins.str] db_cluster_identifier: The DocumentDB Cluster Identifier from which to take the snapshot.
        :param pulumi.Input[builtins.str] db_cluster_snapshot_arn: The Amazon Resource Name (ARN) for the DocumentDB Cluster Snapshot.
        :param pulumi.Input[builtins.str] db_cluster_snapshot_identifier: The Identifier for the snapshot.
...
class ClusterSnapshot(pulumi.CustomResource):
    ...
    pulumi_type = "aws:docdb/clusterSnapshot:ClusterSnapshot"
