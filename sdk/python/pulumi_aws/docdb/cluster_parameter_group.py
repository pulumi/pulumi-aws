...
class ClusterParameterGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] family: The family of the DocumentDB cluster parameter group.
        :param pulumi.Input[_builtins.str] description: The description of the DocumentDB cluster parameter group. Defaults to "Managed by Pulumi".
...
class _ClusterParameterGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] arn: The ARN of the DocumentDB cluster parameter group.
        :param pulumi.Input[_builtins.str] description: The description of the DocumentDB cluster parameter group. Defaults to "Managed by Pulumi".
        :param pulumi.Input[_builtins.str] family: The family of the DocumentDB cluster parameter group.
        :param pulumi.Input[_builtins.str] name: The name of the DocumentDB parameter.
        :param pulumi.Input[_builtins.str] name_prefix: Creates a unique name beginning with the specified prefix. Conflicts with `name`.
...
@pulumi.type_token("aws:docdb/clusterParameterGroup:ClusterParameterGroup")
class ClusterParameterGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the DocumentDB parameter.
        :param pulumi.Input[_builtins.str] name_prefix: Creates a unique name beginning with the specified prefix. Conflicts with `name`.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ClusterParameterGroupParameterArgs', 'ClusterParameterGroupParameterArgsDict', 'outputs.ClusterParameterGroupParameter']]]] parameters: A list of DocumentDB parameters to apply. Setting parameters to system default values may show a difference on imported resources.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: A map of tags to assign to the resource. .If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
        ...
