...
class ClusterParameterGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] family: The family of the DocumentDB cluster parameter group.
        :param pulumi.Input[builtins.str] description: The description of the DocumentDB cluster parameter group. Defaults to "Managed by Pulumi".
...
class _ClusterParameterGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the DocumentDB cluster parameter group.
        :param pulumi.Input[builtins.str] description: The description of the DocumentDB cluster parameter group. Defaults to "Managed by Pulumi".
        :param pulumi.Input[builtins.str] family: The family of the DocumentDB cluster parameter group.
        :param pulumi.Input[builtins.str] name: The name of the DocumentDB parameter.
        :param pulumi.Input[builtins.str] name_prefix: Creates a unique name beginning with the specified prefix. Conflicts with `name`.
