...
class EventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The name of the DocDB event subscription. By default generated by the provider.
        :param pulumi.Input[str] name_prefix: The name of the DocDB event subscription. Conflicts with `name`.
...
class _EventSubscriptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] arn: The Amazon Resource Name of the DocDB event notification subscription
        :param pulumi.Input[str] customer_aws_id: The AWS customer account associated with the DocDB event notification subscription
        :param pulumi.Input[bool] enabled: A boolean flag to enable/disable the subscription. Defaults to true.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] event_categories: A list of event categories for a SourceType that you want to subscribe to. See https://docs.aws.amazon.com/documentdb/latest/developerguide/API_Event.html or run `aws docdb describe-event-categories`.
        :param pulumi.Input[str] name: The name of the DocDB event subscription. By default generated by the provider.
        :param pulumi.Input[str] name_prefix: The name of the DocDB event subscription. Conflicts with `name`.
