...
class SubnetGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the docDB subnet group. Defaults to "Managed by Pulumi".
        :param pulumi.Input[builtins.str] name: The name of the docDB subnet group. If omitted, this provider will assign a random, unique name.
...
class _SubnetGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the docDB subnet group.
        :param pulumi.Input[builtins.str] description: The description of the docDB subnet group. Defaults to "Managed by Pulumi".
        :param pulumi.Input[builtins.str] name: The name of the docDB subnet group. If omitted, this provider will assign a random, unique name.
        :param pulumi.Input[builtins.str] name_prefix: Creates a unique name beginning with the specified prefix. Conflicts with `name`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A list of VPC subnet IDs.
...
class SubnetGroup(pulumi.CustomResource):
    ...
    pulumi_type = "aws:docdb/subnetGroup:SubnetGroup"
