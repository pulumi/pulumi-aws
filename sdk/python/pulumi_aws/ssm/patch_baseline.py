...
class PatchBaselineArgs:
    def __init__(__self__, *,
                 ...
                 approved_patches_compliance_level: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] approved_patches: List of explicitly approved patches for the baseline. Cannot be specified with `approval_rule`.
        :param pulumi.Input[builtins.str] approved_patches_compliance_level: Compliance level for approved patches. This means that if an approved patch is reported as missing, this is the severity of the compliance violation. Valid values are `CRITICAL`, `HIGH`, `MEDIUM`, `LOW`, `INFORMATIONAL`, `UNSPECIFIED`. The default value is `UNSPECIFIED`.
        :param pulumi.Input[builtins.bool] approved_patches_enable_non_security: Whether the list of approved patches includes non-security updates that should be applied to the instances. Applies to Linux instances only.
        :param pulumi.Input[builtins.str] description: Description of the patch baseline.
        ...
        :param pulumi.Input[builtins.str] name: Name of the patch baseline.
    ...
    def approved_patches_compliance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def approved_patches_compliance_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PatchBaselineState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] approved_patches_compliance_level: Compliance level for approved patches. This means that if an approved patch is reported as missing, this is the severity of the compliance violation. Valid values are `CRITICAL`, `HIGH`, `MEDIUM`, `LOW`, `INFORMATIONAL`, `UNSPECIFIED`. The default value is `UNSPECIFIED`.
        :param pulumi.Input[builtins.bool] approved_patches_enable_non_security: Whether the list of approved patches includes non-security updates that should be applied to the instances. Applies to Linux instances only.
        :param pulumi.Input[builtins.str] arn: ARN of the baseline.
        :param pulumi.Input[builtins.str] description: Description of the patch baseline.
        :param pulumi.Input[Sequence[pulumi.Input['PatchBaselineGlobalFilterArgs']]] global_filters: Set of global filters used to exclude patches from the baseline. Up to 4 global filters can be specified using Key/Value pairs. Valid Keys are `PRODUCT`, `CLASSIFICATION`, `MSRC_SEVERITY`, and `PATCH_ID`.
        :param pulumi.Input[builtins.str] json: JSON definition of the baseline.
        :param pulumi.Input[builtins.str] name: Name of the patch baseline.
...
class PatchBaseline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            sources: Optional[pulumi.Input[Sequence[pulumi.Input[Union['PatchBaselineSourceArgs', 'PatchBaselineSourceArgsDict']]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'PatchBaseline':
        """
    ...
    @property
    @pulumi.getter(name="approvedPatchesComplianceLevel")
    def approved_patches_compliance_level(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Compliance level for approved patches. This means that if an approved patch is reported as missing, this is the severity of the compliance violation. Valid values are `CRITICAL`, `HIGH`, `MEDIUM`, `LOW`, `INFORMATIONAL`, `UNSPECIFIED`. The default value is `UNSPECIFIED`.
        """
        return pulumi.get(self, "approved_patches_compliance_level")
