...
class ParameterArgs:
    def __init__(__self__, *,
                 ...
                 allowed_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 arn: Optional[pulumi.Input[builtins.str]] = None,
                 data_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 insecure_value: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'ParameterType']] type: Type of the parameter. Valid types are `String`, `StringList` and `SecureString`.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] allowed_pattern: Regular expression used to validate the parameter value.
        :param pulumi.Input[builtins.str] arn: ARN of the parameter.
        :param pulumi.Input[builtins.str] data_type: Data type of the parameter. Valid values: `text`, `aws:ssm:integration` and `aws:ec2:image` for AMI format, see the [Native parameter support for Amazon Machine Image IDs](https://docs.aws.amazon.com/systems-manager/latest/userguide/parameter-store-ec2-aliases.html).
        :param pulumi.Input[builtins.str] description: Description of the parameter.
        :param pulumi.Input[builtins.str] insecure_value: Value of the parameter. **Use caution:** This value is _never_ marked as sensitive in the pulumi preview output. This argument is not valid with a `type` of `SecureString`.
        :param pulumi.Input[builtins.str] key_id: KMS key ID or ARN for encrypting a SecureString.
        :param pulumi.Input[builtins.str] name: Name of the parameter. If the name contains a path (e.g., any forward slashes (`/`)), it must be fully qualified with a leading forward slash (`/`). For additional requirements and constraints, see the [AWS SSM User Guide](https://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-parameter-name-constraints.html).
        :param pulumi.Input[builtins.bool] overwrite: Overwrite an existing parameter. If not specified, defaults to `false` during create operations to avoid overwriting existing resources and then `true` for all subsequent operations once the resource is managed by IAC. Lifecycle rules should be used to manage non-standard update behavior.
    ...
    def allowed_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def allowed_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def insecure_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def insecure_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ParameterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Union[builtins.str, 'ParameterType']] type: Type of the parameter. Valid types are `String`, `StringList` and `SecureString`.
               ...
               The following arguments are optional:
        :param pulumi.Input[builtins.str] value: Value of the parameter. This value is always marked as sensitive in the pulumi preview output, regardless of `type
        :param pulumi.Input[builtins.int] version: Version of the parameter.
        """
        if allowed_pattern is not None:
            pulumi.set(__self__, "allowed_pattern", allowed_pattern)
        if arn is not None:
...
class Parameter(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[Union[builtins.str, 'ParameterType']]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Parameter':
        """
    ...
    @property
    @pulumi.getter(name="allowedPattern")
    def allowed_pattern(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Regular expression used to validate the parameter value.
        """
        return pulumi.get(self, "allowed_pattern")
    ...
    @property
    @pulumi.getter(name="insecureValue")
    def insecure_value(self) -> pulumi.Output[builtins.str]:
        """
        Value of the parameter. **Use caution:** This value is _never_ marked as sensitive in the pulumi preview output. This argument is not valid with a `type` of `SecureString`.
        """
        return pulumi.get(self, "insecure_value")
    ...
    @property
    @pulumi.getter
    def overwrite(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Overwrite an existing parameter. If not specified, defaults to `false` during create operations to avoid overwriting existing resources and then `true` for all subsequent operations once the resource is managed by IAC. Lifecycle rules should be used to manage non-standard update behavior.
        """
        return pulumi.get(self, "overwrite")
