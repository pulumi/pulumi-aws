...
if not MYPY:
    class AssociationOutputLocationArgsDict(TypedDict):
        ...
        """
        s3_region: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AssociationOutputLocationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] s3_bucket_name: The S3 bucket name.
        :param pulumi.Input[builtins.str] s3_key_prefix: The S3 bucket prefix. Results stored in the root if not configured.
        :param pulumi.Input[builtins.str] s3_region: The S3 bucket region.
...
class ContactsRotationRecurrenceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] number_of_on_calls: (Required) The number of contacts, or shift team members designated to be on call concurrently during a shift.
        :param pulumi.Input[builtins.int] recurrence_multiplier: (Required) The number of days, weeks, or months a single rotation lasts.
    ...
    def number_of_on_calls(self) -> pulumi.Input[builtins.int]:
        """
        (Required) The number of contacts, or shift team members designated to be on call concurrently during a shift.
        """
    ...
    def number_of_on_calls(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "number_of_on_calls", value)

    @property
    @pulumi.getter(name="recurrenceMultiplier")
    def recurrence_multiplier(self) -> pulumi.Input[builtins.int]:
        """
        (Required) The number of days, weeks, or months a single rotation lasts.
        """
    ...
    def recurrence_multiplier(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class ContactsRotationRecurrenceDailySettingArgsDict(TypedDict):
        ...
        """
        minute_of_hour: pulumi.Input[builtins.int]
        """
...
class ContactsRotationRecurrenceDailySettingArgs:
    def __init__(__self__, *,
                 ...
                 minute_of_hour: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] hour_of_day: (Required) The hour of the day.
        :param pulumi.Input[builtins.int] minute_of_hour: (Required) The minutes of the hour.
        """
    ...
    def minute_of_hour(self) -> pulumi.Input[builtins.int]:
        """
        (Required) The minutes of the hour.
        """
...
class ContactsRotationRecurrenceMonthlySettingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] day_of_month: (Required) The day of the month when monthly recurring on-call rotations begin.
    ...
    def day_of_month(self) -> pulumi.Input[builtins.int]:
        """
        (Required) The day of the month when monthly recurring on-call rotations begin.
        """
    ...
    @day_of_month.setter
    def day_of_month(self, value: pulumi.Input[builtins.int]):
...
class ContactsRotationRecurrenceWeeklySettingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] day_of_week: (Required) The day of the week when the shift coverage occurs.
...
class DocumentAttachmentsSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: The key of a key-value pair that identifies the location of an attachment to the document. Valid values: `SourceUrl`, `S3FileUrl`, `AttachmentReference`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: The value of a key-value pair that identifies the location of an attachment to the document. The argument format is a list of a single string that depends on the type of key you specify - see the [API Reference](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_AttachmentsSource.html) for details.
...
class DocumentParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] default_value: If specified, the default values for the parameters. Parameters without a default value are required. Parameters with a default value are optional.
        ...
        :param pulumi.Input[builtins.str] type: The type of parameter. Valid values: `String`, `StringList`.
        """
...
class MaintenanceWindowTaskTargetArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: The array of strings.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "values", values)
...
class MaintenanceWindowTaskTaskInvocationParametersAutomationParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] document_version: The version of an Automation document to use during task execution.
...
if not MYPY:
    class MaintenanceWindowTaskTaskInvocationParametersLambdaParametersArgsDict(TypedDict):
        client_context: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MaintenanceWindowTaskTaskInvocationParametersLambdaParametersArgs:
    def __init__(__self__, *,
                 client_context: Optional[pulumi.Input[builtins.str]] = None,
                 payload: Optional[pulumi.Input[builtins.str]] = None,
                 qualifier: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] client_context: Pass client-specific information to the Lambda function that you are invoking.
        :param pulumi.Input[builtins.str] payload: JSON to provide to your Lambda function as input.
        :param pulumi.Input[builtins.str] qualifier: Specify a Lambda function version or alias name.
        """
    ...
    def client_context(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Pass client-specific information to the Lambda function that you are invoking.
        """
    ...
    def client_context(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersArgsDict(TypedDict):
        ...
        """
        document_hash: NotRequired[pulumi.Input[builtins.str]]
        """
        The SHA-256 or SHA-1 hash created by the system when the document was created. SHA-1 hashes have been deprecated.
        """
        document_hash_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        output_s3_bucket: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        The parameters for the RUN_COMMAND task execution. Documented below.
        """
        service_role_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersArgs:
    def __init__(__self__, *,
                 ...
                 document_hash: Optional[pulumi.Input[builtins.str]] = None,
                 document_hash_type: Optional[pulumi.Input[builtins.str]] = None,
                 document_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 output_s3_bucket: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] comment: Information about the command(s) to execute.
        :param pulumi.Input[builtins.str] document_hash: The SHA-256 or SHA-1 hash created by the system when the document was created. SHA-1 hashes have been deprecated.
        :param pulumi.Input[builtins.str] document_hash_type: SHA-256 or SHA-1. SHA-1 hashes have been deprecated. Valid values: `Sha256` and `Sha1`
        :param pulumi.Input[builtins.str] document_version: The version of an Automation document to use during task execution.
        ...
        :param pulumi.Input[builtins.str] output_s3_bucket: The name of the Amazon S3 bucket.
        :param pulumi.Input[builtins.str] output_s3_key_prefix: The Amazon S3 bucket subfolder.
        ...
        :param pulumi.Input[builtins.str] service_role_arn: The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) service role to use to publish Amazon Simple Notification Service (Amazon SNS) notifications for maintenance window Run Command tasks.
        :param pulumi.Input[builtins.int] timeout_seconds: If this time is reached and the command has not already started executing, it doesn't run.
        """
    ...
    def document_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The SHA-256 or SHA-1 hash created by the system when the document was created. SHA-1 hashes have been deprecated.
        """
    ...
    def document_hash(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "document_hash", value)

    @property
    @pulumi.getter(name="documentHashType")
    def document_hash_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        SHA-256 or SHA-1. SHA-1 hashes have been deprecated. Valid values: `Sha256` and `Sha1`
        """
    ...
    def document_hash_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def output_s3_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Amazon S3 bucket.
        """
    ...
    def output_s3_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigArgsDict(TypedDict):
        cloudwatch_log_group_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The name of the CloudWatch log group where you want to send command output. If you don't specify a group name, Systems Manager automatically creates a log group for you. The log group uses the following naming format: aws/ssm/SystemsManagerDocumentName.
        """
        cloudwatch_output_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersCloudwatchConfigArgs:
    def __init__(__self__, *,
                 cloudwatch_log_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 cloudwatch_output_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] cloudwatch_log_group_name: The name of the CloudWatch log group where you want to send command output. If you don't specify a group name, Systems Manager automatically creates a log group for you. The log group uses the following naming format: aws/ssm/SystemsManagerDocumentName.
        :param pulumi.Input[builtins.bool] cloudwatch_output_enabled: Enables Systems Manager to send command output to CloudWatch Logs.
        """
    ...
    def cloudwatch_log_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the CloudWatch log group where you want to send command output. If you don't specify a group name, Systems Manager automatically creates a log group for you. The log group uses the following naming format: aws/ssm/SystemsManagerDocumentName.
        """
    ...
    def cloudwatch_log_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cloudwatch_log_group_name", value)

    @property
    @pulumi.getter(name="cloudwatchOutputEnabled")
    def cloudwatch_output_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enables Systems Manager to send command output to CloudWatch Logs.
        """
    ...
    def cloudwatch_output_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersNotificationConfigArgsDict(TypedDict):
        notification_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        An Amazon Resource Name (ARN) for a Simple Notification Service (SNS) topic. Run Command pushes notifications about command status changes to this topic.
        """
        notification_events: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The different events for which you can receive notifications. Valid values: `All`, `InProgress`, `Success`, `TimedOut`, `Cancelled`, and `Failed`
        """
        notification_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class MaintenanceWindowTaskTaskInvocationParametersRunCommandParametersNotificationConfigArgs:
    def __init__(__self__, *,
                 ...
                 notification_events: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 notification_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] notification_arn: An Amazon Resource Name (ARN) for a Simple Notification Service (SNS) topic. Run Command pushes notifications about command status changes to this topic.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] notification_events: The different events for which you can receive notifications. Valid values: `All`, `InProgress`, `Success`, `TimedOut`, `Cancelled`, and `Failed`
        :param pulumi.Input[builtins.str] notification_type: When specified with `Command`, receive notification when the status of a command changes. When specified with `Invocation`, for commands sent to multiple instances, receive notification on a per-instance basis when the status of a command changes. Valid values: `Command` and `Invocation`
        """
    ...
    def notification_events(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The different events for which you can receive notifications. Valid values: `All`, `InProgress`, `Success`, `TimedOut`, `Cancelled`, and `Failed`
        """
    ...
    def notification_events(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class MaintenanceWindowTaskTaskInvocationParametersStepFunctionsParametersArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] input: The inputs for the STEP_FUNCTION task.
        :param pulumi.Input[builtins.str] name: The name of the STEP_FUNCTION task.
        """
...
if not MYPY:
    class PatchBaselineApprovalRuleArgsDict(TypedDict):
        ...
        """
        compliance_level: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PatchBaselineApprovalRuleArgs:
    def __init__(__self__, *,
                 ...
                 compliance_level: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] approve_after_days: Number of days after the release date of each patch matched by the rule the patch is marked as approved in the patch baseline. Valid Range: 0 to 360. Conflicts with `approve_until_date`.
        :param pulumi.Input[builtins.str] approve_until_date: Cutoff date for auto approval of released patches. Any patches released on or before this date are installed automatically. Date is formatted as `YYYY-MM-DD`. Conflicts with `approve_after_days`
        :param pulumi.Input[builtins.str] compliance_level: Compliance level for patches approved by this rule. Valid values are `CRITICAL`, `HIGH`, `MEDIUM`, `LOW`, `INFORMATIONAL`, and `UNSPECIFIED`. The default value is `UNSPECIFIED`.
        :param pulumi.Input[builtins.bool] enable_non_security: Boolean enabling the application of non-security updates. The default value is `false`. Valid for Linux instances only.
        """
    ...
    def compliance_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Compliance level for patches approved by this rule. Valid values are `CRITICAL`, `HIGH`, `MEDIUM`, `LOW`, `INFORMATIONAL`, and `UNSPECIFIED`. The default value is `UNSPECIFIED`.
        """
    ...
    def compliance_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PatchBaselineSourceArgsDict(TypedDict):
        ...
        """
        products: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class PatchBaselineSourceArgs:
    def __init__(__self__, *,
                 ...
                 products: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] configuration: Value of the yum repo configuration. For information about other options available for your yum repository configuration, see the [`dnf.conf` documentation](https://man7.org/linux/man-pages/man5/dnf.conf.5.html)
        :param pulumi.Input[builtins.str] name: Name specified to identify the patch source.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] products: Specific operating system versions a patch repository applies to, such as `"Ubuntu16.04"`, `"AmazonLinux2016.09"`, `"RedhatEnterpriseLinux7.2"` or `"Suse12.7"`. For lists of supported product values, see [PatchFilter](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html).
        """
    ...
    @property
    @pulumi.getter
    def products(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Specific operating system versions a patch repository applies to, such as `"Ubuntu16.04"`, `"AmazonLinux2016.09"`, `"RedhatEnterpriseLinux7.2"` or `"Suse12.7"`. For lists of supported product values, see [PatchFilter](https://docs.aws.amazon.com/systems-manager/latest/APIReference/API_PatchFilter.html).
        """
    ...
    @products.setter
    def products(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class QuicksetupConfigurationManagerConfigurationDefinitionArgsDict(TypedDict):
        ...
        local_deployment_administration_role_arn: NotRequired[pulumi.Input[builtins.str]]
        local_deployment_execution_role_name: NotRequired[pulumi.Input[builtins.str]]
        """
        Name of the IAM role used to deploy local configurations.
        """
        type_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class QuicksetupConfigurationManagerConfigurationDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 local_deployment_administration_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 local_deployment_execution_role_name: Optional[pulumi.Input[builtins.str]] = None,
                 type_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] parameters: Parameters for the configuration definition type. Parameters for configuration definitions vary based the configuration type. See the [AWS API documentation](https://docs.aws.amazon.com/quick-setup/latest/APIReference/API_ConfigurationDefinitionInput.html) for a complete list of parameters for each configuration type.
        :param pulumi.Input[builtins.str] type: Type of the Quick Setup configuration.
        :param pulumi.Input[builtins.str] local_deployment_execution_role_name: Name of the IAM role used to deploy local configurations.
        :param pulumi.Input[builtins.str] type_version: Version of the Quick Setup type to use.
        """
        pulumi.set(__self__, "parameters", parameters)
        pulumi.set(__self__, "type", type)
        if id is not None:
    ...
    def local_deployment_administration_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "local_deployment_administration_role_arn")

    @local_deployment_administration_role_arn.setter
    def local_deployment_administration_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "local_deployment_administration_role_arn", value)

    @property
    @pulumi.getter(name="localDeploymentExecutionRoleName")
    def local_deployment_execution_role_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the IAM role used to deploy local configurations.
        """
    ...
    def local_deployment_execution_role_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "local_deployment_execution_role_name", value)

    @property
    @pulumi.getter(name="typeVersion")
    def type_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Version of the Quick Setup type to use.
        """
    ...
    @type_version.setter
    def type_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class QuicksetupConfigurationManagerStatusSummaryArgsDict(TypedDict):
        ...
        """
        status_type: pulumi.Input[builtins.str]
        """
...
class QuicksetupConfigurationManagerStatusSummaryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] status_message: When applicable, returns an informational message relevant to the current status and status type of the status summary object.
        :param pulumi.Input[builtins.str] status_type: Type of a status summary.
        """
    ...
    def status_type(self) -> pulumi.Input[builtins.str]:
        """
        Type of a status summary.
        """
    ...
    @status_type.setter
    def status_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ResourceDataSyncS3DestinationArgsDict(TypedDict):
        ...
        """
        sync_format: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ResourceDataSyncS3DestinationArgs:
    def __init__(__self__, *,
                 ...
                 sync_format: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bucket_name: Name of S3 bucket where the aggregated data is stored.
        :param pulumi.Input[builtins.str] region: Region with the bucket targeted by the Resource Data Sync.
        :param pulumi.Input[builtins.str] kms_key_arn: ARN of an encryption key for a destination in Amazon S3.
        :param pulumi.Input[builtins.str] prefix: Prefix for the bucket.
        :param pulumi.Input[builtins.str] sync_format: A supported sync format. Only JsonSerDe is currently supported. Defaults to JsonSerDe.
        """
    ...
    def sync_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A supported sync format. Only JsonSerDe is currently supported. Defaults to JsonSerDe.
        """
    ...
    @sync_format.setter
    def sync_format(self, value: Optional[pulumi.Input[builtins.str]]):
