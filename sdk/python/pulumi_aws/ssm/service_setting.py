...
class ServiceSettingArgs:
    ...
    def setting_value(self) -> pulumi.Input[builtins.str]:
        """
...
class _ServiceSettingState:
    ...
    @property
    @pulumi.getter(name="settingValue")
    def setting_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Value of the service setting.
        """
        return pulumi.get(self, "setting_value")
    ...
    @setting_value.setter
    def setting_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "setting_value", value)
...
class ServiceSetting(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="settingValue")
    def setting_value(self) -> pulumi.Output[builtins.str]:
        """
        Value of the service setting.
        """
        return pulumi.get(self, "setting_value")
