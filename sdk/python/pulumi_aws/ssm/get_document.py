...
def get_document(document_format: Optional[_builtins.str] = None,
...
def get_document_output(document_format: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                        document_version: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
