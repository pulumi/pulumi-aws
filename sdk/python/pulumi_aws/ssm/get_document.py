...
def get_document_output(document_format: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                        document_version: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
