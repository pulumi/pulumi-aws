...
class MaintenanceWindowArgs:
    def __init__(__self__, *,
                 cutoff: pulumi.Input[builtins.int],
                 duration: pulumi.Input[builtins.int],
                 schedule: pulumi.Input[builtins.str],
                 allow_unassociated_targets: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] cutoff: The number of hours before the end of the Maintenance Window that Systems Manager stops scheduling new tasks for execution.
        :param pulumi.Input[builtins.int] duration: The duration of the Maintenance Window in hours.
        ...
        :param pulumi.Input[builtins.bool] allow_unassociated_targets: Whether targets must be registered with the Maintenance Window before tasks can be defined for those targets.
        :param pulumi.Input[builtins.str] description: A description for the maintenance window.
    ...
    @property
    @pulumi.getter
    def cutoff(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @cutoff.setter
    def cutoff(self, value: pulumi.Input[builtins.int]):
    ...
    def allow_unassociated_targets(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_unassociated_targets(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def schedule_timezone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def schedule_timezone(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MaintenanceWindowState:
    def __init__(__self__, *,
                 allow_unassociated_targets: Optional[pulumi.Input[builtins.bool]] = None,
                 cutoff: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter
    def cutoff(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of hours before the end of the Maintenance Window that Systems Manager stops scheduling new tasks for execution.
        """
        return pulumi.get(self, "cutoff")
    ...
    @cutoff.setter
    def cutoff(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cutoff", value)
...
class MaintenanceWindow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            start_date: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'MaintenanceWindow':
        """
    ...
    @property
    @pulumi.getter(name="allowUnassociatedTargets")
    def allow_unassociated_targets(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether targets must be registered with the Maintenance Window before tasks can be defined for those targets.
        """
        return pulumi.get(self, "allow_unassociated_targets")
    ...
    @property
    @pulumi.getter
    def cutoff(self) -> pulumi.Output[builtins.int]:
        """
        The number of hours before the end of the Maintenance Window that Systems Manager stops scheduling new tasks for execution.
        """
        return pulumi.get(self, "cutoff")
    ...
    @property
    @pulumi.getter(name="scheduleTimezone")
    def schedule_timezone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Timezone for schedule in [Internet Assigned Numbers Authority (IANA) Time Zone Database format](https://www.iana.org/time-zones). For example: `America/Los_Angeles`, `etc/UTC`, or `Asia/Seoul`.
        """
        return pulumi.get(self, "schedule_timezone")
