...
class MaintenanceWindowTaskArgs:
    def __init__(__self__, *,
                 task_arn: pulumi.Input[builtins.str],
                 task_type: pulumi.Input[builtins.str],
                 window_id: pulumi.Input[builtins.str],
                 cutoff_behavior: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] task_type: The type of task being registered. Valid values: `AUTOMATION`, `LAMBDA`, `RUN_COMMAND` or `STEP_FUNCTIONS`.
        :param pulumi.Input[builtins.str] window_id: The Id of the maintenance window to register the task with.
        :param pulumi.Input[builtins.str] cutoff_behavior: Indicates whether tasks should continue to run after the cutoff time specified in the maintenance windows is reached. Valid values are `CONTINUE_TASK` and `CANCEL_TASK`.
        :param pulumi.Input[builtins.str] description: The description of the maintenance window task.
        :param pulumi.Input[builtins.str] max_concurrency: The maximum number of targets this task can be run for in parallel.
    ...
    def task_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @task_arn.setter
    def task_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def cutoff_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cutoff_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MaintenanceWindowTaskState:
    def __init__(__self__, *,
                 ...
                 window_task_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering MaintenanceWindowTask resources.
        :param pulumi.Input[builtins.str] arn: The ARN of the maintenance window task.
        :param pulumi.Input[builtins.str] cutoff_behavior: Indicates whether tasks should continue to run after the cutoff time specified in the maintenance windows is reached. Valid values are `CONTINUE_TASK` and `CANCEL_TASK`.
        :param pulumi.Input[builtins.str] description: The description of the maintenance window task.
        :param pulumi.Input[builtins.str] max_concurrency: The maximum number of targets this task can be run for in parallel.
        :param pulumi.Input[builtins.str] max_errors: The maximum number of errors allowed before this task stops being scheduled.
        ...
        :param pulumi.Input[builtins.str] task_type: The type of task being registered. Valid values: `AUTOMATION`, `LAMBDA`, `RUN_COMMAND` or `STEP_FUNCTIONS`.
        :param pulumi.Input[builtins.str] window_id: The Id of the maintenance window to register the task with.
        :param pulumi.Input[builtins.str] window_task_id: The ID of the maintenance window task.
        """
        if arn is not None:
    ...
    @property
    @pulumi.getter(name="taskArn")
    def task_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the task to execute.
        """
        return pulumi.get(self, "task_arn")
    ...
    @task_arn.setter
    def task_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "task_arn", value)
    ...
    def window_task_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def window_task_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MaintenanceWindowTask(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            task_type: Optional[pulumi.Input[builtins.str]] = None,
            window_id: Optional[pulumi.Input[builtins.str]] = None,
            window_task_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MaintenanceWindowTask':
        """
    ...
    @property
    @pulumi.getter(name="cutoffBehavior")
    def cutoff_behavior(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates whether tasks should continue to run after the cutoff time specified in the maintenance windows is reached. Valid values are `CONTINUE_TASK` and `CANCEL_TASK`.
        """
        return pulumi.get(self, "cutoff_behavior")
    ...
    @property
    @pulumi.getter(name="maxConcurrency")
    def max_concurrency(self) -> pulumi.Output[builtins.str]:
        """
        The maximum number of targets this task can be run for in parallel.
        """
        return pulumi.get(self, "max_concurrency")
    ...
    @property
    @pulumi.getter(name="maxErrors")
    def max_errors(self) -> pulumi.Output[builtins.str]:
        """
        The maximum number of errors allowed before this task stops being scheduled.
        """
        return pulumi.get(self, "max_errors")
    ...
    @property
    @pulumi.getter(name="windowTaskId")
    def window_task_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the maintenance window task.
        """
        return pulumi.get(self, "window_task_id")
