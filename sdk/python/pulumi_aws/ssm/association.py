...
class AssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] association_name: The descriptive name for the association.
    ...
    def compliance_severity(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compliance_severity(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sync_compliance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sync_compliance(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AssociationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] apply_only_at_cron_interval: By default, when you create a new or update associations, the system runs it immediately and then according to the schedule you specified. Enable this option if you do not want an association to run immediately after you create or update it. This parameter is not supported for rate expressions. Default: `false`.
        :param pulumi.Input[builtins.str] arn: The ARN of the SSM association
        :param pulumi.Input[builtins.str] association_id: The ID of the SSM association.
        :param pulumi.Input[builtins.str] association_name: The descriptive name for the association.
        :param pulumi.Input[builtins.str] automation_target_parameter_name: Specify the target for the association. This target is required for associations that use an `Automation` document and target resources by using rate controls. This should be set to the SSM document `parameter` that will define how your automation will branch out.
        :param pulumi.Input[builtins.str] compliance_severity: The compliance severity for the association. Can be one of the following: `UNSPECIFIED`, `LOW`, `MEDIUM`, `HIGH` or `CRITICAL`
        :param pulumi.Input[builtins.str] document_version: The document version you want to associate with the target(s). Can be a specific version or the default version.
...
class Association(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            targets: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AssociationTargetArgs', 'AssociationTargetArgsDict']]]]] = None,
            wait_for_success_timeout_seconds: Optional[pulumi.Input[builtins.int]] = None) -> 'Association':
        """
    ...
    @property
    @pulumi.getter(name="complianceSeverity")
    def compliance_severity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The compliance severity for the association. Can be one of the following: `UNSPECIFIED`, `LOW`, `MEDIUM`, `HIGH` or `CRITICAL`
        """
        return pulumi.get(self, "compliance_severity")
    ...
    @property
    @pulumi.getter(name="syncCompliance")
    def sync_compliance(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The mode for generating association compliance. You can specify `AUTO` or `MANUAL`.
        """
        return pulumi.get(self, "sync_compliance")
