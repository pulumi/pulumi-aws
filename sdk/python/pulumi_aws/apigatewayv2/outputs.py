...
class ApiCorsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] allow_headers: Set of allowed HTTP headers.
        :param Sequence[_builtins.str] allow_methods: Set of allowed HTTP methods.
        :param Sequence[_builtins.str] allow_origins: Set of allowed origins.
        :param Sequence[_builtins.str] expose_headers: Set of exposed HTTP headers.
        :param _builtins.int max_age: Number of seconds that the browser should cache preflight request results.
        """
...
class AuthorizerJwtConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] audiences: List of the intended recipients of the JWT. A valid JWT must provide an aud that matches at least one entry in this list.
        :param _builtins.str issuer: Base domain of the identity provider that issues JSON Web Tokens, such as the `endpoint` attribute of the `cognito.UserPool` resource.
        """
...
class RoutingRuleConditionMatchBasePaths(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RoutingRuleConditionMatchBasePaths. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RoutingRuleConditionMatchBasePaths.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] any_ofs: List of strings of the case sensitive base path to be matched.
        """
...
class RoutingRuleConditionMatchHeaders(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RoutingRuleConditionMatchHeaders. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RoutingRuleConditionMatchHeaders.__key_warning(key)
        return super().__getitem__(key)
...
class RoutingRuleConditionMatchHeadersAnyOf(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RoutingRuleConditionMatchHeadersAnyOf. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RoutingRuleConditionMatchHeadersAnyOf.__key_warning(key)
        return super().__getitem__(key)
