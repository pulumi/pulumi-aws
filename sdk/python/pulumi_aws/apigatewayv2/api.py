...
class Api(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cors_configuration is not None and not isinstance(cors_configuration, ApiCorsConfigurationArgs):
                cors_configuration = cors_configuration or {}
                def _setter(key, value):
                    cors_configuration[key] = value
                ApiCorsConfigurationArgs._configure(_setter, **cors_configuration)
