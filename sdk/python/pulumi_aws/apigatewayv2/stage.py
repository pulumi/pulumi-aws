...
class Stage(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if default_route_settings is not None and not isinstance(default_route_settings, StageDefaultRouteSettingsArgs):
                default_route_settings = default_route_settings or {}
                def _setter(key, value):
                    default_route_settings[key] = value
                StageDefaultRouteSettingsArgs._configure(_setter, **default_route_settings)
