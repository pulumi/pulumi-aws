...
class ApiCorsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] allow_credentials: Whether credentials are included in the CORS request.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow_headers: Set of allowed HTTP headers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow_methods: Set of allowed HTTP methods.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allow_origins: Set of allowed origins.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] expose_headers: Set of exposed HTTP headers.
        :param pulumi.Input[builtins.int] max_age: Number of seconds that the browser should cache preflight request results.
        """
...
class AuthorizerJwtConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] audiences: List of the intended recipients of the JWT. A valid JWT must provide an aud that matches at least one entry in this list.
        :param pulumi.Input[builtins.str] issuer: Base domain of the identity provider that issues JSON Web Tokens, such as the `endpoint` attribute of the `cognito.UserPool` resource.
        """
...
if not MYPY:
    class DomainNameDomainNameConfigurationArgsDict(TypedDict):
        ...
        """
        target_domain_name: NotRequired[pulumi.Input[builtins.str]]
        """
        Target domain name.
        """
elif False:
...
class DomainNameDomainNameConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] certificate_arn: ARN of an AWS-managed certificate that will be used by the endpoint for the domain name. AWS Certificate Manager is the only supported source. Use the `acm.Certificate` resource to configure an ACM certificate.
...
if not MYPY:
    class DomainNameMutualTlsAuthenticationArgsDict(TypedDict):
        truststore_uri: pulumi.Input[builtins.str]
        """
...
class DomainNameMutualTlsAuthenticationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] truststore_uri: Amazon S3 URL that specifies the truststore for mutual TLS authentication, for example, `s3://bucket-name/key-name`. The truststore can contain certificates from public or private certificate authorities. To update the truststore, upload a new version to S3, and then update your custom domain name to use the new version.
        :param pulumi.Input[builtins.str] truststore_version: Version of the S3 object that contains the truststore. To specify a version, you must have versioning enabled for the S3 bucket.
        """
    ...
    def truststore_uri(self) -> pulumi.Input[builtins.str]:
        """
        Amazon S3 URL that specifies the truststore for mutual TLS authentication, for example, `s3://bucket-name/key-name`. The truststore can contain certificates from public or private certificate authorities. To update the truststore, upload a new version to S3, and then update your custom domain name to use the new version.
        """
    ...
    def truststore_uri(self, value: pulumi.Input[builtins.str]):
...
class IntegrationResponseParameterArgs:
    def __init__(__self__, *,
                 ...
                 status_code: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] mappings: Key-value map. The key of this map identifies the location of the request parameter to change, and how to change it. The corresponding value specifies the new data for the parameter.
               See the [Amazon API Gateway Developer Guide](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-parameter-mapping.html) for details.
        :param pulumi.Input[builtins.str] status_code: HTTP status code in the range 200-599.
        """
...
if not MYPY:
    class RouteRequestParameterArgsDict(TypedDict):
        request_parameter_key: pulumi.Input[builtins.str]
        """
...
class RouteRequestParameterArgs:
    def __init__(__self__, *,
                 ...
                 required: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.str] request_parameter_key: Request parameter key. This is a [request data mapping parameter](https://docs.aws.amazon.com/apigateway/latest/developerguide/websocket-api-data-mapping.html#websocket-mapping-request-parameters).
        :param pulumi.Input[builtins.bool] required: Boolean whether or not the parameter is required.
        """
    ...
    def request_parameter_key(self) -> pulumi.Input[builtins.str]:
        """
        Request parameter key. This is a [request data mapping parameter](https://docs.aws.amazon.com/apigateway/latest/developerguide/websocket-api-data-mapping.html#websocket-mapping-request-parameters).
        """
    ...
    def request_parameter_key(self, value: pulumi.Input[builtins.str]):
...
class StageAccessLogSettingsArgs:
    def __init__(__self__, *,
                 ...
                 format: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] destination_arn: ARN of the CloudWatch Logs log group to receive access logs. Any trailing `:*` is trimmed from the ARN.
        :param pulumi.Input[builtins.str] format: Single line [format](https://docs.aws.amazon.com/apigateway/latest/developerguide/set-up-logging.html#apigateway-cloudwatch-log-formats) of the access logs of data. Refer to log settings for [HTTP](https://docs.aws.amazon.com/apigateway/latest/developerguide/http-api-logging-variables.html) or [Websocket](https://docs.aws.amazon.com/apigateway/latest/developerguide/websocket-api-logging.html).
        """
...
if not MYPY:
    class StageDefaultRouteSettingsArgsDict(TypedDict):
        ...
        """
        detailed_metrics_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class StageDefaultRouteSettingsArgs:
    def __init__(__self__, *,
                 ...
                 detailed_metrics_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.bool] data_trace_enabled: Whether data trace logging is enabled for the default route. Affects the log entries pushed to Amazon CloudWatch Logs.
               Defaults to `false`. Supported only for WebSocket APIs.
        :param pulumi.Input[builtins.bool] detailed_metrics_enabled: Whether detailed metrics are enabled for the default route. Defaults to `false`.
        :param pulumi.Input[builtins.str] logging_level: Logging level for the default route. Affects the log entries pushed to Amazon CloudWatch Logs.
               Valid values: `ERROR`, `INFO`, `OFF`. Defaults to `OFF`. Supported only for WebSocket APIs. This provider will only perform drift detection of its value when present in a configuration.
        :param pulumi.Input[builtins.int] throttling_burst_limit: Throttling burst limit for the default route.
        :param pulumi.Input[builtins.float] throttling_rate_limit: Throttling rate limit for the default route.
        """
    ...
    def detailed_metrics_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether detailed metrics are enabled for the default route. Defaults to `false`.
        """
    ...
    def detailed_metrics_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class StageRouteSettingArgs:
    def __init__(__self__, *,
                 ...
                 throttling_rate_limit: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.str] route_key: Route key.
        :param pulumi.Input[builtins.bool] data_trace_enabled: Whether data trace logging is enabled for the route. Affects the log entries pushed to Amazon CloudWatch Logs.
               Defaults to `false`. Supported only for WebSocket APIs.
        :param pulumi.Input[builtins.bool] detailed_metrics_enabled: Whether detailed metrics are enabled for the route. Defaults to `false`.
        :param pulumi.Input[builtins.str] logging_level: Logging level for the route. Affects the log entries pushed to Amazon CloudWatch Logs.
               Valid values: `ERROR`, `INFO`, `OFF`. Defaults to `OFF`. Supported only for WebSocket APIs. This provider will only perform drift detection of its value when present in a configuration.
        :param pulumi.Input[builtins.int] throttling_burst_limit: Throttling burst limit for the route.
        :param pulumi.Input[builtins.float] throttling_rate_limit: Throttling rate limit for the route.
        """
