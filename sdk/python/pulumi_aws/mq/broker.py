...
class Broker(pulumi.CustomResource):
    ...
    Configuration block containing encryption options. See below.
      ...
      * `use_aws_owned_key` (`bool`) - Boolean to enable an AWS owned Key Management Service (KMS) Customer Master Key (CMK) that is not in your account. Defaults to `true`. Setting to `false` without configuring `kms_key_id` will create an AWS managed Customer Master Key (CMK) aliased to `aws/mq` in your account.
    """
    ...
    * `wss://broker-id.mq.us-west-2.amazonaws.com:61619`
    ...
    Maintenance window start time. See below.
      ...
      * `day_of_week` (`str`) - The day of the week. e.g. `MONDAY`, `TUESDAY`, or `WEDNESDAY`
      * `time_of_day` (`str`) - The time, in 24-hour format. e.g. `02:00`
      * `time_zone` (`str`) - The time zone, UTC by default, in either the Country/City format, or the UTC offset format. e.g. `CET`
    """
    ...
    def __init__(__self__, resource_name, opts=None, apply_immediately=None, auto_minor_version_upgrade=None, broker_name=None, configuration=None, deployment_mode=None, encryption_options=None, engine_type=None, engine_version=None, host_instance_type=None, logs=None, maintenance_window_start_time=None, publicly_accessible=None, security_groups=None, subnet_ids=None, tags=None, users=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **encryption_options** object supports the following:
          ...
          * `use_aws_owned_key` (`pulumi.Input[bool]`) - Boolean to enable an AWS owned Key Management Service (KMS) Customer Master Key (CMK) that is not in your account. Defaults to `true`. Setting to `false` without configuring `kms_key_id` will create an AWS managed Customer Master Key (CMK) aliased to `aws/mq` in your account.
        ...
        The **maintenance_window_start_time** object supports the following:
          ...
          * `day_of_week` (`pulumi.Input[str]`) - The day of the week. e.g. `MONDAY`, `TUESDAY`, or `WEDNESDAY`
          * `time_of_day` (`pulumi.Input[str]`) - The time, in 24-hour format. e.g. `02:00`
          * `time_zone` (`pulumi.Input[str]`) - The time zone, UTC by default, in either the Country/City format, or the UTC offset format. e.g. `CET`
