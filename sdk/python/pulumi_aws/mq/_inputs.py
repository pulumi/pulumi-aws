...
class BrokerEncryptionOptionsArgs:
    ...
    def use_aws_owned_key(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BrokerInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] endpoints: Broker's wire-level protocol endpoints in the following order & format referenceable e.g., as `instances.0.endpoints.0` (SSL):
               ...
               * For `RabbitMQ`:
               * `amqps://broker-id.mq.us-west-2.amazonaws.com:5671`
        :param pulumi.Input[builtins.str] ip_address: IP Address of the broker.
        """
...
if not MYPY:
    class BrokerLdapServerMetadataArgsDict(TypedDict):
        ...
        """
        role_search_subtree: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether the directory search scope is the entire sub-tree.
        """
        service_account_password: NotRequired[pulumi.Input[builtins.str]]
        """
        Service account password.
        """
        service_account_username: NotRequired[pulumi.Input[builtins.str]]
        """
        Service account username.
        """
        user_base: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        user_search_subtree: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether the directory search scope is the entire sub-tree.
        """
elif False:
...
class BrokerLdapServerMetadataArgs:
    def __init__(__self__, *,
                 ...
                 role_base: Optional[pulumi.Input[builtins.str]] = None,
                 role_name: Optional[pulumi.Input[builtins.str]] = None,
                 role_search_matching: Optional[pulumi.Input[builtins.str]] = None,
                 role_search_subtree: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 user_base: Optional[pulumi.Input[builtins.str]] = None,
                 user_role_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @role_base.setter
    def role_base(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def role_search_matching(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Search criteria for groups.
        """
    ...
    def role_search_matching(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "role_search_matching", value)

    @property
    @pulumi.getter(name="roleSearchSubtree")
    def role_search_subtree(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the directory search scope is the entire sub-tree.
        """
    ...
    def role_search_subtree(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def user_base(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Fully qualified name of the directory where you want to search for users.
        """
    ...
    @user_base.setter
    def user_base(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_role_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_role_name", value)

    @property
    @pulumi.getter(name="userSearchMatching")
    def user_search_matching(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Search criteria for users.
        """
    ...
    def user_search_matching(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_search_matching", value)

    @property
    @pulumi.getter(name="userSearchSubtree")
    def user_search_subtree(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the directory search scope is the entire sub-tree.
        """
    ...
    def user_search_subtree(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BrokerLogsArgs:
    ...
    @audit.setter
    def audit(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @general.setter
    def general(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class BrokerMaintenanceWindowStartTimeArgsDict(TypedDict):
        ...
        """
        time_of_day: pulumi.Input[builtins.str]
        """
...
class BrokerMaintenanceWindowStartTimeArgs:
    def __init__(__self__, *,
                 ...
                 time_zone: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] day_of_week: Day of the week, e.g., `MONDAY`, `TUESDAY`, or `WEDNESDAY`.
        :param pulumi.Input[builtins.str] time_of_day: Time, in 24-hour format, e.g., `02:00`.
        :param pulumi.Input[builtins.str] time_zone: Time zone in either the Country/City format or the UTC offset format, e.g., `CET`.
        """
    ...
    def time_of_day(self) -> pulumi.Input[builtins.str]:
        """
        Time, in 24-hour format, e.g., `02:00`.
        """
    ...
    @time_of_day.setter
    def time_of_day(self, value: pulumi.Input[builtins.str]):
...
class BrokerUserArgs:
    def __init__(__self__, *,
                 password: pulumi.Input[builtins.str],
                 username: pulumi.Input[builtins.str],
                 console_access: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def console_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to enable access to the [ActiveMQ Web Console](http://activemq.apache.org/web-console.html) for the user. Applies to `engine_type` of `ActiveMQ` only.
        """
    ...
    def console_access(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def replication_user(self, value: Optional[pulumi.Input[builtins.bool]]):
