...
class ProviderArgs:
    ...
    def _configure(
        ...
        if 'stsRegion' in kwargs:
            sts_region = kwargs['stsRegion']
        if 'useDualstackEndpoint' in kwargs:
            use_dualstack_endpoint = kwargs['useDualstackEndpoint']
        if 'useFipsEndpoint' in kwargs:
