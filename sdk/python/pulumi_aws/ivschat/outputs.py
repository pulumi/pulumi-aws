...
class LoggingConfigurationDestinationConfigurationCloudwatchLogs(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str log_group_name: Name of the Amazon Cloudwatch Logs destination where chat activity will be logged.
        """
...
class RoomMessageReviewHandler(dict):
    ...
    def __init__(__self__, *,
                 fallback_result: Optional[_builtins.str] = None,
                 uri: Optional[_builtins.str] = None):
        """
        :param _builtins.str fallback_result: The fallback behavior (whether the message
        ...
        :param _builtins.str uri: ARN of the lambda message review handler function.
        """
