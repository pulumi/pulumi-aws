...
class RoomArgs:
    def __init__(__self__, *,
                 logging_configuration_identifiers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 maximum_message_length: Optional[pulumi.Input[builtins.int]] = None,
                 maximum_message_rate_per_second: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] logging_configuration_identifiers: List of Logging Configuration
               ARNs to attach to the room.
        :param pulumi.Input[builtins.int] maximum_message_length: Maximum number of characters in a single
               message. Messages are expected to be UTF-8 encoded and this limit applies
               specifically to rune/code-point count, not number of bytes.
        :param pulumi.Input[builtins.int] maximum_message_rate_per_second: Maximum number of messages per
               second that can be sent to the room (by all clients).
        :param pulumi.Input['RoomMessageReviewHandlerArgs'] message_review_handler: Configuration information for optional
               review of messages.
        :param pulumi.Input[builtins.str] name: Room name.
    ...
    def logging_configuration_identifiers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def logging_configuration_identifiers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "logging_configuration_identifiers", value)

    @property
    @pulumi.getter(name="maximumMessageLength")
    def maximum_message_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_message_length(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "maximum_message_length", value)

    @property
    @pulumi.getter(name="maximumMessageRatePerSecond")
    def maximum_message_rate_per_second(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def maximum_message_rate_per_second(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _RoomState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the Room.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] logging_configuration_identifiers: List of Logging Configuration
               ARNs to attach to the room.
        :param pulumi.Input[builtins.int] maximum_message_length: Maximum number of characters in a single
               message. Messages are expected to be UTF-8 encoded and this limit applies
...
class Room(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Room':
        """
    ...
    @property
    @pulumi.getter(name="loggingConfigurationIdentifiers")
    def logging_configuration_identifiers(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of Logging Configuration
        ARNs to attach to the room.
        """
    ...
    @property
    @pulumi.getter(name="maximumMessageLength")
    def maximum_message_length(self) -> pulumi.Output[builtins.int]:
        """
        Maximum number of characters in a single
        message. Messages are expected to be UTF-8 encoded and this limit applies
        specifically to rune/code-point count, not number of bytes.
    ...
    @property
    @pulumi.getter(name="maximumMessageRatePerSecond")
    def maximum_message_rate_per_second(self) -> pulumi.Output[builtins.int]:
        """
        Maximum number of messages per
        second that can be sent to the room (by all clients).
        """
