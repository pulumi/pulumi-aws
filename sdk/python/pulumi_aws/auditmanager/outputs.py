...
class AssessmentAssessmentReportsDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str destination: Destination of the assessment report. This value be in the form `s3://{bucket_name}`.
        :param builtins.str destination_type: Destination type. Currently, `S3` is the only valid value.
        """
...
class AssessmentRole(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role_arn: Amazon Resource Name (ARN) of the IAM role.
        :param builtins.str role_type: Type of customer persona. For assessment creation, type must always be `PROCESS_OWNER`.
        """
...
class AssessmentScopeAwsAccount(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: Identifier for the Amazon Web Services account.
        """
...
class AssessmentScopeAwsService(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str service_name: Name of the Amazon Web Service.
        """
...
class ControlControlMappingSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_frequency: Optional[builtins.str] = None,
                 source_id: Optional[builtins.str] = None,
                 source_keyword: Optional['outputs.ControlControlMappingSourceSourceKeyword'] = None,
                 troubleshooting_text: Optional[builtins.str] = None):
        """
        :param builtins.str source_name: Name of the source.
        :param builtins.str source_set_up_option: The setup option for the data source. This option reflects if the evidence collection is automated or manual. Valid values are `System_Controls_Mapping` (automated) and `Procedural_Controls_Mapping` (manual).
        :param builtins.str source_type: Type of data source for evidence collection. If `source_set_up_option` is manual, the only valid value is `MANUAL`. If `source_set_up_option` is automated, valid values are `AWS_Cloudtrail`, `AWS_Config`, `AWS_Security_Hub`, or `AWS_API_Call`.
               
               The following arguments are optional:
        :param builtins.str source_description: Description of the source.
        :param builtins.str source_frequency: Frequency of evidence collection. Valid values are `DAILY`, `WEEKLY`, or `MONTHLY`.
        ...
        :param builtins.str troubleshooting_text: Instructions for troubleshooting the control.
        """
    ...
    def source_frequency(self) -> Optional[builtins.str]:
        """
    ...
    def troubleshooting_text(self) -> Optional[builtins.str]:
        """
...
class ControlControlMappingSourceSourceKeyword(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str keyword_input_type: Input method for the keyword. Valid values are `INPUT_TEXT`, `SELECT_FROM_LIST`, or `UPLOAD_FILE`.
        :param builtins.str keyword_value: The value of the keyword that's used when mapping a control data source. For example, this can be a CloudTrail event name, a rule name for Config, a Security Hub control, or the name of an Amazon Web Services API call. See the [Audit Manager supported control data sources documentation](https://docs.aws.amazon.com/audit-manager/latest/userguide/control-data-sources.html) for more information.
        """
...
class FrameworkControlSet(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the control set.
        ...
        :param builtins.str id: Unique identifier for the framework.
        """
...
class FrameworkControlSetControl(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: Unique identifier of the control.
        """
        pulumi.set(__self__, "id", id)
