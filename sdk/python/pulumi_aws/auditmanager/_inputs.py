...
class AssessmentAssessmentReportsDestinationArgs:
    def __init__(__self__, *,
                 ...
                 destination_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] destination: Destination of the assessment report. This value be in the form `s3://{bucket_name}`.
        :param pulumi.Input[builtins.str] destination_type: Destination type. Currently, `S3` is the only valid value.
        """
...
class AssessmentRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_type: Type of customer persona. For assessment creation, type must always be `PROCESS_OWNER`.
        """
...
class AssessmentScopeAwsAccountArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: Identifier for the Amazon Web Services account.
        """
...
class AssessmentScopeAwsServiceArgs:
    def __init__(__self__, *,
                 service_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] service_name: Name of the Amazon Web Service.
        """
...
if not MYPY:
    class ControlControlMappingSourceArgsDict(TypedDict):
        ...
        Name of the source.
        """
        source_set_up_option: pulumi.Input[builtins.str]
        """
        ...
        """
        source_frequency: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        troubleshooting_text: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ControlControlMappingSourceArgs:
    def __init__(__self__, *,
                 ...
                 source_frequency: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 troubleshooting_text: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] source_name: Name of the source.
        :param pulumi.Input[builtins.str] source_set_up_option: The setup option for the data source. This option reflects if the evidence collection is automated or manual. Valid values are `System_Controls_Mapping` (automated) and `Procedural_Controls_Mapping` (manual).
        :param pulumi.Input[builtins.str] source_type: Type of data source for evidence collection. If `source_set_up_option` is manual, the only valid value is `MANUAL`. If `source_set_up_option` is automated, valid values are `AWS_Cloudtrail`, `AWS_Config`, `AWS_Security_Hub`, or `AWS_API_Call`.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] source_description: Description of the source.
        :param pulumi.Input[builtins.str] source_frequency: Frequency of evidence collection. Valid values are `DAILY`, `WEEKLY`, or `MONTHLY`.
        ...
        :param pulumi.Input[builtins.str] troubleshooting_text: Instructions for troubleshooting the control.
        """
    ...
    def source_set_up_option(self) -> pulumi.Input[builtins.str]:
        """
        The setup option for the data source. This option reflects if the evidence collection is automated or manual. Valid values are `System_Controls_Mapping` (automated) and `Procedural_Controls_Mapping` (manual).
        """
    ...
    def source_set_up_option(self, value: pulumi.Input[builtins.str]):
    ...
    def source_frequency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Frequency of evidence collection. Valid values are `DAILY`, `WEEKLY`, or `MONTHLY`.
        """
    ...
    def source_frequency(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def troubleshooting_text(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Instructions for troubleshooting the control.
        """
...
class ControlControlMappingSourceSourceKeywordArgs:
    def __init__(__self__, *,
                 ...
                 keyword_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] keyword_input_type: Input method for the keyword. Valid values are `INPUT_TEXT`, `SELECT_FROM_LIST`, or `UPLOAD_FILE`.
        :param pulumi.Input[builtins.str] keyword_value: The value of the keyword that's used when mapping a control data source. For example, this can be a CloudTrail event name, a rule name for Config, a Security Hub control, or the name of an Amazon Web Services API call. See the [Audit Manager supported control data sources documentation](https://docs.aws.amazon.com/audit-manager/latest/userguide/control-data-sources.html) for more information.
        """
    ...
    def keyword_input_type(self) -> pulumi.Input[builtins.str]:
        """
        Input method for the keyword. Valid values are `INPUT_TEXT`, `SELECT_FROM_LIST`, or `UPLOAD_FILE`.
        """
    ...
    def keyword_input_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "keyword_input_type", value)

    @property
    @pulumi.getter(name="keywordValue")
    def keyword_value(self) -> pulumi.Input[builtins.str]:
        """
        The value of the keyword that's used when mapping a control data source. For example, this can be a CloudTrail event name, a rule name for Config, a Security Hub control, or the name of an Amazon Web Services API call. See the [Audit Manager supported control data sources documentation](https://docs.aws.amazon.com/audit-manager/latest/userguide/control-data-sources.html) for more information.
        """
    ...
    def keyword_value(self, value: pulumi.Input[builtins.str]):
...
class FrameworkControlSetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Name of the control set.
        ...
        :param pulumi.Input[builtins.str] id: Unique identifier for the framework.
        """
...
class FrameworkControlSetControlArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: Unique identifier of the control.
        """
        pulumi.set(__self__, "id", id)
...
class GetControlControlMappingSourceArgs:
    ...
    @source_description.setter
    def source_description(self, value: builtins.str):
        pulumi.set(self, "source_description", value)
    ...
    @source_frequency.setter
    def source_frequency(self, value: builtins.str):
        pulumi.set(self, "source_frequency", value)
    ...
    @source_id.setter
    def source_id(self, value: builtins.str):
        pulumi.set(self, "source_id", value)
    ...
    @source_name.setter
    def source_name(self, value: builtins.str):
        pulumi.set(self, "source_name", value)
    ...
    @source_set_up_option.setter
    def source_set_up_option(self, value: builtins.str):
        pulumi.set(self, "source_set_up_option", value)
    ...
    @source_type.setter
    def source_type(self, value: builtins.str):
        pulumi.set(self, "source_type", value)
    ...
    @troubleshooting_text.setter
    def troubleshooting_text(self, value: builtins.str):
        pulumi.set(self, "troubleshooting_text", value)
...
class GetControlControlMappingSourceSourceKeywordArgs:
    ...
    @keyword_input_type.setter
    def keyword_input_type(self, value: builtins.str):
        pulumi.set(self, "keyword_input_type", value)
    ...
    @keyword_value.setter
    def keyword_value(self, value: builtins.str):
        pulumi.set(self, "keyword_value", value)
