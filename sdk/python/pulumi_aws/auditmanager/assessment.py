...
class Assessment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if assessment_reports_destination is not None and not isinstance(assessment_reports_destination, AssessmentAssessmentReportsDestinationArgs):
                assessment_reports_destination = assessment_reports_destination or {}
                def _setter(key, value):
                    assessment_reports_destination[key] = value
                AssessmentAssessmentReportsDestinationArgs._configure(_setter, **assessment_reports_destination)
