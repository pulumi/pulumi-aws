...
class ConnectorProfileArgs:
    def __init__(__self__, *,
                 connection_mode: pulumi.Input[builtins.str],
    ...
    def connection_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connection_mode(self, value: pulumi.Input[builtins.str]):
    ...
    def connector_label(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def connector_label(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConnectorProfile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="connectorLabel")
    def connector_label(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The label of the connector. The label is unique for each ConnectorRegistration in your AWS account. Only needed if calling for `CustomConnector` connector type.
        """
        return pulumi.get(self, "connector_label")
    ...
    @property
    @pulumi.getter(name="credentialsArn")
    def credentials_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the connector profile credentials.
        """
        return pulumi.get(self, "credentials_arn")
