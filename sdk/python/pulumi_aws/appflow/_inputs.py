...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] authentication_type: The authentication type that the custom connector uses for authenticating while creating a connector profile. One of: `APIKEY`, `BASIC`, `CUSTOM`, `OAUTH2`.
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsCustomConnectorOauth2OauthRequestArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] redirect_uri: The URL to which the authentication server redirects the browser after authorization has been granted.
        """
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsInforNexusArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] datakey: Encryption keys used to encrypt data.
        :param pulumi.Input[builtins.str] secret_access_key: The secret key used to sign requests.
        :param pulumi.Input[builtins.str] user_id: Identifier for the user.
        """
...
if not MYPY:
    class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceArgsDict(TypedDict):
        ...
        """
        oauth2_grant_type: NotRequired[pulumi.Input[builtins.str]]
...
class ConnectorProfileConnectorProfileConfigConnectorProfileCredentialsSalesforceArgs:
    def __init__(__self__, *,
                 ...
                 oauth2_grant_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 refresh_token: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] client_credentials_arn: The secret manager ARN, which contains the client ID and client secret of the connected app.
        :param pulumi.Input[builtins.str] jwt_token: A JSON web token (JWT) that authorizes access to Salesforce records.
        """
        if access_token is not None:
            pulumi.set(__self__, "access_token", access_token)
    ...
    def oauth2_grant_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "oauth2_grant_type")

    @oauth2_grant_type.setter
    def oauth2_grant_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesCustomConnectorOauth2PropertiesArgsDict(TypedDict):
        oauth2_grant_type: pulumi.Input[builtins.str]
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesCustomConnectorOauth2PropertiesArgs:
    ...
    @property
    @pulumi.getter(name="oauth2GrantType")
    def oauth2_grant_type(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "oauth2_grant_type")

    @oauth2_grant_type.setter
    def oauth2_grant_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "oauth2_grant_type", value)
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesRedshiftArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] role_arn: ARN of the IAM role.
        :param pulumi.Input[builtins.str] cluster_identifier: The unique ID that's assigned to an Amazon Redshift cluster.
        :param pulumi.Input[builtins.str] data_api_role_arn: ARN of the IAM role that permits AppFlow to access the database through Data API.
        :param pulumi.Input[builtins.str] database_name: The name of an Amazon Redshift database.
...
if not MYPY:
    class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSalesforceArgsDict(TypedDict):
        ...
        """
        use_privatelink_for_metadata_and_authorization: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSalesforceArgs:
    def __init__(__self__, *,
                 ...
                 use_privatelink_for_metadata_and_authorization: Optional[pulumi.Input[builtins.bool]] = None):
        """
    ...
    def use_privatelink_for_metadata_and_authorization(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether Amazon AppFlow uses the private network to send metadata and authorization calls to Salesforce. Amazon AppFlow sends private calls through AWS PrivateLink. These calls travel through AWS infrastructure without being exposed to the public internet.
        """
    ...
    def use_privatelink_for_metadata_and_authorization(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataArgsDict(TypedDict):
        application_host_url: pulumi.Input[builtins.str]
        """
        The location of the SAPOData resource.
        """
        application_service_path: pulumi.Input[builtins.str]
        """
        The application path to catalog service.
        """
        client_number: pulumi.Input[builtins.str]
        """
        The client number for the client creating the connection.
        """
        port_number: pulumi.Input[builtins.int]
        """
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataArgs:
    ...
    def application_host_url(self) -> pulumi.Input[builtins.str]:
        """
        The location of the SAPOData resource.
        """
    ...
    def application_host_url(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "application_host_url", value)

    @property
    @pulumi.getter(name="applicationServicePath")
    def application_service_path(self) -> pulumi.Input[builtins.str]:
        """
        The application path to catalog service.
        """
    ...
    def application_service_path(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "application_service_path", value)

    @property
    @pulumi.getter(name="clientNumber")
    def client_number(self) -> pulumi.Input[builtins.str]:
        """
        The client number for the client creating the connection.
        """
    ...
    def client_number(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "client_number", value)

    @property
    @pulumi.getter(name="portNumber")
    def port_number(self) -> pulumi.Input[builtins.int]:
        """
        The port number of the SAPOData instance.
        """
    ...
    @port_number.setter
    def port_number(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOauthPropertiesArgsDict(TypedDict):
        auth_code_url: pulumi.Input[builtins.str]
        """
...
class ConnectorProfileConnectorProfileConfigConnectorProfilePropertiesSapoDataOauthPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] oauth_scopes: The OAuth scopes required for OAuth type authentication.
        """
    ...
    def auth_code_url(self) -> pulumi.Input[builtins.str]:
        """
        The authorization code url required to redirect to SAP Login Page to fetch authorization code for OAuth type authentication.
        """
    ...
    def auth_code_url(self, value: pulumi.Input[builtins.str]):
...
class FlowDestinationFlowConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] connector_type: Type of connector, such as Salesforce, Amplitude, and so on. Valid values are `Salesforce`, `Singular`, `Slack`, `Redshift`, `S3`, `Marketo`, `Googleanalytics`, `Zendesk`, `Servicenow`, `Datadog`, `Trendmicro`, `Snowflake`, `Dynatrace`, `Infornexus`, `Amplitude`, `Veeva`, `EventBridge`, `LookoutMetrics`, `Upsolver`, `Honeycode`, `CustomerProfiles`, `SAPOData`, and `CustomConnector`.
        ...
        :param pulumi.Input[builtins.str] api_version: API version that the destination connector uses.
        :param pulumi.Input[builtins.str] connector_profile_name: Name of the connector profile. This name must be unique for each connector profile in the AWS account.
        """
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnectorArgs:
    ...
    def write_operation_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "write_operation_type")

    @write_operation_type.setter
    def write_operation_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnectorErrorHandlingConfigArgsDict(TypedDict):
        ...
        """
        fail_on_first_destination_error: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesCustomConnectorErrorHandlingConfigArgs:
    def __init__(__self__, *,
                 ...
                 bucket_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 fail_on_first_destination_error: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] bucket_name: Name of the Amazon S3 bucket.
        :param pulumi.Input[builtins.str] bucket_prefix: Amazon S3 bucket prefix.
        :param pulumi.Input[builtins.bool] fail_on_first_destination_error: If the flow should fail after the first instance of a failure when attempting to place data in the destination.
        """
    ...
    def fail_on_first_destination_error(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If the flow should fail after the first instance of a failure when attempting to place data in the destination.
        """
    ...
    def fail_on_first_destination_error(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class FlowDestinationFlowConfigDestinationConnectorPropertiesCustomerProfilesArgsDict(TypedDict):
        ...
        """
        object_type_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesCustomerProfilesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] domain_name: Unique name of the Amazon Connect Customer Profiles domain.
        :param pulumi.Input[builtins.str] object_type_name: Object specified in the Amazon Connect Customer Profiles flow destination.
        """
    ...
    def object_type_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigArgsDict(TypedDict):
        ...
        """
        file_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] file_type: File type that Amazon AppFlow places in the Amazon S3 bucket. Valid values are `CSV`, `JSON`, and `PARQUET`.
        ...
        :param pulumi.Input[builtins.bool] preserve_source_data_typing: Whether the data types from the source system need to be preserved (Only valid for `Parquet` file type)
        """
...
if not MYPY:
    class FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigAggregationConfigArgsDict(TypedDict):
        aggregation_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigAggregationConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] aggregation_type: Whether Amazon AppFlow aggregates the flow records into a single file, or leave them unaggregated. Valid values are `None` and `SingleFile`.
        :param pulumi.Input[builtins.int] target_file_size: The desired file size, in MB, for each output file that Amazon AppFlow writes to the flow destination. Integer value.
        """
...
if not MYPY:
    class FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigPrefixConfigArgsDict(TypedDict):
        prefix_format: NotRequired[pulumi.Input[builtins.str]]
        """
        Determines the level of granularity that's included in the prefix. Valid values are `YEAR`, `MONTH`, `DAY`, `HOUR`, and `MINUTE`.
        """
        prefix_hierarchies: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        prefix_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesS3S3OutputFormatConfigPrefixConfigArgs:
    def __init__(__self__, *,
                 prefix_format: Optional[pulumi.Input[builtins.str]] = None,
                 prefix_hierarchies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 prefix_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] prefix_format: Determines the level of granularity that's included in the prefix. Valid values are `YEAR`, `MONTH`, `DAY`, `HOUR`, and `MINUTE`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prefix_hierarchies: Determines whether the destination file path includes either or both of the selected elements. Valid values are `EXECUTION_ID` and `SCHEMA_VERSION`
        :param pulumi.Input[builtins.str] prefix_type: Determines the format of the prefix, and whether it applies to the file name, file path, or both. Valid values are `FILENAME`, `PATH`, and `PATH_AND_FILENAME`.
        """
    ...
    def prefix_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines the level of granularity that's included in the prefix. Valid values are `YEAR`, `MONTH`, `DAY`, `HOUR`, and `MINUTE`.
        """
    ...
    def prefix_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "prefix_format", value)

    @property
    @pulumi.getter(name="prefixHierarchies")
    def prefix_hierarchies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Determines whether the destination file path includes either or both of the selected elements. Valid values are `EXECUTION_ID` and `SCHEMA_VERSION`
        """
    ...
    def prefix_hierarchies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "prefix_hierarchies", value)

    @property
    @pulumi.getter(name="prefixType")
    def prefix_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines the format of the prefix, and whether it applies to the file name, file path, or both. Valid values are `FILENAME`, `PATH`, and `PATH_AND_FILENAME`.
        """
    ...
    @prefix_type.setter
    def prefix_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigPrefixConfigArgsDict(TypedDict):
        prefix_type: pulumi.Input[builtins.str]
        """
        Determines the format of the prefix, and whether it applies to the file name, file path, or both. Valid values are `FILENAME`, `PATH`, and `PATH_AND_FILENAME`.
        """
        prefix_format: NotRequired[pulumi.Input[builtins.str]]
...
class FlowDestinationFlowConfigDestinationConnectorPropertiesUpsolverS3OutputFormatConfigPrefixConfigArgs:
    ...
    @property
    @pulumi.getter(name="prefixType")
    def prefix_type(self) -> pulumi.Input[builtins.str]:
        """
        Determines the format of the prefix, and whether it applies to the file name, file path, or both. Valid values are `FILENAME`, `PATH`, and `PATH_AND_FILENAME`.
        """
        return pulumi.get(self, "prefix_type")
    ...
    @prefix_type.setter
    def prefix_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "prefix_type", value)
...
class FlowMetadataCatalogConfigGlueDataCatalogArgs:
    def __init__(__self__, *,
                 ...
                 table_prefix: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] database_name: The name of an existing Glue database to store the metadata tables that Amazon AppFlow creates.
        :param pulumi.Input[builtins.str] role_arn: The ARN of an IAM role that grants AppFlow the permissions it needs to create Data Catalog tables, databases, and partitions.
        :param pulumi.Input[builtins.str] table_prefix: A naming prefix for each Data Catalog table that Amazon AppFlow creates
        """
        pulumi.set(__self__, "database_name", database_name)
        pulumi.set(__self__, "role_arn", role_arn)
...
class FlowSourceFlowConfigIncrementalPullConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] datetime_type_field_name: Field that specifies the date time or timestamp field as the criteria to use when importing incremental records from the source.
        """
...
if not MYPY:
    class FlowSourceFlowConfigSourceConnectorPropertiesS3S3InputFormatConfigArgsDict(TypedDict):
        s3_input_file_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FlowSourceFlowConfigSourceConnectorPropertiesS3S3InputFormatConfigArgs:
    def __init__(__self__, *,
                 s3_input_file_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] s3_input_file_type: File type that Amazon AppFlow gets from your Amazon S3 bucket. Valid values are `CSV` and `JSON`.
        """
    ...
    def s3_input_file_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        File type that Amazon AppFlow gets from your Amazon S3 bucket. Valid values are `CSV` and `JSON`.
        """
    ...
    def s3_input_file_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FlowSourceFlowConfigSourceConnectorPropertiesSapoDataPaginationConfigArgs:
    def __init__(__self__, *,
                 max_page_size: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_page_size: he maximum number of records that Amazon AppFlow receives in each page of the response from your SAP application.
        """
...
class FlowSourceFlowConfigSourceConnectorPropertiesVeevaArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] document_type: Document type specified in the Veeva document extract flow.
...
if not MYPY:
    class FlowTaskArgsDict(TypedDict):
        ...
        """
        source_fields: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Source fields to which a particular task is applied.
        """
        task_properties: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class FlowTaskArgs:
    def __init__(__self__, *,
                 ...
                 source_fields: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 task_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] task_type: Particular task implementation that Amazon AppFlow performs. Valid values are `Arithmetic`, `Filter`, `Map`, `Map_all`, `Mask`, `Merge`, `Passthrough`, `Truncate`, and `Validate`.
        ...
        :param pulumi.Input[builtins.str] destination_field: Field in a destination connector, or a field value against which Amazon AppFlow validates a source field.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_fields: Source fields to which a particular task is applied.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] task_properties: Map used to store task-related information. The execution service looks for particular information based on the `TaskType`. Valid keys are `VALUE`, `VALUES`, `DATA_TYPE`, `UPPER_BOUND`, `LOWER_BOUND`, `SOURCE_DATA_TYPE`, `DESTINATION_DATA_TYPE`, `VALIDATION_ACTION`, `MASK_VALUE`, `MASK_LENGTH`, `TRUNCATE_LENGTH`, `MATH_OPERATION_FIELDS_ORDER`, `CONCAT_FORMAT`, `SUBFIELD_CATEGORY_MAP`, and `EXCLUDE_SOURCE_FIELDS_LIST`.
        """
    ...
    def source_fields(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Source fields to which a particular task is applied.
        """
    ...
    def source_fields(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "source_fields", value)

    @property
    @pulumi.getter(name="taskProperties")
    def task_properties(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Map used to store task-related information. The execution service looks for particular information based on the `TaskType`. Valid keys are `VALUE`, `VALUES`, `DATA_TYPE`, `UPPER_BOUND`, `LOWER_BOUND`, `SOURCE_DATA_TYPE`, `DESTINATION_DATA_TYPE`, `VALIDATION_ACTION`, `MASK_VALUE`, `MASK_LENGTH`, `TRUNCATE_LENGTH`, `MATH_OPERATION_FIELDS_ORDER`, `CONCAT_FORMAT`, `SUBFIELD_CATEGORY_MAP`, and `EXCLUDE_SOURCE_FIELDS_LIST`.
        """
...
if not MYPY:
    class FlowTaskConnectorOperatorArgsDict(TypedDict):
        ...
        """
        dynatrace: NotRequired[pulumi.Input[builtins.str]]
        """
        Operation to be performed on the provided Dynatrace source fields. Valid values are `PROJECTION`, `BETWEEN`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        google_analytics: NotRequired[pulumi.Input[builtins.str]]
        """
        Operation to be performed on the provided Google Analytics source fields. Valid values are `PROJECTION` and `BETWEEN`.
        """
        infor_nexus: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        marketo: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        slack: NotRequired[pulumi.Input[builtins.str]]
        """
        Operation to be performed on the provided Slack source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        trendmicro: NotRequired[pulumi.Input[builtins.str]]
        """
        Operation to be performed on the provided Trend Micro source fields. Valid values are `PROJECTION`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        veeva: NotRequired[pulumi.Input[builtins.str]]
        """
        Operation to be performed on the provided Veeva source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        zendesk: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FlowTaskConnectorOperatorArgs:
    def __init__(__self__, *,
                 amplitude: Optional[pulumi.Input[builtins.str]] = None,
                 custom_connector: Optional[pulumi.Input[builtins.str]] = None,
                 datadog: Optional[pulumi.Input[builtins.str]] = None,
                 dynatrace: Optional[pulumi.Input[builtins.str]] = None,
                 google_analytics: Optional[pulumi.Input[builtins.str]] = None,
                 infor_nexus: Optional[pulumi.Input[builtins.str]] = None,
                 marketo: Optional[pulumi.Input[builtins.str]] = None,
                 s3: Optional[pulumi.Input[builtins.str]] = None,
                 salesforce: Optional[pulumi.Input[builtins.str]] = None,
                 sapo_data: Optional[pulumi.Input[builtins.str]] = None,
                 service_now: Optional[pulumi.Input[builtins.str]] = None,
                 singular: Optional[pulumi.Input[builtins.str]] = None,
                 slack: Optional[pulumi.Input[builtins.str]] = None,
                 trendmicro: Optional[pulumi.Input[builtins.str]] = None,
                 veeva: Optional[pulumi.Input[builtins.str]] = None,
                 zendesk: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] amplitude: Operation to be performed on the provided Amplitude source fields. The only valid value is `BETWEEN`.
        :param pulumi.Input[builtins.str] custom_connector: Operators supported by the custom connector. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] datadog: Operation to be performed on the provided Datadog source fields. Valid values are `PROJECTION`, `BETWEEN`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] dynatrace: Operation to be performed on the provided Dynatrace source fields. Valid values are `PROJECTION`, `BETWEEN`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] google_analytics: Operation to be performed on the provided Google Analytics source fields. Valid values are `PROJECTION` and `BETWEEN`.
        :param pulumi.Input[builtins.str] infor_nexus: Operation to be performed on the provided Infor Nexus source fields. Valid values are `PROJECTION`, `BETWEEN`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] marketo: Operation to be performed on the provided Marketo source fields. Valid values are `PROJECTION`, `BETWEEN`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] s3: Operation to be performed on the provided Amazon S3 source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] salesforce: Operation to be performed on the provided Salesforce source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] sapo_data: Operation to be performed on the provided SAPOData source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] service_now: Operation to be performed on the provided ServiceNow source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] singular: Operation to be performed on the provided Singular source fields. Valid values are `PROJECTION`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] slack: Operation to be performed on the provided Slack source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] trendmicro: Operation to be performed on the provided Trend Micro source fields. Valid values are `PROJECTION`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] veeva: Operation to be performed on the provided Veeva source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        :param pulumi.Input[builtins.str] zendesk: Operation to be performed on the provided Zendesk source fields. Valid values are `PROJECTION`, `GREATER_THAN`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        if amplitude is not None:
            pulumi.set(__self__, "amplitude", amplitude)
        if custom_connector is not None:
    ...
    @property
    @pulumi.getter
    def amplitude(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Amplitude source fields. The only valid value is `BETWEEN`.
        """
        return pulumi.get(self, "amplitude")
    ...
    @amplitude.setter
    def amplitude(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "amplitude", value)

    @property
    @pulumi.getter(name="customConnector")
    def custom_connector(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operators supported by the custom connector. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "custom_connector")
    ...
    @custom_connector.setter
    def custom_connector(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_connector", value)

    @property
    @pulumi.getter
    def datadog(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Datadog source fields. Valid values are `PROJECTION`, `BETWEEN`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "datadog")
    ...
    @datadog.setter
    def datadog(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "datadog", value)

    @property
    @pulumi.getter
    def dynatrace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Dynatrace source fields. Valid values are `PROJECTION`, `BETWEEN`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "dynatrace")
    ...
    @dynatrace.setter
    def dynatrace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dynatrace", value)

    @property
    @pulumi.getter(name="googleAnalytics")
    def google_analytics(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Google Analytics source fields. Valid values are `PROJECTION` and `BETWEEN`.
        """
        return pulumi.get(self, "google_analytics")
    ...
    @google_analytics.setter
    def google_analytics(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "google_analytics", value)

    @property
    @pulumi.getter(name="inforNexus")
    def infor_nexus(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Infor Nexus source fields. Valid values are `PROJECTION`, `BETWEEN`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "infor_nexus")
    ...
    @infor_nexus.setter
    def infor_nexus(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "infor_nexus", value)

    @property
    @pulumi.getter
    def marketo(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Marketo source fields. Valid values are `PROJECTION`, `BETWEEN`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "marketo")
    ...
    @marketo.setter
    def marketo(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "marketo", value)

    @property
    @pulumi.getter
    def s3(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Amazon S3 source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "s3")
    ...
    @s3.setter
    def s3(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "s3", value)

    @property
    @pulumi.getter
    def salesforce(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Salesforce source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "salesforce")
    ...
    @salesforce.setter
    def salesforce(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "salesforce", value)

    @property
    @pulumi.getter(name="sapoData")
    def sapo_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided SAPOData source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "sapo_data")
    ...
    @sapo_data.setter
    def sapo_data(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sapo_data", value)

    @property
    @pulumi.getter(name="serviceNow")
    def service_now(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided ServiceNow source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "service_now")
    ...
    @service_now.setter
    def service_now(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_now", value)
    ...
    @property
    @pulumi.getter
    def slack(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Slack source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "slack")
    ...
    @slack.setter
    def slack(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "slack", value)

    @property
    @pulumi.getter
    def trendmicro(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Trend Micro source fields. Valid values are `PROJECTION`, `EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "trendmicro")
    ...
    @trendmicro.setter
    def trendmicro(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trendmicro", value)

    @property
    @pulumi.getter
    def veeva(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Veeva source fields. Valid values are `PROJECTION`, `LESS_THAN`, `GREATER_THAN`, `CONTAINS`, `BETWEEN`, `LESS_THAN_OR_EQUAL_TO`, `GREATER_THAN_OR_EQUAL_TO`, `EQUAL_TO`, `NOT_EQUAL_TO`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "veeva")
    ...
    @veeva.setter
    def veeva(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "veeva", value)

    @property
    @pulumi.getter
    def zendesk(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Operation to be performed on the provided Zendesk source fields. Valid values are `PROJECTION`, `GREATER_THAN`, `ADDITION`, `MULTIPLICATION`, `DIVISION`, `SUBTRACTION`, `MASK_ALL`, `MASK_FIRST_N`, `MASK_LAST_N`, `VALIDATE_NON_NULL`, `VALIDATE_NON_ZERO`, `VALIDATE_NON_NEGATIVE`, `VALIDATE_NUMERIC`, and `NO_OP`.
        """
        return pulumi.get(self, "zendesk")
    ...
    @zendesk.setter
    def zendesk(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "zendesk", value)
...
class FlowTriggerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] trigger_type: Type of flow trigger. Valid values are `Scheduled`, `Event`, and `OnDemand`.
...
if not MYPY:
    class FlowTriggerConfigTriggerPropertiesScheduledArgsDict(TypedDict):
        ...
        """
        data_pull_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FlowTriggerConfigTriggerPropertiesScheduledArgs:
    def __init__(__self__, *,
                 schedule_expression: pulumi.Input[builtins.str],
                 data_pull_mode: Optional[pulumi.Input[builtins.str]] = None,
                 first_execution_from: Optional[pulumi.Input[builtins.str]] = None,
                 schedule_end_time: Optional[pulumi.Input[builtins.str]] = None,
                 schedule_offset: Optional[pulumi.Input[builtins.int]] = None,
                 schedule_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] schedule_expression: Scheduling expression that determines the rate at which the schedule will run, for example `rate(5minutes)`.
        :param pulumi.Input[builtins.str] data_pull_mode: Whether a scheduled flow has an incremental data transfer or a complete data transfer for each flow run. Valid values are `Incremental` and `Complete`.
        :param pulumi.Input[builtins.str] first_execution_from: Date range for the records to import from the connector in the first flow run. Must be a valid RFC3339 timestamp.
        :param pulumi.Input[builtins.str] schedule_end_time: Scheduled end time for a schedule-triggered flow. Must be a valid RFC3339 timestamp.
        :param pulumi.Input[builtins.int] schedule_offset: Optional offset that is added to the time interval for a schedule-triggered flow. Maximum value of 36000.
        :param pulumi.Input[builtins.str] schedule_start_time: Scheduled start time for a schedule-triggered flow. Must be a valid RFC3339 timestamp.
        :param pulumi.Input[builtins.str] timezone: Time zone used when referring to the date and time of a scheduled-triggered flow, such as `America/New_York`.
        """
    ...
    def data_pull_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether a scheduled flow has an incremental data transfer or a complete data transfer for each flow run. Valid values are `Incremental` and `Complete`.
        """
    ...
    def data_pull_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def schedule_end_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Scheduled end time for a schedule-triggered flow. Must be a valid RFC3339 timestamp.
        """
    ...
    def schedule_end_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def schedule_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Scheduled start time for a schedule-triggered flow. Must be a valid RFC3339 timestamp.
        """
    ...
    def schedule_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
