...
def get_state_machine_versions(region: Optional[_builtins.str] = None,
...
def get_state_machine_versions_output(region: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
