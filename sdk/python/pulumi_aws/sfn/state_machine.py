...
class StateMachineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] definition: The [Amazon States Language](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html) definition of the state machine.
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role to use for this state machine.
        ...
        :param pulumi.Input[builtins.str] name: The name of the state machine. The name should only contain `0`-`9`, `A`-`Z`, `a`-`z`, `-` and `_`. If omitted, the provider will assign a random, unique name.
        ...
        :param pulumi.Input[builtins.bool] publish: Set to true to publish a version of the state machine during creation. Default: false.
        ...
        :param pulumi.Input[builtins.str] type: Determines whether a Standard or Express state machine is created. The default is `STANDARD`. You cannot update the type of a state machine once it has been created. Valid values: `STANDARD`, `EXPRESS`.
        """
...
class _StateMachineState:
    def __init__(__self__, *,
                 ...
                 state_machine_version_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the state machine.
        :param pulumi.Input[builtins.str] creation_date: The date the state machine was created.
        :param pulumi.Input[builtins.str] definition: The [Amazon States Language](https://docs.aws.amazon.com/step-functions/latest/dg/concepts-amazon-states-language.html) definition of the state machine.
        :param pulumi.Input['StateMachineEncryptionConfigurationArgs'] encryption_configuration: Defines what encryption configuration is used to encrypt data in the State Machine. For more information see [TBD] in the AWS Step Functions User Guide.
        :param pulumi.Input['StateMachineLoggingConfigurationArgs'] logging_configuration: Defines what execution history events are logged and where they are logged. The `logging_configuration` parameter is valid when `type` is set to `STANDARD` or `EXPRESS`. Defaults to `OFF`. For more information see [Logging Express Workflows](https://docs.aws.amazon.com/step-functions/latest/dg/cw-logs.html), [Log Levels](https://docs.aws.amazon.com/step-functions/latest/dg/cloudwatch-log-level.html) and [Logging Configuration](https://docs.aws.amazon.com/step-functions/latest/apireference/API_CreateStateMachine.html) in the AWS Step Functions User Guide.
        :param pulumi.Input[builtins.str] name: The name of the state machine. The name should only contain `0`-`9`, `A`-`Z`, `a`-`z`, `-` and `_`. If omitted, the provider will assign a random, unique name.
        ...
        :param pulumi.Input[builtins.bool] publish: Set to true to publish a version of the state machine during creation. Default: false.
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the IAM role to use for this state machine.
        :param pulumi.Input[builtins.str] state_machine_version_arn: The ARN of the state machine version.
        :param pulumi.Input[builtins.str] status: The current status of the state machine. Either `ACTIVE` or `DELETING`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value map of resource tags. .If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    def state_machine_version_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def state_machine_version_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class StateMachine(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tracing_configuration: Optional[pulumi.Input[Union['StateMachineTracingConfigurationArgs', 'StateMachineTracingConfigurationArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            version_description: Optional[pulumi.Input[builtins.str]] = None) -> 'StateMachine':
        """
    ...
    @property
    @pulumi.getter(name="stateMachineVersionArn")
    def state_machine_version_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the state machine version.
        """
        return pulumi.get(self, "state_machine_version_arn")
