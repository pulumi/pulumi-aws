...
@pulumi.output_type
class S3TableIntegrationEncryption(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "sseAlgorithm":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in S3TableIntegrationEncryption. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        S3TableIntegrationEncryption.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_arn: Optional[_builtins.str] = None):
        """
        :param _builtins.str sse_algorithm: Server-side encryption algorithm. Valid values: `AES256`, `aws:kms`.
        :param _builtins.str kms_key_arn: ARN of the KMS key to use for encryption. Required when `sse_algorithm` is `aws:kms`.
        """
...
@pulumi.output_type
class S3TableIntegrationTimeouts(dict):
    def __init__(__self__, *,
                 create: Optional[_builtins.str] = None,
