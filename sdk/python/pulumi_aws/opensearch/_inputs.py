...
class AuthorizeVpcEndpointAccessAuthorizedPrincipalArgs:
    def __init__(__self__, *,
                 ...
                 principal_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] principal: IAM principal that is allowed to access to the domain.
        :param pulumi.Input[builtins.str] principal_type: Type of principal.
        """
...
if not MYPY:
    class DomainAdvancedSecurityOptionsArgsDict(TypedDict):
        ...
        """
        anonymous_auth_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DomainAdvancedSecurityOptionsArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool],
                 anonymous_auth_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] anonymous_auth_enabled: Whether Anonymous auth is enabled. Enables fine-grained access control on an existing domain. Ignored unless `advanced_security_options` are enabled. _Can only be enabled on an existing domain._
        :param pulumi.Input[builtins.bool] internal_user_database_enabled: Whether the internal user database is enabled. Default is `false`.
    ...
    def anonymous_auth_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether Anonymous auth is enabled. Enables fine-grained access control on an existing domain. Ignored unless `advanced_security_options` are enabled. _Can only be enabled on an existing domain._
        """
    ...
    def anonymous_auth_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DomainAdvancedSecurityOptionsMasterUserOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] master_user_name: Main user's username, which is stored in the Amazon OpenSearch Service domain's internal database. Only specify if `internal_user_database_enabled` is set to `true`.
        :param pulumi.Input[builtins.str] master_user_password: Main user's password, which is stored in the Amazon OpenSearch Service domain's internal database. Only specify if `internal_user_database_enabled` is set to `true`.
        """
...
if not MYPY:
    class DomainAutoTuneOptionsArgsDict(TypedDict):
        ...
        **NOTE:** Maintenance windows are deprecated and have been replaced with [off-peak windows](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/off-peak.html). Consequently, `maintenance_schedule` configuration blocks cannot be specified when `use_off_peak_window` is set to `true`.
        ...
        """
        use_off_peak_window: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DomainAutoTuneOptionsArgs:
    def __init__(__self__, *,
                 ...
                 use_off_peak_window: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] desired_state: Auto-Tune desired state for the domain. Valid values: `ENABLED` or `DISABLED`.
        ...
        :param pulumi.Input[builtins.bool] use_off_peak_window: Whether to schedule Auto-Tune optimizations that require blue/green deployments during the domain's configured daily off-peak window. Defaults to `false`.
        """
    ...
    def use_off_peak_window(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to schedule Auto-Tune optimizations that require blue/green deployments during the domain's configured daily off-peak window. Defaults to `false`.
        """
    ...
    def use_off_peak_window(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DomainAutoTuneOptionsMaintenanceScheduleDurationArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] unit: Unit of time specifying the duration of an Auto-Tune maintenance window. Valid values: `HOURS`.
...
if not MYPY:
    class DomainClusterConfigArgsDict(TypedDict):
        ...
        """
        multi_az_with_standby_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DomainClusterConfigArgs:
    def __init__(__self__, *,
                 ...
                 multi_az_with_standby_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] multi_az_with_standby_enabled: Whether a multi-AZ domain is turned on with a standby AZ. For more information, see [Configuring a multi-AZ domain in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-multiaz.html).
        ...
        :param pulumi.Input[builtins.str] warm_type: Instance type for the OpenSearch cluster's warm nodes. Valid values are `ultrawarm1.medium.search`, `ultrawarm1.large.search` and `ultrawarm1.xlarge.search`. `warm_type` can be only and must be set when `warm_enabled` is set to `true`.
    ...
    def multi_az_with_standby_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether a multi-AZ domain is turned on with a standby AZ. For more information, see [Configuring a multi-AZ domain in Amazon OpenSearch Service](https://docs.aws.amazon.com/opensearch-service/latest/developerguide/managedomains-multiaz.html).
        """
    ...
    def multi_az_with_standby_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DomainClusterConfigColdStorageOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Boolean to enable cold storage for an OpenSearch domain. Defaults to `false`. Master and ultrawarm nodes must be enabled for cold storage.
        """
...
class DomainClusterConfigNodeOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] node_type: Type of node this configuration describes. Valid values: `coordinator`.
        """
...
class DomainClusterConfigNodeOptionNodeConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] count: Number of nodes of a particular node type in the cluster.
        :param pulumi.Input[builtins.bool] enabled: Whether a particular node type is enabled.
        :param pulumi.Input[builtins.str] type: The instance type of a particular node type in the cluster.
        """
...
class DomainCognitoOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: ARN of the IAM role that has the AmazonOpenSearchServiceCognitoAccess policy attached.
        :param pulumi.Input[builtins.str] user_pool_id: ID of the Cognito User Pool to use.
        :param pulumi.Input[builtins.bool] enabled: Whether Amazon Cognito authentication with Dashboard is enabled or not. Default is `false`.
        """
...
class DomainDomainEndpointOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] custom_endpoint_enabled: Whether to enable custom endpoint for the OpenSearch domain.
...
class DomainEncryptAtRestArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Whether to enable encryption at rest. If the `encrypt_at_rest` block is not provided then this defaults to `false`. Enabling encryption on new domains requires an `engine_version` of `OpenSearch_X.Y` or `Elasticsearch_5.1` or greater.
...
class DomainLogPublishingOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] log_type: Type of OpenSearch log. Valid values: `INDEX_SLOW_LOGS`, `SEARCH_SLOW_LOGS`, `ES_APPLICATION_LOGS`, `AUDIT_LOGS`.
...
class DomainNodeToNodeEncryptionArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Whether to enable node-to-node encryption. If the `node_to_node_encryption` block is not provided then this defaults to `false`. Enabling node-to-node encryption of a new domain requires an `engine_version` of `OpenSearch_X.Y` or `Elasticsearch_6.0` or greater.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class DomainOffPeakWindowOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Enabled disabled toggle for off-peak update window.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class DomainOffPeakWindowOptionsOffPeakWindowWindowStartTimeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] hours: Starting hour of the 10-hour window for updates
        :param pulumi.Input[builtins.int] minutes: Starting minute of the 10-hour window for updates
        """
...
class DomainSamlOptionsSamlOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subject_key: Element of the SAML assertion to use for username. Default is NameID.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if idp is not None:
...
class DomainSamlOptionsSamlOptionsIdpArgs:
    def __init__(__self__, *,
                 ...
                 metadata_content: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] entity_id: Unique Entity ID of the application in SAML Identity Provider.
        :param pulumi.Input[builtins.str] metadata_content: Metadata of the SAML application in xml format.
        """
...
if not MYPY:
    class DomainSoftwareUpdateOptionsArgsDict(TypedDict):
        auto_software_update_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DomainSoftwareUpdateOptionsArgs:
    def __init__(__self__, *,
                 auto_software_update_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] auto_software_update_enabled: Whether automatic service software updates are enabled for the domain. Defaults to `false`.
        """
    ...
    def auto_software_update_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether automatic service software updates are enabled for the domain. Defaults to `false`.
        """
    ...
    def auto_software_update_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DomainVpcOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: List of VPC Security Group IDs to be applied to the OpenSearch domain endpoints. If omitted, the default Security Group for the VPC will be used.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: List of VPC Subnet IDs for the OpenSearch domain endpoints to be created in.
...
class OutboundConnectionConnectionPropertiesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint: The endpoint of the remote domain, is only set when `connection_mode` is `VPC_ENDPOINT` and `accept_connection` is `TRUE`.
        """
...
if not MYPY:
    class OutboundConnectionConnectionPropertiesCrossClusterSearchArgsDict(TypedDict):
        skip_unavailable: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OutboundConnectionConnectionPropertiesCrossClusterSearchArgs:
    def __init__(__self__, *,
                 skip_unavailable: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] skip_unavailable: Skips unavailable clusters and can only be used for cross-cluster searches. Accepted values are `ENABLED` or `DISABLED`.
        """
    ...
    def skip_unavailable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Skips unavailable clusters and can only be used for cross-cluster searches. Accepted values are `ENABLED` or `DISABLED`.
        """
    ...
    def skip_unavailable(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OutboundConnectionLocalDomainInfoArgs:
    def __init__(__self__, *,
                 ...
                 region: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] domain_name: The name of the local domain.
        :param pulumi.Input[builtins.str] owner_id: The Account ID of the owner of the local domain.
        :param pulumi.Input[builtins.str] region: The region of the local domain.
        """
...
class OutboundConnectionRemoteDomainInfoArgs:
    def __init__(__self__, *,
                 ...
                 region: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] domain_name: The name of the remote domain.
        :param pulumi.Input[builtins.str] owner_id: The Account ID of the owner of the remote domain.
        :param pulumi.Input[builtins.str] region: The region of the remote domain.
        """
        pulumi.set(__self__, "domain_name", domain_name)
        pulumi.set(__self__, "owner_id", owner_id)
        pulumi.set(__self__, "region", region)
...
class PackagePackageSourceArgs:
    def __init__(__self__, *,
                 ...
                 s3_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] s3_bucket_name: The name of the Amazon S3 bucket containing the package.
        :param pulumi.Input[builtins.str] s3_key: Key (file name) of the package.
        """
...
class ServerlessSecurityConfigSamlOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] metadata: The XML IdP metadata file generated from your identity provider.
        :param pulumi.Input[builtins.str] group_attribute: Group attribute for this SAML integration.
        :param pulumi.Input[builtins.int] session_timeout: Session timeout, in minutes. Minimum is 5 minutes and maximum is 720 minutes (12 hours). Default is 60 minutes.
        :param pulumi.Input[builtins.str] user_attribute: User attribute for this SAML integration.
        """
...
class VpcEndpointVpcOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The list of security group IDs associated with the VPC endpoints for the domain. If you do not provide a security group ID, OpenSearch Service uses the default security group for the VPC.
        """
        pulumi.set(__self__, "subnet_ids", subnet_ids)
        if availability_zones is not None:
            pulumi.set(__self__, "availability_zones", availability_zones)
...
class GetDomainOffPeakWindowOptionsOffPeakWindowWindowStartTimeArgs:
    ...
    @hours.setter
    def hours(self, value: builtins.int):
        pulumi.set(self, "hours", value)
    ...
    @minutes.setter
    def minutes(self, value: builtins.int):
        pulumi.set(self, "minutes", value)
...
class GetServerlessSecurityConfigSamlOptionsArgs:
    ...
    @group_attribute.setter
    def group_attribute(self, value: builtins.str):
        pulumi.set(self, "group_attribute", value)
    ...
    @metadata.setter
    def metadata(self, value: builtins.str):
        pulumi.set(self, "metadata", value)
    ...
    @session_timeout.setter
    def session_timeout(self, value: builtins.int):
        pulumi.set(self, "session_timeout", value)
    ...
    @user_attribute.setter
    def user_attribute(self, value: builtins.str):
        pulumi.set(self, "user_attribute", value)
