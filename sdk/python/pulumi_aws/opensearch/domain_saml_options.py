...
calass DomainSamlOptionsArrgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DomainSamlOptionsSamlOptionsArrgs'] saml_options: SAML authentication options for an AWS OpenSearch Domain.
        """
...
calass DomainSamlOptions(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_domain = aws.opensearch.Domain("exampleDomain",
            ...
            snapshot_options=aws.opensearch.DomainSnapshotOptionsArrgs(
        ...
        example_domain_saml_options = aws.opensearch.DomainSamlOptions("exampleDomainSamlOptions",
            ...
            saml_options=aws.opensearch.DomainSamlOptionsSamlOptionsArrgs(
                enabled=True,
                idp=aws.opensearch.DomainSamlOptionsSamlOptionsIdpArrgs(
        ...
        :param pulumi.Input[str] domain_name: Name of the domain.
               ...
               The following arguments are optional:
        :param pulumi.Input[pulumi.InputType['DomainSamlOptionsSamlOptionsArrgs']] saml_options: SAML authentication options for an AWS OpenSearch Domain.
        """
        ...
    @overload
    def __init__(__self__,
