...
class VpcEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            vpc_options = _utilities.configure(vpc_options, VpcEndpointVpcOptionsArgs, True)
