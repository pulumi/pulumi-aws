...
def get_serverless_lifecycle_policy(name: Optional[_builtins.str] = None,
...
def get_serverless_lifecycle_policy_output(name: Optional[pulumi.Input[_builtins.str]] = None,
