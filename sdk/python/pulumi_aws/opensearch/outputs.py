...
class DomainAutoTuneOptions(dict):
    ...
    def _configure(
        ...
        if 'maintenanceSchedules' in kwargs:
            maintenance_schedules = kwargs['maintenanceSchedules']
        if 'rollbackOnDisable' in kwargs:
...
class DomainAutoTuneOptionsMaintenanceSchedule(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'cronExpressionForRecurrence' in kwargs:
...
class DomainClusterConfig(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'coldStorageOptions' in kwargs:
...
class OutboundConnectionConnectionProperties(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'crossClusterSearch' in kwargs:
...
class GetDomainClusterConfigResult(dict):
    ...
    def _configure(
        ...
        if 'warmType' in kwargs:
            warm_type = kwargs['warmType']
        if 'zoneAwarenessConfigs' in kwargs:
