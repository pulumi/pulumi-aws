...
class PackageArgs:
    ...
    def package_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class _PackageState:
    def __init__(__self__, *,
                 available_package_version: Optional[pulumi.Input[builtins.str]] = None,
                 package_description: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def available_package_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def available_package_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Package(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="availablePackageVersion")
    def available_package_version(self) -> pulumi.Output[builtins.str]:
        """
        The current version of the package.
        """
        return pulumi.get(self, "available_package_version")
    ...
    @property
    @pulumi.getter(name="packageDescription")
    def package_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Description of the package.
        """
        return pulumi.get(self, "package_description")
