...
class IdentitySourceConfigurationCognitoUserPoolConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] user_pool_arn: The Amazon Resource Name (ARN) of the Amazon Cognito user pool that contains the identities to be authorized.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_ids: The unique application client IDs that are associated with the specified Amazon Cognito user pool.
...
if not MYPY:
    class IdentitySourceConfigurationCognitoUserPoolConfigurationGroupConfigurationArgsDict(TypedDict):
        group_entity_type: pulumi.Input[builtins.str]
        """
...
class IdentitySourceConfigurationCognitoUserPoolConfigurationGroupConfigurationArgs:
    def __init__(__self__, *,
                 group_entity_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] group_entity_type: The name of the schema entity type that's mapped to the user pool group. Defaults to `AWS::CognitoGroup`.
        """
        pulumi.set(__self__, "group_entity_type", group_entity_type)

    @property
    @pulumi.getter(name="groupEntityType")
    def group_entity_type(self) -> pulumi.Input[builtins.str]:
        """
        The name of the schema entity type that's mapped to the user pool group. Defaults to `AWS::CognitoGroup`.
        """
    ...
    def group_entity_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class IdentitySourceConfigurationOpenIdConnectConfigurationArgsDict(TypedDict):
        ...
        """
        entity_id_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IdentitySourceConfigurationOpenIdConnectConfigurationArgs:
    def __init__(__self__, *,
                 issuer: pulumi.Input[builtins.str],
                 entity_id_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] issuer: The issuer URL of an OIDC identity provider. This URL must have an OIDC discovery endpoint at the path `.well-known/openid-configuration`.
        :param pulumi.Input[builtins.str] entity_id_prefix: A descriptive string that you want to prefix to user entities from your OIDC identity provider.
    ...
    def entity_id_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A descriptive string that you want to prefix to user entities from your OIDC identity provider.
        """
    ...
    def entity_id_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class IdentitySourceConfigurationOpenIdConnectConfigurationGroupConfigurationArgsDict(TypedDict):
        group_claim: pulumi.Input[builtins.str]
        """
...
class IdentitySourceConfigurationOpenIdConnectConfigurationGroupConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 group_entity_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] group_claim: The token claim that you want Verified Permissions to interpret as group membership. For example, `groups`.
        :param pulumi.Input[builtins.str] group_entity_type: The name of the schema entity type that's mapped to the user pool group. Defaults to `AWS::CognitoGroup`.
        """
    ...
    def group_claim(self) -> pulumi.Input[builtins.str]:
        """
        The token claim that you want Verified Permissions to interpret as group membership. For example, `groups`.
        """
    ...
    @group_claim.setter
    def group_claim(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class IdentitySourceConfigurationOpenIdConnectConfigurationTokenSelectionAccessTokenOnlyArgsDict(TypedDict):
        ...
        """
        principal_id_claim: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IdentitySourceConfigurationOpenIdConnectConfigurationTokenSelectionAccessTokenOnlyArgs:
    def __init__(__self__, *,
                 ...
                 principal_id_claim: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] audiences: The access token aud claim values that you want to accept in your policy store.
        :param pulumi.Input[builtins.str] principal_id_claim: The claim that determines the principal in OIDC access tokens.
        """
    ...
    def principal_id_claim(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The claim that determines the principal in OIDC access tokens.
        """
    ...
    def principal_id_claim(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IdentitySourceConfigurationOpenIdConnectConfigurationTokenSelectionIdentityTokenOnlyArgs:
    def __init__(__self__, *,
                 ...
                 principal_id_claim: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_ids: The ID token audience, or client ID, claim values that you want to accept in your policy store from an OIDC identity provider.
        :param pulumi.Input[builtins.str] principal_id_claim: The claim that determines the principal in OIDC access tokens.
        """
        if client_ids is not None:
            pulumi.set(__self__, "client_ids", client_ids)
...
class PolicyDefinitionStaticArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] statement: The statement of the static policy.
        :param pulumi.Input[builtins.str] description: The description of the static policy.
        """
...
if not MYPY:
    class PolicyDefinitionTemplateLinkedArgsDict(TypedDict):
        policy_template_id: pulumi.Input[builtins.str]
        """
...
class PolicyDefinitionTemplateLinkedArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] policy_template_id: The ID of the template.
    ...
    def policy_template_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the template.
        """
    ...
    def policy_template_id(self, value: pulumi.Input[builtins.str]):
...
class PolicyDefinitionTemplateLinkedPrincipalArgs:
    def __init__(__self__, *,
                 ...
                 entity_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] entity_id: The entity ID of the principal.
        :param pulumi.Input[builtins.str] entity_type: The entity type of the principal.
        """
...
class PolicyDefinitionTemplateLinkedResourceArgs:
    def __init__(__self__, *,
                 ...
                 entity_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] entity_id: The entity ID of the resource.
        :param pulumi.Input[builtins.str] entity_type: The entity type of the resource.
        """
        pulumi.set(__self__, "entity_id", entity_id)
        pulumi.set(__self__, "entity_type", entity_type)
...
class PolicyStoreValidationSettingsArgs:
    def __init__(__self__, *,
                 mode: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] mode: The mode for the validation settings. Valid values: `OFF`, `STRICT`.
...
class SchemaDefinitionArgs:
    def __init__(__self__, *,
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] value: A JSON string representation of the schema.
        """
