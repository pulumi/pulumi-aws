...
class _PolicyTemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_date: The date the Policy Store was created.
        :param pulumi.Input[builtins.str] description: Provides a description for the policy template.
        :param pulumi.Input[builtins.str] policy_store_id: The ID of the Policy Store.
    ...
    def policy_template_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Policy Store.
        """
    ...
    def policy_template_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PolicyTemplate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="policyTemplateId")
    def policy_template_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Policy Store.
        """
        return pulumi.get(self, "policy_template_id")
