...
@pulumi.output_type
calass GetOrganizationalUnitDescendantAccountsResult:
    """
...
calass AwaitableGetOrganizationalUnitDescendantAccountsResult(GetOrganizationalUnitDescendantAccountsResult):
