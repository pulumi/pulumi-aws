...
def get_organizational_unit_descendant_accounts(parent_id: Optional[builtins.str] = None,
    ...
    :param builtins.str parent_id: The parent ID of the accounts.
    """
    __args__ = dict()
...
def get_organizational_unit_descendant_accounts_output(parent_id: Optional[pulumi.Input[builtins.str]] = None,
