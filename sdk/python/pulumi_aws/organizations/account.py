...
class AccountArgs:
    def __init__(__self__, *,
                 ...
                 close_on_deletion: Optional[pulumi.Input[builtins.bool]] = None,
                 create_govcloud: Optional[pulumi.Input[builtins.bool]] = None,
                 iam_user_access_to_billing: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] email: Email address of the owner to assign to the new member account. This email address must not already be associated with another AWS account.
        :param pulumi.Input[builtins.bool] close_on_deletion: If true, a deletion event will close the account. Otherwise, it will only remove from the organization. This is not supported for GovCloud accounts.
        :param pulumi.Input[builtins.bool] create_govcloud: Whether to also create a GovCloud account. The GovCloud account is tied to the main (commercial) account this resource creates. If `true`, the GovCloud account ID is available in the `govcloud_id` attribute. The only way to manage the GovCloud account with the provider is to subsequently import the account using this resource.
        :param pulumi.Input[builtins.str] iam_user_access_to_billing: If set to `ALLOW`, the new account enables IAM users and roles to access account billing information if they have the required permissions. If set to `DENY`, then only the root user (and no roles) of the new account can access account billing information. If this is unset, the AWS API will default this to `ALLOW`. If the resource is created and this option is changed, it will try to recreate the account.
        :param pulumi.Input[builtins.str] name: Friendly name for the member account.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] parent_id: Parent Organizational Unit ID or Root ID for the account. Defaults to the Organization default Root ID. A configuration must be present for this argument to perform drift detection.
        :param pulumi.Input[builtins.str] role_name: The name of an IAM role that Organizations automatically preconfigures in the new member account. This role trusts the root account, allowing users in the root account to assume the role, as permitted by the root account administrator. The role has administrator permissions in the new member account. The Organizations API provides no method for reading this information after account creation, so the provider cannot perform drift detection on its value and will always show a difference for a configured value after import unless `ignoreChanges` is used.
    ...
    def close_on_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def close_on_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "close_on_deletion", value)

    @property
    @pulumi.getter(name="createGovcloud")
    def create_govcloud(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def create_govcloud(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "create_govcloud", value)

    @property
    @pulumi.getter(name="iamUserAccessToBilling")
    def iam_user_access_to_billing(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def iam_user_access_to_billing(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AccountState:
    def __init__(__self__, *,
                 ...
                 govcloud_id: Optional[pulumi.Input[builtins.str]] = None,
                 iam_user_access_to_billing: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN for this account.
        :param pulumi.Input[builtins.bool] close_on_deletion: If true, a deletion event will close the account. Otherwise, it will only remove from the organization. This is not supported for GovCloud accounts.
        :param pulumi.Input[builtins.bool] create_govcloud: Whether to also create a GovCloud account. The GovCloud account is tied to the main (commercial) account this resource creates. If `true`, the GovCloud account ID is available in the `govcloud_id` attribute. The only way to manage the GovCloud account with the provider is to subsequently import the account using this resource.
        :param pulumi.Input[builtins.str] email: Email address of the owner to assign to the new member account. This email address must not already be associated with another AWS account.
        :param pulumi.Input[builtins.str] govcloud_id: ID for a GovCloud account created with the account.
        :param pulumi.Input[builtins.str] iam_user_access_to_billing: If set to `ALLOW`, the new account enables IAM users and roles to access account billing information if they have the required permissions. If set to `DENY`, then only the root user (and no roles) of the new account can access account billing information. If this is unset, the AWS API will default this to `ALLOW`. If the resource is created and this option is changed, it will try to recreate the account.
        :param pulumi.Input[builtins.str] name: Friendly name for the member account.
        ...
        :param pulumi.Input[builtins.str] parent_id: Parent Organizational Unit ID or Root ID for the account. Defaults to the Organization default Root ID. A configuration must be present for this argument to perform drift detection.
        :param pulumi.Input[builtins.str] role_name: The name of an IAM role that Organizations automatically preconfigures in the new member account. This role trusts the root account, allowing users in the root account to assume the role, as permitted by the root account administrator. The role has administrator permissions in the new member account. The Organizations API provides no method for reading this information after account creation, so the provider cannot perform drift detection on its value and will always show a difference for a configured value after import unless `ignoreChanges` is used.
        :param pulumi.Input[builtins.str] status: The status of the account in the organization.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value map of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    def govcloud_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @govcloud_id.setter
    def govcloud_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Account(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Account':
        """
    ...
    @property
    @pulumi.getter(name="closeOnDeletion")
    def close_on_deletion(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, a deletion event will close the account. Otherwise, it will only remove from the organization. This is not supported for GovCloud accounts.
        """
        return pulumi.get(self, "close_on_deletion")
    ...
    @property
    @pulumi.getter(name="createGovcloud")
    def create_govcloud(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to also create a GovCloud account. The GovCloud account is tied to the main (commercial) account this resource creates. If `true`, the GovCloud account ID is available in the `govcloud_id` attribute. The only way to manage the GovCloud account with the provider is to subsequently import the account using this resource.
        """
        return pulumi.get(self, "create_govcloud")
    ...
    @property
    @pulumi.getter(name="govcloudId")
    def govcloud_id(self) -> pulumi.Output[builtins.str]:
        """
        ID for a GovCloud account created with the account.
        """
        return pulumi.get(self, "govcloud_id")
    ...
    @property
    @pulumi.getter(name="iamUserAccessToBilling")
    def iam_user_access_to_billing(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If set to `ALLOW`, the new account enables IAM users and roles to access account billing information if they have the required permissions. If set to `DENY`, then only the root user (and no roles) of the new account can access account billing information. If this is unset, the AWS API will default this to `ALLOW`. If the resource is created and this option is changed, it will try to recreate the account.
        """
        return pulumi.get(self, "iam_user_access_to_billing")
