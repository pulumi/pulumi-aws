...
class GetPolicyResult:
    ...
    def aws_managed(self) -> builtins.bool:
        """
...
def get_policy(policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str policy_id: The unique identifier (ID) of the policy that you want more details on. Policy id starts with a "p-" followed by 8-28 lowercase or uppercase letters, digits, and underscores.
    """
    __args__ = dict()
