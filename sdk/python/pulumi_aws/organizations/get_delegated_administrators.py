...
class GetDelegatedAdministratorsResult:
    ...
    def service_principal(self) -> Optional[builtins.str]:
...
def get_delegated_administrators(service_principal: Optional[builtins.str] = None,
    ...
    :param builtins.str service_principal: Specifies a service principal name. If specified, then the operation lists the delegated administrators only for the specified service. If you don't specify a service principal, the operation lists all delegated administrators for all services in your organization.
    """
    __args__ = dict()
...
def get_delegated_administrators_output(service_principal: Optional[pulumi.Input[Optional[builtins.str]]] = None,
