...
def get_policies(filter: Optional[builtins.str] = None,
    ...
    :param builtins.str filter: The type of policies to be returned in the response. Valid values are `AISERVICES_OPT_OUT_POLICY | BACKUP_POLICY | RESOURCE_CONTROL_POLICY | SERVICE_CONTROL_POLICY | TAG_POLICY`
    """
    __args__ = dict()
...
def get_policies_output(filter: Optional[pulumi.Input[builtins.str]] = None,
