...
def get_organizational_unit_descendant_organizational_units(parent_id: Optional[builtins.str] = None,
...
def get_organizational_unit_descendant_organizational_units_output(parent_id: Optional[pulumi.Input[builtins.str]] = None,
