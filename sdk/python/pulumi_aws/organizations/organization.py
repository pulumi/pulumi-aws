...
class OrganizationArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'awsServiceAccessPrincipals' in kwargs:
            aws_service_access_principals = kwargs['awsServiceAccessPrincipals']
        if 'enabledPolicyTypes' in kwargs:
