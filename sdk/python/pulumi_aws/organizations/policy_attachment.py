...
class PolicyAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy_id: The unique identifier (ID) of the policy that you want to attach to the target.
        :param pulumi.Input[builtins.str] target_id: The unique identifier (ID) of the root, organizational unit, or account number that you want to attach the policy to.
        :param pulumi.Input[builtins.bool] skip_destroy: If set to `true`, destroy will **not** detach the policy and instead just remove the resource from state. This can be useful in situations where the attachment must be preserved to meet the AWS minimum requirement of 1 attached policy.
        """
...
class PolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_id: Optional[pulumi.Input[builtins.str]] = None,
            skip_destroy: Optional[pulumi.Input[builtins.bool]] = None,
            target_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PolicyAttachment':
        """
