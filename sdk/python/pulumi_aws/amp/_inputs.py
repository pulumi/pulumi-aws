...
class ScraperDestinationAmpArgs:
    def __init__(__self__, *,
                 workspace_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] workspace_arn: The Amazon Resource Name (ARN) of the prometheus workspace.
        """
...
class ScraperRoleConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] source_role_arn: The Amazon Resource Name (ARN) of the source role configuration. Must be an IAM role ARN.
        :param pulumi.Input[builtins.str] target_role_arn: The Amazon Resource Name (ARN) of the target role configuration. Must be an IAM role ARN.
        """
...
class ScraperSourceEksArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: List of subnet IDs. Must be in at least two different availability zones.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: List of the security group IDs for the Amazon EKS cluster VPC configuration.
        """
...
class WorkspaceLoggingConfigurationArgs:
    def __init__(__self__, *,
                 log_group_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] log_group_arn: The ARN of the CloudWatch log group to which the vended log data will be published. This log group must exist.
        """
