...
class LandingZoneArgs:
    ...
    def manifest_json(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def manifest_json(self, value: pulumi.Input[builtins.str]):
...
class _LandingZoneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the landing zone.
    ...
    def latest_available_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def latest_available_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "latest_available_version", value)

    @property
    @pulumi.getter(name="manifestJson")
    def manifest_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The manifest JSON file is a text file that describes your AWS resources. For examples, review [Launch your landing zone](https://docs.aws.amazon.com/controltower/latest/userguide/lz-api-launch).
        """
        return pulumi.get(self, "manifest_json")
    ...
    @manifest_json.setter
    def manifest_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "manifest_json", value)
...
class LandingZone(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="latestAvailableVersion")
    def latest_available_version(self) -> pulumi.Output[builtins.str]:
        """
        The latest available version of the landing zone.
        """
        return pulumi.get(self, "latest_available_version")
    ...
    @property
    @pulumi.getter(name="manifestJson")
    def manifest_json(self) -> pulumi.Output[builtins.str]:
        """
        The manifest JSON file is a text file that describes your AWS resources. For examples, review [Launch your landing zone](https://docs.aws.amazon.com/controltower/latest/userguide/lz-api-launch).
        """
        return pulumi.get(self, "manifest_json")
