...
class LocationObjectStorageArgs:
    def __init__(__self__, *,
                 ...
                 server_protocol: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] server_protocol: The protocol that the object storage server uses to communicate. Valid values are `HTTP` or `HTTPS`.
    ...
    def server_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def server_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LocationObjectStorageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] uri: The URL of the Object Storage location that was described.
        """
        if access_key is not None:
            pulumi.set(__self__, "access_key", access_key)
...
class LocationObjectStorage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None) -> 'LocationObjectStorage':
        """
    ...
    @property
    @pulumi.getter(name="serverProtocol")
    def server_protocol(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The protocol that the object storage server uses to communicate. Valid values are `HTTP` or `HTTPS`.
        """
        return pulumi.get(self, "server_protocol")
