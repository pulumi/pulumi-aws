...
class EfsLocationArgs:
    def __init__(__self__, *,
                 ...
                 efs_file_system_arn: pulumi.Input[builtins.str],
    ...
    def efs_file_system_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def efs_file_system_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def file_system_access_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def file_system_access_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "file_system_access_role_arn", value)

    @property
    @pulumi.getter(name="inTransitEncryption")
    def in_transit_encryption(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def in_transit_encryption(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EfsLocationState:
    ...
    @property
    @pulumi.getter(name="efsFileSystemArn")
    def efs_file_system_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Amazon Resource Name (ARN) of EFS File System.
        """
        return pulumi.get(self, "efs_file_system_arn")
    ...
    @efs_file_system_arn.setter
    def efs_file_system_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "efs_file_system_arn", value)
...
class EfsLocation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None) -> 'EfsLocation':
        """
    ...
    @property
    @pulumi.getter(name="accessPointArn")
    def access_point_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the Amazon Resource Name (ARN) of the access point that DataSync uses to access the Amazon EFS file system.
        """
        return pulumi.get(self, "access_point_arn")
    ...
    @property
    @pulumi.getter(name="efsFileSystemArn")
    def efs_file_system_arn(self) -> pulumi.Output[builtins.str]:
        """
        Amazon Resource Name (ARN) of EFS File System.
        """
        return pulumi.get(self, "efs_file_system_arn")
    ...
    @property
    @pulumi.getter(name="fileSystemAccessRoleArn")
    def file_system_access_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies an Identity and Access Management (IAM) role that DataSync assumes when mounting the Amazon EFS file system.
        """
        return pulumi.get(self, "file_system_access_role_arn")
    ...
    @property
    @pulumi.getter(name="inTransitEncryption")
    def in_transit_encryption(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether you want DataSync to use TLS encryption when transferring data to or from your Amazon EFS file system. Valid values are `NONE` and `TLS1_2`.
        """
        return pulumi.get(self, "in_transit_encryption")
