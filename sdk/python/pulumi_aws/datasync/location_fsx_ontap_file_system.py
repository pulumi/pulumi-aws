...
class _LocationFsxOntapFileSystemState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subdirectory: Path to the file share in the SVM where you'll copy your data. You can specify a junction path (also known as a mount point), qtree path (for NFS file shares), or share name (for SMB file shares) (e.g. `/vol1`, `/vol1/tree1`, `share1`).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value pairs of resource tags to assign to the DataSync Location. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[builtins.str] uri: URI of the FSx ONTAP file system location
        """
        if arn is not None:
    ...
    @property
    @pulumi.getter(name="storageVirtualMachineArn")
    def storage_virtual_machine_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the SVM in your file system where you want to copy data to of from.
    ...
    @storage_virtual_machine_arn.setter
    def storage_virtual_machine_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "storage_virtual_machine_arn", value)
...
class LocationFsxOntapFileSystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None) -> 'LocationFsxOntapFileSystem':
        """
