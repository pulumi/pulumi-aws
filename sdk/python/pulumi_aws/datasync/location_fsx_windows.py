...
class LocationFsxWindowsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] fsx_filesystem_arn: ARN for the FSx for Windows file system.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_arns: ARNs of the security groups that are to use to configure the FSx for Windows file system.
        ...
        :param pulumi.Input[_builtins.str] subdirectory: Subdirectory to perform actions as source or destination.
...
class _LocationFsxWindowsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] uri: The URL of the FSx for Windows location that was described.
        :param pulumi.Input[_builtins.str] user: The user who has the permissions to access files and folders in the FSx for Windows file system.
        """
        if arn is not None:
...
class LocationFsxWindows(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            uri: pulumi.Input[Optional[_builtins.str]] = None,
            user: pulumi.Input[Optional[_builtins.str]] = None) -> 'LocationFsxWindows':
        """
