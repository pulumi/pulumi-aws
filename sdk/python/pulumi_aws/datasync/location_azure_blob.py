...
class LocationAzureBlobArgs:
    ...
    def container_url(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def container_url(self, value: pulumi.Input[builtins.str]):
    ...
    def blob_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @blob_type.setter
    def blob_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LocationAzureBlobState:
    ...
    @property
    @pulumi.getter(name="containerUrl")
    def container_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The URL of the Azure Blob Storage container involved in your transfer.
        """
        return pulumi.get(self, "container_url")
    ...
    @container_url.setter
    def container_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "container_url", value)
...
class LocationAzureBlob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None) -> 'LocationAzureBlob':
        """
    ...
    @property
    @pulumi.getter(name="blobType")
    def blob_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of blob that you want your objects or files to be when transferring them into Azure Blob Storage. Valid values: `BLOB`. Default: `BLOB`.
        """
        return pulumi.get(self, "blob_type")
    ...
    @property
    @pulumi.getter(name="containerUrl")
    def container_url(self) -> pulumi.Output[builtins.str]:
        """
        The URL of the Azure Blob Storage container involved in your transfer.
        """
        return pulumi.get(self, "container_url")
