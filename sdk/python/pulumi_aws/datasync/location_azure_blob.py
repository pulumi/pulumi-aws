...
class LocationAzureBlobArgs:
    ...
    def _configure(
        ...
        if container_url is None and 'containerUrl' in kwargs:
            container_url = kwargs['containerUrl']
        if container_url is None:
            raise TypeError("Missing 'container_url' argument")
        ...
        if sas_configuration is None and 'sasConfiguration' in kwargs:
...
class LocationAzureBlob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            sas_configuration = _utilities.configure(sas_configuration, LocationAzureBlobSasConfigurationArgs, True)
