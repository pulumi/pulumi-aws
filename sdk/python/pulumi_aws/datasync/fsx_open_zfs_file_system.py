...
class FsxOpenZfsFileSystemArgs:
    ...
    def fsx_filesystem_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def fsx_filesystem_arn(self, value: pulumi.Input[builtins.str]):
...
class _FsxOpenZfsFileSystemState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] uri: The URL of the FSx for openzfs location that was described.
        """
        if arn is not None:
...
class FsxOpenZfsFileSystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None) -> 'FsxOpenZfsFileSystem':
        """
