...
class FsxOpenZfsFileSystemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] fsx_filesystem_arn: The Amazon Resource Name (ARN) for the FSx for OpenZfs file system.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_arns: The Amazon Resource Names (ARNs) of the security groups that are to use to configure the FSx for openzfs file system.
...
class _FsxOpenZfsFileSystemState:
    def __init__(__self__, *,
                 ...
                 protocol: pulumi.Input[Optional['FsxOpenZfsFileSystemProtocolArgs']] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] uri: The URL of the FSx for openzfs location that was described.
        """
        if arn is not None:
    ...
    @_builtins.property
    @pulumi.getter
    def protocol(self) -> pulumi.Input[Optional['FsxOpenZfsFileSystemProtocolArgs']]:
        """
        The type of protocol that DataSync uses to access your file system. See below.
        """
        return pulumi.get(self, "protocol")
    ...
    @protocol.setter
    def protocol(self, value: pulumi.Input[Optional['FsxOpenZfsFileSystemProtocolArgs']]):
        pulumi.set(self, "protocol", value)
...
class FsxOpenZfsFileSystem(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Using `pulumi import`, import `datasync.FsxOpenZfsFileSystem` using the `DataSync-ARN#FSx-openzfs-ARN`. For example:
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            uri: pulumi.Input[Optional[_builtins.str]] = None) -> 'FsxOpenZfsFileSystem':
        """
