...
class GroupArgs:
    def __init__(__self__, *,
                 ...
                 ignore_failed_scaling_activities: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 launch_configuration: Optional[pulumi.Input[Union[builtins.str, '_ec2.LaunchConfiguration']]] = None,
                 ...
                 metrics_granularity: Optional[pulumi.Input[Union[builtins.str, 'MetricsGranularity']]] = None,
                 min_elb_capacity: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 placement_group: Optional[pulumi.Input[Union[builtins.str, '_ec2.PlacementGroup']]] = None,
                 ...
                 vpc_zone_identifiers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 wait_for_capacity_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 wait_for_elb_capacity: Optional[pulumi.Input[builtins.int]] = None,
                 warm_pool: Optional[pulumi.Input['GroupWarmPoolArgs']] = None):
        """
        The set of arguments for constructing a Group resource.
        :param pulumi.Input[builtins.int] max_size: Maximum size of the Auto Scaling Group.
        :param pulumi.Input[builtins.int] min_size: Minimum size of the Auto Scaling Group.
        ...
        :param pulumi.Input[builtins.int] desired_capacity: Number of Amazon EC2 instances that
        ...
        :param pulumi.Input[builtins.bool] force_delete_warm_pool: Allows deleting the Auto Scaling Group without waiting for all instances in the warm pool to terminate.
        :param pulumi.Input[builtins.int] health_check_grace_period: Time (in seconds) after instance comes into service before checking health.
        :param pulumi.Input[builtins.str] health_check_type: "EC2" or "ELB". Controls how health checking is done.
        :param pulumi.Input[builtins.bool] ignore_failed_scaling_activities: Whether to ignore failed [Auto Scaling scaling activities](https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-verify-scaling-activity.html) while waiting for capacity. The default is `false` -- failed scaling activities cause errors to be returned.
        ...
        :param pulumi.Input[Union[builtins.str, '_ec2.LaunchConfiguration']] launch_configuration: Name of the launch configuration to use.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] load_balancers: List of elastic load balancer names to add to the autoscaling
        ...
        :param pulumi.Input[builtins.int] max_instance_lifetime: Maximum amount of time, in seconds, that an instance can be in service, values must be either equal to 0 or between 86400 and 31536000 seconds.
        :param pulumi.Input[Union[builtins.str, 'MetricsGranularity']] metrics_granularity: Granularity to associate with the metrics to collect. The only valid value is `1Minute`. Default is `1Minute`.
        :param pulumi.Input[builtins.int] min_elb_capacity: Setting this causes Pulumi to wait for
        ...
        :param pulumi.Input[Union[builtins.str, '_ec2.PlacementGroup']] placement_group: Name of the placement group into which you'll launch your instances, if any.
        :param pulumi.Input[builtins.bool] protect_from_scale_in: Whether newly launched instances
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_group_arns: Set of `alb.TargetGroup` ARNs, for use with Application or Network Load Balancing. To remove all target group attachments an empty list should be specified.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_zone_identifiers: List of subnet IDs to launch resources in. Subnets automatically determine which availability zones the group will reside. Conflicts with `availability_zones`.
        :param pulumi.Input[builtins.str] wait_for_capacity_timeout: Maximum
        ...
        :param pulumi.Input[builtins.int] wait_for_elb_capacity: Setting this will cause Pulumi to wait
    ...
    def force_delete_warm_pool(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def force_delete_warm_pool(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ignore_failed_scaling_activities(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_failed_scaling_activities(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def launch_configuration(self) -> Optional[pulumi.Input[Union[builtins.str, '_ec2.LaunchConfiguration']]]:
        """
    ...
    def launch_configuration(self, value: Optional[pulumi.Input[Union[builtins.str, '_ec2.LaunchConfiguration']]]):
    ...
    def metrics_granularity(self) -> Optional[pulumi.Input[Union[builtins.str, 'MetricsGranularity']]]:
        """
    ...
    def metrics_granularity(self, value: Optional[pulumi.Input[Union[builtins.str, 'MetricsGranularity']]]):
        pulumi.set(self, "metrics_granularity", value)

    @property
    @pulumi.getter(name="minElbCapacity")
    def min_elb_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_elb_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def placement_group(self) -> Optional[pulumi.Input[Union[builtins.str, '_ec2.PlacementGroup']]]:
        """
    ...
    def placement_group(self, value: Optional[pulumi.Input[Union[builtins.str, '_ec2.PlacementGroup']]]):
    ...
    def vpc_zone_identifiers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def vpc_zone_identifiers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "vpc_zone_identifiers", value)

    @property
    @pulumi.getter(name="waitForCapacityTimeout")
    def wait_for_capacity_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Maximum
        [duration](https://golang.org/pkg/time/#ParseDuration) that the provider should
        wait for ASG instances to be healthy before timing out. (See also Waiting
    ...
    def wait_for_capacity_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "wait_for_capacity_timeout", value)

    @property
    @pulumi.getter(name="waitForElbCapacity")
    def wait_for_elb_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def wait_for_elb_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _GroupState:
    def __init__(__self__, *,
                 ...
                 wait_for_elb_capacity: Optional[pulumi.Input[builtins.int]] = None,
                 warm_pool: Optional[pulumi.Input['GroupWarmPoolArgs']] = None,
                 warm_pool_size: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering Group resources.
        :param pulumi.Input[builtins.str] arn: ARN for this Auto Scaling Group
        :param pulumi.Input['GroupAvailabilityZoneDistributionArgs'] availability_zone_distribution: The instance capacity distribution across Availability Zones. See Availability Zone Distribution below for more details.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: A list of Availability Zones where instances in the Auto Scaling group can be created. Used for launching into the default VPC subnet in each Availability Zone when not using the `vpc_zone_identifier` attribute, or for attaching a network interface when an existing network interface ID is specified in a launch template. Conflicts with `vpc_zone_identifier`.
        :param pulumi.Input[builtins.bool] capacity_rebalance: Whether capacity rebalance is enabled. Otherwise, capacity rebalance is disabled.
        :param pulumi.Input['GroupCapacityReservationSpecificationArgs'] capacity_reservation_specification: The capacity reservation specification for the Auto Scaling group allows you to prioritize launching into On-Demand Capacity Reservations. See Capacity Reservation Specification below for more details.
        ...
        :param pulumi.Input[builtins.str] name_prefix: Creates a unique name beginning with the specified
               prefix. Conflicts with `name`.
        :param pulumi.Input[Union[builtins.str, '_ec2.PlacementGroup']] placement_group: Name of the placement group into which you'll launch your instances, if any.
        :param pulumi.Input[builtins.int] predicted_capacity: Predicted capacity of the group.
        :param pulumi.Input[builtins.bool] protect_from_scale_in: Whether newly launched instances
               are automatically protected from termination by Amazon EC2 Auto Scaling when
               scaling in. For more information about preventing instances from terminating
               on scale in, see [Using instance scale-in protection](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-instance-protection.html)
        ...
        :param pulumi.Input['GroupWarmPoolArgs'] warm_pool: If this block is configured, add a [Warm Pool](https://docs.aws.amazon.com/autoscaling/ec2/userguide/ec2-auto-scaling-warm-pools.html)
               to the specified Auto Scaling group. Defined below
        :param pulumi.Input[builtins.int] warm_pool_size: Current size of the warm pool.
        """
        if arn is not None:
    ...
    def predicted_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def predicted_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def warm_pool_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def warm_pool_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Group(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            wait_for_elb_capacity: Optional[pulumi.Input[builtins.int]] = None,
            warm_pool: Optional[pulumi.Input[Union['GroupWarmPoolArgs', 'GroupWarmPoolArgsDict']]] = None,
            warm_pool_size: Optional[pulumi.Input[builtins.int]] = None) -> 'Group':
        """
    ...
    @property
    @pulumi.getter(name="forceDeleteWarmPool")
    def force_delete_warm_pool(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Allows deleting the Auto Scaling Group without waiting for all instances in the warm pool to terminate.
        """
        return pulumi.get(self, "force_delete_warm_pool")
    ...
    @property
    @pulumi.getter(name="ignoreFailedScalingActivities")
    def ignore_failed_scaling_activities(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to ignore failed [Auto Scaling scaling activities](https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-verify-scaling-activity.html) while waiting for capacity. The default is `false` -- failed scaling activities cause errors to be returned.
        """
        return pulumi.get(self, "ignore_failed_scaling_activities")
    ...
    @property
    @pulumi.getter(name="launchConfiguration")
    def launch_configuration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the launch configuration to use.
        """
        return pulumi.get(self, "launch_configuration")
    ...
    @property
    @pulumi.getter(name="metricsGranularity")
    def metrics_granularity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Granularity to associate with the metrics to collect. The only valid value is `1Minute`. Default is `1Minute`.
        """
        return pulumi.get(self, "metrics_granularity")
    ...
    @property
    @pulumi.getter(name="minElbCapacity")
    def min_elb_capacity(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Setting this causes Pulumi to wait for
        this number of instances from this Auto Scaling Group to show up healthy in the
        ELB only on creation. Updates will not wait on ELB instance number changes.
    ...
    @property
    @pulumi.getter(name="predictedCapacity")
    def predicted_capacity(self) -> pulumi.Output[builtins.int]:
        """
        Predicted capacity of the group.
        """
        return pulumi.get(self, "predicted_capacity")
    ...
    @property
    @pulumi.getter(name="protectFromScaleIn")
    def protect_from_scale_in(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether newly launched instances
        are automatically protected from termination by Amazon EC2 Auto Scaling when
        scaling in. For more information about preventing instances from terminating
    ...
    @property
    @pulumi.getter(name="serviceLinkedRoleArn")
    def service_linked_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the service-linked role that the ASG will use to call other AWS services
        """
        return pulumi.get(self, "service_linked_role_arn")
    ...
    @property
    @pulumi.getter(name="suspendedProcesses")
    def suspended_processes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of processes to suspend for the Auto Scaling Group. The allowed values are `Launch`, `Terminate`, `HealthCheck`, `ReplaceUnhealthy`, `AZRebalance`, `AlarmNotification`, `ScheduledActions`, `AddToLoadBalancer`, `InstanceRefresh`.
        Note that if you suspend either the `Launch` or `Terminate` process types, it can prevent your Auto Scaling Group from functioning properly.
        """
    ...
    @property
    @pulumi.getter(name="vpcZoneIdentifiers")
    def vpc_zone_identifiers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of subnet IDs to launch resources in. Subnets automatically determine which availability zones the group will reside. Conflicts with `availability_zones`.
        """
        return pulumi.get(self, "vpc_zone_identifiers")
    ...
    @property
    @pulumi.getter(name="waitForCapacityTimeout")
    def wait_for_capacity_timeout(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Maximum
        [duration](https://golang.org/pkg/time/#ParseDuration) that the provider should
        wait for ASG instances to be healthy before timing out. (See also Waiting
    ...
    @property
    @pulumi.getter(name="waitForElbCapacity")
    def wait_for_elb_capacity(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Setting this will cause Pulumi to wait
        for exactly this number of healthy instances from this Auto Scaling Group in
        all attached load balancers on both create and update operations. (Takes
    ...
    @property
    @pulumi.getter(name="warmPoolSize")
    def warm_pool_size(self) -> pulumi.Output[builtins.int]:
        """
        Current size of the warm pool.
        """
        return pulumi.get(self, "warm_pool_size")
