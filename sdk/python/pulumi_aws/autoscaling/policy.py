...
class PolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] autoscaling_group_name: Name of the autoscaling group.
        ...
        :param pulumi.Input[builtins.bool] enabled: Whether the scaling policy is enabled or disabled. Default: `true`.
               
               The following argument is only available to "SimpleScaling" and "StepScaling" type policies:
        :param pulumi.Input[builtins.int] estimated_instance_warmup: Estimated time, in seconds, until a newly launched instance will contribute CloudWatch metrics. Without a value, AWS will default to the group's specified cooldown period.
        ...
        :param pulumi.Input[builtins.int] min_adjustment_magnitude: Minimum value to scale by when `adjustment_type` is set to `PercentChangeInCapacity`.
...
class Policy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="metricAggregationType")
    def metric_aggregation_type(self) -> pulumi.Output[builtins.str]:
        """
        Aggregation type for the policy's metrics. Valid values are "Minimum", "Maximum", and "Average". Without a value, AWS will treat the aggregation type as "Average".
        """
        return pulumi.get(self, "metric_aggregation_type")
