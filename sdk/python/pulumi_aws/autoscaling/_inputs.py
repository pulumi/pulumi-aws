...
if not MYPY:
    class GroupAvailabilityZoneDistributionArgsDict(TypedDict):
        capacity_distribution_strategy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GroupAvailabilityZoneDistributionArgs:
    def __init__(__self__, *,
                 capacity_distribution_strategy: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] capacity_distribution_strategy: The strategy to use for distributing capacity across the Availability Zones. Valid values are `balanced-only` and `balanced-best-effort`. Default is `balanced-best-effort`.
        """
    ...
    def capacity_distribution_strategy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The strategy to use for distributing capacity across the Availability Zones. Valid values are `balanced-only` and `balanced-best-effort`. Default is `balanced-best-effort`.
        """
...
class GroupInitialLifecycleHookArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Name of the Auto Scaling Group. By default generated by Pulumi. Conflicts with `name_prefix`.
        """
...
if not MYPY:
    class GroupInstanceMaintenancePolicyArgsDict(TypedDict):
        max_healthy_percentage: pulumi.Input[builtins.int]
        """
        ...
        """
        min_healthy_percentage: pulumi.Input[builtins.int]
        """
...
class GroupInstanceMaintenancePolicyArgs:
    def __init__(__self__, *,
                 ...
                 min_healthy_percentage: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] max_healthy_percentage: Specifies the upper limit on the number of instances that are in the InService or Pending state with a healthy status during an instance replacement activity.
        :param pulumi.Input[builtins.int] min_healthy_percentage: Specifies the lower limit on the number of instances that must be in the InService state with a healthy status during an instance replacement activity.
        """
    ...
    def max_healthy_percentage(self) -> pulumi.Input[builtins.int]:
        """
        Specifies the upper limit on the number of instances that are in the InService or Pending state with a healthy status during an instance replacement activity.
        """
    ...
    def max_healthy_percentage(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "max_healthy_percentage", value)

    @property
    @pulumi.getter(name="minHealthyPercentage")
    def min_healthy_percentage(self) -> pulumi.Input[builtins.int]:
        """
        Specifies the lower limit on the number of instances that must be in the InService state with a healthy status during an instance replacement activity.
        """
    ...
    def min_healthy_percentage(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class GroupInstanceRefreshArgsDict(TypedDict):
        ...
        """
        triggers: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class GroupInstanceRefreshArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] strategy: Strategy to use for instance refresh. The only allowed value is `Rolling`. See [StartInstanceRefresh Action](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_StartInstanceRefresh.html#API_StartInstanceRefresh_RequestParameters) for more information.
        :param pulumi.Input['GroupInstanceRefreshPreferencesArgs'] preferences: Override default parameters for Instance Refresh.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] triggers: Set of additional property names that will trigger an Instance Refresh. A refresh will always be triggered by a change in any of `launch_configuration`, `launch_template`, or `mixed_instances_policy`.
...
if not MYPY:
    class GroupInstanceRefreshPreferencesArgsDict(TypedDict):
        ...
        """
        auto_rollback: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        checkpoint_delay: NotRequired[pulumi.Input[builtins.str]]
        """
        Number of seconds to wait after a checkpoint. Defaults to `3600`.
        """
        checkpoint_percentages: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
        List of percentages for each checkpoint. Values must be unique and in ascending order. To replace all instances, the final number must be `100`.
        """
        instance_warmup: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        scale_in_protected_instances: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        skip_matching: NotRequired[pulumi.Input[builtins.bool]]
        """
        Replace instances that already have your desired configuration. Defaults to `false`.
        """
        standby_instances: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GroupInstanceRefreshPreferencesArgs:
    def __init__(__self__, *,
                 ...
                 auto_rollback: Optional[pulumi.Input[builtins.bool]] = None,
                 checkpoint_delay: Optional[pulumi.Input[builtins.str]] = None,
                 checkpoint_percentages: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
                 instance_warmup: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 scale_in_protected_instances: Optional[pulumi.Input[builtins.str]] = None,
                 skip_matching: Optional[pulumi.Input[builtins.bool]] = None,
                 standby_instances: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] auto_rollback: Automatically rollback if instance refresh fails. Defaults to `false`. This option may only be set to `true` when specifying a `launch_template` or `mixed_instances_policy`.
        :param pulumi.Input[builtins.str] checkpoint_delay: Number of seconds to wait after a checkpoint. Defaults to `3600`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] checkpoint_percentages: List of percentages for each checkpoint. Values must be unique and in ascending order. To replace all instances, the final number must be `100`.
        :param pulumi.Input[builtins.str] instance_warmup: Number of seconds until a newly launched instance is configured and ready to use. Default behavior is to use the Auto Scaling Group's health check grace period.
        :param pulumi.Input[builtins.int] max_healthy_percentage: Amount of capacity in the Auto Scaling group that can be in service and healthy, or pending, to support your workload when an instance refresh is in place, as a percentage of the desired capacity of the Auto Scaling group. Values must be between `100` and `200`, defaults to `100`.
        :param pulumi.Input[builtins.int] min_healthy_percentage: Amount of capacity in the Auto Scaling group that must remain healthy during an instance refresh to allow the operation to continue, as a percentage of the desired capacity of the Auto Scaling group. Defaults to `90`.
        :param pulumi.Input[builtins.str] scale_in_protected_instances: Behavior when encountering instances protected from scale in are found. Available behaviors are `Refresh`, `Ignore`, and `Wait`. Default is `Ignore`.
        :param pulumi.Input[builtins.bool] skip_matching: Replace instances that already have your desired configuration. Defaults to `false`.
        :param pulumi.Input[builtins.str] standby_instances: Behavior when encountering instances in the `Standby` state in are found. Available behaviors are `Terminate`, `Ignore`, and `Wait`. Default is `Ignore`.
        """
    ...
    def auto_rollback(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Automatically rollback if instance refresh fails. Defaults to `false`. This option may only be set to `true` when specifying a `launch_template` or `mixed_instances_policy`.
        """
    ...
    def auto_rollback(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_rollback", value)

    @property
    @pulumi.getter(name="checkpointDelay")
    def checkpoint_delay(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Number of seconds to wait after a checkpoint. Defaults to `3600`.
        """
    ...
    def checkpoint_delay(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "checkpoint_delay", value)

    @property
    @pulumi.getter(name="checkpointPercentages")
    def checkpoint_percentages(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        List of percentages for each checkpoint. Values must be unique and in ascending order. To replace all instances, the final number must be `100`.
        """
    ...
    def checkpoint_percentages(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "checkpoint_percentages", value)

    @property
    @pulumi.getter(name="instanceWarmup")
    def instance_warmup(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Number of seconds until a newly launched instance is configured and ready to use. Default behavior is to use the Auto Scaling Group's health check grace period.
        """
    ...
    def instance_warmup(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scale_in_protected_instances(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Behavior when encountering instances protected from scale in are found. Available behaviors are `Refresh`, `Ignore`, and `Wait`. Default is `Ignore`.
        """
    ...
    def scale_in_protected_instances(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scale_in_protected_instances", value)

    @property
    @pulumi.getter(name="skipMatching")
    def skip_matching(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Replace instances that already have your desired configuration. Defaults to `false`.
        """
    ...
    def skip_matching(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "skip_matching", value)

    @property
    @pulumi.getter(name="standbyInstances")
    def standby_instances(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Behavior when encountering instances in the `Standby` state in are found. Available behaviors are `Terminate`, `Ignore`, and `Wait`. Default is `Ignore`.
        """
    ...
    def standby_instances(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GroupInstanceRefreshPreferencesAlarmSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] alarms: List of Cloudwatch alarms. If any of these alarms goes into ALARM state, Instance Refresh is failed.
        """
...
class GroupLaunchTemplateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: ID of the launch template. Conflicts with `name`.
        :param pulumi.Input[builtins.str] name: Name of the launch template. Conflicts with `id`.
        :param pulumi.Input[builtins.str] version: Template version. Can be version number, `$Latest`, or `$Default`. (Default: `$Default`).
        """
        if id is not None:
...
class GroupMixedInstancesPolicyInstancesDistributionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] on_demand_allocation_strategy: Strategy to use when launching on-demand instances. Valid values: `prioritized`, `lowest-price`. Default: `prioritized`.
        :param pulumi.Input[builtins.int] on_demand_base_capacity: Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: `0`.
        :param pulumi.Input[builtins.int] on_demand_percentage_above_base_capacity: Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: `100`.
        :param pulumi.Input[builtins.str] spot_allocation_strategy: How to allocate capacity across the Spot pools. Valid values: `lowest-price`, `capacity-optimized`, `capacity-optimized-prioritized`, and `price-capacity-optimized`. Default: `lowest-price`.
        :param pulumi.Input[builtins.int] spot_instance_pools: Number of Spot pools per availability zone to allocate capacity. EC2 Auto Scaling selects the cheapest Spot pools and evenly allocates Spot capacity across the number of Spot pools that you specify. Only available with `spot_allocation_strategy` set to `lowest-price`. Otherwise it must be set to `0`, if it has been defined before. Default: `2`.
        :param pulumi.Input[builtins.str] spot_max_price: Maximum price per unit hour that the user is willing to pay for the Spot instances. Default: an empty string which means the on-demand price.
        """
...
class GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecificationArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] launch_template_id: ID of the launch template. Conflicts with `launch_template_name`.
        :param pulumi.Input[builtins.str] launch_template_name: Name of the launch template. Conflicts with `launch_template_id`.
        """
...
class GroupMixedInstancesPolicyLaunchTemplateOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_type: Override the instance type in the Launch Template.
        ...
        :param pulumi.Input[builtins.str] weighted_capacity: Number of capacity units, which gives the instance type a proportional weight to other instance types.
        """
...
class GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] accelerator_manufacturers: List of accelerator manufacturer names. Default is any manufacturer.
               ...
               * xilinx
               ```
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] accelerator_names: List of accelerator names. Default is any acclerator.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] accelerator_types: List of accelerator types. Default is any accelerator type.
               ...
               * inference
               ```
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_instance_types: List of instance types to apply your specified attributes against. All other instance types are ignored, even if they match your specified attributes. You can use strings with one or more wild cards, represented by an asterisk (\\*), to allow an instance type, size, or generation. The following are examples: `m5.8xlarge`, `c5*.*`, `m5a.*`, `r*`, `*3*`. For example, if you specify `c5*`, you are allowing the entire C5 instance family, which includes all C5a and C5n instance types. If you specify `m5a.*`, you are allowing all the M5a instance types, but not the M5n instance types. Maximum of 400 entries in the list; each entry is limited to 30 characters. Default is all instance types.
               
               > **NOTE:** If you specify `allowed_instance_types`, you can't specify `excluded_instance_types`.
        :param pulumi.Input[builtins.str] bare_metal: Indicate whether bare metal instace types should be `included`, `excluded`, or `required`. Default is `excluded`.
        ...
        :param pulumi.Input[builtins.str] burstable_performance: Indicate whether burstable performance instance types should be `included`, `excluded`, or `required`. Default is `excluded`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cpu_manufacturers: List of CPU manufacturer names. Default is any manufacturer.
               ...
               * intel
               ```
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] excluded_instance_types: List of instance types to exclude. You can use strings with one or more wild cards, represented by an asterisk (\\*), to exclude an instance type, size, or generation. The following are examples: `m5.8xlarge`, `c5*.*`, `m5a.*`, `r*`, `*3*`. For example, if you specify `c5*`, you are excluding the entire C5 instance family, which includes all C5a and C5n instance types. If you specify `m5a.*`, you are excluding all the M5a instance types, but not the M5n instance types. Maximum of 400 entries in the list; each entry is limited to 30 characters. Default is no excluded instance types.
               
               > **NOTE:** If you specify `excluded_instance_types`, you can't specify `allowed_instance_types`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instance_generations: List of instance generation names. Default is any generation.
               ...
               * previous - For existing applications optimized for older instance types.
               ```
        :param pulumi.Input[builtins.str] local_storage: Indicate whether instance types with local storage volumes are `included`, `excluded`, or `required`. Default is `included`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] local_storage_types: List of local storage type names. Default any storage type.
               ...
               * ssd - solid state drive
               ```
        :param pulumi.Input[builtins.int] max_spot_price_as_percentage_of_optimal_on_demand_price: The price protection threshold for Spot Instances. This is the maximum you’ll pay for a Spot Instance, expressed as a percentage higher than the cheapest M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as 999999. Conflicts with `spot_max_price_percentage_over_lowest_price`
        ...
        :param pulumi.Input[builtins.int] on_demand_max_price_percentage_over_lowest_price: Price protection threshold for On-Demand Instances. This is the maximum you’ll pay for an On-Demand Instance, expressed as a percentage higher than the cheapest M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as 999999. Default is 20.
               
               If you set DesiredCapacityType to vcpu or memory-mib, the price protection threshold is applied based on the per vCPU or per memory price instead of the per instance price.
        :param pulumi.Input[builtins.bool] require_hibernate_support: Indicate whether instance types must support On-Demand Instance Hibernation, either `true` or `false`. Default is `false`.
        :param pulumi.Input[builtins.int] spot_max_price_percentage_over_lowest_price: Price protection threshold for Spot Instances. This is the maximum you’ll pay for a Spot Instance, expressed as a percentage higher than the cheapest M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as 999999. Default is 100. Conflicts with `max_spot_price_as_percentage_of_optimal_on_demand_price`
...
class GroupTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] propagate_at_launch: Enables propagation of the tag to
               Amazon EC2 instances launched via this ASG
...
class GroupTrafficSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] identifier: Identifies the traffic source. For Application Load Balancers, Gateway Load Balancers, Network Load Balancers, and VPC Lattice, this will be the Amazon Resource Name (ARN) for a target group in this account and Region. For Classic Load Balancers, this will be the name of the Classic Load Balancer in this account and Region.
...
if not MYPY:
    class GroupWarmPoolArgsDict(TypedDict):
        ...
        """
        max_group_prepared_capacity: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        pool_state: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GroupWarmPoolArgs:
    def __init__(__self__, *,
                 ...
                 max_group_prepared_capacity: Optional[pulumi.Input[builtins.int]] = None,
                 min_size: Optional[pulumi.Input[builtins.int]] = None,
                 pool_state: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] max_group_prepared_capacity: Total maximum number of instances that are allowed to be in the warm pool or in any state except Terminated for the Auto Scaling group.
        :param pulumi.Input[builtins.int] min_size: Minimum number of instances to maintain in the warm pool. This helps you to ensure that there is always a certain number of warmed instances available to handle traffic spikes. Defaults to 0 if not specified.
        :param pulumi.Input[builtins.str] pool_state: Sets the instance state to transition to after the lifecycle hooks finish. Valid values are: Stopped (default), Running or Hibernated.
        """
    ...
    def max_group_prepared_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Total maximum number of instances that are allowed to be in the warm pool or in any state except Terminated for the Auto Scaling group.
        """
    ...
    def max_group_prepared_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def pool_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Sets the instance state to transition to after the lifecycle hooks finish. Valid values are: Stopped (default), Running or Hibernated.
        """
    ...
    @pool_state.setter
    def pool_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GroupWarmPoolInstanceReusePolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] reuse_on_scale_in: Whether instances in the Auto Scaling group can be returned to the warm pool on scale in.
        """
...
if not MYPY:
    class PolicyPredictiveScalingConfigurationArgsDict(TypedDict):
        ...
        """
        max_capacity_buffer: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        scheduling_buffer_time: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PolicyPredictiveScalingConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 max_capacity_buffer: Optional[pulumi.Input[builtins.str]] = None,
                 mode: Optional[pulumi.Input[builtins.str]] = None,
                 scheduling_buffer_time: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] max_capacity_breach_behavior: Defines the behavior that should be applied if the forecast capacity approaches or exceeds the maximum capacity of the Auto Scaling group. Valid values are `HonorMaxCapacity` or `IncreaseMaxCapacity`. Default is `HonorMaxCapacity`.
        :param pulumi.Input[builtins.str] max_capacity_buffer: Size of the capacity buffer to use when the forecast capacity is close to or exceeds the maximum capacity. Valid range is `0` to `100`. If set to `0`, Amazon EC2 Auto Scaling may scale capacity higher than the maximum capacity to equal but not exceed forecast capacity.
        :param pulumi.Input[builtins.str] mode: Predictive scaling mode. Valid values are `ForecastAndScale` and `ForecastOnly`. Default is `ForecastOnly`.
        :param pulumi.Input[builtins.str] scheduling_buffer_time: Amount of time, in seconds, by which the instance launch time can be advanced. Minimum is `0`.
        """
    ...
    def max_capacity_buffer(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Size of the capacity buffer to use when the forecast capacity is close to or exceeds the maximum capacity. Valid range is `0` to `100`. If set to `0`, Amazon EC2 Auto Scaling may scale capacity higher than the maximum capacity to equal but not exceed forecast capacity.
        """
    ...
    def max_capacity_buffer(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scheduling_buffer_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Amount of time, in seconds, by which the instance launch time can be advanced. Minimum is `0`.
        """
    ...
    def scheduling_buffer_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: Short name for the metric used in predictive scaling policy.
...
class PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedLoadMetricSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] predefined_metric_type: Metric type. Valid values are `ASGTotalCPUUtilization`, `ASGTotalNetworkIn`, `ASGTotalNetworkOut`, or `ALBTargetGroupRequestCount`.
        :param pulumi.Input[builtins.str] resource_label: Label that uniquely identifies a specific Application Load Balancer target group from which to determine the request count served by your Auto Scaling group. You create the resource label by appending the final portion of the load balancer ARN and the final portion of the target group ARN into a single value, separated by a forward slash (/). Refer to [PredefinedMetricSpecification](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_PredefinedMetricSpecification.html) for more information.
        """
...
class PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedMetricPairSpecificationArgs:
    def __init__(__self__, *,
                 ...
                 resource_label: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] predefined_metric_type: Which metrics to use. There are two different types of metrics for each metric type: one is a load metric and one is a scaling metric. For example, if the metric type is `ASGCPUUtilization`, the Auto Scaling group's total CPU metric is used as the load metric, and the average CPU metric is used for the scaling metric. Valid values are `ASGCPUUtilization`, `ASGNetworkIn`, `ASGNetworkOut`, or `ALBRequestCount`.
        :param pulumi.Input[builtins.str] resource_label: Label that uniquely identifies a specific Application Load Balancer target group from which to determine the request count served by your Auto Scaling group. You create the resource label by appending the final portion of the load balancer ARN and the final portion of the target group ARN into a single value, separated by a forward slash (/). Refer to [PredefinedMetricSpecification](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_PredefinedMetricSpecification.html) for more information.
        """
        pulumi.set(__self__, "predefined_metric_type", predefined_metric_type)
        if resource_label is not None:
...
class PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedScalingMetricSpecificationArgs:
    def __init__(__self__, *,
                 ...
                 resource_label: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] predefined_metric_type: Describes a scaling metric for a predictive scaling policy. Valid values are `ASGAverageCPUUtilization`, `ASGAverageNetworkIn`, `ASGAverageNetworkOut`, or `ALBRequestCountPerTarget`.
        :param pulumi.Input[builtins.str] resource_label: Label that uniquely identifies a specific Application Load Balancer target group from which to determine the request count served by your Auto Scaling group. You create the resource label by appending the final portion of the load balancer ARN and the final portion of the target group ARN into a single value, separated by a forward slash (/). Refer to [PredefinedMetricSpecification](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_PredefinedMetricSpecification.html) for more information.
        """
        pulumi.set(__self__, "predefined_metric_type", predefined_metric_type)
        if resource_label is not None:
...
class PolicyStepAdjustmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] scaling_adjustment: Number of members by which to
               scale, when the adjustment bounds are breached. A positive value scales
               up. A negative value scales down.
        :param pulumi.Input[builtins.str] metric_interval_lower_bound: Lower bound for the
               difference between the alarm threshold and the CloudWatch metric.
               Without a value, AWS will treat this bound as negative infinity.
        :param pulumi.Input[builtins.str] metric_interval_upper_bound: Upper bound for the
               difference between the alarm threshold and the CloudWatch metric.
               Without a value, AWS will treat this bound as positive infinity. The upper bound
               must be greater than the lower bound.
...
class PolicyTargetTrackingConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] disable_scale_in: Whether scale in by the target tracking policy is disabled.
...
class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] namespace: Namespace of the metric.
        :param pulumi.Input[builtins.int] period: The period of the metric in seconds.
        :param pulumi.Input[builtins.str] statistic: Statistic of the metric.
        :param pulumi.Input[builtins.str] unit: Unit of the metric.
        """
...
class PolicyTargetTrackingConfigurationPredefinedMetricSpecificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_label: Identifies the resource associated with the metric type.
        """
        pulumi.set(__self__, "predefined_metric_type", predefined_metric_type)
        if resource_label is not None:
            pulumi.set(__self__, "resource_label", resource_label)
...
class TagTagArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] propagate_at_launch: Whether to propagate the tags to instances launched by the ASG.
...
class GetAmiIdsFilterArgs:
    def __init__(__self__, *,
                 ...
                 values: Sequence[builtins.str]):
        """
        :param builtins.str name: Name of the DescribeAutoScalingGroup filter. The recommended values are: `tag-key`, `tag-value`, and `tag:<tag name>`
        :param Sequence[builtins.str] values: Value of the filter.
        """
        pulumi.set(__self__, "name", name)
