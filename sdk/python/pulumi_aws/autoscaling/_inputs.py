...
class GroupMixedInstancesPolicyArgs:
    ...
    def _configure(
        ...
        if 'instancesDistribution' in kwargs:
...
class GroupMixedInstancesPolicyInstancesDistributionArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'onDemandAllocationStrategy' in kwargs:
...
class GroupTagArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'propagateAtLaunch' in kwargs:
...
class PolicyPredictiveScalingConfigurationMetricSpecificationArgs:
    ...
    def _configure(
        ...
        if 'customizedCapacityMetricSpecification' in kwargs:
        ...
        if 'predefinedMetricPairSpecification' in kwargs:
