...
class GroupInstanceRefreshPreferencesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[bool] auto_rollback: Automatically rollback if instance refresh fails. Defaults to `false`.
...
class GroupMixedInstancesPolicyLaunchTemplateOverrideArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['GroupMixedInstancesPolicyLaunchTemplateOverrideLaunchTemplateSpecificationArgs'] launch_template_specification: Nested argument defines the Launch Template. Defined below.
