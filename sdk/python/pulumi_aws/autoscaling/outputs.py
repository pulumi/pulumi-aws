...
class GroupAvailabilityZoneDistribution(dict):
    ...
    def __init__(__self__, *,
                 capacity_distribution_strategy: Optional[builtins.str] = None):
        """
        :param builtins.str capacity_distribution_strategy: The strategy to use for distributing capacity across the Availability Zones. Valid values are `balanced-only` and `balanced-best-effort`. Default is `balanced-best-effort`.
        """
    ...
    def capacity_distribution_strategy(self) -> Optional[builtins.str]:
        """
...
class GroupCapacityReservationSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str capacity_reservation_preference: Capacity Reservation preference helps you use Capacity Reservations efficiently by prioritizing reserved capacity in a Capacity Reservation before using On-Demand capacity. Valid values are `default`, `capacity-reservations-only`, `capacity-reservations-first` and `none`. Default is `default`.
        :param 'GroupCapacityReservationSpecificationCapacityReservationTargetArgs' capacity_reservation_target: Describes a target Capacity Reservation or Capacity Reservation resource group.
        """
...
class GroupCapacityReservationSpecificationCapacityReservationTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] capacity_reservation_ids: List of On-Demand Capacity Reservation Ids. Conflicts with `capacity_reservation_resource_group_arns`.
        :param Sequence[builtins.str] capacity_reservation_resource_group_arns: List of On-Demand Capacity Reservation Resource Group Arns. Conflicts with `capacity_reservation_ids`.
        """
    ...
    def capacity_reservation_resource_group_arns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class GroupInitialLifecycleHook(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 default_result: Optional[builtins.str] = None,
                 heartbeat_timeout: Optional[builtins.int] = None,
                 notification_metadata: Optional[builtins.str] = None,
                 notification_target_arn: Optional[builtins.str] = None,
                 role_arn: Optional[builtins.str] = None):
        """
        :param builtins.str name: Name of the Auto Scaling Group. By default generated by Pulumi. Conflicts with `name_prefix`.
        """
    ...
    def default_result(self) -> Optional[builtins.str]:
        return pulumi.get(self, "default_result")

    @property
    @pulumi.getter(name="heartbeatTimeout")
    def heartbeat_timeout(self) -> Optional[builtins.int]:
        return pulumi.get(self, "heartbeat_timeout")

    @property
    @pulumi.getter(name="notificationMetadata")
    def notification_metadata(self) -> Optional[builtins.str]:
        return pulumi.get(self, "notification_metadata")

    @property
    @pulumi.getter(name="notificationTargetArn")
    def notification_target_arn(self) -> Optional[builtins.str]:
...
class GroupInstanceMaintenancePolicy(dict):
    ...
    def __init__(__self__, *,
                 max_healthy_percentage: builtins.int,
                 min_healthy_percentage: builtins.int):
        """
        :param builtins.int max_healthy_percentage: Specifies the upper limit on the number of instances that are in the InService or Pending state with a healthy status during an instance replacement activity.
        :param builtins.int min_healthy_percentage: Specifies the lower limit on the number of instances that must be in the InService state with a healthy status during an instance replacement activity.
        """
    ...
    def max_healthy_percentage(self) -> builtins.int:
        """
    ...
    def min_healthy_percentage(self) -> builtins.int:
        """
...
class GroupInstanceRefresh(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str strategy: Strategy to use for instance refresh. The only allowed value is `Rolling`. See [StartInstanceRefresh Action](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_StartInstanceRefresh.html#API_StartInstanceRefresh_RequestParameters) for more information.
        :param 'GroupInstanceRefreshPreferencesArgs' preferences: Override default parameters for Instance Refresh.
        :param Sequence[builtins.str] triggers: Set of additional property names that will trigger an Instance Refresh. A refresh will always be triggered by a change in any of `launch_configuration`, `launch_template`, or `mixed_instances_policy`.
...
class GroupInstanceRefreshPreferences(dict):
    ...
    def __init__(__self__, *,
                 ...
                 auto_rollback: Optional[builtins.bool] = None,
                 checkpoint_delay: Optional[builtins.str] = None,
                 checkpoint_percentages: Optional[Sequence[builtins.int]] = None,
                 instance_warmup: Optional[builtins.str] = None,
                 max_healthy_percentage: Optional[builtins.int] = None,
                 min_healthy_percentage: Optional[builtins.int] = None,
                 scale_in_protected_instances: Optional[builtins.str] = None,
                 skip_matching: Optional[builtins.bool] = None,
                 standby_instances: Optional[builtins.str] = None):
        """
        :param 'GroupInstanceRefreshPreferencesAlarmSpecificationArgs' alarm_specification: Alarm Specification for Instance Refresh.
        :param builtins.bool auto_rollback: Automatically rollback if instance refresh fails. Defaults to `false`. This option may only be set to `true` when specifying a `launch_template` or `mixed_instances_policy`.
        :param builtins.str checkpoint_delay: Number of seconds to wait after a checkpoint. Defaults to `3600`.
        :param Sequence[builtins.int] checkpoint_percentages: List of percentages for each checkpoint. Values must be unique and in ascending order. To replace all instances, the final number must be `100`.
        :param builtins.str instance_warmup: Number of seconds until a newly launched instance is configured and ready to use. Default behavior is to use the Auto Scaling Group's health check grace period.
        :param builtins.int max_healthy_percentage: Amount of capacity in the Auto Scaling group that can be in service and healthy, or pending, to support your workload when an instance refresh is in place, as a percentage of the desired capacity of the Auto Scaling group. Values must be between `100` and `200`, defaults to `100`.
        :param builtins.int min_healthy_percentage: Amount of capacity in the Auto Scaling group that must remain healthy during an instance refresh to allow the operation to continue, as a percentage of the desired capacity of the Auto Scaling group. Defaults to `90`.
        :param builtins.str scale_in_protected_instances: Behavior when encountering instances protected from scale in are found. Available behaviors are `Refresh`, `Ignore`, and `Wait`. Default is `Ignore`.
        :param builtins.bool skip_matching: Replace instances that already have your desired configuration. Defaults to `false`.
        :param builtins.str standby_instances: Behavior when encountering instances in the `Standby` state in are found. Available behaviors are `Terminate`, `Ignore`, and `Wait`. Default is `Ignore`.
        """
    ...
    def auto_rollback(self) -> Optional[builtins.bool]:
        """
    ...
    def checkpoint_delay(self) -> Optional[builtins.str]:
        """
    ...
    def checkpoint_percentages(self) -> Optional[Sequence[builtins.int]]:
        """
    ...
    def instance_warmup(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="maxHealthyPercentage")
    def max_healthy_percentage(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter(name="minHealthyPercentage")
    def min_healthy_percentage(self) -> Optional[builtins.int]:
        """
    ...
    def scale_in_protected_instances(self) -> Optional[builtins.str]:
        """
    ...
    def skip_matching(self) -> Optional[builtins.bool]:
        """
    ...
    def standby_instances(self) -> Optional[builtins.str]:
        """
...
class GroupInstanceRefreshPreferencesAlarmSpecification(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] alarms: List of Cloudwatch alarms. If any of these alarms goes into ALARM state, Instance Refresh is failed.
        """
...
class GroupLaunchTemplate(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: ID of the launch template. Conflicts with `name`.
        :param builtins.str name: Name of the launch template. Conflicts with `id`.
        :param builtins.str version: Template version. Can be version number, `$Latest`, or `$Default`. (Default: `$Default`).
        """
        if id is not None:
...
class GroupMixedInstancesPolicyInstancesDistribution(dict):
    ...
    def __init__(__self__, *,
                 ...
                 spot_instance_pools: Optional[builtins.int] = None,
                 spot_max_price: Optional[builtins.str] = None):
        """
        :param builtins.str on_demand_allocation_strategy: Strategy to use when launching on-demand instances. Valid values: `prioritized`, `lowest-price`. Default: `prioritized`.
        :param builtins.int on_demand_base_capacity: Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances. Default: `0`.
        :param builtins.int on_demand_percentage_above_base_capacity: Percentage split between on-demand and Spot instances above the base on-demand capacity. Default: `100`.
        :param builtins.str spot_allocation_strategy: How to allocate capacity across the Spot pools. Valid values: `lowest-price`, `capacity-optimized`, `capacity-optimized-prioritized`, and `price-capacity-optimized`. Default: `lowest-price`.
        :param builtins.int spot_instance_pools: Number of Spot pools per availability zone to allocate capacity. EC2 Auto Scaling selects the cheapest Spot pools and evenly allocates Spot capacity across the number of Spot pools that you specify. Only available with `spot_allocation_strategy` set to `lowest-price`. Otherwise it must be set to `0`, if it has been defined before. Default: `2`.
        :param builtins.str spot_max_price: Maximum price per unit hour that the user is willing to pay for the Spot instances. Default: an empty string which means the on-demand price.
        """
    ...
    def spot_instance_pools(self) -> Optional[builtins.int]:
        """
    ...
    def spot_max_price(self) -> Optional[builtins.str]:
        """
...
class GroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 version: Optional[builtins.str] = None):
        """
        :param builtins.str launch_template_id: ID of the launch template. Conflicts with `launch_template_name`.
        :param builtins.str launch_template_name: Name of the launch template. Conflicts with `launch_template_id`.
        """
...
class GroupMixedInstancesPolicyLaunchTemplateOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str instance_type: Override the instance type in the Launch Template.
        ...
        :param builtins.str weighted_capacity: Number of capacity units, which gives the instance type a proportional weight to other instance types.
        """
...
class GroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirements(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] accelerator_manufacturers: List of accelerator manufacturer names. Default is any manufacturer.
               ...
               * xilinx
               ```
        :param Sequence[builtins.str] accelerator_names: List of accelerator names. Default is any acclerator.
        ...
        :param Sequence[builtins.str] accelerator_types: List of accelerator types. Default is any accelerator type.
               ...
               * inference
               ```
        :param Sequence[builtins.str] allowed_instance_types: List of instance types to apply your specified attributes against. All other instance types are ignored, even if they match your specified attributes. You can use strings with one or more wild cards, represented by an asterisk (\\*), to allow an instance type, size, or generation. The following are examples: `m5.8xlarge`, `c5*.*`, `m5a.*`, `r*`, `*3*`. For example, if you specify `c5*`, you are allowing the entire C5 instance family, which includes all C5a and C5n instance types. If you specify `m5a.*`, you are allowing all the M5a instance types, but not the M5n instance types. Maximum of 400 entries in the list; each entry is limited to 30 characters. Default is all instance types.
               
               > **NOTE:** If you specify `allowed_instance_types`, you can't specify `excluded_instance_types`.
        :param builtins.str bare_metal: Indicate whether bare metal instace types should be `included`, `excluded`, or `required`. Default is `excluded`.
        ...
        :param builtins.str burstable_performance: Indicate whether burstable performance instance types should be `included`, `excluded`, or `required`. Default is `excluded`.
        :param Sequence[builtins.str] cpu_manufacturers: List of CPU manufacturer names. Default is any manufacturer.
               ...
               * intel
               ```
        :param Sequence[builtins.str] excluded_instance_types: List of instance types to exclude. You can use strings with one or more wild cards, represented by an asterisk (\\*), to exclude an instance type, size, or generation. The following are examples: `m5.8xlarge`, `c5*.*`, `m5a.*`, `r*`, `*3*`. For example, if you specify `c5*`, you are excluding the entire C5 instance family, which includes all C5a and C5n instance types. If you specify `m5a.*`, you are excluding all the M5a instance types, but not the M5n instance types. Maximum of 400 entries in the list; each entry is limited to 30 characters. Default is no excluded instance types.
               
               > **NOTE:** If you specify `excluded_instance_types`, you can't specify `allowed_instance_types`.
        :param Sequence[builtins.str] instance_generations: List of instance generation names. Default is any generation.
               ...
               * previous - For existing applications optimized for older instance types.
               ```
        :param builtins.str local_storage: Indicate whether instance types with local storage volumes are `included`, `excluded`, or `required`. Default is `included`.
        :param Sequence[builtins.str] local_storage_types: List of local storage type names. Default any storage type.
               ...
               * ssd - solid state drive
               ```
        :param builtins.int max_spot_price_as_percentage_of_optimal_on_demand_price: The price protection threshold for Spot Instances. This is the maximum you’ll pay for a Spot Instance, expressed as a percentage higher than the cheapest M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as 999999. Conflicts with `spot_max_price_percentage_over_lowest_price`
        ...
        :param builtins.int on_demand_max_price_percentage_over_lowest_price: Price protection threshold for On-Demand Instances. This is the maximum you’ll pay for an On-Demand Instance, expressed as a percentage higher than the cheapest M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as 999999. Default is 20.
               
               If you set DesiredCapacityType to vcpu or memory-mib, the price protection threshold is applied based on the per vCPU or per memory price instead of the per instance price.
        :param builtins.bool require_hibernate_support: Indicate whether instance types must support On-Demand Instance Hibernation, either `true` or `false`. Default is `false`.
        :param builtins.int spot_max_price_percentage_over_lowest_price: Price protection threshold for Spot Instances. This is the maximum you’ll pay for a Spot Instance, expressed as a percentage higher than the cheapest M, C, or R instance type with your specified attributes. When Amazon EC2 Auto Scaling selects instance types with your attributes, we will exclude instance types whose price is higher than your threshold. The parameter accepts an integer, which Amazon EC2 Auto Scaling interprets as a percentage. To turn off price protection, specify a high value, such as 999999. Default is 100. Conflicts with `max_spot_price_as_percentage_of_optimal_on_demand_price`
...
class GroupTag(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool propagate_at_launch: Enables propagation of the tag to
    ...
    def propagate_at_launch(self) -> builtins.bool:
        """
...
class GroupWarmPool(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_group_prepared_capacity: Optional[builtins.int] = None,
                 min_size: Optional[builtins.int] = None,
                 pool_state: Optional[builtins.str] = None):
        """
        ...
        :param builtins.int max_group_prepared_capacity: Total maximum number of instances that are allowed to be in the warm pool or in any state except Terminated for the Auto Scaling group.
        :param builtins.int min_size: Minimum number of instances to maintain in the warm pool. This helps you to ensure that there is always a certain number of warmed instances available to handle traffic spikes. Defaults to 0 if not specified.
        :param builtins.str pool_state: Sets the instance state to transition to after the lifecycle hooks finish. Valid values are: Stopped (default), Running or Hibernated.
        """
...
class GroupWarmPoolInstanceReusePolicy(dict):
    ...
    def __init__(__self__, *,
                 reuse_on_scale_in: Optional[builtins.bool] = None):
        """
        :param builtins.bool reuse_on_scale_in: Whether instances in the Auto Scaling group can be returned to the warm pool on scale in.
        """
    ...
    def reuse_on_scale_in(self) -> Optional[builtins.bool]:
        """
...
class PolicyPredictiveScalingConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_capacity_breach_behavior: Optional[builtins.str] = None,
                 max_capacity_buffer: Optional[builtins.str] = None,
                 mode: Optional[builtins.str] = None,
                 scheduling_buffer_time: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str max_capacity_breach_behavior: Defines the behavior that should be applied if the forecast capacity approaches or exceeds the maximum capacity of the Auto Scaling group. Valid values are `HonorMaxCapacity` or `IncreaseMaxCapacity`. Default is `HonorMaxCapacity`.
        :param builtins.str max_capacity_buffer: Size of the capacity buffer to use when the forecast capacity is close to or exceeds the maximum capacity. Valid range is `0` to `100`. If set to `0`, Amazon EC2 Auto Scaling may scale capacity higher than the maximum capacity to equal but not exceed forecast capacity.
        :param builtins.str mode: Predictive scaling mode. Valid values are `ForecastAndScale` and `ForecastOnly`. Default is `ForecastOnly`.
        :param builtins.str scheduling_buffer_time: Amount of time, in seconds, by which the instance launch time can be advanced. Minimum is `0`.
        """
    ...
    def max_capacity_breach_behavior(self) -> Optional[builtins.str]:
        """
    ...
    def max_capacity_buffer(self) -> Optional[builtins.str]:
        """
    ...
    def scheduling_buffer_time(self) -> Optional[builtins.str]:
        """
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQuery(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: Short name for the metric used in predictive scaling policy.
        :param builtins.str expression: Math expression used on the returned metric. You must specify either `expression` or `metric_stat`, but not both.
        :param builtins.str label: Human-readable label for this metric or expression.
        ...
        :param builtins.bool return_data: Boolean that indicates whether to return the timestamps and raw data values of this metric, the default is true
        """
        pulumi.set(__self__, "id", id)
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStat(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str stat: Statistic of the metrics to return.
        :param builtins.str unit: Unit of the metrics to return.
        """
...
class PolicyPredictiveScalingConfigurationMetricSpecificationCustomizedCapacityMetricSpecificationMetricDataQueryMetricStatMetricDimension(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str value: Value of the dimension.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedLoadMetricSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str predefined_metric_type: Metric type. Valid values are `ASGTotalCPUUtilization`, `ASGTotalNetworkIn`, `ASGTotalNetworkOut`, or `ALBTargetGroupRequestCount`.
        :param builtins.str resource_label: Label that uniquely identifies a specific Application Load Balancer target group from which to determine the request count served by your Auto Scaling group. You create the resource label by appending the final portion of the load balancer ARN and the final portion of the target group ARN into a single value, separated by a forward slash (/). Refer to [PredefinedMetricSpecification](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_PredefinedMetricSpecification.html) for more information.
        """
...
class PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedMetricPairSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_label: Optional[builtins.str] = None):
        """
        :param builtins.str predefined_metric_type: Which metrics to use. There are two different types of metrics for each metric type: one is a load metric and one is a scaling metric. For example, if the metric type is `ASGCPUUtilization`, the Auto Scaling group's total CPU metric is used as the load metric, and the average CPU metric is used for the scaling metric. Valid values are `ASGCPUUtilization`, `ASGNetworkIn`, `ASGNetworkOut`, or `ALBRequestCount`.
        :param builtins.str resource_label: Label that uniquely identifies a specific Application Load Balancer target group from which to determine the request count served by your Auto Scaling group. You create the resource label by appending the final portion of the load balancer ARN and the final portion of the target group ARN into a single value, separated by a forward slash (/). Refer to [PredefinedMetricSpecification](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_PredefinedMetricSpecification.html) for more information.
        """
        pulumi.set(__self__, "predefined_metric_type", predefined_metric_type)
        if resource_label is not None:
...
class PolicyPredictiveScalingConfigurationMetricSpecificationPredefinedScalingMetricSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_label: Optional[builtins.str] = None):
        """
        :param builtins.str predefined_metric_type: Describes a scaling metric for a predictive scaling policy. Valid values are `ASGAverageCPUUtilization`, `ASGAverageNetworkIn`, `ASGAverageNetworkOut`, or `ALBRequestCountPerTarget`.
        :param builtins.str resource_label: Label that uniquely identifies a specific Application Load Balancer target group from which to determine the request count served by your Auto Scaling group. You create the resource label by appending the final portion of the load balancer ARN and the final portion of the target group ARN into a single value, separated by a forward slash (/). Refer to [PredefinedMetricSpecification](https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_PredefinedMetricSpecification.html) for more information.
        """
        pulumi.set(__self__, "predefined_metric_type", predefined_metric_type)
        if resource_label is not None:
...
class PolicyStepAdjustment(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int scaling_adjustment: Number of members by which to
               scale, when the adjustment bounds are breached. A positive value scales
               up. A negative value scales down.
        :param builtins.str metric_interval_lower_bound: Lower bound for the
               difference between the alarm threshold and the CloudWatch metric.
               Without a value, AWS will treat this bound as negative infinity.
        :param builtins.str metric_interval_upper_bound: Upper bound for the
               difference between the alarm threshold and the CloudWatch metric.
...
class PolicyTargetTrackingConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool disable_scale_in: Whether scale in by the target tracking policy is disabled.
...
class PolicyTargetTrackingConfigurationCustomizedMetricSpecification(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str namespace: Namespace of the metric.
        :param builtins.int period: The period of the metric in seconds.
        :param builtins.str statistic: Statistic of the metric.
...
class PolicyTargetTrackingConfigurationCustomizedMetricSpecificationMetric(dict):
    ...
    def __init__(__self__, *,
                 ...
                 return_data: Optional[builtins.bool] = None):
        """
        :param builtins.str id: Short name for the metric used in target tracking scaling policy.
        :param builtins.str expression: Math expression used on the returned metric. You must specify either `expression` or `metric_stat`, but not both.
        :param builtins.str label: Human-readable label for this metric or expression.
...
class PolicyTargetTrackingConfigurationPredefinedMetricSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_label: Optional[builtins.str] = None):
        """
        :param builtins.str predefined_metric_type: Metric type.
...
class TagTag(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool propagate_at_launch: Whether to propagate the tags to instances launched by the ASG.
...
class GetGroupLaunchTemplateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: ID of the launch template.
...
class GetGroupMixedInstancesPolicyInstancesDistributionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str on_demand_allocation_strategy: Strategy used when launching on-demand instances.
        :param builtins.int on_demand_base_capacity: Absolute minimum amount of desired capacity that must be fulfilled by on-demand instances.
        :param builtins.str spot_allocation_strategy: Strategy used when launching Spot instances.
        :param builtins.int spot_instance_pools: Number of Spot pools per availability zone to allocate capacity.
        :param builtins.str spot_max_price: Maximum price per unit hour that the user is willing to pay for the Spot instances.
        """
        pulumi.set(__self__, "on_demand_allocation_strategy", on_demand_allocation_strategy)
        pulumi.set(__self__, "on_demand_base_capacity", on_demand_base_capacity)
        pulumi.set(__self__, "on_demand_percentage_above_base_capacity", on_demand_percentage_above_base_capacity)
...
class GetGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecificationResult(dict):
    def __init__(__self__, *,
                 ...
                 version: builtins.str):
        """
        :param builtins.str launch_template_id: ID of the launch template.
...
class GetGroupMixedInstancesPolicyLaunchTemplateOverrideResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str instance_type: Overriding instance type.
...
class GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementResult(dict):
    def __init__(__self__, *,
                 ...
                 accelerator_manufacturers: Sequence[builtins.str],
                 accelerator_names: Sequence[builtins.str],
                 ...
                 accelerator_types: Sequence[builtins.str],
                 allowed_instance_types: Sequence[builtins.str],
                 bare_metal: builtins.str,
                 ...
                 cpu_manufacturers: Sequence[builtins.str],
                 excluded_instance_types: Sequence[builtins.str],
                 instance_generations: Sequence[builtins.str],
                 local_storage: builtins.str,
                 local_storage_types: Sequence[builtins.str],
                 max_spot_price_as_percentage_of_optimal_on_demand_price: builtins.int,
                 ...
                 on_demand_max_price_percentage_over_lowest_price: builtins.int,
                 require_hibernate_support: builtins.bool,
                 spot_max_price_percentage_over_lowest_price: builtins.int,
        ...
        """
        :param Sequence[builtins.str] accelerator_manufacturers: List of accelerator manufacturer names.
        :param Sequence[builtins.str] accelerator_names: List of accelerator names.
        ...
        :param Sequence[builtins.str] accelerator_types: List of accelerator types.
        :param Sequence[builtins.str] allowed_instance_types: List of instance types to apply the specified attributes against.
        :param builtins.str bare_metal: Indicates whether bare metal instances are included, excluded, or required.
        ...
        :param builtins.str burstable_performance: Indicates whether burstable performance instance types are included, excluded, or required.
        :param Sequence[builtins.str] cpu_manufacturers: List of CPU manufacturer names.
        :param Sequence[builtins.str] excluded_instance_types: List of excluded instance types.
        :param Sequence[builtins.str] instance_generations: List of instance generation names.
        :param builtins.str local_storage: Indicates whether instance types with instance store volumes are included, excluded, or required.
        :param Sequence[builtins.str] local_storage_types: List of local storage type names.
        :param builtins.int max_spot_price_as_percentage_of_optimal_on_demand_price: Price protection threshold for Spot Instances.
        ...
        :param builtins.int on_demand_max_price_percentage_over_lowest_price: Price protection threshold for On-Demand Instances.
        :param builtins.bool require_hibernate_support: Indicates whether instance types must support On-Demand Instance Hibernation.
        :param builtins.int spot_max_price_percentage_over_lowest_price: Price protection threshold for Spot Instances.
    ...
    @property
    @pulumi.getter(name="acceleratorManufacturers")
    def accelerator_manufacturers(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="acceleratorNames")
    def accelerator_names(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="acceleratorTypes")
    def accelerator_types(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="allowedInstanceTypes")
    def allowed_instance_types(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="cpuManufacturers")
    def cpu_manufacturers(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="instanceGenerations")
    def instance_generations(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="localStorageTypes")
    def local_storage_types(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="maxSpotPriceAsPercentageOfOptimalOnDemandPrice")
    def max_spot_price_as_percentage_of_optimal_on_demand_price(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="onDemandMaxPricePercentageOverLowestPrice")
    def on_demand_max_price_percentage_over_lowest_price(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="requireHibernateSupport")
    def require_hibernate_support(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="spotMaxPricePercentageOverLowestPrice")
    def spot_max_price_percentage_over_lowest_price(self) -> builtins.int:
        """
        Price protection threshold for Spot Instances.
        """
        return pulumi.get(self, "spot_max_price_percentage_over_lowest_price")
...
class GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementAcceleratorCountResult(dict):
    def __init__(__self__, *,
                 ...
                 min: builtins.int):
        """
        :param builtins.int max: Maximum.
        :param builtins.int min: Minimum.
        """
        pulumi.set(__self__, "max", max)
        pulumi.set(__self__, "min", min)
...
class GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementMemoryGibPerVcpusResult(dict):
    def __init__(__self__, *,
                 ...
                 min: builtins.float):
        """
        :param builtins.float max: Maximum.
        :param builtins.float min: Minimum.
        """
        pulumi.set(__self__, "max", max)
        pulumi.set(__self__, "min", min)
...
class GetGroupTagResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: Key.
        :param builtins.bool propagate_at_launch: Whether the tag is propagated to Amazon EC2 instances launched via this ASG.
        :param builtins.str value: Value.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "propagate_at_launch", propagate_at_launch)
...
class GetGroupTrafficSourceResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str identifier: Identifies the traffic source. For Application Load Balancers, Gateway Load Balancers, Network Load Balancers, and VPC Lattice, this will be the Amazon Resource Name (ARN) for a target group in this account and Region. For Classic Load Balancers, this will be the name of the Classic Load Balancer in this account and Region.
        :param builtins.str type: Traffic source type.
        """
        pulumi.set(__self__, "identifier", identifier)
        pulumi.set(__self__, "type", type)
...
class GetGroupWarmPoolResult(dict):
    def __init__(__self__, *,
                 ...
                 max_group_prepared_capacity: builtins.int,
                 min_size: builtins.int,
                 pool_state: builtins.str):
        """
        :param Sequence['GetGroupWarmPoolInstanceReusePolicyArgs'] instance_reuse_policies: List of instance reuse policy objects.
        :param builtins.int min_size: Minimum number of instances to maintain in the warm pool.
        :param builtins.str pool_state: Instance state to transition to after the lifecycle actions are complete.
        """
    ...
    @property
    @pulumi.getter(name="maxGroupPreparedCapacity")
    def max_group_prepared_capacity(self) -> builtins.int:
        return pulumi.get(self, "max_group_prepared_capacity")
...
class GetGroupWarmPoolInstanceReusePolicyResult(dict):
    def __init__(__self__, *,
                 reuse_on_scale_in: builtins.bool):
        """
        :param builtins.bool reuse_on_scale_in: Indicates whether instances in the Auto Scaling group can be returned to the warm pool on scale in.
        """
        pulumi.set(__self__, "reuse_on_scale_in", reuse_on_scale_in)

    @property
    @pulumi.getter(name="reuseOnScaleIn")
    def reuse_on_scale_in(self) -> builtins.bool:
        """
