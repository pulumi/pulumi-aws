...
class GroupMixedInstancesPolicyLaunchTemplateOverride(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'GroupMixedInstancesPolicyLaunchTemplateOverrideLaunchTemplateSpecificationArgs' launch_template_specification: Nested argument defines the Launch Template. Defined below.
