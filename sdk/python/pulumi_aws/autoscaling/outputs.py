...
class GetGroupMixedInstancesPolicyResult(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'instancesDistributions' in kwargs:
...
class GetGroupMixedInstancesPolicyLaunchTemplateResult(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'launchTemplateSpecifications' in kwargs:
...
class GetGroupMixedInstancesPolicyLaunchTemplateOverrideInstanceRequirementResult(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'acceleratorCounts' in kwargs:
            accelerator_counts = kwargs['acceleratorCounts']
        if 'acceleratorManufacturers' in kwargs:
            accelerator_manufacturers = kwargs['acceleratorManufacturers']
        if 'acceleratorNames' in kwargs:
            accelerator_names = kwargs['acceleratorNames']
        if 'acceleratorTotalMemoryMibs' in kwargs:
        ...
        if 'localStorageTypes' in kwargs:
            local_storage_types = kwargs['localStorageTypes']
        if 'memoryGibPerVcpus' in kwargs:
            memory_gib_per_vcpus = kwargs['memoryGibPerVcpus']
        if 'memoryMibs' in kwargs:
            memory_mibs = kwargs['memoryMibs']
        if 'networkBandwidthGbps' in kwargs:
            network_bandwidth_gbps = kwargs['networkBandwidthGbps']
        if 'networkInterfaceCounts' in kwargs:
        ...
        if 'spotMaxPricePercentageOverLowestPrice' in kwargs:
            spot_max_price_percentage_over_lowest_price = kwargs['spotMaxPricePercentageOverLowestPrice']
        if 'totalLocalStorageGbs' in kwargs:
            total_local_storage_gbs = kwargs['totalLocalStorageGbs']
        if 'vcpuCounts' in kwargs:
...
class GetGroupWarmPoolResult(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'instanceReusePolicies' in kwargs:
