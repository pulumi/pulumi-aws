...
class GetSlackWorkspaceResult:
    ...
    """
    def __init__(__self__, region=None, slack_team_id=None, slack_team_name=None):
...
def get_slack_workspace_output(region: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
