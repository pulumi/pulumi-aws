...
class SlackChannelConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 slack_channel_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] configuration_name: Name of the Slack channel configuration.
    ...
    def slack_channel_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def slack_channel_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "slack_channel_id", value)

    @property
    @pulumi.getter(name="slackTeamId")
    def slack_team_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def slack_team_id(self, value: pulumi.Input[builtins.str]):
...
class _SlackChannelConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] chat_configuration_arn: ARN of the Slack channel configuration.
        :param pulumi.Input[builtins.str] configuration_name: Name of the Slack channel configuration.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] guardrail_policy_arns: List of IAM policy ARNs that are applied as channel guardrails. The AWS managed `AdministratorAccess` policy is applied by default if this is not set.
        :param pulumi.Input[builtins.str] iam_role_arn: User-defined role that AWS Chatbot assumes. This is not the service-linked role.
        :param pulumi.Input[builtins.str] logging_level: Logging levels include `ERROR`, `INFO`, or `NONE`.
        ...
        :param pulumi.Input[builtins.str] slack_team_id: ID of the Slack workspace authorized with AWS Chatbot. For example, `T07EA123LEP`.
               ...
               The following arguments are optional:
        :param pulumi.Input[builtins.str] slack_team_name: Name of the Slack team.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sns_topic_arns: ARNs of the SNS topics that deliver notifications to AWS Chatbot.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of tags assigned to the resource.
    ...
    @property
    @pulumi.getter(name="slackTeamId")
    def slack_team_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the Slack workspace authorized with AWS Chatbot. For example, `T07EA123LEP`.
    ...
    @slack_team_id.setter
    def slack_team_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "slack_team_id", value)

    @property
    @pulumi.getter(name="slackTeamName")
    def slack_team_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def slack_team_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SlackChannelConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            timeouts: Optional[pulumi.Input[Union['SlackChannelConfigurationTimeoutsArgs', 'SlackChannelConfigurationTimeoutsArgsDict']]] = None,
            user_authorization_required: Optional[pulumi.Input[builtins.bool]] = None) -> 'SlackChannelConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="slackChannelId")
    def slack_channel_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the Slack channel. For example, `C07EZ1ABC23`.
        """
        return pulumi.get(self, "slack_channel_id")
    ...
    @property
    @pulumi.getter(name="slackChannelName")
    def slack_channel_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the Slack channel.
        """
        return pulumi.get(self, "slack_channel_name")
    ...
    @property
    @pulumi.getter(name="slackTeamId")
    def slack_team_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the Slack workspace authorized with AWS Chatbot. For example, `T07EA123LEP`.
    ...
    @property
    @pulumi.getter(name="slackTeamName")
    def slack_team_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the Slack team.
        """
        return pulumi.get(self, "slack_team_name")
