...
class DomainAdvancedSecurityOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool internal_user_database_enabled: Whether the internal user database is enabled. If not set, defaults to `false` by the AWS API.
...
class DomainAdvancedSecurityOptionsMasterUserOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str master_user_name: Main user's username, which is stored in the Amazon Elasticsearch Service domain's internal database. Only specify if `internal_user_database_enabled` is set to `true`.
        :param _builtins.str master_user_password: Main user's password, which is stored in the Amazon Elasticsearch Service domain's internal database. Only specify if `internal_user_database_enabled` is set to `true`.
        """
...
class DomainAutoTuneOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str desired_state: The Auto-Tune desired state for the domain. Valid values: `ENABLED` or `DISABLED`.
...
class DomainAutoTuneOptionsMaintenanceScheduleDuration(dict):
    def __init__(__self__, *,
                 ...
                 value: _builtins.int):
        """
        :param _builtins.str unit: The unit of time specifying the duration of an Auto-Tune maintenance window. Valid values: `HOURS`.
...
class DomainClusterConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str warm_type: Instance type for the Elasticsearch cluster's warm nodes. Valid values are `ultrawarm1.medium.elasticsearch`, `ultrawarm1.large.elasticsearch` and `ultrawarm1.xlarge.elasticsearch`. `warm_type` can be only and must be set when `warm_enabled` is set to `true`.
...
class DomainClusterConfigColdStorageOptions(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: Boolean to enable cold storage for an Elasticsearch domain. Defaults to `false`. Master and ultrawarm nodes must be enabled for cold storage.
        """
...
class DomainCognitoOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str role_arn: ARN of the IAM role that has the AmazonESCognitoAccess policy attached.
        :param _builtins.str user_pool_id: ID of the Cognito User Pool to use.
        :param _builtins.bool enabled: Whether Amazon Cognito authentication with Kibana is enabled or not.
        """
...
class DomainDomainEndpointOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool custom_endpoint_enabled: Whether to enable custom endpoint for the Elasticsearch domain.
        :param _builtins.bool enforce_https: Whether or not to require HTTPS. Defaults to `true`.
        :param _builtins.str tls_security_policy: Name of the TLS security policy that needs to be applied to the HTTPS endpoint. Valid values:  `Policy-Min-TLS-1-0-2019-07`, `Policy-Min-TLS-1-2-2019-07`, and `Policy-Min-TLS-1-2-PFS-2023-10`. Pulumi will only perform drift detection if a configuration value is provided.
        """
...
class DomainEncryptAtRest(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: Whether to enable encryption at rest. If the `encrypt_at_rest` block is not provided then this defaults to `false`. Enabling encryption on new domains requires `elasticsearch_version` 5.1 or greater.
...
class DomainLogPublishingOption(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str log_type: Type of Elasticsearch log. Valid values: `INDEX_SLOW_LOGS`, `SEARCH_SLOW_LOGS`, `ES_APPLICATION_LOGS`, `AUDIT_LOGS`.
...
class DomainNodeToNodeEncryption(dict):
    def __init__(__self__, *,
                 enabled: _builtins.bool):
        """
        :param _builtins.bool enabled: Whether to enable node-to-node encryption. If the `node_to_node_encryption` block is not provided then this defaults to `false`. Enabling node-to-node encryption of a new domain requires an `elasticsearch_version` of `6.0` or greater.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class DomainSamlOptionsSamlOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str subject_key: Custom SAML attribute to use for user names. Default is an empty string - `""`. This will cause Elasticsearch to use the `NameID` element of the `Subject`, which is the default location for name identifiers in the SAML specification.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if idp is not None:
...
class DomainSamlOptionsSamlOptionsIdp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str entity_id: The unique Entity ID of the application in SAML Identity Provider.
...
class DomainVpcOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] security_group_ids: List of VPC Security Group IDs to be applied to the Elasticsearch domain endpoints. If omitted, the default Security Group for the VPC will be used.
        :param Sequence[_builtins.str] subnet_ids: List of VPC Subnet IDs for the Elasticsearch domain endpoints to be created in.
...
class VpcEndpointVpcOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[_builtins.str] security_group_ids: The list of security group IDs associated with the VPC endpoints for the domain. If you do not provide a security group ID, elasticsearch Service uses the default security group for the VPC.
        """
        pulumi.set(__self__, "subnet_ids", subnet_ids)
        if availability_zones is not None:
            pulumi.set(__self__, "availability_zones", availability_zones)
...
class GetDomainAdvancedSecurityOptionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: Whether node to node encryption is enabled.
...
class GetDomainAutoTuneOptionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str desired_state: The Auto-Tune desired state for the domain.
...
class GetDomainClusterConfigResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str warm_type: The instance type for the Elasticsearch cluster's warm nodes.
...
class GetDomainCognitoOptionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: Whether node to node encryption is enabled.
        :param _builtins.str identity_pool_id: The Cognito Identity pool used by the domain.
        :param _builtins.str role_arn: The IAM Role with the AmazonESCognitoAccess policy attached.
        :param _builtins.str user_pool_id: The Cognito User pool used by the domain.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "identity_pool_id", identity_pool_id)
        pulumi.set(__self__, "role_arn", role_arn)
...
class GetDomainEbsOptionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool ebs_enabled: Whether EBS volumes are attached to data nodes in the domain.
        :param _builtins.int iops: The baseline input/output (I/O) performance of EBS volumes attached to data nodes.
        :param _builtins.int throughput: The throughput (in MiB/s) of the EBS volumes attached to data nodes.
        :param _builtins.int volume_size: The size of EBS volumes attached to data nodes (in GB).
        :param _builtins.str volume_type: The type of EBS volumes attached to data nodes.
        """
        pulumi.set(__self__, "ebs_enabled", ebs_enabled)
        pulumi.set(__self__, "iops", iops)
        pulumi.set(__self__, "throughput", throughput)
...
class GetDomainEncryptionAtRestResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: Whether node to node encryption is enabled.
        :param _builtins.str kms_key_id: The KMS key id used to encrypt data at rest.
        """
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class GetDomainLogPublishingOptionResult(dict):
    def __init__(__self__, *,
                 ...
                 log_type: _builtins.str):
        """
        :param _builtins.str cloudwatch_log_group_arn: The CloudWatch Log Group where the logs are published.
        :param _builtins.bool enabled: Whether node to node encryption is enabled.
        :param _builtins.str log_type: The type of Elasticsearch log being published.
        """
        pulumi.set(__self__, "cloudwatch_log_group_arn", cloudwatch_log_group_arn)
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "log_type", log_type)
...
class GetDomainVpcOptionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] availability_zones: The availability zones used by the domain.
        :param Sequence[_builtins.str] security_group_ids: The security groups used by the domain.
        :param Sequence[_builtins.str] subnet_ids: The subnets used by the domain.
        :param _builtins.str vpc_id: The VPC used by the domain.
        """
        pulumi.set(__self__, "availability_zones", availability_zones)
        pulumi.set(__self__, "security_group_ids", security_group_ids)
        pulumi.set(__self__, "subnet_ids", subnet_ids)
