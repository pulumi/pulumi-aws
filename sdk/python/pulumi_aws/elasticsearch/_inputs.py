...
class DomainAdvancedSecurityOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] internal_user_database_enabled: Whether the internal user database is enabled. If not set, defaults to `false` by the AWS API.
...
class DomainAdvancedSecurityOptionsMasterUserOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] master_user_name: Main user's username, which is stored in the Amazon Elasticsearch Service domain's internal database. Only specify if `internal_user_database_enabled` is set to `true`.
        :param pulumi.Input[_builtins.str] master_user_password: Main user's password, which is stored in the Amazon Elasticsearch Service domain's internal database. Only specify if `internal_user_database_enabled` is set to `true`.
        """
...
class DomainAutoTuneOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] desired_state: The Auto-Tune desired state for the domain. Valid values: `ENABLED` or `DISABLED`.
...
class DomainAutoTuneOptionsMaintenanceScheduleDurationArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.str] unit: The unit of time specifying the duration of an Auto-Tune maintenance window. Valid values: `HOURS`.
...
class DomainClusterConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] warm_type: Instance type for the Elasticsearch cluster's warm nodes. Valid values are `ultrawarm1.medium.elasticsearch`, `ultrawarm1.large.elasticsearch` and `ultrawarm1.xlarge.elasticsearch`. `warm_type` can be only and must be set when `warm_enabled` is set to `true`.
...
class DomainClusterConfigColdStorageOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.bool] enabled: Boolean to enable cold storage for an Elasticsearch domain. Defaults to `false`. Master and ultrawarm nodes must be enabled for cold storage.
        """
...
class DomainCognitoOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] role_arn: ARN of the IAM role that has the AmazonESCognitoAccess policy attached.
        :param pulumi.Input[_builtins.str] user_pool_id: ID of the Cognito User Pool to use.
        :param pulumi.Input[_builtins.bool] enabled: Whether Amazon Cognito authentication with Kibana is enabled or not.
        """
...
class DomainDomainEndpointOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] custom_endpoint_enabled: Whether to enable custom endpoint for the Elasticsearch domain.
...
class DomainEncryptAtRestArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.bool] enabled: Whether to enable encryption at rest. If the `encrypt_at_rest` block is not provided then this defaults to `false`. Enabling encryption on new domains requires `elasticsearch_version` 5.1 or greater.
...
class DomainLogPublishingOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] log_type: Type of Elasticsearch log. Valid values: `INDEX_SLOW_LOGS`, `SEARCH_SLOW_LOGS`, `ES_APPLICATION_LOGS`, `AUDIT_LOGS`.
...
class DomainNodeToNodeEncryptionArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[_builtins.bool]):
        """
        :param pulumi.Input[_builtins.bool] enabled: Whether to enable node-to-node encryption. If the `node_to_node_encryption` block is not provided then this defaults to `false`. Enabling node-to-node encryption of a new domain requires an `elasticsearch_version` of `6.0` or greater.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class DomainSamlOptionsSamlOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subject_key: Custom SAML attribute to use for user names. Default is an empty string - `""`. This will cause Elasticsearch to use the `NameID` element of the `Subject`, which is the default location for name identifiers in the SAML specification.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
        if idp is not None:
...
class DomainSamlOptionsSamlOptionsIdpArgs:
    def __init__(__self__, *,
                 ...
                 metadata_content: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] entity_id: The unique Entity ID of the application in SAML Identity Provider.
...
class DomainVpcOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: List of VPC Security Group IDs to be applied to the Elasticsearch domain endpoints. If omitted, the default Security Group for the VPC will be used.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subnet_ids: List of VPC Subnet IDs for the Elasticsearch domain endpoints to be created in.
...
class VpcEndpointVpcOptionsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: The list of security group IDs associated with the VPC endpoints for the domain. If you do not provide a security group ID, elasticsearch Service uses the default security group for the VPC.
        """
        pulumi.set(__self__, "subnet_ids", subnet_ids)
        if availability_zones is not None:
            pulumi.set(__self__, "availability_zones", availability_zones)
