...
class DomainArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] elasticsearch_version: Version of Elasticsearch to deploy. Defaults to `1.5`.
...
class Domain(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="elasticsearchVersion")
    def elasticsearch_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Version of Elasticsearch to deploy. Defaults to `1.5`.
        """
        return pulumi.get(self, "elasticsearch_version")
