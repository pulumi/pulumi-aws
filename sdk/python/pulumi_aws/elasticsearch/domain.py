...
class Domain(pulumi.CustomResource):
    ...
    Cluster configuration of the domain, see below.
      ...
      * `dedicated_master_count` (`float`) - Number of dedicated master nodes in the cluster
      * `dedicated_master_enabled` (`bool`) - Indicates whether dedicated master nodes are enabled for the cluster.
      * `dedicated_master_type` (`str`) - Instance type of the dedicated master nodes in the cluster.
      * `instance_count` (`float`) - Number of instances in the cluster.
      * `instance_type` (`str`) - Instance type of data nodes in the cluster.
      * `zone_awareness_config` (`dict`) - Configuration block containing zone awareness settings. Documented below.
    
        * `availability_zone_count` (`float`) - Number of Availability Zones for the domain to use with `zone_awareness_enabled`. Defaults to `2`. Valid values: `2` or `3`.
    
      * `zone_awareness_enabled` (`bool`) - Indicates whether zone awareness is enabled. To enable awareness with three Availability Zones, the `availability_zone_count` within the `zone_awareness_config` must be set to `3`.
    """
    ...
    EBS related options, may be required based on chosen [instance size](https://aws.amazon.com/elasticsearch-service/pricing/). See below.
      ...
      * `ebs_enabled` (`bool`) - Whether EBS volumes are attached to data nodes in the domain
      ...
      * `volume_type` (`str`) - The type of EBS volumes attached to data nodes.
    """
    ...
    * `vpc_options.0.vpc_id` - If the domain was created inside a VPC, the ID of the VPC.
    ...
    Options for publishing slow logs to CloudWatch Logs.
      ...
      * `enabled` (`bool`) - Specifies whether Amazon Cognito authentication with Kibana is enabled or not
      * `log_type` (`str`) - A type of Elasticsearch log. Valid values: INDEX_SLOW_LOGS, SEARCH_SLOW_LOGS, ES_APPLICATION_LOGS
    """
    ...
    Snapshot related options, see below.
      ...
      * `automated_snapshot_start_hour` (`float`) - Hour during which the service takes an automated daily
    ...
    def __init__(__self__, resource_name, opts=None, access_policies=None, advanced_options=None, cluster_config=None, cognito_options=None, domain_name=None, ebs_options=None, elasticsearch_version=None, encrypt_at_rest=None, log_publishing_options=None, node_to_node_encryption=None, snapshot_options=None, tags=None, vpc_options=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **snapshot_options** object supports the following:
          ...
          * `automated_snapshot_start_hour` (`pulumi.Input[float]`) - Hour during which the service takes an automated daily
            snapshot of the indices in the domain.
        ...
        The **cluster_config** object supports the following:
          ...
          * `dedicated_master_count` (`pulumi.Input[float]`) - Number of dedicated master nodes in the cluster
          * `dedicated_master_enabled` (`pulumi.Input[bool]`) - Indicates whether dedicated master nodes are enabled for the cluster.
          * `dedicated_master_type` (`pulumi.Input[str]`) - Instance type of the dedicated master nodes in the cluster.
          ...
          * `zone_awareness_config` (`pulumi.Input[dict]`) - Configuration block containing zone awareness settings. Documented below.
        
            * `availability_zone_count` (`pulumi.Input[float]`) - Number of Availability Zones for the domain to use with `zone_awareness_enabled`. Defaults to `2`. Valid values: `2` or `3`.
        
          * `zone_awareness_enabled` (`pulumi.Input[bool]`) - Indicates whether zone awareness is enabled. To enable awareness with three Availability Zones, the `availability_zone_count` within the `zone_awareness_config` must be set to `3`.
        ...
        The **ebs_options** object supports the following:
          ...
          * `ebs_enabled` (`pulumi.Input[bool]`) - Whether EBS volumes are attached to data nodes in the domain
          ...
          * `volume_size` (`pulumi.Input[float]`) - The size of EBS volumes attached to data nodes (in GB).
            **Required** if `ebs_enabled` is set to `true`.
          * `volume_type` (`pulumi.Input[str]`) - The type of EBS volumes attached to data nodes.
        ...
        The **log_publishing_options** object supports the following:
          ...
          * `enabled` (`pulumi.Input[bool]`) - Specifies whether Amazon Cognito authentication with Kibana is enabled or not
          * `log_type` (`pulumi.Input[str]`) - A type of Elasticsearch log. Valid values: INDEX_SLOW_LOGS, SEARCH_SLOW_LOGS, ES_APPLICATION_LOGS
