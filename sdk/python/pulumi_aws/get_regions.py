...
def get_regions(all_regions: Optional[builtins.bool] = None,
    ...
    :param builtins.bool all_regions: If true the source will query all regions regardless of availability.
...
def get_regions_output(all_regions: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
