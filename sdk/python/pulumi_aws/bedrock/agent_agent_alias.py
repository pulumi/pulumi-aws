...
class AgentAgentAliasArgs:
    def __init__(__self__, *,
                 agent_alias_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] agent_alias_name: Name of the alias.
        :param pulumi.Input[builtins.str] agent_id: Identifier of the agent to create an alias for.
    ...
    def agent_alias_name(self) -> pulumi.Input[builtins.str]:
        """
        Name of the alias.
        """
    ...
    def agent_alias_name(self, value: pulumi.Input[builtins.str]):
...
class _AgentAgentAliasState:
    def __init__(__self__, *,
                 agent_alias_arn: Optional[pulumi.Input[builtins.str]] = None,
                 agent_alias_id: Optional[pulumi.Input[builtins.str]] = None,
                 agent_alias_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] agent_alias_arn: ARN of the alias.
        :param pulumi.Input[builtins.str] agent_alias_id: Unique identifier of the alias.
        :param pulumi.Input[builtins.str] agent_alias_name: Name of the alias.
        :param pulumi.Input[builtins.str] agent_id: Identifier of the agent to create an alias for.
    ...
    def agent_alias_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the alias.
        """
    ...
    def agent_alias_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agent_alias_arn", value)

    @property
    @pulumi.getter(name="agentAliasId")
    def agent_alias_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def agent_alias_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agent_alias_id", value)

    @property
    @pulumi.getter(name="agentAliasName")
    def agent_alias_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the alias.
        """
        return pulumi.get(self, "agent_alias_name")
    ...
    @agent_alias_name.setter
    def agent_alias_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agent_alias_name", value)
...
class AgentAgentAlias(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="agentAliasArn")
    def agent_alias_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the alias.
        """
        return pulumi.get(self, "agent_alias_arn")
    ...
    @property
    @pulumi.getter(name="agentAliasId")
    def agent_alias_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier of the alias.
        """
        return pulumi.get(self, "agent_alias_id")
    ...
    @property
    @pulumi.getter(name="agentAliasName")
    def agent_alias_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the alias.
        """
        return pulumi.get(self, "agent_alias_name")
