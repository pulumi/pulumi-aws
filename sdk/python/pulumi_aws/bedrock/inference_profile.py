...
class InferenceProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description of the inference profile.
...
class _InferenceProfileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the inference profile.
        :param pulumi.Input[builtins.str] created_at: The time at which the inference profile was created.
        :param pulumi.Input[builtins.str] description: The description of the inference profile.
        :param pulumi.Input['InferenceProfileModelSourceArgs'] model_source: The source of the model this inference profile will track metrics and cost for. See `model_source`.
        ...
        :param pulumi.Input[builtins.str] updated_at: The time at which the inference profile was last updated.
        """
        if arn is not None:
...
class InferenceProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timeouts: Optional[pulumi.Input[Union['InferenceProfileTimeoutsArgs', 'InferenceProfileTimeoutsArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'InferenceProfile':
        """
