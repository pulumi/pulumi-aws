...
class AgentAgentKnowledgeBaseAssociationArgs:
    def __init__(__self__, *,
                 ...
                 timeouts: pulumi.Input[Optional['AgentAgentKnowledgeBaseAssociationTimeoutsArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] knowledge_base_state: Whether to use the knowledge base when sending an [InvokeAgent](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_agent-runtime_InvokeAgent.html) request. Valid values: `ENABLED`, `DISABLED`.
    ...
    @_builtins.property
    @pulumi.getter
    def timeouts(self) -> pulumi.Input[Optional['AgentAgentKnowledgeBaseAssociationTimeoutsArgs']]:
        return pulumi.get(self, "timeouts")

    @timeouts.setter
    def timeouts(self, value: pulumi.Input[Optional['AgentAgentKnowledgeBaseAssociationTimeoutsArgs']]):
...
class _AgentAgentKnowledgeBaseAssociationState:
    def __init__(__self__, *,
                 ...
                 knowledge_base_state: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 timeouts: pulumi.Input[Optional['AgentAgentKnowledgeBaseAssociationTimeoutsArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="knowledgeBaseState")
    def knowledge_base_state(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Whether to use the knowledge base when sending an [InvokeAgent](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_agent-runtime_InvokeAgent.html) request. Valid values: `ENABLED`, `DISABLED`.
    ...
    @knowledge_base_state.setter
    def knowledge_base_state(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "knowledge_base_state", value)
...
class AgentAgentKnowledgeBaseAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 knowledge_base_state: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 timeouts: pulumi.Input[Optional[Union['AgentAgentKnowledgeBaseAssociationTimeoutsArgs', 'AgentAgentKnowledgeBaseAssociationTimeoutsArgsDict', 'outputs.AgentAgentKnowledgeBaseAssociationTimeouts']]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            knowledge_base_state: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None,
            timeouts: pulumi.Input[Optional[Union['AgentAgentKnowledgeBaseAssociationTimeoutsArgs', 'AgentAgentKnowledgeBaseAssociationTimeoutsArgsDict', 'outputs.AgentAgentKnowledgeBaseAssociationTimeouts']]] = None) -> 'AgentAgentKnowledgeBaseAssociation':
        """
