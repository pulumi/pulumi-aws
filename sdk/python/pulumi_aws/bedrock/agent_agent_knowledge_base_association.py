...
class AgentAgentKnowledgeBaseAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agent_id: Unique identifier of the agent with which you want to associate the knowledge base.
        :param pulumi.Input[builtins.str] description: Description of what the agent should use the knowledge base for.
        :param pulumi.Input[builtins.str] knowledge_base_id: Unique identifier of the knowledge base to associate with the agent.
    ...
    def knowledge_base_state(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def knowledge_base_state(self, value: pulumi.Input[builtins.str]):
...
class _AgentAgentKnowledgeBaseAssociationState:
    ...
    @property
    @pulumi.getter(name="knowledgeBaseState")
    def knowledge_base_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether to use the knowledge base when sending an [InvokeAgent](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_agent-runtime_InvokeAgent.html) request. Valid values: `ENABLED`, `DISABLED`.
    ...
    @knowledge_base_state.setter
    def knowledge_base_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "knowledge_base_state", value)
...
class AgentAgentKnowledgeBaseAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="knowledgeBaseState")
    def knowledge_base_state(self) -> pulumi.Output[builtins.str]:
        """
        Whether to use the knowledge base when sending an [InvokeAgent](https://docs.aws.amazon.com/bedrock/latest/APIReference/API_agent-runtime_InvokeAgent.html) request. Valid values: `ENABLED`, `DISABLED`.
