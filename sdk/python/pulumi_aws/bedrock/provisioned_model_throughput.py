...
class ProvisionedModelThroughputArgs:
    ...
    def model_units(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @model_units.setter
    def model_units(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "model_units", value)

    @property
    @pulumi.getter(name="provisionedModelName")
    def provisioned_model_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def provisioned_model_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "provisioned_model_name", value)

    @property
    @pulumi.getter(name="commitmentDuration")
    def commitment_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def commitment_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProvisionedModelThroughputState:
    ...
    @property
    @pulumi.getter(name="modelArn")
    def model_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the model to associate with this Provisioned Throughput.
        """
        return pulumi.get(self, "model_arn")
    ...
    @model_arn.setter
    def model_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "model_arn", value)

    @property
    @pulumi.getter(name="modelUnits")
    def model_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of model units to allocate. A model unit delivers a specific throughput level for the specified model.
        """
        return pulumi.get(self, "model_units")
    ...
    @model_units.setter
    def model_units(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "model_units", value)

    @property
    @pulumi.getter(name="provisionedModelArn")
    def provisioned_model_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provisioned_model_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provisioned_model_arn", value)

    @property
    @pulumi.getter(name="provisionedModelName")
    def provisioned_model_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique name for this Provisioned Throughput.
        """
        return pulumi.get(self, "provisioned_model_name")
    ...
    @provisioned_model_name.setter
    def provisioned_model_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provisioned_model_name", value)
...
class ProvisionedModelThroughput(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="commitmentDuration")
    def commitment_duration(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Commitment duration requested for the Provisioned Throughput. For custom models, you can purchase on-demand Provisioned Throughput by omitting this argument. Valid values: `OneMonth`, `SixMonths`.
        """
        return pulumi.get(self, "commitment_duration")
    ...
    @property
    @pulumi.getter(name="modelArn")
    def model_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the model to associate with this Provisioned Throughput.
        """
        return pulumi.get(self, "model_arn")
    ...
    @property
    @pulumi.getter(name="modelUnits")
    def model_units(self) -> pulumi.Output[builtins.int]:
        """
        Number of model units to allocate. A model unit delivers a specific throughput level for the specified model.
        """
        return pulumi.get(self, "model_units")
    ...
    @property
    @pulumi.getter(name="provisionedModelArn")
    def provisioned_model_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the Provisioned Throughput.
        """
        return pulumi.get(self, "provisioned_model_arn")
    ...
    @property
    @pulumi.getter(name="provisionedModelName")
    def provisioned_model_name(self) -> pulumi.Output[builtins.str]:
        """
        Unique name for this Provisioned Throughput.
        """
        return pulumi.get(self, "provisioned_model_name")
