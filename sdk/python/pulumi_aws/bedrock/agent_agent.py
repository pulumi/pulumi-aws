...
class AgentAgentArgs:
    def __init__(__self__, *,
                 agent_name: pulumi.Input[builtins.str],
                 agent_resource_role_arn: pulumi.Input[builtins.str],
                 foundation_model: pulumi.Input[builtins.str],
                 agent_collaboration: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] agent_name: Name of the agent.
        :param pulumi.Input[builtins.str] agent_resource_role_arn: ARN of the IAM role with permissions to invoke API operations on the agent.
        :param pulumi.Input[builtins.str] foundation_model: Foundation model used for orchestration by the agent.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] agent_collaboration: Agents collaboration role. Valid values: `SUPERVISOR`, `SUPERVISOR_ROUTER`, `DISABLED`.
        :param pulumi.Input[builtins.str] customer_encryption_key_arn: ARN of the AWS KMS key that encrypts the agent.
    ...
    def agent_name(self) -> pulumi.Input[builtins.str]:
        """
        Name of the agent.
        """
    ...
    @agent_name.setter
    def agent_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "agent_name", value)

    @property
    @pulumi.getter(name="agentResourceRoleArn")
    def agent_resource_role_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def agent_resource_role_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "agent_resource_role_arn", value)

    @property
    @pulumi.getter(name="foundationModel")
    def foundation_model(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def foundation_model(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "foundation_model", value)

    @property
    @pulumi.getter(name="agentCollaboration")
    def agent_collaboration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def agent_collaboration(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AgentAgentState:
    def __init__(__self__, *,
                 agent_arn: Optional[pulumi.Input[builtins.str]] = None,
                 agent_collaboration: Optional[pulumi.Input[builtins.str]] = None,
                 agent_id: Optional[pulumi.Input[builtins.str]] = None,
                 agent_name: Optional[pulumi.Input[builtins.str]] = None,
                 agent_resource_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 agent_version: Optional[pulumi.Input[builtins.str]] = None,
                 customer_encryption_key_arn: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 foundation_model: Optional[pulumi.Input[builtins.str]] = None,
                 guardrail_configurations: Optional[pulumi.Input[Sequence[pulumi.Input['AgentAgentGuardrailConfigurationArgs']]]] = None,
                 idle_session_ttl_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 instruction: Optional[pulumi.Input[builtins.str]] = None,
                 memory_configurations: Optional[pulumi.Input[Sequence[pulumi.Input['AgentAgentMemoryConfigurationArgs']]]] = None,
        ...
        :param pulumi.Input[builtins.str] agent_arn: ARN of the agent.
        :param pulumi.Input[builtins.str] agent_collaboration: Agents collaboration role. Valid values: `SUPERVISOR`, `SUPERVISOR_ROUTER`, `DISABLED`.
        :param pulumi.Input[builtins.str] agent_id: Unique identifier of the agent.
        :param pulumi.Input[builtins.str] agent_name: Name of the agent.
        :param pulumi.Input[builtins.str] agent_resource_role_arn: ARN of the IAM role with permissions to invoke API operations on the agent.
        :param pulumi.Input[builtins.str] agent_version: Version of the agent.
        :param pulumi.Input[builtins.str] customer_encryption_key_arn: ARN of the AWS KMS key that encrypts the agent.
        :param pulumi.Input[builtins.str] description: Description of the agent.
        :param pulumi.Input[builtins.str] foundation_model: Foundation model used for orchestration by the agent.
    ...
    def agent_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the agent.
        """
    ...
    @agent_arn.setter
    def agent_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="agentResourceRoleArn")
    def agent_resource_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the IAM role with permissions to invoke API operations on the agent.
        """
        return pulumi.get(self, "agent_resource_role_arn")
    ...
    @agent_resource_role_arn.setter
    def agent_resource_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "agent_resource_role_arn", value)
    ...
    @property
    @pulumi.getter(name="foundationModel")
    def foundation_model(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Foundation model used for orchestration by the agent.
    ...
    @foundation_model.setter
    def foundation_model(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "foundation_model", value)
...
class AgentAgent(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="agentArn")
    def agent_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the agent.
        """
        return pulumi.get(self, "agent_arn")
    ...
    @property
    @pulumi.getter(name="agentCollaboration")
    def agent_collaboration(self) -> pulumi.Output[builtins.str]:
        """
        Agents collaboration role. Valid values: `SUPERVISOR`, `SUPERVISOR_ROUTER`, `DISABLED`.
        """
        return pulumi.get(self, "agent_collaboration")
    ...
    @property
    @pulumi.getter(name="agentName")
    def agent_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the agent.
        """
        return pulumi.get(self, "agent_name")
    ...
    @property
    @pulumi.getter(name="agentResourceRoleArn")
    def agent_resource_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the IAM role with permissions to invoke API operations on the agent.
        """
        return pulumi.get(self, "agent_resource_role_arn")
    ...
    @property
    @pulumi.getter(name="foundationModel")
    def foundation_model(self) -> pulumi.Output[builtins.str]:
        """
        Foundation model used for orchestration by the agent.
    ...
    @property
    @pulumi.getter(name="idleSessionTtlInSeconds")
    def idle_session_ttl_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        Number of seconds for which Amazon Bedrock keeps information about a user's conversation with the agent. A user interaction remains active for the amount of time specified. If no conversation occurs during this time, the session expires and Amazon Bedrock deletes any data provided before the timeout.
        """
        return pulumi.get(self, "idle_session_ttl_in_seconds")
