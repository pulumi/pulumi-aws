...
class DrtAccessLogBucketAssociationArgs:
    def __init__(__self__, *,
                 ...
                 role_arn_association_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] log_bucket: The Amazon S3 bucket that contains the logs that you want to share.
        :param pulumi.Input[builtins.str] role_arn_association_id: The ID of the Role Arn association used for allowing Shield DRT Access.
        """
    ...
    def role_arn_association_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def role_arn_association_id(self, value: pulumi.Input[builtins.str]):
...
class _DrtAccessLogBucketAssociationState:
    def __init__(__self__, *,
                 log_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 role_arn_association_id: Optional[pulumi.Input[builtins.str]] = None,
                 timeouts: Optional[pulumi.Input['DrtAccessLogBucketAssociationTimeoutsArgs']] = None):
        """
    ...
    @property
    @pulumi.getter(name="logBucket")
    def log_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon S3 bucket that contains the logs that you want to share.
        """
        return pulumi.get(self, "log_bucket")
    ...
    @log_bucket.setter
    def log_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_bucket", value)

    @property
    @pulumi.getter(name="roleArnAssociationId")
    def role_arn_association_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Role Arn association used for allowing Shield DRT Access.
        """
        return pulumi.get(self, "role_arn_association_id")
    ...
    @role_arn_association_id.setter
    def role_arn_association_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "role_arn_association_id", value)
...
class DrtAccessLogBucketAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="logBucket")
    def log_bucket(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon S3 bucket that contains the logs that you want to share.
        """
        return pulumi.get(self, "log_bucket")
    ...
    @property
    @pulumi.getter(name="roleArnAssociationId")
    def role_arn_association_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Role Arn association used for allowing Shield DRT Access.
        """
        return pulumi.get(self, "role_arn_association_id")
