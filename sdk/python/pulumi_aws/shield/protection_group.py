...
class ProtectionGroupArgs:
    def __init__(__self__, *,
                 ...
                 protection_group_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] aggregation: Defines how AWS Shield combines resource data for the group in order to detect, mitigate, and report events.
        :param pulumi.Input[builtins.str] pattern: The criteria to use to choose the protected resources for inclusion in the group.
        :param pulumi.Input[builtins.str] protection_group_id: The name of the protection group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] members: The Amazon Resource Names (ARNs) of the resources to include in the protection group. You must set this when you set `pattern` to ARBITRARY and you must not set it for any other `pattern` setting.
        :param pulumi.Input[builtins.str] resource_type: The resource type to include in the protection group. You must set this when you set `pattern` to BY_RESOURCE_TYPE and you must not set it for any other `pattern` setting.
    ...
    def protection_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def protection_group_id(self, value: pulumi.Input[builtins.str]):
...
class _ProtectionGroupState:
    def __init__(__self__, *,
                 ...
                 protection_group_arn: Optional[pulumi.Input[builtins.str]] = None,
                 protection_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 resource_type: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] members: The Amazon Resource Names (ARNs) of the resources to include in the protection group. You must set this when you set `pattern` to ARBITRARY and you must not set it for any other `pattern` setting.
        :param pulumi.Input[builtins.str] pattern: The criteria to use to choose the protected resources for inclusion in the group.
        :param pulumi.Input[builtins.str] protection_group_arn: The ARN (Amazon Resource Name) of the protection group.
        :param pulumi.Input[builtins.str] protection_group_id: The name of the protection group.
        :param pulumi.Input[builtins.str] resource_type: The resource type to include in the protection group. You must set this when you set `pattern` to BY_RESOURCE_TYPE and you must not set it for any other `pattern` setting.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value map of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    def protection_group_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def protection_group_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "protection_group_arn", value)

    @property
    @pulumi.getter(name="protectionGroupId")
    def protection_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the protection group.
        """
        return pulumi.get(self, "protection_group_id")
    ...
    @protection_group_id.setter
    def protection_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "protection_group_id", value)
...
class ProtectionGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            resource_type: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ProtectionGroup':
        """
    ...
    @property
    @pulumi.getter(name="protectionGroupArn")
    def protection_group_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN (Amazon Resource Name) of the protection group.
        """
        return pulumi.get(self, "protection_group_arn")
    ...
    @property
    @pulumi.getter(name="protectionGroupId")
    def protection_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The name of the protection group.
        """
        return pulumi.get(self, "protection_group_id")
