...
class DrtAccessRoleArnAssociation(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if timeouts is not None and not isinstance(timeouts, DrtAccessRoleArnAssociationTimeoutsArgs):
                timeouts = timeouts or {}
                def _setter(key, value):
                    timeouts[key] = value
                DrtAccessRoleArnAssociationTimeoutsArgs._configure(_setter, **timeouts)
