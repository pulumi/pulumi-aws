...
class ProtectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_arn: The ARN (Amazon Resource Name) of the resource to be protected.
        :param pulumi.Input[builtins.str] name: A friendly name for the Protection you are creating.
...
class _ProtectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the Protection.
        :param pulumi.Input[builtins.str] name: A friendly name for the Protection you are creating.
        :param pulumi.Input[builtins.str] resource_arn: The ARN (Amazon Resource Name) of the resource to be protected.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value map of resource tags. .If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
...
class Protection(pulumi.CustomResource):
    ...
    pulumi_type = "aws:shield/protection:Protection"
    ...
    def get(resource_name: str,
            ...
            resource_arn: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Protection':
        """
