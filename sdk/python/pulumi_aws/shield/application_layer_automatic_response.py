...
class ApplicationLayerAutomaticResponseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: One of `COUNT` or `BLOCK`
        :param pulumi.Input[builtins.str] resource_arn: ARN of the resource to protect (Cloudfront Distributions and ALBs only at this time).
        """
