...
class ProactiveEngagementEmergencyContact(dict):
    ...
    def __init__(__self__, *,
                 ...
                 contact_notes: Optional[builtins.str] = None,
                 phone_number: Optional[builtins.str] = None):
        """
        :param builtins.str email_address: A valid email address that will be used for this contact.
        :param builtins.str contact_notes: Additional notes regarding the contact.
        :param builtins.str phone_number: A phone number, starting with `+` and up to 15 digits that will be used for this contact.
        """
    ...
    def contact_notes(self) -> Optional[builtins.str]:
        """
