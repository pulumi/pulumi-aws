...
class ApplicationArgs:
    def __init__(__self__, *,
                 runtime_environment: pulumi.Input[builtins.str],
                 service_execution_role: pulumi.Input[builtins.str],
                 application_configuration: Optional[pulumi.Input['ApplicationApplicationConfigurationArgs']] = None,
                 application_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] application_mode: The application's mode. Valid values are `STREAMING`, `INTERACTIVE`.
    ...
    def runtime_environment(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def runtime_environment(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "runtime_environment", value)

    @property
    @pulumi.getter(name="serviceExecutionRole")
    def service_execution_role(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def service_execution_role(self, value: pulumi.Input[builtins.str]):
    ...
    def application_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ApplicationState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 runtime_environment: Optional[pulumi.Input[builtins.str]] = None,
                 service_execution_role: Optional[pulumi.Input[builtins.str]] = None,
                 start_application: Optional[pulumi.Input[builtins.bool]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 version_id: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering Application resources.
        :param pulumi.Input['ApplicationApplicationConfigurationArgs'] application_configuration: The application's configuration
        :param pulumi.Input[builtins.str] application_mode: The application's mode. Valid values are `STREAMING`, `INTERACTIVE`.
        :param pulumi.Input[builtins.str] arn: The ARN of the application.
        :param pulumi.Input['ApplicationCloudwatchLoggingOptionsArgs'] cloudwatch_logging_options: A CloudWatch log stream to monitor application configuration errors.
        :param pulumi.Input[builtins.str] create_timestamp: The current timestamp when the application was created.
        :param pulumi.Input[builtins.str] description: A summary description of the application.
        :param pulumi.Input[builtins.bool] force_stop: Whether to force stop an unresponsive Flink-based application.
        ...
        :param pulumi.Input[builtins.int] version_id: The current application version. Kinesis Data Analytics updates the `version_id` each time the application is updated.
        """
        if application_configuration is not None:
            pulumi.set(__self__, "application_configuration", application_configuration)
        if application_mode is not None:
    ...
    @property
    @pulumi.getter(name="runtimeEnvironment")
    def runtime_environment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The runtime environment for the application. Valid values: `SQL-1_0`, `FLINK-1_6`, `FLINK-1_8`, `FLINK-1_11`, `FLINK-1_13`, `FLINK-1_15`, `FLINK-1_18`, `FLINK-1_19`.
        """
        return pulumi.get(self, "runtime_environment")
    ...
    @runtime_environment.setter
    def runtime_environment(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "runtime_environment", value)

    @property
    @pulumi.getter(name="serviceExecutionRole")
    def service_execution_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the IAM role used by the application to access Kinesis data streams, Kinesis Data Firehose delivery streams, Amazon S3 objects, and other external resources.
        """
        return pulumi.get(self, "service_execution_role")
    ...
    @service_execution_role.setter
    def service_execution_role(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_execution_role", value)
    ...
    def version_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @version_id.setter
    def version_id(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Application(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            version_id: Optional[pulumi.Input[builtins.int]] = None) -> 'Application':
        """
    ...
    @property
    @pulumi.getter(name="applicationMode")
    def application_mode(self) -> pulumi.Output[builtins.str]:
        """
        The application's mode. Valid values are `STREAMING`, `INTERACTIVE`.
        """
        return pulumi.get(self, "application_mode")
    ...
    @property
    @pulumi.getter(name="runtimeEnvironment")
    def runtime_environment(self) -> pulumi.Output[builtins.str]:
        """
        The runtime environment for the application. Valid values: `SQL-1_0`, `FLINK-1_6`, `FLINK-1_8`, `FLINK-1_11`, `FLINK-1_13`, `FLINK-1_15`, `FLINK-1_18`, `FLINK-1_19`.
        """
        return pulumi.get(self, "runtime_environment")
    ...
    @property
    @pulumi.getter(name="serviceExecutionRole")
    def service_execution_role(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the IAM role used by the application to access Kinesis data streams, Kinesis Data Firehose delivery streams, Amazon S3 objects, and other external resources.
        """
        return pulumi.get(self, "service_execution_role")
    ...
    @property
    @pulumi.getter(name="versionId")
    def version_id(self) -> pulumi.Output[builtins.int]:
        """
        The current application version. Kinesis Data Analytics updates the `version_id` each time the application is updated.
        """
        return pulumi.get(self, "version_id")
