...
class ApplicationApplicationConfigurationApplicationCodeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str code_content_type: Specifies whether the code content is in text or zip format. Valid values: `PLAINTEXT`, `ZIPFILE`.
...
class ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContent(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str text_content: The text-format code for the application.
        """
...
class ApplicationApplicationConfigurationApplicationCodeConfigurationCodeContentS3ContentLocation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket_arn: The ARN for the S3 bucket containing the application code.
...
class ApplicationApplicationConfigurationEnvironmentPropertiesPropertyGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 property_map: Mapping[str, builtins.str]):
        """
        :param builtins.str property_group_id: The key of the application execution property key-value map.
        :param Mapping[str, builtins.str] property_map: Application execution property key-value map.
        """
    ...
    def property_map(self) -> Mapping[str, builtins.str]:
        """
...
class ApplicationApplicationConfigurationFlinkApplicationConfigurationCheckpointConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str configuration_type: Describes whether the application uses Kinesis Data Analytics' default checkpointing behavior. Valid values: `CUSTOM`, `DEFAULT`. Set this attribute to `CUSTOM` in order for any specified `checkpointing_enabled`, `checkpoint_interval`, or `min_pause_between_checkpoints` attribute values to be effective. If this attribute is set to `DEFAULT`, the application will always use the following values:
        ...
        :param builtins.int min_pause_between_checkpoints: Describes the minimum time in milliseconds after a checkpoint operation completes that a new checkpoint operation can start.
        """
...
class ApplicationApplicationConfigurationFlinkApplicationConfigurationMonitoringConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 metrics_level: Optional[builtins.str] = None):
        """
        :param builtins.str configuration_type: Describes whether to use the default CloudWatch logging configuration for an application. Valid values: `CUSTOM`, `DEFAULT`. Set this attribute to `CUSTOM` in order for any specified `log_level` or `metrics_level` attribute values to be effective.
        :param builtins.str log_level: Describes the verbosity of the CloudWatch Logs for an application. Valid values: `DEBUG`, `ERROR`, `INFO`, `WARN`.
        :param builtins.str metrics_level: Describes the granularity of the CloudWatch Logs for an application. Valid values: `APPLICATION`, `OPERATOR`, `PARALLELISM`, `TASK`.
        """
        pulumi.set(__self__, "configuration_type", configuration_type)
    ...
    def metrics_level(self) -> Optional[builtins.str]:
        """
...
class ApplicationApplicationConfigurationFlinkApplicationConfigurationParallelismConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int parallelism: Describes the initial number of parallel tasks that a Flink-based Kinesis Data Analytics application can perform.
        :param builtins.int parallelism_per_kpu: Describes the number of parallel tasks that a Flink-based Kinesis Data Analytics application can perform per Kinesis Processing Unit (KPU) used by the application.
        """
        pulumi.set(__self__, "configuration_type", configuration_type)
...
class ApplicationApplicationConfigurationRunConfigurationApplicationRestoreConfiguration(dict):
    ...
    def __init__(__self__, *,
                 application_restore_type: Optional[builtins.str] = None,
                 snapshot_name: Optional[builtins.str] = None):
        """
        :param builtins.str application_restore_type: Specifies how the application should be restored. Valid values: `RESTORE_FROM_CUSTOM_SNAPSHOT`, `RESTORE_FROM_LATEST_SNAPSHOT`, `SKIP_RESTORE_FROM_SNAPSHOT`.
        :param builtins.str snapshot_name: The identifier of an existing snapshot of application state to use to restart an application. The application uses this value if `RESTORE_FROM_CUSTOM_SNAPSHOT` is specified for `application_restore_type`.
        """
    ...
    def application_restore_type(self) -> Optional[builtins.str]:
        """
...
class ApplicationApplicationConfigurationRunConfigurationFlinkRunConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool allow_non_restored_state: When restoring from a snapshot, specifies whether the runtime is allowed to skip a state that cannot be mapped to the new program. Default is `false`.
        """
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 in_app_stream_names: Optional[Sequence[builtins.str]] = None,
                 input_id: Optional[builtins.str] = None,
    ...
    def in_app_stream_names(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "in_app_stream_names")

    @property
    @pulumi.getter(name="inputId")
    def input_id(self) -> Optional[builtins.str]:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputProcessingConfigurationInputLambdaProcessor(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_arn: The ARN of the Lambda function that operates on records in the stream.
        """
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchema(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str record_encoding: Specifies the encoding of the records in the streaming source. For example, `UTF-8`.
        """
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputSchemaRecordFormat(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str record_format_type: The type of record format. Valid values: `CSV`, `JSON`.
        """
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInputInputStartingPositionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 input_starting_position: Optional[builtins.str] = None):
        """
        :param builtins.str input_starting_position: The starting position on the stream. Valid values: `LAST_STOPPED_POINT`, `NOW`, `TRIM_HORIZON`.
        """
    ...
    def input_starting_position(self) -> Optional[builtins.str]:
        """
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationInputKinesisFirehoseInput(dict):
    ...
    def __init__(__self__, *,
                 resource_arn: builtins.str):
        """
        :param builtins.str resource_arn: The ARN of the delivery stream.
        """
        pulumi.set(__self__, "resource_arn", resource_arn)
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationOutput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 output_id: Optional[builtins.str] = None):
        """
    ...
    def output_id(self) -> Optional[builtins.str]:
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationOutputDestinationSchema(dict):
    ...
    def __init__(__self__, *,
                 record_format_type: builtins.str):
        """
        :param builtins.str record_format_type: Specifies the format of the records on the output stream. Valid values: `CSV`, `JSON`.
        """
        pulumi.set(__self__, "record_format_type", record_format_type)
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationOutputKinesisFirehoseOutput(dict):
    ...
    def __init__(__self__, *,
                 resource_arn: builtins.str):
        """
        :param builtins.str resource_arn: The ARN of the destination delivery stream to write to.
        """
        pulumi.set(__self__, "resource_arn", resource_arn)
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationOutputKinesisStreamsOutput(dict):
    ...
    def __init__(__self__, *,
                 resource_arn: builtins.str):
        """
        :param builtins.str resource_arn: The ARN of the destination Kinesis data stream to write to.
        """
        pulumi.set(__self__, "resource_arn", resource_arn)
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationOutputLambdaOutput(dict):
    ...
    def __init__(__self__, *,
                 resource_arn: builtins.str):
        """
        :param builtins.str resource_arn: The ARN of the destination Lambda function to write to.
        """
        pulumi.set(__self__, "resource_arn", resource_arn)
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str table_name: The name of the in-application table to create.
        """
...
class ApplicationApplicationConfigurationSqlApplicationConfigurationReferenceDataSourceS3ReferenceDataSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str file_key: The object key name containing the reference data.
        """
        pulumi.set(__self__, "bucket_arn", bucket_arn)
        pulumi.set(__self__, "file_key", file_key)
...
class ApplicationApplicationConfigurationVpcConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vpc_configuration_id: Optional[builtins.str] = None,
                 vpc_id: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] security_group_ids: The Security Group IDs used by the VPC configuration.
        :param Sequence[builtins.str] subnet_ids: The Subnet IDs used by the VPC configuration.
        """
    ...
    def vpc_configuration_id(self) -> Optional[builtins.str]:
...
class ApplicationCloudwatchLoggingOptions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cloudwatch_logging_option_id: Optional[builtins.str] = None):
        """
        :param builtins.str log_stream_arn: The ARN of the CloudWatch log stream to receive application messages.
        """
    ...
    def cloudwatch_logging_option_id(self) -> Optional[builtins.str]:
