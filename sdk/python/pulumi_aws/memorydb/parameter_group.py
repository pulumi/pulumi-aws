...
class ParameterGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] family: The engine version that the parameter group can be used with.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] description: Description for the parameter group. Defaults to `"Managed by Pulumi"`.
        :param pulumi.Input[builtins.str] name: Name of the parameter group. If omitted, the provider will assign a random, unique name. Conflicts with `name_prefix`.
...
class _ParameterGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the parameter group.
        :param pulumi.Input[builtins.str] description: Description for the parameter group. Defaults to `"Managed by Pulumi"`.
        :param pulumi.Input[builtins.str] family: The engine version that the parameter group can be used with.
