...
__all__ = [
    'GetBrokerInstanceTypeOfferingsResult',
    'AwaitableGetBrokerInstanceTypeOfferingsResult',
    'get_broker_instance_type_offerings',
    'get_broker_instance_type_offerings_output',
]

@pulumi.output_type
class GetBrokerInstanceTypeOfferingsResult:
    """
    ...
    def broker_instance_options(self) -> Sequence['outputs.GetBrokerInstanceTypeOfferingsBrokerInstanceOptionResult']:
        """
...
class AwaitableGetBrokerInstanceTypeOfferingsResult(GetBrokerInstanceTypeOfferingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetBrokerInstanceTypeOfferingsResult(
...
def get_broker_instance_type_offerings(engine_type: Optional[str] = None,
                                       host_instance_type: Optional[str] = None,
                                       storage_type: Optional[str] = None,
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBrokerInstanceTypeOfferingsResult:
    """
    ...
    empty = aws.memorydb.get_broker_instance_type_offerings()
    engine = aws.memorydb.get_broker_instance_type_offerings(engine_type="ACTIVEMQ")
    storage = aws.memorydb.get_broker_instance_type_offerings(storage_type="EBS")
    instance = aws.memorydb.get_broker_instance_type_offerings(host_instance_type="mq.m5.large")
    all = aws.memorydb.get_broker_instance_type_offerings(engine_type="ACTIVEMQ",
    ...
    __ret__ = pulumi.runtime.invoke('aws:memorydb/getBrokerInstanceTypeOfferings:getBrokerInstanceTypeOfferings', __args__, opts=opts, typ=GetBrokerInstanceTypeOfferingsResult).value

    return AwaitableGetBrokerInstanceTypeOfferingsResult(
...
@_utilities.lift_output_func(get_broker_instance_type_offerings)
def get_broker_instance_type_offerings_output(engine_type: Optional[pulumi.Input[Optional[str]]] = None,
                                              host_instance_type: Optional[pulumi.Input[Optional[str]]] = None,
                                              storage_type: Optional[pulumi.Input[Optional[str]]] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetBrokerInstanceTypeOfferingsResult]:
    """
    Provides information about a MQ Broker Instance Offerings.
