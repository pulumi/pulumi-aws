...
class MultiRegionClusterArgs:
    def __init__(__self__, *,
                 multi_region_cluster_name_suffix: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] multi_region_cluster_name_suffix: A suffix to be added to the multi-region cluster name. An AWS generated prefix is automatically applied to the multi-region cluster name when it is created.
        :param pulumi.Input[builtins.str] node_type: The node type to be used for the multi-region cluster.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] description: description for the multi-region cluster.
        :param pulumi.Input[builtins.str] engine: The name of the engine to be used for the multi-region cluster. Valid values are `redis` and `valkey`.
    ...
    def multi_region_cluster_name_suffix(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def multi_region_cluster_name_suffix(self, value: pulumi.Input[builtins.str]):
...
class _MultiRegionClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the multi-region cluster.
        :param pulumi.Input[builtins.str] description: description for the multi-region cluster.
        :param pulumi.Input[builtins.str] engine: The name of the engine to be used for the multi-region cluster. Valid values are `redis` and `valkey`.
        :param pulumi.Input[builtins.str] engine_version: The version of the engine to be used for the multi-region cluster. Downgrades are not supported.
        :param pulumi.Input[builtins.str] multi_region_cluster_name: The name of the multi-region cluster.
        :param pulumi.Input[builtins.str] multi_region_cluster_name_suffix: A suffix to be added to the multi-region cluster name. An AWS generated prefix is automatically applied to the multi-region cluster name when it is created.
        :param pulumi.Input[builtins.str] multi_region_parameter_group_name: The name of the multi-region parameter group to be associated with the cluster.
        :param pulumi.Input[builtins.str] node_type: The node type to be used for the multi-region cluster.
...
class MultiRegionCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timeouts: Optional[pulumi.Input[Union['MultiRegionClusterTimeoutsArgs', 'MultiRegionClusterTimeoutsArgsDict']]] = None,
            tls_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            update_strategy: Optional[pulumi.Input[builtins.str]] = None) -> 'MultiRegionCluster':
        """
    ...
    @property
    @pulumi.getter(name="multiRegionClusterNameSuffix")
    def multi_region_cluster_name_suffix(self) -> pulumi.Output[builtins.str]:
        """
        A suffix to be added to the multi-region cluster name. An AWS generated prefix is automatically applied to the multi-region cluster name when it is created.
        """
        return pulumi.get(self, "multi_region_cluster_name_suffix")
    ...
    @property
    @pulumi.getter(name="multiRegionParameterGroupName")
    def multi_region_parameter_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the multi-region parameter group to be associated with the cluster.
        """
        return pulumi.get(self, "multi_region_parameter_group_name")
