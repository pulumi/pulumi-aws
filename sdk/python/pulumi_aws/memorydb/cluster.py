...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 data_tiering: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] node_type: The compute and memory capacity of the nodes in the cluster. See AWS documentation on [supported node types](https://docs.aws.amazon.com/memorydb/latest/devguide/nodes.supportedtypes.html) as well as [vertical scaling](https://docs.aws.amazon.com/memorydb/latest/devguide/cluster-vertical-scaling.html).
               
               The following arguments are optional:
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: When set to `true`, the cluster will automatically receive minor engine version upgrades after launch. Defaults to `true`.
        :param pulumi.Input[builtins.bool] data_tiering: Enables data tiering. This option is not supported by all instance types. For more information, see [Data tiering](https://docs.aws.amazon.com/memorydb/latest/devguide/data-tiering.html).
        :param pulumi.Input[builtins.str] description: Description for the cluster. Defaults to `"Managed by Pulumi"`.
        :param pulumi.Input[builtins.str] engine: The engine that will run on your nodes. Supported values are `redis` and `valkey`.
        :param pulumi.Input[builtins.str] engine_version: Version number of the engine to be used for the cluster. Downgrades are not supported.
        :param pulumi.Input[builtins.str] final_snapshot_name: Name of the final cluster snapshot to be created when this resource is deleted. If omitted, no final snapshot will be made.
        :param pulumi.Input[builtins.str] kms_key_arn: ARN of the KMS key used to encrypt the cluster at rest.
        :param pulumi.Input[builtins.str] maintenance_window: Specifies the weekly time range during which maintenance on the cluster is performed. Specify as a range in the format `ddd:hh24:mi-ddd:hh24:mi` (24H Clock UTC). The minimum maintenance window is a 60 minute period. Example: `sun:23:00-mon:01:30`.
        :param pulumi.Input[builtins.str] multi_region_cluster_name: The multi region cluster identifier specified on `memorydb.MultiRegionCluster`.
        ...
        :param pulumi.Input[builtins.int] num_replicas_per_shard: The number of replicas to apply to each shard, up to a maximum of 5. Defaults to `1` (i.e. 2 nodes per shard).
        ...
        :param pulumi.Input[builtins.int] snapshot_retention_limit: The number of days for which MemoryDB retains automatic snapshots before deleting them. When set to `0`, automatic backups are disabled. Defaults to `0`.
        :param pulumi.Input[builtins.str] snapshot_window: The daily time range (in UTC) during which MemoryDB begins taking a daily snapshot of your shard. Example: `05:00-09:00`.
        :param pulumi.Input[builtins.str] sns_topic_arn: ARN of the SNS topic to which cluster notifications are sent.
        :param pulumi.Input[builtins.str] subnet_group_name: The name of the subnet group to be used for the cluster. Defaults to a subnet group consisting of default VPC subnets.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the resource. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[builtins.bool] tls_enabled: A flag to enable in-transit encryption on the cluster. When set to `false`, the `acl_name` must be `open-access`. Defaults to `true`.
        """
    ...
    def data_tiering(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @data_tiering.setter
    def data_tiering(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 engine: Optional[pulumi.Input[builtins.str]] = None,
                 engine_patch_version: Optional[pulumi.Input[builtins.str]] = None,
                 engine_version: Optional[pulumi.Input[builtins.str]] = None,
                 final_snapshot_name: Optional[pulumi.Input[builtins.str]] = None,
                 kms_key_arn: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_window: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] acl_name: The name of the Access Control List to associate with the cluster.
        :param pulumi.Input[builtins.str] arn: The ARN of the cluster.
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: When set to `true`, the cluster will automatically receive minor engine version upgrades after launch. Defaults to `true`.
        :param pulumi.Input[builtins.bool] data_tiering: Enables data tiering. This option is not supported by all instance types. For more information, see [Data tiering](https://docs.aws.amazon.com/memorydb/latest/devguide/data-tiering.html).
        :param pulumi.Input[builtins.str] description: Description for the cluster. Defaults to `"Managed by Pulumi"`.
        :param pulumi.Input[builtins.str] engine: The engine that will run on your nodes. Supported values are `redis` and `valkey`.
        :param pulumi.Input[builtins.str] engine_patch_version: Patch version number of the engine used by the cluster.
        :param pulumi.Input[builtins.str] engine_version: Version number of the engine to be used for the cluster. Downgrades are not supported.
        :param pulumi.Input[builtins.str] final_snapshot_name: Name of the final cluster snapshot to be created when this resource is deleted. If omitted, no final snapshot will be made.
        :param pulumi.Input[builtins.str] kms_key_arn: ARN of the KMS key used to encrypt the cluster at rest.
        :param pulumi.Input[builtins.str] maintenance_window: Specifies the weekly time range during which maintenance on the cluster is performed. Specify as a range in the format `ddd:hh24:mi-ddd:hh24:mi` (24H Clock UTC). The minimum maintenance window is a 60 minute period. Example: `sun:23:00-mon:01:30`.
    ...
    def engine_patch_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def engine_patch_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tls_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'Cluster':
        """
    ...
    @property
    @pulumi.getter(name="dataTiering")
    def data_tiering(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enables data tiering. This option is not supported by all instance types. For more information, see [Data tiering](https://docs.aws.amazon.com/memorydb/latest/devguide/data-tiering.html).
        """
        return pulumi.get(self, "data_tiering")
    ...
    @property
    @pulumi.getter(name="enginePatchVersion")
    def engine_patch_version(self) -> pulumi.Output[builtins.str]:
        """
        Patch version number of the engine used by the cluster.
        """
        return pulumi.get(self, "engine_patch_version")
