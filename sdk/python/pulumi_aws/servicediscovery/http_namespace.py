...
class HttpNamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: The description that you specify for the namespace when you create it.
        :param pulumi.Input[builtins.str] name: The name of the http namespace.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the namespace. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
...
class _HttpNamespaceState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 http_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering HttpNamespace resources.
        :param pulumi.Input[builtins.str] arn: The ARN that Amazon Route 53 assigns to the namespace when you create it.
        :param pulumi.Input[builtins.str] description: The description that you specify for the namespace when you create it.
        :param pulumi.Input[builtins.str] http_name: The name of an HTTP namespace.
        :param pulumi.Input[builtins.str] name: The name of the http namespace.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the namespace. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    def http_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @http_name.setter
    def http_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HttpNamespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'HttpNamespace':
        """
    ...
    @property
    @pulumi.getter(name="httpName")
    def http_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of an HTTP namespace.
        """
        return pulumi.get(self, "http_name")
