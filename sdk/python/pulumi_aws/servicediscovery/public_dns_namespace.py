...
class _PublicDnsNamespaceState:
    def __init__(__self__, *,
        ...
        """
        _PublicDnsNamespaceState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            arn=arn,
            description=description,
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if hosted_zone is None and 'hostedZone' in kwargs:
            hosted_zone = kwargs['hostedZone']
        ...
        if hosted_zone is not None:
            _setter("hosted_zone", hosted_zone)
        if name is not None:
            _setter("name", name)
        if tags is not None:
            _setter("tags", tags)
...
class PublicDnsNamespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None) -> 'PublicDnsNamespace':
        """
