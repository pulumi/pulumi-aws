...
if not MYPY:
    class ServiceDnsConfigArgsDict(TypedDict):
        ...
        """
        routing_policy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceDnsConfigArgs:
    def __init__(__self__, *,
                 ...
                 namespace_id: pulumi.Input[builtins.str],
                 routing_policy: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] namespace_id: The ID of the namespace to use for DNS configuration.
        :param pulumi.Input[builtins.str] routing_policy: The routing policy that you want to apply to all records that Route 53 creates when you register an instance and specify the service. Valid Values: MULTIVALUE, WEIGHTED
        """
    ...
    def routing_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The routing policy that you want to apply to all records that Route 53 creates when you register an instance and specify the service. Valid Values: MULTIVALUE, WEIGHTED
        """
    ...
    def routing_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceDnsConfigDnsRecordArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] ttl: The amount of time, in seconds, that you want DNS resolvers to cache the settings for this resource record set.
        :param pulumi.Input[builtins.str] type: The type of the resource, which indicates the value that Amazon Route 53 returns in response to DNS queries. Valid Values: A, AAAA, SRV, CNAME
        """
...
class ServiceHealthCheckConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] failure_threshold: The number of consecutive health checks. Maximum value of 10.
        :param pulumi.Input[builtins.str] resource_path: The path that you want Route 53 to request when performing health checks. Route 53 automatically adds the DNS name for the service. If you don't specify a value, the default value is /.
        :param pulumi.Input[builtins.str] type: The type of health check that you want to create, which indicates how Route 53 determines whether an endpoint is healthy. Valid Values: HTTP, HTTPS, TCP
        """
