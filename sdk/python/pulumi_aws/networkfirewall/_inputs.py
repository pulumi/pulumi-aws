...
class FirewallEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of AWS KMS key to use for encryption of your Network Firewall resources. Valid values are `CUSTOMER_KMS` and `AWS_OWNED_KMS_KEY`.
        :param pulumi.Input[builtins.str] key_id: The ID of the customer managed key. You can use any of the [key identifiers](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id) that KMS supports, unless you're using a key that's managed by another account. If you're using a key managed by another account, then specify the key ARN.
        """
...
class FirewallFirewallStatusSyncStateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone: The Availability Zone where the subnet is configured.
        """
...
class FirewallFirewallStatusSyncStateAttachmentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] endpoint_id: The identifier of the firewall endpoint that AWS Network Firewall has instantiated in the subnet. You use this to identify the firewall endpoint in the VPC route tables, when you redirect the VPC traffic through the endpoint.
        :param pulumi.Input[builtins.str] subnet_id: The unique identifier of the subnet that you've specified to be used for a firewall endpoint.
        """
...
if not MYPY:
    class FirewallPolicyFirewallPolicyArgsDict(TypedDict):
        stateless_default_actions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        Set of actions to take on a packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: `aws:drop`, `aws:pass`, or `aws:forward_to_sfe`.
        In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify `aws:forward_to_sfe`.
        """
        stateless_fragment_default_actions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        stateful_default_actions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        tls_inspection_configuration_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FirewallPolicyFirewallPolicyArgs:
    def __init__(__self__, *,
                 ...
                 stateful_default_actions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 tls_inspection_configuration_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stateless_default_actions: Set of actions to take on a packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: `aws:drop`, `aws:pass`, or `aws:forward_to_sfe`.
               In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify `aws:forward_to_sfe`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stateless_fragment_default_actions: Set of actions to take on a fragmented packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: `aws:drop`, `aws:pass`, or `aws:forward_to_sfe`.
               In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify `aws:forward_to_sfe`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] stateful_default_actions: Set of actions to take on a packet if it does not match any stateful rules in the policy. This can only be specified if the policy has a `stateful_engine_options` block with a `rule_order` value of `STRICT_ORDER`. You can specify one of either or neither values of `aws:drop_strict` or `aws:drop_established`, as well as any combination of `aws:alert_strict` and `aws:alert_established`.
    ...
    def stateless_default_actions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Set of actions to take on a packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: `aws:drop`, `aws:pass`, or `aws:forward_to_sfe`.
        In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify `aws:forward_to_sfe`.
        """
    ...
    def stateless_default_actions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "stateless_default_actions", value)

    @property
    @pulumi.getter(name="statelessFragmentDefaultActions")
    def stateless_fragment_default_actions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Set of actions to take on a fragmented packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: `aws:drop`, `aws:pass`, or `aws:forward_to_sfe`.
        In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify `aws:forward_to_sfe`.
        """
    ...
    def stateless_fragment_default_actions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def stateful_default_actions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of actions to take on a packet if it does not match any stateful rules in the policy. This can only be specified if the policy has a `stateful_engine_options` block with a `rule_order` value of `STRICT_ORDER`. You can specify one of either or neither values of `aws:drop_strict` or `aws:drop_established`, as well as any combination of `aws:alert_strict` and `aws:alert_established`.
        """
    ...
    def stateful_default_actions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def tls_inspection_configuration_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The (ARN) of the TLS Inspection policy to attach to the FW Policy.  This must be added at creation of the resource per AWS documentation. "You can only add a TLS inspection configuration to a new policy, not to an existing policy."  This cannot be removed from a FW Policy.
        """
    ...
    def tls_inspection_configuration_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key: An alphanumeric string to identify the `ip_set`. Valid values: `HOME_NET`
        """
...
class FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableIpSetArgs:
    def __init__(__self__, *,
                 definitions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] definitions: Set of IPv4 or IPv6 addresses in CIDR notation to use for the Suricata `HOME_NET` variable.
        """
...
if not MYPY:
    class FirewallPolicyFirewallPolicyStatefulEngineOptionsArgsDict(TypedDict):
        ...
        """
        stream_exception_policy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FirewallPolicyFirewallPolicyStatefulEngineOptionsArgs:
    def __init__(__self__, *,
                 ...
                 stream_exception_policy: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] rule_order: Indicates how to manage the order of stateful rule evaluation for the policy. Default value: `DEFAULT_ACTION_ORDER`. Valid values: `DEFAULT_ACTION_ORDER`, `STRICT_ORDER`.
        :param pulumi.Input[builtins.str] stream_exception_policy: Describes how to treat traffic which has broken midstream. Default value: `DROP`. Valid values: `DROP`, `CONTINUE`, `REJECT`.
        """
    ...
    def stream_exception_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Describes how to treat traffic which has broken midstream. Default value: `DROP`. Valid values: `DROP`, `CONTINUE`, `REJECT`.
        """
    ...
    def stream_exception_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeoutsArgsDict(TypedDict):
        tcp_idle_timeout_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeoutsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] tcp_idle_timeout_seconds: Number of seconds that can pass without any TCP traffic sent through the firewall before the firewall determines that the connection is idle. After the idle timeout passes, data packets are dropped, however, the next TCP SYN packet is considered a new flow and is processed by the firewall. Clients or targets can use TCP keepalive packets to reset the idle timeout. Default value: `350`.
        """
...
class FirewallPolicyFirewallPolicyStatefulRuleGroupReferenceOverrideArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The action that changes the rule group from DROP to ALERT . This only applies to managed rule groups.
        """
...
class FirewallPolicyFirewallPolicyStatelessCustomActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action_name: A friendly name of the custom action.
        """
...
class FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionPublishMetricActionDimensionArgs:
    def __init__(__self__, *,
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] value: The string value to use in the custom metric dimension.
        """
...
class FirewallPolicyFirewallPolicyStatelessRuleGroupReferenceArgs:
    def __init__(__self__, *,
                 ...
                 resource_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.int] priority: An integer setting that indicates the order in which to run the stateless rule groups in a single policy. AWS Network Firewall applies each stateless rule group to a packet starting with the group that has the lowest priority setting.
...
if not MYPY:
    class LoggingConfigurationLoggingConfigurationLogDestinationConfigArgsDict(TypedDict):
        log_destination: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]
        """
        ...
        * For a Kinesis Data Firehose delivery stream, specify the key `deliveryStream` with the name of the delivery stream.
        """
        log_destination_type: pulumi.Input[builtins.str]
        """
...
class LoggingConfigurationLoggingConfigurationLogDestinationConfigArgs:
    def __init__(__self__, *,
                 ...
                 log_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] log_destination: A map describing the logging destination for the chosen `log_destination_type`.
               * For an Amazon S3 bucket, specify the key `bucketName` with the name of the bucket and optionally specify the key `prefix` with a path (Do not add a leading / in the `prefix` as the configuration will have two // when applied).
               * For a CloudWatch log group, specify the key `logGroup` with the name of the CloudWatch log group.
               * For a Kinesis Data Firehose delivery stream, specify the key `deliveryStream` with the name of the delivery stream.
        :param pulumi.Input[builtins.str] log_destination_type: The location to send logs to. Valid values: `S3`, `CloudWatchLogs`, `KinesisDataFirehose`.
        :param pulumi.Input[builtins.str] log_type: The type of log to send. Valid values: `ALERT` or `FLOW` or `TLS`. Alert logs report traffic that matches a `StatefulRule` with an action setting that sends a log message. Flow logs are standard network traffic flow logs.
        """
    ...
    def log_destination(self) -> pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]:
        """
        A map describing the logging destination for the chosen `log_destination_type`.
        * For an Amazon S3 bucket, specify the key `bucketName` with the name of the bucket and optionally specify the key `prefix` with a path (Do not add a leading / in the `prefix` as the configuration will have two // when applied).
        * For a CloudWatch log group, specify the key `logGroup` with the name of the CloudWatch log group.
    ...
    def log_destination(self, value: pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]):
        pulumi.set(self, "log_destination", value)

    @property
    @pulumi.getter(name="logDestinationType")
    def log_destination_type(self) -> pulumi.Input[builtins.str]:
        """
        The location to send logs to. Valid values: `S3`, `CloudWatchLogs`, `KinesisDataFirehose`.
        """
    ...
    def log_destination_type(self, value: pulumi.Input[builtins.str]):
...
class RuleGroupRuleGroupReferenceSetsIpSetReferenceIpSetReferenceArgs:
    def __init__(__self__, *,
                 reference_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] reference_arn: Set of Managed Prefix IP ARN(s)
        """
...
class RuleGroupRuleGroupRuleVariablesIpSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key: A unique alphanumeric string to identify the `ip_set`.
        """
        pulumi.set(__self__, "ip_set", ip_set)
        pulumi.set(__self__, "key", key)
...
class RuleGroupRuleGroupRuleVariablesIpSetIpSetArgs:
    def __init__(__self__, *,
                 definitions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] definitions: Set of IP addresses and address ranges, in CIDR notation.
        """
        pulumi.set(__self__, "definitions", definitions)
...
class RuleGroupRuleGroupRuleVariablesPortSetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: An unique alphanumeric string to identify the `port_set`.
...
class RuleGroupRuleGroupRuleVariablesPortSetPortSetArgs:
    def __init__(__self__, *,
                 definitions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] definitions: Set of port ranges.
        """
        pulumi.set(__self__, "definitions", definitions)
...
class RuleGroupRuleGroupRulesSourceArgs:
    def __init__(__self__, *,
                 ...
                 rules_string: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @rules_string.setter
    def rules_string(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class RuleGroupRuleGroupRulesSourceRulesSourceListArgsDict(TypedDict):
        generated_rules_type: pulumi.Input[builtins.str]
        """
...
class RuleGroupRuleGroupRulesSourceRulesSourceListArgs:
    def __init__(__self__, *,
                 ...
                 targets: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] generated_rules_type: String value to specify whether domains in the target list are allowed or denied access. Valid values: `ALLOWLIST`, `DENYLIST`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_types: Set of types of domain specifications that are provided in the `targets` argument. Valid values: `HTTP_HOST`, `TLS_SNI`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] targets: Set of domains that you want to inspect for in your traffic flows.
        """
    ...
    def generated_rules_type(self) -> pulumi.Input[builtins.str]:
        """
        String value to specify whether domains in the target list are allowed or denied access. Valid values: `ALLOWLIST`, `DENYLIST`.
        """
    ...
    def generated_rules_type(self, value: pulumi.Input[builtins.str]):
...
class RuleGroupRuleGroupRulesSourceStatefulRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: Action to take with packets in a traffic flow when the flow matches the stateful rule criteria. For all actions, AWS Network Firewall performs the specified action and discontinues stateful inspection of the traffic flow. Valid values: `ALERT`, `DROP`, `PASS`, or `REJECT`.
...
if not MYPY:
    class RuleGroupRuleGroupRulesSourceStatefulRuleHeaderArgsDict(TypedDict):
        ...
        """
        destination_port: pulumi.Input[builtins.str]
        """
...
class RuleGroupRuleGroupRulesSourceStatefulRuleHeaderArgs:
    def __init__(__self__, *,
                 ...
                 source_port: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] destination: The destination IP address or address range to inspect for, in CIDR notation. To match with any address, specify `ANY`.
        :param pulumi.Input[builtins.str] destination_port: The destination port to inspect for. To match with any address, specify `ANY`.
        :param pulumi.Input[builtins.str] direction: The direction of traffic flow to inspect. Valid values: `ANY` or `FORWARD`.
        :param pulumi.Input[builtins.str] protocol: The protocol to inspect. Valid values: `IP`, `TCP`, `UDP`, `ICMP`, `HTTP`, `FTP`, `TLS`, `SMB`, `DNS`, `DCERPC`, `SSH`, `SMTP`, `IMAP`, `MSN`, `KRB5`, `IKEV2`, `TFTP`, `NTP`, `DHCP`.
        :param pulumi.Input[builtins.str] source: The source IP address or address range for, in CIDR notation. To match with any address, specify `ANY`.
        :param pulumi.Input[builtins.str] source_port: The source port to inspect for. To match with any address, specify `ANY`.
        """
    ...
    def destination_port(self) -> pulumi.Input[builtins.str]:
        """
        The destination port to inspect for. To match with any address, specify `ANY`.
        """
    ...
    def destination_port(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class RuleGroupRuleGroupRulesSourceStatefulRuleRuleOptionArgsDict(TypedDict):
        ...
        """
        settings: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RuleGroupRuleGroupRulesSourceStatefulRuleRuleOptionArgs:
    def __init__(__self__, *,
                 keyword: pulumi.Input[builtins.str],
                 settings: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] keyword: Keyword defined by open source detection systems like Snort or Suricata for stateful rule inspection.
               See [Snort General Rule Options](http://manual-snort-org.s3-website-us-east-1.amazonaws.com/node31.html) or [Suricata Rule Options](https://suricata.readthedocs.io/en/suricata-5.0.1/rules/intro.html#rule-options) for more details.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] settings: Set of strings for additional settings to use in stateful rule inspection.
        """
    ...
    @property
    @pulumi.getter
    def settings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of strings for additional settings to use in stateful rule inspection.
        """
    ...
    @settings.setter
    def settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsCustomActionActionDefinitionPublishMetricActionDimensionArgs:
    def __init__(__self__, *,
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] value: The value to use in the custom metric dimension.
        """
        pulumi.set(__self__, "value", value)
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] priority: A setting that indicates the order in which to run this rule relative to all of the rules that are defined for a stateless rule group. AWS Network Firewall evaluates the rules in a rule group starting with the lowest priority setting.
...
if not MYPY:
    class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesArgsDict(TypedDict):
        ...
        """
        protocols: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]
        """
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesArgs:
    def __init__(__self__, *,
                 ...
                 protocols: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] protocols: Set of protocols to inspect for, specified using the protocol's assigned internet protocol number (IANA). If not specified, this matches with any protocol.
    ...
    @property
    @pulumi.getter
    def protocols(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]:
        """
        Set of protocols to inspect for, specified using the protocol's assigned internet protocol number (IANA). If not specified, this matches with any protocol.
        """
    ...
    @protocols.setter
    def protocols(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.int]]]]):
...
if not MYPY:
    class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationArgsDict(TypedDict):
        address_definition: pulumi.Input[builtins.str]
        """
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationArgs:
    def __init__(__self__, *,
                 address_definition: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] address_definition: An IP address or a block of IP addresses in CIDR notation. AWS Network Firewall supports all address ranges for IPv4.
        """
        pulumi.set(__self__, "address_definition", address_definition)

    @property
    @pulumi.getter(name="addressDefinition")
    def address_definition(self) -> pulumi.Input[builtins.str]:
        """
        An IP address or a block of IP addresses in CIDR notation. AWS Network Firewall supports all address ranges for IPv4.
        """
    ...
    def address_definition(self, value: pulumi.Input[builtins.str]):
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationPortArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] from_port: The lower limit of the port range. This must be less than or equal to the `to_port`.
        :param pulumi.Input[builtins.int] to_port: The upper limit of the port range. This must be greater than or equal to the `from_port`.
        """
...
if not MYPY:
    class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesTcpFlagArgsDict(TypedDict):
        flags: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        Set of flags to look for in a packet. This setting can only specify values that are also specified in `masks`.
        Valid values: `FIN`, `SYN`, `RST`, `PSH`, `ACK`, `URG`, `ECE`, `CWR`.
        """
        masks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesTcpFlagArgs:
    def __init__(__self__, *,
                 flags: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 masks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] flags: Set of flags to look for in a packet. This setting can only specify values that are also specified in `masks`.
               Valid values: `FIN`, `SYN`, `RST`, `PSH`, `ACK`, `URG`, `ECE`, `CWR`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] masks: Set of flags to consider in the inspection. To inspect all flags, leave this empty.
               Valid values: `FIN`, `SYN`, `RST`, `PSH`, `ACK`, `URG`, `ECE`, `CWR`.
        """
    ...
    @property
    @pulumi.getter
    def flags(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Set of flags to look for in a packet. This setting can only specify values that are also specified in `masks`.
        Valid values: `FIN`, `SYN`, `RST`, `PSH`, `ACK`, `URG`, `ECE`, `CWR`.
        """
    ...
    @flags.setter
    def flags(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "flags", value)

    @property
    @pulumi.getter
    def masks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of flags to consider in the inspection. To inspect all flags, leave this empty.
        Valid values: `FIN`, `SYN`, `RST`, `PSH`, `ACK`, `URG`, `ECE`, `CWR`.
        """
    ...
    @masks.setter
    def masks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "masks", value)


if not MYPY:
    class RuleGroupRuleGroupStatefulRuleOptionsArgsDict(TypedDict):
        rule_order: pulumi.Input[builtins.str]
        """
...
class RuleGroupRuleGroupStatefulRuleOptionsArgs:
    def __init__(__self__, *,
                 rule_order: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] rule_order: Indicates how to manage the order of the rule evaluation for the rule group. Default value: `DEFAULT_ACTION_ORDER`. Valid values: `DEFAULT_ACTION_ORDER`, `STRICT_ORDER`.
        """
        pulumi.set(__self__, "rule_order", rule_order)

    @property
    @pulumi.getter(name="ruleOrder")
    def rule_order(self) -> pulumi.Input[builtins.str]:
        """
        Indicates how to manage the order of the rule evaluation for the rule group. Default value: `DEFAULT_ACTION_ORDER`. Valid values: `DEFAULT_ACTION_ORDER`, `STRICT_ORDER`.
        """
        return pulumi.get(self, "rule_order")
    ...
    @rule_order.setter
    def rule_order(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rule_order", value)
...
if not MYPY:
    class TlsInspectionConfigurationCertificateArgsDict(TypedDict):
        ...
        """
        certificate_serial: pulumi.Input[builtins.str]
        """
...
class TlsInspectionConfigurationCertificateArgs:
    def __init__(__self__, *,
                 ...
                 status_message: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] certificate_arn: ARN of the certificate.
        :param pulumi.Input[builtins.str] certificate_serial: Serial number of the certificate.
        :param pulumi.Input[builtins.str] status: Status of the certificate.
        :param pulumi.Input[builtins.str] status_message: Details about the certificate status, including information about certificate errors.
        """
    ...
    def certificate_serial(self) -> pulumi.Input[builtins.str]:
        """
        Serial number of the certificate.
        """
    ...
    def certificate_serial(self, value: pulumi.Input[builtins.str]):
...
class TlsInspectionConfigurationEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key_id: ARN of the Amazon Web Services Key Management Service (KMS) customer managed key.
        :param pulumi.Input[builtins.str] type: Type of KMS key to use for encryption of your Network Firewall resources. Valid values: `AWS_OWNED_KMS_KEY`, `CUSTOMER_KMS`.
        """
        pulumi.set(__self__, "key_id", key_id)
        pulumi.set(__self__, "type", type)
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] certificate_authority_arn: ARN of the imported certificate authority (CA) certificate within Certificate Manager (ACM) to use for outbound SSL/TLS inspection. See [Using SSL/TLS certificates with TLS inspection configurations](https://docs.aws.amazon.com/network-firewall/latest/developerguide/tls-inspection-certificate-requirements.html) for limitations on CA certificates.
...
if not MYPY:
    class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatusArgsDict(TypedDict):
        revoked_status_action: NotRequired[pulumi.Input[builtins.str]]
        unknown_status_action: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatusArgs:
    def __init__(__self__, *,
                 revoked_status_action: Optional[pulumi.Input[builtins.str]] = None,
                 unknown_status_action: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def revoked_status_action(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "revoked_status_action")

    @revoked_status_action.setter
    def revoked_status_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "revoked_status_action", value)

    @property
    @pulumi.getter(name="unknownStatusAction")
    def unknown_status_action(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "unknown_status_action")

    @unknown_status_action.setter
    def unknown_status_action(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] protocols: Set of protocols to inspect for, specified using the protocol's assigned internet protocol number (IANA). Network Firewall currently supports TCP only. Valid values: `6`
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationServerCertificateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] resource_arn: ARN of the Certificate Manager SSL/TLS server certificate that's used for inbound SSL/TLS inspection.
        """
