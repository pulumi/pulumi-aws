...
class Firewall(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if encryption_configuration is not None and not isinstance(encryption_configuration, FirewallEncryptionConfigurationArgs):
                encryption_configuration = encryption_configuration or {}
                def _setter(key, value):
                    encryption_configuration[key] = value
                FirewallEncryptionConfigurationArgs._configure(_setter, **encryption_configuration)
