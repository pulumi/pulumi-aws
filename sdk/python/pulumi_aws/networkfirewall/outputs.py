...
class FirewallEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of AWS KMS key to use for encryption of your Network Firewall resources. Valid values are `CUSTOMER_KMS` and `AWS_OWNED_KMS_KEY`.
        :param builtins.str key_id: The ID of the customer managed key. You can use any of the [key identifiers](https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#key-id) that KMS supports, unless you're using a key that's managed by another account. If you're using a key managed by another account, then specify the key ARN.
        """
...
class FirewallFirewallStatusSyncState(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str availability_zone: The Availability Zone where the subnet is configured.
        """
...
class FirewallFirewallStatusSyncStateAttachment(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str endpoint_id: The identifier of the firewall endpoint that AWS Network Firewall has instantiated in the subnet. You use this to identify the firewall endpoint in the VPC route tables, when you redirect the VPC traffic through the endpoint.
        :param builtins.str subnet_id: The unique identifier of the subnet that you've specified to be used for a firewall endpoint.
        """
...
class FirewallPolicyFirewallPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] stateless_default_actions: Set of actions to take on a packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: `aws:drop`, `aws:pass`, or `aws:forward_to_sfe`.
               In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify `aws:forward_to_sfe`.
        :param Sequence[builtins.str] stateless_fragment_default_actions: Set of actions to take on a fragmented packet if it does not match any of the stateless rules in the policy. You must specify one of the standard actions including: `aws:drop`, `aws:pass`, or `aws:forward_to_sfe`.
               In addition, you can specify custom actions that are compatible with your standard action choice. If you want non-matching packets to be forwarded for stateful inspection, specify `aws:forward_to_sfe`.
...
class FirewallPolicyFirewallPolicyPolicyVariablesRuleVariable(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str key: An alphanumeric string to identify the `ip_set`. Valid values: `HOME_NET`
        """
...
class FirewallPolicyFirewallPolicyPolicyVariablesRuleVariableIpSet(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] definitions: Set of IPv4 or IPv6 addresses in CIDR notation to use for the Suricata `HOME_NET` variable.
        """
...
class FirewallPolicyFirewallPolicyStatefulEngineOptions(dict):
    ...
    def __init__(__self__, *,
                 flow_timeouts: Optional['outputs.FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeouts'] = None,
                 rule_order: Optional[builtins.str] = None,
                 stream_exception_policy: Optional[builtins.str] = None):
        """
        :param 'FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeoutsArgs' flow_timeouts: Amount of time that can pass without any traffic sent through the firewall before the firewall determines that the connection is idle.
        :param builtins.str rule_order: Indicates how to manage the order of stateful rule evaluation for the policy. Default value: `DEFAULT_ACTION_ORDER`. Valid values: `DEFAULT_ACTION_ORDER`, `STRICT_ORDER`.
        :param builtins.str stream_exception_policy: Describes how to treat traffic which has broken midstream. Default value: `DROP`. Valid values: `DROP`, `CONTINUE`, `REJECT`.
        """
    ...
    def stream_exception_policy(self) -> Optional[builtins.str]:
        """
...
class FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeouts(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeouts. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        FirewallPolicyFirewallPolicyStatefulEngineOptionsFlowTimeouts.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int tcp_idle_timeout_seconds: Number of seconds that can pass without any TCP traffic sent through the firewall before the firewall determines that the connection is idle. After the idle timeout passes, data packets are dropped, however, the next TCP SYN packet is considered a new flow and is processed by the firewall. Clients or targets can use TCP keepalive packets to reset the idle timeout. Default value: `350`.
        """
...
class FirewallPolicyFirewallPolicyStatefulRuleGroupReferenceOverride(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action that changes the rule group from DROP to ALERT . This only applies to managed rule groups.
        """
...
class FirewallPolicyFirewallPolicyStatelessCustomAction(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str action_name: A friendly name of the custom action.
        """
...
class FirewallPolicyFirewallPolicyStatelessCustomActionActionDefinitionPublishMetricActionDimension(dict):
    def __init__(__self__, *,
                 value: builtins.str):
        """
        :param builtins.str value: The string value to use in the custom metric dimension.
        """
...
class FirewallPolicyFirewallPolicyStatelessRuleGroupReference(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_arn: builtins.str):
        """
        :param builtins.int priority: An integer setting that indicates the order in which to run the stateless rule groups in a single policy. AWS Network Firewall applies each stateless rule group to a packet starting with the group that has the lowest priority setting.
...
class LoggingConfigurationLoggingConfigurationLogDestinationConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] log_destination: A map describing the logging destination for the chosen `log_destination_type`.
        ...
        :param builtins.str log_destination_type: The location to send logs to. Valid values: `S3`, `CloudWatchLogs`, `KinesisDataFirehose`.
        :param builtins.str log_type: The type of log to send. Valid values: `ALERT` or `FLOW` or `TLS`. Alert logs report traffic that matches a `StatefulRule` with an action setting that sends a log message. Flow logs are standard network traffic flow logs.
        """
...
class RuleGroupRuleGroupReferenceSetsIpSetReferenceIpSetReference(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str reference_arn: Set of Managed Prefix IP ARN(s)
        """
...
class RuleGroupRuleGroupRuleVariablesIpSet(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str key: A unique alphanumeric string to identify the `ip_set`.
        """
        pulumi.set(__self__, "ip_set", ip_set)
        pulumi.set(__self__, "key", key)
...
class RuleGroupRuleGroupRuleVariablesIpSetIpSet(dict):
    def __init__(__self__, *,
                 definitions: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] definitions: Set of IP addresses and address ranges, in CIDR notation.
        """
        pulumi.set(__self__, "definitions", definitions)
...
class RuleGroupRuleGroupRuleVariablesPortSet(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: An unique alphanumeric string to identify the `port_set`.
...
class RuleGroupRuleGroupRuleVariablesPortSetPortSet(dict):
    def __init__(__self__, *,
                 definitions: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] definitions: Set of port ranges.
        """
        pulumi.set(__self__, "definitions", definitions)
...
class RuleGroupRuleGroupRulesSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str rules_string: The fully qualified name of a file in an S3 bucket that contains Suricata compatible intrusion preventions system (IPS) rules or the Suricata rules as a string. These rules contain **stateful** inspection criteria and the action to take for traffic that matches the criteria.
...
class RuleGroupRuleGroupRulesSourceRulesSourceList(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str generated_rules_type: String value to specify whether domains in the target list are allowed or denied access. Valid values: `ALLOWLIST`, `DENYLIST`.
        :param Sequence[builtins.str] target_types: Set of types of domain specifications that are provided in the `targets` argument. Valid values: `HTTP_HOST`, `TLS_SNI`.
        :param Sequence[builtins.str] targets: Set of domains that you want to inspect for in your traffic flows.
        """
...
class RuleGroupRuleGroupRulesSourceStatefulRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: Action to take with packets in a traffic flow when the flow matches the stateful rule criteria. For all actions, AWS Network Firewall performs the specified action and discontinues stateful inspection of the traffic flow. Valid values: `ALERT`, `DROP`, `PASS`, or `REJECT`.
...
class RuleGroupRuleGroupRulesSourceStatefulRuleHeader(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str destination_port: The destination port to inspect for. To match with any address, specify `ANY`.
        :param builtins.str direction: The direction of traffic flow to inspect. Valid values: `ANY` or `FORWARD`.
        :param builtins.str protocol: The protocol to inspect. Valid values: `IP`, `TCP`, `UDP`, `ICMP`, `HTTP`, `FTP`, `TLS`, `SMB`, `DNS`, `DCERPC`, `SSH`, `SMTP`, `IMAP`, `MSN`, `KRB5`, `IKEV2`, `TFTP`, `NTP`, `DHCP`.
        :param builtins.str source: The source IP address or address range for, in CIDR notation. To match with any address, specify `ANY`.
        :param builtins.str source_port: The source port to inspect for. To match with any address, specify `ANY`.
        """
...
class RuleGroupRuleGroupRulesSourceStatefulRuleRuleOption(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str keyword: Keyword defined by open source detection systems like Snort or Suricata for stateful rule inspection.
               See [Snort General Rule Options](http://manual-snort-org.s3-website-us-east-1.amazonaws.com/node31.html) or [Suricata Rule Options](https://suricata.readthedocs.io/en/suricata-5.0.1/rules/intro.html#rule-options) for more details.
        :param Sequence[builtins.str] settings: Set of strings for additional settings to use in stateful rule inspection.
        """
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int priority: A setting that indicates the order in which to run this rule relative to all of the rules that are defined for a stateless rule group. AWS Network Firewall evaluates the rules in a rule group starting with the lowest priority setting.
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] actions: Set of actions to take on a packet that matches one of the stateless rule definition's `match_attributes`. For every rule you must specify 1 standard action, and you can add custom actions. Standard actions include: `aws:pass`, `aws:drop`, `aws:forward_to_sfe`.
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributes(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.int] protocols: Set of protocols to inspect for, specified using the protocol's assigned internet protocol number (IANA). If not specified, this matches with any protocol.
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str address_definition: An IP address or a block of IP addresses in CIDR notation. AWS Network Firewall supports all address ranges for IPv4.
        """
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesDestinationPort(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int from_port: The lower limit of the port range. This must be less than or equal to the `to_port`.
        :param builtins.int to_port: The upper limit of the port range. This must be greater than or equal to the `from_port`.
        """
...
class RuleGroupRuleGroupRulesSourceStatelessRulesAndCustomActionsStatelessRuleRuleDefinitionMatchAttributesTcpFlag(dict):
    def __init__(__self__, *,
                 ...
                 masks: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] flags: Set of flags to look for in a packet. This setting can only specify values that are also specified in `masks`.
               Valid values: `FIN`, `SYN`, `RST`, `PSH`, `ACK`, `URG`, `ECE`, `CWR`.
        :param Sequence[builtins.str] masks: Set of flags to consider in the inspection. To inspect all flags, leave this empty.
               Valid values: `FIN`, `SYN`, `RST`, `PSH`, `ACK`, `URG`, `ECE`, `CWR`.
        """
    ...
    @property
    @pulumi.getter
    def masks(self) -> Optional[Sequence[builtins.str]]:
        """
...
class RuleGroupRuleGroupStatefulRuleOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str rule_order: Indicates how to manage the order of the rule evaluation for the rule group. Default value: `DEFAULT_ACTION_ORDER`. Valid values: `DEFAULT_ACTION_ORDER`, `STRICT_ORDER`.
        """
        pulumi.set(__self__, "rule_order", rule_order)
...
class TlsInspectionConfigurationCertificate(dict):
    ...
    def __key_warning(key: str):
        ...
        elif key == "certificateSerial":
            suggest = "certificate_serial"
        elif key == "statusMessage":
            suggest = "status_message"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationCertificate. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationCertificate.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 certificate_serial: builtins.str,
                 status: builtins.str,
                 status_message: builtins.str):
        """
        :param builtins.str certificate_arn: ARN of the certificate.
        :param builtins.str certificate_serial: Serial number of the certificate.
        :param builtins.str status: Status of the certificate.
        :param builtins.str status_message: Details about the certificate status, including information about certificate errors.
        """
...
class TlsInspectionConfigurationCertificateAuthority(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationCertificateAuthority. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationCertificateAuthority.__key_warning(key)
        return super().__getitem__(key)
...
class TlsInspectionConfigurationEncryptionConfiguration(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationEncryptionConfiguration. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationEncryptionConfiguration.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str key_id: ARN of the Amazon Web Services Key Management Service (KMS) customer managed key.
        :param builtins.str type: Type of KMS key to use for encryption of your Network Firewall resources. Valid values: `AWS_OWNED_KMS_KEY`, `CUSTOMER_KMS`.
        """
        pulumi.set(__self__, "key_id", key_id)
        pulumi.set(__self__, "type", type)
...
class TlsInspectionConfigurationTlsInspectionConfiguration(dict):
    ...
    def __key_warning(key: str):
        suggest = None
        if key == "serverCertificateConfiguration":
            suggest = "server_certificate_configuration"
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfiguration(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfiguration. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfiguration.__key_warning(key)
        return super().__getitem__(key)
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatus(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatus. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationCheckCertificateRevocationStatus.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 revoked_status_action: Optional[builtins.str] = None,
                 unknown_status_action: Optional[builtins.str] = None):
    ...
    def revoked_status_action(self) -> Optional[builtins.str]:
        return pulumi.get(self, "revoked_status_action")

    @property
    @pulumi.getter(name="unknownStatusAction")
    def unknown_status_action(self) -> Optional[builtins.str]:
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScope(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScope. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScope.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.int] protocols: Set of protocols to inspect for, specified using the protocol's assigned internet protocol number (IANA). Network Firewall currently supports TCP only. Valid values: `6`
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestination(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestination. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestination.__key_warning(key)
        return super().__getitem__(key)
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestinationPort(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestinationPort. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeDestinationPort.__key_warning(key)
        return super().__getitem__(key)
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSource(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSource. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSource.__key_warning(key)
        return super().__getitem__(key)
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSourcePort(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSourcePort. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationScopeSourcePort.__key_warning(key)
        return super().__getitem__(key)
...
class TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationServerCertificate(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationServerCertificate. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        TlsInspectionConfigurationTlsInspectionConfigurationServerCertificateConfigurationServerCertificate.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_arn: ARN of the Certificate Manager SSL/TLS server certificate that's used for inbound SSL/TLS inspection.
        """
...
class GetFirewallEncryptionConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str key_id: The ID of the AWS Key Management Service (AWS KMS) customer managed key.
        :param builtins.str type: The type of the AWS Key Management Service (AWS KMS) key use by the firewall.
        """
        pulumi.set(__self__, "key_id", key_id)
        pulumi.set(__self__, "type", type)
...
class GetFirewallFirewallStatusResult(dict):
    def __init__(__self__, *,
                 ...
                 configuration_sync_state_summary: builtins.str,
                 status: builtins.str,
        ...
        :param builtins.str configuration_sync_state_summary: Summary of sync states for all availability zones in which the firewall is configured.
...
class GetFirewallFirewallStatusCapacityUsageSummaryCidrResult(dict):
    def __init__(__self__, *,
                 available_cidr_count: builtins.int,
                 ip_set_references: Sequence['outputs.GetFirewallFirewallStatusCapacityUsageSummaryCidrIpSetReferenceResult'],
                 utilized_cidr_count: builtins.int):
        """
        :param builtins.int available_cidr_count: Available number of CIDR blocks available for use by the IP set references in a firewall.
        ...
        :param builtins.int utilized_cidr_count: Number of CIDR blocks used by the IP set references in a firewall.
        """
    ...
    def available_cidr_count(self) -> builtins.int:
        """
    ...
    def utilized_cidr_count(self) -> builtins.int:
        """
...
class GetFirewallFirewallStatusCapacityUsageSummaryCidrIpSetReferenceResult(dict):
    def __init__(__self__, *,
                 resolved_cidr_count: builtins.int):
        """
        :param builtins.int resolved_cidr_count: Total number of CIDR blocks used by the IP set references in a firewall.
        """
        pulumi.set(__self__, "resolved_cidr_count", resolved_cidr_count)

    @property
    @pulumi.getter(name="resolvedCidrCount")
    def resolved_cidr_count(self) -> builtins.int:
        """
...
class GetFirewallPolicyFirewallPolicyResult(dict):
    ...
    @property
    @pulumi.getter(name="statefulDefaultActions")
    def stateful_default_actions(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "stateful_default_actions")
...
class GetFirewallPolicyFirewallPolicyStatefulEngineOptionResult(dict):
    def __init__(__self__, *,
                 rule_order: builtins.str,
                 stream_exception_policy: builtins.str):
        pulumi.set(__self__, "rule_order", rule_order)
        pulumi.set(__self__, "stream_exception_policy", stream_exception_policy)
