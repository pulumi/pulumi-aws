...
class FirewallPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if encryption_configuration is not None and not isinstance(encryption_configuration, FirewallPolicyEncryptionConfigurationArgs):
                encryption_configuration = encryption_configuration or {}
                def _setter(key, value):
                    encryption_configuration[key] = value
                FirewallPolicyEncryptionConfigurationArgs._configure(_setter, **encryption_configuration)
            __props__.__dict__["encryption_configuration"] = encryption_configuration
            if firewall_policy is not None and not isinstance(firewall_policy, FirewallPolicyFirewallPolicyArgs):
                firewall_policy = firewall_policy or {}
                def _setter(key, value):
                    firewall_policy[key] = value
                FirewallPolicyFirewallPolicyArgs._configure(_setter, **firewall_policy)
