...
class RuleGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if encryption_configuration is not None and not isinstance(encryption_configuration, RuleGroupEncryptionConfigurationArgs):
                encryption_configuration = encryption_configuration or {}
                def _setter(key, value):
                    encryption_configuration[key] = value
                RuleGroupEncryptionConfigurationArgs._configure(_setter, **encryption_configuration)
            __props__.__dict__["encryption_configuration"] = encryption_configuration
            __props__.__dict__["name"] = name
            if rule_group is not None and not isinstance(rule_group, RuleGroupRuleGroupArgs):
                rule_group = rule_group or {}
                def _setter(key, value):
                    rule_group[key] = value
                RuleGroupRuleGroupArgs._configure(_setter, **rule_group)
