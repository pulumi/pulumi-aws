...
class MountTarget(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        foo = aws.ec2.vpc.Vpc("foo", cidr_block=10.0.0.0/16)
        alpha_subnet = aws.ec2.subnet.Subnet("alphaSubnet",
            vpc_id=foo.id,
            availability_zone=us-west-2a,
            cidr_block=10.0.1.0/24)
        alpha_mount_target = aws.efs.mount_target.MountTarget("alphaMountTarget",
