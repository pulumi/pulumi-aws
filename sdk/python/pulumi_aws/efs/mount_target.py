...
class _MountTargetState:
    def __init__(__self__, *,
                 ...
                 ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 mount_target_dns_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_zone_id: The unique and consistent identifier of the Availability Zone (AZ) that the mount target resides in.
        :param pulumi.Input[builtins.str] availability_zone_name: The name of the Availability Zone (AZ) that the mount target resides in.
        :param pulumi.Input[builtins.str] dns_name: The DNS name for the EFS file system.
        :param pulumi.Input[builtins.str] file_system_arn: Amazon Resource Name of the file system.
        :param pulumi.Input[builtins.str] file_system_id: The ID of the file system for which the mount target is intended.
        :param pulumi.Input[builtins.str] ip_address: The address (within the address range of the specified subnet) at
               which the file system may be mounted via the mount target.
    ...
    def mount_target_dns_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mount_target_dns_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MountTarget(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner_id: Optional[pulumi.Input[builtins.str]] = None,
            security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            subnet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MountTarget':
        """
    ...
    @property
    @pulumi.getter(name="mountTargetDnsName")
    def mount_target_dns_name(self) -> pulumi.Output[builtins.str]:
        """
        The DNS name for the given subnet/AZ per [documented convention](http://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html).
        """
        return pulumi.get(self, "mount_target_dns_name")
