...
class FileSystemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_zone_name: the AWS Availability Zone in which to create the file system. Used to create a file system that uses One Zone storage classes. See [user guide](https://docs.aws.amazon.com/efs/latest/ug/availability-durability.html) for more information.
        :param pulumi.Input[builtins.str] creation_token: A unique name (a maximum of 64 characters are allowed)
        ...
        :param pulumi.Input[Sequence[pulumi.Input['FileSystemLifecyclePolicyArgs']]] lifecycle_policies: A file system [lifecycle policy](https://docs.aws.amazon.com/efs/latest/ug/API_LifecyclePolicy.html) object. See `lifecycle_policy` block below for details.
    ...
    def creation_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def creation_token(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def performance_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def performance_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provisioned_throughput_in_mibps(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def provisioned_throughput_in_mibps(self, value: Optional[pulumi.Input[builtins.float]]):
...
class _FileSystemState:
    def __init__(__self__, *,
                 ...
                 number_of_mount_targets: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_zone_id: The identifier of the Availability Zone in which the file system's One Zone storage classes exist.
        :param pulumi.Input[builtins.str] availability_zone_name: the AWS Availability Zone in which to create the file system. Used to create a file system that uses One Zone storage classes. See [user guide](https://docs.aws.amazon.com/efs/latest/ug/availability-durability.html) for more information.
        :param pulumi.Input[builtins.str] creation_token: A unique name (a maximum of 64 characters are allowed)
               used as reference when creating the Elastic File System to ensure idempotent file
               system creation. By default generated by this provider. See [Elastic File System]
               user guide for more information.
        :param pulumi.Input[builtins.str] dns_name: The DNS name for the filesystem per [documented convention](http://docs.aws.amazon.com/efs/latest/ug/mounting-fs-mount-cmd-dns-name.html).
        :param pulumi.Input[builtins.bool] encrypted: If true, the disk will be encrypted.
        :param pulumi.Input[builtins.str] kms_key_id: The ARN for the KMS encryption key. When specifying kms_key_id, encrypted needs to be set to true.
        :param pulumi.Input[Sequence[pulumi.Input['FileSystemLifecyclePolicyArgs']]] lifecycle_policies: A file system [lifecycle policy](https://docs.aws.amazon.com/efs/latest/ug/API_LifecyclePolicy.html) object. See `lifecycle_policy` block below for details.
        :param pulumi.Input[builtins.str] name: The value of the file system's `Name` tag.
        :param pulumi.Input[builtins.int] number_of_mount_targets: The current number of mount targets that the file system has.
        :param pulumi.Input[builtins.str] owner_id: The AWS account that created the file system. If the file system was createdby an IAM user, the parent account to which the user belongs is the owner.
        :param pulumi.Input[builtins.str] performance_mode: The file system performance mode. Can be either `"generalPurpose"` or `"maxIO"` (Default: `"generalPurpose"`).
        :param pulumi.Input['FileSystemProtectionArgs'] protection: A file system [protection](https://docs.aws.amazon.com/efs/latest/ug/API_FileSystemProtectionDescription.html) object. See `protection` block below for details.
        :param pulumi.Input[builtins.float] provisioned_throughput_in_mibps: The throughput, measured in MiB/s, that you want to provision for the file system. Only applicable with `throughput_mode` set to `provisioned`.
    ...
    def number_of_mount_targets(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def number_of_mount_targets(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FileSystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            throughput_mode: Optional[pulumi.Input[builtins.str]] = None) -> 'FileSystem':
        """
    ...
    @property
    @pulumi.getter(name="numberOfMountTargets")
    def number_of_mount_targets(self) -> pulumi.Output[builtins.int]:
        """
        The current number of mount targets that the file system has.
        """
        return pulumi.get(self, "number_of_mount_targets")
    ...
    @property
    @pulumi.getter(name="performanceMode")
    def performance_mode(self) -> pulumi.Output[builtins.str]:
        """
        The file system performance mode. Can be either `"generalPurpose"` or `"maxIO"` (Default: `"generalPurpose"`).
        """
        return pulumi.get(self, "performance_mode")
    ...
    @property
    @pulumi.getter(name="provisionedThroughputInMibps")
    def provisioned_throughput_in_mibps(self) -> pulumi.Output[Optional[builtins.float]]:
        """
        The throughput, measured in MiB/s, that you want to provision for the file system. Only applicable with `throughput_mode` set to `provisioned`.
        """
        return pulumi.get(self, "provisioned_throughput_in_mibps")
    ...
    @property
    @pulumi.getter(name="throughputMode")
    def throughput_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Throughput mode for the file system. Defaults to `bursting`. Valid values: `bursting`, `provisioned`, or `elastic`. When using `provisioned`, also set `provisioned_throughput_in_mibps`.
        """
        return pulumi.get(self, "throughput_mode")
