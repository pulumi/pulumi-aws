...
class EventDataStoreAdvancedEventSelectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Specifies the name of the advanced event selector.
        """
...
if not MYPY:
    class EventDataStoreAdvancedEventSelectorFieldSelectorArgsDict(TypedDict):
        ends_withs: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        not_ends_withs: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        not_starts_withs: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of values that excludes events that match the first few characters of the event record field specified as the value of `field`.
        """
        starts_withs: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class EventDataStoreAdvancedEventSelectorFieldSelectorArgs:
    def __init__(__self__, *,
                 ends_withs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 equals: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 field: Optional[pulumi.Input[builtins.str]] = None,
                 not_ends_withs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 not_equals: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 not_starts_withs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 starts_withs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ends_withs: A list of values that includes events that match the last few characters of the event record field specified as the value of `field`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] equals: A list of values that includes events that match the exact value of the event record field specified as the value of `field`. This is the only valid operator that you can use with the `readOnly`, `eventCategory`, and `resources.type` fields.
        :param pulumi.Input[builtins.str] field: Specifies a field in an event record on which to filter events to be logged. You can specify only the following values: `readOnly`, `eventSource`, `eventName`, `eventCategory`, `resources.type`, `resources.ARN`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_ends_withs: A list of values that excludes events that match the last few characters of the event record field specified as the value of `field`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_equals: A list of values that excludes events that match the exact value of the event record field specified as the value of `field`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_starts_withs: A list of values that excludes events that match the first few characters of the event record field specified as the value of `field`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] starts_withs: A list of values that includes events that match the first few characters of the event record field specified as the value of `field`.
        """
    ...
    def ends_withs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of values that includes events that match the last few characters of the event record field specified as the value of `field`.
        """
    ...
    @ends_withs.setter
    def ends_withs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def not_ends_withs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of values that excludes events that match the last few characters of the event record field specified as the value of `field`.
        """
    ...
    def not_ends_withs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def not_starts_withs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of values that excludes events that match the first few characters of the event record field specified as the value of `field`.
        """
    ...
    def not_starts_withs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "not_starts_withs", value)

    @property
    @pulumi.getter(name="startsWiths")
    def starts_withs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of values that includes events that match the first few characters of the event record field specified as the value of `field`.
        """
    ...
    @starts_withs.setter
    def starts_withs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class TrailAdvancedEventSelectorFieldSelectorArgs:
    def __init__(__self__, *,
                 ...
                 starts_withs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] field: Field in an event record on which to filter events to be logged. You can specify only the following values: `readOnly`, `eventSource`, `eventName`, `eventCategory`, `resources.type`, `resources.ARN`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ends_withs: A list of values that includes events that match the last few characters of the event record field specified as the value of `field`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] equals: A list of values that includes events that match the exact value of the event record field specified as the value of `field`. This is the only valid operator that you can use with the `readOnly`, `eventCategory`, and `resources.type` fields.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_ends_withs: A list of values that excludes events that match the last few characters of the event record field specified as the value of `field`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] not_equals: A list of values that excludes events that match the exact value of the event record field specified as the value of `field`.
...
if not MYPY:
    class TrailEventSelectorArgsDict(TypedDict):
        ...
        """
        exclude_management_event_sources: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        include_management_events: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to include management events for your trail. Defaults to `true`.
        """
        read_write_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class TrailEventSelectorArgs:
    def __init__(__self__, *,
                 ...
                 exclude_management_event_sources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 include_management_events: Optional[pulumi.Input[builtins.bool]] = None,
                 read_write_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_management_event_sources: A set of event sources to exclude. Valid values include: `kms.amazonaws.com` and `rdsdata.amazonaws.com`. `include_management_events` must be set to`true` to allow this.
        :param pulumi.Input[builtins.bool] include_management_events: Whether to include management events for your trail. Defaults to `true`.
        :param pulumi.Input[builtins.str] read_write_type: Type of events to log. Valid values are `ReadOnly`, `WriteOnly`, `All`. Default value is `All`.
        """
    ...
    def exclude_management_event_sources(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A set of event sources to exclude. Valid values include: `kms.amazonaws.com` and `rdsdata.amazonaws.com`. `include_management_events` must be set to`true` to allow this.
        """
    ...
    def exclude_management_event_sources(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "exclude_management_event_sources", value)

    @property
    @pulumi.getter(name="includeManagementEvents")
    def include_management_events(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to include management events for your trail. Defaults to `true`.
        """
    ...
    def include_management_events(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_management_events", value)

    @property
    @pulumi.getter(name="readWriteType")
    def read_write_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Type of events to log. Valid values are `ReadOnly`, `WriteOnly`, `All`. Default value is `All`.
        """
    ...
    def read_write_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TrailEventSelectorDataResourceArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] type: Resource type in which you want to log data events. You can specify only the following value: "AWS::S3::Object", "AWS::Lambda::Function" and "AWS::DynamoDB::Table".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: List of ARN strings or partial ARN strings to specify selectors for data audit events over data resources. ARN list is specific to single-valued `type`. For example, `arn:aws:s3:::<bucket name>/` for all objects in a bucket, `arn:aws:s3:::<bucket name>/key` for specific objects, `arn:aws:lambda` for all lambda events within an account, `arn:aws:lambda:<region>:<account number>:function:<function name>` for a specific Lambda function, `arn:aws:dynamodb` for all DDB events for all tables within an account, or `arn:aws:dynamodb:<region>:<account number>:table/<table name>` for a specific DynamoDB table.
        """
...
if not MYPY:
    class TrailInsightSelectorArgsDict(TypedDict):
        insight_type: pulumi.Input[builtins.str]
        """
...
class TrailInsightSelectorArgs:
    def __init__(__self__, *,
                 insight_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] insight_type: Type of insights to log on a trail. Valid values are: `ApiCallRateInsight` and `ApiErrorRateInsight`.
        """
        pulumi.set(__self__, "insight_type", insight_type)

    @property
    @pulumi.getter(name="insightType")
    def insight_type(self) -> pulumi.Input[builtins.str]:
        """
        Type of insights to log on a trail. Valid values are: `ApiCallRateInsight` and `ApiErrorRateInsight`.
        """
    ...
    @insight_type.setter
    def insight_type(self, value: pulumi.Input[builtins.str]):
