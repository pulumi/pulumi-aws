...
class EventDataStoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] billing_mode: The billing mode for the event data store. The valid values are `EXTENDABLE_RETENTION_PRICING` and `FIXED_RETENTION_PRICING`. Defaults to `EXTENDABLE_RETENTION_PRICING`.
        :param pulumi.Input[builtins.str] kms_key_id: Specifies the AWS KMS key ID to use to encrypt the events delivered by CloudTrail. The value can be an alias name prefixed by alias/, a fully specified ARN to an alias, a fully specified ARN to a key, or a globally unique identifier.
    ...
    def multi_region_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def multi_region_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def organization_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def organization_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def suspend(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @suspend.setter
    def suspend(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EventDataStoreState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EventDataStoreAdvancedEventSelectorArgs']]] advanced_event_selectors: The advanced event selectors to use to select the events for the data store. For more information about how to use advanced event selectors, see [Log events by using advanced event selectors](https://docs.aws.amazon.com/awscloudtrail/latest/userguide/logging-data-events-with-cloudtrail.html#creating-data-event-selectors-advanced) in the CloudTrail User Guide.
        :param pulumi.Input[builtins.str] arn: ARN of the event data store.
        :param pulumi.Input[builtins.str] billing_mode: The billing mode for the event data store. The valid values are `EXTENDABLE_RETENTION_PRICING` and `FIXED_RETENTION_PRICING`. Defaults to `EXTENDABLE_RETENTION_PRICING`.
        :param pulumi.Input[builtins.str] kms_key_id: Specifies the AWS KMS key ID to use to encrypt the events delivered by CloudTrail. The value can be an alias name prefixed by alias/, a fully specified ARN to an alias, a fully specified ARN to a key, or a globally unique identifier.
        :param pulumi.Input[builtins.bool] multi_region_enabled: Specifies whether the event data store includes events from all regions, or only from the region in which the event data store is created. Default: `true`.
        :param pulumi.Input[builtins.str] name: The name of the event data store.
...
class EventDataStore(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            termination_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'EventDataStore':
        """
    ...
    @property
    @pulumi.getter(name="multiRegionEnabled")
    def multi_region_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether the event data store includes events from all regions, or only from the region in which the event data store is created. Default: `true`.
        """
        return pulumi.get(self, "multi_region_enabled")
    ...
    @property
    @pulumi.getter(name="organizationEnabled")
    def organization_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether an event data store collects events logged for an organization in AWS Organizations. Default: `false`.
        """
        return pulumi.get(self, "organization_enabled")
    ...
    @property
    @pulumi.getter
    def suspend(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether to stop ingesting new events into the event data store. If set to `true`, ingestion is suspended while maintaining the ability to query existing events. If set to `false`, ingestion is active.
        """
        return pulumi.get(self, "suspend")
