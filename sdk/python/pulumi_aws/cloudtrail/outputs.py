...
class EventDataStoreAdvancedEventSelector(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Specifies the name of the advanced event selector.
        """
...
class EventDataStoreAdvancedEventSelectorFieldSelector(dict):
    ...
    def __init__(__self__, *,
                 ends_withs: Optional[Sequence[builtins.str]] = None,
                 equals: Optional[Sequence[builtins.str]] = None,
                 field: Optional[builtins.str] = None,
                 not_ends_withs: Optional[Sequence[builtins.str]] = None,
                 not_equals: Optional[Sequence[builtins.str]] = None,
                 not_starts_withs: Optional[Sequence[builtins.str]] = None,
                 starts_withs: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] ends_withs: A list of values that includes events that match the last few characters of the event record field specified as the value of `field`.
        :param Sequence[builtins.str] equals: A list of values that includes events that match the exact value of the event record field specified as the value of `field`. This is the only valid operator that you can use with the `readOnly`, `eventCategory`, and `resources.type` fields.
        :param builtins.str field: Specifies a field in an event record on which to filter events to be logged. You can specify only the following values: `readOnly`, `eventSource`, `eventName`, `eventCategory`, `resources.type`, `resources.ARN`.
        :param Sequence[builtins.str] not_ends_withs: A list of values that excludes events that match the last few characters of the event record field specified as the value of `field`.
        :param Sequence[builtins.str] not_equals: A list of values that excludes events that match the exact value of the event record field specified as the value of `field`.
        :param Sequence[builtins.str] not_starts_withs: A list of values that excludes events that match the first few characters of the event record field specified as the value of `field`.
        :param Sequence[builtins.str] starts_withs: A list of values that includes events that match the first few characters of the event record field specified as the value of `field`.
        """
    ...
    def ends_withs(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def not_ends_withs(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def not_starts_withs(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def starts_withs(self) -> Optional[Sequence[builtins.str]]:
        """
...
class TrailAdvancedEventSelector(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Name of the trail.
        """
        pulumi.set(__self__, "field_selectors", field_selectors)
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class TrailAdvancedEventSelectorFieldSelector(dict):
    ...
    def __init__(__self__, *,
                 ...
                 starts_withs: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str field: Field in an event record on which to filter events to be logged. You can specify only the following values: `readOnly`, `eventSource`, `eventName`, `eventCategory`, `resources.type`, `resources.ARN`.
        :param Sequence[builtins.str] ends_withs: A list of values that includes events that match the last few characters of the event record field specified as the value of `field`.
        :param Sequence[builtins.str] equals: A list of values that includes events that match the exact value of the event record field specified as the value of `field`. This is the only valid operator that you can use with the `readOnly`, `eventCategory`, and `resources.type` fields.
        :param Sequence[builtins.str] not_ends_withs: A list of values that excludes events that match the last few characters of the event record field specified as the value of `field`.
        :param Sequence[builtins.str] not_equals: A list of values that excludes events that match the exact value of the event record field specified as the value of `field`.
...
class TrailEventSelector(dict):
    ...
    def __init__(__self__, *,
                 ...
                 read_write_type: Optional[builtins.str] = None):
        """
        :param Sequence['TrailEventSelectorDataResourceArgs'] data_resources: Configuration block for data events. See details below.
        :param Sequence[builtins.str] exclude_management_event_sources: A set of event sources to exclude. Valid values include: `kms.amazonaws.com` and `rdsdata.amazonaws.com`. `include_management_events` must be set to`true` to allow this.
        :param builtins.bool include_management_events: Whether to include management events for your trail. Defaults to `true`.
        :param builtins.str read_write_type: Type of events to log. Valid values are `ReadOnly`, `WriteOnly`, `All`. Default value is `All`.
        """
    ...
    def read_write_type(self) -> Optional[builtins.str]:
        """
...
class TrailEventSelectorDataResource(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Resource type in which you want to log data events. You can specify only the following value: "AWS::S3::Object", "AWS::Lambda::Function" and "AWS::DynamoDB::Table".
        :param Sequence[builtins.str] values: List of ARN strings or partial ARN strings to specify selectors for data audit events over data resources. ARN list is specific to single-valued `type`. For example, `arn:aws:s3:::<bucket name>/` for all objects in a bucket, `arn:aws:s3:::<bucket name>/key` for specific objects, `arn:aws:lambda` for all lambda events within an account, `arn:aws:lambda:<region>:<account number>:function:<function name>` for a specific Lambda function, `arn:aws:dynamodb` for all DDB events for all tables within an account, or `arn:aws:dynamodb:<region>:<account number>:table/<table name>` for a specific DynamoDB table.
        """
...
class TrailInsightSelector(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str insight_type: Type of insights to log on a trail. Valid values are: `ApiCallRateInsight` and `ApiErrorRateInsight`.
        """
