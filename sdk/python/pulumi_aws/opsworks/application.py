...
class ApplicationArgs:
    ...
    def _configure(
        ...
        if app_sources is None and 'appSources' in kwargs:
            app_sources = kwargs['appSources']
        if auto_bundle_on_deploy is None and 'autoBundleOnDeploy' in kwargs:
            auto_bundle_on_deploy = kwargs['autoBundleOnDeploy']
        if aws_flow_ruby_settings is None and 'awsFlowRubySettings' in kwargs:
            aws_flow_ruby_settings = kwargs['awsFlowRubySettings']
        if data_source_arn is None and 'dataSourceArn' in kwargs:
            data_source_arn = kwargs['dataSourceArn']
        if data_source_database_name is None and 'dataSourceDatabaseName' in kwargs:
            data_source_database_name = kwargs['dataSourceDatabaseName']
        ...
        if rails_env is None and 'railsEnv' in kwargs:
            rails_env = kwargs['railsEnv']
