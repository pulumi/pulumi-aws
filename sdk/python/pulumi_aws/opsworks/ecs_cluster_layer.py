...
__all__ = ['EcsClusterLayerArrgs', 'EcsClusterLayer']

@pulumi.input_type
calass EcsClusterLayerArrgs:
    def __init__(__self__, *,
                 ...
                 cloudwatch_configuration: Optional[pulumi.Input['EcsClusterLayerCloudwatchConfigurationArrgs']] = None,
                 ...
                 ebs_volumes: Optional[pulumi.Input[Sequence[pulumi.Input['EcsClusterLayerEbsVolumeArrgs']]]] = None,
                 ...
                 load_based_auto_scaling: Optional[pulumi.Input['EcsClusterLayerLoadBasedAutoScalingArrgs']] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EcsClusterLayerEbsVolumeArrgs']]] ebs_volumes: `ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
    ...
    def ecs_cluster_arn(self, value: pulumi.Input[str]):
    ...
    def cloudwatch_configuration(self) -> Optional[pulumi.Input['EcsClusterLayerCloudwatchConfigurationArrgs']]:
        return pulumi.get(self, "cloudwatch_configuration")

    @cloudwatch_configuration.setter
    def cloudwatch_configuration(self, value: Optional[pulumi.Input['EcsClusterLayerCloudwatchConfigurationArrgs']]):
    ...
    def ebs_volumes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['EcsClusterLayerEbsVolumeArrgs']]]]:
        """
    ...
    @ebs_volumes.setter
    def ebs_volumes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['EcsClusterLayerEbsVolumeArrgs']]]]):
    ...
    def load_based_auto_scaling(self) -> Optional[pulumi.Input['EcsClusterLayerLoadBasedAutoScalingArrgs']]:
        return pulumi.get(self, "load_based_auto_scaling")

    @load_based_auto_scaling.setter
    def load_based_auto_scaling(self, value: Optional[pulumi.Input['EcsClusterLayerLoadBasedAutoScalingArrgs']]):
...
calass EcsClusterLayer(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 auto_assign_public_ips: Optional[pulumi.Input[bool]] = None,
                 auto_healing: Optional[pulumi.Input[bool]] = None,
                 cloudwatch_configuration: Optional[pulumi.Input[pulumi.InputType['EcsClusterLayerCloudwatchConfigurationArrgs']]] = None,
                 custom_configure_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 custom_deploy_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 custom_instance_profile_arn: Optional[pulumi.Input[str]] = None,
                 custom_json: Optional[pulumi.Input[str]] = None,
                 ...
                 custom_undeploy_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 drain_elb_on_shutdown: Optional[pulumi.Input[bool]] = None,
                 ebs_volumes: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EcsClusterLayerEbsVolumeArrgs']]]]] = None,
                 ecs_cluster_arn: Optional[pulumi.Input[str]] = None,
                 elastic_load_balancer: Optional[pulumi.Input[str]] = None,
                 install_updates_on_boot: Optional[pulumi.Input[bool]] = None,
                 instance_shutdown_timeout: Optional[pulumi.Input[int]] = None,
                 load_based_auto_scaling: Optional[pulumi.Input[pulumi.InputType['EcsClusterLayerLoadBasedAutoScalingArrgs']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 stack_id: Optional[pulumi.Input[str]] = None,
                 system_packages: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] custom_security_group_ids: Ids for a set of security groups to apply to the layer's instances.
        :param pulumi.Input[bool] drain_elb_on_shutdown: Whether to enable Elastic Load Balancing connection draining.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['EcsClusterLayerEbsVolumeArrgs']]]] ebs_volumes: `ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
        :param pulumi.Input[str] ecs_cluster_arn: The ECS Cluster ARN of the layer.
        :param pulumi.Input[str] elastic_load_balancer: Name of an Elastic Load Balancer to attach to this layer
        :param pulumi.Input[bool] install_updates_on_boot: Whether to install OS and package updates on each instance when it boots.
        :param pulumi.Input[int] instance_shutdown_timeout: The time, in seconds, that OpsWorks will wait for Chef to complete after triggering the Shutdown event.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param EcsClusterLayerArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(EcsClusterLayerArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = EcsClusterLayerArrgs.__new__(EcsClusterLayerArrgs)
            ...
            if ecs_cluster_arn is None and not opts.urn:
                raise TypeError("Missing required property 'ecs_cluster_arn'")
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            use_ebs_optimized_instances: Optional[pulumi.Input[bool]] = None) -> 'EcsClusterLayer':
        """
        ...
        __props__ = _EcsClusterLayerState.__new__(_EcsClusterLayerState)
        ...
        __props__.__dict__["use_ebs_optimized_instances"] = use_ebs_optimized_instances
        return EcsClusterLayer(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="cloudwatchConfiguration")
    def cloudwatch_configuration(self) -> pulumi.Output[Optional['outputs.EcsClusterLayerCloudwatchConfiguration']]:
        return pulumi.get(self, "cloudwatch_configuration")
    ...
    @property
    @pulumi.getter(name="loadBasedAutoScaling")
    def load_based_auto_scaling(self) -> pulumi.Output['outputs.EcsClusterLayerLoadBasedAutoScaling']:
        return pulumi.get(self, "load_based_auto_scaling")
