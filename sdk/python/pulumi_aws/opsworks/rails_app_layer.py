...
class RailsAppLayerArgs:
    def __init__(__self__, *,
                 ...
                 app_server: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 bundler_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 manage_bundler: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 passenger_version: Optional[pulumi.Input[builtins.str]] = None,
                 ruby_version: Optional[pulumi.Input[builtins.str]] = None,
                 rubygems_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] app_server: Keyword for the app server to use. Defaults to "apache_passenger".
        ...
        :param pulumi.Input[builtins.str] bundler_version: When OpsWorks is managing Bundler, which version to use. Defaults to "1.5.3".
        ...
        :param pulumi.Input[builtins.bool] manage_bundler: Whether OpsWorks should manage bundler. On by default.
        :param pulumi.Input[builtins.str] name: A human-readable name for the layer.
        :param pulumi.Input[builtins.str] passenger_version: The version of Passenger to use. Defaults to "4.0.46".
        :param pulumi.Input[builtins.str] ruby_version: The version of Ruby to use. Defaults to "2.0.0".
        :param pulumi.Input[builtins.str] rubygems_version: The version of RubyGems to use. Defaults to "2.2.2".
        ...
        if app_server is not None:
            pulumi.set(__self__, "app_server", app_server)
        ...
        if passenger_version is not None:
            pulumi.set(__self__, "passenger_version", passenger_version)
        if ruby_version is not None:
            pulumi.set(__self__, "ruby_version", ruby_version)
        if rubygems_version is not None:
            pulumi.set(__self__, "rubygems_version", rubygems_version)
    ...
    def app_server(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @app_server.setter
    def app_server(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "app_server", value)
    ...
    def bundler_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bundler_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def manage_bundler(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether OpsWorks should manage bundler. On by default.
        """
        return pulumi.get(self, "manage_bundler")

    @manage_bundler.setter
    def manage_bundler(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "manage_bundler", value)
    ...
    def passenger_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The version of Passenger to use. Defaults to "4.0.46".
        """
        return pulumi.get(self, "passenger_version")

    @passenger_version.setter
    def passenger_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "passenger_version", value)

    @property
    @pulumi.getter(name="rubyVersion")
    def ruby_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ruby_version.setter
    def ruby_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ruby_version", value)

    @property
    @pulumi.getter(name="rubygemsVersion")
    def rubygems_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The version of RubyGems to use. Defaults to "2.2.2".
        """
        return pulumi.get(self, "rubygems_version")

    @rubygems_version.setter
    def rubygems_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rubygems_version", value)
...
class RailsAppLayer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_healing: Optional[pulumi.Input[builtins.bool]] = None,
                 bundler_version: Optional[pulumi.Input[builtins.str]] = None,
                 cloudwatch_configuration: Optional[pulumi.Input[Union['RailsAppLayerCloudwatchConfigurationArgs', 'RailsAppLayerCloudwatchConfigurationArgsDict']]] = None,
                 custom_configure_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 custom_deploy_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 custom_instance_profile_arn: Optional[pulumi.Input[builtins.str]] = None,
                 custom_json: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 custom_undeploy_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 drain_elb_on_shutdown: Optional[pulumi.Input[builtins.bool]] = None,
                 ebs_volumes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['RailsAppLayerEbsVolumeArgs', 'RailsAppLayerEbsVolumeArgsDict']]]]] = None,
                 elastic_load_balancer: Optional[pulumi.Input[builtins.str]] = None,
                 install_updates_on_boot: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_shutdown_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 load_based_auto_scaling: Optional[pulumi.Input[Union['RailsAppLayerLoadBasedAutoScalingArgs', 'RailsAppLayerLoadBasedAutoScalingArgsDict']]] = None,
                 manage_bundler: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 passenger_version: Optional[pulumi.Input[builtins.str]] = None,
                 ruby_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_security_group_ids: Ids for a set of security groups to apply to the layer's instances.
        :param pulumi.Input[builtins.bool] drain_elb_on_shutdown: Whether to enable Elastic Load Balancing connection draining.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RailsAppLayerEbsVolumeArgs', 'RailsAppLayerEbsVolumeArgsDict']]]] ebs_volumes: `ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
        :param pulumi.Input[builtins.str] elastic_load_balancer: Name of an Elastic Load Balancer to attach to this layer
        :param pulumi.Input[builtins.bool] install_updates_on_boot: Whether to install OS and package updates on each instance when it boots.
        :param pulumi.Input[builtins.int] instance_shutdown_timeout: The time, in seconds, that OpsWorks will wait for Chef to complete after triggering the Shutdown event.
        :param pulumi.Input[builtins.bool] manage_bundler: Whether OpsWorks should manage bundler. On by default.
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["ruby_version"] = ruby_version
            __props__.__dict__["rubygems_version"] = rubygems_version
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            use_ebs_optimized_instances: Optional[pulumi.Input[builtins.bool]] = None) -> 'RailsAppLayer':
        """
        ...
        __props__ = _RailsAppLayerState.__new__(_RailsAppLayerState)
    ...
    @property
    @pulumi.getter(name="appServer")
    def app_server(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Keyword for the app server to use. Defaults to "apache_passenger".
        """
        return pulumi.get(self, "app_server")
    ...
    @property
    @pulumi.getter(name="bundlerVersion")
    def bundler_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When OpsWorks is managing Bundler, which version to use. Defaults to "1.5.3".
        """
        return pulumi.get(self, "bundler_version")
    ...
    @property
    @pulumi.getter(name="ebsVolumes")
    def ebs_volumes(self) -> pulumi.Output[Sequence['outputs.RailsAppLayerEbsVolume']]:
        """
        `ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
        """
        return pulumi.get(self, "ebs_volumes")
    ...
    @property
    @pulumi.getter(name="manageBundler")
    def manage_bundler(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether OpsWorks should manage bundler. On by default.
        """
        return pulumi.get(self, "manage_bundler")
    ...
    @property
    @pulumi.getter(name="passengerVersion")
    def passenger_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of Passenger to use. Defaults to "4.0.46".
        """
        return pulumi.get(self, "passenger_version")
    ...
    @property
    @pulumi.getter(name="rubyVersion")
    def ruby_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of Ruby to use. Defaults to "2.0.0".
        """
        return pulumi.get(self, "ruby_version")
    ...
    @property
    @pulumi.getter(name="rubygemsVersion")
    def rubygems_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The version of RubyGems to use. Defaults to "2.2.2".
        """
        return pulumi.get(self, "rubygems_version")
