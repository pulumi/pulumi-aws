...
class RailsAppLayerArgs:
    def __init__(__self__, *,
                 ...
                 rubygems_version: Optional[pulumi.Input[str]] = None,
    ...
    def _configure(
        ...
        if app_server is None and 'appServer' in kwargs:
            app_server = kwargs['appServer']
        ...
        if bundler_version is None and 'bundlerVersion' in kwargs:
            bundler_version = kwargs['bundlerVersion']
        ...
        if manage_bundler is None and 'manageBundler' in kwargs:
            manage_bundler = kwargs['manageBundler']
        if passenger_version is None and 'passengerVersion' in kwargs:
            passenger_version = kwargs['passengerVersion']
        if ruby_version is None and 'rubyVersion' in kwargs:
            ruby_version = kwargs['rubyVersion']
        if rubygems_version is None and 'rubygemsVersion' in kwargs:
            rubygems_version = kwargs['rubygemsVersion']
        ...
        if bundler_version is not None:
            _setter("bundler_version", bundler_version)
        ...
        if passenger_version is not None:
            _setter("passenger_version", passenger_version)
        if ruby_version is not None:
            _setter("ruby_version", ruby_version)
        if rubygems_version is not None:
            _setter("rubygems_version", rubygems_version)
    ...
    @app_server.setter
    def app_server(self, value: Optional[pulumi.Input[str]]):
    ...
    def manage_bundler(self, value: Optional[pulumi.Input[bool]]):
    ...
    def passenger_version(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def passenger_version(self, value: Optional[pulumi.Input[str]]):
    ...
    def rubygems_version(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def rubygems_version(self, value: Optional[pulumi.Input[str]]):
...
class _RailsAppLayerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] use_ebs_optimized_instances: Whether to use EBS-optimized instances.
        """
        _RailsAppLayerState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            app_server=app_server,
            arn=arn,
            auto_assign_elastic_ips=auto_assign_elastic_ips,
...
class RailsAppLayer(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            RailsAppLayerArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cloudwatch_configuration is not None and not isinstance(cloudwatch_configuration, RailsAppLayerCloudwatchConfigurationArgs):
                cloudwatch_configuration = cloudwatch_configuration or {}
                def _setter(key, value):
                    cloudwatch_configuration[key] = value
                RailsAppLayerCloudwatchConfigurationArgs._configure(_setter, **cloudwatch_configuration)
            ...
            if load_based_auto_scaling is not None and not isinstance(load_based_auto_scaling, RailsAppLayerLoadBasedAutoScalingArgs):
                load_based_auto_scaling = load_based_auto_scaling or {}
                def _setter(key, value):
                    load_based_auto_scaling[key] = value
                RailsAppLayerLoadBasedAutoScalingArgs._configure(_setter, **load_based_auto_scaling)
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            use_ebs_optimized_instances: Optional[pulumi.Input[bool]] = None) -> 'RailsAppLayer':
        """
