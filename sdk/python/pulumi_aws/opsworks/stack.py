...
class StackArgs:
    def __init__(__self__, *,
                 default_instance_profile_arn: pulumi.Input[builtins.str],
                 region: pulumi.Input[builtins.str],
                 service_role_arn: pulumi.Input[builtins.str],
                 agent_version: Optional[pulumi.Input[builtins.str]] = None,
                 berkshelf_version: Optional[pulumi.Input[builtins.str]] = None,
                 color: Optional[pulumi.Input[builtins.str]] = None,
                 configuration_manager_name: Optional[pulumi.Input[builtins.str]] = None,
                 configuration_manager_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 default_availability_zone: Optional[pulumi.Input[builtins.str]] = None,
                 default_os: Optional[pulumi.Input[builtins.str]] = None,
                 default_root_device_type: Optional[pulumi.Input[builtins.str]] = None,
                 default_ssh_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 default_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
                 hostname_theme: Optional[pulumi.Input[builtins.str]] = None,
                 manage_berkshelf: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 use_custom_cookbooks: Optional[pulumi.Input[builtins.bool]] = None,
                 use_opsworks_security_groups: Optional[pulumi.Input[builtins.bool]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Stack resource.
        :param pulumi.Input[builtins.str] default_instance_profile_arn: The ARN of an IAM Instance Profile that created instances will have by default.
        :param pulumi.Input[builtins.str] region: The name of the region where the stack will exist.
        :param pulumi.Input[builtins.str] service_role_arn: The ARN of an IAM role that the OpsWorks service will act as.
        :param pulumi.Input[builtins.str] agent_version: If set to `"LATEST"`, OpsWorks will automatically install the latest version.
        :param pulumi.Input[builtins.str] berkshelf_version: If `manage_berkshelf` is enabled, the version of Berkshelf to use.
        :param pulumi.Input[builtins.str] color: Color to paint next to the stack's resources in the OpsWorks console.
        :param pulumi.Input[builtins.str] configuration_manager_name: Name of the configuration manager to use. Defaults to "Chef".
        :param pulumi.Input[builtins.str] configuration_manager_version: Version of the configuration manager to use. Defaults to "11.4".
        ...
        :param pulumi.Input[builtins.str] custom_json: Custom JSON attributes to apply to the entire stack.
        :param pulumi.Input[builtins.str] default_availability_zone: Name of the availability zone where instances will be created by default.
               Cannot be set when `vpc_id` is set.
        :param pulumi.Input[builtins.str] default_os: Name of OS that will be installed on instances by default.
        :param pulumi.Input[builtins.str] default_root_device_type: Name of the type of root device instances will have by default.
        :param pulumi.Input[builtins.str] default_ssh_key_name: Name of the SSH keypair that instances will have by default.
        :param pulumi.Input[builtins.str] default_subnet_id: ID of the subnet in which instances will be created by default.
               Required if `vpc_id` is set to a VPC other than the default VPC, and forbidden if it isn't.
        :param pulumi.Input[builtins.str] hostname_theme: Keyword representing the naming scheme that will be used for instance hostnames within this stack.
        :param pulumi.Input[builtins.bool] manage_berkshelf: Boolean value controlling whether Opsworks will run Berkshelf for this stack.
        :param pulumi.Input[builtins.str] name: The name of the stack.
        ...
        :param pulumi.Input[builtins.bool] use_custom_cookbooks: Boolean value controlling whether the custom cookbook settings are enabled.
        :param pulumi.Input[builtins.bool] use_opsworks_security_groups: Boolean value controlling whether the standard OpsWorks security groups apply to created instances.
        :param pulumi.Input[builtins.str] vpc_id: ID of the VPC that this stack belongs to.
    ...
    def default_instance_profile_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def default_instance_profile_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def berkshelf_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def berkshelf_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def configuration_manager_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def configuration_manager_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "configuration_manager_name", value)

    @property
    @pulumi.getter(name="configurationManagerVersion")
    def configuration_manager_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def configuration_manager_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def default_availability_zone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_availability_zone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_availability_zone", value)

    @property
    @pulumi.getter(name="defaultOs")
    def default_os(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @default_os.setter
    def default_os(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_os", value)

    @property
    @pulumi.getter(name="defaultRootDeviceType")
    def default_root_device_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_root_device_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_root_device_type", value)

    @property
    @pulumi.getter(name="defaultSshKeyName")
    def default_ssh_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_ssh_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_ssh_key_name", value)

    @property
    @pulumi.getter(name="defaultSubnetId")
    def default_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_subnet_id", value)

    @property
    @pulumi.getter(name="hostnameTheme")
    def hostname_theme(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hostname_theme(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hostname_theme", value)

    @property
    @pulumi.getter(name="manageBerkshelf")
    def manage_berkshelf(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def manage_berkshelf(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def use_custom_cookbooks(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_custom_cookbooks(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "use_custom_cookbooks", value)

    @property
    @pulumi.getter(name="useOpsworksSecurityGroups")
    def use_opsworks_security_groups(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def use_opsworks_security_groups(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _StackState:
    def __init__(__self__, *,
                 ...
                 custom_json: Optional[pulumi.Input[builtins.str]] = None,
                 default_availability_zone: Optional[pulumi.Input[builtins.str]] = None,
                 default_instance_profile_arn: Optional[pulumi.Input[builtins.str]] = None,
                 default_os: Optional[pulumi.Input[builtins.str]] = None,
                 default_root_device_type: Optional[pulumi.Input[builtins.str]] = None,
                 default_ssh_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 default_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 stack_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="defaultInstanceProfileArn")
    def default_instance_profile_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of an IAM Instance Profile that created instances will have by default.
        """
        return pulumi.get(self, "default_instance_profile_arn")
    ...
    @default_instance_profile_arn.setter
    def default_instance_profile_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_instance_profile_arn", value)
    ...
    def stack_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "stack_endpoint")

    @stack_endpoint.setter
    def stack_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Stack(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            use_custom_cookbooks: Optional[pulumi.Input[builtins.bool]] = None,
            use_opsworks_security_groups: Optional[pulumi.Input[builtins.bool]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Stack':
        """
    ...
    @property
    @pulumi.getter(name="berkshelfVersion")
    def berkshelf_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `manage_berkshelf` is enabled, the version of Berkshelf to use.
        """
        return pulumi.get(self, "berkshelf_version")
    ...
    @property
    @pulumi.getter(name="configurationManagerName")
    def configuration_manager_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the configuration manager to use. Defaults to "Chef".
        """
        return pulumi.get(self, "configuration_manager_name")
    ...
    @property
    @pulumi.getter(name="configurationManagerVersion")
    def configuration_manager_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Version of the configuration manager to use. Defaults to "11.4".
        """
        return pulumi.get(self, "configuration_manager_version")
    ...
    @property
    @pulumi.getter(name="defaultAvailabilityZone")
    def default_availability_zone(self) -> pulumi.Output[builtins.str]:
        """
        Name of the availability zone where instances will be created by default.
        Cannot be set when `vpc_id` is set.
        """
    ...
    @property
    @pulumi.getter(name="defaultInstanceProfileArn")
    def default_instance_profile_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of an IAM Instance Profile that created instances will have by default.
        """
        return pulumi.get(self, "default_instance_profile_arn")
    ...
    @property
    @pulumi.getter(name="defaultOs")
    def default_os(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of OS that will be installed on instances by default.
        """
        return pulumi.get(self, "default_os")
    ...
    @property
    @pulumi.getter(name="defaultRootDeviceType")
    def default_root_device_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the type of root device instances will have by default.
        """
        return pulumi.get(self, "default_root_device_type")
    ...
    @property
    @pulumi.getter(name="defaultSshKeyName")
    def default_ssh_key_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the SSH keypair that instances will have by default.
        """
        return pulumi.get(self, "default_ssh_key_name")
    ...
    @property
    @pulumi.getter(name="defaultSubnetId")
    def default_subnet_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the subnet in which instances will be created by default.
        Required if `vpc_id` is set to a VPC other than the default VPC, and forbidden if it isn't.
        """
    ...
    @property
    @pulumi.getter(name="hostnameTheme")
    def hostname_theme(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Keyword representing the naming scheme that will be used for instance hostnames within this stack.
        """
        return pulumi.get(self, "hostname_theme")
    ...
    @property
    @pulumi.getter(name="manageBerkshelf")
    def manage_berkshelf(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean value controlling whether Opsworks will run Berkshelf for this stack.
        """
        return pulumi.get(self, "manage_berkshelf")
    ...
    @property
    @pulumi.getter(name="stackEndpoint")
    def stack_endpoint(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "stack_endpoint")
    ...
    @property
    @pulumi.getter(name="useCustomCookbooks")
    def use_custom_cookbooks(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean value controlling whether the custom cookbook settings are enabled.
        """
        return pulumi.get(self, "use_custom_cookbooks")
    ...
    @property
    @pulumi.getter(name="useOpsworksSecurityGroups")
    def use_opsworks_security_groups(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean value controlling whether the standard OpsWorks security groups apply to created instances.
        """
        return pulumi.get(self, "use_opsworks_security_groups")
