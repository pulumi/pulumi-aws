...
class PhpAppLayer(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            PhpAppLayerArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cloudwatch_configuration is not None and not isinstance(cloudwatch_configuration, PhpAppLayerCloudwatchConfigurationArgs):
                cloudwatch_configuration = cloudwatch_configuration or {}
                def _setter(key, value):
                    cloudwatch_configuration[key] = value
                PhpAppLayerCloudwatchConfigurationArgs._configure(_setter, **cloudwatch_configuration)
            ...
            if load_based_auto_scaling is not None and not isinstance(load_based_auto_scaling, PhpAppLayerLoadBasedAutoScalingArgs):
                load_based_auto_scaling = load_based_auto_scaling or {}
                def _setter(key, value):
                    load_based_auto_scaling[key] = value
                PhpAppLayerLoadBasedAutoScalingArgs._configure(_setter, **load_based_auto_scaling)
