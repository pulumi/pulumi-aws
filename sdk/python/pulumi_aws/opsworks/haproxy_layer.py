...
class HaproxyLayerArgs:
    ...
    def _configure(
        ...
        if stats_password is None and 'statsPassword' in kwargs:
            stats_password = kwargs['statsPassword']
        if stats_password is None:
            raise TypeError("Missing 'stats_password' argument")
        ...
        if healthcheck_method is None and 'healthcheckMethod' in kwargs:
            healthcheck_method = kwargs['healthcheckMethod']
        if healthcheck_url is None and 'healthcheckUrl' in kwargs:
            healthcheck_url = kwargs['healthcheckUrl']
        ...
        if stats_enabled is None and 'statsEnabled' in kwargs:
            stats_enabled = kwargs['statsEnabled']
        if stats_url is None and 'statsUrl' in kwargs:
            stats_url = kwargs['statsUrl']
        if stats_user is None and 'statsUser' in kwargs:
            stats_user = kwargs['statsUser']
        ...
        _setter("stats_password", stats_password)
        ...
        if healthcheck_method is not None:
            _setter("healthcheck_method", healthcheck_method)
        if healthcheck_url is not None:
            _setter("healthcheck_url", healthcheck_url)
...
class HaproxyLayer(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            HaproxyLayerArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cloudwatch_configuration is not None and not isinstance(cloudwatch_configuration, HaproxyLayerCloudwatchConfigurationArgs):
                cloudwatch_configuration = cloudwatch_configuration or {}
                def _setter(key, value):
                    cloudwatch_configuration[key] = value
                HaproxyLayerCloudwatchConfigurationArgs._configure(_setter, **cloudwatch_configuration)
            ...
            if load_based_auto_scaling is not None and not isinstance(load_based_auto_scaling, HaproxyLayerLoadBasedAutoScalingArgs):
                load_based_auto_scaling = load_based_auto_scaling or {}
                def _setter(key, value):
                    load_based_auto_scaling[key] = value
                HaproxyLayerLoadBasedAutoScalingArgs._configure(_setter, **load_based_auto_scaling)
