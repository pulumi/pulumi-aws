...
class ApplicationAppSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of source to use. For example, "archive".
        :param builtins.str password: Password to use when authenticating to the source. This provider cannot perform drift detection of this configuration.
        :param builtins.str revision: For sources that are version-aware, the revision to use.
        :param builtins.str ssh_key: SSH key to use when authenticating to the source. This provider cannot perform drift detection of this configuration.
        :param builtins.str url: The URL where the app resource can be found.
        :param builtins.str username: Username to use when authenticating to the source.
        """
...
class ApplicationEnvironment(dict):
    def __init__(__self__, *,
                 key: builtins.str,
                 value: builtins.str,
                 secure: Optional[builtins.bool] = None):
        """
        :param builtins.str key: Variable name.
        :param builtins.str value: Variable value.
        :param builtins.bool secure: Set visibility of the variable value to `true` or `false`.
        """
    ...
    @property
    @pulumi.getter
    def secure(self) -> Optional[builtins.bool]:
        """
...
class ApplicationSslConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate: The contents of the certificate's domain.crt file.
        :param builtins.str private_key: The private key; the contents of the certificate's domain.key file.
        :param builtins.str chain: Can be used to specify an intermediate certificate authority key or client authentication.
        """
...
class CustomLayerCloudwatchConfigurationLogStream(dict):
    ...
    def __init__(__self__, *,
                 ...
                 buffer_duration: Optional[builtins.int] = None,
                 datetime_format: Optional[builtins.str] = None,
                 encoding: Optional[builtins.str] = None,
                 file_fingerprint_lines: Optional[builtins.str] = None,
                 initial_position: Optional[builtins.str] = None,
                 multiline_start_pattern: Optional[builtins.str] = None,
                 time_zone: Optional[builtins.str] = None):
        """
        :param builtins.str file: Specifies log files that you want to push to CloudWatch Logs. File can point to a specific file or multiple files (by using wild card characters such as /var/log/system.log*).
        :param builtins.str log_group_name: Specifies the destination log group. A log group is created automatically if it doesn't already exist.
        :param builtins.int batch_count: Specifies the max number of log events in a batch, up to `10000`. The default value is `1000`.
        :param builtins.int batch_size: Specifies the maximum size of log events in a batch, in bytes, up to `1048576` bytes. The default value is `32768` bytes.
        :param builtins.int buffer_duration: Specifies the time duration for the batching of log events. The minimum value is `5000` and default value is `5000`.
        :param builtins.str datetime_format: Specifies how the timestamp is extracted from logs. For more information, see the CloudWatch Logs Agent Reference (https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/AgentReference.html).
        :param builtins.str encoding: Specifies the encoding of the log file so that the file can be read correctly. The default is `utf_8`.
        :param builtins.str file_fingerprint_lines: Specifies the range of lines for identifying a file. The valid values are one number, or two dash-delimited numbers, such as `1`, `2-5`. The default value is `1`.
        :param builtins.str initial_position: Specifies where to start to read data (`start_of_file` or `end_of_file`). The default is `start_of_file`.
        :param builtins.str multiline_start_pattern: Specifies the pattern for identifying the start of a log message.
        :param builtins.str time_zone: Specifies the time zone of log event time stamps.
        """
    ...
    def buffer_duration(self) -> Optional[builtins.int]:
        """
    ...
    def datetime_format(self) -> Optional[builtins.str]:
        """
    ...
    def file_fingerprint_lines(self) -> Optional[builtins.str]:
        """
    ...
    def initial_position(self) -> Optional[builtins.str]:
        """
    ...
    def multiline_start_pattern(self) -> Optional[builtins.str]:
        """
...
class CustomLayerEbsVolume(dict):
    ...
    def __init__(__self__, *,
                 ...
                 raid_level: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str mount_point: The path to mount the EBS volume on the layer's instances.
        :param builtins.int number_of_disks: The number of disks to use for the EBS volume.
        :param builtins.int size: The size of the volume in gigabytes.
        :param builtins.bool encrypted: Encrypt the volume.
        :param builtins.int iops: For PIOPS volumes, the IOPS per disk.
        :param builtins.str raid_level: The RAID level to use for the volume.
        :param builtins.str type: The type of volume to create. This may be `standard` (the default), `io1` or `gp2`.
        """
    ...
    def raid_level(self) -> Optional[builtins.str]:
        """
...
class CustomLayerLoadBasedAutoScaling(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool enable: Whether load-based auto scaling is enabled for the layer.
...
class CustomLayerLoadBasedAutoScalingDownscaling(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ignore_metrics_time: Optional[builtins.int] = None,
                 instance_count: Optional[builtins.int] = None,
                 load_threshold: Optional[builtins.float] = None,
                 memory_threshold: Optional[builtins.float] = None,
                 thresholds_wait_time: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] alarms: Custom Cloudwatch auto scaling alarms, to be used as thresholds. This parameter takes a list of up to five alarm names, which are case sensitive and must be in the same region as the stack.
        :param builtins.float cpu_threshold: The CPU utilization threshold, as a percent of the available CPU. A value of -1 disables the threshold.
        :param builtins.int ignore_metrics_time: The amount of time (in minutes) after a scaling event occurs that AWS OpsWorks Stacks should ignore metrics and suppress additional scaling events.
        :param builtins.int instance_count: The number of instances to add or remove when the load exceeds a threshold.
        :param builtins.float load_threshold: The load threshold. A value of -1 disables the threshold.
        :param builtins.float memory_threshold: The memory utilization threshold, as a percent of the available memory. A value of -1 disables the threshold.
        :param builtins.int thresholds_wait_time: The amount of time, in minutes, that the load must exceed a threshold before more instances are added or removed.
        """
    ...
    def ignore_metrics_time(self) -> Optional[builtins.int]:
        """
    ...
    def load_threshold(self) -> Optional[builtins.float]:
        """
    ...
    def memory_threshold(self) -> Optional[builtins.float]:
        """
    ...
    def thresholds_wait_time(self) -> Optional[builtins.int]:
        """
...
class StackCustomCookbooksSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of source to use. For example, "archive".
        :param builtins.str url: The URL where the cookbooks resource can be found.
        :param builtins.str password: Password to use when authenticating to the source. The provider cannot perform drift detection of this configuration.
        :param builtins.str revision: For sources that are version-aware, the revision to use.
        :param builtins.str ssh_key: SSH key to use when authenticating to the source. This provider cannot perform drift detection of this configuration.
        :param builtins.str username: Username to use when authenticating to the source.
        """
