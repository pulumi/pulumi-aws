...
class JavaAppLayerArgs:
    ...
    def _configure(
        ...
        if app_server_version is None and 'appServerVersion' in kwargs:
            app_server_version = kwargs['appServerVersion']
        ...
        if jvm_type is None and 'jvmType' in kwargs:
            jvm_type = kwargs['jvmType']
        if jvm_version is None and 'jvmVersion' in kwargs:
            jvm_version = kwargs['jvmVersion']
        ...
        if app_server_version is not None:
            _setter("app_server_version", app_server_version)
        ...
        if jvm_type is not None:
            _setter("jvm_type", jvm_type)
        if jvm_version is not None:
            _setter("jvm_version", jvm_version)
    ...
    def app_server_version(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def app_server_version(self, value: Optional[pulumi.Input[str]]):
    ...
    def jvm_type(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @jvm_type.setter
    def jvm_type(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "jvm_type", value)

    @property
    @pulumi.getter(name="jvmVersion")
    def jvm_version(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @jvm_version.setter
    def jvm_version(self, value: Optional[pulumi.Input[str]]):
...
class JavaAppLayer(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            JavaAppLayerArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if cloudwatch_configuration is not None and not isinstance(cloudwatch_configuration, JavaAppLayerCloudwatchConfigurationArgs):
                cloudwatch_configuration = cloudwatch_configuration or {}
                def _setter(key, value):
                    cloudwatch_configuration[key] = value
                JavaAppLayerCloudwatchConfigurationArgs._configure(_setter, **cloudwatch_configuration)
            ...
            if load_based_auto_scaling is not None and not isinstance(load_based_auto_scaling, JavaAppLayerLoadBasedAutoScalingArgs):
                load_based_auto_scaling = load_based_auto_scaling or {}
                def _setter(key, value):
                    load_based_auto_scaling[key] = value
                JavaAppLayerLoadBasedAutoScalingArgs._configure(_setter, **load_based_auto_scaling)
