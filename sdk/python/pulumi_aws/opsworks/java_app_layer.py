...
class JavaAppLayerArgs:
    def __init__(__self__, *,
                 ...
                 app_server_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 jvm_options: Optional[pulumi.Input[builtins.str]] = None,
                 jvm_type: Optional[pulumi.Input[builtins.str]] = None,
                 jvm_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] app_server: Keyword for the application container to use. Defaults to "tomcat".
        :param pulumi.Input[builtins.str] app_server_version: Version of the selected application container to use. Defaults to "7".
        ...
        :param pulumi.Input[builtins.str] jvm_options: Options to set for the JVM.
        :param pulumi.Input[builtins.str] jvm_type: Keyword for the type of JVM to use. Defaults to `openjdk`.
        :param pulumi.Input[builtins.str] jvm_version: Version of JVM to use. Defaults to "7".
        ...
        if app_server_version is not None:
            pulumi.set(__self__, "app_server_version", app_server_version)
    ...
    def app_server_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def app_server_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "app_server_version", value)
    ...
    def jvm_options(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @jvm_options.setter
    def jvm_options(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "jvm_options", value)

    @property
    @pulumi.getter(name="jvmType")
    def jvm_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @jvm_type.setter
    def jvm_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "jvm_type", value)

    @property
    @pulumi.getter(name="jvmVersion")
    def jvm_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @jvm_version.setter
    def jvm_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class JavaAppLayer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 auto_assign_public_ips: Optional[pulumi.Input[builtins.bool]] = None,
                 auto_healing: Optional[pulumi.Input[builtins.bool]] = None,
                 cloudwatch_configuration: Optional[pulumi.Input[Union['JavaAppLayerCloudwatchConfigurationArgs', 'JavaAppLayerCloudwatchConfigurationArgsDict']]] = None,
                 custom_configure_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 custom_deploy_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 custom_instance_profile_arn: Optional[pulumi.Input[builtins.str]] = None,
                 custom_json: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 custom_undeploy_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 drain_elb_on_shutdown: Optional[pulumi.Input[builtins.bool]] = None,
                 ebs_volumes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['JavaAppLayerEbsVolumeArgs', 'JavaAppLayerEbsVolumeArgsDict']]]]] = None,
                 elastic_load_balancer: Optional[pulumi.Input[builtins.str]] = None,
                 install_updates_on_boot: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_shutdown_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 jvm_options: Optional[pulumi.Input[builtins.str]] = None,
                 jvm_type: Optional[pulumi.Input[builtins.str]] = None,
                 jvm_version: Optional[pulumi.Input[builtins.str]] = None,
                 load_based_auto_scaling: Optional[pulumi.Input[Union['JavaAppLayerLoadBasedAutoScalingArgs', 'JavaAppLayerLoadBasedAutoScalingArgsDict']]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 stack_id: Optional[pulumi.Input[builtins.str]] = None,
                 system_packages: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_security_group_ids: Ids for a set of security groups to apply to the layer's instances.
        :param pulumi.Input[builtins.bool] drain_elb_on_shutdown: Whether to enable Elastic Load Balancing connection draining.
        :param pulumi.Input[Sequence[pulumi.Input[Union['JavaAppLayerEbsVolumeArgs', 'JavaAppLayerEbsVolumeArgsDict']]]] ebs_volumes: `ebs_volume` blocks, as described below, will each create an EBS volume and connect it to the layer's instances.
        :param pulumi.Input[builtins.str] elastic_load_balancer: Name of an Elastic Load Balancer to attach to this layer
        :param pulumi.Input[builtins.bool] install_updates_on_boot: Whether to install OS and package updates on each instance when it boots.
        :param pulumi.Input[builtins.int] instance_shutdown_timeout: The time, in seconds, that OpsWorks will wait for Chef to complete after triggering the Shutdown event.
        :param pulumi.Input[builtins.str] jvm_options: Options to set for the JVM.
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            use_ebs_optimized_instances: Optional[pulumi.Input[builtins.bool]] = None) -> 'JavaAppLayer':
        """
        ...
        __props__ = _JavaAppLayerState.__new__(_JavaAppLayerState)
    ...
    @property
    @pulumi.getter(name="appServerVersion")
    def app_server_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Version of the selected application container to use. Defaults to "7".
        """
        return pulumi.get(self, "app_server_version")
    ...
    @property
    @pulumi.getter(name="jvmOptions")
    def jvm_options(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Options to set for the JVM.
        """
        return pulumi.get(self, "jvm_options")
    ...
    @property
    @pulumi.getter(name="jvmType")
    def jvm_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Keyword for the type of JVM to use. Defaults to `openjdk`.
        """
        return pulumi.get(self, "jvm_type")
    ...
    @property
    @pulumi.getter(name="jvmVersion")
    def jvm_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Version of JVM to use. Defaults to "7".
        """
        return pulumi.get(self, "jvm_version")
