...
class JavaAppLayer(pulumi.CustomResource):
    ...
    def __init__(__self__, __name__, __opts__=None, app_server=None, app_server_version=None, auto_assign_elastic_ips=None, auto_assign_public_ips=None, auto_healing=None, custom_configure_recipes=None, custom_deploy_recipes=None, custom_instance_profile_arn=None, custom_json=None, custom_security_group_ids=None, custom_setup_recipes=None, custom_shutdown_recipes=None, custom_undeploy_recipes=None, drain_elb_on_shutdown=None, ebs_volumes=None, elastic_load_balancer=None, install_updates_on_boot=None, instance_shutdown_timeout=None, jvm_options=None, jvm_type=None, jvm_version=None, name=None, stack_id=None, system_packages=None, use_ebs_optimized_instances=None):
        ...
        if app_server_version and not isinstance(app_server_version, basestring):
            raise TypeError('Expected property app_server_version to be a basestring')
        __self__.app_server_version = app_server_version
        """
        Version of the selected application container to use. Defaults to "7".
        """
        __props__['appServerVersion'] = app_server_version
        ...
        if jvm_options and not isinstance(jvm_options, basestring):
            raise TypeError('Expected property jvm_options to be a basestring')
        __self__.jvm_options = jvm_options
        """
        Options to set for the JVM.
        """
        __props__['jvmOptions'] = jvm_options

        if jvm_type and not isinstance(jvm_type, basestring):
            raise TypeError('Expected property jvm_type to be a basestring')
        __self__.jvm_type = jvm_type
        """
        Keyword for the type of JVM to use. Defaults to `openjdk`.
        """
        __props__['jvmType'] = jvm_type

        if jvm_version and not isinstance(jvm_version, basestring):
            raise TypeError('Expected property jvm_version to be a basestring')
        __self__.jvm_version = jvm_version
        """
        Version of JVM to use. Defaults to "7".
        """
        __props__['jvmVersion'] = jvm_version
    ...
    def set_outputs(self, outs):
        ...
        if 'appServerVersion' in outs:
            self.app_server_version = outs['appServerVersion']
        ...
        if 'jvmOptions' in outs:
            self.jvm_options = outs['jvmOptions']
        if 'jvmType' in outs:
            self.jvm_type = outs['jvmType']
        if 'jvmVersion' in outs:
            self.jvm_version = outs['jvmVersion']
        if 'name' in outs:
            self.name = outs['name']
        if 'stackId' in outs:
