...
class InstanceArgs:
    ...
    def _configure(
        ...
        if 'deleteEbs' in kwargs:
            delete_ebs = kwargs['deleteEbs']
        if 'deleteEip' in kwargs:
        ...
        if 'infrastructureClass' in kwargs:
...
class _InstanceState:
    ...
    def _configure(
        ...
        if 'instanceType' in kwargs:
            instance_type = kwargs['instanceType']
        if 'lastServiceErrorId' in kwargs:
