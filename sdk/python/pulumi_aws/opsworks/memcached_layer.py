...
class MemcachedLayerArgs:
    def __init__(__self__, *,
                 ...
                 allocated_memory: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] allocated_memory: Amount of memory to allocate for the cache on each instance, in megabytes. Defaults to 512MB.
    ...
    def allocated_memory(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def allocated_memory(self, value: Optional[pulumi.Input[builtins.int]]):
...
class MemcachedLayer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            use_ebs_optimized_instances: Optional[pulumi.Input[builtins.bool]] = None) -> 'MemcachedLayer':
        """
    ...
    @property
    @pulumi.getter(name="allocatedMemory")
    def allocated_memory(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Amount of memory to allocate for the cache on each instance, in megabytes. Defaults to 512MB.
        """
        return pulumi.get(self, "allocated_memory")
