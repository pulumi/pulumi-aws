...
class MemcachedLayer(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            cloudwatch_configuration = _utilities.configure(cloudwatch_configuration, MemcachedLayerCloudwatchConfigurationArgs, True)
            ...
            load_based_auto_scaling = _utilities.configure(load_based_auto_scaling, MemcachedLayerLoadBasedAutoScalingArgs, True)
