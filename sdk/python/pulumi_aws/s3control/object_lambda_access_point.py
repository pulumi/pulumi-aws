...
class ObjectLambdaAccessPointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] account_id: AWS account ID for the owner of the bucket for which you want to create an Object Lambda Access Point. Defaults to automatically determined account ID of the Terraform AWS provider.
...
class ObjectLambdaAccessPoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 account_id: pulumi.Input[Optional[_builtins.str]] = None,
                 configuration: pulumi.Input[Optional[Union['ObjectLambdaAccessPointConfigurationArgs', 'ObjectLambdaAccessPointConfigurationArgsDict']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
