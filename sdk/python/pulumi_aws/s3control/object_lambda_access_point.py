...
class ObjectLambdaAccessPointArgs:
    def __init__(__self__, *,
        ...
        """
        ObjectLambdaAccessPointArgs._configure(
...
class _ObjectLambdaAccessPointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The name for this Object Lambda Access Point.
        """
        _ObjectLambdaAccessPointState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            account_id=account_id,
            alias=alias,
            arn=arn,
...
class ObjectLambdaAccessPoint(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            ObjectLambdaAccessPointArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if configuration is not None and not isinstance(configuration, ObjectLambdaAccessPointConfigurationArgs):
                configuration = configuration or {}
                def _setter(key, value):
                    configuration[key] = value
                ObjectLambdaAccessPointConfigurationArgs._configure(_setter, **configuration)
