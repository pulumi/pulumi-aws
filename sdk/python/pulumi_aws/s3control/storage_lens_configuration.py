...
class StorageLensConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if storage_lens_configuration is not None and not isinstance(storage_lens_configuration, StorageLensConfigurationStorageLensConfigurationArgs):
                storage_lens_configuration = storage_lens_configuration or {}
                def _setter(key, value):
                    storage_lens_configuration[key] = value
                StorageLensConfigurationStorageLensConfigurationArgs._configure(_setter, **storage_lens_configuration)
