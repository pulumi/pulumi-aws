...
class AccessGrantsLocationArgs:
    ...
    def location_scope(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def location_scope(self, value: pulumi.Input[builtins.str]):
...
class _AccessGrantsLocationState:
    def __init__(__self__, *,
                 access_grants_location_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_grants_location_arn: Amazon Resource Name (ARN) of the S3 Access Grants location.
        :param pulumi.Input[builtins.str] access_grants_location_id: Unique ID of the S3 Access Grants location.
        :param pulumi.Input[builtins.str] iam_role_arn: The ARN of the IAM role that S3 Access Grants should use when fulfilling runtime access
               requests to the location.
        :param pulumi.Input[builtins.str] location_scope: The default S3 URI `s3://` or the URI to a custom location, a specific bucket or prefix.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value map of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    def access_grants_location_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_grants_location_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="locationScope")
    def location_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The default S3 URI `s3://` or the URI to a custom location, a specific bucket or prefix.
        """
        return pulumi.get(self, "location_scope")
    ...
    @location_scope.setter
    def location_scope(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "location_scope", value)
...
@pulumi.type_token("aws:s3control/accessGrantsLocation:AccessGrantsLocation")
class AccessGrantsLocation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="accessGrantsLocationArn")
    def access_grants_location_arn(self) -> pulumi.Output[builtins.str]:
        """
        Amazon Resource Name (ARN) of the S3 Access Grants location.
        """
        return pulumi.get(self, "access_grants_location_arn")
    ...
    @property
    @pulumi.getter(name="locationScope")
    def location_scope(self) -> pulumi.Output[builtins.str]:
        """
        The default S3 URI `s3://` or the URI to a custom location, a specific bucket or prefix.
        """
        return pulumi.get(self, "location_scope")
