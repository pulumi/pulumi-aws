...
class AccessGrantAccessGrantsLocationConfiguration(dict):
    ...
    def __init__(__self__, *,
                 s3_sub_prefix: Optional[builtins.str] = None):
        """
        :param builtins.str s3_sub_prefix: Sub-prefix.
        """
    ...
    def s3_sub_prefix(self) -> Optional[builtins.str]:
        """
        Sub-prefix.
        """
...
class AccessGrantGrantee(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str grantee_identifier: Grantee identifier.
        :param builtins.str grantee_type: Grantee types. Valid values: `DIRECTORY_USER`, `DIRECTORY_GROUP`, `IAM`.
        """
...
class BucketLifecycleConfigurationRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str status: Status of the rule. Valid values: `Enabled` and `Disabled`. Defaults to `Enabled`.
        """
...
class BucketLifecycleConfigurationRuleExpiration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str date: Date the object is to be deleted. Should be in `YYYY-MM-DD` date format, e.g., `2020-09-30`.
        :param builtins.int days: Number of days before the object is to be deleted.
        :param builtins.bool expired_object_delete_marker: Enable to remove a delete marker with no noncurrent versions. Cannot be specified with `date` or `days`.
        """
        if date is not None:
...
class BucketLifecycleConfigurationRuleFilter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str prefix: Object prefix for rule filtering.
        :param Mapping[str, builtins.str] tags: Key-value map of object tags for rule filtering.
        """
...
class ObjectLambdaAccessPointConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] allowed_features: Allowed features. Valid values: `GetObject-Range`, `GetObject-PartNumber`.
        :param builtins.bool cloud_watch_metrics_enabled: Whether or not the CloudWatch metrics configuration is enabled.
        """
...
class ObjectLambdaAccessPointConfigurationTransformationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] actions: The actions of an Object Lambda Access Point configuration. Valid values: `GetObject`.
...
class ObjectLambdaAccessPointConfigurationTransformationConfigurationContentTransformationAwsLambda(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str function_arn: The Amazon Resource Name (ARN) of the AWS Lambda function.
        :param builtins.str function_payload: Additional JSON that provides supplemental data to the Lambda function used to transform objects.
        """
...
class StorageLensConfigurationStorageLensConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool enabled: Whether the S3 Storage Lens configuration is enabled.
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelActivityMetrics(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Whether the activity metrics are enabled.
        """
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelAdvancedCostOptimizationMetrics(dict):
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: Whether advanced cost-optimization metrics are enabled.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelAdvancedDataProtectionMetrics(dict):
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: Whether advanced data-protection metrics are enabled.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelDetailedStatusCodeMetrics(dict):
    def __init__(__self__, *,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: Whether detailed status code metrics are enabled.
        """
        if enabled is not None:
            pulumi.set(__self__, "enabled", enabled)
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetrics(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enabled: Whether prefix-level storage metrics are enabled.
...
class StorageLensConfigurationStorageLensConfigurationAccountLevelBucketLevelPrefixLevelStorageMetricsSelectionCriteria(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str delimiter: The delimiter of the selection criteria being used.
        :param builtins.int max_depth: The max depth of the selection criteria.
        :param builtins.float min_storage_bytes_percentage: The minimum number of storage bytes percentage whose metrics will be selected.
        """
...
class StorageLensConfigurationStorageLensConfigurationAwsOrg(dict):
    def __init__(__self__, *,
                 arn: builtins.str):
        """
        :param builtins.str arn: The Amazon Resource Name (ARN) of the Amazon Web Services organization.
        """
...
class StorageLensConfigurationStorageLensConfigurationDataExportCloudWatchMetrics(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool):
        """
        :param builtins.bool enabled: Whether CloudWatch publishing for S3 Storage Lens metrics is enabled.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestination(dict):
    ...
    def __init__(__self__, *,
                 ...
                 prefix: Optional[builtins.str] = None):
        """
        :param builtins.str account_id: The account ID of the owner of the S3 Storage Lens metrics export bucket.
        :param builtins.str arn: The Amazon Resource Name (ARN) of the bucket.
        :param builtins.str format: The export format. Valid values: `CSV`, `Parquet`.
        :param builtins.str output_schema_version: The schema version of the export file. Valid values: `V_1`.
        ...
        :param builtins.str prefix: The prefix of the destination bucket where the metrics export will be delivered.
        """
...
class StorageLensConfigurationStorageLensConfigurationDataExportS3BucketDestinationEncryptionSseKms(dict):
    ...
    def __init__(__self__, *,
                 key_id: builtins.str):
        """
        :param builtins.str key_id: KMS key ARN.
        """
...
class StorageLensConfigurationStorageLensConfigurationExclude(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] buckets: List of S3 bucket ARNs.
        :param Sequence[builtins.str] regions: List of AWS Regions.
        """
...
class GetMultiRegionAccessPointPublicAccessBlockResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool block_public_acls: Specifies whether Amazon S3 should block public access control lists (ACLs). When set to `true` causes the following behavior:
               * PUT Bucket acl and PUT Object acl calls fail if the specified ACL is public.
               * PUT Object calls fail if the request includes a public ACL.
               * PUT Bucket calls fail if the request includes a public ACL.
        :param builtins.bool block_public_policy: Specifies whether Amazon S3 should block public bucket policies for buckets in this account. When set to `true` causes Amazon S3 to:
               * Reject calls to PUT Bucket policy if the specified bucket policy allows public access.
        :param builtins.bool ignore_public_acls: Specifies whether Amazon S3 should ignore public ACLs for buckets in this account. When set to `true` causes Amazon S3 to:
               * Ignore all public ACLs on buckets in this account and any objects that they contain.
        :param builtins.bool restrict_public_buckets: Specifies whether Amazon S3 should restrict public bucket policies for buckets in this account. When set to `true`:
