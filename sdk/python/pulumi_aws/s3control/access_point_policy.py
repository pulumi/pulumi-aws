...
class AccessPointPolicyArgs:
    ...
    def access_point_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def access_point_arn(self, value: pulumi.Input[builtins.str]):
...
class AccessPointPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="accessPointArn")
    def access_point_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the access point that you want to associate with the specified policy.
        """
        return pulumi.get(self, "access_point_arn")
