...
class MultiRegionAccessPointPolicy(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if details is not None and not isinstance(details, MultiRegionAccessPointPolicyDetailsArgs):
                details = details or {}
                def _setter(key, value):
                    details[key] = value
                MultiRegionAccessPointPolicyDetailsArgs._configure(_setter, **details)
