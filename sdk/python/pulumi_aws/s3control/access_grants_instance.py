...
class AccessGrantsInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] identity_center_arn: The ARN of the AWS IAM Identity Center instance associated with the S3 Access Grants instance.
...
class _AccessGrantsInstanceState:
    def __init__(__self__, *,
                 access_grants_instance_arn: Optional[pulumi.Input[builtins.str]] = None,
                 access_grants_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 account_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] access_grants_instance_arn: Amazon Resource Name (ARN) of the S3 Access Grants instance.
        :param pulumi.Input[builtins.str] access_grants_instance_id: Unique ID of the S3 Access Grants instance.
        :param pulumi.Input[builtins.str] identity_center_application_arn: The ARN of the AWS IAM Identity Center instance application; a subresource of the original Identity Center instance.
        :param pulumi.Input[builtins.str] identity_center_arn: The ARN of the AWS IAM Identity Center instance associated with the S3 Access Grants instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value map of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    def access_grants_instance_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_grants_instance_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_grants_instance_arn", value)

    @property
    @pulumi.getter(name="accessGrantsInstanceId")
    def access_grants_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_grants_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("aws:s3control/accessGrantsInstance:AccessGrantsInstance")
class AccessGrantsInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            identity_center_arn: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'AccessGrantsInstance':
        """
