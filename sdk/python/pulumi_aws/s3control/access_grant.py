...
class AccessGrantArgs:
    ...
    def s3_prefix_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AccessGrantState:
    def __init__(__self__, *,
                 access_grant_arn: Optional[pulumi.Input[builtins.str]] = None,
                 access_grant_id: Optional[pulumi.Input[builtins.str]] = None,
                 access_grants_location_configuration: Optional[pulumi.Input['AccessGrantAccessGrantsLocationConfigurationArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] access_grant_arn: Amazon Resource Name (ARN) of the S3 Access Grant.
        :param pulumi.Input[builtins.str] access_grant_id: Unique ID of the S3 Access Grant.
        :param pulumi.Input['AccessGrantAccessGrantsLocationConfigurationArgs'] access_grants_location_configuration: See Location Configuration below for more details.
        :param pulumi.Input[builtins.str] access_grants_location_id: The ID of the S3 Access Grants location to with the access grant is giving access.
    ...
    def access_grant_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_grant_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_grant_arn", value)

    @property
    @pulumi.getter(name="accessGrantId")
    def access_grant_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def access_grant_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="accessGrantsLocationId")
    def access_grants_location_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the S3 Access Grants location to with the access grant is giving access.
        """
        return pulumi.get(self, "access_grants_location_id")
    ...
    @access_grants_location_id.setter
    def access_grants_location_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "access_grants_location_id", value)
    ...
    def grant_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @grant_scope.setter
    def grant_scope(self, value: Optional[pulumi.Input[builtins.str]]):
