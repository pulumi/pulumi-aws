...
class ContactChannelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] contact_id: Amazon Resource Name (ARN) of the AWS SSM Contact that the contact channel belongs to.
        ...
        :param pulumi.Input[builtins.str] type: Type of the contact channel. One of `SMS`, `VOICE` or `EMAIL`.
        :param pulumi.Input[builtins.str] name: Name of the contact channel. Must be between 1 and 255 characters, and may contain alphanumerics, underscores (`_`), hyphens (`-`), periods (`.`), and spaces.
        """
...
class _ContactChannelState:
    def __init__(__self__, *,
                 activation_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] activation_status: Whether the contact channel is activated. The contact channel must be activated to use it to engage the contact. One of `ACTIVATED` or `NOT_ACTIVATED`.
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the contact channel.
        :param pulumi.Input[builtins.str] contact_id: Amazon Resource Name (ARN) of the AWS SSM Contact that the contact channel belongs to.
        :param pulumi.Input['ContactChannelDeliveryAddressArgs'] delivery_address: Block that contains contact engagement details. See details below.
        :param pulumi.Input[builtins.str] name: Name of the contact channel. Must be between 1 and 255 characters, and may contain alphanumerics, underscores (`_`), hyphens (`-`), periods (`.`), and spaces.
        :param pulumi.Input[builtins.str] type: Type of the contact channel. One of `SMS`, `VOICE` or `EMAIL`.
    ...
    def activation_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def activation_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ContactChannel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            delivery_address: Optional[pulumi.Input[Union['ContactChannelDeliveryAddressArgs', 'ContactChannelDeliveryAddressArgsDict']]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ContactChannel':
        """
    ...
    @property
    @pulumi.getter(name="activationStatus")
    def activation_status(self) -> pulumi.Output[builtins.str]:
        """
        Whether the contact channel is activated. The contact channel must be activated to use it to engage the contact. One of `ACTIVATED` or `NOT_ACTIVATED`.
        """
        return pulumi.get(self, "activation_status")
