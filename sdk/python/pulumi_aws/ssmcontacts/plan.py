...
class PlanArgs:
    def __init__(__self__, *,
                 contact_id: pulumi.Input[builtins.str],
                 stages: pulumi.Input[Sequence[pulumi.Input['PlanStageArgs']]]):
        """
        The set of arguments for constructing a Plan resource.
        :param pulumi.Input[builtins.str] contact_id: The Amazon Resource Name (ARN) of the contact or escalation plan.
    ...
    def contact_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @contact_id.setter
    def contact_id(self, value: pulumi.Input[builtins.str]):
...
class Plan(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="contactId")
    def contact_id(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the contact or escalation plan.
        """
        return pulumi.get(self, "contact_id")
