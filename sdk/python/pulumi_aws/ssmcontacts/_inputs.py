...
if not MYPY:
    class ContactChannelDeliveryAddressArgsDict(TypedDict):
        simple_address: pulumi.Input[builtins.str]
        """
...
class ContactChannelDeliveryAddressArgs:
    def __init__(__self__, *,
                 simple_address: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] simple_address: Details to engage this contact channel. The expected format depends on the contact channel type and is described in the [`ContactChannelAddress` section of the SSM Contacts API Reference](https://docs.aws.amazon.com/incident-manager/latest/APIReference/API_SSMContacts_ContactChannelAddress.html).
        """
        pulumi.set(__self__, "simple_address", simple_address)

    @property
    @pulumi.getter(name="simpleAddress")
    def simple_address(self) -> pulumi.Input[builtins.str]:
        """
        Details to engage this contact channel. The expected format depends on the contact channel type and is described in the [`ContactChannelAddress` section of the SSM Contacts API Reference](https://docs.aws.amazon.com/incident-manager/latest/APIReference/API_SSMContacts_ContactChannelAddress.html).
        """
    ...
    def simple_address(self, value: pulumi.Input[builtins.str]):
...
class PlanStageArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] duration_in_minutes: The time to wait until beginning the next stage. The duration can only be set to 0 if a target is specified.
...
if not MYPY:
    class PlanStageTargetChannelTargetInfoArgsDict(TypedDict):
        contact_channel_id: pulumi.Input[builtins.str]
        """
        The Amazon Resource Name (ARN) of the contact channel.
        """
        retry_interval_in_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PlanStageTargetChannelTargetInfoArgs:
    def __init__(__self__, *,
                 contact_channel_id: pulumi.Input[builtins.str],
                 retry_interval_in_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] contact_channel_id: The Amazon Resource Name (ARN) of the contact channel.
        :param pulumi.Input[builtins.int] retry_interval_in_minutes: The number of minutes to wait before retrying to send engagement if the engagement initially failed.
        """
    ...
    def contact_channel_id(self) -> pulumi.Input[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the contact channel.
        """
    ...
    def contact_channel_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "contact_channel_id", value)

    @property
    @pulumi.getter(name="retryIntervalInMinutes")
    def retry_interval_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of minutes to wait before retrying to send engagement if the engagement initially failed.
        """
    ...
    def retry_interval_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "retry_interval_in_minutes", value)


if not MYPY:
    class PlanStageTargetContactTargetInfoArgsDict(TypedDict):
        is_essential: pulumi.Input[builtins.bool]
        """
...
class PlanStageTargetContactTargetInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] is_essential: A Boolean value determining if the contact's acknowledgement stops the progress of stages in the plan.
        :param pulumi.Input[builtins.str] contact_id: The Amazon Resource Name (ARN) of the contact.
        """
    ...
    def is_essential(self) -> pulumi.Input[builtins.bool]:
        """
        A Boolean value determining if the contact's acknowledgement stops the progress of stages in the plan.
        """
    ...
    @is_essential.setter
    def is_essential(self, value: pulumi.Input[builtins.bool]):
