...
class ContactChannelDeliveryAddress(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str simple_address: Details to engage this contact channel. The expected format depends on the contact channel type and is described in the [`ContactChannelAddress` section of the SSM Contacts API Reference](https://docs.aws.amazon.com/incident-manager/latest/APIReference/API_SSMContacts_ContactChannelAddress.html).
        """
...
class PlanStage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int duration_in_minutes: The time to wait until beginning the next stage. The duration can only be set to 0 if a target is specified.
...
class PlanStageTargetChannelTargetInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 retry_interval_in_minutes: Optional[builtins.int] = None):
        """
        :param builtins.str contact_channel_id: The Amazon Resource Name (ARN) of the contact channel.
        :param builtins.int retry_interval_in_minutes: The number of minutes to wait before retrying to send engagement if the engagement initially failed.
        """
    ...
    def retry_interval_in_minutes(self) -> Optional[builtins.int]:
        """
...
class PlanStageTargetContactTargetInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool is_essential: A Boolean value determining if the contact's acknowledgement stops the progress of stages in the plan.
        :param builtins.str contact_id: The Amazon Resource Name (ARN) of the contact.
        """
...
class GetPlanStageTargetChannelTargetInfoResult(dict):
    def __init__(__self__, *,
                 contact_channel_id: builtins.str,
                 retry_interval_in_minutes: builtins.int):
        pulumi.set(__self__, "contact_channel_id", contact_channel_id)
        pulumi.set(__self__, "retry_interval_in_minutes", retry_interval_in_minutes)
    ...
    @property
    @pulumi.getter(name="retryIntervalInMinutes")
    def retry_interval_in_minutes(self) -> builtins.int:
        return pulumi.get(self, "retry_interval_in_minutes")
