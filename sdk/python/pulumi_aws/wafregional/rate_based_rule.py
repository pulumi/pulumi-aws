...
class RateBasedRuleArgs:
    def __init__(__self__, *,
                 ...
                 rate_key: pulumi.Input[builtins.str],
    ...
    def rate_key(self) -> pulumi.Input[builtins.str]:
        """
        Valid value is IP.
        """
    ...
    @rate_key.setter
    def rate_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rate_key", value)

    @property
    @pulumi.getter(name="rateLimit")
    def rate_limit(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @rate_limit.setter
    def rate_limit(self, value: pulumi.Input[builtins.int]):
...
class _RateBasedRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the WAF Regional Rate Based Rule.
        :param pulumi.Input[builtins.str] metric_name: The name or description for the Amazon CloudWatch metric of this rule.
        :param pulumi.Input[builtins.str] name: The name or description of the rule.
        :param pulumi.Input[Sequence[pulumi.Input['RateBasedRulePredicateArgs']]] predicates: The objects to include in a rule (documented below).
        :param pulumi.Input[builtins.str] rate_key: Valid value is IP.
    ...
    @property
    @pulumi.getter(name="rateKey")
    def rate_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Valid value is IP.
        """
        return pulumi.get(self, "rate_key")
    ...
    @rate_key.setter
    def rate_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rate_key", value)
...
class RateBasedRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="rateKey")
    def rate_key(self) -> pulumi.Output[builtins.str]:
        """
        Valid value is IP.
        """
        return pulumi.get(self, "rate_key")
    ...
    @property
    @pulumi.getter(name="rateLimit")
    def rate_limit(self) -> pulumi.Output[builtins.int]:
        """
        The maximum number of requests, which have an identical value in the field specified by the RateKey, allowed in a five-minute period. Minimum value is 100.
        """
        return pulumi.get(self, "rate_limit")
