...
def get_rate_based_mod(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of the WAF Regional rate based rule.
    """
    __args__ = dict()
    __args__['name'] = name
...
def get_rate_based_mod_output(name: Optional[pulumi.Input[builtins.str]] = None,
