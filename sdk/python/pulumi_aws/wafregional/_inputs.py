...
class ByteMatchSetByteMatchTupleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] text_transformation: The formatting way for web request.
               
               FieldToMatch(field_to_match) support following:
        :param pulumi.Input[builtins.str] target_string: The value that you want AWS WAF to search for. The maximum length of the value is 50 bytes.
        """
...
class ByteMatchSetByteMatchTupleFieldToMatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] data: When the value of Type is HEADER, enter the name of the header that you want AWS WAF to search, for example, User-Agent or Referer. If the value of Type is any other value, omit Data.
        """
...
class IpSetIpSetDescriptorArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: The string like IPV4 or IPV6.
        :param pulumi.Input[builtins.str] value: The CIDR notation.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class SizeConstraintSetSizeConstraintArgs:
    def __init__(__self__, *,
                 ...
                 text_transformation: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] comparison_operator: The type of comparison you want to perform.
               e.g., `EQ`, `NE`, `LT`, `GT`.
               See [docs](https://docs.aws.amazon.com/waf/latest/APIReference/API_wafRegional_SizeConstraint.html) for all supported values.
        ...
        :param pulumi.Input[builtins.int] size: The size in bytes that you want to compare against the size of the specified `field_to_match`.
               Valid values are between 0 - 21474836480 bytes (0 - 20 GB).
        :param pulumi.Input[builtins.str] text_transformation: Text transformations used to eliminate unusual formatting that attackers use in web requests in an effort to bypass AWS WAF.
               If you specify a transformation, AWS WAF performs the transformation on `field_to_match` before inspecting a request for a match.
               e.g., `CMD_LINE`, `HTML_ENTITY_DECODE` or `NONE`.
...
class WebAclDefaultActionArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: Specifies how you want AWS WAF Regional to respond to requests that match the settings in a ruleE.g., `ALLOW`, `BLOCK` or `COUNT`
        """
        pulumi.set(__self__, "type", type)
...
class WebAclRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] priority: Specifies the order in which the rules in a WebACL are evaluated.
               Rules with a lower value are evaluated before rules with a higher value.
        :param pulumi.Input[builtins.str] rule_id: ID of the associated WAF (Regional) rule (e.g., `wafregional.Rule`). WAF (Global) rules cannot be used.
...
class WebAclRuleActionArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: Specifies how you want AWS WAF Regional to respond to requests that match the settings in a rule. Valid values for `action` are `ALLOW`, `BLOCK` or `COUNT`. Valid values for `override_action` are `COUNT` and `NONE`.
        """
        pulumi.set(__self__, "type", type)
...
class XssMatchSetXssMatchTupleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] text_transformation: Which text transformation, if any, to perform on the web request before inspecting the request for cross-site scripting attacks.
        """
        pulumi.set(__self__, "field_to_match", field_to_match)
        pulumi.set(__self__, "text_transformation", text_transformation)
