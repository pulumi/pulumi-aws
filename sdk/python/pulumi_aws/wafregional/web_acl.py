...
class WebAcl(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if logging_configuration is not None and not isinstance(logging_configuration, WebAclLoggingConfigurationArgs):
                logging_configuration = logging_configuration or {}
                def _setter(key, value):
                    logging_configuration[key] = value
                WebAclLoggingConfigurationArgs._configure(_setter, **logging_configuration)
