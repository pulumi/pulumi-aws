...
class WebAcl(pulumi.CustomResource):
    ...
    Configuration block to enable WAF logging. Detailed below.
      ...
      * `redacted_fields` (`dict`) - Configuration block containing parts of the request that you want redacted from the logs. Detailed below.
        ...
        * `field_to_matches` (`list`) - Set of configuration blocks for fields to redact. Detailed below.
    ...
    Set of configuration blocks containing rules for the web ACL. Detailed below.
      ...
      * `override_action` (`dict`) - Configuration block of the override the action that a group requests CloudFront or AWS WAF takes when a web request matches the conditions in the rule.  Only used if `type` is `GROUP`. Detailed below.
    ...
    def __init__(__self__, resource_name, opts=None, default_action=None, logging_configuration=None, metric_name=None, name=None, rules=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **logging_configuration** object supports the following:
          ...
          * `redacted_fields` (`pulumi.Input[dict]`) - Configuration block containing parts of the request that you want redacted from the logs. Detailed below.
            ...
            * `field_to_matches` (`pulumi.Input[list]`) - Set of configuration blocks for fields to redact. Detailed below.
        ...
        The **rules** object supports the following:
          ...
          * `override_action` (`pulumi.Input[dict]`) - Configuration block of the override the action that a group requests CloudFront or AWS WAF takes when a web request matches the conditions in the rule.  Only used if `type` is `GROUP`. Detailed below.
