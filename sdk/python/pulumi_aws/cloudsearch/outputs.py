...
class DomainEndpointOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enforce_https: Enables or disables the requirement that all requests to the domain arrive over HTTPS.
        :param _builtins.str tls_security_policy: The minimum required TLS version. See the [AWS documentation](https://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_DomainEndpointOptions.html) for valid values.
        """
...
class DomainIndexField(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: A unique name for the field. Field names must begin with a letter and be at least 1 and no more than 64 characters long. The allowed characters are: `a`-`z` (lower-case letters), `0`-`9`, and `_` (underscore). The name `score` is reserved and cannot be used as a field name.
        :param _builtins.str type: The field type. Valid values: `date`, `date-array`, `double`, `double-array`, `int`, `int-array`, `literal`, `literal-array`, `text`, `text-array`.
        :param _builtins.str analysis_scheme: The analysis scheme you want to use for a `text` field. The analysis scheme specifies the language-specific text processing options that are used during indexing.
        :param _builtins.str default_value: The default value for the field. This value is used when no value is specified for the field in the document data.
        :param _builtins.bool facet: You can get facet information by enabling this.
        :param _builtins.bool highlight: You can highlight information.
        :param _builtins.bool return_: You can enable returning the value of all searchable fields.
        :param _builtins.bool search: You can set whether this index should be searchable or not.
        :param _builtins.bool sort: You can enable the property to be sortable.
        :param _builtins.str source_fields: A comma-separated list of source fields to map to the field. Specifying a source field copies data from one field to another, enabling you to use the same source data in different ways by configuring different options for the fields.
        """
...
class DomainScalingParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str desired_instance_type: The instance type that you want to preconfigure for your domain. See the [AWS documentation](https://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_ScalingParameters.html) for valid values.
        :param _builtins.int desired_partition_count: The number of partitions you want to preconfigure for your domain. Only valid when you select `search.2xlarge` as the instance type.
        :param _builtins.int desired_replication_count: The number of replicas you want to preconfigure for each index partition.
        """
