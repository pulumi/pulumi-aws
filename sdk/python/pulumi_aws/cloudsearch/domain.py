...
class _DomainState:
    def __init__(__self__, *,
                 ...
                 document_service_endpoint: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The domain's ARN.
        :param pulumi.Input[builtins.str] document_service_endpoint: The service endpoint for updating documents in a search domain.
        :param pulumi.Input[builtins.str] domain_id: An internally generated unique identifier for the domain.
        :param pulumi.Input['DomainEndpointOptionsArgs'] endpoint_options: Domain endpoint options. Documented below.
        :param pulumi.Input[Sequence[pulumi.Input['DomainIndexFieldArgs']]] index_fields: The index fields for documents added to the domain. Documented below.
        :param pulumi.Input[builtins.bool] multi_az: Whether or not to maintain extra instances for the domain in a second Availability Zone to ensure high availability.
        :param pulumi.Input[builtins.str] name: The name of the CloudSearch domain.
    ...
    def document_service_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def document_service_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def search_service_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def search_service_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Domain(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="documentServiceEndpoint")
    def document_service_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The service endpoint for updating documents in a search domain.
        """
        return pulumi.get(self, "document_service_endpoint")
    ...
    @property
    @pulumi.getter(name="searchServiceEndpoint")
    def search_service_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The service endpoint for requesting search results from a search domain.
        """
        return pulumi.get(self, "search_service_endpoint")
