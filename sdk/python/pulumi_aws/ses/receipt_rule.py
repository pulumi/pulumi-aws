...
class ReceiptRuleArgs:
    def __init__(__self__, *,
                 ...
                 after: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] after: The name of the rule to place this rule after
        ...
        :param pulumi.Input[builtins.bool] enabled: If true, the rule will be enabled
        ...
        :param pulumi.Input[builtins.str] tls_policy: `Require` or `Optional`
    ...
    @property
    @pulumi.getter
    def after(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @after.setter
    def after(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scan_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @scan_enabled.setter
    def scan_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ReceiptRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ReceiptRuleAddHeaderActionArgs']]] add_header_actions: A list of Add Header Action blocks. Documented below.
        :param pulumi.Input[builtins.str] after: The name of the rule to place this rule after
        :param pulumi.Input[builtins.str] arn: The SES receipt rule ARN.
        :param pulumi.Input[Sequence[pulumi.Input['ReceiptRuleBounceActionArgs']]] bounce_actions: A list of Bounce Action blocks. Documented below.
        :param pulumi.Input[builtins.bool] enabled: If true, the rule will be enabled
        :param pulumi.Input[Sequence[pulumi.Input['ReceiptRuleLambdaActionArgs']]] lambda_actions: A list of Lambda Action blocks. Documented below.
        :param pulumi.Input[builtins.str] name: The name of the rule
...
class ReceiptRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def after(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the rule to place this rule after
        """
        return pulumi.get(self, "after")
    ...
    @property
    @pulumi.getter
    def recipients(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of email addresses
        """
        return pulumi.get(self, "recipients")
    ...
    @property
    @pulumi.getter(name="scanEnabled")
    def scan_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, incoming emails will be scanned for spam and viruses
        """
        return pulumi.get(self, "scan_enabled")
