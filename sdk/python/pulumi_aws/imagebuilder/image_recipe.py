...
class ImageRecipe(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if systems_manager_agent is not None and not isinstance(systems_manager_agent, ImageRecipeSystemsManagerAgentArgs):
                systems_manager_agent = systems_manager_agent or {}
                def _setter(key, value):
                    systems_manager_agent[key] = value
                ImageRecipeSystemsManagerAgentArgs._configure(_setter, **systems_manager_agent)
