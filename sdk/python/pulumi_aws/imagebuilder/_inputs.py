...
if not MYPY:
    class ContainerRecipeComponentArgsDict(TypedDict):
        component_arn: pulumi.Input[builtins.str]
        """
...
class ContainerRecipeComponentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] component_arn: Amazon Resource Name (ARN) of the Image Builder Component to associate.
    ...
    def component_arn(self) -> pulumi.Input[builtins.str]:
        """
        Amazon Resource Name (ARN) of the Image Builder Component to associate.
        """
    ...
    def component_arn(self, value: pulumi.Input[builtins.str]):
...
class ContainerRecipeComponentParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the component parameter.
        :param pulumi.Input[builtins.str] value: The value for the named component parameter.
        """
...
class ContainerRecipeInstanceConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] image: The AMI ID to use as the base image for a container build and test instance. If not specified, Image Builder will use the appropriate ECS-optimized AMI as a base image.
        """
...
class ContainerRecipeInstanceConfigurationBlockDeviceMappingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] device_name: Name of the device. For example, `/dev/sda` or `/dev/xvdb`.
        ...
        :param pulumi.Input[builtins.bool] no_device: Set to `true` to remove a mapping from the parent image.
        :param pulumi.Input[builtins.str] virtual_name: Virtual device name. For example, `ephemeral0`. Instance store volumes are numbered starting from 0.
        """
...
if not MYPY:
    class ContainerRecipeInstanceConfigurationBlockDeviceMappingEbsArgsDict(TypedDict):
        delete_on_termination: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ContainerRecipeInstanceConfigurationBlockDeviceMappingEbsArgs:
    def __init__(__self__, *,
                 delete_on_termination: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] delete_on_termination: Whether to delete the volume on termination. Defaults to unset, which is the value inherited from the parent image.
        :param pulumi.Input[builtins.str] encrypted: Whether to encrypt the volume. Defaults to unset, which is the value inherited from the parent image.
        :param pulumi.Input[builtins.int] iops: Number of Input/Output (I/O) operations per second to provision for an `io1` or `io2` volume.
        :param pulumi.Input[builtins.str] kms_key_id: Amazon Resource Name (ARN) of the Key Management Service (KMS) Key for encryption.
        :param pulumi.Input[builtins.str] snapshot_id: Identifier of the EC2 Volume Snapshot.
        :param pulumi.Input[builtins.int] throughput: For GP3 volumes only. The throughput in MiB/s that the volume supports.
        :param pulumi.Input[builtins.int] volume_size: Size of the volume, in GiB.
        :param pulumi.Input[builtins.str] volume_type: Type of the volume. For example, `gp2` or `io2`.
        """
    ...
    def delete_on_termination(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether to delete the volume on termination. Defaults to unset, which is the value inherited from the parent image.
        """
    ...
    def delete_on_termination(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ContainerRecipeTargetRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 service: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] repository_name: The name of the container repository where the output container image is stored. This name is prefixed by the repository location.
        :param pulumi.Input[builtins.str] service: The service in which this image is registered. Valid values: `ECR`.
        """
...
if not MYPY:
    class DistributionConfigurationDistributionArgsDict(TypedDict):
        ...
        """
        license_configuration_arns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DistributionConfigurationDistributionArgs:
    ...
    def license_configuration_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of Amazon Resource Names (ARNs) of License Manager License Configurations.
        """
...
if not MYPY:
    class DistributionConfigurationDistributionAmiDistributionConfigurationArgsDict(TypedDict):
        ami_tags: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        target_account_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DistributionConfigurationDistributionAmiDistributionConfigurationArgs:
    def __init__(__self__, *,
                 ami_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 target_account_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] ami_tags: Key-value map of tags to apply to the distributed AMI.
        :param pulumi.Input[builtins.str] description: Description to apply to the distributed AMI.
        :param pulumi.Input[builtins.str] kms_key_id: Amazon Resource Name (ARN) of the Key Management Service (KMS) Key to encrypt the distributed AMI.
        ...
        :param pulumi.Input[builtins.str] name: Name to apply to the distributed AMI.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_account_ids: Set of AWS Account identifiers to distribute the AMI.
        """
    ...
    def ami_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Key-value map of tags to apply to the distributed AMI.
        """
    ...
    @ami_tags.setter
    def ami_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def target_account_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of AWS Account identifiers to distribute the AMI.
        """
    ...
    def target_account_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionArgsDict(TypedDict):
        organization_arns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Set of AWS Organization ARNs to assign.
        """
        organizational_unit_arns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Set of AWS Organizational Unit ARNs to assign.
        """
        user_groups: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionArgs:
    def __init__(__self__, *,
                 organization_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 organizational_unit_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] organization_arns: Set of AWS Organization ARNs to assign.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] organizational_unit_arns: Set of AWS Organizational Unit ARNs to assign.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_groups: Set of EC2 launch permission user groups to assign. Use `all` to distribute a public AMI.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_ids: Set of AWS Account identifiers to assign.
        """
    ...
    def organization_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of AWS Organization ARNs to assign.
        """
    ...
    def organization_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "organization_arns", value)

    @property
    @pulumi.getter(name="organizationalUnitArns")
    def organizational_unit_arns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of AWS Organizational Unit ARNs to assign.
        """
    ...
    def organizational_unit_arns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class DistributionConfigurationDistributionContainerDistributionConfigurationArgsDict(TypedDict):
        ...
        """
        container_tags: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DistributionConfigurationDistributionContainerDistributionConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 container_tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_tags: Set of tags that are attached to the container distribution configuration.
        :param pulumi.Input[builtins.str] description: Description of the container distribution configuration.
        """
    ...
    def container_tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of tags that are attached to the container distribution configuration.
        """
    ...
    def container_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class DistributionConfigurationDistributionFastLaunchConfigurationArgsDict(TypedDict):
        ...
        """
        max_parallel_launches: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DistributionConfigurationDistributionFastLaunchConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 max_parallel_launches: Optional[pulumi.Input[builtins.int]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] account_id: The owner account ID for the fast-launch enabled Windows AMI.
        :param pulumi.Input[builtins.bool] enabled: A Boolean that represents the current state of faster launching for the Windows AMI. Set to `true` to start using Windows faster launching, or `false` to stop using it.
        ...
        :param pulumi.Input[builtins.int] max_parallel_launches: The maximum number of parallel instances that are launched for creating resources.
    ...
    def max_parallel_launches(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of parallel instances that are launched for creating resources.
        """
    ...
    def max_parallel_launches(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] launch_template_id: The ID of the launch template to use for faster launching for a Windows AMI.
        :param pulumi.Input[builtins.str] launch_template_name: The name of the launch template to use for faster launching for a Windows AMI.
        :param pulumi.Input[builtins.str] launch_template_version: The version of the launch template to use for faster launching for a Windows AMI.
        """
...
if not MYPY:
    class DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfigurationArgsDict(TypedDict):
        target_resource_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfigurationArgs:
    def __init__(__self__, *,
                 target_resource_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] target_resource_count: The number of pre-provisioned snapshots to keep on hand for a fast-launch enabled Windows AMI.
        """
    ...
    def target_resource_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of pre-provisioned snapshots to keep on hand for a fast-launch enabled Windows AMI.
        """
    ...
    def target_resource_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class DistributionConfigurationDistributionLaunchTemplateConfigurationArgsDict(TypedDict):
        launch_template_id: pulumi.Input[builtins.str]
        """
...
class DistributionConfigurationDistributionLaunchTemplateConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] launch_template_id: The ID of the Amazon EC2 launch template to use.
        :param pulumi.Input[builtins.str] account_id: The account ID that this configuration applies to.
        :param pulumi.Input[builtins.bool] default: Indicates whether to set the specified Amazon EC2 launch template as the default launch template. Defaults to `true`.
        """
        pulumi.set(__self__, "launch_template_id", launch_template_id)
    ...
    @property
    @pulumi.getter(name="launchTemplateId")
    def launch_template_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the Amazon EC2 launch template to use.
        """
        return pulumi.get(self, "launch_template_id")
    ...
    @launch_template_id.setter
    def launch_template_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "launch_template_id", value)
...
if not MYPY:
    class DistributionConfigurationDistributionS3ExportConfigurationArgsDict(TypedDict):
        disk_image_format: pulumi.Input[builtins.str]
        """
        ...
        """
        s3_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DistributionConfigurationDistributionS3ExportConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] disk_image_format: The disk image format of the exported image (`RAW`, `VHD`, or `VMDK`)
        :param pulumi.Input[builtins.str] role_name: The name of the IAM role to use for exporting.
        :param pulumi.Input[builtins.str] s3_bucket: The name of the S3 bucket to store the exported image in. The bucket needs to exist before the export configuration is created.
        :param pulumi.Input[builtins.str] s3_prefix: The prefix for the exported image.
        """
    ...
    def disk_image_format(self) -> pulumi.Input[builtins.str]:
        """
        The disk image format of the exported image (`RAW`, `VHD`, or `VMDK`)
        """
    ...
    def disk_image_format(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ImageImageScanningConfigurationArgsDict(TypedDict):
        ...
        """
        image_scanning_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ImageImageScanningConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 image_scanning_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] image_scanning_enabled: Indicates whether Image Builder keeps a snapshot of the vulnerability scans that Amazon Inspector runs against the build instance when you create a new image. Defaults to `false`.
        """
    ...
    def image_scanning_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether Image Builder keeps a snapshot of the vulnerability scans that Amazon Inspector runs against the build instance when you create a new image. Defaults to `false`.
        """
    ...
    def image_scanning_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ImageImageScanningConfigurationEcrConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] container_tags: Set of tags for Image Builder to apply to the output container image that that Amazon Inspector scans.
        :param pulumi.Input[builtins.str] repository_name: The name of the container repository that Amazon Inspector scans to identify findings for your container images.
        """
        if container_tags is not None:
            pulumi.set(__self__, "container_tags", container_tags)
...
if not MYPY:
    class ImageImageTestsConfigurationArgsDict(TypedDict):
        image_tests_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether image tests are enabled. Defaults to `true`.
        """
        timeout_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ImageImageTestsConfigurationArgs:
    def __init__(__self__, *,
                 image_tests_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 timeout_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] image_tests_enabled: Whether image tests are enabled. Defaults to `true`.
        :param pulumi.Input[builtins.int] timeout_minutes: Number of minutes before image tests time out. Valid values are between `60` and `1440`. Defaults to `720`.
        """
    ...
    def image_tests_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether image tests are enabled. Defaults to `true`.
        """
    ...
    def image_tests_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "image_tests_enabled", value)

    @property
    @pulumi.getter(name="timeoutMinutes")
    def timeout_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of minutes before image tests time out. Valid values are between `60` and `1440`. Defaults to `720`.
        """
    ...
    def timeout_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ImageOutputResourceAmiArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] account_id: Account identifier of the AMI.
...
if not MYPY:
    class ImageOutputResourceContainerArgsDict(TypedDict):
        image_uris: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ImageOutputResourceContainerArgs:
    def __init__(__self__, *,
                 image_uris: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def image_uris(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of URIs for created containers.
        """
    ...
    @image_uris.setter
    def image_uris(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ImagePipelineImageScanningConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] image_scanning_enabled: Whether image scans are enabled. Defaults to `false`.
        """
        if ecr_configuration is not None:
            pulumi.set(__self__, "ecr_configuration", ecr_configuration)
        if image_scanning_enabled is not None:
...
class ImagePipelineImageScanningConfigurationEcrConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 repository_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] repository_name: The name of the repository to scan
        """
        if container_tags is not None:
            pulumi.set(__self__, "container_tags", container_tags)
        if repository_name is not None:
...
if not MYPY:
    class ImagePipelineScheduleArgsDict(TypedDict):
        ...
        The following arguments are optional:
        """
        pipeline_execution_start_condition: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ImagePipelineScheduleArgs:
    def __init__(__self__, *,
                 schedule_expression: pulumi.Input[builtins.str],
                 pipeline_execution_start_condition: Optional[pulumi.Input[builtins.str]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] schedule_expression: Cron expression of how often the pipeline start condition is evaluated. For example, `cron(0 0 * * ? *)` is evaluated every day at midnight UTC. Configurations using the five field syntax that was previously accepted by the API, such as `cron(0 0 * * *)`, must be updated to the six field syntax. For more information, see the [Image Builder User Guide](https://docs.aws.amazon.com/imagebuilder/latest/userguide/cron-expressions.html).
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] pipeline_execution_start_condition: Condition when the pipeline should trigger a new image build. Valid values are `EXPRESSION_MATCH_AND_DEPENDENCY_UPDATES_AVAILABLE` and `EXPRESSION_MATCH_ONLY`. Defaults to `EXPRESSION_MATCH_AND_DEPENDENCY_UPDATES_AVAILABLE`.
        :param pulumi.Input[builtins.str] timezone: The timezone that applies to the scheduling expression. For example, "Etc/UTC", "America/Los_Angeles" in the [IANA timezone format](https://www.joda.org/joda-time/timezones.html). If not specified this defaults to UTC.
        """
    ...
    def pipeline_execution_start_condition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Condition when the pipeline should trigger a new image build. Valid values are `EXPRESSION_MATCH_AND_DEPENDENCY_UPDATES_AVAILABLE` and `EXPRESSION_MATCH_ONLY`. Defaults to `EXPRESSION_MATCH_AND_DEPENDENCY_UPDATES_AVAILABLE`.
        """
    ...
    def pipeline_execution_start_condition(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ImagePipelineWorkflowArgsDict(TypedDict):
        workflow_arn: pulumi.Input[builtins.str]
        """
        Amazon Resource Name (ARN) of the Image Builder Workflow.

        The following arguments are optional:
        """
        on_failure: NotRequired[pulumi.Input[builtins.str]]
        """
        The action to take if the workflow fails. Must be one of `CONTINUE` or `ABORT`.
        """
        parallel_group: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ImagePipelineWorkflowArgs:
    def __init__(__self__, *,
                 ...
                 parallel_group: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[Sequence[pulumi.Input['ImagePipelineWorkflowParameterArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] workflow_arn: Amazon Resource Name (ARN) of the Image Builder Workflow.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] on_failure: The action to take if the workflow fails. Must be one of `CONTINUE` or `ABORT`.
        :param pulumi.Input[builtins.str] parallel_group: The parallel group in which to run a test Workflow.
    ...
    def workflow_arn(self) -> pulumi.Input[builtins.str]:
        """
        Amazon Resource Name (ARN) of the Image Builder Workflow.
    ...
    @workflow_arn.setter
    def workflow_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def parallel_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The parallel group in which to run a test Workflow.
        """
    ...
    def parallel_group(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ImagePipelineWorkflowParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the Workflow parameter.
        :param pulumi.Input[builtins.str] value: The value of the Workflow parameter.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class ImageRecipeSystemsManagerAgentArgsDict(TypedDict):
        uninstall_after_build: pulumi.Input[builtins.bool]
        """
...
class ImageRecipeSystemsManagerAgentArgs:
    def __init__(__self__, *,
                 uninstall_after_build: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] uninstall_after_build: Whether to remove the Systems Manager Agent after the image has been built.
        """
        pulumi.set(__self__, "uninstall_after_build", uninstall_after_build)

    @property
    @pulumi.getter(name="uninstallAfterBuild")
    def uninstall_after_build(self) -> pulumi.Input[builtins.bool]:
        """
        Whether to remove the Systems Manager Agent after the image has been built.
        """
    ...
    def uninstall_after_build(self, value: pulumi.Input[builtins.bool]):
...
class InfrastructureConfigurationInstanceMetadataOptionsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] http_put_response_hop_limit: The number of hops that an instance can traverse to reach its destonation.
        :param pulumi.Input[builtins.str] http_tokens: Whether a signed token is required for instance metadata retrieval requests. Valid values: `required`, `optional`.
        """
...
class InfrastructureConfigurationLoggingS3LogsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] s3_bucket_name: Name of the S3 Bucket.
               ...
               The following arguments are optional:
        :param pulumi.Input[builtins.str] s3_key_prefix: Prefix to use for S3 logs. Defaults to `/`.
        """
...
class LifecyclePolicyPolicyDetailActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Specifies the lifecycle action to take. Valid values: `DELETE`, `DEPRECATE` or `DISABLE`.
...
if not MYPY:
    class LifecyclePolicyPolicyDetailActionIncludeResourcesArgsDict(TypedDict):
        amis: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies whether the lifecycle action should apply to distributed AMIs.
        """
        containers: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies whether the lifecycle action should apply to distributed containers.
        """
        snapshots: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class LifecyclePolicyPolicyDetailActionIncludeResourcesArgs:
    def __init__(__self__, *,
                 amis: Optional[pulumi.Input[builtins.bool]] = None,
                 containers: Optional[pulumi.Input[builtins.bool]] = None,
                 snapshots: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] amis: Specifies whether the lifecycle action should apply to distributed AMIs.
        :param pulumi.Input[builtins.bool] containers: Specifies whether the lifecycle action should apply to distributed containers.
        :param pulumi.Input[builtins.bool] snapshots: Specifies whether the lifecycle action should apply to snapshots associated with distributed AMIs.
        """
        if amis is not None:
            pulumi.set(__self__, "amis", amis)
        if containers is not None:
    ...
    @property
    @pulumi.getter
    def amis(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether the lifecycle action should apply to distributed AMIs.
        """
        return pulumi.get(self, "amis")
    ...
    @amis.setter
    def amis(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "amis", value)

    @property
    @pulumi.getter
    def containers(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether the lifecycle action should apply to distributed containers.
        """
        return pulumi.get(self, "containers")
    ...
    @containers.setter
    def containers(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "containers", value)

    @property
    @pulumi.getter
    def snapshots(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether the lifecycle action should apply to snapshots associated with distributed AMIs.
        """
    ...
    @snapshots.setter
    def snapshots(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class LifecyclePolicyPolicyDetailExclusionRulesArgsDict(TypedDict):
        ...
        """
        tag_map: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class LifecyclePolicyPolicyDetailExclusionRulesArgs:
    def __init__(__self__, *,
                 ...
                 tag_map: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tag_map: Contains a list of tags that Image Builder uses to skip lifecycle actions for Image Builder image resources that have them.
        """
        if amis is not None:
            pulumi.set(__self__, "amis", amis)
    ...
    def tag_map(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Contains a list of tags that Image Builder uses to skip lifecycle actions for Image Builder image resources that have them.
        """
    ...
    @tag_map.setter
    def tag_map(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class LifecyclePolicyPolicyDetailExclusionRulesAmisArgsDict(TypedDict):
        ...
        """
        shared_accounts: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class LifecyclePolicyPolicyDetailExclusionRulesAmisArgs:
    def __init__(__self__, *,
                 ...
                 tag_map: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.bool] is_public: Configures whether public AMIs are excluded from the lifecycle action.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: Configures AWS Regions that are excluded from the lifecycle action.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] shared_accounts: Specifies AWS accounts whose resources are excluded from the lifecycle action.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tag_map: Lists tags that should be excluded from lifecycle actions for the AMIs that have them.
        """
...
class LifecyclePolicyPolicyDetailExclusionRulesAmisLastLaunchedArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] unit: Defines the unit of time that the lifecycle policy uses to calculate elapsed time since the last instance launched from the AMI. For example: days, weeks, months, or years. Valid values: `DAYS`, `WEEKS`, `MONTHS` or `YEARS`.
        :param pulumi.Input[builtins.int] value: The integer number of units for the time period. For example 6 (months).
        """
...
if not MYPY:
    class LifecyclePolicyPolicyDetailFilterArgsDict(TypedDict):
        ...
        The following arguments are optional:
        """
        retain_at_least: NotRequired[pulumi.Input[builtins.int]]
        """
...
class LifecyclePolicyPolicyDetailFilterArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 value: pulumi.Input[builtins.int],
                 retain_at_least: Optional[pulumi.Input[builtins.int]] = None,
                 unit: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Filter resources based on either age or count. Valid values: `AGE` or `COUNT`.
        :param pulumi.Input[builtins.int] value: The number of units for the time period or for the count. For example, a value of 6 might refer to six months or six AMIs.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.int] retain_at_least: For age-based filters, this is the number of resources to keep on hand after the lifecycle DELETE action is applied. Impacted resources are only deleted if you have more than this number of resources. If you have fewer resources than this number, the impacted resource is not deleted.
        :param pulumi.Input[builtins.str] unit: Defines the unit of time that the lifecycle policy uses to determine impacted resources. This is required for age-based rules. Valid values: `DAYS`, `WEEKS`, `MONTHS` or `YEARS`.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
    ...
    def retain_at_least(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        For age-based filters, this is the number of resources to keep on hand after the lifecycle DELETE action is applied. Impacted resources are only deleted if you have more than this number of resources. If you have fewer resources than this number, the impacted resource is not deleted.
        """
    ...
    def retain_at_least(self, value: Optional[pulumi.Input[builtins.int]]):
...
class LifecyclePolicyResourceSelectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tag_map: A list of tags that are used as selection criteria for the Image Builder image resources that the lifecycle policy applies to.
        """
...
if not MYPY:
    class LifecyclePolicyResourceSelectionRecipeArgsDict(TypedDict):
        ...
        """
        semantic_version: pulumi.Input[builtins.str]
        """
...
class LifecyclePolicyResourceSelectionRecipeArgs:
    def __init__(__self__, *,
                 ...
                 semantic_version: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of an Image Builder recipe that the lifecycle policy uses for resource selection.
        :param pulumi.Input[builtins.str] semantic_version: The version of the Image Builder recipe specified by the name field.
        """
        pulumi.set(__self__, "name", name)
    ...
    def semantic_version(self) -> pulumi.Input[builtins.str]:
        """
        The version of the Image Builder recipe specified by the name field.
        """
    ...
    def semantic_version(self, value: pulumi.Input[builtins.str]):
...
class GetComponentsFilterArgs:
    def __init__(__self__, *,
                 ...
                 values: Sequence[builtins.str]):
        """
        :param builtins.str name: Name of the filter field. Valid values can be found in the [Image Builder ListComponents API Reference](https://docs.aws.amazon.com/imagebuilder/latest/APIReference/API_ListComponents.html).
...
class GetContainerRecipesFilterArgs:
    def __init__(__self__, *,
                 ...
                 values: Sequence[builtins.str]):
        """
        :param builtins.str name: Name of the filter field. Valid values can be found in the [Image Builder ListContainerRecipes API Reference](https://docs.aws.amazon.com/imagebuilder/latest/APIReference/API_ListContainerRecipes.html).
        :param Sequence[builtins.str] values: Set of values that are accepted for the given filter field. Results will be selected if any given value matches.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
...
class GetDistributionConfigurationsFilterArgs:
    def __init__(__self__, *,
                 ...
                 values: Sequence[builtins.str]):
        """
        :param builtins.str name: Name of the filter field. Valid values can be found in the [Image Builder ListDistributionConfigurations API Reference](https://docs.aws.amazon.com/imagebuilder/latest/APIReference/API_ListDistributionConfigurations.html).
        :param Sequence[builtins.str] values: Set of values that are accepted for the given filter field. Results will be selected if any given value matches.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
...
class GetImagePipelinesFilterArgs:
    def __init__(__self__, *,
                 ...
                 values: Sequence[builtins.str]):
        """
        :param builtins.str name: Name of the filter field. Valid values can be found in the [Image Builder ListImagePipelines API Reference](https://docs.aws.amazon.com/imagebuilder/latest/APIReference/API_ListImagePipelines.html).
        :param Sequence[builtins.str] values: Set of values that are accepted for the given filter field. Results will be selected if any given value matches.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
...
class GetImageRecipesFilterArgs:
    def __init__(__self__, *,
                 ...
                 values: Sequence[builtins.str]):
        """
        :param builtins.str name: Name of the filter field. Valid values can be found in the [Image Builder ListImageRecipes API Reference](https://docs.aws.amazon.com/imagebuilder/latest/APIReference/API_ListImageRecipes.html).
        :param Sequence[builtins.str] values: Set of values that are accepted for the given filter field. Results will be selected if any given value matches.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
...
class GetInfrastructureConfigurationsFilterArgs:
    def __init__(__self__, *,
                 ...
                 values: Sequence[builtins.str]):
        """
        :param builtins.str name: Name of the filter field. Valid values can be found in the [Image Builder ListInfrastructureConfigurations API Reference](https://docs.aws.amazon.com/imagebuilder/latest/APIReference/API_ListInfrastructureConfigurations.html).
        :param Sequence[builtins.str] values: Set of values that are accepted for the given filter field. Results will be selected if any given value matches.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
