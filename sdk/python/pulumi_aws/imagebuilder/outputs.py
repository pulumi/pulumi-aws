...
class ContainerRecipeComponent(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str component_arn: Amazon Resource Name (ARN) of the Image Builder Component to associate.
...
class ContainerRecipeComponentParameter(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The name of the component parameter.
        :param builtins.str value: The value for the named component parameter.
        """
...
class ContainerRecipeInstanceConfigurationBlockDeviceMapping(dict):
    ...
    def __init__(__self__, *,
                 ...
                 no_device: Optional[builtins.bool] = None,
                 virtual_name: Optional[builtins.str] = None):
        """
        :param builtins.str device_name: Name of the device. For example, `/dev/sda` or `/dev/xvdb`.
        ...
        :param builtins.bool no_device: Set to `true` to remove a mapping from the parent image.
        :param builtins.str virtual_name: Virtual device name. For example, `ephemeral0`. Instance store volumes are numbered starting from 0.
        """
    ...
    def no_device(self) -> Optional[builtins.bool]:
        """
...
class ContainerRecipeInstanceConfigurationBlockDeviceMappingEbs(dict):
    ...
    def __init__(__self__, *,
                 delete_on_termination: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str delete_on_termination: Whether to delete the volume on termination. Defaults to unset, which is the value inherited from the parent image.
        :param builtins.str encrypted: Whether to encrypt the volume. Defaults to unset, which is the value inherited from the parent image.
        :param builtins.int iops: Number of Input/Output (I/O) operations per second to provision for an `io1` or `io2` volume.
        :param builtins.str kms_key_id: Amazon Resource Name (ARN) of the Key Management Service (KMS) Key for encryption.
        :param builtins.str snapshot_id: Identifier of the EC2 Volume Snapshot.
        :param builtins.int throughput: For GP3 volumes only. The throughput in MiB/s that the volume supports.
        :param builtins.int volume_size: Size of the volume, in GiB.
        :param builtins.str volume_type: Type of the volume. For example, `gp2` or `io2`.
        """
    ...
    def delete_on_termination(self) -> Optional[builtins.str]:
        """
...
class ContainerRecipeTargetRepository(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str service: The service in which this image is registered. Valid values: `ECR`.
        """
...
class DistributionConfigurationDistributionAmiDistributionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] ami_tags: Key-value map of tags to apply to the distributed AMI.
        :param builtins.str description: Description to apply to the distributed AMI.
        :param builtins.str kms_key_id: Amazon Resource Name (ARN) of the Key Management Service (KMS) Key to encrypt the distributed AMI.
        ...
        :param builtins.str name: Name to apply to the distributed AMI.
        :param Sequence[builtins.str] target_account_ids: Set of AWS Account identifiers to distribute the AMI.
        """
...
class DistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermission(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] organization_arns: Set of AWS Organization ARNs to assign.
        :param Sequence[builtins.str] organizational_unit_arns: Set of AWS Organizational Unit ARNs to assign.
        :param Sequence[builtins.str] user_groups: Set of EC2 launch permission user groups to assign. Use `all` to distribute a public AMI.
        :param Sequence[builtins.str] user_ids: Set of AWS Account identifiers to assign.
        """
...
class DistributionConfigurationDistributionContainerDistributionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] container_tags: Set of tags that are attached to the container distribution configuration.
        :param builtins.str description: Description of the container distribution configuration.
        """
...
class DistributionConfigurationDistributionLaunchTemplateConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str launch_template_id: The ID of the Amazon EC2 launch template to use.
        :param builtins.str account_id: The account ID that this configuration applies to.
        :param builtins.bool default: Indicates whether to set the specified Amazon EC2 launch template as the default launch template. Defaults to `true`.
        """
        pulumi.set(__self__, "launch_template_id", launch_template_id)
...
class DistributionConfigurationDistributionS3ExportConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str disk_image_format: The disk image format of the exported image (`RAW`, `VHD`, or `VMDK`)
        :param builtins.str role_name: The name of the IAM role to use for exporting.
        :param builtins.str s3_bucket: The name of the S3 bucket to store the exported image in. The bucket needs to exist before the export configuration is created.
        :param builtins.str s3_prefix: The prefix for the exported image.
        """
...
class ImageImageScanningConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool image_scanning_enabled: Indicates whether Image Builder keeps a snapshot of the vulnerability scans that Amazon Inspector runs against the build instance when you create a new image. Defaults to `false`.
        """
...
class ImageImageScanningConfigurationEcrConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] container_tags: Set of tags for Image Builder to apply to the output container image that that Amazon Inspector scans.
        :param builtins.str repository_name: The name of the container repository that Amazon Inspector scans to identify findings for your container images.
        """
        if container_tags is not None:
            pulumi.set(__self__, "container_tags", container_tags)
...
class ImageImageTestsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool image_tests_enabled: Whether image tests are enabled. Defaults to `true`.
        :param builtins.int timeout_minutes: Number of minutes before image tests time out. Valid values are between `60` and `1440`. Defaults to `720`.
        """
...
class ImageOutputResourceAmi(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_id: Account identifier of the AMI.
...
class ImageOutputResourceContainer(dict):
    ...
    def __init__(__self__, *,
                 image_uris: Optional[Sequence[builtins.str]] = None,
                 region: Optional[builtins.str] = None):
        """
    ...
    def image_uris(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ImagePipelineImageScanningConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool image_scanning_enabled: Whether image scans are enabled. Defaults to `false`.
        """
        if ecr_configuration is not None:
            pulumi.set(__self__, "ecr_configuration", ecr_configuration)
        if image_scanning_enabled is not None:
...
class ImagePipelineImageScanningConfigurationEcrConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 repository_name: Optional[builtins.str] = None):
        """
        :param builtins.str repository_name: The name of the repository to scan
        """
        if container_tags is not None:
            pulumi.set(__self__, "container_tags", container_tags)
        if repository_name is not None:
...
class ImagePipelineSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 pipeline_execution_start_condition: Optional[builtins.str] = None,
                 timezone: Optional[builtins.str] = None):
        """
        :param builtins.str schedule_expression: Cron expression of how often the pipeline start condition is evaluated. For example, `cron(0 0 * * ? *)` is evaluated every day at midnight UTC. Configurations using the five field syntax that was previously accepted by the API, such as `cron(0 0 * * *)`, must be updated to the six field syntax. For more information, see the [Image Builder User Guide](https://docs.aws.amazon.com/imagebuilder/latest/userguide/cron-expressions.html).
               
               The following arguments are optional:
        :param builtins.str pipeline_execution_start_condition: Condition when the pipeline should trigger a new image build. Valid values are `EXPRESSION_MATCH_AND_DEPENDENCY_UPDATES_AVAILABLE` and `EXPRESSION_MATCH_ONLY`. Defaults to `EXPRESSION_MATCH_AND_DEPENDENCY_UPDATES_AVAILABLE`.
        :param builtins.str timezone: The timezone that applies to the scheduling expression. For example, "Etc/UTC", "America/Los_Angeles" in the [IANA timezone format](https://www.joda.org/joda-time/timezones.html). If not specified this defaults to UTC.
        """
    ...
    def pipeline_execution_start_condition(self) -> Optional[builtins.str]:
        """
...
class ImagePipelineWorkflow(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in ImagePipelineWorkflow. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        ImagePipelineWorkflow.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str workflow_arn: Amazon Resource Name (ARN) of the Image Builder Workflow.
               
               The following arguments are optional:
        :param builtins.str on_failure: The action to take if the workflow fails. Must be one of `CONTINUE` or `ABORT`.
        :param builtins.str parallel_group: The parallel group in which to run a test Workflow.
        :param Sequence['ImagePipelineWorkflowParameterArgs'] parameters: Configuration block for the workflow parameters. Detailed below.
        """
...
class ImagePipelineWorkflowParameter(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The name of the Workflow parameter.
        :param builtins.str value: The value of the Workflow parameter.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class ImageRecipeSystemsManagerAgent(dict):
    ...
    def __init__(__self__, *,
                 uninstall_after_build: builtins.bool):
        """
        :param builtins.bool uninstall_after_build: Whether to remove the Systems Manager Agent after the image has been built.
        """
        pulumi.set(__self__, "uninstall_after_build", uninstall_after_build)

    @property
    @pulumi.getter(name="uninstallAfterBuild")
    def uninstall_after_build(self) -> builtins.bool:
        """
...
class InfrastructureConfigurationInstanceMetadataOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int http_put_response_hop_limit: The number of hops that an instance can traverse to reach its destonation.
        :param builtins.str http_tokens: Whether a signed token is required for instance metadata retrieval requests. Valid values: `required`, `optional`.
        """
...
class InfrastructureConfigurationLoggingS3Logs(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str s3_bucket_name: Name of the S3 Bucket.
               ...
               The following arguments are optional:
        :param builtins.str s3_key_prefix: Prefix to use for S3 logs. Defaults to `/`.
        """
...
class InfrastructureConfigurationPlacement(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str availability_zone: Availability Zone where your build and test instances will launch.
        :param builtins.str host_id: ID of the Dedicated Host on which build and test instances run. Conflicts with `host_resource_group_arn`.
        :param builtins.str host_resource_group_arn: ARN of the host resource group in which to launch build and test instances. Conflicts with `host_id`.
        :param builtins.str tenancy: Placement tenancy of the instance. Valid values: `default`, `dedicated` and `host`.
        """
...
class LifecyclePolicyPolicyDetailAction(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LifecyclePolicyPolicyDetailAction. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LifecyclePolicyPolicyDetailAction.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 include_resources: Optional['outputs.LifecyclePolicyPolicyDetailActionIncludeResources'] = None):
        """
        :param builtins.str type: Specifies the lifecycle action to take. Valid values: `DELETE`, `DEPRECATE` or `DISABLE`.
               
               The following arguments are optional:
        :param 'LifecyclePolicyPolicyDetailActionIncludeResourcesArgs' include_resources: Specifies the resources that the lifecycle policy applies to. Detailed below.
        """
...
class LifecyclePolicyPolicyDetailActionIncludeResources(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool amis: Specifies whether the lifecycle action should apply to distributed AMIs.
        :param builtins.bool containers: Specifies whether the lifecycle action should apply to distributed containers.
        :param builtins.bool snapshots: Specifies whether the lifecycle action should apply to snapshots associated with distributed AMIs.
        """
        if amis is not None:
            pulumi.set(__self__, "amis", amis)
        if containers is not None:
...
class LifecyclePolicyPolicyDetailExclusionRules(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LifecyclePolicyPolicyDetailExclusionRules. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LifecyclePolicyPolicyDetailExclusionRules.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 amis: Optional['outputs.LifecyclePolicyPolicyDetailExclusionRulesAmis'] = None,
                 tag_map: Optional[Mapping[str, builtins.str]] = None):
        """
        :param 'LifecyclePolicyPolicyDetailExclusionRulesAmisArgs' amis: Lists configuration values that apply to AMIs that Image Builder should exclude from the lifecycle action. Detailed below.
        :param Mapping[str, builtins.str] tag_map: Contains a list of tags that Image Builder uses to skip lifecycle actions for Image Builder image resources that have them.
        """
        if amis is not None:
            pulumi.set(__self__, "amis", amis)
...
class LifecyclePolicyPolicyDetailExclusionRulesAmis(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LifecyclePolicyPolicyDetailExclusionRulesAmis. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LifecyclePolicyPolicyDetailExclusionRulesAmis.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 ...
                 last_launched: Optional['outputs.LifecyclePolicyPolicyDetailExclusionRulesAmisLastLaunched'] = None,
                 regions: Optional[Sequence[builtins.str]] = None,
                 shared_accounts: Optional[Sequence[builtins.str]] = None,
                 tag_map: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.bool is_public: Configures whether public AMIs are excluded from the lifecycle action.
        :param 'LifecyclePolicyPolicyDetailExclusionRulesAmisLastLaunchedArgs' last_launched: Specifies configuration details for Image Builder to exclude the most recent resources from lifecycle actions. Detailed below.
        :param Sequence[builtins.str] regions: Configures AWS Regions that are excluded from the lifecycle action.
        :param Sequence[builtins.str] shared_accounts: Specifies AWS accounts whose resources are excluded from the lifecycle action.
        :param Mapping[str, builtins.str] tag_map: Lists tags that should be excluded from lifecycle actions for the AMIs that have them.
        """
...
class LifecyclePolicyPolicyDetailExclusionRulesAmisLastLaunched(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.int):
        """
        :param builtins.str unit: Defines the unit of time that the lifecycle policy uses to calculate elapsed time since the last instance launched from the AMI. For example: days, weeks, months, or years. Valid values: `DAYS`, `WEEKS`, `MONTHS` or `YEARS`.
        :param builtins.int value: The integer number of units for the time period. For example 6 (months).
        """
...
class LifecyclePolicyPolicyDetailFilter(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LifecyclePolicyPolicyDetailFilter. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LifecyclePolicyPolicyDetailFilter.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Filter resources based on either age or count. Valid values: `AGE` or `COUNT`.
        :param builtins.int value: The number of units for the time period or for the count. For example, a value of 6 might refer to six months or six AMIs.
               
               The following arguments are optional:
        :param builtins.int retain_at_least: For age-based filters, this is the number of resources to keep on hand after the lifecycle DELETE action is applied. Impacted resources are only deleted if you have more than this number of resources. If you have fewer resources than this number, the impacted resource is not deleted.
        :param builtins.str unit: Defines the unit of time that the lifecycle policy uses to determine impacted resources. This is required for age-based rules. Valid values: `DAYS`, `WEEKS`, `MONTHS` or `YEARS`.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class LifecyclePolicyResourceSelection(dict):
    ...
    def __init__(__self__, *,
                 recipes: Optional[Sequence['outputs.LifecyclePolicyResourceSelectionRecipe']] = None,
                 tag_map: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Sequence['LifecyclePolicyResourceSelectionRecipeArgs'] recipes: A list of recipe that are used as selection criteria for the output images that the lifecycle policy applies to. Detailed below.
        :param Mapping[str, builtins.str] tag_map: A list of tags that are used as selection criteria for the Image Builder image resources that the lifecycle policy applies to.
        """
...
class LifecyclePolicyResourceSelectionRecipe(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in LifecyclePolicyResourceSelectionRecipe. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        LifecyclePolicyResourceSelectionRecipe.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of an Image Builder recipe that the lifecycle policy uses for resource selection.
        :param builtins.str semantic_version: The version of the Image Builder recipe specified by the name field.
        """
        pulumi.set(__self__, "name", name)
...
class GetContainerRecipeComponentResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str component_arn: ARN of the Image Builder Component.
...
class GetContainerRecipeComponentParameterResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: Name of the container recipe.
        :param builtins.str value: Value of the component parameter.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class GetContainerRecipeInstanceConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str image: AMI ID of the base image for container build and test instance.
        """
        pulumi.set(__self__, "block_device_mappings", block_device_mappings)
        pulumi.set(__self__, "image", image)
...
class GetContainerRecipeInstanceConfigurationBlockDeviceMappingResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str no_device: Whether to remove a mapping from the parent image.
        :param builtins.str virtual_name: Virtual device name. For example, `ephemeral0`. Instance store volumes are numbered starting from 0.
        """
        pulumi.set(__self__, "device_name", device_name)
        pulumi.set(__self__, "ebs", ebs)
...
class GetContainerRecipeInstanceConfigurationBlockDeviceMappingEbResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool delete_on_termination: Whether to delete the volume on termination. Defaults to unset, which is the value inherited from the parent image.
        :param builtins.bool encrypted: Whether to encrypt the volume. Defaults to unset, which is the value inherited from the parent image.
        :param builtins.int iops: Number of Input/Output (I/O) operations per second to provision for an `io1` or `io2` volume.
        :param builtins.str kms_key_id: KMS key used to encrypt the container image.
        :param builtins.str snapshot_id: Identifier of the EC2 Volume Snapshot.
        :param builtins.int throughput: For GP3 volumes only. The throughput in MiB/s that the volume supports.
        :param builtins.int volume_size: Size of the volume, in GiB.
        :param builtins.str volume_type: Type of the volume. For example, `gp2` or `io2`.
...
class GetContainerRecipeTargetRepositoryResult(dict):
    def __init__(__self__, *,
                 ...
                 service: builtins.str):
        """
        :param builtins.str repository_name: Name of the container repository where the output container image is stored. The name is prefixed by the repository location.
        :param builtins.str service: Service in which this image is registered.
        """
        pulumi.set(__self__, "repository_name", repository_name)
        pulumi.set(__self__, "service", service)
...
class GetDistributionConfigurationDistributionResult(dict):
    ...
    @property
    @pulumi.getter(name="licenseConfigurationArns")
    def license_configuration_arns(self) -> Sequence[builtins.str]:
        """
        Set of Amazon Resource Names (ARNs) of License Manager License Configurations.
        """
        return pulumi.get(self, "license_configuration_arns")
...
class GetDistributionConfigurationDistributionAmiDistributionConfigurationResult(dict):
    def __init__(__self__, *,
                 ami_tags: Mapping[str, builtins.str],
                 ...
                 name: builtins.str,
                 target_account_ids: Sequence[builtins.str]):
        """
        :param Mapping[str, builtins.str] ami_tags: Key-value map of tags to apply to distributed AMI.
        :param builtins.str description: Description of the container distribution configuration.
        :param builtins.str kms_key_id: ARN of Key Management Service (KMS) Key to encrypt AMI.
        ...
        :param builtins.str name: Name of the distribution configuration.
        :param Sequence[builtins.str] target_account_ids: Set of target AWS Account identifiers.
        """
        pulumi.set(__self__, "ami_tags", ami_tags)
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "kms_key_id", kms_key_id)
    ...
    @property
    @pulumi.getter(name="amiTags")
    def ami_tags(self) -> Mapping[str, builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="targetAccountIds")
    def target_account_ids(self) -> Sequence[builtins.str]:
        """
...
class GetDistributionConfigurationDistributionAmiDistributionConfigurationLaunchPermissionResult(dict):
    def __init__(__self__, *,
                 organization_arns: Sequence[builtins.str],
                 organizational_unit_arns: Sequence[builtins.str],
                 user_groups: Sequence[builtins.str],
                 user_ids: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] organization_arns: Set of AWS Organization ARNs.
        :param Sequence[builtins.str] organizational_unit_arns: Set of AWS Organizational Unit ARNs.
        :param Sequence[builtins.str] user_groups: Set of EC2 launch permission user groups.
        :param Sequence[builtins.str] user_ids: Set of AWS Account identifiers.
        """
        pulumi.set(__self__, "organization_arns", organization_arns)
        pulumi.set(__self__, "organizational_unit_arns", organizational_unit_arns)
        pulumi.set(__self__, "user_groups", user_groups)
    ...
    @property
    @pulumi.getter(name="organizationArns")
    def organization_arns(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="organizationalUnitArns")
    def organizational_unit_arns(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="userGroups")
    def user_groups(self) -> Sequence[builtins.str]:
        """
...
class GetDistributionConfigurationDistributionContainerDistributionConfigurationResult(dict):
    def __init__(__self__, *,
                 container_tags: Sequence[builtins.str],
                 description: builtins.str,
    ...
    @property
    @pulumi.getter(name="containerTags")
    def container_tags(self) -> Sequence[builtins.str]:
        """
        Set of tags that are attached to the container distribution configuration.
        """
        return pulumi.get(self, "container_tags")
...
class GetDistributionConfigurationDistributionContainerDistributionConfigurationTargetRepositoryResult(dict):
    def __init__(__self__, *,
                 ...
                 service: builtins.str):
        """
        :param builtins.str repository_name: Name of the container repository where the output container image is stored.
        :param builtins.str service: Service in which the image is registered.
        """
        pulumi.set(__self__, "repository_name", repository_name)
        pulumi.set(__self__, "service", service)
...
class GetDistributionConfigurationDistributionFastLaunchConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 max_parallel_launches: builtins.int,
        ...
        """
        :param builtins.str account_id: The account ID that this configuration applies to.
        :param builtins.bool enabled: A Boolean that represents the current state of faster launching for the Windows AMI.
    ...
    @property
    @pulumi.getter(name="maxParallelLaunches")
    def max_parallel_launches(self) -> builtins.int:
        """
        The maximum number of parallel instances that are launched for creating resources.
        """
        return pulumi.get(self, "max_parallel_launches")
...
class GetDistributionConfigurationDistributionFastLaunchConfigurationLaunchTemplateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str launch_template_id: ID of the Amazon EC2 launch template.
        :param builtins.str launch_template_name: The name of the launch template to use for faster launching for a Windows AMI.
        :param builtins.str launch_template_version: The version of the launch template to use for faster launching for a Windows AMI.
        """
        pulumi.set(__self__, "launch_template_id", launch_template_id)
...
class GetDistributionConfigurationDistributionFastLaunchConfigurationSnapshotConfigurationResult(dict):
    def __init__(__self__, *,
                 target_resource_count: builtins.int):
        """
        :param builtins.int target_resource_count: The number of pre-provisioned snapshots to keep on hand for a fast-launch enabled Windows AMI.
        """
        pulumi.set(__self__, "target_resource_count", target_resource_count)
    ...
    @property
    @pulumi.getter(name="targetResourceCount")
    def target_resource_count(self) -> builtins.int:
        """
        The number of pre-provisioned snapshots to keep on hand for a fast-launch enabled Windows AMI.
        """
        return pulumi.get(self, "target_resource_count")
...
class GetDistributionConfigurationDistributionLaunchTemplateConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_id: The account ID that this configuration applies to.
        :param builtins.bool default: Whether the specified Amazon EC2 launch template is set as the default launch template.
        :param builtins.str launch_template_id: ID of the Amazon EC2 launch template.
        """
        pulumi.set(__self__, "account_id", account_id)
        pulumi.set(__self__, "default", default)
...
class GetDistributionConfigurationDistributionS3ExportConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str disk_image_format: The disk image format of the exported image (`RAW`, `VHD`, or `VMDK`)
        :param builtins.str role_name: The name of the IAM role to use for exporting.
        :param builtins.str s3_bucket: The name of the S3 bucket to store the exported image in.
        :param builtins.str s3_prefix: The prefix for the exported image.
        """
        pulumi.set(__self__, "disk_image_format", disk_image_format)
        pulumi.set(__self__, "role_name", role_name)
...
class GetImageImageScanningConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 image_scanning_enabled: builtins.bool):
        """
        ...
        :param builtins.bool image_scanning_enabled: Indicates whether Image Builder keeps a snapshot of the vulnerability scans that Amazon Inspector runs against the build instance when you create a new image.
        """
    ...
    @property
    @pulumi.getter(name="imageScanningEnabled")
    def image_scanning_enabled(self) -> builtins.bool:
        """
...
class GetImageImageTestsConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool image_tests_enabled: Whether image tests are enabled.
        :param builtins.int timeout_minutes: Number of minutes before image tests time out.
        """
        pulumi.set(__self__, "image_tests_enabled", image_tests_enabled)
        pulumi.set(__self__, "timeout_minutes", timeout_minutes)
    ...
    @property
    @pulumi.getter(name="imageTestsEnabled")
    def image_tests_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="timeoutMinutes")
    def timeout_minutes(self) -> builtins.int:
        """
...
class GetImageOutputResourceContainerResult(dict):
    def __init__(__self__, *,
                 image_uris: Sequence[builtins.str],
                 region: builtins.str):
        """
        :param Sequence[builtins.str] image_uris: Set of URIs for created containers.
        :param builtins.str region: Region of the container image.
    ...
    @property
    @pulumi.getter(name="imageUris")
    def image_uris(self) -> Sequence[builtins.str]:
        """
        Set of URIs for created containers.
        """
        return pulumi.get(self, "image_uris")
...
class GetImagePipelineImageScanningConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool image_scanning_enabled: Whether image scanning is enabled.
        """
        pulumi.set(__self__, "ecr_configurations", ecr_configurations)
        pulumi.set(__self__, "image_scanning_enabled", image_scanning_enabled)
...
class GetImagePipelineImageScanningConfigurationEcrConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 repository_name: builtins.str):
        """
        :param Sequence[builtins.str] container_tags: Tags that are added to the output containers that are scanned
        :param builtins.str repository_name: The name of the container repository that Amazon Inspector scans
        """
        pulumi.set(__self__, "container_tags", container_tags)
        pulumi.set(__self__, "repository_name", repository_name)
...
class GetImagePipelineScheduleResult(dict):
    def __init__(__self__, *,
                 ...
                 schedule_expression: builtins.str):
        """
        :param builtins.str pipeline_execution_start_condition: Condition when the pipeline should trigger a new image build.
        :param builtins.str schedule_expression: Cron expression of how often the pipeline start condition is evaluated.
        """
        pulumi.set(__self__, "pipeline_execution_start_condition", pipeline_execution_start_condition)
        pulumi.set(__self__, "schedule_expression", schedule_expression)
...
class GetImageRecipeBlockDeviceMappingEbResult(dict):
    def __init__(__self__, *,
                 delete_on_termination: builtins.str,
        ...
        :param builtins.str encrypted: Whether to encrypt the volume. Defaults to unset, which is the value inherited from the parent image.
        :param builtins.int iops: Number of Input/Output (I/O) operations per second to provision for an `io1` or `io2` volume.
        :param builtins.str kms_key_id: ARN of the Key Management Service (KMS) Key for encryption.
        :param builtins.str snapshot_id: Identifier of the EC2 Volume Snapshot.
        :param builtins.int throughput: For GP3 volumes only. The throughput in MiB/s that the volume supports.
        :param builtins.int volume_size: Size of the volume, in GiB.
        :param builtins.str volume_type: Type of the volume. For example, `gp2` or `io2`.
...
class GetImageRecipeComponentParameterResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: Name of the image recipe.
        :param builtins.str value: Value of the component parameter.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class GetInfrastructureConfigurationInstanceMetadataOptionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int http_put_response_hop_limit: Number of hops that an instance can traverse to reach its destonation.
        :param builtins.str http_tokens: Whether a signed token is required for instance metadata retrieval requests.
        """
        pulumi.set(__self__, "http_put_response_hop_limit", http_put_response_hop_limit)
        pulumi.set(__self__, "http_tokens", http_tokens)
...
class GetInfrastructureConfigurationLoggingS3LogResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str s3_bucket_name: Name of the S3 Bucket for logging.
        :param builtins.str s3_key_prefix: Key prefix for S3 Bucket logging.
        """
        pulumi.set(__self__, "s3_bucket_name", s3_bucket_name)
        pulumi.set(__self__, "s3_key_prefix", s3_key_prefix)
...
class GetInfrastructureConfigurationPlacementResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str availability_zone: Availability Zone where your build and test instances will launch.
        :param builtins.str host_id: ID of the Dedicated Host on which build and test instances run.
        :param builtins.str host_resource_group_arn: ARN of the host resource group in which to launch build and test instances.
        :param builtins.str tenancy: Placement tenancy of the instance.
        """
        pulumi.set(__self__, "availability_zone", availability_zone)
        pulumi.set(__self__, "host_id", host_id)
        pulumi.set(__self__, "host_resource_group_arn", host_resource_group_arn)
