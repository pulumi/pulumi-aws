...
class ComponentArgs:
    ...
    def supported_os_versions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def supported_os_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ComponentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: (Required) Amazon Resource Name (ARN) of the component.
        :param pulumi.Input[builtins.str] change_description: Change description of the component.
        :param pulumi.Input[builtins.str] data: Inline YAML string with data of the component. Exactly one of `data` and `uri` can be specified. the provider will only perform drift detection of its value when present in a configuration.
        :param pulumi.Input[builtins.str] date_created: Date the component was created.
        :param pulumi.Input[builtins.str] description: Description of the component.
        :param pulumi.Input[builtins.bool] encrypted: Encryption status of the component.
        :param pulumi.Input[builtins.str] kms_key_id: Amazon Resource Name (ARN) of the Key Management Service (KMS) Key used to encrypt the component.
        :param pulumi.Input[builtins.str] name: Name of the component.
        ...
        :param pulumi.Input[builtins.str] type: Type of the component.
        :param pulumi.Input[builtins.str] uri: S3 URI with data of the component. Exactly one of `data` and `uri` can be specified.
...
class Component(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'Component':
        """
    ...
    @property
    @pulumi.getter(name="supportedOsVersions")
    def supported_os_versions(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Set of Operating Systems (OS) supported by the component.
        """
        return pulumi.get(self, "supported_os_versions")
