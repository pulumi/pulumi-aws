...
class DistributionConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the distribution configuration.
        :param pulumi.Input[builtins.str] name: Name of the distribution configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value map of resource tags for the distribution configuration. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
...
class _DistributionConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: (Required) Amazon Resource Name (ARN) of the distribution configuration.
        :param pulumi.Input[builtins.str] date_created: Date the distribution configuration was created.
        :param pulumi.Input[builtins.str] date_updated: Date the distribution configuration was updated.
        :param pulumi.Input[builtins.str] description: Description of the distribution configuration.
        :param pulumi.Input[Sequence[pulumi.Input['DistributionConfigurationDistributionArgs']]] distributions: One or more configuration blocks with distribution settings. Detailed below.
...
class DistributionConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'DistributionConfiguration':
        """
