...
class ContainerRecipe(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if target_repository is not None and not isinstance(target_repository, ContainerRecipeTargetRepositoryArgs):
                target_repository = target_repository or {}
                def _setter(key, value):
                    target_repository[key] = value
                ContainerRecipeTargetRepositoryArgs._configure(_setter, **target_repository)
