...
class Image(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if image_scanning_configuration is not None and not isinstance(image_scanning_configuration, ImageImageScanningConfigurationArgs):
                image_scanning_configuration = image_scanning_configuration or {}
                def _setter(key, value):
                    image_scanning_configuration[key] = value
                ImageImageScanningConfigurationArgs._configure(_setter, **image_scanning_configuration)
            __props__.__dict__["image_scanning_configuration"] = image_scanning_configuration
            if image_tests_configuration is not None and not isinstance(image_tests_configuration, ImageImageTestsConfigurationArgs):
                image_tests_configuration = image_tests_configuration or {}
                def _setter(key, value):
                    image_tests_configuration[key] = value
                ImageImageTestsConfigurationArgs._configure(_setter, **image_tests_configuration)
