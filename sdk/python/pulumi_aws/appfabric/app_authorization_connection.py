...
class AppAuthorizationConnectionArgs:
    def __init__(__self__, *,
                 app_authorization_arn: pulumi.Input[builtins.str],
    ...
    def app_authorization_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def app_authorization_arn(self, value: pulumi.Input[builtins.str]):
...
class _AppAuthorizationConnectionState:
    def __init__(__self__, *,
                 ...
                 app_authorization_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] app: The name of the application.
        :param pulumi.Input[builtins.str] app_authorization_arn: The Amazon Resource Name (ARN) or Universal Unique Identifier (UUID) of the app authorization to use for the request.
        :param pulumi.Input[builtins.str] app_bundle_arn: The Amazon Resource Name (ARN) of the app bundle to use for the request.
        :param pulumi.Input['AppAuthorizationConnectionAuthRequestArgs'] auth_request: Contains OAuth2 authorization information.This is required if the app authorization for the request is configured with an OAuth2 (oauth2) authorization type.
    ...
    @property
    @pulumi.getter(name="appAuthorizationArn")
    def app_authorization_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) or Universal Unique Identifier (UUID) of the app authorization to use for the request.
        """
        return pulumi.get(self, "app_authorization_arn")
    ...
    @app_authorization_arn.setter
    def app_authorization_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "app_authorization_arn", value)
...
class AppAuthorizationConnection(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="appAuthorizationArn")
    def app_authorization_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) or Universal Unique Identifier (UUID) of the app authorization to use for the request.
        """
        return pulumi.get(self, "app_authorization_arn")
