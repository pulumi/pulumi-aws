...
class StackArgs:
    def __init__(__self__, *,
                 ...
                 embed_host_domains: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] description: Description for the AppStream stack.
        :param pulumi.Input[builtins.str] display_name: Stack name to display.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] embed_host_domains: Domains where AppStream 2.0 streaming sessions can be embedded in an iframe. You must approve the domains that you want to host embedded AppStream 2.0 streaming sessions.
        :param pulumi.Input[builtins.str] feedback_url: URL that users are redirected to after they click the Send Feedback link. If no URL is specified, no Send Feedback link is displayed. .
        :param pulumi.Input[builtins.str] name: Unique name for the AppStream stack.
    ...
    def embed_host_domains(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def embed_host_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "embed_host_domains", value)

    @property
    @pulumi.getter(name="feedbackUrl")
    def feedback_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @feedback_url.setter
    def feedback_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _StackState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['StackApplicationSettingsArgs'] application_settings: Settings for application settings persistence.
               See `application_settings` below.
        :param pulumi.Input[builtins.str] arn: ARN of the appstream stack.
        :param pulumi.Input[builtins.str] created_time: Date and time, in UTC and extended RFC 3339 format, when the stack was created.
        :param pulumi.Input[builtins.str] description: Description for the AppStream stack.
        :param pulumi.Input[builtins.str] display_name: Stack name to display.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] embed_host_domains: Domains where AppStream 2.0 streaming sessions can be embedded in an iframe. You must approve the domains that you want to host embedded AppStream 2.0 streaming sessions.
        :param pulumi.Input[builtins.str] feedback_url: URL that users are redirected to after they click the Send Feedback link. If no URL is specified, no Send Feedback link is displayed. .
...
class Stack(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="embedHostDomains")
    def embed_host_domains(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Domains where AppStream 2.0 streaming sessions can be embedded in an iframe. You must approve the domains that you want to host embedded AppStream 2.0 streaming sessions.
        """
        return pulumi.get(self, "embed_host_domains")
    ...
    @property
    @pulumi.getter(name="feedbackUrl")
    def feedback_url(self) -> pulumi.Output[builtins.str]:
        """
        URL that users are redirected to after they click the Send Feedback link. If no URL is specified, no Send Feedback link is displayed. .
        """
        return pulumi.get(self, "feedback_url")
