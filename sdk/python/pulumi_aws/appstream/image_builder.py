...
class ImageBuilderArgs:
    def __init__(__self__, *,
                 ...
                 appstream_agent_version: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 domain_join_info: Optional[pulumi.Input['ImageBuilderDomainJoinInfoArgs']] = None,
                 enable_default_internet_access: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_type: Instance type to use when launching the image builder.
        ...
        :param pulumi.Input[builtins.str] appstream_agent_version: Version of the AppStream 2.0 agent to use for this image builder.
        :param pulumi.Input[builtins.str] description: Description to display.
        :param pulumi.Input[builtins.str] display_name: Human-readable friendly name for the AppStream image builder.
        ...
        :param pulumi.Input[builtins.bool] enable_default_internet_access: Enables or disables default internet access for the image builder.
        :param pulumi.Input[builtins.str] iam_role_arn: ARN of the IAM role to apply to the image builder.
        :param pulumi.Input[builtins.str] image_arn: ARN of the public, private, or shared image to use.
        :param pulumi.Input[builtins.str] image_name: Name of the image used to create the image builder.
        :param pulumi.Input[builtins.str] name: Unique name for the image builder.
    ...
    def appstream_agent_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def appstream_agent_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enable_default_internet_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_default_internet_access(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ImageBuilderState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ImageBuilderAccessEndpointArgs']]] access_endpoints: Set of interface VPC endpoint (interface endpoint) objects. Maximum of 4. See below.
        :param pulumi.Input[builtins.str] appstream_agent_version: Version of the AppStream 2.0 agent to use for this image builder.
        :param pulumi.Input[builtins.str] arn: ARN of the appstream image builder.
        :param pulumi.Input[builtins.str] created_time: Date and time, in UTC and extended RFC 3339 format, when the image builder was created.
        :param pulumi.Input[builtins.str] description: Description to display.
        :param pulumi.Input[builtins.str] display_name: Human-readable friendly name for the AppStream image builder.
        :param pulumi.Input['ImageBuilderDomainJoinInfoArgs'] domain_join_info: Configuration block for the name of the directory and organizational unit (OU) to use to join the image builder to a Microsoft Active Directory domain. See below.
        :param pulumi.Input[builtins.bool] enable_default_internet_access: Enables or disables default internet access for the image builder.
        ...
        :param pulumi.Input[builtins.str] name: Unique name for the image builder.
               ...
               The following arguments are optional:
        :param pulumi.Input[builtins.str] state: State of the image builder. For valid values, refer to the [AWS documentation](https://docs.aws.amazon.com/appstream2/latest/APIReference/API_ImageBuilder.html#AppStream2-Type-ImageBuilder-State).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of tags to assign to the instance. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
...
class ImageBuilder(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="appstreamAgentVersion")
    def appstream_agent_version(self) -> pulumi.Output[builtins.str]:
        """
        Version of the AppStream 2.0 agent to use for this image builder.
        """
        return pulumi.get(self, "appstream_agent_version")
    ...
    @property
    @pulumi.getter(name="enableDefaultInternetAccess")
    def enable_default_internet_access(self) -> pulumi.Output[builtins.bool]:
        """
        Enables or disables default internet access for the image builder.
        """
        return pulumi.get(self, "enable_default_internet_access")
