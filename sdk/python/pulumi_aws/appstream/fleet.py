...
class FleetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_type: Instance type to use when launching fleet instances.
        :param pulumi.Input[builtins.str] description: Description to display.
        :param pulumi.Input[builtins.int] disconnect_timeout_in_seconds: Amount of time that a streaming session remains active after users disconnect.
        :param pulumi.Input[builtins.str] display_name: Human-readable friendly name for the AppStream fleet.
        ...
        :param pulumi.Input[builtins.bool] enable_default_internet_access: Enables or disables default internet access for the fleet.
        :param pulumi.Input[builtins.str] fleet_type: Fleet type. Valid values are: `ON_DEMAND`, `ALWAYS_ON`
        :param pulumi.Input[builtins.str] iam_role_arn: ARN of the IAM role to apply to the fleet.
        :param pulumi.Input[builtins.int] idle_disconnect_timeout_in_seconds: Amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the `disconnect_timeout_in_seconds` time interval begins. Defaults to `0`. Valid value is between `60` and `3600 `seconds.
        :param pulumi.Input[builtins.str] image_arn: ARN of the public, private, or shared image to use.
        :param pulumi.Input[builtins.str] image_name: Name of the image used to create the fleet.
        :param pulumi.Input[builtins.int] max_sessions_per_instance: The maximum number of user sessions on an instance. This only applies to multi-session fleets.
        :param pulumi.Input[builtins.int] max_user_duration_in_seconds: Maximum amount of time that a streaming session can remain active, in seconds.
    ...
    def max_sessions_per_instance(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_sessions_per_instance(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @stream_view.setter
    def stream_view(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FleetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the appstream fleet.
        :param pulumi.Input['FleetComputeCapacityArgs'] compute_capacity: Configuration block for the desired capacity of the fleet. See below.
        :param pulumi.Input[builtins.str] created_time: Date and time, in UTC and extended RFC 3339 format, when the fleet was created.
        :param pulumi.Input[builtins.str] description: Description to display.
        :param pulumi.Input[builtins.int] disconnect_timeout_in_seconds: Amount of time that a streaming session remains active after users disconnect.
        :param pulumi.Input[builtins.str] display_name: Human-readable friendly name for the AppStream fleet.
        :param pulumi.Input['FleetDomainJoinInfoArgs'] domain_join_info: Configuration block for the name of the directory and organizational unit (OU) to use to join the fleet to a Microsoft Active Directory domain. See below.
...
class Fleet(pulumi.CustomResource):
    ...
    pulumi_type = "aws:appstream/fleet:Fleet"
    ...
    @property
    @pulumi.getter(name="disconnectTimeoutInSeconds")
    def disconnect_timeout_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        Amount of time that a streaming session remains active after users disconnect.
        """
        return pulumi.get(self, "disconnect_timeout_in_seconds")
    ...
    @property
    @pulumi.getter(name="idleDisconnectTimeoutInSeconds")
    def idle_disconnect_timeout_in_seconds(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Amount of time that users can be idle (inactive) before they are disconnected from their streaming session and the `disconnect_timeout_in_seconds` time interval begins. Defaults to `0`. Valid value is between `60` and `3600 `seconds.
        """
        return pulumi.get(self, "idle_disconnect_timeout_in_seconds")
    ...
    @property
    @pulumi.getter(name="maxSessionsPerInstance")
    def max_sessions_per_instance(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The maximum number of user sessions on an instance. This only applies to multi-session fleets.
        """
        return pulumi.get(self, "max_sessions_per_instance")
    ...
    @property
    @pulumi.getter(name="maxUserDurationInSeconds")
    def max_user_duration_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        Maximum amount of time that a streaming session can remain active, in seconds.
        """
        return pulumi.get(self, "max_user_duration_in_seconds")
    ...
    @property
    @pulumi.getter(name="streamView")
    def stream_view(self) -> pulumi.Output[builtins.str]:
        """
        AppStream 2.0 view that is displayed to your users when they stream from the fleet. When `APP` is specified, only the windows of applications opened by users display. When `DESKTOP` is specified, the standard desktop that is provided by the operating system displays. If not specified, defaults to `APP`.
        """
        return pulumi.get(self, "stream_view")
