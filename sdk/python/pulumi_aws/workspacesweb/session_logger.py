...
class _SessionLoggerState:
    def __init__(__self__, *,
                 ...
                 customer_managed_key: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 event_filter: pulumi.Input[Optional['SessionLoggerEventFilterArgs']] = None,
                 log_configuration: pulumi.Input[Optional['SessionLoggerLogConfigurationArgs']] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="eventFilter")
    def event_filter(self) -> pulumi.Input[Optional['SessionLoggerEventFilterArgs']]:
        """
        Event filter that determines which events are logged. See Event Filter below.
        """
        return pulumi.get(self, "event_filter")
    ...
    @event_filter.setter
    def event_filter(self, value: pulumi.Input[Optional['SessionLoggerEventFilterArgs']]):
        pulumi.set(self, "event_filter", value)

    @_builtins.property
    @pulumi.getter(name="logConfiguration")
    def log_configuration(self) -> pulumi.Input[Optional['SessionLoggerLogConfigurationArgs']]:
        """
        Configuration block for specifying where logs are delivered. See Log Configuration below.
    ...
    @log_configuration.setter
    def log_configuration(self, value: pulumi.Input[Optional['SessionLoggerLogConfigurationArgs']]):
        pulumi.set(self, "log_configuration", value)
...
class SessionLogger(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            session_logger_arn: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'SessionLogger':
        """
