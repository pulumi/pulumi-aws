...
class EnvironmentEC2Args:
    def __init__(__self__, *,
                 ...
                 automatic_stop_time_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 connection_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 owner_arn: Optional[pulumi.Input[builtins.str]] = None,
                 subnet_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a EnvironmentEC2 resource.
        :param pulumi.Input[builtins.str] image_id: The identifier for the Amazon Machine Image (AMI) that's used to create the EC2 instance. Valid values are
        ...
        :param pulumi.Input[builtins.str] instance_type: The type of instance to connect to the environment, e.g., `t2.micro`.
        :param pulumi.Input[builtins.int] automatic_stop_time_minutes: The number of minutes until the running instance is shut down after the environment has last been used.
        :param pulumi.Input[builtins.str] connection_type: The connection type used for connecting to an Amazon EC2 environment. Valid values are `CONNECT_SSH` and `CONNECT_SSM`. For more information please refer [AWS documentation for Cloud9](https://docs.aws.amazon.com/cloud9/latest/user-guide/ec2-ssm.html).
        ...
        :param pulumi.Input[builtins.str] owner_arn: The ARN of the environment owner. This can be ARN of any AWS IAM principal. Defaults to the environment's creator.
        :param pulumi.Input[builtins.str] subnet_id: The ID of the subnet in Amazon VPC that AWS Cloud9 will use to communicate with the Amazon EC2 instance.
    ...
    def automatic_stop_time_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def automatic_stop_time_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def owner_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @owner_arn.setter
    def owner_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EnvironmentEC2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the environment.
        :param pulumi.Input[builtins.int] automatic_stop_time_minutes: The number of minutes until the running instance is shut down after the environment has last been used.
        :param pulumi.Input[builtins.str] connection_type: The connection type used for connecting to an Amazon EC2 environment. Valid values are `CONNECT_SSH` and `CONNECT_SSM`. For more information please refer [AWS documentation for Cloud9](https://docs.aws.amazon.com/cloud9/latest/user-guide/ec2-ssm.html).
        :param pulumi.Input[builtins.str] description: The description of the environment.
        :param pulumi.Input[builtins.str] image_id: The identifier for the Amazon Machine Image (AMI) that's used to create the EC2 instance. Valid values are
        ...
        :param pulumi.Input[builtins.str] type: The type of the environment (e.g., `ssh` or `ec2`).
        """
        if arn is not None:
...
class EnvironmentEC2(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'EnvironmentEC2':
        """
    ...
    @property
    @pulumi.getter(name="automaticStopTimeMinutes")
    def automatic_stop_time_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The number of minutes until the running instance is shut down after the environment has last been used.
        """
        return pulumi.get(self, "automatic_stop_time_minutes")
    ...
    @property
    @pulumi.getter(name="ownerArn")
    def owner_arn(self) -> pulumi.Output[builtins.str]:
        """
        The ARN of the environment owner. This can be ARN of any AWS IAM principal. Defaults to the environment's creator.
        """
        return pulumi.get(self, "owner_arn")
