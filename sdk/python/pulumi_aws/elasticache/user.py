...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_string: Access permissions string used for this user. See [Specifying Permissions Using an Access String](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Clusters.RBAC.html#Access-string) for more details.
    ...
    def no_password_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def no_password_required(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _UserState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_string: Access permissions string used for this user. See [Specifying Permissions Using an Access String](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Clusters.RBAC.html#Access-string) for more details.
        :param pulumi.Input[builtins.str] arn: The ARN of the created ElastiCache User.
        :param pulumi.Input['UserAuthenticationModeArgs'] authentication_mode: Denotes the user's authentication properties. Detailed below.
        :param pulumi.Input[builtins.str] engine: The current supported values are `redis`, `valkey` (case insensitive).
        :param pulumi.Input[builtins.bool] no_password_required: Indicates a password is not required for this user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] passwords: Passwords used for this user. You can create up to two passwords for each user.
...
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="noPasswordRequired")
    def no_password_required(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates a password is not required for this user.
        """
        return pulumi.get(self, "no_password_required")
