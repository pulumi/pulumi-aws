...
if not MYPY:
    class GlobalReplicationGroupGlobalNodeGroupArgsDict(TypedDict):
        global_node_group_id: NotRequired[pulumi.Input[str]]
        """
...
class ServerlessCacheCacheUsageLimitsEcpuPerSecondArgs:
    def __init__(__self__, *,
                 ...
                 minimum: Optional[pulumi.Input[int]] = None):
        """
        :param pulumi.Input[int] maximum: The maximum number of ECPUs the cache can consume per second. Must be between 1,000 and 15,000,000.
        :param pulumi.Input[int] minimum: The minimum number of ECPUs the cache can consume per second. Must be between 1,000 and 15,000,000.
        """
        if maximum is not None:
            pulumi.set(__self__, "maximum", maximum)
        if minimum is not None:
...
if not MYPY:
    class GetUserAuthenticationModeArgsDict(TypedDict):
        password_count: NotRequired[int]
