...
class ReservedCacheNodeArgs:
    ...
    def reserved_cache_nodes_offering_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def reserved_cache_nodes_offering_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "reserved_cache_nodes_offering_id", value)

    @property
    @pulumi.getter(name="cacheNodeCount")
    def cache_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cache_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ReservedCacheNodeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN for the reserved cache node.
        :param pulumi.Input[builtins.int] cache_node_count: Number of cache node instances to reserve.
               Default value is `1`.
        :param pulumi.Input[builtins.str] cache_node_type: Node type for the reserved cache nodes.
        :param pulumi.Input[builtins.str] duration: Duration of the reservation as an RFC3339 duration.
        :param pulumi.Input[builtins.float] fixed_price: Fixed price charged for this reserved cache node.
        ...
        :param pulumi.Input[builtins.str] state: State of the reserved cache node.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of tags to assign to the reservation. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags_all: Map of tags assigned to the resource, including those inherited from the provider `default_tags` configuration block.
        :param pulumi.Input[builtins.float] usage_price: Hourly price charged for this reserved cache node.
        """
        if arn is not None:
    ...
    @reserved_cache_nodes_offering_id.setter
    def reserved_cache_nodes_offering_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reserved_cache_nodes_offering_id", value)
...
class ReservedCacheNode(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            timeouts: Optional[pulumi.Input[Union['ReservedCacheNodeTimeoutsArgs', 'ReservedCacheNodeTimeoutsArgsDict']]] = None,
            usage_price: Optional[pulumi.Input[builtins.float]] = None) -> 'ReservedCacheNode':
        """
    ...
    @property
    @pulumi.getter(name="cacheNodeCount")
    def cache_node_count(self) -> pulumi.Output[builtins.int]:
        """
        Number of cache node instances to reserve.
        Default value is `1`.
        """
