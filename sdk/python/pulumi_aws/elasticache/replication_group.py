...
class ReplicationGroupArgs:
    def __init__(__self__, *,
                 ...
                 auth_token_update_strategy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 data_tiering_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 multi_az_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 num_cache_clusters: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] description: User-created description for the replication group. Must not be empty.
        :param pulumi.Input[builtins.bool] apply_immediately: Specifies whether any modifications are applied immediately, or during the next maintenance window. Default is `false`.
        :param pulumi.Input[builtins.bool] at_rest_encryption_enabled: Whether to enable encryption at rest.
        ...
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: Specifies whether minor version engine upgrades will be applied automatically to the underlying Cache Cluster instances during the maintenance window.
               ...
               Defaults to `true`.
        :param pulumi.Input[builtins.bool] automatic_failover_enabled: Specifies whether a read-only replica will be automatically promoted to read/write primary if the existing primary fails. If enabled, `num_cache_clusters` must be greater than 1. Must be enabled for Redis (cluster mode enabled) replication groups. Defaults to `false`.
        :param pulumi.Input[builtins.str] cluster_mode: Specifies whether cluster mode is enabled or disabled. Valid values are `enabled` or `disabled` or `compatible`
        :param pulumi.Input[builtins.bool] data_tiering_enabled: Enables data tiering. Data tiering is only supported for replication groups using the r6gd node type. This parameter must be set to `true` when using r6gd nodes.
        :param pulumi.Input[builtins.str] engine: Name of the cache engine to be used for the clusters in this replication group.
               Valid values are `redis` or `valkey`.
               Default is `redis`.
        :param pulumi.Input[builtins.str] engine_version: Version number of the cache engine to be used for the cache clusters in this replication group.
        ...
        :param pulumi.Input[builtins.str] final_snapshot_identifier: The name of your final node group (shard) snapshot. ElastiCache creates the snapshot from the primary node in the cluster. If omitted, no final snapshot will be made.
        :param pulumi.Input[builtins.str] global_replication_group_id: The ID of the global replication group to which this replication group should belong. If this parameter is specified, the replication group is added to the specified global replication group as a secondary replication group; otherwise, the replication group is not part of any global replication group. If `global_replication_group_id` is set, the `num_node_groups` parameter cannot be set.
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The ARN of the key that you wish to use if encrypting at rest. If not supplied, uses service managed encryption. Can be specified only if `at_rest_encryption_enabled = true`.
        ...
        :param pulumi.Input[builtins.str] maintenance_window: Specifies the weekly time range for when maintenance on the cache cluster is performed. The format is `ddd:hh24:mi-ddd:hh24:mi` (24H Clock UTC). The minimum maintenance window is a 60 minute period. Example: `sun:05:00-sun:09:00`
        :param pulumi.Input[builtins.bool] multi_az_enabled: Specifies whether to enable Multi-AZ Support for the replication group.
               If `true`, `automatic_failover_enabled` must also be enabled.
               Defaults to `false`.
        :param pulumi.Input[builtins.str] network_type: The IP versions for cache cluster connections. Valid values are `ipv4`, `ipv6` or `dual_stack`.
        :param pulumi.Input[builtins.str] node_type: Instance class to be used.
        ...
        :param pulumi.Input[builtins.int] num_cache_clusters: Number of cache clusters (primary and replicas) this replication group will have.
               ...
               Defaults to `1`.
        :param pulumi.Input[builtins.int] num_node_groups: Number of node groups (shards) for this Redis replication group.
        ...
        :param pulumi.Input[builtins.str] replication_group_id: Replication group identifier. This parameter is stored as a lowercase string.
               
               The following arguments are optional:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: IDs of one or more Amazon VPC security groups associated with this replication group. Use this parameter only when you are creating a replication group in an Amazon Virtual Private Cloud.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_names: Names of one or more Amazon VPC security groups associated with this replication group. Use this parameter only when you are creating a replication group in an Amazon Virtual Private Cloud.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] snapshot_arns: List of ARNs that identify Redis RDB snapshot files stored in Amazon S3. The names object names cannot contain any commas.
        :param pulumi.Input[builtins.str] snapshot_name: Name of a snapshot from which to restore data into the new node group. Changing the `snapshot_name` forces a new resource.
        ...
        :param pulumi.Input[builtins.str] transit_encryption_mode: A setting that enables clients to migrate to in-transit encryption with no downtime.
    ...
    def auth_token_update_strategy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def data_tiering_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def data_tiering_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def multi_az_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def multi_az_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def num_cache_clusters(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def num_cache_clusters(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def preferred_cache_cluster_azs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def preferred_cache_cluster_azs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def replicas_per_node_group(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ReplicationGroupState:
    def __init__(__self__, *,
                 ...
                 cluster_mode: Optional[pulumi.Input[builtins.str]] = None,
                 configuration_endpoint_address: Optional[pulumi.Input[builtins.str]] = None,
                 data_tiering_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 log_delivery_configurations: Optional[pulumi.Input[Sequence[pulumi.Input['ReplicationGroupLogDeliveryConfigurationArgs']]]] = None,
                 maintenance_window: Optional[pulumi.Input[builtins.str]] = None,
                 member_clusters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 multi_az_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 network_type: Optional[pulumi.Input[builtins.str]] = None,
                 node_type: Optional[pulumi.Input[builtins.str]] = None,
                 notification_topic_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] apply_immediately: Specifies whether any modifications are applied immediately, or during the next maintenance window. Default is `false`.
        :param pulumi.Input[builtins.str] arn: ARN of the created ElastiCache Replication Group.
        :param pulumi.Input[builtins.bool] at_rest_encryption_enabled: Whether to enable encryption at rest.
               When `engine` is `redis`, default is `false`.
               When `engine` is `valkey`, default is `true`.
        :param pulumi.Input[builtins.str] auth_token: Password used to access a password protected server. Can be specified only if `transit_encryption_enabled = true`.
        ...
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: Specifies whether minor version engine upgrades will be applied automatically to the underlying Cache Cluster instances during the maintenance window.
               ...
               Defaults to `true`.
        :param pulumi.Input[builtins.bool] automatic_failover_enabled: Specifies whether a read-only replica will be automatically promoted to read/write primary if the existing primary fails. If enabled, `num_cache_clusters` must be greater than 1. Must be enabled for Redis (cluster mode enabled) replication groups. Defaults to `false`.
        :param pulumi.Input[builtins.bool] cluster_enabled: Indicates if cluster mode is enabled.
        :param pulumi.Input[builtins.str] cluster_mode: Specifies whether cluster mode is enabled or disabled. Valid values are `enabled` or `disabled` or `compatible`
        :param pulumi.Input[builtins.str] configuration_endpoint_address: Address of the replication group configuration endpoint when cluster mode is enabled.
        :param pulumi.Input[builtins.bool] data_tiering_enabled: Enables data tiering. Data tiering is only supported for replication groups using the r6gd node type. This parameter must be set to `true` when using r6gd nodes.
        :param pulumi.Input[builtins.str] description: User-created description for the replication group. Must not be empty.
        :param pulumi.Input[builtins.str] engine: Name of the cache engine to be used for the clusters in this replication group.
               Valid values are `redis` or `valkey`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ReplicationGroupLogDeliveryConfigurationArgs']]] log_delivery_configurations: Specifies the destination and format of Redis OSS/Valkey [SLOWLOG](https://redis.io/commands/slowlog) or Redis OSS/Valkey [Engine Log](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Log_Delivery.html#Log_contents-engine-log). See the documentation on [Amazon ElastiCache](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/Log_Delivery.html#Log_contents-engine-log). See Log Delivery Configuration below for more details.
        :param pulumi.Input[builtins.str] maintenance_window: Specifies the weekly time range for when maintenance on the cache cluster is performed. The format is `ddd:hh24:mi-ddd:hh24:mi` (24H Clock UTC). The minimum maintenance window is a 60 minute period. Example: `sun:05:00-sun:09:00`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] member_clusters: Identifiers of all the nodes that are part of this replication group.
        :param pulumi.Input[builtins.bool] multi_az_enabled: Specifies whether to enable Multi-AZ Support for the replication group.
               If `true`, `automatic_failover_enabled` must also be enabled.
               Defaults to `false`.
        :param pulumi.Input[builtins.str] network_type: The IP versions for cache cluster connections. Valid values are `ipv4`, `ipv6` or `dual_stack`.
    ...
    def configuration_endpoint_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def configuration_endpoint_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def member_clusters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def member_clusters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def primary_endpoint_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_endpoint_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "primary_endpoint_address", value)

    @property
    @pulumi.getter(name="readerEndpointAddress")
    def reader_endpoint_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reader_endpoint_address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ReplicationGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transit_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
            transit_encryption_mode: Optional[pulumi.Input[builtins.str]] = None,
            user_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ReplicationGroup':
        """
    ...
    @property
    @pulumi.getter(name="configurationEndpointAddress")
    def configuration_endpoint_address(self) -> pulumi.Output[builtins.str]:
        """
        Address of the replication group configuration endpoint when cluster mode is enabled.
        """
        return pulumi.get(self, "configuration_endpoint_address")
    ...
    @property
    @pulumi.getter(name="dataTieringEnabled")
    def data_tiering_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Enables data tiering. Data tiering is only supported for replication groups using the r6gd node type. This parameter must be set to `true` when using r6gd nodes.
        """
        return pulumi.get(self, "data_tiering_enabled")
    ...
    @property
    @pulumi.getter(name="memberClusters")
    def member_clusters(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Identifiers of all the nodes that are part of this replication group.
        """
        return pulumi.get(self, "member_clusters")
    ...
    @property
    @pulumi.getter(name="multiAzEnabled")
    def multi_az_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to enable Multi-AZ Support for the replication group.
        If `true`, `automatic_failover_enabled` must also be enabled.
        Defaults to `false`.
    ...
    @property
    @pulumi.getter(name="numCacheClusters")
    def num_cache_clusters(self) -> pulumi.Output[builtins.int]:
        """
        Number of cache clusters (primary and replicas) this replication group will have.
        If `automatic_failover_enabled` or `multi_az_enabled` are `true`, must be at least 2.
        Updates will occur before other modifications.
    ...
    @property
    @pulumi.getter(name="preferredCacheClusterAzs")
    def preferred_cache_cluster_azs(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of EC2 availability zones in which the replication group's cache clusters will be created. The order of the availability zones in the list is considered. The first item in the list will be the primary node. Ignored when updating.
        """
        return pulumi.get(self, "preferred_cache_cluster_azs")
    ...
    @property
    @pulumi.getter(name="primaryEndpointAddress")
    def primary_endpoint_address(self) -> pulumi.Output[builtins.str]:
        """
        (Redis only) Address of the endpoint for the primary node in the replication group, if the cluster mode is disabled.
        """
        return pulumi.get(self, "primary_endpoint_address")
    ...
    @property
    @pulumi.getter(name="readerEndpointAddress")
    def reader_endpoint_address(self) -> pulumi.Output[builtins.str]:
        """
        (Redis only) Address of the endpoint for the reader node in the replication group, if the cluster mode is disabled.
        """
        return pulumi.get(self, "reader_endpoint_address")
    ...
    @property
    @pulumi.getter(name="replicasPerNodeGroup")
    def replicas_per_node_group(self) -> pulumi.Output[builtins.int]:
        """
        Number of replica nodes in each node group.
        Changing this number will trigger a resizing operation before other settings modifications.
        Valid values are 0 to 5.
    ...
    @property
    @pulumi.getter(name="securityGroupNames")
    def security_group_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Names of one or more Amazon VPC security groups associated with this replication group. Use this parameter only when you are creating a replication group in an Amazon Virtual Private Cloud.
        """
        return pulumi.get(self, "security_group_names")
