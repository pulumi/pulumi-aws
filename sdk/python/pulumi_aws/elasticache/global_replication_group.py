...
class GlobalReplicationGroupArgs:
    def __init__(__self__, *,
                 global_replication_group_id_suffix: pulumi.Input[builtins.str],
                 primary_replication_group_id: pulumi.Input[builtins.str],
                 automatic_failover_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 cache_node_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] automatic_failover_enabled: Specifies whether read-only replicas will be automatically promoted to read/write primary if the existing primary fails.
               When creating, by default the Global Replication Group inherits the automatic failover setting of the primary replication group.
        :param pulumi.Input[builtins.str] cache_node_type: The instance class used.
               See AWS documentation for information on [supported node types](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/CacheNodes.SupportedTypes.html)
               and [guidance on selecting node types](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/nodes-select-size.html).
               When creating, by default the Global Replication Group inherits the node type of the primary replication group.
        :param pulumi.Input[builtins.str] engine_version: Redis version to use for the Global Replication Group.
        ...
        :param pulumi.Input[builtins.str] global_replication_group_description: A user-created description for the global replication group.
        :param pulumi.Input[builtins.int] num_node_groups: The number of node groups (shards) on the global replication group.
        :param pulumi.Input[builtins.str] parameter_group_name: An ElastiCache Parameter Group to use for the Global Replication Group.
    ...
    def global_replication_group_id_suffix(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def global_replication_group_id_suffix(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "global_replication_group_id_suffix", value)

    @property
    @pulumi.getter(name="primaryReplicationGroupId")
    def primary_replication_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def primary_replication_group_id(self, value: pulumi.Input[builtins.str]):
    ...
    def cache_node_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cache_node_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def global_replication_group_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def global_replication_group_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "global_replication_group_description", value)

    @property
    @pulumi.getter(name="numNodeGroups")
    def num_node_groups(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def num_node_groups(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _GlobalReplicationGroupState:
    def __init__(__self__, *,
                 ...
                 at_rest_encryption_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 auth_token_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 automatic_failover_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 cache_node_type: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 global_replication_group_description: Optional[pulumi.Input[builtins.str]] = None,
                 global_replication_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 global_replication_group_id_suffix: Optional[pulumi.Input[builtins.str]] = None,
                 num_node_groups: Optional[pulumi.Input[builtins.int]] = None,
                 parameter_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the ElastiCache Global Replication Group.
        :param pulumi.Input[builtins.bool] at_rest_encryption_enabled: A flag that indicate whether the encryption at rest is enabled.
        :param pulumi.Input[builtins.bool] auth_token_enabled: A flag that indicate whether AuthToken (password) is enabled.
        :param pulumi.Input[builtins.bool] automatic_failover_enabled: Specifies whether read-only replicas will be automatically promoted to read/write primary if the existing primary fails.
               When creating, by default the Global Replication Group inherits the automatic failover setting of the primary replication group.
        :param pulumi.Input[builtins.str] cache_node_type: The instance class used.
               See AWS documentation for information on [supported node types](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/CacheNodes.SupportedTypes.html)
               and [guidance on selecting node types](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/nodes-select-size.html).
               When creating, by default the Global Replication Group inherits the node type of the primary replication group.
        :param pulumi.Input[builtins.bool] cluster_enabled: Indicates whether the Global Datastore is cluster enabled.
        :param pulumi.Input[builtins.str] engine: The name of the cache engine to be used for the clusters in this global replication group.
        :param pulumi.Input[builtins.str] engine_version: Redis version to use for the Global Replication Group.
               When creating, by default the Global Replication Group inherits the version of the primary replication group.
               If a version is specified, the Global Replication Group and all member replication groups will be upgraded to this version.
               Cannot be downgraded without replacing the Global Replication Group and all member replication groups.
               ...
               or the minor version can be unspecified which will use the latest version at creation time, e.g., `6.x`.
               The actual engine version used is returned in the attribute `engine_version_actual`, see Attribute Reference below.
        :param pulumi.Input[builtins.str] engine_version_actual: The full version number of the cache engine running on the members of this global replication group.
        :param pulumi.Input[Sequence[pulumi.Input['GlobalReplicationGroupGlobalNodeGroupArgs']]] global_node_groups: Set of node groups (shards) on the global replication group.
               Has the values:
        :param pulumi.Input[builtins.str] global_replication_group_description: A user-created description for the global replication group.
        :param pulumi.Input[builtins.str] global_replication_group_id: The full ID of the global replication group.
        :param pulumi.Input[builtins.str] global_replication_group_id_suffix: The suffix name of a Global Datastore. If `global_replication_group_id_suffix` is changed, creates a new resource.
        :param pulumi.Input[builtins.int] num_node_groups: The number of node groups (shards) on the global replication group.
        :param pulumi.Input[builtins.str] parameter_group_name: An ElastiCache Parameter Group to use for the Global Replication Group.
               Required when upgrading a major engine version, but will be ignored if left configured after the upgrade is complete.
    ...
    def at_rest_encryption_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def at_rest_encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "at_rest_encryption_enabled", value)

    @property
    @pulumi.getter(name="authTokenEnabled")
    def auth_token_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auth_token_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def cluster_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cluster_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def global_replication_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def global_replication_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "global_replication_group_id", value)

    @property
    @pulumi.getter(name="globalReplicationGroupIdSuffix")
    def global_replication_group_id_suffix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The suffix name of a Global Datastore. If `global_replication_group_id_suffix` is changed, creates a new resource.
        """
        return pulumi.get(self, "global_replication_group_id_suffix")
    ...
    @global_replication_group_id_suffix.setter
    def global_replication_group_id_suffix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "global_replication_group_id_suffix", value)
    ...
    @property
    @pulumi.getter(name="primaryReplicationGroupId")
    def primary_replication_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the primary cluster that accepts writes and will replicate updates to the secondary cluster. If `primary_replication_group_id` is changed, creates a new resource.
        """
        return pulumi.get(self, "primary_replication_group_id")
    ...
    @primary_replication_group_id.setter
    def primary_replication_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "primary_replication_group_id", value)
...
class GlobalReplicationGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="atRestEncryptionEnabled")
    def at_rest_encryption_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        A flag that indicate whether the encryption at rest is enabled.
        """
        return pulumi.get(self, "at_rest_encryption_enabled")
    ...
    @property
    @pulumi.getter(name="authTokenEnabled")
    def auth_token_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        A flag that indicate whether AuthToken (password) is enabled.
        """
        return pulumi.get(self, "auth_token_enabled")
    ...
    @property
    @pulumi.getter(name="automaticFailoverEnabled")
    def automatic_failover_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether read-only replicas will be automatically promoted to read/write primary if the existing primary fails.
        When creating, by default the Global Replication Group inherits the automatic failover setting of the primary replication group.
        """
    ...
    @property
    @pulumi.getter(name="cacheNodeType")
    def cache_node_type(self) -> pulumi.Output[builtins.str]:
        """
        The instance class used.
        See AWS documentation for information on [supported node types](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/CacheNodes.SupportedTypes.html)
        and [guidance on selecting node types](https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/nodes-select-size.html).
    ...
    @property
    @pulumi.getter(name="clusterEnabled")
    def cluster_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the Global Datastore is cluster enabled.
        """
        return pulumi.get(self, "cluster_enabled")
    ...
    @property
    @pulumi.getter(name="globalReplicationGroupDescription")
    def global_replication_group_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A user-created description for the global replication group.
        """
        return pulumi.get(self, "global_replication_group_description")
    ...
    @property
    @pulumi.getter(name="globalReplicationGroupId")
    def global_replication_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The full ID of the global replication group.
        """
        return pulumi.get(self, "global_replication_group_id")
    ...
    @property
    @pulumi.getter(name="globalReplicationGroupIdSuffix")
    def global_replication_group_id_suffix(self) -> pulumi.Output[builtins.str]:
        """
        The suffix name of a Global Datastore. If `global_replication_group_id_suffix` is changed, creates a new resource.
        """
        return pulumi.get(self, "global_replication_group_id_suffix")
    ...
    @property
    @pulumi.getter(name="numNodeGroups")
    def num_node_groups(self) -> pulumi.Output[builtins.int]:
        """
        The number of node groups (shards) on the global replication group.
        """
        return pulumi.get(self, "num_node_groups")
    ...
    @property
    @pulumi.getter(name="primaryReplicationGroupId")
    def primary_replication_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the primary cluster that accepts writes and will replicate updates to the secondary cluster. If `primary_replication_group_id` is changed, creates a new resource.
        """
        return pulumi.get(self, "primary_replication_group_id")
