...
class ThingPrincipalAttachmentArgs:
    ...
    @property
    @pulumi.getter
    def thing(self) -> pulumi.Input[builtins.str]:
        """
...
class _ThingPrincipalAttachmentState:
    ...
    @property
    @pulumi.getter
    def thing(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the thing.
        """
        return pulumi.get(self, "thing")
    ...
    @thing.setter
    def thing(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "thing", value)
...
class ThingPrincipalAttachment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def thing(self) -> pulumi.Output[builtins.str]:
        """
        The name of the thing.
        """
        return pulumi.get(self, "thing")
