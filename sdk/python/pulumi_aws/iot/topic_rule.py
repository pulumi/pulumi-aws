...
class TopicRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if error_action is not None and not isinstance(error_action, TopicRuleErrorActionArgs):
                error_action = error_action or {}
                def _setter(key, value):
                    error_action[key] = value
                TopicRuleErrorActionArgs._configure(_setter, **error_action)
