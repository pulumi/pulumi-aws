...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ca_pem: The CA certificate for the certificate to be registered. If this is set, the CA needs to be registered with AWS IoT beforehand.
        :param pulumi.Input[builtins.str] certificate_pem: The certificate to be registered. If `ca_pem` is unspecified, review
               [RegisterCertificateWithoutCA](https://docs.aws.amazon.com/iot/latest/apireference/API_RegisterCertificateWithoutCA.html).
               If `ca_pem` is specified, review
               [RegisterCertificate](https://docs.aws.amazon.com/iot/latest/apireference/API_RegisterCertificate.html)
               for more information on registering a certificate.
        :param pulumi.Input[builtins.str] csr: The certificate signing request. Review
...
class _CertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] active: Boolean flag to indicate if the certificate should be active
        :param pulumi.Input[builtins.str] arn: The ARN of the created certificate.
        :param pulumi.Input[builtins.str] ca_certificate_id: The certificate ID of the CA certificate used to sign the certificate.
        :param pulumi.Input[builtins.str] ca_pem: The CA certificate for the certificate to be registered. If this is set, the CA needs to be registered with AWS IoT beforehand.
        :param pulumi.Input[builtins.str] certificate_pem: The certificate to be registered. If `ca_pem` is unspecified, review
               [RegisterCertificateWithoutCA](https://docs.aws.amazon.com/iot/latest/apireference/API_RegisterCertificateWithoutCA.html).
               If `ca_pem` is specified, review
