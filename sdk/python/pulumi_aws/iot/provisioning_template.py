...
class ProvisioningTemplateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] template_body: The JSON formatted contents of the fleet provisioning template.
        ...
        :param pulumi.Input[builtins.str] name: The name of the fleet provisioning template.
        ...
        :param pulumi.Input[builtins.str] type: The type you define in a provisioning template.
        """
...
class _ProvisioningTemplateState:
    def __init__(__self__, *,
                 ...
                 default_version_id: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 pre_provisioning_hook: Optional[pulumi.Input['ProvisioningTemplatePreProvisioningHookArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN that identifies the provisioning template.
        :param pulumi.Input[builtins.int] default_version_id: The default version of the fleet provisioning template.
        :param pulumi.Input[builtins.str] description: The description of the fleet provisioning template.
        :param pulumi.Input[builtins.bool] enabled: True to enable the fleet provisioning template, otherwise false.
        :param pulumi.Input[builtins.str] name: The name of the fleet provisioning template.
        :param pulumi.Input['ProvisioningTemplatePreProvisioningHookArgs'] pre_provisioning_hook: Creates a pre-provisioning hook template. Details below.
    ...
    def default_version_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def default_version_id(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter(name="provisioningRoleArn")
    def provisioning_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The role ARN for the role associated with the fleet provisioning template. This IoT role grants permission to provision a device.
        """
        return pulumi.get(self, "provisioning_role_arn")
    ...
    @provisioning_role_arn.setter
    def provisioning_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provisioning_role_arn", value)
...
class ProvisioningTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            template_body: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ProvisioningTemplate':
        """
    ...
    @property
    @pulumi.getter(name="defaultVersionId")
    def default_version_id(self) -> pulumi.Output[builtins.int]:
        """
        The default version of the fleet provisioning template.
        """
        return pulumi.get(self, "default_version_id")
