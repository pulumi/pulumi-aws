...
class ThingGroupMembershipArgs:
    ...
    def thing_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def thing_group_name(self, value: pulumi.Input[builtins.str]):
    ...
    def override_dynamic_group(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
...
class ThingGroupMembership(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="overrideDynamicGroup")
    def override_dynamic_group(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Override dynamic thing groups with static thing groups when 10-group limit is reached. If a thing belongs to 10 thing groups, and one or more of those groups are dynamic thing groups, adding a thing to a static group removes the thing from the last dynamic group.
        """
        return pulumi.get(self, "override_dynamic_group")
    ...
    @property
    @pulumi.getter(name="thingGroupName")
    def thing_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the group to which you are adding a thing.
        """
        return pulumi.get(self, "thing_group_name")
    ...
    @property
    @pulumi.getter(name="thingName")
    def thing_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the thing to add to a group.
        """
        return pulumi.get(self, "thing_name")
