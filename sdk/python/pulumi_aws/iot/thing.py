...
class _ThingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the thing.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] attributes: Map of attributes of the thing.
    ...
    def default_client_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_client_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Thing(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultClientId")
    def default_client_id(self) -> pulumi.Output[builtins.str]:
        """
        The default client ID.
        """
        return pulumi.get(self, "default_client_id")
