...
class IndexingConfigurationArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'thingGroupIndexingConfiguration' in kwargs:
            thing_group_indexing_configuration = kwargs['thingGroupIndexingConfiguration']
        if 'thingIndexingConfiguration' in kwargs:
...
class IndexingConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if thing_group_indexing_configuration is not None and not isinstance(thing_group_indexing_configuration, IndexingConfigurationThingGroupIndexingConfigurationArgs):
                thing_group_indexing_configuration = thing_group_indexing_configuration or {}
                def _setter(key, value):
                    thing_group_indexing_configuration[key] = value
                IndexingConfigurationThingGroupIndexingConfigurationArgs._configure(_setter, **thing_group_indexing_configuration)
            __props__.__dict__["thing_group_indexing_configuration"] = thing_group_indexing_configuration
            if thing_indexing_configuration is not None and not isinstance(thing_indexing_configuration, IndexingConfigurationThingIndexingConfigurationArgs):
                thing_indexing_configuration = thing_indexing_configuration or {}
                def _setter(key, value):
                    thing_indexing_configuration[key] = value
                IndexingConfigurationThingIndexingConfigurationArgs._configure(_setter, **thing_indexing_configuration)
