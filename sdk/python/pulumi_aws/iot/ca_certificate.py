...
class CaCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ca_private_key = tls.index.private_key.PrivateKey("ca", algorithm=RSA)
        ca = tls.index.self_signed_cert.SelfSignedCert("ca",
        ...
        verification_private_key = tls.index.private_key.PrivateKey("verification", algorithm=RSA)
        example = aws.iot.get_registration_code()
        verification = tls.index.cert_request.CertRequest("verification",
            private_key_pem=verification_private_key.private_key_pem,
            subject={
                commonName: example.registration_code,
            })
        verification_locally_signed_cert = tls.index.locally_signed_cert.LocallySignedCert("verification",
