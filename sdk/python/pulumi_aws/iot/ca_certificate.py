...
class CaCertificateArgs:
    def __init__(__self__, *,
                 ...
                 verification_certificate_pem: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CaCertificate resource.
        :param pulumi.Input[builtins.bool] active: Boolean flag to indicate if the certificate should be active for device authentication.
        ...
        :param pulumi.Input[builtins.str] certificate_mode: The certificate mode in which the CA will be registered. Valida values: `DEFAULT` and `SNI_ONLY`. Default: `DEFAULT`.
    ...
    def allow_auto_registration(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def allow_auto_registration(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "allow_auto_registration", value)

    @property
    @pulumi.getter(name="caCertificatePem")
    def ca_certificate_pem(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ca_certificate_pem(self, value: pulumi.Input[builtins.str]):
    ...
    def verification_certificate_pem(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def verification_certificate_pem(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CaCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] active: Boolean flag to indicate if the certificate should be active for device authentication.
        :param pulumi.Input[builtins.bool] allow_auto_registration: Boolean flag to indicate if the certificate should be active for device regisration.
        :param pulumi.Input[builtins.str] arn: The ARN of the created CA certificate.
        :param pulumi.Input[builtins.str] ca_certificate_pem: PEM encoded CA certificate.
        :param pulumi.Input[builtins.str] certificate_mode: The certificate mode in which the CA will be registered. Valida values: `DEFAULT` and `SNI_ONLY`. Default: `DEFAULT`.
    ...
    @property
    @pulumi.getter(name="allowAutoRegistration")
    def allow_auto_registration(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Boolean flag to indicate if the certificate should be active for device regisration.
        """
        return pulumi.get(self, "allow_auto_registration")
    ...
    @allow_auto_registration.setter
    def allow_auto_registration(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "allow_auto_registration", value)
    ...
    def customer_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def customer_version(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "customer_version", value)

    @property
    @pulumi.getter(name="generationId")
    def generation_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def generation_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CaCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            verification_certificate_pem: Optional[pulumi.Input[builtins.str]] = None) -> 'CaCertificate':
        """
    ...
    @property
    @pulumi.getter(name="allowAutoRegistration")
    def allow_auto_registration(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean flag to indicate if the certificate should be active for device regisration.
        """
        return pulumi.get(self, "allow_auto_registration")
    ...
    @property
    @pulumi.getter(name="caCertificatePem")
    def ca_certificate_pem(self) -> pulumi.Output[builtins.str]:
        """
        PEM encoded CA certificate.
        """
        return pulumi.get(self, "ca_certificate_pem")
    ...
    @property
    @pulumi.getter(name="certificateMode")
    def certificate_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The certificate mode in which the CA will be registered. Valida values: `DEFAULT` and `SNI_ONLY`. Default: `DEFAULT`.
        """
        return pulumi.get(self, "certificate_mode")
    ...
    @property
    @pulumi.getter(name="customerVersion")
    def customer_version(self) -> pulumi.Output[builtins.int]:
        """
        The customer version of the CA certificate.
        """
        return pulumi.get(self, "customer_version")
    ...
    @property
    @pulumi.getter(name="generationId")
    def generation_id(self) -> pulumi.Output[builtins.str]:
        """
        The generation ID of the CA certificate.
        """
        return pulumi.get(self, "generation_id")
    ...
    @property
    @pulumi.getter(name="verificationCertificatePem")
    def verification_certificate_pem(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        PEM encoded verification certificate containing the common name of a registration code. Review
        [CreateVerificationCSR](https://docs.aws.amazon.com/iot/latest/developerguide/register-CA-cert.html). Reuired if `certificate_mode` is `DEFAULT`.
        """
