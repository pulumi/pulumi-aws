...
class ThingType(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if properties is not None and not isinstance(properties, ThingTypePropertiesArgs):
                properties = properties or {}
                def _setter(key, value):
                    properties[key] = value
                ThingTypePropertiesArgs._configure(_setter, **properties)
