...
class BillingGroupProperties(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: A description of the Billing Group.
        """
...
class CaCertificateValidity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str not_after: The certificate is not valid after this date.
        :param builtins.str not_before: The certificate is not valid before this date.
        """
...
class DomainConfigurationTlsConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str security_policy: The security policy for a domain configuration.
        """
...
class IndexingConfigurationThingGroupIndexingConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str thing_group_indexing_mode: Thing group indexing mode. Valid values: `OFF`, `ON`.
...
class IndexingConfigurationThingGroupIndexingConfigurationCustomField(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: The data type of the field. Valid values: `Number`, `String`, `Boolean`.
        """
        if name is not None:
...
class IndexingConfigurationThingIndexingConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 device_defender_indexing_mode: Optional[builtins.str] = None,
                 ...
                 named_shadow_indexing_mode: Optional[builtins.str] = None,
                 thing_connectivity_indexing_mode: Optional[builtins.str] = None):
        """
        :param builtins.str thing_indexing_mode: Thing indexing mode. Valid values: `REGISTRY`, `REGISTRY_AND_SHADOW`, `OFF`.
        ...
        :param builtins.str device_defender_indexing_mode: Device Defender indexing mode. Valid values: `VIOLATIONS`, `OFF`. Default: `OFF`.
        ...
        :param builtins.str named_shadow_indexing_mode: [Named shadow](https://docs.aws.amazon.com/iot/latest/developerguide/iot-device-shadows.html) indexing mode. Valid values: `ON`, `OFF`. Default: `OFF`.
        :param builtins.str thing_connectivity_indexing_mode: Thing connectivity indexing mode. Valid values: `STATUS`, `OFF`. Default: `OFF`.
        """
    ...
    def device_defender_indexing_mode(self) -> Optional[builtins.str]:
        """
    ...
    def named_shadow_indexing_mode(self) -> Optional[builtins.str]:
        """
    ...
    def thing_connectivity_indexing_mode(self) -> Optional[builtins.str]:
        """
...
class IndexingConfigurationThingIndexingConfigurationFilter(dict):
    ...
    def __init__(__self__, *,
                 named_shadow_names: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] named_shadow_names: List of shadow names that you select to index.
        """
    ...
    def named_shadow_names(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ProvisioningTemplatePreProvisioningHook(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str payload_version: The version of the payload that was sent to the target function. The only valid (and the default) payload version is `"2020-04-01"`.
        """
...
class ThingGroupMetadata(dict):
    ...
    def __init__(__self__, *,
                 ...
                 parent_group_name: Optional[builtins.str] = None,
                 root_to_parent_groups: Optional[Sequence['outputs.ThingGroupMetadataRootToParentGroup']] = None):
        """
        :param builtins.str parent_group_name: The name of the parent Thing Group.
        """
    ...
    def parent_group_name(self) -> Optional[builtins.str]:
        """
...
class ThingGroupMetadataRootToParentGroup(dict):
    ...
    def __init__(__self__, *,
                 group_arn: Optional[builtins.str] = None,
...
class ThingGroupProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str description: A description of the Thing Group.
        """
...
class ThingGroupPropertiesAttributePayload(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] attributes: Key-value map.
        """
...
class ThingTypeProperties(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: The description of the thing type.
...
class TopicRuleCloudwatchAlarm(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: The IAM role ARN that allows access to the CloudWatch alarm.
...
class TopicRuleCloudwatchLog(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_group_name: The CloudWatch log group name.
        :param builtins.str role_arn: The IAM role ARN that allows access to the CloudWatch alarm.
        :param builtins.bool batch_mode: The payload that contains a JSON array of records will be sent to CloudWatch via a batch call.
        """
...
class TopicRuleCloudwatchMetric(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str metric_unit: The metric unit (supported units can be found here: http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/cloudwatch_concepts.html#Unit)
        :param builtins.str metric_value: The CloudWatch metric value.
        :param builtins.str role_arn: The IAM role ARN that allows access to the CloudWatch metric.
        :param builtins.str metric_timestamp: An optional Unix timestamp (http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/cloudwatch_concepts.html#about_timestamp).
        """
...
class TopicRuleDynamodb(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str operation: The operation. Valid values are "INSERT", "UPDATE", or "DELETE".
        :param builtins.str payload_field: The action payload.
...
class TopicRuleElasticsearch(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str endpoint: The endpoint of your Elasticsearch domain.
        :param builtins.str id: The unique identifier for the document you are storing.
        :param builtins.str index: The Elasticsearch index where you want to store your data.
        :param builtins.str role_arn: The IAM role ARN that has access to Elasticsearch.
...
class TopicRuleErrorActionFirehose(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: The IAM role ARN that grants access to the Amazon Kinesis Firehose stream.
        :param builtins.bool batch_mode: The payload that contains a JSON array of records will be sent to Kinesis Firehose via a batch call.
        :param builtins.str separator: A character separator that is used to separate records written to the Firehose stream. Valid values are: '\\n' (newline), '\\t' (tab), '\\r\\n' (Windows newline), ',' (comma).
        """
...
class TopicRuleErrorActionHttp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str url: The HTTPS URL.
        :param builtins.str confirmation_url: The HTTPS URL used to verify ownership of `url`.
...
class TopicRuleErrorActionHttpHttpHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The name of the HTTP header.
        :param builtins.str value: The value of the HTTP header.
        """
...
class TopicRuleErrorActionIotAnalytics(dict):
    ...
    def __init__(__self__, *,
                 ...
                 batch_mode: Optional[builtins.bool] = None):
        """
        :param builtins.str channel_name: Name of AWS IOT Analytics channel.
        :param builtins.str role_arn: The ARN of the IAM role that grants access.
        :param builtins.bool batch_mode: The payload that contains a JSON array of records will be sent to IoT Analytics via a batch call.
        """
...
class TopicRuleErrorActionIotEvents(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str role_arn: The ARN of the IAM role that grants access.
        :param builtins.bool batch_mode: The payload that contains a JSON array of records will be sent to IoT Events via a batch call.
        :param builtins.str message_id: Use this to ensure that only one input (message) with a given messageId is processed by an AWS IoT Events detector.
        """
...
class TopicRuleErrorActionKafka(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] client_properties: Properties of the Apache Kafka producer client. For more info, see the [AWS documentation](https://docs.aws.amazon.com/iot/latest/developerguide/apache-kafka-rule-action.html).
        :param builtins.str destination_arn: The ARN of Kafka action's VPC `iot.TopicRuleDestination`.
...
class TopicRuleErrorActionRepublish(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role_arn: The ARN of the IAM role that grants access.
        :param builtins.str topic: The name of the MQTT topic the message should be republished to.
        :param builtins.int qos: The Quality of Service (QoS) level to use when republishing messages. Valid values are 0 or 1. The default value is 0.
        """
        pulumi.set(__self__, "role_arn", role_arn)
        pulumi.set(__self__, "topic", topic)
        if qos is not None:
...
class TopicRuleErrorActionS3(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket_name: The Amazon S3 bucket name.
        :param builtins.str key: The object key.
        :param builtins.str role_arn: The ARN of the IAM role that grants access.
        :param builtins.str canned_acl: The Amazon S3 canned ACL that controls access to the object identified by the object key. [Valid values](https://docs.aws.amazon.com/AmazonS3/latest/userguide/acl-overview.html#canned-acl).
        """
...
class TopicRuleErrorActionSns(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str message_format: The message format of the message to publish. Accepted values are "JSON" and "RAW".
        """
        pulumi.set(__self__, "role_arn", role_arn)
        pulumi.set(__self__, "target_arn", target_arn)
...
class TopicRuleErrorActionSqs(dict):
    ...
    def use_base64(self) -> builtins.bool:
        """
...
class TopicRuleErrorActionStepFunctions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role_arn: The ARN of the IAM role that grants access to start execution of the state machine.
        :param builtins.str state_machine_name: The name of the Step Functions state machine whose execution will be started.
        :param builtins.str execution_name_prefix: The prefix used to generate, along with a UUID, the unique state machine execution name.
        """
        pulumi.set(__self__, "role_arn", role_arn)
...
class TopicRuleErrorActionTimestream(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str database_name: The name of an Amazon Timestream database.
        ...
        :param builtins.str role_arn: The ARN of the role that grants permission to write to the Amazon Timestream database table.
        :param builtins.str table_name: The name of the database table into which to write the measure records.
...
class TopicRuleErrorActionTimestreamDimension(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: The metadata dimension name. This is the name of the column in the Amazon Timestream database table record.
        :param builtins.str value: The value to write in this column of the database record.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class TopicRuleErrorActionTimestreamTimestamp(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str unit: The precision of the timestamp value that results from the expression described in value. Valid values: `SECONDS`, `MILLISECONDS`, `MICROSECONDS`, `NANOSECONDS`.
