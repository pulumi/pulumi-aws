...
class DomainArgs:
    def __init__(__self__, *,
                 workflow_execution_retention_period_in_days: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] workflow_execution_retention_period_in_days: Length of time that SWF will continue to retain information about the workflow execution after the workflow execution is complete, must be between 0 and 90 days.
        :param pulumi.Input[builtins.str] description: The domain description.
        :param pulumi.Input[builtins.str] name: The name of the domain. If omitted, this provider will assign a random, unique name.
    ...
    def workflow_execution_retention_period_in_days(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def workflow_execution_retention_period_in_days(self, value: pulumi.Input[builtins.str]):
...
class _DomainState:
    def __init__(__self__, *,
                 ...
                 workflow_execution_retention_period_in_days: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="workflowExecutionRetentionPeriodInDays")
    def workflow_execution_retention_period_in_days(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Length of time that SWF will continue to retain information about the workflow execution after the workflow execution is complete, must be between 0 and 90 days.
        """
        return pulumi.get(self, "workflow_execution_retention_period_in_days")
    ...
    @workflow_execution_retention_period_in_days.setter
    def workflow_execution_retention_period_in_days(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "workflow_execution_retention_period_in_days", value)


class Domain(pulumi.CustomResource):

    pulumi_type = "aws:swf/domain:Domain"
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            workflow_execution_retention_period_in_days: Optional[pulumi.Input[builtins.str]] = None) -> 'Domain':
        """
    ...
    @property
    @pulumi.getter(name="workflowExecutionRetentionPeriodInDays")
    def workflow_execution_retention_period_in_days(self) -> pulumi.Output[builtins.str]:
        """
        Length of time that SWF will continue to retain information about the workflow execution after the workflow execution is complete, must be between 0 and 90 days.
        """
        return pulumi.get(self, "workflow_execution_retention_period_in_days")
