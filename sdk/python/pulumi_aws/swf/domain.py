...
class DomainArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if workflow_execution_retention_period_in_days is None and 'workflowExecutionRetentionPeriodInDays' in kwargs:
            workflow_execution_retention_period_in_days = kwargs['workflowExecutionRetentionPeriodInDays']
        if workflow_execution_retention_period_in_days is None:
            raise TypeError("Missing 'workflow_execution_retention_period_in_days' argument")
        if name_prefix is None and 'namePrefix' in kwargs:
            name_prefix = kwargs['namePrefix']

        _setter("workflow_execution_retention_period_in_days", workflow_execution_retention_period_in_days)
