...
class CustomDbEngineVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] engine_version: The version of the database engine.
        :param pulumi.Input[builtins.str] database_installation_files_s3_bucket_name: The name of the Amazon S3 bucket that contains the database installation files.
        :param pulumi.Input[builtins.str] database_installation_files_s3_prefix: The prefix for the Amazon S3 bucket that contains the database installation files.
        :param pulumi.Input[builtins.str] description: The description of the CEV.
        :param pulumi.Input[builtins.str] filename: The name of the manifest file within the local filesystem. Conflicts with `manifest`.
    ...
    def manifest_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def manifest_hash(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CustomDbEngineVersionState:
    def __init__(__self__, *,
                 ...
                 database_installation_files_s3_bucket_name: Optional[pulumi.Input[builtins.str]] = None,
                 database_installation_files_s3_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 db_parameter_group_family: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) for the custom engine version.
        :param pulumi.Input[builtins.str] create_time: The date and time that the CEV was created.
        :param pulumi.Input[builtins.str] database_installation_files_s3_bucket_name: The name of the Amazon S3 bucket that contains the database installation files.
        :param pulumi.Input[builtins.str] database_installation_files_s3_prefix: The prefix for the Amazon S3 bucket that contains the database installation files.
        :param pulumi.Input[builtins.str] db_parameter_group_family: The name of the DB parameter group family for the CEV.
        :param pulumi.Input[builtins.str] description: The description of the CEV.
        :param pulumi.Input[builtins.str] engine: The name of the database engine. Valid values are `custom-oracle*`, `custom-sqlserver*`.
        :param pulumi.Input[builtins.str] engine_version: The version of the database engine.
        :param pulumi.Input[builtins.str] filename: The name of the manifest file within the local filesystem. Conflicts with `manifest`.
        :param pulumi.Input[builtins.str] image_id: The ID of the AMI that was created with the CEV.
        :param pulumi.Input[builtins.str] kms_key_id: The ARN of the AWS KMS key that is used to encrypt the database installation files. Required for RDS Custom for Oracle.
        :param pulumi.Input[builtins.str] major_engine_version: The major version of the database engine.
        :param pulumi.Input[builtins.str] manifest: The manifest file, in JSON format, that contains the list of database installation files. Conflicts with `filename`.
    ...
    def db_parameter_group_family(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_parameter_group_family(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def manifest_computed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def manifest_computed(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CustomDbEngineVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'CustomDbEngineVersion':
        """
    ...
    @property
    @pulumi.getter(name="dbParameterGroupFamily")
    def db_parameter_group_family(self) -> pulumi.Output[builtins.str]:
        """
        The name of the DB parameter group family for the CEV.
        """
        return pulumi.get(self, "db_parameter_group_family")
    ...
    @property
    @pulumi.getter(name="manifestComputed")
    def manifest_computed(self) -> pulumi.Output[builtins.str]:
        """
        The returned manifest file, in JSON format, service generated and often different from input `manifest`.
        """
        return pulumi.get(self, "manifest_computed")
    ...
    @property
    @pulumi.getter(name="manifestHash")
    def manifest_hash(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Used to trigger updates. Must be set to a base64-encoded SHA256 hash of the manifest source specified with `filename`. The usual way to set this is filebase64sha256("manifest.json") where "manifest.json" is the local filename of the manifest source.
        """
        return pulumi.get(self, "manifest_hash")
