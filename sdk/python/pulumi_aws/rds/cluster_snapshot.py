...
class _ClusterSnapshotState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] allocated_storage: Allocated storage size in gigabytes (GB).
        ...
        :param pulumi.Input[builtins.str] db_cluster_snapshot_identifier: The Identifier for the snapshot.
        :param pulumi.Input[builtins.str] engine: Name of the database engine.
