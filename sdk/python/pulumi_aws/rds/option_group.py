...
class OptionGroupArgs:
    def __init__(__self__, *,
                 ...
                 major_engine_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] major_engine_version: Specifies the major version of the engine that this option group should be associated with.
        :param pulumi.Input[builtins.str] name: Name of the option group. If omitted, the provider will assign a random, unique name. Must be lowercase, to match as it is stored in AWS.
    ...
    def major_engine_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def major_engine_version(self, value: pulumi.Input[builtins.str]):
    ...
    def option_group_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def option_group_description(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OptionGroupState:
    def __init__(__self__, *,
                 ...
                 engine_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the DB option group.
        :param pulumi.Input[builtins.str] engine_name: Specifies the name of the engine that this option group should be associated with.
        :param pulumi.Input[builtins.str] major_engine_version: Specifies the major version of the engine that this option group should be associated with.
        :param pulumi.Input[builtins.str] name: Name of the option group. If omitted, the provider will assign a random, unique name. Must be lowercase, to match as it is stored in AWS.
        :param pulumi.Input[builtins.str] name_prefix: Creates a unique name beginning with the specified prefix. Conflicts with `name`. Must be lowercase, to match as it is stored in AWS.
    ...
    @property
    @pulumi.getter(name="engineName")
    def engine_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the name of the engine that this option group should be associated with.
        """
        return pulumi.get(self, "engine_name")
    ...
    @engine_name.setter
    def engine_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "engine_name", value)
...
class OptionGroup(pulumi.CustomResource):
    ...
    pulumi_type = "aws:rds/optionGroup:OptionGroup"
    ...
    @property
    @pulumi.getter(name="engineName")
    def engine_name(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the name of the engine that this option group should be associated with.
        """
        return pulumi.get(self, "engine_name")
    ...
    @property
    @pulumi.getter(name="optionGroupDescription")
    def option_group_description(self) -> pulumi.Output[builtins.str]:
        """
        Description of the option group. Defaults to "Managed by Pulumi".
        """
        return pulumi.get(self, "option_group_description")
