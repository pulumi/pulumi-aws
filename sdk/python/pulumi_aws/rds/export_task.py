...
class ExportTaskArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'exportTaskIdentifier' in kwargs:
...
class _ExportTaskState:
    ...
    def _configure(
        ...
        if 'taskEndTime' in kwargs:
            task_end_time = kwargs['taskEndTime']
        if 'taskStartTime' in kwargs:
...
class ExportTask(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if timeouts is not None and not isinstance(timeouts, ExportTaskTimeoutsArgs):
                timeouts = timeouts or {}
                def _setter(key, value):
                    timeouts[key] = value
                ExportTaskTimeoutsArgs._configure(_setter, **timeouts)
