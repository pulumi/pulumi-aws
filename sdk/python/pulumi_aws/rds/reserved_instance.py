...
class ReservedInstanceArgs:
    ...
    def offering_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @offering_id.setter
    def offering_id(self, value: pulumi.Input[builtins.str]):
    ...
    def reservation_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ReservedInstanceState:
    def __init__(__self__, *,
                 ...
                 fixed_price: Optional[pulumi.Input[builtins.float]] = None,
                 instance_count: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 usage_price: Optional[pulumi.Input[builtins.float]] = None):
        """
        Input properties used for looking up and filtering ReservedInstance resources.
        :param pulumi.Input[builtins.str] arn: ARN for the reserved DB instance.
        :param pulumi.Input[builtins.str] currency_code: Currency code for the reserved DB instance.
        :param pulumi.Input[builtins.str] db_instance_class: DB instance class for the reserved DB instance.
        :param pulumi.Input[builtins.int] duration: Duration of the reservation in seconds.
        :param pulumi.Input[builtins.float] fixed_price: Fixed price charged for this reserved DB instance.
        :param pulumi.Input[builtins.int] instance_count: Number of instances to reserve. Default value is `1`.
        :param pulumi.Input[builtins.str] lease_id: Unique identifier for the lease associated with the reserved DB instance. Amazon Web Services Support might request the lease ID for an issue related to a reserved DB instance.
        :param pulumi.Input[builtins.bool] multi_az: Whether the reservation applies to Multi-AZ deployments.
        :param pulumi.Input[builtins.str] offering_id: ID of the Reserved DB instance offering to purchase. To determine an `offering_id`, see the `rds_get_reserved_instance_offering` data source.
        ...
        :param pulumi.Input[builtins.float] usage_price: Hourly price charged for this reserved DB instance.
        """
        if arn is not None:
    ...
    def fixed_price(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    @fixed_price.setter
    def fixed_price(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    @property
    @pulumi.getter(name="offeringId")
    def offering_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the Reserved DB instance offering to purchase. To determine an `offering_id`, see the `rds_get_reserved_instance_offering` data source.
    ...
    @offering_id.setter
    def offering_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "offering_id", value)
    ...
    def product_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def product_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def usage_price(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    @usage_price.setter
    def usage_price(self, value: Optional[pulumi.Input[builtins.float]]):
...
class ReservedInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            usage_price: Optional[pulumi.Input[builtins.float]] = None) -> 'ReservedInstance':
        """
    ...
    @property
    @pulumi.getter(name="fixedPrice")
    def fixed_price(self) -> pulumi.Output[builtins.float]:
        """
        Fixed price charged for this reserved DB instance.
        """
        return pulumi.get(self, "fixed_price")
    ...
    @property
    @pulumi.getter(name="offeringId")
    def offering_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the Reserved DB instance offering to purchase. To determine an `offering_id`, see the `rds_get_reserved_instance_offering` data source.
    ...
    @property
    @pulumi.getter(name="productDescription")
    def product_description(self) -> pulumi.Output[builtins.str]:
        """
        Description of the reserved DB instance.
        """
        return pulumi.get(self, "product_description")
    ...
    @property
    @pulumi.getter(name="usagePrice")
    def usage_price(self) -> pulumi.Output[builtins.float]:
        """
        Hourly price charged for this reserved DB instance.
        """
        return pulumi.get(self, "usage_price")
