...
class _ReservedInstanceState:
    ...
    def _configure(
        ...
        if 'productDescription' in kwargs:
            product_description = kwargs['productDescription']
        if 'recurringCharges' in kwargs:
