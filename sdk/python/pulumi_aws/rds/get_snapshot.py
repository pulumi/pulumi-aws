...
class GetSnapshotResult:
    ...
    def db_instance_identifier(self) -> Optional[builtins.str]:
    ...
    def db_snapshot_identifier(self) -> Optional[builtins.str]:
...
def get_snapshot(db_instance_identifier: Optional[builtins.str] = None,
                 db_snapshot_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str db_instance_identifier: Returns the list of snapshots created by the specific db_instance
    :param builtins.str db_snapshot_identifier: Returns information on a specific snapshot_id.
    :param builtins.bool include_public: Set this value to true to include manual DB snapshots that are public and can be
           copied or restored by any AWS account, otherwise set this value to false. The default is `false`.
    :param builtins.bool include_shared: Set this value to true to include shared manual DB snapshots from other
...
def get_snapshot_output(db_instance_identifier: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        db_snapshot_identifier: Optional[pulumi.Input[Optional[builtins.str]]] = None,
