...
class EventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] sns_topic: SNS topic to send events to.
        :param pulumi.Input[_builtins.bool] enabled: Boolean flag to enable/disable the subscription. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_categories: List of event categories for a SourceType that you want to subscribe to. See http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html or run `aws rds describe-event-categories`.
        :param pulumi.Input[_builtins.str] name: Name of the DB event subscription. By default generated by Terraform.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] source_ids: List of identifiers of the event sources for which events will be returned. If not specified, then all sources are included in the response. If specified, a source_type must also be specified.
        :param pulumi.Input[_builtins.str] source_type: Type of source that will be generating the events. Valid options are `db-instance`, `db-parameter-group`, `db-security-group`, `db-snapshot`, `db-cluster`, `db-cluster-snapshot`, `custom-engine-version`, `db-proxy`, `blue-green-deployment`, `db-shard-group`, and `zero-etl`. If not set, all sources will be subscribed to.
...
class _EventSubscriptionState:
    def __init__(__self__, *,
                 ...
                 name_prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 sns_topic: pulumi.Input[Optional[_builtins.str]] = None,
                 source_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 source_type: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] arn: ARN of the RDS event notification subscription
        :param pulumi.Input[_builtins.str] customer_aws_id: AWS customer account associated with the RDS event notification subscription
        :param pulumi.Input[_builtins.bool] enabled: Boolean flag to enable/disable the subscription. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_categories: List of event categories for a SourceType that you want to subscribe to. See http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html or run `aws rds describe-event-categories`.
        :param pulumi.Input[_builtins.str] name: Name of the DB event subscription. By default generated by Terraform.
        :param pulumi.Input[_builtins.str] name_prefix: Creates a unique name beginning with the specified prefix. Conflicts with `name`.
    ...
    @_builtins.property
    @pulumi.getter(name="snsTopic")
    def sns_topic(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        SNS topic to send events to.
        """
        return pulumi.get(self, "sns_topic")
    ...
    @sns_topic.setter
    def sns_topic(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "sns_topic", value)
