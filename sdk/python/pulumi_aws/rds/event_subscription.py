...
class EventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_categories: A list of event categories for a SourceType that you want to subscribe to. See http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html or run `aws rds describe-event-categories`.
        :param pulumi.Input[_builtins.str] name: The name of the DB event subscription. By default generated by this provider.
...
class _EventSubscriptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] arn: The Amazon Resource Name of the RDS event notification subscription
        :param pulumi.Input[_builtins.str] customer_aws_id: The AWS customer account associated with the RDS event notification subscription
        :param pulumi.Input[_builtins.bool] enabled: A boolean flag to enable/disable the subscription. Defaults to true.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] event_categories: A list of event categories for a SourceType that you want to subscribe to. See http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html or run `aws rds describe-event-categories`.
        :param pulumi.Input[_builtins.str] name: The name of the DB event subscription. By default generated by this provider.
        :param pulumi.Input[_builtins.str] name_prefix: The name of the DB event subscription. Conflicts with `name`.
