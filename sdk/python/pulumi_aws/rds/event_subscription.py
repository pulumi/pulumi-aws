...
class EventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] sns_topic: The SNS topic to send events to.
        :param pulumi.Input[builtins.bool] enabled: A boolean flag to enable/disable the subscription. Defaults to true.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_categories: A list of event categories for a SourceType that you want to subscribe to. See http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html or run `aws rds describe-event-categories`.
        :param pulumi.Input[builtins.str] name: The name of the DB event subscription. By default generated by this provider.
        :param pulumi.Input[builtins.str] name_prefix: The name of the DB event subscription. Conflicts with `name`.
        ...
        :param pulumi.Input[builtins.str] source_type: The type of source that will be generating the events. Valid options are `db-instance`, `db-security-group`, `db-parameter-group`, `db-snapshot`, `db-cluster`, `db-cluster-snapshot`, or `db-proxy`. If not set, all sources will be subscribed to.
...
class _EventSubscriptionState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 name_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 sns_topic: Optional[pulumi.Input[builtins.str]] = None,
                 source_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 source_type: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name of the RDS event notification subscription
        :param pulumi.Input[builtins.str] customer_aws_id: The AWS customer account associated with the RDS event notification subscription
        :param pulumi.Input[builtins.bool] enabled: A boolean flag to enable/disable the subscription. Defaults to true.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_categories: A list of event categories for a SourceType that you want to subscribe to. See http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Events.html or run `aws rds describe-event-categories`.
        :param pulumi.Input[builtins.str] name: The name of the DB event subscription. By default generated by this provider.
        :param pulumi.Input[builtins.str] name_prefix: The name of the DB event subscription. Conflicts with `name`.
    ...
    @property
    @pulumi.getter(name="snsTopic")
    def sns_topic(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The SNS topic to send events to.
        """
        return pulumi.get(self, "sns_topic")
    ...
    @sns_topic.setter
    def sns_topic(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sns_topic", value)
...
class EventSubscription(pulumi.CustomResource):
    ...
    pulumi_type = "aws:rds/eventSubscription:EventSubscription"
    ...
    @property
    @pulumi.getter(name="snsTopic")
    def sns_topic(self) -> pulumi.Output[builtins.str]:
        """
        The SNS topic to send events to.
        """
        return pulumi.get(self, "sns_topic")
