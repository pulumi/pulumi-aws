...
class ProxyDefaultTargetGroupArgs:
    ...
    def _configure(
        ...
        if 'connectionPoolConfig' in kwargs:
...
class ProxyDefaultTargetGroup(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if connection_pool_config is not None and not isinstance(connection_pool_config, ProxyDefaultTargetGroupConnectionPoolConfigArgs):
                connection_pool_config = connection_pool_config or {}
                def _setter(key, value):
                    connection_pool_config[key] = value
                ProxyDefaultTargetGroupConnectionPoolConfigArgs._configure(_setter, **connection_pool_config)
