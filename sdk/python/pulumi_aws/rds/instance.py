...
class InstanceArgs:
    def __init__(__self__, *,
                 ...
                 customer_owned_ip_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Union[builtins.str, 'InstanceType']] instance_class: The instance type of the RDS instance.
        :param pulumi.Input[builtins.int] allocated_storage: The allocated storage in gibibytes. If `max_allocated_storage` is configured, this argument represents the initial storage allocation and differences from the configuration will be ignored automatically when Storage Autoscaling occurs. If `replicate_source_db` is set, the value is ignored during the creation of the instance.
        :param pulumi.Input[builtins.bool] allow_major_version_upgrade: Indicates that major version
        ...
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: Indicates that minor engine upgrades
               will be applied automatically to the DB instance during the maintenance window.
               Defaults to true.
        :param pulumi.Input[builtins.str] availability_zone: The AZ for the RDS instance.
        :param pulumi.Input[builtins.int] backup_retention_period: The days to retain backups for.
        ...
        :param pulumi.Input[builtins.str] backup_target: Specifies where automated backups and manual snapshots are stored. Possible values are `region` (default) and `outposts`. See [Working with Amazon RDS on AWS Outposts](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-on-outposts.html) for more information.
        :param pulumi.Input[builtins.str] backup_window: The daily time range (in UTC) during which automated backups are created if they are enabled.
        ...
        :param pulumi.Input[builtins.str] ca_cert_identifier: The identifier of the CA certificate for the DB instance.
        :param pulumi.Input[builtins.str] character_set_name: The character set name to use for DB encoding in Oracle and Microsoft SQL instances (collation).
        ...
        :param pulumi.Input[builtins.bool] copy_tags_to_snapshot: Copy all Instance `tags` to snapshots. Default is `false`.
        ...
        :param pulumi.Input[builtins.bool] customer_owned_ip_enabled: Indicates whether to enable a customer-owned IP address (CoIP) for an RDS on Outposts DB instance. See [CoIP for RDS on Outposts](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-on-outposts.html#rds-on-outposts.coip) for more information.
               ...
               standalone database.
        :param pulumi.Input[builtins.str] database_insights_mode: The mode of Database Insights that is enabled for the instance. Valid values: `standard`, `advanced` .
        ...
        :param pulumi.Input[builtins.str] db_subnet_group_name: Name of DB subnet group.
        ...
        :param pulumi.Input[builtins.bool] dedicated_log_volume: Use a dedicated log volume (DLV) for the DB instance. Requires Provisioned IOPS. See the [AWS documentation](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_PIOPS.StorageTypes.html#USER_PIOPS.dlv) for more details.
        :param pulumi.Input[builtins.bool] delete_automated_backups: Specifies whether to remove automated backups immediately after the DB instance is deleted. Default is `true`.
        :param pulumi.Input[builtins.bool] deletion_protection: If the DB instance should have deletion protection enabled. The database can't be deleted when this value is set to `true`. The default is `false`.
        :param pulumi.Input[builtins.str] domain: The ID of the Directory Service Active Directory domain to create the instance in. Conflicts with `domain_fqdn`, `domain_ou`, `domain_auth_secret_arn` and a `domain_dns_ips`.
        :param pulumi.Input[builtins.str] domain_auth_secret_arn: The ARN for the Secrets Manager secret with the self managed Active Directory credentials for the user joining the domain. Conflicts with `domain` and `domain_iam_role_name`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] domain_dns_ips: The IPv4 DNS IP addresses of your primary and secondary self managed Active Directory domain controllers. Two IP addresses must be provided. If there isn't a secondary domain controller, use the IP address of the primary domain controller for both entries in the list. Conflicts with `domain` and `domain_iam_role_name`.
        :param pulumi.Input[builtins.str] domain_fqdn: The fully qualified domain name (FQDN) of the self managed Active Directory domain. Conflicts with `domain` and `domain_iam_role_name`.
        :param pulumi.Input[builtins.str] domain_iam_role_name: The name of the IAM role to be used when making API calls to the Directory Service. Conflicts with `domain_fqdn`, `domain_ou`, `domain_auth_secret_arn` and a `domain_dns_ips`.
        :param pulumi.Input[builtins.str] domain_ou: The self managed Active Directory organizational unit for your DB instance to join. Conflicts with `domain` and `domain_iam_role_name`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] enabled_cloudwatch_logs_exports: Set of log types to enable for exporting to CloudWatch logs. If omitted, no logs will be exported. For supported values, see the EnableCloudwatchLogsExports.member.N parameter in [API action CreateDBInstance](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateDBInstance.html).
        :param pulumi.Input[builtins.str] engine: The database engine to use. For supported values, see the Engine parameter in [API action CreateDBInstance](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateDBInstance.html). Note that for Amazon Aurora instances the engine must match the DB cluster's engine'. For information on the difference between the available Aurora MySQL engines see [Comparison between Aurora MySQL 1 and Aurora MySQL 2](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/AuroraMySQL.Updates.20180206.html) in the Amazon RDS User Guide.
        :param pulumi.Input[builtins.str] engine_lifecycle_support: The life cycle type for this DB instance. This setting applies only to RDS for MySQL and RDS for PostgreSQL. Valid values are `open-source-rds-extended-support`, `open-source-rds-extended-support-disabled`. Default value is `open-source-rds-extended-support`. [Using Amazon RDS Extended Support]: https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/extended-support.html
        :param pulumi.Input[builtins.str] engine_version: The engine version to use. If `auto_minor_version_upgrade` is enabled, you can provide a prefix of the version such as `8.0` (for `8.0.36`). The actual engine version used is returned in the attribute `engine_version_actual`, see Attribute Reference below. For supported values, see the EngineVersion parameter in [API action CreateDBInstance](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateDBInstance.html). Note that for Amazon Aurora instances the engine version must match the DB cluster's engine version'.
        ...
        :param pulumi.Input[builtins.bool] iam_database_authentication_enabled: Specifies whether mappings of AWS Identity and Access Management (IAM) accounts to database
               accounts is enabled.
        :param pulumi.Input[builtins.str] identifier: The name of the RDS instance, if omitted, this provider will assign a random, unique identifier. Required if `restore_to_point_in_time` is specified.
        ...
        :param pulumi.Input[builtins.int] iops: The amount of provisioned IOPS. Setting this implies a
        ...
        :param pulumi.Input[builtins.str] license_model: License model information for this DB instance. Valid values for this field are as follows:
               * RDS for MariaDB: `general-public-license`
               * RDS for Microsoft SQL Server: `license-included`
               * RDS for MySQL: `general-public-license`
               * RDS for Oracle: `bring-your-own-license | license-included`
               * RDS for PostgreSQL: `postgresql-license`
        :param pulumi.Input[builtins.str] maintenance_window: The window to perform maintenance in.
               Syntax: "ddd:hh24:mi-ddd:hh24:mi". Eg: "Mon:00:00-Mon:03:00". See [RDS
               Maintenance Window
               docs](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_UpgradeDBInstance.Maintenance.html#AdjustingTheMaintenanceWindow)
               for more information.
        :param pulumi.Input[builtins.bool] manage_master_user_password: Set to true to allow RDS to manage the master user password in Secrets Manager. Cannot be set if `password` or `password_wo` is provided.
        :param pulumi.Input[builtins.str] master_user_secret_kms_key_id: The Amazon Web Services KMS key identifier is the key ARN, key ID, alias ARN, or alias name for the KMS key. To use a KMS key in a different Amazon Web Services account, specify the key ARN or alias ARN. If not specified, the default KMS key for your Amazon Web Services account is used.
        :param pulumi.Input[builtins.int] max_allocated_storage: Specifies the maximum storage (in GiB) that Amazon RDS can automatically scale to for this DB instance. By default, Storage Autoscaling is disabled. To enable Storage Autoscaling, set `max_allocated_storage` to **greater than or equal to** `allocated_storage`. Setting `max_allocated_storage` to 0 explicitly disables Storage Autoscaling. When configured, changes to `allocated_storage` will be automatically ignored as the storage can dynamically scale.
        :param pulumi.Input[builtins.int] monitoring_interval: The interval, in seconds, between points
               when Enhanced Monitoring metrics are collected for the DB instance. To disable
               collecting Enhanced Monitoring metrics, specify 0. The default is 0. Valid
               Values: 0, 1, 5, 10, 15, 30, 60.
        :param pulumi.Input[builtins.str] monitoring_role_arn: The ARN for the IAM role that permits RDS
               to send enhanced monitoring metrics to CloudWatch Logs. You can find more
               information on the [AWS
               Documentation](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_Monitoring.html)
               what IAM permissions are needed to allow Enhanced Monitoring for RDS Instances.
        :param pulumi.Input[builtins.bool] multi_az: Specifies if the RDS instance is multi-AZ
        :param pulumi.Input[builtins.str] nchar_character_set_name: The national character set is used in the NCHAR, NVARCHAR2, and NCLOB data types for Oracle instances. This can't be changed. See [Oracle Character Sets
               Supported in Amazon RDS](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Appendix.OracleCharacterSets.html).
        :param pulumi.Input[builtins.str] network_type: The network type of the DB instance. Valid values: `IPV4`, `DUAL`.
        :param pulumi.Input[builtins.str] option_group_name: Name of the DB option group to associate.
        :param pulumi.Input[builtins.str] parameter_group_name: Name of the DB parameter group to associate.
        :param pulumi.Input[builtins.str] password: Password for the master DB user. Note that this may show up in logs, and it will be stored in the state file. Cannot be set if `manage_master_user_password` is set to `true`.
        :param pulumi.Input[builtins.bool] performance_insights_enabled: Specifies whether Performance Insights are enabled. Defaults to false.
        :param pulumi.Input[builtins.str] performance_insights_kms_key_id: The ARN for the KMS key to encrypt Performance Insights data. When specifying `performance_insights_kms_key_id`, `performance_insights_enabled` needs to be set to true. Once KMS key is set, it can never be changed.
        ...
        :param pulumi.Input[builtins.bool] skip_final_snapshot: Determines whether a final DB snapshot is
               created before the DB instance is deleted. If true is specified, no DBSnapshot
               is created. If false is specified, a DB snapshot is created before the DB
               instance is deleted, using the value from `final_snapshot_identifier`. Default
               is `false`.
        :param pulumi.Input[builtins.str] snapshot_identifier: Specifies whether or not to create this database from a snapshot.
               This corresponds to the snapshot ID you'd find in the RDS console, e.g: rds:production-2015-06-26-06-05.
        :param pulumi.Input[builtins.bool] storage_encrypted: Specifies whether the DB instance is
               encrypted. Note that if you are creating a cross-region read replica this field
               is ignored and you should instead declare `kms_key_id` with a valid ARN. The
               default is `false` if not specified.
        :param pulumi.Input[builtins.int] storage_throughput: The storage throughput value for the DB instance. Can only be set when `storage_type` is `"gp3"`. Cannot be specified if the `allocated_storage` value is below a per-`engine` threshold. See the [RDS User Guide](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_Storage.html#gp3-storage) for details.
        :param pulumi.Input[Union[builtins.str, 'StorageType']] storage_type: One of "standard" (magnetic), "gp2" (general
        ...
        :param pulumi.Input[builtins.str] timezone: Time zone of the DB instance. `timezone` is currently
               ...
               for more information.
        :param pulumi.Input[builtins.bool] upgrade_storage_config: Whether to upgrade the storage file system configuration on the read replica.
               Can only be set with `replicate_source_db`.
        :param pulumi.Input[builtins.str] username: (Required unless a `snapshot_identifier` or `replicate_source_db`
               is provided) Username for the master DB user. Cannot be specified for a replica.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_security_group_ids: List of VPC security groups to
               associate.
        """
    ...
    def customer_owned_ip_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def replicate_source_db(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replicate_source_db(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def upgrade_storage_config(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def upgrade_storage_config(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 iops: Optional[pulumi.Input[builtins.int]] = None,
                 kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 latest_restorable_time: Optional[pulumi.Input[builtins.str]] = None,
                 license_model: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] apply_immediately: Specifies whether any database modifications
               ...
               `false`. See [Amazon RDS Documentation for more
               information.](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Overview.DBInstance.Modifying.html)
        :param pulumi.Input[builtins.str] arn: The ARN of the RDS instance.
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: Indicates that minor engine upgrades
               will be applied automatically to the DB instance during the maintenance window.
               Defaults to true.
        :param pulumi.Input[builtins.str] availability_zone: The AZ for the RDS instance.
        ...
        :param pulumi.Input[builtins.str] engine_lifecycle_support: The life cycle type for this DB instance. This setting applies only to RDS for MySQL and RDS for PostgreSQL. Valid values are `open-source-rds-extended-support`, `open-source-rds-extended-support-disabled`. Default value is `open-source-rds-extended-support`. [Using Amazon RDS Extended Support]: https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/extended-support.html
        :param pulumi.Input[builtins.str] engine_version: The engine version to use. If `auto_minor_version_upgrade` is enabled, you can provide a prefix of the version such as `8.0` (for `8.0.36`). The actual engine version used is returned in the attribute `engine_version_actual`, see Attribute Reference below. For supported values, see the EngineVersion parameter in [API action CreateDBInstance](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateDBInstance.html). Note that for Amazon Aurora instances the engine version must match the DB cluster's engine version'.
        :param pulumi.Input[builtins.str] engine_version_actual: The running version of the database.
        :param pulumi.Input[builtins.str] final_snapshot_identifier: The name of your final DB snapshot
               when this DB instance is deleted. Must be provided if `skip_final_snapshot` is
               set to `false`. The value must begin with a letter, only contain alphanumeric characters and hyphens, and not end with a hyphen or contain two consecutive hyphens. Must not be provided when deleting a read replica.
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The ARN for the KMS encryption key. If creating an
               encrypted replica, set this to the destination KMS ARN.
        :param pulumi.Input[builtins.str] latest_restorable_time: The latest time, in UTC [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8), to which a database can be restored with point-in-time restore.
        :param pulumi.Input[builtins.str] license_model: License model information for this DB instance. Valid values for this field are as follows:
               * RDS for MariaDB: `general-public-license`
               * RDS for Microsoft SQL Server: `license-included`
               * RDS for MySQL: `general-public-license`
        ...
        :param pulumi.Input[builtins.str] replicate_source_db: Specifies that this resource is a Replica database, and to use this value as the source database.
               ...
               Note that if you are creating a cross-region replica of an encrypted database you will also need to specify a `kms_key_id`.
               See [DB Instance Replication][instance-replication] and [Working with PostgreSQL and MySQL Read Replicas](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_ReadRepl.html) for more information on using Replication.
        :param pulumi.Input[builtins.str] resource_id: The RDS Resource ID of this instance.
        :param pulumi.Input['InstanceRestoreToPointInTimeArgs'] restore_to_point_in_time: A configuration block for restoring a DB instance to an arbitrary point in time.
               Requires the `identifier` argument to be set with the name of the new DB instance to be created.
               See Restore To Point In Time below for details.
        :param pulumi.Input['InstanceS3ImportArgs'] s3_import: Restore from a Percona Xtrabackup in S3.  See [Importing Data into an Amazon RDS MySQL DB Instance](http://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/MySQL.Procedural.Importing.html)
        ...
        :param pulumi.Input[builtins.str] snapshot_identifier: Specifies whether or not to create this database from a snapshot.
               This corresponds to the snapshot ID you'd find in the RDS console, e.g: rds:production-2015-06-26-06-05.
        :param pulumi.Input[builtins.str] status: The RDS instance status.
        :param pulumi.Input[builtins.bool] storage_encrypted: Specifies whether the DB instance is
               encrypted. Note that if you are creating a cross-region read replica this field
               is ignored and you should instead declare `kms_key_id` with a valid ARN. The
               default is `false` if not specified.
    ...
    def latest_restorable_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def latest_restorable_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def replicas(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "replicas")

    @replicas.setter
    def replicas(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Instance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="backupTarget")
    def backup_target(self) -> pulumi.Output[builtins.str]:
        """
        Specifies where automated backups and manual snapshots are stored. Possible values are `region` (default) and `outposts`. See [Working with Amazon RDS on AWS Outposts](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/rds-on-outposts.html) for more information.
        """
        return pulumi.get(self, "backup_target")
    ...
    @property
    @pulumi.getter(name="domainFqdn")
    def domain_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The fully qualified domain name (FQDN) of the self managed Active Directory domain. Conflicts with `domain` and `domain_iam_role_name`.
        """
        return pulumi.get(self, "domain_fqdn")
    ...
    @property
    @pulumi.getter(name="replicaMode")
    def replica_mode(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether the replica is in either `mounted` or `open-read-only` mode. This attribute
        is only supported by Oracle instances. Oracle replicas operate in `open-read-only` mode unless otherwise specified. See [Working with Oracle Read Replicas](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/oracle-read-replicas.html) for more information.
        """
    ...
    @property
    @pulumi.getter
    def replicas(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "replicas")

    @property
    @pulumi.getter(name="replicateSourceDb")
    def replicate_source_db(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies that this resource is a Replica database, and to use this value as the source database.
        If replicating an Amazon RDS Database Instance in the same region, use the `identifier` of the source DB, unless also specifying the `db_subnet_group_name`.
        If specifying the `db_subnet_group_name` in the same region, use the `arn` of the source DB.
    ...
    @property
    @pulumi.getter(name="upgradeStorageConfig")
    def upgrade_storage_config(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to upgrade the storage file system configuration on the read replica.
        Can only be set with `replicate_source_db`.
        """
