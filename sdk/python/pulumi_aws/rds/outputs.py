...
class ClusterRestoreToPointInTime(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'sourceClusterIdentifier' in kwargs:
...
class ClusterS3Import(dict):
    ...
    def _configure(
        ...
        if 'ingestionRole' in kwargs:
            ingestion_role = kwargs['ingestionRole']
        if 'sourceEngine' in kwargs:
            source_engine = kwargs['sourceEngine']
        if 'sourceEngineVersion' in kwargs:
...
class GlobalClusterGlobalClusterMember(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'dbClusterArn' in kwargs:
            db_cluster_arn = kwargs['dbClusterArn']
        if 'isWriter' in kwargs:
...
class OptionGroupOption(dict):
    ...
    def _configure(
        ...
        if 'dbSecurityGroupMemberships' in kwargs:
        ...
        if 'vpcSecurityGroupMemberships' in kwargs:
...
class ProxyAuth(dict):
    ...
    def _configure(
        ...
        if 'clientPasswordAuthType' in kwargs:
            client_password_auth_type = kwargs['clientPasswordAuthType']
        if 'iamAuth' in kwargs:
...
class ReservedInstanceRecurringCharge(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'recurringChargeAmount' in kwargs:
            recurring_charge_amount = kwargs['recurringChargeAmount']
        if 'recurringChargeFrequency' in kwargs:
