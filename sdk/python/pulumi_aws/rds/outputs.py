...
class ClusterParameterGroupParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str name: The name of the DB cluster parameter group. If omitted, the provider will assign a random, unique name.
...
class ParameterGroupParameter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 apply_method: Optional[str] = None):
        """
        :param str name: The name of the DB parameter group. If omitted, this provider will assign a random, unique name.
        :param str value: The value of the DB parameter.
        :param str apply_method: "immediate" (default), or "pending-reboot". Some
               engines can't apply some parameters without a reboot, and you will need to
               specify "pending-reboot" here.
