...
class SnapshotCopyArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'sourceDbSnapshotIdentifier' in kwargs:
            source_db_snapshot_identifier = kwargs['sourceDbSnapshotIdentifier']
        if 'targetDbSnapshotIdentifier' in kwargs:
        ...
        if 'presignedUrl' in kwargs:
            presigned_url = kwargs['presignedUrl']
        if 'targetCustomAvailabilityZone' in kwargs:
