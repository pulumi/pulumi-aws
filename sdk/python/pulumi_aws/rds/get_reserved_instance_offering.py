...
def get_reserved_instance_offering(db_instance_class: Optional[builtins.str] = None,
    ...
    :param builtins.str db_instance_class: DB instance class for the reserved DB instance.
    :param builtins.int duration: Duration of the reservation in years or seconds. Valid values are `1`, `3`, `31536000`, `94608000`
