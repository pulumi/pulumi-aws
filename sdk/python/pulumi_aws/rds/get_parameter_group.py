...
def get_parameter_group(name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name: DB parameter group name.
...
def get_parameter_group_output(name: Optional[pulumi.Input[_builtins.str]] = None,
