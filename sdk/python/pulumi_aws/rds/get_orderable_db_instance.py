...
class GetOrderableDbInstanceResult:
    ...
    def engine_latest_version(self) -> Optional[builtins.bool]:
    ...
    def max_iops_per_db_instance(self) -> builtins.int:
        """
    ...
    def max_iops_per_gib(self) -> builtins.float:
        """
    ...
    def max_storage_size(self) -> builtins.int:
        """
    ...
    def min_iops_per_db_instance(self) -> builtins.int:
        """
    ...
    def min_iops_per_gib(self) -> builtins.float:
        """
    ...
    def min_storage_size(self) -> builtins.int:
        """
    ...
    def multi_az_capable(self) -> builtins.bool:
        """
    ...
    def outpost_capable(self) -> builtins.bool:
        """
    ...
    def preferred_engine_versions(self) -> Optional[Sequence[builtins.str]]:
    ...
    def read_replica_capable(self) -> builtins.bool:
    ...
    def supported_engine_modes(self) -> Sequence[builtins.str]:
    ...
    def supports_clusters(self) -> builtins.bool:
        return pulumi.get(self, "supports_clusters")

    @property
    @pulumi.getter(name="supportsEnhancedMonitoring")
    def supports_enhanced_monitoring(self) -> builtins.bool:
...
def get_orderable_db_instance(availability_zone_group: Optional[builtins.str] = None,
                              engine: Optional[builtins.str] = None,
                              engine_latest_version: Optional[builtins.bool] = None,
                              ...
                              supports_clusters: Optional[builtins.bool] = None,
                              supports_enhanced_monitoring: Optional[builtins.bool] = None,
                              supports_global_databases: Optional[builtins.bool] = None,
                              supports_iam_database_authentication: Optional[builtins.bool] = None,
                              supports_iops: Optional[builtins.bool] = None,
                              supports_kerberos_authentication: Optional[builtins.bool] = None,
                              supports_multi_az: Optional[builtins.bool] = None,
                              supports_performance_insights: Optional[builtins.bool] = None,
                              supports_storage_autoscaling: Optional[builtins.bool] = None,
                              supports_storage_encryption: Optional[builtins.bool] = None,
    ...
    :param builtins.str availability_zone_group: Availability zone group.
    :param builtins.str engine: DB engine. Engine values include `aurora`, `aurora-mysql`, `aurora-postgresql`, `docdb`, `mariadb`, `mysql`, `neptune`, `oracle-ee`, `oracle-se`, `oracle-se1`, `oracle-se2`, `postgres`, `sqlserver-ee`, `sqlserver-ex`, `sqlserver-se`, and `sqlserver-web`.
    :param builtins.bool engine_latest_version: When set to `true`, the data source attempts to return the most recent version matching the other criteria you provide. You must use `engine_latest_version` with `preferred_instance_classes` and/or `preferred_engine_versions`. Using `engine_latest_version` will avoid `multiple RDS DB Instance Classes` errors. If you use `engine_latest_version` with `preferred_instance_classes`, the data source returns the latest version for the _first_ matching instance class (instance class priority). **Note:** The data source uses a best-effort approach at selecting the latest version but due to the complexity of version identifiers across engines, using `engine_latest_version` may _not_ return the latest version in every situation.
    :param builtins.str engine_version: Version of the DB engine. If none is provided, the data source tries to use the AWS-defined default version that matches any other criteria.
    :param builtins.str instance_class: DB instance class. Examples of classes are `db.m3.2xlarge`, `db.t2.small`, and `db.m3.medium`.
    :param builtins.str license_model: License model. Examples of license models are `general-public-license`, `bring-your-own-license`, and `amazon-license`.
    ...
    :param builtins.bool supports_clusters: Whether to limit results to instances that support clusters.
    :param builtins.bool supports_enhanced_monitoring: Enable this to ensure a DB instance supports Enhanced Monitoring at intervals from 1 to 60 seconds.
    :param builtins.bool supports_global_databases: Enable this to ensure a DB instance supports Aurora global databases with a specific combination of other DB engine attributes.
    :param builtins.bool supports_iam_database_authentication: Enable this to ensure a DB instance supports IAM database authentication.
    :param builtins.bool supports_iops: Enable this to ensure a DB instance supports provisioned IOPS.
    :param builtins.bool supports_kerberos_authentication: Enable this to ensure a DB instance supports Kerberos Authentication.
    :param builtins.bool supports_multi_az: Whether to limit results to instances that are multi-AZ capable.
    :param builtins.bool supports_performance_insights: Enable this to ensure a DB instance supports Performance Insights.
    :param builtins.bool supports_storage_autoscaling: Enable this to ensure Amazon RDS can automatically scale storage for DB instances that use the specified DB instance class.
    :param builtins.bool supports_storage_encryption: Enable this to ensure a DB instance supports encrypted storage.
    :param builtins.bool vpc: Boolean that indicates whether to show only VPC or non-VPC offerings.
    """
    __args__ = dict()
...
def get_orderable_db_instance_output(availability_zone_group: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     engine: Optional[pulumi.Input[builtins.str]] = None,
                                     engine_latest_version: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     ...
                                     supports_clusters: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     supports_enhanced_monitoring: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     supports_global_databases: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     supports_iam_database_authentication: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     supports_iops: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     supports_kerberos_authentication: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     supports_multi_az: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     supports_performance_insights: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     supports_storage_autoscaling: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     supports_storage_encryption: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
