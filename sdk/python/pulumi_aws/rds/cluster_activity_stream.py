...
class _ClusterActivityStreamState:
    ...
    def kinesis_stream_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def kinesis_stream_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterActivityStream(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="kinesisStreamName")
    def kinesis_stream_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Amazon Kinesis data stream to be used for the database activity stream.
        """
        return pulumi.get(self, "kinesis_stream_name")
