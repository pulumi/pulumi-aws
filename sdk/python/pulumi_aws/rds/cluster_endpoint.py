...
class ClusterEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test1 = aws.rds.cluster_instance.ClusterInstance("test1",
        ...
        test2 = aws.rds.cluster_instance.ClusterInstance("test2",
            apply_immediately=True,
            cluster_identifier=default.id,
            identifier=test2,
            instance_class=db.t2.small,
            engine=default.engine,
            engine_version=default.engine_version)
        test3 = aws.rds.cluster_instance.ClusterInstance("test3",
            apply_immediately=True,
            cluster_identifier=default.id,
            identifier=test3,
            instance_class=db.t2.small,
            engine=default.engine,
            engine_version=default.engine_version)
        eligible = aws.rds.cluster_endpoint.ClusterEndpoint("eligible",
            cluster_identifier=default.id,
        ...
        static = aws.rds.cluster_endpoint.ClusterEndpoint("static",
            cluster_identifier=default.id,
