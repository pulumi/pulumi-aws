...
class ClusterEndpointArgs:
    def __init__(__self__, *,
                 cluster_endpoint_identifier: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] cluster_endpoint_identifier: The identifier to use for the new endpoint. This parameter is stored as a lowercase string.
    ...
    def cluster_endpoint_identifier(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cluster_endpoint_identifier(self, value: pulumi.Input[builtins.str]):
    ...
    def custom_endpoint_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def custom_endpoint_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "custom_endpoint_type", value)

    @property
    @pulumi.getter(name="excludedMembers")
    def excluded_members(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def excluded_members(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def static_members(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ClusterEndpointState:
    def __init__(__self__, *,
                 ...
                 cluster_endpoint_identifier: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="clusterEndpointIdentifier")
    def cluster_endpoint_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier to use for the new endpoint. This parameter is stored as a lowercase string.
        """
        return pulumi.get(self, "cluster_endpoint_identifier")
    ...
    @cluster_endpoint_identifier.setter
    def cluster_endpoint_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cluster_endpoint_identifier", value)
    ...
    @property
    @pulumi.getter(name="customEndpointType")
    def custom_endpoint_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the endpoint. One of: READER , ANY .
        """
        return pulumi.get(self, "custom_endpoint_type")
    ...
    @custom_endpoint_type.setter
    def custom_endpoint_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_endpoint_type", value)
...
class ClusterEndpoint(pulumi.CustomResource):
    ...
    pulumi_type = "aws:rds/clusterEndpoint:ClusterEndpoint"
    ...
    @property
    @pulumi.getter(name="clusterEndpointIdentifier")
    def cluster_endpoint_identifier(self) -> pulumi.Output[builtins.str]:
        """
        The identifier to use for the new endpoint. This parameter is stored as a lowercase string.
        """
        return pulumi.get(self, "cluster_endpoint_identifier")
    ...
    @property
    @pulumi.getter(name="customEndpointType")
    def custom_endpoint_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the endpoint. One of: READER , ANY .
        """
        return pulumi.get(self, "custom_endpoint_type")
    ...
    @property
    @pulumi.getter(name="excludedMembers")
    def excluded_members(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of DB instance identifiers that aren't part of the custom endpoint group. All other eligible instances are reachable through the custom endpoint. Only relevant if the list of static members is empty. Conflicts with `static_members`.
        """
        return pulumi.get(self, "excluded_members")
