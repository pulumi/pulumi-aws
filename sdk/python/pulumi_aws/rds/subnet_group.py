...
class _SubnetGroupState:
    ...
    def _configure(
        ...
        if subnet_ids is None and 'subnetIds' in kwargs:
            subnet_ids = kwargs['subnetIds']
        if supported_network_types is None and 'supportedNetworkTypes' in kwargs:
            supported_network_types = kwargs['supportedNetworkTypes']
        ...
        if supported_network_types is not None:
            _setter("supported_network_types", supported_network_types)
        if tags is not None:
            _setter("tags", tags)
