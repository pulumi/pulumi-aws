...
class JobTemplateJobTemplateData(dict):
    ...
    def __init__(__self__, *,
                 ...
                 job_tags: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str execution_role_arn: The execution role ARN of the job run.
        ...
        :param builtins.str release_label: The release version of Amazon EMR.
        ...
        :param Mapping[str, builtins.str] job_tags: The tags assigned to jobs started using the job template.
        """
    ...
    def job_tags(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class JobTemplateJobTemplateDataConfigurationOverridesApplicationConfiguration(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] properties: A set of properties specified within a configuration classification.
        """
...
class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 persistent_app_ui: Optional[builtins.str] = None,
        ...
        :param builtins.str persistent_app_ui: Monitoring configurations for the persistent application UI.
    ...
    def persistent_app_ui(self) -> Optional[builtins.str]:
        """
...
class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationCloudWatchMonitoringConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_group_name: The name of the log group for log publishing.
        :param builtins.str log_stream_name_prefix: The specified name prefix for log streams.
        """
...
class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationS3MonitoringConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_uri: Amazon S3 destination URI for log publishing.
        """
...
class JobTemplateJobTemplateDataJobDriverSparkSqlJobDriver(dict):
    ...
    def __init__(__self__, *,
                 ...
                 spark_sql_parameters: Optional[builtins.str] = None):
        """
        :param builtins.str entry_point: The SQL file to be executed.
        :param builtins.str spark_sql_parameters: The Spark parameters to be included in the Spark SQL command.
        """
    ...
    def spark_sql_parameters(self) -> Optional[builtins.str]:
        """
...
class JobTemplateJobTemplateDataJobDriverSparkSubmitJobDriver(dict):
    ...
    def __init__(__self__, *,
                 ...
                 entry_point_arguments: Optional[Sequence[builtins.str]] = None,
                 spark_submit_parameters: Optional[builtins.str] = None):
        """
        :param builtins.str entry_point: The entry point of job application.
        :param Sequence[builtins.str] entry_point_arguments: The arguments for job application.
        :param builtins.str spark_submit_parameters: The Spark submit parameters that are used for job runs.
        """
        pulumi.set(__self__, "entry_point", entry_point)
    ...
    def entry_point_arguments(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def spark_submit_parameters(self) -> Optional[builtins.str]:
        """
...
class VirtualClusterContainerProvider(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str id: The name of the container provider that is running your EMR Containers cluster
        ...
        :param builtins.str type: The type of the container provider
        """
...
class VirtualClusterContainerProviderInfoEksInfo(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str namespace: The namespace where the EMR Containers cluster is running
        """
