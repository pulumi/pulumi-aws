...
if not MYPY:
    class JobTemplateJobTemplateDataArgsDict(TypedDict):
        ...
        """
        job_tags: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class JobTemplateJobTemplateDataArgs:
    def __init__(__self__, *,
                 ...
                 job_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] execution_role_arn: The execution role ARN of the job run.
        ...
        :param pulumi.Input[builtins.str] release_label: The release version of Amazon EMR.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] job_tags: The tags assigned to jobs started using the job template.
        """
    ...
    def job_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        The tags assigned to jobs started using the job template.
        """
    ...
    @job_tags.setter
    def job_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class JobTemplateJobTemplateDataConfigurationOverridesApplicationConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: A set of properties specified within a configuration classification.
        """
...
if not MYPY:
    class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationArgsDict(TypedDict):
        ...
        """
        persistent_app_ui: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 persistent_app_ui: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] persistent_app_ui: Monitoring configurations for the persistent application UI.
    ...
    def persistent_app_ui(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Monitoring configurations for the persistent application UI.
        """
    ...
    def persistent_app_ui(self, value: Optional[pulumi.Input[builtins.str]]):
...
class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationCloudWatchMonitoringConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] log_group_name: The name of the log group for log publishing.
        :param pulumi.Input[builtins.str] log_stream_name_prefix: The specified name prefix for log streams.
        """
...
if not MYPY:
    class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationS3MonitoringConfigurationArgsDict(TypedDict):
        log_uri: pulumi.Input[builtins.str]
        """
...
class JobTemplateJobTemplateDataConfigurationOverridesMonitoringConfigurationS3MonitoringConfigurationArgs:
    def __init__(__self__, *,
                 log_uri: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] log_uri: Amazon S3 destination URI for log publishing.
        """
        pulumi.set(__self__, "log_uri", log_uri)

    @property
    @pulumi.getter(name="logUri")
    def log_uri(self) -> pulumi.Input[builtins.str]:
        """
        Amazon S3 destination URI for log publishing.
        """
    ...
    @log_uri.setter
    def log_uri(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class JobTemplateJobTemplateDataJobDriverSparkSqlJobDriverArgsDict(TypedDict):
        ...
        """
        spark_sql_parameters: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobTemplateJobTemplateDataJobDriverSparkSqlJobDriverArgs:
    def __init__(__self__, *,
                 ...
                 spark_sql_parameters: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] entry_point: The SQL file to be executed.
        :param pulumi.Input[builtins.str] spark_sql_parameters: The Spark parameters to be included in the Spark SQL command.
        """
    ...
    def spark_sql_parameters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Spark parameters to be included in the Spark SQL command.
        """
    ...
    def spark_sql_parameters(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class JobTemplateJobTemplateDataJobDriverSparkSubmitJobDriverArgsDict(TypedDict):
        entry_point: pulumi.Input[builtins.str]
        """
        The entry point of job application.
        """
        entry_point_arguments: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The arguments for job application.
        """
        spark_submit_parameters: NotRequired[pulumi.Input[builtins.str]]
        """
...
class JobTemplateJobTemplateDataJobDriverSparkSubmitJobDriverArgs:
    def __init__(__self__, *,
                 entry_point: pulumi.Input[builtins.str],
                 entry_point_arguments: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 spark_submit_parameters: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] entry_point: The entry point of job application.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] entry_point_arguments: The arguments for job application.
        :param pulumi.Input[builtins.str] spark_submit_parameters: The Spark submit parameters that are used for job runs.
        """
        pulumi.set(__self__, "entry_point", entry_point)
    ...
    @property
    @pulumi.getter(name="entryPoint")
    def entry_point(self) -> pulumi.Input[builtins.str]:
        """
        The entry point of job application.
        """
        return pulumi.get(self, "entry_point")
    ...
    @entry_point.setter
    def entry_point(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "entry_point", value)

    @property
    @pulumi.getter(name="entryPointArguments")
    def entry_point_arguments(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The arguments for job application.
        """
    ...
    def entry_point_arguments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "entry_point_arguments", value)

    @property
    @pulumi.getter(name="sparkSubmitParameters")
    def spark_submit_parameters(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Spark submit parameters that are used for job runs.
        """
    ...
    def spark_submit_parameters(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VirtualClusterContainerProviderArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: The name of the container provider that is running your EMR Containers cluster
...
class VirtualClusterContainerProviderInfoEksInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] namespace: The namespace where the EMR Containers cluster is running
        """
