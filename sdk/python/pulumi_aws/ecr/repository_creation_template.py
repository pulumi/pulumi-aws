...
class RepositoryCreationTemplateArgs:
    def __init__(__self__, *,
                 ...
                 encryption_configurations: pulumi.Input[Optional[Sequence[pulumi.Input['RepositoryCreationTemplateEncryptionConfigurationArgs']]]] = None,
    ...
    def encryption_configurations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RepositoryCreationTemplateEncryptionConfigurationArgs']]]]:
        """
    ...
    def encryption_configurations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RepositoryCreationTemplateEncryptionConfigurationArgs']]]]):
...
class _RepositoryCreationTemplateState:
    ...
    @_builtins.property
    @pulumi.getter(name="appliedFors")
    def applied_fors(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        Which features this template applies to. Must contain one or more of `CREATE_ON_PUSH`, `PULL_THROUGH_CACHE`, or `REPLICATION`.
        """
        return pulumi.get(self, "applied_fors")
    ...
    @applied_fors.setter
    def applied_fors(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "applied_fors", value)
...
class RepositoryCreationTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            registry_id: pulumi.Input[Optional[_builtins.str]] = None,
            repository_policy: pulumi.Input[Optional[_builtins.str]] = None,
            resource_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'RepositoryCreationTemplate':
        """
