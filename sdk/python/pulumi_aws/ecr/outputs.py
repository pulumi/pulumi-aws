...
class RegistryScanningConfigurationRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str scan_frequency: The frequency that scans are performed at for a private registry. Can be `SCAN_ON_PUSH`, `CONTINUOUS_SCAN`, or `MANUAL`.
        """
...
class ReplicationConfigurationReplicationConfigurationRuleDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: A Region to replicate to.
        :param builtins.str registry_id: The account ID of the destination registry to replicate to.
        """
...
class ReplicationConfigurationReplicationConfigurationRuleRepositoryFilter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 filter_type: builtins.str):
        """
        :param builtins.str filter: The repository filter details.
        :param builtins.str filter_type: The repository filter type. The only supported value is `PREFIX_MATCH`, which is a repository name prefix specified with the filter parameter.
        """
        pulumi.set(__self__, "filter", filter)
        pulumi.set(__self__, "filter_type", filter_type)
...
class RepositoryCreationTemplateEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str encryption_type: The encryption type to use for any created repositories. Valid values are `AES256` or `KMS`. Defaults to `AES256`.
        :param builtins.str kms_key: The ARN of the KMS key to use when `encryption_type` is `KMS`. If not specified, uses the default AWS managed key for ECR.
        """
...
class RepositoryEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key: Optional[builtins.str] = None):
        """
        :param builtins.str encryption_type: The encryption type to use for the repository. Valid values are `AES256` or `KMS`. Defaults to `AES256`.
        :param builtins.str kms_key: The ARN of the KMS key to use when `encryption_type` is `KMS`. If not specified, uses the default AWS managed key for ECR.
        """
        if encryption_type is not None:
            pulumi.set(__self__, "encryption_type", encryption_type)
...
class RepositoryImageScanningConfiguration(dict):
    ...
    def __init__(__self__, *,
                 scan_on_push: builtins.bool):
        """
        :param builtins.bool scan_on_push: Indicates whether images are scanned after being pushed to the repository (true) or not scanned (false).
        """
...
class GetRepositoryCreationTemplateEncryptionConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str encryption_type: Encryption type to use for any created repositories, either `AES256` or `KMS`.
        :param builtins.str kms_key: If `encryption_type` is `KMS`, the ARN of the KMS key used.
        """
        pulumi.set(__self__, "encryption_type", encryption_type)
        pulumi.set(__self__, "kms_key", kms_key)
...
class GetRepositoryEncryptionConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 kms_key: builtins.str):
        """
        :param builtins.str encryption_type: Encryption type to use for the repository, either `AES256` or `KMS`.
        :param builtins.str kms_key: If `encryption_type` is `KMS`, the ARN of the KMS key used.
        """
        pulumi.set(__self__, "encryption_type", encryption_type)
        pulumi.set(__self__, "kms_key", kms_key)
...
class GetRepositoryImageScanningConfigurationResult(dict):
    def __init__(__self__, *,
                 scan_on_push: builtins.bool):
        """
        :param builtins.bool scan_on_push: Whether images are scanned after being pushed to the repository.
        """
        pulumi.set(__self__, "scan_on_push", scan_on_push)
