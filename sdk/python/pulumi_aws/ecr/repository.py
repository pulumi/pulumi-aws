...
class Repository(pulumi.CustomResource):
    ...
    Configuration block that defines image scanning configuration for the repository. By default, image scanning must be manually triggered. See the [ECR User Guide](https://docs.aws.amazon.com/AmazonECR/latest/userguide/image-scanning.html) for more information about image scanning.
      ...
      * `scan_on_push` (`bool`) - Indicates whether images are scanned after being pushed to the repository (true) or not scanned (false).
    """
    ...
    def __init__(__self__, resource_name, opts=None, image_scanning_configuration=None, image_tag_mutability=None, name=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **image_scanning_configuration** object supports the following:
          ...
          * `scan_on_push` (`pulumi.Input[bool]`) - Indicates whether images are scanned after being pushed to the repository (true) or not scanned (false).
        """
