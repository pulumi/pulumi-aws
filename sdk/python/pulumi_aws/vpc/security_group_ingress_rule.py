...
class SecurityGroupIngressRuleArgs:
    def __init__(__self__, *,
        ...
        """
        SecurityGroupIngressRuleArgs._configure(
    ...
    def _configure(
        ...
        if 'referencedSecurityGroupId' in kwargs:
...
class _SecurityGroupIngressRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] to_port: The end of port range for the TCP and UDP protocols, or an ICMP/ICMPv6 code.
        """
        _SecurityGroupIngressRuleState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            arn=arn,
            cidr_ipv4=cidr_ipv4,
            cidr_ipv6=cidr_ipv6,
    ...
    def _configure(
        ...
        if 'securityGroupId' in kwargs:
            security_group_id = kwargs['securityGroupId']
        if 'securityGroupRuleId' in kwargs:
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            SecurityGroupIngressRuleArgs._configure(_setter, **kwargs)
