...
class SecurityGroupIngressRuleArgs:
    def __init__(__self__, *,
                 ...
                 cidr_ipv4: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cidr_ipv4: The source IPv4 CIDR range.
        :param pulumi.Input[builtins.str] cidr_ipv6: The source IPv6 CIDR range.
        :param pulumi.Input[builtins.str] description: The security group rule description.
        :param pulumi.Input[builtins.int] from_port: The start of port range for the TCP and UDP protocols, or an ICMP/ICMPv6 type.
        :param pulumi.Input[builtins.str] prefix_list_id: The ID of the source prefix list.
        :param pulumi.Input[builtins.str] referenced_security_group_id: The source security group that is referenced in the rule.
    ...
    def cidr_ipv4(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cidr_ipv4.setter
    def cidr_ipv4(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def referenced_security_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def referenced_security_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SecurityGroupIngressRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the security group rule.
        :param pulumi.Input[builtins.str] cidr_ipv4: The source IPv4 CIDR range.
        :param pulumi.Input[builtins.str] cidr_ipv6: The source IPv6 CIDR range.
        :param pulumi.Input[builtins.str] description: The security group rule description.
        :param pulumi.Input[builtins.int] from_port: The start of port range for the TCP and UDP protocols, or an ICMP/ICMPv6 type.
...
class SecurityGroupIngressRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            to_port: Optional[pulumi.Input[builtins.int]] = None) -> 'SecurityGroupIngressRule':
        """
    ...
    @property
    @pulumi.getter(name="cidrIpv4")
    def cidr_ipv4(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The source IPv4 CIDR range.
        """
        return pulumi.get(self, "cidr_ipv4")
    ...
    @property
    @pulumi.getter(name="cidrIpv6")
    def cidr_ipv6(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The source IPv6 CIDR range.
        """
        return pulumi.get(self, "cidr_ipv6")
    ...
    @property
    @pulumi.getter(name="prefixListId")
    def prefix_list_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the source prefix list.
        """
        return pulumi.get(self, "prefix_list_id")
    ...
    @property
    @pulumi.getter(name="referencedSecurityGroupId")
    def referenced_security_group_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The source security group that is referenced in the rule.
        """
        return pulumi.get(self, "referenced_security_group_id")
