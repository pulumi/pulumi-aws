...
def get_endpoint_associations(vpc_endpoint_id: Optional[builtins.str] = None,
...
def get_endpoint_associations_output(vpc_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
