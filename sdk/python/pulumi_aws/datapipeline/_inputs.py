...
if not MYPY:
    ...
    PipelineDefinitionParameterObjectArgsDict: TypeAlias = Mapping[str, Any]
...
class PipelineDefinitionParameterObjectArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: ID of the parameter object.
...
if not MYPY:
    ...
    PipelineDefinitionParameterObjectAttributeArgsDict: TypeAlias = Mapping[str, Any]
...
class PipelineDefinitionParameterObjectAttributeArgs:
    def __init__(__self__, *,
                 ...
                 string_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Field identifier.
        :param pulumi.Input[builtins.str] string_value: Field value, expressed as a String.
        """
...
if not MYPY:
    ...
    PipelineDefinitionParameterValueArgsDict: TypeAlias = Mapping[str, Any]
...
class PipelineDefinitionParameterValueArgs:
    def __init__(__self__, *,
                 ...
                 string_value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: ID of the parameter value.
        :param pulumi.Input[builtins.str] string_value: Field value, expressed as a String.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "string_value", string_value)
...
if not MYPY:
    ...
    PipelineDefinitionPipelineObjectArgsDict: TypeAlias = Mapping[str, Any]
...
class PipelineDefinitionPipelineObjectArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: ID of the object.
        :param pulumi.Input[builtins.str] name: ARN of the storage connector.
...
if not MYPY:
    class PipelineDefinitionPipelineObjectFieldArgsDict(TypedDict):
        ...
        Field identifier.
        """
        ref_value: NotRequired[pulumi.Input[builtins.str]]
        """
    ...
    PipelineDefinitionPipelineObjectFieldArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class PipelineDefinitionPipelineObjectFieldArgs:
    def __init__(__self__, *,
                 key: pulumi.Input[builtins.str],
                 ref_value: Optional[pulumi.Input[builtins.str]] = None,
                 string_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] key: Field identifier.
        :param pulumi.Input[builtins.str] ref_value: Field value, expressed as the identifier of another object
        :param pulumi.Input[builtins.str] string_value: Field value, expressed as a String.
        """
        pulumi.set(__self__, "key", key)
    ...
    def ref_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Field value, expressed as the identifier of another object
        """
    ...
    @ref_value.setter
    def ref_value(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    ...
    GetPipelineDefinitionParameterValueArgsDict: TypeAlias = Mapping[str, Any]
...
class GetPipelineDefinitionParameterValueArgs:
    def __init__(__self__, *,
                 ...
                 string_value: builtins.str):
        """
        :param builtins.str id: ID of the object.
        :param builtins.str string_value: Field value, expressed as a String.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "string_value", string_value)
    ...
    @string_value.setter
    def string_value(self, value: builtins.str):
        pulumi.set(self, "string_value", value)
