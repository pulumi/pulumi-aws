...
class HoursOfOperationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Hours of Operation.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Tags to apply to the Hours of Operation. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
...
class _HoursOfOperationState:
    def __init__(__self__, *,
                 ...
                 configs: pulumi.Input[Optional[Sequence[pulumi.Input['HoursOfOperationConfigArgs']]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] arn: ARN of the Hours of Operation.
        :param pulumi.Input[Sequence[pulumi.Input['HoursOfOperationConfigArgs']]] configs: One or more config blocks which define the configuration information for the hours of operation: day, start time, and end time . Config blocks are documented below.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the Hours of Operation.
        :param pulumi.Input[_builtins.str] hours_of_operation_id: The identifier for the hours of operation.
        :param pulumi.Input[_builtins.str] instance_id: Specifies the identifier of the hosting Amazon Connect Instance.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Hours of Operation.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Tags to apply to the Hours of Operation. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    @_builtins.property
    @pulumi.getter
    def configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['HoursOfOperationConfigArgs']]]]:
        """
        One or more config blocks which define the configuration information for the hours of operation: day, start time, and end time . Config blocks are documented below.
        """
        return pulumi.get(self, "configs")
    ...
    @configs.setter
    def configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['HoursOfOperationConfigArgs']]]]):
        pulumi.set(self, "configs", value)
...
class HoursOfOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['HoursOfOperationConfigArgs', 'HoursOfOperationConfigArgsDict', 'outputs.HoursOfOperationConfig']]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['HoursOfOperationConfigArgs', 'HoursOfOperationConfigArgsDict', 'outputs.HoursOfOperationConfig']]]] configs: One or more config blocks which define the configuration information for the hours of operation: day, start time, and end time . Config blocks are documented below.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the Hours of Operation.
        :param pulumi.Input[_builtins.str] instance_id: Specifies the identifier of the hosting Amazon Connect Instance.
        :param pulumi.Input[_builtins.str] name: Specifies the name of the Hours of Operation.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_zone: pulumi.Input[Optional[_builtins.str]] = None) -> 'HoursOfOperation':
        """
