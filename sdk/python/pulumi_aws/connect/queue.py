...
class QueueArgs:
    def __init__(__self__, *,
                 hours_of_operation_id: pulumi.Input[builtins.str],
                 instance_id: pulumi.Input[builtins.str],
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 max_contacts: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 outbound_caller_config: Optional[pulumi.Input['QueueOutboundCallerConfigArgs']] = None,
                 quick_connect_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Queue resource.
        :param pulumi.Input[builtins.str] hours_of_operation_id: Specifies the identifier of the Hours of Operation.
        :param pulumi.Input[builtins.str] instance_id: Specifies the identifier of the hosting Amazon Connect Instance.
        :param pulumi.Input[builtins.str] description: Specifies the description of the Queue.
        :param pulumi.Input[builtins.int] max_contacts: Specifies the maximum number of contacts that can be in the queue before it is considered full. Minimum value of 0.
    ...
    def hours_of_operation_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def hours_of_operation_id(self, value: pulumi.Input[builtins.str]):
    ...
    def max_contacts(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @max_contacts.setter
    def max_contacts(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def quick_connect_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def quick_connect_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _QueueState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 hours_of_operation_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the Queue.
        :param pulumi.Input[builtins.str] description: Specifies the description of the Queue.
        :param pulumi.Input[builtins.str] hours_of_operation_id: Specifies the identifier of the Hours of Operation.
        :param pulumi.Input[builtins.str] instance_id: Specifies the identifier of the hosting Amazon Connect Instance.
        :param pulumi.Input[builtins.int] max_contacts: Specifies the maximum number of contacts that can be in the queue before it is considered full. Minimum value of 0.
    ...
    @property
    @pulumi.getter(name="hoursOfOperationId")
    def hours_of_operation_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the identifier of the Hours of Operation.
        """
        return pulumi.get(self, "hours_of_operation_id")
    ...
    @hours_of_operation_id.setter
    def hours_of_operation_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hours_of_operation_id", value)
...
class Queue(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="hoursOfOperationId")
    def hours_of_operation_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the identifier of the Hours of Operation.
        """
        return pulumi.get(self, "hours_of_operation_id")
    ...
    @property
    @pulumi.getter(name="maxContacts")
    def max_contacts(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Specifies the maximum number of contacts that can be in the queue before it is considered full. Minimum value of 0.
        """
        return pulumi.get(self, "max_contacts")
    ...
    @property
    @pulumi.getter(name="quickConnectIds")
    def quick_connect_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies a list of quick connects ids that determine the quick connects available to agents who are working the queue.
        """
        return pulumi.get(self, "quick_connect_ids")
