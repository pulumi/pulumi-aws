...
class BotAssociationLexBot(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 lex_region: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the Amazon Lex (V1) bot.
        :param builtins.str lex_region: The Region that the Amazon Lex (V1) bot was created in. Defaults to current region.
        """
    ...
    def lex_region(self) -> Optional[builtins.str]:
        """
...
class HoursOfOperationConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str day: Specifies the day that the hours of operation applies to.
...
class HoursOfOperationConfigEndTime(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int hours: Specifies the hour of closing.
        :param builtins.int minutes: Specifies the minute of closing.
        """
...
class HoursOfOperationConfigStartTime(dict):
    def __init__(__self__, *,
                 ...
                 minutes: builtins.int):
        """
        :param builtins.int hours: Specifies the hour of opening.
        :param builtins.int minutes: Specifies the minute of opening.
        """
        pulumi.set(__self__, "hours", hours)
        pulumi.set(__self__, "minutes", minutes)
...
class InstanceStorageConfigStorageConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str storage_type: A valid storage type. Valid Values: `S3` | `KINESIS_VIDEO_STREAM` | `KINESIS_STREAM` | `KINESIS_FIREHOSE`.
...
class InstanceStorageConfigStorageConfigKinesisVideoStreamConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str prefix: The prefix of the video stream. Minimum length of `1`. Maximum length of `128`. When read from the state, the value returned is `<prefix>-connect-<connect_instance_alias>-contact-` since the API appends additional details to the `prefix`.
        :param builtins.int retention_period_hours: The number of hours data is retained in the stream. Kinesis Video Streams retains the data in a data store that is associated with the stream. Minimum value of `0`. Maximum value of `87600`. A value of `0`, indicates that the stream does not persist data.
        """
    ...
    def retention_period_hours(self) -> builtins.int:
        """
...
class InstanceStorageConfigStorageConfigKinesisVideoStreamConfigEncryptionConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 key_id: builtins.str):
        """
        :param builtins.str encryption_type: The type of encryption. Valid Values: `KMS`.
        :param builtins.str key_id: The full ARN of the encryption key. Be sure to provide the full ARN of the encryption key, not just the ID.
        """
...
class PhoneNumberStatus(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str message: The status message.
        :param builtins.str status: The status of the phone number. Valid Values: `CLAIMED` | `IN_PROGRESS` | `FAILED`.
        """
...
class QueueOutboundCallerConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 outbound_caller_id_number_id: Optional[builtins.str] = None,
                 outbound_flow_id: Optional[builtins.str] = None):
        """
        :param builtins.str outbound_caller_id_name: Specifies the caller ID name.
        :param builtins.str outbound_caller_id_number_id: Specifies the caller ID number.
        :param builtins.str outbound_flow_id: Specifies outbound whisper flow to be used during an outbound call.
        """
    ...
    def outbound_caller_id_number_id(self) -> Optional[builtins.str]:
        """
    ...
    def outbound_flow_id(self) -> Optional[builtins.str]:
        """
...
class QuickConnectQuickConnectConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str quick_connect_type: Specifies the configuration type of the quick connect. valid values are `PHONE_NUMBER`, `QUEUE`, `USER`.
...
class QuickConnectQuickConnectConfigPhoneConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str phone_number: Specifies the phone number in in E.164 format.
        """
...
class QuickConnectQuickConnectConfigQueueConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str contact_flow_id: Specifies the identifier of the contact flow.
        :param builtins.str queue_id: Specifies the identifier for the queue.
        """
...
class QuickConnectQuickConnectConfigUserConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str contact_flow_id: Specifies the identifier of the contact flow.
        :param builtins.str user_id: Specifies the identifier for the user.
        """
        pulumi.set(__self__, "contact_flow_id", contact_flow_id)
...
class RoutingProfileMediaConcurrency(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str channel: Specifies the channels that agents can handle in the Contact Control Panel (CCP). Valid values are `VOICE`, `CHAT`, `TASK`.
        :param builtins.int concurrency: Specifies the number of contacts an agent can have on a channel simultaneously. Valid Range for `VOICE`: Minimum value of 1. Maximum value of 1. Valid Range for `CHAT`: Minimum value of 1. Maximum value of 10. Valid Range for `TASK`: Minimum value of 1. Maximum value of 10.
        """
...
class RoutingProfileQueueConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 queue_id: builtins.str,
                 queue_arn: Optional[builtins.str] = None,
                 queue_name: Optional[builtins.str] = None):
        """
        :param builtins.str channel: Specifies the channels agents can handle in the Contact Control Panel (CCP) for this routing profile. Valid values are `VOICE`, `CHAT`, `TASK`.
        :param builtins.int delay: Specifies the delay, in seconds, that a contact should be in the queue before they are routed to an available agent
        :param builtins.int priority: Specifies the order in which contacts are to be handled for the queue.
        :param builtins.str queue_id: Specifies the identifier for the queue.
        :param builtins.str queue_arn: ARN for the queue.
        :param builtins.str queue_name: Name for the queue.
        """
        pulumi.set(__self__, "channel", channel)
    ...
    def queue_arn(self) -> Optional[builtins.str]:
        """
        ARN for the queue.
        """
...
class UserHierarchyGroupHierarchyPathLevelFife(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str arn: The Amazon Resource Name (ARN) of the hierarchy group.
        :param builtins.str id: The identifier of the hierarchy group.
        :param builtins.str name: The name of the user hierarchy group. Must not be more than 100 characters.
        """
        if arn is not None:
...
class UserHierarchyStructureHierarchyStructureLevelFive(dict):
    def __init__(__self__, *,
                 ...
                 id: Optional[builtins.str] = None):
        """
        :param builtins.str name: The name of the user hierarchy level. Must not be more than 50 characters.
        :param builtins.str arn: The Amazon Resource Name (ARN) of the hierarchy level.
        :param builtins.str id: The identifier of the hierarchy level.
        """
        pulumi.set(__self__, "name", name)
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
...
class UserIdentityInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str email: The email address. If you are using SAML for identity management and include this parameter, an error is returned. Note that updates to the `email` is supported. From the [UpdateUserIdentityInfo API documentation](https://docs.aws.amazon.com/connect/latest/APIReference/API_UpdateUserIdentityInfo.html) it is strongly recommended to limit who has the ability to invoke `UpdateUserIdentityInfo`. Someone with that ability can change the login credentials of other users by changing their email address. This poses a security risk to your organization. They can change the email address of a user to the attacker's email address, and then reset the password through email. For more information, see [Best Practices for Security Profiles](https://docs.aws.amazon.com/connect/latest/adminguide/security-profile-best-practices.html) in the Amazon Connect Administrator Guide.
        :param builtins.str first_name: The first name. This is required if you are using Amazon Connect or SAML for identity management. Minimum length of 1. Maximum length of 100.
        :param builtins.str last_name: The last name. This is required if you are using Amazon Connect or SAML for identity management. Minimum length of 1. Maximum length of 100.
        :param builtins.str secondary_email: The secondary email address. If present, email notifications will be sent to this email address instead of the primary one.
        """
...
class UserPhoneConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str phone_type: The phone type. Valid values are `DESK_PHONE` and `SOFT_PHONE`.
        :param builtins.int after_contact_work_time_limit: The After Call Work (ACW) timeout setting, in seconds. Minimum value of 0.
        :param builtins.bool auto_accept: When Auto-Accept Call is enabled for an available agent, the agent connects to contacts automatically.
        :param builtins.str desk_phone_number: The phone number for the user's desk phone. Required if `phone_type` is set as `DESK_PHONE`.
        """
...
class GetBotAssociationLexBotResult(dict):
    def __init__(__self__, *,
                 lex_region: builtins.str,
                 name: builtins.str):
        """
        :param builtins.str lex_region: Region that the Amazon Lex (V1) bot was created in.
        :param builtins.str name: Name of the Amazon Lex (V1) bot.
        """
        pulumi.set(__self__, "lex_region", lex_region)
        pulumi.set(__self__, "name", name)
...
class GetHoursOfOperationConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str day: Day that the hours of operation applies to.
...
class GetHoursOfOperationConfigEndTimeResult(dict):
    def __init__(__self__, *,
                 ...
                 minutes: builtins.int):
        """
        :param builtins.int hours: Hour of opening.
        :param builtins.int minutes: Minute of opening.
        """
        pulumi.set(__self__, "hours", hours)
        pulumi.set(__self__, "minutes", minutes)
...
class GetInstanceStorageConfigStorageConfigKinesisVideoStreamConfigResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str prefix: The prefix of the video stream. Minimum length of `1`. Maximum length of `128`. When read from the state, the value returned is `<prefix>-connect-<connect_instance_alias>-contact-` since the API appends additional details to the `prefix`.
        :param builtins.int retention_period_hours: The number of hours to retain the data in a data store associated with the stream. Minimum value of `0`. Maximum value of `87600`. A value of `0` indicates that the stream does not persist data.
        """
...
class GetQueueOutboundCallerConfigResult(dict):
    def __init__(__self__, *,
                 outbound_caller_id_name: builtins.str,
                 outbound_caller_id_number_id: builtins.str,
                 outbound_flow_id: builtins.str):
        """
        :param builtins.str outbound_caller_id_name: Specifies the caller ID name.
        :param builtins.str outbound_caller_id_number_id: Specifies the caller ID number.
        :param builtins.str outbound_flow_id: Outbound whisper flow to be used during an outbound call.
        """
        pulumi.set(__self__, "outbound_caller_id_name", outbound_caller_id_name)
        pulumi.set(__self__, "outbound_caller_id_number_id", outbound_caller_id_number_id)
        pulumi.set(__self__, "outbound_flow_id", outbound_flow_id)
...
class GetQuickConnectQuickConnectConfigResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str quick_connect_type: Configuration type of the Quick Connect. Valid values are `PHONE_NUMBER`, `QUEUE`, `USER`.
...
class GetQuickConnectQuickConnectConfigPhoneConfigResult(dict):
    def __init__(__self__, *,
                 phone_number: builtins.str):
        """
        :param builtins.str phone_number: Phone number in in E.164 format.
        """
        pulumi.set(__self__, "phone_number", phone_number)
...
class GetQuickConnectQuickConnectConfigQueueConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 queue_id: builtins.str):
        """
        :param builtins.str contact_flow_id: Identifier of the contact flow.
        :param builtins.str queue_id: Identifier for the queue.
        """
        pulumi.set(__self__, "contact_flow_id", contact_flow_id)
        pulumi.set(__self__, "queue_id", queue_id)
...
class GetRoutingProfileMediaConcurrencyResult(dict):
    def __init__(__self__, *,
                 ...
                 concurrency: builtins.int):
        """
        :param builtins.str channel: Channels agents can handle in the Contact Control Panel (CCP) for this routing profile. Valid values are `VOICE`, `CHAT`, `TASK`.
        :param builtins.int concurrency: Number of contacts an agent can have on a channel simultaneously. Valid Range for `VOICE`: Minimum value of 1. Maximum value of 1. Valid Range for `CHAT`: Minimum value of 1. Maximum value of 10. Valid Range for `TASK`: Minimum value of 1. Maximum value of 10.
        """
        pulumi.set(__self__, "channel", channel)
        pulumi.set(__self__, "concurrency", concurrency)
...
class GetRoutingProfileQueueConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str channel: Channels agents can handle in the Contact Control Panel (CCP) for this routing profile. Valid values are `VOICE`, `CHAT`, `TASK`.
        :param builtins.int delay: Delay, in seconds, that a contact should be in the queue before they are routed to an available agent
        :param builtins.int priority: Order in which contacts are to be handled for the queue.
        :param builtins.str queue_arn: ARN for the queue.
        :param builtins.str queue_id: Identifier for the queue.
        :param builtins.str queue_name: Name for the queue.
        """
...
class GetUserHierarchyStructureHierarchyStructureLevelFifeResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str arn: ARN of the hierarchy level.
        :param builtins.str id: The identifier of the hierarchy level.
        :param builtins.str name: Name of the user hierarchy level. Must not be more than 50 characters.
        """
        pulumi.set(__self__, "arn", arn)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "name", name)
...
class GetUserIdentityInfoResult(dict):
    def __init__(__self__, *,
                 ...
                 secondary_email: builtins.str):
        """
        :param builtins.str email: The email address.
        :param builtins.str first_name: The first name.
        :param builtins.str last_name: The last name.
        :param builtins.str secondary_email: The secondary email address. If present, email notifications will be sent to this email address instead of the primary one.
        """
        pulumi.set(__self__, "email", email)
        pulumi.set(__self__, "first_name", first_name)
...
class GetUserPhoneConfigResult(dict):
    def __init__(__self__, *,
                 after_contact_work_time_limit: builtins.int,
                 auto_accept: builtins.bool,
                 desk_phone_number: builtins.str,
                 phone_type: builtins.str):
        """
        :param builtins.int after_contact_work_time_limit: The After Call Work (ACW) timeout setting, in seconds.
        :param builtins.bool auto_accept: When Auto-Accept Call is enabled for an available agent, the agent connects to contacts automatically.
    ...
    @property
    @pulumi.getter(name="afterContactWorkTimeLimit")
    def after_contact_work_time_limit(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="autoAccept")
    def auto_accept(self) -> builtins.bool:
        """
        When Auto-Accept Call is enabled for an available agent, the agent connects to contacts automatically.
        """
        return pulumi.get(self, "auto_accept")
