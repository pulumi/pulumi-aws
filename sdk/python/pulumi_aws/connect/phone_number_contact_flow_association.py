...
class PhoneNumberContactFlowAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Using `pulumi import`, import `connect.PhoneNumberContactFlowAssociation` using the `phone_number_id`, `instance_id` and `contact_flow_id` separated by a comma (`,`). For example:
    ...
    def get(resource_name: str,
            ...
            instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            phone_number_id: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None) -> 'PhoneNumberContactFlowAssociation':
        """
