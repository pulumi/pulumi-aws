...
class ContactFlowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content: Specifies the content of the Contact Flow, provided as a JSON string, written in Amazon Connect Contact Flow Language. If defined, the `filename` argument cannot be used.
        :param pulumi.Input[builtins.str] content_hash: Used to trigger updates. Must be set to a base64-encoded SHA256 hash of the Contact Flow source specified with `filename`.
        :param pulumi.Input[builtins.str] description: Specifies the description of the Contact Flow.
        :param pulumi.Input[builtins.str] filename: The path to the Contact Flow source within the local filesystem. Conflicts with `content`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Contact Flow.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Tags to apply to the Contact Flow. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[builtins.str] type: Specifies the type of the Contact Flow. Defaults to `CONTACT_FLOW`. Allowed Values are: `CONTACT_FLOW`, `CUSTOMER_QUEUE`, `CUSTOMER_HOLD`, `CUSTOMER_WHISPER`, `AGENT_HOLD`, `AGENT_WHISPER`, `OUTBOUND_WHISPER`, `AGENT_TRANSFER`, `QUEUE_TRANSFER`.
        """
...
class _ContactFlowState:
    def __init__(__self__, *,
                 ...
                 contact_flow_id: Optional[pulumi.Input[builtins.str]] = None,
                 content: Optional[pulumi.Input[builtins.str]] = None,
                 content_hash: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 filename: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the Contact Flow.
        :param pulumi.Input[builtins.str] contact_flow_id: The identifier of the Contact Flow.
        :param pulumi.Input[builtins.str] content: Specifies the content of the Contact Flow, provided as a JSON string, written in Amazon Connect Contact Flow Language. If defined, the `filename` argument cannot be used.
        :param pulumi.Input[builtins.str] content_hash: Used to trigger updates. Must be set to a base64-encoded SHA256 hash of the Contact Flow source specified with `filename`.
        :param pulumi.Input[builtins.str] description: Specifies the description of the Contact Flow.
        :param pulumi.Input[builtins.str] filename: The path to the Contact Flow source within the local filesystem. Conflicts with `content`.
    ...
    def contact_flow_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def contact_flow_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ContactFlow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ContactFlow':
        """
    ...
    @property
    @pulumi.getter(name="contactFlowId")
    def contact_flow_id(self) -> pulumi.Output[builtins.str]:
        """
        The identifier of the Contact Flow.
        """
        return pulumi.get(self, "contact_flow_id")
    ...
    @property
    @pulumi.getter(name="contentHash")
    def content_hash(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Used to trigger updates. Must be set to a base64-encoded SHA256 hash of the Contact Flow source specified with `filename`.
        """
        return pulumi.get(self, "content_hash")
