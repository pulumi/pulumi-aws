...
class _SecurityProfileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the Security Profile.
        :param pulumi.Input[builtins.str] description: Specifies the description of the Security Profile.
        :param pulumi.Input[builtins.str] instance_id: Specifies the identifier of the hosting Amazon Connect Instance.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Security Profile.
    ...
    def organization_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def organization_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_profile_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityProfile(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="organizationResourceId")
    def organization_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The organization resource identifier for the security profile.
        """
        return pulumi.get(self, "organization_resource_id")
