...
class _QuickConnectState:
    ...
    def _configure(
        ...
        if quick_connect_config is None and 'quickConnectConfig' in kwargs:
            quick_connect_config = kwargs['quickConnectConfig']
        if quick_connect_id is None and 'quickConnectId' in kwargs:
            quick_connect_id = kwargs['quickConnectId']
        ...
        if quick_connect_id is not None:
            _setter("quick_connect_id", quick_connect_id)
        if tags is not None:
            _setter("tags", tags)
...
class QuickConnect(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if quick_connect_config is not None and not isinstance(quick_connect_config, QuickConnectQuickConnectConfigArgs):
                quick_connect_config = quick_connect_config or {}
                def _setter(key, value):
                    quick_connect_config[key] = value
                QuickConnectQuickConnectConfigArgs._configure(_setter, **quick_connect_config)
