...
__all__ = ['LambdaFunctionAssociationArrgs', 'LambdaFunctionAssociation']

@pulumi.input_type
calass LambdaFunctionAssociationArrgs:
...
@pulumi.input_type
calass _LambdaFunctionAssociationState:
    def __init__(__self__, *,
...
calass LambdaFunctionAssociation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: LambdaFunctionAssociationArrgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Provides an Amazon Connect Lambda Function Association. For more information see
        [Amazon Connect: Getting Started](https://docs.aws.amazon.com/connect/latest/adminguide/amazon-connect-get-started.html) and [Invoke AWS Lambda functions](https://docs.aws.amazon.com/connect/latest/adminguide/connect-lambda-functions.html).
        ...
        :param str resource_name: The name of the resource.
        :param LambdaFunctionAssociationArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LambdaFunctionAssociationArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LambdaFunctionAssociationArrgs.__new__(LambdaFunctionAssociationArrgs)
