...
class InstanceArgs:
    ...
    def _configure(
        ...
        if inbound_calls_enabled is None and 'inboundCallsEnabled' in kwargs:
            inbound_calls_enabled = kwargs['inboundCallsEnabled']
        if inbound_calls_enabled is None:
            raise TypeError("Missing 'inbound_calls_enabled' argument")
        if outbound_calls_enabled is None and 'outboundCallsEnabled' in kwargs:
            outbound_calls_enabled = kwargs['outboundCallsEnabled']
        if outbound_calls_enabled is None:
            raise TypeError("Missing 'outbound_calls_enabled' argument")
        if auto_resolve_best_voices_enabled is None and 'autoResolveBestVoicesEnabled' in kwargs:
            auto_resolve_best_voices_enabled = kwargs['autoResolveBestVoicesEnabled']
        if contact_flow_logs_enabled is None and 'contactFlowLogsEnabled' in kwargs:
            contact_flow_logs_enabled = kwargs['contactFlowLogsEnabled']
        if contact_lens_enabled is None and 'contactLensEnabled' in kwargs:
        ...
        if early_media_enabled is None and 'earlyMediaEnabled' in kwargs:
        ...
        if multi_party_conference_enabled is None and 'multiPartyConferenceEnabled' in kwargs:
