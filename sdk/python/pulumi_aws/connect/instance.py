...
class InstanceArgs:
    def __init__(__self__, *,
                 identity_management_type: pulumi.Input[builtins.str],
                 inbound_calls_enabled: pulumi.Input[builtins.bool],
                 outbound_calls_enabled: pulumi.Input[builtins.bool],
                 auto_resolve_best_voices_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 contact_flow_logs_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 contact_lens_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] identity_management_type: Specifies the identity management type attached to the instance. Allowed Values are: `SAML`, `CONNECT_MANAGED`, `EXISTING_DIRECTORY`.
        :param pulumi.Input[builtins.bool] inbound_calls_enabled: Specifies whether inbound calls are enabled.
        :param pulumi.Input[builtins.bool] outbound_calls_enabled: Specifies whether outbound calls are enabled.
        :param pulumi.Input[builtins.bool] auto_resolve_best_voices_enabled: Specifies whether auto resolve best voices is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.bool] contact_flow_logs_enabled: Specifies whether contact flow logs are enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] contact_lens_enabled: Specifies whether contact lens is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] directory_id: The identifier for the directory if identity_management_type is `EXISTING_DIRECTORY`.
    ...
    def identity_management_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def identity_management_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "identity_management_type", value)

    @property
    @pulumi.getter(name="inboundCallsEnabled")
    def inbound_calls_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def inbound_calls_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "inbound_calls_enabled", value)

    @property
    @pulumi.getter(name="outboundCallsEnabled")
    def outbound_calls_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def outbound_calls_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "outbound_calls_enabled", value)

    @property
    @pulumi.getter(name="autoResolveBestVoicesEnabled")
    def auto_resolve_best_voices_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_resolve_best_voices_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_resolve_best_voices_enabled", value)

    @property
    @pulumi.getter(name="contactFlowLogsEnabled")
    def contact_flow_logs_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def contact_flow_logs_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "contact_flow_logs_enabled", value)

    @property
    @pulumi.getter(name="contactLensEnabled")
    def contact_lens_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def contact_lens_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def early_media_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def early_media_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def multi_party_conference_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def multi_party_conference_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 ...
                 directory_id: Optional[pulumi.Input[builtins.str]] = None,
                 early_media_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 identity_management_type: Optional[pulumi.Input[builtins.str]] = None,
                 inbound_calls_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 instance_alias: Optional[pulumi.Input[builtins.str]] = None,
                 multi_party_conference_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the instance.
        :param pulumi.Input[builtins.bool] auto_resolve_best_voices_enabled: Specifies whether auto resolve best voices is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.bool] contact_flow_logs_enabled: Specifies whether contact flow logs are enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] contact_lens_enabled: Specifies whether contact lens is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] created_time: When the instance was created.
        :param pulumi.Input[builtins.str] directory_id: The identifier for the directory if identity_management_type is `EXISTING_DIRECTORY`.
        :param pulumi.Input[builtins.bool] early_media_enabled: Specifies whether early media for outbound calls is enabled . Defaults to `true` if outbound calls is enabled.
        :param pulumi.Input[builtins.str] identity_management_type: Specifies the identity management type attached to the instance. Allowed Values are: `SAML`, `CONNECT_MANAGED`, `EXISTING_DIRECTORY`.
        :param pulumi.Input[builtins.bool] inbound_calls_enabled: Specifies whether inbound calls are enabled.
    ...
    @property
    @pulumi.getter(name="identityManagementType")
    def identity_management_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the identity management type attached to the instance. Allowed Values are: `SAML`, `CONNECT_MANAGED`, `EXISTING_DIRECTORY`.
        """
        return pulumi.get(self, "identity_management_type")
    ...
    @identity_management_type.setter
    def identity_management_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "identity_management_type", value)

    @property
    @pulumi.getter(name="inboundCallsEnabled")
    def inbound_calls_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether inbound calls are enabled.
        """
        return pulumi.get(self, "inbound_calls_enabled")
    ...
    @inbound_calls_enabled.setter
    def inbound_calls_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "inbound_calls_enabled", value)
    ...
    @property
    @pulumi.getter(name="outboundCallsEnabled")
    def outbound_calls_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether outbound calls are enabled.
        """
        return pulumi.get(self, "outbound_calls_enabled")
    ...
    @outbound_calls_enabled.setter
    def outbound_calls_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "outbound_calls_enabled", value)
...
class Instance(pulumi.CustomResource):
    ...
    pulumi_type = "aws:connect/instance:Instance"
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Instance':
        """
    ...
    @property
    @pulumi.getter(name="autoResolveBestVoicesEnabled")
    def auto_resolve_best_voices_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether auto resolve best voices is enabled. Defaults to `true`.
        """
        return pulumi.get(self, "auto_resolve_best_voices_enabled")
    ...
    @property
    @pulumi.getter(name="contactFlowLogsEnabled")
    def contact_flow_logs_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether contact flow logs are enabled. Defaults to `false`.
        """
        return pulumi.get(self, "contact_flow_logs_enabled")
    ...
    @property
    @pulumi.getter(name="contactLensEnabled")
    def contact_lens_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether contact lens is enabled. Defaults to `true`.
        """
        return pulumi.get(self, "contact_lens_enabled")
    ...
    @property
    @pulumi.getter(name="earlyMediaEnabled")
    def early_media_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether early media for outbound calls is enabled . Defaults to `true` if outbound calls is enabled.
        """
        return pulumi.get(self, "early_media_enabled")
    ...
    @property
    @pulumi.getter(name="identityManagementType")
    def identity_management_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the identity management type attached to the instance. Allowed Values are: `SAML`, `CONNECT_MANAGED`, `EXISTING_DIRECTORY`.
        """
        return pulumi.get(self, "identity_management_type")
    ...
    @property
    @pulumi.getter(name="inboundCallsEnabled")
    def inbound_calls_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether inbound calls are enabled.
        """
        return pulumi.get(self, "inbound_calls_enabled")
    ...
    @property
    @pulumi.getter(name="multiPartyConferenceEnabled")
    def multi_party_conference_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether multi-party calls/conference is enabled. Defaults to `false`.
        """
        return pulumi.get(self, "multi_party_conference_enabled")
    ...
    @property
    @pulumi.getter(name="outboundCallsEnabled")
    def outbound_calls_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether outbound calls are enabled.
        """
        return pulumi.get(self, "outbound_calls_enabled")
