...
def get_user_hierarchy_structure(instance_id: Optional[_builtins.str] = None,
...
def get_user_hierarchy_structure_output(instance_id: Optional[pulumi.Input[_builtins.str]] = None,
