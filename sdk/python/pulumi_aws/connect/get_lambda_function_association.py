...
def get_lambda_function_association(function_arn: Optional[_builtins.str] = None,
    ...
    :param _builtins.str function_arn: ARN of the Lambda Function, omitting any version or alias qualifier.
