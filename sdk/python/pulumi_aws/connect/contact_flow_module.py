...
class ContactFlowModuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content: Specifies the content of the Contact Flow Module, provided as a JSON string, written in Amazon Connect Contact Flow Language. If defined, the `filename` argument cannot be used.
        :param pulumi.Input[builtins.str] content_hash: Used to trigger updates. Must be set to a base64-encoded SHA256 hash of the Contact Flow Module source specified with `filename`.
        :param pulumi.Input[builtins.str] description: Specifies the description of the Contact Flow Module.
        :param pulumi.Input[builtins.str] filename: The path to the Contact Flow Module source within the local filesystem. Conflicts with `content`.
        :param pulumi.Input[builtins.str] name: Specifies the name of the Contact Flow Module.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Tags to apply to the Contact Flow Module. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
...
class _ContactFlowModuleState:
    def __init__(__self__, *,
                 ...
                 contact_flow_module_id: Optional[pulumi.Input[builtins.str]] = None,
                 content: Optional[pulumi.Input[builtins.str]] = None,
                 content_hash: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 filename: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the Contact Flow Module.
        :param pulumi.Input[builtins.str] contact_flow_module_id: The identifier of the Contact Flow Module.
        :param pulumi.Input[builtins.str] content: Specifies the content of the Contact Flow Module, provided as a JSON string, written in Amazon Connect Contact Flow Language. If defined, the `filename` argument cannot be used.
        :param pulumi.Input[builtins.str] content_hash: Used to trigger updates. Must be set to a base64-encoded SHA256 hash of the Contact Flow Module source specified with `filename`.
        :param pulumi.Input[builtins.str] description: Specifies the description of the Contact Flow Module.
        :param pulumi.Input[builtins.str] filename: The path to the Contact Flow Module source within the local filesystem. Conflicts with `content`.
    ...
    def contact_flow_module_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def contact_flow_module_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ContactFlowModule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ContactFlowModule':
        """
    ...
    @property
    @pulumi.getter(name="contactFlowModuleId")
    def contact_flow_module_id(self) -> pulumi.Output[builtins.str]:
        """
        The identifier of the Contact Flow Module.
        """
        return pulumi.get(self, "contact_flow_module_id")
