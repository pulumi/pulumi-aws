...
class AwsLogSourceSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] regions: Specify the Regions where you want to enable Security Lake.
        :param builtins.str source_name: The name for a AWS source. This must be a Regionally unique value. Valid values: `ROUTE53`, `VPC_FLOW`, `SH_FINDINGS`, `CLOUD_TRAIL_MGMT`, `LAMBDA_EXECUTION`, `S3_DATA`, `EKS_AUDIT`, `WAF`.
        :param Sequence[builtins.str] accounts: Specify the AWS account information where you want to enable Security Lake.
               If not specified, uses all accounts included in the Security Lake.
        :param builtins.str source_version: The version for a AWS source.
    ...
    def source_version(self) -> Optional[builtins.str]:
        """
...
class CustomLogSourceAttribute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str crawler_arn: The ARN of the AWS Glue crawler.
        :param builtins.str database_arn: The ARN of the AWS Glue database where results are written.
        :param builtins.str table_arn: The ARN of the AWS Glue table.
        """
...
class CustomLogSourceConfigurationCrawlerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role_arn: The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role to be used by the AWS Glue crawler.
        """
...
class CustomLogSourceConfigurationProviderIdentity(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str external_id: The external ID used to estalish trust relationship with the AWS identity.
        :param builtins.str principal: The AWS identity principal.
        """
...
class CustomLogSourceProviderDetail(dict):
    ...
    def __init__(__self__, *,
                 ...
                 role_arn: builtins.str):
        """
        :param builtins.str location: The location of the partition in the Amazon S3 bucket for Security Lake.
        :param builtins.str role_arn: The ARN of the IAM role to be used by the entity putting logs into your custom source partition.
        """
...
class DataLakeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: The AWS Regions where Security Lake is automatically enabled.
...
class DataLakeConfigurationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key_id: The id of KMS encryption key used by Amazon Security Lake to encrypt the Security Lake object.
        """
...
class DataLakeConfigurationLifecycleConfigurationExpiration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int days: Number of days before data transition to a different S3 Storage Class in the Amazon Security Lake object.
        """
        if days is not None:
...
class DataLakeConfigurationLifecycleConfigurationTransition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int days: Number of days before data transition to a different S3 Storage Class in the Amazon Security Lake object.
        :param builtins.str storage_class: The range of storage classes that you can choose from based on the data access, resiliency, and cost requirements of your workloads.
        """
        if days is not None:
            pulumi.set(__self__, "days", days)
...
class DataLakeConfigurationReplicationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] regions: Replication enables automatic, asynchronous copying of objects across Amazon S3 buckets. Amazon S3 buckets that are configured for object replication can be owned by the same AWS account or by different accounts. You can replicate objects to a single destination bucket or to multiple destination buckets. The destination buckets can be in different AWS Regions or within the same Region as the source bucket.
        :param builtins.str role_arn: Replication settings for the Amazon S3 buckets. This parameter uses the AWS Identity and Access Management (IAM) role you created that is managed by Security Lake, to ensure the replication setting is correct.
        """
...
class SubscriberNotificationConfigurationHttpsNotificationConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 authorization_api_key_name: Optional[builtins.str] = None,
                 authorization_api_key_value: Optional[builtins.str] = None,
                 http_method: Optional[builtins.str] = None):
        """
        :param builtins.str endpoint: The subscription endpoint in Security Lake.
               If you prefer notification with an HTTPS endpoint, populate this field.
        :param builtins.str target_role_arn: The Amazon Resource Name (ARN) of the EventBridge API destinations IAM role that you created.
               For more information about ARNs and how to use them in policies, see Managing data access and AWS Managed Policies in the Amazon Security Lake User Guide.
        :param builtins.str authorization_api_key_name: The API key name for the notification subscription.
        :param builtins.str authorization_api_key_value: The API key value for the notification subscription.
        :param builtins.str http_method: The HTTP method used for the notification subscription.
    ...
    def authorization_api_key_name(self) -> Optional[builtins.str]:
        """
    ...
    def authorization_api_key_value(self) -> Optional[builtins.str]:
        """
...
class SubscriberSourceAwsLogSourceResource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_version: Optional[builtins.str] = None):
        """
        :param builtins.str source_name: Provides data expiration details of Amazon Security Lake object.
        :param builtins.str source_version: Provides data storage transition details of Amazon Security Lake object.
        """
        pulumi.set(__self__, "source_name", source_name)
        if source_version is not None:
            pulumi.set(__self__, "source_version", source_version)
...
class SubscriberSourceCustomLogSourceResource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_version: Optional[builtins.str] = None):
        """
        :param builtins.str source_name: The name for a third-party custom source. This must be a Regionally unique value.
        ...
        :param builtins.str source_version: The version for a third-party custom source. This must be a Regionally unique value.
        """
        pulumi.set(__self__, "source_name", source_name)
...
class SubscriberSubscriberIdentity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 principal: builtins.str):
        """
        :param builtins.str external_id: The AWS Regions where Security Lake is automatically enabled.
        :param builtins.str principal: Provides encryption details of Amazon Security Lake object.
        """
        pulumi.set(__self__, "external_id", external_id)
        pulumi.set(__self__, "principal", principal)
