...
class SubscriberArgs:
    def __init__(__self__, *,
                 ...
                 subscriber_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] subscriber_name: The name of your Security Lake subscriber account.
    ...
    def subscriber_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subscriber_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subscriber_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subscriber_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SubscriberState:
    def __init__(__self__, *,
                 ...
                 subscriber_identity: Optional[pulumi.Input['SubscriberSubscriberIdentityArgs']] = None,
                 subscriber_name: Optional[pulumi.Input[builtins.str]] = None,
                 subscriber_status: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] s3_bucket_arn: The ARN for the Amazon Security Lake Amazon S3 bucket.
        :param pulumi.Input['SubscriberSourceArgs'] source: The supported AWS services from which logs and events are collected. Security Lake supports log and event collection for natively supported AWS services. See `source` Blocks below.
        :param pulumi.Input[builtins.str] subscriber_description: The description for your subscriber account in Security Lake.
        :param pulumi.Input[builtins.str] subscriber_endpoint: The subscriber endpoint to which exception messages are posted.
        :param pulumi.Input['SubscriberSubscriberIdentityArgs'] subscriber_identity: The AWS identity used to access your data. See `subscriber_identity` Block below.
        :param pulumi.Input[builtins.str] subscriber_name: The name of your Security Lake subscriber account.
        :param pulumi.Input[builtins.str] subscriber_status: The subscriber status of the Amazon Security Lake subscriber account.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key-value map of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    def subscriber_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subscriber_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subscriber_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subscriber_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Subscriber(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="subscriberDescription")
    def subscriber_description(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The description for your subscriber account in Security Lake.
        """
        return pulumi.get(self, "subscriber_description")
    ...
    @property
    @pulumi.getter(name="subscriberEndpoint")
    def subscriber_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The subscriber endpoint to which exception messages are posted.
        """
        return pulumi.get(self, "subscriber_endpoint")
    ...
    @property
    @pulumi.getter(name="subscriberName")
    def subscriber_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of your Security Lake subscriber account.
        """
        return pulumi.get(self, "subscriber_name")
    ...
    @property
    @pulumi.getter(name="subscriberStatus")
    def subscriber_status(self) -> pulumi.Output[builtins.str]:
        """
        The subscriber status of the Amazon Security Lake subscriber account.
        """
        return pulumi.get(self, "subscriber_status")
