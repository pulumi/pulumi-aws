...
class DataLakeArgs:
    def __init__(__self__, *,
                 meta_store_manager_role_arn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] meta_store_manager_role_arn: The Amazon Resource Name (ARN) used to create and update the AWS Glue table. This table contains partitions generated by the ingestion and normalization of AWS log sources and custom sources.
    ...
    def meta_store_manager_role_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def meta_store_manager_role_arn(self, value: pulumi.Input[builtins.str]):
...
class DataLake(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="metaStoreManagerRoleArn")
    def meta_store_manager_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) used to create and update the AWS Glue table. This table contains partitions generated by the ingestion and normalization of AWS log sources and custom sources.
        """
        return pulumi.get(self, "meta_store_manager_role_arn")
