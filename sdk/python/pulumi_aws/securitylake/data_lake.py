...
class DataLakeArgs:
    def __init__(__self__, *,
                 ...
                 timeouts: pulumi.Input[Optional['DataLakeTimeoutsArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] meta_store_manager_role_arn: ARN used to create and update the AWS Glue table. This table contains partitions generated by the ingestion and normalization of AWS log sources and custom sources.
    ...
    @_builtins.property
    @pulumi.getter
    def timeouts(self) -> pulumi.Input[Optional['DataLakeTimeoutsArgs']]:
        return pulumi.get(self, "timeouts")

    @timeouts.setter
    def timeouts(self, value: pulumi.Input[Optional['DataLakeTimeoutsArgs']]):
...
class _DataLakeState:
    def __init__(__self__, *,
                 ...
                 configuration: pulumi.Input[Optional['DataLakeConfigurationArgs']] = None,
                 meta_store_manager_role_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def configuration(self) -> pulumi.Input[Optional['DataLakeConfigurationArgs']]:
        """
        Specify the Region or Regions that will contribute data to the rollup region.
        """
        return pulumi.get(self, "configuration")
    ...
    @configuration.setter
    def configuration(self, value: pulumi.Input[Optional['DataLakeConfigurationArgs']]):
        pulumi.set(self, "configuration", value)

    @_builtins.property
    @pulumi.getter(name="metaStoreManagerRoleArn")
    def meta_store_manager_role_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ARN used to create and update the AWS Glue table. This table contains partitions generated by the ingestion and normalization of AWS log sources and custom sources.
        """
        return pulumi.get(self, "meta_store_manager_role_arn")
    ...
    @meta_store_manager_role_arn.setter
    def meta_store_manager_role_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "meta_store_manager_role_arn", value)
...
class DataLake(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 configuration: pulumi.Input[Optional[Union['DataLakeConfigurationArgs', 'DataLakeConfigurationArgsDict', 'outputs.DataLakeConfiguration']]] = None,
                 meta_store_manager_role_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 timeouts: pulumi.Input[Optional[Union['DataLakeTimeoutsArgs', 'DataLakeTimeoutsArgsDict', 'outputs.DataLakeTimeouts']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Union['DataLakeConfigurationArgs', 'DataLakeConfigurationArgsDict', 'outputs.DataLakeConfiguration']] configuration: Specify the Region or Regions that will contribute data to the rollup region.
        :param pulumi.Input[_builtins.str] meta_store_manager_role_arn: ARN used to create and update the AWS Glue table. This table contains partitions generated by the ingestion and normalization of AWS log sources and custom sources.
        :param pulumi.Input[_builtins.str] region: The AWS Regions where Security Lake is automatically enabled.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Key-value map of resource tags. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            timeouts: pulumi.Input[Optional[Union['DataLakeTimeoutsArgs', 'DataLakeTimeoutsArgsDict', 'outputs.DataLakeTimeouts']]] = None) -> 'DataLake':
        """
