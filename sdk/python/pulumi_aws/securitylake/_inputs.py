...
class AwsLogSourceSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: Specify the Regions where you want to enable Security Lake.
        :param pulumi.Input[builtins.str] source_name: The name for a AWS source. This must be a Regionally unique value. Valid values: `ROUTE53`, `VPC_FLOW`, `SH_FINDINGS`, `CLOUD_TRAIL_MGMT`, `LAMBDA_EXECUTION`, `S3_DATA`, `EKS_AUDIT`, `WAF`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] accounts: Specify the AWS account information where you want to enable Security Lake.
               If not specified, uses all accounts included in the Security Lake.
        :param pulumi.Input[builtins.str] source_version: The version for a AWS source.
               If not specified, the version will be the default.
               This must be a Regionally unique value.
        """
...
if not MYPY:
    class CustomLogSourceAttributeArgsDict(TypedDict):
        crawler_arn: pulumi.Input[builtins.str]
        """
        The ARN of the AWS Glue crawler.
        """
        database_arn: pulumi.Input[builtins.str]
        """
...
class CustomLogSourceAttributeArgs:
    def __init__(__self__, *,
                 ...
                 table_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] crawler_arn: The ARN of the AWS Glue crawler.
        :param pulumi.Input[builtins.str] database_arn: The ARN of the AWS Glue database where results are written.
        :param pulumi.Input[builtins.str] table_arn: The ARN of the AWS Glue table.
        """
    ...
    def crawler_arn(self) -> pulumi.Input[builtins.str]:
        """
        The ARN of the AWS Glue crawler.
        """
    ...
    @crawler_arn.setter
    def crawler_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "crawler_arn", value)

    @property
    @pulumi.getter(name="databaseArn")
    def database_arn(self) -> pulumi.Input[builtins.str]:
        """
        The ARN of the AWS Glue database where results are written.
        """
    ...
    @database_arn.setter
    def database_arn(self, value: pulumi.Input[builtins.str]):
    ...
    @table_arn.setter
    def table_arn(self, value: pulumi.Input[builtins.str]):
...
class CustomLogSourceConfigurationCrawlerConfigurationArgs:
    def __init__(__self__, *,
                 role_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role to be used by the AWS Glue crawler.
        """
...
class CustomLogSourceConfigurationProviderIdentityArgs:
    def __init__(__self__, *,
                 ...
                 principal: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] external_id: The external ID used to estalish trust relationship with the AWS identity.
...
class CustomLogSourceProviderDetailArgs:
    def __init__(__self__, *,
                 ...
                 role_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] location: The location of the partition in the Amazon S3 bucket for Security Lake.
...
class DataLakeConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] region: The AWS Regions where Security Lake is automatically enabled.
...
class DataLakeConfigurationLifecycleConfigurationExpirationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] days: Number of days before data transition to a different S3 Storage Class in the Amazon Security Lake object.
        """
        if days is not None:
...
class DataLakeConfigurationReplicationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] regions: Replication enables automatic, asynchronous copying of objects across Amazon S3 buckets. Amazon S3 buckets that are configured for object replication can be owned by the same AWS account or by different accounts. You can replicate objects to a single destination bucket or to multiple destination buckets. The destination buckets can be in different AWS Regions or within the same Region as the source bucket.
...
class SubscriberNotificationConfigurationHttpsNotificationConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_role_arn: The Amazon Resource Name (ARN) of the EventBridge API destinations IAM role that you created.
               For more information about ARNs and how to use them in policies, see Managing data access and AWS Managed Policies in the Amazon Security Lake User Guide.
        :param pulumi.Input[builtins.str] authorization_api_key_name: The API key name for the notification subscription.
        :param pulumi.Input[builtins.str] authorization_api_key_value: The API key value for the notification subscription.
        :param pulumi.Input[builtins.str] http_method: The HTTP method used for the notification subscription.
               Valid values are `POST` and `PUT`.
        """
...
class SubscriberSourceAwsLogSourceResourceArgs:
    def __init__(__self__, *,
                 ...
                 source_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] source_name: Provides data expiration details of Amazon Security Lake object.
        :param pulumi.Input[builtins.str] source_version: Provides data storage transition details of Amazon Security Lake object.
        """
        pulumi.set(__self__, "source_name", source_name)
        if source_version is not None:
            pulumi.set(__self__, "source_version", source_version)
...
class SubscriberSubscriberIdentityArgs:
    def __init__(__self__, *,
                 ...
                 principal: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] external_id: The AWS Regions where Security Lake is automatically enabled.
        :param pulumi.Input[builtins.str] principal: Provides encryption details of Amazon Security Lake object.
        """
        pulumi.set(__self__, "external_id", external_id)
        pulumi.set(__self__, "principal", principal)
