...
class DevEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_type: The Amazon EC2 instace type to use for the Dev Environment. Valid values include dev.standard1.small,dev.standard1.medium,dev.standard1.large,dev.standard1.xlarge
    ...
    def inactivity_timeout_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def inactivity_timeout_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DevEnvironment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="inactivityTimeoutMinutes")
    def inactivity_timeout_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The amount of time the Dev Environment will run without any activity detected before stopping, in minutes. Only whole integers are allowed. Dev Environments consume compute minutes when running.
        """
        return pulumi.get(self, "inactivity_timeout_minutes")
