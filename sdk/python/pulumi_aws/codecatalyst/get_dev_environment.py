...
class GetDevEnvironmentResult:
    ...
    def creator_id(self) -> Optional[builtins.str]:
        """
    ...
    def inactivity_timeout_minutes(self) -> builtins.int:
        """
...
def get_dev_environment(alias: Optional[builtins.str] = None,
    ...
    :param builtins.str alias: The user-specified alias for the Dev Environment.
...
def get_dev_environment_output(alias: Optional[pulumi.Input[Optional[builtins.str]]] = None,
