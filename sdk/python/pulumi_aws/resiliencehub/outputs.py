...
class ResiliencyPolicyPolicyAz(dict):
    def __init__(__self__, *,
                 ...
                 rto: builtins.str):
        """
        :param builtins.str rpo: Recovery Point Objective (RPO) as a Go duration.
        :param builtins.str rto: Recovery Time Objective (RTO) as a Go duration.
        """
...
class ResiliencyPolicyPolicyRegion(dict):
    def __init__(__self__, *,
                 rpo: Optional[builtins.str] = None,
                 rto: Optional[builtins.str] = None):
        """
        :param builtins.str rpo: Recovery Point Objective (RPO) as a Go duration.
        :param builtins.str rto: Recovery Time Objective (RTO) as a Go duration.
        """
    ...
    @property
    @pulumi.getter
    def rpo(self) -> Optional[builtins.str]:
        """
        Recovery Point Objective (RPO) as a Go duration.
        """
        return pulumi.get(self, "rpo")
    ...
    @property
    @pulumi.getter
    def rto(self) -> Optional[builtins.str]:
        """
        Recovery Time Objective (RTO) as a Go duration.
        """
        return pulumi.get(self, "rto")
