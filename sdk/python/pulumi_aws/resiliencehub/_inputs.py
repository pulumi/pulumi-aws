...
if not MYPY:
    class ResiliencyPolicyPolicyAzArgsDict(TypedDict):
        rpo: pulumi.Input[builtins.str]
        """
        Recovery Point Objective (RPO) as a Go duration.
        """
        rto: pulumi.Input[builtins.str]
        """
...
class ResiliencyPolicyPolicyAzArgs:
    def __init__(__self__, *,
                 ...
                 rto: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] rpo: Recovery Point Objective (RPO) as a Go duration.
        :param pulumi.Input[builtins.str] rto: Recovery Time Objective (RTO) as a Go duration.
        """
    ...
    @property
    @pulumi.getter
    def rpo(self) -> pulumi.Input[builtins.str]:
        """
        Recovery Point Objective (RPO) as a Go duration.
        """
    ...
    @rpo.setter
    def rpo(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rpo", value)

    @property
    @pulumi.getter
    def rto(self) -> pulumi.Input[builtins.str]:
        """
        Recovery Time Objective (RTO) as a Go duration.
        """
    ...
    @rto.setter
    def rto(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ResiliencyPolicyPolicyRegionArgsDict(TypedDict):
        rpo: NotRequired[pulumi.Input[builtins.str]]
        """
        Recovery Point Objective (RPO) as a Go duration.
        """
        rto: NotRequired[pulumi.Input[builtins.str]]
        """
        Recovery Time Objective (RTO) as a Go duration.
        """
elif False:
...
class ResiliencyPolicyPolicyRegionArgs:
    def __init__(__self__, *,
                 ...
                 rto: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] rpo: Recovery Point Objective (RPO) as a Go duration.
        :param pulumi.Input[builtins.str] rto: Recovery Time Objective (RTO) as a Go duration.
        """
    ...
    @property
    @pulumi.getter
    def rto(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Recovery Time Objective (RTO) as a Go duration.
        """
        return pulumi.get(self, "rto")
    ...
    @rto.setter
    def rto(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rto", value)
