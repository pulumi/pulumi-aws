...
warnings.warn("aws.elasticloadbalancingv2.getLoadBalancer has been deprecated in favour of aws.lb.getLoadBalancer", DeprecationWarning)
...
def get_load_balancer(arn=None,name=None,tags=None,opts=None):
    ...
    """
    pulumi.log.warn("get_load_balancer is deprecated: aws.elasticloadbalancingv2.getLoadBalancer has been deprecated in favour of aws.lb.getLoadBalancer")
    __args__ = dict()
