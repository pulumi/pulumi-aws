...
class _BucketOwnershipControlsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BucketOwnershipControlsRuleArgs'] rule: Configuration block(s) with Ownership Controls rules. Detailed below.
        """
        _BucketOwnershipControlsState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            bucket=bucket,
            rule=rule,
        )
...
class BucketOwnershipControls(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            BucketOwnershipControlsArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if rule is not None and not isinstance(rule, BucketOwnershipControlsRuleArgs):
                rule = rule or {}
                def _setter(key, value):
                    rule[key] = value
                BucketOwnershipControlsRuleArgs._configure(_setter, **rule)
