...
class BucketCorsRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 max_age_seconds: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] allowed_methods: Specifies which methods are allowed. Can be `GET`, `PUT`, `POST`, `DELETE` or `HEAD`.
        ...
        :param Sequence[builtins.str] expose_headers: Specifies expose header in the response.
...
class BucketObjectLockConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str object_lock_enabled: Indicates whether this bucket has an Object Lock configuration enabled. Valid value is `Enabled`.
...
class BucketObjectLockConfigurationRuleDefaultRetention(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str mode: The default Object Lock retention mode you want to apply to new objects placed in this bucket. Valid values are `GOVERNANCE` and `COMPLIANCE`.
        :param builtins.int days: The number of days that you want to specify for the default retention period.
        :param builtins.int years: The number of years that you want to specify for the default retention period.
...
class BucketReplicationConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str role: The ARN of the IAM role for Amazon S3 to assume when replicating the objects.
...
class BucketReplicationConfigurationRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str status: The status of the rule. Either `Enabled` or `Disabled`. The rule is ignored if status is not Enabled.
        ...
        :param builtins.int priority: The priority associated with the rule. Priority should only be set if `filter` is configured. If not provided, defaults to `0`. Priority must be unique between multiple rules.
...
class BucketReplicationConfigurationRuleDestination(dict):
    ...
    def __init__(__self__, *,
                 ...
                 storage_class: Optional[builtins.str] = None):
        """
        :param builtins.str bucket: The ARN of the S3 bucket where you want Amazon S3 to store replicas of the object identified by the rule.
        ...
        :param builtins.str account_id: The Account ID to use for overriding the object owner on replication. Must be used in conjunction with `access_control_translation` override configuration.
...
class BucketReplicationConfigurationRuleDestinationAccessControlTranslation(dict):
    def __init__(__self__, *,
                 owner: builtins.str):
        """
        :param builtins.str owner: The override value for the owner on replicated objects. Currently only `Destination` is supported.
        """
        pulumi.set(__self__, "owner", owner)
...
class BucketReplicationConfigurationRuleDestinationMetrics(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str status: The status of replication metrics. Either `Enabled` or `Disabled`.
        """
...
class BucketReplicationConfigurationRuleDestinationReplicationTime(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int minutes: Threshold within which objects are to be replicated. The only valid value is `15`.
        :param builtins.str status: The status of RTC. Either `Enabled` or `Disabled`.
        """
        if minutes is not None:
            pulumi.set(__self__, "minutes", minutes)
        if status is not None:
...
class BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefault(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str sse_algorithm: The server-side encryption algorithm to use. Valid values are `AES256` and `aws:kms`
        :param builtins.str kms_master_key_id: The AWS KMS master key ID used for the SSE-KMS encryption. This can only be used when you set the value of `sse_algorithm` as `aws:kms`. The default `aws/s3` AWS KMS master key is used if this element is absent while the `sse_algorithm` is `aws:kms`.
        """
...
class BucketWebsite(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Union[builtins.str, Sequence['RoutingRuleArgs']] routing_rules: A json array containing [routing rules](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-websiteconfiguration-routingrules.html)
               describing redirect behavior and when redirects are applied.
...
class Condition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        A condition that must be met for the specified redirect to be applied.
        :param builtins.str http_error_code_returned_equals: The HTTP error code that must match for the redirect to apply. If an error occurs, and if the error code meets this value, then the specified redirect applies. `HttpErrorCodeReturnedEquals` is required if `KeyPrefixEquals` is not specified. If both are specified, both must be true for the condition to be met.
        :param builtins.str key_prefix_equals: The prefix of the object key name from which requests are redirected. `KeyPrefixEquals` is required if `HttpErrorCodeReturnedEquals` is not specified. If both are specified, both must be true for the condition to be met.
        """
        if http_error_code_returned_equals is not None:
            pulumi.set(__self__, "http_error_code_returned_equals", http_error_code_returned_equals)
        if key_prefix_equals is not None:
...
class Redirect(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in Redirect. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        Redirect.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
        ...
        """
        Provides instructions for redirecting the request. You can redirect requests to another host or another page, or you can specify another protocol to use. At least one property must be set.
        :param builtins.str host_name: The hostname to be used in the Location header that is returned in the response. If another property is set, `HostName` is not required.
        :param builtins.str http_redirect_code: The HTTP redirect code to be used in the Location header that is returned in the response. If another property is set, `HttpRedirectCode` is not required.
        :param builtins.str protocol: The protocol, http or https, to be used in the Location header that is returned in the response. If another property is set, `Protocol` is not required.
        :param builtins.str replace_key_prefix_with: The prefix of the object key name that replaces the value of `KeyPrefixEquals` in the redirect request. If another property is set, `ReplaceKeyPrefixWith` is not required. It can be set only if `ReplaceKeyWith` is not set.
        :param builtins.str replace_key_with: The object key to be used in the Location header that is returned in the response. If another property is set, `ReplaceKeyWith` is not required. It can be set only if `ReplaceKeyPrefixWith` is not set.
        """
        if host_name is not None:
            pulumi.set(__self__, "host_name", host_name)
        if http_redirect_code is not None:
...
class RoutingRule(dict):
    ...
    def __key_warning(key: str):
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in RoutingRule. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        RoutingRule.__key_warning(key)
        return super().__getitem__(key)
    ...
    def __init__(__self__, *,
                 redirect: 'outputs.Redirect',
                 condition: Optional['outputs.Condition'] = None):
        """
        A rule that identifies a condition and the redirect that is applied when the condition is met. If a condition is not included, the rule is applied to all requests.
        :param 'RedirectArgs' redirect: Provides instructions for redirecting the request. You can redirect requests to another host or another page, or you can specify another protocol to use.
        :param 'ConditionArgs' condition: A condition that must be met for the specified redirect to be applied. If not included, the rule is applied to all requests.
        """
        pulumi.set(__self__, "redirect", redirect)
        if condition is not None:
            pulumi.set(__self__, "condition", condition)
    ...
    def redirect(self) -> 'outputs.Redirect':
        """
    ...
    def condition(self) -> Optional['outputs.Condition']:
        """
