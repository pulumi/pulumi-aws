...
__all__ = ['TablesTablePolicyArgs', 'TablesTablePolicy']

@pulumi.input_type
class TablesTablePolicyArgs:
...
class TablesTablePolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TablesTablePolicyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TablesTablePolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TablesTablePolicyArgs.__new__(TablesTablePolicyArgs)
        ...
        super(TablesTablePolicy, __self__).__init__(
            'aws:s3/tablesTablePolicy:TablesTablePolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            namespace: Optional[pulumi.Input[str]] = None,
            resource_policy: Optional[pulumi.Input[str]] = None,
            table_bucket_arn: Optional[pulumi.Input[str]] = None) -> 'TablesTablePolicy':
        """
        ...
        __props__ = _TablesTablePolicyState.__new__(_TablesTablePolicyState)

        __props__.__dict__["name"] = name
        __props__.__dict__["namespace"] = namespace
        __props__.__dict__["resource_policy"] = resource_policy
        __props__.__dict__["table_bucket_arn"] = table_bucket_arn
        return TablesTablePolicy(resource_name, opts=opts, __props__=__props__)
