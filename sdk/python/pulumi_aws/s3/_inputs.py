...
__all__ = [
    ...
    'BucketReplicationConfigurationRuleDestinationMetricArgs',
    'BucketReplicationConfigurationRuleDestinationMetricArgsDict',
    ...
    'BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgs',
    'BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgsDict',
...
class AccessPointPublicAccessBlockConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] block_public_acls: Whether Amazon S3 should block public ACLs for buckets in this account. Defaults to `true`. Enabling this setting does not affect existing policies or ACLs. When set to `true` causes the following behavior:
               * PUT Bucket acl and PUT Object acl calls fail if the specified ACL is public.
               * PUT Object calls fail if the request includes a public ACL.
               * PUT Bucket calls fail if the request includes a public ACL.
        :param pulumi.Input[builtins.bool] block_public_policy: Whether Amazon S3 should block public bucket policies for buckets in this account. Defaults to `true`. Enabling this setting does not affect existing bucket policies. When set to `true` causes Amazon S3 to:
               * Reject calls to PUT Bucket policy if the specified bucket policy allows public access.
        :param pulumi.Input[builtins.bool] ignore_public_acls: Whether Amazon S3 should ignore public ACLs for buckets in this account. Defaults to `true`. Enabling this setting does not affect the persistence of any existing ACLs and doesn't prevent new public ACLs from being set. When set to `true` causes Amazon S3 to:
               * Ignore all public ACLs on buckets in this account and any objects that they contain.
...
class AccessPointVpcConfigurationArgs:
    def __init__(__self__, *,
                 vpc_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] vpc_id: This access point will only allow connections from the specified VPC ID.
        """
...
class AnalyticsConfigurationFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] prefix: Object prefix for filtering.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Set of object tags for filtering.
        """
...
if not MYPY:
    class AnalyticsConfigurationStorageClassAnalysisDataExportArgsDict(TypedDict):
        ...
        """
        output_schema_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AnalyticsConfigurationStorageClassAnalysisDataExportArgs:
    def __init__(__self__, *,
                 ...
                 output_schema_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] output_schema_version: Schema version of exported analytics data. Allowed values: `V_1`. Default value: `V_1`.
        """
    ...
    def output_schema_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Schema version of exported analytics data. Allowed values: `V_1`. Default value: `V_1`.
        """
    ...
    def output_schema_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AnalyticsConfigurationStorageClassAnalysisDataExportDestinationS3BucketDestinationArgs:
    def __init__(__self__, *,
                 ...
                 prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bucket_arn: ARN of the destination bucket.
        :param pulumi.Input[builtins.str] bucket_account_id: Account ID that owns the destination bucket.
        :param pulumi.Input[builtins.str] format: Output format of exported analytics data. Allowed values: `CSV`. Default value: `CSV`.
        :param pulumi.Input[builtins.str] prefix: Prefix to append to exported analytics data.
        """
...
class BucketAclV2AccessControlPolicyGrantArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] permission: Logging permissions assigned to the grantee for the bucket. Valid values: `FULL_CONTROL`, `WRITE`, `WRITE_ACP`, `READ`, `READ_ACP`. See [What permissions can I grant?](https://docs.aws.amazon.com/AmazonS3/latest/userguide/acl-overview.html#permissions) for more details about what each permission means in the context of buckets.
...
class BucketAclV2AccessControlPolicyGrantGranteeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Type of grantee. Valid values: `CanonicalUser`, `AmazonCustomerByEmail`, `Group`.
        :param pulumi.Input[builtins.str] display_name: Display name of the owner.
        :param pulumi.Input[builtins.str] email_address: Email address of the grantee. See [Regions and Endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html#s3_region) for supported AWS regions where this argument can be specified.
        :param pulumi.Input[builtins.str] id: Canonical user ID of the grantee.
        :param pulumi.Input[builtins.str] uri: URI of the grantee group.
        """
...
class BucketAclV2AccessControlPolicyOwnerArgs:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] id: ID of the owner.
        :param pulumi.Input[builtins.str] display_name: Display name of the owner.
        """
        pulumi.set(__self__, "id", id)
        if display_name is not None:
...
class BucketCorsConfigurationV2CorsRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: Set of HTTP methods that you allow the origin to execute. Valid values are `GET`, `PUT`, `HEAD`, `POST`, and `DELETE`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_origins: Set of origins you want customers to be able to access the bucket from.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_headers: Set of Headers that are specified in the `Access-Control-Request-Headers` header.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] expose_headers: Set of headers in the response that you want customers to be able to access from their applications (for example, from a JavaScript `XMLHttpRequest` object).
        :param pulumi.Input[builtins.str] id: Unique identifier for the rule. The value cannot be longer than 255 characters.
        :param pulumi.Input[builtins.int] max_age_seconds: Time in seconds that your browser is to cache the preflight response for the specified resource.
        """
...
class BucketCorsRuleArgs:
    def __init__(__self__, *,
                 ...
                 max_age_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: One or more HTTP methods that you allow the origin to execute. Can be `GET`, `PUT`, `POST`, `DELETE` or `HEAD`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_headers: List of headers allowed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] expose_headers: One or more headers in the response that you want customers to be able to access from their applications (for example, from a JavaScript `XMLHttpRequest` object).
...
class BucketGrantArgs:
    def __init__(__self__, *,
                 ...
                 uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] permissions: List of permissions to apply for grantee. Valid values are `READ`, `WRITE`, `READ_ACP`, `WRITE_ACP`, `FULL_CONTROL`.
        :param pulumi.Input[builtins.str] type: Type of grantee to apply for. Valid values are `CanonicalUser` and `Group`. `AmazonCustomerByEmail` is not supported.
        :param pulumi.Input[builtins.str] id: Canonical user id to grant for. Used only when `type` is `CanonicalUser`.
        :param pulumi.Input[builtins.str] uri: Uri address to grant for. Used only when `type` is `Group`.
        """
...
class BucketIntelligentTieringConfigurationFilterArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] prefix: Object key name prefix that identifies the subset of objects to which the configuration applies.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: All of these tags must exist in the object's tag set in order for the configuration to apply.
        """
        if prefix is not None:
            pulumi.set(__self__, "prefix", prefix)
        if tags is not None:
...
if not MYPY:
    class BucketIntelligentTieringConfigurationTieringArgsDict(TypedDict):
        access_tier: pulumi.Input[builtins.str]
        """
...
class BucketIntelligentTieringConfigurationTieringArgs:
    def __init__(__self__, *,
                 ...
                 days: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] access_tier: S3 Intelligent-Tiering access tier. Valid values: `ARCHIVE_ACCESS`, `DEEP_ARCHIVE_ACCESS`.
        :param pulumi.Input[builtins.int] days: Number of consecutive days of no access after which an object will be eligible to be transitioned to the corresponding tier.
        """
    ...
    def access_tier(self) -> pulumi.Input[builtins.str]:
        """
        S3 Intelligent-Tiering access tier. Valid values: `ARCHIVE_ACCESS`, `DEEP_ARCHIVE_ACCESS`.
        """
    ...
    @access_tier.setter
    def access_tier(self, value: pulumi.Input[builtins.str]):
...
class BucketLifecycleConfigurationV2RuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: Unique identifier for the rule. The value cannot be longer than 255 characters.
        :param pulumi.Input[builtins.str] status: Whether the rule is currently being applied. Valid values: `Enabled` or `Disabled`.
        ...
        :param pulumi.Input[builtins.str] prefix: **DEPRECATED** Use `filter` instead.
               This has been deprecated by Amazon S3.
               Prefix identifying one or more objects to which the rule applies.
               Defaults to an empty string (`""`) if `filter` is not specified.
               One of `prefix` or `filter` should be specified.
...
class BucketLifecycleConfigurationV2RuleExpirationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] date: Date the object is to be moved or deleted. The date value must be in [RFC3339 full-date format](https://datatracker.ietf.org/doc/html/rfc3339#section-5.6) e.g. `2023-08-22`.
        :param pulumi.Input[builtins.int] days: Lifetime, in days, of the objects that are subject to the rule. The value must be a non-zero positive integer.
        :param pulumi.Input[builtins.bool] expired_object_delete_marker: Indicates whether Amazon S3 will remove a delete marker with no noncurrent versions. If set to `true`, the delete marker will be expired; if set to `false` the policy takes no action.
        """
        if date is not None:
...
class BucketLifecycleConfigurationV2RuleFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] prefix: Prefix identifying one or more objects to which the rule applies. Defaults to an empty string (`""`) if not specified.
...
class BucketLifecycleConfigurationV2RuleFilterTagArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Name of the object key.
...
class BucketLifecycleConfigurationV2RuleNoncurrentVersionExpirationArgs:
    def __init__(__self__, *,
                 noncurrent_days: pulumi.Input[builtins.int],
                 newer_noncurrent_versions: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] noncurrent_days: Number of days an object is noncurrent before Amazon S3 can perform the associated action. Must be a positive integer.
        :param pulumi.Input[builtins.int] newer_noncurrent_versions: Number of noncurrent versions Amazon S3 will retain. Must be a non-zero positive integer.
        """
    ...
    def noncurrent_days(self) -> pulumi.Input[builtins.int]:
        """
        Number of days an object is noncurrent before Amazon S3 can perform the associated action. Must be a positive integer.
        """
    ...
    def noncurrent_days(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "noncurrent_days", value)

    @property
    @pulumi.getter(name="newerNoncurrentVersions")
    def newer_noncurrent_versions(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of noncurrent versions Amazon S3 will retain. Must be a non-zero positive integer.
        """
    ...
    def newer_noncurrent_versions(self, value: Optional[pulumi.Input[builtins.int]]):
...
class BucketLifecycleConfigurationV2RuleNoncurrentVersionTransitionArgs:
    def __init__(__self__, *,
                 ...
                 newer_noncurrent_versions: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] noncurrent_days: Number of days an object is noncurrent before Amazon S3 can perform the associated action.
        :param pulumi.Input[builtins.str] storage_class: Class of storage used to store the object. Valid Values: `GLACIER`, `STANDARD_IA`, `ONEZONE_IA`, `INTELLIGENT_TIERING`, `DEEP_ARCHIVE`, `GLACIER_IR`.
        :param pulumi.Input[builtins.int] newer_noncurrent_versions: Number of noncurrent versions Amazon S3 will retain. Must be a non-zero positive integer.
        """
        pulumi.set(__self__, "noncurrent_days", noncurrent_days)
...
class BucketLifecycleConfigurationV2RuleTransitionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] storage_class: Class of storage used to store the object. Valid Values: `GLACIER`, `STANDARD_IA`, `ONEZONE_IA`, `INTELLIGENT_TIERING`, `DEEP_ARCHIVE`, `GLACIER_IR`.
        :param pulumi.Input[builtins.str] date: Date objects are transitioned to the specified storage class. The date value must be in [RFC3339 full-date format](https://datatracker.ietf.org/doc/html/rfc3339#section-5.6) e.g. `2023-08-22`.
        :param pulumi.Input[builtins.int] days: Number of days after creation when objects are transitioned to the specified storage class. The value must be a positive integer. If both `days` and `date` are not specified, defaults to `0`. Valid values depend on `storage_class`, see [Transition objects using Amazon S3 Lifecycle](https://docs.aws.amazon.com/AmazonS3/latest/userguide/lifecycle-transition-general-considerations.html) for more details.
        """
        pulumi.set(__self__, "storage_class", storage_class)
        if date is not None:
            pulumi.set(__self__, "date", date)
...
class BucketLifecycleRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BucketLifecycleRuleExpirationArgs']]] expirations: Specifies a period in the object's expire. See Expiration below for details.
        :param pulumi.Input[builtins.str] id: Unique identifier for the rule. Must be less than or equal to 255 characters in length.
        :param pulumi.Input[Sequence[pulumi.Input['BucketLifecycleRuleNoncurrentVersionExpirationArgs']]] noncurrent_version_expirations: Specifies when noncurrent object versions expire. See Noncurrent Version Expiration below for details.
...
class BucketLifecycleRuleExpirationArgs:
    def __init__(__self__, *,
                 ...
                 expired_object_delete_marker: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] date: Specifies the date after which you want the corresponding action to take effect.
        ...
        :param pulumi.Input[builtins.bool] expired_object_delete_marker: On a versioned bucket (versioning-enabled or versioning-suspended bucket), you can add this element in the lifecycle configuration to direct Amazon S3 to delete expired object delete markers. This cannot be specified with Days or Date in a Lifecycle Expiration Policy.
        """
        if date is not None:
            pulumi.set(__self__, "date", date)
        if days is not None:
...
class BucketLifecycleRuleNoncurrentVersionExpirationArgs:
    def __init__(__self__, *,
                 days: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] days: Specifies the number of days noncurrent object versions expire.
        """
        if days is not None:
            pulumi.set(__self__, "days", days)
...
class BucketLifecycleRuleNoncurrentVersionTransitionArgs:
    def __init__(__self__, *,
                 ...
                 days: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] storage_class: Specifies the Amazon S3 [storage class](https://docs.aws.amazon.com/AmazonS3/latest/API/API_Transition.html#AmazonS3-Type-Transition-StorageClass) to which you want the object to transition.
...
class BucketLoggingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] target_bucket: Name of the bucket that will receive the log objects.
...
class BucketLoggingV2TargetGrantArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] permission: Logging permissions assigned to the grantee for the bucket. Valid values: `FULL_CONTROL`, `READ`, `WRITE`.
        """
        pulumi.set(__self__, "grantee", grantee)
        pulumi.set(__self__, "permission", permission)
...
if not MYPY:
    class BucketLoggingV2TargetObjectKeyFormatPartitionedPrefixArgsDict(TypedDict):
        partition_date_source: pulumi.Input[builtins.str]
        """
...
class BucketLoggingV2TargetObjectKeyFormatPartitionedPrefixArgs:
    def __init__(__self__, *,
                 partition_date_source: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] partition_date_source: Specifies the partition date source for the partitioned prefix. Valid values: `EventTime`, `DeliveryTime`.
        """
        pulumi.set(__self__, "partition_date_source", partition_date_source)

    @property
    @pulumi.getter(name="partitionDateSource")
    def partition_date_source(self) -> pulumi.Input[builtins.str]:
        """
        Specifies the partition date source for the partitioned prefix. Valid values: `EventTime`, `DeliveryTime`.
        """
    ...
    def partition_date_source(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class BucketMetricFilterArgsDict(TypedDict):
        access_point: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketMetricFilterArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] access_point: S3 Access Point ARN for filtering (singular).
        :param pulumi.Input[builtins.str] prefix: Object prefix for filtering (singular).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Object tags for filtering (up to 10).
        """
...
class BucketNotificationLambdaFunctionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: [Event](http://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html#notification-how-to-event-types-and-destinations) for which to send notifications.
        :param pulumi.Input[builtins.str] filter_prefix: Object key name prefix.
        :param pulumi.Input[builtins.str] filter_suffix: Object key name suffix.
        :param pulumi.Input[builtins.str] id: Unique identifier for each of the notification configurations.
        :param pulumi.Input[builtins.str] lambda_function_arn: Lambda function ARN.
        """
...
class BucketNotificationQueueArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: Specifies [event](http://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html#notification-how-to-event-types-and-destinations) for which to send notifications.
        :param pulumi.Input[builtins.str] queue_arn: SQS queue ARN.
        :param pulumi.Input[builtins.str] filter_prefix: Object key name prefix.
        :param pulumi.Input[builtins.str] filter_suffix: Object key name suffix.
        :param pulumi.Input[builtins.str] id: Unique identifier for each of the notification configurations.
        """
...
class BucketNotificationTopicArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: [Event](http://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html#notification-how-to-event-types-and-destinations) for which to send notifications.
        :param pulumi.Input[builtins.str] topic_arn: SNS topic ARN.
        :param pulumi.Input[builtins.str] filter_prefix: Object key name prefix.
        :param pulumi.Input[builtins.str] filter_suffix: Object key name suffix.
        :param pulumi.Input[builtins.str] id: Unique identifier for each of the notification configurations.
        """
...
if not MYPY:
    class BucketObjectLockConfigurationArgsDict(TypedDict):
        ...
        """
        rules: NotRequired[pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleArgsDict']]]]
        """
...
class BucketObjectLockConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] object_lock_enabled: Indicates whether this bucket has an Object Lock configuration enabled. Valid values are `true` or `false`. This argument is not supported in all regions or partitions.
        :param pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleArgs']]] rules: Object Lock rule in place for this bucket (documented below).
        """
    ...
    def rules(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleArgs']]]]:
        """
        Object Lock rule in place for this bucket (documented below).
        """
    ...
    @rules.setter
    def rules(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleArgs']]]]):
        pulumi.set(self, "rules", value)


if not MYPY:
    class BucketObjectLockConfigurationRuleArgsDict(TypedDict):
        default_retentions: pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleDefaultRetentionArgsDict']]]
        """
...
class BucketObjectLockConfigurationRuleArgs:
    def __init__(__self__, *,
                 default_retentions: pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleDefaultRetentionArgs']]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleDefaultRetentionArgs']]] default_retentions: Default retention period that you want to apply to new objects placed in this bucket (documented below).
        """
        pulumi.set(__self__, "default_retentions", default_retentions)

    @property
    @pulumi.getter(name="defaultRetentions")
    def default_retentions(self) -> pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleDefaultRetentionArgs']]]:
        """
        Default retention period that you want to apply to new objects placed in this bucket (documented below).
        """
    ...
    def default_retentions(self, value: pulumi.Input[Sequence[pulumi.Input['BucketObjectLockConfigurationRuleDefaultRetentionArgs']]]):
...
class BucketObjectLockConfigurationRuleDefaultRetentionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] mode: Default Object Lock retention mode you want to apply to new objects placed in this bucket. Valid values are `GOVERNANCE` and `COMPLIANCE`.
        :param pulumi.Input[builtins.int] days: Number of days that you want to specify for the default retention period.
        :param pulumi.Input[builtins.int] years: Number of years that you want to specify for the default retention period.
        """
...
class BucketObjectLockConfigurationV2RuleDefaultRetentionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] days: Number of days that you want to specify for the default retention period.
        :param pulumi.Input[builtins.str] mode: Default Object Lock retention mode you want to apply to new objects placed in the specified bucket. Valid values: `COMPLIANCE`, `GOVERNANCE`.
        :param pulumi.Input[builtins.int] years: Number of years that you want to specify for the default retention period.
        """
        if days is not None:
            pulumi.set(__self__, "days", days)
...
if not MYPY:
    class BucketOwnershipControlsRuleArgsDict(TypedDict):
        object_ownership: pulumi.Input[builtins.str]
        """
...
class BucketOwnershipControlsRuleArgs:
    def __init__(__self__, *,
                 object_ownership: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] object_ownership: Object ownership. Valid values: `BucketOwnerPreferred`, `ObjectWriter` or `BucketOwnerEnforced`
               * `BucketOwnerPreferred` - Objects uploaded to the bucket change ownership to the bucket owner if the objects are uploaded with the `bucket-owner-full-control` canned ACL.
               * `ObjectWriter` - Uploading account will own the object if the object is uploaded with the `bucket-owner-full-control` canned ACL.
               * `BucketOwnerEnforced` - Bucket owner automatically owns and has full control over every object in the bucket. ACLs no longer affect permissions to data in the S3 bucket.
        """
    ...
    def object_ownership(self) -> pulumi.Input[builtins.str]:
        """
        Object ownership. Valid values: `BucketOwnerPreferred`, `ObjectWriter` or `BucketOwnerEnforced`
        * `BucketOwnerPreferred` - Objects uploaded to the bucket change ownership to the bucket owner if the objects are uploaded with the `bucket-owner-full-control` canned ACL.
        * `ObjectWriter` - Uploading account will own the object if the object is uploaded with the `bucket-owner-full-control` canned ACL.
    ...
    def object_ownership(self, value: pulumi.Input[builtins.str]):
...
class BucketReplicationConfigRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] status: Status of the rule. Either `"Enabled"` or `"Disabled"`. The rule is ignored if status is not "Enabled".
        ...
        :param pulumi.Input[builtins.str] id: Unique identifier for the rule. Must be less than or equal to 255 characters in length.
        :param pulumi.Input[builtins.str] prefix: Object key name prefix identifying one or more objects to which the rule applies. Must be less than or equal to 1024 characters in length. Defaults to an empty string (`""`) if `filter` is not specified.
        :param pulumi.Input[builtins.int] priority: Priority associated with the rule. Priority should only be set if `filter` is configured. If not provided, defaults to `0`. Priority must be unique between multiple rules.
...
class BucketReplicationConfigRuleDeleteMarkerReplicationArgs:
    def __init__(__self__, *,
                 status: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] status: Whether delete markers should be replicated. Either `"Enabled"` or `"Disabled"`.
        """
        pulumi.set(__self__, "status", status)
...
if not MYPY:
    class BucketReplicationConfigRuleDestinationArgsDict(TypedDict):
        ...
        """
        account: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketReplicationConfigRuleDestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: ARN of the bucket where you want Amazon S3 to store the results.
        ...
        :param pulumi.Input[builtins.str] account: Account ID to specify the replica ownership. Must be used in conjunction with `access_control_translation` override configuration.
        ...
        :param pulumi.Input[builtins.str] storage_class: The [storage class](https://docs.aws.amazon.com/AmazonS3/latest/API/API_Destination.html#AmazonS3-Type-Destination-StorageClass) used to store the object. By default, Amazon S3 uses the storage class of the source object to create the object replica.
        """
...
class BucketReplicationConfigRuleDestinationAccessControlTranslationArgs:
    def __init__(__self__, *,
                 owner: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] owner: Specifies the replica ownership. For default and valid values, see [PUT bucket replication](https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTreplication.html) in the Amazon S3 API Reference. Valid values: `Destination`.
        """
        pulumi.set(__self__, "owner", owner)
...
class BucketReplicationConfigRuleDestinationEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 replica_kms_key_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] replica_kms_key_id: ID (Key ARN or Alias ARN) of the customer managed AWS KMS key stored in AWS Key Management Service (KMS) for the destination bucket.
        """
...
class BucketReplicationConfigRuleDestinationMetricsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] status: Status of the Destination Metrics. Either `"Enabled"` or `"Disabled"`.
...
class BucketReplicationConfigRuleDestinationMetricsEventThresholdArgs:
    def __init__(__self__, *,
                 minutes: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] minutes: Time in minutes. Valid values: `15`.
        """
...
class BucketReplicationConfigRuleDestinationReplicationTimeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] status: Status of the Replication Time Control. Either `"Enabled"` or `"Disabled"`.
...
class BucketReplicationConfigRuleExistingObjectReplicationArgs:
    def __init__(__self__, *,
                 status: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] status: Whether the existing objects should be replicated. Either `"Enabled"` or `"Disabled"`.
        """
        pulumi.set(__self__, "status", status)
...
class BucketReplicationConfigRuleFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] prefix: Object key name prefix that identifies subset of objects to which the rule applies. Must be less than or equal to 1024 characters in length.
...
class BucketReplicationConfigRuleFilterAndArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] prefix: Object key name prefix that identifies subset of objects to which the rule applies. Must be less than or equal to 1024 characters in length.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of tags (key and value pairs) that identifies a subset of objects to which the rule applies. The rule applies only to objects having all the tags in its tagset.
        """
        if prefix is not None:
            pulumi.set(__self__, "prefix", prefix)
        if tags is not None:
...
class BucketReplicationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] role: ARN of the IAM role for Amazon S3 to assume when replicating the objects.
...
if not MYPY:
    class BucketReplicationConfigurationRuleArgsDict(TypedDict):
        destinations: pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationArgsDict']]]
        """
        ...
        Status of the rule. Either `Enabled` or `Disabled`. The rule is ignored if status is not Enabled.
        """
        delete_marker_replication_status: NotRequired[pulumi.Input[builtins.str]]
        """
        Whether delete markers are replicated. The only valid value is `Enabled`. To disable, omit this argument. This argument is only valid with V2 replication configurations (i.e., when `filter` is used).
        """
        filters: NotRequired[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleFilterArgsDict']]]]
        """
        ...
        Priority associated with the rule. Priority should only be set if `filter` is configured. If not provided, defaults to `0`. Priority must be unique between multiple rules.
        """
        source_selection_criterias: NotRequired[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaArgsDict']]]]
        """
...
class BucketReplicationConfigurationRuleArgs:
    def __init__(__self__, *,
                 destinations: pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationArgs']]],
                 status: pulumi.Input[builtins.str],
                 delete_marker_replication_status: Optional[pulumi.Input[builtins.str]] = None,
                 filters: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleFilterArgs']]]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 prefix: Optional[pulumi.Input[builtins.str]] = None,
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 source_selection_criterias: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaArgs']]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationArgs']]] destinations: Specifies the destination for the rule (documented below).
        :param pulumi.Input[builtins.str] status: Status of the rule. Either `Enabled` or `Disabled`. The rule is ignored if status is not Enabled.
        :param pulumi.Input[builtins.str] delete_marker_replication_status: Whether delete markers are replicated. The only valid value is `Enabled`. To disable, omit this argument. This argument is only valid with V2 replication configurations (i.e., when `filter` is used).
        :param pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleFilterArgs']]] filters: Filter that identifies subset of objects to which the replication rule applies (documented below).
        :param pulumi.Input[builtins.str] id: Unique identifier for the rule. Must be less than or equal to 255 characters in length.
        :param pulumi.Input[builtins.str] prefix: Object keyname prefix identifying one or more objects to which the rule applies. Must be less than or equal to 1024 characters in length.
        :param pulumi.Input[builtins.int] priority: Priority associated with the rule. Priority should only be set if `filter` is configured. If not provided, defaults to `0`. Priority must be unique between multiple rules.
        :param pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaArgs']]] source_selection_criterias: Specifies special object selection criteria (documented below).
        """
    ...
    @property
    @pulumi.getter
    def destinations(self) -> pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationArgs']]]:
        """
        Specifies the destination for the rule (documented below).
        """
    ...
    @destinations.setter
    def destinations(self, value: pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationArgs']]]):
    ...
    def delete_marker_replication_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether delete markers are replicated. The only valid value is `Enabled`. To disable, omit this argument. This argument is only valid with V2 replication configurations (i.e., when `filter` is used).
        """
    ...
    def delete_marker_replication_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delete_marker_replication_status", value)

    @property
    @pulumi.getter
    def filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleFilterArgs']]]]:
        """
        Filter that identifies subset of objects to which the replication rule applies (documented below).
        """
    ...
    @filters.setter
    def filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleFilterArgs']]]]):
    ...
    def source_selection_criterias(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaArgs']]]]:
        """
        Specifies special object selection criteria (documented below).
        """
    ...
    def source_selection_criterias(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaArgs']]]]):
...
if not MYPY:
    class BucketReplicationConfigurationRuleDestinationArgsDict(TypedDict):
        ...
        """
        access_control_translations: NotRequired[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationAccessControlTranslationArgsDict']]]]
        """
        ...
        """
        metrics: NotRequired[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationMetricArgsDict']]]]
        """
        Enables replication metrics (required for S3 RTC) (documented below).
        """
        replica_kms_key_id: NotRequired[pulumi.Input[builtins.str]]
        """
        Destination KMS encryption key ARN for SSE-KMS replication. Must be used in conjunction with
        `sse_kms_encrypted_objects` source selection criteria.
        """
        replication_times: NotRequired[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationReplicationTimeArgsDict']]]]
        """
...
class BucketReplicationConfigurationRuleDestinationArgs:
    def __init__(__self__, *,
                 bucket: pulumi.Input[builtins.str],
                 access_control_translations: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationAccessControlTranslationArgs']]]] = None,
                 account_id: Optional[pulumi.Input[builtins.str]] = None,
                 metrics: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationMetricArgs']]]] = None,
                 replica_kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 replication_times: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationReplicationTimeArgs']]]] = None,
                 storage_class: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bucket: ARN of the S3 bucket where you want Amazon S3 to store replicas of the object identified by the rule.
        :param pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationAccessControlTranslationArgs']]] access_control_translations: Specifies the overrides to use for object owners on replication (documented below). Must be used in conjunction with `account_id` owner override configuration.
        :param pulumi.Input[builtins.str] account_id: Account ID to use for overriding the object owner on replication. Must be used in conjunction with `access_control_translation` override configuration.
        :param pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationMetricArgs']]] metrics: Enables replication metrics (required for S3 RTC) (documented below).
        :param pulumi.Input[builtins.str] replica_kms_key_id: Destination KMS encryption key ARN for SSE-KMS replication. Must be used in conjunction with
               `sse_kms_encrypted_objects` source selection criteria.
        :param pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationReplicationTimeArgs']]] replication_times: Enables S3 Replication Time Control (S3 RTC) (documented below).
        :param pulumi.Input[builtins.str] storage_class: The [storage class](https://docs.aws.amazon.com/AmazonS3/latest/API/API_Destination.html#AmazonS3-Type-Destination-StorageClass) used to store the object. By default, Amazon S3 uses the storage class of the source object to create the object replica.
        """
        pulumi.set(__self__, "bucket", bucket)
    ...
    def access_control_translations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationAccessControlTranslationArgs']]]]:
        """
        Specifies the overrides to use for object owners on replication (documented below). Must be used in conjunction with `account_id` owner override configuration.
        """
    ...
    def access_control_translations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationAccessControlTranslationArgs']]]]):
    ...
    @property
    @pulumi.getter
    def metrics(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationMetricArgs']]]]:
        """
        Enables replication metrics (required for S3 RTC) (documented below).
        """
        return pulumi.get(self, "metrics")
    ...
    @metrics.setter
    def metrics(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationMetricArgs']]]]):
        pulumi.set(self, "metrics", value)

    @property
    @pulumi.getter(name="replicaKmsKeyId")
    def replica_kms_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Destination KMS encryption key ARN for SSE-KMS replication. Must be used in conjunction with
        `sse_kms_encrypted_objects` source selection criteria.
        """
    ...
    @replica_kms_key_id.setter
    def replica_kms_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replica_kms_key_id", value)

    @property
    @pulumi.getter(name="replicationTimes")
    def replication_times(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationReplicationTimeArgs']]]]:
        """
        Enables S3 Replication Time Control (S3 RTC) (documented below).
        """
    ...
    def replication_times(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleDestinationReplicationTimeArgs']]]]):
...
class BucketReplicationConfigurationRuleDestinationAccessControlTranslationArgs:
    def __init__(__self__, *,
                 owner: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] owner: Specifies the replica ownership. For default and valid values, see [PUT bucket replication](https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutBucketReplication.html) in the Amazon S3 API Reference. The only valid value is `Destination`.
        """
        pulumi.set(__self__, "owner", owner)
...
if not MYPY:
    class BucketReplicationConfigurationRuleDestinationMetricArgsDict(TypedDict):
    ...
    BucketReplicationConfigurationRuleDestinationMetricArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class BucketReplicationConfigurationRuleDestinationMetricArgs:
    def __init__(__self__, *,
                 minutes: Optional[pulumi.Input[builtins.int]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] minutes: Threshold within which objects are to be replicated. The only valid value is `15`.
        :param pulumi.Input[builtins.str] status: Status of replication metrics. Either `Enabled` or `Disabled`.
        """
...
class BucketReplicationConfigurationRuleDestinationReplicationTimeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] minutes: Threshold within which objects are to be replicated. The only valid value is `15`.
        :param pulumi.Input[builtins.str] status: Status of RTC. Either `Enabled` or `Disabled`.
        """
        if minutes is not None:
            pulumi.set(__self__, "minutes", minutes)
        if status is not None:
...
class BucketReplicationConfigurationRuleFilterArgs:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] prefix: Object keyname prefix that identifies subset of objects to which the rule applies. Must be less than or equal to 1024 characters in length.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags that identifies subset of objects to which the rule applies.
               The rule applies only to objects having all the tags in its tagset.
        """
        if prefix is not None:
            pulumi.set(__self__, "prefix", prefix)
...
if not MYPY:
    class BucketReplicationConfigurationRuleSourceSelectionCriteriaArgsDict(TypedDict):
        sse_kms_encrypted_objects: NotRequired[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgsDict']]]]
        """
...
class BucketReplicationConfigurationRuleSourceSelectionCriteriaArgs:
    def __init__(__self__, *,
                 sse_kms_encrypted_objects: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgs']]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgs']]] sse_kms_encrypted_objects: Match SSE-KMS encrypted objects (documented below). If specified, `replica_kms_key_id`
               in `destination` must be specified as well.
        """
        if sse_kms_encrypted_objects is not None:
            pulumi.set(__self__, "sse_kms_encrypted_objects", sse_kms_encrypted_objects)
    ...
    @property
    @pulumi.getter(name="sseKmsEncryptedObjects")
    def sse_kms_encrypted_objects(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgs']]]]:
        """
        Match SSE-KMS encrypted objects (documented below). If specified, `replica_kms_key_id`
        in `destination` must be specified as well.
        """
    ...
    @sse_kms_encrypted_objects.setter
    def sse_kms_encrypted_objects(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgs']]]]):
        pulumi.set(self, "sse_kms_encrypted_objects", value)


if not MYPY:
    class BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgsDict(TypedDict):
        enabled: pulumi.Input[builtins.bool]
        """
        Boolean which indicates if this criteria is enabled.
        """
elif False:
    BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class BucketReplicationConfigurationRuleSourceSelectionCriteriaSseKmsEncryptedObjectArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] enabled: Boolean which indicates if this criteria is enabled.
        """
        pulumi.set(__self__, "enabled", enabled)
...
if not MYPY:
    class BucketServerSideEncryptionConfigurationArgsDict(TypedDict):
        rules: pulumi.Input[Sequence[pulumi.Input['BucketServerSideEncryptionConfigurationRuleArgsDict']]]
        """
...
class BucketServerSideEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input['BucketServerSideEncryptionConfigurationRuleArgs']]] rules: Single object for server-side encryption by default configuration. (documented below)
        """
        pulumi.set(__self__, "rules", rules)
...
if not MYPY:
    class BucketServerSideEncryptionConfigurationRuleArgsDict(TypedDict):
        apply_server_side_encryption_by_defaults: pulumi.Input[Sequence[pulumi.Input['BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefaultArgsDict']]]
        """
...
class BucketServerSideEncryptionConfigurationRuleArgs:
    def __init__(__self__, *,
                 apply_server_side_encryption_by_defaults: pulumi.Input[Sequence[pulumi.Input['BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefaultArgs']]],
                 bucket_key_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefaultArgs']]] apply_server_side_encryption_by_defaults: Single object for setting server-side encryption by default. (documented below)
    ...
    def apply_server_side_encryption_by_defaults(self) -> pulumi.Input[Sequence[pulumi.Input['BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefaultArgs']]]:
        """
        Single object for setting server-side encryption by default. (documented below)
        """
    ...
    def apply_server_side_encryption_by_defaults(self, value: pulumi.Input[Sequence[pulumi.Input['BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefaultArgs']]]):
...
class BucketServerSideEncryptionConfigurationRuleApplyServerSideEncryptionByDefaultArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] sse_algorithm: Server-side encryption algorithm to use. Valid values are `AES256` and `aws:kms`
        :param pulumi.Input[builtins.str] kms_master_key_id: AWS KMS master key ID used for the SSE-KMS encryption. This can only be used when you set the value of `sse_algorithm` as `aws:kms`. The default `aws/s3` AWS KMS master key is used if this element is absent while the `sse_algorithm` is `aws:kms`.
        """
...
class BucketServerSideEncryptionConfigurationV2RuleApplyServerSideEncryptionByDefaultArgs:
    def __init__(__self__, *,
                 ...
                 kms_master_key_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] sse_algorithm: Server-side encryption algorithm to use. Valid values are `AES256`, `aws:kms`, and `aws:kms:dsse`
        :param pulumi.Input[builtins.str] kms_master_key_id: AWS KMS master key ID used for the SSE-KMS encryption. This can only be used when you set the value of `sse_algorithm` as `aws:kms`. The default `aws/s3` AWS KMS master key is used if this element is absent while the `sse_algorithm` is `aws:kms`.
        """
        pulumi.set(__self__, "sse_algorithm", sse_algorithm)
        if kms_master_key_id is not None:
...
if not MYPY:
    class BucketV2VersioningArgsDict(TypedDict):
        ...
        """
        mfa_delete: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BucketV2VersioningArgs:
    def __init__(__self__, *,
                 ...
                 mfa_delete: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] mfa_delete: Enable MFA delete for either `Change the versioning state of your bucket` or `Permanently delete an object version`. Default is `false`. This cannot be used to toggle this setting but is available to allow managed buckets to reflect the state in AWS
        """
    ...
    def mfa_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Enable MFA delete for either `Change the versioning state of your bucket` or `Permanently delete an object version`. Default is `false`. This cannot be used to toggle this setting but is available to allow managed buckets to reflect the state in AWS
        """
    ...
    @mfa_delete.setter
    def mfa_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BucketV2WebsiteArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] error_document: Absolute path to the document to return in case of a 4XX error.
        ...
        :param pulumi.Input[builtins.str] redirect_all_requests_to: Hostname to redirect all website requests for this bucket to. Hostname can optionally be prefixed with a protocol (`http://` or `https://`) to use when redirecting requests. The default is the protocol that is used in the original request.
        :param pulumi.Input[builtins.str] routing_rules: JSON array containing [routing rules](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-s3-websiteconfiguration-routingrules.html)
               describing redirect behavior and when redirects are applied.
        """
...
if not MYPY:
    class BucketVersioningV2VersioningConfigurationArgsDict(TypedDict):
        ...
        """
        mfa_delete: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketVersioningV2VersioningConfigurationArgs:
    def __init__(__self__, *,
                 status: pulumi.Input[builtins.str],
                 mfa_delete: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] status: Versioning state of the bucket. Valid values: `Enabled`, `Suspended`, or `Disabled`. `Disabled` should only be used when creating or importing resources that correspond to unversioned S3 buckets.
        :param pulumi.Input[builtins.str] mfa_delete: Specifies whether MFA delete is enabled in the bucket versioning configuration. Valid values: `Enabled` or `Disabled`.
        """
        pulumi.set(__self__, "status", status)
        if mfa_delete is not None:
            pulumi.set(__self__, "mfa_delete", mfa_delete)
    ...
    @property
    @pulumi.getter(name="mfaDelete")
    def mfa_delete(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies whether MFA delete is enabled in the bucket versioning configuration. Valid values: `Enabled` or `Disabled`.
        """
        return pulumi.get(self, "mfa_delete")
    ...
    @mfa_delete.setter
    def mfa_delete(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mfa_delete", value)
...
class BucketWebsiteConfigurationV2ErrorDocumentArgs:
    def __init__(__self__, *,
                 key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Object key name to use when a 4XX class error occurs.
        """
        pulumi.set(__self__, "key", key)
...
class BucketWebsiteConfigurationV2IndexDocumentArgs:
    def __init__(__self__, *,
                 suffix: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] suffix: Suffix that is appended to a request that is for a directory on the website endpoint.
               For example, if the suffix is `index.html` and you make a request to `samplebucket/images/`, the data that is returned will be for the object with the key name `images/index.html`.
               The suffix must not be empty and must not include a slash character.
        """
...
class BucketWebsiteConfigurationV2RedirectAllRequestsToArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host_name: Name of the host where requests are redirected.
        :param pulumi.Input[builtins.str] protocol: Protocol to use when redirecting requests. The default is the protocol that is used in the original request. Valid values: `http`, `https`.
        """
...
class BucketWebsiteConfigurationV2RoutingRuleConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] http_error_code_returned_equals: HTTP error code when the redirect is applied. If specified with `key_prefix_equals`, then both must be true for the redirect to be applied.
        :param pulumi.Input[builtins.str] key_prefix_equals: Object key name prefix when the redirect is applied. If specified with `http_error_code_returned_equals`, then both must be true for the redirect to be applied.
        """
...
class BucketWebsiteConfigurationV2RoutingRuleRedirectArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host_name: Host name to use in the redirect request.
        :param pulumi.Input[builtins.str] http_redirect_code: HTTP redirect code to use on the response.
        :param pulumi.Input[builtins.str] protocol: Protocol to use when redirecting requests. The default is the protocol that is used in the original request. Valid values: `http`, `https`.
        :param pulumi.Input[builtins.str] replace_key_prefix_with: Object key prefix to use in the redirect request. For example, to redirect requests for all pages with prefix `docs/` (objects in the `docs/` folder) to `documents/`, you can set a `condition` block with `key_prefix_equals` set to `docs/` and in the `redirect` set `replace_key_prefix_with` to `/documents`.
        :param pulumi.Input[builtins.str] replace_key_with: Specific object key to use in the redirect request. For example, redirect request to `error.html`.
        """
...
class DirectoryBucketLocationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: [Availability Zone ID](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#az-ids) or Local Zone ID.
        :param pulumi.Input[builtins.str] type: Location type. Valid values: `AvailabilityZone`, `LocalZone`.
        """
...
class InventoryDestinationBucketArgs:
    def __init__(__self__, *,
                 ...
                 prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bucket_arn: Amazon S3 bucket ARN of the destination.
        :param pulumi.Input[builtins.str] format: Specifies the output format of the inventory results. Can be `CSV`, [`ORC`](https://orc.apache.org/) or [`Parquet`](https://parquet.apache.org/).
        :param pulumi.Input[builtins.str] account_id: ID of the account that owns the destination bucket. Recommended to be set to prevent problems if the destination bucket ownership changes.
        ...
        :param pulumi.Input[builtins.str] prefix: Prefix that is prepended to all inventory results.
        """
        pulumi.set(__self__, "bucket_arn", bucket_arn)
        pulumi.set(__self__, "format", format)
        if account_id is not None:
...
class InventoryDestinationBucketEncryptionSseKmsArgs:
    def __init__(__self__, *,
                 key_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key_id: ARN of the KMS customer master key (CMK) used to encrypt the inventory file.
        """
...
class InventoryFilterArgs:
    def __init__(__self__, *,
                 prefix: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] prefix: Prefix that an object must have to be included in the inventory results.
        """
        if prefix is not None:
            pulumi.set(__self__, "prefix", prefix)
...
class InventoryScheduleArgs:
    def __init__(__self__, *,
                 frequency: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] frequency: Specifies how frequently inventory results are produced. Valid values: `Daily`, `Weekly`.
        """
...
class ObjectCopyGrantArgs:
    def __init__(__self__, *,
                 ...
                 uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] permissions: List of permissions to grant to grantee. Valid values are `READ`, `READ_ACP`, `WRITE_ACP`, `FULL_CONTROL`.
        :param pulumi.Input[builtins.str] type: Type of grantee. Valid values are `CanonicalUser`, `Group`, and `AmazonCustomerByEmail`.
               
               This configuration block has the following optional arguments (one of the three is required):
        :param pulumi.Input[builtins.str] email: Email address of the grantee. Used only when `type` is `AmazonCustomerByEmail`.
        :param pulumi.Input[builtins.str] id: Canonical user ID of the grantee. Used only when `type` is `CanonicalUser`.
        :param pulumi.Input[builtins.str] uri: URI of the grantee group. Used only when `type` is `Group`.
        """
        pulumi.set(__self__, "permissions", permissions)
        pulumi.set(__self__, "type", type)
