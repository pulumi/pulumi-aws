...
class GetObjectResult:
    ...
    def checksum_crc32c(self) -> builtins.str:
        """
    ...
    def checksum_crc64nvme(self) -> builtins.str:
        """
    ...
    def checksum_mode(self) -> Optional[builtins.str]:
...
def get_object(bucket: Optional[builtins.str] = None,
               checksum_mode: Optional[builtins.str] = None,
...
def get_object_output(bucket: Optional[pulumi.Input[builtins.str]] = None,
                      checksum_mode: Optional[pulumi.Input[Optional[builtins.str]]] = None,
