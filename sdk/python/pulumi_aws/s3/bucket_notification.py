...
class BucketNotificationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: Name of the bucket for notification configuration.
    ...
    @property
    @pulumi.getter
    def eventbridge(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @eventbridge.setter
    def eventbridge(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BucketNotification(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def eventbridge(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable Amazon EventBridge notifications. Defaults to `false`.
        """
        return pulumi.get(self, "eventbridge")
