...
class BucketV2Args:
    def __init__(__self__, *,
                 ...
                 cors_rules: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2CorsRuleArgs']]]] = None,
                 force_destroy: pulumi.Input[Optional[_builtins.bool]] = None,
                 grants: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2GrantArgs']]]] = None,
                 lifecycle_rules: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2LifecycleRuleArgs']]]] = None,
                 loggings: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2LoggingArgs']]]] = None,
                 object_lock_configuration: pulumi.Input[Optional['BucketV2ObjectLockConfigurationArgs']] = None,
                 object_lock_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 policy: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 replication_configurations: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2ReplicationConfigurationArgs']]]] = None,
                 request_payer: pulumi.Input[Optional[_builtins.str]] = None,
                 server_side_encryption_configurations: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2ServerSideEncryptionConfigurationArgs']]]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 versionings: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2VersioningArgs']]]] = None,
                 websites: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2WebsiteArgs']]]] = None):
        """
        The set of arguments for constructing a BucketV2 resource.

        :param pulumi.Input[_builtins.str] acceleration_status: Sets the accelerate configuration of an existing bucket. Can be `Enabled` or `Suspended`. Cannot be used in `cn-north-1` or `us-gov-west-1`. This provider will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketAccelerateConfiguration` instead.
        :param pulumi.Input[_builtins.str] acl: [Canned ACL](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#canned-acl) to apply. Valid values are `private`, `public-read`, `public-read-write`, `aws-exec-read`, `authenticated-read`, and `log-delivery-write`. Defaults to `private`. Conflicts with `grant`. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketAcl` instead.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2CorsRuleArgs']]] cors_rules: Rule of [Cross-Origin Resource Sharing](https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html). See `cors_rule` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketCorsConfiguration` instead.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2GrantArgs']]] grants: [ACL policy grant](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#sample-acl). See `grant` Block below for details. Conflicts with `acl`. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketAcl` instead.
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2LifecycleRuleArgs']]] lifecycle_rules: Configuration of [object lifecycle management](http://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html). See `lifecycle_rule` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketLifecycleConfiguration` instead.
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2LoggingArgs']]] loggings: Configuration of [S3 bucket logging](https://docs.aws.amazon.com/AmazonS3/latest/UG/ManagingBucketLogging.html) parameters. See `logging` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketLogging` instead.
        :param pulumi.Input['BucketV2ObjectLockConfigurationArgs'] object_lock_configuration: Configuration of [S3 object locking](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html). See `object_lock_configuration` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the `object_lock_enabled` parameter and the resource `s3.BucketObjectLockConfiguration` instead.
        :param pulumi.Input[_builtins.bool] object_lock_enabled: Whether this bucket has an Object Lock configuration enabled. Valid values are `true` or `false`. This argument is not supported in all regions or partitions.
        :param pulumi.Input[_builtins.str] policy: Valid [bucket policy](https://docs.aws.amazon.com/AmazonS3/latest/dev/example-bucket-policies.html) JSON document. Note that if the policy document is not specific enough (but still valid), this provider may view the policy as constantly changing. In this case, please make sure you use the verbose/specific version of the policy. For more information about building AWS IAM policy documents with this provider, see the AWS IAM Policy Document Guide. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketPolicy` instead.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2ReplicationConfigurationArgs']]] replication_configurations: Configuration of [replication configuration](http://docs.aws.amazon.com/AmazonS3/latest/dev/crr.html). See `replication_configuration` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketReplicationConfig` instead.
        :param pulumi.Input[_builtins.str] request_payer: Who should bear the cost of Amazon S3 data transfer. Can be either `BucketOwner` or `Requester`. By default, the owner of the S3 bucket would incur the costs of any data transfer. See [Requester Pays Buckets](http://docs.aws.amazon.com/AmazonS3/latest/dev/RequesterPaysBuckets.html) developer guide for more information. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketRequestPaymentConfiguration` instead.
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2ServerSideEncryptionConfigurationArgs']]] server_side_encryption_configurations: Configuration of [server-side encryption configuration](http://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html). See `server_side_encryption_configuration` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketServerSideEncryptionConfiguration` instead.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2VersioningArgs']]] versionings: Configuration of the [S3 bucket versioning state](https://docs.aws.amazon.com/AmazonS3/latest/dev/Versioning.html). See `versioning` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketVersioning` instead.
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2WebsiteArgs']]] websites: Configuration of the [S3 bucket website](https://docs.aws.amazon.com/AmazonS3/latest/userguide/WebsiteHosting.html). See `website` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketWebsiteConfiguration` instead.
        """
    ...
    def cors_rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2CorsRuleArgs']]]]:
        """
        Rule of [Cross-Origin Resource Sharing](https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html). See `cors_rule` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketCorsConfiguration` instead.
        """
        return pulumi.get(self, "cors_rules")

    @cors_rules.setter
    def cors_rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2CorsRuleArgs']]]]):
    ...
    def grants(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2GrantArgs']]]]:
        """
        [ACL policy grant](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#sample-acl). See `grant` Block below for details. Conflicts with `acl`. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketAcl` instead.
        """
        return pulumi.get(self, "grants")

    @grants.setter
    def grants(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2GrantArgs']]]]):
        pulumi.set(self, "grants", value)

    @_builtins.property
    @pulumi.getter(name="lifecycleRules")
    @_utilities.deprecated("""lifecycle_rule is deprecated. Use the s3.BucketLifecycleConfiguration resource instead.""")
    def lifecycle_rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2LifecycleRuleArgs']]]]:
        """
        Configuration of [object lifecycle management](http://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html). See `lifecycle_rule` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketLifecycleConfiguration` instead.
        """
        return pulumi.get(self, "lifecycle_rules")

    @lifecycle_rules.setter
    def lifecycle_rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2LifecycleRuleArgs']]]]):
    ...
    def loggings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2LoggingArgs']]]]:
        """
        Configuration of [S3 bucket logging](https://docs.aws.amazon.com/AmazonS3/latest/UG/ManagingBucketLogging.html) parameters. See `logging` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketLogging` instead.
        """
        return pulumi.get(self, "loggings")

    @loggings.setter
    def loggings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2LoggingArgs']]]]):
    ...
    def object_lock_configuration(self) -> pulumi.Input[Optional['BucketV2ObjectLockConfigurationArgs']]:
        """
    ...
    def object_lock_configuration(self, value: pulumi.Input[Optional['BucketV2ObjectLockConfigurationArgs']]):
    ...
    def replication_configurations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2ReplicationConfigurationArgs']]]]:
        """
        Configuration of [replication configuration](http://docs.aws.amazon.com/AmazonS3/latest/dev/crr.html). See `replication_configuration` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketReplicationConfig` instead.
        """
        return pulumi.get(self, "replication_configurations")

    @replication_configurations.setter
    def replication_configurations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2ReplicationConfigurationArgs']]]]):
    ...
    def server_side_encryption_configurations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2ServerSideEncryptionConfigurationArgs']]]]:
        """
        Configuration of [server-side encryption configuration](http://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html). See `server_side_encryption_configuration` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketServerSideEncryptionConfiguration` instead.
        """
    ...
    def server_side_encryption_configurations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2ServerSideEncryptionConfigurationArgs']]]]):
    ...
    def versionings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2VersioningArgs']]]]:
        """
        Configuration of the [S3 bucket versioning state](https://docs.aws.amazon.com/AmazonS3/latest/dev/Versioning.html). See `versioning` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketVersioning` instead.
        """
        return pulumi.get(self, "versionings")

    @versionings.setter
    def versionings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2VersioningArgs']]]]):
    ...
    def websites(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2WebsiteArgs']]]]:
        """
        Configuration of the [S3 bucket website](https://docs.aws.amazon.com/AmazonS3/latest/userguide/WebsiteHosting.html). See `website` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketWebsiteConfiguration` instead.
        """
        return pulumi.get(self, "websites")

    @websites.setter
    def websites(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2WebsiteArgs']]]]):
...
class _BucketV2State:
    def __init__(__self__, *,
                 ...
                 bucket_regional_domain_name: pulumi.Input[Optional[_builtins.str]] = None,
                 cors_rules: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2CorsRuleArgs']]]] = None,
                 force_destroy: pulumi.Input[Optional[_builtins.bool]] = None,
                 grants: pulumi.Input[Optional[Sequence[pulumi.Input['BucketV2GrantArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] bucket_regional_domain_name: Bucket region-specific domain name. The bucket domain name including the region name. Please refer to the [S3 endpoints reference](https://docs.aws.amazon.com/general/latest/gr/s3.html#s3_region) for format. Note: AWS CloudFront allows specifying an S3 region-specific endpoint when creating an S3 origin. This will prevent redirect issues from CloudFront to the S3 Origin URL. For more information, see the [Virtual Hosted-Style Requests for Other Regions](https://docs.aws.amazon.com/AmazonS3/latest/userguide/VirtualHosting.html#deprecated-global-endpoint) section in the AWS S3 User Guide.
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2CorsRuleArgs']]] cors_rules: Rule of [Cross-Origin Resource Sharing](https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html). See `cors_rule` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketCorsConfiguration` instead.
        :param pulumi.Input[_builtins.bool] force_destroy: Boolean that indicates all objects (including any [locked objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock-overview.html)) should be deleted from the bucket *when the bucket is destroyed* so that the bucket can be destroyed without error. These objects are *not* recoverable. This only deletes objects when the bucket is destroyed, *not* when setting this parameter to `true`. Once this parameter is set to `true`, there must be a successful `pulumi up` run before a destroy is required to update this value in the resource state. Without a successful `pulumi up` after this parameter is set, this flag will have no effect. If setting this field in the same operation that would require replacing the bucket or destroying the bucket, this flag will not work. Additionally when importing a bucket, a successful `pulumi up` is required to set this value in state before it will take effect on a destroy operation.
        :param pulumi.Input[Sequence[pulumi.Input['BucketV2GrantArgs']]] grants: [ACL policy grant](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#sample-acl). See `grant` Block below for details. Conflicts with `acl`. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketAcl` instead.
    ...
    def bucket_regional_domain_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def bucket_regional_domain_name(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class BucketV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 bucket_namespace: pulumi.Input[Optional[_builtins.str]] = None,
                 bucket_prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 cors_rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketV2CorsRuleArgs', 'BucketV2CorsRuleArgsDict']]]]] = None,
                 force_destroy: pulumi.Input[Optional[_builtins.bool]] = None,
                 grants: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketV2GrantArgs', 'BucketV2GrantArgsDict']]]]] = None,
                 lifecycle_rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketV2LifecycleRuleArgs', 'BucketV2LifecycleRuleArgsDict']]]]] = None,
                 loggings: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketV2LoggingArgs', 'BucketV2LoggingArgsDict']]]]] = None,
                 object_lock_configuration: pulumi.Input[Optional[Union['BucketV2ObjectLockConfigurationArgs', 'BucketV2ObjectLockConfigurationArgsDict']]] = None,
                 object_lock_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 policy: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 replication_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketV2ReplicationConfigurationArgs', 'BucketV2ReplicationConfigurationArgsDict']]]]] = None,
                 request_payer: pulumi.Input[Optional[_builtins.str]] = None,
                 server_side_encryption_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketV2ServerSideEncryptionConfigurationArgs', 'BucketV2ServerSideEncryptionConfigurationArgsDict']]]]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 versionings: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketV2VersioningArgs', 'BucketV2VersioningArgsDict']]]]] = None,
                 websites: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketV2WebsiteArgs', 'BucketV2WebsiteArgsDict']]]]] = None,
                 __props__=None):
        """
        ...
        > Object Lock can be enabled by using the `object_lock_enabled` attribute or by using the `s3.BucketObjectLockConfiguration` resource. Please note, that by using the resource, Object Lock can be enabled/disabled without destroying and recreating the bucket.
        ...
        * `region` (String) Region where this resource is managed.
        ...
        :param pulumi.Input[_builtins.str] bucket_namespace: Namespace for the bucket. Determines bucket naming scope. Valid values: `account-regional`, `global`. Defaults to `global` (AWS).
        :param pulumi.Input[_builtins.str] bucket_prefix: Creates a unique bucket name beginning with the specified prefix. Conflicts with `bucket`. Must be lowercase and less than or equal to 37 characters in length. A full list of bucket naming rules [may be found here](https://docs.aws.amazon.com/AmazonS3/latest/userguide/bucketnamingrules.html).
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketV2CorsRuleArgs', 'BucketV2CorsRuleArgsDict']]]] cors_rules: Rule of [Cross-Origin Resource Sharing](https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html). See `cors_rule` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketCorsConfiguration` instead.
        :param pulumi.Input[_builtins.bool] force_destroy: Boolean that indicates all objects (including any [locked objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock-overview.html)) should be deleted from the bucket *when the bucket is destroyed* so that the bucket can be destroyed without error. These objects are *not* recoverable. This only deletes objects when the bucket is destroyed, *not* when setting this parameter to `true`. Once this parameter is set to `true`, there must be a successful `pulumi up` run before a destroy is required to update this value in the resource state. Without a successful `pulumi up` after this parameter is set, this flag will have no effect. If setting this field in the same operation that would require replacing the bucket or destroying the bucket, this flag will not work. Additionally when importing a bucket, a successful `pulumi up` is required to set this value in state before it will take effect on a destroy operation.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketV2GrantArgs', 'BucketV2GrantArgsDict']]]] grants: [ACL policy grant](https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html#sample-acl). See `grant` Block below for details. Conflicts with `acl`. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketAcl` instead.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketV2LifecycleRuleArgs', 'BucketV2LifecycleRuleArgsDict']]]] lifecycle_rules: Configuration of [object lifecycle management](http://docs.aws.amazon.com/AmazonS3/latest/dev/object-lifecycle-mgmt.html). See `lifecycle_rule` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketLifecycleConfiguration` instead.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketV2LoggingArgs', 'BucketV2LoggingArgsDict']]]] loggings: Configuration of [S3 bucket logging](https://docs.aws.amazon.com/AmazonS3/latest/UG/ManagingBucketLogging.html) parameters. See `logging` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketLogging` instead.
        :param pulumi.Input[Union['BucketV2ObjectLockConfigurationArgs', 'BucketV2ObjectLockConfigurationArgsDict']] object_lock_configuration: Configuration of [S3 object locking](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html). See `object_lock_configuration` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the `object_lock_enabled` parameter and the resource `s3.BucketObjectLockConfiguration` instead.
        :param pulumi.Input[_builtins.bool] object_lock_enabled: Whether this bucket has an Object Lock configuration enabled. Valid values are `true` or `false`. This argument is not supported in all regions or partitions.
        :param pulumi.Input[_builtins.str] policy: Valid [bucket policy](https://docs.aws.amazon.com/AmazonS3/latest/dev/example-bucket-policies.html) JSON document. Note that if the policy document is not specific enough (but still valid), this provider may view the policy as constantly changing. In this case, please make sure you use the verbose/specific version of the policy. For more information about building AWS IAM policy documents with this provider, see the AWS IAM Policy Document Guide. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketPolicy` instead.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketV2ReplicationConfigurationArgs', 'BucketV2ReplicationConfigurationArgsDict']]]] replication_configurations: Configuration of [replication configuration](http://docs.aws.amazon.com/AmazonS3/latest/dev/crr.html). See `replication_configuration` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketReplicationConfig` instead.
        :param pulumi.Input[_builtins.str] request_payer: Who should bear the cost of Amazon S3 data transfer. Can be either `BucketOwner` or `Requester`. By default, the owner of the S3 bucket would incur the costs of any data transfer. See [Requester Pays Buckets](http://docs.aws.amazon.com/AmazonS3/latest/dev/RequesterPaysBuckets.html) developer guide for more information. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketRequestPaymentConfiguration` instead.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketV2ServerSideEncryptionConfigurationArgs', 'BucketV2ServerSideEncryptionConfigurationArgsDict']]]] server_side_encryption_configurations: Configuration of [server-side encryption configuration](http://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html). See `server_side_encryption_configuration` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketServerSideEncryptionConfiguration` instead.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Map of tags to assign to the bucket. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags_all: Map of tags assigned to the resource, including those inherited from the provider `default_tags` configuration block.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketV2VersioningArgs', 'BucketV2VersioningArgsDict']]]] versionings: Configuration of the [S3 bucket versioning state](https://docs.aws.amazon.com/AmazonS3/latest/dev/Versioning.html). See `versioning` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketVersioning` instead.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BucketV2WebsiteArgs', 'BucketV2WebsiteArgsDict']]]] websites: Configuration of the [S3 bucket website](https://docs.aws.amazon.com/AmazonS3/latest/userguide/WebsiteHosting.html). See `website` Block below for details. Terraform will only perform drift detection if a configuration value is provided. Use the resource `s3.BucketWebsiteConfiguration` instead.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            website_domain: pulumi.Input[Optional[_builtins.str]] = None,
            website_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
            websites: pulumi.Input[Optional[Sequence[pulumi.Input[Union['BucketV2WebsiteArgs', 'BucketV2WebsiteArgsDict']]]]] = None) -> 'BucketV2':
        """
