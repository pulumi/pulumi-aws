...
class BucketIntelligentTieringConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if filter is not None and not isinstance(filter, BucketIntelligentTieringConfigurationFilterArgs):
                filter = filter or {}
                def _setter(key, value):
                    filter[key] = value
                BucketIntelligentTieringConfigurationFilterArgs._configure(_setter, **filter)
