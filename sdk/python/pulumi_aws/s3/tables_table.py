...
__all__ = ['TablesTableArgs', 'TablesTable']

@pulumi.input_type
class TablesTableArgs:
    def __init__(__self__, *,
                 format: pulumi.Input[str],
                 namespace: pulumi.Input[str],
                 table_bucket_arn: pulumi.Input[str],
                 maintenance_configuration: Optional[pulumi.Input['TablesTableMaintenanceConfigurationArgs']] = None,
        ...
        :param pulumi.Input['TablesTableMaintenanceConfigurationArgs'] maintenance_configuration: A single table bucket maintenance configuration block.
    ...
    def maintenance_configuration(self) -> Optional[pulumi.Input['TablesTableMaintenanceConfigurationArgs']]:
        """
    ...
    def maintenance_configuration(self, value: Optional[pulumi.Input['TablesTableMaintenanceConfigurationArgs']]):
...
class TablesTable(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 opts: Optional[pulumi.ResourceOptions] = None,
                 format: Optional[pulumi.Input[str]] = None,
                 maintenance_configuration: Optional[pulumi.Input[Union['TablesTableMaintenanceConfigurationArgs', 'TablesTableMaintenanceConfigurationArgsDict']]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 namespace: Optional[pulumi.Input[str]] = None,
                 table_bucket_arn: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        ...
        example_tables_table_bucket = aws.s3.TablesTableBucket("example", name="example-bucket")
        example_tables_namespace = aws.s3.TablesNamespace("example",
            namespace="example-namespace",
            table_bucket_arn=example_tables_table_bucket.arn)
        example = aws.s3.TablesTable("example",
            name="example-table",
            namespace=example_tables_namespace,
            table_bucket_arn=example_tables_namespace.table_bucket_arn,
            format="ICEBERG")
        ```
        ...
        :param pulumi.Input[str] format: Format of the table.
               Must be `ICEBERG`.
        :param pulumi.Input[Union['TablesTableMaintenanceConfigurationArgs', 'TablesTableMaintenanceConfigurationArgsDict']] maintenance_configuration: A single table bucket maintenance configuration block.
               See `maintenance_configuration` below
        :param pulumi.Input[str] name: Name of the table.
               Must be between 1 and 255 characters in length.
               Can consist of lowercase letters, numbers, and underscores, and must begin and end with a lowercase letter or number.
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TablesTableArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TablesTableArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TablesTableArgs.__new__(TablesTableArgs)
        ...
        super(TablesTable, __self__).__init__(
            'aws:s3/tablesTable:TablesTable',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[str]] = None,
            version_token: Optional[pulumi.Input[str]] = None,
            warehouse_location: Optional[pulumi.Input[str]] = None) -> 'TablesTable':
        """
        ...
        __props__ = _TablesTableState.__new__(_TablesTableState)
        ...
        return TablesTable(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="maintenanceConfiguration")
    def maintenance_configuration(self) -> pulumi.Output['outputs.TablesTableMaintenanceConfiguration']:
        """
        A single table bucket maintenance configuration block.
        See `maintenance_configuration` below
        """
