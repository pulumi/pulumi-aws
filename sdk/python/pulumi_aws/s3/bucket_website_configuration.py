...
class BucketWebsiteConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        alias_opts = pulumi.ResourceOptions(aliases=[pulumi.Alias(type_="aws:s3/bucketWebsiteConfiguration:BucketWebsiteConfiguration"), pulumi.Alias(type_="aws:s3/bucketWebsiteConfigurationV2:BucketWebsiteConfigurationV2")])
