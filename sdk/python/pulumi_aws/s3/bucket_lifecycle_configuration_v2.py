...
class BucketLifecycleConfigurationV2(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * One or more transition or expiration actions
        ...
        example = aws.s3.bucket_lifecycle_configuration_v2.BucketLifecycleConfigurationV2("example",
        ...
        bucket_acl = aws.s3.bucket_acl_v2.BucketAclV2("bucketAcl",
            bucket=bucket.id,
            acl=private)
        bucket_config = aws.s3.bucket_lifecycle_configuration_v2.BucketLifecycleConfigurationV2("bucket-config",
            bucket=bucket.id,
            rules=[
                {
                    id: log,
        ...
        versioning_bucket = aws.s3.bucket_v2.BucketV2("versioningBucket")
        versioning_bucket_acl = aws.s3.bucket_acl_v2.BucketAclV2("versioningBucketAcl",
            bucket=versioning_bucket.id,
            acl=private)
        versioning = aws.s3.bucket_versioning_v2.BucketVersioningV2("versioning",
            bucket=versioning_bucket.id,
            versioning_configuration={
                status: Enabled,
            })
        versioning_bucket_config = aws.s3.bucket_lifecycle_configuration_v2.BucketLifecycleConfigurationV2("versioning-bucket-config",
            bucket=versioning_bucket.id,
            rules=[{
                id: config,
                filter: {
