...
class BucketReplicationConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        # ... other configuration ...
        east_bucket_v2 = aws.s3.bucket_v2.BucketV2("eastBucketV2")
        east_bucket_versioning_v2 = aws.s3.bucket_versioning_v2.BucketVersioningV2("eastBucketVersioningV2",
            bucket=east_bucket_v2.id,
            versioning_configuration={
                status: Enabled,
            })
        west_bucket_v2 = aws.s3.bucket_v2.BucketV2("westBucketV2", opts=pulumi.ResourceOptions(provider=aws["west"]))
        west_bucket_versioning_v2 = aws.s3.bucket_versioning_v2.BucketVersioningV2("westBucketVersioningV2",
            bucket=west_bucket_v2.id,
            versioning_configuration={
                status: Enabled,
            },
            opts=pulumi.ResourceOptions(provider=aws["west"]))
        east_to_west = aws.s3.bucket_replication_config.BucketReplicationConfig("eastToWest",
        ...
        west_to_east = aws.s3.bucket_replication_config.BucketReplicationConfig("westToEast",
