...
class BucketAccelerateConfigurationV2Args:
    def __init__(__self__, *,
        ...
        """
        BucketAccelerateConfigurationV2Args._configure(
...
class _BucketAccelerateConfigurationV2State:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] status: Transfer acceleration state of the bucket. Valid values: `Enabled`, `Suspended`.
        """
        _BucketAccelerateConfigurationV2State._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            bucket=bucket,
            expected_bucket_owner=expected_bucket_owner,
            status=status,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            BucketAccelerateConfigurationV2Args._configure(_setter, **kwargs)
