...
__all__ = ['BucketPolicyArrgs', 'BucketPolicy']

@pulumi.input_type
calass BucketPolicyArrgs:
...
calass BucketPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        allow_access_from_another_account_policy_document = aws.iam.get_policy_document_output(statements=[aws.iam.GetPolicyDocumentStatementArrgs(
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param BucketPolicyArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BucketPolicyArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BucketPolicyArrgs.__new__(BucketPolicyArrgs)
