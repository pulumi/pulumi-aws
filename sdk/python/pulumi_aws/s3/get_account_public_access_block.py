...
def get_account_public_access_block(account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_id: AWS account ID to configure. Defaults to automatically determined account ID of the AWS provider.
    """
    __args__ = dict()
...
def get_account_public_access_block_output(account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
