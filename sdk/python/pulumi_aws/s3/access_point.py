...
class AccessPointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: Name of an AWS Partition S3 General Purpose Bucket or the ARN of S3 on Outposts Bucket that you want to associate this access point with.
        :param pulumi.Input[builtins.str] account_id: AWS account ID for the owner of the bucket for which you want to create an access point. Defaults to automatically determined account ID of the AWS provider.
        :param pulumi.Input[builtins.str] bucket_account_id: AWS account ID associated with the S3 bucket associated with this access point.
        :param pulumi.Input[builtins.str] name: Name you want to assign to this access point. See the [AWS documentation](https://docs.aws.amazon.com/AmazonS3/latest/userguide/creating-access-points.html?icmpid=docs_amazons3_console#access-points-names) for naming conditions.
...
class _AccessPointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: AWS account ID for the owner of the bucket for which you want to create an access point. Defaults to automatically determined account ID of the AWS provider.
        :param pulumi.Input[builtins.str] alias: Alias of the S3 Access Point.
        :param pulumi.Input[builtins.str] arn: ARN of the S3 Access Point.
        :param pulumi.Input[builtins.str] bucket: Name of an AWS Partition S3 General Purpose Bucket or the ARN of S3 on Outposts Bucket that you want to associate this access point with.
        :param pulumi.Input[builtins.str] bucket_account_id: AWS account ID associated with the S3 bucket associated with this access point.
        :param pulumi.Input[builtins.str] domain_name: DNS domain name of the S3 Access Point in the format _`name`_-_`account_id`_.s3-accesspoint._region_.amazonaws.com.
               Note: S3 access points only support secure access by HTTPS. HTTP isn't supported.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] endpoints: VPC endpoints for the S3 Access Point.
...
class AccessPoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="bucketAccountId")
    def bucket_account_id(self) -> pulumi.Output[builtins.str]:
        """
        AWS account ID associated with the S3 bucket associated with this access point.
        """
        return pulumi.get(self, "bucket_account_id")
    ...
    @property
    @pulumi.getter
    def endpoints(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        VPC endpoints for the S3 Access Point.
        """
        return pulumi.get(self, "endpoints")
