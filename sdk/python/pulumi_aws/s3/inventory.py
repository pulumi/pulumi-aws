...
class InventoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Specifies whether the inventory is enabled or disabled.
...
class Inventory(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="optionalFields")
    def optional_fields(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of optional fields that are included in the inventory results. Please refer to the S3 [documentation](https://docs.aws.amazon.com/AmazonS3/latest/API/API_InventoryConfiguration.html#AmazonS3-Type-InventoryConfiguration-OptionalFields) for more details.
        """
        return pulumi.get(self, "optional_fields")
