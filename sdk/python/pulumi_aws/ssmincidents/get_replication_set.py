...
class GetReplicationSetResult:
    ...
    def deletion_protected(self) -> builtins.bool:
        """
...
def get_replication_set(tags: Optional[Mapping[str, builtins.str]] = None,
    ...
    :param Mapping[str, builtins.str] tags: All tags applied to the replication set.
    """
    __args__ = dict()
    __args__['tags'] = tags
...
def get_replication_set_output(tags: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
