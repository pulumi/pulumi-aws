...
class ReplicationSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Tags applied to the replication set.
...
class _ReplicationSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the replication set.
    ...
    def deletion_protected(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def deletion_protected(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "deletion_protected", value)

    @property
    @pulumi.getter(name="lastModifiedBy")
    def last_modified_by(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_modified_by(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ReplicationSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ReplicationSet':
        """
    ...
    @property
    @pulumi.getter(name="deletionProtected")
    def deletion_protected(self) -> pulumi.Output[builtins.bool]:
        """
        If `true`, the last region in a replication set cannot be deleted.
        """
        return pulumi.get(self, "deletion_protected")
