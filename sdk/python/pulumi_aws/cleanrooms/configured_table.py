...
class ConfiguredTableArgs:
    def __init__(__self__, *,
                 ...
                 analysis_method: pulumi.Input[builtins.str],
    ...
    def analysis_method(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def analysis_method(self, value: pulumi.Input[builtins.str]):
...
class _ConfiguredTableState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_columns: The columns of the references table which will be included in the configured table.
        :param pulumi.Input[builtins.str] analysis_method: The analysis method for the configured table. The only valid value is currently `DIRECT_QUERY`.
        :param pulumi.Input[builtins.str] arn: The ARN of the configured table.
        ...
        :param pulumi.Input['ConfiguredTableTableReferenceArgs'] table_reference: A reference to the AWS Glue table which will be used to create the configured table.
               ...
               * `table_reference.table_name` - (Required - Forces new resource) - The name of the AWS Glue table which will be used to create the configured table.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Key value pairs which tag the configured table.
        :param pulumi.Input[builtins.str] update_time: The date and time the configured table was last updated.
        """
    ...
    @property
    @pulumi.getter(name="allowedColumns")
    def allowed_columns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The columns of the references table which will be included in the configured table.
        """
        return pulumi.get(self, "allowed_columns")
    ...
    @allowed_columns.setter
    def allowed_columns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_columns", value)

    @property
    @pulumi.getter(name="analysisMethod")
    def analysis_method(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The analysis method for the configured table. The only valid value is currently `DIRECT_QUERY`.
        """
        return pulumi.get(self, "analysis_method")
    ...
    @analysis_method.setter
    def analysis_method(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "analysis_method", value)
...
class ConfiguredTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            update_time: Optional[pulumi.Input[builtins.str]] = None) -> 'ConfiguredTable':
        """
    ...
    @property
    @pulumi.getter(name="analysisMethod")
    def analysis_method(self) -> pulumi.Output[builtins.str]:
        """
        The analysis method for the configured table. The only valid value is currently `DIRECT_QUERY`.
        """
        return pulumi.get(self, "analysis_method")
