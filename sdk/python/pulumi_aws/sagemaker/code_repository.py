...
class CodeRepositoryArgs:
    def __init__(__self__, *,
                 code_repository_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] code_repository_name: The name of the Code Repository (must be unique).
    ...
    def code_repository_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def code_repository_name(self, value: pulumi.Input[builtins.str]):
...
class _CodeRepositoryState:
    def __init__(__self__, *,
                 ...
                 code_repository_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) assigned by AWS to this Code Repository.
        :param pulumi.Input[builtins.str] code_repository_name: The name of the Code Repository (must be unique).
        :param pulumi.Input['CodeRepositoryGitConfigArgs'] git_config: Specifies details about the repository. see Git Config details below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the resource. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    @property
    @pulumi.getter(name="codeRepositoryName")
    def code_repository_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Code Repository (must be unique).
        """
        return pulumi.get(self, "code_repository_name")
    ...
    @code_repository_name.setter
    def code_repository_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "code_repository_name", value)
...
class CodeRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            git_config: Optional[pulumi.Input[Union['CodeRepositoryGitConfigArgs', 'CodeRepositoryGitConfigArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'CodeRepository':
        """
    ...
    @property
    @pulumi.getter(name="codeRepositoryName")
    def code_repository_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Code Repository (must be unique).
        """
        return pulumi.get(self, "code_repository_name")
