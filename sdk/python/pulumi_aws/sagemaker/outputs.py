...
class AppImageConfigCodeEditorAppImageConfigContainerConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 container_entrypoints: Optional[Sequence[builtins.str]] = None,
                 container_environment_variables: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Sequence[builtins.str] container_arguments: The arguments for the container when you're running the application.
        :param Sequence[builtins.str] container_entrypoints: The entrypoint used to run the application in the container.
        :param Mapping[str, builtins.str] container_environment_variables: The environment variables to set in the container.
        """
    ...
    def container_entrypoints(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def container_environment_variables(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class AppImageConfigCodeEditorAppImageConfigFileSystemConfig(dict):
    ...
    def __init__(__self__, *,
                 default_gid: Optional[builtins.int] = None,
                 default_uid: Optional[builtins.int] = None,
                 mount_path: Optional[builtins.str] = None):
        """
        :param builtins.int default_gid: The default POSIX group ID (GID). If not specified, defaults to `100`. Valid values are `0` and `100`.
        :param builtins.int default_uid: The default POSIX user ID (UID). If not specified, defaults to `1000`. Valid values are `0` and `1000`.
        :param builtins.str mount_path: The path within the image to mount the user's EFS home directory. The directory should be empty. If not specified, defaults to `/home/sagemaker-user`.
    ...
    def default_gid(self) -> Optional[builtins.int]:
        """
    ...
    def default_uid(self) -> Optional[builtins.int]:
        """
...
class AppImageConfigKernelGatewayImageConfigKernelSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the kernel.
        :param builtins.str display_name: The display name of the kernel.
        """
...
class AppResourceSpec(dict):
    ...
    def __init__(__self__, *,
                 ...
                 lifecycle_config_arn: Optional[builtins.str] = None,
                 sagemaker_image_arn: Optional[builtins.str] = None,
                 sagemaker_image_version_alias: Optional[builtins.str] = None,
                 sagemaker_image_version_arn: Optional[builtins.str] = None):
        """
        :param builtins.str instance_type: The instance type that the image version runs on. For valid values see [SageMaker AI Instance Types](https://docs.aws.amazon.com/sagemaker/latest/dg/notebooks-available-instance-types.html).
        :param builtins.str lifecycle_config_arn: The Amazon Resource Name (ARN) of the Lifecycle Configuration attached to the Resource.
        :param builtins.str sagemaker_image_arn: The ARN of the SageMaker AI image that the image version belongs to.
        :param builtins.str sagemaker_image_version_alias: The SageMaker AI Image Version Alias.
        :param builtins.str sagemaker_image_version_arn: The ARN of the image version created on the instance.
        """
    ...
    def lifecycle_config_arn(self) -> Optional[builtins.str]:
        """
    ...
    def sagemaker_image_arn(self) -> Optional[builtins.str]:
        """
    ...
    def sagemaker_image_version_alias(self) -> Optional[builtins.str]:
        """
    ...
    def sagemaker_image_version_arn(self) -> Optional[builtins.str]:
        """
...
class CodeRepositoryGitConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str repository_url: The URL where the Git repository is located.
        :param builtins.str branch: The default branch for the Git repository.
        :param builtins.str secret_arn: The Amazon Resource Name (ARN) of the AWS Secrets Manager secret that contains the credentials used to access the git repository. The secret must have a staging label of AWSCURRENT and must be in the following format: `{"username": UserName, "password": Password}`
        """
...
class DataQualityJobDefinitionDataQualityAppSpecification(dict):
    ...
    def __init__(__self__, *,
                 ...
                 post_analytics_processor_source_uri: Optional[builtins.str] = None,
                 record_preprocessor_source_uri: Optional[builtins.str] = None):
        """
        :param builtins.str image_uri: The container image that the data quality monitoring job runs.
        :param Mapping[str, builtins.str] environment: Sets the environment variables in the container that the monitoring job runs. A list of key value pairs.
        :param builtins.str post_analytics_processor_source_uri: An Amazon S3 URI to a script that is called after analysis has been performed. Applicable only for the built-in (first party) containers.
        :param builtins.str record_preprocessor_source_uri: An Amazon S3 URI to a script that is called per row prior to running analysis. It can base64 decode the payload and convert it into a flatted json so that the built-in container can use the converted data. Applicable only for the built-in (first party) containers.
        """
    ...
    def post_analytics_processor_source_uri(self) -> Optional[builtins.str]:
        """
    ...
    def record_preprocessor_source_uri(self) -> Optional[builtins.str]:
        """
...
class DataQualityJobDefinitionDataQualityBaselineConfigConstraintsResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str s3_uri: The Amazon S3 URI for the constraints resource.
        """
...
class DataQualityJobDefinitionDataQualityBaselineConfigStatisticsResource(dict):
    ...
    def __init__(__self__, *,
                 s3_uri: Optional[builtins.str] = None):
        """
        :param builtins.str s3_uri: The Amazon S3 URI for the statistics resource.
        """
        if s3_uri is not None:
            pulumi.set(__self__, "s3_uri", s3_uri)
...
class DataQualityJobDefinitionDataQualityJobInputBatchTransformInput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_data_distribution_type: Optional[builtins.str] = None,
                 s3_input_mode: Optional[builtins.str] = None):
        """
        :param builtins.str data_captured_destination_s3_uri: The Amazon S3 location being used to capture the data.
        ...
        :param builtins.str local_path: Path to the filesystem where the batch transform data is available to the container. Defaults to `/opt/ml/processing/input`.
        :param builtins.str s3_data_distribution_type: Whether input data distributed in Amazon S3 is fully replicated or sharded by an S3 key. Defaults to `FullyReplicated`. Valid values are `FullyReplicated` or `ShardedByS3Key`
        :param builtins.str s3_input_mode: Whether the `Pipe` or `File` is used as the input mode for transferring data for the monitoring job. `Pipe` mode is recommended for large datasets. `File` mode is useful for small files that fit in memory. Defaults to `File`.  Valid values are `Pipe` or `File`
        """
    ...
    def s3_data_distribution_type(self) -> Optional[builtins.str]:
        """
    ...
    def s3_input_mode(self) -> Optional[builtins.str]:
        """
...
class DataQualityJobDefinitionDataQualityJobInputBatchTransformInputDatasetFormatCsv(dict):
    def __init__(__self__, *,
                 header: Optional[builtins.bool] = None):
        """
        :param builtins.bool header: Indicates if the CSV data has a header.
        """
    ...
    @property
    @pulumi.getter
    def header(self) -> Optional[builtins.bool]:
        """
...
class DataQualityJobDefinitionDataQualityJobInputBatchTransformInputDatasetFormatJson(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool line: Indicates if the file should be read as a json object per line.
        """
        if line is not None:
...
class DataQualityJobDefinitionDataQualityJobInputEndpointInput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_input_mode: Optional[builtins.str] = None):
        """
        :param builtins.str endpoint_name: An endpoint in customer's account which has `data_capture_config` enabled.
        :param builtins.str local_path: Path to the filesystem where the endpoint data is available to the container. Defaults to `/opt/ml/processing/input`.
        :param builtins.str s3_data_distribution_type: Whether input data distributed in Amazon S3 is fully replicated or sharded by an S3 key. Defaults to `FullyReplicated`. Valid values are `FullyReplicated` or `ShardedByS3Key`
        :param builtins.str s3_input_mode: Whether the `Pipe` or `File` is used as the input mode for transferring data for the monitoring job. `Pipe` mode is recommended for large datasets. `File` mode is useful for small files that fit in memory. Defaults to `File`.  Valid values are `Pipe` or `File`
        """
...
class DataQualityJobDefinitionDataQualityJobOutputConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker AI uses to encrypt the model artifacts at rest using Amazon S3 server-side encryption.
        """
...
class DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputsS3Output(dict):
    ...
    def __init__(__self__, *,
                 s3_uri: builtins.str,
                 local_path: Optional[builtins.str] = None,
                 s3_upload_mode: Optional[builtins.str] = None):
        """
        :param builtins.str s3_uri: A URI that identifies the Amazon S3 storage location where Amazon SageMaker AI saves the results of a monitoring job.
        :param builtins.str local_path: The local path to the Amazon S3 storage location where Amazon SageMaker AI saves the results of a monitoring job. LocalPath is an absolute path for the output data. Defaults to `/opt/ml/processing/output`.
        :param builtins.str s3_upload_mode: Whether to upload the results of the monitoring job continuously or after the job completes. Valid values are `Continuous` or `EndOfJob`
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
        if local_path is not None:
            pulumi.set(__self__, "local_path", local_path)
    ...
    def s3_upload_mode(self) -> Optional[builtins.str]:
        """
...
class DataQualityJobDefinitionJobResourcesClusterConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int instance_count: The number of ML compute instances to use in the model monitoring job. For distributed processing jobs, specify a value greater than 1.
        :param builtins.str instance_type: The ML compute instance type for the processing job.
        ...
        :param builtins.str volume_kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker AI uses to encrypt data on the storage volume attached to the ML compute instance(s) that run the model monitoring job.
        """
...
class DataQualityJobDefinitionNetworkConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable_inter_container_traffic_encryption: Whether to encrypt all communications between the instances used for the monitoring jobs. Choose `true` to encrypt communications. Encryption provides greater security for distributed jobs, but the processing might take longer.
        :param builtins.bool enable_network_isolation: Whether to allow inbound and outbound network calls to and from the containers used for the monitoring job.
...
class DataQualityJobDefinitionNetworkConfigVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] subnets: The ID of the subnets in the VPC to which you want to connect your training job or model.
        """
...
class DataQualityJobDefinitionStoppingCondition(dict):
    ...
    def __init__(__self__, *,
                 max_runtime_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.int max_runtime_in_seconds: The maximum runtime allowed in seconds.
        """
    ...
    def max_runtime_in_seconds(self) -> Optional[builtins.int]:
        """
...
class DeviceDevice(dict):
    ...
    def __init__(__self__, *,
                 ...
                 iot_thing_name: Optional[builtins.str] = None):
        """
        :param builtins.str device_name: The name of the device.
        :param builtins.str description: A description for the device.
        :param builtins.str iot_thing_name: Amazon Web Services Internet of Things (IoT) object name.
        """
    ...
    def iot_thing_name(self) -> Optional[builtins.str]:
        """
...
class DeviceFleetOutputConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_id: Optional[builtins.str] = None):
        """
        :param builtins.str s3_output_location: The Amazon Simple Storage (S3) bucker URI.
        :param builtins.str kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker AI uses to encrypt data on the storage volume after compilation job. If you don't provide a KMS key ID, Amazon SageMaker AI uses the default KMS key for Amazon S3 for your role's account.
        """
...
class DomainDefaultSpaceSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str execution_role: The execution role for the space.
        ...
        :param Sequence[builtins.str] security_groups: The security groups for the Amazon Virtual Private Cloud that the space uses for communication.
...
class DomainDefaultSpaceSettingsCustomFileSystemConfigEfsFileSystemConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str file_system_id: The ID of your Amazon EFS file system.
        :param builtins.str file_system_path: The path to the file system directory that is accessible in Amazon SageMaker AI Studio. Permitted users can access only this directory and below.
        """
...
class DomainDefaultSpaceSettingsCustomPosixUserConfig(dict):
    def __init__(__self__, *,
                 ...
                 uid: builtins.int):
        """
        :param builtins.int gid: The POSIX group ID.
        :param builtins.int uid: The POSIX user ID.
        """
...
class DomainDefaultSpaceSettingsJupyterLabAppSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 built_in_lifecycle_config_arn: Optional[builtins.str] = None,
                 ...
                 lifecycle_config_arns: Optional[Sequence[builtins.str]] = None):
        """
        ...
        :param builtins.str built_in_lifecycle_config_arn: The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
        ...
        :param Sequence[builtins.str] lifecycle_config_arns: The Amazon Resource Name (ARN) of the Lifecycle Configurations.
        """
    ...
    def lifecycle_config_arns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagementIdleSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 lifecycle_management: Optional[builtins.str] = None,
                 max_idle_timeout_in_minutes: Optional[builtins.int] = None,
                 min_idle_timeout_in_minutes: Optional[builtins.int] = None):
        """
        :param builtins.int idle_timeout_in_minutes: The time that SageMaker AI waits after the application becomes idle before shutting it down. Valid values are between `60` and `525600`.
        :param builtins.str lifecycle_management: Indicates whether idle shutdown is activated for the application type. Valid values are `ENABLED` and `DISABLED`.
        :param builtins.int max_idle_timeout_in_minutes: The maximum value in minutes that custom idle shutdown can be set to by the user. Valid values are between `60` and `525600`.
        :param builtins.int min_idle_timeout_in_minutes: The minimum value in minutes that custom idle shutdown can be set to by the user. Valid values are between `60` and `525600`.
        """
    ...
    def lifecycle_management(self) -> Optional[builtins.str]:
        """
    ...
    def max_idle_timeout_in_minutes(self) -> Optional[builtins.int]:
        """
    ...
    def min_idle_timeout_in_minutes(self) -> Optional[builtins.int]:
        """
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsCodeRepository(dict):
    ...
    def __init__(__self__, *,
                 repository_url: builtins.str):
        """
        :param builtins.str repository_url: The URL of the Git repository.
        """
        pulumi.set(__self__, "repository_url", repository_url)
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 image_version_number: Optional[builtins.int] = None):
        """
        :param builtins.str app_image_config_name: The name of the App Image Config.
        :param builtins.str image_name: The name of the Custom Image.
        :param builtins.int image_version_number: The version number of the Custom Image.
        """
    ...
    def image_version_number(self) -> Optional[builtins.int]:
        """
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettings(dict):
    ...
    def assumable_role_arns(self) -> Optional[Sequence[builtins.str]]:
        """
        An array of Amazon Resource Names (ARNs) of the IAM roles that the execution role of SageMaker AI can assume for performing operations or tasks related to Amazon EMR clusters or Amazon EMR Serverless applications. These roles define the permissions and access policies required when performing Amazon EMR-related operations, such as listing, connecting to, or terminating Amazon EMR clusters or Amazon EMR Serverless applications. They are typically used in cross-account access scenarios, where the Amazon EMR resources (clusters or serverless applications) are located in a different AWS account than the SageMaker AI domain.
        """
    ...
    def execution_role_arns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DomainDefaultSpaceSettingsSpaceStorageSettingsDefaultEbsStorageSettings(dict):
    ...
    def __init__(__self__, *,
                 default_ebs_volume_size_in_gb: builtins.int,
                 maximum_ebs_volume_size_in_gb: builtins.int):
        """
        :param builtins.int default_ebs_volume_size_in_gb: The default size of the EBS storage volume for a private space.
        :param builtins.int maximum_ebs_volume_size_in_gb: The maximum size of the EBS storage volume for a private space.
        """
    ...
    def default_ebs_volume_size_in_gb(self) -> builtins.int:
        """
    ...
    def maximum_ebs_volume_size_in_gb(self) -> builtins.int:
        """
...
class DomainDefaultUserSettings(dict):
    ...
    def __init__(__self__, *,
                 execution_role: builtins.str,
                 auto_mount_home_efs: Optional[builtins.str] = None,
                 ...
                 default_landing_uri: Optional[builtins.str] = None,
                 ...
                 studio_web_portal: Optional[builtins.str] = None,
        ...
        :param builtins.str default_landing_uri: The default experience that the user is directed to when accessing the domain. The supported values are: `studio::`: Indicates that Studio is the default experience. This value can only be passed if StudioWebPortal is set to ENABLED. `app:JupyterServer:`: Indicates that Studio Classic is the default experience.
        ...
        :param Sequence[builtins.str] security_groups: A list of security group IDs that will be attached to the user.
        ...
        :param builtins.str studio_web_portal: Whether the user can access Studio. If this value is set to `DISABLED`, the user cannot access Studio, even if that is the default experience for the domain. Valid values are `ENABLED` and `DISABLED`.
    ...
    def auto_mount_home_efs(self) -> Optional[builtins.str]:
        """
        Indicates whether auto-mounting of an EFS volume is supported for the user profile. The `DefaultAsDomain` value is only supported for user profiles. Do not use the `DefaultAsDomain` value when setting this parameter for a domain. Valid values are: `Enabled`, `Disabled`, and `DefaultAsDomain`.
        """
    ...
    def default_landing_uri(self) -> Optional[builtins.str]:
        """
    ...
    def studio_web_portal(self) -> Optional[builtins.str]:
        """
...
class DomainDefaultUserSettingsCanvasAppSettingsDirectDeploySettings(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str status: Describes whether model deployment permissions are enabled or disabled in the Canvas application. Valid values are `ENABLED` and `DISABLED`.
        """
...
class DomainDefaultUserSettingsCanvasAppSettingsEmrServerlessSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str execution_role_arn: The Amazon Resource Name (ARN) of the AWS IAM role that is assumed for running Amazon EMR Serverless jobs in SageMaker AI Canvas. This role should have the necessary permissions to read and write data attached and a trust relationship with EMR Serverless.
        :param builtins.str status: Describes whether Amazon EMR Serverless job capabilities are enabled or disabled in the SageMaker AI Canvas application. Valid values are: `ENABLED` and `DISABLED`.
        """
...
class DomainDefaultUserSettingsCanvasAppSettingsGenerativeAiSettings(dict):
    ...
    def __init__(__self__, *,
                 amazon_bedrock_role_arn: Optional[builtins.str] = None):
    ...
    def amazon_bedrock_role_arn(self) -> Optional[builtins.str]:
...
class DomainDefaultUserSettingsCanvasAppSettingsIdentityProviderOauthSetting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str secret_arn: The ARN of an Amazon Web Services Secrets Manager secret that stores the credentials from your identity provider, such as the client ID and secret, authorization URL, and token URL.
        :param builtins.str data_source_name: The name of the data source that you're connecting to. Canvas currently supports OAuth for Snowflake and Salesforce Data Cloud. Valid values are `SalesforceGenie` and `Snowflake`.
        :param builtins.str status: Describes whether OAuth for a data source is enabled or disabled in the Canvas application. Valid values are `ENABLED` and `DISABLED`.
        """
        pulumi.set(__self__, "secret_arn", secret_arn)
...
class DomainDefaultUserSettingsCanvasAppSettingsKendraSettings(dict):
    def __init__(__self__, *,
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str status: Describes whether the document querying feature is enabled or disabled in the Canvas application. Valid values are `ENABLED` and `DISABLED`.
        """
        if status is not None:
            pulumi.set(__self__, "status", status)
...
class DomainDefaultUserSettingsCanvasAppSettingsModelRegisterSettings(dict):
    ...
    def __init__(__self__, *,
                 cross_account_model_register_role_arn: Optional[builtins.str] = None,
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str cross_account_model_register_role_arn: The Amazon Resource Name (ARN) of the SageMaker AI model registry account. Required only to register model versions created by a different SageMaker AI Canvas AWS account than the AWS account in which SageMaker AI model registry is set up.
        :param builtins.str status: Describes whether the integration to the model registry is enabled or disabled in the Canvas application. Valid values are `ENABLED` and `DISABLED`.
        """
    ...
    def cross_account_model_register_role_arn(self) -> Optional[builtins.str]:
        """
...
class DomainDefaultUserSettingsCanvasAppSettingsTimeSeriesForecastingSettings(dict):
    ...
    def __init__(__self__, *,
                 amazon_forecast_role_arn: Optional[builtins.str] = None,
                 status: Optional[builtins.str] = None):
        """
        :param builtins.str amazon_forecast_role_arn: The IAM role that Canvas passes to Amazon Forecast for time series forecasting. By default, Canvas uses the execution role specified in the UserProfile that launches the Canvas app. If an execution role is not specified in the UserProfile, Canvas uses the execution role specified in the Domain that owns the UserProfile. To allow time series forecasting, this IAM role should have the [AmazonSageMakerCanvasForecastAccess](https://docs.aws.amazon.com/sagemaker/latest/dg/security-iam-awsmanpol-canvas.html#security-iam-awsmanpol-AmazonSageMakerCanvasForecastAccess) policy attached and forecast.amazonaws.com added in the trust relationship as a service principal.
        :param builtins.str status: Describes whether time series forecasting is enabled or disabled in the Canvas app. Valid values are `ENABLED` and `DISABLED`.
        """
    ...
    def amazon_forecast_role_arn(self) -> Optional[builtins.str]:
        """
...
class DomainDefaultUserSettingsCanvasAppSettingsWorkspaceSettings(dict):
    ...
    def __init__(__self__, *,
                 s3_artifact_path: Optional[builtins.str] = None,
                 s3_kms_key_id: Optional[builtins.str] = None):
        """
        :param builtins.str s3_artifact_path: The Amazon S3 bucket used to store artifacts generated by Canvas. Updating the Amazon S3 location impacts existing configuration settings, and Canvas users no longer have access to their artifacts. Canvas users must log out and log back in to apply the new location.
        :param builtins.str s3_kms_key_id: The Amazon Web Services Key Management Service (KMS) encryption key ID that is used to encrypt artifacts generated by Canvas in the Amazon S3 bucket.
        """
    ...
    def s3_artifact_path(self) -> Optional[builtins.str]:
        """
    ...
    def s3_kms_key_id(self) -> Optional[builtins.str]:
        """
...
class DomainDefaultUserSettingsRStudioServerProAppSettings(dict):
    ...
    def __init__(__self__, *,
                 access_status: Optional[builtins.str] = None,
                 user_group: Optional[builtins.str] = None):
        """
        :param builtins.str access_status: Indicates whether the current user has access to the RStudioServerPro app. Valid values are `ENABLED` and `DISABLED`.
        :param builtins.str user_group: The level of permissions that the user has within the RStudioServerPro app. This value defaults to `R_STUDIO_USER`. The `R_STUDIO_ADMIN` value allows the user access to the RStudio Administrative Dashboard. Valid values are `R_STUDIO_USER` and `R_STUDIO_ADMIN`.
        """
    ...
    def access_status(self) -> Optional[builtins.str]:
        """
    ...
    def user_group(self) -> Optional[builtins.str]:
        """
...
class DomainDefaultUserSettingsSharingSettings(dict):
    ...
    def __init__(__self__, *,
                 notebook_output_option: Optional[builtins.str] = None,
                 s3_kms_key_id: Optional[builtins.str] = None,
                 s3_output_path: Optional[builtins.str] = None):
        """
        :param builtins.str notebook_output_option: Whether to include the notebook cell output when sharing the notebook. The default is `Disabled`. Valid values are `Allowed` and `Disabled`.
        :param builtins.str s3_kms_key_id: When `notebook_output_option` is Allowed, the AWS Key Management Service (KMS) encryption key ID used to encrypt the notebook cell output in the Amazon S3 bucket.
        :param builtins.str s3_output_path: When `notebook_output_option` is Allowed, the Amazon S3 bucket used to save the notebook cell output.
        """
    ...
    def notebook_output_option(self) -> Optional[builtins.str]:
        """
    ...
    def s3_output_path(self) -> Optional[builtins.str]:
        """
...
class DomainDefaultUserSettingsStudioWebPortalSettings(dict):
    ...
    def __init__(__self__, *,
                 hidden_app_types: Optional[Sequence[builtins.str]] = None,
                 hidden_instance_types: Optional[Sequence[builtins.str]] = None,
                 hidden_ml_tools: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] hidden_app_types: The Applications supported in Studio that are hidden from the Studio left navigation pane.
        :param Sequence[builtins.str] hidden_instance_types: The instance types you are hiding from the Studio user interface.
        :param Sequence[builtins.str] hidden_ml_tools: The machine learning tools that are hidden from the Studio left navigation pane.
        """
    ...
    def hidden_app_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def hidden_instance_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def hidden_ml_tools(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DomainDomainSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 execution_role_identity_config: Optional[builtins.str] = None,
        ...
        :param Sequence[builtins.str] security_group_ids: The security groups for the Amazon Virtual Private Cloud that the Domain uses for communication between Domain-level apps and user apps.
        """
    ...
    def execution_role_identity_config(self) -> Optional[builtins.str]:
        """
...
class DomainDomainSettingsDockerSettings(dict):
    ...
    def __init__(__self__, *,
                 enable_docker_access: Optional[builtins.str] = None,
                 vpc_only_trusted_accounts: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str enable_docker_access: Indicates whether the domain can access Docker. Valid values are `ENABLED` and `DISABLED`.
        :param Sequence[builtins.str] vpc_only_trusted_accounts: The list of Amazon Web Services accounts that are trusted when the domain is created in VPC-only mode.
        """
    ...
    def enable_docker_access(self) -> Optional[builtins.str]:
        """
    ...
    def vpc_only_trusted_accounts(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DomainDomainSettingsRStudioServerProDomainSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 r_studio_connect_url: Optional[builtins.str] = None,
                 r_studio_package_manager_url: Optional[builtins.str] = None):
        """
        :param builtins.str domain_execution_role_arn: The ARN of the execution role for the RStudioServerPro Domain-level app.
        ...
        :param builtins.str r_studio_connect_url: A URL pointing to an RStudio Connect server.
        :param builtins.str r_studio_package_manager_url: A URL pointing to an RStudio Package Manager server.
        """
    ...
    def r_studio_connect_url(self) -> Optional[builtins.str]:
        """
    ...
    def r_studio_package_manager_url(self) -> Optional[builtins.str]:
        """
...
class DomainRetentionPolicy(dict):
    ...
    def __init__(__self__, *,
                 home_efs_file_system: Optional[builtins.str] = None):
        """
        :param builtins.str home_efs_file_system: The retention policy for data stored on an Amazon Elastic File System (EFS) volume. Valid values are `Retain` or `Delete`.  Default value is `Retain`.
        """
    ...
    def home_efs_file_system(self) -> Optional[builtins.str]:
        """
...
class EndpointConfigurationAsyncInferenceConfigClientConfig(dict):
    ...
    def __init__(__self__, *,
                 max_concurrent_invocations_per_instance: Optional[builtins.int] = None):
        """
        :param builtins.int max_concurrent_invocations_per_instance: The maximum number of concurrent requests sent by the SageMaker AI client to the model container. If no value is provided, Amazon SageMaker AI will choose an optimal value for you.
        """
    ...
    def max_concurrent_invocations_per_instance(self) -> Optional[builtins.int]:
        """
...
class EndpointConfigurationAsyncInferenceConfigOutputConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_failure_path: Optional[builtins.str] = None):
        """
        :param builtins.str s3_output_path: The Amazon S3 location to upload inference responses to.
        :param builtins.str kms_key_id: The Amazon Web Services Key Management Service (Amazon Web Services KMS) key that Amazon SageMaker AI uses to encrypt the asynchronous inference output in Amazon S3.
        ...
        :param builtins.str s3_failure_path: The Amazon S3 location to upload failure inference responses to.
        """
        pulumi.set(__self__, "s3_output_path", s3_output_path)
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
    ...
    def s3_failure_path(self) -> Optional[builtins.str]:
        """
...
class EndpointConfigurationAsyncInferenceConfigOutputConfigNotificationConfig(dict):
    ...
    def __init__(__self__, *,
                 error_topic: Optional[builtins.str] = None,
                 include_inference_response_ins: Optional[Sequence[builtins.str]] = None,
                 success_topic: Optional[builtins.str] = None):
        """
        :param builtins.str error_topic: Amazon SNS topic to post a notification to when inference fails. If no topic is provided, no notification is sent on failure.
        :param Sequence[builtins.str] include_inference_response_ins: The Amazon SNS topics where you want the inference response to be included. Valid values are `SUCCESS_NOTIFICATION_TOPIC` and `ERROR_NOTIFICATION_TOPIC`.
        :param builtins.str success_topic: Amazon SNS topic to post a notification to when inference completes successfully. If no topic is provided, no notification is sent on success.
        """
    ...
    def error_topic(self) -> Optional[builtins.str]:
        """
    ...
    def include_inference_response_ins(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def success_topic(self) -> Optional[builtins.str]:
        """
...
class EndpointConfigurationDataCaptureConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_capture: Optional[builtins.bool] = None,
                 kms_key_id: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str destination_s3_uri: The URL for S3 location where the captured data is stored.
        :param builtins.int initial_sampling_percentage: Portion of data to capture. Should be between 0 and 100.
        ...
        :param builtins.bool enable_capture: Flag to enable data capture. Defaults to `false`.
        :param builtins.str kms_key_id: Amazon Resource Name (ARN) of a AWS Key Management Service key that Amazon SageMaker AI uses to encrypt the captured data on Amazon S3.
        """
    ...
    def initial_sampling_percentage(self) -> builtins.int:
        """
    ...
    def enable_capture(self) -> Optional[builtins.bool]:
        """
...
class EndpointConfigurationDataCaptureConfigCaptureContentTypeHeader(dict):
    ...
    def __init__(__self__, *,
                 csv_content_types: Optional[Sequence[builtins.str]] = None,
                 json_content_types: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] csv_content_types: The CSV content type headers to capture.
               One of `csv_content_types` or `json_content_types` is required.
        :param Sequence[builtins.str] json_content_types: The JSON content type headers to capture.
    ...
    def csv_content_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def json_content_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
class EndpointConfigurationDataCaptureConfigCaptureOption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str capture_mode: Specifies the data to be captured. Should be one of `Input`, `Output` or `InputAndOutput`.
        """
...
class EndpointConfigurationProductionVariant(dict):
    ...
    def __init__(__self__, *,
                 ...
                 container_startup_health_check_timeout_in_seconds: Optional[builtins.int] = None,
                 core_dump_config: Optional['outputs.EndpointConfigurationProductionVariantCoreDumpConfig'] = None,
                 enable_ssm_access: Optional[builtins.bool] = None,
                 inference_ami_version: Optional[builtins.str] = None,
                 initial_instance_count: Optional[builtins.int] = None,
                 initial_variant_weight: Optional[builtins.float] = None,
                 instance_type: Optional[builtins.str] = None,
                 managed_instance_scaling: Optional['outputs.EndpointConfigurationProductionVariantManagedInstanceScaling'] = None,
                 model_data_download_timeout_in_seconds: Optional[builtins.int] = None,
                 ...
                 variant_name: Optional[builtins.str] = None,
                 volume_size_in_gb: Optional[builtins.int] = None):
        """
        :param builtins.str model_name: The name of the model to use.
        :param builtins.str accelerator_type: The size of the Elastic Inference (EI) instance to use for the production variant.
        :param builtins.int container_startup_health_check_timeout_in_seconds: The timeout value, in seconds, for your inference container to pass health check by SageMaker AI Hosting. For more information about health check, see [How Your Container Should Respond to Health Check (Ping) Requests](https://docs.aws.amazon.com/sagemaker/latest/dg/your-algorithms-inference-code.html#your-algorithms-inference-algo-ping-requests). Valid values between `60` and `3600`.
        ...
        :param builtins.bool enable_ssm_access: You can use this parameter to turn on native Amazon Web Services Systems Manager (SSM) access for a production variant behind an endpoint. By default, SSM access is disabled for all production variants behind an endpoints.
        :param builtins.str inference_ami_version: Specifies an option from a collection of preconfigured Amazon Machine Image (AMI) images. Each image is configured by Amazon Web Services with a set of software and driver versions. Amazon Web Services optimizes these configurations for different machine learning workloads.
        :param builtins.int initial_instance_count: Initial number of instances used for auto-scaling.
        :param builtins.float initial_variant_weight: Determines initial traffic distribution among all of the models that you specify in the endpoint configuration. If unspecified, it defaults to `1.0`.
        :param builtins.str instance_type: The type of instance to start.
        ...
        :param builtins.int model_data_download_timeout_in_seconds: The timeout value, in seconds, to download and extract the model that you want to host from Amazon S3 to the individual inference instance associated with this production variant. Valid values between `60` and `3600`.
        ...
        :param builtins.str variant_name: The name of the variant. If omitted, this provider will assign a random, unique name.
        :param builtins.int volume_size_in_gb: The size, in GB, of the ML storage volume attached to individual inference instance associated with the production variant. Valid values between `1` and `512`.
        """
    ...
    def container_startup_health_check_timeout_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def enable_ssm_access(self) -> Optional[builtins.bool]:
        """
    ...
    def inference_ami_version(self) -> Optional[builtins.str]:
        """
    ...
    def initial_instance_count(self) -> Optional[builtins.int]:
        """
    ...
    def initial_variant_weight(self) -> Optional[builtins.float]:
        """
    ...
    def model_data_download_timeout_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def variant_name(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="volumeSizeInGb")
    def volume_size_in_gb(self) -> Optional[builtins.int]:
        """
...
class EndpointConfigurationProductionVariantCoreDumpConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_id: Optional[builtins.str] = None):
        """
        :param builtins.str destination_s3_uri: The Amazon S3 bucket to send the core dump to.
        :param builtins.str kms_key_id: The Amazon Web Services Key Management Service (Amazon Web Services KMS) key that SageMaker AI uses to encrypt the core dump data at rest using Amazon S3 server-side encryption.
        """
        pulumi.set(__self__, "destination_s3_uri", destination_s3_uri)
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class EndpointConfigurationProductionVariantManagedInstanceScaling(dict):
    ...
    def __init__(__self__, *,
                 ...
                 status: Optional[builtins.str] = None):
        """
        :param builtins.int max_instance_count: The maximum number of instances that the endpoint can provision when it scales up to accommodate an increase in traffic.
        :param builtins.int min_instance_count: The minimum number of instances that the endpoint must retain when it scales down to accommodate a decrease in traffic.
        :param builtins.str status: Indicates whether managed instance scaling is enabled. Valid values are `ENABLED` and `DISABLED`.
        """
...
class EndpointConfigurationProductionVariantRoutingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str routing_strategy: Sets how the endpoint routes incoming traffic. Valid values are `LEAST_OUTSTANDING_REQUESTS` and `RANDOM`. `LEAST_OUTSTANDING_REQUESTS` routes requests to the specific instances that have more capacity to process them. `RANDOM` routes each request to a randomly chosen instance.
        """
...
class EndpointConfigurationProductionVariantServerlessConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 memory_size_in_mb: builtins.int,
                 provisioned_concurrency: Optional[builtins.int] = None):
        """
        :param builtins.int max_concurrency: The maximum number of concurrent invocations your serverless endpoint can process. Valid values are between `1` and `200`.
        :param builtins.int memory_size_in_mb: The memory size of your serverless endpoint. Valid values are in 1 GB increments: `1024` MB, `2048` MB, `3072` MB, `4096` MB, `5120` MB, or `6144` MB.
        :param builtins.int provisioned_concurrency: The amount of provisioned concurrency to allocate for the serverless endpoint. Should be less than or equal to `max_concurrency`. Valid values are between `1` and `200`.
        """
    ...
    def memory_size_in_mb(self) -> builtins.int:
        """
    ...
    def provisioned_concurrency(self) -> Optional[builtins.int]:
        """
...
class EndpointDeploymentConfigAutoRollbackConfigurationAlarm(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str alarm_name: The name of a CloudWatch alarm in your account.
        """
...
class EndpointDeploymentConfigBlueGreenUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 maximum_execution_timeout_in_seconds: Optional[builtins.int] = None,
                 termination_wait_in_seconds: Optional[builtins.int] = None):
        """
        ...
        :param builtins.int termination_wait_in_seconds: Additional waiting time in seconds after the completion of an endpoint deployment before terminating the old endpoint fleet. Default is `0`. Valid values are between `0` and `3600`.
        """
    ...
    def maximum_execution_timeout_in_seconds(self) -> Optional[builtins.int]:
        return pulumi.get(self, "maximum_execution_timeout_in_seconds")

    @property
    @pulumi.getter(name="terminationWaitInSeconds")
    def termination_wait_in_seconds(self) -> Optional[builtins.int]:
        """
...
class EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfiguration(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 wait_interval_in_seconds: builtins.int,
        ...
        """
        :param builtins.str type: Traffic routing strategy type. Valid values are: `ALL_AT_ONCE`, `CANARY`, and `LINEAR`.
        :param builtins.int wait_interval_in_seconds: The waiting time (in seconds) between incremental steps to turn on traffic on the new endpoint fleet. Valid values are between `0` and `3600`.
    ...
    def wait_interval_in_seconds(self) -> builtins.int:
        """
...
class EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationCanarySize(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.int):
        """
        :param builtins.str type: Specifies the endpoint capacity type. Valid values are: `INSTANCE_COUNT`, or `CAPACITY_PERCENT`.
        :param builtins.int value: Defines the capacity size, either as a number of instances or a capacity percentage.
        """
        pulumi.set(__self__, "type", type)
...
class EndpointDeploymentConfigRollingUpdatePolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int wait_interval_in_seconds: The length of the baking period, during which SageMaker AI monitors alarms for each batch on the new fleet. Valid values are between `0` and `3600`.
        :param builtins.int maximum_execution_timeout_in_seconds: The time limit for the total deployment. Exceeding this limit causes a timeout. Valid values are between `600` and `14400`.
...
class FeatureGroupFeatureDefinition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 collection_type: Optional[builtins.str] = None,
                 feature_name: Optional[builtins.str] = None,
                 feature_type: Optional[builtins.str] = None):
        """
        :param builtins.str feature_name: The name of a feature. `feature_name` cannot be any of the following: `is_deleted`, `write_time`, `api_invocation_time`.
        :param builtins.str feature_type: The value type of a feature. Valid values are `Integral`, `Fractional`, or `String`.
        """
    ...
    def feature_type(self) -> Optional[builtins.str]:
        """
...
class FeatureGroupOfflineStoreConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_glue_table_creation: Optional[builtins.bool] = None,
        ...
        :param builtins.bool disable_glue_table_creation: Set to `true` to turn Online Store On.
        :param builtins.str table_format: Format for the offline store table. Supported formats are `Glue` (Default) and Apache `Iceberg` (https://iceberg.apache.org/).
        """
    ...
    def disable_glue_table_creation(self) -> Optional[builtins.bool]:
        """
    ...
    def table_format(self) -> Optional[builtins.str]:
        """
...
class FeatureGroupOfflineStoreConfigDataCatalogConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str catalog: The name of the Glue table catalog.
        :param builtins.str database: The name of the Glue table database.
        :param builtins.str table_name: The name of the Glue table.
        """
...
class FeatureGroupOfflineStoreConfigS3StorageConfig(dict):
    ...
    def __init__(__self__, *,
                 s3_uri: builtins.str,
                 kms_key_id: Optional[builtins.str] = None,
                 resolved_output_s3_uri: Optional[builtins.str] = None):
        """
        :param builtins.str s3_uri: The S3 URI, or location in Amazon S3, of OfflineStore.
        :param builtins.str kms_key_id: The AWS Key Management Service (KMS) key ID of the key used to encrypt any objects written into the OfflineStore S3 location.
        :param builtins.str resolved_output_s3_uri: The S3 path where offline records are written.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
    ...
    def resolved_output_s3_uri(self) -> Optional[builtins.str]:
        """
...
class FeatureGroupOnlineStoreConfig(dict):
    ...
    def __init__(__self__, *,
                 enable_online_store: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.bool enable_online_store: Set to `true` to disable the automatic creation of an AWS Glue table when configuring an OfflineStore.
        ...
        :param builtins.str storage_type: Option for different tiers of low latency storage for real-time data retrieval. Valid values are `Standard`, or `InMemory`.
    ...
    def enable_online_store(self) -> Optional[builtins.bool]:
        """
...
class FeatureGroupOnlineStoreConfigSecurityConfig(dict):
    ...
    def __init__(__self__, *,
                 kms_key_id: Optional[builtins.str] = None):
        """
        :param builtins.str kms_key_id: The ID of the AWS Key Management Service (AWS KMS) key that SageMaker AI Feature Store uses to encrypt the Amazon S3 objects at rest using Amazon S3 server-side encryption.
        """
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class FeatureGroupOnlineStoreConfigTtlDuration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str unit: TtlDuration time unit. Valid values are `Seconds`, `Minutes`, `Hours`, `Days`, or `Weeks`.
        :param builtins.int value: TtlDuration time value.
        """
        if unit is not None:
...
class FeatureGroupThroughputConfig(dict):
    ...
    def __init__(__self__, *,
                 provisioned_read_capacity_units: Optional[builtins.int] = None,
                 provisioned_write_capacity_units: Optional[builtins.int] = None,
    ...
    def provisioned_read_capacity_units(self) -> Optional[builtins.int]:
        return pulumi.get(self, "provisioned_read_capacity_units")

    @property
    @pulumi.getter(name="provisionedWriteCapacityUnits")
    def provisioned_write_capacity_units(self) -> Optional[builtins.int]:
...
class FlowDefinitionHumanLoopActivationConfigHumanLoopActivationConditionsConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str human_loop_activation_conditions: A JSON expressing use-case specific conditions declaratively. If any condition is matched, atomic tasks are created against the configured work team. For more information about how to structure the JSON, see [JSON Schema for Human Loop Activation Conditions in Amazon Augmented AI](https://docs.aws.amazon.com/sagemaker/latest/dg/a2i-human-fallback-conditions-json-schema.html).
        """
...
class FlowDefinitionHumanLoopConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 task_availability_lifetime_in_seconds: Optional[builtins.int] = None,
                 task_keywords: Optional[Sequence[builtins.str]] = None,
                 task_time_limit_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.str human_task_ui_arn: The Amazon Resource Name (ARN) of the human task user interface.
        :param builtins.int task_count: The number of distinct workers who will perform the same task on each object. Valid value range between `1` and `3`.
        :param builtins.str task_description: A description for the human worker task.
        :param builtins.str task_title: A title for the human worker task.
        :param builtins.str workteam_arn: The Amazon Resource Name (ARN) of the human task user interface. Amazon Resource Name (ARN) of a team of workers. For Public workforces see [AWS Docs](https://docs.aws.amazon.com/sagemaker/latest/dg/sms-workforce-management-public.html).
        ...
        :param builtins.int task_availability_lifetime_in_seconds: The length of time that a task remains available for review by human workers. Valid value range between `1` and `864000`.
        :param Sequence[builtins.str] task_keywords: An array of keywords used to describe the task so that workers can discover the task.
        :param builtins.int task_time_limit_in_seconds: The amount of time that a worker has to complete a task. The default value is `3600` seconds.
        """
    ...
    def task_availability_lifetime_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def task_keywords(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def task_time_limit_in_seconds(self) -> Optional[builtins.int]:
        """
...
class FlowDefinitionHumanLoopConfigPublicWorkforceTaskPriceAmountInUsd(dict):
    ...
    def __init__(__self__, *,
                 cents: Optional[builtins.int] = None,
                 dollars: Optional[builtins.int] = None,
                 tenth_fractions_of_a_cent: Optional[builtins.int] = None):
        """
        :param builtins.int cents: The fractional portion, in cents, of the amount. Valid value range between `0` and `99`.
        :param builtins.int dollars: The whole number of dollars in the amount. Valid value range between `0` and `2`.
        :param builtins.int tenth_fractions_of_a_cent: Fractions of a cent, in tenths. Valid value range between `0` and `9`.
        """
    ...
    @property
    @pulumi.getter
    def cents(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def dollars(self) -> Optional[builtins.int]:
        """
    ...
    def tenth_fractions_of_a_cent(self) -> Optional[builtins.int]:
        """
...
class FlowDefinitionHumanLoopRequestSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str aws_managed_human_loop_request_source: Specifies whether Amazon Rekognition or Amazon Textract are used as the integration source. Valid values are: `AWS/Rekognition/DetectModerationLabels/Image/V3` and `AWS/Textract/AnalyzeDocument/Forms/V1`.
        """
...
class FlowDefinitionOutputConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 kms_key_id: Optional[builtins.str] = None):
        """
        :param builtins.str s3_output_path: The Amazon S3 path where the object containing human output will be made available.
        :param builtins.str kms_key_id: The Amazon Key Management Service (KMS) key ARN for server-side encryption.
        """
        pulumi.set(__self__, "s3_output_path", s3_output_path)
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class HubS3StorageConfig(dict):
    ...
    def __init__(__self__, *,
                 s3_output_path: Optional[builtins.str] = None):
        """
        :param builtins.str s3_output_path: The Amazon S3 bucket prefix for hosting hub content.interface.
        """
        if s3_output_path is not None:
            pulumi.set(__self__, "s3_output_path", s3_output_path)
...
class HumanTaskUIUiTemplate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 content_sha256: Optional[builtins.str] = None,
                 url: Optional[builtins.str] = None):
        """
        :param builtins.str content: The content of the Liquid template for the worker user interface.
        :param builtins.str content_sha256: The SHA-256 digest of the contents of the template.
        :param builtins.str url: The URL for the user interface template.
        """
    ...
    def content_sha256(self) -> Optional[builtins.str]:
        """
...
class ModelContainer(dict):
    ...
    def __init__(__self__, *,
                 container_hostname: Optional[builtins.str] = None,
                 environment: Optional[Mapping[str, builtins.str]] = None,
                 image: Optional[builtins.str] = None,
                 image_config: Optional['outputs.ModelContainerImageConfig'] = None,
                 inference_specification_name: Optional[builtins.str] = None,
                 mode: Optional[builtins.str] = None,
                 model_data_source: Optional['outputs.ModelContainerModelDataSource'] = None,
                 model_data_url: Optional[builtins.str] = None,
                 model_package_name: Optional[builtins.str] = None,
                 multi_model_config: Optional['outputs.ModelContainerMultiModelConfig'] = None):
        """
        :param builtins.str container_hostname: The DNS host name for the container.
        :param Mapping[str, builtins.str] environment: Environment variables for the Docker container.
               A list of key value pairs.
        :param builtins.str image: The registry path where the inference code image is stored in Amazon ECR.
        ...
        :param builtins.str inference_specification_name: The inference specification name in the model package version.
        :param builtins.str mode: The container hosts value `SingleModel/MultiModel`. The default value is `SingleModel`.
        ...
        :param builtins.str model_data_url: The URL for the S3 location where model artifacts are stored.
        :param builtins.str model_package_name: The Amazon Resource Name (ARN) of the model package to use to create the model.
    ...
    def container_hostname(self) -> Optional[builtins.str]:
        """
    ...
    def inference_specification_name(self) -> Optional[builtins.str]:
        """
    ...
    def model_data_url(self) -> Optional[builtins.str]:
        """
...
class ModelContainerImageConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str repository_access_mode: Specifies whether the model container is in Amazon ECR or a private Docker registry accessible from your Amazon Virtual Private Cloud (VPC). Allowed values are: `Platform` and `Vpc`.
...
class ModelContainerImageConfigRepositoryAuthConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str repository_credentials_provider_arn: The Amazon Resource Name (ARN) of an AWS Lambda function that provides credentials to authenticate to the private Docker registry where your model image is hosted. For information about how to create an AWS Lambda function, see [Create a Lambda function with the console](https://docs.aws.amazon.com/lambda/latest/dg/getting-started-create-function.html) in the _AWS Lambda Developer Guide_.
        """
...
class ModelContainerModelDataSourceS3DataSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str compression_type: How the model data is prepared. Allowed values are: `None` and `Gzip`.
        :param builtins.str s3_data_type: The type of model data to deploy. Allowed values are: `S3Object` and `S3Prefix`.
        :param builtins.str s3_uri: The S3 path of model data to deploy.
...
class ModelContainerModelDataSourceS3DataSourceModelAccessConfig(dict):
    ...
    def __init__(__self__, *,
                 accept_eula: builtins.bool):
        """
        :param builtins.bool accept_eula: Specifies agreement to the model end-user license agreement (EULA). The AcceptEula value must be explicitly defined as `true` in order to accept the EULA that this model requires. You are responsible for reviewing and complying with any applicable license terms and making sure they are acceptable for your use case before downloading or using a model.
        """
        pulumi.set(__self__, "accept_eula", accept_eula)

    @property
    @pulumi.getter(name="acceptEula")
    def accept_eula(self) -> builtins.bool:
        """
...
class ModelContainerMultiModelConfig(dict):
    ...
    def model_cache_setting(self) -> Optional[builtins.str]:
        """
...
class MonitoringScheduleMonitoringScheduleConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str monitoring_job_definition_name: The name of the monitoring job definition to schedule.
        :param builtins.str monitoring_type: The type of the monitoring job definition to schedule. Valid values are `DataQuality`, `ModelQuality`, `ModelBias` or `ModelExplainability`
...
class MonitoringScheduleMonitoringScheduleConfigScheduleConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str schedule_expression: A cron expression that describes details about the monitoring schedule. For example, and hourly schedule would be `cron(0 * ? * * *)`.
        """
...
class NotebookInstanceInstanceMetadataServiceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 minimum_instance_metadata_service_version: Optional[builtins.str] = None):
        """
        :param builtins.str minimum_instance_metadata_service_version: Indicates the minimum IMDS version that the notebook instance supports. When passed "1" is passed. This means that both IMDSv1 and IMDSv2 are supported. Valid values are `1` and `2`.
        """
    ...
    def minimum_instance_metadata_service_version(self) -> Optional[builtins.str]:
        """
...
class PipelineParallelismConfiguration(dict):
    ...
    def __init__(__self__, *,
                 max_parallel_execution_steps: builtins.int):
        """
        :param builtins.int max_parallel_execution_steps: The max number of steps that can be executed in parallel.
        """
    ...
    def max_parallel_execution_steps(self) -> builtins.int:
        """
...
class PipelinePipelineDefinitionS3Location(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str object_key: The object key (or key name) uniquely identifies the object in an S3 bucket.
        :param builtins.str version_id: Version Id of the pipeline definition file. If not specified, Amazon SageMaker AI will retrieve the latest version.
        """
...
class ProjectServiceCatalogProvisioningDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 path_id: Optional[builtins.str] = None,
                 provisioning_artifact_id: Optional[builtins.str] = None,
                 provisioning_parameters: Optional[Sequence['outputs.ProjectServiceCatalogProvisioningDetailsProvisioningParameter']] = None):
        """
        :param builtins.str product_id: The ID of the product to provision.
        :param builtins.str path_id: The path identifier of the product. This value is optional if the product has a default path, and required if the product has more than one path.
        :param builtins.str provisioning_artifact_id: The ID of the provisioning artifact.
...
class ProjectServiceCatalogProvisioningDetailsProvisioningParameter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: The key that identifies a provisioning parameter.
        :param builtins.str value: The value of the provisioning parameter.
        """
...
class SpaceOwnershipSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str owner_user_profile_name: The user profile who is the owner of the private space.
        """
...
class SpaceSpaceSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str app_type: The type of app created within the space.
...
class SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpec(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str lifecycle_config_arn: The Amazon Resource Name (ARN) of the Lifecycle Configuration attached to the Resource.
        :param builtins.str sagemaker_image_arn: The Amazon Resource Name (ARN) of the SageMaker AI image created on the instance.
        :param builtins.str sagemaker_image_version_alias: The SageMaker AI Image Version Alias.
        :param builtins.str sagemaker_image_version_arn: The ARN of the image version created on the instance.
        """
        if instance_type is not None:
...
class SpaceSpaceSettingsSpaceStorageSettingsEbsStorageSettings(dict):
    ...
    def __init__(__self__, *,
                 ebs_volume_size_in_gb: builtins.int):
        """
        :param builtins.int ebs_volume_size_in_gb: The size of an EBS storage volume for a space.
        """
        pulumi.set(__self__, "ebs_volume_size_in_gb", ebs_volume_size_in_gb)

    @property
    @pulumi.getter(name="ebsVolumeSizeInGb")
    def ebs_volume_size_in_gb(self) -> builtins.int:
        """
...
class SpaceSpaceSharingSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str sharing_type: Specifies the sharing type of the space. Valid values are `Private` and `Shared`.
        """
...
class UserProfileUserSettingsCustomFileSystemConfigEfsFileSystemConfig(dict):
    ...
    def __init__(__self__, *,
                 file_system_id: builtins.str,
                 file_system_path: Optional[builtins.str] = None):
        """
        :param builtins.str file_system_id: The ID of your Amazon EFS file system.
        :param builtins.str file_system_path: The path to the file system directory that is accessible in Amazon SageMaker AI Studio. Permitted users can access only this directory and below.
        """
    ...
    @property
    @pulumi.getter(name="fileSystemPath")
    def file_system_path(self) -> Optional[builtins.str]:
        """
        The path to the file system directory that is accessible in Amazon SageMaker AI Studio. Permitted users can access only this directory and below.
        """
        return pulumi.get(self, "file_system_path")
...
class WorkforceCognitoConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_id: The client ID for your Amazon Cognito user pool.
        :param builtins.str user_pool: ID for your Amazon Cognito user pool.
        """
...
class WorkforceOidcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str authorization_endpoint: The OIDC IdP authorization endpoint used to configure your private workforce.
        :param builtins.str client_id: The OIDC IdP client ID used to configure your private workforce.
        :param builtins.str client_secret: The OIDC IdP client secret used to configure your private workforce.
        :param builtins.str issuer: The OIDC IdP issuer used to configure your private workforce.
        :param builtins.str jwks_uri: The OIDC IdP JSON Web Key Set (Jwks) URI used to configure your private workforce.
        :param builtins.str logout_endpoint: The OIDC IdP logout endpoint used to configure your private workforce.
        :param builtins.str token_endpoint: The OIDC IdP token endpoint used to configure your private workforce.
        :param builtins.str user_info_endpoint: The OIDC IdP user information endpoint used to configure your private workforce.
        :param Mapping[str, builtins.str] authentication_request_extra_params: A string to string map of identifiers specific to the custom identity provider (IdP) being used.
        :param builtins.str scope: An array of string identifiers used to refer to the specific pieces of user data or claims that the client application wants to access.
        """
...
class WorkforceSourceIpConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] cidrs: A list of up to 10 CIDR values.
        """
...
class WorkforceWorkforceVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] security_group_ids: The VPC security group IDs. The security groups must be for the same VPC as specified in the subnet.
        :param Sequence[builtins.str] subnets: The ID of the subnets in the VPC that you want to connect.
        :param builtins.str vpc_endpoint_id: The IDs for the VPC service endpoints of your VPC workforce.
        :param builtins.str vpc_id: The ID of the VPC that the workforce uses for communication.
        """
        if security_group_ids is not None:
            pulumi.set(__self__, "security_group_ids", security_group_ids)
...
class WorkteamMemberDefinitionCognitoMemberDefinition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 user_pool: builtins.str):
        """
        :param builtins.str client_id: An identifier for an application client. You must create the app client ID using Amazon Cognito.
        :param builtins.str user_group: An identifier for a user group.
        :param builtins.str user_pool: An identifier for a user pool. The user pool must be in the same region as the service that you are calling.
        """
        pulumi.set(__self__, "client_id", client_id)
        pulumi.set(__self__, "user_group", user_group)
        pulumi.set(__self__, "user_pool", user_pool)
...
class WorkteamMemberDefinitionOidcMemberDefinition(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] groups: A list of comma separated strings that identifies user groups in your OIDC IdP. Each user group is made up of a group of private workers.
        """
...
class WorkteamNotificationConfiguration(dict):
    ...
    def __init__(__self__, *,
                 notification_topic_arn: Optional[builtins.str] = None):
        """
        :param builtins.str notification_topic_arn: The ARN for the SNS topic to which notifications should be published.
        """
    ...
    def notification_topic_arn(self) -> Optional[builtins.str]:
        """
...
class WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraints(dict):
    ...
    def vpc_source_ip(self) -> Optional[builtins.str]:
        """
        When VpcSourceIp is Enabled the worker's IP address when a task is rendered in private worker portal inside the VPC is added to the IAM policy as a Condition used to generate the Amazon S3 presigned URL. To render the task successfully Amazon S3 checks that the presigned URL is being accessed over an Amazon S3 VPC Endpoint, and that the worker's IP address matches the IP address in the IAM policy. To learn more about configuring private worker portal, see [Use Amazon VPC mode from a private worker portal](https://docs.aws.amazon.com/sagemaker/latest/dg/samurai-vpc-worker-portal.html). Valid values are `Enabled` or `Disabled`
        """
