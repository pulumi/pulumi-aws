...
class FeatureGroupArgs:
    def __init__(__self__, *,
                 event_time_feature_name: pulumi.Input[builtins.str],
                 feature_definitions: pulumi.Input[Sequence[pulumi.Input['FeatureGroupFeatureDefinitionArgs']]],
                 feature_group_name: pulumi.Input[builtins.str],
                 record_identifier_feature_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] event_time_feature_name: The name of the feature that stores the EventTime of a Record in a Feature Group.
        ...
        :param pulumi.Input[builtins.str] feature_group_name: The name of the Feature Group. The name must be unique within an AWS Region in an AWS account.
    ...
    def event_time_feature_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def event_time_feature_name(self, value: pulumi.Input[builtins.str]):
    ...
    def feature_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def feature_group_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "feature_group_name", value)

    @property
    @pulumi.getter(name="recordIdentifierFeatureName")
    def record_identifier_feature_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def record_identifier_feature_name(self, value: pulumi.Input[builtins.str]):
...
class _FeatureGroupState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 event_time_feature_name: Optional[pulumi.Input[builtins.str]] = None,
                 feature_definitions: Optional[pulumi.Input[Sequence[pulumi.Input['FeatureGroupFeatureDefinitionArgs']]]] = None,
                 feature_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 offline_store_config: Optional[pulumi.Input['FeatureGroupOfflineStoreConfigArgs']] = None,
                 online_store_config: Optional[pulumi.Input['FeatureGroupOnlineStoreConfigArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) assigned by AWS to this feature_group.
        :param pulumi.Input[builtins.str] description: A free-form description of a Feature Group.
        :param pulumi.Input[builtins.str] event_time_feature_name: The name of the feature that stores the EventTime of a Record in a Feature Group.
        :param pulumi.Input[Sequence[pulumi.Input['FeatureGroupFeatureDefinitionArgs']]] feature_definitions: A list of Feature names and types. See Feature Definition Below.
        :param pulumi.Input[builtins.str] feature_group_name: The name of the Feature Group. The name must be unique within an AWS Region in an AWS account.
    ...
    @property
    @pulumi.getter(name="eventTimeFeatureName")
    def event_time_feature_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the feature that stores the EventTime of a Record in a Feature Group.
        """
        return pulumi.get(self, "event_time_feature_name")
    ...
    @event_time_feature_name.setter
    def event_time_feature_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_time_feature_name", value)
    ...
    @property
    @pulumi.getter(name="featureGroupName")
    def feature_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Feature Group. The name must be unique within an AWS Region in an AWS account.
        """
        return pulumi.get(self, "feature_group_name")
    ...
    @feature_group_name.setter
    def feature_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "feature_group_name", value)
    ...
    @property
    @pulumi.getter(name="recordIdentifierFeatureName")
    def record_identifier_feature_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the Feature whose value uniquely identifies a Record defined in the Feature Store. Only the latest record per identifier value will be stored in the Online Store.
        """
        return pulumi.get(self, "record_identifier_feature_name")
    ...
    @record_identifier_feature_name.setter
    def record_identifier_feature_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "record_identifier_feature_name", value)
...
class FeatureGroup(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="eventTimeFeatureName")
    def event_time_feature_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the feature that stores the EventTime of a Record in a Feature Group.
        """
        return pulumi.get(self, "event_time_feature_name")
    ...
    @property
    @pulumi.getter(name="featureGroupName")
    def feature_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Feature Group. The name must be unique within an AWS Region in an AWS account.
        """
        return pulumi.get(self, "feature_group_name")
    ...
    @property
    @pulumi.getter(name="recordIdentifierFeatureName")
    def record_identifier_feature_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Feature whose value uniquely identifies a Record defined in the Feature Store. Only the latest record per identifier value will be stored in the Online Store.
        """
        return pulumi.get(self, "record_identifier_feature_name")
