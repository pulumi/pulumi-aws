...
class WorkforceArgs:
    def __init__(__self__, *,
                 workforce_name: pulumi.Input[builtins.str],
    ...
    def workforce_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def workforce_name(self, value: pulumi.Input[builtins.str]):
...
class Workforce(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="workforceName")
    def workforce_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the Workforce (must be unique).
        """
        return pulumi.get(self, "workforce_name")
