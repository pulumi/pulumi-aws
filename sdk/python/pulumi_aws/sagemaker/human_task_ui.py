...
class HumanTaskUI(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if ui_template is not None and not isinstance(ui_template, HumanTaskUIUiTemplateArgs):
                ui_template = ui_template or {}
                def _setter(key, value):
                    ui_template[key] = value
                HumanTaskUIUiTemplateArgs._configure(_setter, **ui_template)
