...
class MonitoringSchedule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if monitoring_schedule_config is not None and not isinstance(monitoring_schedule_config, MonitoringScheduleMonitoringScheduleConfigArgs):
                monitoring_schedule_config = monitoring_schedule_config or {}
                def _setter(key, value):
                    monitoring_schedule_config[key] = value
                MonitoringScheduleMonitoringScheduleConfigArgs._configure(_setter, **monitoring_schedule_config)
