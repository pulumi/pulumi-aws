...
class ModelArgs:
    def __init__(__self__, *,
                 ...
                 enable_network_isolation: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] execution_role_arn: A role that SageMaker AI can assume to access model artifacts and docker images for deployment.
        ...
        :param pulumi.Input[builtins.bool] enable_network_isolation: Isolates the model container. No inbound or outbound network calls can be made to or from the model container.
    ...
    def enable_network_isolation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_network_isolation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ModelState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) assigned by AWS to this model.
        :param pulumi.Input[Sequence[pulumi.Input['ModelContainerArgs']]] containers: Specifies containers in the inference pipeline. If not specified, the `primary_container` argument is required. Fields are documented below.
        :param pulumi.Input[builtins.bool] enable_network_isolation: Isolates the model container. No inbound or outbound network calls can be made to or from the model container.
        :param pulumi.Input[builtins.str] execution_role_arn: A role that SageMaker AI can assume to access model artifacts and docker images for deployment.
        :param pulumi.Input['ModelInferenceExecutionConfigArgs'] inference_execution_config: Specifies details of how containers in a multi-container endpoint are called. see Inference Execution Config.
...
class Model(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableNetworkIsolation")
    def enable_network_isolation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Isolates the model container. No inbound or outbound network calls can be made to or from the model container.
        """
        return pulumi.get(self, "enable_network_isolation")
