...
class AppImageConfigCodeEditorAppImageConfigContainerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] container_arguments: The arguments for the container when you're running the application.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] container_entrypoints: The entrypoint used to run the application in the container.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] container_environment_variables: The environment variables to set in the container.
        """
...
class AppImageConfigCodeEditorAppImageConfigFileSystemConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] default_gid: The default POSIX group ID (GID). If not specified, defaults to `100`. Valid values are `0` and `100`.
        :param pulumi.Input[_builtins.int] default_uid: The default POSIX user ID (UID). If not specified, defaults to `1000`. Valid values are `0` and `1000`.
...
class AppImageConfigKernelGatewayImageConfigKernelSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] name: The name of the kernel.
        :param pulumi.Input[_builtins.str] display_name: The display name of the kernel.
        """
...
class AppResourceSpecArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] instance_type: The instance type that the image version runs on. For valid values see [SageMaker AI Instance Types](https://docs.aws.amazon.com/sagemaker/latest/dg/notebooks-available-instance-types.html).
        :param pulumi.Input[_builtins.str] lifecycle_config_arn: The Amazon Resource Name (ARN) of the Lifecycle Configuration attached to the Resource.
        :param pulumi.Input[_builtins.str] sagemaker_image_arn: The ARN of the SageMaker AI image that the image version belongs to.
        :param pulumi.Input[_builtins.str] sagemaker_image_version_alias: The SageMaker AI Image Version Alias.
        :param pulumi.Input[_builtins.str] sagemaker_image_version_arn: The ARN of the image version created on the instance.
        """
...
class CodeRepositoryGitConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] secret_arn: The Amazon Resource Name (ARN) of the AWS Secrets Manager secret that contains the credentials used to access the git repository. The secret must have a staging label of AWSCURRENT and must be in the following format: `{"username": UserName, "password": Password}`
        """
...
class DataQualityJobDefinitionDataQualityAppSpecificationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] image_uri: The container image that the data quality monitoring job runs.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] environment: Sets the environment variables in the container that the monitoring job runs. A list of key value pairs.
        :param pulumi.Input[_builtins.str] post_analytics_processor_source_uri: An Amazon S3 URI to a script that is called after analysis has been performed. Applicable only for the built-in (first party) containers.
        :param pulumi.Input[_builtins.str] record_preprocessor_source_uri: An Amazon S3 URI to a script that is called per row prior to running analysis. It can base64 decode the payload and convert it into a flatted json so that the built-in container can use the converted data. Applicable only for the built-in (first party) containers.
        """
...
class DataQualityJobDefinitionDataQualityBaselineConfigConstraintsResourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] s3_uri: The Amazon S3 URI for the constraints resource.
        """
...
class DataQualityJobDefinitionDataQualityBaselineConfigStatisticsResourceArgs:
    def __init__(__self__, *,
                 s3_uri: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] s3_uri: The Amazon S3 URI for the statistics resource.
        """
        if s3_uri is not None:
            pulumi.set(__self__, "s3_uri", s3_uri)
...
class DataQualityJobDefinitionDataQualityJobInputBatchTransformInputArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] data_captured_destination_s3_uri: The Amazon S3 location being used to capture the data.
        ...
        :param pulumi.Input[_builtins.str] local_path: Path to the filesystem where the batch transform data is available to the container. Defaults to `/opt/ml/processing/input`.
        :param pulumi.Input[_builtins.str] s3_data_distribution_type: Whether input data distributed in Amazon S3 is fully replicated or sharded by an S3 key. Defaults to `FullyReplicated`. Valid values are `FullyReplicated` or `ShardedByS3Key`
        :param pulumi.Input[_builtins.str] s3_input_mode: Whether the `Pipe` or `File` is used as the input mode for transferring data for the monitoring job. `Pipe` mode is recommended for large datasets. `File` mode is useful for small files that fit in memory. Defaults to `File`.  Valid values are `Pipe` or `File`
        """
...
class DataQualityJobDefinitionDataQualityJobInputEndpointInputArgs:
    def __init__(__self__, *,
                 ...
                 s3_input_mode: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] endpoint_name: An endpoint in customer's account which has `data_capture_config` enabled.
        :param pulumi.Input[_builtins.str] local_path: Path to the filesystem where the endpoint data is available to the container. Defaults to `/opt/ml/processing/input`.
        :param pulumi.Input[_builtins.str] s3_data_distribution_type: Whether input data distributed in Amazon S3 is fully replicated or sharded by an S3 key. Defaults to `FullyReplicated`. Valid values are `FullyReplicated` or `ShardedByS3Key`
        :param pulumi.Input[_builtins.str] s3_input_mode: Whether the `Pipe` or `File` is used as the input mode for transferring data for the monitoring job. `Pipe` mode is recommended for large datasets. `File` mode is useful for small files that fit in memory. Defaults to `File`.  Valid values are `Pipe` or `File`
        """
...
class DataQualityJobDefinitionDataQualityJobOutputConfigMonitoringOutputsS3OutputArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] s3_uri: A URI that identifies the Amazon S3 storage location where Amazon SageMaker AI saves the results of a monitoring job.
        :param pulumi.Input[_builtins.str] local_path: The local path to the Amazon S3 storage location where Amazon SageMaker AI saves the results of a monitoring job. LocalPath is an absolute path for the output data. Defaults to `/opt/ml/processing/output`.
        :param pulumi.Input[_builtins.str] s3_upload_mode: Whether to upload the results of the monitoring job continuously or after the job completes. Valid values are `Continuous` or `EndOfJob`
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
        if local_path is not None:
            pulumi.set(__self__, "local_path", local_path)
...
class DataQualityJobDefinitionJobResourcesClusterConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] instance_count: The number of ML compute instances to use in the model monitoring job. For distributed processing jobs, specify a value greater than 1.
        ...
        :param pulumi.Input[_builtins.str] volume_kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker AI uses to encrypt data on the storage volume attached to the ML compute instance(s) that run the model monitoring job.
        """
...
class DataQualityJobDefinitionNetworkConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.bool] enable_inter_container_traffic_encryption: Whether to encrypt all communications between the instances used for the monitoring jobs. Choose `true` to encrypt communications. Encryption provides greater security for distributed jobs, but the processing might take longer.
        :param pulumi.Input[_builtins.bool] enable_network_isolation: Whether to allow inbound and outbound network calls to and from the containers used for the monitoring job.
...
class DeviceDeviceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: A description for the device.
        :param pulumi.Input[_builtins.str] iot_thing_name: Amazon Web Services Internet of Things (IoT) object name.
        """
...
class DeviceFleetOutputConfigArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] s3_output_location: The Amazon Simple Storage (S3) bucker URI.
        :param pulumi.Input[_builtins.str] kms_key_id: The AWS Key Management Service (AWS KMS) key that Amazon SageMaker AI uses to encrypt data on the storage volume after compilation job. If you don't provide a KMS key ID, Amazon SageMaker AI uses the default KMS key for Amazon S3 for your role's account.
        """
...
class DomainDefaultSpaceSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_groups: The security groups for the Amazon Virtual Private Cloud that the space uses for communication.
...
class DomainDefaultSpaceSettingsCustomFileSystemConfigEfsFileSystemConfigArgs:
    def __init__(__self__, *,
                 ...
                 file_system_path: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] file_system_id: The ID of your Amazon EFS file system.
        :param pulumi.Input[_builtins.str] file_system_path: The path to the file system directory that is accessible in Amazon SageMaker AI Studio. Permitted users can access only this directory and below.
        """
...
class DomainDefaultSpaceSettingsCustomPosixUserConfigArgs:
    def __init__(__self__, *,
                 ...
                 uid: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] gid: The POSIX group ID.
        :param pulumi.Input[_builtins.int] uid: The POSIX user ID.
        """
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] built_in_lifecycle_config_arn: The lifecycle configuration that runs before the default lifecycle configuration. It can override changes made in the default lifecycle configuration.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] lifecycle_config_arns: The Amazon Resource Name (ARN) of the Lifecycle Configurations.
        """
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsAppLifecycleManagementIdleSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] idle_timeout_in_minutes: The time that SageMaker AI waits after the application becomes idle before shutting it down. Valid values are between `60` and `525600`.
        :param pulumi.Input[_builtins.str] lifecycle_management: Indicates whether idle shutdown is activated for the application type. Valid values are `ENABLED` and `DISABLED`.
        :param pulumi.Input[_builtins.int] max_idle_timeout_in_minutes: The maximum value in minutes that custom idle shutdown can be set to by the user. Valid values are between `60` and `525600`.
        :param pulumi.Input[_builtins.int] min_idle_timeout_in_minutes: The minimum value in minutes that custom idle shutdown can be set to by the user. Valid values are between `60` and `525600`.
        """
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsCodeRepositoryArgs:
    def __init__(__self__, *,
                 repository_url: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] repository_url: The URL of the Git repository.
        """
        pulumi.set(__self__, "repository_url", repository_url)
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsCustomImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] image_name: The name of the Custom Image.
        :param pulumi.Input[_builtins.int] image_version_number: The version number of the Custom Image.
        """
...
class DomainDefaultSpaceSettingsJupyterLabAppSettingsEmrSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] assumable_role_arns: An array of Amazon Resource Names (ARNs) of the IAM roles that the execution role of SageMaker AI can assume for performing operations or tasks related to Amazon EMR clusters or Amazon EMR Serverless applications. These roles define the permissions and access policies required when performing Amazon EMR-related operations, such as listing, connecting to, or terminating Amazon EMR clusters or Amazon EMR Serverless applications. They are typically used in cross-account access scenarios, where the Amazon EMR resources (clusters or serverless applications) are located in a different AWS account than the SageMaker AI domain.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] execution_role_arns: An array of Amazon Resource Names (ARNs) of the IAM roles used by the Amazon EMR cluster instances or job execution environments to access other AWS services and resources needed during the runtime of your Amazon EMR or Amazon EMR Serverless workloads, such as Amazon S3 for data access, Amazon CloudWatch for logging, or other AWS services based on the particular workload requirements.
        """
...
class DomainDefaultSpaceSettingsSpaceStorageSettingsDefaultEbsStorageSettingsArgs:
    def __init__(__self__, *,
                 ...
                 maximum_ebs_volume_size_in_gb: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] default_ebs_volume_size_in_gb: The default size of the EBS storage volume for a private space.
        :param pulumi.Input[_builtins.int] maximum_ebs_volume_size_in_gb: The maximum size of the EBS storage volume for a private space.
        """
...
class DomainDefaultUserSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] execution_role: The execution role ARN for the user.
        :param pulumi.Input[_builtins.str] auto_mount_home_efs: Indicates whether auto-mounting of an EFS volume is supported for the user profile. The `DefaultAsDomain` value is only supported for user profiles. Do not use the `DefaultAsDomain` value when setting this parameter for a domain. Valid values are: `Enabled`, `Disabled`, and `DefaultAsDomain`.
        ...
        :param pulumi.Input[_builtins.str] default_landing_uri: The default experience that the user is directed to when accessing the domain. The supported values are: `studio::`: Indicates that Studio is the default experience. This value can only be passed if StudioWebPortal is set to ENABLED. `app:JupyterServer:`: Indicates that Studio Classic is the default experience.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_groups: A list of security group IDs that will be attached to the user.
        ...
        :param pulumi.Input[_builtins.str] studio_web_portal: Whether the user can access Studio. If this value is set to `DISABLED`, the user cannot access Studio, even if that is the default experience for the domain. Valid values are `ENABLED` and `DISABLED`.
...
class DomainDefaultUserSettingsCanvasAppSettingsDirectDeploySettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] status: Describes whether model deployment permissions are enabled or disabled in the Canvas application. Valid values are `ENABLED` and `DISABLED`.
        """
...
class DomainDefaultUserSettingsCanvasAppSettingsEmrServerlessSettingsArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] execution_role_arn: The Amazon Resource Name (ARN) of the AWS IAM role that is assumed for running Amazon EMR Serverless jobs in SageMaker AI Canvas. This role should have the necessary permissions to read and write data attached and a trust relationship with EMR Serverless.
        :param pulumi.Input[_builtins.str] status: Describes whether Amazon EMR Serverless job capabilities are enabled or disabled in the SageMaker AI Canvas application. Valid values are: `ENABLED` and `DISABLED`.
        """
...
class DomainDefaultUserSettingsCanvasAppSettingsIdentityProviderOauthSettingArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] secret_arn: The ARN of an Amazon Web Services Secrets Manager secret that stores the credentials from your identity provider, such as the client ID and secret, authorization URL, and token URL.
        :param pulumi.Input[_builtins.str] data_source_name: The name of the data source that you're connecting to. Canvas currently supports OAuth for Snowflake and Salesforce Data Cloud. Valid values are `SalesforceGenie` and `Snowflake`.
        :param pulumi.Input[_builtins.str] status: Describes whether OAuth for a data source is enabled or disabled in the Canvas application. Valid values are `ENABLED` and `DISABLED`.
        """
        pulumi.set(__self__, "secret_arn", secret_arn)
...
class DomainDefaultUserSettingsCanvasAppSettingsKendraSettingsArgs:
    def __init__(__self__, *,
                 status: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] status: Describes whether the document querying feature is enabled or disabled in the Canvas application. Valid values are `ENABLED` and `DISABLED`.
        """
        if status is not None:
            pulumi.set(__self__, "status", status)
...
class DomainDefaultUserSettingsCanvasAppSettingsModelRegisterSettingsArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] cross_account_model_register_role_arn: The Amazon Resource Name (ARN) of the SageMaker AI model registry account. Required only to register model versions created by a different SageMaker AI Canvas AWS account than the AWS account in which SageMaker AI model registry is set up.
        :param pulumi.Input[_builtins.str] status: Describes whether the integration to the model registry is enabled or disabled in the Canvas application. Valid values are `ENABLED` and `DISABLED`.
        """
...
class DomainDefaultUserSettingsCanvasAppSettingsTimeSeriesForecastingSettingsArgs:
    def __init__(__self__, *,
                 ...
                 status: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] amazon_forecast_role_arn: The IAM role that Canvas passes to Amazon Forecast for time series forecasting. By default, Canvas uses the execution role specified in the UserProfile that launches the Canvas app. If an execution role is not specified in the UserProfile, Canvas uses the execution role specified in the Domain that owns the UserProfile. To allow time series forecasting, this IAM role should have the [AmazonSageMakerCanvasForecastAccess](https://docs.aws.amazon.com/sagemaker/latest/dg/security-iam-awsmanpol-canvas.html#security-iam-awsmanpol-AmazonSageMakerCanvasForecastAccess) policy attached and forecast.amazonaws.com added in the trust relationship as a service principal.
        :param pulumi.Input[_builtins.str] status: Describes whether time series forecasting is enabled or disabled in the Canvas app. Valid values are `ENABLED` and `DISABLED`.
        """
...
class DomainDefaultUserSettingsCanvasAppSettingsWorkspaceSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] s3_artifact_path: The Amazon S3 bucket used to store artifacts generated by Canvas. Updating the Amazon S3 location impacts existing configuration settings, and Canvas users no longer have access to their artifacts. Canvas users must log out and log back in to apply the new location.
        :param pulumi.Input[_builtins.str] s3_kms_key_id: The Amazon Web Services Key Management Service (KMS) encryption key ID that is used to encrypt artifacts generated by Canvas in the Amazon S3 bucket.
        """
...
class DomainDefaultUserSettingsRStudioServerProAppSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] access_status: Indicates whether the current user has access to the RStudioServerPro app. Valid values are `ENABLED` and `DISABLED`.
        :param pulumi.Input[_builtins.str] user_group: The level of permissions that the user has within the RStudioServerPro app. This value defaults to `R_STUDIO_USER`. The `R_STUDIO_ADMIN` value allows the user access to the RStudio Administrative Dashboard. Valid values are `R_STUDIO_USER` and `R_STUDIO_ADMIN`.
        """
...
class DomainDefaultUserSettingsSharingSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] notebook_output_option: Whether to include the notebook cell output when sharing the notebook. The default is `Disabled`. Valid values are `Allowed` and `Disabled`.
        :param pulumi.Input[_builtins.str] s3_kms_key_id: When `notebook_output_option` is Allowed, the AWS Key Management Service (KMS) encryption key ID used to encrypt the notebook cell output in the Amazon S3 bucket.
        :param pulumi.Input[_builtins.str] s3_output_path: When `notebook_output_option` is Allowed, the Amazon S3 bucket used to save the notebook cell output.
        """
...
class DomainDefaultUserSettingsStudioWebPortalSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] hidden_app_types: The Applications supported in Studio that are hidden from the Studio left navigation pane.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] hidden_instance_types: The instance types you are hiding from the Studio user interface.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] hidden_ml_tools: The machine learning tools that are hidden from the Studio left navigation pane.
        """
...
class DomainDomainSettingsDockerSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] enable_docker_access: Indicates whether the domain can access Docker. Valid values are `ENABLED` and `DISABLED`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vpc_only_trusted_accounts: The list of Amazon Web Services accounts that are trusted when the domain is created in VPC-only mode.
        """
...
class DomainDomainSettingsRStudioServerProDomainSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] r_studio_package_manager_url: A URL pointing to an RStudio Package Manager server.
        """
...
class DomainRetentionPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] home_efs_file_system: The retention policy for data stored on an Amazon Elastic File System (EFS) volume. Valid values are `Retain` or `Delete`.  Default value is `Retain`.
        """
...
class EndpointDeploymentConfigAutoRollbackConfigurationAlarmArgs:
    def __init__(__self__, *,
                 alarm_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] alarm_name: The name of a CloudWatch alarm in your account.
        """
...
class EndpointDeploymentConfigBlueGreenUpdatePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] termination_wait_in_seconds: Additional waiting time in seconds after the completion of an endpoint deployment before terminating the old endpoint fleet. Default is `0`. Valid values are between `0` and `3600`.
        """
...
class EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] type: Traffic routing strategy type. Valid values are: `ALL_AT_ONCE`, `CANARY`, and `LINEAR`.
        :param pulumi.Input[_builtins.int] wait_interval_in_seconds: The waiting time (in seconds) between incremental steps to turn on traffic on the new endpoint fleet. Valid values are between `0` and `3600`.
...
class EndpointDeploymentConfigBlueGreenUpdatePolicyTrafficRoutingConfigurationCanarySizeArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.str] type: Specifies the endpoint capacity type. Valid values are: `INSTANCE_COUNT`, or `CAPACITY_PERCENT`.
        :param pulumi.Input[_builtins.int] value: Defines the capacity size, either as a number of instances or a capacity percentage.
        """
        pulumi.set(__self__, "type", type)
...
class EndpointDeploymentConfigRollingUpdatePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] wait_interval_in_seconds: The length of the baking period, during which SageMaker AI monitors alarms for each batch on the new fleet. Valid values are between `0` and `3600`.
        :param pulumi.Input[_builtins.int] maximum_execution_timeout_in_seconds: The time limit for the total deployment. Exceeding this limit causes a timeout. Valid values are between `600` and `14400`.
...
class FeatureGroupFeatureDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] feature_name: The name of a feature. `feature_name` cannot be any of the following: `is_deleted`, `write_time`, `api_invocation_time`.
        :param pulumi.Input[_builtins.str] feature_type: The value type of a feature. Valid values are `Integral`, `Fractional`, or `String`.
        """
...
class FeatureGroupOfflineStoreConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] disable_glue_table_creation: Set to `true` to turn Online Store On.
        :param pulumi.Input[_builtins.str] table_format: Format for the offline store table. Supported formats are `Glue` (Default) and Apache `Iceberg` (https://iceberg.apache.org/).
        """
...
class FeatureGroupOfflineStoreConfigDataCatalogConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] catalog: The name of the Glue table catalog.
        :param pulumi.Input[_builtins.str] database: The name of the Glue table database.
        :param pulumi.Input[_builtins.str] table_name: The name of the Glue table.
        """
...
class FeatureGroupOfflineStoreConfigS3StorageConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] s3_uri: The S3 URI, or location in Amazon S3, of OfflineStore.
        :param pulumi.Input[_builtins.str] kms_key_id: The AWS Key Management Service (KMS) key ID of the key used to encrypt any objects written into the OfflineStore S3 location.
        :param pulumi.Input[_builtins.str] resolved_output_s3_uri: The S3 path where offline records are written.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class FeatureGroupOnlineStoreConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.bool] enable_online_store: Set to `true` to disable the automatic creation of an AWS Glue table when configuring an OfflineStore.
        ...
        :param pulumi.Input[_builtins.str] storage_type: Option for different tiers of low latency storage for real-time data retrieval. Valid values are `Standard`, or `InMemory`.
...
class FeatureGroupOnlineStoreConfigSecurityConfigArgs:
    def __init__(__self__, *,
                 kms_key_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] kms_key_id: The ID of the AWS Key Management Service (AWS KMS) key that SageMaker AI Feature Store uses to encrypt the Amazon S3 objects at rest using Amazon S3 server-side encryption.
        """
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class FeatureGroupOnlineStoreConfigTtlDurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] unit: TtlDuration time unit. Valid values are `Seconds`, `Minutes`, `Hours`, `Days`, or `Weeks`.
...
class FlowDefinitionHumanLoopActivationConfigHumanLoopActivationConditionsConfigArgs:
    def __init__(__self__, *,
                 human_loop_activation_conditions: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] human_loop_activation_conditions: A JSON expressing use-case specific conditions declaratively. If any condition is matched, atomic tasks are created against the configured work team. For more information about how to structure the JSON, see [JSON Schema for Human Loop Activation Conditions in Amazon Augmented AI](https://docs.aws.amazon.com/sagemaker/latest/dg/a2i-human-fallback-conditions-json-schema.html).
        """
...
class FlowDefinitionHumanLoopConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] human_task_ui_arn: The Amazon Resource Name (ARN) of the human task user interface.
        :param pulumi.Input[_builtins.int] task_count: The number of distinct workers who will perform the same task on each object. Valid value range between `1` and `3`.
        :param pulumi.Input[_builtins.str] task_description: A description for the human worker task.
        :param pulumi.Input[_builtins.str] task_title: A title for the human worker task.
        :param pulumi.Input[_builtins.str] workteam_arn: The Amazon Resource Name (ARN) of the human task user interface. Amazon Resource Name (ARN) of a team of workers. For Public workforces see [AWS Docs](https://docs.aws.amazon.com/sagemaker/latest/dg/sms-workforce-management-public.html).
        ...
        :param pulumi.Input[_builtins.int] task_availability_lifetime_in_seconds: The length of time that a task remains available for review by human workers. Valid value range between `1` and `864000`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] task_keywords: An array of keywords used to describe the task so that workers can discover the task.
        :param pulumi.Input[_builtins.int] task_time_limit_in_seconds: The amount of time that a worker has to complete a task. The default value is `3600` seconds.
        """
...
class FlowDefinitionHumanLoopConfigPublicWorkforceTaskPriceAmountInUsdArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.int] cents: The fractional portion, in cents, of the amount. Valid value range between `0` and `99`.
        :param pulumi.Input[_builtins.int] dollars: The whole number of dollars in the amount. Valid value range between `0` and `2`.
        :param pulumi.Input[_builtins.int] tenth_fractions_of_a_cent: Fractions of a cent, in tenths. Valid value range between `0` and `9`.
        """
...
class FlowDefinitionHumanLoopRequestSourceArgs:
    def __init__(__self__, *,
                 aws_managed_human_loop_request_source: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] aws_managed_human_loop_request_source: Specifies whether Amazon Rekognition or Amazon Textract are used as the integration source. Valid values are: `AWS/Rekognition/DetectModerationLabels/Image/V3` and `AWS/Textract/AnalyzeDocument/Forms/V1`.
        """
...
class FlowDefinitionOutputConfigArgs:
    def __init__(__self__, *,
                 ...
                 kms_key_id: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] s3_output_path: The Amazon S3 path where the object containing human output will be made available.
        :param pulumi.Input[_builtins.str] kms_key_id: The Amazon Key Management Service (KMS) key ARN for server-side encryption.
        """
        pulumi.set(__self__, "s3_output_path", s3_output_path)
        if kms_key_id is not None:
            pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class HubS3StorageConfigArgs:
    def __init__(__self__, *,
                 s3_output_path: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] s3_output_path: The Amazon S3 bucket prefix for hosting hub content.interface.
        """
        if s3_output_path is not None:
            pulumi.set(__self__, "s3_output_path", s3_output_path)
...
class HumanTaskUIUiTemplateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] content: The content of the Liquid template for the worker user interface.
        :param pulumi.Input[_builtins.str] content_sha256: The SHA-256 digest of the contents of the template.
        :param pulumi.Input[_builtins.str] url: The URL for the user interface template.
        """
...
class ModelContainerImageConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] repository_access_mode: Specifies whether the model container is in Amazon ECR or a private Docker registry accessible from your Amazon Virtual Private Cloud (VPC). Allowed values are: `Platform` and `Vpc`.
...
class ModelContainerMultiModelConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] model_cache_setting: Whether to cache models for a multi-model endpoint. By default, multi-model endpoints cache models so that a model does not have to be loaded into memory each time it is invoked. Some use cases do not benefit from model caching. For example, if an endpoint hosts a large number of models that are each invoked infrequently, the endpoint might perform better if you disable model caching. To disable model caching, set the value of this parameter to `Disabled`. Allowed values are: `Enabled` and `Disabled`.
        """
...
class MonitoringScheduleMonitoringScheduleConfigScheduleConfigArgs:
    def __init__(__self__, *,
                 schedule_expression: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] schedule_expression: A cron expression that describes details about the monitoring schedule. For example, and hourly schedule would be `cron(0 * ? * * *)`.
        """
...
class NotebookInstanceInstanceMetadataServiceConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] minimum_instance_metadata_service_version: Indicates the minimum IMDS version that the notebook instance supports. When passed "1" is passed. This means that both IMDSv1 and IMDSv2 are supported. Valid values are `1` and `2`.
        """
...
class PipelineParallelismConfigurationArgs:
    def __init__(__self__, *,
                 max_parallel_execution_steps: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] max_parallel_execution_steps: The max number of steps that can be executed in parallel.
        """
...
class PipelinePipelineDefinitionS3LocationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] object_key: The object key (or key name) uniquely identifies the object in an S3 bucket.
        :param pulumi.Input[_builtins.str] version_id: Version Id of the pipeline definition file. If not specified, Amazon SageMaker AI will retrieve the latest version.
        """
...
class ProjectServiceCatalogProvisioningDetailsProvisioningParameterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] key: The key that identifies a provisioning parameter.
        :param pulumi.Input[_builtins.str] value: The value of the provisioning parameter.
        """
...
class SpaceOwnershipSettingsArgs:
    def __init__(__self__, *,
                 owner_user_profile_name: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] owner_user_profile_name: The user profile who is the owner of the private space.
        """
...
class SpaceSpaceSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] app_type: The type of app created within the space.
...
class SpaceSpaceSettingsCodeEditorAppSettingsDefaultResourceSpecArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] lifecycle_config_arn: The Amazon Resource Name (ARN) of the Lifecycle Configuration attached to the Resource.
        :param pulumi.Input[_builtins.str] sagemaker_image_arn: The Amazon Resource Name (ARN) of the SageMaker AI image created on the instance.
        :param pulumi.Input[_builtins.str] sagemaker_image_version_alias: The SageMaker AI Image Version Alias.
        :param pulumi.Input[_builtins.str] sagemaker_image_version_arn: The ARN of the image version created on the instance.
        """
        if instance_type is not None:
...
class SpaceSpaceSettingsSpaceStorageSettingsEbsStorageSettingsArgs:
    def __init__(__self__, *,
                 ebs_volume_size_in_gb: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] ebs_volume_size_in_gb: The size of an EBS storage volume for a space.
        """
...
class SpaceSpaceSharingSettingsArgs:
    def __init__(__self__, *,
                 sharing_type: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] sharing_type: Specifies the sharing type of the space. Valid values are `Private` and `Shared`.
        """
...
class WorkforceCognitoConfigArgs:
    def __init__(__self__, *,
                 ...
                 user_pool: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] client_id: The client ID for your Amazon Cognito user pool.
        :param pulumi.Input[_builtins.str] user_pool: ID for your Amazon Cognito user pool.
        """
...
class WorkforceOidcConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] authorization_endpoint: The OIDC IdP authorization endpoint used to configure your private workforce.
        :param pulumi.Input[_builtins.str] client_id: The OIDC IdP client ID used to configure your private workforce.
        :param pulumi.Input[_builtins.str] client_secret: The OIDC IdP client secret used to configure your private workforce.
        :param pulumi.Input[_builtins.str] issuer: The OIDC IdP issuer used to configure your private workforce.
        :param pulumi.Input[_builtins.str] jwks_uri: The OIDC IdP JSON Web Key Set (Jwks) URI used to configure your private workforce.
        :param pulumi.Input[_builtins.str] logout_endpoint: The OIDC IdP logout endpoint used to configure your private workforce.
        :param pulumi.Input[_builtins.str] token_endpoint: The OIDC IdP token endpoint used to configure your private workforce.
        :param pulumi.Input[_builtins.str] user_info_endpoint: The OIDC IdP user information endpoint used to configure your private workforce.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] authentication_request_extra_params: A string to string map of identifiers specific to the custom identity provider (IdP) being used.
        :param pulumi.Input[_builtins.str] scope: An array of string identifiers used to refer to the specific pieces of user data or claims that the client application wants to access.
        """
...
class WorkforceSourceIpConfigArgs:
    def __init__(__self__, *,
                 cidrs: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] cidrs: A list of up to 10 CIDR values.
        """
...
class WorkforceWorkforceVpcConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] security_group_ids: The VPC security group IDs. The security groups must be for the same VPC as specified in the subnet.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subnets: The ID of the subnets in the VPC that you want to connect.
        :param pulumi.Input[_builtins.str] vpc_endpoint_id: The IDs for the VPC service endpoints of your VPC workforce.
        :param pulumi.Input[_builtins.str] vpc_id: The ID of the VPC that the workforce uses for communication.
        """
        if security_group_ids is not None:
            pulumi.set(__self__, "security_group_ids", security_group_ids)
...
class WorkteamMemberDefinitionCognitoMemberDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 user_pool: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] client_id: An identifier for an application client. You must create the app client ID using Amazon Cognito.
        :param pulumi.Input[_builtins.str] user_group: An identifier for a user group.
        :param pulumi.Input[_builtins.str] user_pool: An identifier for a user pool. The user pool must be in the same region as the service that you are calling.
        """
        pulumi.set(__self__, "client_id", client_id)
        pulumi.set(__self__, "user_group", user_group)
        pulumi.set(__self__, "user_pool", user_pool)
...
class WorkteamMemberDefinitionOidcMemberDefinitionArgs:
    def __init__(__self__, *,
                 groups: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] groups: A list of comma separated strings that identifies user groups in your OIDC IdP. Each user group is made up of a group of private workers.
        """
...
class WorkteamNotificationConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] notification_topic_arn: The ARN for the SNS topic to which notifications should be published.
        """
...
class WorkteamWorkerAccessConfigurationS3PresignIamPolicyConstraintsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] source_ip: When SourceIp is Enabled the worker's IP address when a task is rendered in the worker portal is added to the IAM policy as a Condition used to generate the Amazon S3 presigned URL. This IP address is checked by Amazon S3 and must match in order for the Amazon S3 resource to be rendered in the worker portal. Valid values are `Enabled` or `Disabled`
        :param pulumi.Input[_builtins.str] vpc_source_ip: When VpcSourceIp is Enabled the worker's IP address when a task is rendered in private worker portal inside the VPC is added to the IAM policy as a Condition used to generate the Amazon S3 presigned URL. To render the task successfully Amazon S3 checks that the presigned URL is being accessed over an Amazon S3 VPC Endpoint, and that the worker's IP address matches the IP address in the IAM policy. To learn more about configuring private worker portal, see [Use Amazon VPC mode from a private worker portal](https://docs.aws.amazon.com/sagemaker/latest/dg/samurai-vpc-worker-portal.html). Valid values are `Enabled` or `Disabled`
        """
