...
class EndpointArgs:
    ...
    def endpoint_config_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def endpoint_config_name(self, value: pulumi.Input[builtins.str]):
...
class _EndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) assigned by AWS to this endpoint.
        :param pulumi.Input['EndpointDeploymentConfigArgs'] deployment_config: The deployment configuration for an endpoint, which contains the desired deployment strategy and rollback configurations. See Deployment Config.
        :param pulumi.Input[builtins.str] endpoint_config_name: The name of the endpoint configuration to use.
        :param pulumi.Input[builtins.str] name: The name of the endpoint. If omitted, the provider will assign a random, unique name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the resource. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    @property
    @pulumi.getter(name="endpointConfigName")
    def endpoint_config_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the endpoint configuration to use.
        """
        return pulumi.get(self, "endpoint_config_name")
    ...
    @endpoint_config_name.setter
    def endpoint_config_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "endpoint_config_name", value)
...
class Endpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="endpointConfigName")
    def endpoint_config_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the endpoint configuration to use.
        """
        return pulumi.get(self, "endpoint_config_name")
