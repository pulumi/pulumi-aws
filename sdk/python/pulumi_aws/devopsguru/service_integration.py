...
class ServiceIntegrationArgs:
    def __init__(__self__, *,
                 kms_server_side_encryption: pulumi.Input['ServiceIntegrationKmsServerSideEncryptionArgs'],
                 logs_anomaly_detection: pulumi.Input['ServiceIntegrationLogsAnomalyDetectionArgs'],
    ...
    def kms_server_side_encryption(self, value: pulumi.Input['ServiceIntegrationKmsServerSideEncryptionArgs']):
    ...
    def logs_anomaly_detection(self, value: pulumi.Input['ServiceIntegrationLogsAnomalyDetectionArgs']):
...
class _ServiceIntegrationState:
    def __init__(__self__, *,
                 kms_server_side_encryption: pulumi.Input[Optional['ServiceIntegrationKmsServerSideEncryptionArgs']] = None,
                 logs_anomaly_detection: pulumi.Input[Optional['ServiceIntegrationLogsAnomalyDetectionArgs']] = None,
                 ops_center: pulumi.Input[Optional['ServiceIntegrationOpsCenterArgs']] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="kmsServerSideEncryption")
    def kms_server_side_encryption(self) -> pulumi.Input[Optional['ServiceIntegrationKmsServerSideEncryptionArgs']]:
        """
        Information about whether DevOps Guru is configured to encrypt server-side data using KMS. See `kms_server_side_encryption` below.
        """
        return pulumi.get(self, "kms_server_side_encryption")
    ...
    @kms_server_side_encryption.setter
    def kms_server_side_encryption(self, value: pulumi.Input[Optional['ServiceIntegrationKmsServerSideEncryptionArgs']]):
        pulumi.set(self, "kms_server_side_encryption", value)

    @_builtins.property
    @pulumi.getter(name="logsAnomalyDetection")
    def logs_anomaly_detection(self) -> pulumi.Input[Optional['ServiceIntegrationLogsAnomalyDetectionArgs']]:
        """
        Information about whether DevOps Guru is configured to perform log anomaly detection on Amazon CloudWatch log groups. See `logs_anomaly_detection` below.
        """
        return pulumi.get(self, "logs_anomaly_detection")
    ...
    @logs_anomaly_detection.setter
    def logs_anomaly_detection(self, value: pulumi.Input[Optional['ServiceIntegrationLogsAnomalyDetectionArgs']]):
        pulumi.set(self, "logs_anomaly_detection", value)

    @_builtins.property
    @pulumi.getter(name="opsCenter")
    def ops_center(self) -> pulumi.Input[Optional['ServiceIntegrationOpsCenterArgs']]:
        """
        Information about whether DevOps Guru is configured to create an OpsItem in AWS Systems Manager OpsCenter for each created insight. See `ops_center` below.
        """
        return pulumi.get(self, "ops_center")
    ...
    @ops_center.setter
    def ops_center(self, value: pulumi.Input[Optional['ServiceIntegrationOpsCenterArgs']]):
        pulumi.set(self, "ops_center", value)
...
class ServiceIntegration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kms_server_side_encryption: pulumi.Input[Optional[Union['ServiceIntegrationKmsServerSideEncryptionArgs', 'ServiceIntegrationKmsServerSideEncryptionArgsDict', 'outputs.ServiceIntegrationKmsServerSideEncryption']]] = None,
                 logs_anomaly_detection: pulumi.Input[Optional[Union['ServiceIntegrationLogsAnomalyDetectionArgs', 'ServiceIntegrationLogsAnomalyDetectionArgsDict', 'outputs.ServiceIntegrationLogsAnomalyDetection']]] = None,
                 ops_center: pulumi.Input[Optional[Union['ServiceIntegrationOpsCenterArgs', 'ServiceIntegrationOpsCenterArgsDict', 'outputs.ServiceIntegrationOpsCenter']]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        * `region` (String) Region where this resource is managed.
        ...
        :param pulumi.Input[Union['ServiceIntegrationKmsServerSideEncryptionArgs', 'ServiceIntegrationKmsServerSideEncryptionArgsDict', 'outputs.ServiceIntegrationKmsServerSideEncryption']] kms_server_side_encryption: Information about whether DevOps Guru is configured to encrypt server-side data using KMS. See `kms_server_side_encryption` below.
        :param pulumi.Input[Union['ServiceIntegrationLogsAnomalyDetectionArgs', 'ServiceIntegrationLogsAnomalyDetectionArgsDict', 'outputs.ServiceIntegrationLogsAnomalyDetection']] logs_anomaly_detection: Information about whether DevOps Guru is configured to perform log anomaly detection on Amazon CloudWatch log groups. See `logs_anomaly_detection` below.
        :param pulumi.Input[Union['ServiceIntegrationOpsCenterArgs', 'ServiceIntegrationOpsCenterArgsDict', 'outputs.ServiceIntegrationOpsCenter']] ops_center: Information about whether DevOps Guru is configured to create an OpsItem in AWS Systems Manager OpsCenter for each created insight. See `ops_center` below.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if kms_server_side_encryption is None and not opts.urn:
                raise TypeError("Missing required property 'kms_server_side_encryption'")
            __props__.__dict__["kms_server_side_encryption"] = kms_server_side_encryption
            if logs_anomaly_detection is None and not opts.urn:
                raise TypeError("Missing required property 'logs_anomaly_detection'")
            __props__.__dict__["logs_anomaly_detection"] = logs_anomaly_detection
            if ops_center is None and not opts.urn:
                raise TypeError("Missing required property 'ops_center'")
    ...
    def get(resource_name: str,
            ...
            logs_anomaly_detection: pulumi.Input[Optional[Union['ServiceIntegrationLogsAnomalyDetectionArgs', 'ServiceIntegrationLogsAnomalyDetectionArgsDict', 'outputs.ServiceIntegrationLogsAnomalyDetection']]] = None,
            ops_center: pulumi.Input[Optional[Union['ServiceIntegrationOpsCenterArgs', 'ServiceIntegrationOpsCenterArgsDict', 'outputs.ServiceIntegrationOpsCenter']]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None) -> 'ServiceIntegration':
        """
