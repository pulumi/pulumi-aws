...
class EventSourcesConfigEventSourceAmazonCodeGuruProfiler(dict):
    def __init__(__self__, *,
                 status: builtins.str):
        """
        :param builtins.str status: Status of the CodeGuru Profiler integration. Valid values are `ENABLED` and `DISABLED`.
        """
...
class NotificationChannelFilters(dict):
    ...
    def __init__(__self__, *,
                 message_types: Optional[Sequence[builtins.str]] = None,
                 severities: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] message_types: Events to receive notifications for. Valid values are `NEW_INSIGHT`, `CLOSED_INSIGHT`, `NEW_ASSOCIATION`, `SEVERITY_UPGRADED`, and `NEW_RECOMMENDATION`.
        :param Sequence[builtins.str] severities: Severity levels to receive notifications for. Valid values are `LOW`, `MEDIUM`, and `HIGH`.
        """
    ...
    def message_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ResourceCollectionCloudformation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] stack_names: Array of the names of the AWS CloudFormation stacks. If `type` is `AWS_SERVICE` (all acccount resources) this array should be a single item containing a wildcard (`"*"`).
        """
...
class ServiceIntegrationKmsServerSideEncryption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 opt_in_status: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str kms_key_id: KMS key ID. This value can be a key ID, key ARN, alias name, or alias ARN.
        :param builtins.str opt_in_status: Specifies whether KMS integration is enabled. Valid values are `DISABLED` and `ENABLED`.
        :param builtins.str type: Type of KMS key used. Valid values are `CUSTOMER_MANAGED_KEY` and `AWS_OWNED_KMS_KEY`.
        """
    ...
    def opt_in_status(self) -> Optional[builtins.str]:
        """
...
class ServiceIntegrationLogsAnomalyDetection(dict):
    ...
    def __init__(__self__, *,
                 opt_in_status: Optional[builtins.str] = None):
        """
        :param builtins.str opt_in_status: Specifies if DevOps Guru is configured to perform log anomaly detection on CloudWatch log groups. Valid values are `DISABLED` and `ENABLED`.
        """
        if opt_in_status is not None:
            pulumi.set(__self__, "opt_in_status", opt_in_status)
...
class ServiceIntegrationOpsCenter(dict):
    ...
    def __init__(__self__, *,
                 opt_in_status: Optional[builtins.str] = None):
        """
        :param builtins.str opt_in_status: Specifies if DevOps Guru is enabled to create an AWS Systems Manager OpsItem for each created insight. Valid values are `DISABLED` and `ENABLED`.
        """
        if opt_in_status is not None:
            pulumi.set(__self__, "opt_in_status", opt_in_status)
