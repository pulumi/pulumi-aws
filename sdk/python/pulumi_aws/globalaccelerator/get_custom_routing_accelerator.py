...
class GetCustomRoutingAcceleratorResult:
    ...
    @property
    @pulumi.getter
    def attributes(self) -> Optional[Sequence['outputs.GetCustomRoutingAcceleratorAttributeResult']]:
    ...
    def ip_sets(self) -> Optional[Sequence['outputs.GetCustomRoutingAcceleratorIpSetResult']]:
