...
def get_custom_routing_accelerator(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: Full ARN of the custom routing accelerator.
    :param builtins.str name: Unique name of the custom routing accelerator.
...
def get_custom_routing_accelerator_output(arn: Optional[pulumi.Input[Optional[builtins.str]]] = None,
