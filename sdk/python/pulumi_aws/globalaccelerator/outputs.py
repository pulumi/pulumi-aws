...
class AcceleratorAttributes(dict):
    ...
    def __init__(__self__, *,
                 flow_logs_enabled: Optional[builtins.bool] = None,
                 flow_logs_s3_bucket: Optional[builtins.str] = None,
                 flow_logs_s3_prefix: Optional[builtins.str] = None):
        """
        :param builtins.bool flow_logs_enabled: Indicates whether flow logs are enabled. Defaults to `false`. Valid values: `true`, `false`.
        :param builtins.str flow_logs_s3_bucket: The name of the Amazon S3 bucket for the flow logs. Required if `flow_logs_enabled` is `true`.
        :param builtins.str flow_logs_s3_prefix: The prefix for the location in the Amazon S3 bucket for the flow logs. Required if `flow_logs_enabled` is `true`.
        """
    ...
    def flow_logs_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def flow_logs_s3_bucket(self) -> Optional[builtins.str]:
        """
    ...
    def flow_logs_s3_prefix(self) -> Optional[builtins.str]:
        """
...
class AcceleratorIpSet(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] ip_addresses: The IP addresses to use for BYOIP accelerators. If not specified, the service assigns IP addresses. Valid values: 1 or 2 IPv4 addresses.
        :param builtins.str ip_family: The type of IP addresses included in this IP set.
        """
...
class CrossAccountAttachmentResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cidr_block: IP address range, in CIDR format, that is specified as resource.
...
class CustomRoutingEndpointGroupDestinationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int from_port: The first port, inclusive, in the range of ports for the endpoint group that is associated with a custom routing accelerator.
        :param Sequence[builtins.str] protocols: The protocol for the endpoint group that is associated with a custom routing accelerator. The protocol can be either `"TCP"` or `"UDP"`.
        :param builtins.int to_port: The last port, inclusive, in the range of ports for the endpoint group that is associated with a custom routing accelerator.
        """
...
class CustomRoutingEndpointGroupEndpointConfiguration(dict):
    ...
    def __init__(__self__, *,
                 endpoint_id: Optional[builtins.str] = None):
        """
        :param builtins.str endpoint_id: An ID for the endpoint. For custom routing accelerators, this is the virtual private cloud (VPC) subnet ID.
        """
        if endpoint_id is not None:
            pulumi.set(__self__, "endpoint_id", endpoint_id)
...
class EndpointGroupEndpointConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str attachment_arn: An ARN of an exposed cross-account attachment. See the [AWS documentation](https://docs.aws.amazon.com/global-accelerator/latest/dg/cross-account-resources.html) for more details.
        :param builtins.bool client_ip_preservation_enabled: Indicates whether client IP address preservation is enabled for an Application Load Balancer endpoint. See the [AWS documentation](https://docs.aws.amazon.com/global-accelerator/latest/dg/preserve-client-ip-address.html) for more details. The default value is `false`.
               **Note:** When client IP address preservation is enabled, the Global Accelerator service creates an EC2 Security Group in the VPC named `GlobalAccelerator` that must be deleted (potentially outside of the provider) before the VPC will successfully delete. If this EC2 Security Group is not deleted, the provider will retry the VPC deletion for a few minutes before reporting a `DependencyViolation` error. This cannot be resolved by re-running the provider.
        :param builtins.str endpoint_id: An ID for the endpoint. If the endpoint is a Network Load Balancer or Application Load Balancer, this is the Amazon Resource Name (ARN) of the resource. If the endpoint is an Elastic IP address, this is the Elastic IP address allocation ID.
        :param builtins.int weight: The weight associated with the endpoint. When you add weights to endpoints, you configure AWS Global Accelerator to route traffic based on proportions that you specify.
        """
...
class GetAcceleratorAttributeResult(dict):
    def __init__(__self__, *,
                 flow_logs_enabled: builtins.bool,
                 flow_logs_s3_bucket: builtins.str,
                 flow_logs_s3_prefix: builtins.str):
        pulumi.set(__self__, "flow_logs_enabled", flow_logs_enabled)
        pulumi.set(__self__, "flow_logs_s3_bucket", flow_logs_s3_bucket)
        pulumi.set(__self__, "flow_logs_s3_prefix", flow_logs_s3_prefix)
    ...
    @property
    @pulumi.getter(name="flowLogsEnabled")
    def flow_logs_enabled(self) -> builtins.bool:
        return pulumi.get(self, "flow_logs_enabled")
