...
class _AcceleratorState:
    ...
    def _configure(
        ...
        if dual_stack_dns_name is None and 'dualStackDnsName' in kwargs:
            dual_stack_dns_name = kwargs['dualStackDnsName']
        ...
        if dual_stack_dns_name is not None:
            _setter("dual_stack_dns_name", dual_stack_dns_name)
        if enabled is not None:
            _setter("enabled", enabled)
...
class Accelerator(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if attributes is not None and not isinstance(attributes, AcceleratorAttributesArgs):
                attributes = attributes or {}
                def _setter(key, value):
                    attributes[key] = value
                AcceleratorAttributesArgs._configure(_setter, **attributes)
