...
class AcceleratorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ip_address_type: The value for the address type. Defaults to `IPV4`. Valid values: `IPV4`, `DUAL_STACK`.
        ...
        :param pulumi.Input[builtins.str] name: The name of the accelerator.
...
class _AcceleratorState:
    def __init__(__self__, *,
                 ...
                 dual_stack_dns_name: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the accelerator.
        :param pulumi.Input['AcceleratorAttributesArgs'] attributes: The attributes of the accelerator. Fields documented below.
        ...
        :param pulumi.Input[builtins.str] dual_stack_dns_name: The Domain Name System (DNS) name that Global Accelerator creates that points to a dual-stack accelerator's four static IP addresses: two IPv4 addresses and two IPv6 addresses. For example, `a1234567890abcdef.dualstack.awsglobalaccelerator.com`.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether the accelerator is enabled. Defaults to `true`. Valid values: `true`, `false`.
    ...
    def dual_stack_dns_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dual_stack_dns_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Accelerator(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'Accelerator':
        """
    ...
    @property
    @pulumi.getter(name="dualStackDnsName")
    def dual_stack_dns_name(self) -> pulumi.Output[builtins.str]:
        """
        The Domain Name System (DNS) name that Global Accelerator creates that points to a dual-stack accelerator's four static IP addresses: two IPv4 addresses and two IPv6 addresses. For example, `a1234567890abcdef.dualstack.awsglobalaccelerator.com`.
        """
        return pulumi.get(self, "dual_stack_dns_name")
