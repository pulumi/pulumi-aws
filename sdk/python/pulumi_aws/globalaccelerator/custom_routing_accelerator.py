...
class CustomRoutingAcceleratorArgs:
    def __init__(__self__, *,
        ...
        """
        CustomRoutingAcceleratorArgs._configure(
...
class _CustomRoutingAcceleratorState:
    def __init__(__self__, *,
        ...
        """
        _CustomRoutingAcceleratorState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            attributes=attributes,
            dns_name=dns_name,
            enabled=enabled,
...
class CustomRoutingAccelerator(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            CustomRoutingAcceleratorArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if attributes is not None and not isinstance(attributes, CustomRoutingAcceleratorAttributesArgs):
                attributes = attributes or {}
                def _setter(key, value):
                    attributes[key] = value
                CustomRoutingAcceleratorAttributesArgs._configure(_setter, **attributes)
