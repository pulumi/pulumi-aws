...
class DocumentClassifierInputDataConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 label_delimiter: Optional[builtins.str] = None,
                 s3_uri: Optional[builtins.str] = None,
                 test_s3_uri: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str data_format: The format for the training data.
               One of `COMPREHEND_CSV` or `AUGMENTED_MANIFEST`.
        :param builtins.str label_delimiter: Delimiter between labels when training a multi-label classifier.
               Valid values are `|`, `~`, `!`, `@`, `#`, `$`, `%`, `^`, `*`, `-`, `_`, `+`, `=`, `\\`, `:`, `;`, `>`, `?`, `/`, `<space>`, and `<tab>`.
               Default is `|`.
        :param builtins.str s3_uri: Location of training documents.
    ...
    def label_delimiter(self) -> Optional[builtins.str]:
        """
    ...
    def test_s3_uri(self) -> Optional[builtins.str]:
...
class DocumentClassifierInputDataConfigAugmentedManifest(dict):
    ...
    def __init__(__self__, *,
                 ...
                 s3_uri: builtins.str,
                 annotation_data_s3_uri: Optional[builtins.str] = None,
                 document_type: Optional[builtins.str] = None,
                 source_documents_s3_uri: Optional[builtins.str] = None,
                 split: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] attribute_names: The JSON attribute that contains the annotations for the training documents.
        :param builtins.str s3_uri: Location of augmented manifest file.
        :param builtins.str annotation_data_s3_uri: Location of annotation files.
        :param builtins.str document_type: Type of augmented manifest.
               One of `PLAIN_TEXT_DOCUMENT` or `SEMI_STRUCTURED_DOCUMENT`.
        :param builtins.str source_documents_s3_uri: Location of source PDF files.
        :param builtins.str split: Purpose of data in augmented manifest.
    ...
    def annotation_data_s3_uri(self) -> Optional[builtins.str]:
        """
    ...
    def source_documents_s3_uri(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def split(self) -> Optional[builtins.str]:
        """
...
class DocumentClassifierOutputDataConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 output_s3_uri: Optional[builtins.str] = None):
        """
        :param builtins.str s3_uri: Destination path for the output documents.
               The full path to the output file will be returned in `output_s3_uri`.
        :param builtins.str kms_key_id: KMS Key used to encrypt the output documents.
               Can be a KMS Key ID, a KMS Key ARN, a KMS Alias name, or a KMS Alias ARN.
        :param builtins.str output_s3_uri: Full path for the output documents.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
    ...
    def output_s3_uri(self) -> Optional[builtins.str]:
        """
...
class DocumentClassifierVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] subnets: List of VPC subnets.
        """
...
class EntityRecognizerInputDataConfigAnnotations(dict):
    ...
    def __init__(__self__, *,
                 ...
                 test_s3_uri: Optional[builtins.str] = None):
        """
        :param builtins.str s3_uri: Location of training annotations.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
        if test_s3_uri is not None:
            pulumi.set(__self__, "test_s3_uri", test_s3_uri)
...
class EntityRecognizerInputDataConfigDocuments(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str s3_uri: Location of training documents.
        :param builtins.str input_format: Specifies how the input files should be processed.
...
class EntityRecognizerInputDataConfigEntityList(dict):
    ...
    def __init__(__self__, *,
                 s3_uri: builtins.str):
        """
        :param builtins.str s3_uri: Location of entity list.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
...
class EntityRecognizerInputDataConfigEntityType(dict):
    def __init__(__self__, *,
                 type: builtins.str):
        """
        :param builtins.str type: An entity type to be matched by the Entity Recognizer.
