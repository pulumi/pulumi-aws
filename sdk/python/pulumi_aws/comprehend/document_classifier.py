...
class DocumentClassifierArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] mode: The document classification mode.
               One of `MULTI_CLASS` or `MULTI_LABEL`.
               `MULTI_CLASS` is also known as "Single Label" in the AWS Console.
        :param pulumi.Input[builtins.str] model_kms_key_id: KMS Key used to encrypt trained Document Classifiers.
               Can be a KMS Key ID or a KMS Key ARN.
        :param pulumi.Input[builtins.str] name: Name for the Document Classifier.
        ...
        :param pulumi.Input[builtins.str] volume_kms_key_id: KMS Key used to encrypt storage volumes during job processing.
               Can be a KMS Key ID or a KMS Key ARN.
...
class _DocumentClassifierState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the Document Classifier version.
        :param pulumi.Input[builtins.str] data_access_role_arn: The ARN for an IAM Role which allows Comprehend to read the training and testing data.
        :param pulumi.Input['DocumentClassifierInputDataConfigArgs'] input_data_config: Configuration for the training and testing data.
               See the `input_data_config` Configuration Block section below.
        :param pulumi.Input[builtins.str] language_code: Two-letter language code for the language.
