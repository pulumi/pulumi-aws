...
class DocumentClassifierInputDataConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DocumentClassifierInputDataConfigAugmentedManifestArgs']]] augmented_manifests: List of training datasets produced by Amazon SageMaker AI Ground Truth.
               Used if `data_format` is `AUGMENTED_MANIFEST`.
               See the `augmented_manifests` Configuration Block section below.
        :param pulumi.Input[builtins.str] data_format: The format for the training data.
               One of `COMPREHEND_CSV` or `AUGMENTED_MANIFEST`.
        :param pulumi.Input[builtins.str] label_delimiter: Delimiter between labels when training a multi-label classifier.
               Valid values are `|`, `~`, `!`, `@`, `#`, `$`, `%`, `^`, `*`, `-`, `_`, `+`, `=`, `\\`, `:`, `;`, `>`, `?`, `/`, `<space>`, and `<tab>`.
               Default is `|`.
        :param pulumi.Input[builtins.str] s3_uri: Location of training documents.
               Used if `data_format` is `COMPREHEND_CSV`.
        """
...
if not MYPY:
    class DocumentClassifierInputDataConfigAugmentedManifestArgsDict(TypedDict):
        ...
        """
        annotation_data_s3_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        source_documents_s3_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        Location of source PDF files.
        """
        split: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DocumentClassifierInputDataConfigAugmentedManifestArgs:
    def __init__(__self__, *,
                 attribute_names: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 s3_uri: pulumi.Input[builtins.str],
                 annotation_data_s3_uri: Optional[pulumi.Input[builtins.str]] = None,
                 document_type: Optional[pulumi.Input[builtins.str]] = None,
                 source_documents_s3_uri: Optional[pulumi.Input[builtins.str]] = None,
                 split: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] attribute_names: The JSON attribute that contains the annotations for the training documents.
        :param pulumi.Input[builtins.str] s3_uri: Location of augmented manifest file.
        :param pulumi.Input[builtins.str] annotation_data_s3_uri: Location of annotation files.
        :param pulumi.Input[builtins.str] document_type: Type of augmented manifest.
               One of `PLAIN_TEXT_DOCUMENT` or `SEMI_STRUCTURED_DOCUMENT`.
        :param pulumi.Input[builtins.str] source_documents_s3_uri: Location of source PDF files.
        :param pulumi.Input[builtins.str] split: Purpose of data in augmented manifest.
               One of `TRAIN` or `TEST`.
        """
    ...
    def annotation_data_s3_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Location of annotation files.
        """
    ...
    def annotation_data_s3_uri(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_documents_s3_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Location of source PDF files.
        """
    ...
    def source_documents_s3_uri(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_documents_s3_uri", value)

    @property
    @pulumi.getter
    def split(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Purpose of data in augmented manifest.
        One of `TRAIN` or `TEST`.
        """
    ...
    @split.setter
    def split(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DocumentClassifierOutputDataConfigArgsDict(TypedDict):
        ...
        """
        output_s3_uri: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DocumentClassifierOutputDataConfigArgs:
    def __init__(__self__, *,
                 ...
                 output_s3_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] s3_uri: Destination path for the output documents.
               The full path to the output file will be returned in `output_s3_uri`.
        :param pulumi.Input[builtins.str] kms_key_id: KMS Key used to encrypt the output documents.
               Can be a KMS Key ID, a KMS Key ARN, a KMS Alias name, or a KMS Alias ARN.
        :param pulumi.Input[builtins.str] output_s3_uri: Full path for the output documents.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
    ...
    def output_s3_uri(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Full path for the output documents.
        """
    ...
    def output_s3_uri(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DocumentClassifierVpcConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: List of VPC subnets.
        """
...
class EntityRecognizerInputDataConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['EntityRecognizerInputDataConfigAnnotationsArgs'] annotations: Specifies location of the document annotation data.
               See the `annotations` Configuration Block section below.
               One of `annotations` or `entity_list` is required.
        :param pulumi.Input[Sequence[pulumi.Input['EntityRecognizerInputDataConfigAugmentedManifestArgs']]] augmented_manifests: List of training datasets produced by Amazon SageMaker AI Ground Truth.
               Used if `data_format` is `AUGMENTED_MANIFEST`.
               See the `augmented_manifests` Configuration Block section below.
        :param pulumi.Input[builtins.str] data_format: The format for the training data.
               One of `COMPREHEND_CSV` or `AUGMENTED_MANIFEST`.
...
class EntityRecognizerInputDataConfigAnnotationsArgs:
    def __init__(__self__, *,
                 ...
                 test_s3_uri: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] s3_uri: Location of training annotations.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
        if test_s3_uri is not None:
            pulumi.set(__self__, "test_s3_uri", test_s3_uri)
...
class EntityRecognizerInputDataConfigDocumentsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] s3_uri: Location of training documents.
        :param pulumi.Input[builtins.str] input_format: Specifies how the input files should be processed.
               One of `ONE_DOC_PER_LINE` or `ONE_DOC_PER_FILE`.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
...
class EntityRecognizerInputDataConfigEntityListArgs:
    def __init__(__self__, *,
                 s3_uri: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] s3_uri: Location of entity list.
        """
        pulumi.set(__self__, "s3_uri", s3_uri)
...
class EntityRecognizerInputDataConfigEntityTypeArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: An entity type to be matched by the Entity Recognizer.
               Cannot contain a newline (`\\n`), carriage return (`\\r`), or tab (`\\t`).
        """
