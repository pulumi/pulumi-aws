...
class CustomerManagedPolicyAttachment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            customer_managed_policy_reference = _utilities.configure(customer_managed_policy_reference, CustomerManagedPolicyAttachmentCustomerManagedPolicyReferenceArgs, True)
