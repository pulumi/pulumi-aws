...
class PermissionSetInlinePolicyArgs:
    def __init__(__self__, *,
                 inline_policy: pulumi.Input[builtins.str],
    ...
    def inline_policy(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def inline_policy(self, value: pulumi.Input[builtins.str]):
...
class _PermissionSetInlinePolicyState:
    def __init__(__self__, *,
                 inline_policy: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="inlinePolicy")
    def inline_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IAM inline policy to attach to a Permission Set.
        """
        return pulumi.get(self, "inline_policy")
    ...
    @inline_policy.setter
    def inline_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "inline_policy", value)
...
class PermissionSetInlinePolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            inline_policy: Optional[pulumi.Input[builtins.str]] = None,
            instance_arn: Optional[pulumi.Input[builtins.str]] = None,
            permission_set_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'PermissionSetInlinePolicy':
        """
    ...
    @property
    @pulumi.getter(name="inlinePolicy")
    def inline_policy(self) -> pulumi.Output[builtins.str]:
        """
        The IAM inline policy to attach to a Permission Set.
        """
        return pulumi.get(self, "inline_policy")
