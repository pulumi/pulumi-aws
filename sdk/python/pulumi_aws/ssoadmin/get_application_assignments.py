...
class GetApplicationAssignmentsResult:
    ...
    """
    def __init__(__self__, application_arn=None, application_assignments=None, id=None, region=None):
...
def get_application_assignments(application_arn: Optional[_builtins.str] = None,
...
def get_application_assignments_output(application_arn: Optional[pulumi.Input[_builtins.str]] = None,
