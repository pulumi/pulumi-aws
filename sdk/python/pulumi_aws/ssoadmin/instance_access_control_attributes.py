...
class InstanceAccessControlAttributes(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a InstanceAccessControlAttributes resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            status: Optional[pulumi.Input[_builtins.str]] = None,
            status_reason: Optional[pulumi.Input[_builtins.str]] = None) -> 'InstanceAccessControlAttributes':
        """
