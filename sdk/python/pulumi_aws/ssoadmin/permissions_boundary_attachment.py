...
class PermissionsBoundaryAttachment(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if permissions_boundary is not None and not isinstance(permissions_boundary, PermissionsBoundaryAttachmentPermissionsBoundaryArgs):
                permissions_boundary = permissions_boundary or {}
                def _setter(key, value):
                    permissions_boundary[key] = value
                PermissionsBoundaryAttachmentPermissionsBoundaryArgs._configure(_setter, **permissions_boundary)
