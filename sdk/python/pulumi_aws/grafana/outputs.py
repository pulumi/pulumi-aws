...
class WorkspaceNetworkAccessControl(dict):
    ...
    def __init__(__self__, *,
                 prefix_list_ids: Sequence[builtins.str],
                 vpce_ids: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] prefix_list_ids: An array of prefix list IDs.
        :param Sequence[builtins.str] vpce_ids: An array of Amazon VPC endpoint IDs for the workspace. The only VPC endpoints that can be specified here are interface VPC endpoints for Grafana workspaces (using the com.amazonaws.[region].grafana-workspace service endpoint). Other VPC endpoints will be ignored.
        """
    ...
    def prefix_list_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def vpce_ids(self) -> Sequence[builtins.str]:
        """
