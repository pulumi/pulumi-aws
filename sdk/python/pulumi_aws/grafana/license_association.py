...
class LicenseAssociationArgs:
    ...
    def grafana_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class _LicenseAssociationState:
    def __init__(__self__, *,
                 free_trial_expiration: Optional[pulumi.Input[builtins.str]] = None,
                 grafana_token: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] free_trial_expiration: If `license_type` is set to `ENTERPRISE_FREE_TRIAL`, this is the expiration date of the free trial.
        :param pulumi.Input[builtins.str] grafana_token: A token from Grafana Labs that ties your AWS account with a Grafana Labs account.
    ...
    def free_trial_expiration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def free_trial_expiration(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def license_expiration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def license_expiration(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LicenseAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="freeTrialExpiration")
    def free_trial_expiration(self) -> pulumi.Output[builtins.str]:
        """
        If `license_type` is set to `ENTERPRISE_FREE_TRIAL`, this is the expiration date of the free trial.
        """
        return pulumi.get(self, "free_trial_expiration")
    ...
    @property
    @pulumi.getter(name="grafanaToken")
    def grafana_token(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A token from Grafana Labs that ties your AWS account with a Grafana Labs account.
        """
        return pulumi.get(self, "grafana_token")
    ...
    @property
    @pulumi.getter(name="licenseExpiration")
    def license_expiration(self) -> pulumi.Output[builtins.str]:
        """
        If `license_type` is set to `ENTERPRISE`, this is the expiration date of the enterprise license.
        """
        return pulumi.get(self, "license_expiration")
