...
if not MYPY:
    class WorkspaceNetworkAccessControlArgsDict(TypedDict):
        prefix_list_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        An array of prefix list IDs.
        """
        vpce_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class WorkspaceNetworkAccessControlArgs:
    def __init__(__self__, *,
                 ...
                 vpce_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] prefix_list_ids: An array of prefix list IDs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpce_ids: An array of Amazon VPC endpoint IDs for the workspace. The only VPC endpoints that can be specified here are interface VPC endpoints for Grafana workspaces (using the com.amazonaws.[region].grafana-workspace service endpoint). Other VPC endpoints will be ignored.
        """
    ...
    def prefix_list_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        An array of prefix list IDs.
        """
    ...
    def prefix_list_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "prefix_list_ids", value)

    @property
    @pulumi.getter(name="vpceIds")
    def vpce_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        An array of Amazon VPC endpoint IDs for the workspace. The only VPC endpoints that can be specified here are interface VPC endpoints for Grafana workspaces (using the com.amazonaws.[region].grafana-workspace service endpoint). Other VPC endpoints will be ignored.
        """
    ...
    @vpce_ids.setter
    def vpce_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class WorkspaceVpcConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 subnet_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: The list of Amazon EC2 security group IDs attached to the Amazon VPC for your Grafana workspace to connect.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The list of Amazon EC2 subnet IDs created in the Amazon VPC for your Grafana workspace to connect.
        """
