...
class WorkspaceNetworkAccessControlArgs:
    def __init__(__self__, *,
                 ...
                 vpce_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] prefix_list_ids: An array of prefix list IDs.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] vpce_ids: An array of Amazon VPC endpoint IDs for the workspace. The only VPC endpoints that can be specified here are interface VPC endpoints for Grafana workspaces (using the com.amazonaws.[region].grafana-workspace service endpoint). Other VPC endpoints will be ignored.
        """
    ...
    def prefix_list_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
    ...
    @vpce_ids.setter
    def vpce_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
