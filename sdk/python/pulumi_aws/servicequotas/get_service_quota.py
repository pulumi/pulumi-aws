...
def get_service_quota(quota_code: Optional[str] = None,
    ...
    :param str service_code: Service code for the quota. Available values can be found with the `servicequotas.get_service` or [AWS CLI service-quotas list-services command](https://docs.aws.amazon.com/cli/latest/reference/service-quotas/list-services.html).
    """
    __args__ = dict()
