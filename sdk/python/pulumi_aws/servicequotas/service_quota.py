...
class _ServiceQuotaState:
    def __init__(__self__, *,
                 adjustable: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 usage_metrics: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceQuotaUsageMetricArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def adjustable(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    @adjustable.setter
    def adjustable(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def usage_metrics(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ServiceQuotaUsageMetricArgs']]]]:
        """
    ...
    def usage_metrics(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ServiceQuotaUsageMetricArgs']]]]):
...
class ServiceQuota(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Using `pulumi import`, import `servicequotas.ServiceQuota` using the service code and quota code, separated by a front slash (`/`). For example:
