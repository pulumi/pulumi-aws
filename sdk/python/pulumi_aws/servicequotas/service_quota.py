...
class ServiceQuotaArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] quota_code: Code of the service quota to track. For example: `L-F678F1CE`. Available values can be found with the [AWS CLI service-quotas list-service-quotas command](https://docs.aws.amazon.com/cli/latest/reference/service-quotas/list-service-quotas.html).
        :param pulumi.Input[builtins.str] service_code: Code of the service to track. For example: `vpc`. Available values can be found with the [AWS CLI service-quotas list-services command](https://docs.aws.amazon.com/cli/latest/reference/service-quotas/list-services.html).
        :param pulumi.Input[builtins.float] value: Float specifying the desired value for the service quota. If the desired value is higher than the current value, a quota increase request is submitted. When a known request is submitted and pending, the value reflects the desired value of the pending request.
        """
    ...
    def quota_code(self) -> pulumi.Input[builtins.str]:
        """
...
class _ServiceQuotaState:
    def __init__(__self__, *,
                 adjustable: Optional[pulumi.Input[builtins.bool]] = None,
                 arn: Optional[pulumi.Input[builtins.str]] = None,
                 default_value: Optional[pulumi.Input[builtins.float]] = None,
                 ...
                 request_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] adjustable: Whether the service quota can be increased.
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the service quota.
        :param pulumi.Input[builtins.float] default_value: Default value of the service quota.
        :param pulumi.Input[builtins.str] quota_code: Code of the service quota to track. For example: `L-F678F1CE`. Available values can be found with the [AWS CLI service-quotas list-service-quotas command](https://docs.aws.amazon.com/cli/latest/reference/service-quotas/list-service-quotas.html).
        :param pulumi.Input[builtins.str] quota_name: Name of the quota.
        :param pulumi.Input[builtins.str] service_code: Code of the service to track. For example: `vpc`. Available values can be found with the [AWS CLI service-quotas list-services command](https://docs.aws.amazon.com/cli/latest/reference/service-quotas/list-services.html).
    ...
    @property
    @pulumi.getter
    def adjustable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @adjustable.setter
    def adjustable(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def default_value(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def default_value(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "default_value", value)

    @property
    @pulumi.getter(name="quotaCode")
    def quota_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Code of the service quota to track. For example: `L-F678F1CE`. Available values can be found with the [AWS CLI service-quotas list-service-quotas command](https://docs.aws.amazon.com/cli/latest/reference/service-quotas/list-service-quotas.html).
        """
        return pulumi.get(self, "quota_code")
    ...
    @quota_code.setter
    def quota_code(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "quota_code", value)
    ...
    def request_status(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "request_status")

    @request_status.setter
    def request_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ServiceQuota(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            value: Optional[pulumi.Input[builtins.float]] = None) -> 'ServiceQuota':
        """
    ...
    @property
    @pulumi.getter
    def adjustable(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the service quota can be increased.
        """
        return pulumi.get(self, "adjustable")
    ...
    @property
    @pulumi.getter(name="defaultValue")
    def default_value(self) -> pulumi.Output[builtins.float]:
        """
        Default value of the service quota.
        """
        return pulumi.get(self, "default_value")
    ...
    @property
    @pulumi.getter(name="quotaCode")
    def quota_code(self) -> pulumi.Output[builtins.str]:
        """
        Code of the service quota to track. For example: `L-F678F1CE`. Available values can be found with the [AWS CLI service-quotas list-service-quotas command](https://docs.aws.amazon.com/cli/latest/reference/service-quotas/list-service-quotas.html).
        """
        return pulumi.get(self, "quota_code")
    ...
    @property
    @pulumi.getter(name="requestStatus")
    def request_status(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "request_status")
