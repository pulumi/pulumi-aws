...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 connection_draining: Optional[pulumi.Input[builtins.bool]] = None,
                 connection_draining_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 cross_zone_load_balancing: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The AZ's to serve traffic in.
        :param pulumi.Input[builtins.bool] connection_draining: Boolean to enable connection draining. Default: `false`
        :param pulumi.Input[builtins.int] connection_draining_timeout: The time in seconds to allow for connections to drain. Default: `300`
        :param pulumi.Input[builtins.bool] cross_zone_load_balancing: Enable cross-zone load balancing. Default: `true`
        :param pulumi.Input[builtins.str] desync_mitigation_mode: Determines how the load balancer handles requests that might pose a security risk to an application due to HTTP desync. Valid values are `monitor`, `defensive` (default), `strictest`.
        :param pulumi.Input['LoadBalancerHealthCheckArgs'] health_check: A health_check block. Health Check documented below.
        :param pulumi.Input[builtins.int] idle_timeout: The time in seconds that the connection is allowed to be idle. Default: `60`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instances: A list of instance ids to place in the ELB pool.
        :param pulumi.Input[builtins.bool] internal: If true, ELB will be an internal ELB.
        :param pulumi.Input[builtins.str] name: The name of the ELB. By default generated by this provider.
        :param pulumi.Input[builtins.str] name_prefix: Creates a unique name beginning with the specified
               prefix. Conflicts with `name`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: A list of security group IDs to assign to the ELB.
               Only valid if creating an ELB within a VPC
        :param pulumi.Input[builtins.str] source_security_group: The name of the security group that you can use as
               part of your inbound rules for your load balancer's back-end application
               instances. Use this for Classic or Default VPC only.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: A list of subnet IDs to attach to the ELB. When an update to subnets will remove all current subnets, this will force a new resource.
    ...
    def connection_draining(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def connection_draining(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "connection_draining", value)

    @property
    @pulumi.getter(name="connectionDrainingTimeout")
    def connection_draining_timeout(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def connection_draining_timeout(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "connection_draining_timeout", value)

    @property
    @pulumi.getter(name="crossZoneLoadBalancing")
    def cross_zone_load_balancing(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def cross_zone_load_balancing(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def source_security_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_security_group(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LoadBalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['LoadBalancerAccessLogsArgs'] access_logs: An Access Logs block. Access Logs documented below.
        :param pulumi.Input[builtins.str] arn: The ARN of the ELB
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The AZ's to serve traffic in.
        :param pulumi.Input[builtins.bool] connection_draining: Boolean to enable connection draining. Default: `false`
        :param pulumi.Input[builtins.int] connection_draining_timeout: The time in seconds to allow for connections to drain. Default: `300`
        :param pulumi.Input[builtins.bool] cross_zone_load_balancing: Enable cross-zone load balancing. Default: `true`
        :param pulumi.Input[builtins.str] desync_mitigation_mode: Determines how the load balancer handles requests that might pose a security risk to an application due to HTTP desync. Valid values are `monitor`, `defensive` (default), `strictest`.
        :param pulumi.Input[builtins.str] dns_name: The DNS name of the ELB
        :param pulumi.Input['LoadBalancerHealthCheckArgs'] health_check: A health_check block. Health Check documented below.
        :param pulumi.Input[builtins.int] idle_timeout: The time in seconds that the connection is allowed to be idle. Default: `60`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instances: A list of instance ids to place in the ELB pool.
        :param pulumi.Input[builtins.bool] internal: If true, ELB will be an internal ELB.
        ...
        :param pulumi.Input[builtins.str] source_security_group: The name of the security group that you can use as
               part of your inbound rules for your load balancer's back-end application
               instances. Use this for Classic or Default VPC only.
        :param pulumi.Input[builtins.str] source_security_group_id: The ID of the security group that you can use as
               part of your inbound rules for your load balancer's back-end application
        ...
        :param pulumi.Input[builtins.str] zone_id: The canonical hosted zone ID of the ELB (to be used in a Route 53 Alias record)
        """
        if access_logs is not None:
            pulumi.set(__self__, "access_logs", access_logs)
        if arn is not None:
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.bool] cross_zone_load_balancing: Enable cross-zone load balancing. Default: `true`
        :param pulumi.Input[builtins.str] desync_mitigation_mode: Determines how the load balancer handles requests that might pose a security risk to an application due to HTTP desync. Valid values are `monitor`, `defensive` (default), `strictest`.
        :param pulumi.Input[Union['LoadBalancerHealthCheckArgs', 'LoadBalancerHealthCheckArgsDict']] health_check: A health_check block. Health Check documented below.
        :param pulumi.Input[builtins.int] idle_timeout: The time in seconds that the connection is allowed to be idle. Default: `60`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instances: A list of instance ids to place in the ELB pool.
        :param pulumi.Input[builtins.bool] internal: If true, ELB will be an internal ELB.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LoadBalancerListenerArgs', 'LoadBalancerListenerArgsDict']]]] listeners: A list of listener blocks. Listeners documented below.
        :param pulumi.Input[builtins.str] name: The name of the ELB. By default generated by this provider.
        :param pulumi.Input[builtins.str] name_prefix: Creates a unique name beginning with the specified
               prefix. Conflicts with `name`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: A list of security group IDs to assign to the ELB.
    ...
    @property
    @pulumi.getter(name="connectionDraining")
    def connection_draining(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean to enable connection draining. Default: `false`
        """
        return pulumi.get(self, "connection_draining")
    ...
    @property
    @pulumi.getter(name="connectionDrainingTimeout")
    def connection_draining_timeout(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The time in seconds to allow for connections to drain. Default: `300`
        """
        return pulumi.get(self, "connection_draining_timeout")
    ...
    @property
    @pulumi.getter(name="crossZoneLoadBalancing")
    def cross_zone_load_balancing(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Enable cross-zone load balancing. Default: `true`
        """
        return pulumi.get(self, "cross_zone_load_balancing")
    ...
    @property
    @pulumi.getter(name="sourceSecurityGroup")
    def source_security_group(self) -> pulumi.Output[builtins.str]:
        """
        The name of the security group that you can use as
        part of your inbound rules for your load balancer's back-end application
        instances. Use this for Classic or Default VPC only.
