...
class ListenerPolicyArgs:
    ...
    def load_balancer_port(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def load_balancer_port(self, value: pulumi.Input[builtins.int]):
...
class _ListenerPolicyState:
    ...
    @property
    @pulumi.getter(name="loadBalancerPort")
    def load_balancer_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The load balancer listener port to apply the policy to.
        """
        return pulumi.get(self, "load_balancer_port")
    ...
    @load_balancer_port.setter
    def load_balancer_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "load_balancer_port", value)
...
class ListenerPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="loadBalancerPort")
    def load_balancer_port(self) -> pulumi.Output[builtins.int]:
        """
        The load balancer listener port to apply the policy to.
        """
        return pulumi.get(self, "load_balancer_port")
