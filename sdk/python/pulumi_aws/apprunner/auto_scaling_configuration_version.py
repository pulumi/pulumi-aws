...
class AutoScalingConfigurationVersionArgs:
    def __init__(__self__, *,
                 auto_scaling_configuration_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] auto_scaling_configuration_name: Name of the auto scaling configuration.
    ...
    def auto_scaling_configuration_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def auto_scaling_configuration_name(self, value: pulumi.Input[builtins.str]):
...
class _AutoScalingConfigurationVersionState:
    def __init__(__self__, *,
                 ...
                 auto_scaling_configuration_revision: Optional[pulumi.Input[builtins.int]] = None,
                 has_associated_service: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of this auto scaling configuration version.
        :param pulumi.Input[builtins.str] auto_scaling_configuration_name: Name of the auto scaling configuration.
        :param pulumi.Input[builtins.int] auto_scaling_configuration_revision: The revision of this auto scaling configuration.
        :param pulumi.Input[builtins.bool] latest: Whether the auto scaling configuration has the highest `auto_scaling_configuration_revision` among all configurations that share the same `auto_scaling_configuration_name`.
        :param pulumi.Input[builtins.int] max_concurrency: Maximal number of concurrent requests that you want an instance to process. When the number of concurrent requests goes over this limit, App Runner scales up your service.
        :param pulumi.Input[builtins.int] max_size: Maximal number of instances that App Runner provisions for your service.
        :param pulumi.Input[builtins.int] min_size: Minimal number of instances that App Runner provisions for your service.
    ...
    def auto_scaling_configuration_revision(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def auto_scaling_configuration_revision(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "auto_scaling_configuration_revision", value)

    @property
    @pulumi.getter(name="hasAssociatedService")
    def has_associated_service(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "has_associated_service")

    @has_associated_service.setter
    def has_associated_service(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AutoScalingConfigurationVersion(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoScalingConfigurationName")
    def auto_scaling_configuration_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the auto scaling configuration.
        """
        return pulumi.get(self, "auto_scaling_configuration_name")
    ...
    @property
    @pulumi.getter(name="hasAssociatedService")
    def has_associated_service(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "has_associated_service")
