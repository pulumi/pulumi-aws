...
class ObservabilityConfigurationArgs:
    ...
    def _configure(
        ...
        if observability_configuration_name is None:
            raise TypeError("Missing 'observability_configuration_name' argument")
...
class _ObservabilityConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ObservabilityConfigurationTraceConfigurationArgs'] trace_configuration: Configuration of the tracing feature within this observability configuration. If you don't specify it, App Runner doesn't enable tracing. See Trace Configuration below for more details.
        """
        _ObservabilityConfigurationState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            arn=arn,
            latest=latest,
            observability_configuration_name=observability_configuration_name,
    ...
    def _configure(
        ...
        if observability_configuration_name is None and 'observabilityConfigurationName' in kwargs:
            observability_configuration_name = kwargs['observabilityConfigurationName']
        if observability_configuration_revision is None and 'observabilityConfigurationRevision' in kwargs:
            observability_configuration_revision = kwargs['observabilityConfigurationRevision']
