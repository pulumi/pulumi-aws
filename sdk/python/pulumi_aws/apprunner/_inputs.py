...
class CustomDomainAssociationCertificateValidationRecordArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Certificate CNAME record name.
        ...
        :param pulumi.Input[builtins.str] type: Record type, always `CNAME`.
        :param pulumi.Input[builtins.str] value: Certificate CNAME record value.
        """
        if name is not None:
...
class ObservabilityConfigurationTraceConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] vendor: Implementation provider chosen for tracing App Runner services. Valid values: `AWSXRAY`.
        """
...
class ServiceEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 kms_key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key: ARN of the KMS key used for encryption.
        """
...
class ServiceHealthCheckConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] healthy_threshold: Number of consecutive checks that must succeed before App Runner decides that the service is healthy. Defaults to 1. Minimum value of 1. Maximum value of 20.
        :param pulumi.Input[builtins.int] interval: Time interval, in seconds, between health checks. Defaults to 5. Minimum value of 1. Maximum value of 20.
        :param pulumi.Input[builtins.str] path: URL to send requests to for health checks. Defaults to `/`. Minimum length of 0. Maximum length of 51200.
        :param pulumi.Input[builtins.str] protocol: IP protocol that App Runner uses to perform health checks for your service. Valid values: `TCP`, `HTTP`. Defaults to `TCP`. If you set protocol to `HTTP`, App Runner sends health check requests to the HTTP path specified by `path`.
        :param pulumi.Input[builtins.int] timeout: Time, in seconds, to wait for a health check response before deciding it failed. Defaults to 2. Minimum value of  1. Maximum value of 20.
        :param pulumi.Input[builtins.int] unhealthy_threshold: Number of consecutive checks that must fail before App Runner decides that the service is unhealthy. Defaults to 5. Minimum value of  1. Maximum value of 20.
        """
...
if not MYPY:
    class ServiceInstanceConfigurationArgsDict(TypedDict):
        ...
        """
        instance_role_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceInstanceConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cpu: Number of CPU units reserved for each instance of your App Runner service represented as a String. Defaults to `1024`. Valid values: `256|512|1024|2048|4096|(0.25|0.5|1|2|4) vCPU`.
        :param pulumi.Input[builtins.str] instance_role_arn: ARN of an IAM role that provides permissions to your App Runner service. These are permissions that your code needs when it calls any AWS APIs.
        :param pulumi.Input[builtins.str] memory: Amount of memory, in MB or GB, reserved for each instance of your App Runner service. Defaults to `2048`. Valid values: `512|1024|2048|3072|4096|6144|8192|10240|12288|(0.5|1|2|3|4|6|8|10|12) GB`.
        """
        if cpu is not None:
...
class ServiceNetworkConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] ip_address_type: App Runner provides you with the option to choose between Internet Protocol version 4 (IPv4) and dual stack (IPv4 and IPv6) for your incoming public network configuration. Valid values: `IPV4`, `DUAL_STACK`. Default: `IPV4`.
        """
...
if not MYPY:
    class ServiceNetworkConfigurationEgressConfigurationArgsDict(TypedDict):
        egress_type: NotRequired[pulumi.Input[builtins.str]]
        """
        The type of egress configuration. Valid values are: `DEFAULT` and `VPC`.
        """
        vpc_connector_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceNetworkConfigurationEgressConfigurationArgs:
    def __init__(__self__, *,
                 egress_type: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_connector_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] egress_type: The type of egress configuration. Valid values are: `DEFAULT` and `VPC`.
        :param pulumi.Input[builtins.str] vpc_connector_arn: The Amazon Resource Name (ARN) of the App Runner VPC connector that you want to associate with your App Runner service. Only valid when `EgressType = VPC`.
        """
    ...
    def egress_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of egress configuration. Valid values are: `DEFAULT` and `VPC`.
        """
    ...
    @egress_type.setter
    def egress_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "egress_type", value)

    @property
    @pulumi.getter(name="vpcConnectorArn")
    def vpc_connector_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the App Runner VPC connector that you want to associate with your App Runner service. Only valid when `EgressType = VPC`.
        """
    ...
    def vpc_connector_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpc_connector_arn", value)


if not MYPY:
    class ServiceNetworkConfigurationIngressConfigurationArgsDict(TypedDict):
        is_publicly_accessible: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServiceNetworkConfigurationIngressConfigurationArgs:
    def __init__(__self__, *,
                 is_publicly_accessible: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] is_publicly_accessible: Specifies whether your App Runner service is publicly accessible. To make the service publicly accessible set it to True. To make the service privately accessible, from only within an Amazon VPC set it to False.
        """
    ...
    def is_publicly_accessible(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether your App Runner service is publicly accessible. To make the service publicly accessible set it to True. To make the service privately accessible, from only within an Amazon VPC set it to False.
        """
    ...
    def is_publicly_accessible(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_publicly_accessible", value)


if not MYPY:
    class ServiceObservabilityConfigurationArgsDict(TypedDict):
        observability_enabled: pulumi.Input[builtins.bool]
        """
        When `true`, an observability configuration resource is associated with the service.
        """
        observability_configuration_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceObservabilityConfigurationArgs:
    def __init__(__self__, *,
                 observability_enabled: pulumi.Input[builtins.bool],
                 observability_configuration_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] observability_enabled: When `true`, an observability configuration resource is associated with the service.
        :param pulumi.Input[builtins.str] observability_configuration_arn: ARN of the observability configuration that is associated with the service. Specified only when `observability_enabled` is `true`.
        """
    ...
    def observability_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        When `true`, an observability configuration resource is associated with the service.
        """
    ...
    def observability_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "observability_enabled", value)

    @property
    @pulumi.getter(name="observabilityConfigurationArn")
    def observability_configuration_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the observability configuration that is associated with the service. Specified only when `observability_enabled` is `true`.
        """
    ...
    def observability_configuration_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ServiceSourceConfigurationArgsDict(TypedDict):
        ...
        """
        auto_deployments_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ServiceSourceConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 auto_deployments_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] auto_deployments_enabled: Whether continuous integration from the source repository is enabled for the App Runner service. If set to `true`, each repository change (source code commit or new image version) starts a deployment. Defaults to `true`.
    ...
    def auto_deployments_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether continuous integration from the source repository is enabled for the App Runner service. If set to `true`, each repository change (source code commit or new image version) starts a deployment. Defaults to `true`.
        """
    ...
    def auto_deployments_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class ServiceSourceConfigurationAuthenticationConfigurationArgsDict(TypedDict):
        access_role_arn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceSourceConfigurationAuthenticationConfigurationArgs:
    def __init__(__self__, *,
                 access_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 connection_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] access_role_arn: ARN of the IAM role that grants the App Runner service access to a source repository. Required for ECR image repositories (but not for ECR Public)
        :param pulumi.Input[builtins.str] connection_arn: ARN of the App Runner connection that enables the App Runner service to connect to a source repository. Required for GitHub code repositories.
        """
    ...
    def access_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the IAM role that grants the App Runner service access to a source repository. Required for ECR image repositories (but not for ECR Public)
        """
    ...
    def access_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ServiceSourceConfigurationCodeRepositoryArgsDict(TypedDict):
        ...
        """
        source_directory: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ServiceSourceConfigurationCodeRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 source_directory: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] repository_url: Location of the repository that contains the source code.
        ...
        :param pulumi.Input[builtins.str] source_directory: The path of the directory that stores source code and configuration files. The build and start commands also execute from here. The path is absolute from root and, if not specified, defaults to the repository root.
        """
    ...
    def source_directory(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The path of the directory that stores source code and configuration files. The build and start commands also execute from here. The path is absolute from root and, if not specified, defaults to the repository root.
        """
...
class ServiceSourceConfigurationCodeRepositoryCodeConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] configuration_source: Source of the App Runner configuration. Valid values: `REPOSITORY`, `API`. Values are interpreted as follows:
               * `REPOSITORY` - App Runner reads configuration values from the apprunner.yaml file in the
               source code repository and ignores the CodeConfigurationValues parameter.
               * `API` - App Runner uses configuration values provided in the CodeConfigurationValues
               parameter and ignores the apprunner.yaml file in the source code repository.
    ...
    def configuration_source(self) -> pulumi.Input[builtins.str]:
        """
        Source of the App Runner configuration. Valid values: `REPOSITORY`, `API`. Values are interpreted as follows:
        * `REPOSITORY` - App Runner reads configuration values from the apprunner.yaml file in the
        source code repository and ignores the CodeConfigurationValues parameter.
    ...
    def configuration_source(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesArgsDict(TypedDict):
        ...
        """
        runtime_environment_secrets: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        Secrets and parameters available to your service as environment variables. A map of key/value pairs, where the key is the desired name of the Secret in the environment (i.e. it does not have to match the name of the secret in Secrets Manager or SSM Parameter Store), and the value is the ARN of the secret from AWS Secrets Manager or the ARN of the parameter in AWS SSM Parameter Store.
        """
        runtime_environment_variables: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class ServiceSourceConfigurationCodeRepositoryCodeConfigurationCodeConfigurationValuesArgs:
    def __init__(__self__, *,
                 ...
                 runtime_environment_secrets: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 runtime_environment_variables: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 start_command: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] runtime: Runtime environment type for building and running an App Runner service. Represents a programming language runtime. Valid values: `PYTHON_3`, `NODEJS_12`, `NODEJS_14`, `NODEJS_16`, `CORRETTO_8`, `CORRETTO_11`, `GO_1`, `DOTNET_6`, `PHP_81`, `RUBY_31`.
        :param pulumi.Input[builtins.str] build_command: Command App Runner runs to build your application.
        :param pulumi.Input[builtins.str] port: Port that your application listens to in the container. Defaults to `"8080"`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] runtime_environment_secrets: Secrets and parameters available to your service as environment variables. A map of key/value pairs, where the key is the desired name of the Secret in the environment (i.e. it does not have to match the name of the secret in Secrets Manager or SSM Parameter Store), and the value is the ARN of the secret from AWS Secrets Manager or the ARN of the parameter in AWS SSM Parameter Store.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] runtime_environment_variables: Environment variables available to your running App Runner service. A map of key/value pairs. Keys with a prefix of `AWSAPPRUNNER` are reserved for system use and aren't valid.
        :param pulumi.Input[builtins.str] start_command: Command App Runner runs to start your application.
        """
    ...
    def runtime_environment_secrets(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Secrets and parameters available to your service as environment variables. A map of key/value pairs, where the key is the desired name of the Secret in the environment (i.e. it does not have to match the name of the secret in Secrets Manager or SSM Parameter Store), and the value is the ARN of the secret from AWS Secrets Manager or the ARN of the parameter in AWS SSM Parameter Store.
        """
    ...
    def runtime_environment_secrets(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "runtime_environment_secrets", value)

    @property
    @pulumi.getter(name="runtimeEnvironmentVariables")
    def runtime_environment_variables(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Environment variables available to your running App Runner service. A map of key/value pairs. Keys with a prefix of `AWSAPPRUNNER` are reserved for system use and aren't valid.
        """
    ...
    def runtime_environment_variables(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class ServiceSourceConfigurationCodeRepositorySourceCodeVersionArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: Type of version identifier. For a git-based repository, branches represent versions. Valid values: `BRANCH`.
        :param pulumi.Input[builtins.str] value: Source code version. For a git-based repository, a branch name maps to a specific version. App Runner uses the most recent commit to the branch.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class ServiceSourceConfigurationImageRepositoryArgsDict(TypedDict):
        image_identifier: pulumi.Input[builtins.str]
        """
        ...
        """
        image_repository_type: pulumi.Input[builtins.str]
        """
...
class ServiceSourceConfigurationImageRepositoryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] image_identifier: Identifier of an image. For an image in Amazon Elastic Container Registry (Amazon ECR), this is an image name. For the
               image name format, see Pulling an image in the Amazon ECR User Guide.
        :param pulumi.Input[builtins.str] image_repository_type: Type of the image repository. This reflects the repository provider and whether the repository is private or public. Valid values: `ECR` , `ECR_PUBLIC`.
    ...
    def image_identifier(self) -> pulumi.Input[builtins.str]:
        """
        Identifier of an image. For an image in Amazon Elastic Container Registry (Amazon ECR), this is an image name. For the
        image name format, see Pulling an image in the Amazon ECR User Guide.
        """
    ...
    def image_identifier(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "image_identifier", value)

    @property
    @pulumi.getter(name="imageRepositoryType")
    def image_repository_type(self) -> pulumi.Input[builtins.str]:
        """
        Type of the image repository. This reflects the repository provider and whether the repository is private or public. Valid values: `ECR` , `ECR_PUBLIC`.
        """
    ...
    def image_repository_type(self, value: pulumi.Input[builtins.str]):
...
class ServiceSourceConfigurationImageRepositoryImageConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] runtime_environment_secrets: Secrets and parameters available to your service as environment variables. A map of key/value pairs, where the key is the desired name of the Secret in the environment (i.e. it does not have to match the name of the secret in Secrets Manager or SSM Parameter Store), and the value is the ARN of the secret from AWS Secrets Manager or the ARN of the parameter in AWS SSM Parameter Store.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] runtime_environment_variables: Environment variables available to your running App Runner service. A map of key/value pairs. Keys with a prefix of `AWSAPPRUNNER` are reserved for system use and aren't valid.
        :param pulumi.Input[builtins.str] start_command: Command App Runner runs to start the application in the source image. If specified, this command overrides the Docker image’s default start command.
        """
        if port is not None:
            pulumi.set(__self__, "port", port)
        if runtime_environment_secrets is not None:
...
class VpcIngressConnectionIngressVpcConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] vpc_endpoint_id: The ID of the VPC endpoint that your App Runner service connects to.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the VPC that is used for the VPC endpoint.
        """
