...
class DefaultAutoScalingConfigurationVersion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_auto_scaling_configuration_version = aws.apprunner.auto_scaling_configuration_version.AutoScalingConfigurationVersion("exampleAutoScalingConfigurationVersion",
            auto_scaling_configuration_name=example,
            max_concurrency=50,
            max_size=10,
            min_size=2)
        example_default_auto_scaling_configuration_version = aws.apprunner.default_auto_scaling_configuration_version.DefaultAutoScalingConfigurationVersion("exampleDefaultAutoScalingConfigurationVersion", auto_scaling_configuration_arn=example_auto_scaling_configuration_version.arn)
        ```
