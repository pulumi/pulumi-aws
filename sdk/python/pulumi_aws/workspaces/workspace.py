...
class WorkspaceArgs:
    def __init__(__self__, *,
                 ...
                 volume_encryption_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] volume_encryption_key: The ARN of a symmetric AWS KMS customer master key (CMK) used to encrypt data stored on your WorkSpace. Amazon WorkSpaces does not support asymmetric CMKs.
    ...
    def root_volume_encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def user_volume_encryption_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def user_volume_encryption_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "user_volume_encryption_enabled", value)

    @property
    @pulumi.getter(name="volumeEncryptionKey")
    def volume_encryption_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def volume_encryption_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Workspace(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="userVolumeEncryptionEnabled")
    def user_volume_encryption_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Indicates whether the data stored on the user volume is encrypted.
        """
        return pulumi.get(self, "user_volume_encryption_enabled")
    ...
    @property
    @pulumi.getter(name="volumeEncryptionKey")
    def volume_encryption_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of a symmetric AWS KMS customer master key (CMK) used to encrypt data stored on your WorkSpace. Amazon WorkSpaces does not support asymmetric CMKs.
        """
        return pulumi.get(self, "volume_encryption_key")
