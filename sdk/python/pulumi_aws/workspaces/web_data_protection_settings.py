...
__all__ = ['WebDataProtectionSettingsArgs', 'WebDataProtectionSettings']

@pulumi.input_type
class WebDataProtectionSettingsArgs:
    def __init__(__self__, *,
                 ...
                 inline_redaction_configuration: Optional[pulumi.Input['WebDataProtectionSettingsInlineRedactionConfigurationArgs']] = None,
        ...
        :param pulumi.Input['WebDataProtectionSettingsInlineRedactionConfigurationArgs'] inline_redaction_configuration: The inline redaction configuration of the data protection settings. Detailed below.
    ...
    def inline_redaction_configuration(self) -> Optional[pulumi.Input['WebDataProtectionSettingsInlineRedactionConfigurationArgs']]:
        """
    ...
    def inline_redaction_configuration(self, value: Optional[pulumi.Input['WebDataProtectionSettingsInlineRedactionConfigurationArgs']]):
...
@pulumi.input_type
class _WebDataProtectionSettingsState:
    def __init__(__self__, *,
                 additional_encryption_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
...
class WebDataProtectionSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the data protection settings.
               ...
               The following arguments are optional:
        :param pulumi.Input[Union['WebDataProtectionSettingsInlineRedactionConfigurationArgs', 'WebDataProtectionSettingsInlineRedactionConfigurationArgsDict']] inline_redaction_configuration: The inline redaction configuration of the data protection settings. Detailed below.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of tags assigned to the resource. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
        ...
    @overload
    def __init__(__self__,
                 resource_name: str,
                 args: WebDataProtectionSettingsArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Resource for managing an AWS WorkSpaces Web Data Protection Settings resource. Once associated with a web portal, data protection settings control how sensitive information is redacted in streaming sessions.
        ...
        :param str resource_name: The name of the resource.
        :param WebDataProtectionSettingsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(WebDataProtectionSettingsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = WebDataProtectionSettingsArgs.__new__(WebDataProtectionSettingsArgs)
        ...
        super(WebDataProtectionSettings, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            inline_redaction_configuration: Optional[pulumi.Input[Union['WebDataProtectionSettingsInlineRedactionConfigurationArgs', 'WebDataProtectionSettingsInlineRedactionConfigurationArgsDict']]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'WebDataProtectionSettings':
        """
        ...
        __props__ = _WebDataProtectionSettingsState.__new__(_WebDataProtectionSettingsState)
        ...
        return WebDataProtectionSettings(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="inlineRedactionConfiguration")
    def inline_redaction_configuration(self) -> pulumi.Output[Optional['outputs.WebDataProtectionSettingsInlineRedactionConfiguration']]:
        """
        The inline redaction configuration of the data protection settings. Detailed below.
        """
        return pulumi.get(self, "inline_redaction_configuration")
