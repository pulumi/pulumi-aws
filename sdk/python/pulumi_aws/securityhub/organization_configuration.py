...
class OrganizationConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 auto_enable_standards: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def auto_enable_standards(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_enable_standards(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OrganizationConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoEnableStandards")
    def auto_enable_standards(self) -> pulumi.Output[builtins.str]:
        """
        Whether to automatically enable Security Hub default standards for new member accounts in the organization. By default, this parameter is equal to `DEFAULT`, and new member accounts are automatically enabled with default Security Hub standards. To opt out of enabling default standards for new member accounts, set this parameter equal to `NONE`.
        """
        return pulumi.get(self, "auto_enable_standards")
