...
class OrganizationAdminAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] admin_account_id: The AWS account identifier of the account to designate as the Security Hub administrator account.
        """
...
@pulumi.type_token("aws:securityhub/organizationAdminAccount:OrganizationAdminAccount")
