...
class AutomationRuleAction(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: Specifies that the rule action should update the `Types` finding field. The `Types` finding field classifies findings in the format of namespace/category/classifier.
        """
...
class AutomationRuleActionFindingFieldsUpdate(dict):
    ...
    def __init__(__self__, *,
                 ...
                 criticality: Optional[builtins.int] = None,
                 ...
                 user_defined_fields: Optional[Mapping[str, builtins.str]] = None,
        ...
        """
        :param builtins.int confidence: The rule action updates the `Confidence` field of a finding.
        :param builtins.int criticality: The rule action updates the `Criticality` field of a finding.
        ...
        :param Sequence[builtins.str] types: The rule action updates the `Types` field of a finding.
        :param Mapping[str, builtins.str] user_defined_fields: The rule action updates the `UserDefinedFields` field of a finding.
        :param builtins.str verification_state: The rule action updates the `VerificationState` field of a finding. The allowed values are the following `UNKNOWN`, `TRUE_POSITIVE`, `FALSE_POSITIVE` and `BENIGN_POSITIVE`.
    ...
    @property
    @pulumi.getter
    def criticality(self) -> Optional[builtins.int]:
        """
    ...
    def user_defined_fields(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class AutomationRuleActionFindingFieldsUpdateNote(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str text: The updated note text.
        :param builtins.str updated_by: The principal that updated the note.
        """
...
class AutomationRuleActionFindingFieldsUpdateRelatedFinding(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: The product-generated identifier for a related finding.
        :param builtins.str product_arn: The ARN of the product that generated a related finding.
        """
...
class AutomationRuleActionFindingFieldsUpdateSeverity(dict):
    def __init__(__self__, *,
                 ...
                 product: Optional[builtins.float] = None):
        """
        :param builtins.str label: The severity value of the finding. The allowed values are the following `INFORMATIONAL`, `LOW`, `MEDIUM`, `HIGH` and `CRITICAL`.
        :param builtins.float product: The native severity as defined by the AWS service or integrated partner product that generated the finding.
        """
    ...
    @property
    @pulumi.getter
    def product(self) -> Optional[builtins.float]:
        """
...
class AutomationRuleActionFindingFieldsUpdateWorkflow(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str status: The status of the investigation into the finding. The allowed values are the following `NEW`, `NOTIFIED`, `RESOLVED` and `SUPPRESSED`.
        """
...
class AutomationRuleCriteriaConfidence(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.float eq: The equal-to condition to be applied to a single field when querying for findings, provided as a String.
        :param builtins.float gte: The greater-than-equal condition to be applied to a single field when querying for findings, provided as a String.
        :param builtins.float lte: The less-than-equal condition to be applied to a single field when querying for findings, provided as a String.
        """
        if eq is not None:
...
class AutomationRuleCriteriaCreatedAt(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str end: An end date for the date filter. Required with `start` if `date_range` is not specified.
        :param builtins.str start: A start date for the date filter. Required with `end` if `date_range` is not specified.
        """
...
class AutomationRuleCriteriaCreatedAtDateRange(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.int):
        """
        :param builtins.str unit: A date range unit for the date filter. Valid values: `DAYS`.
        :param builtins.int value: A date range value for the date filter, provided as an Integer.
        """
...
class ConfigurationPolicyConfigurationPolicy(dict):
    ...
    def __init__(__self__, *,
                 service_enabled: builtins.bool,
                 enabled_standard_arns: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param builtins.bool service_enabled: Indicates whether Security Hub is enabled in the policy.
        :param Sequence[builtins.str] enabled_standard_arns: A list that defines which security standards are enabled in the configuration policy. It must be defined if `service_enabled` is set to true.
    ...
    def service_enabled(self) -> builtins.bool:
        """
    ...
    def enabled_standard_arns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConfigurationPolicyConfigurationPolicySecurityControlsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 disabled_control_identifiers: Optional[Sequence[builtins.str]] = None,
                 enabled_control_identifiers: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param Sequence[builtins.str] disabled_control_identifiers: A list of security controls that are disabled in the configuration policy Security Hub enables all other controls (including newly released controls) other than the listed controls. Conflicts with `enabled_control_identifiers`.
        :param Sequence[builtins.str] enabled_control_identifiers: A list of security controls that are enabled in the configuration policy. Security Hub disables all other controls (including newly released controls) other than the listed controls. Conflicts with `disabled_control_identifiers`.
    ...
    def disabled_control_identifiers(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def enabled_control_identifiers(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str security_control_id: The ID of the security control. For more information see the [Security Hub controls reference] documentation.
        """
...
class ConfigurationPolicyConfigurationPolicySecurityControlsConfigurationSecurityControlCustomParameterParameter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the control parameter. For more information see the [Security Hub controls reference] documentation.
        :param builtins.str value_type: Identifies whether a control parameter uses a custom user-defined value or subscribes to the default Security Hub behavior. Valid values: `DEFAULT`, `CUSTOM`.
...
class InsightFiltersConfidence(dict):
    def __init__(__self__, *,
                 eq: Optional[builtins.str] = None,
                 gte: Optional[builtins.str] = None,
                 lte: Optional[builtins.str] = None):
        """
        :param builtins.str eq: The equal-to condition to be applied to a single field when querying for findings, provided as a String.
        :param builtins.str gte: The greater-than-equal condition to be applied to a single field when querying for findings, provided as a String.
        :param builtins.str lte: The less-than-equal condition to be applied to a single field when querying for findings, provided as a String.
        """
        if eq is not None:
            pulumi.set(__self__, "eq", eq)
        if gte is not None:
    ...
    @property
    @pulumi.getter
    def eq(self) -> Optional[builtins.str]:
        """
        The equal-to condition to be applied to a single field when querying for findings, provided as a String.
        """
        return pulumi.get(self, "eq")
    ...
    @property
    @pulumi.getter
    def gte(self) -> Optional[builtins.str]:
        """
        The greater-than-equal condition to be applied to a single field when querying for findings, provided as a String.
        """
        return pulumi.get(self, "gte")
    ...
    @property
    @pulumi.getter
    def lte(self) -> Optional[builtins.str]:
        """
        The less-than-equal condition to be applied to a single field when querying for findings, provided as a String.
        """
        return pulumi.get(self, "lte")
...
class InsightFiltersKeyword(dict):
    def __init__(__self__, *,
                 value: builtins.str):
        """
        :param builtins.str value: A value for the keyword.
        """
        pulumi.set(__self__, "value", value)
...
class InsightFiltersNetworkDestinationIpv4(dict):
    def __init__(__self__, *,
                 cidr: builtins.str):
        """
        :param builtins.str cidr: A finding's CIDR value.
        """
...
class InsightFiltersProductField(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: The key of the map filter. For example, for `ResourceTags`, `Key` identifies the name of the tag. For `UserDefinedFields`, `Key` is the name of the field.
        """
        pulumi.set(__self__, "comparison", comparison)
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class GetStandardsControlAssociationsStandardsControlAssociationResult(dict):
    def __init__(__self__, *,
                 ...
                 related_requirements: Sequence[builtins.str],
                 security_control_arn: builtins.str,
                 security_control_id: builtins.str,
                 standards_arn: builtins.str,
                 standards_control_description: builtins.str,
                 standards_control_title: builtins.str,
                 updated_at: builtins.str,
                 updated_reason: builtins.str):
        """
        :param builtins.str association_status: Enablement status of a control in a specific standard.
        :param Sequence[builtins.str] related_requirements: List of underlying requirements in the compliance framework related to the standard.
        :param builtins.str security_control_arn: ARN of the security control.
        ...
        :param builtins.str standards_arn: ARN of the standard.
        :param builtins.str standards_control_description: Description of the standard.
        :param builtins.str standards_control_title: Title of the standard.
        :param builtins.str updated_at: Last time that a control's enablement status in a specified standard was updated.
        :param builtins.str updated_reason: Reason for updating a control's enablement status in a specified standard.
        """
    ...
    def related_requirements(self) -> Sequence[builtins.str]:
        """
