...
class InsightArgs:
    ...
    def _configure(
        ...
        if group_by_attribute is None and 'groupByAttribute' in kwargs:
            group_by_attribute = kwargs['groupByAttribute']
        if group_by_attribute is None:
            raise TypeError("Missing 'group_by_attribute' argument")
...
class Insight(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            InsightArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if filters is not None and not isinstance(filters, InsightFiltersArgs):
                filters = filters or {}
                def _setter(key, value):
                    filters[key] = value
                InsightFiltersArgs._configure(_setter, **filters)
