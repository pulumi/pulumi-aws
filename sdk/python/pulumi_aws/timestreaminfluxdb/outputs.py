...
class DbInstanceLogDeliveryConfigurationS3Configuration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket_name: Name of the S3 bucket to deliver logs to.
        :param builtins.bool enabled: Indicates whether log delivery to the S3 bucket is enabled.
