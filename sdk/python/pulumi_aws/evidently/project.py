...
class _ProjectState:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'activeExperimentCount' in kwargs:
            active_experiment_count = kwargs['activeExperimentCount']
        if 'activeLaunchCount' in kwargs:
...
class Project(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if data_delivery is not None and not isinstance(data_delivery, ProjectDataDeliveryArgs):
                data_delivery = data_delivery or {}
                def _setter(key, value):
                    data_delivery[key] = value
                ProjectDataDeliveryArgs._configure(_setter, **data_delivery)
