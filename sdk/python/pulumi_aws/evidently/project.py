...
class _ProjectState:
    def __init__(__self__, *,
                 active_experiment_count: Optional[pulumi.Input[builtins.int]] = None,
                 active_launch_count: Optional[pulumi.Input[builtins.int]] = None,
                 arn: Optional[pulumi.Input[builtins.str]] = None,
                 created_time: Optional[pulumi.Input[builtins.str]] = None,
                 data_delivery: Optional[pulumi.Input['ProjectDataDeliveryArgs']] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 experiment_count: Optional[pulumi.Input[builtins.int]] = None,
                 feature_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] active_experiment_count: The number of ongoing experiments currently in the project.
        :param pulumi.Input[builtins.int] active_launch_count: The number of ongoing launches currently in the project.
        :param pulumi.Input[builtins.str] arn: The ARN of the project.
        :param pulumi.Input[builtins.str] created_time: The date and time that the project is created.
        :param pulumi.Input['ProjectDataDeliveryArgs'] data_delivery: A block that contains information about where Evidently is to store evaluation events for longer term storage, if you choose to do so. If you choose not to store these events, Evidently deletes them after using them to produce metrics and other experiment results that you can view. See below.
        :param pulumi.Input[builtins.str] description: Specifies the description of the project.
        :param pulumi.Input[builtins.int] experiment_count: The number of experiments currently in the project. This includes all experiments that have been created and not deleted, whether they are ongoing or not.
        :param pulumi.Input[builtins.int] feature_count: The number of features currently in the project.
    ...
    def active_experiment_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def active_experiment_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "active_experiment_count", value)

    @property
    @pulumi.getter(name="activeLaunchCount")
    def active_launch_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def active_launch_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def feature_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def feature_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Project(pulumi.CustomResource):
    ...
    pulumi_type = "aws:evidently/project:Project"
    ...
    @property
    @pulumi.getter(name="activeExperimentCount")
    def active_experiment_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of ongoing experiments currently in the project.
        """
        return pulumi.get(self, "active_experiment_count")
    ...
    @property
    @pulumi.getter(name="activeLaunchCount")
    def active_launch_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of ongoing launches currently in the project.
        """
        return pulumi.get(self, "active_launch_count")
    ...
    @property
    @pulumi.getter(name="featureCount")
    def feature_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of features currently in the project.
        """
        return pulumi.get(self, "feature_count")
