...
class FeatureVariationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] name: The name of the variation. Minimum length of `1`. Maximum length of `127`.
...
class FeatureVariationValueArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] long_value: If this feature uses the long variation type, this field contains the long value of this variation. Minimum value of `-9007199254740991`. Maximum value of `9007199254740991`.
        :param pulumi.Input[_builtins.str] string_value: If this feature uses the string variation type, this field contains the string value of this variation. Minimum length of `0`. Maximum length of `512`.
        """
...
class LaunchGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] variation: Specifies the feature variation to use for this launch group.
        :param pulumi.Input[_builtins.str] description: Specifies the description of the launch group.
        """
...
class LaunchMetricMonitorMetricDefinitionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] value_key: Specifies the value that is tracked to produce the metric.
        :param pulumi.Input[_builtins.str] event_pattern: Specifies The EventBridge event pattern that defines how the metric is recorded.
        :param pulumi.Input[_builtins.str] unit_label: Specifies a label for the units that the metric is measuring.
        """
...
class LaunchScheduledSplitsConfigStepSegmentOverrideArgs:
    def __init__(__self__, *,
                 ...
                 weights: pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]]):
        """
        :param pulumi.Input[_builtins.int] evaluation_order: Specifies a number indicating the order to use to evaluate segment overrides, if there are more than one. Segment overrides with lower numbers are evaluated first.
        :param pulumi.Input[_builtins.str] segment: The name or ARN of the segment to use.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.int]]] weights: The traffic allocation percentages among the feature variations to assign to this segment. This is a set of key-value pairs. The keys are variation names. The values represent the amount of traffic to allocate to that variation for this segment. This is expressed in thousandths of a percent, so a weight of 50000 represents 50% of traffic.
        """
