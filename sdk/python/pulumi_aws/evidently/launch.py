...
class Launch(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if scheduled_splits_config is not None and not isinstance(scheduled_splits_config, LaunchScheduledSplitsConfigArgs):
                scheduled_splits_config = scheduled_splits_config or {}
                def _setter(key, value):
                    scheduled_splits_config[key] = value
                LaunchScheduledSplitsConfigArgs._configure(_setter, **scheduled_splits_config)
