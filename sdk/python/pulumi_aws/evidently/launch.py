...
class LaunchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Specifies the description of the launch.
    ...
    def randomization_salt(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def randomization_salt(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LaunchState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the launch.
        :param pulumi.Input[builtins.str] created_time: The date and time that the launch is created.
        :param pulumi.Input[builtins.str] description: Specifies the description of the launch.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LaunchGroupArgs']]] groups: One or up to five blocks that contain the feature and variations that are to be used for the launch. Detailed below.
        :param pulumi.Input[builtins.str] last_updated_time: The date and time that the launch was most recently updated.
        :param pulumi.Input[Sequence[pulumi.Input['LaunchMetricMonitorArgs']]] metric_monitors: One or up to three blocks that define the metrics that will be used to monitor the launch performance. Detailed below.
        :param pulumi.Input[builtins.str] name: The name for the new launch. Minimum length of `1`. Maximum length of `127`.
        :param pulumi.Input[builtins.str] project: The name or ARN of the project that is to contain the new launch.
        :param pulumi.Input[builtins.str] randomization_salt: When Evidently assigns a particular user session to a launch, it must use a randomization ID to determine which variation the user session is served. This randomization ID is a combination of the entity ID and randomizationSalt. If you omit randomizationSalt, Evidently uses the launch name as the randomizationSalt.
        ...
        :param pulumi.Input[builtins.str] type: The type of launch.
        """
        if arn is not None:
...
class Launch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Launch':
        """
    ...
    @property
    @pulumi.getter(name="randomizationSalt")
    def randomization_salt(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When Evidently assigns a particular user session to a launch, it must use a randomization ID to determine which variation the user session is served. This randomization ID is a combination of the entity ID and randomizationSalt. If you omit randomizationSalt, Evidently uses the launch name as the randomizationSalt.
        """
        return pulumi.get(self, "randomization_salt")
