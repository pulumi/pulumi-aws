...
if not MYPY:
    class LifecyclePolicyPolicyDetailsArgsDict(TypedDict):
        ...
        """
        resource_locations: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        target_tags: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class LifecyclePolicyPolicyDetailsArgs:
    def __init__(__self__, *,
                 ...
                 resource_locations: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 target_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] policy_type: The valid target resource types and actions a policy can manage. Specify `EBS_SNAPSHOT_MANAGEMENT` to create a lifecycle policy that manages the lifecycle of Amazon EBS snapshots. Specify `IMAGE_MANAGEMENT` to create a lifecycle policy that manages the lifecycle of EBS-backed AMIs. Specify `EVENT_BASED_POLICY` to create an event-based policy that performs specific actions when a defined event occurs in your AWS account. Default value is `EBS_SNAPSHOT_MANAGEMENT`.
        :param pulumi.Input[builtins.str] resource_locations: The location of the resources to backup. If the source resources are located in an AWS Region, specify `CLOUD`. If the source resources are located on an Outpost in your account, specify `OUTPOST`. If you specify `OUTPOST`, Amazon Data Lifecycle Manager backs up all resources of the specified type with matching target tags across all of the Outposts in your account. Valid values are `CLOUD` and `OUTPOST`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_types: A list of resource types that should be targeted by the lifecycle policy. Valid values are `VOLUME` and `INSTANCE`.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] target_tags: A map of tag keys and their values. Any resources that match the `resource_types` and are tagged with _any_ of these tags will be targeted.
    ...
    def resource_locations(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The location of the resources to backup. If the source resources are located in an AWS Region, specify `CLOUD`. If the source resources are located on an Outpost in your account, specify `OUTPOST`. If you specify `OUTPOST`, Amazon Data Lifecycle Manager backs up all resources of the specified type with matching target tags across all of the Outposts in your account. Valid values are `CLOUD` and `OUTPOST`.
        """
    ...
    def resource_locations(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A map of tag keys and their values. Any resources that match the `resource_types` and are tagged with _any_ of these tags will be targeted.
    ...
    @target_tags.setter
    def target_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class LifecyclePolicyPolicyDetailsActionCrossRegionCopyEncryptionConfigurationArgsDict(TypedDict):
        cmk_arn: NotRequired[pulumi.Input[builtins.str]]
...
class LifecyclePolicyPolicyDetailsActionCrossRegionCopyEncryptionConfigurationArgs:
    def __init__(__self__, *,
                 cmk_arn: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def cmk_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "cmk_arn")

    @cmk_arn.setter
    def cmk_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LifecyclePolicyPolicyDetailsEventSourceArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] type: The source of the event. Currently only managed CloudWatch Events rules are supported. Valid values are `MANAGED_CWE`.
        """
        pulumi.set(__self__, "parameters", parameters)
...
if not MYPY:
    class LifecyclePolicyPolicyDetailsEventSourceParametersArgsDict(TypedDict):
        description_regex: pulumi.Input[builtins.str]
        """
        ...
        """
        snapshot_owners: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class LifecyclePolicyPolicyDetailsEventSourceParametersArgs:
    def __init__(__self__, *,
                 ...
                 snapshot_owners: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] description_regex: The snapshot description that can trigger the policy. The description pattern is specified using a regular expression. The policy runs only if a snapshot with a description that matches the specified pattern is shared with your account.
        :param pulumi.Input[builtins.str] event_type: The type of event. Currently, only `shareSnapshot` events are supported.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] snapshot_owners: The IDs of the AWS accounts that can trigger policy by sharing snapshots with your account. The policy only runs if one of the specified AWS accounts shares a snapshot with your account.
        """
    ...
    def description_regex(self) -> pulumi.Input[builtins.str]:
        """
        The snapshot description that can trigger the policy. The description pattern is specified using a regular expression. The policy runs only if a snapshot with a description that matches the specified pattern is shared with your account.
        """
    ...
    def description_regex(self, value: pulumi.Input[builtins.str]):
    ...
    def snapshot_owners(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The IDs of the AWS accounts that can trigger policy by sharing snapshots with your account. The policy only runs if one of the specified AWS accounts shares a snapshot with your account.
        """
    ...
    def snapshot_owners(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "snapshot_owners", value)


if not MYPY:
    class LifecyclePolicyPolicyDetailsParametersArgsDict(TypedDict):
        exclude_boot_volume: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates whether to exclude the root volume from snapshots created using CreateSnapshots. The default is `false`.
        """
        no_reboot: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class LifecyclePolicyPolicyDetailsParametersArgs:
    def __init__(__self__, *,
                 exclude_boot_volume: Optional[pulumi.Input[builtins.bool]] = None,
                 no_reboot: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] exclude_boot_volume: Indicates whether to exclude the root volume from snapshots created using CreateSnapshots. The default is `false`.
        :param pulumi.Input[builtins.bool] no_reboot: Applies to AMI lifecycle policies only. Indicates whether targeted instances are rebooted when the lifecycle policy runs. `true` indicates that targeted instances are not rebooted when the policy runs. `false` indicates that target instances are rebooted when the policy runs. The default is `true` (instances are not rebooted).
        """
    ...
    def exclude_boot_volume(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether to exclude the root volume from snapshots created using CreateSnapshots. The default is `false`.
        """
    ...
    def exclude_boot_volume(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "exclude_boot_volume", value)

    @property
    @pulumi.getter(name="noReboot")
    def no_reboot(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Applies to AMI lifecycle policies only. Indicates whether targeted instances are rebooted when the lifecycle policy runs. `true` indicates that targeted instances are not rebooted when the policy runs. `false` indicates that target instances are rebooted when the policy runs. The default is `true` (instances are not rebooted).
        """
    ...
    @no_reboot.setter
    def no_reboot(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class LifecyclePolicyPolicyDetailsScheduleArgsDict(TypedDict):
        ...
        copy_tags: NotRequired[pulumi.Input[builtins.bool]]
        ...
        """
        tags_to_add: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        A map of tag keys and their values. DLM lifecycle policies will already tag the snapshot with the tags on the volume. This configuration adds extra tags on top of these.
        """
        variable_tags: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class LifecyclePolicyPolicyDetailsScheduleArgs:
    def __init__(__self__, *,
                 ...
                 tags_to_add: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 variable_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags_to_add: A map of tag keys and their values. DLM lifecycle policies will already tag the snapshot with the tags on the volume. This configuration adds extra tags on top of these.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] variable_tags: A map of tag keys and variable values, where the values are determined when the policy is executed. Only `$(instance-id)` or `$(timestamp)` are valid values. Can only be used when `resource_types` is `INSTANCE`.
        """
    ...
    def tags_to_add(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A map of tag keys and their values. DLM lifecycle policies will already tag the snapshot with the tags on the volume. This configuration adds extra tags on top of these.
        """
    ...
    @tags_to_add.setter
    def tags_to_add(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "tags_to_add", value)

    @property
    @pulumi.getter(name="variableTags")
    def variable_tags(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        A map of tag keys and variable values, where the values are determined when the policy is executed. Only `$(instance-id)` or `$(timestamp)` are valid values. Can only be used when `resource_types` is `INSTANCE`.
        """
    ...
    def variable_tags(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class LifecyclePolicyPolicyDetailsScheduleCreateRuleArgsDict(TypedDict):
        ...
        interval_unit: NotRequired[pulumi.Input[builtins.str]]
...
class LifecyclePolicyPolicyDetailsScheduleCreateRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cron_expression: The schedule, as a Cron expression. The schedule interval must be between 1 hour and 1 year. Conflicts with `interval`, `interval_unit`, and `times`.
        :param pulumi.Input[builtins.str] location: Specifies the destination for snapshots created by the policy. To create snapshots in the same Region as the source resource, specify `CLOUD`. To create snapshots on the same Outpost as the source resource, specify `OUTPOST_LOCAL`. If you omit this parameter, `CLOUD` is used by default. If the policy targets resources in an AWS Region, then you must create snapshots in the same Region as the source resource. If the policy targets resources on an Outpost, then you can create snapshots on the same Outpost as the source resource, or in the Region of that Outpost. Valid values are `CLOUD` and `OUTPOST_LOCAL`.
        :param pulumi.Input[builtins.str] times: A list of times in 24 hour clock format that sets when the lifecycle policy should be evaluated. Max of 1. Conflicts with `cron_expression`. Must be set if `interval` is set.
        """
...
if not MYPY:
    class LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgsDict(TypedDict):
        encrypted: pulumi.Input[builtins.bool]
        target: pulumi.Input[builtins.str]
        cmk_arn: NotRequired[pulumi.Input[builtins.str]]
        copy_tags: NotRequired[pulumi.Input[builtins.bool]]
...
class LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgs:
    ...
    @property
    @pulumi.getter
    def encrypted(self) -> pulumi.Input[builtins.bool]:
        return pulumi.get(self, "encrypted")

    @encrypted.setter
    def encrypted(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "encrypted", value)
...
class LifecyclePolicyPolicyDetailsScheduleFastRestoreRuleArgs:
    def __init__(__self__, *,
                 ...
                 interval_unit: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: The Availability Zones in which to enable fast snapshot restore.
        """
...
if not MYPY:
    class LifecyclePolicyPolicyDetailsScheduleShareRuleArgsDict(TypedDict):
        ...
        """
        unshare_interval: NotRequired[pulumi.Input[builtins.int]]
        """
        The period after which snapshots that are shared with other AWS accounts are automatically unshared.
        """
        unshare_interval_unit: NotRequired[pulumi.Input[builtins.str]]
        """
...
class LifecyclePolicyPolicyDetailsScheduleShareRuleArgs:
    def __init__(__self__, *,
                 target_accounts: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 unshare_interval: Optional[pulumi.Input[builtins.int]] = None,
                 unshare_interval_unit: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_accounts: The IDs of the AWS accounts with which to share the snapshots.
        :param pulumi.Input[builtins.int] unshare_interval: The period after which snapshots that are shared with other AWS accounts are automatically unshared.
        :param pulumi.Input[builtins.str] unshare_interval_unit: The unit of time for the automatic unsharing interval. Valid values are `DAYS`, `WEEKS`, `MONTHS`, `YEARS`.
        """
    ...
    def unshare_interval(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The period after which snapshots that are shared with other AWS accounts are automatically unshared.
        """
    ...
    def unshare_interval(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "unshare_interval", value)

    @property
    @pulumi.getter(name="unshareIntervalUnit")
    def unshare_interval_unit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unit of time for the automatic unsharing interval. Valid values are `DAYS`, `WEEKS`, `MONTHS`, `YEARS`.
        """
    ...
    def unshare_interval_unit(self, value: Optional[pulumi.Input[builtins.str]]):
