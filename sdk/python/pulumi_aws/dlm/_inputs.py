...
class LifecyclePolicyPolicyDetailsArgsDict(TypedDict):
    action: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsActionArgsDict']]]
    """
    ...
    """
    event_source: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsEventSourceArgsDict']]]
    """
    ...
    """
    exclusions: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsExclusionsArgsDict']]]
    """
    ...
    """
    parameters: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsParametersArgsDict']]]
    ...
    """
    resource_locations: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    schedules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['LifecyclePolicyPolicyDetailsScheduleArgsDict']]]]]
    """
    See the `schedule` configuration block.
    """
    target_tags: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
...
class LifecyclePolicyPolicyDetailsArgs:
    def __init__(__self__, *,
                 action: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsActionArgs']] = None,
                 copy_tags: pulumi.Input[Optional[_builtins.bool]] = None,
                 create_interval: pulumi.Input[Optional[_builtins.int]] = None,
                 event_source: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsEventSourceArgs']] = None,
                 exclusions: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsExclusionsArgs']] = None,
                 extend_deletion: pulumi.Input[Optional[_builtins.bool]] = None,
                 parameters: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsParametersArgs']] = None,
                 policy_language: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_type: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_locations: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 schedules: pulumi.Input[Optional[Sequence[pulumi.Input['LifecyclePolicyPolicyDetailsScheduleArgs']]]] = None,
                 target_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def action(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsActionArgs']]:
        """
        The actions to be performed when the event-based policy is triggered. You can specify only one action per policy. This parameter is required for event-based policies only. If you are creating a snapshot or AMI policy, omit this parameter. See the `action` configuration block.
        """
    ...
    @action.setter
    def action(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsActionArgs']]):
    ...
    def event_source(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsEventSourceArgs']]:
        """
        The event that triggers the event-based policy. This parameter is required for event-based policies only. If you are creating a snapshot or AMI policy, omit this parameter. See the `event_source` configuration block.
        """
    ...
    @event_source.setter
    def event_source(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsEventSourceArgs']]):
        pulumi.set(self, "event_source", value)

    @_builtins.property
    @pulumi.getter
    def exclusions(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsExclusionsArgs']]:
        """
        Specifies exclusion parameters for volumes or instances for which you do not want to create snapshots or AMIs.  See the `exclusions` configuration block.
        """
    ...
    @exclusions.setter
    def exclusions(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsExclusionsArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def parameters(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsParametersArgs']]:
        return pulumi.get(self, "parameters")

    @parameters.setter
    def parameters(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsParametersArgs']]):
    ...
    def resource_locations(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The location of the resources to backup. If the source resources are located in an AWS Region, specify `CLOUD`. If the source resources are located on an Outpost in your account, specify `OUTPOST`. If the source resources are located in a Local Zone, specify `LOCAL_ZONE`. Valid values are `CLOUD`, `LOCAL_ZONE`, and `OUTPOST`.
        """
    ...
    def resource_locations(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def schedules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LifecyclePolicyPolicyDetailsScheduleArgs']]]]:
        """
        See the `schedule` configuration block.
        """
    ...
    @schedules.setter
    def schedules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LifecyclePolicyPolicyDetailsScheduleArgs']]]]):
        pulumi.set(self, "schedules", value)

    @_builtins.property
    @pulumi.getter(name="targetTags")
    def target_tags(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        A map of tag keys and their values. Any resources that match the `resource_types` and are tagged with _any_ of these tags will be targeted. Required when `policy_type` is `EBS_SNAPSHOT_MANAGEMENT` or `IMAGE_MANAGEMENT`. Must not be specified when `policy_type` is `EVENT_BASED_POLICY`.
    ...
    @target_tags.setter
    def target_tags(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class LifecyclePolicyPolicyDetailsActionCrossRegionCopyArgsDict(TypedDict):
    ...
    retain_rule: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRuleArgsDict']]]
...
class LifecyclePolicyPolicyDetailsActionCrossRegionCopyArgs:
    def __init__(__self__, *,
                 ...
                 target: pulumi.Input[_builtins.str],
                 retain_rule: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRuleArgs']] = None):
        """
    ...
    def retain_rule(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRuleArgs']]:
        return pulumi.get(self, "retain_rule")

    @retain_rule.setter
    def retain_rule(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsActionCrossRegionCopyRetainRuleArgs']]):
...
class LifecyclePolicyPolicyDetailsExclusionsArgsDict(TypedDict):
    ...
    """
    exclude_tags: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
...
class LifecyclePolicyPolicyDetailsExclusionsArgs:
    def __init__(__self__, *,
                 ...
                 exclude_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
    ...
    def exclude_tags(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        Map specifies whether to exclude volumes that have specific tags.
        """
    ...
    @exclude_tags.setter
    def exclude_tags(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class LifecyclePolicyPolicyDetailsScheduleArgsDict(TypedDict):
    ...
    archive_rule: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleArchiveRuleArgsDict']]]
    """
    Specifies a snapshot archiving rule for a schedule. See `archive_rule` block.
    """
    copy_tags: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    cross_region_copy_rules: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgsDict']]]]]
    """
    See the `cross_region_copy_rule` block. Max of 3 per schedule.
    """
    deprecate_rule: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleDeprecateRuleArgsDict']]]
    fast_restore_rule: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleFastRestoreRuleArgsDict']]]
    """
    See the `fast_restore_rule` block. Max of 1 per schedule.
    """
    share_rule: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleShareRuleArgsDict']]]
    """
    See the `share_rule` block. Max of 1 per schedule.
    """
    tags_to_add: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
    A map of tag keys and their values. DLM lifecycle policies will already tag the snapshot with the tags on the volume. This configuration adds extra tags on top of these.
    """
    variable_tags: NotRequired[pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]]
    """
...
class LifecyclePolicyPolicyDetailsScheduleArgs:
    def __init__(__self__, *,
                 ...
                 archive_rule: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleArchiveRuleArgs']] = None,
                 copy_tags: pulumi.Input[Optional[_builtins.bool]] = None,
                 cross_region_copy_rules: pulumi.Input[Optional[Sequence[pulumi.Input['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgs']]]] = None,
                 deprecate_rule: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleDeprecateRuleArgs']] = None,
                 fast_restore_rule: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleFastRestoreRuleArgs']] = None,
                 share_rule: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleShareRuleArgs']] = None,
                 tags_to_add: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 variable_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None):
        """
    ...
    def archive_rule(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleArchiveRuleArgs']]:
        """
        Specifies a snapshot archiving rule for a schedule. See `archive_rule` block.
        """
    ...
    @archive_rule.setter
    def archive_rule(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleArchiveRuleArgs']]):
    ...
    def cross_region_copy_rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgs']]]]:
        """
        See the `cross_region_copy_rule` block. Max of 3 per schedule.
        """
    ...
    def cross_region_copy_rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgs']]]]):
        pulumi.set(self, "cross_region_copy_rules", value)

    @_builtins.property
    @pulumi.getter(name="deprecateRule")
    def deprecate_rule(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleDeprecateRuleArgs']]:
        return pulumi.get(self, "deprecate_rule")

    @deprecate_rule.setter
    def deprecate_rule(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleDeprecateRuleArgs']]):
        pulumi.set(self, "deprecate_rule", value)

    @_builtins.property
    @pulumi.getter(name="fastRestoreRule")
    def fast_restore_rule(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleFastRestoreRuleArgs']]:
        """
        See the `fast_restore_rule` block. Max of 1 per schedule.
        """
    ...
    def fast_restore_rule(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleFastRestoreRuleArgs']]):
        pulumi.set(self, "fast_restore_rule", value)

    @_builtins.property
    @pulumi.getter(name="shareRule")
    def share_rule(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleShareRuleArgs']]:
        """
        See the `share_rule` block. Max of 1 per schedule.
        """
    ...
    @share_rule.setter
    def share_rule(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleShareRuleArgs']]):
        pulumi.set(self, "share_rule", value)

    @_builtins.property
    @pulumi.getter(name="tagsToAdd")
    def tags_to_add(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        A map of tag keys and their values. DLM lifecycle policies will already tag the snapshot with the tags on the volume. This configuration adds extra tags on top of these.
        """
    ...
    @tags_to_add.setter
    def tags_to_add(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "tags_to_add", value)

    @_builtins.property
    @pulumi.getter(name="variableTags")
    def variable_tags(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        A map of tag keys and variable values, where the values are determined when the policy is executed. Only `$(instance-id)` or `$(timestamp)` are valid values. Can only be used when `resource_types` is `INSTANCE`.
        """
    ...
    def variable_tags(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class LifecyclePolicyPolicyDetailsScheduleCreateRuleArgsDict(TypedDict):
    ...
    """
    scripts: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCreateRuleScriptsArgsDict']]]
    """
...
class LifecyclePolicyPolicyDetailsScheduleCreateRuleArgs:
    def __init__(__self__, *,
                 ...
                 scripts: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCreateRuleScriptsArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def scripts(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCreateRuleScriptsArgs']]:
        """
        Specifies pre and/or post scripts for a snapshot lifecycle policy that targets instances. Valid only when `resource_type` is INSTANCE. See the `scripts` configuration block.
        """
    ...
    @scripts.setter
    def scripts(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCreateRuleScriptsArgs']]):
...
class LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgsDict(TypedDict):
    ...
    cmk_arn: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    copy_tags: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    deprecate_rule: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleDeprecateRuleArgsDict']]]
    retain_rule: NotRequired[pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleRetainRuleArgsDict']]]
...
class LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleArgs:
    def __init__(__self__, *,
                 ...
                 cmk_arn: pulumi.Input[Optional[_builtins.str]] = None,
                 copy_tags: pulumi.Input[Optional[_builtins.bool]] = None,
                 deprecate_rule: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleDeprecateRuleArgs']] = None,
                 retain_rule: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleRetainRuleArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="deprecateRule")
    def deprecate_rule(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleDeprecateRuleArgs']]:
        return pulumi.get(self, "deprecate_rule")

    @deprecate_rule.setter
    def deprecate_rule(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleDeprecateRuleArgs']]):
        pulumi.set(self, "deprecate_rule", value)

    @_builtins.property
    @pulumi.getter(name="retainRule")
    def retain_rule(self) -> pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleRetainRuleArgs']]:
        return pulumi.get(self, "retain_rule")

    @retain_rule.setter
    def retain_rule(self, value: pulumi.Input[Optional['LifecyclePolicyPolicyDetailsScheduleCrossRegionCopyRuleRetainRuleArgs']]):
        pulumi.set(self, "retain_rule", value)
