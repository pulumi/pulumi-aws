...
class ClusterClusterCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str aws_hardware_certificate: The HSM hardware certificate issued (signed) by AWS CloudHSM.
        :param _builtins.str cluster_certificate: The cluster certificate issued (signed) by the issuing certificate authority (CA) of the cluster's owner.
        :param _builtins.str cluster_csr: The certificate signing request (CSR). Available only in `UNINITIALIZED` state after an HSM instance is added to the cluster.
        :param _builtins.str hsm_certificate: The HSM certificate issued (signed) by the HSM hardware.
        :param _builtins.str manufacturer_hardware_certificate: The HSM hardware certificate issued (signed) by the hardware manufacturer.
        """
...
class GetClusterClusterCertificateResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str aws_hardware_certificate: The HSM hardware certificate issued (signed) by AWS CloudHSM.
        :param _builtins.str cluster_certificate: The cluster certificate issued (signed) by the issuing certificate authority (CA) of the cluster's owner.
        :param _builtins.str cluster_csr: The certificate signing request (CSR). Available only in UNINITIALIZED state.
        :param _builtins.str hsm_certificate: The HSM certificate issued (signed) by the HSM hardware.
        :param _builtins.str manufacturer_hardware_certificate: The HSM hardware certificate issued (signed) by the hardware manufacturer.
