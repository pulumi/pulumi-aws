...
class ClusterArgs:
    ...
    def hsm_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @hsm_type.setter
    def hsm_type(self, value: pulumi.Input[builtins.str]):
    ...
    def source_backup_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The id of the CloudHSM cluster.
        ...
        :param pulumi.Input[builtins.str] vpc_id: The id of the VPC that the CloudHSM cluster resides in.
        """
    ...
    @property
    @pulumi.getter(name="hsmType")
    def hsm_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of HSM module in the cluster. Currently, `hsm1.medium` and `hsm2m.medium` are supported.
        """
        return pulumi.get(self, "hsm_type")
    ...
    @hsm_type.setter
    def hsm_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hsm_type", value)
...
class Cluster(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="hsmType")
    def hsm_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of HSM module in the cluster. Currently, `hsm1.medium` and `hsm2m.medium` are supported.
        """
        return pulumi.get(self, "hsm_type")
    ...
    @property
    @pulumi.getter(name="sourceBackupIdentifier")
    def source_backup_identifier(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ID of Cloud HSM v2 cluster backup to be restored.
        """
        return pulumi.get(self, "source_backup_identifier")
