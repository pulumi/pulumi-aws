...
class ClusterArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if hsm_type is None and 'hsmType' in kwargs:
            hsm_type = kwargs['hsmType']
        if hsm_type is None:
            raise TypeError("Missing 'hsm_type' argument")
        if subnet_ids is None and 'subnetIds' in kwargs:
            subnet_ids = kwargs['subnetIds']
        if subnet_ids is None:
            raise TypeError("Missing 'subnet_ids' argument")
        if source_backup_identifier is None and 'sourceBackupIdentifier' in kwargs:
            source_backup_identifier = kwargs['sourceBackupIdentifier']
...
class _ClusterState:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if cluster_certificates is None and 'clusterCertificates' in kwargs:
            cluster_certificates = kwargs['clusterCertificates']
