...
class _HsmState:
    def __init__(__self__, *,
                 ...
                 hsm_eni_id: Optional[pulumi.Input[builtins.str]] = None,
                 hsm_id: Optional[pulumi.Input[builtins.str]] = None,
                 hsm_state: Optional[pulumi.Input[builtins.str]] = None,
                 ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 subnet_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] availability_zone: The IDs of AZ in which HSM module will be located. Conflicts with `subnet_id`.
        :param pulumi.Input[builtins.str] cluster_id: The ID of Cloud HSM v2 cluster to which HSM will be added.
        :param pulumi.Input[builtins.str] hsm_eni_id: The id of the ENI interface allocated for HSM module.
    ...
    def hsm_eni_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @hsm_eni_id.setter
    def hsm_eni_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hsm_eni_id", value)

    @property
    @pulumi.getter(name="hsmId")
    def hsm_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @hsm_id.setter
    def hsm_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hsm_id", value)

    @property
    @pulumi.getter(name="hsmState")
    def hsm_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @hsm_state.setter
    def hsm_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Hsm(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            hsm_state: Optional[pulumi.Input[builtins.str]] = None,
            ip_address: Optional[pulumi.Input[builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Hsm':
        """
    ...
    @property
    @pulumi.getter(name="hsmEniId")
    def hsm_eni_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the ENI interface allocated for HSM module.
        """
        return pulumi.get(self, "hsm_eni_id")
    ...
    @property
    @pulumi.getter(name="hsmId")
    def hsm_id(self) -> pulumi.Output[builtins.str]:
        """
        The id of the HSM module.
        """
        return pulumi.get(self, "hsm_id")
    ...
    @property
    @pulumi.getter(name="hsmState")
    def hsm_state(self) -> pulumi.Output[builtins.str]:
        """
        The state of the HSM module.
        """
        return pulumi.get(self, "hsm_state")
