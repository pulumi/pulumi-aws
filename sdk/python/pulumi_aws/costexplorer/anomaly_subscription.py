...
class AnomalySubscription(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if threshold_expression is not None and not isinstance(threshold_expression, AnomalySubscriptionThresholdExpressionArgs):
                threshold_expression = threshold_expression or {}
                def _setter(key, value):
                    threshold_expression[key] = value
                AnomalySubscriptionThresholdExpressionArgs._configure(_setter, **threshold_expression)
