...
class AnomalySubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 monitor_arn_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
    ...
    def monitor_arn_lists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def monitor_arn_lists(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class _AnomalySubscriptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The unique identifier for the AWS account in which the anomaly subscription ought to be created.
        :param pulumi.Input[builtins.str] arn: ARN of the anomaly subscription.
        :param pulumi.Input[builtins.str] frequency: The frequency that anomaly reports are sent. Valid Values: `DAILY` | `IMMEDIATE` | `WEEKLY`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] monitor_arn_lists: A list of cost anomaly monitors.
        :param pulumi.Input[builtins.str] name: The name for the subscription.
        :param pulumi.Input[Sequence[pulumi.Input['AnomalySubscriptionSubscriberArgs']]] subscribers: A subscriber configuration. Multiple subscribers can be defined.
    ...
    @property
    @pulumi.getter(name="monitorArnLists")
    def monitor_arn_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of cost anomaly monitors.
        """
        return pulumi.get(self, "monitor_arn_lists")
    ...
    @monitor_arn_lists.setter
    def monitor_arn_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "monitor_arn_lists", value)
...
class AnomalySubscription(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="monitorArnLists")
    def monitor_arn_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of cost anomaly monitors.
        """
        return pulumi.get(self, "monitor_arn_lists")
