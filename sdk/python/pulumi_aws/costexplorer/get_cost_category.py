...
class GetCostCategoryResult:
    ...
    """
    def __init__(__self__, cost_category_arn=None, effective_end=None, effective_start=None, id=None, name=None, rule_version=None, rules=None, split_charge_rules=None):
