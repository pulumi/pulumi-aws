...
class StreamKinesisConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 aggregation_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str stream_arn: The Amazon Resource Name (ARN) of the Kinesis Data Streams resource.
        :param builtins.bool aggregation_enabled: Enables QLDB to publish multiple data records in a single Kinesis Data Streams record, increasing the number of records sent per API call. Default: `true`.
        """
    ...
    def aggregation_enabled(self) -> Optional[builtins.bool]:
        """
