...
class InstanceProfileArgs:
    def __init__(__self__, *,
                 ...
                 exclude_app_packages_from_cleanups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_app_packages_from_cleanups: An array of strings that specifies the list of app packages that should not be cleaned up from the device after a test run.
    ...
    def exclude_app_packages_from_cleanups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def exclude_app_packages_from_cleanups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _InstanceProfileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name of this instance profile.
        :param pulumi.Input[builtins.str] description: The description of the instance profile.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclude_app_packages_from_cleanups: An array of strings that specifies the list of app packages that should not be cleaned up from the device after a test run.
        :param pulumi.Input[builtins.str] name: The name for the instance profile.
        :param pulumi.Input[builtins.bool] package_cleanup: When set to `true`, Device Farm removes app packages after a test run. The default value is `false` for private devices.
...
class InstanceProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reboot_after_use: Optional[pulumi.Input[builtins.bool]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'InstanceProfile':
        """
    ...
    @property
    @pulumi.getter(name="excludeAppPackagesFromCleanups")
    def exclude_app_packages_from_cleanups(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        An array of strings that specifies the list of app packages that should not be cleaned up from the device after a test run.
        """
        return pulumi.get(self, "exclude_app_packages_from_cleanups")
