...
class PermissionArgs:
    ...
    def _configure(
        ...
        if statement_id_prefix is None and 'statementIdPrefix' in kwargs:
            statement_id_prefix = kwargs['statementIdPrefix']
        ...
        if statement_id_prefix is not None:
            _setter("statement_id_prefix", statement_id_prefix)
