...
class FunctionArgs:
    ...
    def _configure(
        ...
        if 'replaceSecurityGroupsOnDestroy' in kwargs:
            replace_security_groups_on_destroy = kwargs['replaceSecurityGroupsOnDestroy']
        if 'replacementSecurityGroupIds' in kwargs:
...
class _FunctionState:
    ...
    def _configure(
        ...
        if 'packageType' in kwargs:
            package_type = kwargs['packageType']
        if 'qualifiedArn' in kwargs:
            qualified_arn = kwargs['qualifiedArn']
        if 'qualifiedInvokeArn' in kwargs:
        ...
        if 's3ObjectVersion' in kwargs:
            s3_object_version = kwargs['s3ObjectVersion']
        if 'signingJobArn' in kwargs:
            signing_job_arn = kwargs['signingJobArn']
        if 'signingProfileVersionArn' in kwargs:
