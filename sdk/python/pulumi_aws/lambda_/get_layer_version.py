...
class GetLayerVersionResult:
    ...
    def compatible_architecture(self) -> Optional[builtins.str]:
    ...
    def compatible_runtime(self) -> Optional[builtins.str]:
        return pulumi.get(self, "compatible_runtime")

    @property
    @pulumi.getter(name="compatibleRuntimes")
    def compatible_runtimes(self) -> Sequence[builtins.str]:
        """
    ...
    def source_code_size(self) -> builtins.int:
        """
