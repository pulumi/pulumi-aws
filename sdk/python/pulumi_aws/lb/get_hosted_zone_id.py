...
def get_hosted_zone_id(load_balancer_type: Optional[builtins.str] = None,
...
def get_hosted_zone_id_output(load_balancer_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
