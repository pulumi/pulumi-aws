...
def get_trust_store(arn: Optional[builtins.str] = None,
    ...
    :param builtins.str arn: Full ARN of the trust store.
...
def get_trust_store_output(arn: Optional[pulumi.Input[Optional[builtins.str]]] = None,
