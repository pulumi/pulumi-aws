...
class ScalingPlan(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_scaling_plan = aws.autoscalingplans.ScalingPlan("example",
            ...
            application_source=aws.autoscalingplans.ScalingPlanApplicationSourceArgs(
                tag_filters=[aws.autoscalingplans.ScalingPlanApplicationSourceTagFilterArgs(
                    key="application",
                    values=["example"],
                )],
            ),
            scaling_instructions=[aws.autoscalingplans.ScalingPlanScalingInstructionArgs(
                max_capacity=3,
                min_capacity=0,
                resource_id=not_implemented("format(\\"autoScalingGroup/%s\\",aws_autoscaling_group.example.name)"),
                scalable_dimension="autoscaling:autoScalingGroup:DesiredCapacity",
                service_namespace="autoscaling",
                target_tracking_configurations=[aws.autoscalingplans.ScalingPlanScalingInstructionTargetTrackingConfigurationArgs(
                    predefined_scaling_metric_specification=aws.autoscalingplans.ScalingPlanScalingInstructionTargetTrackingConfigurationPredefinedScalingMetricSpecificationArgs(
        ...
        example_scaling_plan = aws.autoscalingplans.ScalingPlan("example",
            ...
            scaling_instructions=[aws.autoscalingplans.ScalingPlanScalingInstructionArgs(
                ...
                predefined_load_metric_specification=aws.autoscalingplans.ScalingPlanScalingInstructionPredefinedLoadMetricSpecificationArgs(
