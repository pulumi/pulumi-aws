...
class _ScalingPlanState:
    ...
    def scaling_plan_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def scaling_plan_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ScalingPlan(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="scalingPlanVersion")
    def scaling_plan_version(self) -> pulumi.Output[builtins.int]:
        """
        The version number of the scaling plan. This value is always 1.
        """
        return pulumi.get(self, "scaling_plan_version")
