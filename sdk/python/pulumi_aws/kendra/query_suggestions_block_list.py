...
class _QuerySuggestionsBlockListState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the block list.
        :param pulumi.Input[builtins.str] index_id: Identifier of the index for a block list.
        :param pulumi.Input[builtins.str] name: Name for the block list.
    ...
    def query_suggestions_block_list_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def query_suggestions_block_list_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class QuerySuggestionsBlockList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'QuerySuggestionsBlockList':
        """
    ...
    @property
    @pulumi.getter(name="querySuggestionsBlockListId")
    def query_suggestions_block_list_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier of the block list.
        """
        return pulumi.get(self, "query_suggestions_block_list_id")
