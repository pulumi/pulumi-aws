...
class _ThesaurusState:
    ...
    def thesaurus_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "thesaurus_id")

    @thesaurus_id.setter
    def thesaurus_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Thesaurus(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            thesaurus_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Thesaurus':
        """
    ...
    @property
    @pulumi.getter(name="thesaurusId")
    def thesaurus_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "thesaurus_id")
