...
class DataSourceConfigurationS3ConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_name: The name of the bucket that contains the documents.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclusion_patterns: A list of glob patterns for documents that should not be indexed. If a document that matches an inclusion prefix or inclusion pattern also matches an exclusion pattern, the document is not indexed. Refer to [Exclusion Patterns for more examples](https://docs.aws.amazon.com/kendra/latest/dg/API_S3DataSourceConfiguration.html#Kendra-Type-S3DataSourceConfiguration-ExclusionPatterns).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inclusion_patterns: A list of glob patterns for documents that should be indexed. If a document that matches an inclusion pattern also matches an exclusion pattern, the document is not indexed. Refer to [Inclusion Patterns for more examples](https://docs.aws.amazon.com/kendra/latest/dg/API_S3DataSourceConfiguration.html#Kendra-Type-S3DataSourceConfiguration-InclusionPatterns).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inclusion_prefixes: A list of S3 prefixes for the documents that should be included in the index.
        """
...
class DataSourceConfigurationS3ConfigurationAccessControlListConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key_path: Path to the AWS S3 bucket that contains the ACL files.
        """
...
class DataSourceConfigurationS3ConfigurationDocumentsMetadataConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] s3_prefix: A prefix used to filter metadata configuration files in the AWS S3 bucket. The S3 bucket might contain multiple metadata files. Use `s3_prefix` to include only the desired metadata files.
        """
...
class DataSourceConfigurationTemplateConfigurationArgs:
    def __init__(__self__, *,
                 template: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] template: JSON string containing a [data source template schema](https://docs.aws.amazon.com/kendra/latest/dg/ds-schemas.html).
        """
...
if not MYPY:
    class DataSourceConfigurationWebCrawlerConfigurationArgsDict(TypedDict):
        ...
        """
        max_links_per_page: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        max_urls_per_minute_crawl_rate: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        url_exclusion_patterns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of regular expression patterns to exclude certain URLs to crawl. URLs that match the patterns are excluded from the index. URLs that don't match the patterns are included in the index. If a URL matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL file isn't included in the index. Array Members: Minimum number of `0` items. Maximum number of `100` items. Length Constraints: Minimum length of `1`. Maximum length of `150`.
        """
        url_inclusion_patterns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DataSourceConfigurationWebCrawlerConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 crawl_depth: Optional[pulumi.Input[builtins.int]] = None,
                 max_content_size_per_page_in_mega_bytes: Optional[pulumi.Input[builtins.float]] = None,
                 max_links_per_page: Optional[pulumi.Input[builtins.int]] = None,
                 max_urls_per_minute_crawl_rate: Optional[pulumi.Input[builtins.int]] = None,
                 proxy_configuration: Optional[pulumi.Input['DataSourceConfigurationWebCrawlerConfigurationProxyConfigurationArgs']] = None,
                 url_exclusion_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 url_inclusion_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] url_exclusion_patterns: A list of regular expression patterns to exclude certain URLs to crawl. URLs that match the patterns are excluded from the index. URLs that don't match the patterns are included in the index. If a URL matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL file isn't included in the index. Array Members: Minimum number of `0` items. Maximum number of `100` items. Length Constraints: Minimum length of `1`. Maximum length of `150`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] url_inclusion_patterns: A list of regular expression patterns to include certain URLs to crawl. URLs that match the patterns are included in the index. URLs that don't match the patterns are excluded from the index. If a URL matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL file isn't included in the index. Array Members: Minimum number of `0` items. Maximum number of `100` items. Length Constraints: Minimum length of `1`. Maximum length of `150`.
        """
    ...
    @crawl_depth.setter
    def crawl_depth(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "crawl_depth", value)

    @property
    @pulumi.getter(name="maxContentSizePerPageInMegaBytes")
    def max_content_size_per_page_in_mega_bytes(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The maximum size (in MB) of a webpage or attachment to crawl. Files larger than this size (in MB) are skipped/not crawled. The default maximum size of a webpage or attachment is set to `50` MB. Minimum value of `1.0e-06`. Maximum value of `50`.
        """
    ...
    def max_content_size_per_page_in_mega_bytes(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "max_content_size_per_page_in_mega_bytes", value)

    @property
    @pulumi.getter(name="maxLinksPerPage")
    def max_links_per_page(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of URLs on a webpage to include when crawling a website. This number is per webpage. As a website’s webpages are crawled, any URLs the webpages link to are also crawled. URLs on a webpage are crawled in order of appearance. The default maximum links per page is `100`. Minimum value of `1`. Maximum value of `1000`.
        """
    ...
    def max_links_per_page(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_links_per_page", value)

    @property
    @pulumi.getter(name="maxUrlsPerMinuteCrawlRate")
    def max_urls_per_minute_crawl_rate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of URLs crawled per website host per minute. The default maximum number of URLs crawled per website host per minute is `300`. Minimum value of `1`. Maximum value of `300`.
        """
    ...
    def max_urls_per_minute_crawl_rate(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def url_exclusion_patterns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of regular expression patterns to exclude certain URLs to crawl. URLs that match the patterns are excluded from the index. URLs that don't match the patterns are included in the index. If a URL matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL file isn't included in the index. Array Members: Minimum number of `0` items. Maximum number of `100` items. Length Constraints: Minimum length of `1`. Maximum length of `150`.
        """
    ...
    def url_exclusion_patterns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "url_exclusion_patterns", value)

    @property
    @pulumi.getter(name="urlInclusionPatterns")
    def url_inclusion_patterns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of regular expression patterns to include certain URLs to crawl. URLs that match the patterns are included in the index. URLs that don't match the patterns are excluded from the index. If a URL matches both an inclusion and exclusion pattern, the exclusion pattern takes precedence and the URL file isn't included in the index. Array Members: Minimum number of `0` items. Maximum number of `100` items. Length Constraints: Minimum length of `1`. Maximum length of `150`.
        """
    ...
    def url_inclusion_patterns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfigurationBasicAuthenticationArgs:
    def __init__(__self__, *,
                 ...
                 port: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] credentials: Your secret ARN, which you can create in AWS Secrets Manager. You use a secret if basic authentication credentials are required to connect to a website. The secret stores your credentials of user name and password.
        :param pulumi.Input[builtins.str] host: The name of the website host you want to connect to using authentication credentials. For example, the host name of `https://a.example.com/page1.html` is `"a.example.com"`.
        :param pulumi.Input[builtins.int] port: The port number of the website host you want to connect to using authentication credentials. For example, the port for `https://a.example.com/page1.html` is `443`, the standard port for HTTPS.
        """
...
class DataSourceConfigurationWebCrawlerConfigurationProxyConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host: The name of the website host you want to connect to via a web proxy server. For example, the host name of `https://a.example.com/page1.html` is `"a.example.com"`.
        :param pulumi.Input[builtins.int] port: The port number of the website host you want to connect to via a web proxy server. For example, the port for `https://a.example.com/page1.html` is `443`, the standard port for HTTPS.
...
if not MYPY:
    class DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfigurationArgsDict(TypedDict):
        seed_urls: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfigurationArgs:
    def __init__(__self__, *,
                 seed_urls: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 web_crawler_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def seed_urls(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The list of seed or starting point URLs of the websites you want to crawl. The list can include a maximum of `100` seed URLs. Array Members: Minimum number of `0` items. Maximum number of `100` items. Length Constraints: Minimum length of `1`. Maximum length of `2048`.
        """
    ...
    @seed_urls.setter
    def seed_urls(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def web_crawler_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DataSourceConfigurationWebCrawlerConfigurationUrlsSiteMapsConfigurationArgsDict(TypedDict):
        site_maps: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class DataSourceConfigurationWebCrawlerConfigurationUrlsSiteMapsConfigurationArgs:
    def __init__(__self__, *,
                 site_maps: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] site_maps: The list of sitemap URLs of the websites you want to crawl. The list can include a maximum of `3` sitemap URLs.
        """
        pulumi.set(__self__, "site_maps", site_maps)

    @property
    @pulumi.getter(name="siteMaps")
    def site_maps(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The list of sitemap URLs of the websites you want to crawl. The list can include a maximum of `3` sitemap URLs.
        """
    ...
    @site_maps.setter
    def site_maps(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class DataSourceCustomDocumentEnrichmentConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] role_arn: The Amazon Resource Name (ARN) of a role with permission to run `pre_extraction_hook_configuration` and `post_extraction_hook_configuration` for altering document metadata and content during the document ingestion process. For more information, see [IAM roles for Amazon Kendra](https://docs.aws.amazon.com/kendra/latest/dg/iam-roles.html).
        """
...
if not MYPY:
    class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationArgsDict(TypedDict):
        ...
        """
        document_content_deletion: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 document_content_deletion: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] document_content_deletion: `TRUE` to delete content if the condition used for the target attribute is met.
    ...
    def document_content_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        `TRUE` to delete content if the condition used for the target attribute is met.
        """
    ...
    def document_content_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionArgsDict(TypedDict):
        condition_document_attribute_key: pulumi.Input[builtins.str]
        """
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] condition_document_attribute_key: The identifier of the document attribute used for the condition. For example, `_source_uri` could be an identifier for the attribute or metadata field that contains source URIs associated with the documents. Amazon Kendra currently does not support `_document_body` as an attribute key used for the condition.
        :param pulumi.Input[builtins.str] operator: The condition operator. For example, you can use `Contains` to partially match a string. Valid Values: `GreaterThan` | `GreaterThanOrEquals` | `LessThan` | `LessThanOrEquals` | `Equals` | `NotEquals` | `Contains` | `NotContains` | `Exists` | `NotExists` | `BeginsWith`.
    ...
    def condition_document_attribute_key(self) -> pulumi.Input[builtins.str]:
        """
        The identifier of the document attribute used for the condition. For example, `_source_uri` could be an identifier for the attribute or metadata field that contains source URIs associated with the documents. Amazon Kendra currently does not support `_document_body` as an attribute key used for the condition.
        """
    ...
    def condition_document_attribute_key(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValueArgsDict(TypedDict):
        date_value: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        long_value: NotRequired[pulumi.Input[builtins.int]]
        """
        A long integer value.
        """
        string_list_values: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        A list of strings.
        """
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValueArgs:
    def __init__(__self__, *,
                 date_value: Optional[pulumi.Input[builtins.str]] = None,
                 long_value: Optional[pulumi.Input[builtins.int]] = None,
                 string_list_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 string_value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] date_value: A date expressed as an ISO 8601 string. It is important for the time zone to be included in the ISO 8601 date-time format. As of this writing only UTC is supported. For example, `2012-03-25T12:30:10+00:00`.
        :param pulumi.Input[builtins.int] long_value: A long integer value.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] string_list_values: A list of strings.
        """
    ...
    def date_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A date expressed as an ISO 8601 string. It is important for the time zone to be included in the ISO 8601 date-time format. As of this writing only UTC is supported. For example, `2012-03-25T12:30:10+00:00`.
        """
    ...
    @date_value.setter
    def date_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "date_value", value)

    @property
    @pulumi.getter(name="longValue")
    def long_value(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        A long integer value.
        """
    ...
    @long_value.setter
    def long_value(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "long_value", value)

    @property
    @pulumi.getter(name="stringListValues")
    def string_list_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        A list of strings.
        """
    ...
    def string_list_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetArgsDict(TypedDict):
        target_document_attribute_key: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        target_document_attribute_value_deletion: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTargetArgs:
    def __init__(__self__, *,
                 target_document_attribute_key: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 target_document_attribute_value_deletion: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] target_document_attribute_key: The identifier of the target document attribute or metadata field. For example, 'Department' could be an identifier for the target attribute or metadata field that includes the department names associated with the documents.
        ...
        :param pulumi.Input[builtins.bool] target_document_attribute_value_deletion: `TRUE` to delete the existing target value for your specified target attribute key. You cannot create a target value and set this to `TRUE`. To create a target value (`TargetDocumentAttributeValue`), set this to `FALSE`.
        """
    ...
    def target_document_attribute_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The identifier of the target document attribute or metadata field. For example, 'Department' could be an identifier for the target attribute or metadata field that includes the department names associated with the documents.
        """
    ...
    def target_document_attribute_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_document_attribute_value_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        `TRUE` to delete the existing target value for your specified target attribute key. You cannot create a target value and set this to `TRUE`. To create a target value (`TargetDocumentAttributeValue`), set this to `FALSE`.
        """
    ...
    def target_document_attribute_value_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] lambda_arn: The Amazon Resource Name (ARN) of a Lambda Function that can manipulate your document metadata fields or attributes and content.
        :param pulumi.Input[builtins.str] s3_bucket: Stores the original, raw documents or the structured, parsed documents before and after altering them. For more information, see [Data contracts for Lambda functions](https://docs.aws.amazon.com/kendra/latest/dg/custom-document-enrichment.html#cde-data-contracts-lambda).
...
if not MYPY:
    class ExperienceConfigurationContentSourceConfigurationArgsDict(TypedDict):
        data_source_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The identifiers of the data sources you want to use for your Amazon Kendra experience. Maximum number of 100 items.
        """
        direct_put_content: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to use documents you indexed directly using the `BatchPutDocument API`. Defaults to `false`.
        """
        faq_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ExperienceConfigurationContentSourceConfigurationArgs:
    def __init__(__self__, *,
                 data_source_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 direct_put_content: Optional[pulumi.Input[builtins.bool]] = None,
                 faq_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] data_source_ids: The identifiers of the data sources you want to use for your Amazon Kendra experience. Maximum number of 100 items.
        :param pulumi.Input[builtins.bool] direct_put_content: Whether to use documents you indexed directly using the `BatchPutDocument API`. Defaults to `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] faq_ids: The identifier of the FAQs that you want to use for your Amazon Kendra experience. Maximum number of 100 items.
        """
    ...
    def data_source_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The identifiers of the data sources you want to use for your Amazon Kendra experience. Maximum number of 100 items.
        """
    ...
    def data_source_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "data_source_ids", value)

    @property
    @pulumi.getter(name="directPutContent")
    def direct_put_content(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to use documents you indexed directly using the `BatchPutDocument API`. Defaults to `false`.
        """
    ...
    def direct_put_content(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "direct_put_content", value)

    @property
    @pulumi.getter(name="faqIds")
    def faq_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The identifier of the FAQs that you want to use for your Amazon Kendra experience. Maximum number of 100 items.
        """
    ...
    @faq_ids.setter
    def faq_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "faq_ids", value)


if not MYPY:
    class ExperienceConfigurationUserIdentityConfigurationArgsDict(TypedDict):
        identity_attribute_name: pulumi.Input[builtins.str]
        """
...
class ExperienceConfigurationUserIdentityConfigurationArgs:
    def __init__(__self__, *,
                 identity_attribute_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] identity_attribute_name: The AWS SSO field name that contains the identifiers of your users, such as their emails.
        """
        pulumi.set(__self__, "identity_attribute_name", identity_attribute_name)

    @property
    @pulumi.getter(name="identityAttributeName")
    def identity_attribute_name(self) -> pulumi.Input[builtins.str]:
        """
        The AWS SSO field name that contains the identifiers of your users, such as their emails.
        """
    ...
    def identity_attribute_name(self, value: pulumi.Input[builtins.str]):
...
class ExperienceEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] endpoint: The endpoint of your Amazon Kendra experience.
        :param pulumi.Input[builtins.str] endpoint_type: The type of endpoint for your Amazon Kendra experience.
        """
...
class FaqS3PathArgs:
    def __init__(__self__, *,
                 ...
                 key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] bucket: The name of the S3 bucket that contains the file.
        :param pulumi.Input[builtins.str] key: The name of the file.
...
if not MYPY:
    class IndexCapacityUnitsArgsDict(TypedDict):
        query_capacity_units: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        storage_capacity_units: NotRequired[pulumi.Input[builtins.int]]
        """
...
class IndexCapacityUnitsArgs:
    def __init__(__self__, *,
                 query_capacity_units: Optional[pulumi.Input[builtins.int]] = None,
                 storage_capacity_units: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] query_capacity_units: The amount of extra query capacity for an index and GetQuerySuggestions capacity. For more information, refer to [QueryCapacityUnits](https://docs.aws.amazon.com/kendra/latest/dg/API_CapacityUnitsConfiguration.html#Kendra-Type-CapacityUnitsConfiguration-QueryCapacityUnits).
        :param pulumi.Input[builtins.int] storage_capacity_units: The amount of extra storage capacity for an index. A single capacity unit provides 30 GB of storage space or 100,000 documents, whichever is reached first. Minimum value of 0.
        """
    ...
    def query_capacity_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The amount of extra query capacity for an index and GetQuerySuggestions capacity. For more information, refer to [QueryCapacityUnits](https://docs.aws.amazon.com/kendra/latest/dg/API_CapacityUnitsConfiguration.html#Kendra-Type-CapacityUnitsConfiguration-QueryCapacityUnits).
        """
    ...
    def query_capacity_units(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "query_capacity_units", value)

    @property
    @pulumi.getter(name="storageCapacityUnits")
    def storage_capacity_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The amount of extra storage capacity for an index. A single capacity unit provides 30 GB of storage space or 100,000 documents, whichever is reached first. Minimum value of 0.
        """
    ...
    def storage_capacity_units(self, value: Optional[pulumi.Input[builtins.int]]):
...
class IndexDocumentMetadataConfigurationUpdateArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the index field. Minimum length of 1. Maximum length of 30.
        :param pulumi.Input[builtins.str] type: The data type of the index field. Valid values are `STRING_VALUE`, `STRING_LIST_VALUE`, `LONG_VALUE`, `DATE_VALUE`.
...
if not MYPY:
    class IndexDocumentMetadataConfigurationUpdateRelevanceArgsDict(TypedDict):
        ...
        """
        freshness: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        importance: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        rank_order: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        values_importance_map: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]]
        """
...
class IndexDocumentMetadataConfigurationUpdateRelevanceArgs:
    def __init__(__self__, *,
                 ...
                 freshness: Optional[pulumi.Input[builtins.bool]] = None,
                 importance: Optional[pulumi.Input[builtins.int]] = None,
                 rank_order: Optional[pulumi.Input[builtins.str]] = None,
                 values_importance_map: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]] = None):
        """
        :param pulumi.Input[builtins.str] duration: Specifies the time period that the boost applies to. For more information, refer to [Duration](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-Duration).
        :param pulumi.Input[builtins.bool] freshness: Indicates that this field determines how "fresh" a document is. For more information, refer to [Freshness](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-Freshness).
        :param pulumi.Input[builtins.int] importance: The relative importance of the field in the search. Larger numbers provide more of a boost than smaller numbers. Minimum value of 1. Maximum value of 10.
        :param pulumi.Input[builtins.str] rank_order: Determines how values should be interpreted. For more information, refer to [RankOrder](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-RankOrder).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]] values_importance_map: A list of values that should be given a different boost when they appear in the result list. For more information, refer to [ValueImportanceMap](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-ValueImportanceMap).
        """
    ...
    @property
    @pulumi.getter
    def freshness(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates that this field determines how "fresh" a document is. For more information, refer to [Freshness](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-Freshness).
        """
    ...
    @freshness.setter
    def freshness(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "freshness", value)

    @property
    @pulumi.getter
    def importance(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The relative importance of the field in the search. Larger numbers provide more of a boost than smaller numbers. Minimum value of 1. Maximum value of 10.
        """
    ...
    @importance.setter
    def importance(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "importance", value)

    @property
    @pulumi.getter(name="rankOrder")
    def rank_order(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines how values should be interpreted. For more information, refer to [RankOrder](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-RankOrder).
        """
    ...
    @rank_order.setter
    def rank_order(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rank_order", value)

    @property
    @pulumi.getter(name="valuesImportanceMap")
    def values_importance_map(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]]:
        """
        A list of values that should be given a different boost when they appear in the result list. For more information, refer to [ValueImportanceMap](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-ValueImportanceMap).
        """
    ...
    def values_importance_map(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.int]]]]):
        pulumi.set(self, "values_importance_map", value)


if not MYPY:
    class IndexDocumentMetadataConfigurationUpdateSearchArgsDict(TypedDict):
        displayable: NotRequired[pulumi.Input[builtins.bool]]
        """
        Determines whether the field is returned in the query response. The default is `true`.
        """
        facetable: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates that the field can be used to create search facets, a count of results for each value in the field. The default is `false`.
        """
        searchable: NotRequired[pulumi.Input[builtins.bool]]
        """
        Determines whether the field is used in the search. If the Searchable field is true, you can use relevance tuning to manually tune how Amazon Kendra weights the field in the search. The default is `true` for `string` fields and `false` for `number` and `date` fields.
        """
        sortable: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class IndexDocumentMetadataConfigurationUpdateSearchArgs:
    def __init__(__self__, *,
                 displayable: Optional[pulumi.Input[builtins.bool]] = None,
                 facetable: Optional[pulumi.Input[builtins.bool]] = None,
                 searchable: Optional[pulumi.Input[builtins.bool]] = None,
                 sortable: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] displayable: Determines whether the field is returned in the query response. The default is `true`.
        :param pulumi.Input[builtins.bool] facetable: Indicates that the field can be used to create search facets, a count of results for each value in the field. The default is `false`.
        :param pulumi.Input[builtins.bool] searchable: Determines whether the field is used in the search. If the Searchable field is true, you can use relevance tuning to manually tune how Amazon Kendra weights the field in the search. The default is `true` for `string` fields and `false` for `number` and `date` fields.
        :param pulumi.Input[builtins.bool] sortable: Determines whether the field can be used to sort the results of a query. If you specify sorting on a field that does not have Sortable set to true, Amazon Kendra returns an exception. The default is `false`.
        """
    ...
    @property
    @pulumi.getter
    def displayable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Determines whether the field is returned in the query response. The default is `true`.
        """
    ...
    @displayable.setter
    def displayable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "displayable", value)

    @property
    @pulumi.getter
    def facetable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates that the field can be used to create search facets, a count of results for each value in the field. The default is `false`.
        """
    ...
    @facetable.setter
    def facetable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "facetable", value)

    @property
    @pulumi.getter
    def searchable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Determines whether the field is used in the search. If the Searchable field is true, you can use relevance tuning to manually tune how Amazon Kendra weights the field in the search. The default is `true` for `string` fields and `false` for `number` and `date` fields.
        """
    ...
    @searchable.setter
    def searchable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "searchable", value)

    @property
    @pulumi.getter
    def sortable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Determines whether the field can be used to sort the results of a query. If you specify sorting on a field that does not have Sortable set to true, Amazon Kendra returns an exception. The default is `false`.
        """
    ...
    @sortable.setter
    def sortable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class IndexIndexStatisticFaqStatisticArgsDict(TypedDict):
        indexed_question_answers_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class IndexIndexStatisticFaqStatisticArgs:
    def __init__(__self__, *,
                 indexed_question_answers_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] indexed_question_answers_count: The total number of FAQ questions and answers contained in the index.
        """
    ...
    def indexed_question_answers_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The total number of FAQ questions and answers contained in the index.
        """
    ...
    def indexed_question_answers_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "indexed_question_answers_count", value)


if not MYPY:
    class IndexIndexStatisticTextDocumentStatisticArgsDict(TypedDict):
        indexed_text_bytes: NotRequired[pulumi.Input[builtins.int]]
        """
        The total size, in bytes, of the indexed documents.
        """
        indexed_text_documents_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class IndexIndexStatisticTextDocumentStatisticArgs:
    def __init__(__self__, *,
                 indexed_text_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 indexed_text_documents_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] indexed_text_bytes: The total size, in bytes, of the indexed documents.
        :param pulumi.Input[builtins.int] indexed_text_documents_count: The number of text documents indexed.
        """
    ...
    def indexed_text_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The total size, in bytes, of the indexed documents.
        """
    ...
    def indexed_text_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "indexed_text_bytes", value)

    @property
    @pulumi.getter(name="indexedTextDocumentsCount")
    def indexed_text_documents_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of text documents indexed.
        """
    ...
    def indexed_text_documents_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class IndexServerSideEncryptionConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kms_key_id: The identifier of the AWS KMScustomer master key (CMK). Amazon Kendra doesn't support asymmetric CMKs.
        """
...
if not MYPY:
    class IndexUserGroupResolutionConfigurationArgsDict(TypedDict):
        user_group_resolution_mode: pulumi.Input[builtins.str]
        """
...
class IndexUserGroupResolutionConfigurationArgs:
    ...
    def user_group_resolution_mode(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class IndexUserTokenConfigurationsJsonTokenTypeConfigurationArgsDict(TypedDict):
        group_attribute_field: pulumi.Input[builtins.str]
        """
        The group attribute field. Minimum length of 1. Maximum length of 2048.
        """
        user_name_attribute_field: pulumi.Input[builtins.str]
        """
...
class IndexUserTokenConfigurationsJsonTokenTypeConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 user_name_attribute_field: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] group_attribute_field: The group attribute field. Minimum length of 1. Maximum length of 2048.
        :param pulumi.Input[builtins.str] user_name_attribute_field: The user name attribute field. Minimum length of 1. Maximum length of 2048.
        """
    ...
    def group_attribute_field(self) -> pulumi.Input[builtins.str]:
        """
        The group attribute field. Minimum length of 1. Maximum length of 2048.
        """
    ...
    def group_attribute_field(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "group_attribute_field", value)

    @property
    @pulumi.getter(name="userNameAttributeField")
    def user_name_attribute_field(self) -> pulumi.Input[builtins.str]:
        """
        The user name attribute field. Minimum length of 1. Maximum length of 2048.
        """
    ...
    def user_name_attribute_field(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class IndexUserTokenConfigurationsJwtTokenTypeConfigurationArgsDict(TypedDict):
        ...
        """
        user_name_attribute_field: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IndexUserTokenConfigurationsJwtTokenTypeConfigurationArgs:
    def __init__(__self__, *,
                 key_location: pulumi.Input[builtins.str],
                 claim_regex: Optional[pulumi.Input[builtins.str]] = None,
                 group_attribute_field: Optional[pulumi.Input[builtins.str]] = None,
                 issuer: Optional[pulumi.Input[builtins.str]] = None,
                 secrets_manager_arn: Optional[pulumi.Input[builtins.str]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None,
                 user_name_attribute_field: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] key_location: The location of the key. Valid values are `URL` or `SECRET_MANAGER`
        :param pulumi.Input[builtins.str] claim_regex: The regular expression that identifies the claim. Minimum length of 1. Maximum length of 100.
        :param pulumi.Input[builtins.str] group_attribute_field: The group attribute field. Minimum length of 1. Maximum length of 100.
        :param pulumi.Input[builtins.str] issuer: The issuer of the token. Minimum length of 1. Maximum length of 65.
        :param pulumi.Input[builtins.str] secrets_manager_arn: The Amazon Resource Name (ARN) of the secret.
        :param pulumi.Input[builtins.str] url: The signing key URL. Valid pattern is `^(https?|ftp|file):\\/\\/([^\\s]*)`
        :param pulumi.Input[builtins.str] user_name_attribute_field: The user name attribute field. Minimum length of 1. Maximum length of 100.
        """
    ...
    def key_location(self) -> pulumi.Input[builtins.str]:
        """
        The location of the key. Valid values are `URL` or `SECRET_MANAGER`
        """
    ...
    @key_location.setter
    def key_location(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "key_location", value)

    @property
    @pulumi.getter(name="claimRegex")
    def claim_regex(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The regular expression that identifies the claim. Minimum length of 1. Maximum length of 100.
        """
    ...
    @claim_regex.setter
    def claim_regex(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "claim_regex", value)

    @property
    @pulumi.getter(name="groupAttributeField")
    def group_attribute_field(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The group attribute field. Minimum length of 1. Maximum length of 100.
        """
        return pulumi.get(self, "group_attribute_field")
    ...
    @group_attribute_field.setter
    def group_attribute_field(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "group_attribute_field", value)
    ...
    @property
    @pulumi.getter(name="userNameAttributeField")
    def user_name_attribute_field(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The user name attribute field. Minimum length of 1. Maximum length of 100.
        """
        return pulumi.get(self, "user_name_attribute_field")
    ...
    @user_name_attribute_field.setter
    def user_name_attribute_field(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_name_attribute_field", value)
...
class QuerySuggestionsBlockListSourceS3PathArgs:
    def __init__(__self__, *,
                 ...
                 key: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] bucket: Name of the S3 bucket that contains the file.
        :param pulumi.Input[builtins.str] key: Name of the file.
