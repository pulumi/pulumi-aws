...
class DataSourceConfigurationS3ConfigurationAccessControlListConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_path: Path to the AWS S3 bucket that contains the ACL files.
        """
...
class DataSourceConfigurationS3ConfigurationDocumentsMetadataConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str s3_prefix: A prefix used to filter metadata configuration files in the AWS S3 bucket. The S3 bucket might contain multiple metadata files. Use `s3_prefix` to include only the desired metadata files.
        """
...
class DataSourceConfigurationTemplateConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str template: JSON string containing a [data source template schema](https://docs.aws.amazon.com/kendra/latest/dg/ds-schemas.html).
        """
...
class DataSourceConfigurationWebCrawlerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int crawl_depth: Specifies the number of levels in a website that you want to crawl. The first level begins from the website seed or starting point URL. For example, if a website has 3 levels – index level (i.e. seed in this example), sections level, and subsections level – and you are only interested in crawling information up to the sections level (i.e. levels 0-1), you can set your depth to 1. The default crawl depth is set to `2`. Minimum value of `0`. Maximum value of `10`.
        :param builtins.float max_content_size_per_page_in_mega_bytes: The maximum size (in MB) of a webpage or attachment to crawl. Files larger than this size (in MB) are skipped/not crawled. The default maximum size of a webpage or attachment is set to `50` MB. Minimum value of `1.0e-06`. Maximum value of `50`.
        :param builtins.int max_links_per_page: The maximum number of URLs on a webpage to include when crawling a website. This number is per webpage. As a website’s webpages are crawled, any URLs the webpages link to are also crawled. URLs on a webpage are crawled in order of appearance. The default maximum links per page is `100`. Minimum value of `1`. Maximum value of `1000`.
        :param builtins.int max_urls_per_minute_crawl_rate: The maximum number of URLs crawled per website host per minute. The default maximum number of URLs crawled per website host per minute is `300`. Minimum value of `1`. Maximum value of `300`.
...
class DataSourceConfigurationWebCrawlerConfigurationAuthenticationConfigurationBasicAuthentication(dict):
    def __init__(__self__, *,
                 ...
                 port: builtins.int):
        """
        :param builtins.str credentials: Your secret ARN, which you can create in AWS Secrets Manager. You use a secret if basic authentication credentials are required to connect to a website. The secret stores your credentials of user name and password.
        :param builtins.str host: The name of the website host you want to connect to using authentication credentials. For example, the host name of `https://a.example.com/page1.html` is `"a.example.com"`.
        :param builtins.int port: The port number of the website host you want to connect to using authentication credentials. For example, the port for `https://a.example.com/page1.html` is `443`, the standard port for HTTPS.
        """
...
class DataSourceConfigurationWebCrawlerConfigurationProxyConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host: The name of the website host you want to connect to via a web proxy server. For example, the host name of `https://a.example.com/page1.html` is `"a.example.com"`.
        :param builtins.int port: The port number of the website host you want to connect to via a web proxy server. For example, the port for `https://a.example.com/page1.html` is `443`, the standard port for HTTPS.
...
class DataSourceConfigurationWebCrawlerConfigurationUrlsSeedUrlConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 web_crawler_mode: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] seed_urls: The list of seed or starting point URLs of the websites you want to crawl. The list can include a maximum of `100` seed URLs. Array Members: Minimum number of `0` items. Maximum number of `100` items. Length Constraints: Minimum length of `1`. Maximum length of `2048`.
        :param builtins.str web_crawler_mode: The default mode is set to `HOST_ONLY`. You can choose one of the following modes:
    ...
    def web_crawler_mode(self) -> Optional[builtins.str]:
        """
...
class DataSourceConfigurationWebCrawlerConfigurationUrlsSiteMapsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] site_maps: The list of sitemap URLs of the websites you want to crawl. The list can include a maximum of `3` sitemap URLs.
        """
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool document_content_deletion: `TRUE` to delete content if the condition used for the target attribute is met.
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str condition_document_attribute_key: The identifier of the document attribute used for the condition. For example, `_source_uri` could be an identifier for the attribute or metadata field that contains source URIs associated with the documents. Amazon Kendra currently does not support `_document_body` as an attribute key used for the condition.
        :param builtins.str operator: The condition operator. For example, you can use `Contains` to partially match a string. Valid Values: `GreaterThan` | `GreaterThanOrEquals` | `LessThan` | `LessThanOrEquals` | `Equals` | `NotEquals` | `Contains` | `NotContains` | `Exists` | `NotExists` | `BeginsWith`.
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationConditionConditionOnValue(dict):
    ...
    def __init__(__self__, *,
                 ...
                 string_list_values: Optional[Sequence[builtins.str]] = None,
                 string_value: Optional[builtins.str] = None):
        """
        :param builtins.str date_value: A date expressed as an ISO 8601 string. It is important for the time zone to be included in the ISO 8601 date-time format. As of this writing only UTC is supported. For example, `2012-03-25T12:30:10+00:00`.
        :param builtins.int long_value: A long integer value.
        :param Sequence[builtins.str] string_list_values: A list of strings.
        """
    ...
    def string_list_values(self) -> Optional[Sequence[builtins.str]]:
        """
        A list of strings.
        """
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfigurationTarget(dict):
    ...
    def __init__(__self__, *,
                 target_document_attribute_key: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str target_document_attribute_key: The identifier of the target document attribute or metadata field. For example, 'Department' could be an identifier for the target attribute or metadata field that includes the department names associated with the documents.
        ...
        :param builtins.bool target_document_attribute_value_deletion: `TRUE` to delete the existing target value for your specified target attribute key. You cannot create a target value and set this to `TRUE`. To create a target value (`TargetDocumentAttributeValue`), set this to `FALSE`.
        """
    ...
    def target_document_attribute_key(self) -> Optional[builtins.str]:
        """
...
class DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str lambda_arn: The Amazon Resource Name (ARN) of a Lambda Function that can manipulate your document metadata fields or attributes and content.
...
class ExperienceConfigurationContentSourceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 data_source_ids: Optional[Sequence[builtins.str]] = None,
                 direct_put_content: Optional[builtins.bool] = None,
                 faq_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] data_source_ids: The identifiers of the data sources you want to use for your Amazon Kendra experience. Maximum number of 100 items.
        :param builtins.bool direct_put_content: Whether to use documents you indexed directly using the `BatchPutDocument API`. Defaults to `false`.
        :param Sequence[builtins.str] faq_ids: The identifier of the FAQs that you want to use for your Amazon Kendra experience. Maximum number of 100 items.
        """
    ...
    def data_source_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def direct_put_content(self) -> Optional[builtins.bool]:
        """
    ...
    def faq_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ExperienceConfigurationUserIdentityConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str identity_attribute_name: The AWS SSO field name that contains the identifiers of your users, such as their emails.
        """
...
class ExperienceEndpoint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str endpoint: The endpoint of your Amazon Kendra experience.
        :param builtins.str endpoint_type: The type of endpoint for your Amazon Kendra experience.
        """
...
class IndexCapacityUnits(dict):
    ...
    def __init__(__self__, *,
                 query_capacity_units: Optional[builtins.int] = None,
                 storage_capacity_units: Optional[builtins.int] = None):
        """
        :param builtins.int query_capacity_units: The amount of extra query capacity for an index and GetQuerySuggestions capacity. For more information, refer to [QueryCapacityUnits](https://docs.aws.amazon.com/kendra/latest/dg/API_CapacityUnitsConfiguration.html#Kendra-Type-CapacityUnitsConfiguration-QueryCapacityUnits).
        :param builtins.int storage_capacity_units: The amount of extra storage capacity for an index. A single capacity unit provides 30 GB of storage space or 100,000 documents, whichever is reached first. Minimum value of 0.
        """
    ...
    def query_capacity_units(self) -> Optional[builtins.int]:
        """
    ...
    def storage_capacity_units(self) -> Optional[builtins.int]:
        """
...
class IndexDocumentMetadataConfigurationUpdate(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the index field. Minimum length of 1. Maximum length of 30.
        :param builtins.str type: The data type of the index field. Valid values are `STRING_VALUE`, `STRING_LIST_VALUE`, `LONG_VALUE`, `DATE_VALUE`.
...
class IndexDocumentMetadataConfigurationUpdateRelevance(dict):
    ...
    def __init__(__self__, *,
                 ...
                 rank_order: Optional[builtins.str] = None,
                 values_importance_map: Optional[Mapping[str, builtins.int]] = None):
        """
        :param builtins.str duration: Specifies the time period that the boost applies to. For more information, refer to [Duration](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-Duration).
        :param builtins.bool freshness: Indicates that this field determines how "fresh" a document is. For more information, refer to [Freshness](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-Freshness).
        :param builtins.int importance: The relative importance of the field in the search. Larger numbers provide more of a boost than smaller numbers. Minimum value of 1. Maximum value of 10.
        :param builtins.str rank_order: Determines how values should be interpreted. For more information, refer to [RankOrder](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-RankOrder).
        :param Mapping[str, builtins.int] values_importance_map: A list of values that should be given a different boost when they appear in the result list. For more information, refer to [ValueImportanceMap](https://docs.aws.amazon.com/kendra/latest/dg/API_Relevance.html#Kendra-Type-Relevance-ValueImportanceMap).
        """
    ...
    def rank_order(self) -> Optional[builtins.str]:
        """
    ...
    def values_importance_map(self) -> Optional[Mapping[str, builtins.int]]:
        """
...
class IndexDocumentMetadataConfigurationUpdateSearch(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool displayable: Determines whether the field is returned in the query response. The default is `true`.
        :param builtins.bool facetable: Indicates that the field can be used to create search facets, a count of results for each value in the field. The default is `false`.
        :param builtins.bool searchable: Determines whether the field is used in the search. If the Searchable field is true, you can use relevance tuning to manually tune how Amazon Kendra weights the field in the search. The default is `true` for `string` fields and `false` for `number` and `date` fields.
        :param builtins.bool sortable: Determines whether the field can be used to sort the results of a query. If you specify sorting on a field that does not have Sortable set to true, Amazon Kendra returns an exception. The default is `false`.
        """
...
class IndexIndexStatisticFaqStatistic(dict):
    ...
    def __init__(__self__, *,
                 indexed_question_answers_count: Optional[builtins.int] = None):
        """
        :param builtins.int indexed_question_answers_count: The total number of FAQ questions and answers contained in the index.
        """
    ...
    def indexed_question_answers_count(self) -> Optional[builtins.int]:
        """
...
class IndexIndexStatisticTextDocumentStatistic(dict):
    ...
    def __init__(__self__, *,
                 indexed_text_bytes: Optional[builtins.int] = None,
                 indexed_text_documents_count: Optional[builtins.int] = None):
        """
        :param builtins.int indexed_text_bytes: The total size, in bytes, of the indexed documents.
        :param builtins.int indexed_text_documents_count: The number of text documents indexed.
        """
    ...
    def indexed_text_bytes(self) -> Optional[builtins.int]:
        """
    ...
    def indexed_text_documents_count(self) -> Optional[builtins.int]:
        """
...
class IndexServerSideEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key_id: The identifier of the AWS KMScustomer master key (CMK). Amazon Kendra doesn't support asymmetric CMKs.
        """
...
class IndexUserTokenConfigurationsJsonTokenTypeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str group_attribute_field: The group attribute field. Minimum length of 1. Maximum length of 2048.
        :param builtins.str user_name_attribute_field: The user name attribute field. Minimum length of 1. Maximum length of 2048.
        """
...
class IndexUserTokenConfigurationsJwtTokenTypeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_location: The location of the key. Valid values are `URL` or `SECRET_MANAGER`
        :param builtins.str claim_regex: The regular expression that identifies the claim. Minimum length of 1. Maximum length of 100.
        :param builtins.str group_attribute_field: The group attribute field. Minimum length of 1. Maximum length of 100.
        :param builtins.str issuer: The issuer of the token. Minimum length of 1. Maximum length of 65.
        :param builtins.str secrets_manager_arn: The Amazon Resource Name (ARN) of the secret.
        :param builtins.str url: The signing key URL. Valid pattern is `^(https?|ftp|file):\\/\\/([^\\s]*)`
        :param builtins.str user_name_attribute_field: The user name attribute field. Minimum length of 1. Maximum length of 100.
        """
...
class QuerySuggestionsBlockListSourceS3Path(dict):
    def __init__(__self__, *,
                 ...
                 key: builtins.str):
        """
        :param builtins.str bucket: Name of the S3 bucket that contains the file.
        :param builtins.str key: Name of the file.
...
class GetExperienceConfigurationContentSourceConfigurationResult(dict):
    def __init__(__self__, *,
                 data_source_ids: Sequence[builtins.str],
                 direct_put_content: builtins.bool,
                 faq_ids: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] data_source_ids: Identifiers of the data sources you want to use for your Amazon Kendra Experience.
        :param builtins.bool direct_put_content: Whether to use documents you indexed directly using the `BatchPutDocument API`.
        :param Sequence[builtins.str] faq_ids: Identifier of the FAQs that you want to use for your Amazon Kendra Experience.
        """
        pulumi.set(__self__, "data_source_ids", data_source_ids)
        pulumi.set(__self__, "direct_put_content", direct_put_content)
        pulumi.set(__self__, "faq_ids", faq_ids)
    ...
    @property
    @pulumi.getter(name="dataSourceIds")
    def data_source_ids(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="directPutContent")
    def direct_put_content(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="faqIds")
    def faq_ids(self) -> Sequence[builtins.str]:
        """
...
class GetExperienceEndpointResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str endpoint: Endpoint of your Amazon Kendra Experience.
        :param builtins.str endpoint_type: Type of endpoint for your Amazon Kendra Experience.
        """
        pulumi.set(__self__, "endpoint", endpoint)
        pulumi.set(__self__, "endpoint_type", endpoint_type)
...
class GetIndexDocumentMetadataConfigurationUpdateResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str name: Name of the index field. Minimum length of 1. Maximum length of 30.
        ...
        :param builtins.str type: Data type of the index field. Valid values are `STRING_VALUE`, `STRING_LIST_VALUE`, `LONG_VALUE`, `DATE_VALUE`.
        """
        pulumi.set(__self__, "name", name)
...
class GetIndexDocumentMetadataConfigurationUpdateRelevanceResult(dict):
    def __init__(__self__, *,
                 ...
                 freshness: builtins.bool,
                 importance: builtins.int,
                 rank_order: builtins.str,
                 values_importance_map: Mapping[str, builtins.int]):
        """
        :param builtins.str duration: Time period that the boost applies to. For more information, refer to [Duration](https://docs.aws.amazon.com/kendra/latest/APIReference/API_Relevance.html#Kendra-Type-Relevance-Duration).
        :param builtins.bool freshness: How "fresh" a document is. For more information, refer to [Freshness](https://docs.aws.amazon.com/kendra/latest/APIReference/API_Relevance.html#Kendra-Type-Relevance-Freshness).
        :param builtins.int importance: Relative importance of the field in the search. Larger numbers provide more of a boost than smaller numbers. Minimum value of 1. Maximum value of 10.
        :param builtins.str rank_order: Determines how values should be interpreted. For more information, refer to [RankOrder](https://docs.aws.amazon.com/kendra/latest/APIReference/API_Relevance.html#Kendra-Type-Relevance-RankOrder).
        :param Mapping[str, builtins.int] values_importance_map: A list of values that should be given a different boost when they appear in the result list. For more information, refer to [ValueImportanceMap](https://docs.aws.amazon.com/kendra/latest/APIReference/API_Relevance.html#Kendra-Type-Relevance-ValueImportanceMap).
        """
        pulumi.set(__self__, "duration", duration)
        pulumi.set(__self__, "freshness", freshness)
        pulumi.set(__self__, "importance", importance)
    ...
    @property
    @pulumi.getter
    def freshness(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="valuesImportanceMap")
    def values_importance_map(self) -> Mapping[str, builtins.int]:
        """
...
class GetIndexDocumentMetadataConfigurationUpdateSearchResult(dict):
    def __init__(__self__, *,
                 displayable: builtins.bool,
                 facetable: builtins.bool,
                 searchable: builtins.bool,
                 sortable: builtins.bool):
        """
        :param builtins.bool displayable: Determines whether the field is returned in the query response. The default is `true`.
        :param builtins.bool facetable: Whether the field can be used to create search facets, a count of results for each value in the field. The default is `false`.
        :param builtins.bool searchable: Determines whether the field is used in the search. If the Searchable field is true, you can use relevance tuning to manually tune how Amazon Kendra weights the field in the search. The default is `true` for `string` fields and `false` for `number` and `date` fields.
        :param builtins.bool sortable: Determines whether the field can be used to sort the results of a query. If you specify sorting on a field that does not have Sortable set to true, Amazon Kendra returns an exception. The default is `false`.
        """
        pulumi.set(__self__, "displayable", displayable)
    ...
    @property
    @pulumi.getter
    def displayable(self) -> builtins.bool:
        """
        Determines whether the field is returned in the query response. The default is `true`.
        """
        return pulumi.get(self, "displayable")
    ...
    @property
    @pulumi.getter
    def facetable(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter
    def searchable(self) -> builtins.bool:
        """
        Determines whether the field is used in the search. If the Searchable field is true, you can use relevance tuning to manually tune how Amazon Kendra weights the field in the search. The default is `true` for `string` fields and `false` for `number` and `date` fields.
        """
        return pulumi.get(self, "searchable")
    ...
    @property
    @pulumi.getter
    def sortable(self) -> builtins.bool:
        """
        Determines whether the field can be used to sort the results of a query. If you specify sorting on a field that does not have Sortable set to true, Amazon Kendra returns an exception. The default is `false`.
        """
        return pulumi.get(self, "sortable")
...
class GetIndexIndexStatisticFaqStatisticResult(dict):
    def __init__(__self__, *,
                 indexed_question_answers_count: builtins.int):
        """
        :param builtins.int indexed_question_answers_count: The total number of FAQ questions and answers contained in the index.
        """
        pulumi.set(__self__, "indexed_question_answers_count", indexed_question_answers_count)
    ...
    @property
    @pulumi.getter(name="indexedQuestionAnswersCount")
    def indexed_question_answers_count(self) -> builtins.int:
        """
        The total number of FAQ questions and answers contained in the index.
        """
        return pulumi.get(self, "indexed_question_answers_count")
...
class GetIndexIndexStatisticTextDocumentStatisticResult(dict):
    def __init__(__self__, *,
                 indexed_text_bytes: builtins.int,
                 indexed_text_documents_count: builtins.int):
        """
        :param builtins.int indexed_text_bytes: Total size, in bytes, of the indexed documents.
        :param builtins.int indexed_text_documents_count: The number of text documents indexed.
        """
        pulumi.set(__self__, "indexed_text_bytes", indexed_text_bytes)
        pulumi.set(__self__, "indexed_text_documents_count", indexed_text_documents_count)
    ...
    @property
    @pulumi.getter(name="indexedTextBytes")
    def indexed_text_bytes(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="indexedTextDocumentsCount")
    def indexed_text_documents_count(self) -> builtins.int:
        """
        The number of text documents indexed.
        """
        return pulumi.get(self, "indexed_text_documents_count")
...
class GetIndexServerSideEncryptionConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key_id: Identifier of the AWS KMScustomer master key (CMK). Amazon Kendra doesn't support asymmetric CMKs.
        """
        pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class GetIndexUserTokenConfigurationJsonTokenTypeConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 user_name_attribute_field: builtins.str):
        """
        :param builtins.str group_attribute_field: The group attribute field.
        :param builtins.str user_name_attribute_field: The user name attribute field.
        """
        pulumi.set(__self__, "group_attribute_field", group_attribute_field)
        pulumi.set(__self__, "user_name_attribute_field", user_name_attribute_field)
...
class GetIndexUserTokenConfigurationJwtTokenTypeConfigurationResult(dict):
    def __init__(__self__, *,
                 claim_regex: builtins.str,
                 group_attribute_field: builtins.str,
                 issuer: builtins.str,
                 key_location: builtins.str,
                 secrets_manager_arn: builtins.str,
                 url: builtins.str,
                 user_name_attribute_field: builtins.str):
        """
        :param builtins.str claim_regex: Regular expression that identifies the claim.
        :param builtins.str group_attribute_field: The group attribute field.
        :param builtins.str issuer: Issuer of the token.
        :param builtins.str key_location: Location of the key. Valid values are `URL` or `SECRET_MANAGER`
        :param builtins.str secrets_manager_arn: ARN of the secret.
        :param builtins.str url: Signing key URL.
        :param builtins.str user_name_attribute_field: The user name attribute field.
        """
        pulumi.set(__self__, "claim_regex", claim_regex)
        pulumi.set(__self__, "group_attribute_field", group_attribute_field)
