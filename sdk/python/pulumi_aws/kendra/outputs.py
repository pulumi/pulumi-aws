...
class DataSourceConfigurationS3ConfigurationAccessControlListConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str key_path: Path to the AWS S3 bucket that contains the ACL files.
        """
...
class DataSourceConfigurationTemplateConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str template: JSON string containing a [data source template schema](https://docs.aws.amazon.com/kendra/latest/dg/ds-schemas.html).
        """
...
class DataSourceCustomDocumentEnrichmentConfigurationInlineConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.bool document_content_deletion: `TRUE` to delete content if the condition used for the target attribute is met.
...
class DataSourceCustomDocumentEnrichmentConfigurationPostExtractionHookConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str lambda_arn: The Amazon Resource Name (ARN) of a Lambda Function that can manipulate your document metadata fields or attributes and content.
...
class IndexUserTokenConfigurationsJwtTokenTypeConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str secrets_manager_arn: The Amazon Resource Name (ARN) of the secret.
...
class GetExperienceConfigurationContentSourceConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] data_source_ids: Identifiers of the data sources you want to use for your Amazon Kendra Experience.
        :param _builtins.bool direct_put_content: Whether to use documents you indexed directly using the `BatchPutDocument API`.
        :param Sequence[_builtins.str] faq_ids: Identifier of the FAQs that you want to use for your Amazon Kendra Experience.
        """
        pulumi.set(__self__, "data_source_ids", data_source_ids)
        pulumi.set(__self__, "direct_put_content", direct_put_content)
        pulumi.set(__self__, "faq_ids", faq_ids)
