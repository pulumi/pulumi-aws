...
class IndexArgs:
    ...
    def _configure(
        ...
        if 'documentMetadataConfigurationUpdates' in kwargs:
        ...
        if 'userGroupResolutionConfiguration' in kwargs:
...
class Index(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if capacity_units is not None and not isinstance(capacity_units, IndexCapacityUnitsArgs):
                capacity_units = capacity_units or {}
                def _setter(key, value):
                    capacity_units[key] = value
                IndexCapacityUnitsArgs._configure(_setter, **capacity_units)
            ...
            if user_group_resolution_configuration is not None and not isinstance(user_group_resolution_configuration, IndexUserGroupResolutionConfigurationArgs):
                user_group_resolution_configuration = user_group_resolution_configuration or {}
                def _setter(key, value):
                    user_group_resolution_configuration[key] = value
                IndexUserGroupResolutionConfigurationArgs._configure(_setter, **user_group_resolution_configuration)
            __props__.__dict__["user_group_resolution_configuration"] = user_group_resolution_configuration
            if user_token_configurations is not None and not isinstance(user_token_configurations, IndexUserTokenConfigurationsArgs):
                user_token_configurations = user_token_configurations or {}
                def _setter(key, value):
                    user_token_configurations[key] = value
                IndexUserTokenConfigurationsArgs._configure(_setter, **user_token_configurations)
