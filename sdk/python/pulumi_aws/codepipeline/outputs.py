...
class PipelineArtifactStore(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'PipelineArtifactStoreEncryptionKeyArgs' encryption_key: Encryption key block AWS CodePipeline uses to encrypt the data in the artifact store, such as a KMS key. If you don't specify a key, AWS CodePipeline uses the default key for S3. An `encryption_key` block is documented below.
