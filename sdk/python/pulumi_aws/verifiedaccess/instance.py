...
class InstanceArgs:
    def __init__(__self__, *,
                 cidr_endpoints_custom_subdomain: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def cidr_endpoints_custom_subdomain(self, value: Optional[pulumi.Input[_builtins.str]]):
