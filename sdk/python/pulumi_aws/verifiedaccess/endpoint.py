...
class EndpointArgs:
    def __init__(__self__, *,
                 ...
                 verified_access_group_id: pulumi.Input[builtins.str],
                 application_domain: Optional[pulumi.Input[builtins.str]] = None,
                 cidr_options: Optional[pulumi.Input['EndpointCidrOptionsArgs']] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 domain_certificate_arn: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_domain_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: The type of Verified Access endpoint to create. Currently `load-balancer` or `network-interface` are supported.
        :param pulumi.Input[builtins.str] verified_access_group_id: The ID of the Verified Access group to associate the endpoint with.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] application_domain: The DNS name for users to reach your application. This parameter is required if the endpoint type is `load-balancer` or `network-interface`.
        ...
        :param pulumi.Input[builtins.str] description: A description for the Verified Access endpoint.
        :param pulumi.Input[builtins.str] domain_certificate_arn: The ARN of the public TLS/SSL certificate in AWS Certificate Manager to associate with the endpoint. The CN in the certificate must match the DNS name your end users will use to reach your application. This parameter is required if the endpoint type is `load-balancer` or `network-interface`.
        :param pulumi.Input[builtins.str] endpoint_domain_prefix: A custom identifier that is prepended to the DNS name that is generated for the endpoint.
    ...
    def verified_access_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def verified_access_group_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "verified_access_group_id", value)

    @property
    @pulumi.getter(name="applicationDomain")
    def application_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_domain(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def domain_certificate_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def domain_certificate_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "domain_certificate_arn", value)

    @property
    @pulumi.getter(name="endpointDomainPrefix")
    def endpoint_domain_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_domain_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EndpointState:
    def __init__(__self__, *,
                 ...
                 cidr_options: Optional[pulumi.Input['EndpointCidrOptionsArgs']] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 device_validation_domain: Optional[pulumi.Input[builtins.str]] = None,
                 domain_certificate_arn: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 verified_access_instance_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input['EndpointCidrOptionsArgs'] cidr_options: The CIDR block details. This parameter is required if the endpoint type is `cidr`.
        :param pulumi.Input[builtins.str] description: A description for the Verified Access endpoint.
        :param pulumi.Input[builtins.str] device_validation_domain: Returned if endpoint has a device trust provider attached.
        :param pulumi.Input[builtins.str] domain_certificate_arn: The ARN of the public TLS/SSL certificate in AWS Certificate Manager to associate with the endpoint. The CN in the certificate must match the DNS name your end users will use to reach your application. This parameter is required if the endpoint type is `load-balancer` or `network-interface`.
        :param pulumi.Input[builtins.str] endpoint_domain: A DNS name that is generated for the endpoint.
        :param pulumi.Input[builtins.str] endpoint_domain_prefix: A custom identifier that is prepended to the DNS name that is generated for the endpoint.
        :param pulumi.Input[builtins.str] endpoint_type: The type of Verified Access endpoint to create. Currently `load-balancer` or `network-interface` are supported.
        :param pulumi.Input['EndpointLoadBalancerOptionsArgs'] load_balancer_options: The load balancer details. This parameter is required if the endpoint type is `load-balancer`.
        :param pulumi.Input['EndpointNetworkInterfaceOptionsArgs'] network_interface_options: The network interface details. This parameter is required if the endpoint type is `network-interface`.
    ...
    def device_validation_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def device_validation_domain(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="verifiedAccessGroupId")
    def verified_access_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Verified Access group to associate the endpoint with.
    ...
    @verified_access_group_id.setter
    def verified_access_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "verified_access_group_id", value)

    @property
    @pulumi.getter(name="verifiedAccessInstanceId")
    def verified_access_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "verified_access_instance_id")

    @verified_access_instance_id.setter
    def verified_access_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Endpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            verified_access_group_id: Optional[pulumi.Input[builtins.str]] = None,
            verified_access_instance_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Endpoint':
        """
    ...
    @property
    @pulumi.getter(name="applicationDomain")
    def application_domain(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The DNS name for users to reach your application. This parameter is required if the endpoint type is `load-balancer` or `network-interface`.
        """
        return pulumi.get(self, "application_domain")
    ...
    @property
    @pulumi.getter(name="deviceValidationDomain")
    def device_validation_domain(self) -> pulumi.Output[builtins.str]:
        """
        Returned if endpoint has a device trust provider attached.
        """
        return pulumi.get(self, "device_validation_domain")
    ...
    @property
    @pulumi.getter(name="domainCertificateArn")
    def domain_certificate_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the public TLS/SSL certificate in AWS Certificate Manager to associate with the endpoint. The CN in the certificate must match the DNS name your end users will use to reach your application. This parameter is required if the endpoint type is `load-balancer` or `network-interface`.
        """
        return pulumi.get(self, "domain_certificate_arn")
    ...
    @property
    @pulumi.getter(name="endpointDomainPrefix")
    def endpoint_domain_prefix(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A custom identifier that is prepended to the DNS name that is generated for the endpoint.
        """
        return pulumi.get(self, "endpoint_domain_prefix")
    ...
    @property
    @pulumi.getter(name="verifiedAccessGroupId")
    def verified_access_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Verified Access group to associate the endpoint with.
    ...
    @property
    @pulumi.getter(name="verifiedAccessInstanceId")
    def verified_access_instance_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "verified_access_instance_id")
