...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 admin_password_secret_kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 admin_user_password: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] admin_password_secret_kms_key_id: ID of the KMS key used to encrypt the namespace's admin credentials secret.
        :param pulumi.Input[builtins.str] admin_user_password: The password of the administrator for the first database created in the namespace.
               Conflicts with `manage_admin_password` and `admin_user_password_wo`.
        :param pulumi.Input[builtins.str] admin_username: The username of the administrator for the first database created in the namespace.
        :param pulumi.Input[builtins.str] db_name: The name of the first database created in the namespace.
        :param pulumi.Input[builtins.str] default_iam_role_arn: The Amazon Resource Name (ARN) of the IAM role to set as a default in the namespace. When specifying `default_iam_role_arn`, it also must be part of `iam_roles`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] iam_roles: A list of IAM roles to associate with the namespace.
        :param pulumi.Input[builtins.str] kms_key_id: The ARN of the Amazon Web Services Key Management Service key used to encrypt your data.
    ...
    def admin_password_secret_kms_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def admin_password_secret_kms_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "admin_password_secret_kms_key_id", value)

    @property
    @pulumi.getter(name="adminUserPassword")
    def admin_user_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def admin_user_password(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def default_iam_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_iam_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def manage_admin_password(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def manage_admin_password(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _NamespaceState:
    def __init__(__self__, *,
                 admin_password_secret_arn: Optional[pulumi.Input[builtins.str]] = None,
                 admin_password_secret_kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 admin_user_password: Optional[pulumi.Input[builtins.str]] = None,
                 admin_username: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] admin_password_secret_arn: Amazon Resource Name (ARN) of namespace's admin user credentials secret.
        :param pulumi.Input[builtins.str] admin_password_secret_kms_key_id: ID of the KMS key used to encrypt the namespace's admin credentials secret.
        :param pulumi.Input[builtins.str] admin_user_password: The password of the administrator for the first database created in the namespace.
               Conflicts with `manage_admin_password` and `admin_user_password_wo`.
        :param pulumi.Input[builtins.str] admin_username: The username of the administrator for the first database created in the namespace.
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the Redshift Serverless Namespace.
        :param pulumi.Input[builtins.str] db_name: The name of the first database created in the namespace.
        :param pulumi.Input[builtins.str] default_iam_role_arn: The Amazon Resource Name (ARN) of the IAM role to set as a default in the namespace. When specifying `default_iam_role_arn`, it also must be part of `iam_roles`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] iam_roles: A list of IAM roles to associate with the namespace.
        :param pulumi.Input[builtins.str] kms_key_id: The ARN of the Amazon Web Services Key Management Service key used to encrypt your data.
    ...
    def admin_password_secret_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def admin_password_secret_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Namespace(pulumi.CustomResource):
    ...
    pulumi_type = "aws:redshiftserverless/namespace:Namespace"
    ...
    @property
    @pulumi.getter(name="adminPasswordSecretArn")
    def admin_password_secret_arn(self) -> pulumi.Output[builtins.str]:
        """
        Amazon Resource Name (ARN) of namespace's admin user credentials secret.
        """
        return pulumi.get(self, "admin_password_secret_arn")
    ...
    @property
    @pulumi.getter(name="adminPasswordSecretKmsKeyId")
    def admin_password_secret_kms_key_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the KMS key used to encrypt the namespace's admin credentials secret.
        """
        return pulumi.get(self, "admin_password_secret_kms_key_id")
    ...
    @property
    @pulumi.getter(name="adminUserPassword")
    def admin_user_password(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The password of the administrator for the first database created in the namespace.
        Conflicts with `manage_admin_password` and `admin_user_password_wo`.
        """
    ...
    @property
    @pulumi.getter(name="defaultIamRoleArn")
    def default_iam_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the IAM role to set as a default in the namespace. When specifying `default_iam_role_arn`, it also must be part of `iam_roles`.
        """
        return pulumi.get(self, "default_iam_role_arn")
    ...
    @property
    @pulumi.getter(name="iamRoles")
    def iam_roles(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of IAM roles to associate with the namespace.
        """
        return pulumi.get(self, "iam_roles")
    ...
    @property
    @pulumi.getter(name="manageAdminPassword")
    def manage_admin_password(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to use AWS SecretManager to manage namespace's admin credentials.
        Conflicts with `admin_user_password` and `admin_user_password_wo`.
        """
