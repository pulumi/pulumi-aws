...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy: The policy to create or update. For example, the following policy grants a user authorization to restore a snapshot.
...
@pulumi.type_token("aws:redshiftserverless/resourcePolicy:ResourcePolicy")
