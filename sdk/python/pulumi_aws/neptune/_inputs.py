...
__all__ = [
    ...
    'GraphGraphTimeoutsArgsDict',
    'GraphGraphVectorSearchConfigurationArgs',
    'GraphGraphVectorSearchConfigurationArgsDict',
...
if not MYPY:
    class GraphGraphTimeoutsArgsDict(TypedDict):
    ...
    GraphGraphTimeoutsArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class GraphGraphTimeoutsArgs:
    def __init__(__self__, *,
...
if not MYPY:
    class GraphGraphVectorSearchConfigurationArgsDict(TypedDict):
        vector_search_dimension: NotRequired[pulumi.Input[int]]
        """
        Specifies the number of dimensions for vector embeddings.  Value must be between 1 and 65,535.
        """
elif False:
    GraphGraphVectorSearchConfigurationArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class GraphGraphVectorSearchConfigurationArgs:
    def __init__(__self__, *,
                 vector_search_dimension: Optional[pulumi.Input[int]] = None):
        """
        :param pulumi.Input[int] vector_search_dimension: Specifies the number of dimensions for vector embeddings.  Value must be between 1 and 65,535.
        """
    ...
    def vector_search_dimension(self) -> Optional[pulumi.Input[int]]:
        """
        Specifies the number of dimensions for vector embeddings.  Value must be between 1 and 65,535.
        """
    ...
    def vector_search_dimension(self, value: Optional[pulumi.Input[int]]):
