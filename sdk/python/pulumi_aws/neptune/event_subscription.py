...
class EventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the Neptune event subscription. By default generated by this provider.
        :param pulumi.Input[_builtins.str] name_prefix: The name of the Neptune event subscription. Conflicts with `name`.
        ...
        :param pulumi.Input[_builtins.str] source_type: The type of source that will be generating the events. Valid options are `db-instance`, `db-security-group`, `db-parameter-group`, `db-snapshot`, `db-cluster` or `db-cluster-snapshot`. If not set, all sources will be subscribed to.
