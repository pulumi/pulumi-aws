...
class EventSubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_categories: A list of event categories for a `source_type` that you want to subscribe to. Run `aws neptune describe-event-categories` to find all the event categories.
        :param pulumi.Input[builtins.str] name: The name of the Neptune event subscription. By default generated by this provider.
        :param pulumi.Input[builtins.str] name_prefix: The name of the Neptune event subscription. Conflicts with `name`.
        ...
        :param pulumi.Input[builtins.str] source_type: The type of source that will be generating the events. Valid options are `db-instance`, `db-security-group`, `db-parameter-group`, `db-snapshot`, `db-cluster` or `db-cluster-snapshot`. If not set, all sources will be subscribed to.
...
class _EventSubscriptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name of the Neptune event notification subscription.
        :param pulumi.Input[builtins.str] customer_aws_id: The AWS customer account associated with the Neptune event notification subscription.
        :param pulumi.Input[builtins.bool] enabled: A boolean flag to enable/disable the subscription. Defaults to true.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_categories: A list of event categories for a `source_type` that you want to subscribe to. Run `aws neptune describe-event-categories` to find all the event categories.
        :param pulumi.Input[builtins.str] name: The name of the Neptune event subscription. By default generated by this provider.
        :param pulumi.Input[builtins.str] name_prefix: The name of the Neptune event subscription. Conflicts with `name`.
