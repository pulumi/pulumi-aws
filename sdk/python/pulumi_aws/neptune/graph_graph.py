...
__all__ = ['GraphGraphArgs', 'GraphGraph']

@pulumi.input_type
class GraphGraphArgs:
    def __init__(__self__, *,
                 ...
                 timeouts: Optional[pulumi.Input['GraphGraphTimeoutsArgs']] = None,
                 vector_search_configuration: Optional[pulumi.Input['GraphGraphVectorSearchConfigurationArgs']] = None):
        """
        ...
        :param pulumi.Input['GraphGraphVectorSearchConfigurationArgs'] vector_search_configuration: Vector search configuration for the Neptune Graph
        """
    ...
    @property
    @pulumi.getter
    def timeouts(self) -> Optional[pulumi.Input['GraphGraphTimeoutsArgs']]:
        return pulumi.get(self, "timeouts")

    @timeouts.setter
    def timeouts(self, value: Optional[pulumi.Input['GraphGraphTimeoutsArgs']]):
        pulumi.set(self, "timeouts", value)

    @property
    @pulumi.getter(name="vectorSearchConfiguration")
    def vector_search_configuration(self) -> Optional[pulumi.Input['GraphGraphVectorSearchConfigurationArgs']]:
        """
    ...
    def vector_search_configuration(self, value: Optional[pulumi.Input['GraphGraphVectorSearchConfigurationArgs']]):
        pulumi.set(self, "vector_search_configuration", value)


@pulumi.input_type
class _GraphGraphState:
    def __init__(__self__, *,
...
class GraphGraph(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 replica_count: Optional[pulumi.Input[int]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 timeouts: Optional[pulumi.Input[Union['GraphGraphTimeoutsArgs', 'GraphGraphTimeoutsArgsDict']]] = None,
                 vector_search_configuration: Optional[pulumi.Input[Union['GraphGraphVectorSearchConfigurationArgs', 'GraphGraphVectorSearchConfigurationArgsDict']]] = None,
                 __props__=None):
        """
        ...
        example = aws.neptune.GraphGraph("example",
        ...
        :param pulumi.Input[bool] public_connectivity: Specifies whether or not the graph can be reachable over the internet. All access to graphs is IAM authenticated. When
               ...
               the DNS name resolves to a private IP address that is reachable from the VPC.
        :param pulumi.Input[int] replica_count: The number of replicas in other AZs. Value must be between 0 and 2.
        :param pulumi.Input[Union['GraphGraphVectorSearchConfigurationArgs', 'GraphGraphVectorSearchConfigurationArgsDict']] vector_search_configuration: Vector search configuration for the Neptune Graph
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GraphGraphArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GraphGraphArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GraphGraphArgs.__new__(GraphGraphArgs)
        ...
        super(GraphGraph, __self__).__init__(
            'aws:neptune/graphGraph:GraphGraph',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            timeouts: Optional[pulumi.Input[Union['GraphGraphTimeoutsArgs', 'GraphGraphTimeoutsArgsDict']]] = None,
            vector_search_configuration: Optional[pulumi.Input[Union['GraphGraphVectorSearchConfigurationArgs', 'GraphGraphVectorSearchConfigurationArgsDict']]] = None) -> 'GraphGraph':
        """
        ...
        __props__ = _GraphGraphState.__new__(_GraphGraphState)
        ...
        __props__.__dict__["timeouts"] = timeouts
        __props__.__dict__["vector_search_configuration"] = vector_search_configuration
        return GraphGraph(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def timeouts(self) -> pulumi.Output[Optional['outputs.GraphGraphTimeouts']]:
        return pulumi.get(self, "timeouts")

    @property
    @pulumi.getter(name="vectorSearchConfiguration")
    def vector_search_configuration(self) -> pulumi.Output[Optional['outputs.GraphGraphVectorSearchConfiguration']]:
        """
        Vector search configuration for the Neptune Graph
        """
        return pulumi.get(self, "vector_search_configuration")
