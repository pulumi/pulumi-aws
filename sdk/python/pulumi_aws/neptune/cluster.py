...
class Cluster(pulumi.CustomResource):
    ...
    def enable_cloudwatch_logs_exports(self) -> Optional[List[str]]:
        """
    ...
    def iam_roles(self) -> Optional[List[str]]:
        """
    ...
    def neptune_cluster_parameter_group_name(self) -> Optional[str]:
        """
