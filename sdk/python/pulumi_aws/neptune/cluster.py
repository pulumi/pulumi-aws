...
class ClusterArgs:
    ...
    def _configure(
        ...
        if 'clusterIdentifierPrefix' in kwargs:
        ...
        if 'finalSnapshotIdentifier' in kwargs:
        ...
        if 'iamDatabaseAuthenticationEnabled' in kwargs:
        ...
        if 'skipFinalSnapshot' in kwargs:
