...
class ClusterInstanceArgs:
    def __init__(__self__, *,
                 ...
                 neptune_parameter_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_class: The instance class to use.
        :param pulumi.Input[builtins.bool] apply_immediately: Specifies whether any instance modifications
               are applied immediately, or during the next maintenance window. Default is`false`.
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: Indicates that minor engine upgrades will be applied automatically to the instance during the maintenance window. Default is `true`.
        :param pulumi.Input[builtins.str] availability_zone: The EC2 Availability Zone that the neptune instance is created in.
        :param pulumi.Input[builtins.str] engine: The name of the database engine to be used for the neptune instance. Defaults to `neptune`. Valid Values: `neptune`.
        :param pulumi.Input[builtins.str] engine_version: The neptune engine version. Currently configuring this argumnet has no effect.
        :param pulumi.Input[builtins.str] identifier: The identifier for the neptune instance, if omitted, this provider will assign a random, unique identifier.
        ...
        :param pulumi.Input[builtins.str] neptune_parameter_group_name: The name of the neptune parameter group to associate with this instance.
        :param pulumi.Input[builtins.str] neptune_subnet_group_name: A subnet group to associate with this neptune instance. **NOTE:** This must match the `neptune_subnet_group_name` of the attached `neptune.Cluster`.
        :param pulumi.Input[builtins.int] port: The port on which the DB accepts connections. Defaults to `8182`.
        :param pulumi.Input[builtins.str] preferred_backup_window: The daily time range during which automated backups are created if automated backups are enabled. Eg: "04:00-09:00"
    ...
    def neptune_parameter_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def neptune_parameter_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClusterInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address: The hostname of the instance. See also `endpoint` and `port`.
        :param pulumi.Input[builtins.bool] apply_immediately: Specifies whether any instance modifications
               are applied immediately, or during the next maintenance window. Default is`false`.
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of neptune instance
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: Indicates that minor engine upgrades will be applied automatically to the instance during the maintenance window. Default is `true`.
        :param pulumi.Input[builtins.str] availability_zone: The EC2 Availability Zone that the neptune instance is created in.
        :param pulumi.Input[builtins.str] cluster_identifier: The identifier of the `neptune.Cluster` in which to launch this instance.
        :param pulumi.Input[builtins.str] dbi_resource_id: The region-unique, immutable identifier for the neptune instance.
        :param pulumi.Input[builtins.str] endpoint: The connection endpoint in `address:port` format.
        :param pulumi.Input[builtins.str] engine: The name of the database engine to be used for the neptune instance. Defaults to `neptune`. Valid Values: `neptune`.
        :param pulumi.Input[builtins.str] engine_version: The neptune engine version. Currently configuring this argumnet has no effect.
        :param pulumi.Input[builtins.str] identifier: The identifier for the neptune instance, if omitted, this provider will assign a random, unique identifier.
        :param pulumi.Input[builtins.str] identifier_prefix: Creates a unique identifier beginning with the specified prefix. Conflicts with `identifier`.
        :param pulumi.Input[builtins.str] instance_class: The instance class to use.
        :param pulumi.Input[builtins.str] kms_key_arn: The ARN for the KMS encryption key if one is set to the neptune cluster.
        :param pulumi.Input[builtins.str] neptune_parameter_group_name: The name of the neptune parameter group to associate with this instance.
        :param pulumi.Input[builtins.str] neptune_subnet_group_name: A subnet group to associate with this neptune instance. **NOTE:** This must match the `neptune_subnet_group_name` of the attached `neptune.Cluster`.
        :param pulumi.Input[builtins.int] port: The port on which the DB accepts connections. Defaults to `8182`.
        :param pulumi.Input[builtins.str] preferred_backup_window: The daily time range during which automated backups are created if automated backups are enabled. Eg: "04:00-09:00"
...
class ClusterInstance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="neptuneParameterGroupName")
    def neptune_parameter_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the neptune parameter group to associate with this instance.
        """
        return pulumi.get(self, "neptune_parameter_group_name")
