...
class ParameterGroup(pulumi.CustomResource):
    ...
    A list of Neptune parameters to apply.
      ...
      * `apply_method` (`str`) - The apply method of the Neptune parameter. Valid values are `immediate` and `pending-reboot`. Defaults to `pending-reboot`.
    ...
    def __init__(__self__, resource_name, opts=None, description=None, family=None, name=None, parameters=None, tags=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **parameters** object supports the following:
          ...
          * `apply_method` (`pulumi.Input[str]`) - The apply method of the Neptune parameter. Valid values are `immediate` and `pending-reboot`. Defaults to `pending-reboot`.
