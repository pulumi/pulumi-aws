...
class Repository(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if catalog_data is not None and not isinstance(catalog_data, RepositoryCatalogDataArgs):
                catalog_data = catalog_data or {}
                def _setter(key, value):
                    catalog_data[key] = value
                RepositoryCatalogDataArgs._configure(_setter, **catalog_data)
