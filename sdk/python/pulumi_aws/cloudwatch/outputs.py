...
class CompositeAlarmActionsSuppressor(dict):
    ...
    def __init__(__self__, *,
                 alarm: builtins.str,
                 extension_period: builtins.int,
                 wait_period: builtins.int):
        """
        :param builtins.str alarm: Can be an AlarmName or an Amazon Resource Name (ARN) from an existing alarm.
        :param builtins.int extension_period: The maximum time in seconds that the composite alarm waits after suppressor alarm goes out of the `ALARM` state. After this time, the composite alarm performs its actions.
        :param builtins.int wait_period: The maximum time in seconds that the composite alarm waits for the suppressor alarm to go into the `ALARM` state. After this time, the composite alarm performs its actions.
        """
    ...
    def extension_period(self) -> builtins.int:
        """
    ...
    def wait_period(self) -> builtins.int:
        """
...
class EventConnectionAuthParametersApiKey(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: Header Name.
        :param builtins.str value: Header Value. Created and stored in AWS Secrets Manager.
        """
...
class EventConnectionAuthParametersBasic(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str password: A password for the authorization. Created and stored in AWS Secrets Manager.
        :param builtins.str username: A username for the authorization.
        """
...
class EventConnectionAuthParametersInvocationHttpParametersBody(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool is_value_secret: Specified whether the value is secret.
        :param builtins.str key: The key for the parameter.
        :param builtins.str value: The value associated with the key. Created and stored in AWS Secrets Manager if is secret.
        """
...
class EventConnectionAuthParametersOauth(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str authorization_endpoint: The URL to the authorization endpoint.
        :param builtins.str http_method: A password for the authorization. Created and stored in AWS Secrets Manager.
...
class EventConnectionAuthParametersOauthClientParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str client_id: The client ID for the credentials to use for authorization. Created and stored in AWS Secrets Manager.
        :param builtins.str client_secret: The client secret for the credentials to use for authorization. Created and stored in AWS Secrets Manager.
        """
...
class EventConnectionInvocationConnectivityParametersResourceParameters(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_configuration_arn: ARN of the Amazon VPC Lattice resource configuration for the resource endpoint.
        """
...
class EventEndpointEventBus(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str event_bus_arn: The ARN of the event bus the endpoint is associated with.
        """
...
class EventEndpointReplicationConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str state: The state of event replication. Valid values: `ENABLED`, `DISABLED`. The default state is `ENABLED`, which means you must supply a `role_arn`. If you don't have a `role_arn` or you don't want event replication enabled, set `state` to `DISABLED`.
        """
...
class EventEndpointRoutingConfigFailoverConfigSecondary(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str route: The name of the secondary Region.
        """
...
class EventPermissionCondition(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str key: Key for the condition. Valid values: `aws:PrincipalOrgID`.
        :param builtins.str type: Type of condition. Value values: `StringEquals`.
        :param builtins.str value: Value for the key.
        """
        pulumi.set(__self__, "key", key)
...
class EventTargetAppsyncTarget(dict):
    ...
    def __init__(__self__, *,
                 graphql_operation: Optional[builtins.str] = None):
        """
        :param builtins.str graphql_operation: Contains the GraphQL mutation to be parsed and executed.
        """
    ...
    def graphql_operation(self) -> Optional[builtins.str]:
        """
...
class EventTargetBatchTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 array_size: Optional[builtins.int] = None,
                 job_attempts: Optional[builtins.int] = None):
        """
        ...
        :param builtins.int array_size: The size of the array, if this is an array batch job. Valid values are integers between 2 and 10,000.
        :param builtins.int job_attempts: The number of times to attempt to retry, if the job fails. Valid values are 1 to 10.
        """
    ...
    def array_size(self) -> Optional[builtins.int]:
        """
    ...
    def job_attempts(self) -> Optional[builtins.int]:
        """
...
class EventTargetDeadLetterConfig(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str arn: ARN of the SQS queue specified as the target for the dead-letter queue.
        """
        if arn is not None:
...
class EventTargetEcsTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str task_definition_arn: The ARN of the task definition to use if the event target is an Amazon ECS cluster.
        ...
        :param builtins.bool enable_ecs_managed_tags: Specifies whether to enable Amazon ECS managed tags for the task.
        ...
        :param builtins.str launch_type: Specifies the launch type on which your task is running. The launch type that you specify here must match one of the launch type (compatibilities) of the target task. Valid values include: `EC2`, `EXTERNAL`, or `FARGATE`.
        ...
        :param builtins.str platform_version: Specifies the platform version for the task. Specify only the numeric portion of the platform version, such as `1.1.0`. This is used only if LaunchType is FARGATE. For more information about valid platform versions, see [AWS Fargate Platform Versions](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html).
        :param builtins.str propagate_tags: Specifies whether to propagate the tags from the task definition to the task. If no value is specified, the tags are not propagated. Tags can only be propagated to the task during task creation. The only valid value is: `TASK_DEFINITION`.
        :param Mapping[str, builtins.str] tags: A map of tags to assign to ecs resources.
        :param builtins.int task_count: The number of tasks to create based on the TaskDefinition. Defaults to `1`.
        """
...
class EventTargetEcsTargetCapacityProviderStrategy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int base: The base value designates how many tasks, at a minimum, to run on the specified capacity provider. Only one capacity provider in a capacity provider strategy can have a base defined. Defaults to `0`.
...
class EventTargetEcsTargetNetworkConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] subnets: The subnets associated with the task or service.
        :param builtins.bool assign_public_ip: Assign a public IP address to the ENI (Fargate launch type only). Valid values are `true` or `false`. Defaults to `false`.
               
               For more information, see [Task Networking](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-networking.html)
        :param Sequence[builtins.str] security_groups: The security groups associated with the task or service. If you do not specify a security group, the default security group for the VPC is used.
        """
...
class EventTargetEcsTargetOrderedPlacementStrategy(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Type of placement strategy. The only valid values at this time are `binpack`, `random` and `spread`.
...
class EventTargetHttpTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] header_parameters: Enables you to specify HTTP headers to add to the request.
        :param Sequence[builtins.str] path_parameter_values: The list of values that correspond sequentially to any path variables in your endpoint ARN (for example `arn:aws:execute-api:us-east-1:123456:myapi/*/POST/pets/*`).
        :param Mapping[str, builtins.str] query_string_parameters: Represents keys/values of query string parameters that are appended to the invoked endpoint.
        """
...
class EventTargetInputTransformer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 input_paths: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str input_template: Template to customize data sent to the target. Must be valid JSON. To send a string value, the string value must include double quotes.
        :param Mapping[str, builtins.str] input_paths: Key value pairs specified in the form of JSONPath (for example, time = $.time)
    ...
    def input_paths(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class EventTargetKinesisTarget(dict):
    ...
    def __init__(__self__, *,
                 partition_key_path: Optional[builtins.str] = None):
        """
        :param builtins.str partition_key_path: The JSON path to be extracted from the event and used as the partition key.
        """
    ...
    def partition_key_path(self) -> Optional[builtins.str]:
        """
...
class EventTargetRedshiftTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secrets_manager_arn: Optional[builtins.str] = None,
                 sql: Optional[builtins.str] = None,
                 statement_name: Optional[builtins.str] = None,
                 with_event: Optional[builtins.bool] = None):
        """
        :param builtins.str database: The name of the database.
        :param builtins.str db_user: The database user name.
        :param builtins.str secrets_manager_arn: The name or ARN of the secret that enables access to the database.
        :param builtins.str sql: The SQL statement text to run.
        :param builtins.str statement_name: The name of the SQL statement.
...
class EventTargetRetryPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int maximum_event_age_in_seconds: The age in seconds to continue to make retry attempts.
        :param builtins.int maximum_retry_attempts: maximum number of retry attempts to make before the request fails
        """
...
class InternetMonitorHealthEventsConfig(dict):
    ...
    def __init__(__self__, *,
                 availability_score_threshold: Optional[builtins.float] = None,
                 performance_score_threshold: Optional[builtins.float] = None):
        """
        :param builtins.float availability_score_threshold: The health event threshold percentage set for availability scores.
        :param builtins.float performance_score_threshold: The health event threshold percentage set for performance scores.
        """
    ...
    def availability_score_threshold(self) -> Optional[builtins.float]:
        """
    ...
    def performance_score_threshold(self) -> Optional[builtins.float]:
        """
...
class InternetMonitorInternetMeasurementsLogDeliveryS3Config(dict):
    ...
    def __init__(__self__, *,
                 ...
                 log_delivery_status: Optional[builtins.str] = None):
    ...
    def log_delivery_status(self) -> Optional[builtins.str]:
...
class LogDeliveryDestinationDeliveryDestinationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str destination_resource_arn: The ARN of the AWS destination that this delivery destination represents.
        """
...
class LogDeliveryS3DeliveryConfiguration(dict):
    ...
    def __init__(__self__, *,
                 enable_hive_compatible_path: builtins.bool,
                 suffix_path: builtins.str):
        """
        :param builtins.bool enable_hive_compatible_path: This parameter causes the S3 objects that contain delivered logs to use a prefix structure that allows for integration with Apache Hive.
        :param builtins.str suffix_path: This string allows re-configuring the S3 object prefix to contain either static or variable sections. The valid variables to use in the suffix path will vary by each log source.
        """
    ...
    def enable_hive_compatible_path(self) -> builtins.bool:
        """
...
class LogMetricFilterMetricTransformation(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the CloudWatch metric to which the monitored log information should be published (e.g., `ErrorCount`)
        :param builtins.str namespace: The destination namespace of the CloudWatch metric.
        :param builtins.str value: What to publish to the metric. For example, if you're counting the occurrences of a particular term like "Error", the value will be "1" for each occurrence. If you're counting the bytes transferred the published value will be the value in the log event.
        :param builtins.str default_value: The value to emit when a filter pattern does not match a log event. Conflicts with `dimensions`.
        :param Mapping[str, builtins.str] dimensions: Map of fields to use as dimensions for the metric. Up to 3 dimensions are allowed. Conflicts with `default_value`.
        :param builtins.str unit: The unit to assign to the metric. If you omit this, the unit is set as `None`.
        """
        pulumi.set(__self__, "name", name)
...
class MetricAlarmMetricQuery(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: A short name used to tie this object to the results in the response. If you are performing math expressions on this set of data, this name represents that data and can serve as a variable in the mathematical expression. The valid characters are letters, numbers, and underscore. The first character must be a lowercase letter.
        :param builtins.str account_id: The ID of the account where the metrics are located, if this is a cross-account alarm.
        :param builtins.str expression: The math expression to be performed on the returned data, if this object is performing a math expression. This expression can use the id of the other metrics to refer to those metrics, and can also use the id of other expressions to use the result of those expressions. For more information about metric math expressions, see Metric Math Syntax and Functions in the [Amazon CloudWatch User Guide](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/using-metric-math.html#metric-math-syntax).
        :param builtins.str label: A human-readable label for this metric or expression. This is especially useful if this is an expression, so that you know what the value represents.
...
class MetricAlarmMetricQueryMetric(dict):
    ...
    def __init__(__self__, *,
                 ...
                 unit: Optional[builtins.str] = None):
        """
        :param builtins.str metric_name: The name for this metric.
        ...
        :param builtins.str namespace: The namespace for this metric. See docs for the [list of namespaces](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/aws-namespaces.html).
               See docs for [supported metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/CW_Support_For_AWS.html).
        :param builtins.str unit: The unit for this metric.
        """
...
class MetricStreamExcludeFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str namespace: Name of the metric namespace in the filter.
        :param Sequence[builtins.str] metric_names: An array that defines the metrics you want to exclude for this metric namespace
        """
        pulumi.set(__self__, "namespace", namespace)
...
class MetricStreamIncludeFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str namespace: Name of the metric namespace in the filter.
        :param Sequence[builtins.str] metric_names: An array that defines the metrics you want to include for this metric namespace
        """
        pulumi.set(__self__, "namespace", namespace)
        if metric_names is not None:
            pulumi.set(__self__, "metric_names", metric_names)
...
class MetricStreamStatisticsConfiguration(dict):
    ...
    def __init__(__self__, *,
                 additional_statistics: Sequence[builtins.str],
                 include_metrics: Sequence['outputs.MetricStreamStatisticsConfigurationIncludeMetric']):
        """
        :param Sequence[builtins.str] additional_statistics: The additional statistics to stream for the metrics listed in `include_metrics`.
    ...
    def additional_statistics(self) -> Sequence[builtins.str]:
        """
...
class GetContributorManagedInsightRulesManagedRuleRuleStateResult(dict):
    def __init__(__self__, *,
                 ...
                 state: builtins.str):
        """
        :param builtins.str rule_name: Name of the Contributor Insights rule that contains data for the specified Amazon Web Services resource.
        :param builtins.str state: Indicates whether the rule is enabled or disabled.
        """
...
class GetEventBusesEventBusResult(dict):
    def __init__(__self__, *,
                 ...
                 policy: builtins.str):
        """
        :param builtins.str arn: The ARN of the event bus.
        :param builtins.str creation_time: The time the event bus was created.
        :param builtins.str description: The event bus description.
        :param builtins.str last_modified_time: The time the event bus was last modified.
        :param builtins.str name: The name of the event bus.
        :param builtins.str policy: The permissions policy of the event bus, describing which other AWS accounts can write events to this event bus.
        """
        pulumi.set(__self__, "arn", arn)
