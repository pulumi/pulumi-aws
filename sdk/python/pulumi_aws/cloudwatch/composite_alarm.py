...
class CompositeAlarmArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alarm_name: The name for the composite alarm. This name must be unique within the region.
        ...
        :param pulumi.Input[builtins.bool] actions_enabled: Indicates whether actions should be executed during any changes to the alarm state of the composite alarm. Defaults to `true`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] alarm_actions: The set of actions to execute when this alarm transitions to the `ALARM` state from any other state. Each action is specified as an ARN. Up to 5 actions are allowed.
...
class _CompositeAlarmState:
    ...
    @property
    @pulumi.getter(name="alarmRule")
    def alarm_rule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An expression that specifies which other alarms are to be evaluated to determine this composite alarm's state. For syntax, see [Creating a Composite Alarm](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Create_Composite_Alarm.html). The maximum length is 10240 characters.
        """
        return pulumi.get(self, "alarm_rule")
    ...
    @alarm_rule.setter
    def alarm_rule(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alarm_rule", value)
