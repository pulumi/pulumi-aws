...
class EventPermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: The action that you are enabling the other account to perform. Defaults to `events:PutEvents`.
...
class EventPermission(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            event_bus_name: Optional[pulumi.Input[builtins.str]] = None,
            principal: Optional[pulumi.Input[builtins.str]] = None,
            statement_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EventPermission':
        """
