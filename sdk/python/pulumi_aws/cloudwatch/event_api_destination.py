...
class EventApiDestinationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connection_arn: ARN of the EventBridge Connection to use for the API Destination.
        :param pulumi.Input[_builtins.str] http_method: Select the HTTP method used for the invocation endpoint, such as GET, POST, PUT, etc.
        :param pulumi.Input[_builtins.str] invocation_endpoint: URL endpoint to invoke as a target. This could be a valid endpoint generated by a partner service. You can include "*" as path parameters wildcards to be set from the Target HttpParameters.
        :param pulumi.Input[_builtins.str] description: The description of the new API Destination. Maximum of 512 characters.
        :param pulumi.Input[_builtins.int] invocation_rate_limit_per_second: Enter the maximum number of invocations per second to allow for this destination. Enter a value greater than 0 (default 300).
        :param pulumi.Input[_builtins.str] name: The name of the new API Destination. The name must be unique for your account. Maximum of 64 characters consisting of numbers, lower/upper case letters, .,-,_.
...
class _EventApiDestinationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] arn: The Amazon Resource Name (ARN) of the event API Destination.
        :param pulumi.Input[_builtins.str] connection_arn: ARN of the EventBridge Connection to use for the API Destination.
        :param pulumi.Input[_builtins.str] description: The description of the new API Destination. Maximum of 512 characters.
        :param pulumi.Input[_builtins.str] http_method: Select the HTTP method used for the invocation endpoint, such as GET, POST, PUT, etc.
        :param pulumi.Input[_builtins.str] invocation_endpoint: URL endpoint to invoke as a target. This could be a valid endpoint generated by a partner service. You can include "*" as path parameters wildcards to be set from the Target HttpParameters.
    ...
    @_builtins.property
    @pulumi.getter(name="invocationEndpoint")
    def invocation_endpoint(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        URL endpoint to invoke as a target. This could be a valid endpoint generated by a partner service. You can include "*" as path parameters wildcards to be set from the Target HttpParameters.
        """
        return pulumi.get(self, "invocation_endpoint")
    ...
    @invocation_endpoint.setter
    def invocation_endpoint(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "invocation_endpoint", value)
...
class EventApiDestination(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            invocation_rate_limit_per_second: pulumi.Input[Optional[_builtins.int]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None) -> 'EventApiDestination':
        """
