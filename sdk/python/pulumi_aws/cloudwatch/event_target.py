...
class EventTargetArgs:
    ...
    def _configure(
        ...
        if batch_target is None and 'batchTarget' in kwargs:
            batch_target = kwargs['batchTarget']
        if dead_letter_config is None and 'deadLetterConfig' in kwargs:
            dead_letter_config = kwargs['deadLetterConfig']
        if ecs_target is None and 'ecsTarget' in kwargs:
            ecs_target = kwargs['ecsTarget']
        ...
        if kinesis_target is None and 'kinesisTarget' in kwargs:
            kinesis_target = kwargs['kinesisTarget']
        if redshift_target is None and 'redshiftTarget' in kwargs:
            redshift_target = kwargs['redshiftTarget']
        ...
        if sagemaker_pipeline_target is None and 'sagemakerPipelineTarget' in kwargs:
            sagemaker_pipeline_target = kwargs['sagemakerPipelineTarget']
        if sqs_target is None and 'sqsTarget' in kwargs:
            sqs_target = kwargs['sqsTarget']
        ...
        if kinesis_target is not None:
            _setter("kinesis_target", kinesis_target)
        if redshift_target is not None:
            _setter("redshift_target", redshift_target)
        ...
        if sagemaker_pipeline_target is not None:
            _setter("sagemaker_pipeline_target", sagemaker_pipeline_target)
        if sqs_target is not None:
            _setter("sqs_target", sqs_target)
...
class EventTarget(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            EventTargetArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if batch_target is not None and not isinstance(batch_target, EventTargetBatchTargetArgs):
                batch_target = batch_target or {}
                def _setter(key, value):
                    batch_target[key] = value
                EventTargetBatchTargetArgs._configure(_setter, **batch_target)
            __props__.__dict__["batch_target"] = batch_target
            if dead_letter_config is not None and not isinstance(dead_letter_config, EventTargetDeadLetterConfigArgs):
                dead_letter_config = dead_letter_config or {}
                def _setter(key, value):
                    dead_letter_config[key] = value
                EventTargetDeadLetterConfigArgs._configure(_setter, **dead_letter_config)
            __props__.__dict__["dead_letter_config"] = dead_letter_config
            if ecs_target is not None and not isinstance(ecs_target, EventTargetEcsTargetArgs):
                ecs_target = ecs_target or {}
                def _setter(key, value):
                    ecs_target[key] = value
                EventTargetEcsTargetArgs._configure(_setter, **ecs_target)
            __props__.__dict__["ecs_target"] = ecs_target
            __props__.__dict__["event_bus_name"] = event_bus_name
            if http_target is not None and not isinstance(http_target, EventTargetHttpTargetArgs):
                http_target = http_target or {}
                def _setter(key, value):
                    http_target[key] = value
                EventTargetHttpTargetArgs._configure(_setter, **http_target)
            __props__.__dict__["http_target"] = http_target
            __props__.__dict__["input"] = input
            __props__.__dict__["input_path"] = input_path
            if input_transformer is not None and not isinstance(input_transformer, EventTargetInputTransformerArgs):
                input_transformer = input_transformer or {}
                def _setter(key, value):
                    input_transformer[key] = value
                EventTargetInputTransformerArgs._configure(_setter, **input_transformer)
            __props__.__dict__["input_transformer"] = input_transformer
            if kinesis_target is not None and not isinstance(kinesis_target, EventTargetKinesisTargetArgs):
                kinesis_target = kinesis_target or {}
                def _setter(key, value):
                    kinesis_target[key] = value
                EventTargetKinesisTargetArgs._configure(_setter, **kinesis_target)
            __props__.__dict__["kinesis_target"] = kinesis_target
            if redshift_target is not None and not isinstance(redshift_target, EventTargetRedshiftTargetArgs):
                redshift_target = redshift_target or {}
                def _setter(key, value):
                    redshift_target[key] = value
                EventTargetRedshiftTargetArgs._configure(_setter, **redshift_target)
            __props__.__dict__["redshift_target"] = redshift_target
            if retry_policy is not None and not isinstance(retry_policy, EventTargetRetryPolicyArgs):
                retry_policy = retry_policy or {}
                def _setter(key, value):
                    retry_policy[key] = value
                EventTargetRetryPolicyArgs._configure(_setter, **retry_policy)
            ...
            if sagemaker_pipeline_target is not None and not isinstance(sagemaker_pipeline_target, EventTargetSagemakerPipelineTargetArgs):
                sagemaker_pipeline_target = sagemaker_pipeline_target or {}
                def _setter(key, value):
                    sagemaker_pipeline_target[key] = value
                EventTargetSagemakerPipelineTargetArgs._configure(_setter, **sagemaker_pipeline_target)
            __props__.__dict__["sagemaker_pipeline_target"] = sagemaker_pipeline_target
            if sqs_target is not None and not isinstance(sqs_target, EventTargetSqsTargetArgs):
                sqs_target = sqs_target or {}
                def _setter(key, value):
                    sqs_target[key] = value
                EventTargetSqsTargetArgs._configure(_setter, **sqs_target)
