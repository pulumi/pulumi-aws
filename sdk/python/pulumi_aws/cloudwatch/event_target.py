...
class EventTargetArgs:
    def __init__(__self__, *,
                 ...
                 input_path: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the target.
        ...
        :param pulumi.Input[builtins.str] event_bus_name: The name or ARN of the event bus to associate with the rule.
        ...
        :param pulumi.Input[builtins.str] input: Valid JSON text passed to the target. Conflicts with `input_path` and `input_transformer`.
        :param pulumi.Input[builtins.str] input_path: The value of the [JSONPath](http://goessner.net/articles/JsonPath/) that is used for extracting part of the matched event when passing it to the target. Conflicts with `input` and `input_transformer`.
        ...
        :param pulumi.Input[builtins.str] target_id: The unique target assignment ID. If missing, will generate a random, unique id.
        """
    ...
    def input_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @input_path.setter
    def input_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EventTarget(pulumi.CustomResource):
    ...
    pulumi_type = "aws:cloudwatch/eventTarget:EventTarget"
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['EventTargetSagemakerPipelineTargetArgs', 'EventTargetSagemakerPipelineTargetArgsDict']] sagemaker_pipeline_target: Parameters used when you are using the rule to invoke an Amazon SageMaker AI Pipeline. Documented below. A maximum of 1 are allowed.
    ...
    def get(resource_name: str,
            ...
            sagemaker_pipeline_target: Optional[pulumi.Input[Union['EventTargetSagemakerPipelineTargetArgs', 'EventTargetSagemakerPipelineTargetArgsDict']]] = None,
            sqs_target: Optional[pulumi.Input[Union['EventTargetSqsTargetArgs', 'EventTargetSqsTargetArgsDict']]] = None,
            target_id: Optional[pulumi.Input[builtins.str]] = None) -> 'EventTarget':
        """
    ...
    @property
    @pulumi.getter(name="inputPath")
    def input_path(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The value of the [JSONPath](http://goessner.net/articles/JsonPath/) that is used for extracting part of the matched event when passing it to the target. Conflicts with `input` and `input_transformer`.
        """
        return pulumi.get(self, "input_path")
