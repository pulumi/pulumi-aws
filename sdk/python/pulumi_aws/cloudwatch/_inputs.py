...
if not MYPY:
    class CompositeAlarmActionsSuppressorArgsDict(TypedDict):
        alarm: pulumi.Input[builtins.str]
        """
        Can be an AlarmName or an Amazon Resource Name (ARN) from an existing alarm.
        """
        extension_period: pulumi.Input[builtins.int]
        """
        The maximum time in seconds that the composite alarm waits after suppressor alarm goes out of the `ALARM` state. After this time, the composite alarm performs its actions.
        """
        wait_period: pulumi.Input[builtins.int]
        """
...
class CompositeAlarmActionsSuppressorArgs:
    def __init__(__self__, *,
                 ...
                 wait_period: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] alarm: Can be an AlarmName or an Amazon Resource Name (ARN) from an existing alarm.
        :param pulumi.Input[builtins.int] extension_period: The maximum time in seconds that the composite alarm waits after suppressor alarm goes out of the `ALARM` state. After this time, the composite alarm performs its actions.
        :param pulumi.Input[builtins.int] wait_period: The maximum time in seconds that the composite alarm waits for the suppressor alarm to go into the `ALARM` state. After this time, the composite alarm performs its actions.
        """
    ...
    @property
    @pulumi.getter
    def alarm(self) -> pulumi.Input[builtins.str]:
        """
        Can be an AlarmName or an Amazon Resource Name (ARN) from an existing alarm.
        """
    ...
    @alarm.setter
    def alarm(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "alarm", value)

    @property
    @pulumi.getter(name="extensionPeriod")
    def extension_period(self) -> pulumi.Input[builtins.int]:
        """
        The maximum time in seconds that the composite alarm waits after suppressor alarm goes out of the `ALARM` state. After this time, the composite alarm performs its actions.
        """
    ...
    def extension_period(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "extension_period", value)

    @property
    @pulumi.getter(name="waitPeriod")
    def wait_period(self) -> pulumi.Input[builtins.int]:
        """
        The maximum time in seconds that the composite alarm waits for the suppressor alarm to go into the `ALARM` state. After this time, the composite alarm performs its actions.
        """
...
class EventConnectionAuthParametersApiKeyArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Header Name.
        :param pulumi.Input[builtins.str] value: Header Value. Created and stored in AWS Secrets Manager.
        """
...
class EventConnectionAuthParametersBasicArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] password: A password for the authorization. Created and stored in AWS Secrets Manager.
        :param pulumi.Input[builtins.str] username: A username for the authorization.
        """
...
if not MYPY:
    class EventConnectionAuthParametersInvocationHttpParametersBodyArgsDict(TypedDict):
        is_value_secret: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class EventConnectionAuthParametersInvocationHttpParametersBodyArgs:
    def __init__(__self__, *,
                 is_value_secret: Optional[pulumi.Input[builtins.bool]] = None,
                 key: Optional[pulumi.Input[builtins.str]] = None,
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] is_value_secret: Specified whether the value is secret.
        :param pulumi.Input[builtins.str] key: The key for the parameter.
        :param pulumi.Input[builtins.str] value: The value associated with the key. Created and stored in AWS Secrets Manager if is secret.
        """
    ...
    def is_value_secret(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specified whether the value is secret.
        """
    ...
    def is_value_secret(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class EventConnectionAuthParametersOauthArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] authorization_endpoint: The URL to the authorization endpoint.
        :param pulumi.Input[builtins.str] http_method: A password for the authorization. Created and stored in AWS Secrets Manager.
...
class EventConnectionAuthParametersOauthClientParametersArgs:
    def __init__(__self__, *,
                 ...
                 client_secret: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] client_id: The client ID for the credentials to use for authorization. Created and stored in AWS Secrets Manager.
        :param pulumi.Input[builtins.str] client_secret: The client secret for the credentials to use for authorization. Created and stored in AWS Secrets Manager.
        """
...
if not MYPY:
    class EventConnectionInvocationConnectivityParametersResourceParametersArgsDict(TypedDict):
        resource_configuration_arn: pulumi.Input[builtins.str]
        """
        ARN of the Amazon VPC Lattice resource configuration for the resource endpoint.
        """
        resource_association_arn: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class EventConnectionInvocationConnectivityParametersResourceParametersArgs:
    def __init__(__self__, *,
                 resource_configuration_arn: pulumi.Input[builtins.str],
                 resource_association_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] resource_configuration_arn: ARN of the Amazon VPC Lattice resource configuration for the resource endpoint.
        """
    ...
    def resource_configuration_arn(self) -> pulumi.Input[builtins.str]:
        """
        ARN of the Amazon VPC Lattice resource configuration for the resource endpoint.
        """
    ...
    def resource_configuration_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "resource_configuration_arn", value)

    @property
    @pulumi.getter(name="resourceAssociationArn")
    def resource_association_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "resource_association_arn")

    @resource_association_arn.setter
    def resource_association_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EventEndpointEventBusArgs:
    def __init__(__self__, *,
                 event_bus_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] event_bus_arn: The ARN of the event bus the endpoint is associated with.
        """
...
class EventEndpointReplicationConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] state: The state of event replication. Valid values: `ENABLED`, `DISABLED`. The default state is `ENABLED`, which means you must supply a `role_arn`. If you don't have a `role_arn` or you don't want event replication enabled, set `state` to `DISABLED`.
        """
...
class EventEndpointRoutingConfigFailoverConfigPrimaryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] health_check: The ARN of the health check used by the endpoint to determine whether failover is triggered.
        """
...
class EventEndpointRoutingConfigFailoverConfigSecondaryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] route: The name of the secondary Region.
        """
...
class EventPermissionConditionArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] key: Key for the condition. Valid values: `aws:PrincipalOrgID`.
        :param pulumi.Input[builtins.str] type: Type of condition. Value values: `StringEquals`.
        :param pulumi.Input[builtins.str] value: Value for the key.
        """
        pulumi.set(__self__, "key", key)
...
if not MYPY:
    class EventTargetAppsyncTargetArgsDict(TypedDict):
        graphql_operation: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EventTargetAppsyncTargetArgs:
    def __init__(__self__, *,
                 graphql_operation: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] graphql_operation: Contains the GraphQL mutation to be parsed and executed.
        """
    ...
    def graphql_operation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Contains the GraphQL mutation to be parsed and executed.
        """
    ...
    def graphql_operation(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EventTargetBatchTargetArgsDict(TypedDict):
        ...
        """
        array_size: NotRequired[pulumi.Input[builtins.int]]
        """
        The size of the array, if this is an array batch job. Valid values are integers between 2 and 10,000.
        """
        job_attempts: NotRequired[pulumi.Input[builtins.int]]
        """
...
class EventTargetBatchTargetArgs:
    def __init__(__self__, *,
                 job_definition: pulumi.Input[builtins.str],
                 job_name: pulumi.Input[builtins.str],
                 array_size: Optional[pulumi.Input[builtins.int]] = None,
                 job_attempts: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] job_definition: The ARN or name of the job definition to use if the event target is an AWS Batch job. This job definition must already exist.
        :param pulumi.Input[builtins.str] job_name: The name to use for this execution of the job, if the target is an AWS Batch job.
        :param pulumi.Input[builtins.int] array_size: The size of the array, if this is an array batch job. Valid values are integers between 2 and 10,000.
        :param pulumi.Input[builtins.int] job_attempts: The number of times to attempt to retry, if the job fails. Valid values are 1 to 10.
        """
    ...
    def array_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The size of the array, if this is an array batch job. Valid values are integers between 2 and 10,000.
        """
    ...
    @array_size.setter
    def array_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "array_size", value)

    @property
    @pulumi.getter(name="jobAttempts")
    def job_attempts(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of times to attempt to retry, if the job fails. Valid values are 1 to 10.
        """
    ...
    @job_attempts.setter
    def job_attempts(self, value: Optional[pulumi.Input[builtins.int]]):
...
class EventTargetDeadLetterConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] arn: ARN of the SQS queue specified as the target for the dead-letter queue.
        """
        if arn is not None:
...
class EventTargetEcsTargetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] task_definition_arn: The ARN of the task definition to use if the event target is an Amazon ECS cluster.
        ...
        :param pulumi.Input[builtins.bool] enable_ecs_managed_tags: Specifies whether to enable Amazon ECS managed tags for the task.
        :param pulumi.Input[builtins.bool] enable_execute_command: Whether or not to enable the execute command functionality for the containers in this task. If true, this enables execute command functionality on all containers in the task.
        :param pulumi.Input[builtins.str] group: Specifies an ECS task group for the task. The maximum length is 255 characters.
        :param pulumi.Input[builtins.str] launch_type: Specifies the launch type on which your task is running. The launch type that you specify here must match one of the launch type (compatibilities) of the target task. Valid values include: `EC2`, `EXTERNAL`, or `FARGATE`.
        ...
        :param pulumi.Input[builtins.str] platform_version: Specifies the platform version for the task. Specify only the numeric portion of the platform version, such as `1.1.0`. This is used only if LaunchType is FARGATE. For more information about valid platform versions, see [AWS Fargate Platform Versions](http://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html).
        :param pulumi.Input[builtins.str] propagate_tags: Specifies whether to propagate the tags from the task definition to the task. If no value is specified, the tags are not propagated. Tags can only be propagated to the task during task creation. The only valid value is: `TASK_DEFINITION`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to ecs resources.
        :param pulumi.Input[builtins.int] task_count: The number of tasks to create based on the TaskDefinition. Defaults to `1`.
        """
...
class EventTargetEcsTargetCapacityProviderStrategyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] base: The base value designates how many tasks, at a minimum, to run on the specified capacity provider. Only one capacity provider in a capacity provider strategy can have a base defined. Defaults to `0`.
...
class EventTargetEcsTargetNetworkConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: The subnets associated with the task or service.
        :param pulumi.Input[builtins.bool] assign_public_ip: Assign a public IP address to the ENI (Fargate launch type only). Valid values are `true` or `false`. Defaults to `false`.
               
               For more information, see [Task Networking](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task-networking.html)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: The security groups associated with the task or service. If you do not specify a security group, the default security group for the VPC is used.
        """
...
class EventTargetEcsTargetOrderedPlacementStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Type of placement strategy. The only valid values at this time are `binpack`, `random` and `spread`.
...
if not MYPY:
    class EventTargetHttpTargetArgsDict(TypedDict):
        ...
        """
        path_parameter_values: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class EventTargetHttpTargetArgs:
    def __init__(__self__, *,
                 ...
                 path_parameter_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 query_string_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] header_parameters: Enables you to specify HTTP headers to add to the request.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] path_parameter_values: The list of values that correspond sequentially to any path variables in your endpoint ARN (for example `arn:aws:execute-api:us-east-1:123456:myapi/*/POST/pets/*`).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] query_string_parameters: Represents keys/values of query string parameters that are appended to the invoked endpoint.
        """
    ...
    def path_parameter_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of values that correspond sequentially to any path variables in your endpoint ARN (for example `arn:aws:execute-api:us-east-1:123456:myapi/*/POST/pets/*`).
        """
    ...
    def path_parameter_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class EventTargetInputTransformerArgsDict(TypedDict):
        input_template: pulumi.Input[builtins.str]
        """
        ...
        """
        input_paths: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class EventTargetInputTransformerArgs:
    def __init__(__self__, *,
                 input_template: pulumi.Input[builtins.str],
                 input_paths: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] input_template: Template to customize data sent to the target. Must be valid JSON. To send a string value, the string value must include double quotes.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] input_paths: Key value pairs specified in the form of JSONPath (for example, time = $.time)
               * You can have as many as 100 key-value pairs.
               * You must use JSON dot notation, not bracket notation.
               * The keys can't start with "AWS".
        """
    ...
    def input_template(self) -> pulumi.Input[builtins.str]:
        """
        Template to customize data sent to the target. Must be valid JSON. To send a string value, the string value must include double quotes.
        """
    ...
    def input_template(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "input_template", value)

    @property
    @pulumi.getter(name="inputPaths")
    def input_paths(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Key value pairs specified in the form of JSONPath (for example, time = $.time)
        * You can have as many as 100 key-value pairs.
        * You must use JSON dot notation, not bracket notation.
    ...
    @input_paths.setter
    def input_paths(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "input_paths", value)


if not MYPY:
    class EventTargetKinesisTargetArgsDict(TypedDict):
        partition_key_path: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EventTargetKinesisTargetArgs:
    def __init__(__self__, *,
                 partition_key_path: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] partition_key_path: The JSON path to be extracted from the event and used as the partition key.
        """
    ...
    def partition_key_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The JSON path to be extracted from the event and used as the partition key.
        """
    ...
    def partition_key_path(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EventTargetRedshiftTargetArgsDict(TypedDict):
        ...
        """
        secrets_manager_arn: NotRequired[pulumi.Input[builtins.str]]
        """
        The name or ARN of the secret that enables access to the database.
        """
        sql: NotRequired[pulumi.Input[builtins.str]]
        """
...
class EventTargetRedshiftTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] secrets_manager_arn: The name or ARN of the secret that enables access to the database.
        :param pulumi.Input[builtins.str] sql: The SQL statement text to run.
        :param pulumi.Input[builtins.str] statement_name: The name of the SQL statement.
    ...
    def secrets_manager_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name or ARN of the secret that enables access to the database.
        """
    ...
    def secrets_manager_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class EventTargetRetryPolicyArgsDict(TypedDict):
        maximum_event_age_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class EventTargetRetryPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] maximum_event_age_in_seconds: The age in seconds to continue to make retry attempts.
        :param pulumi.Input[builtins.int] maximum_retry_attempts: maximum number of retry attempts to make before the request fails
        """
...
class EventTargetRunCommandTargetArgs:
    def __init__(__self__, *,
                 ...
                 values: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] key: Can be either `tag:tag-key` or `InstanceIds`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: If Key is `tag:tag-key`, Values is a list of tag values. If Key is `InstanceIds`, Values is a list of Amazon EC2 instance IDs.
        """
        pulumi.set(__self__, "key", key)
...
class EventTargetSagemakerPipelineTargetPipelineParameterListArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Name of parameter to start execution of a SageMaker AI Model Building Pipeline.
        :param pulumi.Input[builtins.str] value: Value of parameter to start execution of a SageMaker AI Model Building Pipeline.
        """
...
class InternetMonitorHealthEventsConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] availability_score_threshold: The health event threshold percentage set for availability scores.
        :param pulumi.Input[builtins.float] performance_score_threshold: The health event threshold percentage set for performance scores.
        """
...
if not MYPY:
    class InternetMonitorInternetMeasurementsLogDeliveryS3ConfigArgsDict(TypedDict):
        ...
        log_delivery_status: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class InternetMonitorInternetMeasurementsLogDeliveryS3ConfigArgs:
    def __init__(__self__, *,
                 ...
                 log_delivery_status: Optional[pulumi.Input[builtins.str]] = None):
...
class LogDeliveryDestinationDeliveryDestinationConfigurationArgs:
    def __init__(__self__, *,
                 destination_resource_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] destination_resource_arn: The ARN of the AWS destination that this delivery destination represents.
        """
        pulumi.set(__self__, "destination_resource_arn", destination_resource_arn)

    @property
    @pulumi.getter(name="destinationResourceArn")
    def destination_resource_arn(self) -> pulumi.Input[builtins.str]:
        """
        The ARN of the AWS destination that this delivery destination represents.
        """
    ...
    def destination_resource_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_resource_arn", value)


if not MYPY:
    class LogDeliveryS3DeliveryConfigurationArgsDict(TypedDict):
        enable_hive_compatible_path: pulumi.Input[builtins.bool]
        """
        This parameter causes the S3 objects that contain delivered logs to use a prefix structure that allows for integration with Apache Hive.
        """
        suffix_path: pulumi.Input[builtins.str]
        """
...
class LogDeliveryS3DeliveryConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 suffix_path: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.bool] enable_hive_compatible_path: This parameter causes the S3 objects that contain delivered logs to use a prefix structure that allows for integration with Apache Hive.
        :param pulumi.Input[builtins.str] suffix_path: This string allows re-configuring the S3 object prefix to contain either static or variable sections. The valid variables to use in the suffix path will vary by each log source.
        """
    ...
    def enable_hive_compatible_path(self) -> pulumi.Input[builtins.bool]:
        """
        This parameter causes the S3 objects that contain delivered logs to use a prefix structure that allows for integration with Apache Hive.
        """
    ...
    def enable_hive_compatible_path(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "enable_hive_compatible_path", value)

    @property
    @pulumi.getter(name="suffixPath")
    def suffix_path(self) -> pulumi.Input[builtins.str]:
        """
        This string allows re-configuring the S3 object prefix to contain either static or variable sections. The valid variables to use in the suffix path will vary by each log source.
        """
    ...
    @suffix_path.setter
    def suffix_path(self, value: pulumi.Input[builtins.str]):
...
class LogMetricFilterMetricTransformationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the CloudWatch metric to which the monitored log information should be published (e.g., `ErrorCount`)
        :param pulumi.Input[builtins.str] namespace: The destination namespace of the CloudWatch metric.
        :param pulumi.Input[builtins.str] value: What to publish to the metric. For example, if you're counting the occurrences of a particular term like "Error", the value will be "1" for each occurrence. If you're counting the bytes transferred the published value will be the value in the log event.
        :param pulumi.Input[builtins.str] default_value: The value to emit when a filter pattern does not match a log event. Conflicts with `dimensions`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] dimensions: Map of fields to use as dimensions for the metric. Up to 3 dimensions are allowed. Conflicts with `default_value`.
        :param pulumi.Input[builtins.str] unit: The unit to assign to the metric. If you omit this, the unit is set as `None`.
        """
        pulumi.set(__self__, "name", name)
...
class MetricAlarmMetricQueryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: A short name used to tie this object to the results in the response. If you are performing math expressions on this set of data, this name represents that data and can serve as a variable in the mathematical expression. The valid characters are letters, numbers, and underscore. The first character must be a lowercase letter.
        ...
        :param pulumi.Input[builtins.str] expression: The math expression to be performed on the returned data, if this object is performing a math expression. This expression can use the id of the other metrics to refer to those metrics, and can also use the id of other expressions to use the result of those expressions. For more information about metric math expressions, see Metric Math Syntax and Functions in the [Amazon CloudWatch User Guide](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/using-metric-math.html#metric-math-syntax).
        :param pulumi.Input[builtins.str] label: A human-readable label for this metric or expression. This is especially useful if this is an expression, so that you know what the value represents.
...
class MetricAlarmMetricQueryMetricArgs:
    def __init__(__self__, *,
                 ...
                 unit: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] metric_name: The name for this metric.
               See docs for [supported metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/CW_Support_For_AWS.html).
        :param pulumi.Input[builtins.int] period: Granularity in seconds of returned data points.
               For metrics with regular resolution, valid values are any multiple of `60`.
               For high-resolution metrics, valid values are `1`, `5`, `10`, `30`, or any multiple of `60`.
        ...
        :param pulumi.Input[builtins.str] namespace: The namespace for this metric. See docs for the [list of namespaces](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/aws-namespaces.html).
               See docs for [supported metrics](https://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/CW_Support_For_AWS.html).
        :param pulumi.Input[builtins.str] unit: The unit for this metric.
        """
...
if not MYPY:
    class MetricStreamExcludeFilterArgsDict(TypedDict):
        ...
        """
        metric_names: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class MetricStreamExcludeFilterArgs:
    def __init__(__self__, *,
                 namespace: pulumi.Input[builtins.str],
                 metric_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] namespace: Name of the metric namespace in the filter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] metric_names: An array that defines the metrics you want to exclude for this metric namespace
        """
        pulumi.set(__self__, "namespace", namespace)
    ...
    def metric_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        An array that defines the metrics you want to exclude for this metric namespace
        """
    ...
    @metric_names.setter
    def metric_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class MetricStreamIncludeFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] namespace: Name of the metric namespace in the filter.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] metric_names: An array that defines the metrics you want to include for this metric namespace
        """
        pulumi.set(__self__, "namespace", namespace)
        if metric_names is not None:
            pulumi.set(__self__, "metric_names", metric_names)
...
if not MYPY:
    class MetricStreamStatisticsConfigurationArgsDict(TypedDict):
        additional_statistics: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class MetricStreamStatisticsConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_statistics: The additional statistics to stream for the metrics listed in `include_metrics`.
    ...
    def additional_statistics(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The additional statistics to stream for the metrics listed in `include_metrics`.
        """
    ...
    def additional_statistics(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class GetLogDataProtectionPolicyDocumentConfigurationCustomDataIdentifierArgs:
    def __init__(__self__, *,
                 ...
                 regex: builtins.str):
        """
        :param builtins.str name: Name of the custom data idenfitier
        :param builtins.str regex: Regular expression to match sensitive data
        """
        pulumi.set(__self__, "name", name)
...
class GetLogDataProtectionPolicyDocumentStatementArgs:
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] data_identifiers: Set of at least 1 sensitive data identifiers that you want to mask. Read more in [Types of data that you can protect](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/protect-sensitive-log-data-types.html).
        ...
        :param builtins.str sid: Name of this statement.
        """
    ...
    def data_identifiers(self) -> Sequence[builtins.str]:
        """
        Set of at least 1 sensitive data identifiers that you want to mask. Read more in [Types of data that you can protect](https://docs.aws.amazon.com/AmazonCloudWatch/latest/logs/protect-sensitive-log-data-types.html).
        """
    ...
    def data_identifiers(self, value: Sequence[builtins.str]):
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationCloudwatchLogsArgs:
    def __init__(__self__, *,
                 log_group: builtins.str):
        """
        :param builtins.str log_group: Name of the CloudWatch Log Group to send findings to.
        """
    ...
    @log_group.setter
    def log_group(self, value: builtins.str):
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationFirehoseArgs:
    def __init__(__self__, *,
                 delivery_stream: builtins.str):
        """
        :param builtins.str delivery_stream: Name of the Kinesis Firehose Delivery Stream to send findings to.
        """
    ...
    def delivery_stream(self, value: builtins.str):
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditFindingsDestinationS3Args:
    def __init__(__self__, *,
                 bucket: builtins.str):
        """
        :param builtins.str bucket: Name of the S3 Bucket to send findings to.
        """
    ...
    @bucket.setter
    def bucket(self, value: builtins.str):
