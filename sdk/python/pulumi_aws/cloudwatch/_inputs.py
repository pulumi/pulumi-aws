...
class CompositeAlarmActionsSuppressorArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'extensionPeriod' in kwargs:
            extension_period = kwargs['extensionPeriod']
        if 'waitPeriod' in kwargs:
...
class EventConnectionAuthParametersArgs:
    ...
    def _configure(
        ...
        if 'invocationHttpParameters' in kwargs:
...
class EventTargetEcsTargetArgs:
    ...
    def _configure(
        ...
        if 'orderedPlacementStrategies' in kwargs:
...
class EventTargetSagemakerPipelineTargetArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'pipelineParameterLists' in kwargs:
...
class GetLogDataProtectionPolicyDocumentStatementOperationAuditArgs:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'findingsDestination' in kwargs:
