...
class ContributorInsightRuleArgs:
    def __init__(__self__, *,
                 rule_definition: pulumi.Input[str],
        ...
        :param pulumi.Input[str] rule_definition: Definition of the rule, as a JSON object. For details on the valid syntax, see [Contributor Insights Rule Syntax](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/ContributorInsights-RuleSyntax.html).
        :param pulumi.Input[str] rule_name: Unique name of the rule.
               
               The following arguments are optional:
        :param pulumi.Input[str] rule_state: State of the rule. Valid values are `ENABLED` and `DISABLED`.
        """
    ...
    def rule_definition(self) -> pulumi.Input[str]:
        """
    ...
    def rule_definition(self, value: pulumi.Input[str]):
    ...
    def rule_state(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @rule_state.setter
    def rule_state(self, value: Optional[pulumi.Input[str]]):
...
class _ContributorInsightRuleState:
    def __init__(__self__, *,
                 ...
                 rule_definition: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] resource_arn: ARN of the Contributor Insight Rule.
        :param pulumi.Input[str] rule_definition: Definition of the rule, as a JSON object. For details on the valid syntax, see [Contributor Insights Rule Syntax](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/ContributorInsights-RuleSyntax.html).
        :param pulumi.Input[str] rule_name: Unique name of the rule.
    ...
    @property
    @pulumi.getter(name="ruleDefinition")
    def rule_definition(self) -> Optional[pulumi.Input[str]]:
        """
        Definition of the rule, as a JSON object. For details on the valid syntax, see [Contributor Insights Rule Syntax](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/ContributorInsights-RuleSyntax.html).
        """
        return pulumi.get(self, "rule_definition")
    ...
    @rule_definition.setter
    def rule_definition(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "rule_definition", value)
...
class ContributorInsightRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rule_state: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None) -> 'ContributorInsightRule':
        """
    ...
    @property
    @pulumi.getter(name="ruleDefinition")
    def rule_definition(self) -> pulumi.Output[str]:
        """
        Definition of the rule, as a JSON object. For details on the valid syntax, see [Contributor Insights Rule Syntax](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/ContributorInsights-RuleSyntax.html).
        """
        return pulumi.get(self, "rule_definition")
