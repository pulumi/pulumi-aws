...
class LogDeliveryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] delivery_destination_arn: The ARN of the delivery destination to use for this delivery.
...
class _LogDeliveryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the delivery.
        :param pulumi.Input[builtins.str] delivery_destination_arn: The ARN of the delivery destination to use for this delivery.
        :param pulumi.Input[builtins.str] delivery_source_name: The name of the delivery source to use for this delivery.
        :param pulumi.Input[builtins.str] field_delimiter: The field delimiter to use between record fields when the final output format of a delivery is in `plain`, `w3c`, or `raw` format.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] record_fields: The list of record fields to be delivered to the destination, in order.
    ...
    @property
    @pulumi.getter(name="deliveryDestinationArn")
    def delivery_destination_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ARN of the delivery destination to use for this delivery.
        """
        return pulumi.get(self, "delivery_destination_arn")
    ...
    @delivery_destination_arn.setter
    def delivery_destination_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_destination_arn", value)

    @property
    @pulumi.getter(name="deliverySourceName")
    def delivery_source_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the delivery source to use for this delivery.
        """
        return pulumi.get(self, "delivery_source_name")
    ...
    @delivery_source_name.setter
    def delivery_source_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_source_name", value)
...
class LogDelivery(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="recordFields")
    def record_fields(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of record fields to be delivered to the destination, in order.
        """
        return pulumi.get(self, "record_fields")
