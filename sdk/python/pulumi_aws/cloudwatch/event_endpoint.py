...
class EventEndpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            replication_config = _utilities.configure(replication_config, EventEndpointReplicationConfigArgs, True)
            __props__.__dict__["replication_config"] = replication_config
            __props__.__dict__["role_arn"] = role_arn
            routing_config = _utilities.configure(routing_config, EventEndpointRoutingConfigArgs, True)
