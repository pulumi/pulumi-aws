...
if not MYPY:
    class VaultNotificationArgsDict(TypedDict):
        ...
        """
        sns_topic: pulumi.Input[builtins.str]
        """
        The SNS Topic ARN.
        """
elif False:
...
class VaultNotificationArgs:
    def __init__(__self__, *,
                 ...
                 sns_topic: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: You can configure a vault to publish a notification for `ArchiveRetrievalCompleted` and `InventoryRetrievalCompleted` events.
        :param pulumi.Input[builtins.str] sns_topic: The SNS Topic ARN.
        """
    ...
    def sns_topic(self) -> pulumi.Input[builtins.str]:
        """
        The SNS Topic ARN.
        """
    ...
    @sns_topic.setter
    def sns_topic(self, value: pulumi.Input[builtins.str]):
