...
class Host(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if vpc_configuration is not None and not isinstance(vpc_configuration, HostVpcConfigurationArgs):
                vpc_configuration = vpc_configuration or {}
                def _setter(key, value):
                    vpc_configuration[key] = value
                HostVpcConfigurationArgs._configure(_setter, **vpc_configuration)
