...
class HostArgs:
    ...
    def provider_endpoint(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def provider_endpoint(self, value: pulumi.Input[builtins.str]):
...
class _HostState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The CodeStar Host ARN.
        :param pulumi.Input[builtins.str] name: The name of the host to be created. The name must be unique in the calling AWS account.
        :param pulumi.Input[builtins.str] provider_endpoint: The endpoint of the infrastructure to be represented by the host after it is created.
        :param pulumi.Input[builtins.str] provider_type: The name of the external provider where your third-party code repository is configured.
    ...
    @property
    @pulumi.getter(name="providerEndpoint")
    def provider_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The endpoint of the infrastructure to be represented by the host after it is created.
        """
        return pulumi.get(self, "provider_endpoint")
    ...
    @provider_endpoint.setter
    def provider_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provider_endpoint", value)
...
class Host(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="providerEndpoint")
    def provider_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The endpoint of the infrastructure to be represented by the host after it is created.
        """
        return pulumi.get(self, "provider_endpoint")
