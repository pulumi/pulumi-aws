...
def get_models(by_customization_type: Optional[_builtins.str] = None,
               by_inference_type: Optional[_builtins.str] = None,
               by_output_modality: Optional[_builtins.str] = None,
               by_provider: Optional[_builtins.str] = None,
