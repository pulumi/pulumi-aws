...
class LustreFileSystem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            log_configuration = _utilities.configure(log_configuration, LustreFileSystemLogConfigurationArgs, True)
            ...
            root_squash_configuration = _utilities.configure(root_squash_configuration, LustreFileSystemRootSquashConfigurationArgs, True)
