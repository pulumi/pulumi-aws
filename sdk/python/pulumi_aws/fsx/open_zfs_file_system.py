...
class OpenZfsFileSystem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            disk_iops_configuration = _utilities.configure(disk_iops_configuration, OpenZfsFileSystemDiskIopsConfigurationArgs, True)
            ...
            root_volume_configuration = _utilities.configure(root_volume_configuration, OpenZfsFileSystemRootVolumeConfigurationArgs, True)
