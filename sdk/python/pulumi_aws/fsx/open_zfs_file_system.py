...
class OpenZfsFileSystemArgs:
    def __init__(__self__, *,
        ...
        """
        OpenZfsFileSystemArgs._configure(
...
class _OpenZfsFileSystemState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] weekly_maintenance_start_time: The preferred start time (in `d:HH:MM` format) to perform weekly maintenance, in the UTC time zone.
        """
        _OpenZfsFileSystemState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            arn=arn,
            automatic_backup_retention_days=automatic_backup_retention_days,
            backup_id=backup_id,
    ...
    def _configure(
        ...
        if root_volume_configuration is None and 'rootVolumeConfiguration' in kwargs:
            root_volume_configuration = kwargs['rootVolumeConfiguration']
        if root_volume_id is None and 'rootVolumeId' in kwargs:
...
class OpenZfsFileSystem(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            OpenZfsFileSystemArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if disk_iops_configuration is not None and not isinstance(disk_iops_configuration, OpenZfsFileSystemDiskIopsConfigurationArgs):
                disk_iops_configuration = disk_iops_configuration or {}
                def _setter(key, value):
                    disk_iops_configuration[key] = value
                OpenZfsFileSystemDiskIopsConfigurationArgs._configure(_setter, **disk_iops_configuration)
            ...
            if root_volume_configuration is not None and not isinstance(root_volume_configuration, OpenZfsFileSystemRootVolumeConfigurationArgs):
                root_volume_configuration = root_volume_configuration or {}
                def _setter(key, value):
                    root_volume_configuration[key] = value
                OpenZfsFileSystemRootVolumeConfigurationArgs._configure(_setter, **root_volume_configuration)
