...
class OpenZfsFileSystemArgs:
    def __init__(__self__, *,
                 ...
                 copy_tags_to_volumes: Optional[pulumi.Input[builtins.bool]] = None,
                 daily_automatic_backup_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 delete_options: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] deployment_type: Filesystem deployment type. See the [AWS API documentation](https://docs.aws.amazon.com/fsx/latest/APIReference/API_CreateFileSystemOpenZFSConfiguration.html#FSx-Type-CreateFileSystemOpenZFSConfiguration-DeploymentType) for a list of valid values.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A list of IDs for the subnets that the file system will be accessible from.
        :param pulumi.Input[builtins.int] throughput_capacity: Throughput (MB/s) of the file system. Valid values depend on `deployment_type`. Must be one of `64`, `128`, `256`, `512`, `1024`, `2048`, `3072`, `4096` for `SINGLE_AZ_1`. Must be one of `160`, `320`, `640`, `1280`, `2560`, `3840`, `5120`, `7680`, `10240` for `SINGLE_AZ_2`.
        ...
        :param pulumi.Input[builtins.bool] copy_tags_to_backups: A boolean flag indicating whether tags for the file system should be copied to backups. The default value is false.
        :param pulumi.Input[builtins.bool] copy_tags_to_volumes: A boolean flag indicating whether tags for the file system should be copied to snapshots. The default value is false.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] delete_options: List of delete options, which at present supports only one value that specifies whether to delete all child volumes and snapshots when the file system is deleted. Valid values: `DELETE_CHILD_VOLUMES_AND_SNAPSHOTS`.
        ...
        :param pulumi.Input[builtins.str] endpoint_ip_address_range: (Multi-AZ only) Specifies the IP address range in which the endpoints to access your file system will be created.
        ...
        :param pulumi.Input[builtins.int] storage_capacity: The storage capacity (GiB) of the file system. Valid values between `64` and `524288`.
        :param pulumi.Input[builtins.str] storage_type: The filesystem storage type. Only `SSD` is supported.
    ...
    def copy_tags_to_volumes(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def copy_tags_to_volumes(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def delete_options(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def delete_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _OpenZfsFileSystemState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_ip_address: IP address of the endpoint that is used to access data or to manage the file system.
        :param pulumi.Input[builtins.str] endpoint_ip_address_range: (Multi-AZ only) Specifies the IP address range in which the endpoints to access your file system will be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] final_backup_tags: A map of tags to apply to the file system's final backup.
        :param pulumi.Input[builtins.str] kms_key_id: ARN for the KMS Key to encrypt the file system at rest, Defaults to an AWS managed KMS Key.
...
class OpenZfsFileSystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            throughput_capacity: Optional[pulumi.Input[builtins.int]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            weekly_maintenance_start_time: Optional[pulumi.Input[builtins.str]] = None) -> 'OpenZfsFileSystem':
        """
    ...
    @property
    @pulumi.getter(name="copyTagsToVolumes")
    def copy_tags_to_volumes(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean flag indicating whether tags for the file system should be copied to snapshots. The default value is false.
        """
        return pulumi.get(self, "copy_tags_to_volumes")
    ...
    @property
    @pulumi.getter(name="deleteOptions")
    def delete_options(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        List of delete options, which at present supports only one value that specifies whether to delete all child volumes and snapshots when the file system is deleted. Valid values: `DELETE_CHILD_VOLUMES_AND_SNAPSHOTS`.
        """
        return pulumi.get(self, "delete_options")
    ...
    @property
    @pulumi.getter(name="endpointIpAddress")
    def endpoint_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        IP address of the endpoint that is used to access data or to manage the file system.
        """
        return pulumi.get(self, "endpoint_ip_address")
    ...
    @property
    @pulumi.getter(name="preferredSubnetId")
    def preferred_subnet_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Multi-AZ only) Required when `deployment_type` is set to `MULTI_AZ_1`. This specifies the subnet in which you want the preferred file server to be located.
        """
        return pulumi.get(self, "preferred_subnet_id")
