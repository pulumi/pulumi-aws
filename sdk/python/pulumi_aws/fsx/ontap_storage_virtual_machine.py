...
class OntapStorageVirtualMachine(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if active_directory_configuration is not None and not isinstance(active_directory_configuration, OntapStorageVirtualMachineActiveDirectoryConfigurationArgs):
                active_directory_configuration = active_directory_configuration or {}
                def _setter(key, value):
                    active_directory_configuration[key] = value
                OntapStorageVirtualMachineActiveDirectoryConfigurationArgs._configure(_setter, **active_directory_configuration)
