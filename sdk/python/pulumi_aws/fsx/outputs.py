...
class DataRepositoryAssociationS3AutoExportPolicy(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] events: A list of file event types to automatically export to your linked S3 bucket or import from the linked S3 bucket. Valid values are `NEW`, `CHANGED`, `DELETED`. Max of 3.
        """
...
class FileCacheDataRepositoryAssociation(dict):
    ...
    def __init__(__self__, *,
                 ...
                 data_repository_subdirectories: Optional[Sequence[builtins.str]] = None,
                 file_cache_id: Optional[builtins.str] = None,
                 file_system_id: Optional[builtins.str] = None,
                 file_system_path: Optional[builtins.str] = None,
                 imported_file_chunk_size: Optional[builtins.int] = None,
                 nfs: Optional[Sequence['outputs.FileCacheDataRepositoryAssociationNf']] = None,
                 resource_arn: Optional[builtins.str] = None,
                 tags: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str data_repository_path: The path to the S3 or NFS data repository that links to the cache.
        :param builtins.str file_cache_path: A path on the cache that points to a high-level directory (such as /ns1/) or subdirectory (such as /ns1/subdir/) that will be mapped 1-1 with DataRepositoryPath. The leading forward slash in the name is required. Two data repository associations cannot have overlapping cache paths. For example, if a data repository is associated with cache path /ns1/, then you cannot link another data repository with cache path /ns1/ns2. This path specifies where in your cache files will be exported from. This cache directory can be linked to only one data repository, and no data repository other can be linked to the directory. Note: The cache path can only be set to root (/) on an NFS DRA when DataRepositorySubdirectories is specified. If you specify root (/) as the cache path, you can create only one DRA on the cache. The cache path cannot be set to root (/) for an S3 DRA.
        :param Sequence[builtins.str] data_repository_subdirectories: A list of NFS Exports that will be linked with this data repository association. The Export paths are in the format /exportpath1. To use this parameter, you must configure DataRepositoryPath as the domain name of the NFS file system. The NFS file system domain name in effect is the root of the subdirectories. Note that DataRepositorySubdirectories is not supported for S3 data repositories. Max of 500.
        :param builtins.str file_cache_id: The system-generated, unique ID of the cache.
        :param Sequence['FileCacheDataRepositoryAssociationNfArgs'] nfs: (Optional) See the `nfs` configuration block.
        :param Mapping[str, builtins.str] tags: A map of tags to assign to the file cache. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
    ...
    def data_repository_subdirectories(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def file_cache_id(self) -> Optional[builtins.str]:
        """
...
class FileCacheDataRepositoryAssociationNf(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str version: The version of the NFS (Network File System) protocol of the NFS data repository. The only supported value is NFS3, which indicates that the data repository must support the NFSv3 protocol. The only supported value is `NFS3`.
        :param Sequence[builtins.str] dns_ips: A list of up to 2 IP addresses of DNS servers used to resolve the NFS file system domain name. The provided IP addresses can either be the IP addresses of a DNS forwarder or resolver that the customer manages and runs inside the customer VPC, or the IP addresses of the on-premises DNS servers.
        """
...
class FileCacheLustreConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 weekly_maintenance_start_time: Optional[builtins.str] = None):
        """
        :param builtins.str deployment_type: Specifies the cache deployment type. The only supported value is `CACHE_1`.
        ...
        :param builtins.int per_unit_storage_throughput: Provisions the amount of read and write throughput for each 1 tebibyte (TiB) of cache storage capacity, in MB/s/TiB. The only supported value is `1000`.
        :param builtins.str weekly_maintenance_start_time: A recurring weekly time, in the format `D:HH:MM`. `D` is the day of the week, for which `1` represents Monday and `7` represents Sunday. `HH` is the zero-padded hour of the day (0-23), and `MM` is the zero-padded minute of the hour. For example, 1:05:00 specifies maintenance at 5 AM Monday. See the [ISO week date](https://en.wikipedia.org/wiki/ISO_week_date) for more information.
        """
    ...
    def weekly_maintenance_start_time(self) -> Optional[builtins.str]:
        """
        A recurring weekly time, in the format `D:HH:MM`. `D` is the day of the week, for which `1` represents Monday and `7` represents Sunday. `HH` is the zero-padded hour of the day (0-23), and `MM` is the zero-padded minute of the hour. For example, 1:05:00 specifies maintenance at 5 AM Monday. See the [ISO week date](https://en.wikipedia.org/wiki/ISO_week_date) for more information.
        """
...
class FileCacheLustreConfigurationMetadataConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int storage_capacity: The storage capacity of the Lustre MDT (Metadata Target) storage volume in gibibytes (GiB). The only supported value is `2400` GiB.
        """
...
class LustreFileSystemLogConfiguration(dict):
    def __init__(__self__, *,
                 ...
                 level: Optional[builtins.str] = None):
        """
        :param builtins.str destination: The Amazon Resource Name (ARN) that specifies the destination of the logs. The name of the Amazon CloudWatch Logs log group must begin with the `/aws/fsx` prefix. If you do not provide a destination, Amazon FSx will create and use a log stream in the CloudWatch Logs `/aws/fsx/lustre` log group.
        :param builtins.str level: Sets which data repository events are logged by Amazon FSx. Valid values are `WARN_ONLY`, `FAILURE_ONLY`, `ERROR_ONLY`, `WARN_ERROR` and `DISABLED`. Default value is `DISABLED`.
        """
        if destination is not None:
            pulumi.set(__self__, "destination", destination)
        if level is not None:
...
class LustreFileSystemRootSquashConfiguration(dict):
    ...
    def __init__(__self__, *,
                 no_squash_nids: Optional[Sequence[builtins.str]] = None,
                 root_squash: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] no_squash_nids: When root squash is enabled, you can optionally specify an array of NIDs of clients for which root squash does not apply. A client NID is a Lustre Network Identifier used to uniquely identify a client. You can specify the NID as either a single address or a range of addresses: 1. A single address is described in standard Lustre NID format by specifying the client’s IP address followed by the Lustre network ID (for example, 10.0.1.6@tcp). 2. An address range is described using a dash to separate the range (for example, 10.0.[2-10].[1-255]@tcp).
        :param builtins.str root_squash: You enable root squash by setting a user ID (UID) and group ID (GID) for the file system in the format UID:GID (for example, 365534:65534). The UID and GID values can range from 0 to 4294967294.
        """
    ...
    def no_squash_nids(self) -> Optional[Sequence[builtins.str]]:
        """
        When root squash is enabled, you can optionally specify an array of NIDs of clients for which root squash does not apply. A client NID is a Lustre Network Identifier used to uniquely identify a client. You can specify the NID as either a single address or a range of addresses: 1. A single address is described in standard Lustre NID format by specifying the client’s IP address followed by the Lustre network ID (for example, 10.0.1.6@tcp). 2. An address range is described using a dash to separate the range (for example, 10.0.[2-10].[1-255]@tcp).
        """
...
class OntapFileSystemDiskIopsConfiguration(dict):
    def __init__(__self__, *,
                 ...
                 mode: Optional[builtins.str] = None):
        """
        :param builtins.int iops: The total number of SSD IOPS provisioned for the file system.
        :param builtins.str mode: Specifies whether the number of IOPS for the file system is using the system. Valid values are `AUTOMATIC` and `USER_PROVISIONED`. Default value is `AUTOMATIC`.
        """
        if iops is not None:
            pulumi.set(__self__, "iops", iops)
        if mode is not None:
...
class OntapFileSystemEndpointIntercluster(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dns_name: The Domain Name Service (DNS) name for the file system. You can mount your file system using its DNS name.
        :param Sequence[builtins.str] ip_addresses: IP addresses of the file system endpoint.
        """
...
class OntapStorageVirtualMachineActiveDirectoryConfiguration(dict):
    ...
    def __init__(__self__, *,
                 netbios_name: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str netbios_name: The NetBIOS name of the Active Directory computer object that will be created for your SVM. This is often the same as the SVM name but can be different. AWS limits to 15 characters because of standard NetBIOS naming limits.
        """
    ...
    def netbios_name(self) -> Optional[builtins.str]:
        """
...
class OntapStorageVirtualMachineActiveDirectoryConfigurationSelfManagedActiveDirectoryConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 file_system_administrators_group: Optional[builtins.str] = None,
                 organizational_unit_distinguished_name: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] dns_ips: A list of up to three IP addresses of DNS servers or domain controllers in the self-managed AD directory.
        :param builtins.str domain_name: The fully qualified domain name of the self-managed AD directory. For example, `corp.example.com`.
        :param builtins.str password: The password for the service account on your self-managed AD domain that Amazon FSx will use to join to your AD domain.
        :param builtins.str username: The user name for the service account on your self-managed AD domain that Amazon FSx will use to join to your AD domain.
        :param builtins.str file_system_administrators_group: The name of the domain group whose members are granted administrative privileges for the SVM. The group that you specify must already exist in your domain. Defaults to `Domain Admins`.
        :param builtins.str organizational_unit_distinguished_name: The fully qualified distinguished name of the organizational unit within your self-managed AD directory that the Windows File Server instance will join. For example, `OU=FSx,DC=yourdomain,DC=corp,DC=com`. Only accepts OU as the direct parent of the SVM. If none is provided, the SVM is created in the default location of your self-managed AD directory. To learn more, see [RFC 2253](https://tools.ietf.org/html/rfc2253).
        """
        pulumi.set(__self__, "dns_ips", dns_ips)
    ...
    def file_system_administrators_group(self) -> Optional[builtins.str]:
        """
...
class OntapStorageVirtualMachineEndpointIscsi(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_addresses: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str dns_name: The Domain Name Service (DNS) name for the storage virtual machine. You can mount your storage virtual machine using its DNS name.
        :param Sequence[builtins.str] ip_addresses: IP addresses of the storage virtual machine endpoint.
        """
        if dns_name is not None:
            pulumi.set(__self__, "dns_name", dns_name)
        if ip_addresses is not None:
...
class OntapVolumeAggregateConfiguration(dict):
    ...
    def __init__(__self__, *,
                 aggregates: Optional[Sequence[builtins.str]] = None,
                 constituents_per_aggregate: Optional[builtins.int] = None,
                 total_constituents: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] aggregates: Used to specify the names of the aggregates on which the volume will be created. Each aggregate needs to be in the format aggrX where X is the number of the aggregate.
        :param builtins.int constituents_per_aggregate: Used to explicitly set the number of constituents within the FlexGroup per storage aggregate. the default value is `8`.
        :param builtins.int total_constituents: The total amount of constituents for a `FLEXGROUP` volume. This would equal constituents_per_aggregate x aggregates.
        """
    ...
    @property
    @pulumi.getter
    def aggregates(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def constituents_per_aggregate(self) -> Optional[builtins.int]:
        """
    ...
    def total_constituents(self) -> Optional[builtins.int]:
        """
...
class OntapVolumeSnaplockConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 audit_log_volume: Optional[builtins.bool] = None,
                 autocommit_period: Optional['outputs.OntapVolumeSnaplockConfigurationAutocommitPeriod'] = None,
                 privileged_delete: Optional[builtins.str] = None,
                 retention_period: Optional['outputs.OntapVolumeSnaplockConfigurationRetentionPeriod'] = None,
                 volume_append_mode_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.str snaplock_type: Specifies the retention mode of an FSx for ONTAP SnapLock volume. After it is set, it can't be changed. Valid values: `COMPLIANCE`, `ENTERPRISE`.
        :param builtins.bool audit_log_volume: Enables or disables the audit log volume for an FSx for ONTAP SnapLock volume. The default value is `false`.
        :param 'OntapVolumeSnaplockConfigurationAutocommitPeriodArgs' autocommit_period: The configuration object for setting the autocommit period of files in an FSx for ONTAP SnapLock volume. See `autocommit_period` Block for details.
        :param builtins.str privileged_delete: Enables, disables, or permanently disables privileged delete on an FSx for ONTAP SnapLock Enterprise volume. Valid values: `DISABLED`, `ENABLED`, `PERMANENTLY_DISABLED`. The default value is `DISABLED`.
        :param 'OntapVolumeSnaplockConfigurationRetentionPeriodArgs' retention_period: The retention period of an FSx for ONTAP SnapLock volume. See `retention_period` Block for details.
        :param builtins.bool volume_append_mode_enabled: Enables or disables volume-append mode on an FSx for ONTAP SnapLock volume. The default value is `false`.
        """
    ...
    def audit_log_volume(self) -> Optional[builtins.bool]:
        """
    ...
    def privileged_delete(self) -> Optional[builtins.str]:
        """
    ...
    def volume_append_mode_enabled(self) -> Optional[builtins.bool]:
        """
...
class OntapVolumeSnaplockConfigurationAutocommitPeriod(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of time for the autocommit period of a file in an FSx for ONTAP SnapLock volume. Setting this value to `NONE` disables autocommit. Valid values: `MINUTES`, `HOURS`, `DAYS`, `MONTHS`, `YEARS`, `NONE`.
        :param builtins.int value: The amount of time for the autocommit period of a file in an FSx for ONTAP SnapLock volume.
        """
        if type is not None:
...
class OntapVolumeSnaplockConfigurationRetentionPeriod(dict):
    ...
    def __init__(__self__, *,
        ...
        :param 'OntapVolumeSnaplockConfigurationRetentionPeriodMaximumRetentionArgs' maximum_retention: The longest retention period that can be assigned to a WORM file on an FSx for ONTAP SnapLock volume. See `maximum_retention` Block for details.
        :param 'OntapVolumeSnaplockConfigurationRetentionPeriodMinimumRetentionArgs' minimum_retention: The shortest retention period that can be assigned to a WORM file on an FSx for ONTAP SnapLock volume. See `minimum_retention` Block for details.
        """
...
class OntapVolumeTieringPolicy(dict):
    ...
    def cooling_period(self) -> Optional[builtins.int]:
        """
        Specifies the number of days that user data in a volume must remain inactive before it is considered "cold" and moved to the capacity pool. Used with `AUTO` and `SNAPSHOT_ONLY` tiering policies only. Valid values are whole numbers between 2 and 183. Default values are 31 days for `AUTO` and 2 days for `SNAPSHOT_ONLY`.
        """
...
class OpenZfsFileSystemRootVolumeConfiguration(dict):
    ...
    def __init__(__self__, *,
                 copy_tags_to_snapshots: Optional[builtins.bool] = None,
                 data_compression_type: Optional[builtins.str] = None,
                 ...
                 record_size_kib: Optional[builtins.int] = None,
                 user_and_group_quotas: Optional[Sequence['outputs.OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuota']] = None):
        """
        :param builtins.bool copy_tags_to_snapshots: A boolean flag indicating whether tags for the file system should be copied to snapshots. The default value is false.
        :param builtins.str data_compression_type: Method used to compress the data on the volume. Valid values are `LZ4`, `NONE` or `ZSTD`. Child volumes that don't specify compression option will inherit from parent volume. This option on file system applies to the root volume.
        :param 'OpenZfsFileSystemRootVolumeConfigurationNfsExportsArgs' nfs_exports: NFS export configuration for the root volume. Exactly 1 item. See `nfs_exports` Block for details.
        :param builtins.bool read_only: specifies whether the volume is read-only. Default is false.
        :param builtins.int record_size_kib: Specifies the record size of an OpenZFS root volume, in kibibytes (KiB). Valid values are `4`, `8`, `16`, `32`, `64`, `128`, `256`, `512`, or `1024` KiB. The default is `128` KiB.
        :param Sequence['OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuotaArgs'] user_and_group_quotas: Specify how much storage users or groups can use on the volume. Maximum of 100 items. See `user_and_group_quotas` Block for details.
        """
    ...
    def copy_tags_to_snapshots(self) -> Optional[builtins.bool]:
        """
    ...
    def data_compression_type(self) -> Optional[builtins.str]:
        """
    ...
    def record_size_kib(self) -> Optional[builtins.int]:
        """
...
class OpenZfsFileSystemRootVolumeConfigurationNfsExports(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence['OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfigurationArgs'] client_configurations: A list of configuration objects that contain the client and options for mounting the OpenZFS file system. Maximum of 25 items. See `client_configurations` Block for details.
        """
...
class OpenZfsFileSystemRootVolumeConfigurationNfsExportsClientConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str clients: A value that specifies who can mount the file system. You can provide a wildcard character (*), an IP address (0.0.0.0), or a CIDR address (192.0.2.0/24. By default, Amazon FSx uses the wildcard character when specifying the client.
        :param Sequence[builtins.str] options: The options to use when mounting the file system. Maximum of 20 items. See the [Linix NFS exports man page](https://linux.die.net/man/5/exports) for more information. `crossmount` and `sync` are used by default.
        """
...
class OpenZfsFileSystemRootVolumeConfigurationUserAndGroupQuota(dict):
    ...
    def __init__(__self__, *,
                 id: builtins.int,
                 storage_capacity_quota_gib: builtins.int,
                 type: builtins.str):
        """
        :param builtins.int id: The ID of the user or group. Valid values between `0` and `2147483647`
        :param builtins.int storage_capacity_quota_gib: The amount of storage that the user or group can use in gibibytes (GiB). Valid values between `0` and `2147483647`
        :param builtins.str type: A value that specifies whether the quota applies to a user or group. Valid values are `USER` or `GROUP`.
        """
    ...
    def storage_capacity_quota_gib(self) -> builtins.int:
        """
...
class OpenZfsVolumeOriginSnapshot(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str copy_strategy: Specifies the strategy used when copying data from the snapshot to the new volume. Valid values are `CLONE`, `FULL_COPY`, `INCREMENTAL_COPY`.
        :param builtins.str snapshot_arn: The Amazon Resource Name (ARN) of the origin snapshot.
        """
...
class WindowsFileSystemAuditLogConfiguration(dict):
    ...
    def __init__(__self__, *,
                 audit_log_destination: Optional[builtins.str] = None,
                 file_access_audit_log_level: Optional[builtins.str] = None,
                 file_share_access_audit_log_level: Optional[builtins.str] = None):
        """
        :param builtins.str audit_log_destination: The Amazon Resource Name (ARN) for the destination of the audit logs. The destination can be any Amazon CloudWatch Logs log group ARN or Amazon Kinesis Data Firehose delivery stream ARN. Can be specified when `file_access_audit_log_level` and `file_share_access_audit_log_level` are not set to `DISABLED`. The name of the Amazon CloudWatch Logs log group must begin with the `/aws/fsx` prefix. The name of the Amazon Kinesis Data Firehouse delivery stream must begin with the `aws-fsx` prefix. If you do not provide a destination in `audit_log_destionation`, Amazon FSx will create and use a log stream in the CloudWatch Logs /aws/fsx/windows log group.
        :param builtins.str file_access_audit_log_level: Sets which attempt type is logged by Amazon FSx for file and folder accesses. Valid values are `SUCCESS_ONLY`, `FAILURE_ONLY`, `SUCCESS_AND_FAILURE`, and `DISABLED`. Default value is `DISABLED`.
        :param builtins.str file_share_access_audit_log_level: Sets which attempt type is logged by Amazon FSx for file share accesses. Valid values are `SUCCESS_ONLY`, `FAILURE_ONLY`, `SUCCESS_AND_FAILURE`, and `DISABLED`. Default value is `DISABLED`.
        """
    ...
    def audit_log_destination(self) -> Optional[builtins.str]:
        """
    ...
    def file_access_audit_log_level(self) -> Optional[builtins.str]:
        """
    ...
    def file_share_access_audit_log_level(self) -> Optional[builtins.str]:
        """
...
class WindowsFileSystemSelfManagedActiveDirectory(dict):
    ...
    def __init__(__self__, *,
                 ...
                 organizational_unit_distinguished_name: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] dns_ips: A list of up to two IP addresses of DNS servers or domain controllers in the self-managed AD directory. The IP addresses need to be either in the same VPC CIDR range as the file system or in the private IP version 4 (IPv4) address ranges as specified in [RFC 1918](https://tools.ietf.org/html/rfc1918).
        :param builtins.str domain_name: The fully qualified domain name of the self-managed AD directory. For example, `corp.example.com`.
        :param builtins.str password: The password for the service account on your self-managed AD domain that Amazon FSx will use to join to your AD domain.
        :param builtins.str username: The user name for the service account on your self-managed AD domain that Amazon FSx will use to join to your AD domain.
        :param builtins.str file_system_administrators_group: The name of the domain group whose members are granted administrative privileges for the file system. Administrative privileges include taking ownership of files and folders, and setting audit controls (audit ACLs) on files and folders. The group that you specify must already exist in your domain. Defaults to `Domain Admins`.
...
class GetOntapFileSystemDiskIopsConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int iops: The total number of SSD IOPS provisioned for the file system.
        :param builtins.str mode: Specifies whether the file system is using the `AUTOMATIC` setting of SSD IOPS of 3 IOPS per GB of storage capacity, or if it using a `USER_PROVISIONED` value.
        """
        pulumi.set(__self__, "iops", iops)
        pulumi.set(__self__, "mode", mode)
...
class GetOntapFileSystemEndpointInterclusterResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dns_name: DNS name for the file system.
        """
        pulumi.set(__self__, "dns_name", dns_name)
        pulumi.set(__self__, "ip_addresses", ip_addresses)
...
class GetOntapStorageVirtualMachineActiveDirectoryConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str netbios_name: The NetBIOS name of the AD computer object to which the SVM is joined.
        """
        pulumi.set(__self__, "netbios_name", netbios_name)
...
class GetOntapStorageVirtualMachineActiveDirectoryConfigurationSelfManagedActiveDirectoryConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] dns_ips: A list of up to three IP addresses of DNS servers or domain controllers in the self-managed AD directory.
        :param builtins.str domain_name: The fully qualified domain name of the self-managed AD directory.
        :param builtins.str file_system_administrators_group: The name of the domain group whose members have administrative privileges for the FSx file system.
        :param builtins.str organizational_unit_distinguished_name: The fully qualified distinguished name of the organizational unit within the self-managed AD directory to which the Windows File Server or ONTAP storage virtual machine (SVM) instance is joined.
        :param builtins.str username: The user name for the service account on your self-managed AD domain that FSx uses to join to your AD domain.
        """
        pulumi.set(__self__, "dns_ips", dns_ips)
        pulumi.set(__self__, "domain_name", domain_name)
        pulumi.set(__self__, "file_system_administrators_group", file_system_administrators_group)
...
class GetOntapStorageVirtualMachineLifecycleTransitionReasonResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str message: A detailed message.
        """
...
class GetWindowsFileSystemAuditLogConfigurationResult(dict):
    def __init__(__self__, *,
                 audit_log_destination: builtins.str,
