...
class OntapFileSystem(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if disk_iops_configuration is not None and not isinstance(disk_iops_configuration, OntapFileSystemDiskIopsConfigurationArgs):
                disk_iops_configuration = disk_iops_configuration or {}
                def _setter(key, value):
                    disk_iops_configuration[key] = value
                OntapFileSystemDiskIopsConfigurationArgs._configure(_setter, **disk_iops_configuration)
