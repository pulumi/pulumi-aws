...
class BackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] volume_id: ID of the volume to back up. Required if backing up a ONTAP Volume.
        """
...
class _BackupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: Type of the file system backup.
        :param pulumi.Input[_builtins.str] volume_id: ID of the volume to back up. Required if backing up a ONTAP Volume.
        """
        if arn is not None:
