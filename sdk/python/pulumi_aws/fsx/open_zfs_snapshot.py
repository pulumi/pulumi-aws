...
class OpenZfsSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] volume_id: ID of the volume to snapshot. This can be the root volume or a child volume.
...
class OpenZfsSnapshot(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            volume_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'OpenZfsSnapshot':
        """
