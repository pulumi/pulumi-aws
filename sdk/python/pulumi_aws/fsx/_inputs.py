...
class FileCacheDataRepositoryAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] resource_arn: ARN of the data repository association.
...
class FileCacheLustreConfigurationLogConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] destination: ARN of the destination that receives the logs.
...
class OpenZfsVolumeOriginSnapshotArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] snapshot_arn: The ARN of the origin snapshot.
        """
...
class WindowsFileSystemAuditLogConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] audit_log_destination: ARN for the destination of the audit logs. The destination can be any Amazon CloudWatch Logs log group ARN or Amazon Kinesis Data Firehose delivery stream ARN. Can be specified when `file_access_audit_log_level` and `file_share_access_audit_log_level` are not set to `DISABLED`. The name of the Amazon CloudWatch Logs log group must begin with the `/aws/fsx` prefix. The name of the Amazon Kinesis Data Firehouse delivery stream must begin with the `aws-fsx` prefix. If you do not provide a destination in `audit_log_destionation`, Amazon FSx will create and use a log stream in the CloudWatch Logs /aws/fsx/windows log group.
...
class WindowsFileSystemSelfManagedActiveDirectoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] domain_name: Fully qualified domain name of the self-managed AD directory. For example, `corp.example.com`.
        :param pulumi.Input[_builtins.str] domain_join_service_account_secret: ARN for the AWS Secrets Manager secret that contains the credentials for the service account on your self-managed AD domain. Conflicts with `username` and `password`.
