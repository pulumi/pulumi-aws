...
class FileCacheArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'fileCacheType' in kwargs:
            file_cache_type = kwargs['fileCacheType']
        if 'fileCacheTypeVersion' in kwargs:
...
class _FileCacheState:
    ...
    def _configure(
        ...
        if 'copyTagsToDataRepositoryAssociations' in kwargs:
            copy_tags_to_data_repository_associations = kwargs['copyTagsToDataRepositoryAssociations']
        if 'dataRepositoryAssociationIds' in kwargs:
