...
class FileCacheArgs:
    def __init__(__self__, *,
                 file_cache_type: pulumi.Input[builtins.str],
                 file_cache_type_version: pulumi.Input[builtins.str],
                 storage_capacity: pulumi.Input[builtins.int],
                 subnet_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 copy_tags_to_data_repository_associations: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] file_cache_type: The type of cache that you're creating. The only supported value is `LUSTRE`.
        ...
        :param pulumi.Input[builtins.bool] copy_tags_to_data_repository_associations: A boolean flag indicating whether tags for the cache should be copied to data repository associations. This value defaults to false.
    ...
    def file_cache_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def file_cache_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "file_cache_type", value)

    @property
    @pulumi.getter(name="fileCacheTypeVersion")
    def file_cache_type_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def file_cache_type_version(self, value: pulumi.Input[builtins.str]):
    ...
    def copy_tags_to_data_repository_associations(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def copy_tags_to_data_repository_associations(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _FileCacheState:
    def __init__(__self__, *,
                 ...
                 copy_tags_to_data_repository_associations: Optional[pulumi.Input[builtins.bool]] = None,
                 data_repository_association_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 data_repository_associations: Optional[pulumi.Input[Sequence[pulumi.Input['FileCacheDataRepositoryAssociationArgs']]]] = None,
                 dns_name: Optional[pulumi.Input[builtins.str]] = None,
                 file_cache_id: Optional[pulumi.Input[builtins.str]] = None,
                 file_cache_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) for the resource.
        :param pulumi.Input[builtins.bool] copy_tags_to_data_repository_associations: A boolean flag indicating whether tags for the cache should be copied to data repository associations. This value defaults to false.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] data_repository_association_ids: A list of IDs of data repository associations that are associated with this cache.
        :param pulumi.Input[Sequence[pulumi.Input['FileCacheDataRepositoryAssociationArgs']]] data_repository_associations: See the `data_repository_association` configuration block. Max of 8.
               A list of up to 8 configurations for data repository associations (DRAs) to be created during the cache creation. The DRAs link the cache to either an Amazon S3 data repository or a Network File System (NFS) data repository that supports the NFSv3 protocol. The DRA configurations must meet the following requirements: 1) All configurations on the list must be of the same data repository type, either all S3 or all NFS. A cache can't link to different data repository types at the same time. 2) An NFS DRA must link to an NFS file system that supports the NFSv3 protocol. DRA automatic import and automatic export is not supported.
        :param pulumi.Input[builtins.str] dns_name: The Domain Name System (DNS) name for the cache.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: A list of subnet IDs that the cache will be accessible from. You can specify only one subnet ID.
               ...
               The following arguments are optional:
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the file cache. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[builtins.str] vpc_id: The ID of your virtual private cloud (VPC).
        """
        if arn is not None:
    ...
    def data_repository_association_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def data_repository_association_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter(name="fileCacheType")
    def file_cache_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of cache that you're creating. The only supported value is `LUSTRE`.
        """
        return pulumi.get(self, "file_cache_type")
    ...
    @file_cache_type.setter
    def file_cache_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "file_cache_type", value)

    @property
    @pulumi.getter(name="fileCacheTypeVersion")
    def file_cache_type_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The version for the type of cache that you're creating. The only supported value is `2.12`.
        """
        return pulumi.get(self, "file_cache_type_version")
    ...
    @file_cache_type_version.setter
    def file_cache_type_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "file_cache_type_version", value)
...
class FileCache(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'FileCache':
        """
    ...
    @property
    @pulumi.getter(name="copyTagsToDataRepositoryAssociations")
    def copy_tags_to_data_repository_associations(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean flag indicating whether tags for the cache should be copied to data repository associations. This value defaults to false.
        """
        return pulumi.get(self, "copy_tags_to_data_repository_associations")
    ...
    @property
    @pulumi.getter(name="dataRepositoryAssociationIds")
    def data_repository_association_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of IDs of data repository associations that are associated with this cache.
        """
        return pulumi.get(self, "data_repository_association_ids")
    ...
    @property
    @pulumi.getter(name="fileCacheId")
    def file_cache_id(self) -> pulumi.Output[builtins.str]:
        """
        The system-generated, unique ID of the cache.
        """
        return pulumi.get(self, "file_cache_id")
    ...
    @property
    @pulumi.getter(name="fileCacheType")
    def file_cache_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of cache that you're creating. The only supported value is `LUSTRE`.
        """
        return pulumi.get(self, "file_cache_type")
    ...
    @property
    @pulumi.getter(name="fileCacheTypeVersion")
    def file_cache_type_version(self) -> pulumi.Output[builtins.str]:
        """
        The version for the type of cache that you're creating. The only supported value is `2.12`.
        """
        return pulumi.get(self, "file_cache_type_version")
