...
class ResolverQueryLogConfigAssociationArgs:
    def __init__(__self__, *,
                 resolver_query_log_config_id: pulumi.Input[builtins.str],
    ...
    def resolver_query_log_config_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resolver_query_log_config_id(self, value: pulumi.Input[builtins.str]):
...
class _ResolverQueryLogConfigAssociationState:
    def __init__(__self__, *,
                 resolver_query_log_config_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="resolverQueryLogConfigId")
    def resolver_query_log_config_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Route 53 Resolver query logging configuration that you want to associate a VPC with.
        """
        return pulumi.get(self, "resolver_query_log_config_id")
    ...
    @resolver_query_log_config_id.setter
    def resolver_query_log_config_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resolver_query_log_config_id", value)
...
class ResolverQueryLogConfigAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            resolver_query_log_config_id: Optional[pulumi.Input[builtins.str]] = None,
            resource_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ResolverQueryLogConfigAssociation':
        """
    ...
    @property
    @pulumi.getter(name="resolverQueryLogConfigId")
    def resolver_query_log_config_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the Route 53 Resolver query logging configuration that you want to associate a VPC with.
        """
        return pulumi.get(self, "resolver_query_log_config_id")
