...
class RecordArgs:
    ...
    def _configure(
        ...
        if 'cidrRoutingPolicy' in kwargs:
            cidr_routing_policy = kwargs['cidrRoutingPolicy']
        if 'failoverRoutingPolicies' in kwargs:
            failover_routing_policies = kwargs['failoverRoutingPolicies']
        if 'geolocationRoutingPolicies' in kwargs:
        ...
        if 'latencyRoutingPolicies' in kwargs:
            latency_routing_policies = kwargs['latencyRoutingPolicies']
        if 'multivalueAnswerRoutingPolicy' in kwargs:
        ...
        if 'weightedRoutingPolicies' in kwargs:
