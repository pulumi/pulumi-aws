...
class ProfilesResourceAssociationArgs:
    ...
    def resource_properties(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProfilesResourceAssociationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] status: Status of the Profile Association. Valid values [AWS docs](https://docs.aws.amazon.com/Route53/latest/APIReference/API_route53profiles_Profile.html)
        :param pulumi.Input[builtins.str] status_message: Status message of the Profile Resource Association.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
@pulumi.type_token("aws:route53/profilesResourceAssociation:ProfilesResourceAssociation")
