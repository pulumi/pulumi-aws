...
class GetZoneResult:
    ...
    def private_zone(self) -> Optional[builtins.bool]:
        """
    ...
    def resource_record_set_count(self) -> builtins.int:
        """
...
def get_zone(name: Optional[builtins.str] = None,
             private_zone: Optional[builtins.bool] = None,
...
def get_zone_output(name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                    private_zone: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
