...
class ZoneAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vpc_id: The VPC to associate with the private hosted zone.
        :param pulumi.Input[builtins.str] zone_id: The private hosted zone to associate.
...
class _ZoneAssociationState:
    def __init__(__self__, *,
                 owning_account: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_id: Optional[pulumi.Input[builtins.str]] = None,
                 vpc_region: Optional[pulumi.Input[builtins.str]] = None,
                 zone_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ZoneAssociation resources.
        :param pulumi.Input[builtins.str] owning_account: The account ID of the account that created the hosted zone.
        :param pulumi.Input[builtins.str] vpc_id: The VPC to associate with the private hosted zone.
        :param pulumi.Input[builtins.str] vpc_region: The VPC's region. Defaults to the region of the AWS provider.
        :param pulumi.Input[builtins.str] zone_id: The private hosted zone to associate.
        """
    ...
    def owning_account(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def owning_account(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ZoneAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_region: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ZoneAssociation':
        """
    ...
    @property
    @pulumi.getter(name="owningAccount")
    def owning_account(self) -> pulumi.Output[builtins.str]:
        """
        The account ID of the account that created the hosted zone.
        """
        return pulumi.get(self, "owning_account")
