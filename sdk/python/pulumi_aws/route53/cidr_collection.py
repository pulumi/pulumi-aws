...
class CidrCollectionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Unique name for the CIDR collection.
        """
        if name is not None:
...
class _CidrCollectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the CIDR collection.
        :param pulumi.Input[builtins.str] name: Unique name for the CIDR collection.
        :param pulumi.Input[builtins.int] version: The lastest version of the CIDR collection.
        """
        if arn is not None:
...
class CidrCollection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            arn: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'CidrCollection':
        """
