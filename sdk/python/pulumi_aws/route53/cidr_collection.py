...
__all__ = ['CidrCollectionArrgs', 'CidrCollection']

@pulumi.input_type
calass CidrCollectionArrgs:
...
calass CidrCollection(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[CidrCollectionArrgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Provides a Route53 CIDR collection resource.
        ...
        :param str resource_name: The name of the resource.
        :param CidrCollectionArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CidrCollectionArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CidrCollectionArrgs.__new__(CidrCollectionArrgs)
