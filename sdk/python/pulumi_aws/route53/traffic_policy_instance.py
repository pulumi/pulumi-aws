...
class TrafficPolicyInstanceArgs:
    def __init__(__self__, *,
                 ...
                 traffic_policy_version: pulumi.Input[builtins.int],
                 ttl: pulumi.Input[builtins.int],
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TrafficPolicyInstance resource.
        :param pulumi.Input[builtins.str] hosted_zone_id: ID of the hosted zone that you want Amazon Route 53 to create resource record sets in by using the configuration in a traffic policy.
        :param pulumi.Input[builtins.str] traffic_policy_id: ID of the traffic policy that you want to use to create resource record sets in the specified hosted zone.
        :param pulumi.Input[builtins.int] traffic_policy_version: Version of the traffic policy
        :param pulumi.Input[builtins.int] ttl: TTL that you want Amazon Route 53 to assign to all the resource record sets that it creates in the specified hosted zone.
        :param pulumi.Input[builtins.str] name: Domain name for which Amazon Route 53 responds to DNS queries by using the resource record sets that Route 53 creates for this traffic policy instance.
        """
    ...
    def traffic_policy_version(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def traffic_policy_version(self, value: pulumi.Input[builtins.int]):
...
class _TrafficPolicyInstanceState:
    def __init__(__self__, *,
                 ...
                 traffic_policy_version: Optional[pulumi.Input[builtins.int]] = None,
                 ttl: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering TrafficPolicyInstance resources.
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the traffic policy instance.
        :param pulumi.Input[builtins.str] hosted_zone_id: ID of the hosted zone that you want Amazon Route 53 to create resource record sets in by using the configuration in a traffic policy.
        :param pulumi.Input[builtins.str] name: Domain name for which Amazon Route 53 responds to DNS queries by using the resource record sets that Route 53 creates for this traffic policy instance.
        :param pulumi.Input[builtins.str] traffic_policy_id: ID of the traffic policy that you want to use to create resource record sets in the specified hosted zone.
        :param pulumi.Input[builtins.int] traffic_policy_version: Version of the traffic policy
    ...
    @property
    @pulumi.getter(name="trafficPolicyId")
    def traffic_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the traffic policy that you want to use to create resource record sets in the specified hosted zone.
        """
        return pulumi.get(self, "traffic_policy_id")
    ...
    @traffic_policy_id.setter
    def traffic_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "traffic_policy_id", value)

    @property
    @pulumi.getter(name="trafficPolicyVersion")
    def traffic_policy_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Version of the traffic policy
        """
        return pulumi.get(self, "traffic_policy_version")
    ...
    @traffic_policy_version.setter
    def traffic_policy_version(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "traffic_policy_version", value)
...
@pulumi.type_token("aws:route53/trafficPolicyInstance:TrafficPolicyInstance")
class TrafficPolicyInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            traffic_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            traffic_policy_version: Optional[pulumi.Input[builtins.int]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None) -> 'TrafficPolicyInstance':
        """
    ...
    @property
    @pulumi.getter(name="trafficPolicyVersion")
    def traffic_policy_version(self) -> pulumi.Output[builtins.int]:
        """
        Version of the traffic policy
        """
        return pulumi.get(self, "traffic_policy_version")
