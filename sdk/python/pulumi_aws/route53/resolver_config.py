...
class _ResolverConfigState:
    def __init__(__self__, *,
                 autodefined_reverse_flag: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="autodefinedReverseFlag")
    def autodefined_reverse_flag(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Indicates whether or not the Resolver will create autodefined rules for reverse DNS lookups. Valid values: `ENABLE`, `DISABLE`.
        """
        return pulumi.get(self, "autodefined_reverse_flag")
    ...
    @autodefined_reverse_flag.setter
    def autodefined_reverse_flag(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "autodefined_reverse_flag", value)
...
class ResolverConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner_id: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None,
            resource_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ResolverConfig':
        """
