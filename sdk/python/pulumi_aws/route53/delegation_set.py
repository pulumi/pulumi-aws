...
class _DelegationSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the Delegation Set.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] name_servers: A list of authoritative name servers for the hosted zone
...
class DelegationSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            arn: Optional[pulumi.Input[builtins.str]] = None,
            name_servers: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            reference_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DelegationSet':
        """
