...
class _ResolverRuleAssociationState:
    def __init__(__self__, *,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 resolver_rule_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="resolverRuleId")
    def resolver_rule_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The ID of the resolver rule that you want to associate with the VPC.
        """
        return pulumi.get(self, "resolver_rule_id")
    ...
    @resolver_rule_id.setter
    def resolver_rule_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "resolver_rule_id", value)
...
class ResolverRuleAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            resolver_rule_id: pulumi.Input[Optional[_builtins.str]] = None,
            vpc_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ResolverRuleAssociation':
        """
