...
class HostedZoneDnsSecArgs:
    def __init__(__self__, *,
                 ...
                 signing_status: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] signing_status: Hosted Zone signing status. Valid values: `SIGNING`, `NOT_SIGNING`. Defaults to `SIGNING`.
        """
    ...
    def signing_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def signing_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class HostedZoneDnsSec(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            hosted_zone_id: Optional[pulumi.Input[builtins.str]] = None,
            signing_status: Optional[pulumi.Input[builtins.str]] = None) -> 'HostedZoneDnsSec':
        """
    ...
    @property
    @pulumi.getter(name="signingStatus")
    def signing_status(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Hosted Zone signing status. Valid values: `SIGNING`, `NOT_SIGNING`. Defaults to `SIGNING`.
        """
        return pulumi.get(self, "signing_status")
