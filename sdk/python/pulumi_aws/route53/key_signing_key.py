...
class KeySigningKeyArgs:
    def __init__(__self__, *,
                 ...
                 key_management_service_arn: pulumi.Input[builtins.str],
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a KeySigningKey resource.
        :param pulumi.Input[builtins.str] hosted_zone_id: Identifier of the Route 53 Hosted Zone.
        :param pulumi.Input[builtins.str] key_management_service_arn: Amazon Resource Name (ARN) of the Key Management Service (KMS) Key. This must be unique for each key-signing key (KSK) in a single hosted zone. This key must be in the `us-east-1` Region and meet certain requirements, which are described in the [Route 53 Developer Guide](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-configuring-dnssec-cmk-requirements.html) and [Route 53 API Reference](https://docs.aws.amazon.com/Route53/latest/APIReference/API_CreateKeySigningKey.html).
        :param pulumi.Input[builtins.str] name: Name of the key-signing key (KSK). Must be unique for each key-signing key in the same hosted zone.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] status: Status of the key-signing key (KSK). Valid values: `ACTIVE`, `INACTIVE`. Defaults to `ACTIVE`.
        """
    ...
    def key_management_service_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def key_management_service_arn(self, value: pulumi.Input[builtins.str]):
...
class _KeySigningKeyState:
    def __init__(__self__, *,
                 digest_algorithm_mnemonic: Optional[pulumi.Input[builtins.str]] = None,
                 digest_algorithm_type: Optional[pulumi.Input[builtins.int]] = None,
                 digest_value: Optional[pulumi.Input[builtins.str]] = None,
                 dnskey_record: Optional[pulumi.Input[builtins.str]] = None,
                 ds_record: Optional[pulumi.Input[builtins.str]] = None,
                 flag: Optional[pulumi.Input[builtins.int]] = None,
                 hosted_zone_id: Optional[pulumi.Input[builtins.str]] = None,
                 key_management_service_arn: Optional[pulumi.Input[builtins.str]] = None,
                 key_tag: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 public_key: Optional[pulumi.Input[builtins.str]] = None,
                 signing_algorithm_mnemonic: Optional[pulumi.Input[builtins.str]] = None,
                 signing_algorithm_type: Optional[pulumi.Input[builtins.int]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering KeySigningKey resources.
        :param pulumi.Input[builtins.str] digest_algorithm_mnemonic: A string used to represent the delegation signer digest algorithm. This value must follow the guidelines provided by [RFC-8624 Section 3.3](https://tools.ietf.org/html/rfc8624#section-3.3).
        :param pulumi.Input[builtins.int] digest_algorithm_type: An integer used to represent the delegation signer digest algorithm. This value must follow the guidelines provided by [RFC-8624 Section 3.3](https://tools.ietf.org/html/rfc8624#section-3.3).
        :param pulumi.Input[builtins.str] digest_value: A cryptographic digest of a DNSKEY resource record (RR). DNSKEY records are used to publish the public key that resolvers can use to verify DNSSEC signatures that are used to secure certain kinds of information provided by the DNS system.
        :param pulumi.Input[builtins.str] dnskey_record: A string that represents a DNSKEY record.
        :param pulumi.Input[builtins.str] ds_record: A string that represents a delegation signer (DS) record.
        :param pulumi.Input[builtins.int] flag: An integer that specifies how the key is used. For key-signing key (KSK), this value is always 257.
        :param pulumi.Input[builtins.str] hosted_zone_id: Identifier of the Route 53 Hosted Zone.
        :param pulumi.Input[builtins.str] key_management_service_arn: Amazon Resource Name (ARN) of the Key Management Service (KMS) Key. This must be unique for each key-signing key (KSK) in a single hosted zone. This key must be in the `us-east-1` Region and meet certain requirements, which are described in the [Route 53 Developer Guide](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-configuring-dnssec-cmk-requirements.html) and [Route 53 API Reference](https://docs.aws.amazon.com/Route53/latest/APIReference/API_CreateKeySigningKey.html).
        :param pulumi.Input[builtins.int] key_tag: An integer used to identify the DNSSEC record for the domain name. The process used to calculate the value is described in [RFC-4034 Appendix B](https://tools.ietf.org/rfc/rfc4034.txt).
        :param pulumi.Input[builtins.str] name: Name of the key-signing key (KSK). Must be unique for each key-signing key in the same hosted zone.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] public_key: The public key, represented as a Base64 encoding, as required by [RFC-4034 Page 5](https://tools.ietf.org/rfc/rfc4034.txt).
        :param pulumi.Input[builtins.str] signing_algorithm_mnemonic: A string used to represent the signing algorithm. This value must follow the guidelines provided by [RFC-8624 Section 3.1](https://tools.ietf.org/html/rfc8624#section-3.1).
        :param pulumi.Input[builtins.int] signing_algorithm_type: An integer used to represent the signing algorithm. This value must follow the guidelines provided by [RFC-8624 Section 3.1](https://tools.ietf.org/html/rfc8624#section-3.1).
        :param pulumi.Input[builtins.str] status: Status of the key-signing key (KSK). Valid values: `ACTIVE`, `INACTIVE`. Defaults to `ACTIVE`.
        """
    ...
    def digest_algorithm_mnemonic(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def digest_algorithm_mnemonic(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "digest_algorithm_mnemonic", value)

    @property
    @pulumi.getter(name="digestAlgorithmType")
    def digest_algorithm_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def digest_algorithm_type(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "digest_algorithm_type", value)

    @property
    @pulumi.getter(name="digestValue")
    def digest_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @digest_value.setter
    def digest_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "digest_value", value)

    @property
    @pulumi.getter(name="dnskeyRecord")
    def dnskey_record(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dnskey_record(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dnskey_record", value)

    @property
    @pulumi.getter(name="dsRecord")
    def ds_record(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ds_record.setter
    def ds_record(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="keyManagementServiceArn")
    def key_management_service_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Amazon Resource Name (ARN) of the Key Management Service (KMS) Key. This must be unique for each key-signing key (KSK) in a single hosted zone. This key must be in the `us-east-1` Region and meet certain requirements, which are described in the [Route 53 Developer Guide](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-configuring-dnssec-cmk-requirements.html) and [Route 53 API Reference](https://docs.aws.amazon.com/Route53/latest/APIReference/API_CreateKeySigningKey.html).
        """
        return pulumi.get(self, "key_management_service_arn")
    ...
    @key_management_service_arn.setter
    def key_management_service_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "key_management_service_arn", value)
    ...
    def signing_algorithm_mnemonic(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def signing_algorithm_mnemonic(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "signing_algorithm_mnemonic", value)

    @property
    @pulumi.getter(name="signingAlgorithmType")
    def signing_algorithm_type(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def signing_algorithm_type(self, value: Optional[pulumi.Input[builtins.int]]):
...
class KeySigningKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            signing_algorithm_mnemonic: Optional[pulumi.Input[builtins.str]] = None,
            signing_algorithm_type: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'KeySigningKey':
        """
    ...
    @property
    @pulumi.getter(name="digestAlgorithmMnemonic")
    def digest_algorithm_mnemonic(self) -> pulumi.Output[builtins.str]:
        """
        A string used to represent the delegation signer digest algorithm. This value must follow the guidelines provided by [RFC-8624 Section 3.3](https://tools.ietf.org/html/rfc8624#section-3.3).
        """
        return pulumi.get(self, "digest_algorithm_mnemonic")
    ...
    @property
    @pulumi.getter(name="digestAlgorithmType")
    def digest_algorithm_type(self) -> pulumi.Output[builtins.int]:
        """
        An integer used to represent the delegation signer digest algorithm. This value must follow the guidelines provided by [RFC-8624 Section 3.3](https://tools.ietf.org/html/rfc8624#section-3.3).
        """
        return pulumi.get(self, "digest_algorithm_type")
    ...
    @property
    @pulumi.getter(name="digestValue")
    def digest_value(self) -> pulumi.Output[builtins.str]:
        """
        A cryptographic digest of a DNSKEY resource record (RR). DNSKEY records are used to publish the public key that resolvers can use to verify DNSSEC signatures that are used to secure certain kinds of information provided by the DNS system.
        """
        return pulumi.get(self, "digest_value")
    ...
    @property
    @pulumi.getter(name="dnskeyRecord")
    def dnskey_record(self) -> pulumi.Output[builtins.str]:
        """
        A string that represents a DNSKEY record.
        """
        return pulumi.get(self, "dnskey_record")
    ...
    @property
    @pulumi.getter(name="dsRecord")
    def ds_record(self) -> pulumi.Output[builtins.str]:
        """
        A string that represents a delegation signer (DS) record.
        """
        return pulumi.get(self, "ds_record")
    ...
    @property
    @pulumi.getter
    def flag(self) -> pulumi.Output[builtins.int]:
        """
        An integer that specifies how the key is used. For key-signing key (KSK), this value is always 257.
        """
        return pulumi.get(self, "flag")
    ...
    @property
    @pulumi.getter(name="keyManagementServiceArn")
    def key_management_service_arn(self) -> pulumi.Output[builtins.str]:
        """
        Amazon Resource Name (ARN) of the Key Management Service (KMS) Key. This must be unique for each key-signing key (KSK) in a single hosted zone. This key must be in the `us-east-1` Region and meet certain requirements, which are described in the [Route 53 Developer Guide](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-configuring-dnssec-cmk-requirements.html) and [Route 53 API Reference](https://docs.aws.amazon.com/Route53/latest/APIReference/API_CreateKeySigningKey.html).
        """
        return pulumi.get(self, "key_management_service_arn")
    ...
    @property
    @pulumi.getter(name="keyTag")
    def key_tag(self) -> pulumi.Output[builtins.int]:
        """
        An integer used to identify the DNSSEC record for the domain name. The process used to calculate the value is described in [RFC-4034 Appendix B](https://tools.ietf.org/rfc/rfc4034.txt).
        """
        return pulumi.get(self, "key_tag")
    ...
    @property
    @pulumi.getter(name="signingAlgorithmMnemonic")
    def signing_algorithm_mnemonic(self) -> pulumi.Output[builtins.str]:
        """
        A string used to represent the signing algorithm. This value must follow the guidelines provided by [RFC-8624 Section 3.1](https://tools.ietf.org/html/rfc8624#section-3.1).
        """
        return pulumi.get(self, "signing_algorithm_mnemonic")
    ...
    @property
    @pulumi.getter(name="signingAlgorithmType")
    def signing_algorithm_type(self) -> pulumi.Output[builtins.int]:
        """
        An integer used to represent the signing algorithm. This value must follow the guidelines provided by [RFC-8624 Section 3.1](https://tools.ietf.org/html/rfc8624#section-3.1).
        """
        return pulumi.get(self, "signing_algorithm_type")
