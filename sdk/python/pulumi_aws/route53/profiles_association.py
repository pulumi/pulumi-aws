...
class ProfilesAssociationArgs:
    def __init__(__self__, *,
                 ...
                 timeouts: pulumi.Input[Optional['ProfilesAssociationTimeoutsArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def timeouts(self) -> pulumi.Input[Optional['ProfilesAssociationTimeoutsArgs']]:
        return pulumi.get(self, "timeouts")

    @timeouts.setter
    def timeouts(self, value: pulumi.Input[Optional['ProfilesAssociationTimeoutsArgs']]):
...
class _ProfilesAssociationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[_builtins.str] resource_id: Resource ID of the VPC the profile to be associated with.
        :param pulumi.Input[_builtins.str] status: Status of the Profile Association.
        :param pulumi.Input[_builtins.str] status_message: Status message of the Profile Association.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Map of tags to assign to the resource. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
