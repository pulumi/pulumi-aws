...
class SiteArgs:
    def __init__(__self__, *,
                 ...
                 location: pulumi.Input[Optional['SiteLocationArgs']] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def location(self) -> pulumi.Input[Optional['SiteLocationArgs']]:
        """
    ...
    @location.setter
    def location(self, value: pulumi.Input[Optional['SiteLocationArgs']]):
