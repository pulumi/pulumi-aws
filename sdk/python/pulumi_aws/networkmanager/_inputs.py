...
class GetCoreNetworkPolicyDocumentAttachmentPolicyArgs:
    ...
    def _configure(
             _setter: Callable[[Any, Any], None],
             action: Optional['GetCoreNetworkPolicyDocumentAttachmentPolicyActionArgs'] = None,
             conditions: Optional[Sequence['GetCoreNetworkPolicyDocumentAttachmentPolicyConditionArgs']] = None,
...
class GetCoreNetworkPolicyDocumentCoreNetworkConfigurationArgs:
    ...
    def _configure(
             ...
             edge_locations: Optional[Sequence['GetCoreNetworkPolicyDocumentCoreNetworkConfigurationEdgeLocationArgs']] = None,
             inside_cidr_blocks: Optional[Sequence[str]] = None,
             vpn_ecmp_support: Optional[bool] = None,
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
