...
class TransitGatewayRegistrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] global_network_id: The ID of the Global Network to register to.
        :param pulumi.Input[builtins.str] transit_gateway_arn: The ARN of the Transit Gateway to register.
        """
...
@pulumi.type_token("aws:networkmanager/transitGatewayRegistration:TransitGatewayRegistration")
class TransitGatewayRegistration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            global_network_id: Optional[pulumi.Input[builtins.str]] = None,
            transit_gateway_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitGatewayRegistration':
        """
