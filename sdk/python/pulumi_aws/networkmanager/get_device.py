...
def get_device(device_id: Optional[builtins.str] = None,
    ...
    :param builtins.str global_network_id: ID of the global network.
    :param Mapping[str, builtins.str] tags: Key-value tags for the device.
    """
    __args__ = dict()
...
def get_device_output(device_id: Optional[pulumi.Input[builtins.str]] = None,
