...
def get_connection(connection_id: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_id: ID of the specific connection to retrieve.
    :param builtins.str global_network_id: ID of the Global Network of the connection to retrieve.
    :param Mapping[str, builtins.str] tags: Key-value tags for the connection.
    """
    __args__ = dict()
