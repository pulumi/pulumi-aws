...
def get_devices(global_network_id: Optional[builtins.str] = None,
    ...
    :param builtins.str global_network_id: ID of the Global Network of the devices to retrieve.
    :param builtins.str site_id: ID of the site of the devices to retrieve.
    :param Mapping[str, builtins.str] tags: Restricts the list to the devices with these tags.
    """
    __args__ = dict()
...
def get_devices_output(global_network_id: Optional[pulumi.Input[builtins.str]] = None,
