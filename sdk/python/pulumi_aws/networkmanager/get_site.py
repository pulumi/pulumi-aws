...
def get_site(global_network_id: Optional[builtins.str] = None,
    ...
    :param builtins.str global_network_id: ID of the Global Network of the site to retrieve.
    :param builtins.str site_id: ID of the specific site to retrieve.
    :param Mapping[str, builtins.str] tags: Key-value tags for the Site.
    """
    __args__ = dict()
...
def get_site_output(global_network_id: Optional[pulumi.Input[builtins.str]] = None,
