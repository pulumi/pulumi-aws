...
class CoreNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = aws.networkmanager.core_network.CoreNetwork("example", global_network_id=aws_networkmanager_global_network.example.id)
        ```
        ### With description
        ...
        example = aws.networkmanager.core_network.CoreNetwork("example",
