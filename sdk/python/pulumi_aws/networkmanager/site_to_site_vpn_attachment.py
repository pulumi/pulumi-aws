...
class SiteToSiteVpnAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] core_network_id: ID of a core network for the VPN attachment.
        :param pulumi.Input[builtins.str] vpn_connection_arn: ARN of the site-to-site VPN connection.
...
class _SiteToSiteVpnAttachmentState:
    ...
    @property
    @pulumi.getter(name="vpnConnectionArn")
    def vpn_connection_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the site-to-site VPN connection.
    ...
    @vpn_connection_arn.setter
    def vpn_connection_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpn_connection_arn", value)


@pulumi.type_token("aws:networkmanager/siteToSiteVpnAttachment:SiteToSiteVpnAttachment")
class SiteToSiteVpnAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpn_connection_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'SiteToSiteVpnAttachment':
        """
