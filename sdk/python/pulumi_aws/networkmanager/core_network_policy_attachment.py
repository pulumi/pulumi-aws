...
class CoreNetworkPolicyAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_core_network = aws.networkmanager.core_network.CoreNetwork("exampleCoreNetwork", global_network_id=aws_networkmanager_global_network.example.id)
        example_core_network_policy_attachment = aws.networkmanager.core_network_policy_attachment.CoreNetworkPolicyAttachment("exampleCoreNetworkPolicyAttachment",
