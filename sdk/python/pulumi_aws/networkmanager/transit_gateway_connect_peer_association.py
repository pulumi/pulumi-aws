...
class TransitGatewayConnectPeerAssociationArgs:
    ...
    def _configure(
        ...
        if transit_gateway_connect_peer_arn is None and 'transitGatewayConnectPeerArn' in kwargs:
            transit_gateway_connect_peer_arn = kwargs['transitGatewayConnectPeerArn']
        if transit_gateway_connect_peer_arn is None:
            raise TypeError("Missing 'transit_gateway_connect_peer_arn' argument")
