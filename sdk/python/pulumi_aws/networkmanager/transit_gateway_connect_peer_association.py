...
class TransitGatewayConnectPeerAssociationArgs:
    def __init__(__self__, *,
                 ...
                 transit_gateway_connect_peer_arn: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] transit_gateway_connect_peer_arn: The Amazon Resource Name (ARN) of the Connect peer.
    ...
    def transit_gateway_connect_peer_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def transit_gateway_connect_peer_arn(self, value: pulumi.Input[builtins.str]):
...
class _TransitGatewayConnectPeerAssociationState:
    def __init__(__self__, *,
                 ...
                 link_id: Optional[pulumi.Input[builtins.str]] = None,
                 transit_gateway_connect_peer_arn: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="transitGatewayConnectPeerArn")
    def transit_gateway_connect_peer_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the Connect peer.
        """
        return pulumi.get(self, "transit_gateway_connect_peer_arn")
    ...
    @transit_gateway_connect_peer_arn.setter
    def transit_gateway_connect_peer_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "transit_gateway_connect_peer_arn", value)
...
class TransitGatewayConnectPeerAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            global_network_id: Optional[pulumi.Input[builtins.str]] = None,
            link_id: Optional[pulumi.Input[builtins.str]] = None,
            transit_gateway_connect_peer_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitGatewayConnectPeerAssociation':
        """
    ...
    @property
    @pulumi.getter(name="transitGatewayConnectPeerArn")
    def transit_gateway_connect_peer_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) of the Connect peer.
        """
        return pulumi.get(self, "transit_gateway_connect_peer_arn")
