...
class OrganizationAdminAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_organization = aws.organizations.organization.Organization("exampleOrganization",
            ...
            feature_set=ALL)
        example_organization_admin_account = aws.detective.organization_admin_account.OrganizationAdminAccount("exampleOrganizationAdminAccount", account_id=123456789012,
