...
class MemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: AWS account ID for the account.
    ...
    def graph_arn(self) -> pulumi.Input[builtins.str]:
        """
...
class _MemberState:
    def __init__(__self__, *,
                 ...
                 administrator_id: Optional[pulumi.Input[builtins.str]] = None,
                 disable_email_notification: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 invited_time: Optional[pulumi.Input[builtins.str]] = None,
                 message: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 updated_time: Optional[pulumi.Input[builtins.str]] = None,
                 volume_usage_in_bytes: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Member resources.
        :param pulumi.Input[builtins.str] account_id: AWS account ID for the account.
        :param pulumi.Input[builtins.str] administrator_id: AWS account ID for the administrator account.
        :param pulumi.Input[builtins.bool] disable_email_notification: If set to true, then the root user of the invited account will _not_ receive an email notification. This notification is in addition to an alert that the root user receives in AWS Personal Health Dashboard. By default, this is set to `false`.
        :param pulumi.Input[builtins.str] email_address: Email address for the account.
        :param pulumi.Input[builtins.str] graph_arn: ARN of the behavior graph to invite the member accounts to contribute their data to.
    ...
    def administrator_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def administrator_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="graphArn")
    def graph_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the behavior graph to invite the member accounts to contribute their data to.
        """
        return pulumi.get(self, "graph_arn")
    ...
    def invited_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @invited_time.setter
    def invited_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def volume_usage_in_bytes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def volume_usage_in_bytes(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Member(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            updated_time: Optional[pulumi.Input[builtins.str]] = None,
            volume_usage_in_bytes: Optional[pulumi.Input[builtins.str]] = None) -> 'Member':
        """
    ...
    @property
    @pulumi.getter(name="administratorId")
    def administrator_id(self) -> pulumi.Output[builtins.str]:
        """
        AWS account ID for the administrator account.
        """
        return pulumi.get(self, "administrator_id")
    ...
    @property
    @pulumi.getter(name="graphArn")
    def graph_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the behavior graph to invite the member accounts to contribute their data to.
        """
        return pulumi.get(self, "graph_arn")
    ...
    @property
    @pulumi.getter(name="invitedTime")
    def invited_time(self) -> pulumi.Output[builtins.str]:
        """
        Date and time, in UTC and extended RFC 3339 format, when an Amazon Detective membership invitation was last sent to the account.
        """
        return pulumi.get(self, "invited_time")
    ...
    @property
    @pulumi.getter(name="volumeUsageInBytes")
    def volume_usage_in_bytes(self) -> pulumi.Output[builtins.str]:
        """
        Data volume in bytes per day for the member account.
        """
        return pulumi.get(self, "volume_usage_in_bytes")
