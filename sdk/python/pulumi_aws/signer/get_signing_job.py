...
class GetSigningJobResult:
    ...
    def job_invoker(self) -> Optional[str]:
        """
    ...
    def revocation_records(self) -> Optional[Sequence['outputs.GetSigningJobRevocationRecordResult']]:
        """
    ...
    def signature_expires_at(self) -> Optional[str]:
        """
    ...
    def signed_objects(self) -> Optional[Sequence['outputs.GetSigningJobSignedObjectResult']]:
        """
    ...
    @property
    @pulumi.getter
    def sources(self) -> Optional[Sequence['outputs.GetSigningJobSourceResult']]:
        """
