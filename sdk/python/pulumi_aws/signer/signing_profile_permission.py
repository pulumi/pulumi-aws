...
class SigningProfilePermissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] profile_version: The signing profile version that a permission applies to.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[_builtins.str] statement_id: A unique statement identifier. By default generated by the provider.
        :param pulumi.Input[_builtins.str] statement_id_prefix: A statement identifier prefix. The provider will generate a unique suffix. Conflicts with `statement_id`.
        """
...
class SigningProfilePermission(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region: Optional[pulumi.Input[_builtins.str]] = None,
            statement_id: Optional[pulumi.Input[_builtins.str]] = None,
            statement_id_prefix: Optional[pulumi.Input[_builtins.str]] = None) -> 'SigningProfilePermission':
        """
