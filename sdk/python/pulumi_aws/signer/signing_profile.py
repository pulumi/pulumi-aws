...
__all__ = ['SigningProfileArrgs', 'SigningProfile']

@pulumi.input_type
calass SigningProfileArrgs:
    def __init__(__self__, *,
                 platform_id: pulumi.Input[str],
                 name: Optional[pulumi.Input[str]] = None,
                 name_prefix: Optional[pulumi.Input[str]] = None,
                 signature_validity_period: Optional[pulumi.Input['SigningProfileSignatureValidityPeriodArrgs']] = None,
                 signing_material: Optional[pulumi.Input['SigningProfileSigningMaterialArrgs']] = None,
        ...
        :param pulumi.Input['SigningProfileSignatureValidityPeriodArrgs'] signature_validity_period: The validity period for a signing job.
    ...
    def signature_validity_period(self) -> Optional[pulumi.Input['SigningProfileSignatureValidityPeriodArrgs']]:
        """
    ...
    def signature_validity_period(self, value: Optional[pulumi.Input['SigningProfileSignatureValidityPeriodArrgs']]):
        pulumi.set(self, "signature_validity_period", value)

    @property
    @pulumi.getter(name="signingMaterial")
    def signing_material(self) -> Optional[pulumi.Input['SigningProfileSigningMaterialArrgs']]:
        return pulumi.get(self, "signing_material")

    @signing_material.setter
    def signing_material(self, value: Optional[pulumi.Input['SigningProfileSigningMaterialArrgs']]):
...
calass _SigningProfileState:
    def __init__(__self__, *,
                 ...
                 revocation_records: Optional[pulumi.Input[Sequence[pulumi.Input['SigningProfileRevocationRecordArrgs']]]] = None,
                 signature_validity_period: Optional[pulumi.Input['SigningProfileSignatureValidityPeriodArrgs']] = None,
                 signing_material: Optional[pulumi.Input['SigningProfileSigningMaterialArrgs']] = None,
        ...
        :param pulumi.Input[str] platform_id: The ID of the platform that is used by the target signing profile.
        :param pulumi.Input[Sequence[pulumi.Input['SigningProfileRevocationRecordArrgs']]] revocation_records: Revocation information for a signing profile.
        :param pulumi.Input['SigningProfileSignatureValidityPeriodArrgs'] signature_validity_period: The validity period for a signing job.
    ...
    def revocation_records(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SigningProfileRevocationRecordArrgs']]]]:
        """
    ...
    def revocation_records(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SigningProfileRevocationRecordArrgs']]]]):
...
calass SigningProfile(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 name_prefix: Optional[pulumi.Input[str]] = None,
                 platform_id: Optional[pulumi.Input[str]] = None,
                 signature_validity_period: Optional[pulumi.Input[pulumi.InputType['SigningProfileSignatureValidityPeriodArrgs']]] = None,
                 signing_material: Optional[pulumi.Input[pulumi.InputType['SigningProfileSigningMaterialArrgs']]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] name_prefix: A signing profile name prefix. The provider will generate a unique suffix. Conflicts with `name`.
        :param pulumi.Input[str] platform_id: The ID of the platform that is used by the target signing profile.
        :param pulumi.Input[pulumi.InputType['SigningProfileSignatureValidityPeriodArrgs']] signature_validity_period: The validity period for a signing job.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: A list of tags associated with the signing profile. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param SigningProfileArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SigningProfileArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SigningProfileArrgs.__new__(SigningProfileArrgs)
    ...
    def get(resource_name: str,
            ...
            platform_display_name: Optional[pulumi.Input[str]] = None,
            platform_id: Optional[pulumi.Input[str]] = None,
            revocation_records: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SigningProfileRevocationRecordArrgs']]]]] = None,
            signature_validity_period: Optional[pulumi.Input[pulumi.InputType['SigningProfileSignatureValidityPeriodArrgs']]] = None,
            signing_material: Optional[pulumi.Input[pulumi.InputType['SigningProfileSigningMaterialArrgs']]] = None,
            status: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
        ...
        :param pulumi.Input[str] platform_display_name: A human-readable name for the signing platform associated with the signing profile.
        :param pulumi.Input[str] platform_id: The ID of the platform that is used by the target signing profile.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SigningProfileRevocationRecordArrgs']]]] revocation_records: Revocation information for a signing profile.
        :param pulumi.Input[pulumi.InputType['SigningProfileSignatureValidityPeriodArrgs']] signature_validity_period: The validity period for a signing job.
        :param pulumi.Input[str] status: The status of the target signing profile.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: A list of tags associated with the signing profile. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags_all: A map of tags assigned to the resource, including those inherited from the provider `default_tags` configuration block.
