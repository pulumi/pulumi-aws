...
class SigningProfileArgs:
    def __init__(__self__, *,
                 ...
                 signature_validity_period: pulumi.Input[Optional['SigningProfileSignatureValidityPeriodArgs']] = None,
                 signing_material: pulumi.Input[Optional['SigningProfileSigningMaterialArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] name: A unique signing profile name. By default generated by Terraform. Signing profile names are immutable and cannot be reused after canceled.
    ...
    def signature_validity_period(self) -> pulumi.Input[Optional['SigningProfileSignatureValidityPeriodArgs']]:
        """
    ...
    def signature_validity_period(self, value: pulumi.Input[Optional['SigningProfileSignatureValidityPeriodArgs']]):
        pulumi.set(self, "signature_validity_period", value)

    @_builtins.property
    @pulumi.getter(name="signingMaterial")
    def signing_material(self) -> pulumi.Input[Optional['SigningProfileSigningMaterialArgs']]:
        """
    ...
    def signing_material(self, value: pulumi.Input[Optional['SigningProfileSigningMaterialArgs']]):
        pulumi.set(self, "signing_material", value)

    @_builtins.property
    @pulumi.getter(name="signingParameters")
    def signing_parameters(self) -> pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
    ...
    def signing_parameters(self, value: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]]):
...
class _SigningProfileState:
    def __init__(__self__, *,
                 ...
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 revocation_records: pulumi.Input[Optional[Sequence[pulumi.Input['SigningProfileRevocationRecordArgs']]]] = None,
                 signature_validity_period: pulumi.Input[Optional['SigningProfileSignatureValidityPeriodArgs']] = None,
                 signing_material: pulumi.Input[Optional['SigningProfileSigningMaterialArgs']] = None,
                 signing_parameters: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 ...
                 version_arn: pulumi.Input[Optional[_builtins.str]] = None):
        """
        Input properties used for looking up and filtering SigningProfile resources.

        :param pulumi.Input[_builtins.str] arn: ARN for the signing profile.
        :param pulumi.Input[_builtins.str] name: A unique signing profile name. By default generated by Terraform. Signing profile names are immutable and cannot be reused after canceled.
        :param pulumi.Input[_builtins.str] name_prefix: A signing profile name prefix. Terraform will generate a unique suffix. Conflicts with `name`.
    ...
    def revocation_records(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SigningProfileRevocationRecordArgs']]]]:
        """
    ...
    def revocation_records(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SigningProfileRevocationRecordArgs']]]]):
    ...
    def version_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @version_arn.setter
    def version_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class SigningProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            version: pulumi.Input[Optional[_builtins.str]] = None,
            version_arn: pulumi.Input[Optional[_builtins.str]] = None) -> 'SigningProfile':
        """
