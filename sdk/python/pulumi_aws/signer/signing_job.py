...
class SigningJobArgs:
    ...
    def _configure(
        ...
        if ignore_signing_job_failure is None and 'ignoreSigningJobFailure' in kwargs:
...
class _SigningJobState:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if completed_at is None and 'completedAt' in kwargs:
        ...
        if job_id is None and 'jobId' in kwargs:
            job_id = kwargs['jobId']
        if job_invoker is None and 'jobInvoker' in kwargs:
        ...
        if requested_by is None and 'requestedBy' in kwargs:
        ...
        if signature_expires_at is None and 'signatureExpiresAt' in kwargs:
            signature_expires_at = kwargs['signatureExpiresAt']
        if signed_objects is None and 'signedObjects' in kwargs:
...
class SigningJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            destination = _utilities.configure(destination, SigningJobDestinationArgs, True)
            ...
            source = _utilities.configure(source, SigningJobSourceArgs, True)
