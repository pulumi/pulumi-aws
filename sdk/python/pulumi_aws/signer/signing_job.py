...
class SigningJobArgs:
    def __init__(__self__, *,
                 ...
                 ignore_signing_job_failure: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] profile_name: The name of the profile to initiate the signing operation.
        ...
        :param pulumi.Input[builtins.bool] ignore_signing_job_failure: Set this argument to `true` to ignore signing job failures and retrieve failed status and reason. Default `false`.
        """
    ...
    def ignore_signing_job_failure(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_signing_job_failure(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SigningJobState:
    def __init__(__self__, *,
                 ...
                 job_invoker: Optional[pulumi.Input[builtins.str]] = None,
                 job_owner: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 requested_by: Optional[pulumi.Input[builtins.str]] = None,
                 revocation_records: Optional[pulumi.Input[Sequence[pulumi.Input['SigningJobRevocationRecordArgs']]]] = None,
                 signature_expires_at: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] completed_at: Date and time in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) that the signing job was completed.
        :param pulumi.Input[builtins.str] created_at: Date and time in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) that the signing job was created.
        :param pulumi.Input['SigningJobDestinationArgs'] destination: The S3 bucket in which to save your signed object. See Destination below for details.
        :param pulumi.Input[builtins.bool] ignore_signing_job_failure: Set this argument to `true` to ignore signing job failures and retrieve failed status and reason. Default `false`.
        :param pulumi.Input[builtins.str] job_id: The ID of the signing job on output.
        :param pulumi.Input[builtins.str] job_invoker: The IAM entity that initiated the signing job.
        :param pulumi.Input[builtins.str] job_owner: The AWS account ID of the job owner.
        :param pulumi.Input[builtins.str] platform_display_name: A human-readable name for the signing platform associated with the signing job.
        :param pulumi.Input[builtins.str] platform_id: The platform to which your signed code image will be distributed.
        :param pulumi.Input[builtins.str] profile_name: The name of the profile to initiate the signing operation.
        :param pulumi.Input[builtins.str] profile_version: The version of the signing profile used to initiate the signing job.
        :param pulumi.Input[builtins.str] requested_by: The IAM principal that requested the signing job.
        ...
        :param pulumi.Input[builtins.str] signature_expires_at: The time when the signature of a signing job expires.
        ...
        :param pulumi.Input['SigningJobSourceArgs'] source: The S3 bucket that contains the object to sign. See Source below for details.
        :param pulumi.Input[builtins.str] status: Status of the signing job.
        :param pulumi.Input[builtins.str] status_reason: String value that contains the status reason.
        """
    ...
    def job_invoker(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @job_invoker.setter
    def job_invoker(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "job_invoker", value)

    @property
    @pulumi.getter(name="jobOwner")
    def job_owner(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @job_owner.setter
    def job_owner(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def requested_by(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @requested_by.setter
    def requested_by(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def signature_expires_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def signature_expires_at(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SigningJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source: Optional[pulumi.Input[Union['SigningJobSourceArgs', 'SigningJobSourceArgsDict']]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            status_reason: Optional[pulumi.Input[builtins.str]] = None) -> 'SigningJob':
        """
    ...
    @property
    @pulumi.getter(name="ignoreSigningJobFailure")
    def ignore_signing_job_failure(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set this argument to `true` to ignore signing job failures and retrieve failed status and reason. Default `false`.
        """
        return pulumi.get(self, "ignore_signing_job_failure")
    ...
    @property
    @pulumi.getter(name="jobInvoker")
    def job_invoker(self) -> pulumi.Output[builtins.str]:
        """
        The IAM entity that initiated the signing job.
        """
        return pulumi.get(self, "job_invoker")
    ...
    @property
    @pulumi.getter(name="jobOwner")
    def job_owner(self) -> pulumi.Output[builtins.str]:
        """
        The AWS account ID of the job owner.
        """
        return pulumi.get(self, "job_owner")
    ...
    @property
    @pulumi.getter(name="requestedBy")
    def requested_by(self) -> pulumi.Output[builtins.str]:
        """
        The IAM principal that requested the signing job.
        """
        return pulumi.get(self, "requested_by")
    ...
    @property
    @pulumi.getter(name="signatureExpiresAt")
    def signature_expires_at(self) -> pulumi.Output[builtins.str]:
        """
        The time when the signature of a signing job expires.
        """
        return pulumi.get(self, "signature_expires_at")
