...
class GetRandomPasswordResult:
    ...
    def include_space(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "include_space")

    @property
    @pulumi.getter(name="passwordLength")
    def password_length(self) -> Optional[builtins.int]:
...
def get_random_password(exclude_characters: Optional[builtins.str] = None,
                        exclude_lowercase: Optional[builtins.bool] = None,
                        exclude_numbers: Optional[builtins.bool] = None,
                        exclude_punctuation: Optional[builtins.bool] = None,
    ...
    :param builtins.str exclude_characters: String of the characters that you don't want in the password.
    :param builtins.bool exclude_lowercase: Specifies whether to exclude lowercase letters from the password.
    :param builtins.bool exclude_numbers: Specifies whether to exclude numbers from the password.
    :param builtins.bool exclude_punctuation: Specifies whether to exclude the following punctuation characters from the password: ``! " # $ % & ' ( ) * + , - . / : ; < = > ? @ [ \\ ] ^ _ ` { | } ~ .``
...
def get_random_password_output(exclude_characters: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ...
                               exclude_numbers: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                               exclude_punctuation: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
