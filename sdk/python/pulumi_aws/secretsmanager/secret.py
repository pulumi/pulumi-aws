...
class SecretArgs:
    def __init__(__self__, *,
                 ...
                 force_overwrite_replica_secret: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 replicas: pulumi.Input[Optional[Sequence[pulumi.Input['SecretReplicaArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: Friendly name of the new secret. The secret name can consist of uppercase letters, lowercase letters, digits, and any of the following characters: `/_+=.@-` Conflicts with `name_prefix`.
        ...
        :param pulumi.Input[_builtins.str] type: The type of secret for managed external secrets. Valid values are `SalesforceClientSecret`, `BigIDClientSecret`, and `SnowflakeKeyPairAuthentication`. For more information about supported partners and their specific requirements, see [Managed external secret partners](https://docs.aws.amazon.com/secretsmanager/latest/userguide/mes-partners.html). This attribute cannot be changed after creation.
        """
    ...
    def force_overwrite_replica_secret(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def force_overwrite_replica_secret(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    @_builtins.property
    @pulumi.getter
    def replicas(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SecretReplicaArgs']]]]:
        """
    ...
    @replicas.setter
    def replicas(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SecretReplicaArgs']]]]):
...
class Secret(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Using `pulumi import`, import `secretsmanager.Secret` using the secret Amazon Resource Name (ARN). For example:
