...
class DataSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] asset_type: The type of asset that is added to a data set. Valid values include `API_GATEWAY_API`, `LAKE_FORMATION_DATA_PERMISSION`, `REDSHIFT_DATA_SHARE`, `S3_DATA_ACCESS`, `S3_SNAPSHOT`.
        :param pulumi.Input[builtins.str] description: A description for the data set.
        :param pulumi.Input[builtins.str] name: The name of the data set.
...
class DataSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'DataSet':
        """
