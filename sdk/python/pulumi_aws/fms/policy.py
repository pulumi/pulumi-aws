...
class PolicyArgs:
    def __init__(__self__, *,
                 ...
                 delete_unused_fm_managed_resources: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] delete_all_policy_resources: If true, the request will also perform a clean-up process. Defaults to `true`. More information can be found here [AWS Firewall Manager delete policy](https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_DeletePolicy.html)
        :param pulumi.Input[builtins.bool] delete_unused_fm_managed_resources: If true, Firewall Manager will automatically remove protections from resources that leave the policy scope. Defaults to `false`. More information can be found here [AWS Firewall Manager policy contents](https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_Policy.html)
        :param pulumi.Input[builtins.str] description: The description of the AWS Network Firewall firewall policy.
    ...
    def delete_unused_fm_managed_resources(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def delete_unused_fm_managed_resources(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def remediation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _PolicyState:
    ...
    @property
    @pulumi.getter(name="excludeResourceTags")
    def exclude_resource_tags(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        A boolean value, if true the tags that are specified in the `resource_tags` are not protected by this policy. If set to false and resource_tags are populated, resources that contain tags will be protected by this policy.
        """
        return pulumi.get(self, "exclude_resource_tags")
    ...
    @exclude_resource_tags.setter
    def exclude_resource_tags(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "exclude_resource_tags", value)
    ...
    def policy_update_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_update_token(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Policy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deleteUnusedFmManagedResources")
    def delete_unused_fm_managed_resources(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, Firewall Manager will automatically remove protections from resources that leave the policy scope. Defaults to `false`. More information can be found here [AWS Firewall Manager policy contents](https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_Policy.html)
        """
        return pulumi.get(self, "delete_unused_fm_managed_resources")
    ...
    @property
    @pulumi.getter(name="policyUpdateToken")
    def policy_update_token(self) -> pulumi.Output[builtins.str]:
        """
        A unique identifier for each update to the policy.
        """
        return pulumi.get(self, "policy_update_token")
    ...
    @property
    @pulumi.getter(name="remediationEnabled")
    def remediation_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean value, indicates if the policy should automatically applied to resources that already exist in the account.
        """
        return pulumi.get(self, "remediation_enabled")
    ...
    @property
    @pulumi.getter(name="resourceTypeLists")
    def resource_type_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of resource types to protect. Conflicts with `resource_type`. See the [FMS API Reference](https://docs.aws.amazon.com/fms/2018-01-01/APIReference/API_Policy.html#fms-Type-Policy-ResourceType) for more information about supported values. Lists with only one element are not supported, instead use `resource_type`.
        """
        return pulumi.get(self, "resource_type_lists")
