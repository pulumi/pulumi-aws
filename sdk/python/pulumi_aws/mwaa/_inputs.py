...
class EnvironmentLoggingConfigurationDagProcessingLogsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Enabling or disabling the collection of logs
        :param pulumi.Input[builtins.str] log_level: Logging level. Valid values: `CRITICAL`, `ERROR`, `WARNING`, `INFO`, `DEBUG`. Will be `INFO` by default.
        """
...
class EnvironmentNetworkConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 subnet_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_group_ids: Security groups IDs for the environment. At least one of the security group needs to allow MWAA resources to talk to each other, otherwise MWAA cannot be provisioned.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: The private subnet IDs in which the environment should be created. MWAA requires two subnets.
        """
