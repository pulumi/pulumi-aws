...
class CloudFormationStackArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_id: The ARN of the application from the Serverless Application Repository.
...
class CloudFormationStack(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            semantic_version: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'CloudFormationStack':
        """
    ...
    @property
    @pulumi.getter(name="semanticVersion")
    def semantic_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of the application to deploy. If not supplied, deploys the latest version.
        """
        return pulumi.get(self, "semantic_version")
