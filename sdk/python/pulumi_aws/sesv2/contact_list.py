...
class ContactListArgs:
    def __init__(__self__, *,
                 contact_list_name: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] contact_list_name: Name of the contact list.
    ...
    def contact_list_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def contact_list_name(self, value: pulumi.Input[builtins.str]):
...
class _ContactListState:
    def __init__(__self__, *,
                 ...
                 contact_list_name: Optional[pulumi.Input[builtins.str]] = None,
                 created_timestamp: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 last_updated_timestamp: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="contactListName")
    def contact_list_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the contact list.
    ...
    @contact_list_name.setter
    def contact_list_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "contact_list_name", value)
    ...
    def last_updated_timestamp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_updated_timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ContactList(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="contactListName")
    def contact_list_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the contact list.
    ...
    @property
    @pulumi.getter(name="lastUpdatedTimestamp")
    def last_updated_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        Timestamp noting the last time the contact list was updated in ISO 8601 format.
        """
        return pulumi.get(self, "last_updated_timestamp")
