...
class AccountVdmAttributesArgs:
    ...
    def vdm_enabled(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @vdm_enabled.setter
    def vdm_enabled(self, value: pulumi.Input[builtins.str]):
...
class _AccountVdmAttributesState:
    ...
    @vdm_enabled.setter
    def vdm_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vdm_enabled", value)
...
class AccountVdmAttributes(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vdmEnabled")
    def vdm_enabled(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the status of your VDM configuration. Valid values: `ENABLED`, `DISABLED`.
