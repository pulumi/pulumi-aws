...
class AccountVdmAttributes(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            dashboard_attributes = _utilities.configure(dashboard_attributes, AccountVdmAttributesDashboardAttributesArgs, True)
            __props__.__dict__["dashboard_attributes"] = dashboard_attributes
            guardian_attributes = _utilities.configure(guardian_attributes, AccountVdmAttributesGuardianAttributesArgs, True)
