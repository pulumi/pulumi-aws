...
class _DedicatedIpAssignmentState:
    def __init__(__self__, *,
                 destination_pool_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="destinationPoolName")
    def destination_pool_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Dedicated IP address.
        """
        return pulumi.get(self, "destination_pool_name")
    ...
    @destination_pool_name.setter
    def destination_pool_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "destination_pool_name", value)
...
class DedicatedIpAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            destination_pool_name: pulumi.Input[Optional[_builtins.str]] = None,
            ip: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None) -> 'DedicatedIpAssignment':
        """
