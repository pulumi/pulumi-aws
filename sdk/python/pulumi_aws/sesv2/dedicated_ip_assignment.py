...
class _DedicatedIpAssignmentState:
    def __init__(__self__, *,
                 destination_pool_name: Optional[pulumi.Input[_builtins.str]] = None,
...
class DedicatedIpAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DedicatedIpAssignment resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            destination_pool_name: Optional[pulumi.Input[_builtins.str]] = None,
            ip: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'DedicatedIpAssignment':
        """
