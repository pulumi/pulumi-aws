...
def get_service_account(region: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Name of the region whose AWS Redshift account ID is desired.
...
def get_service_account_output(region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('aws:redshift/getServiceAccount:getServiceAccount', __args__, opts=opts, typ=GetServiceAccountResult)
