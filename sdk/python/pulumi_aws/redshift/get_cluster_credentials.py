...
class GetClusterCredentialsResult:
    ...
    def auto_create(self) -> Optional[builtins.bool]:
    ...
    def db_groups(self) -> Optional[Sequence[builtins.str]]:
...
def get_cluster_credentials(auto_create: Optional[builtins.bool] = None,
                            ...
                            db_groups: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.bool auto_create: Create a database user with the name specified for the user named in `db_user` if one does not exist.
    :param builtins.str cluster_identifier: Unique identifier of the cluster that contains the database for which your are requesting credentials.
    :param Sequence[builtins.str] db_groups: List of the names of existing database groups that the user named in `db_user` will join for the current session, in addition to any group memberships for an existing user. If not specified, a new user is added only to `PUBLIC`.
