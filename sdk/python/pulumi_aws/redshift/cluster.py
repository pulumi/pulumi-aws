...
class ClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] node_type: The node type to be provisioned for the cluster.
        :param pulumi.Input[builtins.bool] allow_version_upgrade: If true , major version upgrades can be applied during the maintenance window to the Amazon Redshift engine that is running on the cluster. Default is `true`.
        ...
        :param pulumi.Input[builtins.str] aqua_configuration_status: The value represents how the cluster is configured to use AQUA (Advanced Query Accelerator) after the cluster is restored.
               No longer supported by the AWS API.
               Always returns `auto`.
        :param pulumi.Input[builtins.int] automated_snapshot_retention_period: The number of days that automated snapshots are retained. If the value is 0, automated snapshots are disabled. Even if automated snapshots are disabled, you can still create manual snapshots when you want with create-cluster-snapshot. Default is 1.
        ...
        :param pulumi.Input[builtins.str] database_name: The name of the first database to be created when the cluster is created.
        ...
        :param pulumi.Input[builtins.int] manual_snapshot_retention_period: The default number of days to retain a manual snapshot. If the value is -1, the snapshot is retained indefinitely. This setting doesn't change the retention period of existing snapshots. Valid values are between `-1` and `3653`. Default value is `-1`.
        :param pulumi.Input[builtins.str] master_password: Password for the master DB user.
        ...
        :param pulumi.Input[builtins.str] master_password_secret_kms_key_id: ID of the KMS key used to encrypt the cluster admin credentials secret.
        :param pulumi.Input[builtins.str] master_username: Username for the master DB user.
        :param pulumi.Input[builtins.bool] multi_az: Specifies if the Redshift cluster is multi-AZ.
        :param pulumi.Input[builtins.int] number_of_nodes: The number of compute nodes in the cluster. This parameter is required when the ClusterType parameter is specified as multi-node. Default is 1.
        :param pulumi.Input[builtins.str] owner_account: The AWS customer account used to create or copy the snapshot. Required if you are restoring a snapshot you do not own, optional if you own the snapshot.
        :param pulumi.Input[builtins.int] port: The port number on which the cluster accepts incoming connections. Valid values are between `1115` and `65535`.
    ...
    def availability_zone_relocation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def availability_zone_relocation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def snapshot_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @snapshot_arn.setter
    def snapshot_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 ...
                 cluster_namespace_arn: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 manual_snapshot_retention_period: Optional[pulumi.Input[builtins.int]] = None,
                 master_password: Optional[pulumi.Input[builtins.str]] = None,
                 master_password_secret_arn: Optional[pulumi.Input[builtins.str]] = None,
                 master_password_secret_kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 master_username: Optional[pulumi.Input[builtins.str]] = None,
                 multi_az: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] availability_zone_relocation_enabled: If true, the cluster can be relocated to another availabity zone, either automatically by AWS or when requested. Default is `false`. Available for use on clusters from the RA3 instance family.
        :param pulumi.Input[builtins.str] cluster_identifier: The Cluster Identifier. Must be a lower case string.
        :param pulumi.Input[builtins.str] cluster_namespace_arn: The namespace Amazon Resource Name (ARN) of the cluster
        ...
        :param pulumi.Input[builtins.str] master_password: Password for the master DB user.
               ...
               Note that this may show up in logs, and it will be stored in the state file.
               Password must contain at least 8 characters and contain at least one uppercase letter, one lowercase letter, and one number.
        :param pulumi.Input[builtins.str] master_password_secret_arn: ARN of the cluster admin credentials secret
        :param pulumi.Input[builtins.str] master_password_secret_kms_key_id: ID of the KMS key used to encrypt the cluster admin credentials secret.
        :param pulumi.Input[builtins.str] master_username: Username for the master DB user.
        :param pulumi.Input[builtins.bool] multi_az: Specifies if the Redshift cluster is multi-AZ.
        :param pulumi.Input[builtins.str] node_type: The node type to be provisioned for the cluster.
    ...
    def cluster_namespace_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_namespace_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def master_password_secret_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_password_secret_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Cluster(pulumi.CustomResource):
    ...
    pulumi_type = "aws:redshift/cluster:Cluster"
    ...
    @pulumi.getter(name="aquaConfigurationStatus")
    @_utilities.deprecated("""aqua_configuration_status is deprecated. This parameter is no longer supported by the AWS API. It will be removed in the next major version of the provider.""")
    def aqua_configuration_status(self) -> pulumi.Output[builtins.str]:
        """
        The value represents how the cluster is configured to use AQUA (Advanced Query Accelerator) after the cluster is restored.
        No longer supported by the AWS API.
        Always returns `auto`.
    ...
    @property
    @pulumi.getter(name="availabilityZoneRelocationEnabled")
    def availability_zone_relocation_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, the cluster can be relocated to another availabity zone, either automatically by AWS or when requested. Default is `false`. Available for use on clusters from the RA3 instance family.
        """
        return pulumi.get(self, "availability_zone_relocation_enabled")
    ...
    @property
    @pulumi.getter(name="clusterParameterGroupName")
    def cluster_parameter_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the parameter group to be associated with this cluster.
        """
        return pulumi.get(self, "cluster_parameter_group_name")
    ...
    @property
    @pulumi.getter(name="clusterPublicKey")
    def cluster_public_key(self) -> pulumi.Output[builtins.str]:
        """
        The public key for the cluster
        """
        return pulumi.get(self, "cluster_public_key")
    ...
    @property
    @pulumi.getter(name="clusterRevisionNumber")
    def cluster_revision_number(self) -> pulumi.Output[builtins.str]:
        """
        The specific revision number of the database in the cluster
        """
        return pulumi.get(self, "cluster_revision_number")
    ...
    @property
    @pulumi.getter(name="clusterSubnetGroupName")
    def cluster_subnet_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of a cluster subnet group to be associated with this cluster. If this parameter is not provided the resulting cluster will be deployed outside virtual private cloud (VPC).
        """
        return pulumi.get(self, "cluster_subnet_group_name")
    ...
    @property
    @pulumi.getter(name="defaultIamRoleArn")
    def default_iam_role_arn(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon Resource Name (ARN) for the IAM role that was set as default for the cluster when the cluster was created.
        """
        return pulumi.get(self, "default_iam_role_arn")
    ...
    @property
    @pulumi.getter(name="enhancedVpcRouting")
    def enhanced_vpc_routing(self) -> pulumi.Output[builtins.bool]:
        """
        If true , enhanced VPC routing is enabled.
        """
        return pulumi.get(self, "enhanced_vpc_routing")
    ...
    @property
    @pulumi.getter(name="masterPasswordSecretKmsKeyId")
    def master_password_secret_kms_key_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the KMS key used to encrypt the cluster admin credentials secret.
        """
        return pulumi.get(self, "master_password_secret_kms_key_id")
    ...
    @property
    @pulumi.getter(name="snapshotArn")
    def snapshot_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the snapshot from which to create the new cluster. Conflicts with `snapshot_identifier`.
        """
        return pulumi.get(self, "snapshot_arn")
