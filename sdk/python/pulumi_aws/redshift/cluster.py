...
class ClusterArgs:
    ...
    def _configure(
        ...
        if 'availabilityZoneRelocationEnabled' in kwargs:
        ...
        if 'clusterRevisionNumber' in kwargs:
...
class _ClusterState:
    ...
    def _configure(
        ...
        if 'clusterIdentifier' in kwargs:
            cluster_identifier = kwargs['clusterIdentifier']
        if 'clusterNamespaceArn' in kwargs:
...
class Cluster(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if logging is not None and not isinstance(logging, ClusterLoggingArgs):
                logging = logging or {}
                def _setter(key, value):
                    logging[key] = value
                ClusterLoggingArgs._configure(_setter, **logging)
            ...
            if snapshot_copy is not None and not isinstance(snapshot_copy, ClusterSnapshotCopyArgs):
                snapshot_copy = snapshot_copy or {}
                def _setter(key, value):
                    snapshot_copy[key] = value
                ClusterSnapshotCopyArgs._configure(_setter, **snapshot_copy)
