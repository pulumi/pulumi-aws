...
if not MYPY:
    class ClusterLoggingArgsDict(TypedDict):
        ...
        """
        log_destination_type: NotRequired[pulumi.Input[builtins.str]]
        """
        The log destination type. An enum with possible values of `s3` and `cloudwatch`.
        """
        log_exports: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ClusterLoggingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enable: Enables logging information such as queries and connection attempts, for the specified Amazon Redshift cluster.
        :param pulumi.Input[builtins.str] bucket_name: The name of an existing S3 bucket where the log files are to be stored. Must be in the same region as the cluster and the cluster must have read bucket and put object permissions.
               For more information on the permissions required for the bucket, please read the AWS [documentation](http://docs.aws.amazon.com/redshift/latest/mgmt/db-auditing.html#db-auditing-enable-logging)
        :param pulumi.Input[builtins.str] log_destination_type: The log destination type. An enum with possible values of `s3` and `cloudwatch`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] log_exports: The collection of exported log types. Log types include the connection log, user log and user activity log. Required when `log_destination_type` is `cloudwatch`. Valid log types are `connectionlog`, `userlog`, and `useractivitylog`.
        :param pulumi.Input[builtins.str] s3_key_prefix: The prefix applied to the log file names.
        """
...
if not MYPY:
    class ClusterSnapshotCopyArgsDict(TypedDict):
        ...
        """
        grant_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClusterSnapshotCopyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] destination_region: The destination region that you want to copy snapshots to.
        :param pulumi.Input[builtins.str] grant_name: The name of the snapshot copy grant to use when snapshots of an AWS KMS-encrypted cluster are copied to the destination region.
        :param pulumi.Input[builtins.int] retention_period: The number of days to retain automated snapshots in the destination region after they are copied from the source region. Defaults to `7`.
        """
...
class GetDataSharesDataShareArgs:
    ...
    def data_share_arn(self, value: builtins.str):
    ...
    @managed_by.setter
    def managed_by(self, value: builtins.str):
    ...
    @producer_arn.setter
    def producer_arn(self, value: builtins.str):
