...
class EventSubscriptionArgs:
    ...
    def event_categories(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def event_categories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @source_ids.setter
    def source_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _EventSubscriptionState:
    def __init__(__self__, *,
                 ...
                 customer_aws_id: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 event_categories: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 severity: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the Redshift event notification subscription
        :param pulumi.Input[builtins.str] customer_aws_id: The AWS customer account associated with the Redshift event notification subscription
        :param pulumi.Input[builtins.bool] enabled: A boolean flag to enable/disable the subscription. Defaults to `true`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] event_categories: A list of event categories for a SourceType that you want to subscribe to. See https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-event-notifications.html or run `aws redshift describe-event-categories`.
        :param pulumi.Input[builtins.str] name: The name of the Redshift event subscription.
        :param pulumi.Input[builtins.str] severity: The event severity to be published by the notification subscription. Valid options are `INFO` or `ERROR`. Default value of `INFO`.
    ...
    def customer_aws_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def customer_aws_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EventSubscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'EventSubscription':
        """
    ...
    @property
    @pulumi.getter(name="customerAwsId")
    def customer_aws_id(self) -> pulumi.Output[builtins.str]:
        """
        The AWS customer account associated with the Redshift event notification subscription
        """
        return pulumi.get(self, "customer_aws_id")
    ...
    @property
    @pulumi.getter(name="eventCategories")
    def event_categories(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of event categories for a SourceType that you want to subscribe to. See https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-event-notifications.html or run `aws redshift describe-event-categories`.
        """
        return pulumi.get(self, "event_categories")
    ...
    @property
    @pulumi.getter(name="sourceIds")
    def source_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of identifiers of the event sources for which events will be returned. If not specified, then all sources are included in the response. If specified, a `source_type` must also be specified.
        """
        return pulumi.get(self, "source_ids")
