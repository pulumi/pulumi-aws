...
class EndpointAccessArgs:
    ...
    def subnet_group_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def subnet_group_name(self, value: pulumi.Input[builtins.str]):
...
class _EndpointAccessState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address: The DNS address of the endpoint.
        :param pulumi.Input[builtins.str] cluster_identifier: The cluster identifier of the cluster to access.
        :param pulumi.Input[builtins.str] endpoint_name: The Redshift-managed VPC endpoint name.
...
class EndpointAccess(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vpc_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'EndpointAccess':
        """
