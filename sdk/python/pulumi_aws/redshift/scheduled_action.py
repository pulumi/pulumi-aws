...
class ScheduledAction(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if target_action is not None and not isinstance(target_action, ScheduledActionTargetActionArgs):
                target_action = target_action or {}
                def _setter(key, value):
                    target_action[key] = value
                ScheduledActionTargetActionArgs._configure(_setter, **target_action)
