...
class SnapshotCopyGrant(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_snapshot_copy_grant = aws.redshift.snapshot_copy_grant.SnapshotCopyGrant("testSnapshotCopyGrant", snapshot_copy_grant_name=my-grant)
        test_cluster = aws.redshift.cluster.Cluster("testCluster", snapshot_copy={
