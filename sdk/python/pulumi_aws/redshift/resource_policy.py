...
class ResourcePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] policy: The content of the resource policy being updated.
        :param pulumi.Input[builtins.str] resource_arn: The Amazon Resource Name (ARN) of the account to create or update a resource policy for.
        """
