...
class _ClusterState:
    ...
    def _configure(
        ...
        if 'zookeeperConnectString' in kwargs:
            zookeeper_connect_string = kwargs['zookeeperConnectString']
        if 'zookeeperConnectStringTls' in kwargs:
