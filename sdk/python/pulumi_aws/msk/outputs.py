...
class ClusterBrokerNodeGroupInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 az_distribution: Optional[builtins.str] = None,
        ...
        """
        :param Sequence[builtins.str] client_subnets: A list of subnets to connect to in client VPC ([documentation](https://docs.aws.amazon.com/msk/1.0/apireference/clusters.html#clusters-prop-brokernodegroupinfo-clientsubnets)).
        :param builtins.str instance_type: Specify the instance type to use for the kafka brokersE.g., kafka.m5.large. ([Pricing info](https://aws.amazon.com/msk/pricing/))
        :param Sequence[builtins.str] security_groups: A list of the security groups to associate with the elastic network interfaces to control who can communicate with the cluster.
        :param builtins.str az_distribution: The distribution of broker nodes across availability zones ([documentation](https://docs.aws.amazon.com/msk/1.0/apireference/clusters.html#clusters-model-brokerazdistribution)). Currently the only valid value is `DEFAULT`.
    ...
    def az_distribution(self) -> Optional[builtins.str]:
        """
...
class ClusterBrokerNodeGroupInfoConnectivityInfoPublicAccess(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Public access type. Valid values: `DISABLED`, `SERVICE_PROVIDED_EIPS`.
        """
        if type is not None:
...
class ClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivityClientAuthentication(dict):
    def __init__(__self__, *,
        ...
        :param builtins.bool tls: Configuration block for specifying TLS client authentication. See below.
        """
        if sasl is not None:
...
class ClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivityClientAuthenticationSasl(dict):
    def __init__(__self__, *,
                 iam: Optional[builtins.bool] = None,
                 scram: Optional[builtins.bool] = None):
        if iam is not None:
    ...
    @property
    @pulumi.getter
    def iam(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "iam")

    @property
    @pulumi.getter
    def scram(self) -> Optional[builtins.bool]:
...
class ClusterBrokerNodeGroupInfoStorageInfoEbsStorageInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int volume_size: The size in GiB of the EBS volume for the data drive on each broker node. Minimum value of `1` and maximum value of `16384`.
        """
...
class ClusterClientAuthentication(dict):
    def __init__(__self__, *,
                 ...
                 unauthenticated: Optional[builtins.bool] = None):
        """
        ...
        :param builtins.bool unauthenticated: Enables unauthenticated access.
        """
        if sasl is not None:
            pulumi.set(__self__, "sasl", sasl)
        if tls is not None:
    ...
    @property
    @pulumi.getter
    def unauthenticated(self) -> Optional[builtins.bool]:
        """
...
class ClusterClientAuthenticationTls(dict):
    ...
    def __init__(__self__, *,
                 certificate_authority_arns: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] certificate_authority_arns: List of ACM Certificate Authority Amazon Resource Names (ARNs).
        """
    ...
    def certificate_authority_arns(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ClusterConfigurationInfo(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str arn: Amazon Resource Name (ARN) of the MSK Configuration to use in the cluster.
        :param builtins.int revision: Revision of the MSK Configuration to use in the cluster.
        """
...
class ClusterEncryptionInfo(dict):
    ...
    def __init__(__self__, *,
                 encryption_at_rest_kms_key_arn: Optional[builtins.str] = None,
                 encryption_in_transit: Optional['outputs.ClusterEncryptionInfoEncryptionInTransit'] = None):
        """
        :param builtins.str encryption_at_rest_kms_key_arn: You may specify a KMS key short ID or ARN (it will always output an ARN) to use for encrypting your data at rest.  If no key is specified, an AWS managed KMS ('aws/msk' managed service) key will be used for encrypting the data at rest.
    ...
    def encryption_at_rest_kms_key_arn(self) -> Optional[builtins.str]:
        """
...
class ClusterEncryptionInfoEncryptionInTransit(dict):
    ...
    def __init__(__self__, *,
                 client_broker: Optional[builtins.str] = None,
                 in_cluster: Optional[builtins.bool] = None):
        """
        :param builtins.str client_broker: Encryption setting for data in transit between clients and brokers. Valid values: `TLS`, `TLS_PLAINTEXT`, and `PLAINTEXT`. Default value is `TLS`.
        :param builtins.bool in_cluster: Whether data communication among broker nodes is encrypted. Default value: `true`.
        """
    ...
    def client_broker(self) -> Optional[builtins.str]:
        """
...
class ClusterLoggingInfoBrokerLogsCloudwatchLogs(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_group: Name of the Cloudwatch Log Group to deliver logs to.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ClusterLoggingInfoBrokerLogsFirehose(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str delivery_stream: Name of the Kinesis Data Firehose delivery stream to deliver logs to.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ClusterLoggingInfoBrokerLogsS3(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket: Name of the S3 bucket to deliver logs to.
        :param builtins.str prefix: Prefix to append to the folder name.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ReplicatorKafkaClusterVpcConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 security_groups_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] subnet_ids: The list of subnets to connect to in the virtual private cloud (VPC). AWS creates elastic network interfaces inside these subnets to allow communication between your Kafka Cluster and the replicator.
        :param Sequence[builtins.str] security_groups_ids: The AWS security groups to associate with the ENIs used by the replicator. If a security group is not specified, the default security group associated with the VPC is used.
        """
    ...
    def security_groups_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ReplicatorReplicationInfoList(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_kafka_cluster_alias: Optional[builtins.str] = None,
                 target_kafka_cluster_alias: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str source_kafka_cluster_arn: The ARN of the source Kafka cluster.
        :param builtins.str target_compression_type: The type of compression to use writing records to target Kafka cluster.
        :param builtins.str target_kafka_cluster_arn: The ARN of the target Kafka cluster.
    ...
    def source_kafka_cluster_alias(self) -> Optional[builtins.str]:
        return pulumi.get(self, "source_kafka_cluster_alias")

    @property
    @pulumi.getter(name="targetKafkaClusterAlias")
    def target_kafka_cluster_alias(self) -> Optional[builtins.str]:
...
class ReplicatorReplicationInfoListConsumerGroupReplication(dict):
    ...
    def __init__(__self__, *,
                 consumer_groups_to_replicates: Sequence[builtins.str],
                 consumer_groups_to_excludes: Optional[Sequence[builtins.str]] = None,
        ...
        """
        :param Sequence[builtins.str] consumer_groups_to_replicates: List of regular expression patterns indicating the consumer groups to copy.
        :param Sequence[builtins.str] consumer_groups_to_excludes: List of regular expression patterns indicating the consumer groups that should not be replicated.
    ...
    def consumer_groups_to_replicates(self) -> Sequence[builtins.str]:
        """
    ...
    def consumer_groups_to_excludes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ReplicatorReplicationInfoListTopicReplication(dict):
    ...
    def __init__(__self__, *,
                 topics_to_replicates: Sequence[builtins.str],
                 ...
                 topics_to_excludes: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] topics_to_replicates: List of regular expression patterns indicating the topics to copy.
        ...
        :param Sequence[builtins.str] topics_to_excludes: List of regular expression patterns indicating the topics that should not be replica.
        """
    ...
    def topics_to_replicates(self) -> Sequence[builtins.str]:
        """
    ...
    def topics_to_excludes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ReplicatorReplicationInfoListTopicReplicationStartingPosition(dict):
    def __init__(__self__, *,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str type: The type of replication starting position. Supports `LATEST` and `EARLIEST`.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class ReplicatorReplicationInfoListTopicReplicationTopicNameConfiguration(dict):
    def __init__(__self__, *,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str type: The type of topic configuration name. Supports `PREFIXED_WITH_SOURCE_CLUSTER_ALIAS` and `IDENTICAL`.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class ServerlessClusterClientAuthenticationSaslIam(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool):
        """
        :param builtins.bool enabled: Whether SASL/IAM authentication is enabled or not.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ServerlessClusterVpcConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] subnet_ids: A list of subnets in at least two different Availability Zones that host your client applications.
        :param Sequence[builtins.str] security_group_ids: Specifies up to five security groups that control inbound and outbound traffic for the serverless cluster.
        """
        pulumi.set(__self__, "subnet_ids", subnet_ids)
...
class GetBrokerNodesNodeInfoListResult(dict):
    def __init__(__self__, *,
                 attached_eni_id: builtins.str,
                 broker_id: builtins.float,
                 client_subnet: builtins.str,
                 client_vpc_ip_address: builtins.str,
                 endpoints: Sequence[builtins.str],
                 node_arn: builtins.str):
        """
        :param builtins.str attached_eni_id: Attached elastic network interface of the broker
        :param builtins.float broker_id: ID of the broker
        :param builtins.str client_subnet: Client subnet to which this broker node belongs
        :param builtins.str client_vpc_ip_address: The client virtual private cloud (VPC) IP address
        :param Sequence[builtins.str] endpoints: Set of endpoints for accessing the broker. This does not include ports
        :param builtins.str node_arn: ARN of the node
        """
    ...
    def broker_id(self) -> builtins.float:
        """
        ID of the broker
        """
...
class GetClusterBrokerNodeGroupInfoConnectivityInfoVpcConnectivityClientAuthenticationSaslResult(dict):
    ...
    @property
    @pulumi.getter
    def iam(self) -> builtins.bool:
        return pulumi.get(self, "iam")

    @property
    @pulumi.getter
    def scram(self) -> builtins.bool:
        return pulumi.get(self, "scram")
...
class GetClusterBrokerNodeGroupInfoStorageInfoEbsStorageInfoProvisionedThroughputResult(dict):
    def __init__(__self__, *,
                 enabled: builtins.bool,
                 volume_throughput: builtins.int):
        pulumi.set(__self__, "enabled", enabled)
        pulumi.set(__self__, "volume_throughput", volume_throughput)
    ...
    @property
    @pulumi.getter(name="volumeThroughput")
    def volume_throughput(self) -> builtins.int:
        return pulumi.get(self, "volume_throughput")
