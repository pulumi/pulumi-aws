...
class ScramSecretAssociationArgs:
    ...
    def secret_arn_lists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
...
class _ScramSecretAssociationState:
    ...
    @property
    @pulumi.getter(name="secretArnLists")
    def secret_arn_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of AWS Secrets Manager secret ARNs.
        """
        return pulumi.get(self, "secret_arn_lists")
    ...
    @secret_arn_lists.setter
    def secret_arn_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "secret_arn_lists", value)
...
class ScramSecretAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="secretArnLists")
    def secret_arn_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of AWS Secrets Manager secret ARNs.
        """
        return pulumi.get(self, "secret_arn_lists")
