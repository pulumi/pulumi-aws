...
class CachePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: Description for the cache policy.
        :param pulumi.Input[builtins.int] default_ttl: Amount of time, in seconds, that objects are allowed to remain in the CloudFront cache before CloudFront sends a new request to the origin server to check if the object has been updated.
        :param pulumi.Input[builtins.int] max_ttl: Maximum amount of time, in seconds, that objects stay in the CloudFront cache before CloudFront sends another request to the origin to see if the object has been updated.
        :param pulumi.Input[builtins.int] min_ttl: Minimum amount of time, in seconds, that objects should remain in the CloudFront cache before a new request is sent to the origin to check for updates.
        :param pulumi.Input[builtins.str] name: Unique name used to identify the cache policy.
        """
...
class _CachePolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The cache policy ARN.
        :param pulumi.Input[builtins.str] comment: Description for the cache policy.
        :param pulumi.Input[builtins.int] default_ttl: Amount of time, in seconds, that objects are allowed to remain in the CloudFront cache before CloudFront sends a new request to the origin server to check if the object has been updated.
        :param pulumi.Input[builtins.str] etag: Current version of the cache policy.
        :param pulumi.Input[builtins.int] max_ttl: Maximum amount of time, in seconds, that objects stay in the CloudFront cache before CloudFront sends another request to the origin to see if the object has been updated.
        :param pulumi.Input[builtins.int] min_ttl: Minimum amount of time, in seconds, that objects should remain in the CloudFront cache before a new request is sent to the origin to check for updates.
        :param pulumi.Input[builtins.str] name: Unique name used to identify the cache policy.
        :param pulumi.Input['CachePolicyParametersInCacheKeyAndForwardedToOriginArgs'] parameters_in_cache_key_and_forwarded_to_origin: Configuration for including HTTP headers, cookies, and URL query strings in the cache key. For more information, refer to the Parameters In Cache Key And Forwarded To Origin section.
...
class CachePolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="minTtl")
    def min_ttl(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Minimum amount of time, in seconds, that objects should remain in the CloudFront cache before a new request is sent to the origin to check for updates.
        """
        return pulumi.get(self, "min_ttl")
