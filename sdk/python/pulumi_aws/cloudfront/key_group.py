...
class KeyGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: A comment to describe the key group..
...
class _KeyGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: A comment to describe the key group..
        :param pulumi.Input[builtins.str] etag: The identifier for this version of the key group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] items: A list of the identifiers of the public keys in the key group.
        :param pulumi.Input[builtins.str] name: A name to identify the key group.
        """
        if comment is not None:
...
class KeyGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            etag: Optional[pulumi.Input[builtins.str]] = None,
            items: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None) -> 'KeyGroup':
        """
    ...
    @property
    @pulumi.getter
    def items(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of the identifiers of the public keys in the key group.
        """
        return pulumi.get(self, "items")
