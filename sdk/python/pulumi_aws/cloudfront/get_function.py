...
class GetFunctionResult:
    ...
    def key_value_store_associations(self) -> Sequence[builtins.str]:
        """
...
def get_function(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: Name of the CloudFront function.
    :param builtins.str stage: Function’s stage, either `DEVELOPMENT` or `LIVE`.
    """
    __args__ = dict()
    __args__['name'] = name
