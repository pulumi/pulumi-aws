...
class OriginAccessControlArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] origin_access_control_origin_type: The type of origin that this Origin Access Control is for. Valid values are `lambda`, `mediapackagev2`, `mediastore`, and `s3`.
        :param pulumi.Input[builtins.str] signing_behavior: Specifies which requests CloudFront signs. Specify `always` for the most common use case. Allowed values: `always`, `never`, and `no-override`.
        :param pulumi.Input[builtins.str] signing_protocol: Determines how CloudFront signs (authenticates) requests. The only valid value is `sigv4`.
        :param pulumi.Input[builtins.str] description: The description of the Origin Access Control. Defaults to "Managed by Pulumi" if omitted.
        :param pulumi.Input[builtins.str] name: A name that identifies the Origin Access Control.
        """
...
class _OriginAccessControlState:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 origin_access_control_origin_type: Optional[pulumi.Input[builtins.str]] = None,
                 signing_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 signing_protocol: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering OriginAccessControl resources.
        :param pulumi.Input[builtins.str] arn: The Origin Access Control ARN.
        :param pulumi.Input[builtins.str] description: The description of the Origin Access Control. Defaults to "Managed by Pulumi" if omitted.
        :param pulumi.Input[builtins.str] etag: The current version of this Origin Access Control.
        :param pulumi.Input[builtins.str] name: A name that identifies the Origin Access Control.
        :param pulumi.Input[builtins.str] origin_access_control_origin_type: The type of origin that this Origin Access Control is for. Valid values are `lambda`, `mediapackagev2`, `mediastore`, and `s3`.
        :param pulumi.Input[builtins.str] signing_behavior: Specifies which requests CloudFront signs. Specify `always` for the most common use case. Allowed values: `always`, `never`, and `no-override`.
        :param pulumi.Input[builtins.str] signing_protocol: Determines how CloudFront signs (authenticates) requests. The only valid value is `sigv4`.
    ...
    @property
    @pulumi.getter(name="originAccessControlOriginType")
    def origin_access_control_origin_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of origin that this Origin Access Control is for. Valid values are `lambda`, `mediapackagev2`, `mediastore`, and `s3`.
        """
        return pulumi.get(self, "origin_access_control_origin_type")
    ...
    @origin_access_control_origin_type.setter
    def origin_access_control_origin_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "origin_access_control_origin_type", value)

    @property
    @pulumi.getter(name="signingBehavior")
    def signing_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies which requests CloudFront signs. Specify `always` for the most common use case. Allowed values: `always`, `never`, and `no-override`.
        """
        return pulumi.get(self, "signing_behavior")
    ...
    @signing_behavior.setter
    def signing_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "signing_behavior", value)

    @property
    @pulumi.getter(name="signingProtocol")
    def signing_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines how CloudFront signs (authenticates) requests. The only valid value is `sigv4`.
        """
        return pulumi.get(self, "signing_protocol")
    ...
    @signing_protocol.setter
    def signing_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "signing_protocol", value)
...
class OriginAccessControl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            origin_access_control_origin_type: Optional[pulumi.Input[builtins.str]] = None,
            signing_behavior: Optional[pulumi.Input[builtins.str]] = None,
            signing_protocol: Optional[pulumi.Input[builtins.str]] = None) -> 'OriginAccessControl':
        """
    ...
    @property
    @pulumi.getter(name="originAccessControlOriginType")
    def origin_access_control_origin_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of origin that this Origin Access Control is for. Valid values are `lambda`, `mediapackagev2`, `mediastore`, and `s3`.
        """
        return pulumi.get(self, "origin_access_control_origin_type")
    ...
    @property
    @pulumi.getter(name="signingBehavior")
    def signing_behavior(self) -> pulumi.Output[builtins.str]:
        """
        Specifies which requests CloudFront signs. Specify `always` for the most common use case. Allowed values: `always`, `never`, and `no-override`.
        """
        return pulumi.get(self, "signing_behavior")
    ...
    @property
    @pulumi.getter(name="signingProtocol")
    def signing_protocol(self) -> pulumi.Output[builtins.str]:
        """
        Determines how CloudFront signs (authenticates) requests. The only valid value is `sigv4`.
        """
        return pulumi.get(self, "signing_protocol")
