...
class KeyValueStoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Unique name for your CloudFront KeyValueStore.
...
class _KeyValueStoreState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) identifying your CloudFront KeyValueStore.
        :param pulumi.Input[builtins.str] comment: Comment.
        :param pulumi.Input[builtins.str] etag: ETag hash of the KeyValueStore.
        :param pulumi.Input[builtins.str] name: Unique name for your CloudFront KeyValueStore.
