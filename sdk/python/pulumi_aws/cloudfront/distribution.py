...
class DistributionArgs:
    ...
    def _configure(
        ...
        if 'orderedCacheBehaviors' in kwargs:
...
class _DistributionState:
    ...
    def _configure(
        ...
        if 'httpVersion' in kwargs:
            http_version = kwargs['httpVersion']
        if 'inProgressValidationBatches' in kwargs:
...
class Distribution(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if logging_config is not None and not isinstance(logging_config, DistributionLoggingConfigArgs):
                logging_config = logging_config or {}
                def _setter(key, value):
                    logging_config[key] = value
                DistributionLoggingConfigArgs._configure(_setter, **logging_config)
            ...
            if restrictions is not None and not isinstance(restrictions, DistributionRestrictionsArgs):
                restrictions = restrictions or {}
                def _setter(key, value):
                    restrictions[key] = value
                DistributionRestrictionsArgs._configure(_setter, **restrictions)
            ...
            if viewer_certificate is not None and not isinstance(viewer_certificate, DistributionViewerCertificateArgs):
                viewer_certificate = viewer_certificate or {}
                def _setter(key, value):
                    viewer_certificate[key] = value
                DistributionViewerCertificateArgs._configure(_setter, **viewer_certificate)
