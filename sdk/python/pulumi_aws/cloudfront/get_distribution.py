...
class GetDistributionResult:
    ...
    def in_progress_validation_batches(self) -> builtins.int:
        """
...
def get_distribution(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: Identifier for the distribution. For example: `EDFDVBD632BHDS5`.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['tags'] = tags
...
def get_distribution_output(id: Optional[pulumi.Input[builtins.str]] = None,
