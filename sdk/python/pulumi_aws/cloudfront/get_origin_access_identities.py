...
class GetOriginAccessIdentitiesResult:
    ...
    @property
    @pulumi.getter
    def comments(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "comments")

    @property
    @pulumi.getter(name="iamArns")
    def iam_arns(self) -> Sequence[builtins.str]:
        """
    ...
    def s3_canonical_user_ids(self) -> Sequence[builtins.str]:
        """
...
def get_origin_access_identities(comments: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] comments: Filter origin access identities by comment.
    """
    __args__ = dict()
...
def get_origin_access_identities_output(comments: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
