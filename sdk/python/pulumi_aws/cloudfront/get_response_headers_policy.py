...
def get_response_headers_policy(id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: Identifier for the response headers policy.
    :param _builtins.str name: Unique name to identify the response headers policy.
    """
    __args__ = dict()
    __args__['id'] = id
    __args__['name'] = name
...
def get_response_headers_policy_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
