...
class PublicKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] encoded_key: The encoded public key that you want to add to CloudFront to use with features like field-level encryption.
        :param pulumi.Input[_builtins.str] comment: An optional comment about the public key.
        :param pulumi.Input[_builtins.str] name: The name for the public key. By default generated by this provider. Note: Do not set if using the key's id in another resource (e.g. KeyGroup) since it will result in a dependency error from AWS. Instead, it is recommended to use Pulumi autonaming by leaving this property unset (default behavior) or set the `namePrefix` property to allow the provider to autoname the resource.
        :param pulumi.Input[_builtins.str] name_prefix: The name for the public key. Conflicts with `name`.
...
class _PublicKeyState:
    def __init__(__self__, *,
                 ...
                 comment: pulumi.Input[Optional[_builtins.str]] = None,
                 encoded_key: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] caller_reference: Internal value used by CloudFront to allow future updates to the public key configuration.
        :param pulumi.Input[_builtins.str] comment: An optional comment about the public key.
        :param pulumi.Input[_builtins.str] encoded_key: The encoded public key that you want to add to CloudFront to use with features like field-level encryption.
        :param pulumi.Input[_builtins.str] etag: The current version of the public key. For example: `E2QWRUHAPOMQZL`.
        :param pulumi.Input[_builtins.str] name: The name for the public key. By default generated by this provider. Note: Do not set if using the key's id in another resource (e.g. KeyGroup) since it will result in a dependency error from AWS. Instead, it is recommended to use Pulumi autonaming by leaving this property unset (default behavior) or set the `namePrefix` property to allow the provider to autoname the resource.
        :param pulumi.Input[_builtins.str] name_prefix: The name for the public key. Conflicts with `name`.
    ...
    @_builtins.property
    @pulumi.getter(name="encodedKey")
    def encoded_key(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The encoded public key that you want to add to CloudFront to use with features like field-level encryption.
        """
        return pulumi.get(self, "encoded_key")
    ...
    @encoded_key.setter
    def encoded_key(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "encoded_key", value)
...
class PublicKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            etag: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            name_prefix: pulumi.Input[Optional[_builtins.str]] = None) -> 'PublicKey':
        """
