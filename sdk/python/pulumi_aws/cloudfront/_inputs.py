...
if not MYPY:
    class CachePolicyParametersInCacheKeyAndForwardedToOriginArgsDict(TypedDict):
        ...
        """
        enable_accept_encoding_gzip: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class CachePolicyParametersInCacheKeyAndForwardedToOriginArgs:
    def __init__(__self__, *,
                 ...
                 enable_accept_encoding_gzip: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] enable_accept_encoding_brotli: Flag determines whether the Accept-Encoding HTTP header is included in the cache key and in requests that CloudFront sends to the origin.
        :param pulumi.Input[builtins.bool] enable_accept_encoding_gzip: Whether the Accept-Encoding HTTP header is included in the cache key and in requests sent to the origin by CloudFront.
        """
    ...
    def enable_accept_encoding_gzip(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the Accept-Encoding HTTP header is included in the cache key and in requests sent to the origin by CloudFront.
        """
    ...
    def enable_accept_encoding_gzip(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class CachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] cookie_behavior: Whether any cookies in viewer requests are included in the cache key and automatically included in requests that CloudFront sends to the origin. Valid values for `cookie_behavior` are `none`, `whitelist`, `allExcept`, and `all`.
...
if not MYPY:
    class CachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfigCookiesArgsDict(TypedDict):
        items: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class CachePolicyParametersInCacheKeyAndForwardedToOriginCookiesConfigCookiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] items: List of item names, such as cookies, headers, or query strings.
        """
...
if not MYPY:
    class CachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfigArgsDict(TypedDict):
        header_behavior: NotRequired[pulumi.Input[builtins.str]]
        """
...
class CachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfigArgs:
    def __init__(__self__, *,
                 header_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 headers: Optional[pulumi.Input['CachePolicyParametersInCacheKeyAndForwardedToOriginHeadersConfigHeadersArgs']] = None):
        """
        :param pulumi.Input[builtins.str] header_behavior: Whether any HTTP headers are included in the cache key and automatically included in requests that CloudFront sends to the origin. Valid values for `header_behavior` are `none` and `whitelist`.
    ...
    def header_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Whether any HTTP headers are included in the cache key and automatically included in requests that CloudFront sends to the origin. Valid values for `header_behavior` are `none` and `whitelist`.
        """
    ...
    def header_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
...
class CachePolicyParametersInCacheKeyAndForwardedToOriginQueryStringsConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] query_string_behavior: Whether URL query strings in viewer requests are included in the cache key and automatically included in requests that CloudFront sends to the origin. Valid values for `query_string_behavior` are `none`, `whitelist`, `allExcept`, and `all`.
...
class ContinuousDeploymentPolicyStagingDistributionDnsNamesArgs:
    def __init__(__self__, *,
                 ...
                 items: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.int] quantity: Number of CloudFront domain names in the staging distribution.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] items: A list of CloudFront domain names for the staging distribution.
        """
...
class ContinuousDeploymentPolicyTrafficConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Type of traffic configuration. Valid values are `SingleWeight` and `SingleHeader`.
...
class ContinuousDeploymentPolicyTrafficConfigSingleHeaderConfigArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] header: Request header name to send to the staging distribution. The header must contain the prefix `aws-cf-cd-`.
...
class ContinuousDeploymentPolicyTrafficConfigSingleWeightConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] weight: The percentage of traffic to send to a staging distribution, expressed as a decimal number between `0` and `.15`.
...
class ContinuousDeploymentPolicyTrafficConfigSingleWeightConfigSessionStickinessConfigArgs:
    def __init__(__self__, *,
                 ...
                 maximum_ttl: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] idle_ttl: The amount of time in seconds after which sessions will cease if no requests are received. Valid values are `300` – `3600` (5–60 minutes). The value must be less than or equal to `maximum_ttl`.
        :param pulumi.Input[builtins.int] maximum_ttl: The maximum amount of time in seconds to consider requests from the viewer as being part of the same session. Valid values are `300` – `3600` (5–60 minutes). The value must be greater than or equal to `idle_ttl`.
        """
...
if not MYPY:
    class DistributionCustomErrorResponseArgsDict(TypedDict):
        ...
        """
        error_caching_min_ttl: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DistributionCustomErrorResponseArgs:
    def __init__(__self__, *,
                 error_code: pulumi.Input[builtins.int],
                 error_caching_min_ttl: Optional[pulumi.Input[builtins.int]] = None,
                 response_code: Optional[pulumi.Input[builtins.int]] = None,
                 response_page_path: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] error_code: 4xx or 5xx HTTP status code that you want to customize.
        :param pulumi.Input[builtins.int] error_caching_min_ttl: Minimum amount of time you want HTTP error codes to stay in CloudFront caches before CloudFront queries your origin to see whether the object has been updated.
        :param pulumi.Input[builtins.int] response_code: HTTP status code that you want CloudFront to return with the custom error page to the viewer.
        :param pulumi.Input[builtins.str] response_page_path: Path of the custom error page (for example, `/custom_404.html`).
        """
    ...
    def error_caching_min_ttl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Minimum amount of time you want HTTP error codes to stay in CloudFront caches before CloudFront queries your origin to see whether the object has been updated.
        """
    ...
    def error_caching_min_ttl(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class DistributionDefaultCacheBehaviorArgsDict(TypedDict):
        ...
        """
        cached_methods: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        min_ttl: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DistributionDefaultCacheBehaviorArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: Controls which HTTP methods CloudFront processes and forwards to your Amazon S3 bucket or your custom origin.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cached_methods: Controls whether CloudFront caches the response to requests using the specified HTTP methods.
        :param pulumi.Input[builtins.str] target_origin_id: Value of ID for the origin that you want CloudFront to route requests to when a request matches the path pattern either for a cache behavior or for the default cache behavior.
        :param pulumi.Input[builtins.str] viewer_protocol_policy: Use this element to specify the protocol that users can use to access the files in the origin specified by TargetOriginId when a request matches the path pattern in PathPattern. One of `allow-all`, `https-only`, or `redirect-to-https`.
        :param pulumi.Input[builtins.str] cache_policy_id: Unique identifier of the cache policy that is attached to the cache behavior. If configuring the `default_cache_behavior` either `cache_policy_id` or `forwarded_values` must be set.
        :param pulumi.Input[builtins.bool] compress: Whether you want CloudFront to automatically compress content for web requests that include `Accept-Encoding: gzip` in the request header (default: `false`).
        :param pulumi.Input[builtins.int] default_ttl: Default amount of time (in seconds) that an object is in a CloudFront cache before CloudFront forwards another request in the absence of an `Cache-Control max-age` or `Expires` header. The TTL defined in Cache Policy overrides this configuration.
        :param pulumi.Input[builtins.str] field_level_encryption_id: Field level encryption configuration ID.
        ...
        :param pulumi.Input[builtins.int] max_ttl: Maximum amount of time (in seconds) that an object is in a CloudFront cache before CloudFront forwards another request to your origin to determine whether the object has been updated. Only effective in the presence of `Cache-Control max-age`, `Cache-Control s-maxage`, and `Expires` headers. The TTL defined in Cache Policy overrides this configuration.
        :param pulumi.Input[builtins.int] min_ttl: Minimum amount of time that you want objects to stay in CloudFront caches before CloudFront queries your origin to see whether the object has been updated. Defaults to 0 seconds. The TTL defined in Cache Policy overrides this configuration.
        :param pulumi.Input[builtins.str] origin_request_policy_id: Unique identifier of the origin request policy that is attached to the behavior.
        :param pulumi.Input[builtins.str] realtime_log_config_arn: ARN of the real-time log configuration that is attached to this cache behavior.
        :param pulumi.Input[builtins.str] response_headers_policy_id: Identifier for a response headers policy.
        :param pulumi.Input[builtins.bool] smooth_streaming: Indicates whether you want to distribute media files in Microsoft Smooth Streaming format using the origin that is associated with this cache behavior.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trusted_key_groups: List of nested attributes for active trusted key groups, if the distribution is set up to serve private content with signed URLs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trusted_signers: List of nested attributes for active trusted signers, if the distribution is set up to serve private content with signed URLs.
        """
    ...
    def cached_methods(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        Controls whether CloudFront caches the response to requests using the specified HTTP methods.
        """
    ...
    def cached_methods(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class DistributionDefaultCacheBehaviorForwardedValuesArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] query_string: Indicates whether you want CloudFront to forward query strings to the origin that is associated with this cache behavior.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] headers: Headers, if any, that you want CloudFront to vary upon for this cache behavior. Specify `*` to include all headers.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] query_string_cache_keys: When specified, along with a value of `true` for `query_string`, all query strings are forwarded, however only the query string keys listed in this argument are cached. When omitted with a value of `true` for `query_string`, all query string keys are cached.
        """
        pulumi.set(__self__, "cookies", cookies)
...
class DistributionDefaultCacheBehaviorForwardedValuesCookiesArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] forward: Whether you want CloudFront to forward cookies to the origin that is associated with this cache behavior. You can specify `all`, `none` or `whitelist`. If `whitelist`, you must include the subsequent `whitelisted_names`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] whitelisted_names: If you have specified `whitelist` to `forward`, the whitelisted cookies that you want CloudFront to forward to your origin.
        """
...
class DistributionDefaultCacheBehaviorFunctionAssociationArgs:
    def __init__(__self__, *,
                 ...
                 function_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] event_type: Specific event to trigger this function. Valid values: `viewer-request` or `viewer-response`.
        :param pulumi.Input[builtins.str] function_arn: ARN of the CloudFront function.
        """
...
class DistributionDefaultCacheBehaviorLambdaFunctionAssociationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] event_type: Specific event to trigger this function. Valid values: `viewer-request`, `origin-request`, `viewer-response`, `origin-response`.
        :param pulumi.Input[builtins.str] lambda_arn: ARN of the Lambda function.
        :param pulumi.Input[builtins.bool] include_body: When set to true it exposes the request body to the lambda function. Defaults to false. Valid values: `true`, `false`.
        """
        pulumi.set(__self__, "event_type", event_type)
...
class DistributionLoggingConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: Amazon S3 bucket to store the access logs in, for example, `myawslogbucket.s3.amazonaws.com`. The bucket must have correct ACL attached with "FULL_CONTROL" permission for "awslogsdelivery" account (Canonical ID: "c4c1ede66af53448b93c283ce9448c4ba468c9432aa01d700d3878632f77d2d0") for log transfer to work.
        :param pulumi.Input[builtins.bool] include_cookies: Whether to include cookies in access logs (default: `false`).
        :param pulumi.Input[builtins.str] prefix: Prefix to the access log filenames for this distribution, for example, `myprefix/`.
        """
...
class DistributionOrderedCacheBehaviorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: Controls which HTTP methods CloudFront processes and forwards to your Amazon S3 bucket or your custom origin.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cached_methods: Controls whether CloudFront caches the response to requests using the specified HTTP methods.
        :param pulumi.Input[builtins.str] path_pattern: Pattern (for example, `images/*.jpg`) that specifies which requests you want this cache behavior to apply to.
        :param pulumi.Input[builtins.str] target_origin_id: Value of ID for the origin that you want CloudFront to route requests to when a request matches the path pattern either for a cache behavior or for the default cache behavior.
        :param pulumi.Input[builtins.str] viewer_protocol_policy: Use this element to specify the protocol that users can use to access the files in the origin specified by TargetOriginId when a request matches the path pattern in PathPattern. One of `allow-all`, `https-only`, or `redirect-to-https`.
        :param pulumi.Input[builtins.str] cache_policy_id: Unique identifier of the cache policy that is attached to the cache behavior. If configuring the `default_cache_behavior` either `cache_policy_id` or `forwarded_values` must be set.
        :param pulumi.Input[builtins.bool] compress: Whether you want CloudFront to automatically compress content for web requests that include `Accept-Encoding: gzip` in the request header (default: `false`).
...
class DistributionOriginArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] domain_name: Domain name corresponding to the distribution. For example: `d604721fxaaqy9.cloudfront.net`.
        :param pulumi.Input[builtins.int] connection_attempts: Number of times that CloudFront attempts to connect to the origin. Must be between 1-3. Defaults to 3.
        :param pulumi.Input[builtins.int] connection_timeout: Number of seconds that CloudFront waits when trying to establish a connection to the origin. Must be between 1-10. Defaults to 10.
        ...
        :param pulumi.Input[builtins.str] origin_access_control_id: Unique identifier of a [CloudFront origin access control][8] for this origin.
        :param pulumi.Input[builtins.str] origin_path: Optional element that causes CloudFront to request your content from a directory in your Amazon S3 bucket or your custom origin.
...
if not MYPY:
    class DistributionOriginCustomOriginConfigArgsDict(TypedDict):
        http_port: pulumi.Input[builtins.int]
        """
        HTTP port the custom origin listens on.
        """
        https_port: pulumi.Input[builtins.int]
        """
...
class DistributionOriginCustomOriginConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] http_port: HTTP port the custom origin listens on.
        :param pulumi.Input[builtins.int] https_port: HTTPS port the custom origin listens on.
        :param pulumi.Input[builtins.str] origin_protocol_policy: Origin protocol policy to apply to your origin. One of `http-only`, `https-only`, or `match-viewer`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] origin_ssl_protocols: List of SSL/TLS protocols that CloudFront can use when connecting to your origin over HTTPS. Valid values: `SSLv3`, `TLSv1`, `TLSv1.1`, `TLSv1.2`. For more information, see [Minimum Origin SSL Protocol](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/distribution-web-values-specify.html#DownloadDistValuesOriginSSLProtocols) in the Amazon CloudFront Developer Guide.
        """
    ...
    def http_port(self) -> pulumi.Input[builtins.int]:
        """
        HTTP port the custom origin listens on.
        """
    ...
    @http_port.setter
    def http_port(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "http_port", value)

    @property
    @pulumi.getter(name="httpsPort")
    def https_port(self) -> pulumi.Input[builtins.int]:
        """
        HTTPS port the custom origin listens on.
        """
    ...
    @https_port.setter
    def https_port(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class DistributionOriginGroupFailoverCriteriaArgsDict(TypedDict):
        status_codes: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]
        """
...
class DistributionOriginGroupFailoverCriteriaArgs:
    def __init__(__self__, *,
                 status_codes: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.int]]] status_codes: List of HTTP status codes for the origin group.
        """
        pulumi.set(__self__, "status_codes", status_codes)

    @property
    @pulumi.getter(name="statusCodes")
    def status_codes(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.int]]]:
        """
        List of HTTP status codes for the origin group.
        """
    ...
    @status_codes.setter
    def status_codes(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.int]]]):
...
if not MYPY:
    class DistributionOriginS3OriginConfigArgsDict(TypedDict):
        origin_access_identity: pulumi.Input[builtins.str]
        """
...
class DistributionOriginS3OriginConfigArgs:
    def __init__(__self__, *,
                 origin_access_identity: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] origin_access_identity: The CloudFront origin access identity to associate with the origin.
        """
        pulumi.set(__self__, "origin_access_identity", origin_access_identity)

    @property
    @pulumi.getter(name="originAccessIdentity")
    def origin_access_identity(self) -> pulumi.Input[builtins.str]:
        """
        The CloudFront origin access identity to associate with the origin.
        """
    ...
    def origin_access_identity(self, value: pulumi.Input[builtins.str]):
...
class DistributionRestrictionsGeoRestrictionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] restriction_type: Method that you want to use to restrict distribution of your content by country: `none`, `whitelist`, or `blacklist`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] locations: [ISO 3166-1-alpha-2 codes][4] for which you want CloudFront either to distribute your content (`whitelist`) or not distribute your content (`blacklist`). If the type is specified as `none` an empty array can be used.
        """
...
if not MYPY:
    class DistributionTrustedKeyGroupItemArgsDict(TypedDict):
        key_group_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ID of the key group that contains the public keys.
        """
        key_pair_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DistributionTrustedKeyGroupItemArgs:
    def __init__(__self__, *,
                 key_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 key_pair_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] key_group_id: ID of the key group that contains the public keys.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] key_pair_ids: Set of active CloudFront key pairs associated with the signer account
        """
    ...
    def key_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the key group that contains the public keys.
        """
    ...
    @key_group_id.setter
    def key_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "key_group_id", value)

    @property
    @pulumi.getter(name="keyPairIds")
    def key_pair_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Set of active CloudFront key pairs associated with the signer account
        """
    ...
    @key_pair_ids.setter
    def key_pair_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class DistributionTrustedSignerItemArgsDict(TypedDict):
        aws_account_number: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DistributionTrustedSignerItemArgs:
    def __init__(__self__, *,
                 aws_account_number: Optional[pulumi.Input[builtins.str]] = None,
                 key_pair_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] aws_account_number: AWS account ID or `self`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] key_pair_ids: Set of active CloudFront key pairs associated with the signer account
        """
    ...
    def aws_account_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        AWS account ID or `self`
        """
    ...
    def aws_account_number(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DistributionViewerCertificateArgsDict(TypedDict):
        ...
        """
        cloudfront_default_certificate: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DistributionViewerCertificateArgs:
    def __init__(__self__, *,
                 ...
                 cloudfront_default_certificate: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] acm_certificate_arn: ARN of the [AWS Certificate Manager](https://aws.amazon.com/certificate-manager/) certificate that you wish to use with this distribution. Specify this, `cloudfront_default_certificate`, or `iam_certificate_id`.  The ACM certificate must be in  US-EAST-1.
        :param pulumi.Input[builtins.bool] cloudfront_default_certificate: `true` if you want viewers to use HTTPS to request your objects and you're using the CloudFront domain name for your distribution. Specify this, `acm_certificate_arn`, or `iam_certificate_id`.
        :param pulumi.Input[builtins.str] iam_certificate_id: IAM certificate identifier of the custom viewer certificate for this distribution if you are using a custom domain. Specify this, `acm_certificate_arn`, or `cloudfront_default_certificate`.
        :param pulumi.Input[builtins.str] minimum_protocol_version: Minimum version of the SSL protocol that you want CloudFront to use for HTTPS connections. Can only be set if `cloudfront_default_certificate = false`. See all possible values in [this](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/secure-connections-supported-viewer-protocols-ciphers.html) table under "Security policy." Some examples include: `TLSv1.2_2019` and `TLSv1.2_2021`. Default: `TLSv1`. **NOTE**: If you are using a custom certificate (specified with `acm_certificate_arn` or `iam_certificate_id`), and have specified `sni-only` in `ssl_support_method`, `TLSv1` or later must be specified. If you have specified `vip` in `ssl_support_method`, only `SSLv3` or `TLSv1` can be specified. If you have specified `cloudfront_default_certificate`, `TLSv1` must be specified.
        :param pulumi.Input[builtins.str] ssl_support_method: How you want CloudFront to serve HTTPS requests. One of `vip`, `sni-only`, or `static-ip`. Required if you specify `acm_certificate_arn` or `iam_certificate_id`. **NOTE:** `vip` causes CloudFront to use a dedicated IP address and may incur extra charges.
        """
    ...
    def cloudfront_default_certificate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        `true` if you want viewers to use HTTPS to request your objects and you're using the CloudFront domain name for your distribution. Specify this, `acm_certificate_arn`, or `iam_certificate_id`.
        """
    ...
    def cloudfront_default_certificate(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class FieldLevelEncryptionConfigContentTypeProfileConfigArgsDict(TypedDict):
        ...
        """
        forward_when_content_type_is_unknown: pulumi.Input[builtins.bool]
        """
...
class FieldLevelEncryptionConfigContentTypeProfileConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] forward_when_content_type_is_unknown: specifies what to do when an unknown content type is provided for the profile. If true, content is forwarded without being encrypted when the content type is unknown. If false (the default), an error is returned when the content type is unknown.
        """
    ...
    def forward_when_content_type_is_unknown(self) -> pulumi.Input[builtins.bool]:
        """
        specifies what to do when an unknown content type is provided for the profile. If true, content is forwarded without being encrypted when the content type is unknown. If false (the default), an error is returned when the content type is unknown.
        """
    ...
    def forward_when_content_type_is_unknown(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfilesItemArgsDict(TypedDict):
        ...
        """
        profile_id: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class FieldLevelEncryptionConfigContentTypeProfileConfigContentTypeProfilesItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content_type: he content type for a field-level encryption content type-profile mapping. Valid value is `application/x-www-form-urlencoded`.
        :param pulumi.Input[builtins.str] format: The format for a field-level encryption content type-profile mapping. Valid value is `URLEncoded`.
        """
...
if not MYPY:
    class FieldLevelEncryptionConfigQueryArgProfileConfigArgsDict(TypedDict):
        forward_when_query_arg_profile_is_unknown: pulumi.Input[builtins.bool]
        """
...
class FieldLevelEncryptionConfigQueryArgProfileConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] forward_when_query_arg_profile_is_unknown: Flag to set if you want a request to be forwarded to the origin even if the profile specified by the field-level encryption query argument, fle-profile, is unknown.
    ...
    def forward_when_query_arg_profile_is_unknown(self) -> pulumi.Input[builtins.bool]:
        """
        Flag to set if you want a request to be forwarded to the origin even if the profile specified by the field-level encryption query argument, fle-profile, is unknown.
        """
    ...
    def forward_when_query_arg_profile_is_unknown(self, value: pulumi.Input[builtins.bool]):
...
if not MYPY:
    class FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfilesItemArgsDict(TypedDict):
        ...
        query_arg: pulumi.Input[builtins.str]
        """
...
class FieldLevelEncryptionConfigQueryArgProfileConfigQueryArgProfilesItemArgs:
    def __init__(__self__, *,
                 ...
                 query_arg: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] query_arg: Query argument for field-level encryption query argument-profile mapping.
        """
        pulumi.set(__self__, "profile_id", profile_id)
    ...
    def query_arg(self) -> pulumi.Input[builtins.str]:
        """
        Query argument for field-level encryption query argument-profile mapping.
        """
    ...
    @query_arg.setter
    def query_arg(self, value: pulumi.Input[builtins.str]):
...
class FieldLevelEncryptionProfileEncryptionEntitiesItemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] provider_id: The provider associated with the public key being used for encryption.
        :param pulumi.Input[builtins.str] public_key_id: The public key associated with a set of field-level encryption patterns, to be used when encrypting the fields that match the patterns.
        """
...
if not MYPY:
    class MonitoringSubscriptionMonitoringSubscriptionRealtimeMetricsSubscriptionConfigArgsDict(TypedDict):
        realtime_metrics_subscription_status: pulumi.Input[builtins.str]
        """
...
class MonitoringSubscriptionMonitoringSubscriptionRealtimeMetricsSubscriptionConfigArgs:
    def __init__(__self__, *,
                 realtime_metrics_subscription_status: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] realtime_metrics_subscription_status: A flag that indicates whether additional CloudWatch metrics are enabled for a given CloudFront distribution. Valid values are `Enabled` and `Disabled`. See below.
        """
    ...
    def realtime_metrics_subscription_status(self) -> pulumi.Input[builtins.str]:
        """
        A flag that indicates whether additional CloudWatch metrics are enabled for a given CloudFront distribution. Valid values are `Enabled` and `Disabled`. See below.
        """
    ...
    def realtime_metrics_subscription_status(self, value: pulumi.Input[builtins.str]):
...
class RealtimeLogConfigEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] stream_type: The type of data stream where real-time log data is sent. The only valid value is `Kinesis`.
        """
...
class RealtimeLogConfigEndpointKinesisStreamConfigArgs:
    def __init__(__self__, *,
                 ...
                 stream_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] role_arn: The ARN of an IAM role that CloudFront can use to send real-time log data to the Kinesis data stream.
               See the [AWS documentation](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/real-time-logs.html#understand-real-time-log-config-iam-role) for more information.
        :param pulumi.Input[builtins.str] stream_arn: The ARN of the Kinesis data stream.
        """
...
class ResponseHeadersPolicyCorsConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] access_control_allow_credentials: A Boolean value that CloudFront uses as the value for the `Access-Control-Allow-Credentials` HTTP response header.
        ...
        :param pulumi.Input[builtins.bool] origin_override: A Boolean value that determines how CloudFront behaves for the HTTP response header.
...
class ResponseHeadersPolicySecurityHeadersConfigContentSecurityPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] override: Whether CloudFront overrides the `Content-Security-Policy` HTTP response header received from the origin with the one specified in this response headers policy.
        """
        pulumi.set(__self__, "content_security_policy", content_security_policy)
        pulumi.set(__self__, "override", override)
...
class ResponseHeadersPolicySecurityHeadersConfigContentTypeOptionsArgs:
    def __init__(__self__, *,
                 override: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] override: Whether CloudFront overrides the `X-Content-Type-Options` HTTP response header received from the origin with the one specified in this response headers policy.
        """
        pulumi.set(__self__, "override", override)
...
class ResponseHeadersPolicySecurityHeadersConfigFrameOptionsArgs:
    def __init__(__self__, *,
                 ...
                 override: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.str] frame_option: The value of the `X-Frame-Options` HTTP response header. Valid values: `DENY` | `SAMEORIGIN`
        :param pulumi.Input[builtins.bool] override: Whether CloudFront overrides the `X-Frame-Options` HTTP response header received from the origin with the one specified in this response headers policy.
        """
...
class ResponseHeadersPolicySecurityHeadersConfigReferrerPolicyArgs:
    def __init__(__self__, *,
                 ...
                 referrer_policy: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.bool] override: Whether CloudFront overrides the `Referrer-Policy` HTTP response header received from the origin with the one specified in this response headers policy.
        :param pulumi.Input[builtins.str] referrer_policy: The value of the `Referrer-Policy` HTTP response header. Valid Values: `no-referrer` | `no-referrer-when-downgrade` | `origin` | `origin-when-cross-origin` | `same-origin` | `strict-origin` | `strict-origin-when-cross-origin` | `unsafe-url`
        """
        pulumi.set(__self__, "override", override)
        pulumi.set(__self__, "referrer_policy", referrer_policy)
...
class ResponseHeadersPolicySecurityHeadersConfigStrictTransportSecurityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] override: Whether CloudFront overrides the `Strict-Transport-Security` HTTP response header received from the origin with the one specified in this response headers policy.
        :param pulumi.Input[builtins.bool] include_subdomains: Whether CloudFront includes the `includeSubDomains` directive in the `Strict-Transport-Security` HTTP response header.
        :param pulumi.Input[builtins.bool] preload: Whether CloudFront includes the `preload` directive in the `Strict-Transport-Security` HTTP response header.
        """
        pulumi.set(__self__, "access_control_max_age_sec", access_control_max_age_sec)
        pulumi.set(__self__, "override", override)
...
class ResponseHeadersPolicySecurityHeadersConfigXssProtectionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] override: Whether CloudFront overrides the `X-XSS-Protection` HTTP response header received from the origin with the one specified in this response headers policy.
        :param pulumi.Input[builtins.bool] protection: A Boolean value that determines the value of the `X-XSS-Protection` HTTP response header. When this setting is `true`, the value of the `X-XSS-Protection` header is `1`. When this setting is `false`, the value of the `X-XSS-Protection` header is `0`.
        :param pulumi.Input[builtins.bool] mode_block: Whether CloudFront includes the `mode=block` directive in the `X-XSS-Protection` header.
        :param pulumi.Input[builtins.str] report_uri: A reporting URI, which CloudFront uses as the value of the report directive in the `X-XSS-Protection` header. You cannot specify a `report_uri` when `mode_block` is `true`.
        """
        pulumi.set(__self__, "override", override)
...
if not MYPY:
    class ResponseHeadersPolicyServerTimingHeadersConfigArgsDict(TypedDict):
        ...
        """
        sampling_rate: pulumi.Input[builtins.float]
        """
...
class ResponseHeadersPolicyServerTimingHeadersConfigArgs:
    def __init__(__self__, *,
                 ...
                 sampling_rate: pulumi.Input[builtins.float]):
        """
        :param pulumi.Input[builtins.bool] enabled: A Whether CloudFront adds the `Server-Timing` header to HTTP responses that it sends in response to requests that match a cache behavior that's associated with this response headers policy.
        :param pulumi.Input[builtins.float] sampling_rate: A number 0–100 (inclusive) that specifies the percentage of responses that you want CloudFront to add the Server-Timing header to. Valid range: Minimum value of 0.0. Maximum value of 100.0.
        """
        pulumi.set(__self__, "enabled", enabled)
    ...
    def sampling_rate(self) -> pulumi.Input[builtins.float]:
        """
        A number 0–100 (inclusive) that specifies the percentage of responses that you want CloudFront to add the Server-Timing header to. Valid range: Minimum value of 0.0. Maximum value of 100.0.
        """
    ...
    def sampling_rate(self, value: pulumi.Input[builtins.float]):
...
class VpcOriginVpcOriginEndpointConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] http_port: The HTTP port for the CloudFront VPC origin endpoint configuration.
        :param pulumi.Input[builtins.int] https_port: The HTTPS port for the CloudFront VPC origin endpoint configuration.
