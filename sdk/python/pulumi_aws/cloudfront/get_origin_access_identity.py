...
def get_origin_access_identity(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The identifier for the origin access identity. For example: `E1ZAKK699EOLAL`.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_origin_access_identity_output(id: Optional[pulumi.Input[builtins.str]] = None,
