...
class OriginAccessIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] comment: An optional comment for the origin access identity.
        """
...
class _OriginAccessIdentityState:
    def __init__(__self__, *,
                 ...
                 cloudfront_access_identity_path: Optional[pulumi.Input[builtins.str]] = None,
                 comment: Optional[pulumi.Input[builtins.str]] = None,
                 etag: Optional[pulumi.Input[builtins.str]] = None,
                 iam_arn: Optional[pulumi.Input[builtins.str]] = None,
                 s3_canonical_user_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering OriginAccessIdentity resources.
        :param pulumi.Input[builtins.str] arn: The origin access identity ARN.
        :param pulumi.Input[builtins.str] caller_reference: Internal value used by CloudFront to allow future
               updates to the origin access identity.
        :param pulumi.Input[builtins.str] cloudfront_access_identity_path: A shortcut to the full path for the
               origin access identity to use in CloudFront, see below.
        :param pulumi.Input[builtins.str] comment: An optional comment for the origin access identity.
        :param pulumi.Input[builtins.str] etag: The current version of the origin access identity's information.
               For example: `E2QWRUHAPOMQZL`.
        :param pulumi.Input[builtins.str] iam_arn: A pre-generated ARN for use in S3 bucket policies (see below).
               Example: `arn:aws:iam::cloudfront:user/CloudFront Origin Access Identity
               E2QWRUHAPOMQZL`.
        :param pulumi.Input[builtins.str] s3_canonical_user_id: The Amazon S3 canonical user ID for the origin
    ...
    def cloudfront_access_identity_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cloudfront_access_identity_path(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def s3_canonical_user_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def s3_canonical_user_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OriginAccessIdentity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            etag: Optional[pulumi.Input[builtins.str]] = None,
            iam_arn: Optional[pulumi.Input[builtins.str]] = None,
            s3_canonical_user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OriginAccessIdentity':
        """
    ...
    @property
    @pulumi.getter(name="cloudfrontAccessIdentityPath")
    def cloudfront_access_identity_path(self) -> pulumi.Output[builtins.str]:
        """
        A shortcut to the full path for the
        origin access identity to use in CloudFront, see below.
        """
    ...
    @property
    @pulumi.getter(name="iamArn")
    def iam_arn(self) -> pulumi.Output[builtins.str]:
        """
        A pre-generated ARN for use in S3 bucket policies (see below).
        Example: `arn:aws:iam::cloudfront:user/CloudFront Origin Access Identity
        E2QWRUHAPOMQZL`.
    ...
    @property
    @pulumi.getter(name="s3CanonicalUserId")
    def s3_canonical_user_id(self) -> pulumi.Output[builtins.str]:
        """
        The Amazon S3 canonical user ID for the origin
        access identity, which you use when giving the origin access identity read
        permission to an object in Amazon S3.
