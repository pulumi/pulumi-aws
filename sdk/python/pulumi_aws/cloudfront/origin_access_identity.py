...
class _OriginAccessIdentityState:
    def __init__(__self__, *,
                 ...
                 cloudfront_access_identity_path: pulumi.Input[Optional[_builtins.str]] = None,
                 comment: pulumi.Input[Optional[_builtins.str]] = None,
                 etag: pulumi.Input[Optional[_builtins.str]] = None,
                 iam_arn: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] cloudfront_access_identity_path: A shortcut to the full path for the
               origin access identity to use in CloudFront, see below.
        :param pulumi.Input[_builtins.str] comment: An optional comment for the origin access identity.
        :param pulumi.Input[_builtins.str] etag: The current version of the origin access identity's information.
               For example: `E2QWRUHAPOMQZL`.
        :param pulumi.Input[_builtins.str] iam_arn: A pre-generated ARN for use in S3 bucket policies (see below).
               Example: `arn:aws:iam::cloudfront:user/CloudFront Origin Access Identity
               E2QWRUHAPOMQZL`.
        :param pulumi.Input[_builtins.str] s3_canonical_user_id: The Amazon S3 canonical user ID for the origin
    ...
    def cloudfront_access_identity_path(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def cloudfront_access_identity_path(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def iam_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @iam_arn.setter
    def iam_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class OriginAccessIdentity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            etag: pulumi.Input[Optional[_builtins.str]] = None,
            iam_arn: pulumi.Input[Optional[_builtins.str]] = None,
            s3_canonical_user_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'OriginAccessIdentity':
        """
