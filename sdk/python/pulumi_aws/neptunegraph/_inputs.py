...
__all__ = [
    ...
    'PrivateGraphEndpointTimeoutsArgsDict',
]
...
class GraphVectorSearchConfigurationArgsDict(TypedDict):
    vector_search_dimension: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class GraphVectorSearchConfigurationArgs:
    def __init__(__self__, *,
                 vector_search_dimension: pulumi.Input[Optional[_builtins.int]] = None):
        """
        :param pulumi.Input[_builtins.int] vector_search_dimension: Specifies the number of dimensions for vector embeddings.  Value must be between 1 and 65,535.
        """
    ...
    def vector_search_dimension(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Specifies the number of dimensions for vector embeddings.  Value must be between 1 and 65,535.
        """
    ...
    def vector_search_dimension(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "vector_search_dimension", value)


class PrivateGraphEndpointTimeoutsArgsDict(TypedDict):
    create: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
    """
...
@pulumi.input_type
class PrivateGraphEndpointTimeoutsArgs:
    def __init__(__self__, *,
                 create: pulumi.Input[Optional[_builtins.str]] = None,
                 delete: pulumi.Input[Optional[_builtins.str]] = None):
        """
