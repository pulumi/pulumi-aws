...
class WorkgroupConfigurationArgsDict(TypedDict):
    bytes_scanned_cutoff_per_query: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    enable_minimum_encryption_configuration: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    enforce_workgroup_configuration: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    publish_cloudwatch_metrics_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    requester_pays_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class WorkgroupConfigurationArgs:
    def __init__(__self__, *,
                 bytes_scanned_cutoff_per_query: pulumi.Input[Optional[_builtins.int]] = None,
                 customer_content_encryption_configuration: pulumi.Input[Optional['WorkgroupConfigurationCustomerContentEncryptionConfigurationArgs']] = None,
                 enable_minimum_encryption_configuration: pulumi.Input[Optional[_builtins.bool]] = None,
                 enforce_workgroup_configuration: pulumi.Input[Optional[_builtins.bool]] = None,
                 engine_version: pulumi.Input[Optional['WorkgroupConfigurationEngineVersionArgs']] = None,
                 execution_role: pulumi.Input[Optional[_builtins.str]] = None,
                 identity_center_configuration: pulumi.Input[Optional['WorkgroupConfigurationIdentityCenterConfigurationArgs']] = None,
                 managed_query_results_configuration: pulumi.Input[Optional['WorkgroupConfigurationManagedQueryResultsConfigurationArgs']] = None,
                 monitoring_configuration: pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationArgs']] = None,
                 publish_cloudwatch_metrics_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 query_results_s3_access_grants_configuration: pulumi.Input[Optional['WorkgroupConfigurationQueryResultsS3AccessGrantsConfigurationArgs']] = None,
                 requester_pays_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 result_configuration: pulumi.Input[Optional['WorkgroupConfigurationResultConfigurationArgs']] = None):
        """
    ...
    def bytes_scanned_cutoff_per_query(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Integer for the upper data usage limit (cutoff) for the amount of bytes a single query in a workgroup is allowed to scan. Must be at least `10485760`.
        """
    ...
    def bytes_scanned_cutoff_per_query(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "bytes_scanned_cutoff_per_query", value)

    @_builtins.property
    @pulumi.getter(name="customerContentEncryptionConfiguration")
    def customer_content_encryption_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationCustomerContentEncryptionConfigurationArgs']]:
        """
        Configuration block to specify the KMS key that is used to encrypt the user's data stores in Athena. This setting applies to the PySpark engine for Athena notebooks. See Customer Content Encryption Configuration below.
        """
    ...
    def customer_content_encryption_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationCustomerContentEncryptionConfigurationArgs']]):
        pulumi.set(self, "customer_content_encryption_configuration", value)

    @_builtins.property
    @pulumi.getter(name="enableMinimumEncryptionConfiguration")
    def enable_minimum_encryption_configuration(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Boolean indicating whether a minimum level of encryption is enforced for the workgroup for query and calculation results written to Amazon S3.
        """
    ...
    def enable_minimum_encryption_configuration(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enable_minimum_encryption_configuration", value)

    @_builtins.property
    @pulumi.getter(name="enforceWorkgroupConfiguration")
    def enforce_workgroup_configuration(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Boolean whether the settings for the workgroup override client-side settings. For more information, see [Workgroup Settings Override Client-Side Settings](https://docs.aws.amazon.com/athena/latest/ug/workgroups-settings-override.html). Defaults to `true`.
        """
    ...
    def enforce_workgroup_configuration(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "enforce_workgroup_configuration", value)

    @_builtins.property
    @pulumi.getter(name="engineVersion")
    def engine_version(self) -> pulumi.Input[Optional['WorkgroupConfigurationEngineVersionArgs']]:
        """
        Configuration block for the Athena Engine Versioning. For more information, see [Athena Engine Versioning](https://docs.aws.amazon.com/athena/latest/ug/engine-versions.html). See Engine Version below.
        """
    ...
    def engine_version(self, value: pulumi.Input[Optional['WorkgroupConfigurationEngineVersionArgs']]):
    ...
    def identity_center_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationIdentityCenterConfigurationArgs']]:
        """
        Configuration block to set up an IAM Identity Center enabled workgroup. See Identity Center Configuration below.
        """
    ...
    def identity_center_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationIdentityCenterConfigurationArgs']]):
        pulumi.set(self, "identity_center_configuration", value)

    @_builtins.property
    @pulumi.getter(name="managedQueryResultsConfiguration")
    def managed_query_results_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationManagedQueryResultsConfigurationArgs']]:
        """
        Configuration block for storing results in Athena owned storage. See Managed Query Results Configuration below.
        """
    ...
    def managed_query_results_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationManagedQueryResultsConfigurationArgs']]):
        pulumi.set(self, "managed_query_results_configuration", value)

    @_builtins.property
    @pulumi.getter(name="monitoringConfiguration")
    def monitoring_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationArgs']]:
        """
        Configuration block for managed log persistence, delivering logs to Amazon S3 buckets, Amazon CloudWatch log groups etc. Only applicable to Apache Spark engine. See Monitoring Configuration below.
        """
    ...
    def monitoring_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationArgs']]):
        pulumi.set(self, "monitoring_configuration", value)

    @_builtins.property
    @pulumi.getter(name="publishCloudwatchMetricsEnabled")
    def publish_cloudwatch_metrics_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Boolean whether Amazon CloudWatch metrics are enabled for the workgroup. Defaults to `true`.
        """
    ...
    def publish_cloudwatch_metrics_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "publish_cloudwatch_metrics_enabled", value)

    @_builtins.property
    @pulumi.getter(name="queryResultsS3AccessGrantsConfiguration")
    def query_results_s3_access_grants_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationQueryResultsS3AccessGrantsConfigurationArgs']]:
        """
        Configuration block for S3 access grants. See Query Results S3 Access Grants Configuration below.
        """
    ...
    def query_results_s3_access_grants_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationQueryResultsS3AccessGrantsConfigurationArgs']]):
        pulumi.set(self, "query_results_s3_access_grants_configuration", value)

    @_builtins.property
    @pulumi.getter(name="requesterPaysEnabled")
    def requester_pays_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If set to true , allows members assigned to a workgroup to reference Amazon S3 Requester Pays buckets in queries. If set to false , workgroup members cannot query data from Requester Pays buckets, and queries that retrieve data from Requester Pays buckets cause an error. The default is false . For more information about Requester Pays buckets, see [Requester Pays Buckets](https://docs.aws.amazon.com/AmazonS3/latest/dev/RequesterPaysBuckets.html) in the Amazon Simple Storage Service Developer Guide.
        """
    ...
    def requester_pays_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "requester_pays_enabled", value)

    @_builtins.property
    @pulumi.getter(name="resultConfiguration")
    def result_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationResultConfigurationArgs']]:
        """
        Configuration block with result settings. See Result Configuration below.
        """
    ...
    def result_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationResultConfigurationArgs']]):
...
class WorkgroupConfigurationEngineVersionArgsDict(TypedDict):
    effective_engine_version: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    selected_engine_version: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class WorkgroupConfigurationEngineVersionArgs:
    def __init__(__self__, *,
                 effective_engine_version: pulumi.Input[Optional[_builtins.str]] = None,
                 selected_engine_version: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def effective_engine_version(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The engine version on which the query runs. If `selected_engine_version` is set to `AUTO`, the effective engine version is chosen by Athena.
        """
    ...
    def effective_engine_version(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "effective_engine_version", value)

    @_builtins.property
    @pulumi.getter(name="selectedEngineVersion")
    def selected_engine_version(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Requested engine version. Defaults to `AUTO`.
        """
    ...
    def selected_engine_version(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class WorkgroupConfigurationManagedQueryResultsConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 encryption_configuration: pulumi.Input[Optional['WorkgroupConfigurationManagedQueryResultsConfigurationEncryptionConfigurationArgs']] = None):
        """
    ...
    def encryption_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationManagedQueryResultsConfigurationEncryptionConfigurationArgs']]:
        """
        Configuration block for the encryption configuration. See Managed Query Results Encryption Configuration below.
        """
    ...
    def encryption_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationManagedQueryResultsConfigurationEncryptionConfigurationArgs']]):
...
class WorkgroupConfigurationMonitoringConfigurationArgs:
    def __init__(__self__, *,
                 cloud_watch_logging_configuration: pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationArgs']] = None,
                 managed_logging_configuration: pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfigurationArgs']] = None,
                 s3_logging_configuration: pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationS3LoggingConfigurationArgs']] = None):
        """
    ...
    def cloud_watch_logging_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationArgs']]:
        """
        Configuration block for delivering logs to Amazon CloudWatch log groups. See CloudWatch Logging Configuration below.
        """
    ...
    def cloud_watch_logging_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationArgs']]):
        pulumi.set(self, "cloud_watch_logging_configuration", value)

    @_builtins.property
    @pulumi.getter(name="managedLoggingConfiguration")
    def managed_logging_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfigurationArgs']]:
        """
        Configuration block for managed log persistence. See Managed Logging Configuration below.
        """
    ...
    def managed_logging_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationManagedLoggingConfigurationArgs']]):
        pulumi.set(self, "managed_logging_configuration", value)

    @_builtins.property
    @pulumi.getter(name="s3LoggingConfiguration")
    def s3_logging_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationS3LoggingConfigurationArgs']]:
        """
        Configuration block for delivering logs to Amazon S3 buckets. See S3 Logging Configuration below.
        """
    ...
    def s3_logging_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationMonitoringConfigurationS3LoggingConfigurationArgs']]):
...
class WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 log_types: pulumi.Input[Optional[Sequence[pulumi.Input['WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationLogTypeArgs']]]] = None):
        """
    ...
    def log_types(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationLogTypeArgs']]]]:
        """
        Repeatable block defining log types to be delivered to CloudWatch.
        """
    ...
    @log_types.setter
    def log_types(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['WorkgroupConfigurationMonitoringConfigurationCloudWatchLoggingConfigurationLogTypeArgs']]]]):
...
class WorkgroupConfigurationMonitoringConfigurationS3LoggingConfigurationArgsDict(TypedDict):
    ...
    """
    log_location: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class WorkgroupConfigurationMonitoringConfigurationS3LoggingConfigurationArgs:
    def __init__(__self__, *,
                 enabled: pulumi.Input[_builtins.bool],
                 kms_key: pulumi.Input[Optional[_builtins.str]] = None,
                 log_location: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def log_location(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Amazon S3 destination URI (`s3://bucket/prefix`) for log publishing.
        """
    ...
    @log_location.setter
    def log_location(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class WorkgroupConfigurationQueryResultsS3AccessGrantsConfigurationArgsDict(TypedDict):
    ...
    """
    create_user_level_prefix: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class WorkgroupConfigurationQueryResultsS3AccessGrantsConfigurationArgs:
    def __init__(__self__, *,
                 authentication_type: pulumi.Input[_builtins.str],
                 enable_s3_access_grants: pulumi.Input[_builtins.bool],
                 create_user_level_prefix: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def create_user_level_prefix(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        When enabled, appends the user ID as an Amazon S3 path prefix to the query result output location. Defaults to `false`.
        """
    ...
    def create_user_level_prefix(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class WorkgroupConfigurationResultConfigurationArgs:
    def __init__(__self__, *,
                 acl_configuration: pulumi.Input[Optional['WorkgroupConfigurationResultConfigurationAclConfigurationArgs']] = None,
                 encryption_configuration: pulumi.Input[Optional['WorkgroupConfigurationResultConfigurationEncryptionConfigurationArgs']] = None,
    ...
    def acl_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationResultConfigurationAclConfigurationArgs']]:
        """
        That an Amazon S3 canned ACL should be set to control ownership of stored query results. See ACL Configuration below.
        """
    ...
    def acl_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationResultConfigurationAclConfigurationArgs']]):
        pulumi.set(self, "acl_configuration", value)

    @_builtins.property
    @pulumi.getter(name="encryptionConfiguration")
    def encryption_configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationResultConfigurationEncryptionConfigurationArgs']]:
        """
        Configuration block with encryption settings. See Encryption Configuration below.
        """
        return pulumi.get(self, "encryption_configuration")
    ...
    @encryption_configuration.setter
    def encryption_configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationResultConfigurationEncryptionConfigurationArgs']]):
        pulumi.set(self, "encryption_configuration", value)
