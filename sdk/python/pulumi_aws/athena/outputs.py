...
class DatabaseAclConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str s3_acl_option: Amazon S3 canned ACL that Athena should specify when storing query results. Valid value is `BUCKET_OWNER_FULL_CONTROL`.
...
class DatabaseEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str encryption_option: Type of key; one of `SSE_S3`, `SSE_KMS`, `CSE_KMS`
        :param builtins.str kms_key: KMS key ARN or ID; required for key types `SSE_KMS` and `CSE_KMS`.
        """
...
class WorkgroupConfiguration(dict):
    ...
    def __init__(__self__, *,
                 bytes_scanned_cutoff_per_query: Optional[builtins.int] = None,
                 enforce_workgroup_configuration: Optional[builtins.bool] = None,
                 engine_version: Optional['outputs.WorkgroupConfigurationEngineVersion'] = None,
                 execution_role: Optional[builtins.str] = None,
                 publish_cloudwatch_metrics_enabled: Optional[builtins.bool] = None,
                 requester_pays_enabled: Optional[builtins.bool] = None,
                 result_configuration: Optional['outputs.WorkgroupConfigurationResultConfiguration'] = None):
        """
        :param builtins.int bytes_scanned_cutoff_per_query: Integer for the upper data usage limit (cutoff) for the amount of bytes a single query in a workgroup is allowed to scan. Must be at least `10485760`.
        :param builtins.bool enforce_workgroup_configuration: Boolean whether the settings for the workgroup override client-side settings. For more information, see [Workgroup Settings Override Client-Side Settings](https://docs.aws.amazon.com/athena/latest/ug/workgroups-settings-override.html). Defaults to `true`.
        ...
        :param builtins.str execution_role: Role used in a notebook session for accessing the user's resources.
        :param builtins.bool publish_cloudwatch_metrics_enabled: Boolean whether Amazon CloudWatch metrics are enabled for the workgroup. Defaults to `true`.
        :param builtins.bool requester_pays_enabled: If set to true , allows members assigned to a workgroup to reference Amazon S3 Requester Pays buckets in queries. If set to false , workgroup members cannot query data from Requester Pays buckets, and queries that retrieve data from Requester Pays buckets cause an error. The default is false . For more information about Requester Pays buckets, see [Requester Pays Buckets](https://docs.aws.amazon.com/AmazonS3/latest/dev/RequesterPaysBuckets.html) in the Amazon Simple Storage Service Developer Guide.
    ...
    def bytes_scanned_cutoff_per_query(self) -> Optional[builtins.int]:
        """
    ...
    def enforce_workgroup_configuration(self) -> Optional[builtins.bool]:
        """
    ...
    def publish_cloudwatch_metrics_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def requester_pays_enabled(self) -> Optional[builtins.bool]:
        """
...
class WorkgroupConfigurationEngineVersion(dict):
    ...
    def __init__(__self__, *,
                 effective_engine_version: Optional[builtins.str] = None,
                 selected_engine_version: Optional[builtins.str] = None):
        """
        :param builtins.str effective_engine_version: The engine version on which the query runs. If `selected_engine_version` is set to `AUTO`, the effective engine version is chosen by Athena.
        :param builtins.str selected_engine_version: Requested engine version. Defaults to `AUTO`.
        """
    ...
    def effective_engine_version(self) -> Optional[builtins.str]:
        """
    ...
    def selected_engine_version(self) -> Optional[builtins.str]:
        """
...
class WorkgroupConfigurationResultConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expected_bucket_owner: Optional[builtins.str] = None,
        ...
        :param builtins.str expected_bucket_owner: AWS account ID that you expect to be the owner of the Amazon S3 bucket.
        :param builtins.str output_location: Location in Amazon S3 where your query results are stored, such as `s3://path/to/query/bucket/`. For more information, see [Queries and Query Result Files](https://docs.aws.amazon.com/athena/latest/ug/querying.html).
        """
