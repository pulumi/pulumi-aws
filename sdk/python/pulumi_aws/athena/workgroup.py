...
class WorkgroupArgs:
    def __init__(__self__, *,
                 configuration: pulumi.Input[Optional['WorkgroupConfigurationArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] state: State of the workgroup. Valid values are `DISABLED` or `ENABLED`. Defaults to `ENABLED`.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Key-value map of resource tags for the workgroup. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
    ...
    @_builtins.property
    @pulumi.getter
    def configuration(self) -> pulumi.Input[Optional['WorkgroupConfigurationArgs']]:
        """
    ...
    def configuration(self, value: pulumi.Input[Optional['WorkgroupConfigurationArgs']]):
...
class Workgroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'Workgroup':
        """
