...
class AppMonitorAppMonitorConfigurationArgsDict(TypedDict):
    ...
    """
    enable_xray: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    telemetries: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
...
class AppMonitorAppMonitorConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 enable_xray: pulumi.Input[Optional[_builtins.bool]] = None,
                 ...
                 telemetries: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None):
        """
    ...
    def enable_xray(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If you set this to `true`, RUM enables X-Ray tracing for the user sessions that RUM samples. RUM adds an X-Ray trace header to allowed HTTP requests. It also records an X-Ray segment for allowed HTTP requests.
        """
    ...
    @enable_xray.setter
    def enable_xray(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    @_builtins.property
    @pulumi.getter
    def telemetries(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        An array that lists the types of telemetry data that this app monitor is to collect. Valid values are `errors`, `performance`, and `http`.
        """
    ...
    @telemetries.setter
    def telemetries(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
