...
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_domain = aws.customerprofiles.domain.Domain("exampleDomain", domain_name=example)
        example_profile = aws.customerprofiles.profile.Profile("exampleProfile", domain_name=example_domain.domain_name)
        ```
