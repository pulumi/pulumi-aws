...
class MicrovmArgs:
    def __init__(__self__, *,
                 ...
                 idle_policy: pulumi.Input[Optional['MicrovmIdlePolicyArgs']] = None,
                 ...
                 logging: pulumi.Input[Optional['MicrovmLoggingArgs']] = None,
                 ...
                 timeouts: pulumi.Input[Optional['MicrovmTimeoutsArgs']] = None):
        """
        ...
        :param pulumi.Input['MicrovmIdlePolicyArgs'] idle_policy: Configuration controlling automatic suspend and resume behavior. See below. Changing this value creates a new resource.
        ...
        :param pulumi.Input['MicrovmLoggingArgs'] logging: Logging configuration for the MicroVM. See below. Changing this value creates a new resource.
    ...
    def idle_policy(self) -> pulumi.Input[Optional['MicrovmIdlePolicyArgs']]:
        """
    ...
    @idle_policy.setter
    def idle_policy(self, value: pulumi.Input[Optional['MicrovmIdlePolicyArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def logging(self) -> pulumi.Input[Optional['MicrovmLoggingArgs']]:
        """
    ...
    @logging.setter
    def logging(self, value: pulumi.Input[Optional['MicrovmLoggingArgs']]):
    ...
    @_builtins.property
    @pulumi.getter
    def timeouts(self) -> pulumi.Input[Optional['MicrovmTimeoutsArgs']]:
        return pulumi.get(self, "timeouts")

    @timeouts.setter
    def timeouts(self, value: pulumi.Input[Optional['MicrovmTimeoutsArgs']]):
...
@pulumi.type_token("aws:lambdamicrovms/microvm:Microvm")
class Microvm(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        * `region` (String) Region where this resource is managed.
        ...
        :param str resource_name: The name of the resource.
        :param MicrovmArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MicrovmArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MicrovmArgs.__new__(MicrovmArgs)
        ...
        super(Microvm, __self__).__init__(
    ...
    def get(resource_name: str,
        ...
        __props__ = _MicrovmState.__new__(_MicrovmState)
        ...
        __props__.__dict__["timeouts"] = timeouts
        return Microvm(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="idlePolicy")
    def idle_policy(self) -> pulumi.Output[Optional['outputs.MicrovmIdlePolicy']]:
        """
        Configuration controlling automatic suspend and resume behavior. See below. Changing this value creates a new resource.
        """
        return pulumi.get(self, "idle_policy")
    ...
    @_builtins.property
    @pulumi.getter
    def logging(self) -> pulumi.Output[Optional['outputs.MicrovmLogging']]:
        """
        Logging configuration for the MicroVM. See below. Changing this value creates a new resource.
        """
        return pulumi.get(self, "logging")
    ...
    @_builtins.property
    @pulumi.getter
    def timeouts(self) -> pulumi.Output[Optional['outputs.MicrovmTimeouts']]:
        return pulumi.get(self, "timeouts")
