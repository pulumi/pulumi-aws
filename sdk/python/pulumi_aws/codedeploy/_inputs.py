...
class DeploymentConfigMinimumHealthyHostsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type can either be `FLEET_PERCENT` or `HOST_COUNT`.
        :param pulumi.Input[builtins.int] value: The value when the type is `FLEET_PERCENT` represents the minimum number of healthy instances as
               a percentage of the total number of instances in the deployment. If you specify FLEET_PERCENT, at the start of the
               deployment, AWS CodeDeploy converts the percentage to the equivalent number of instance and rounds up fractional instances.
               When the type is `HOST_COUNT`, the value represents the minimum number of healthy instances as an absolute value.
        """
...
class DeploymentConfigTrafficRoutingConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Type of traffic routing config. One of `TimeBasedCanary`, `TimeBasedLinear`, `AllAtOnce`.
        """
...
class DeploymentConfigTrafficRoutingConfigTimeBasedCanaryArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] interval: The number of minutes between the first and second traffic shifts of a `TimeBasedCanary` deployment.
        :param pulumi.Input[builtins.int] percentage: The percentage of traffic to shift in the first increment of a `TimeBasedCanary` deployment.
        """
...
class DeploymentConfigTrafficRoutingConfigTimeBasedLinearArgs:
    def __init__(__self__, *,
                 ...
                 percentage: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] interval: The number of minutes between each incremental traffic shift of a `TimeBasedLinear` deployment.
        :param pulumi.Input[builtins.int] percentage: The percentage of traffic that is shifted at the start of each increment of a `TimeBasedLinear` deployment.
        """
        if interval is not None:
            pulumi.set(__self__, "interval", interval)
        if percentage is not None:
...
if not MYPY:
    class DeploymentConfigZonalConfigArgsDict(TypedDict):
        first_zone_monitor_duration_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        monitor_duration_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DeploymentConfigZonalConfigArgs:
    def __init__(__self__, *,
                 first_zone_monitor_duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 minimum_healthy_hosts_per_zone: Optional[pulumi.Input['DeploymentConfigZonalConfigMinimumHealthyHostsPerZoneArgs']] = None,
                 monitor_duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] first_zone_monitor_duration_in_seconds: The period of time, in seconds, that CodeDeploy must wait after completing a deployment to the first Availability Zone. CodeDeploy will wait this amount of time before starting a deployment to the second Availability Zone. If you don't specify a value for `first_zone_monitor_duration_in_seconds`, then CodeDeploy uses the `monitor_duration_in_seconds` value for the first Availability Zone.
        ...
        :param pulumi.Input[builtins.int] monitor_duration_in_seconds: The period of time, in seconds, that CodeDeploy must wait after completing a deployment to an Availability Zone. CodeDeploy will wait this amount of time before starting a deployment to the next Availability Zone. If you don't specify a `monitor_duration_in_seconds`, CodeDeploy starts deploying to the next Availability Zone immediately.
        """
    ...
    def first_zone_monitor_duration_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The period of time, in seconds, that CodeDeploy must wait after completing a deployment to the first Availability Zone. CodeDeploy will wait this amount of time before starting a deployment to the second Availability Zone. If you don't specify a value for `first_zone_monitor_duration_in_seconds`, then CodeDeploy uses the `monitor_duration_in_seconds` value for the first Availability Zone.
        """
    ...
    def first_zone_monitor_duration_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def monitor_duration_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The period of time, in seconds, that CodeDeploy must wait after completing a deployment to an Availability Zone. CodeDeploy will wait this amount of time before starting a deployment to the next Availability Zone. If you don't specify a `monitor_duration_in_seconds`, CodeDeploy starts deploying to the next Availability Zone immediately.
        """
    ...
    def monitor_duration_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DeploymentConfigZonalConfigMinimumHealthyHostsPerZoneArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type can either be `FLEET_PERCENT` or `HOST_COUNT`.
        :param pulumi.Input[builtins.int] value: The value when the type is `FLEET_PERCENT` represents the minimum number of healthy instances as a percentage of the total number of instances in the Availability Zone during a deployment. If you specify FLEET_PERCENT, at the start of the deployment, AWS CodeDeploy converts the percentage to the equivalent number of instance and rounds up fractional instances. When the type is `HOST_COUNT`, the value represents the minimum number of healthy instances in the Availability Zone as an absolute value.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
        if value is not None:
...
if not MYPY:
    class DeploymentGroupAlarmConfigurationArgsDict(TypedDict):
        ...
        """
        ignore_poll_alarm_failure: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DeploymentGroupAlarmConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 ignore_poll_alarm_failure: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] alarms: A list of alarms configured for the deployment group.
        :param pulumi.Input[builtins.bool] enabled: Indicates whether the alarm configuration is enabled. This option is useful when you want to temporarily deactivate alarm monitoring for a deployment group without having to add the same alarms again later.
        :param pulumi.Input[builtins.bool] ignore_poll_alarm_failure: Indicates whether a deployment should continue if information about the current state of alarms cannot be retrieved from CloudWatch. The default value is `false`.
        """
    ...
    def ignore_poll_alarm_failure(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether a deployment should continue if information about the current state of alarms cannot be retrieved from CloudWatch. The default value is `false`.
        """
    ...
    def ignore_poll_alarm_failure(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DeploymentGroupAutoRollbackConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Indicates whether a defined automatic rollback configuration is currently enabled for this Deployment Group. If you enable automatic rollback, you must specify at least one event type.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: The event type or types that trigger a rollback. Supported types are `DEPLOYMENT_FAILURE`, `DEPLOYMENT_STOP_ON_ALARM` and `DEPLOYMENT_STOP_ON_REQUEST`.
...
if not MYPY:
    class DeploymentGroupBlueGreenDeploymentConfigDeploymentReadyOptionArgsDict(TypedDict):
        action_on_timeout: NotRequired[pulumi.Input[builtins.str]]
        """
        When to reroute traffic from an original environment to a replacement environment in a blue/green deployment.
        * `CONTINUE_DEPLOYMENT`: Register new instances with the load balancer immediately after the new application revision is installed on the instances in the replacement environment.
        * `STOP_DEPLOYMENT`: Do not register new instances with load balancer unless traffic is rerouted manually. If traffic is not rerouted manually before the end of the specified wait period, the deployment status is changed to Stopped.
        """
        wait_time_in_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DeploymentGroupBlueGreenDeploymentConfigDeploymentReadyOptionArgs:
    def __init__(__self__, *,
                 action_on_timeout: Optional[pulumi.Input[builtins.str]] = None,
                 wait_time_in_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] action_on_timeout: When to reroute traffic from an original environment to a replacement environment in a blue/green deployment.
               * `CONTINUE_DEPLOYMENT`: Register new instances with the load balancer immediately after the new application revision is installed on the instances in the replacement environment.
               * `STOP_DEPLOYMENT`: Do not register new instances with load balancer unless traffic is rerouted manually. If traffic is not rerouted manually before the end of the specified wait period, the deployment status is changed to Stopped.
        :param pulumi.Input[builtins.int] wait_time_in_minutes: The number of minutes to wait before the status of a blue/green deployment changed to Stopped if rerouting is not started manually. Applies only to the `STOP_DEPLOYMENT` option for `action_on_timeout`.
        """
    ...
    def action_on_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        When to reroute traffic from an original environment to a replacement environment in a blue/green deployment.
        * `CONTINUE_DEPLOYMENT`: Register new instances with the load balancer immediately after the new application revision is installed on the instances in the replacement environment.
        * `STOP_DEPLOYMENT`: Do not register new instances with load balancer unless traffic is rerouted manually. If traffic is not rerouted manually before the end of the specified wait period, the deployment status is changed to Stopped.
    ...
    def action_on_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "action_on_timeout", value)

    @property
    @pulumi.getter(name="waitTimeInMinutes")
    def wait_time_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of minutes to wait before the status of a blue/green deployment changed to Stopped if rerouting is not started manually. Applies only to the `STOP_DEPLOYMENT` option for `action_on_timeout`.
        """
    ...
    def wait_time_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DeploymentGroupBlueGreenDeploymentConfigGreenFleetProvisioningOptionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: The method used to add instances to a replacement environment.
               * `DISCOVER_EXISTING`: Use instances that already exist or will be created manually.
               * `COPY_AUTO_SCALING_GROUP`: Use settings from a specified **Auto Scaling** group to define and create instances in a new Auto Scaling group. _Exactly one Auto Scaling group must be specified_ when selecting `COPY_AUTO_SCALING_GROUP`. Use `autoscaling_groups` to specify the Auto Scaling group.
        """
...
if not MYPY:
    class DeploymentGroupBlueGreenDeploymentConfigTerminateBlueInstancesOnDeploymentSuccessArgsDict(TypedDict):
        ...
        * `KEEP_ALIVE`: Instances are left running after they are deregistered from the load balancer and removed from the deployment group.
        """
        termination_wait_time_in_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DeploymentGroupBlueGreenDeploymentConfigTerminateBlueInstancesOnDeploymentSuccessArgs:
    def __init__(__self__, *,
                 action: Optional[pulumi.Input[builtins.str]] = None,
                 termination_wait_time_in_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] action: The action to take on instances in the original environment after a successful blue/green deployment.
               * `TERMINATE`: Instances are terminated after a specified wait time.
               * `KEEP_ALIVE`: Instances are left running after they are deregistered from the load balancer and removed from the deployment group.
        :param pulumi.Input[builtins.int] termination_wait_time_in_minutes: The number of minutes to wait after a successful blue/green deployment before terminating instances from the original environment.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
    ...
    def termination_wait_time_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of minutes to wait after a successful blue/green deployment before terminating instances from the original environment.
        """
    ...
    def termination_wait_time_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DeploymentGroupDeploymentStyleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] deployment_option: Indicates whether to route deployment traffic behind a load balancer. Valid Values are `WITH_TRAFFIC_CONTROL` or `WITHOUT_TRAFFIC_CONTROL`. Default is `WITHOUT_TRAFFIC_CONTROL`.
        :param pulumi.Input[builtins.str] deployment_type: Indicates whether to run an in-place deployment or a blue/green deployment. Valid Values are `IN_PLACE` or `BLUE_GREEN`. Default is `IN_PLACE`.
...
class DeploymentGroupEc2TagFilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of the tag filter, either `KEY_ONLY`, `VALUE_ONLY`, or `KEY_AND_VALUE`.
...
class DeploymentGroupEcsServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] service_name: The name of the ECS service.
        """
...
class DeploymentGroupLoadBalancerInfoElbInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: The name of the load balancer that will be used to route traffic from original instances to replacement instances in a blue/green deployment. For in-place deployments, the name of the load balancer that instances are deregistered from so they are not serving traffic during a deployment, and then re-registered with after the deployment completes.
        """
        if name is not None:
...
class DeploymentGroupLoadBalancerInfoTargetGroupInfoArgs:
    def __init__(__self__, *,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The name of the target group that instances in the original environment are deregistered from, and instances in the replacement environment registered with. For in-place deployments, the name of the target group that instances are deregistered from, so they are not serving traffic during a deployment, and then re-registered with after the deployment completes.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
if not MYPY:
    class DeploymentGroupLoadBalancerInfoTargetGroupPairInfoProdTrafficRouteArgsDict(TypedDict):
        listener_arns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class DeploymentGroupLoadBalancerInfoTargetGroupPairInfoProdTrafficRouteArgs:
    def __init__(__self__, *,
                 listener_arns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] listener_arns: List of Amazon Resource Names (ARNs) of the load balancer listeners. Must contain exactly one listener ARN.
        """
        pulumi.set(__self__, "listener_arns", listener_arns)

    @property
    @pulumi.getter(name="listenerArns")
    def listener_arns(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        List of Amazon Resource Names (ARNs) of the load balancer listeners. Must contain exactly one listener ARN.
        """
    ...
    def listener_arns(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class DeploymentGroupLoadBalancerInfoTargetGroupPairInfoTargetGroupArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Name of the target group.
        """
        pulumi.set(__self__, "name", name)
...
class DeploymentGroupLoadBalancerInfoTargetGroupPairInfoTestTrafficRouteArgs:
    def __init__(__self__, *,
                 listener_arns: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] listener_arns: List of Amazon Resource Names (ARNs) of the load balancer listeners.
        """
        pulumi.set(__self__, "listener_arns", listener_arns)
...
if not MYPY:
    class DeploymentGroupTriggerConfigurationArgsDict(TypedDict):
        trigger_events: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        ...
        """
        trigger_name: pulumi.Input[builtins.str]
        """
        The name of the notification trigger.
        """
        trigger_target_arn: pulumi.Input[builtins.str]
        """
...
class DeploymentGroupTriggerConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 trigger_target_arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trigger_events: The event type or types for which notifications are triggered. Some values that are supported: `DeploymentStart`, `DeploymentSuccess`, `DeploymentFailure`, `DeploymentStop`, `DeploymentRollback`, `InstanceStart`, `InstanceSuccess`, `InstanceFailure`.  See [the CodeDeploy documentation](http://docs.aws.amazon.com/codedeploy/latest/userguide/monitoring-sns-event-notifications-create-trigger.html) for all possible values.
        :param pulumi.Input[builtins.str] trigger_name: The name of the notification trigger.
        :param pulumi.Input[builtins.str] trigger_target_arn: The ARN of the SNS topic through which notifications are sent.
        """
    ...
    def trigger_events(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        The event type or types for which notifications are triggered. Some values that are supported: `DeploymentStart`, `DeploymentSuccess`, `DeploymentFailure`, `DeploymentStop`, `DeploymentRollback`, `InstanceStart`, `InstanceSuccess`, `InstanceFailure`.  See [the CodeDeploy documentation](http://docs.aws.amazon.com/codedeploy/latest/userguide/monitoring-sns-event-notifications-create-trigger.html) for all possible values.
        """
    ...
    def trigger_events(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "trigger_events", value)

    @property
    @pulumi.getter(name="triggerName")
    def trigger_name(self) -> pulumi.Input[builtins.str]:
        """
        The name of the notification trigger.
        """
    ...
    @trigger_name.setter
    def trigger_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "trigger_name", value)

    @property
    @pulumi.getter(name="triggerTargetArn")
    def trigger_target_arn(self) -> pulumi.Input[builtins.str]:
        """
        The ARN of the SNS topic through which notifications are sent.
        """
    ...
    def trigger_target_arn(self, value: pulumi.Input[builtins.str]):
