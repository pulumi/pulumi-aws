...
class DeploymentGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] termination_hook_enabled: Indicates whether the deployment group was configured to have CodeDeploy install a termination hook into an Auto Scaling group.
