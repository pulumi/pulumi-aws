...
class DeploymentConfigMinimumHealthyHosts(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type: The type can either be `FLEET_PERCENT` or `HOST_COUNT`.
        :param _builtins.int value: The value when the type is `FLEET_PERCENT` represents the minimum number of healthy instances as
...
class DeploymentConfigTrafficRoutingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str type: Type of traffic routing config. One of `TimeBasedCanary`, `TimeBasedLinear`, `AllAtOnce`.
        """
...
class DeploymentConfigTrafficRoutingConfigTimeBasedCanary(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.int interval: The number of minutes between the first and second traffic shifts of a `TimeBasedCanary` deployment.
        :param _builtins.int percentage: The percentage of traffic to shift in the first increment of a `TimeBasedCanary` deployment.
        """
...
class DeploymentConfigTrafficRoutingConfigTimeBasedLinear(dict):
    def __init__(__self__, *,
                 ...
                 percentage: Optional[_builtins.int] = None):
        """
        :param _builtins.int interval: The number of minutes between each incremental traffic shift of a `TimeBasedLinear` deployment.
        :param _builtins.int percentage: The percentage of traffic that is shifted at the start of each increment of a `TimeBasedLinear` deployment.
        """
        if interval is not None:
            pulumi.set(__self__, "interval", interval)
        if percentage is not None:
...
class DeploymentConfigZonalConfigMinimumHealthyHostsPerZone(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str type: The type can either be `FLEET_PERCENT` or `HOST_COUNT`.
        :param _builtins.int value: The value when the type is `FLEET_PERCENT` represents the minimum number of healthy instances as a percentage of the total number of instances in the Availability Zone during a deployment. If you specify FLEET_PERCENT, at the start of the deployment, AWS CodeDeploy converts the percentage to the equivalent number of instance and rounds up fractional instances. When the type is `HOST_COUNT`, the value represents the minimum number of healthy instances in the Availability Zone as an absolute value.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
        if value is not None:
...
class DeploymentGroupAlarmConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] alarms: A list of alarms configured for the deployment group.
        :param _builtins.bool enabled: Indicates whether the alarm configuration is enabled. This option is useful when you want to temporarily deactivate alarm monitoring for a deployment group without having to add the same alarms again later.
        :param _builtins.bool ignore_poll_alarm_failure: Indicates whether a deployment should continue if information about the current state of alarms cannot be retrieved from CloudWatch. The default value is `false`.
        """
...
class DeploymentGroupAutoRollbackConfiguration(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.bool enabled: Indicates whether a defined automatic rollback configuration is currently enabled for this Deployment Group. If you enable automatic rollback, you must specify at least one event type.
        :param Sequence[_builtins.str] events: The event type or types that trigger a rollback. Supported types are `DEPLOYMENT_FAILURE`, `DEPLOYMENT_STOP_ON_ALARM` and `DEPLOYMENT_STOP_ON_REQUEST`.
...
class DeploymentGroupBlueGreenDeploymentConfigDeploymentReadyOption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str action_on_timeout: When to reroute traffic from an original environment to a replacement environment in a blue/green deployment.
               * `CONTINUE_DEPLOYMENT`: Register new instances with the load balancer immediately after the new application revision is installed on the instances in the replacement environment.
               * `STOP_DEPLOYMENT`: Do not register new instances with load balancer unless traffic is rerouted manually. If traffic is not rerouted manually before the end of the specified wait period, the deployment status is changed to Stopped.
        :param _builtins.int wait_time_in_minutes: The number of minutes to wait before the status of a blue/green deployment changed to Stopped if rerouting is not started manually. Applies only to the `STOP_DEPLOYMENT` option for `action_on_timeout`.
        """
...
class DeploymentGroupBlueGreenDeploymentConfigTerminateBlueInstancesOnDeploymentSuccess(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.int termination_wait_time_in_minutes: The number of minutes to wait after a successful blue/green deployment before terminating instances from the original environment.
        """
        if action is not None:
            pulumi.set(__self__, "action", action)
...
class DeploymentGroupDeploymentStyle(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str deployment_option: Indicates whether to route deployment traffic behind a load balancer. Valid Values are `WITH_TRAFFIC_CONTROL` or `WITHOUT_TRAFFIC_CONTROL`. Default is `WITHOUT_TRAFFIC_CONTROL`.
        :param _builtins.str deployment_type: Indicates whether to run an in-place deployment or a blue/green deployment. Valid Values are `IN_PLACE` or `BLUE_GREEN`. Default is `IN_PLACE`.
...
class DeploymentGroupEc2TagFilter(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str type: The type of the tag filter, either `KEY_ONLY`, `VALUE_ONLY`, or `KEY_AND_VALUE`.
...
class DeploymentGroupEcsService(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str cluster_name: The name of the ECS cluster.
        :param _builtins.str service_name: The name of the ECS service.
        """
...
class DeploymentGroupLoadBalancerInfoElbInfo(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str name: The name of the load balancer that will be used to route traffic from original instances to replacement instances in a blue/green deployment. For in-place deployments, the name of the load balancer that instances are deregistered from so they are not serving traffic during a deployment, and then re-registered with after the deployment completes.
        """
        if name is not None:
...
class DeploymentGroupLoadBalancerInfoTargetGroupInfo(dict):
    def __init__(__self__, *,
                 name: Optional[_builtins.str] = None):
        """
        :param _builtins.str name: The name of the target group that instances in the original environment are deregistered from, and instances in the replacement environment registered with. For in-place deployments, the name of the target group that instances are deregistered from, so they are not serving traffic during a deployment, and then re-registered with after the deployment completes.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class DeploymentGroupLoadBalancerInfoTargetGroupPairInfoProdTrafficRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] listener_arns: List of Amazon Resource Names (ARNs) of the load balancer listeners. Must contain exactly one listener ARN.
        """
...
class DeploymentGroupLoadBalancerInfoTargetGroupPairInfoTestTrafficRoute(dict):
    ...
    def __init__(__self__, *,
                 listener_arns: Sequence[_builtins.str]):
        """
        :param Sequence[_builtins.str] listener_arns: List of Amazon Resource Names (ARNs) of the load balancer listeners.
        """
        pulumi.set(__self__, "listener_arns", listener_arns)
...
class DeploymentGroupTriggerConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[_builtins.str] trigger_events: The event type or types for which notifications are triggered. Some values that are supported: `DeploymentStart`, `DeploymentSuccess`, `DeploymentFailure`, `DeploymentStop`, `DeploymentRollback`, `InstanceStart`, `InstanceSuccess`, `InstanceFailure`.  See [the CodeDeploy documentation](http://docs.aws.amazon.com/codedeploy/latest/userguide/monitoring-sns-event-notifications-create-trigger.html) for all possible values.
        :param _builtins.str trigger_name: The name of the notification trigger.
        :param _builtins.str trigger_target_arn: The ARN of the SNS topic through which notifications are sent.
        """
