...
class _DeploymentConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the deployment config.
        :param pulumi.Input[builtins.str] compute_platform: The compute platform can be `Server`, `Lambda`, or `ECS`. Default is `Server`.
    ...
    def deployment_config_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def deployment_config_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DeploymentConfig(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deploymentConfigId")
    def deployment_config_id(self) -> pulumi.Output[builtins.str]:
        """
        The AWS Assigned deployment config id
        """
        return pulumi.get(self, "deployment_config_id")
    ...
    @property
    @pulumi.getter(name="deploymentConfigName")
    def deployment_config_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the deployment config.
        """
        return pulumi.get(self, "deployment_config_name")
