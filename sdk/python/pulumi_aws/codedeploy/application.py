...
class Application(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = aws.codedeploy.application.Application("example", compute_platform=ECS)
        ```
        ### Lambda Application
        ...
        example = aws.codedeploy.application.Application("example", compute_platform=Lambda)
        ```
        ### Server Application
        ...
        example = aws.codedeploy.application.Application("example", compute_platform=Server)
        ```
