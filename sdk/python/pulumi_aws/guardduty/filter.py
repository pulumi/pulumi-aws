...
class FilterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: Specifies the action that is to be applied to the findings that match the filter. Can be one of `ARCHIVE` or `NOOP`.
        :param pulumi.Input[builtins.str] detector_id: ID of a GuardDuty detector, attached to your account.
...
class _FilterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] action: Specifies the action that is to be applied to the findings that match the filter. Can be one of `ARCHIVE` or `NOOP`.
        :param pulumi.Input[builtins.str] arn: The ARN of the GuardDuty filter.
        :param pulumi.Input[builtins.str] description: Description of the filter.
        :param pulumi.Input[builtins.str] detector_id: ID of a GuardDuty detector, attached to your account.
        :param pulumi.Input['FilterFindingCriteriaArgs'] finding_criteria: Represents the criteria to be used in the filter for querying findings. Contains one or more `criterion` blocks, documented below.
        :param pulumi.Input[builtins.str] name: The name of your filter.
