...
class _FilterState:
    def __init__(__self__, *,
                 ...
                 finding_criteria: pulumi.Input[Optional['FilterFindingCriteriaArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="findingCriteria")
    def finding_criteria(self) -> pulumi.Input[Optional['FilterFindingCriteriaArgs']]:
        """
        Represents the criteria to be used in the filter for querying findings. Contains one or more `criterion` blocks, documented below.
        """
        return pulumi.get(self, "finding_criteria")
    ...
    @finding_criteria.setter
    def finding_criteria(self, value: pulumi.Input[Optional['FilterFindingCriteriaArgs']]):
        pulumi.set(self, "finding_criteria", value)
