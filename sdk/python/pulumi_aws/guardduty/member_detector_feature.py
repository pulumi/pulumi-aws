...
class MemberDetectorFeatureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] account_id: Member account ID to be updated.
        ...
        :param pulumi.Input[str] name: The name of the detector feature. Valid values: `S3_DATA_EVENTS`, `EKS_AUDIT_LOGS`, `EBS_MALWARE_PROTECTION`, `RDS_LOGIN_EVENTS`, `EKS_RUNTIME_MONITORING`,`RUNTIME_MONITORING`, `LAMBDA_NETWORK_LOGS`.
        """
...
class MemberDetectorFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            detector_id: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None) -> 'MemberDetectorFeature':
        """
