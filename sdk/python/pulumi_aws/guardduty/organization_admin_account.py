...
class OrganizationAdminAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example_organization = aws.organizations.organization.Organization("exampleOrganization",
            ...
            feature_set=ALL)
        example_detector = aws.guardduty.detector.Detector("exampleDetector")
        example_organization_admin_account = aws.guardduty.organization_admin_account.OrganizationAdminAccount("exampleOrganizationAdminAccount", admin_account_id=123456789012,
