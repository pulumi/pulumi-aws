...
class ThreatIntelSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] activate: Specifies whether GuardDuty is to start using the uploaded ThreatIntelSet.
        :param pulumi.Input[builtins.str] detector_id: The detector ID of the GuardDuty.
        :param pulumi.Input[builtins.str] format: The format of the file that contains the ThreatIntelSet. Valid values: `TXT` | `STIX` | `OTX_CSV` | `ALIEN_VAULT` | `PROOF_POINT` | `FIRE_EYE`
        :param pulumi.Input[builtins.str] location: The URI of the file that contains the ThreatIntelSet.
        :param pulumi.Input[builtins.str] name: The friendly name to identify the ThreatIntelSet.
...
class _ThreatIntelSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] activate: Specifies whether GuardDuty is to start using the uploaded ThreatIntelSet.
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the GuardDuty ThreatIntelSet.
        :param pulumi.Input[builtins.str] detector_id: The detector ID of the GuardDuty.
        :param pulumi.Input[builtins.str] format: The format of the file that contains the ThreatIntelSet. Valid values: `TXT` | `STIX` | `OTX_CSV` | `ALIEN_VAULT` | `PROOF_POINT` | `FIRE_EYE`
        :param pulumi.Input[builtins.str] location: The URI of the file that contains the ThreatIntelSet.
        :param pulumi.Input[builtins.str] name: The friendly name to identify the ThreatIntelSet.
...
class ThreatIntelSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ThreatIntelSet':
        """
