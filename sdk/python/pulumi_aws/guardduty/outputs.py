...
class DetectorDatasourcesKubernetesAuditLogs(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool enable: If true, enables Kubernetes audit logs as a data source for [Kubernetes protection](https://docs.aws.amazon.com/guardduty/latest/ug/kubernetes-protection.html).
               Defaults to `true`.
        """
...
class DetectorDatasourcesMalwareProtectionScanEc2InstanceWithFindingsEbsVolumes(dict):
    def __init__(__self__, *,
                 enable: builtins.bool):
        """
        :param builtins.bool enable: If true, enables [Malware Protection](https://docs.aws.amazon.com/guardduty/latest/ug/malware-protection.html) as data source for the detector.
               Defaults to `true`.
        """
        pulumi.set(__self__, "enable", enable)
...
class DetectorDatasourcesS3Logs(dict):
    def __init__(__self__, *,
                 enable: builtins.bool):
        """
        :param builtins.bool enable: If true, enables [S3 protection](https://docs.aws.amazon.com/guardduty/latest/ug/s3-protection.html).
               Defaults to `true`.
        """
        pulumi.set(__self__, "enable", enable)
...
class FilterFindingCriteriaCriterion(dict):
    ...
    def __init__(__self__, *,
                 ...
                 greater_than: Optional[builtins.str] = None,
                 greater_than_or_equal: Optional[builtins.str] = None,
                 less_than: Optional[builtins.str] = None,
                 less_than_or_equal: Optional[builtins.str] = None,
                 not_equals: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str field: The name of the field to be evaluated. The full list of field names can be found in [AWS documentation](https://docs.aws.amazon.com/guardduty/latest/ug/guardduty_filter-findings.html#filter_criteria).
        :param Sequence[builtins.str] equals: List of string values to be evaluated.
        :param builtins.str greater_than: A value to be evaluated. Accepts either an integer or a date in [RFC 3339 format](https://tools.ietf.org/html/rfc3339#section-5.8).
        :param builtins.str greater_than_or_equal: A value to be evaluated. Accepts either an integer or a date in [RFC 3339 format](https://tools.ietf.org/html/rfc3339#section-5.8).
        :param builtins.str less_than: A value to be evaluated. Accepts either an integer or a date in [RFC 3339 format](https://tools.ietf.org/html/rfc3339#section-5.8).
        :param builtins.str less_than_or_equal: A value to be evaluated. Accepts either an integer or a date in [RFC 3339 format](https://tools.ietf.org/html/rfc3339#section-5.8).
        :param Sequence[builtins.str] not_equals: List of string values to be evaluated.
        """
    ...
    def greater_than(self) -> Optional[builtins.str]:
        """
    ...
    def greater_than_or_equal(self) -> Optional[builtins.str]:
        """
        A value to be evaluated. Accepts either an integer or a date in [RFC 3339 format](https://tools.ietf.org/html/rfc3339#section-5.8).
        """
    ...
    def less_than(self) -> Optional[builtins.str]:
        """
        A value to be evaluated. Accepts either an integer or a date in [RFC 3339 format](https://tools.ietf.org/html/rfc3339#section-5.8).
        """
    ...
    def less_than_or_equal(self) -> Optional[builtins.str]:
        """
        A value to be evaluated. Accepts either an integer or a date in [RFC 3339 format](https://tools.ietf.org/html/rfc3339#section-5.8).
        """
...
class MalwareProtectionPlanActionTagging(dict):
    def __init__(__self__, *,
                 status: builtins.str):
        """
        :param builtins.str status: Indicates whether or not the tags will added. Valid values are `DISABLED` and `ENABLED`. Defaults to `DISABLED`
        """
        pulumi.set(__self__, "status", status)
...
class MalwareProtectionPlanProtectedResourceS3Bucket(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] object_prefixes: The list of object prefixes that specify the S3 objects that will be scanned.
        """
...
class MemberDetectorFeatureAdditionalConfiguration(dict):
    def __init__(__self__, *,
                 ...
                 status: builtins.str):
        """
        :param builtins.str name: The name of the additional configuration. Valid values: `EKS_ADDON_MANAGEMENT`, `ECS_FARGATE_AGENT_MANAGEMENT`.
        :param builtins.str status: The status of the additional configuration. Valid values: `ENABLED`, `DISABLED`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "status", status)
...
class OrganizationConfigurationDatasourcesMalwareProtectionScanEc2InstanceWithFindingsEbsVolumes(dict):
    ...
    def __init__(__self__, *,
                 auto_enable: builtins.bool):
        """
        :param builtins.bool auto_enable: If true, enables [Malware Protection](https://docs.aws.amazon.com/guardduty/latest/ug/malware-protection.html) for all new accounts joining the organization.
               Defaults to `true`.
        """
    ...
    def auto_enable(self) -> builtins.bool:
        """
...
class OrganizationConfigurationDatasourcesS3Logs(dict):
    ...
    def __init__(__self__, *,
                 auto_enable: builtins.bool):
        """
        :param builtins.bool auto_enable: Set to `true` if you want S3 data event logs to be automatically enabled for new members of the organization. Default: `false`
        """
        pulumi.set(__self__, "auto_enable", auto_enable)
...
class OrganizationConfigurationFeatureAdditionalConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str auto_enable: The status of the additional configuration that will be configured for the organization. Valid values: `NEW`, `ALL`, `NONE`.
...
class GetDetectorFeatureResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the detector feature.
        :param builtins.str status: Current status of the detector.
        """
