...
class DetectorFeatureArgs:
    def __init__(__self__, *,
                 ...
                 additional_configurations: pulumi.Input[Optional[Sequence[pulumi.Input['DetectorFeatureAdditionalConfigurationArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] name: The name of the detector feature. Valid values: `S3_DATA_EVENTS`, `EKS_AUDIT_LOGS`, `EBS_MALWARE_PROTECTION`, `RDS_LOGIN_EVENTS`, `EKS_RUNTIME_MONITORING`, `LAMBDA_NETWORK_LOGS`, `RUNTIME_MONITORING`, `AI_PROTECTION`, `AI_ANALYST`. Only one of two features `EKS_RUNTIME_MONITORING` or `RUNTIME_MONITORING` can be added, adding both features will cause an error. Refer to the [AWS Documentation](https://docs.aws.amazon.com/guardduty/latest/APIReference/API_DetectorFeatureConfiguration.html) for the current list of supported values.
    ...
    def additional_configurations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DetectorFeatureAdditionalConfigurationArgs']]]]:
        """
    ...
    def additional_configurations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DetectorFeatureAdditionalConfigurationArgs']]]]):
...
class DetectorFeature(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 additional_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DetectorFeatureAdditionalConfigurationArgs', 'DetectorFeatureAdditionalConfigurationArgsDict', 'outputs.DetectorFeatureAdditionalConfiguration']]]]] = None,
                 detector_id: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 status: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            region: pulumi.Input[Optional[_builtins.str]] = None,
            status: pulumi.Input[Optional[_builtins.str]] = None) -> 'DetectorFeature':
        """
