...
def get_finding_ids(detector_id: Optional[str] = None,
    ...
    example = aws.guardduty.get_finding_ids(detector_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetFindingIdsResult(
        detector_id=__ret__.detector_id,
        finding_ids=__ret__.finding_ids,
        has_findings=__ret__.has_findings,
        id=__ret__.id)
