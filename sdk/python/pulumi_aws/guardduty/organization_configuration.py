...
class OrganizationConfigurationArgs:
    ...
    def _configure(
        ...
        if 'autoEnableOrganizationMembers' in kwargs:
...
class OrganizationConfiguration(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if datasources is not None and not isinstance(datasources, OrganizationConfigurationDatasourcesArgs):
                datasources = datasources or {}
                def _setter(key, value):
                    datasources[key] = value
                OrganizationConfigurationDatasourcesArgs._configure(_setter, **datasources)
