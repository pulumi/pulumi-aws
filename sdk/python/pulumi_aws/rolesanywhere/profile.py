...
class ProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enabled: Whether or not the Profile is enabled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] managed_policy_arns: A list of managed policy ARNs that apply to the vended session credentials.
        :param pulumi.Input[builtins.str] name: The name of the Profile.
        :param pulumi.Input[builtins.bool] require_instance_properties: Specifies whether instance properties are required in [CreateSession](https://docs.aws.amazon.com/rolesanywhere/latest/APIReference/API_CreateSession.html) requests with this profile.
...
class _ProfileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the Profile
        :param pulumi.Input[builtins.int] duration_seconds: The number of seconds the vended session credentials are valid for. Defaults to 3600.
        :param pulumi.Input[builtins.bool] enabled: Whether or not the Profile is enabled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] managed_policy_arns: A list of managed policy ARNs that apply to the vended session credentials.
        :param pulumi.Input[builtins.str] name: The name of the Profile.
...
class Profile(pulumi.CustomResource):
    ...
    pulumi_type = "aws:rolesanywhere/profile:Profile"
    ...
    @property
    @pulumi.getter(name="durationSeconds")
    def duration_seconds(self) -> pulumi.Output[builtins.int]:
        """
        The number of seconds the vended session credentials are valid for. Defaults to 3600.
        """
        return pulumi.get(self, "duration_seconds")
