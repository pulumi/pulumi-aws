...
class VoiceConnectorLoggingArgs:
    ...
    def _configure(
        ...
        if enable_media_metric_logs is None and 'enableMediaMetricLogs' in kwargs:
            enable_media_metric_logs = kwargs['enableMediaMetricLogs']
        if enable_sip_logs is None and 'enableSipLogs' in kwargs:
            enable_sip_logs = kwargs['enableSipLogs']
