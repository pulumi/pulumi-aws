...
class VoiceConnectorLoggingArgs:
    ...
    def enable_media_metric_logs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_media_metric_logs(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_media_metric_logs", value)

    @property
    @pulumi.getter(name="enableSipLogs")
    def enable_sip_logs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
...
class VoiceConnectorLogging(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableMediaMetricLogs")
    def enable_media_metric_logs(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true, enables logging of detailed media metrics for Voice Connectors to Amazon CloudWatch logs.
        """
        return pulumi.get(self, "enable_media_metric_logs")
    ...
    @property
    @pulumi.getter(name="enableSipLogs")
    def enable_sip_logs(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When true, enables SIP message logs for sending to Amazon CloudWatch Logs.
        """
        return pulumi.get(self, "enable_sip_logs")
