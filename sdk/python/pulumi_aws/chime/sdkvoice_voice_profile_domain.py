...
class SdkvoiceVoiceProfileDomain(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if server_side_encryption_configuration is not None and not isinstance(server_side_encryption_configuration, SdkvoiceVoiceProfileDomainServerSideEncryptionConfigurationArgs):
                ...
                SdkvoiceVoiceProfileDomainServerSideEncryptionConfigurationArgs._configure(_setter, **server_side_encryption_configuration)
