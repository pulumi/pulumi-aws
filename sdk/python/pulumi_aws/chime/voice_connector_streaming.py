...
class VoiceConnectorStreamingArgs:
    def __init__(__self__, *,
                 data_retention: pulumi.Input[builtins.int],
                 ...
                 streaming_notification_targets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
    ...
    def data_retention(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def data_retention(self, value: pulumi.Input[builtins.int]):
    ...
    def streaming_notification_targets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def streaming_notification_targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _VoiceConnectorStreamingState:
    def __init__(__self__, *,
                 data_retention: Optional[pulumi.Input[builtins.int]] = None,
                 disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 media_insights_configuration: Optional[pulumi.Input['VoiceConnectorStreamingMediaInsightsConfigurationArgs']] = None,
                 streaming_notification_targets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
    ...
    @property
    @pulumi.getter(name="dataRetention")
    def data_retention(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The retention period, in hours, for the Amazon Kinesis data.
        """
        return pulumi.get(self, "data_retention")
    ...
    @data_retention.setter
    def data_retention(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_retention", value)
...
class VoiceConnectorStreaming(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            media_insights_configuration: Optional[pulumi.Input[Union['VoiceConnectorStreamingMediaInsightsConfigurationArgs', 'VoiceConnectorStreamingMediaInsightsConfigurationArgsDict']]] = None,
            streaming_notification_targets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            voice_connector_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VoiceConnectorStreaming':
        """
    ...
    @property
    @pulumi.getter(name="dataRetention")
    def data_retention(self) -> pulumi.Output[builtins.int]:
        """
        The retention period, in hours, for the Amazon Kinesis data.
        """
        return pulumi.get(self, "data_retention")
    ...
    @property
    @pulumi.getter(name="streamingNotificationTargets")
    def streaming_notification_targets(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The streaming notification targets. Valid Values: `EventBridge | SNS | SQS`
        """
        return pulumi.get(self, "streaming_notification_targets")
