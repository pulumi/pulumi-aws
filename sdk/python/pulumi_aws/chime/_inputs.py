...
class SdkvoiceSipMediaApplicationEndpointsArgs:
    def __init__(__self__, *,
                 lambda_arn: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] lambda_arn: Valid ARN of the Lambda function, version, or alias. The function must be created in the same AWS Region as the SIP media application.
        """
