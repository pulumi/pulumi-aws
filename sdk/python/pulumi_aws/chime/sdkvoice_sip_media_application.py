...
class SdkvoiceSipMediaApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] aws_region: The AWS Region in which the AWS Chime SDK Voice Sip Media Application is created.
...
class _SdkvoiceSipMediaApplicationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN (Amazon Resource Name) of the AWS Chime SDK Voice Sip Media Application
        :param pulumi.Input[builtins.str] aws_region: The AWS Region in which the AWS Chime SDK Voice Sip Media Application is created.
        :param pulumi.Input['SdkvoiceSipMediaApplicationEndpointsArgs'] endpoints: List of endpoints (Lambda Amazon Resource Names) specified for the SIP media application. Currently, only one endpoint is supported. See `endpoints`.
        :param pulumi.Input[builtins.str] name: The name of the AWS Chime SDK Voice Sip Media Application.
