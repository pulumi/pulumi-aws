...
class SdkvoiceSipMediaApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['SdkvoiceSipMediaApplicationEndpointsArgs'] endpoints: List of endpoints (Lambda ARNs) specified for the SIP media application. Currently, only one endpoint is supported. See `endpoints`.
...
class _SdkvoiceSipMediaApplicationState:
    def __init__(__self__, *,
                 ...
                 endpoints: pulumi.Input[Optional['SdkvoiceSipMediaApplicationEndpointsArgs']] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] arn: ARN of the AWS Chime SDK Voice Sip Media Application
        :param pulumi.Input[_builtins.str] aws_region: The AWS Region in which the AWS Chime SDK Voice Sip Media Application is created.
        :param pulumi.Input['SdkvoiceSipMediaApplicationEndpointsArgs'] endpoints: List of endpoints (Lambda ARNs) specified for the SIP media application. Currently, only one endpoint is supported. See `endpoints`.
        :param pulumi.Input[_builtins.str] name: The name of the AWS Chime SDK Voice Sip Media Application.
    ...
    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> pulumi.Input[Optional['SdkvoiceSipMediaApplicationEndpointsArgs']]:
        """
        List of endpoints (Lambda ARNs) specified for the SIP media application. Currently, only one endpoint is supported. See `endpoints`.
        """
        return pulumi.get(self, "endpoints")
    ...
    @endpoints.setter
    def endpoints(self, value: pulumi.Input[Optional['SdkvoiceSipMediaApplicationEndpointsArgs']]):
        pulumi.set(self, "endpoints", value)
...
class SdkvoiceSipMediaApplication(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 aws_region: pulumi.Input[Optional[_builtins.str]] = None,
                 endpoints: pulumi.Input[Optional[Union['SdkvoiceSipMediaApplicationEndpointsArgs', 'SdkvoiceSipMediaApplicationEndpointsArgsDict', 'outputs.SdkvoiceSipMediaApplicationEndpoints']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[_builtins.str] aws_region: The AWS Region in which the AWS Chime SDK Voice Sip Media Application is created.
        :param pulumi.Input[Union['SdkvoiceSipMediaApplicationEndpointsArgs', 'SdkvoiceSipMediaApplicationEndpointsArgsDict', 'outputs.SdkvoiceSipMediaApplicationEndpoints']] endpoints: List of endpoints (Lambda ARNs) specified for the SIP media application. Currently, only one endpoint is supported. See `endpoints`.
        :param pulumi.Input[_builtins.str] name: The name of the AWS Chime SDK Voice Sip Media Application.
    ...
    def get(resource_name: str,
            ...
            region: pulumi.Input[Optional[_builtins.str]] = None,
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None) -> 'SdkvoiceSipMediaApplication':
        """
