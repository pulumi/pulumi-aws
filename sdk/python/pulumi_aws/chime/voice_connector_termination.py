...
class VoiceConnectorTerminationArgs:
    def __init__(__self__, *,
                 calling_regions: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 cidr_allow_lists: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 voice_connector_id: pulumi.Input[builtins.str],
                 cps_limit: Optional[pulumi.Input[builtins.int]] = None,
                 default_phone_number: Optional[pulumi.Input[builtins.str]] = None,
                 disabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a VoiceConnectorTermination resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] calling_regions: The countries to which calls are allowed, in ISO 3166-1 alpha-2 format.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] cidr_allow_lists: The IP addresses allowed to make calls, in CIDR format.
        :param pulumi.Input[builtins.str] voice_connector_id: The Amazon Chime Voice Connector ID.
        :param pulumi.Input[builtins.int] cps_limit: The limit on calls per second. Max value based on account service quota. Default value of `1`.
        :param pulumi.Input[builtins.str] default_phone_number: The default caller ID phone number.
        :param pulumi.Input[builtins.bool] disabled: When termination settings are disabled, outbound calls can not be made.
        """
    ...
    def calling_regions(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def calling_regions(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "calling_regions", value)

    @property
    @pulumi.getter(name="cidrAllowLists")
    def cidr_allow_lists(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def cidr_allow_lists(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def cps_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @cps_limit.setter
    def cps_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cps_limit", value)

    @property
    @pulumi.getter(name="defaultPhoneNumber")
    def default_phone_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_phone_number(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VoiceConnectorTerminationState:
    def __init__(__self__, *,
                 calling_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 cidr_allow_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 cps_limit: Optional[pulumi.Input[builtins.int]] = None,
                 default_phone_number: Optional[pulumi.Input[builtins.str]] = None,
                 disabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="callingRegions")
    def calling_regions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The countries to which calls are allowed, in ISO 3166-1 alpha-2 format.
        """
        return pulumi.get(self, "calling_regions")
    ...
    @calling_regions.setter
    def calling_regions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "calling_regions", value)

    @property
    @pulumi.getter(name="cidrAllowLists")
    def cidr_allow_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The IP addresses allowed to make calls, in CIDR format.
        """
        return pulumi.get(self, "cidr_allow_lists")
    ...
    @cidr_allow_lists.setter
    def cidr_allow_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "cidr_allow_lists", value)
...
class VoiceConnectorTermination(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            default_phone_number: Optional[pulumi.Input[builtins.str]] = None,
            disabled: Optional[pulumi.Input[builtins.bool]] = None,
            voice_connector_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VoiceConnectorTermination':
        """
    ...
    @property
    @pulumi.getter(name="callingRegions")
    def calling_regions(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The countries to which calls are allowed, in ISO 3166-1 alpha-2 format.
        """
        return pulumi.get(self, "calling_regions")
    ...
    @property
    @pulumi.getter(name="cidrAllowLists")
    def cidr_allow_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The IP addresses allowed to make calls, in CIDR format.
        """
        return pulumi.get(self, "cidr_allow_lists")
    ...
    @property
    @pulumi.getter(name="cpsLimit")
    def cps_limit(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The limit on calls per second. Max value based on account service quota. Default value of `1`.
        """
        return pulumi.get(self, "cps_limit")
    ...
    @property
    @pulumi.getter(name="defaultPhoneNumber")
    def default_phone_number(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The default caller ID phone number.
        """
        return pulumi.get(self, "default_phone_number")
