...
class KeyArgs:
    def __init__(__self__, *,
                 ...
                 custom_key_store_id: Optional[pulumi.Input[builtins.str]] = None,
                 customer_master_key_spec: Optional[pulumi.Input[builtins.str]] = None,
                 deletion_window_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enable_key_rotation: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] custom_key_store_id: ID of the KMS [Custom Key Store](https://docs.aws.amazon.com/kms/latest/developerguide/create-cmk-keystore.html) where the key will be stored instead of KMS (eg CloudHSM).
        :param pulumi.Input[builtins.str] customer_master_key_spec: Specifies whether the key contains a symmetric key or an asymmetric key pair and the encryption algorithms or signing algorithms that the key supports.
        ...
        :param pulumi.Input[builtins.str] description: The description of the key as viewed in AWS console.
        :param pulumi.Input[builtins.bool] enable_key_rotation: Specifies whether [key rotation](http://docs.aws.amazon.com/kms/latest/developerguide/rotate-keys.html) is enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] is_enabled: Specifies whether the key is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] key_usage: Specifies the intended use of the key. Valid values: `ENCRYPT_DECRYPT`, `SIGN_VERIFY`, or `GENERATE_VERIFY_MAC`.
        ...
        :param pulumi.Input[builtins.str] policy: A valid policy JSON document. Although this is a key policy, not an IAM policy, an `iam_get_policy_document`, in the form that designates a principal, can be used.
    ...
    def custom_key_store_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_key_store_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_key_store_id", value)

    @property
    @pulumi.getter(name="customerMasterKeySpec")
    def customer_master_key_spec(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def customer_master_key_spec(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def enable_key_rotation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_key_rotation(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def rotation_period_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def rotation_period_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @xks_key_id.setter
    def xks_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _KeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enable_key_rotation: Specifies whether [key rotation](http://docs.aws.amazon.com/kms/latest/developerguide/rotate-keys.html) is enabled. Defaults to `false`.
        :param pulumi.Input[builtins.bool] is_enabled: Specifies whether the key is enabled. Defaults to `true`.
        :param pulumi.Input[builtins.str] key_id: The globally unique identifier for the key.
        :param pulumi.Input[builtins.str] key_usage: Specifies the intended use of the key. Valid values: `ENCRYPT_DECRYPT`, `SIGN_VERIFY`, or `GENERATE_VERIFY_MAC`.
               Defaults to `ENCRYPT_DECRYPT`.
        :param pulumi.Input[builtins.bool] multi_region: Indicates whether the KMS key is a multi-Region (`true`) or regional (`false`) key. Defaults to `false`.
        :param pulumi.Input[builtins.str] policy: A valid policy JSON document. Although this is a key policy, not an IAM policy, an `iam_get_policy_document`, in the form that designates a principal, can be used.
...
class Key(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            xks_key_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Key':
        """
    ...
    @property
    @pulumi.getter(name="customKeyStoreId")
    def custom_key_store_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ID of the KMS [Custom Key Store](https://docs.aws.amazon.com/kms/latest/developerguide/create-cmk-keystore.html) where the key will be stored instead of KMS (eg CloudHSM).
        """
        return pulumi.get(self, "custom_key_store_id")
    ...
    @property
    @pulumi.getter(name="customerMasterKeySpec")
    def customer_master_key_spec(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies whether the key contains a symmetric key or an asymmetric key pair and the encryption algorithms or signing algorithms that the key supports.
        Valid values: `SYMMETRIC_DEFAULT`,  `RSA_2048`, `RSA_3072`, `RSA_4096`, `HMAC_256`, `ECC_NIST_P256`, `ECC_NIST_P384`, `ECC_NIST_P521`, or `ECC_SECG_P256K1`. Defaults to `SYMMETRIC_DEFAULT`. For help with choosing a key spec, see the [AWS KMS Developer Guide](https://docs.aws.amazon.com/kms/latest/developerguide/symm-asymm-choose.html).
        """
    ...
    @property
    @pulumi.getter(name="enableKeyRotation")
    def enable_key_rotation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether [key rotation](http://docs.aws.amazon.com/kms/latest/developerguide/rotate-keys.html) is enabled. Defaults to `false`.
        """
        return pulumi.get(self, "enable_key_rotation")
    ...
    @property
    @pulumi.getter(name="keyUsage")
    def key_usage(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the intended use of the key. Valid values: `ENCRYPT_DECRYPT`, `SIGN_VERIFY`, or `GENERATE_VERIFY_MAC`.
        Defaults to `ENCRYPT_DECRYPT`.
        """
    ...
    @property
    @pulumi.getter(name="rotationPeriodInDays")
    def rotation_period_in_days(self) -> pulumi.Output[builtins.int]:
        """
        Custom period of time between each rotation date. Must be a number between 90 and 2560 (inclusive).
        """
        return pulumi.get(self, "rotation_period_in_days")
    ...
    @property
    @pulumi.getter(name="xksKeyId")
    def xks_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Identifies the external key that serves as key material for the KMS key in an external key store.
        """
        return pulumi.get(self, "xks_key_id")
