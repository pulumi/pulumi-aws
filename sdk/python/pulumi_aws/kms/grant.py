...
class GrantArgs:
    def __init__(__self__, *,
                 grantee_principal: pulumi.Input[builtins.str],
                 ...
                 grant_creation_tokens: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 retire_on_delete: Optional[pulumi.Input[builtins.bool]] = None,
                 retiring_principal: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Grant resource.
        :param pulumi.Input[builtins.str] grantee_principal: The principal that is given permission to perform the operations that the grant permits in ARN format. Note that due to eventual consistency issues around IAM principals, the providers's state may not always be refreshed to reflect what is true in AWS.
        :param pulumi.Input[builtins.str] key_id: The unique identifier for the customer master key (CMK) that the grant applies to. Specify the key ID or the Amazon Resource Name (ARN) of the CMK. To specify a CMK in a different AWS account, you must use the key ARN.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] operations: A list of operations that the grant permits. The permitted values are: `Decrypt`, `Encrypt`, `GenerateDataKey`, `GenerateDataKeyWithoutPlaintext`, `ReEncryptFrom`, `ReEncryptTo`, `Sign`, `Verify`, `GetPublicKey`, `CreateGrant`, `RetireGrant`, `DescribeKey`, `GenerateDataKeyPair`, or `GenerateDataKeyPairWithoutPlaintext`.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] grant_creation_tokens: A list of grant tokens to be used when creating the grant. See [Grant Tokens](http://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token) for more information about grant tokens.
        :param pulumi.Input[builtins.str] name: A friendly name for identifying the grant.
        :param pulumi.Input[builtins.bool] retire_on_delete: If set to false (the default) the grants will be revoked upon deletion, and if set to true the grants will try to be retired upon deletion. Note that retiring grants requires special permissions, hence why we default to revoking grants.
               See [RetireGrant](https://docs.aws.amazon.com/kms/latest/APIReference/API_RetireGrant.html) for more information.
        :param pulumi.Input[builtins.str] retiring_principal: The principal that is given permission to retire the grant by using RetireGrant operation in ARN format. Note that due to eventual consistency issues around IAM principals, the providers's state may not always be refreshed to reflect what is true in AWS.
        """
    ...
    def grantee_principal(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def grantee_principal(self, value: pulumi.Input[builtins.str]):
    ...
    def grant_creation_tokens(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def grant_creation_tokens(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def retire_on_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def retire_on_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "retire_on_delete", value)

    @property
    @pulumi.getter(name="retiringPrincipal")
    def retiring_principal(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def retiring_principal(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _GrantState:
    def __init__(__self__, *,
                 ...
                 grant_token: Optional[pulumi.Input[builtins.str]] = None,
                 grantee_principal: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['GrantConstraintArgs']]] constraints: A structure that you can use to allow certain operations in the grant only when the desired encryption context is present. For more information about encryption context, see [Encryption Context](http://docs.aws.amazon.com/kms/latest/developerguide/encryption-context.html).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] grant_creation_tokens: A list of grant tokens to be used when creating the grant. See [Grant Tokens](http://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token) for more information about grant tokens.
        :param pulumi.Input[builtins.str] grant_id: The unique identifier for the grant.
        :param pulumi.Input[builtins.str] grant_token: The grant token for the created grant. For more information, see [Grant Tokens](http://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token).
        :param pulumi.Input[builtins.str] grantee_principal: The principal that is given permission to perform the operations that the grant permits in ARN format. Note that due to eventual consistency issues around IAM principals, the providers's state may not always be refreshed to reflect what is true in AWS.
        :param pulumi.Input[builtins.str] key_id: The unique identifier for the customer master key (CMK) that the grant applies to. Specify the key ID or the Amazon Resource Name (ARN) of the CMK. To specify a CMK in a different AWS account, you must use the key ARN.
        :param pulumi.Input[builtins.str] name: A friendly name for identifying the grant.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] operations: A list of operations that the grant permits. The permitted values are: `Decrypt`, `Encrypt`, `GenerateDataKey`, `GenerateDataKeyWithoutPlaintext`, `ReEncryptFrom`, `ReEncryptTo`, `Sign`, `Verify`, `GetPublicKey`, `CreateGrant`, `RetireGrant`, `DescribeKey`, `GenerateDataKeyPair`, or `GenerateDataKeyPairWithoutPlaintext`.
    ...
    def grant_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @grant_id.setter
    def grant_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grant_id", value)

    @property
    @pulumi.getter(name="grantToken")
    def grant_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @grant_token.setter
    def grant_token(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grant_token", value)

    @property
    @pulumi.getter(name="granteePrincipal")
    def grantee_principal(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The principal that is given permission to perform the operations that the grant permits in ARN format. Note that due to eventual consistency issues around IAM principals, the providers's state may not always be refreshed to reflect what is true in AWS.
        """
        return pulumi.get(self, "grantee_principal")
    ...
    @grantee_principal.setter
    def grantee_principal(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grantee_principal", value)
...
class Grant(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            operations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            retire_on_delete: Optional[pulumi.Input[builtins.bool]] = None,
            retiring_principal: Optional[pulumi.Input[builtins.str]] = None) -> 'Grant':
        """
    ...
    @property
    @pulumi.getter(name="grantCreationTokens")
    def grant_creation_tokens(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        A list of grant tokens to be used when creating the grant. See [Grant Tokens](http://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token) for more information about grant tokens.
        """
        return pulumi.get(self, "grant_creation_tokens")
    ...
    @property
    @pulumi.getter(name="grantToken")
    def grant_token(self) -> pulumi.Output[builtins.str]:
        """
        The grant token for the created grant. For more information, see [Grant Tokens](http://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#grant_token).
        """
        return pulumi.get(self, "grant_token")
    ...
    @property
    @pulumi.getter(name="granteePrincipal")
    def grantee_principal(self) -> pulumi.Output[builtins.str]:
        """
        The principal that is given permission to perform the operations that the grant permits in ARN format. Note that due to eventual consistency issues around IAM principals, the providers's state may not always be refreshed to reflect what is true in AWS.
        """
        return pulumi.get(self, "grantee_principal")
    ...
    @property
    @pulumi.getter(name="retireOnDelete")
    def retire_on_delete(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to false (the default) the grants will be revoked upon deletion, and if set to true the grants will try to be retired upon deletion. Note that retiring grants requires special permissions, hence why we default to revoking grants.
        See [RetireGrant](https://docs.aws.amazon.com/kms/latest/APIReference/API_RetireGrant.html) for more information.
        """
    ...
    @property
    @pulumi.getter(name="retiringPrincipal")
    def retiring_principal(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The principal that is given permission to retire the grant by using RetireGrant operation in ARN format. Note that due to eventual consistency issues around IAM principals, the providers's state may not always be refreshed to reflect what is true in AWS.
        """
        return pulumi.get(self, "retiring_principal")
