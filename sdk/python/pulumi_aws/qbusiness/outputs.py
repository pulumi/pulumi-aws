...
class ApplicationAttachmentsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str attachments_control_mode: Status information about whether file upload functionality is activated or deactivated for your end user. Valid values are `ENABLED` and `DISABLED`.
        """
        pulumi.set(__self__, "attachments_control_mode", attachments_control_mode)

    @property
    @pulumi.getter(name="attachmentsControlMode")
    def attachments_control_mode(self) -> str:
        """
...
class ApplicationEncryptionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 kms_key_id: str):
        """
        :param str kms_key_id: Identifier of the AWS KMS key that is used to encrypt your data. Amazon Q doesn't support asymmetric keys.
        """
