...
class ClassificationExportConfigurationS3DestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_name: The Amazon S3 bucket name in which Amazon Macie exports the data classification results.
        :param pulumi.Input[builtins.str] kms_key_arn: Amazon Resource Name (ARN) of the KMS key to be used to encrypt the data.
               
               Additional information can be found in the [Storing and retaining sensitive data discovery results with Amazon Macie for AWS Macie documentation](https://docs.aws.amazon.com/macie/latest/user/discovery-results-repository-s3.html).
        :param pulumi.Input[builtins.str] key_prefix: The object key for the bucket in which Amazon Macie exports the data classification results.
        """
...
class ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndSimpleCriterionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] comparator: The operator to use in a condition. Valid combination of values are available in the [AWS Documentation](https://docs.aws.amazon.com/macie/latest/APIReference/jobs.html#jobs-model-jobcomparator)
        :param pulumi.Input[builtins.str] key: The object property to use in the condition. Valid combination of values are available in the [AWS Documentation](https://docs.aws.amazon.com/macie/latest/APIReference/jobs.html#jobs-model-simplecriterionkeyforjob)
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: An array that lists the values to use in the condition. Valid combination of values are available in the [AWS Documentation](https://docs.aws.amazon.com/macie/latest/APIReference/jobs.html#jobs-model-simplecriterionforjob)
        """
...
class ClassificationJobS3JobDefinitionBucketCriteriaExcludesAndTagCriterionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] comparator: The operator to use in the condition. Valid combination and values are available in the [AWS Documentation](https://docs.aws.amazon.com/macie/latest/APIReference/jobs.html#jobs-model-jobcomparator)
...
if not MYPY:
    class ClassificationJobS3JobDefinitionBucketDefinitionArgsDict(TypedDict):
        ...
        """
        buckets: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
...
class ClassificationJobS3JobDefinitionBucketDefinitionArgs:
    def __init__(__self__, *,
                 ...
                 buckets: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[builtins.str] account_id: The unique identifier for the AWS account that owns the buckets.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] buckets: An array that lists the names of the buckets.
        """
    ...
    @property
    @pulumi.getter
    def buckets(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        An array that lists the names of the buckets.
        """
    ...
    @buckets.setter
    def buckets(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ClassificationJobS3JobDefinitionScopingExcludesAndSimpleScopeTermArgs:
    def __init__(__self__, *,
                 ...
                 values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] comparator: The operator to use in a condition. Valid values are: `EQ`, `GT`, `GTE`, `LT`, `LTE`, `NE`, `CONTAINS`, `STARTS_WITH`
        :param pulumi.Input[builtins.str] key: The object property to use in the condition.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: An array that lists the values to use in the condition.
        """
        if comparator is not None:
            pulumi.set(__self__, "comparator", comparator)
        if key is not None:
...
class ClassificationJobS3JobDefinitionScopingExcludesAndTagScopeTermArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] comparator: The operator to use in the condition.
        :param pulumi.Input[builtins.str] key: The tag key to use in the condition. The only valid value is `TAG`.
        ...
        :param pulumi.Input[builtins.str] target: The type of object to apply the condition to. The only valid value is `S3_OBJECT`.
        """
        if comparator is not None:
            pulumi.set(__self__, "comparator", comparator)
        if key is not None:
...
if not MYPY:
    class ClassificationJobScheduleFrequencyArgsDict(TypedDict):
        daily_schedule: NotRequired[pulumi.Input[builtins.bool]]
        """
        Specifies a daily recurrence pattern for running the job.
        """
        monthly_schedule: NotRequired[pulumi.Input[builtins.int]]
        """
        Specifies a monthly recurrence pattern for running the job.
        """
        weekly_schedule: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ClassificationJobScheduleFrequencyArgs:
    def __init__(__self__, *,
                 daily_schedule: Optional[pulumi.Input[builtins.bool]] = None,
                 monthly_schedule: Optional[pulumi.Input[builtins.int]] = None,
                 weekly_schedule: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] daily_schedule: Specifies a daily recurrence pattern for running the job.
        :param pulumi.Input[builtins.int] monthly_schedule: Specifies a monthly recurrence pattern for running the job.
        :param pulumi.Input[builtins.str] weekly_schedule: Specifies a weekly recurrence pattern for running the job.
        """
    ...
    def daily_schedule(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies a daily recurrence pattern for running the job.
        """
    ...
    def daily_schedule(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "daily_schedule", value)

    @property
    @pulumi.getter(name="monthlySchedule")
    def monthly_schedule(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies a monthly recurrence pattern for running the job.
        """
    ...
    def monthly_schedule(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "monthly_schedule", value)

    @property
    @pulumi.getter(name="weeklySchedule")
    def weekly_schedule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies a weekly recurrence pattern for running the job.
        """
    ...
    def weekly_schedule(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "weekly_schedule", value)


if not MYPY:
    class ClassificationJobUserPausedDetailArgsDict(TypedDict):
        job_expires_at: NotRequired[pulumi.Input[builtins.str]]
        job_imminent_expiration_health_event_arn: NotRequired[pulumi.Input[builtins.str]]
        job_paused_at: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class ClassificationJobUserPausedDetailArgs:
    def __init__(__self__, *,
                 job_expires_at: Optional[pulumi.Input[builtins.str]] = None,
                 job_imminent_expiration_health_event_arn: Optional[pulumi.Input[builtins.str]] = None,
                 job_paused_at: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def job_expires_at(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "job_expires_at")

    @job_expires_at.setter
    def job_expires_at(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "job_expires_at", value)

    @property
    @pulumi.getter(name="jobImminentExpirationHealthEventArn")
    def job_imminent_expiration_health_event_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "job_imminent_expiration_health_event_arn")

    @job_imminent_expiration_health_event_arn.setter
    def job_imminent_expiration_health_event_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "job_imminent_expiration_health_event_arn", value)

    @property
    @pulumi.getter(name="jobPausedAt")
    def job_paused_at(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "job_paused_at")

    @job_paused_at.setter
    def job_paused_at(self, value: Optional[pulumi.Input[builtins.str]]):
