...
class InvitationAccepterArgs:
    ...
    def administrator_account_id(self) -> pulumi.Input[builtins.str]:
        """
...
class _InvitationAccepterState:
    ...
    @property
    @pulumi.getter(name="administratorAccountId")
    def administrator_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The AWS account ID for the account that sent the invitation.
        """
        return pulumi.get(self, "administrator_account_id")
    ...
    @administrator_account_id.setter
    def administrator_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "administrator_account_id", value)
...
class InvitationAccepter(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="administratorAccountId")
    def administrator_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The AWS account ID for the account that sent the invitation.
        """
        return pulumi.get(self, "administrator_account_id")
