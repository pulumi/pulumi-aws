...
class MemberArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The AWS account ID for the account.
        :param pulumi.Input[builtins.str] email: The email address for the account.
    ...
    def invitation_disable_email_notification(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Specifies whether to send an email notification to the root user of each account that the invitation will be sent to. This notification is in addition to an alert that the root user receives in AWS Personal Health Dashboard. To send an email notification to the root user of each account, set this value to `true`.
        """
    ...
    def invitation_disable_email_notification(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] account_id: The AWS account ID for the account.
        :param pulumi.Input[builtins.str] administrator_account_id: The AWS account ID for the administrator account.
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the account.
        :param pulumi.Input[builtins.str] email: The email address for the account.
        :param pulumi.Input[builtins.bool] invitation_disable_email_notification: Specifies whether to send an email notification to the root user of each account that the invitation will be sent to. This notification is in addition to an alert that the root user receives in AWS Personal Health Dashboard. To send an email notification to the root user of each account, set this value to `true`.
        :param pulumi.Input[builtins.str] invitation_message: A custom message to include in the invitation. Amazon Macie adds this message to the standard content that it sends for an invitation.
        :param pulumi.Input[builtins.bool] invite: Send an invitation to a member
        ...
        :param pulumi.Input[builtins.str] updated_at: The date and time, in UTC and extended RFC 3339 format, of the most recent change to the status of the relationship between the account and the administrator account.
        """
    ...
    def invited_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @invited_at.setter
    def invited_at(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Member(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            updated_at: Optional[pulumi.Input[builtins.str]] = None) -> 'Member':
        """
    ...
    @property
    @pulumi.getter(name="invitationDisableEmailNotification")
    def invitation_disable_email_notification(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to send an email notification to the root user of each account that the invitation will be sent to. This notification is in addition to an alert that the root user receives in AWS Personal Health Dashboard. To send an email notification to the root user of each account, set this value to `true`.
        """
        return pulumi.get(self, "invitation_disable_email_notification")
    ...
    @property
    @pulumi.getter
    def invite(self) -> pulumi.Output[builtins.bool]:
        """
        Send an invitation to a member
        """
        return pulumi.get(self, "invite")
    ...
    @property
    @pulumi.getter(name="invitedAt")
    def invited_at(self) -> pulumi.Output[builtins.str]:
        """
        The date and time, in UTC and extended RFC 3339 format, when an Amazon Macie membership invitation was last sent to the account. This value is null if a Macie invitation hasn't been sent to the account.
        """
        return pulumi.get(self, "invited_at")
