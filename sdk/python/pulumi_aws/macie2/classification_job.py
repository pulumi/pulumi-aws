...
class _ClassificationJobState:
    ...
    def _configure(
        ...
        if 'userPausedDetails' in kwargs:
...
class ClassificationJob(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if s3_job_definition is not None and not isinstance(s3_job_definition, ClassificationJobS3JobDefinitionArgs):
                s3_job_definition = s3_job_definition or {}
                def _setter(key, value):
                    s3_job_definition[key] = value
                ClassificationJobS3JobDefinitionArgs._configure(_setter, **s3_job_definition)
            ...
            if schedule_frequency is not None and not isinstance(schedule_frequency, ClassificationJobScheduleFrequencyArgs):
                schedule_frequency = schedule_frequency or {}
                def _setter(key, value):
                    schedule_frequency[key] = value
                ClassificationJobScheduleFrequencyArgs._configure(_setter, **schedule_frequency)
