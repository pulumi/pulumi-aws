...
class ClassificationJobArgs:
    def __init__(__self__, *,
                 ...
                 custom_data_identifier_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 initial_run: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_data_identifier_ids: The custom data identifiers to use for data analysis and classification.
        :param pulumi.Input[builtins.str] description: A custom description of the job. The description can contain as many as 200 characters.
        :param pulumi.Input[builtins.bool] initial_run: Specifies whether to analyze all existing, eligible objects immediately after the job is created.
    ...
    def custom_data_identifier_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def custom_data_identifier_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def initial_run(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @initial_run.setter
    def initial_run(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ClassificationJobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] created_at: The date and time, in UTC and extended RFC 3339 format, when the job was created.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] custom_data_identifier_ids: The custom data identifiers to use for data analysis and classification.
        :param pulumi.Input[builtins.str] description: A custom description of the job. The description can contain as many as 200 characters.
        :param pulumi.Input[builtins.bool] initial_run: Specifies whether to analyze all existing, eligible objects immediately after the job is created.
        :param pulumi.Input[builtins.str] job_status: The status for the job. Valid values are: `CANCELLED`, `RUNNING` and `USER_PAUSED`
...
class ClassificationJob(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="customDataIdentifierIds")
    def custom_data_identifier_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The custom data identifiers to use for data analysis and classification.
        """
        return pulumi.get(self, "custom_data_identifier_ids")
    ...
    @property
    @pulumi.getter(name="initialRun")
    def initial_run(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies whether to analyze all existing, eligible objects immediately after the job is created.
        """
        return pulumi.get(self, "initial_run")
    ...
    @property
    @pulumi.getter(name="samplingPercentage")
    def sampling_percentage(self) -> pulumi.Output[builtins.int]:
        """
        The sampling depth, as a percentage, to apply when processing objects. This value determines the percentage of eligible objects that the job analyzes. If this value is less than 100, Amazon Macie selects the objects to analyze at random, up to the specified percentage, and analyzes all the data in those objects.
        """
        return pulumi.get(self, "sampling_percentage")
