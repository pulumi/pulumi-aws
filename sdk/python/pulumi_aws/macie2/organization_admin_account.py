...
class OrganizationAdminAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] admin_account_id: The AWS account ID for the account to designate as the delegated Amazon Macie administrator account for the organization.
        """
        pulumi.set(__self__, "admin_account_id", admin_account_id)

    @property
    @pulumi.getter(name="adminAccountId")
    def admin_account_id(self) -> pulumi.Input[builtins.str]:
        """
...
class _OrganizationAdminAccountState:
    ...
    @property
    @pulumi.getter(name="adminAccountId")
    def admin_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The AWS account ID for the account to designate as the delegated Amazon Macie administrator account for the organization.
        """
        return pulumi.get(self, "admin_account_id")
    ...
    @admin_account_id.setter
    def admin_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "admin_account_id", value)


@pulumi.type_token("aws:macie2/organizationAdminAccount:OrganizationAdminAccount")
class OrganizationAdminAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            admin_account_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OrganizationAdminAccount':
        """
    ...
    @property
    @pulumi.getter(name="adminAccountId")
    def admin_account_id(self) -> pulumi.Output[builtins.str]:
        """
        The AWS account ID for the account to designate as the delegated Amazon Macie administrator account for the organization.
        """
        return pulumi.get(self, "admin_account_id")
