...
class ApprovalRuleTemplateAssociationArgs:
    ...
    def approval_rule_template_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def approval_rule_template_name(self, value: pulumi.Input[builtins.str]):
...
class _ApprovalRuleTemplateAssociationState:
    ...
    @property
    @pulumi.getter(name="approvalRuleTemplateName")
    def approval_rule_template_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name for the approval rule template.
        """
        return pulumi.get(self, "approval_rule_template_name")
...
class ApprovalRuleTemplateAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="approvalRuleTemplateName")
    def approval_rule_template_name(self) -> pulumi.Output[builtins.str]:
        """
        The name for the approval rule template.
        """
        return pulumi.get(self, "approval_rule_template_name")
