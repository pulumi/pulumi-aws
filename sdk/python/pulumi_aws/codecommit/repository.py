...
class _RepositoryState:
    def __init__(__self__, *,
                 ...
                 clone_url_http: Optional[pulumi.Input[builtins.str]] = None,
                 clone_url_ssh: Optional[pulumi.Input[builtins.str]] = None,
                 default_branch: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] clone_url_http: The URL to use for cloning the repository over HTTPS.
        :param pulumi.Input[builtins.str] clone_url_ssh: The URL to use for cloning the repository over SSH.
        :param pulumi.Input[builtins.str] default_branch: The default branch of the repository. The branch specified here needs to exist.
        :param pulumi.Input[builtins.str] description: The description of the repository. This needs to be less than 1000 characters
        :param pulumi.Input[builtins.str] kms_key_id: The ARN of the encryption key. If no key is specified, the default `aws/codecommit` Amazon Web Services managed key is used.
    ...
    def clone_url_http(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def clone_url_http(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "clone_url_http", value)

    @property
    @pulumi.getter(name="cloneUrlSsh")
    def clone_url_ssh(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def clone_url_ssh(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Repository(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="cloneUrlHttp")
    def clone_url_http(self) -> pulumi.Output[builtins.str]:
        """
        The URL to use for cloning the repository over HTTPS.
        """
        return pulumi.get(self, "clone_url_http")
    ...
    @property
    @pulumi.getter(name="cloneUrlSsh")
    def clone_url_ssh(self) -> pulumi.Output[builtins.str]:
        """
        The URL to use for cloning the repository over SSH.
        """
        return pulumi.get(self, "clone_url_ssh")
