...
if not MYPY:
    class ConnectorCapacityAutoscalingArgsDict(TypedDict):
        ...
        """
        mcu_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ConnectorCapacityAutoscalingArgs:
    def __init__(__self__, *,
                 max_worker_count: pulumi.Input[builtins.int],
                 min_worker_count: pulumi.Input[builtins.int],
                 mcu_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        """
        :param pulumi.Input[builtins.int] max_worker_count: The maximum number of workers allocated to the connector.
        :param pulumi.Input[builtins.int] min_worker_count: The minimum number of workers allocated to the connector.
        :param pulumi.Input[builtins.int] mcu_count: The number of microcontroller units (MCUs) allocated to each connector worker. Valid values: `1`, `2`, `4`, `8`. The default value is `1`.
    ...
    def mcu_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of microcontroller units (MCUs) allocated to each connector worker. Valid values: `1`, `2`, `4`, `8`. The default value is `1`.
        """
    ...
    @mcu_count.setter
    def mcu_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ConnectorCapacityAutoscalingScaleInPolicyArgsDict(TypedDict):
        cpu_utilization_percentage: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ConnectorCapacityAutoscalingScaleInPolicyArgs:
    def __init__(__self__, *,
                 cpu_utilization_percentage: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] cpu_utilization_percentage: Specifies the CPU utilization percentage threshold at which you want connector scale in to be triggered.
        """
    ...
    def cpu_utilization_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Specifies the CPU utilization percentage threshold at which you want connector scale in to be triggered.
        """
    ...
    def cpu_utilization_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ConnectorCapacityAutoscalingScaleOutPolicyArgs:
    def __init__(__self__, *,
                 cpu_utilization_percentage: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] cpu_utilization_percentage: The CPU utilization percentage threshold at which you want connector scale out to be triggered.
        """
        if cpu_utilization_percentage is not None:
            pulumi.set(__self__, "cpu_utilization_percentage", cpu_utilization_percentage)
...
class ConnectorCapacityProvisionedCapacityArgs:
    def __init__(__self__, *,
                 ...
                 mcu_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] worker_count: The number of workers that are allocated to the connector.
        :param pulumi.Input[builtins.int] mcu_count: The number of microcontroller units (MCUs) allocated to each connector worker. Valid values: `1`, `2`, `4`, `8`. The default value is `1`.
        """
...
if not MYPY:
    class ConnectorKafkaClusterApacheKafkaClusterArgsDict(TypedDict):
        bootstrap_servers: pulumi.Input[builtins.str]
        """
...
class ConnectorKafkaClusterApacheKafkaClusterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bootstrap_servers: The bootstrap servers of the cluster.
    ...
    def bootstrap_servers(self) -> pulumi.Input[builtins.str]:
        """
        The bootstrap servers of the cluster.
        """
    ...
    def bootstrap_servers(self, value: pulumi.Input[builtins.str]):
...
class ConnectorKafkaClusterApacheKafkaClusterVpcArgs:
    def __init__(__self__, *,
                 ...
                 subnets: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: The security groups for the connector.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnets: The subnets for the connector.
        """
...
class ConnectorKafkaClusterClientAuthenticationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] authentication_type: The type of client authentication used to connect to the Apache Kafka cluster. Valid values: `IAM`, `NONE`. A value of `NONE` means that no client authentication is used. The default value is `NONE`.
        """
...
class ConnectorKafkaClusterEncryptionInTransitArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] encryption_type: The type of encryption in transit to the Apache Kafka cluster. Valid values: `PLAINTEXT`, `TLS`. The default values is `PLAINTEXT`.
        """
...
class ConnectorLogDeliveryWorkerLogDeliveryCloudwatchLogsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Whether log delivery to Amazon CloudWatch Logs is enabled.
        :param pulumi.Input[builtins.str] log_group: The name of the CloudWatch log group that is the destination for log delivery.
        """
...
class ConnectorLogDeliveryWorkerLogDeliveryFirehoseArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Specifies whether connector logs get delivered to Amazon Kinesis Data Firehose.
        :param pulumi.Input[builtins.str] delivery_stream: The name of the Kinesis Data Firehose delivery stream that is the destination for log delivery.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ConnectorLogDeliveryWorkerLogDeliveryS3Args:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Specifies whether connector logs get sent to the specified Amazon S3 destination.
        :param pulumi.Input[builtins.str] bucket: The name of the S3 bucket that is the destination for log delivery.
        :param pulumi.Input[builtins.str] prefix: The S3 prefix that is the destination for log delivery.
        """
        pulumi.set(__self__, "enabled", enabled)
...
class ConnectorPluginCustomPluginArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] revision: The revision of the custom plugin.
        """
...
class ConnectorWorkerConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] revision: The revision of the worker configuration.
        """
        pulumi.set(__self__, "arn", arn)
        pulumi.set(__self__, "revision", revision)
...
class CustomPluginLocationS3Args:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket_arn: The Amazon Resource Name (ARN) of an S3 bucket.
        :param pulumi.Input[builtins.str] file_key: The file key for an object in an S3 bucket.
        :param pulumi.Input[builtins.str] object_version: The version of an object in an S3 bucket.
        """
