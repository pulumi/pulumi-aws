...
class ContactsEmailContactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] email_address: Email address for the contact. Must be between 6 and 254 characters and match an email
               pattern.
        :param pulumi.Input[builtins.str] name: Name of the email contact. Must be between 1 and 64 characters and can contain alphanumeric
...
class _ContactsEmailContactState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the Email Contact.
        :param pulumi.Input[builtins.str] email_address: Email address for the contact. Must be between 6 and 254 characters and match an email
               pattern.
        :param pulumi.Input[builtins.str] name: Name of the email contact. Must be between 1 and 64 characters and can contain alphanumeric
               characters, underscores, tildes, periods, and hyphens.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of tags to assign to the resource. If configured with a provider 
               `default_tags` configuration block
               present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags_all: Map of tags assigned to the resource, including those inherited from the provider 
               `default_tags` configuration block.
        """
        if arn is not None:
...
class ContactsEmailContact(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'ContactsEmailContact':
        """
