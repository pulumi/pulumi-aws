...
class TopicArgs:
    def __init__(__self__, *,
                 application_failure_feedback_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 application_success_feedback_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 application_success_feedback_sample_rate: Optional[pulumi.Input[builtins.int]] = None,
                 archive_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 firehose_success_feedback_sample_rate: Optional[pulumi.Input[builtins.int]] = None,
                 http_failure_feedback_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 http_success_feedback_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 http_success_feedback_sample_rate: Optional[pulumi.Input[builtins.int]] = None,
                 kms_master_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 lambda_failure_feedback_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 lambda_success_feedback_role_arn: Optional[pulumi.Input[builtins.str]] = None,
                 lambda_success_feedback_sample_rate: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] application_failure_feedback_role_arn: IAM role for failure feedback
        :param pulumi.Input[builtins.str] application_success_feedback_role_arn: The IAM role permitted to receive success feedback for this topic
        :param pulumi.Input[builtins.int] application_success_feedback_sample_rate: Percentage of success to sample
        :param pulumi.Input[builtins.str] archive_policy: The message archive policy for FIFO topics. More details in the [AWS documentation](https://docs.aws.amazon.com/sns/latest/dg/message-archiving-and-replay-topic-owner.html).
        ...
        :param pulumi.Input[builtins.int] firehose_success_feedback_sample_rate: Percentage of success to sample
        :param pulumi.Input[builtins.str] http_failure_feedback_role_arn: IAM role for failure feedback
        :param pulumi.Input[builtins.str] http_success_feedback_role_arn: The IAM role permitted to receive success feedback for this topic
        :param pulumi.Input[builtins.int] http_success_feedback_sample_rate: Percentage of success to sample
        :param pulumi.Input[builtins.str] kms_master_key_id: The ID of an AWS-managed customer master key (CMK) for Amazon SNS or a custom CMK. For more information, see [Key Terms](https://docs.aws.amazon.com/sns/latest/dg/sns-server-side-encryption.html#sse-key-terms)
        :param pulumi.Input[builtins.str] lambda_failure_feedback_role_arn: IAM role for failure feedback
        :param pulumi.Input[builtins.str] lambda_success_feedback_role_arn: The IAM role permitted to receive success feedback for this topic
        :param pulumi.Input[builtins.int] lambda_success_feedback_sample_rate: Percentage of success to sample
    ...
    def application_failure_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_failure_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_failure_feedback_role_arn", value)

    @property
    @pulumi.getter(name="applicationSuccessFeedbackRoleArn")
    def application_success_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def application_success_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "application_success_feedback_role_arn", value)

    @property
    @pulumi.getter(name="applicationSuccessFeedbackSampleRate")
    def application_success_feedback_sample_rate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def application_success_feedback_sample_rate(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "application_success_feedback_sample_rate", value)

    @property
    @pulumi.getter(name="archivePolicy")
    def archive_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def archive_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def delivery_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delivery_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def firehose_failure_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        IAM role for failure feedback
        """
    ...
    def firehose_failure_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "firehose_failure_feedback_role_arn", value)

    @property
    @pulumi.getter(name="firehoseSuccessFeedbackRoleArn")
    def firehose_success_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IAM role permitted to receive success feedback for this topic
        """
    ...
    def firehose_success_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "firehose_success_feedback_role_arn", value)

    @property
    @pulumi.getter(name="firehoseSuccessFeedbackSampleRate")
    def firehose_success_feedback_sample_rate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Percentage of success to sample
        """
    ...
    def firehose_success_feedback_sample_rate(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "firehose_success_feedback_sample_rate", value)

    @property
    @pulumi.getter(name="httpFailureFeedbackRoleArn")
    def http_failure_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        IAM role for failure feedback
        """
    ...
    def http_failure_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "http_failure_feedback_role_arn", value)

    @property
    @pulumi.getter(name="httpSuccessFeedbackRoleArn")
    def http_success_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IAM role permitted to receive success feedback for this topic
        """
    ...
    def http_success_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "http_success_feedback_role_arn", value)

    @property
    @pulumi.getter(name="httpSuccessFeedbackSampleRate")
    def http_success_feedback_sample_rate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Percentage of success to sample
        """
    ...
    def http_success_feedback_sample_rate(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def lambda_failure_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        IAM role for failure feedback
        """
    ...
    def lambda_failure_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lambda_failure_feedback_role_arn", value)

    @property
    @pulumi.getter(name="lambdaSuccessFeedbackRoleArn")
    def lambda_success_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IAM role permitted to receive success feedback for this topic
        """
    ...
    def lambda_success_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "lambda_success_feedback_role_arn", value)

    @property
    @pulumi.getter(name="lambdaSuccessFeedbackSampleRate")
    def lambda_success_feedback_sample_rate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Percentage of success to sample
        """
    ...
    def lambda_success_feedback_sample_rate(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def signature_version(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "signature_version", value)

    @property
    @pulumi.getter(name="sqsFailureFeedbackRoleArn")
    def sqs_failure_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        IAM role for failure feedback
        """
    ...
    def sqs_failure_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sqs_failure_feedback_role_arn", value)

    @property
    @pulumi.getter(name="sqsSuccessFeedbackRoleArn")
    def sqs_success_feedback_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IAM role permitted to receive success feedback for this topic
        """
    ...
    def sqs_success_feedback_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sqs_success_feedback_role_arn", value)

    @property
    @pulumi.getter(name="sqsSuccessFeedbackSampleRate")
    def sqs_success_feedback_sample_rate(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Percentage of success to sample
        """
    ...
    def sqs_success_feedback_sample_rate(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def tracing_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tracing_config(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TopicState:
    def __init__(__self__, *,
                 ...
                 beginning_archive_time: Optional[pulumi.Input[builtins.str]] = None,
                 content_based_deduplication: Optional[pulumi.Input[builtins.bool]] = None,
                 delivery_policy: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 fifo_topic: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] application_success_feedback_sample_rate: Percentage of success to sample
        :param pulumi.Input[builtins.str] archive_policy: The message archive policy for FIFO topics. More details in the [AWS documentation](https://docs.aws.amazon.com/sns/latest/dg/message-archiving-and-replay-topic-owner.html).
        :param pulumi.Input[builtins.str] arn: The ARN of the SNS topic, as a more obvious property (clone of id)
        :param pulumi.Input[builtins.str] beginning_archive_time: The oldest timestamp at which a FIFO topic subscriber can start a replay.
        :param pulumi.Input[builtins.bool] content_based_deduplication: Enables content-based deduplication for FIFO topics. For more information, see the [related documentation](https://docs.aws.amazon.com/sns/latest/dg/fifo-message-dedup.html)
        :param pulumi.Input[builtins.str] delivery_policy: The SNS delivery policy. More details in the [AWS documentation](https://docs.aws.amazon.com/sns/latest/dg/DeliveryPolicies.html).
        :param pulumi.Input[builtins.str] display_name: The display name for the topic
        :param pulumi.Input[builtins.bool] fifo_topic: Boolean indicating whether or not to create a FIFO (first-in-first-out) topic. FIFO topics can't deliver messages to customer managed endpoints, such as email addresses, mobile apps, SMS, or HTTP(S) endpoints. These endpoint types aren't guaranteed to preserve strict message ordering. Default is `false`.
    ...
    def beginning_archive_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def beginning_archive_time(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Topic(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tracing_config: Optional[pulumi.Input[builtins.str]] = None) -> 'Topic':
        """
    ...
    @property
    @pulumi.getter(name="applicationFailureFeedbackRoleArn")
    def application_failure_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IAM role for failure feedback
        """
        return pulumi.get(self, "application_failure_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="applicationSuccessFeedbackRoleArn")
    def application_success_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IAM role permitted to receive success feedback for this topic
        """
        return pulumi.get(self, "application_success_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="applicationSuccessFeedbackSampleRate")
    def application_success_feedback_sample_rate(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Percentage of success to sample
        """
        return pulumi.get(self, "application_success_feedback_sample_rate")
    ...
    @property
    @pulumi.getter(name="archivePolicy")
    def archive_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The message archive policy for FIFO topics. More details in the [AWS documentation](https://docs.aws.amazon.com/sns/latest/dg/message-archiving-and-replay-topic-owner.html).
        """
        return pulumi.get(self, "archive_policy")
    ...
    @property
    @pulumi.getter(name="beginningArchiveTime")
    def beginning_archive_time(self) -> pulumi.Output[builtins.str]:
        """
        The oldest timestamp at which a FIFO topic subscriber can start a replay.
        """
        return pulumi.get(self, "beginning_archive_time")
    ...
    @property
    @pulumi.getter(name="deliveryPolicy")
    def delivery_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The SNS delivery policy. More details in the [AWS documentation](https://docs.aws.amazon.com/sns/latest/dg/DeliveryPolicies.html).
        """
        return pulumi.get(self, "delivery_policy")
    ...
    @property
    @pulumi.getter(name="fifoTopic")
    def fifo_topic(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean indicating whether or not to create a FIFO (first-in-first-out) topic. FIFO topics can't deliver messages to customer managed endpoints, such as email addresses, mobile apps, SMS, or HTTP(S) endpoints. These endpoint types aren't guaranteed to preserve strict message ordering. Default is `false`.
        """
        return pulumi.get(self, "fifo_topic")
    ...
    @property
    @pulumi.getter(name="firehoseFailureFeedbackRoleArn")
    def firehose_failure_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IAM role for failure feedback
        """
        return pulumi.get(self, "firehose_failure_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="firehoseSuccessFeedbackRoleArn")
    def firehose_success_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IAM role permitted to receive success feedback for this topic
        """
        return pulumi.get(self, "firehose_success_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="firehoseSuccessFeedbackSampleRate")
    def firehose_success_feedback_sample_rate(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Percentage of success to sample
        """
        return pulumi.get(self, "firehose_success_feedback_sample_rate")
    ...
    @property
    @pulumi.getter(name="httpFailureFeedbackRoleArn")
    def http_failure_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IAM role for failure feedback
        """
        return pulumi.get(self, "http_failure_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="httpSuccessFeedbackRoleArn")
    def http_success_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IAM role permitted to receive success feedback for this topic
        """
        return pulumi.get(self, "http_success_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="httpSuccessFeedbackSampleRate")
    def http_success_feedback_sample_rate(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Percentage of success to sample
        """
        return pulumi.get(self, "http_success_feedback_sample_rate")
    ...
    @property
    @pulumi.getter(name="kmsMasterKeyId")
    def kms_master_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of an AWS-managed customer master key (CMK) for Amazon SNS or a custom CMK. For more information, see [Key Terms](https://docs.aws.amazon.com/sns/latest/dg/sns-server-side-encryption.html#sse-key-terms)
        """
        return pulumi.get(self, "kms_master_key_id")
    ...
    @property
    @pulumi.getter(name="lambdaFailureFeedbackRoleArn")
    def lambda_failure_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IAM role for failure feedback
        """
        return pulumi.get(self, "lambda_failure_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="lambdaSuccessFeedbackRoleArn")
    def lambda_success_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IAM role permitted to receive success feedback for this topic
        """
        return pulumi.get(self, "lambda_success_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="lambdaSuccessFeedbackSampleRate")
    def lambda_success_feedback_sample_rate(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Percentage of success to sample
        """
        return pulumi.get(self, "lambda_success_feedback_sample_rate")
    ...
    @property
    @pulumi.getter(name="sqsFailureFeedbackRoleArn")
    def sqs_failure_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IAM role for failure feedback
        """
        return pulumi.get(self, "sqs_failure_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="sqsSuccessFeedbackRoleArn")
    def sqs_success_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IAM role permitted to receive success feedback for this topic
        """
        return pulumi.get(self, "sqs_success_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="sqsSuccessFeedbackSampleRate")
    def sqs_success_feedback_sample_rate(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Percentage of success to sample
        """
        return pulumi.get(self, "sqs_success_feedback_sample_rate")
    ...
    @property
    @pulumi.getter(name="tracingConfig")
    def tracing_config(self) -> pulumi.Output[builtins.str]:
        """
        Tracing mode of an Amazon SNS topic. Valid values: `"PassThrough"`, `"Active"`.
        """
        return pulumi.get(self, "tracing_config")
