...
class PlatformApplicationArgs:
    def __init__(__self__, *,
                 ...
                 platform_credential: pulumi.Input[builtins.str],
                 apple_platform_bundle_id: Optional[pulumi.Input[builtins.str]] = None,
                 apple_platform_team_id: Optional[pulumi.Input[builtins.str]] = None,
                 event_delivery_failure_topic_arn: Optional[pulumi.Input[builtins.str]] = None,
                 event_endpoint_created_topic_arn: Optional[pulumi.Input[builtins.str]] = None,
                 event_endpoint_deleted_topic_arn: Optional[pulumi.Input[builtins.str]] = None,
                 event_endpoint_updated_topic_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] apple_platform_bundle_id: The bundle identifier that's assigned to your iOS app. May only include alphanumeric characters, hyphens (-), and periods (.).
        :param pulumi.Input[builtins.str] apple_platform_team_id: The identifier that's assigned to your Apple developer account team. Must be 10 alphanumeric characters.
        :param pulumi.Input[builtins.str] event_delivery_failure_topic_arn: The ARN of the SNS Topic triggered when a delivery to any of the platform endpoints associated with your platform application encounters a permanent failure.
        :param pulumi.Input[builtins.str] event_endpoint_created_topic_arn: The ARN of the SNS Topic triggered when a new platform endpoint is added to your platform application.
        :param pulumi.Input[builtins.str] event_endpoint_deleted_topic_arn: The ARN of the SNS Topic triggered when an existing platform endpoint is deleted from your platform application.
        :param pulumi.Input[builtins.str] event_endpoint_updated_topic_arn: The ARN of the SNS Topic triggered when an existing platform endpoint is changed from your platform application.
    ...
    def platform_credential(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def platform_credential(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "platform_credential", value)

    @property
    @pulumi.getter(name="applePlatformBundleId")
    def apple_platform_bundle_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def apple_platform_bundle_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "apple_platform_bundle_id", value)

    @property
    @pulumi.getter(name="applePlatformTeamId")
    def apple_platform_team_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def apple_platform_team_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "apple_platform_team_id", value)

    @property
    @pulumi.getter(name="eventDeliveryFailureTopicArn")
    def event_delivery_failure_topic_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_delivery_failure_topic_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_delivery_failure_topic_arn", value)

    @property
    @pulumi.getter(name="eventEndpointCreatedTopicArn")
    def event_endpoint_created_topic_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_endpoint_created_topic_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_endpoint_created_topic_arn", value)

    @property
    @pulumi.getter(name="eventEndpointDeletedTopicArn")
    def event_endpoint_deleted_topic_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_endpoint_deleted_topic_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "event_endpoint_deleted_topic_arn", value)

    @property
    @pulumi.getter(name="eventEndpointUpdatedTopicArn")
    def event_endpoint_updated_topic_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_endpoint_updated_topic_arn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def platform_principal(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def platform_principal(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PlatformApplicationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] apple_platform_bundle_id: The bundle identifier that's assigned to your iOS app. May only include alphanumeric characters, hyphens (-), and periods (.).
        :param pulumi.Input[builtins.str] apple_platform_team_id: The identifier that's assigned to your Apple developer account team. Must be 10 alphanumeric characters.
        :param pulumi.Input[builtins.str] arn: The ARN of the SNS platform application
        :param pulumi.Input[builtins.str] event_delivery_failure_topic_arn: The ARN of the SNS Topic triggered when a delivery to any of the platform endpoints associated with your platform application encounters a permanent failure.
        :param pulumi.Input[builtins.str] event_endpoint_created_topic_arn: The ARN of the SNS Topic triggered when a new platform endpoint is added to your platform application.
        :param pulumi.Input[builtins.str] event_endpoint_deleted_topic_arn: The ARN of the SNS Topic triggered when an existing platform endpoint is deleted from your platform application.
        :param pulumi.Input[builtins.str] event_endpoint_updated_topic_arn: The ARN of the SNS Topic triggered when an existing platform endpoint is changed from your platform application.
    ...
    @property
    @pulumi.getter(name="platformCredential")
    def platform_credential(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Application Platform credential. See [Credential](http://docs.aws.amazon.com/sns/latest/dg/mobile-push-send-register.html) for type of credential required for platform. The value of this attribute when stored into the state is only a hash of the real value, so therefore it is not practical to use this as an attribute for other resources.
        """
        return pulumi.get(self, "platform_credential")
    ...
    @platform_credential.setter
    def platform_credential(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "platform_credential", value)
...
class PlatformApplication(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="applePlatformBundleId")
    def apple_platform_bundle_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The bundle identifier that's assigned to your iOS app. May only include alphanumeric characters, hyphens (-), and periods (.).
        """
        return pulumi.get(self, "apple_platform_bundle_id")
    ...
    @property
    @pulumi.getter(name="applePlatformTeamId")
    def apple_platform_team_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The identifier that's assigned to your Apple developer account team. Must be 10 alphanumeric characters.
        """
        return pulumi.get(self, "apple_platform_team_id")
    ...
    @property
    @pulumi.getter(name="eventDeliveryFailureTopicArn")
    def event_delivery_failure_topic_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the SNS Topic triggered when a delivery to any of the platform endpoints associated with your platform application encounters a permanent failure.
        """
        return pulumi.get(self, "event_delivery_failure_topic_arn")
    ...
    @property
    @pulumi.getter(name="eventEndpointCreatedTopicArn")
    def event_endpoint_created_topic_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the SNS Topic triggered when a new platform endpoint is added to your platform application.
        """
        return pulumi.get(self, "event_endpoint_created_topic_arn")
    ...
    @property
    @pulumi.getter(name="eventEndpointDeletedTopicArn")
    def event_endpoint_deleted_topic_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the SNS Topic triggered when an existing platform endpoint is deleted from your platform application.
        """
        return pulumi.get(self, "event_endpoint_deleted_topic_arn")
    ...
    @property
    @pulumi.getter(name="eventEndpointUpdatedTopicArn")
    def event_endpoint_updated_topic_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the SNS Topic triggered when an existing platform endpoint is changed from your platform application.
        """
        return pulumi.get(self, "event_endpoint_updated_topic_arn")
    ...
    @property
    @pulumi.getter(name="failureFeedbackRoleArn")
    def failure_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IAM role ARN permitted to receive failure feedback for this application and give SNS write access to use CloudWatch logs on your behalf.
        """
        return pulumi.get(self, "failure_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="platformCredential")
    def platform_credential(self) -> pulumi.Output[builtins.str]:
        """
        Application Platform credential. See [Credential](http://docs.aws.amazon.com/sns/latest/dg/mobile-push-send-register.html) for type of credential required for platform. The value of this attribute when stored into the state is only a hash of the real value, so therefore it is not practical to use this as an attribute for other resources.
        """
        return pulumi.get(self, "platform_credential")
    ...
    @property
    @pulumi.getter(name="platformPrincipal")
    def platform_principal(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Application Platform principal. See [Principal](http://docs.aws.amazon.com/sns/latest/api/API_CreatePlatformApplication.html) for type of principal required for platform. The value of this attribute when stored into the state is only a hash of the real value, so therefore it is not practical to use this as an attribute for other resources.
        """
        return pulumi.get(self, "platform_principal")
    ...
    @property
    @pulumi.getter(name="successFeedbackRoleArn")
    def success_feedback_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The IAM role ARN permitted to receive success feedback for this application and give SNS write access to use CloudWatch logs on your behalf.
        """
        return pulumi.get(self, "success_feedback_role_arn")
    ...
    @property
    @pulumi.getter(name="successFeedbackSampleRate")
    def success_feedback_sample_rate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The sample rate percentage (0-100) of successfully delivered messages.
