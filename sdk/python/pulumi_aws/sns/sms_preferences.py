...
class SmsPreferencesArgs:
    def __init__(__self__, *,
                 ...
                 default_sms_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] default_sender_id: A string, such as your business brand, that is displayed as the sender on the receiving device.
        :param pulumi.Input[builtins.str] default_sms_type: The type of SMS message that you will send by default. Possible values are: Promotional, Transactional
    ...
    def default_sms_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_sms_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_sms_type", value)

    @property
    @pulumi.getter(name="deliveryStatusIamRoleArn")
    def delivery_status_iam_role_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delivery_status_iam_role_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_status_iam_role_arn", value)

    @property
    @pulumi.getter(name="deliveryStatusSuccessSamplingRate")
    def delivery_status_success_sampling_rate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def delivery_status_success_sampling_rate(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivery_status_success_sampling_rate", value)

    @property
    @pulumi.getter(name="monthlySpendLimit")
    def monthly_spend_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def usage_report_s3_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def usage_report_s3_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SmsPreferences(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="defaultSmsType")
    def default_sms_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of SMS message that you will send by default. Possible values are: Promotional, Transactional
        """
        return pulumi.get(self, "default_sms_type")
    ...
    @property
    @pulumi.getter(name="deliveryStatusIamRoleArn")
    def delivery_status_iam_role_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ARN of the IAM role that allows Amazon SNS to write logs about SMS deliveries in CloudWatch Logs.
        """
        return pulumi.get(self, "delivery_status_iam_role_arn")
    ...
    @property
    @pulumi.getter(name="deliveryStatusSuccessSamplingRate")
    def delivery_status_success_sampling_rate(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The percentage of successful SMS deliveries for which Amazon SNS will write logs in CloudWatch Logs. The value must be between 0 and 100.
        """
        return pulumi.get(self, "delivery_status_success_sampling_rate")
    ...
    @property
    @pulumi.getter(name="monthlySpendLimit")
    def monthly_spend_limit(self) -> pulumi.Output[builtins.int]:
        """
        The maximum amount in USD that you are willing to spend each month to send SMS messages.
        """
        return pulumi.get(self, "monthly_spend_limit")
    ...
    @property
    @pulumi.getter(name="usageReportS3Bucket")
    def usage_report_s3_bucket(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The name of the Amazon S3 bucket to receive daily SMS usage reports from Amazon SNS.
        """
        return pulumi.get(self, "usage_report_s3_bucket")
