...
class TopicSubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 filter_policy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] delivery_policy: JSON String with the delivery policy (retries, backoff, etc.) that will be used in the subscription - this only applies to HTTP/S subscriptions. Refer to the [SNS docs](https://docs.aws.amazon.com/sns/latest/dg/DeliveryPolicies.html) for more details.
        :param pulumi.Input[builtins.bool] endpoint_auto_confirms: Whether the endpoint is capable of [auto confirming subscription](http://docs.aws.amazon.com/sns/latest/dg/SendMessageToHttp.html#SendMessageToHttp.prepare) (e.g., PagerDuty). Default is `false`.
        :param pulumi.Input[builtins.str] filter_policy: JSON String with the filter policy that will be used in the subscription to filter messages seen by the target resource. Refer to the [SNS docs](https://docs.aws.amazon.com/sns/latest/dg/message-filtering.html) for more details.
    ...
    def confirmation_timeout_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def confirmation_timeout_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def endpoint_auto_confirms(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def endpoint_auto_confirms(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "endpoint_auto_confirms", value)

    @property
    @pulumi.getter(name="filterPolicy")
    def filter_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def filter_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def replay_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TopicSubscriptionState:
    def __init__(__self__, *,
                 ...
                 confirmation_timeout_in_minutes: Optional[pulumi.Input[builtins.int]] = None,
                 confirmation_was_authenticated: Optional[pulumi.Input[builtins.bool]] = None,
                 delivery_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 pending_confirmation: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.int] confirmation_timeout_in_minutes: Integer indicating number of minutes to wait in retrying mode for fetching subscription arn before marking it as failure. Only applicable for http and https protocols. Default is `1`.
        :param pulumi.Input[builtins.bool] confirmation_was_authenticated: Whether the subscription confirmation request was authenticated.
        :param pulumi.Input[builtins.str] delivery_policy: JSON String with the delivery policy (retries, backoff, etc.) that will be used in the subscription - this only applies to HTTP/S subscriptions. Refer to the [SNS docs](https://docs.aws.amazon.com/sns/latest/dg/DeliveryPolicies.html) for more details.
        :param pulumi.Input[builtins.str] endpoint: Endpoint to send data to. The contents vary with the protocol. See details below.
        :param pulumi.Input[builtins.bool] endpoint_auto_confirms: Whether the endpoint is capable of [auto confirming subscription](http://docs.aws.amazon.com/sns/latest/dg/SendMessageToHttp.html#SendMessageToHttp.prepare) (e.g., PagerDuty). Default is `false`.
        :param pulumi.Input[builtins.str] filter_policy: JSON String with the filter policy that will be used in the subscription to filter messages seen by the target resource. Refer to the [SNS docs](https://docs.aws.amazon.com/sns/latest/dg/message-filtering.html) for more details.
        :param pulumi.Input[builtins.str] filter_policy_scope: Whether the `filter_policy` applies to `MessageAttributes` (default) or `MessageBody`.
        :param pulumi.Input[builtins.str] owner_id: AWS account ID of the subscription's owner.
        :param pulumi.Input[builtins.bool] pending_confirmation: Whether the subscription has not been confirmed.
        :param pulumi.Input[builtins.str] protocol: Protocol to use. Valid values are: `sqs`, `sms`, `lambda`, `firehose`, and `application`. Protocols `email`, `email-json`, `http` and `https` are also valid but partially supported. See details below.
        :param pulumi.Input[builtins.bool] raw_message_delivery: Whether to enable raw message delivery (the original message is directly passed, not wrapped in JSON with the original message in the message property). Default is `false`.
        :param pulumi.Input[builtins.str] redrive_policy: JSON String with the redrive policy that will be used in the subscription. Refer to the [SNS docs](https://docs.aws.amazon.com/sns/latest/dg/sns-dead-letter-queues.html#how-messages-moved-into-dead-letter-queue) for more details.
        :param pulumi.Input[builtins.str] replay_policy: JSON String with the archived message replay policy that will be used in the subscription. Refer to the [SNS docs](https://docs.aws.amazon.com/sns/latest/dg/message-archiving-and-replay-subscriber.html) for more details.
    ...
    def confirmation_was_authenticated(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def confirmation_was_authenticated(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def pending_confirmation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def pending_confirmation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class TopicSubscription(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="confirmationTimeoutInMinutes")
    def confirmation_timeout_in_minutes(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Integer indicating number of minutes to wait in retrying mode for fetching subscription arn before marking it as failure. Only applicable for http and https protocols. Default is `1`.
        """
        return pulumi.get(self, "confirmation_timeout_in_minutes")
    ...
    @property
    @pulumi.getter(name="confirmationWasAuthenticated")
    def confirmation_was_authenticated(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the subscription confirmation request was authenticated.
        """
        return pulumi.get(self, "confirmation_was_authenticated")
    ...
    @property
    @pulumi.getter(name="endpointAutoConfirms")
    def endpoint_auto_confirms(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether the endpoint is capable of [auto confirming subscription](http://docs.aws.amazon.com/sns/latest/dg/SendMessageToHttp.html#SendMessageToHttp.prepare) (e.g., PagerDuty). Default is `false`.
        """
        return pulumi.get(self, "endpoint_auto_confirms")
    ...
    @property
    @pulumi.getter(name="filterPolicy")
    def filter_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        JSON String with the filter policy that will be used in the subscription to filter messages seen by the target resource. Refer to the [SNS docs](https://docs.aws.amazon.com/sns/latest/dg/message-filtering.html) for more details.
        """
        return pulumi.get(self, "filter_policy")
    ...
    @property
    @pulumi.getter(name="filterPolicyScope")
    def filter_policy_scope(self) -> pulumi.Output[builtins.str]:
        """
        Whether the `filter_policy` applies to `MessageAttributes` (default) or `MessageBody`.
        """
        return pulumi.get(self, "filter_policy_scope")
    ...
    @property
    @pulumi.getter(name="pendingConfirmation")
    def pending_confirmation(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the subscription has not been confirmed.
        """
        return pulumi.get(self, "pending_confirmation")
    ...
    @property
    @pulumi.getter(name="replayPolicy")
    def replay_policy(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        JSON String with the archived message replay policy that will be used in the subscription. Refer to the [SNS docs](https://docs.aws.amazon.com/sns/latest/dg/message-archiving-and-replay-subscriber.html) for more details.
        """
        return pulumi.get(self, "replay_policy")
