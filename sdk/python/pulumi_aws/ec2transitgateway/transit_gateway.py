...
class TransitGatewayArgs:
    def __init__(__self__, *,
                 ...
                 auto_accept_shared_attachments: Optional[pulumi.Input[builtins.str]] = None,
                 default_route_table_association: Optional[pulumi.Input[builtins.str]] = None,
                 default_route_table_propagation: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] amazon_side_asn: Private Autonomous System Number (ASN) for the Amazon side of a BGP session. The range is `64512` to `65534` for 16-bit ASNs and `4200000000` to `4294967294` for 32-bit ASNs. Default value: `64512`.
        ...
        :param pulumi.Input[builtins.str] auto_accept_shared_attachments: Whether resource attachment requests are automatically accepted. Valid values: `disable`, `enable`. Default value: `disable`.
        :param pulumi.Input[builtins.str] default_route_table_association: Whether resource attachments are automatically associated with the default association route table. Valid values: `disable`, `enable`. Default value: `enable`.
        :param pulumi.Input[builtins.str] default_route_table_propagation: Whether resource attachments automatically propagate routes to the default propagation route table. Valid values: `disable`, `enable`. Default value: `enable`.
    ...
    def auto_accept_shared_attachments(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def auto_accept_shared_attachments(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def default_route_table_association(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def default_route_table_propagation(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def multicast_support(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def multicast_support(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def transit_gateway_cidr_blocks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def transit_gateway_cidr_blocks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "transit_gateway_cidr_blocks", value)

    @property
    @pulumi.getter(name="vpnEcmpSupport")
    def vpn_ecmp_support(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vpn_ecmp_support(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TransitGatewayState:
    def __init__(__self__, *,
                 ...
                 association_default_route_table_id: Optional[pulumi.Input[builtins.str]] = None,
                 auto_accept_shared_attachments: Optional[pulumi.Input[builtins.str]] = None,
                 default_route_table_association: Optional[pulumi.Input[builtins.str]] = None,
                 default_route_table_propagation: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] amazon_side_asn: Private Autonomous System Number (ASN) for the Amazon side of a BGP session. The range is `64512` to `65534` for 16-bit ASNs and `4200000000` to `4294967294` for 32-bit ASNs. Default value: `64512`.
               ...
               > **NOTE:** Modifying `amazon_side_asn` on a Transit Gateway with active BGP sessions is [not allowed](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ModifyTransitGatewayOptions.html). You must first delete all Transit Gateway attachments that have BGP configured prior to modifying `amazon_side_asn`.
        :param pulumi.Input[builtins.str] arn: EC2 Transit Gateway Amazon Resource Name (ARN)
        :param pulumi.Input[builtins.str] association_default_route_table_id: Identifier of the default association route table
        :param pulumi.Input[builtins.str] auto_accept_shared_attachments: Whether resource attachment requests are automatically accepted. Valid values: `disable`, `enable`. Default value: `disable`.
        :param pulumi.Input[builtins.str] default_route_table_association: Whether resource attachments are automatically associated with the default association route table. Valid values: `disable`, `enable`. Default value: `enable`.
        :param pulumi.Input[builtins.str] default_route_table_propagation: Whether resource attachments automatically propagate routes to the default propagation route table. Valid values: `disable`, `enable`. Default value: `enable`.
        :param pulumi.Input[builtins.str] description: Description of the EC2 Transit Gateway.
    ...
    def association_default_route_table_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def association_default_route_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def propagation_default_route_table_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def propagation_default_route_table_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TransitGateway(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            transit_gateway_cidr_blocks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            vpn_ecmp_support: Optional[pulumi.Input[builtins.str]] = None) -> 'TransitGateway':
        """
    ...
    @property
    @pulumi.getter(name="amazonSideAsn")
    def amazon_side_asn(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Private Autonomous System Number (ASN) for the Amazon side of a BGP session. The range is `64512` to `65534` for 16-bit ASNs and `4200000000` to `4294967294` for 32-bit ASNs. Default value: `64512`.
    ...
    @property
    @pulumi.getter(name="associationDefaultRouteTableId")
    def association_default_route_table_id(self) -> pulumi.Output[builtins.str]:
        """
        Identifier of the default association route table
        """
        return pulumi.get(self, "association_default_route_table_id")
    ...
    @property
    @pulumi.getter(name="autoAcceptSharedAttachments")
    def auto_accept_shared_attachments(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether resource attachment requests are automatically accepted. Valid values: `disable`, `enable`. Default value: `disable`.
        """
        return pulumi.get(self, "auto_accept_shared_attachments")
    ...
    @property
    @pulumi.getter(name="multicastSupport")
    def multicast_support(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether Multicast support is enabled. Required to use `ec2_transit_gateway_multicast_domain`. Valid values: `disable`, `enable`. Default value: `disable`.
        """
        return pulumi.get(self, "multicast_support")
    ...
    @property
    @pulumi.getter(name="propagationDefaultRouteTableId")
    def propagation_default_route_table_id(self) -> pulumi.Output[builtins.str]:
        """
        Identifier of the default propagation route table
        """
        return pulumi.get(self, "propagation_default_route_table_id")
    ...
    @property
    @pulumi.getter(name="transitGatewayCidrBlocks")
    def transit_gateway_cidr_blocks(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        One or more IPv4 or IPv6 CIDR blocks for the transit gateway. Must be a size /24 CIDR block or larger for IPv4, or a size /64 CIDR block or larger for IPv6.
        """
        return pulumi.get(self, "transit_gateway_cidr_blocks")
    ...
    @property
    @pulumi.getter(name="vpnEcmpSupport")
    def vpn_ecmp_support(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether VPN Equal Cost Multipath Protocol support is enabled. Valid values: `disable`, `enable`. Default value: `enable`.
        """
        return pulumi.get(self, "vpn_ecmp_support")
