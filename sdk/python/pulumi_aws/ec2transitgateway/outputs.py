...
class PeeringAttachmentOptions(dict):
    ...
    def __init__(__self__, *,
                 dynamic_routing: Optional[builtins.str] = None):
        """
        :param builtins.str dynamic_routing: Indicates whether dynamic routing is enabled or disabled.. Supports `enable` and `disable`.
        """
    ...
    def dynamic_routing(self) -> Optional[builtins.str]:
        """
...
class GetMulticastDomainAssociationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str subnet_id: The ID of the subnet associated with the transit gateway multicast domain.
        :param builtins.str transit_gateway_attachment_id: The ID of the transit gateway attachment.
        """
...
class GetMulticastDomainMemberResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str group_ip_address: The IP address assigned to the transit gateway multicast group.
        :param builtins.str network_interface_id: The group members' network interface ID.
        """
...
class GetRouteTableRoutesRouteResult(dict):
    def __init__(__self__, *,
                 ...
                 state: builtins.str,
                 transit_gateway_route_table_announcement_id: builtins.str,
                 type: builtins.str):
        """
        :param builtins.str destination_cidr_block: The CIDR used for route destination matches.
        :param builtins.str prefix_list_id: The ID of the prefix list used for destination matches.
        :param builtins.str state: The current state of the route, can be `active`, `deleted`, `pending`, `blackhole`, `deleting`.
        :param builtins.str transit_gateway_route_table_announcement_id: The id of the transit gateway route table announcement, most of the time it is an empty string.
        :param builtins.str type: The type of the route, can be `propagated` or `static`.
        """
