...
class VpcAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] appliance_mode_support: Whether Appliance Mode support is enabled. If enabled, a traffic flow between a source and destination uses the same Availability Zone for the VPC attachment for the lifetime of that flow. Valid values: `disable`, `enable`. Default value: `disable`.
        ...
        :param pulumi.Input[builtins.str] ipv6_support: Whether IPv6 support is enabled. Valid values: `disable`, `enable`. Default value: `disable`.
        ...
        :param pulumi.Input[builtins.bool] transit_gateway_default_route_table_association: Boolean whether the VPC Attachment should be associated with the EC2 Transit Gateway association default route table. This cannot be configured or perform drift detection with Resource Access Manager shared EC2 Transit Gateways. Default value: `true`.
        :param pulumi.Input[builtins.bool] transit_gateway_default_route_table_propagation: Boolean whether the VPC Attachment should propagate routes with the EC2 Transit Gateway propagation default route table. This cannot be configured or perform drift detection with Resource Access Manager shared EC2 Transit Gateways. Default value: `true`.
        """
    ...
    def appliance_mode_support(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def appliance_mode_support(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "appliance_mode_support", value)

    @property
    @pulumi.getter(name="dnsSupport")
    def dns_support(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dns_support.setter
    def dns_support(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_support", value)

    @property
    @pulumi.getter(name="ipv6Support")
    def ipv6_support(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ipv6_support.setter
    def ipv6_support(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_group_referencing_support(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def transit_gateway_default_route_table_association(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def transit_gateway_default_route_table_association(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def transit_gateway_default_route_table_propagation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Boolean whether the VPC Attachment should propagate routes with the EC2 Transit Gateway propagation default route table. This cannot be configured or perform drift detection with Resource Access Manager shared EC2 Transit Gateways. Default value: `true`.
        """
    ...
    def transit_gateway_default_route_table_propagation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _VpcAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] transit_gateway_id: Identifier of EC2 Transit Gateway.
        :param pulumi.Input[builtins.str] vpc_id: Identifier of EC2 VPC.
        :param pulumi.Input[builtins.str] vpc_owner_id: Identifier of the AWS account that owns the EC2 VPC.
        """
        if appliance_mode_support is not None:
            pulumi.set(__self__, "appliance_mode_support", appliance_mode_support)
        if arn is not None:
...
class VpcAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transit_gateway_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None,
            vpc_owner_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcAttachment':
        """
    ...
    @property
    @pulumi.getter(name="applianceModeSupport")
    def appliance_mode_support(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether Appliance Mode support is enabled. If enabled, a traffic flow between a source and destination uses the same Availability Zone for the VPC attachment for the lifetime of that flow. Valid values: `disable`, `enable`. Default value: `disable`.
        """
        return pulumi.get(self, "appliance_mode_support")
    ...
    @property
    @pulumi.getter(name="dnsSupport")
    def dns_support(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether DNS support is enabled. Valid values: `disable`, `enable`. Default value: `enable`.
        """
        return pulumi.get(self, "dns_support")
    ...
    @property
    @pulumi.getter(name="ipv6Support")
    def ipv6_support(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether IPv6 support is enabled. Valid values: `disable`, `enable`. Default value: `disable`.
        """
        return pulumi.get(self, "ipv6_support")
    ...
    @property
    @pulumi.getter(name="transitGatewayDefaultRouteTableAssociation")
    def transit_gateway_default_route_table_association(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean whether the VPC Attachment should be associated with the EC2 Transit Gateway association default route table. This cannot be configured or perform drift detection with Resource Access Manager shared EC2 Transit Gateways. Default value: `true`.
        """
        return pulumi.get(self, "transit_gateway_default_route_table_association")
    ...
    @property
    @pulumi.getter(name="transitGatewayDefaultRouteTablePropagation")
    def transit_gateway_default_route_table_propagation(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean whether the VPC Attachment should propagate routes with the EC2 Transit Gateway propagation default route table. This cannot be configured or perform drift detection with Resource Access Manager shared EC2 Transit Gateways. Default value: `true`.
        """
        return pulumi.get(self, "transit_gateway_default_route_table_propagation")
