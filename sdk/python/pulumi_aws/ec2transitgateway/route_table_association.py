...
class RouteTableAssociationArgs:
    def __init__(__self__, *,
                 ...
                 replace_existing_association: pulumi.Input[Optional[_builtins.bool]] = None):
        """
    ...
    def replace_existing_association(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def replace_existing_association(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class RouteTableAssociation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        When associating a Direct Connect Gateway attachment, reference the `transit_gateway_attachment_id` attribute directly from the `directconnect.GatewayAssociation` resource (available in v6.5.0+):
        ...
        Using `pulumi import`, import `ec2transitgateway.RouteTableAssociation` using the EC2 Transit Gateway Route Table identifier, an underscore, and the EC2 Transit Gateway Attachment identifier. For example:
    ...
    def get(resource_name: str,
            ...
            resource_type: pulumi.Input[Optional[_builtins.str]] = None,
            transit_gateway_attachment_id: pulumi.Input[Optional[_builtins.str]] = None,
            transit_gateway_route_table_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'RouteTableAssociation':
        """
