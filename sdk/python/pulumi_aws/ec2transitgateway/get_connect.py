...
calass AwaitableGetConnectResult(GetConnectResult):
...
def get_connect(filters: Optional[Sequence[pulumi.InputType['GetConnectFilterArrgs']]] = None,
    ...
    example = aws.ec2transitgateway.get_connect(filters=[aws.ec2transitgateway.GetConnectFilterArrgs(
    ...
    :param Sequence[pulumi.InputType['GetConnectFilterArrgs']] filters: One or more configuration blocks containing name-values filters. Detailed below.
...
def get_connect_output(filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetConnectFilterArrgs']]]]] = None,
