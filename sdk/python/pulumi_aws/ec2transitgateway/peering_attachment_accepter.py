...
@pulumi.type_token("aws:ec2transitgateway/peeringAttachmentAccepter:PeeringAttachmentAccepter")
class PeeringAttachmentAccepter(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PeeringAttachmentAccepter resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            transit_gateway_attachment_id: Optional[pulumi.Input[_builtins.str]] = None,
            transit_gateway_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'PeeringAttachmentAccepter':
        """
