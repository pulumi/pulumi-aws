...
class VpcEndpointServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_principals: The ARNs of one or more principals allowed to discover the endpoint service.
    ...
    def supported_ip_address_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _VpcEndpointServiceState:
    def __init__(__self__, *,
                 ...
                 base_endpoint_dns_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 gateway_load_balancer_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 manages_vpc_endpoints: Optional[pulumi.Input[builtins.bool]] = None,
                 network_load_balancer_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 private_dns_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] acceptance_required: Whether or not VPC endpoint connection requests to the service must be accepted by the service owner - `true` or `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_principals: The ARNs of one or more principals allowed to discover the endpoint service.
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of the VPC endpoint service.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_zones: A set of Availability Zones in which the service is available.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] base_endpoint_dns_names: A set of DNS names for the service.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] gateway_load_balancer_arns: Amazon Resource Names (ARNs) of one or more Gateway Load Balancers for the endpoint service.
        :param pulumi.Input[builtins.bool] manages_vpc_endpoints: Whether or not the service manages its VPC endpoints - `true` or `false`.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_load_balancer_arns: Amazon Resource Names (ARNs) of one or more Network Load Balancers for the endpoint service.
        :param pulumi.Input[builtins.str] private_dns_name: The private DNS name for the service.
    ...
    def base_endpoint_dns_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def base_endpoint_dns_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def manages_vpc_endpoints(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def manages_vpc_endpoints(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class VpcEndpointService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            supported_regions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'VpcEndpointService':
        """
    ...
    @property
    @pulumi.getter(name="baseEndpointDnsNames")
    def base_endpoint_dns_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A set of DNS names for the service.
        """
        return pulumi.get(self, "base_endpoint_dns_names")
    ...
    @property
    @pulumi.getter(name="managesVpcEndpoints")
    def manages_vpc_endpoints(self) -> pulumi.Output[builtins.bool]:
        """
        Whether or not the service manages its VPC endpoints - `true` or `false`.
        """
        return pulumi.get(self, "manages_vpc_endpoints")
    ...
    @property
    @pulumi.getter(name="supportedIpAddressTypes")
    def supported_ip_address_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The supported IP address types. The possible values are `ipv4` and `ipv6`.
        """
        return pulumi.get(self, "supported_ip_address_types")
    ...
    @property
    @pulumi.getter(name="supportedRegions")
    def supported_regions(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The set of regions from which service consumers can access the service.
        """
        return pulumi.get(self, "supported_regions")
