...
def get_managed_prefix_lists(filters: Optional[Sequence[pulumi.InputType['GetManagedPrefixListsFilterArgs']]] = None,
    ...
    test_env_get_managed_prefix_list = [aws.ec2.get_managed_prefix_list(id=not_implemented("tolist(data.aws_ec2_managed_prefix_lists.test_env.ids)")[__index]) for __index in range(len(test_env.ids))]
    ```
