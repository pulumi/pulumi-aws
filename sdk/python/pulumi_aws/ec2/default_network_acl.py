...
class DefaultNetworkAclArgs:
    def __init__(__self__, *,
                 default_network_acl_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] default_network_acl_id: Network ACL ID to manage. This attribute is exported from `ec2.Vpc`, or manually found via the AWS Console.
    ...
    def default_network_acl_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def default_network_acl_id(self, value: pulumi.Input[builtins.str]):
...
class _DefaultNetworkAclState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the Default Network ACL
        :param pulumi.Input[builtins.str] default_network_acl_id: Network ACL ID to manage. This attribute is exported from `ec2.Vpc`, or manually found via the AWS Console.
        ...
        :param pulumi.Input[builtins.str] vpc_id: ID of the associated VPC
        """
        if arn is not None:
...
class DefaultNetworkAcl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 default_network_acl_id: Optional[pulumi.Input[builtins.str]] = None,
                 egress: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DefaultNetworkAclEgressArgs', 'DefaultNetworkAclEgressArgsDict']]]]] = None,
                 ingress: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DefaultNetworkAclIngressArgs', 'DefaultNetworkAclIngressArgsDict']]]]] = None,
                 subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DefaultNetworkAcl':
        """
