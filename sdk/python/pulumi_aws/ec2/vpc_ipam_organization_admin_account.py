...
class VpcIpamOrganizationAdminAccountArgs:
    def __init__(__self__, *,
                 delegated_admin_account_id: pulumi.Input[builtins.str]):
        """
    ...
    def delegated_admin_account_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "delegated_admin_account_id")

    @delegated_admin_account_id.setter
    def delegated_admin_account_id(self, value: pulumi.Input[builtins.str]):
...
class _VpcIpamOrganizationAdminAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Organizations ARN for the delegate account.
        :param pulumi.Input[builtins.str] email: The Organizations email for the delegate account.
        :param pulumi.Input[builtins.str] name: The Organizations name for the delegate account.
        :param pulumi.Input[builtins.str] service_principal: The AWS service principal.
        """
        if arn is not None:
    ...
    @property
    @pulumi.getter(name="delegatedAdminAccountId")
    def delegated_admin_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "delegated_admin_account_id")
...
class VpcIpamOrganizationAdminAccount(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            email: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            service_principal: Optional[pulumi.Input[builtins.str]] = None) -> 'VpcIpamOrganizationAdminAccount':
        """
    ...
    @property
    @pulumi.getter(name="delegatedAdminAccountId")
    def delegated_admin_account_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "delegated_admin_account_id")
