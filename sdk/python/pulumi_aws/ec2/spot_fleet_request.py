...
class SpotFleetRequestArgs:
    ...
    def _configure(
        ...
        if 'instanceInterruptionBehaviour' in kwargs:
        ...
        if 'onDemandMaxTotalPrice' in kwargs:
        ...
        if 'spotMaintenanceStrategies' in kwargs:
        ...
        if 'terminateInstancesOnDelete' in kwargs:
...
class SpotFleetRequest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if spot_maintenance_strategies is not None and not isinstance(spot_maintenance_strategies, SpotFleetRequestSpotMaintenanceStrategiesArgs):
                spot_maintenance_strategies = spot_maintenance_strategies or {}
                def _setter(key, value):
                    spot_maintenance_strategies[key] = value
                SpotFleetRequestSpotMaintenanceStrategiesArgs._configure(_setter, **spot_maintenance_strategies)
