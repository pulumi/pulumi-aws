...
class _VpcEndpointConnectionAccepterState:
    ...
    def vpc_endpoint_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vpc_endpoint_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vpc_endpoint_state", value)


@pulumi.type_token("aws:ec2/vpcEndpointConnectionAccepter:VpcEndpointConnectionAccepter")
class VpcEndpointConnectionAccepter(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vpcEndpointState")
    def vpc_endpoint_state(self) -> pulumi.Output[builtins.str]:
        """
        State of the VPC Endpoint.
        """
        return pulumi.get(self, "vpc_endpoint_state")
