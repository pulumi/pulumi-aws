...
class SpotInstanceRequest(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            capacity_reservation_specification = _utilities.configure(capacity_reservation_specification, SpotInstanceRequestCapacityReservationSpecificationArgs, True)
            __props__.__dict__["capacity_reservation_specification"] = capacity_reservation_specification
            __props__.__dict__["cpu_core_count"] = cpu_core_count
            cpu_options = _utilities.configure(cpu_options, SpotInstanceRequestCpuOptionsArgs, True)
            __props__.__dict__["cpu_options"] = cpu_options
            __props__.__dict__["cpu_threads_per_core"] = cpu_threads_per_core
            credit_specification = _utilities.configure(credit_specification, SpotInstanceRequestCreditSpecificationArgs, True)
            ...
            enclave_options = _utilities.configure(enclave_options, SpotInstanceRequestEnclaveOptionsArgs, True)
            ...
            launch_template = _utilities.configure(launch_template, SpotInstanceRequestLaunchTemplateArgs, True)
            __props__.__dict__["launch_template"] = launch_template
            maintenance_options = _utilities.configure(maintenance_options, SpotInstanceRequestMaintenanceOptionsArgs, True)
            __props__.__dict__["maintenance_options"] = maintenance_options
            metadata_options = _utilities.configure(metadata_options, SpotInstanceRequestMetadataOptionsArgs, True)
            ...
            private_dns_name_options = _utilities.configure(private_dns_name_options, SpotInstanceRequestPrivateDnsNameOptionsArgs, True)
            __props__.__dict__["private_dns_name_options"] = private_dns_name_options
            __props__.__dict__["private_ip"] = private_ip
            root_block_device = _utilities.configure(root_block_device, SpotInstanceRequestRootBlockDeviceArgs, True)
