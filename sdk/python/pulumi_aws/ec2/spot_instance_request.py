...
class SpotInstanceRequestArgs:
    def __init__(__self__, *,
                 ...
                 instance_interruption_behavior: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 launch_group: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 spot_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] instance_interruption_behavior: Indicates Spot instance behavior when it is interrupted. Valid values are `terminate`, `stop`, or `hibernate`. Default value is `terminate`.
        :param pulumi.Input[builtins.str] instance_type: Instance type to use for the instance. Required unless `launch_template` is specified and the Launch Template specifies an instance type. If an instance type is specified in the Launch Template, setting `instance_type` will override the instance type specified in the Launch Template. Updates to this field will trigger a stop/start of the EC2 instance.
        ...
        :param pulumi.Input[builtins.str] launch_group: A launch group is a group of spot instances that launch together and terminate together.
        ...
        :param pulumi.Input[builtins.str] spot_price: The maximum price to request on the spot market.
        :param pulumi.Input[builtins.str] spot_type: If set to `one-time`, after
        ...
        :param pulumi.Input[builtins.str] tenancy: Tenancy of the instance (if the instance is running in a VPC). An instance with a tenancy of `dedicated` runs on single-tenant hardware. The `host` tenancy is not supported for the import-instance command. Valid values are `default`, `dedicated`, and `host`.
    ...
    def instance_interruption_behavior(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def instance_interruption_behavior(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def launch_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @launch_group.setter
    def launch_group(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def spot_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @spot_type.setter
    def spot_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SpotInstanceRequestState:
    def __init__(__self__, *,
                 ...
                 security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 source_dest_check: Optional[pulumi.Input[builtins.bool]] = None,
                 spot_bid_status: Optional[pulumi.Input[builtins.str]] = None,
                 spot_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 spot_price: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] placement_group: Placement Group to start the instance in.
        :param pulumi.Input[builtins.int] placement_partition_number: Number of the partition the instance is in. Valid only if the `ec2.PlacementGroup` resource's `strategy` argument is set to `"partition"`.
        :param pulumi.Input[builtins.str] private_dns: The private DNS name assigned to the instance. Can only be
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] security_groups: List of security group names to associate with.
               ...
               > **NOTE:** If you are creating Instances in a VPC, use `vpc_security_group_ids` instead.
        :param pulumi.Input[builtins.bool] source_dest_check: Controls if traffic is routed to the instance when the destination address does not match the instance. Used for NAT or VPNs. Defaults true.
        :param pulumi.Input[builtins.str] spot_bid_status: The current [bid
               status](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-bid-status.html)
               of the Spot Instance Request.
        :param pulumi.Input[builtins.str] spot_instance_id: The Instance ID (if any) that is currently fulfilling
               the Spot Instance request.
        :param pulumi.Input[builtins.str] spot_price: The maximum price to request on the spot market.
        :param pulumi.Input[builtins.str] spot_request_state: The current [request
    ...
    def spot_bid_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The current [bid
        status](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-bid-status.html)
        of the Spot Instance Request.
    ...
    def spot_bid_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spot_bid_status", value)

    @property
    @pulumi.getter(name="spotInstanceId")
    def spot_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def spot_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SpotInstanceRequest(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volume_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            wait_for_fulfillment: Optional[pulumi.Input[builtins.bool]] = None) -> 'SpotInstanceRequest':
        """
    ...
    @property
    @pulumi.getter(name="instanceInterruptionBehavior")
    def instance_interruption_behavior(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Indicates Spot instance behavior when it is interrupted. Valid values are `terminate`, `stop`, or `hibernate`. Default value is `terminate`.
        """
        return pulumi.get(self, "instance_interruption_behavior")
    ...
    @property
    @pulumi.getter(name="launchGroup")
    def launch_group(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        A launch group is a group of spot instances that launch together and terminate together.
        If left empty instances are launched and terminated individually.
        """
    ...
    @property
    @pulumi.getter(name="spotBidStatus")
    def spot_bid_status(self) -> pulumi.Output[builtins.str]:
        """
        The current [bid
        status](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-bid-status.html)
        of the Spot Instance Request.
    ...
    @property
    @pulumi.getter(name="spotInstanceId")
    def spot_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The Instance ID (if any) that is currently fulfilling
        the Spot Instance request.
        """
    ...
    @property
    @pulumi.getter(name="spotPrice")
    def spot_price(self) -> pulumi.Output[builtins.str]:
        """
        The maximum price to request on the spot market.
        """
        return pulumi.get(self, "spot_price")
    ...
    @property
    @pulumi.getter(name="spotType")
    def spot_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If set to `one-time`, after
        the instance is terminated, the spot request will be closed.
        """
