...
__all__ = ['SpotInstanceRequestArrgs', 'SpotInstanceRequest']

@pulumi.input_type
calass SpotInstanceRequestArrgs:
    def __init__(__self__, *,
                 ami: Optional[pulumi.Input[str]] = None,
                 associate_public_ip_address: Optional[pulumi.Input[bool]] = None,
                 availability_zone: Optional[pulumi.Input[str]] = None,
                 block_duration_minutes: Optional[pulumi.Input[int]] = None,
                 capacity_reservation_specification: Optional[pulumi.Input['SpotInstanceRequestCapacityReservationSpecificationArrgs']] = None,
                 cpu_core_count: Optional[pulumi.Input[int]] = None,
                 cpu_options: Optional[pulumi.Input['SpotInstanceRequestCpuOptionsArrgs']] = None,
                 cpu_threads_per_core: Optional[pulumi.Input[int]] = None,
                 credit_specification: Optional[pulumi.Input['SpotInstanceRequestCreditSpecificationArrgs']] = None,
                 disable_api_stop: Optional[pulumi.Input[bool]] = None,
                 disable_api_termination: Optional[pulumi.Input[bool]] = None,
                 ebs_block_devices: Optional[pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestEbsBlockDeviceArrgs']]]] = None,
                 ebs_optimized: Optional[pulumi.Input[bool]] = None,
                 enclave_options: Optional[pulumi.Input['SpotInstanceRequestEnclaveOptionsArrgs']] = None,
                 ephemeral_block_devices: Optional[pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestEphemeralBlockDeviceArrgs']]]] = None,
                 ...
                 launch_template: Optional[pulumi.Input['SpotInstanceRequestLaunchTemplateArrgs']] = None,
                 maintenance_options: Optional[pulumi.Input['SpotInstanceRequestMaintenanceOptionsArrgs']] = None,
                 metadata_options: Optional[pulumi.Input['SpotInstanceRequestMetadataOptionsArrgs']] = None,
                 monitoring: Optional[pulumi.Input[bool]] = None,
                 network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestNetworkInterfaceArrgs']]]] = None,
                 placement_group: Optional[pulumi.Input[str]] = None,
                 placement_partition_number: Optional[pulumi.Input[int]] = None,
                 private_dns_name_options: Optional[pulumi.Input['SpotInstanceRequestPrivateDnsNameOptionsArrgs']] = None,
                 private_ip: Optional[pulumi.Input[str]] = None,
                 root_block_device: Optional[pulumi.Input['SpotInstanceRequestRootBlockDeviceArrgs']] = None,
        ...
        :param pulumi.Input['SpotInstanceRequestCapacityReservationSpecificationArrgs'] capacity_reservation_specification: Describes an instance's Capacity Reservation targeting option. See Capacity Reservation Specification below for more details.
        ...
        :param pulumi.Input['SpotInstanceRequestCpuOptionsArrgs'] cpu_options: The CPU options for the instance. See CPU Options below for more details.
        ...
        :param pulumi.Input['SpotInstanceRequestEnclaveOptionsArrgs'] enclave_options: Enable Nitro Enclaves on launched instances. See Enclave Options below for more details.
        :param pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestEphemeralBlockDeviceArrgs']]] ephemeral_block_devices: One or more configuration blocks to customize Ephemeral (also known as "Instance Store") volumes on the instance. See Block Devices below for details. When accessing this as an attribute reference, it is a set of objects.
        ...
        :param pulumi.Input['SpotInstanceRequestLaunchTemplateArrgs'] launch_template: Specifies a Launch Template to configure the instance. Parameters configured on this resource will override the corresponding parameters in the Launch Template. See Launch Template Specification below for more details.
        :param pulumi.Input['SpotInstanceRequestMaintenanceOptionsArrgs'] maintenance_options: Maintenance and recovery options for the instance. See Maintenance Options below for more details.
        :param pulumi.Input['SpotInstanceRequestMetadataOptionsArrgs'] metadata_options: Customize the metadata options of the instance. See Metadata Options below for more details.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestNetworkInterfaceArrgs']]] network_interfaces: Customize network interfaces to be attached at instance boot time. See Network Interfaces below for more details.
        ...
        :param pulumi.Input['SpotInstanceRequestPrivateDnsNameOptionsArrgs'] private_dns_name_options: Options for the instance hostname. The default values are inherited from the subnet. See Private DNS Name Options below for more details.
        :param pulumi.Input[str] private_ip: Private IP address to associate with the instance in a VPC.
        :param pulumi.Input['SpotInstanceRequestRootBlockDeviceArrgs'] root_block_device: Configuration block to customize details about the root block device of the instance. See Block Devices below for details. When accessing this as an attribute reference, it is a list containing one object.
        ...
        :param pulumi.Input[str] tenancy: Tenancy of the instance (if the instance is running in a VPC). An instance with a tenancy of `dedicated` runs on single-tenant hardware. The `host` tenancy is not supported for the import-instance command. Valid values are `default`, `dedicated`, and `host`.
    ...
    def capacity_reservation_specification(self) -> Optional[pulumi.Input['SpotInstanceRequestCapacityReservationSpecificationArrgs']]:
        """
    ...
    def capacity_reservation_specification(self, value: Optional[pulumi.Input['SpotInstanceRequestCapacityReservationSpecificationArrgs']]):
    ...
    def cpu_options(self) -> Optional[pulumi.Input['SpotInstanceRequestCpuOptionsArrgs']]:
        """
    ...
    @cpu_options.setter
    def cpu_options(self, value: Optional[pulumi.Input['SpotInstanceRequestCpuOptionsArrgs']]):
    ...
    def credit_specification(self) -> Optional[pulumi.Input['SpotInstanceRequestCreditSpecificationArrgs']]:
        """
    ...
    def credit_specification(self, value: Optional[pulumi.Input['SpotInstanceRequestCreditSpecificationArrgs']]):
    ...
    def ebs_block_devices(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestEbsBlockDeviceArrgs']]]]:
        """
    ...
    def ebs_block_devices(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestEbsBlockDeviceArrgs']]]]):
    ...
    def enclave_options(self) -> Optional[pulumi.Input['SpotInstanceRequestEnclaveOptionsArrgs']]:
        """
    ...
    def enclave_options(self, value: Optional[pulumi.Input['SpotInstanceRequestEnclaveOptionsArrgs']]):
        pulumi.set(self, "enclave_options", value)

    @property
    @pulumi.getter(name="ephemeralBlockDevices")
    def ephemeral_block_devices(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestEphemeralBlockDeviceArrgs']]]]:
        """
    ...
    def ephemeral_block_devices(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestEphemeralBlockDeviceArrgs']]]]):
    ...
    def launch_template(self) -> Optional[pulumi.Input['SpotInstanceRequestLaunchTemplateArrgs']]:
        """
    ...
    def launch_template(self, value: Optional[pulumi.Input['SpotInstanceRequestLaunchTemplateArrgs']]):
        pulumi.set(self, "launch_template", value)

    @property
    @pulumi.getter(name="maintenanceOptions")
    def maintenance_options(self) -> Optional[pulumi.Input['SpotInstanceRequestMaintenanceOptionsArrgs']]:
        """
    ...
    def maintenance_options(self, value: Optional[pulumi.Input['SpotInstanceRequestMaintenanceOptionsArrgs']]):
        pulumi.set(self, "maintenance_options", value)

    @property
    @pulumi.getter(name="metadataOptions")
    def metadata_options(self) -> Optional[pulumi.Input['SpotInstanceRequestMetadataOptionsArrgs']]:
        """
    ...
    def metadata_options(self, value: Optional[pulumi.Input['SpotInstanceRequestMetadataOptionsArrgs']]):
    ...
    def network_interfaces(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestNetworkInterfaceArrgs']]]]:
        """
    ...
    def network_interfaces(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['SpotInstanceRequestNetworkInterfaceArrgs']]]]):
    ...
    def private_dns_name_options(self) -> Optional[pulumi.Input['SpotInstanceRequestPrivateDnsNameOptionsArrgs']]:
        """
    ...
    def private_dns_name_options(self, value: Optional[pulumi.Input['SpotInstanceRequestPrivateDnsNameOptionsArrgs']]):
    ...
    def root_block_device(self) -> Optional[pulumi.Input['SpotInstanceRequestRootBlockDeviceArrgs']]:
        """
    ...
    def root_block_device(self, value: Optional[pulumi.Input['SpotInstanceRequestRootBlockDeviceArrgs']]):
...
@pulumi.input_type
calass _SpotInstanceRequestState:
    def __init__(__self__, *,
                 ami: Optional[pulumi.Input[str]] = None,
...
calass SpotInstanceRequest(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 availability_zone: Optional[pulumi.Input[str]] = None,
                 block_duration_minutes: Optional[pulumi.Input[int]] = None,
                 capacity_reservation_specification: Optional[pulumi.Input[pulumi.InputType['SpotInstanceRequestCapacityReservationSpecificationArrgs']]] = None,
                 cpu_core_count: Optional[pulumi.Input[int]] = None,
                 cpu_options: Optional[pulumi.Input[pulumi.InputType['SpotInstanceRequestCpuOptionsArrgs']]] = None,
                 cpu_threads_per_core: Optional[pulumi.Input[int]] = None,
                 credit_specification: Optional[pulumi.Input[pulumi.InputType['SpotInstanceRequestCreditSpecificationArrgs']]] = None,
                 disable_api_stop: Optional[pulumi.Input[bool]] = None,
                 disable_api_termination: Optional[pulumi.Input[bool]] = None,
                 ebs_block_devices: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SpotInstanceRequestEbsBlockDeviceArrgs']]]]] = None,
                 ebs_optimized: Optional[pulumi.Input[bool]] = None,
                 enclave_options: Optional[pulumi.Input[pulumi.InputType['SpotInstanceRequestEnclaveOptionsArrgs']]] = None,
                 ephemeral_block_devices: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SpotInstanceRequestEphemeralBlockDeviceArrgs']]]]] = None,
                 get_password_data: Optional[pulumi.Input[bool]] = None,
                 hibernation: Optional[pulumi.Input[bool]] = None,
                 host_id: Optional[pulumi.Input[str]] = None,
                 host_resource_group_arn: Optional[pulumi.Input[str]] = None,
                 ...
                 key_name: Optional[pulumi.Input[str]] = None,
                 launch_group: Optional[pulumi.Input[str]] = None,
                 launch_template: Optional[pulumi.Input[pulumi.InputType['SpotInstanceRequestLaunchTemplateArrgs']]] = None,
                 maintenance_options: Optional[pulumi.Input[pulumi.InputType['SpotInstanceRequestMaintenanceOptionsArrgs']]] = None,
                 metadata_options: Optional[pulumi.Input[pulumi.InputType['SpotInstanceRequestMetadataOptionsArrgs']]] = None,
                 monitoring: Optional[pulumi.Input[bool]] = None,
                 network_interfaces: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SpotInstanceRequestNetworkInterfaceArrgs']]]]] = None,
                 placement_group: Optional[pulumi.Input[str]] = None,
                 placement_partition_number: Optional[pulumi.Input[int]] = None,
                 private_dns_name_options: Optional[pulumi.Input[pulumi.InputType['SpotInstanceRequestPrivateDnsNameOptionsArrgs']]] = None,
                 private_ip: Optional[pulumi.Input[str]] = None,
                 root_block_device: Optional[pulumi.Input[pulumi.InputType['SpotInstanceRequestRootBlockDeviceArrgs']]] = None,
                 secondary_private_ips: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 security_groups: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 source_dest_check: Optional[pulumi.Input[bool]] = None,
                 spot_price: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[int] block_duration_minutes: The required duration for the Spot instances, in minutes. This value must be a multiple of 60 (60, 120, 180, 240, 300, or 360).
               The duration period starts as soon as your Spot instance receives its instance ID. At the end of the duration period, Amazon EC2 marks the Spot instance for termination and provides a Spot instance termination notice, which gives the instance a two-minute warning before it terminates.
               Note that you can't specify an Availability Zone group or a launch group if you specify a duration.
        :param pulumi.Input[pulumi.InputType['SpotInstanceRequestCapacityReservationSpecificationArrgs']] capacity_reservation_specification: Describes an instance's Capacity Reservation targeting option. See Capacity Reservation Specification below for more details.
               
               > **NOTE:** Changing `cpu_core_count` and/or `cpu_threads_per_core` will cause the resource to be destroyed and re-created.
        :param pulumi.Input[int] cpu_core_count: Sets the number of CPU cores for an instance. This option is only supported on creation of instance type that support CPU Options [CPU Cores and Threads Per CPU Core Per Instance Type](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-optimize-cpu.html#cpu-options-supported-instances-values) - specifying this option for unsupported instance types will return an error from the EC2 API.
        :param pulumi.Input[pulumi.InputType['SpotInstanceRequestCpuOptionsArrgs']] cpu_options: The CPU options for the instance. See CPU Options below for more details.
        :param pulumi.Input[int] cpu_threads_per_core: If set to 1, hyperthreading is disabled on the launched instance. Defaults to 2 if not set. See [Optimizing CPU Options](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-optimize-cpu.html) for more information.
        :param pulumi.Input[pulumi.InputType['SpotInstanceRequestCreditSpecificationArrgs']] credit_specification: Configuration block for customizing the credit specification of the instance. See Credit Specification below for more details. This provider will only perform drift detection of its value when present in a configuration. Removing this configuration on existing instances will only stop managing it. It will not change the configuration back to the default for the instance type.
        :param pulumi.Input[bool] disable_api_stop: If true, enables [EC2 Instance Stop Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Stop_Start.html#Using_StopProtection).
        :param pulumi.Input[bool] disable_api_termination: If true, enables [EC2 Instance Termination Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-instances.html#Using_ChangingDisableAPITermination).
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SpotInstanceRequestEbsBlockDeviceArrgs']]]] ebs_block_devices: One or more configuration blocks with additional EBS block devices to attach to the instance. Block device configurations only apply on resource creation. See Block Devices below for details on attributes and drift detection. When accessing this as an attribute reference, it is a set of objects.
        :param pulumi.Input[bool] ebs_optimized: If true, the launched EC2 instance will be EBS-optimized. Note that if this is not set on an instance type that is optimized by default then this will show as disabled but if the instance type is optimized by default then there is no need to set this and there is no effect to disabling it. See the [EBS Optimized section](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSOptimized.html) of the AWS User Guide for more information.
        :param pulumi.Input[pulumi.InputType['SpotInstanceRequestEnclaveOptionsArrgs']] enclave_options: Enable Nitro Enclaves on launched instances. See Enclave Options below for more details.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SpotInstanceRequestEphemeralBlockDeviceArrgs']]]] ephemeral_block_devices: One or more configuration blocks to customize Ephemeral (also known as "Instance Store") volumes on the instance. See Block Devices below for details. When accessing this as an attribute reference, it is a set of objects.
        :param pulumi.Input[bool] get_password_data: If true, wait for password data to become available and retrieve it. Useful for getting the administrator password for instances running Microsoft Windows. The password data is exported to the `password_data` attribute. See [GetPasswordData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetPasswordData.html) for more information.
        :param pulumi.Input[bool] hibernation: If true, the launched EC2 instance will support hibernation.
        :param pulumi.Input[str] host_id: ID of a dedicated host that the instance will be assigned to. Use when an instance is to be launched on a specific dedicated host.
        :param pulumi.Input[str] host_resource_group_arn: ARN of the host resource group in which to launch the instances. If you specify an ARN, omit the `tenancy` parameter or set it to `host`.
        ...
        :param pulumi.Input[str] launch_group: A launch group is a group of spot instances that launch together and terminate together.
               If left empty instances are launched and terminated individually.
        :param pulumi.Input[pulumi.InputType['SpotInstanceRequestLaunchTemplateArrgs']] launch_template: Specifies a Launch Template to configure the instance. Parameters configured on this resource will override the corresponding parameters in the Launch Template. See Launch Template Specification below for more details.
        :param pulumi.Input[pulumi.InputType['SpotInstanceRequestMaintenanceOptionsArrgs']] maintenance_options: Maintenance and recovery options for the instance. See Maintenance Options below for more details.
        :param pulumi.Input[pulumi.InputType['SpotInstanceRequestMetadataOptionsArrgs']] metadata_options: Customize the metadata options of the instance. See Metadata Options below for more details.
        :param pulumi.Input[bool] monitoring: If true, the launched EC2 instance will have detailed monitoring enabled. (Available since v0.6.0)
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['SpotInstanceRequestNetworkInterfaceArrgs']]]] network_interfaces: Customize network interfaces to be attached at instance boot time. See Network Interfaces below for more details.
        :param pulumi.Input[str] placement_group: Placement Group to start the instance in.
        :param pulumi.Input[int] placement_partition_number: Number of the partition the instance is in. Valid only if the `ec2.PlacementGroup` resource's `strategy` argument is set to `"partition"`.
        :param pulumi.Input[pulumi.InputType['SpotInstanceRequestPrivateDnsNameOptionsArrgs']] private_dns_name_options: Options for the instance hostname. The default values are inherited from the subnet. See Private DNS Name Options below for more details.
        :param pulumi.Input[str] private_ip: Private IP address to associate with the instance in a VPC.
        :param pulumi.Input[pulumi.InputType['SpotInstanceRequestRootBlockDeviceArrgs']] root_block_device: Configuration block to customize details about the root block device of the instance. See Block Devices below for details. When accessing this as an attribute reference, it is a list containing one object.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] secondary_private_ips: List of secondary private IPv4 addresses to assign to the instance's primary network interface (eth0) in a VPC. Can only be assigned to the primary network interface (eth0) attached at instance creation, not a pre-existing network interface i.e., referenced in a `network_interface` block. Refer to the [Elastic network interfaces documentation](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html#AvailableIpPerENI) to see the maximum number of private IP addresses allowed per instance type.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] security_groups: List of security group names to associate with.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[SpotInstanceRequestArrgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Provides an EC2 Spot Instance Request resource. This allows instances to be
        requested on the spot market.
        ...
        :param str resource_name: The name of the resource.
        :param SpotInstanceRequestArrgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SpotInstanceRequestArrgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SpotInstanceRequestArrgs.__new__(SpotInstanceRequestArrgs)
