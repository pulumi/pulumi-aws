...
class DefaultVpcArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'assignGeneratedIpv6CidrBlock' in kwargs:
        ...
        if 'enableNetworkAddressUsageMetrics' in kwargs:
        ...
        if 'ipv6CidrBlockNetworkBorderGroup' in kwargs:
...
class _DefaultVpcState:
    ...
    def _configure(
        ...
        if 'defaultNetworkAclId' in kwargs:
        ...
        if 'defaultSecurityGroupId' in kwargs:
