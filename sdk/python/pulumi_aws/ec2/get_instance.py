...
class GetInstanceResult:
    ...
    def disable_api_stop(self) -> builtins.bool:
        """
    ...
    def disable_api_termination(self) -> builtins.bool:
        """
    ...
    def get_password_data(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "get_password_data")

    @property
    @pulumi.getter(name="getUserData")
    def get_user_data(self) -> Optional[builtins.bool]:
    ...
    def placement_partition_number(self) -> builtins.int:
        """
    ...
    def secondary_private_ips(self) -> Sequence[builtins.str]:
        """
    ...
    def source_dest_check(self) -> builtins.bool:
        """
...
def get_instance(filters: Optional[Sequence[Union['GetInstanceFilterArgs', 'GetInstanceFilterArgsDict']]] = None,
                 get_password_data: Optional[builtins.bool] = None,
    ...
    :param builtins.bool get_password_data: If true, wait for password data to become available and retrieve it. Useful for getting the administrator password for instances running Microsoft Windows. The password data is exported to the `password_data` attribute. See [GetPasswordData](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_GetPasswordData.html) for more information.
    :param builtins.bool get_user_data: Retrieve Base64 encoded User Data contents into the `user_data_base64` attribute. A SHA-1 hash of the User Data contents will always be present in the `user_data` attribute. Defaults to `false`.
...
def get_instance_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetInstanceFilterArgs', 'GetInstanceFilterArgsDict']]]]] = None,
                        get_password_data: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
