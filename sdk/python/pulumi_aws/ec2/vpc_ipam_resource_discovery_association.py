...
class VpcIpamResourceDiscoveryAssociationArgs:
    ...
    def ipam_resource_discovery_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ipam_resource_discovery_id(self, value: pulumi.Input[builtins.str]):
...
class _VpcIpamResourceDiscoveryAssociationState:
    def __init__(__self__, *,
                 ...
                 ipam_region: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) of IPAM Resource Discovery Association.
        :param pulumi.Input[builtins.str] ipam_arn: The Amazon Resource Name (ARN) of the IPAM.
        :param pulumi.Input[builtins.str] ipam_id: The ID of the IPAM to associate.
        :param pulumi.Input[builtins.str] ipam_region: The home region of the IPAM.
        :param pulumi.Input[builtins.str] ipam_resource_discovery_id: The ID of the Resource Discovery to associate.
    ...
    def ipam_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ipam_region.setter
    def ipam_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipam_region", value)

    @property
    @pulumi.getter(name="ipamResourceDiscoveryId")
    def ipam_resource_discovery_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the Resource Discovery to associate.
        """
        return pulumi.get(self, "ipam_resource_discovery_id")
    ...
    @ipam_resource_discovery_id.setter
    def ipam_resource_discovery_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipam_resource_discovery_id", value)
...
class VpcIpamResourceDiscoveryAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ipamRegion")
    def ipam_region(self) -> pulumi.Output[builtins.str]:
        """
        The home region of the IPAM.
        """
        return pulumi.get(self, "ipam_region")
