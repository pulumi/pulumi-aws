...
class DefaultRouteTableArgs:
    def __init__(__self__, *,
                 ...
                 routes: pulumi.Input[Optional[Sequence[pulumi.Input['DefaultRouteTableRouteArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] propagating_vgws: List of virtual gateways for propagation.
    ...
    def propagating_vgws(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def propagating_vgws(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def routes(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DefaultRouteTableRouteArgs']]]]:
        """
    ...
    @routes.setter
    def routes(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DefaultRouteTableRouteArgs']]]]):
...
class _DefaultRouteTableState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] default_route_table_id: ID of the default route table.
               ...
               The following arguments are optional:
        :param pulumi.Input[_builtins.str] owner_id: ID of the AWS account that owns the route table.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] propagating_vgws: List of virtual gateways for propagation.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[Sequence[pulumi.Input['DefaultRouteTableRouteArgs']]] routes: Set of objects. Detailed below
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Map of tags to assign to the resource. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
...
class DefaultRouteTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 propagating_vgws: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 routes: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DefaultRouteTableRouteArgs', 'DefaultRouteTableRouteArgsDict', 'outputs.DefaultRouteTableRoute']]]]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] propagating_vgws: List of virtual gateways for propagation.
        :param pulumi.Input[_builtins.str] region: Region where this resource will be [managed](https://docs.aws.amazon.com/general/latest/gr/rande.html#regional-endpoints). Defaults to the Region set in the provider configuration.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DefaultRouteTableRouteArgs', 'DefaultRouteTableRouteArgsDict', 'outputs.DefaultRouteTableRoute']]]] routes: Set of objects. Detailed below
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Map of tags to assign to the resource. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vpc_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'DefaultRouteTable':
        """
