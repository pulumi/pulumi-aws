...
class GetSubnetResult:
    ...
    def assign_ipv6_address_on_creation(self) -> builtins.bool:
        """
    ...
    def default_for_az(self) -> builtins.bool:
        return pulumi.get(self, "default_for_az")

    @property
    @pulumi.getter(name="enableDns64")
    def enable_dns64(self) -> builtins.bool:
        """
    ...
    def enable_lni_at_device_index(self) -> builtins.int:
        """
    ...
    def enable_resource_name_dns_a_record_on_launch(self) -> builtins.bool:
        """
    ...
    def enable_resource_name_dns_aaaa_record_on_launch(self) -> builtins.bool:
        """
    ...
    def ipv6_native(self) -> builtins.bool:
        """
    ...
    def map_customer_owned_ip_on_launch(self) -> builtins.bool:
        """
    ...
    def map_public_ip_on_launch(self) -> builtins.bool:
        """
...
def get_subnet(availability_zone: Optional[builtins.str] = None,
               ...
               default_for_az: Optional[builtins.bool] = None,
    ...
    :param builtins.str availability_zone: Availability zone where the subnet must reside.
    :param builtins.str availability_zone_id: ID of the Availability Zone for the subnet. This argument is not supported in all regions or partitions. If necessary, use `availability_zone` instead.
    :param builtins.str cidr_block: CIDR block of the desired subnet.
    :param builtins.bool default_for_az: Whether the desired subnet must be the default subnet for its associated availability zone.
...
def get_subnet_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      ...
                      default_for_az: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
