...
class InstanceMetadataDefaultsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] instance_metadata_tags: Enables or disables access to instance tags from the instance metadata service. Can be `"enabled"`, `"disabled"`, or `"no-preference"`. Default: `"no-preference"`.
...
class InstanceMetadataDefaults(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            http_tokens: Optional[pulumi.Input[_builtins.str]] = None,
            instance_metadata_tags: Optional[pulumi.Input[_builtins.str]] = None,
            region: Optional[pulumi.Input[_builtins.str]] = None) -> 'InstanceMetadataDefaults':
        """
