...
class VpcIpv6CidrBlockAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ipv6_pool: The  ID of an IPv6 address pool from which to allocate the IPv6 CIDR block. Conflicts with `assign_generated_ipv6_cidr_block` and `ipv6_pam_pool_id`.
        """
...
class VpcIpv6CidrBlockAssociation(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="ipv6Pool")
    def ipv6_pool(self) -> pulumi.Output[str]:
        """
        The  ID of an IPv6 address pool from which to allocate the IPv6 CIDR block. Conflicts with `assign_generated_ipv6_cidr_block` and `ipv6_pam_pool_id`.
        """
        return pulumi.get(self, "ipv6_pool")
