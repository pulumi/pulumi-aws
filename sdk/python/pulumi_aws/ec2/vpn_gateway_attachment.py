...
class VpnGatewayAttachment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        network = aws.ec2.vpc.Vpc("network", cidr_block=10.0.0.0/16)
        vpn = aws.ec2.vpn_gateway.VpnGateway("vpn", tags={
            Name: example-vpn-gateway,
        })
        vpn_attachment = aws.ec2.vpn_gateway_attachment.VpnGatewayAttachment("vpnAttachment",
            vpc_id=network.id,
