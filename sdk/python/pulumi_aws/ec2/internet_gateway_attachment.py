...
class InternetGatewayAttachmentArgs:
    ...
    def internet_gateway_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def internet_gateway_id(self, value: pulumi.Input[builtins.str]):
...
@pulumi.type_token("aws:ec2/internetGatewayAttachment:InternetGatewayAttachment")
class InternetGatewayAttachment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="internetGatewayId")
    def internet_gateway_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the internet gateway.
        """
        return pulumi.get(self, "internet_gateway_id")
