...
def get_serial_console_access(region: Optional[builtins.str] = None,
...
def get_serial_console_access_output(region: Optional[pulumi.Input[Optional[builtins.str]]] = None,
