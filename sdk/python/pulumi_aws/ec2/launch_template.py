...
class LaunchTemplateArgs:
    ...
    def _configure(
        ...
        if 'elasticInferenceAccelerator' in kwargs:
...
class LaunchTemplate(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if capacity_reservation_specification is not None and not isinstance(capacity_reservation_specification, LaunchTemplateCapacityReservationSpecificationArgs):
                capacity_reservation_specification = capacity_reservation_specification or {}
                def _setter(key, value):
                    capacity_reservation_specification[key] = value
                LaunchTemplateCapacityReservationSpecificationArgs._configure(_setter, **capacity_reservation_specification)
            __props__.__dict__["capacity_reservation_specification"] = capacity_reservation_specification
            if cpu_options is not None and not isinstance(cpu_options, LaunchTemplateCpuOptionsArgs):
                cpu_options = cpu_options or {}
                def _setter(key, value):
                    cpu_options[key] = value
                LaunchTemplateCpuOptionsArgs._configure(_setter, **cpu_options)
            __props__.__dict__["cpu_options"] = cpu_options
            if credit_specification is not None and not isinstance(credit_specification, LaunchTemplateCreditSpecificationArgs):
                credit_specification = credit_specification or {}
                def _setter(key, value):
                    credit_specification[key] = value
                LaunchTemplateCreditSpecificationArgs._configure(_setter, **credit_specification)
            ...
            if elastic_inference_accelerator is not None and not isinstance(elastic_inference_accelerator, LaunchTemplateElasticInferenceAcceleratorArgs):
                elastic_inference_accelerator = elastic_inference_accelerator or {}
                def _setter(key, value):
                    elastic_inference_accelerator[key] = value
                LaunchTemplateElasticInferenceAcceleratorArgs._configure(_setter, **elastic_inference_accelerator)
            __props__.__dict__["elastic_inference_accelerator"] = elastic_inference_accelerator
            if enclave_options is not None and not isinstance(enclave_options, LaunchTemplateEnclaveOptionsArgs):
                enclave_options = enclave_options or {}
                def _setter(key, value):
                    enclave_options[key] = value
                LaunchTemplateEnclaveOptionsArgs._configure(_setter, **enclave_options)
            __props__.__dict__["enclave_options"] = enclave_options
            if hibernation_options is not None and not isinstance(hibernation_options, LaunchTemplateHibernationOptionsArgs):
                hibernation_options = hibernation_options or {}
                def _setter(key, value):
                    hibernation_options[key] = value
                LaunchTemplateHibernationOptionsArgs._configure(_setter, **hibernation_options)
            __props__.__dict__["hibernation_options"] = hibernation_options
            if iam_instance_profile is not None and not isinstance(iam_instance_profile, LaunchTemplateIamInstanceProfileArgs):
                iam_instance_profile = iam_instance_profile or {}
                def _setter(key, value):
                    iam_instance_profile[key] = value
                LaunchTemplateIamInstanceProfileArgs._configure(_setter, **iam_instance_profile)
            __props__.__dict__["iam_instance_profile"] = iam_instance_profile
            __props__.__dict__["image_id"] = image_id
            __props__.__dict__["instance_initiated_shutdown_behavior"] = instance_initiated_shutdown_behavior
            if instance_market_options is not None and not isinstance(instance_market_options, LaunchTemplateInstanceMarketOptionsArgs):
                instance_market_options = instance_market_options or {}
                def _setter(key, value):
                    instance_market_options[key] = value
                LaunchTemplateInstanceMarketOptionsArgs._configure(_setter, **instance_market_options)
            __props__.__dict__["instance_market_options"] = instance_market_options
            if instance_requirements is not None and not isinstance(instance_requirements, LaunchTemplateInstanceRequirementsArgs):
                instance_requirements = instance_requirements or {}
                def _setter(key, value):
                    instance_requirements[key] = value
                LaunchTemplateInstanceRequirementsArgs._configure(_setter, **instance_requirements)
            ...
            if maintenance_options is not None and not isinstance(maintenance_options, LaunchTemplateMaintenanceOptionsArgs):
                maintenance_options = maintenance_options or {}
                def _setter(key, value):
                    maintenance_options[key] = value
                LaunchTemplateMaintenanceOptionsArgs._configure(_setter, **maintenance_options)
            __props__.__dict__["maintenance_options"] = maintenance_options
            if metadata_options is not None and not isinstance(metadata_options, LaunchTemplateMetadataOptionsArgs):
                metadata_options = metadata_options or {}
                def _setter(key, value):
                    metadata_options[key] = value
                LaunchTemplateMetadataOptionsArgs._configure(_setter, **metadata_options)
            __props__.__dict__["metadata_options"] = metadata_options
            if monitoring is not None and not isinstance(monitoring, LaunchTemplateMonitoringArgs):
                monitoring = monitoring or {}
                def _setter(key, value):
                    monitoring[key] = value
                LaunchTemplateMonitoringArgs._configure(_setter, **monitoring)
            __props__.__dict__["monitoring"] = monitoring
            __props__.__dict__["name"] = name
            __props__.__dict__["name_prefix"] = name_prefix
            __props__.__dict__["network_interfaces"] = network_interfaces
            if placement is not None and not isinstance(placement, LaunchTemplatePlacementArgs):
                placement = placement or {}
                def _setter(key, value):
                    placement[key] = value
                LaunchTemplatePlacementArgs._configure(_setter, **placement)
            __props__.__dict__["placement"] = placement
            if private_dns_name_options is not None and not isinstance(private_dns_name_options, LaunchTemplatePrivateDnsNameOptionsArgs):
                private_dns_name_options = private_dns_name_options or {}
                def _setter(key, value):
                    private_dns_name_options[key] = value
                LaunchTemplatePrivateDnsNameOptionsArgs._configure(_setter, **private_dns_name_options)
