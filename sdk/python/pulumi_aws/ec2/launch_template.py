...
class LaunchTemplateArgs:
    def __init__(__self__, *,
                 ...
                 default_version: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] default_version: Default Version of the launch template.
        :param pulumi.Input[builtins.str] description: Description of the launch template.
        :param pulumi.Input[builtins.bool] disable_api_stop: If true, enables [EC2 Instance Stop Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-stop-protection.html).
        ...
        :param pulumi.Input['LaunchTemplateIamInstanceProfileArgs'] iam_instance_profile: The IAM Instance Profile to launch the instance with. See Instance Profile
               below for more details.
        :param pulumi.Input[builtins.str] image_id: The AMI from which to launch the instance or use a Systems Manager parameter convention e.g. `resolve:ssm:parameter-name`. See [docs](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/create-launch-template.html#use-an-ssm-parameter-instead-of-an-ami-id) for more details.
        :param pulumi.Input[builtins.str] instance_initiated_shutdown_behavior: Shutdown behavior for the instance. Can be `stop` or `terminate`.
               (Default: `stop`).
        ...
        :param pulumi.Input[builtins.str] instance_type: The type of the instance. If present then `instance_requirements` cannot be present.
        :param pulumi.Input[builtins.str] kernel_id: The kernel ID.
        :param pulumi.Input[builtins.str] key_name: The key name to use for the instance.
        ...
        :param pulumi.Input[builtins.str] name: The name of the launch template. If you leave this blank, the provider will auto-generate a unique name.
    ...
    def default_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def default_version(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def ebs_optimized(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ram_disk_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ram_disk_id.setter
    def ram_disk_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def security_group_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def update_default_version(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def update_default_version(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _LaunchTemplateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: Amazon Resource Name (ARN) of the launch template.
        :param pulumi.Input[Sequence[pulumi.Input['LaunchTemplateBlockDeviceMappingArgs']]] block_device_mappings: Specify volumes to attach to the instance besides the volumes specified by the AMI.
               See Block Devices below for details.
        :param pulumi.Input['LaunchTemplateCapacityReservationSpecificationArgs'] capacity_reservation_specification: Targeting for EC2 capacity reservations. See Capacity Reservation Specification below for more details.
        :param pulumi.Input['LaunchTemplateCpuOptionsArgs'] cpu_options: The CPU options for the instance. See CPU Options below for more details.
        ...
        :param pulumi.Input[builtins.str] kernel_id: The kernel ID.
        :param pulumi.Input[builtins.str] key_name: The key name to use for the instance.
        :param pulumi.Input[builtins.int] latest_version: The latest version of the launch template.
        :param pulumi.Input[Sequence[pulumi.Input['LaunchTemplateLicenseSpecificationArgs']]] license_specifications: A list of license specifications to associate with. See License Specification below for more details.
        :param pulumi.Input['LaunchTemplateMaintenanceOptionsArgs'] maintenance_options: The maintenance options for the instance. See Maintenance Options below for more details.
        :param pulumi.Input['LaunchTemplateMetadataOptionsArgs'] metadata_options: Customize the metadata options for the instance. See Metadata Options below for more details.
        :param pulumi.Input['LaunchTemplateMonitoringArgs'] monitoring: The monitoring option for the instance. See Monitoring below for more details.
...
class LaunchTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            update_default_version: Optional[pulumi.Input[builtins.bool]] = None,
            user_data: Optional[pulumi.Input[builtins.str]] = None,
            vpc_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'LaunchTemplate':
        """
    ...
    @property
    @pulumi.getter(name="defaultVersion")
    def default_version(self) -> pulumi.Output[builtins.int]:
        """
        Default Version of the launch template.
        """
        return pulumi.get(self, "default_version")
    ...
    @property
    @pulumi.getter(name="disableApiStop")
    def disable_api_stop(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If true, enables [EC2 Instance Stop Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-stop-protection.html).
        """
        return pulumi.get(self, "disable_api_stop")
    ...
    @property
    @pulumi.getter(name="disableApiTermination")
    def disable_api_termination(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If `true`, enables [EC2 Instance
        Termination Protection](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_ChangingDisableAPITermination.html)
        """
    ...
    @property
    @pulumi.getter(name="ebsOptimized")
    def ebs_optimized(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        If `true`, the launched EC2 instance will be EBS-optimized.
        """
        return pulumi.get(self, "ebs_optimized")
    ...
    @property
    @pulumi.getter(name="instanceInitiatedShutdownBehavior")
    def instance_initiated_shutdown_behavior(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Shutdown behavior for the instance. Can be `stop` or `terminate`.
        (Default: `stop`).
        """
    ...
    @property
    @pulumi.getter(name="ramDiskId")
    def ram_disk_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The ID of the RAM disk.
        """
        return pulumi.get(self, "ram_disk_id")
    ...
    @property
    @pulumi.getter(name="updateDefaultVersion")
    def update_default_version(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to update Default Version each update. Conflicts with `default_version`.
        """
        return pulumi.get(self, "update_default_version")
