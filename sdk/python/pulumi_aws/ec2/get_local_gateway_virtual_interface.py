...
@pulumi.output_type
calass GetLocalGatewayVirtualInterfaceResult:
    """
...
calass AwaitableGetLocalGatewayVirtualInterfaceResult(GetLocalGatewayVirtualInterfaceResult):
...
def get_local_gateway_virtual_interface(filters: Optional[Sequence[pulumi.InputType['GetLocalGatewayVirtualInterfaceFilterArrgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetLocalGatewayVirtualInterfaceFilterArrgs']] filters: One or more configuration blocks containing name-values filters. See the [EC2 API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeLocalGatewayVirtualInterfaces.html) for supported filters. Detailed below.
...
def get_local_gateway_virtual_interface_output(filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetLocalGatewayVirtualInterfaceFilterArrgs']]]]] = None,
