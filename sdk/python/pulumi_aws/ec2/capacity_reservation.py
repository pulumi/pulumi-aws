...
class CapacityReservationArgs:
    def __init__(__self__, *,
                 ...
                 instance_platform: pulumi.Input[Union[builtins.str, 'InstancePlatform']],
                 instance_type: pulumi.Input[Union[builtins.str, 'InstanceType']],
        ...
        :param pulumi.Input[builtins.str] end_date_type: Indicates the way in which the Capacity Reservation ends. Specify either `unlimited` or `limited`.
        :param pulumi.Input[builtins.bool] ephemeral_storage: Indicates whether the Capacity Reservation supports instances with temporary, block-level storage.
    ...
    def instance_platform(self) -> pulumi.Input[Union[builtins.str, 'InstancePlatform']]:
        """
    ...
    def instance_platform(self, value: pulumi.Input[Union[builtins.str, 'InstancePlatform']]):
        pulumi.set(self, "instance_platform", value)

    @property
    @pulumi.getter(name="instanceType")
    def instance_type(self) -> pulumi.Input[Union[builtins.str, 'InstanceType']]:
        """
    ...
    def instance_type(self, value: pulumi.Input[Union[builtins.str, 'InstanceType']]):
...
class _CapacityReservationState:
    def __init__(__self__, *,
                 ...
                 instance_match_criteria: Optional[pulumi.Input[builtins.str]] = None,
                 instance_platform: Optional[pulumi.Input[Union[builtins.str, 'InstancePlatform']]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the Capacity Reservation.
        :param pulumi.Input[builtins.str] availability_zone: The Availability Zone in which to create the Capacity Reservation.
        :param pulumi.Input[builtins.bool] ebs_optimized: Indicates whether the Capacity Reservation supports EBS-optimized instances.
        :param pulumi.Input[builtins.str] end_date: The date and time at which the Capacity Reservation expires. When a Capacity Reservation expires, the reserved capacity is released and you can no longer launch instances into it. Valid values: [RFC3339 time string](https://tools.ietf.org/html/rfc3339#section-5.8) (`YYYY-MM-DDTHH:MM:SSZ`)
        :param pulumi.Input[builtins.str] end_date_type: Indicates the way in which the Capacity Reservation ends. Specify either `unlimited` or `limited`.
    ...
    @property
    @pulumi.getter(name="instancePlatform")
    def instance_platform(self) -> Optional[pulumi.Input[Union[builtins.str, 'InstancePlatform']]]:
        """
        The type of operating system for which to reserve capacity. Valid options are `Linux/UNIX`, `Red Hat Enterprise Linux`, `SUSE Linux`, `Windows`, `Windows with SQL Server`, `Windows with SQL Server Enterprise`, `Windows with SQL Server Standard` or `Windows with SQL Server Web`.
        """
        return pulumi.get(self, "instance_platform")
    ...
    @instance_platform.setter
    def instance_platform(self, value: Optional[pulumi.Input[Union[builtins.str, 'InstancePlatform']]]):
        pulumi.set(self, "instance_platform", value)
...
class CapacityReservation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tenancy: Optional[pulumi.Input[Union[builtins.str, 'Tenancy']]] = None) -> 'CapacityReservation':
        """
