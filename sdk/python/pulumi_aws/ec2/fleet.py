...
class Fleet(pulumi.CustomResource):
    ...
    Nested argument containing EC2 Launch Template configurations. Defined below.
      ...
      * `launch_template_specification` (`dict`) - Nested argument containing EC2 Launch Template to use. Defined below.
    
        * `launch_template_id` (`str`) - ID of the launch template.
      ...
      * `overrides` (`list`) - Nested argument(s) containing parameters to override the same parameters in the Launch Template. Defined below.
        ...
        * `max_price` (`str`) - Maximum price per unit hour that you are willing to pay for a Spot Instance.
        ...
        * `weighted_capacity` (`float`) - Number of units provided by the specified instance type.
    """
    ...
    Nested argument containing Spot configurations. Defined below.
      ...
      * `allocation_strategy` (`str`) - How to allocate the target capacity across the Spot pools. Valid values: `diversified`, `lowestPrice`. Default: `lowestPrice`.
      * `instance_interruption_behavior` (`str`) - Behavior when a Spot Instance is interrupted. Valid values: `hibernate`, `stop`, `terminate`. Default: `terminate`.
    ...
    Nested argument containing target capacity configurations. Defined below.
      ...
      * `default_target_capacity_type` (`str`) - Default target capacity type. Valid values: `on-demand`, `spot`.
      * `on_demand_target_capacity` (`float`) - The number of On-Demand units to request.
      * `spot_target_capacity` (`float`) - The number of Spot units to request.
      * `total_target_capacity` (`float`) - The number of units to request, filled using `default_target_capacity_type`.
    """
    ...
    def __init__(__self__, resource_name, opts=None, excess_capacity_termination_policy=None, launch_template_config=None, on_demand_options=None, replace_unhealthy_instances=None, spot_options=None, tags=None, target_capacity_specification=None, terminate_instances=None, terminate_instances_with_expiration=None, type=None, __props__=None, __name__=None, __opts__=None):
        ...
        The **launch_template_config** object supports the following:
          ...
          * `launch_template_specification` (`pulumi.Input[dict]`) - Nested argument containing EC2 Launch Template to use. Defined below.
        
            * `launch_template_id` (`pulumi.Input[str]`) - ID of the launch template.
          ...
          * `overrides` (`pulumi.Input[list]`) - Nested argument(s) containing parameters to override the same parameters in the Launch Template. Defined below.
            ...
            * `max_price` (`pulumi.Input[str]`) - Maximum price per unit hour that you are willing to pay for a Spot Instance.
            ...
            * `weighted_capacity` (`pulumi.Input[float]`) - Number of units provided by the specified instance type.
        ...
        The **spot_options** object supports the following:
          ...
          * `allocation_strategy` (`pulumi.Input[str]`) - How to allocate the target capacity across the Spot pools. Valid values: `diversified`, `lowestPrice`. Default: `lowestPrice`.
          * `instance_interruption_behavior` (`pulumi.Input[str]`) - Behavior when a Spot Instance is interrupted. Valid values: `hibernate`, `stop`, `terminate`. Default: `terminate`.
        ...
        The **target_capacity_specification** object supports the following:
          ...
          * `default_target_capacity_type` (`pulumi.Input[str]`) - Default target capacity type. Valid values: `on-demand`, `spot`.
          * `on_demand_target_capacity` (`pulumi.Input[float]`) - The number of On-Demand units to request.
          * `spot_target_capacity` (`pulumi.Input[float]`) - The number of Spot units to request.
          * `total_target_capacity` (`pulumi.Input[float]`) - The number of units to request, filled using `default_target_capacity_type`.
