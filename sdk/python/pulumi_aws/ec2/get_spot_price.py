...
def get_spot_price(availability_zone: Optional[builtins.str] = None,
...
def get_spot_price_output(availability_zone: Optional[pulumi.Input[Optional[builtins.str]]] = None,
