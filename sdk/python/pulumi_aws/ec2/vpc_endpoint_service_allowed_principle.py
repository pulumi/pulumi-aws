...
class VpcEndpointServiceAllowedPrincipleArgs:
    ...
    def vpc_endpoint_service_id(self) -> pulumi.Input[builtins.str]:
        """
...
@pulumi.type_token("aws:ec2/vpcEndpointServiceAllowedPrinciple:VpcEndpointServiceAllowedPrinciple")
class VpcEndpointServiceAllowedPrinciple(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="vpcEndpointServiceId")
    def vpc_endpoint_service_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the VPC endpoint service to allow permission.
        """
        return pulumi.get(self, "vpc_endpoint_service_id")
