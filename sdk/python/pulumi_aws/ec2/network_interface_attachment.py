...
class NetworkInterfaceAttachmentInitArgs:
    ...
    def device_index(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @device_index.setter
    def device_index(self, value: pulumi.Input[builtins.int]):
...
class _NetworkInterfaceAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] attachment_id: The ENI Attachment ID.
        :param pulumi.Input[builtins.int] device_index: Network interface index (int).
        :param pulumi.Input[builtins.str] instance_id: Instance ID to attach.
        :param pulumi.Input[builtins.str] network_interface_id: ENI ID to attach.
...
class NetworkInterfaceAttachment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deviceIndex")
    def device_index(self) -> pulumi.Output[builtins.int]:
        """
        Network interface index (int).
        """
        return pulumi.get(self, "device_index")
