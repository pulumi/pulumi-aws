...
class _VpcIpamState:
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions] = None,
             **kwargs):
        if default_resource_discovery_association_id is None and 'defaultResourceDiscoveryAssociationId' in kwargs:
            default_resource_discovery_association_id = kwargs['defaultResourceDiscoveryAssociationId']
        if default_resource_discovery_id is None and 'defaultResourceDiscoveryId' in kwargs:
            default_resource_discovery_id = kwargs['defaultResourceDiscoveryId']
        if operating_regions is None and 'operatingRegions' in kwargs:
            operating_regions = kwargs['operatingRegions']
        if private_default_scope_id is None and 'privateDefaultScopeId' in kwargs:
            private_default_scope_id = kwargs['privateDefaultScopeId']
        if public_default_scope_id is None and 'publicDefaultScopeId' in kwargs:
            public_default_scope_id = kwargs['publicDefaultScopeId']
        if scope_count is None and 'scopeCount' in kwargs:
