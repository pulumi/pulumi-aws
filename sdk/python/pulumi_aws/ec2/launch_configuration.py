...
class LaunchConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] associate_public_ip_address: Associate a public ip address with an instance in a VPC.
        ...
        :param pulumi.Input[builtins.str] user_data: The user data to provide when launching the instance. Do not pass gzip-compressed data via this argument; see `user_data_base64` instead.
...
class _LaunchConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name of the launch configuration.
        :param pulumi.Input[builtins.bool] associate_public_ip_address: Associate a public ip address with an instance in a VPC.
        :param pulumi.Input[Sequence[pulumi.Input['LaunchConfigurationEbsBlockDeviceArgs']]] ebs_block_devices: Additional EBS block devices to attach to the instance. See Block Devices below for details.
        :param pulumi.Input[builtins.bool] ebs_optimized: If true, the launched EC2 instance will be EBS-optimized.
        :param pulumi.Input[builtins.bool] enable_monitoring: Enables/disables detailed monitoring. This is enabled by default.
...
class LaunchConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 associate_public_ip_address: Optional[pulumi.Input[builtins.bool]] = None,
                 ebs_block_devices: Optional[pulumi.Input[Sequence[pulumi.Input[Union['LaunchConfigurationEbsBlockDeviceArgs', 'LaunchConfigurationEbsBlockDeviceArgsDict']]]]] = None,
                 ebs_optimized: Optional[pulumi.Input[builtins.bool]] = None,
                 enable_monitoring: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def get(resource_name: str,
            ...
            spot_price: Optional[pulumi.Input[builtins.str]] = None,
            user_data: Optional[pulumi.Input[builtins.str]] = None,
            user_data_base64: Optional[pulumi.Input[builtins.str]] = None) -> 'LaunchConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="userDataBase64")
    def user_data_base64(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Can be used instead of `user_data` to pass base64-encoded binary data directly. Use this instead of `user_data` whenever the value is not a valid UTF-8 string. For example, gzip-encoded user data must be base64-encoded and passed via this argument to avoid corruption.
        """
        return pulumi.get(self, "user_data_base64")
