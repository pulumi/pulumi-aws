...
@pulumi.output_type
calass GetInstanceTypeOfferingResult:
    """
...
calass AwaitableGetInstanceTypeOfferingResult(GetInstanceTypeOfferingResult):
...
def get_instance_type_offering(filters: Optional[Sequence[pulumi.InputType['GetInstanceTypeOfferingFilterArrgs']]] = None,
    ...
    example = aws.ec2.get_instance_type_offering(filters=[aws.ec2.GetInstanceTypeOfferingFilterArrgs(
            name="instance-type",
            values=[
                "t2.micro",
                "t3.micro",
    ...
    :param Sequence[pulumi.InputType['GetInstanceTypeOfferingFilterArrgs']] filters: One or more configuration blocks containing name-values filters. See the [EC2 API Reference](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DescribeInstanceTypeOfferings.html) for supported filters. Detailed below.
...
def get_instance_type_offering_output(filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetInstanceTypeOfferingFilterArrgs']]]]] = None,
