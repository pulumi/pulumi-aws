...
class TrafficMirrorTargetArgs:
    def __init__(__self__, *,
                 ...
                 gateway_load_balancer_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
                 network_interface_id: Optional[pulumi.Input[builtins.str]] = None,
                 network_load_balancer_arn: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def gateway_load_balancer_endpoint_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def gateway_load_balancer_endpoint_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def network_load_balancer_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def network_load_balancer_arn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TrafficMirrorTargetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: The ARN of the traffic mirror target.
        :param pulumi.Input[builtins.str] description: A description of the traffic mirror session.
        :param pulumi.Input[builtins.str] gateway_load_balancer_endpoint_id: The VPC Endpoint Id of the Gateway Load Balancer that is associated with the target.
        :param pulumi.Input[builtins.str] network_interface_id: The network interface ID that is associated with the target.
        :param pulumi.Input[builtins.str] network_load_balancer_arn: The Amazon Resource Name (ARN) of the Network Load Balancer that is associated with the target.
...
class TrafficMirrorTarget(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner_id: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'TrafficMirrorTarget':
        """
    ...
    @property
    @pulumi.getter(name="gatewayLoadBalancerEndpointId")
    def gateway_load_balancer_endpoint_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The VPC Endpoint Id of the Gateway Load Balancer that is associated with the target.
        """
        return pulumi.get(self, "gateway_load_balancer_endpoint_id")
    ...
    @property
    @pulumi.getter(name="networkLoadBalancerArn")
    def network_load_balancer_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The Amazon Resource Name (ARN) of the Network Load Balancer that is associated with the target.
        """
        return pulumi.get(self, "network_load_balancer_arn")
