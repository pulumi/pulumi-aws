...
class VpcPeeringConnectionAccepterInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] auto_accept: Whether or not to accept the peering request. Defaults to `false`.
    ...
    def auto_accept(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @auto_accept.setter
    def auto_accept(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _VpcPeeringConnectionAccepterState:
    def __init__(__self__, *,
                 accept_status: Optional[pulumi.Input[builtins.str]] = None,
                 accepter: Optional[pulumi.Input['VpcPeeringConnectionAccepterAccepterArgs']] = None,
                 auto_accept: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] accept_status: The status of the VPC Peering Connection request.
        :param pulumi.Input['VpcPeeringConnectionAccepterAccepterArgs'] accepter: A configuration block that describes [VPC Peering Connection]
               (https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the accepter VPC.
        :param pulumi.Input[builtins.bool] auto_accept: Whether or not to accept the peering request. Defaults to `false`.
        :param pulumi.Input[builtins.str] peer_owner_id: The AWS account ID of the owner of the requester VPC.
        :param pulumi.Input[builtins.str] peer_region: The region of the accepter VPC.
        :param pulumi.Input[builtins.str] peer_vpc_id: The ID of the requester VPC.
        :param pulumi.Input['VpcPeeringConnectionAccepterRequesterArgs'] requester: A configuration block that describes [VPC Peering Connection]
               (https://docs.aws.amazon.com/vpc/latest/peering/what-is-vpc-peering.html) options set for the requester VPC.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the resource. .If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags_all: A map of tags assigned to the resource, including those inherited from the provider `default_tags` configuration block.
        :param pulumi.Input[builtins.str] vpc_id: The ID of the accepter VPC.
        :param pulumi.Input[builtins.str] vpc_peering_connection_id: The VPC Peering Connection ID to manage.
        """
    ...
    def accept_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def accept_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def peer_owner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_owner_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VpcPeeringConnectionAccepter(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="acceptStatus")
    def accept_status(self) -> pulumi.Output[builtins.str]:
        """
        The status of the VPC Peering Connection request.
        """
        return pulumi.get(self, "accept_status")
    ...
    @property
    @pulumi.getter(name="autoAccept")
    def auto_accept(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether or not to accept the peering request. Defaults to `false`.
        """
        return pulumi.get(self, "auto_accept")
    ...
    @property
    @pulumi.getter(name="peerOwnerId")
    def peer_owner_id(self) -> pulumi.Output[builtins.str]:
        """
        The AWS account ID of the owner of the requester VPC.
        """
        return pulumi.get(self, "peer_owner_id")
