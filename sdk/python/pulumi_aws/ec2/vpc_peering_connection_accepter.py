...
class VpcPeeringConnectionAccepterInitArgs:
    def __init__(__self__, *,
        ...
        """
        VpcPeeringConnectionAccepterInitArgs._configure(
...
class _VpcPeeringConnectionAccepterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] vpc_peering_connection_id: The VPC Peering Connection ID to manage.
        """
        _VpcPeeringConnectionAccepterState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
...
class VpcPeeringConnectionAccepter(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            VpcPeeringConnectionAccepterInitArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if accepter is not None and not isinstance(accepter, VpcPeeringConnectionAccepterAccepterArgs):
                accepter = accepter or {}
                def _setter(key, value):
                    accepter[key] = value
                VpcPeeringConnectionAccepterAccepterArgs._configure(_setter, **accepter)
            __props__.__dict__["accepter"] = accepter
            __props__.__dict__["auto_accept"] = auto_accept
            if requester is not None and not isinstance(requester, VpcPeeringConnectionAccepterRequesterArgs):
                requester = requester or {}
                def _setter(key, value):
                    requester[key] = value
                VpcPeeringConnectionAccepterRequesterArgs._configure(_setter, **requester)
