...
class NetworkAclRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        bar_network_acl = aws.ec2.network_acl.NetworkAcl("barNetworkAcl", vpc_id=aws_vpc.foo.id)
        bar_network_acl_rule = aws.ec2.network_acl_rule.NetworkAclRule("barNetworkAclRule",
