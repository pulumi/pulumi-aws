...
@pulumi.output_type
calass GetInternetGatewayResult:
    """
...
calass AwaitableGetInternetGatewayResult(GetInternetGatewayResult):
...
def get_internet_gateway(filters: Optional[Sequence[pulumi.InputType['GetInternetGatewayFilterArrgs']]] = None,
    ...
    default = aws.ec2.get_internet_gateway(filters=[aws.ec2.GetInternetGatewayFilterArrgs(
    ...
    :param Sequence[pulumi.InputType['GetInternetGatewayFilterArrgs']] filters: Custom filter block as described below.
...
def get_internet_gateway_output(filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetInternetGatewayFilterArrgs']]]]] = None,
