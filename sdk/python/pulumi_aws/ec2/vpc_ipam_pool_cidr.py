...
class VpcIpamPoolCidrArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cidr: The CIDR you want to assign to the pool. Conflicts with `netmask_length`.
        ...
        :param pulumi.Input[builtins.int] netmask_length: If provided, the cidr provisioned into the specified pool will be the next available cidr given this declared netmask length. Conflicts with `cidr`.
        """
...
class _VpcIpamPoolCidrState:
    def __init__(__self__, *,
                 cidr: Optional[pulumi.Input[builtins.str]] = None,
                 cidr_authorization_context: Optional[pulumi.Input['VpcIpamPoolCidrCidrAuthorizationContextArgs']] = None,
                 ipam_pool_cidr_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cidr: The CIDR you want to assign to the pool. Conflicts with `netmask_length`.
        :param pulumi.Input['VpcIpamPoolCidrCidrAuthorizationContextArgs'] cidr_authorization_context: A signed document that proves that you are authorized to bring the specified IP address range to Amazon using BYOIP. This is not stored in the state file. See cidr_authorization_context for more information.
        :param pulumi.Input[builtins.str] ipam_pool_cidr_id: The unique ID generated by AWS for the pool cidr. Typically this is the resource `id` but this attribute was added to the API calls after the fact and is therefore not used as the resource id.
        :param pulumi.Input[builtins.str] ipam_pool_id: The ID of the pool to which you want to assign a CIDR.
        :param pulumi.Input[builtins.int] netmask_length: If provided, the cidr provisioned into the specified pool will be the next available cidr given this declared netmask length. Conflicts with `cidr`.
        """
        if cidr is not None:
    ...
    def ipam_pool_cidr_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ipam_pool_cidr_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VpcIpamPoolCidr(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ipam_pool_cidr_id: Optional[pulumi.Input[builtins.str]] = None,
            ipam_pool_id: Optional[pulumi.Input[builtins.str]] = None,
            netmask_length: Optional[pulumi.Input[builtins.int]] = None) -> 'VpcIpamPoolCidr':
        """
    ...
    @property
    @pulumi.getter(name="ipamPoolCidrId")
    def ipam_pool_cidr_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique ID generated by AWS for the pool cidr. Typically this is the resource `id` but this attribute was added to the API calls after the fact and is therefore not used as the resource id.
        """
        return pulumi.get(self, "ipam_pool_cidr_id")
    ...
    @property
    @pulumi.getter(name="netmaskLength")
    def netmask_length(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        If provided, the cidr provisioned into the specified pool will be the next available cidr given this declared netmask length. Conflicts with `cidr`.
        """
        return pulumi.get(self, "netmask_length")
