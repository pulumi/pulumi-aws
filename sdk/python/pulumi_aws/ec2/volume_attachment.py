...
class VolumeAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] device_name: The device name to expose to the instance (for
        ...
        :param pulumi.Input[builtins.str] volume_id: ID of the Volume to be attached
        :param pulumi.Input[builtins.bool] force_detach: Set to `true` if you want to force the
        ...
        :param pulumi.Input[builtins.bool] skip_destroy: Set this to true if you do not wish
               ...
               means attached.
        :param pulumi.Input[builtins.bool] stop_instance_before_detaching: Set this to true to ensure that the target instance is stopped
    ...
    def force_detach(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @force_detach.setter
    def force_detach(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def stop_instance_before_detaching(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def stop_instance_before_detaching(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class VolumeAttachment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="forceDetach")
    def force_detach(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set to `true` if you want to force the
        volume to detach. Useful if previous attempts failed, but use this option only
        as a last resort, as this can result in **data loss**. See
    ...
    @property
    @pulumi.getter(name="stopInstanceBeforeDetaching")
    def stop_instance_before_detaching(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Set this to true to ensure that the target instance is stopped
        before trying to detach the volume. Stops the instance, if it is not already stopped.
        """
