...
class SubnetArgs:
    ...
    def _configure(
        ...
        if 'mapCustomerOwnedIpOnLaunch' in kwargs:
        ...
        if 'privateDnsHostnameTypeOnLaunch' in kwargs:
...
class _SubnetState:
    ...
    def _configure(
        ...
        if 'ipv6CidrBlock' in kwargs:
            ipv6_cidr_block = kwargs['ipv6CidrBlock']
        if 'ipv6CidrBlockAssociationId' in kwargs:
