...
class TrafficMirrorFilterRule(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            destination_port_range = _utilities.configure(destination_port_range, TrafficMirrorFilterRuleDestinationPortRangeArgs, True)
            ...
            source_port_range = _utilities.configure(source_port_range, TrafficMirrorFilterRuleSourcePortRangeArgs, True)
