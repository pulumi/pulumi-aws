...
class AmiCopyArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if 'sourceAmiId' in kwargs:
            source_ami_id = kwargs['sourceAmiId']
        if 'sourceAmiRegion' in kwargs:
            source_ami_region = kwargs['sourceAmiRegion']
        if 'deprecationTime' in kwargs:
            deprecation_time = kwargs['deprecationTime']
        if 'destinationOutpostArn' in kwargs:
...
class _AmiCopyState:
    ...
    def _configure(
        ...
        if 'ebsBlockDevices' in kwargs:
            ebs_block_devices = kwargs['ebsBlockDevices']
        if 'enaSupport' in kwargs:
            ena_support = kwargs['enaSupport']
        if 'ephemeralBlockDevices' in kwargs:
            ephemeral_block_devices = kwargs['ephemeralBlockDevices']
        if 'imageLocation' in kwargs:
