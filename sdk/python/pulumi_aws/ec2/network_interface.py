...
class NetworkInterfaceArgs:
    ...
    def _configure(
        ...
        if ipv6_address_list_enabled is None and 'ipv6AddressListEnabled' in kwargs:
            ipv6_address_list_enabled = kwargs['ipv6AddressListEnabled']
        if ipv6_address_lists is None and 'ipv6AddressLists' in kwargs:
        ...
        if private_ip_list_enabled is None and 'privateIpListEnabled' in kwargs:
            private_ip_list_enabled = kwargs['privateIpListEnabled']
        if private_ip_lists is None and 'privateIpLists' in kwargs:
