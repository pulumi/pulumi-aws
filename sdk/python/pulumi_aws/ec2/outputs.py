...
class InstanceInstanceMarketOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param str market_type: Type of market for the instance. Valid values are `spot` and `capacity-block`. Defaults to `spot`. Required if `spot_options` is specified.
...
class InstanceMetadataOptions(dict):
    ...
    def __init__(__self__, *,
        ...
        :param str http_tokens: Whether or not the metadata service requires session tokens, also referred to as _Instance Metadata Service Version 2 (IMDSv2)_. Valid values include `optional` or `required`.
...
class InstanceRootBlockDevice(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param bool delete_on_termination: Whether the volume should be destroyed on instance termination. Defaults to `true`.
        :param str device_name: Device name, e.g., `/dev/sdh` or `xvdh`.
...
class LaunchTemplateIamInstanceProfile(dict):
    def __init__(__self__, *,
                 ...
                 name: Optional[str] = None):
        """
        :param str arn: The Amazon Resource Name (ARN) of the instance profile. Conflicts with `name`.
