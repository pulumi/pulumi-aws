...
class GetAmiResult:
    ...
    def ena_support(self) -> builtins.bool:
        """
    ...
    def state_reason(self) -> Mapping[str, builtins.str]:
        """
    ...
    def uefi_data(self) -> Optional[builtins.str]:
        """
...
def get_ami(executable_users: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.bool include_deprecated: If true, all deprecated AMIs are included in the response. If false, no deprecated AMIs are included in the response. If no value is specified, the default value is false.
