...
calass AwaitableGetSecurityGroupResult(GetSecurityGroupResult):
...
def get_security_group(filters: Optional[Sequence[pulumi.InputType['GetSecurityGroupFilterArrgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetSecurityGroupFilterArrgs']] filters: Custom filter block as described below.
...
def get_security_group_output(filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetSecurityGroupFilterArrgs']]]]] = None,
