...
__all__ = [
    ...
    'EncryptionControlResourceExclusionsArgs',
    'EncryptionControlResourceExclusionsArgsDict',
    'EncryptionControlResourceExclusionsEgressOnlyInternetGatewayArgs',
    'EncryptionControlResourceExclusionsEgressOnlyInternetGatewayArgsDict',
    'EncryptionControlResourceExclusionsElasticFileSystemArgs',
    'EncryptionControlResourceExclusionsElasticFileSystemArgsDict',
    'EncryptionControlResourceExclusionsInternetGatewayArgs',
    'EncryptionControlResourceExclusionsInternetGatewayArgsDict',
    'EncryptionControlResourceExclusionsLambdaArgs',
    'EncryptionControlResourceExclusionsLambdaArgsDict',
    'EncryptionControlResourceExclusionsNatGatewayArgs',
    'EncryptionControlResourceExclusionsNatGatewayArgsDict',
    'EncryptionControlResourceExclusionsVirtualPrivateGatewayArgs',
    'EncryptionControlResourceExclusionsVirtualPrivateGatewayArgsDict',
    'EncryptionControlResourceExclusionsVpcLatticeArgs',
    'EncryptionControlResourceExclusionsVpcLatticeArgsDict',
    'EncryptionControlResourceExclusionsVpcPeeringArgs',
    'EncryptionControlResourceExclusionsVpcPeeringArgsDict',
    'EncryptionControlTimeoutsArgs',
    'EncryptionControlTimeoutsArgsDict',
    ...
    'NatGatewayRegionalNatGatewayAddressArgs',
...
class AmiEphemeralBlockDeviceArgs:
    ...
    @virtual_name.setter
    def virtual_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "virtual_name", value)
...
class DefaultNetworkAclEgressArgs:
    ...
    @rule_no.setter
    def rule_no(self, value: pulumi.Input[_builtins.int]):
...
if not MYPY:
    ...
    EncryptionControlResourceExclusionsArgsDict: TypeAlias = Mapping[str, Any]

@pulumi.input_type
class EncryptionControlResourceExclusionsArgs:
    def __init__(__self__, *,
                 egress_only_internet_gateway: pulumi.Input['EncryptionControlResourceExclusionsEgressOnlyInternetGatewayArgs'],
                 elastic_file_system: pulumi.Input['EncryptionControlResourceExclusionsElasticFileSystemArgs'],
                 internet_gateway: pulumi.Input['EncryptionControlResourceExclusionsInternetGatewayArgs'],
                 lambda_: pulumi.Input['EncryptionControlResourceExclusionsLambdaArgs'],
                 nat_gateway: pulumi.Input['EncryptionControlResourceExclusionsNatGatewayArgs'],
                 virtual_private_gateway: pulumi.Input['EncryptionControlResourceExclusionsVirtualPrivateGatewayArgs'],
    ...
    def egress_only_internet_gateway(self, value: pulumi.Input['EncryptionControlResourceExclusionsEgressOnlyInternetGatewayArgs']):
    ...
    def elastic_file_system(self, value: pulumi.Input['EncryptionControlResourceExclusionsElasticFileSystemArgs']):
    ...
    def internet_gateway(self, value: pulumi.Input['EncryptionControlResourceExclusionsInternetGatewayArgs']):
    ...
    @lambda_.setter
    def lambda_(self, value: pulumi.Input['EncryptionControlResourceExclusionsLambdaArgs']):
    ...
    @nat_gateway.setter
    def nat_gateway(self, value: pulumi.Input['EncryptionControlResourceExclusionsNatGatewayArgs']):
    ...
    def virtual_private_gateway(self, value: pulumi.Input['EncryptionControlResourceExclusionsVirtualPrivateGatewayArgs']):
    ...
    @vpc_lattice.setter
    def vpc_lattice(self, value: pulumi.Input['EncryptionControlResourceExclusionsVpcLatticeArgs']):
    ...
    @vpc_peering.setter
    def vpc_peering(self, value: pulumi.Input['EncryptionControlResourceExclusionsVpcPeeringArgs']):
...
if not MYPY:
    ...
    EncryptionControlResourceExclusionsEgressOnlyInternetGatewayArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    EncryptionControlResourceExclusionsElasticFileSystemArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    EncryptionControlResourceExclusionsInternetGatewayArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    EncryptionControlResourceExclusionsLambdaArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    EncryptionControlResourceExclusionsNatGatewayArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    EncryptionControlResourceExclusionsVirtualPrivateGatewayArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    EncryptionControlResourceExclusionsVpcLatticeArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    EncryptionControlResourceExclusionsVpcPeeringArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    EncryptionControlTimeoutsArgsDict: TypeAlias = Mapping[str, Any]
...
class FleetFleetInstanceSetArgs:
    def __init__(__self__, *,
                 ...
                 lifecycle: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @lifecycle.setter
    def lifecycle(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class FleetOnDemandOptionsCapacityReservationOptionsArgs:
    def __init__(__self__, *,
                 usage_strategy: Optional[pulumi.Input[_builtins.str]] = None):
    ...
    def usage_strategy(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class FleetSpotOptionsMaintenanceStrategiesCapacityRebalanceArgs:
    def __init__(__self__, *,
                 replacement_strategy: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def replacement_strategy(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class FleetTargetCapacitySpecificationArgs:
    ...
    def default_target_capacity_type(self, value: pulumi.Input[_builtins.str]):
...
class FlowLogDestinationOptionsArgs:
    def __init__(__self__, *,
                 ...
                 hive_compatible_partitions: Optional[pulumi.Input[_builtins.bool]] = None,
                 per_hour_partition: Optional[pulumi.Input[_builtins.bool]] = None):
    ...
    def hive_compatible_partitions(self, value: Optional[pulumi.Input[_builtins.bool]]):
    ...
    def per_hour_partition(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class InstanceCpuOptionsArgs:
    def __init__(__self__, *,
                 amd_sev_snp: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @amd_sev_snp.setter
    def amd_sev_snp(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class LaunchTemplateHibernationOptionsArgs:
    ...
    @configured.setter
    def configured(self, value: pulumi.Input[_builtins.bool]):
...
class LaunchTemplateNetworkInterfaceArgs:
    def __init__(__self__, *,
                 associate_carrier_ip_address: Optional[pulumi.Input[_builtins.str]] = None,
                 associate_public_ip_address: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 network_card_index: Optional[pulumi.Input[_builtins.int]] = None,
                 network_interface_id: Optional[pulumi.Input[_builtins.str]] = None,
                 primary_ipv6: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def associate_carrier_ip_address(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def associate_public_ip_address(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @primary_ipv6.setter
    def primary_ipv6(self, value: Optional[pulumi.Input[_builtins.str]]):
...
if not MYPY:
    ...
    NatGatewayEipAssociationTimeoutsArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    NatGatewayRegionalNatGatewayAddressArgsDict: TypeAlias = Mapping[str, Any]
...
class NetworkInsightsAnalysisExplanationArgs:
    def __init__(__self__, *,
                 ...
                 explanation_code: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 load_balancer_listener_port: Optional[pulumi.Input[_builtins.int]] = None,
                 ...
                 load_balancer_target_port: Optional[pulumi.Input[_builtins.int]] = None,
                 missing_component: Optional[pulumi.Input[_builtins.str]] = None,
                 ...
                 packet_field: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def explanation_code(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def load_balancer_listener_port(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def load_balancer_target_port(self, value: Optional[pulumi.Input[_builtins.int]]):
    ...
    def missing_component(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    @packet_field.setter
    def packet_field(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class NetworkInsightsAnalysisExplanationTransitGatewayRouteTableRouteArgs:
    def __init__(__self__, *,
                 ...
                 resource_type: Optional[pulumi.Input[_builtins.str]] = None,
                 route_origin: Optional[pulumi.Input[_builtins.str]] = None,
                 state: Optional[pulumi.Input[_builtins.str]] = None):
    ...
    @route_origin.setter
    def route_origin(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class NetworkInsightsAnalysisForwardPathComponentArgs:
    def __init__(__self__, *,
                 ...
                 sequence_number: Optional[pulumi.Input[_builtins.int]] = None,
    ...
    def sequence_number(self, value: Optional[pulumi.Input[_builtins.int]]):
...
class NetworkInsightsAnalysisForwardPathComponentAdditionalDetailArgs:
    def __init__(__self__, *,
                 additional_detail_type: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def additional_detail_type(self, value: Optional[pulumi.Input[_builtins.str]]):
...
if not MYPY:
    ...
    NetworkInterfacePermissionTimeoutsArgsDict: TypeAlias = Mapping[str, Any]
...
class PeeringConnectionOptionsAccepterArgs:
    def __init__(__self__, *,
                 allow_remote_vpc_dns_resolution: Optional[pulumi.Input[_builtins.bool]] = None):
    ...
    def allow_remote_vpc_dns_resolution(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class SpotFleetRequestLaunchSpecificationArgs:
    ...
    def iam_instance_profile_arn(self, value: Optional[pulumi.Input[_builtins.str]]):
...
if not MYPY:
    ...
    SpotInstanceRequestPrimaryNetworkInterfaceArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    VpcBlockPublicAccessExclusionTimeoutsArgsDict: TypeAlias = Mapping[str, Any]
...
if not MYPY:
    ...
    VpcBlockPublicAccessOptionsTimeoutsArgsDict: TypeAlias = Mapping[str, Any]
...
class VpcEndpointDnsOptionsArgs:
    ...
    def dns_record_ip_type(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class VpnConnectionTunnel1LogOptionsCloudwatchLogOptionsArgs:
    def __init__(__self__, *,
                 ...
                 bgp_log_output_format: Optional[pulumi.Input[_builtins.str]] = None,
                 log_enabled: Optional[pulumi.Input[_builtins.bool]] = None,
                 log_group_arn: Optional[pulumi.Input[_builtins.str]] = None,
                 log_output_format: Optional[pulumi.Input[_builtins.str]] = None):
    ...
    def bgp_log_output_format(self, value: Optional[pulumi.Input[_builtins.str]]):
    ...
    def log_output_format(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class VpnConnectionVgwTelemetryArgs:
    def __init__(__self__, *,
                 ...
                 last_status_change: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    def last_status_change(self, value: Optional[pulumi.Input[_builtins.str]]):
