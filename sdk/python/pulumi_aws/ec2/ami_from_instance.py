...
class AmiFromInstanceArgs:
    def __init__(__self__, *,
                 source_instance_id: pulumi.Input[builtins.str],
    ...
    def source_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_instance_id(self, value: pulumi.Input[builtins.str]):
    ...
    def snapshot_without_reboot(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AmiFromInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            uefi_data: Optional[pulumi.Input[builtins.str]] = None,
            usage_operation: Optional[pulumi.Input[builtins.str]] = None,
            virtualization_type: Optional[pulumi.Input[builtins.str]] = None) -> 'AmiFromInstance':
        """
    ...
    @property
    @pulumi.getter(name="snapshotWithoutReboot")
    def snapshot_without_reboot(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean that overrides the behavior of stopping
        the instance before snapshotting. This is risky since it may cause a snapshot of an
        inconsistent filesystem state, but can be used to avoid downtime if the user otherwise
    ...
    @property
    @pulumi.getter(name="sourceInstanceId")
    def source_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the instance to use as the basis of the AMI.
        """
        return pulumi.get(self, "source_instance_id")
