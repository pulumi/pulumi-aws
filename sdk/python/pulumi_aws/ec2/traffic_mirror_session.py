...
class TrafficMirrorSession(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        target = aws.ec2.traffic_mirror_target.TrafficMirrorTarget("target", network_load_balancer_arn=aws_lb.lb.arn)
        session = aws.ec2.traffic_mirror_session.TrafficMirrorSession("session",
