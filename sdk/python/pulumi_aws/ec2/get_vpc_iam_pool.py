...
def get_vpc_iam_pool(allocation_resource_tags: Optional[Mapping[str, builtins.str]] = None,
...
def get_vpc_iam_pool_output(allocation_resource_tags: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
