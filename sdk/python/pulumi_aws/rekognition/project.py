...
class ProjectArgs:
    def __init__(__self__, *,
                 auto_update: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] auto_update: Specify if automatic retraining should occur. Valid values are `ENABLED` or `DISABLED`. Defaults to `DISABLED`.
        :param pulumi.Input[builtins.str] feature: Specify the feature being customized. Valid values are `CONTENT_MODERATION` or `CUSTOM_LABELS`. Defaults to `CUSTOM_LABELS`.
        :param pulumi.Input[builtins.str] name: Desired name of the project.
    ...
    def auto_update(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @auto_update.setter
    def auto_update(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the Project.
        :param pulumi.Input[builtins.str] auto_update: Specify if automatic retraining should occur. Valid values are `ENABLED` or `DISABLED`. Defaults to `DISABLED`.
        :param pulumi.Input[builtins.str] feature: Specify the feature being customized. Valid values are `CONTENT_MODERATION` or `CUSTOM_LABELS`. Defaults to `CUSTOM_LABELS`.
        :param pulumi.Input[builtins.str] name: Desired name of the project.
...
class Project(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoUpdate")
    def auto_update(self) -> pulumi.Output[builtins.str]:
        """
        Specify if automatic retraining should occur. Valid values are `ENABLED` or `DISABLED`. Defaults to `DISABLED`.
        """
        return pulumi.get(self, "auto_update")
