...
class StreamProcessorDataSharingPreference(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool opt_in: Whether you are sharing data with Rekognition to improve model performance.
        """
...
class StreamProcessorInputKinesisVideoStream(dict):
    def __init__(__self__, *,
                 arn: builtins.str):
        """
        :param builtins.str arn: ARN of the Kinesis video stream stream that streams the source video.
        """
...
class StreamProcessorNotificationChannel(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str sns_topic_arn: The Amazon Resource Number (ARN) of the Amazon Amazon Simple Notification Service topic to which Amazon Rekognition posts the completion status.
        """
...
class StreamProcessorOutputKinesisDataStream(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str arn: ARN of the output Amazon Kinesis Data Streams stream.
        """
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
...
class StreamProcessorOutputS3Destination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str bucket: Name of the Amazon S3 bucket you want to associate with the streaming video project.
        :param builtins.str key_prefix: The prefix value of the location within the bucket that you want the information to be published to.
        """
...
class StreamProcessorRegionsOfInterestBoundingBox(dict):
    def __init__(__self__, *,
                 height: Optional[builtins.float] = None,
                 left: Optional[builtins.float] = None,
                 top: Optional[builtins.float] = None,
                 width: Optional[builtins.float] = None):
        """
    ...
    @property
    @pulumi.getter
    def height(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def left(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def top(self) -> Optional[builtins.float]:
        """
    ...
    @property
    @pulumi.getter
    def width(self) -> Optional[builtins.float]:
        """
...
class StreamProcessorRegionsOfInterestPolygon(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.float x: The value of the X coordinate for a point on a Polygon.
        :param builtins.float y: The value of the Y coordinate for a point on a Polygon.
        """
        if x is not None:
...
class StreamProcessorSettingsConnectedHome(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.float min_confidence: Minimum confidence required to label an object in the video.
        """
...
class StreamProcessorSettingsFaceSearch(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str collection_id: ID of a collection that contains faces that you want to search for.
        :param builtins.float face_match_threshold: Minimum face match confidence score that must be met to return a result for a recognized face.
        """
