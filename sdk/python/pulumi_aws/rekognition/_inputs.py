...
class StreamProcessorDataSharingPreferenceArgs:
    ...
    @opt_in.setter
    def opt_in(self, value: pulumi.Input[_builtins.bool]):
...
class StreamProcessorInputArgs:
    def __init__(__self__, *,
                 kinesis_video_stream: pulumi.Input['StreamProcessorInputKinesisVideoStreamArgs']):
        """
    ...
    def kinesis_video_stream(self, value: pulumi.Input['StreamProcessorInputKinesisVideoStreamArgs']):
...
class StreamProcessorInputKinesisVideoStreamArgs:
    def __init__(__self__, *,
                 arn: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] arn: ARN of the Kinesis video stream stream that streams the source video.
        """
...
class StreamProcessorRegionsOfInterestBoundingBoxArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] width: Width of the bounding box as a ratio of the overall image width.
        """
