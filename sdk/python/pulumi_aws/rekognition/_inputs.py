...
class StreamProcessorDataSharingPreferenceArgs:
    def __init__(__self__, *,
                 opt_in: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] opt_in: Whether you are sharing data with Rekognition to improve model performance.
        """
...
class StreamProcessorInputKinesisVideoStreamArgs:
    def __init__(__self__, *,
                 arn: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] arn: ARN of the Kinesis video stream stream that streams the source video.
        """
...
class StreamProcessorNotificationChannelArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] sns_topic_arn: The Amazon Resource Number (ARN) of the Amazon Amazon Simple Notification Service topic to which Amazon Rekognition posts the completion status.
        """
...
class StreamProcessorOutputKinesisDataStreamArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] arn: ARN of the output Amazon Kinesis Data Streams stream.
        """
        if arn is not None:
            pulumi.set(__self__, "arn", arn)
...
class StreamProcessorOutputS3DestinationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: Name of the Amazon S3 bucket you want to associate with the streaming video project.
        :param pulumi.Input[builtins.str] key_prefix: The prefix value of the location within the bucket that you want the information to be published to.
        """
...
class StreamProcessorRegionsOfInterestArgs:
    ...
    @bounding_box.setter
    def bounding_box(self, value: pulumi.Input['StreamProcessorRegionsOfInterestBoundingBoxArgs']):
...
if not MYPY:
    class StreamProcessorRegionsOfInterestBoundingBoxArgsDict(TypedDict):
        ...
        """
        left: NotRequired[pulumi.Input[builtins.float]]
        """
        Left coordinate of the bounding box as a ratio of overall image width.
        """
        top: NotRequired[pulumi.Input[builtins.float]]
        """
...
class StreamProcessorRegionsOfInterestBoundingBoxArgs:
    def __init__(__self__, *,
                 ...
                 left: Optional[pulumi.Input[builtins.float]] = None,
                 top: Optional[pulumi.Input[builtins.float]] = None,
    ...
    @property
    @pulumi.getter
    def left(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Left coordinate of the bounding box as a ratio of overall image width.
        """
    ...
    @left.setter
    def left(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "left", value)

    @property
    @pulumi.getter
    def top(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Top coordinate of the bounding box as a ratio of overall image height.
        """
    ...
    @top.setter
    def top(self, value: Optional[pulumi.Input[builtins.float]]):
...
class StreamProcessorRegionsOfInterestPolygonArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] x: The value of the X coordinate for a point on a Polygon.
        :param pulumi.Input[builtins.float] y: The value of the Y coordinate for a point on a Polygon.
        """
        if x is not None:
...
class StreamProcessorSettingsConnectedHomeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] min_confidence: Minimum confidence required to label an object in the video.
        """
...
class StreamProcessorSettingsFaceSearchArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] collection_id: ID of a collection that contains faces that you want to search for.
        :param pulumi.Input[builtins.float] face_match_threshold: Minimum face match confidence score that must be met to return a result for a recognized face.
        """
