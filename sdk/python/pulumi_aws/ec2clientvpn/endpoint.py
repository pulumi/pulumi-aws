...
class Endpoint(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if client_connect_options is not None and not isinstance(client_connect_options, EndpointClientConnectOptionsArgs):
                client_connect_options = client_connect_options or {}
                def _setter(key, value):
                    client_connect_options[key] = value
                EndpointClientConnectOptionsArgs._configure(_setter, **client_connect_options)
            __props__.__dict__["client_connect_options"] = client_connect_options
            if client_login_banner_options is not None and not isinstance(client_login_banner_options, EndpointClientLoginBannerOptionsArgs):
                client_login_banner_options = client_login_banner_options or {}
                def _setter(key, value):
                    client_login_banner_options[key] = value
                EndpointClientLoginBannerOptionsArgs._configure(_setter, **client_login_banner_options)
            __props__.__dict__["client_login_banner_options"] = client_login_banner_options
            if connection_log_options is not None and not isinstance(connection_log_options, EndpointConnectionLogOptionsArgs):
                connection_log_options = connection_log_options or {}
                def _setter(key, value):
                    connection_log_options[key] = value
                EndpointConnectionLogOptionsArgs._configure(_setter, **connection_log_options)
