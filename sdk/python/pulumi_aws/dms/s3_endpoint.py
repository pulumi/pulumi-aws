...
class S3EndpointArgs:
    def __init__(__self__, *,
                 ...
                 add_trailing_padding_character: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 date_partition_timezone: Optional[pulumi.Input[builtins.str]] = None,
                 detach_target_on_lob_lookup_failure_parquet: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] service_access_role_arn: ARN of the IAM role with permissions to the S3 Bucket.
        ...
        :param pulumi.Input[builtins.bool] add_trailing_padding_character: Whether to add padding. Default is `false`. (Ignored for source endpoints.)
        ...
        :param pulumi.Input[builtins.str] csv_no_sup_value: Only applies if output files for a CDC load are written in .csv format. If `use_csv_no_sup_value` is set to `true`, string to use for all columns not included in the supplemental log. If you do not specify a string value, DMS uses the null value for these columns regardless of `use_csv_no_sup_value`. (Ignored for source endpoints.)
        :param pulumi.Input[builtins.str] csv_null_value: String to as null when writing to the target. (AWS default is `NULL`.)
        :param pulumi.Input[builtins.str] csv_row_delimiter: Delimiter used to separate rows in the source files. Default is newline (_i.e._, `\\n`).
        :param pulumi.Input[builtins.str] data_format: Output format for the files that AWS DMS uses to create S3 objects. Valid values are `csv` and `parquet`.  (Ignored for source endpoints -- only `csv` is valid.)
        :param pulumi.Input[builtins.int] data_page_size: Size of one data page in bytes. (AWS default is 1 MiB, _i.e._, `1048576`.)
        :param pulumi.Input[builtins.str] date_partition_delimiter: Date separating delimiter to use during folder partitioning. Valid values are `SLASH`, `UNDERSCORE`, `DASH`, and `NONE`. (AWS default is `SLASH`.) (Ignored for source endpoints.)
        :param pulumi.Input[builtins.bool] date_partition_enabled: Partition S3 bucket folders based on transaction commit dates. Default is `false`. (Ignored for source endpoints.)
        :param pulumi.Input[builtins.str] date_partition_sequence: Date format to use during folder partitioning. Use this parameter when `date_partition_enabled` is set to true. Valid values are `YYYYMMDD`, `YYYYMMDDHH`, `YYYYMM`, `MMYYYYDD`, and `DDMMYYYY`. (AWS default is `YYYYMMDD`.) (Ignored for source endpoints.)
        :param pulumi.Input[builtins.str] date_partition_timezone: Convert the current UTC time to a timezone. The conversion occurs when a date partition folder is created and a CDC filename is generated. The timezone format is Area/Location (_e.g._, `Europe/Paris`). Use this when `date_partition_enabled` is `true`. (Ignored for source endpoints.)
        :param pulumi.Input[builtins.bool] detach_target_on_lob_lookup_failure_parquet: Undocumented argument for use as directed by AWS Support.
        :param pulumi.Input[builtins.int] dict_page_size_limit: Maximum size in bytes of an encoded dictionary page of a column. (AWS default is 1 MiB, _i.e._, `1048576`.)
        ...
        :param pulumi.Input[builtins.int] max_file_size: Maximum size (in KB) of any .csv file to be created while migrating to an S3 target during full load. Valid values are from `1` to `1048576`. (AWS default is 1 GB, _i.e._, `1048576`.)
        ...
        :param pulumi.Input[builtins.str] ssl_mode: SSL mode to use for the connection. Valid values are `none`, `require`, `verify-ca`, `verify-full`. (AWS default is `none`.)
        ...
        :param pulumi.Input[builtins.bool] use_csv_no_sup_value: Whether to use `csv_no_sup_value` for columns not included in the supplemental log. (Ignored for source endpoints.)
    ...
    def add_trailing_padding_character(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def add_trailing_padding_character(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def date_partition_timezone(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def date_partition_timezone(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "date_partition_timezone", value)

    @property
    @pulumi.getter(name="detachTargetOnLobLookupFailureParquet")
    def detach_target_on_lob_lookup_failure_parquet(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def detach_target_on_lob_lookup_failure_parquet(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _S3EndpointState:
    def __init__(__self__, *,
                 ...
                 engine_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 expected_bucket_owner: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] encoding_type: Type of encoding to use. Value values are `rle_dictionary`, `plain`, and `plain_dictionary`. (AWS default is `rle_dictionary`.)
        :param pulumi.Input[builtins.str] encryption_mode: Server-side encryption mode that you want to encrypt your .csv or .parquet object files copied to S3. Valid values are `SSE_S3` and `SSE_KMS`. (AWS default is `SSE_S3`.) (Ignored for source endpoints -- only `SSE_S3` is valid.)
        :param pulumi.Input[builtins.str] endpoint_arn: ARN for the endpoint.
        :param pulumi.Input[builtins.str] endpoint_id: Database endpoint identifier. Identifiers must contain from 1 to 255 alphanumeric characters or hyphens, begin with a letter, contain only ASCII letters, digits, and hyphens, not end with a hyphen, and not contain two consecutive hyphens.
        :param pulumi.Input[builtins.str] endpoint_type: Type of endpoint. Valid values are `source`, `target`.
        ...
        :param pulumi.Input[builtins.str] service_access_role_arn: ARN of the IAM role with permissions to the S3 Bucket.
               ...
               The following arguments are optional:
        :param pulumi.Input[builtins.str] ssl_mode: SSL mode to use for the connection. Valid values are `none`, `require`, `verify-ca`, `verify-full`. (AWS default is `none`.)
        :param pulumi.Input[builtins.str] status: Status of the endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of tags to assign to the resource. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    def engine_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def engine_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class S3Endpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            timestamp_column_name: Optional[pulumi.Input[builtins.str]] = None,
            use_csv_no_sup_value: Optional[pulumi.Input[builtins.bool]] = None,
            use_task_start_time_for_full_load_timestamp: Optional[pulumi.Input[builtins.bool]] = None) -> 'S3Endpoint':
        """
    ...
    @property
    @pulumi.getter(name="addColumnName")
    def add_column_name(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to add column name information to the .csv output file. Default is `false`.
        """
        return pulumi.get(self, "add_column_name")
    ...
    @property
    @pulumi.getter(name="addTrailingPaddingCharacter")
    def add_trailing_padding_character(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to add padding. Default is `false`. (Ignored for source endpoints.)
        """
        return pulumi.get(self, "add_trailing_padding_character")
    ...
    @property
    @pulumi.getter(name="bucketFolder")
    def bucket_folder(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        S3 object prefix.
        """
        return pulumi.get(self, "bucket_folder")
    ...
    @property
    @pulumi.getter(name="cannedAclForObjects")
    def canned_acl_for_objects(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Predefined (canned) access control list for objects created in an S3 bucket. Valid values include `none`, `private`, `public-read`, `public-read-write`, `authenticated-read`, `aws-exec-read`, `bucket-owner-read`, and `bucket-owner-full-control`. Default is `none`.
        """
        return pulumi.get(self, "canned_acl_for_objects")
    ...
    @property
    @pulumi.getter(name="cdcInsertsAndUpdates")
    def cdc_inserts_and_updates(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to write insert and update operations to .csv or .parquet output files. Default is `false`.
        """
        return pulumi.get(self, "cdc_inserts_and_updates")
    ...
    @property
    @pulumi.getter(name="cdcInsertsOnly")
    def cdc_inserts_only(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to write insert operations to .csv or .parquet output files. Default is `false`.
        """
        return pulumi.get(self, "cdc_inserts_only")
    ...
    @property
    @pulumi.getter(name="cdcMaxBatchInterval")
    def cdc_max_batch_interval(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum length of the interval, defined in seconds, after which to output a file to Amazon S3. (AWS default is `60`.)
        """
        return pulumi.get(self, "cdc_max_batch_interval")
    ...
    @property
    @pulumi.getter(name="cdcMinFileSize")
    def cdc_min_file_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Minimum file size condition as defined in kilobytes to output a file to Amazon S3. (AWS default is 32000 KB.)
        """
        return pulumi.get(self, "cdc_min_file_size")
    ...
    @property
    @pulumi.getter(name="csvDelimiter")
    def csv_delimiter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Delimiter used to separate columns in the source files. Default is `,`.
        """
        return pulumi.get(self, "csv_delimiter")
    ...
    @property
    @pulumi.getter(name="csvNoSupValue")
    def csv_no_sup_value(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Only applies if output files for a CDC load are written in .csv format. If `use_csv_no_sup_value` is set to `true`, string to use for all columns not included in the supplemental log. If you do not specify a string value, DMS uses the null value for these columns regardless of `use_csv_no_sup_value`. (Ignored for source endpoints.)
        """
        return pulumi.get(self, "csv_no_sup_value")
    ...
    @property
    @pulumi.getter(name="csvNullValue")
    def csv_null_value(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        String to as null when writing to the target. (AWS default is `NULL`.)
        """
        return pulumi.get(self, "csv_null_value")
    ...
    @property
    @pulumi.getter(name="csvRowDelimiter")
    def csv_row_delimiter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Delimiter used to separate rows in the source files. Default is newline (_i.e._, `\\n`).
        """
        return pulumi.get(self, "csv_row_delimiter")
    ...
    @property
    @pulumi.getter(name="dataPageSize")
    def data_page_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Size of one data page in bytes. (AWS default is 1 MiB, _i.e._, `1048576`.)
        """
        return pulumi.get(self, "data_page_size")
    ...
    @property
    @pulumi.getter(name="datePartitionDelimiter")
    def date_partition_delimiter(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Date separating delimiter to use during folder partitioning. Valid values are `SLASH`, `UNDERSCORE`, `DASH`, and `NONE`. (AWS default is `SLASH`.) (Ignored for source endpoints.)
        """
        return pulumi.get(self, "date_partition_delimiter")
    ...
    @property
    @pulumi.getter(name="datePartitionEnabled")
    def date_partition_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Partition S3 bucket folders based on transaction commit dates. Default is `false`. (Ignored for source endpoints.)
        """
        return pulumi.get(self, "date_partition_enabled")
    ...
    @property
    @pulumi.getter(name="datePartitionSequence")
    def date_partition_sequence(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Date format to use during folder partitioning. Use this parameter when `date_partition_enabled` is set to true. Valid values are `YYYYMMDD`, `YYYYMMDDHH`, `YYYYMM`, `MMYYYYDD`, and `DDMMYYYY`. (AWS default is `YYYYMMDD`.) (Ignored for source endpoints.)
        """
        return pulumi.get(self, "date_partition_sequence")
    ...
    @property
    @pulumi.getter(name="datePartitionTimezone")
    def date_partition_timezone(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Convert the current UTC time to a timezone. The conversion occurs when a date partition folder is created and a CDC filename is generated. The timezone format is Area/Location (_e.g._, `Europe/Paris`). Use this when `date_partition_enabled` is `true`. (Ignored for source endpoints.)
        """
        return pulumi.get(self, "date_partition_timezone")
    ...
    @property
    @pulumi.getter(name="detachTargetOnLobLookupFailureParquet")
    def detach_target_on_lob_lookup_failure_parquet(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Undocumented argument for use as directed by AWS Support.
        """
        return pulumi.get(self, "detach_target_on_lob_lookup_failure_parquet")
    ...
    @property
    @pulumi.getter(name="dictPageSizeLimit")
    def dict_page_size_limit(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum size in bytes of an encoded dictionary page of a column. (AWS default is 1 MiB, _i.e._, `1048576`.)
        """
        return pulumi.get(self, "dict_page_size_limit")
    ...
    @property
    @pulumi.getter(name="enableStatistics")
    def enable_statistics(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable statistics for Parquet pages and row groups. Default is `true`.
        """
        return pulumi.get(self, "enable_statistics")
    ...
    @property
    @pulumi.getter(name="encodingType")
    def encoding_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Type of encoding to use. Value values are `rle_dictionary`, `plain`, and `plain_dictionary`. (AWS default is `rle_dictionary`.)
        """
        return pulumi.get(self, "encoding_type")
    ...
    @property
    @pulumi.getter(name="encryptionMode")
    def encryption_mode(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Server-side encryption mode that you want to encrypt your .csv or .parquet object files copied to S3. Valid values are `SSE_S3` and `SSE_KMS`. (AWS default is `SSE_S3`.) (Ignored for source endpoints -- only `SSE_S3` is valid.)
        """
        return pulumi.get(self, "encryption_mode")
    ...
    @property
    @pulumi.getter(name="endpointArn")
    def endpoint_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN for the endpoint.
        """
        return pulumi.get(self, "endpoint_arn")
    ...
    @property
    @pulumi.getter(name="engineDisplayName")
    def engine_display_name(self) -> pulumi.Output[builtins.str]:
        """
        Expanded name for the engine name.
        """
        return pulumi.get(self, "engine_display_name")
    ...
    @property
    @pulumi.getter(name="glueCatalogGeneration")
    def glue_catalog_generation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to integrate AWS Glue Data Catalog with an Amazon S3 target. See [Using AWS Glue Data Catalog with an Amazon S3 target for AWS DMS](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.S3.html#CHAP_Target.S3.GlueCatalog) for more information. Default is `false`.
        """
        return pulumi.get(self, "glue_catalog_generation")
    ...
    @property
    @pulumi.getter(name="ignoreHeaderRows")
    def ignore_header_rows(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        When this value is set to `1`, DMS ignores the first row header in a .csv file. (AWS default is `0`.)
        """
        return pulumi.get(self, "ignore_header_rows")
    ...
    @property
    @pulumi.getter(name="includeOpForFullLoad")
    def include_op_for_full_load(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable a full load to write INSERT operations to the .csv output files only to indicate how the rows were added to the source database. Default is `false`.
        """
        return pulumi.get(self, "include_op_for_full_load")
    ...
    @property
    @pulumi.getter(name="maxFileSize")
    def max_file_size(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Maximum size (in KB) of any .csv file to be created while migrating to an S3 target during full load. Valid values are from `1` to `1048576`. (AWS default is 1 GB, _i.e._, `1048576`.)
        """
        return pulumi.get(self, "max_file_size")
    ...
    @property
    @pulumi.getter(name="parquetTimestampInMillisecond")
    def parquet_timestamp_in_millisecond(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Specifies the precision of any TIMESTAMP column values written to an S3 object file in .parquet format. Default is `false`. (Ignored for source endpoints.)
        """
        return pulumi.get(self, "parquet_timestamp_in_millisecond")
    ...
    @property
    @pulumi.getter(name="parquetVersion")
    def parquet_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Version of the .parquet file format. Valid values are `parquet-1-0` and `parquet-2-0`. (AWS default is `parquet-1-0`.) (Ignored for source endpoints.)
        """
        return pulumi.get(self, "parquet_version")
    ...
    @property
    @pulumi.getter(name="preserveTransactions")
    def preserve_transactions(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether DMS saves the transaction order for a CDC load on the S3 target specified by `cdc_path`. Default is `false`. (Ignored for source endpoints.)
        """
        return pulumi.get(self, "preserve_transactions")
    ...
    @property
    @pulumi.getter(name="rowGroupLength")
    def row_group_length(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Number of rows in a row group. (AWS default is `10000`.)
        """
        return pulumi.get(self, "row_group_length")
    ...
    @property
    @pulumi.getter(name="serverSideEncryptionKmsKeyId")
    def server_side_encryption_kms_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        When `encryption_mode` is `SSE_KMS`, ARN for the AWS KMS key. (Ignored for source endpoints -- only `SSE_S3` `encryption_mode` is valid.)
        """
        return pulumi.get(self, "server_side_encryption_kms_key_id")
    ...
    @property
    @pulumi.getter(name="timestampColumnName")
    def timestamp_column_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Column to add with timestamp information to the endpoint data for an Amazon S3 target.
        """
        return pulumi.get(self, "timestamp_column_name")
    ...
    @property
    @pulumi.getter(name="useCsvNoSupValue")
    def use_csv_no_sup_value(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to use `csv_no_sup_value` for columns not included in the supplemental log. (Ignored for source endpoints.)
        """
        return pulumi.get(self, "use_csv_no_sup_value")
    ...
    @property
    @pulumi.getter(name="useTaskStartTimeForFullLoadTimestamp")
    def use_task_start_time_for_full_load_timestamp(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When set to `true`, uses the task start time as the timestamp column value instead of the time data is written to target. For full load, when set to `true`, each row of the timestamp column contains the task start time. For CDC loads, each row of the timestamp column contains the transaction commit time.When set to false, the full load timestamp in the timestamp column increments with the time data arrives at the target. Default is `false`.
        """
        return pulumi.get(self, "use_task_start_time_for_full_load_timestamp")
