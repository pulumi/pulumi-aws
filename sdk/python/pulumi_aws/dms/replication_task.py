...
class ReplicationTaskArgs:
    def __init__(__self__, *,
                 ...
                 replication_instance_arn: pulumi.Input[builtins.str],
                 replication_task_id: pulumi.Input[builtins.str],
                 ...
                 cdc_start_position: Optional[pulumi.Input[builtins.str]] = None,
                 cdc_start_time: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] replication_instance_arn: ARN of the replication instance.
        :param pulumi.Input[builtins.str] replication_task_id: Replication task identifier which must contain from 1 to 255 alphanumeric characters or hyphens, first character must be a letter, cannot end with a hyphen, and cannot contain two consecutive hyphens.
        :param pulumi.Input[builtins.str] source_endpoint_arn: ARN that uniquely identifies the source endpoint.
        ...
        :param pulumi.Input[builtins.str] cdc_start_position: Indicates when you want a change data capture (CDC) operation to start. The value can be a RFC3339 formatted date, a checkpoint, or a LSN/SCN format depending on the source engine. For more information see [Determining a CDC native start point](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Task.CDC.html#CHAP_Task.CDC.StartPoint.Native).
        :param pulumi.Input[builtins.str] cdc_start_time: RFC3339 formatted date string or UNIX timestamp for the start of the Change Data Capture (CDC) operation.
        :param pulumi.Input[builtins.str] replication_task_settings: Escaped JSON string that contains the task settings. For a complete list of task settings, see [Task Settings for AWS Database Migration Service Tasks](http://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.CustomizingTasks.TaskSettings.html). Note that `Logging.CloudWatchLogGroup` and `Logging.CloudWatchLogStream` are read only and should not be defined, even as `null`, in the configuration since AWS provides a value for these settings.
    ...
    def replication_instance_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def replication_instance_arn(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "replication_instance_arn", value)

    @property
    @pulumi.getter(name="replicationTaskId")
    def replication_task_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def replication_task_id(self, value: pulumi.Input[builtins.str]):
    ...
    def cdc_start_position(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cdc_start_position(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cdc_start_position", value)

    @property
    @pulumi.getter(name="cdcStartTime")
    def cdc_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cdc_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cdc_start_time", value)

    @property
    @pulumi.getter(name="replicationTaskSettings")
    def replication_task_settings(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replication_task_settings(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def start_replication_task(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def start_replication_task(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ReplicationTaskState:
    def __init__(__self__, *,
                 ...
                 replication_instance_arn: Optional[pulumi.Input[builtins.str]] = None,
                 replication_task_arn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] migration_type: Migration type. Can be one of `full-load | cdc | full-load-and-cdc`.
        :param pulumi.Input[builtins.str] replication_instance_arn: ARN of the replication instance.
        :param pulumi.Input[builtins.str] replication_task_arn: ARN for the replication task.
        :param pulumi.Input[builtins.str] replication_task_id: Replication task identifier which must contain from 1 to 255 alphanumeric characters or hyphens, first character must be a letter, cannot end with a hyphen, and cannot contain two consecutive hyphens.
        :param pulumi.Input[builtins.str] replication_task_settings: Escaped JSON string that contains the task settings. For a complete list of task settings, see [Task Settings for AWS Database Migration Service Tasks](http://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.CustomizingTasks.TaskSettings.html). Note that `Logging.CloudWatchLogGroup` and `Logging.CloudWatchLogStream` are read only and should not be defined, even as `null`, in the configuration since AWS provides a value for these settings.
        :param pulumi.Input[builtins.str] resource_identifier: A friendly name for the resource identifier at the end of the EndpointArn response parameter that is returned in the created Endpoint object.
        :param pulumi.Input[builtins.str] source_endpoint_arn: ARN that uniquely identifies the source endpoint.
        :param pulumi.Input[builtins.bool] start_replication_task: Whether to run or stop the replication task.
        :param pulumi.Input[builtins.str] status: Replication Task status.
        :param pulumi.Input[builtins.str] table_mappings: Escaped JSON string that contains the table mappings. For information on table mapping see [Using Table Mapping with an AWS Database Migration Service Task to Select and Filter Data](http://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.CustomizingTasks.TableMapping.html)
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the resource. .If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    @property
    @pulumi.getter(name="replicationInstanceArn")
    def replication_instance_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the replication instance.
        """
        return pulumi.get(self, "replication_instance_arn")
    ...
    @replication_instance_arn.setter
    def replication_instance_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_instance_arn", value)

    @property
    @pulumi.getter(name="replicationTaskArn")
    def replication_task_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replication_task_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_task_arn", value)

    @property
    @pulumi.getter(name="replicationTaskId")
    def replication_task_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Replication task identifier which must contain from 1 to 255 alphanumeric characters or hyphens, first character must be a letter, cannot end with a hyphen, and cannot contain two consecutive hyphens.
        """
        return pulumi.get(self, "replication_task_id")
    ...
    @replication_task_id.setter
    def replication_task_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_task_id", value)
...
class ReplicationTask(pulumi.CustomResource):
    ...
    pulumi_type = "aws:dms/replicationTask:ReplicationTask"
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            target_endpoint_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'ReplicationTask':
        """
    ...
    @property
    @pulumi.getter(name="cdcStartPosition")
    def cdc_start_position(self) -> pulumi.Output[builtins.str]:
        """
        Indicates when you want a change data capture (CDC) operation to start. The value can be a RFC3339 formatted date, a checkpoint, or a LSN/SCN format depending on the source engine. For more information see [Determining a CDC native start point](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Task.CDC.html#CHAP_Task.CDC.StartPoint.Native).
        """
        return pulumi.get(self, "cdc_start_position")
    ...
    @property
    @pulumi.getter(name="cdcStartTime")
    def cdc_start_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        RFC3339 formatted date string or UNIX timestamp for the start of the Change Data Capture (CDC) operation.
        """
        return pulumi.get(self, "cdc_start_time")
    ...
    @property
    @pulumi.getter(name="replicationInstanceArn")
    def replication_instance_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the replication instance.
        """
        return pulumi.get(self, "replication_instance_arn")
    ...
    @property
    @pulumi.getter(name="replicationTaskArn")
    def replication_task_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN for the replication task.
        """
        return pulumi.get(self, "replication_task_arn")
    ...
    @property
    @pulumi.getter(name="replicationTaskId")
    def replication_task_id(self) -> pulumi.Output[builtins.str]:
        """
        Replication task identifier which must contain from 1 to 255 alphanumeric characters or hyphens, first character must be a letter, cannot end with a hyphen, and cannot contain two consecutive hyphens.
        """
        return pulumi.get(self, "replication_task_id")
    ...
    @property
    @pulumi.getter(name="replicationTaskSettings")
    def replication_task_settings(self) -> pulumi.Output[builtins.str]:
        """
        Escaped JSON string that contains the task settings. For a complete list of task settings, see [Task Settings for AWS Database Migration Service Tasks](http://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.CustomizingTasks.TaskSettings.html). Note that `Logging.CloudWatchLogGroup` and `Logging.CloudWatchLogStream` are read only and should not be defined, even as `null`, in the configuration since AWS provides a value for these settings.
        """
        return pulumi.get(self, "replication_task_settings")
    ...
    @property
    @pulumi.getter(name="startReplicationTask")
    def start_replication_task(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to run or stop the replication task.
        """
        return pulumi.get(self, "start_replication_task")
