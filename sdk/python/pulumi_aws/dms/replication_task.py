...
class ReplicationTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test = aws.dms.replication_task.ReplicationTask("test",
            cdc_start_time=1993-05-21T05:50:00Z,
            migration_type=full-load,
            replication_instance_arn=aws_dms_replication_instance.test_dms_replication_instance_tf.replication_instance_arn,
            replication_task_id=test-dms-replication-task-tf,
            replication_task_settings=...,
            source_endpoint_arn=aws_dms_endpoint.test_dms_source_endpoint_tf.endpoint_arn,
            table_mappings={"rules":[{"rule-type":"selection","rule-id":"1","rule-name":"1","object-locator":{"schema-name":"%","table-name":"%"},"rule-action":"include"}]},
            tags={
                Name: test,
            },
            target_endpoint_arn=aws_dms_endpoint.test_dms_target_endpoint_tf.endpoint_arn)
        ```
