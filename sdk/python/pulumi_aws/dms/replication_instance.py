...
class ReplicationInstanceArgs:
    def __init__(__self__, *,
                 replication_instance_class: pulumi.Input[builtins.str],
                 replication_instance_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.int] allocated_storage: The amount of storage (in gigabytes) to be initially allocated for the replication instance.
        :param pulumi.Input[builtins.bool] allow_major_version_upgrade: Indicates that major version upgrades are allowed.
        :param pulumi.Input[builtins.bool] apply_immediately: Indicates whether the changes should be applied immediately or during the next maintenance window. Only used when updating an existing resource.
        :param pulumi.Input[builtins.bool] auto_minor_version_upgrade: Indicates that minor engine upgrades will be applied automatically to the replication instance during the maintenance window.
        :param pulumi.Input[builtins.str] availability_zone: The EC2 Availability Zone that the replication instance will be created in.
        :param pulumi.Input[builtins.str] engine_version: The engine version number of the replication instance.
        :param pulumi.Input[builtins.str] kms_key_arn: The Amazon Resource Name (ARN) for the KMS key that will be used to encrypt the connection parameters. If you do not specify a value for `kms_key_arn`, then AWS DMS will use your default encryption key. AWS KMS creates the default encryption key for your AWS account. Your AWS account has a different default encryption key for each AWS region.
        ...
        :param pulumi.Input[builtins.str] network_type: The type of IP address protocol used by a replication instance. Valid values: `IPV4`, `DUAL`.
    ...
    def replication_instance_class(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def replication_instance_class(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "replication_instance_class", value)

    @property
    @pulumi.getter(name="replicationInstanceId")
    def replication_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def replication_instance_id(self, value: pulumi.Input[builtins.str]):
...
class _ReplicationInstanceState:
    def __init__(__self__, *,
                 ...
                 replication_instance_class: Optional[pulumi.Input[builtins.str]] = None,
                 replication_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 replication_instance_private_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 replication_instance_public_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 replication_subnet_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] replication_instance_id: The replication instance identifier. This parameter is stored as a lowercase string.
               ...
               - Cannot end with a hyphen
               - Cannot contain two consecutive hyphens.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] replication_instance_private_ips: A list of the private IP addresses of the replication instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] replication_instance_public_ips: A list of the public IP addresses of the replication instance.
        :param pulumi.Input[builtins.str] replication_subnet_group_id: A subnet group to associate with the replication instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to assign to the resource. .If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
    ...
    @property
    @pulumi.getter(name="replicationInstanceClass")
    def replication_instance_class(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The compute and memory capacity of the replication instance as specified by the replication instance class. See [AWS DMS User Guide](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_ReplicationInstance.Types.html) for available instance sizes and advice on which one to choose.
        """
        return pulumi.get(self, "replication_instance_class")
    ...
    @replication_instance_class.setter
    def replication_instance_class(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_instance_class", value)

    @property
    @pulumi.getter(name="replicationInstanceId")
    def replication_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The replication instance identifier. This parameter is stored as a lowercase string.
    ...
    @replication_instance_id.setter
    def replication_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_instance_id", value)

    @property
    @pulumi.getter(name="replicationInstancePrivateIps")
    def replication_instance_private_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def replication_instance_private_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "replication_instance_private_ips", value)

    @property
    @pulumi.getter(name="replicationInstancePublicIps")
    def replication_instance_public_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def replication_instance_public_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ReplicationInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            vpc_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ReplicationInstance':
        """
    ...
    @property
    @pulumi.getter(name="autoMinorVersionUpgrade")
    def auto_minor_version_upgrade(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates that minor engine upgrades will be applied automatically to the replication instance during the maintenance window.
        """
        return pulumi.get(self, "auto_minor_version_upgrade")
    ...
    @property
    @pulumi.getter(name="replicationInstanceClass")
    def replication_instance_class(self) -> pulumi.Output[builtins.str]:
        """
        The compute and memory capacity of the replication instance as specified by the replication instance class. See [AWS DMS User Guide](https://docs.aws.amazon.com/dms/latest/userguide/CHAP_ReplicationInstance.Types.html) for available instance sizes and advice on which one to choose.
        """
        return pulumi.get(self, "replication_instance_class")
    ...
    @property
    @pulumi.getter(name="replicationInstanceId")
    def replication_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The replication instance identifier. This parameter is stored as a lowercase string.
    ...
    @property
    @pulumi.getter(name="replicationInstancePrivateIps")
    def replication_instance_private_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of the private IP addresses of the replication instance.
        """
        return pulumi.get(self, "replication_instance_private_ips")
    ...
    @property
    @pulumi.getter(name="replicationInstancePublicIps")
    def replication_instance_public_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of the public IP addresses of the replication instance.
        """
        return pulumi.get(self, "replication_instance_public_ips")
