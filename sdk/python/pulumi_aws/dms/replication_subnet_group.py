...
class _ReplicationSubnetGroupState:
    def __init__(__self__, *,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 replication_subnet_group_arn: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def replication_subnet_group_arn(self) -> pulumi.Input[Optional[_builtins.str]]:
        return pulumi.get(self, "replication_subnet_group_arn")

    @replication_subnet_group_arn.setter
    def replication_subnet_group_arn(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "replication_subnet_group_arn", value)

    @_builtins.property
    @pulumi.getter(name="replicationSubnetGroupDescription")
    def replication_subnet_group_description(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Description for the subnet group.
        """
        return pulumi.get(self, "replication_subnet_group_description")
    ...
    @replication_subnet_group_description.setter
    def replication_subnet_group_description(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "replication_subnet_group_description", value)
...
class ReplicationSubnetGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tags_all: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            vpc_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ReplicationSubnetGroup':
        """
