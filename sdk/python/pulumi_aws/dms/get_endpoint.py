...
def get_endpoint(elasticsearch_settings: Optional[Sequence[pulumi.InputType['GetEndpointElasticsearchSettingArgs']]] = None,
    ...
    return AwaitableGetEndpointResult(
        ...
        endpoint_arn=__ret__.endpoint_arn,
