...
class TableArgs:
    def __init__(__self__, *,
                 ...
                 restore_source_table_arn: Optional[pulumi.Input[builtins.str]] = None,
                 restore_to_latest_time: Optional[pulumi.Input[builtins.bool]] = None,
                 server_side_encryption: Optional[pulumi.Input['TableServerSideEncryptionArgs']] = None,
                 stream_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 stream_view_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] billing_mode: Controls how you are charged for read and write throughput and how you manage capacity. The valid values are `PROVISIONED` and `PAY_PER_REQUEST`. Defaults to `PROVISIONED`.
        :param pulumi.Input[builtins.bool] deletion_protection_enabled: Enables deletion protection for table. Defaults to `false`.
        ...
        :param pulumi.Input[builtins.str] hash_key: Attribute to use as the hash (partition) key. Must also be defined as an `attribute`. See below.
        ...
        :param pulumi.Input[builtins.str] restore_source_table_arn: ARN of the source table to restore. Must be supplied for cross-region restores.
        :param pulumi.Input[builtins.bool] restore_to_latest_time: If set, restores table to the most recent point-in-time recovery point.
        ...
        :param pulumi.Input[builtins.bool] stream_enabled: Whether Streams are enabled.
        :param pulumi.Input[builtins.str] stream_view_type: When an item in the table is modified, StreamViewType determines what information is written to the table's stream. Valid values are `KEYS_ONLY`, `NEW_IMAGE`, `OLD_IMAGE`, `NEW_AND_OLD_IMAGES`.
        :param pulumi.Input[builtins.str] table_class: Storage class of the table.
               Valid values are `STANDARD` and `STANDARD_INFREQUENT_ACCESS`.
               Default value is `STANDARD`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: A map of tags to populate on the created table. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input['TableTtlArgs'] ttl: Configuration block for TTL. See below.
        :param pulumi.Input[builtins.int] write_capacity: Number of write units for this table. If the `billing_mode` is `PROVISIONED`, this field is required.
        """
    ...
    def restore_date_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_date_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restore_date_time", value)

    @property
    @pulumi.getter(name="restoreSourceName")
    def restore_source_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_source_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restore_source_name", value)

    @property
    @pulumi.getter(name="restoreSourceTableArn")
    def restore_source_table_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restore_source_table_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "restore_source_table_arn", value)

    @property
    @pulumi.getter(name="restoreToLatestTime")
    def restore_to_latest_time(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def restore_to_latest_time(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def stream_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def stream_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "stream_enabled", value)

    @property
    @pulumi.getter(name="streamViewType")
    def stream_view_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def stream_view_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Table(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            ttl: Optional[pulumi.Input[Union['TableTtlArgs', 'TableTtlArgsDict']]] = None,
            write_capacity: Optional[pulumi.Input[builtins.int]] = None) -> 'Table':
        """
    ...
    @property
    @pulumi.getter(name="readCapacity")
    def read_capacity(self) -> pulumi.Output[builtins.int]:
        """
        Number of read units for this table. If the `billing_mode` is `PROVISIONED`, this field is required.
        """
        return pulumi.get(self, "read_capacity")
    ...
    @property
    @pulumi.getter(name="restoreDateTime")
    def restore_date_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Time of the point-in-time recovery point to restore.
        """
        return pulumi.get(self, "restore_date_time")
    ...
    @property
    @pulumi.getter(name="restoreSourceName")
    def restore_source_name(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Name of the table to restore. Must match the name of an existing table.
        """
        return pulumi.get(self, "restore_source_name")
    ...
    @property
    @pulumi.getter(name="restoreSourceTableArn")
    def restore_source_table_arn(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ARN of the source table to restore. Must be supplied for cross-region restores.
        """
        return pulumi.get(self, "restore_source_table_arn")
    ...
    @property
    @pulumi.getter(name="restoreToLatestTime")
    def restore_to_latest_time(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set, restores table to the most recent point-in-time recovery point.
        """
        return pulumi.get(self, "restore_to_latest_time")
    ...
    @property
    @pulumi.getter(name="streamEnabled")
    def stream_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether Streams are enabled.
        """
        return pulumi.get(self, "stream_enabled")
    ...
    @property
    @pulumi.getter(name="streamLabel")
    def stream_label(self) -> pulumi.Output[builtins.str]:
        """
        Timestamp, in ISO 8601 format, for this stream. Note that this timestamp is not a unique identifier for the stream on its own. However, the combination of AWS customer ID, table name and this field is guaranteed to be unique. It can be used for creating CloudWatch Alarms. Only available when `stream_enabled = true`.
        """
        return pulumi.get(self, "stream_label")
    ...
    @property
    @pulumi.getter(name="streamViewType")
    def stream_view_type(self) -> pulumi.Output[builtins.str]:
        """
        When an item in the table is modified, StreamViewType determines what information is written to the table's stream. Valid values are `KEYS_ONLY`, `NEW_IMAGE`, `OLD_IMAGE`, `NEW_AND_OLD_IMAGES`.
        """
        return pulumi.get(self, "stream_view_type")
    ...
    @property
    @pulumi.getter(name="writeCapacity")
    def write_capacity(self) -> pulumi.Output[builtins.int]:
        """
        Number of write units for this table. If the `billing_mode` is `PROVISIONED`, this field is required.
        """
        return pulumi.get(self, "write_capacity")
