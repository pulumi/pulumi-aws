...
class TableReplicaInitArgs:
    def __init__(__self__, *,
                 global_table_arn: pulumi.Input[builtins.str],
    ...
    def global_table_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def global_table_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def point_in_time_recovery(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def point_in_time_recovery(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "point_in_time_recovery", value)

    @property
    @pulumi.getter(name="tableClassOverride")
    def table_class_override(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def table_class_override(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TableReplicaState:
    def __init__(__self__, *,
                 ...
                 deletion_protection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 global_table_arn: Optional[pulumi.Input[builtins.str]] = None,
                 kms_key_arn: Optional[pulumi.Input[builtins.str]] = None,
                 point_in_time_recovery: Optional[pulumi.Input[builtins.bool]] = None,
                 table_class_override: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the table replica.
        :param pulumi.Input[builtins.bool] deletion_protection_enabled: Whether deletion protection is enabled (true) or disabled (false) on the table replica.
        :param pulumi.Input[builtins.str] global_table_arn: ARN of the _main_ or global table which this resource will replicate.
    ...
    @property
    @pulumi.getter(name="globalTableArn")
    def global_table_arn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ARN of the _main_ or global table which this resource will replicate.
    ...
    @global_table_arn.setter
    def global_table_arn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "global_table_arn", value)
...
class TableReplica(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            table_class_override: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None) -> 'TableReplica':
        """
    ...
    @property
    @pulumi.getter(name="globalTableArn")
    def global_table_arn(self) -> pulumi.Output[builtins.str]:
        """
        ARN of the _main_ or global table which this resource will replicate.
    ...
    @property
    @pulumi.getter(name="pointInTimeRecovery")
    def point_in_time_recovery(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether to enable Point In Time Recovery for the table replica. Default is `false`.
        """
        return pulumi.get(self, "point_in_time_recovery")
    ...
    @property
    @pulumi.getter(name="tableClassOverride")
    def table_class_override(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Storage class of the table replica. Valid values are `STANDARD` and `STANDARD_INFREQUENT_ACCESS`. If not used, the table replica will use the same class as the global table.
        """
        return pulumi.get(self, "table_class_override")
