...
class TableItemArgs:
    ...
    def hash_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @hash_key.setter
    def hash_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "hash_key", value)

    @property
    @pulumi.getter
    def item(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @item.setter
    def item(self, value: pulumi.Input[builtins.str]):
    ...
    def range_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class _TableItemState:
    ...
    @property
    @pulumi.getter
    def item(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        JSON representation of a map of attribute name/value pairs, one for each attribute. Only the primary key attributes are required; you can optionally provide other attribute name-value pairs for the item.
        """
        return pulumi.get(self, "item")
    ...
    @item.setter
    def item(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "item", value)
...
class TableItem(pulumi.CustomResource):
    ...
    pulumi_type = "aws:dynamodb/tableItem:TableItem"
    ...
    @property
    @pulumi.getter(name="hashKey")
    def hash_key(self) -> pulumi.Output[builtins.str]:
        """
        Hash key to use for lookups and identification of the item
        """
        return pulumi.get(self, "hash_key")
    ...
    @property
    @pulumi.getter
    def item(self) -> pulumi.Output[builtins.str]:
        """
        JSON representation of a map of attribute name/value pairs, one for each attribute. Only the primary key attributes are required; you can optionally provide other attribute name-value pairs for the item.
        """
        return pulumi.get(self, "item")
    ...
    @property
    @pulumi.getter(name="rangeKey")
    def range_key(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Range key to use for lookups and identification of the item. Required if there is range key defined in the table.
        """
        return pulumi.get(self, "range_key")
