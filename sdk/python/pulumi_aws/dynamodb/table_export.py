...
class TableExportArgs:
    def __init__(__self__, *,
                 ...
                 export_format: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] table_arn: ARN associated with the table to export.
               
               The following arguments are optional:
        :param pulumi.Input[builtins.str] export_format: Format for the exported data. Valid values are: `DYNAMODB_JSON`, `ION`. See the [AWS Documentation](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/S3DataExport.Output.html#S3DataExport.Output_Data) for more information on these export formats. Default is `DYNAMODB_JSON`.
        ...
        :param pulumi.Input[builtins.str] s3_sse_kms_key_id: ID of the AWS KMS managed key used to encrypt the S3 bucket where export data will be stored (if applicable).
        """
    ...
    def export_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def export_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "export_format", value)

    @property
    @pulumi.getter(name="exportTime")
    def export_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @export_time.setter
    def export_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def s3_bucket_owner(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def s3_sse_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def s3_sse_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TableExportState:
    def __init__(__self__, *,
                 ...
                 billed_size_in_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 end_time: Optional[pulumi.Input[builtins.str]] = None,
                 export_format: Optional[pulumi.Input[builtins.str]] = None,
                 export_status: Optional[pulumi.Input[builtins.str]] = None,
                 export_time: Optional[pulumi.Input[builtins.str]] = None,
                 export_type: Optional[pulumi.Input[builtins.str]] = None,
                 incremental_export_specification: Optional[pulumi.Input['TableExportIncrementalExportSpecificationArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] arn: ARN of the Table Export.
        :param pulumi.Input[builtins.int] billed_size_in_bytes: Billable size of the table export.
        :param pulumi.Input[builtins.str] end_time: Time at which the export task completed.
        :param pulumi.Input[builtins.str] export_format: Format for the exported data. Valid values are: `DYNAMODB_JSON`, `ION`. See the [AWS Documentation](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/S3DataExport.Output.html#S3DataExport.Output_Data) for more information on these export formats. Default is `DYNAMODB_JSON`.
        :param pulumi.Input[builtins.str] export_status: Status of the export - export can be in one of the following states `IN_PROGRESS`, `COMPLETED`, or `FAILED`.
        :param pulumi.Input[builtins.str] export_time: Time in RFC3339 format from which to export table data. The table export will be a snapshot of the table's state at this point in time. Omitting this value will result in a snapshot from the current time.
        :param pulumi.Input[builtins.str] export_type: Whether to execute as a full export or incremental export. Valid values are: `FULL_EXPORT`, `INCREMENTAL_EXPORT`. Defaults to `FULL_EXPORT`. If `INCREMENTAL_EXPORT` is provided, the `incremental_export_specification` argument must also be provided.
               `incremental_export_specification` - (Optional, Forces new resource) Parameters specific to an incremental export. See `incremental_export_specification` Block for details.
        ...
        :param pulumi.Input[builtins.str] s3_sse_algorithm: Type of encryption used on the bucket where export data will be stored. Valid values are: `AES256`, `KMS`.
        :param pulumi.Input[builtins.str] s3_sse_kms_key_id: ID of the AWS KMS managed key used to encrypt the S3 bucket where export data will be stored (if applicable).
        :param pulumi.Input[builtins.str] start_time: Time at which the export task began.
        :param pulumi.Input[builtins.str] table_arn: ARN associated with the table to export.
    ...
    def billed_size_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def billed_size_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def export_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def export_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def item_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @item_count.setter
    def item_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "item_count", value)

    @property
    @pulumi.getter(name="manifestFilesS3Key")
    def manifest_files_s3_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def manifest_files_s3_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TableExport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            s3_sse_kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
            start_time: Optional[pulumi.Input[builtins.str]] = None,
            table_arn: Optional[pulumi.Input[builtins.str]] = None) -> 'TableExport':
        """
    ...
    @property
    @pulumi.getter(name="billedSizeInBytes")
    def billed_size_in_bytes(self) -> pulumi.Output[builtins.int]:
        """
        Billable size of the table export.
        """
        return pulumi.get(self, "billed_size_in_bytes")
    ...
    @property
    @pulumi.getter(name="exportFormat")
    def export_format(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Format for the exported data. Valid values are: `DYNAMODB_JSON`, `ION`. See the [AWS Documentation](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/S3DataExport.Output.html#S3DataExport.Output_Data) for more information on these export formats. Default is `DYNAMODB_JSON`.
        """
        return pulumi.get(self, "export_format")
    ...
    @property
    @pulumi.getter(name="exportTime")
    def export_time(self) -> pulumi.Output[builtins.str]:
        """
        Time in RFC3339 format from which to export table data. The table export will be a snapshot of the table's state at this point in time. Omitting this value will result in a snapshot from the current time.
        """
        return pulumi.get(self, "export_time")
    ...
    @property
    @pulumi.getter(name="itemCount")
    def item_count(self) -> pulumi.Output[builtins.int]:
        """
        Number of items exported.
        """
        return pulumi.get(self, "item_count")
    ...
    @property
    @pulumi.getter(name="manifestFilesS3Key")
    def manifest_files_s3_key(self) -> pulumi.Output[builtins.str]:
        """
        Name of the manifest file for the export task. See the [AWS Documentation](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/S3DataExport.Output.html#S3DataExport.Output_Manifest) for more information on this manifest file.
        """
        return pulumi.get(self, "manifest_files_s3_key")
    ...
    @property
    @pulumi.getter(name="s3BucketOwner")
    def s3_bucket_owner(self) -> pulumi.Output[builtins.str]:
        """
        ID of the AWS account that owns the bucket the export will be stored in.
        """
        return pulumi.get(self, "s3_bucket_owner")
    ...
    @property
    @pulumi.getter(name="s3SseAlgorithm")
    def s3_sse_algorithm(self) -> pulumi.Output[builtins.str]:
        """
        Type of encryption used on the bucket where export data will be stored. Valid values are: `AES256`, `KMS`.
        """
        return pulumi.get(self, "s3_sse_algorithm")
    ...
    @property
    @pulumi.getter(name="s3SseKmsKeyId")
    def s3_sse_kms_key_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        ID of the AWS KMS managed key used to encrypt the S3 bucket where export data will be stored (if applicable).
        """
        return pulumi.get(self, "s3_sse_kms_key_id")
