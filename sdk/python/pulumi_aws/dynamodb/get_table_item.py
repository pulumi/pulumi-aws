...
class GetTableItemResult:
    ...
    def expression_attribute_names(self) -> Optional[Mapping[str, builtins.str]]:
    ...
    def projection_expression(self) -> Optional[builtins.str]:
...
def get_table_item(expression_attribute_names: Optional[Mapping[str, builtins.str]] = None,
    ...
    :param builtins.str key: A map of attribute names to AttributeValue objects, representing the primary key of the item to retrieve.
