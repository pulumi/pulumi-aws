...
def get_access_keys(user: Optional[builtins.str] = None,
    ...
    :param builtins.str user: Name of the IAM user associated with the access keys.
    """
    __args__ = dict()
    __args__['user'] = user
...
def get_access_keys_output(user: Optional[pulumi.Input[builtins.str]] = None,
