...
class SigningCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_body: The contents of the signing certificate in PEM-encoded format.
        :param pulumi.Input[builtins.str] user_name: The name of the user the signing certificate is for.
        :param pulumi.Input[builtins.str] status: The status you want to assign to the certificate. `Active` means that the certificate can be used for programmatic calls to Amazon Web Services `Inactive` means that the certificate cannot be used.
        """
...
class _SigningCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_body: The contents of the signing certificate in PEM-encoded format.
        :param pulumi.Input[builtins.str] certificate_id: The ID for the signing certificate.
        :param pulumi.Input[builtins.str] status: The status you want to assign to the certificate. `Active` means that the certificate can be used for programmatic calls to Amazon Web Services `Inactive` means that the certificate cannot be used.
        :param pulumi.Input[builtins.str] user_name: The name of the user the signing certificate is for.
        """
...
class SigningCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            certificate_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'SigningCertificate':
        """
