...
class UserPolicyAttachmentsExclusiveArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policy_arns: A list of managed IAM policy ARNs to be attached to the user. Policies attached to this user but not configured in this argument will be removed.
...
class UserPolicyAttachmentsExclusive(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            policy_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'UserPolicyAttachmentsExclusive':
        """
