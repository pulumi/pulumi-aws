...
class SshKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] encoding: Specifies the public key encoding format to use in the response. To retrieve the public key in ssh-rsa format, use `SSH`. To retrieve the public key in PEM format, use `PEM`.
        :param pulumi.Input[builtins.str] public_key: The SSH public key. The public key must be encoded in ssh-rsa format or PEM format.
        :param pulumi.Input[builtins.str] username: The name of the IAM user to associate the SSH public key with.
        :param pulumi.Input[builtins.str] status: The status to assign to the SSH public key. Active means the key can be used for authentication with an AWS CodeCommit repository. Inactive means the key cannot be used. Default is `active`.
        """
...
class _SshKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] encoding: Specifies the public key encoding format to use in the response. To retrieve the public key in ssh-rsa format, use `SSH`. To retrieve the public key in PEM format, use `PEM`.
        :param pulumi.Input[builtins.str] fingerprint: The MD5 message digest of the SSH public key.
        :param pulumi.Input[builtins.str] public_key: The SSH public key. The public key must be encoded in ssh-rsa format or PEM format.
        :param pulumi.Input[builtins.str] ssh_public_key_id: The unique identifier for the SSH public key.
        :param pulumi.Input[builtins.str] status: The status to assign to the SSH public key. Active means the key can be used for authentication with an AWS CodeCommit repository. Inactive means the key cannot be used. Default is `active`.
        :param pulumi.Input[builtins.str] username: The name of the IAM user to associate the SSH public key with.
        """
    ...
    def ssh_public_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ssh_public_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SshKey(pulumi.CustomResource):
    ...
    pulumi_type = "aws:iam/sshKey:SshKey"
    ...
    def get(resource_name: str,
            ...
            ssh_public_key_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'SshKey':
        """
    ...
    @property
    @pulumi.getter(name="sshPublicKeyId")
    def ssh_public_key_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier for the SSH public key.
        """
        return pulumi.get(self, "ssh_public_key_id")
