...
class GroupPolicyAttachmentsExclusiveArgs:
    ...
    @policy_arns.setter
    def policy_arns(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class GroupPolicyAttachmentsExclusive(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a GroupPolicyAttachmentsExclusive resource with the given unique name, props, and options.
