...
class GroupPolicyAttachmentsExclusiveArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policy_arns: A list of managed IAM policy ARNs to be attached to the group. Policies attached to this group but not configured in this argument will be removed.
        """
...
@pulumi.type_token("aws:iam/groupPolicyAttachmentsExclusive:GroupPolicyAttachmentsExclusive")
class GroupPolicyAttachmentsExclusive(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            group_name: Optional[pulumi.Input[builtins.str]] = None,
            policy_arns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'GroupPolicyAttachmentsExclusive':
        """
