...
class UserGroupMembership(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        user1 = aws.iam.user.User("user1")
        group1 = aws.iam.group.Group("group1")
        group2 = aws.iam.group.Group("group2")
        example1 = aws.iam.user_group_membership.UserGroupMembership("example1",
            user=user1.name,
            groups=[
                group1.name,
                group2.name,
            ])
        group3 = aws.iam.group.Group("group3")
        example2 = aws.iam.user_group_membership.UserGroupMembership("example2",
            user=user1.name,
            groups=[group3.name])
        ```
