...
class UserLoginProfileArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] user: The IAM user's name.
        :param pulumi.Input[builtins.int] password_length: The length of the generated password on resource creation. Only applies on resource creation. Drift detection is not possible with this argument. Default value is `20`.
        :param pulumi.Input[builtins.bool] password_reset_required: Whether the user should be forced to reset the generated password on resource creation. Only applies on resource creation.
        :param pulumi.Input[builtins.str] pgp_key: Either a base-64 encoded PGP public key, or a keybase username in the form `keybase:username`. Only applies on resource creation. Drift detection is not possible with this argument.
        """
...
class _UserLoginProfileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] encrypted_password: The encrypted password, base64 encoded. Only available if password was handled on resource creation, not import.
        :param pulumi.Input[builtins.str] key_fingerprint: The fingerprint of the PGP key used to encrypt the password. Only available if password was handled on this provider resource creation, not import.
        :param pulumi.Input[builtins.str] password: The plain text password, only available when `pgp_key` is not provided.
        :param pulumi.Input[builtins.int] password_length: The length of the generated password on resource creation. Only applies on resource creation. Drift detection is not possible with this argument. Default value is `20`.
        :param pulumi.Input[builtins.bool] password_reset_required: Whether the user should be forced to reset the generated password on resource creation. Only applies on resource creation.
        :param pulumi.Input[builtins.str] pgp_key: Either a base-64 encoded PGP public key, or a keybase username in the form `keybase:username`. Only applies on resource creation. Drift detection is not possible with this argument.
        :param pulumi.Input[builtins.str] user: The IAM user's name.
...
class UserLoginProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            password_reset_required: Optional[pulumi.Input[builtins.bool]] = None,
            pgp_key: Optional[pulumi.Input[builtins.str]] = None,
            user: Optional[pulumi.Input[builtins.str]] = None) -> 'UserLoginProfile':
        """
    ...
    @property
    @pulumi.getter(name="passwordLength")
    def password_length(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The length of the generated password on resource creation. Only applies on resource creation. Drift detection is not possible with this argument. Default value is `20`.
        """
        return pulumi.get(self, "password_length")
