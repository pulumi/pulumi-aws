...
class GetPrincipalPolicySimulationResult:
    ...
    def caller_arn(self) -> Optional[builtins.str]:
    ...
    def permissions_boundary_policies_jsons(self) -> Optional[Sequence[builtins.str]]:
...
def get_principal_policy_simulation(action_names: Optional[Sequence[builtins.str]] = None,
                                    additional_policies_jsons: Optional[Sequence[builtins.str]] = None,
                                    caller_arn: Optional[builtins.str] = None,
                                    ...
                                    permissions_boundary_policies_jsons: Optional[Sequence[builtins.str]] = None,
                                    policy_source_arn: Optional[builtins.str] = None,
                                    resource_arns: Optional[Sequence[builtins.str]] = None,
                                    resource_handling_option: Optional[builtins.str] = None,
                                    resource_owner_account_id: Optional[builtins.str] = None,
                                    resource_policy_json: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] action_names: A set of IAM action names to run simulations for. Each entry in this set adds an additional hypothetical request to the simulation.
    ...
    :param Sequence[builtins.str] additional_policies_jsons: A set of additional principal policy documents to include in the simulation. The simulator will behave as if each of these policies were associated with the object specified in `policy_source_arn`, allowing you to test the effect of hypothetical policies not yet created.
    :param builtins.str caller_arn: The ARN of an user that will appear as the "caller" of the simulated requests. If you do not specify `caller_arn` then the simulation will use the `policy_source_arn` instead, if it contains a user ARN.
    ...
    :param Sequence[builtins.str] permissions_boundary_policies_jsons: A set of [permissions boundary policy documents](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_boundaries.html) to include in the simulation.
    :param builtins.str policy_source_arn: The [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of the IAM user, group, or role whose policies will be included in the simulation.
    ...
    :param Sequence[builtins.str] resource_arns: A set of ARNs of resources to include in the simulation.
    ...
    :param builtins.str resource_handling_option: Specifies a special simulation type to run. Some EC2 actions require special simulation behaviors and a particular set of resource ARNs to achieve a realistic result.
    ...
    :param builtins.str resource_owner_account_id: An AWS account ID to use for any resource ARN in `resource_arns` that doesn't include its own AWS account ID. If unspecified, the simulator will use the account ID from the `caller_arn` argument as a placeholder.
    :param builtins.str resource_policy_json: An IAM policy document representing the resource-level policy of all of the resources specified in `resource_arns`.
...
def get_principal_policy_simulation_output(action_names: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
                                           additional_policies_jsons: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                           caller_arn: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           ...
                                           permissions_boundary_policies_jsons: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                           policy_source_arn: Optional[pulumi.Input[builtins.str]] = None,
                                           resource_arns: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                           resource_handling_option: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           resource_owner_account_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           resource_policy_json: Optional[pulumi.Input[Optional[builtins.str]]] = None,
