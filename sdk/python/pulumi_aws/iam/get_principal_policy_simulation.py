...
@pulumi.output_type
calass GetPrincipalPolicySimulationResult:
    """
...
calass AwaitableGetPrincipalPolicySimulationResult(GetPrincipalPolicySimulationResult):
...
def get_principal_policy_simulation(action_names: Optional[Sequence[str]] = None,
                                    ...
                                    contexts: Optional[Sequence[pulumi.InputType['GetPrincipalPolicySimulationContextArrgs']]] = None,
    ...
    :param Sequence[pulumi.InputType['GetPrincipalPolicySimulationContextArrgs']] contexts: Each `context` block defines an entry in the table of additional context keys in the simulated request.
...
def get_principal_policy_simulation_output(action_names: Optional[pulumi.Input[Sequence[str]]] = None,
                                           ...
                                           contexts: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetPrincipalPolicySimulationContextArrgs']]]]] = None,
