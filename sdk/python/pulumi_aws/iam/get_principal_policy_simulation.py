...
def get_principal_policy_simulation(action_names: Optional[Sequence[str]] = None,
    ...
    return AwaitableGetPrincipalPolicySimulationResult(
        action_names=__ret__.action_names,
        additional_policies_jsons=__ret__.additional_policies_jsons,
        all_allowed=__ret__.all_allowed,
        caller_arn=__ret__.caller_arn,
        contexts=__ret__.contexts,
        id=__ret__.id,
        permissions_boundary_policies_jsons=__ret__.permissions_boundary_policies_jsons,
        policy_source_arn=__ret__.policy_source_arn,
        resource_arns=__ret__.resource_arns,
        resource_handling_option=__ret__.resource_handling_option,
        resource_owner_account_id=__ret__.resource_owner_account_id,
        resource_policy_json=__ret__.resource_policy_json,
