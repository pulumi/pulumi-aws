...
class RoleInlinePolicy(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the role policy.
        :param builtins.str policy: Policy document as a JSON formatted string.
        """
        if name is not None:
...
class GetAccessKeysAccessKeyResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str create_date: Date and time in [RFC3339 format](https://tools.ietf.org/html/rfc3339#section-5.8) that the access key was created.
        :param builtins.str status: Access key status. Possible values are `Active` and `Inactive`.
        """
...
class GetGroupUserResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str arn: User ARN.
        :param builtins.str path: Path to the IAM user.
        :param builtins.str user_id: Stable and unique string identifying the IAM user.
        :param builtins.str user_name: Name of the IAM user.
        """
...
class GetPrincipalPolicySimulationResultResult(dict):
    def __init__(__self__, *,
                 ...
                 decision_details: Mapping[str, builtins.str],
                 matched_statements: Sequence['outputs.GetPrincipalPolicySimulationResultMatchedStatementResult'],
                 missing_context_keys: Sequence[builtins.str],
                 resource_arn: builtins.str):
        """
        :param builtins.str action_name: The name of the single IAM action used for this particular request.
        :param builtins.bool allowed: `true` if `decision` is "allowed", and `false` otherwise.
        :param builtins.str decision: The raw decision determined from all of the policies in scope; either "allowed", "explicitDeny", or "implicitDeny".
        :param Mapping[str, builtins.str] decision_details: A map of arbitrary metadata entries returned by the policy simulator for this request.
        ...
        :param Sequence[builtins.str] missing_context_keys: A set of context keys (or condition keys) that were needed by some of the policies contributing to this result but not specified using a `context` block in the configuration. Missing or incorrect context keys will typically cause a simulated request to be disallowed.
        :param builtins.str resource_arn: ARN of the resource that was used for this particular request. When you specify multiple actions and multiple resource ARNs, that causes a separate policy request for each combination of unique action and resource.
        """
    ...
    def decision_details(self) -> Mapping[str, builtins.str]:
        """
    ...
    def missing_context_keys(self) -> Sequence[builtins.str]:
        """
...
class GetPrincipalPolicySimulationResultMatchedStatementResult(dict):
    def __init__(__self__, *,
                 source_policy_id: builtins.str,
                 source_policy_type: builtins.str):
        """
        :param builtins.str source_policy_id: Identifier of one of the policies used as input to the simulation.
        :param builtins.str source_policy_type: The type of the policy identified in source_policy_id.
        """
...
class GetRoleRoleLastUsedResult(dict):
    def __init__(__self__, *,
                 last_used_date: builtins.str,
                 region: builtins.str):
        """
        :param builtins.str last_used_date: The date and time, in RFC 3339 format, that the role was last used.
        :param builtins.str region: The name of the AWS Region in which the role was last used.
        """
