...
class GetPrincipalPolicySimulationResultResult(dict):
    ...
    def _configure(
        ...
        if 'decisionDetails' in kwargs:
            decision_details = kwargs['decisionDetails']
        if 'matchedStatements' in kwargs:
            matched_statements = kwargs['matchedStatements']
        if 'missingContextKeys' in kwargs:
...
class GetPrincipalPolicySimulationResultMatchedStatementResult(dict):
    ...
    def _configure(
             ...
             opts: Optional[pulumi.ResourceOptions]=None,
             **kwargs):
        if 'sourcePolicyId' in kwargs:
            source_policy_id = kwargs['sourcePolicyId']
        if 'sourcePolicyType' in kwargs:
