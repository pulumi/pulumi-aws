...
class UserPoliciesExclusiveArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] policy_names: A list of inline policy names to be assigned to the user. Policies attached to this user but not configured in this argument will be removed.
        :param pulumi.Input[builtins.str] user_name: IAM user name.
        """
...
class UserPoliciesExclusive(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            policy_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'UserPoliciesExclusive':
        """
