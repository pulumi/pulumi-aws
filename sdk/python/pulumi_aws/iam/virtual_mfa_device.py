...
class VirtualMfaDeviceArgs:
    def __init__(__self__, *,
                 virtual_mfa_device_name: pulumi.Input[builtins.str],
                 path: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a VirtualMfaDevice resource.
        :param pulumi.Input[builtins.str] virtual_mfa_device_name: The name of the virtual MFA device. Use with path to uniquely identify a virtual MFA device.
        :param pulumi.Input[builtins.str] path: The path for the virtual MFA device.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of resource tags for the virtual mfa device. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        """
    ...
    def virtual_mfa_device_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def virtual_mfa_device_name(self, value: pulumi.Input[builtins.str]):
...
class _VirtualMfaDeviceState:
    def __init__(__self__, *,
                 ...
                 base32_string_seed: Optional[pulumi.Input[builtins.str]] = None,
                 enable_date: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None,
                 qr_code_png: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 user_name: Optional[pulumi.Input[builtins.str]] = None,
                 virtual_mfa_device_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering VirtualMfaDevice resources.
        :param pulumi.Input[builtins.str] arn: The Amazon Resource Name (ARN) specifying the virtual mfa device.
        :param pulumi.Input[builtins.str] base32_string_seed: The base32 seed defined as specified in [RFC3548](https://tools.ietf.org/html/rfc3548.txt). The `base_32_string_seed` is base64-encoded.
        :param pulumi.Input[builtins.str] enable_date: The date and time when the virtual MFA device was enabled.
        :param pulumi.Input[builtins.str] path: The path for the virtual MFA device.
        :param pulumi.Input[builtins.str] qr_code_png: A QR code PNG image that encodes `otpauth://totp/$virtualMFADeviceName@$AccountName?secret=$Base32String` where `$virtualMFADeviceName` is one of the create call arguments. AccountName is the user name if set (otherwise, the account ID), and Base32String is the seed in base32 format.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Map of resource tags for the virtual mfa device. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags_all: A map of tags assigned to the resource, including those inherited from the provider `default_tags` configuration block.
        :param pulumi.Input[builtins.str] user_name: The associated IAM User name if the virtual MFA device is enabled.
        :param pulumi.Input[builtins.str] virtual_mfa_device_name: The name of the virtual MFA device. Use with path to uniquely identify a virtual MFA device.
        """
        if arn is not None:
    ...
    def base32_string_seed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def base32_string_seed(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "base32_string_seed", value)

    @property
    @pulumi.getter(name="enableDate")
    def enable_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @enable_date.setter
    def enable_date(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def qr_code_png(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @qr_code_png.setter
    def qr_code_png(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="virtualMfaDeviceName")
    def virtual_mfa_device_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the virtual MFA device. Use with path to uniquely identify a virtual MFA device.
        """
        return pulumi.get(self, "virtual_mfa_device_name")
    ...
    @virtual_mfa_device_name.setter
    def virtual_mfa_device_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "virtual_mfa_device_name", value)
...
class VirtualMfaDevice(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags_all: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            user_name: Optional[pulumi.Input[builtins.str]] = None,
            virtual_mfa_device_name: Optional[pulumi.Input[builtins.str]] = None) -> 'VirtualMfaDevice':
        """
    ...
    @property
    @pulumi.getter(name="base32StringSeed")
    def base32_string_seed(self) -> pulumi.Output[builtins.str]:
        """
        The base32 seed defined as specified in [RFC3548](https://tools.ietf.org/html/rfc3548.txt). The `base_32_string_seed` is base64-encoded.
        """
        return pulumi.get(self, "base32_string_seed")
    ...
    @property
    @pulumi.getter(name="enableDate")
    def enable_date(self) -> pulumi.Output[builtins.str]:
        """
        The date and time when the virtual MFA device was enabled.
        """
        return pulumi.get(self, "enable_date")
    ...
    @property
    @pulumi.getter(name="qrCodePng")
    def qr_code_png(self) -> pulumi.Output[builtins.str]:
        """
        A QR code PNG image that encodes `otpauth://totp/$virtualMFADeviceName@$AccountName?secret=$Base32String` where `$virtualMFADeviceName` is one of the create call arguments. AccountName is the user name if set (otherwise, the account ID), and Base32String is the seed in base32 format.
        """
        return pulumi.get(self, "qr_code_png")
    ...
    @property
    @pulumi.getter(name="virtualMfaDeviceName")
    def virtual_mfa_device_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the virtual MFA device. Use with path to uniquely identify a virtual MFA device.
        """
        return pulumi.get(self, "virtual_mfa_device_name")
