...
def get_server_certificate(latest: Optional[builtins.bool] = None,
    ...
    :param builtins.bool latest: sort results by expiration date. returns the certificate with expiration date in furthest in the future.
    :param builtins.str name: exact name of the cert to lookup
    :param builtins.str name_prefix: prefix of cert to filter by
    :param builtins.str path_prefix: prefix of path to filter by
    """
    __args__ = dict()
...
def get_server_certificate_output(latest: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
