...
class SafetyRuleArgs:
    def __init__(__self__, *,
                 control_panel_arn: pulumi.Input[builtins.str],
                 rule_config: pulumi.Input['SafetyRuleRuleConfigArgs'],
                 wait_period_ms: pulumi.Input[builtins.int],
                 asserted_controls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 gating_controls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 target_controls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a SafetyRule resource.
        :param pulumi.Input[builtins.str] control_panel_arn: ARN of the control panel in which this safety rule will reside.
        :param pulumi.Input['SafetyRuleRuleConfigArgs'] rule_config: Configuration block for safety rule criteria. See below.
        :param pulumi.Input[builtins.int] wait_period_ms: Evaluation period, in milliseconds (ms), during which any request against the target routing controls will fail.
               
               The following arguments are optional:
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] asserted_controls: Routing controls that are part of transactions that are evaluated to determine if a request to change a routing control state is allowed.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] gating_controls: Gating controls for the new gating rule. That is, routing controls that are evaluated by the rule configuration that you specify.
        :param pulumi.Input[builtins.str] name: Name describing the safety rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_controls: Routing controls that can only be set or unset if the specified `rule_config` evaluates to true for the specified `gating_controls`.
        """
    ...
    def control_panel_arn(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def control_panel_arn(self, value: pulumi.Input[builtins.str]):
    ...
    def asserted_controls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def asserted_controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "asserted_controls", value)

    @property
    @pulumi.getter(name="gatingControls")
    def gating_controls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def gating_controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def target_controls(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def target_controls(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _SafetyRuleState:
    def __init__(__self__, *,
                 ...
                 target_controls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 wait_period_ms: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering SafetyRule resources.
        :param pulumi.Input[builtins.str] arn: ARN of the safety rule.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] asserted_controls: Routing controls that are part of transactions that are evaluated to determine if a request to change a routing control state is allowed.
        :param pulumi.Input[builtins.str] control_panel_arn: ARN of the control panel in which this safety rule will reside.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] gating_controls: Gating controls for the new gating rule. That is, routing controls that are evaluated by the rule configuration that you specify.
        :param pulumi.Input[builtins.str] name: Name describing the safety rule.
        :param pulumi.Input['SafetyRuleRuleConfigArgs'] rule_config: Configuration block for safety rule criteria. See below.
        :param pulumi.Input[builtins.str] status: Status of the safety rule. `PENDING` when it is being created/updated, `PENDING_DELETION` when it is being deleted, and `DEPLOYED` otherwise.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_controls: Routing controls that can only be set or unset if the specified `rule_config` evaluates to true for the specified `gating_controls`.
        :param pulumi.Input[builtins.int] wait_period_ms: Evaluation period, in milliseconds (ms), during which any request against the target routing controls will fail.
    ...
    @property
    @pulumi.getter(name="waitPeriodMs")
    def wait_period_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Evaluation period, in milliseconds (ms), during which any request against the target routing controls will fail.
    ...
    @wait_period_ms.setter
    def wait_period_ms(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "wait_period_ms", value)
...
class SafetyRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            target_controls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            wait_period_ms: Optional[pulumi.Input[builtins.int]] = None) -> 'SafetyRule':
        """
    ...
    @property
    @pulumi.getter(name="assertedControls")
    def asserted_controls(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Routing controls that are part of transactions that are evaluated to determine if a request to change a routing control state is allowed.
        """
        return pulumi.get(self, "asserted_controls")
    ...
    @property
    @pulumi.getter(name="gatingControls")
    def gating_controls(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Gating controls for the new gating rule. That is, routing controls that are evaluated by the rule configuration that you specify.
        """
        return pulumi.get(self, "gating_controls")
    ...
    @property
    @pulumi.getter(name="targetControls")
    def target_controls(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Routing controls that can only be set or unset if the specified `rule_config` evaluates to true for the specified `gating_controls`.
        """
        return pulumi.get(self, "target_controls")
    ...
    @property
    @pulumi.getter(name="waitPeriodMs")
    def wait_period_ms(self) -> pulumi.Output[builtins.int]:
        """
        Evaluation period, in milliseconds (ms), during which any request against the target routing controls will fail.
