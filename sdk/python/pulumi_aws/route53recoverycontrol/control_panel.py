...
class ControlPanelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_arn: ARN of the cluster in which this control panel will reside.
        :param pulumi.Input[builtins.str] name: Name describing the control panel.
        """
...
class _ControlPanelState:
    def __init__(__self__, *,
                 ...
                 default_control_panel: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 routing_control_count: Optional[pulumi.Input[builtins.int]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ControlPanel resources.
        :param pulumi.Input[builtins.str] arn: ARN of the control panel.
        :param pulumi.Input[builtins.str] cluster_arn: ARN of the cluster in which this control panel will reside.
        :param pulumi.Input[builtins.bool] default_control_panel: Whether a control panel is default.
        :param pulumi.Input[builtins.str] name: Name describing the control panel.
        :param pulumi.Input[builtins.int] routing_control_count: Number routing controls in a control panel.
        :param pulumi.Input[builtins.str] status: Status of control panel: `PENDING` when it is being created/updated, `PENDING_DELETION` when it is being deleted, and `DEPLOYED` otherwise.
        """
        if arn is not None:
    ...
    def default_control_panel(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def default_control_panel(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def routing_control_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def routing_control_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ControlPanel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            routing_control_count: Optional[pulumi.Input[builtins.int]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'ControlPanel':
        """
