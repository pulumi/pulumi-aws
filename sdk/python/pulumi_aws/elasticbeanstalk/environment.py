...
class EnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 version: Optional[pulumi.Input['ApplicationVersion']] = None,
        ...
        :param pulumi.Input[builtins.str] cname_prefix: Prefix to use for the fully qualified DNS name of
               the Environment.
        :param pulumi.Input[builtins.str] description: Short description of the Environment
        :param pulumi.Input[builtins.str] name: A unique name for this Environment. This name is used
               in the application URL
        :param pulumi.Input[builtins.str] platform_arn: The [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of the Elastic Beanstalk [Platform](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk-environment.html#cfn-beanstalk-environment-platformarn)
               to use in deployment
        :param pulumi.Input[builtins.str] poll_interval: The time between polling the AWS API to
        ...
        :param pulumi.Input['ApplicationVersion'] version: The name of the Elastic Beanstalk Application Version
               to use in deployment.
    ...
    def cname_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cname_prefix.setter
    def cname_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def version(self) -> Optional[pulumi.Input['ApplicationVersion']]:
        """
    ...
    @version.setter
    def version(self, value: Optional[pulumi.Input['ApplicationVersion']]):
        pulumi.set(self, "version", value)

    @property
    @pulumi.getter(name="waitForReadyTimeout")
    def wait_for_ready_timeout(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The maximum
        [duration](https://golang.org/pkg/time/#ParseDuration) that this provider should
        wait for an Elastic Beanstalk Environment to be in a ready state before timing
    ...
    def wait_for_ready_timeout(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EnvironmentState:
    def __init__(__self__, *,
                 ...
                 launch_configurations: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] cname_prefix: Prefix to use for the fully qualified DNS name of
               the Environment.
        :param pulumi.Input[builtins.str] description: Short description of the Environment
        :param pulumi.Input[builtins.str] endpoint_url: The URL to the Load Balancer for this Environment
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] instances: Instances used by this Environment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] launch_configurations: Launch configurations in use by this Environment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] load_balancers: Elastic load balancers in use by this Environment.
        :param pulumi.Input[builtins.str] name: A unique name for this Environment. This name is used
               in the application URL
        :param pulumi.Input[builtins.str] platform_arn: The [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of the Elastic Beanstalk [Platform](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk-environment.html#cfn-beanstalk-environment-platformarn)
               to use in deployment
    ...
    def autoscaling_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def autoscaling_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def launch_configurations(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def launch_configurations(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Environment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autoscalingGroups")
    def autoscaling_groups(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The autoscaling groups used by this Environment.
        """
        return pulumi.get(self, "autoscaling_groups")
    ...
    @property
    @pulumi.getter(name="cnamePrefix")
    def cname_prefix(self) -> pulumi.Output[builtins.str]:
        """
        Prefix to use for the fully qualified DNS name of
        the Environment.
        """
    ...
    @property
    @pulumi.getter(name="launchConfigurations")
    def launch_configurations(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Launch configurations in use by this Environment.
        """
        return pulumi.get(self, "launch_configurations")
    ...
    @property
    @pulumi.getter(name="platformArn")
    def platform_arn(self) -> pulumi.Output[builtins.str]:
        """
        The [ARN](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html) of the Elastic Beanstalk [Platform](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-beanstalk-environment.html#cfn-beanstalk-environment-platformarn)
        to use in deployment
        """
    ...
    @property
    @pulumi.getter
    def queues(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        SQS queues in use by this Environment.
        """
        return pulumi.get(self, "queues")
    ...
    @property
    @pulumi.getter(name="solutionStackName")
    def solution_stack_name(self) -> pulumi.Output[builtins.str]:
        """
        A solution stack to base your environment
        off of. Example stacks can be found in the [Amazon API documentation](https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/concepts.platforms.html)
        """
    ...
    @property
    @pulumi.getter
    def version(self) -> pulumi.Output['ApplicationVersion']:
        """
        The name of the Elastic Beanstalk Application Version
        to use in deployment.
        """
    ...
    @property
    @pulumi.getter(name="waitForReadyTimeout")
    def wait_for_ready_timeout(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The maximum
        [duration](https://golang.org/pkg/time/#ParseDuration) that this provider should
        wait for an Elastic Beanstalk Environment to be in a ready state before timing
