...
class ApplicationArgs:
    ...
    def _configure(
             ...
             **kwargs):
        if appversion_lifecycle is None and 'appversionLifecycle' in kwargs:
            appversion_lifecycle = kwargs['appversionLifecycle']

        if appversion_lifecycle is not None:
            _setter("appversion_lifecycle", appversion_lifecycle)
...
class Application(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if appversion_lifecycle is not None and not isinstance(appversion_lifecycle, ApplicationAppversionLifecycleArgs):
                appversion_lifecycle = appversion_lifecycle or {}
                def _setter(key, value):
                    appversion_lifecycle[key] = value
                ApplicationAppversionLifecycleArgs._configure(_setter, **appversion_lifecycle)
