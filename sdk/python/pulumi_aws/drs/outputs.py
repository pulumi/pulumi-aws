...
class ReplicationConfigurationTemplatePitPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 retention_duration: builtins.int,
                 units: builtins.str,
                 enabled: Optional[builtins.bool] = None,
                 rule_id: Optional[builtins.int] = None):
        """
        :param builtins.int interval: How often, in the chosen units, a snapshot should be taken.
        :param builtins.int retention_duration: Duration to retain a snapshot for, in the chosen `units`.
        :param builtins.str units: Units used to measure the `interval` and `retention_duration`. Valid values are `MINUTE`, `HOUR`, and `DAY`.
        :param builtins.bool enabled: Whether this rule is enabled or not.
        :param builtins.int rule_id: ID of the rule. Valid values are integers.
        """
