...
if not MYPY:
    class ReplicationConfigurationTemplatePitPolicyArgsDict(TypedDict):
        ...
        """
        retention_duration: pulumi.Input[builtins.int]
        """
...
class ReplicationConfigurationTemplatePitPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] interval: How often, in the chosen units, a snapshot should be taken.
        :param pulumi.Input[builtins.int] retention_duration: Duration to retain a snapshot for, in the chosen `units`.
        :param pulumi.Input[builtins.str] units: Units used to measure the `interval` and `retention_duration`. Valid values are `MINUTE`, `HOUR`, and `DAY`.
        :param pulumi.Input[builtins.bool] enabled: Whether this rule is enabled or not.
        :param pulumi.Input[builtins.int] rule_id: ID of the rule. Valid values are integers.
        """
    ...
    def retention_duration(self) -> pulumi.Input[builtins.int]:
        """
        Duration to retain a snapshot for, in the chosen `units`.
        """
    ...
    def retention_duration(self, value: pulumi.Input[builtins.int]):
