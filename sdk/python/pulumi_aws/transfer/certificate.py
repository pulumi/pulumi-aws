...
class CertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate: The valid certificate file required for the transfer.
...
class _CertificateState:
    def __init__(__self__, *,
                 active_date: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] active_date: An date when the certificate becomes active
        :param pulumi.Input[builtins.str] arn: The ARN of the certificate
        :param pulumi.Input[builtins.str] certificate: The valid certificate file required for the transfer.
        :param pulumi.Input[builtins.str] certificate_chain: The optional list of certificate that make up the chain for the certificate that is being imported.
        :param pulumi.Input[builtins.str] certificate_id: The unique identifier for the AS2 certificate
        :param pulumi.Input[builtins.str] description: A short description that helps identify the certificate.
    ...
    def active_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @active_date.setter
    def active_date(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def inactive_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inactive_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Certificate(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="activeDate")
    def active_date(self) -> pulumi.Output[builtins.str]:
        """
        An date when the certificate becomes active
        """
        return pulumi.get(self, "active_date")
    ...
    @property
    @pulumi.getter(name="inactiveDate")
    def inactive_date(self) -> pulumi.Output[builtins.str]:
        """
        An date when the certificate becomes inactive
        """
        return pulumi.get(self, "inactive_date")
