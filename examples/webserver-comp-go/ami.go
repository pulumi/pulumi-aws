...
var instanceTypeArch = map[string]string{
	"t1.micro":    "PV64",
	"t2.nano":     "HVM64",
	"t2.micro":    "HVM64",
	"t2.small":    "HVM64",
...
var regionArchLinuxAMI = map[string]map[string]string{
	"us-east-1": {
		"PV64":  "ami-2a69aa47",
		"HVM64": "ami-6869aa05",
		"HVMG2": "ami-648d9973",
...
func getLinuxAMI(region, instanceType string) string {
	arch := instanceTypeArch[instanceType]
