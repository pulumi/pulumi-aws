		...
		ExtraTypes: map[string]schema.ComplexTypeSpec{
			...
			"aws:iam/ManagedPolicy:ManagedPolicy": {
				...
				Enum: []*schema.EnumValueSpec{
					...
					{Name: "AWSBatchServiceRole", Value: "arn:iam::aws:policy/service-role/AWSBatchServiceRole"},
					...
					{Name: "AWSCloudHSMRole", Value: "arn:iam::aws:policy/service-role/AWSCloudHSMRole"},
					...
					{Name: "AWSCodeDeployRole", Value: "arn:iam::aws:policy/service-role/AWSCodeDeployRole"},
					...
					{Name: "AWSCodeStarServiceRole", Value: "arn:iam::aws:policy/service-role/AWSCodeStarServiceRole"},
					{Name: "AWSConfigRole", Value: "arn:iam::aws:policy/service-role/AWSConfigRole"},
					{Name: "AWSConfigRulesExecutionRole", Value: "arn:iam::aws:policy/service-role/AWSConfigRulesExecutionRole"},
					...
					{Name: "AWSDataPipelineRole", Value: "arn:iam::aws:policy/service-role/AWSDataPipelineRole"},
					...
					{Name: "AWSElasticBeanstalkEnhancedHealth", Value: "arn:iam::aws:policy/service-role/AWSElasticBeanstalkEnhancedHealth"},
					...
					{Name: "AWSElasticBeanstalkService", Value: "arn:iam::aws:policy/service-role/AWSElasticBeanstalkService"},
					...
					{Name: "AWSGreengrassResourceAccessRolePolicy", Value: "arn:iam::aws:policy/service-role/AWSGreengrassResourceAccessRolePolicy"},
					...
					{Name: "AWSIoTLogging", Value: "arn:iam::aws:policy/service-role/AWSIoTLogging"},
					{Name: "AWSIoTRuleActions", Value: "arn:iam::aws:policy/service-role/AWSIoTRuleActions"},
					{Name: "AWSKeyManagementServicePowerUser", Value: "arn:aws:iam::aws:policy/AWSKeyManagementServicePowerUser"},
					{Name: "AWSLambdaBasicExecutionRole", Value: "arn:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole"},
					{Name: "AWSLambdaDynamoDBExecutionRole", Value: "arn:iam::aws:policy/service-role/AWSLambdaDynamoDBExecutionRole"},
					{Name: "AWSLambdaENIManagementAccess", Value: "arn:iam::aws:policy/service-role/AWSLambdaENIManagementAccess"},
					...
					{Name: "AWSLambdaKinesisExecutionRole", Value: "arn:iam::aws:policy/service-role/AWSLambdaKinesisExecutionRole"},
					{Name: "AWSLambdaReadOnlyAccess", Value: "arn:aws:iam::aws:policy/AWSLambdaReadOnlyAccess"},
					{Name: "AWSLambdaRole", Value: "arn:iam::aws:policy/service-role/AWSLambdaRole"},
					{Name: "AWSLambdaVPCAccessExecutionRole", Value: "arn:iam::aws:policy/service-role/AWSLambdaVPCAccessExecutionRole"},
					...
					{Name: "AWSMobileHub_ServiceUseOnly", Value: "arn:iam::aws:policy/service-role/AWSMobileHub_ServiceUseOnly"},
					{Name: "AWSOpsWorksCMInstanceProfileRole", Value: "arn:aws:iam::aws:policy/AWSOpsWorksCMInstanceProfileRole"},
					{Name: "AWSOpsWorksCMServiceRole", Value: "arn:iam::aws:policy/service-role/AWSOpsWorksCMServiceRole"},
					...
					{Name: "AWSOpsWorksRole", Value: "arn:iam::aws:policy/service-role/AWSOpsWorksRole"},
					{Name: "AWSQuickSightDescribeRD", Value: "arn:iam::aws:policy/service-role/AWSQuickSightDescribeRDS"},
					{Name: "AWSQuickSightDescribeRedshift", Value: "arn:iam::aws:policy/service-role/AWSQuickSightDescribeRedshift"},
					{Name: "AWSQuickSightListIAM", Value: "arn:iam::aws:policy/service-role/AWSQuickSightListIAM"},
					{Name: "AWSQuicksightAthenaAccess", Value: "arn:iam::aws:policy/service-role/AWSQuicksightAthenaAccess"},
					...
					{Name: "AmazonAPIGatewayPushToCloudWatchLogs", Value: "arn:iam::aws:policy/service-role/AmazonAPIGatewayPushToCloudWatchLogs"},
					...
					{Name: "AmazonAppStreamServiceAccess", Value: "arn:iam::aws:policy/service-role/AmazonAppStreamServiceAccess"},
					...
					{Name: "AmazonDMSCloudWatchLogsRole", Value: "arn:iam::aws:policy/service-role/AmazonDMSCloudWatchLogsRole"},
					{Name: "AmazonDMSRedshiftS3Role", Value: "arn:iam::aws:policy/service-role/AmazonDMSRedshiftS3Role"},
					{Name: "AmazonDMSVPCManagementRole", Value: "arn:iam::aws:policy/service-role/AmazonDMSVPCManagementRole"},
					...
					{Name: "AmazonEC2ContainerServiceAutoscaleRole", Value: "arn:iam::aws:policy/service-role/AmazonEC2ContainerServiceAutoscaleRole"},
					{Name: "AmazonEC2ContainerServiceFullAccess", Value: "arn:aws:iam::aws:policy/AmazonEC2ContainerServiceFullAccess"},
					{Name: "AmazonEC2ContainerServiceRole", Value: "arn:iam::aws:policy/service-role/AmazonEC2ContainerServiceRole"},
					{Name: "AmazonEC2ContainerServiceforEC2Role", Value: "arn:iam::aws:policy/service-role/AmazonEC2ContainerServiceforEC2Role"},
					...
					{Name: "AmazonEC2RoleforAWSCodeDeploy", Value: "arn:iam::aws:policy/service-role/AmazonEC2RoleforAWSCodeDeploy"},
					{Name: "AmazonEC2RoleforDataPipelineRole", Value: "arn:iam::aws:policy/service-role/AmazonEC2RoleforDataPipelineRole"},
					{Name: "AmazonEC2RoleforSSM", Value: "arn:iam::aws:policy/service-role/AmazonEC2RoleforSSM"},
					{Name: "AmazonEC2SpotFleetAutoscaleRole", Value: "arn:iam::aws:policy/service-role/AmazonEC2SpotFleetAutoscaleRole"},
					{Name: "AmazonEC2SpotFleetRole", Value: "arn:iam::aws:policy/service-role/AmazonEC2SpotFleetRole"},
					{Name: "AmazonEC2SpotFleetTaggingRole", Value: "arn:iam::aws:policy/service-role/AmazonEC2SpotFleetTaggingRole"},
					...
					{Name: "AmazonElasticMapReduceRole", Value: "arn:iam::aws:policy/service-role/AmazonElasticMapReduceRole"},
					{Name: "AmazonElasticMapReduceforAutoScalingRole", Value: "arn:iam::aws:policy/service-role/AmazonElasticMapReduceforAutoScalingRole"},
					{Name: "AmazonElasticMapReduceforEC2Role", Value: "arn:iam::aws:policy/service-role/AmazonElasticMapReduceforEC2Role"},
					...
					{Name: "AmazonElasticTranscoderRole", Value: "arn:iam::aws:policy/service-role/AmazonElasticTranscoderRole"},
					...
					{Name: "AmazonMachineLearningRoleforRedshiftDataSource", Value: "arn:iam::aws:policy/service-role/AmazonMachineLearningRoleforRedshiftDataSource"},
					...
					{Name: "AmazonRDSDirectoryServiceAccess", Value: "arn:iam::aws:policy/service-role/AmazonRDSDirectoryServiceAccess"},
					{Name: "AmazonRDSEnhancedMonitoringRole", Value: "arn:iam::aws:policy/service-role/AmazonRDSEnhancedMonitoringRole"},
					...
					{Name: "AmazonSNSRole", Value: "arn:iam::aws:policy/service-role/AmazonSNSRole"},
					...
					{Name: "AmazonSSMAutomationRole", Value: "arn:iam::aws:policy/service-role/AmazonSSMAutomationRole"},
					{Name: "AmazonSSMFullAccess", Value: "arn:aws:iam::aws:policy/AmazonSSMFullAccess"},
					{Name: "AmazonSSMMaintenanceWindowRole", Value: "arn:iam::aws:policy/service-role/AmazonSSMMaintenanceWindowRole"},
					...
					{Name: "ApplicationAutoScalingForAmazonAppStreamAccess", Value: "arn:iam::aws:policy/service-role/ApplicationAutoScalingForAmazonAppStreamAccess"},
					...
					{Name: "AutoScalingNotificationAccessRole", Value: "arn:iam::aws:policy/service-role/AutoScalingNotificationAccessRole"},
