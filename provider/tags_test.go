...
// This test confirms that if a non-empty tag is present then tagsAll will be marked as
// secret.
func TestSecretsAreInsertedForNonEmptyTags(t *testing.T) {
	if testing.Short() {
		t.Skipf("Needs credentials to test")
	}
	const replayEvent = `[{
  ...
  "request": {
    "id": "mybucket-947e6d1",
    "urn": "urn:pulumi:dev::ts::aws:s3/bucketV2:BucketV2::mybucket",
    "olds": {
      ...
      "accelerationStatus": "",
      "arn": "arn:aws:s3:::mybucket-947e6d1",
      "bucket": "mybucket-947e6d1",
      "bucketDomainName": "mybucket-947e6d1.s3.amazonaws.com",
      "bucketPrefix": "",
      "bucketRegionalDomainName": "mybucket-947e6d1.s3.us-west-2.amazonaws.com",
      "corsRules": [],
      "forceDestroy": false,
      "grants": [
        {
...
// This test confirms that if a empty tagsAll is present then tagsAll will not be secret.
func TestEmptyTagsAllNotSecret(t *testing.T) {
	if testing.Short() {
		t.Skipf("Needs credentials to test")
	}
	const replayEvent = `[{
