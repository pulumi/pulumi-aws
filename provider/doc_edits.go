...
func editRules(defaults []tfbridge.DocsEdit) []tfbridge.DocsEdit {
	return append(defaults,
		targetedSimpleReplace("cloudfront_public_key.html.markdown",
		...
		targetedSimpleReplace("ecs_service.html.markdown",
...
func extraNotesFor(from string, to string) tfbridge.DocsEdit {
	fromR, toB := regexp.MustCompile(from), []byte(to)
	return tfbridge.DocsEdit{
		Path: "*",
		Edit: func(_ string, content []byte) ([]byte, error) {
