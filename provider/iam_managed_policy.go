...
func iamManagedPolicyValues() []schema.EnumValueSpec {
	return []schema.EnumValueSpec{
		...
		{
			Name:  "AWSServiceRoleForCodeGuruProfiler",
		...
		{
			Name:  "AdministratorAccessAWSElasticBeanstalk",
		...
		{
			Name:  "AmazonDocDBElasticServiceRolePolicy",
		...
		{Name: "AmazonECSFullAccess", Value: "arn:aws:iam::aws:policy/AmazonECS_FullAccess"},
		{
			...
			Value: "arn:aws:iam::aws:policy/service-role/AmazonECSInfrastructureRolePolicyForServiceConnectTransportLayerSecurity", //nolint:lll
		},
		{
		...
		{
			Name:  "AmazonMobileAnalyticsNonfinancialReportAccess",
		...
		{
			Name:  "AmazonSageMakerAdminServiceCatalogProductsServiceRolePolicy",
		...
		},
		{
			...
			Value: "arn:aws:iam::aws:policy/service-role/AmazonSageMakerPartnerServiceCatalogProductsApiGatewayServiceRolePolicy", //nolint:lll
		},
		{
			Name:  "AmazonSageMakerPartnerServiceCatalogProductsCloudFormationServiceRolePolicy",
			Value: "arn:aws:iam::aws:policy/service-role/AmazonSageMakerPartnerServiceCatalogProductsCloudFormationServiceRolePolicy", //nolint:lll
		},
		{
